...
public class Percentile75Deserializer implements JsonDeserializer<Percentile75> {

	@Override
	public Percentile75 deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
			throws JsonParseException {
		if(jsonElement.isJsonPrimitive()) {
			return new PERCENTILE75(jsonElement.getAsBigDecimal());
		}

		JsonObject jsonObject = jsonElement.getAsJsonObject();
		Percentile75 obj = new PERCENTILE75();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = PERCENTILE75.class.getFields();
		for(Field fld : flds) {
