...
public class OccupationLocationDeserializer implements JsonDeserializer<OccupationLocation> {

	@Override
	public OccupationLocation deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
			throws JsonParseException {
		if(jsonElement.isJsonPrimitive()) {
			return new OCCUPATION_LOCATION(jsonElement.getAsString());
		}

		JsonObject jsonObject = jsonElement.getAsJsonObject();
		OccupationLocation obj = new OCCUPATION_LOCATION();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = OCCUPATION_LOCATION.class.getFields();
		for(Field fld : flds) {
