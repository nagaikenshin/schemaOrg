...
import org.kyojo.schemaorg.m3n4.pending.impl.INCLUDES_HEALTH_PLAN_FORMULARY;
import org.kyojo.schemaorg.m3n4.pending.Container.IncludesHealthPlanFormulary;
...
public class IncludesHealthPlanFormularyDeserializer implements JsonDeserializer<IncludesHealthPlanFormulary> {
	...
	public IncludesHealthPlanFormulary deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
		...
		IncludesHealthPlanFormulary obj = new INCLUDES_HEALTH_PLAN_FORMULARY();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = INCLUDES_HEALTH_PLAN_FORMULARY.class.getFields();
		for(Field fld : flds) {
