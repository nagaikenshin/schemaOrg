...
public class TouristDestinationDeserializer implements JsonDeserializer<TouristDestination> {

	@Override
	public TouristDestination deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
			throws JsonParseException {
		if(jsonElement.isJsonPrimitive()) {
			return new TOURIST_DESTINATION(jsonElement.getAsString());
		}

		JsonObject jsonObject = jsonElement.getAsJsonObject();
		TouristDestination obj = new TOURIST_DESTINATION();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = TOURIST_DESTINATION.class.getFields();
		for(Field fld : flds) {
