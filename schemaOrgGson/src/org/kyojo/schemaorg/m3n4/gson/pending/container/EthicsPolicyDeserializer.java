...
public class EthicsPolicyDeserializer implements JsonDeserializer<EthicsPolicy> {

	@Override
	public EthicsPolicy deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
			throws JsonParseException {
		if(jsonElement.isJsonPrimitive()) {
			return new ETHICS_POLICY(jsonElement.getAsString());
		}

		JsonObject jsonObject = jsonElement.getAsJsonObject();
		EthicsPolicy obj = new ETHICS_POLICY();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = ETHICS_POLICY.class.getFields();
		for(Field fld : flds) {
