...
public class BackstoryDeserializer implements JsonDeserializer<Backstory> {

	@Override
	public Backstory deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
			throws JsonParseException {
		if(jsonElement.isJsonPrimitive()) {
			return new BACKSTORY(jsonElement.getAsString());
		}

		JsonObject jsonObject = jsonElement.getAsJsonObject();
		Backstory obj = new BACKSTORY();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = BACKSTORY.class.getFields();
		for(Field fld : flds) {
