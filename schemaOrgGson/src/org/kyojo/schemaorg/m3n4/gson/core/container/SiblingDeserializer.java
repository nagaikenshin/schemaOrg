...
import org.kyojo.schemaorg.m3n4.core.impl.SIBLING;
import org.kyojo.schemaorg.m3n4.core.Container.Sibling;

public class SiblingDeserializer implements JsonDeserializer<Sibling> {

	@Override
	public Sibling deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
			throws JsonParseException {
		if(jsonElement.isJsonPrimitive()) {
			return new SIBLING(jsonElement.getAsString());
		}

		JsonObject jsonObject = jsonElement.getAsJsonObject();
		Sibling obj = new SIBLING();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = SIBLING.class.getFields();
		for(Field fld : flds) {
