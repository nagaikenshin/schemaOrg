...
import org.kyojo.schemaorg.m3n4.core.orderStatus.ORDER_PROCESSING;
import org.kyojo.schemaorg.m3n4.core.OrderStatus.OrderProcessing;
...
public class OrderProcessingDeserializer implements JsonDeserializer<OrderProcessing> {
	...
	public OrderProcessing deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
		...
		OrderProcessing obj = new ORDER_PROCESSING();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = ORDER_PROCESSING.class.getFields();
		for(Field fld : flds) {
