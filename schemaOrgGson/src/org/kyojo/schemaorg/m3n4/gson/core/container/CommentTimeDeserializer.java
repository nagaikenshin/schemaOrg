...
import org.kyojo.schemaorg.m3n4.core.impl.COMMENT_TIME;
import org.kyojo.schemaorg.m3n4.core.Container.CommentTime;
...
public class CommentTimeDeserializer implements JsonDeserializer<CommentTime> {
	...
	public CommentTime deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
		...
		CommentTime obj = new COMMENT_TIME();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = COMMENT_TIME.class.getFields();
		for(Field fld : flds) {
