...
import org.kyojo.schemaorg.m3n4.core.impl.PASSENGER_PRIORITY_STATUS;
import org.kyojo.schemaorg.m3n4.core.Container.PassengerPriorityStatus;
...
public class PassengerPriorityStatusDeserializer implements JsonDeserializer<PassengerPriorityStatus> {
	...
	public PassengerPriorityStatus deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
		...
		PassengerPriorityStatus obj = new PASSENGER_PRIORITY_STATUS();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = PASSENGER_PRIORITY_STATUS.class.getFields();
		for(Field fld : flds) {
