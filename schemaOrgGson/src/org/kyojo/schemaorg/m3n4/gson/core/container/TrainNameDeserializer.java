...
import org.kyojo.schemaorg.m3n4.core.impl.TRAIN_NAME;
import org.kyojo.schemaorg.m3n4.core.Container.TrainName;
...
public class TrainNameDeserializer implements JsonDeserializer<TrainName> {
	...
	public TrainName deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
		...
		TrainName obj = new TRAIN_NAME();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = TRAIN_NAME.class.getFields();
		for(Field fld : flds) {
