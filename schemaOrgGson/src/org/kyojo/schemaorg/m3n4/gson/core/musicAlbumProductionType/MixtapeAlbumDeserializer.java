...
import org.kyojo.schemaorg.m3n4.core.musicAlbumProductionType.MIXTAPE_ALBUM;
import org.kyojo.schemaorg.m3n4.core.MusicAlbumProductionType.MixtapeAlbum;
...
public class MixtapeAlbumDeserializer implements JsonDeserializer<MixtapeAlbum> {
	...
	public MixtapeAlbum deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
		...
		MixtapeAlbum obj = new MIXTAPE_ALBUM();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = MIXTAPE_ALBUM.class.getFields();
		for(Field fld : flds) {
