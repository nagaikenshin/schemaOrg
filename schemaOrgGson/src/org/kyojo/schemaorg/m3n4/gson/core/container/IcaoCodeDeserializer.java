...
public class IcaoCodeDeserializer implements JsonDeserializer<IcaoCode> {

	@Override
	public IcaoCode deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
			throws JsonParseException {
		if(jsonElement.isJsonPrimitive()) {
			return new ICAO_CODE(jsonElement.getAsString());
		}

		JsonObject jsonObject = jsonElement.getAsJsonObject();
		IcaoCode obj = new ICAO_CODE();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = ICAO_CODE.class.getFields();
		for(Field fld : flds) {
