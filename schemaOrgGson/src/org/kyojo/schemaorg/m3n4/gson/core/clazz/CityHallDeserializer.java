...
import org.kyojo.schemaorg.m3n4.core.impl.CITY_HALL;
import org.kyojo.schemaorg.m3n4.core.Clazz.CityHall;

public class CityHallDeserializer implements JsonDeserializer<CityHall> {

	@Override
	public CityHall deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
			throws JsonParseException {
		if(jsonElement.isJsonPrimitive()) {
			return new CITY_HALL(jsonElement.getAsString());
		}

		JsonObject jsonObject = jsonElement.getAsJsonObject();
		CityHall obj = new CITY_HALL();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = CITY_HALL.class.getFields();
		for(Field fld : flds) {
