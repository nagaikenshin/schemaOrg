...
import org.kyojo.schemaorg.m3n4.core.orderStatus.ORDER_CANCELLED;
import org.kyojo.schemaorg.m3n4.core.OrderStatus.OrderCancelled;
...
public class OrderCancelledDeserializer implements JsonDeserializer<OrderCancelled> {
	...
	public OrderCancelled deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
		...
		OrderCancelled obj = new ORDER_CANCELLED();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = ORDER_CANCELLED.class.getFields();
		for(Field fld : flds) {
