...
import org.kyojo.schemaorg.m3n4.core.orderStatus.ORDER_RETURNED;
import org.kyojo.schemaorg.m3n4.core.OrderStatus.OrderReturned;
...
public class OrderReturnedDeserializer implements JsonDeserializer<OrderReturned> {
	...
	public OrderReturned deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
		...
		OrderReturned obj = new ORDER_RETURNED();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = ORDER_RETURNED.class.getFields();
		for(Field fld : flds) {
