package org.kyojo.schemaorg.m3n4.gson.core.boardingPolicyType;
...
import org.kyojo.schemaorg.m3n4.core.boardingPolicyType.GROUP_BOARDING_POLICY;
import org.kyojo.schemaorg.m3n4.core.BoardingPolicyType.GroupBoardingPolicy;
...
public class GroupBoardingPolicyDeserializer implements JsonDeserializer<GroupBoardingPolicy> {
	...
	public GroupBoardingPolicy deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
		...
		GroupBoardingPolicy obj = new GROUP_BOARDING_POLICY();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = GROUP_BOARDING_POLICY.class.getFields();
		for(Field fld : flds) {
