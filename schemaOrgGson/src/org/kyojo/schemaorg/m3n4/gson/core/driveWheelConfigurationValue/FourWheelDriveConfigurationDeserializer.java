...
import org.kyojo.schemaorg.m3n4.core.driveWheelConfigurationValue.FOUR_WHEEL_DRIVE_CONFIGURATION;
import org.kyojo.schemaorg.m3n4.core.DriveWheelConfigurationValue.FourWheelDriveConfiguration;
...
public class FourWheelDriveConfigurationDeserializer implements JsonDeserializer<FourWheelDriveConfiguration> {
	...
	public FourWheelDriveConfiguration deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
		...
		FourWheelDriveConfiguration obj = new FOUR_WHEEL_DRIVE_CONFIGURATION();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = FOUR_WHEEL_DRIVE_CONFIGURATION.class.getFields();
		for(Field fld : flds) {
