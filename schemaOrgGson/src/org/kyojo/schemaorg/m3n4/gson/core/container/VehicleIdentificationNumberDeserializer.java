...
import org.kyojo.schemaorg.m3n4.core.impl.VEHICLE_IDENTIFICATION_NUMBER;
import org.kyojo.schemaorg.m3n4.core.Container.VehicleIdentificationNumber;
...
public class VehicleIdentificationNumberDeserializer implements JsonDeserializer<VehicleIdentificationNumber> {
	...
	public VehicleIdentificationNumber deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
		...
		VehicleIdentificationNumber obj = new VEHICLE_IDENTIFICATION_NUMBER();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = VEHICLE_IDENTIFICATION_NUMBER.class.getFields();
		for(Field fld : flds) {
