...
import org.kyojo.schemaorg.m3n4.core.impl.SECURITY_SCREENING;
import org.kyojo.schemaorg.m3n4.core.Container.SecurityScreening;
...
public class SecurityScreeningDeserializer implements JsonDeserializer<SecurityScreening> {
	...
	public SecurityScreening deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
		...
		SecurityScreening obj = new SECURITY_SCREENING();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = SECURITY_SCREENING.class.getFields();
		for(Field fld : flds) {
