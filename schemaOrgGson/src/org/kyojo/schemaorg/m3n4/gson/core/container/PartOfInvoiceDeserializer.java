...
import org.kyojo.schemaorg.m3n4.core.impl.PART_OF_INVOICE;
import org.kyojo.schemaorg.m3n4.core.Container.PartOfInvoice;
...
public class PartOfInvoiceDeserializer implements JsonDeserializer<PartOfInvoice> {
	...
	public PartOfInvoice deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
		...
		PartOfInvoice obj = new PART_OF_INVOICE();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = PART_OF_INVOICE.class.getFields();
		for(Field fld : flds) {
