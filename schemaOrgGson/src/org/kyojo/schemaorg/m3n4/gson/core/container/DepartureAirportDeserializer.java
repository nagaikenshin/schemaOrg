...
import org.kyojo.schemaorg.m3n4.core.impl.DEPARTURE_AIRPORT;
import org.kyojo.schemaorg.m3n4.core.Container.DepartureAirport;
...
public class DepartureAirportDeserializer implements JsonDeserializer<DepartureAirport> {
	...
	public DepartureAirport deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
		...
		DepartureAirport obj = new DEPARTURE_AIRPORT();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = DEPARTURE_AIRPORT.class.getFields();
		for(Field fld : flds) {
