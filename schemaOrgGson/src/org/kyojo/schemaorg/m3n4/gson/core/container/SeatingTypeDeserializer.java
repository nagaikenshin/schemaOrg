...
import org.kyojo.schemaorg.m3n4.core.impl.SEATING_TYPE;
import org.kyojo.schemaorg.m3n4.core.Container.SeatingType;
...
public class SeatingTypeDeserializer implements JsonDeserializer<SeatingType> {
	...
	public SeatingType deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
		...
		SeatingType obj = new SEATING_TYPE();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = SEATING_TYPE.class.getFields();
		for(Field fld : flds) {
