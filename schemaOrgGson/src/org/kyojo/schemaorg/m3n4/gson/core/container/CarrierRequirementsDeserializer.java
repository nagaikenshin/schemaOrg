...
import org.kyojo.schemaorg.m3n4.core.impl.CARRIER_REQUIREMENTS;
import org.kyojo.schemaorg.m3n4.core.Container.CarrierRequirements;
...
public class CarrierRequirementsDeserializer implements JsonDeserializer<CarrierRequirements> {
	...
	public CarrierRequirements deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
		...
		CarrierRequirements obj = new CARRIER_REQUIREMENTS();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = CARRIER_REQUIREMENTS.class.getFields();
		for(Field fld : flds) {
