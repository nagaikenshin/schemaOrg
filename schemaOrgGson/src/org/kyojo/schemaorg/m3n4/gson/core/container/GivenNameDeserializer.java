...
import org.kyojo.schemaorg.m3n4.core.impl.GIVEN_NAME;
import org.kyojo.schemaorg.m3n4.core.Container.GivenName;

public class GivenNameDeserializer implements JsonDeserializer<GivenName> {

	@Override
	public GivenName deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
			throws JsonParseException {
		if(jsonElement.isJsonPrimitive()) {
			return new GIVEN_NAME(jsonElement.getAsString());
		}

		JsonObject jsonObject = jsonElement.getAsJsonObject();
		GivenName obj = new GIVEN_NAME();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = GIVEN_NAME.class.getFields();
		for(Field fld : flds) {
