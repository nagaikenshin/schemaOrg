...
import org.kyojo.schemaorg.m3n4.core.eventStatusType.EVENT_RESCHEDULED;
import org.kyojo.schemaorg.m3n4.core.EventStatusType.EventRescheduled;
...
public class EventRescheduledDeserializer implements JsonDeserializer<EventRescheduled> {
	...
	public EventRescheduled deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
		...
		EventRescheduled obj = new EVENT_RESCHEDULED();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = EVENT_RESCHEDULED.class.getFields();
		for(Field fld : flds) {
