...
public class BusinessFunctionDeserializer implements JsonDeserializer<BusinessFunction> {

	@Override
	public BusinessFunction deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
			throws JsonParseException {
		if(jsonElement.isJsonPrimitive()) {
			return new BUSINESS_FUNCTION(jsonElement.getAsString());
		}

		JsonObject jsonObject = jsonElement.getAsJsonObject();
		BusinessFunction obj = new BUSINESS_FUNCTION();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = BUSINESS_FUNCTION.class.getFields();
		for(Field fld : flds) {
