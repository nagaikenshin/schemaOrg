...
import org.kyojo.schemaorg.m3n4.core.impl.DROPOFF_TIME;
import org.kyojo.schemaorg.m3n4.core.Container.DropoffTime;
...
public class DropoffTimeDeserializer implements JsonDeserializer<DropoffTime> {
	...
	public DropoffTime deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
		...
		DropoffTime obj = new DROPOFF_TIME();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = DROPOFF_TIME.class.getFields();
		for(Field fld : flds) {
