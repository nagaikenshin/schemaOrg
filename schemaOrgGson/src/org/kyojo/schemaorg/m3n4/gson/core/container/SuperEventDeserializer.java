...
import org.kyojo.schemaorg.m3n4.core.impl.SUPER_EVENT;
import org.kyojo.schemaorg.m3n4.core.Container.SuperEvent;

public class SuperEventDeserializer implements JsonDeserializer<SuperEvent> {

	@Override
	public SuperEvent deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
			throws JsonParseException {
		if(jsonElement.isJsonPrimitive()) {
			return new SUPER_EVENT(jsonElement.getAsString());
		}

		JsonObject jsonObject = jsonElement.getAsJsonObject();
		SuperEvent obj = new SUPER_EVENT();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = SUPER_EVENT.class.getFields();
		for(Field fld : flds) {
