...
import org.kyojo.schemaorg.m3n4.healthLifesci.drugPrescriptionStatus.PRESCRIPTION_ONLY;
import org.kyojo.schemaorg.m3n4.healthLifesci.DrugPrescriptionStatus.PrescriptionOnly;
...
public class PrescriptionOnlyDeserializer implements JsonDeserializer<PrescriptionOnly> {
	...
	public PrescriptionOnly deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
		...
		PrescriptionOnly obj = new PRESCRIPTION_ONLY();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = PRESCRIPTION_ONLY.class.getFields();
		for(Field fld : flds) {
