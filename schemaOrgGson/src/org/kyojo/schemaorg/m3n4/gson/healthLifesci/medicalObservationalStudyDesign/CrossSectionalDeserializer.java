...
import org.kyojo.schemaorg.m3n4.healthLifesci.medicalObservationalStudyDesign.CROSS_SECTIONAL;
import org.kyojo.schemaorg.m3n4.healthLifesci.MedicalObservationalStudyDesign.CrossSectional;
...
public class CrossSectionalDeserializer implements JsonDeserializer<CrossSectional> {
	...
	public CrossSectional deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
		...
		CrossSectional obj = new CROSS_SECTIONAL();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = CROSS_SECTIONAL.class.getFields();
		for(Field fld : flds) {
