...
public class PodiatricDeserializer implements JsonDeserializer<Podiatric> {

	@Override
	public Podiatric deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
			throws JsonParseException {
		if(jsonElement.isJsonPrimitive()) {
			return new PODIATRIC(jsonElement.getAsString());
		}

		JsonObject jsonObject = jsonElement.getAsJsonObject();
		Podiatric obj = new PODIATRIC();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = PODIATRIC.class.getFields();
		for(Field fld : flds) {
