...
public class WarningDeserializer implements JsonDeserializer<Warning> {
	...
	@Override
	public Warning deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
			throws JsonParseException {
		if(jsonElement.isJsonPrimitive()) {
			return new WARNING(jsonElement.getAsString());
		}

		return DeserializerTemplate.deserializeSub(jsonElement, type, context,
			new WARNING(), Warning.class, WARNING.class, fldMap);
	}
