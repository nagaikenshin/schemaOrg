...
public class MidwiferyDeserializer implements JsonDeserializer<Midwifery> {

	@Override
	public Midwifery deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
			throws JsonParseException {
		if(jsonElement.isJsonPrimitive()) {
			return new MIDWIFERY(jsonElement.getAsString());
		}

		JsonObject jsonObject = jsonElement.getAsJsonObject();
		Midwifery obj = new MIDWIFERY();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = MIDWIFERY.class.getFields();
		for(Field fld : flds) {
