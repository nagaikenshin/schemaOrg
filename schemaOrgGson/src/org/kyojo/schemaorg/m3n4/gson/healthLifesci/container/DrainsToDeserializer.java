...
import org.kyojo.schemaorg.m3n4.healthLifesci.impl.DRAINS_TO;
import org.kyojo.schemaorg.m3n4.healthLifesci.Container.DrainsTo;
...
public class DrainsToDeserializer implements JsonDeserializer<DrainsTo> {
	...
	public DrainsTo deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
		...
		DrainsTo obj = new DRAINS_TO();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = DRAINS_TO.class.getFields();
		for(Field fld : flds) {
