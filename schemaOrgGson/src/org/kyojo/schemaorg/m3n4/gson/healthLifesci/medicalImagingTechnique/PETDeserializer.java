...
import org.kyojo.schemaorg.m3n4.healthLifesci.medicalImagingTechnique.PET;
import org.kyojo.schemaorg.m3n4.healthLifesci.MedicalImagingTechnique;

public class PETDeserializer implements JsonDeserializer<MedicalImagingTechnique.PET> {

	@Override
	public MedicalImagingTechnique.PET deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
			throws JsonParseException {
		if(jsonElement.isJsonPrimitive()) {
			return new PET(jsonElement.getAsString());
		}

		JsonObject jsonObject = jsonElement.getAsJsonObject();
		MedicalImagingTechnique.PET obj = new PET();
		HashMap<String, Field> fldMap = new HashMap<>();
		Field[] flds = PET.class.getFields();
		for(Field fld : flds) {
