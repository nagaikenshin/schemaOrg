...
import org.kyojo.schemaorg.m3n5.healthLifesci.medicalImagingTechnique.X_RAY;
import org.kyojo.schemaorg.m3n5.healthLifesci.MedicalImagingTechnique.XRay;
...
public class XRayDeserializer implements JsonDeserializer<XRay> {
	...
	public XRay deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
		...
		return DeserializerTemplate.deserializeSub(jsonElement, type, context,
			new X_RAY(), XRay.class, X_RAY.class, fldMap);
	}
