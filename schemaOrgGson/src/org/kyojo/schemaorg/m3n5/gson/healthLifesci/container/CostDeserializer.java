...
public class CostDeserializer implements JsonDeserializer<Cost> {
	...
	@Override
	public Cost deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
			throws JsonParseException {
		if(jsonElement.isJsonPrimitive()) {
			return new COST(jsonElement.getAsString());
		}

		return DeserializerTemplate.deserializeSub(jsonElement, type, context,
			new COST(), Cost.class, COST.class, fldMap);
	}
