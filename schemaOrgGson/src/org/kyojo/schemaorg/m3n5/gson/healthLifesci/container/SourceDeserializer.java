...
public class SourceDeserializer implements JsonDeserializer<Source> {
	...
	@Override
	public Source deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
			throws JsonParseException {
		if(jsonElement.isJsonPrimitive()) {
			return new SOURCE(jsonElement.getAsString());
		}

		return DeserializerTemplate.deserializeSub(jsonElement, type, context,
			new SOURCE(), Source.class, SOURCE.class, fldMap);
	}
