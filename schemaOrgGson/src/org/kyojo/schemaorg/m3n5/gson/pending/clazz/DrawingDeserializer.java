...
public class DrawingDeserializer implements JsonDeserializer<Drawing> {
	...
	@Override
	public Drawing deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
			throws JsonParseException {
		if(jsonElement.isJsonPrimitive()) {
			return new DRAWING(jsonElement.getAsString());
		}

		return DeserializerTemplate.deserializeSub(jsonElement, type, context,
			new DRAWING(), Drawing.class, DRAWING.class, fldMap);
	}
