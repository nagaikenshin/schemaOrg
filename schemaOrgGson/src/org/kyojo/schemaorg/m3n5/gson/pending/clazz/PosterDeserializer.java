...
public class PosterDeserializer implements JsonDeserializer<Poster> {
	...
	@Override
	public Poster deserialize(JsonElement jsonElement, Type type, JsonDeserializationContext context)
			throws JsonParseException {
		if(jsonElement.isJsonPrimitive()) {
			return new POSTER(jsonElement.getAsString());
		}

		return DeserializerTemplate.deserializeSub(jsonElement, type, context,
			new POSTER(), Poster.class, POSTER.class, fldMap);
	}
