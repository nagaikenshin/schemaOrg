...
public interface Container extends SchemaOrgProperty {
	...
	@SchemaOrgComment(""
			...
			+ " no matching property in schema.org.<br/><br/>\n\nNote: Publishers should be"
	...
	@SchemaOrgComment(""
			...
			+ " represents where a work was created e.g. where a news report was written).  For"
			+ " location depicted or described in the content, use <a class=\"localLink\""
			+ " href=\"http://schema.org/contentLocation\">contentLocation</a>.<br/><br/>\n\nDateline"
			+ " summaries are oriented more towards human readers than towards automated"
			+ " processing, and can vary substantially. Some examples: \"BEIRUT, Lebanon, June"
			+ " 2.\", \"Paris, France\", \"December 19, 2017 11:43AM Reporting from"
	...
	@SchemaOrgComment(""
			...
			+ " reference</a>) e.g. application/zip for a SoftwareApplication binary,"
			+ " audio/mpeg for .mp3 etc.).<br/><br/>\n\nIn cases where a <a class=\"localLink\""
			+ " href=\"http://schema.org/CreativeWork\">CreativeWork</a> has several media type"
			+ " representations, <a class=\"localLink\""
	...
	@SchemaOrgComment(""
			...
			+ " book from January to <em>December</em>.<br/><br/>\n\nNote that Event uses"
	...
	@SchemaOrgComment(""
			...
			+ " (mpg) or kilometers per liter (km/L).<br/><br/>\n\n<ul>\n<li>Note 1: There are"
	...
	@SchemaOrgComment(""
			...
			+ " Prefix, Item Reference, and Check Digit used to identify trade items. See <a"
	...
	@SchemaOrgComment(""
			...
			+ " can be converted into a GTIN-13 code by simply adding a preceeding zero. See <a"
			+ " href=\"http://www.gs1.org/barcodes/technical/idkeys/gtin\">GS1 GTIN Summary</a>"
			+ " for more details.")
	...
	public interface HasPart extends SchemaOrgProperty {
		...
		public void setTripList(List<Clazz.Trip> tripList);
	...
	@SchemaOrgComment(""
			...
			+ " \"Paul\", \"Mary\"), existing entities, or use ListItem.<br/><br/>\n\nText"
	...
	@SchemaOrgComment(""
			...
			+ " production, as read from its odometer.<br/><br/>\n\nTypical unit code(s): KMT"
	...
	@SchemaOrgComment(""
			...
			+ " using a hyphen '-'.<br/><br/>\n\n<ul>\n<li>Days are specified using the"
	...
	@SchemaOrgComment(""
			...
			+ " wrote a book from <em>January</em> to December.<br/><br/>\n\nNote that Event"
	...
	public interface Step extends SchemaOrgProperty {
		...
		public void setHowToSectionList(List<Clazz.HowToSection> howToSectionList);
		...
		public void setHowToStepList(List<Clazz.HowToStep> howToStepList);
