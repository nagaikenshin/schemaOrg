...
import org.kyojo.schemaorg.m3n5.meta.Container.RangeIncludes;
import org.kyojo.schemaorg.m3n5.meta.Container.SupersededBy;

public class PROPERTY implements Clazz.Property {
	...
	public DomainIncludes domainIncludes;
	public Identifier identifier;
	public Image image;
	public InverseOf inverseOf;
	public MainEntityOfPage mainEntityOfPage;
	public Name name;
	public NameFuzzy nameFuzzy;
	public NameRuby nameRuby;
	public PotentialAction potentialAction;
	public RangeIncludes rangeIncludes;
	...
	public PROPERTY(DomainIncludes domainIncludes) {
		setDomainIncludes(domainIncludes);
	}

	@Override
	public DomainIncludes getDomainIncludes() {
		return domainIncludes;
	}

	@Override
	public void setDomainIncludes(DomainIncludes domainIncludes) {
	...
	public PROPERTY(InverseOf inverseOf) {
		setInverseOf(inverseOf);
	}

	@Override
	public InverseOf getInverseOf() {
		return inverseOf;
	}

	@Override
	public void setInverseOf(InverseOf inverseOf) {
	...
	public PROPERTY(NameFuzzy nameFuzzy) {
	...
	public PROPERTY(NameRuby nameRuby) {
	...
	public PROPERTY(RangeIncludes rangeIncludes) {
		setRangeIncludes(rangeIncludes);
	}

	@Override
	public RangeIncludes getRangeIncludes() {
		return rangeIncludes;
	}

	@Override
	public void setRangeIncludes(RangeIncludes rangeIncludes) {
	...
	public PROPERTY(SupersededBy supersededBy) {
	...
	public void copy(Clazz.Property org) {
		...
		setDomainIncludes(org.getDomainIncludes());
		setIdentifier(org.getIdentifier());
		setImage(org.getImage());
		setInverseOf(org.getInverseOf());
		setMainEntityOfPage(org.getMainEntityOfPage());
		setName(org.getName());
		setNameFuzzy(org.getNameFuzzy());
		setNameRuby(org.getNameRuby());
		setPotentialAction(org.getPotentialAction());
		setRangeIncludes(org.getRangeIncludes());
