...
public class ORDER_CANCELLED implements OrderStatus.OrderCancelled {
	...
	public ORDER_CANCELLED() {
	}

	public ORDER_CANCELLED(Long seq) {
		setSeq(seq);
	}

	public ORDER_CANCELLED(String string) {
	...
	public ORDER_CANCELLED(AdditionalType additionalType) {
	...
	public ORDER_CANCELLED(AlternateName alternateName) {
	...
	public ORDER_CANCELLED(Description description) {
	...
	public ORDER_CANCELLED(DisambiguatingDescription disambiguatingDescription) {
	...
	public ORDER_CANCELLED(Identifier identifier) {
	...
	public ORDER_CANCELLED(Image image) {
		setImage(image);
	}
	...
	public ORDER_CANCELLED(MainEntityOfPage mainEntityOfPage) {
	...
	public ORDER_CANCELLED(Name name) {
		setName(name);
	}
	...
	public ORDER_CANCELLED(NameFuzzy nameFuzzy) {
	...
	public ORDER_CANCELLED(NameRuby nameRuby) {
	...
	public ORDER_CANCELLED(PotentialAction potentialAction) {
	...
	public ORDER_CANCELLED(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ORDER_CANCELLED(SubjectOf subjectOf) {
	...
	public ORDER_CANCELLED(SupersededBy supersededBy) {
	...
	public ORDER_CANCELLED(Url url) {
		setUrl(url);
	}
	...
	public void copy(OrderStatus.OrderCancelled org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return OrderStatus.OrderCancelled.class.getAnnotation(SampleValue.class).value();
	}
