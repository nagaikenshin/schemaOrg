...
public class ORDER_PAYMENT_DUE implements OrderStatus.OrderPaymentDue {
	...
	public ORDER_PAYMENT_DUE() {
	}

	public ORDER_PAYMENT_DUE(Long seq) {
		setSeq(seq);
	}

	public ORDER_PAYMENT_DUE(String string) {
	...
	public ORDER_PAYMENT_DUE(AdditionalType additionalType) {
	...
	public ORDER_PAYMENT_DUE(AlternateName alternateName) {
	...
	public ORDER_PAYMENT_DUE(Description description) {
	...
	public ORDER_PAYMENT_DUE(DisambiguatingDescription disambiguatingDescription) {
	...
	public ORDER_PAYMENT_DUE(Identifier identifier) {
	...
	public ORDER_PAYMENT_DUE(Image image) {
		setImage(image);
	}
	...
	public ORDER_PAYMENT_DUE(MainEntityOfPage mainEntityOfPage) {
	...
	public ORDER_PAYMENT_DUE(Name name) {
		setName(name);
	}
	...
	public ORDER_PAYMENT_DUE(NameFuzzy nameFuzzy) {
	...
	public ORDER_PAYMENT_DUE(NameRuby nameRuby) {
	...
	public ORDER_PAYMENT_DUE(PotentialAction potentialAction) {
	...
	public ORDER_PAYMENT_DUE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ORDER_PAYMENT_DUE(SubjectOf subjectOf) {
	...
	public ORDER_PAYMENT_DUE(SupersededBy supersededBy) {
	...
	public ORDER_PAYMENT_DUE(Url url) {
		setUrl(url);
	}
	...
	public void copy(OrderStatus.OrderPaymentDue org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return OrderStatus.OrderPaymentDue.class.getAnnotation(SampleValue.class).value();
	}
