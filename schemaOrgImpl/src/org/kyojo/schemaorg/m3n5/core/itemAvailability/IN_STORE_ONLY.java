...
public class IN_STORE_ONLY implements ItemAvailability.InStoreOnly {
	...
	public IN_STORE_ONLY() {
	}

	public IN_STORE_ONLY(Long seq) {
		setSeq(seq);
	}

	public IN_STORE_ONLY(String string) {
	...
	public IN_STORE_ONLY(AdditionalType additionalType) {
	...
	public IN_STORE_ONLY(AlternateName alternateName) {
	...
	public IN_STORE_ONLY(Description description) {
	...
	public IN_STORE_ONLY(DisambiguatingDescription disambiguatingDescription) {
	...
	public IN_STORE_ONLY(Identifier identifier) {
	...
	public IN_STORE_ONLY(Image image) {
		setImage(image);
	}
	...
	public IN_STORE_ONLY(MainEntityOfPage mainEntityOfPage) {
	...
	public IN_STORE_ONLY(Name name) {
		setName(name);
	}
	...
	public IN_STORE_ONLY(NameFuzzy nameFuzzy) {
	...
	public IN_STORE_ONLY(NameRuby nameRuby) {
	...
	public IN_STORE_ONLY(PotentialAction potentialAction) {
	...
	public IN_STORE_ONLY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public IN_STORE_ONLY(SubjectOf subjectOf) {
	...
	public IN_STORE_ONLY(SupersededBy supersededBy) {
	...
	public void copy(ItemAvailability.InStoreOnly org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return ItemAvailability.InStoreOnly.class.getAnnotation(SampleValue.class).value();
	}
