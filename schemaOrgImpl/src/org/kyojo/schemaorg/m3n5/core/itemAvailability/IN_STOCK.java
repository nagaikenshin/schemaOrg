...
public class IN_STOCK implements ItemAvailability.InStock {
	...
	public IN_STOCK(Long seq) {
		setSeq(seq);
	}

	public IN_STOCK(String string) {
	...
	public IN_STOCK(AdditionalType additionalType) {
	...
	public IN_STOCK(AlternateName alternateName) {
	...
	public IN_STOCK(Description description) {
	...
	public IN_STOCK(DisambiguatingDescription disambiguatingDescription) {
	...
	public IN_STOCK(Identifier identifier) {
	...
	public IN_STOCK(MainEntityOfPage mainEntityOfPage) {
	...
	public IN_STOCK(NameFuzzy nameFuzzy) {
	...
	public IN_STOCK(NameRuby nameRuby) {
	...
	public IN_STOCK(PotentialAction potentialAction) {
	...
	public IN_STOCK(SubjectOf subjectOf) {
	...
	public IN_STOCK(SupersededBy supersededBy) {
	...
	public void copy(ItemAvailability.InStock org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return ItemAvailability.InStock.class.getAnnotation(SampleValue.class).value();
	}
