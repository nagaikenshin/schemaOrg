...
public class ONLINE_ONLY implements ItemAvailability.OnlineOnly {
	...
	public ONLINE_ONLY(Long seq) {
		setSeq(seq);
	}

	public ONLINE_ONLY(String string) {
	...
	public ONLINE_ONLY(AdditionalType additionalType) {
	...
	public ONLINE_ONLY(AlternateName alternateName) {
	...
	public ONLINE_ONLY(Description description) {
	...
	public ONLINE_ONLY(DisambiguatingDescription disambiguatingDescription) {
	...
	public ONLINE_ONLY(Identifier identifier) {
	...
	public ONLINE_ONLY(Image image) {
		setImage(image);
	}
	...
	public ONLINE_ONLY(MainEntityOfPage mainEntityOfPage) {
	...
	public ONLINE_ONLY(NameFuzzy nameFuzzy) {
	...
	public ONLINE_ONLY(NameRuby nameRuby) {
	...
	public ONLINE_ONLY(PotentialAction potentialAction) {
	...
	public ONLINE_ONLY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ONLINE_ONLY(SubjectOf subjectOf) {
	...
	public ONLINE_ONLY(SupersededBy supersededBy) {
	...
	public void copy(ItemAvailability.OnlineOnly org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return ItemAvailability.OnlineOnly.class.getAnnotation(SampleValue.class).value();
	}
