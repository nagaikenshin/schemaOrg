...
public class RSVP_RESPONSE_YES implements RsvpResponseType.RsvpResponseYes {
	...
	public RSVP_RESPONSE_YES() {
	}

	public RSVP_RESPONSE_YES(Long seq) {
		setSeq(seq);
	}

	public RSVP_RESPONSE_YES(String string) {
	...
	public RSVP_RESPONSE_YES(AdditionalType additionalType) {
	...
	public RSVP_RESPONSE_YES(AlternateName alternateName) {
	...
	public RSVP_RESPONSE_YES(Description description) {
	...
	public RSVP_RESPONSE_YES(DisambiguatingDescription disambiguatingDescription) {
	...
	public RSVP_RESPONSE_YES(Identifier identifier) {
	...
	public RSVP_RESPONSE_YES(Image image) {
		setImage(image);
	}
	...
	public RSVP_RESPONSE_YES(MainEntityOfPage mainEntityOfPage) {
	...
	public RSVP_RESPONSE_YES(Name name) {
		setName(name);
	}
	...
	public RSVP_RESPONSE_YES(NameFuzzy nameFuzzy) {
	...
	public RSVP_RESPONSE_YES(NameRuby nameRuby) {
	...
	public RSVP_RESPONSE_YES(PotentialAction potentialAction) {
	...
	public RSVP_RESPONSE_YES(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RSVP_RESPONSE_YES(SubjectOf subjectOf) {
	...
	public RSVP_RESPONSE_YES(SupersededBy supersededBy) {
	...
	public RSVP_RESPONSE_YES(Url url) {
		setUrl(url);
	}
	...
	public void copy(RsvpResponseType.RsvpResponseYes org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return RsvpResponseType.RsvpResponseYes.class.getAnnotation(SampleValue.class).value();
	}
