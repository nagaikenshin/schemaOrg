...
public class DIGITAL_FORMAT implements MusicReleaseFormatType.DigitalFormat {
	...
	public DIGITAL_FORMAT() {
	}

	public DIGITAL_FORMAT(Long seq) {
		setSeq(seq);
	}

	public DIGITAL_FORMAT(String string) {
	...
	public DIGITAL_FORMAT(AdditionalType additionalType) {
	...
	public DIGITAL_FORMAT(AlternateName alternateName) {
	...
	public DIGITAL_FORMAT(Description description) {
	...
	public DIGITAL_FORMAT(DisambiguatingDescription disambiguatingDescription) {
	...
	public DIGITAL_FORMAT(Identifier identifier) {
	...
	public DIGITAL_FORMAT(Image image) {
		setImage(image);
	}
	...
	public DIGITAL_FORMAT(MainEntityOfPage mainEntityOfPage) {
	...
	public DIGITAL_FORMAT(Name name) {
		setName(name);
	}
	...
	public DIGITAL_FORMAT(NameFuzzy nameFuzzy) {
	...
	public DIGITAL_FORMAT(NameRuby nameRuby) {
	...
	public DIGITAL_FORMAT(PotentialAction potentialAction) {
	...
	public DIGITAL_FORMAT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DIGITAL_FORMAT(SubjectOf subjectOf) {
	...
	public DIGITAL_FORMAT(SupersededBy supersededBy) {
	...
	public void copy(MusicReleaseFormatType.DigitalFormat org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MusicReleaseFormatType.DigitalFormat.class.getAnnotation(SampleValue.class).value();
	}
