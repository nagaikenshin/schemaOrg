...
public class ONLINE implements GameServerStatus.Online {
	...
	public ONLINE(Long seq) {
		setSeq(seq);
	}

	public ONLINE(String string) {
	...
	public ONLINE(AdditionalType additionalType) {
	...
	public ONLINE(AlternateName alternateName) {
	...
	public ONLINE(Description description) {
	...
	public ONLINE(DisambiguatingDescription disambiguatingDescription) {
	...
	public ONLINE(Identifier identifier) {
	...
	public ONLINE(MainEntityOfPage mainEntityOfPage) {
	...
	public ONLINE(NameFuzzy nameFuzzy) {
	...
	public ONLINE(NameRuby nameRuby) {
	...
	public ONLINE(PotentialAction potentialAction) {
	...
	public ONLINE(SubjectOf subjectOf) {
	...
	public ONLINE(SupersededBy supersededBy) {
	...
	public void copy(GameServerStatus.Online org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return GameServerStatus.Online.class.getAnnotation(SampleValue.class).value();
	}
