...
public class ONLINE_FULL implements GameServerStatus.OnlineFull {
	...
	public ONLINE_FULL(Long seq) {
		setSeq(seq);
	}

	public ONLINE_FULL(String string) {
	...
	public ONLINE_FULL(AdditionalType additionalType) {
	...
	public ONLINE_FULL(AlternateName alternateName) {
	...
	public ONLINE_FULL(Description description) {
	...
	public ONLINE_FULL(DisambiguatingDescription disambiguatingDescription) {
	...
	public ONLINE_FULL(Identifier identifier) {
	...
	public ONLINE_FULL(Image image) {
		setImage(image);
	}
	...
	public ONLINE_FULL(MainEntityOfPage mainEntityOfPage) {
	...
	public ONLINE_FULL(NameFuzzy nameFuzzy) {
	...
	public ONLINE_FULL(NameRuby nameRuby) {
	...
	public ONLINE_FULL(PotentialAction potentialAction) {
	...
	public ONLINE_FULL(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ONLINE_FULL(SubjectOf subjectOf) {
	...
	public ONLINE_FULL(SupersededBy supersededBy) {
	...
	public void copy(GameServerStatus.OnlineFull org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return GameServerStatus.OnlineFull.class.getAnnotation(SampleValue.class).value();
	}
