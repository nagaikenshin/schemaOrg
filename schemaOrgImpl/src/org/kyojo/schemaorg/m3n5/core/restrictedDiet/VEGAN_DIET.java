...
public class VEGAN_DIET implements RestrictedDiet.VeganDiet {
	...
	public VEGAN_DIET(Long seq) {
		setSeq(seq);
	}

	public VEGAN_DIET(String string) {
	...
	public VEGAN_DIET(AdditionalType additionalType) {
	...
	public VEGAN_DIET(AlternateName alternateName) {
	...
	public VEGAN_DIET(Description description) {
	...
	public VEGAN_DIET(DisambiguatingDescription disambiguatingDescription) {
	...
	public VEGAN_DIET(Identifier identifier) {
	...
	public VEGAN_DIET(MainEntityOfPage mainEntityOfPage) {
	...
	public VEGAN_DIET(NameFuzzy nameFuzzy) {
	...
	public VEGAN_DIET(NameRuby nameRuby) {
	...
	public VEGAN_DIET(PotentialAction potentialAction) {
	...
	public VEGAN_DIET(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public VEGAN_DIET(SubjectOf subjectOf) {
	...
	public VEGAN_DIET(SupersededBy supersededBy) {
	...
	public void copy(RestrictedDiet.VeganDiet org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return RestrictedDiet.VeganDiet.class.getAnnotation(SampleValue.class).value();
	}
