...
public class HINDU_DIET implements RestrictedDiet.HinduDiet {
	...
	public HINDU_DIET(Long seq) {
		setSeq(seq);
	}

	public HINDU_DIET(String string) {
	...
	public HINDU_DIET(AdditionalType additionalType) {
	...
	public HINDU_DIET(AlternateName alternateName) {
	...
	public HINDU_DIET(Description description) {
	...
	public HINDU_DIET(DisambiguatingDescription disambiguatingDescription) {
	...
	public HINDU_DIET(Identifier identifier) {
	...
	public HINDU_DIET(MainEntityOfPage mainEntityOfPage) {
	...
	public HINDU_DIET(NameFuzzy nameFuzzy) {
	...
	public HINDU_DIET(NameRuby nameRuby) {
	...
	public HINDU_DIET(PotentialAction potentialAction) {
	...
	public HINDU_DIET(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public HINDU_DIET(SubjectOf subjectOf) {
	...
	public HINDU_DIET(SupersededBy supersededBy) {
	...
	public void copy(RestrictedDiet.HinduDiet org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return RestrictedDiet.HinduDiet.class.getAnnotation(SampleValue.class).value();
	}
