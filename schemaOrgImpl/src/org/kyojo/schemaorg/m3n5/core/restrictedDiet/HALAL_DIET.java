...
public class HALAL_DIET implements RestrictedDiet.HalalDiet {
	...
	public HALAL_DIET(Long seq) {
		setSeq(seq);
	}

	public HALAL_DIET(String string) {
	...
	public HALAL_DIET(AdditionalType additionalType) {
	...
	public HALAL_DIET(AlternateName alternateName) {
	...
	public HALAL_DIET(Description description) {
	...
	public HALAL_DIET(DisambiguatingDescription disambiguatingDescription) {
	...
	public HALAL_DIET(Identifier identifier) {
	...
	public HALAL_DIET(MainEntityOfPage mainEntityOfPage) {
	...
	public HALAL_DIET(NameFuzzy nameFuzzy) {
	...
	public HALAL_DIET(NameRuby nameRuby) {
	...
	public HALAL_DIET(PotentialAction potentialAction) {
	...
	public HALAL_DIET(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public HALAL_DIET(SubjectOf subjectOf) {
	...
	public HALAL_DIET(SupersededBy supersededBy) {
	...
	public void copy(RestrictedDiet.HalalDiet org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return RestrictedDiet.HalalDiet.class.getAnnotation(SampleValue.class).value();
	}
