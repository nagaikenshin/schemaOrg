...
public class LOW_SALT_DIET implements RestrictedDiet.LowSaltDiet {
	...
	public LOW_SALT_DIET() {
	}

	public LOW_SALT_DIET(Long seq) {
		setSeq(seq);
	}

	public LOW_SALT_DIET(String string) {
	...
	public LOW_SALT_DIET(AdditionalType additionalType) {
	...
	public LOW_SALT_DIET(AlternateName alternateName) {
	...
	public LOW_SALT_DIET(Description description) {
	...
	public LOW_SALT_DIET(DisambiguatingDescription disambiguatingDescription) {
	...
	public LOW_SALT_DIET(Identifier identifier) {
	...
	public LOW_SALT_DIET(Image image) {
		setImage(image);
	}
	...
	public LOW_SALT_DIET(MainEntityOfPage mainEntityOfPage) {
	...
	public LOW_SALT_DIET(Name name) {
		setName(name);
	}
	...
	public LOW_SALT_DIET(NameFuzzy nameFuzzy) {
	...
	public LOW_SALT_DIET(NameRuby nameRuby) {
	...
	public LOW_SALT_DIET(PotentialAction potentialAction) {
	...
	public LOW_SALT_DIET(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public LOW_SALT_DIET(SubjectOf subjectOf) {
	...
	public LOW_SALT_DIET(SupersededBy supersededBy) {
	...
	public void copy(RestrictedDiet.LowSaltDiet org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return RestrictedDiet.LowSaltDiet.class.getAnnotation(SampleValue.class).value();
	}
