...
public class KOSHER_DIET implements RestrictedDiet.KosherDiet {
	...
	public KOSHER_DIET(Long seq) {
		setSeq(seq);
	}

	public KOSHER_DIET(String string) {
	...
	public KOSHER_DIET(AdditionalType additionalType) {
	...
	public KOSHER_DIET(AlternateName alternateName) {
	...
	public KOSHER_DIET(Description description) {
	...
	public KOSHER_DIET(DisambiguatingDescription disambiguatingDescription) {
	...
	public KOSHER_DIET(Identifier identifier) {
	...
	public KOSHER_DIET(Image image) {
		setImage(image);
	}
	...
	public KOSHER_DIET(MainEntityOfPage mainEntityOfPage) {
	...
	public KOSHER_DIET(NameFuzzy nameFuzzy) {
	...
	public KOSHER_DIET(NameRuby nameRuby) {
	...
	public KOSHER_DIET(PotentialAction potentialAction) {
	...
	public KOSHER_DIET(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public KOSHER_DIET(SubjectOf subjectOf) {
	...
	public KOSHER_DIET(SupersededBy supersededBy) {
	...
	public void copy(RestrictedDiet.KosherDiet org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return RestrictedDiet.KosherDiet.class.getAnnotation(SampleValue.class).value();
	}
