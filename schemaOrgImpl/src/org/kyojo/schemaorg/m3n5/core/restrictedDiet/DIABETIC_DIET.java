...
public class DIABETIC_DIET implements RestrictedDiet.DiabeticDiet {
	...
	public DIABETIC_DIET() {
	}

	public DIABETIC_DIET(Long seq) {
		setSeq(seq);
	}

	public DIABETIC_DIET(String string) {
	...
	public DIABETIC_DIET(AdditionalType additionalType) {
	...
	public DIABETIC_DIET(AlternateName alternateName) {
	...
	public DIABETIC_DIET(Description description) {
	...
	public DIABETIC_DIET(DisambiguatingDescription disambiguatingDescription) {
	...
	public DIABETIC_DIET(Identifier identifier) {
	...
	public DIABETIC_DIET(Image image) {
		setImage(image);
	}
	...
	public DIABETIC_DIET(MainEntityOfPage mainEntityOfPage) {
	...
	public DIABETIC_DIET(Name name) {
		setName(name);
	}
	...
	public DIABETIC_DIET(NameFuzzy nameFuzzy) {
	...
	public DIABETIC_DIET(NameRuby nameRuby) {
	...
	public DIABETIC_DIET(PotentialAction potentialAction) {
	...
	public DIABETIC_DIET(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DIABETIC_DIET(SubjectOf subjectOf) {
	...
	public DIABETIC_DIET(SupersededBy supersededBy) {
	...
	public void copy(RestrictedDiet.DiabeticDiet org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return RestrictedDiet.DiabeticDiet.class.getAnnotation(SampleValue.class).value();
	}
