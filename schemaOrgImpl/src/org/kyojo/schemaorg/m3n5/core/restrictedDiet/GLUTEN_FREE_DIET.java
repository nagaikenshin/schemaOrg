package org.kyojo.schemaorg.m3n5.core.restrictedDiet;
...
import org.kyojo.schemaorg.m3n5.core.RestrictedDiet;
...
public class GLUTEN_FREE_DIET implements RestrictedDiet.GlutenFreeDiet {
	...
	public GLUTEN_FREE_DIET() {
	}

	public GLUTEN_FREE_DIET(Long seq) {
		setSeq(seq);
	}

	public GLUTEN_FREE_DIET(String string) {
	...
	public GLUTEN_FREE_DIET(AdditionalType additionalType) {
	...
	public GLUTEN_FREE_DIET(AlternateName alternateName) {
	...
	public GLUTEN_FREE_DIET(Description description) {
	...
	public GLUTEN_FREE_DIET(DisambiguatingDescription disambiguatingDescription) {
	...
	public GLUTEN_FREE_DIET(Identifier identifier) {
	...
	public GLUTEN_FREE_DIET(Image image) {
		setImage(image);
	}
	...
	public GLUTEN_FREE_DIET(MainEntityOfPage mainEntityOfPage) {
	...
	public GLUTEN_FREE_DIET(Name name) {
		setName(name);
	}
	...
	public GLUTEN_FREE_DIET(NameFuzzy nameFuzzy) {
	...
	public GLUTEN_FREE_DIET(NameRuby nameRuby) {
	...
	public GLUTEN_FREE_DIET(PotentialAction potentialAction) {
	...
	public GLUTEN_FREE_DIET(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public GLUTEN_FREE_DIET(SubjectOf subjectOf) {
	...
	public GLUTEN_FREE_DIET(SupersededBy supersededBy) {
	...
	public GLUTEN_FREE_DIET(Url url) {
		setUrl(url);
	}
	...
	public void copy(RestrictedDiet.GlutenFreeDiet org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return RestrictedDiet.GlutenFreeDiet.class.getAnnotation(SampleValue.class).value();
	}
