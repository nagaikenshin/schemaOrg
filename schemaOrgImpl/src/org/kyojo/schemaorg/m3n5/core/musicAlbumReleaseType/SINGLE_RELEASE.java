...
public class SINGLE_RELEASE implements MusicAlbumReleaseType.SingleRelease {
	...
	public SINGLE_RELEASE() {
	}

	public SINGLE_RELEASE(Long seq) {
		setSeq(seq);
	}

	public SINGLE_RELEASE(String string) {
	...
	public SINGLE_RELEASE(AdditionalType additionalType) {
	...
	public SINGLE_RELEASE(AlternateName alternateName) {
	...
	public SINGLE_RELEASE(Description description) {
	...
	public SINGLE_RELEASE(DisambiguatingDescription disambiguatingDescription) {
	...
	public SINGLE_RELEASE(Identifier identifier) {
	...
	public SINGLE_RELEASE(Image image) {
		setImage(image);
	}
	...
	public SINGLE_RELEASE(MainEntityOfPage mainEntityOfPage) {
	...
	public SINGLE_RELEASE(Name name) {
		setName(name);
	}
	...
	public SINGLE_RELEASE(NameFuzzy nameFuzzy) {
	...
	public SINGLE_RELEASE(NameRuby nameRuby) {
	...
	public SINGLE_RELEASE(PotentialAction potentialAction) {
	...
	public SINGLE_RELEASE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SINGLE_RELEASE(SubjectOf subjectOf) {
	...
	public SINGLE_RELEASE(SupersededBy supersededBy) {
	...
	public void copy(MusicAlbumReleaseType.SingleRelease org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MusicAlbumReleaseType.SingleRelease.class.getAnnotation(SampleValue.class).value();
	}
