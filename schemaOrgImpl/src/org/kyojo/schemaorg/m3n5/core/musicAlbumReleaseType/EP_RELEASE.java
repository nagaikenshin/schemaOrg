...
public class EP_RELEASE implements MusicAlbumReleaseType.EPRelease {
	...
	public EP_RELEASE(Long seq) {
		setSeq(seq);
	}

	public EP_RELEASE(String string) {
	...
	public EP_RELEASE(AdditionalType additionalType) {
	...
	public EP_RELEASE(AlternateName alternateName) {
	...
	public EP_RELEASE(Description description) {
	...
	public EP_RELEASE(DisambiguatingDescription disambiguatingDescription) {
	...
	public EP_RELEASE(Identifier identifier) {
	...
	public EP_RELEASE(MainEntityOfPage mainEntityOfPage) {
	...
	public EP_RELEASE(NameFuzzy nameFuzzy) {
	...
	public EP_RELEASE(NameRuby nameRuby) {
	...
	public EP_RELEASE(PotentialAction potentialAction) {
	...
	public EP_RELEASE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public EP_RELEASE(SubjectOf subjectOf) {
	...
	public EP_RELEASE(SupersededBy supersededBy) {
	...
	public void copy(MusicAlbumReleaseType.EPRelease org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MusicAlbumReleaseType.EPRelease.class.getAnnotation(SampleValue.class).value();
	}
