...
public class FRIDAY implements DayOfWeek.Friday {
	...
	public FRIDAY(Long seq) {
		setSeq(seq);
	}

	public FRIDAY(String string) {
	...
	public FRIDAY(AdditionalType additionalType) {
	...
	public FRIDAY(AlternateName alternateName) {
	...
	public FRIDAY(Description description) {
	...
	public FRIDAY(DisambiguatingDescription disambiguatingDescription) {
	...
	public FRIDAY(Identifier identifier) {
	...
	public FRIDAY(MainEntityOfPage mainEntityOfPage) {
	...
	public FRIDAY(NameFuzzy nameFuzzy) {
	...
	public FRIDAY(NameRuby nameRuby) {
	...
	public FRIDAY(PotentialAction potentialAction) {
	...
	public FRIDAY(SubjectOf subjectOf) {
	...
	public FRIDAY(SupersededBy supersededBy) {
	...
	public void copy(DayOfWeek.Friday org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return DayOfWeek.Friday.class.getAnnotation(SampleValue.class).value();
	}
