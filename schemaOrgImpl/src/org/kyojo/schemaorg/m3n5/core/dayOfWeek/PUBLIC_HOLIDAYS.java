package org.kyojo.schemaorg.m3n5.core.dayOfWeek;
...
import org.kyojo.schemaorg.m3n5.core.DayOfWeek;
...
public class PUBLIC_HOLIDAYS implements DayOfWeek.PublicHolidays {
	...
	public PUBLIC_HOLIDAYS(Long seq) {
		setSeq(seq);
	}

	public PUBLIC_HOLIDAYS(String string) {
	...
	public PUBLIC_HOLIDAYS(AdditionalType additionalType) {
	...
	public PUBLIC_HOLIDAYS(AlternateName alternateName) {
	...
	public PUBLIC_HOLIDAYS(Description description) {
	...
	public PUBLIC_HOLIDAYS(DisambiguatingDescription disambiguatingDescription) {
	...
	public PUBLIC_HOLIDAYS(Identifier identifier) {
	...
	public PUBLIC_HOLIDAYS(Image image) {
		setImage(image);
	}
	...
	public PUBLIC_HOLIDAYS(MainEntityOfPage mainEntityOfPage) {
	...
	public PUBLIC_HOLIDAYS(Name name) {
		setName(name);
	}
	...
	public PUBLIC_HOLIDAYS(NameFuzzy nameFuzzy) {
	...
	public PUBLIC_HOLIDAYS(NameRuby nameRuby) {
	...
	public PUBLIC_HOLIDAYS(PotentialAction potentialAction) {
	...
	public PUBLIC_HOLIDAYS(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PUBLIC_HOLIDAYS(SubjectOf subjectOf) {
	...
	public PUBLIC_HOLIDAYS(SupersededBy supersededBy) {
	...
	public PUBLIC_HOLIDAYS(Url url) {
		setUrl(url);
	}
	...
	public void copy(DayOfWeek.PublicHolidays org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return DayOfWeek.PublicHolidays.class.getAnnotation(SampleValue.class).value();
	}
