...
public class THURSDAY implements DayOfWeek.Thursday {
	...
	public THURSDAY(Long seq) {
		setSeq(seq);
	}

	public THURSDAY(String string) {
	...
	public THURSDAY(AdditionalType additionalType) {
	...
	public THURSDAY(AlternateName alternateName) {
	...
	public THURSDAY(Description description) {
	...
	public THURSDAY(DisambiguatingDescription disambiguatingDescription) {
	...
	public THURSDAY(Identifier identifier) {
	...
	public THURSDAY(MainEntityOfPage mainEntityOfPage) {
	...
	public THURSDAY(NameFuzzy nameFuzzy) {
	...
	public THURSDAY(NameRuby nameRuby) {
	...
	public THURSDAY(PotentialAction potentialAction) {
	...
	public THURSDAY(SubjectOf subjectOf) {
	...
	public THURSDAY(SupersededBy supersededBy) {
	...
	public void copy(DayOfWeek.Thursday org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return DayOfWeek.Thursday.class.getAnnotation(SampleValue.class).value();
	}
