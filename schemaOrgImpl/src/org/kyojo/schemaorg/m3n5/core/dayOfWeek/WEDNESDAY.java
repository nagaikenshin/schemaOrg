...
public class WEDNESDAY implements DayOfWeek.Wednesday {
	...
	public WEDNESDAY(Long seq) {
		setSeq(seq);
	}

	public WEDNESDAY(String string) {
	...
	public WEDNESDAY(AdditionalType additionalType) {
	...
	public WEDNESDAY(AlternateName alternateName) {
	...
	public WEDNESDAY(Description description) {
	...
	public WEDNESDAY(DisambiguatingDescription disambiguatingDescription) {
	...
	public WEDNESDAY(Identifier identifier) {
	...
	public WEDNESDAY(MainEntityOfPage mainEntityOfPage) {
	...
	public WEDNESDAY(NameFuzzy nameFuzzy) {
	...
	public WEDNESDAY(NameRuby nameRuby) {
	...
	public WEDNESDAY(PotentialAction potentialAction) {
	...
	public WEDNESDAY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public WEDNESDAY(SubjectOf subjectOf) {
	...
	public WEDNESDAY(SupersededBy supersededBy) {
	...
	public void copy(DayOfWeek.Wednesday org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return DayOfWeek.Wednesday.class.getAnnotation(SampleValue.class).value();
	}
