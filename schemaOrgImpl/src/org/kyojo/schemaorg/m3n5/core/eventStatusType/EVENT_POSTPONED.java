...
public class EVENT_POSTPONED implements EventStatusType.EventPostponed {
	...
	public EVENT_POSTPONED() {
	}

	public EVENT_POSTPONED(Long seq) {
		setSeq(seq);
	}

	public EVENT_POSTPONED(String string) {
	...
	public EVENT_POSTPONED(AdditionalType additionalType) {
	...
	public EVENT_POSTPONED(AlternateName alternateName) {
	...
	public EVENT_POSTPONED(Description description) {
	...
	public EVENT_POSTPONED(DisambiguatingDescription disambiguatingDescription) {
	...
	public EVENT_POSTPONED(Identifier identifier) {
	...
	public EVENT_POSTPONED(Image image) {
		setImage(image);
	}
	...
	public EVENT_POSTPONED(MainEntityOfPage mainEntityOfPage) {
	...
	public EVENT_POSTPONED(Name name) {
		setName(name);
	}
	...
	public EVENT_POSTPONED(NameFuzzy nameFuzzy) {
	...
	public EVENT_POSTPONED(NameRuby nameRuby) {
	...
	public EVENT_POSTPONED(PotentialAction potentialAction) {
	...
	public EVENT_POSTPONED(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public EVENT_POSTPONED(SubjectOf subjectOf) {
	...
	public EVENT_POSTPONED(SupersededBy supersededBy) {
	...
	public EVENT_POSTPONED(Url url) {
		setUrl(url);
	}
	...
	public void copy(EventStatusType.EventPostponed org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return EventStatusType.EventPostponed.class.getAnnotation(SampleValue.class).value();
	}
