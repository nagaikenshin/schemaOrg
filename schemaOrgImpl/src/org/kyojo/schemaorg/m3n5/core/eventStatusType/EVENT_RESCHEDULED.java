package org.kyojo.schemaorg.m3n5.core.eventStatusType;
...
import org.kyojo.schemaorg.m3n5.core.EventStatusType;
...
public class EVENT_RESCHEDULED implements EventStatusType.EventRescheduled {
	...
	public EVENT_RESCHEDULED() {
	}

	public EVENT_RESCHEDULED(Long seq) {
		setSeq(seq);
	}

	public EVENT_RESCHEDULED(String string) {
	...
	public EVENT_RESCHEDULED(AdditionalType additionalType) {
	...
	public EVENT_RESCHEDULED(AlternateName alternateName) {
	...
	public EVENT_RESCHEDULED(Description description) {
	...
	public EVENT_RESCHEDULED(DisambiguatingDescription disambiguatingDescription) {
	...
	public EVENT_RESCHEDULED(Identifier identifier) {
	...
	public EVENT_RESCHEDULED(Image image) {
		setImage(image);
	}
	...
	public EVENT_RESCHEDULED(MainEntityOfPage mainEntityOfPage) {
	...
	public EVENT_RESCHEDULED(Name name) {
		setName(name);
	}
	...
	public EVENT_RESCHEDULED(NameFuzzy nameFuzzy) {
	...
	public EVENT_RESCHEDULED(NameRuby nameRuby) {
	...
	public EVENT_RESCHEDULED(PotentialAction potentialAction) {
	...
	public EVENT_RESCHEDULED(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public EVENT_RESCHEDULED(SubjectOf subjectOf) {
	...
	public EVENT_RESCHEDULED(SupersededBy supersededBy) {
	...
	public EVENT_RESCHEDULED(Url url) {
		setUrl(url);
	}
	...
	public void copy(EventStatusType.EventRescheduled org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return EventStatusType.EventRescheduled.class.getAnnotation(SampleValue.class).value();
	}
