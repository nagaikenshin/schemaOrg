...
public class EVENT_SCHEDULED implements EventStatusType.EventScheduled {
	...
	public EVENT_SCHEDULED() {
	}

	public EVENT_SCHEDULED(Long seq) {
		setSeq(seq);
	}

	public EVENT_SCHEDULED(String string) {
	...
	public EVENT_SCHEDULED(AdditionalType additionalType) {
	...
	public EVENT_SCHEDULED(AlternateName alternateName) {
	...
	public EVENT_SCHEDULED(Description description) {
	...
	public EVENT_SCHEDULED(DisambiguatingDescription disambiguatingDescription) {
	...
	public EVENT_SCHEDULED(Identifier identifier) {
	...
	public EVENT_SCHEDULED(Image image) {
		setImage(image);
	}
	...
	public EVENT_SCHEDULED(MainEntityOfPage mainEntityOfPage) {
	...
	public EVENT_SCHEDULED(Name name) {
		setName(name);
	}
	...
	public EVENT_SCHEDULED(NameFuzzy nameFuzzy) {
	...
	public EVENT_SCHEDULED(NameRuby nameRuby) {
	...
	public EVENT_SCHEDULED(PotentialAction potentialAction) {
	...
	public EVENT_SCHEDULED(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public EVENT_SCHEDULED(SubjectOf subjectOf) {
	...
	public EVENT_SCHEDULED(SupersededBy supersededBy) {
	...
	public EVENT_SCHEDULED(Url url) {
		setUrl(url);
	}
	...
	public void copy(EventStatusType.EventScheduled org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return EventStatusType.EventScheduled.class.getAnnotation(SampleValue.class).value();
	}
