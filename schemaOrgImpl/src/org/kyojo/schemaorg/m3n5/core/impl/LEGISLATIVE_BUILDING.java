...
public class LEGISLATIVE_BUILDING implements Clazz.LegislativeBuilding {
	...
	public LEGISLATIVE_BUILDING(GeoContains geoContains) {
	...
	public LEGISLATIVE_BUILDING(GeoCoveredBy geoCoveredBy) {
	...
	public LEGISLATIVE_BUILDING(GeoCovers geoCovers) {
	...
	public LEGISLATIVE_BUILDING(GeoCrosses geoCrosses) {
	...
	public LEGISLATIVE_BUILDING(GeoDisjoint geoDisjoint) {
	...
	public LEGISLATIVE_BUILDING(GeoEquals geoEquals) {
	...
	public LEGISLATIVE_BUILDING(GeoIntersects geoIntersects) {
	...
	public LEGISLATIVE_BUILDING(GeoOverlaps geoOverlaps) {
	...
	public LEGISLATIVE_BUILDING(GeoTouches geoTouches) {
	...
	public LEGISLATIVE_BUILDING(GeoWithin geoWithin) {
	...
	public LEGISLATIVE_BUILDING(Slogan slogan) {
		setSlogan(slogan);
	}
