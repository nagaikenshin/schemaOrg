...
public class ELECTRICIAN implements Clazz.Electrician {
	...
	public ELECTRICIAN(GeoContains geoContains) {
	...
	public ELECTRICIAN(GeoCoveredBy geoCoveredBy) {
	...
	public ELECTRICIAN(GeoCovers geoCovers) {
	...
	public ELECTRICIAN(GeoCrosses geoCrosses) {
	...
	public ELECTRICIAN(GeoDisjoint geoDisjoint) {
	...
	public ELECTRICIAN(GeoEquals geoEquals) {
	...
	public ELECTRICIAN(GeoIntersects geoIntersects) {
	...
	public ELECTRICIAN(GeoOverlaps geoOverlaps) {
	...
	public ELECTRICIAN(GeoTouches geoTouches) {
	...
	public ELECTRICIAN(GeoWithin geoWithin) {
	...
	public ELECTRICIAN(Slogan slogan) {
		setSlogan(slogan);
	}
