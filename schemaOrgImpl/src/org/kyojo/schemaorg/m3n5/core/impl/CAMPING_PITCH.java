...
public class CAMPING_PITCH implements Clazz.CampingPitch {
	...
	public CAMPING_PITCH(GeoContains geoContains) {
	...
	public CAMPING_PITCH(GeoCoveredBy geoCoveredBy) {
	...
	public CAMPING_PITCH(GeoCovers geoCovers) {
	...
	public CAMPING_PITCH(GeoCrosses geoCrosses) {
	...
	public CAMPING_PITCH(GeoDisjoint geoDisjoint) {
	...
	public CAMPING_PITCH(GeoEquals geoEquals) {
	...
	public CAMPING_PITCH(GeoIntersects geoIntersects) {
	...
	public CAMPING_PITCH(GeoOverlaps geoOverlaps) {
	...
	public CAMPING_PITCH(GeoTouches geoTouches) {
	...
	public CAMPING_PITCH(GeoWithin geoWithin) {
	...
	public CAMPING_PITCH(Slogan slogan) {
		setSlogan(slogan);
	}
