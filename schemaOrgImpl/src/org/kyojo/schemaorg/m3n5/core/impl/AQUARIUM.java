...
public class AQUARIUM implements Clazz.Aquarium {
	...
	public AQUARIUM(GeoContains geoContains) {
	...
	public AQUARIUM(GeoCoveredBy geoCoveredBy) {
	...
	public AQUARIUM(GeoCovers geoCovers) {
	...
	public AQUARIUM(GeoCrosses geoCrosses) {
	...
	public AQUARIUM(GeoDisjoint geoDisjoint) {
	...
	public AQUARIUM(GeoEquals geoEquals) {
	...
	public AQUARIUM(GeoIntersects geoIntersects) {
	...
	public AQUARIUM(GeoOverlaps geoOverlaps) {
	...
	public AQUARIUM(GeoTouches geoTouches) {
	...
	public AQUARIUM(GeoWithin geoWithin) {
