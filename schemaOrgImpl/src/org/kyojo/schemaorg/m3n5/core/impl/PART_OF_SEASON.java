...
public class PART_OF_SEASON implements Container.PartOfSeason {
	...
	public PART_OF_SEASON(APIReference apiReference) {
	...
	public PART_OF_SEASON(AboutPage aboutPage) {
	...
	public PART_OF_SEASON(AdvertiserContentArticle advertiserContentArticle) {
	...
	public PART_OF_SEASON(AnalysisNewsArticle analysisNewsArticle) {
	...
	public PART_OF_SEASON(Answer answer) {
	...
	public PART_OF_SEASON(ArchiveComponent archiveComponent) {
	...
	public PART_OF_SEASON(Article article) {
	...
	public PART_OF_SEASON(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public PART_OF_SEASON(Atlas atlas) {
	...
	public PART_OF_SEASON(AudioObject audioObject) {
	...
	public PART_OF_SEASON(Audiobook audiobook) {
	...
	public PART_OF_SEASON(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public PART_OF_SEASON(Barcode barcode) {
	...
	public PART_OF_SEASON(Blog blog) {
	...
	public PART_OF_SEASON(BlogPosting blogPosting) {
	...
	public PART_OF_SEASON(Book book) {
	...
	public PART_OF_SEASON(BookSeries bookSeries) {
	...
	public PART_OF_SEASON(CategoryCodeSet categoryCodeSet) {
	...
	public PART_OF_SEASON(Chapter chapter) {
	...
	public PART_OF_SEASON(CheckoutPage checkoutPage) {
	...
	public PART_OF_SEASON(Claim claim) {
	...
	public PART_OF_SEASON(ClaimReview claimReview) {
	...
	public PART_OF_SEASON(Clip clip) {
	...
	public PART_OF_SEASON(Collection collection) {
	...
	public PART_OF_SEASON(CollectionPage collectionPage) {
	...
	public PART_OF_SEASON(ComicCoverArt comicCoverArt) {
	...
	public PART_OF_SEASON(ComicIssue comicIssue) {
	...
	public PART_OF_SEASON(ComicSeries comicSeries) {
	...
	public PART_OF_SEASON(ComicStory comicStory) {
	...
	public PART_OF_SEASON(Comment comment) {
	...
	public PART_OF_SEASON(CompleteDataFeed completeDataFeed) {
	...
	public PART_OF_SEASON(ContactPage contactPage) {
	...
	public PART_OF_SEASON(Conversation conversation) {
	...
	public PART_OF_SEASON(CorrectionComment correctionComment) {
	...
	public PART_OF_SEASON(Course course) {
	...
	public PART_OF_SEASON(CoverArt coverArt) {
	...
	public PART_OF_SEASON(CreativeWorkSeries creativeWorkSeries) {
	...
	public PART_OF_SEASON(CriticReview criticReview) {
	...
	public PART_OF_SEASON(DataCatalog dataCatalog) {
	...
	public PART_OF_SEASON(DataDownload dataDownload) {
	...
	public PART_OF_SEASON(DataFeed dataFeed) {
	...
	public PART_OF_SEASON(Dataset dataset) {
	...
	public PART_OF_SEASON(DefinedTermSet definedTermSet) {
	...
	public PART_OF_SEASON(Diet diet) {
	...
	public PART_OF_SEASON(DigitalDocument digitalDocument) {
	...
	public PART_OF_SEASON(DiscussionForumPosting discussionForumPosting) {
	...
	public PART_OF_SEASON(Drawing drawing) {
	...
	public PART_OF_SEASON(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public PART_OF_SEASON(EmailMessage emailMessage) {
	...
	public PART_OF_SEASON(EmployerReview employerReview) {
	...
	public PART_OF_SEASON(Episode episode) {
	...
	public PART_OF_SEASON(ExercisePlan exercisePlan) {
	...
	public PART_OF_SEASON(FAQPage faqPage) {
	...
	public PART_OF_SEASON(Game game) {
	...
	public PART_OF_SEASON(HowTo howTo) {
	...
	public PART_OF_SEASON(HowToDirection howToDirection) {
	...
	public PART_OF_SEASON(HowToSection howToSection) {
	...
	public PART_OF_SEASON(HowToStep howToStep) {
	...
	public PART_OF_SEASON(HowToTip howToTip) {
	...
	public PART_OF_SEASON(ImageGallery imageGallery) {
	...
	public PART_OF_SEASON(ImageObject imageObject) {
	...
	public PART_OF_SEASON(ItemPage itemPage) {
	...
	public PART_OF_SEASON(Legislation legislation) {
	...
	public PART_OF_SEASON(LegislationObject legislationObject) {
	...
	public PART_OF_SEASON(LiveBlogPosting liveBlogPosting) {
	...
	public PART_OF_SEASON(Manuscript manuscript) {
	...
	public PART_OF_SEASON(MediaObject mediaObject) {
	...
	public PART_OF_SEASON(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public PART_OF_SEASON(MedicalWebPage medicalWebPage) {
	...
	public PART_OF_SEASON(Menu menu) {
	...
	public PART_OF_SEASON(MenuSection menuSection) {
	...
	public PART_OF_SEASON(Message message) {
	...
	public PART_OF_SEASON(MobileApplication mobileApplication) {
	...
	public PART_OF_SEASON(Movie movie) {
	...
	public PART_OF_SEASON(MovieClip movieClip) {
	...
	public PART_OF_SEASON(MovieSeries movieSeries) {
	...
	public PART_OF_SEASON(MusicAlbum musicAlbum) {
	...
	public PART_OF_SEASON(MusicComposition musicComposition) {
	...
	public PART_OF_SEASON(MusicPlaylist musicPlaylist) {
	...
	public PART_OF_SEASON(MusicRecording musicRecording) {
	...
	public PART_OF_SEASON(MusicRelease musicRelease) {
	...
	public PART_OF_SEASON(MusicVideoObject musicVideoObject) {
	...
	public PART_OF_SEASON(NewsArticle newsArticle) {
	...
	public PART_OF_SEASON(Newspaper newspaper) {
	...
	public PART_OF_SEASON(NoteDigitalDocument noteDigitalDocument) {
	...
	public PART_OF_SEASON(OpinionNewsArticle opinionNewsArticle) {
	...
	public PART_OF_SEASON(Painting painting) {
	...
	public PART_OF_SEASON(Periodical periodical) {
	...
	public PART_OF_SEASON(Photograph photograph) {
	...
	public PART_OF_SEASON(Play play) {
	...
	public PART_OF_SEASON(Poster poster) {
	...
	public PART_OF_SEASON(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public PART_OF_SEASON(ProfilePage profilePage) {
	...
	public PART_OF_SEASON(PublicationIssue publicationIssue) {
	...
	public PART_OF_SEASON(PublicationVolume publicationVolume) {
	...
	public PART_OF_SEASON(QAPage qaPage) {
	...
	public PART_OF_SEASON(Question question) {
	...
	public PART_OF_SEASON(Quotation quotation) {
	...
	public PART_OF_SEASON(RadioClip radioClip) {
	...
	public PART_OF_SEASON(RadioEpisode radioEpisode) {
	...
	public PART_OF_SEASON(RadioSeason radioSeason) {
	...
	public PART_OF_SEASON(RadioSeries radioSeries) {
	...
	public PART_OF_SEASON(Recipe recipe) {
	...
	public PART_OF_SEASON(Report report) {
	...
	public PART_OF_SEASON(ReportageNewsArticle reportageNewsArticle) {
	...
	public PART_OF_SEASON(Review review) {
	...
	public PART_OF_SEASON(ReviewNewsArticle reviewNewsArticle) {
	...
	public PART_OF_SEASON(SatiricalArticle satiricalArticle) {
	...
	public PART_OF_SEASON(ScholarlyArticle scholarlyArticle) {
	...
	public PART_OF_SEASON(Sculpture sculpture) {
	...
	public PART_OF_SEASON(SearchResultsPage searchResultsPage) {
	...
	public PART_OF_SEASON(SheetMusic sheetMusic) {
	...
	public PART_OF_SEASON(ShortStory shortStory) {
	...
	public PART_OF_SEASON(SiteNavigationElement siteNavigationElement) {
	...
	public PART_OF_SEASON(SocialMediaPosting socialMediaPosting) {
	...
	public PART_OF_SEASON(SoftwareApplication softwareApplication) {
	...
	public PART_OF_SEASON(SoftwareSourceCode softwareSourceCode) {
	...
	public PART_OF_SEASON(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public PART_OF_SEASON(TVClip tvClip) {
	...
	public PART_OF_SEASON(TVEpisode tvEpisode) {
	...
	public PART_OF_SEASON(TVSeason tvSeason) {
	...
	public PART_OF_SEASON(TVSeries tvSeries) {
	...
	public PART_OF_SEASON(Table table) {
	...
	public PART_OF_SEASON(TechArticle techArticle) {
	...
	public PART_OF_SEASON(TextDigitalDocument textDigitalDocument) {
	...
	public PART_OF_SEASON(Thesis thesis) {
	...
	public PART_OF_SEASON(ThreeDimensionalModel threeDimensionalModel) {
	...
	public PART_OF_SEASON(UserReview userReview) {
	...
	public PART_OF_SEASON(VideoGallery videoGallery) {
	...
	public PART_OF_SEASON(VideoGame videoGame) {
	...
	public PART_OF_SEASON(VideoGameClip videoGameClip) {
	...
	public PART_OF_SEASON(VideoGameSeries videoGameSeries) {
	...
	public PART_OF_SEASON(VideoObject videoObject) {
	...
	public PART_OF_SEASON(VisualArtwork visualArtwork) {
	...
	public PART_OF_SEASON(WPAdBlock wpAdBlock) {
	...
	public PART_OF_SEASON(WPFooter wpFooter) {
	...
	public PART_OF_SEASON(WPHeader wpHeader) {
	...
	public PART_OF_SEASON(WPSideBar wpSideBar) {
	...
	public PART_OF_SEASON(WebApplication webApplication) {
	...
	public PART_OF_SEASON(WebPage webPage) {
	...
	public PART_OF_SEASON(WebPageElement webPageElement) {
	...
	public PART_OF_SEASON(WebSite webSite) {
