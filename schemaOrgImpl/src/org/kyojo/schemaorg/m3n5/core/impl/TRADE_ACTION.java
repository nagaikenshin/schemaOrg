...
public class TRADE_ACTION implements Clazz.TradeAction {
	...
	public TRADE_ACTION(Long seq) {
		setSeq(seq);
	}

	public TRADE_ACTION(String string) {
	...
	public TRADE_ACTION(ActionStatus actionStatus) {
	...
	public TRADE_ACTION(AdditionalType additionalType) {
	...
	public TRADE_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public TRADE_ACTION(AlternateName alternateName) {
	...
	public TRADE_ACTION(Description description) {
	...
	public TRADE_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public TRADE_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public TRADE_ACTION(Error error) {
		setError(error);
	}
	...
	public TRADE_ACTION(Identifier identifier) {
	...
	public TRADE_ACTION(Image image) {
		setImage(image);
	}
	...
	public TRADE_ACTION(Instrument instrument) {
	...
	public TRADE_ACTION(Location location) {
	...
	public TRADE_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public TRADE_ACTION(NameFuzzy nameFuzzy) {
	...
	public TRADE_ACTION(NameRuby nameRuby) {
	...
	public TRADE_ACTION(Object object) {
		setObject(object);
	}
	...
	public TRADE_ACTION(Participant participant) {
	...
	public TRADE_ACTION(PotentialAction potentialAction) {
	...
	public TRADE_ACTION(Price price) {
		setPrice(price);
	}
	...
	public TRADE_ACTION(PriceCurrency priceCurrency) {
	...
	public TRADE_ACTION(PriceSpecification priceSpecification) {
	...
	public TRADE_ACTION(Result result) {
		setResult(result);
	}
	...
	public TRADE_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TRADE_ACTION(StartTime startTime) {
	...
	public TRADE_ACTION(SubjectOf subjectOf) {
	...
	public TRADE_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.TradeAction org) {
		setSeq(org.getSeq());
