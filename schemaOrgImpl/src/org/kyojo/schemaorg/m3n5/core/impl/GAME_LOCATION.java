...
public class GAME_LOCATION implements Container.GameLocation {
	...
	public GAME_LOCATION(Accommodation accommodation) {
	...
	public GAME_LOCATION(AccountingService accountingService) {
	...
	public GAME_LOCATION(AdministrativeArea administrativeArea) {
	...
	public GAME_LOCATION(AdultEntertainment adultEntertainment) {
	...
	public GAME_LOCATION(Airport airport) {
	...
	public GAME_LOCATION(AmusementPark amusementPark) {
	...
	public GAME_LOCATION(AnimalShelter animalShelter) {
	...
	public GAME_LOCATION(Apartment apartment) {
	...
	public GAME_LOCATION(ApartmentComplex apartmentComplex) {
	...
	public GAME_LOCATION(Aquarium aquarium) {
	...
	public GAME_LOCATION(ArchiveOrganization archiveOrganization) {
	...
	public GAME_LOCATION(ArtGallery artGallery) {
	...
	public GAME_LOCATION(Attorney attorney) {
	...
	public GAME_LOCATION(AutoBodyShop autoBodyShop) {
	...
	public GAME_LOCATION(AutoDealer autoDealer) {
	...
	public GAME_LOCATION(AutoPartsStore autoPartsStore) {
	...
	public GAME_LOCATION(AutoRental autoRental) {
	...
	public GAME_LOCATION(AutoRepair autoRepair) {
	...
	public GAME_LOCATION(AutoWash autoWash) {
	...
	public GAME_LOCATION(AutomatedTeller automatedTeller) {
	...
	public GAME_LOCATION(AutomotiveBusiness automotiveBusiness) {
	...
	public GAME_LOCATION(Bakery bakery) {
	...
	public GAME_LOCATION(BankOrCreditUnion bankOrCreditUnion) {
	...
	public GAME_LOCATION(BarOrPub barOrPub) {
	...
	public GAME_LOCATION(Beach beach) {
	...
	public GAME_LOCATION(BeautySalon beautySalon) {
	...
	public GAME_LOCATION(BedAndBreakfast bedAndBreakfast) {
	...
	public GAME_LOCATION(BikeStore bikeStore) {
	...
	public GAME_LOCATION(BodyOfWater bodyOfWater) {
	...
	public GAME_LOCATION(BookStore bookStore) {
	...
	public GAME_LOCATION(BowlingAlley bowlingAlley) {
	...
	public GAME_LOCATION(Brewery brewery) {
	...
	public GAME_LOCATION(Bridge bridge) {
	...
	public GAME_LOCATION(BuddhistTemple buddhistTemple) {
	...
	public GAME_LOCATION(BusStation busStation) {
	...
	public GAME_LOCATION(BusStop busStop) {
	...
	public GAME_LOCATION(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public GAME_LOCATION(Campground campground) {
	...
	public GAME_LOCATION(CampingPitch campingPitch) {
	...
	public GAME_LOCATION(Canal canal) {
	...
	public GAME_LOCATION(Casino casino) {
	...
	public GAME_LOCATION(CatholicChurch catholicChurch) {
	...
	public GAME_LOCATION(Cemetery cemetery) {
	...
	public GAME_LOCATION(ChildCare childCare) {
	...
	public GAME_LOCATION(Church church) {
	...
	public GAME_LOCATION(City city) {
	...
	public GAME_LOCATION(CityHall cityHall) {
	...
	public GAME_LOCATION(CivicStructure civicStructure) {
	...
	public GAME_LOCATION(ClothingStore clothingStore) {
	...
	public GAME_LOCATION(ComedyClub comedyClub) {
	...
	public GAME_LOCATION(CommunityHealth communityHealth) {
	...
	public GAME_LOCATION(ComputerStore computerStore) {
	...
	public GAME_LOCATION(Continent continent) {
	...
	public GAME_LOCATION(ConvenienceStore convenienceStore) {
	...
	public GAME_LOCATION(Country country) {
	...
	public GAME_LOCATION(Courthouse courthouse) {
	...
	public GAME_LOCATION(Crematorium crematorium) {
	...
	public GAME_LOCATION(DaySpa daySpa) {
	...
	public GAME_LOCATION(DefenceEstablishment defenceEstablishment) {
	...
	public GAME_LOCATION(Dentist dentist) {
	...
	public GAME_LOCATION(DepartmentStore departmentStore) {
	...
	public GAME_LOCATION(Dermatology dermatology) {
	...
	public GAME_LOCATION(DietNutrition dietNutrition) {
	...
	public GAME_LOCATION(Distillery distillery) {
	...
	public GAME_LOCATION(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public GAME_LOCATION(Electrician electrician) {
	...
	public GAME_LOCATION(ElectronicsStore electronicsStore) {
	...
	public GAME_LOCATION(Embassy embassy) {
	...
	public GAME_LOCATION(Emergency emergency) {
	...
	public GAME_LOCATION(EmergencyService emergencyService) {
	...
	public GAME_LOCATION(EmploymentAgency employmentAgency) {
	...
	public GAME_LOCATION(EntertainmentBusiness entertainmentBusiness) {
	...
	public GAME_LOCATION(EventVenue eventVenue) {
	...
	public GAME_LOCATION(ExerciseGym exerciseGym) {
	...
	public GAME_LOCATION(FastFoodRestaurant fastFoodRestaurant) {
	...
	public GAME_LOCATION(FinancialService financialService) {
	...
	public GAME_LOCATION(FireStation fireStation) {
	...
	public GAME_LOCATION(Florist florist) {
	...
	public GAME_LOCATION(FoodEstablishment foodEstablishment) {
	...
	public GAME_LOCATION(FurnitureStore furnitureStore) {
	...
	public GAME_LOCATION(GardenStore gardenStore) {
	...
	public GAME_LOCATION(GasStation gasStation) {
	...
	public GAME_LOCATION(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public GAME_LOCATION(GeneralContractor generalContractor) {
	...
	public GAME_LOCATION(Geriatric geriatric) {
	...
	public GAME_LOCATION(GolfCourse golfCourse) {
	...
	public GAME_LOCATION(GovernmentBuilding governmentBuilding) {
	...
	public GAME_LOCATION(GovernmentOffice governmentOffice) {
	...
	public GAME_LOCATION(GroceryStore groceryStore) {
	...
	public GAME_LOCATION(Gynecologic gynecologic) {
	...
	public GAME_LOCATION(HVACBusiness hvacBusiness) {
	...
	public GAME_LOCATION(HairSalon hairSalon) {
	...
	public GAME_LOCATION(HardwareStore hardwareStore) {
	...
	public GAME_LOCATION(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public GAME_LOCATION(HealthClub healthClub) {
	...
	public GAME_LOCATION(HinduTemple hinduTemple) {
	...
	public GAME_LOCATION(HobbyShop hobbyShop) {
	...
	public GAME_LOCATION(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public GAME_LOCATION(HomeGoodsStore homeGoodsStore) {
	...
	public GAME_LOCATION(Hospital hospital) {
	...
	public GAME_LOCATION(Hostel hostel) {
	...
	public GAME_LOCATION(Hotel hotel) {
	...
	public GAME_LOCATION(HotelRoom hotelRoom) {
	...
	public GAME_LOCATION(House house) {
	...
	public GAME_LOCATION(HousePainter housePainter) {
	...
	public GAME_LOCATION(IceCreamShop iceCreamShop) {
	...
	public GAME_LOCATION(InsuranceAgency insuranceAgency) {
	...
	public GAME_LOCATION(InternetCafe internetCafe) {
	...
	public GAME_LOCATION(JewelryStore jewelryStore) {
	...
	public GAME_LOCATION(LakeBodyOfWater lakeBodyOfWater) {
	...
	public GAME_LOCATION(Landform landform) {
	...
	public GAME_LOCATION(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public GAME_LOCATION(LegalService legalService) {
	...
	public GAME_LOCATION(LegislativeBuilding legislativeBuilding) {
	...
	public GAME_LOCATION(Library library) {
	...
	public GAME_LOCATION(LiquorStore liquorStore) {
	...
	public GAME_LOCATION(LocalBusiness localBusiness) {
	...
	public GAME_LOCATION(Locksmith locksmith) {
	...
	public GAME_LOCATION(LodgingBusiness lodgingBusiness) {
	...
	public GAME_LOCATION(MedicalBusiness medicalBusiness) {
	...
	public GAME_LOCATION(MedicalClinic medicalClinic) {
	...
	public GAME_LOCATION(MeetingRoom meetingRoom) {
	...
	public GAME_LOCATION(MensClothingStore mensClothingStore) {
	...
	public GAME_LOCATION(Midwifery midwifery) {
	...
	public GAME_LOCATION(MobilePhoneStore mobilePhoneStore) {
	...
	public GAME_LOCATION(Mosque mosque) {
	...
	public GAME_LOCATION(Motel motel) {
	...
	public GAME_LOCATION(MotorcycleDealer motorcycleDealer) {
	...
	public GAME_LOCATION(MotorcycleRepair motorcycleRepair) {
	...
	public GAME_LOCATION(Mountain mountain) {
	...
	public GAME_LOCATION(MovieRentalStore movieRentalStore) {
	...
	public GAME_LOCATION(MovieTheater movieTheater) {
	...
	public GAME_LOCATION(MovingCompany movingCompany) {
	...
	public GAME_LOCATION(Museum museum) {
	...
	public GAME_LOCATION(MusicStore musicStore) {
	...
	public GAME_LOCATION(MusicVenue musicVenue) {
	...
	public GAME_LOCATION(NailSalon nailSalon) {
	...
	public GAME_LOCATION(NightClub nightClub) {
	...
	public GAME_LOCATION(Notary notary) {
	...
	public GAME_LOCATION(Nursing nursing) {
	...
	public GAME_LOCATION(Obstetric obstetric) {
	...
	public GAME_LOCATION(OceanBodyOfWater oceanBodyOfWater) {
	...
	public GAME_LOCATION(OfficeEquipmentStore officeEquipmentStore) {
	...
	public GAME_LOCATION(Oncologic oncologic) {
	...
	public GAME_LOCATION(Optician optician) {
	...
	public GAME_LOCATION(Optometric optometric) {
	...
	public GAME_LOCATION(Otolaryngologic otolaryngologic) {
	...
	public GAME_LOCATION(OutletStore outletStore) {
	...
	public GAME_LOCATION(Park park) {
	...
	public GAME_LOCATION(ParkingFacility parkingFacility) {
	...
	public GAME_LOCATION(PawnShop pawnShop) {
	...
	public GAME_LOCATION(Pediatric pediatric) {
	...
	public GAME_LOCATION(PerformingArtsTheater performingArtsTheater) {
	...
	public GAME_LOCATION(PetStore petStore) {
	...
	public GAME_LOCATION(Pharmacy pharmacy) {
	...
	public GAME_LOCATION(Physician physician) {
	...
	public GAME_LOCATION(Physiotherapy physiotherapy) {
	...
	public GAME_LOCATION(PlaceOfWorship placeOfWorship) {
	...
	public GAME_LOCATION(PlasticSurgery plasticSurgery) {
	...
	public GAME_LOCATION(Playground playground) {
	...
	public GAME_LOCATION(Plumber plumber) {
	...
	public GAME_LOCATION(Podiatric podiatric) {
	...
	public GAME_LOCATION(PoliceStation policeStation) {
	...
	public GAME_LOCATION(Pond pond) {
	...
	public GAME_LOCATION(PostOffice postOffice) {
	...
	public GAME_LOCATION(PrimaryCare primaryCare) {
	...
	public GAME_LOCATION(ProfessionalService professionalService) {
	...
	public GAME_LOCATION(Psychiatric psychiatric) {
	...
	public GAME_LOCATION(PublicHealth publicHealth) {
	...
	public GAME_LOCATION(PublicSwimmingPool publicSwimmingPool) {
	...
	public GAME_LOCATION(PublicToilet publicToilet) {
	...
	public GAME_LOCATION(RVPark rvPark) {
	...
	public GAME_LOCATION(RadioStation radioStation) {
	...
	public GAME_LOCATION(RealEstateAgent realEstateAgent) {
	...
	public GAME_LOCATION(RecyclingCenter recyclingCenter) {
	...
	public GAME_LOCATION(Reservoir reservoir) {
	...
	public GAME_LOCATION(Residence residence) {
	...
	public GAME_LOCATION(Resort resort) {
	...
	public GAME_LOCATION(Restaurant restaurant) {
	...
	public GAME_LOCATION(RiverBodyOfWater riverBodyOfWater) {
	...
	public GAME_LOCATION(RoofingContractor roofingContractor) {
	...
	public GAME_LOCATION(Room room) {
	...
	public GAME_LOCATION(SeaBodyOfWater seaBodyOfWater) {
	...
	public GAME_LOCATION(SelfStorage selfStorage) {
	...
	public GAME_LOCATION(ShoeStore shoeStore) {
	...
	public GAME_LOCATION(ShoppingCenter shoppingCenter) {
	...
	public GAME_LOCATION(SingleFamilyResidence singleFamilyResidence) {
	...
	public GAME_LOCATION(SkiResort skiResort) {
	...
	public GAME_LOCATION(SportingGoodsStore sportingGoodsStore) {
	...
	public GAME_LOCATION(SportsActivityLocation sportsActivityLocation) {
	...
	public GAME_LOCATION(SportsClub sportsClub) {
	...
	public GAME_LOCATION(StadiumOrArena stadiumOrArena) {
	...
	public GAME_LOCATION(State state) {
	...
	public GAME_LOCATION(Store store) {
	...
	public GAME_LOCATION(SubwayStation subwayStation) {
	...
	public GAME_LOCATION(Suite suite) {
	...
	public GAME_LOCATION(Synagogue synagogue) {
	...
	public GAME_LOCATION(TattooParlor tattooParlor) {
	...
	public GAME_LOCATION(TaxiStand taxiStand) {
	...
	public GAME_LOCATION(TelevisionStation televisionStation) {
	...
	public GAME_LOCATION(TennisComplex tennisComplex) {
	...
	public GAME_LOCATION(TireShop tireShop) {
	...
	public GAME_LOCATION(TouristAttraction touristAttraction) {
	...
	public GAME_LOCATION(TouristDestination touristDestination) {
	...
	public GAME_LOCATION(TouristInformationCenter touristInformationCenter) {
	...
	public GAME_LOCATION(ToyStore toyStore) {
	...
	public GAME_LOCATION(TrainStation trainStation) {
	...
	public GAME_LOCATION(TravelAgency travelAgency) {
	...
	public GAME_LOCATION(Volcano volcano) {
	...
	public GAME_LOCATION(Waterfall waterfall) {
	...
	public GAME_LOCATION(WholesaleStore wholesaleStore) {
	...
	public GAME_LOCATION(Winery winery) {
