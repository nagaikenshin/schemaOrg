...
import org.kyojo.schemaorg.m3n5.core.Container.Loser;
...
public class WIN_ACTION implements Clazz.WinAction {
	...
	public WIN_ACTION(Long seq) {
		setSeq(seq);
	}

	public WIN_ACTION(String string) {
	...
	public WIN_ACTION(ActionStatus actionStatus) {
	...
	public WIN_ACTION(AdditionalType additionalType) {
	...
	public WIN_ACTION(AlternateName alternateName) {
	...
	public WIN_ACTION(Description description) {
	...
	public WIN_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public WIN_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public WIN_ACTION(Identifier identifier) {
	...
	public WIN_ACTION(Instrument instrument) {
	...
	public WIN_ACTION(Location location) {
	...
	public WIN_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public WIN_ACTION(NameFuzzy nameFuzzy) {
	...
	public WIN_ACTION(NameRuby nameRuby) {
	...
	public WIN_ACTION(Object object) {
		setObject(object);
	}
	...
	public WIN_ACTION(Participant participant) {
	...
	public WIN_ACTION(PotentialAction potentialAction) {
	...
	public WIN_ACTION(Result result) {
		setResult(result);
	}
	...
	public WIN_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public WIN_ACTION(StartTime startTime) {
	...
	public WIN_ACTION(SubjectOf subjectOf) {
	...
	public WIN_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.WinAction org) {
		setSeq(org.getSeq());
