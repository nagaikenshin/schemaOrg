...
public class GOVERNMENT_ORGANIZATION implements Clazz.GovernmentOrganization {
	...
	public GOVERNMENT_ORGANIZATION() {
	}

	public GOVERNMENT_ORGANIZATION(Long seq) {
		setSeq(seq);
	}

	public GOVERNMENT_ORGANIZATION(String string) {
	...
	public GOVERNMENT_ORGANIZATION(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public GOVERNMENT_ORGANIZATION(AdditionalType additionalType) {
	...
	public GOVERNMENT_ORGANIZATION(Address address) {
		setAddress(address);
	}
	...
	public GOVERNMENT_ORGANIZATION(AggregateRating aggregateRating) {
	...
	public GOVERNMENT_ORGANIZATION(AlternateName alternateName) {
	...
	public GOVERNMENT_ORGANIZATION(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public GOVERNMENT_ORGANIZATION(AreaServed areaServed) {
	...
	public GOVERNMENT_ORGANIZATION(Award award) {
		setAward(award);
	}
	...
	public GOVERNMENT_ORGANIZATION(Brand brand) {
		setBrand(brand);
	}
	...
	public GOVERNMENT_ORGANIZATION(ContactPoint contactPoint) {
	...
	public GOVERNMENT_ORGANIZATION(CorrectionsPolicy correctionsPolicy) {
	...
	public GOVERNMENT_ORGANIZATION(Department department) {
	...
	public GOVERNMENT_ORGANIZATION(Description description) {
	...
	public GOVERNMENT_ORGANIZATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public GOVERNMENT_ORGANIZATION(DissolutionDate dissolutionDate) {
	...
	public GOVERNMENT_ORGANIZATION(DiversityPolicy diversityPolicy) {
	...
	public GOVERNMENT_ORGANIZATION(DiversityStaffingReport diversityStaffingReport) {
	...
	public GOVERNMENT_ORGANIZATION(Duns duns) {
		setDuns(duns);
	}
	...
	public GOVERNMENT_ORGANIZATION(Email email) {
		setEmail(email);
	}
	...
	public GOVERNMENT_ORGANIZATION(Employee employee) {
	...
	public GOVERNMENT_ORGANIZATION(EthicsPolicy ethicsPolicy) {
	...
	public GOVERNMENT_ORGANIZATION(Event event) {
		setEvent(event);
	}
	...
	public GOVERNMENT_ORGANIZATION(FaxNumber faxNumber) {
	...
	public GOVERNMENT_ORGANIZATION(Founder founder) {
		setFounder(founder);
	}
	...
	public GOVERNMENT_ORGANIZATION(FoundingDate foundingDate) {
	...
	public GOVERNMENT_ORGANIZATION(FoundingLocation foundingLocation) {
	...
	public GOVERNMENT_ORGANIZATION(Funder funder) {
		setFunder(funder);
	}
	...
	public GOVERNMENT_ORGANIZATION(GlobalLocationNumber globalLocationNumber) {
	...
	public GOVERNMENT_ORGANIZATION(HasOfferCatalog hasOfferCatalog) {
	...
	public GOVERNMENT_ORGANIZATION(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public GOVERNMENT_ORGANIZATION(Identifier identifier) {
	...
	public GOVERNMENT_ORGANIZATION(Image image) {
		setImage(image);
	}
	...
	public GOVERNMENT_ORGANIZATION(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public GOVERNMENT_ORGANIZATION(KnowsAbout knowsAbout) {
	...
	public GOVERNMENT_ORGANIZATION(KnowsLanguage knowsLanguage) {
	...
	public GOVERNMENT_ORGANIZATION(LegalName legalName) {
	...
	public GOVERNMENT_ORGANIZATION(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public GOVERNMENT_ORGANIZATION(Location location) {
	...
	public GOVERNMENT_ORGANIZATION(Logo logo) {
		setLogo(logo);
	}
	...
	public GOVERNMENT_ORGANIZATION(MainEntityOfPage mainEntityOfPage) {
	...
	public GOVERNMENT_ORGANIZATION(MakesOffer makesOffer) {
	...
	public GOVERNMENT_ORGANIZATION(Member member) {
		setMember(member);
	}
	...
	public GOVERNMENT_ORGANIZATION(MemberOf memberOf) {
	...
	public GOVERNMENT_ORGANIZATION(Naics naics) {
		setNaics(naics);
	}
	...
	public GOVERNMENT_ORGANIZATION(Name name) {
		setName(name);
	}
	...
	public GOVERNMENT_ORGANIZATION(NameFuzzy nameFuzzy) {
	...
	public GOVERNMENT_ORGANIZATION(NameRuby nameRuby) {
	...
	public GOVERNMENT_ORGANIZATION(NumberOfEmployees numberOfEmployees) {
	...
	public GOVERNMENT_ORGANIZATION(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public GOVERNMENT_ORGANIZATION(Owns owns) {
		setOwns(owns);
	}
	...
	public GOVERNMENT_ORGANIZATION(ParentOrganization parentOrganization) {
	...
	public GOVERNMENT_ORGANIZATION(PotentialAction potentialAction) {
	...
	public GOVERNMENT_ORGANIZATION(PublishingPrinciples publishingPrinciples) {
	...
	public GOVERNMENT_ORGANIZATION(Review review) {
		setReview(review);
	}
	...
	public GOVERNMENT_ORGANIZATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public GOVERNMENT_ORGANIZATION(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public GOVERNMENT_ORGANIZATION(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public GOVERNMENT_ORGANIZATION(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public GOVERNMENT_ORGANIZATION(SubOrganization subOrganization) {
	...
	public GOVERNMENT_ORGANIZATION(SubjectOf subjectOf) {
	...
	public GOVERNMENT_ORGANIZATION(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public GOVERNMENT_ORGANIZATION(Telephone telephone) {
	...
	public GOVERNMENT_ORGANIZATION(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public GOVERNMENT_ORGANIZATION(Url url) {
		setUrl(url);
	}
	...
	public GOVERNMENT_ORGANIZATION(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.GovernmentOrganization org) {
		setSeq(org.getSeq());
