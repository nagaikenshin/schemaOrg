...
public class LEND_ACTION implements Clazz.LendAction {
	...
	public LEND_ACTION(Long seq) {
		setSeq(seq);
	}

	public LEND_ACTION(String string) {
	...
	public LEND_ACTION(ActionStatus actionStatus) {
	...
	public LEND_ACTION(AdditionalType additionalType) {
	...
	public LEND_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public LEND_ACTION(AlternateName alternateName) {
	...
	public LEND_ACTION(Borrower borrower) {
	...
	public LEND_ACTION(Description description) {
	...
	public LEND_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public LEND_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public LEND_ACTION(Error error) {
		setError(error);
	}
	...
	public LEND_ACTION(FromLocation fromLocation) {
	...
	public LEND_ACTION(Identifier identifier) {
	...
	public LEND_ACTION(Image image) {
		setImage(image);
	}
	...
	public LEND_ACTION(Instrument instrument) {
	...
	public LEND_ACTION(Location location) {
	...
	public LEND_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public LEND_ACTION(NameFuzzy nameFuzzy) {
	...
	public LEND_ACTION(NameRuby nameRuby) {
	...
	public LEND_ACTION(Object object) {
		setObject(object);
	}
	...
	public LEND_ACTION(Participant participant) {
	...
	public LEND_ACTION(PotentialAction potentialAction) {
	...
	public LEND_ACTION(Result result) {
		setResult(result);
	}
	...
	public LEND_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public LEND_ACTION(StartTime startTime) {
	...
	public LEND_ACTION(SubjectOf subjectOf) {
	...
	public LEND_ACTION(Target target) {
		setTarget(target);
	}
	...
	public LEND_ACTION(ToLocation toLocation) {
	...
	public void copy(Clazz.LendAction org) {
		setSeq(org.getSeq());
