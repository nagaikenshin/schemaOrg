...
import org.kyojo.schemaorg.m3n5.core.Container.NumberOfBeds;
...
public class BED_DETAILS implements Clazz.BedDetails {
	...
	public NumberOfBeds numberOfBeds;
	public PotentialAction potentialAction;
	public SameAs sameAs;
	public SubjectOf subjectOf;
	public TypeOfBed typeOfBed;
	public Url url;

	public BED_DETAILS() {
	}

	public BED_DETAILS(Long seq) {
		setSeq(seq);
	}
	...
	public BED_DETAILS(AdditionalType additionalType) {
	...
	public BED_DETAILS(AlternateName alternateName) {
	...
	public BED_DETAILS(Description description) {
	...
	public BED_DETAILS(DisambiguatingDescription disambiguatingDescription) {
	...
	public BED_DETAILS(Identifier identifier) {
	...
	public BED_DETAILS(Image image) {
		setImage(image);
	}
	...
	public BED_DETAILS(MainEntityOfPage mainEntityOfPage) {
	...
	public BED_DETAILS(NameFuzzy nameFuzzy) {
	...
	public BED_DETAILS(NameRuby nameRuby) {
	...
	public BED_DETAILS(NumberOfBeds numberOfBeds) {
		setNumberOfBeds(numberOfBeds);
	}

	@Override
	public NumberOfBeds getNumberOfBeds() {
		return numberOfBeds;
	}

	@Override
	public void setNumberOfBeds(NumberOfBeds numberOfBeds) {
		this.numberOfBeds = numberOfBeds;
	}

	public BED_DETAILS(PotentialAction potentialAction) {
	...
	public BED_DETAILS(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public BED_DETAILS(SubjectOf subjectOf) {
	...
	public BED_DETAILS(TypeOfBed typeOfBed) {
	...
	public void copy(Clazz.BedDetails org) {
		setSeq(org.getSeq());
		...
		setNumberOfBeds(org.getNumberOfBeds());
		setPotentialAction(org.getPotentialAction());
		setSameAs(org.getSameAs());
		setSubjectOf(org.getSubjectOf());
		setTypeOfBed(org.getTypeOfBed());
		setUrl(org.getUrl());
	}
