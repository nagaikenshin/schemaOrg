...
public class SHARE_ACTION implements Clazz.ShareAction {
	...
	public SHARE_ACTION(Long seq) {
		setSeq(seq);
	}

	public SHARE_ACTION(String string) {
	...
	public SHARE_ACTION(About about) {
		setAbout(about);
	}
	...
	public SHARE_ACTION(ActionStatus actionStatus) {
	...
	public SHARE_ACTION(AdditionalType additionalType) {
	...
	public SHARE_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public SHARE_ACTION(AlternateName alternateName) {
	...
	public SHARE_ACTION(Description description) {
	...
	public SHARE_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public SHARE_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public SHARE_ACTION(Error error) {
		setError(error);
	}
	...
	public SHARE_ACTION(Identifier identifier) {
	...
	public SHARE_ACTION(Image image) {
		setImage(image);
	}
	...
	public SHARE_ACTION(InLanguage inLanguage) {
	...
	public SHARE_ACTION(Instrument instrument) {
	...
	public SHARE_ACTION(Location location) {
	...
	public SHARE_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public SHARE_ACTION(NameFuzzy nameFuzzy) {
	...
	public SHARE_ACTION(NameRuby nameRuby) {
	...
	public SHARE_ACTION(Object object) {
		setObject(object);
	}
	...
	public SHARE_ACTION(Participant participant) {
	...
	public SHARE_ACTION(PotentialAction potentialAction) {
	...
	public SHARE_ACTION(Recipient recipient) {
	...
	public SHARE_ACTION(Result result) {
		setResult(result);
	}
	...
	public SHARE_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SHARE_ACTION(StartTime startTime) {
	...
	public SHARE_ACTION(SubjectOf subjectOf) {
	...
	public SHARE_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.ShareAction org) {
		setSeq(org.getSeq());
