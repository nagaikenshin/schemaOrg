...
public class REVIEW implements Clazz.Review, Container.Review {
	...
	public REVIEW(AccessMode accessMode) {
	...
	public REVIEW(AccessModeSufficient accessModeSufficient) {
	...
	public REVIEW(AccessibilityAPI accessibilityAPI) {
	...
	public REVIEW(AccessibilityControl accessibilityControl) {
	...
	public REVIEW(AccessibilityFeature accessibilityFeature) {
	...
	public REVIEW(AccessibilityHazard accessibilityHazard) {
	...
	public REVIEW(AccessibilitySummary accessibilitySummary) {
	...
	public REVIEW(AccountablePerson accountablePerson) {
	...
	public REVIEW(AdditionalType additionalType) {
	...
	public REVIEW(AggregateRating aggregateRating) {
	...
	public REVIEW(AlternateName alternateName) {
	...
	public REVIEW(AlternativeHeadline alternativeHeadline) {
	...
	public REVIEW(AssociatedMedia associatedMedia) {
	...
	public REVIEW(Audience audience) {
	...
	public REVIEW(Character character) {
	...
	public REVIEW(Citation citation) {
	...
	public REVIEW(CommentCount commentCount) {
	...
	public REVIEW(ContentLocation contentLocation) {
	...
	public REVIEW(ContentRating contentRating) {
	...
	public REVIEW(ContentReferenceTime contentReferenceTime) {
	...
	public REVIEW(Contributor contributor) {
	...
	public REVIEW(CopyrightHolder copyrightHolder) {
	...
	public REVIEW(CopyrightYear copyrightYear) {
	...
	public REVIEW(Correction correction) {
	...
	public REVIEW(DateModified dateModified) {
	...
	public REVIEW(DatePublished datePublished) {
	...
	public REVIEW(Description description) {
	...
	public REVIEW(DisambiguatingDescription disambiguatingDescription) {
	...
	public REVIEW(DiscussionUrl discussionUrl) {
	...
	public REVIEW(EducationalAlignment educationalAlignment) {
	...
	public REVIEW(EducationalUse educationalUse) {
	...
	public REVIEW(EncodingFormat encodingFormat) {
	...
	public REVIEW(ExampleOfWork exampleOfWork) {
	...
	public REVIEW(Headline headline) {
	...
	public REVIEW(Identifier identifier) {
	...
	public REVIEW(InLanguage inLanguage) {
	...
	public REVIEW(InteractionStatistic interactionStatistic) {
	...
	public REVIEW(InteractivityType interactivityType) {
	...
	public REVIEW(IsAccessibleForFree isAccessibleForFree) {
	...
	public REVIEW(IsBasedOn isBasedOn) {
	...
	public REVIEW(IsFamilyFriendly isFamilyFriendly) {
	...
	public REVIEW(IsPartOf isPartOf) {
	...
	public REVIEW(ItemReviewed itemReviewed) {
	...
	public REVIEW(Keywords keywords) {
	...
	public REVIEW(LearningResourceType learningResourceType) {
	...
	public REVIEW(LocationCreated locationCreated) {
	...
	public REVIEW(MainEntity mainEntity) {
	...
	public REVIEW(MainEntityOfPage mainEntityOfPage) {
	...
	public REVIEW(Material material) {
	...
	public REVIEW(MaterialExtent materialExtent) {
	...
	public REVIEW(Mentions mentions) {
	...
	public REVIEW(NameFuzzy nameFuzzy) {
	...
	public REVIEW(NameRuby nameRuby) {
	...
	public REVIEW(Position position) {
	...
	public REVIEW(PotentialAction potentialAction) {
	...
	public REVIEW(Producer producer) {
	...
	public REVIEW(Provider provider) {
	...
	public REVIEW(Publication publication) {
	...
	public REVIEW(Publisher publisher) {
	...
	public REVIEW(PublisherImprint publisherImprint) {
	...
	public REVIEW(PublishingPrinciples publishingPrinciples) {
	...
	public REVIEW(RecordedAt recordedAt) {
	...
	public REVIEW(ReleasedEvent releasedEvent) {
	...
	public REVIEW(Container.Review review) {
		setReview(review);
	}
	...
	public REVIEW(Clazz.Review review) {
	...
	public REVIEW(ReviewAspect reviewAspect) {
	...
	public REVIEW(ReviewBody reviewBody) {
	...
	public REVIEW(SchemaVersion schemaVersion) {
	...
	public REVIEW(SdDatePublished sdDatePublished) {
	...
	public REVIEW(SdLicense sdLicense) {
	...
	public REVIEW(SdPublisher sdPublisher) {
	...
	public REVIEW(SourceOrganization sourceOrganization) {
	...
	public REVIEW(SpatialCoverage spatialCoverage) {
	...
	public REVIEW(SubjectOf subjectOf) {
	...
	public REVIEW(Temporal temporal) {
	...
	public REVIEW(TemporalCoverage temporalCoverage) {
	...
	public REVIEW(ThumbnailUrl thumbnailUrl) {
	...
	public REVIEW(TimeRequired timeRequired) {
	...
	public REVIEW(TranslationOfWork translationOfWork) {
	...
	public REVIEW(Translator translator) {
	...
	public REVIEW(TypicalAgeRange typicalAgeRange) {
	...
	public REVIEW(WorkExample workExample) {
	...
	public REVIEW(WorkTranslation workTranslation) {
