...
public class CONTAINS_PLACE implements Container.ContainsPlace {
	...
	public CONTAINS_PLACE(String string) {
	...
	public CONTAINS_PLACE(Accommodation accommodation) {
	...
	public CONTAINS_PLACE(AccountingService accountingService) {
	...
	public CONTAINS_PLACE(AdministrativeArea administrativeArea) {
	...
	public CONTAINS_PLACE(AdultEntertainment adultEntertainment) {
	...
	public CONTAINS_PLACE(Airport airport) {
	...
	public CONTAINS_PLACE(AmusementPark amusementPark) {
	...
	public CONTAINS_PLACE(AnimalShelter animalShelter) {
	...
	public CONTAINS_PLACE(Apartment apartment) {
	...
	public CONTAINS_PLACE(ApartmentComplex apartmentComplex) {
	...
	public CONTAINS_PLACE(Aquarium aquarium) {
	...
	public CONTAINS_PLACE(ArchiveOrganization archiveOrganization) {
	...
	public CONTAINS_PLACE(ArtGallery artGallery) {
	...
	public CONTAINS_PLACE(Attorney attorney) {
	...
	public CONTAINS_PLACE(AutoBodyShop autoBodyShop) {
	...
	public CONTAINS_PLACE(AutoDealer autoDealer) {
	...
	public CONTAINS_PLACE(AutoPartsStore autoPartsStore) {
	...
	public CONTAINS_PLACE(AutoRental autoRental) {
	...
	public CONTAINS_PLACE(AutoRepair autoRepair) {
	...
	public CONTAINS_PLACE(AutoWash autoWash) {
	...
	public CONTAINS_PLACE(AutomatedTeller automatedTeller) {
	...
	public CONTAINS_PLACE(AutomotiveBusiness automotiveBusiness) {
	...
	public CONTAINS_PLACE(Bakery bakery) {
	...
	public CONTAINS_PLACE(BankOrCreditUnion bankOrCreditUnion) {
	...
	public CONTAINS_PLACE(BarOrPub barOrPub) {
	...
	public CONTAINS_PLACE(Beach beach) {
	...
	public CONTAINS_PLACE(BeautySalon beautySalon) {
	...
	public CONTAINS_PLACE(BedAndBreakfast bedAndBreakfast) {
	...
	public CONTAINS_PLACE(BikeStore bikeStore) {
	...
	public CONTAINS_PLACE(BodyOfWater bodyOfWater) {
	...
	public CONTAINS_PLACE(BookStore bookStore) {
	...
	public CONTAINS_PLACE(BowlingAlley bowlingAlley) {
	...
	public CONTAINS_PLACE(Brewery brewery) {
	...
	public CONTAINS_PLACE(Bridge bridge) {
	...
	public CONTAINS_PLACE(BuddhistTemple buddhistTemple) {
	...
	public CONTAINS_PLACE(BusStation busStation) {
	...
	public CONTAINS_PLACE(BusStop busStop) {
	...
	public CONTAINS_PLACE(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public CONTAINS_PLACE(Campground campground) {
	...
	public CONTAINS_PLACE(CampingPitch campingPitch) {
	...
	public CONTAINS_PLACE(Canal canal) {
	...
	public CONTAINS_PLACE(Casino casino) {
	...
	public CONTAINS_PLACE(CatholicChurch catholicChurch) {
	...
	public CONTAINS_PLACE(Cemetery cemetery) {
	...
	public CONTAINS_PLACE(ChildCare childCare) {
	...
	public CONTAINS_PLACE(Church church) {
	...
	public CONTAINS_PLACE(City city) {
	...
	public CONTAINS_PLACE(CityHall cityHall) {
	...
	public CONTAINS_PLACE(CivicStructure civicStructure) {
	...
	public CONTAINS_PLACE(ClothingStore clothingStore) {
	...
	public CONTAINS_PLACE(ComedyClub comedyClub) {
	...
	public CONTAINS_PLACE(CommunityHealth communityHealth) {
	...
	public CONTAINS_PLACE(ComputerStore computerStore) {
	...
	public CONTAINS_PLACE(Continent continent) {
	...
	public CONTAINS_PLACE(ConvenienceStore convenienceStore) {
	...
	public CONTAINS_PLACE(Country country) {
	...
	public CONTAINS_PLACE(Courthouse courthouse) {
	...
	public CONTAINS_PLACE(Crematorium crematorium) {
	...
	public CONTAINS_PLACE(DaySpa daySpa) {
	...
	public CONTAINS_PLACE(DefenceEstablishment defenceEstablishment) {
	...
	public CONTAINS_PLACE(Dentist dentist) {
	...
	public CONTAINS_PLACE(DepartmentStore departmentStore) {
	...
	public CONTAINS_PLACE(Dermatology dermatology) {
	...
	public CONTAINS_PLACE(DietNutrition dietNutrition) {
	...
	public CONTAINS_PLACE(Distillery distillery) {
	...
	public CONTAINS_PLACE(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public CONTAINS_PLACE(Electrician electrician) {
	...
	public CONTAINS_PLACE(ElectronicsStore electronicsStore) {
	...
	public CONTAINS_PLACE(Embassy embassy) {
	...
	public CONTAINS_PLACE(Emergency emergency) {
	...
	public CONTAINS_PLACE(EmergencyService emergencyService) {
	...
	public CONTAINS_PLACE(EmploymentAgency employmentAgency) {
	...
	public CONTAINS_PLACE(EntertainmentBusiness entertainmentBusiness) {
	...
	public CONTAINS_PLACE(EventVenue eventVenue) {
	...
	public CONTAINS_PLACE(ExerciseGym exerciseGym) {
	...
	public CONTAINS_PLACE(FastFoodRestaurant fastFoodRestaurant) {
	...
	public CONTAINS_PLACE(FinancialService financialService) {
	...
	public CONTAINS_PLACE(FireStation fireStation) {
	...
	public CONTAINS_PLACE(Florist florist) {
	...
	public CONTAINS_PLACE(FoodEstablishment foodEstablishment) {
	...
	public CONTAINS_PLACE(FurnitureStore furnitureStore) {
	...
	public CONTAINS_PLACE(GardenStore gardenStore) {
	...
	public CONTAINS_PLACE(GasStation gasStation) {
	...
	public CONTAINS_PLACE(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public CONTAINS_PLACE(GeneralContractor generalContractor) {
	...
	public CONTAINS_PLACE(Geriatric geriatric) {
	...
	public CONTAINS_PLACE(GolfCourse golfCourse) {
	...
	public CONTAINS_PLACE(GovernmentBuilding governmentBuilding) {
	...
	public CONTAINS_PLACE(GovernmentOffice governmentOffice) {
	...
	public CONTAINS_PLACE(GroceryStore groceryStore) {
	...
	public CONTAINS_PLACE(Gynecologic gynecologic) {
	...
	public CONTAINS_PLACE(HVACBusiness hvacBusiness) {
	...
	public CONTAINS_PLACE(HairSalon hairSalon) {
	...
	public CONTAINS_PLACE(HardwareStore hardwareStore) {
	...
	public CONTAINS_PLACE(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public CONTAINS_PLACE(HealthClub healthClub) {
	...
	public CONTAINS_PLACE(HinduTemple hinduTemple) {
	...
	public CONTAINS_PLACE(HobbyShop hobbyShop) {
	...
	public CONTAINS_PLACE(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public CONTAINS_PLACE(HomeGoodsStore homeGoodsStore) {
	...
	public CONTAINS_PLACE(Hospital hospital) {
	...
	public CONTAINS_PLACE(Hostel hostel) {
	...
	public CONTAINS_PLACE(Hotel hotel) {
	...
	public CONTAINS_PLACE(HotelRoom hotelRoom) {
	...
	public CONTAINS_PLACE(House house) {
	...
	public CONTAINS_PLACE(HousePainter housePainter) {
	...
	public CONTAINS_PLACE(IceCreamShop iceCreamShop) {
	...
	public CONTAINS_PLACE(InsuranceAgency insuranceAgency) {
	...
	public CONTAINS_PLACE(InternetCafe internetCafe) {
	...
	public CONTAINS_PLACE(JewelryStore jewelryStore) {
	...
	public CONTAINS_PLACE(LakeBodyOfWater lakeBodyOfWater) {
	...
	public CONTAINS_PLACE(Landform landform) {
	...
	public CONTAINS_PLACE(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public CONTAINS_PLACE(LegalService legalService) {
	...
	public CONTAINS_PLACE(LegislativeBuilding legislativeBuilding) {
	...
	public CONTAINS_PLACE(Library library) {
	...
	public CONTAINS_PLACE(LiquorStore liquorStore) {
	...
	public CONTAINS_PLACE(LocalBusiness localBusiness) {
	...
	public CONTAINS_PLACE(Locksmith locksmith) {
	...
	public CONTAINS_PLACE(LodgingBusiness lodgingBusiness) {
	...
	public CONTAINS_PLACE(MedicalBusiness medicalBusiness) {
	...
	public CONTAINS_PLACE(MedicalClinic medicalClinic) {
	...
	public CONTAINS_PLACE(MeetingRoom meetingRoom) {
	...
	public CONTAINS_PLACE(MensClothingStore mensClothingStore) {
	...
	public CONTAINS_PLACE(Midwifery midwifery) {
	...
	public CONTAINS_PLACE(MobilePhoneStore mobilePhoneStore) {
	...
	public CONTAINS_PLACE(Mosque mosque) {
	...
	public CONTAINS_PLACE(Motel motel) {
	...
	public CONTAINS_PLACE(MotorcycleDealer motorcycleDealer) {
	...
	public CONTAINS_PLACE(MotorcycleRepair motorcycleRepair) {
	...
	public CONTAINS_PLACE(Mountain mountain) {
	...
	public CONTAINS_PLACE(MovieRentalStore movieRentalStore) {
	...
	public CONTAINS_PLACE(MovieTheater movieTheater) {
	...
	public CONTAINS_PLACE(MovingCompany movingCompany) {
	...
	public CONTAINS_PLACE(Museum museum) {
	...
	public CONTAINS_PLACE(MusicStore musicStore) {
	...
	public CONTAINS_PLACE(MusicVenue musicVenue) {
	...
	public CONTAINS_PLACE(NailSalon nailSalon) {
	...
	public CONTAINS_PLACE(NightClub nightClub) {
	...
	public CONTAINS_PLACE(Notary notary) {
	...
	public CONTAINS_PLACE(Nursing nursing) {
	...
	public CONTAINS_PLACE(Obstetric obstetric) {
	...
	public CONTAINS_PLACE(OceanBodyOfWater oceanBodyOfWater) {
	...
	public CONTAINS_PLACE(OfficeEquipmentStore officeEquipmentStore) {
	...
	public CONTAINS_PLACE(Oncologic oncologic) {
	...
	public CONTAINS_PLACE(Optician optician) {
	...
	public CONTAINS_PLACE(Optometric optometric) {
	...
	public CONTAINS_PLACE(Otolaryngologic otolaryngologic) {
	...
	public CONTAINS_PLACE(OutletStore outletStore) {
	...
	public CONTAINS_PLACE(Park park) {
	...
	public CONTAINS_PLACE(ParkingFacility parkingFacility) {
	...
	public CONTAINS_PLACE(PawnShop pawnShop) {
	...
	public CONTAINS_PLACE(Pediatric pediatric) {
	...
	public CONTAINS_PLACE(PerformingArtsTheater performingArtsTheater) {
	...
	public CONTAINS_PLACE(PetStore petStore) {
	...
	public CONTAINS_PLACE(Pharmacy pharmacy) {
	...
	public CONTAINS_PLACE(Physician physician) {
	...
	public CONTAINS_PLACE(Physiotherapy physiotherapy) {
	...
	public CONTAINS_PLACE(Place place) {
		placeList = new ArrayList<Place>();
		placeList.add(place);
	}
	...
	public CONTAINS_PLACE(PlaceOfWorship placeOfWorship) {
	...
	public CONTAINS_PLACE(PlasticSurgery plasticSurgery) {
	...
	public CONTAINS_PLACE(Playground playground) {
	...
	public CONTAINS_PLACE(Plumber plumber) {
	...
	public CONTAINS_PLACE(Podiatric podiatric) {
	...
	public CONTAINS_PLACE(PoliceStation policeStation) {
	...
	public CONTAINS_PLACE(Pond pond) {
	...
	public CONTAINS_PLACE(PostOffice postOffice) {
	...
	public CONTAINS_PLACE(PrimaryCare primaryCare) {
	...
	public CONTAINS_PLACE(ProfessionalService professionalService) {
	...
	public CONTAINS_PLACE(Psychiatric psychiatric) {
	...
	public CONTAINS_PLACE(PublicHealth publicHealth) {
	...
	public CONTAINS_PLACE(PublicSwimmingPool publicSwimmingPool) {
	...
	public CONTAINS_PLACE(PublicToilet publicToilet) {
	...
	public CONTAINS_PLACE(RVPark rvPark) {
	...
	public CONTAINS_PLACE(RadioStation radioStation) {
	...
	public CONTAINS_PLACE(RealEstateAgent realEstateAgent) {
	...
	public CONTAINS_PLACE(RecyclingCenter recyclingCenter) {
	...
	public CONTAINS_PLACE(Reservoir reservoir) {
	...
	public CONTAINS_PLACE(Residence residence) {
	...
	public CONTAINS_PLACE(Resort resort) {
	...
	public CONTAINS_PLACE(Restaurant restaurant) {
	...
	public CONTAINS_PLACE(RiverBodyOfWater riverBodyOfWater) {
	...
	public CONTAINS_PLACE(RoofingContractor roofingContractor) {
	...
	public CONTAINS_PLACE(Room room) {
	...
	public CONTAINS_PLACE(SeaBodyOfWater seaBodyOfWater) {
	...
	public CONTAINS_PLACE(SelfStorage selfStorage) {
	...
	public CONTAINS_PLACE(ShoeStore shoeStore) {
	...
	public CONTAINS_PLACE(ShoppingCenter shoppingCenter) {
	...
	public CONTAINS_PLACE(SingleFamilyResidence singleFamilyResidence) {
	...
	public CONTAINS_PLACE(SkiResort skiResort) {
	...
	public CONTAINS_PLACE(SportingGoodsStore sportingGoodsStore) {
	...
	public CONTAINS_PLACE(SportsActivityLocation sportsActivityLocation) {
	...
	public CONTAINS_PLACE(SportsClub sportsClub) {
	...
	public CONTAINS_PLACE(StadiumOrArena stadiumOrArena) {
	...
	public CONTAINS_PLACE(State state) {
	...
	public CONTAINS_PLACE(Store store) {
	...
	public CONTAINS_PLACE(SubwayStation subwayStation) {
	...
	public CONTAINS_PLACE(Suite suite) {
	...
	public CONTAINS_PLACE(Synagogue synagogue) {
	...
	public CONTAINS_PLACE(TattooParlor tattooParlor) {
	...
	public CONTAINS_PLACE(TaxiStand taxiStand) {
	...
	public CONTAINS_PLACE(TelevisionStation televisionStation) {
	...
	public CONTAINS_PLACE(TennisComplex tennisComplex) {
	...
	public CONTAINS_PLACE(TireShop tireShop) {
	...
	public CONTAINS_PLACE(TouristAttraction touristAttraction) {
	...
	public CONTAINS_PLACE(TouristDestination touristDestination) {
	...
	public CONTAINS_PLACE(TouristInformationCenter touristInformationCenter) {
	...
	public CONTAINS_PLACE(ToyStore toyStore) {
	...
	public CONTAINS_PLACE(TrainStation trainStation) {
	...
	public CONTAINS_PLACE(TravelAgency travelAgency) {
	...
	public CONTAINS_PLACE(Volcano volcano) {
	...
	public CONTAINS_PLACE(Waterfall waterfall) {
	...
	public CONTAINS_PLACE(WholesaleStore wholesaleStore) {
	...
	public CONTAINS_PLACE(Winery winery) {
	...
	public void copy(Container.ContainsPlace org) {
