...
public class COLLEGE_OR_UNIVERSITY implements Clazz.CollegeOrUniversity {
	...
	public COLLEGE_OR_UNIVERSITY() {
	}

	public COLLEGE_OR_UNIVERSITY(Long seq) {
		setSeq(seq);
	}

	public COLLEGE_OR_UNIVERSITY(String string) {
	...
	public COLLEGE_OR_UNIVERSITY(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public COLLEGE_OR_UNIVERSITY(AdditionalType additionalType) {
	...
	public COLLEGE_OR_UNIVERSITY(Address address) {
		setAddress(address);
	}
	...
	public COLLEGE_OR_UNIVERSITY(AggregateRating aggregateRating) {
	...
	public COLLEGE_OR_UNIVERSITY(AlternateName alternateName) {
	...
	public COLLEGE_OR_UNIVERSITY(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public COLLEGE_OR_UNIVERSITY(AreaServed areaServed) {
	...
	public COLLEGE_OR_UNIVERSITY(Award award) {
		setAward(award);
	}
	...
	public COLLEGE_OR_UNIVERSITY(Brand brand) {
		setBrand(brand);
	}
	...
	public COLLEGE_OR_UNIVERSITY(ContactPoint contactPoint) {
	...
	public COLLEGE_OR_UNIVERSITY(CorrectionsPolicy correctionsPolicy) {
	...
	public COLLEGE_OR_UNIVERSITY(Department department) {
	...
	public COLLEGE_OR_UNIVERSITY(Description description) {
	...
	public COLLEGE_OR_UNIVERSITY(DisambiguatingDescription disambiguatingDescription) {
	...
	public COLLEGE_OR_UNIVERSITY(DissolutionDate dissolutionDate) {
	...
	public COLLEGE_OR_UNIVERSITY(DiversityPolicy diversityPolicy) {
	...
	public COLLEGE_OR_UNIVERSITY(DiversityStaffingReport diversityStaffingReport) {
	...
	public COLLEGE_OR_UNIVERSITY(Duns duns) {
		setDuns(duns);
	}
	...
	public COLLEGE_OR_UNIVERSITY(Email email) {
		setEmail(email);
	}
	...
	public COLLEGE_OR_UNIVERSITY(Employee employee) {
	...
	public COLLEGE_OR_UNIVERSITY(EthicsPolicy ethicsPolicy) {
	...
	public COLLEGE_OR_UNIVERSITY(Event event) {
		setEvent(event);
	}
	...
	public COLLEGE_OR_UNIVERSITY(FaxNumber faxNumber) {
	...
	public COLLEGE_OR_UNIVERSITY(Founder founder) {
		setFounder(founder);
	}
	...
	public COLLEGE_OR_UNIVERSITY(FoundingDate foundingDate) {
	...
	public COLLEGE_OR_UNIVERSITY(FoundingLocation foundingLocation) {
	...
	public COLLEGE_OR_UNIVERSITY(Funder funder) {
		setFunder(funder);
	}
	...
	public COLLEGE_OR_UNIVERSITY(GlobalLocationNumber globalLocationNumber) {
	...
	public COLLEGE_OR_UNIVERSITY(HasOfferCatalog hasOfferCatalog) {
	...
	public COLLEGE_OR_UNIVERSITY(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public COLLEGE_OR_UNIVERSITY(Identifier identifier) {
	...
	public COLLEGE_OR_UNIVERSITY(Image image) {
		setImage(image);
	}
	...
	public COLLEGE_OR_UNIVERSITY(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public COLLEGE_OR_UNIVERSITY(KnowsAbout knowsAbout) {
	...
	public COLLEGE_OR_UNIVERSITY(KnowsLanguage knowsLanguage) {
	...
	public COLLEGE_OR_UNIVERSITY(LegalName legalName) {
	...
	public COLLEGE_OR_UNIVERSITY(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public COLLEGE_OR_UNIVERSITY(Location location) {
	...
	public COLLEGE_OR_UNIVERSITY(Logo logo) {
		setLogo(logo);
	}
	...
	public COLLEGE_OR_UNIVERSITY(MainEntityOfPage mainEntityOfPage) {
	...
	public COLLEGE_OR_UNIVERSITY(MakesOffer makesOffer) {
	...
	public COLLEGE_OR_UNIVERSITY(Member member) {
		setMember(member);
	}
	...
	public COLLEGE_OR_UNIVERSITY(MemberOf memberOf) {
	...
	public COLLEGE_OR_UNIVERSITY(Naics naics) {
		setNaics(naics);
	}
	...
	public COLLEGE_OR_UNIVERSITY(Name name) {
		setName(name);
	}
	...
	public COLLEGE_OR_UNIVERSITY(NameFuzzy nameFuzzy) {
	...
	public COLLEGE_OR_UNIVERSITY(NameRuby nameRuby) {
	...
	public COLLEGE_OR_UNIVERSITY(NumberOfEmployees numberOfEmployees) {
	...
	public COLLEGE_OR_UNIVERSITY(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public COLLEGE_OR_UNIVERSITY(Owns owns) {
		setOwns(owns);
	}
	...
	public COLLEGE_OR_UNIVERSITY(ParentOrganization parentOrganization) {
	...
	public COLLEGE_OR_UNIVERSITY(PotentialAction potentialAction) {
	...
	public COLLEGE_OR_UNIVERSITY(PublishingPrinciples publishingPrinciples) {
	...
	public COLLEGE_OR_UNIVERSITY(Review review) {
		setReview(review);
	}
	...
	public COLLEGE_OR_UNIVERSITY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public COLLEGE_OR_UNIVERSITY(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public COLLEGE_OR_UNIVERSITY(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public COLLEGE_OR_UNIVERSITY(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public COLLEGE_OR_UNIVERSITY(SubOrganization subOrganization) {
	...
	public COLLEGE_OR_UNIVERSITY(SubjectOf subjectOf) {
	...
	public COLLEGE_OR_UNIVERSITY(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public COLLEGE_OR_UNIVERSITY(Telephone telephone) {
	...
	public COLLEGE_OR_UNIVERSITY(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public COLLEGE_OR_UNIVERSITY(Url url) {
		setUrl(url);
	}
	...
	public COLLEGE_OR_UNIVERSITY(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.CollegeOrUniversity org) {
		setSeq(org.getSeq());
