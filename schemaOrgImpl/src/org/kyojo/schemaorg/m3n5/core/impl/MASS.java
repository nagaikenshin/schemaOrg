...
public class MASS implements Clazz.Mass {
	...
	public MASS(Long seq) {
		setSeq(seq);
	}

	public MASS(String string) {
	...
	public MASS(AdditionalType additionalType) {
	...
	public MASS(AlternateName alternateName) {
	...
	public MASS(Description description) {
	...
	public MASS(DisambiguatingDescription disambiguatingDescription) {
	...
	public MASS(Identifier identifier) {
	...
	public MASS(MainEntityOfPage mainEntityOfPage) {
	...
	public MASS(NameFuzzy nameFuzzy) {
	...
	public MASS(PotentialAction potentialAction) {
	...
	public MASS(SubjectOf subjectOf) {
	...
	public void copy(Clazz.Mass org) {
		setSeq(org.getSeq());
