...
public class AIRPORT implements Clazz.Airport {
	...
	public AIRPORT(GeoContains geoContains) {
	...
	public AIRPORT(GeoCoveredBy geoCoveredBy) {
	...
	public AIRPORT(GeoCovers geoCovers) {
	...
	public AIRPORT(GeoCrosses geoCrosses) {
	...
	public AIRPORT(GeoDisjoint geoDisjoint) {
	...
	public AIRPORT(GeoEquals geoEquals) {
	...
	public AIRPORT(GeoIntersects geoIntersects) {
	...
	public AIRPORT(GeoOverlaps geoOverlaps) {
	...
	public AIRPORT(GeoTouches geoTouches) {
	...
	public AIRPORT(GeoWithin geoWithin) {
