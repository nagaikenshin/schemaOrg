...
public class RADIO_CHANNEL implements Clazz.RadioChannel {
	...
	public RADIO_CHANNEL() {
	}

	public RADIO_CHANNEL(Long seq) {
		setSeq(seq);
	}

	public RADIO_CHANNEL(String string) {
	...
	public RADIO_CHANNEL(AdditionalType additionalType) {
	...
	public RADIO_CHANNEL(AlternateName alternateName) {
	...
	public RADIO_CHANNEL(BroadcastChannelId broadcastChannelId) {
	...
	public RADIO_CHANNEL(BroadcastFrequency broadcastFrequency) {
	...
	public RADIO_CHANNEL(BroadcastServiceTier broadcastServiceTier) {
	...
	public RADIO_CHANNEL(Description description) {
	...
	public RADIO_CHANNEL(DisambiguatingDescription disambiguatingDescription) {
	...
	public RADIO_CHANNEL(Genre genre) {
		setGenre(genre);
	}
	...
	public RADIO_CHANNEL(Identifier identifier) {
	...
	public RADIO_CHANNEL(Image image) {
		setImage(image);
	}
	...
	public RADIO_CHANNEL(InBroadcastLineup inBroadcastLineup) {
	...
	public RADIO_CHANNEL(MainEntityOfPage mainEntityOfPage) {
	...
	public RADIO_CHANNEL(Name name) {
		setName(name);
	}
	...
	public RADIO_CHANNEL(NameFuzzy nameFuzzy) {
	...
	public RADIO_CHANNEL(NameRuby nameRuby) {
	...
	public RADIO_CHANNEL(PotentialAction potentialAction) {
	...
	public RADIO_CHANNEL(ProvidesBroadcastService providesBroadcastService) {
	...
	public RADIO_CHANNEL(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RADIO_CHANNEL(SubjectOf subjectOf) {
	...
	public void copy(Clazz.RadioChannel org) {
		setSeq(org.getSeq());
