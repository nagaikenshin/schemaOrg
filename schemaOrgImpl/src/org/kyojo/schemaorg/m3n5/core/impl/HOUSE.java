...
public class HOUSE implements Clazz.House {
	...
	public HOUSE(GeoContains geoContains) {
	...
	public HOUSE(GeoCoveredBy geoCoveredBy) {
	...
	public HOUSE(GeoCovers geoCovers) {
	...
	public HOUSE(GeoCrosses geoCrosses) {
	...
	public HOUSE(GeoDisjoint geoDisjoint) {
	...
	public HOUSE(GeoEquals geoEquals) {
	...
	public HOUSE(GeoIntersects geoIntersects) {
	...
	public HOUSE(GeoOverlaps geoOverlaps) {
	...
	public HOUSE(GeoTouches geoTouches) {
	...
	public HOUSE(GeoWithin geoWithin) {
