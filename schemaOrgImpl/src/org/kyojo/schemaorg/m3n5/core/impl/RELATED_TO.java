...
public class RELATED_TO implements Container.RelatedTo {
	...
	public RELATED_TO(String string) {
	...
	public RELATED_TO(Patient patient) {
	...
	public RELATED_TO(Person person) {
		personList = new ArrayList<Person>();
	...
	public RELATED_TO(List<Patient> patientList,
			List<Person> personList) {
		setPatientList(patientList);
		setPersonList(personList);
	}

	public void copy(Container.RelatedTo org) {
