...
public class ASSOCIATED_MEDIA implements Container.AssociatedMedia {
	...
	public ASSOCIATED_MEDIA(String string) {
	...
	public ASSOCIATED_MEDIA(AudioObject audioObject) {
	...
	public ASSOCIATED_MEDIA(Audiobook audiobook) {
	...
	public ASSOCIATED_MEDIA(Barcode barcode) {
	...
	public ASSOCIATED_MEDIA(DataDownload dataDownload) {
	...
	public ASSOCIATED_MEDIA(ImageObject imageObject) {
	...
	public ASSOCIATED_MEDIA(LegislationObject legislationObject) {
	...
	public ASSOCIATED_MEDIA(MediaObject mediaObject) {
		mediaObjectList = new ArrayList<MediaObject>();
	...
	public ASSOCIATED_MEDIA(MusicVideoObject musicVideoObject) {
	...
	public ASSOCIATED_MEDIA(VideoObject videoObject) {
	...
	public ASSOCIATED_MEDIA(List<AudioObject> audioObjectList,
	...
	public void copy(Container.AssociatedMedia org) {
