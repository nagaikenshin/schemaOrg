...
public class CONTRIBUTOR implements Container.Contributor {
	...
	public CONTRIBUTOR(AccountingService accountingService) {
	...
	public CONTRIBUTOR(AdultEntertainment adultEntertainment) {
	...
	public CONTRIBUTOR(Airline airline) {
	...
	public CONTRIBUTOR(AmusementPark amusementPark) {
	...
	public CONTRIBUTOR(AnimalShelter animalShelter) {
	...
	public CONTRIBUTOR(ArchiveOrganization archiveOrganization) {
	...
	public CONTRIBUTOR(ArtGallery artGallery) {
	...
	public CONTRIBUTOR(Attorney attorney) {
	...
	public CONTRIBUTOR(AutoBodyShop autoBodyShop) {
	...
	public CONTRIBUTOR(AutoDealer autoDealer) {
	...
	public CONTRIBUTOR(AutoPartsStore autoPartsStore) {
	...
	public CONTRIBUTOR(AutoRental autoRental) {
	...
	public CONTRIBUTOR(AutoRepair autoRepair) {
	...
	public CONTRIBUTOR(AutoWash autoWash) {
	...
	public CONTRIBUTOR(AutomatedTeller automatedTeller) {
	...
	public CONTRIBUTOR(AutomotiveBusiness automotiveBusiness) {
	...
	public CONTRIBUTOR(Bakery bakery) {
	...
	public CONTRIBUTOR(BankOrCreditUnion bankOrCreditUnion) {
	...
	public CONTRIBUTOR(BarOrPub barOrPub) {
	...
	public CONTRIBUTOR(BeautySalon beautySalon) {
	...
	public CONTRIBUTOR(BedAndBreakfast bedAndBreakfast) {
	...
	public CONTRIBUTOR(BikeStore bikeStore) {
	...
	public CONTRIBUTOR(BookStore bookStore) {
	...
	public CONTRIBUTOR(BowlingAlley bowlingAlley) {
	...
	public CONTRIBUTOR(Brewery brewery) {
	...
	public CONTRIBUTOR(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public CONTRIBUTOR(Campground campground) {
	...
	public CONTRIBUTOR(Casino casino) {
	...
	public CONTRIBUTOR(ChildCare childCare) {
	...
	public CONTRIBUTOR(ClothingStore clothingStore) {
	...
	public CONTRIBUTOR(CollegeOrUniversity collegeOrUniversity) {
	...
	public CONTRIBUTOR(ComedyClub comedyClub) {
	...
	public CONTRIBUTOR(CommunityHealth communityHealth) {
	...
	public CONTRIBUTOR(ComputerStore computerStore) {
	...
	public CONTRIBUTOR(Consortium consortium) {
	...
	public CONTRIBUTOR(ConvenienceStore convenienceStore) {
	...
	public CONTRIBUTOR(Corporation corporation) {
	...
	public CONTRIBUTOR(DanceGroup danceGroup) {
	...
	public CONTRIBUTOR(DaySpa daySpa) {
	...
	public CONTRIBUTOR(Dentist dentist) {
	...
	public CONTRIBUTOR(DepartmentStore departmentStore) {
	...
	public CONTRIBUTOR(Dermatology dermatology) {
	...
	public CONTRIBUTOR(DiagnosticLab diagnosticLab) {
	...
	public CONTRIBUTOR(DietNutrition dietNutrition) {
	...
	public CONTRIBUTOR(Distillery distillery) {
	...
	public CONTRIBUTOR(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public CONTRIBUTOR(EducationalOrganization educationalOrganization) {
	...
	public CONTRIBUTOR(Electrician electrician) {
	...
	public CONTRIBUTOR(ElectronicsStore electronicsStore) {
	...
	public CONTRIBUTOR(ElementarySchool elementarySchool) {
	...
	public CONTRIBUTOR(Emergency emergency) {
	...
	public CONTRIBUTOR(EmergencyService emergencyService) {
	...
	public CONTRIBUTOR(EmploymentAgency employmentAgency) {
	...
	public CONTRIBUTOR(EntertainmentBusiness entertainmentBusiness) {
	...
	public CONTRIBUTOR(ExerciseGym exerciseGym) {
	...
	public CONTRIBUTOR(FastFoodRestaurant fastFoodRestaurant) {
	...
	public CONTRIBUTOR(FinancialService financialService) {
	...
	public CONTRIBUTOR(FireStation fireStation) {
	...
	public CONTRIBUTOR(Florist florist) {
	...
	public CONTRIBUTOR(FoodEstablishment foodEstablishment) {
	...
	public CONTRIBUTOR(FundingAgency fundingAgency) {
	...
	public CONTRIBUTOR(FundingScheme fundingScheme) {
	...
	public CONTRIBUTOR(FurnitureStore furnitureStore) {
	...
	public CONTRIBUTOR(GardenStore gardenStore) {
	...
	public CONTRIBUTOR(GasStation gasStation) {
	...
	public CONTRIBUTOR(GeneralContractor generalContractor) {
	...
	public CONTRIBUTOR(Geriatric geriatric) {
	...
	public CONTRIBUTOR(GolfCourse golfCourse) {
	...
	public CONTRIBUTOR(GovernmentOffice governmentOffice) {
	...
	public CONTRIBUTOR(GovernmentOrganization governmentOrganization) {
	...
	public CONTRIBUTOR(GroceryStore groceryStore) {
	...
	public CONTRIBUTOR(Gynecologic gynecologic) {
	...
	public CONTRIBUTOR(HVACBusiness hvacBusiness) {
	...
	public CONTRIBUTOR(HairSalon hairSalon) {
	...
	public CONTRIBUTOR(HardwareStore hardwareStore) {
	...
	public CONTRIBUTOR(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public CONTRIBUTOR(HealthClub healthClub) {
	...
	public CONTRIBUTOR(HighSchool highSchool) {
	...
	public CONTRIBUTOR(HobbyShop hobbyShop) {
	...
	public CONTRIBUTOR(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public CONTRIBUTOR(HomeGoodsStore homeGoodsStore) {
	...
	public CONTRIBUTOR(Hospital hospital) {
	...
	public CONTRIBUTOR(Hostel hostel) {
	...
	public CONTRIBUTOR(Hotel hotel) {
	...
	public CONTRIBUTOR(HousePainter housePainter) {
	...
	public CONTRIBUTOR(IceCreamShop iceCreamShop) {
	...
	public CONTRIBUTOR(InsuranceAgency insuranceAgency) {
	...
	public CONTRIBUTOR(InternetCafe internetCafe) {
	...
	public CONTRIBUTOR(JewelryStore jewelryStore) {
	...
	public CONTRIBUTOR(LegalService legalService) {
	...
	public CONTRIBUTOR(Library library) {
	...
	public CONTRIBUTOR(LibrarySystem librarySystem) {
	...
	public CONTRIBUTOR(LiquorStore liquorStore) {
	...
	public CONTRIBUTOR(LocalBusiness localBusiness) {
	...
	public CONTRIBUTOR(Locksmith locksmith) {
	...
	public CONTRIBUTOR(LodgingBusiness lodgingBusiness) {
	...
	public CONTRIBUTOR(MedicalBusiness medicalBusiness) {
	...
	public CONTRIBUTOR(MedicalClinic medicalClinic) {
	...
	public CONTRIBUTOR(MedicalOrganization medicalOrganization) {
	...
	public CONTRIBUTOR(MensClothingStore mensClothingStore) {
	...
	public CONTRIBUTOR(MiddleSchool middleSchool) {
	...
	public CONTRIBUTOR(Midwifery midwifery) {
	...
	public CONTRIBUTOR(MobilePhoneStore mobilePhoneStore) {
	...
	public CONTRIBUTOR(Motel motel) {
	...
	public CONTRIBUTOR(MotorcycleDealer motorcycleDealer) {
	...
	public CONTRIBUTOR(MotorcycleRepair motorcycleRepair) {
	...
	public CONTRIBUTOR(MovieRentalStore movieRentalStore) {
	...
	public CONTRIBUTOR(MovieTheater movieTheater) {
	...
	public CONTRIBUTOR(MovingCompany movingCompany) {
	...
	public CONTRIBUTOR(MusicGroup musicGroup) {
	...
	public CONTRIBUTOR(MusicStore musicStore) {
	...
	public CONTRIBUTOR(NailSalon nailSalon) {
	...
	public CONTRIBUTOR(NewsMediaOrganization newsMediaOrganization) {
	...
	public CONTRIBUTOR(NightClub nightClub) {
	...
	public CONTRIBUTOR(Notary notary) {
	...
	public CONTRIBUTOR(Nursing nursing) {
	...
	public CONTRIBUTOR(Obstetric obstetric) {
	...
	public CONTRIBUTOR(OfficeEquipmentStore officeEquipmentStore) {
	...
	public CONTRIBUTOR(Oncologic oncologic) {
	...
	public CONTRIBUTOR(Optician optician) {
	...
	public CONTRIBUTOR(Optometric optometric) {
	...
	public CONTRIBUTOR(Organization organization) {
		organizationList = new ArrayList<Organization>();
	...
	public CONTRIBUTOR(Otolaryngologic otolaryngologic) {
	...
	public CONTRIBUTOR(OutletStore outletStore) {
	...
	public CONTRIBUTOR(Patient patient) {
	...
	public CONTRIBUTOR(PawnShop pawnShop) {
	...
	public CONTRIBUTOR(Pediatric pediatric) {
	...
	public CONTRIBUTOR(PerformingGroup performingGroup) {
	...
	public CONTRIBUTOR(PetStore petStore) {
	...
	public CONTRIBUTOR(Pharmacy pharmacy) {
	...
	public CONTRIBUTOR(Physician physician) {
	...
	public CONTRIBUTOR(Physiotherapy physiotherapy) {
	...
	public CONTRIBUTOR(PlasticSurgery plasticSurgery) {
	...
	public CONTRIBUTOR(Plumber plumber) {
	...
	public CONTRIBUTOR(Podiatric podiatric) {
	...
	public CONTRIBUTOR(PoliceStation policeStation) {
	...
	public CONTRIBUTOR(PostOffice postOffice) {
	...
	public CONTRIBUTOR(Preschool preschool) {
	...
	public CONTRIBUTOR(PrimaryCare primaryCare) {
	...
	public CONTRIBUTOR(ProfessionalService professionalService) {
	...
	public CONTRIBUTOR(Psychiatric psychiatric) {
	...
	public CONTRIBUTOR(PublicHealth publicHealth) {
	...
	public CONTRIBUTOR(PublicSwimmingPool publicSwimmingPool) {
	...
	public CONTRIBUTOR(RadioStation radioStation) {
	...
	public CONTRIBUTOR(RealEstateAgent realEstateAgent) {
	...
	public CONTRIBUTOR(RecyclingCenter recyclingCenter) {
	...
	public CONTRIBUTOR(ResearchProject researchProject) {
	...
	public CONTRIBUTOR(Resort resort) {
	...
	public CONTRIBUTOR(Restaurant restaurant) {
	...
	public CONTRIBUTOR(RoofingContractor roofingContractor) {
	...
	public CONTRIBUTOR(School school) {
	...
	public CONTRIBUTOR(SelfStorage selfStorage) {
	...
	public CONTRIBUTOR(ShoeStore shoeStore) {
	...
	public CONTRIBUTOR(ShoppingCenter shoppingCenter) {
	...
	public CONTRIBUTOR(SkiResort skiResort) {
	...
	public CONTRIBUTOR(SportingGoodsStore sportingGoodsStore) {
	...
	public CONTRIBUTOR(SportsActivityLocation sportsActivityLocation) {
	...
	public CONTRIBUTOR(SportsClub sportsClub) {
	...
	public CONTRIBUTOR(SportsOrganization sportsOrganization) {
	...
	public CONTRIBUTOR(SportsTeam sportsTeam) {
	...
	public CONTRIBUTOR(StadiumOrArena stadiumOrArena) {
	...
	public CONTRIBUTOR(Store store) {
	...
	public CONTRIBUTOR(TattooParlor tattooParlor) {
	...
	public CONTRIBUTOR(TelevisionStation televisionStation) {
	...
	public CONTRIBUTOR(TennisComplex tennisComplex) {
	...
	public CONTRIBUTOR(TheaterGroup theaterGroup) {
	...
	public CONTRIBUTOR(TireShop tireShop) {
	...
	public CONTRIBUTOR(TouristInformationCenter touristInformationCenter) {
	...
	public CONTRIBUTOR(ToyStore toyStore) {
	...
	public CONTRIBUTOR(TravelAgency travelAgency) {
	...
	public CONTRIBUTOR(VeterinaryCare veterinaryCare) {
	...
	public CONTRIBUTOR(WholesaleStore wholesaleStore) {
	...
	public CONTRIBUTOR(Winery winery) {
	...
	public CONTRIBUTOR(WorkersUnion workersUnion) {
	...
	public void copy(Container.Contributor org) {
