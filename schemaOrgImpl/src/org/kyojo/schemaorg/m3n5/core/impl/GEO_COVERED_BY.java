...
public class GEO_COVERED_BY implements Container.GeoCoveredBy {
	...
	public GEO_COVERED_BY() {
	}

	public GEO_COVERED_BY(String string) {
	...
	public GEO_COVERED_BY(Accommodation accommodation) {
	...
	public GEO_COVERED_BY(AccountingService accountingService) {
	...
	public GEO_COVERED_BY(AdministrativeArea administrativeArea) {
	...
	public GEO_COVERED_BY(AdultEntertainment adultEntertainment) {
	...
	public GEO_COVERED_BY(Airport airport) {
	...
	public GEO_COVERED_BY(AmusementPark amusementPark) {
	...
	public GEO_COVERED_BY(AnimalShelter animalShelter) {
	...
	public GEO_COVERED_BY(Apartment apartment) {
	...
	public GEO_COVERED_BY(ApartmentComplex apartmentComplex) {
	...
	public GEO_COVERED_BY(Aquarium aquarium) {
	...
	public GEO_COVERED_BY(ArchiveOrganization archiveOrganization) {
	...
	public GEO_COVERED_BY(ArtGallery artGallery) {
	...
	public GEO_COVERED_BY(Attorney attorney) {
	...
	public GEO_COVERED_BY(AutoBodyShop autoBodyShop) {
	...
	public GEO_COVERED_BY(AutoDealer autoDealer) {
	...
	public GEO_COVERED_BY(AutoPartsStore autoPartsStore) {
	...
	public GEO_COVERED_BY(AutoRental autoRental) {
	...
	public GEO_COVERED_BY(AutoRepair autoRepair) {
	...
	public GEO_COVERED_BY(AutoWash autoWash) {
	...
	public GEO_COVERED_BY(AutomatedTeller automatedTeller) {
	...
	public GEO_COVERED_BY(AutomotiveBusiness automotiveBusiness) {
	...
	public GEO_COVERED_BY(Bakery bakery) {
	...
	public GEO_COVERED_BY(BankOrCreditUnion bankOrCreditUnion) {
	...
	public GEO_COVERED_BY(BarOrPub barOrPub) {
	...
	public GEO_COVERED_BY(Beach beach) {
	...
	public GEO_COVERED_BY(BeautySalon beautySalon) {
	...
	public GEO_COVERED_BY(BedAndBreakfast bedAndBreakfast) {
	...
	public GEO_COVERED_BY(BikeStore bikeStore) {
	...
	public GEO_COVERED_BY(BodyOfWater bodyOfWater) {
	...
	public GEO_COVERED_BY(BookStore bookStore) {
	...
	public GEO_COVERED_BY(BowlingAlley bowlingAlley) {
	...
	public GEO_COVERED_BY(Brewery brewery) {
	...
	public GEO_COVERED_BY(Bridge bridge) {
	...
	public GEO_COVERED_BY(BuddhistTemple buddhistTemple) {
	...
	public GEO_COVERED_BY(BusStation busStation) {
	...
	public GEO_COVERED_BY(BusStop busStop) {
	...
	public GEO_COVERED_BY(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public GEO_COVERED_BY(Campground campground) {
	...
	public GEO_COVERED_BY(CampingPitch campingPitch) {
	...
	public GEO_COVERED_BY(Canal canal) {
	...
	public GEO_COVERED_BY(Casino casino) {
	...
	public GEO_COVERED_BY(CatholicChurch catholicChurch) {
	...
	public GEO_COVERED_BY(Cemetery cemetery) {
	...
	public GEO_COVERED_BY(ChildCare childCare) {
	...
	public GEO_COVERED_BY(Church church) {
	...
	public GEO_COVERED_BY(City city) {
	...
	public GEO_COVERED_BY(CityHall cityHall) {
	...
	public GEO_COVERED_BY(CivicStructure civicStructure) {
	...
	public GEO_COVERED_BY(ClothingStore clothingStore) {
	...
	public GEO_COVERED_BY(ComedyClub comedyClub) {
	...
	public GEO_COVERED_BY(CommunityHealth communityHealth) {
	...
	public GEO_COVERED_BY(ComputerStore computerStore) {
	...
	public GEO_COVERED_BY(Continent continent) {
	...
	public GEO_COVERED_BY(ConvenienceStore convenienceStore) {
	...
	public GEO_COVERED_BY(Country country) {
	...
	public GEO_COVERED_BY(Courthouse courthouse) {
	...
	public GEO_COVERED_BY(Crematorium crematorium) {
	...
	public GEO_COVERED_BY(DaySpa daySpa) {
	...
	public GEO_COVERED_BY(DefenceEstablishment defenceEstablishment) {
	...
	public GEO_COVERED_BY(Dentist dentist) {
	...
	public GEO_COVERED_BY(DepartmentStore departmentStore) {
	...
	public GEO_COVERED_BY(Dermatology dermatology) {
	...
	public GEO_COVERED_BY(DietNutrition dietNutrition) {
	...
	public GEO_COVERED_BY(Distillery distillery) {
	...
	public GEO_COVERED_BY(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public GEO_COVERED_BY(Electrician electrician) {
	...
	public GEO_COVERED_BY(ElectronicsStore electronicsStore) {
	...
	public GEO_COVERED_BY(Embassy embassy) {
	...
	public GEO_COVERED_BY(Emergency emergency) {
	...
	public GEO_COVERED_BY(EmergencyService emergencyService) {
	...
	public GEO_COVERED_BY(EmploymentAgency employmentAgency) {
	...
	public GEO_COVERED_BY(EntertainmentBusiness entertainmentBusiness) {
	...
	public GEO_COVERED_BY(EventVenue eventVenue) {
	...
	public GEO_COVERED_BY(ExerciseGym exerciseGym) {
	...
	public GEO_COVERED_BY(FastFoodRestaurant fastFoodRestaurant) {
	...
	public GEO_COVERED_BY(FinancialService financialService) {
	...
	public GEO_COVERED_BY(FireStation fireStation) {
	...
	public GEO_COVERED_BY(Florist florist) {
	...
	public GEO_COVERED_BY(FoodEstablishment foodEstablishment) {
	...
	public GEO_COVERED_BY(FurnitureStore furnitureStore) {
	...
	public GEO_COVERED_BY(GardenStore gardenStore) {
	...
	public GEO_COVERED_BY(GasStation gasStation) {
	...
	public GEO_COVERED_BY(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public GEO_COVERED_BY(GeneralContractor generalContractor) {
	...
	public GEO_COVERED_BY(GeospatialGeometry geospatialGeometry) {
		geospatialGeometryList = new ArrayList<GeospatialGeometry>();
	...
	public GEO_COVERED_BY(Geriatric geriatric) {
	...
	public GEO_COVERED_BY(GolfCourse golfCourse) {
	...
	public GEO_COVERED_BY(GovernmentBuilding governmentBuilding) {
	...
	public GEO_COVERED_BY(GovernmentOffice governmentOffice) {
	...
	public GEO_COVERED_BY(GroceryStore groceryStore) {
	...
	public GEO_COVERED_BY(Gynecologic gynecologic) {
	...
	public GEO_COVERED_BY(HVACBusiness hvacBusiness) {
	...
	public GEO_COVERED_BY(HairSalon hairSalon) {
	...
	public GEO_COVERED_BY(HardwareStore hardwareStore) {
	...
	public GEO_COVERED_BY(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public GEO_COVERED_BY(HealthClub healthClub) {
	...
	public GEO_COVERED_BY(HinduTemple hinduTemple) {
	...
	public GEO_COVERED_BY(HobbyShop hobbyShop) {
	...
	public GEO_COVERED_BY(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public GEO_COVERED_BY(HomeGoodsStore homeGoodsStore) {
	...
	public GEO_COVERED_BY(Hospital hospital) {
	...
	public GEO_COVERED_BY(Hostel hostel) {
	...
	public GEO_COVERED_BY(Hotel hotel) {
	...
	public GEO_COVERED_BY(HotelRoom hotelRoom) {
	...
	public GEO_COVERED_BY(House house) {
	...
	public GEO_COVERED_BY(HousePainter housePainter) {
	...
	public GEO_COVERED_BY(IceCreamShop iceCreamShop) {
	...
	public GEO_COVERED_BY(InsuranceAgency insuranceAgency) {
	...
	public GEO_COVERED_BY(InternetCafe internetCafe) {
	...
	public GEO_COVERED_BY(JewelryStore jewelryStore) {
	...
	public GEO_COVERED_BY(LakeBodyOfWater lakeBodyOfWater) {
	...
	public GEO_COVERED_BY(Landform landform) {
	...
	public GEO_COVERED_BY(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public GEO_COVERED_BY(LegalService legalService) {
	...
	public GEO_COVERED_BY(LegislativeBuilding legislativeBuilding) {
	...
	public GEO_COVERED_BY(Library library) {
	...
	public GEO_COVERED_BY(LiquorStore liquorStore) {
	...
	public GEO_COVERED_BY(LocalBusiness localBusiness) {
	...
	public GEO_COVERED_BY(Locksmith locksmith) {
	...
	public GEO_COVERED_BY(LodgingBusiness lodgingBusiness) {
	...
	public GEO_COVERED_BY(MedicalBusiness medicalBusiness) {
	...
	public GEO_COVERED_BY(MedicalClinic medicalClinic) {
	...
	public GEO_COVERED_BY(MeetingRoom meetingRoom) {
	...
	public GEO_COVERED_BY(MensClothingStore mensClothingStore) {
	...
	public GEO_COVERED_BY(Midwifery midwifery) {
	...
	public GEO_COVERED_BY(MobilePhoneStore mobilePhoneStore) {
	...
	public GEO_COVERED_BY(Mosque mosque) {
	...
	public GEO_COVERED_BY(Motel motel) {
	...
	public GEO_COVERED_BY(MotorcycleDealer motorcycleDealer) {
	...
	public GEO_COVERED_BY(MotorcycleRepair motorcycleRepair) {
	...
	public GEO_COVERED_BY(Mountain mountain) {
	...
	public GEO_COVERED_BY(MovieRentalStore movieRentalStore) {
	...
	public GEO_COVERED_BY(MovieTheater movieTheater) {
	...
	public GEO_COVERED_BY(MovingCompany movingCompany) {
	...
	public GEO_COVERED_BY(Museum museum) {
	...
	public GEO_COVERED_BY(MusicStore musicStore) {
	...
	public GEO_COVERED_BY(MusicVenue musicVenue) {
	...
	public GEO_COVERED_BY(NailSalon nailSalon) {
	...
	public GEO_COVERED_BY(NightClub nightClub) {
	...
	public GEO_COVERED_BY(Notary notary) {
	...
	public GEO_COVERED_BY(Nursing nursing) {
	...
	public GEO_COVERED_BY(Obstetric obstetric) {
	...
	public GEO_COVERED_BY(OceanBodyOfWater oceanBodyOfWater) {
	...
	public GEO_COVERED_BY(OfficeEquipmentStore officeEquipmentStore) {
	...
	public GEO_COVERED_BY(Oncologic oncologic) {
	...
	public GEO_COVERED_BY(Optician optician) {
	...
	public GEO_COVERED_BY(Optometric optometric) {
	...
	public GEO_COVERED_BY(Otolaryngologic otolaryngologic) {
	...
	public GEO_COVERED_BY(OutletStore outletStore) {
	...
	public GEO_COVERED_BY(Park park) {
	...
	public GEO_COVERED_BY(ParkingFacility parkingFacility) {
	...
	public GEO_COVERED_BY(PawnShop pawnShop) {
	...
	public GEO_COVERED_BY(Pediatric pediatric) {
	...
	public GEO_COVERED_BY(PerformingArtsTheater performingArtsTheater) {
	...
	public GEO_COVERED_BY(PetStore petStore) {
	...
	public GEO_COVERED_BY(Pharmacy pharmacy) {
	...
	public GEO_COVERED_BY(Physician physician) {
	...
	public GEO_COVERED_BY(Physiotherapy physiotherapy) {
	...
	public GEO_COVERED_BY(Place place) {
	...
	public GEO_COVERED_BY(PlaceOfWorship placeOfWorship) {
	...
	public GEO_COVERED_BY(PlasticSurgery plasticSurgery) {
	...
	public GEO_COVERED_BY(Playground playground) {
	...
	public GEO_COVERED_BY(Plumber plumber) {
	...
	public GEO_COVERED_BY(Podiatric podiatric) {
	...
	public GEO_COVERED_BY(PoliceStation policeStation) {
	...
	public GEO_COVERED_BY(Pond pond) {
	...
	public GEO_COVERED_BY(PostOffice postOffice) {
	...
	public GEO_COVERED_BY(PrimaryCare primaryCare) {
	...
	public GEO_COVERED_BY(ProfessionalService professionalService) {
	...
	public GEO_COVERED_BY(Psychiatric psychiatric) {
	...
	public GEO_COVERED_BY(PublicHealth publicHealth) {
	...
	public GEO_COVERED_BY(PublicSwimmingPool publicSwimmingPool) {
	...
	public GEO_COVERED_BY(PublicToilet publicToilet) {
	...
	public GEO_COVERED_BY(RVPark rvPark) {
	...
	public GEO_COVERED_BY(RadioStation radioStation) {
	...
	public GEO_COVERED_BY(RealEstateAgent realEstateAgent) {
	...
	public GEO_COVERED_BY(RecyclingCenter recyclingCenter) {
	...
	public GEO_COVERED_BY(Reservoir reservoir) {
	...
	public GEO_COVERED_BY(Residence residence) {
	...
	public GEO_COVERED_BY(Resort resort) {
	...
	public GEO_COVERED_BY(Restaurant restaurant) {
	...
	public GEO_COVERED_BY(RiverBodyOfWater riverBodyOfWater) {
	...
	public GEO_COVERED_BY(RoofingContractor roofingContractor) {
	...
	public GEO_COVERED_BY(Room room) {
	...
	public GEO_COVERED_BY(SeaBodyOfWater seaBodyOfWater) {
	...
	public GEO_COVERED_BY(SelfStorage selfStorage) {
	...
	public GEO_COVERED_BY(ShoeStore shoeStore) {
	...
	public GEO_COVERED_BY(ShoppingCenter shoppingCenter) {
	...
	public GEO_COVERED_BY(SingleFamilyResidence singleFamilyResidence) {
	...
	public GEO_COVERED_BY(SkiResort skiResort) {
	...
	public GEO_COVERED_BY(SportingGoodsStore sportingGoodsStore) {
	...
	public GEO_COVERED_BY(SportsActivityLocation sportsActivityLocation) {
	...
	public GEO_COVERED_BY(SportsClub sportsClub) {
	...
	public GEO_COVERED_BY(StadiumOrArena stadiumOrArena) {
	...
	public GEO_COVERED_BY(State state) {
	...
	public GEO_COVERED_BY(Store store) {
	...
	public GEO_COVERED_BY(SubwayStation subwayStation) {
	...
	public GEO_COVERED_BY(Suite suite) {
	...
	public GEO_COVERED_BY(Synagogue synagogue) {
	...
	public GEO_COVERED_BY(TattooParlor tattooParlor) {
	...
	public GEO_COVERED_BY(TaxiStand taxiStand) {
	...
	public GEO_COVERED_BY(TelevisionStation televisionStation) {
	...
	public GEO_COVERED_BY(TennisComplex tennisComplex) {
	...
	public GEO_COVERED_BY(TireShop tireShop) {
	...
	public GEO_COVERED_BY(TouristAttraction touristAttraction) {
	...
	public GEO_COVERED_BY(TouristDestination touristDestination) {
	...
	public GEO_COVERED_BY(TouristInformationCenter touristInformationCenter) {
	...
	public GEO_COVERED_BY(ToyStore toyStore) {
	...
	public GEO_COVERED_BY(TrainStation trainStation) {
	...
	public GEO_COVERED_BY(TravelAgency travelAgency) {
	...
	public GEO_COVERED_BY(Volcano volcano) {
	...
	public GEO_COVERED_BY(Waterfall waterfall) {
	...
	public GEO_COVERED_BY(WholesaleStore wholesaleStore) {
	...
	public GEO_COVERED_BY(Winery winery) {
	...
	public void copy(Container.GeoCoveredBy org) {
