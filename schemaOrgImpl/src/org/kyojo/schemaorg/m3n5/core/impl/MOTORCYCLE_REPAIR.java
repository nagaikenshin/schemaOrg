...
public class MOTORCYCLE_REPAIR implements Clazz.MotorcycleRepair {
	...
	public MOTORCYCLE_REPAIR(GeoContains geoContains) {
	...
	public MOTORCYCLE_REPAIR(GeoCoveredBy geoCoveredBy) {
	...
	public MOTORCYCLE_REPAIR(GeoCovers geoCovers) {
	...
	public MOTORCYCLE_REPAIR(GeoCrosses geoCrosses) {
	...
	public MOTORCYCLE_REPAIR(GeoDisjoint geoDisjoint) {
	...
	public MOTORCYCLE_REPAIR(GeoEquals geoEquals) {
	...
	public MOTORCYCLE_REPAIR(GeoIntersects geoIntersects) {
	...
	public MOTORCYCLE_REPAIR(GeoOverlaps geoOverlaps) {
	...
	public MOTORCYCLE_REPAIR(GeoTouches geoTouches) {
	...
	public MOTORCYCLE_REPAIR(GeoWithin geoWithin) {
	...
	public MOTORCYCLE_REPAIR(Slogan slogan) {
		setSlogan(slogan);
	}
