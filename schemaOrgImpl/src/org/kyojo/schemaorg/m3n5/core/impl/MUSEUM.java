...
public class MUSEUM implements Clazz.Museum {
	...
	public MUSEUM(GeoContains geoContains) {
	...
	public MUSEUM(GeoCoveredBy geoCoveredBy) {
	...
	public MUSEUM(GeoCovers geoCovers) {
	...
	public MUSEUM(GeoCrosses geoCrosses) {
	...
	public MUSEUM(GeoDisjoint geoDisjoint) {
	...
	public MUSEUM(GeoEquals geoEquals) {
	...
	public MUSEUM(GeoIntersects geoIntersects) {
	...
	public MUSEUM(GeoOverlaps geoOverlaps) {
	...
	public MUSEUM(GeoTouches geoTouches) {
	...
	public MUSEUM(GeoWithin geoWithin) {
