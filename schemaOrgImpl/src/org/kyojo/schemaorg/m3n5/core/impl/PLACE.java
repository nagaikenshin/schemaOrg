...
public class PLACE implements Clazz.Place {
	...
	public PLACE(GeoContains geoContains) {
	...
	public PLACE(GeoCoveredBy geoCoveredBy) {
	...
	public PLACE(GeoCovers geoCovers) {
	...
	public PLACE(GeoCrosses geoCrosses) {
	...
	public PLACE(GeoDisjoint geoDisjoint) {
	...
	public PLACE(GeoEquals geoEquals) {
	...
	public PLACE(GeoIntersects geoIntersects) {
	...
	public PLACE(GeoOverlaps geoOverlaps) {
	...
	public PLACE(GeoTouches geoTouches) {
	...
	public PLACE(GeoWithin geoWithin) {
