...
public class PROFESSIONAL_SERVICE implements Clazz.ProfessionalService {
	...
	public PROFESSIONAL_SERVICE(GeoContains geoContains) {
	...
	public PROFESSIONAL_SERVICE(GeoCoveredBy geoCoveredBy) {
	...
	public PROFESSIONAL_SERVICE(GeoCovers geoCovers) {
	...
	public PROFESSIONAL_SERVICE(GeoCrosses geoCrosses) {
	...
	public PROFESSIONAL_SERVICE(GeoDisjoint geoDisjoint) {
	...
	public PROFESSIONAL_SERVICE(GeoEquals geoEquals) {
	...
	public PROFESSIONAL_SERVICE(GeoIntersects geoIntersects) {
	...
	public PROFESSIONAL_SERVICE(GeoOverlaps geoOverlaps) {
	...
	public PROFESSIONAL_SERVICE(GeoTouches geoTouches) {
	...
	public PROFESSIONAL_SERVICE(GeoWithin geoWithin) {
	...
	public PROFESSIONAL_SERVICE(Slogan slogan) {
		setSlogan(slogan);
	}
