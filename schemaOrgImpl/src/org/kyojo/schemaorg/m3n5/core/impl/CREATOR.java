...
public class CREATOR implements Container.Creator {
	...
	public CREATOR(AccountingService accountingService) {
	...
	public CREATOR(AdultEntertainment adultEntertainment) {
	...
	public CREATOR(Airline airline) {
	...
	public CREATOR(AmusementPark amusementPark) {
	...
	public CREATOR(AnimalShelter animalShelter) {
	...
	public CREATOR(ArchiveOrganization archiveOrganization) {
	...
	public CREATOR(ArtGallery artGallery) {
	...
	public CREATOR(Attorney attorney) {
	...
	public CREATOR(AutoBodyShop autoBodyShop) {
	...
	public CREATOR(AutoDealer autoDealer) {
	...
	public CREATOR(AutoPartsStore autoPartsStore) {
	...
	public CREATOR(AutoRental autoRental) {
	...
	public CREATOR(AutoRepair autoRepair) {
	...
	public CREATOR(AutoWash autoWash) {
	...
	public CREATOR(AutomatedTeller automatedTeller) {
	...
	public CREATOR(AutomotiveBusiness automotiveBusiness) {
	...
	public CREATOR(BankOrCreditUnion bankOrCreditUnion) {
	...
	public CREATOR(BarOrPub barOrPub) {
	...
	public CREATOR(BeautySalon beautySalon) {
	...
	public CREATOR(BedAndBreakfast bedAndBreakfast) {
	...
	public CREATOR(BikeStore bikeStore) {
	...
	public CREATOR(BookStore bookStore) {
	...
	public CREATOR(BowlingAlley bowlingAlley) {
	...
	public CREATOR(Brewery brewery) {
	...
	public CREATOR(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public CREATOR(Campground campground) {
	...
	public CREATOR(ChildCare childCare) {
	...
	public CREATOR(ClothingStore clothingStore) {
	...
	public CREATOR(CollegeOrUniversity collegeOrUniversity) {
	...
	public CREATOR(ComedyClub comedyClub) {
	...
	public CREATOR(CommunityHealth communityHealth) {
	...
	public CREATOR(ComputerStore computerStore) {
	...
	public CREATOR(Consortium consortium) {
	...
	public CREATOR(ConvenienceStore convenienceStore) {
	...
	public CREATOR(Corporation corporation) {
	...
	public CREATOR(DanceGroup danceGroup) {
	...
	public CREATOR(Dentist dentist) {
	...
	public CREATOR(DepartmentStore departmentStore) {
	...
	public CREATOR(Dermatology dermatology) {
	...
	public CREATOR(DiagnosticLab diagnosticLab) {
	...
	public CREATOR(DietNutrition dietNutrition) {
	...
	public CREATOR(Distillery distillery) {
	...
	public CREATOR(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public CREATOR(EducationalOrganization educationalOrganization) {
	...
	public CREATOR(Electrician electrician) {
	...
	public CREATOR(ElectronicsStore electronicsStore) {
	...
	public CREATOR(ElementarySchool elementarySchool) {
	...
	public CREATOR(Emergency emergency) {
	...
	public CREATOR(EmergencyService emergencyService) {
	...
	public CREATOR(EmploymentAgency employmentAgency) {
	...
	public CREATOR(EntertainmentBusiness entertainmentBusiness) {
	...
	public CREATOR(ExerciseGym exerciseGym) {
	...
	public CREATOR(FastFoodRestaurant fastFoodRestaurant) {
	...
	public CREATOR(FinancialService financialService) {
	...
	public CREATOR(FireStation fireStation) {
	...
	public CREATOR(Florist florist) {
	...
	public CREATOR(FoodEstablishment foodEstablishment) {
	...
	public CREATOR(FundingAgency fundingAgency) {
	...
	public CREATOR(FundingScheme fundingScheme) {
	...
	public CREATOR(FurnitureStore furnitureStore) {
	...
	public CREATOR(GardenStore gardenStore) {
	...
	public CREATOR(GasStation gasStation) {
	...
	public CREATOR(GeneralContractor generalContractor) {
	...
	public CREATOR(Geriatric geriatric) {
	...
	public CREATOR(GolfCourse golfCourse) {
	...
	public CREATOR(GovernmentOffice governmentOffice) {
	...
	public CREATOR(GovernmentOrganization governmentOrganization) {
	...
	public CREATOR(GroceryStore groceryStore) {
	...
	public CREATOR(Gynecologic gynecologic) {
	...
	public CREATOR(HVACBusiness hvacBusiness) {
	...
	public CREATOR(HairSalon hairSalon) {
	...
	public CREATOR(HardwareStore hardwareStore) {
	...
	public CREATOR(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public CREATOR(HealthClub healthClub) {
	...
	public CREATOR(HighSchool highSchool) {
	...
	public CREATOR(HobbyShop hobbyShop) {
	...
	public CREATOR(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public CREATOR(HomeGoodsStore homeGoodsStore) {
	...
	public CREATOR(Hospital hospital) {
	...
	public CREATOR(HousePainter housePainter) {
	...
	public CREATOR(IceCreamShop iceCreamShop) {
	...
	public CREATOR(InsuranceAgency insuranceAgency) {
	...
	public CREATOR(InternetCafe internetCafe) {
	...
	public CREATOR(JewelryStore jewelryStore) {
	...
	public CREATOR(LegalService legalService) {
	...
	public CREATOR(Library library) {
	...
	public CREATOR(LibrarySystem librarySystem) {
	...
	public CREATOR(LiquorStore liquorStore) {
	...
	public CREATOR(LocalBusiness localBusiness) {
	...
	public CREATOR(Locksmith locksmith) {
	...
	public CREATOR(LodgingBusiness lodgingBusiness) {
	...
	public CREATOR(MedicalBusiness medicalBusiness) {
	...
	public CREATOR(MedicalClinic medicalClinic) {
	...
	public CREATOR(MedicalOrganization medicalOrganization) {
	...
	public CREATOR(MensClothingStore mensClothingStore) {
	...
	public CREATOR(MiddleSchool middleSchool) {
	...
	public CREATOR(Midwifery midwifery) {
	...
	public CREATOR(MobilePhoneStore mobilePhoneStore) {
	...
	public CREATOR(MotorcycleDealer motorcycleDealer) {
	...
	public CREATOR(MotorcycleRepair motorcycleRepair) {
	...
	public CREATOR(MovieRentalStore movieRentalStore) {
	...
	public CREATOR(MovieTheater movieTheater) {
	...
	public CREATOR(MovingCompany movingCompany) {
	...
	public CREATOR(MusicGroup musicGroup) {
	...
	public CREATOR(MusicStore musicStore) {
	...
	public CREATOR(NailSalon nailSalon) {
	...
	public CREATOR(NewsMediaOrganization newsMediaOrganization) {
	...
	public CREATOR(NightClub nightClub) {
	...
	public CREATOR(Nursing nursing) {
	...
	public CREATOR(Obstetric obstetric) {
	...
	public CREATOR(OfficeEquipmentStore officeEquipmentStore) {
	...
	public CREATOR(Oncologic oncologic) {
	...
	public CREATOR(Optician optician) {
	...
	public CREATOR(Optometric optometric) {
	...
	public CREATOR(Organization organization) {
		organizationList = new ArrayList<Organization>();
	...
	public CREATOR(Otolaryngologic otolaryngologic) {
	...
	public CREATOR(OutletStore outletStore) {
	...
	public CREATOR(Patient patient) {
	...
	public CREATOR(PawnShop pawnShop) {
	...
	public CREATOR(Pediatric pediatric) {
	...
	public CREATOR(PerformingGroup performingGroup) {
	...
	public CREATOR(PetStore petStore) {
	...
	public CREATOR(Pharmacy pharmacy) {
	...
	public CREATOR(Physician physician) {
	...
	public CREATOR(Physiotherapy physiotherapy) {
	...
	public CREATOR(PlasticSurgery plasticSurgery) {
	...
	public CREATOR(Plumber plumber) {
	...
	public CREATOR(Podiatric podiatric) {
	...
	public CREATOR(PoliceStation policeStation) {
	...
	public CREATOR(PostOffice postOffice) {
	...
	public CREATOR(Preschool preschool) {
	...
	public CREATOR(PrimaryCare primaryCare) {
	...
	public CREATOR(ProfessionalService professionalService) {
	...
	public CREATOR(Project project) {
	...
	public CREATOR(Psychiatric psychiatric) {
	...
	public CREATOR(PublicHealth publicHealth) {
	...
	public CREATOR(PublicSwimmingPool publicSwimmingPool) {
	...
	public CREATOR(RadioStation radioStation) {
	...
	public CREATOR(RealEstateAgent realEstateAgent) {
	...
	public CREATOR(RecyclingCenter recyclingCenter) {
	...
	public CREATOR(ResearchProject researchProject) {
	...
	public CREATOR(Restaurant restaurant) {
	...
	public CREATOR(RoofingContractor roofingContractor) {
	...
	public CREATOR(SelfStorage selfStorage) {
	...
	public CREATOR(ShoeStore shoeStore) {
	...
	public CREATOR(ShoppingCenter shoppingCenter) {
	...
	public CREATOR(SkiResort skiResort) {
	...
	public CREATOR(SportingGoodsStore sportingGoodsStore) {
	...
	public CREATOR(SportsActivityLocation sportsActivityLocation) {
	...
	public CREATOR(SportsClub sportsClub) {
	...
	public CREATOR(SportsOrganization sportsOrganization) {
	...
	public CREATOR(SportsTeam sportsTeam) {
	...
	public CREATOR(StadiumOrArena stadiumOrArena) {
	...
	public CREATOR(TattooParlor tattooParlor) {
	...
	public CREATOR(TelevisionStation televisionStation) {
	...
	public CREATOR(TennisComplex tennisComplex) {
	...
	public CREATOR(TheaterGroup theaterGroup) {
	...
	public CREATOR(TireShop tireShop) {
	...
	public CREATOR(TouristInformationCenter touristInformationCenter) {
	...
	public CREATOR(ToyStore toyStore) {
	...
	public CREATOR(TravelAgency travelAgency) {
	...
	public CREATOR(VeterinaryCare veterinaryCare) {
	...
	public CREATOR(WholesaleStore wholesaleStore) {
	...
	public CREATOR(WorkersUnion workersUnion) {
	...
	public void copy(Container.Creator org) {
