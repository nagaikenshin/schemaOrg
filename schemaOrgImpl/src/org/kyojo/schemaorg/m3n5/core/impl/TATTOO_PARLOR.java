...
public class TATTOO_PARLOR implements Clazz.TattooParlor {
	...
	public TATTOO_PARLOR(GeoContains geoContains) {
	...
	public TATTOO_PARLOR(GeoCoveredBy geoCoveredBy) {
	...
	public TATTOO_PARLOR(GeoCovers geoCovers) {
	...
	public TATTOO_PARLOR(GeoCrosses geoCrosses) {
	...
	public TATTOO_PARLOR(GeoDisjoint geoDisjoint) {
	...
	public TATTOO_PARLOR(GeoEquals geoEquals) {
	...
	public TATTOO_PARLOR(GeoIntersects geoIntersects) {
	...
	public TATTOO_PARLOR(GeoOverlaps geoOverlaps) {
	...
	public TATTOO_PARLOR(GeoTouches geoTouches) {
	...
	public TATTOO_PARLOR(GeoWithin geoWithin) {
	...
	public TATTOO_PARLOR(Slogan slogan) {
		setSlogan(slogan);
	}
