...
import org.kyojo.schemaorg.m3n5.core.Container.PublishedOn;
...
public class ON_DEMAND_EVENT implements Clazz.OnDemandEvent {
	...
	public ON_DEMAND_EVENT() {
	}

	public ON_DEMAND_EVENT(Long seq) {
		setSeq(seq);
	}

	public ON_DEMAND_EVENT(String string) {
	...
	public ON_DEMAND_EVENT(About about) {
		setAbout(about);
	}
	...
	public ON_DEMAND_EVENT(Actor actor) {
		setActor(actor);
	}
	...
	public ON_DEMAND_EVENT(AdditionalType additionalType) {
	...
	public ON_DEMAND_EVENT(AggregateRating aggregateRating) {
	...
	public ON_DEMAND_EVENT(AlternateName alternateName) {
	...
	public ON_DEMAND_EVENT(Attendee attendee) {
	...
	public ON_DEMAND_EVENT(Audience audience) {
	...
	public ON_DEMAND_EVENT(Composer composer) {
	...
	public ON_DEMAND_EVENT(Contributor contributor) {
	...
	public ON_DEMAND_EVENT(Description description) {
	...
	public ON_DEMAND_EVENT(Director director) {
	...
	public ON_DEMAND_EVENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public ON_DEMAND_EVENT(DoorTime doorTime) {
	...
	public ON_DEMAND_EVENT(Duration duration) {
	...
	public ON_DEMAND_EVENT(EndDate endDate) {
		setEndDate(endDate);
	}
	...
	public ON_DEMAND_EVENT(EventStatus eventStatus) {
	...
	public ON_DEMAND_EVENT(Funder funder) {
		setFunder(funder);
	}
	...
	public ON_DEMAND_EVENT(Identifier identifier) {
	...
	public ON_DEMAND_EVENT(Image image) {
		setImage(image);
	}
	...
	public ON_DEMAND_EVENT(InLanguage inLanguage) {
	...
	public ON_DEMAND_EVENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public ON_DEMAND_EVENT(Location location) {
	...
	public ON_DEMAND_EVENT(MainEntityOfPage mainEntityOfPage) {
	...
	public ON_DEMAND_EVENT(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public ON_DEMAND_EVENT(Name name) {
		setName(name);
	}
	...
	public ON_DEMAND_EVENT(NameFuzzy nameFuzzy) {
	...
	public ON_DEMAND_EVENT(NameRuby nameRuby) {
	...
	public ON_DEMAND_EVENT(Offers offers) {
		setOffers(offers);
	}
	...
	public ON_DEMAND_EVENT(Organizer organizer) {
	...
	public ON_DEMAND_EVENT(Performer performer) {
	...
	public ON_DEMAND_EVENT(PotentialAction potentialAction) {
	...
	public ON_DEMAND_EVENT(PreviousStartDate previousStartDate) {
	...
	public ON_DEMAND_EVENT(PublishedBy publishedBy) {
	...
	public ON_DEMAND_EVENT(PublishedOn publishedOn) {
	...
	public ON_DEMAND_EVENT(RecordedIn recordedIn) {
	...
	public ON_DEMAND_EVENT(RemainingAttendeeCapacity remainingAttendeeCapacity) {
	...
	public ON_DEMAND_EVENT(Review review) {
		setReview(review);
	}
	...
	public ON_DEMAND_EVENT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ON_DEMAND_EVENT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public ON_DEMAND_EVENT(StartDate startDate) {
	...
	public ON_DEMAND_EVENT(SubEvent subEvent) {
	...
	public ON_DEMAND_EVENT(SubjectOf subjectOf) {
	...
	public ON_DEMAND_EVENT(SuperEvent superEvent) {
	...
	public ON_DEMAND_EVENT(Translator translator) {
	...
	public ON_DEMAND_EVENT(TypicalAgeRange typicalAgeRange) {
	...
	public ON_DEMAND_EVENT(Url url) {
		setUrl(url);
	}
	...
	public ON_DEMAND_EVENT(WorkFeatured workFeatured) {
	...
	public ON_DEMAND_EVENT(WorkPerformed workPerformed) {
	...
	public void copy(Clazz.OnDemandEvent org) {
		setSeq(org.getSeq());
