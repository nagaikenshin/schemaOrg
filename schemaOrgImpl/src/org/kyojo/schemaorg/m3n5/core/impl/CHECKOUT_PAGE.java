...
public class CHECKOUT_PAGE implements Clazz.CheckoutPage {
	...
	public CHECKOUT_PAGE(Long seq) {
		setSeq(seq);
	}

	public CHECKOUT_PAGE(String string) {
	...
	public CHECKOUT_PAGE(About about) {
		setAbout(about);
	}
	...
	public CHECKOUT_PAGE(AccessMode accessMode) {
	...
	public CHECKOUT_PAGE(AccessModeSufficient accessModeSufficient) {
	...
	public CHECKOUT_PAGE(AccessibilityAPI accessibilityAPI) {
	...
	public CHECKOUT_PAGE(AccessibilityControl accessibilityControl) {
	...
	public CHECKOUT_PAGE(AccessibilityFeature accessibilityFeature) {
	...
	public CHECKOUT_PAGE(AccessibilityHazard accessibilityHazard) {
	...
	public CHECKOUT_PAGE(AccessibilitySummary accessibilitySummary) {
	...
	public CHECKOUT_PAGE(AccountablePerson accountablePerson) {
	...
	public CHECKOUT_PAGE(AdditionalType additionalType) {
	...
	public CHECKOUT_PAGE(AggregateRating aggregateRating) {
	...
	public CHECKOUT_PAGE(AlternateName alternateName) {
	...
	public CHECKOUT_PAGE(AlternativeHeadline alternativeHeadline) {
	...
	public CHECKOUT_PAGE(AssociatedMedia associatedMedia) {
	...
	public CHECKOUT_PAGE(Audience audience) {
	...
	public CHECKOUT_PAGE(Audio audio) {
		setAudio(audio);
	}
	...
	public CHECKOUT_PAGE(Author author) {
		setAuthor(author);
	}
	...
	public CHECKOUT_PAGE(Award award) {
		setAward(award);
	}
	...
	public CHECKOUT_PAGE(Breadcrumb breadcrumb) {
	...
	public CHECKOUT_PAGE(Character character) {
	...
	public CHECKOUT_PAGE(Citation citation) {
	...
	public CHECKOUT_PAGE(Comment comment) {
		setComment(comment);
	}
	...
	public CHECKOUT_PAGE(CommentCount commentCount) {
	...
	public CHECKOUT_PAGE(ContentLocation contentLocation) {
	...
	public CHECKOUT_PAGE(ContentRating contentRating) {
	...
	public CHECKOUT_PAGE(ContentReferenceTime contentReferenceTime) {
	...
	public CHECKOUT_PAGE(Contributor contributor) {
	...
	public CHECKOUT_PAGE(CopyrightHolder copyrightHolder) {
	...
	public CHECKOUT_PAGE(CopyrightYear copyrightYear) {
	...
	public CHECKOUT_PAGE(Correction correction) {
	...
	public CHECKOUT_PAGE(Creator creator) {
		setCreator(creator);
	}
	...
	public CHECKOUT_PAGE(DateCreated dateCreated) {
	...
	public CHECKOUT_PAGE(DateModified dateModified) {
	...
	public CHECKOUT_PAGE(DatePublished datePublished) {
	...
	public CHECKOUT_PAGE(Description description) {
	...
	public CHECKOUT_PAGE(DisambiguatingDescription disambiguatingDescription) {
	...
	public CHECKOUT_PAGE(DiscussionUrl discussionUrl) {
	...
	public CHECKOUT_PAGE(Editor editor) {
		setEditor(editor);
	}
	...
	public CHECKOUT_PAGE(EducationalAlignment educationalAlignment) {
	...
	public CHECKOUT_PAGE(EducationalUse educationalUse) {
	...
	public CHECKOUT_PAGE(Encoding encoding) {
	...
	public CHECKOUT_PAGE(EncodingFormat encodingFormat) {
	...
	public CHECKOUT_PAGE(ExampleOfWork exampleOfWork) {
	...
	public CHECKOUT_PAGE(Expires expires) {
		setExpires(expires);
	}
	...
	public CHECKOUT_PAGE(Funder funder) {
		setFunder(funder);
	}
	...
	public CHECKOUT_PAGE(Genre genre) {
		setGenre(genre);
	}
	...
	public CHECKOUT_PAGE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public CHECKOUT_PAGE(Headline headline) {
	...
	public CHECKOUT_PAGE(Identifier identifier) {
	...
	public CHECKOUT_PAGE(Image image) {
		setImage(image);
	}
	...
	public CHECKOUT_PAGE(InLanguage inLanguage) {
	...
	public CHECKOUT_PAGE(InteractionStatistic interactionStatistic) {
	...
	public CHECKOUT_PAGE(InteractivityType interactivityType) {
	...
	public CHECKOUT_PAGE(IsAccessibleForFree isAccessibleForFree) {
	...
	public CHECKOUT_PAGE(IsBasedOn isBasedOn) {
	...
	public CHECKOUT_PAGE(IsFamilyFriendly isFamilyFriendly) {
	...
	public CHECKOUT_PAGE(IsPartOf isPartOf) {
	...
	public CHECKOUT_PAGE(Keywords keywords) {
	...
	public CHECKOUT_PAGE(LastReviewed lastReviewed) {
	...
	public CHECKOUT_PAGE(LearningResourceType learningResourceType) {
	...
	public CHECKOUT_PAGE(License license) {
		setLicense(license);
	}
	...
	public CHECKOUT_PAGE(LocationCreated locationCreated) {
	...
	public CHECKOUT_PAGE(MainContentOfPage mainContentOfPage) {
	...
	public CHECKOUT_PAGE(MainEntity mainEntity) {
	...
	public CHECKOUT_PAGE(MainEntityOfPage mainEntityOfPage) {
	...
	public CHECKOUT_PAGE(Material material) {
	...
	public CHECKOUT_PAGE(MaterialExtent materialExtent) {
	...
	public CHECKOUT_PAGE(Mentions mentions) {
	...
	public CHECKOUT_PAGE(Name name) {
		setName(name);
	}
	...
	public CHECKOUT_PAGE(NameFuzzy nameFuzzy) {
	...
	public CHECKOUT_PAGE(NameRuby nameRuby) {
	...
	public CHECKOUT_PAGE(Offers offers) {
		setOffers(offers);
	}
	...
	public CHECKOUT_PAGE(Position position) {
	...
	public CHECKOUT_PAGE(PotentialAction potentialAction) {
	...
	public CHECKOUT_PAGE(PrimaryImageOfPage primaryImageOfPage) {
	...
	public CHECKOUT_PAGE(Producer producer) {
	...
	public CHECKOUT_PAGE(Provider provider) {
	...
	public CHECKOUT_PAGE(Publication publication) {
	...
	public CHECKOUT_PAGE(Publisher publisher) {
	...
	public CHECKOUT_PAGE(PublisherImprint publisherImprint) {
	...
	public CHECKOUT_PAGE(PublishingPrinciples publishingPrinciples) {
	...
	public CHECKOUT_PAGE(RecordedAt recordedAt) {
	...
	public CHECKOUT_PAGE(RelatedLink relatedLink) {
	...
	public CHECKOUT_PAGE(ReleasedEvent releasedEvent) {
	...
	public CHECKOUT_PAGE(Review review) {
		setReview(review);
	}
	...
	public CHECKOUT_PAGE(ReviewedBy reviewedBy) {
	...
	public CHECKOUT_PAGE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CHECKOUT_PAGE(SchemaVersion schemaVersion) {
	...
	public CHECKOUT_PAGE(SdDatePublished sdDatePublished) {
	...
	public CHECKOUT_PAGE(SdLicense sdLicense) {
	...
	public CHECKOUT_PAGE(SdPublisher sdPublisher) {
	...
	public CHECKOUT_PAGE(SignificantLink significantLink) {
	...
	public CHECKOUT_PAGE(SourceOrganization sourceOrganization) {
	...
	public CHECKOUT_PAGE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public CHECKOUT_PAGE(SpatialCoverage spatialCoverage) {
	...
	public CHECKOUT_PAGE(Speakable speakable) {
	...
	public CHECKOUT_PAGE(Specialty specialty) {
	...
	public CHECKOUT_PAGE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public CHECKOUT_PAGE(SubjectOf subjectOf) {
	...
	public CHECKOUT_PAGE(Temporal temporal) {
	...
	public CHECKOUT_PAGE(TemporalCoverage temporalCoverage) {
	...
	public CHECKOUT_PAGE(Text text) {
		setText(text);
	}
	...
	public CHECKOUT_PAGE(ThumbnailUrl thumbnailUrl) {
	...
	public CHECKOUT_PAGE(TimeRequired timeRequired) {
	...
	public CHECKOUT_PAGE(TranslationOfWork translationOfWork) {
	...
	public CHECKOUT_PAGE(Translator translator) {
	...
	public CHECKOUT_PAGE(TypicalAgeRange typicalAgeRange) {
	...
	public CHECKOUT_PAGE(Version version) {
		setVersion(version);
	}
	...
	public CHECKOUT_PAGE(Video video) {
		setVideo(video);
	}
	...
	public CHECKOUT_PAGE(WorkExample workExample) {
	...
	public CHECKOUT_PAGE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.CheckoutPage org) {
		setSeq(org.getSeq());
