...
public class ACCOMMODATION implements Clazz.Accommodation {
	...
	public ACCOMMODATION(GeoContains geoContains) {
	...
	public ACCOMMODATION(GeoCoveredBy geoCoveredBy) {
	...
	public ACCOMMODATION(GeoCovers geoCovers) {
	...
	public ACCOMMODATION(GeoCrosses geoCrosses) {
	...
	public ACCOMMODATION(GeoDisjoint geoDisjoint) {
	...
	public ACCOMMODATION(GeoEquals geoEquals) {
	...
	public ACCOMMODATION(GeoIntersects geoIntersects) {
	...
	public ACCOMMODATION(GeoOverlaps geoOverlaps) {
	...
	public ACCOMMODATION(GeoTouches geoTouches) {
	...
	public ACCOMMODATION(GeoWithin geoWithin) {
	...
	public ACCOMMODATION(Slogan slogan) {
		setSlogan(slogan);
	}
