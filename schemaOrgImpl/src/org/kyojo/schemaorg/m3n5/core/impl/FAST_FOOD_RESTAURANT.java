...
public class FAST_FOOD_RESTAURANT implements Clazz.FastFoodRestaurant {
	...
	public FAST_FOOD_RESTAURANT(GeoContains geoContains) {
	...
	public FAST_FOOD_RESTAURANT(GeoCoveredBy geoCoveredBy) {
	...
	public FAST_FOOD_RESTAURANT(GeoCovers geoCovers) {
	...
	public FAST_FOOD_RESTAURANT(GeoCrosses geoCrosses) {
	...
	public FAST_FOOD_RESTAURANT(GeoDisjoint geoDisjoint) {
	...
	public FAST_FOOD_RESTAURANT(GeoEquals geoEquals) {
	...
	public FAST_FOOD_RESTAURANT(GeoIntersects geoIntersects) {
	...
	public FAST_FOOD_RESTAURANT(GeoOverlaps geoOverlaps) {
	...
	public FAST_FOOD_RESTAURANT(GeoTouches geoTouches) {
	...
	public FAST_FOOD_RESTAURANT(GeoWithin geoWithin) {
	...
	public FAST_FOOD_RESTAURANT(Slogan slogan) {
		setSlogan(slogan);
	}
