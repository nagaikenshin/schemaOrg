...
public class PLACE_OF_WORSHIP implements Clazz.PlaceOfWorship {
	...
	public PLACE_OF_WORSHIP(GeoContains geoContains) {
	...
	public PLACE_OF_WORSHIP(GeoCoveredBy geoCoveredBy) {
	...
	public PLACE_OF_WORSHIP(GeoCovers geoCovers) {
	...
	public PLACE_OF_WORSHIP(GeoCrosses geoCrosses) {
	...
	public PLACE_OF_WORSHIP(GeoDisjoint geoDisjoint) {
	...
	public PLACE_OF_WORSHIP(GeoEquals geoEquals) {
	...
	public PLACE_OF_WORSHIP(GeoIntersects geoIntersects) {
	...
	public PLACE_OF_WORSHIP(GeoOverlaps geoOverlaps) {
	...
	public PLACE_OF_WORSHIP(GeoTouches geoTouches) {
	...
	public PLACE_OF_WORSHIP(GeoWithin geoWithin) {
	...
	public PLACE_OF_WORSHIP(Slogan slogan) {
		setSlogan(slogan);
	}
