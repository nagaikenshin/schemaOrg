...
import org.kyojo.schemaorg.m3n5.core.Container.ScreenCount;
...
public class MOVIE_THEATER implements Clazz.MovieTheater {
	...
	public MOVIE_THEATER(GeoContains geoContains) {
	...
	public MOVIE_THEATER(GeoCoveredBy geoCoveredBy) {
	...
	public MOVIE_THEATER(GeoCovers geoCovers) {
	...
	public MOVIE_THEATER(GeoCrosses geoCrosses) {
	...
	public MOVIE_THEATER(GeoDisjoint geoDisjoint) {
	...
	public MOVIE_THEATER(GeoEquals geoEquals) {
	...
	public MOVIE_THEATER(GeoIntersects geoIntersects) {
	...
	public MOVIE_THEATER(GeoOverlaps geoOverlaps) {
	...
	public MOVIE_THEATER(GeoTouches geoTouches) {
	...
	public MOVIE_THEATER(GeoWithin geoWithin) {
	...
	public MOVIE_THEATER(Slogan slogan) {
		setSlogan(slogan);
	}
