...
public class AUTHENTICATOR implements Container.Authenticator {
	...
	public AUTHENTICATOR(AccountingService accountingService) {
	...
	public AUTHENTICATOR(AdultEntertainment adultEntertainment) {
	...
	public AUTHENTICATOR(Airline airline) {
	...
	public AUTHENTICATOR(AmusementPark amusementPark) {
	...
	public AUTHENTICATOR(AnimalShelter animalShelter) {
	...
	public AUTHENTICATOR(ArchiveOrganization archiveOrganization) {
	...
	public AUTHENTICATOR(ArtGallery artGallery) {
	...
	public AUTHENTICATOR(Attorney attorney) {
	...
	public AUTHENTICATOR(AutoBodyShop autoBodyShop) {
	...
	public AUTHENTICATOR(AutoDealer autoDealer) {
	...
	public AUTHENTICATOR(AutoPartsStore autoPartsStore) {
	...
	public AUTHENTICATOR(AutoRental autoRental) {
	...
	public AUTHENTICATOR(AutoRepair autoRepair) {
	...
	public AUTHENTICATOR(AutoWash autoWash) {
	...
	public AUTHENTICATOR(AutomatedTeller automatedTeller) {
	...
	public AUTHENTICATOR(AutomotiveBusiness automotiveBusiness) {
	...
	public AUTHENTICATOR(Bakery bakery) {
	...
	public AUTHENTICATOR(BankOrCreditUnion bankOrCreditUnion) {
	...
	public AUTHENTICATOR(BarOrPub barOrPub) {
	...
	public AUTHENTICATOR(BeautySalon beautySalon) {
	...
	public AUTHENTICATOR(BedAndBreakfast bedAndBreakfast) {
	...
	public AUTHENTICATOR(BikeStore bikeStore) {
	...
	public AUTHENTICATOR(BookStore bookStore) {
	...
	public AUTHENTICATOR(BowlingAlley bowlingAlley) {
	...
	public AUTHENTICATOR(Brewery brewery) {
	...
	public AUTHENTICATOR(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public AUTHENTICATOR(Campground campground) {
	...
	public AUTHENTICATOR(Casino casino) {
	...
	public AUTHENTICATOR(ChildCare childCare) {
	...
	public AUTHENTICATOR(ClothingStore clothingStore) {
	...
	public AUTHENTICATOR(CollegeOrUniversity collegeOrUniversity) {
	...
	public AUTHENTICATOR(ComedyClub comedyClub) {
	...
	public AUTHENTICATOR(CommunityHealth communityHealth) {
	...
	public AUTHENTICATOR(ComputerStore computerStore) {
	...
	public AUTHENTICATOR(Consortium consortium) {
	...
	public AUTHENTICATOR(ConvenienceStore convenienceStore) {
	...
	public AUTHENTICATOR(Corporation corporation) {
	...
	public AUTHENTICATOR(DanceGroup danceGroup) {
	...
	public AUTHENTICATOR(DaySpa daySpa) {
	...
	public AUTHENTICATOR(Dentist dentist) {
	...
	public AUTHENTICATOR(DepartmentStore departmentStore) {
	...
	public AUTHENTICATOR(Dermatology dermatology) {
	...
	public AUTHENTICATOR(DiagnosticLab diagnosticLab) {
	...
	public AUTHENTICATOR(DietNutrition dietNutrition) {
	...
	public AUTHENTICATOR(Distillery distillery) {
	...
	public AUTHENTICATOR(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public AUTHENTICATOR(EducationalOrganization educationalOrganization) {
	...
	public AUTHENTICATOR(Electrician electrician) {
	...
	public AUTHENTICATOR(ElectronicsStore electronicsStore) {
	...
	public AUTHENTICATOR(ElementarySchool elementarySchool) {
	...
	public AUTHENTICATOR(Emergency emergency) {
	...
	public AUTHENTICATOR(EmergencyService emergencyService) {
	...
	public AUTHENTICATOR(EmploymentAgency employmentAgency) {
	...
	public AUTHENTICATOR(EntertainmentBusiness entertainmentBusiness) {
	...
	public AUTHENTICATOR(ExerciseGym exerciseGym) {
	...
	public AUTHENTICATOR(FastFoodRestaurant fastFoodRestaurant) {
	...
	public AUTHENTICATOR(FinancialService financialService) {
	...
	public AUTHENTICATOR(FireStation fireStation) {
	...
	public AUTHENTICATOR(Florist florist) {
	...
	public AUTHENTICATOR(FoodEstablishment foodEstablishment) {
	...
	public AUTHENTICATOR(FundingAgency fundingAgency) {
	...
	public AUTHENTICATOR(FundingScheme fundingScheme) {
	...
	public AUTHENTICATOR(FurnitureStore furnitureStore) {
	...
	public AUTHENTICATOR(GardenStore gardenStore) {
	...
	public AUTHENTICATOR(GasStation gasStation) {
	...
	public AUTHENTICATOR(GeneralContractor generalContractor) {
	...
	public AUTHENTICATOR(Geriatric geriatric) {
	...
	public AUTHENTICATOR(GolfCourse golfCourse) {
	...
	public AUTHENTICATOR(GovernmentOffice governmentOffice) {
	...
	public AUTHENTICATOR(GovernmentOrganization governmentOrganization) {
	...
	public AUTHENTICATOR(GroceryStore groceryStore) {
	...
	public AUTHENTICATOR(Gynecologic gynecologic) {
	...
	public AUTHENTICATOR(HVACBusiness hvacBusiness) {
	...
	public AUTHENTICATOR(HairSalon hairSalon) {
	...
	public AUTHENTICATOR(HardwareStore hardwareStore) {
	...
	public AUTHENTICATOR(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public AUTHENTICATOR(HealthClub healthClub) {
	...
	public AUTHENTICATOR(HighSchool highSchool) {
	...
	public AUTHENTICATOR(HobbyShop hobbyShop) {
	...
	public AUTHENTICATOR(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public AUTHENTICATOR(HomeGoodsStore homeGoodsStore) {
	...
	public AUTHENTICATOR(Hospital hospital) {
	...
	public AUTHENTICATOR(Hostel hostel) {
	...
	public AUTHENTICATOR(Hotel hotel) {
	...
	public AUTHENTICATOR(HousePainter housePainter) {
	...
	public AUTHENTICATOR(IceCreamShop iceCreamShop) {
	...
	public AUTHENTICATOR(InsuranceAgency insuranceAgency) {
	...
	public AUTHENTICATOR(InternetCafe internetCafe) {
	...
	public AUTHENTICATOR(JewelryStore jewelryStore) {
	...
	public AUTHENTICATOR(LegalService legalService) {
	...
	public AUTHENTICATOR(Library library) {
	...
	public AUTHENTICATOR(LibrarySystem librarySystem) {
	...
	public AUTHENTICATOR(LiquorStore liquorStore) {
	...
	public AUTHENTICATOR(LocalBusiness localBusiness) {
	...
	public AUTHENTICATOR(Locksmith locksmith) {
	...
	public AUTHENTICATOR(LodgingBusiness lodgingBusiness) {
	...
	public AUTHENTICATOR(MedicalBusiness medicalBusiness) {
	...
	public AUTHENTICATOR(MedicalClinic medicalClinic) {
	...
	public AUTHENTICATOR(MedicalOrganization medicalOrganization) {
	...
	public AUTHENTICATOR(MensClothingStore mensClothingStore) {
	...
	public AUTHENTICATOR(MiddleSchool middleSchool) {
	...
	public AUTHENTICATOR(Midwifery midwifery) {
	...
	public AUTHENTICATOR(MobilePhoneStore mobilePhoneStore) {
	...
	public AUTHENTICATOR(Motel motel) {
	...
	public AUTHENTICATOR(MotorcycleDealer motorcycleDealer) {
	...
	public AUTHENTICATOR(MotorcycleRepair motorcycleRepair) {
	...
	public AUTHENTICATOR(MovieRentalStore movieRentalStore) {
	...
	public AUTHENTICATOR(MovieTheater movieTheater) {
	...
	public AUTHENTICATOR(MovingCompany movingCompany) {
	...
	public AUTHENTICATOR(MusicGroup musicGroup) {
	...
	public AUTHENTICATOR(MusicStore musicStore) {
	...
	public AUTHENTICATOR(NailSalon nailSalon) {
	...
	public AUTHENTICATOR(NewsMediaOrganization newsMediaOrganization) {
	...
	public AUTHENTICATOR(NightClub nightClub) {
	...
	public AUTHENTICATOR(Notary notary) {
	...
	public AUTHENTICATOR(Nursing nursing) {
	...
	public AUTHENTICATOR(Obstetric obstetric) {
	...
	public AUTHENTICATOR(OfficeEquipmentStore officeEquipmentStore) {
	...
	public AUTHENTICATOR(Oncologic oncologic) {
	...
	public AUTHENTICATOR(Optician optician) {
	...
	public AUTHENTICATOR(Optometric optometric) {
	...
	public AUTHENTICATOR(Otolaryngologic otolaryngologic) {
	...
	public AUTHENTICATOR(OutletStore outletStore) {
	...
	public AUTHENTICATOR(PawnShop pawnShop) {
	...
	public AUTHENTICATOR(Pediatric pediatric) {
	...
	public AUTHENTICATOR(PerformingGroup performingGroup) {
	...
	public AUTHENTICATOR(PetStore petStore) {
	...
	public AUTHENTICATOR(Pharmacy pharmacy) {
	...
	public AUTHENTICATOR(Physician physician) {
	...
	public AUTHENTICATOR(Physiotherapy physiotherapy) {
	...
	public AUTHENTICATOR(PlasticSurgery plasticSurgery) {
	...
	public AUTHENTICATOR(Plumber plumber) {
	...
	public AUTHENTICATOR(Podiatric podiatric) {
	...
	public AUTHENTICATOR(PoliceStation policeStation) {
	...
	public AUTHENTICATOR(PostOffice postOffice) {
	...
	public AUTHENTICATOR(Preschool preschool) {
	...
	public AUTHENTICATOR(PrimaryCare primaryCare) {
	...
	public AUTHENTICATOR(ProfessionalService professionalService) {
	...
	public AUTHENTICATOR(Psychiatric psychiatric) {
	...
	public AUTHENTICATOR(PublicHealth publicHealth) {
	...
	public AUTHENTICATOR(PublicSwimmingPool publicSwimmingPool) {
	...
	public AUTHENTICATOR(RadioStation radioStation) {
	...
	public AUTHENTICATOR(RealEstateAgent realEstateAgent) {
	...
	public AUTHENTICATOR(RecyclingCenter recyclingCenter) {
	...
	public AUTHENTICATOR(ResearchProject researchProject) {
	...
	public AUTHENTICATOR(Resort resort) {
	...
	public AUTHENTICATOR(Restaurant restaurant) {
	...
	public AUTHENTICATOR(RoofingContractor roofingContractor) {
	...
	public AUTHENTICATOR(School school) {
	...
	public AUTHENTICATOR(SelfStorage selfStorage) {
	...
	public AUTHENTICATOR(ShoeStore shoeStore) {
	...
	public AUTHENTICATOR(ShoppingCenter shoppingCenter) {
	...
	public AUTHENTICATOR(SkiResort skiResort) {
	...
	public AUTHENTICATOR(SportingGoodsStore sportingGoodsStore) {
	...
	public AUTHENTICATOR(SportsActivityLocation sportsActivityLocation) {
	...
	public AUTHENTICATOR(SportsClub sportsClub) {
	...
	public AUTHENTICATOR(SportsOrganization sportsOrganization) {
	...
	public AUTHENTICATOR(SportsTeam sportsTeam) {
	...
	public AUTHENTICATOR(StadiumOrArena stadiumOrArena) {
	...
	public AUTHENTICATOR(Store store) {
	...
	public AUTHENTICATOR(TattooParlor tattooParlor) {
	...
	public AUTHENTICATOR(TelevisionStation televisionStation) {
	...
	public AUTHENTICATOR(TennisComplex tennisComplex) {
	...
	public AUTHENTICATOR(TheaterGroup theaterGroup) {
	...
	public AUTHENTICATOR(TireShop tireShop) {
	...
	public AUTHENTICATOR(TouristInformationCenter touristInformationCenter) {
	...
	public AUTHENTICATOR(ToyStore toyStore) {
	...
	public AUTHENTICATOR(TravelAgency travelAgency) {
	...
	public AUTHENTICATOR(VeterinaryCare veterinaryCare) {
	...
	public AUTHENTICATOR(WholesaleStore wholesaleStore) {
	...
	public AUTHENTICATOR(Winery winery) {
	...
	public AUTHENTICATOR(WorkersUnion workersUnion) {
	...
	public void copy(Container.Authenticator org) {
