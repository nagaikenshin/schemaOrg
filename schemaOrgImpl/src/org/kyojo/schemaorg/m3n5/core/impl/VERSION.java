...
public class VERSION implements Container.Version {
	...
	public VERSION(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public VERSION(Float fl0at) {
	...
	public VERSION(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public VERSION(Integer integer) {
	...
	public VERSION(java.math.BigDecimal number) {
	...
	public VERSION(List<Float> fl0atList,
	...
	public void copy(Container.Version org) {
