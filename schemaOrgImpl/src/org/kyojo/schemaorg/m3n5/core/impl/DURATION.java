...
public class DURATION implements Clazz.Duration, Container.Duration {
	...
	public DURATION(AdditionalType additionalType) {
	...
	public DURATION(AlternateName alternateName) {
	...
	public DURATION(Description description) {
	...
	public DURATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public DURATION(Clazz.Duration duration) {
		durationList = new ArrayList<Clazz.Duration>();
	...
	public DURATION(Identifier identifier) {
	...
	public DURATION(MainEntityOfPage mainEntityOfPage) {
	...
	public DURATION(NameFuzzy nameFuzzy) {
	...
	public DURATION(NameRuby nameRuby) {
	...
	public DURATION(PotentialAction potentialAction) {
	...
	public DURATION(SubjectOf subjectOf) {
	...
	public void copy(Clazz.Duration org) {
		setSeq(org.getSeq());
	...
	public void copy(Container.Duration org) {
