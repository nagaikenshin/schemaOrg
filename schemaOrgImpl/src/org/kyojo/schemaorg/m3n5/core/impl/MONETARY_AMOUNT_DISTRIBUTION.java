...
public class MONETARY_AMOUNT_DISTRIBUTION implements Clazz.MonetaryAmountDistribution {
	...
	public MONETARY_AMOUNT_DISTRIBUTION(Duration duration) {
	...
	public MONETARY_AMOUNT_DISTRIBUTION(Median median) {
		setMedian(median);
	}
	...
	public MONETARY_AMOUNT_DISTRIBUTION(Percentile10 percentile10) {
	...
	public MONETARY_AMOUNT_DISTRIBUTION(Percentile25 percentile25) {
	...
	public MONETARY_AMOUNT_DISTRIBUTION(Percentile75 percentile75) {
	...
	public MONETARY_AMOUNT_DISTRIBUTION(Percentile90 percentile90) {
