...
public class SUBJECT_OF implements Container.SubjectOf {
	...
	public SUBJECT_OF(APIReference apiReference) {
	...
	public SUBJECT_OF(AboutPage aboutPage) {
	...
	public SUBJECT_OF(AdvertiserContentArticle advertiserContentArticle) {
	...
	public SUBJECT_OF(AnalysisNewsArticle analysisNewsArticle) {
	...
	public SUBJECT_OF(Answer answer) {
	...
	public SUBJECT_OF(ArchiveComponent archiveComponent) {
	...
	public SUBJECT_OF(Article article) {
	...
	public SUBJECT_OF(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public SUBJECT_OF(AudioObject audioObject) {
	...
	public SUBJECT_OF(Audiobook audiobook) {
	...
	public SUBJECT_OF(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public SUBJECT_OF(Barcode barcode) {
	...
	public SUBJECT_OF(BlogPosting blogPosting) {
	...
	public SUBJECT_OF(BookSeries bookSeries) {
	...
	public SUBJECT_OF(BroadcastEvent broadcastEvent) {
	...
	public SUBJECT_OF(BusinessEvent businessEvent) {
	...
	public SUBJECT_OF(CategoryCodeSet categoryCodeSet) {
	...
	public SUBJECT_OF(Chapter chapter) {
	...
	public SUBJECT_OF(CheckoutPage checkoutPage) {
	...
	public SUBJECT_OF(ChildrensEvent childrensEvent) {
	...
	public SUBJECT_OF(ClaimReview claimReview) {
	...
	public SUBJECT_OF(Collection collection) {
	...
	public SUBJECT_OF(CollectionPage collectionPage) {
	...
	public SUBJECT_OF(ComedyEvent comedyEvent) {
	...
	public SUBJECT_OF(ComicCoverArt comicCoverArt) {
	...
	public SUBJECT_OF(ComicIssue comicIssue) {
	...
	public SUBJECT_OF(ComicSeries comicSeries) {
	...
	public SUBJECT_OF(ComicStory comicStory) {
	...
	public SUBJECT_OF(Comment comment) {
	...
	public SUBJECT_OF(CompleteDataFeed completeDataFeed) {
	...
	public SUBJECT_OF(ContactPage contactPage) {
	...
	public SUBJECT_OF(Conversation conversation) {
	...
	public SUBJECT_OF(CorrectionComment correctionComment) {
	...
	public SUBJECT_OF(Course course) {
	...
	public SUBJECT_OF(CourseInstance courseInstance) {
	...
	public SUBJECT_OF(CoverArt coverArt) {
	...
	public SUBJECT_OF(CreativeWorkSeason creativeWorkSeason) {
	...
	public SUBJECT_OF(CreativeWorkSeries creativeWorkSeries) {
	...
	public SUBJECT_OF(CriticReview criticReview) {
	...
	public SUBJECT_OF(DanceEvent danceEvent) {
	...
	public SUBJECT_OF(DataCatalog dataCatalog) {
	...
	public SUBJECT_OF(DataDownload dataDownload) {
	...
	public SUBJECT_OF(DataFeed dataFeed) {
	...
	public SUBJECT_OF(Dataset dataset) {
	...
	public SUBJECT_OF(DefinedTermSet definedTermSet) {
	...
	public SUBJECT_OF(DeliveryEvent deliveryEvent) {
	...
	public SUBJECT_OF(DigitalDocument digitalDocument) {
	...
	public SUBJECT_OF(DiscussionForumPosting discussionForumPosting) {
	...
	public SUBJECT_OF(Drawing drawing) {
	...
	public SUBJECT_OF(EducationEvent educationEvent) {
	...
	public SUBJECT_OF(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public SUBJECT_OF(EmailMessage emailMessage) {
	...
	public SUBJECT_OF(EmployerReview employerReview) {
	...
	public SUBJECT_OF(Episode episode) {
	...
	public SUBJECT_OF(EventSeries eventSeries) {
	...
	public SUBJECT_OF(ExercisePlan exercisePlan) {
	...
	public SUBJECT_OF(ExhibitionEvent exhibitionEvent) {
	...
	public SUBJECT_OF(FAQPage faqPage) {
	...
	public SUBJECT_OF(Festival festival) {
	...
	public SUBJECT_OF(FoodEvent foodEvent) {
	...
	public SUBJECT_OF(HowToDirection howToDirection) {
	...
	public SUBJECT_OF(HowToSection howToSection) {
	...
	public SUBJECT_OF(HowToStep howToStep) {
	...
	public SUBJECT_OF(HowToTip howToTip) {
	...
	public SUBJECT_OF(ImageGallery imageGallery) {
	...
	public SUBJECT_OF(ImageObject imageObject) {
	...
	public SUBJECT_OF(ItemPage itemPage) {
	...
	public SUBJECT_OF(Legislation legislation) {
	...
	public SUBJECT_OF(LegislationObject legislationObject) {
	...
	public SUBJECT_OF(LiteraryEvent literaryEvent) {
	...
	public SUBJECT_OF(LiveBlogPosting liveBlogPosting) {
	...
	public SUBJECT_OF(Manuscript manuscript) {
	...
	public SUBJECT_OF(MediaObject mediaObject) {
	...
	public SUBJECT_OF(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public SUBJECT_OF(MedicalWebPage medicalWebPage) {
	...
	public SUBJECT_OF(MenuSection menuSection) {
	...
	public SUBJECT_OF(Message message) {
	...
	public SUBJECT_OF(MobileApplication mobileApplication) {
	...
	public SUBJECT_OF(MovieClip movieClip) {
	...
	public SUBJECT_OF(MovieSeries movieSeries) {
	...
	public SUBJECT_OF(MusicAlbum musicAlbum) {
	...
	public SUBJECT_OF(MusicComposition musicComposition) {
	...
	public SUBJECT_OF(MusicEvent musicEvent) {
	...
	public SUBJECT_OF(MusicPlaylist musicPlaylist) {
	...
	public SUBJECT_OF(MusicRecording musicRecording) {
	...
	public SUBJECT_OF(MusicRelease musicRelease) {
	...
	public SUBJECT_OF(MusicVideoObject musicVideoObject) {
	...
	public SUBJECT_OF(NewsArticle newsArticle) {
	...
	public SUBJECT_OF(Newspaper newspaper) {
	...
	public SUBJECT_OF(NoteDigitalDocument noteDigitalDocument) {
	...
	public SUBJECT_OF(OnDemandEvent onDemandEvent) {
	...
	public SUBJECT_OF(OpinionNewsArticle opinionNewsArticle) {
	...
	public SUBJECT_OF(Painting painting) {
	...
	public SUBJECT_OF(Periodical periodical) {
	...
	public SUBJECT_OF(Photograph photograph) {
	...
	public SUBJECT_OF(Poster poster) {
	...
	public SUBJECT_OF(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public SUBJECT_OF(ProfilePage profilePage) {
	...
	public SUBJECT_OF(PublicationEvent publicationEvent) {
	...
	public SUBJECT_OF(PublicationIssue publicationIssue) {
	...
	public SUBJECT_OF(PublicationVolume publicationVolume) {
	...
	public SUBJECT_OF(QAPage qaPage) {
	...
	public SUBJECT_OF(Question question) {
	...
	public SUBJECT_OF(Quotation quotation) {
	...
	public SUBJECT_OF(RadioClip radioClip) {
	...
	public SUBJECT_OF(RadioEpisode radioEpisode) {
	...
	public SUBJECT_OF(RadioSeason radioSeason) {
	...
	public SUBJECT_OF(RadioSeries radioSeries) {
	...
	public SUBJECT_OF(Recipe recipe) {
	...
	public SUBJECT_OF(Report report) {
	...
	public SUBJECT_OF(ReportageNewsArticle reportageNewsArticle) {
	...
	public SUBJECT_OF(Review review) {
	...
	public SUBJECT_OF(ReviewNewsArticle reviewNewsArticle) {
	...
	public SUBJECT_OF(SaleEvent saleEvent) {
	...
	public SUBJECT_OF(SatiricalArticle satiricalArticle) {
	...
	public SUBJECT_OF(ScholarlyArticle scholarlyArticle) {
	...
	public SUBJECT_OF(ScreeningEvent screeningEvent) {
	...
	public SUBJECT_OF(Sculpture sculpture) {
	...
	public SUBJECT_OF(SearchResultsPage searchResultsPage) {
	...
	public SUBJECT_OF(SheetMusic sheetMusic) {
	...
	public SUBJECT_OF(ShortStory shortStory) {
	...
	public SUBJECT_OF(SiteNavigationElement siteNavigationElement) {
	...
	public SUBJECT_OF(SocialEvent socialEvent) {
	...
	public SUBJECT_OF(SocialMediaPosting socialMediaPosting) {
	...
	public SUBJECT_OF(SoftwareApplication softwareApplication) {
	...
	public SUBJECT_OF(SoftwareSourceCode softwareSourceCode) {
	...
	public SUBJECT_OF(SportsEvent sportsEvent) {
	...
	public SUBJECT_OF(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public SUBJECT_OF(TVClip tvClip) {
	...
	public SUBJECT_OF(TVEpisode tvEpisode) {
	...
	public SUBJECT_OF(TVSeason tvSeason) {
	...
	public SUBJECT_OF(TVSeries tvSeries) {
	...
	public SUBJECT_OF(TechArticle techArticle) {
	...
	public SUBJECT_OF(TextDigitalDocument textDigitalDocument) {
	...
	public SUBJECT_OF(TheaterEvent theaterEvent) {
	...
	public SUBJECT_OF(Thesis thesis) {
	...
	public SUBJECT_OF(ThreeDimensionalModel threeDimensionalModel) {
	...
	public SUBJECT_OF(UserReview userReview) {
	...
	public SUBJECT_OF(VideoGallery videoGallery) {
	...
	public SUBJECT_OF(VideoGame videoGame) {
	...
	public SUBJECT_OF(VideoGameClip videoGameClip) {
	...
	public SUBJECT_OF(VideoGameSeries videoGameSeries) {
	...
	public SUBJECT_OF(VideoObject videoObject) {
	...
	public SUBJECT_OF(VisualArtsEvent visualArtsEvent) {
	...
	public SUBJECT_OF(VisualArtwork visualArtwork) {
	...
	public SUBJECT_OF(WPAdBlock wpAdBlock) {
	...
	public SUBJECT_OF(WPFooter wpFooter) {
	...
	public SUBJECT_OF(WPHeader wpHeader) {
	...
	public SUBJECT_OF(WPSideBar wpSideBar) {
	...
	public SUBJECT_OF(WebApplication webApplication) {
	...
	public SUBJECT_OF(WebPage webPage) {
	...
	public SUBJECT_OF(WebPageElement webPageElement) {
	...
	public SUBJECT_OF(WebSite webSite) {
