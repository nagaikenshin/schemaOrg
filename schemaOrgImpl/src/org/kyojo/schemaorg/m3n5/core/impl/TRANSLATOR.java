...
public class TRANSLATOR implements Container.Translator {
	...
	public TRANSLATOR(AccountingService accountingService) {
	...
	public TRANSLATOR(AdultEntertainment adultEntertainment) {
	...
	public TRANSLATOR(Airline airline) {
	...
	public TRANSLATOR(AmusementPark amusementPark) {
	...
	public TRANSLATOR(AnimalShelter animalShelter) {
	...
	public TRANSLATOR(ArchiveOrganization archiveOrganization) {
	...
	public TRANSLATOR(ArtGallery artGallery) {
	...
	public TRANSLATOR(Attorney attorney) {
	...
	public TRANSLATOR(AutoBodyShop autoBodyShop) {
	...
	public TRANSLATOR(AutoDealer autoDealer) {
	...
	public TRANSLATOR(AutoPartsStore autoPartsStore) {
	...
	public TRANSLATOR(AutoRental autoRental) {
	...
	public TRANSLATOR(AutoRepair autoRepair) {
	...
	public TRANSLATOR(AutoWash autoWash) {
	...
	public TRANSLATOR(AutomatedTeller automatedTeller) {
	...
	public TRANSLATOR(AutomotiveBusiness automotiveBusiness) {
	...
	public TRANSLATOR(Bakery bakery) {
	...
	public TRANSLATOR(BankOrCreditUnion bankOrCreditUnion) {
	...
	public TRANSLATOR(BarOrPub barOrPub) {
	...
	public TRANSLATOR(BeautySalon beautySalon) {
	...
	public TRANSLATOR(BedAndBreakfast bedAndBreakfast) {
	...
	public TRANSLATOR(BikeStore bikeStore) {
	...
	public TRANSLATOR(BookStore bookStore) {
	...
	public TRANSLATOR(BowlingAlley bowlingAlley) {
	...
	public TRANSLATOR(Brewery brewery) {
	...
	public TRANSLATOR(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public TRANSLATOR(Campground campground) {
	...
	public TRANSLATOR(Casino casino) {
	...
	public TRANSLATOR(ChildCare childCare) {
	...
	public TRANSLATOR(ClothingStore clothingStore) {
	...
	public TRANSLATOR(CollegeOrUniversity collegeOrUniversity) {
	...
	public TRANSLATOR(ComedyClub comedyClub) {
	...
	public TRANSLATOR(CommunityHealth communityHealth) {
	...
	public TRANSLATOR(ComputerStore computerStore) {
	...
	public TRANSLATOR(Consortium consortium) {
	...
	public TRANSLATOR(ConvenienceStore convenienceStore) {
	...
	public TRANSLATOR(Corporation corporation) {
	...
	public TRANSLATOR(DanceGroup danceGroup) {
	...
	public TRANSLATOR(DaySpa daySpa) {
	...
	public TRANSLATOR(Dentist dentist) {
	...
	public TRANSLATOR(DepartmentStore departmentStore) {
	...
	public TRANSLATOR(Dermatology dermatology) {
	...
	public TRANSLATOR(DiagnosticLab diagnosticLab) {
	...
	public TRANSLATOR(DietNutrition dietNutrition) {
	...
	public TRANSLATOR(Distillery distillery) {
	...
	public TRANSLATOR(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public TRANSLATOR(EducationalOrganization educationalOrganization) {
	...
	public TRANSLATOR(Electrician electrician) {
	...
	public TRANSLATOR(ElectronicsStore electronicsStore) {
	...
	public TRANSLATOR(ElementarySchool elementarySchool) {
	...
	public TRANSLATOR(Emergency emergency) {
	...
	public TRANSLATOR(EmergencyService emergencyService) {
	...
	public TRANSLATOR(EmploymentAgency employmentAgency) {
	...
	public TRANSLATOR(EntertainmentBusiness entertainmentBusiness) {
	...
	public TRANSLATOR(ExerciseGym exerciseGym) {
	...
	public TRANSLATOR(FastFoodRestaurant fastFoodRestaurant) {
	...
	public TRANSLATOR(FinancialService financialService) {
	...
	public TRANSLATOR(FireStation fireStation) {
	...
	public TRANSLATOR(Florist florist) {
	...
	public TRANSLATOR(FoodEstablishment foodEstablishment) {
	...
	public TRANSLATOR(FundingAgency fundingAgency) {
	...
	public TRANSLATOR(FundingScheme fundingScheme) {
	...
	public TRANSLATOR(FurnitureStore furnitureStore) {
	...
	public TRANSLATOR(GardenStore gardenStore) {
	...
	public TRANSLATOR(GasStation gasStation) {
	...
	public TRANSLATOR(GeneralContractor generalContractor) {
	...
	public TRANSLATOR(Geriatric geriatric) {
	...
	public TRANSLATOR(GolfCourse golfCourse) {
	...
	public TRANSLATOR(GovernmentOffice governmentOffice) {
	...
	public TRANSLATOR(GovernmentOrganization governmentOrganization) {
	...
	public TRANSLATOR(GroceryStore groceryStore) {
	...
	public TRANSLATOR(Gynecologic gynecologic) {
	...
	public TRANSLATOR(HVACBusiness hvacBusiness) {
	...
	public TRANSLATOR(HairSalon hairSalon) {
	...
	public TRANSLATOR(HardwareStore hardwareStore) {
	...
	public TRANSLATOR(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public TRANSLATOR(HealthClub healthClub) {
	...
	public TRANSLATOR(HighSchool highSchool) {
	...
	public TRANSLATOR(HobbyShop hobbyShop) {
	...
	public TRANSLATOR(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public TRANSLATOR(HomeGoodsStore homeGoodsStore) {
	...
	public TRANSLATOR(Hospital hospital) {
	...
	public TRANSLATOR(Hostel hostel) {
	...
	public TRANSLATOR(HousePainter housePainter) {
	...
	public TRANSLATOR(IceCreamShop iceCreamShop) {
	...
	public TRANSLATOR(InsuranceAgency insuranceAgency) {
	...
	public TRANSLATOR(InternetCafe internetCafe) {
	...
	public TRANSLATOR(JewelryStore jewelryStore) {
	...
	public TRANSLATOR(LegalService legalService) {
	...
	public TRANSLATOR(Library library) {
	...
	public TRANSLATOR(LibrarySystem librarySystem) {
	...
	public TRANSLATOR(LiquorStore liquorStore) {
	...
	public TRANSLATOR(LocalBusiness localBusiness) {
	...
	public TRANSLATOR(Locksmith locksmith) {
	...
	public TRANSLATOR(LodgingBusiness lodgingBusiness) {
	...
	public TRANSLATOR(MedicalBusiness medicalBusiness) {
	...
	public TRANSLATOR(MedicalClinic medicalClinic) {
	...
	public TRANSLATOR(MedicalOrganization medicalOrganization) {
	...
	public TRANSLATOR(MensClothingStore mensClothingStore) {
	...
	public TRANSLATOR(MiddleSchool middleSchool) {
	...
	public TRANSLATOR(Midwifery midwifery) {
	...
	public TRANSLATOR(MobilePhoneStore mobilePhoneStore) {
	...
	public TRANSLATOR(MotorcycleDealer motorcycleDealer) {
	...
	public TRANSLATOR(MotorcycleRepair motorcycleRepair) {
	...
	public TRANSLATOR(MovieRentalStore movieRentalStore) {
	...
	public TRANSLATOR(MovieTheater movieTheater) {
	...
	public TRANSLATOR(MovingCompany movingCompany) {
	...
	public TRANSLATOR(MusicGroup musicGroup) {
	...
	public TRANSLATOR(MusicStore musicStore) {
	...
	public TRANSLATOR(NailSalon nailSalon) {
	...
	public TRANSLATOR(NewsMediaOrganization newsMediaOrganization) {
	...
	public TRANSLATOR(NightClub nightClub) {
	...
	public TRANSLATOR(Notary notary) {
	...
	public TRANSLATOR(Nursing nursing) {
	...
	public TRANSLATOR(Obstetric obstetric) {
	...
	public TRANSLATOR(OfficeEquipmentStore officeEquipmentStore) {
	...
	public TRANSLATOR(Oncologic oncologic) {
	...
	public TRANSLATOR(Optician optician) {
	...
	public TRANSLATOR(Optometric optometric) {
	...
	public TRANSLATOR(Organization organization) {
		organizationList = new ArrayList<Organization>();
	...
	public TRANSLATOR(Otolaryngologic otolaryngologic) {
	...
	public TRANSLATOR(OutletStore outletStore) {
	...
	public TRANSLATOR(Patient patient) {
	...
	public TRANSLATOR(PawnShop pawnShop) {
	...
	public TRANSLATOR(Pediatric pediatric) {
	...
	public TRANSLATOR(PerformingGroup performingGroup) {
	...
	public TRANSLATOR(PetStore petStore) {
	...
	public TRANSLATOR(Pharmacy pharmacy) {
	...
	public TRANSLATOR(Physician physician) {
	...
	public TRANSLATOR(Physiotherapy physiotherapy) {
	...
	public TRANSLATOR(PlasticSurgery plasticSurgery) {
	...
	public TRANSLATOR(Plumber plumber) {
	...
	public TRANSLATOR(Podiatric podiatric) {
	...
	public TRANSLATOR(PoliceStation policeStation) {
	...
	public TRANSLATOR(PostOffice postOffice) {
	...
	public TRANSLATOR(Preschool preschool) {
	...
	public TRANSLATOR(PrimaryCare primaryCare) {
	...
	public TRANSLATOR(ProfessionalService professionalService) {
	...
	public TRANSLATOR(Psychiatric psychiatric) {
	...
	public TRANSLATOR(PublicHealth publicHealth) {
	...
	public TRANSLATOR(PublicSwimmingPool publicSwimmingPool) {
	...
	public TRANSLATOR(RadioStation radioStation) {
	...
	public TRANSLATOR(RealEstateAgent realEstateAgent) {
	...
	public TRANSLATOR(RecyclingCenter recyclingCenter) {
	...
	public TRANSLATOR(ResearchProject researchProject) {
	...
	public TRANSLATOR(Resort resort) {
	...
	public TRANSLATOR(Restaurant restaurant) {
	...
	public TRANSLATOR(RoofingContractor roofingContractor) {
	...
	public TRANSLATOR(School school) {
	...
	public TRANSLATOR(SelfStorage selfStorage) {
	...
	public TRANSLATOR(ShoeStore shoeStore) {
	...
	public TRANSLATOR(ShoppingCenter shoppingCenter) {
	...
	public TRANSLATOR(SkiResort skiResort) {
	...
	public TRANSLATOR(SportingGoodsStore sportingGoodsStore) {
	...
	public TRANSLATOR(SportsActivityLocation sportsActivityLocation) {
	...
	public TRANSLATOR(SportsClub sportsClub) {
	...
	public TRANSLATOR(SportsOrganization sportsOrganization) {
	...
	public TRANSLATOR(SportsTeam sportsTeam) {
	...
	public TRANSLATOR(StadiumOrArena stadiumOrArena) {
	...
	public TRANSLATOR(TattooParlor tattooParlor) {
	...
	public TRANSLATOR(TelevisionStation televisionStation) {
	...
	public TRANSLATOR(TennisComplex tennisComplex) {
	...
	public TRANSLATOR(TheaterGroup theaterGroup) {
	...
	public TRANSLATOR(TireShop tireShop) {
	...
	public TRANSLATOR(TouristInformationCenter touristInformationCenter) {
	...
	public TRANSLATOR(ToyStore toyStore) {
	...
	public TRANSLATOR(TravelAgency travelAgency) {
	...
	public TRANSLATOR(VeterinaryCare veterinaryCare) {
	...
	public TRANSLATOR(WholesaleStore wholesaleStore) {
	...
	public TRANSLATOR(Winery winery) {
	...
	public TRANSLATOR(WorkersUnion workersUnion) {
	...
	public void copy(Container.Translator org) {
