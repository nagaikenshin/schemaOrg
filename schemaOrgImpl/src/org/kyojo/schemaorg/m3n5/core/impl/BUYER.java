...
public class BUYER implements Container.Buyer {
	...
	public BUYER(AccountingService accountingService) {
	...
	public BUYER(AdultEntertainment adultEntertainment) {
	...
	public BUYER(AmusementPark amusementPark) {
	...
	public BUYER(AnimalShelter animalShelter) {
	...
	public BUYER(ArchiveOrganization archiveOrganization) {
	...
	public BUYER(ArtGallery artGallery) {
	...
	public BUYER(Attorney attorney) {
	...
	public BUYER(AutoBodyShop autoBodyShop) {
	...
	public BUYER(AutoDealer autoDealer) {
	...
	public BUYER(AutoPartsStore autoPartsStore) {
	...
	public BUYER(AutoRental autoRental) {
	...
	public BUYER(AutoRepair autoRepair) {
	...
	public BUYER(AutoWash autoWash) {
	...
	public BUYER(AutomatedTeller automatedTeller) {
	...
	public BUYER(AutomotiveBusiness automotiveBusiness) {
	...
	public BUYER(BankOrCreditUnion bankOrCreditUnion) {
	...
	public BUYER(BarOrPub barOrPub) {
	...
	public BUYER(BeautySalon beautySalon) {
	...
	public BUYER(BedAndBreakfast bedAndBreakfast) {
	...
	public BUYER(BikeStore bikeStore) {
	...
	public BUYER(BowlingAlley bowlingAlley) {
	...
	public BUYER(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public BUYER(Campground campground) {
	...
	public BUYER(ChildCare childCare) {
	...
	public BUYER(ClothingStore clothingStore) {
	...
	public BUYER(CollegeOrUniversity collegeOrUniversity) {
	...
	public BUYER(ComedyClub comedyClub) {
	...
	public BUYER(CommunityHealth communityHealth) {
	...
	public BUYER(ComputerStore computerStore) {
	...
	public BUYER(Consortium consortium) {
	...
	public BUYER(ConvenienceStore convenienceStore) {
	...
	public BUYER(Corporation corporation) {
	...
	public BUYER(DanceGroup danceGroup) {
	...
	public BUYER(DepartmentStore departmentStore) {
	...
	public BUYER(Dermatology dermatology) {
	...
	public BUYER(DiagnosticLab diagnosticLab) {
	...
	public BUYER(DietNutrition dietNutrition) {
	...
	public BUYER(Distillery distillery) {
	...
	public BUYER(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public BUYER(EducationalOrganization educationalOrganization) {
	...
	public BUYER(Electrician electrician) {
	...
	public BUYER(ElectronicsStore electronicsStore) {
	...
	public BUYER(ElementarySchool elementarySchool) {
	...
	public BUYER(Emergency emergency) {
	...
	public BUYER(EmergencyService emergencyService) {
	...
	public BUYER(EmploymentAgency employmentAgency) {
	...
	public BUYER(EntertainmentBusiness entertainmentBusiness) {
	...
	public BUYER(ExerciseGym exerciseGym) {
	...
	public BUYER(FastFoodRestaurant fastFoodRestaurant) {
	...
	public BUYER(FinancialService financialService) {
	...
	public BUYER(FireStation fireStation) {
	...
	public BUYER(FoodEstablishment foodEstablishment) {
	...
	public BUYER(FundingAgency fundingAgency) {
	...
	public BUYER(FundingScheme fundingScheme) {
	...
	public BUYER(FurnitureStore furnitureStore) {
	...
	public BUYER(GardenStore gardenStore) {
	...
	public BUYER(GasStation gasStation) {
	...
	public BUYER(GeneralContractor generalContractor) {
	...
	public BUYER(Geriatric geriatric) {
	...
	public BUYER(GolfCourse golfCourse) {
	...
	public BUYER(GovernmentOffice governmentOffice) {
	...
	public BUYER(GovernmentOrganization governmentOrganization) {
	...
	public BUYER(GroceryStore groceryStore) {
	...
	public BUYER(Gynecologic gynecologic) {
	...
	public BUYER(HVACBusiness hvacBusiness) {
	...
	public BUYER(HairSalon hairSalon) {
	...
	public BUYER(HardwareStore hardwareStore) {
	...
	public BUYER(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public BUYER(HealthClub healthClub) {
	...
	public BUYER(HighSchool highSchool) {
	...
	public BUYER(HobbyShop hobbyShop) {
	...
	public BUYER(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public BUYER(HomeGoodsStore homeGoodsStore) {
	...
	public BUYER(Hospital hospital) {
	...
	public BUYER(HousePainter housePainter) {
	...
	public BUYER(IceCreamShop iceCreamShop) {
	...
	public BUYER(InsuranceAgency insuranceAgency) {
	...
	public BUYER(InternetCafe internetCafe) {
	...
	public BUYER(JewelryStore jewelryStore) {
	...
	public BUYER(LegalService legalService) {
	...
	public BUYER(LibrarySystem librarySystem) {
	...
	public BUYER(LiquorStore liquorStore) {
	...
	public BUYER(LocalBusiness localBusiness) {
	...
	public BUYER(Locksmith locksmith) {
	...
	public BUYER(LodgingBusiness lodgingBusiness) {
	...
	public BUYER(MedicalBusiness medicalBusiness) {
	...
	public BUYER(MedicalClinic medicalClinic) {
	...
	public BUYER(MedicalOrganization medicalOrganization) {
	...
	public BUYER(MensClothingStore mensClothingStore) {
	...
	public BUYER(MiddleSchool middleSchool) {
	...
	public BUYER(Midwifery midwifery) {
	...
	public BUYER(MobilePhoneStore mobilePhoneStore) {
	...
	public BUYER(MotorcycleDealer motorcycleDealer) {
	...
	public BUYER(MotorcycleRepair motorcycleRepair) {
	...
	public BUYER(MovieRentalStore movieRentalStore) {
	...
	public BUYER(MovieTheater movieTheater) {
	...
	public BUYER(MovingCompany movingCompany) {
	...
	public BUYER(MusicGroup musicGroup) {
	...
	public BUYER(MusicStore musicStore) {
	...
	public BUYER(NailSalon nailSalon) {
	...
	public BUYER(NewsMediaOrganization newsMediaOrganization) {
	...
	public BUYER(NightClub nightClub) {
	...
	public BUYER(Obstetric obstetric) {
	...
	public BUYER(OfficeEquipmentStore officeEquipmentStore) {
	...
	public BUYER(Oncologic oncologic) {
	...
	public BUYER(Optician optician) {
	...
	public BUYER(Optometric optometric) {
	...
	public BUYER(Organization organization) {
	...
	public BUYER(Otolaryngologic otolaryngologic) {
	...
	public BUYER(OutletStore outletStore) {
	...
	public BUYER(PawnShop pawnShop) {
	...
	public BUYER(Pediatric pediatric) {
	...
	public BUYER(PerformingGroup performingGroup) {
	...
	public BUYER(PetStore petStore) {
	...
	public BUYER(Pharmacy pharmacy) {
	...
	public BUYER(Physician physician) {
	...
	public BUYER(Physiotherapy physiotherapy) {
	...
	public BUYER(PlasticSurgery plasticSurgery) {
	...
	public BUYER(Podiatric podiatric) {
	...
	public BUYER(PoliceStation policeStation) {
	...
	public BUYER(PostOffice postOffice) {
	...
	public BUYER(Preschool preschool) {
	...
	public BUYER(PrimaryCare primaryCare) {
	...
	public BUYER(ProfessionalService professionalService) {
	...
	public BUYER(Psychiatric psychiatric) {
	...
	public BUYER(PublicHealth publicHealth) {
	...
	public BUYER(PublicSwimmingPool publicSwimmingPool) {
	...
	public BUYER(RadioStation radioStation) {
	...
	public BUYER(RealEstateAgent realEstateAgent) {
	...
	public BUYER(RecyclingCenter recyclingCenter) {
	...
	public BUYER(ResearchProject researchProject) {
	...
	public BUYER(Restaurant restaurant) {
	...
	public BUYER(RoofingContractor roofingContractor) {
	...
	public BUYER(SelfStorage selfStorage) {
	...
	public BUYER(ShoeStore shoeStore) {
	...
	public BUYER(ShoppingCenter shoppingCenter) {
	...
	public BUYER(SkiResort skiResort) {
	...
	public BUYER(SportingGoodsStore sportingGoodsStore) {
	...
	public BUYER(SportsActivityLocation sportsActivityLocation) {
	...
	public BUYER(SportsClub sportsClub) {
	...
	public BUYER(SportsOrganization sportsOrganization) {
	...
	public BUYER(SportsTeam sportsTeam) {
	...
	public BUYER(StadiumOrArena stadiumOrArena) {
	...
	public BUYER(TattooParlor tattooParlor) {
	...
	public BUYER(TelevisionStation televisionStation) {
	...
	public BUYER(TennisComplex tennisComplex) {
	...
	public BUYER(TheaterGroup theaterGroup) {
	...
	public BUYER(TireShop tireShop) {
	...
	public BUYER(TouristInformationCenter touristInformationCenter) {
	...
	public BUYER(ToyStore toyStore) {
	...
	public BUYER(TravelAgency travelAgency) {
	...
	public BUYER(VeterinaryCare veterinaryCare) {
	...
	public BUYER(WholesaleStore wholesaleStore) {
	...
	public BUYER(WorkersUnion workersUnion) {
	...
	public void copy(Container.Buyer org) {
