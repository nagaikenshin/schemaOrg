...
public class WP_FOOTER implements Clazz.WPFooter {
	...
	public WP_FOOTER(Long seq) {
		setSeq(seq);
	}

	public WP_FOOTER(String string) {
	...
	public WP_FOOTER(AccessMode accessMode) {
	...
	public WP_FOOTER(AccessModeSufficient accessModeSufficient) {
	...
	public WP_FOOTER(AccessibilityAPI accessibilityAPI) {
	...
	public WP_FOOTER(AccessibilityControl accessibilityControl) {
	...
	public WP_FOOTER(AccessibilityFeature accessibilityFeature) {
	...
	public WP_FOOTER(AccessibilityHazard accessibilityHazard) {
	...
	public WP_FOOTER(AccessibilitySummary accessibilitySummary) {
	...
	public WP_FOOTER(AccountablePerson accountablePerson) {
	...
	public WP_FOOTER(AdditionalType additionalType) {
	...
	public WP_FOOTER(AggregateRating aggregateRating) {
	...
	public WP_FOOTER(AlternateName alternateName) {
	...
	public WP_FOOTER(AlternativeHeadline alternativeHeadline) {
	...
	public WP_FOOTER(AssociatedMedia associatedMedia) {
	...
	public WP_FOOTER(Audience audience) {
	...
	public WP_FOOTER(Author author) {
		setAuthor(author);
	}
	...
	public WP_FOOTER(Character character) {
	...
	public WP_FOOTER(Citation citation) {
	...
	public WP_FOOTER(Comment comment) {
		setComment(comment);
	}
	...
	public WP_FOOTER(CommentCount commentCount) {
	...
	public WP_FOOTER(ContentLocation contentLocation) {
	...
	public WP_FOOTER(ContentRating contentRating) {
	...
	public WP_FOOTER(ContentReferenceTime contentReferenceTime) {
	...
	public WP_FOOTER(Contributor contributor) {
	...
	public WP_FOOTER(CopyrightHolder copyrightHolder) {
	...
	public WP_FOOTER(CopyrightYear copyrightYear) {
	...
	public WP_FOOTER(Correction correction) {
	...
	public WP_FOOTER(Creator creator) {
		setCreator(creator);
	}
	...
	public WP_FOOTER(CssSelector cssSelector) {
	...
	public WP_FOOTER(DateCreated dateCreated) {
	...
	public WP_FOOTER(DateModified dateModified) {
	...
	public WP_FOOTER(DatePublished datePublished) {
	...
	public WP_FOOTER(Description description) {
	...
	public WP_FOOTER(DisambiguatingDescription disambiguatingDescription) {
	...
	public WP_FOOTER(DiscussionUrl discussionUrl) {
	...
	public WP_FOOTER(Editor editor) {
		setEditor(editor);
	}
	...
	public WP_FOOTER(EducationalAlignment educationalAlignment) {
	...
	public WP_FOOTER(EducationalUse educationalUse) {
	...
	public WP_FOOTER(Encoding encoding) {
	...
	public WP_FOOTER(EncodingFormat encodingFormat) {
	...
	public WP_FOOTER(ExampleOfWork exampleOfWork) {
	...
	public WP_FOOTER(Expires expires) {
		setExpires(expires);
	}
	...
	public WP_FOOTER(Funder funder) {
		setFunder(funder);
	}
	...
	public WP_FOOTER(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public WP_FOOTER(Headline headline) {
	...
	public WP_FOOTER(Identifier identifier) {
	...
	public WP_FOOTER(InLanguage inLanguage) {
	...
	public WP_FOOTER(InteractionStatistic interactionStatistic) {
	...
	public WP_FOOTER(InteractivityType interactivityType) {
	...
	public WP_FOOTER(IsAccessibleForFree isAccessibleForFree) {
	...
	public WP_FOOTER(IsBasedOn isBasedOn) {
	...
	public WP_FOOTER(IsFamilyFriendly isFamilyFriendly) {
	...
	public WP_FOOTER(IsPartOf isPartOf) {
	...
	public WP_FOOTER(Keywords keywords) {
	...
	public WP_FOOTER(LearningResourceType learningResourceType) {
	...
	public WP_FOOTER(License license) {
		setLicense(license);
	}
	...
	public WP_FOOTER(LocationCreated locationCreated) {
	...
	public WP_FOOTER(MainEntity mainEntity) {
	...
	public WP_FOOTER(MainEntityOfPage mainEntityOfPage) {
	...
	public WP_FOOTER(Material material) {
	...
	public WP_FOOTER(MaterialExtent materialExtent) {
	...
	public WP_FOOTER(Mentions mentions) {
	...
	public WP_FOOTER(NameFuzzy nameFuzzy) {
	...
	public WP_FOOTER(NameRuby nameRuby) {
	...
	public WP_FOOTER(Offers offers) {
		setOffers(offers);
	}
	...
	public WP_FOOTER(Position position) {
	...
	public WP_FOOTER(PotentialAction potentialAction) {
	...
	public WP_FOOTER(Producer producer) {
	...
	public WP_FOOTER(Provider provider) {
	...
	public WP_FOOTER(Publication publication) {
	...
	public WP_FOOTER(Publisher publisher) {
	...
	public WP_FOOTER(PublisherImprint publisherImprint) {
	...
	public WP_FOOTER(PublishingPrinciples publishingPrinciples) {
	...
	public WP_FOOTER(RecordedAt recordedAt) {
	...
	public WP_FOOTER(ReleasedEvent releasedEvent) {
	...
	public WP_FOOTER(Review review) {
		setReview(review);
	}
	...
	public WP_FOOTER(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public WP_FOOTER(SchemaVersion schemaVersion) {
	...
	public WP_FOOTER(SdDatePublished sdDatePublished) {
	...
	public WP_FOOTER(SdLicense sdLicense) {
	...
	public WP_FOOTER(SdPublisher sdPublisher) {
	...
	public WP_FOOTER(SourceOrganization sourceOrganization) {
	...
	public WP_FOOTER(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public WP_FOOTER(SpatialCoverage spatialCoverage) {
	...
	public WP_FOOTER(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public WP_FOOTER(SubjectOf subjectOf) {
	...
	public WP_FOOTER(Temporal temporal) {
	...
	public WP_FOOTER(TemporalCoverage temporalCoverage) {
	...
	public WP_FOOTER(ThumbnailUrl thumbnailUrl) {
	...
	public WP_FOOTER(TimeRequired timeRequired) {
	...
	public WP_FOOTER(TranslationOfWork translationOfWork) {
	...
	public WP_FOOTER(Translator translator) {
	...
	public WP_FOOTER(TypicalAgeRange typicalAgeRange) {
	...
	public WP_FOOTER(Version version) {
		setVersion(version);
	}
	...
	public WP_FOOTER(WorkExample workExample) {
	...
	public WP_FOOTER(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.WPFooter org) {
		setSeq(org.getSeq());
