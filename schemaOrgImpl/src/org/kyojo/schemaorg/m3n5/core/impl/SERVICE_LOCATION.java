...
public class SERVICE_LOCATION implements Container.ServiceLocation {
	...
	public SERVICE_LOCATION(String string) {
	...
	public SERVICE_LOCATION(Accommodation accommodation) {
	...
	public SERVICE_LOCATION(AccountingService accountingService) {
	...
	public SERVICE_LOCATION(AdministrativeArea administrativeArea) {
	...
	public SERVICE_LOCATION(AdultEntertainment adultEntertainment) {
	...
	public SERVICE_LOCATION(Airport airport) {
	...
	public SERVICE_LOCATION(AmusementPark amusementPark) {
	...
	public SERVICE_LOCATION(AnimalShelter animalShelter) {
	...
	public SERVICE_LOCATION(Apartment apartment) {
	...
	public SERVICE_LOCATION(ApartmentComplex apartmentComplex) {
	...
	public SERVICE_LOCATION(Aquarium aquarium) {
	...
	public SERVICE_LOCATION(ArchiveOrganization archiveOrganization) {
	...
	public SERVICE_LOCATION(ArtGallery artGallery) {
	...
	public SERVICE_LOCATION(Attorney attorney) {
	...
	public SERVICE_LOCATION(AutoBodyShop autoBodyShop) {
	...
	public SERVICE_LOCATION(AutoDealer autoDealer) {
	...
	public SERVICE_LOCATION(AutoPartsStore autoPartsStore) {
	...
	public SERVICE_LOCATION(AutoRental autoRental) {
	...
	public SERVICE_LOCATION(AutoRepair autoRepair) {
	...
	public SERVICE_LOCATION(AutoWash autoWash) {
	...
	public SERVICE_LOCATION(AutomatedTeller automatedTeller) {
	...
	public SERVICE_LOCATION(AutomotiveBusiness automotiveBusiness) {
	...
	public SERVICE_LOCATION(Bakery bakery) {
	...
	public SERVICE_LOCATION(BankOrCreditUnion bankOrCreditUnion) {
	...
	public SERVICE_LOCATION(BarOrPub barOrPub) {
	...
	public SERVICE_LOCATION(Beach beach) {
	...
	public SERVICE_LOCATION(BeautySalon beautySalon) {
	...
	public SERVICE_LOCATION(BedAndBreakfast bedAndBreakfast) {
	...
	public SERVICE_LOCATION(BikeStore bikeStore) {
	...
	public SERVICE_LOCATION(BodyOfWater bodyOfWater) {
	...
	public SERVICE_LOCATION(BookStore bookStore) {
	...
	public SERVICE_LOCATION(BowlingAlley bowlingAlley) {
	...
	public SERVICE_LOCATION(Brewery brewery) {
	...
	public SERVICE_LOCATION(Bridge bridge) {
	...
	public SERVICE_LOCATION(BuddhistTemple buddhistTemple) {
	...
	public SERVICE_LOCATION(BusStation busStation) {
	...
	public SERVICE_LOCATION(BusStop busStop) {
	...
	public SERVICE_LOCATION(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public SERVICE_LOCATION(Campground campground) {
	...
	public SERVICE_LOCATION(CampingPitch campingPitch) {
	...
	public SERVICE_LOCATION(Canal canal) {
	...
	public SERVICE_LOCATION(Casino casino) {
	...
	public SERVICE_LOCATION(CatholicChurch catholicChurch) {
	...
	public SERVICE_LOCATION(Cemetery cemetery) {
	...
	public SERVICE_LOCATION(ChildCare childCare) {
	...
	public SERVICE_LOCATION(Church church) {
	...
	public SERVICE_LOCATION(City city) {
	...
	public SERVICE_LOCATION(CityHall cityHall) {
	...
	public SERVICE_LOCATION(CivicStructure civicStructure) {
	...
	public SERVICE_LOCATION(ClothingStore clothingStore) {
	...
	public SERVICE_LOCATION(ComedyClub comedyClub) {
	...
	public SERVICE_LOCATION(CommunityHealth communityHealth) {
	...
	public SERVICE_LOCATION(ComputerStore computerStore) {
	...
	public SERVICE_LOCATION(Continent continent) {
	...
	public SERVICE_LOCATION(ConvenienceStore convenienceStore) {
	...
	public SERVICE_LOCATION(Country country) {
	...
	public SERVICE_LOCATION(Courthouse courthouse) {
	...
	public SERVICE_LOCATION(Crematorium crematorium) {
	...
	public SERVICE_LOCATION(DaySpa daySpa) {
	...
	public SERVICE_LOCATION(DefenceEstablishment defenceEstablishment) {
	...
	public SERVICE_LOCATION(Dentist dentist) {
	...
	public SERVICE_LOCATION(DepartmentStore departmentStore) {
	...
	public SERVICE_LOCATION(Dermatology dermatology) {
	...
	public SERVICE_LOCATION(DietNutrition dietNutrition) {
	...
	public SERVICE_LOCATION(Distillery distillery) {
	...
	public SERVICE_LOCATION(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public SERVICE_LOCATION(Electrician electrician) {
	...
	public SERVICE_LOCATION(ElectronicsStore electronicsStore) {
	...
	public SERVICE_LOCATION(Embassy embassy) {
	...
	public SERVICE_LOCATION(Emergency emergency) {
	...
	public SERVICE_LOCATION(EmergencyService emergencyService) {
	...
	public SERVICE_LOCATION(EmploymentAgency employmentAgency) {
	...
	public SERVICE_LOCATION(EntertainmentBusiness entertainmentBusiness) {
	...
	public SERVICE_LOCATION(EventVenue eventVenue) {
	...
	public SERVICE_LOCATION(ExerciseGym exerciseGym) {
	...
	public SERVICE_LOCATION(FastFoodRestaurant fastFoodRestaurant) {
	...
	public SERVICE_LOCATION(FinancialService financialService) {
	...
	public SERVICE_LOCATION(FireStation fireStation) {
	...
	public SERVICE_LOCATION(Florist florist) {
	...
	public SERVICE_LOCATION(FoodEstablishment foodEstablishment) {
	...
	public SERVICE_LOCATION(FurnitureStore furnitureStore) {
	...
	public SERVICE_LOCATION(GardenStore gardenStore) {
	...
	public SERVICE_LOCATION(GasStation gasStation) {
	...
	public SERVICE_LOCATION(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public SERVICE_LOCATION(GeneralContractor generalContractor) {
	...
	public SERVICE_LOCATION(Geriatric geriatric) {
	...
	public SERVICE_LOCATION(GolfCourse golfCourse) {
	...
	public SERVICE_LOCATION(GovernmentBuilding governmentBuilding) {
	...
	public SERVICE_LOCATION(GovernmentOffice governmentOffice) {
	...
	public SERVICE_LOCATION(GroceryStore groceryStore) {
	...
	public SERVICE_LOCATION(Gynecologic gynecologic) {
	...
	public SERVICE_LOCATION(HVACBusiness hvacBusiness) {
	...
	public SERVICE_LOCATION(HairSalon hairSalon) {
	...
	public SERVICE_LOCATION(HardwareStore hardwareStore) {
	...
	public SERVICE_LOCATION(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public SERVICE_LOCATION(HealthClub healthClub) {
	...
	public SERVICE_LOCATION(HinduTemple hinduTemple) {
	...
	public SERVICE_LOCATION(HobbyShop hobbyShop) {
	...
	public SERVICE_LOCATION(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public SERVICE_LOCATION(HomeGoodsStore homeGoodsStore) {
	...
	public SERVICE_LOCATION(Hospital hospital) {
	...
	public SERVICE_LOCATION(Hostel hostel) {
	...
	public SERVICE_LOCATION(Hotel hotel) {
	...
	public SERVICE_LOCATION(HotelRoom hotelRoom) {
	...
	public SERVICE_LOCATION(House house) {
	...
	public SERVICE_LOCATION(HousePainter housePainter) {
	...
	public SERVICE_LOCATION(IceCreamShop iceCreamShop) {
	...
	public SERVICE_LOCATION(InsuranceAgency insuranceAgency) {
	...
	public SERVICE_LOCATION(InternetCafe internetCafe) {
	...
	public SERVICE_LOCATION(JewelryStore jewelryStore) {
	...
	public SERVICE_LOCATION(LakeBodyOfWater lakeBodyOfWater) {
	...
	public SERVICE_LOCATION(Landform landform) {
	...
	public SERVICE_LOCATION(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public SERVICE_LOCATION(LegalService legalService) {
	...
	public SERVICE_LOCATION(LegislativeBuilding legislativeBuilding) {
	...
	public SERVICE_LOCATION(Library library) {
	...
	public SERVICE_LOCATION(LiquorStore liquorStore) {
	...
	public SERVICE_LOCATION(LocalBusiness localBusiness) {
	...
	public SERVICE_LOCATION(Locksmith locksmith) {
	...
	public SERVICE_LOCATION(LodgingBusiness lodgingBusiness) {
	...
	public SERVICE_LOCATION(MedicalBusiness medicalBusiness) {
	...
	public SERVICE_LOCATION(MedicalClinic medicalClinic) {
	...
	public SERVICE_LOCATION(MeetingRoom meetingRoom) {
	...
	public SERVICE_LOCATION(MensClothingStore mensClothingStore) {
	...
	public SERVICE_LOCATION(Midwifery midwifery) {
	...
	public SERVICE_LOCATION(MobilePhoneStore mobilePhoneStore) {
	...
	public SERVICE_LOCATION(Mosque mosque) {
	...
	public SERVICE_LOCATION(Motel motel) {
	...
	public SERVICE_LOCATION(MotorcycleDealer motorcycleDealer) {
	...
	public SERVICE_LOCATION(MotorcycleRepair motorcycleRepair) {
	...
	public SERVICE_LOCATION(Mountain mountain) {
	...
	public SERVICE_LOCATION(MovieRentalStore movieRentalStore) {
	...
	public SERVICE_LOCATION(MovieTheater movieTheater) {
	...
	public SERVICE_LOCATION(MovingCompany movingCompany) {
	...
	public SERVICE_LOCATION(Museum museum) {
	...
	public SERVICE_LOCATION(MusicStore musicStore) {
	...
	public SERVICE_LOCATION(MusicVenue musicVenue) {
	...
	public SERVICE_LOCATION(NailSalon nailSalon) {
	...
	public SERVICE_LOCATION(NightClub nightClub) {
	...
	public SERVICE_LOCATION(Notary notary) {
	...
	public SERVICE_LOCATION(Nursing nursing) {
	...
	public SERVICE_LOCATION(Obstetric obstetric) {
	...
	public SERVICE_LOCATION(OceanBodyOfWater oceanBodyOfWater) {
	...
	public SERVICE_LOCATION(OfficeEquipmentStore officeEquipmentStore) {
	...
	public SERVICE_LOCATION(Oncologic oncologic) {
	...
	public SERVICE_LOCATION(Optician optician) {
	...
	public SERVICE_LOCATION(Optometric optometric) {
	...
	public SERVICE_LOCATION(Otolaryngologic otolaryngologic) {
	...
	public SERVICE_LOCATION(OutletStore outletStore) {
	...
	public SERVICE_LOCATION(Park park) {
	...
	public SERVICE_LOCATION(ParkingFacility parkingFacility) {
	...
	public SERVICE_LOCATION(PawnShop pawnShop) {
	...
	public SERVICE_LOCATION(Pediatric pediatric) {
	...
	public SERVICE_LOCATION(PerformingArtsTheater performingArtsTheater) {
	...
	public SERVICE_LOCATION(PetStore petStore) {
	...
	public SERVICE_LOCATION(Pharmacy pharmacy) {
	...
	public SERVICE_LOCATION(Physician physician) {
	...
	public SERVICE_LOCATION(Physiotherapy physiotherapy) {
	...
	public SERVICE_LOCATION(Place place) {
		placeList = new ArrayList<Place>();
		placeList.add(place);
	}
	...
	public SERVICE_LOCATION(PlaceOfWorship placeOfWorship) {
	...
	public SERVICE_LOCATION(PlasticSurgery plasticSurgery) {
	...
	public SERVICE_LOCATION(Playground playground) {
	...
	public SERVICE_LOCATION(Plumber plumber) {
	...
	public SERVICE_LOCATION(Podiatric podiatric) {
	...
	public SERVICE_LOCATION(PoliceStation policeStation) {
	...
	public SERVICE_LOCATION(Pond pond) {
	...
	public SERVICE_LOCATION(PostOffice postOffice) {
	...
	public SERVICE_LOCATION(PrimaryCare primaryCare) {
	...
	public SERVICE_LOCATION(ProfessionalService professionalService) {
	...
	public SERVICE_LOCATION(Psychiatric psychiatric) {
	...
	public SERVICE_LOCATION(PublicHealth publicHealth) {
	...
	public SERVICE_LOCATION(PublicSwimmingPool publicSwimmingPool) {
	...
	public SERVICE_LOCATION(PublicToilet publicToilet) {
	...
	public SERVICE_LOCATION(RVPark rvPark) {
	...
	public SERVICE_LOCATION(RadioStation radioStation) {
	...
	public SERVICE_LOCATION(RealEstateAgent realEstateAgent) {
	...
	public SERVICE_LOCATION(RecyclingCenter recyclingCenter) {
	...
	public SERVICE_LOCATION(Reservoir reservoir) {
	...
	public SERVICE_LOCATION(Residence residence) {
	...
	public SERVICE_LOCATION(Resort resort) {
	...
	public SERVICE_LOCATION(Restaurant restaurant) {
	...
	public SERVICE_LOCATION(RiverBodyOfWater riverBodyOfWater) {
	...
	public SERVICE_LOCATION(RoofingContractor roofingContractor) {
	...
	public SERVICE_LOCATION(Room room) {
	...
	public SERVICE_LOCATION(SeaBodyOfWater seaBodyOfWater) {
	...
	public SERVICE_LOCATION(SelfStorage selfStorage) {
	...
	public SERVICE_LOCATION(ShoeStore shoeStore) {
	...
	public SERVICE_LOCATION(ShoppingCenter shoppingCenter) {
	...
	public SERVICE_LOCATION(SingleFamilyResidence singleFamilyResidence) {
	...
	public SERVICE_LOCATION(SkiResort skiResort) {
	...
	public SERVICE_LOCATION(SportingGoodsStore sportingGoodsStore) {
	...
	public SERVICE_LOCATION(SportsActivityLocation sportsActivityLocation) {
	...
	public SERVICE_LOCATION(SportsClub sportsClub) {
	...
	public SERVICE_LOCATION(StadiumOrArena stadiumOrArena) {
	...
	public SERVICE_LOCATION(State state) {
	...
	public SERVICE_LOCATION(Store store) {
	...
	public SERVICE_LOCATION(SubwayStation subwayStation) {
	...
	public SERVICE_LOCATION(Suite suite) {
	...
	public SERVICE_LOCATION(Synagogue synagogue) {
	...
	public SERVICE_LOCATION(TattooParlor tattooParlor) {
	...
	public SERVICE_LOCATION(TaxiStand taxiStand) {
	...
	public SERVICE_LOCATION(TelevisionStation televisionStation) {
	...
	public SERVICE_LOCATION(TennisComplex tennisComplex) {
	...
	public SERVICE_LOCATION(TireShop tireShop) {
	...
	public SERVICE_LOCATION(TouristAttraction touristAttraction) {
	...
	public SERVICE_LOCATION(TouristDestination touristDestination) {
	...
	public SERVICE_LOCATION(TouristInformationCenter touristInformationCenter) {
	...
	public SERVICE_LOCATION(ToyStore toyStore) {
	...
	public SERVICE_LOCATION(TrainStation trainStation) {
	...
	public SERVICE_LOCATION(TravelAgency travelAgency) {
	...
	public SERVICE_LOCATION(Volcano volcano) {
	...
	public SERVICE_LOCATION(Waterfall waterfall) {
	...
	public SERVICE_LOCATION(WholesaleStore wholesaleStore) {
	...
	public SERVICE_LOCATION(Winery winery) {
	...
	public SERVICE_LOCATION(Zoo zoo) {
	...
	public void copy(Container.ServiceLocation org) {
