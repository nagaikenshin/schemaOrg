...
public class EXHIBITION_EVENT implements Clazz.ExhibitionEvent {
	...
	public EXHIBITION_EVENT() {
	}

	public EXHIBITION_EVENT(Long seq) {
		setSeq(seq);
	}

	public EXHIBITION_EVENT(String string) {
	...
	public EXHIBITION_EVENT(About about) {
		setAbout(about);
	}
	...
	public EXHIBITION_EVENT(Actor actor) {
		setActor(actor);
	}
	...
	public EXHIBITION_EVENT(AdditionalType additionalType) {
	...
	public EXHIBITION_EVENT(AggregateRating aggregateRating) {
	...
	public EXHIBITION_EVENT(AlternateName alternateName) {
	...
	public EXHIBITION_EVENT(Attendee attendee) {
	...
	public EXHIBITION_EVENT(Audience audience) {
	...
	public EXHIBITION_EVENT(Composer composer) {
	...
	public EXHIBITION_EVENT(Contributor contributor) {
	...
	public EXHIBITION_EVENT(Description description) {
	...
	public EXHIBITION_EVENT(Director director) {
	...
	public EXHIBITION_EVENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public EXHIBITION_EVENT(DoorTime doorTime) {
	...
	public EXHIBITION_EVENT(Duration duration) {
	...
	public EXHIBITION_EVENT(EndDate endDate) {
		setEndDate(endDate);
	}
	...
	public EXHIBITION_EVENT(EventStatus eventStatus) {
	...
	public EXHIBITION_EVENT(Funder funder) {
		setFunder(funder);
	}
	...
	public EXHIBITION_EVENT(Identifier identifier) {
	...
	public EXHIBITION_EVENT(Image image) {
		setImage(image);
	}
	...
	public EXHIBITION_EVENT(InLanguage inLanguage) {
	...
	public EXHIBITION_EVENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public EXHIBITION_EVENT(Location location) {
	...
	public EXHIBITION_EVENT(MainEntityOfPage mainEntityOfPage) {
	...
	public EXHIBITION_EVENT(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public EXHIBITION_EVENT(Name name) {
		setName(name);
	}
	...
	public EXHIBITION_EVENT(NameFuzzy nameFuzzy) {
	...
	public EXHIBITION_EVENT(NameRuby nameRuby) {
	...
	public EXHIBITION_EVENT(Offers offers) {
		setOffers(offers);
	}
	...
	public EXHIBITION_EVENT(Organizer organizer) {
	...
	public EXHIBITION_EVENT(Performer performer) {
	...
	public EXHIBITION_EVENT(PotentialAction potentialAction) {
	...
	public EXHIBITION_EVENT(PreviousStartDate previousStartDate) {
	...
	public EXHIBITION_EVENT(RecordedIn recordedIn) {
	...
	public EXHIBITION_EVENT(RemainingAttendeeCapacity remainingAttendeeCapacity) {
	...
	public EXHIBITION_EVENT(Review review) {
		setReview(review);
	}
	...
	public EXHIBITION_EVENT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public EXHIBITION_EVENT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public EXHIBITION_EVENT(StartDate startDate) {
	...
	public EXHIBITION_EVENT(SubEvent subEvent) {
	...
	public EXHIBITION_EVENT(SubjectOf subjectOf) {
	...
	public EXHIBITION_EVENT(SuperEvent superEvent) {
	...
	public EXHIBITION_EVENT(Translator translator) {
	...
	public EXHIBITION_EVENT(TypicalAgeRange typicalAgeRange) {
	...
	public EXHIBITION_EVENT(Url url) {
		setUrl(url);
	}
	...
	public EXHIBITION_EVENT(WorkFeatured workFeatured) {
	...
	public EXHIBITION_EVENT(WorkPerformed workPerformed) {
	...
	public void copy(Clazz.ExhibitionEvent org) {
		setSeq(org.getSeq());
