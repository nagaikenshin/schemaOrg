...
public class HOSTEL implements Clazz.Hostel {
	...
	public HOSTEL(GeoContains geoContains) {
	...
	public HOSTEL(GeoCoveredBy geoCoveredBy) {
	...
	public HOSTEL(GeoCovers geoCovers) {
	...
	public HOSTEL(GeoCrosses geoCrosses) {
	...
	public HOSTEL(GeoDisjoint geoDisjoint) {
	...
	public HOSTEL(GeoEquals geoEquals) {
	...
	public HOSTEL(GeoIntersects geoIntersects) {
	...
	public HOSTEL(GeoOverlaps geoOverlaps) {
	...
	public HOSTEL(GeoTouches geoTouches) {
	...
	public HOSTEL(GeoWithin geoWithin) {
