...
public class EVENT_VENUE implements Clazz.EventVenue {
	...
	public EVENT_VENUE(GeoContains geoContains) {
	...
	public EVENT_VENUE(GeoCoveredBy geoCoveredBy) {
	...
	public EVENT_VENUE(GeoCovers geoCovers) {
	...
	public EVENT_VENUE(GeoCrosses geoCrosses) {
	...
	public EVENT_VENUE(GeoDisjoint geoDisjoint) {
	...
	public EVENT_VENUE(GeoEquals geoEquals) {
	...
	public EVENT_VENUE(GeoIntersects geoIntersects) {
	...
	public EVENT_VENUE(GeoOverlaps geoOverlaps) {
	...
	public EVENT_VENUE(GeoTouches geoTouches) {
	...
	public EVENT_VENUE(GeoWithin geoWithin) {
	...
	public EVENT_VENUE(Slogan slogan) {
		setSlogan(slogan);
	}
