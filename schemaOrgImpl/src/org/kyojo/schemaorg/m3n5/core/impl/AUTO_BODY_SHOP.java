...
public class AUTO_BODY_SHOP implements Clazz.AutoBodyShop {
	...
	public AUTO_BODY_SHOP(GeoContains geoContains) {
	...
	public AUTO_BODY_SHOP(GeoCoveredBy geoCoveredBy) {
	...
	public AUTO_BODY_SHOP(GeoCovers geoCovers) {
	...
	public AUTO_BODY_SHOP(GeoCrosses geoCrosses) {
	...
	public AUTO_BODY_SHOP(GeoDisjoint geoDisjoint) {
	...
	public AUTO_BODY_SHOP(GeoEquals geoEquals) {
	...
	public AUTO_BODY_SHOP(GeoIntersects geoIntersects) {
	...
	public AUTO_BODY_SHOP(GeoOverlaps geoOverlaps) {
	...
	public AUTO_BODY_SHOP(GeoTouches geoTouches) {
	...
	public AUTO_BODY_SHOP(GeoWithin geoWithin) {
	...
	public AUTO_BODY_SHOP(Slogan slogan) {
		setSlogan(slogan);
	}
