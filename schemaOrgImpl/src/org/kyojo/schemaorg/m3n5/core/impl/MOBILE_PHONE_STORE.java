...
public class MOBILE_PHONE_STORE implements Clazz.MobilePhoneStore {
	...
	public MOBILE_PHONE_STORE(GeoContains geoContains) {
	...
	public MOBILE_PHONE_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public MOBILE_PHONE_STORE(GeoCovers geoCovers) {
	...
	public MOBILE_PHONE_STORE(GeoCrosses geoCrosses) {
	...
	public MOBILE_PHONE_STORE(GeoDisjoint geoDisjoint) {
	...
	public MOBILE_PHONE_STORE(GeoEquals geoEquals) {
	...
	public MOBILE_PHONE_STORE(GeoIntersects geoIntersects) {
	...
	public MOBILE_PHONE_STORE(GeoOverlaps geoOverlaps) {
	...
	public MOBILE_PHONE_STORE(GeoTouches geoTouches) {
	...
	public MOBILE_PHONE_STORE(GeoWithin geoWithin) {
	...
	public MOBILE_PHONE_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
