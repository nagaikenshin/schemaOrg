...
public class HOME_TEAM implements Container.HomeTeam {
	...
	public HOME_TEAM(String string) {
	...
	public HOME_TEAM(Patient patient) {
	...
	public HOME_TEAM(Person person) {
		personList = new ArrayList<Person>();
	...
	public HOME_TEAM(SportsTeam sportsTeam) {
	...
	public HOME_TEAM(List<Patient> patientList,
	...
	public void copy(Container.HomeTeam org) {
