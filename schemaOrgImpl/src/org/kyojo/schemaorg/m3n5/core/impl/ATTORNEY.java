...
public class ATTORNEY implements Clazz.Attorney {
	...
	public ATTORNEY(GeoContains geoContains) {
	...
	public ATTORNEY(GeoCoveredBy geoCoveredBy) {
	...
	public ATTORNEY(GeoCovers geoCovers) {
	...
	public ATTORNEY(GeoCrosses geoCrosses) {
	...
	public ATTORNEY(GeoDisjoint geoDisjoint) {
	...
	public ATTORNEY(GeoEquals geoEquals) {
	...
	public ATTORNEY(GeoIntersects geoIntersects) {
	...
	public ATTORNEY(GeoOverlaps geoOverlaps) {
	...
	public ATTORNEY(GeoTouches geoTouches) {
	...
	public ATTORNEY(GeoWithin geoWithin) {
