...
public class DRINK_ACTION implements Clazz.DrinkAction {
	...
	public DRINK_ACTION(Long seq) {
		setSeq(seq);
	}

	public DRINK_ACTION(String string) {
	...
	public DRINK_ACTION(ActionAccessibilityRequirement actionAccessibilityRequirement) {
	...
	public DRINK_ACTION(ActionStatus actionStatus) {
	...
	public DRINK_ACTION(AdditionalType additionalType) {
	...
	public DRINK_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public DRINK_ACTION(AlternateName alternateName) {
	...
	public DRINK_ACTION(Description description) {
	...
	public DRINK_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public DRINK_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public DRINK_ACTION(Error error) {
		setError(error);
	}
	...
	public DRINK_ACTION(ExpectsAcceptanceOf expectsAcceptanceOf) {
	...
	public DRINK_ACTION(Identifier identifier) {
	...
	public DRINK_ACTION(Image image) {
		setImage(image);
	}
	...
	public DRINK_ACTION(Instrument instrument) {
	...
	public DRINK_ACTION(Location location) {
	...
	public DRINK_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public DRINK_ACTION(NameFuzzy nameFuzzy) {
	...
	public DRINK_ACTION(NameRuby nameRuby) {
	...
	public DRINK_ACTION(Object object) {
		setObject(object);
	}
	...
	public DRINK_ACTION(Participant participant) {
	...
	public DRINK_ACTION(PotentialAction potentialAction) {
	...
	public DRINK_ACTION(Result result) {
		setResult(result);
	}
	...
	public DRINK_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DRINK_ACTION(StartTime startTime) {
	...
	public DRINK_ACTION(SubjectOf subjectOf) {
	...
	public DRINK_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.DrinkAction org) {
		setSeq(org.getSeq());
