...
public class COMMENT implements Clazz.Comment, Container.Comment {
	...
	public COMMENT(AccessMode accessMode) {
	...
	public COMMENT(AccessModeSufficient accessModeSufficient) {
	...
	public COMMENT(AccessibilityAPI accessibilityAPI) {
	...
	public COMMENT(AccessibilityControl accessibilityControl) {
	...
	public COMMENT(AccessibilityFeature accessibilityFeature) {
	...
	public COMMENT(AccessibilityHazard accessibilityHazard) {
	...
	public COMMENT(AccessibilitySummary accessibilitySummary) {
	...
	public COMMENT(AccountablePerson accountablePerson) {
	...
	public COMMENT(AdditionalType additionalType) {
	...
	public COMMENT(AggregateRating aggregateRating) {
	...
	public COMMENT(AlternateName alternateName) {
	...
	public COMMENT(AlternativeHeadline alternativeHeadline) {
	...
	public COMMENT(Audience audience) {
	...
	public COMMENT(Character character) {
	...
	public COMMENT(Citation citation) {
	...
	public COMMENT(Container.Comment comment) {
		setComment(comment);
	}
	...
	public COMMENT(Clazz.Comment comment) {
	...
	public COMMENT(CommentCount commentCount) {
	...
	public COMMENT(ContentLocation contentLocation) {
	...
	public COMMENT(ContentRating contentRating) {
	...
	public COMMENT(ContentReferenceTime contentReferenceTime) {
	...
	public COMMENT(Contributor contributor) {
	...
	public COMMENT(CopyrightHolder copyrightHolder) {
	...
	public COMMENT(CopyrightYear copyrightYear) {
	...
	public COMMENT(Correction correction) {
	...
	public COMMENT(DateCreated dateCreated) {
	...
	public COMMENT(DateModified dateModified) {
	...
	public COMMENT(DatePublished datePublished) {
	...
	public COMMENT(Description description) {
	...
	public COMMENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public COMMENT(DiscussionUrl discussionUrl) {
	...
	public COMMENT(DownvoteCount downvoteCount) {
	...
	public COMMENT(EducationalAlignment educationalAlignment) {
	...
	public COMMENT(EducationalUse educationalUse) {
	...
	public COMMENT(EncodingFormat encodingFormat) {
	...
	public COMMENT(ExampleOfWork exampleOfWork) {
	...
	public COMMENT(Expires expires) {
		setExpires(expires);
	}
	...
	public COMMENT(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public COMMENT(Headline headline) {
	...
	public COMMENT(Identifier identifier) {
	...
	public COMMENT(InLanguage inLanguage) {
	...
	public COMMENT(InteractionStatistic interactionStatistic) {
	...
	public COMMENT(InteractivityType interactivityType) {
	...
	public COMMENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public COMMENT(IsBasedOn isBasedOn) {
	...
	public COMMENT(IsFamilyFriendly isFamilyFriendly) {
	...
	public COMMENT(IsPartOf isPartOf) {
	...
	public COMMENT(Keywords keywords) {
	...
	public COMMENT(LearningResourceType learningResourceType) {
	...
	public COMMENT(License license) {
		setLicense(license);
	}
	...
	public COMMENT(LocationCreated locationCreated) {
	...
	public COMMENT(MainEntity mainEntity) {
	...
	public COMMENT(MainEntityOfPage mainEntityOfPage) {
	...
	public COMMENT(Material material) {
	...
	public COMMENT(MaterialExtent materialExtent) {
	...
	public COMMENT(Mentions mentions) {
	...
	public COMMENT(NameFuzzy nameFuzzy) {
	...
	public COMMENT(NameRuby nameRuby) {
	...
	public COMMENT(ParentItem parentItem) {
	...
	public COMMENT(PotentialAction potentialAction) {
	...
	public COMMENT(Producer producer) {
	...
	public COMMENT(Provider provider) {
	...
	public COMMENT(Publisher publisher) {
	...
	public COMMENT(PublisherImprint publisherImprint) {
	...
	public COMMENT(PublishingPrinciples publishingPrinciples) {
	...
	public COMMENT(RecordedAt recordedAt) {
	...
	public COMMENT(ReleasedEvent releasedEvent) {
	...
	public COMMENT(SchemaVersion schemaVersion) {
	...
	public COMMENT(SdDatePublished sdDatePublished) {
	...
	public COMMENT(SdLicense sdLicense) {
	...
	public COMMENT(SdPublisher sdPublisher) {
	...
	public COMMENT(SourceOrganization sourceOrganization) {
	...
	public COMMENT(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public COMMENT(SpatialCoverage spatialCoverage) {
	...
	public COMMENT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public COMMENT(SubjectOf subjectOf) {
	...
	public COMMENT(Temporal temporal) {
	...
	public COMMENT(TemporalCoverage temporalCoverage) {
	...
	public COMMENT(ThumbnailUrl thumbnailUrl) {
	...
	public COMMENT(TimeRequired timeRequired) {
	...
	public COMMENT(TranslationOfWork translationOfWork) {
	...
	public COMMENT(Translator translator) {
	...
	public COMMENT(TypicalAgeRange typicalAgeRange) {
	...
	public COMMENT(UpvoteCount upvoteCount) {
	...
	public COMMENT(Version version) {
		setVersion(version);
	}
	...
	public COMMENT(WorkExample workExample) {
	...
	public COMMENT(WorkTranslation workTranslation) {
