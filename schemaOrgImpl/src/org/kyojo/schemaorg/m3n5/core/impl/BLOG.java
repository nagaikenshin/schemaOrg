...
import org.kyojo.schemaorg.m3n5.core.Container.BlogPost;
...
public class BLOG implements Clazz.Blog {
	...
	public BLOG(Long seq) {
		setSeq(seq);
	}

	public BLOG(String string) {
	...
	public BLOG(AccessMode accessMode) {
	...
	public BLOG(AccessModeSufficient accessModeSufficient) {
	...
	public BLOG(AccessibilityAPI accessibilityAPI) {
	...
	public BLOG(AccessibilityControl accessibilityControl) {
	...
	public BLOG(AccessibilityFeature accessibilityFeature) {
	...
	public BLOG(AccessibilityHazard accessibilityHazard) {
	...
	public BLOG(AccessibilitySummary accessibilitySummary) {
	...
	public BLOG(AccountablePerson accountablePerson) {
	...
	public BLOG(AdditionalType additionalType) {
	...
	public BLOG(AggregateRating aggregateRating) {
	...
	public BLOG(AlternateName alternateName) {
	...
	public BLOG(AlternativeHeadline alternativeHeadline) {
	...
	public BLOG(AssociatedMedia associatedMedia) {
	...
	public BLOG(Character character) {
	...
	public BLOG(CommentCount commentCount) {
	...
	public BLOG(ContentLocation contentLocation) {
	...
	public BLOG(ContentRating contentRating) {
	...
	public BLOG(ContentReferenceTime contentReferenceTime) {
	...
	public BLOG(Contributor contributor) {
	...
	public BLOG(CopyrightHolder copyrightHolder) {
	...
	public BLOG(CopyrightYear copyrightYear) {
	...
	public BLOG(Correction correction) {
	...
	public BLOG(DateCreated dateCreated) {
	...
	public BLOG(DateModified dateModified) {
	...
	public BLOG(DatePublished datePublished) {
	...
	public BLOG(Description description) {
	...
	public BLOG(DisambiguatingDescription disambiguatingDescription) {
	...
	public BLOG(DiscussionUrl discussionUrl) {
	...
	public BLOG(EducationalAlignment educationalAlignment) {
	...
	public BLOG(EducationalUse educationalUse) {
	...
	public BLOG(EncodingFormat encodingFormat) {
	...
	public BLOG(ExampleOfWork exampleOfWork) {
	...
	public BLOG(Identifier identifier) {
	...
	public BLOG(InLanguage inLanguage) {
	...
	public BLOG(InteractionStatistic interactionStatistic) {
	...
	public BLOG(InteractivityType interactivityType) {
	...
	public BLOG(IsAccessibleForFree isAccessibleForFree) {
	...
	public BLOG(IsBasedOn isBasedOn) {
	...
	public BLOG(IsFamilyFriendly isFamilyFriendly) {
	...
	public BLOG(LearningResourceType learningResourceType) {
	...
	public BLOG(LocationCreated locationCreated) {
	...
	public BLOG(MainEntity mainEntity) {
	...
	public BLOG(MainEntityOfPage mainEntityOfPage) {
	...
	public BLOG(MaterialExtent materialExtent) {
	...
	public BLOG(NameFuzzy nameFuzzy) {
	...
	public BLOG(PotentialAction potentialAction) {
	...
	public BLOG(Publication publication) {
	...
	public BLOG(Publisher publisher) {
	...
	public BLOG(PublisherImprint publisherImprint) {
	...
	public BLOG(PublishingPrinciples publishingPrinciples) {
	...
	public BLOG(RecordedAt recordedAt) {
	...
	public BLOG(ReleasedEvent releasedEvent) {
	...
	public BLOG(SchemaVersion schemaVersion) {
	...
	public BLOG(SdDatePublished sdDatePublished) {
	...
	public BLOG(SdLicense sdLicense) {
	...
	public BLOG(SdPublisher sdPublisher) {
	...
	public BLOG(SourceOrganization sourceOrganization) {
	...
	public BLOG(SpatialCoverage spatialCoverage) {
	...
	public BLOG(SubjectOf subjectOf) {
	...
	public BLOG(TemporalCoverage temporalCoverage) {
	...
	public BLOG(ThumbnailUrl thumbnailUrl) {
	...
	public BLOG(TimeRequired timeRequired) {
	...
	public BLOG(TranslationOfWork translationOfWork) {
	...
	public BLOG(Translator translator) {
	...
	public BLOG(TypicalAgeRange typicalAgeRange) {
	...
	public BLOG(WorkExample workExample) {
	...
	public BLOG(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Blog org) {
		setSeq(org.getSeq());
