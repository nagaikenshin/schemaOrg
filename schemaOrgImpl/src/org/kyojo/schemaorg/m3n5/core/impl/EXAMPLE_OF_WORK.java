...
public class EXAMPLE_OF_WORK implements Container.ExampleOfWork {
	...
	public EXAMPLE_OF_WORK(String string) {
	...
	public EXAMPLE_OF_WORK(APIReference apiReference) {
	...
	public EXAMPLE_OF_WORK(AboutPage aboutPage) {
	...
	public EXAMPLE_OF_WORK(AdvertiserContentArticle advertiserContentArticle) {
	...
	public EXAMPLE_OF_WORK(AnalysisNewsArticle analysisNewsArticle) {
	...
	public EXAMPLE_OF_WORK(Answer answer) {
	...
	public EXAMPLE_OF_WORK(ArchiveComponent archiveComponent) {
	...
	public EXAMPLE_OF_WORK(Article article) {
	...
	public EXAMPLE_OF_WORK(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public EXAMPLE_OF_WORK(Atlas atlas) {
	...
	public EXAMPLE_OF_WORK(AudioObject audioObject) {
	...
	public EXAMPLE_OF_WORK(Audiobook audiobook) {
	...
	public EXAMPLE_OF_WORK(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public EXAMPLE_OF_WORK(Barcode barcode) {
	...
	public EXAMPLE_OF_WORK(Blog blog) {
	...
	public EXAMPLE_OF_WORK(BlogPosting blogPosting) {
	...
	public EXAMPLE_OF_WORK(Book book) {
	...
	public EXAMPLE_OF_WORK(BookSeries bookSeries) {
	...
	public EXAMPLE_OF_WORK(CategoryCodeSet categoryCodeSet) {
	...
	public EXAMPLE_OF_WORK(Chapter chapter) {
	...
	public EXAMPLE_OF_WORK(CheckoutPage checkoutPage) {
	...
	public EXAMPLE_OF_WORK(Claim claim) {
	...
	public EXAMPLE_OF_WORK(ClaimReview claimReview) {
	...
	public EXAMPLE_OF_WORK(Clip clip) {
	...
	public EXAMPLE_OF_WORK(Collection collection) {
	...
	public EXAMPLE_OF_WORK(CollectionPage collectionPage) {
	...
	public EXAMPLE_OF_WORK(ComicCoverArt comicCoverArt) {
	...
	public EXAMPLE_OF_WORK(ComicIssue comicIssue) {
	...
	public EXAMPLE_OF_WORK(ComicSeries comicSeries) {
	...
	public EXAMPLE_OF_WORK(ComicStory comicStory) {
	...
	public EXAMPLE_OF_WORK(Comment comment) {
	...
	public EXAMPLE_OF_WORK(CompleteDataFeed completeDataFeed) {
	...
	public EXAMPLE_OF_WORK(ContactPage contactPage) {
	...
	public EXAMPLE_OF_WORK(Conversation conversation) {
	...
	public EXAMPLE_OF_WORK(CorrectionComment correctionComment) {
	...
	public EXAMPLE_OF_WORK(Course course) {
	...
	public EXAMPLE_OF_WORK(CoverArt coverArt) {
	...
	public EXAMPLE_OF_WORK(CreativeWork creativeWork) {
		creativeWorkList = new ArrayList<CreativeWork>();
	...
	public EXAMPLE_OF_WORK(CreativeWorkSeason creativeWorkSeason) {
	...
	public EXAMPLE_OF_WORK(CreativeWorkSeries creativeWorkSeries) {
	...
	public EXAMPLE_OF_WORK(CriticReview criticReview) {
	...
	public EXAMPLE_OF_WORK(DataCatalog dataCatalog) {
	...
	public EXAMPLE_OF_WORK(DataDownload dataDownload) {
	...
	public EXAMPLE_OF_WORK(DataFeed dataFeed) {
	...
	public EXAMPLE_OF_WORK(Dataset dataset) {
	...
	public EXAMPLE_OF_WORK(DefinedTermSet definedTermSet) {
	...
	public EXAMPLE_OF_WORK(Diet diet) {
	...
	public EXAMPLE_OF_WORK(DigitalDocument digitalDocument) {
	...
	public EXAMPLE_OF_WORK(DiscussionForumPosting discussionForumPosting) {
	...
	public EXAMPLE_OF_WORK(Drawing drawing) {
	...
	public EXAMPLE_OF_WORK(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public EXAMPLE_OF_WORK(EmailMessage emailMessage) {
	...
	public EXAMPLE_OF_WORK(EmployerReview employerReview) {
	...
	public EXAMPLE_OF_WORK(Episode episode) {
	...
	public EXAMPLE_OF_WORK(ExercisePlan exercisePlan) {
	...
	public EXAMPLE_OF_WORK(FAQPage faqPage) {
	...
	public EXAMPLE_OF_WORK(Game game) {
	...
	public EXAMPLE_OF_WORK(HowTo howTo) {
	...
	public EXAMPLE_OF_WORK(HowToDirection howToDirection) {
	...
	public EXAMPLE_OF_WORK(HowToSection howToSection) {
	...
	public EXAMPLE_OF_WORK(HowToStep howToStep) {
	...
	public EXAMPLE_OF_WORK(HowToTip howToTip) {
	...
	public EXAMPLE_OF_WORK(ImageGallery imageGallery) {
	...
	public EXAMPLE_OF_WORK(ImageObject imageObject) {
	...
	public EXAMPLE_OF_WORK(ItemPage itemPage) {
	...
	public EXAMPLE_OF_WORK(Legislation legislation) {
	...
	public EXAMPLE_OF_WORK(LegislationObject legislationObject) {
	...
	public EXAMPLE_OF_WORK(LiveBlogPosting liveBlogPosting) {
	...
	public EXAMPLE_OF_WORK(Manuscript manuscript) {
	...
	public EXAMPLE_OF_WORK(Map map) {
	...
	public EXAMPLE_OF_WORK(MediaObject mediaObject) {
	...
	public EXAMPLE_OF_WORK(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public EXAMPLE_OF_WORK(MedicalWebPage medicalWebPage) {
	...
	public EXAMPLE_OF_WORK(Menu menu) {
	...
	public EXAMPLE_OF_WORK(MenuSection menuSection) {
	...
	public EXAMPLE_OF_WORK(Message message) {
	...
	public EXAMPLE_OF_WORK(MobileApplication mobileApplication) {
	...
	public EXAMPLE_OF_WORK(Movie movie) {
	...
	public EXAMPLE_OF_WORK(MovieClip movieClip) {
	...
	public EXAMPLE_OF_WORK(MovieSeries movieSeries) {
	...
	public EXAMPLE_OF_WORK(MusicAlbum musicAlbum) {
	...
	public EXAMPLE_OF_WORK(MusicComposition musicComposition) {
	...
	public EXAMPLE_OF_WORK(MusicPlaylist musicPlaylist) {
	...
	public EXAMPLE_OF_WORK(MusicRecording musicRecording) {
	...
	public EXAMPLE_OF_WORK(MusicRelease musicRelease) {
	...
	public EXAMPLE_OF_WORK(MusicVideoObject musicVideoObject) {
	...
	public EXAMPLE_OF_WORK(NewsArticle newsArticle) {
	...
	public EXAMPLE_OF_WORK(Newspaper newspaper) {
	...
	public EXAMPLE_OF_WORK(NoteDigitalDocument noteDigitalDocument) {
	...
	public EXAMPLE_OF_WORK(OpinionNewsArticle opinionNewsArticle) {
	...
	public EXAMPLE_OF_WORK(Painting painting) {
	...
	public EXAMPLE_OF_WORK(Periodical periodical) {
	...
	public EXAMPLE_OF_WORK(Photograph photograph) {
	...
	public EXAMPLE_OF_WORK(Play play) {
	...
	public EXAMPLE_OF_WORK(Poster poster) {
	...
	public EXAMPLE_OF_WORK(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public EXAMPLE_OF_WORK(ProfilePage profilePage) {
	...
	public EXAMPLE_OF_WORK(PublicationIssue publicationIssue) {
	...
	public EXAMPLE_OF_WORK(PublicationVolume publicationVolume) {
	...
	public EXAMPLE_OF_WORK(QAPage qaPage) {
	...
	public EXAMPLE_OF_WORK(Question question) {
	...
	public EXAMPLE_OF_WORK(Quotation quotation) {
	...
	public EXAMPLE_OF_WORK(RadioClip radioClip) {
	...
	public EXAMPLE_OF_WORK(RadioEpisode radioEpisode) {
	...
	public EXAMPLE_OF_WORK(RadioSeason radioSeason) {
	...
	public EXAMPLE_OF_WORK(RadioSeries radioSeries) {
	...
	public EXAMPLE_OF_WORK(Recipe recipe) {
	...
	public EXAMPLE_OF_WORK(Report report) {
	...
	public EXAMPLE_OF_WORK(ReportageNewsArticle reportageNewsArticle) {
	...
	public EXAMPLE_OF_WORK(Review review) {
	...
	public EXAMPLE_OF_WORK(ReviewNewsArticle reviewNewsArticle) {
	...
	public EXAMPLE_OF_WORK(SatiricalArticle satiricalArticle) {
	...
	public EXAMPLE_OF_WORK(ScholarlyArticle scholarlyArticle) {
	...
	public EXAMPLE_OF_WORK(Sculpture sculpture) {
	...
	public EXAMPLE_OF_WORK(SearchResultsPage searchResultsPage) {
	...
	public EXAMPLE_OF_WORK(SheetMusic sheetMusic) {
	...
	public EXAMPLE_OF_WORK(ShortStory shortStory) {
	...
	public EXAMPLE_OF_WORK(SiteNavigationElement siteNavigationElement) {
	...
	public EXAMPLE_OF_WORK(SocialMediaPosting socialMediaPosting) {
	...
	public EXAMPLE_OF_WORK(SoftwareApplication softwareApplication) {
	...
	public EXAMPLE_OF_WORK(SoftwareSourceCode softwareSourceCode) {
	...
	public EXAMPLE_OF_WORK(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public EXAMPLE_OF_WORK(TVClip tvClip) {
	...
	public EXAMPLE_OF_WORK(TVEpisode tvEpisode) {
	...
	public EXAMPLE_OF_WORK(TVSeason tvSeason) {
	...
	public EXAMPLE_OF_WORK(TVSeries tvSeries) {
	...
	public EXAMPLE_OF_WORK(Table table) {
	...
	public EXAMPLE_OF_WORK(TechArticle techArticle) {
	...
	public EXAMPLE_OF_WORK(TextDigitalDocument textDigitalDocument) {
	...
	public EXAMPLE_OF_WORK(Thesis thesis) {
	...
	public EXAMPLE_OF_WORK(ThreeDimensionalModel threeDimensionalModel) {
	...
	public EXAMPLE_OF_WORK(UserReview userReview) {
	...
	public EXAMPLE_OF_WORK(VideoGallery videoGallery) {
	...
	public EXAMPLE_OF_WORK(VideoGame videoGame) {
	...
	public EXAMPLE_OF_WORK(VideoGameClip videoGameClip) {
	...
	public EXAMPLE_OF_WORK(VideoGameSeries videoGameSeries) {
	...
	public EXAMPLE_OF_WORK(VideoObject videoObject) {
	...
	public EXAMPLE_OF_WORK(VisualArtwork visualArtwork) {
	...
	public EXAMPLE_OF_WORK(WPAdBlock wpAdBlock) {
	...
	public EXAMPLE_OF_WORK(WPFooter wpFooter) {
	...
	public EXAMPLE_OF_WORK(WPHeader wpHeader) {
	...
	public EXAMPLE_OF_WORK(WPSideBar wpSideBar) {
	...
	public EXAMPLE_OF_WORK(WebApplication webApplication) {
	...
	public EXAMPLE_OF_WORK(WebPage webPage) {
	...
	public EXAMPLE_OF_WORK(WebPageElement webPageElement) {
	...
	public EXAMPLE_OF_WORK(WebSite webSite) {
	...
	public void copy(Container.ExampleOfWork org) {
