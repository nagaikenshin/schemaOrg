...
public class TRAVEL_AGENCY implements Clazz.TravelAgency {
	...
	public TRAVEL_AGENCY(GeoContains geoContains) {
	...
	public TRAVEL_AGENCY(GeoCoveredBy geoCoveredBy) {
	...
	public TRAVEL_AGENCY(GeoCovers geoCovers) {
	...
	public TRAVEL_AGENCY(GeoCrosses geoCrosses) {
	...
	public TRAVEL_AGENCY(GeoDisjoint geoDisjoint) {
	...
	public TRAVEL_AGENCY(GeoEquals geoEquals) {
	...
	public TRAVEL_AGENCY(GeoIntersects geoIntersects) {
	...
	public TRAVEL_AGENCY(GeoOverlaps geoOverlaps) {
	...
	public TRAVEL_AGENCY(GeoTouches geoTouches) {
	...
	public TRAVEL_AGENCY(GeoWithin geoWithin) {
	...
	public TRAVEL_AGENCY(Slogan slogan) {
		setSlogan(slogan);
	}
