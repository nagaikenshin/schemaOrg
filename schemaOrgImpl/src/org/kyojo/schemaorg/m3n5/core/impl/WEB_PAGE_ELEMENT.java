...
public class WEB_PAGE_ELEMENT implements Clazz.WebPageElement {
	...
	public WEB_PAGE_ELEMENT() {
	}

	public WEB_PAGE_ELEMENT(Long seq) {
		setSeq(seq);
	}

	public WEB_PAGE_ELEMENT(String string) {
	...
	public WEB_PAGE_ELEMENT(About about) {
		setAbout(about);
	}
	...
	public WEB_PAGE_ELEMENT(AccessMode accessMode) {
	...
	public WEB_PAGE_ELEMENT(AccessModeSufficient accessModeSufficient) {
	...
	public WEB_PAGE_ELEMENT(AccessibilityAPI accessibilityAPI) {
	...
	public WEB_PAGE_ELEMENT(AccessibilityControl accessibilityControl) {
	...
	public WEB_PAGE_ELEMENT(AccessibilityFeature accessibilityFeature) {
	...
	public WEB_PAGE_ELEMENT(AccessibilityHazard accessibilityHazard) {
	...
	public WEB_PAGE_ELEMENT(AccessibilitySummary accessibilitySummary) {
	...
	public WEB_PAGE_ELEMENT(AccountablePerson accountablePerson) {
	...
	public WEB_PAGE_ELEMENT(AdditionalType additionalType) {
	...
	public WEB_PAGE_ELEMENT(AggregateRating aggregateRating) {
	...
	public WEB_PAGE_ELEMENT(AlternateName alternateName) {
	...
	public WEB_PAGE_ELEMENT(AlternativeHeadline alternativeHeadline) {
	...
	public WEB_PAGE_ELEMENT(AssociatedMedia associatedMedia) {
	...
	public WEB_PAGE_ELEMENT(Audience audience) {
	...
	public WEB_PAGE_ELEMENT(Audio audio) {
		setAudio(audio);
	}
	...
	public WEB_PAGE_ELEMENT(Author author) {
		setAuthor(author);
	}
	...
	public WEB_PAGE_ELEMENT(Award award) {
		setAward(award);
	}
	...
	public WEB_PAGE_ELEMENT(Character character) {
	...
	public WEB_PAGE_ELEMENT(Citation citation) {
	...
	public WEB_PAGE_ELEMENT(Comment comment) {
		setComment(comment);
	}
	...
	public WEB_PAGE_ELEMENT(CommentCount commentCount) {
	...
	public WEB_PAGE_ELEMENT(ContentLocation contentLocation) {
	...
	public WEB_PAGE_ELEMENT(ContentRating contentRating) {
	...
	public WEB_PAGE_ELEMENT(ContentReferenceTime contentReferenceTime) {
	...
	public WEB_PAGE_ELEMENT(Contributor contributor) {
	...
	public WEB_PAGE_ELEMENT(CopyrightHolder copyrightHolder) {
	...
	public WEB_PAGE_ELEMENT(CopyrightYear copyrightYear) {
	...
	public WEB_PAGE_ELEMENT(Correction correction) {
	...
	public WEB_PAGE_ELEMENT(Creator creator) {
		setCreator(creator);
	}
	...
	public WEB_PAGE_ELEMENT(CssSelector cssSelector) {
	...
	public WEB_PAGE_ELEMENT(DateCreated dateCreated) {
	...
	public WEB_PAGE_ELEMENT(DateModified dateModified) {
	...
	public WEB_PAGE_ELEMENT(DatePublished datePublished) {
	...
	public WEB_PAGE_ELEMENT(Description description) {
	...
	public WEB_PAGE_ELEMENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public WEB_PAGE_ELEMENT(DiscussionUrl discussionUrl) {
	...
	public WEB_PAGE_ELEMENT(Editor editor) {
		setEditor(editor);
	}
	...
	public WEB_PAGE_ELEMENT(EducationalAlignment educationalAlignment) {
	...
	public WEB_PAGE_ELEMENT(EducationalUse educationalUse) {
	...
	public WEB_PAGE_ELEMENT(Encoding encoding) {
	...
	public WEB_PAGE_ELEMENT(EncodingFormat encodingFormat) {
	...
	public WEB_PAGE_ELEMENT(ExampleOfWork exampleOfWork) {
	...
	public WEB_PAGE_ELEMENT(Expires expires) {
		setExpires(expires);
	}
	...
	public WEB_PAGE_ELEMENT(Funder funder) {
		setFunder(funder);
	}
	...
	public WEB_PAGE_ELEMENT(Genre genre) {
		setGenre(genre);
	}
	...
	public WEB_PAGE_ELEMENT(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public WEB_PAGE_ELEMENT(Headline headline) {
	...
	public WEB_PAGE_ELEMENT(Identifier identifier) {
	...
	public WEB_PAGE_ELEMENT(Image image) {
		setImage(image);
	}
	...
	public WEB_PAGE_ELEMENT(InLanguage inLanguage) {
	...
	public WEB_PAGE_ELEMENT(InteractionStatistic interactionStatistic) {
	...
	public WEB_PAGE_ELEMENT(InteractivityType interactivityType) {
	...
	public WEB_PAGE_ELEMENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public WEB_PAGE_ELEMENT(IsBasedOn isBasedOn) {
	...
	public WEB_PAGE_ELEMENT(IsFamilyFriendly isFamilyFriendly) {
	...
	public WEB_PAGE_ELEMENT(IsPartOf isPartOf) {
	...
	public WEB_PAGE_ELEMENT(Keywords keywords) {
	...
	public WEB_PAGE_ELEMENT(LearningResourceType learningResourceType) {
	...
	public WEB_PAGE_ELEMENT(License license) {
		setLicense(license);
	}
	...
	public WEB_PAGE_ELEMENT(LocationCreated locationCreated) {
	...
	public WEB_PAGE_ELEMENT(MainEntity mainEntity) {
	...
	public WEB_PAGE_ELEMENT(MainEntityOfPage mainEntityOfPage) {
	...
	public WEB_PAGE_ELEMENT(Material material) {
	...
	public WEB_PAGE_ELEMENT(MaterialExtent materialExtent) {
	...
	public WEB_PAGE_ELEMENT(Mentions mentions) {
	...
	public WEB_PAGE_ELEMENT(Name name) {
		setName(name);
	}
	...
	public WEB_PAGE_ELEMENT(NameFuzzy nameFuzzy) {
	...
	public WEB_PAGE_ELEMENT(NameRuby nameRuby) {
	...
	public WEB_PAGE_ELEMENT(Offers offers) {
		setOffers(offers);
	}
	...
	public WEB_PAGE_ELEMENT(Position position) {
	...
	public WEB_PAGE_ELEMENT(PotentialAction potentialAction) {
	...
	public WEB_PAGE_ELEMENT(Producer producer) {
	...
	public WEB_PAGE_ELEMENT(Provider provider) {
	...
	public WEB_PAGE_ELEMENT(Publication publication) {
	...
	public WEB_PAGE_ELEMENT(Publisher publisher) {
	...
	public WEB_PAGE_ELEMENT(PublisherImprint publisherImprint) {
	...
	public WEB_PAGE_ELEMENT(PublishingPrinciples publishingPrinciples) {
	...
	public WEB_PAGE_ELEMENT(RecordedAt recordedAt) {
	...
	public WEB_PAGE_ELEMENT(ReleasedEvent releasedEvent) {
	...
	public WEB_PAGE_ELEMENT(Review review) {
		setReview(review);
	}
	...
	public WEB_PAGE_ELEMENT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public WEB_PAGE_ELEMENT(SchemaVersion schemaVersion) {
	...
	public WEB_PAGE_ELEMENT(SdDatePublished sdDatePublished) {
	...
	public WEB_PAGE_ELEMENT(SdLicense sdLicense) {
	...
	public WEB_PAGE_ELEMENT(SdPublisher sdPublisher) {
	...
	public WEB_PAGE_ELEMENT(SourceOrganization sourceOrganization) {
	...
	public WEB_PAGE_ELEMENT(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public WEB_PAGE_ELEMENT(SpatialCoverage spatialCoverage) {
	...
	public WEB_PAGE_ELEMENT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public WEB_PAGE_ELEMENT(SubjectOf subjectOf) {
	...
	public WEB_PAGE_ELEMENT(Temporal temporal) {
	...
	public WEB_PAGE_ELEMENT(TemporalCoverage temporalCoverage) {
	...
	public WEB_PAGE_ELEMENT(Text text) {
		setText(text);
	}
	...
	public WEB_PAGE_ELEMENT(ThumbnailUrl thumbnailUrl) {
	...
	public WEB_PAGE_ELEMENT(TimeRequired timeRequired) {
	...
	public WEB_PAGE_ELEMENT(TranslationOfWork translationOfWork) {
	...
	public WEB_PAGE_ELEMENT(Translator translator) {
	...
	public WEB_PAGE_ELEMENT(TypicalAgeRange typicalAgeRange) {
	...
	public WEB_PAGE_ELEMENT(Url url) {
		setUrl(url);
	}
	...
	public WEB_PAGE_ELEMENT(Version version) {
		setVersion(version);
	}
	...
	public WEB_PAGE_ELEMENT(Video video) {
		setVideo(video);
	}
	...
	public WEB_PAGE_ELEMENT(WorkExample workExample) {
	...
	public WEB_PAGE_ELEMENT(WorkTranslation workTranslation) {
	...
	public WEB_PAGE_ELEMENT(Xpath xpath) {
		setXpath(xpath);
	}
	...
	public void copy(Clazz.WebPageElement org) {
		setSeq(org.getSeq());
