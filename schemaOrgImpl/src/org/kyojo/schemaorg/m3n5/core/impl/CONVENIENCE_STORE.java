...
public class CONVENIENCE_STORE implements Clazz.ConvenienceStore {
	...
	public CONVENIENCE_STORE(GeoContains geoContains) {
	...
	public CONVENIENCE_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public CONVENIENCE_STORE(GeoCovers geoCovers) {
	...
	public CONVENIENCE_STORE(GeoCrosses geoCrosses) {
	...
	public CONVENIENCE_STORE(GeoDisjoint geoDisjoint) {
	...
	public CONVENIENCE_STORE(GeoEquals geoEquals) {
	...
	public CONVENIENCE_STORE(GeoIntersects geoIntersects) {
	...
	public CONVENIENCE_STORE(GeoOverlaps geoOverlaps) {
	...
	public CONVENIENCE_STORE(GeoTouches geoTouches) {
	...
	public CONVENIENCE_STORE(GeoWithin geoWithin) {
	...
	public CONVENIENCE_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
