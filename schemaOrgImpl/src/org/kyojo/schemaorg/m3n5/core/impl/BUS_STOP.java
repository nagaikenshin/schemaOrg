...
public class BUS_STOP implements Clazz.BusStop {
	...
	public BUS_STOP(GeoContains geoContains) {
	...
	public BUS_STOP(GeoCoveredBy geoCoveredBy) {
	...
	public BUS_STOP(GeoCovers geoCovers) {
	...
	public BUS_STOP(GeoCrosses geoCrosses) {
	...
	public BUS_STOP(GeoDisjoint geoDisjoint) {
	...
	public BUS_STOP(GeoEquals geoEquals) {
	...
	public BUS_STOP(GeoIntersects geoIntersects) {
	...
	public BUS_STOP(GeoOverlaps geoOverlaps) {
	...
	public BUS_STOP(GeoTouches geoTouches) {
	...
	public BUS_STOP(GeoWithin geoWithin) {
