...
public class WINNER implements Container.Winner {
	...
	public WINNER(AccountingService accountingService) {
	...
	public WINNER(AdultEntertainment adultEntertainment) {
	...
	public WINNER(AmusementPark amusementPark) {
	...
	public WINNER(AnimalShelter animalShelter) {
	...
	public WINNER(ArchiveOrganization archiveOrganization) {
	...
	public WINNER(ArtGallery artGallery) {
	...
	public WINNER(Attorney attorney) {
	...
	public WINNER(AutoBodyShop autoBodyShop) {
	...
	public WINNER(AutoDealer autoDealer) {
	...
	public WINNER(AutoPartsStore autoPartsStore) {
	...
	public WINNER(AutoRental autoRental) {
	...
	public WINNER(AutoRepair autoRepair) {
	...
	public WINNER(AutoWash autoWash) {
	...
	public WINNER(AutomatedTeller automatedTeller) {
	...
	public WINNER(AutomotiveBusiness automotiveBusiness) {
	...
	public WINNER(BankOrCreditUnion bankOrCreditUnion) {
	...
	public WINNER(BarOrPub barOrPub) {
	...
	public WINNER(BeautySalon beautySalon) {
	...
	public WINNER(BedAndBreakfast bedAndBreakfast) {
	...
	public WINNER(BikeStore bikeStore) {
	...
	public WINNER(BookStore bookStore) {
	...
	public WINNER(BowlingAlley bowlingAlley) {
	...
	public WINNER(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public WINNER(Campground campground) {
	...
	public WINNER(ChildCare childCare) {
	...
	public WINNER(ClothingStore clothingStore) {
	...
	public WINNER(CollegeOrUniversity collegeOrUniversity) {
	...
	public WINNER(ComedyClub comedyClub) {
	...
	public WINNER(CommunityHealth communityHealth) {
	...
	public WINNER(ComputerStore computerStore) {
	...
	public WINNER(Consortium consortium) {
	...
	public WINNER(ConvenienceStore convenienceStore) {
	...
	public WINNER(Corporation corporation) {
	...
	public WINNER(DanceGroup danceGroup) {
	...
	public WINNER(DepartmentStore departmentStore) {
	...
	public WINNER(Dermatology dermatology) {
	...
	public WINNER(DiagnosticLab diagnosticLab) {
	...
	public WINNER(DietNutrition dietNutrition) {
	...
	public WINNER(Distillery distillery) {
	...
	public WINNER(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public WINNER(EducationalOrganization educationalOrganization) {
	...
	public WINNER(Electrician electrician) {
	...
	public WINNER(ElectronicsStore electronicsStore) {
	...
	public WINNER(ElementarySchool elementarySchool) {
	...
	public WINNER(Emergency emergency) {
	...
	public WINNER(EmergencyService emergencyService) {
	...
	public WINNER(EmploymentAgency employmentAgency) {
	...
	public WINNER(EntertainmentBusiness entertainmentBusiness) {
	...
	public WINNER(ExerciseGym exerciseGym) {
	...
	public WINNER(FastFoodRestaurant fastFoodRestaurant) {
	...
	public WINNER(FinancialService financialService) {
	...
	public WINNER(FireStation fireStation) {
	...
	public WINNER(FoodEstablishment foodEstablishment) {
	...
	public WINNER(FundingAgency fundingAgency) {
	...
	public WINNER(FundingScheme fundingScheme) {
	...
	public WINNER(FurnitureStore furnitureStore) {
	...
	public WINNER(GardenStore gardenStore) {
	...
	public WINNER(GasStation gasStation) {
	...
	public WINNER(GeneralContractor generalContractor) {
	...
	public WINNER(Geriatric geriatric) {
	...
	public WINNER(GolfCourse golfCourse) {
	...
	public WINNER(GovernmentOffice governmentOffice) {
	...
	public WINNER(GovernmentOrganization governmentOrganization) {
	...
	public WINNER(GroceryStore groceryStore) {
	...
	public WINNER(Gynecologic gynecologic) {
	...
	public WINNER(HVACBusiness hvacBusiness) {
	...
	public WINNER(HairSalon hairSalon) {
	...
	public WINNER(HardwareStore hardwareStore) {
	...
	public WINNER(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public WINNER(HealthClub healthClub) {
	...
	public WINNER(HighSchool highSchool) {
	...
	public WINNER(HobbyShop hobbyShop) {
	...
	public WINNER(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public WINNER(HomeGoodsStore homeGoodsStore) {
	...
	public WINNER(Hospital hospital) {
	...
	public WINNER(HousePainter housePainter) {
	...
	public WINNER(IceCreamShop iceCreamShop) {
	...
	public WINNER(InsuranceAgency insuranceAgency) {
	...
	public WINNER(InternetCafe internetCafe) {
	...
	public WINNER(JewelryStore jewelryStore) {
	...
	public WINNER(LegalService legalService) {
	...
	public WINNER(LibrarySystem librarySystem) {
	...
	public WINNER(LiquorStore liquorStore) {
	...
	public WINNER(LocalBusiness localBusiness) {
	...
	public WINNER(Locksmith locksmith) {
	...
	public WINNER(LodgingBusiness lodgingBusiness) {
	...
	public WINNER(MedicalBusiness medicalBusiness) {
	...
	public WINNER(MedicalClinic medicalClinic) {
	...
	public WINNER(MedicalOrganization medicalOrganization) {
	...
	public WINNER(MensClothingStore mensClothingStore) {
	...
	public WINNER(MiddleSchool middleSchool) {
	...
	public WINNER(Midwifery midwifery) {
	...
	public WINNER(MobilePhoneStore mobilePhoneStore) {
	...
	public WINNER(MotorcycleDealer motorcycleDealer) {
	...
	public WINNER(MotorcycleRepair motorcycleRepair) {
	...
	public WINNER(MovieRentalStore movieRentalStore) {
	...
	public WINNER(MovieTheater movieTheater) {
	...
	public WINNER(MovingCompany movingCompany) {
	...
	public WINNER(MusicGroup musicGroup) {
	...
	public WINNER(MusicStore musicStore) {
	...
	public WINNER(NailSalon nailSalon) {
	...
	public WINNER(NewsMediaOrganization newsMediaOrganization) {
	...
	public WINNER(NightClub nightClub) {
	...
	public WINNER(Obstetric obstetric) {
	...
	public WINNER(OfficeEquipmentStore officeEquipmentStore) {
	...
	public WINNER(Oncologic oncologic) {
	...
	public WINNER(Optician optician) {
	...
	public WINNER(Optometric optometric) {
	...
	public WINNER(Organization organization) {
	...
	public WINNER(Otolaryngologic otolaryngologic) {
	...
	public WINNER(OutletStore outletStore) {
	...
	public WINNER(PawnShop pawnShop) {
	...
	public WINNER(Pediatric pediatric) {
	...
	public WINNER(PerformingGroup performingGroup) {
	...
	public WINNER(PetStore petStore) {
	...
	public WINNER(Pharmacy pharmacy) {
	...
	public WINNER(Physician physician) {
	...
	public WINNER(Physiotherapy physiotherapy) {
	...
	public WINNER(PlasticSurgery plasticSurgery) {
	...
	public WINNER(Podiatric podiatric) {
	...
	public WINNER(PoliceStation policeStation) {
	...
	public WINNER(PostOffice postOffice) {
	...
	public WINNER(Preschool preschool) {
	...
	public WINNER(PrimaryCare primaryCare) {
	...
	public WINNER(ProfessionalService professionalService) {
	...
	public WINNER(Psychiatric psychiatric) {
	...
	public WINNER(PublicHealth publicHealth) {
	...
	public WINNER(PublicSwimmingPool publicSwimmingPool) {
	...
	public WINNER(RadioStation radioStation) {
	...
	public WINNER(RealEstateAgent realEstateAgent) {
	...
	public WINNER(RecyclingCenter recyclingCenter) {
	...
	public WINNER(ResearchProject researchProject) {
	...
	public WINNER(Restaurant restaurant) {
	...
	public WINNER(RoofingContractor roofingContractor) {
	...
	public WINNER(SelfStorage selfStorage) {
	...
	public WINNER(ShoeStore shoeStore) {
	...
	public WINNER(ShoppingCenter shoppingCenter) {
	...
	public WINNER(SkiResort skiResort) {
	...
	public WINNER(SportingGoodsStore sportingGoodsStore) {
	...
	public WINNER(SportsActivityLocation sportsActivityLocation) {
	...
	public WINNER(SportsClub sportsClub) {
	...
	public WINNER(SportsOrganization sportsOrganization) {
	...
	public WINNER(SportsTeam sportsTeam) {
	...
	public WINNER(StadiumOrArena stadiumOrArena) {
	...
	public WINNER(TattooParlor tattooParlor) {
	...
	public WINNER(TelevisionStation televisionStation) {
	...
	public WINNER(TennisComplex tennisComplex) {
	...
	public WINNER(TheaterGroup theaterGroup) {
	...
	public WINNER(TireShop tireShop) {
	...
	public WINNER(TouristInformationCenter touristInformationCenter) {
	...
	public WINNER(ToyStore toyStore) {
	...
	public WINNER(TravelAgency travelAgency) {
	...
	public WINNER(VeterinaryCare veterinaryCare) {
	...
	public WINNER(WholesaleStore wholesaleStore) {
	...
	public WINNER(WorkersUnion workersUnion) {
	...
	public void copy(Container.Winner org) {
