...
public class MUSIC_GROUP implements Clazz.MusicGroup {
	...
	public MUSIC_GROUP(Long seq) {
		setSeq(seq);
	}

	public MUSIC_GROUP(String string) {
	...
	public MUSIC_GROUP(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public MUSIC_GROUP(AdditionalType additionalType) {
	...
	public MUSIC_GROUP(Address address) {
		setAddress(address);
	}
	...
	public MUSIC_GROUP(AggregateRating aggregateRating) {
	...
	public MUSIC_GROUP(Album album) {
		setAlbum(album);
	}
	...
	public MUSIC_GROUP(AlternateName alternateName) {
	...
	public MUSIC_GROUP(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public MUSIC_GROUP(AreaServed areaServed) {
	...
	public MUSIC_GROUP(Award award) {
		setAward(award);
	}
	...
	public MUSIC_GROUP(Brand brand) {
		setBrand(brand);
	}
	...
	public MUSIC_GROUP(ContactPoint contactPoint) {
	...
	public MUSIC_GROUP(CorrectionsPolicy correctionsPolicy) {
	...
	public MUSIC_GROUP(Department department) {
	...
	public MUSIC_GROUP(Description description) {
	...
	public MUSIC_GROUP(DisambiguatingDescription disambiguatingDescription) {
	...
	public MUSIC_GROUP(DissolutionDate dissolutionDate) {
	...
	public MUSIC_GROUP(DiversityPolicy diversityPolicy) {
	...
	public MUSIC_GROUP(DiversityStaffingReport diversityStaffingReport) {
	...
	public MUSIC_GROUP(Email email) {
		setEmail(email);
	}
	...
	public MUSIC_GROUP(Employee employee) {
	...
	public MUSIC_GROUP(EthicsPolicy ethicsPolicy) {
	...
	public MUSIC_GROUP(Event event) {
		setEvent(event);
	}
	...
	public MUSIC_GROUP(FaxNumber faxNumber) {
	...
	public MUSIC_GROUP(Founder founder) {
		setFounder(founder);
	}
	...
	public MUSIC_GROUP(FoundingDate foundingDate) {
	...
	public MUSIC_GROUP(FoundingLocation foundingLocation) {
	...
	public MUSIC_GROUP(Funder funder) {
		setFunder(funder);
	}
	...
	public MUSIC_GROUP(Genre genre) {
		setGenre(genre);
	}
	...
	public MUSIC_GROUP(GlobalLocationNumber globalLocationNumber) {
	...
	public MUSIC_GROUP(HasOfferCatalog hasOfferCatalog) {
	...
	public MUSIC_GROUP(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public MUSIC_GROUP(Identifier identifier) {
	...
	public MUSIC_GROUP(Image image) {
		setImage(image);
	}
	...
	public MUSIC_GROUP(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public MUSIC_GROUP(KnowsAbout knowsAbout) {
	...
	public MUSIC_GROUP(KnowsLanguage knowsLanguage) {
	...
	public MUSIC_GROUP(LegalName legalName) {
	...
	public MUSIC_GROUP(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public MUSIC_GROUP(Location location) {
	...
	public MUSIC_GROUP(MainEntityOfPage mainEntityOfPage) {
	...
	public MUSIC_GROUP(MakesOffer makesOffer) {
	...
	public MUSIC_GROUP(Member member) {
		setMember(member);
	}
	...
	public MUSIC_GROUP(MemberOf memberOf) {
	...
	public MUSIC_GROUP(Naics naics) {
		setNaics(naics);
	}
	...
	public MUSIC_GROUP(NameFuzzy nameFuzzy) {
	...
	public MUSIC_GROUP(NameRuby nameRuby) {
	...
	public MUSIC_GROUP(NumberOfEmployees numberOfEmployees) {
	...
	public MUSIC_GROUP(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public MUSIC_GROUP(ParentOrganization parentOrganization) {
	...
	public MUSIC_GROUP(PotentialAction potentialAction) {
	...
	public MUSIC_GROUP(PublishingPrinciples publishingPrinciples) {
	...
	public MUSIC_GROUP(Review review) {
		setReview(review);
	}
	...
	public MUSIC_GROUP(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MUSIC_GROUP(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public MUSIC_GROUP(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public MUSIC_GROUP(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MUSIC_GROUP(SubOrganization subOrganization) {
	...
	public MUSIC_GROUP(SubjectOf subjectOf) {
	...
	public MUSIC_GROUP(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public MUSIC_GROUP(Telephone telephone) {
	...
	public MUSIC_GROUP(Track track) {
		setTrack(track);
	}
	...
	public MUSIC_GROUP(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public MUSIC_GROUP(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.MusicGroup org) {
		setSeq(org.getSeq());
