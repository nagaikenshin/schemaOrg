...
public class INTANGIBLE implements Clazz.Intangible {
	...
	public INTANGIBLE(Long seq) {
		setSeq(seq);
	}

	public INTANGIBLE(String string) {
	...
	public INTANGIBLE(AdditionalType additionalType) {
	...
	public INTANGIBLE(AlternateName alternateName) {
	...
	public INTANGIBLE(Description description) {
	...
	public INTANGIBLE(DisambiguatingDescription disambiguatingDescription) {
	...
	public INTANGIBLE(Identifier identifier) {
	...
	public INTANGIBLE(MainEntityOfPage mainEntityOfPage) {
	...
	public INTANGIBLE(NameFuzzy nameFuzzy) {
	...
	public INTANGIBLE(NameRuby nameRuby) {
	...
	public INTANGIBLE(PotentialAction potentialAction) {
	...
	public INTANGIBLE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public INTANGIBLE(SubjectOf subjectOf) {
	...
	public void copy(Clazz.Intangible org) {
		setSeq(org.getSeq());
