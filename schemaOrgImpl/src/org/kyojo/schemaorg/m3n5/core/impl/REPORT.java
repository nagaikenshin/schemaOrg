...
import org.kyojo.schemaorg.m3n5.core.Container.ReportNumber;
...
public class REPORT implements Clazz.Report {
	...
	public ReportNumber reportNumber;
	...
	public REPORT(AccessMode accessMode) {
	...
	public REPORT(AccessModeSufficient accessModeSufficient) {
	...
	public REPORT(AccessibilityAPI accessibilityAPI) {
	...
	public REPORT(AccessibilityControl accessibilityControl) {
	...
	public REPORT(AccessibilityFeature accessibilityFeature) {
	...
	public REPORT(AccessibilityHazard accessibilityHazard) {
	...
	public REPORT(AccessibilitySummary accessibilitySummary) {
	...
	public REPORT(AccountablePerson accountablePerson) {
	...
	public REPORT(AdditionalType additionalType) {
	...
	public REPORT(AggregateRating aggregateRating) {
	...
	public REPORT(AlternateName alternateName) {
	...
	public REPORT(AlternativeHeadline alternativeHeadline) {
	...
	public REPORT(ArticleBody articleBody) {
	...
	public REPORT(ArticleSection articleSection) {
	...
	public REPORT(AssociatedMedia associatedMedia) {
	...
	public REPORT(Audience audience) {
	...
	public REPORT(Backstory backstory) {
	...
	public REPORT(Character character) {
	...
	public REPORT(Citation citation) {
	...
	public REPORT(CommentCount commentCount) {
	...
	public REPORT(ContentLocation contentLocation) {
	...
	public REPORT(ContentRating contentRating) {
	...
	public REPORT(ContentReferenceTime contentReferenceTime) {
	...
	public REPORT(Contributor contributor) {
	...
	public REPORT(CopyrightHolder copyrightHolder) {
	...
	public REPORT(CopyrightYear copyrightYear) {
	...
	public REPORT(Correction correction) {
	...
	public REPORT(DateCreated dateCreated) {
	...
	public REPORT(DateModified dateModified) {
	...
	public REPORT(DatePublished datePublished) {
	...
	public REPORT(DisambiguatingDescription disambiguatingDescription) {
	...
	public REPORT(DiscussionUrl discussionUrl) {
	...
	public REPORT(EducationalAlignment educationalAlignment) {
	...
	public REPORT(EducationalUse educationalUse) {
	...
	public REPORT(Encoding encoding) {
	...
	public REPORT(EncodingFormat encodingFormat) {
	...
	public REPORT(ExampleOfWork exampleOfWork) {
	...
	public REPORT(Headline headline) {
	...
	public REPORT(Identifier identifier) {
	...
	public REPORT(InLanguage inLanguage) {
	...
	public REPORT(InteractionStatistic interactionStatistic) {
	...
	public REPORT(InteractivityType interactivityType) {
	...
	public REPORT(IsAccessibleForFree isAccessibleForFree) {
	...
	public REPORT(IsBasedOn isBasedOn) {
	...
	public REPORT(IsFamilyFriendly isFamilyFriendly) {
	...
	public REPORT(IsPartOf isPartOf) {
	...
	public REPORT(Keywords keywords) {
	...
	public REPORT(LearningResourceType learningResourceType) {
	...
	public REPORT(LocationCreated locationCreated) {
	...
	public REPORT(MainEntity mainEntity) {
	...
	public REPORT(MainEntityOfPage mainEntityOfPage) {
	...
	public REPORT(Material material) {
	...
	public REPORT(MaterialExtent materialExtent) {
	...
	public REPORT(Mentions mentions) {
	...
	public REPORT(NameFuzzy nameFuzzy) {
	...
	public REPORT(NameRuby nameRuby) {
	...
	public REPORT(PageStart pageStart) {
	...
	public REPORT(PotentialAction potentialAction) {
	...
	public REPORT(Producer producer) {
	...
	public REPORT(Provider provider) {
	...
	public REPORT(Publication publication) {
	...
	public REPORT(Publisher publisher) {
	...
	public REPORT(PublisherImprint publisherImprint) {
	...
	public REPORT(PublishingPrinciples publishingPrinciples) {
	...
	public REPORT(RecordedAt recordedAt) {
	...
	public REPORT(ReleasedEvent releasedEvent) {
	...
	public REPORT(ReportNumber reportNumber) {
		setReportNumber(reportNumber);
	}

	@Override
	public ReportNumber getReportNumber() {
		return reportNumber;
	}

	@Override
	public void setReportNumber(ReportNumber reportNumber) {
	...
	public REPORT(SchemaVersion schemaVersion) {
	...
	public REPORT(SdDatePublished sdDatePublished) {
	...
	public REPORT(SdLicense sdLicense) {
	...
	public REPORT(SdPublisher sdPublisher) {
	...
	public REPORT(SourceOrganization sourceOrganization) {
	...
	public REPORT(SpatialCoverage spatialCoverage) {
	...
	public REPORT(Speakable speakable) {
	...
	public REPORT(SubjectOf subjectOf) {
	...
	public REPORT(Temporal temporal) {
	...
	public REPORT(TemporalCoverage temporalCoverage) {
	...
	public REPORT(ThumbnailUrl thumbnailUrl) {
	...
	public REPORT(TimeRequired timeRequired) {
	...
	public REPORT(TranslationOfWork translationOfWork) {
	...
	public REPORT(TypicalAgeRange typicalAgeRange) {
	...
	public REPORT(WordCount wordCount) {
	...
	public REPORT(WorkExample workExample) {
	...
	public REPORT(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Report org) {
		setSeq(org.getSeq());
		...
		setReportNumber(org.getReportNumber());
