...
public class INSURANCE_AGENCY implements Clazz.InsuranceAgency {
	...
	public INSURANCE_AGENCY(GeoContains geoContains) {
	...
	public INSURANCE_AGENCY(GeoCoveredBy geoCoveredBy) {
	...
	public INSURANCE_AGENCY(GeoCovers geoCovers) {
	...
	public INSURANCE_AGENCY(GeoCrosses geoCrosses) {
	...
	public INSURANCE_AGENCY(GeoDisjoint geoDisjoint) {
	...
	public INSURANCE_AGENCY(GeoEquals geoEquals) {
	...
	public INSURANCE_AGENCY(GeoIntersects geoIntersects) {
	...
	public INSURANCE_AGENCY(GeoOverlaps geoOverlaps) {
	...
	public INSURANCE_AGENCY(GeoTouches geoTouches) {
	...
	public INSURANCE_AGENCY(GeoWithin geoWithin) {
	...
	public INSURANCE_AGENCY(Slogan slogan) {
		setSlogan(slogan);
	}
