...
public class HEALTH_AND_BEAUTY_BUSINESS implements Clazz.HealthAndBeautyBusiness {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(GeoContains geoContains) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(GeoCoveredBy geoCoveredBy) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(GeoCovers geoCovers) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(GeoCrosses geoCrosses) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(GeoDisjoint geoDisjoint) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(GeoEquals geoEquals) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(GeoIntersects geoIntersects) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(GeoOverlaps geoOverlaps) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(GeoTouches geoTouches) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(GeoWithin geoWithin) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Slogan slogan) {
		setSlogan(slogan);
	}
