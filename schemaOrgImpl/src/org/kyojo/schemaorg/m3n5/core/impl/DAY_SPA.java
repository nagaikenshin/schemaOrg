...
public class DAY_SPA implements Clazz.DaySpa {
	...
	public DAY_SPA(GeoContains geoContains) {
	...
	public DAY_SPA(GeoCoveredBy geoCoveredBy) {
	...
	public DAY_SPA(GeoCovers geoCovers) {
	...
	public DAY_SPA(GeoCrosses geoCrosses) {
	...
	public DAY_SPA(GeoDisjoint geoDisjoint) {
	...
	public DAY_SPA(GeoEquals geoEquals) {
	...
	public DAY_SPA(GeoIntersects geoIntersects) {
	...
	public DAY_SPA(GeoOverlaps geoOverlaps) {
	...
	public DAY_SPA(GeoTouches geoTouches) {
	...
	public DAY_SPA(GeoWithin geoWithin) {
