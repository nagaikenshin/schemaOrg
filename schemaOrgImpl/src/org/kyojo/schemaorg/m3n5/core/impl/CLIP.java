...
public class CLIP implements Clazz.Clip {
	...
	public CLIP(Long seq) {
		setSeq(seq);
	}

	public CLIP(String string) {
	...
	public CLIP(AccessMode accessMode) {
	...
	public CLIP(AccessModeSufficient accessModeSufficient) {
	...
	public CLIP(AccessibilityAPI accessibilityAPI) {
	...
	public CLIP(AccessibilityControl accessibilityControl) {
	...
	public CLIP(AccessibilityFeature accessibilityFeature) {
	...
	public CLIP(AccessibilityHazard accessibilityHazard) {
	...
	public CLIP(AccessibilitySummary accessibilitySummary) {
	...
	public CLIP(AccountablePerson accountablePerson) {
	...
	public CLIP(AdditionalType additionalType) {
	...
	public CLIP(AggregateRating aggregateRating) {
	...
	public CLIP(AlternateName alternateName) {
	...
	public CLIP(AlternativeHeadline alternativeHeadline) {
	...
	public CLIP(AssociatedMedia associatedMedia) {
	...
	public CLIP(Character character) {
	...
	public CLIP(ClipNumber clipNumber) {
	...
	public CLIP(CommentCount commentCount) {
	...
	public CLIP(ContentLocation contentLocation) {
	...
	public CLIP(ContentRating contentRating) {
	...
	public CLIP(ContentReferenceTime contentReferenceTime) {
	...
	public CLIP(Contributor contributor) {
	...
	public CLIP(CopyrightHolder copyrightHolder) {
	...
	public CLIP(CopyrightYear copyrightYear) {
	...
	public CLIP(Correction correction) {
	...
	public CLIP(DateCreated dateCreated) {
	...
	public CLIP(DateModified dateModified) {
	...
	public CLIP(DatePublished datePublished) {
	...
	public CLIP(Description description) {
	...
	public CLIP(DisambiguatingDescription disambiguatingDescription) {
	...
	public CLIP(DiscussionUrl discussionUrl) {
	...
	public CLIP(EducationalAlignment educationalAlignment) {
	...
	public CLIP(EducationalUse educationalUse) {
	...
	public CLIP(EncodingFormat encodingFormat) {
	...
	public CLIP(EndOffset endOffset) {
	...
	public CLIP(ExampleOfWork exampleOfWork) {
	...
	public CLIP(Identifier identifier) {
	...
	public CLIP(InLanguage inLanguage) {
	...
	public CLIP(InteractionStatistic interactionStatistic) {
	...
	public CLIP(InteractivityType interactivityType) {
	...
	public CLIP(IsAccessibleForFree isAccessibleForFree) {
	...
	public CLIP(IsBasedOn isBasedOn) {
	...
	public CLIP(IsFamilyFriendly isFamilyFriendly) {
	...
	public CLIP(LearningResourceType learningResourceType) {
	...
	public CLIP(LocationCreated locationCreated) {
	...
	public CLIP(MainEntity mainEntity) {
	...
	public CLIP(MainEntityOfPage mainEntityOfPage) {
	...
	public CLIP(MaterialExtent materialExtent) {
	...
	public CLIP(NameFuzzy nameFuzzy) {
	...
	public CLIP(PartOfEpisode partOfEpisode) {
	...
	public CLIP(PartOfSeason partOfSeason) {
	...
	public CLIP(PartOfSeries partOfSeries) {
	...
	public CLIP(PotentialAction potentialAction) {
	...
	public CLIP(Publication publication) {
	...
	public CLIP(Publisher publisher) {
	...
	public CLIP(PublisherImprint publisherImprint) {
	...
	public CLIP(PublishingPrinciples publishingPrinciples) {
	...
	public CLIP(RecordedAt recordedAt) {
	...
	public CLIP(ReleasedEvent releasedEvent) {
	...
	public CLIP(SchemaVersion schemaVersion) {
	...
	public CLIP(SdDatePublished sdDatePublished) {
	...
	public CLIP(SdLicense sdLicense) {
	...
	public CLIP(SdPublisher sdPublisher) {
	...
	public CLIP(SourceOrganization sourceOrganization) {
	...
	public CLIP(SpatialCoverage spatialCoverage) {
	...
	public CLIP(StartOffset startOffset) {
	...
	public CLIP(SubjectOf subjectOf) {
	...
	public CLIP(TemporalCoverage temporalCoverage) {
	...
	public CLIP(ThumbnailUrl thumbnailUrl) {
	...
	public CLIP(TimeRequired timeRequired) {
	...
	public CLIP(TranslationOfWork translationOfWork) {
	...
	public CLIP(Translator translator) {
	...
	public CLIP(TypicalAgeRange typicalAgeRange) {
	...
	public CLIP(WorkExample workExample) {
	...
	public CLIP(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Clip org) {
		setSeq(org.getSeq());
