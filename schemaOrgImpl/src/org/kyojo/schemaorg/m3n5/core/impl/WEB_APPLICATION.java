...
public class WEB_APPLICATION implements Clazz.WebApplication {
	...
	public WEB_APPLICATION(Correction correction) {
	...
	public WEB_APPLICATION(EncodingFormat encodingFormat) {
	...
	public WEB_APPLICATION(MaterialExtent materialExtent) {
	...
	public WEB_APPLICATION(SdDatePublished sdDatePublished) {
	...
	public WEB_APPLICATION(SdLicense sdLicense) {
	...
	public WEB_APPLICATION(SdPublisher sdPublisher) {
	...
	public WEB_APPLICATION(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public WEB_APPLICATION(SubjectOf subjectOf) {
	...
	public WEB_APPLICATION(Temporal temporal) {
