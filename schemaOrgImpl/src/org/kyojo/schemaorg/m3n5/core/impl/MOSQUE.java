...
public class MOSQUE implements Clazz.Mosque {
	...
	public MOSQUE(GeoContains geoContains) {
	...
	public MOSQUE(GeoCoveredBy geoCoveredBy) {
	...
	public MOSQUE(GeoCovers geoCovers) {
	...
	public MOSQUE(GeoCrosses geoCrosses) {
	...
	public MOSQUE(GeoDisjoint geoDisjoint) {
	...
	public MOSQUE(GeoEquals geoEquals) {
	...
	public MOSQUE(GeoIntersects geoIntersects) {
	...
	public MOSQUE(GeoOverlaps geoOverlaps) {
	...
	public MOSQUE(GeoTouches geoTouches) {
	...
	public MOSQUE(GeoWithin geoWithin) {
