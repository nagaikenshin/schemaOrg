...
public class MUSIC_PLAYLIST implements Clazz.MusicPlaylist {
	...
	public MUSIC_PLAYLIST(Long seq) {
		setSeq(seq);
	}

	public MUSIC_PLAYLIST(String string) {
	...
	public MUSIC_PLAYLIST(About about) {
		setAbout(about);
	}
	...
	public MUSIC_PLAYLIST(AccessMode accessMode) {
	...
	public MUSIC_PLAYLIST(AccessModeSufficient accessModeSufficient) {
	...
	public MUSIC_PLAYLIST(AccessibilityAPI accessibilityAPI) {
	...
	public MUSIC_PLAYLIST(AccessibilityControl accessibilityControl) {
	...
	public MUSIC_PLAYLIST(AccessibilityFeature accessibilityFeature) {
	...
	public MUSIC_PLAYLIST(AccessibilityHazard accessibilityHazard) {
	...
	public MUSIC_PLAYLIST(AccessibilitySummary accessibilitySummary) {
	...
	public MUSIC_PLAYLIST(AccountablePerson accountablePerson) {
	...
	public MUSIC_PLAYLIST(AdditionalType additionalType) {
	...
	public MUSIC_PLAYLIST(AggregateRating aggregateRating) {
	...
	public MUSIC_PLAYLIST(AlternateName alternateName) {
	...
	public MUSIC_PLAYLIST(AlternativeHeadline alternativeHeadline) {
	...
	public MUSIC_PLAYLIST(AssociatedMedia associatedMedia) {
	...
	public MUSIC_PLAYLIST(Audience audience) {
	...
	public MUSIC_PLAYLIST(Audio audio) {
		setAudio(audio);
	}
	...
	public MUSIC_PLAYLIST(Author author) {
		setAuthor(author);
	}
	...
	public MUSIC_PLAYLIST(Award award) {
		setAward(award);
	}
	...
	public MUSIC_PLAYLIST(Character character) {
	...
	public MUSIC_PLAYLIST(Citation citation) {
	...
	public MUSIC_PLAYLIST(Comment comment) {
		setComment(comment);
	}
	...
	public MUSIC_PLAYLIST(CommentCount commentCount) {
	...
	public MUSIC_PLAYLIST(ContentLocation contentLocation) {
	...
	public MUSIC_PLAYLIST(ContentRating contentRating) {
	...
	public MUSIC_PLAYLIST(ContentReferenceTime contentReferenceTime) {
	...
	public MUSIC_PLAYLIST(Contributor contributor) {
	...
	public MUSIC_PLAYLIST(CopyrightHolder copyrightHolder) {
	...
	public MUSIC_PLAYLIST(CopyrightYear copyrightYear) {
	...
	public MUSIC_PLAYLIST(Correction correction) {
	...
	public MUSIC_PLAYLIST(Creator creator) {
		setCreator(creator);
	}
	...
	public MUSIC_PLAYLIST(DateCreated dateCreated) {
	...
	public MUSIC_PLAYLIST(DateModified dateModified) {
	...
	public MUSIC_PLAYLIST(DatePublished datePublished) {
	...
	public MUSIC_PLAYLIST(Description description) {
	...
	public MUSIC_PLAYLIST(DisambiguatingDescription disambiguatingDescription) {
	...
	public MUSIC_PLAYLIST(DiscussionUrl discussionUrl) {
	...
	public MUSIC_PLAYLIST(Editor editor) {
		setEditor(editor);
	}
	...
	public MUSIC_PLAYLIST(EducationalAlignment educationalAlignment) {
	...
	public MUSIC_PLAYLIST(EducationalUse educationalUse) {
	...
	public MUSIC_PLAYLIST(Encoding encoding) {
	...
	public MUSIC_PLAYLIST(EncodingFormat encodingFormat) {
	...
	public MUSIC_PLAYLIST(ExampleOfWork exampleOfWork) {
	...
	public MUSIC_PLAYLIST(Expires expires) {
		setExpires(expires);
	}
	...
	public MUSIC_PLAYLIST(Funder funder) {
		setFunder(funder);
	}
	...
	public MUSIC_PLAYLIST(Genre genre) {
		setGenre(genre);
	}
	...
	public MUSIC_PLAYLIST(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public MUSIC_PLAYLIST(Headline headline) {
	...
	public MUSIC_PLAYLIST(Identifier identifier) {
	...
	public MUSIC_PLAYLIST(Image image) {
		setImage(image);
	}
	...
	public MUSIC_PLAYLIST(InLanguage inLanguage) {
	...
	public MUSIC_PLAYLIST(InteractionStatistic interactionStatistic) {
	...
	public MUSIC_PLAYLIST(InteractivityType interactivityType) {
	...
	public MUSIC_PLAYLIST(IsAccessibleForFree isAccessibleForFree) {
	...
	public MUSIC_PLAYLIST(IsBasedOn isBasedOn) {
	...
	public MUSIC_PLAYLIST(IsFamilyFriendly isFamilyFriendly) {
	...
	public MUSIC_PLAYLIST(IsPartOf isPartOf) {
	...
	public MUSIC_PLAYLIST(Keywords keywords) {
	...
	public MUSIC_PLAYLIST(LearningResourceType learningResourceType) {
	...
	public MUSIC_PLAYLIST(License license) {
		setLicense(license);
	}
	...
	public MUSIC_PLAYLIST(LocationCreated locationCreated) {
	...
	public MUSIC_PLAYLIST(MainEntity mainEntity) {
	...
	public MUSIC_PLAYLIST(MainEntityOfPage mainEntityOfPage) {
	...
	public MUSIC_PLAYLIST(Material material) {
	...
	public MUSIC_PLAYLIST(MaterialExtent materialExtent) {
	...
	public MUSIC_PLAYLIST(Mentions mentions) {
	...
	public MUSIC_PLAYLIST(Name name) {
		setName(name);
	}
	...
	public MUSIC_PLAYLIST(NameFuzzy nameFuzzy) {
	...
	public MUSIC_PLAYLIST(NameRuby nameRuby) {
	...
	public MUSIC_PLAYLIST(NumTracks numTracks) {
	...
	public MUSIC_PLAYLIST(Offers offers) {
		setOffers(offers);
	}
	...
	public MUSIC_PLAYLIST(Position position) {
	...
	public MUSIC_PLAYLIST(PotentialAction potentialAction) {
	...
	public MUSIC_PLAYLIST(Producer producer) {
	...
	public MUSIC_PLAYLIST(Provider provider) {
	...
	public MUSIC_PLAYLIST(Publication publication) {
	...
	public MUSIC_PLAYLIST(Publisher publisher) {
	...
	public MUSIC_PLAYLIST(PublisherImprint publisherImprint) {
	...
	public MUSIC_PLAYLIST(PublishingPrinciples publishingPrinciples) {
	...
	public MUSIC_PLAYLIST(RecordedAt recordedAt) {
	...
	public MUSIC_PLAYLIST(ReleasedEvent releasedEvent) {
	...
	public MUSIC_PLAYLIST(Review review) {
		setReview(review);
	}
	...
	public MUSIC_PLAYLIST(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MUSIC_PLAYLIST(SchemaVersion schemaVersion) {
	...
	public MUSIC_PLAYLIST(SdDatePublished sdDatePublished) {
	...
	public MUSIC_PLAYLIST(SdLicense sdLicense) {
	...
	public MUSIC_PLAYLIST(SdPublisher sdPublisher) {
	...
	public MUSIC_PLAYLIST(SourceOrganization sourceOrganization) {
	...
	public MUSIC_PLAYLIST(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public MUSIC_PLAYLIST(SpatialCoverage spatialCoverage) {
	...
	public MUSIC_PLAYLIST(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MUSIC_PLAYLIST(SubjectOf subjectOf) {
	...
	public MUSIC_PLAYLIST(Temporal temporal) {
	...
	public MUSIC_PLAYLIST(TemporalCoverage temporalCoverage) {
	...
	public MUSIC_PLAYLIST(Text text) {
		setText(text);
	}
	...
	public MUSIC_PLAYLIST(ThumbnailUrl thumbnailUrl) {
	...
	public MUSIC_PLAYLIST(TimeRequired timeRequired) {
	...
	public MUSIC_PLAYLIST(Track track) {
		setTrack(track);
	}
	...
	public MUSIC_PLAYLIST(TranslationOfWork translationOfWork) {
	...
	public MUSIC_PLAYLIST(Translator translator) {
	...
	public MUSIC_PLAYLIST(TypicalAgeRange typicalAgeRange) {
	...
	public MUSIC_PLAYLIST(Version version) {
		setVersion(version);
	}
	...
	public MUSIC_PLAYLIST(Video video) {
		setVideo(video);
	}
	...
	public MUSIC_PLAYLIST(WorkExample workExample) {
	...
	public MUSIC_PLAYLIST(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.MusicPlaylist org) {
		setSeq(org.getSeq());
