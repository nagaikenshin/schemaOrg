...
public class FOLLOW_ACTION implements Clazz.FollowAction {
	...
	public FOLLOW_ACTION(Long seq) {
		setSeq(seq);
	}

	public FOLLOW_ACTION(String string) {
	...
	public FOLLOW_ACTION(ActionStatus actionStatus) {
	...
	public FOLLOW_ACTION(AdditionalType additionalType) {
	...
	public FOLLOW_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public FOLLOW_ACTION(AlternateName alternateName) {
	...
	public FOLLOW_ACTION(Description description) {
	...
	public FOLLOW_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public FOLLOW_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public FOLLOW_ACTION(Error error) {
		setError(error);
	}
	...
	public FOLLOW_ACTION(Followee followee) {
	...
	public FOLLOW_ACTION(Identifier identifier) {
	...
	public FOLLOW_ACTION(Image image) {
		setImage(image);
	}
	...
	public FOLLOW_ACTION(Instrument instrument) {
	...
	public FOLLOW_ACTION(Location location) {
	...
	public FOLLOW_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public FOLLOW_ACTION(Name name) {
		setName(name);
	}
	...
	public FOLLOW_ACTION(NameFuzzy nameFuzzy) {
	...
	public FOLLOW_ACTION(NameRuby nameRuby) {
	...
	public FOLLOW_ACTION(Object object) {
		setObject(object);
	}
	...
	public FOLLOW_ACTION(Participant participant) {
	...
	public FOLLOW_ACTION(PotentialAction potentialAction) {
	...
	public FOLLOW_ACTION(Result result) {
		setResult(result);
	}
	...
	public FOLLOW_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public FOLLOW_ACTION(StartTime startTime) {
	...
	public FOLLOW_ACTION(SubjectOf subjectOf) {
	...
	public FOLLOW_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.FollowAction org) {
		setSeq(org.getSeq());
