...
public class NOTARY implements Clazz.Notary {
	...
	public NOTARY(GeoContains geoContains) {
	...
	public NOTARY(GeoCoveredBy geoCoveredBy) {
	...
	public NOTARY(GeoCovers geoCovers) {
	...
	public NOTARY(GeoCrosses geoCrosses) {
	...
	public NOTARY(GeoDisjoint geoDisjoint) {
	...
	public NOTARY(GeoEquals geoEquals) {
	...
	public NOTARY(GeoIntersects geoIntersects) {
	...
	public NOTARY(GeoOverlaps geoOverlaps) {
	...
	public NOTARY(GeoTouches geoTouches) {
	...
	public NOTARY(GeoWithin geoWithin) {
