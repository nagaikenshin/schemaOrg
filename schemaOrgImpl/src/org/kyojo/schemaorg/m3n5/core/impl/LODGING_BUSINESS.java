...
public class LODGING_BUSINESS implements Clazz.LodgingBusiness {
	...
	public LODGING_BUSINESS(GeoContains geoContains) {
	...
	public LODGING_BUSINESS(GeoCoveredBy geoCoveredBy) {
	...
	public LODGING_BUSINESS(GeoCovers geoCovers) {
	...
	public LODGING_BUSINESS(GeoCrosses geoCrosses) {
	...
	public LODGING_BUSINESS(GeoDisjoint geoDisjoint) {
	...
	public LODGING_BUSINESS(GeoEquals geoEquals) {
	...
	public LODGING_BUSINESS(GeoIntersects geoIntersects) {
	...
	public LODGING_BUSINESS(GeoOverlaps geoOverlaps) {
	...
	public LODGING_BUSINESS(GeoTouches geoTouches) {
	...
	public LODGING_BUSINESS(GeoWithin geoWithin) {
	...
	public LODGING_BUSINESS(Slogan slogan) {
		setSlogan(slogan);
	}
