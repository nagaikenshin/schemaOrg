...
public class GAS_STATION implements Clazz.GasStation {
	...
	public GAS_STATION(GeoContains geoContains) {
	...
	public GAS_STATION(GeoCoveredBy geoCoveredBy) {
	...
	public GAS_STATION(GeoCovers geoCovers) {
	...
	public GAS_STATION(GeoCrosses geoCrosses) {
	...
	public GAS_STATION(GeoDisjoint geoDisjoint) {
	...
	public GAS_STATION(GeoEquals geoEquals) {
	...
	public GAS_STATION(GeoIntersects geoIntersects) {
	...
	public GAS_STATION(GeoOverlaps geoOverlaps) {
	...
	public GAS_STATION(GeoTouches geoTouches) {
	...
	public GAS_STATION(GeoWithin geoWithin) {
	...
	public GAS_STATION(Slogan slogan) {
		setSlogan(slogan);
	}
