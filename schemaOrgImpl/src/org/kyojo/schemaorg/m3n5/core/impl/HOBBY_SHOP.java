...
public class HOBBY_SHOP implements Clazz.HobbyShop {
	...
	public HOBBY_SHOP(GeoContains geoContains) {
	...
	public HOBBY_SHOP(GeoCoveredBy geoCoveredBy) {
	...
	public HOBBY_SHOP(GeoCovers geoCovers) {
	...
	public HOBBY_SHOP(GeoCrosses geoCrosses) {
	...
	public HOBBY_SHOP(GeoDisjoint geoDisjoint) {
	...
	public HOBBY_SHOP(GeoEquals geoEquals) {
	...
	public HOBBY_SHOP(GeoIntersects geoIntersects) {
	...
	public HOBBY_SHOP(GeoOverlaps geoOverlaps) {
	...
	public HOBBY_SHOP(GeoTouches geoTouches) {
	...
	public HOBBY_SHOP(GeoWithin geoWithin) {
	...
	public HOBBY_SHOP(Slogan slogan) {
		setSlogan(slogan);
	}
