...
public class PLAYGROUND implements Clazz.Playground {
	...
	public PLAYGROUND(GeoContains geoContains) {
	...
	public PLAYGROUND(GeoCoveredBy geoCoveredBy) {
	...
	public PLAYGROUND(GeoCovers geoCovers) {
	...
	public PLAYGROUND(GeoCrosses geoCrosses) {
	...
	public PLAYGROUND(GeoDisjoint geoDisjoint) {
	...
	public PLAYGROUND(GeoEquals geoEquals) {
	...
	public PLAYGROUND(GeoIntersects geoIntersects) {
	...
	public PLAYGROUND(GeoOverlaps geoOverlaps) {
	...
	public PLAYGROUND(GeoTouches geoTouches) {
	...
	public PLAYGROUND(GeoWithin geoWithin) {
	...
	public PLAYGROUND(Slogan slogan) {
		setSlogan(slogan);
	}
