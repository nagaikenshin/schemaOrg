...
public class FUNDER implements Container.Funder {
	...
	public FUNDER(AccountingService accountingService) {
	...
	public FUNDER(AdultEntertainment adultEntertainment) {
	...
	public FUNDER(AmusementPark amusementPark) {
	...
	public FUNDER(AnimalShelter animalShelter) {
	...
	public FUNDER(ArchiveOrganization archiveOrganization) {
	...
	public FUNDER(ArtGallery artGallery) {
	...
	public FUNDER(Attorney attorney) {
	...
	public FUNDER(AutoBodyShop autoBodyShop) {
	...
	public FUNDER(AutoDealer autoDealer) {
	...
	public FUNDER(AutoPartsStore autoPartsStore) {
	...
	public FUNDER(AutoRental autoRental) {
	...
	public FUNDER(AutoRepair autoRepair) {
	...
	public FUNDER(AutoWash autoWash) {
	...
	public FUNDER(AutomatedTeller automatedTeller) {
	...
	public FUNDER(AutomotiveBusiness automotiveBusiness) {
	...
	public FUNDER(BankOrCreditUnion bankOrCreditUnion) {
	...
	public FUNDER(BarOrPub barOrPub) {
	...
	public FUNDER(BeautySalon beautySalon) {
	...
	public FUNDER(BedAndBreakfast bedAndBreakfast) {
	...
	public FUNDER(BikeStore bikeStore) {
	...
	public FUNDER(BookStore bookStore) {
	...
	public FUNDER(BowlingAlley bowlingAlley) {
	...
	public FUNDER(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public FUNDER(Campground campground) {
	...
	public FUNDER(ChildCare childCare) {
	...
	public FUNDER(ClothingStore clothingStore) {
	...
	public FUNDER(CollegeOrUniversity collegeOrUniversity) {
	...
	public FUNDER(ComedyClub comedyClub) {
	...
	public FUNDER(CommunityHealth communityHealth) {
	...
	public FUNDER(ComputerStore computerStore) {
	...
	public FUNDER(Consortium consortium) {
	...
	public FUNDER(ConvenienceStore convenienceStore) {
	...
	public FUNDER(Corporation corporation) {
	...
	public FUNDER(DanceGroup danceGroup) {
	...
	public FUNDER(DepartmentStore departmentStore) {
	...
	public FUNDER(Dermatology dermatology) {
	...
	public FUNDER(DiagnosticLab diagnosticLab) {
	...
	public FUNDER(DietNutrition dietNutrition) {
	...
	public FUNDER(Distillery distillery) {
	...
	public FUNDER(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public FUNDER(EducationalOrganization educationalOrganization) {
	...
	public FUNDER(Electrician electrician) {
	...
	public FUNDER(ElectronicsStore electronicsStore) {
	...
	public FUNDER(ElementarySchool elementarySchool) {
	...
	public FUNDER(Emergency emergency) {
	...
	public FUNDER(EmergencyService emergencyService) {
	...
	public FUNDER(EmploymentAgency employmentAgency) {
	...
	public FUNDER(EntertainmentBusiness entertainmentBusiness) {
	...
	public FUNDER(ExerciseGym exerciseGym) {
	...
	public FUNDER(FastFoodRestaurant fastFoodRestaurant) {
	...
	public FUNDER(FinancialService financialService) {
	...
	public FUNDER(FireStation fireStation) {
	...
	public FUNDER(FoodEstablishment foodEstablishment) {
	...
	public FUNDER(FundingAgency fundingAgency) {
	...
	public FUNDER(FundingScheme fundingScheme) {
	...
	public FUNDER(FurnitureStore furnitureStore) {
	...
	public FUNDER(GardenStore gardenStore) {
	...
	public FUNDER(GasStation gasStation) {
	...
	public FUNDER(GeneralContractor generalContractor) {
	...
	public FUNDER(Geriatric geriatric) {
	...
	public FUNDER(GolfCourse golfCourse) {
	...
	public FUNDER(GovernmentOffice governmentOffice) {
	...
	public FUNDER(GovernmentOrganization governmentOrganization) {
	...
	public FUNDER(GroceryStore groceryStore) {
	...
	public FUNDER(Gynecologic gynecologic) {
	...
	public FUNDER(HVACBusiness hvacBusiness) {
	...
	public FUNDER(HairSalon hairSalon) {
	...
	public FUNDER(HardwareStore hardwareStore) {
	...
	public FUNDER(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public FUNDER(HealthClub healthClub) {
	...
	public FUNDER(HighSchool highSchool) {
	...
	public FUNDER(HobbyShop hobbyShop) {
	...
	public FUNDER(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public FUNDER(HomeGoodsStore homeGoodsStore) {
	...
	public FUNDER(Hospital hospital) {
	...
	public FUNDER(HousePainter housePainter) {
	...
	public FUNDER(IceCreamShop iceCreamShop) {
	...
	public FUNDER(InsuranceAgency insuranceAgency) {
	...
	public FUNDER(InternetCafe internetCafe) {
	...
	public FUNDER(JewelryStore jewelryStore) {
	...
	public FUNDER(LegalService legalService) {
	...
	public FUNDER(LibrarySystem librarySystem) {
	...
	public FUNDER(LiquorStore liquorStore) {
	...
	public FUNDER(LocalBusiness localBusiness) {
	...
	public FUNDER(Locksmith locksmith) {
	...
	public FUNDER(LodgingBusiness lodgingBusiness) {
	...
	public FUNDER(MedicalBusiness medicalBusiness) {
	...
	public FUNDER(MedicalClinic medicalClinic) {
	...
	public FUNDER(MedicalOrganization medicalOrganization) {
	...
	public FUNDER(MensClothingStore mensClothingStore) {
	...
	public FUNDER(MiddleSchool middleSchool) {
	...
	public FUNDER(Midwifery midwifery) {
	...
	public FUNDER(MobilePhoneStore mobilePhoneStore) {
	...
	public FUNDER(MotorcycleDealer motorcycleDealer) {
	...
	public FUNDER(MotorcycleRepair motorcycleRepair) {
	...
	public FUNDER(MovieRentalStore movieRentalStore) {
	...
	public FUNDER(MovieTheater movieTheater) {
	...
	public FUNDER(MovingCompany movingCompany) {
	...
	public FUNDER(MusicGroup musicGroup) {
	...
	public FUNDER(MusicStore musicStore) {
	...
	public FUNDER(NailSalon nailSalon) {
	...
	public FUNDER(NewsMediaOrganization newsMediaOrganization) {
	...
	public FUNDER(NightClub nightClub) {
	...
	public FUNDER(Obstetric obstetric) {
	...
	public FUNDER(OfficeEquipmentStore officeEquipmentStore) {
	...
	public FUNDER(Oncologic oncologic) {
	...
	public FUNDER(Optician optician) {
	...
	public FUNDER(Optometric optometric) {
	...
	public FUNDER(Organization organization) {
		organizationList = new ArrayList<Organization>();
	...
	public FUNDER(Otolaryngologic otolaryngologic) {
	...
	public FUNDER(OutletStore outletStore) {
	...
	public FUNDER(PawnShop pawnShop) {
	...
	public FUNDER(Pediatric pediatric) {
	...
	public FUNDER(PerformingGroup performingGroup) {
	...
	public FUNDER(PetStore petStore) {
	...
	public FUNDER(Pharmacy pharmacy) {
	...
	public FUNDER(Physician physician) {
	...
	public FUNDER(Physiotherapy physiotherapy) {
	...
	public FUNDER(PlasticSurgery plasticSurgery) {
	...
	public FUNDER(Podiatric podiatric) {
	...
	public FUNDER(PoliceStation policeStation) {
	...
	public FUNDER(PostOffice postOffice) {
	...
	public FUNDER(Preschool preschool) {
	...
	public FUNDER(PrimaryCare primaryCare) {
	...
	public FUNDER(ProfessionalService professionalService) {
	...
	public FUNDER(Psychiatric psychiatric) {
	...
	public FUNDER(PublicHealth publicHealth) {
	...
	public FUNDER(PublicSwimmingPool publicSwimmingPool) {
	...
	public FUNDER(RadioStation radioStation) {
	...
	public FUNDER(RealEstateAgent realEstateAgent) {
	...
	public FUNDER(RecyclingCenter recyclingCenter) {
	...
	public FUNDER(ResearchProject researchProject) {
	...
	public FUNDER(Restaurant restaurant) {
	...
	public FUNDER(RoofingContractor roofingContractor) {
	...
	public FUNDER(SelfStorage selfStorage) {
	...
	public FUNDER(ShoeStore shoeStore) {
	...
	public FUNDER(ShoppingCenter shoppingCenter) {
	...
	public FUNDER(SkiResort skiResort) {
	...
	public FUNDER(SportingGoodsStore sportingGoodsStore) {
	...
	public FUNDER(SportsActivityLocation sportsActivityLocation) {
	...
	public FUNDER(SportsClub sportsClub) {
	...
	public FUNDER(SportsOrganization sportsOrganization) {
	...
	public FUNDER(SportsTeam sportsTeam) {
	...
	public FUNDER(StadiumOrArena stadiumOrArena) {
	...
	public FUNDER(TattooParlor tattooParlor) {
	...
	public FUNDER(TelevisionStation televisionStation) {
	...
	public FUNDER(TennisComplex tennisComplex) {
	...
	public FUNDER(TheaterGroup theaterGroup) {
	...
	public FUNDER(TireShop tireShop) {
	...
	public FUNDER(TouristInformationCenter touristInformationCenter) {
	...
	public FUNDER(ToyStore toyStore) {
	...
	public FUNDER(TravelAgency travelAgency) {
	...
	public FUNDER(VeterinaryCare veterinaryCare) {
	...
	public FUNDER(WholesaleStore wholesaleStore) {
	...
	public FUNDER(WorkersUnion workersUnion) {
	...
	public void copy(Container.Funder org) {
