...
public class APARTMENT implements Clazz.Apartment {
	...
	public APARTMENT(GeoContains geoContains) {
	...
	public APARTMENT(GeoCoveredBy geoCoveredBy) {
	...
	public APARTMENT(GeoCovers geoCovers) {
	...
	public APARTMENT(GeoCrosses geoCrosses) {
	...
	public APARTMENT(GeoDisjoint geoDisjoint) {
	...
	public APARTMENT(GeoEquals geoEquals) {
	...
	public APARTMENT(GeoIntersects geoIntersects) {
	...
	public APARTMENT(GeoOverlaps geoOverlaps) {
	...
	public APARTMENT(GeoTouches geoTouches) {
	...
	public APARTMENT(GeoWithin geoWithin) {
	...
	public APARTMENT(Slogan slogan) {
		setSlogan(slogan);
	}
