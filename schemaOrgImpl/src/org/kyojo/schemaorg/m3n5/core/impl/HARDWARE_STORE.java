...
public class HARDWARE_STORE implements Clazz.HardwareStore {
	...
	public HARDWARE_STORE(GeoContains geoContains) {
	...
	public HARDWARE_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public HARDWARE_STORE(GeoCovers geoCovers) {
	...
	public HARDWARE_STORE(GeoCrosses geoCrosses) {
	...
	public HARDWARE_STORE(GeoDisjoint geoDisjoint) {
	...
	public HARDWARE_STORE(GeoEquals geoEquals) {
	...
	public HARDWARE_STORE(GeoIntersects geoIntersects) {
	...
	public HARDWARE_STORE(GeoOverlaps geoOverlaps) {
	...
	public HARDWARE_STORE(GeoTouches geoTouches) {
	...
	public HARDWARE_STORE(GeoWithin geoWithin) {
	...
	public HARDWARE_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
