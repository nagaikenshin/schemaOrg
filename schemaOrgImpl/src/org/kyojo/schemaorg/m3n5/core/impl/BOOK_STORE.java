...
public class BOOK_STORE implements Clazz.BookStore {
	...
	public BOOK_STORE(GeoContains geoContains) {
	...
	public BOOK_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public BOOK_STORE(GeoCovers geoCovers) {
	...
	public BOOK_STORE(GeoCrosses geoCrosses) {
	...
	public BOOK_STORE(GeoDisjoint geoDisjoint) {
	...
	public BOOK_STORE(GeoEquals geoEquals) {
	...
	public BOOK_STORE(GeoIntersects geoIntersects) {
	...
	public BOOK_STORE(GeoOverlaps geoOverlaps) {
	...
	public BOOK_STORE(GeoTouches geoTouches) {
	...
	public BOOK_STORE(GeoWithin geoWithin) {
	...
	public BOOK_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
