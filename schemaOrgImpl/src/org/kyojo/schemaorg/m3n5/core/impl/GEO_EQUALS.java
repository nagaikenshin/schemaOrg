...
public class GEO_EQUALS implements Container.GeoEquals {
	...
	public GEO_EQUALS(String string) {
	...
	public GEO_EQUALS(Accommodation accommodation) {
	...
	public GEO_EQUALS(AccountingService accountingService) {
	...
	public GEO_EQUALS(AdministrativeArea administrativeArea) {
	...
	public GEO_EQUALS(AdultEntertainment adultEntertainment) {
	...
	public GEO_EQUALS(Airport airport) {
	...
	public GEO_EQUALS(AmusementPark amusementPark) {
	...
	public GEO_EQUALS(AnimalShelter animalShelter) {
	...
	public GEO_EQUALS(Apartment apartment) {
	...
	public GEO_EQUALS(ApartmentComplex apartmentComplex) {
	...
	public GEO_EQUALS(Aquarium aquarium) {
	...
	public GEO_EQUALS(ArchiveOrganization archiveOrganization) {
	...
	public GEO_EQUALS(ArtGallery artGallery) {
	...
	public GEO_EQUALS(Attorney attorney) {
	...
	public GEO_EQUALS(AutoBodyShop autoBodyShop) {
	...
	public GEO_EQUALS(AutoDealer autoDealer) {
	...
	public GEO_EQUALS(AutoPartsStore autoPartsStore) {
	...
	public GEO_EQUALS(AutoRental autoRental) {
	...
	public GEO_EQUALS(AutoRepair autoRepair) {
	...
	public GEO_EQUALS(AutoWash autoWash) {
	...
	public GEO_EQUALS(AutomatedTeller automatedTeller) {
	...
	public GEO_EQUALS(AutomotiveBusiness automotiveBusiness) {
	...
	public GEO_EQUALS(Bakery bakery) {
	...
	public GEO_EQUALS(BankOrCreditUnion bankOrCreditUnion) {
	...
	public GEO_EQUALS(BarOrPub barOrPub) {
	...
	public GEO_EQUALS(BeautySalon beautySalon) {
	...
	public GEO_EQUALS(BedAndBreakfast bedAndBreakfast) {
	...
	public GEO_EQUALS(BikeStore bikeStore) {
	...
	public GEO_EQUALS(BodyOfWater bodyOfWater) {
	...
	public GEO_EQUALS(BookStore bookStore) {
	...
	public GEO_EQUALS(BowlingAlley bowlingAlley) {
	...
	public GEO_EQUALS(Brewery brewery) {
	...
	public GEO_EQUALS(Bridge bridge) {
	...
	public GEO_EQUALS(BuddhistTemple buddhistTemple) {
	...
	public GEO_EQUALS(BusStation busStation) {
	...
	public GEO_EQUALS(BusStop busStop) {
	...
	public GEO_EQUALS(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public GEO_EQUALS(Campground campground) {
	...
	public GEO_EQUALS(CampingPitch campingPitch) {
	...
	public GEO_EQUALS(Casino casino) {
	...
	public GEO_EQUALS(CatholicChurch catholicChurch) {
	...
	public GEO_EQUALS(Cemetery cemetery) {
	...
	public GEO_EQUALS(ChildCare childCare) {
	...
	public GEO_EQUALS(Church church) {
	...
	public GEO_EQUALS(CityHall cityHall) {
	...
	public GEO_EQUALS(CivicStructure civicStructure) {
	...
	public GEO_EQUALS(ClothingStore clothingStore) {
	...
	public GEO_EQUALS(ComedyClub comedyClub) {
	...
	public GEO_EQUALS(CommunityHealth communityHealth) {
	...
	public GEO_EQUALS(ComputerStore computerStore) {
	...
	public GEO_EQUALS(Continent continent) {
	...
	public GEO_EQUALS(ConvenienceStore convenienceStore) {
	...
	public GEO_EQUALS(Country country) {
	...
	public GEO_EQUALS(Courthouse courthouse) {
	...
	public GEO_EQUALS(Crematorium crematorium) {
	...
	public GEO_EQUALS(DaySpa daySpa) {
	...
	public GEO_EQUALS(DefenceEstablishment defenceEstablishment) {
	...
	public GEO_EQUALS(Dentist dentist) {
	...
	public GEO_EQUALS(DepartmentStore departmentStore) {
	...
	public GEO_EQUALS(Dermatology dermatology) {
	...
	public GEO_EQUALS(DietNutrition dietNutrition) {
	...
	public GEO_EQUALS(Distillery distillery) {
	...
	public GEO_EQUALS(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public GEO_EQUALS(Electrician electrician) {
	...
	public GEO_EQUALS(ElectronicsStore electronicsStore) {
	...
	public GEO_EQUALS(Embassy embassy) {
	...
	public GEO_EQUALS(Emergency emergency) {
	...
	public GEO_EQUALS(EmergencyService emergencyService) {
	...
	public GEO_EQUALS(EmploymentAgency employmentAgency) {
	...
	public GEO_EQUALS(EntertainmentBusiness entertainmentBusiness) {
	...
	public GEO_EQUALS(EventVenue eventVenue) {
	...
	public GEO_EQUALS(ExerciseGym exerciseGym) {
	...
	public GEO_EQUALS(FastFoodRestaurant fastFoodRestaurant) {
	...
	public GEO_EQUALS(FinancialService financialService) {
	...
	public GEO_EQUALS(FireStation fireStation) {
	...
	public GEO_EQUALS(Florist florist) {
	...
	public GEO_EQUALS(FoodEstablishment foodEstablishment) {
	...
	public GEO_EQUALS(FurnitureStore furnitureStore) {
	...
	public GEO_EQUALS(GardenStore gardenStore) {
	...
	public GEO_EQUALS(GasStation gasStation) {
	...
	public GEO_EQUALS(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public GEO_EQUALS(GeneralContractor generalContractor) {
	...
	public GEO_EQUALS(GeospatialGeometry geospatialGeometry) {
		geospatialGeometryList = new ArrayList<GeospatialGeometry>();
	...
	public GEO_EQUALS(Geriatric geriatric) {
	...
	public GEO_EQUALS(GolfCourse golfCourse) {
	...
	public GEO_EQUALS(GovernmentBuilding governmentBuilding) {
	...
	public GEO_EQUALS(GovernmentOffice governmentOffice) {
	...
	public GEO_EQUALS(GroceryStore groceryStore) {
	...
	public GEO_EQUALS(Gynecologic gynecologic) {
	...
	public GEO_EQUALS(HVACBusiness hvacBusiness) {
	...
	public GEO_EQUALS(HairSalon hairSalon) {
	...
	public GEO_EQUALS(HardwareStore hardwareStore) {
	...
	public GEO_EQUALS(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public GEO_EQUALS(HealthClub healthClub) {
	...
	public GEO_EQUALS(HinduTemple hinduTemple) {
	...
	public GEO_EQUALS(HobbyShop hobbyShop) {
	...
	public GEO_EQUALS(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public GEO_EQUALS(HomeGoodsStore homeGoodsStore) {
	...
	public GEO_EQUALS(Hospital hospital) {
	...
	public GEO_EQUALS(Hostel hostel) {
	...
	public GEO_EQUALS(HotelRoom hotelRoom) {
	...
	public GEO_EQUALS(HousePainter housePainter) {
	...
	public GEO_EQUALS(IceCreamShop iceCreamShop) {
	...
	public GEO_EQUALS(InsuranceAgency insuranceAgency) {
	...
	public GEO_EQUALS(InternetCafe internetCafe) {
	...
	public GEO_EQUALS(JewelryStore jewelryStore) {
	...
	public GEO_EQUALS(LakeBodyOfWater lakeBodyOfWater) {
	...
	public GEO_EQUALS(Landform landform) {
	...
	public GEO_EQUALS(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public GEO_EQUALS(LegalService legalService) {
	...
	public GEO_EQUALS(LegislativeBuilding legislativeBuilding) {
	...
	public GEO_EQUALS(Library library) {
	...
	public GEO_EQUALS(LiquorStore liquorStore) {
	...
	public GEO_EQUALS(LocalBusiness localBusiness) {
	...
	public GEO_EQUALS(Locksmith locksmith) {
	...
	public GEO_EQUALS(LodgingBusiness lodgingBusiness) {
	...
	public GEO_EQUALS(MedicalBusiness medicalBusiness) {
	...
	public GEO_EQUALS(MedicalClinic medicalClinic) {
	...
	public GEO_EQUALS(MeetingRoom meetingRoom) {
	...
	public GEO_EQUALS(MensClothingStore mensClothingStore) {
	...
	public GEO_EQUALS(Midwifery midwifery) {
	...
	public GEO_EQUALS(MobilePhoneStore mobilePhoneStore) {
	...
	public GEO_EQUALS(Mosque mosque) {
	...
	public GEO_EQUALS(MotorcycleDealer motorcycleDealer) {
	...
	public GEO_EQUALS(MotorcycleRepair motorcycleRepair) {
	...
	public GEO_EQUALS(Mountain mountain) {
	...
	public GEO_EQUALS(MovieRentalStore movieRentalStore) {
	...
	public GEO_EQUALS(MovieTheater movieTheater) {
	...
	public GEO_EQUALS(MovingCompany movingCompany) {
	...
	public GEO_EQUALS(Museum museum) {
	...
	public GEO_EQUALS(MusicStore musicStore) {
	...
	public GEO_EQUALS(MusicVenue musicVenue) {
	...
	public GEO_EQUALS(NailSalon nailSalon) {
	...
	public GEO_EQUALS(NightClub nightClub) {
	...
	public GEO_EQUALS(Notary notary) {
	...
	public GEO_EQUALS(Nursing nursing) {
	...
	public GEO_EQUALS(Obstetric obstetric) {
	...
	public GEO_EQUALS(OceanBodyOfWater oceanBodyOfWater) {
	...
	public GEO_EQUALS(OfficeEquipmentStore officeEquipmentStore) {
	...
	public GEO_EQUALS(Oncologic oncologic) {
	...
	public GEO_EQUALS(Optician optician) {
	...
	public GEO_EQUALS(Optometric optometric) {
	...
	public GEO_EQUALS(Otolaryngologic otolaryngologic) {
	...
	public GEO_EQUALS(OutletStore outletStore) {
	...
	public GEO_EQUALS(ParkingFacility parkingFacility) {
	...
	public GEO_EQUALS(PawnShop pawnShop) {
	...
	public GEO_EQUALS(Pediatric pediatric) {
	...
	public GEO_EQUALS(PerformingArtsTheater performingArtsTheater) {
	...
	public GEO_EQUALS(PetStore petStore) {
	...
	public GEO_EQUALS(Pharmacy pharmacy) {
	...
	public GEO_EQUALS(Physician physician) {
	...
	public GEO_EQUALS(Physiotherapy physiotherapy) {
	...
	public GEO_EQUALS(PlaceOfWorship placeOfWorship) {
	...
	public GEO_EQUALS(PlasticSurgery plasticSurgery) {
	...
	public GEO_EQUALS(Playground playground) {
	...
	public GEO_EQUALS(Plumber plumber) {
	...
	public GEO_EQUALS(Podiatric podiatric) {
	...
	public GEO_EQUALS(PoliceStation policeStation) {
	...
	public GEO_EQUALS(PostOffice postOffice) {
	...
	public GEO_EQUALS(PrimaryCare primaryCare) {
	...
	public GEO_EQUALS(ProfessionalService professionalService) {
	...
	public GEO_EQUALS(Psychiatric psychiatric) {
	...
	public GEO_EQUALS(PublicHealth publicHealth) {
	...
	public GEO_EQUALS(PublicSwimmingPool publicSwimmingPool) {
	...
	public GEO_EQUALS(PublicToilet publicToilet) {
	...
	public GEO_EQUALS(RVPark rvPark) {
	...
	public GEO_EQUALS(RadioStation radioStation) {
	...
	public GEO_EQUALS(RealEstateAgent realEstateAgent) {
	...
	public GEO_EQUALS(RecyclingCenter recyclingCenter) {
	...
	public GEO_EQUALS(Reservoir reservoir) {
	...
	public GEO_EQUALS(Residence residence) {
	...
	public GEO_EQUALS(Resort resort) {
	...
	public GEO_EQUALS(Restaurant restaurant) {
	...
	public GEO_EQUALS(RiverBodyOfWater riverBodyOfWater) {
	...
	public GEO_EQUALS(RoofingContractor roofingContractor) {
	...
	public GEO_EQUALS(SeaBodyOfWater seaBodyOfWater) {
	...
	public GEO_EQUALS(SelfStorage selfStorage) {
	...
	public GEO_EQUALS(ShoeStore shoeStore) {
	...
	public GEO_EQUALS(ShoppingCenter shoppingCenter) {
	...
	public GEO_EQUALS(SingleFamilyResidence singleFamilyResidence) {
	...
	public GEO_EQUALS(SkiResort skiResort) {
	...
	public GEO_EQUALS(SportingGoodsStore sportingGoodsStore) {
	...
	public GEO_EQUALS(SportsActivityLocation sportsActivityLocation) {
	...
	public GEO_EQUALS(SportsClub sportsClub) {
	...
	public GEO_EQUALS(StadiumOrArena stadiumOrArena) {
	...
	public GEO_EQUALS(SubwayStation subwayStation) {
	...
	public GEO_EQUALS(Synagogue synagogue) {
	...
	public GEO_EQUALS(TattooParlor tattooParlor) {
	...
	public GEO_EQUALS(TaxiStand taxiStand) {
	...
	public GEO_EQUALS(TelevisionStation televisionStation) {
	...
	public GEO_EQUALS(TennisComplex tennisComplex) {
	...
	public GEO_EQUALS(TireShop tireShop) {
	...
	public GEO_EQUALS(TouristAttraction touristAttraction) {
	...
	public GEO_EQUALS(TouristDestination touristDestination) {
	...
	public GEO_EQUALS(TouristInformationCenter touristInformationCenter) {
	...
	public GEO_EQUALS(ToyStore toyStore) {
	...
	public GEO_EQUALS(TrainStation trainStation) {
	...
	public GEO_EQUALS(TravelAgency travelAgency) {
	...
	public GEO_EQUALS(Volcano volcano) {
	...
	public GEO_EQUALS(Waterfall waterfall) {
	...
	public GEO_EQUALS(WholesaleStore wholesaleStore) {
	...
	public GEO_EQUALS(Winery winery) {
	...
	public void copy(Container.GeoEquals org) {
