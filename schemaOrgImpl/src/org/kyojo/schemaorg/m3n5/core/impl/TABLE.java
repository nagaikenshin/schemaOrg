...
public class TABLE implements Clazz.Table {
	...
	public TABLE(AccessMode accessMode) {
	...
	public TABLE(AccessModeSufficient accessModeSufficient) {
	...
	public TABLE(AccessibilityAPI accessibilityAPI) {
	...
	public TABLE(AccessibilityControl accessibilityControl) {
	...
	public TABLE(AccessibilityFeature accessibilityFeature) {
	...
	public TABLE(AccessibilityHazard accessibilityHazard) {
	...
	public TABLE(AccessibilitySummary accessibilitySummary) {
	...
	public TABLE(AccountablePerson accountablePerson) {
	...
	public TABLE(AdditionalType additionalType) {
	...
	public TABLE(AggregateRating aggregateRating) {
	...
	public TABLE(AlternativeHeadline alternativeHeadline) {
	...
	public TABLE(AssociatedMedia associatedMedia) {
	...
	public TABLE(Audience audience) {
	...
	public TABLE(Citation citation) {
	...
	public TABLE(CommentCount commentCount) {
	...
	public TABLE(ContentLocation contentLocation) {
	...
	public TABLE(ContentRating contentRating) {
	...
	public TABLE(ContentReferenceTime contentReferenceTime) {
	...
	public TABLE(Contributor contributor) {
	...
	public TABLE(CopyrightHolder copyrightHolder) {
	...
	public TABLE(CopyrightYear copyrightYear) {
	...
	public TABLE(Correction correction) {
	...
	public TABLE(CssSelector cssSelector) {
	...
	public TABLE(DateCreated dateCreated) {
	...
	public TABLE(DateModified dateModified) {
	...
	public TABLE(DatePublished datePublished) {
	...
	public TABLE(DisambiguatingDescription disambiguatingDescription) {
	...
	public TABLE(DiscussionUrl discussionUrl) {
	...
	public TABLE(EducationalAlignment educationalAlignment) {
	...
	public TABLE(EducationalUse educationalUse) {
	...
	public TABLE(EncodingFormat encodingFormat) {
	...
	public TABLE(ExampleOfWork exampleOfWork) {
	...
	public TABLE(Headline headline) {
	...
	public TABLE(InLanguage inLanguage) {
	...
	public TABLE(InteractionStatistic interactionStatistic) {
	...
	public TABLE(InteractivityType interactivityType) {
	...
	public TABLE(IsAccessibleForFree isAccessibleForFree) {
	...
	public TABLE(IsBasedOn isBasedOn) {
	...
	public TABLE(IsFamilyFriendly isFamilyFriendly) {
	...
	public TABLE(IsPartOf isPartOf) {
	...
	public TABLE(Keywords keywords) {
	...
	public TABLE(LearningResourceType learningResourceType) {
	...
	public TABLE(LocationCreated locationCreated) {
	...
	public TABLE(MainEntity mainEntity) {
	...
	public TABLE(MainEntityOfPage mainEntityOfPage) {
	...
	public TABLE(MaterialExtent materialExtent) {
	...
	public TABLE(Mentions mentions) {
	...
	public TABLE(NameFuzzy nameFuzzy) {
	...
	public TABLE(NameRuby nameRuby) {
	...
	public TABLE(PotentialAction potentialAction) {
	...
	public TABLE(Producer producer) {
	...
	public TABLE(Provider provider) {
	...
	public TABLE(Publication publication) {
	...
	public TABLE(PublisherImprint publisherImprint) {
	...
	public TABLE(PublishingPrinciples publishingPrinciples) {
	...
	public TABLE(RecordedAt recordedAt) {
	...
	public TABLE(ReleasedEvent releasedEvent) {
	...
	public TABLE(SchemaVersion schemaVersion) {
	...
	public TABLE(SdDatePublished sdDatePublished) {
	...
	public TABLE(SdLicense sdLicense) {
	...
	public TABLE(SdPublisher sdPublisher) {
	...
	public TABLE(SourceOrganization sourceOrganization) {
	...
	public TABLE(SpatialCoverage spatialCoverage) {
	...
	public TABLE(SubjectOf subjectOf) {
	...
	public TABLE(Temporal temporal) {
	...
	public TABLE(TemporalCoverage temporalCoverage) {
	...
	public TABLE(ThumbnailUrl thumbnailUrl) {
	...
	public TABLE(TimeRequired timeRequired) {
	...
	public TABLE(TranslationOfWork translationOfWork) {
	...
	public TABLE(Translator translator) {
	...
	public TABLE(TypicalAgeRange typicalAgeRange) {
	...
	public TABLE(WorkExample workExample) {
	...
	public TABLE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Table org) {
		setSeq(org.getSeq());
