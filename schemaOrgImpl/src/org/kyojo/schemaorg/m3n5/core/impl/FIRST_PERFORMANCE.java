...
public class FIRST_PERFORMANCE implements Container.FirstPerformance {
	...
	public FIRST_PERFORMANCE(String string) {
	...
	public FIRST_PERFORMANCE(BroadcastEvent broadcastEvent) {
	...
	public FIRST_PERFORMANCE(BusinessEvent businessEvent) {
	...
	public FIRST_PERFORMANCE(ChildrensEvent childrensEvent) {
	...
	public FIRST_PERFORMANCE(ComedyEvent comedyEvent) {
	...
	public FIRST_PERFORMANCE(CourseInstance courseInstance) {
	...
	public FIRST_PERFORMANCE(DanceEvent danceEvent) {
	...
	public FIRST_PERFORMANCE(DeliveryEvent deliveryEvent) {
	...
	public FIRST_PERFORMANCE(EducationEvent educationEvent) {
	...
	public FIRST_PERFORMANCE(Event event) {
		eventList = new ArrayList<Event>();
		eventList.add(event);
	}
	...
	public FIRST_PERFORMANCE(EventSeries eventSeries) {
	...
	public FIRST_PERFORMANCE(ExhibitionEvent exhibitionEvent) {
	...
	public FIRST_PERFORMANCE(Festival festival) {
	...
	public FIRST_PERFORMANCE(FoodEvent foodEvent) {
	...
	public FIRST_PERFORMANCE(LiteraryEvent literaryEvent) {
	...
	public FIRST_PERFORMANCE(MusicEvent musicEvent) {
	...
	public FIRST_PERFORMANCE(OnDemandEvent onDemandEvent) {
	...
	public FIRST_PERFORMANCE(PublicationEvent publicationEvent) {
	...
	public FIRST_PERFORMANCE(SaleEvent saleEvent) {
	...
	public FIRST_PERFORMANCE(ScreeningEvent screeningEvent) {
	...
	public FIRST_PERFORMANCE(SocialEvent socialEvent) {
	...
	public FIRST_PERFORMANCE(SportsEvent sportsEvent) {
	...
	public FIRST_PERFORMANCE(TheaterEvent theaterEvent) {
	...
	public FIRST_PERFORMANCE(VisualArtsEvent visualArtsEvent) {
	...
	public void copy(Container.FirstPerformance org) {
