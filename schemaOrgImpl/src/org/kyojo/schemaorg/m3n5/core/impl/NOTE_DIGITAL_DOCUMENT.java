...
public class NOTE_DIGITAL_DOCUMENT implements Clazz.NoteDigitalDocument {
	...
	public NOTE_DIGITAL_DOCUMENT() {
	}

	public NOTE_DIGITAL_DOCUMENT(Long seq) {
		setSeq(seq);
	}

	public NOTE_DIGITAL_DOCUMENT(String string) {
	...
	public NOTE_DIGITAL_DOCUMENT(About about) {
		setAbout(about);
	}
	...
	public NOTE_DIGITAL_DOCUMENT(AccessMode accessMode) {
	...
	public NOTE_DIGITAL_DOCUMENT(AccessModeSufficient accessModeSufficient) {
	...
	public NOTE_DIGITAL_DOCUMENT(AccessibilityAPI accessibilityAPI) {
	...
	public NOTE_DIGITAL_DOCUMENT(AccessibilityControl accessibilityControl) {
	...
	public NOTE_DIGITAL_DOCUMENT(AccessibilityFeature accessibilityFeature) {
	...
	public NOTE_DIGITAL_DOCUMENT(AccessibilityHazard accessibilityHazard) {
	...
	public NOTE_DIGITAL_DOCUMENT(AccessibilitySummary accessibilitySummary) {
	...
	public NOTE_DIGITAL_DOCUMENT(AccountablePerson accountablePerson) {
	...
	public NOTE_DIGITAL_DOCUMENT(AdditionalType additionalType) {
	...
	public NOTE_DIGITAL_DOCUMENT(AggregateRating aggregateRating) {
	...
	public NOTE_DIGITAL_DOCUMENT(AlternateName alternateName) {
	...
	public NOTE_DIGITAL_DOCUMENT(AlternativeHeadline alternativeHeadline) {
	...
	public NOTE_DIGITAL_DOCUMENT(AssociatedMedia associatedMedia) {
	...
	public NOTE_DIGITAL_DOCUMENT(Audience audience) {
	...
	public NOTE_DIGITAL_DOCUMENT(Audio audio) {
		setAudio(audio);
	}
	...
	public NOTE_DIGITAL_DOCUMENT(Author author) {
		setAuthor(author);
	}
	...
	public NOTE_DIGITAL_DOCUMENT(Award award) {
		setAward(award);
	}
	...
	public NOTE_DIGITAL_DOCUMENT(Character character) {
	...
	public NOTE_DIGITAL_DOCUMENT(Citation citation) {
	...
	public NOTE_DIGITAL_DOCUMENT(Comment comment) {
		setComment(comment);
	}
	...
	public NOTE_DIGITAL_DOCUMENT(CommentCount commentCount) {
	...
	public NOTE_DIGITAL_DOCUMENT(ContentLocation contentLocation) {
	...
	public NOTE_DIGITAL_DOCUMENT(ContentRating contentRating) {
	...
	public NOTE_DIGITAL_DOCUMENT(ContentReferenceTime contentReferenceTime) {
	...
	public NOTE_DIGITAL_DOCUMENT(Contributor contributor) {
	...
	public NOTE_DIGITAL_DOCUMENT(CopyrightHolder copyrightHolder) {
	...
	public NOTE_DIGITAL_DOCUMENT(CopyrightYear copyrightYear) {
	...
	public NOTE_DIGITAL_DOCUMENT(Correction correction) {
	...
	public NOTE_DIGITAL_DOCUMENT(Creator creator) {
		setCreator(creator);
	}
	...
	public NOTE_DIGITAL_DOCUMENT(DateCreated dateCreated) {
	...
	public NOTE_DIGITAL_DOCUMENT(DateModified dateModified) {
	...
	public NOTE_DIGITAL_DOCUMENT(DatePublished datePublished) {
	...
	public NOTE_DIGITAL_DOCUMENT(Description description) {
	...
	public NOTE_DIGITAL_DOCUMENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public NOTE_DIGITAL_DOCUMENT(DiscussionUrl discussionUrl) {
	...
	public NOTE_DIGITAL_DOCUMENT(Editor editor) {
		setEditor(editor);
	}
	...
	public NOTE_DIGITAL_DOCUMENT(EducationalAlignment educationalAlignment) {
	...
	public NOTE_DIGITAL_DOCUMENT(EducationalUse educationalUse) {
	...
	public NOTE_DIGITAL_DOCUMENT(Encoding encoding) {
	...
	public NOTE_DIGITAL_DOCUMENT(EncodingFormat encodingFormat) {
	...
	public NOTE_DIGITAL_DOCUMENT(ExampleOfWork exampleOfWork) {
	...
	public NOTE_DIGITAL_DOCUMENT(Expires expires) {
		setExpires(expires);
	}
	...
	public NOTE_DIGITAL_DOCUMENT(Funder funder) {
		setFunder(funder);
	}
	...
	public NOTE_DIGITAL_DOCUMENT(Genre genre) {
		setGenre(genre);
	}
	...
	public NOTE_DIGITAL_DOCUMENT(HasDigitalDocumentPermission hasDigitalDocumentPermission) {
	...
	public NOTE_DIGITAL_DOCUMENT(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public NOTE_DIGITAL_DOCUMENT(Headline headline) {
	...
	public NOTE_DIGITAL_DOCUMENT(Identifier identifier) {
	...
	public NOTE_DIGITAL_DOCUMENT(Image image) {
		setImage(image);
	}
	...
	public NOTE_DIGITAL_DOCUMENT(InLanguage inLanguage) {
	...
	public NOTE_DIGITAL_DOCUMENT(InteractionStatistic interactionStatistic) {
	...
	public NOTE_DIGITAL_DOCUMENT(InteractivityType interactivityType) {
	...
	public NOTE_DIGITAL_DOCUMENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public NOTE_DIGITAL_DOCUMENT(IsBasedOn isBasedOn) {
	...
	public NOTE_DIGITAL_DOCUMENT(IsFamilyFriendly isFamilyFriendly) {
	...
	public NOTE_DIGITAL_DOCUMENT(IsPartOf isPartOf) {
	...
	public NOTE_DIGITAL_DOCUMENT(Keywords keywords) {
	...
	public NOTE_DIGITAL_DOCUMENT(LearningResourceType learningResourceType) {
	...
	public NOTE_DIGITAL_DOCUMENT(License license) {
		setLicense(license);
	}
	...
	public NOTE_DIGITAL_DOCUMENT(LocationCreated locationCreated) {
	...
	public NOTE_DIGITAL_DOCUMENT(MainEntity mainEntity) {
	...
	public NOTE_DIGITAL_DOCUMENT(MainEntityOfPage mainEntityOfPage) {
	...
	public NOTE_DIGITAL_DOCUMENT(Material material) {
	...
	public NOTE_DIGITAL_DOCUMENT(MaterialExtent materialExtent) {
	...
	public NOTE_DIGITAL_DOCUMENT(Mentions mentions) {
	...
	public NOTE_DIGITAL_DOCUMENT(Name name) {
		setName(name);
	}
	...
	public NOTE_DIGITAL_DOCUMENT(NameFuzzy nameFuzzy) {
	...
	public NOTE_DIGITAL_DOCUMENT(NameRuby nameRuby) {
	...
	public NOTE_DIGITAL_DOCUMENT(Offers offers) {
		setOffers(offers);
	}
	...
	public NOTE_DIGITAL_DOCUMENT(Position position) {
	...
	public NOTE_DIGITAL_DOCUMENT(PotentialAction potentialAction) {
	...
	public NOTE_DIGITAL_DOCUMENT(Producer producer) {
	...
	public NOTE_DIGITAL_DOCUMENT(Provider provider) {
	...
	public NOTE_DIGITAL_DOCUMENT(Publication publication) {
	...
	public NOTE_DIGITAL_DOCUMENT(Publisher publisher) {
	...
	public NOTE_DIGITAL_DOCUMENT(PublisherImprint publisherImprint) {
	...
	public NOTE_DIGITAL_DOCUMENT(PublishingPrinciples publishingPrinciples) {
	...
	public NOTE_DIGITAL_DOCUMENT(RecordedAt recordedAt) {
	...
	public NOTE_DIGITAL_DOCUMENT(ReleasedEvent releasedEvent) {
	...
	public NOTE_DIGITAL_DOCUMENT(Review review) {
		setReview(review);
	}
	...
	public NOTE_DIGITAL_DOCUMENT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public NOTE_DIGITAL_DOCUMENT(SchemaVersion schemaVersion) {
	...
	public NOTE_DIGITAL_DOCUMENT(SdDatePublished sdDatePublished) {
	...
	public NOTE_DIGITAL_DOCUMENT(SdLicense sdLicense) {
	...
	public NOTE_DIGITAL_DOCUMENT(SdPublisher sdPublisher) {
	...
	public NOTE_DIGITAL_DOCUMENT(SourceOrganization sourceOrganization) {
	...
	public NOTE_DIGITAL_DOCUMENT(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public NOTE_DIGITAL_DOCUMENT(SpatialCoverage spatialCoverage) {
	...
	public NOTE_DIGITAL_DOCUMENT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public NOTE_DIGITAL_DOCUMENT(SubjectOf subjectOf) {
	...
	public NOTE_DIGITAL_DOCUMENT(Temporal temporal) {
	...
	public NOTE_DIGITAL_DOCUMENT(TemporalCoverage temporalCoverage) {
	...
	public NOTE_DIGITAL_DOCUMENT(Text text) {
		setText(text);
	}
	...
	public NOTE_DIGITAL_DOCUMENT(ThumbnailUrl thumbnailUrl) {
	...
	public NOTE_DIGITAL_DOCUMENT(TimeRequired timeRequired) {
	...
	public NOTE_DIGITAL_DOCUMENT(TranslationOfWork translationOfWork) {
	...
	public NOTE_DIGITAL_DOCUMENT(Translator translator) {
	...
	public NOTE_DIGITAL_DOCUMENT(TypicalAgeRange typicalAgeRange) {
	...
	public NOTE_DIGITAL_DOCUMENT(Url url) {
		setUrl(url);
	}
	...
	public NOTE_DIGITAL_DOCUMENT(Version version) {
		setVersion(version);
	}
	...
	public NOTE_DIGITAL_DOCUMENT(Video video) {
		setVideo(video);
	}
	...
	public NOTE_DIGITAL_DOCUMENT(WorkExample workExample) {
	...
	public NOTE_DIGITAL_DOCUMENT(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.NoteDigitalDocument org) {
		setSeq(org.getSeq());
