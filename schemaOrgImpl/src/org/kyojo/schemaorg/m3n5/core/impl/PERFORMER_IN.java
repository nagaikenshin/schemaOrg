...
public class PERFORMER_IN implements Container.PerformerIn {
	...
	public PERFORMER_IN(String string) {
	...
	public PERFORMER_IN(BroadcastEvent broadcastEvent) {
	...
	public PERFORMER_IN(BusinessEvent businessEvent) {
	...
	public PERFORMER_IN(ChildrensEvent childrensEvent) {
	...
	public PERFORMER_IN(ComedyEvent comedyEvent) {
	...
	public PERFORMER_IN(CourseInstance courseInstance) {
	...
	public PERFORMER_IN(DanceEvent danceEvent) {
	...
	public PERFORMER_IN(DeliveryEvent deliveryEvent) {
	...
	public PERFORMER_IN(EducationEvent educationEvent) {
	...
	public PERFORMER_IN(Event event) {
		eventList = new ArrayList<Event>();
		eventList.add(event);
	}
	...
	public PERFORMER_IN(EventSeries eventSeries) {
	...
	public PERFORMER_IN(ExhibitionEvent exhibitionEvent) {
	...
	public PERFORMER_IN(Festival festival) {
	...
	public PERFORMER_IN(FoodEvent foodEvent) {
	...
	public PERFORMER_IN(LiteraryEvent literaryEvent) {
	...
	public PERFORMER_IN(MusicEvent musicEvent) {
	...
	public PERFORMER_IN(OnDemandEvent onDemandEvent) {
	...
	public PERFORMER_IN(PublicationEvent publicationEvent) {
	...
	public PERFORMER_IN(SaleEvent saleEvent) {
	...
	public PERFORMER_IN(ScreeningEvent screeningEvent) {
	...
	public PERFORMER_IN(SocialEvent socialEvent) {
	...
	public PERFORMER_IN(SportsEvent sportsEvent) {
	...
	public PERFORMER_IN(TheaterEvent theaterEvent) {
	...
	public PERFORMER_IN(VisualArtsEvent visualArtsEvent) {
	...
	public void copy(Container.PerformerIn org) {
