...
public class LEI_CODE implements Container.LeiCode {
	...
	public LEI_CODE(LocationFeatureSpecification locationFeatureSpecification) {
	...
	public LEI_CODE(PropertyValue propertyValue) {
	...
	public LEI_CODE(String string) {
		this(new TEXT(string));
	}

	public LEI_CODE(Text text) {
	...
	public LEI_CODE(List<LocationFeatureSpecification> locationFeatureSpecificationList,
	...
	public void copy(Container.LeiCode org) {
