...
public class CHILD_MAX_AGE implements Container.ChildMaxAge {
	...
	public CHILD_MAX_AGE(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public CHILD_MAX_AGE(Float fl0at) {
	...
	public CHILD_MAX_AGE(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public CHILD_MAX_AGE(Integer integer) {
	...
	public CHILD_MAX_AGE(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public CHILD_MAX_AGE(Number number) {
	...
	public CHILD_MAX_AGE(List<Float> fl0atList,
	...
	public void copy(Container.ChildMaxAge org) {
