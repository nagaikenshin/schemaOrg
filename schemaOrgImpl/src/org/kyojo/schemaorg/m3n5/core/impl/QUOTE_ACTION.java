...
public class QUOTE_ACTION implements Clazz.QuoteAction {
	...
	public QUOTE_ACTION(Long seq) {
		setSeq(seq);
	}

	public QUOTE_ACTION(String string) {
	...
	public QUOTE_ACTION(ActionStatus actionStatus) {
	...
	public QUOTE_ACTION(AdditionalType additionalType) {
	...
	public QUOTE_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public QUOTE_ACTION(AlternateName alternateName) {
	...
	public QUOTE_ACTION(Description description) {
	...
	public QUOTE_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public QUOTE_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public QUOTE_ACTION(Error error) {
		setError(error);
	}
	...
	public QUOTE_ACTION(Identifier identifier) {
	...
	public QUOTE_ACTION(Image image) {
		setImage(image);
	}
	...
	public QUOTE_ACTION(Instrument instrument) {
	...
	public QUOTE_ACTION(Location location) {
	...
	public QUOTE_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public QUOTE_ACTION(NameFuzzy nameFuzzy) {
	...
	public QUOTE_ACTION(NameRuby nameRuby) {
	...
	public QUOTE_ACTION(Object object) {
		setObject(object);
	}
	...
	public QUOTE_ACTION(Participant participant) {
	...
	public QUOTE_ACTION(PotentialAction potentialAction) {
	...
	public QUOTE_ACTION(Price price) {
		setPrice(price);
	}
	...
	public QUOTE_ACTION(PriceCurrency priceCurrency) {
	...
	public QUOTE_ACTION(PriceSpecification priceSpecification) {
	...
	public QUOTE_ACTION(Result result) {
		setResult(result);
	}
	...
	public QUOTE_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public QUOTE_ACTION(StartTime startTime) {
	...
	public QUOTE_ACTION(SubjectOf subjectOf) {
	...
	public QUOTE_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.QuoteAction org) {
		setSeq(org.getSeq());
