...
public class BUS_RESERVATION implements Clazz.BusReservation {
	...
	public BUS_RESERVATION(Long seq) {
		setSeq(seq);
	}

	public BUS_RESERVATION(String string) {
	...
	public BUS_RESERVATION(AdditionalType additionalType) {
	...
	public BUS_RESERVATION(AlternateName alternateName) {
	...
	public BUS_RESERVATION(BookingTime bookingTime) {
	...
	public BUS_RESERVATION(Broker broker) {
		setBroker(broker);
	}
	...
	public BUS_RESERVATION(Description description) {
	...
	public BUS_RESERVATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public BUS_RESERVATION(Identifier identifier) {
	...
	public BUS_RESERVATION(Image image) {
		setImage(image);
	}
	...
	public BUS_RESERVATION(MainEntityOfPage mainEntityOfPage) {
	...
	public BUS_RESERVATION(ModifiedTime modifiedTime) {
	...
	public BUS_RESERVATION(Name name) {
		setName(name);
	}
	...
	public BUS_RESERVATION(NameFuzzy nameFuzzy) {
	...
	public BUS_RESERVATION(NameRuby nameRuby) {
	...
	public BUS_RESERVATION(PotentialAction potentialAction) {
	...
	public BUS_RESERVATION(PriceCurrency priceCurrency) {
	...
	public BUS_RESERVATION(ProgramMembershipUsed programMembershipUsed) {
	...
	public BUS_RESERVATION(Provider provider) {
	...
	public BUS_RESERVATION(ReservationFor reservationFor) {
	...
	public BUS_RESERVATION(ReservationId reservationId) {
	...
	public BUS_RESERVATION(ReservationStatus reservationStatus) {
	...
	public BUS_RESERVATION(ReservedTicket reservedTicket) {
	...
	public BUS_RESERVATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public BUS_RESERVATION(SubjectOf subjectOf) {
	...
	public BUS_RESERVATION(TotalPrice totalPrice) {
	...
	public BUS_RESERVATION(UnderName underName) {
	...
	public BUS_RESERVATION(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.BusReservation org) {
		setSeq(org.getSeq());
