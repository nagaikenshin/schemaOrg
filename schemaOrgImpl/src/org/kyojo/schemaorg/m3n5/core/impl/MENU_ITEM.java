...
public class MENU_ITEM implements Clazz.MenuItem {
	...
	public MENU_ITEM(Long seq) {
		setSeq(seq);
	}

	public MENU_ITEM(String string) {
	...
	public MENU_ITEM(AdditionalType additionalType) {
	...
	public MENU_ITEM(AlternateName alternateName) {
	...
	public MENU_ITEM(Description description) {
	...
	public MENU_ITEM(DisambiguatingDescription disambiguatingDescription) {
	...
	public MENU_ITEM(Identifier identifier) {
	...
	public MENU_ITEM(MainEntityOfPage mainEntityOfPage) {
	...
	public MENU_ITEM(MenuAddOn menuAddOn) {
		setMenuAddOn(menuAddOn);
	}
	...
	public MENU_ITEM(NameFuzzy nameFuzzy) {
	...
	public MENU_ITEM(NameRuby nameRuby) {
	...
	public MENU_ITEM(Nutrition nutrition) {
	...
	public MENU_ITEM(Offers offers) {
		setOffers(offers);
	}
	...
	public MENU_ITEM(PotentialAction potentialAction) {
	...
	public MENU_ITEM(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MENU_ITEM(SubjectOf subjectOf) {
	...
	public MENU_ITEM(SuitableForDiet suitableForDiet) {
	...
	public void copy(Clazz.MenuItem org) {
		setSeq(org.getSeq());
