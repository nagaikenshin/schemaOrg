...
public class AUTO_WASH implements Clazz.AutoWash {
	...
	public AUTO_WASH(GeoContains geoContains) {
	...
	public AUTO_WASH(GeoCoveredBy geoCoveredBy) {
	...
	public AUTO_WASH(GeoCovers geoCovers) {
	...
	public AUTO_WASH(GeoCrosses geoCrosses) {
	...
	public AUTO_WASH(GeoDisjoint geoDisjoint) {
	...
	public AUTO_WASH(GeoEquals geoEquals) {
	...
	public AUTO_WASH(GeoIntersects geoIntersects) {
	...
	public AUTO_WASH(GeoOverlaps geoOverlaps) {
	...
	public AUTO_WASH(GeoTouches geoTouches) {
	...
	public AUTO_WASH(GeoWithin geoWithin) {
	...
	public AUTO_WASH(Slogan slogan) {
		setSlogan(slogan);
	}
