...
public class PUBLISHER implements Container.Publisher {
	...
	public PUBLISHER(AccountingService accountingService) {
	...
	public PUBLISHER(AdultEntertainment adultEntertainment) {
	...
	public PUBLISHER(Airline airline) {
	...
	public PUBLISHER(AmusementPark amusementPark) {
	...
	public PUBLISHER(AnimalShelter animalShelter) {
	...
	public PUBLISHER(ArchiveOrganization archiveOrganization) {
	...
	public PUBLISHER(ArtGallery artGallery) {
	...
	public PUBLISHER(Attorney attorney) {
	...
	public PUBLISHER(AutoBodyShop autoBodyShop) {
	...
	public PUBLISHER(AutoDealer autoDealer) {
	...
	public PUBLISHER(AutoPartsStore autoPartsStore) {
	...
	public PUBLISHER(AutoRental autoRental) {
	...
	public PUBLISHER(AutoRepair autoRepair) {
	...
	public PUBLISHER(AutoWash autoWash) {
	...
	public PUBLISHER(AutomatedTeller automatedTeller) {
	...
	public PUBLISHER(AutomotiveBusiness automotiveBusiness) {
	...
	public PUBLISHER(Bakery bakery) {
	...
	public PUBLISHER(BankOrCreditUnion bankOrCreditUnion) {
	...
	public PUBLISHER(BarOrPub barOrPub) {
	...
	public PUBLISHER(BeautySalon beautySalon) {
	...
	public PUBLISHER(BedAndBreakfast bedAndBreakfast) {
	...
	public PUBLISHER(BikeStore bikeStore) {
	...
	public PUBLISHER(BookStore bookStore) {
	...
	public PUBLISHER(BowlingAlley bowlingAlley) {
	...
	public PUBLISHER(Brewery brewery) {
	...
	public PUBLISHER(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public PUBLISHER(Campground campground) {
	...
	public PUBLISHER(Casino casino) {
	...
	public PUBLISHER(ChildCare childCare) {
	...
	public PUBLISHER(ClothingStore clothingStore) {
	...
	public PUBLISHER(CollegeOrUniversity collegeOrUniversity) {
	...
	public PUBLISHER(ComedyClub comedyClub) {
	...
	public PUBLISHER(CommunityHealth communityHealth) {
	...
	public PUBLISHER(ComputerStore computerStore) {
	...
	public PUBLISHER(Consortium consortium) {
	...
	public PUBLISHER(ConvenienceStore convenienceStore) {
	...
	public PUBLISHER(Corporation corporation) {
	...
	public PUBLISHER(DanceGroup danceGroup) {
	...
	public PUBLISHER(DaySpa daySpa) {
	...
	public PUBLISHER(Dentist dentist) {
	...
	public PUBLISHER(DepartmentStore departmentStore) {
	...
	public PUBLISHER(Dermatology dermatology) {
	...
	public PUBLISHER(DiagnosticLab diagnosticLab) {
	...
	public PUBLISHER(DietNutrition dietNutrition) {
	...
	public PUBLISHER(Distillery distillery) {
	...
	public PUBLISHER(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public PUBLISHER(EducationalOrganization educationalOrganization) {
	...
	public PUBLISHER(Electrician electrician) {
	...
	public PUBLISHER(ElectronicsStore electronicsStore) {
	...
	public PUBLISHER(ElementarySchool elementarySchool) {
	...
	public PUBLISHER(Emergency emergency) {
	...
	public PUBLISHER(EmergencyService emergencyService) {
	...
	public PUBLISHER(EmploymentAgency employmentAgency) {
	...
	public PUBLISHER(EntertainmentBusiness entertainmentBusiness) {
	...
	public PUBLISHER(ExerciseGym exerciseGym) {
	...
	public PUBLISHER(FastFoodRestaurant fastFoodRestaurant) {
	...
	public PUBLISHER(FinancialService financialService) {
	...
	public PUBLISHER(FireStation fireStation) {
	...
	public PUBLISHER(Florist florist) {
	...
	public PUBLISHER(FoodEstablishment foodEstablishment) {
	...
	public PUBLISHER(FundingAgency fundingAgency) {
	...
	public PUBLISHER(FundingScheme fundingScheme) {
	...
	public PUBLISHER(FurnitureStore furnitureStore) {
	...
	public PUBLISHER(GardenStore gardenStore) {
	...
	public PUBLISHER(GasStation gasStation) {
	...
	public PUBLISHER(GeneralContractor generalContractor) {
	...
	public PUBLISHER(Geriatric geriatric) {
	...
	public PUBLISHER(GolfCourse golfCourse) {
	...
	public PUBLISHER(GovernmentOffice governmentOffice) {
	...
	public PUBLISHER(GovernmentOrganization governmentOrganization) {
	...
	public PUBLISHER(GroceryStore groceryStore) {
	...
	public PUBLISHER(Gynecologic gynecologic) {
	...
	public PUBLISHER(HVACBusiness hvacBusiness) {
	...
	public PUBLISHER(HairSalon hairSalon) {
	...
	public PUBLISHER(HardwareStore hardwareStore) {
	...
	public PUBLISHER(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public PUBLISHER(HealthClub healthClub) {
	...
	public PUBLISHER(HighSchool highSchool) {
	...
	public PUBLISHER(HobbyShop hobbyShop) {
	...
	public PUBLISHER(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public PUBLISHER(HomeGoodsStore homeGoodsStore) {
	...
	public PUBLISHER(Hospital hospital) {
	...
	public PUBLISHER(Hostel hostel) {
	...
	public PUBLISHER(HousePainter housePainter) {
	...
	public PUBLISHER(IceCreamShop iceCreamShop) {
	...
	public PUBLISHER(InsuranceAgency insuranceAgency) {
	...
	public PUBLISHER(InternetCafe internetCafe) {
	...
	public PUBLISHER(JewelryStore jewelryStore) {
	...
	public PUBLISHER(LegalService legalService) {
	...
	public PUBLISHER(Library library) {
	...
	public PUBLISHER(LibrarySystem librarySystem) {
	...
	public PUBLISHER(LiquorStore liquorStore) {
	...
	public PUBLISHER(LocalBusiness localBusiness) {
	...
	public PUBLISHER(Locksmith locksmith) {
	...
	public PUBLISHER(LodgingBusiness lodgingBusiness) {
	...
	public PUBLISHER(MedicalBusiness medicalBusiness) {
	...
	public PUBLISHER(MedicalClinic medicalClinic) {
	...
	public PUBLISHER(MedicalOrganization medicalOrganization) {
	...
	public PUBLISHER(MensClothingStore mensClothingStore) {
	...
	public PUBLISHER(MiddleSchool middleSchool) {
	...
	public PUBLISHER(Midwifery midwifery) {
	...
	public PUBLISHER(MobilePhoneStore mobilePhoneStore) {
	...
	public PUBLISHER(MotorcycleDealer motorcycleDealer) {
	...
	public PUBLISHER(MotorcycleRepair motorcycleRepair) {
	...
	public PUBLISHER(MovieRentalStore movieRentalStore) {
	...
	public PUBLISHER(MovieTheater movieTheater) {
	...
	public PUBLISHER(MovingCompany movingCompany) {
	...
	public PUBLISHER(MusicGroup musicGroup) {
	...
	public PUBLISHER(MusicStore musicStore) {
	...
	public PUBLISHER(NailSalon nailSalon) {
	...
	public PUBLISHER(NewsMediaOrganization newsMediaOrganization) {
	...
	public PUBLISHER(NightClub nightClub) {
	...
	public PUBLISHER(Notary notary) {
	...
	public PUBLISHER(Nursing nursing) {
	...
	public PUBLISHER(Obstetric obstetric) {
	...
	public PUBLISHER(OfficeEquipmentStore officeEquipmentStore) {
	...
	public PUBLISHER(Oncologic oncologic) {
	...
	public PUBLISHER(Optician optician) {
	...
	public PUBLISHER(Optometric optometric) {
	...
	public PUBLISHER(Organization organization) {
		organizationList = new ArrayList<Organization>();
	...
	public PUBLISHER(Otolaryngologic otolaryngologic) {
	...
	public PUBLISHER(OutletStore outletStore) {
	...
	public PUBLISHER(Patient patient) {
	...
	public PUBLISHER(PawnShop pawnShop) {
	...
	public PUBLISHER(Pediatric pediatric) {
	...
	public PUBLISHER(PerformingGroup performingGroup) {
	...
	public PUBLISHER(PetStore petStore) {
	...
	public PUBLISHER(Pharmacy pharmacy) {
	...
	public PUBLISHER(Physician physician) {
	...
	public PUBLISHER(Physiotherapy physiotherapy) {
	...
	public PUBLISHER(PlasticSurgery plasticSurgery) {
	...
	public PUBLISHER(Plumber plumber) {
	...
	public PUBLISHER(Podiatric podiatric) {
	...
	public PUBLISHER(PoliceStation policeStation) {
	...
	public PUBLISHER(PostOffice postOffice) {
	...
	public PUBLISHER(Preschool preschool) {
	...
	public PUBLISHER(PrimaryCare primaryCare) {
	...
	public PUBLISHER(ProfessionalService professionalService) {
	...
	public PUBLISHER(Project project) {
	...
	public PUBLISHER(Psychiatric psychiatric) {
	...
	public PUBLISHER(PublicHealth publicHealth) {
	...
	public PUBLISHER(PublicSwimmingPool publicSwimmingPool) {
	...
	public PUBLISHER(RadioStation radioStation) {
	...
	public PUBLISHER(RealEstateAgent realEstateAgent) {
	...
	public PUBLISHER(RecyclingCenter recyclingCenter) {
	...
	public PUBLISHER(ResearchProject researchProject) {
	...
	public PUBLISHER(Resort resort) {
	...
	public PUBLISHER(Restaurant restaurant) {
	...
	public PUBLISHER(RoofingContractor roofingContractor) {
	...
	public PUBLISHER(School school) {
	...
	public PUBLISHER(SelfStorage selfStorage) {
	...
	public PUBLISHER(ShoeStore shoeStore) {
	...
	public PUBLISHER(ShoppingCenter shoppingCenter) {
	...
	public PUBLISHER(SkiResort skiResort) {
	...
	public PUBLISHER(SportingGoodsStore sportingGoodsStore) {
	...
	public PUBLISHER(SportsActivityLocation sportsActivityLocation) {
	...
	public PUBLISHER(SportsClub sportsClub) {
	...
	public PUBLISHER(SportsOrganization sportsOrganization) {
	...
	public PUBLISHER(SportsTeam sportsTeam) {
	...
	public PUBLISHER(StadiumOrArena stadiumOrArena) {
	...
	public PUBLISHER(TattooParlor tattooParlor) {
	...
	public PUBLISHER(TelevisionStation televisionStation) {
	...
	public PUBLISHER(TennisComplex tennisComplex) {
	...
	public PUBLISHER(TheaterGroup theaterGroup) {
	...
	public PUBLISHER(TireShop tireShop) {
	...
	public PUBLISHER(TouristInformationCenter touristInformationCenter) {
	...
	public PUBLISHER(ToyStore toyStore) {
	...
	public PUBLISHER(TravelAgency travelAgency) {
	...
	public PUBLISHER(VeterinaryCare veterinaryCare) {
	...
	public PUBLISHER(WholesaleStore wholesaleStore) {
	...
	public PUBLISHER(Winery winery) {
	...
	public PUBLISHER(WorkersUnion workersUnion) {
	...
	public void copy(Container.Publisher org) {
