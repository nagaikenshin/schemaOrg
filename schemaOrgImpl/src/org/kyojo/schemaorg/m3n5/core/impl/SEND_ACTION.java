...
public class SEND_ACTION implements Clazz.SendAction {
	...
	public SEND_ACTION(Long seq) {
		setSeq(seq);
	}

	public SEND_ACTION(String string) {
	...
	public SEND_ACTION(ActionStatus actionStatus) {
	...
	public SEND_ACTION(AdditionalType additionalType) {
	...
	public SEND_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public SEND_ACTION(AlternateName alternateName) {
	...
	public SEND_ACTION(DeliveryMethod deliveryMethod) {
	...
	public SEND_ACTION(Description description) {
	...
	public SEND_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public SEND_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public SEND_ACTION(Error error) {
		setError(error);
	}
	...
	public SEND_ACTION(FromLocation fromLocation) {
	...
	public SEND_ACTION(Identifier identifier) {
	...
	public SEND_ACTION(Image image) {
		setImage(image);
	}
	...
	public SEND_ACTION(Instrument instrument) {
	...
	public SEND_ACTION(Location location) {
	...
	public SEND_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public SEND_ACTION(NameFuzzy nameFuzzy) {
	...
	public SEND_ACTION(NameRuby nameRuby) {
	...
	public SEND_ACTION(Object object) {
		setObject(object);
	}
	...
	public SEND_ACTION(Participant participant) {
	...
	public SEND_ACTION(PotentialAction potentialAction) {
	...
	public SEND_ACTION(Recipient recipient) {
	...
	public SEND_ACTION(Result result) {
		setResult(result);
	}
	...
	public SEND_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SEND_ACTION(StartTime startTime) {
	...
	public SEND_ACTION(SubjectOf subjectOf) {
	...
	public SEND_ACTION(Target target) {
		setTarget(target);
	}
	...
	public SEND_ACTION(ToLocation toLocation) {
	...
	public void copy(Clazz.SendAction org) {
		setSeq(org.getSeq());
