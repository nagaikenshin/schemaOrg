...
import org.kyojo.schemaorg.m3n5.core.Container.Replacee;
...
import org.kyojo.schemaorg.m3n5.core.Container.TargetCollection;
...
public class REPLACE_ACTION implements Clazz.ReplaceAction {
	...
	public REPLACE_ACTION() {
	}

	public REPLACE_ACTION(Long seq) {
		setSeq(seq);
	}

	public REPLACE_ACTION(String string) {
	...
	public REPLACE_ACTION(ActionStatus actionStatus) {
	...
	public REPLACE_ACTION(AdditionalType additionalType) {
	...
	public REPLACE_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public REPLACE_ACTION(AlternateName alternateName) {
	...
	public REPLACE_ACTION(Description description) {
	...
	public REPLACE_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public REPLACE_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public REPLACE_ACTION(Error error) {
		setError(error);
	}
	...
	public REPLACE_ACTION(Identifier identifier) {
	...
	public REPLACE_ACTION(Image image) {
		setImage(image);
	}
	...
	public REPLACE_ACTION(Instrument instrument) {
	...
	public REPLACE_ACTION(Location location) {
	...
	public REPLACE_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public REPLACE_ACTION(Name name) {
		setName(name);
	}
	...
	public REPLACE_ACTION(NameFuzzy nameFuzzy) {
	...
	public REPLACE_ACTION(NameRuby nameRuby) {
	...
	public REPLACE_ACTION(Object object) {
		setObject(object);
	}
	...
	public REPLACE_ACTION(Participant participant) {
	...
	public REPLACE_ACTION(PotentialAction potentialAction) {
	...
	public REPLACE_ACTION(Replacee replacee) {
		setReplacee(replacee);
	}

	@Override
	public Replacee getReplacee() {
		return replacee;
	}

	@Override
	public void setReplacee(Replacee replacee) {
		this.replacee = replacee;
	}

	public REPLACE_ACTION(Replacer replacer) {
	...
	public REPLACE_ACTION(Result result) {
		setResult(result);
	}
	...
	public REPLACE_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public REPLACE_ACTION(StartTime startTime) {
	...
	public REPLACE_ACTION(SubjectOf subjectOf) {
	...
	public REPLACE_ACTION(Target target) {
		setTarget(target);
	}
	...
	public REPLACE_ACTION(TargetCollection targetCollection) {
	...
	public void copy(Clazz.ReplaceAction org) {
		setSeq(org.getSeq());
		...
		setReplacee(org.getReplacee());
		setReplacer(org.getReplacer());
