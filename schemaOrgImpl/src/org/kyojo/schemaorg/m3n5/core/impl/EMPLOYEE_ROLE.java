...
import org.kyojo.schemaorg.m3n5.core.Container.BaseSalary;
...
public class EMPLOYEE_ROLE implements Clazz.EmployeeRole {
	...
	public EMPLOYEE_ROLE(String string) {
	...
	public EMPLOYEE_ROLE(AdditionalType additionalType) {
	...
	public EMPLOYEE_ROLE(AlternateName alternateName) {
	...
	public EMPLOYEE_ROLE(BaseSalary baseSalary) {
	...
	public EMPLOYEE_ROLE(Description description) {
	...
	public EMPLOYEE_ROLE(DisambiguatingDescription disambiguatingDescription) {
	...
	public EMPLOYEE_ROLE(EndDate endDate) {
		setEndDate(endDate);
	}
	...
	public EMPLOYEE_ROLE(Identifier identifier) {
	...
	public EMPLOYEE_ROLE(Image image) {
		setImage(image);
	}
	...
	public EMPLOYEE_ROLE(MainEntityOfPage mainEntityOfPage) {
	...
	public EMPLOYEE_ROLE(Name name) {
		setName(name);
	}
	...
	public EMPLOYEE_ROLE(NameFuzzy nameFuzzy) {
	...
	public EMPLOYEE_ROLE(NameRuby nameRuby) {
	...
	public EMPLOYEE_ROLE(NumberedPosition numberedPosition) {
	...
	public EMPLOYEE_ROLE(PotentialAction potentialAction) {
	...
	public EMPLOYEE_ROLE(RoleName roleName) {
	...
	public EMPLOYEE_ROLE(SalaryCurrency salaryCurrency) {
	...
	public EMPLOYEE_ROLE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public EMPLOYEE_ROLE(StartDate startDate) {
	...
	public EMPLOYEE_ROLE(SubjectOf subjectOf) {
