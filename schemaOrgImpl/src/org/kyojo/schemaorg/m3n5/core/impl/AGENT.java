...
public class AGENT implements Container.Agent {
	...
	public AGENT(AccountingService accountingService) {
	...
	public AGENT(AdultEntertainment adultEntertainment) {
	...
	public AGENT(AmusementPark amusementPark) {
	...
	public AGENT(AnimalShelter animalShelter) {
	...
	public AGENT(ArchiveOrganization archiveOrganization) {
	...
	public AGENT(ArtGallery artGallery) {
	...
	public AGENT(Attorney attorney) {
	...
	public AGENT(AutoBodyShop autoBodyShop) {
	...
	public AGENT(AutoDealer autoDealer) {
	...
	public AGENT(AutoPartsStore autoPartsStore) {
	...
	public AGENT(AutoRental autoRental) {
	...
	public AGENT(AutoRepair autoRepair) {
	...
	public AGENT(AutoWash autoWash) {
	...
	public AGENT(AutomatedTeller automatedTeller) {
	...
	public AGENT(AutomotiveBusiness automotiveBusiness) {
	...
	public AGENT(BankOrCreditUnion bankOrCreditUnion) {
	...
	public AGENT(BarOrPub barOrPub) {
	...
	public AGENT(BeautySalon beautySalon) {
	...
	public AGENT(BedAndBreakfast bedAndBreakfast) {
	...
	public AGENT(BikeStore bikeStore) {
	...
	public AGENT(BookStore bookStore) {
	...
	public AGENT(BowlingAlley bowlingAlley) {
	...
	public AGENT(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public AGENT(Campground campground) {
	...
	public AGENT(ChildCare childCare) {
	...
	public AGENT(ClothingStore clothingStore) {
	...
	public AGENT(CollegeOrUniversity collegeOrUniversity) {
	...
	public AGENT(ComedyClub comedyClub) {
	...
	public AGENT(CommunityHealth communityHealth) {
	...
	public AGENT(ComputerStore computerStore) {
	...
	public AGENT(Consortium consortium) {
	...
	public AGENT(ConvenienceStore convenienceStore) {
	...
	public AGENT(Corporation corporation) {
	...
	public AGENT(DanceGroup danceGroup) {
	...
	public AGENT(DepartmentStore departmentStore) {
	...
	public AGENT(Dermatology dermatology) {
	...
	public AGENT(DiagnosticLab diagnosticLab) {
	...
	public AGENT(DietNutrition dietNutrition) {
	...
	public AGENT(Distillery distillery) {
	...
	public AGENT(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public AGENT(EducationalOrganization educationalOrganization) {
	...
	public AGENT(Electrician electrician) {
	...
	public AGENT(ElectronicsStore electronicsStore) {
	...
	public AGENT(ElementarySchool elementarySchool) {
	...
	public AGENT(Emergency emergency) {
	...
	public AGENT(EmergencyService emergencyService) {
	...
	public AGENT(EmploymentAgency employmentAgency) {
	...
	public AGENT(EntertainmentBusiness entertainmentBusiness) {
	...
	public AGENT(ExerciseGym exerciseGym) {
	...
	public AGENT(FastFoodRestaurant fastFoodRestaurant) {
	...
	public AGENT(FinancialService financialService) {
	...
	public AGENT(FireStation fireStation) {
	...
	public AGENT(FoodEstablishment foodEstablishment) {
	...
	public AGENT(FundingAgency fundingAgency) {
	...
	public AGENT(FundingScheme fundingScheme) {
	...
	public AGENT(FurnitureStore furnitureStore) {
	...
	public AGENT(GardenStore gardenStore) {
	...
	public AGENT(GasStation gasStation) {
	...
	public AGENT(GeneralContractor generalContractor) {
	...
	public AGENT(Geriatric geriatric) {
	...
	public AGENT(GolfCourse golfCourse) {
	...
	public AGENT(GovernmentOffice governmentOffice) {
	...
	public AGENT(GovernmentOrganization governmentOrganization) {
	...
	public AGENT(GroceryStore groceryStore) {
	...
	public AGENT(Gynecologic gynecologic) {
	...
	public AGENT(HVACBusiness hvacBusiness) {
	...
	public AGENT(HairSalon hairSalon) {
	...
	public AGENT(HardwareStore hardwareStore) {
	...
	public AGENT(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public AGENT(HealthClub healthClub) {
	...
	public AGENT(HighSchool highSchool) {
	...
	public AGENT(HobbyShop hobbyShop) {
	...
	public AGENT(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public AGENT(HomeGoodsStore homeGoodsStore) {
	...
	public AGENT(Hospital hospital) {
	...
	public AGENT(HousePainter housePainter) {
	...
	public AGENT(IceCreamShop iceCreamShop) {
	...
	public AGENT(InsuranceAgency insuranceAgency) {
	...
	public AGENT(InternetCafe internetCafe) {
	...
	public AGENT(JewelryStore jewelryStore) {
	...
	public AGENT(LegalService legalService) {
	...
	public AGENT(LibrarySystem librarySystem) {
	...
	public AGENT(LiquorStore liquorStore) {
	...
	public AGENT(LocalBusiness localBusiness) {
	...
	public AGENT(Locksmith locksmith) {
	...
	public AGENT(LodgingBusiness lodgingBusiness) {
	...
	public AGENT(MedicalBusiness medicalBusiness) {
	...
	public AGENT(MedicalClinic medicalClinic) {
	...
	public AGENT(MedicalOrganization medicalOrganization) {
	...
	public AGENT(MensClothingStore mensClothingStore) {
	...
	public AGENT(MiddleSchool middleSchool) {
	...
	public AGENT(Midwifery midwifery) {
	...
	public AGENT(MobilePhoneStore mobilePhoneStore) {
	...
	public AGENT(MotorcycleDealer motorcycleDealer) {
	...
	public AGENT(MotorcycleRepair motorcycleRepair) {
	...
	public AGENT(MovieRentalStore movieRentalStore) {
	...
	public AGENT(MovieTheater movieTheater) {
	...
	public AGENT(MovingCompany movingCompany) {
	...
	public AGENT(MusicGroup musicGroup) {
	...
	public AGENT(MusicStore musicStore) {
	...
	public AGENT(NailSalon nailSalon) {
	...
	public AGENT(NewsMediaOrganization newsMediaOrganization) {
	...
	public AGENT(NightClub nightClub) {
	...
	public AGENT(Obstetric obstetric) {
	...
	public AGENT(OfficeEquipmentStore officeEquipmentStore) {
	...
	public AGENT(Oncologic oncologic) {
	...
	public AGENT(Optician optician) {
	...
	public AGENT(Optometric optometric) {
	...
	public AGENT(Organization organization) {
		organizationList = new ArrayList<Organization>();
	...
	public AGENT(Otolaryngologic otolaryngologic) {
	...
	public AGENT(OutletStore outletStore) {
	...
	public AGENT(PawnShop pawnShop) {
	...
	public AGENT(Pediatric pediatric) {
	...
	public AGENT(PerformingGroup performingGroup) {
	...
	public AGENT(PetStore petStore) {
	...
	public AGENT(Pharmacy pharmacy) {
	...
	public AGENT(Physician physician) {
	...
	public AGENT(Physiotherapy physiotherapy) {
	...
	public AGENT(PlasticSurgery plasticSurgery) {
	...
	public AGENT(Podiatric podiatric) {
	...
	public AGENT(PoliceStation policeStation) {
	...
	public AGENT(PostOffice postOffice) {
	...
	public AGENT(Preschool preschool) {
	...
	public AGENT(PrimaryCare primaryCare) {
	...
	public AGENT(ProfessionalService professionalService) {
	...
	public AGENT(Psychiatric psychiatric) {
	...
	public AGENT(PublicHealth publicHealth) {
	...
	public AGENT(PublicSwimmingPool publicSwimmingPool) {
	...
	public AGENT(RadioStation radioStation) {
	...
	public AGENT(RealEstateAgent realEstateAgent) {
	...
	public AGENT(RecyclingCenter recyclingCenter) {
	...
	public AGENT(ResearchProject researchProject) {
	...
	public AGENT(Restaurant restaurant) {
	...
	public AGENT(RoofingContractor roofingContractor) {
	...
	public AGENT(SelfStorage selfStorage) {
	...
	public AGENT(ShoeStore shoeStore) {
	...
	public AGENT(ShoppingCenter shoppingCenter) {
	...
	public AGENT(SkiResort skiResort) {
	...
	public AGENT(SportingGoodsStore sportingGoodsStore) {
	...
	public AGENT(SportsActivityLocation sportsActivityLocation) {
	...
	public AGENT(SportsClub sportsClub) {
	...
	public AGENT(SportsOrganization sportsOrganization) {
	...
	public AGENT(SportsTeam sportsTeam) {
	...
	public AGENT(StadiumOrArena stadiumOrArena) {
	...
	public AGENT(TattooParlor tattooParlor) {
	...
	public AGENT(TelevisionStation televisionStation) {
	...
	public AGENT(TennisComplex tennisComplex) {
	...
	public AGENT(TheaterGroup theaterGroup) {
	...
	public AGENT(TireShop tireShop) {
	...
	public AGENT(TouristInformationCenter touristInformationCenter) {
	...
	public AGENT(ToyStore toyStore) {
	...
	public AGENT(TravelAgency travelAgency) {
	...
	public AGENT(VeterinaryCare veterinaryCare) {
	...
	public AGENT(WholesaleStore wholesaleStore) {
	...
	public AGENT(WorkersUnion workersUnion) {
	...
	public void copy(Container.Agent org) {
