...
public class SPORTS_CLUB implements Clazz.SportsClub {
	...
	public SPORTS_CLUB(GeoContains geoContains) {
	...
	public SPORTS_CLUB(GeoCoveredBy geoCoveredBy) {
	...
	public SPORTS_CLUB(GeoCovers geoCovers) {
	...
	public SPORTS_CLUB(GeoCrosses geoCrosses) {
	...
	public SPORTS_CLUB(GeoDisjoint geoDisjoint) {
	...
	public SPORTS_CLUB(GeoEquals geoEquals) {
	...
	public SPORTS_CLUB(GeoIntersects geoIntersects) {
	...
	public SPORTS_CLUB(GeoOverlaps geoOverlaps) {
	...
	public SPORTS_CLUB(GeoTouches geoTouches) {
	...
	public SPORTS_CLUB(GeoWithin geoWithin) {
	...
	public SPORTS_CLUB(Slogan slogan) {
		setSlogan(slogan);
	}
