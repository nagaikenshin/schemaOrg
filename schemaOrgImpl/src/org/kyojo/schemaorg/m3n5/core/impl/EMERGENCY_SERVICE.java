...
public class EMERGENCY_SERVICE implements Clazz.EmergencyService {
	...
	public EMERGENCY_SERVICE(GeoContains geoContains) {
	...
	public EMERGENCY_SERVICE(GeoCoveredBy geoCoveredBy) {
	...
	public EMERGENCY_SERVICE(GeoCovers geoCovers) {
	...
	public EMERGENCY_SERVICE(GeoCrosses geoCrosses) {
	...
	public EMERGENCY_SERVICE(GeoDisjoint geoDisjoint) {
	...
	public EMERGENCY_SERVICE(GeoEquals geoEquals) {
	...
	public EMERGENCY_SERVICE(GeoIntersects geoIntersects) {
	...
	public EMERGENCY_SERVICE(GeoOverlaps geoOverlaps) {
	...
	public EMERGENCY_SERVICE(GeoTouches geoTouches) {
	...
	public EMERGENCY_SERVICE(GeoWithin geoWithin) {
	...
	public EMERGENCY_SERVICE(Slogan slogan) {
		setSlogan(slogan);
	}
