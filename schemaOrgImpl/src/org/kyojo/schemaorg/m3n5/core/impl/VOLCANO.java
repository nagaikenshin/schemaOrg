...
public class VOLCANO implements Clazz.Volcano {
	...
	public VOLCANO(GeoContains geoContains) {
	...
	public VOLCANO(GeoCoveredBy geoCoveredBy) {
	...
	public VOLCANO(GeoCovers geoCovers) {
	...
	public VOLCANO(GeoCrosses geoCrosses) {
	...
	public VOLCANO(GeoDisjoint geoDisjoint) {
	...
	public VOLCANO(GeoEquals geoEquals) {
	...
	public VOLCANO(GeoIntersects geoIntersects) {
	...
	public VOLCANO(GeoOverlaps geoOverlaps) {
	...
	public VOLCANO(GeoTouches geoTouches) {
	...
	public VOLCANO(GeoWithin geoWithin) {
