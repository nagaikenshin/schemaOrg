...
public class CONTAINS_SEASON implements Container.ContainsSeason {
	...
	public CONTAINS_SEASON(String string) {
		this(new CREATIVE_WORK_SEASON(string));
	}

	public String getString() {
		if(creativeWorkSeasonList == null || creativeWorkSeasonList.size() == 0 || creativeWorkSeasonList.get(0) == null) {
			return null;
		} else {
			Name name = creativeWorkSeasonList.get(0).getName();
	...
	public void setString(String string) {
		...
		if(creativeWorkSeasonList.size() == 0) {
			creativeWorkSeasonList.add(new CREATIVE_WORK_SEASON(string));
		} else {
			creativeWorkSeasonList.set(0, new CREATIVE_WORK_SEASON(string));
		}
	}

	public CONTAINS_SEASON(APIReference apiReference) {
	...
	public CONTAINS_SEASON(AboutPage aboutPage) {
	...
	public CONTAINS_SEASON(AdvertiserContentArticle advertiserContentArticle) {
	...
	public CONTAINS_SEASON(AnalysisNewsArticle analysisNewsArticle) {
	...
	public CONTAINS_SEASON(Answer answer) {
	...
	public CONTAINS_SEASON(ArchiveComponent archiveComponent) {
	...
	public CONTAINS_SEASON(Article article) {
	...
	public CONTAINS_SEASON(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public CONTAINS_SEASON(Atlas atlas) {
	...
	public CONTAINS_SEASON(AudioObject audioObject) {
	...
	public CONTAINS_SEASON(Audiobook audiobook) {
	...
	public CONTAINS_SEASON(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public CONTAINS_SEASON(Barcode barcode) {
	...
	public CONTAINS_SEASON(Blog blog) {
	...
	public CONTAINS_SEASON(BlogPosting blogPosting) {
	...
	public CONTAINS_SEASON(Book book) {
	...
	public CONTAINS_SEASON(BookSeries bookSeries) {
	...
	public CONTAINS_SEASON(CategoryCodeSet categoryCodeSet) {
	...
	public CONTAINS_SEASON(Chapter chapter) {
	...
	public CONTAINS_SEASON(CheckoutPage checkoutPage) {
	...
	public CONTAINS_SEASON(Claim claim) {
	...
	public CONTAINS_SEASON(ClaimReview claimReview) {
	...
	public CONTAINS_SEASON(Clip clip) {
	...
	public CONTAINS_SEASON(Collection collection) {
	...
	public CONTAINS_SEASON(CollectionPage collectionPage) {
	...
	public CONTAINS_SEASON(ComicCoverArt comicCoverArt) {
	...
	public CONTAINS_SEASON(ComicIssue comicIssue) {
	...
	public CONTAINS_SEASON(ComicSeries comicSeries) {
	...
	public CONTAINS_SEASON(ComicStory comicStory) {
	...
	public CONTAINS_SEASON(Comment comment) {
	...
	public CONTAINS_SEASON(CompleteDataFeed completeDataFeed) {
	...
	public CONTAINS_SEASON(ContactPage contactPage) {
	...
	public CONTAINS_SEASON(Conversation conversation) {
	...
	public CONTAINS_SEASON(CorrectionComment correctionComment) {
	...
	public CONTAINS_SEASON(Course course) {
	...
	public CONTAINS_SEASON(CoverArt coverArt) {
	...
	public CONTAINS_SEASON(CreativeWorkSeries creativeWorkSeries) {
	...
	public CONTAINS_SEASON(CriticReview criticReview) {
	...
	public CONTAINS_SEASON(DataCatalog dataCatalog) {
	...
	public CONTAINS_SEASON(DataDownload dataDownload) {
	...
	public CONTAINS_SEASON(DataFeed dataFeed) {
	...
	public CONTAINS_SEASON(Dataset dataset) {
	...
	public CONTAINS_SEASON(DefinedTermSet definedTermSet) {
	...
	public CONTAINS_SEASON(Diet diet) {
	...
	public CONTAINS_SEASON(DigitalDocument digitalDocument) {
	...
	public CONTAINS_SEASON(DiscussionForumPosting discussionForumPosting) {
	...
	public CONTAINS_SEASON(Drawing drawing) {
	...
	public CONTAINS_SEASON(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public CONTAINS_SEASON(EmailMessage emailMessage) {
	...
	public CONTAINS_SEASON(EmployerReview employerReview) {
	...
	public CONTAINS_SEASON(Episode episode) {
	...
	public CONTAINS_SEASON(ExercisePlan exercisePlan) {
	...
	public CONTAINS_SEASON(FAQPage faqPage) {
	...
	public CONTAINS_SEASON(Game game) {
	...
	public CONTAINS_SEASON(HowTo howTo) {
	...
	public CONTAINS_SEASON(HowToDirection howToDirection) {
	...
	public CONTAINS_SEASON(HowToSection howToSection) {
	...
	public CONTAINS_SEASON(HowToStep howToStep) {
	...
	public CONTAINS_SEASON(HowToTip howToTip) {
	...
	public CONTAINS_SEASON(ImageGallery imageGallery) {
	...
	public CONTAINS_SEASON(ImageObject imageObject) {
	...
	public CONTAINS_SEASON(ItemPage itemPage) {
	...
	public CONTAINS_SEASON(Legislation legislation) {
	...
	public CONTAINS_SEASON(LegislationObject legislationObject) {
	...
	public CONTAINS_SEASON(LiveBlogPosting liveBlogPosting) {
	...
	public CONTAINS_SEASON(Manuscript manuscript) {
	...
	public CONTAINS_SEASON(Map map) {
	...
	public CONTAINS_SEASON(MediaObject mediaObject) {
	...
	public CONTAINS_SEASON(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public CONTAINS_SEASON(MedicalWebPage medicalWebPage) {
	...
	public CONTAINS_SEASON(Menu menu) {
	...
	public CONTAINS_SEASON(MenuSection menuSection) {
	...
	public CONTAINS_SEASON(Message message) {
	...
	public CONTAINS_SEASON(MobileApplication mobileApplication) {
	...
	public CONTAINS_SEASON(Movie movie) {
	...
	public CONTAINS_SEASON(MovieClip movieClip) {
	...
	public CONTAINS_SEASON(MovieSeries movieSeries) {
	...
	public CONTAINS_SEASON(MusicAlbum musicAlbum) {
	...
	public CONTAINS_SEASON(MusicComposition musicComposition) {
	...
	public CONTAINS_SEASON(MusicPlaylist musicPlaylist) {
	...
	public CONTAINS_SEASON(MusicRecording musicRecording) {
	...
	public CONTAINS_SEASON(MusicRelease musicRelease) {
	...
	public CONTAINS_SEASON(MusicVideoObject musicVideoObject) {
	...
	public CONTAINS_SEASON(NewsArticle newsArticle) {
	...
	public CONTAINS_SEASON(Newspaper newspaper) {
	...
	public CONTAINS_SEASON(NoteDigitalDocument noteDigitalDocument) {
	...
	public CONTAINS_SEASON(OpinionNewsArticle opinionNewsArticle) {
	...
	public CONTAINS_SEASON(Painting painting) {
	...
	public CONTAINS_SEASON(Periodical periodical) {
	...
	public CONTAINS_SEASON(Photograph photograph) {
	...
	public CONTAINS_SEASON(Play play) {
	...
	public CONTAINS_SEASON(Poster poster) {
	...
	public CONTAINS_SEASON(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public CONTAINS_SEASON(ProfilePage profilePage) {
	...
	public CONTAINS_SEASON(PublicationIssue publicationIssue) {
	...
	public CONTAINS_SEASON(PublicationVolume publicationVolume) {
	...
	public CONTAINS_SEASON(QAPage qaPage) {
	...
	public CONTAINS_SEASON(Question question) {
	...
	public CONTAINS_SEASON(Quotation quotation) {
	...
	public CONTAINS_SEASON(RadioClip radioClip) {
	...
	public CONTAINS_SEASON(RadioEpisode radioEpisode) {
	...
	public CONTAINS_SEASON(RadioSeason radioSeason) {
	...
	public CONTAINS_SEASON(RadioSeries radioSeries) {
	...
	public CONTAINS_SEASON(Recipe recipe) {
	...
	public CONTAINS_SEASON(Report report) {
	...
	public CONTAINS_SEASON(ReportageNewsArticle reportageNewsArticle) {
	...
	public CONTAINS_SEASON(Review review) {
	...
	public CONTAINS_SEASON(ReviewNewsArticle reviewNewsArticle) {
	...
	public CONTAINS_SEASON(SatiricalArticle satiricalArticle) {
	...
	public CONTAINS_SEASON(ScholarlyArticle scholarlyArticle) {
	...
	public CONTAINS_SEASON(Sculpture sculpture) {
	...
	public CONTAINS_SEASON(SearchResultsPage searchResultsPage) {
	...
	public CONTAINS_SEASON(SheetMusic sheetMusic) {
	...
	public CONTAINS_SEASON(ShortStory shortStory) {
	...
	public CONTAINS_SEASON(SiteNavigationElement siteNavigationElement) {
	...
	public CONTAINS_SEASON(SocialMediaPosting socialMediaPosting) {
	...
	public CONTAINS_SEASON(SoftwareApplication softwareApplication) {
	...
	public CONTAINS_SEASON(SoftwareSourceCode softwareSourceCode) {
	...
	public CONTAINS_SEASON(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public CONTAINS_SEASON(TVClip tvClip) {
	...
	public CONTAINS_SEASON(TVEpisode tvEpisode) {
	...
	public CONTAINS_SEASON(TVSeason tvSeason) {
	...
	public CONTAINS_SEASON(TVSeries tvSeries) {
	...
	public CONTAINS_SEASON(Table table) {
	...
	public CONTAINS_SEASON(TechArticle techArticle) {
	...
	public CONTAINS_SEASON(TextDigitalDocument textDigitalDocument) {
	...
	public CONTAINS_SEASON(Thesis thesis) {
	...
	public CONTAINS_SEASON(ThreeDimensionalModel threeDimensionalModel) {
	...
	public CONTAINS_SEASON(UserReview userReview) {
	...
	public CONTAINS_SEASON(VideoGallery videoGallery) {
	...
	public CONTAINS_SEASON(VideoGame videoGame) {
	...
	public CONTAINS_SEASON(VideoGameClip videoGameClip) {
	...
	public CONTAINS_SEASON(VideoGameSeries videoGameSeries) {
	...
	public CONTAINS_SEASON(VideoObject videoObject) {
	...
	public CONTAINS_SEASON(VisualArtwork visualArtwork) {
	...
	public CONTAINS_SEASON(WPAdBlock wpAdBlock) {
	...
	public CONTAINS_SEASON(WPFooter wpFooter) {
	...
	public CONTAINS_SEASON(WPHeader wpHeader) {
	...
	public CONTAINS_SEASON(WPSideBar wpSideBar) {
	...
	public CONTAINS_SEASON(WebApplication webApplication) {
	...
	public CONTAINS_SEASON(WebPage webPage) {
	...
	public CONTAINS_SEASON(WebPageElement webPageElement) {
	...
	public CONTAINS_SEASON(WebSite webSite) {
