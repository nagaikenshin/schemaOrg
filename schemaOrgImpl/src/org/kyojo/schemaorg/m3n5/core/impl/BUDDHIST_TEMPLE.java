...
public class BUDDHIST_TEMPLE implements Clazz.BuddhistTemple {
	...
	public BUDDHIST_TEMPLE(GeoContains geoContains) {
	...
	public BUDDHIST_TEMPLE(GeoCoveredBy geoCoveredBy) {
	...
	public BUDDHIST_TEMPLE(GeoCovers geoCovers) {
	...
	public BUDDHIST_TEMPLE(GeoCrosses geoCrosses) {
	...
	public BUDDHIST_TEMPLE(GeoDisjoint geoDisjoint) {
	...
	public BUDDHIST_TEMPLE(GeoEquals geoEquals) {
	...
	public BUDDHIST_TEMPLE(GeoIntersects geoIntersects) {
	...
	public BUDDHIST_TEMPLE(GeoOverlaps geoOverlaps) {
	...
	public BUDDHIST_TEMPLE(GeoTouches geoTouches) {
	...
	public BUDDHIST_TEMPLE(GeoWithin geoWithin) {
	...
	public BUDDHIST_TEMPLE(Slogan slogan) {
		setSlogan(slogan);
	}
