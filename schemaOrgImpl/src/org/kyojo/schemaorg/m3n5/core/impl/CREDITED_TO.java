...
public class CREDITED_TO implements Container.CreditedTo {
	...
	public CREDITED_TO(String string) {
	...
	public CREDITED_TO(AccountingService accountingService) {
	...
	public CREDITED_TO(AdultEntertainment adultEntertainment) {
	...
	public CREDITED_TO(Airline airline) {
	...
	public CREDITED_TO(AmusementPark amusementPark) {
	...
	public CREDITED_TO(AnimalShelter animalShelter) {
	...
	public CREDITED_TO(ArchiveOrganization archiveOrganization) {
	...
	public CREDITED_TO(ArtGallery artGallery) {
	...
	public CREDITED_TO(Attorney attorney) {
	...
	public CREDITED_TO(AutoBodyShop autoBodyShop) {
	...
	public CREDITED_TO(AutoDealer autoDealer) {
	...
	public CREDITED_TO(AutoPartsStore autoPartsStore) {
	...
	public CREDITED_TO(AutoRental autoRental) {
	...
	public CREDITED_TO(AutoRepair autoRepair) {
	...
	public CREDITED_TO(AutoWash autoWash) {
	...
	public CREDITED_TO(AutomatedTeller automatedTeller) {
	...
	public CREDITED_TO(AutomotiveBusiness automotiveBusiness) {
	...
	public CREDITED_TO(Bakery bakery) {
	...
	public CREDITED_TO(BankOrCreditUnion bankOrCreditUnion) {
	...
	public CREDITED_TO(BarOrPub barOrPub) {
	...
	public CREDITED_TO(BeautySalon beautySalon) {
	...
	public CREDITED_TO(BedAndBreakfast bedAndBreakfast) {
	...
	public CREDITED_TO(BikeStore bikeStore) {
	...
	public CREDITED_TO(BookStore bookStore) {
	...
	public CREDITED_TO(BowlingAlley bowlingAlley) {
	...
	public CREDITED_TO(Brewery brewery) {
	...
	public CREDITED_TO(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public CREDITED_TO(Campground campground) {
	...
	public CREDITED_TO(Casino casino) {
	...
	public CREDITED_TO(ChildCare childCare) {
	...
	public CREDITED_TO(ClothingStore clothingStore) {
	...
	public CREDITED_TO(CollegeOrUniversity collegeOrUniversity) {
	...
	public CREDITED_TO(ComedyClub comedyClub) {
	...
	public CREDITED_TO(CommunityHealth communityHealth) {
	...
	public CREDITED_TO(ComputerStore computerStore) {
	...
	public CREDITED_TO(Consortium consortium) {
	...
	public CREDITED_TO(ConvenienceStore convenienceStore) {
	...
	public CREDITED_TO(Corporation corporation) {
	...
	public CREDITED_TO(DanceGroup danceGroup) {
	...
	public CREDITED_TO(DaySpa daySpa) {
	...
	public CREDITED_TO(Dentist dentist) {
	...
	public CREDITED_TO(DepartmentStore departmentStore) {
	...
	public CREDITED_TO(Dermatology dermatology) {
	...
	public CREDITED_TO(DiagnosticLab diagnosticLab) {
	...
	public CREDITED_TO(DietNutrition dietNutrition) {
	...
	public CREDITED_TO(Distillery distillery) {
	...
	public CREDITED_TO(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public CREDITED_TO(EducationalOrganization educationalOrganization) {
	...
	public CREDITED_TO(Electrician electrician) {
	...
	public CREDITED_TO(ElectronicsStore electronicsStore) {
	...
	public CREDITED_TO(ElementarySchool elementarySchool) {
	...
	public CREDITED_TO(Emergency emergency) {
	...
	public CREDITED_TO(EmergencyService emergencyService) {
	...
	public CREDITED_TO(EmploymentAgency employmentAgency) {
	...
	public CREDITED_TO(EntertainmentBusiness entertainmentBusiness) {
	...
	public CREDITED_TO(ExerciseGym exerciseGym) {
	...
	public CREDITED_TO(FastFoodRestaurant fastFoodRestaurant) {
	...
	public CREDITED_TO(FinancialService financialService) {
	...
	public CREDITED_TO(FireStation fireStation) {
	...
	public CREDITED_TO(Florist florist) {
	...
	public CREDITED_TO(FoodEstablishment foodEstablishment) {
	...
	public CREDITED_TO(FundingAgency fundingAgency) {
	...
	public CREDITED_TO(FundingScheme fundingScheme) {
	...
	public CREDITED_TO(FurnitureStore furnitureStore) {
	...
	public CREDITED_TO(GardenStore gardenStore) {
	...
	public CREDITED_TO(GasStation gasStation) {
	...
	public CREDITED_TO(GeneralContractor generalContractor) {
	...
	public CREDITED_TO(Geriatric geriatric) {
	...
	public CREDITED_TO(GolfCourse golfCourse) {
	...
	public CREDITED_TO(GovernmentOffice governmentOffice) {
	...
	public CREDITED_TO(GovernmentOrganization governmentOrganization) {
	...
	public CREDITED_TO(GroceryStore groceryStore) {
	...
	public CREDITED_TO(Gynecologic gynecologic) {
	...
	public CREDITED_TO(HVACBusiness hvacBusiness) {
	...
	public CREDITED_TO(HairSalon hairSalon) {
	...
	public CREDITED_TO(HardwareStore hardwareStore) {
	...
	public CREDITED_TO(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public CREDITED_TO(HealthClub healthClub) {
	...
	public CREDITED_TO(HighSchool highSchool) {
	...
	public CREDITED_TO(HobbyShop hobbyShop) {
	...
	public CREDITED_TO(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public CREDITED_TO(HomeGoodsStore homeGoodsStore) {
	...
	public CREDITED_TO(Hospital hospital) {
	...
	public CREDITED_TO(Hostel hostel) {
	...
	public CREDITED_TO(Hotel hotel) {
	...
	public CREDITED_TO(HousePainter housePainter) {
	...
	public CREDITED_TO(IceCreamShop iceCreamShop) {
	...
	public CREDITED_TO(InsuranceAgency insuranceAgency) {
	...
	public CREDITED_TO(InternetCafe internetCafe) {
	...
	public CREDITED_TO(JewelryStore jewelryStore) {
	...
	public CREDITED_TO(LegalService legalService) {
	...
	public CREDITED_TO(Library library) {
	...
	public CREDITED_TO(LibrarySystem librarySystem) {
	...
	public CREDITED_TO(LiquorStore liquorStore) {
	...
	public CREDITED_TO(LocalBusiness localBusiness) {
	...
	public CREDITED_TO(Locksmith locksmith) {
	...
	public CREDITED_TO(LodgingBusiness lodgingBusiness) {
	...
	public CREDITED_TO(MedicalBusiness medicalBusiness) {
	...
	public CREDITED_TO(MedicalClinic medicalClinic) {
	...
	public CREDITED_TO(MedicalOrganization medicalOrganization) {
	...
	public CREDITED_TO(MensClothingStore mensClothingStore) {
	...
	public CREDITED_TO(MiddleSchool middleSchool) {
	...
	public CREDITED_TO(Midwifery midwifery) {
	...
	public CREDITED_TO(MobilePhoneStore mobilePhoneStore) {
	...
	public CREDITED_TO(Motel motel) {
	...
	public CREDITED_TO(MotorcycleDealer motorcycleDealer) {
	...
	public CREDITED_TO(MotorcycleRepair motorcycleRepair) {
	...
	public CREDITED_TO(MovieRentalStore movieRentalStore) {
	...
	public CREDITED_TO(MovieTheater movieTheater) {
	...
	public CREDITED_TO(MovingCompany movingCompany) {
	...
	public CREDITED_TO(MusicGroup musicGroup) {
	...
	public CREDITED_TO(MusicStore musicStore) {
	...
	public CREDITED_TO(NailSalon nailSalon) {
	...
	public CREDITED_TO(NewsMediaOrganization newsMediaOrganization) {
	...
	public CREDITED_TO(NightClub nightClub) {
	...
	public CREDITED_TO(Notary notary) {
	...
	public CREDITED_TO(Nursing nursing) {
	...
	public CREDITED_TO(Obstetric obstetric) {
	...
	public CREDITED_TO(OfficeEquipmentStore officeEquipmentStore) {
	...
	public CREDITED_TO(Oncologic oncologic) {
	...
	public CREDITED_TO(Optician optician) {
	...
	public CREDITED_TO(Optometric optometric) {
	...
	public CREDITED_TO(Organization organization) {
		organizationList = new ArrayList<Organization>();
	...
	public CREDITED_TO(Otolaryngologic otolaryngologic) {
	...
	public CREDITED_TO(OutletStore outletStore) {
	...
	public CREDITED_TO(Patient patient) {
	...
	public CREDITED_TO(PawnShop pawnShop) {
	...
	public CREDITED_TO(Pediatric pediatric) {
	...
	public CREDITED_TO(PerformingGroup performingGroup) {
	...
	public CREDITED_TO(Person person) {
	...
	public CREDITED_TO(PetStore petStore) {
	...
	public CREDITED_TO(Pharmacy pharmacy) {
	...
	public CREDITED_TO(Physician physician) {
	...
	public CREDITED_TO(Physiotherapy physiotherapy) {
	...
	public CREDITED_TO(PlasticSurgery plasticSurgery) {
	...
	public CREDITED_TO(Plumber plumber) {
	...
	public CREDITED_TO(Podiatric podiatric) {
	...
	public CREDITED_TO(PoliceStation policeStation) {
	...
	public CREDITED_TO(PostOffice postOffice) {
	...
	public CREDITED_TO(Preschool preschool) {
	...
	public CREDITED_TO(PrimaryCare primaryCare) {
	...
	public CREDITED_TO(ProfessionalService professionalService) {
	...
	public CREDITED_TO(Project project) {
	...
	public CREDITED_TO(Psychiatric psychiatric) {
	...
	public CREDITED_TO(PublicHealth publicHealth) {
	...
	public CREDITED_TO(PublicSwimmingPool publicSwimmingPool) {
	...
	public CREDITED_TO(RadioStation radioStation) {
	...
	public CREDITED_TO(RealEstateAgent realEstateAgent) {
	...
	public CREDITED_TO(RecyclingCenter recyclingCenter) {
	...
	public CREDITED_TO(ResearchProject researchProject) {
	...
	public CREDITED_TO(Resort resort) {
	...
	public CREDITED_TO(Restaurant restaurant) {
	...
	public CREDITED_TO(RoofingContractor roofingContractor) {
	...
	public CREDITED_TO(School school) {
	...
	public CREDITED_TO(SelfStorage selfStorage) {
	...
	public CREDITED_TO(ShoeStore shoeStore) {
	...
	public CREDITED_TO(ShoppingCenter shoppingCenter) {
	...
	public CREDITED_TO(SkiResort skiResort) {
	...
	public CREDITED_TO(SportingGoodsStore sportingGoodsStore) {
	...
	public CREDITED_TO(SportsActivityLocation sportsActivityLocation) {
	...
	public CREDITED_TO(SportsClub sportsClub) {
	...
	public CREDITED_TO(SportsOrganization sportsOrganization) {
	...
	public CREDITED_TO(SportsTeam sportsTeam) {
	...
	public CREDITED_TO(StadiumOrArena stadiumOrArena) {
	...
	public CREDITED_TO(Store store) {
	...
	public CREDITED_TO(TattooParlor tattooParlor) {
	...
	public CREDITED_TO(TelevisionStation televisionStation) {
	...
	public CREDITED_TO(TennisComplex tennisComplex) {
	...
	public CREDITED_TO(TheaterGroup theaterGroup) {
	...
	public CREDITED_TO(TireShop tireShop) {
	...
	public CREDITED_TO(TouristInformationCenter touristInformationCenter) {
	...
	public CREDITED_TO(ToyStore toyStore) {
	...
	public CREDITED_TO(TravelAgency travelAgency) {
	...
	public CREDITED_TO(VeterinaryCare veterinaryCare) {
	...
	public CREDITED_TO(WholesaleStore wholesaleStore) {
	...
	public CREDITED_TO(Winery winery) {
	...
	public CREDITED_TO(WorkersUnion workersUnion) {
	...
	public void copy(Container.CreditedTo org) {
