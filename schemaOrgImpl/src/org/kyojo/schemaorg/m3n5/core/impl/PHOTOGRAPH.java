...
public class PHOTOGRAPH implements Clazz.Photograph {
	...
	public PHOTOGRAPH(Long seq) {
		setSeq(seq);
	}

	public PHOTOGRAPH(String string) {
	...
	public PHOTOGRAPH(AccessMode accessMode) {
	...
	public PHOTOGRAPH(AccessModeSufficient accessModeSufficient) {
	...
	public PHOTOGRAPH(AccessibilityAPI accessibilityAPI) {
	...
	public PHOTOGRAPH(AccessibilityControl accessibilityControl) {
	...
	public PHOTOGRAPH(AccessibilityFeature accessibilityFeature) {
	...
	public PHOTOGRAPH(AccessibilityHazard accessibilityHazard) {
	...
	public PHOTOGRAPH(AccessibilitySummary accessibilitySummary) {
	...
	public PHOTOGRAPH(AccountablePerson accountablePerson) {
	...
	public PHOTOGRAPH(AdditionalType additionalType) {
	...
	public PHOTOGRAPH(AggregateRating aggregateRating) {
	...
	public PHOTOGRAPH(AlternateName alternateName) {
	...
	public PHOTOGRAPH(AlternativeHeadline alternativeHeadline) {
	...
	public PHOTOGRAPH(AssociatedMedia associatedMedia) {
	...
	public PHOTOGRAPH(Audience audience) {
	...
	public PHOTOGRAPH(Author author) {
		setAuthor(author);
	}
	...
	public PHOTOGRAPH(Character character) {
	...
	public PHOTOGRAPH(Citation citation) {
	...
	public PHOTOGRAPH(Comment comment) {
		setComment(comment);
	}
	...
	public PHOTOGRAPH(CommentCount commentCount) {
	...
	public PHOTOGRAPH(ContentLocation contentLocation) {
	...
	public PHOTOGRAPH(ContentRating contentRating) {
	...
	public PHOTOGRAPH(ContentReferenceTime contentReferenceTime) {
	...
	public PHOTOGRAPH(Contributor contributor) {
	...
	public PHOTOGRAPH(CopyrightHolder copyrightHolder) {
	...
	public PHOTOGRAPH(CopyrightYear copyrightYear) {
	...
	public PHOTOGRAPH(Correction correction) {
	...
	public PHOTOGRAPH(Creator creator) {
		setCreator(creator);
	}
	...
	public PHOTOGRAPH(DateCreated dateCreated) {
	...
	public PHOTOGRAPH(DateModified dateModified) {
	...
	public PHOTOGRAPH(DatePublished datePublished) {
	...
	public PHOTOGRAPH(Description description) {
	...
	public PHOTOGRAPH(DisambiguatingDescription disambiguatingDescription) {
	...
	public PHOTOGRAPH(DiscussionUrl discussionUrl) {
	...
	public PHOTOGRAPH(Editor editor) {
		setEditor(editor);
	}
	...
	public PHOTOGRAPH(EducationalAlignment educationalAlignment) {
	...
	public PHOTOGRAPH(EducationalUse educationalUse) {
	...
	public PHOTOGRAPH(Encoding encoding) {
	...
	public PHOTOGRAPH(EncodingFormat encodingFormat) {
	...
	public PHOTOGRAPH(ExampleOfWork exampleOfWork) {
	...
	public PHOTOGRAPH(Expires expires) {
		setExpires(expires);
	}
	...
	public PHOTOGRAPH(Funder funder) {
		setFunder(funder);
	}
	...
	public PHOTOGRAPH(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public PHOTOGRAPH(Headline headline) {
	...
	public PHOTOGRAPH(Identifier identifier) {
	...
	public PHOTOGRAPH(InLanguage inLanguage) {
	...
	public PHOTOGRAPH(InteractionStatistic interactionStatistic) {
	...
	public PHOTOGRAPH(InteractivityType interactivityType) {
	...
	public PHOTOGRAPH(IsAccessibleForFree isAccessibleForFree) {
	...
	public PHOTOGRAPH(IsBasedOn isBasedOn) {
	...
	public PHOTOGRAPH(IsFamilyFriendly isFamilyFriendly) {
	...
	public PHOTOGRAPH(IsPartOf isPartOf) {
	...
	public PHOTOGRAPH(Keywords keywords) {
	...
	public PHOTOGRAPH(LearningResourceType learningResourceType) {
	...
	public PHOTOGRAPH(License license) {
		setLicense(license);
	}
	...
	public PHOTOGRAPH(LocationCreated locationCreated) {
	...
	public PHOTOGRAPH(MainEntity mainEntity) {
	...
	public PHOTOGRAPH(MainEntityOfPage mainEntityOfPage) {
	...
	public PHOTOGRAPH(Material material) {
	...
	public PHOTOGRAPH(MaterialExtent materialExtent) {
	...
	public PHOTOGRAPH(Mentions mentions) {
	...
	public PHOTOGRAPH(NameFuzzy nameFuzzy) {
	...
	public PHOTOGRAPH(NameRuby nameRuby) {
	...
	public PHOTOGRAPH(Offers offers) {
		setOffers(offers);
	}
	...
	public PHOTOGRAPH(Position position) {
	...
	public PHOTOGRAPH(PotentialAction potentialAction) {
	...
	public PHOTOGRAPH(Producer producer) {
	...
	public PHOTOGRAPH(Provider provider) {
	...
	public PHOTOGRAPH(Publication publication) {
	...
	public PHOTOGRAPH(Publisher publisher) {
	...
	public PHOTOGRAPH(PublisherImprint publisherImprint) {
	...
	public PHOTOGRAPH(PublishingPrinciples publishingPrinciples) {
	...
	public PHOTOGRAPH(RecordedAt recordedAt) {
	...
	public PHOTOGRAPH(ReleasedEvent releasedEvent) {
	...
	public PHOTOGRAPH(Review review) {
		setReview(review);
	}
	...
	public PHOTOGRAPH(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PHOTOGRAPH(SchemaVersion schemaVersion) {
	...
	public PHOTOGRAPH(SdDatePublished sdDatePublished) {
	...
	public PHOTOGRAPH(SdLicense sdLicense) {
	...
	public PHOTOGRAPH(SdPublisher sdPublisher) {
	...
	public PHOTOGRAPH(SourceOrganization sourceOrganization) {
	...
	public PHOTOGRAPH(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public PHOTOGRAPH(SpatialCoverage spatialCoverage) {
	...
	public PHOTOGRAPH(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public PHOTOGRAPH(SubjectOf subjectOf) {
	...
	public PHOTOGRAPH(Temporal temporal) {
	...
	public PHOTOGRAPH(TemporalCoverage temporalCoverage) {
	...
	public PHOTOGRAPH(ThumbnailUrl thumbnailUrl) {
	...
	public PHOTOGRAPH(TimeRequired timeRequired) {
	...
	public PHOTOGRAPH(TranslationOfWork translationOfWork) {
	...
	public PHOTOGRAPH(Translator translator) {
	...
	public PHOTOGRAPH(TypicalAgeRange typicalAgeRange) {
	...
	public PHOTOGRAPH(Version version) {
		setVersion(version);
	}
	...
	public PHOTOGRAPH(WorkExample workExample) {
	...
	public PHOTOGRAPH(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Photograph org) {
		setSeq(org.getSeq());
