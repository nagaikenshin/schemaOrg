...
public class TOY_STORE implements Clazz.ToyStore {
	...
	public TOY_STORE(GeoContains geoContains) {
	...
	public TOY_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public TOY_STORE(GeoCovers geoCovers) {
	...
	public TOY_STORE(GeoCrosses geoCrosses) {
	...
	public TOY_STORE(GeoDisjoint geoDisjoint) {
	...
	public TOY_STORE(GeoEquals geoEquals) {
	...
	public TOY_STORE(GeoIntersects geoIntersects) {
	...
	public TOY_STORE(GeoOverlaps geoOverlaps) {
	...
	public TOY_STORE(GeoTouches geoTouches) {
	...
	public TOY_STORE(GeoWithin geoWithin) {
	...
	public TOY_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
