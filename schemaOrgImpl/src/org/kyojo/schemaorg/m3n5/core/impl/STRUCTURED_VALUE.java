...
public class STRUCTURED_VALUE implements Clazz.StructuredValue {
	...
	public STRUCTURED_VALUE(Long seq) {
		setSeq(seq);
	}

	public STRUCTURED_VALUE(String string) {
	...
	public STRUCTURED_VALUE(AdditionalType additionalType) {
	...
	public STRUCTURED_VALUE(AlternateName alternateName) {
	...
	public STRUCTURED_VALUE(Description description) {
	...
	public STRUCTURED_VALUE(DisambiguatingDescription disambiguatingDescription) {
	...
	public STRUCTURED_VALUE(Identifier identifier) {
	...
	public STRUCTURED_VALUE(Image image) {
		setImage(image);
	}
	...
	public STRUCTURED_VALUE(MainEntityOfPage mainEntityOfPage) {
	...
	public STRUCTURED_VALUE(Name name) {
		setName(name);
	}
	...
	public STRUCTURED_VALUE(NameFuzzy nameFuzzy) {
	...
	public STRUCTURED_VALUE(NameRuby nameRuby) {
	...
	public STRUCTURED_VALUE(PotentialAction potentialAction) {
	...
	public STRUCTURED_VALUE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public STRUCTURED_VALUE(SubjectOf subjectOf) {
	...
	public STRUCTURED_VALUE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.StructuredValue org) {
		setSeq(org.getSeq());
