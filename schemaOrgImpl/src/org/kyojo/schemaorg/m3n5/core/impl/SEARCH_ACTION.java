...
import org.kyojo.schemaorg.m3n5.core.Container.Query;
...
public class SEARCH_ACTION implements Clazz.SearchAction {
	...
	public SEARCH_ACTION(Long seq) {
		setSeq(seq);
	}

	public SEARCH_ACTION(String string) {
	...
	public SEARCH_ACTION(ActionStatus actionStatus) {
	...
	public SEARCH_ACTION(AdditionalType additionalType) {
	...
	public SEARCH_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public SEARCH_ACTION(AlternateName alternateName) {
	...
	public SEARCH_ACTION(Description description) {
	...
	public SEARCH_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public SEARCH_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public SEARCH_ACTION(Error error) {
		setError(error);
	}
	...
	public SEARCH_ACTION(Identifier identifier) {
	...
	public SEARCH_ACTION(Image image) {
		setImage(image);
	}
	...
	public SEARCH_ACTION(Instrument instrument) {
	...
	public SEARCH_ACTION(Location location) {
	...
	public SEARCH_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public SEARCH_ACTION(Name name) {
		setName(name);
	}
	...
	public SEARCH_ACTION(NameFuzzy nameFuzzy) {
	...
	public SEARCH_ACTION(NameRuby nameRuby) {
	...
	public SEARCH_ACTION(Object object) {
		setObject(object);
	}
	...
	public SEARCH_ACTION(Participant participant) {
	...
	public SEARCH_ACTION(PotentialAction potentialAction) {
	...
	public SEARCH_ACTION(Query query) {
		setQuery(query);
	}
	...
	public SEARCH_ACTION(Result result) {
		setResult(result);
	}
	...
	public SEARCH_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SEARCH_ACTION(StartTime startTime) {
	...
	public SEARCH_ACTION(SubjectOf subjectOf) {
	...
	public SEARCH_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.SearchAction org) {
		setSeq(org.getSeq());
