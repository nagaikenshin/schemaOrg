...
public class NUMBER implements DataType.Number {
	...
	public NUMBER(Long seq) {
		setSeq(seq);
	}

	public NUMBER(java.math.BigDecimal number) {
		setNumber(number);
	}
	...
	public void copy(DataType.Number org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return DataType.Number.class.getAnnotation(SampleValue.class).value();
	}
