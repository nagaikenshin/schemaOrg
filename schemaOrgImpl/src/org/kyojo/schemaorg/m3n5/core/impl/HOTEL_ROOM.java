...
import org.kyojo.schemaorg.m3n5.core.Container.Bed;
...
public class HOTEL_ROOM implements Clazz.HotelRoom {
	...
	public HOTEL_ROOM(GeoContains geoContains) {
	...
	public HOTEL_ROOM(GeoCoveredBy geoCoveredBy) {
	...
	public HOTEL_ROOM(GeoCovers geoCovers) {
	...
	public HOTEL_ROOM(GeoCrosses geoCrosses) {
	...
	public HOTEL_ROOM(GeoDisjoint geoDisjoint) {
	...
	public HOTEL_ROOM(GeoEquals geoEquals) {
	...
	public HOTEL_ROOM(GeoIntersects geoIntersects) {
	...
	public HOTEL_ROOM(GeoOverlaps geoOverlaps) {
	...
	public HOTEL_ROOM(GeoTouches geoTouches) {
	...
	public HOTEL_ROOM(GeoWithin geoWithin) {
	...
	public HOTEL_ROOM(Slogan slogan) {
		setSlogan(slogan);
	}
