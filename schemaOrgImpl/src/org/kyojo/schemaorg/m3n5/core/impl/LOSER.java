...
public class LOSER implements Container.Loser {
	...
	public LOSER(AccountingService accountingService) {
	...
	public LOSER(AdultEntertainment adultEntertainment) {
	...
	public LOSER(AmusementPark amusementPark) {
	...
	public LOSER(AnimalShelter animalShelter) {
	...
	public LOSER(ArchiveOrganization archiveOrganization) {
	...
	public LOSER(ArtGallery artGallery) {
	...
	public LOSER(Attorney attorney) {
	...
	public LOSER(AutoBodyShop autoBodyShop) {
	...
	public LOSER(AutoDealer autoDealer) {
	...
	public LOSER(AutoPartsStore autoPartsStore) {
	...
	public LOSER(AutoRental autoRental) {
	...
	public LOSER(AutoRepair autoRepair) {
	...
	public LOSER(AutoWash autoWash) {
	...
	public LOSER(AutomatedTeller automatedTeller) {
	...
	public LOSER(AutomotiveBusiness automotiveBusiness) {
	...
	public LOSER(BankOrCreditUnion bankOrCreditUnion) {
	...
	public LOSER(BarOrPub barOrPub) {
	...
	public LOSER(BeautySalon beautySalon) {
	...
	public LOSER(BedAndBreakfast bedAndBreakfast) {
	...
	public LOSER(BikeStore bikeStore) {
	...
	public LOSER(BookStore bookStore) {
	...
	public LOSER(BowlingAlley bowlingAlley) {
	...
	public LOSER(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public LOSER(Campground campground) {
	...
	public LOSER(ChildCare childCare) {
	...
	public LOSER(ClothingStore clothingStore) {
	...
	public LOSER(CollegeOrUniversity collegeOrUniversity) {
	...
	public LOSER(ComedyClub comedyClub) {
	...
	public LOSER(CommunityHealth communityHealth) {
	...
	public LOSER(ComputerStore computerStore) {
	...
	public LOSER(Consortium consortium) {
	...
	public LOSER(ConvenienceStore convenienceStore) {
	...
	public LOSER(Corporation corporation) {
	...
	public LOSER(DanceGroup danceGroup) {
	...
	public LOSER(DepartmentStore departmentStore) {
	...
	public LOSER(Dermatology dermatology) {
	...
	public LOSER(DiagnosticLab diagnosticLab) {
	...
	public LOSER(DietNutrition dietNutrition) {
	...
	public LOSER(Distillery distillery) {
	...
	public LOSER(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public LOSER(EducationalOrganization educationalOrganization) {
	...
	public LOSER(Electrician electrician) {
	...
	public LOSER(ElectronicsStore electronicsStore) {
	...
	public LOSER(ElementarySchool elementarySchool) {
	...
	public LOSER(Emergency emergency) {
	...
	public LOSER(EmergencyService emergencyService) {
	...
	public LOSER(EmploymentAgency employmentAgency) {
	...
	public LOSER(EntertainmentBusiness entertainmentBusiness) {
	...
	public LOSER(ExerciseGym exerciseGym) {
	...
	public LOSER(FastFoodRestaurant fastFoodRestaurant) {
	...
	public LOSER(FinancialService financialService) {
	...
	public LOSER(FireStation fireStation) {
	...
	public LOSER(FoodEstablishment foodEstablishment) {
	...
	public LOSER(FundingAgency fundingAgency) {
	...
	public LOSER(FundingScheme fundingScheme) {
	...
	public LOSER(FurnitureStore furnitureStore) {
	...
	public LOSER(GardenStore gardenStore) {
	...
	public LOSER(GasStation gasStation) {
	...
	public LOSER(GeneralContractor generalContractor) {
	...
	public LOSER(Geriatric geriatric) {
	...
	public LOSER(GolfCourse golfCourse) {
	...
	public LOSER(GovernmentOffice governmentOffice) {
	...
	public LOSER(GovernmentOrganization governmentOrganization) {
	...
	public LOSER(GroceryStore groceryStore) {
	...
	public LOSER(Gynecologic gynecologic) {
	...
	public LOSER(HVACBusiness hvacBusiness) {
	...
	public LOSER(HairSalon hairSalon) {
	...
	public LOSER(HardwareStore hardwareStore) {
	...
	public LOSER(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public LOSER(HealthClub healthClub) {
	...
	public LOSER(HighSchool highSchool) {
	...
	public LOSER(HobbyShop hobbyShop) {
	...
	public LOSER(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public LOSER(HomeGoodsStore homeGoodsStore) {
	...
	public LOSER(Hospital hospital) {
	...
	public LOSER(HousePainter housePainter) {
	...
	public LOSER(IceCreamShop iceCreamShop) {
	...
	public LOSER(InsuranceAgency insuranceAgency) {
	...
	public LOSER(InternetCafe internetCafe) {
	...
	public LOSER(JewelryStore jewelryStore) {
	...
	public LOSER(LegalService legalService) {
	...
	public LOSER(LibrarySystem librarySystem) {
	...
	public LOSER(LiquorStore liquorStore) {
	...
	public LOSER(LocalBusiness localBusiness) {
	...
	public LOSER(Locksmith locksmith) {
	...
	public LOSER(LodgingBusiness lodgingBusiness) {
	...
	public LOSER(MedicalBusiness medicalBusiness) {
	...
	public LOSER(MedicalClinic medicalClinic) {
	...
	public LOSER(MedicalOrganization medicalOrganization) {
	...
	public LOSER(MensClothingStore mensClothingStore) {
	...
	public LOSER(MiddleSchool middleSchool) {
	...
	public LOSER(Midwifery midwifery) {
	...
	public LOSER(MobilePhoneStore mobilePhoneStore) {
	...
	public LOSER(MotorcycleDealer motorcycleDealer) {
	...
	public LOSER(MotorcycleRepair motorcycleRepair) {
	...
	public LOSER(MovieRentalStore movieRentalStore) {
	...
	public LOSER(MovieTheater movieTheater) {
	...
	public LOSER(MovingCompany movingCompany) {
	...
	public LOSER(MusicGroup musicGroup) {
	...
	public LOSER(MusicStore musicStore) {
	...
	public LOSER(NailSalon nailSalon) {
	...
	public LOSER(NewsMediaOrganization newsMediaOrganization) {
	...
	public LOSER(NightClub nightClub) {
	...
	public LOSER(Obstetric obstetric) {
	...
	public LOSER(OfficeEquipmentStore officeEquipmentStore) {
	...
	public LOSER(Oncologic oncologic) {
	...
	public LOSER(Optician optician) {
	...
	public LOSER(Optometric optometric) {
	...
	public LOSER(Organization organization) {
	...
	public LOSER(Otolaryngologic otolaryngologic) {
	...
	public LOSER(OutletStore outletStore) {
	...
	public LOSER(PawnShop pawnShop) {
	...
	public LOSER(Pediatric pediatric) {
	...
	public LOSER(PerformingGroup performingGroup) {
	...
	public LOSER(PetStore petStore) {
	...
	public LOSER(Pharmacy pharmacy) {
	...
	public LOSER(Physician physician) {
	...
	public LOSER(Physiotherapy physiotherapy) {
	...
	public LOSER(PlasticSurgery plasticSurgery) {
	...
	public LOSER(Podiatric podiatric) {
	...
	public LOSER(PoliceStation policeStation) {
	...
	public LOSER(PostOffice postOffice) {
	...
	public LOSER(Preschool preschool) {
	...
	public LOSER(PrimaryCare primaryCare) {
	...
	public LOSER(ProfessionalService professionalService) {
	...
	public LOSER(Psychiatric psychiatric) {
	...
	public LOSER(PublicHealth publicHealth) {
	...
	public LOSER(PublicSwimmingPool publicSwimmingPool) {
	...
	public LOSER(RadioStation radioStation) {
	...
	public LOSER(RealEstateAgent realEstateAgent) {
	...
	public LOSER(RecyclingCenter recyclingCenter) {
	...
	public LOSER(ResearchProject researchProject) {
	...
	public LOSER(Restaurant restaurant) {
	...
	public LOSER(RoofingContractor roofingContractor) {
	...
	public LOSER(SelfStorage selfStorage) {
	...
	public LOSER(ShoeStore shoeStore) {
	...
	public LOSER(ShoppingCenter shoppingCenter) {
	...
	public LOSER(SkiResort skiResort) {
	...
	public LOSER(SportingGoodsStore sportingGoodsStore) {
	...
	public LOSER(SportsActivityLocation sportsActivityLocation) {
	...
	public LOSER(SportsClub sportsClub) {
	...
	public LOSER(SportsOrganization sportsOrganization) {
	...
	public LOSER(SportsTeam sportsTeam) {
	...
	public LOSER(StadiumOrArena stadiumOrArena) {
	...
	public LOSER(TattooParlor tattooParlor) {
	...
	public LOSER(TelevisionStation televisionStation) {
	...
	public LOSER(TennisComplex tennisComplex) {
	...
	public LOSER(TheaterGroup theaterGroup) {
	...
	public LOSER(TireShop tireShop) {
	...
	public LOSER(TouristInformationCenter touristInformationCenter) {
	...
	public LOSER(ToyStore toyStore) {
	...
	public LOSER(TravelAgency travelAgency) {
	...
	public LOSER(VeterinaryCare veterinaryCare) {
	...
	public LOSER(WholesaleStore wholesaleStore) {
	...
	public LOSER(WorkersUnion workersUnion) {
	...
	public void copy(Container.Loser org) {
