...
public class IS_BASED_ON implements Container.IsBasedOn {
	...
	public IS_BASED_ON(APIReference apiReference) {
	...
	public IS_BASED_ON(AboutPage aboutPage) {
	...
	public IS_BASED_ON(AdvertiserContentArticle advertiserContentArticle) {
	...
	public IS_BASED_ON(AnalysisNewsArticle analysisNewsArticle) {
	...
	public IS_BASED_ON(Answer answer) {
	...
	public IS_BASED_ON(ArchiveComponent archiveComponent) {
	...
	public IS_BASED_ON(Article article) {
	...
	public IS_BASED_ON(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public IS_BASED_ON(Atlas atlas) {
	...
	public IS_BASED_ON(AudioObject audioObject) {
	...
	public IS_BASED_ON(Audiobook audiobook) {
	...
	public IS_BASED_ON(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public IS_BASED_ON(Barcode barcode) {
	...
	public IS_BASED_ON(BlogPosting blogPosting) {
	...
	public IS_BASED_ON(BookSeries bookSeries) {
	...
	public IS_BASED_ON(BusOrCoach busOrCoach) {
	...
	public IS_BASED_ON(CategoryCodeSet categoryCodeSet) {
	...
	public IS_BASED_ON(Chapter chapter) {
	...
	public IS_BASED_ON(CheckoutPage checkoutPage) {
	...
	public IS_BASED_ON(Claim claim) {
	...
	public IS_BASED_ON(ClaimReview claimReview) {
	...
	public IS_BASED_ON(Collection collection) {
	...
	public IS_BASED_ON(CollectionPage collectionPage) {
	...
	public IS_BASED_ON(ComicCoverArt comicCoverArt) {
	...
	public IS_BASED_ON(ComicIssue comicIssue) {
	...
	public IS_BASED_ON(ComicSeries comicSeries) {
	...
	public IS_BASED_ON(ComicStory comicStory) {
	...
	public IS_BASED_ON(Comment comment) {
	...
	public IS_BASED_ON(CompleteDataFeed completeDataFeed) {
	...
	public IS_BASED_ON(ContactPage contactPage) {
	...
	public IS_BASED_ON(Conversation conversation) {
	...
	public IS_BASED_ON(CorrectionComment correctionComment) {
	...
	public IS_BASED_ON(Course course) {
	...
	public IS_BASED_ON(CoverArt coverArt) {
	...
	public IS_BASED_ON(CreativeWorkSeason creativeWorkSeason) {
	...
	public IS_BASED_ON(CreativeWorkSeries creativeWorkSeries) {
	...
	public IS_BASED_ON(CriticReview criticReview) {
	...
	public IS_BASED_ON(DataCatalog dataCatalog) {
	...
	public IS_BASED_ON(DataDownload dataDownload) {
	...
	public IS_BASED_ON(DataFeed dataFeed) {
	...
	public IS_BASED_ON(Dataset dataset) {
	...
	public IS_BASED_ON(DefinedTermSet definedTermSet) {
	...
	public IS_BASED_ON(DigitalDocument digitalDocument) {
	...
	public IS_BASED_ON(DiscussionForumPosting discussionForumPosting) {
	...
	public IS_BASED_ON(Drawing drawing) {
	...
	public IS_BASED_ON(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public IS_BASED_ON(EmailMessage emailMessage) {
	...
	public IS_BASED_ON(EmployerReview employerReview) {
	...
	public IS_BASED_ON(Episode episode) {
	...
	public IS_BASED_ON(ExercisePlan exercisePlan) {
	...
	public IS_BASED_ON(FAQPage faqPage) {
	...
	public IS_BASED_ON(HowTo howTo) {
	...
	public IS_BASED_ON(HowToDirection howToDirection) {
	...
	public IS_BASED_ON(HowToSection howToSection) {
	...
	public IS_BASED_ON(HowToStep howToStep) {
	...
	public IS_BASED_ON(HowToTip howToTip) {
	...
	public IS_BASED_ON(ImageGallery imageGallery) {
	...
	public IS_BASED_ON(ImageObject imageObject) {
	...
	public IS_BASED_ON(IndividualProduct individualProduct) {
	...
	public IS_BASED_ON(ItemPage itemPage) {
	...
	public IS_BASED_ON(Legislation legislation) {
	...
	public IS_BASED_ON(LegislationObject legislationObject) {
	...
	public IS_BASED_ON(LiveBlogPosting liveBlogPosting) {
	...
	public IS_BASED_ON(Manuscript manuscript) {
	...
	public IS_BASED_ON(MediaObject mediaObject) {
	...
	public IS_BASED_ON(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public IS_BASED_ON(MedicalWebPage medicalWebPage) {
	...
	public IS_BASED_ON(MenuSection menuSection) {
	...
	public IS_BASED_ON(Message message) {
	...
	public IS_BASED_ON(MobileApplication mobileApplication) {
	...
	public IS_BASED_ON(Motorcycle motorcycle) {
	...
	public IS_BASED_ON(MotorizedBicycle motorizedBicycle) {
	...
	public IS_BASED_ON(Movie movie) {
	...
	public IS_BASED_ON(MovieClip movieClip) {
	...
	public IS_BASED_ON(MovieSeries movieSeries) {
	...
	public IS_BASED_ON(MusicAlbum musicAlbum) {
	...
	public IS_BASED_ON(MusicComposition musicComposition) {
	...
	public IS_BASED_ON(MusicPlaylist musicPlaylist) {
	...
	public IS_BASED_ON(MusicRecording musicRecording) {
	...
	public IS_BASED_ON(MusicRelease musicRelease) {
	...
	public IS_BASED_ON(MusicVideoObject musicVideoObject) {
	...
	public IS_BASED_ON(NewsArticle newsArticle) {
	...
	public IS_BASED_ON(Newspaper newspaper) {
	...
	public IS_BASED_ON(NoteDigitalDocument noteDigitalDocument) {
	...
	public IS_BASED_ON(OpinionNewsArticle opinionNewsArticle) {
	...
	public IS_BASED_ON(Painting painting) {
	...
	public IS_BASED_ON(Periodical periodical) {
	...
	public IS_BASED_ON(Photograph photograph) {
	...
	public IS_BASED_ON(Poster poster) {
	...
	public IS_BASED_ON(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public IS_BASED_ON(ProductModel productModel) {
	...
	public IS_BASED_ON(ProfilePage profilePage) {
	...
	public IS_BASED_ON(PublicationIssue publicationIssue) {
	...
	public IS_BASED_ON(PublicationVolume publicationVolume) {
	...
	public IS_BASED_ON(QAPage qaPage) {
	...
	public IS_BASED_ON(Question question) {
	...
	public IS_BASED_ON(Quotation quotation) {
	...
	public IS_BASED_ON(RadioClip radioClip) {
	...
	public IS_BASED_ON(RadioEpisode radioEpisode) {
	...
	public IS_BASED_ON(RadioSeason radioSeason) {
	...
	public IS_BASED_ON(RadioSeries radioSeries) {
	...
	public IS_BASED_ON(Recipe recipe) {
	...
	public IS_BASED_ON(Report report) {
	...
	public IS_BASED_ON(ReportageNewsArticle reportageNewsArticle) {
	...
	public IS_BASED_ON(Review review) {
	...
	public IS_BASED_ON(ReviewNewsArticle reviewNewsArticle) {
	...
	public IS_BASED_ON(SatiricalArticle satiricalArticle) {
	...
	public IS_BASED_ON(ScholarlyArticle scholarlyArticle) {
	...
	public IS_BASED_ON(Sculpture sculpture) {
	...
	public IS_BASED_ON(SearchResultsPage searchResultsPage) {
	...
	public IS_BASED_ON(SheetMusic sheetMusic) {
	...
	public IS_BASED_ON(ShortStory shortStory) {
	...
	public IS_BASED_ON(SiteNavigationElement siteNavigationElement) {
	...
	public IS_BASED_ON(SocialMediaPosting socialMediaPosting) {
	...
	public IS_BASED_ON(SoftwareApplication softwareApplication) {
	...
	public IS_BASED_ON(SoftwareSourceCode softwareSourceCode) {
	...
	public IS_BASED_ON(SomeProducts someProducts) {
	...
	public IS_BASED_ON(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public IS_BASED_ON(TVClip tvClip) {
	...
	public IS_BASED_ON(TVEpisode tvEpisode) {
	...
	public IS_BASED_ON(TVSeason tvSeason) {
	...
	public IS_BASED_ON(TVSeries tvSeries) {
	...
	public IS_BASED_ON(Table table) {
	...
	public IS_BASED_ON(TechArticle techArticle) {
	...
	public IS_BASED_ON(TextDigitalDocument textDigitalDocument) {
	...
	public IS_BASED_ON(Thesis thesis) {
	...
	public IS_BASED_ON(ThreeDimensionalModel threeDimensionalModel) {
	...
	public IS_BASED_ON(UserReview userReview) {
	...
	public IS_BASED_ON(Vehicle vehicle) {
	...
	public IS_BASED_ON(VideoGallery videoGallery) {
	...
	public IS_BASED_ON(VideoGame videoGame) {
	...
	public IS_BASED_ON(VideoGameClip videoGameClip) {
	...
	public IS_BASED_ON(VideoGameSeries videoGameSeries) {
	...
	public IS_BASED_ON(VideoObject videoObject) {
	...
	public IS_BASED_ON(VisualArtwork visualArtwork) {
	...
	public IS_BASED_ON(WPAdBlock wpAdBlock) {
	...
	public IS_BASED_ON(WPFooter wpFooter) {
	...
	public IS_BASED_ON(WPHeader wpHeader) {
	...
	public IS_BASED_ON(WPSideBar wpSideBar) {
	...
	public IS_BASED_ON(WebApplication webApplication) {
	...
	public IS_BASED_ON(WebPage webPage) {
	...
	public IS_BASED_ON(WebPageElement webPageElement) {
	...
	public IS_BASED_ON(WebSite webSite) {
