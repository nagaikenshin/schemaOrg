...
public class MENS_CLOTHING_STORE implements Clazz.MensClothingStore {
	...
	public MENS_CLOTHING_STORE(GeoContains geoContains) {
	...
	public MENS_CLOTHING_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public MENS_CLOTHING_STORE(GeoCovers geoCovers) {
	...
	public MENS_CLOTHING_STORE(GeoCrosses geoCrosses) {
	...
	public MENS_CLOTHING_STORE(GeoDisjoint geoDisjoint) {
	...
	public MENS_CLOTHING_STORE(GeoEquals geoEquals) {
	...
	public MENS_CLOTHING_STORE(GeoIntersects geoIntersects) {
	...
	public MENS_CLOTHING_STORE(GeoOverlaps geoOverlaps) {
	...
	public MENS_CLOTHING_STORE(GeoTouches geoTouches) {
	...
	public MENS_CLOTHING_STORE(GeoWithin geoWithin) {
	...
	public MENS_CLOTHING_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
