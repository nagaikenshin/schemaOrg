...
public class RADIO_STATION implements Clazz.RadioStation {
	...
	public RADIO_STATION(GeoContains geoContains) {
	...
	public RADIO_STATION(GeoCoveredBy geoCoveredBy) {
	...
	public RADIO_STATION(GeoCovers geoCovers) {
	...
	public RADIO_STATION(GeoCrosses geoCrosses) {
	...
	public RADIO_STATION(GeoDisjoint geoDisjoint) {
	...
	public RADIO_STATION(GeoEquals geoEquals) {
	...
	public RADIO_STATION(GeoIntersects geoIntersects) {
	...
	public RADIO_STATION(GeoOverlaps geoOverlaps) {
	...
	public RADIO_STATION(GeoTouches geoTouches) {
	...
	public RADIO_STATION(GeoWithin geoWithin) {
	...
	public RADIO_STATION(Slogan slogan) {
		setSlogan(slogan);
	}
