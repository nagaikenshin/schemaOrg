...
public class TAXI_RESERVATION implements Clazz.TaxiReservation {
	...
	public TAXI_RESERVATION() {
	}

	public TAXI_RESERVATION(Long seq) {
		setSeq(seq);
	}

	public TAXI_RESERVATION(String string) {
	...
	public TAXI_RESERVATION(AdditionalType additionalType) {
	...
	public TAXI_RESERVATION(AlternateName alternateName) {
	...
	public TAXI_RESERVATION(BookingTime bookingTime) {
	...
	public TAXI_RESERVATION(Broker broker) {
		setBroker(broker);
	}
	...
	public TAXI_RESERVATION(Description description) {
	...
	public TAXI_RESERVATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public TAXI_RESERVATION(Identifier identifier) {
	...
	public TAXI_RESERVATION(Image image) {
		setImage(image);
	}
	...
	public TAXI_RESERVATION(MainEntityOfPage mainEntityOfPage) {
	...
	public TAXI_RESERVATION(ModifiedTime modifiedTime) {
	...
	public TAXI_RESERVATION(Name name) {
		setName(name);
	}
	...
	public TAXI_RESERVATION(NameFuzzy nameFuzzy) {
	...
	public TAXI_RESERVATION(NameRuby nameRuby) {
	...
	public TAXI_RESERVATION(PartySize partySize) {
	...
	public TAXI_RESERVATION(PickupLocation pickupLocation) {
	...
	public TAXI_RESERVATION(PickupTime pickupTime) {
	...
	public TAXI_RESERVATION(PotentialAction potentialAction) {
	...
	public TAXI_RESERVATION(PriceCurrency priceCurrency) {
	...
	public TAXI_RESERVATION(ProgramMembershipUsed programMembershipUsed) {
	...
	public TAXI_RESERVATION(Provider provider) {
	...
	public TAXI_RESERVATION(ReservationFor reservationFor) {
	...
	public TAXI_RESERVATION(ReservationId reservationId) {
	...
	public TAXI_RESERVATION(ReservationStatus reservationStatus) {
	...
	public TAXI_RESERVATION(ReservedTicket reservedTicket) {
	...
	public TAXI_RESERVATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TAXI_RESERVATION(SubjectOf subjectOf) {
	...
	public TAXI_RESERVATION(TotalPrice totalPrice) {
	...
	public TAXI_RESERVATION(UnderName underName) {
	...
	public TAXI_RESERVATION(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.TaxiReservation org) {
		setSeq(org.getSeq());
