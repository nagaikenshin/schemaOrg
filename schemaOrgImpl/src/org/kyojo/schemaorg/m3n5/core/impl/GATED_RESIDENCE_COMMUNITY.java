...
public class GATED_RESIDENCE_COMMUNITY implements Clazz.GatedResidenceCommunity {
	...
	public GATED_RESIDENCE_COMMUNITY(GeoContains geoContains) {
	...
	public GATED_RESIDENCE_COMMUNITY(GeoCoveredBy geoCoveredBy) {
	...
	public GATED_RESIDENCE_COMMUNITY(GeoCovers geoCovers) {
	...
	public GATED_RESIDENCE_COMMUNITY(GeoCrosses geoCrosses) {
	...
	public GATED_RESIDENCE_COMMUNITY(GeoDisjoint geoDisjoint) {
	...
	public GATED_RESIDENCE_COMMUNITY(GeoEquals geoEquals) {
	...
	public GATED_RESIDENCE_COMMUNITY(GeoIntersects geoIntersects) {
	...
	public GATED_RESIDENCE_COMMUNITY(GeoOverlaps geoOverlaps) {
	...
	public GATED_RESIDENCE_COMMUNITY(GeoTouches geoTouches) {
	...
	public GATED_RESIDENCE_COMMUNITY(GeoWithin geoWithin) {
	...
	public GATED_RESIDENCE_COMMUNITY(Slogan slogan) {
		setSlogan(slogan);
	}
