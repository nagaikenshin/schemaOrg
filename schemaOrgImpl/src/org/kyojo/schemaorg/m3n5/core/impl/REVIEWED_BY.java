...
public class REVIEWED_BY implements Container.ReviewedBy {
	...
	public REVIEWED_BY(String string) {
	...
	public REVIEWED_BY(AccountingService accountingService) {
	...
	public REVIEWED_BY(AdultEntertainment adultEntertainment) {
	...
	public REVIEWED_BY(Airline airline) {
	...
	public REVIEWED_BY(AmusementPark amusementPark) {
	...
	public REVIEWED_BY(AnimalShelter animalShelter) {
	...
	public REVIEWED_BY(ArchiveOrganization archiveOrganization) {
	...
	public REVIEWED_BY(ArtGallery artGallery) {
	...
	public REVIEWED_BY(Attorney attorney) {
	...
	public REVIEWED_BY(AutoBodyShop autoBodyShop) {
	...
	public REVIEWED_BY(AutoDealer autoDealer) {
	...
	public REVIEWED_BY(AutoPartsStore autoPartsStore) {
	...
	public REVIEWED_BY(AutoRental autoRental) {
	...
	public REVIEWED_BY(AutoRepair autoRepair) {
	...
	public REVIEWED_BY(AutoWash autoWash) {
	...
	public REVIEWED_BY(AutomatedTeller automatedTeller) {
	...
	public REVIEWED_BY(AutomotiveBusiness automotiveBusiness) {
	...
	public REVIEWED_BY(Bakery bakery) {
	...
	public REVIEWED_BY(BankOrCreditUnion bankOrCreditUnion) {
	...
	public REVIEWED_BY(BarOrPub barOrPub) {
	...
	public REVIEWED_BY(BeautySalon beautySalon) {
	...
	public REVIEWED_BY(BedAndBreakfast bedAndBreakfast) {
	...
	public REVIEWED_BY(BikeStore bikeStore) {
	...
	public REVIEWED_BY(BookStore bookStore) {
	...
	public REVIEWED_BY(BowlingAlley bowlingAlley) {
	...
	public REVIEWED_BY(Brewery brewery) {
	...
	public REVIEWED_BY(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public REVIEWED_BY(Campground campground) {
	...
	public REVIEWED_BY(Casino casino) {
	...
	public REVIEWED_BY(ChildCare childCare) {
	...
	public REVIEWED_BY(ClothingStore clothingStore) {
	...
	public REVIEWED_BY(CollegeOrUniversity collegeOrUniversity) {
	...
	public REVIEWED_BY(ComedyClub comedyClub) {
	...
	public REVIEWED_BY(CommunityHealth communityHealth) {
	...
	public REVIEWED_BY(ComputerStore computerStore) {
	...
	public REVIEWED_BY(Consortium consortium) {
	...
	public REVIEWED_BY(ConvenienceStore convenienceStore) {
	...
	public REVIEWED_BY(Corporation corporation) {
	...
	public REVIEWED_BY(DanceGroup danceGroup) {
	...
	public REVIEWED_BY(DaySpa daySpa) {
	...
	public REVIEWED_BY(Dentist dentist) {
	...
	public REVIEWED_BY(DepartmentStore departmentStore) {
	...
	public REVIEWED_BY(Dermatology dermatology) {
	...
	public REVIEWED_BY(DiagnosticLab diagnosticLab) {
	...
	public REVIEWED_BY(DietNutrition dietNutrition) {
	...
	public REVIEWED_BY(Distillery distillery) {
	...
	public REVIEWED_BY(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public REVIEWED_BY(EducationalOrganization educationalOrganization) {
	...
	public REVIEWED_BY(Electrician electrician) {
	...
	public REVIEWED_BY(ElectronicsStore electronicsStore) {
	...
	public REVIEWED_BY(ElementarySchool elementarySchool) {
	...
	public REVIEWED_BY(Emergency emergency) {
	...
	public REVIEWED_BY(EmergencyService emergencyService) {
	...
	public REVIEWED_BY(EmploymentAgency employmentAgency) {
	...
	public REVIEWED_BY(EntertainmentBusiness entertainmentBusiness) {
	...
	public REVIEWED_BY(ExerciseGym exerciseGym) {
	...
	public REVIEWED_BY(FastFoodRestaurant fastFoodRestaurant) {
	...
	public REVIEWED_BY(FinancialService financialService) {
	...
	public REVIEWED_BY(FireStation fireStation) {
	...
	public REVIEWED_BY(Florist florist) {
	...
	public REVIEWED_BY(FoodEstablishment foodEstablishment) {
	...
	public REVIEWED_BY(FundingAgency fundingAgency) {
	...
	public REVIEWED_BY(FundingScheme fundingScheme) {
	...
	public REVIEWED_BY(FurnitureStore furnitureStore) {
	...
	public REVIEWED_BY(GardenStore gardenStore) {
	...
	public REVIEWED_BY(GasStation gasStation) {
	...
	public REVIEWED_BY(GeneralContractor generalContractor) {
	...
	public REVIEWED_BY(Geriatric geriatric) {
	...
	public REVIEWED_BY(GolfCourse golfCourse) {
	...
	public REVIEWED_BY(GovernmentOffice governmentOffice) {
	...
	public REVIEWED_BY(GovernmentOrganization governmentOrganization) {
	...
	public REVIEWED_BY(GroceryStore groceryStore) {
	...
	public REVIEWED_BY(Gynecologic gynecologic) {
	...
	public REVIEWED_BY(HVACBusiness hvacBusiness) {
	...
	public REVIEWED_BY(HairSalon hairSalon) {
	...
	public REVIEWED_BY(HardwareStore hardwareStore) {
	...
	public REVIEWED_BY(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public REVIEWED_BY(HealthClub healthClub) {
	...
	public REVIEWED_BY(HighSchool highSchool) {
	...
	public REVIEWED_BY(HobbyShop hobbyShop) {
	...
	public REVIEWED_BY(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public REVIEWED_BY(HomeGoodsStore homeGoodsStore) {
	...
	public REVIEWED_BY(Hospital hospital) {
	...
	public REVIEWED_BY(Hostel hostel) {
	...
	public REVIEWED_BY(Hotel hotel) {
	...
	public REVIEWED_BY(HousePainter housePainter) {
	...
	public REVIEWED_BY(IceCreamShop iceCreamShop) {
	...
	public REVIEWED_BY(InsuranceAgency insuranceAgency) {
	...
	public REVIEWED_BY(InternetCafe internetCafe) {
	...
	public REVIEWED_BY(JewelryStore jewelryStore) {
	...
	public REVIEWED_BY(LegalService legalService) {
	...
	public REVIEWED_BY(Library library) {
	...
	public REVIEWED_BY(LibrarySystem librarySystem) {
	...
	public REVIEWED_BY(LiquorStore liquorStore) {
	...
	public REVIEWED_BY(LocalBusiness localBusiness) {
	...
	public REVIEWED_BY(Locksmith locksmith) {
	...
	public REVIEWED_BY(LodgingBusiness lodgingBusiness) {
	...
	public REVIEWED_BY(MedicalBusiness medicalBusiness) {
	...
	public REVIEWED_BY(MedicalClinic medicalClinic) {
	...
	public REVIEWED_BY(MedicalOrganization medicalOrganization) {
	...
	public REVIEWED_BY(MensClothingStore mensClothingStore) {
	...
	public REVIEWED_BY(MiddleSchool middleSchool) {
	...
	public REVIEWED_BY(Midwifery midwifery) {
	...
	public REVIEWED_BY(MobilePhoneStore mobilePhoneStore) {
	...
	public REVIEWED_BY(Motel motel) {
	...
	public REVIEWED_BY(MotorcycleDealer motorcycleDealer) {
	...
	public REVIEWED_BY(MotorcycleRepair motorcycleRepair) {
	...
	public REVIEWED_BY(MovieRentalStore movieRentalStore) {
	...
	public REVIEWED_BY(MovieTheater movieTheater) {
	...
	public REVIEWED_BY(MovingCompany movingCompany) {
	...
	public REVIEWED_BY(MusicGroup musicGroup) {
	...
	public REVIEWED_BY(MusicStore musicStore) {
	...
	public REVIEWED_BY(NailSalon nailSalon) {
	...
	public REVIEWED_BY(NewsMediaOrganization newsMediaOrganization) {
	...
	public REVIEWED_BY(NightClub nightClub) {
	...
	public REVIEWED_BY(Notary notary) {
	...
	public REVIEWED_BY(Nursing nursing) {
	...
	public REVIEWED_BY(Obstetric obstetric) {
	...
	public REVIEWED_BY(OfficeEquipmentStore officeEquipmentStore) {
	...
	public REVIEWED_BY(Oncologic oncologic) {
	...
	public REVIEWED_BY(Optician optician) {
	...
	public REVIEWED_BY(Optometric optometric) {
	...
	public REVIEWED_BY(Organization organization) {
		organizationList = new ArrayList<Organization>();
	...
	public REVIEWED_BY(Otolaryngologic otolaryngologic) {
	...
	public REVIEWED_BY(OutletStore outletStore) {
	...
	public REVIEWED_BY(Patient patient) {
	...
	public REVIEWED_BY(PawnShop pawnShop) {
	...
	public REVIEWED_BY(Pediatric pediatric) {
	...
	public REVIEWED_BY(PerformingGroup performingGroup) {
	...
	public REVIEWED_BY(Person person) {
	...
	public REVIEWED_BY(PetStore petStore) {
	...
	public REVIEWED_BY(Pharmacy pharmacy) {
	...
	public REVIEWED_BY(Physician physician) {
	...
	public REVIEWED_BY(Physiotherapy physiotherapy) {
	...
	public REVIEWED_BY(PlasticSurgery plasticSurgery) {
	...
	public REVIEWED_BY(Plumber plumber) {
	...
	public REVIEWED_BY(Podiatric podiatric) {
	...
	public REVIEWED_BY(PoliceStation policeStation) {
	...
	public REVIEWED_BY(PostOffice postOffice) {
	...
	public REVIEWED_BY(Preschool preschool) {
	...
	public REVIEWED_BY(PrimaryCare primaryCare) {
	...
	public REVIEWED_BY(ProfessionalService professionalService) {
	...
	public REVIEWED_BY(Project project) {
	...
	public REVIEWED_BY(Psychiatric psychiatric) {
	...
	public REVIEWED_BY(PublicHealth publicHealth) {
	...
	public REVIEWED_BY(PublicSwimmingPool publicSwimmingPool) {
	...
	public REVIEWED_BY(RadioStation radioStation) {
	...
	public REVIEWED_BY(RealEstateAgent realEstateAgent) {
	...
	public REVIEWED_BY(RecyclingCenter recyclingCenter) {
	...
	public REVIEWED_BY(ResearchProject researchProject) {
	...
	public REVIEWED_BY(Resort resort) {
	...
	public REVIEWED_BY(Restaurant restaurant) {
	...
	public REVIEWED_BY(RoofingContractor roofingContractor) {
	...
	public REVIEWED_BY(School school) {
	...
	public REVIEWED_BY(SelfStorage selfStorage) {
	...
	public REVIEWED_BY(ShoeStore shoeStore) {
	...
	public REVIEWED_BY(ShoppingCenter shoppingCenter) {
	...
	public REVIEWED_BY(SkiResort skiResort) {
	...
	public REVIEWED_BY(SportingGoodsStore sportingGoodsStore) {
	...
	public REVIEWED_BY(SportsActivityLocation sportsActivityLocation) {
	...
	public REVIEWED_BY(SportsClub sportsClub) {
	...
	public REVIEWED_BY(SportsOrganization sportsOrganization) {
	...
	public REVIEWED_BY(SportsTeam sportsTeam) {
	...
	public REVIEWED_BY(StadiumOrArena stadiumOrArena) {
	...
	public REVIEWED_BY(Store store) {
	...
	public REVIEWED_BY(TattooParlor tattooParlor) {
	...
	public REVIEWED_BY(TelevisionStation televisionStation) {
	...
	public REVIEWED_BY(TennisComplex tennisComplex) {
	...
	public REVIEWED_BY(TheaterGroup theaterGroup) {
	...
	public REVIEWED_BY(TireShop tireShop) {
	...
	public REVIEWED_BY(TouristInformationCenter touristInformationCenter) {
	...
	public REVIEWED_BY(ToyStore toyStore) {
	...
	public REVIEWED_BY(TravelAgency travelAgency) {
	...
	public REVIEWED_BY(VeterinaryCare veterinaryCare) {
	...
	public REVIEWED_BY(WholesaleStore wholesaleStore) {
	...
	public REVIEWED_BY(Winery winery) {
	...
	public REVIEWED_BY(WorkersUnion workersUnion) {
	...
	public void copy(Container.ReviewedBy org) {
