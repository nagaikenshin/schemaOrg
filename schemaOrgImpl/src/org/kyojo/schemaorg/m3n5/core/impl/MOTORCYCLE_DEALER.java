...
public class MOTORCYCLE_DEALER implements Clazz.MotorcycleDealer {
	...
	public MOTORCYCLE_DEALER(GeoContains geoContains) {
	...
	public MOTORCYCLE_DEALER(GeoCoveredBy geoCoveredBy) {
	...
	public MOTORCYCLE_DEALER(GeoCovers geoCovers) {
	...
	public MOTORCYCLE_DEALER(GeoCrosses geoCrosses) {
	...
	public MOTORCYCLE_DEALER(GeoDisjoint geoDisjoint) {
	...
	public MOTORCYCLE_DEALER(GeoEquals geoEquals) {
	...
	public MOTORCYCLE_DEALER(GeoIntersects geoIntersects) {
	...
	public MOTORCYCLE_DEALER(GeoOverlaps geoOverlaps) {
	...
	public MOTORCYCLE_DEALER(GeoTouches geoTouches) {
	...
	public MOTORCYCLE_DEALER(GeoWithin geoWithin) {
	...
	public MOTORCYCLE_DEALER(Slogan slogan) {
		setSlogan(slogan);
	}
