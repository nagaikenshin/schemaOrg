...
public class REVIEW_RATING implements Container.ReviewRating {
	...
	public REVIEW_RATING(String string) {
	...
	public REVIEW_RATING(AggregateRating aggregateRating) {
	...
	public REVIEW_RATING(EmployerAggregateRating employerAggregateRating) {
	...
	public REVIEW_RATING(EndorsementRating endorsementRating) {
	...
	public REVIEW_RATING(Rating rating) {
		ratingList = new ArrayList<Rating>();
	...
	public REVIEW_RATING(List<AggregateRating> aggregateRatingList,
	...
	public void copy(Container.ReviewRating org) {
