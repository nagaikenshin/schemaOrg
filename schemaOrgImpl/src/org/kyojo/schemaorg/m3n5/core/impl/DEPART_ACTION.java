...
public class DEPART_ACTION implements Clazz.DepartAction {
	...
	public DEPART_ACTION() {
	}

	public DEPART_ACTION(Long seq) {
		setSeq(seq);
	}

	public DEPART_ACTION(String string) {
	...
	public DEPART_ACTION(ActionStatus actionStatus) {
	...
	public DEPART_ACTION(AdditionalType additionalType) {
	...
	public DEPART_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public DEPART_ACTION(AlternateName alternateName) {
	...
	public DEPART_ACTION(Description description) {
	...
	public DEPART_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public DEPART_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public DEPART_ACTION(Error error) {
		setError(error);
	}
	...
	public DEPART_ACTION(FromLocation fromLocation) {
	...
	public DEPART_ACTION(Identifier identifier) {
	...
	public DEPART_ACTION(Image image) {
		setImage(image);
	}
	...
	public DEPART_ACTION(Instrument instrument) {
	...
	public DEPART_ACTION(Location location) {
	...
	public DEPART_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public DEPART_ACTION(Name name) {
		setName(name);
	}
	...
	public DEPART_ACTION(NameFuzzy nameFuzzy) {
	...
	public DEPART_ACTION(NameRuby nameRuby) {
	...
	public DEPART_ACTION(Object object) {
		setObject(object);
	}
	...
	public DEPART_ACTION(Participant participant) {
	...
	public DEPART_ACTION(PotentialAction potentialAction) {
	...
	public DEPART_ACTION(Result result) {
		setResult(result);
	}
	...
	public DEPART_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DEPART_ACTION(StartTime startTime) {
	...
	public DEPART_ACTION(SubjectOf subjectOf) {
	...
	public DEPART_ACTION(Target target) {
		setTarget(target);
	}
	...
	public DEPART_ACTION(ToLocation toLocation) {
	...
	public void copy(Clazz.DepartAction org) {
		setSeq(org.getSeq());
