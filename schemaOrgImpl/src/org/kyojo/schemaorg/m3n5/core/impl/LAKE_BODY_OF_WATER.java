...
public class LAKE_BODY_OF_WATER implements Clazz.LakeBodyOfWater {
	...
	public LAKE_BODY_OF_WATER(GeoContains geoContains) {
	...
	public LAKE_BODY_OF_WATER(GeoCoveredBy geoCoveredBy) {
	...
	public LAKE_BODY_OF_WATER(GeoCovers geoCovers) {
	...
	public LAKE_BODY_OF_WATER(GeoCrosses geoCrosses) {
	...
	public LAKE_BODY_OF_WATER(GeoDisjoint geoDisjoint) {
	...
	public LAKE_BODY_OF_WATER(GeoEquals geoEquals) {
	...
	public LAKE_BODY_OF_WATER(GeoIntersects geoIntersects) {
	...
	public LAKE_BODY_OF_WATER(GeoOverlaps geoOverlaps) {
	...
	public LAKE_BODY_OF_WATER(GeoTouches geoTouches) {
	...
	public LAKE_BODY_OF_WATER(GeoWithin geoWithin) {
	...
	public LAKE_BODY_OF_WATER(Slogan slogan) {
		setSlogan(slogan);
	}
