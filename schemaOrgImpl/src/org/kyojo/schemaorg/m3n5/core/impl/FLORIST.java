...
public class FLORIST implements Clazz.Florist {
	...
	public FLORIST(GeoContains geoContains) {
	...
	public FLORIST(GeoCoveredBy geoCoveredBy) {
	...
	public FLORIST(GeoCovers geoCovers) {
	...
	public FLORIST(GeoCrosses geoCrosses) {
	...
	public FLORIST(GeoDisjoint geoDisjoint) {
	...
	public FLORIST(GeoEquals geoEquals) {
	...
	public FLORIST(GeoIntersects geoIntersects) {
	...
	public FLORIST(GeoOverlaps geoOverlaps) {
	...
	public FLORIST(GeoTouches geoTouches) {
	...
	public FLORIST(GeoWithin geoWithin) {
