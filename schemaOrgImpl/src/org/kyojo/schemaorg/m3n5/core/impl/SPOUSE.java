...
public class SPOUSE implements Container.Spouse {
	...
	public SPOUSE(List<Patient> patientList,
			List<Person> personList) {
		setPatientList(patientList);
		setPersonList(personList);
	}

	public void copy(Container.Spouse org) {
