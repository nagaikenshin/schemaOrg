...
public class CREATIVE_WORK_SERIES implements Clazz.CreativeWorkSeries {
	...
	public CREATIVE_WORK_SERIES() {
	}

	public CREATIVE_WORK_SERIES(Long seq) {
		setSeq(seq);
	}

	public CREATIVE_WORK_SERIES(String string) {
	...
	public CREATIVE_WORK_SERIES(About about) {
		setAbout(about);
	}
	...
	public CREATIVE_WORK_SERIES(AccessMode accessMode) {
	...
	public CREATIVE_WORK_SERIES(AccessModeSufficient accessModeSufficient) {
	...
	public CREATIVE_WORK_SERIES(AccessibilityAPI accessibilityAPI) {
	...
	public CREATIVE_WORK_SERIES(AccessibilityControl accessibilityControl) {
	...
	public CREATIVE_WORK_SERIES(AccessibilityFeature accessibilityFeature) {
	...
	public CREATIVE_WORK_SERIES(AccessibilityHazard accessibilityHazard) {
	...
	public CREATIVE_WORK_SERIES(AccessibilitySummary accessibilitySummary) {
	...
	public CREATIVE_WORK_SERIES(AccountablePerson accountablePerson) {
	...
	public CREATIVE_WORK_SERIES(AdditionalType additionalType) {
	...
	public CREATIVE_WORK_SERIES(AggregateRating aggregateRating) {
	...
	public CREATIVE_WORK_SERIES(AlternateName alternateName) {
	...
	public CREATIVE_WORK_SERIES(AlternativeHeadline alternativeHeadline) {
	...
	public CREATIVE_WORK_SERIES(AssociatedMedia associatedMedia) {
	...
	public CREATIVE_WORK_SERIES(Audience audience) {
	...
	public CREATIVE_WORK_SERIES(Audio audio) {
		setAudio(audio);
	}
	...
	public CREATIVE_WORK_SERIES(Author author) {
		setAuthor(author);
	}
	...
	public CREATIVE_WORK_SERIES(Award award) {
		setAward(award);
	}
	...
	public CREATIVE_WORK_SERIES(Character character) {
	...
	public CREATIVE_WORK_SERIES(Citation citation) {
	...
	public CREATIVE_WORK_SERIES(Comment comment) {
		setComment(comment);
	}
	...
	public CREATIVE_WORK_SERIES(CommentCount commentCount) {
	...
	public CREATIVE_WORK_SERIES(ContentLocation contentLocation) {
	...
	public CREATIVE_WORK_SERIES(ContentRating contentRating) {
	...
	public CREATIVE_WORK_SERIES(ContentReferenceTime contentReferenceTime) {
	...
	public CREATIVE_WORK_SERIES(Contributor contributor) {
	...
	public CREATIVE_WORK_SERIES(CopyrightHolder copyrightHolder) {
	...
	public CREATIVE_WORK_SERIES(CopyrightYear copyrightYear) {
	...
	public CREATIVE_WORK_SERIES(Correction correction) {
	...
	public CREATIVE_WORK_SERIES(Creator creator) {
		setCreator(creator);
	}
	...
	public CREATIVE_WORK_SERIES(DateCreated dateCreated) {
	...
	public CREATIVE_WORK_SERIES(DateModified dateModified) {
	...
	public CREATIVE_WORK_SERIES(DatePublished datePublished) {
	...
	public CREATIVE_WORK_SERIES(Description description) {
	...
	public CREATIVE_WORK_SERIES(DisambiguatingDescription disambiguatingDescription) {
	...
	public CREATIVE_WORK_SERIES(DiscussionUrl discussionUrl) {
	...
	public CREATIVE_WORK_SERIES(Editor editor) {
		setEditor(editor);
	}
	...
	public CREATIVE_WORK_SERIES(EducationalAlignment educationalAlignment) {
	...
	public CREATIVE_WORK_SERIES(EducationalUse educationalUse) {
	...
	public CREATIVE_WORK_SERIES(Encoding encoding) {
	...
	public CREATIVE_WORK_SERIES(EncodingFormat encodingFormat) {
	...
	public CREATIVE_WORK_SERIES(EndDate endDate) {
		setEndDate(endDate);
	}
	...
	public CREATIVE_WORK_SERIES(ExampleOfWork exampleOfWork) {
	...
	public CREATIVE_WORK_SERIES(Expires expires) {
		setExpires(expires);
	}
	...
	public CREATIVE_WORK_SERIES(Funder funder) {
		setFunder(funder);
	}
	...
	public CREATIVE_WORK_SERIES(Genre genre) {
		setGenre(genre);
	}
	...
	public CREATIVE_WORK_SERIES(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public CREATIVE_WORK_SERIES(Headline headline) {
	...
	public CREATIVE_WORK_SERIES(Identifier identifier) {
	...
	public CREATIVE_WORK_SERIES(Image image) {
		setImage(image);
	}
	...
	public CREATIVE_WORK_SERIES(InLanguage inLanguage) {
	...
	public CREATIVE_WORK_SERIES(InteractionStatistic interactionStatistic) {
	...
	public CREATIVE_WORK_SERIES(InteractivityType interactivityType) {
	...
	public CREATIVE_WORK_SERIES(IsAccessibleForFree isAccessibleForFree) {
	...
	public CREATIVE_WORK_SERIES(IsBasedOn isBasedOn) {
	...
	public CREATIVE_WORK_SERIES(IsFamilyFriendly isFamilyFriendly) {
	...
	public CREATIVE_WORK_SERIES(IsPartOf isPartOf) {
	...
	public CREATIVE_WORK_SERIES(Issn issn) {
		setIssn(issn);
	}
	...
	public CREATIVE_WORK_SERIES(Keywords keywords) {
	...
	public CREATIVE_WORK_SERIES(LearningResourceType learningResourceType) {
	...
	public CREATIVE_WORK_SERIES(License license) {
		setLicense(license);
	}
	...
	public CREATIVE_WORK_SERIES(LocationCreated locationCreated) {
	...
	public CREATIVE_WORK_SERIES(MainEntity mainEntity) {
	...
	public CREATIVE_WORK_SERIES(MainEntityOfPage mainEntityOfPage) {
	...
	public CREATIVE_WORK_SERIES(Material material) {
	...
	public CREATIVE_WORK_SERIES(MaterialExtent materialExtent) {
	...
	public CREATIVE_WORK_SERIES(Mentions mentions) {
	...
	public CREATIVE_WORK_SERIES(Name name) {
		setName(name);
	}
	...
	public CREATIVE_WORK_SERIES(NameFuzzy nameFuzzy) {
	...
	public CREATIVE_WORK_SERIES(NameRuby nameRuby) {
	...
	public CREATIVE_WORK_SERIES(Offers offers) {
		setOffers(offers);
	}
	...
	public CREATIVE_WORK_SERIES(Position position) {
	...
	public CREATIVE_WORK_SERIES(PotentialAction potentialAction) {
	...
	public CREATIVE_WORK_SERIES(Producer producer) {
	...
	public CREATIVE_WORK_SERIES(Provider provider) {
	...
	public CREATIVE_WORK_SERIES(Publication publication) {
	...
	public CREATIVE_WORK_SERIES(Publisher publisher) {
	...
	public CREATIVE_WORK_SERIES(PublisherImprint publisherImprint) {
	...
	public CREATIVE_WORK_SERIES(PublishingPrinciples publishingPrinciples) {
	...
	public CREATIVE_WORK_SERIES(RecordedAt recordedAt) {
	...
	public CREATIVE_WORK_SERIES(ReleasedEvent releasedEvent) {
	...
	public CREATIVE_WORK_SERIES(Review review) {
		setReview(review);
	}
	...
	public CREATIVE_WORK_SERIES(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CREATIVE_WORK_SERIES(SchemaVersion schemaVersion) {
	...
	public CREATIVE_WORK_SERIES(SdDatePublished sdDatePublished) {
	...
	public CREATIVE_WORK_SERIES(SdLicense sdLicense) {
	...
	public CREATIVE_WORK_SERIES(SdPublisher sdPublisher) {
	...
	public CREATIVE_WORK_SERIES(SourceOrganization sourceOrganization) {
	...
	public CREATIVE_WORK_SERIES(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public CREATIVE_WORK_SERIES(SpatialCoverage spatialCoverage) {
	...
	public CREATIVE_WORK_SERIES(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public CREATIVE_WORK_SERIES(StartDate startDate) {
	...
	public CREATIVE_WORK_SERIES(SubjectOf subjectOf) {
	...
	public CREATIVE_WORK_SERIES(Temporal temporal) {
	...
	public CREATIVE_WORK_SERIES(TemporalCoverage temporalCoverage) {
	...
	public CREATIVE_WORK_SERIES(Text text) {
		setText(text);
	}
	...
	public CREATIVE_WORK_SERIES(ThumbnailUrl thumbnailUrl) {
	...
	public CREATIVE_WORK_SERIES(TimeRequired timeRequired) {
	...
	public CREATIVE_WORK_SERIES(TranslationOfWork translationOfWork) {
	...
	public CREATIVE_WORK_SERIES(Translator translator) {
	...
	public CREATIVE_WORK_SERIES(TypicalAgeRange typicalAgeRange) {
	...
	public CREATIVE_WORK_SERIES(Url url) {
		setUrl(url);
	}
	...
	public CREATIVE_WORK_SERIES(Version version) {
		setVersion(version);
	}
	...
	public CREATIVE_WORK_SERIES(Video video) {
		setVideo(video);
	}
	...
	public CREATIVE_WORK_SERIES(WorkExample workExample) {
	...
	public CREATIVE_WORK_SERIES(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.CreativeWorkSeries org) {
		setSeq(org.getSeq());
