...
public class HOME_AND_CONSTRUCTION_BUSINESS implements Clazz.HomeAndConstructionBusiness {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(GeoContains geoContains) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(GeoCoveredBy geoCoveredBy) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(GeoCovers geoCovers) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(GeoCrosses geoCrosses) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(GeoDisjoint geoDisjoint) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(GeoEquals geoEquals) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(GeoIntersects geoIntersects) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(GeoOverlaps geoOverlaps) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(GeoTouches geoTouches) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(GeoWithin geoWithin) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Slogan slogan) {
		setSlogan(slogan);
	}
