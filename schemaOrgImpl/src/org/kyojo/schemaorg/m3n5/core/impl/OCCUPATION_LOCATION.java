...
public class OCCUPATION_LOCATION implements Container.OccupationLocation {
	...
	public OCCUPATION_LOCATION(String string) {
	...
	public OCCUPATION_LOCATION(AdministrativeArea administrativeArea) {
		administrativeAreaList = new ArrayList<AdministrativeArea>();
