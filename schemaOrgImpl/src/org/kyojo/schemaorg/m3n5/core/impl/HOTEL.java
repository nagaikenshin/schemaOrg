...
public class HOTEL implements Clazz.Hotel {
	...
	public HOTEL(GeoContains geoContains) {
	...
	public HOTEL(GeoCoveredBy geoCoveredBy) {
	...
	public HOTEL(GeoCovers geoCovers) {
	...
	public HOTEL(GeoCrosses geoCrosses) {
	...
	public HOTEL(GeoDisjoint geoDisjoint) {
	...
	public HOTEL(GeoEquals geoEquals) {
	...
	public HOTEL(GeoIntersects geoIntersects) {
	...
	public HOTEL(GeoOverlaps geoOverlaps) {
	...
	public HOTEL(GeoTouches geoTouches) {
	...
	public HOTEL(GeoWithin geoWithin) {
