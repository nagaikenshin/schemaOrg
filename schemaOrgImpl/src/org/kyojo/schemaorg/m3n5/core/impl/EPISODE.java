...
public class EPISODE implements Clazz.Episode, Container.Episode {
	...
	public EPISODE(ArchiveComponent archiveComponent) {
	...
	public EPISODE(Drawing drawing) {
	...
	public EPISODE(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public EPISODE(Manuscript manuscript) {
	...
	public EPISODE(MaterialExtent materialExtent) {
	...
	public EPISODE(SheetMusic sheetMusic) {
	...
	public EPISODE(ShortStory shortStory) {
	...
	public EPISODE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public EPISODE(Temporal temporal) {
	...
	public EPISODE(ThreeDimensionalModel threeDimensionalModel) {
