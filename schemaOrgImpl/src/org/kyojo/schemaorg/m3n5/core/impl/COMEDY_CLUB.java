...
public class COMEDY_CLUB implements Clazz.ComedyClub {
	...
	public COMEDY_CLUB(GeoContains geoContains) {
	...
	public COMEDY_CLUB(GeoCoveredBy geoCoveredBy) {
	...
	public COMEDY_CLUB(GeoCovers geoCovers) {
	...
	public COMEDY_CLUB(GeoCrosses geoCrosses) {
	...
	public COMEDY_CLUB(GeoDisjoint geoDisjoint) {
	...
	public COMEDY_CLUB(GeoEquals geoEquals) {
	...
	public COMEDY_CLUB(GeoIntersects geoIntersects) {
	...
	public COMEDY_CLUB(GeoOverlaps geoOverlaps) {
	...
	public COMEDY_CLUB(GeoTouches geoTouches) {
	...
	public COMEDY_CLUB(GeoWithin geoWithin) {
	...
	public COMEDY_CLUB(Slogan slogan) {
		setSlogan(slogan);
	}
