...
import org.kyojo.schemaorg.m3n5.core.Container.ReleaseOf;
...
public class MUSIC_RELEASE implements Clazz.MusicRelease {
	...
	public MusicReleaseFormat musicReleaseFormat;
	public Name name;
	public NameFuzzy nameFuzzy;
	public NameRuby nameRuby;
	public NumTracks numTracks;
	...
	public MUSIC_RELEASE(Long seq) {
		setSeq(seq);
	}

	public MUSIC_RELEASE(String string) {
	...
	public MUSIC_RELEASE(About about) {
		setAbout(about);
	}
	...
	public MUSIC_RELEASE(AccessMode accessMode) {
	...
	public MUSIC_RELEASE(AccessModeSufficient accessModeSufficient) {
	...
	public MUSIC_RELEASE(AccessibilityAPI accessibilityAPI) {
	...
	public MUSIC_RELEASE(AccessibilityControl accessibilityControl) {
	...
	public MUSIC_RELEASE(AccessibilityFeature accessibilityFeature) {
	...
	public MUSIC_RELEASE(AccessibilityHazard accessibilityHazard) {
	...
	public MUSIC_RELEASE(AccessibilitySummary accessibilitySummary) {
	...
	public MUSIC_RELEASE(AccountablePerson accountablePerson) {
	...
	public MUSIC_RELEASE(AdditionalType additionalType) {
	...
	public MUSIC_RELEASE(AggregateRating aggregateRating) {
	...
	public MUSIC_RELEASE(AlternateName alternateName) {
	...
	public MUSIC_RELEASE(AlternativeHeadline alternativeHeadline) {
	...
	public MUSIC_RELEASE(AssociatedMedia associatedMedia) {
	...
	public MUSIC_RELEASE(Audience audience) {
	...
	public MUSIC_RELEASE(Audio audio) {
		setAudio(audio);
	}
	...
	public MUSIC_RELEASE(Author author) {
		setAuthor(author);
	}
	...
	public MUSIC_RELEASE(Award award) {
		setAward(award);
	}
	...
	public MUSIC_RELEASE(CatalogNumber catalogNumber) {
	...
	public MUSIC_RELEASE(Character character) {
	...
	public MUSIC_RELEASE(Citation citation) {
	...
	public MUSIC_RELEASE(Comment comment) {
		setComment(comment);
	}
	...
	public MUSIC_RELEASE(CommentCount commentCount) {
	...
	public MUSIC_RELEASE(ContentLocation contentLocation) {
	...
	public MUSIC_RELEASE(ContentRating contentRating) {
	...
	public MUSIC_RELEASE(ContentReferenceTime contentReferenceTime) {
	...
	public MUSIC_RELEASE(Contributor contributor) {
	...
	public MUSIC_RELEASE(CopyrightHolder copyrightHolder) {
	...
	public MUSIC_RELEASE(CopyrightYear copyrightYear) {
	...
	public MUSIC_RELEASE(Correction correction) {
	...
	public MUSIC_RELEASE(Creator creator) {
		setCreator(creator);
	}
	...
	public MUSIC_RELEASE(CreditedTo creditedTo) {
		setCreditedTo(creditedTo);
	}

	@Override
	public CreditedTo getCreditedTo() {
		return creditedTo;
	}

	@Override
	public void setCreditedTo(CreditedTo creditedTo) {
		this.creditedTo = creditedTo;
	}

	public MUSIC_RELEASE(DateCreated dateCreated) {
	...
	public MUSIC_RELEASE(DateModified dateModified) {
	...
	public MUSIC_RELEASE(DatePublished datePublished) {
	...
	public MUSIC_RELEASE(Description description) {
	...
	public MUSIC_RELEASE(DisambiguatingDescription disambiguatingDescription) {
	...
	public MUSIC_RELEASE(DiscussionUrl discussionUrl) {
	...
	public MUSIC_RELEASE(Duration duration) {
	...
	public MUSIC_RELEASE(Editor editor) {
		setEditor(editor);
	}
	...
	public MUSIC_RELEASE(EducationalAlignment educationalAlignment) {
	...
	public MUSIC_RELEASE(EducationalUse educationalUse) {
	...
	public MUSIC_RELEASE(Encoding encoding) {
	...
	public MUSIC_RELEASE(EncodingFormat encodingFormat) {
	...
	public MUSIC_RELEASE(ExampleOfWork exampleOfWork) {
	...
	public MUSIC_RELEASE(Expires expires) {
		setExpires(expires);
	}
	...
	public MUSIC_RELEASE(Funder funder) {
		setFunder(funder);
	}
	...
	public MUSIC_RELEASE(Genre genre) {
		setGenre(genre);
	}
	...
	public MUSIC_RELEASE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public MUSIC_RELEASE(Headline headline) {
	...
	public MUSIC_RELEASE(Identifier identifier) {
	...
	public MUSIC_RELEASE(Image image) {
		setImage(image);
	}
	...
	public MUSIC_RELEASE(InLanguage inLanguage) {
	...
	public MUSIC_RELEASE(InteractionStatistic interactionStatistic) {
	...
	public MUSIC_RELEASE(InteractivityType interactivityType) {
	...
	public MUSIC_RELEASE(IsAccessibleForFree isAccessibleForFree) {
	...
	public MUSIC_RELEASE(IsBasedOn isBasedOn) {
	...
	public MUSIC_RELEASE(IsFamilyFriendly isFamilyFriendly) {
	...
	public MUSIC_RELEASE(IsPartOf isPartOf) {
	...
	public MUSIC_RELEASE(Keywords keywords) {
	...
	public MUSIC_RELEASE(LearningResourceType learningResourceType) {
	...
	public MUSIC_RELEASE(License license) {
		setLicense(license);
	}
	...
	public MUSIC_RELEASE(LocationCreated locationCreated) {
	...
	public MUSIC_RELEASE(MainEntity mainEntity) {
	...
	public MUSIC_RELEASE(MainEntityOfPage mainEntityOfPage) {
	...
	public MUSIC_RELEASE(Material material) {
	...
	public MUSIC_RELEASE(MaterialExtent materialExtent) {
	...
	public MUSIC_RELEASE(Mentions mentions) {
	...
	public MUSIC_RELEASE(MusicReleaseFormat musicReleaseFormat) {
		setMusicReleaseFormat(musicReleaseFormat);
	}

	@Override
	public MusicReleaseFormat getMusicReleaseFormat() {
		return musicReleaseFormat;
	}

	@Override
	public void setMusicReleaseFormat(MusicReleaseFormat musicReleaseFormat) {
		this.musicReleaseFormat = musicReleaseFormat;
	}

	public MUSIC_RELEASE(Name name) {
		setName(name);
	}
	...
	public MUSIC_RELEASE(NameFuzzy nameFuzzy) {
	...
	public MUSIC_RELEASE(NameRuby nameRuby) {
	...
	public MUSIC_RELEASE(NumTracks numTracks) {
		setNumTracks(numTracks);
	}

	@Override
	public NumTracks getNumTracks() {
		return numTracks;
	}

	@Override
	public void setNumTracks(NumTracks numTracks) {
		this.numTracks = numTracks;
	}

	public MUSIC_RELEASE(Offers offers) {
		setOffers(offers);
	}
	...
	public MUSIC_RELEASE(Position position) {
	...
	public MUSIC_RELEASE(PotentialAction potentialAction) {
	...
	public MUSIC_RELEASE(Producer producer) {
	...
	public MUSIC_RELEASE(Provider provider) {
	...
	public MUSIC_RELEASE(Publication publication) {
	...
	public MUSIC_RELEASE(Publisher publisher) {
	...
	public MUSIC_RELEASE(PublisherImprint publisherImprint) {
	...
	public MUSIC_RELEASE(PublishingPrinciples publishingPrinciples) {
	...
	public MUSIC_RELEASE(RecordLabel recordLabel) {
	...
	public MUSIC_RELEASE(RecordedAt recordedAt) {
	...
	public MUSIC_RELEASE(ReleaseOf releaseOf) {
		setReleaseOf(releaseOf);
	}

	@Override
	public ReleaseOf getReleaseOf() {
		return releaseOf;
	}

	@Override
	public void setReleaseOf(ReleaseOf releaseOf) {
		this.releaseOf = releaseOf;
	}

	public MUSIC_RELEASE(ReleasedEvent releasedEvent) {
	...
	public MUSIC_RELEASE(Review review) {
		setReview(review);
	}
	...
	public MUSIC_RELEASE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MUSIC_RELEASE(SchemaVersion schemaVersion) {
	...
	public MUSIC_RELEASE(SdDatePublished sdDatePublished) {
	...
	public MUSIC_RELEASE(SdLicense sdLicense) {
	...
	public MUSIC_RELEASE(SdPublisher sdPublisher) {
	...
	public MUSIC_RELEASE(SourceOrganization sourceOrganization) {
	...
	public MUSIC_RELEASE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public MUSIC_RELEASE(SpatialCoverage spatialCoverage) {
	...
	public MUSIC_RELEASE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MUSIC_RELEASE(SubjectOf subjectOf) {
	...
	public MUSIC_RELEASE(Temporal temporal) {
	...
	public MUSIC_RELEASE(TemporalCoverage temporalCoverage) {
	...
	public MUSIC_RELEASE(Text text) {
		setText(text);
	}
	...
	public MUSIC_RELEASE(ThumbnailUrl thumbnailUrl) {
	...
	public MUSIC_RELEASE(TimeRequired timeRequired) {
	...
	public MUSIC_RELEASE(Track track) {
		setTrack(track);
	}
	...
	public MUSIC_RELEASE(TranslationOfWork translationOfWork) {
	...
	public MUSIC_RELEASE(Translator translator) {
	...
	public MUSIC_RELEASE(TypicalAgeRange typicalAgeRange) {
	...
	public MUSIC_RELEASE(Version version) {
		setVersion(version);
	}
	...
	public MUSIC_RELEASE(Video video) {
		setVideo(video);
	}
	...
	public MUSIC_RELEASE(WorkExample workExample) {
	...
	public MUSIC_RELEASE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.MusicRelease org) {
		setSeq(org.getSeq());
		...
		setCatalogNumber(org.getCatalogNumber());
		...
		setCreditedTo(org.getCreditedTo());
		...
		setMusicReleaseFormat(org.getMusicReleaseFormat());
		setName(org.getName());
		setNameFuzzy(org.getNameFuzzy());
		setNameRuby(org.getNameRuby());
		setNumTracks(org.getNumTracks());
		...
		setRecordLabel(org.getRecordLabel());
		setRecordedAt(org.getRecordedAt());
		setReleaseOf(org.getReleaseOf());
