...
public class POND implements Clazz.Pond {
	...
	public POND(GeoContains geoContains) {
	...
	public POND(GeoCoveredBy geoCoveredBy) {
	...
	public POND(GeoCovers geoCovers) {
	...
	public POND(GeoCrosses geoCrosses) {
	...
	public POND(GeoDisjoint geoDisjoint) {
	...
	public POND(GeoEquals geoEquals) {
	...
	public POND(GeoIntersects geoIntersects) {
	...
	public POND(GeoOverlaps geoOverlaps) {
	...
	public POND(GeoTouches geoTouches) {
	...
	public POND(GeoWithin geoWithin) {
