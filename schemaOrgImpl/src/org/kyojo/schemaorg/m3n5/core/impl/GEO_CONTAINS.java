...
public class GEO_CONTAINS implements Container.GeoContains {
	...
	public GEO_CONTAINS(String string) {
	...
	public GEO_CONTAINS(Accommodation accommodation) {
	...
	public GEO_CONTAINS(AccountingService accountingService) {
	...
	public GEO_CONTAINS(AdministrativeArea administrativeArea) {
	...
	public GEO_CONTAINS(AdultEntertainment adultEntertainment) {
	...
	public GEO_CONTAINS(Airport airport) {
	...
	public GEO_CONTAINS(AmusementPark amusementPark) {
	...
	public GEO_CONTAINS(AnimalShelter animalShelter) {
	...
	public GEO_CONTAINS(Apartment apartment) {
	...
	public GEO_CONTAINS(ApartmentComplex apartmentComplex) {
	...
	public GEO_CONTAINS(Aquarium aquarium) {
	...
	public GEO_CONTAINS(ArchiveOrganization archiveOrganization) {
	...
	public GEO_CONTAINS(ArtGallery artGallery) {
	...
	public GEO_CONTAINS(Attorney attorney) {
	...
	public GEO_CONTAINS(AutoBodyShop autoBodyShop) {
	...
	public GEO_CONTAINS(AutoDealer autoDealer) {
	...
	public GEO_CONTAINS(AutoPartsStore autoPartsStore) {
	...
	public GEO_CONTAINS(AutoRental autoRental) {
	...
	public GEO_CONTAINS(AutoRepair autoRepair) {
	...
	public GEO_CONTAINS(AutoWash autoWash) {
	...
	public GEO_CONTAINS(AutomatedTeller automatedTeller) {
	...
	public GEO_CONTAINS(AutomotiveBusiness automotiveBusiness) {
	...
	public GEO_CONTAINS(Bakery bakery) {
	...
	public GEO_CONTAINS(BankOrCreditUnion bankOrCreditUnion) {
	...
	public GEO_CONTAINS(BarOrPub barOrPub) {
	...
	public GEO_CONTAINS(Beach beach) {
	...
	public GEO_CONTAINS(BeautySalon beautySalon) {
	...
	public GEO_CONTAINS(BedAndBreakfast bedAndBreakfast) {
	...
	public GEO_CONTAINS(BikeStore bikeStore) {
	...
	public GEO_CONTAINS(BodyOfWater bodyOfWater) {
	...
	public GEO_CONTAINS(BookStore bookStore) {
	...
	public GEO_CONTAINS(BowlingAlley bowlingAlley) {
	...
	public GEO_CONTAINS(Brewery brewery) {
	...
	public GEO_CONTAINS(Bridge bridge) {
	...
	public GEO_CONTAINS(BuddhistTemple buddhistTemple) {
	...
	public GEO_CONTAINS(BusStation busStation) {
	...
	public GEO_CONTAINS(BusStop busStop) {
	...
	public GEO_CONTAINS(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public GEO_CONTAINS(Campground campground) {
	...
	public GEO_CONTAINS(CampingPitch campingPitch) {
	...
	public GEO_CONTAINS(Canal canal) {
	...
	public GEO_CONTAINS(Casino casino) {
	...
	public GEO_CONTAINS(CatholicChurch catholicChurch) {
	...
	public GEO_CONTAINS(Cemetery cemetery) {
	...
	public GEO_CONTAINS(ChildCare childCare) {
	...
	public GEO_CONTAINS(Church church) {
	...
	public GEO_CONTAINS(CityHall cityHall) {
	...
	public GEO_CONTAINS(CivicStructure civicStructure) {
	...
	public GEO_CONTAINS(ClothingStore clothingStore) {
	...
	public GEO_CONTAINS(ComedyClub comedyClub) {
	...
	public GEO_CONTAINS(CommunityHealth communityHealth) {
	...
	public GEO_CONTAINS(ComputerStore computerStore) {
	...
	public GEO_CONTAINS(Continent continent) {
	...
	public GEO_CONTAINS(ConvenienceStore convenienceStore) {
	...
	public GEO_CONTAINS(Country country) {
	...
	public GEO_CONTAINS(Courthouse courthouse) {
	...
	public GEO_CONTAINS(Crematorium crematorium) {
	...
	public GEO_CONTAINS(DaySpa daySpa) {
	...
	public GEO_CONTAINS(DefenceEstablishment defenceEstablishment) {
	...
	public GEO_CONTAINS(Dentist dentist) {
	...
	public GEO_CONTAINS(DepartmentStore departmentStore) {
	...
	public GEO_CONTAINS(Dermatology dermatology) {
	...
	public GEO_CONTAINS(DietNutrition dietNutrition) {
	...
	public GEO_CONTAINS(Distillery distillery) {
	...
	public GEO_CONTAINS(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public GEO_CONTAINS(Electrician electrician) {
	...
	public GEO_CONTAINS(ElectronicsStore electronicsStore) {
	...
	public GEO_CONTAINS(Embassy embassy) {
	...
	public GEO_CONTAINS(Emergency emergency) {
	...
	public GEO_CONTAINS(EmergencyService emergencyService) {
	...
	public GEO_CONTAINS(EmploymentAgency employmentAgency) {
	...
	public GEO_CONTAINS(EntertainmentBusiness entertainmentBusiness) {
	...
	public GEO_CONTAINS(EventVenue eventVenue) {
	...
	public GEO_CONTAINS(ExerciseGym exerciseGym) {
	...
	public GEO_CONTAINS(FastFoodRestaurant fastFoodRestaurant) {
	...
	public GEO_CONTAINS(FinancialService financialService) {
	...
	public GEO_CONTAINS(FireStation fireStation) {
	...
	public GEO_CONTAINS(Florist florist) {
	...
	public GEO_CONTAINS(FoodEstablishment foodEstablishment) {
	...
	public GEO_CONTAINS(FurnitureStore furnitureStore) {
	...
	public GEO_CONTAINS(GardenStore gardenStore) {
	...
	public GEO_CONTAINS(GasStation gasStation) {
	...
	public GEO_CONTAINS(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public GEO_CONTAINS(GeneralContractor generalContractor) {
	...
	public GEO_CONTAINS(GeospatialGeometry geospatialGeometry) {
		geospatialGeometryList = new ArrayList<GeospatialGeometry>();
	...
	public GEO_CONTAINS(Geriatric geriatric) {
	...
	public GEO_CONTAINS(GolfCourse golfCourse) {
	...
	public GEO_CONTAINS(GovernmentBuilding governmentBuilding) {
	...
	public GEO_CONTAINS(GovernmentOffice governmentOffice) {
	...
	public GEO_CONTAINS(GroceryStore groceryStore) {
	...
	public GEO_CONTAINS(Gynecologic gynecologic) {
	...
	public GEO_CONTAINS(HVACBusiness hvacBusiness) {
	...
	public GEO_CONTAINS(HairSalon hairSalon) {
	...
	public GEO_CONTAINS(HardwareStore hardwareStore) {
	...
	public GEO_CONTAINS(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public GEO_CONTAINS(HealthClub healthClub) {
	...
	public GEO_CONTAINS(HinduTemple hinduTemple) {
	...
	public GEO_CONTAINS(HobbyShop hobbyShop) {
	...
	public GEO_CONTAINS(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public GEO_CONTAINS(HomeGoodsStore homeGoodsStore) {
	...
	public GEO_CONTAINS(Hospital hospital) {
	...
	public GEO_CONTAINS(Hostel hostel) {
	...
	public GEO_CONTAINS(Hotel hotel) {
	...
	public GEO_CONTAINS(HotelRoom hotelRoom) {
	...
	public GEO_CONTAINS(House house) {
	...
	public GEO_CONTAINS(HousePainter housePainter) {
	...
	public GEO_CONTAINS(IceCreamShop iceCreamShop) {
	...
	public GEO_CONTAINS(InsuranceAgency insuranceAgency) {
	...
	public GEO_CONTAINS(InternetCafe internetCafe) {
	...
	public GEO_CONTAINS(JewelryStore jewelryStore) {
	...
	public GEO_CONTAINS(LakeBodyOfWater lakeBodyOfWater) {
	...
	public GEO_CONTAINS(Landform landform) {
	...
	public GEO_CONTAINS(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public GEO_CONTAINS(LegalService legalService) {
	...
	public GEO_CONTAINS(LegislativeBuilding legislativeBuilding) {
	...
	public GEO_CONTAINS(Library library) {
	...
	public GEO_CONTAINS(LiquorStore liquorStore) {
	...
	public GEO_CONTAINS(LocalBusiness localBusiness) {
	...
	public GEO_CONTAINS(Locksmith locksmith) {
	...
	public GEO_CONTAINS(LodgingBusiness lodgingBusiness) {
	...
	public GEO_CONTAINS(MedicalBusiness medicalBusiness) {
	...
	public GEO_CONTAINS(MedicalClinic medicalClinic) {
	...
	public GEO_CONTAINS(MeetingRoom meetingRoom) {
	...
	public GEO_CONTAINS(MensClothingStore mensClothingStore) {
	...
	public GEO_CONTAINS(Midwifery midwifery) {
	...
	public GEO_CONTAINS(MobilePhoneStore mobilePhoneStore) {
	...
	public GEO_CONTAINS(Mosque mosque) {
	...
	public GEO_CONTAINS(Motel motel) {
	...
	public GEO_CONTAINS(MotorcycleDealer motorcycleDealer) {
	...
	public GEO_CONTAINS(MotorcycleRepair motorcycleRepair) {
	...
	public GEO_CONTAINS(Mountain mountain) {
	...
	public GEO_CONTAINS(MovieRentalStore movieRentalStore) {
	...
	public GEO_CONTAINS(MovieTheater movieTheater) {
	...
	public GEO_CONTAINS(MovingCompany movingCompany) {
	...
	public GEO_CONTAINS(Museum museum) {
	...
	public GEO_CONTAINS(MusicStore musicStore) {
	...
	public GEO_CONTAINS(MusicVenue musicVenue) {
	...
	public GEO_CONTAINS(NailSalon nailSalon) {
	...
	public GEO_CONTAINS(NightClub nightClub) {
	...
	public GEO_CONTAINS(Notary notary) {
	...
	public GEO_CONTAINS(Nursing nursing) {
	...
	public GEO_CONTAINS(Obstetric obstetric) {
	...
	public GEO_CONTAINS(OceanBodyOfWater oceanBodyOfWater) {
	...
	public GEO_CONTAINS(OfficeEquipmentStore officeEquipmentStore) {
	...
	public GEO_CONTAINS(Oncologic oncologic) {
	...
	public GEO_CONTAINS(Optician optician) {
	...
	public GEO_CONTAINS(Optometric optometric) {
	...
	public GEO_CONTAINS(Otolaryngologic otolaryngologic) {
	...
	public GEO_CONTAINS(OutletStore outletStore) {
	...
	public GEO_CONTAINS(ParkingFacility parkingFacility) {
	...
	public GEO_CONTAINS(PawnShop pawnShop) {
	...
	public GEO_CONTAINS(Pediatric pediatric) {
	...
	public GEO_CONTAINS(PerformingArtsTheater performingArtsTheater) {
	...
	public GEO_CONTAINS(PetStore petStore) {
	...
	public GEO_CONTAINS(Pharmacy pharmacy) {
	...
	public GEO_CONTAINS(Physician physician) {
	...
	public GEO_CONTAINS(Physiotherapy physiotherapy) {
	...
	public GEO_CONTAINS(Place place) {
	...
	public GEO_CONTAINS(PlaceOfWorship placeOfWorship) {
	...
	public GEO_CONTAINS(PlasticSurgery plasticSurgery) {
	...
	public GEO_CONTAINS(Playground playground) {
	...
	public GEO_CONTAINS(Plumber plumber) {
	...
	public GEO_CONTAINS(Podiatric podiatric) {
	...
	public GEO_CONTAINS(PoliceStation policeStation) {
	...
	public GEO_CONTAINS(PostOffice postOffice) {
	...
	public GEO_CONTAINS(PrimaryCare primaryCare) {
	...
	public GEO_CONTAINS(ProfessionalService professionalService) {
	...
	public GEO_CONTAINS(Psychiatric psychiatric) {
	...
	public GEO_CONTAINS(PublicHealth publicHealth) {
	...
	public GEO_CONTAINS(PublicSwimmingPool publicSwimmingPool) {
	...
	public GEO_CONTAINS(PublicToilet publicToilet) {
	...
	public GEO_CONTAINS(RVPark rvPark) {
	...
	public GEO_CONTAINS(RadioStation radioStation) {
	...
	public GEO_CONTAINS(RealEstateAgent realEstateAgent) {
	...
	public GEO_CONTAINS(RecyclingCenter recyclingCenter) {
	...
	public GEO_CONTAINS(Reservoir reservoir) {
	...
	public GEO_CONTAINS(Residence residence) {
	...
	public GEO_CONTAINS(Resort resort) {
	...
	public GEO_CONTAINS(Restaurant restaurant) {
	...
	public GEO_CONTAINS(RiverBodyOfWater riverBodyOfWater) {
	...
	public GEO_CONTAINS(RoofingContractor roofingContractor) {
	...
	public GEO_CONTAINS(SeaBodyOfWater seaBodyOfWater) {
	...
	public GEO_CONTAINS(SelfStorage selfStorage) {
	...
	public GEO_CONTAINS(ShoeStore shoeStore) {
	...
	public GEO_CONTAINS(ShoppingCenter shoppingCenter) {
	...
	public GEO_CONTAINS(SingleFamilyResidence singleFamilyResidence) {
	...
	public GEO_CONTAINS(SkiResort skiResort) {
	...
	public GEO_CONTAINS(SportingGoodsStore sportingGoodsStore) {
	...
	public GEO_CONTAINS(SportsActivityLocation sportsActivityLocation) {
	...
	public GEO_CONTAINS(SportsClub sportsClub) {
	...
	public GEO_CONTAINS(StadiumOrArena stadiumOrArena) {
	...
	public GEO_CONTAINS(State state) {
	...
	public GEO_CONTAINS(Store store) {
	...
	public GEO_CONTAINS(SubwayStation subwayStation) {
	...
	public GEO_CONTAINS(Suite suite) {
	...
	public GEO_CONTAINS(Synagogue synagogue) {
	...
	public GEO_CONTAINS(TattooParlor tattooParlor) {
	...
	public GEO_CONTAINS(TaxiStand taxiStand) {
	...
	public GEO_CONTAINS(TelevisionStation televisionStation) {
	...
	public GEO_CONTAINS(TennisComplex tennisComplex) {
	...
	public GEO_CONTAINS(TireShop tireShop) {
	...
	public GEO_CONTAINS(TouristAttraction touristAttraction) {
	...
	public GEO_CONTAINS(TouristDestination touristDestination) {
	...
	public GEO_CONTAINS(TouristInformationCenter touristInformationCenter) {
	...
	public GEO_CONTAINS(ToyStore toyStore) {
	...
	public GEO_CONTAINS(TrainStation trainStation) {
	...
	public GEO_CONTAINS(TravelAgency travelAgency) {
	...
	public GEO_CONTAINS(Volcano volcano) {
	...
	public GEO_CONTAINS(Waterfall waterfall) {
	...
	public GEO_CONTAINS(WholesaleStore wholesaleStore) {
	...
	public GEO_CONTAINS(Winery winery) {
	...
	public void copy(Container.GeoContains org) {
