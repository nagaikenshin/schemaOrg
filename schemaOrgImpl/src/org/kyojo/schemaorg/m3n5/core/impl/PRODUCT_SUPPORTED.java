...
public class PRODUCT_SUPPORTED implements Container.ProductSupported {
	...
	public PRODUCT_SUPPORTED(BusOrCoach busOrCoach) {
	...
	public PRODUCT_SUPPORTED(Car car) {
	...
	public PRODUCT_SUPPORTED(IndividualProduct individualProduct) {
	...
	public PRODUCT_SUPPORTED(Motorcycle motorcycle) {
	...
	public PRODUCT_SUPPORTED(MotorizedBicycle motorizedBicycle) {
	...
	public PRODUCT_SUPPORTED(ProductModel productModel) {
	...
	public PRODUCT_SUPPORTED(SomeProducts someProducts) {
	...
	public PRODUCT_SUPPORTED(Vehicle vehicle) {
	...
	public PRODUCT_SUPPORTED(List<BusOrCoach> busOrCoachList,
			List<Car> carList,
