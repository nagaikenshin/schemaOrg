...
public class PARK implements Clazz.Park {
	...
	public PARK(GeoContains geoContains) {
	...
	public PARK(GeoCoveredBy geoCoveredBy) {
	...
	public PARK(GeoCovers geoCovers) {
	...
	public PARK(GeoCrosses geoCrosses) {
	...
	public PARK(GeoDisjoint geoDisjoint) {
	...
	public PARK(GeoEquals geoEquals) {
	...
	public PARK(GeoIntersects geoIntersects) {
	...
	public PARK(GeoOverlaps geoOverlaps) {
	...
	public PARK(GeoTouches geoTouches) {
	...
	public PARK(GeoWithin geoWithin) {
