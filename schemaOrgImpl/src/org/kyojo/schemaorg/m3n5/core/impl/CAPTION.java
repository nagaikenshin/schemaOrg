...
public class CAPTION implements Container.Caption {
	...
	public CAPTION(AudioObject audioObject) {
	...
	public CAPTION(Audiobook audiobook) {
	...
	public CAPTION(Barcode barcode) {
	...
	public CAPTION(DataDownload dataDownload) {
	...
	public CAPTION(ImageObject imageObject) {
	...
	public CAPTION(LegislationObject legislationObject) {
	...
	public CAPTION(MediaObject mediaObject) {
	...
	public CAPTION(MusicVideoObject musicVideoObject) {
	...
	public CAPTION(VideoObject videoObject) {
	...
	public CAPTION(List<AudioObject> audioObjectList,
	...
	public void copy(Container.Caption org) {
