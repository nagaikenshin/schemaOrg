...
public class DEPARTMENT implements Container.Department {
	...
	public DEPARTMENT(AccountingService accountingService) {
	...
	public DEPARTMENT(AdultEntertainment adultEntertainment) {
	...
	public DEPARTMENT(Airline airline) {
	...
	public DEPARTMENT(AmusementPark amusementPark) {
	...
	public DEPARTMENT(AnimalShelter animalShelter) {
	...
	public DEPARTMENT(ArchiveOrganization archiveOrganization) {
	...
	public DEPARTMENT(ArtGallery artGallery) {
	...
	public DEPARTMENT(Attorney attorney) {
	...
	public DEPARTMENT(AutoBodyShop autoBodyShop) {
	...
	public DEPARTMENT(AutoDealer autoDealer) {
	...
	public DEPARTMENT(AutoPartsStore autoPartsStore) {
	...
	public DEPARTMENT(AutoRental autoRental) {
	...
	public DEPARTMENT(AutoRepair autoRepair) {
	...
	public DEPARTMENT(AutoWash autoWash) {
	...
	public DEPARTMENT(AutomatedTeller automatedTeller) {
	...
	public DEPARTMENT(AutomotiveBusiness automotiveBusiness) {
	...
	public DEPARTMENT(Bakery bakery) {
	...
	public DEPARTMENT(BankOrCreditUnion bankOrCreditUnion) {
	...
	public DEPARTMENT(BarOrPub barOrPub) {
	...
	public DEPARTMENT(BeautySalon beautySalon) {
	...
	public DEPARTMENT(BedAndBreakfast bedAndBreakfast) {
	...
	public DEPARTMENT(BikeStore bikeStore) {
	...
	public DEPARTMENT(BookStore bookStore) {
	...
	public DEPARTMENT(BowlingAlley bowlingAlley) {
	...
	public DEPARTMENT(Brewery brewery) {
	...
	public DEPARTMENT(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public DEPARTMENT(Campground campground) {
	...
	public DEPARTMENT(Casino casino) {
	...
	public DEPARTMENT(ChildCare childCare) {
	...
	public DEPARTMENT(ClothingStore clothingStore) {
	...
	public DEPARTMENT(CollegeOrUniversity collegeOrUniversity) {
	...
	public DEPARTMENT(ComedyClub comedyClub) {
	...
	public DEPARTMENT(CommunityHealth communityHealth) {
	...
	public DEPARTMENT(ComputerStore computerStore) {
	...
	public DEPARTMENT(Consortium consortium) {
	...
	public DEPARTMENT(ConvenienceStore convenienceStore) {
	...
	public DEPARTMENT(Corporation corporation) {
	...
	public DEPARTMENT(DanceGroup danceGroup) {
	...
	public DEPARTMENT(DaySpa daySpa) {
	...
	public DEPARTMENT(Dentist dentist) {
	...
	public DEPARTMENT(DepartmentStore departmentStore) {
	...
	public DEPARTMENT(Dermatology dermatology) {
	...
	public DEPARTMENT(DiagnosticLab diagnosticLab) {
	...
	public DEPARTMENT(DietNutrition dietNutrition) {
	...
	public DEPARTMENT(Distillery distillery) {
	...
	public DEPARTMENT(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public DEPARTMENT(EducationalOrganization educationalOrganization) {
	...
	public DEPARTMENT(Electrician electrician) {
	...
	public DEPARTMENT(ElectronicsStore electronicsStore) {
	...
	public DEPARTMENT(ElementarySchool elementarySchool) {
	...
	public DEPARTMENT(Emergency emergency) {
	...
	public DEPARTMENT(EmergencyService emergencyService) {
	...
	public DEPARTMENT(EmploymentAgency employmentAgency) {
	...
	public DEPARTMENT(EntertainmentBusiness entertainmentBusiness) {
	...
	public DEPARTMENT(ExerciseGym exerciseGym) {
	...
	public DEPARTMENT(FastFoodRestaurant fastFoodRestaurant) {
	...
	public DEPARTMENT(FinancialService financialService) {
	...
	public DEPARTMENT(FireStation fireStation) {
	...
	public DEPARTMENT(Florist florist) {
	...
	public DEPARTMENT(FoodEstablishment foodEstablishment) {
	...
	public DEPARTMENT(FundingAgency fundingAgency) {
	...
	public DEPARTMENT(FundingScheme fundingScheme) {
	...
	public DEPARTMENT(FurnitureStore furnitureStore) {
	...
	public DEPARTMENT(GardenStore gardenStore) {
	...
	public DEPARTMENT(GasStation gasStation) {
	...
	public DEPARTMENT(GeneralContractor generalContractor) {
	...
	public DEPARTMENT(Geriatric geriatric) {
	...
	public DEPARTMENT(GolfCourse golfCourse) {
	...
	public DEPARTMENT(GovernmentOffice governmentOffice) {
	...
	public DEPARTMENT(GovernmentOrganization governmentOrganization) {
	...
	public DEPARTMENT(GroceryStore groceryStore) {
	...
	public DEPARTMENT(Gynecologic gynecologic) {
	...
	public DEPARTMENT(HVACBusiness hvacBusiness) {
	...
	public DEPARTMENT(HairSalon hairSalon) {
	...
	public DEPARTMENT(HardwareStore hardwareStore) {
	...
	public DEPARTMENT(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public DEPARTMENT(HealthClub healthClub) {
	...
	public DEPARTMENT(HighSchool highSchool) {
	...
	public DEPARTMENT(HobbyShop hobbyShop) {
	...
	public DEPARTMENT(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public DEPARTMENT(HomeGoodsStore homeGoodsStore) {
	...
	public DEPARTMENT(Hostel hostel) {
	...
	public DEPARTMENT(HousePainter housePainter) {
	...
	public DEPARTMENT(IceCreamShop iceCreamShop) {
	...
	public DEPARTMENT(InsuranceAgency insuranceAgency) {
	...
	public DEPARTMENT(InternetCafe internetCafe) {
	...
	public DEPARTMENT(JewelryStore jewelryStore) {
	...
	public DEPARTMENT(LegalService legalService) {
	...
	public DEPARTMENT(LibrarySystem librarySystem) {
	...
	public DEPARTMENT(LiquorStore liquorStore) {
	...
	public DEPARTMENT(LocalBusiness localBusiness) {
	...
	public DEPARTMENT(Locksmith locksmith) {
	...
	public DEPARTMENT(LodgingBusiness lodgingBusiness) {
	...
	public DEPARTMENT(MedicalBusiness medicalBusiness) {
	...
	public DEPARTMENT(MedicalClinic medicalClinic) {
	...
	public DEPARTMENT(MedicalOrganization medicalOrganization) {
	...
	public DEPARTMENT(MensClothingStore mensClothingStore) {
	...
	public DEPARTMENT(MiddleSchool middleSchool) {
	...
	public DEPARTMENT(Midwifery midwifery) {
	...
	public DEPARTMENT(MobilePhoneStore mobilePhoneStore) {
	...
	public DEPARTMENT(MotorcycleDealer motorcycleDealer) {
	...
	public DEPARTMENT(MotorcycleRepair motorcycleRepair) {
	...
	public DEPARTMENT(MovieRentalStore movieRentalStore) {
	...
	public DEPARTMENT(MovieTheater movieTheater) {
	...
	public DEPARTMENT(MovingCompany movingCompany) {
	...
	public DEPARTMENT(MusicGroup musicGroup) {
	...
	public DEPARTMENT(MusicStore musicStore) {
	...
	public DEPARTMENT(NailSalon nailSalon) {
	...
	public DEPARTMENT(NewsMediaOrganization newsMediaOrganization) {
	...
	public DEPARTMENT(NightClub nightClub) {
	...
	public DEPARTMENT(Notary notary) {
	...
	public DEPARTMENT(Nursing nursing) {
	...
	public DEPARTMENT(Obstetric obstetric) {
	...
	public DEPARTMENT(OfficeEquipmentStore officeEquipmentStore) {
	...
	public DEPARTMENT(Oncologic oncologic) {
	...
	public DEPARTMENT(Optician optician) {
	...
	public DEPARTMENT(Optometric optometric) {
	...
	public DEPARTMENT(Otolaryngologic otolaryngologic) {
	...
	public DEPARTMENT(OutletStore outletStore) {
	...
	public DEPARTMENT(PawnShop pawnShop) {
	...
	public DEPARTMENT(Pediatric pediatric) {
	...
	public DEPARTMENT(PerformingGroup performingGroup) {
	...
	public DEPARTMENT(PetStore petStore) {
	...
	public DEPARTMENT(Pharmacy pharmacy) {
	...
	public DEPARTMENT(Physician physician) {
	...
	public DEPARTMENT(Physiotherapy physiotherapy) {
	...
	public DEPARTMENT(PlasticSurgery plasticSurgery) {
	...
	public DEPARTMENT(Plumber plumber) {
	...
	public DEPARTMENT(Podiatric podiatric) {
	...
	public DEPARTMENT(PoliceStation policeStation) {
	...
	public DEPARTMENT(PostOffice postOffice) {
	...
	public DEPARTMENT(Preschool preschool) {
	...
	public DEPARTMENT(PrimaryCare primaryCare) {
	...
	public DEPARTMENT(ProfessionalService professionalService) {
	...
	public DEPARTMENT(Project project) {
	...
	public DEPARTMENT(Psychiatric psychiatric) {
	...
	public DEPARTMENT(PublicHealth publicHealth) {
	...
	public DEPARTMENT(PublicSwimmingPool publicSwimmingPool) {
	...
	public DEPARTMENT(RadioStation radioStation) {
	...
	public DEPARTMENT(RealEstateAgent realEstateAgent) {
	...
	public DEPARTMENT(RecyclingCenter recyclingCenter) {
	...
	public DEPARTMENT(ResearchProject researchProject) {
	...
	public DEPARTMENT(Resort resort) {
	...
	public DEPARTMENT(Restaurant restaurant) {
	...
	public DEPARTMENT(RoofingContractor roofingContractor) {
	...
	public DEPARTMENT(School school) {
	...
	public DEPARTMENT(SelfStorage selfStorage) {
	...
	public DEPARTMENT(ShoeStore shoeStore) {
	...
	public DEPARTMENT(ShoppingCenter shoppingCenter) {
	...
	public DEPARTMENT(SkiResort skiResort) {
	...
	public DEPARTMENT(SportingGoodsStore sportingGoodsStore) {
	...
	public DEPARTMENT(SportsActivityLocation sportsActivityLocation) {
	...
	public DEPARTMENT(SportsClub sportsClub) {
	...
	public DEPARTMENT(SportsOrganization sportsOrganization) {
	...
	public DEPARTMENT(SportsTeam sportsTeam) {
	...
	public DEPARTMENT(StadiumOrArena stadiumOrArena) {
	...
	public DEPARTMENT(TattooParlor tattooParlor) {
	...
	public DEPARTMENT(TelevisionStation televisionStation) {
	...
	public DEPARTMENT(TennisComplex tennisComplex) {
	...
	public DEPARTMENT(TheaterGroup theaterGroup) {
	...
	public DEPARTMENT(TireShop tireShop) {
	...
	public DEPARTMENT(TouristInformationCenter touristInformationCenter) {
	...
	public DEPARTMENT(ToyStore toyStore) {
	...
	public DEPARTMENT(TravelAgency travelAgency) {
	...
	public DEPARTMENT(VeterinaryCare veterinaryCare) {
	...
	public DEPARTMENT(WholesaleStore wholesaleStore) {
	...
	public DEPARTMENT(Winery winery) {
	...
	public DEPARTMENT(WorkersUnion workersUnion) {
	...
	public void copy(Container.Department org) {
