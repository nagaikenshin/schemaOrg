...
public class WORK_FEATURED implements Container.WorkFeatured {
	...
	public WORK_FEATURED(String string) {
	...
	public WORK_FEATURED(APIReference apiReference) {
	...
	public WORK_FEATURED(AboutPage aboutPage) {
	...
	public WORK_FEATURED(AdvertiserContentArticle advertiserContentArticle) {
	...
	public WORK_FEATURED(AnalysisNewsArticle analysisNewsArticle) {
	...
	public WORK_FEATURED(Answer answer) {
	...
	public WORK_FEATURED(ArchiveComponent archiveComponent) {
	...
	public WORK_FEATURED(Article article) {
	...
	public WORK_FEATURED(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public WORK_FEATURED(Atlas atlas) {
	...
	public WORK_FEATURED(AudioObject audioObject) {
	...
	public WORK_FEATURED(Audiobook audiobook) {
	...
	public WORK_FEATURED(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public WORK_FEATURED(Barcode barcode) {
	...
	public WORK_FEATURED(Blog blog) {
	...
	public WORK_FEATURED(BlogPosting blogPosting) {
	...
	public WORK_FEATURED(Book book) {
	...
	public WORK_FEATURED(BookSeries bookSeries) {
	...
	public WORK_FEATURED(CategoryCodeSet categoryCodeSet) {
	...
	public WORK_FEATURED(Chapter chapter) {
	...
	public WORK_FEATURED(CheckoutPage checkoutPage) {
	...
	public WORK_FEATURED(Claim claim) {
	...
	public WORK_FEATURED(ClaimReview claimReview) {
	...
	public WORK_FEATURED(Clip clip) {
	...
	public WORK_FEATURED(Collection collection) {
	...
	public WORK_FEATURED(CollectionPage collectionPage) {
	...
	public WORK_FEATURED(ComicCoverArt comicCoverArt) {
	...
	public WORK_FEATURED(ComicIssue comicIssue) {
	...
	public WORK_FEATURED(ComicSeries comicSeries) {
	...
	public WORK_FEATURED(ComicStory comicStory) {
	...
	public WORK_FEATURED(Comment comment) {
	...
	public WORK_FEATURED(CompleteDataFeed completeDataFeed) {
	...
	public WORK_FEATURED(ContactPage contactPage) {
	...
	public WORK_FEATURED(Conversation conversation) {
	...
	public WORK_FEATURED(CorrectionComment correctionComment) {
	...
	public WORK_FEATURED(Course course) {
	...
	public WORK_FEATURED(CoverArt coverArt) {
	...
	public WORK_FEATURED(CreativeWork creativeWork) {
		creativeWorkList = new ArrayList<CreativeWork>();
	...
	public WORK_FEATURED(CreativeWorkSeason creativeWorkSeason) {
	...
	public WORK_FEATURED(CreativeWorkSeries creativeWorkSeries) {
	...
	public WORK_FEATURED(CriticReview criticReview) {
	...
	public WORK_FEATURED(DataCatalog dataCatalog) {
	...
	public WORK_FEATURED(DataDownload dataDownload) {
	...
	public WORK_FEATURED(DataFeed dataFeed) {
	...
	public WORK_FEATURED(Dataset dataset) {
	...
	public WORK_FEATURED(DefinedTermSet definedTermSet) {
	...
	public WORK_FEATURED(Diet diet) {
	...
	public WORK_FEATURED(DigitalDocument digitalDocument) {
	...
	public WORK_FEATURED(DiscussionForumPosting discussionForumPosting) {
	...
	public WORK_FEATURED(Drawing drawing) {
	...
	public WORK_FEATURED(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public WORK_FEATURED(EmailMessage emailMessage) {
	...
	public WORK_FEATURED(EmployerReview employerReview) {
	...
	public WORK_FEATURED(Episode episode) {
	...
	public WORK_FEATURED(ExercisePlan exercisePlan) {
	...
	public WORK_FEATURED(FAQPage faqPage) {
	...
	public WORK_FEATURED(Game game) {
	...
	public WORK_FEATURED(HowTo howTo) {
	...
	public WORK_FEATURED(HowToDirection howToDirection) {
	...
	public WORK_FEATURED(HowToSection howToSection) {
	...
	public WORK_FEATURED(HowToStep howToStep) {
	...
	public WORK_FEATURED(HowToTip howToTip) {
	...
	public WORK_FEATURED(ImageGallery imageGallery) {
	...
	public WORK_FEATURED(ImageObject imageObject) {
	...
	public WORK_FEATURED(ItemPage itemPage) {
	...
	public WORK_FEATURED(Legislation legislation) {
	...
	public WORK_FEATURED(LegislationObject legislationObject) {
	...
	public WORK_FEATURED(LiveBlogPosting liveBlogPosting) {
	...
	public WORK_FEATURED(Manuscript manuscript) {
	...
	public WORK_FEATURED(MediaObject mediaObject) {
	...
	public WORK_FEATURED(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public WORK_FEATURED(MedicalWebPage medicalWebPage) {
	...
	public WORK_FEATURED(Menu menu) {
	...
	public WORK_FEATURED(MenuSection menuSection) {
	...
	public WORK_FEATURED(Message message) {
	...
	public WORK_FEATURED(MobileApplication mobileApplication) {
	...
	public WORK_FEATURED(Movie movie) {
	...
	public WORK_FEATURED(MovieClip movieClip) {
	...
	public WORK_FEATURED(MovieSeries movieSeries) {
	...
	public WORK_FEATURED(MusicAlbum musicAlbum) {
	...
	public WORK_FEATURED(MusicComposition musicComposition) {
	...
	public WORK_FEATURED(MusicPlaylist musicPlaylist) {
	...
	public WORK_FEATURED(MusicRecording musicRecording) {
	...
	public WORK_FEATURED(MusicRelease musicRelease) {
	...
	public WORK_FEATURED(MusicVideoObject musicVideoObject) {
	...
	public WORK_FEATURED(NewsArticle newsArticle) {
	...
	public WORK_FEATURED(Newspaper newspaper) {
	...
	public WORK_FEATURED(NoteDigitalDocument noteDigitalDocument) {
	...
	public WORK_FEATURED(OpinionNewsArticle opinionNewsArticle) {
	...
	public WORK_FEATURED(Painting painting) {
	...
	public WORK_FEATURED(Periodical periodical) {
	...
	public WORK_FEATURED(Photograph photograph) {
	...
	public WORK_FEATURED(Play play) {
	...
	public WORK_FEATURED(Poster poster) {
	...
	public WORK_FEATURED(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public WORK_FEATURED(ProfilePage profilePage) {
	...
	public WORK_FEATURED(PublicationIssue publicationIssue) {
	...
	public WORK_FEATURED(PublicationVolume publicationVolume) {
	...
	public WORK_FEATURED(QAPage qaPage) {
	...
	public WORK_FEATURED(Question question) {
	...
	public WORK_FEATURED(Quotation quotation) {
	...
	public WORK_FEATURED(RadioClip radioClip) {
	...
	public WORK_FEATURED(RadioEpisode radioEpisode) {
	...
	public WORK_FEATURED(RadioSeason radioSeason) {
	...
	public WORK_FEATURED(RadioSeries radioSeries) {
	...
	public WORK_FEATURED(Recipe recipe) {
	...
	public WORK_FEATURED(Report report) {
	...
	public WORK_FEATURED(ReportageNewsArticle reportageNewsArticle) {
	...
	public WORK_FEATURED(Review review) {
	...
	public WORK_FEATURED(ReviewNewsArticle reviewNewsArticle) {
	...
	public WORK_FEATURED(SatiricalArticle satiricalArticle) {
	...
	public WORK_FEATURED(ScholarlyArticle scholarlyArticle) {
	...
	public WORK_FEATURED(Sculpture sculpture) {
	...
	public WORK_FEATURED(SearchResultsPage searchResultsPage) {
	...
	public WORK_FEATURED(SheetMusic sheetMusic) {
	...
	public WORK_FEATURED(ShortStory shortStory) {
	...
	public WORK_FEATURED(SiteNavigationElement siteNavigationElement) {
	...
	public WORK_FEATURED(SocialMediaPosting socialMediaPosting) {
	...
	public WORK_FEATURED(SoftwareApplication softwareApplication) {
	...
	public WORK_FEATURED(SoftwareSourceCode softwareSourceCode) {
	...
	public WORK_FEATURED(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public WORK_FEATURED(TVClip tvClip) {
	...
	public WORK_FEATURED(TVEpisode tvEpisode) {
	...
	public WORK_FEATURED(TVSeason tvSeason) {
	...
	public WORK_FEATURED(TVSeries tvSeries) {
	...
	public WORK_FEATURED(Table table) {
	...
	public WORK_FEATURED(TechArticle techArticle) {
	...
	public WORK_FEATURED(TextDigitalDocument textDigitalDocument) {
	...
	public WORK_FEATURED(Thesis thesis) {
	...
	public WORK_FEATURED(ThreeDimensionalModel threeDimensionalModel) {
	...
	public WORK_FEATURED(UserReview userReview) {
	...
	public WORK_FEATURED(VideoGallery videoGallery) {
	...
	public WORK_FEATURED(VideoGame videoGame) {
	...
	public WORK_FEATURED(VideoGameClip videoGameClip) {
	...
	public WORK_FEATURED(VideoGameSeries videoGameSeries) {
	...
	public WORK_FEATURED(VideoObject videoObject) {
	...
	public WORK_FEATURED(VisualArtwork visualArtwork) {
	...
	public WORK_FEATURED(WPAdBlock wpAdBlock) {
	...
	public WORK_FEATURED(WPFooter wpFooter) {
	...
	public WORK_FEATURED(WPHeader wpHeader) {
	...
	public WORK_FEATURED(WPSideBar wpSideBar) {
	...
	public WORK_FEATURED(WebApplication webApplication) {
	...
	public WORK_FEATURED(WebPage webPage) {
	...
	public WORK_FEATURED(WebPageElement webPageElement) {
	...
	public WORK_FEATURED(WebSite webSite) {
	...
	public void copy(Container.WorkFeatured org) {
