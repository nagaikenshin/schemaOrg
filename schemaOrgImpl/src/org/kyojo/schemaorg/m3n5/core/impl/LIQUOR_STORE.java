...
public class LIQUOR_STORE implements Clazz.LiquorStore {
	...
	public LIQUOR_STORE(GeoContains geoContains) {
	...
	public LIQUOR_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public LIQUOR_STORE(GeoCovers geoCovers) {
	...
	public LIQUOR_STORE(GeoCrosses geoCrosses) {
	...
	public LIQUOR_STORE(GeoDisjoint geoDisjoint) {
	...
	public LIQUOR_STORE(GeoEquals geoEquals) {
	...
	public LIQUOR_STORE(GeoIntersects geoIntersects) {
	...
	public LIQUOR_STORE(GeoOverlaps geoOverlaps) {
	...
	public LIQUOR_STORE(GeoTouches geoTouches) {
	...
	public LIQUOR_STORE(GeoWithin geoWithin) {
	...
	public LIQUOR_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
