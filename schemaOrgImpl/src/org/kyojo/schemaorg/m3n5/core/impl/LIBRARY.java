...
public class LIBRARY implements Clazz.Library {
	...
	public LIBRARY(GeoContains geoContains) {
	...
	public LIBRARY(GeoCoveredBy geoCoveredBy) {
	...
	public LIBRARY(GeoCovers geoCovers) {
	...
	public LIBRARY(GeoCrosses geoCrosses) {
	...
	public LIBRARY(GeoDisjoint geoDisjoint) {
	...
	public LIBRARY(GeoEquals geoEquals) {
	...
	public LIBRARY(GeoIntersects geoIntersects) {
	...
	public LIBRARY(GeoOverlaps geoOverlaps) {
	...
	public LIBRARY(GeoTouches geoTouches) {
	...
	public LIBRARY(GeoWithin geoWithin) {
