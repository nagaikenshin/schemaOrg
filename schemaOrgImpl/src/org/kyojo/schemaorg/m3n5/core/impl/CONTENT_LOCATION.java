...
public class CONTENT_LOCATION implements Container.ContentLocation {
	...
	public CONTENT_LOCATION(String string) {
	...
	public CONTENT_LOCATION(Accommodation accommodation) {
	...
	public CONTENT_LOCATION(AccountingService accountingService) {
	...
	public CONTENT_LOCATION(AdministrativeArea administrativeArea) {
	...
	public CONTENT_LOCATION(AdultEntertainment adultEntertainment) {
	...
	public CONTENT_LOCATION(Airport airport) {
	...
	public CONTENT_LOCATION(AmusementPark amusementPark) {
	...
	public CONTENT_LOCATION(AnimalShelter animalShelter) {
	...
	public CONTENT_LOCATION(Apartment apartment) {
	...
	public CONTENT_LOCATION(ApartmentComplex apartmentComplex) {
	...
	public CONTENT_LOCATION(Aquarium aquarium) {
	...
	public CONTENT_LOCATION(ArchiveOrganization archiveOrganization) {
	...
	public CONTENT_LOCATION(ArtGallery artGallery) {
	...
	public CONTENT_LOCATION(Attorney attorney) {
	...
	public CONTENT_LOCATION(AutoBodyShop autoBodyShop) {
	...
	public CONTENT_LOCATION(AutoDealer autoDealer) {
	...
	public CONTENT_LOCATION(AutoPartsStore autoPartsStore) {
	...
	public CONTENT_LOCATION(AutoRental autoRental) {
	...
	public CONTENT_LOCATION(AutoRepair autoRepair) {
	...
	public CONTENT_LOCATION(AutoWash autoWash) {
	...
	public CONTENT_LOCATION(AutomatedTeller automatedTeller) {
	...
	public CONTENT_LOCATION(AutomotiveBusiness automotiveBusiness) {
	...
	public CONTENT_LOCATION(Bakery bakery) {
	...
	public CONTENT_LOCATION(BankOrCreditUnion bankOrCreditUnion) {
	...
	public CONTENT_LOCATION(BarOrPub barOrPub) {
	...
	public CONTENT_LOCATION(Beach beach) {
	...
	public CONTENT_LOCATION(BeautySalon beautySalon) {
	...
	public CONTENT_LOCATION(BedAndBreakfast bedAndBreakfast) {
	...
	public CONTENT_LOCATION(BikeStore bikeStore) {
	...
	public CONTENT_LOCATION(BodyOfWater bodyOfWater) {
	...
	public CONTENT_LOCATION(BookStore bookStore) {
	...
	public CONTENT_LOCATION(BowlingAlley bowlingAlley) {
	...
	public CONTENT_LOCATION(Brewery brewery) {
	...
	public CONTENT_LOCATION(Bridge bridge) {
	...
	public CONTENT_LOCATION(BuddhistTemple buddhistTemple) {
	...
	public CONTENT_LOCATION(BusStation busStation) {
	...
	public CONTENT_LOCATION(BusStop busStop) {
	...
	public CONTENT_LOCATION(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public CONTENT_LOCATION(Campground campground) {
	...
	public CONTENT_LOCATION(CampingPitch campingPitch) {
	...
	public CONTENT_LOCATION(Canal canal) {
	...
	public CONTENT_LOCATION(Casino casino) {
	...
	public CONTENT_LOCATION(CatholicChurch catholicChurch) {
	...
	public CONTENT_LOCATION(Cemetery cemetery) {
	...
	public CONTENT_LOCATION(ChildCare childCare) {
	...
	public CONTENT_LOCATION(Church church) {
	...
	public CONTENT_LOCATION(City city) {
	...
	public CONTENT_LOCATION(CityHall cityHall) {
	...
	public CONTENT_LOCATION(CivicStructure civicStructure) {
	...
	public CONTENT_LOCATION(ClothingStore clothingStore) {
	...
	public CONTENT_LOCATION(ComedyClub comedyClub) {
	...
	public CONTENT_LOCATION(CommunityHealth communityHealth) {
	...
	public CONTENT_LOCATION(ComputerStore computerStore) {
	...
	public CONTENT_LOCATION(Continent continent) {
	...
	public CONTENT_LOCATION(ConvenienceStore convenienceStore) {
	...
	public CONTENT_LOCATION(Country country) {
	...
	public CONTENT_LOCATION(Courthouse courthouse) {
	...
	public CONTENT_LOCATION(Crematorium crematorium) {
	...
	public CONTENT_LOCATION(DaySpa daySpa) {
	...
	public CONTENT_LOCATION(DefenceEstablishment defenceEstablishment) {
	...
	public CONTENT_LOCATION(Dentist dentist) {
	...
	public CONTENT_LOCATION(DepartmentStore departmentStore) {
	...
	public CONTENT_LOCATION(Dermatology dermatology) {
	...
	public CONTENT_LOCATION(DietNutrition dietNutrition) {
	...
	public CONTENT_LOCATION(Distillery distillery) {
	...
	public CONTENT_LOCATION(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public CONTENT_LOCATION(Electrician electrician) {
	...
	public CONTENT_LOCATION(ElectronicsStore electronicsStore) {
	...
	public CONTENT_LOCATION(Embassy embassy) {
	...
	public CONTENT_LOCATION(Emergency emergency) {
	...
	public CONTENT_LOCATION(EmergencyService emergencyService) {
	...
	public CONTENT_LOCATION(EmploymentAgency employmentAgency) {
	...
	public CONTENT_LOCATION(EntertainmentBusiness entertainmentBusiness) {
	...
	public CONTENT_LOCATION(EventVenue eventVenue) {
	...
	public CONTENT_LOCATION(ExerciseGym exerciseGym) {
	...
	public CONTENT_LOCATION(FastFoodRestaurant fastFoodRestaurant) {
	...
	public CONTENT_LOCATION(FinancialService financialService) {
	...
	public CONTENT_LOCATION(FireStation fireStation) {
	...
	public CONTENT_LOCATION(Florist florist) {
	...
	public CONTENT_LOCATION(FoodEstablishment foodEstablishment) {
	...
	public CONTENT_LOCATION(FurnitureStore furnitureStore) {
	...
	public CONTENT_LOCATION(GardenStore gardenStore) {
	...
	public CONTENT_LOCATION(GasStation gasStation) {
	...
	public CONTENT_LOCATION(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public CONTENT_LOCATION(GeneralContractor generalContractor) {
	...
	public CONTENT_LOCATION(Geriatric geriatric) {
	...
	public CONTENT_LOCATION(GolfCourse golfCourse) {
	...
	public CONTENT_LOCATION(GovernmentBuilding governmentBuilding) {
	...
	public CONTENT_LOCATION(GovernmentOffice governmentOffice) {
	...
	public CONTENT_LOCATION(GroceryStore groceryStore) {
	...
	public CONTENT_LOCATION(Gynecologic gynecologic) {
	...
	public CONTENT_LOCATION(HVACBusiness hvacBusiness) {
	...
	public CONTENT_LOCATION(HairSalon hairSalon) {
	...
	public CONTENT_LOCATION(HardwareStore hardwareStore) {
	...
	public CONTENT_LOCATION(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public CONTENT_LOCATION(HealthClub healthClub) {
	...
	public CONTENT_LOCATION(HinduTemple hinduTemple) {
	...
	public CONTENT_LOCATION(HobbyShop hobbyShop) {
	...
	public CONTENT_LOCATION(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public CONTENT_LOCATION(HomeGoodsStore homeGoodsStore) {
	...
	public CONTENT_LOCATION(Hospital hospital) {
	...
	public CONTENT_LOCATION(Hostel hostel) {
	...
	public CONTENT_LOCATION(Hotel hotel) {
	...
	public CONTENT_LOCATION(HotelRoom hotelRoom) {
	...
	public CONTENT_LOCATION(House house) {
	...
	public CONTENT_LOCATION(HousePainter housePainter) {
	...
	public CONTENT_LOCATION(IceCreamShop iceCreamShop) {
	...
	public CONTENT_LOCATION(InsuranceAgency insuranceAgency) {
	...
	public CONTENT_LOCATION(InternetCafe internetCafe) {
	...
	public CONTENT_LOCATION(JewelryStore jewelryStore) {
	...
	public CONTENT_LOCATION(LakeBodyOfWater lakeBodyOfWater) {
	...
	public CONTENT_LOCATION(Landform landform) {
	...
	public CONTENT_LOCATION(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public CONTENT_LOCATION(LegalService legalService) {
	...
	public CONTENT_LOCATION(LegislativeBuilding legislativeBuilding) {
	...
	public CONTENT_LOCATION(Library library) {
	...
	public CONTENT_LOCATION(LiquorStore liquorStore) {
	...
	public CONTENT_LOCATION(LocalBusiness localBusiness) {
	...
	public CONTENT_LOCATION(Locksmith locksmith) {
	...
	public CONTENT_LOCATION(LodgingBusiness lodgingBusiness) {
	...
	public CONTENT_LOCATION(MedicalBusiness medicalBusiness) {
	...
	public CONTENT_LOCATION(MedicalClinic medicalClinic) {
	...
	public CONTENT_LOCATION(MeetingRoom meetingRoom) {
	...
	public CONTENT_LOCATION(MensClothingStore mensClothingStore) {
	...
	public CONTENT_LOCATION(Midwifery midwifery) {
	...
	public CONTENT_LOCATION(MobilePhoneStore mobilePhoneStore) {
	...
	public CONTENT_LOCATION(Mosque mosque) {
	...
	public CONTENT_LOCATION(Motel motel) {
	...
	public CONTENT_LOCATION(MotorcycleDealer motorcycleDealer) {
	...
	public CONTENT_LOCATION(MotorcycleRepair motorcycleRepair) {
	...
	public CONTENT_LOCATION(Mountain mountain) {
	...
	public CONTENT_LOCATION(MovieRentalStore movieRentalStore) {
	...
	public CONTENT_LOCATION(MovieTheater movieTheater) {
	...
	public CONTENT_LOCATION(MovingCompany movingCompany) {
	...
	public CONTENT_LOCATION(Museum museum) {
	...
	public CONTENT_LOCATION(MusicStore musicStore) {
	...
	public CONTENT_LOCATION(MusicVenue musicVenue) {
	...
	public CONTENT_LOCATION(NailSalon nailSalon) {
	...
	public CONTENT_LOCATION(NightClub nightClub) {
	...
	public CONTENT_LOCATION(Notary notary) {
	...
	public CONTENT_LOCATION(Nursing nursing) {
	...
	public CONTENT_LOCATION(Obstetric obstetric) {
	...
	public CONTENT_LOCATION(OceanBodyOfWater oceanBodyOfWater) {
	...
	public CONTENT_LOCATION(OfficeEquipmentStore officeEquipmentStore) {
	...
	public CONTENT_LOCATION(Oncologic oncologic) {
	...
	public CONTENT_LOCATION(Optician optician) {
	...
	public CONTENT_LOCATION(Optometric optometric) {
	...
	public CONTENT_LOCATION(Otolaryngologic otolaryngologic) {
	...
	public CONTENT_LOCATION(OutletStore outletStore) {
	...
	public CONTENT_LOCATION(Park park) {
	...
	public CONTENT_LOCATION(ParkingFacility parkingFacility) {
	...
	public CONTENT_LOCATION(PawnShop pawnShop) {
	...
	public CONTENT_LOCATION(Pediatric pediatric) {
	...
	public CONTENT_LOCATION(PerformingArtsTheater performingArtsTheater) {
	...
	public CONTENT_LOCATION(PetStore petStore) {
	...
	public CONTENT_LOCATION(Pharmacy pharmacy) {
	...
	public CONTENT_LOCATION(Physician physician) {
	...
	public CONTENT_LOCATION(Physiotherapy physiotherapy) {
	...
	public CONTENT_LOCATION(Place place) {
		placeList = new ArrayList<Place>();
		placeList.add(place);
	}
	...
	public CONTENT_LOCATION(PlaceOfWorship placeOfWorship) {
	...
	public CONTENT_LOCATION(PlasticSurgery plasticSurgery) {
	...
	public CONTENT_LOCATION(Playground playground) {
	...
	public CONTENT_LOCATION(Plumber plumber) {
	...
	public CONTENT_LOCATION(Podiatric podiatric) {
	...
	public CONTENT_LOCATION(PoliceStation policeStation) {
	...
	public CONTENT_LOCATION(Pond pond) {
	...
	public CONTENT_LOCATION(PostOffice postOffice) {
	...
	public CONTENT_LOCATION(PrimaryCare primaryCare) {
	...
	public CONTENT_LOCATION(ProfessionalService professionalService) {
	...
	public CONTENT_LOCATION(Psychiatric psychiatric) {
	...
	public CONTENT_LOCATION(PublicHealth publicHealth) {
	...
	public CONTENT_LOCATION(PublicSwimmingPool publicSwimmingPool) {
	...
	public CONTENT_LOCATION(PublicToilet publicToilet) {
	...
	public CONTENT_LOCATION(RVPark rvPark) {
	...
	public CONTENT_LOCATION(RadioStation radioStation) {
	...
	public CONTENT_LOCATION(RealEstateAgent realEstateAgent) {
	...
	public CONTENT_LOCATION(RecyclingCenter recyclingCenter) {
	...
	public CONTENT_LOCATION(Reservoir reservoir) {
	...
	public CONTENT_LOCATION(Residence residence) {
	...
	public CONTENT_LOCATION(Resort resort) {
	...
	public CONTENT_LOCATION(Restaurant restaurant) {
	...
	public CONTENT_LOCATION(RiverBodyOfWater riverBodyOfWater) {
	...
	public CONTENT_LOCATION(RoofingContractor roofingContractor) {
	...
	public CONTENT_LOCATION(Room room) {
	...
	public CONTENT_LOCATION(SeaBodyOfWater seaBodyOfWater) {
	...
	public CONTENT_LOCATION(SelfStorage selfStorage) {
	...
	public CONTENT_LOCATION(ShoeStore shoeStore) {
	...
	public CONTENT_LOCATION(ShoppingCenter shoppingCenter) {
	...
	public CONTENT_LOCATION(SingleFamilyResidence singleFamilyResidence) {
	...
	public CONTENT_LOCATION(SkiResort skiResort) {
	...
	public CONTENT_LOCATION(SportingGoodsStore sportingGoodsStore) {
	...
	public CONTENT_LOCATION(SportsActivityLocation sportsActivityLocation) {
	...
	public CONTENT_LOCATION(SportsClub sportsClub) {
	...
	public CONTENT_LOCATION(StadiumOrArena stadiumOrArena) {
	...
	public CONTENT_LOCATION(State state) {
	...
	public CONTENT_LOCATION(Store store) {
	...
	public CONTENT_LOCATION(SubwayStation subwayStation) {
	...
	public CONTENT_LOCATION(Suite suite) {
	...
	public CONTENT_LOCATION(Synagogue synagogue) {
	...
	public CONTENT_LOCATION(TattooParlor tattooParlor) {
	...
	public CONTENT_LOCATION(TaxiStand taxiStand) {
	...
	public CONTENT_LOCATION(TelevisionStation televisionStation) {
	...
	public CONTENT_LOCATION(TennisComplex tennisComplex) {
	...
	public CONTENT_LOCATION(TireShop tireShop) {
	...
	public CONTENT_LOCATION(TouristAttraction touristAttraction) {
	...
	public CONTENT_LOCATION(TouristDestination touristDestination) {
	...
	public CONTENT_LOCATION(TouristInformationCenter touristInformationCenter) {
	...
	public CONTENT_LOCATION(ToyStore toyStore) {
	...
	public CONTENT_LOCATION(TrainStation trainStation) {
	...
	public CONTENT_LOCATION(TravelAgency travelAgency) {
	...
	public CONTENT_LOCATION(Volcano volcano) {
	...
	public CONTENT_LOCATION(Waterfall waterfall) {
	...
	public CONTENT_LOCATION(WholesaleStore wholesaleStore) {
	...
	public CONTENT_LOCATION(Winery winery) {
	...
	public CONTENT_LOCATION(Zoo zoo) {
	...
	public void copy(Container.ContentLocation org) {
