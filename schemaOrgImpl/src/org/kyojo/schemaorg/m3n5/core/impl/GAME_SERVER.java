...
import org.kyojo.schemaorg.m3n5.core.Container.PlayersOnline;
...
public class GAME_SERVER implements Clazz.GameServer, Container.GameServer {
	...
	public PlayersOnline playersOnline;
	...
	public GAME_SERVER(String string) {
	...
	public GAME_SERVER(AdditionalType additionalType) {
	...
	public GAME_SERVER(AlternateName alternateName) {
	...
	public GAME_SERVER(Description description) {
	...
	public GAME_SERVER(DisambiguatingDescription disambiguatingDescription) {
	...
	public GAME_SERVER(Clazz.GameServer gameServer) {
		gameServerList = new ArrayList<Clazz.GameServer>();
	...
	public GAME_SERVER(Identifier identifier) {
	...
	public GAME_SERVER(Image image) {
		setImage(image);
	}
	...
	public GAME_SERVER(MainEntityOfPage mainEntityOfPage) {
	...
	public GAME_SERVER(NameFuzzy nameFuzzy) {
	...
	public GAME_SERVER(NameRuby nameRuby) {
	...
	public GAME_SERVER(PlayersOnline playersOnline) {
	...
	@Override
	public void setPlayersOnline(PlayersOnline playersOnline) {
		this.playersOnline = playersOnline;
	}

	public GAME_SERVER(PotentialAction potentialAction) {
	...
	public GAME_SERVER(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public GAME_SERVER(ServerStatus serverStatus) {
	...
	public GAME_SERVER(SubjectOf subjectOf) {
	...
	public void copy(Clazz.GameServer org) {
		...
		setPlayersOnline(org.getPlayersOnline());
		setPotentialAction(org.getPotentialAction());
		setSameAs(org.getSameAs());
		setServerStatus(org.getServerStatus());
		setSubjectOf(org.getSubjectOf());
		setUrl(org.getUrl());
	}

	public void copy(Container.GameServer org) {
