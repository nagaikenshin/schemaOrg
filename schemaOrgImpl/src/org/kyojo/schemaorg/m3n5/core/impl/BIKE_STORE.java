...
public class BIKE_STORE implements Clazz.BikeStore {
	...
	public BIKE_STORE(GeoContains geoContains) {
	...
	public BIKE_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public BIKE_STORE(GeoCovers geoCovers) {
	...
	public BIKE_STORE(GeoCrosses geoCrosses) {
	...
	public BIKE_STORE(GeoDisjoint geoDisjoint) {
	...
	public BIKE_STORE(GeoEquals geoEquals) {
	...
	public BIKE_STORE(GeoIntersects geoIntersects) {
	...
	public BIKE_STORE(GeoOverlaps geoOverlaps) {
	...
	public BIKE_STORE(GeoTouches geoTouches) {
	...
	public BIKE_STORE(GeoWithin geoWithin) {
	...
	public BIKE_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
