...
public class FOUNDING_LOCATION implements Container.FoundingLocation {
	...
	public FOUNDING_LOCATION(String string) {
	...
	public FOUNDING_LOCATION(Accommodation accommodation) {
	...
	public FOUNDING_LOCATION(AccountingService accountingService) {
	...
	public FOUNDING_LOCATION(AdministrativeArea administrativeArea) {
	...
	public FOUNDING_LOCATION(AdultEntertainment adultEntertainment) {
	...
	public FOUNDING_LOCATION(Airport airport) {
	...
	public FOUNDING_LOCATION(AmusementPark amusementPark) {
	...
	public FOUNDING_LOCATION(AnimalShelter animalShelter) {
	...
	public FOUNDING_LOCATION(Apartment apartment) {
	...
	public FOUNDING_LOCATION(ApartmentComplex apartmentComplex) {
	...
	public FOUNDING_LOCATION(Aquarium aquarium) {
	...
	public FOUNDING_LOCATION(ArchiveOrganization archiveOrganization) {
	...
	public FOUNDING_LOCATION(ArtGallery artGallery) {
	...
	public FOUNDING_LOCATION(Attorney attorney) {
	...
	public FOUNDING_LOCATION(AutoBodyShop autoBodyShop) {
	...
	public FOUNDING_LOCATION(AutoDealer autoDealer) {
	...
	public FOUNDING_LOCATION(AutoPartsStore autoPartsStore) {
	...
	public FOUNDING_LOCATION(AutoRental autoRental) {
	...
	public FOUNDING_LOCATION(AutoRepair autoRepair) {
	...
	public FOUNDING_LOCATION(AutoWash autoWash) {
	...
	public FOUNDING_LOCATION(AutomatedTeller automatedTeller) {
	...
	public FOUNDING_LOCATION(AutomotiveBusiness automotiveBusiness) {
	...
	public FOUNDING_LOCATION(Bakery bakery) {
	...
	public FOUNDING_LOCATION(BankOrCreditUnion bankOrCreditUnion) {
	...
	public FOUNDING_LOCATION(BarOrPub barOrPub) {
	...
	public FOUNDING_LOCATION(Beach beach) {
	...
	public FOUNDING_LOCATION(BeautySalon beautySalon) {
	...
	public FOUNDING_LOCATION(BedAndBreakfast bedAndBreakfast) {
	...
	public FOUNDING_LOCATION(BikeStore bikeStore) {
	...
	public FOUNDING_LOCATION(BodyOfWater bodyOfWater) {
	...
	public FOUNDING_LOCATION(BookStore bookStore) {
	...
	public FOUNDING_LOCATION(BowlingAlley bowlingAlley) {
	...
	public FOUNDING_LOCATION(Brewery brewery) {
	...
	public FOUNDING_LOCATION(Bridge bridge) {
	...
	public FOUNDING_LOCATION(BuddhistTemple buddhistTemple) {
	...
	public FOUNDING_LOCATION(BusStation busStation) {
	...
	public FOUNDING_LOCATION(BusStop busStop) {
	...
	public FOUNDING_LOCATION(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public FOUNDING_LOCATION(Campground campground) {
	...
	public FOUNDING_LOCATION(CampingPitch campingPitch) {
	...
	public FOUNDING_LOCATION(Canal canal) {
	...
	public FOUNDING_LOCATION(Casino casino) {
	...
	public FOUNDING_LOCATION(CatholicChurch catholicChurch) {
	...
	public FOUNDING_LOCATION(Cemetery cemetery) {
	...
	public FOUNDING_LOCATION(ChildCare childCare) {
	...
	public FOUNDING_LOCATION(Church church) {
	...
	public FOUNDING_LOCATION(City city) {
	...
	public FOUNDING_LOCATION(CityHall cityHall) {
	...
	public FOUNDING_LOCATION(CivicStructure civicStructure) {
	...
	public FOUNDING_LOCATION(ClothingStore clothingStore) {
	...
	public FOUNDING_LOCATION(ComedyClub comedyClub) {
	...
	public FOUNDING_LOCATION(CommunityHealth communityHealth) {
	...
	public FOUNDING_LOCATION(ComputerStore computerStore) {
	...
	public FOUNDING_LOCATION(Continent continent) {
	...
	public FOUNDING_LOCATION(ConvenienceStore convenienceStore) {
	...
	public FOUNDING_LOCATION(Country country) {
	...
	public FOUNDING_LOCATION(Courthouse courthouse) {
	...
	public FOUNDING_LOCATION(Crematorium crematorium) {
	...
	public FOUNDING_LOCATION(DaySpa daySpa) {
	...
	public FOUNDING_LOCATION(DefenceEstablishment defenceEstablishment) {
	...
	public FOUNDING_LOCATION(Dentist dentist) {
	...
	public FOUNDING_LOCATION(DepartmentStore departmentStore) {
	...
	public FOUNDING_LOCATION(Dermatology dermatology) {
	...
	public FOUNDING_LOCATION(DietNutrition dietNutrition) {
	...
	public FOUNDING_LOCATION(Distillery distillery) {
	...
	public FOUNDING_LOCATION(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public FOUNDING_LOCATION(Electrician electrician) {
	...
	public FOUNDING_LOCATION(ElectronicsStore electronicsStore) {
	...
	public FOUNDING_LOCATION(Embassy embassy) {
	...
	public FOUNDING_LOCATION(Emergency emergency) {
	...
	public FOUNDING_LOCATION(EmergencyService emergencyService) {
	...
	public FOUNDING_LOCATION(EmploymentAgency employmentAgency) {
	...
	public FOUNDING_LOCATION(EntertainmentBusiness entertainmentBusiness) {
	...
	public FOUNDING_LOCATION(EventVenue eventVenue) {
	...
	public FOUNDING_LOCATION(ExerciseGym exerciseGym) {
	...
	public FOUNDING_LOCATION(FastFoodRestaurant fastFoodRestaurant) {
	...
	public FOUNDING_LOCATION(FinancialService financialService) {
	...
	public FOUNDING_LOCATION(FireStation fireStation) {
	...
	public FOUNDING_LOCATION(Florist florist) {
	...
	public FOUNDING_LOCATION(FoodEstablishment foodEstablishment) {
	...
	public FOUNDING_LOCATION(FurnitureStore furnitureStore) {
	...
	public FOUNDING_LOCATION(GardenStore gardenStore) {
	...
	public FOUNDING_LOCATION(GasStation gasStation) {
	...
	public FOUNDING_LOCATION(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public FOUNDING_LOCATION(GeneralContractor generalContractor) {
	...
	public FOUNDING_LOCATION(Geriatric geriatric) {
	...
	public FOUNDING_LOCATION(GolfCourse golfCourse) {
	...
	public FOUNDING_LOCATION(GovernmentBuilding governmentBuilding) {
	...
	public FOUNDING_LOCATION(GovernmentOffice governmentOffice) {
	...
	public FOUNDING_LOCATION(GroceryStore groceryStore) {
	...
	public FOUNDING_LOCATION(Gynecologic gynecologic) {
	...
	public FOUNDING_LOCATION(HVACBusiness hvacBusiness) {
	...
	public FOUNDING_LOCATION(HairSalon hairSalon) {
	...
	public FOUNDING_LOCATION(HardwareStore hardwareStore) {
	...
	public FOUNDING_LOCATION(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public FOUNDING_LOCATION(HealthClub healthClub) {
	...
	public FOUNDING_LOCATION(HinduTemple hinduTemple) {
	...
	public FOUNDING_LOCATION(HobbyShop hobbyShop) {
	...
	public FOUNDING_LOCATION(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public FOUNDING_LOCATION(HomeGoodsStore homeGoodsStore) {
	...
	public FOUNDING_LOCATION(Hospital hospital) {
	...
	public FOUNDING_LOCATION(Hostel hostel) {
	...
	public FOUNDING_LOCATION(Hotel hotel) {
	...
	public FOUNDING_LOCATION(HotelRoom hotelRoom) {
	...
	public FOUNDING_LOCATION(House house) {
	...
	public FOUNDING_LOCATION(HousePainter housePainter) {
	...
	public FOUNDING_LOCATION(IceCreamShop iceCreamShop) {
	...
	public FOUNDING_LOCATION(InsuranceAgency insuranceAgency) {
	...
	public FOUNDING_LOCATION(InternetCafe internetCafe) {
	...
	public FOUNDING_LOCATION(JewelryStore jewelryStore) {
	...
	public FOUNDING_LOCATION(LakeBodyOfWater lakeBodyOfWater) {
	...
	public FOUNDING_LOCATION(Landform landform) {
	...
	public FOUNDING_LOCATION(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public FOUNDING_LOCATION(LegalService legalService) {
	...
	public FOUNDING_LOCATION(LegislativeBuilding legislativeBuilding) {
	...
	public FOUNDING_LOCATION(Library library) {
	...
	public FOUNDING_LOCATION(LiquorStore liquorStore) {
	...
	public FOUNDING_LOCATION(LocalBusiness localBusiness) {
	...
	public FOUNDING_LOCATION(Locksmith locksmith) {
	...
	public FOUNDING_LOCATION(LodgingBusiness lodgingBusiness) {
	...
	public FOUNDING_LOCATION(MedicalBusiness medicalBusiness) {
	...
	public FOUNDING_LOCATION(MedicalClinic medicalClinic) {
	...
	public FOUNDING_LOCATION(MeetingRoom meetingRoom) {
	...
	public FOUNDING_LOCATION(MensClothingStore mensClothingStore) {
	...
	public FOUNDING_LOCATION(Midwifery midwifery) {
	...
	public FOUNDING_LOCATION(MobilePhoneStore mobilePhoneStore) {
	...
	public FOUNDING_LOCATION(Mosque mosque) {
	...
	public FOUNDING_LOCATION(Motel motel) {
	...
	public FOUNDING_LOCATION(MotorcycleDealer motorcycleDealer) {
	...
	public FOUNDING_LOCATION(MotorcycleRepair motorcycleRepair) {
	...
	public FOUNDING_LOCATION(Mountain mountain) {
	...
	public FOUNDING_LOCATION(MovieRentalStore movieRentalStore) {
	...
	public FOUNDING_LOCATION(MovieTheater movieTheater) {
	...
	public FOUNDING_LOCATION(MovingCompany movingCompany) {
	...
	public FOUNDING_LOCATION(Museum museum) {
	...
	public FOUNDING_LOCATION(MusicStore musicStore) {
	...
	public FOUNDING_LOCATION(MusicVenue musicVenue) {
	...
	public FOUNDING_LOCATION(NailSalon nailSalon) {
	...
	public FOUNDING_LOCATION(NightClub nightClub) {
	...
	public FOUNDING_LOCATION(Notary notary) {
	...
	public FOUNDING_LOCATION(Nursing nursing) {
	...
	public FOUNDING_LOCATION(Obstetric obstetric) {
	...
	public FOUNDING_LOCATION(OceanBodyOfWater oceanBodyOfWater) {
	...
	public FOUNDING_LOCATION(OfficeEquipmentStore officeEquipmentStore) {
	...
	public FOUNDING_LOCATION(Oncologic oncologic) {
	...
	public FOUNDING_LOCATION(Optician optician) {
	...
	public FOUNDING_LOCATION(Optometric optometric) {
	...
	public FOUNDING_LOCATION(Otolaryngologic otolaryngologic) {
	...
	public FOUNDING_LOCATION(OutletStore outletStore) {
	...
	public FOUNDING_LOCATION(Park park) {
	...
	public FOUNDING_LOCATION(ParkingFacility parkingFacility) {
	...
	public FOUNDING_LOCATION(PawnShop pawnShop) {
	...
	public FOUNDING_LOCATION(Pediatric pediatric) {
	...
	public FOUNDING_LOCATION(PerformingArtsTheater performingArtsTheater) {
	...
	public FOUNDING_LOCATION(PetStore petStore) {
	...
	public FOUNDING_LOCATION(Pharmacy pharmacy) {
	...
	public FOUNDING_LOCATION(Physician physician) {
	...
	public FOUNDING_LOCATION(Physiotherapy physiotherapy) {
	...
	public FOUNDING_LOCATION(Place place) {
		placeList = new ArrayList<Place>();
		placeList.add(place);
	}
	...
	public FOUNDING_LOCATION(PlaceOfWorship placeOfWorship) {
	...
	public FOUNDING_LOCATION(PlasticSurgery plasticSurgery) {
	...
	public FOUNDING_LOCATION(Playground playground) {
	...
	public FOUNDING_LOCATION(Plumber plumber) {
	...
	public FOUNDING_LOCATION(Podiatric podiatric) {
	...
	public FOUNDING_LOCATION(PoliceStation policeStation) {
	...
	public FOUNDING_LOCATION(Pond pond) {
	...
	public FOUNDING_LOCATION(PostOffice postOffice) {
	...
	public FOUNDING_LOCATION(PrimaryCare primaryCare) {
	...
	public FOUNDING_LOCATION(ProfessionalService professionalService) {
	...
	public FOUNDING_LOCATION(Psychiatric psychiatric) {
	...
	public FOUNDING_LOCATION(PublicHealth publicHealth) {
	...
	public FOUNDING_LOCATION(PublicSwimmingPool publicSwimmingPool) {
	...
	public FOUNDING_LOCATION(PublicToilet publicToilet) {
	...
	public FOUNDING_LOCATION(RVPark rvPark) {
	...
	public FOUNDING_LOCATION(RadioStation radioStation) {
	...
	public FOUNDING_LOCATION(RealEstateAgent realEstateAgent) {
	...
	public FOUNDING_LOCATION(RecyclingCenter recyclingCenter) {
	...
	public FOUNDING_LOCATION(Reservoir reservoir) {
	...
	public FOUNDING_LOCATION(Residence residence) {
	...
	public FOUNDING_LOCATION(Resort resort) {
	...
	public FOUNDING_LOCATION(Restaurant restaurant) {
	...
	public FOUNDING_LOCATION(RiverBodyOfWater riverBodyOfWater) {
	...
	public FOUNDING_LOCATION(RoofingContractor roofingContractor) {
	...
	public FOUNDING_LOCATION(Room room) {
	...
	public FOUNDING_LOCATION(SeaBodyOfWater seaBodyOfWater) {
	...
	public FOUNDING_LOCATION(SelfStorage selfStorage) {
	...
	public FOUNDING_LOCATION(ShoeStore shoeStore) {
	...
	public FOUNDING_LOCATION(ShoppingCenter shoppingCenter) {
	...
	public FOUNDING_LOCATION(SingleFamilyResidence singleFamilyResidence) {
	...
	public FOUNDING_LOCATION(SkiResort skiResort) {
	...
	public FOUNDING_LOCATION(SportingGoodsStore sportingGoodsStore) {
	...
	public FOUNDING_LOCATION(SportsActivityLocation sportsActivityLocation) {
	...
	public FOUNDING_LOCATION(SportsClub sportsClub) {
	...
	public FOUNDING_LOCATION(StadiumOrArena stadiumOrArena) {
	...
	public FOUNDING_LOCATION(State state) {
	...
	public FOUNDING_LOCATION(Store store) {
	...
	public FOUNDING_LOCATION(SubwayStation subwayStation) {
	...
	public FOUNDING_LOCATION(Suite suite) {
	...
	public FOUNDING_LOCATION(Synagogue synagogue) {
	...
	public FOUNDING_LOCATION(TattooParlor tattooParlor) {
	...
	public FOUNDING_LOCATION(TaxiStand taxiStand) {
	...
	public FOUNDING_LOCATION(TelevisionStation televisionStation) {
	...
	public FOUNDING_LOCATION(TennisComplex tennisComplex) {
	...
	public FOUNDING_LOCATION(TireShop tireShop) {
	...
	public FOUNDING_LOCATION(TouristAttraction touristAttraction) {
	...
	public FOUNDING_LOCATION(TouristDestination touristDestination) {
	...
	public FOUNDING_LOCATION(TouristInformationCenter touristInformationCenter) {
	...
	public FOUNDING_LOCATION(ToyStore toyStore) {
	...
	public FOUNDING_LOCATION(TrainStation trainStation) {
	...
	public FOUNDING_LOCATION(TravelAgency travelAgency) {
	...
	public FOUNDING_LOCATION(Volcano volcano) {
	...
	public FOUNDING_LOCATION(Waterfall waterfall) {
	...
	public FOUNDING_LOCATION(WholesaleStore wholesaleStore) {
	...
	public FOUNDING_LOCATION(Winery winery) {
	...
	public FOUNDING_LOCATION(Zoo zoo) {
	...
	public void copy(Container.FoundingLocation org) {
