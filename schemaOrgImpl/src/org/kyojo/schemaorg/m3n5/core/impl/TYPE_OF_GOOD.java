...
public class TYPE_OF_GOOD implements Container.TypeOfGood {
	...
	public TYPE_OF_GOOD(BankAccount bankAccount) {
	...
	public TYPE_OF_GOOD(BroadcastService broadcastService) {
	...
	public TYPE_OF_GOOD(BrokerageAccount brokerageAccount) {
	...
	public TYPE_OF_GOOD(BusOrCoach busOrCoach) {
	...
	public TYPE_OF_GOOD(CableOrSatelliteService cableOrSatelliteService) {
	...
	public TYPE_OF_GOOD(CreditCard creditCard) {
	...
	public TYPE_OF_GOOD(CurrencyConversionService currencyConversionService) {
	...
	public TYPE_OF_GOOD(DepositAccount depositAccount) {
	...
	public TYPE_OF_GOOD(FinancialProduct financialProduct) {
	...
	public TYPE_OF_GOOD(FoodService foodService) {
	...
	public TYPE_OF_GOOD(GovernmentService governmentService) {
	...
	public TYPE_OF_GOOD(IndividualProduct individualProduct) {
	...
	public TYPE_OF_GOOD(InvestmentFund investmentFund) {
	...
	public TYPE_OF_GOOD(InvestmentOrDeposit investmentOrDeposit) {
	...
	public TYPE_OF_GOOD(LoanOrCredit loanOrCredit) {
	...
	public TYPE_OF_GOOD(MortgageLoan mortgageLoan) {
	...
	public TYPE_OF_GOOD(Motorcycle motorcycle) {
	...
	public TYPE_OF_GOOD(MotorizedBicycle motorizedBicycle) {
	...
	public TYPE_OF_GOOD(PaymentCard paymentCard) {
	...
	public TYPE_OF_GOOD(PaymentService paymentService) {
	...
	public TYPE_OF_GOOD(ProductModel productModel) {
	...
	public TYPE_OF_GOOD(RadioBroadcastService radioBroadcastService) {
	...
	public TYPE_OF_GOOD(SomeProducts someProducts) {
	...
	public TYPE_OF_GOOD(TaxiService taxiService) {
	...
	public TYPE_OF_GOOD(Vehicle vehicle) {
	...
	public TYPE_OF_GOOD(WebAPI webAPI) {
