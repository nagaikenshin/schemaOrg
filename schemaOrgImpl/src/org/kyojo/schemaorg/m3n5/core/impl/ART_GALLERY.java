...
public class ART_GALLERY implements Clazz.ArtGallery {
	...
	public ART_GALLERY(GeoContains geoContains) {
	...
	public ART_GALLERY(GeoCoveredBy geoCoveredBy) {
	...
	public ART_GALLERY(GeoCovers geoCovers) {
	...
	public ART_GALLERY(GeoCrosses geoCrosses) {
	...
	public ART_GALLERY(GeoDisjoint geoDisjoint) {
	...
	public ART_GALLERY(GeoEquals geoEquals) {
	...
	public ART_GALLERY(GeoIntersects geoIntersects) {
	...
	public ART_GALLERY(GeoOverlaps geoOverlaps) {
	...
	public ART_GALLERY(GeoTouches geoTouches) {
	...
	public ART_GALLERY(GeoWithin geoWithin) {
	...
	public ART_GALLERY(Slogan slogan) {
		setSlogan(slogan);
	}
