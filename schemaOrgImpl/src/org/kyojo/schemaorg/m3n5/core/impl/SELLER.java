...
public class SELLER implements Container.Seller {
	...
	public SELLER(AccountingService accountingService) {
	...
	public SELLER(AdultEntertainment adultEntertainment) {
	...
	public SELLER(AmusementPark amusementPark) {
	...
	public SELLER(AnimalShelter animalShelter) {
	...
	public SELLER(ArchiveOrganization archiveOrganization) {
	...
	public SELLER(ArtGallery artGallery) {
	...
	public SELLER(Attorney attorney) {
	...
	public SELLER(AutoBodyShop autoBodyShop) {
	...
	public SELLER(AutoDealer autoDealer) {
	...
	public SELLER(AutoPartsStore autoPartsStore) {
	...
	public SELLER(AutoRental autoRental) {
	...
	public SELLER(AutoRepair autoRepair) {
	...
	public SELLER(AutoWash autoWash) {
	...
	public SELLER(AutomatedTeller automatedTeller) {
	...
	public SELLER(AutomotiveBusiness automotiveBusiness) {
	...
	public SELLER(BankOrCreditUnion bankOrCreditUnion) {
	...
	public SELLER(BarOrPub barOrPub) {
	...
	public SELLER(BeautySalon beautySalon) {
	...
	public SELLER(BedAndBreakfast bedAndBreakfast) {
	...
	public SELLER(BikeStore bikeStore) {
	...
	public SELLER(BowlingAlley bowlingAlley) {
	...
	public SELLER(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public SELLER(Campground campground) {
	...
	public SELLER(ChildCare childCare) {
	...
	public SELLER(ClothingStore clothingStore) {
	...
	public SELLER(CollegeOrUniversity collegeOrUniversity) {
	...
	public SELLER(ComedyClub comedyClub) {
	...
	public SELLER(CommunityHealth communityHealth) {
	...
	public SELLER(ComputerStore computerStore) {
	...
	public SELLER(Consortium consortium) {
	...
	public SELLER(ConvenienceStore convenienceStore) {
	...
	public SELLER(Corporation corporation) {
	...
	public SELLER(DanceGroup danceGroup) {
	...
	public SELLER(DepartmentStore departmentStore) {
	...
	public SELLER(Dermatology dermatology) {
	...
	public SELLER(DiagnosticLab diagnosticLab) {
	...
	public SELLER(DietNutrition dietNutrition) {
	...
	public SELLER(Distillery distillery) {
	...
	public SELLER(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public SELLER(EducationalOrganization educationalOrganization) {
	...
	public SELLER(Electrician electrician) {
	...
	public SELLER(ElectronicsStore electronicsStore) {
	...
	public SELLER(ElementarySchool elementarySchool) {
	...
	public SELLER(Emergency emergency) {
	...
	public SELLER(EmergencyService emergencyService) {
	...
	public SELLER(EmploymentAgency employmentAgency) {
	...
	public SELLER(EntertainmentBusiness entertainmentBusiness) {
	...
	public SELLER(ExerciseGym exerciseGym) {
	...
	public SELLER(FastFoodRestaurant fastFoodRestaurant) {
	...
	public SELLER(FinancialService financialService) {
	...
	public SELLER(FireStation fireStation) {
	...
	public SELLER(FoodEstablishment foodEstablishment) {
	...
	public SELLER(FundingAgency fundingAgency) {
	...
	public SELLER(FundingScheme fundingScheme) {
	...
	public SELLER(FurnitureStore furnitureStore) {
	...
	public SELLER(GardenStore gardenStore) {
	...
	public SELLER(GasStation gasStation) {
	...
	public SELLER(GeneralContractor generalContractor) {
	...
	public SELLER(Geriatric geriatric) {
	...
	public SELLER(GolfCourse golfCourse) {
	...
	public SELLER(GovernmentOffice governmentOffice) {
	...
	public SELLER(GovernmentOrganization governmentOrganization) {
	...
	public SELLER(GroceryStore groceryStore) {
	...
	public SELLER(Gynecologic gynecologic) {
	...
	public SELLER(HVACBusiness hvacBusiness) {
	...
	public SELLER(HairSalon hairSalon) {
	...
	public SELLER(HardwareStore hardwareStore) {
	...
	public SELLER(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public SELLER(HealthClub healthClub) {
	...
	public SELLER(HighSchool highSchool) {
	...
	public SELLER(HobbyShop hobbyShop) {
	...
	public SELLER(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public SELLER(HomeGoodsStore homeGoodsStore) {
	...
	public SELLER(Hospital hospital) {
	...
	public SELLER(HousePainter housePainter) {
	...
	public SELLER(IceCreamShop iceCreamShop) {
	...
	public SELLER(InsuranceAgency insuranceAgency) {
	...
	public SELLER(InternetCafe internetCafe) {
	...
	public SELLER(JewelryStore jewelryStore) {
	...
	public SELLER(LegalService legalService) {
	...
	public SELLER(LibrarySystem librarySystem) {
	...
	public SELLER(LiquorStore liquorStore) {
	...
	public SELLER(LocalBusiness localBusiness) {
	...
	public SELLER(Locksmith locksmith) {
	...
	public SELLER(LodgingBusiness lodgingBusiness) {
	...
	public SELLER(MedicalBusiness medicalBusiness) {
	...
	public SELLER(MedicalClinic medicalClinic) {
	...
	public SELLER(MedicalOrganization medicalOrganization) {
	...
	public SELLER(MensClothingStore mensClothingStore) {
	...
	public SELLER(MiddleSchool middleSchool) {
	...
	public SELLER(Midwifery midwifery) {
	...
	public SELLER(MobilePhoneStore mobilePhoneStore) {
	...
	public SELLER(MotorcycleDealer motorcycleDealer) {
	...
	public SELLER(MotorcycleRepair motorcycleRepair) {
	...
	public SELLER(MovieRentalStore movieRentalStore) {
	...
	public SELLER(MovieTheater movieTheater) {
	...
	public SELLER(MovingCompany movingCompany) {
	...
	public SELLER(MusicGroup musicGroup) {
	...
	public SELLER(MusicStore musicStore) {
	...
	public SELLER(NailSalon nailSalon) {
	...
	public SELLER(NewsMediaOrganization newsMediaOrganization) {
	...
	public SELLER(NightClub nightClub) {
	...
	public SELLER(Obstetric obstetric) {
	...
	public SELLER(OfficeEquipmentStore officeEquipmentStore) {
	...
	public SELLER(Oncologic oncologic) {
	...
	public SELLER(Optician optician) {
	...
	public SELLER(Optometric optometric) {
	...
	public SELLER(Organization organization) {
		organizationList = new ArrayList<Organization>();
	...
	public SELLER(Otolaryngologic otolaryngologic) {
	...
	public SELLER(OutletStore outletStore) {
	...
	public SELLER(PawnShop pawnShop) {
	...
	public SELLER(Pediatric pediatric) {
	...
	public SELLER(PerformingGroup performingGroup) {
	...
	public SELLER(PetStore petStore) {
	...
	public SELLER(Pharmacy pharmacy) {
	...
	public SELLER(Physician physician) {
	...
	public SELLER(Physiotherapy physiotherapy) {
	...
	public SELLER(PlasticSurgery plasticSurgery) {
	...
	public SELLER(Podiatric podiatric) {
	...
	public SELLER(PoliceStation policeStation) {
	...
	public SELLER(PostOffice postOffice) {
	...
	public SELLER(Preschool preschool) {
	...
	public SELLER(PrimaryCare primaryCare) {
	...
	public SELLER(ProfessionalService professionalService) {
	...
	public SELLER(Psychiatric psychiatric) {
	...
	public SELLER(PublicHealth publicHealth) {
	...
	public SELLER(PublicSwimmingPool publicSwimmingPool) {
	...
	public SELLER(RadioStation radioStation) {
	...
	public SELLER(RealEstateAgent realEstateAgent) {
	...
	public SELLER(RecyclingCenter recyclingCenter) {
	...
	public SELLER(ResearchProject researchProject) {
	...
	public SELLER(RoofingContractor roofingContractor) {
	...
	public SELLER(SelfStorage selfStorage) {
	...
	public SELLER(ShoeStore shoeStore) {
	...
	public SELLER(ShoppingCenter shoppingCenter) {
	...
	public SELLER(SkiResort skiResort) {
	...
	public SELLER(SportingGoodsStore sportingGoodsStore) {
	...
	public SELLER(SportsActivityLocation sportsActivityLocation) {
	...
	public SELLER(SportsClub sportsClub) {
	...
	public SELLER(SportsOrganization sportsOrganization) {
	...
	public SELLER(SportsTeam sportsTeam) {
	...
	public SELLER(StadiumOrArena stadiumOrArena) {
	...
	public SELLER(TattooParlor tattooParlor) {
	...
	public SELLER(TelevisionStation televisionStation) {
	...
	public SELLER(TennisComplex tennisComplex) {
	...
	public SELLER(TheaterGroup theaterGroup) {
	...
	public SELLER(TireShop tireShop) {
	...
	public SELLER(TouristInformationCenter touristInformationCenter) {
	...
	public SELLER(ToyStore toyStore) {
	...
	public SELLER(TravelAgency travelAgency) {
	...
	public SELLER(VeterinaryCare veterinaryCare) {
	...
	public SELLER(WholesaleStore wholesaleStore) {
	...
	public SELLER(WorkersUnion workersUnion) {
	...
	public void copy(Container.Seller org) {
