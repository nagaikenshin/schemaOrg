...
public class AUTOMOTIVE_BUSINESS implements Clazz.AutomotiveBusiness {
	...
	public AUTOMOTIVE_BUSINESS(GeoContains geoContains) {
	...
	public AUTOMOTIVE_BUSINESS(GeoCoveredBy geoCoveredBy) {
	...
	public AUTOMOTIVE_BUSINESS(GeoCovers geoCovers) {
	...
	public AUTOMOTIVE_BUSINESS(GeoCrosses geoCrosses) {
	...
	public AUTOMOTIVE_BUSINESS(GeoDisjoint geoDisjoint) {
	...
	public AUTOMOTIVE_BUSINESS(GeoEquals geoEquals) {
	...
	public AUTOMOTIVE_BUSINESS(GeoIntersects geoIntersects) {
	...
	public AUTOMOTIVE_BUSINESS(GeoOverlaps geoOverlaps) {
	...
	public AUTOMOTIVE_BUSINESS(GeoTouches geoTouches) {
	...
	public AUTOMOTIVE_BUSINESS(GeoWithin geoWithin) {
	...
	public AUTOMOTIVE_BUSINESS(Slogan slogan) {
		setSlogan(slogan);
	}
