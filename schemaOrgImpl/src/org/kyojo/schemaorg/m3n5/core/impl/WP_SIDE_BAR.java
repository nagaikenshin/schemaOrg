...
public class WP_SIDE_BAR implements Clazz.WPSideBar {
	...
	public WP_SIDE_BAR(Long seq) {
		setSeq(seq);
	}

	public WP_SIDE_BAR(String string) {
	...
	public WP_SIDE_BAR(About about) {
		setAbout(about);
	}
	...
	public WP_SIDE_BAR(AccessMode accessMode) {
	...
	public WP_SIDE_BAR(AccessModeSufficient accessModeSufficient) {
	...
	public WP_SIDE_BAR(AccessibilityAPI accessibilityAPI) {
	...
	public WP_SIDE_BAR(AccessibilityControl accessibilityControl) {
	...
	public WP_SIDE_BAR(AccessibilityFeature accessibilityFeature) {
	...
	public WP_SIDE_BAR(AccessibilityHazard accessibilityHazard) {
	...
	public WP_SIDE_BAR(AccessibilitySummary accessibilitySummary) {
	...
	public WP_SIDE_BAR(AccountablePerson accountablePerson) {
	...
	public WP_SIDE_BAR(AdditionalType additionalType) {
	...
	public WP_SIDE_BAR(AggregateRating aggregateRating) {
	...
	public WP_SIDE_BAR(AlternateName alternateName) {
	...
	public WP_SIDE_BAR(AlternativeHeadline alternativeHeadline) {
	...
	public WP_SIDE_BAR(AssociatedMedia associatedMedia) {
	...
	public WP_SIDE_BAR(Audience audience) {
	...
	public WP_SIDE_BAR(Audio audio) {
		setAudio(audio);
	}
	...
	public WP_SIDE_BAR(Author author) {
		setAuthor(author);
	}
	...
	public WP_SIDE_BAR(Award award) {
		setAward(award);
	}
	...
	public WP_SIDE_BAR(Character character) {
	...
	public WP_SIDE_BAR(Citation citation) {
	...
	public WP_SIDE_BAR(Comment comment) {
		setComment(comment);
	}
	...
	public WP_SIDE_BAR(CommentCount commentCount) {
	...
	public WP_SIDE_BAR(ContentLocation contentLocation) {
	...
	public WP_SIDE_BAR(ContentRating contentRating) {
	...
	public WP_SIDE_BAR(ContentReferenceTime contentReferenceTime) {
	...
	public WP_SIDE_BAR(Contributor contributor) {
	...
	public WP_SIDE_BAR(CopyrightHolder copyrightHolder) {
	...
	public WP_SIDE_BAR(CopyrightYear copyrightYear) {
	...
	public WP_SIDE_BAR(Correction correction) {
	...
	public WP_SIDE_BAR(Creator creator) {
		setCreator(creator);
	}
	...
	public WP_SIDE_BAR(CssSelector cssSelector) {
	...
	public WP_SIDE_BAR(DateCreated dateCreated) {
	...
	public WP_SIDE_BAR(DateModified dateModified) {
	...
	public WP_SIDE_BAR(DatePublished datePublished) {
	...
	public WP_SIDE_BAR(Description description) {
	...
	public WP_SIDE_BAR(DisambiguatingDescription disambiguatingDescription) {
	...
	public WP_SIDE_BAR(DiscussionUrl discussionUrl) {
	...
	public WP_SIDE_BAR(Editor editor) {
		setEditor(editor);
	}
	...
	public WP_SIDE_BAR(EducationalAlignment educationalAlignment) {
	...
	public WP_SIDE_BAR(EducationalUse educationalUse) {
	...
	public WP_SIDE_BAR(Encoding encoding) {
	...
	public WP_SIDE_BAR(EncodingFormat encodingFormat) {
	...
	public WP_SIDE_BAR(ExampleOfWork exampleOfWork) {
	...
	public WP_SIDE_BAR(Expires expires) {
		setExpires(expires);
	}
	...
	public WP_SIDE_BAR(Funder funder) {
		setFunder(funder);
	}
	...
	public WP_SIDE_BAR(Genre genre) {
		setGenre(genre);
	}
	...
	public WP_SIDE_BAR(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public WP_SIDE_BAR(Headline headline) {
	...
	public WP_SIDE_BAR(Identifier identifier) {
	...
	public WP_SIDE_BAR(Image image) {
		setImage(image);
	}
	...
	public WP_SIDE_BAR(InLanguage inLanguage) {
	...
	public WP_SIDE_BAR(InteractionStatistic interactionStatistic) {
	...
	public WP_SIDE_BAR(InteractivityType interactivityType) {
	...
	public WP_SIDE_BAR(IsAccessibleForFree isAccessibleForFree) {
	...
	public WP_SIDE_BAR(IsBasedOn isBasedOn) {
	...
	public WP_SIDE_BAR(IsFamilyFriendly isFamilyFriendly) {
	...
	public WP_SIDE_BAR(IsPartOf isPartOf) {
	...
	public WP_SIDE_BAR(Keywords keywords) {
	...
	public WP_SIDE_BAR(LearningResourceType learningResourceType) {
	...
	public WP_SIDE_BAR(License license) {
		setLicense(license);
	}
	...
	public WP_SIDE_BAR(LocationCreated locationCreated) {
	...
	public WP_SIDE_BAR(MainEntity mainEntity) {
	...
	public WP_SIDE_BAR(MainEntityOfPage mainEntityOfPage) {
	...
	public WP_SIDE_BAR(Material material) {
	...
	public WP_SIDE_BAR(MaterialExtent materialExtent) {
	...
	public WP_SIDE_BAR(Mentions mentions) {
	...
	public WP_SIDE_BAR(NameFuzzy nameFuzzy) {
	...
	public WP_SIDE_BAR(NameRuby nameRuby) {
	...
	public WP_SIDE_BAR(Offers offers) {
		setOffers(offers);
	}
	...
	public WP_SIDE_BAR(Position position) {
	...
	public WP_SIDE_BAR(PotentialAction potentialAction) {
	...
	public WP_SIDE_BAR(Producer producer) {
	...
	public WP_SIDE_BAR(Provider provider) {
	...
	public WP_SIDE_BAR(Publication publication) {
	...
	public WP_SIDE_BAR(Publisher publisher) {
	...
	public WP_SIDE_BAR(PublisherImprint publisherImprint) {
	...
	public WP_SIDE_BAR(PublishingPrinciples publishingPrinciples) {
	...
	public WP_SIDE_BAR(RecordedAt recordedAt) {
	...
	public WP_SIDE_BAR(ReleasedEvent releasedEvent) {
	...
	public WP_SIDE_BAR(Review review) {
		setReview(review);
	}
	...
	public WP_SIDE_BAR(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public WP_SIDE_BAR(SchemaVersion schemaVersion) {
	...
	public WP_SIDE_BAR(SdDatePublished sdDatePublished) {
	...
	public WP_SIDE_BAR(SdLicense sdLicense) {
	...
	public WP_SIDE_BAR(SdPublisher sdPublisher) {
	...
	public WP_SIDE_BAR(SourceOrganization sourceOrganization) {
	...
	public WP_SIDE_BAR(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public WP_SIDE_BAR(SpatialCoverage spatialCoverage) {
	...
	public WP_SIDE_BAR(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public WP_SIDE_BAR(SubjectOf subjectOf) {
	...
	public WP_SIDE_BAR(Temporal temporal) {
	...
	public WP_SIDE_BAR(TemporalCoverage temporalCoverage) {
	...
	public WP_SIDE_BAR(ThumbnailUrl thumbnailUrl) {
	...
	public WP_SIDE_BAR(TimeRequired timeRequired) {
	...
	public WP_SIDE_BAR(TranslationOfWork translationOfWork) {
	...
	public WP_SIDE_BAR(Translator translator) {
	...
	public WP_SIDE_BAR(TypicalAgeRange typicalAgeRange) {
	...
	public WP_SIDE_BAR(Version version) {
		setVersion(version);
	}
	...
	public WP_SIDE_BAR(Video video) {
		setVideo(video);
	}
	...
	public WP_SIDE_BAR(WorkExample workExample) {
	...
	public WP_SIDE_BAR(WorkTranslation workTranslation) {
	...
	public WP_SIDE_BAR(Xpath xpath) {
		setXpath(xpath);
	}
	...
	public void copy(Clazz.WPSideBar org) {
		setSeq(org.getSeq());
