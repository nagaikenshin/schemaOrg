...
public class RESIDENCE implements Clazz.Residence {
	...
	public RESIDENCE(GeoContains geoContains) {
	...
	public RESIDENCE(GeoCoveredBy geoCoveredBy) {
	...
	public RESIDENCE(GeoCovers geoCovers) {
	...
	public RESIDENCE(GeoCrosses geoCrosses) {
	...
	public RESIDENCE(GeoDisjoint geoDisjoint) {
	...
	public RESIDENCE(GeoEquals geoEquals) {
	...
	public RESIDENCE(GeoIntersects geoIntersects) {
	...
	public RESIDENCE(GeoOverlaps geoOverlaps) {
	...
	public RESIDENCE(GeoTouches geoTouches) {
	...
	public RESIDENCE(GeoWithin geoWithin) {
	...
	public RESIDENCE(Slogan slogan) {
		setSlogan(slogan);
	}
