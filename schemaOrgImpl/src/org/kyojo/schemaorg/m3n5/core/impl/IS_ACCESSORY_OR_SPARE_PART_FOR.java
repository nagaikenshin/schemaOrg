...
public class IS_ACCESSORY_OR_SPARE_PART_FOR implements Container.IsAccessoryOrSparePartFor {
	...
	public IS_ACCESSORY_OR_SPARE_PART_FOR(BusOrCoach busOrCoach) {
	...
	public IS_ACCESSORY_OR_SPARE_PART_FOR(Car car) {
	...
	public IS_ACCESSORY_OR_SPARE_PART_FOR(IndividualProduct individualProduct) {
	...
	public IS_ACCESSORY_OR_SPARE_PART_FOR(Motorcycle motorcycle) {
	...
	public IS_ACCESSORY_OR_SPARE_PART_FOR(MotorizedBicycle motorizedBicycle) {
	...
	public IS_ACCESSORY_OR_SPARE_PART_FOR(ProductModel productModel) {
	...
	public IS_ACCESSORY_OR_SPARE_PART_FOR(SomeProducts someProducts) {
	...
	public IS_ACCESSORY_OR_SPARE_PART_FOR(Vehicle vehicle) {
	...
	public IS_ACCESSORY_OR_SPARE_PART_FOR(List<BusOrCoach> busOrCoachList,
			List<Car> carList,
	...
	public void copy(Container.IsAccessoryOrSparePartFor org) {
