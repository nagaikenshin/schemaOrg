...
public class AUTO_PARTS_STORE implements Clazz.AutoPartsStore {
	...
	public AUTO_PARTS_STORE(GeoContains geoContains) {
	...
	public AUTO_PARTS_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public AUTO_PARTS_STORE(GeoCovers geoCovers) {
	...
	public AUTO_PARTS_STORE(GeoCrosses geoCrosses) {
	...
	public AUTO_PARTS_STORE(GeoDisjoint geoDisjoint) {
	...
	public AUTO_PARTS_STORE(GeoEquals geoEquals) {
	...
	public AUTO_PARTS_STORE(GeoIntersects geoIntersects) {
	...
	public AUTO_PARTS_STORE(GeoOverlaps geoOverlaps) {
	...
	public AUTO_PARTS_STORE(GeoTouches geoTouches) {
	...
	public AUTO_PARTS_STORE(GeoWithin geoWithin) {
	...
	public AUTO_PARTS_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
