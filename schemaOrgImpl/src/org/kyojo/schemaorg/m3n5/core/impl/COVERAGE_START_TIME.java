...
public class COVERAGE_START_TIME implements Container.CoverageStartTime {
	...
	public COVERAGE_START_TIME(java.util.Date dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public COVERAGE_START_TIME(java.time.OffsetDateTime dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public COVERAGE_START_TIME(DateTime dateTime) {
