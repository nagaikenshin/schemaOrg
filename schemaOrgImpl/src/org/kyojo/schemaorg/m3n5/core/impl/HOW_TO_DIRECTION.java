...
import org.kyojo.schemaorg.m3n5.core.Container.BeforeMedia;
...
public class HOW_TO_DIRECTION implements Clazz.HowToDirection {
	...
	public HOW_TO_DIRECTION(MaterialExtent materialExtent) {
	...
	public HOW_TO_DIRECTION(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public HOW_TO_DIRECTION(Temporal temporal) {
