...
import org.kyojo.schemaorg.m3n5.core.Container.ServesCuisine;
...
public class FOOD_ESTABLISHMENT implements Clazz.FoodEstablishment, Container.FoodEstablishment {
	...
	public FOOD_ESTABLISHMENT(ArchiveOrganization archiveOrganization) {
	...
	public FOOD_ESTABLISHMENT(GeoContains geoContains) {
	...
	public FOOD_ESTABLISHMENT(GeoCoveredBy geoCoveredBy) {
	...
	public FOOD_ESTABLISHMENT(GeoCovers geoCovers) {
	...
	public FOOD_ESTABLISHMENT(GeoCrosses geoCrosses) {
	...
	public FOOD_ESTABLISHMENT(GeoDisjoint geoDisjoint) {
	...
	public FOOD_ESTABLISHMENT(GeoEquals geoEquals) {
	...
	public FOOD_ESTABLISHMENT(GeoIntersects geoIntersects) {
	...
	public FOOD_ESTABLISHMENT(GeoOverlaps geoOverlaps) {
	...
	public FOOD_ESTABLISHMENT(GeoTouches geoTouches) {
	...
	public FOOD_ESTABLISHMENT(GeoWithin geoWithin) {
	...
	public FOOD_ESTABLISHMENT(Slogan slogan) {
		setSlogan(slogan);
	}
