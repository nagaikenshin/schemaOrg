...
public class ACCEPT_ACTION implements Clazz.AcceptAction {
	...
	public ACCEPT_ACTION(Long seq) {
		setSeq(seq);
	}

	public ACCEPT_ACTION(String string) {
	...
	public ACCEPT_ACTION(ActionStatus actionStatus) {
	...
	public ACCEPT_ACTION(AdditionalType additionalType) {
	...
	public ACCEPT_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public ACCEPT_ACTION(AlternateName alternateName) {
	...
	public ACCEPT_ACTION(Description description) {
	...
	public ACCEPT_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public ACCEPT_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public ACCEPT_ACTION(Error error) {
		setError(error);
	}
	...
	public ACCEPT_ACTION(Identifier identifier) {
	...
	public ACCEPT_ACTION(Image image) {
		setImage(image);
	}
	...
	public ACCEPT_ACTION(Instrument instrument) {
	...
	public ACCEPT_ACTION(Location location) {
	...
	public ACCEPT_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public ACCEPT_ACTION(Name name) {
		setName(name);
	}
	...
	public ACCEPT_ACTION(NameFuzzy nameFuzzy) {
	...
	public ACCEPT_ACTION(NameRuby nameRuby) {
	...
	public ACCEPT_ACTION(Object object) {
		setObject(object);
	}
	...
	public ACCEPT_ACTION(Participant participant) {
	...
	public ACCEPT_ACTION(PotentialAction potentialAction) {
	...
	public ACCEPT_ACTION(Purpose purpose) {
		setPurpose(purpose);
	}
	...
	public ACCEPT_ACTION(Result result) {
		setResult(result);
	}
	...
	public ACCEPT_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ACCEPT_ACTION(StartTime startTime) {
	...
	public ACCEPT_ACTION(SubjectOf subjectOf) {
	...
	public ACCEPT_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.AcceptAction org) {
		setSeq(org.getSeq());
