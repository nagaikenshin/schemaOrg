...
public class HOW_TO_STEP implements Clazz.HowToStep {
	...
	public HOW_TO_STEP(Long seq) {
		setSeq(seq);
	}

	public HOW_TO_STEP(String string) {
	...
	public HOW_TO_STEP(About about) {
		setAbout(about);
	}
	...
	public HOW_TO_STEP(AccessMode accessMode) {
	...
	public HOW_TO_STEP(AccessModeSufficient accessModeSufficient) {
	...
	public HOW_TO_STEP(AccessibilityAPI accessibilityAPI) {
	...
	public HOW_TO_STEP(AccessibilityControl accessibilityControl) {
	...
	public HOW_TO_STEP(AccessibilityFeature accessibilityFeature) {
	...
	public HOW_TO_STEP(AccessibilityHazard accessibilityHazard) {
	...
	public HOW_TO_STEP(AccessibilitySummary accessibilitySummary) {
	...
	public HOW_TO_STEP(AccountablePerson accountablePerson) {
	...
	public HOW_TO_STEP(AdditionalType additionalType) {
	...
	public HOW_TO_STEP(AggregateRating aggregateRating) {
	...
	public HOW_TO_STEP(AlternateName alternateName) {
	...
	public HOW_TO_STEP(AlternativeHeadline alternativeHeadline) {
	...
	public HOW_TO_STEP(AssociatedMedia associatedMedia) {
	...
	public HOW_TO_STEP(Audience audience) {
	...
	public HOW_TO_STEP(Audio audio) {
		setAudio(audio);
	}
	...
	public HOW_TO_STEP(Author author) {
		setAuthor(author);
	}
	...
	public HOW_TO_STEP(Award award) {
		setAward(award);
	}
	...
	public HOW_TO_STEP(Character character) {
	...
	public HOW_TO_STEP(Citation citation) {
	...
	public HOW_TO_STEP(Comment comment) {
		setComment(comment);
	}
	...
	public HOW_TO_STEP(CommentCount commentCount) {
	...
	public HOW_TO_STEP(ContentLocation contentLocation) {
	...
	public HOW_TO_STEP(ContentRating contentRating) {
	...
	public HOW_TO_STEP(ContentReferenceTime contentReferenceTime) {
	...
	public HOW_TO_STEP(Contributor contributor) {
	...
	public HOW_TO_STEP(CopyrightHolder copyrightHolder) {
	...
	public HOW_TO_STEP(CopyrightYear copyrightYear) {
	...
	public HOW_TO_STEP(Correction correction) {
	...
	public HOW_TO_STEP(Creator creator) {
		setCreator(creator);
	}
	...
	public HOW_TO_STEP(DateCreated dateCreated) {
	...
	public HOW_TO_STEP(DateModified dateModified) {
	...
	public HOW_TO_STEP(DatePublished datePublished) {
	...
	public HOW_TO_STEP(Description description) {
	...
	public HOW_TO_STEP(DisambiguatingDescription disambiguatingDescription) {
	...
	public HOW_TO_STEP(DiscussionUrl discussionUrl) {
	...
	public HOW_TO_STEP(Editor editor) {
		setEditor(editor);
	}
	...
	public HOW_TO_STEP(EducationalAlignment educationalAlignment) {
	...
	public HOW_TO_STEP(EducationalUse educationalUse) {
	...
	public HOW_TO_STEP(Encoding encoding) {
	...
	public HOW_TO_STEP(EncodingFormat encodingFormat) {
	...
	public HOW_TO_STEP(ExampleOfWork exampleOfWork) {
	...
	public HOW_TO_STEP(Expires expires) {
		setExpires(expires);
	}
	...
	public HOW_TO_STEP(Funder funder) {
		setFunder(funder);
	}
	...
	public HOW_TO_STEP(Genre genre) {
		setGenre(genre);
	}
	...
	public HOW_TO_STEP(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public HOW_TO_STEP(Headline headline) {
	...
	public HOW_TO_STEP(Identifier identifier) {
	...
	public HOW_TO_STEP(Image image) {
		setImage(image);
	}
	...
	public HOW_TO_STEP(InLanguage inLanguage) {
	...
	public HOW_TO_STEP(InteractionStatistic interactionStatistic) {
	...
	public HOW_TO_STEP(InteractivityType interactivityType) {
	...
	public HOW_TO_STEP(IsAccessibleForFree isAccessibleForFree) {
	...
	public HOW_TO_STEP(IsBasedOn isBasedOn) {
	...
	public HOW_TO_STEP(IsFamilyFriendly isFamilyFriendly) {
	...
	public HOW_TO_STEP(IsPartOf isPartOf) {
	...
	public HOW_TO_STEP(ItemListElement itemListElement) {
	...
	public HOW_TO_STEP(ItemListOrder itemListOrder) {
	...
	public HOW_TO_STEP(Keywords keywords) {
	...
	public HOW_TO_STEP(LearningResourceType learningResourceType) {
	...
	public HOW_TO_STEP(License license) {
		setLicense(license);
	}
	...
	public HOW_TO_STEP(LocationCreated locationCreated) {
	...
	public HOW_TO_STEP(MainEntity mainEntity) {
	...
	public HOW_TO_STEP(MainEntityOfPage mainEntityOfPage) {
	...
	public HOW_TO_STEP(Material material) {
	...
	public HOW_TO_STEP(MaterialExtent materialExtent) {
	...
	public HOW_TO_STEP(Mentions mentions) {
	...
	public HOW_TO_STEP(NameFuzzy nameFuzzy) {
	...
	public HOW_TO_STEP(NameRuby nameRuby) {
	...
	public HOW_TO_STEP(NextItem nextItem) {
	...
	public HOW_TO_STEP(NumberOfItems numberOfItems) {
	...
	public HOW_TO_STEP(Offers offers) {
		setOffers(offers);
	}
	...
	public HOW_TO_STEP(Position position) {
	...
	public HOW_TO_STEP(PotentialAction potentialAction) {
	...
	public HOW_TO_STEP(PreviousItem previousItem) {
	...
	public HOW_TO_STEP(Producer producer) {
	...
	public HOW_TO_STEP(Provider provider) {
	...
	public HOW_TO_STEP(Publication publication) {
	...
	public HOW_TO_STEP(Publisher publisher) {
	...
	public HOW_TO_STEP(PublisherImprint publisherImprint) {
	...
	public HOW_TO_STEP(PublishingPrinciples publishingPrinciples) {
	...
	public HOW_TO_STEP(RecordedAt recordedAt) {
	...
	public HOW_TO_STEP(ReleasedEvent releasedEvent) {
	...
	public HOW_TO_STEP(Review review) {
		setReview(review);
	}
	...
	public HOW_TO_STEP(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public HOW_TO_STEP(SchemaVersion schemaVersion) {
	...
	public HOW_TO_STEP(SdDatePublished sdDatePublished) {
	...
	public HOW_TO_STEP(SdLicense sdLicense) {
	...
	public HOW_TO_STEP(SdPublisher sdPublisher) {
	...
	public HOW_TO_STEP(SourceOrganization sourceOrganization) {
	...
	public HOW_TO_STEP(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public HOW_TO_STEP(SpatialCoverage spatialCoverage) {
	...
	public HOW_TO_STEP(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public HOW_TO_STEP(SubjectOf subjectOf) {
	...
	public HOW_TO_STEP(Temporal temporal) {
	...
	public HOW_TO_STEP(TemporalCoverage temporalCoverage) {
	...
	public HOW_TO_STEP(ThumbnailUrl thumbnailUrl) {
	...
	public HOW_TO_STEP(TimeRequired timeRequired) {
	...
	public HOW_TO_STEP(TranslationOfWork translationOfWork) {
	...
	public HOW_TO_STEP(Translator translator) {
	...
	public HOW_TO_STEP(TypicalAgeRange typicalAgeRange) {
	...
	public HOW_TO_STEP(Version version) {
		setVersion(version);
	}
	...
	public HOW_TO_STEP(Video video) {
		setVideo(video);
	}
	...
	public HOW_TO_STEP(WorkExample workExample) {
	...
	public HOW_TO_STEP(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.HowToStep org) {
		setSeq(org.getSeq());
