...
public class LANDMARKS_OR_HISTORICAL_BUILDINGS implements Clazz.LandmarksOrHistoricalBuildings {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(GeoContains geoContains) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(GeoCoveredBy geoCoveredBy) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(GeoCovers geoCovers) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(GeoCrosses geoCrosses) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(GeoDisjoint geoDisjoint) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(GeoEquals geoEquals) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(GeoIntersects geoIntersects) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(GeoOverlaps geoOverlaps) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(GeoTouches geoTouches) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(GeoWithin geoWithin) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(Slogan slogan) {
		setSlogan(slogan);
	}
