...
public class GAME implements Clazz.Game, Container.Game {
	...
	public GAME(AccessMode accessMode) {
	...
	public GAME(AccessModeSufficient accessModeSufficient) {
	...
	public GAME(AccessibilityAPI accessibilityAPI) {
	...
	public GAME(AccessibilityControl accessibilityControl) {
	...
	public GAME(AccessibilityFeature accessibilityFeature) {
	...
	public GAME(AccessibilityHazard accessibilityHazard) {
	...
	public GAME(AccessibilitySummary accessibilitySummary) {
	...
	public GAME(AccountablePerson accountablePerson) {
	...
	public GAME(AdditionalType additionalType) {
	...
	public GAME(AggregateRating aggregateRating) {
	...
	public GAME(AlternateName alternateName) {
	...
	public GAME(AlternativeHeadline alternativeHeadline) {
	...
	public GAME(AssociatedMedia associatedMedia) {
	...
	public GAME(CharacterAttribute characterAttribute) {
	...
	public GAME(CommentCount commentCount) {
	...
	public GAME(ContentLocation contentLocation) {
	...
	public GAME(ContentRating contentRating) {
	...
	public GAME(ContentReferenceTime contentReferenceTime) {
	...
	public GAME(Contributor contributor) {
	...
	public GAME(CopyrightHolder copyrightHolder) {
	...
	public GAME(CopyrightYear copyrightYear) {
	...
	public GAME(Correction correction) {
	...
	public GAME(DateCreated dateCreated) {
	...
	public GAME(DateModified dateModified) {
	...
	public GAME(DatePublished datePublished) {
	...
	public GAME(DisambiguatingDescription disambiguatingDescription) {
	...
	public GAME(DiscussionUrl discussionUrl) {
	...
	public GAME(EducationalAlignment educationalAlignment) {
	...
	public GAME(EducationalUse educationalUse) {
	...
	public GAME(EncodingFormat encodingFormat) {
	...
	public GAME(ExampleOfWork exampleOfWork) {
	...
	public GAME(Identifier identifier) {
	...
	public GAME(InLanguage inLanguage) {
	...
	public GAME(InteractionStatistic interactionStatistic) {
	...
	public GAME(InteractivityType interactivityType) {
	...
	public GAME(IsAccessibleForFree isAccessibleForFree) {
	...
	public GAME(IsBasedOn isBasedOn) {
	...
	public GAME(IsFamilyFriendly isFamilyFriendly) {
	...
	public GAME(LearningResourceType learningResourceType) {
	...
	public GAME(LocationCreated locationCreated) {
	...
	public GAME(MainEntity mainEntity) {
	...
	public GAME(MainEntityOfPage mainEntityOfPage) {
	...
	public GAME(MaterialExtent materialExtent) {
	...
	public GAME(NameFuzzy nameFuzzy) {
	...
	public GAME(PotentialAction potentialAction) {
	...
	public GAME(Publication publication) {
	...
	public GAME(PublisherImprint publisherImprint) {
	...
	public GAME(PublishingPrinciples publishingPrinciples) {
	...
	public GAME(RecordedAt recordedAt) {
	...
	public GAME(ReleasedEvent releasedEvent) {
	...
	public GAME(SchemaVersion schemaVersion) {
	...
	public GAME(SdDatePublished sdDatePublished) {
	...
	public GAME(SdLicense sdLicense) {
	...
	public GAME(SdPublisher sdPublisher) {
	...
	public GAME(SourceOrganization sourceOrganization) {
	...
	public GAME(SpatialCoverage spatialCoverage) {
	...
	public GAME(SubjectOf subjectOf) {
	...
	public GAME(TemporalCoverage temporalCoverage) {
	...
	public GAME(ThumbnailUrl thumbnailUrl) {
	...
	public GAME(TimeRequired timeRequired) {
	...
	public GAME(TranslationOfWork translationOfWork) {
	...
	public GAME(Translator translator) {
	...
	public GAME(TypicalAgeRange typicalAgeRange) {
	...
	public GAME(VideoGame videoGame) {
	...
	public GAME(WorkExample workExample) {
	...
	public GAME(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Game org) {
		setSeq(org.getSeq());
	...
	public void copy(Container.Game org) {
