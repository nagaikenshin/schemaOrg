...
public class BEACH implements Clazz.Beach {
	...
	public BEACH(GeoContains geoContains) {
	...
	public BEACH(GeoCoveredBy geoCoveredBy) {
	...
	public BEACH(GeoCovers geoCovers) {
	...
	public BEACH(GeoCrosses geoCrosses) {
	...
	public BEACH(GeoDisjoint geoDisjoint) {
	...
	public BEACH(GeoEquals geoEquals) {
	...
	public BEACH(GeoIntersects geoIntersects) {
	...
	public BEACH(GeoOverlaps geoOverlaps) {
	...
	public BEACH(GeoTouches geoTouches) {
	...
	public BEACH(GeoWithin geoWithin) {
