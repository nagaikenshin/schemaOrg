...
public class HAIR_SALON implements Clazz.HairSalon {
	...
	public HAIR_SALON(GeoContains geoContains) {
	...
	public HAIR_SALON(GeoCoveredBy geoCoveredBy) {
	...
	public HAIR_SALON(GeoCovers geoCovers) {
	...
	public HAIR_SALON(GeoCrosses geoCrosses) {
	...
	public HAIR_SALON(GeoDisjoint geoDisjoint) {
	...
	public HAIR_SALON(GeoEquals geoEquals) {
	...
	public HAIR_SALON(GeoIntersects geoIntersects) {
	...
	public HAIR_SALON(GeoOverlaps geoOverlaps) {
	...
	public HAIR_SALON(GeoTouches geoTouches) {
	...
	public HAIR_SALON(GeoWithin geoWithin) {
	...
	public HAIR_SALON(Slogan slogan) {
		setSlogan(slogan);
	}
