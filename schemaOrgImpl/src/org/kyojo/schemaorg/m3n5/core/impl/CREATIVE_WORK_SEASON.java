...
import org.kyojo.schemaorg.m3n5.core.Container.Episode;
...
public class CREATIVE_WORK_SEASON implements Clazz.CreativeWorkSeason {
	...
	public CREATIVE_WORK_SEASON() {
	}

	public CREATIVE_WORK_SEASON(Long seq) {
		setSeq(seq);
	}

	public CREATIVE_WORK_SEASON(String string) {
	...
	public CREATIVE_WORK_SEASON(About about) {
		setAbout(about);
	}
	...
	public CREATIVE_WORK_SEASON(AccessMode accessMode) {
	...
	public CREATIVE_WORK_SEASON(AccessModeSufficient accessModeSufficient) {
	...
	public CREATIVE_WORK_SEASON(AccessibilityAPI accessibilityAPI) {
	...
	public CREATIVE_WORK_SEASON(AccessibilityControl accessibilityControl) {
	...
	public CREATIVE_WORK_SEASON(AccessibilityFeature accessibilityFeature) {
	...
	public CREATIVE_WORK_SEASON(AccessibilityHazard accessibilityHazard) {
	...
	public CREATIVE_WORK_SEASON(AccessibilitySummary accessibilitySummary) {
	...
	public CREATIVE_WORK_SEASON(AccountablePerson accountablePerson) {
	...
	public CREATIVE_WORK_SEASON(Actor actor) {
		setActor(actor);
	}
	...
	public CREATIVE_WORK_SEASON(AdditionalType additionalType) {
	...
	public CREATIVE_WORK_SEASON(AggregateRating aggregateRating) {
	...
	public CREATIVE_WORK_SEASON(AlternateName alternateName) {
	...
	public CREATIVE_WORK_SEASON(AlternativeHeadline alternativeHeadline) {
	...
	public CREATIVE_WORK_SEASON(AssociatedMedia associatedMedia) {
	...
	public CREATIVE_WORK_SEASON(Audience audience) {
	...
	public CREATIVE_WORK_SEASON(Audio audio) {
		setAudio(audio);
	}
	...
	public CREATIVE_WORK_SEASON(Author author) {
		setAuthor(author);
	}
	...
	public CREATIVE_WORK_SEASON(Award award) {
		setAward(award);
	}
	...
	public CREATIVE_WORK_SEASON(Character character) {
	...
	public CREATIVE_WORK_SEASON(Citation citation) {
	...
	public CREATIVE_WORK_SEASON(Comment comment) {
		setComment(comment);
	}
	...
	public CREATIVE_WORK_SEASON(CommentCount commentCount) {
	...
	public CREATIVE_WORK_SEASON(ContentLocation contentLocation) {
	...
	public CREATIVE_WORK_SEASON(ContentRating contentRating) {
	...
	public CREATIVE_WORK_SEASON(ContentReferenceTime contentReferenceTime) {
	...
	public CREATIVE_WORK_SEASON(Contributor contributor) {
	...
	public CREATIVE_WORK_SEASON(CopyrightHolder copyrightHolder) {
	...
	public CREATIVE_WORK_SEASON(CopyrightYear copyrightYear) {
	...
	public CREATIVE_WORK_SEASON(Correction correction) {
	...
	public CREATIVE_WORK_SEASON(Creator creator) {
		setCreator(creator);
	}
	...
	public CREATIVE_WORK_SEASON(DateCreated dateCreated) {
	...
	public CREATIVE_WORK_SEASON(DateModified dateModified) {
	...
	public CREATIVE_WORK_SEASON(DatePublished datePublished) {
	...
	public CREATIVE_WORK_SEASON(Description description) {
	...
	public CREATIVE_WORK_SEASON(Director director) {
	...
	public CREATIVE_WORK_SEASON(DisambiguatingDescription disambiguatingDescription) {
	...
	public CREATIVE_WORK_SEASON(DiscussionUrl discussionUrl) {
	...
	public CREATIVE_WORK_SEASON(Editor editor) {
		setEditor(editor);
	}
	...
	public CREATIVE_WORK_SEASON(EducationalAlignment educationalAlignment) {
	...
	public CREATIVE_WORK_SEASON(EducationalUse educationalUse) {
	...
	public CREATIVE_WORK_SEASON(Encoding encoding) {
	...
	public CREATIVE_WORK_SEASON(EncodingFormat encodingFormat) {
	...
	public CREATIVE_WORK_SEASON(EndDate endDate) {
		setEndDate(endDate);
	}
	...
	public CREATIVE_WORK_SEASON(Episode episode) {
		setEpisode(episode);
	}
	...
	public CREATIVE_WORK_SEASON(ExampleOfWork exampleOfWork) {
	...
	public CREATIVE_WORK_SEASON(Expires expires) {
		setExpires(expires);
	}
	...
	public CREATIVE_WORK_SEASON(Funder funder) {
		setFunder(funder);
	}
	...
	public CREATIVE_WORK_SEASON(Genre genre) {
		setGenre(genre);
	}
	...
	public CREATIVE_WORK_SEASON(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public CREATIVE_WORK_SEASON(Headline headline) {
	...
	public CREATIVE_WORK_SEASON(Identifier identifier) {
	...
	public CREATIVE_WORK_SEASON(Image image) {
		setImage(image);
	}
	...
	public CREATIVE_WORK_SEASON(InLanguage inLanguage) {
	...
	public CREATIVE_WORK_SEASON(InteractionStatistic interactionStatistic) {
	...
	public CREATIVE_WORK_SEASON(InteractivityType interactivityType) {
	...
	public CREATIVE_WORK_SEASON(IsAccessibleForFree isAccessibleForFree) {
	...
	public CREATIVE_WORK_SEASON(IsBasedOn isBasedOn) {
	...
	public CREATIVE_WORK_SEASON(IsFamilyFriendly isFamilyFriendly) {
	...
	public CREATIVE_WORK_SEASON(IsPartOf isPartOf) {
	...
	public CREATIVE_WORK_SEASON(Keywords keywords) {
	...
	public CREATIVE_WORK_SEASON(LearningResourceType learningResourceType) {
	...
	public CREATIVE_WORK_SEASON(License license) {
		setLicense(license);
	}
	...
	public CREATIVE_WORK_SEASON(LocationCreated locationCreated) {
	...
	public CREATIVE_WORK_SEASON(MainEntity mainEntity) {
	...
	public CREATIVE_WORK_SEASON(MainEntityOfPage mainEntityOfPage) {
	...
	public CREATIVE_WORK_SEASON(Material material) {
	...
	public CREATIVE_WORK_SEASON(MaterialExtent materialExtent) {
	...
	public CREATIVE_WORK_SEASON(Mentions mentions) {
	...
	public CREATIVE_WORK_SEASON(Name name) {
		setName(name);
	}
	...
	public CREATIVE_WORK_SEASON(NameFuzzy nameFuzzy) {
	...
	public CREATIVE_WORK_SEASON(NameRuby nameRuby) {
	...
	public CREATIVE_WORK_SEASON(NumberOfEpisodes numberOfEpisodes) {
	...
	public CREATIVE_WORK_SEASON(Offers offers) {
		setOffers(offers);
	}
	...
	public CREATIVE_WORK_SEASON(PartOfSeries partOfSeries) {
	...
	public CREATIVE_WORK_SEASON(Position position) {
	...
	public CREATIVE_WORK_SEASON(PotentialAction potentialAction) {
	...
	public CREATIVE_WORK_SEASON(Producer producer) {
	...
	public CREATIVE_WORK_SEASON(ProductionCompany productionCompany) {
	...
	public CREATIVE_WORK_SEASON(Provider provider) {
	...
	public CREATIVE_WORK_SEASON(Publication publication) {
	...
	public CREATIVE_WORK_SEASON(Publisher publisher) {
	...
	public CREATIVE_WORK_SEASON(PublisherImprint publisherImprint) {
	...
	public CREATIVE_WORK_SEASON(PublishingPrinciples publishingPrinciples) {
	...
	public CREATIVE_WORK_SEASON(RecordedAt recordedAt) {
	...
	public CREATIVE_WORK_SEASON(ReleasedEvent releasedEvent) {
	...
	public CREATIVE_WORK_SEASON(Review review) {
		setReview(review);
	}
	...
	public CREATIVE_WORK_SEASON(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CREATIVE_WORK_SEASON(SchemaVersion schemaVersion) {
	...
	public CREATIVE_WORK_SEASON(SdDatePublished sdDatePublished) {
	...
	public CREATIVE_WORK_SEASON(SdLicense sdLicense) {
	...
	public CREATIVE_WORK_SEASON(SdPublisher sdPublisher) {
	...
	public CREATIVE_WORK_SEASON(SeasonNumber seasonNumber) {
	...
	public CREATIVE_WORK_SEASON(SourceOrganization sourceOrganization) {
	...
	public CREATIVE_WORK_SEASON(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public CREATIVE_WORK_SEASON(SpatialCoverage spatialCoverage) {
	...
	public CREATIVE_WORK_SEASON(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public CREATIVE_WORK_SEASON(StartDate startDate) {
	...
	public CREATIVE_WORK_SEASON(SubjectOf subjectOf) {
	...
	public CREATIVE_WORK_SEASON(Temporal temporal) {
	...
	public CREATIVE_WORK_SEASON(TemporalCoverage temporalCoverage) {
	...
	public CREATIVE_WORK_SEASON(Text text) {
		setText(text);
	}
	...
	public CREATIVE_WORK_SEASON(ThumbnailUrl thumbnailUrl) {
	...
	public CREATIVE_WORK_SEASON(TimeRequired timeRequired) {
	...
	public CREATIVE_WORK_SEASON(Trailer trailer) {
		setTrailer(trailer);
	}
	...
	public CREATIVE_WORK_SEASON(TranslationOfWork translationOfWork) {
	...
	public CREATIVE_WORK_SEASON(Translator translator) {
	...
	public CREATIVE_WORK_SEASON(TypicalAgeRange typicalAgeRange) {
	...
	public CREATIVE_WORK_SEASON(Url url) {
		setUrl(url);
	}
	...
	public CREATIVE_WORK_SEASON(Version version) {
		setVersion(version);
	}
	...
	public CREATIVE_WORK_SEASON(Video video) {
		setVideo(video);
	}
	...
	public CREATIVE_WORK_SEASON(WorkExample workExample) {
	...
	public CREATIVE_WORK_SEASON(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.CreativeWorkSeason org) {
		setSeq(org.getSeq());
		...
		setSeasonNumber(org.getSeasonNumber());
