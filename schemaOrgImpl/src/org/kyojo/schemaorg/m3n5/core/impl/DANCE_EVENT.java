...
public class DANCE_EVENT implements Clazz.DanceEvent {
	...
	public DANCE_EVENT(Long seq) {
		setSeq(seq);
	}

	public DANCE_EVENT(String string) {
	...
	public DANCE_EVENT(About about) {
		setAbout(about);
	}
	...
	public DANCE_EVENT(Actor actor) {
		setActor(actor);
	}
	...
	public DANCE_EVENT(AdditionalType additionalType) {
	...
	public DANCE_EVENT(AggregateRating aggregateRating) {
	...
	public DANCE_EVENT(AlternateName alternateName) {
	...
	public DANCE_EVENT(Attendee attendee) {
	...
	public DANCE_EVENT(Audience audience) {
	...
	public DANCE_EVENT(Composer composer) {
	...
	public DANCE_EVENT(Contributor contributor) {
	...
	public DANCE_EVENT(Description description) {
	...
	public DANCE_EVENT(Director director) {
	...
	public DANCE_EVENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public DANCE_EVENT(DoorTime doorTime) {
	...
	public DANCE_EVENT(Duration duration) {
	...
	public DANCE_EVENT(EndDate endDate) {
		setEndDate(endDate);
	}
	...
	public DANCE_EVENT(EventStatus eventStatus) {
	...
	public DANCE_EVENT(Funder funder) {
		setFunder(funder);
	}
	...
	public DANCE_EVENT(Identifier identifier) {
	...
	public DANCE_EVENT(Image image) {
		setImage(image);
	}
	...
	public DANCE_EVENT(InLanguage inLanguage) {
	...
	public DANCE_EVENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public DANCE_EVENT(Location location) {
	...
	public DANCE_EVENT(MainEntityOfPage mainEntityOfPage) {
	...
	public DANCE_EVENT(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public DANCE_EVENT(NameFuzzy nameFuzzy) {
	...
	public DANCE_EVENT(NameRuby nameRuby) {
	...
	public DANCE_EVENT(Offers offers) {
		setOffers(offers);
	}
	...
	public DANCE_EVENT(Organizer organizer) {
	...
	public DANCE_EVENT(Performer performer) {
	...
	public DANCE_EVENT(PotentialAction potentialAction) {
	...
	public DANCE_EVENT(PreviousStartDate previousStartDate) {
	...
	public DANCE_EVENT(RecordedIn recordedIn) {
	...
	public DANCE_EVENT(RemainingAttendeeCapacity remainingAttendeeCapacity) {
	...
	public DANCE_EVENT(Review review) {
		setReview(review);
	}
	...
	public DANCE_EVENT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DANCE_EVENT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public DANCE_EVENT(StartDate startDate) {
	...
	public DANCE_EVENT(SubEvent subEvent) {
	...
	public DANCE_EVENT(SubjectOf subjectOf) {
	...
	public DANCE_EVENT(SuperEvent superEvent) {
	...
	public DANCE_EVENT(Translator translator) {
	...
	public DANCE_EVENT(TypicalAgeRange typicalAgeRange) {
	...
	public DANCE_EVENT(WorkFeatured workFeatured) {
	...
	public DANCE_EVENT(WorkPerformed workPerformed) {
	...
	public void copy(Clazz.DanceEvent org) {
		setSeq(org.getSeq());
