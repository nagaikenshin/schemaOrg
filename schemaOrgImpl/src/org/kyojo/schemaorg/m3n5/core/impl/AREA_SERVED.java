...
public class AREA_SERVED implements Container.AreaServed {
	...
	public AREA_SERVED(Accommodation accommodation) {
	...
	public AREA_SERVED(AccountingService accountingService) {
	...
	public AREA_SERVED(AdministrativeArea administrativeArea) {
	...
	public AREA_SERVED(AdultEntertainment adultEntertainment) {
	...
	public AREA_SERVED(Airport airport) {
	...
	public AREA_SERVED(AmusementPark amusementPark) {
	...
	public AREA_SERVED(AnimalShelter animalShelter) {
	...
	public AREA_SERVED(Apartment apartment) {
	...
	public AREA_SERVED(ApartmentComplex apartmentComplex) {
	...
	public AREA_SERVED(Aquarium aquarium) {
	...
	public AREA_SERVED(ArchiveOrganization archiveOrganization) {
	...
	public AREA_SERVED(ArtGallery artGallery) {
	...
	public AREA_SERVED(Attorney attorney) {
	...
	public AREA_SERVED(AutoBodyShop autoBodyShop) {
	...
	public AREA_SERVED(AutoDealer autoDealer) {
	...
	public AREA_SERVED(AutoPartsStore autoPartsStore) {
	...
	public AREA_SERVED(AutoRental autoRental) {
	...
	public AREA_SERVED(AutoRepair autoRepair) {
	...
	public AREA_SERVED(AutoWash autoWash) {
	...
	public AREA_SERVED(AutomatedTeller automatedTeller) {
	...
	public AREA_SERVED(AutomotiveBusiness automotiveBusiness) {
	...
	public AREA_SERVED(Bakery bakery) {
	...
	public AREA_SERVED(BankOrCreditUnion bankOrCreditUnion) {
	...
	public AREA_SERVED(BarOrPub barOrPub) {
	...
	public AREA_SERVED(Beach beach) {
	...
	public AREA_SERVED(BeautySalon beautySalon) {
	...
	public AREA_SERVED(BedAndBreakfast bedAndBreakfast) {
	...
	public AREA_SERVED(BikeStore bikeStore) {
	...
	public AREA_SERVED(BodyOfWater bodyOfWater) {
	...
	public AREA_SERVED(BookStore bookStore) {
	...
	public AREA_SERVED(BowlingAlley bowlingAlley) {
	...
	public AREA_SERVED(Brewery brewery) {
	...
	public AREA_SERVED(Bridge bridge) {
	...
	public AREA_SERVED(BuddhistTemple buddhistTemple) {
	...
	public AREA_SERVED(BusStation busStation) {
	...
	public AREA_SERVED(BusStop busStop) {
	...
	public AREA_SERVED(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public AREA_SERVED(Campground campground) {
	...
	public AREA_SERVED(CampingPitch campingPitch) {
	...
	public AREA_SERVED(Canal canal) {
	...
	public AREA_SERVED(Casino casino) {
	...
	public AREA_SERVED(CatholicChurch catholicChurch) {
	...
	public AREA_SERVED(Cemetery cemetery) {
	...
	public AREA_SERVED(ChildCare childCare) {
	...
	public AREA_SERVED(Church church) {
	...
	public AREA_SERVED(CityHall cityHall) {
	...
	public AREA_SERVED(CivicStructure civicStructure) {
	...
	public AREA_SERVED(ClothingStore clothingStore) {
	...
	public AREA_SERVED(ComedyClub comedyClub) {
	...
	public AREA_SERVED(CommunityHealth communityHealth) {
	...
	public AREA_SERVED(ComputerStore computerStore) {
	...
	public AREA_SERVED(Continent continent) {
	...
	public AREA_SERVED(ConvenienceStore convenienceStore) {
	...
	public AREA_SERVED(Country country) {
	...
	public AREA_SERVED(Courthouse courthouse) {
	...
	public AREA_SERVED(Crematorium crematorium) {
	...
	public AREA_SERVED(DaySpa daySpa) {
	...
	public AREA_SERVED(DefenceEstablishment defenceEstablishment) {
	...
	public AREA_SERVED(Dentist dentist) {
	...
	public AREA_SERVED(DepartmentStore departmentStore) {
	...
	public AREA_SERVED(Dermatology dermatology) {
	...
	public AREA_SERVED(DietNutrition dietNutrition) {
	...
	public AREA_SERVED(Distillery distillery) {
	...
	public AREA_SERVED(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public AREA_SERVED(Electrician electrician) {
	...
	public AREA_SERVED(ElectronicsStore electronicsStore) {
	...
	public AREA_SERVED(Embassy embassy) {
	...
	public AREA_SERVED(Emergency emergency) {
	...
	public AREA_SERVED(EmergencyService emergencyService) {
	...
	public AREA_SERVED(EmploymentAgency employmentAgency) {
	...
	public AREA_SERVED(EntertainmentBusiness entertainmentBusiness) {
	...
	public AREA_SERVED(EventVenue eventVenue) {
	...
	public AREA_SERVED(ExerciseGym exerciseGym) {
	...
	public AREA_SERVED(FastFoodRestaurant fastFoodRestaurant) {
	...
	public AREA_SERVED(FinancialService financialService) {
	...
	public AREA_SERVED(FireStation fireStation) {
	...
	public AREA_SERVED(Florist florist) {
	...
	public AREA_SERVED(FoodEstablishment foodEstablishment) {
	...
	public AREA_SERVED(FurnitureStore furnitureStore) {
	...
	public AREA_SERVED(GardenStore gardenStore) {
	...
	public AREA_SERVED(GasStation gasStation) {
	...
	public AREA_SERVED(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public AREA_SERVED(GeneralContractor generalContractor) {
	...
	public AREA_SERVED(GeoCircle geoCircle) {
	...
	public AREA_SERVED(GeoShape geoShape) {
	...
	public AREA_SERVED(Geriatric geriatric) {
	...
	public AREA_SERVED(GolfCourse golfCourse) {
	...
	public AREA_SERVED(GovernmentBuilding governmentBuilding) {
	...
	public AREA_SERVED(GovernmentOffice governmentOffice) {
	...
	public AREA_SERVED(GroceryStore groceryStore) {
	...
	public AREA_SERVED(Gynecologic gynecologic) {
	...
	public AREA_SERVED(HVACBusiness hvacBusiness) {
	...
	public AREA_SERVED(HairSalon hairSalon) {
	...
	public AREA_SERVED(HardwareStore hardwareStore) {
	...
	public AREA_SERVED(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public AREA_SERVED(HealthClub healthClub) {
	...
	public AREA_SERVED(HinduTemple hinduTemple) {
	...
	public AREA_SERVED(HobbyShop hobbyShop) {
	...
	public AREA_SERVED(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public AREA_SERVED(HomeGoodsStore homeGoodsStore) {
	...
	public AREA_SERVED(Hospital hospital) {
	...
	public AREA_SERVED(Hostel hostel) {
	...
	public AREA_SERVED(Hotel hotel) {
	...
	public AREA_SERVED(HotelRoom hotelRoom) {
	...
	public AREA_SERVED(House house) {
	...
	public AREA_SERVED(HousePainter housePainter) {
	...
	public AREA_SERVED(IceCreamShop iceCreamShop) {
	...
	public AREA_SERVED(InsuranceAgency insuranceAgency) {
	...
	public AREA_SERVED(InternetCafe internetCafe) {
	...
	public AREA_SERVED(JewelryStore jewelryStore) {
	...
	public AREA_SERVED(LakeBodyOfWater lakeBodyOfWater) {
	...
	public AREA_SERVED(Landform landform) {
	...
	public AREA_SERVED(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public AREA_SERVED(LegalService legalService) {
	...
	public AREA_SERVED(LegislativeBuilding legislativeBuilding) {
	...
	public AREA_SERVED(Library library) {
	...
	public AREA_SERVED(LiquorStore liquorStore) {
	...
	public AREA_SERVED(LocalBusiness localBusiness) {
	...
	public AREA_SERVED(Locksmith locksmith) {
	...
	public AREA_SERVED(LodgingBusiness lodgingBusiness) {
	...
	public AREA_SERVED(MedicalBusiness medicalBusiness) {
	...
	public AREA_SERVED(MedicalClinic medicalClinic) {
	...
	public AREA_SERVED(MeetingRoom meetingRoom) {
	...
	public AREA_SERVED(MensClothingStore mensClothingStore) {
	...
	public AREA_SERVED(Midwifery midwifery) {
	...
	public AREA_SERVED(MobilePhoneStore mobilePhoneStore) {
	...
	public AREA_SERVED(Mosque mosque) {
	...
	public AREA_SERVED(Motel motel) {
	...
	public AREA_SERVED(MotorcycleDealer motorcycleDealer) {
	...
	public AREA_SERVED(MotorcycleRepair motorcycleRepair) {
	...
	public AREA_SERVED(Mountain mountain) {
	...
	public AREA_SERVED(MovieRentalStore movieRentalStore) {
	...
	public AREA_SERVED(MovieTheater movieTheater) {
	...
	public AREA_SERVED(MovingCompany movingCompany) {
	...
	public AREA_SERVED(Museum museum) {
	...
	public AREA_SERVED(MusicStore musicStore) {
	...
	public AREA_SERVED(MusicVenue musicVenue) {
	...
	public AREA_SERVED(NailSalon nailSalon) {
	...
	public AREA_SERVED(NightClub nightClub) {
	...
	public AREA_SERVED(Notary notary) {
	...
	public AREA_SERVED(Nursing nursing) {
	...
	public AREA_SERVED(Obstetric obstetric) {
	...
	public AREA_SERVED(OceanBodyOfWater oceanBodyOfWater) {
	...
	public AREA_SERVED(OfficeEquipmentStore officeEquipmentStore) {
	...
	public AREA_SERVED(Oncologic oncologic) {
	...
	public AREA_SERVED(Optician optician) {
	...
	public AREA_SERVED(Optometric optometric) {
	...
	public AREA_SERVED(Otolaryngologic otolaryngologic) {
	...
	public AREA_SERVED(OutletStore outletStore) {
	...
	public AREA_SERVED(ParkingFacility parkingFacility) {
	...
	public AREA_SERVED(PawnShop pawnShop) {
	...
	public AREA_SERVED(Pediatric pediatric) {
	...
	public AREA_SERVED(PerformingArtsTheater performingArtsTheater) {
	...
	public AREA_SERVED(PetStore petStore) {
	...
	public AREA_SERVED(Pharmacy pharmacy) {
	...
	public AREA_SERVED(Physician physician) {
	...
	public AREA_SERVED(Physiotherapy physiotherapy) {
	...
	public AREA_SERVED(Place place) {
	...
	public AREA_SERVED(PlaceOfWorship placeOfWorship) {
	...
	public AREA_SERVED(PlasticSurgery plasticSurgery) {
	...
	public AREA_SERVED(Playground playground) {
	...
	public AREA_SERVED(Plumber plumber) {
	...
	public AREA_SERVED(Podiatric podiatric) {
	...
	public AREA_SERVED(PoliceStation policeStation) {
	...
	public AREA_SERVED(PostOffice postOffice) {
	...
	public AREA_SERVED(PrimaryCare primaryCare) {
	...
	public AREA_SERVED(ProfessionalService professionalService) {
	...
	public AREA_SERVED(Psychiatric psychiatric) {
	...
	public AREA_SERVED(PublicHealth publicHealth) {
	...
	public AREA_SERVED(PublicSwimmingPool publicSwimmingPool) {
	...
	public AREA_SERVED(PublicToilet publicToilet) {
	...
	public AREA_SERVED(RVPark rvPark) {
	...
	public AREA_SERVED(RadioStation radioStation) {
	...
	public AREA_SERVED(RealEstateAgent realEstateAgent) {
	...
	public AREA_SERVED(RecyclingCenter recyclingCenter) {
	...
	public AREA_SERVED(Reservoir reservoir) {
	...
	public AREA_SERVED(Residence residence) {
	...
	public AREA_SERVED(Resort resort) {
	...
	public AREA_SERVED(Restaurant restaurant) {
	...
	public AREA_SERVED(RiverBodyOfWater riverBodyOfWater) {
	...
	public AREA_SERVED(RoofingContractor roofingContractor) {
	...
	public AREA_SERVED(SeaBodyOfWater seaBodyOfWater) {
	...
	public AREA_SERVED(SelfStorage selfStorage) {
	...
	public AREA_SERVED(ShoeStore shoeStore) {
	...
	public AREA_SERVED(ShoppingCenter shoppingCenter) {
	...
	public AREA_SERVED(SingleFamilyResidence singleFamilyResidence) {
	...
	public AREA_SERVED(SkiResort skiResort) {
	...
	public AREA_SERVED(SportingGoodsStore sportingGoodsStore) {
	...
	public AREA_SERVED(SportsActivityLocation sportsActivityLocation) {
	...
	public AREA_SERVED(SportsClub sportsClub) {
	...
	public AREA_SERVED(StadiumOrArena stadiumOrArena) {
	...
	public AREA_SERVED(State state) {
	...
	public AREA_SERVED(Store store) {
	...
	public AREA_SERVED(SubwayStation subwayStation) {
	...
	public AREA_SERVED(Suite suite) {
	...
	public AREA_SERVED(Synagogue synagogue) {
	...
	public AREA_SERVED(TattooParlor tattooParlor) {
	...
	public AREA_SERVED(TaxiStand taxiStand) {
	...
	public AREA_SERVED(TelevisionStation televisionStation) {
	...
	public AREA_SERVED(TennisComplex tennisComplex) {
	...
	public AREA_SERVED(String string) {
		this(new TEXT(string));
	}

	public AREA_SERVED(Text text) {
	...
	public AREA_SERVED(TireShop tireShop) {
	...
	public AREA_SERVED(TouristAttraction touristAttraction) {
	...
	public AREA_SERVED(TouristDestination touristDestination) {
	...
	public AREA_SERVED(TouristInformationCenter touristInformationCenter) {
	...
	public AREA_SERVED(ToyStore toyStore) {
	...
	public AREA_SERVED(TrainStation trainStation) {
	...
	public AREA_SERVED(TravelAgency travelAgency) {
	...
	public AREA_SERVED(Volcano volcano) {
	...
	public AREA_SERVED(Waterfall waterfall) {
	...
	public AREA_SERVED(WholesaleStore wholesaleStore) {
	...
	public AREA_SERVED(Winery winery) {
	...
	public void copy(Container.AreaServed org) {
