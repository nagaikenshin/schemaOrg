...
public class ELIGIBLE_REGION implements Container.EligibleRegion {
	...
	public ELIGIBLE_REGION(Accommodation accommodation) {
	...
	public ELIGIBLE_REGION(AccountingService accountingService) {
	...
	public ELIGIBLE_REGION(AdultEntertainment adultEntertainment) {
	...
	public ELIGIBLE_REGION(Airport airport) {
	...
	public ELIGIBLE_REGION(AmusementPark amusementPark) {
	...
	public ELIGIBLE_REGION(AnimalShelter animalShelter) {
	...
	public ELIGIBLE_REGION(Apartment apartment) {
	...
	public ELIGIBLE_REGION(ApartmentComplex apartmentComplex) {
	...
	public ELIGIBLE_REGION(Aquarium aquarium) {
	...
	public ELIGIBLE_REGION(ArchiveOrganization archiveOrganization) {
	...
	public ELIGIBLE_REGION(ArtGallery artGallery) {
	...
	public ELIGIBLE_REGION(Attorney attorney) {
	...
	public ELIGIBLE_REGION(AutoBodyShop autoBodyShop) {
	...
	public ELIGIBLE_REGION(AutoDealer autoDealer) {
	...
	public ELIGIBLE_REGION(AutoPartsStore autoPartsStore) {
	...
	public ELIGIBLE_REGION(AutoRental autoRental) {
	...
	public ELIGIBLE_REGION(AutoRepair autoRepair) {
	...
	public ELIGIBLE_REGION(AutoWash autoWash) {
	...
	public ELIGIBLE_REGION(AutomatedTeller automatedTeller) {
	...
	public ELIGIBLE_REGION(AutomotiveBusiness automotiveBusiness) {
	...
	public ELIGIBLE_REGION(Bakery bakery) {
	...
	public ELIGIBLE_REGION(BankOrCreditUnion bankOrCreditUnion) {
	...
	public ELIGIBLE_REGION(BarOrPub barOrPub) {
	...
	public ELIGIBLE_REGION(Beach beach) {
	...
	public ELIGIBLE_REGION(BeautySalon beautySalon) {
	...
	public ELIGIBLE_REGION(BedAndBreakfast bedAndBreakfast) {
	...
	public ELIGIBLE_REGION(BikeStore bikeStore) {
	...
	public ELIGIBLE_REGION(BodyOfWater bodyOfWater) {
	...
	public ELIGIBLE_REGION(BookStore bookStore) {
	...
	public ELIGIBLE_REGION(BowlingAlley bowlingAlley) {
	...
	public ELIGIBLE_REGION(Brewery brewery) {
	...
	public ELIGIBLE_REGION(Bridge bridge) {
	...
	public ELIGIBLE_REGION(BuddhistTemple buddhistTemple) {
	...
	public ELIGIBLE_REGION(BusStation busStation) {
	...
	public ELIGIBLE_REGION(BusStop busStop) {
	...
	public ELIGIBLE_REGION(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public ELIGIBLE_REGION(Campground campground) {
	...
	public ELIGIBLE_REGION(CampingPitch campingPitch) {
	...
	public ELIGIBLE_REGION(Canal canal) {
	...
	public ELIGIBLE_REGION(Casino casino) {
	...
	public ELIGIBLE_REGION(CatholicChurch catholicChurch) {
	...
	public ELIGIBLE_REGION(Cemetery cemetery) {
	...
	public ELIGIBLE_REGION(ChildCare childCare) {
	...
	public ELIGIBLE_REGION(Church church) {
	...
	public ELIGIBLE_REGION(City city) {
	...
	public ELIGIBLE_REGION(CityHall cityHall) {
	...
	public ELIGIBLE_REGION(CivicStructure civicStructure) {
	...
	public ELIGIBLE_REGION(ClothingStore clothingStore) {
	...
	public ELIGIBLE_REGION(ComedyClub comedyClub) {
	...
	public ELIGIBLE_REGION(CommunityHealth communityHealth) {
	...
	public ELIGIBLE_REGION(ComputerStore computerStore) {
	...
	public ELIGIBLE_REGION(Continent continent) {
	...
	public ELIGIBLE_REGION(ConvenienceStore convenienceStore) {
	...
	public ELIGIBLE_REGION(Country country) {
	...
	public ELIGIBLE_REGION(Courthouse courthouse) {
	...
	public ELIGIBLE_REGION(Crematorium crematorium) {
	...
	public ELIGIBLE_REGION(DaySpa daySpa) {
	...
	public ELIGIBLE_REGION(DefenceEstablishment defenceEstablishment) {
	...
	public ELIGIBLE_REGION(Dentist dentist) {
	...
	public ELIGIBLE_REGION(DepartmentStore departmentStore) {
	...
	public ELIGIBLE_REGION(Dermatology dermatology) {
	...
	public ELIGIBLE_REGION(DietNutrition dietNutrition) {
	...
	public ELIGIBLE_REGION(Distillery distillery) {
	...
	public ELIGIBLE_REGION(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public ELIGIBLE_REGION(Electrician electrician) {
	...
	public ELIGIBLE_REGION(ElectronicsStore electronicsStore) {
	...
	public ELIGIBLE_REGION(Embassy embassy) {
	...
	public ELIGIBLE_REGION(Emergency emergency) {
	...
	public ELIGIBLE_REGION(EmergencyService emergencyService) {
	...
	public ELIGIBLE_REGION(EmploymentAgency employmentAgency) {
	...
	public ELIGIBLE_REGION(EntertainmentBusiness entertainmentBusiness) {
	...
	public ELIGIBLE_REGION(EventVenue eventVenue) {
	...
	public ELIGIBLE_REGION(ExerciseGym exerciseGym) {
	...
	public ELIGIBLE_REGION(FastFoodRestaurant fastFoodRestaurant) {
	...
	public ELIGIBLE_REGION(FinancialService financialService) {
	...
	public ELIGIBLE_REGION(FireStation fireStation) {
	...
	public ELIGIBLE_REGION(Florist florist) {
	...
	public ELIGIBLE_REGION(FoodEstablishment foodEstablishment) {
	...
	public ELIGIBLE_REGION(FurnitureStore furnitureStore) {
	...
	public ELIGIBLE_REGION(GardenStore gardenStore) {
	...
	public ELIGIBLE_REGION(GasStation gasStation) {
	...
	public ELIGIBLE_REGION(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public ELIGIBLE_REGION(GeneralContractor generalContractor) {
	...
	public ELIGIBLE_REGION(GeoCircle geoCircle) {
	...
	public ELIGIBLE_REGION(Geriatric geriatric) {
	...
	public ELIGIBLE_REGION(GolfCourse golfCourse) {
	...
	public ELIGIBLE_REGION(GovernmentBuilding governmentBuilding) {
	...
	public ELIGIBLE_REGION(GovernmentOffice governmentOffice) {
	...
	public ELIGIBLE_REGION(GroceryStore groceryStore) {
	...
	public ELIGIBLE_REGION(Gynecologic gynecologic) {
	...
	public ELIGIBLE_REGION(HVACBusiness hvacBusiness) {
	...
	public ELIGIBLE_REGION(HairSalon hairSalon) {
	...
	public ELIGIBLE_REGION(HardwareStore hardwareStore) {
	...
	public ELIGIBLE_REGION(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public ELIGIBLE_REGION(HealthClub healthClub) {
	...
	public ELIGIBLE_REGION(HinduTemple hinduTemple) {
	...
	public ELIGIBLE_REGION(HobbyShop hobbyShop) {
	...
	public ELIGIBLE_REGION(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public ELIGIBLE_REGION(HomeGoodsStore homeGoodsStore) {
	...
	public ELIGIBLE_REGION(Hospital hospital) {
	...
	public ELIGIBLE_REGION(Hostel hostel) {
	...
	public ELIGIBLE_REGION(Hotel hotel) {
	...
	public ELIGIBLE_REGION(HotelRoom hotelRoom) {
	...
	public ELIGIBLE_REGION(House house) {
	...
	public ELIGIBLE_REGION(HousePainter housePainter) {
	...
	public ELIGIBLE_REGION(IceCreamShop iceCreamShop) {
	...
	public ELIGIBLE_REGION(InsuranceAgency insuranceAgency) {
	...
	public ELIGIBLE_REGION(InternetCafe internetCafe) {
	...
	public ELIGIBLE_REGION(JewelryStore jewelryStore) {
	...
	public ELIGIBLE_REGION(LakeBodyOfWater lakeBodyOfWater) {
	...
	public ELIGIBLE_REGION(Landform landform) {
	...
	public ELIGIBLE_REGION(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public ELIGIBLE_REGION(LegalService legalService) {
	...
	public ELIGIBLE_REGION(LegislativeBuilding legislativeBuilding) {
	...
	public ELIGIBLE_REGION(Library library) {
	...
	public ELIGIBLE_REGION(LiquorStore liquorStore) {
	...
	public ELIGIBLE_REGION(LocalBusiness localBusiness) {
	...
	public ELIGIBLE_REGION(Locksmith locksmith) {
	...
	public ELIGIBLE_REGION(LodgingBusiness lodgingBusiness) {
	...
	public ELIGIBLE_REGION(MedicalBusiness medicalBusiness) {
	...
	public ELIGIBLE_REGION(MedicalClinic medicalClinic) {
	...
	public ELIGIBLE_REGION(MeetingRoom meetingRoom) {
	...
	public ELIGIBLE_REGION(MensClothingStore mensClothingStore) {
	...
	public ELIGIBLE_REGION(Midwifery midwifery) {
	...
	public ELIGIBLE_REGION(MobilePhoneStore mobilePhoneStore) {
	...
	public ELIGIBLE_REGION(Mosque mosque) {
	...
	public ELIGIBLE_REGION(Motel motel) {
	...
	public ELIGIBLE_REGION(MotorcycleDealer motorcycleDealer) {
	...
	public ELIGIBLE_REGION(MotorcycleRepair motorcycleRepair) {
	...
	public ELIGIBLE_REGION(Mountain mountain) {
	...
	public ELIGIBLE_REGION(MovieRentalStore movieRentalStore) {
	...
	public ELIGIBLE_REGION(MovieTheater movieTheater) {
	...
	public ELIGIBLE_REGION(MovingCompany movingCompany) {
	...
	public ELIGIBLE_REGION(Museum museum) {
	...
	public ELIGIBLE_REGION(MusicStore musicStore) {
	...
	public ELIGIBLE_REGION(MusicVenue musicVenue) {
	...
	public ELIGIBLE_REGION(NailSalon nailSalon) {
	...
	public ELIGIBLE_REGION(NightClub nightClub) {
	...
	public ELIGIBLE_REGION(Notary notary) {
	...
	public ELIGIBLE_REGION(Nursing nursing) {
	...
	public ELIGIBLE_REGION(Obstetric obstetric) {
	...
	public ELIGIBLE_REGION(OceanBodyOfWater oceanBodyOfWater) {
	...
	public ELIGIBLE_REGION(OfficeEquipmentStore officeEquipmentStore) {
	...
	public ELIGIBLE_REGION(Oncologic oncologic) {
	...
	public ELIGIBLE_REGION(Optician optician) {
	...
	public ELIGIBLE_REGION(Optometric optometric) {
	...
	public ELIGIBLE_REGION(Otolaryngologic otolaryngologic) {
	...
	public ELIGIBLE_REGION(OutletStore outletStore) {
	...
	public ELIGIBLE_REGION(Park park) {
	...
	public ELIGIBLE_REGION(ParkingFacility parkingFacility) {
	...
	public ELIGIBLE_REGION(PawnShop pawnShop) {
	...
	public ELIGIBLE_REGION(Pediatric pediatric) {
	...
	public ELIGIBLE_REGION(PerformingArtsTheater performingArtsTheater) {
	...
	public ELIGIBLE_REGION(PetStore petStore) {
	...
	public ELIGIBLE_REGION(Pharmacy pharmacy) {
	...
	public ELIGIBLE_REGION(Physician physician) {
	...
	public ELIGIBLE_REGION(Physiotherapy physiotherapy) {
	...
	public ELIGIBLE_REGION(PlaceOfWorship placeOfWorship) {
	...
	public ELIGIBLE_REGION(PlasticSurgery plasticSurgery) {
	...
	public ELIGIBLE_REGION(Playground playground) {
	...
	public ELIGIBLE_REGION(Plumber plumber) {
	...
	public ELIGIBLE_REGION(Podiatric podiatric) {
	...
	public ELIGIBLE_REGION(PoliceStation policeStation) {
	...
	public ELIGIBLE_REGION(Pond pond) {
	...
	public ELIGIBLE_REGION(PostOffice postOffice) {
	...
	public ELIGIBLE_REGION(PrimaryCare primaryCare) {
	...
	public ELIGIBLE_REGION(ProfessionalService professionalService) {
	...
	public ELIGIBLE_REGION(Psychiatric psychiatric) {
	...
	public ELIGIBLE_REGION(PublicHealth publicHealth) {
	...
	public ELIGIBLE_REGION(PublicSwimmingPool publicSwimmingPool) {
	...
	public ELIGIBLE_REGION(PublicToilet publicToilet) {
	...
	public ELIGIBLE_REGION(RVPark rvPark) {
	...
	public ELIGIBLE_REGION(RadioStation radioStation) {
	...
	public ELIGIBLE_REGION(RealEstateAgent realEstateAgent) {
	...
	public ELIGIBLE_REGION(RecyclingCenter recyclingCenter) {
	...
	public ELIGIBLE_REGION(Reservoir reservoir) {
	...
	public ELIGIBLE_REGION(Residence residence) {
	...
	public ELIGIBLE_REGION(Resort resort) {
	...
	public ELIGIBLE_REGION(Restaurant restaurant) {
	...
	public ELIGIBLE_REGION(RiverBodyOfWater riverBodyOfWater) {
	...
	public ELIGIBLE_REGION(RoofingContractor roofingContractor) {
	...
	public ELIGIBLE_REGION(Room room) {
	...
	public ELIGIBLE_REGION(SeaBodyOfWater seaBodyOfWater) {
	...
	public ELIGIBLE_REGION(SelfStorage selfStorage) {
	...
	public ELIGIBLE_REGION(ShoeStore shoeStore) {
	...
	public ELIGIBLE_REGION(ShoppingCenter shoppingCenter) {
	...
	public ELIGIBLE_REGION(SingleFamilyResidence singleFamilyResidence) {
	...
	public ELIGIBLE_REGION(SkiResort skiResort) {
	...
	public ELIGIBLE_REGION(SportingGoodsStore sportingGoodsStore) {
	...
	public ELIGIBLE_REGION(SportsActivityLocation sportsActivityLocation) {
	...
	public ELIGIBLE_REGION(SportsClub sportsClub) {
	...
	public ELIGIBLE_REGION(StadiumOrArena stadiumOrArena) {
	...
	public ELIGIBLE_REGION(State state) {
	...
	public ELIGIBLE_REGION(Store store) {
	...
	public ELIGIBLE_REGION(SubwayStation subwayStation) {
	...
	public ELIGIBLE_REGION(Suite suite) {
	...
	public ELIGIBLE_REGION(Synagogue synagogue) {
	...
	public ELIGIBLE_REGION(TattooParlor tattooParlor) {
	...
	public ELIGIBLE_REGION(TaxiStand taxiStand) {
	...
	public ELIGIBLE_REGION(TelevisionStation televisionStation) {
	...
	public ELIGIBLE_REGION(TennisComplex tennisComplex) {
	...
	public ELIGIBLE_REGION(TireShop tireShop) {
	...
	public ELIGIBLE_REGION(TouristAttraction touristAttraction) {
	...
	public ELIGIBLE_REGION(TouristDestination touristDestination) {
	...
	public ELIGIBLE_REGION(TouristInformationCenter touristInformationCenter) {
	...
	public ELIGIBLE_REGION(ToyStore toyStore) {
	...
	public ELIGIBLE_REGION(TrainStation trainStation) {
	...
	public ELIGIBLE_REGION(TravelAgency travelAgency) {
	...
	public ELIGIBLE_REGION(Volcano volcano) {
	...
	public ELIGIBLE_REGION(Waterfall waterfall) {
	...
	public ELIGIBLE_REGION(WholesaleStore wholesaleStore) {
	...
	public ELIGIBLE_REGION(Winery winery) {
	...
	public ELIGIBLE_REGION(Zoo zoo) {
