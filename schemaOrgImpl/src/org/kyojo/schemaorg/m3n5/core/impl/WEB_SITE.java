...
public class WEB_SITE implements Clazz.WebSite {
	...
	public WEB_SITE(Long seq) {
		setSeq(seq);
	}

	public WEB_SITE(String string) {
	...
	public WEB_SITE(AccessMode accessMode) {
	...
	public WEB_SITE(AccessModeSufficient accessModeSufficient) {
	...
	public WEB_SITE(AccessibilityAPI accessibilityAPI) {
	...
	public WEB_SITE(AccessibilityControl accessibilityControl) {
	...
	public WEB_SITE(AccessibilityFeature accessibilityFeature) {
	...
	public WEB_SITE(AccessibilityHazard accessibilityHazard) {
	...
	public WEB_SITE(AccessibilitySummary accessibilitySummary) {
	...
	public WEB_SITE(AccountablePerson accountablePerson) {
	...
	public WEB_SITE(AdditionalType additionalType) {
	...
	public WEB_SITE(AggregateRating aggregateRating) {
	...
	public WEB_SITE(AlternateName alternateName) {
	...
	public WEB_SITE(AlternativeHeadline alternativeHeadline) {
	...
	public WEB_SITE(AssociatedMedia associatedMedia) {
	...
	public WEB_SITE(Audience audience) {
	...
	public WEB_SITE(Character character) {
	...
	public WEB_SITE(Citation citation) {
	...
	public WEB_SITE(Comment comment) {
		setComment(comment);
	}
	...
	public WEB_SITE(CommentCount commentCount) {
	...
	public WEB_SITE(ContentLocation contentLocation) {
	...
	public WEB_SITE(ContentRating contentRating) {
	...
	public WEB_SITE(ContentReferenceTime contentReferenceTime) {
	...
	public WEB_SITE(Contributor contributor) {
	...
	public WEB_SITE(CopyrightHolder copyrightHolder) {
	...
	public WEB_SITE(CopyrightYear copyrightYear) {
	...
	public WEB_SITE(Correction correction) {
	...
	public WEB_SITE(Creator creator) {
		setCreator(creator);
	}
	...
	public WEB_SITE(DateCreated dateCreated) {
	...
	public WEB_SITE(DateModified dateModified) {
	...
	public WEB_SITE(DatePublished datePublished) {
	...
	public WEB_SITE(Description description) {
	...
	public WEB_SITE(DisambiguatingDescription disambiguatingDescription) {
	...
	public WEB_SITE(DiscussionUrl discussionUrl) {
	...
	public WEB_SITE(EducationalAlignment educationalAlignment) {
	...
	public WEB_SITE(EducationalUse educationalUse) {
	...
	public WEB_SITE(Encoding encoding) {
	...
	public WEB_SITE(EncodingFormat encodingFormat) {
	...
	public WEB_SITE(ExampleOfWork exampleOfWork) {
	...
	public WEB_SITE(Expires expires) {
		setExpires(expires);
	}
	...
	public WEB_SITE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public WEB_SITE(Headline headline) {
	...
	public WEB_SITE(Identifier identifier) {
	...
	public WEB_SITE(InLanguage inLanguage) {
	...
	public WEB_SITE(InteractionStatistic interactionStatistic) {
	...
	public WEB_SITE(InteractivityType interactivityType) {
	...
	public WEB_SITE(IsAccessibleForFree isAccessibleForFree) {
	...
	public WEB_SITE(IsBasedOn isBasedOn) {
	...
	public WEB_SITE(IsFamilyFriendly isFamilyFriendly) {
	...
	public WEB_SITE(IsPartOf isPartOf) {
	...
	public WEB_SITE(Keywords keywords) {
	...
	public WEB_SITE(LearningResourceType learningResourceType) {
	...
	public WEB_SITE(License license) {
		setLicense(license);
	}
	...
	public WEB_SITE(LocationCreated locationCreated) {
	...
	public WEB_SITE(MainEntity mainEntity) {
	...
	public WEB_SITE(MainEntityOfPage mainEntityOfPage) {
	...
	public WEB_SITE(Material material) {
	...
	public WEB_SITE(MaterialExtent materialExtent) {
	...
	public WEB_SITE(Mentions mentions) {
	...
	public WEB_SITE(NameFuzzy nameFuzzy) {
	...
	public WEB_SITE(NameRuby nameRuby) {
	...
	public WEB_SITE(Position position) {
	...
	public WEB_SITE(PotentialAction potentialAction) {
	...
	public WEB_SITE(Producer producer) {
	...
	public WEB_SITE(Provider provider) {
	...
	public WEB_SITE(Publication publication) {
	...
	public WEB_SITE(Publisher publisher) {
	...
	public WEB_SITE(PublisherImprint publisherImprint) {
	...
	public WEB_SITE(PublishingPrinciples publishingPrinciples) {
	...
	public WEB_SITE(RecordedAt recordedAt) {
	...
	public WEB_SITE(ReleasedEvent releasedEvent) {
	...
	public WEB_SITE(SchemaVersion schemaVersion) {
	...
	public WEB_SITE(SdDatePublished sdDatePublished) {
	...
	public WEB_SITE(SdLicense sdLicense) {
	...
	public WEB_SITE(SdPublisher sdPublisher) {
	...
	public WEB_SITE(SourceOrganization sourceOrganization) {
	...
	public WEB_SITE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public WEB_SITE(SpatialCoverage spatialCoverage) {
	...
	public WEB_SITE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public WEB_SITE(SubjectOf subjectOf) {
	...
	public WEB_SITE(Temporal temporal) {
	...
	public WEB_SITE(TemporalCoverage temporalCoverage) {
	...
	public WEB_SITE(ThumbnailUrl thumbnailUrl) {
	...
	public WEB_SITE(TimeRequired timeRequired) {
	...
	public WEB_SITE(TranslationOfWork translationOfWork) {
	...
	public WEB_SITE(Translator translator) {
	...
	public WEB_SITE(TypicalAgeRange typicalAgeRange) {
	...
	public WEB_SITE(Version version) {
		setVersion(version);
	}
	...
	public WEB_SITE(WorkExample workExample) {
	...
	public WEB_SITE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.WebSite org) {
		setSeq(org.getSeq());
