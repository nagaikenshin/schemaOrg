...
public class DEATH_PLACE implements Container.DeathPlace {
	...
	public DEATH_PLACE(String string) {
	...
	public DEATH_PLACE(Accommodation accommodation) {
	...
	public DEATH_PLACE(AccountingService accountingService) {
	...
	public DEATH_PLACE(AdministrativeArea administrativeArea) {
	...
	public DEATH_PLACE(AdultEntertainment adultEntertainment) {
	...
	public DEATH_PLACE(Airport airport) {
	...
	public DEATH_PLACE(AmusementPark amusementPark) {
	...
	public DEATH_PLACE(AnimalShelter animalShelter) {
	...
	public DEATH_PLACE(Apartment apartment) {
	...
	public DEATH_PLACE(ApartmentComplex apartmentComplex) {
	...
	public DEATH_PLACE(Aquarium aquarium) {
	...
	public DEATH_PLACE(ArchiveOrganization archiveOrganization) {
	...
	public DEATH_PLACE(ArtGallery artGallery) {
	...
	public DEATH_PLACE(Attorney attorney) {
	...
	public DEATH_PLACE(AutoBodyShop autoBodyShop) {
	...
	public DEATH_PLACE(AutoDealer autoDealer) {
	...
	public DEATH_PLACE(AutoPartsStore autoPartsStore) {
	...
	public DEATH_PLACE(AutoRental autoRental) {
	...
	public DEATH_PLACE(AutoRepair autoRepair) {
	...
	public DEATH_PLACE(AutoWash autoWash) {
	...
	public DEATH_PLACE(AutomatedTeller automatedTeller) {
	...
	public DEATH_PLACE(AutomotiveBusiness automotiveBusiness) {
	...
	public DEATH_PLACE(Bakery bakery) {
	...
	public DEATH_PLACE(BankOrCreditUnion bankOrCreditUnion) {
	...
	public DEATH_PLACE(BarOrPub barOrPub) {
	...
	public DEATH_PLACE(Beach beach) {
	...
	public DEATH_PLACE(BeautySalon beautySalon) {
	...
	public DEATH_PLACE(BedAndBreakfast bedAndBreakfast) {
	...
	public DEATH_PLACE(BikeStore bikeStore) {
	...
	public DEATH_PLACE(BodyOfWater bodyOfWater) {
	...
	public DEATH_PLACE(BookStore bookStore) {
	...
	public DEATH_PLACE(BowlingAlley bowlingAlley) {
	...
	public DEATH_PLACE(Brewery brewery) {
	...
	public DEATH_PLACE(Bridge bridge) {
	...
	public DEATH_PLACE(BuddhistTemple buddhistTemple) {
	...
	public DEATH_PLACE(BusStation busStation) {
	...
	public DEATH_PLACE(BusStop busStop) {
	...
	public DEATH_PLACE(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public DEATH_PLACE(Campground campground) {
	...
	public DEATH_PLACE(CampingPitch campingPitch) {
	...
	public DEATH_PLACE(Canal canal) {
	...
	public DEATH_PLACE(Casino casino) {
	...
	public DEATH_PLACE(CatholicChurch catholicChurch) {
	...
	public DEATH_PLACE(Cemetery cemetery) {
	...
	public DEATH_PLACE(ChildCare childCare) {
	...
	public DEATH_PLACE(Church church) {
	...
	public DEATH_PLACE(CityHall cityHall) {
	...
	public DEATH_PLACE(CivicStructure civicStructure) {
	...
	public DEATH_PLACE(ClothingStore clothingStore) {
	...
	public DEATH_PLACE(ComedyClub comedyClub) {
	...
	public DEATH_PLACE(CommunityHealth communityHealth) {
	...
	public DEATH_PLACE(ComputerStore computerStore) {
	...
	public DEATH_PLACE(Continent continent) {
	...
	public DEATH_PLACE(ConvenienceStore convenienceStore) {
	...
	public DEATH_PLACE(Country country) {
	...
	public DEATH_PLACE(Courthouse courthouse) {
	...
	public DEATH_PLACE(Crematorium crematorium) {
	...
	public DEATH_PLACE(DaySpa daySpa) {
	...
	public DEATH_PLACE(DefenceEstablishment defenceEstablishment) {
	...
	public DEATH_PLACE(Dentist dentist) {
	...
	public DEATH_PLACE(DepartmentStore departmentStore) {
	...
	public DEATH_PLACE(Dermatology dermatology) {
	...
	public DEATH_PLACE(DietNutrition dietNutrition) {
	...
	public DEATH_PLACE(Distillery distillery) {
	...
	public DEATH_PLACE(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public DEATH_PLACE(Electrician electrician) {
	...
	public DEATH_PLACE(ElectronicsStore electronicsStore) {
	...
	public DEATH_PLACE(Embassy embassy) {
	...
	public DEATH_PLACE(Emergency emergency) {
	...
	public DEATH_PLACE(EmergencyService emergencyService) {
	...
	public DEATH_PLACE(EmploymentAgency employmentAgency) {
	...
	public DEATH_PLACE(EntertainmentBusiness entertainmentBusiness) {
	...
	public DEATH_PLACE(EventVenue eventVenue) {
	...
	public DEATH_PLACE(ExerciseGym exerciseGym) {
	...
	public DEATH_PLACE(FastFoodRestaurant fastFoodRestaurant) {
	...
	public DEATH_PLACE(FinancialService financialService) {
	...
	public DEATH_PLACE(FireStation fireStation) {
	...
	public DEATH_PLACE(Florist florist) {
	...
	public DEATH_PLACE(FoodEstablishment foodEstablishment) {
	...
	public DEATH_PLACE(FurnitureStore furnitureStore) {
	...
	public DEATH_PLACE(GardenStore gardenStore) {
	...
	public DEATH_PLACE(GasStation gasStation) {
	...
	public DEATH_PLACE(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public DEATH_PLACE(GeneralContractor generalContractor) {
	...
	public DEATH_PLACE(Geriatric geriatric) {
	...
	public DEATH_PLACE(GolfCourse golfCourse) {
	...
	public DEATH_PLACE(GovernmentBuilding governmentBuilding) {
	...
	public DEATH_PLACE(GovernmentOffice governmentOffice) {
	...
	public DEATH_PLACE(GroceryStore groceryStore) {
	...
	public DEATH_PLACE(Gynecologic gynecologic) {
	...
	public DEATH_PLACE(HVACBusiness hvacBusiness) {
	...
	public DEATH_PLACE(HairSalon hairSalon) {
	...
	public DEATH_PLACE(HardwareStore hardwareStore) {
	...
	public DEATH_PLACE(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public DEATH_PLACE(HealthClub healthClub) {
	...
	public DEATH_PLACE(HinduTemple hinduTemple) {
	...
	public DEATH_PLACE(HobbyShop hobbyShop) {
	...
	public DEATH_PLACE(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public DEATH_PLACE(HomeGoodsStore homeGoodsStore) {
	...
	public DEATH_PLACE(Hospital hospital) {
	...
	public DEATH_PLACE(Hostel hostel) {
	...
	public DEATH_PLACE(Hotel hotel) {
	...
	public DEATH_PLACE(HotelRoom hotelRoom) {
	...
	public DEATH_PLACE(House house) {
	...
	public DEATH_PLACE(HousePainter housePainter) {
	...
	public DEATH_PLACE(IceCreamShop iceCreamShop) {
	...
	public DEATH_PLACE(InsuranceAgency insuranceAgency) {
	...
	public DEATH_PLACE(InternetCafe internetCafe) {
	...
	public DEATH_PLACE(JewelryStore jewelryStore) {
	...
	public DEATH_PLACE(LakeBodyOfWater lakeBodyOfWater) {
	...
	public DEATH_PLACE(Landform landform) {
	...
	public DEATH_PLACE(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public DEATH_PLACE(LegalService legalService) {
	...
	public DEATH_PLACE(LegislativeBuilding legislativeBuilding) {
	...
	public DEATH_PLACE(Library library) {
	...
	public DEATH_PLACE(LiquorStore liquorStore) {
	...
	public DEATH_PLACE(LocalBusiness localBusiness) {
	...
	public DEATH_PLACE(Locksmith locksmith) {
	...
	public DEATH_PLACE(LodgingBusiness lodgingBusiness) {
	...
	public DEATH_PLACE(MedicalBusiness medicalBusiness) {
	...
	public DEATH_PLACE(MedicalClinic medicalClinic) {
	...
	public DEATH_PLACE(MeetingRoom meetingRoom) {
	...
	public DEATH_PLACE(MensClothingStore mensClothingStore) {
	...
	public DEATH_PLACE(Midwifery midwifery) {
	...
	public DEATH_PLACE(MobilePhoneStore mobilePhoneStore) {
	...
	public DEATH_PLACE(Mosque mosque) {
	...
	public DEATH_PLACE(Motel motel) {
	...
	public DEATH_PLACE(MotorcycleDealer motorcycleDealer) {
	...
	public DEATH_PLACE(MotorcycleRepair motorcycleRepair) {
	...
	public DEATH_PLACE(Mountain mountain) {
	...
	public DEATH_PLACE(MovieRentalStore movieRentalStore) {
	...
	public DEATH_PLACE(MovieTheater movieTheater) {
	...
	public DEATH_PLACE(MovingCompany movingCompany) {
	...
	public DEATH_PLACE(Museum museum) {
	...
	public DEATH_PLACE(MusicStore musicStore) {
	...
	public DEATH_PLACE(MusicVenue musicVenue) {
	...
	public DEATH_PLACE(NailSalon nailSalon) {
	...
	public DEATH_PLACE(NightClub nightClub) {
	...
	public DEATH_PLACE(Notary notary) {
	...
	public DEATH_PLACE(Nursing nursing) {
	...
	public DEATH_PLACE(Obstetric obstetric) {
	...
	public DEATH_PLACE(OceanBodyOfWater oceanBodyOfWater) {
	...
	public DEATH_PLACE(OfficeEquipmentStore officeEquipmentStore) {
	...
	public DEATH_PLACE(Oncologic oncologic) {
	...
	public DEATH_PLACE(Optician optician) {
	...
	public DEATH_PLACE(Optometric optometric) {
	...
	public DEATH_PLACE(Otolaryngologic otolaryngologic) {
	...
	public DEATH_PLACE(OutletStore outletStore) {
	...
	public DEATH_PLACE(ParkingFacility parkingFacility) {
	...
	public DEATH_PLACE(PawnShop pawnShop) {
	...
	public DEATH_PLACE(Pediatric pediatric) {
	...
	public DEATH_PLACE(PerformingArtsTheater performingArtsTheater) {
	...
	public DEATH_PLACE(PetStore petStore) {
	...
	public DEATH_PLACE(Pharmacy pharmacy) {
	...
	public DEATH_PLACE(Physician physician) {
	...
	public DEATH_PLACE(Physiotherapy physiotherapy) {
	...
	public DEATH_PLACE(Place place) {
		placeList = new ArrayList<Place>();
		placeList.add(place);
	}
	...
	public DEATH_PLACE(PlaceOfWorship placeOfWorship) {
	...
	public DEATH_PLACE(PlasticSurgery plasticSurgery) {
	...
	public DEATH_PLACE(Playground playground) {
	...
	public DEATH_PLACE(Plumber plumber) {
	...
	public DEATH_PLACE(Podiatric podiatric) {
	...
	public DEATH_PLACE(PoliceStation policeStation) {
	...
	public DEATH_PLACE(PostOffice postOffice) {
	...
	public DEATH_PLACE(PrimaryCare primaryCare) {
	...
	public DEATH_PLACE(ProfessionalService professionalService) {
	...
	public DEATH_PLACE(Psychiatric psychiatric) {
	...
	public DEATH_PLACE(PublicHealth publicHealth) {
	...
	public DEATH_PLACE(PublicSwimmingPool publicSwimmingPool) {
	...
	public DEATH_PLACE(PublicToilet publicToilet) {
	...
	public DEATH_PLACE(RVPark rvPark) {
	...
	public DEATH_PLACE(RadioStation radioStation) {
	...
	public DEATH_PLACE(RealEstateAgent realEstateAgent) {
	...
	public DEATH_PLACE(RecyclingCenter recyclingCenter) {
	...
	public DEATH_PLACE(Reservoir reservoir) {
	...
	public DEATH_PLACE(Residence residence) {
	...
	public DEATH_PLACE(Resort resort) {
	...
	public DEATH_PLACE(Restaurant restaurant) {
	...
	public DEATH_PLACE(RiverBodyOfWater riverBodyOfWater) {
	...
	public DEATH_PLACE(RoofingContractor roofingContractor) {
	...
	public DEATH_PLACE(SeaBodyOfWater seaBodyOfWater) {
	...
	public DEATH_PLACE(SelfStorage selfStorage) {
	...
	public DEATH_PLACE(ShoeStore shoeStore) {
	...
	public DEATH_PLACE(ShoppingCenter shoppingCenter) {
	...
	public DEATH_PLACE(SingleFamilyResidence singleFamilyResidence) {
	...
	public DEATH_PLACE(SkiResort skiResort) {
	...
	public DEATH_PLACE(SportingGoodsStore sportingGoodsStore) {
	...
	public DEATH_PLACE(SportsActivityLocation sportsActivityLocation) {
	...
	public DEATH_PLACE(SportsClub sportsClub) {
	...
	public DEATH_PLACE(StadiumOrArena stadiumOrArena) {
	...
	public DEATH_PLACE(State state) {
	...
	public DEATH_PLACE(Store store) {
	...
	public DEATH_PLACE(SubwayStation subwayStation) {
	...
	public DEATH_PLACE(Suite suite) {
	...
	public DEATH_PLACE(Synagogue synagogue) {
	...
	public DEATH_PLACE(TattooParlor tattooParlor) {
	...
	public DEATH_PLACE(TaxiStand taxiStand) {
	...
	public DEATH_PLACE(TelevisionStation televisionStation) {
	...
	public DEATH_PLACE(TennisComplex tennisComplex) {
	...
	public DEATH_PLACE(TireShop tireShop) {
	...
	public DEATH_PLACE(TouristAttraction touristAttraction) {
	...
	public DEATH_PLACE(TouristDestination touristDestination) {
	...
	public DEATH_PLACE(TouristInformationCenter touristInformationCenter) {
	...
	public DEATH_PLACE(ToyStore toyStore) {
	...
	public DEATH_PLACE(TrainStation trainStation) {
	...
	public DEATH_PLACE(TravelAgency travelAgency) {
	...
	public DEATH_PLACE(Volcano volcano) {
	...
	public DEATH_PLACE(Waterfall waterfall) {
	...
	public DEATH_PLACE(WholesaleStore wholesaleStore) {
	...
	public DEATH_PLACE(Winery winery) {
	...
	public void copy(Container.DeathPlace org) {
