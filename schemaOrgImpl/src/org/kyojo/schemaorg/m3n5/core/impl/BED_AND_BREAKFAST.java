...
public class BED_AND_BREAKFAST implements Clazz.BedAndBreakfast {
	...
	public BED_AND_BREAKFAST(GeoContains geoContains) {
	...
	public BED_AND_BREAKFAST(GeoCoveredBy geoCoveredBy) {
	...
	public BED_AND_BREAKFAST(GeoCovers geoCovers) {
	...
	public BED_AND_BREAKFAST(GeoCrosses geoCrosses) {
	...
	public BED_AND_BREAKFAST(GeoDisjoint geoDisjoint) {
	...
	public BED_AND_BREAKFAST(GeoEquals geoEquals) {
	...
	public BED_AND_BREAKFAST(GeoIntersects geoIntersects) {
	...
	public BED_AND_BREAKFAST(GeoOverlaps geoOverlaps) {
	...
	public BED_AND_BREAKFAST(GeoTouches geoTouches) {
	...
	public BED_AND_BREAKFAST(GeoWithin geoWithin) {
	...
	public BED_AND_BREAKFAST(Slogan slogan) {
		setSlogan(slogan);
	}
