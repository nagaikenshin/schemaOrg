...
public class EVENT_RESERVATION implements Clazz.EventReservation {
	...
	public EVENT_RESERVATION(Long seq) {
		setSeq(seq);
	}

	public EVENT_RESERVATION(String string) {
	...
	public EVENT_RESERVATION(AdditionalType additionalType) {
	...
	public EVENT_RESERVATION(AlternateName alternateName) {
	...
	public EVENT_RESERVATION(BookingTime bookingTime) {
	...
	public EVENT_RESERVATION(Broker broker) {
		setBroker(broker);
	}
	...
	public EVENT_RESERVATION(Description description) {
	...
	public EVENT_RESERVATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public EVENT_RESERVATION(Identifier identifier) {
	...
	public EVENT_RESERVATION(Image image) {
		setImage(image);
	}
	...
	public EVENT_RESERVATION(MainEntityOfPage mainEntityOfPage) {
	...
	public EVENT_RESERVATION(ModifiedTime modifiedTime) {
	...
	public EVENT_RESERVATION(Name name) {
		setName(name);
	}
	...
	public EVENT_RESERVATION(NameFuzzy nameFuzzy) {
	...
	public EVENT_RESERVATION(NameRuby nameRuby) {
	...
	public EVENT_RESERVATION(PotentialAction potentialAction) {
	...
	public EVENT_RESERVATION(PriceCurrency priceCurrency) {
	...
	public EVENT_RESERVATION(ProgramMembershipUsed programMembershipUsed) {
	...
	public EVENT_RESERVATION(Provider provider) {
	...
	public EVENT_RESERVATION(ReservationFor reservationFor) {
	...
	public EVENT_RESERVATION(ReservationId reservationId) {
	...
	public EVENT_RESERVATION(ReservationStatus reservationStatus) {
	...
	public EVENT_RESERVATION(ReservedTicket reservedTicket) {
	...
	public EVENT_RESERVATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public EVENT_RESERVATION(SubjectOf subjectOf) {
	...
	public EVENT_RESERVATION(TotalPrice totalPrice) {
	...
	public EVENT_RESERVATION(UnderName underName) {
	...
	public EVENT_RESERVATION(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.EventReservation org) {
		setSeq(org.getSeq());
