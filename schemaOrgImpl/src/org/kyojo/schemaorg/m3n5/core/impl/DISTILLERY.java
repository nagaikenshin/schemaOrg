...
public class DISTILLERY implements Clazz.Distillery {
	...
	public DISTILLERY(GeoContains geoContains) {
	...
	public DISTILLERY(GeoCoveredBy geoCoveredBy) {
	...
	public DISTILLERY(GeoCovers geoCovers) {
	...
	public DISTILLERY(GeoCrosses geoCrosses) {
	...
	public DISTILLERY(GeoDisjoint geoDisjoint) {
	...
	public DISTILLERY(GeoEquals geoEquals) {
	...
	public DISTILLERY(GeoIntersects geoIntersects) {
	...
	public DISTILLERY(GeoOverlaps geoOverlaps) {
	...
	public DISTILLERY(GeoTouches geoTouches) {
	...
	public DISTILLERY(GeoWithin geoWithin) {
	...
	public DISTILLERY(Slogan slogan) {
		setSlogan(slogan);
	}
