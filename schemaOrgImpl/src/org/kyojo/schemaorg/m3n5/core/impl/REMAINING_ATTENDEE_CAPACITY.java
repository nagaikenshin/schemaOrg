...
public class REMAINING_ATTENDEE_CAPACITY implements Container.RemainingAttendeeCapacity {
	...
	public REMAINING_ATTENDEE_CAPACITY(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public REMAINING_ATTENDEE_CAPACITY(Integer integer) {
