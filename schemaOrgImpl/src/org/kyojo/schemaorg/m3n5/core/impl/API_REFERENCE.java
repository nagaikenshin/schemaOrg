...
import org.kyojo.schemaorg.m3n5.core.Container.ProgrammingModel;
...
public class API_REFERENCE implements Clazz.APIReference {
	...
	public ExecutableLibraryName executableLibraryName;
	...
	public API_REFERENCE(Long seq) {
		setSeq(seq);
	}

	public API_REFERENCE(String string) {
	...
	public API_REFERENCE(About about) {
		setAbout(about);
	}
	...
	public API_REFERENCE(AccessMode accessMode) {
	...
	public API_REFERENCE(AccessModeSufficient accessModeSufficient) {
	...
	public API_REFERENCE(AccessibilityAPI accessibilityAPI) {
	...
	public API_REFERENCE(AccessibilityControl accessibilityControl) {
	...
	public API_REFERENCE(AccessibilityFeature accessibilityFeature) {
	...
	public API_REFERENCE(AccessibilityHazard accessibilityHazard) {
	...
	public API_REFERENCE(AccessibilitySummary accessibilitySummary) {
	...
	public API_REFERENCE(AccountablePerson accountablePerson) {
	...
	public API_REFERENCE(AdditionalType additionalType) {
	...
	public API_REFERENCE(AggregateRating aggregateRating) {
	...
	public API_REFERENCE(AlternateName alternateName) {
	...
	public API_REFERENCE(AlternativeHeadline alternativeHeadline) {
	...
	public API_REFERENCE(ArticleBody articleBody) {
	...
	public API_REFERENCE(ArticleSection articleSection) {
	...
	public API_REFERENCE(AssemblyVersion assemblyVersion) {
	...
	@Override
	public void setAssemblyVersion(AssemblyVersion assemblyVersion) {
		this.assemblyVersion = assemblyVersion;
	}

	public API_REFERENCE(AssociatedMedia associatedMedia) {
	...
	public API_REFERENCE(Audience audience) {
	...
	public API_REFERENCE(Audio audio) {
		setAudio(audio);
	}
	...
	public API_REFERENCE(Author author) {
		setAuthor(author);
	}
	...
	public API_REFERENCE(Award award) {
		setAward(award);
	}
	...
	public API_REFERENCE(Backstory backstory) {
	...
	public API_REFERENCE(Character character) {
	...
	public API_REFERENCE(Citation citation) {
	...
	public API_REFERENCE(Comment comment) {
		setComment(comment);
	}
	...
	public API_REFERENCE(CommentCount commentCount) {
	...
	public API_REFERENCE(ContentLocation contentLocation) {
	...
	public API_REFERENCE(ContentRating contentRating) {
	...
	public API_REFERENCE(ContentReferenceTime contentReferenceTime) {
	...
	public API_REFERENCE(Contributor contributor) {
	...
	public API_REFERENCE(CopyrightHolder copyrightHolder) {
	...
	public API_REFERENCE(CopyrightYear copyrightYear) {
	...
	public API_REFERENCE(Correction correction) {
	...
	public API_REFERENCE(Creator creator) {
		setCreator(creator);
	}
	...
	public API_REFERENCE(DateCreated dateCreated) {
	...
	public API_REFERENCE(DateModified dateModified) {
	...
	public API_REFERENCE(DatePublished datePublished) {
	...
	public API_REFERENCE(Dependencies dependencies) {
	...
	public API_REFERENCE(Description description) {
	...
	public API_REFERENCE(DisambiguatingDescription disambiguatingDescription) {
	...
	public API_REFERENCE(DiscussionUrl discussionUrl) {
	...
	public API_REFERENCE(Editor editor) {
		setEditor(editor);
	}
	...
	public API_REFERENCE(EducationalAlignment educationalAlignment) {
	...
	public API_REFERENCE(EducationalUse educationalUse) {
	...
	public API_REFERENCE(Encoding encoding) {
	...
	public API_REFERENCE(EncodingFormat encodingFormat) {
	...
	public API_REFERENCE(ExampleOfWork exampleOfWork) {
	...
	public API_REFERENCE(ExecutableLibraryName executableLibraryName) {
		setExecutableLibraryName(executableLibraryName);
	}

	@Override
	public ExecutableLibraryName getExecutableLibraryName() {
		return executableLibraryName;
	}

	@Override
	public void setExecutableLibraryName(ExecutableLibraryName executableLibraryName) {
		this.executableLibraryName = executableLibraryName;
	}

	public API_REFERENCE(Expires expires) {
		setExpires(expires);
	}
	...
	public API_REFERENCE(Funder funder) {
		setFunder(funder);
	}
	...
	public API_REFERENCE(Genre genre) {
		setGenre(genre);
	}
	...
	public API_REFERENCE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public API_REFERENCE(Headline headline) {
	...
	public API_REFERENCE(Identifier identifier) {
	...
	public API_REFERENCE(Image image) {
		setImage(image);
	}
	...
	public API_REFERENCE(InLanguage inLanguage) {
	...
	public API_REFERENCE(InteractionStatistic interactionStatistic) {
	...
	public API_REFERENCE(InteractivityType interactivityType) {
	...
	public API_REFERENCE(IsAccessibleForFree isAccessibleForFree) {
	...
	public API_REFERENCE(IsBasedOn isBasedOn) {
	...
	public API_REFERENCE(IsFamilyFriendly isFamilyFriendly) {
	...
	public API_REFERENCE(IsPartOf isPartOf) {
	...
	public API_REFERENCE(Keywords keywords) {
	...
	public API_REFERENCE(LearningResourceType learningResourceType) {
	...
	public API_REFERENCE(License license) {
		setLicense(license);
	}
	...
	public API_REFERENCE(LocationCreated locationCreated) {
	...
	public API_REFERENCE(MainEntity mainEntity) {
	...
	public API_REFERENCE(MainEntityOfPage mainEntityOfPage) {
	...
	public API_REFERENCE(Material material) {
	...
	public API_REFERENCE(MaterialExtent materialExtent) {
	...
	public API_REFERENCE(Mentions mentions) {
	...
	public API_REFERENCE(Name name) {
		setName(name);
	}
	...
	public API_REFERENCE(NameFuzzy nameFuzzy) {
	...
	public API_REFERENCE(NameRuby nameRuby) {
	...
	public API_REFERENCE(Offers offers) {
		setOffers(offers);
	}
	...
	public API_REFERENCE(PageEnd pageEnd) {
		setPageEnd(pageEnd);
	}
	...
	public API_REFERENCE(PageStart pageStart) {
	...
	public API_REFERENCE(Pagination pagination) {
	...
	public API_REFERENCE(Position position) {
	...
	public API_REFERENCE(PotentialAction potentialAction) {
	...
	public API_REFERENCE(Producer producer) {
	...
	public API_REFERENCE(ProficiencyLevel proficiencyLevel) {
	...
	public API_REFERENCE(ProgrammingModel programmingModel) {
		setProgrammingModel(programmingModel);
	}
	...
	public API_REFERENCE(Provider provider) {
	...
	public API_REFERENCE(Publication publication) {
	...
	public API_REFERENCE(Publisher publisher) {
	...
	public API_REFERENCE(PublisherImprint publisherImprint) {
	...
	public API_REFERENCE(PublishingPrinciples publishingPrinciples) {
	...
	public API_REFERENCE(RecordedAt recordedAt) {
	...
	public API_REFERENCE(ReleasedEvent releasedEvent) {
	...
	public API_REFERENCE(Review review) {
		setReview(review);
	}
	...
	public API_REFERENCE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public API_REFERENCE(SchemaVersion schemaVersion) {
	...
	public API_REFERENCE(SdDatePublished sdDatePublished) {
	...
	public API_REFERENCE(SdLicense sdLicense) {
	...
	public API_REFERENCE(SdPublisher sdPublisher) {
	...
	public API_REFERENCE(SourceOrganization sourceOrganization) {
	...
	public API_REFERENCE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public API_REFERENCE(SpatialCoverage spatialCoverage) {
	...
	public API_REFERENCE(Speakable speakable) {
	...
	public API_REFERENCE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public API_REFERENCE(SubjectOf subjectOf) {
	...
	public API_REFERENCE(TargetPlatform targetPlatform) {
	...
	public API_REFERENCE(Temporal temporal) {
	...
	public API_REFERENCE(TemporalCoverage temporalCoverage) {
	...
	public API_REFERENCE(Text text) {
		setText(text);
	}
	...
	public API_REFERENCE(ThumbnailUrl thumbnailUrl) {
	...
	public API_REFERENCE(TimeRequired timeRequired) {
	...
	public API_REFERENCE(TranslationOfWork translationOfWork) {
	...
	public API_REFERENCE(Translator translator) {
	...
	public API_REFERENCE(TypicalAgeRange typicalAgeRange) {
	...
	public API_REFERENCE(Version version) {
		setVersion(version);
	}
	...
	public API_REFERENCE(Video video) {
		setVideo(video);
	}
	...
	public API_REFERENCE(WordCount wordCount) {
	...
	public API_REFERENCE(WorkExample workExample) {
	...
	public API_REFERENCE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.APIReference org) {
		setSeq(org.getSeq());
		...
		setAssemblyVersion(org.getAssemblyVersion());
		...
		setDependencies(org.getDependencies());
		...
		setExecutableLibraryName(org.getExecutableLibraryName());
		...
		setProficiencyLevel(org.getProficiencyLevel());
		setProgrammingModel(org.getProgrammingModel());
		...
		setTargetPlatform(org.getTargetPlatform());
