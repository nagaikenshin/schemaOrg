...
public class GEO_INTERSECTS implements Container.GeoIntersects {
	...
	public GEO_INTERSECTS() {
	}

	public GEO_INTERSECTS(String string) {
	...
	public GEO_INTERSECTS(Accommodation accommodation) {
	...
	public GEO_INTERSECTS(AccountingService accountingService) {
	...
	public GEO_INTERSECTS(AdministrativeArea administrativeArea) {
	...
	public GEO_INTERSECTS(AdultEntertainment adultEntertainment) {
	...
	public GEO_INTERSECTS(Airport airport) {
	...
	public GEO_INTERSECTS(AmusementPark amusementPark) {
	...
	public GEO_INTERSECTS(AnimalShelter animalShelter) {
	...
	public GEO_INTERSECTS(Apartment apartment) {
	...
	public GEO_INTERSECTS(ApartmentComplex apartmentComplex) {
	...
	public GEO_INTERSECTS(Aquarium aquarium) {
	...
	public GEO_INTERSECTS(ArchiveOrganization archiveOrganization) {
	...
	public GEO_INTERSECTS(ArtGallery artGallery) {
	...
	public GEO_INTERSECTS(Attorney attorney) {
	...
	public GEO_INTERSECTS(AutoBodyShop autoBodyShop) {
	...
	public GEO_INTERSECTS(AutoDealer autoDealer) {
	...
	public GEO_INTERSECTS(AutoPartsStore autoPartsStore) {
	...
	public GEO_INTERSECTS(AutoRental autoRental) {
	...
	public GEO_INTERSECTS(AutoRepair autoRepair) {
	...
	public GEO_INTERSECTS(AutoWash autoWash) {
	...
	public GEO_INTERSECTS(AutomatedTeller automatedTeller) {
	...
	public GEO_INTERSECTS(AutomotiveBusiness automotiveBusiness) {
	...
	public GEO_INTERSECTS(Bakery bakery) {
	...
	public GEO_INTERSECTS(BankOrCreditUnion bankOrCreditUnion) {
	...
	public GEO_INTERSECTS(BarOrPub barOrPub) {
	...
	public GEO_INTERSECTS(Beach beach) {
	...
	public GEO_INTERSECTS(BeautySalon beautySalon) {
	...
	public GEO_INTERSECTS(BedAndBreakfast bedAndBreakfast) {
	...
	public GEO_INTERSECTS(BikeStore bikeStore) {
	...
	public GEO_INTERSECTS(BodyOfWater bodyOfWater) {
	...
	public GEO_INTERSECTS(BookStore bookStore) {
	...
	public GEO_INTERSECTS(BowlingAlley bowlingAlley) {
	...
	public GEO_INTERSECTS(Brewery brewery) {
	...
	public GEO_INTERSECTS(Bridge bridge) {
	...
	public GEO_INTERSECTS(BuddhistTemple buddhistTemple) {
	...
	public GEO_INTERSECTS(BusStation busStation) {
	...
	public GEO_INTERSECTS(BusStop busStop) {
	...
	public GEO_INTERSECTS(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public GEO_INTERSECTS(Campground campground) {
	...
	public GEO_INTERSECTS(CampingPitch campingPitch) {
	...
	public GEO_INTERSECTS(Canal canal) {
	...
	public GEO_INTERSECTS(Casino casino) {
	...
	public GEO_INTERSECTS(CatholicChurch catholicChurch) {
	...
	public GEO_INTERSECTS(Cemetery cemetery) {
	...
	public GEO_INTERSECTS(ChildCare childCare) {
	...
	public GEO_INTERSECTS(Church church) {
	...
	public GEO_INTERSECTS(City city) {
	...
	public GEO_INTERSECTS(CityHall cityHall) {
	...
	public GEO_INTERSECTS(CivicStructure civicStructure) {
	...
	public GEO_INTERSECTS(ClothingStore clothingStore) {
	...
	public GEO_INTERSECTS(ComedyClub comedyClub) {
	...
	public GEO_INTERSECTS(CommunityHealth communityHealth) {
	...
	public GEO_INTERSECTS(ComputerStore computerStore) {
	...
	public GEO_INTERSECTS(Continent continent) {
	...
	public GEO_INTERSECTS(ConvenienceStore convenienceStore) {
	...
	public GEO_INTERSECTS(Country country) {
	...
	public GEO_INTERSECTS(Courthouse courthouse) {
	...
	public GEO_INTERSECTS(Crematorium crematorium) {
	...
	public GEO_INTERSECTS(DaySpa daySpa) {
	...
	public GEO_INTERSECTS(DefenceEstablishment defenceEstablishment) {
	...
	public GEO_INTERSECTS(Dentist dentist) {
	...
	public GEO_INTERSECTS(DepartmentStore departmentStore) {
	...
	public GEO_INTERSECTS(Dermatology dermatology) {
	...
	public GEO_INTERSECTS(DietNutrition dietNutrition) {
	...
	public GEO_INTERSECTS(Distillery distillery) {
	...
	public GEO_INTERSECTS(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public GEO_INTERSECTS(Electrician electrician) {
	...
	public GEO_INTERSECTS(ElectronicsStore electronicsStore) {
	...
	public GEO_INTERSECTS(Embassy embassy) {
	...
	public GEO_INTERSECTS(Emergency emergency) {
	...
	public GEO_INTERSECTS(EmergencyService emergencyService) {
	...
	public GEO_INTERSECTS(EmploymentAgency employmentAgency) {
	...
	public GEO_INTERSECTS(EntertainmentBusiness entertainmentBusiness) {
	...
	public GEO_INTERSECTS(EventVenue eventVenue) {
	...
	public GEO_INTERSECTS(ExerciseGym exerciseGym) {
	...
	public GEO_INTERSECTS(FastFoodRestaurant fastFoodRestaurant) {
	...
	public GEO_INTERSECTS(FinancialService financialService) {
	...
	public GEO_INTERSECTS(FireStation fireStation) {
	...
	public GEO_INTERSECTS(Florist florist) {
	...
	public GEO_INTERSECTS(FoodEstablishment foodEstablishment) {
	...
	public GEO_INTERSECTS(FurnitureStore furnitureStore) {
	...
	public GEO_INTERSECTS(GardenStore gardenStore) {
	...
	public GEO_INTERSECTS(GasStation gasStation) {
	...
	public GEO_INTERSECTS(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public GEO_INTERSECTS(GeneralContractor generalContractor) {
	...
	public GEO_INTERSECTS(GeospatialGeometry geospatialGeometry) {
		geospatialGeometryList = new ArrayList<GeospatialGeometry>();
	...
	public GEO_INTERSECTS(Geriatric geriatric) {
	...
	public GEO_INTERSECTS(GolfCourse golfCourse) {
	...
	public GEO_INTERSECTS(GovernmentBuilding governmentBuilding) {
	...
	public GEO_INTERSECTS(GovernmentOffice governmentOffice) {
	...
	public GEO_INTERSECTS(GroceryStore groceryStore) {
	...
	public GEO_INTERSECTS(Gynecologic gynecologic) {
	...
	public GEO_INTERSECTS(HVACBusiness hvacBusiness) {
	...
	public GEO_INTERSECTS(HairSalon hairSalon) {
	...
	public GEO_INTERSECTS(HardwareStore hardwareStore) {
	...
	public GEO_INTERSECTS(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public GEO_INTERSECTS(HealthClub healthClub) {
	...
	public GEO_INTERSECTS(HinduTemple hinduTemple) {
	...
	public GEO_INTERSECTS(HobbyShop hobbyShop) {
	...
	public GEO_INTERSECTS(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public GEO_INTERSECTS(HomeGoodsStore homeGoodsStore) {
	...
	public GEO_INTERSECTS(Hospital hospital) {
	...
	public GEO_INTERSECTS(Hostel hostel) {
	...
	public GEO_INTERSECTS(Hotel hotel) {
	...
	public GEO_INTERSECTS(HotelRoom hotelRoom) {
	...
	public GEO_INTERSECTS(House house) {
	...
	public GEO_INTERSECTS(HousePainter housePainter) {
	...
	public GEO_INTERSECTS(IceCreamShop iceCreamShop) {
	...
	public GEO_INTERSECTS(InsuranceAgency insuranceAgency) {
	...
	public GEO_INTERSECTS(InternetCafe internetCafe) {
	...
	public GEO_INTERSECTS(JewelryStore jewelryStore) {
	...
	public GEO_INTERSECTS(LakeBodyOfWater lakeBodyOfWater) {
	...
	public GEO_INTERSECTS(Landform landform) {
	...
	public GEO_INTERSECTS(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public GEO_INTERSECTS(LegalService legalService) {
	...
	public GEO_INTERSECTS(LegislativeBuilding legislativeBuilding) {
	...
	public GEO_INTERSECTS(Library library) {
	...
	public GEO_INTERSECTS(LiquorStore liquorStore) {
	...
	public GEO_INTERSECTS(LocalBusiness localBusiness) {
	...
	public GEO_INTERSECTS(Locksmith locksmith) {
	...
	public GEO_INTERSECTS(LodgingBusiness lodgingBusiness) {
	...
	public GEO_INTERSECTS(MedicalBusiness medicalBusiness) {
	...
	public GEO_INTERSECTS(MedicalClinic medicalClinic) {
	...
	public GEO_INTERSECTS(MeetingRoom meetingRoom) {
	...
	public GEO_INTERSECTS(MensClothingStore mensClothingStore) {
	...
	public GEO_INTERSECTS(Midwifery midwifery) {
	...
	public GEO_INTERSECTS(MobilePhoneStore mobilePhoneStore) {
	...
	public GEO_INTERSECTS(Mosque mosque) {
	...
	public GEO_INTERSECTS(Motel motel) {
	...
	public GEO_INTERSECTS(MotorcycleDealer motorcycleDealer) {
	...
	public GEO_INTERSECTS(MotorcycleRepair motorcycleRepair) {
	...
	public GEO_INTERSECTS(Mountain mountain) {
	...
	public GEO_INTERSECTS(MovieRentalStore movieRentalStore) {
	...
	public GEO_INTERSECTS(MovieTheater movieTheater) {
	...
	public GEO_INTERSECTS(MovingCompany movingCompany) {
	...
	public GEO_INTERSECTS(Museum museum) {
	...
	public GEO_INTERSECTS(MusicStore musicStore) {
	...
	public GEO_INTERSECTS(MusicVenue musicVenue) {
	...
	public GEO_INTERSECTS(NailSalon nailSalon) {
	...
	public GEO_INTERSECTS(NightClub nightClub) {
	...
	public GEO_INTERSECTS(Notary notary) {
	...
	public GEO_INTERSECTS(Nursing nursing) {
	...
	public GEO_INTERSECTS(Obstetric obstetric) {
	...
	public GEO_INTERSECTS(OceanBodyOfWater oceanBodyOfWater) {
	...
	public GEO_INTERSECTS(OfficeEquipmentStore officeEquipmentStore) {
	...
	public GEO_INTERSECTS(Oncologic oncologic) {
	...
	public GEO_INTERSECTS(Optician optician) {
	...
	public GEO_INTERSECTS(Optometric optometric) {
	...
	public GEO_INTERSECTS(Otolaryngologic otolaryngologic) {
	...
	public GEO_INTERSECTS(OutletStore outletStore) {
	...
	public GEO_INTERSECTS(Park park) {
	...
	public GEO_INTERSECTS(ParkingFacility parkingFacility) {
	...
	public GEO_INTERSECTS(PawnShop pawnShop) {
	...
	public GEO_INTERSECTS(Pediatric pediatric) {
	...
	public GEO_INTERSECTS(PerformingArtsTheater performingArtsTheater) {
	...
	public GEO_INTERSECTS(PetStore petStore) {
	...
	public GEO_INTERSECTS(Pharmacy pharmacy) {
	...
	public GEO_INTERSECTS(Physician physician) {
	...
	public GEO_INTERSECTS(Physiotherapy physiotherapy) {
	...
	public GEO_INTERSECTS(Place place) {
	...
	public GEO_INTERSECTS(PlaceOfWorship placeOfWorship) {
	...
	public GEO_INTERSECTS(PlasticSurgery plasticSurgery) {
	...
	public GEO_INTERSECTS(Playground playground) {
	...
	public GEO_INTERSECTS(Plumber plumber) {
	...
	public GEO_INTERSECTS(Podiatric podiatric) {
	...
	public GEO_INTERSECTS(PoliceStation policeStation) {
	...
	public GEO_INTERSECTS(Pond pond) {
	...
	public GEO_INTERSECTS(PostOffice postOffice) {
	...
	public GEO_INTERSECTS(PrimaryCare primaryCare) {
	...
	public GEO_INTERSECTS(ProfessionalService professionalService) {
	...
	public GEO_INTERSECTS(Psychiatric psychiatric) {
	...
	public GEO_INTERSECTS(PublicHealth publicHealth) {
	...
	public GEO_INTERSECTS(PublicSwimmingPool publicSwimmingPool) {
	...
	public GEO_INTERSECTS(PublicToilet publicToilet) {
	...
	public GEO_INTERSECTS(RVPark rvPark) {
	...
	public GEO_INTERSECTS(RadioStation radioStation) {
	...
	public GEO_INTERSECTS(RealEstateAgent realEstateAgent) {
	...
	public GEO_INTERSECTS(RecyclingCenter recyclingCenter) {
	...
	public GEO_INTERSECTS(Reservoir reservoir) {
	...
	public GEO_INTERSECTS(Residence residence) {
	...
	public GEO_INTERSECTS(Resort resort) {
	...
	public GEO_INTERSECTS(Restaurant restaurant) {
	...
	public GEO_INTERSECTS(RiverBodyOfWater riverBodyOfWater) {
	...
	public GEO_INTERSECTS(RoofingContractor roofingContractor) {
	...
	public GEO_INTERSECTS(Room room) {
	...
	public GEO_INTERSECTS(SeaBodyOfWater seaBodyOfWater) {
	...
	public GEO_INTERSECTS(SelfStorage selfStorage) {
	...
	public GEO_INTERSECTS(ShoeStore shoeStore) {
	...
	public GEO_INTERSECTS(ShoppingCenter shoppingCenter) {
	...
	public GEO_INTERSECTS(SingleFamilyResidence singleFamilyResidence) {
	...
	public GEO_INTERSECTS(SkiResort skiResort) {
	...
	public GEO_INTERSECTS(SportingGoodsStore sportingGoodsStore) {
	...
	public GEO_INTERSECTS(SportsActivityLocation sportsActivityLocation) {
	...
	public GEO_INTERSECTS(SportsClub sportsClub) {
	...
	public GEO_INTERSECTS(StadiumOrArena stadiumOrArena) {
	...
	public GEO_INTERSECTS(State state) {
	...
	public GEO_INTERSECTS(Store store) {
	...
	public GEO_INTERSECTS(SubwayStation subwayStation) {
	...
	public GEO_INTERSECTS(Suite suite) {
	...
	public GEO_INTERSECTS(Synagogue synagogue) {
	...
	public GEO_INTERSECTS(TattooParlor tattooParlor) {
	...
	public GEO_INTERSECTS(TaxiStand taxiStand) {
	...
	public GEO_INTERSECTS(TelevisionStation televisionStation) {
	...
	public GEO_INTERSECTS(TennisComplex tennisComplex) {
	...
	public GEO_INTERSECTS(TireShop tireShop) {
	...
	public GEO_INTERSECTS(TouristAttraction touristAttraction) {
	...
	public GEO_INTERSECTS(TouristDestination touristDestination) {
	...
	public GEO_INTERSECTS(TouristInformationCenter touristInformationCenter) {
	...
	public GEO_INTERSECTS(ToyStore toyStore) {
	...
	public GEO_INTERSECTS(TrainStation trainStation) {
	...
	public GEO_INTERSECTS(TravelAgency travelAgency) {
	...
	public GEO_INTERSECTS(Volcano volcano) {
	...
	public GEO_INTERSECTS(Waterfall waterfall) {
	...
	public GEO_INTERSECTS(WholesaleStore wholesaleStore) {
	...
	public GEO_INTERSECTS(Winery winery) {
	...
	public void copy(Container.GeoIntersects org) {
