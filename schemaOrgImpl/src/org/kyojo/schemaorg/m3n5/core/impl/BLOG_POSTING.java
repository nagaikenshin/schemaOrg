...
public class BLOG_POSTING implements Clazz.BlogPosting {
	...
	public BLOG_POSTING(Long seq) {
		setSeq(seq);
	}

	public BLOG_POSTING(String string) {
	...
	public BLOG_POSTING(About about) {
		setAbout(about);
	}
	...
	public BLOG_POSTING(AccessMode accessMode) {
	...
	public BLOG_POSTING(AccessModeSufficient accessModeSufficient) {
	...
	public BLOG_POSTING(AccessibilityAPI accessibilityAPI) {
	...
	public BLOG_POSTING(AccessibilityControl accessibilityControl) {
	...
	public BLOG_POSTING(AccessibilityFeature accessibilityFeature) {
	...
	public BLOG_POSTING(AccessibilityHazard accessibilityHazard) {
	...
	public BLOG_POSTING(AccessibilitySummary accessibilitySummary) {
	...
	public BLOG_POSTING(AccountablePerson accountablePerson) {
	...
	public BLOG_POSTING(AdditionalType additionalType) {
	...
	public BLOG_POSTING(AggregateRating aggregateRating) {
	...
	public BLOG_POSTING(AlternateName alternateName) {
	...
	public BLOG_POSTING(AlternativeHeadline alternativeHeadline) {
	...
	public BLOG_POSTING(ArticleBody articleBody) {
	...
	public BLOG_POSTING(ArticleSection articleSection) {
	...
	public BLOG_POSTING(AssociatedMedia associatedMedia) {
	...
	public BLOG_POSTING(Audience audience) {
	...
	public BLOG_POSTING(Audio audio) {
		setAudio(audio);
	}
	...
	public BLOG_POSTING(Author author) {
		setAuthor(author);
	}
	...
	public BLOG_POSTING(Award award) {
		setAward(award);
	}
	...
	public BLOG_POSTING(Backstory backstory) {
	...
	public BLOG_POSTING(Character character) {
	...
	public BLOG_POSTING(Citation citation) {
	...
	public BLOG_POSTING(Comment comment) {
		setComment(comment);
	}
	...
	public BLOG_POSTING(CommentCount commentCount) {
	...
	public BLOG_POSTING(ContentLocation contentLocation) {
	...
	public BLOG_POSTING(ContentRating contentRating) {
	...
	public BLOG_POSTING(ContentReferenceTime contentReferenceTime) {
	...
	public BLOG_POSTING(Contributor contributor) {
	...
	public BLOG_POSTING(CopyrightHolder copyrightHolder) {
	...
	public BLOG_POSTING(CopyrightYear copyrightYear) {
	...
	public BLOG_POSTING(Correction correction) {
	...
	public BLOG_POSTING(Creator creator) {
		setCreator(creator);
	}
	...
	public BLOG_POSTING(DateCreated dateCreated) {
	...
	public BLOG_POSTING(DateModified dateModified) {
	...
	public BLOG_POSTING(DatePublished datePublished) {
	...
	public BLOG_POSTING(Description description) {
	...
	public BLOG_POSTING(DisambiguatingDescription disambiguatingDescription) {
	...
	public BLOG_POSTING(DiscussionUrl discussionUrl) {
	...
	public BLOG_POSTING(Editor editor) {
		setEditor(editor);
	}
	...
	public BLOG_POSTING(EducationalAlignment educationalAlignment) {
	...
	public BLOG_POSTING(EducationalUse educationalUse) {
	...
	public BLOG_POSTING(Encoding encoding) {
	...
	public BLOG_POSTING(EncodingFormat encodingFormat) {
	...
	public BLOG_POSTING(ExampleOfWork exampleOfWork) {
	...
	public BLOG_POSTING(Expires expires) {
		setExpires(expires);
	}
	...
	public BLOG_POSTING(Funder funder) {
		setFunder(funder);
	}
	...
	public BLOG_POSTING(Genre genre) {
		setGenre(genre);
	}
	...
	public BLOG_POSTING(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public BLOG_POSTING(Headline headline) {
	...
	public BLOG_POSTING(Identifier identifier) {
	...
	public BLOG_POSTING(Image image) {
		setImage(image);
	}
	...
	public BLOG_POSTING(InLanguage inLanguage) {
	...
	public BLOG_POSTING(InteractionStatistic interactionStatistic) {
	...
	public BLOG_POSTING(InteractivityType interactivityType) {
	...
	public BLOG_POSTING(IsAccessibleForFree isAccessibleForFree) {
	...
	public BLOG_POSTING(IsBasedOn isBasedOn) {
	...
	public BLOG_POSTING(IsFamilyFriendly isFamilyFriendly) {
	...
	public BLOG_POSTING(IsPartOf isPartOf) {
	...
	public BLOG_POSTING(Keywords keywords) {
	...
	public BLOG_POSTING(LearningResourceType learningResourceType) {
	...
	public BLOG_POSTING(License license) {
		setLicense(license);
	}
	...
	public BLOG_POSTING(LocationCreated locationCreated) {
	...
	public BLOG_POSTING(MainEntity mainEntity) {
	...
	public BLOG_POSTING(MainEntityOfPage mainEntityOfPage) {
	...
	public BLOG_POSTING(Material material) {
	...
	public BLOG_POSTING(MaterialExtent materialExtent) {
	...
	public BLOG_POSTING(Mentions mentions) {
	...
	public BLOG_POSTING(NameFuzzy nameFuzzy) {
	...
	public BLOG_POSTING(NameRuby nameRuby) {
	...
	public BLOG_POSTING(Offers offers) {
		setOffers(offers);
	}
	...
	public BLOG_POSTING(PageEnd pageEnd) {
		setPageEnd(pageEnd);
	}
	...
	public BLOG_POSTING(PageStart pageStart) {
	...
	public BLOG_POSTING(Pagination pagination) {
	...
	public BLOG_POSTING(Position position) {
	...
	public BLOG_POSTING(PotentialAction potentialAction) {
	...
	public BLOG_POSTING(Producer producer) {
	...
	public BLOG_POSTING(Provider provider) {
	...
	public BLOG_POSTING(Publication publication) {
	...
	public BLOG_POSTING(Publisher publisher) {
	...
	public BLOG_POSTING(PublisherImprint publisherImprint) {
	...
	public BLOG_POSTING(PublishingPrinciples publishingPrinciples) {
	...
	public BLOG_POSTING(RecordedAt recordedAt) {
	...
	public BLOG_POSTING(ReleasedEvent releasedEvent) {
	...
	public BLOG_POSTING(Review review) {
		setReview(review);
	}
	...
	public BLOG_POSTING(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public BLOG_POSTING(SchemaVersion schemaVersion) {
	...
	public BLOG_POSTING(SdDatePublished sdDatePublished) {
	...
	public BLOG_POSTING(SdLicense sdLicense) {
	...
	public BLOG_POSTING(SdPublisher sdPublisher) {
	...
	public BLOG_POSTING(SharedContent sharedContent) {
	...
	public BLOG_POSTING(SourceOrganization sourceOrganization) {
	...
	public BLOG_POSTING(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public BLOG_POSTING(SpatialCoverage spatialCoverage) {
	...
	public BLOG_POSTING(Speakable speakable) {
	...
	public BLOG_POSTING(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public BLOG_POSTING(SubjectOf subjectOf) {
	...
	public BLOG_POSTING(Temporal temporal) {
	...
	public BLOG_POSTING(TemporalCoverage temporalCoverage) {
	...
	public BLOG_POSTING(ThumbnailUrl thumbnailUrl) {
	...
	public BLOG_POSTING(TimeRequired timeRequired) {
	...
	public BLOG_POSTING(TranslationOfWork translationOfWork) {
	...
	public BLOG_POSTING(Translator translator) {
	...
	public BLOG_POSTING(TypicalAgeRange typicalAgeRange) {
	...
	public BLOG_POSTING(Version version) {
		setVersion(version);
	}
	...
	public BLOG_POSTING(Video video) {
		setVideo(video);
	}
	...
	public BLOG_POSTING(WordCount wordCount) {
	...
	public BLOG_POSTING(WorkExample workExample) {
	...
	public BLOG_POSTING(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.BlogPosting org) {
		setSeq(org.getSeq());
