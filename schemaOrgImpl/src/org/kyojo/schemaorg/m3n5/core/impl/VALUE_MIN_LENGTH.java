...
public class VALUE_MIN_LENGTH implements Container.ValueMinLength {
	...
	public VALUE_MIN_LENGTH(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public VALUE_MIN_LENGTH(Float fl0at) {
	...
	public VALUE_MIN_LENGTH(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public VALUE_MIN_LENGTH(Integer integer) {
	...
	public VALUE_MIN_LENGTH(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public VALUE_MIN_LENGTH(Number number) {
	...
	public VALUE_MIN_LENGTH(List<Float> fl0atList,
	...
	public void copy(Container.ValueMinLength org) {
