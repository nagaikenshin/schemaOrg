...
public class WP_HEADER implements Clazz.WPHeader {
	...
	public WP_HEADER(Long seq) {
		setSeq(seq);
	}

	public WP_HEADER(String string) {
	...
	public WP_HEADER(AccessMode accessMode) {
	...
	public WP_HEADER(AccessModeSufficient accessModeSufficient) {
	...
	public WP_HEADER(AccessibilityAPI accessibilityAPI) {
	...
	public WP_HEADER(AccessibilityControl accessibilityControl) {
	...
	public WP_HEADER(AccessibilityFeature accessibilityFeature) {
	...
	public WP_HEADER(AccessibilityHazard accessibilityHazard) {
	...
	public WP_HEADER(AccessibilitySummary accessibilitySummary) {
	...
	public WP_HEADER(AccountablePerson accountablePerson) {
	...
	public WP_HEADER(AdditionalType additionalType) {
	...
	public WP_HEADER(AggregateRating aggregateRating) {
	...
	public WP_HEADER(AlternateName alternateName) {
	...
	public WP_HEADER(AlternativeHeadline alternativeHeadline) {
	...
	public WP_HEADER(AssociatedMedia associatedMedia) {
	...
	public WP_HEADER(Audience audience) {
	...
	public WP_HEADER(Author author) {
		setAuthor(author);
	}
	...
	public WP_HEADER(Character character) {
	...
	public WP_HEADER(Citation citation) {
	...
	public WP_HEADER(Comment comment) {
		setComment(comment);
	}
	...
	public WP_HEADER(CommentCount commentCount) {
	...
	public WP_HEADER(ContentLocation contentLocation) {
	...
	public WP_HEADER(ContentRating contentRating) {
	...
	public WP_HEADER(ContentReferenceTime contentReferenceTime) {
	...
	public WP_HEADER(Contributor contributor) {
	...
	public WP_HEADER(CopyrightHolder copyrightHolder) {
	...
	public WP_HEADER(CopyrightYear copyrightYear) {
	...
	public WP_HEADER(Correction correction) {
	...
	public WP_HEADER(Creator creator) {
		setCreator(creator);
	}
	...
	public WP_HEADER(CssSelector cssSelector) {
	...
	public WP_HEADER(DateCreated dateCreated) {
	...
	public WP_HEADER(DateModified dateModified) {
	...
	public WP_HEADER(DatePublished datePublished) {
	...
	public WP_HEADER(Description description) {
	...
	public WP_HEADER(DisambiguatingDescription disambiguatingDescription) {
	...
	public WP_HEADER(DiscussionUrl discussionUrl) {
	...
	public WP_HEADER(Editor editor) {
		setEditor(editor);
	}
	...
	public WP_HEADER(EducationalAlignment educationalAlignment) {
	...
	public WP_HEADER(EducationalUse educationalUse) {
	...
	public WP_HEADER(Encoding encoding) {
	...
	public WP_HEADER(EncodingFormat encodingFormat) {
	...
	public WP_HEADER(ExampleOfWork exampleOfWork) {
	...
	public WP_HEADER(Expires expires) {
		setExpires(expires);
	}
	...
	public WP_HEADER(Funder funder) {
		setFunder(funder);
	}
	...
	public WP_HEADER(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public WP_HEADER(Headline headline) {
	...
	public WP_HEADER(Identifier identifier) {
	...
	public WP_HEADER(InLanguage inLanguage) {
	...
	public WP_HEADER(InteractionStatistic interactionStatistic) {
	...
	public WP_HEADER(InteractivityType interactivityType) {
	...
	public WP_HEADER(IsAccessibleForFree isAccessibleForFree) {
	...
	public WP_HEADER(IsBasedOn isBasedOn) {
	...
	public WP_HEADER(IsFamilyFriendly isFamilyFriendly) {
	...
	public WP_HEADER(IsPartOf isPartOf) {
	...
	public WP_HEADER(Keywords keywords) {
	...
	public WP_HEADER(LearningResourceType learningResourceType) {
	...
	public WP_HEADER(License license) {
		setLicense(license);
	}
	...
	public WP_HEADER(LocationCreated locationCreated) {
	...
	public WP_HEADER(MainEntity mainEntity) {
	...
	public WP_HEADER(MainEntityOfPage mainEntityOfPage) {
	...
	public WP_HEADER(Material material) {
	...
	public WP_HEADER(MaterialExtent materialExtent) {
	...
	public WP_HEADER(Mentions mentions) {
	...
	public WP_HEADER(NameFuzzy nameFuzzy) {
	...
	public WP_HEADER(NameRuby nameRuby) {
	...
	public WP_HEADER(Offers offers) {
		setOffers(offers);
	}
	...
	public WP_HEADER(Position position) {
	...
	public WP_HEADER(PotentialAction potentialAction) {
	...
	public WP_HEADER(Producer producer) {
	...
	public WP_HEADER(Provider provider) {
	...
	public WP_HEADER(Publication publication) {
	...
	public WP_HEADER(Publisher publisher) {
	...
	public WP_HEADER(PublisherImprint publisherImprint) {
	...
	public WP_HEADER(PublishingPrinciples publishingPrinciples) {
	...
	public WP_HEADER(RecordedAt recordedAt) {
	...
	public WP_HEADER(ReleasedEvent releasedEvent) {
	...
	public WP_HEADER(Review review) {
		setReview(review);
	}
	...
	public WP_HEADER(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public WP_HEADER(SchemaVersion schemaVersion) {
	...
	public WP_HEADER(SdDatePublished sdDatePublished) {
	...
	public WP_HEADER(SdLicense sdLicense) {
	...
	public WP_HEADER(SdPublisher sdPublisher) {
	...
	public WP_HEADER(SourceOrganization sourceOrganization) {
	...
	public WP_HEADER(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public WP_HEADER(SpatialCoverage spatialCoverage) {
	...
	public WP_HEADER(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public WP_HEADER(SubjectOf subjectOf) {
	...
	public WP_HEADER(Temporal temporal) {
	...
	public WP_HEADER(TemporalCoverage temporalCoverage) {
	...
	public WP_HEADER(ThumbnailUrl thumbnailUrl) {
	...
	public WP_HEADER(TimeRequired timeRequired) {
	...
	public WP_HEADER(TranslationOfWork translationOfWork) {
	...
	public WP_HEADER(Translator translator) {
	...
	public WP_HEADER(TypicalAgeRange typicalAgeRange) {
	...
	public WP_HEADER(Version version) {
		setVersion(version);
	}
	...
	public WP_HEADER(WorkExample workExample) {
	...
	public WP_HEADER(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.WPHeader org) {
		setSeq(org.getSeq());
