...
public class WP_AD_BLOCK implements Clazz.WPAdBlock {
	...
	public WP_AD_BLOCK(Long seq) {
		setSeq(seq);
	}

	public WP_AD_BLOCK(String string) {
	...
	public WP_AD_BLOCK(About about) {
		setAbout(about);
	}
	...
	public WP_AD_BLOCK(AccessMode accessMode) {
	...
	public WP_AD_BLOCK(AccessModeSufficient accessModeSufficient) {
	...
	public WP_AD_BLOCK(AccessibilityAPI accessibilityAPI) {
	...
	public WP_AD_BLOCK(AccessibilityControl accessibilityControl) {
	...
	public WP_AD_BLOCK(AccessibilityFeature accessibilityFeature) {
	...
	public WP_AD_BLOCK(AccessibilityHazard accessibilityHazard) {
	...
	public WP_AD_BLOCK(AccessibilitySummary accessibilitySummary) {
	...
	public WP_AD_BLOCK(AccountablePerson accountablePerson) {
	...
	public WP_AD_BLOCK(AdditionalType additionalType) {
	...
	public WP_AD_BLOCK(AggregateRating aggregateRating) {
	...
	public WP_AD_BLOCK(AlternateName alternateName) {
	...
	public WP_AD_BLOCK(AlternativeHeadline alternativeHeadline) {
	...
	public WP_AD_BLOCK(AssociatedMedia associatedMedia) {
	...
	public WP_AD_BLOCK(Audience audience) {
	...
	public WP_AD_BLOCK(Audio audio) {
		setAudio(audio);
	}
	...
	public WP_AD_BLOCK(Author author) {
		setAuthor(author);
	}
	...
	public WP_AD_BLOCK(Award award) {
		setAward(award);
	}
	...
	public WP_AD_BLOCK(Character character) {
	...
	public WP_AD_BLOCK(Citation citation) {
	...
	public WP_AD_BLOCK(Comment comment) {
		setComment(comment);
	}
	...
	public WP_AD_BLOCK(CommentCount commentCount) {
	...
	public WP_AD_BLOCK(ContentLocation contentLocation) {
	...
	public WP_AD_BLOCK(ContentRating contentRating) {
	...
	public WP_AD_BLOCK(ContentReferenceTime contentReferenceTime) {
	...
	public WP_AD_BLOCK(Contributor contributor) {
	...
	public WP_AD_BLOCK(CopyrightHolder copyrightHolder) {
	...
	public WP_AD_BLOCK(CopyrightYear copyrightYear) {
	...
	public WP_AD_BLOCK(Correction correction) {
	...
	public WP_AD_BLOCK(Creator creator) {
		setCreator(creator);
	}
	...
	public WP_AD_BLOCK(CssSelector cssSelector) {
	...
	public WP_AD_BLOCK(DateCreated dateCreated) {
	...
	public WP_AD_BLOCK(DateModified dateModified) {
	...
	public WP_AD_BLOCK(DatePublished datePublished) {
	...
	public WP_AD_BLOCK(Description description) {
	...
	public WP_AD_BLOCK(DisambiguatingDescription disambiguatingDescription) {
	...
	public WP_AD_BLOCK(DiscussionUrl discussionUrl) {
	...
	public WP_AD_BLOCK(Editor editor) {
		setEditor(editor);
	}
	...
	public WP_AD_BLOCK(EducationalAlignment educationalAlignment) {
	...
	public WP_AD_BLOCK(EducationalUse educationalUse) {
	...
	public WP_AD_BLOCK(Encoding encoding) {
	...
	public WP_AD_BLOCK(EncodingFormat encodingFormat) {
	...
	public WP_AD_BLOCK(ExampleOfWork exampleOfWork) {
	...
	public WP_AD_BLOCK(Expires expires) {
		setExpires(expires);
	}
	...
	public WP_AD_BLOCK(Funder funder) {
		setFunder(funder);
	}
	...
	public WP_AD_BLOCK(Genre genre) {
		setGenre(genre);
	}
	...
	public WP_AD_BLOCK(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public WP_AD_BLOCK(Headline headline) {
	...
	public WP_AD_BLOCK(Identifier identifier) {
	...
	public WP_AD_BLOCK(Image image) {
		setImage(image);
	}
	...
	public WP_AD_BLOCK(InLanguage inLanguage) {
	...
	public WP_AD_BLOCK(InteractionStatistic interactionStatistic) {
	...
	public WP_AD_BLOCK(InteractivityType interactivityType) {
	...
	public WP_AD_BLOCK(IsAccessibleForFree isAccessibleForFree) {
	...
	public WP_AD_BLOCK(IsBasedOn isBasedOn) {
	...
	public WP_AD_BLOCK(IsFamilyFriendly isFamilyFriendly) {
	...
	public WP_AD_BLOCK(IsPartOf isPartOf) {
	...
	public WP_AD_BLOCK(Keywords keywords) {
	...
	public WP_AD_BLOCK(LearningResourceType learningResourceType) {
	...
	public WP_AD_BLOCK(License license) {
		setLicense(license);
	}
	...
	public WP_AD_BLOCK(LocationCreated locationCreated) {
	...
	public WP_AD_BLOCK(MainEntity mainEntity) {
	...
	public WP_AD_BLOCK(MainEntityOfPage mainEntityOfPage) {
	...
	public WP_AD_BLOCK(Material material) {
	...
	public WP_AD_BLOCK(MaterialExtent materialExtent) {
	...
	public WP_AD_BLOCK(Mentions mentions) {
	...
	public WP_AD_BLOCK(NameFuzzy nameFuzzy) {
	...
	public WP_AD_BLOCK(NameRuby nameRuby) {
	...
	public WP_AD_BLOCK(Offers offers) {
		setOffers(offers);
	}
	...
	public WP_AD_BLOCK(Position position) {
	...
	public WP_AD_BLOCK(PotentialAction potentialAction) {
	...
	public WP_AD_BLOCK(Producer producer) {
	...
	public WP_AD_BLOCK(Provider provider) {
	...
	public WP_AD_BLOCK(Publication publication) {
	...
	public WP_AD_BLOCK(Publisher publisher) {
	...
	public WP_AD_BLOCK(PublisherImprint publisherImprint) {
	...
	public WP_AD_BLOCK(PublishingPrinciples publishingPrinciples) {
	...
	public WP_AD_BLOCK(RecordedAt recordedAt) {
	...
	public WP_AD_BLOCK(ReleasedEvent releasedEvent) {
	...
	public WP_AD_BLOCK(Review review) {
		setReview(review);
	}
	...
	public WP_AD_BLOCK(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public WP_AD_BLOCK(SchemaVersion schemaVersion) {
	...
	public WP_AD_BLOCK(SdDatePublished sdDatePublished) {
	...
	public WP_AD_BLOCK(SdLicense sdLicense) {
	...
	public WP_AD_BLOCK(SdPublisher sdPublisher) {
	...
	public WP_AD_BLOCK(SourceOrganization sourceOrganization) {
	...
	public WP_AD_BLOCK(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public WP_AD_BLOCK(SpatialCoverage spatialCoverage) {
	...
	public WP_AD_BLOCK(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public WP_AD_BLOCK(SubjectOf subjectOf) {
	...
	public WP_AD_BLOCK(Temporal temporal) {
	...
	public WP_AD_BLOCK(TemporalCoverage temporalCoverage) {
	...
	public WP_AD_BLOCK(ThumbnailUrl thumbnailUrl) {
	...
	public WP_AD_BLOCK(TimeRequired timeRequired) {
	...
	public WP_AD_BLOCK(TranslationOfWork translationOfWork) {
	...
	public WP_AD_BLOCK(Translator translator) {
	...
	public WP_AD_BLOCK(TypicalAgeRange typicalAgeRange) {
	...
	public WP_AD_BLOCK(Version version) {
		setVersion(version);
	}
	...
	public WP_AD_BLOCK(Video video) {
		setVideo(video);
	}
	...
	public WP_AD_BLOCK(WorkExample workExample) {
	...
	public WP_AD_BLOCK(WorkTranslation workTranslation) {
	...
	public WP_AD_BLOCK(Xpath xpath) {
		setXpath(xpath);
	}
	...
	public void copy(Clazz.WPAdBlock org) {
		setSeq(org.getSeq());
