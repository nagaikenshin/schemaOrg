...
import org.kyojo.schemaorg.m3n5.core.Container.Question;
...
public class ASK_ACTION implements Clazz.AskAction {
	...
	public ASK_ACTION(Long seq) {
		setSeq(seq);
	}

	public ASK_ACTION(String string) {
	...
	public ASK_ACTION(ActionStatus actionStatus) {
	...
	public ASK_ACTION(AdditionalType additionalType) {
	...
	public ASK_ACTION(AlternateName alternateName) {
	...
	public ASK_ACTION(Description description) {
	...
	public ASK_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public ASK_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public ASK_ACTION(Identifier identifier) {
	...
	public ASK_ACTION(InLanguage inLanguage) {
	...
	public ASK_ACTION(Instrument instrument) {
	...
	public ASK_ACTION(Location location) {
	...
	public ASK_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public ASK_ACTION(NameFuzzy nameFuzzy) {
	...
	public ASK_ACTION(NameRuby nameRuby) {
	...
	public ASK_ACTION(Object object) {
		setObject(object);
	}
	...
	public ASK_ACTION(Participant participant) {
	...
	public ASK_ACTION(PotentialAction potentialAction) {
	...
	public ASK_ACTION(Question question) {
	...
	public ASK_ACTION(Recipient recipient) {
	...
	public ASK_ACTION(Result result) {
		setResult(result);
	}
	...
	public ASK_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ASK_ACTION(StartTime startTime) {
	...
	public ASK_ACTION(SubjectOf subjectOf) {
	...
	public ASK_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.AskAction org) {
		setSeq(org.getSeq());
