...
public class MOVIE_RENTAL_STORE implements Clazz.MovieRentalStore {
	...
	public MOVIE_RENTAL_STORE(GeoContains geoContains) {
	...
	public MOVIE_RENTAL_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public MOVIE_RENTAL_STORE(GeoCovers geoCovers) {
	...
	public MOVIE_RENTAL_STORE(GeoCrosses geoCrosses) {
	...
	public MOVIE_RENTAL_STORE(GeoDisjoint geoDisjoint) {
	...
	public MOVIE_RENTAL_STORE(GeoEquals geoEquals) {
	...
	public MOVIE_RENTAL_STORE(GeoIntersects geoIntersects) {
	...
	public MOVIE_RENTAL_STORE(GeoOverlaps geoOverlaps) {
	...
	public MOVIE_RENTAL_STORE(GeoTouches geoTouches) {
	...
	public MOVIE_RENTAL_STORE(GeoWithin geoWithin) {
	...
	public MOVIE_RENTAL_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
