...
public class EMPLOYMENT_AGENCY implements Clazz.EmploymentAgency {
	...
	public EMPLOYMENT_AGENCY(GeoContains geoContains) {
	...
	public EMPLOYMENT_AGENCY(GeoCoveredBy geoCoveredBy) {
	...
	public EMPLOYMENT_AGENCY(GeoCovers geoCovers) {
	...
	public EMPLOYMENT_AGENCY(GeoCrosses geoCrosses) {
	...
	public EMPLOYMENT_AGENCY(GeoDisjoint geoDisjoint) {
	...
	public EMPLOYMENT_AGENCY(GeoEquals geoEquals) {
	...
	public EMPLOYMENT_AGENCY(GeoIntersects geoIntersects) {
	...
	public EMPLOYMENT_AGENCY(GeoOverlaps geoOverlaps) {
	...
	public EMPLOYMENT_AGENCY(GeoTouches geoTouches) {
	...
	public EMPLOYMENT_AGENCY(GeoWithin geoWithin) {
	...
	public EMPLOYMENT_AGENCY(Slogan slogan) {
		setSlogan(slogan);
	}
