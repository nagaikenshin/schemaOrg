...
public class END_DATE implements Container.EndDate {
	...
	public END_DATE(java.time.LocalDate date) {
		this(new DATE(date));
	}

	public END_DATE(Date date) {
	...
	public END_DATE(java.util.Date dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public END_DATE(java.time.OffsetDateTime dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public END_DATE(DateTime dateTime) {
	...
	public END_DATE(List<Date> dateList,
			List<DateTime> dateTimeList) {
		setDateList(dateList);
		setDateTimeList(dateTimeList);
	}

	public void copy(Container.EndDate org) {
