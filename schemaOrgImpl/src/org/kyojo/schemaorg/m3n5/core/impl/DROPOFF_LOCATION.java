...
public class DROPOFF_LOCATION implements Container.DropoffLocation {
	...
	public DROPOFF_LOCATION(Accommodation accommodation) {
	...
	public DROPOFF_LOCATION(AccountingService accountingService) {
	...
	public DROPOFF_LOCATION(AdministrativeArea administrativeArea) {
	...
	public DROPOFF_LOCATION(AdultEntertainment adultEntertainment) {
	...
	public DROPOFF_LOCATION(Airport airport) {
	...
	public DROPOFF_LOCATION(AmusementPark amusementPark) {
	...
	public DROPOFF_LOCATION(AnimalShelter animalShelter) {
	...
	public DROPOFF_LOCATION(Apartment apartment) {
	...
	public DROPOFF_LOCATION(ApartmentComplex apartmentComplex) {
	...
	public DROPOFF_LOCATION(Aquarium aquarium) {
	...
	public DROPOFF_LOCATION(ArchiveOrganization archiveOrganization) {
	...
	public DROPOFF_LOCATION(ArtGallery artGallery) {
	...
	public DROPOFF_LOCATION(Attorney attorney) {
	...
	public DROPOFF_LOCATION(AutoBodyShop autoBodyShop) {
	...
	public DROPOFF_LOCATION(AutoDealer autoDealer) {
	...
	public DROPOFF_LOCATION(AutoPartsStore autoPartsStore) {
	...
	public DROPOFF_LOCATION(AutoRental autoRental) {
	...
	public DROPOFF_LOCATION(AutoRepair autoRepair) {
	...
	public DROPOFF_LOCATION(AutoWash autoWash) {
	...
	public DROPOFF_LOCATION(AutomatedTeller automatedTeller) {
	...
	public DROPOFF_LOCATION(AutomotiveBusiness automotiveBusiness) {
	...
	public DROPOFF_LOCATION(Bakery bakery) {
	...
	public DROPOFF_LOCATION(BankOrCreditUnion bankOrCreditUnion) {
	...
	public DROPOFF_LOCATION(BarOrPub barOrPub) {
	...
	public DROPOFF_LOCATION(Beach beach) {
	...
	public DROPOFF_LOCATION(BeautySalon beautySalon) {
	...
	public DROPOFF_LOCATION(BedAndBreakfast bedAndBreakfast) {
	...
	public DROPOFF_LOCATION(BikeStore bikeStore) {
	...
	public DROPOFF_LOCATION(BodyOfWater bodyOfWater) {
	...
	public DROPOFF_LOCATION(BookStore bookStore) {
	...
	public DROPOFF_LOCATION(BowlingAlley bowlingAlley) {
	...
	public DROPOFF_LOCATION(Brewery brewery) {
	...
	public DROPOFF_LOCATION(Bridge bridge) {
	...
	public DROPOFF_LOCATION(BuddhistTemple buddhistTemple) {
	...
	public DROPOFF_LOCATION(BusStation busStation) {
	...
	public DROPOFF_LOCATION(BusStop busStop) {
	...
	public DROPOFF_LOCATION(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public DROPOFF_LOCATION(Campground campground) {
	...
	public DROPOFF_LOCATION(CampingPitch campingPitch) {
	...
	public DROPOFF_LOCATION(Canal canal) {
	...
	public DROPOFF_LOCATION(Casino casino) {
	...
	public DROPOFF_LOCATION(CatholicChurch catholicChurch) {
	...
	public DROPOFF_LOCATION(Cemetery cemetery) {
	...
	public DROPOFF_LOCATION(ChildCare childCare) {
	...
	public DROPOFF_LOCATION(Church church) {
	...
	public DROPOFF_LOCATION(City city) {
	...
	public DROPOFF_LOCATION(CityHall cityHall) {
	...
	public DROPOFF_LOCATION(CivicStructure civicStructure) {
	...
	public DROPOFF_LOCATION(ClothingStore clothingStore) {
	...
	public DROPOFF_LOCATION(ComedyClub comedyClub) {
	...
	public DROPOFF_LOCATION(CommunityHealth communityHealth) {
	...
	public DROPOFF_LOCATION(ComputerStore computerStore) {
	...
	public DROPOFF_LOCATION(Continent continent) {
	...
	public DROPOFF_LOCATION(ConvenienceStore convenienceStore) {
	...
	public DROPOFF_LOCATION(Country country) {
	...
	public DROPOFF_LOCATION(Courthouse courthouse) {
	...
	public DROPOFF_LOCATION(Crematorium crematorium) {
	...
	public DROPOFF_LOCATION(DaySpa daySpa) {
	...
	public DROPOFF_LOCATION(DefenceEstablishment defenceEstablishment) {
	...
	public DROPOFF_LOCATION(Dentist dentist) {
	...
	public DROPOFF_LOCATION(DepartmentStore departmentStore) {
	...
	public DROPOFF_LOCATION(Dermatology dermatology) {
	...
	public DROPOFF_LOCATION(DietNutrition dietNutrition) {
	...
	public DROPOFF_LOCATION(Distillery distillery) {
	...
	public DROPOFF_LOCATION(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public DROPOFF_LOCATION(Electrician electrician) {
	...
	public DROPOFF_LOCATION(ElectronicsStore electronicsStore) {
	...
	public DROPOFF_LOCATION(Embassy embassy) {
	...
	public DROPOFF_LOCATION(Emergency emergency) {
	...
	public DROPOFF_LOCATION(EmergencyService emergencyService) {
	...
	public DROPOFF_LOCATION(EmploymentAgency employmentAgency) {
	...
	public DROPOFF_LOCATION(EntertainmentBusiness entertainmentBusiness) {
	...
	public DROPOFF_LOCATION(EventVenue eventVenue) {
	...
	public DROPOFF_LOCATION(ExerciseGym exerciseGym) {
	...
	public DROPOFF_LOCATION(FastFoodRestaurant fastFoodRestaurant) {
	...
	public DROPOFF_LOCATION(FinancialService financialService) {
	...
	public DROPOFF_LOCATION(FireStation fireStation) {
	...
	public DROPOFF_LOCATION(Florist florist) {
	...
	public DROPOFF_LOCATION(FoodEstablishment foodEstablishment) {
	...
	public DROPOFF_LOCATION(FurnitureStore furnitureStore) {
	...
	public DROPOFF_LOCATION(GardenStore gardenStore) {
	...
	public DROPOFF_LOCATION(GasStation gasStation) {
	...
	public DROPOFF_LOCATION(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public DROPOFF_LOCATION(GeneralContractor generalContractor) {
	...
	public DROPOFF_LOCATION(Geriatric geriatric) {
	...
	public DROPOFF_LOCATION(GolfCourse golfCourse) {
	...
	public DROPOFF_LOCATION(GovernmentBuilding governmentBuilding) {
	...
	public DROPOFF_LOCATION(GovernmentOffice governmentOffice) {
	...
	public DROPOFF_LOCATION(GroceryStore groceryStore) {
	...
	public DROPOFF_LOCATION(Gynecologic gynecologic) {
	...
	public DROPOFF_LOCATION(HVACBusiness hvacBusiness) {
	...
	public DROPOFF_LOCATION(HairSalon hairSalon) {
	...
	public DROPOFF_LOCATION(HardwareStore hardwareStore) {
	...
	public DROPOFF_LOCATION(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public DROPOFF_LOCATION(HealthClub healthClub) {
	...
	public DROPOFF_LOCATION(HinduTemple hinduTemple) {
	...
	public DROPOFF_LOCATION(HobbyShop hobbyShop) {
	...
	public DROPOFF_LOCATION(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public DROPOFF_LOCATION(HomeGoodsStore homeGoodsStore) {
	...
	public DROPOFF_LOCATION(Hospital hospital) {
	...
	public DROPOFF_LOCATION(Hostel hostel) {
	...
	public DROPOFF_LOCATION(Hotel hotel) {
	...
	public DROPOFF_LOCATION(HotelRoom hotelRoom) {
	...
	public DROPOFF_LOCATION(House house) {
	...
	public DROPOFF_LOCATION(HousePainter housePainter) {
	...
	public DROPOFF_LOCATION(IceCreamShop iceCreamShop) {
	...
	public DROPOFF_LOCATION(InsuranceAgency insuranceAgency) {
	...
	public DROPOFF_LOCATION(InternetCafe internetCafe) {
	...
	public DROPOFF_LOCATION(JewelryStore jewelryStore) {
	...
	public DROPOFF_LOCATION(LakeBodyOfWater lakeBodyOfWater) {
	...
	public DROPOFF_LOCATION(Landform landform) {
	...
	public DROPOFF_LOCATION(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public DROPOFF_LOCATION(LegalService legalService) {
	...
	public DROPOFF_LOCATION(LegislativeBuilding legislativeBuilding) {
	...
	public DROPOFF_LOCATION(Library library) {
	...
	public DROPOFF_LOCATION(LiquorStore liquorStore) {
	...
	public DROPOFF_LOCATION(LocalBusiness localBusiness) {
	...
	public DROPOFF_LOCATION(Locksmith locksmith) {
	...
	public DROPOFF_LOCATION(LodgingBusiness lodgingBusiness) {
	...
	public DROPOFF_LOCATION(MedicalBusiness medicalBusiness) {
	...
	public DROPOFF_LOCATION(MedicalClinic medicalClinic) {
	...
	public DROPOFF_LOCATION(MeetingRoom meetingRoom) {
	...
	public DROPOFF_LOCATION(MensClothingStore mensClothingStore) {
	...
	public DROPOFF_LOCATION(Midwifery midwifery) {
	...
	public DROPOFF_LOCATION(MobilePhoneStore mobilePhoneStore) {
	...
	public DROPOFF_LOCATION(Mosque mosque) {
	...
	public DROPOFF_LOCATION(Motel motel) {
	...
	public DROPOFF_LOCATION(MotorcycleDealer motorcycleDealer) {
	...
	public DROPOFF_LOCATION(MotorcycleRepair motorcycleRepair) {
	...
	public DROPOFF_LOCATION(Mountain mountain) {
	...
	public DROPOFF_LOCATION(MovieRentalStore movieRentalStore) {
	...
	public DROPOFF_LOCATION(MovieTheater movieTheater) {
	...
	public DROPOFF_LOCATION(MovingCompany movingCompany) {
	...
	public DROPOFF_LOCATION(Museum museum) {
	...
	public DROPOFF_LOCATION(MusicStore musicStore) {
	...
	public DROPOFF_LOCATION(MusicVenue musicVenue) {
	...
	public DROPOFF_LOCATION(NailSalon nailSalon) {
	...
	public DROPOFF_LOCATION(NightClub nightClub) {
	...
	public DROPOFF_LOCATION(Notary notary) {
	...
	public DROPOFF_LOCATION(Nursing nursing) {
	...
	public DROPOFF_LOCATION(Obstetric obstetric) {
	...
	public DROPOFF_LOCATION(OceanBodyOfWater oceanBodyOfWater) {
	...
	public DROPOFF_LOCATION(OfficeEquipmentStore officeEquipmentStore) {
	...
	public DROPOFF_LOCATION(Oncologic oncologic) {
	...
	public DROPOFF_LOCATION(Optician optician) {
	...
	public DROPOFF_LOCATION(Optometric optometric) {
	...
	public DROPOFF_LOCATION(Otolaryngologic otolaryngologic) {
	...
	public DROPOFF_LOCATION(OutletStore outletStore) {
	...
	public DROPOFF_LOCATION(Park park) {
	...
	public DROPOFF_LOCATION(ParkingFacility parkingFacility) {
	...
	public DROPOFF_LOCATION(PawnShop pawnShop) {
	...
	public DROPOFF_LOCATION(Pediatric pediatric) {
	...
	public DROPOFF_LOCATION(PerformingArtsTheater performingArtsTheater) {
	...
	public DROPOFF_LOCATION(PetStore petStore) {
	...
	public DROPOFF_LOCATION(Pharmacy pharmacy) {
	...
	public DROPOFF_LOCATION(Physician physician) {
	...
	public DROPOFF_LOCATION(Physiotherapy physiotherapy) {
	...
	public DROPOFF_LOCATION(PlaceOfWorship placeOfWorship) {
	...
	public DROPOFF_LOCATION(PlasticSurgery plasticSurgery) {
	...
	public DROPOFF_LOCATION(Playground playground) {
	...
	public DROPOFF_LOCATION(Plumber plumber) {
	...
	public DROPOFF_LOCATION(Podiatric podiatric) {
	...
	public DROPOFF_LOCATION(PoliceStation policeStation) {
	...
	public DROPOFF_LOCATION(Pond pond) {
	...
	public DROPOFF_LOCATION(PostOffice postOffice) {
	...
	public DROPOFF_LOCATION(PrimaryCare primaryCare) {
	...
	public DROPOFF_LOCATION(ProfessionalService professionalService) {
	...
	public DROPOFF_LOCATION(Psychiatric psychiatric) {
	...
	public DROPOFF_LOCATION(PublicHealth publicHealth) {
	...
	public DROPOFF_LOCATION(PublicSwimmingPool publicSwimmingPool) {
	...
	public DROPOFF_LOCATION(PublicToilet publicToilet) {
	...
	public DROPOFF_LOCATION(RVPark rvPark) {
	...
	public DROPOFF_LOCATION(RadioStation radioStation) {
	...
	public DROPOFF_LOCATION(RealEstateAgent realEstateAgent) {
	...
	public DROPOFF_LOCATION(RecyclingCenter recyclingCenter) {
	...
	public DROPOFF_LOCATION(Reservoir reservoir) {
	...
	public DROPOFF_LOCATION(Residence residence) {
	...
	public DROPOFF_LOCATION(Resort resort) {
	...
	public DROPOFF_LOCATION(Restaurant restaurant) {
	...
	public DROPOFF_LOCATION(RiverBodyOfWater riverBodyOfWater) {
	...
	public DROPOFF_LOCATION(RoofingContractor roofingContractor) {
	...
	public DROPOFF_LOCATION(Room room) {
	...
	public DROPOFF_LOCATION(SeaBodyOfWater seaBodyOfWater) {
	...
	public DROPOFF_LOCATION(SelfStorage selfStorage) {
	...
	public DROPOFF_LOCATION(ShoeStore shoeStore) {
	...
	public DROPOFF_LOCATION(ShoppingCenter shoppingCenter) {
	...
	public DROPOFF_LOCATION(SingleFamilyResidence singleFamilyResidence) {
	...
	public DROPOFF_LOCATION(SkiResort skiResort) {
	...
	public DROPOFF_LOCATION(SportingGoodsStore sportingGoodsStore) {
	...
	public DROPOFF_LOCATION(SportsActivityLocation sportsActivityLocation) {
	...
	public DROPOFF_LOCATION(SportsClub sportsClub) {
	...
	public DROPOFF_LOCATION(StadiumOrArena stadiumOrArena) {
	...
	public DROPOFF_LOCATION(State state) {
	...
	public DROPOFF_LOCATION(Store store) {
	...
	public DROPOFF_LOCATION(SubwayStation subwayStation) {
	...
	public DROPOFF_LOCATION(Suite suite) {
	...
	public DROPOFF_LOCATION(Synagogue synagogue) {
	...
	public DROPOFF_LOCATION(TattooParlor tattooParlor) {
	...
	public DROPOFF_LOCATION(TaxiStand taxiStand) {
	...
	public DROPOFF_LOCATION(TelevisionStation televisionStation) {
	...
	public DROPOFF_LOCATION(TennisComplex tennisComplex) {
	...
	public DROPOFF_LOCATION(TireShop tireShop) {
	...
	public DROPOFF_LOCATION(TouristAttraction touristAttraction) {
	...
	public DROPOFF_LOCATION(TouristDestination touristDestination) {
	...
	public DROPOFF_LOCATION(TouristInformationCenter touristInformationCenter) {
	...
	public DROPOFF_LOCATION(ToyStore toyStore) {
	...
	public DROPOFF_LOCATION(TrainStation trainStation) {
	...
	public DROPOFF_LOCATION(TravelAgency travelAgency) {
	...
	public DROPOFF_LOCATION(Volcano volcano) {
	...
	public DROPOFF_LOCATION(Waterfall waterfall) {
	...
	public DROPOFF_LOCATION(WholesaleStore wholesaleStore) {
	...
	public DROPOFF_LOCATION(Winery winery) {
	...
	public DROPOFF_LOCATION(Zoo zoo) {
	...
	public void copy(Container.DropoffLocation org) {
