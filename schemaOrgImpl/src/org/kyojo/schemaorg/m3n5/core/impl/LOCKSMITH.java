...
public class LOCKSMITH implements Clazz.Locksmith {
	...
	public LOCKSMITH(GeoContains geoContains) {
	...
	public LOCKSMITH(GeoCoveredBy geoCoveredBy) {
	...
	public LOCKSMITH(GeoCovers geoCovers) {
	...
	public LOCKSMITH(GeoCrosses geoCrosses) {
	...
	public LOCKSMITH(GeoDisjoint geoDisjoint) {
	...
	public LOCKSMITH(GeoEquals geoEquals) {
	...
	public LOCKSMITH(GeoIntersects geoIntersects) {
	...
	public LOCKSMITH(GeoOverlaps geoOverlaps) {
	...
	public LOCKSMITH(GeoTouches geoTouches) {
	...
	public LOCKSMITH(GeoWithin geoWithin) {
	...
	public LOCKSMITH(Slogan slogan) {
		setSlogan(slogan);
	}
