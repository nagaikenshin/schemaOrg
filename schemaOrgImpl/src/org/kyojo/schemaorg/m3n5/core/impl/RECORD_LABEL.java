...
public class RECORD_LABEL implements Container.RecordLabel {
	...
	public RECORD_LABEL(String string) {
	...
	public RECORD_LABEL(AccountingService accountingService) {
	...
	public RECORD_LABEL(AdultEntertainment adultEntertainment) {
	...
	public RECORD_LABEL(Airline airline) {
	...
	public RECORD_LABEL(AmusementPark amusementPark) {
	...
	public RECORD_LABEL(AnimalShelter animalShelter) {
	...
	public RECORD_LABEL(ArchiveOrganization archiveOrganization) {
	...
	public RECORD_LABEL(ArtGallery artGallery) {
	...
	public RECORD_LABEL(Attorney attorney) {
	...
	public RECORD_LABEL(AutoBodyShop autoBodyShop) {
	...
	public RECORD_LABEL(AutoDealer autoDealer) {
	...
	public RECORD_LABEL(AutoPartsStore autoPartsStore) {
	...
	public RECORD_LABEL(AutoRental autoRental) {
	...
	public RECORD_LABEL(AutoRepair autoRepair) {
	...
	public RECORD_LABEL(AutoWash autoWash) {
	...
	public RECORD_LABEL(AutomatedTeller automatedTeller) {
	...
	public RECORD_LABEL(AutomotiveBusiness automotiveBusiness) {
	...
	public RECORD_LABEL(Bakery bakery) {
	...
	public RECORD_LABEL(BankOrCreditUnion bankOrCreditUnion) {
	...
	public RECORD_LABEL(BarOrPub barOrPub) {
	...
	public RECORD_LABEL(BeautySalon beautySalon) {
	...
	public RECORD_LABEL(BedAndBreakfast bedAndBreakfast) {
	...
	public RECORD_LABEL(BikeStore bikeStore) {
	...
	public RECORD_LABEL(BookStore bookStore) {
	...
	public RECORD_LABEL(BowlingAlley bowlingAlley) {
	...
	public RECORD_LABEL(Brewery brewery) {
	...
	public RECORD_LABEL(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public RECORD_LABEL(Campground campground) {
	...
	public RECORD_LABEL(Casino casino) {
	...
	public RECORD_LABEL(ChildCare childCare) {
	...
	public RECORD_LABEL(ClothingStore clothingStore) {
	...
	public RECORD_LABEL(CollegeOrUniversity collegeOrUniversity) {
	...
	public RECORD_LABEL(ComedyClub comedyClub) {
	...
	public RECORD_LABEL(CommunityHealth communityHealth) {
	...
	public RECORD_LABEL(ComputerStore computerStore) {
	...
	public RECORD_LABEL(Consortium consortium) {
	...
	public RECORD_LABEL(ConvenienceStore convenienceStore) {
	...
	public RECORD_LABEL(Corporation corporation) {
	...
	public RECORD_LABEL(DanceGroup danceGroup) {
	...
	public RECORD_LABEL(DaySpa daySpa) {
	...
	public RECORD_LABEL(Dentist dentist) {
	...
	public RECORD_LABEL(DepartmentStore departmentStore) {
	...
	public RECORD_LABEL(Dermatology dermatology) {
	...
	public RECORD_LABEL(DiagnosticLab diagnosticLab) {
	...
	public RECORD_LABEL(DietNutrition dietNutrition) {
	...
	public RECORD_LABEL(Distillery distillery) {
	...
	public RECORD_LABEL(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public RECORD_LABEL(EducationalOrganization educationalOrganization) {
	...
	public RECORD_LABEL(Electrician electrician) {
	...
	public RECORD_LABEL(ElectronicsStore electronicsStore) {
	...
	public RECORD_LABEL(ElementarySchool elementarySchool) {
	...
	public RECORD_LABEL(Emergency emergency) {
	...
	public RECORD_LABEL(EmergencyService emergencyService) {
	...
	public RECORD_LABEL(EmploymentAgency employmentAgency) {
	...
	public RECORD_LABEL(EntertainmentBusiness entertainmentBusiness) {
	...
	public RECORD_LABEL(ExerciseGym exerciseGym) {
	...
	public RECORD_LABEL(FastFoodRestaurant fastFoodRestaurant) {
	...
	public RECORD_LABEL(FinancialService financialService) {
	...
	public RECORD_LABEL(FireStation fireStation) {
	...
	public RECORD_LABEL(Florist florist) {
	...
	public RECORD_LABEL(FoodEstablishment foodEstablishment) {
	...
	public RECORD_LABEL(FundingAgency fundingAgency) {
	...
	public RECORD_LABEL(FundingScheme fundingScheme) {
	...
	public RECORD_LABEL(FurnitureStore furnitureStore) {
	...
	public RECORD_LABEL(GardenStore gardenStore) {
	...
	public RECORD_LABEL(GasStation gasStation) {
	...
	public RECORD_LABEL(GeneralContractor generalContractor) {
	...
	public RECORD_LABEL(Geriatric geriatric) {
	...
	public RECORD_LABEL(GolfCourse golfCourse) {
	...
	public RECORD_LABEL(GovernmentOffice governmentOffice) {
	...
	public RECORD_LABEL(GovernmentOrganization governmentOrganization) {
	...
	public RECORD_LABEL(GroceryStore groceryStore) {
	...
	public RECORD_LABEL(Gynecologic gynecologic) {
	...
	public RECORD_LABEL(HVACBusiness hvacBusiness) {
	...
	public RECORD_LABEL(HairSalon hairSalon) {
	...
	public RECORD_LABEL(HardwareStore hardwareStore) {
	...
	public RECORD_LABEL(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public RECORD_LABEL(HealthClub healthClub) {
	...
	public RECORD_LABEL(HighSchool highSchool) {
	...
	public RECORD_LABEL(HobbyShop hobbyShop) {
	...
	public RECORD_LABEL(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public RECORD_LABEL(HomeGoodsStore homeGoodsStore) {
	...
	public RECORD_LABEL(Hospital hospital) {
	...
	public RECORD_LABEL(Hostel hostel) {
	...
	public RECORD_LABEL(Hotel hotel) {
	...
	public RECORD_LABEL(HousePainter housePainter) {
	...
	public RECORD_LABEL(IceCreamShop iceCreamShop) {
	...
	public RECORD_LABEL(InsuranceAgency insuranceAgency) {
	...
	public RECORD_LABEL(InternetCafe internetCafe) {
	...
	public RECORD_LABEL(JewelryStore jewelryStore) {
	...
	public RECORD_LABEL(LegalService legalService) {
	...
	public RECORD_LABEL(Library library) {
	...
	public RECORD_LABEL(LibrarySystem librarySystem) {
	...
	public RECORD_LABEL(LiquorStore liquorStore) {
	...
	public RECORD_LABEL(LocalBusiness localBusiness) {
	...
	public RECORD_LABEL(Locksmith locksmith) {
	...
	public RECORD_LABEL(LodgingBusiness lodgingBusiness) {
	...
	public RECORD_LABEL(MedicalBusiness medicalBusiness) {
	...
	public RECORD_LABEL(MedicalClinic medicalClinic) {
	...
	public RECORD_LABEL(MedicalOrganization medicalOrganization) {
	...
	public RECORD_LABEL(MensClothingStore mensClothingStore) {
	...
	public RECORD_LABEL(MiddleSchool middleSchool) {
	...
	public RECORD_LABEL(Midwifery midwifery) {
	...
	public RECORD_LABEL(MobilePhoneStore mobilePhoneStore) {
	...
	public RECORD_LABEL(Motel motel) {
	...
	public RECORD_LABEL(MotorcycleDealer motorcycleDealer) {
	...
	public RECORD_LABEL(MotorcycleRepair motorcycleRepair) {
	...
	public RECORD_LABEL(MovieRentalStore movieRentalStore) {
	...
	public RECORD_LABEL(MovieTheater movieTheater) {
	...
	public RECORD_LABEL(MovingCompany movingCompany) {
	...
	public RECORD_LABEL(MusicGroup musicGroup) {
	...
	public RECORD_LABEL(MusicStore musicStore) {
	...
	public RECORD_LABEL(NailSalon nailSalon) {
	...
	public RECORD_LABEL(NewsMediaOrganization newsMediaOrganization) {
	...
	public RECORD_LABEL(NightClub nightClub) {
	...
	public RECORD_LABEL(Notary notary) {
	...
	public RECORD_LABEL(Nursing nursing) {
	...
	public RECORD_LABEL(Obstetric obstetric) {
	...
	public RECORD_LABEL(OfficeEquipmentStore officeEquipmentStore) {
	...
	public RECORD_LABEL(Oncologic oncologic) {
	...
	public RECORD_LABEL(Optician optician) {
	...
	public RECORD_LABEL(Optometric optometric) {
	...
	public RECORD_LABEL(Organization organization) {
		organizationList = new ArrayList<Organization>();
	...
	public RECORD_LABEL(Otolaryngologic otolaryngologic) {
	...
	public RECORD_LABEL(OutletStore outletStore) {
	...
	public RECORD_LABEL(PawnShop pawnShop) {
	...
	public RECORD_LABEL(Pediatric pediatric) {
	...
	public RECORD_LABEL(PerformingGroup performingGroup) {
	...
	public RECORD_LABEL(PetStore petStore) {
	...
	public RECORD_LABEL(Pharmacy pharmacy) {
	...
	public RECORD_LABEL(Physician physician) {
	...
	public RECORD_LABEL(Physiotherapy physiotherapy) {
	...
	public RECORD_LABEL(PlasticSurgery plasticSurgery) {
	...
	public RECORD_LABEL(Plumber plumber) {
	...
	public RECORD_LABEL(Podiatric podiatric) {
	...
	public RECORD_LABEL(PoliceStation policeStation) {
	...
	public RECORD_LABEL(PostOffice postOffice) {
	...
	public RECORD_LABEL(Preschool preschool) {
	...
	public RECORD_LABEL(PrimaryCare primaryCare) {
	...
	public RECORD_LABEL(ProfessionalService professionalService) {
	...
	public RECORD_LABEL(Project project) {
	...
	public RECORD_LABEL(Psychiatric psychiatric) {
	...
	public RECORD_LABEL(PublicHealth publicHealth) {
	...
	public RECORD_LABEL(PublicSwimmingPool publicSwimmingPool) {
	...
	public RECORD_LABEL(RadioStation radioStation) {
	...
	public RECORD_LABEL(RealEstateAgent realEstateAgent) {
	...
	public RECORD_LABEL(RecyclingCenter recyclingCenter) {
	...
	public RECORD_LABEL(ResearchProject researchProject) {
	...
	public RECORD_LABEL(Resort resort) {
	...
	public RECORD_LABEL(Restaurant restaurant) {
	...
	public RECORD_LABEL(RoofingContractor roofingContractor) {
	...
	public RECORD_LABEL(School school) {
	...
	public RECORD_LABEL(SelfStorage selfStorage) {
	...
	public RECORD_LABEL(ShoeStore shoeStore) {
	...
	public RECORD_LABEL(ShoppingCenter shoppingCenter) {
	...
	public RECORD_LABEL(SkiResort skiResort) {
	...
	public RECORD_LABEL(SportingGoodsStore sportingGoodsStore) {
	...
	public RECORD_LABEL(SportsActivityLocation sportsActivityLocation) {
	...
	public RECORD_LABEL(SportsClub sportsClub) {
	...
	public RECORD_LABEL(SportsOrganization sportsOrganization) {
	...
	public RECORD_LABEL(SportsTeam sportsTeam) {
	...
	public RECORD_LABEL(StadiumOrArena stadiumOrArena) {
	...
	public RECORD_LABEL(Store store) {
	...
	public RECORD_LABEL(TattooParlor tattooParlor) {
	...
	public RECORD_LABEL(TelevisionStation televisionStation) {
	...
	public RECORD_LABEL(TennisComplex tennisComplex) {
	...
	public RECORD_LABEL(TheaterGroup theaterGroup) {
	...
	public RECORD_LABEL(TireShop tireShop) {
	...
	public RECORD_LABEL(TouristInformationCenter touristInformationCenter) {
	...
	public RECORD_LABEL(ToyStore toyStore) {
	...
	public RECORD_LABEL(TravelAgency travelAgency) {
	...
	public RECORD_LABEL(VeterinaryCare veterinaryCare) {
	...
	public RECORD_LABEL(WholesaleStore wholesaleStore) {
	...
	public RECORD_LABEL(Winery winery) {
	...
	public RECORD_LABEL(WorkersUnion workersUnion) {
	...
	public void copy(Container.RecordLabel org) {
