...
public class BROADCASTER implements Container.Broadcaster {
	...
	public BROADCASTER(String string) {
	...
	public BROADCASTER(AccountingService accountingService) {
	...
	public BROADCASTER(AdultEntertainment adultEntertainment) {
	...
	public BROADCASTER(Airline airline) {
	...
	public BROADCASTER(AmusementPark amusementPark) {
	...
	public BROADCASTER(AnimalShelter animalShelter) {
	...
	public BROADCASTER(ArchiveOrganization archiveOrganization) {
	...
	public BROADCASTER(ArtGallery artGallery) {
	...
	public BROADCASTER(Attorney attorney) {
	...
	public BROADCASTER(AutoBodyShop autoBodyShop) {
	...
	public BROADCASTER(AutoDealer autoDealer) {
	...
	public BROADCASTER(AutoPartsStore autoPartsStore) {
	...
	public BROADCASTER(AutoRental autoRental) {
	...
	public BROADCASTER(AutoRepair autoRepair) {
	...
	public BROADCASTER(AutoWash autoWash) {
	...
	public BROADCASTER(AutomatedTeller automatedTeller) {
	...
	public BROADCASTER(AutomotiveBusiness automotiveBusiness) {
	...
	public BROADCASTER(Bakery bakery) {
	...
	public BROADCASTER(BankOrCreditUnion bankOrCreditUnion) {
	...
	public BROADCASTER(BarOrPub barOrPub) {
	...
	public BROADCASTER(BeautySalon beautySalon) {
	...
	public BROADCASTER(BedAndBreakfast bedAndBreakfast) {
	...
	public BROADCASTER(BikeStore bikeStore) {
	...
	public BROADCASTER(BookStore bookStore) {
	...
	public BROADCASTER(BowlingAlley bowlingAlley) {
	...
	public BROADCASTER(Brewery brewery) {
	...
	public BROADCASTER(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public BROADCASTER(Campground campground) {
	...
	public BROADCASTER(Casino casino) {
	...
	public BROADCASTER(ChildCare childCare) {
	...
	public BROADCASTER(ClothingStore clothingStore) {
	...
	public BROADCASTER(CollegeOrUniversity collegeOrUniversity) {
	...
	public BROADCASTER(ComedyClub comedyClub) {
	...
	public BROADCASTER(CommunityHealth communityHealth) {
	...
	public BROADCASTER(ComputerStore computerStore) {
	...
	public BROADCASTER(Consortium consortium) {
	...
	public BROADCASTER(ConvenienceStore convenienceStore) {
	...
	public BROADCASTER(Corporation corporation) {
	...
	public BROADCASTER(DanceGroup danceGroup) {
	...
	public BROADCASTER(DaySpa daySpa) {
	...
	public BROADCASTER(Dentist dentist) {
	...
	public BROADCASTER(DepartmentStore departmentStore) {
	...
	public BROADCASTER(Dermatology dermatology) {
	...
	public BROADCASTER(DiagnosticLab diagnosticLab) {
	...
	public BROADCASTER(DietNutrition dietNutrition) {
	...
	public BROADCASTER(Distillery distillery) {
	...
	public BROADCASTER(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public BROADCASTER(EducationalOrganization educationalOrganization) {
	...
	public BROADCASTER(Electrician electrician) {
	...
	public BROADCASTER(ElectronicsStore electronicsStore) {
	...
	public BROADCASTER(ElementarySchool elementarySchool) {
	...
	public BROADCASTER(Emergency emergency) {
	...
	public BROADCASTER(EmergencyService emergencyService) {
	...
	public BROADCASTER(EmploymentAgency employmentAgency) {
	...
	public BROADCASTER(EntertainmentBusiness entertainmentBusiness) {
	...
	public BROADCASTER(ExerciseGym exerciseGym) {
	...
	public BROADCASTER(FastFoodRestaurant fastFoodRestaurant) {
	...
	public BROADCASTER(FinancialService financialService) {
	...
	public BROADCASTER(FireStation fireStation) {
	...
	public BROADCASTER(Florist florist) {
	...
	public BROADCASTER(FoodEstablishment foodEstablishment) {
	...
	public BROADCASTER(FundingAgency fundingAgency) {
	...
	public BROADCASTER(FundingScheme fundingScheme) {
	...
	public BROADCASTER(FurnitureStore furnitureStore) {
	...
	public BROADCASTER(GardenStore gardenStore) {
	...
	public BROADCASTER(GasStation gasStation) {
	...
	public BROADCASTER(GeneralContractor generalContractor) {
	...
	public BROADCASTER(Geriatric geriatric) {
	...
	public BROADCASTER(GolfCourse golfCourse) {
	...
	public BROADCASTER(GovernmentOffice governmentOffice) {
	...
	public BROADCASTER(GovernmentOrganization governmentOrganization) {
	...
	public BROADCASTER(GroceryStore groceryStore) {
	...
	public BROADCASTER(Gynecologic gynecologic) {
	...
	public BROADCASTER(HVACBusiness hvacBusiness) {
	...
	public BROADCASTER(HairSalon hairSalon) {
	...
	public BROADCASTER(HardwareStore hardwareStore) {
	...
	public BROADCASTER(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public BROADCASTER(HealthClub healthClub) {
	...
	public BROADCASTER(HighSchool highSchool) {
	...
	public BROADCASTER(HobbyShop hobbyShop) {
	...
	public BROADCASTER(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public BROADCASTER(HomeGoodsStore homeGoodsStore) {
	...
	public BROADCASTER(Hospital hospital) {
	...
	public BROADCASTER(Hostel hostel) {
	...
	public BROADCASTER(Hotel hotel) {
	...
	public BROADCASTER(HousePainter housePainter) {
	...
	public BROADCASTER(IceCreamShop iceCreamShop) {
	...
	public BROADCASTER(InsuranceAgency insuranceAgency) {
	...
	public BROADCASTER(InternetCafe internetCafe) {
	...
	public BROADCASTER(JewelryStore jewelryStore) {
	...
	public BROADCASTER(LegalService legalService) {
	...
	public BROADCASTER(Library library) {
	...
	public BROADCASTER(LibrarySystem librarySystem) {
	...
	public BROADCASTER(LiquorStore liquorStore) {
	...
	public BROADCASTER(LocalBusiness localBusiness) {
	...
	public BROADCASTER(Locksmith locksmith) {
	...
	public BROADCASTER(LodgingBusiness lodgingBusiness) {
	...
	public BROADCASTER(MedicalBusiness medicalBusiness) {
	...
	public BROADCASTER(MedicalClinic medicalClinic) {
	...
	public BROADCASTER(MedicalOrganization medicalOrganization) {
	...
	public BROADCASTER(MensClothingStore mensClothingStore) {
	...
	public BROADCASTER(MiddleSchool middleSchool) {
	...
	public BROADCASTER(Midwifery midwifery) {
	...
	public BROADCASTER(MobilePhoneStore mobilePhoneStore) {
	...
	public BROADCASTER(Motel motel) {
	...
	public BROADCASTER(MotorcycleDealer motorcycleDealer) {
	...
	public BROADCASTER(MotorcycleRepair motorcycleRepair) {
	...
	public BROADCASTER(MovieRentalStore movieRentalStore) {
	...
	public BROADCASTER(MovieTheater movieTheater) {
	...
	public BROADCASTER(MovingCompany movingCompany) {
	...
	public BROADCASTER(MusicGroup musicGroup) {
	...
	public BROADCASTER(MusicStore musicStore) {
	...
	public BROADCASTER(NailSalon nailSalon) {
	...
	public BROADCASTER(NewsMediaOrganization newsMediaOrganization) {
	...
	public BROADCASTER(NightClub nightClub) {
	...
	public BROADCASTER(Notary notary) {
	...
	public BROADCASTER(Nursing nursing) {
	...
	public BROADCASTER(Obstetric obstetric) {
	...
	public BROADCASTER(OfficeEquipmentStore officeEquipmentStore) {
	...
	public BROADCASTER(Oncologic oncologic) {
	...
	public BROADCASTER(Optician optician) {
	...
	public BROADCASTER(Optometric optometric) {
	...
	public BROADCASTER(Organization organization) {
		organizationList = new ArrayList<Organization>();
	...
	public BROADCASTER(Otolaryngologic otolaryngologic) {
	...
	public BROADCASTER(OutletStore outletStore) {
	...
	public BROADCASTER(PawnShop pawnShop) {
	...
	public BROADCASTER(Pediatric pediatric) {
	...
	public BROADCASTER(PerformingGroup performingGroup) {
	...
	public BROADCASTER(PetStore petStore) {
	...
	public BROADCASTER(Pharmacy pharmacy) {
	...
	public BROADCASTER(Physician physician) {
	...
	public BROADCASTER(Physiotherapy physiotherapy) {
	...
	public BROADCASTER(PlasticSurgery plasticSurgery) {
	...
	public BROADCASTER(Plumber plumber) {
	...
	public BROADCASTER(Podiatric podiatric) {
	...
	public BROADCASTER(PoliceStation policeStation) {
	...
	public BROADCASTER(PostOffice postOffice) {
	...
	public BROADCASTER(Preschool preschool) {
	...
	public BROADCASTER(PrimaryCare primaryCare) {
	...
	public BROADCASTER(ProfessionalService professionalService) {
	...
	public BROADCASTER(Project project) {
	...
	public BROADCASTER(Psychiatric psychiatric) {
	...
	public BROADCASTER(PublicHealth publicHealth) {
	...
	public BROADCASTER(PublicSwimmingPool publicSwimmingPool) {
	...
	public BROADCASTER(RadioStation radioStation) {
	...
	public BROADCASTER(RealEstateAgent realEstateAgent) {
	...
	public BROADCASTER(RecyclingCenter recyclingCenter) {
	...
	public BROADCASTER(ResearchProject researchProject) {
	...
	public BROADCASTER(Resort resort) {
	...
	public BROADCASTER(Restaurant restaurant) {
	...
	public BROADCASTER(RoofingContractor roofingContractor) {
	...
	public BROADCASTER(School school) {
	...
	public BROADCASTER(SelfStorage selfStorage) {
	...
	public BROADCASTER(ShoeStore shoeStore) {
	...
	public BROADCASTER(ShoppingCenter shoppingCenter) {
	...
	public BROADCASTER(SkiResort skiResort) {
	...
	public BROADCASTER(SportingGoodsStore sportingGoodsStore) {
	...
	public BROADCASTER(SportsActivityLocation sportsActivityLocation) {
	...
	public BROADCASTER(SportsClub sportsClub) {
	...
	public BROADCASTER(SportsOrganization sportsOrganization) {
	...
	public BROADCASTER(SportsTeam sportsTeam) {
	...
	public BROADCASTER(StadiumOrArena stadiumOrArena) {
	...
	public BROADCASTER(Store store) {
	...
	public BROADCASTER(TattooParlor tattooParlor) {
	...
	public BROADCASTER(TelevisionStation televisionStation) {
	...
	public BROADCASTER(TennisComplex tennisComplex) {
	...
	public BROADCASTER(TheaterGroup theaterGroup) {
	...
	public BROADCASTER(TireShop tireShop) {
	...
	public BROADCASTER(TouristInformationCenter touristInformationCenter) {
	...
	public BROADCASTER(ToyStore toyStore) {
	...
	public BROADCASTER(TravelAgency travelAgency) {
	...
	public BROADCASTER(VeterinaryCare veterinaryCare) {
	...
	public BROADCASTER(WholesaleStore wholesaleStore) {
	...
	public BROADCASTER(Winery winery) {
	...
	public BROADCASTER(WorkersUnion workersUnion) {
	...
	public void copy(Container.Broadcaster org) {
