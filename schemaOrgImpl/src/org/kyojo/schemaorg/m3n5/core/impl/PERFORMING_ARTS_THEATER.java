...
public class PERFORMING_ARTS_THEATER implements Clazz.PerformingArtsTheater {
	...
	public PERFORMING_ARTS_THEATER(GeoContains geoContains) {
	...
	public PERFORMING_ARTS_THEATER(GeoCoveredBy geoCoveredBy) {
	...
	public PERFORMING_ARTS_THEATER(GeoCovers geoCovers) {
	...
	public PERFORMING_ARTS_THEATER(GeoCrosses geoCrosses) {
	...
	public PERFORMING_ARTS_THEATER(GeoDisjoint geoDisjoint) {
	...
	public PERFORMING_ARTS_THEATER(GeoEquals geoEquals) {
	...
	public PERFORMING_ARTS_THEATER(GeoIntersects geoIntersects) {
	...
	public PERFORMING_ARTS_THEATER(GeoOverlaps geoOverlaps) {
	...
	public PERFORMING_ARTS_THEATER(GeoTouches geoTouches) {
	...
	public PERFORMING_ARTS_THEATER(GeoWithin geoWithin) {
	...
	public PERFORMING_ARTS_THEATER(Slogan slogan) {
		setSlogan(slogan);
	}
