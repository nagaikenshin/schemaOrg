...
public class CANAL implements Clazz.Canal {
	...
	public CANAL(GeoContains geoContains) {
	...
	public CANAL(GeoCoveredBy geoCoveredBy) {
	...
	public CANAL(GeoCovers geoCovers) {
	...
	public CANAL(GeoCrosses geoCrosses) {
	...
	public CANAL(GeoDisjoint geoDisjoint) {
	...
	public CANAL(GeoEquals geoEquals) {
	...
	public CANAL(GeoIntersects geoIntersects) {
	...
	public CANAL(GeoOverlaps geoOverlaps) {
	...
	public CANAL(GeoTouches geoTouches) {
	...
	public CANAL(GeoWithin geoWithin) {
