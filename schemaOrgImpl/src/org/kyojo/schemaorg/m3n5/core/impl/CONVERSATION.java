...
public class CONVERSATION implements Clazz.Conversation {
	...
	public CONVERSATION(About about) {
		setAbout(about);
	}
	...
	public CONVERSATION(AccessMode accessMode) {
	...
	public CONVERSATION(AccessModeSufficient accessModeSufficient) {
	...
	public CONVERSATION(AccessibilityAPI accessibilityAPI) {
	...
	public CONVERSATION(AccessibilityControl accessibilityControl) {
	...
	public CONVERSATION(AccessibilityFeature accessibilityFeature) {
	...
	public CONVERSATION(AccessibilityHazard accessibilityHazard) {
	...
	public CONVERSATION(AccessibilitySummary accessibilitySummary) {
	...
	public CONVERSATION(AccountablePerson accountablePerson) {
	...
	public CONVERSATION(AdditionalType additionalType) {
	...
	public CONVERSATION(AggregateRating aggregateRating) {
	...
	public CONVERSATION(AlternateName alternateName) {
	...
	public CONVERSATION(AlternativeHeadline alternativeHeadline) {
	...
	public CONVERSATION(AssociatedMedia associatedMedia) {
	...
	public CONVERSATION(Audio audio) {
		setAudio(audio);
	}
	...
	public CONVERSATION(Author author) {
		setAuthor(author);
	}
	...
	public CONVERSATION(Award award) {
		setAward(award);
	}
	...
	public CONVERSATION(Character character) {
	...
	public CONVERSATION(Citation citation) {
	...
	public CONVERSATION(Comment comment) {
		setComment(comment);
	}
	...
	public CONVERSATION(CommentCount commentCount) {
	...
	public CONVERSATION(ContentLocation contentLocation) {
	...
	public CONVERSATION(ContentRating contentRating) {
	...
	public CONVERSATION(ContentReferenceTime contentReferenceTime) {
	...
	public CONVERSATION(Contributor contributor) {
	...
	public CONVERSATION(CopyrightHolder copyrightHolder) {
	...
	public CONVERSATION(CopyrightYear copyrightYear) {
	...
	public CONVERSATION(Correction correction) {
	...
	public CONVERSATION(Creator creator) {
		setCreator(creator);
	}
	...
	public CONVERSATION(DateCreated dateCreated) {
	...
	public CONVERSATION(DateModified dateModified) {
	...
	public CONVERSATION(DatePublished datePublished) {
	...
	public CONVERSATION(Description description) {
	...
	public CONVERSATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public CONVERSATION(DiscussionUrl discussionUrl) {
	...
	public CONVERSATION(Editor editor) {
		setEditor(editor);
	}
	...
	public CONVERSATION(EducationalAlignment educationalAlignment) {
	...
	public CONVERSATION(EducationalUse educationalUse) {
	...
	public CONVERSATION(Encoding encoding) {
	...
	public CONVERSATION(EncodingFormat encodingFormat) {
	...
	public CONVERSATION(ExampleOfWork exampleOfWork) {
	...
	public CONVERSATION(Expires expires) {
		setExpires(expires);
	}
	...
	public CONVERSATION(Funder funder) {
		setFunder(funder);
	}
	...
	public CONVERSATION(Genre genre) {
		setGenre(genre);
	}
	...
	public CONVERSATION(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public CONVERSATION(Headline headline) {
	...
	public CONVERSATION(Identifier identifier) {
	...
	public CONVERSATION(Image image) {
		setImage(image);
	}
	...
	public CONVERSATION(InLanguage inLanguage) {
	...
	public CONVERSATION(InteractionStatistic interactionStatistic) {
	...
	public CONVERSATION(InteractivityType interactivityType) {
	...
	public CONVERSATION(IsAccessibleForFree isAccessibleForFree) {
	...
	public CONVERSATION(IsBasedOn isBasedOn) {
	...
	public CONVERSATION(IsFamilyFriendly isFamilyFriendly) {
	...
	public CONVERSATION(IsPartOf isPartOf) {
	...
	public CONVERSATION(Keywords keywords) {
	...
	public CONVERSATION(LearningResourceType learningResourceType) {
	...
	public CONVERSATION(License license) {
		setLicense(license);
	}
	...
	public CONVERSATION(LocationCreated locationCreated) {
	...
	public CONVERSATION(MainEntity mainEntity) {
	...
	public CONVERSATION(MainEntityOfPage mainEntityOfPage) {
	...
	public CONVERSATION(Material material) {
	...
	public CONVERSATION(MaterialExtent materialExtent) {
	...
	public CONVERSATION(Mentions mentions) {
	...
	public CONVERSATION(NameFuzzy nameFuzzy) {
	...
	public CONVERSATION(NameRuby nameRuby) {
	...
	public CONVERSATION(Offers offers) {
		setOffers(offers);
	}
	...
	public CONVERSATION(Position position) {
	...
	public CONVERSATION(PotentialAction potentialAction) {
	...
	public CONVERSATION(Producer producer) {
	...
	public CONVERSATION(Provider provider) {
	...
	public CONVERSATION(Publication publication) {
	...
	public CONVERSATION(Publisher publisher) {
	...
	public CONVERSATION(PublisherImprint publisherImprint) {
	...
	public CONVERSATION(PublishingPrinciples publishingPrinciples) {
	...
	public CONVERSATION(RecordedAt recordedAt) {
	...
	public CONVERSATION(ReleasedEvent releasedEvent) {
	...
	public CONVERSATION(Review review) {
		setReview(review);
	}
	...
	public CONVERSATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CONVERSATION(SchemaVersion schemaVersion) {
	...
	public CONVERSATION(SdDatePublished sdDatePublished) {
	...
	public CONVERSATION(SdLicense sdLicense) {
	...
	public CONVERSATION(SdPublisher sdPublisher) {
	...
	public CONVERSATION(SourceOrganization sourceOrganization) {
	...
	public CONVERSATION(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public CONVERSATION(SpatialCoverage spatialCoverage) {
	...
	public CONVERSATION(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public CONVERSATION(SubjectOf subjectOf) {
	...
	public CONVERSATION(Temporal temporal) {
	...
	public CONVERSATION(TemporalCoverage temporalCoverage) {
	...
	public CONVERSATION(ThumbnailUrl thumbnailUrl) {
	...
	public CONVERSATION(TimeRequired timeRequired) {
	...
	public CONVERSATION(TranslationOfWork translationOfWork) {
	...
	public CONVERSATION(Translator translator) {
	...
	public CONVERSATION(TypicalAgeRange typicalAgeRange) {
	...
	public CONVERSATION(Version version) {
		setVersion(version);
	}
	...
	public CONVERSATION(Video video) {
		setVideo(video);
	}
	...
	public CONVERSATION(WorkExample workExample) {
	...
	public CONVERSATION(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Conversation org) {
		setSeq(org.getSeq());
