...
public class WORK_PRESENTED implements Container.WorkPresented {
	...
	public WORK_PRESENTED(String string) {
		this(new MOVIE(string));
	}

	public String getString() {
		if(movieList == null || movieList.size() == 0 || movieList.get(0) == null) {
			return null;
		} else {
			Name name = movieList.get(0).getName();
	...
	public void setString(String string) {
		...
		if(movieList.size() == 0) {
			movieList.add(new MOVIE(string));
		} else {
			movieList.set(0, new MOVIE(string));
		}
	}

	public WORK_PRESENTED(APIReference apiReference) {
	...
	public WORK_PRESENTED(AboutPage aboutPage) {
	...
	public WORK_PRESENTED(AdvertiserContentArticle advertiserContentArticle) {
	...
	public WORK_PRESENTED(AnalysisNewsArticle analysisNewsArticle) {
	...
	public WORK_PRESENTED(Answer answer) {
	...
	public WORK_PRESENTED(ArchiveComponent archiveComponent) {
	...
	public WORK_PRESENTED(Article article) {
	...
	public WORK_PRESENTED(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public WORK_PRESENTED(Atlas atlas) {
	...
	public WORK_PRESENTED(AudioObject audioObject) {
	...
	public WORK_PRESENTED(Audiobook audiobook) {
	...
	public WORK_PRESENTED(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public WORK_PRESENTED(Barcode barcode) {
	...
	public WORK_PRESENTED(Blog blog) {
	...
	public WORK_PRESENTED(BlogPosting blogPosting) {
	...
	public WORK_PRESENTED(Book book) {
	...
	public WORK_PRESENTED(BookSeries bookSeries) {
	...
	public WORK_PRESENTED(CategoryCodeSet categoryCodeSet) {
	...
	public WORK_PRESENTED(Chapter chapter) {
	...
	public WORK_PRESENTED(CheckoutPage checkoutPage) {
	...
	public WORK_PRESENTED(Claim claim) {
	...
	public WORK_PRESENTED(ClaimReview claimReview) {
	...
	public WORK_PRESENTED(Clip clip) {
	...
	public WORK_PRESENTED(Collection collection) {
	...
	public WORK_PRESENTED(CollectionPage collectionPage) {
	...
	public WORK_PRESENTED(ComicCoverArt comicCoverArt) {
	...
	public WORK_PRESENTED(ComicIssue comicIssue) {
	...
	public WORK_PRESENTED(ComicSeries comicSeries) {
	...
	public WORK_PRESENTED(ComicStory comicStory) {
	...
	public WORK_PRESENTED(Comment comment) {
	...
	public WORK_PRESENTED(CompleteDataFeed completeDataFeed) {
	...
	public WORK_PRESENTED(ContactPage contactPage) {
	...
	public WORK_PRESENTED(Conversation conversation) {
	...
	public WORK_PRESENTED(CorrectionComment correctionComment) {
	...
	public WORK_PRESENTED(Course course) {
	...
	public WORK_PRESENTED(CoverArt coverArt) {
	...
	public WORK_PRESENTED(CreativeWorkSeason creativeWorkSeason) {
	...
	public WORK_PRESENTED(CreativeWorkSeries creativeWorkSeries) {
	...
	public WORK_PRESENTED(CriticReview criticReview) {
	...
	public WORK_PRESENTED(DataCatalog dataCatalog) {
	...
	public WORK_PRESENTED(DataDownload dataDownload) {
	...
	public WORK_PRESENTED(DataFeed dataFeed) {
	...
	public WORK_PRESENTED(Dataset dataset) {
	...
	public WORK_PRESENTED(DefinedTermSet definedTermSet) {
	...
	public WORK_PRESENTED(Diet diet) {
	...
	public WORK_PRESENTED(DigitalDocument digitalDocument) {
	...
	public WORK_PRESENTED(DiscussionForumPosting discussionForumPosting) {
	...
	public WORK_PRESENTED(Drawing drawing) {
	...
	public WORK_PRESENTED(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public WORK_PRESENTED(EmailMessage emailMessage) {
	...
	public WORK_PRESENTED(EmployerReview employerReview) {
	...
	public WORK_PRESENTED(Episode episode) {
	...
	public WORK_PRESENTED(ExercisePlan exercisePlan) {
	...
	public WORK_PRESENTED(FAQPage faqPage) {
	...
	public WORK_PRESENTED(Game game) {
	...
	public WORK_PRESENTED(HowTo howTo) {
	...
	public WORK_PRESENTED(HowToDirection howToDirection) {
	...
	public WORK_PRESENTED(HowToSection howToSection) {
	...
	public WORK_PRESENTED(HowToStep howToStep) {
	...
	public WORK_PRESENTED(HowToTip howToTip) {
	...
	public WORK_PRESENTED(ImageGallery imageGallery) {
	...
	public WORK_PRESENTED(ImageObject imageObject) {
	...
	public WORK_PRESENTED(ItemPage itemPage) {
	...
	public WORK_PRESENTED(Legislation legislation) {
	...
	public WORK_PRESENTED(LegislationObject legislationObject) {
	...
	public WORK_PRESENTED(LiveBlogPosting liveBlogPosting) {
	...
	public WORK_PRESENTED(Manuscript manuscript) {
	...
	public WORK_PRESENTED(MediaObject mediaObject) {
	...
	public WORK_PRESENTED(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public WORK_PRESENTED(MedicalWebPage medicalWebPage) {
	...
	public WORK_PRESENTED(Menu menu) {
	...
	public WORK_PRESENTED(MenuSection menuSection) {
	...
	public WORK_PRESENTED(Message message) {
	...
	public WORK_PRESENTED(MobileApplication mobileApplication) {
	...
	public WORK_PRESENTED(MovieClip movieClip) {
	...
	public WORK_PRESENTED(MovieSeries movieSeries) {
	...
	public WORK_PRESENTED(MusicAlbum musicAlbum) {
	...
	public WORK_PRESENTED(MusicComposition musicComposition) {
	...
	public WORK_PRESENTED(MusicPlaylist musicPlaylist) {
	...
	public WORK_PRESENTED(MusicRecording musicRecording) {
	...
	public WORK_PRESENTED(MusicRelease musicRelease) {
	...
	public WORK_PRESENTED(MusicVideoObject musicVideoObject) {
	...
	public WORK_PRESENTED(NewsArticle newsArticle) {
	...
	public WORK_PRESENTED(Newspaper newspaper) {
	...
	public WORK_PRESENTED(NoteDigitalDocument noteDigitalDocument) {
	...
	public WORK_PRESENTED(OpinionNewsArticle opinionNewsArticle) {
	...
	public WORK_PRESENTED(Painting painting) {
	...
	public WORK_PRESENTED(Periodical periodical) {
	...
	public WORK_PRESENTED(Photograph photograph) {
	...
	public WORK_PRESENTED(Play play) {
	...
	public WORK_PRESENTED(Poster poster) {
	...
	public WORK_PRESENTED(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public WORK_PRESENTED(ProfilePage profilePage) {
	...
	public WORK_PRESENTED(PublicationIssue publicationIssue) {
	...
	public WORK_PRESENTED(PublicationVolume publicationVolume) {
	...
	public WORK_PRESENTED(QAPage qaPage) {
	...
	public WORK_PRESENTED(Question question) {
	...
	public WORK_PRESENTED(Quotation quotation) {
	...
	public WORK_PRESENTED(RadioClip radioClip) {
	...
	public WORK_PRESENTED(RadioEpisode radioEpisode) {
	...
	public WORK_PRESENTED(RadioSeason radioSeason) {
	...
	public WORK_PRESENTED(RadioSeries radioSeries) {
	...
	public WORK_PRESENTED(Recipe recipe) {
	...
	public WORK_PRESENTED(Report report) {
	...
	public WORK_PRESENTED(ReportageNewsArticle reportageNewsArticle) {
	...
	public WORK_PRESENTED(Review review) {
	...
	public WORK_PRESENTED(ReviewNewsArticle reviewNewsArticle) {
	...
	public WORK_PRESENTED(SatiricalArticle satiricalArticle) {
	...
	public WORK_PRESENTED(ScholarlyArticle scholarlyArticle) {
	...
	public WORK_PRESENTED(Sculpture sculpture) {
	...
	public WORK_PRESENTED(SearchResultsPage searchResultsPage) {
	...
	public WORK_PRESENTED(SheetMusic sheetMusic) {
	...
	public WORK_PRESENTED(ShortStory shortStory) {
	...
	public WORK_PRESENTED(SiteNavigationElement siteNavigationElement) {
	...
	public WORK_PRESENTED(SocialMediaPosting socialMediaPosting) {
	...
	public WORK_PRESENTED(SoftwareApplication softwareApplication) {
	...
	public WORK_PRESENTED(SoftwareSourceCode softwareSourceCode) {
	...
	public WORK_PRESENTED(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public WORK_PRESENTED(TVClip tvClip) {
	...
	public WORK_PRESENTED(TVEpisode tvEpisode) {
	...
	public WORK_PRESENTED(TVSeason tvSeason) {
	...
	public WORK_PRESENTED(TVSeries tvSeries) {
	...
	public WORK_PRESENTED(Table table) {
	...
	public WORK_PRESENTED(TechArticle techArticle) {
	...
	public WORK_PRESENTED(TextDigitalDocument textDigitalDocument) {
	...
	public WORK_PRESENTED(Thesis thesis) {
	...
	public WORK_PRESENTED(ThreeDimensionalModel threeDimensionalModel) {
	...
	public WORK_PRESENTED(UserReview userReview) {
	...
	public WORK_PRESENTED(VideoGallery videoGallery) {
	...
	public WORK_PRESENTED(VideoGame videoGame) {
	...
	public WORK_PRESENTED(VideoGameClip videoGameClip) {
	...
	public WORK_PRESENTED(VideoGameSeries videoGameSeries) {
	...
	public WORK_PRESENTED(VideoObject videoObject) {
	...
	public WORK_PRESENTED(VisualArtwork visualArtwork) {
	...
	public WORK_PRESENTED(WPAdBlock wpAdBlock) {
	...
	public WORK_PRESENTED(WPFooter wpFooter) {
	...
	public WORK_PRESENTED(WPHeader wpHeader) {
	...
	public WORK_PRESENTED(WPSideBar wpSideBar) {
	...
	public WORK_PRESENTED(WebApplication webApplication) {
	...
	public WORK_PRESENTED(WebPage webPage) {
	...
	public WORK_PRESENTED(WebPageElement webPageElement) {
	...
	public WORK_PRESENTED(WebSite webSite) {
