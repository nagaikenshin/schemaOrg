...
public class SUITE implements Clazz.Suite {
	...
	public SUITE(GeoContains geoContains) {
	...
	public SUITE(GeoCoveredBy geoCoveredBy) {
	...
	public SUITE(GeoCovers geoCovers) {
	...
	public SUITE(GeoCrosses geoCrosses) {
	...
	public SUITE(GeoDisjoint geoDisjoint) {
	...
	public SUITE(GeoEquals geoEquals) {
	...
	public SUITE(GeoIntersects geoIntersects) {
	...
	public SUITE(GeoOverlaps geoOverlaps) {
	...
	public SUITE(GeoTouches geoTouches) {
	...
	public SUITE(GeoWithin geoWithin) {
