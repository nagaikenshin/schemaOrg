...
public class BEST_RATING implements Container.BestRating {
	...
	public BEST_RATING(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public BEST_RATING(Float fl0at) {
	...
	public BEST_RATING(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public BEST_RATING(Integer integer) {
	...
	public BEST_RATING(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public BEST_RATING(Number number) {
	...
	public BEST_RATING(String string) {
		this(new TEXT(string));
	}

	public BEST_RATING(Text text) {
	...
	public BEST_RATING(List<Float> fl0atList,
	...
	public void copy(Container.BestRating org) {
