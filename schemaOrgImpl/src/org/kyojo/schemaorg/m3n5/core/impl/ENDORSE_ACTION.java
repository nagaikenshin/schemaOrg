...
import org.kyojo.schemaorg.m3n5.core.Container.Endorsee;
...
public class ENDORSE_ACTION implements Clazz.EndorseAction {
	...
	public ENDORSE_ACTION() {
	}

	public ENDORSE_ACTION(Long seq) {
		setSeq(seq);
	}

	public ENDORSE_ACTION(String string) {
	...
	public ENDORSE_ACTION(ActionStatus actionStatus) {
	...
	public ENDORSE_ACTION(AdditionalType additionalType) {
	...
	public ENDORSE_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public ENDORSE_ACTION(AlternateName alternateName) {
	...
	public ENDORSE_ACTION(Description description) {
	...
	public ENDORSE_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public ENDORSE_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public ENDORSE_ACTION(Endorsee endorsee) {
		setEndorsee(endorsee);
	}
	...
	public ENDORSE_ACTION(Error error) {
		setError(error);
	}
	...
	public ENDORSE_ACTION(Identifier identifier) {
	...
	public ENDORSE_ACTION(Image image) {
		setImage(image);
	}
	...
	public ENDORSE_ACTION(Instrument instrument) {
	...
	public ENDORSE_ACTION(Location location) {
	...
	public ENDORSE_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public ENDORSE_ACTION(Name name) {
		setName(name);
	}
	...
	public ENDORSE_ACTION(NameFuzzy nameFuzzy) {
	...
	public ENDORSE_ACTION(NameRuby nameRuby) {
	...
	public ENDORSE_ACTION(Object object) {
		setObject(object);
	}
	...
	public ENDORSE_ACTION(Participant participant) {
	...
	public ENDORSE_ACTION(PotentialAction potentialAction) {
	...
	public ENDORSE_ACTION(Result result) {
		setResult(result);
	}
	...
	public ENDORSE_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ENDORSE_ACTION(StartTime startTime) {
	...
	public ENDORSE_ACTION(SubjectOf subjectOf) {
	...
	public ENDORSE_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.EndorseAction org) {
		setSeq(org.getSeq());
