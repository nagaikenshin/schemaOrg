...
import org.kyojo.schemaorg.m3n5.core.Container.AdditionalNumberOfGuests;
...
public class RSVP_ACTION implements Clazz.RsvpAction {
	...
	public AdditionalNumberOfGuests additionalNumberOfGuests;
	...
	public RsvpResponse rsvpResponse;
	...
	public RSVP_ACTION(Long seq) {
		setSeq(seq);
	}

	public RSVP_ACTION(String string) {
	...
	public RSVP_ACTION(About about) {
		setAbout(about);
	}
	...
	public RSVP_ACTION(ActionStatus actionStatus) {
	...
	public RSVP_ACTION(AdditionalNumberOfGuests additionalNumberOfGuests) {
		setAdditionalNumberOfGuests(additionalNumberOfGuests);
	}

	@Override
	public AdditionalNumberOfGuests getAdditionalNumberOfGuests() {
		return additionalNumberOfGuests;
	}

	@Override
	public void setAdditionalNumberOfGuests(AdditionalNumberOfGuests additionalNumberOfGuests) {
		this.additionalNumberOfGuests = additionalNumberOfGuests;
	}

	public RSVP_ACTION(AdditionalType additionalType) {
	...
	public RSVP_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public RSVP_ACTION(AlternateName alternateName) {
	...
	public RSVP_ACTION(Comment comment) {
		setComment(comment);
	}
	...
	public RSVP_ACTION(Description description) {
	...
	public RSVP_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public RSVP_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public RSVP_ACTION(Error error) {
		setError(error);
	}
	...
	public RSVP_ACTION(Event event) {
		setEvent(event);
	}
	...
	public RSVP_ACTION(Identifier identifier) {
	...
	public RSVP_ACTION(Image image) {
		setImage(image);
	}
	...
	public RSVP_ACTION(InLanguage inLanguage) {
	...
	public RSVP_ACTION(Instrument instrument) {
	...
	public RSVP_ACTION(Location location) {
	...
	public RSVP_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public RSVP_ACTION(NameFuzzy nameFuzzy) {
	...
	public RSVP_ACTION(NameRuby nameRuby) {
	...
	public RSVP_ACTION(Object object) {
		setObject(object);
	}
	...
	public RSVP_ACTION(Participant participant) {
	...
	public RSVP_ACTION(PotentialAction potentialAction) {
	...
	public RSVP_ACTION(Recipient recipient) {
	...
	public RSVP_ACTION(Result result) {
		setResult(result);
	}
	...
	public RSVP_ACTION(RsvpResponse rsvpResponse) {
		setRsvpResponse(rsvpResponse);
	}

	@Override
	public RsvpResponse getRsvpResponse() {
		return rsvpResponse;
	}

	@Override
	public void setRsvpResponse(RsvpResponse rsvpResponse) {
		this.rsvpResponse = rsvpResponse;
	}

	public RSVP_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RSVP_ACTION(StartTime startTime) {
	...
	public RSVP_ACTION(SubjectOf subjectOf) {
	...
	public RSVP_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.RsvpAction org) {
		setSeq(org.getSeq());
		...
		setAdditionalNumberOfGuests(org.getAdditionalNumberOfGuests());
		...
		setRsvpResponse(org.getRsvpResponse());
