...
public class BIRTH_PLACE implements Container.BirthPlace {
	...
	public BIRTH_PLACE(String string) {
	...
	public BIRTH_PLACE(Accommodation accommodation) {
	...
	public BIRTH_PLACE(AccountingService accountingService) {
	...
	public BIRTH_PLACE(AdministrativeArea administrativeArea) {
	...
	public BIRTH_PLACE(AdultEntertainment adultEntertainment) {
	...
	public BIRTH_PLACE(Airport airport) {
	...
	public BIRTH_PLACE(AmusementPark amusementPark) {
	...
	public BIRTH_PLACE(AnimalShelter animalShelter) {
	...
	public BIRTH_PLACE(Apartment apartment) {
	...
	public BIRTH_PLACE(ApartmentComplex apartmentComplex) {
	...
	public BIRTH_PLACE(Aquarium aquarium) {
	...
	public BIRTH_PLACE(ArchiveOrganization archiveOrganization) {
	...
	public BIRTH_PLACE(ArtGallery artGallery) {
	...
	public BIRTH_PLACE(Attorney attorney) {
	...
	public BIRTH_PLACE(AutoBodyShop autoBodyShop) {
	...
	public BIRTH_PLACE(AutoDealer autoDealer) {
	...
	public BIRTH_PLACE(AutoPartsStore autoPartsStore) {
	...
	public BIRTH_PLACE(AutoRental autoRental) {
	...
	public BIRTH_PLACE(AutoRepair autoRepair) {
	...
	public BIRTH_PLACE(AutoWash autoWash) {
	...
	public BIRTH_PLACE(AutomatedTeller automatedTeller) {
	...
	public BIRTH_PLACE(AutomotiveBusiness automotiveBusiness) {
	...
	public BIRTH_PLACE(Bakery bakery) {
	...
	public BIRTH_PLACE(BankOrCreditUnion bankOrCreditUnion) {
	...
	public BIRTH_PLACE(BarOrPub barOrPub) {
	...
	public BIRTH_PLACE(Beach beach) {
	...
	public BIRTH_PLACE(BeautySalon beautySalon) {
	...
	public BIRTH_PLACE(BedAndBreakfast bedAndBreakfast) {
	...
	public BIRTH_PLACE(BikeStore bikeStore) {
	...
	public BIRTH_PLACE(BodyOfWater bodyOfWater) {
	...
	public BIRTH_PLACE(BookStore bookStore) {
	...
	public BIRTH_PLACE(BowlingAlley bowlingAlley) {
	...
	public BIRTH_PLACE(Brewery brewery) {
	...
	public BIRTH_PLACE(Bridge bridge) {
	...
	public BIRTH_PLACE(BuddhistTemple buddhistTemple) {
	...
	public BIRTH_PLACE(BusStation busStation) {
	...
	public BIRTH_PLACE(BusStop busStop) {
	...
	public BIRTH_PLACE(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public BIRTH_PLACE(Campground campground) {
	...
	public BIRTH_PLACE(CampingPitch campingPitch) {
	...
	public BIRTH_PLACE(Canal canal) {
	...
	public BIRTH_PLACE(Casino casino) {
	...
	public BIRTH_PLACE(CatholicChurch catholicChurch) {
	...
	public BIRTH_PLACE(Cemetery cemetery) {
	...
	public BIRTH_PLACE(ChildCare childCare) {
	...
	public BIRTH_PLACE(Church church) {
	...
	public BIRTH_PLACE(CityHall cityHall) {
	...
	public BIRTH_PLACE(CivicStructure civicStructure) {
	...
	public BIRTH_PLACE(ClothingStore clothingStore) {
	...
	public BIRTH_PLACE(ComedyClub comedyClub) {
	...
	public BIRTH_PLACE(CommunityHealth communityHealth) {
	...
	public BIRTH_PLACE(ComputerStore computerStore) {
	...
	public BIRTH_PLACE(Continent continent) {
	...
	public BIRTH_PLACE(ConvenienceStore convenienceStore) {
	...
	public BIRTH_PLACE(Country country) {
	...
	public BIRTH_PLACE(Courthouse courthouse) {
	...
	public BIRTH_PLACE(Crematorium crematorium) {
	...
	public BIRTH_PLACE(DaySpa daySpa) {
	...
	public BIRTH_PLACE(DefenceEstablishment defenceEstablishment) {
	...
	public BIRTH_PLACE(Dentist dentist) {
	...
	public BIRTH_PLACE(DepartmentStore departmentStore) {
	...
	public BIRTH_PLACE(Dermatology dermatology) {
	...
	public BIRTH_PLACE(DietNutrition dietNutrition) {
	...
	public BIRTH_PLACE(Distillery distillery) {
	...
	public BIRTH_PLACE(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public BIRTH_PLACE(Electrician electrician) {
	...
	public BIRTH_PLACE(ElectronicsStore electronicsStore) {
	...
	public BIRTH_PLACE(Embassy embassy) {
	...
	public BIRTH_PLACE(Emergency emergency) {
	...
	public BIRTH_PLACE(EmergencyService emergencyService) {
	...
	public BIRTH_PLACE(EmploymentAgency employmentAgency) {
	...
	public BIRTH_PLACE(EntertainmentBusiness entertainmentBusiness) {
	...
	public BIRTH_PLACE(EventVenue eventVenue) {
	...
	public BIRTH_PLACE(ExerciseGym exerciseGym) {
	...
	public BIRTH_PLACE(FastFoodRestaurant fastFoodRestaurant) {
	...
	public BIRTH_PLACE(FinancialService financialService) {
	...
	public BIRTH_PLACE(FireStation fireStation) {
	...
	public BIRTH_PLACE(Florist florist) {
	...
	public BIRTH_PLACE(FoodEstablishment foodEstablishment) {
	...
	public BIRTH_PLACE(FurnitureStore furnitureStore) {
	...
	public BIRTH_PLACE(GardenStore gardenStore) {
	...
	public BIRTH_PLACE(GasStation gasStation) {
	...
	public BIRTH_PLACE(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public BIRTH_PLACE(GeneralContractor generalContractor) {
	...
	public BIRTH_PLACE(Geriatric geriatric) {
	...
	public BIRTH_PLACE(GolfCourse golfCourse) {
	...
	public BIRTH_PLACE(GovernmentBuilding governmentBuilding) {
	...
	public BIRTH_PLACE(GovernmentOffice governmentOffice) {
	...
	public BIRTH_PLACE(GroceryStore groceryStore) {
	...
	public BIRTH_PLACE(Gynecologic gynecologic) {
	...
	public BIRTH_PLACE(HVACBusiness hvacBusiness) {
	...
	public BIRTH_PLACE(HairSalon hairSalon) {
	...
	public BIRTH_PLACE(HardwareStore hardwareStore) {
	...
	public BIRTH_PLACE(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public BIRTH_PLACE(HealthClub healthClub) {
	...
	public BIRTH_PLACE(HinduTemple hinduTemple) {
	...
	public BIRTH_PLACE(HobbyShop hobbyShop) {
	...
	public BIRTH_PLACE(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public BIRTH_PLACE(HomeGoodsStore homeGoodsStore) {
	...
	public BIRTH_PLACE(Hospital hospital) {
	...
	public BIRTH_PLACE(Hostel hostel) {
	...
	public BIRTH_PLACE(Hotel hotel) {
	...
	public BIRTH_PLACE(HotelRoom hotelRoom) {
	...
	public BIRTH_PLACE(House house) {
	...
	public BIRTH_PLACE(HousePainter housePainter) {
	...
	public BIRTH_PLACE(IceCreamShop iceCreamShop) {
	...
	public BIRTH_PLACE(InsuranceAgency insuranceAgency) {
	...
	public BIRTH_PLACE(InternetCafe internetCafe) {
	...
	public BIRTH_PLACE(JewelryStore jewelryStore) {
	...
	public BIRTH_PLACE(LakeBodyOfWater lakeBodyOfWater) {
	...
	public BIRTH_PLACE(Landform landform) {
	...
	public BIRTH_PLACE(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public BIRTH_PLACE(LegalService legalService) {
	...
	public BIRTH_PLACE(LegislativeBuilding legislativeBuilding) {
	...
	public BIRTH_PLACE(Library library) {
	...
	public BIRTH_PLACE(LiquorStore liquorStore) {
	...
	public BIRTH_PLACE(LocalBusiness localBusiness) {
	...
	public BIRTH_PLACE(Locksmith locksmith) {
	...
	public BIRTH_PLACE(LodgingBusiness lodgingBusiness) {
	...
	public BIRTH_PLACE(MedicalBusiness medicalBusiness) {
	...
	public BIRTH_PLACE(MedicalClinic medicalClinic) {
	...
	public BIRTH_PLACE(MeetingRoom meetingRoom) {
	...
	public BIRTH_PLACE(MensClothingStore mensClothingStore) {
	...
	public BIRTH_PLACE(Midwifery midwifery) {
	...
	public BIRTH_PLACE(MobilePhoneStore mobilePhoneStore) {
	...
	public BIRTH_PLACE(Mosque mosque) {
	...
	public BIRTH_PLACE(Motel motel) {
	...
	public BIRTH_PLACE(MotorcycleDealer motorcycleDealer) {
	...
	public BIRTH_PLACE(MotorcycleRepair motorcycleRepair) {
	...
	public BIRTH_PLACE(Mountain mountain) {
	...
	public BIRTH_PLACE(MovieRentalStore movieRentalStore) {
	...
	public BIRTH_PLACE(MovieTheater movieTheater) {
	...
	public BIRTH_PLACE(MovingCompany movingCompany) {
	...
	public BIRTH_PLACE(Museum museum) {
	...
	public BIRTH_PLACE(MusicStore musicStore) {
	...
	public BIRTH_PLACE(MusicVenue musicVenue) {
	...
	public BIRTH_PLACE(NailSalon nailSalon) {
	...
	public BIRTH_PLACE(NightClub nightClub) {
	...
	public BIRTH_PLACE(Notary notary) {
	...
	public BIRTH_PLACE(Nursing nursing) {
	...
	public BIRTH_PLACE(Obstetric obstetric) {
	...
	public BIRTH_PLACE(OceanBodyOfWater oceanBodyOfWater) {
	...
	public BIRTH_PLACE(OfficeEquipmentStore officeEquipmentStore) {
	...
	public BIRTH_PLACE(Oncologic oncologic) {
	...
	public BIRTH_PLACE(Optician optician) {
	...
	public BIRTH_PLACE(Optometric optometric) {
	...
	public BIRTH_PLACE(Otolaryngologic otolaryngologic) {
	...
	public BIRTH_PLACE(OutletStore outletStore) {
	...
	public BIRTH_PLACE(ParkingFacility parkingFacility) {
	...
	public BIRTH_PLACE(PawnShop pawnShop) {
	...
	public BIRTH_PLACE(Pediatric pediatric) {
	...
	public BIRTH_PLACE(PerformingArtsTheater performingArtsTheater) {
	...
	public BIRTH_PLACE(PetStore petStore) {
	...
	public BIRTH_PLACE(Pharmacy pharmacy) {
	...
	public BIRTH_PLACE(Physician physician) {
	...
	public BIRTH_PLACE(Physiotherapy physiotherapy) {
	...
	public BIRTH_PLACE(Place place) {
		placeList = new ArrayList<Place>();
		placeList.add(place);
	}
	...
	public BIRTH_PLACE(PlaceOfWorship placeOfWorship) {
	...
	public BIRTH_PLACE(PlasticSurgery plasticSurgery) {
	...
	public BIRTH_PLACE(Playground playground) {
	...
	public BIRTH_PLACE(Plumber plumber) {
	...
	public BIRTH_PLACE(Podiatric podiatric) {
	...
	public BIRTH_PLACE(PoliceStation policeStation) {
	...
	public BIRTH_PLACE(PostOffice postOffice) {
	...
	public BIRTH_PLACE(PrimaryCare primaryCare) {
	...
	public BIRTH_PLACE(ProfessionalService professionalService) {
	...
	public BIRTH_PLACE(Psychiatric psychiatric) {
	...
	public BIRTH_PLACE(PublicHealth publicHealth) {
	...
	public BIRTH_PLACE(PublicSwimmingPool publicSwimmingPool) {
	...
	public BIRTH_PLACE(PublicToilet publicToilet) {
	...
	public BIRTH_PLACE(RVPark rvPark) {
	...
	public BIRTH_PLACE(RadioStation radioStation) {
	...
	public BIRTH_PLACE(RealEstateAgent realEstateAgent) {
	...
	public BIRTH_PLACE(RecyclingCenter recyclingCenter) {
	...
	public BIRTH_PLACE(Reservoir reservoir) {
	...
	public BIRTH_PLACE(Residence residence) {
	...
	public BIRTH_PLACE(Resort resort) {
	...
	public BIRTH_PLACE(Restaurant restaurant) {
	...
	public BIRTH_PLACE(RiverBodyOfWater riverBodyOfWater) {
	...
	public BIRTH_PLACE(RoofingContractor roofingContractor) {
	...
	public BIRTH_PLACE(SeaBodyOfWater seaBodyOfWater) {
	...
	public BIRTH_PLACE(SelfStorage selfStorage) {
	...
	public BIRTH_PLACE(ShoeStore shoeStore) {
	...
	public BIRTH_PLACE(ShoppingCenter shoppingCenter) {
	...
	public BIRTH_PLACE(SingleFamilyResidence singleFamilyResidence) {
	...
	public BIRTH_PLACE(SkiResort skiResort) {
	...
	public BIRTH_PLACE(SportingGoodsStore sportingGoodsStore) {
	...
	public BIRTH_PLACE(SportsActivityLocation sportsActivityLocation) {
	...
	public BIRTH_PLACE(SportsClub sportsClub) {
	...
	public BIRTH_PLACE(StadiumOrArena stadiumOrArena) {
	...
	public BIRTH_PLACE(State state) {
	...
	public BIRTH_PLACE(Store store) {
	...
	public BIRTH_PLACE(SubwayStation subwayStation) {
	...
	public BIRTH_PLACE(Suite suite) {
	...
	public BIRTH_PLACE(Synagogue synagogue) {
	...
	public BIRTH_PLACE(TattooParlor tattooParlor) {
	...
	public BIRTH_PLACE(TaxiStand taxiStand) {
	...
	public BIRTH_PLACE(TelevisionStation televisionStation) {
	...
	public BIRTH_PLACE(TennisComplex tennisComplex) {
	...
	public BIRTH_PLACE(TireShop tireShop) {
	...
	public BIRTH_PLACE(TouristAttraction touristAttraction) {
	...
	public BIRTH_PLACE(TouristDestination touristDestination) {
	...
	public BIRTH_PLACE(TouristInformationCenter touristInformationCenter) {
	...
	public BIRTH_PLACE(ToyStore toyStore) {
	...
	public BIRTH_PLACE(TrainStation trainStation) {
	...
	public BIRTH_PLACE(TravelAgency travelAgency) {
	...
	public BIRTH_PLACE(Volcano volcano) {
	...
	public BIRTH_PLACE(Waterfall waterfall) {
	...
	public BIRTH_PLACE(WholesaleStore wholesaleStore) {
	...
	public BIRTH_PLACE(Winery winery) {
	...
	public void copy(Container.BirthPlace org) {
