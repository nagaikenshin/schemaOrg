...
public class BANK_OR_CREDIT_UNION implements Clazz.BankOrCreditUnion {
	...
	public BANK_OR_CREDIT_UNION(GeoContains geoContains) {
	...
	public BANK_OR_CREDIT_UNION(GeoCoveredBy geoCoveredBy) {
	...
	public BANK_OR_CREDIT_UNION(GeoCovers geoCovers) {
	...
	public BANK_OR_CREDIT_UNION(GeoCrosses geoCrosses) {
	...
	public BANK_OR_CREDIT_UNION(GeoDisjoint geoDisjoint) {
	...
	public BANK_OR_CREDIT_UNION(GeoEquals geoEquals) {
	...
	public BANK_OR_CREDIT_UNION(GeoIntersects geoIntersects) {
	...
	public BANK_OR_CREDIT_UNION(GeoOverlaps geoOverlaps) {
	...
	public BANK_OR_CREDIT_UNION(GeoTouches geoTouches) {
	...
	public BANK_OR_CREDIT_UNION(GeoWithin geoWithin) {
	...
	public BANK_OR_CREDIT_UNION(Slogan slogan) {
		setSlogan(slogan);
	}
