...
public class ENTERTAINMENT_BUSINESS implements Clazz.EntertainmentBusiness, Container.EntertainmentBusiness {
	...
	public ENTERTAINMENT_BUSINESS(ArchiveOrganization archiveOrganization) {
	...
	public ENTERTAINMENT_BUSINESS(GeoContains geoContains) {
	...
	public ENTERTAINMENT_BUSINESS(GeoCoveredBy geoCoveredBy) {
	...
	public ENTERTAINMENT_BUSINESS(GeoCovers geoCovers) {
	...
	public ENTERTAINMENT_BUSINESS(GeoCrosses geoCrosses) {
	...
	public ENTERTAINMENT_BUSINESS(GeoDisjoint geoDisjoint) {
	...
	public ENTERTAINMENT_BUSINESS(GeoEquals geoEquals) {
	...
	public ENTERTAINMENT_BUSINESS(GeoIntersects geoIntersects) {
	...
	public ENTERTAINMENT_BUSINESS(GeoOverlaps geoOverlaps) {
	...
	public ENTERTAINMENT_BUSINESS(GeoTouches geoTouches) {
	...
	public ENTERTAINMENT_BUSINESS(GeoWithin geoWithin) {
	...
	public ENTERTAINMENT_BUSINESS(Slogan slogan) {
		setSlogan(slogan);
	}
