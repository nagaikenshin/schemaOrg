...
public class TRAVEL_ACTION implements Clazz.TravelAction {
	...
	public TRAVEL_ACTION() {
	}

	public TRAVEL_ACTION(Long seq) {
		setSeq(seq);
	}

	public TRAVEL_ACTION(String string) {
	...
	public TRAVEL_ACTION(ActionStatus actionStatus) {
	...
	public TRAVEL_ACTION(AdditionalType additionalType) {
	...
	public TRAVEL_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public TRAVEL_ACTION(AlternateName alternateName) {
	...
	public TRAVEL_ACTION(Description description) {
	...
	public TRAVEL_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public TRAVEL_ACTION(Distance distance) {
	...
	public TRAVEL_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public TRAVEL_ACTION(Error error) {
		setError(error);
	}
	...
	public TRAVEL_ACTION(FromLocation fromLocation) {
	...
	public TRAVEL_ACTION(Identifier identifier) {
	...
	public TRAVEL_ACTION(Image image) {
		setImage(image);
	}
	...
	public TRAVEL_ACTION(Instrument instrument) {
	...
	public TRAVEL_ACTION(Location location) {
	...
	public TRAVEL_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public TRAVEL_ACTION(Name name) {
		setName(name);
	}
	...
	public TRAVEL_ACTION(NameFuzzy nameFuzzy) {
	...
	public TRAVEL_ACTION(NameRuby nameRuby) {
	...
	public TRAVEL_ACTION(Object object) {
		setObject(object);
	}
	...
	public TRAVEL_ACTION(Participant participant) {
	...
	public TRAVEL_ACTION(PotentialAction potentialAction) {
	...
	public TRAVEL_ACTION(Result result) {
		setResult(result);
	}
	...
	public TRAVEL_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TRAVEL_ACTION(StartTime startTime) {
	...
	public TRAVEL_ACTION(SubjectOf subjectOf) {
	...
	public TRAVEL_ACTION(Target target) {
		setTarget(target);
	}
	...
	public TRAVEL_ACTION(ToLocation toLocation) {
	...
	public void copy(Clazz.TravelAction org) {
		setSeq(org.getSeq());
