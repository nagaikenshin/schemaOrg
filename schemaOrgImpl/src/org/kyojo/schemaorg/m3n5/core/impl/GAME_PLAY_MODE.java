...
public class GAME_PLAY_MODE implements Clazz.GamePlayMode {
	...
	public GAME_PLAY_MODE() {
	}

	public GAME_PLAY_MODE(Long seq) {
		setSeq(seq);
	}

	public GAME_PLAY_MODE(String string) {
	...
	public GAME_PLAY_MODE(AdditionalType additionalType) {
	...
	public GAME_PLAY_MODE(AlternateName alternateName) {
	...
	public GAME_PLAY_MODE(Description description) {
	...
	public GAME_PLAY_MODE(DisambiguatingDescription disambiguatingDescription) {
	...
	public GAME_PLAY_MODE(Identifier identifier) {
	...
	public GAME_PLAY_MODE(Image image) {
		setImage(image);
	}
	...
	public GAME_PLAY_MODE(MainEntityOfPage mainEntityOfPage) {
	...
	public GAME_PLAY_MODE(Name name) {
		setName(name);
	}
	...
	public GAME_PLAY_MODE(NameFuzzy nameFuzzy) {
	...
	public GAME_PLAY_MODE(NameRuby nameRuby) {
	...
	public GAME_PLAY_MODE(PotentialAction potentialAction) {
	...
	public GAME_PLAY_MODE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public GAME_PLAY_MODE(SubjectOf subjectOf) {
	...
	public GAME_PLAY_MODE(SupersededBy supersededBy) {
	...
	public void copy(Clazz.GamePlayMode org) {
		setSeq(org.getSeq());
