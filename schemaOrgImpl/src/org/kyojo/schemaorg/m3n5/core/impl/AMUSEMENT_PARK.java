...
public class AMUSEMENT_PARK implements Clazz.AmusementPark {
	...
	public AMUSEMENT_PARK(GeoContains geoContains) {
	...
	public AMUSEMENT_PARK(GeoCoveredBy geoCoveredBy) {
	...
	public AMUSEMENT_PARK(GeoCovers geoCovers) {
	...
	public AMUSEMENT_PARK(GeoCrosses geoCrosses) {
	...
	public AMUSEMENT_PARK(GeoDisjoint geoDisjoint) {
	...
	public AMUSEMENT_PARK(GeoEquals geoEquals) {
	...
	public AMUSEMENT_PARK(GeoIntersects geoIntersects) {
	...
	public AMUSEMENT_PARK(GeoOverlaps geoOverlaps) {
	...
	public AMUSEMENT_PARK(GeoTouches geoTouches) {
	...
	public AMUSEMENT_PARK(GeoWithin geoWithin) {
	...
	public AMUSEMENT_PARK(Slogan slogan) {
		setSlogan(slogan);
	}
