...
public class REPRESENTATIVE_OF_PAGE implements Container.RepresentativeOfPage {
	...
	public REPRESENTATIVE_OF_PAGE(java.lang.Boolean b00lean) {
		this(new BOOLEAN(b00lean));
	}

	public REPRESENTATIVE_OF_PAGE(Boolean b00lean) {
