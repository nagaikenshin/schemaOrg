...
public class SYNAGOGUE implements Clazz.Synagogue {
	...
	public SYNAGOGUE(GeoContains geoContains) {
	...
	public SYNAGOGUE(GeoCoveredBy geoCoveredBy) {
	...
	public SYNAGOGUE(GeoCovers geoCovers) {
	...
	public SYNAGOGUE(GeoCrosses geoCrosses) {
	...
	public SYNAGOGUE(GeoDisjoint geoDisjoint) {
	...
	public SYNAGOGUE(GeoEquals geoEquals) {
	...
	public SYNAGOGUE(GeoIntersects geoIntersects) {
	...
	public SYNAGOGUE(GeoOverlaps geoOverlaps) {
	...
	public SYNAGOGUE(GeoTouches geoTouches) {
	...
	public SYNAGOGUE(GeoWithin geoWithin) {
	...
	public SYNAGOGUE(Slogan slogan) {
		setSlogan(slogan);
	}
