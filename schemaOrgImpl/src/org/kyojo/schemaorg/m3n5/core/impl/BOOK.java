...
public class BOOK implements Clazz.Book {
	...
	public BOOK(AccessMode accessMode) {
	...
	public BOOK(AccessModeSufficient accessModeSufficient) {
	...
	public BOOK(AccessibilityAPI accessibilityAPI) {
	...
	public BOOK(AccessibilityControl accessibilityControl) {
	...
	public BOOK(AccessibilityFeature accessibilityFeature) {
	...
	public BOOK(AccessibilityHazard accessibilityHazard) {
	...
	public BOOK(AccessibilitySummary accessibilitySummary) {
	...
	public BOOK(AccountablePerson accountablePerson) {
	...
	public BOOK(AdditionalType additionalType) {
	...
	public BOOK(AggregateRating aggregateRating) {
	...
	public BOOK(AlternateName alternateName) {
	...
	public BOOK(AlternativeHeadline alternativeHeadline) {
	...
	public BOOK(AssociatedMedia associatedMedia) {
	...
	public BOOK(BookEdition bookEdition) {
	...
	public BOOK(Character character) {
	...
	public BOOK(CommentCount commentCount) {
	...
	public BOOK(ContentLocation contentLocation) {
	...
	public BOOK(ContentRating contentRating) {
	...
	public BOOK(ContentReferenceTime contentReferenceTime) {
	...
	public BOOK(Contributor contributor) {
	...
	public BOOK(CopyrightHolder copyrightHolder) {
	...
	public BOOK(CopyrightYear copyrightYear) {
	...
	public BOOK(Correction correction) {
	...
	public BOOK(DateCreated dateCreated) {
	...
	public BOOK(DateModified dateModified) {
	...
	public BOOK(DatePublished datePublished) {
	...
	public BOOK(Description description) {
	...
	public BOOK(DisambiguatingDescription disambiguatingDescription) {
	...
	public BOOK(DiscussionUrl discussionUrl) {
	...
	public BOOK(EducationalAlignment educationalAlignment) {
	...
	public BOOK(EducationalUse educationalUse) {
	...
	public BOOK(EncodingFormat encodingFormat) {
	...
	public BOOK(ExampleOfWork exampleOfWork) {
	...
	public BOOK(Identifier identifier) {
	...
	public BOOK(Illustrator illustrator) {
	...
	public BOOK(InLanguage inLanguage) {
	...
	public BOOK(InteractionStatistic interactionStatistic) {
	...
	public BOOK(InteractivityType interactivityType) {
	...
	public BOOK(IsAccessibleForFree isAccessibleForFree) {
	...
	public BOOK(IsBasedOn isBasedOn) {
	...
	public BOOK(IsFamilyFriendly isFamilyFriendly) {
	...
	public BOOK(LearningResourceType learningResourceType) {
	...
	public BOOK(LocationCreated locationCreated) {
	...
	public BOOK(MainEntity mainEntity) {
	...
	public BOOK(MainEntityOfPage mainEntityOfPage) {
	...
	public BOOK(MaterialExtent materialExtent) {
	...
	public BOOK(NameFuzzy nameFuzzy) {
	...
	public BOOK(NumberOfPages numberOfPages) {
	...
	public BOOK(PotentialAction potentialAction) {
	...
	public BOOK(PublisherImprint publisherImprint) {
	...
	public BOOK(PublishingPrinciples publishingPrinciples) {
	...
	public BOOK(RecordedAt recordedAt) {
	...
	public BOOK(ReleasedEvent releasedEvent) {
	...
	public BOOK(SchemaVersion schemaVersion) {
	...
	public BOOK(SdDatePublished sdDatePublished) {
	...
	public BOOK(SdLicense sdLicense) {
	...
	public BOOK(SdPublisher sdPublisher) {
	...
	public BOOK(SourceOrganization sourceOrganization) {
	...
	public BOOK(SpatialCoverage spatialCoverage) {
	...
	public BOOK(SubjectOf subjectOf) {
	...
	public BOOK(TemporalCoverage temporalCoverage) {
	...
	public BOOK(ThumbnailUrl thumbnailUrl) {
	...
	public BOOK(TimeRequired timeRequired) {
	...
	public BOOK(TranslationOfWork translationOfWork) {
	...
	public BOOK(Translator translator) {
	...
	public BOOK(TypicalAgeRange typicalAgeRange) {
	...
	public BOOK(WorkExample workExample) {
	...
	public BOOK(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Book org) {
		setSeq(org.getSeq());
