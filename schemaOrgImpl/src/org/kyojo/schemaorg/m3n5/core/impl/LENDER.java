...
public class LENDER implements Container.Lender {
	...
	public LENDER(AccountingService accountingService) {
	...
	public LENDER(AdultEntertainment adultEntertainment) {
	...
	public LENDER(AmusementPark amusementPark) {
	...
	public LENDER(AnimalShelter animalShelter) {
	...
	public LENDER(ArchiveOrganization archiveOrganization) {
	...
	public LENDER(ArtGallery artGallery) {
	...
	public LENDER(Attorney attorney) {
	...
	public LENDER(AutoBodyShop autoBodyShop) {
	...
	public LENDER(AutoDealer autoDealer) {
	...
	public LENDER(AutoPartsStore autoPartsStore) {
	...
	public LENDER(AutoRental autoRental) {
	...
	public LENDER(AutoRepair autoRepair) {
	...
	public LENDER(AutoWash autoWash) {
	...
	public LENDER(AutomatedTeller automatedTeller) {
	...
	public LENDER(AutomotiveBusiness automotiveBusiness) {
	...
	public LENDER(BankOrCreditUnion bankOrCreditUnion) {
	...
	public LENDER(BarOrPub barOrPub) {
	...
	public LENDER(BeautySalon beautySalon) {
	...
	public LENDER(BedAndBreakfast bedAndBreakfast) {
	...
	public LENDER(BikeStore bikeStore) {
	...
	public LENDER(BookStore bookStore) {
	...
	public LENDER(BowlingAlley bowlingAlley) {
	...
	public LENDER(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public LENDER(Campground campground) {
	...
	public LENDER(ChildCare childCare) {
	...
	public LENDER(ClothingStore clothingStore) {
	...
	public LENDER(CollegeOrUniversity collegeOrUniversity) {
	...
	public LENDER(ComedyClub comedyClub) {
	...
	public LENDER(CommunityHealth communityHealth) {
	...
	public LENDER(ComputerStore computerStore) {
	...
	public LENDER(Consortium consortium) {
	...
	public LENDER(ConvenienceStore convenienceStore) {
	...
	public LENDER(Corporation corporation) {
	...
	public LENDER(DanceGroup danceGroup) {
	...
	public LENDER(DepartmentStore departmentStore) {
	...
	public LENDER(Dermatology dermatology) {
	...
	public LENDER(DiagnosticLab diagnosticLab) {
	...
	public LENDER(DietNutrition dietNutrition) {
	...
	public LENDER(Distillery distillery) {
	...
	public LENDER(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public LENDER(EducationalOrganization educationalOrganization) {
	...
	public LENDER(Electrician electrician) {
	...
	public LENDER(ElectronicsStore electronicsStore) {
	...
	public LENDER(ElementarySchool elementarySchool) {
	...
	public LENDER(Emergency emergency) {
	...
	public LENDER(EmergencyService emergencyService) {
	...
	public LENDER(EmploymentAgency employmentAgency) {
	...
	public LENDER(EntertainmentBusiness entertainmentBusiness) {
	...
	public LENDER(ExerciseGym exerciseGym) {
	...
	public LENDER(FastFoodRestaurant fastFoodRestaurant) {
	...
	public LENDER(FinancialService financialService) {
	...
	public LENDER(FireStation fireStation) {
	...
	public LENDER(FoodEstablishment foodEstablishment) {
	...
	public LENDER(FundingAgency fundingAgency) {
	...
	public LENDER(FundingScheme fundingScheme) {
	...
	public LENDER(FurnitureStore furnitureStore) {
	...
	public LENDER(GardenStore gardenStore) {
	...
	public LENDER(GasStation gasStation) {
	...
	public LENDER(GeneralContractor generalContractor) {
	...
	public LENDER(Geriatric geriatric) {
	...
	public LENDER(GolfCourse golfCourse) {
	...
	public LENDER(GovernmentOffice governmentOffice) {
	...
	public LENDER(GovernmentOrganization governmentOrganization) {
	...
	public LENDER(GroceryStore groceryStore) {
	...
	public LENDER(Gynecologic gynecologic) {
	...
	public LENDER(HVACBusiness hvacBusiness) {
	...
	public LENDER(HairSalon hairSalon) {
	...
	public LENDER(HardwareStore hardwareStore) {
	...
	public LENDER(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public LENDER(HealthClub healthClub) {
	...
	public LENDER(HighSchool highSchool) {
	...
	public LENDER(HobbyShop hobbyShop) {
	...
	public LENDER(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public LENDER(HomeGoodsStore homeGoodsStore) {
	...
	public LENDER(Hospital hospital) {
	...
	public LENDER(HousePainter housePainter) {
	...
	public LENDER(IceCreamShop iceCreamShop) {
	...
	public LENDER(InsuranceAgency insuranceAgency) {
	...
	public LENDER(InternetCafe internetCafe) {
	...
	public LENDER(JewelryStore jewelryStore) {
	...
	public LENDER(LegalService legalService) {
	...
	public LENDER(LibrarySystem librarySystem) {
	...
	public LENDER(LiquorStore liquorStore) {
	...
	public LENDER(LocalBusiness localBusiness) {
	...
	public LENDER(Locksmith locksmith) {
	...
	public LENDER(LodgingBusiness lodgingBusiness) {
	...
	public LENDER(MedicalBusiness medicalBusiness) {
	...
	public LENDER(MedicalClinic medicalClinic) {
	...
	public LENDER(MedicalOrganization medicalOrganization) {
	...
	public LENDER(MensClothingStore mensClothingStore) {
	...
	public LENDER(MiddleSchool middleSchool) {
	...
	public LENDER(Midwifery midwifery) {
	...
	public LENDER(MobilePhoneStore mobilePhoneStore) {
	...
	public LENDER(MotorcycleDealer motorcycleDealer) {
	...
	public LENDER(MotorcycleRepair motorcycleRepair) {
	...
	public LENDER(MovieRentalStore movieRentalStore) {
	...
	public LENDER(MovieTheater movieTheater) {
	...
	public LENDER(MovingCompany movingCompany) {
	...
	public LENDER(MusicGroup musicGroup) {
	...
	public LENDER(MusicStore musicStore) {
	...
	public LENDER(NailSalon nailSalon) {
	...
	public LENDER(NewsMediaOrganization newsMediaOrganization) {
	...
	public LENDER(NightClub nightClub) {
	...
	public LENDER(Obstetric obstetric) {
	...
	public LENDER(OfficeEquipmentStore officeEquipmentStore) {
	...
	public LENDER(Oncologic oncologic) {
	...
	public LENDER(Optician optician) {
	...
	public LENDER(Optometric optometric) {
	...
	public LENDER(Organization organization) {
		organizationList = new ArrayList<Organization>();
	...
	public LENDER(Otolaryngologic otolaryngologic) {
	...
	public LENDER(OutletStore outletStore) {
	...
	public LENDER(PawnShop pawnShop) {
	...
	public LENDER(Pediatric pediatric) {
	...
	public LENDER(PerformingGroup performingGroup) {
	...
	public LENDER(PetStore petStore) {
	...
	public LENDER(Pharmacy pharmacy) {
	...
	public LENDER(Physician physician) {
	...
	public LENDER(Physiotherapy physiotherapy) {
	...
	public LENDER(PlasticSurgery plasticSurgery) {
	...
	public LENDER(Podiatric podiatric) {
	...
	public LENDER(PoliceStation policeStation) {
	...
	public LENDER(PostOffice postOffice) {
	...
	public LENDER(Preschool preschool) {
	...
	public LENDER(PrimaryCare primaryCare) {
	...
	public LENDER(ProfessionalService professionalService) {
	...
	public LENDER(Psychiatric psychiatric) {
	...
	public LENDER(PublicHealth publicHealth) {
	...
	public LENDER(PublicSwimmingPool publicSwimmingPool) {
	...
	public LENDER(RadioStation radioStation) {
	...
	public LENDER(RealEstateAgent realEstateAgent) {
	...
	public LENDER(RecyclingCenter recyclingCenter) {
	...
	public LENDER(ResearchProject researchProject) {
	...
	public LENDER(Restaurant restaurant) {
	...
	public LENDER(RoofingContractor roofingContractor) {
	...
	public LENDER(SelfStorage selfStorage) {
	...
	public LENDER(ShoeStore shoeStore) {
	...
	public LENDER(ShoppingCenter shoppingCenter) {
	...
	public LENDER(SkiResort skiResort) {
	...
	public LENDER(SportingGoodsStore sportingGoodsStore) {
	...
	public LENDER(SportsActivityLocation sportsActivityLocation) {
	...
	public LENDER(SportsClub sportsClub) {
	...
	public LENDER(SportsOrganization sportsOrganization) {
	...
	public LENDER(SportsTeam sportsTeam) {
	...
	public LENDER(StadiumOrArena stadiumOrArena) {
	...
	public LENDER(TattooParlor tattooParlor) {
	...
	public LENDER(TelevisionStation televisionStation) {
	...
	public LENDER(TennisComplex tennisComplex) {
	...
	public LENDER(TheaterGroup theaterGroup) {
	...
	public LENDER(TireShop tireShop) {
	...
	public LENDER(TouristInformationCenter touristInformationCenter) {
	...
	public LENDER(ToyStore toyStore) {
	...
	public LENDER(TravelAgency travelAgency) {
	...
	public LENDER(VeterinaryCare veterinaryCare) {
	...
	public LENDER(WholesaleStore wholesaleStore) {
	...
	public LENDER(WorkersUnion workersUnion) {
	...
	public void copy(Container.Lender org) {
