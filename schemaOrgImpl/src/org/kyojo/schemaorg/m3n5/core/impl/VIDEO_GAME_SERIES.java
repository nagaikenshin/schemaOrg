...
public class VIDEO_GAME_SERIES implements Clazz.VideoGameSeries {
	...
	public VIDEO_GAME_SERIES(Correction correction) {
	...
	public VIDEO_GAME_SERIES(EncodingFormat encodingFormat) {
	...
	public VIDEO_GAME_SERIES(MaterialExtent materialExtent) {
	...
	public VIDEO_GAME_SERIES(SdDatePublished sdDatePublished) {
	...
	public VIDEO_GAME_SERIES(SdLicense sdLicense) {
	...
	public VIDEO_GAME_SERIES(SdPublisher sdPublisher) {
	...
	public VIDEO_GAME_SERIES(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public VIDEO_GAME_SERIES(SubjectOf subjectOf) {
	...
	public VIDEO_GAME_SERIES(Temporal temporal) {
