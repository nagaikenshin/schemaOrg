...
public class SHOPPING_CENTER implements Clazz.ShoppingCenter {
	...
	public SHOPPING_CENTER(GeoContains geoContains) {
	...
	public SHOPPING_CENTER(GeoCoveredBy geoCoveredBy) {
	...
	public SHOPPING_CENTER(GeoCovers geoCovers) {
	...
	public SHOPPING_CENTER(GeoCrosses geoCrosses) {
	...
	public SHOPPING_CENTER(GeoDisjoint geoDisjoint) {
	...
	public SHOPPING_CENTER(GeoEquals geoEquals) {
	...
	public SHOPPING_CENTER(GeoIntersects geoIntersects) {
	...
	public SHOPPING_CENTER(GeoOverlaps geoOverlaps) {
	...
	public SHOPPING_CENTER(GeoTouches geoTouches) {
	...
	public SHOPPING_CENTER(GeoWithin geoWithin) {
	...
	public SHOPPING_CENTER(Slogan slogan) {
		setSlogan(slogan);
	}
