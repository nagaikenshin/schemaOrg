...
public class CHILD_CARE implements Clazz.ChildCare {
	...
	public CHILD_CARE(GeoContains geoContains) {
	...
	public CHILD_CARE(GeoCoveredBy geoCoveredBy) {
	...
	public CHILD_CARE(GeoCovers geoCovers) {
	...
	public CHILD_CARE(GeoCrosses geoCrosses) {
	...
	public CHILD_CARE(GeoDisjoint geoDisjoint) {
	...
	public CHILD_CARE(GeoEquals geoEquals) {
	...
	public CHILD_CARE(GeoIntersects geoIntersects) {
	...
	public CHILD_CARE(GeoOverlaps geoOverlaps) {
	...
	public CHILD_CARE(GeoTouches geoTouches) {
	...
	public CHILD_CARE(GeoWithin geoWithin) {
	...
	public CHILD_CARE(Slogan slogan) {
		setSlogan(slogan);
	}
