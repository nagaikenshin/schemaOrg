...
public class GOLF_COURSE implements Clazz.GolfCourse {
	...
	public GOLF_COURSE(GeoContains geoContains) {
	...
	public GOLF_COURSE(GeoCoveredBy geoCoveredBy) {
	...
	public GOLF_COURSE(GeoCovers geoCovers) {
	...
	public GOLF_COURSE(GeoCrosses geoCrosses) {
	...
	public GOLF_COURSE(GeoDisjoint geoDisjoint) {
	...
	public GOLF_COURSE(GeoEquals geoEquals) {
	...
	public GOLF_COURSE(GeoIntersects geoIntersects) {
	...
	public GOLF_COURSE(GeoOverlaps geoOverlaps) {
	...
	public GOLF_COURSE(GeoTouches geoTouches) {
	...
	public GOLF_COURSE(GeoWithin geoWithin) {
	...
	public GOLF_COURSE(Slogan slogan) {
		setSlogan(slogan);
	}
