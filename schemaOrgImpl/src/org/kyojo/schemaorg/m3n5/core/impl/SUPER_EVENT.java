...
public class SUPER_EVENT implements Container.SuperEvent {
	...
	public SUPER_EVENT(String string) {
	...
	public SUPER_EVENT(BroadcastEvent broadcastEvent) {
	...
	public SUPER_EVENT(BusinessEvent businessEvent) {
	...
	public SUPER_EVENT(ChildrensEvent childrensEvent) {
	...
	public SUPER_EVENT(ComedyEvent comedyEvent) {
	...
	public SUPER_EVENT(CourseInstance courseInstance) {
	...
	public SUPER_EVENT(DanceEvent danceEvent) {
	...
	public SUPER_EVENT(DeliveryEvent deliveryEvent) {
	...
	public SUPER_EVENT(EducationEvent educationEvent) {
	...
	public SUPER_EVENT(Event event) {
		eventList = new ArrayList<Event>();
		eventList.add(event);
	}
	...
	public SUPER_EVENT(EventSeries eventSeries) {
	...
	public SUPER_EVENT(ExhibitionEvent exhibitionEvent) {
	...
	public SUPER_EVENT(Festival festival) {
	...
	public SUPER_EVENT(FoodEvent foodEvent) {
	...
	public SUPER_EVENT(LiteraryEvent literaryEvent) {
	...
	public SUPER_EVENT(MusicEvent musicEvent) {
	...
	public SUPER_EVENT(OnDemandEvent onDemandEvent) {
	...
	public SUPER_EVENT(PublicationEvent publicationEvent) {
	...
	public SUPER_EVENT(SaleEvent saleEvent) {
	...
	public SUPER_EVENT(ScreeningEvent screeningEvent) {
	...
	public SUPER_EVENT(SocialEvent socialEvent) {
	...
	public SUPER_EVENT(SportsEvent sportsEvent) {
	...
	public SUPER_EVENT(TheaterEvent theaterEvent) {
	...
	public SUPER_EVENT(VisualArtsEvent visualArtsEvent) {
	...
	public void copy(Container.SuperEvent org) {
