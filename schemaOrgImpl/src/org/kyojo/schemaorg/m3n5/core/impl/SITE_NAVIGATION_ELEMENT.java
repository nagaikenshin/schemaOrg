...
public class SITE_NAVIGATION_ELEMENT implements Clazz.SiteNavigationElement {
	...
	public SITE_NAVIGATION_ELEMENT() {
	}

	public SITE_NAVIGATION_ELEMENT(Long seq) {
		setSeq(seq);
	}

	public SITE_NAVIGATION_ELEMENT(String string) {
	...
	public SITE_NAVIGATION_ELEMENT(About about) {
		setAbout(about);
	}
	...
	public SITE_NAVIGATION_ELEMENT(AccessMode accessMode) {
	...
	public SITE_NAVIGATION_ELEMENT(AccessModeSufficient accessModeSufficient) {
	...
	public SITE_NAVIGATION_ELEMENT(AccessibilityAPI accessibilityAPI) {
	...
	public SITE_NAVIGATION_ELEMENT(AccessibilityControl accessibilityControl) {
	...
	public SITE_NAVIGATION_ELEMENT(AccessibilityFeature accessibilityFeature) {
	...
	public SITE_NAVIGATION_ELEMENT(AccessibilityHazard accessibilityHazard) {
	...
	public SITE_NAVIGATION_ELEMENT(AccessibilitySummary accessibilitySummary) {
	...
	public SITE_NAVIGATION_ELEMENT(AccountablePerson accountablePerson) {
	...
	public SITE_NAVIGATION_ELEMENT(AdditionalType additionalType) {
	...
	public SITE_NAVIGATION_ELEMENT(AggregateRating aggregateRating) {
	...
	public SITE_NAVIGATION_ELEMENT(AlternateName alternateName) {
	...
	public SITE_NAVIGATION_ELEMENT(AlternativeHeadline alternativeHeadline) {
	...
	public SITE_NAVIGATION_ELEMENT(AssociatedMedia associatedMedia) {
	...
	public SITE_NAVIGATION_ELEMENT(Audience audience) {
	...
	public SITE_NAVIGATION_ELEMENT(Audio audio) {
		setAudio(audio);
	}
	...
	public SITE_NAVIGATION_ELEMENT(Author author) {
		setAuthor(author);
	}
	...
	public SITE_NAVIGATION_ELEMENT(Award award) {
		setAward(award);
	}
	...
	public SITE_NAVIGATION_ELEMENT(Character character) {
	...
	public SITE_NAVIGATION_ELEMENT(Citation citation) {
	...
	public SITE_NAVIGATION_ELEMENT(Comment comment) {
		setComment(comment);
	}
	...
	public SITE_NAVIGATION_ELEMENT(CommentCount commentCount) {
	...
	public SITE_NAVIGATION_ELEMENT(ContentLocation contentLocation) {
	...
	public SITE_NAVIGATION_ELEMENT(ContentRating contentRating) {
	...
	public SITE_NAVIGATION_ELEMENT(ContentReferenceTime contentReferenceTime) {
	...
	public SITE_NAVIGATION_ELEMENT(Contributor contributor) {
	...
	public SITE_NAVIGATION_ELEMENT(CopyrightHolder copyrightHolder) {
	...
	public SITE_NAVIGATION_ELEMENT(CopyrightYear copyrightYear) {
	...
	public SITE_NAVIGATION_ELEMENT(Correction correction) {
	...
	public SITE_NAVIGATION_ELEMENT(Creator creator) {
		setCreator(creator);
	}
	...
	public SITE_NAVIGATION_ELEMENT(CssSelector cssSelector) {
	...
	public SITE_NAVIGATION_ELEMENT(DateCreated dateCreated) {
	...
	public SITE_NAVIGATION_ELEMENT(DateModified dateModified) {
	...
	public SITE_NAVIGATION_ELEMENT(DatePublished datePublished) {
	...
	public SITE_NAVIGATION_ELEMENT(Description description) {
	...
	public SITE_NAVIGATION_ELEMENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public SITE_NAVIGATION_ELEMENT(DiscussionUrl discussionUrl) {
	...
	public SITE_NAVIGATION_ELEMENT(Editor editor) {
		setEditor(editor);
	}
	...
	public SITE_NAVIGATION_ELEMENT(EducationalAlignment educationalAlignment) {
	...
	public SITE_NAVIGATION_ELEMENT(EducationalUse educationalUse) {
	...
	public SITE_NAVIGATION_ELEMENT(Encoding encoding) {
	...
	public SITE_NAVIGATION_ELEMENT(EncodingFormat encodingFormat) {
	...
	public SITE_NAVIGATION_ELEMENT(ExampleOfWork exampleOfWork) {
	...
	public SITE_NAVIGATION_ELEMENT(Expires expires) {
		setExpires(expires);
	}
	...
	public SITE_NAVIGATION_ELEMENT(Funder funder) {
		setFunder(funder);
	}
	...
	public SITE_NAVIGATION_ELEMENT(Genre genre) {
		setGenre(genre);
	}
	...
	public SITE_NAVIGATION_ELEMENT(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public SITE_NAVIGATION_ELEMENT(Headline headline) {
	...
	public SITE_NAVIGATION_ELEMENT(Identifier identifier) {
	...
	public SITE_NAVIGATION_ELEMENT(Image image) {
		setImage(image);
	}
	...
	public SITE_NAVIGATION_ELEMENT(InLanguage inLanguage) {
	...
	public SITE_NAVIGATION_ELEMENT(InteractionStatistic interactionStatistic) {
	...
	public SITE_NAVIGATION_ELEMENT(InteractivityType interactivityType) {
	...
	public SITE_NAVIGATION_ELEMENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public SITE_NAVIGATION_ELEMENT(IsBasedOn isBasedOn) {
	...
	public SITE_NAVIGATION_ELEMENT(IsFamilyFriendly isFamilyFriendly) {
	...
	public SITE_NAVIGATION_ELEMENT(IsPartOf isPartOf) {
	...
	public SITE_NAVIGATION_ELEMENT(Keywords keywords) {
	...
	public SITE_NAVIGATION_ELEMENT(LearningResourceType learningResourceType) {
	...
	public SITE_NAVIGATION_ELEMENT(License license) {
		setLicense(license);
	}
	...
	public SITE_NAVIGATION_ELEMENT(LocationCreated locationCreated) {
	...
	public SITE_NAVIGATION_ELEMENT(MainEntity mainEntity) {
	...
	public SITE_NAVIGATION_ELEMENT(MainEntityOfPage mainEntityOfPage) {
	...
	public SITE_NAVIGATION_ELEMENT(Material material) {
	...
	public SITE_NAVIGATION_ELEMENT(MaterialExtent materialExtent) {
	...
	public SITE_NAVIGATION_ELEMENT(Mentions mentions) {
	...
	public SITE_NAVIGATION_ELEMENT(Name name) {
		setName(name);
	}
	...
	public SITE_NAVIGATION_ELEMENT(NameFuzzy nameFuzzy) {
	...
	public SITE_NAVIGATION_ELEMENT(NameRuby nameRuby) {
	...
	public SITE_NAVIGATION_ELEMENT(Offers offers) {
		setOffers(offers);
	}
	...
	public SITE_NAVIGATION_ELEMENT(Position position) {
	...
	public SITE_NAVIGATION_ELEMENT(PotentialAction potentialAction) {
	...
	public SITE_NAVIGATION_ELEMENT(Producer producer) {
	...
	public SITE_NAVIGATION_ELEMENT(Provider provider) {
	...
	public SITE_NAVIGATION_ELEMENT(Publication publication) {
	...
	public SITE_NAVIGATION_ELEMENT(Publisher publisher) {
	...
	public SITE_NAVIGATION_ELEMENT(PublisherImprint publisherImprint) {
	...
	public SITE_NAVIGATION_ELEMENT(PublishingPrinciples publishingPrinciples) {
	...
	public SITE_NAVIGATION_ELEMENT(RecordedAt recordedAt) {
	...
	public SITE_NAVIGATION_ELEMENT(ReleasedEvent releasedEvent) {
	...
	public SITE_NAVIGATION_ELEMENT(Review review) {
		setReview(review);
	}
	...
	public SITE_NAVIGATION_ELEMENT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SITE_NAVIGATION_ELEMENT(SchemaVersion schemaVersion) {
	...
	public SITE_NAVIGATION_ELEMENT(SdDatePublished sdDatePublished) {
	...
	public SITE_NAVIGATION_ELEMENT(SdLicense sdLicense) {
	...
	public SITE_NAVIGATION_ELEMENT(SdPublisher sdPublisher) {
	...
	public SITE_NAVIGATION_ELEMENT(SourceOrganization sourceOrganization) {
	...
	public SITE_NAVIGATION_ELEMENT(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public SITE_NAVIGATION_ELEMENT(SpatialCoverage spatialCoverage) {
	...
	public SITE_NAVIGATION_ELEMENT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public SITE_NAVIGATION_ELEMENT(SubjectOf subjectOf) {
	...
	public SITE_NAVIGATION_ELEMENT(Temporal temporal) {
	...
	public SITE_NAVIGATION_ELEMENT(TemporalCoverage temporalCoverage) {
	...
	public SITE_NAVIGATION_ELEMENT(Text text) {
		setText(text);
	}
	...
	public SITE_NAVIGATION_ELEMENT(ThumbnailUrl thumbnailUrl) {
	...
	public SITE_NAVIGATION_ELEMENT(TimeRequired timeRequired) {
	...
	public SITE_NAVIGATION_ELEMENT(TranslationOfWork translationOfWork) {
	...
	public SITE_NAVIGATION_ELEMENT(Translator translator) {
	...
	public SITE_NAVIGATION_ELEMENT(TypicalAgeRange typicalAgeRange) {
	...
	public SITE_NAVIGATION_ELEMENT(Url url) {
		setUrl(url);
	}
	...
	public SITE_NAVIGATION_ELEMENT(Version version) {
		setVersion(version);
	}
	...
	public SITE_NAVIGATION_ELEMENT(Video video) {
		setVideo(video);
	}
	...
	public SITE_NAVIGATION_ELEMENT(WorkExample workExample) {
	...
	public SITE_NAVIGATION_ELEMENT(WorkTranslation workTranslation) {
	...
	public SITE_NAVIGATION_ELEMENT(Xpath xpath) {
		setXpath(xpath);
	}
	...
	public void copy(Clazz.SiteNavigationElement org) {
		setSeq(org.getSeq());
		...
		setCssSelector(org.getCssSelector());
