...
public class NGO implements Clazz.NGO {
	...
	public NGO(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public NGO(AdditionalType additionalType) {
	...
	public NGO(AggregateRating aggregateRating) {
	...
	public NGO(AlternateName alternateName) {
	...
	public NGO(AreaServed areaServed) {
	...
	public NGO(ContactPoint contactPoint) {
	...
	public NGO(CorrectionsPolicy correctionsPolicy) {
	...
	public NGO(Department department) {
	...
	public NGO(Description description) {
	...
	public NGO(DisambiguatingDescription disambiguatingDescription) {
	...
	public NGO(DissolutionDate dissolutionDate) {
	...
	public NGO(DiversityPolicy diversityPolicy) {
	...
	public NGO(DiversityStaffingReport diversityStaffingReport) {
	...
	public NGO(EthicsPolicy ethicsPolicy) {
	...
	public NGO(FaxNumber faxNumber) {
	...
	public NGO(FoundingDate foundingDate) {
	...
	public NGO(FoundingLocation foundingLocation) {
	...
	public NGO(GlobalLocationNumber globalLocationNumber) {
	...
	public NGO(HasOfferCatalog hasOfferCatalog) {
	...
	public NGO(Identifier identifier) {
	...
	public NGO(KnowsAbout knowsAbout) {
	...
	public NGO(KnowsLanguage knowsLanguage) {
	...
	public NGO(LegalName legalName) {
	...
	public NGO(MainEntityOfPage mainEntityOfPage) {
	...
	public NGO(MakesOffer makesOffer) {
	...
	public NGO(NameFuzzy nameFuzzy) {
	...
	public NGO(NumberOfEmployees numberOfEmployees) {
	...
	public NGO(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public NGO(ParentOrganization parentOrganization) {
	...
	public NGO(PotentialAction potentialAction) {
	...
	public NGO(PublishingPrinciples publishingPrinciples) {
	...
	public NGO(SubOrganization subOrganization) {
	...
	public NGO(SubjectOf subjectOf) {
	...
	public NGO(Telephone telephone) {
	...
	public NGO(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.NGO org) {
		setSeq(org.getSeq());
