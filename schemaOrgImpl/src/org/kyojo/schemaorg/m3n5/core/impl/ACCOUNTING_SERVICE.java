...
public class ACCOUNTING_SERVICE implements Clazz.AccountingService {
	...
	public ACCOUNTING_SERVICE(GeoContains geoContains) {
	...
	public ACCOUNTING_SERVICE(GeoCoveredBy geoCoveredBy) {
	...
	public ACCOUNTING_SERVICE(GeoCovers geoCovers) {
	...
	public ACCOUNTING_SERVICE(GeoCrosses geoCrosses) {
	...
	public ACCOUNTING_SERVICE(GeoDisjoint geoDisjoint) {
	...
	public ACCOUNTING_SERVICE(GeoEquals geoEquals) {
	...
	public ACCOUNTING_SERVICE(GeoIntersects geoIntersects) {
	...
	public ACCOUNTING_SERVICE(GeoOverlaps geoOverlaps) {
	...
	public ACCOUNTING_SERVICE(GeoTouches geoTouches) {
	...
	public ACCOUNTING_SERVICE(GeoWithin geoWithin) {
	...
	public ACCOUNTING_SERVICE(Slogan slogan) {
		setSlogan(slogan);
	}
