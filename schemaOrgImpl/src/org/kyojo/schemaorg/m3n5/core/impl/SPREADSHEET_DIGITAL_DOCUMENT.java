...
public class SPREADSHEET_DIGITAL_DOCUMENT implements Clazz.SpreadsheetDigitalDocument {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT() {
	}

	public SPREADSHEET_DIGITAL_DOCUMENT(Long seq) {
		setSeq(seq);
	}

	public SPREADSHEET_DIGITAL_DOCUMENT(String string) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(About about) {
		setAbout(about);
	}
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(AccessMode accessMode) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(AccessModeSufficient accessModeSufficient) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(AccessibilityAPI accessibilityAPI) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(AccessibilityControl accessibilityControl) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(AccessibilityFeature accessibilityFeature) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(AccessibilityHazard accessibilityHazard) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(AccessibilitySummary accessibilitySummary) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(AccountablePerson accountablePerson) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(AdditionalType additionalType) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(AggregateRating aggregateRating) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(AlternateName alternateName) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(AlternativeHeadline alternativeHeadline) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(AssociatedMedia associatedMedia) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Audience audience) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Audio audio) {
		setAudio(audio);
	}
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Author author) {
		setAuthor(author);
	}
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Award award) {
		setAward(award);
	}
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Character character) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Citation citation) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Comment comment) {
		setComment(comment);
	}
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(CommentCount commentCount) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(ContentLocation contentLocation) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(ContentRating contentRating) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(ContentReferenceTime contentReferenceTime) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Contributor contributor) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(CopyrightHolder copyrightHolder) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(CopyrightYear copyrightYear) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Correction correction) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Creator creator) {
		setCreator(creator);
	}
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(DateCreated dateCreated) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(DateModified dateModified) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(DatePublished datePublished) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Description description) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(DiscussionUrl discussionUrl) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Editor editor) {
		setEditor(editor);
	}
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(EducationalAlignment educationalAlignment) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(EducationalUse educationalUse) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Encoding encoding) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(EncodingFormat encodingFormat) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(ExampleOfWork exampleOfWork) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Expires expires) {
		setExpires(expires);
	}
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Funder funder) {
		setFunder(funder);
	}
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Genre genre) {
		setGenre(genre);
	}
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(HasDigitalDocumentPermission hasDigitalDocumentPermission) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Headline headline) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Identifier identifier) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Image image) {
		setImage(image);
	}
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(InLanguage inLanguage) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(InteractionStatistic interactionStatistic) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(InteractivityType interactivityType) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(IsBasedOn isBasedOn) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(IsFamilyFriendly isFamilyFriendly) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(IsPartOf isPartOf) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Keywords keywords) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(LearningResourceType learningResourceType) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(License license) {
		setLicense(license);
	}
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(LocationCreated locationCreated) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(MainEntity mainEntity) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(MainEntityOfPage mainEntityOfPage) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Material material) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(MaterialExtent materialExtent) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Mentions mentions) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Name name) {
		setName(name);
	}
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(NameFuzzy nameFuzzy) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(NameRuby nameRuby) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Offers offers) {
		setOffers(offers);
	}
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Position position) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(PotentialAction potentialAction) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Producer producer) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Provider provider) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Publication publication) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Publisher publisher) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(PublisherImprint publisherImprint) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(PublishingPrinciples publishingPrinciples) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(RecordedAt recordedAt) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(ReleasedEvent releasedEvent) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Review review) {
		setReview(review);
	}
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(SchemaVersion schemaVersion) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(SdDatePublished sdDatePublished) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(SdLicense sdLicense) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(SdPublisher sdPublisher) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(SourceOrganization sourceOrganization) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(SpatialCoverage spatialCoverage) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(SubjectOf subjectOf) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Temporal temporal) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(TemporalCoverage temporalCoverage) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Text text) {
		setText(text);
	}
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(ThumbnailUrl thumbnailUrl) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(TimeRequired timeRequired) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(TranslationOfWork translationOfWork) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Translator translator) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(TypicalAgeRange typicalAgeRange) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Url url) {
		setUrl(url);
	}
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Version version) {
		setVersion(version);
	}
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(Video video) {
		setVideo(video);
	}
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(WorkExample workExample) {
	...
	public SPREADSHEET_DIGITAL_DOCUMENT(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.SpreadsheetDigitalDocument org) {
		setSeq(org.getSeq());
