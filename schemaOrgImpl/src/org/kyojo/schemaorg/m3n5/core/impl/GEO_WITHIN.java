...
public class GEO_WITHIN implements Container.GeoWithin {
	...
	public GEO_WITHIN(String string) {
	...
	public GEO_WITHIN(Accommodation accommodation) {
	...
	public GEO_WITHIN(AccountingService accountingService) {
	...
	public GEO_WITHIN(AdministrativeArea administrativeArea) {
	...
	public GEO_WITHIN(AdultEntertainment adultEntertainment) {
	...
	public GEO_WITHIN(Airport airport) {
	...
	public GEO_WITHIN(AmusementPark amusementPark) {
	...
	public GEO_WITHIN(AnimalShelter animalShelter) {
	...
	public GEO_WITHIN(Apartment apartment) {
	...
	public GEO_WITHIN(ApartmentComplex apartmentComplex) {
	...
	public GEO_WITHIN(Aquarium aquarium) {
	...
	public GEO_WITHIN(ArchiveOrganization archiveOrganization) {
	...
	public GEO_WITHIN(ArtGallery artGallery) {
	...
	public GEO_WITHIN(Attorney attorney) {
	...
	public GEO_WITHIN(AutoBodyShop autoBodyShop) {
	...
	public GEO_WITHIN(AutoDealer autoDealer) {
	...
	public GEO_WITHIN(AutoPartsStore autoPartsStore) {
	...
	public GEO_WITHIN(AutoRental autoRental) {
	...
	public GEO_WITHIN(AutoRepair autoRepair) {
	...
	public GEO_WITHIN(AutoWash autoWash) {
	...
	public GEO_WITHIN(AutomatedTeller automatedTeller) {
	...
	public GEO_WITHIN(AutomotiveBusiness automotiveBusiness) {
	...
	public GEO_WITHIN(Bakery bakery) {
	...
	public GEO_WITHIN(BankOrCreditUnion bankOrCreditUnion) {
	...
	public GEO_WITHIN(BarOrPub barOrPub) {
	...
	public GEO_WITHIN(BeautySalon beautySalon) {
	...
	public GEO_WITHIN(BedAndBreakfast bedAndBreakfast) {
	...
	public GEO_WITHIN(BikeStore bikeStore) {
	...
	public GEO_WITHIN(BodyOfWater bodyOfWater) {
	...
	public GEO_WITHIN(BookStore bookStore) {
	...
	public GEO_WITHIN(BowlingAlley bowlingAlley) {
	...
	public GEO_WITHIN(Brewery brewery) {
	...
	public GEO_WITHIN(Bridge bridge) {
	...
	public GEO_WITHIN(BuddhistTemple buddhistTemple) {
	...
	public GEO_WITHIN(BusStation busStation) {
	...
	public GEO_WITHIN(BusStop busStop) {
	...
	public GEO_WITHIN(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public GEO_WITHIN(Campground campground) {
	...
	public GEO_WITHIN(CampingPitch campingPitch) {
	...
	public GEO_WITHIN(Casino casino) {
	...
	public GEO_WITHIN(CatholicChurch catholicChurch) {
	...
	public GEO_WITHIN(Cemetery cemetery) {
	...
	public GEO_WITHIN(ChildCare childCare) {
	...
	public GEO_WITHIN(Church church) {
	...
	public GEO_WITHIN(CityHall cityHall) {
	...
	public GEO_WITHIN(CivicStructure civicStructure) {
	...
	public GEO_WITHIN(ClothingStore clothingStore) {
	...
	public GEO_WITHIN(ComedyClub comedyClub) {
	...
	public GEO_WITHIN(CommunityHealth communityHealth) {
	...
	public GEO_WITHIN(ComputerStore computerStore) {
	...
	public GEO_WITHIN(Continent continent) {
	...
	public GEO_WITHIN(ConvenienceStore convenienceStore) {
	...
	public GEO_WITHIN(Country country) {
	...
	public GEO_WITHIN(Courthouse courthouse) {
	...
	public GEO_WITHIN(Crematorium crematorium) {
	...
	public GEO_WITHIN(DaySpa daySpa) {
	...
	public GEO_WITHIN(DefenceEstablishment defenceEstablishment) {
	...
	public GEO_WITHIN(Dentist dentist) {
	...
	public GEO_WITHIN(DepartmentStore departmentStore) {
	...
	public GEO_WITHIN(Dermatology dermatology) {
	...
	public GEO_WITHIN(DietNutrition dietNutrition) {
	...
	public GEO_WITHIN(Distillery distillery) {
	...
	public GEO_WITHIN(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public GEO_WITHIN(Electrician electrician) {
	...
	public GEO_WITHIN(ElectronicsStore electronicsStore) {
	...
	public GEO_WITHIN(Embassy embassy) {
	...
	public GEO_WITHIN(Emergency emergency) {
	...
	public GEO_WITHIN(EmergencyService emergencyService) {
	...
	public GEO_WITHIN(EmploymentAgency employmentAgency) {
	...
	public GEO_WITHIN(EntertainmentBusiness entertainmentBusiness) {
	...
	public GEO_WITHIN(EventVenue eventVenue) {
	...
	public GEO_WITHIN(ExerciseGym exerciseGym) {
	...
	public GEO_WITHIN(FastFoodRestaurant fastFoodRestaurant) {
	...
	public GEO_WITHIN(FinancialService financialService) {
	...
	public GEO_WITHIN(FireStation fireStation) {
	...
	public GEO_WITHIN(Florist florist) {
	...
	public GEO_WITHIN(FoodEstablishment foodEstablishment) {
	...
	public GEO_WITHIN(FurnitureStore furnitureStore) {
	...
	public GEO_WITHIN(GardenStore gardenStore) {
	...
	public GEO_WITHIN(GasStation gasStation) {
	...
	public GEO_WITHIN(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public GEO_WITHIN(GeneralContractor generalContractor) {
	...
	public GEO_WITHIN(GeospatialGeometry geospatialGeometry) {
		geospatialGeometryList = new ArrayList<GeospatialGeometry>();
	...
	public GEO_WITHIN(Geriatric geriatric) {
	...
	public GEO_WITHIN(GolfCourse golfCourse) {
	...
	public GEO_WITHIN(GovernmentBuilding governmentBuilding) {
	...
	public GEO_WITHIN(GovernmentOffice governmentOffice) {
	...
	public GEO_WITHIN(GroceryStore groceryStore) {
	...
	public GEO_WITHIN(Gynecologic gynecologic) {
	...
	public GEO_WITHIN(HVACBusiness hvacBusiness) {
	...
	public GEO_WITHIN(HairSalon hairSalon) {
	...
	public GEO_WITHIN(HardwareStore hardwareStore) {
	...
	public GEO_WITHIN(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public GEO_WITHIN(HealthClub healthClub) {
	...
	public GEO_WITHIN(HinduTemple hinduTemple) {
	...
	public GEO_WITHIN(HobbyShop hobbyShop) {
	...
	public GEO_WITHIN(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public GEO_WITHIN(HomeGoodsStore homeGoodsStore) {
	...
	public GEO_WITHIN(Hospital hospital) {
	...
	public GEO_WITHIN(Hostel hostel) {
	...
	public GEO_WITHIN(HotelRoom hotelRoom) {
	...
	public GEO_WITHIN(HousePainter housePainter) {
	...
	public GEO_WITHIN(IceCreamShop iceCreamShop) {
	...
	public GEO_WITHIN(InsuranceAgency insuranceAgency) {
	...
	public GEO_WITHIN(InternetCafe internetCafe) {
	...
	public GEO_WITHIN(JewelryStore jewelryStore) {
	...
	public GEO_WITHIN(LakeBodyOfWater lakeBodyOfWater) {
	...
	public GEO_WITHIN(Landform landform) {
	...
	public GEO_WITHIN(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public GEO_WITHIN(LegalService legalService) {
	...
	public GEO_WITHIN(LegislativeBuilding legislativeBuilding) {
	...
	public GEO_WITHIN(Library library) {
	...
	public GEO_WITHIN(LiquorStore liquorStore) {
	...
	public GEO_WITHIN(LocalBusiness localBusiness) {
	...
	public GEO_WITHIN(Locksmith locksmith) {
	...
	public GEO_WITHIN(LodgingBusiness lodgingBusiness) {
	...
	public GEO_WITHIN(MedicalBusiness medicalBusiness) {
	...
	public GEO_WITHIN(MedicalClinic medicalClinic) {
	...
	public GEO_WITHIN(MeetingRoom meetingRoom) {
	...
	public GEO_WITHIN(MensClothingStore mensClothingStore) {
	...
	public GEO_WITHIN(Midwifery midwifery) {
	...
	public GEO_WITHIN(MobilePhoneStore mobilePhoneStore) {
	...
	public GEO_WITHIN(Mosque mosque) {
	...
	public GEO_WITHIN(MotorcycleDealer motorcycleDealer) {
	...
	public GEO_WITHIN(MotorcycleRepair motorcycleRepair) {
	...
	public GEO_WITHIN(Mountain mountain) {
	...
	public GEO_WITHIN(MovieRentalStore movieRentalStore) {
	...
	public GEO_WITHIN(MovieTheater movieTheater) {
	...
	public GEO_WITHIN(MovingCompany movingCompany) {
	...
	public GEO_WITHIN(Museum museum) {
	...
	public GEO_WITHIN(MusicStore musicStore) {
	...
	public GEO_WITHIN(MusicVenue musicVenue) {
	...
	public GEO_WITHIN(NailSalon nailSalon) {
	...
	public GEO_WITHIN(NightClub nightClub) {
	...
	public GEO_WITHIN(Notary notary) {
	...
	public GEO_WITHIN(Nursing nursing) {
	...
	public GEO_WITHIN(Obstetric obstetric) {
	...
	public GEO_WITHIN(OceanBodyOfWater oceanBodyOfWater) {
	...
	public GEO_WITHIN(OfficeEquipmentStore officeEquipmentStore) {
	...
	public GEO_WITHIN(Oncologic oncologic) {
	...
	public GEO_WITHIN(Optician optician) {
	...
	public GEO_WITHIN(Optometric optometric) {
	...
	public GEO_WITHIN(Otolaryngologic otolaryngologic) {
	...
	public GEO_WITHIN(OutletStore outletStore) {
	...
	public GEO_WITHIN(ParkingFacility parkingFacility) {
	...
	public GEO_WITHIN(PawnShop pawnShop) {
	...
	public GEO_WITHIN(Pediatric pediatric) {
	...
	public GEO_WITHIN(PerformingArtsTheater performingArtsTheater) {
	...
	public GEO_WITHIN(PetStore petStore) {
	...
	public GEO_WITHIN(Pharmacy pharmacy) {
	...
	public GEO_WITHIN(Physician physician) {
	...
	public GEO_WITHIN(Physiotherapy physiotherapy) {
	...
	public GEO_WITHIN(PlaceOfWorship placeOfWorship) {
	...
	public GEO_WITHIN(PlasticSurgery plasticSurgery) {
	...
	public GEO_WITHIN(Playground playground) {
	...
	public GEO_WITHIN(Plumber plumber) {
	...
	public GEO_WITHIN(Podiatric podiatric) {
	...
	public GEO_WITHIN(PoliceStation policeStation) {
	...
	public GEO_WITHIN(PostOffice postOffice) {
	...
	public GEO_WITHIN(PrimaryCare primaryCare) {
	...
	public GEO_WITHIN(ProfessionalService professionalService) {
	...
	public GEO_WITHIN(Psychiatric psychiatric) {
	...
	public GEO_WITHIN(PublicHealth publicHealth) {
	...
	public GEO_WITHIN(PublicSwimmingPool publicSwimmingPool) {
	...
	public GEO_WITHIN(PublicToilet publicToilet) {
	...
	public GEO_WITHIN(RVPark rvPark) {
	...
	public GEO_WITHIN(RadioStation radioStation) {
	...
	public GEO_WITHIN(RealEstateAgent realEstateAgent) {
	...
	public GEO_WITHIN(RecyclingCenter recyclingCenter) {
	...
	public GEO_WITHIN(Reservoir reservoir) {
	...
	public GEO_WITHIN(Residence residence) {
	...
	public GEO_WITHIN(Resort resort) {
	...
	public GEO_WITHIN(Restaurant restaurant) {
	...
	public GEO_WITHIN(RiverBodyOfWater riverBodyOfWater) {
	...
	public GEO_WITHIN(RoofingContractor roofingContractor) {
	...
	public GEO_WITHIN(SeaBodyOfWater seaBodyOfWater) {
	...
	public GEO_WITHIN(SelfStorage selfStorage) {
	...
	public GEO_WITHIN(ShoeStore shoeStore) {
	...
	public GEO_WITHIN(ShoppingCenter shoppingCenter) {
	...
	public GEO_WITHIN(SingleFamilyResidence singleFamilyResidence) {
	...
	public GEO_WITHIN(SkiResort skiResort) {
	...
	public GEO_WITHIN(SportingGoodsStore sportingGoodsStore) {
	...
	public GEO_WITHIN(SportsActivityLocation sportsActivityLocation) {
	...
	public GEO_WITHIN(SportsClub sportsClub) {
	...
	public GEO_WITHIN(StadiumOrArena stadiumOrArena) {
	...
	public GEO_WITHIN(SubwayStation subwayStation) {
	...
	public GEO_WITHIN(Synagogue synagogue) {
	...
	public GEO_WITHIN(TattooParlor tattooParlor) {
	...
	public GEO_WITHIN(TaxiStand taxiStand) {
	...
	public GEO_WITHIN(TelevisionStation televisionStation) {
	...
	public GEO_WITHIN(TennisComplex tennisComplex) {
	...
	public GEO_WITHIN(TireShop tireShop) {
	...
	public GEO_WITHIN(TouristAttraction touristAttraction) {
	...
	public GEO_WITHIN(TouristDestination touristDestination) {
	...
	public GEO_WITHIN(TouristInformationCenter touristInformationCenter) {
	...
	public GEO_WITHIN(ToyStore toyStore) {
	...
	public GEO_WITHIN(TrainStation trainStation) {
	...
	public GEO_WITHIN(TravelAgency travelAgency) {
	...
	public GEO_WITHIN(Volcano volcano) {
	...
	public GEO_WITHIN(Waterfall waterfall) {
	...
	public GEO_WITHIN(WholesaleStore wholesaleStore) {
	...
	public GEO_WITHIN(Winery winery) {
	...
	public void copy(Container.GeoWithin org) {
