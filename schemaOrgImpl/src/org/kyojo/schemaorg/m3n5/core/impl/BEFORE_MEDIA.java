...
public class BEFORE_MEDIA implements Container.BeforeMedia {
	...
	public BEFORE_MEDIA(String string) {
	...
	public BEFORE_MEDIA(AudioObject audioObject) {
	...
	public BEFORE_MEDIA(Audiobook audiobook) {
	...
	public BEFORE_MEDIA(Barcode barcode) {
	...
	public BEFORE_MEDIA(DataDownload dataDownload) {
	...
	public BEFORE_MEDIA(ImageObject imageObject) {
	...
	public BEFORE_MEDIA(LegislationObject legislationObject) {
	...
	public BEFORE_MEDIA(MediaObject mediaObject) {
	...
	public BEFORE_MEDIA(MusicVideoObject musicVideoObject) {
	...
	public BEFORE_MEDIA(VideoObject videoObject) {
	...
	public BEFORE_MEDIA(List<AudioObject> audioObjectList,
	...
	public void copy(Container.BeforeMedia org) {
