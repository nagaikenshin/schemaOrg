...
public class GRANTEE implements Container.Grantee {
	...
	public GRANTEE(AccountingService accountingService) {
	...
	public GRANTEE(AdultEntertainment adultEntertainment) {
	...
	public GRANTEE(Airline airline) {
	...
	public GRANTEE(AmusementPark amusementPark) {
	...
	public GRANTEE(AnimalShelter animalShelter) {
	...
	public GRANTEE(ArchiveOrganization archiveOrganization) {
	...
	public GRANTEE(ArtGallery artGallery) {
	...
	public GRANTEE(Attorney attorney) {
	...
	public GRANTEE(AutoBodyShop autoBodyShop) {
	...
	public GRANTEE(AutoDealer autoDealer) {
	...
	public GRANTEE(AutoPartsStore autoPartsStore) {
	...
	public GRANTEE(AutoRental autoRental) {
	...
	public GRANTEE(AutoRepair autoRepair) {
	...
	public GRANTEE(AutoWash autoWash) {
	...
	public GRANTEE(AutomatedTeller automatedTeller) {
	...
	public GRANTEE(AutomotiveBusiness automotiveBusiness) {
	...
	public GRANTEE(BankOrCreditUnion bankOrCreditUnion) {
	...
	public GRANTEE(BarOrPub barOrPub) {
	...
	public GRANTEE(BeautySalon beautySalon) {
	...
	public GRANTEE(BedAndBreakfast bedAndBreakfast) {
	...
	public GRANTEE(BikeStore bikeStore) {
	...
	public GRANTEE(BookStore bookStore) {
	...
	public GRANTEE(BowlingAlley bowlingAlley) {
	...
	public GRANTEE(Brewery brewery) {
	...
	public GRANTEE(BusinessAudience businessAudience) {
	...
	public GRANTEE(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public GRANTEE(Campground campground) {
	...
	public GRANTEE(ChildCare childCare) {
	...
	public GRANTEE(ClothingStore clothingStore) {
	...
	public GRANTEE(CollegeOrUniversity collegeOrUniversity) {
	...
	public GRANTEE(ComedyClub comedyClub) {
	...
	public GRANTEE(CommunityHealth communityHealth) {
	...
	public GRANTEE(ComputerStore computerStore) {
	...
	public GRANTEE(Consortium consortium) {
	...
	public GRANTEE(ConvenienceStore convenienceStore) {
	...
	public GRANTEE(Corporation corporation) {
	...
	public GRANTEE(DanceGroup danceGroup) {
	...
	public GRANTEE(Dentist dentist) {
	...
	public GRANTEE(DepartmentStore departmentStore) {
	...
	public GRANTEE(Dermatology dermatology) {
	...
	public GRANTEE(DiagnosticLab diagnosticLab) {
	...
	public GRANTEE(DietNutrition dietNutrition) {
	...
	public GRANTEE(Distillery distillery) {
	...
	public GRANTEE(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public GRANTEE(EducationalAudience educationalAudience) {
	...
	public GRANTEE(EducationalOrganization educationalOrganization) {
	...
	public GRANTEE(Electrician electrician) {
	...
	public GRANTEE(ElectronicsStore electronicsStore) {
	...
	public GRANTEE(ElementarySchool elementarySchool) {
	...
	public GRANTEE(Emergency emergency) {
	...
	public GRANTEE(EmergencyService emergencyService) {
	...
	public GRANTEE(EmploymentAgency employmentAgency) {
	...
	public GRANTEE(EntertainmentBusiness entertainmentBusiness) {
	...
	public GRANTEE(ExerciseGym exerciseGym) {
	...
	public GRANTEE(FastFoodRestaurant fastFoodRestaurant) {
	...
	public GRANTEE(FinancialService financialService) {
	...
	public GRANTEE(FireStation fireStation) {
	...
	public GRANTEE(Florist florist) {
	...
	public GRANTEE(FoodEstablishment foodEstablishment) {
	...
	public GRANTEE(FundingAgency fundingAgency) {
	...
	public GRANTEE(FundingScheme fundingScheme) {
	...
	public GRANTEE(FurnitureStore furnitureStore) {
	...
	public GRANTEE(GardenStore gardenStore) {
	...
	public GRANTEE(GasStation gasStation) {
	...
	public GRANTEE(GeneralContractor generalContractor) {
	...
	public GRANTEE(Geriatric geriatric) {
	...
	public GRANTEE(GolfCourse golfCourse) {
	...
	public GRANTEE(GovernmentOffice governmentOffice) {
	...
	public GRANTEE(GovernmentOrganization governmentOrganization) {
	...
	public GRANTEE(GroceryStore groceryStore) {
	...
	public GRANTEE(Gynecologic gynecologic) {
	...
	public GRANTEE(HVACBusiness hvacBusiness) {
	...
	public GRANTEE(HairSalon hairSalon) {
	...
	public GRANTEE(HardwareStore hardwareStore) {
	...
	public GRANTEE(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public GRANTEE(HealthClub healthClub) {
	...
	public GRANTEE(HighSchool highSchool) {
	...
	public GRANTEE(HobbyShop hobbyShop) {
	...
	public GRANTEE(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public GRANTEE(HomeGoodsStore homeGoodsStore) {
	...
	public GRANTEE(Hospital hospital) {
	...
	public GRANTEE(HousePainter housePainter) {
	...
	public GRANTEE(IceCreamShop iceCreamShop) {
	...
	public GRANTEE(InsuranceAgency insuranceAgency) {
	...
	public GRANTEE(InternetCafe internetCafe) {
	...
	public GRANTEE(JewelryStore jewelryStore) {
	...
	public GRANTEE(LegalService legalService) {
	...
	public GRANTEE(Library library) {
	...
	public GRANTEE(LibrarySystem librarySystem) {
	...
	public GRANTEE(LiquorStore liquorStore) {
	...
	public GRANTEE(LocalBusiness localBusiness) {
	...
	public GRANTEE(Locksmith locksmith) {
	...
	public GRANTEE(LodgingBusiness lodgingBusiness) {
	...
	public GRANTEE(MedicalAudience medicalAudience) {
	...
	public GRANTEE(MedicalBusiness medicalBusiness) {
	...
	public GRANTEE(MedicalClinic medicalClinic) {
	...
	public GRANTEE(MedicalOrganization medicalOrganization) {
	...
	public GRANTEE(MensClothingStore mensClothingStore) {
	...
	public GRANTEE(MiddleSchool middleSchool) {
	...
	public GRANTEE(Midwifery midwifery) {
	...
	public GRANTEE(MobilePhoneStore mobilePhoneStore) {
	...
	public GRANTEE(MotorcycleDealer motorcycleDealer) {
	...
	public GRANTEE(MotorcycleRepair motorcycleRepair) {
	...
	public GRANTEE(MovieRentalStore movieRentalStore) {
	...
	public GRANTEE(MovieTheater movieTheater) {
	...
	public GRANTEE(MovingCompany movingCompany) {
	...
	public GRANTEE(MusicGroup musicGroup) {
	...
	public GRANTEE(MusicStore musicStore) {
	...
	public GRANTEE(NailSalon nailSalon) {
	...
	public GRANTEE(NewsMediaOrganization newsMediaOrganization) {
	...
	public GRANTEE(NightClub nightClub) {
	...
	public GRANTEE(Nursing nursing) {
	...
	public GRANTEE(Obstetric obstetric) {
	...
	public GRANTEE(OfficeEquipmentStore officeEquipmentStore) {
	...
	public GRANTEE(Oncologic oncologic) {
	...
	public GRANTEE(Optician optician) {
	...
	public GRANTEE(Optometric optometric) {
	...
	public GRANTEE(Otolaryngologic otolaryngologic) {
	...
	public GRANTEE(OutletStore outletStore) {
	...
	public GRANTEE(ParentAudience parentAudience) {
	...
	public GRANTEE(Patient patient) {
	...
	public GRANTEE(PawnShop pawnShop) {
	...
	public GRANTEE(Pediatric pediatric) {
	...
	public GRANTEE(PeopleAudience peopleAudience) {
	...
	public GRANTEE(PerformingGroup performingGroup) {
	...
	public GRANTEE(PetStore petStore) {
	...
	public GRANTEE(Pharmacy pharmacy) {
	...
	public GRANTEE(Physician physician) {
	...
	public GRANTEE(Physiotherapy physiotherapy) {
	...
	public GRANTEE(PlasticSurgery plasticSurgery) {
	...
	public GRANTEE(Plumber plumber) {
	...
	public GRANTEE(Podiatric podiatric) {
	...
	public GRANTEE(PoliceStation policeStation) {
	...
	public GRANTEE(PostOffice postOffice) {
	...
	public GRANTEE(PostalAddress postalAddress) {
	...
	public GRANTEE(Preschool preschool) {
	...
	public GRANTEE(PrimaryCare primaryCare) {
	...
	public GRANTEE(ProfessionalService professionalService) {
	...
	public GRANTEE(Project project) {
	...
	public GRANTEE(Psychiatric psychiatric) {
	...
	public GRANTEE(PublicHealth publicHealth) {
	...
	public GRANTEE(PublicSwimmingPool publicSwimmingPool) {
	...
	public GRANTEE(RadioStation radioStation) {
	...
	public GRANTEE(RealEstateAgent realEstateAgent) {
	...
	public GRANTEE(RecyclingCenter recyclingCenter) {
	...
	public GRANTEE(ResearchProject researchProject) {
	...
	public GRANTEE(Restaurant restaurant) {
	...
	public GRANTEE(RoofingContractor roofingContractor) {
	...
	public GRANTEE(SelfStorage selfStorage) {
	...
	public GRANTEE(ShoeStore shoeStore) {
	...
	public GRANTEE(ShoppingCenter shoppingCenter) {
	...
	public GRANTEE(SkiResort skiResort) {
	...
	public GRANTEE(SportingGoodsStore sportingGoodsStore) {
	...
	public GRANTEE(SportsActivityLocation sportsActivityLocation) {
	...
	public GRANTEE(SportsClub sportsClub) {
	...
	public GRANTEE(SportsOrganization sportsOrganization) {
	...
	public GRANTEE(SportsTeam sportsTeam) {
	...
	public GRANTEE(StadiumOrArena stadiumOrArena) {
	...
	public GRANTEE(TattooParlor tattooParlor) {
	...
	public GRANTEE(TelevisionStation televisionStation) {
	...
	public GRANTEE(TennisComplex tennisComplex) {
	...
	public GRANTEE(TheaterGroup theaterGroup) {
	...
	public GRANTEE(TireShop tireShop) {
	...
	public GRANTEE(TouristInformationCenter touristInformationCenter) {
	...
	public GRANTEE(ToyStore toyStore) {
	...
	public GRANTEE(TravelAgency travelAgency) {
	...
	public GRANTEE(VeterinaryCare veterinaryCare) {
	...
	public GRANTEE(WholesaleStore wholesaleStore) {
	...
	public GRANTEE(WorkersUnion workersUnion) {
