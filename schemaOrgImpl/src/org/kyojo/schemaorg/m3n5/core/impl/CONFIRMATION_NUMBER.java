...
public class CONFIRMATION_NUMBER implements Container.ConfirmationNumber {
	...
	public CONFIRMATION_NUMBER(LocationFeatureSpecification locationFeatureSpecification) {
	...
	public CONFIRMATION_NUMBER(PropertyValue propertyValue) {
	...
	public CONFIRMATION_NUMBER(String string) {
		this(new TEXT(string));
	}

	public CONFIRMATION_NUMBER(Text text) {
	...
	public CONFIRMATION_NUMBER(URL url) {
	...
	public CONFIRMATION_NUMBER(List<LocationFeatureSpecification> locationFeatureSpecificationList,
	...
	public void copy(Container.ConfirmationNumber org) {
