...
public class ROOM implements Clazz.Room {
	...
	public ROOM(GeoContains geoContains) {
	...
	public ROOM(GeoCoveredBy geoCoveredBy) {
	...
	public ROOM(GeoCovers geoCovers) {
	...
	public ROOM(GeoCrosses geoCrosses) {
	...
	public ROOM(GeoDisjoint geoDisjoint) {
	...
	public ROOM(GeoEquals geoEquals) {
	...
	public ROOM(GeoIntersects geoIntersects) {
	...
	public ROOM(GeoOverlaps geoOverlaps) {
	...
	public ROOM(GeoTouches geoTouches) {
	...
	public ROOM(GeoWithin geoWithin) {
