...
public class TAXI_SERVICE implements Clazz.TaxiService {
	...
	public TAXI_SERVICE(Long seq) {
		setSeq(seq);
	}

	public TAXI_SERVICE(String string) {
	...
	public TAXI_SERVICE(AdditionalType additionalType) {
	...
	public TAXI_SERVICE(AggregateRating aggregateRating) {
	...
	public TAXI_SERVICE(AlternateName alternateName) {
	...
	public TAXI_SERVICE(AreaServed areaServed) {
	...
	public TAXI_SERVICE(Audience audience) {
	...
	public TAXI_SERVICE(AvailableChannel availableChannel) {
	...
	public TAXI_SERVICE(Award award) {
		setAward(award);
	}
	...
	public TAXI_SERVICE(Brand brand) {
		setBrand(brand);
	}
	...
	public TAXI_SERVICE(Broker broker) {
		setBroker(broker);
	}
	...
	public TAXI_SERVICE(Category category) {
	...
	public TAXI_SERVICE(Description description) {
	...
	public TAXI_SERVICE(DisambiguatingDescription disambiguatingDescription) {
	...
	public TAXI_SERVICE(HasOfferCatalog hasOfferCatalog) {
	...
	public TAXI_SERVICE(HoursAvailable hoursAvailable) {
	...
	public TAXI_SERVICE(Identifier identifier) {
	...
	public TAXI_SERVICE(Image image) {
		setImage(image);
	}
	...
	public TAXI_SERVICE(IsRelatedTo isRelatedTo) {
	...
	public TAXI_SERVICE(IsSimilarTo isSimilarTo) {
	...
	public TAXI_SERVICE(MainEntityOfPage mainEntityOfPage) {
	...
	public TAXI_SERVICE(NameFuzzy nameFuzzy) {
	...
	public TAXI_SERVICE(NameRuby nameRuby) {
	...
	public TAXI_SERVICE(Offers offers) {
		setOffers(offers);
	}
	...
	public TAXI_SERVICE(PotentialAction potentialAction) {
	...
	public TAXI_SERVICE(Provider provider) {
	...
	public TAXI_SERVICE(ProviderMobility providerMobility) {
	...
	public TAXI_SERVICE(Review review) {
		setReview(review);
	}
	...
	public TAXI_SERVICE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TAXI_SERVICE(ServiceOutput serviceOutput) {
	...
	public TAXI_SERVICE(ServiceType serviceType) {
	...
	public TAXI_SERVICE(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public TAXI_SERVICE(SubjectOf subjectOf) {
	...
	public TAXI_SERVICE(TermsOfService termsOfService) {
	...
	public void copy(Clazz.TaxiService org) {
		setSeq(org.getSeq());
