...
public class CLAIM_REVIEW implements Clazz.ClaimReview {
	...
	public ClaimReviewed claimReviewed;
	...
	public CLAIM_REVIEW(Long seq) {
		setSeq(seq);
	}

	public CLAIM_REVIEW(String string) {
	...
	public CLAIM_REVIEW(About about) {
		setAbout(about);
	}
	...
	public CLAIM_REVIEW(AccessMode accessMode) {
	...
	public CLAIM_REVIEW(AccessModeSufficient accessModeSufficient) {
	...
	public CLAIM_REVIEW(AccessibilityAPI accessibilityAPI) {
	...
	public CLAIM_REVIEW(AccessibilityControl accessibilityControl) {
	...
	public CLAIM_REVIEW(AccessibilityFeature accessibilityFeature) {
	...
	public CLAIM_REVIEW(AccessibilityHazard accessibilityHazard) {
	...
	public CLAIM_REVIEW(AccessibilitySummary accessibilitySummary) {
	...
	public CLAIM_REVIEW(AccountablePerson accountablePerson) {
	...
	public CLAIM_REVIEW(AdditionalType additionalType) {
	...
	public CLAIM_REVIEW(AggregateRating aggregateRating) {
	...
	public CLAIM_REVIEW(AlternateName alternateName) {
	...
	public CLAIM_REVIEW(AlternativeHeadline alternativeHeadline) {
	...
	public CLAIM_REVIEW(AssociatedMedia associatedMedia) {
	...
	public CLAIM_REVIEW(Audience audience) {
	...
	public CLAIM_REVIEW(Audio audio) {
		setAudio(audio);
	}
	...
	public CLAIM_REVIEW(Author author) {
		setAuthor(author);
	}
	...
	public CLAIM_REVIEW(Award award) {
		setAward(award);
	}
	...
	public CLAIM_REVIEW(Character character) {
	...
	public CLAIM_REVIEW(Citation citation) {
	...
	public CLAIM_REVIEW(ClaimReviewed claimReviewed) {
		setClaimReviewed(claimReviewed);
	}

	@Override
	public ClaimReviewed getClaimReviewed() {
		return claimReviewed;
	}

	@Override
	public void setClaimReviewed(ClaimReviewed claimReviewed) {
		this.claimReviewed = claimReviewed;
	}

	public CLAIM_REVIEW(Comment comment) {
		setComment(comment);
	}
	...
	public CLAIM_REVIEW(CommentCount commentCount) {
	...
	public CLAIM_REVIEW(ContentLocation contentLocation) {
	...
	public CLAIM_REVIEW(ContentRating contentRating) {
	...
	public CLAIM_REVIEW(ContentReferenceTime contentReferenceTime) {
	...
	public CLAIM_REVIEW(Contributor contributor) {
	...
	public CLAIM_REVIEW(CopyrightHolder copyrightHolder) {
	...
	public CLAIM_REVIEW(CopyrightYear copyrightYear) {
	...
	public CLAIM_REVIEW(Correction correction) {
	...
	public CLAIM_REVIEW(Creator creator) {
		setCreator(creator);
	}
	...
	public CLAIM_REVIEW(DateCreated dateCreated) {
	...
	public CLAIM_REVIEW(DateModified dateModified) {
	...
	public CLAIM_REVIEW(DatePublished datePublished) {
	...
	public CLAIM_REVIEW(Description description) {
	...
	public CLAIM_REVIEW(DisambiguatingDescription disambiguatingDescription) {
	...
	public CLAIM_REVIEW(DiscussionUrl discussionUrl) {
	...
	public CLAIM_REVIEW(Editor editor) {
		setEditor(editor);
	}
	...
	public CLAIM_REVIEW(EducationalAlignment educationalAlignment) {
	...
	public CLAIM_REVIEW(EducationalUse educationalUse) {
	...
	public CLAIM_REVIEW(Encoding encoding) {
	...
	public CLAIM_REVIEW(EncodingFormat encodingFormat) {
	...
	public CLAIM_REVIEW(ExampleOfWork exampleOfWork) {
	...
	public CLAIM_REVIEW(Expires expires) {
		setExpires(expires);
	}
	...
	public CLAIM_REVIEW(Funder funder) {
		setFunder(funder);
	}
	...
	public CLAIM_REVIEW(Genre genre) {
		setGenre(genre);
	}
	...
	public CLAIM_REVIEW(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public CLAIM_REVIEW(Headline headline) {
	...
	public CLAIM_REVIEW(Identifier identifier) {
	...
	public CLAIM_REVIEW(Image image) {
		setImage(image);
	}
	...
	public CLAIM_REVIEW(InLanguage inLanguage) {
	...
	public CLAIM_REVIEW(InteractionStatistic interactionStatistic) {
	...
	public CLAIM_REVIEW(InteractivityType interactivityType) {
	...
	public CLAIM_REVIEW(IsAccessibleForFree isAccessibleForFree) {
	...
	public CLAIM_REVIEW(IsBasedOn isBasedOn) {
	...
	public CLAIM_REVIEW(IsFamilyFriendly isFamilyFriendly) {
	...
	public CLAIM_REVIEW(IsPartOf isPartOf) {
	...
	public CLAIM_REVIEW(ItemReviewed itemReviewed) {
	...
	public CLAIM_REVIEW(Keywords keywords) {
	...
	public CLAIM_REVIEW(LearningResourceType learningResourceType) {
	...
	public CLAIM_REVIEW(License license) {
		setLicense(license);
	}
	...
	public CLAIM_REVIEW(LocationCreated locationCreated) {
	...
	public CLAIM_REVIEW(MainEntity mainEntity) {
	...
	public CLAIM_REVIEW(MainEntityOfPage mainEntityOfPage) {
	...
	public CLAIM_REVIEW(Material material) {
	...
	public CLAIM_REVIEW(MaterialExtent materialExtent) {
	...
	public CLAIM_REVIEW(Mentions mentions) {
	...
	public CLAIM_REVIEW(NameFuzzy nameFuzzy) {
	...
	public CLAIM_REVIEW(NameRuby nameRuby) {
	...
	public CLAIM_REVIEW(Offers offers) {
		setOffers(offers);
	}
	...
	public CLAIM_REVIEW(Position position) {
	...
	public CLAIM_REVIEW(PotentialAction potentialAction) {
	...
	public CLAIM_REVIEW(Producer producer) {
	...
	public CLAIM_REVIEW(Provider provider) {
	...
	public CLAIM_REVIEW(Publication publication) {
	...
	public CLAIM_REVIEW(Publisher publisher) {
	...
	public CLAIM_REVIEW(PublisherImprint publisherImprint) {
	...
	public CLAIM_REVIEW(PublishingPrinciples publishingPrinciples) {
	...
	public CLAIM_REVIEW(RecordedAt recordedAt) {
	...
	public CLAIM_REVIEW(ReleasedEvent releasedEvent) {
	...
	public CLAIM_REVIEW(Review review) {
		setReview(review);
	}
	...
	public CLAIM_REVIEW(ReviewAspect reviewAspect) {
	...
	public CLAIM_REVIEW(ReviewBody reviewBody) {
	...
	public CLAIM_REVIEW(ReviewRating reviewRating) {
	...
	public CLAIM_REVIEW(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CLAIM_REVIEW(SchemaVersion schemaVersion) {
	...
	public CLAIM_REVIEW(SdDatePublished sdDatePublished) {
	...
	public CLAIM_REVIEW(SdLicense sdLicense) {
	...
	public CLAIM_REVIEW(SdPublisher sdPublisher) {
	...
	public CLAIM_REVIEW(SourceOrganization sourceOrganization) {
	...
	public CLAIM_REVIEW(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public CLAIM_REVIEW(SpatialCoverage spatialCoverage) {
	...
	public CLAIM_REVIEW(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public CLAIM_REVIEW(SubjectOf subjectOf) {
	...
	public CLAIM_REVIEW(Temporal temporal) {
	...
	public CLAIM_REVIEW(TemporalCoverage temporalCoverage) {
	...
	public CLAIM_REVIEW(ThumbnailUrl thumbnailUrl) {
	...
	public CLAIM_REVIEW(TimeRequired timeRequired) {
	...
	public CLAIM_REVIEW(TranslationOfWork translationOfWork) {
	...
	public CLAIM_REVIEW(Translator translator) {
	...
	public CLAIM_REVIEW(TypicalAgeRange typicalAgeRange) {
	...
	public CLAIM_REVIEW(Version version) {
		setVersion(version);
	}
	...
	public CLAIM_REVIEW(Video video) {
		setVideo(video);
	}
	...
	public CLAIM_REVIEW(WorkExample workExample) {
	...
	public CLAIM_REVIEW(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.ClaimReview org) {
		setSeq(org.getSeq());
		...
		setClaimReviewed(org.getClaimReviewed());
