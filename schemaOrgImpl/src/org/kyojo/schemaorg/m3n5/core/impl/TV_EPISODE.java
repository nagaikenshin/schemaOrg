...
public class TV_EPISODE implements Clazz.TVEpisode {
	...
	public TV_EPISODE(Long seq) {
		setSeq(seq);
	}

	public TV_EPISODE(String string) {
	...
	public TV_EPISODE(AccessMode accessMode) {
	...
	public TV_EPISODE(AccessModeSufficient accessModeSufficient) {
	...
	public TV_EPISODE(AccessibilityAPI accessibilityAPI) {
	...
	public TV_EPISODE(AccessibilityControl accessibilityControl) {
	...
	public TV_EPISODE(AccessibilityFeature accessibilityFeature) {
	...
	public TV_EPISODE(AccessibilityHazard accessibilityHazard) {
	...
	public TV_EPISODE(AccessibilitySummary accessibilitySummary) {
	...
	public TV_EPISODE(AccountablePerson accountablePerson) {
	...
	public TV_EPISODE(AdditionalType additionalType) {
	...
	public TV_EPISODE(AggregateRating aggregateRating) {
	...
	public TV_EPISODE(AlternateName alternateName) {
	...
	public TV_EPISODE(AlternativeHeadline alternativeHeadline) {
	...
	public TV_EPISODE(AssociatedMedia associatedMedia) {
	...
	public TV_EPISODE(Audience audience) {
	...
	public TV_EPISODE(Author author) {
		setAuthor(author);
	}
	...
	public TV_EPISODE(Character character) {
	...
	public TV_EPISODE(Citation citation) {
	...
	public TV_EPISODE(Comment comment) {
		setComment(comment);
	}
	...
	public TV_EPISODE(CommentCount commentCount) {
	...
	public TV_EPISODE(ContentLocation contentLocation) {
	...
	public TV_EPISODE(ContentRating contentRating) {
	...
	public TV_EPISODE(ContentReferenceTime contentReferenceTime) {
	...
	public TV_EPISODE(Contributor contributor) {
	...
	public TV_EPISODE(CopyrightHolder copyrightHolder) {
	...
	public TV_EPISODE(CopyrightYear copyrightYear) {
	...
	public TV_EPISODE(Correction correction) {
	...
	public TV_EPISODE(CountryOfOrigin countryOfOrigin) {
	...
	public TV_EPISODE(Creator creator) {
		setCreator(creator);
	}
	...
	public TV_EPISODE(DateCreated dateCreated) {
	...
	public TV_EPISODE(DateModified dateModified) {
	...
	public TV_EPISODE(DatePublished datePublished) {
	...
	public TV_EPISODE(Description description) {
	...
	public TV_EPISODE(Director director) {
	...
	public TV_EPISODE(DisambiguatingDescription disambiguatingDescription) {
	...
	public TV_EPISODE(DiscussionUrl discussionUrl) {
	...
	public TV_EPISODE(Editor editor) {
		setEditor(editor);
	}
	...
	public TV_EPISODE(EducationalAlignment educationalAlignment) {
	...
	public TV_EPISODE(EducationalUse educationalUse) {
	...
	public TV_EPISODE(Encoding encoding) {
	...
	public TV_EPISODE(EncodingFormat encodingFormat) {
	...
	public TV_EPISODE(EpisodeNumber episodeNumber) {
	...
	public TV_EPISODE(ExampleOfWork exampleOfWork) {
	...
	public TV_EPISODE(Expires expires) {
		setExpires(expires);
	}
	...
	public TV_EPISODE(Funder funder) {
		setFunder(funder);
	}
	...
	public TV_EPISODE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public TV_EPISODE(Headline headline) {
	...
	public TV_EPISODE(Identifier identifier) {
	...
	public TV_EPISODE(InLanguage inLanguage) {
	...
	public TV_EPISODE(InteractionStatistic interactionStatistic) {
	...
	public TV_EPISODE(InteractivityType interactivityType) {
	...
	public TV_EPISODE(IsAccessibleForFree isAccessibleForFree) {
	...
	public TV_EPISODE(IsBasedOn isBasedOn) {
	...
	public TV_EPISODE(IsFamilyFriendly isFamilyFriendly) {
	...
	public TV_EPISODE(IsPartOf isPartOf) {
	...
	public TV_EPISODE(Keywords keywords) {
	...
	public TV_EPISODE(LearningResourceType learningResourceType) {
	...
	public TV_EPISODE(License license) {
		setLicense(license);
	}
	...
	public TV_EPISODE(LocationCreated locationCreated) {
	...
	public TV_EPISODE(MainEntity mainEntity) {
	...
	public TV_EPISODE(MainEntityOfPage mainEntityOfPage) {
	...
	public TV_EPISODE(Material material) {
	...
	public TV_EPISODE(MaterialExtent materialExtent) {
	...
	public TV_EPISODE(Mentions mentions) {
	...
	public TV_EPISODE(MusicBy musicBy) {
		setMusicBy(musicBy);
	}
	...
	public TV_EPISODE(NameFuzzy nameFuzzy) {
	...
	public TV_EPISODE(NameRuby nameRuby) {
	...
	public TV_EPISODE(Offers offers) {
		setOffers(offers);
	}
	...
	public TV_EPISODE(PartOfSeason partOfSeason) {
	...
	public TV_EPISODE(PartOfSeries partOfSeries) {
	...
	public TV_EPISODE(Position position) {
	...
	public TV_EPISODE(PotentialAction potentialAction) {
	...
	public TV_EPISODE(Producer producer) {
	...
	public TV_EPISODE(ProductionCompany productionCompany) {
	...
	public TV_EPISODE(Provider provider) {
	...
	public TV_EPISODE(Publication publication) {
	...
	public TV_EPISODE(Publisher publisher) {
	...
	public TV_EPISODE(PublisherImprint publisherImprint) {
	...
	public TV_EPISODE(PublishingPrinciples publishingPrinciples) {
	...
	public TV_EPISODE(RecordedAt recordedAt) {
	...
	public TV_EPISODE(ReleasedEvent releasedEvent) {
	...
	public TV_EPISODE(Review review) {
		setReview(review);
	}
	...
	public TV_EPISODE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TV_EPISODE(SchemaVersion schemaVersion) {
	...
	public TV_EPISODE(SdDatePublished sdDatePublished) {
	...
	public TV_EPISODE(SdLicense sdLicense) {
	...
	public TV_EPISODE(SdPublisher sdPublisher) {
	...
	public TV_EPISODE(SourceOrganization sourceOrganization) {
	...
	public TV_EPISODE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public TV_EPISODE(SpatialCoverage spatialCoverage) {
	...
	public TV_EPISODE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public TV_EPISODE(SubjectOf subjectOf) {
	...
	public TV_EPISODE(SubtitleLanguage subtitleLanguage) {
	...
	public TV_EPISODE(Temporal temporal) {
	...
	public TV_EPISODE(TemporalCoverage temporalCoverage) {
	...
	public TV_EPISODE(ThumbnailUrl thumbnailUrl) {
	...
	public TV_EPISODE(TimeRequired timeRequired) {
	...
	public TV_EPISODE(Trailer trailer) {
		setTrailer(trailer);
	}
	...
	public TV_EPISODE(TranslationOfWork translationOfWork) {
	...
	public TV_EPISODE(Translator translator) {
	...
	public TV_EPISODE(TypicalAgeRange typicalAgeRange) {
	...
	public TV_EPISODE(Version version) {
		setVersion(version);
	}
	...
	public TV_EPISODE(WorkExample workExample) {
	...
	public TV_EPISODE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.TVEpisode org) {
		setSeq(org.getSeq());
