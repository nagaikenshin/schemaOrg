...
public class CITY_HALL implements Clazz.CityHall {
	...
	public CITY_HALL(GeoContains geoContains) {
	...
	public CITY_HALL(GeoCoveredBy geoCoveredBy) {
	...
	public CITY_HALL(GeoCovers geoCovers) {
	...
	public CITY_HALL(GeoCrosses geoCrosses) {
	...
	public CITY_HALL(GeoDisjoint geoDisjoint) {
	...
	public CITY_HALL(GeoEquals geoEquals) {
	...
	public CITY_HALL(GeoIntersects geoIntersects) {
	...
	public CITY_HALL(GeoOverlaps geoOverlaps) {
	...
	public CITY_HALL(GeoTouches geoTouches) {
	...
	public CITY_HALL(GeoWithin geoWithin) {
	...
	public CITY_HALL(Slogan slogan) {
		setSlogan(slogan);
	}
