...
public class BILLING_INCREMENT implements Container.BillingIncrement {
	...
	public BILLING_INCREMENT(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public BILLING_INCREMENT(Float fl0at) {
	...
	public BILLING_INCREMENT(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public BILLING_INCREMENT(Integer integer) {
	...
	public BILLING_INCREMENT(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public BILLING_INCREMENT(Number number) {
	...
	public BILLING_INCREMENT(List<Float> fl0atList,
	...
	public void copy(Container.BillingIncrement org) {
