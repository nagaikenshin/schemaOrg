...
public class AUTO_REPAIR implements Clazz.AutoRepair {
	...
	public AUTO_REPAIR(GeoContains geoContains) {
	...
	public AUTO_REPAIR(GeoCoveredBy geoCoveredBy) {
	...
	public AUTO_REPAIR(GeoCovers geoCovers) {
	...
	public AUTO_REPAIR(GeoCrosses geoCrosses) {
	...
	public AUTO_REPAIR(GeoDisjoint geoDisjoint) {
	...
	public AUTO_REPAIR(GeoEquals geoEquals) {
	...
	public AUTO_REPAIR(GeoIntersects geoIntersects) {
	...
	public AUTO_REPAIR(GeoOverlaps geoOverlaps) {
	...
	public AUTO_REPAIR(GeoTouches geoTouches) {
	...
	public AUTO_REPAIR(GeoWithin geoWithin) {
	...
	public AUTO_REPAIR(Slogan slogan) {
		setSlogan(slogan);
	}
