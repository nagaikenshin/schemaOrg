...
public class IS_FAMILY_FRIENDLY implements Container.IsFamilyFriendly {
	...
	public IS_FAMILY_FRIENDLY(java.lang.Boolean b00lean) {
		this(new BOOLEAN(b00lean));
	}

	public IS_FAMILY_FRIENDLY(Boolean b00lean) {
