...
import org.kyojo.schemaorg.m3n5.core.Container.HasDigitalDocumentPermission;
...
public class PRESENTATION_DIGITAL_DOCUMENT implements Clazz.PresentationDigitalDocument {
	...
	public Genre genre;
	public HasDigitalDocumentPermission hasDigitalDocumentPermission;
	...
	public PRESENTATION_DIGITAL_DOCUMENT() {
	}

	public PRESENTATION_DIGITAL_DOCUMENT(Long seq) {
		setSeq(seq);
	}

	public PRESENTATION_DIGITAL_DOCUMENT(String string) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(About about) {
		setAbout(about);
	}
	...
	public PRESENTATION_DIGITAL_DOCUMENT(AccessMode accessMode) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(AccessModeSufficient accessModeSufficient) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(AccessibilityAPI accessibilityAPI) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(AccessibilityControl accessibilityControl) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(AccessibilityFeature accessibilityFeature) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(AccessibilityHazard accessibilityHazard) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(AccessibilitySummary accessibilitySummary) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(AccountablePerson accountablePerson) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(AdditionalType additionalType) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(AggregateRating aggregateRating) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(AlternateName alternateName) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(AlternativeHeadline alternativeHeadline) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(AssociatedMedia associatedMedia) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Audience audience) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Audio audio) {
		setAudio(audio);
	}
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Author author) {
		setAuthor(author);
	}
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Award award) {
		setAward(award);
	}
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Character character) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Citation citation) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Comment comment) {
		setComment(comment);
	}
	...
	public PRESENTATION_DIGITAL_DOCUMENT(CommentCount commentCount) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(ContentLocation contentLocation) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(ContentRating contentRating) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(ContentReferenceTime contentReferenceTime) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Contributor contributor) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(CopyrightHolder copyrightHolder) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(CopyrightYear copyrightYear) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Correction correction) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Creator creator) {
		setCreator(creator);
	}
	...
	public PRESENTATION_DIGITAL_DOCUMENT(DateCreated dateCreated) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(DateModified dateModified) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(DatePublished datePublished) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Description description) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(DiscussionUrl discussionUrl) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Editor editor) {
		setEditor(editor);
	}
	...
	public PRESENTATION_DIGITAL_DOCUMENT(EducationalAlignment educationalAlignment) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(EducationalUse educationalUse) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Encoding encoding) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(EncodingFormat encodingFormat) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(ExampleOfWork exampleOfWork) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Expires expires) {
		setExpires(expires);
	}
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Funder funder) {
		setFunder(funder);
	}
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Genre genre) {
		setGenre(genre);
	}
	...
	public PRESENTATION_DIGITAL_DOCUMENT(HasDigitalDocumentPermission hasDigitalDocumentPermission) {
		setHasDigitalDocumentPermission(hasDigitalDocumentPermission);
	}

	@Override
	public HasDigitalDocumentPermission getHasDigitalDocumentPermission() {
		return hasDigitalDocumentPermission;
	}

	@Override
	public void setHasDigitalDocumentPermission(HasDigitalDocumentPermission hasDigitalDocumentPermission) {
		this.hasDigitalDocumentPermission = hasDigitalDocumentPermission;
	}

	public PRESENTATION_DIGITAL_DOCUMENT(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Headline headline) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Identifier identifier) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Image image) {
		setImage(image);
	}
	...
	public PRESENTATION_DIGITAL_DOCUMENT(InLanguage inLanguage) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(InteractionStatistic interactionStatistic) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(InteractivityType interactivityType) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(IsBasedOn isBasedOn) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(IsFamilyFriendly isFamilyFriendly) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(IsPartOf isPartOf) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Keywords keywords) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(LearningResourceType learningResourceType) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(License license) {
		setLicense(license);
	}
	...
	public PRESENTATION_DIGITAL_DOCUMENT(LocationCreated locationCreated) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(MainEntity mainEntity) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(MainEntityOfPage mainEntityOfPage) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Material material) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(MaterialExtent materialExtent) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Mentions mentions) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Name name) {
		setName(name);
	}
	...
	public PRESENTATION_DIGITAL_DOCUMENT(NameFuzzy nameFuzzy) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(NameRuby nameRuby) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Offers offers) {
		setOffers(offers);
	}
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Position position) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(PotentialAction potentialAction) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Producer producer) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Provider provider) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Publication publication) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Publisher publisher) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(PublisherImprint publisherImprint) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(PublishingPrinciples publishingPrinciples) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(RecordedAt recordedAt) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(ReleasedEvent releasedEvent) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Review review) {
		setReview(review);
	}
	...
	public PRESENTATION_DIGITAL_DOCUMENT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PRESENTATION_DIGITAL_DOCUMENT(SchemaVersion schemaVersion) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(SdDatePublished sdDatePublished) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(SdLicense sdLicense) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(SdPublisher sdPublisher) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(SourceOrganization sourceOrganization) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public PRESENTATION_DIGITAL_DOCUMENT(SpatialCoverage spatialCoverage) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public PRESENTATION_DIGITAL_DOCUMENT(SubjectOf subjectOf) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Temporal temporal) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(TemporalCoverage temporalCoverage) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Text text) {
		setText(text);
	}
	...
	public PRESENTATION_DIGITAL_DOCUMENT(ThumbnailUrl thumbnailUrl) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(TimeRequired timeRequired) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(TranslationOfWork translationOfWork) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Translator translator) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(TypicalAgeRange typicalAgeRange) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Url url) {
		setUrl(url);
	}
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Version version) {
		setVersion(version);
	}
	...
	public PRESENTATION_DIGITAL_DOCUMENT(Video video) {
		setVideo(video);
	}
	...
	public PRESENTATION_DIGITAL_DOCUMENT(WorkExample workExample) {
	...
	public PRESENTATION_DIGITAL_DOCUMENT(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.PresentationDigitalDocument org) {
		setSeq(org.getSeq());
		...
		setHasDigitalDocumentPermission(org.getHasDigitalDocumentPermission());
