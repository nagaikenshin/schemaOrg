...
public class CANCEL_ACTION implements Clazz.CancelAction {
	...
	public CANCEL_ACTION(Long seq) {
		setSeq(seq);
	}

	public CANCEL_ACTION(String string) {
	...
	public CANCEL_ACTION(ActionStatus actionStatus) {
	...
	public CANCEL_ACTION(AdditionalType additionalType) {
	...
	public CANCEL_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public CANCEL_ACTION(AlternateName alternateName) {
	...
	public CANCEL_ACTION(Description description) {
	...
	public CANCEL_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public CANCEL_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public CANCEL_ACTION(Error error) {
		setError(error);
	}
	...
	public CANCEL_ACTION(Identifier identifier) {
	...
	public CANCEL_ACTION(Image image) {
		setImage(image);
	}
	...
	public CANCEL_ACTION(Instrument instrument) {
	...
	public CANCEL_ACTION(Location location) {
	...
	public CANCEL_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public CANCEL_ACTION(Name name) {
		setName(name);
	}
	...
	public CANCEL_ACTION(NameFuzzy nameFuzzy) {
	...
	public CANCEL_ACTION(NameRuby nameRuby) {
	...
	public CANCEL_ACTION(Object object) {
		setObject(object);
	}
	...
	public CANCEL_ACTION(Participant participant) {
	...
	public CANCEL_ACTION(PotentialAction potentialAction) {
	...
	public CANCEL_ACTION(Result result) {
		setResult(result);
	}
	...
	public CANCEL_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CANCEL_ACTION(ScheduledTime scheduledTime) {
	...
	public CANCEL_ACTION(StartTime startTime) {
	...
	public CANCEL_ACTION(SubjectOf subjectOf) {
	...
	public CANCEL_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.CancelAction org) {
		setSeq(org.getSeq());
