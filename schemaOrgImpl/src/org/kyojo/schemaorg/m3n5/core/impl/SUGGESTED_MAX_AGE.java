...
public class SUGGESTED_MAX_AGE implements Container.SuggestedMaxAge {
	...
	public SUGGESTED_MAX_AGE(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public SUGGESTED_MAX_AGE(Float fl0at) {
	...
	public SUGGESTED_MAX_AGE(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public SUGGESTED_MAX_AGE(Integer integer) {
	...
	public SUGGESTED_MAX_AGE(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public SUGGESTED_MAX_AGE(Number number) {
	...
	public SUGGESTED_MAX_AGE(List<Float> fl0atList,
	...
	public void copy(Container.SuggestedMaxAge org) {
