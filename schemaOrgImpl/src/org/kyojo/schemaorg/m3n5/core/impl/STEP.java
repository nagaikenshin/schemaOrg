...
public class STEP implements Container.Step {
	...
	public STEP(APIReference apiReference) {
	...
	public STEP(AboutPage aboutPage) {
	...
	public STEP(AdvertiserContentArticle advertiserContentArticle) {
	...
	public STEP(AnalysisNewsArticle analysisNewsArticle) {
	...
	public STEP(ArchiveComponent archiveComponent) {
	...
	public STEP(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public STEP(AudioObject audioObject) {
	...
	public STEP(Audiobook audiobook) {
	...
	public STEP(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public STEP(BlogPosting blogPosting) {
	...
	public STEP(BookSeries bookSeries) {
	...
	public STEP(CategoryCodeSet categoryCodeSet) {
	...
	public STEP(CheckoutPage checkoutPage) {
	...
	public STEP(ClaimReview claimReview) {
	...
	public STEP(Collection collection) {
	...
	public STEP(CollectionPage collectionPage) {
	...
	public STEP(ComicCoverArt comicCoverArt) {
	...
	public STEP(ComicIssue comicIssue) {
	...
	public STEP(ComicSeries comicSeries) {
	...
	public STEP(ComicStory comicStory) {
	...
	public STEP(CompleteDataFeed completeDataFeed) {
	...
	public STEP(ContactPage contactPage) {
	...
	public STEP(Conversation conversation) {
	...
	public STEP(CorrectionComment correctionComment) {
	...
	public STEP(CreativeWorkSeason creativeWorkSeason) {
	...
	public STEP(CreativeWorkSeries creativeWorkSeries) {
	...
	public STEP(CriticReview criticReview) {
	...
	public STEP(DataCatalog dataCatalog) {
	...
	public STEP(DataDownload dataDownload) {
	...
	public STEP(DefinedTermSet definedTermSet) {
	...
	public STEP(DigitalDocument digitalDocument) {
	...
	public STEP(DiscussionForumPosting discussionForumPosting) {
	...
	public STEP(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public STEP(EmailMessage emailMessage) {
	...
	public STEP(EmployerReview employerReview) {
	...
	public STEP(ExercisePlan exercisePlan) {
	...
	public STEP(HowToDirection howToDirection) {
	...
	public STEP(ImageGallery imageGallery) {
	...
	public STEP(ImageObject imageObject) {
	...
	public STEP(Legislation legislation) {
	...
	public STEP(LegislationObject legislationObject) {
	...
	public STEP(LiveBlogPosting liveBlogPosting) {
	...
	public STEP(Manuscript manuscript) {
	...
	public STEP(MediaObject mediaObject) {
	...
	public STEP(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public STEP(MedicalWebPage medicalWebPage) {
	...
	public STEP(MenuSection menuSection) {
	...
	public STEP(MobileApplication mobileApplication) {
	...
	public STEP(MovieClip movieClip) {
	...
	public STEP(MovieSeries movieSeries) {
	...
	public STEP(MusicAlbum musicAlbum) {
	...
	public STEP(MusicComposition musicComposition) {
	...
	public STEP(MusicPlaylist musicPlaylist) {
	...
	public STEP(MusicRecording musicRecording) {
	...
	public STEP(MusicRelease musicRelease) {
	...
	public STEP(MusicVideoObject musicVideoObject) {
	...
	public STEP(NewsArticle newsArticle) {
	...
	public STEP(Newspaper newspaper) {
	...
	public STEP(NoteDigitalDocument noteDigitalDocument) {
	...
	public STEP(OpinionNewsArticle opinionNewsArticle) {
	...
	public STEP(Periodical periodical) {
	...
	public STEP(Photograph photograph) {
	...
	public STEP(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public STEP(ProfilePage profilePage) {
	...
	public STEP(PublicationIssue publicationIssue) {
	...
	public STEP(PublicationVolume publicationVolume) {
	...
	public STEP(Quotation quotation) {
	...
	public STEP(RadioClip radioClip) {
	...
	public STEP(RadioEpisode radioEpisode) {
	...
	public STEP(RadioSeason radioSeason) {
	...
	public STEP(RadioSeries radioSeries) {
	...
	public STEP(ReportageNewsArticle reportageNewsArticle) {
	...
	public STEP(ReviewNewsArticle reviewNewsArticle) {
	...
	public STEP(SatiricalArticle satiricalArticle) {
	...
	public STEP(ScholarlyArticle scholarlyArticle) {
	...
	public STEP(Sculpture sculpture) {
	...
	public STEP(SearchResultsPage searchResultsPage) {
	...
	public STEP(SheetMusic sheetMusic) {
	...
	public STEP(ShortStory shortStory) {
	...
	public STEP(SiteNavigationElement siteNavigationElement) {
	...
	public STEP(SocialMediaPosting socialMediaPosting) {
	...
	public STEP(SoftwareApplication softwareApplication) {
	...
	public STEP(SoftwareSourceCode softwareSourceCode) {
	...
	public STEP(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public STEP(TVEpisode tvEpisode) {
	...
	public STEP(TechArticle techArticle) {
	...
	public STEP(TextDigitalDocument textDigitalDocument) {
	...
	public STEP(ThreeDimensionalModel threeDimensionalModel) {
	...
	public STEP(UserReview userReview) {
	...
	public STEP(VideoGallery videoGallery) {
	...
	public STEP(VideoGame videoGame) {
	...
	public STEP(VideoGameClip videoGameClip) {
	...
	public STEP(VideoGameSeries videoGameSeries) {
	...
	public STEP(VideoObject videoObject) {
	...
	public STEP(VisualArtwork visualArtwork) {
	...
	public STEP(WPAdBlock wpAdBlock) {
	...
	public STEP(WPSideBar wpSideBar) {
	...
	public STEP(WebApplication webApplication) {
	...
	public STEP(WebPageElement webPageElement) {
