...
public class CC_RECIPIENT implements Container.CcRecipient {
	...
	public CC_RECIPIENT(String string) {
	...
	public CC_RECIPIENT(AccountingService accountingService) {
	...
	public CC_RECIPIENT(AdultEntertainment adultEntertainment) {
	...
	public CC_RECIPIENT(Airline airline) {
	...
	public CC_RECIPIENT(AmusementPark amusementPark) {
	...
	public CC_RECIPIENT(AnimalShelter animalShelter) {
	...
	public CC_RECIPIENT(ArchiveOrganization archiveOrganization) {
	...
	public CC_RECIPIENT(ArtGallery artGallery) {
	...
	public CC_RECIPIENT(Attorney attorney) {
	...
	public CC_RECIPIENT(Audience audience) {
	...
	public CC_RECIPIENT(AutoBodyShop autoBodyShop) {
	...
	public CC_RECIPIENT(AutoDealer autoDealer) {
	...
	public CC_RECIPIENT(AutoPartsStore autoPartsStore) {
	...
	public CC_RECIPIENT(AutoRental autoRental) {
	...
	public CC_RECIPIENT(AutoRepair autoRepair) {
	...
	public CC_RECIPIENT(AutoWash autoWash) {
	...
	public CC_RECIPIENT(AutomatedTeller automatedTeller) {
	...
	public CC_RECIPIENT(AutomotiveBusiness automotiveBusiness) {
	...
	public CC_RECIPIENT(Bakery bakery) {
	...
	public CC_RECIPIENT(BankOrCreditUnion bankOrCreditUnion) {
	...
	public CC_RECIPIENT(BarOrPub barOrPub) {
	...
	public CC_RECIPIENT(BeautySalon beautySalon) {
	...
	public CC_RECIPIENT(BedAndBreakfast bedAndBreakfast) {
	...
	public CC_RECIPIENT(BikeStore bikeStore) {
	...
	public CC_RECIPIENT(BookStore bookStore) {
	...
	public CC_RECIPIENT(BowlingAlley bowlingAlley) {
	...
	public CC_RECIPIENT(Brewery brewery) {
	...
	public CC_RECIPIENT(BusinessAudience businessAudience) {
	...
	public CC_RECIPIENT(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public CC_RECIPIENT(Campground campground) {
	...
	public CC_RECIPIENT(Casino casino) {
	...
	public CC_RECIPIENT(ChildCare childCare) {
	...
	public CC_RECIPIENT(ClothingStore clothingStore) {
	...
	public CC_RECIPIENT(CollegeOrUniversity collegeOrUniversity) {
	...
	public CC_RECIPIENT(ComedyClub comedyClub) {
	...
	public CC_RECIPIENT(CommunityHealth communityHealth) {
	...
	public CC_RECIPIENT(ComputerStore computerStore) {
	...
	public CC_RECIPIENT(Consortium consortium) {
	...
	public CC_RECIPIENT(ContactPoint contactPoint) {
		contactPointList = new ArrayList<ContactPoint>();
	...
	public CC_RECIPIENT(ConvenienceStore convenienceStore) {
	...
	public CC_RECIPIENT(Corporation corporation) {
	...
	public CC_RECIPIENT(DanceGroup danceGroup) {
	...
	public CC_RECIPIENT(DaySpa daySpa) {
	...
	public CC_RECIPIENT(Dentist dentist) {
	...
	public CC_RECIPIENT(DepartmentStore departmentStore) {
	...
	public CC_RECIPIENT(Dermatology dermatology) {
	...
	public CC_RECIPIENT(DiagnosticLab diagnosticLab) {
	...
	public CC_RECIPIENT(DietNutrition dietNutrition) {
	...
	public CC_RECIPIENT(Distillery distillery) {
	...
	public CC_RECIPIENT(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public CC_RECIPIENT(EducationalAudience educationalAudience) {
	...
	public CC_RECIPIENT(EducationalOrganization educationalOrganization) {
	...
	public CC_RECIPIENT(Electrician electrician) {
	...
	public CC_RECIPIENT(ElectronicsStore electronicsStore) {
	...
	public CC_RECIPIENT(ElementarySchool elementarySchool) {
	...
	public CC_RECIPIENT(Emergency emergency) {
	...
	public CC_RECIPIENT(EmergencyService emergencyService) {
	...
	public CC_RECIPIENT(EmploymentAgency employmentAgency) {
	...
	public CC_RECIPIENT(EntertainmentBusiness entertainmentBusiness) {
	...
	public CC_RECIPIENT(ExerciseGym exerciseGym) {
	...
	public CC_RECIPIENT(FastFoodRestaurant fastFoodRestaurant) {
	...
	public CC_RECIPIENT(FinancialService financialService) {
	...
	public CC_RECIPIENT(FireStation fireStation) {
	...
	public CC_RECIPIENT(Florist florist) {
	...
	public CC_RECIPIENT(FoodEstablishment foodEstablishment) {
	...
	public CC_RECIPIENT(FundingAgency fundingAgency) {
	...
	public CC_RECIPIENT(FundingScheme fundingScheme) {
	...
	public CC_RECIPIENT(FurnitureStore furnitureStore) {
	...
	public CC_RECIPIENT(GardenStore gardenStore) {
	...
	public CC_RECIPIENT(GasStation gasStation) {
	...
	public CC_RECIPIENT(GeneralContractor generalContractor) {
	...
	public CC_RECIPIENT(Geriatric geriatric) {
	...
	public CC_RECIPIENT(GolfCourse golfCourse) {
	...
	public CC_RECIPIENT(GovernmentOffice governmentOffice) {
	...
	public CC_RECIPIENT(GovernmentOrganization governmentOrganization) {
	...
	public CC_RECIPIENT(GroceryStore groceryStore) {
	...
	public CC_RECIPIENT(Gynecologic gynecologic) {
	...
	public CC_RECIPIENT(HVACBusiness hvacBusiness) {
	...
	public CC_RECIPIENT(HairSalon hairSalon) {
	...
	public CC_RECIPIENT(HardwareStore hardwareStore) {
	...
	public CC_RECIPIENT(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public CC_RECIPIENT(HealthClub healthClub) {
	...
	public CC_RECIPIENT(HighSchool highSchool) {
	...
	public CC_RECIPIENT(HobbyShop hobbyShop) {
	...
	public CC_RECIPIENT(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public CC_RECIPIENT(HomeGoodsStore homeGoodsStore) {
	...
	public CC_RECIPIENT(Hospital hospital) {
	...
	public CC_RECIPIENT(Hostel hostel) {
	...
	public CC_RECIPIENT(Hotel hotel) {
	...
	public CC_RECIPIENT(HousePainter housePainter) {
	...
	public CC_RECIPIENT(IceCreamShop iceCreamShop) {
	...
	public CC_RECIPIENT(InsuranceAgency insuranceAgency) {
	...
	public CC_RECIPIENT(InternetCafe internetCafe) {
	...
	public CC_RECIPIENT(JewelryStore jewelryStore) {
	...
	public CC_RECIPIENT(LegalService legalService) {
	...
	public CC_RECIPIENT(Library library) {
	...
	public CC_RECIPIENT(LibrarySystem librarySystem) {
	...
	public CC_RECIPIENT(LiquorStore liquorStore) {
	...
	public CC_RECIPIENT(LocalBusiness localBusiness) {
	...
	public CC_RECIPIENT(Locksmith locksmith) {
	...
	public CC_RECIPIENT(LodgingBusiness lodgingBusiness) {
	...
	public CC_RECIPIENT(MedicalAudience medicalAudience) {
	...
	public CC_RECIPIENT(MedicalBusiness medicalBusiness) {
	...
	public CC_RECIPIENT(MedicalClinic medicalClinic) {
	...
	public CC_RECIPIENT(MedicalOrganization medicalOrganization) {
	...
	public CC_RECIPIENT(MensClothingStore mensClothingStore) {
	...
	public CC_RECIPIENT(MiddleSchool middleSchool) {
	...
	public CC_RECIPIENT(Midwifery midwifery) {
	...
	public CC_RECIPIENT(MobilePhoneStore mobilePhoneStore) {
	...
	public CC_RECIPIENT(Motel motel) {
	...
	public CC_RECIPIENT(MotorcycleDealer motorcycleDealer) {
	...
	public CC_RECIPIENT(MotorcycleRepair motorcycleRepair) {
	...
	public CC_RECIPIENT(MovieRentalStore movieRentalStore) {
	...
	public CC_RECIPIENT(MovieTheater movieTheater) {
	...
	public CC_RECIPIENT(MovingCompany movingCompany) {
	...
	public CC_RECIPIENT(MusicGroup musicGroup) {
	...
	public CC_RECIPIENT(MusicStore musicStore) {
	...
	public CC_RECIPIENT(NailSalon nailSalon) {
	...
	public CC_RECIPIENT(NewsMediaOrganization newsMediaOrganization) {
	...
	public CC_RECIPIENT(NightClub nightClub) {
	...
	public CC_RECIPIENT(Notary notary) {
	...
	public CC_RECIPIENT(Nursing nursing) {
	...
	public CC_RECIPIENT(Obstetric obstetric) {
	...
	public CC_RECIPIENT(OfficeEquipmentStore officeEquipmentStore) {
	...
	public CC_RECIPIENT(Oncologic oncologic) {
	...
	public CC_RECIPIENT(Optician optician) {
	...
	public CC_RECIPIENT(Optometric optometric) {
	...
	public CC_RECIPIENT(Organization organization) {
	...
	public CC_RECIPIENT(Otolaryngologic otolaryngologic) {
	...
	public CC_RECIPIENT(OutletStore outletStore) {
	...
	public CC_RECIPIENT(ParentAudience parentAudience) {
	...
	public CC_RECIPIENT(Patient patient) {
	...
	public CC_RECIPIENT(PawnShop pawnShop) {
	...
	public CC_RECIPIENT(Pediatric pediatric) {
	...
	public CC_RECIPIENT(PeopleAudience peopleAudience) {
	...
	public CC_RECIPIENT(PerformingGroup performingGroup) {
	...
	public CC_RECIPIENT(Person person) {
	...
	public CC_RECIPIENT(PetStore petStore) {
	...
	public CC_RECIPIENT(Pharmacy pharmacy) {
	...
	public CC_RECIPIENT(Physician physician) {
	...
	public CC_RECIPIENT(Physiotherapy physiotherapy) {
	...
	public CC_RECIPIENT(PlasticSurgery plasticSurgery) {
	...
	public CC_RECIPIENT(Plumber plumber) {
	...
	public CC_RECIPIENT(Podiatric podiatric) {
	...
	public CC_RECIPIENT(PoliceStation policeStation) {
	...
	public CC_RECIPIENT(PostOffice postOffice) {
	...
	public CC_RECIPIENT(PostalAddress postalAddress) {
	...
	public CC_RECIPIENT(Preschool preschool) {
	...
	public CC_RECIPIENT(PrimaryCare primaryCare) {
	...
	public CC_RECIPIENT(ProfessionalService professionalService) {
	...
	public CC_RECIPIENT(Project project) {
	...
	public CC_RECIPIENT(Psychiatric psychiatric) {
	...
	public CC_RECIPIENT(PublicHealth publicHealth) {
	...
	public CC_RECIPIENT(PublicSwimmingPool publicSwimmingPool) {
	...
	public CC_RECIPIENT(RadioStation radioStation) {
	...
	public CC_RECIPIENT(RealEstateAgent realEstateAgent) {
	...
	public CC_RECIPIENT(RecyclingCenter recyclingCenter) {
	...
	public CC_RECIPIENT(ResearchProject researchProject) {
	...
	public CC_RECIPIENT(Resort resort) {
	...
	public CC_RECIPIENT(Restaurant restaurant) {
	...
	public CC_RECIPIENT(RoofingContractor roofingContractor) {
	...
	public CC_RECIPIENT(School school) {
	...
	public CC_RECIPIENT(SelfStorage selfStorage) {
	...
	public CC_RECIPIENT(ShoeStore shoeStore) {
	...
	public CC_RECIPIENT(ShoppingCenter shoppingCenter) {
	...
	public CC_RECIPIENT(SkiResort skiResort) {
	...
	public CC_RECIPIENT(SportingGoodsStore sportingGoodsStore) {
	...
	public CC_RECIPIENT(SportsActivityLocation sportsActivityLocation) {
	...
	public CC_RECIPIENT(SportsClub sportsClub) {
	...
	public CC_RECIPIENT(SportsOrganization sportsOrganization) {
	...
	public CC_RECIPIENT(SportsTeam sportsTeam) {
	...
	public CC_RECIPIENT(StadiumOrArena stadiumOrArena) {
	...
	public CC_RECIPIENT(Store store) {
	...
	public CC_RECIPIENT(TattooParlor tattooParlor) {
	...
	public CC_RECIPIENT(TelevisionStation televisionStation) {
	...
	public CC_RECIPIENT(TennisComplex tennisComplex) {
	...
	public CC_RECIPIENT(TheaterGroup theaterGroup) {
	...
	public CC_RECIPIENT(TireShop tireShop) {
	...
	public CC_RECIPIENT(TouristInformationCenter touristInformationCenter) {
	...
	public CC_RECIPIENT(ToyStore toyStore) {
	...
	public CC_RECIPIENT(TravelAgency travelAgency) {
	...
	public CC_RECIPIENT(VeterinaryCare veterinaryCare) {
	...
	public CC_RECIPIENT(WholesaleStore wholesaleStore) {
	...
	public CC_RECIPIENT(Winery winery) {
	...
	public CC_RECIPIENT(WorkersUnion workersUnion) {
	...
	public void copy(Container.CcRecipient org) {
