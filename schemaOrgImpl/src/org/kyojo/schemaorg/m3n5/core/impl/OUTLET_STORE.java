...
public class OUTLET_STORE implements Clazz.OutletStore {
	...
	public OUTLET_STORE(GeoContains geoContains) {
	...
	public OUTLET_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public OUTLET_STORE(GeoCovers geoCovers) {
	...
	public OUTLET_STORE(GeoCrosses geoCrosses) {
	...
	public OUTLET_STORE(GeoDisjoint geoDisjoint) {
	...
	public OUTLET_STORE(GeoEquals geoEquals) {
	...
	public OUTLET_STORE(GeoIntersects geoIntersects) {
	...
	public OUTLET_STORE(GeoOverlaps geoOverlaps) {
	...
	public OUTLET_STORE(GeoTouches geoTouches) {
	...
	public OUTLET_STORE(GeoWithin geoWithin) {
	...
	public OUTLET_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
