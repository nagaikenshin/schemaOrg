...
public class HVAC_BUSINESS implements Clazz.HVACBusiness {
	...
	public HVAC_BUSINESS(GeoContains geoContains) {
	...
	public HVAC_BUSINESS(GeoCoveredBy geoCoveredBy) {
	...
	public HVAC_BUSINESS(GeoCovers geoCovers) {
	...
	public HVAC_BUSINESS(GeoCrosses geoCrosses) {
	...
	public HVAC_BUSINESS(GeoDisjoint geoDisjoint) {
	...
	public HVAC_BUSINESS(GeoEquals geoEquals) {
	...
	public HVAC_BUSINESS(GeoIntersects geoIntersects) {
	...
	public HVAC_BUSINESS(GeoOverlaps geoOverlaps) {
	...
	public HVAC_BUSINESS(GeoTouches geoTouches) {
	...
	public HVAC_BUSINESS(GeoWithin geoWithin) {
	...
	public HVAC_BUSINESS(Slogan slogan) {
		setSlogan(slogan);
	}
