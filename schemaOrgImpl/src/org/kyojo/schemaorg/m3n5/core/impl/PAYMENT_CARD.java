...
public class PAYMENT_CARD implements Clazz.PaymentCard {
	...
	public PAYMENT_CARD(Long seq) {
		setSeq(seq);
	}

	public PAYMENT_CARD(String string) {
	...
	public PAYMENT_CARD(AdditionalType additionalType) {
	...
	public PAYMENT_CARD(AggregateRating aggregateRating) {
	...
	public PAYMENT_CARD(AlternateName alternateName) {
	...
	public PAYMENT_CARD(AnnualPercentageRate annualPercentageRate) {
	...
	public PAYMENT_CARD(AreaServed areaServed) {
	...
	public PAYMENT_CARD(Audience audience) {
	...
	public PAYMENT_CARD(AvailableChannel availableChannel) {
	...
	public PAYMENT_CARD(Award award) {
		setAward(award);
	}
	...
	public PAYMENT_CARD(Brand brand) {
		setBrand(brand);
	}
	...
	public PAYMENT_CARD(Broker broker) {
		setBroker(broker);
	}
	...
	public PAYMENT_CARD(CashBack cashBack) {
	...
	public PAYMENT_CARD(Category category) {
	...
	public PAYMENT_CARD(ContactlessPayment contactlessPayment) {
	...
	public PAYMENT_CARD(Description description) {
	...
	public PAYMENT_CARD(DisambiguatingDescription disambiguatingDescription) {
	...
	public PAYMENT_CARD(FeesAndCommissionsSpecification feesAndCommissionsSpecification) {
	...
	public PAYMENT_CARD(FloorLimit floorLimit) {
	...
	public PAYMENT_CARD(HasOfferCatalog hasOfferCatalog) {
	...
	public PAYMENT_CARD(HoursAvailable hoursAvailable) {
	...
	public PAYMENT_CARD(Identifier identifier) {
	...
	public PAYMENT_CARD(Image image) {
		setImage(image);
	}
	...
	public PAYMENT_CARD(InterestRate interestRate) {
	...
	public PAYMENT_CARD(IsRelatedTo isRelatedTo) {
	...
	public PAYMENT_CARD(IsSimilarTo isSimilarTo) {
	...
	public PAYMENT_CARD(MainEntityOfPage mainEntityOfPage) {
	...
	public PAYMENT_CARD(NameFuzzy nameFuzzy) {
	...
	public PAYMENT_CARD(NameRuby nameRuby) {
	...
	public PAYMENT_CARD(Offers offers) {
		setOffers(offers);
	}
	...
	public PAYMENT_CARD(PotentialAction potentialAction) {
	...
	public PAYMENT_CARD(Provider provider) {
	...
	public PAYMENT_CARD(ProviderMobility providerMobility) {
	...
	public PAYMENT_CARD(Review review) {
		setReview(review);
	}
	...
	public PAYMENT_CARD(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PAYMENT_CARD(ServiceOutput serviceOutput) {
	...
	public PAYMENT_CARD(ServiceType serviceType) {
	...
	public PAYMENT_CARD(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public PAYMENT_CARD(SubjectOf subjectOf) {
	...
	public PAYMENT_CARD(SupersededBy supersededBy) {
	...
	public PAYMENT_CARD(TermsOfService termsOfService) {
	...
	public void copy(Clazz.PaymentCard org) {
		setSeq(org.getSeq());
