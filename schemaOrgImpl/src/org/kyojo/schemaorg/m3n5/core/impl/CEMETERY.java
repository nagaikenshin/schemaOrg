...
public class CEMETERY implements Clazz.Cemetery {
	...
	public CEMETERY(GeoContains geoContains) {
	...
	public CEMETERY(GeoCoveredBy geoCoveredBy) {
	...
	public CEMETERY(GeoCovers geoCovers) {
	...
	public CEMETERY(GeoCrosses geoCrosses) {
	...
	public CEMETERY(GeoDisjoint geoDisjoint) {
	...
	public CEMETERY(GeoEquals geoEquals) {
	...
	public CEMETERY(GeoIntersects geoIntersects) {
	...
	public CEMETERY(GeoOverlaps geoOverlaps) {
	...
	public CEMETERY(GeoTouches geoTouches) {
	...
	public CEMETERY(GeoWithin geoWithin) {
