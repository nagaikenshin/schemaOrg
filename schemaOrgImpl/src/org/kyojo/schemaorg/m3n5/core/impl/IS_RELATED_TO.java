...
public class IS_RELATED_TO implements Container.IsRelatedTo {
	...
	public IS_RELATED_TO(String string) {
	...
	public IS_RELATED_TO(BankAccount bankAccount) {
	...
	public IS_RELATED_TO(BroadcastService broadcastService) {
	...
	public IS_RELATED_TO(BrokerageAccount brokerageAccount) {
	...
	public IS_RELATED_TO(BusOrCoach busOrCoach) {
	...
	public IS_RELATED_TO(CableOrSatelliteService cableOrSatelliteService) {
	...
	public IS_RELATED_TO(CreditCard creditCard) {
	...
	public IS_RELATED_TO(CurrencyConversionService currencyConversionService) {
	...
	public IS_RELATED_TO(DepositAccount depositAccount) {
	...
	public IS_RELATED_TO(FinancialProduct financialProduct) {
	...
	public IS_RELATED_TO(FoodService foodService) {
	...
	public IS_RELATED_TO(GovernmentService governmentService) {
	...
	public IS_RELATED_TO(IndividualProduct individualProduct) {
	...
	public IS_RELATED_TO(InvestmentFund investmentFund) {
	...
	public IS_RELATED_TO(InvestmentOrDeposit investmentOrDeposit) {
	...
	public IS_RELATED_TO(LoanOrCredit loanOrCredit) {
	...
	public IS_RELATED_TO(MortgageLoan mortgageLoan) {
	...
	public IS_RELATED_TO(Motorcycle motorcycle) {
	...
	public IS_RELATED_TO(MotorizedBicycle motorizedBicycle) {
	...
	public IS_RELATED_TO(PaymentCard paymentCard) {
	...
	public IS_RELATED_TO(PaymentService paymentService) {
	...
	public IS_RELATED_TO(Product product) {
		productList = new ArrayList<Product>();
	...
	public IS_RELATED_TO(ProductModel productModel) {
	...
	public IS_RELATED_TO(RadioBroadcastService radioBroadcastService) {
	...
	public IS_RELATED_TO(Service service) {
	...
	public IS_RELATED_TO(SomeProducts someProducts) {
	...
	public IS_RELATED_TO(TaxiService taxiService) {
	...
	public IS_RELATED_TO(Vehicle vehicle) {
	...
	public IS_RELATED_TO(WebAPI webAPI) {
	...
	public void copy(Container.IsRelatedTo org) {
