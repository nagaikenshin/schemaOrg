...
public class BAKERY implements Clazz.Bakery {
	...
	public BAKERY(GeoContains geoContains) {
	...
	public BAKERY(GeoCoveredBy geoCoveredBy) {
	...
	public BAKERY(GeoCovers geoCovers) {
	...
	public BAKERY(GeoCrosses geoCrosses) {
	...
	public BAKERY(GeoDisjoint geoDisjoint) {
	...
	public BAKERY(GeoEquals geoEquals) {
	...
	public BAKERY(GeoIntersects geoIntersects) {
	...
	public BAKERY(GeoOverlaps geoOverlaps) {
	...
	public BAKERY(GeoTouches geoTouches) {
	...
	public BAKERY(GeoWithin geoWithin) {
