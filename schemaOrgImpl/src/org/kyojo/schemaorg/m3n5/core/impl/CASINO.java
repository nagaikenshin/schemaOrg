...
public class CASINO implements Clazz.Casino {
	...
	public CASINO(GeoContains geoContains) {
	...
	public CASINO(GeoCoveredBy geoCoveredBy) {
	...
	public CASINO(GeoCovers geoCovers) {
	...
	public CASINO(GeoCrosses geoCrosses) {
	...
	public CASINO(GeoDisjoint geoDisjoint) {
	...
	public CASINO(GeoEquals geoEquals) {
	...
	public CASINO(GeoIntersects geoIntersects) {
	...
	public CASINO(GeoOverlaps geoOverlaps) {
	...
	public CASINO(GeoTouches geoTouches) {
	...
	public CASINO(GeoWithin geoWithin) {
