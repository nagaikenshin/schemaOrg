...
public class RADIO_EPISODE implements Clazz.RadioEpisode {
	...
	public RADIO_EPISODE() {
	}

	public RADIO_EPISODE(Long seq) {
		setSeq(seq);
	}

	public RADIO_EPISODE(String string) {
	...
	public RADIO_EPISODE(About about) {
		setAbout(about);
	}
	...
	public RADIO_EPISODE(AccessMode accessMode) {
	...
	public RADIO_EPISODE(AccessModeSufficient accessModeSufficient) {
	...
	public RADIO_EPISODE(AccessibilityAPI accessibilityAPI) {
	...
	public RADIO_EPISODE(AccessibilityControl accessibilityControl) {
	...
	public RADIO_EPISODE(AccessibilityFeature accessibilityFeature) {
	...
	public RADIO_EPISODE(AccessibilityHazard accessibilityHazard) {
	...
	public RADIO_EPISODE(AccessibilitySummary accessibilitySummary) {
	...
	public RADIO_EPISODE(AccountablePerson accountablePerson) {
	...
	public RADIO_EPISODE(Actor actor) {
		setActor(actor);
	}
	...
	public RADIO_EPISODE(AdditionalType additionalType) {
	...
	public RADIO_EPISODE(AggregateRating aggregateRating) {
	...
	public RADIO_EPISODE(AlternateName alternateName) {
	...
	public RADIO_EPISODE(AlternativeHeadline alternativeHeadline) {
	...
	public RADIO_EPISODE(AssociatedMedia associatedMedia) {
	...
	public RADIO_EPISODE(Audience audience) {
	...
	public RADIO_EPISODE(Audio audio) {
		setAudio(audio);
	}
	...
	public RADIO_EPISODE(Author author) {
		setAuthor(author);
	}
	...
	public RADIO_EPISODE(Award award) {
		setAward(award);
	}
	...
	public RADIO_EPISODE(Character character) {
	...
	public RADIO_EPISODE(Citation citation) {
	...
	public RADIO_EPISODE(Comment comment) {
		setComment(comment);
	}
	...
	public RADIO_EPISODE(CommentCount commentCount) {
	...
	public RADIO_EPISODE(ContentLocation contentLocation) {
	...
	public RADIO_EPISODE(ContentRating contentRating) {
	...
	public RADIO_EPISODE(ContentReferenceTime contentReferenceTime) {
	...
	public RADIO_EPISODE(Contributor contributor) {
	...
	public RADIO_EPISODE(CopyrightHolder copyrightHolder) {
	...
	public RADIO_EPISODE(CopyrightYear copyrightYear) {
	...
	public RADIO_EPISODE(Correction correction) {
	...
	public RADIO_EPISODE(Creator creator) {
		setCreator(creator);
	}
	...
	public RADIO_EPISODE(DateCreated dateCreated) {
	...
	public RADIO_EPISODE(DateModified dateModified) {
	...
	public RADIO_EPISODE(DatePublished datePublished) {
	...
	public RADIO_EPISODE(Description description) {
	...
	public RADIO_EPISODE(Director director) {
	...
	public RADIO_EPISODE(DisambiguatingDescription disambiguatingDescription) {
	...
	public RADIO_EPISODE(DiscussionUrl discussionUrl) {
	...
	public RADIO_EPISODE(Editor editor) {
		setEditor(editor);
	}
	...
	public RADIO_EPISODE(EducationalAlignment educationalAlignment) {
	...
	public RADIO_EPISODE(EducationalUse educationalUse) {
	...
	public RADIO_EPISODE(Encoding encoding) {
	...
	public RADIO_EPISODE(EncodingFormat encodingFormat) {
	...
	public RADIO_EPISODE(EpisodeNumber episodeNumber) {
	...
	public RADIO_EPISODE(ExampleOfWork exampleOfWork) {
	...
	public RADIO_EPISODE(Expires expires) {
		setExpires(expires);
	}
	...
	public RADIO_EPISODE(Funder funder) {
		setFunder(funder);
	}
	...
	public RADIO_EPISODE(Genre genre) {
		setGenre(genre);
	}
	...
	public RADIO_EPISODE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public RADIO_EPISODE(Headline headline) {
	...
	public RADIO_EPISODE(Identifier identifier) {
	...
	public RADIO_EPISODE(Image image) {
		setImage(image);
	}
	...
	public RADIO_EPISODE(InLanguage inLanguage) {
	...
	public RADIO_EPISODE(InteractionStatistic interactionStatistic) {
	...
	public RADIO_EPISODE(InteractivityType interactivityType) {
	...
	public RADIO_EPISODE(IsAccessibleForFree isAccessibleForFree) {
	...
	public RADIO_EPISODE(IsBasedOn isBasedOn) {
	...
	public RADIO_EPISODE(IsFamilyFriendly isFamilyFriendly) {
	...
	public RADIO_EPISODE(IsPartOf isPartOf) {
	...
	public RADIO_EPISODE(Keywords keywords) {
	...
	public RADIO_EPISODE(LearningResourceType learningResourceType) {
	...
	public RADIO_EPISODE(License license) {
		setLicense(license);
	}
	...
	public RADIO_EPISODE(LocationCreated locationCreated) {
	...
	public RADIO_EPISODE(MainEntity mainEntity) {
	...
	public RADIO_EPISODE(MainEntityOfPage mainEntityOfPage) {
	...
	public RADIO_EPISODE(Material material) {
	...
	public RADIO_EPISODE(MaterialExtent materialExtent) {
	...
	public RADIO_EPISODE(Mentions mentions) {
	...
	public RADIO_EPISODE(MusicBy musicBy) {
		setMusicBy(musicBy);
	}
	...
	public RADIO_EPISODE(Name name) {
		setName(name);
	}
	...
	public RADIO_EPISODE(NameFuzzy nameFuzzy) {
	...
	public RADIO_EPISODE(NameRuby nameRuby) {
	...
	public RADIO_EPISODE(Offers offers) {
		setOffers(offers);
	}
	...
	public RADIO_EPISODE(PartOfSeason partOfSeason) {
	...
	public RADIO_EPISODE(PartOfSeries partOfSeries) {
	...
	public RADIO_EPISODE(Position position) {
	...
	public RADIO_EPISODE(PotentialAction potentialAction) {
	...
	public RADIO_EPISODE(Producer producer) {
	...
	public RADIO_EPISODE(ProductionCompany productionCompany) {
	...
	public RADIO_EPISODE(Provider provider) {
	...
	public RADIO_EPISODE(Publication publication) {
	...
	public RADIO_EPISODE(Publisher publisher) {
	...
	public RADIO_EPISODE(PublisherImprint publisherImprint) {
	...
	public RADIO_EPISODE(PublishingPrinciples publishingPrinciples) {
	...
	public RADIO_EPISODE(RecordedAt recordedAt) {
	...
	public RADIO_EPISODE(ReleasedEvent releasedEvent) {
	...
	public RADIO_EPISODE(Review review) {
		setReview(review);
	}
	...
	public RADIO_EPISODE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RADIO_EPISODE(SchemaVersion schemaVersion) {
	...
	public RADIO_EPISODE(SdDatePublished sdDatePublished) {
	...
	public RADIO_EPISODE(SdLicense sdLicense) {
	...
	public RADIO_EPISODE(SdPublisher sdPublisher) {
	...
	public RADIO_EPISODE(SourceOrganization sourceOrganization) {
	...
	public RADIO_EPISODE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public RADIO_EPISODE(SpatialCoverage spatialCoverage) {
	...
	public RADIO_EPISODE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public RADIO_EPISODE(SubjectOf subjectOf) {
	...
	public RADIO_EPISODE(Temporal temporal) {
	...
	public RADIO_EPISODE(TemporalCoverage temporalCoverage) {
	...
	public RADIO_EPISODE(Text text) {
		setText(text);
	}
	...
	public RADIO_EPISODE(ThumbnailUrl thumbnailUrl) {
	...
	public RADIO_EPISODE(TimeRequired timeRequired) {
	...
	public RADIO_EPISODE(Trailer trailer) {
		setTrailer(trailer);
	}
	...
	public RADIO_EPISODE(TranslationOfWork translationOfWork) {
	...
	public RADIO_EPISODE(Translator translator) {
	...
	public RADIO_EPISODE(TypicalAgeRange typicalAgeRange) {
	...
	public RADIO_EPISODE(Version version) {
		setVersion(version);
	}
	...
	public RADIO_EPISODE(Video video) {
		setVideo(video);
	}
	...
	public RADIO_EPISODE(WorkExample workExample) {
	...
	public RADIO_EPISODE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.RadioEpisode org) {
		setSeq(org.getSeq());
