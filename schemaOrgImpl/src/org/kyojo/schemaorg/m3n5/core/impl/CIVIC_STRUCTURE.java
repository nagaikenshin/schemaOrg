...
public class CIVIC_STRUCTURE implements Clazz.CivicStructure {
	...
	public CIVIC_STRUCTURE(GeoContains geoContains) {
	...
	public CIVIC_STRUCTURE(GeoCoveredBy geoCoveredBy) {
	...
	public CIVIC_STRUCTURE(GeoCovers geoCovers) {
	...
	public CIVIC_STRUCTURE(GeoCrosses geoCrosses) {
	...
	public CIVIC_STRUCTURE(GeoDisjoint geoDisjoint) {
	...
	public CIVIC_STRUCTURE(GeoEquals geoEquals) {
	...
	public CIVIC_STRUCTURE(GeoIntersects geoIntersects) {
	...
	public CIVIC_STRUCTURE(GeoOverlaps geoOverlaps) {
	...
	public CIVIC_STRUCTURE(GeoTouches geoTouches) {
	...
	public CIVIC_STRUCTURE(GeoWithin geoWithin) {
	...
	public CIVIC_STRUCTURE(Slogan slogan) {
		setSlogan(slogan);
	}
