...
public class RESERVE_ACTION implements Clazz.ReserveAction {
	...
	public RESERVE_ACTION() {
	}

	public RESERVE_ACTION(Long seq) {
		setSeq(seq);
	}

	public RESERVE_ACTION(String string) {
	...
	public RESERVE_ACTION(ActionStatus actionStatus) {
	...
	public RESERVE_ACTION(AdditionalType additionalType) {
	...
	public RESERVE_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public RESERVE_ACTION(AlternateName alternateName) {
	...
	public RESERVE_ACTION(Description description) {
	...
	public RESERVE_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public RESERVE_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public RESERVE_ACTION(Error error) {
		setError(error);
	}
	...
	public RESERVE_ACTION(Identifier identifier) {
	...
	public RESERVE_ACTION(Image image) {
		setImage(image);
	}
	...
	public RESERVE_ACTION(Instrument instrument) {
	...
	public RESERVE_ACTION(Location location) {
	...
	public RESERVE_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public RESERVE_ACTION(Name name) {
		setName(name);
	}
	...
	public RESERVE_ACTION(NameFuzzy nameFuzzy) {
	...
	public RESERVE_ACTION(NameRuby nameRuby) {
	...
	public RESERVE_ACTION(Object object) {
		setObject(object);
	}
	...
	public RESERVE_ACTION(Participant participant) {
	...
	public RESERVE_ACTION(PotentialAction potentialAction) {
	...
	public RESERVE_ACTION(Result result) {
		setResult(result);
	}
	...
	public RESERVE_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RESERVE_ACTION(ScheduledTime scheduledTime) {
	...
	public RESERVE_ACTION(StartTime startTime) {
	...
	public RESERVE_ACTION(SubjectOf subjectOf) {
	...
	public RESERVE_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.ReserveAction org) {
		setSeq(org.getSeq());
