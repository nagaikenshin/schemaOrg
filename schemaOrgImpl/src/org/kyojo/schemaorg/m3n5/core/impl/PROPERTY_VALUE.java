...
public class PROPERTY_VALUE implements Clazz.PropertyValue {
	...
	public PROPERTY_VALUE(Long seq) {
		setSeq(seq);
	}

	public PROPERTY_VALUE(String string) {
	...
	public PROPERTY_VALUE(AdditionalType additionalType) {
	...
	public PROPERTY_VALUE(AlternateName alternateName) {
	...
	public PROPERTY_VALUE(Description description) {
	...
	public PROPERTY_VALUE(DisambiguatingDescription disambiguatingDescription) {
	...
	public PROPERTY_VALUE(Identifier identifier) {
	...
	public PROPERTY_VALUE(Image image) {
		setImage(image);
	}
	...
	public PROPERTY_VALUE(MainEntityOfPage mainEntityOfPage) {
	...
	public PROPERTY_VALUE(MaxValue maxValue) {
	...
	public PROPERTY_VALUE(MeasurementTechnique measurementTechnique) {
	...
	public PROPERTY_VALUE(MinValue minValue) {
	...
	public PROPERTY_VALUE(Name name) {
		setName(name);
	}
	...
	public PROPERTY_VALUE(NameFuzzy nameFuzzy) {
	...
	public PROPERTY_VALUE(NameRuby nameRuby) {
	...
	public PROPERTY_VALUE(PotentialAction potentialAction) {
	...
	public PROPERTY_VALUE(PropertyID propertyID) {
	...
	public PROPERTY_VALUE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PROPERTY_VALUE(SubjectOf subjectOf) {
	...
	public PROPERTY_VALUE(UnitCode unitCode) {
	...
	public PROPERTY_VALUE(UnitText unitText) {
	...
	public PROPERTY_VALUE(Value value) {
		setValue(value);
	}
	...
	public PROPERTY_VALUE(ValueReference valueReference) {
	...
	public void copy(Clazz.PropertyValue org) {
		setSeq(org.getSeq());
