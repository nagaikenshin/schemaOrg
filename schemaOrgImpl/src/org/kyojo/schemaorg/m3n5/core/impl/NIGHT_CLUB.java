...
public class NIGHT_CLUB implements Clazz.NightClub {
	...
	public NIGHT_CLUB(GeoContains geoContains) {
	...
	public NIGHT_CLUB(GeoCoveredBy geoCoveredBy) {
	...
	public NIGHT_CLUB(GeoCovers geoCovers) {
	...
	public NIGHT_CLUB(GeoCrosses geoCrosses) {
	...
	public NIGHT_CLUB(GeoDisjoint geoDisjoint) {
	...
	public NIGHT_CLUB(GeoEquals geoEquals) {
	...
	public NIGHT_CLUB(GeoIntersects geoIntersects) {
	...
	public NIGHT_CLUB(GeoOverlaps geoOverlaps) {
	...
	public NIGHT_CLUB(GeoTouches geoTouches) {
	...
	public NIGHT_CLUB(GeoWithin geoWithin) {
	...
	public NIGHT_CLUB(Slogan slogan) {
		setSlogan(slogan);
	}
