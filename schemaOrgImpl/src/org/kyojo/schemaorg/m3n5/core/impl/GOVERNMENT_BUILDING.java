...
public class GOVERNMENT_BUILDING implements Clazz.GovernmentBuilding {
	...
	public GOVERNMENT_BUILDING(GeoContains geoContains) {
	...
	public GOVERNMENT_BUILDING(GeoCoveredBy geoCoveredBy) {
	...
	public GOVERNMENT_BUILDING(GeoCovers geoCovers) {
	...
	public GOVERNMENT_BUILDING(GeoCrosses geoCrosses) {
	...
	public GOVERNMENT_BUILDING(GeoDisjoint geoDisjoint) {
	...
	public GOVERNMENT_BUILDING(GeoEquals geoEquals) {
	...
	public GOVERNMENT_BUILDING(GeoIntersects geoIntersects) {
	...
	public GOVERNMENT_BUILDING(GeoOverlaps geoOverlaps) {
	...
	public GOVERNMENT_BUILDING(GeoTouches geoTouches) {
	...
	public GOVERNMENT_BUILDING(GeoWithin geoWithin) {
	...
	public GOVERNMENT_BUILDING(Slogan slogan) {
		setSlogan(slogan);
	}
