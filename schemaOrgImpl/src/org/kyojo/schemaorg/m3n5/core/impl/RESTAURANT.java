...
public class RESTAURANT implements Clazz.Restaurant {
	...
	public RESTAURANT(GeoContains geoContains) {
	...
	public RESTAURANT(GeoCoveredBy geoCoveredBy) {
	...
	public RESTAURANT(GeoCovers geoCovers) {
	...
	public RESTAURANT(GeoCrosses geoCrosses) {
	...
	public RESTAURANT(GeoDisjoint geoDisjoint) {
	...
	public RESTAURANT(GeoEquals geoEquals) {
	...
	public RESTAURANT(GeoIntersects geoIntersects) {
	...
	public RESTAURANT(GeoOverlaps geoOverlaps) {
	...
	public RESTAURANT(GeoTouches geoTouches) {
	...
	public RESTAURANT(GeoWithin geoWithin) {
	...
	public RESTAURANT(Slogan slogan) {
		setSlogan(slogan);
	}
