...
public class SPATIAL implements Container.Spatial {
	...
	public SPATIAL(Accommodation accommodation) {
	...
	public SPATIAL(AccountingService accountingService) {
	...
	public SPATIAL(AdministrativeArea administrativeArea) {
	...
	public SPATIAL(AdultEntertainment adultEntertainment) {
	...
	public SPATIAL(Airport airport) {
	...
	public SPATIAL(AmusementPark amusementPark) {
	...
	public SPATIAL(AnimalShelter animalShelter) {
	...
	public SPATIAL(Apartment apartment) {
	...
	public SPATIAL(ApartmentComplex apartmentComplex) {
	...
	public SPATIAL(Aquarium aquarium) {
	...
	public SPATIAL(ArchiveOrganization archiveOrganization) {
	...
	public SPATIAL(ArtGallery artGallery) {
	...
	public SPATIAL(Attorney attorney) {
	...
	public SPATIAL(AutoBodyShop autoBodyShop) {
	...
	public SPATIAL(AutoDealer autoDealer) {
	...
	public SPATIAL(AutoPartsStore autoPartsStore) {
	...
	public SPATIAL(AutoRental autoRental) {
	...
	public SPATIAL(AutoRepair autoRepair) {
	...
	public SPATIAL(AutoWash autoWash) {
	...
	public SPATIAL(AutomatedTeller automatedTeller) {
	...
	public SPATIAL(AutomotiveBusiness automotiveBusiness) {
	...
	public SPATIAL(BankOrCreditUnion bankOrCreditUnion) {
	...
	public SPATIAL(BarOrPub barOrPub) {
	...
	public SPATIAL(BeautySalon beautySalon) {
	...
	public SPATIAL(BedAndBreakfast bedAndBreakfast) {
	...
	public SPATIAL(BikeStore bikeStore) {
	...
	public SPATIAL(BodyOfWater bodyOfWater) {
	...
	public SPATIAL(BookStore bookStore) {
	...
	public SPATIAL(BowlingAlley bowlingAlley) {
	...
	public SPATIAL(Brewery brewery) {
	...
	public SPATIAL(BuddhistTemple buddhistTemple) {
	...
	public SPATIAL(BusStation busStation) {
	...
	public SPATIAL(BusStop busStop) {
	...
	public SPATIAL(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public SPATIAL(Campground campground) {
	...
	public SPATIAL(CampingPitch campingPitch) {
	...
	public SPATIAL(CatholicChurch catholicChurch) {
	...
	public SPATIAL(Cemetery cemetery) {
	...
	public SPATIAL(ChildCare childCare) {
	...
	public SPATIAL(CityHall cityHall) {
	...
	public SPATIAL(CivicStructure civicStructure) {
	...
	public SPATIAL(ClothingStore clothingStore) {
	...
	public SPATIAL(ComedyClub comedyClub) {
	...
	public SPATIAL(CommunityHealth communityHealth) {
	...
	public SPATIAL(ComputerStore computerStore) {
	...
	public SPATIAL(Continent continent) {
	...
	public SPATIAL(ConvenienceStore convenienceStore) {
	...
	public SPATIAL(Country country) {
	...
	public SPATIAL(Courthouse courthouse) {
	...
	public SPATIAL(Crematorium crematorium) {
	...
	public SPATIAL(DefenceEstablishment defenceEstablishment) {
	...
	public SPATIAL(Dentist dentist) {
	...
	public SPATIAL(DepartmentStore departmentStore) {
	...
	public SPATIAL(Dermatology dermatology) {
	...
	public SPATIAL(DietNutrition dietNutrition) {
	...
	public SPATIAL(Distillery distillery) {
	...
	public SPATIAL(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public SPATIAL(Electrician electrician) {
	...
	public SPATIAL(ElectronicsStore electronicsStore) {
	...
	public SPATIAL(Embassy embassy) {
	...
	public SPATIAL(Emergency emergency) {
	...
	public SPATIAL(EmergencyService emergencyService) {
	...
	public SPATIAL(EmploymentAgency employmentAgency) {
	...
	public SPATIAL(EntertainmentBusiness entertainmentBusiness) {
	...
	public SPATIAL(EventVenue eventVenue) {
	...
	public SPATIAL(ExerciseGym exerciseGym) {
	...
	public SPATIAL(FastFoodRestaurant fastFoodRestaurant) {
	...
	public SPATIAL(FinancialService financialService) {
	...
	public SPATIAL(FireStation fireStation) {
	...
	public SPATIAL(Florist florist) {
	...
	public SPATIAL(FoodEstablishment foodEstablishment) {
	...
	public SPATIAL(FurnitureStore furnitureStore) {
	...
	public SPATIAL(GardenStore gardenStore) {
	...
	public SPATIAL(GasStation gasStation) {
	...
	public SPATIAL(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public SPATIAL(GeneralContractor generalContractor) {
	...
	public SPATIAL(Geriatric geriatric) {
	...
	public SPATIAL(GolfCourse golfCourse) {
	...
	public SPATIAL(GovernmentBuilding governmentBuilding) {
	...
	public SPATIAL(GovernmentOffice governmentOffice) {
	...
	public SPATIAL(GroceryStore groceryStore) {
	...
	public SPATIAL(Gynecologic gynecologic) {
	...
	public SPATIAL(HVACBusiness hvacBusiness) {
	...
	public SPATIAL(HairSalon hairSalon) {
	...
	public SPATIAL(HardwareStore hardwareStore) {
	...
	public SPATIAL(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public SPATIAL(HealthClub healthClub) {
	...
	public SPATIAL(HinduTemple hinduTemple) {
	...
	public SPATIAL(HobbyShop hobbyShop) {
	...
	public SPATIAL(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public SPATIAL(HomeGoodsStore homeGoodsStore) {
	...
	public SPATIAL(Hospital hospital) {
	...
	public SPATIAL(HotelRoom hotelRoom) {
	...
	public SPATIAL(HousePainter housePainter) {
	...
	public SPATIAL(IceCreamShop iceCreamShop) {
	...
	public SPATIAL(InsuranceAgency insuranceAgency) {
	...
	public SPATIAL(InternetCafe internetCafe) {
	...
	public SPATIAL(JewelryStore jewelryStore) {
	...
	public SPATIAL(LakeBodyOfWater lakeBodyOfWater) {
	...
	public SPATIAL(Landform landform) {
	...
	public SPATIAL(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public SPATIAL(LegalService legalService) {
	...
	public SPATIAL(LegislativeBuilding legislativeBuilding) {
	...
	public SPATIAL(Library library) {
	...
	public SPATIAL(LiquorStore liquorStore) {
	...
	public SPATIAL(LocalBusiness localBusiness) {
	...
	public SPATIAL(Locksmith locksmith) {
	...
	public SPATIAL(LodgingBusiness lodgingBusiness) {
	...
	public SPATIAL(MedicalBusiness medicalBusiness) {
	...
	public SPATIAL(MedicalClinic medicalClinic) {
	...
	public SPATIAL(MeetingRoom meetingRoom) {
	...
	public SPATIAL(MensClothingStore mensClothingStore) {
	...
	public SPATIAL(Midwifery midwifery) {
	...
	public SPATIAL(MobilePhoneStore mobilePhoneStore) {
	...
	public SPATIAL(MotorcycleDealer motorcycleDealer) {
	...
	public SPATIAL(MotorcycleRepair motorcycleRepair) {
	...
	public SPATIAL(Mountain mountain) {
	...
	public SPATIAL(MovieRentalStore movieRentalStore) {
	...
	public SPATIAL(MovieTheater movieTheater) {
	...
	public SPATIAL(MovingCompany movingCompany) {
	...
	public SPATIAL(MusicStore musicStore) {
	...
	public SPATIAL(MusicVenue musicVenue) {
	...
	public SPATIAL(NailSalon nailSalon) {
	...
	public SPATIAL(NightClub nightClub) {
	...
	public SPATIAL(Nursing nursing) {
	...
	public SPATIAL(Obstetric obstetric) {
	...
	public SPATIAL(OceanBodyOfWater oceanBodyOfWater) {
	...
	public SPATIAL(OfficeEquipmentStore officeEquipmentStore) {
	...
	public SPATIAL(Oncologic oncologic) {
	...
	public SPATIAL(Optician optician) {
	...
	public SPATIAL(Optometric optometric) {
	...
	public SPATIAL(Otolaryngologic otolaryngologic) {
	...
	public SPATIAL(OutletStore outletStore) {
	...
	public SPATIAL(ParkingFacility parkingFacility) {
	...
	public SPATIAL(PawnShop pawnShop) {
	...
	public SPATIAL(Pediatric pediatric) {
	...
	public SPATIAL(PerformingArtsTheater performingArtsTheater) {
	...
	public SPATIAL(PetStore petStore) {
	...
	public SPATIAL(Pharmacy pharmacy) {
	...
	public SPATIAL(Physician physician) {
	...
	public SPATIAL(Physiotherapy physiotherapy) {
	...
	public SPATIAL(PlaceOfWorship placeOfWorship) {
	...
	public SPATIAL(PlasticSurgery plasticSurgery) {
	...
	public SPATIAL(Playground playground) {
	...
	public SPATIAL(Plumber plumber) {
	...
	public SPATIAL(Podiatric podiatric) {
	...
	public SPATIAL(PoliceStation policeStation) {
	...
	public SPATIAL(PostOffice postOffice) {
	...
	public SPATIAL(PrimaryCare primaryCare) {
	...
	public SPATIAL(ProfessionalService professionalService) {
	...
	public SPATIAL(Psychiatric psychiatric) {
	...
	public SPATIAL(PublicHealth publicHealth) {
	...
	public SPATIAL(PublicSwimmingPool publicSwimmingPool) {
	...
	public SPATIAL(PublicToilet publicToilet) {
	...
	public SPATIAL(RadioStation radioStation) {
	...
	public SPATIAL(RealEstateAgent realEstateAgent) {
	...
	public SPATIAL(RecyclingCenter recyclingCenter) {
	...
	public SPATIAL(Reservoir reservoir) {
	...
	public SPATIAL(Residence residence) {
	...
	public SPATIAL(Restaurant restaurant) {
	...
	public SPATIAL(RiverBodyOfWater riverBodyOfWater) {
	...
	public SPATIAL(RoofingContractor roofingContractor) {
	...
	public SPATIAL(SeaBodyOfWater seaBodyOfWater) {
	...
	public SPATIAL(SelfStorage selfStorage) {
	...
	public SPATIAL(ShoeStore shoeStore) {
	...
	public SPATIAL(ShoppingCenter shoppingCenter) {
	...
	public SPATIAL(SingleFamilyResidence singleFamilyResidence) {
	...
	public SPATIAL(SkiResort skiResort) {
	...
	public SPATIAL(SportingGoodsStore sportingGoodsStore) {
	...
	public SPATIAL(SportsActivityLocation sportsActivityLocation) {
	...
	public SPATIAL(SportsClub sportsClub) {
	...
	public SPATIAL(StadiumOrArena stadiumOrArena) {
	...
	public SPATIAL(SubwayStation subwayStation) {
	...
	public SPATIAL(Synagogue synagogue) {
	...
	public SPATIAL(TattooParlor tattooParlor) {
	...
	public SPATIAL(TaxiStand taxiStand) {
	...
	public SPATIAL(TelevisionStation televisionStation) {
	...
	public SPATIAL(TennisComplex tennisComplex) {
	...
	public SPATIAL(TireShop tireShop) {
	...
	public SPATIAL(TouristAttraction touristAttraction) {
	...
	public SPATIAL(TouristDestination touristDestination) {
	...
	public SPATIAL(TouristInformationCenter touristInformationCenter) {
	...
	public SPATIAL(ToyStore toyStore) {
	...
	public SPATIAL(TrainStation trainStation) {
	...
	public SPATIAL(TravelAgency travelAgency) {
	...
	public SPATIAL(Volcano volcano) {
	...
	public SPATIAL(Waterfall waterfall) {
	...
	public SPATIAL(WholesaleStore wholesaleStore) {
	...
	public void copy(Container.Spatial org) {
