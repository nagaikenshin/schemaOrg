...
public class CONTROL_ACTION implements Clazz.ControlAction {
	...
	public CONTROL_ACTION(Long seq) {
		setSeq(seq);
	}

	public CONTROL_ACTION(String string) {
	...
	public CONTROL_ACTION(ActionStatus actionStatus) {
	...
	public CONTROL_ACTION(AdditionalType additionalType) {
	...
	public CONTROL_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public CONTROL_ACTION(AlternateName alternateName) {
	...
	public CONTROL_ACTION(Description description) {
	...
	public CONTROL_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public CONTROL_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public CONTROL_ACTION(Error error) {
		setError(error);
	}
	...
	public CONTROL_ACTION(Identifier identifier) {
	...
	public CONTROL_ACTION(Image image) {
		setImage(image);
	}
	...
	public CONTROL_ACTION(Instrument instrument) {
	...
	public CONTROL_ACTION(Location location) {
	...
	public CONTROL_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public CONTROL_ACTION(Name name) {
		setName(name);
	}
	...
	public CONTROL_ACTION(NameFuzzy nameFuzzy) {
	...
	public CONTROL_ACTION(NameRuby nameRuby) {
	...
	public CONTROL_ACTION(Object object) {
		setObject(object);
	}
	...
	public CONTROL_ACTION(Participant participant) {
	...
	public CONTROL_ACTION(PotentialAction potentialAction) {
	...
	public CONTROL_ACTION(Result result) {
		setResult(result);
	}
	...
	public CONTROL_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CONTROL_ACTION(StartTime startTime) {
	...
	public CONTROL_ACTION(SubjectOf subjectOf) {
	...
	public CONTROL_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.ControlAction org) {
		setSeq(org.getSeq());
