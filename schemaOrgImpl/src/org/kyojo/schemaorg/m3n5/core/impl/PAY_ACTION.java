...
public class PAY_ACTION implements Clazz.PayAction {
	...
	public PAY_ACTION(Long seq) {
		setSeq(seq);
	}

	public PAY_ACTION(String string) {
	...
	public PAY_ACTION(ActionStatus actionStatus) {
	...
	public PAY_ACTION(AdditionalType additionalType) {
	...
	public PAY_ACTION(AlternateName alternateName) {
	...
	public PAY_ACTION(Description description) {
	...
	public PAY_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public PAY_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public PAY_ACTION(Identifier identifier) {
	...
	public PAY_ACTION(Instrument instrument) {
	...
	public PAY_ACTION(Location location) {
	...
	public PAY_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public PAY_ACTION(NameFuzzy nameFuzzy) {
	...
	public PAY_ACTION(NameRuby nameRuby) {
	...
	public PAY_ACTION(Object object) {
		setObject(object);
	}
	...
	public PAY_ACTION(Participant participant) {
	...
	public PAY_ACTION(PotentialAction potentialAction) {
	...
	public PAY_ACTION(PriceCurrency priceCurrency) {
	...
	public PAY_ACTION(PriceSpecification priceSpecification) {
	...
	public PAY_ACTION(Purpose purpose) {
		setPurpose(purpose);
	}
	...
	public PAY_ACTION(Recipient recipient) {
	...
	public PAY_ACTION(Result result) {
		setResult(result);
	}
	...
	public PAY_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PAY_ACTION(StartTime startTime) {
	...
	public PAY_ACTION(SubjectOf subjectOf) {
	...
	public PAY_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.PayAction org) {
		setSeq(org.getSeq());
