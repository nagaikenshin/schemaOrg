...
public class BORROWER implements Container.Borrower {
	...
	public BORROWER(AccountingService accountingService) {
	...
	public BORROWER(AdultEntertainment adultEntertainment) {
	...
	public BORROWER(Airline airline) {
	...
	public BORROWER(AmusementPark amusementPark) {
	...
	public BORROWER(AnimalShelter animalShelter) {
	...
	public BORROWER(ArchiveOrganization archiveOrganization) {
	...
	public BORROWER(ArtGallery artGallery) {
	...
	public BORROWER(Attorney attorney) {
	...
	public BORROWER(AutoBodyShop autoBodyShop) {
	...
	public BORROWER(AutoDealer autoDealer) {
	...
	public BORROWER(AutoPartsStore autoPartsStore) {
	...
	public BORROWER(AutoRental autoRental) {
	...
	public BORROWER(AutoRepair autoRepair) {
	...
	public BORROWER(AutoWash autoWash) {
	...
	public BORROWER(AutomatedTeller automatedTeller) {
	...
	public BORROWER(AutomotiveBusiness automotiveBusiness) {
	...
	public BORROWER(BankOrCreditUnion bankOrCreditUnion) {
	...
	public BORROWER(BarOrPub barOrPub) {
	...
	public BORROWER(BeautySalon beautySalon) {
	...
	public BORROWER(BedAndBreakfast bedAndBreakfast) {
	...
	public BORROWER(BikeStore bikeStore) {
	...
	public BORROWER(BookStore bookStore) {
	...
	public BORROWER(BowlingAlley bowlingAlley) {
	...
	public BORROWER(Brewery brewery) {
	...
	public BORROWER(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public BORROWER(Campground campground) {
	...
	public BORROWER(ChildCare childCare) {
	...
	public BORROWER(ClothingStore clothingStore) {
	...
	public BORROWER(CollegeOrUniversity collegeOrUniversity) {
	...
	public BORROWER(ComedyClub comedyClub) {
	...
	public BORROWER(CommunityHealth communityHealth) {
	...
	public BORROWER(ComputerStore computerStore) {
	...
	public BORROWER(Consortium consortium) {
	...
	public BORROWER(ConvenienceStore convenienceStore) {
	...
	public BORROWER(Corporation corporation) {
	...
	public BORROWER(DanceGroup danceGroup) {
	...
	public BORROWER(Dentist dentist) {
	...
	public BORROWER(DepartmentStore departmentStore) {
	...
	public BORROWER(Dermatology dermatology) {
	...
	public BORROWER(DiagnosticLab diagnosticLab) {
	...
	public BORROWER(DietNutrition dietNutrition) {
	...
	public BORROWER(Distillery distillery) {
	...
	public BORROWER(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public BORROWER(EducationalOrganization educationalOrganization) {
	...
	public BORROWER(Electrician electrician) {
	...
	public BORROWER(ElectronicsStore electronicsStore) {
	...
	public BORROWER(ElementarySchool elementarySchool) {
	...
	public BORROWER(Emergency emergency) {
	...
	public BORROWER(EmergencyService emergencyService) {
	...
	public BORROWER(EmploymentAgency employmentAgency) {
	...
	public BORROWER(EntertainmentBusiness entertainmentBusiness) {
	...
	public BORROWER(ExerciseGym exerciseGym) {
	...
	public BORROWER(FastFoodRestaurant fastFoodRestaurant) {
	...
	public BORROWER(FinancialService financialService) {
	...
	public BORROWER(FireStation fireStation) {
	...
	public BORROWER(Florist florist) {
	...
	public BORROWER(FoodEstablishment foodEstablishment) {
	...
	public BORROWER(FundingAgency fundingAgency) {
	...
	public BORROWER(FundingScheme fundingScheme) {
	...
	public BORROWER(FurnitureStore furnitureStore) {
	...
	public BORROWER(GardenStore gardenStore) {
	...
	public BORROWER(GasStation gasStation) {
	...
	public BORROWER(GeneralContractor generalContractor) {
	...
	public BORROWER(Geriatric geriatric) {
	...
	public BORROWER(GolfCourse golfCourse) {
	...
	public BORROWER(GovernmentOffice governmentOffice) {
	...
	public BORROWER(GovernmentOrganization governmentOrganization) {
	...
	public BORROWER(GroceryStore groceryStore) {
	...
	public BORROWER(Gynecologic gynecologic) {
	...
	public BORROWER(HVACBusiness hvacBusiness) {
	...
	public BORROWER(HairSalon hairSalon) {
	...
	public BORROWER(HardwareStore hardwareStore) {
	...
	public BORROWER(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public BORROWER(HealthClub healthClub) {
	...
	public BORROWER(HighSchool highSchool) {
	...
	public BORROWER(HobbyShop hobbyShop) {
	...
	public BORROWER(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public BORROWER(HomeGoodsStore homeGoodsStore) {
	...
	public BORROWER(Hospital hospital) {
	...
	public BORROWER(HousePainter housePainter) {
	...
	public BORROWER(IceCreamShop iceCreamShop) {
	...
	public BORROWER(InsuranceAgency insuranceAgency) {
	...
	public BORROWER(InternetCafe internetCafe) {
	...
	public BORROWER(JewelryStore jewelryStore) {
	...
	public BORROWER(LegalService legalService) {
	...
	public BORROWER(LibrarySystem librarySystem) {
	...
	public BORROWER(LiquorStore liquorStore) {
	...
	public BORROWER(LocalBusiness localBusiness) {
	...
	public BORROWER(Locksmith locksmith) {
	...
	public BORROWER(LodgingBusiness lodgingBusiness) {
	...
	public BORROWER(MedicalBusiness medicalBusiness) {
	...
	public BORROWER(MedicalClinic medicalClinic) {
	...
	public BORROWER(MedicalOrganization medicalOrganization) {
	...
	public BORROWER(MensClothingStore mensClothingStore) {
	...
	public BORROWER(MiddleSchool middleSchool) {
	...
	public BORROWER(Midwifery midwifery) {
	...
	public BORROWER(MobilePhoneStore mobilePhoneStore) {
	...
	public BORROWER(MotorcycleDealer motorcycleDealer) {
	...
	public BORROWER(MotorcycleRepair motorcycleRepair) {
	...
	public BORROWER(MovieRentalStore movieRentalStore) {
	...
	public BORROWER(MovieTheater movieTheater) {
	...
	public BORROWER(MovingCompany movingCompany) {
	...
	public BORROWER(MusicGroup musicGroup) {
	...
	public BORROWER(MusicStore musicStore) {
	...
	public BORROWER(NailSalon nailSalon) {
	...
	public BORROWER(NewsMediaOrganization newsMediaOrganization) {
	...
	public BORROWER(NightClub nightClub) {
	...
	public BORROWER(Nursing nursing) {
	...
	public BORROWER(Obstetric obstetric) {
	...
	public BORROWER(OfficeEquipmentStore officeEquipmentStore) {
	...
	public BORROWER(Oncologic oncologic) {
	...
	public BORROWER(Optician optician) {
	...
	public BORROWER(Optometric optometric) {
	...
	public BORROWER(Organization organization) {
	...
	public BORROWER(Otolaryngologic otolaryngologic) {
	...
	public BORROWER(OutletStore outletStore) {
	...
	public BORROWER(Patient patient) {
	...
	public BORROWER(PawnShop pawnShop) {
	...
	public BORROWER(Pediatric pediatric) {
	...
	public BORROWER(PerformingGroup performingGroup) {
	...
	public BORROWER(PetStore petStore) {
	...
	public BORROWER(Pharmacy pharmacy) {
	...
	public BORROWER(Physician physician) {
	...
	public BORROWER(Physiotherapy physiotherapy) {
	...
	public BORROWER(PlasticSurgery plasticSurgery) {
	...
	public BORROWER(Plumber plumber) {
	...
	public BORROWER(Podiatric podiatric) {
	...
	public BORROWER(PoliceStation policeStation) {
	...
	public BORROWER(PostOffice postOffice) {
	...
	public BORROWER(Preschool preschool) {
	...
	public BORROWER(PrimaryCare primaryCare) {
	...
	public BORROWER(ProfessionalService professionalService) {
	...
	public BORROWER(Project project) {
	...
	public BORROWER(Psychiatric psychiatric) {
	...
	public BORROWER(PublicHealth publicHealth) {
	...
	public BORROWER(PublicSwimmingPool publicSwimmingPool) {
	...
	public BORROWER(RadioStation radioStation) {
	...
	public BORROWER(RealEstateAgent realEstateAgent) {
	...
	public BORROWER(RecyclingCenter recyclingCenter) {
	...
	public BORROWER(ResearchProject researchProject) {
	...
	public BORROWER(Restaurant restaurant) {
	...
	public BORROWER(RoofingContractor roofingContractor) {
	...
	public BORROWER(SelfStorage selfStorage) {
	...
	public BORROWER(ShoeStore shoeStore) {
	...
	public BORROWER(ShoppingCenter shoppingCenter) {
	...
	public BORROWER(SkiResort skiResort) {
	...
	public BORROWER(SportingGoodsStore sportingGoodsStore) {
	...
	public BORROWER(SportsActivityLocation sportsActivityLocation) {
	...
	public BORROWER(SportsClub sportsClub) {
	...
	public BORROWER(SportsOrganization sportsOrganization) {
	...
	public BORROWER(SportsTeam sportsTeam) {
	...
	public BORROWER(StadiumOrArena stadiumOrArena) {
	...
	public BORROWER(TattooParlor tattooParlor) {
	...
	public BORROWER(TelevisionStation televisionStation) {
	...
	public BORROWER(TennisComplex tennisComplex) {
	...
	public BORROWER(TheaterGroup theaterGroup) {
	...
	public BORROWER(TireShop tireShop) {
	...
	public BORROWER(TouristInformationCenter touristInformationCenter) {
	...
	public BORROWER(ToyStore toyStore) {
	...
	public BORROWER(TravelAgency travelAgency) {
	...
	public BORROWER(VeterinaryCare veterinaryCare) {
	...
	public BORROWER(WholesaleStore wholesaleStore) {
	...
	public BORROWER(WorkersUnion workersUnion) {
	...
	public void copy(Container.Borrower org) {
