...
public class MUSIC_ALBUM implements Clazz.MusicAlbum {
	...
	public AlbumProductionType albumProductionType;
	public AlbumRelease albumRelease;
	public AlbumReleaseType albumReleaseType;
	...
	public MUSIC_ALBUM(Long seq) {
		setSeq(seq);
	}

	public MUSIC_ALBUM(String string) {
	...
	public MUSIC_ALBUM(About about) {
		setAbout(about);
	}
	...
	public MUSIC_ALBUM(AccessMode accessMode) {
	...
	public MUSIC_ALBUM(AccessModeSufficient accessModeSufficient) {
	...
	public MUSIC_ALBUM(AccessibilityAPI accessibilityAPI) {
	...
	public MUSIC_ALBUM(AccessibilityControl accessibilityControl) {
	...
	public MUSIC_ALBUM(AccessibilityFeature accessibilityFeature) {
	...
	public MUSIC_ALBUM(AccessibilityHazard accessibilityHazard) {
	...
	public MUSIC_ALBUM(AccessibilitySummary accessibilitySummary) {
	...
	public MUSIC_ALBUM(AccountablePerson accountablePerson) {
	...
	public MUSIC_ALBUM(AdditionalType additionalType) {
	...
	public MUSIC_ALBUM(AggregateRating aggregateRating) {
	...
	public MUSIC_ALBUM(AlbumProductionType albumProductionType) {
		setAlbumProductionType(albumProductionType);
	}

	@Override
	public AlbumProductionType getAlbumProductionType() {
		return albumProductionType;
	}

	@Override
	public void setAlbumProductionType(AlbumProductionType albumProductionType) {
		this.albumProductionType = albumProductionType;
	}

	public MUSIC_ALBUM(AlbumRelease albumRelease) {
		setAlbumRelease(albumRelease);
	}
	...
	public MUSIC_ALBUM(AlbumReleaseType albumReleaseType) {
		setAlbumReleaseType(albumReleaseType);
	}

	@Override
	public AlbumReleaseType getAlbumReleaseType() {
		return albumReleaseType;
	}

	@Override
	public void setAlbumReleaseType(AlbumReleaseType albumReleaseType) {
		this.albumReleaseType = albumReleaseType;
	}

	public MUSIC_ALBUM(AlternateName alternateName) {
	...
	public MUSIC_ALBUM(AlternativeHeadline alternativeHeadline) {
	...
	public MUSIC_ALBUM(AssociatedMedia associatedMedia) {
	...
	public MUSIC_ALBUM(Audience audience) {
	...
	public MUSIC_ALBUM(Audio audio) {
		setAudio(audio);
	}
	...
	public MUSIC_ALBUM(Author author) {
		setAuthor(author);
	}
	...
	public MUSIC_ALBUM(Award award) {
		setAward(award);
	}
	...
	public MUSIC_ALBUM(ByArtist byArtist) {
	...
	public MUSIC_ALBUM(Character character) {
	...
	public MUSIC_ALBUM(Citation citation) {
	...
	public MUSIC_ALBUM(Comment comment) {
		setComment(comment);
	}
	...
	public MUSIC_ALBUM(CommentCount commentCount) {
	...
	public MUSIC_ALBUM(ContentLocation contentLocation) {
	...
	public MUSIC_ALBUM(ContentRating contentRating) {
	...
	public MUSIC_ALBUM(ContentReferenceTime contentReferenceTime) {
	...
	public MUSIC_ALBUM(Contributor contributor) {
	...
	public MUSIC_ALBUM(CopyrightHolder copyrightHolder) {
	...
	public MUSIC_ALBUM(CopyrightYear copyrightYear) {
	...
	public MUSIC_ALBUM(Correction correction) {
	...
	public MUSIC_ALBUM(Creator creator) {
		setCreator(creator);
	}
	...
	public MUSIC_ALBUM(DateCreated dateCreated) {
	...
	public MUSIC_ALBUM(DateModified dateModified) {
	...
	public MUSIC_ALBUM(DatePublished datePublished) {
	...
	public MUSIC_ALBUM(Description description) {
	...
	public MUSIC_ALBUM(DisambiguatingDescription disambiguatingDescription) {
	...
	public MUSIC_ALBUM(DiscussionUrl discussionUrl) {
	...
	public MUSIC_ALBUM(Editor editor) {
		setEditor(editor);
	}
	...
	public MUSIC_ALBUM(EducationalAlignment educationalAlignment) {
	...
	public MUSIC_ALBUM(EducationalUse educationalUse) {
	...
	public MUSIC_ALBUM(Encoding encoding) {
	...
	public MUSIC_ALBUM(EncodingFormat encodingFormat) {
	...
	public MUSIC_ALBUM(ExampleOfWork exampleOfWork) {
	...
	public MUSIC_ALBUM(Expires expires) {
		setExpires(expires);
	}
	...
	public MUSIC_ALBUM(Funder funder) {
		setFunder(funder);
	}
	...
	public MUSIC_ALBUM(Genre genre) {
		setGenre(genre);
	}
	...
	public MUSIC_ALBUM(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public MUSIC_ALBUM(Headline headline) {
	...
	public MUSIC_ALBUM(Identifier identifier) {
	...
	public MUSIC_ALBUM(Image image) {
		setImage(image);
	}
	...
	public MUSIC_ALBUM(InLanguage inLanguage) {
	...
	public MUSIC_ALBUM(InteractionStatistic interactionStatistic) {
	...
	public MUSIC_ALBUM(InteractivityType interactivityType) {
	...
	public MUSIC_ALBUM(IsAccessibleForFree isAccessibleForFree) {
	...
	public MUSIC_ALBUM(IsBasedOn isBasedOn) {
	...
	public MUSIC_ALBUM(IsFamilyFriendly isFamilyFriendly) {
	...
	public MUSIC_ALBUM(IsPartOf isPartOf) {
	...
	public MUSIC_ALBUM(Keywords keywords) {
	...
	public MUSIC_ALBUM(LearningResourceType learningResourceType) {
	...
	public MUSIC_ALBUM(License license) {
		setLicense(license);
	}
	...
	public MUSIC_ALBUM(LocationCreated locationCreated) {
	...
	public MUSIC_ALBUM(MainEntity mainEntity) {
	...
	public MUSIC_ALBUM(MainEntityOfPage mainEntityOfPage) {
	...
	public MUSIC_ALBUM(Material material) {
	...
	public MUSIC_ALBUM(MaterialExtent materialExtent) {
	...
	public MUSIC_ALBUM(Mentions mentions) {
	...
	public MUSIC_ALBUM(NameFuzzy nameFuzzy) {
	...
	public MUSIC_ALBUM(NameRuby nameRuby) {
	...
	public MUSIC_ALBUM(NumTracks numTracks) {
	...
	public MUSIC_ALBUM(Offers offers) {
		setOffers(offers);
	}
	...
	public MUSIC_ALBUM(Position position) {
	...
	public MUSIC_ALBUM(PotentialAction potentialAction) {
	...
	public MUSIC_ALBUM(Producer producer) {
	...
	public MUSIC_ALBUM(Provider provider) {
	...
	public MUSIC_ALBUM(Publication publication) {
	...
	public MUSIC_ALBUM(Publisher publisher) {
	...
	public MUSIC_ALBUM(PublisherImprint publisherImprint) {
	...
	public MUSIC_ALBUM(PublishingPrinciples publishingPrinciples) {
	...
	public MUSIC_ALBUM(RecordedAt recordedAt) {
	...
	public MUSIC_ALBUM(ReleasedEvent releasedEvent) {
	...
	public MUSIC_ALBUM(Review review) {
		setReview(review);
	}
	...
	public MUSIC_ALBUM(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MUSIC_ALBUM(SchemaVersion schemaVersion) {
	...
	public MUSIC_ALBUM(SdDatePublished sdDatePublished) {
	...
	public MUSIC_ALBUM(SdLicense sdLicense) {
	...
	public MUSIC_ALBUM(SdPublisher sdPublisher) {
	...
	public MUSIC_ALBUM(SourceOrganization sourceOrganization) {
	...
	public MUSIC_ALBUM(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public MUSIC_ALBUM(SpatialCoverage spatialCoverage) {
	...
	public MUSIC_ALBUM(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MUSIC_ALBUM(SubjectOf subjectOf) {
	...
	public MUSIC_ALBUM(Temporal temporal) {
	...
	public MUSIC_ALBUM(TemporalCoverage temporalCoverage) {
	...
	public MUSIC_ALBUM(ThumbnailUrl thumbnailUrl) {
	...
	public MUSIC_ALBUM(TimeRequired timeRequired) {
	...
	public MUSIC_ALBUM(Track track) {
		setTrack(track);
	}
	...
	public MUSIC_ALBUM(TranslationOfWork translationOfWork) {
	...
	public MUSIC_ALBUM(Translator translator) {
	...
	public MUSIC_ALBUM(TypicalAgeRange typicalAgeRange) {
	...
	public MUSIC_ALBUM(Version version) {
		setVersion(version);
	}
	...
	public MUSIC_ALBUM(Video video) {
		setVideo(video);
	}
	...
	public MUSIC_ALBUM(WorkExample workExample) {
	...
	public MUSIC_ALBUM(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.MusicAlbum org) {
		setSeq(org.getSeq());
		...
		setAlbumProductionType(org.getAlbumProductionType());
		setAlbumRelease(org.getAlbumRelease());
		setAlbumReleaseType(org.getAlbumReleaseType());
