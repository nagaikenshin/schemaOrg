...
public class GEO_DISJOINT implements Container.GeoDisjoint {
	...
	public GEO_DISJOINT(String string) {
	...
	public GEO_DISJOINT(Accommodation accommodation) {
	...
	public GEO_DISJOINT(AccountingService accountingService) {
	...
	public GEO_DISJOINT(AdministrativeArea administrativeArea) {
	...
	public GEO_DISJOINT(AdultEntertainment adultEntertainment) {
	...
	public GEO_DISJOINT(Airport airport) {
	...
	public GEO_DISJOINT(AmusementPark amusementPark) {
	...
	public GEO_DISJOINT(AnimalShelter animalShelter) {
	...
	public GEO_DISJOINT(Apartment apartment) {
	...
	public GEO_DISJOINT(ApartmentComplex apartmentComplex) {
	...
	public GEO_DISJOINT(Aquarium aquarium) {
	...
	public GEO_DISJOINT(ArchiveOrganization archiveOrganization) {
	...
	public GEO_DISJOINT(ArtGallery artGallery) {
	...
	public GEO_DISJOINT(Attorney attorney) {
	...
	public GEO_DISJOINT(AutoBodyShop autoBodyShop) {
	...
	public GEO_DISJOINT(AutoDealer autoDealer) {
	...
	public GEO_DISJOINT(AutoPartsStore autoPartsStore) {
	...
	public GEO_DISJOINT(AutoRental autoRental) {
	...
	public GEO_DISJOINT(AutoRepair autoRepair) {
	...
	public GEO_DISJOINT(AutoWash autoWash) {
	...
	public GEO_DISJOINT(AutomatedTeller automatedTeller) {
	...
	public GEO_DISJOINT(AutomotiveBusiness automotiveBusiness) {
	...
	public GEO_DISJOINT(Bakery bakery) {
	...
	public GEO_DISJOINT(BankOrCreditUnion bankOrCreditUnion) {
	...
	public GEO_DISJOINT(BarOrPub barOrPub) {
	...
	public GEO_DISJOINT(Beach beach) {
	...
	public GEO_DISJOINT(BeautySalon beautySalon) {
	...
	public GEO_DISJOINT(BedAndBreakfast bedAndBreakfast) {
	...
	public GEO_DISJOINT(BikeStore bikeStore) {
	...
	public GEO_DISJOINT(BodyOfWater bodyOfWater) {
	...
	public GEO_DISJOINT(BookStore bookStore) {
	...
	public GEO_DISJOINT(BowlingAlley bowlingAlley) {
	...
	public GEO_DISJOINT(Brewery brewery) {
	...
	public GEO_DISJOINT(Bridge bridge) {
	...
	public GEO_DISJOINT(BuddhistTemple buddhistTemple) {
	...
	public GEO_DISJOINT(BusStation busStation) {
	...
	public GEO_DISJOINT(BusStop busStop) {
	...
	public GEO_DISJOINT(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public GEO_DISJOINT(Campground campground) {
	...
	public GEO_DISJOINT(CampingPitch campingPitch) {
	...
	public GEO_DISJOINT(Canal canal) {
	...
	public GEO_DISJOINT(Casino casino) {
	...
	public GEO_DISJOINT(CatholicChurch catholicChurch) {
	...
	public GEO_DISJOINT(Cemetery cemetery) {
	...
	public GEO_DISJOINT(ChildCare childCare) {
	...
	public GEO_DISJOINT(Church church) {
	...
	public GEO_DISJOINT(CityHall cityHall) {
	...
	public GEO_DISJOINT(CivicStructure civicStructure) {
	...
	public GEO_DISJOINT(ClothingStore clothingStore) {
	...
	public GEO_DISJOINT(ComedyClub comedyClub) {
	...
	public GEO_DISJOINT(CommunityHealth communityHealth) {
	...
	public GEO_DISJOINT(ComputerStore computerStore) {
	...
	public GEO_DISJOINT(Continent continent) {
	...
	public GEO_DISJOINT(ConvenienceStore convenienceStore) {
	...
	public GEO_DISJOINT(Country country) {
	...
	public GEO_DISJOINT(Courthouse courthouse) {
	...
	public GEO_DISJOINT(Crematorium crematorium) {
	...
	public GEO_DISJOINT(DaySpa daySpa) {
	...
	public GEO_DISJOINT(DefenceEstablishment defenceEstablishment) {
	...
	public GEO_DISJOINT(Dentist dentist) {
	...
	public GEO_DISJOINT(DepartmentStore departmentStore) {
	...
	public GEO_DISJOINT(Dermatology dermatology) {
	...
	public GEO_DISJOINT(DietNutrition dietNutrition) {
	...
	public GEO_DISJOINT(Distillery distillery) {
	...
	public GEO_DISJOINT(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public GEO_DISJOINT(Electrician electrician) {
	...
	public GEO_DISJOINT(ElectronicsStore electronicsStore) {
	...
	public GEO_DISJOINT(Embassy embassy) {
	...
	public GEO_DISJOINT(Emergency emergency) {
	...
	public GEO_DISJOINT(EmergencyService emergencyService) {
	...
	public GEO_DISJOINT(EmploymentAgency employmentAgency) {
	...
	public GEO_DISJOINT(EntertainmentBusiness entertainmentBusiness) {
	...
	public GEO_DISJOINT(EventVenue eventVenue) {
	...
	public GEO_DISJOINT(ExerciseGym exerciseGym) {
	...
	public GEO_DISJOINT(FastFoodRestaurant fastFoodRestaurant) {
	...
	public GEO_DISJOINT(FinancialService financialService) {
	...
	public GEO_DISJOINT(FireStation fireStation) {
	...
	public GEO_DISJOINT(Florist florist) {
	...
	public GEO_DISJOINT(FoodEstablishment foodEstablishment) {
	...
	public GEO_DISJOINT(FurnitureStore furnitureStore) {
	...
	public GEO_DISJOINT(GardenStore gardenStore) {
	...
	public GEO_DISJOINT(GasStation gasStation) {
	...
	public GEO_DISJOINT(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public GEO_DISJOINT(GeneralContractor generalContractor) {
	...
	public GEO_DISJOINT(GeospatialGeometry geospatialGeometry) {
		geospatialGeometryList = new ArrayList<GeospatialGeometry>();
	...
	public GEO_DISJOINT(Geriatric geriatric) {
	...
	public GEO_DISJOINT(GolfCourse golfCourse) {
	...
	public GEO_DISJOINT(GovernmentBuilding governmentBuilding) {
	...
	public GEO_DISJOINT(GovernmentOffice governmentOffice) {
	...
	public GEO_DISJOINT(GroceryStore groceryStore) {
	...
	public GEO_DISJOINT(Gynecologic gynecologic) {
	...
	public GEO_DISJOINT(HVACBusiness hvacBusiness) {
	...
	public GEO_DISJOINT(HairSalon hairSalon) {
	...
	public GEO_DISJOINT(HardwareStore hardwareStore) {
	...
	public GEO_DISJOINT(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public GEO_DISJOINT(HealthClub healthClub) {
	...
	public GEO_DISJOINT(HinduTemple hinduTemple) {
	...
	public GEO_DISJOINT(HobbyShop hobbyShop) {
	...
	public GEO_DISJOINT(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public GEO_DISJOINT(HomeGoodsStore homeGoodsStore) {
	...
	public GEO_DISJOINT(Hospital hospital) {
	...
	public GEO_DISJOINT(Hostel hostel) {
	...
	public GEO_DISJOINT(Hotel hotel) {
	...
	public GEO_DISJOINT(HotelRoom hotelRoom) {
	...
	public GEO_DISJOINT(House house) {
	...
	public GEO_DISJOINT(HousePainter housePainter) {
	...
	public GEO_DISJOINT(IceCreamShop iceCreamShop) {
	...
	public GEO_DISJOINT(InsuranceAgency insuranceAgency) {
	...
	public GEO_DISJOINT(InternetCafe internetCafe) {
	...
	public GEO_DISJOINT(JewelryStore jewelryStore) {
	...
	public GEO_DISJOINT(LakeBodyOfWater lakeBodyOfWater) {
	...
	public GEO_DISJOINT(Landform landform) {
	...
	public GEO_DISJOINT(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public GEO_DISJOINT(LegalService legalService) {
	...
	public GEO_DISJOINT(LegislativeBuilding legislativeBuilding) {
	...
	public GEO_DISJOINT(Library library) {
	...
	public GEO_DISJOINT(LiquorStore liquorStore) {
	...
	public GEO_DISJOINT(LocalBusiness localBusiness) {
	...
	public GEO_DISJOINT(Locksmith locksmith) {
	...
	public GEO_DISJOINT(LodgingBusiness lodgingBusiness) {
	...
	public GEO_DISJOINT(MedicalBusiness medicalBusiness) {
	...
	public GEO_DISJOINT(MedicalClinic medicalClinic) {
	...
	public GEO_DISJOINT(MeetingRoom meetingRoom) {
	...
	public GEO_DISJOINT(MensClothingStore mensClothingStore) {
	...
	public GEO_DISJOINT(Midwifery midwifery) {
	...
	public GEO_DISJOINT(MobilePhoneStore mobilePhoneStore) {
	...
	public GEO_DISJOINT(Mosque mosque) {
	...
	public GEO_DISJOINT(Motel motel) {
	...
	public GEO_DISJOINT(MotorcycleDealer motorcycleDealer) {
	...
	public GEO_DISJOINT(MotorcycleRepair motorcycleRepair) {
	...
	public GEO_DISJOINT(Mountain mountain) {
	...
	public GEO_DISJOINT(MovieRentalStore movieRentalStore) {
	...
	public GEO_DISJOINT(MovieTheater movieTheater) {
	...
	public GEO_DISJOINT(MovingCompany movingCompany) {
	...
	public GEO_DISJOINT(Museum museum) {
	...
	public GEO_DISJOINT(MusicStore musicStore) {
	...
	public GEO_DISJOINT(MusicVenue musicVenue) {
	...
	public GEO_DISJOINT(NailSalon nailSalon) {
	...
	public GEO_DISJOINT(NightClub nightClub) {
	...
	public GEO_DISJOINT(Notary notary) {
	...
	public GEO_DISJOINT(Nursing nursing) {
	...
	public GEO_DISJOINT(Obstetric obstetric) {
	...
	public GEO_DISJOINT(OceanBodyOfWater oceanBodyOfWater) {
	...
	public GEO_DISJOINT(OfficeEquipmentStore officeEquipmentStore) {
	...
	public GEO_DISJOINT(Oncologic oncologic) {
	...
	public GEO_DISJOINT(Optician optician) {
	...
	public GEO_DISJOINT(Optometric optometric) {
	...
	public GEO_DISJOINT(Otolaryngologic otolaryngologic) {
	...
	public GEO_DISJOINT(OutletStore outletStore) {
	...
	public GEO_DISJOINT(ParkingFacility parkingFacility) {
	...
	public GEO_DISJOINT(PawnShop pawnShop) {
	...
	public GEO_DISJOINT(Pediatric pediatric) {
	...
	public GEO_DISJOINT(PerformingArtsTheater performingArtsTheater) {
	...
	public GEO_DISJOINT(PetStore petStore) {
	...
	public GEO_DISJOINT(Pharmacy pharmacy) {
	...
	public GEO_DISJOINT(Physician physician) {
	...
	public GEO_DISJOINT(Physiotherapy physiotherapy) {
	...
	public GEO_DISJOINT(Place place) {
	...
	public GEO_DISJOINT(PlaceOfWorship placeOfWorship) {
	...
	public GEO_DISJOINT(PlasticSurgery plasticSurgery) {
	...
	public GEO_DISJOINT(Playground playground) {
	...
	public GEO_DISJOINT(Plumber plumber) {
	...
	public GEO_DISJOINT(Podiatric podiatric) {
	...
	public GEO_DISJOINT(PoliceStation policeStation) {
	...
	public GEO_DISJOINT(PostOffice postOffice) {
	...
	public GEO_DISJOINT(PrimaryCare primaryCare) {
	...
	public GEO_DISJOINT(ProfessionalService professionalService) {
	...
	public GEO_DISJOINT(Psychiatric psychiatric) {
	...
	public GEO_DISJOINT(PublicHealth publicHealth) {
	...
	public GEO_DISJOINT(PublicSwimmingPool publicSwimmingPool) {
	...
	public GEO_DISJOINT(PublicToilet publicToilet) {
	...
	public GEO_DISJOINT(RVPark rvPark) {
	...
	public GEO_DISJOINT(RadioStation radioStation) {
	...
	public GEO_DISJOINT(RealEstateAgent realEstateAgent) {
	...
	public GEO_DISJOINT(RecyclingCenter recyclingCenter) {
	...
	public GEO_DISJOINT(Reservoir reservoir) {
	...
	public GEO_DISJOINT(Residence residence) {
	...
	public GEO_DISJOINT(Resort resort) {
	...
	public GEO_DISJOINT(Restaurant restaurant) {
	...
	public GEO_DISJOINT(RiverBodyOfWater riverBodyOfWater) {
	...
	public GEO_DISJOINT(RoofingContractor roofingContractor) {
	...
	public GEO_DISJOINT(SeaBodyOfWater seaBodyOfWater) {
	...
	public GEO_DISJOINT(SelfStorage selfStorage) {
	...
	public GEO_DISJOINT(ShoeStore shoeStore) {
	...
	public GEO_DISJOINT(ShoppingCenter shoppingCenter) {
	...
	public GEO_DISJOINT(SingleFamilyResidence singleFamilyResidence) {
	...
	public GEO_DISJOINT(SkiResort skiResort) {
	...
	public GEO_DISJOINT(SportingGoodsStore sportingGoodsStore) {
	...
	public GEO_DISJOINT(SportsActivityLocation sportsActivityLocation) {
	...
	public GEO_DISJOINT(SportsClub sportsClub) {
	...
	public GEO_DISJOINT(StadiumOrArena stadiumOrArena) {
	...
	public GEO_DISJOINT(State state) {
	...
	public GEO_DISJOINT(Store store) {
	...
	public GEO_DISJOINT(SubwayStation subwayStation) {
	...
	public GEO_DISJOINT(Suite suite) {
	...
	public GEO_DISJOINT(Synagogue synagogue) {
	...
	public GEO_DISJOINT(TattooParlor tattooParlor) {
	...
	public GEO_DISJOINT(TaxiStand taxiStand) {
	...
	public GEO_DISJOINT(TelevisionStation televisionStation) {
	...
	public GEO_DISJOINT(TennisComplex tennisComplex) {
	...
	public GEO_DISJOINT(TireShop tireShop) {
	...
	public GEO_DISJOINT(TouristAttraction touristAttraction) {
	...
	public GEO_DISJOINT(TouristDestination touristDestination) {
	...
	public GEO_DISJOINT(TouristInformationCenter touristInformationCenter) {
	...
	public GEO_DISJOINT(ToyStore toyStore) {
	...
	public GEO_DISJOINT(TrainStation trainStation) {
	...
	public GEO_DISJOINT(TravelAgency travelAgency) {
	...
	public GEO_DISJOINT(Volcano volcano) {
	...
	public GEO_DISJOINT(Waterfall waterfall) {
	...
	public GEO_DISJOINT(WholesaleStore wholesaleStore) {
	...
	public GEO_DISJOINT(Winery winery) {
	...
	public void copy(Container.GeoDisjoint org) {
