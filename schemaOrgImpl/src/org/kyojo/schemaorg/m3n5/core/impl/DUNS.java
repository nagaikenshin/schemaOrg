...
public class DUNS implements Container.Duns {
	...
	public DUNS(LocationFeatureSpecification locationFeatureSpecification) {
	...
	public DUNS(PropertyValue propertyValue) {
	...
	public DUNS(String string) {
		this(new TEXT(string));
	}

	public DUNS(Text text) {
	...
	public DUNS(List<LocationFeatureSpecification> locationFeatureSpecificationList,
	...
	public void copy(Container.Duns org) {
