package org.kyojo.schemaorg.m3n5.core.gamePlayMode;
...
import org.kyojo.schemaorg.m3n5.core.GamePlayMode;
...
public class SINGLE_PLAYER implements GamePlayMode.SinglePlayer {
	...
	public SINGLE_PLAYER(Long seq) {
		setSeq(seq);
	}

	public SINGLE_PLAYER(String string) {
	...
	public SINGLE_PLAYER(AdditionalType additionalType) {
	...
	public SINGLE_PLAYER(AlternateName alternateName) {
	...
	public SINGLE_PLAYER(Description description) {
	...
	public SINGLE_PLAYER(DisambiguatingDescription disambiguatingDescription) {
	...
	public SINGLE_PLAYER(Identifier identifier) {
	...
	public SINGLE_PLAYER(Image image) {
		setImage(image);
	}
	...
	public SINGLE_PLAYER(MainEntityOfPage mainEntityOfPage) {
	...
	public SINGLE_PLAYER(Name name) {
		setName(name);
	}
	...
	public SINGLE_PLAYER(NameFuzzy nameFuzzy) {
	...
	public SINGLE_PLAYER(NameRuby nameRuby) {
	...
	public SINGLE_PLAYER(PotentialAction potentialAction) {
	...
	public SINGLE_PLAYER(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SINGLE_PLAYER(SubjectOf subjectOf) {
	...
	public SINGLE_PLAYER(SupersededBy supersededBy) {
	...
	public void copy(GamePlayMode.SinglePlayer org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return GamePlayMode.SinglePlayer.class.getAnnotation(SampleValue.class).value();
	}
