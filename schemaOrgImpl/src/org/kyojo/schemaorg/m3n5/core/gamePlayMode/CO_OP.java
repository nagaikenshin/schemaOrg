...
public class CO_OP implements GamePlayMode.CoOp {
	...
	public CO_OP(Long seq) {
		setSeq(seq);
	}

	public CO_OP(String string) {
	...
	public CO_OP(AdditionalType additionalType) {
	...
	public CO_OP(AlternateName alternateName) {
	...
	public CO_OP(Description description) {
	...
	public CO_OP(DisambiguatingDescription disambiguatingDescription) {
	...
	public CO_OP(Identifier identifier) {
	...
	public CO_OP(MainEntityOfPage mainEntityOfPage) {
	...
	public CO_OP(NameFuzzy nameFuzzy) {
	...
	public CO_OP(NameRuby nameRuby) {
	...
	public CO_OP(PotentialAction potentialAction) {
	...
	public CO_OP(SubjectOf subjectOf) {
	...
	public CO_OP(SupersededBy supersededBy) {
	...
	public void copy(GamePlayMode.CoOp org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return GamePlayMode.CoOp.class.getAnnotation(SampleValue.class).value();
	}
