...
public class PARKING_MAP implements MapCategoryType.ParkingMap {
	...
	public PARKING_MAP(Long seq) {
		setSeq(seq);
	}

	public PARKING_MAP(String string) {
	...
	public PARKING_MAP(AdditionalType additionalType) {
	...
	public PARKING_MAP(AlternateName alternateName) {
	...
	public PARKING_MAP(Description description) {
	...
	public PARKING_MAP(DisambiguatingDescription disambiguatingDescription) {
	...
	public PARKING_MAP(Identifier identifier) {
	...
	public PARKING_MAP(Image image) {
		setImage(image);
	}
	...
	public PARKING_MAP(MainEntityOfPage mainEntityOfPage) {
	...
	public PARKING_MAP(NameFuzzy nameFuzzy) {
	...
	public PARKING_MAP(NameRuby nameRuby) {
	...
	public PARKING_MAP(PotentialAction potentialAction) {
	...
	public PARKING_MAP(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PARKING_MAP(SubjectOf subjectOf) {
	...
	public PARKING_MAP(SupersededBy supersededBy) {
	...
	public void copy(MapCategoryType.ParkingMap org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MapCategoryType.ParkingMap.class.getAnnotation(SampleValue.class).value();
	}
