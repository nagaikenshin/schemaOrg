...
public class PAYMENT_DECLINED implements PaymentStatusType.PaymentDeclined {
	...
	public PAYMENT_DECLINED() {
	}

	public PAYMENT_DECLINED(Long seq) {
		setSeq(seq);
	}

	public PAYMENT_DECLINED(String string) {
	...
	public PAYMENT_DECLINED(AdditionalType additionalType) {
	...
	public PAYMENT_DECLINED(AlternateName alternateName) {
	...
	public PAYMENT_DECLINED(Description description) {
	...
	public PAYMENT_DECLINED(DisambiguatingDescription disambiguatingDescription) {
	...
	public PAYMENT_DECLINED(Identifier identifier) {
	...
	public PAYMENT_DECLINED(Image image) {
		setImage(image);
	}
	...
	public PAYMENT_DECLINED(MainEntityOfPage mainEntityOfPage) {
	...
	public PAYMENT_DECLINED(Name name) {
		setName(name);
	}
	...
	public PAYMENT_DECLINED(NameFuzzy nameFuzzy) {
	...
	public PAYMENT_DECLINED(NameRuby nameRuby) {
	...
	public PAYMENT_DECLINED(PotentialAction potentialAction) {
	...
	public PAYMENT_DECLINED(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PAYMENT_DECLINED(SubjectOf subjectOf) {
	...
	public PAYMENT_DECLINED(SupersededBy supersededBy) {
	...
	public PAYMENT_DECLINED(Url url) {
		setUrl(url);
	}
	...
	public void copy(PaymentStatusType.PaymentDeclined org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return PaymentStatusType.PaymentDeclined.class.getAnnotation(SampleValue.class).value();
	}
