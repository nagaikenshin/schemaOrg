...
public class PAYMENT_PAST_DUE implements PaymentStatusType.PaymentPastDue {
	...
	public PAYMENT_PAST_DUE() {
	}

	public PAYMENT_PAST_DUE(Long seq) {
		setSeq(seq);
	}

	public PAYMENT_PAST_DUE(String string) {
	...
	public PAYMENT_PAST_DUE(AdditionalType additionalType) {
	...
	public PAYMENT_PAST_DUE(AlternateName alternateName) {
	...
	public PAYMENT_PAST_DUE(Description description) {
	...
	public PAYMENT_PAST_DUE(DisambiguatingDescription disambiguatingDescription) {
	...
	public PAYMENT_PAST_DUE(Identifier identifier) {
	...
	public PAYMENT_PAST_DUE(Image image) {
		setImage(image);
	}
	...
	public PAYMENT_PAST_DUE(MainEntityOfPage mainEntityOfPage) {
	...
	public PAYMENT_PAST_DUE(Name name) {
		setName(name);
	}
	...
	public PAYMENT_PAST_DUE(NameFuzzy nameFuzzy) {
	...
	public PAYMENT_PAST_DUE(NameRuby nameRuby) {
	...
	public PAYMENT_PAST_DUE(PotentialAction potentialAction) {
	...
	public PAYMENT_PAST_DUE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PAYMENT_PAST_DUE(SubjectOf subjectOf) {
	...
	public PAYMENT_PAST_DUE(SupersededBy supersededBy) {
	...
	public PAYMENT_PAST_DUE(Url url) {
		setUrl(url);
	}
	...
	public void copy(PaymentStatusType.PaymentPastDue org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return PaymentStatusType.PaymentPastDue.class.getAnnotation(SampleValue.class).value();
	}
