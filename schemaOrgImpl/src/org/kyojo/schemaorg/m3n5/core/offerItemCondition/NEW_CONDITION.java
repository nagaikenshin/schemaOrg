...
public class NEW_CONDITION implements OfferItemCondition.NewCondition {
	...
	public NEW_CONDITION(Long seq) {
		setSeq(seq);
	}

	public NEW_CONDITION(String string) {
	...
	public NEW_CONDITION(AdditionalType additionalType) {
	...
	public NEW_CONDITION(AlternateName alternateName) {
	...
	public NEW_CONDITION(Description description) {
	...
	public NEW_CONDITION(DisambiguatingDescription disambiguatingDescription) {
	...
	public NEW_CONDITION(Identifier identifier) {
	...
	public NEW_CONDITION(Image image) {
		setImage(image);
	}
	...
	public NEW_CONDITION(MainEntityOfPage mainEntityOfPage) {
	...
	public NEW_CONDITION(Name name) {
		setName(name);
	}
	...
	public NEW_CONDITION(NameFuzzy nameFuzzy) {
	...
	public NEW_CONDITION(NameRuby nameRuby) {
	...
	public NEW_CONDITION(PotentialAction potentialAction) {
	...
	public NEW_CONDITION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public NEW_CONDITION(SubjectOf subjectOf) {
	...
	public NEW_CONDITION(SupersededBy supersededBy) {
	...
	public void copy(OfferItemCondition.NewCondition org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return OfferItemCondition.NewCondition.class.getAnnotation(SampleValue.class).value();
	}
