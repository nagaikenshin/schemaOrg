...
public class USED_CONDITION implements OfferItemCondition.UsedCondition {
	...
	public USED_CONDITION() {
	}

	public USED_CONDITION(Long seq) {
		setSeq(seq);
	}

	public USED_CONDITION(String string) {
	...
	public USED_CONDITION(AdditionalType additionalType) {
	...
	public USED_CONDITION(AlternateName alternateName) {
	...
	public USED_CONDITION(Description description) {
	...
	public USED_CONDITION(DisambiguatingDescription disambiguatingDescription) {
	...
	public USED_CONDITION(Identifier identifier) {
	...
	public USED_CONDITION(Image image) {
		setImage(image);
	}
	...
	public USED_CONDITION(MainEntityOfPage mainEntityOfPage) {
	...
	public USED_CONDITION(Name name) {
		setName(name);
	}
	...
	public USED_CONDITION(NameFuzzy nameFuzzy) {
	...
	public USED_CONDITION(NameRuby nameRuby) {
	...
	public USED_CONDITION(PotentialAction potentialAction) {
	...
	public USED_CONDITION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public USED_CONDITION(SubjectOf subjectOf) {
	...
	public USED_CONDITION(SupersededBy supersededBy) {
	...
	public void copy(OfferItemCondition.UsedCondition org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return OfferItemCondition.UsedCondition.class.getAnnotation(SampleValue.class).value();
	}
