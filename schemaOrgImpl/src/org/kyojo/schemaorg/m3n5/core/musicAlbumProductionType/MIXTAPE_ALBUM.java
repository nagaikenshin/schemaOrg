...
public class MIXTAPE_ALBUM implements MusicAlbumProductionType.MixtapeAlbum {
	...
	public MIXTAPE_ALBUM() {
	}

	public MIXTAPE_ALBUM(Long seq) {
		setSeq(seq);
	}

	public MIXTAPE_ALBUM(String string) {
	...
	public MIXTAPE_ALBUM(AdditionalType additionalType) {
	...
	public MIXTAPE_ALBUM(AlternateName alternateName) {
	...
	public MIXTAPE_ALBUM(Description description) {
	...
	public MIXTAPE_ALBUM(DisambiguatingDescription disambiguatingDescription) {
	...
	public MIXTAPE_ALBUM(Identifier identifier) {
	...
	public MIXTAPE_ALBUM(Image image) {
		setImage(image);
	}
	...
	public MIXTAPE_ALBUM(MainEntityOfPage mainEntityOfPage) {
	...
	public MIXTAPE_ALBUM(Name name) {
		setName(name);
	}
	...
	public MIXTAPE_ALBUM(NameFuzzy nameFuzzy) {
	...
	public MIXTAPE_ALBUM(NameRuby nameRuby) {
	...
	public MIXTAPE_ALBUM(PotentialAction potentialAction) {
	...
	public MIXTAPE_ALBUM(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MIXTAPE_ALBUM(SubjectOf subjectOf) {
	...
	public MIXTAPE_ALBUM(SupersededBy supersededBy) {
	...
	public void copy(MusicAlbumProductionType.MixtapeAlbum org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MusicAlbumProductionType.MixtapeAlbum.class.getAnnotation(SampleValue.class).value();
	}
