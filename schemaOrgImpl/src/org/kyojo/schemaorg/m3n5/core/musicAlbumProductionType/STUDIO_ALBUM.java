...
public class STUDIO_ALBUM implements MusicAlbumProductionType.StudioAlbum {
	...
	public STUDIO_ALBUM(Long seq) {
		setSeq(seq);
	}

	public STUDIO_ALBUM(String string) {
	...
	public STUDIO_ALBUM(AdditionalType additionalType) {
	...
	public STUDIO_ALBUM(AlternateName alternateName) {
	...
	public STUDIO_ALBUM(Description description) {
	...
	public STUDIO_ALBUM(DisambiguatingDescription disambiguatingDescription) {
	...
	public STUDIO_ALBUM(Identifier identifier) {
	...
	public STUDIO_ALBUM(Image image) {
		setImage(image);
	}
	...
	public STUDIO_ALBUM(MainEntityOfPage mainEntityOfPage) {
	...
	public STUDIO_ALBUM(NameFuzzy nameFuzzy) {
	...
	public STUDIO_ALBUM(NameRuby nameRuby) {
	...
	public STUDIO_ALBUM(PotentialAction potentialAction) {
	...
	public STUDIO_ALBUM(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public STUDIO_ALBUM(SubjectOf subjectOf) {
	...
	public STUDIO_ALBUM(SupersededBy supersededBy) {
	...
	public void copy(MusicAlbumProductionType.StudioAlbum org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MusicAlbumProductionType.StudioAlbum.class.getAnnotation(SampleValue.class).value();
	}
