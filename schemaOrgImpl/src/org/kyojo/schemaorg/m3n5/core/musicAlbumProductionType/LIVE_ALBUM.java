...
public class LIVE_ALBUM implements MusicAlbumProductionType.LiveAlbum {
	...
	public LIVE_ALBUM(Long seq) {
		setSeq(seq);
	}

	public LIVE_ALBUM(String string) {
	...
	public LIVE_ALBUM(AdditionalType additionalType) {
	...
	public LIVE_ALBUM(AlternateName alternateName) {
	...
	public LIVE_ALBUM(Description description) {
	...
	public LIVE_ALBUM(DisambiguatingDescription disambiguatingDescription) {
	...
	public LIVE_ALBUM(Identifier identifier) {
	...
	public LIVE_ALBUM(MainEntityOfPage mainEntityOfPage) {
	...
	public LIVE_ALBUM(NameFuzzy nameFuzzy) {
	...
	public LIVE_ALBUM(NameRuby nameRuby) {
	...
	public LIVE_ALBUM(PotentialAction potentialAction) {
	...
	public LIVE_ALBUM(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public LIVE_ALBUM(SubjectOf subjectOf) {
	...
	public LIVE_ALBUM(SupersededBy supersededBy) {
	...
	public void copy(MusicAlbumProductionType.LiveAlbum org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MusicAlbumProductionType.LiveAlbum.class.getAnnotation(SampleValue.class).value();
	}
