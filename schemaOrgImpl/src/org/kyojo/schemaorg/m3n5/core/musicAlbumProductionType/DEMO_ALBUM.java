...
public class DEMO_ALBUM implements MusicAlbumProductionType.DemoAlbum {
	...
	public DEMO_ALBUM(Long seq) {
		setSeq(seq);
	}

	public DEMO_ALBUM(String string) {
	...
	public DEMO_ALBUM(AdditionalType additionalType) {
	...
	public DEMO_ALBUM(AlternateName alternateName) {
	...
	public DEMO_ALBUM(Description description) {
	...
	public DEMO_ALBUM(DisambiguatingDescription disambiguatingDescription) {
	...
	public DEMO_ALBUM(Identifier identifier) {
	...
	public DEMO_ALBUM(MainEntityOfPage mainEntityOfPage) {
	...
	public DEMO_ALBUM(NameFuzzy nameFuzzy) {
	...
	public DEMO_ALBUM(NameRuby nameRuby) {
	...
	public DEMO_ALBUM(PotentialAction potentialAction) {
	...
	public DEMO_ALBUM(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DEMO_ALBUM(SubjectOf subjectOf) {
	...
	public DEMO_ALBUM(SupersededBy supersededBy) {
	...
	public void copy(MusicAlbumProductionType.DemoAlbum org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MusicAlbumProductionType.DemoAlbum.class.getAnnotation(SampleValue.class).value();
	}
