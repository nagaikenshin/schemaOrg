...
public class CRITIC_REVIEW implements Clazz.CriticReview {
	...
	public CRITIC_REVIEW() {
	}

	public CRITIC_REVIEW(Long seq) {
		setSeq(seq);
	}

	public CRITIC_REVIEW(String string) {
	...
	public CRITIC_REVIEW(About about) {
		setAbout(about);
	}
	...
	public CRITIC_REVIEW(AccessMode accessMode) {
	...
	public CRITIC_REVIEW(AccessModeSufficient accessModeSufficient) {
	...
	public CRITIC_REVIEW(AccessibilityAPI accessibilityAPI) {
	...
	public CRITIC_REVIEW(AccessibilityControl accessibilityControl) {
	...
	public CRITIC_REVIEW(AccessibilityFeature accessibilityFeature) {
	...
	public CRITIC_REVIEW(AccessibilityHazard accessibilityHazard) {
	...
	public CRITIC_REVIEW(AccessibilitySummary accessibilitySummary) {
	...
	public CRITIC_REVIEW(AccountablePerson accountablePerson) {
	...
	public CRITIC_REVIEW(AdditionalType additionalType) {
	...
	public CRITIC_REVIEW(AggregateRating aggregateRating) {
	...
	public CRITIC_REVIEW(AlternateName alternateName) {
	...
	public CRITIC_REVIEW(AlternativeHeadline alternativeHeadline) {
	...
	public CRITIC_REVIEW(AssociatedMedia associatedMedia) {
	...
	public CRITIC_REVIEW(Audience audience) {
	...
	public CRITIC_REVIEW(Audio audio) {
		setAudio(audio);
	}
	...
	public CRITIC_REVIEW(Author author) {
		setAuthor(author);
	}
	...
	public CRITIC_REVIEW(Award award) {
		setAward(award);
	}
	...
	public CRITIC_REVIEW(Character character) {
	...
	public CRITIC_REVIEW(Citation citation) {
	...
	public CRITIC_REVIEW(Comment comment) {
		setComment(comment);
	}
	...
	public CRITIC_REVIEW(CommentCount commentCount) {
	...
	public CRITIC_REVIEW(ContentLocation contentLocation) {
	...
	public CRITIC_REVIEW(ContentRating contentRating) {
	...
	public CRITIC_REVIEW(ContentReferenceTime contentReferenceTime) {
	...
	public CRITIC_REVIEW(Contributor contributor) {
	...
	public CRITIC_REVIEW(CopyrightHolder copyrightHolder) {
	...
	public CRITIC_REVIEW(CopyrightYear copyrightYear) {
	...
	public CRITIC_REVIEW(Correction correction) {
	...
	public CRITIC_REVIEW(Creator creator) {
		setCreator(creator);
	}
	...
	public CRITIC_REVIEW(DateCreated dateCreated) {
	...
	public CRITIC_REVIEW(DateModified dateModified) {
	...
	public CRITIC_REVIEW(DatePublished datePublished) {
	...
	public CRITIC_REVIEW(Description description) {
	...
	public CRITIC_REVIEW(DisambiguatingDescription disambiguatingDescription) {
	...
	public CRITIC_REVIEW(DiscussionUrl discussionUrl) {
	...
	public CRITIC_REVIEW(Editor editor) {
		setEditor(editor);
	}
	...
	public CRITIC_REVIEW(EducationalAlignment educationalAlignment) {
	...
	public CRITIC_REVIEW(EducationalUse educationalUse) {
	...
	public CRITIC_REVIEW(Encoding encoding) {
	...
	public CRITIC_REVIEW(EncodingFormat encodingFormat) {
	...
	public CRITIC_REVIEW(ExampleOfWork exampleOfWork) {
	...
	public CRITIC_REVIEW(Expires expires) {
		setExpires(expires);
	}
	...
	public CRITIC_REVIEW(Funder funder) {
		setFunder(funder);
	}
	...
	public CRITIC_REVIEW(Genre genre) {
		setGenre(genre);
	}
	...
	public CRITIC_REVIEW(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public CRITIC_REVIEW(Headline headline) {
	...
	public CRITIC_REVIEW(Identifier identifier) {
	...
	public CRITIC_REVIEW(Image image) {
		setImage(image);
	}
	...
	public CRITIC_REVIEW(InLanguage inLanguage) {
	...
	public CRITIC_REVIEW(InteractionStatistic interactionStatistic) {
	...
	public CRITIC_REVIEW(InteractivityType interactivityType) {
	...
	public CRITIC_REVIEW(IsAccessibleForFree isAccessibleForFree) {
	...
	public CRITIC_REVIEW(IsBasedOn isBasedOn) {
	...
	public CRITIC_REVIEW(IsFamilyFriendly isFamilyFriendly) {
	...
	public CRITIC_REVIEW(IsPartOf isPartOf) {
	...
	public CRITIC_REVIEW(ItemReviewed itemReviewed) {
	...
	public CRITIC_REVIEW(Keywords keywords) {
	...
	public CRITIC_REVIEW(LearningResourceType learningResourceType) {
	...
	public CRITIC_REVIEW(License license) {
		setLicense(license);
	}
	...
	public CRITIC_REVIEW(LocationCreated locationCreated) {
	...
	public CRITIC_REVIEW(MainEntity mainEntity) {
	...
	public CRITIC_REVIEW(MainEntityOfPage mainEntityOfPage) {
	...
	public CRITIC_REVIEW(Material material) {
	...
	public CRITIC_REVIEW(MaterialExtent materialExtent) {
	...
	public CRITIC_REVIEW(Mentions mentions) {
	...
	public CRITIC_REVIEW(Name name) {
		setName(name);
	}
	...
	public CRITIC_REVIEW(NameFuzzy nameFuzzy) {
	...
	public CRITIC_REVIEW(NameRuby nameRuby) {
	...
	public CRITIC_REVIEW(Offers offers) {
		setOffers(offers);
	}
	...
	public CRITIC_REVIEW(Position position) {
	...
	public CRITIC_REVIEW(PotentialAction potentialAction) {
	...
	public CRITIC_REVIEW(Producer producer) {
	...
	public CRITIC_REVIEW(Provider provider) {
	...
	public CRITIC_REVIEW(Publication publication) {
	...
	public CRITIC_REVIEW(Publisher publisher) {
	...
	public CRITIC_REVIEW(PublisherImprint publisherImprint) {
	...
	public CRITIC_REVIEW(PublishingPrinciples publishingPrinciples) {
	...
	public CRITIC_REVIEW(RecordedAt recordedAt) {
	...
	public CRITIC_REVIEW(ReleasedEvent releasedEvent) {
	...
	public CRITIC_REVIEW(Review review) {
		setReview(review);
	}
	...
	public CRITIC_REVIEW(ReviewAspect reviewAspect) {
	...
	public CRITIC_REVIEW(ReviewBody reviewBody) {
	...
	public CRITIC_REVIEW(ReviewRating reviewRating) {
	...
	public CRITIC_REVIEW(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CRITIC_REVIEW(SchemaVersion schemaVersion) {
	...
	public CRITIC_REVIEW(SdDatePublished sdDatePublished) {
	...
	public CRITIC_REVIEW(SdLicense sdLicense) {
	...
	public CRITIC_REVIEW(SdPublisher sdPublisher) {
	...
	public CRITIC_REVIEW(SourceOrganization sourceOrganization) {
	...
	public CRITIC_REVIEW(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public CRITIC_REVIEW(SpatialCoverage spatialCoverage) {
	...
	public CRITIC_REVIEW(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public CRITIC_REVIEW(SubjectOf subjectOf) {
	...
	public CRITIC_REVIEW(Temporal temporal) {
	...
	public CRITIC_REVIEW(TemporalCoverage temporalCoverage) {
	...
	public CRITIC_REVIEW(Text text) {
		setText(text);
	}
	...
	public CRITIC_REVIEW(ThumbnailUrl thumbnailUrl) {
	...
	public CRITIC_REVIEW(TimeRequired timeRequired) {
	...
	public CRITIC_REVIEW(TranslationOfWork translationOfWork) {
	...
	public CRITIC_REVIEW(Translator translator) {
	...
	public CRITIC_REVIEW(TypicalAgeRange typicalAgeRange) {
	...
	public CRITIC_REVIEW(Version version) {
		setVersion(version);
	}
	...
	public CRITIC_REVIEW(Video video) {
		setVideo(video);
	}
	...
	public CRITIC_REVIEW(WorkExample workExample) {
	...
	public CRITIC_REVIEW(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.CriticReview org) {
		setSeq(org.getSeq());
