...
public class ETHICS_POLICY implements Container.EthicsPolicy {
	...
	public ETHICS_POLICY(String string) {
	...
	public ETHICS_POLICY(APIReference apiReference) {
	...
	public ETHICS_POLICY(AboutPage aboutPage) {
	...
	public ETHICS_POLICY(AdvertiserContentArticle advertiserContentArticle) {
	...
	public ETHICS_POLICY(AnalysisNewsArticle analysisNewsArticle) {
	...
	public ETHICS_POLICY(Answer answer) {
	...
	public ETHICS_POLICY(ArchiveComponent archiveComponent) {
	...
	public ETHICS_POLICY(Article article) {
	...
	public ETHICS_POLICY(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public ETHICS_POLICY(Atlas atlas) {
	...
	public ETHICS_POLICY(AudioObject audioObject) {
	...
	public ETHICS_POLICY(Audiobook audiobook) {
	...
	public ETHICS_POLICY(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public ETHICS_POLICY(Barcode barcode) {
	...
	public ETHICS_POLICY(Blog blog) {
	...
	public ETHICS_POLICY(BlogPosting blogPosting) {
	...
	public ETHICS_POLICY(Book book) {
	...
	public ETHICS_POLICY(BookSeries bookSeries) {
	...
	public ETHICS_POLICY(CategoryCodeSet categoryCodeSet) {
	...
	public ETHICS_POLICY(Chapter chapter) {
	...
	public ETHICS_POLICY(CheckoutPage checkoutPage) {
	...
	public ETHICS_POLICY(Claim claim) {
	...
	public ETHICS_POLICY(ClaimReview claimReview) {
	...
	public ETHICS_POLICY(Clip clip) {
	...
	public ETHICS_POLICY(Collection collection) {
	...
	public ETHICS_POLICY(CollectionPage collectionPage) {
	...
	public ETHICS_POLICY(ComicCoverArt comicCoverArt) {
	...
	public ETHICS_POLICY(ComicIssue comicIssue) {
	...
	public ETHICS_POLICY(ComicSeries comicSeries) {
	...
	public ETHICS_POLICY(ComicStory comicStory) {
	...
	public ETHICS_POLICY(Comment comment) {
	...
	public ETHICS_POLICY(CompleteDataFeed completeDataFeed) {
	...
	public ETHICS_POLICY(ContactPage contactPage) {
	...
	public ETHICS_POLICY(Conversation conversation) {
	...
	public ETHICS_POLICY(CorrectionComment correctionComment) {
	...
	public ETHICS_POLICY(Course course) {
	...
	public ETHICS_POLICY(CoverArt coverArt) {
	...
	public ETHICS_POLICY(CreativeWork creativeWork) {
	...
	public ETHICS_POLICY(CreativeWorkSeason creativeWorkSeason) {
	...
	public ETHICS_POLICY(CreativeWorkSeries creativeWorkSeries) {
	...
	public ETHICS_POLICY(CriticReview criticReview) {
	...
	public ETHICS_POLICY(DataCatalog dataCatalog) {
	...
	public ETHICS_POLICY(DataDownload dataDownload) {
	...
	public ETHICS_POLICY(DataFeed dataFeed) {
	...
	public ETHICS_POLICY(Dataset dataset) {
	...
	public ETHICS_POLICY(DefinedTermSet definedTermSet) {
	...
	public ETHICS_POLICY(Diet diet) {
	...
	public ETHICS_POLICY(DigitalDocument digitalDocument) {
	...
	public ETHICS_POLICY(DiscussionForumPosting discussionForumPosting) {
	...
	public ETHICS_POLICY(Drawing drawing) {
	...
	public ETHICS_POLICY(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public ETHICS_POLICY(EmailMessage emailMessage) {
	...
	public ETHICS_POLICY(EmployerReview employerReview) {
	...
	public ETHICS_POLICY(Episode episode) {
	...
	public ETHICS_POLICY(ExercisePlan exercisePlan) {
	...
	public ETHICS_POLICY(FAQPage faqPage) {
	...
	public ETHICS_POLICY(Game game) {
	...
	public ETHICS_POLICY(HowTo howTo) {
	...
	public ETHICS_POLICY(HowToDirection howToDirection) {
	...
	public ETHICS_POLICY(HowToSection howToSection) {
	...
	public ETHICS_POLICY(HowToStep howToStep) {
	...
	public ETHICS_POLICY(HowToTip howToTip) {
	...
	public ETHICS_POLICY(ImageGallery imageGallery) {
	...
	public ETHICS_POLICY(ImageObject imageObject) {
	...
	public ETHICS_POLICY(ItemPage itemPage) {
	...
	public ETHICS_POLICY(Legislation legislation) {
	...
	public ETHICS_POLICY(LegislationObject legislationObject) {
	...
	public ETHICS_POLICY(LiveBlogPosting liveBlogPosting) {
	...
	public ETHICS_POLICY(Manuscript manuscript) {
	...
	public ETHICS_POLICY(MediaObject mediaObject) {
	...
	public ETHICS_POLICY(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public ETHICS_POLICY(MedicalWebPage medicalWebPage) {
	...
	public ETHICS_POLICY(Menu menu) {
	...
	public ETHICS_POLICY(MenuSection menuSection) {
	...
	public ETHICS_POLICY(Message message) {
	...
	public ETHICS_POLICY(MobileApplication mobileApplication) {
	...
	public ETHICS_POLICY(Movie movie) {
	...
	public ETHICS_POLICY(MovieClip movieClip) {
	...
	public ETHICS_POLICY(MovieSeries movieSeries) {
	...
	public ETHICS_POLICY(MusicAlbum musicAlbum) {
	...
	public ETHICS_POLICY(MusicComposition musicComposition) {
	...
	public ETHICS_POLICY(MusicPlaylist musicPlaylist) {
	...
	public ETHICS_POLICY(MusicRecording musicRecording) {
	...
	public ETHICS_POLICY(MusicRelease musicRelease) {
	...
	public ETHICS_POLICY(MusicVideoObject musicVideoObject) {
	...
	public ETHICS_POLICY(NewsArticle newsArticle) {
	...
	public ETHICS_POLICY(Newspaper newspaper) {
	...
	public ETHICS_POLICY(NoteDigitalDocument noteDigitalDocument) {
	...
	public ETHICS_POLICY(OpinionNewsArticle opinionNewsArticle) {
	...
	public ETHICS_POLICY(Painting painting) {
	...
	public ETHICS_POLICY(Periodical periodical) {
	...
	public ETHICS_POLICY(Photograph photograph) {
	...
	public ETHICS_POLICY(Play play) {
	...
	public ETHICS_POLICY(Poster poster) {
	...
	public ETHICS_POLICY(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public ETHICS_POLICY(ProfilePage profilePage) {
	...
	public ETHICS_POLICY(PublicationIssue publicationIssue) {
	...
	public ETHICS_POLICY(PublicationVolume publicationVolume) {
	...
	public ETHICS_POLICY(QAPage qaPage) {
	...
	public ETHICS_POLICY(Question question) {
	...
	public ETHICS_POLICY(Quotation quotation) {
	...
	public ETHICS_POLICY(RadioClip radioClip) {
	...
	public ETHICS_POLICY(RadioEpisode radioEpisode) {
	...
	public ETHICS_POLICY(RadioSeason radioSeason) {
	...
	public ETHICS_POLICY(RadioSeries radioSeries) {
	...
	public ETHICS_POLICY(Recipe recipe) {
	...
	public ETHICS_POLICY(Report report) {
	...
	public ETHICS_POLICY(ReportageNewsArticle reportageNewsArticle) {
	...
	public ETHICS_POLICY(Review review) {
	...
	public ETHICS_POLICY(ReviewNewsArticle reviewNewsArticle) {
	...
	public ETHICS_POLICY(SatiricalArticle satiricalArticle) {
	...
	public ETHICS_POLICY(ScholarlyArticle scholarlyArticle) {
	...
	public ETHICS_POLICY(Sculpture sculpture) {
	...
	public ETHICS_POLICY(SearchResultsPage searchResultsPage) {
	...
	public ETHICS_POLICY(SheetMusic sheetMusic) {
	...
	public ETHICS_POLICY(ShortStory shortStory) {
	...
	public ETHICS_POLICY(SiteNavigationElement siteNavigationElement) {
	...
	public ETHICS_POLICY(SocialMediaPosting socialMediaPosting) {
	...
	public ETHICS_POLICY(SoftwareApplication softwareApplication) {
	...
	public ETHICS_POLICY(SoftwareSourceCode softwareSourceCode) {
	...
	public ETHICS_POLICY(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public ETHICS_POLICY(TVClip tvClip) {
	...
	public ETHICS_POLICY(TVEpisode tvEpisode) {
	...
	public ETHICS_POLICY(TVSeason tvSeason) {
	...
	public ETHICS_POLICY(TVSeries tvSeries) {
	...
	public ETHICS_POLICY(Table table) {
	...
	public ETHICS_POLICY(TechArticle techArticle) {
	...
	public ETHICS_POLICY(TextDigitalDocument textDigitalDocument) {
	...
	public ETHICS_POLICY(Thesis thesis) {
	...
	public ETHICS_POLICY(ThreeDimensionalModel threeDimensionalModel) {
	...
	public ETHICS_POLICY(UserReview userReview) {
	...
	public ETHICS_POLICY(VideoGallery videoGallery) {
	...
	public ETHICS_POLICY(VideoGame videoGame) {
	...
	public ETHICS_POLICY(VideoGameClip videoGameClip) {
	...
	public ETHICS_POLICY(VideoGameSeries videoGameSeries) {
	...
	public ETHICS_POLICY(VideoObject videoObject) {
	...
	public ETHICS_POLICY(VisualArtwork visualArtwork) {
	...
	public ETHICS_POLICY(WPAdBlock wpAdBlock) {
	...
	public ETHICS_POLICY(WPFooter wpFooter) {
	...
	public ETHICS_POLICY(WPHeader wpHeader) {
	...
	public ETHICS_POLICY(WPSideBar wpSideBar) {
	...
	public ETHICS_POLICY(WebApplication webApplication) {
	...
	public ETHICS_POLICY(WebPage webPage) {
	...
	public ETHICS_POLICY(WebPageElement webPageElement) {
	...
	public ETHICS_POLICY(WebSite webSite) {
	...
	public void copy(Container.EthicsPolicy org) {
