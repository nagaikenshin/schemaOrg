...
public class NSN implements Container.Nsn {
	...
	public NSN(LocationFeatureSpecification locationFeatureSpecification) {
	...
	public NSN(PropertyValue propertyValue) {
	...
	public NSN(String string) {
		this(new TEXT(string));
	}

	public NSN(Text text) {
	...
	public NSN(List<LocationFeatureSpecification> locationFeatureSpecificationList,
	...
	public void copy(Container.Nsn org) {
