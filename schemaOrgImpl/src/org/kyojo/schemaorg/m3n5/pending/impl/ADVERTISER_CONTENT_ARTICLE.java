...
import org.kyojo.schemaorg.m3n5.core.Container.PageEnd;
...
public class ADVERTISER_CONTENT_ARTICLE implements Clazz.AdvertiserContentArticle {
	...
	public ADVERTISER_CONTENT_ARTICLE() {
	}

	public ADVERTISER_CONTENT_ARTICLE(Long seq) {
		setSeq(seq);
	}

	public ADVERTISER_CONTENT_ARTICLE(String string) {
	...
	public ADVERTISER_CONTENT_ARTICLE(About about) {
		setAbout(about);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(AccessMode accessMode) {
	...
	public ADVERTISER_CONTENT_ARTICLE(AccessModeSufficient accessModeSufficient) {
	...
	public ADVERTISER_CONTENT_ARTICLE(AccessibilityAPI accessibilityAPI) {
	...
	public ADVERTISER_CONTENT_ARTICLE(AccessibilityControl accessibilityControl) {
	...
	public ADVERTISER_CONTENT_ARTICLE(AccessibilityFeature accessibilityFeature) {
	...
	public ADVERTISER_CONTENT_ARTICLE(AccessibilityHazard accessibilityHazard) {
	...
	public ADVERTISER_CONTENT_ARTICLE(AccessibilitySummary accessibilitySummary) {
	...
	public ADVERTISER_CONTENT_ARTICLE(AccountablePerson accountablePerson) {
	...
	public ADVERTISER_CONTENT_ARTICLE(AdditionalType additionalType) {
	...
	public ADVERTISER_CONTENT_ARTICLE(AggregateRating aggregateRating) {
	...
	public ADVERTISER_CONTENT_ARTICLE(AlternateName alternateName) {
	...
	public ADVERTISER_CONTENT_ARTICLE(AlternativeHeadline alternativeHeadline) {
	...
	public ADVERTISER_CONTENT_ARTICLE(ArticleBody articleBody) {
	...
	public ADVERTISER_CONTENT_ARTICLE(ArticleSection articleSection) {
	...
	public ADVERTISER_CONTENT_ARTICLE(AssociatedMedia associatedMedia) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Audience audience) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Audio audio) {
		setAudio(audio);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(Author author) {
		setAuthor(author);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(Award award) {
		setAward(award);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(Backstory backstory) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Character character) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Citation citation) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Comment comment) {
		setComment(comment);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(CommentCount commentCount) {
	...
	public ADVERTISER_CONTENT_ARTICLE(ContentLocation contentLocation) {
	...
	public ADVERTISER_CONTENT_ARTICLE(ContentRating contentRating) {
	...
	public ADVERTISER_CONTENT_ARTICLE(ContentReferenceTime contentReferenceTime) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Contributor contributor) {
	...
	public ADVERTISER_CONTENT_ARTICLE(CopyrightHolder copyrightHolder) {
	...
	public ADVERTISER_CONTENT_ARTICLE(CopyrightYear copyrightYear) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Correction correction) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Creator creator) {
		setCreator(creator);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(DateCreated dateCreated) {
	...
	public ADVERTISER_CONTENT_ARTICLE(DateModified dateModified) {
	...
	public ADVERTISER_CONTENT_ARTICLE(DatePublished datePublished) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Description description) {
	...
	public ADVERTISER_CONTENT_ARTICLE(DisambiguatingDescription disambiguatingDescription) {
	...
	public ADVERTISER_CONTENT_ARTICLE(DiscussionUrl discussionUrl) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Editor editor) {
		setEditor(editor);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(EducationalAlignment educationalAlignment) {
	...
	public ADVERTISER_CONTENT_ARTICLE(EducationalUse educationalUse) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Encoding encoding) {
	...
	public ADVERTISER_CONTENT_ARTICLE(EncodingFormat encodingFormat) {
	...
	public ADVERTISER_CONTENT_ARTICLE(ExampleOfWork exampleOfWork) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Expires expires) {
		setExpires(expires);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(Funder funder) {
		setFunder(funder);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(Genre genre) {
		setGenre(genre);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(Headline headline) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Identifier identifier) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Image image) {
		setImage(image);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(InLanguage inLanguage) {
	...
	public ADVERTISER_CONTENT_ARTICLE(InteractionStatistic interactionStatistic) {
	...
	public ADVERTISER_CONTENT_ARTICLE(InteractivityType interactivityType) {
	...
	public ADVERTISER_CONTENT_ARTICLE(IsAccessibleForFree isAccessibleForFree) {
	...
	public ADVERTISER_CONTENT_ARTICLE(IsBasedOn isBasedOn) {
	...
	public ADVERTISER_CONTENT_ARTICLE(IsFamilyFriendly isFamilyFriendly) {
	...
	public ADVERTISER_CONTENT_ARTICLE(IsPartOf isPartOf) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Keywords keywords) {
	...
	public ADVERTISER_CONTENT_ARTICLE(LearningResourceType learningResourceType) {
	...
	public ADVERTISER_CONTENT_ARTICLE(License license) {
		setLicense(license);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(LocationCreated locationCreated) {
	...
	public ADVERTISER_CONTENT_ARTICLE(MainEntity mainEntity) {
	...
	public ADVERTISER_CONTENT_ARTICLE(MainEntityOfPage mainEntityOfPage) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Material material) {
	...
	public ADVERTISER_CONTENT_ARTICLE(MaterialExtent materialExtent) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Mentions mentions) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Name name) {
		setName(name);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(NameFuzzy nameFuzzy) {
	...
	public ADVERTISER_CONTENT_ARTICLE(NameRuby nameRuby) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Offers offers) {
		setOffers(offers);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(PageEnd pageEnd) {
		setPageEnd(pageEnd);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(PageStart pageStart) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Pagination pagination) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Position position) {
	...
	public ADVERTISER_CONTENT_ARTICLE(PotentialAction potentialAction) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Producer producer) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Provider provider) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Publication publication) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Publisher publisher) {
	...
	public ADVERTISER_CONTENT_ARTICLE(PublisherImprint publisherImprint) {
	...
	public ADVERTISER_CONTENT_ARTICLE(PublishingPrinciples publishingPrinciples) {
	...
	public ADVERTISER_CONTENT_ARTICLE(RecordedAt recordedAt) {
	...
	public ADVERTISER_CONTENT_ARTICLE(ReleasedEvent releasedEvent) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Review review) {
		setReview(review);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(SchemaVersion schemaVersion) {
	...
	public ADVERTISER_CONTENT_ARTICLE(SdDatePublished sdDatePublished) {
	...
	public ADVERTISER_CONTENT_ARTICLE(SdLicense sdLicense) {
	...
	public ADVERTISER_CONTENT_ARTICLE(SdPublisher sdPublisher) {
	...
	public ADVERTISER_CONTENT_ARTICLE(SourceOrganization sourceOrganization) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(SpatialCoverage spatialCoverage) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Speakable speakable) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(SubjectOf subjectOf) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Temporal temporal) {
	...
	public ADVERTISER_CONTENT_ARTICLE(TemporalCoverage temporalCoverage) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Text text) {
		setText(text);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(ThumbnailUrl thumbnailUrl) {
	...
	public ADVERTISER_CONTENT_ARTICLE(TimeRequired timeRequired) {
	...
	public ADVERTISER_CONTENT_ARTICLE(TranslationOfWork translationOfWork) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Translator translator) {
	...
	public ADVERTISER_CONTENT_ARTICLE(TypicalAgeRange typicalAgeRange) {
	...
	public ADVERTISER_CONTENT_ARTICLE(Url url) {
		setUrl(url);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(Version version) {
		setVersion(version);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(Video video) {
		setVideo(video);
	}
	...
	public ADVERTISER_CONTENT_ARTICLE(WordCount wordCount) {
	...
	public ADVERTISER_CONTENT_ARTICLE(WorkExample workExample) {
	...
	public ADVERTISER_CONTENT_ARTICLE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.AdvertiserContentArticle org) {
		setSeq(org.getSeq());
