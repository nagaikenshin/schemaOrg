...
public class FUNDING_AGENCY implements Clazz.FundingAgency {
	...
	public FUNDING_AGENCY(Long seq) {
		setSeq(seq);
	}

	public FUNDING_AGENCY(String string) {
	...
	public FUNDING_AGENCY(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public FUNDING_AGENCY(AdditionalType additionalType) {
	...
	public FUNDING_AGENCY(Address address) {
		setAddress(address);
	}
	...
	public FUNDING_AGENCY(AggregateRating aggregateRating) {
	...
	public FUNDING_AGENCY(AlternateName alternateName) {
	...
	public FUNDING_AGENCY(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public FUNDING_AGENCY(AreaServed areaServed) {
	...
	public FUNDING_AGENCY(Award award) {
		setAward(award);
	}
	...
	public FUNDING_AGENCY(Brand brand) {
		setBrand(brand);
	}
	...
	public FUNDING_AGENCY(ContactPoint contactPoint) {
	...
	public FUNDING_AGENCY(CorrectionsPolicy correctionsPolicy) {
	...
	public FUNDING_AGENCY(Department department) {
	...
	public FUNDING_AGENCY(Description description) {
	...
	public FUNDING_AGENCY(DisambiguatingDescription disambiguatingDescription) {
	...
	public FUNDING_AGENCY(DissolutionDate dissolutionDate) {
	...
	public FUNDING_AGENCY(DiversityPolicy diversityPolicy) {
	...
	public FUNDING_AGENCY(DiversityStaffingReport diversityStaffingReport) {
	...
	public FUNDING_AGENCY(Duns duns) {
		setDuns(duns);
	}
	...
	public FUNDING_AGENCY(Email email) {
		setEmail(email);
	}
	...
	public FUNDING_AGENCY(Employee employee) {
	...
	public FUNDING_AGENCY(EthicsPolicy ethicsPolicy) {
	...
	public FUNDING_AGENCY(Event event) {
		setEvent(event);
	}
	...
	public FUNDING_AGENCY(FaxNumber faxNumber) {
	...
	public FUNDING_AGENCY(Founder founder) {
		setFounder(founder);
	}
	...
	public FUNDING_AGENCY(FoundingDate foundingDate) {
	...
	public FUNDING_AGENCY(FoundingLocation foundingLocation) {
	...
	public FUNDING_AGENCY(Funder funder) {
		setFunder(funder);
	}
	...
	public FUNDING_AGENCY(GlobalLocationNumber globalLocationNumber) {
	...
	public FUNDING_AGENCY(HasOfferCatalog hasOfferCatalog) {
	...
	public FUNDING_AGENCY(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public FUNDING_AGENCY(Identifier identifier) {
	...
	public FUNDING_AGENCY(Image image) {
		setImage(image);
	}
	...
	public FUNDING_AGENCY(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public FUNDING_AGENCY(KnowsAbout knowsAbout) {
	...
	public FUNDING_AGENCY(KnowsLanguage knowsLanguage) {
	...
	public FUNDING_AGENCY(LegalName legalName) {
	...
	public FUNDING_AGENCY(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public FUNDING_AGENCY(Location location) {
	...
	public FUNDING_AGENCY(Logo logo) {
		setLogo(logo);
	}
	...
	public FUNDING_AGENCY(MainEntityOfPage mainEntityOfPage) {
	...
	public FUNDING_AGENCY(MakesOffer makesOffer) {
	...
	public FUNDING_AGENCY(Member member) {
		setMember(member);
	}
	...
	public FUNDING_AGENCY(MemberOf memberOf) {
	...
	public FUNDING_AGENCY(Naics naics) {
		setNaics(naics);
	}
	...
	public FUNDING_AGENCY(Name name) {
		setName(name);
	}
	...
	public FUNDING_AGENCY(NameFuzzy nameFuzzy) {
	...
	public FUNDING_AGENCY(NameRuby nameRuby) {
	...
	public FUNDING_AGENCY(NumberOfEmployees numberOfEmployees) {
	...
	public FUNDING_AGENCY(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public FUNDING_AGENCY(Owns owns) {
		setOwns(owns);
	}
	...
	public FUNDING_AGENCY(ParentOrganization parentOrganization) {
	...
	public FUNDING_AGENCY(PotentialAction potentialAction) {
	...
	public FUNDING_AGENCY(PublishingPrinciples publishingPrinciples) {
	...
	public FUNDING_AGENCY(Review review) {
		setReview(review);
	}
	...
	public FUNDING_AGENCY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public FUNDING_AGENCY(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public FUNDING_AGENCY(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public FUNDING_AGENCY(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public FUNDING_AGENCY(SubOrganization subOrganization) {
	...
	public FUNDING_AGENCY(SubjectOf subjectOf) {
	...
	public FUNDING_AGENCY(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public FUNDING_AGENCY(Telephone telephone) {
	...
	public FUNDING_AGENCY(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public FUNDING_AGENCY(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.FundingAgency org) {
		setSeq(org.getSeq());
