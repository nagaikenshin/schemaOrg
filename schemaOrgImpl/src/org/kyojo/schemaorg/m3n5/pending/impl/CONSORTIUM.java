...
public class CONSORTIUM implements Clazz.Consortium {
	...
	public CONSORTIUM(Long seq) {
		setSeq(seq);
	}

	public CONSORTIUM(String string) {
	...
	public CONSORTIUM(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public CONSORTIUM(AdditionalType additionalType) {
	...
	public CONSORTIUM(Address address) {
		setAddress(address);
	}
	...
	public CONSORTIUM(AggregateRating aggregateRating) {
	...
	public CONSORTIUM(AlternateName alternateName) {
	...
	public CONSORTIUM(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public CONSORTIUM(AreaServed areaServed) {
	...
	public CONSORTIUM(ContactPoint contactPoint) {
	...
	public CONSORTIUM(CorrectionsPolicy correctionsPolicy) {
	...
	public CONSORTIUM(Department department) {
	...
	public CONSORTIUM(Description description) {
	...
	public CONSORTIUM(DisambiguatingDescription disambiguatingDescription) {
	...
	public CONSORTIUM(DissolutionDate dissolutionDate) {
	...
	public CONSORTIUM(DiversityPolicy diversityPolicy) {
	...
	public CONSORTIUM(DiversityStaffingReport diversityStaffingReport) {
	...
	public CONSORTIUM(Employee employee) {
	...
	public CONSORTIUM(EthicsPolicy ethicsPolicy) {
	...
	public CONSORTIUM(FaxNumber faxNumber) {
	...
	public CONSORTIUM(Founder founder) {
		setFounder(founder);
	}
	...
	public CONSORTIUM(FoundingDate foundingDate) {
	...
	public CONSORTIUM(FoundingLocation foundingLocation) {
	...
	public CONSORTIUM(Funder funder) {
		setFunder(funder);
	}
	...
	public CONSORTIUM(GlobalLocationNumber globalLocationNumber) {
	...
	public CONSORTIUM(HasOfferCatalog hasOfferCatalog) {
	...
	public CONSORTIUM(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public CONSORTIUM(Identifier identifier) {
	...
	public CONSORTIUM(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public CONSORTIUM(KnowsAbout knowsAbout) {
	...
	public CONSORTIUM(KnowsLanguage knowsLanguage) {
	...
	public CONSORTIUM(LegalName legalName) {
	...
	public CONSORTIUM(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public CONSORTIUM(Location location) {
	...
	public CONSORTIUM(MainEntityOfPage mainEntityOfPage) {
	...
	public CONSORTIUM(MakesOffer makesOffer) {
	...
	public CONSORTIUM(Member member) {
		setMember(member);
	}
	...
	public CONSORTIUM(MemberOf memberOf) {
	...
	public CONSORTIUM(NameFuzzy nameFuzzy) {
	...
	public CONSORTIUM(NameRuby nameRuby) {
	...
	public CONSORTIUM(NumberOfEmployees numberOfEmployees) {
	...
	public CONSORTIUM(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public CONSORTIUM(ParentOrganization parentOrganization) {
	...
	public CONSORTIUM(PotentialAction potentialAction) {
	...
	public CONSORTIUM(PublishingPrinciples publishingPrinciples) {
	...
	public CONSORTIUM(Review review) {
		setReview(review);
	}
	...
	public CONSORTIUM(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CONSORTIUM(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public CONSORTIUM(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public CONSORTIUM(SubOrganization subOrganization) {
	...
	public CONSORTIUM(SubjectOf subjectOf) {
	...
	public CONSORTIUM(Telephone telephone) {
	...
	public CONSORTIUM(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Consortium org) {
		setSeq(org.getSeq());
