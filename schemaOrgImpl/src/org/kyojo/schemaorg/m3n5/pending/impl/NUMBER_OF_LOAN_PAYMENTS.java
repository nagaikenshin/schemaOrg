...
public class NUMBER_OF_LOAN_PAYMENTS implements Container.NumberOfLoanPayments {
	...
	public NUMBER_OF_LOAN_PAYMENTS(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public NUMBER_OF_LOAN_PAYMENTS(Float fl0at) {
	...
	public NUMBER_OF_LOAN_PAYMENTS(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public NUMBER_OF_LOAN_PAYMENTS(Integer integer) {
	...
	public NUMBER_OF_LOAN_PAYMENTS(List<Float> fl0atList,
	...
	public void copy(Container.NumberOfLoanPayments org) {
