...
import org.kyojo.schemaorg.m3n5.pending.Container.Masthead;
...
public class NEWS_MEDIA_ORGANIZATION implements Clazz.NewsMediaOrganization {
	...
	public NoBylinesPolicy noBylinesPolicy;
	...
	public NEWS_MEDIA_ORGANIZATION(DiversityStaffingReport diversityStaffingReport) {
	...
	public NEWS_MEDIA_ORGANIZATION(KnowsAbout knowsAbout) {
	...
	public NEWS_MEDIA_ORGANIZATION(KnowsLanguage knowsLanguage) {
	...
	public NEWS_MEDIA_ORGANIZATION(NoBylinesPolicy noBylinesPolicy) {
		setNoBylinesPolicy(noBylinesPolicy);
	}

	@Override
	public NoBylinesPolicy getNoBylinesPolicy() {
		return noBylinesPolicy;
	}

	@Override
	public void setNoBylinesPolicy(NoBylinesPolicy noBylinesPolicy) {
	...
	public NEWS_MEDIA_ORGANIZATION(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public NEWS_MEDIA_ORGANIZATION(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public NEWS_MEDIA_ORGANIZATION(SubjectOf subjectOf) {
	...
	public void copy(Clazz.NewsMediaOrganization org) {
		...
		setNoBylinesPolicy(org.getNoBylinesPolicy());
