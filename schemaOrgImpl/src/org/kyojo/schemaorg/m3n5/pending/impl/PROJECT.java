...
public class PROJECT implements Clazz.Project {
	...
	public PROJECT(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public PROJECT(AdditionalType additionalType) {
	...
	public PROJECT(Address address) {
		setAddress(address);
	}
	...
	public PROJECT(AggregateRating aggregateRating) {
	...
	public PROJECT(AlternateName alternateName) {
	...
	public PROJECT(AreaServed areaServed) {
	...
	public PROJECT(ContactPoint contactPoint) {
	...
	public PROJECT(CorrectionsPolicy correctionsPolicy) {
	...
	public PROJECT(Department department) {
	...
	public PROJECT(Description description) {
	...
	public PROJECT(DisambiguatingDescription disambiguatingDescription) {
	...
	public PROJECT(DissolutionDate dissolutionDate) {
	...
	public PROJECT(DiversityPolicy diversityPolicy) {
	...
	public PROJECT(DiversityStaffingReport diversityStaffingReport) {
	...
	public PROJECT(EthicsPolicy ethicsPolicy) {
	...
	public PROJECT(FaxNumber faxNumber) {
	...
	public PROJECT(Founder founder) {
		setFounder(founder);
	}
	...
	public PROJECT(FoundingDate foundingDate) {
	...
	public PROJECT(FoundingLocation foundingLocation) {
	...
	public PROJECT(GlobalLocationNumber globalLocationNumber) {
	...
	public PROJECT(HasOfferCatalog hasOfferCatalog) {
	...
	public PROJECT(KnowsAbout knowsAbout) {
	...
	public PROJECT(KnowsLanguage knowsLanguage) {
	...
	public PROJECT(LegalName legalName) {
	...
	public PROJECT(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public PROJECT(MainEntityOfPage mainEntityOfPage) {
	...
	public PROJECT(MakesOffer makesOffer) {
	...
	public PROJECT(MemberOf memberOf) {
	...
	public PROJECT(NameFuzzy nameFuzzy) {
	...
	public PROJECT(NameRuby nameRuby) {
	...
	public PROJECT(NumberOfEmployees numberOfEmployees) {
	...
	public PROJECT(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public PROJECT(ParentOrganization parentOrganization) {
	...
	public PROJECT(PotentialAction potentialAction) {
	...
	public PROJECT(PublishingPrinciples publishingPrinciples) {
	...
	public PROJECT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public PROJECT(SubOrganization subOrganization) {
	...
	public PROJECT(SubjectOf subjectOf) {
	...
	public PROJECT(Telephone telephone) {
	...
	public PROJECT(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Project org) {
		setSeq(org.getSeq());
