...
public class TOURIST_TRIP implements Clazz.TouristTrip {
	...
	public TOURIST_TRIP(Long seq) {
		setSeq(seq);
	}

	public TOURIST_TRIP(String string) {
	...
	public TOURIST_TRIP(AdditionalType additionalType) {
	...
	public TOURIST_TRIP(AlternateName alternateName) {
	...
	public TOURIST_TRIP(ArrivalTime arrivalTime) {
	...
	public TOURIST_TRIP(DepartureTime departureTime) {
	...
	public TOURIST_TRIP(Description description) {
	...
	public TOURIST_TRIP(DisambiguatingDescription disambiguatingDescription) {
	...
	public TOURIST_TRIP(Identifier identifier) {
	...
	public TOURIST_TRIP(Image image) {
		setImage(image);
	}
	...
	public TOURIST_TRIP(Itinerary itinerary) {
	...
	public TOURIST_TRIP(MainEntityOfPage mainEntityOfPage) {
	...
	public TOURIST_TRIP(NameFuzzy nameFuzzy) {
	...
	public TOURIST_TRIP(NameRuby nameRuby) {
	...
	public TOURIST_TRIP(Offers offers) {
		setOffers(offers);
	}
	...
	public TOURIST_TRIP(PartOfTrip partOfTrip) {
	...
	public TOURIST_TRIP(PotentialAction potentialAction) {
	...
	public TOURIST_TRIP(Provider provider) {
	...
	public TOURIST_TRIP(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TOURIST_TRIP(SubTrip subTrip) {
		setSubTrip(subTrip);
	}
	...
	public TOURIST_TRIP(SubjectOf subjectOf) {
	...
	public TOURIST_TRIP(TouristType touristType) {
	...
	public void copy(Clazz.TouristTrip org) {
		setSeq(org.getSeq());
