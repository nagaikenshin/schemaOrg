...
public class QUOTATION implements Clazz.Quotation {
	...
	public SpokenByCharacter spokenByCharacter;
	...
	public QUOTATION(Long seq) {
		setSeq(seq);
	}

	public QUOTATION(String string) {
	...
	public QUOTATION(AccessMode accessMode) {
	...
	public QUOTATION(AccessModeSufficient accessModeSufficient) {
	...
	public QUOTATION(AccessibilityAPI accessibilityAPI) {
	...
	public QUOTATION(AccessibilityControl accessibilityControl) {
	...
	public QUOTATION(AccessibilityFeature accessibilityFeature) {
	...
	public QUOTATION(AccessibilityHazard accessibilityHazard) {
	...
	public QUOTATION(AccessibilitySummary accessibilitySummary) {
	...
	public QUOTATION(AccountablePerson accountablePerson) {
	...
	public QUOTATION(AdditionalType additionalType) {
	...
	public QUOTATION(AggregateRating aggregateRating) {
	...
	public QUOTATION(AlternateName alternateName) {
	...
	public QUOTATION(AlternativeHeadline alternativeHeadline) {
	...
	public QUOTATION(AssociatedMedia associatedMedia) {
	...
	public QUOTATION(Audience audience) {
	...
	public QUOTATION(Author author) {
		setAuthor(author);
	}
	...
	public QUOTATION(Character character) {
	...
	public QUOTATION(Citation citation) {
	...
	public QUOTATION(Comment comment) {
		setComment(comment);
	}
	...
	public QUOTATION(CommentCount commentCount) {
	...
	public QUOTATION(ContentLocation contentLocation) {
	...
	public QUOTATION(ContentRating contentRating) {
	...
	public QUOTATION(ContentReferenceTime contentReferenceTime) {
	...
	public QUOTATION(Contributor contributor) {
	...
	public QUOTATION(CopyrightHolder copyrightHolder) {
	...
	public QUOTATION(CopyrightYear copyrightYear) {
	...
	public QUOTATION(Correction correction) {
	...
	public QUOTATION(Creator creator) {
		setCreator(creator);
	}
	...
	public QUOTATION(DateCreated dateCreated) {
	...
	public QUOTATION(DateModified dateModified) {
	...
	public QUOTATION(DatePublished datePublished) {
	...
	public QUOTATION(Description description) {
	...
	public QUOTATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public QUOTATION(DiscussionUrl discussionUrl) {
	...
	public QUOTATION(Editor editor) {
		setEditor(editor);
	}
	...
	public QUOTATION(EducationalAlignment educationalAlignment) {
	...
	public QUOTATION(EducationalUse educationalUse) {
	...
	public QUOTATION(Encoding encoding) {
	...
	public QUOTATION(EncodingFormat encodingFormat) {
	...
	public QUOTATION(ExampleOfWork exampleOfWork) {
	...
	public QUOTATION(Expires expires) {
		setExpires(expires);
	}
	...
	public QUOTATION(Funder funder) {
		setFunder(funder);
	}
	...
	public QUOTATION(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public QUOTATION(Headline headline) {
	...
	public QUOTATION(Identifier identifier) {
	...
	public QUOTATION(InLanguage inLanguage) {
	...
	public QUOTATION(InteractionStatistic interactionStatistic) {
	...
	public QUOTATION(InteractivityType interactivityType) {
	...
	public QUOTATION(IsAccessibleForFree isAccessibleForFree) {
	...
	public QUOTATION(IsBasedOn isBasedOn) {
	...
	public QUOTATION(IsFamilyFriendly isFamilyFriendly) {
	...
	public QUOTATION(IsPartOf isPartOf) {
	...
	public QUOTATION(Keywords keywords) {
	...
	public QUOTATION(LearningResourceType learningResourceType) {
	...
	public QUOTATION(License license) {
		setLicense(license);
	}
	...
	public QUOTATION(LocationCreated locationCreated) {
	...
	public QUOTATION(MainEntity mainEntity) {
	...
	public QUOTATION(MainEntityOfPage mainEntityOfPage) {
	...
	public QUOTATION(Material material) {
	...
	public QUOTATION(MaterialExtent materialExtent) {
	...
	public QUOTATION(Mentions mentions) {
	...
	public QUOTATION(NameFuzzy nameFuzzy) {
	...
	public QUOTATION(NameRuby nameRuby) {
	...
	public QUOTATION(Offers offers) {
		setOffers(offers);
	}
	...
	public QUOTATION(Position position) {
	...
	public QUOTATION(PotentialAction potentialAction) {
	...
	public QUOTATION(Producer producer) {
	...
	public QUOTATION(Provider provider) {
	...
	public QUOTATION(Publication publication) {
	...
	public QUOTATION(Publisher publisher) {
	...
	public QUOTATION(PublisherImprint publisherImprint) {
	...
	public QUOTATION(PublishingPrinciples publishingPrinciples) {
	...
	public QUOTATION(RecordedAt recordedAt) {
	...
	public QUOTATION(ReleasedEvent releasedEvent) {
	...
	public QUOTATION(Review review) {
		setReview(review);
	}
	...
	public QUOTATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public QUOTATION(SchemaVersion schemaVersion) {
	...
	public QUOTATION(SdDatePublished sdDatePublished) {
	...
	public QUOTATION(SdLicense sdLicense) {
	...
	public QUOTATION(SdPublisher sdPublisher) {
	...
	public QUOTATION(SourceOrganization sourceOrganization) {
	...
	public QUOTATION(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public QUOTATION(SpatialCoverage spatialCoverage) {
	...
	public QUOTATION(SpokenByCharacter spokenByCharacter) {
		setSpokenByCharacter(spokenByCharacter);
	}

	@Override
	public SpokenByCharacter getSpokenByCharacter() {
		return spokenByCharacter;
	}

	@Override
	public void setSpokenByCharacter(SpokenByCharacter spokenByCharacter) {
		this.spokenByCharacter = spokenByCharacter;
	}

	public QUOTATION(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public QUOTATION(SubjectOf subjectOf) {
	...
	public QUOTATION(Temporal temporal) {
	...
	public QUOTATION(TemporalCoverage temporalCoverage) {
	...
	public QUOTATION(ThumbnailUrl thumbnailUrl) {
	...
	public QUOTATION(TimeRequired timeRequired) {
	...
	public QUOTATION(TranslationOfWork translationOfWork) {
	...
	public QUOTATION(Translator translator) {
	...
	public QUOTATION(TypicalAgeRange typicalAgeRange) {
	...
	public QUOTATION(Version version) {
		setVersion(version);
	}
	...
	public QUOTATION(WorkExample workExample) {
	...
	public QUOTATION(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Quotation org) {
		setSeq(org.getSeq());
		...
		setSpokenByCharacter(org.getSpokenByCharacter());
