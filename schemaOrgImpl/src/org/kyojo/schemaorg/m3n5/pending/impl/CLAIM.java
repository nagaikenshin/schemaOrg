...
public class CLAIM implements Clazz.Claim {
	...
	public CLAIM(AccessMode accessMode) {
	...
	public CLAIM(AccessModeSufficient accessModeSufficient) {
	...
	public CLAIM(AccessibilityAPI accessibilityAPI) {
	...
	public CLAIM(AccessibilityControl accessibilityControl) {
	...
	public CLAIM(AccessibilityFeature accessibilityFeature) {
	...
	public CLAIM(AccessibilityHazard accessibilityHazard) {
	...
	public CLAIM(AccessibilitySummary accessibilitySummary) {
	...
	public CLAIM(AccountablePerson accountablePerson) {
	...
	public CLAIM(AdditionalType additionalType) {
	...
	public CLAIM(AggregateRating aggregateRating) {
	...
	public CLAIM(AlternateName alternateName) {
	...
	public CLAIM(AlternativeHeadline alternativeHeadline) {
	...
	public CLAIM(Appearance appearance) {
	...
	public CLAIM(AssociatedMedia associatedMedia) {
	...
	public CLAIM(Audience audience) {
	...
	public CLAIM(Character character) {
	...
	public CLAIM(Citation citation) {
	...
	public CLAIM(CommentCount commentCount) {
	...
	public CLAIM(ContentLocation contentLocation) {
	...
	public CLAIM(ContentRating contentRating) {
	...
	public CLAIM(ContentReferenceTime contentReferenceTime) {
	...
	public CLAIM(Contributor contributor) {
	...
	public CLAIM(CopyrightHolder copyrightHolder) {
	...
	public CLAIM(CopyrightYear copyrightYear) {
	...
	public CLAIM(Correction correction) {
	...
	public CLAIM(DateCreated dateCreated) {
	...
	public CLAIM(DateModified dateModified) {
	...
	public CLAIM(DatePublished datePublished) {
	...
	public CLAIM(Description description) {
	...
	public CLAIM(DisambiguatingDescription disambiguatingDescription) {
	...
	public CLAIM(DiscussionUrl discussionUrl) {
	...
	public CLAIM(EducationalAlignment educationalAlignment) {
	...
	public CLAIM(EducationalUse educationalUse) {
	...
	public CLAIM(Encoding encoding) {
	...
	public CLAIM(EncodingFormat encodingFormat) {
	...
	public CLAIM(ExampleOfWork exampleOfWork) {
	...
	public CLAIM(FirstAppearance firstAppearance) {
	...
	public CLAIM(Headline headline) {
	...
	public CLAIM(Identifier identifier) {
	...
	public CLAIM(InLanguage inLanguage) {
	...
	public CLAIM(InteractionStatistic interactionStatistic) {
	...
	public CLAIM(InteractivityType interactivityType) {
	...
	public CLAIM(IsAccessibleForFree isAccessibleForFree) {
	...
	public CLAIM(IsBasedOn isBasedOn) {
	...
	public CLAIM(IsFamilyFriendly isFamilyFriendly) {
	...
	public CLAIM(IsPartOf isPartOf) {
	...
	public CLAIM(Keywords keywords) {
	...
	public CLAIM(LearningResourceType learningResourceType) {
	...
	public CLAIM(LocationCreated locationCreated) {
	...
	public CLAIM(MainEntity mainEntity) {
	...
	public CLAIM(MainEntityOfPage mainEntityOfPage) {
	...
	public CLAIM(Material material) {
	...
	public CLAIM(MaterialExtent materialExtent) {
	...
	public CLAIM(Mentions mentions) {
	...
	public CLAIM(NameFuzzy nameFuzzy) {
	...
	public CLAIM(NameRuby nameRuby) {
	...
	public CLAIM(Position position) {
	...
	public CLAIM(PotentialAction potentialAction) {
	...
	public CLAIM(Producer producer) {
	...
	public CLAIM(Provider provider) {
	...
	public CLAIM(Publication publication) {
	...
	public CLAIM(Publisher publisher) {
	...
	public CLAIM(PublisherImprint publisherImprint) {
	...
	public CLAIM(PublishingPrinciples publishingPrinciples) {
	...
	public CLAIM(RecordedAt recordedAt) {
	...
	public CLAIM(ReleasedEvent releasedEvent) {
	...
	public CLAIM(SchemaVersion schemaVersion) {
	...
	public CLAIM(SdDatePublished sdDatePublished) {
	...
	public CLAIM(SdLicense sdLicense) {
	...
	public CLAIM(SdPublisher sdPublisher) {
	...
	public CLAIM(SourceOrganization sourceOrganization) {
	...
	public CLAIM(SpatialCoverage spatialCoverage) {
	...
	public CLAIM(SubjectOf subjectOf) {
	...
	public CLAIM(Temporal temporal) {
	...
	public CLAIM(TemporalCoverage temporalCoverage) {
	...
	public CLAIM(ThumbnailUrl thumbnailUrl) {
	...
	public CLAIM(TimeRequired timeRequired) {
	...
	public CLAIM(TranslationOfWork translationOfWork) {
	...
	public CLAIM(Translator translator) {
	...
	public CLAIM(TypicalAgeRange typicalAgeRange) {
	...
	public CLAIM(WorkExample workExample) {
	...
	public CLAIM(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Claim org) {
		setSeq(org.getSeq());
		...
		setAppearance(org.getAppearance());
		...
		setFirstAppearance(org.getFirstAppearance());
