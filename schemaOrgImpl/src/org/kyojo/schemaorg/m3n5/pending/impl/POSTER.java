...
public class POSTER implements Clazz.Poster {
	...
	public POSTER(AccessMode accessMode) {
	...
	public POSTER(AccessModeSufficient accessModeSufficient) {
	...
	public POSTER(AccessibilityAPI accessibilityAPI) {
	...
	public POSTER(AccessibilityControl accessibilityControl) {
	...
	public POSTER(AccessibilityFeature accessibilityFeature) {
	...
	public POSTER(AccessibilityHazard accessibilityHazard) {
	...
	public POSTER(AccessibilitySummary accessibilitySummary) {
	...
	public POSTER(AccountablePerson accountablePerson) {
	...
	public POSTER(AdditionalType additionalType) {
	...
	public POSTER(AggregateRating aggregateRating) {
	...
	public POSTER(AlternateName alternateName) {
	...
	public POSTER(AlternativeHeadline alternativeHeadline) {
	...
	public POSTER(AssociatedMedia associatedMedia) {
	...
	public POSTER(Audience audience) {
	...
	public POSTER(Character character) {
	...
	public POSTER(Citation citation) {
	...
	public POSTER(CommentCount commentCount) {
	...
	public POSTER(ContentLocation contentLocation) {
	...
	public POSTER(ContentRating contentRating) {
	...
	public POSTER(ContentReferenceTime contentReferenceTime) {
	...
	public POSTER(Contributor contributor) {
	...
	public POSTER(CopyrightHolder copyrightHolder) {
	...
	public POSTER(CopyrightYear copyrightYear) {
	...
	public POSTER(Correction correction) {
	...
	public POSTER(DateCreated dateCreated) {
	...
	public POSTER(DateModified dateModified) {
	...
	public POSTER(DatePublished datePublished) {
	...
	public POSTER(Description description) {
	...
	public POSTER(DisambiguatingDescription disambiguatingDescription) {
	...
	public POSTER(DiscussionUrl discussionUrl) {
	...
	public POSTER(EducationalAlignment educationalAlignment) {
	...
	public POSTER(EducationalUse educationalUse) {
	...
	public POSTER(Encoding encoding) {
	...
	public POSTER(EncodingFormat encodingFormat) {
	...
	public POSTER(ExampleOfWork exampleOfWork) {
	...
	public POSTER(Headline headline) {
	...
	public POSTER(Identifier identifier) {
	...
	public POSTER(InLanguage inLanguage) {
	...
	public POSTER(InteractionStatistic interactionStatistic) {
	...
	public POSTER(InteractivityType interactivityType) {
	...
	public POSTER(IsAccessibleForFree isAccessibleForFree) {
	...
	public POSTER(IsBasedOn isBasedOn) {
	...
	public POSTER(IsFamilyFriendly isFamilyFriendly) {
	...
	public POSTER(IsPartOf isPartOf) {
	...
	public POSTER(Keywords keywords) {
	...
	public POSTER(LearningResourceType learningResourceType) {
	...
	public POSTER(LocationCreated locationCreated) {
	...
	public POSTER(MainEntity mainEntity) {
	...
	public POSTER(MainEntityOfPage mainEntityOfPage) {
	...
	public POSTER(Material material) {
	...
	public POSTER(MaterialExtent materialExtent) {
	...
	public POSTER(Mentions mentions) {
	...
	public POSTER(NameFuzzy nameFuzzy) {
	...
	public POSTER(NameRuby nameRuby) {
	...
	public POSTER(Position position) {
	...
	public POSTER(PotentialAction potentialAction) {
	...
	public POSTER(Producer producer) {
	...
	public POSTER(Provider provider) {
	...
	public POSTER(Publication publication) {
	...
	public POSTER(Publisher publisher) {
	...
	public POSTER(PublisherImprint publisherImprint) {
	...
	public POSTER(PublishingPrinciples publishingPrinciples) {
	...
	public POSTER(RecordedAt recordedAt) {
	...
	public POSTER(ReleasedEvent releasedEvent) {
	...
	public POSTER(SchemaVersion schemaVersion) {
	...
	public POSTER(SdDatePublished sdDatePublished) {
	...
	public POSTER(SdLicense sdLicense) {
	...
	public POSTER(SdPublisher sdPublisher) {
	...
	public POSTER(SourceOrganization sourceOrganization) {
	...
	public POSTER(SpatialCoverage spatialCoverage) {
	...
	public POSTER(SubjectOf subjectOf) {
	...
	public POSTER(Temporal temporal) {
	...
	public POSTER(TemporalCoverage temporalCoverage) {
	...
	public POSTER(ThumbnailUrl thumbnailUrl) {
	...
	public POSTER(TimeRequired timeRequired) {
	...
	public POSTER(TranslationOfWork translationOfWork) {
	...
	public POSTER(Translator translator) {
	...
	public POSTER(TypicalAgeRange typicalAgeRange) {
	...
	public POSTER(WorkExample workExample) {
	...
	public POSTER(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Poster org) {
		setSeq(org.getSeq());
