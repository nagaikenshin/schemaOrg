...
public class SHEET_MUSIC implements Clazz.SheetMusic {
	...
	public SHEET_MUSIC(Long seq) {
		setSeq(seq);
	}

	public SHEET_MUSIC(String string) {
	...
	public SHEET_MUSIC(About about) {
		setAbout(about);
	}
	...
	public SHEET_MUSIC(AccessMode accessMode) {
	...
	public SHEET_MUSIC(AccessModeSufficient accessModeSufficient) {
	...
	public SHEET_MUSIC(AccessibilityAPI accessibilityAPI) {
	...
	public SHEET_MUSIC(AccessibilityControl accessibilityControl) {
	...
	public SHEET_MUSIC(AccessibilityFeature accessibilityFeature) {
	...
	public SHEET_MUSIC(AccessibilityHazard accessibilityHazard) {
	...
	public SHEET_MUSIC(AccessibilitySummary accessibilitySummary) {
	...
	public SHEET_MUSIC(AccountablePerson accountablePerson) {
	...
	public SHEET_MUSIC(AdditionalType additionalType) {
	...
	public SHEET_MUSIC(AggregateRating aggregateRating) {
	...
	public SHEET_MUSIC(AlternateName alternateName) {
	...
	public SHEET_MUSIC(AlternativeHeadline alternativeHeadline) {
	...
	public SHEET_MUSIC(AssociatedMedia associatedMedia) {
	...
	public SHEET_MUSIC(Audience audience) {
	...
	public SHEET_MUSIC(Audio audio) {
		setAudio(audio);
	}
	...
	public SHEET_MUSIC(Author author) {
		setAuthor(author);
	}
	...
	public SHEET_MUSIC(Award award) {
		setAward(award);
	}
	...
	public SHEET_MUSIC(Character character) {
	...
	public SHEET_MUSIC(Citation citation) {
	...
	public SHEET_MUSIC(Comment comment) {
		setComment(comment);
	}
	...
	public SHEET_MUSIC(CommentCount commentCount) {
	...
	public SHEET_MUSIC(ContentLocation contentLocation) {
	...
	public SHEET_MUSIC(ContentRating contentRating) {
	...
	public SHEET_MUSIC(ContentReferenceTime contentReferenceTime) {
	...
	public SHEET_MUSIC(Contributor contributor) {
	...
	public SHEET_MUSIC(CopyrightHolder copyrightHolder) {
	...
	public SHEET_MUSIC(CopyrightYear copyrightYear) {
	...
	public SHEET_MUSIC(Correction correction) {
	...
	public SHEET_MUSIC(Creator creator) {
		setCreator(creator);
	}
	...
	public SHEET_MUSIC(DateCreated dateCreated) {
	...
	public SHEET_MUSIC(DateModified dateModified) {
	...
	public SHEET_MUSIC(DatePublished datePublished) {
	...
	public SHEET_MUSIC(Description description) {
	...
	public SHEET_MUSIC(DisambiguatingDescription disambiguatingDescription) {
	...
	public SHEET_MUSIC(DiscussionUrl discussionUrl) {
	...
	public SHEET_MUSIC(Editor editor) {
		setEditor(editor);
	}
	...
	public SHEET_MUSIC(EducationalAlignment educationalAlignment) {
	...
	public SHEET_MUSIC(EducationalUse educationalUse) {
	...
	public SHEET_MUSIC(Encoding encoding) {
	...
	public SHEET_MUSIC(EncodingFormat encodingFormat) {
	...
	public SHEET_MUSIC(ExampleOfWork exampleOfWork) {
	...
	public SHEET_MUSIC(Expires expires) {
		setExpires(expires);
	}
	...
	public SHEET_MUSIC(Funder funder) {
		setFunder(funder);
	}
	...
	public SHEET_MUSIC(Genre genre) {
		setGenre(genre);
	}
	...
	public SHEET_MUSIC(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public SHEET_MUSIC(Headline headline) {
	...
	public SHEET_MUSIC(Identifier identifier) {
	...
	public SHEET_MUSIC(Image image) {
		setImage(image);
	}
	...
	public SHEET_MUSIC(InLanguage inLanguage) {
	...
	public SHEET_MUSIC(InteractionStatistic interactionStatistic) {
	...
	public SHEET_MUSIC(InteractivityType interactivityType) {
	...
	public SHEET_MUSIC(IsAccessibleForFree isAccessibleForFree) {
	...
	public SHEET_MUSIC(IsBasedOn isBasedOn) {
	...
	public SHEET_MUSIC(IsFamilyFriendly isFamilyFriendly) {
	...
	public SHEET_MUSIC(IsPartOf isPartOf) {
	...
	public SHEET_MUSIC(Keywords keywords) {
	...
	public SHEET_MUSIC(LearningResourceType learningResourceType) {
	...
	public SHEET_MUSIC(License license) {
		setLicense(license);
	}
	...
	public SHEET_MUSIC(LocationCreated locationCreated) {
	...
	public SHEET_MUSIC(MainEntity mainEntity) {
	...
	public SHEET_MUSIC(MainEntityOfPage mainEntityOfPage) {
	...
	public SHEET_MUSIC(Material material) {
	...
	public SHEET_MUSIC(MaterialExtent materialExtent) {
	...
	public SHEET_MUSIC(Mentions mentions) {
	...
	public SHEET_MUSIC(NameFuzzy nameFuzzy) {
	...
	public SHEET_MUSIC(NameRuby nameRuby) {
	...
	public SHEET_MUSIC(Offers offers) {
		setOffers(offers);
	}
	...
	public SHEET_MUSIC(Position position) {
	...
	public SHEET_MUSIC(PotentialAction potentialAction) {
	...
	public SHEET_MUSIC(Producer producer) {
	...
	public SHEET_MUSIC(Provider provider) {
	...
	public SHEET_MUSIC(Publication publication) {
	...
	public SHEET_MUSIC(Publisher publisher) {
	...
	public SHEET_MUSIC(PublisherImprint publisherImprint) {
	...
	public SHEET_MUSIC(PublishingPrinciples publishingPrinciples) {
	...
	public SHEET_MUSIC(RecordedAt recordedAt) {
	...
	public SHEET_MUSIC(ReleasedEvent releasedEvent) {
	...
	public SHEET_MUSIC(Review review) {
		setReview(review);
	}
	...
	public SHEET_MUSIC(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SHEET_MUSIC(SchemaVersion schemaVersion) {
	...
	public SHEET_MUSIC(SdDatePublished sdDatePublished) {
	...
	public SHEET_MUSIC(SdLicense sdLicense) {
	...
	public SHEET_MUSIC(SdPublisher sdPublisher) {
	...
	public SHEET_MUSIC(SourceOrganization sourceOrganization) {
	...
	public SHEET_MUSIC(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public SHEET_MUSIC(SpatialCoverage spatialCoverage) {
	...
	public SHEET_MUSIC(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public SHEET_MUSIC(SubjectOf subjectOf) {
	...
	public SHEET_MUSIC(Temporal temporal) {
	...
	public SHEET_MUSIC(TemporalCoverage temporalCoverage) {
	...
	public SHEET_MUSIC(ThumbnailUrl thumbnailUrl) {
	...
	public SHEET_MUSIC(TimeRequired timeRequired) {
	...
	public SHEET_MUSIC(TranslationOfWork translationOfWork) {
	...
	public SHEET_MUSIC(Translator translator) {
	...
	public SHEET_MUSIC(TypicalAgeRange typicalAgeRange) {
	...
	public SHEET_MUSIC(Version version) {
		setVersion(version);
	}
	...
	public SHEET_MUSIC(Video video) {
		setVideo(video);
	}
	...
	public SHEET_MUSIC(WorkExample workExample) {
	...
	public SHEET_MUSIC(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.SheetMusic org) {
		setSeq(org.getSeq());
