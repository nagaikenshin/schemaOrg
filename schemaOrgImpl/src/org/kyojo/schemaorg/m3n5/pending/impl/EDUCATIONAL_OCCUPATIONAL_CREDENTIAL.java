...
public class EDUCATIONAL_OCCUPATIONAL_CREDENTIAL implements Clazz.EducationalOccupationalCredential {
	...
	public CompetencyRequired competencyRequired;
	...
	public CredentialCategory credentialCategory;
	...
	public RecognizedBy recognizedBy;
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL() {
	}

	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Long seq) {
		setSeq(seq);
	}

	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(String string) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(About about) {
		setAbout(about);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(AccessMode accessMode) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(AccessModeSufficient accessModeSufficient) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(AccessibilityAPI accessibilityAPI) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(AccessibilityControl accessibilityControl) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(AccessibilityFeature accessibilityFeature) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(AccessibilityHazard accessibilityHazard) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(AccessibilitySummary accessibilitySummary) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(AccountablePerson accountablePerson) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(AdditionalType additionalType) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(AggregateRating aggregateRating) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(AlternateName alternateName) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(AlternativeHeadline alternativeHeadline) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(AssociatedMedia associatedMedia) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Audience audience) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Audio audio) {
		setAudio(audio);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Author author) {
		setAuthor(author);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Award award) {
		setAward(award);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Character character) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Citation citation) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Comment comment) {
		setComment(comment);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(CommentCount commentCount) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(CompetencyRequired competencyRequired) {
		setCompetencyRequired(competencyRequired);
	}

	@Override
	public CompetencyRequired getCompetencyRequired() {
		return competencyRequired;
	}

	@Override
	public void setCompetencyRequired(CompetencyRequired competencyRequired) {
		this.competencyRequired = competencyRequired;
	}

	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(ContentLocation contentLocation) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(ContentRating contentRating) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(ContentReferenceTime contentReferenceTime) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Contributor contributor) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(CopyrightHolder copyrightHolder) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(CopyrightYear copyrightYear) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Correction correction) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Creator creator) {
		setCreator(creator);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(CredentialCategory credentialCategory) {
		setCredentialCategory(credentialCategory);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(DateCreated dateCreated) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(DateModified dateModified) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(DatePublished datePublished) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Description description) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(DisambiguatingDescription disambiguatingDescription) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(DiscussionUrl discussionUrl) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Editor editor) {
		setEditor(editor);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(EducationalAlignment educationalAlignment) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(EducationalLevel educationalLevel) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(EducationalUse educationalUse) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Encoding encoding) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(EncodingFormat encodingFormat) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(ExampleOfWork exampleOfWork) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Expires expires) {
		setExpires(expires);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Funder funder) {
		setFunder(funder);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Genre genre) {
		setGenre(genre);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Headline headline) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Identifier identifier) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Image image) {
		setImage(image);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(InLanguage inLanguage) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(InteractionStatistic interactionStatistic) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(InteractivityType interactivityType) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(IsAccessibleForFree isAccessibleForFree) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(IsBasedOn isBasedOn) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(IsFamilyFriendly isFamilyFriendly) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(IsPartOf isPartOf) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Keywords keywords) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(LearningResourceType learningResourceType) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(License license) {
		setLicense(license);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(LocationCreated locationCreated) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(MainEntity mainEntity) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(MainEntityOfPage mainEntityOfPage) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Material material) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(MaterialExtent materialExtent) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Mentions mentions) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Name name) {
		setName(name);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(NameFuzzy nameFuzzy) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(NameRuby nameRuby) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Offers offers) {
		setOffers(offers);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Position position) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(PotentialAction potentialAction) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Producer producer) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Provider provider) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Publication publication) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Publisher publisher) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(PublisherImprint publisherImprint) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(PublishingPrinciples publishingPrinciples) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(RecognizedBy recognizedBy) {
		setRecognizedBy(recognizedBy);
	}
	...
	@Override
	public void setRecognizedBy(RecognizedBy recognizedBy) {
		this.recognizedBy = recognizedBy;
	}

	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(RecordedAt recordedAt) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(ReleasedEvent releasedEvent) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Review review) {
		setReview(review);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(SchemaVersion schemaVersion) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(SdDatePublished sdDatePublished) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(SdLicense sdLicense) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(SdPublisher sdPublisher) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(SourceOrganization sourceOrganization) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(SpatialCoverage spatialCoverage) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(SubjectOf subjectOf) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Temporal temporal) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(TemporalCoverage temporalCoverage) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Text text) {
		setText(text);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(ThumbnailUrl thumbnailUrl) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(TimeRequired timeRequired) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(TranslationOfWork translationOfWork) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Translator translator) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(TypicalAgeRange typicalAgeRange) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Url url) {
		setUrl(url);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(ValidFor validFor) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(ValidIn validIn) {
		setValidIn(validIn);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Version version) {
		setVersion(version);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(Video video) {
		setVideo(video);
	}
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(WorkExample workExample) {
	...
	public EDUCATIONAL_OCCUPATIONAL_CREDENTIAL(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.EducationalOccupationalCredential org) {
		setSeq(org.getSeq());
		...
		setCompetencyRequired(org.getCompetencyRequired());
		...
		setCredentialCategory(org.getCredentialCategory());
		...
		setEducationalLevel(org.getEducationalLevel());
		...
		setRecognizedBy(org.getRecognizedBy());
