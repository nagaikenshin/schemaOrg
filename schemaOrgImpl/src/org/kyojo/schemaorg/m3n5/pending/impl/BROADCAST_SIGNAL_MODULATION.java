...
public class BROADCAST_SIGNAL_MODULATION implements Container.BroadcastSignalModulation {
	...
	public BROADCAST_SIGNAL_MODULATION() {
	}

	public BROADCAST_SIGNAL_MODULATION(QualitativeValue qualitativeValue) {
	...
	public BROADCAST_SIGNAL_MODULATION(String string) {
		this(new TEXT(string));
	}

	public BROADCAST_SIGNAL_MODULATION(Text text) {
	...
	public BROADCAST_SIGNAL_MODULATION(List<QualitativeValue> qualitativeValueList,
			List<Text> textList) {
		setQualitativeValueList(qualitativeValueList);
		setTextList(textList);
	}

	public void copy(Container.BroadcastSignalModulation org) {
