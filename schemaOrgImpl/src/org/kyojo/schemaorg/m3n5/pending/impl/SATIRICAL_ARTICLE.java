...
public class SATIRICAL_ARTICLE implements Clazz.SatiricalArticle {
	...
	public SATIRICAL_ARTICLE() {
	}

	public SATIRICAL_ARTICLE(Long seq) {
		setSeq(seq);
	}

	public SATIRICAL_ARTICLE(String string) {
	...
	public SATIRICAL_ARTICLE(About about) {
		setAbout(about);
	}
	...
	public SATIRICAL_ARTICLE(AccessMode accessMode) {
	...
	public SATIRICAL_ARTICLE(AccessModeSufficient accessModeSufficient) {
	...
	public SATIRICAL_ARTICLE(AccessibilityAPI accessibilityAPI) {
	...
	public SATIRICAL_ARTICLE(AccessibilityControl accessibilityControl) {
	...
	public SATIRICAL_ARTICLE(AccessibilityFeature accessibilityFeature) {
	...
	public SATIRICAL_ARTICLE(AccessibilityHazard accessibilityHazard) {
	...
	public SATIRICAL_ARTICLE(AccessibilitySummary accessibilitySummary) {
	...
	public SATIRICAL_ARTICLE(AccountablePerson accountablePerson) {
	...
	public SATIRICAL_ARTICLE(AdditionalType additionalType) {
	...
	public SATIRICAL_ARTICLE(AggregateRating aggregateRating) {
	...
	public SATIRICAL_ARTICLE(AlternateName alternateName) {
	...
	public SATIRICAL_ARTICLE(AlternativeHeadline alternativeHeadline) {
	...
	public SATIRICAL_ARTICLE(ArticleBody articleBody) {
	...
	public SATIRICAL_ARTICLE(ArticleSection articleSection) {
	...
	public SATIRICAL_ARTICLE(AssociatedMedia associatedMedia) {
	...
	public SATIRICAL_ARTICLE(Audience audience) {
	...
	public SATIRICAL_ARTICLE(Audio audio) {
		setAudio(audio);
	}
	...
	public SATIRICAL_ARTICLE(Author author) {
		setAuthor(author);
	}
	...
	public SATIRICAL_ARTICLE(Award award) {
		setAward(award);
	}
	...
	public SATIRICAL_ARTICLE(Backstory backstory) {
	...
	public SATIRICAL_ARTICLE(Character character) {
	...
	public SATIRICAL_ARTICLE(Citation citation) {
	...
	public SATIRICAL_ARTICLE(Comment comment) {
		setComment(comment);
	}
	...
	public SATIRICAL_ARTICLE(CommentCount commentCount) {
	...
	public SATIRICAL_ARTICLE(ContentLocation contentLocation) {
	...
	public SATIRICAL_ARTICLE(ContentRating contentRating) {
	...
	public SATIRICAL_ARTICLE(ContentReferenceTime contentReferenceTime) {
	...
	public SATIRICAL_ARTICLE(Contributor contributor) {
	...
	public SATIRICAL_ARTICLE(CopyrightHolder copyrightHolder) {
	...
	public SATIRICAL_ARTICLE(CopyrightYear copyrightYear) {
	...
	public SATIRICAL_ARTICLE(Correction correction) {
	...
	public SATIRICAL_ARTICLE(Creator creator) {
		setCreator(creator);
	}
	...
	public SATIRICAL_ARTICLE(DateCreated dateCreated) {
	...
	public SATIRICAL_ARTICLE(DateModified dateModified) {
	...
	public SATIRICAL_ARTICLE(DatePublished datePublished) {
	...
	public SATIRICAL_ARTICLE(Description description) {
	...
	public SATIRICAL_ARTICLE(DisambiguatingDescription disambiguatingDescription) {
	...
	public SATIRICAL_ARTICLE(DiscussionUrl discussionUrl) {
	...
	public SATIRICAL_ARTICLE(Editor editor) {
		setEditor(editor);
	}
	...
	public SATIRICAL_ARTICLE(EducationalAlignment educationalAlignment) {
	...
	public SATIRICAL_ARTICLE(EducationalUse educationalUse) {
	...
	public SATIRICAL_ARTICLE(Encoding encoding) {
	...
	public SATIRICAL_ARTICLE(EncodingFormat encodingFormat) {
	...
	public SATIRICAL_ARTICLE(ExampleOfWork exampleOfWork) {
	...
	public SATIRICAL_ARTICLE(Expires expires) {
		setExpires(expires);
	}
	...
	public SATIRICAL_ARTICLE(Funder funder) {
		setFunder(funder);
	}
	...
	public SATIRICAL_ARTICLE(Genre genre) {
		setGenre(genre);
	}
	...
	public SATIRICAL_ARTICLE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public SATIRICAL_ARTICLE(Headline headline) {
	...
	public SATIRICAL_ARTICLE(Identifier identifier) {
	...
	public SATIRICAL_ARTICLE(Image image) {
		setImage(image);
	}
	...
	public SATIRICAL_ARTICLE(InLanguage inLanguage) {
	...
	public SATIRICAL_ARTICLE(InteractionStatistic interactionStatistic) {
	...
	public SATIRICAL_ARTICLE(InteractivityType interactivityType) {
	...
	public SATIRICAL_ARTICLE(IsAccessibleForFree isAccessibleForFree) {
	...
	public SATIRICAL_ARTICLE(IsBasedOn isBasedOn) {
	...
	public SATIRICAL_ARTICLE(IsFamilyFriendly isFamilyFriendly) {
	...
	public SATIRICAL_ARTICLE(IsPartOf isPartOf) {
	...
	public SATIRICAL_ARTICLE(Keywords keywords) {
	...
	public SATIRICAL_ARTICLE(LearningResourceType learningResourceType) {
	...
	public SATIRICAL_ARTICLE(License license) {
		setLicense(license);
	}
	...
	public SATIRICAL_ARTICLE(LocationCreated locationCreated) {
	...
	public SATIRICAL_ARTICLE(MainEntity mainEntity) {
	...
	public SATIRICAL_ARTICLE(MainEntityOfPage mainEntityOfPage) {
	...
	public SATIRICAL_ARTICLE(Material material) {
	...
	public SATIRICAL_ARTICLE(MaterialExtent materialExtent) {
	...
	public SATIRICAL_ARTICLE(Mentions mentions) {
	...
	public SATIRICAL_ARTICLE(Name name) {
		setName(name);
	}
	...
	public SATIRICAL_ARTICLE(NameFuzzy nameFuzzy) {
	...
	public SATIRICAL_ARTICLE(NameRuby nameRuby) {
	...
	public SATIRICAL_ARTICLE(Offers offers) {
		setOffers(offers);
	}
	...
	public SATIRICAL_ARTICLE(PageEnd pageEnd) {
		setPageEnd(pageEnd);
	}
	...
	public SATIRICAL_ARTICLE(PageStart pageStart) {
	...
	public SATIRICAL_ARTICLE(Pagination pagination) {
	...
	public SATIRICAL_ARTICLE(Position position) {
	...
	public SATIRICAL_ARTICLE(PotentialAction potentialAction) {
	...
	public SATIRICAL_ARTICLE(Producer producer) {
	...
	public SATIRICAL_ARTICLE(Provider provider) {
	...
	public SATIRICAL_ARTICLE(Publication publication) {
	...
	public SATIRICAL_ARTICLE(Publisher publisher) {
	...
	public SATIRICAL_ARTICLE(PublisherImprint publisherImprint) {
	...
	public SATIRICAL_ARTICLE(PublishingPrinciples publishingPrinciples) {
	...
	public SATIRICAL_ARTICLE(RecordedAt recordedAt) {
	...
	public SATIRICAL_ARTICLE(ReleasedEvent releasedEvent) {
	...
	public SATIRICAL_ARTICLE(Review review) {
		setReview(review);
	}
	...
	public SATIRICAL_ARTICLE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SATIRICAL_ARTICLE(SchemaVersion schemaVersion) {
	...
	public SATIRICAL_ARTICLE(SdDatePublished sdDatePublished) {
	...
	public SATIRICAL_ARTICLE(SdLicense sdLicense) {
	...
	public SATIRICAL_ARTICLE(SdPublisher sdPublisher) {
	...
	public SATIRICAL_ARTICLE(SourceOrganization sourceOrganization) {
	...
	public SATIRICAL_ARTICLE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public SATIRICAL_ARTICLE(SpatialCoverage spatialCoverage) {
	...
	public SATIRICAL_ARTICLE(Speakable speakable) {
	...
	public SATIRICAL_ARTICLE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public SATIRICAL_ARTICLE(SubjectOf subjectOf) {
	...
	public SATIRICAL_ARTICLE(Temporal temporal) {
	...
	public SATIRICAL_ARTICLE(TemporalCoverage temporalCoverage) {
	...
	public SATIRICAL_ARTICLE(Text text) {
		setText(text);
	}
	...
	public SATIRICAL_ARTICLE(ThumbnailUrl thumbnailUrl) {
	...
	public SATIRICAL_ARTICLE(TimeRequired timeRequired) {
	...
	public SATIRICAL_ARTICLE(TranslationOfWork translationOfWork) {
	...
	public SATIRICAL_ARTICLE(Translator translator) {
	...
	public SATIRICAL_ARTICLE(TypicalAgeRange typicalAgeRange) {
	...
	public SATIRICAL_ARTICLE(Url url) {
		setUrl(url);
	}
	...
	public SATIRICAL_ARTICLE(Version version) {
		setVersion(version);
	}
	...
	public SATIRICAL_ARTICLE(Video video) {
		setVideo(video);
	}
	...
	public SATIRICAL_ARTICLE(WordCount wordCount) {
	...
	public SATIRICAL_ARTICLE(WorkExample workExample) {
	...
	public SATIRICAL_ARTICLE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.SatiricalArticle org) {
		setSeq(org.getSeq());
