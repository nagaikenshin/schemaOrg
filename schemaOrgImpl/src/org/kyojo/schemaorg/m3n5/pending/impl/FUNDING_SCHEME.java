...
public class FUNDING_SCHEME implements Clazz.FundingScheme {
	...
	public FUNDING_SCHEME() {
	}

	public FUNDING_SCHEME(Long seq) {
		setSeq(seq);
	}

	public FUNDING_SCHEME(String string) {
	...
	public FUNDING_SCHEME(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public FUNDING_SCHEME(AdditionalType additionalType) {
	...
	public FUNDING_SCHEME(Address address) {
		setAddress(address);
	}
	...
	public FUNDING_SCHEME(AggregateRating aggregateRating) {
	...
	public FUNDING_SCHEME(AlternateName alternateName) {
	...
	public FUNDING_SCHEME(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public FUNDING_SCHEME(AreaServed areaServed) {
	...
	public FUNDING_SCHEME(Award award) {
		setAward(award);
	}
	...
	public FUNDING_SCHEME(Brand brand) {
		setBrand(brand);
	}
	...
	public FUNDING_SCHEME(ContactPoint contactPoint) {
	...
	public FUNDING_SCHEME(CorrectionsPolicy correctionsPolicy) {
	...
	public FUNDING_SCHEME(Department department) {
	...
	public FUNDING_SCHEME(Description description) {
	...
	public FUNDING_SCHEME(DisambiguatingDescription disambiguatingDescription) {
	...
	public FUNDING_SCHEME(DissolutionDate dissolutionDate) {
	...
	public FUNDING_SCHEME(DiversityPolicy diversityPolicy) {
	...
	public FUNDING_SCHEME(DiversityStaffingReport diversityStaffingReport) {
	...
	public FUNDING_SCHEME(Duns duns) {
		setDuns(duns);
	}
	...
	public FUNDING_SCHEME(Email email) {
		setEmail(email);
	}
	...
	public FUNDING_SCHEME(Employee employee) {
	...
	public FUNDING_SCHEME(EthicsPolicy ethicsPolicy) {
	...
	public FUNDING_SCHEME(Event event) {
		setEvent(event);
	}
	...
	public FUNDING_SCHEME(FaxNumber faxNumber) {
	...
	public FUNDING_SCHEME(Founder founder) {
		setFounder(founder);
	}
	...
	public FUNDING_SCHEME(FoundingDate foundingDate) {
	...
	public FUNDING_SCHEME(FoundingLocation foundingLocation) {
	...
	public FUNDING_SCHEME(Funder funder) {
		setFunder(funder);
	}
	...
	public FUNDING_SCHEME(GlobalLocationNumber globalLocationNumber) {
	...
	public FUNDING_SCHEME(HasOfferCatalog hasOfferCatalog) {
	...
	public FUNDING_SCHEME(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public FUNDING_SCHEME(Identifier identifier) {
	...
	public FUNDING_SCHEME(Image image) {
		setImage(image);
	}
	...
	public FUNDING_SCHEME(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public FUNDING_SCHEME(KnowsAbout knowsAbout) {
	...
	public FUNDING_SCHEME(KnowsLanguage knowsLanguage) {
	...
	public FUNDING_SCHEME(LegalName legalName) {
	...
	public FUNDING_SCHEME(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public FUNDING_SCHEME(Location location) {
	...
	public FUNDING_SCHEME(Logo logo) {
		setLogo(logo);
	}
	...
	public FUNDING_SCHEME(MainEntityOfPage mainEntityOfPage) {
	...
	public FUNDING_SCHEME(MakesOffer makesOffer) {
	...
	public FUNDING_SCHEME(Member member) {
		setMember(member);
	}
	...
	public FUNDING_SCHEME(MemberOf memberOf) {
	...
	public FUNDING_SCHEME(Naics naics) {
		setNaics(naics);
	}
	...
	public FUNDING_SCHEME(Name name) {
		setName(name);
	}
	...
	public FUNDING_SCHEME(NameFuzzy nameFuzzy) {
	...
	public FUNDING_SCHEME(NameRuby nameRuby) {
	...
	public FUNDING_SCHEME(NumberOfEmployees numberOfEmployees) {
	...
	public FUNDING_SCHEME(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public FUNDING_SCHEME(Owns owns) {
		setOwns(owns);
	}
	...
	public FUNDING_SCHEME(ParentOrganization parentOrganization) {
	...
	public FUNDING_SCHEME(PotentialAction potentialAction) {
	...
	public FUNDING_SCHEME(PublishingPrinciples publishingPrinciples) {
	...
	public FUNDING_SCHEME(Review review) {
		setReview(review);
	}
	...
	public FUNDING_SCHEME(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public FUNDING_SCHEME(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public FUNDING_SCHEME(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public FUNDING_SCHEME(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public FUNDING_SCHEME(SubOrganization subOrganization) {
	...
	public FUNDING_SCHEME(SubjectOf subjectOf) {
	...
	public FUNDING_SCHEME(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public FUNDING_SCHEME(Telephone telephone) {
	...
	public FUNDING_SCHEME(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public FUNDING_SCHEME(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.FundingScheme org) {
		setSeq(org.getSeq());
