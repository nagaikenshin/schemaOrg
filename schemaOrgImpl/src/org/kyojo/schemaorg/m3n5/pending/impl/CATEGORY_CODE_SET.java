...
public class CATEGORY_CODE_SET implements Clazz.CategoryCodeSet {
	...
	public Genre genre;
	public HasCategoryCode hasCategoryCode;
	public HasDefinedTerm hasDefinedTerm;
	...
	public CATEGORY_CODE_SET() {
	}

	public CATEGORY_CODE_SET(Long seq) {
		setSeq(seq);
	}

	public CATEGORY_CODE_SET(String string) {
	...
	public CATEGORY_CODE_SET(About about) {
		setAbout(about);
	}
	...
	public CATEGORY_CODE_SET(AccessMode accessMode) {
	...
	public CATEGORY_CODE_SET(AccessModeSufficient accessModeSufficient) {
	...
	public CATEGORY_CODE_SET(AccessibilityAPI accessibilityAPI) {
	...
	public CATEGORY_CODE_SET(AccessibilityControl accessibilityControl) {
	...
	public CATEGORY_CODE_SET(AccessibilityFeature accessibilityFeature) {
	...
	public CATEGORY_CODE_SET(AccessibilityHazard accessibilityHazard) {
	...
	public CATEGORY_CODE_SET(AccessibilitySummary accessibilitySummary) {
	...
	public CATEGORY_CODE_SET(AccountablePerson accountablePerson) {
	...
	public CATEGORY_CODE_SET(AdditionalType additionalType) {
	...
	public CATEGORY_CODE_SET(AggregateRating aggregateRating) {
	...
	public CATEGORY_CODE_SET(AlternateName alternateName) {
	...
	public CATEGORY_CODE_SET(AlternativeHeadline alternativeHeadline) {
	...
	public CATEGORY_CODE_SET(AssociatedMedia associatedMedia) {
	...
	public CATEGORY_CODE_SET(Audience audience) {
	...
	public CATEGORY_CODE_SET(Audio audio) {
		setAudio(audio);
	}
	...
	public CATEGORY_CODE_SET(Author author) {
		setAuthor(author);
	}
	...
	public CATEGORY_CODE_SET(Award award) {
		setAward(award);
	}
	...
	public CATEGORY_CODE_SET(Character character) {
	...
	public CATEGORY_CODE_SET(Citation citation) {
	...
	public CATEGORY_CODE_SET(Comment comment) {
		setComment(comment);
	}
	...
	public CATEGORY_CODE_SET(CommentCount commentCount) {
	...
	public CATEGORY_CODE_SET(ContentLocation contentLocation) {
	...
	public CATEGORY_CODE_SET(ContentRating contentRating) {
	...
	public CATEGORY_CODE_SET(ContentReferenceTime contentReferenceTime) {
	...
	public CATEGORY_CODE_SET(Contributor contributor) {
	...
	public CATEGORY_CODE_SET(CopyrightHolder copyrightHolder) {
	...
	public CATEGORY_CODE_SET(CopyrightYear copyrightYear) {
	...
	public CATEGORY_CODE_SET(Correction correction) {
	...
	public CATEGORY_CODE_SET(Creator creator) {
		setCreator(creator);
	}
	...
	public CATEGORY_CODE_SET(DateCreated dateCreated) {
	...
	public CATEGORY_CODE_SET(DateModified dateModified) {
	...
	public CATEGORY_CODE_SET(DatePublished datePublished) {
	...
	public CATEGORY_CODE_SET(Description description) {
	...
	public CATEGORY_CODE_SET(DisambiguatingDescription disambiguatingDescription) {
	...
	public CATEGORY_CODE_SET(DiscussionUrl discussionUrl) {
	...
	public CATEGORY_CODE_SET(Editor editor) {
		setEditor(editor);
	}
	...
	public CATEGORY_CODE_SET(EducationalAlignment educationalAlignment) {
	...
	public CATEGORY_CODE_SET(EducationalUse educationalUse) {
	...
	public CATEGORY_CODE_SET(Encoding encoding) {
	...
	public CATEGORY_CODE_SET(EncodingFormat encodingFormat) {
	...
	public CATEGORY_CODE_SET(ExampleOfWork exampleOfWork) {
	...
	public CATEGORY_CODE_SET(Expires expires) {
		setExpires(expires);
	}
	...
	public CATEGORY_CODE_SET(Funder funder) {
		setFunder(funder);
	}
	...
	public CATEGORY_CODE_SET(Genre genre) {
		setGenre(genre);
	}
	...
	public CATEGORY_CODE_SET(HasCategoryCode hasCategoryCode) {
		setHasCategoryCode(hasCategoryCode);
	}

	@Override
	public HasCategoryCode getHasCategoryCode() {
		return hasCategoryCode;
	}

	@Override
	public void setHasCategoryCode(HasCategoryCode hasCategoryCode) {
		this.hasCategoryCode = hasCategoryCode;
	}

	public CATEGORY_CODE_SET(HasDefinedTerm hasDefinedTerm) {
		setHasDefinedTerm(hasDefinedTerm);
	}

	@Override
	public HasDefinedTerm getHasDefinedTerm() {
		return hasDefinedTerm;
	}

	@Override
	public void setHasDefinedTerm(HasDefinedTerm hasDefinedTerm) {
		this.hasDefinedTerm = hasDefinedTerm;
	}

	public CATEGORY_CODE_SET(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public CATEGORY_CODE_SET(Headline headline) {
	...
	public CATEGORY_CODE_SET(Identifier identifier) {
	...
	public CATEGORY_CODE_SET(Image image) {
		setImage(image);
	}
	...
	public CATEGORY_CODE_SET(InLanguage inLanguage) {
	...
	public CATEGORY_CODE_SET(InteractionStatistic interactionStatistic) {
	...
	public CATEGORY_CODE_SET(InteractivityType interactivityType) {
	...
	public CATEGORY_CODE_SET(IsAccessibleForFree isAccessibleForFree) {
	...
	public CATEGORY_CODE_SET(IsBasedOn isBasedOn) {
	...
	public CATEGORY_CODE_SET(IsFamilyFriendly isFamilyFriendly) {
	...
	public CATEGORY_CODE_SET(IsPartOf isPartOf) {
	...
	public CATEGORY_CODE_SET(Keywords keywords) {
	...
	public CATEGORY_CODE_SET(LearningResourceType learningResourceType) {
	...
	public CATEGORY_CODE_SET(License license) {
		setLicense(license);
	}
	...
	public CATEGORY_CODE_SET(LocationCreated locationCreated) {
	...
	public CATEGORY_CODE_SET(MainEntity mainEntity) {
	...
	public CATEGORY_CODE_SET(MainEntityOfPage mainEntityOfPage) {
	...
	public CATEGORY_CODE_SET(Material material) {
	...
	public CATEGORY_CODE_SET(MaterialExtent materialExtent) {
	...
	public CATEGORY_CODE_SET(Mentions mentions) {
	...
	public CATEGORY_CODE_SET(Name name) {
		setName(name);
	}
	...
	public CATEGORY_CODE_SET(NameFuzzy nameFuzzy) {
	...
	public CATEGORY_CODE_SET(NameRuby nameRuby) {
	...
	public CATEGORY_CODE_SET(Offers offers) {
		setOffers(offers);
	}
	...
	public CATEGORY_CODE_SET(Position position) {
	...
	public CATEGORY_CODE_SET(PotentialAction potentialAction) {
	...
	public CATEGORY_CODE_SET(Producer producer) {
	...
	public CATEGORY_CODE_SET(Provider provider) {
	...
	public CATEGORY_CODE_SET(Publication publication) {
	...
	public CATEGORY_CODE_SET(Publisher publisher) {
	...
	public CATEGORY_CODE_SET(PublisherImprint publisherImprint) {
	...
	public CATEGORY_CODE_SET(PublishingPrinciples publishingPrinciples) {
	...
	public CATEGORY_CODE_SET(RecordedAt recordedAt) {
	...
	public CATEGORY_CODE_SET(ReleasedEvent releasedEvent) {
	...
	public CATEGORY_CODE_SET(Review review) {
		setReview(review);
	}
	...
	public CATEGORY_CODE_SET(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CATEGORY_CODE_SET(SchemaVersion schemaVersion) {
	...
	public CATEGORY_CODE_SET(SdDatePublished sdDatePublished) {
	...
	public CATEGORY_CODE_SET(SdLicense sdLicense) {
	...
	public CATEGORY_CODE_SET(SdPublisher sdPublisher) {
	...
	public CATEGORY_CODE_SET(SourceOrganization sourceOrganization) {
	...
	public CATEGORY_CODE_SET(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public CATEGORY_CODE_SET(SpatialCoverage spatialCoverage) {
	...
	public CATEGORY_CODE_SET(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public CATEGORY_CODE_SET(SubjectOf subjectOf) {
	...
	public CATEGORY_CODE_SET(Temporal temporal) {
	...
	public CATEGORY_CODE_SET(TemporalCoverage temporalCoverage) {
	...
	public CATEGORY_CODE_SET(Text text) {
		setText(text);
	}
	...
	public CATEGORY_CODE_SET(ThumbnailUrl thumbnailUrl) {
	...
	public CATEGORY_CODE_SET(TimeRequired timeRequired) {
	...
	public CATEGORY_CODE_SET(TranslationOfWork translationOfWork) {
	...
	public CATEGORY_CODE_SET(Translator translator) {
	...
	public CATEGORY_CODE_SET(TypicalAgeRange typicalAgeRange) {
	...
	public CATEGORY_CODE_SET(Url url) {
		setUrl(url);
	}
	...
	public CATEGORY_CODE_SET(Version version) {
		setVersion(version);
	}
	...
	public CATEGORY_CODE_SET(Video video) {
		setVideo(video);
	}
	...
	public CATEGORY_CODE_SET(WorkExample workExample) {
	...
	public CATEGORY_CODE_SET(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.CategoryCodeSet org) {
		setSeq(org.getSeq());
		...
		setHasCategoryCode(org.getHasCategoryCode());
		setHasDefinedTerm(org.getHasDefinedTerm());
