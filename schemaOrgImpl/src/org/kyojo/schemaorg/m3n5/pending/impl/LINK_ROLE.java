...
public class LINK_ROLE implements Clazz.LinkRole {
	...
	public LINK_ROLE(String string) {
	...
	public LINK_ROLE(AdditionalType additionalType) {
	...
	public LINK_ROLE(AlternateName alternateName) {
	...
	public LINK_ROLE(Description description) {
	...
	public LINK_ROLE(DisambiguatingDescription disambiguatingDescription) {
	...
	public LINK_ROLE(EndDate endDate) {
		setEndDate(endDate);
	}
	...
	public LINK_ROLE(Identifier identifier) {
	...
	public LINK_ROLE(InLanguage inLanguage) {
	...
	public LINK_ROLE(LinkRelationship linkRelationship) {
		setLinkRelationship(linkRelationship);
	}

	@Override
	public LinkRelationship getLinkRelationship() {
		return linkRelationship;
	}

	@Override
	public void setLinkRelationship(LinkRelationship linkRelationship) {
		this.linkRelationship = linkRelationship;
	}

	public LINK_ROLE(MainEntityOfPage mainEntityOfPage) {
	...
	public LINK_ROLE(NameFuzzy nameFuzzy) {
	...
	public LINK_ROLE(NameRuby nameRuby) {
	...
	public LINK_ROLE(PotentialAction potentialAction) {
	...
	public LINK_ROLE(RoleName roleName) {
	...
	public LINK_ROLE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public LINK_ROLE(StartDate startDate) {
	...
	public LINK_ROLE(SubjectOf subjectOf) {
	...
	public void copy(Clazz.LinkRole org) {
		...
		setLinkRelationship(org.getLinkRelationship());
