...
public class IN_CODE_SET implements Container.InCodeSet {
	...
	public IN_CODE_SET(APIReference apiReference) {
	...
	public IN_CODE_SET(AboutPage aboutPage) {
	...
	public IN_CODE_SET(AdvertiserContentArticle advertiserContentArticle) {
	...
	public IN_CODE_SET(AnalysisNewsArticle analysisNewsArticle) {
	...
	public IN_CODE_SET(Answer answer) {
	...
	public IN_CODE_SET(ArchiveComponent archiveComponent) {
	...
	public IN_CODE_SET(Article article) {
	...
	public IN_CODE_SET(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public IN_CODE_SET(Atlas atlas) {
	...
	public IN_CODE_SET(AudioObject audioObject) {
	...
	public IN_CODE_SET(Audiobook audiobook) {
	...
	public IN_CODE_SET(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public IN_CODE_SET(Barcode barcode) {
	...
	public IN_CODE_SET(BlogPosting blogPosting) {
	...
	public IN_CODE_SET(BookSeries bookSeries) {
	...
	public IN_CODE_SET(Chapter chapter) {
	...
	public IN_CODE_SET(CheckoutPage checkoutPage) {
	...
	public IN_CODE_SET(Claim claim) {
	...
	public IN_CODE_SET(ClaimReview claimReview) {
	...
	public IN_CODE_SET(Collection collection) {
	...
	public IN_CODE_SET(CollectionPage collectionPage) {
	...
	public IN_CODE_SET(ComicCoverArt comicCoverArt) {
	...
	public IN_CODE_SET(ComicIssue comicIssue) {
	...
	public IN_CODE_SET(ComicSeries comicSeries) {
	...
	public IN_CODE_SET(ComicStory comicStory) {
	...
	public IN_CODE_SET(Comment comment) {
	...
	public IN_CODE_SET(CompleteDataFeed completeDataFeed) {
	...
	public IN_CODE_SET(ContactPage contactPage) {
	...
	public IN_CODE_SET(Conversation conversation) {
	...
	public IN_CODE_SET(CorrectionComment correctionComment) {
	...
	public IN_CODE_SET(Course course) {
	...
	public IN_CODE_SET(CoverArt coverArt) {
	...
	public IN_CODE_SET(CreativeWorkSeason creativeWorkSeason) {
	...
	public IN_CODE_SET(CreativeWorkSeries creativeWorkSeries) {
	...
	public IN_CODE_SET(CriticReview criticReview) {
	...
	public IN_CODE_SET(DataCatalog dataCatalog) {
	...
	public IN_CODE_SET(DataDownload dataDownload) {
	...
	public IN_CODE_SET(DataFeed dataFeed) {
	...
	public IN_CODE_SET(Dataset dataset) {
	...
	public IN_CODE_SET(DigitalDocument digitalDocument) {
	...
	public IN_CODE_SET(DiscussionForumPosting discussionForumPosting) {
	...
	public IN_CODE_SET(Drawing drawing) {
	...
	public IN_CODE_SET(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public IN_CODE_SET(EmailMessage emailMessage) {
	...
	public IN_CODE_SET(EmployerReview employerReview) {
	...
	public IN_CODE_SET(Episode episode) {
	...
	public IN_CODE_SET(ExercisePlan exercisePlan) {
	...
	public IN_CODE_SET(FAQPage faqPage) {
	...
	public IN_CODE_SET(HowTo howTo) {
	...
	public IN_CODE_SET(HowToDirection howToDirection) {
	...
	public IN_CODE_SET(HowToSection howToSection) {
	...
	public IN_CODE_SET(HowToStep howToStep) {
	...
	public IN_CODE_SET(HowToTip howToTip) {
	...
	public IN_CODE_SET(ImageGallery imageGallery) {
	...
	public IN_CODE_SET(ImageObject imageObject) {
	...
	public IN_CODE_SET(ItemPage itemPage) {
	...
	public IN_CODE_SET(Legislation legislation) {
	...
	public IN_CODE_SET(LegislationObject legislationObject) {
	...
	public IN_CODE_SET(LiveBlogPosting liveBlogPosting) {
	...
	public IN_CODE_SET(Manuscript manuscript) {
	...
	public IN_CODE_SET(MediaObject mediaObject) {
	...
	public IN_CODE_SET(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public IN_CODE_SET(MedicalWebPage medicalWebPage) {
	...
	public IN_CODE_SET(MenuSection menuSection) {
	...
	public IN_CODE_SET(Message message) {
	...
	public IN_CODE_SET(MobileApplication mobileApplication) {
	...
	public IN_CODE_SET(Movie movie) {
	...
	public IN_CODE_SET(MovieClip movieClip) {
	...
	public IN_CODE_SET(MovieSeries movieSeries) {
	...
	public IN_CODE_SET(MusicAlbum musicAlbum) {
	...
	public IN_CODE_SET(MusicComposition musicComposition) {
	...
	public IN_CODE_SET(MusicPlaylist musicPlaylist) {
	...
	public IN_CODE_SET(MusicRecording musicRecording) {
	...
	public IN_CODE_SET(MusicRelease musicRelease) {
	...
	public IN_CODE_SET(MusicVideoObject musicVideoObject) {
	...
	public IN_CODE_SET(NewsArticle newsArticle) {
	...
	public IN_CODE_SET(Newspaper newspaper) {
	...
	public IN_CODE_SET(NoteDigitalDocument noteDigitalDocument) {
	...
	public IN_CODE_SET(OpinionNewsArticle opinionNewsArticle) {
	...
	public IN_CODE_SET(Painting painting) {
	...
	public IN_CODE_SET(Periodical periodical) {
	...
	public IN_CODE_SET(Photograph photograph) {
	...
	public IN_CODE_SET(Poster poster) {
	...
	public IN_CODE_SET(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public IN_CODE_SET(ProfilePage profilePage) {
	...
	public IN_CODE_SET(PublicationIssue publicationIssue) {
	...
	public IN_CODE_SET(PublicationVolume publicationVolume) {
	...
	public IN_CODE_SET(QAPage qaPage) {
	...
	public IN_CODE_SET(Question question) {
	...
	public IN_CODE_SET(Quotation quotation) {
	...
	public IN_CODE_SET(RadioClip radioClip) {
	...
	public IN_CODE_SET(RadioEpisode radioEpisode) {
	...
	public IN_CODE_SET(RadioSeason radioSeason) {
	...
	public IN_CODE_SET(RadioSeries radioSeries) {
	...
	public IN_CODE_SET(Recipe recipe) {
	...
	public IN_CODE_SET(Report report) {
	...
	public IN_CODE_SET(ReportageNewsArticle reportageNewsArticle) {
	...
	public IN_CODE_SET(Review review) {
	...
	public IN_CODE_SET(ReviewNewsArticle reviewNewsArticle) {
	...
	public IN_CODE_SET(SatiricalArticle satiricalArticle) {
	...
	public IN_CODE_SET(ScholarlyArticle scholarlyArticle) {
	...
	public IN_CODE_SET(Sculpture sculpture) {
	...
	public IN_CODE_SET(SearchResultsPage searchResultsPage) {
	...
	public IN_CODE_SET(SheetMusic sheetMusic) {
	...
	public IN_CODE_SET(ShortStory shortStory) {
	...
	public IN_CODE_SET(SiteNavigationElement siteNavigationElement) {
	...
	public IN_CODE_SET(SocialMediaPosting socialMediaPosting) {
	...
	public IN_CODE_SET(SoftwareApplication softwareApplication) {
	...
	public IN_CODE_SET(SoftwareSourceCode softwareSourceCode) {
	...
	public IN_CODE_SET(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public IN_CODE_SET(TVClip tvClip) {
	...
	public IN_CODE_SET(TVEpisode tvEpisode) {
	...
	public IN_CODE_SET(TVSeason tvSeason) {
	...
	public IN_CODE_SET(TVSeries tvSeries) {
	...
	public IN_CODE_SET(Table table) {
	...
	public IN_CODE_SET(TechArticle techArticle) {
	...
	public IN_CODE_SET(TextDigitalDocument textDigitalDocument) {
	...
	public IN_CODE_SET(Thesis thesis) {
	...
	public IN_CODE_SET(ThreeDimensionalModel threeDimensionalModel) {
	...
	public IN_CODE_SET(UserReview userReview) {
	...
	public IN_CODE_SET(VideoGallery videoGallery) {
	...
	public IN_CODE_SET(VideoGame videoGame) {
	...
	public IN_CODE_SET(VideoGameClip videoGameClip) {
	...
	public IN_CODE_SET(VideoGameSeries videoGameSeries) {
	...
	public IN_CODE_SET(VideoObject videoObject) {
	...
	public IN_CODE_SET(VisualArtwork visualArtwork) {
	...
	public IN_CODE_SET(WPAdBlock wpAdBlock) {
	...
	public IN_CODE_SET(WPFooter wpFooter) {
	...
	public IN_CODE_SET(WPHeader wpHeader) {
	...
	public IN_CODE_SET(WPSideBar wpSideBar) {
	...
	public IN_CODE_SET(WebApplication webApplication) {
	...
	public IN_CODE_SET(WebPage webPage) {
	...
	public IN_CODE_SET(WebPageElement webPageElement) {
	...
	public IN_CODE_SET(WebSite webSite) {
