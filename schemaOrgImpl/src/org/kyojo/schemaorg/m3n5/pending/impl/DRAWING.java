...
public class DRAWING implements Clazz.Drawing {
	...
	public DRAWING(AccessMode accessMode) {
	...
	public DRAWING(AccessModeSufficient accessModeSufficient) {
	...
	public DRAWING(AccessibilityAPI accessibilityAPI) {
	...
	public DRAWING(AccessibilityControl accessibilityControl) {
	...
	public DRAWING(AccessibilityFeature accessibilityFeature) {
	...
	public DRAWING(AccessibilityHazard accessibilityHazard) {
	...
	public DRAWING(AccessibilitySummary accessibilitySummary) {
	...
	public DRAWING(AccountablePerson accountablePerson) {
	...
	public DRAWING(AdditionalType additionalType) {
	...
	public DRAWING(AggregateRating aggregateRating) {
	...
	public DRAWING(AlternateName alternateName) {
	...
	public DRAWING(AlternativeHeadline alternativeHeadline) {
	...
	public DRAWING(AssociatedMedia associatedMedia) {
	...
	public DRAWING(Audience audience) {
	...
	public DRAWING(Character character) {
	...
	public DRAWING(Citation citation) {
	...
	public DRAWING(Comment comment) {
		setComment(comment);
	}
	...
	public DRAWING(CommentCount commentCount) {
	...
	public DRAWING(ContentLocation contentLocation) {
	...
	public DRAWING(ContentRating contentRating) {
	...
	public DRAWING(ContentReferenceTime contentReferenceTime) {
	...
	public DRAWING(Contributor contributor) {
	...
	public DRAWING(CopyrightHolder copyrightHolder) {
	...
	public DRAWING(CopyrightYear copyrightYear) {
	...
	public DRAWING(Correction correction) {
	...
	public DRAWING(Creator creator) {
		setCreator(creator);
	}
	...
	public DRAWING(DateCreated dateCreated) {
	...
	public DRAWING(DateModified dateModified) {
	...
	public DRAWING(DatePublished datePublished) {
	...
	public DRAWING(Description description) {
	...
	public DRAWING(DisambiguatingDescription disambiguatingDescription) {
	...
	public DRAWING(DiscussionUrl discussionUrl) {
	...
	public DRAWING(EducationalAlignment educationalAlignment) {
	...
	public DRAWING(EducationalUse educationalUse) {
	...
	public DRAWING(Encoding encoding) {
	...
	public DRAWING(EncodingFormat encodingFormat) {
	...
	public DRAWING(ExampleOfWork exampleOfWork) {
	...
	public DRAWING(Expires expires) {
		setExpires(expires);
	}
	...
	public DRAWING(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public DRAWING(Headline headline) {
	...
	public DRAWING(Identifier identifier) {
	...
	public DRAWING(InLanguage inLanguage) {
	...
	public DRAWING(InteractionStatistic interactionStatistic) {
	...
	public DRAWING(InteractivityType interactivityType) {
	...
	public DRAWING(IsAccessibleForFree isAccessibleForFree) {
	...
	public DRAWING(IsBasedOn isBasedOn) {
	...
	public DRAWING(IsFamilyFriendly isFamilyFriendly) {
	...
	public DRAWING(IsPartOf isPartOf) {
	...
	public DRAWING(Keywords keywords) {
	...
	public DRAWING(LearningResourceType learningResourceType) {
	...
	public DRAWING(License license) {
		setLicense(license);
	}
	...
	public DRAWING(LocationCreated locationCreated) {
	...
	public DRAWING(MainEntity mainEntity) {
	...
	public DRAWING(MainEntityOfPage mainEntityOfPage) {
	...
	public DRAWING(Material material) {
	...
	public DRAWING(MaterialExtent materialExtent) {
	...
	public DRAWING(Mentions mentions) {
	...
	public DRAWING(NameFuzzy nameFuzzy) {
	...
	public DRAWING(NameRuby nameRuby) {
	...
	public DRAWING(Position position) {
	...
	public DRAWING(PotentialAction potentialAction) {
	...
	public DRAWING(Producer producer) {
	...
	public DRAWING(Provider provider) {
	...
	public DRAWING(Publication publication) {
	...
	public DRAWING(Publisher publisher) {
	...
	public DRAWING(PublisherImprint publisherImprint) {
	...
	public DRAWING(PublishingPrinciples publishingPrinciples) {
	...
	public DRAWING(RecordedAt recordedAt) {
	...
	public DRAWING(ReleasedEvent releasedEvent) {
	...
	public DRAWING(SchemaVersion schemaVersion) {
	...
	public DRAWING(SdDatePublished sdDatePublished) {
	...
	public DRAWING(SdLicense sdLicense) {
	...
	public DRAWING(SdPublisher sdPublisher) {
	...
	public DRAWING(SourceOrganization sourceOrganization) {
	...
	public DRAWING(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public DRAWING(SpatialCoverage spatialCoverage) {
	...
	public DRAWING(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public DRAWING(SubjectOf subjectOf) {
	...
	public DRAWING(Temporal temporal) {
	...
	public DRAWING(TemporalCoverage temporalCoverage) {
	...
	public DRAWING(ThumbnailUrl thumbnailUrl) {
	...
	public DRAWING(TimeRequired timeRequired) {
	...
	public DRAWING(TranslationOfWork translationOfWork) {
	...
	public DRAWING(Translator translator) {
	...
	public DRAWING(TypicalAgeRange typicalAgeRange) {
	...
	public DRAWING(Version version) {
		setVersion(version);
	}
	...
	public DRAWING(WorkExample workExample) {
	...
	public DRAWING(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Drawing org) {
		setSeq(org.getSeq());
