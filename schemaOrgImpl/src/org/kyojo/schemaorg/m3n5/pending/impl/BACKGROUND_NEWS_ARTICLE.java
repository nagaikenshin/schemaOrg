...
public class BACKGROUND_NEWS_ARTICLE implements Clazz.BackgroundNewsArticle {
	...
	public BACKGROUND_NEWS_ARTICLE() {
	}

	public BACKGROUND_NEWS_ARTICLE(Long seq) {
		setSeq(seq);
	}

	public BACKGROUND_NEWS_ARTICLE(String string) {
	...
	public BACKGROUND_NEWS_ARTICLE(About about) {
		setAbout(about);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(AccessMode accessMode) {
	...
	public BACKGROUND_NEWS_ARTICLE(AccessModeSufficient accessModeSufficient) {
	...
	public BACKGROUND_NEWS_ARTICLE(AccessibilityAPI accessibilityAPI) {
	...
	public BACKGROUND_NEWS_ARTICLE(AccessibilityControl accessibilityControl) {
	...
	public BACKGROUND_NEWS_ARTICLE(AccessibilityFeature accessibilityFeature) {
	...
	public BACKGROUND_NEWS_ARTICLE(AccessibilityHazard accessibilityHazard) {
	...
	public BACKGROUND_NEWS_ARTICLE(AccessibilitySummary accessibilitySummary) {
	...
	public BACKGROUND_NEWS_ARTICLE(AccountablePerson accountablePerson) {
	...
	public BACKGROUND_NEWS_ARTICLE(AdditionalType additionalType) {
	...
	public BACKGROUND_NEWS_ARTICLE(AggregateRating aggregateRating) {
	...
	public BACKGROUND_NEWS_ARTICLE(AlternateName alternateName) {
	...
	public BACKGROUND_NEWS_ARTICLE(AlternativeHeadline alternativeHeadline) {
	...
	public BACKGROUND_NEWS_ARTICLE(ArticleBody articleBody) {
	...
	public BACKGROUND_NEWS_ARTICLE(ArticleSection articleSection) {
	...
	public BACKGROUND_NEWS_ARTICLE(AssociatedMedia associatedMedia) {
	...
	public BACKGROUND_NEWS_ARTICLE(Audience audience) {
	...
	public BACKGROUND_NEWS_ARTICLE(Audio audio) {
		setAudio(audio);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(Author author) {
		setAuthor(author);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(Award award) {
		setAward(award);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(Backstory backstory) {
	...
	public BACKGROUND_NEWS_ARTICLE(Character character) {
	...
	public BACKGROUND_NEWS_ARTICLE(Citation citation) {
	...
	public BACKGROUND_NEWS_ARTICLE(Comment comment) {
		setComment(comment);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(CommentCount commentCount) {
	...
	public BACKGROUND_NEWS_ARTICLE(ContentLocation contentLocation) {
	...
	public BACKGROUND_NEWS_ARTICLE(ContentRating contentRating) {
	...
	public BACKGROUND_NEWS_ARTICLE(ContentReferenceTime contentReferenceTime) {
	...
	public BACKGROUND_NEWS_ARTICLE(Contributor contributor) {
	...
	public BACKGROUND_NEWS_ARTICLE(CopyrightHolder copyrightHolder) {
	...
	public BACKGROUND_NEWS_ARTICLE(CopyrightYear copyrightYear) {
	...
	public BACKGROUND_NEWS_ARTICLE(Correction correction) {
	...
	public BACKGROUND_NEWS_ARTICLE(Creator creator) {
		setCreator(creator);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(DateCreated dateCreated) {
	...
	public BACKGROUND_NEWS_ARTICLE(DateModified dateModified) {
	...
	public BACKGROUND_NEWS_ARTICLE(DatePublished datePublished) {
	...
	public BACKGROUND_NEWS_ARTICLE(Dateline dateline) {
	...
	public BACKGROUND_NEWS_ARTICLE(Description description) {
	...
	public BACKGROUND_NEWS_ARTICLE(DisambiguatingDescription disambiguatingDescription) {
	...
	public BACKGROUND_NEWS_ARTICLE(DiscussionUrl discussionUrl) {
	...
	public BACKGROUND_NEWS_ARTICLE(Editor editor) {
		setEditor(editor);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(EducationalAlignment educationalAlignment) {
	...
	public BACKGROUND_NEWS_ARTICLE(EducationalUse educationalUse) {
	...
	public BACKGROUND_NEWS_ARTICLE(Encoding encoding) {
	...
	public BACKGROUND_NEWS_ARTICLE(EncodingFormat encodingFormat) {
	...
	public BACKGROUND_NEWS_ARTICLE(ExampleOfWork exampleOfWork) {
	...
	public BACKGROUND_NEWS_ARTICLE(Expires expires) {
		setExpires(expires);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(Funder funder) {
		setFunder(funder);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(Genre genre) {
		setGenre(genre);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(Headline headline) {
	...
	public BACKGROUND_NEWS_ARTICLE(Identifier identifier) {
	...
	public BACKGROUND_NEWS_ARTICLE(Image image) {
		setImage(image);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(InLanguage inLanguage) {
	...
	public BACKGROUND_NEWS_ARTICLE(InteractionStatistic interactionStatistic) {
	...
	public BACKGROUND_NEWS_ARTICLE(InteractivityType interactivityType) {
	...
	public BACKGROUND_NEWS_ARTICLE(IsAccessibleForFree isAccessibleForFree) {
	...
	public BACKGROUND_NEWS_ARTICLE(IsBasedOn isBasedOn) {
	...
	public BACKGROUND_NEWS_ARTICLE(IsFamilyFriendly isFamilyFriendly) {
	...
	public BACKGROUND_NEWS_ARTICLE(IsPartOf isPartOf) {
	...
	public BACKGROUND_NEWS_ARTICLE(Keywords keywords) {
	...
	public BACKGROUND_NEWS_ARTICLE(LearningResourceType learningResourceType) {
	...
	public BACKGROUND_NEWS_ARTICLE(License license) {
		setLicense(license);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(LocationCreated locationCreated) {
	...
	public BACKGROUND_NEWS_ARTICLE(MainEntity mainEntity) {
	...
	public BACKGROUND_NEWS_ARTICLE(MainEntityOfPage mainEntityOfPage) {
	...
	public BACKGROUND_NEWS_ARTICLE(Material material) {
	...
	public BACKGROUND_NEWS_ARTICLE(MaterialExtent materialExtent) {
	...
	public BACKGROUND_NEWS_ARTICLE(Mentions mentions) {
	...
	public BACKGROUND_NEWS_ARTICLE(Name name) {
		setName(name);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(NameFuzzy nameFuzzy) {
	...
	public BACKGROUND_NEWS_ARTICLE(NameRuby nameRuby) {
	...
	public BACKGROUND_NEWS_ARTICLE(Offers offers) {
		setOffers(offers);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(PageEnd pageEnd) {
		setPageEnd(pageEnd);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(PageStart pageStart) {
	...
	public BACKGROUND_NEWS_ARTICLE(Pagination pagination) {
	...
	public BACKGROUND_NEWS_ARTICLE(Position position) {
	...
	public BACKGROUND_NEWS_ARTICLE(PotentialAction potentialAction) {
	...
	public BACKGROUND_NEWS_ARTICLE(PrintColumn printColumn) {
	...
	public BACKGROUND_NEWS_ARTICLE(PrintEdition printEdition) {
	...
	public BACKGROUND_NEWS_ARTICLE(PrintPage printPage) {
	...
	public BACKGROUND_NEWS_ARTICLE(PrintSection printSection) {
	...
	public BACKGROUND_NEWS_ARTICLE(Producer producer) {
	...
	public BACKGROUND_NEWS_ARTICLE(Provider provider) {
	...
	public BACKGROUND_NEWS_ARTICLE(Publication publication) {
	...
	public BACKGROUND_NEWS_ARTICLE(Publisher publisher) {
	...
	public BACKGROUND_NEWS_ARTICLE(PublisherImprint publisherImprint) {
	...
	public BACKGROUND_NEWS_ARTICLE(PublishingPrinciples publishingPrinciples) {
	...
	public BACKGROUND_NEWS_ARTICLE(RecordedAt recordedAt) {
	...
	public BACKGROUND_NEWS_ARTICLE(ReleasedEvent releasedEvent) {
	...
	public BACKGROUND_NEWS_ARTICLE(Review review) {
		setReview(review);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(SchemaVersion schemaVersion) {
	...
	public BACKGROUND_NEWS_ARTICLE(SdDatePublished sdDatePublished) {
	...
	public BACKGROUND_NEWS_ARTICLE(SdLicense sdLicense) {
	...
	public BACKGROUND_NEWS_ARTICLE(SdPublisher sdPublisher) {
	...
	public BACKGROUND_NEWS_ARTICLE(SourceOrganization sourceOrganization) {
	...
	public BACKGROUND_NEWS_ARTICLE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(SpatialCoverage spatialCoverage) {
	...
	public BACKGROUND_NEWS_ARTICLE(Speakable speakable) {
	...
	public BACKGROUND_NEWS_ARTICLE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(SubjectOf subjectOf) {
	...
	public BACKGROUND_NEWS_ARTICLE(Temporal temporal) {
	...
	public BACKGROUND_NEWS_ARTICLE(TemporalCoverage temporalCoverage) {
	...
	public BACKGROUND_NEWS_ARTICLE(Text text) {
		setText(text);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(ThumbnailUrl thumbnailUrl) {
	...
	public BACKGROUND_NEWS_ARTICLE(TimeRequired timeRequired) {
	...
	public BACKGROUND_NEWS_ARTICLE(TranslationOfWork translationOfWork) {
	...
	public BACKGROUND_NEWS_ARTICLE(Translator translator) {
	...
	public BACKGROUND_NEWS_ARTICLE(TypicalAgeRange typicalAgeRange) {
	...
	public BACKGROUND_NEWS_ARTICLE(Url url) {
		setUrl(url);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(Version version) {
		setVersion(version);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(Video video) {
		setVideo(video);
	}
	...
	public BACKGROUND_NEWS_ARTICLE(WordCount wordCount) {
	...
	public BACKGROUND_NEWS_ARTICLE(WorkExample workExample) {
	...
	public BACKGROUND_NEWS_ARTICLE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.BackgroundNewsArticle org) {
		setSeq(org.getSeq());
