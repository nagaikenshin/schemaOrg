...
public class BROADCAST_SUB_CHANNEL implements Container.BroadcastSubChannel {

	private static final long serialVersionUID = 1L;

	public List<Text> textList;

	public BROADCAST_SUB_CHANNEL() {
	}

	public BROADCAST_SUB_CHANNEL(String string) {
		this(new TEXT(string));
	}

	public BROADCAST_SUB_CHANNEL(Text text) {
