...
public class OWNERSHIP_FUNDING_INFO implements Container.OwnershipFundingInfo {
	...
	public OWNERSHIP_FUNDING_INFO(ArchiveComponent archiveComponent) {
	...
	public OWNERSHIP_FUNDING_INFO(Drawing drawing) {
	...
	public OWNERSHIP_FUNDING_INFO(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public OWNERSHIP_FUNDING_INFO(Manuscript manuscript) {
	...
	public OWNERSHIP_FUNDING_INFO(Play play) {
	...
	public OWNERSHIP_FUNDING_INFO(Poster poster) {
	...
	public OWNERSHIP_FUNDING_INFO(SheetMusic sheetMusic) {
	...
	public OWNERSHIP_FUNDING_INFO(ShortStory shortStory) {
	...
	public OWNERSHIP_FUNDING_INFO(ThreeDimensionalModel threeDimensionalModel) {
