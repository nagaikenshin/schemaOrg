...
public class DIVERSITY_POLICY implements Container.DiversityPolicy {
	...
	public DIVERSITY_POLICY(String string) {
	...
	public DIVERSITY_POLICY(APIReference apiReference) {
	...
	public DIVERSITY_POLICY(AboutPage aboutPage) {
	...
	public DIVERSITY_POLICY(AdvertiserContentArticle advertiserContentArticle) {
	...
	public DIVERSITY_POLICY(AnalysisNewsArticle analysisNewsArticle) {
	...
	public DIVERSITY_POLICY(Answer answer) {
	...
	public DIVERSITY_POLICY(ArchiveComponent archiveComponent) {
	...
	public DIVERSITY_POLICY(Article article) {
	...
	public DIVERSITY_POLICY(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public DIVERSITY_POLICY(Atlas atlas) {
	...
	public DIVERSITY_POLICY(AudioObject audioObject) {
	...
	public DIVERSITY_POLICY(Audiobook audiobook) {
	...
	public DIVERSITY_POLICY(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public DIVERSITY_POLICY(Barcode barcode) {
	...
	public DIVERSITY_POLICY(Blog blog) {
	...
	public DIVERSITY_POLICY(BlogPosting blogPosting) {
	...
	public DIVERSITY_POLICY(Book book) {
	...
	public DIVERSITY_POLICY(BookSeries bookSeries) {
	...
	public DIVERSITY_POLICY(CategoryCodeSet categoryCodeSet) {
	...
	public DIVERSITY_POLICY(Chapter chapter) {
	...
	public DIVERSITY_POLICY(CheckoutPage checkoutPage) {
	...
	public DIVERSITY_POLICY(Claim claim) {
	...
	public DIVERSITY_POLICY(ClaimReview claimReview) {
	...
	public DIVERSITY_POLICY(Clip clip) {
	...
	public DIVERSITY_POLICY(Collection collection) {
	...
	public DIVERSITY_POLICY(CollectionPage collectionPage) {
	...
	public DIVERSITY_POLICY(ComicCoverArt comicCoverArt) {
	...
	public DIVERSITY_POLICY(ComicIssue comicIssue) {
	...
	public DIVERSITY_POLICY(ComicSeries comicSeries) {
	...
	public DIVERSITY_POLICY(ComicStory comicStory) {
	...
	public DIVERSITY_POLICY(Comment comment) {
	...
	public DIVERSITY_POLICY(CompleteDataFeed completeDataFeed) {
	...
	public DIVERSITY_POLICY(ContactPage contactPage) {
	...
	public DIVERSITY_POLICY(Conversation conversation) {
	...
	public DIVERSITY_POLICY(CorrectionComment correctionComment) {
	...
	public DIVERSITY_POLICY(Course course) {
	...
	public DIVERSITY_POLICY(CoverArt coverArt) {
	...
	public DIVERSITY_POLICY(CreativeWork creativeWork) {
	...
	public DIVERSITY_POLICY(CreativeWorkSeason creativeWorkSeason) {
	...
	public DIVERSITY_POLICY(CreativeWorkSeries creativeWorkSeries) {
	...
	public DIVERSITY_POLICY(CriticReview criticReview) {
	...
	public DIVERSITY_POLICY(DataCatalog dataCatalog) {
	...
	public DIVERSITY_POLICY(DataDownload dataDownload) {
	...
	public DIVERSITY_POLICY(DataFeed dataFeed) {
	...
	public DIVERSITY_POLICY(Dataset dataset) {
	...
	public DIVERSITY_POLICY(DefinedTermSet definedTermSet) {
	...
	public DIVERSITY_POLICY(Diet diet) {
	...
	public DIVERSITY_POLICY(DigitalDocument digitalDocument) {
	...
	public DIVERSITY_POLICY(DiscussionForumPosting discussionForumPosting) {
	...
	public DIVERSITY_POLICY(Drawing drawing) {
	...
	public DIVERSITY_POLICY(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public DIVERSITY_POLICY(EmailMessage emailMessage) {
	...
	public DIVERSITY_POLICY(EmployerReview employerReview) {
	...
	public DIVERSITY_POLICY(Episode episode) {
	...
	public DIVERSITY_POLICY(ExercisePlan exercisePlan) {
	...
	public DIVERSITY_POLICY(FAQPage faqPage) {
	...
	public DIVERSITY_POLICY(Game game) {
	...
	public DIVERSITY_POLICY(HowTo howTo) {
	...
	public DIVERSITY_POLICY(HowToDirection howToDirection) {
	...
	public DIVERSITY_POLICY(HowToSection howToSection) {
	...
	public DIVERSITY_POLICY(HowToStep howToStep) {
	...
	public DIVERSITY_POLICY(HowToTip howToTip) {
	...
	public DIVERSITY_POLICY(ImageGallery imageGallery) {
	...
	public DIVERSITY_POLICY(ImageObject imageObject) {
	...
	public DIVERSITY_POLICY(ItemPage itemPage) {
	...
	public DIVERSITY_POLICY(Legislation legislation) {
	...
	public DIVERSITY_POLICY(LegislationObject legislationObject) {
	...
	public DIVERSITY_POLICY(LiveBlogPosting liveBlogPosting) {
	...
	public DIVERSITY_POLICY(Manuscript manuscript) {
	...
	public DIVERSITY_POLICY(Map map) {
	...
	public DIVERSITY_POLICY(MediaObject mediaObject) {
	...
	public DIVERSITY_POLICY(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public DIVERSITY_POLICY(MedicalWebPage medicalWebPage) {
	...
	public DIVERSITY_POLICY(Menu menu) {
	...
	public DIVERSITY_POLICY(MenuSection menuSection) {
	...
	public DIVERSITY_POLICY(Message message) {
	...
	public DIVERSITY_POLICY(MobileApplication mobileApplication) {
	...
	public DIVERSITY_POLICY(Movie movie) {
	...
	public DIVERSITY_POLICY(MovieClip movieClip) {
	...
	public DIVERSITY_POLICY(MovieSeries movieSeries) {
	...
	public DIVERSITY_POLICY(MusicAlbum musicAlbum) {
	...
	public DIVERSITY_POLICY(MusicComposition musicComposition) {
	...
	public DIVERSITY_POLICY(MusicPlaylist musicPlaylist) {
	...
	public DIVERSITY_POLICY(MusicRecording musicRecording) {
	...
	public DIVERSITY_POLICY(MusicRelease musicRelease) {
	...
	public DIVERSITY_POLICY(MusicVideoObject musicVideoObject) {
	...
	public DIVERSITY_POLICY(NewsArticle newsArticle) {
	...
	public DIVERSITY_POLICY(Newspaper newspaper) {
	...
	public DIVERSITY_POLICY(NoteDigitalDocument noteDigitalDocument) {
	...
	public DIVERSITY_POLICY(OpinionNewsArticle opinionNewsArticle) {
	...
	public DIVERSITY_POLICY(Painting painting) {
	...
	public DIVERSITY_POLICY(Periodical periodical) {
	...
	public DIVERSITY_POLICY(Photograph photograph) {
	...
	public DIVERSITY_POLICY(Play play) {
	...
	public DIVERSITY_POLICY(Poster poster) {
	...
	public DIVERSITY_POLICY(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public DIVERSITY_POLICY(ProfilePage profilePage) {
	...
	public DIVERSITY_POLICY(PublicationIssue publicationIssue) {
	...
	public DIVERSITY_POLICY(PublicationVolume publicationVolume) {
	...
	public DIVERSITY_POLICY(QAPage qaPage) {
	...
	public DIVERSITY_POLICY(Question question) {
	...
	public DIVERSITY_POLICY(Quotation quotation) {
	...
	public DIVERSITY_POLICY(RadioClip radioClip) {
	...
	public DIVERSITY_POLICY(RadioEpisode radioEpisode) {
	...
	public DIVERSITY_POLICY(RadioSeason radioSeason) {
	...
	public DIVERSITY_POLICY(RadioSeries radioSeries) {
	...
	public DIVERSITY_POLICY(Recipe recipe) {
	...
	public DIVERSITY_POLICY(Report report) {
	...
	public DIVERSITY_POLICY(ReportageNewsArticle reportageNewsArticle) {
	...
	public DIVERSITY_POLICY(Review review) {
	...
	public DIVERSITY_POLICY(ReviewNewsArticle reviewNewsArticle) {
	...
	public DIVERSITY_POLICY(SatiricalArticle satiricalArticle) {
	...
	public DIVERSITY_POLICY(ScholarlyArticle scholarlyArticle) {
	...
	public DIVERSITY_POLICY(Sculpture sculpture) {
	...
	public DIVERSITY_POLICY(SearchResultsPage searchResultsPage) {
	...
	public DIVERSITY_POLICY(SheetMusic sheetMusic) {
	...
	public DIVERSITY_POLICY(ShortStory shortStory) {
	...
	public DIVERSITY_POLICY(SiteNavigationElement siteNavigationElement) {
	...
	public DIVERSITY_POLICY(SocialMediaPosting socialMediaPosting) {
	...
	public DIVERSITY_POLICY(SoftwareApplication softwareApplication) {
	...
	public DIVERSITY_POLICY(SoftwareSourceCode softwareSourceCode) {
	...
	public DIVERSITY_POLICY(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public DIVERSITY_POLICY(TVClip tvClip) {
	...
	public DIVERSITY_POLICY(TVEpisode tvEpisode) {
	...
	public DIVERSITY_POLICY(TVSeason tvSeason) {
	...
	public DIVERSITY_POLICY(TVSeries tvSeries) {
	...
	public DIVERSITY_POLICY(Table table) {
	...
	public DIVERSITY_POLICY(TechArticle techArticle) {
	...
	public DIVERSITY_POLICY(TextDigitalDocument textDigitalDocument) {
	...
	public DIVERSITY_POLICY(Thesis thesis) {
	...
	public DIVERSITY_POLICY(ThreeDimensionalModel threeDimensionalModel) {
	...
	public DIVERSITY_POLICY(URL url) {
		urlList = new ArrayList<URL>();
		urlList.add(url);
	}
	...
	public DIVERSITY_POLICY(UserReview userReview) {
	...
	public DIVERSITY_POLICY(VideoGallery videoGallery) {
	...
	public DIVERSITY_POLICY(VideoGame videoGame) {
	...
	public DIVERSITY_POLICY(VideoGameClip videoGameClip) {
	...
	public DIVERSITY_POLICY(VideoGameSeries videoGameSeries) {
	...
	public DIVERSITY_POLICY(VideoObject videoObject) {
	...
	public DIVERSITY_POLICY(VisualArtwork visualArtwork) {
	...
	public DIVERSITY_POLICY(WPAdBlock wpAdBlock) {
	...
	public DIVERSITY_POLICY(WPFooter wpFooter) {
	...
	public DIVERSITY_POLICY(WPHeader wpHeader) {
	...
	public DIVERSITY_POLICY(WPSideBar wpSideBar) {
	...
	public DIVERSITY_POLICY(WebApplication webApplication) {
	...
	public DIVERSITY_POLICY(WebPage webPage) {
	...
	public DIVERSITY_POLICY(WebPageElement webPageElement) {
	...
	public DIVERSITY_POLICY(WebSite webSite) {
	...
	public void copy(Container.DiversityPolicy org) {
