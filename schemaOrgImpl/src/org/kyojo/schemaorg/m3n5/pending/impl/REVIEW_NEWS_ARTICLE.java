...
public class REVIEW_NEWS_ARTICLE implements Clazz.ReviewNewsArticle {
	...
	public REVIEW_NEWS_ARTICLE() {
	}

	public REVIEW_NEWS_ARTICLE(Long seq) {
		setSeq(seq);
	}

	public REVIEW_NEWS_ARTICLE(String string) {
	...
	public REVIEW_NEWS_ARTICLE(About about) {
		setAbout(about);
	}
	...
	public REVIEW_NEWS_ARTICLE(AccessMode accessMode) {
	...
	public REVIEW_NEWS_ARTICLE(AccessModeSufficient accessModeSufficient) {
	...
	public REVIEW_NEWS_ARTICLE(AccessibilityAPI accessibilityAPI) {
	...
	public REVIEW_NEWS_ARTICLE(AccessibilityControl accessibilityControl) {
	...
	public REVIEW_NEWS_ARTICLE(AccessibilityFeature accessibilityFeature) {
	...
	public REVIEW_NEWS_ARTICLE(AccessibilityHazard accessibilityHazard) {
	...
	public REVIEW_NEWS_ARTICLE(AccessibilitySummary accessibilitySummary) {
	...
	public REVIEW_NEWS_ARTICLE(AccountablePerson accountablePerson) {
	...
	public REVIEW_NEWS_ARTICLE(AdditionalType additionalType) {
	...
	public REVIEW_NEWS_ARTICLE(AggregateRating aggregateRating) {
	...
	public REVIEW_NEWS_ARTICLE(AlternateName alternateName) {
	...
	public REVIEW_NEWS_ARTICLE(AlternativeHeadline alternativeHeadline) {
	...
	public REVIEW_NEWS_ARTICLE(ArticleBody articleBody) {
	...
	public REVIEW_NEWS_ARTICLE(ArticleSection articleSection) {
	...
	public REVIEW_NEWS_ARTICLE(AssociatedMedia associatedMedia) {
	...
	public REVIEW_NEWS_ARTICLE(Audience audience) {
	...
	public REVIEW_NEWS_ARTICLE(Audio audio) {
		setAudio(audio);
	}
	...
	public REVIEW_NEWS_ARTICLE(Author author) {
		setAuthor(author);
	}
	...
	public REVIEW_NEWS_ARTICLE(Award award) {
		setAward(award);
	}
	...
	public REVIEW_NEWS_ARTICLE(Backstory backstory) {
	...
	public REVIEW_NEWS_ARTICLE(Character character) {
	...
	public REVIEW_NEWS_ARTICLE(Citation citation) {
	...
	public REVIEW_NEWS_ARTICLE(Comment comment) {
		setComment(comment);
	}
	...
	public REVIEW_NEWS_ARTICLE(CommentCount commentCount) {
	...
	public REVIEW_NEWS_ARTICLE(ContentLocation contentLocation) {
	...
	public REVIEW_NEWS_ARTICLE(ContentRating contentRating) {
	...
	public REVIEW_NEWS_ARTICLE(ContentReferenceTime contentReferenceTime) {
	...
	public REVIEW_NEWS_ARTICLE(Contributor contributor) {
	...
	public REVIEW_NEWS_ARTICLE(CopyrightHolder copyrightHolder) {
	...
	public REVIEW_NEWS_ARTICLE(CopyrightYear copyrightYear) {
	...
	public REVIEW_NEWS_ARTICLE(Correction correction) {
	...
	public REVIEW_NEWS_ARTICLE(Creator creator) {
		setCreator(creator);
	}
	...
	public REVIEW_NEWS_ARTICLE(DateCreated dateCreated) {
	...
	public REVIEW_NEWS_ARTICLE(DateModified dateModified) {
	...
	public REVIEW_NEWS_ARTICLE(DatePublished datePublished) {
	...
	public REVIEW_NEWS_ARTICLE(Dateline dateline) {
	...
	public REVIEW_NEWS_ARTICLE(Description description) {
	...
	public REVIEW_NEWS_ARTICLE(DisambiguatingDescription disambiguatingDescription) {
	...
	public REVIEW_NEWS_ARTICLE(DiscussionUrl discussionUrl) {
	...
	public REVIEW_NEWS_ARTICLE(Editor editor) {
		setEditor(editor);
	}
	...
	public REVIEW_NEWS_ARTICLE(EducationalAlignment educationalAlignment) {
	...
	public REVIEW_NEWS_ARTICLE(EducationalUse educationalUse) {
	...
	public REVIEW_NEWS_ARTICLE(Encoding encoding) {
	...
	public REVIEW_NEWS_ARTICLE(EncodingFormat encodingFormat) {
	...
	public REVIEW_NEWS_ARTICLE(ExampleOfWork exampleOfWork) {
	...
	public REVIEW_NEWS_ARTICLE(Expires expires) {
		setExpires(expires);
	}
	...
	public REVIEW_NEWS_ARTICLE(Funder funder) {
		setFunder(funder);
	}
	...
	public REVIEW_NEWS_ARTICLE(Genre genre) {
		setGenre(genre);
	}
	...
	public REVIEW_NEWS_ARTICLE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public REVIEW_NEWS_ARTICLE(Headline headline) {
	...
	public REVIEW_NEWS_ARTICLE(Identifier identifier) {
	...
	public REVIEW_NEWS_ARTICLE(Image image) {
		setImage(image);
	}
	...
	public REVIEW_NEWS_ARTICLE(InLanguage inLanguage) {
	...
	public REVIEW_NEWS_ARTICLE(InteractionStatistic interactionStatistic) {
	...
	public REVIEW_NEWS_ARTICLE(InteractivityType interactivityType) {
	...
	public REVIEW_NEWS_ARTICLE(IsAccessibleForFree isAccessibleForFree) {
	...
	public REVIEW_NEWS_ARTICLE(IsBasedOn isBasedOn) {
	...
	public REVIEW_NEWS_ARTICLE(IsFamilyFriendly isFamilyFriendly) {
	...
	public REVIEW_NEWS_ARTICLE(IsPartOf isPartOf) {
	...
	public REVIEW_NEWS_ARTICLE(ItemReviewed itemReviewed) {
	...
	public REVIEW_NEWS_ARTICLE(Keywords keywords) {
	...
	public REVIEW_NEWS_ARTICLE(LearningResourceType learningResourceType) {
	...
	public REVIEW_NEWS_ARTICLE(License license) {
		setLicense(license);
	}
	...
	public REVIEW_NEWS_ARTICLE(LocationCreated locationCreated) {
	...
	public REVIEW_NEWS_ARTICLE(MainEntity mainEntity) {
	...
	public REVIEW_NEWS_ARTICLE(MainEntityOfPage mainEntityOfPage) {
	...
	public REVIEW_NEWS_ARTICLE(Material material) {
	...
	public REVIEW_NEWS_ARTICLE(MaterialExtent materialExtent) {
	...
	public REVIEW_NEWS_ARTICLE(Mentions mentions) {
	...
	public REVIEW_NEWS_ARTICLE(Name name) {
		setName(name);
	}
	...
	public REVIEW_NEWS_ARTICLE(NameFuzzy nameFuzzy) {
	...
	public REVIEW_NEWS_ARTICLE(NameRuby nameRuby) {
	...
	public REVIEW_NEWS_ARTICLE(Offers offers) {
		setOffers(offers);
	}
	...
	public REVIEW_NEWS_ARTICLE(PageEnd pageEnd) {
		setPageEnd(pageEnd);
	}
	...
	public REVIEW_NEWS_ARTICLE(PageStart pageStart) {
	...
	public REVIEW_NEWS_ARTICLE(Pagination pagination) {
	...
	public REVIEW_NEWS_ARTICLE(Position position) {
	...
	public REVIEW_NEWS_ARTICLE(PotentialAction potentialAction) {
	...
	public REVIEW_NEWS_ARTICLE(PrintColumn printColumn) {
	...
	public REVIEW_NEWS_ARTICLE(PrintEdition printEdition) {
	...
	public REVIEW_NEWS_ARTICLE(PrintPage printPage) {
	...
	public REVIEW_NEWS_ARTICLE(PrintSection printSection) {
	...
	public REVIEW_NEWS_ARTICLE(Producer producer) {
	...
	public REVIEW_NEWS_ARTICLE(Provider provider) {
	...
	public REVIEW_NEWS_ARTICLE(Publication publication) {
	...
	public REVIEW_NEWS_ARTICLE(Publisher publisher) {
	...
	public REVIEW_NEWS_ARTICLE(PublisherImprint publisherImprint) {
	...
	public REVIEW_NEWS_ARTICLE(PublishingPrinciples publishingPrinciples) {
	...
	public REVIEW_NEWS_ARTICLE(RecordedAt recordedAt) {
	...
	public REVIEW_NEWS_ARTICLE(ReleasedEvent releasedEvent) {
	...
	public REVIEW_NEWS_ARTICLE(Review review) {
		setReview(review);
	}
	...
	public REVIEW_NEWS_ARTICLE(ReviewAspect reviewAspect) {
	...
	public REVIEW_NEWS_ARTICLE(ReviewBody reviewBody) {
	...
	public REVIEW_NEWS_ARTICLE(ReviewRating reviewRating) {
	...
	public REVIEW_NEWS_ARTICLE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public REVIEW_NEWS_ARTICLE(SchemaVersion schemaVersion) {
	...
	public REVIEW_NEWS_ARTICLE(SdDatePublished sdDatePublished) {
	...
	public REVIEW_NEWS_ARTICLE(SdLicense sdLicense) {
	...
	public REVIEW_NEWS_ARTICLE(SdPublisher sdPublisher) {
	...
	public REVIEW_NEWS_ARTICLE(SourceOrganization sourceOrganization) {
	...
	public REVIEW_NEWS_ARTICLE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public REVIEW_NEWS_ARTICLE(SpatialCoverage spatialCoverage) {
	...
	public REVIEW_NEWS_ARTICLE(Speakable speakable) {
	...
	public REVIEW_NEWS_ARTICLE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public REVIEW_NEWS_ARTICLE(SubjectOf subjectOf) {
	...
	public REVIEW_NEWS_ARTICLE(Temporal temporal) {
	...
	public REVIEW_NEWS_ARTICLE(TemporalCoverage temporalCoverage) {
	...
	public REVIEW_NEWS_ARTICLE(Text text) {
		setText(text);
	}
	...
	public REVIEW_NEWS_ARTICLE(ThumbnailUrl thumbnailUrl) {
	...
	public REVIEW_NEWS_ARTICLE(TimeRequired timeRequired) {
	...
	public REVIEW_NEWS_ARTICLE(TranslationOfWork translationOfWork) {
	...
	public REVIEW_NEWS_ARTICLE(Translator translator) {
	...
	public REVIEW_NEWS_ARTICLE(TypicalAgeRange typicalAgeRange) {
	...
	public REVIEW_NEWS_ARTICLE(Url url) {
		setUrl(url);
	}
	...
	public REVIEW_NEWS_ARTICLE(Version version) {
		setVersion(version);
	}
	...
	public REVIEW_NEWS_ARTICLE(Video video) {
		setVideo(video);
	}
	...
	public REVIEW_NEWS_ARTICLE(WordCount wordCount) {
	...
	public REVIEW_NEWS_ARTICLE(WorkExample workExample) {
	...
	public REVIEW_NEWS_ARTICLE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.ReviewNewsArticle org) {
		setSeq(org.getSeq());
