...
public class RESEARCH_PROJECT implements Clazz.ResearchProject {
	...
	public RESEARCH_PROJECT(Long seq) {
		setSeq(seq);
	}

	public RESEARCH_PROJECT(String string) {
	...
	public RESEARCH_PROJECT(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public RESEARCH_PROJECT(AdditionalType additionalType) {
	...
	public RESEARCH_PROJECT(Address address) {
		setAddress(address);
	}
	...
	public RESEARCH_PROJECT(AggregateRating aggregateRating) {
	...
	public RESEARCH_PROJECT(AlternateName alternateName) {
	...
	public RESEARCH_PROJECT(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public RESEARCH_PROJECT(AreaServed areaServed) {
	...
	public RESEARCH_PROJECT(Award award) {
		setAward(award);
	}
	...
	public RESEARCH_PROJECT(Brand brand) {
		setBrand(brand);
	}
	...
	public RESEARCH_PROJECT(ContactPoint contactPoint) {
	...
	public RESEARCH_PROJECT(CorrectionsPolicy correctionsPolicy) {
	...
	public RESEARCH_PROJECT(Department department) {
	...
	public RESEARCH_PROJECT(Description description) {
	...
	public RESEARCH_PROJECT(DisambiguatingDescription disambiguatingDescription) {
	...
	public RESEARCH_PROJECT(DissolutionDate dissolutionDate) {
	...
	public RESEARCH_PROJECT(DiversityPolicy diversityPolicy) {
	...
	public RESEARCH_PROJECT(DiversityStaffingReport diversityStaffingReport) {
	...
	public RESEARCH_PROJECT(Duns duns) {
		setDuns(duns);
	}
	...
	public RESEARCH_PROJECT(Email email) {
		setEmail(email);
	}
	...
	public RESEARCH_PROJECT(Employee employee) {
	...
	public RESEARCH_PROJECT(EthicsPolicy ethicsPolicy) {
	...
	public RESEARCH_PROJECT(Event event) {
		setEvent(event);
	}
	...
	public RESEARCH_PROJECT(FaxNumber faxNumber) {
	...
	public RESEARCH_PROJECT(Founder founder) {
		setFounder(founder);
	}
	...
	public RESEARCH_PROJECT(FoundingDate foundingDate) {
	...
	public RESEARCH_PROJECT(FoundingLocation foundingLocation) {
	...
	public RESEARCH_PROJECT(Funder funder) {
		setFunder(funder);
	}
	...
	public RESEARCH_PROJECT(GlobalLocationNumber globalLocationNumber) {
	...
	public RESEARCH_PROJECT(HasOfferCatalog hasOfferCatalog) {
	...
	public RESEARCH_PROJECT(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public RESEARCH_PROJECT(Identifier identifier) {
	...
	public RESEARCH_PROJECT(Image image) {
		setImage(image);
	}
	...
	public RESEARCH_PROJECT(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public RESEARCH_PROJECT(KnowsAbout knowsAbout) {
	...
	public RESEARCH_PROJECT(KnowsLanguage knowsLanguage) {
	...
	public RESEARCH_PROJECT(LegalName legalName) {
	...
	public RESEARCH_PROJECT(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public RESEARCH_PROJECT(Location location) {
	...
	public RESEARCH_PROJECT(Logo logo) {
		setLogo(logo);
	}
	...
	public RESEARCH_PROJECT(MainEntityOfPage mainEntityOfPage) {
	...
	public RESEARCH_PROJECT(MakesOffer makesOffer) {
	...
	public RESEARCH_PROJECT(Member member) {
		setMember(member);
	}
	...
	public RESEARCH_PROJECT(MemberOf memberOf) {
	...
	public RESEARCH_PROJECT(Naics naics) {
		setNaics(naics);
	}
	...
	public RESEARCH_PROJECT(Name name) {
		setName(name);
	}
	...
	public RESEARCH_PROJECT(NameFuzzy nameFuzzy) {
	...
	public RESEARCH_PROJECT(NameRuby nameRuby) {
	...
	public RESEARCH_PROJECT(NumberOfEmployees numberOfEmployees) {
	...
	public RESEARCH_PROJECT(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public RESEARCH_PROJECT(Owns owns) {
		setOwns(owns);
	}
	...
	public RESEARCH_PROJECT(ParentOrganization parentOrganization) {
	...
	public RESEARCH_PROJECT(PotentialAction potentialAction) {
	...
	public RESEARCH_PROJECT(PublishingPrinciples publishingPrinciples) {
	...
	public RESEARCH_PROJECT(Review review) {
		setReview(review);
	}
	...
	public RESEARCH_PROJECT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RESEARCH_PROJECT(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public RESEARCH_PROJECT(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public RESEARCH_PROJECT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public RESEARCH_PROJECT(SubOrganization subOrganization) {
	...
	public RESEARCH_PROJECT(SubjectOf subjectOf) {
	...
	public RESEARCH_PROJECT(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public RESEARCH_PROJECT(Telephone telephone) {
	...
	public RESEARCH_PROJECT(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public RESEARCH_PROJECT(Url url) {
		setUrl(url);
	}
	...
	public RESEARCH_PROJECT(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.ResearchProject org) {
		setSeq(org.getSeq());
