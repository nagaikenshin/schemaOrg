...
public class ANALYSIS_NEWS_ARTICLE implements Clazz.AnalysisNewsArticle {
	...
	public ANALYSIS_NEWS_ARTICLE() {
	}

	public ANALYSIS_NEWS_ARTICLE(Long seq) {
		setSeq(seq);
	}

	public ANALYSIS_NEWS_ARTICLE(String string) {
	...
	public ANALYSIS_NEWS_ARTICLE(About about) {
		setAbout(about);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(AccessMode accessMode) {
	...
	public ANALYSIS_NEWS_ARTICLE(AccessModeSufficient accessModeSufficient) {
	...
	public ANALYSIS_NEWS_ARTICLE(AccessibilityAPI accessibilityAPI) {
	...
	public ANALYSIS_NEWS_ARTICLE(AccessibilityControl accessibilityControl) {
	...
	public ANALYSIS_NEWS_ARTICLE(AccessibilityFeature accessibilityFeature) {
	...
	public ANALYSIS_NEWS_ARTICLE(AccessibilityHazard accessibilityHazard) {
	...
	public ANALYSIS_NEWS_ARTICLE(AccessibilitySummary accessibilitySummary) {
	...
	public ANALYSIS_NEWS_ARTICLE(AccountablePerson accountablePerson) {
	...
	public ANALYSIS_NEWS_ARTICLE(AdditionalType additionalType) {
	...
	public ANALYSIS_NEWS_ARTICLE(AggregateRating aggregateRating) {
	...
	public ANALYSIS_NEWS_ARTICLE(AlternateName alternateName) {
	...
	public ANALYSIS_NEWS_ARTICLE(AlternativeHeadline alternativeHeadline) {
	...
	public ANALYSIS_NEWS_ARTICLE(ArticleBody articleBody) {
	...
	public ANALYSIS_NEWS_ARTICLE(ArticleSection articleSection) {
	...
	public ANALYSIS_NEWS_ARTICLE(AssociatedMedia associatedMedia) {
	...
	public ANALYSIS_NEWS_ARTICLE(Audience audience) {
	...
	public ANALYSIS_NEWS_ARTICLE(Audio audio) {
		setAudio(audio);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(Author author) {
		setAuthor(author);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(Award award) {
		setAward(award);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(Backstory backstory) {
	...
	public ANALYSIS_NEWS_ARTICLE(Character character) {
	...
	public ANALYSIS_NEWS_ARTICLE(Citation citation) {
	...
	public ANALYSIS_NEWS_ARTICLE(Comment comment) {
		setComment(comment);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(CommentCount commentCount) {
	...
	public ANALYSIS_NEWS_ARTICLE(ContentLocation contentLocation) {
	...
	public ANALYSIS_NEWS_ARTICLE(ContentRating contentRating) {
	...
	public ANALYSIS_NEWS_ARTICLE(ContentReferenceTime contentReferenceTime) {
	...
	public ANALYSIS_NEWS_ARTICLE(Contributor contributor) {
	...
	public ANALYSIS_NEWS_ARTICLE(CopyrightHolder copyrightHolder) {
	...
	public ANALYSIS_NEWS_ARTICLE(CopyrightYear copyrightYear) {
	...
	public ANALYSIS_NEWS_ARTICLE(Correction correction) {
	...
	public ANALYSIS_NEWS_ARTICLE(Creator creator) {
		setCreator(creator);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(DateCreated dateCreated) {
	...
	public ANALYSIS_NEWS_ARTICLE(DateModified dateModified) {
	...
	public ANALYSIS_NEWS_ARTICLE(DatePublished datePublished) {
	...
	public ANALYSIS_NEWS_ARTICLE(Dateline dateline) {
	...
	public ANALYSIS_NEWS_ARTICLE(Description description) {
	...
	public ANALYSIS_NEWS_ARTICLE(DisambiguatingDescription disambiguatingDescription) {
	...
	public ANALYSIS_NEWS_ARTICLE(DiscussionUrl discussionUrl) {
	...
	public ANALYSIS_NEWS_ARTICLE(Editor editor) {
		setEditor(editor);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(EducationalAlignment educationalAlignment) {
	...
	public ANALYSIS_NEWS_ARTICLE(EducationalUse educationalUse) {
	...
	public ANALYSIS_NEWS_ARTICLE(Encoding encoding) {
	...
	public ANALYSIS_NEWS_ARTICLE(EncodingFormat encodingFormat) {
	...
	public ANALYSIS_NEWS_ARTICLE(ExampleOfWork exampleOfWork) {
	...
	public ANALYSIS_NEWS_ARTICLE(Expires expires) {
		setExpires(expires);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(Funder funder) {
		setFunder(funder);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(Genre genre) {
		setGenre(genre);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(Headline headline) {
	...
	public ANALYSIS_NEWS_ARTICLE(Identifier identifier) {
	...
	public ANALYSIS_NEWS_ARTICLE(Image image) {
		setImage(image);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(InLanguage inLanguage) {
	...
	public ANALYSIS_NEWS_ARTICLE(InteractionStatistic interactionStatistic) {
	...
	public ANALYSIS_NEWS_ARTICLE(InteractivityType interactivityType) {
	...
	public ANALYSIS_NEWS_ARTICLE(IsAccessibleForFree isAccessibleForFree) {
	...
	public ANALYSIS_NEWS_ARTICLE(IsBasedOn isBasedOn) {
	...
	public ANALYSIS_NEWS_ARTICLE(IsFamilyFriendly isFamilyFriendly) {
	...
	public ANALYSIS_NEWS_ARTICLE(IsPartOf isPartOf) {
	...
	public ANALYSIS_NEWS_ARTICLE(Keywords keywords) {
	...
	public ANALYSIS_NEWS_ARTICLE(LearningResourceType learningResourceType) {
	...
	public ANALYSIS_NEWS_ARTICLE(License license) {
		setLicense(license);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(LocationCreated locationCreated) {
	...
	public ANALYSIS_NEWS_ARTICLE(MainEntity mainEntity) {
	...
	public ANALYSIS_NEWS_ARTICLE(MainEntityOfPage mainEntityOfPage) {
	...
	public ANALYSIS_NEWS_ARTICLE(Material material) {
	...
	public ANALYSIS_NEWS_ARTICLE(MaterialExtent materialExtent) {
	...
	public ANALYSIS_NEWS_ARTICLE(Mentions mentions) {
	...
	public ANALYSIS_NEWS_ARTICLE(Name name) {
		setName(name);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(NameFuzzy nameFuzzy) {
	...
	public ANALYSIS_NEWS_ARTICLE(NameRuby nameRuby) {
	...
	public ANALYSIS_NEWS_ARTICLE(Offers offers) {
		setOffers(offers);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(PageEnd pageEnd) {
		setPageEnd(pageEnd);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(PageStart pageStart) {
	...
	public ANALYSIS_NEWS_ARTICLE(Pagination pagination) {
	...
	public ANALYSIS_NEWS_ARTICLE(Position position) {
	...
	public ANALYSIS_NEWS_ARTICLE(PotentialAction potentialAction) {
	...
	public ANALYSIS_NEWS_ARTICLE(PrintColumn printColumn) {
	...
	public ANALYSIS_NEWS_ARTICLE(PrintEdition printEdition) {
	...
	public ANALYSIS_NEWS_ARTICLE(PrintPage printPage) {
	...
	public ANALYSIS_NEWS_ARTICLE(PrintSection printSection) {
	...
	public ANALYSIS_NEWS_ARTICLE(Producer producer) {
	...
	public ANALYSIS_NEWS_ARTICLE(Provider provider) {
	...
	public ANALYSIS_NEWS_ARTICLE(Publication publication) {
	...
	public ANALYSIS_NEWS_ARTICLE(Publisher publisher) {
	...
	public ANALYSIS_NEWS_ARTICLE(PublisherImprint publisherImprint) {
	...
	public ANALYSIS_NEWS_ARTICLE(PublishingPrinciples publishingPrinciples) {
	...
	public ANALYSIS_NEWS_ARTICLE(RecordedAt recordedAt) {
	...
	public ANALYSIS_NEWS_ARTICLE(ReleasedEvent releasedEvent) {
	...
	public ANALYSIS_NEWS_ARTICLE(Review review) {
		setReview(review);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(SchemaVersion schemaVersion) {
	...
	public ANALYSIS_NEWS_ARTICLE(SdDatePublished sdDatePublished) {
	...
	public ANALYSIS_NEWS_ARTICLE(SdLicense sdLicense) {
	...
	public ANALYSIS_NEWS_ARTICLE(SdPublisher sdPublisher) {
	...
	public ANALYSIS_NEWS_ARTICLE(SourceOrganization sourceOrganization) {
	...
	public ANALYSIS_NEWS_ARTICLE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(SpatialCoverage spatialCoverage) {
	...
	public ANALYSIS_NEWS_ARTICLE(Speakable speakable) {
	...
	public ANALYSIS_NEWS_ARTICLE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(SubjectOf subjectOf) {
	...
	public ANALYSIS_NEWS_ARTICLE(Temporal temporal) {
	...
	public ANALYSIS_NEWS_ARTICLE(TemporalCoverage temporalCoverage) {
	...
	public ANALYSIS_NEWS_ARTICLE(Text text) {
		setText(text);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(ThumbnailUrl thumbnailUrl) {
	...
	public ANALYSIS_NEWS_ARTICLE(TimeRequired timeRequired) {
	...
	public ANALYSIS_NEWS_ARTICLE(TranslationOfWork translationOfWork) {
	...
	public ANALYSIS_NEWS_ARTICLE(Translator translator) {
	...
	public ANALYSIS_NEWS_ARTICLE(TypicalAgeRange typicalAgeRange) {
	...
	public ANALYSIS_NEWS_ARTICLE(Url url) {
		setUrl(url);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(Version version) {
		setVersion(version);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(Video video) {
		setVideo(video);
	}
	...
	public ANALYSIS_NEWS_ARTICLE(WordCount wordCount) {
	...
	public ANALYSIS_NEWS_ARTICLE(WorkExample workExample) {
	...
	public ANALYSIS_NEWS_ARTICLE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.AnalysisNewsArticle org) {
		setSeq(org.getSeq());
