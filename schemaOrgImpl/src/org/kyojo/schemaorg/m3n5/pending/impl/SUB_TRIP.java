...
public class SUB_TRIP implements Container.SubTrip {
	...
	public SUB_TRIP(BusTrip busTrip) {
	...
	public SUB_TRIP(TouristTrip touristTrip) {
	...
	public SUB_TRIP(TrainTrip trainTrip) {
	...
	public SUB_TRIP(List<BusTrip> busTripList,
	...
	public void copy(Container.SubTrip org) {
