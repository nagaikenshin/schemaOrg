...
public class EDUCATION_REQUIREMENTS implements Container.EducationRequirements {
	...
	public EDUCATION_REQUIREMENTS(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public EDUCATION_REQUIREMENTS(String string) {
		this(new TEXT(string));
	}

	public EDUCATION_REQUIREMENTS(Text text) {
	...
	public EDUCATION_REQUIREMENTS(List<EducationalOccupationalCredential> educationalOccupationalCredentialList,
			List<Text> textList) {
		setEducationalOccupationalCredentialList(educationalOccupationalCredentialList);
		setTextList(textList);
	}

	public void copy(Container.EducationRequirements org) {
