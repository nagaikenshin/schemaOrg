...
public class DOWN_PAYMENT implements Container.DownPayment {
	...
	public DOWN_PAYMENT(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public DOWN_PAYMENT(Float fl0at) {
	...
	public DOWN_PAYMENT(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public DOWN_PAYMENT(Integer integer) {
	...
	public DOWN_PAYMENT(List<Float> fl0atList,
