...
public class EDUCATIONAL_CREDENTIAL_AWARDED implements Container.EducationalCredentialAwarded {
	...
	public EDUCATIONAL_CREDENTIAL_AWARDED(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public EDUCATIONAL_CREDENTIAL_AWARDED(String string) {
		this(new TEXT(string));
	}

	public EDUCATIONAL_CREDENTIAL_AWARDED(Text text) {
	...
	public EDUCATIONAL_CREDENTIAL_AWARDED(URL url) {
	...
	public EDUCATIONAL_CREDENTIAL_AWARDED(List<EducationalOccupationalCredential> educationalOccupationalCredentialList,
			List<Text> textList,
			List<URL> urlList) {
		setEducationalOccupationalCredentialList(educationalOccupationalCredentialList);
		setTextList(textList);
		setURLList(urlList);
	}

	public void copy(Container.EducationalCredentialAwarded org) {
