...
public class LIBRARY_SYSTEM implements Clazz.LibrarySystem {
	...
	public LIBRARY_SYSTEM(Long seq) {
		setSeq(seq);
	}

	public LIBRARY_SYSTEM(String string) {
	...
	public LIBRARY_SYSTEM(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public LIBRARY_SYSTEM(AdditionalType additionalType) {
	...
	public LIBRARY_SYSTEM(Address address) {
		setAddress(address);
	}
	...
	public LIBRARY_SYSTEM(AggregateRating aggregateRating) {
	...
	public LIBRARY_SYSTEM(AlternateName alternateName) {
	...
	public LIBRARY_SYSTEM(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public LIBRARY_SYSTEM(AreaServed areaServed) {
	...
	public LIBRARY_SYSTEM(Award award) {
		setAward(award);
	}
	...
	public LIBRARY_SYSTEM(Brand brand) {
		setBrand(brand);
	}
	...
	public LIBRARY_SYSTEM(ContactPoint contactPoint) {
	...
	public LIBRARY_SYSTEM(CorrectionsPolicy correctionsPolicy) {
	...
	public LIBRARY_SYSTEM(Department department) {
	...
	public LIBRARY_SYSTEM(Description description) {
	...
	public LIBRARY_SYSTEM(DisambiguatingDescription disambiguatingDescription) {
	...
	public LIBRARY_SYSTEM(DissolutionDate dissolutionDate) {
	...
	public LIBRARY_SYSTEM(DiversityPolicy diversityPolicy) {
	...
	public LIBRARY_SYSTEM(DiversityStaffingReport diversityStaffingReport) {
	...
	public LIBRARY_SYSTEM(Duns duns) {
		setDuns(duns);
	}
	...
	public LIBRARY_SYSTEM(Email email) {
		setEmail(email);
	}
	...
	public LIBRARY_SYSTEM(Employee employee) {
	...
	public LIBRARY_SYSTEM(EthicsPolicy ethicsPolicy) {
	...
	public LIBRARY_SYSTEM(Event event) {
		setEvent(event);
	}
	...
	public LIBRARY_SYSTEM(FaxNumber faxNumber) {
	...
	public LIBRARY_SYSTEM(Founder founder) {
		setFounder(founder);
	}
	...
	public LIBRARY_SYSTEM(FoundingDate foundingDate) {
	...
	public LIBRARY_SYSTEM(FoundingLocation foundingLocation) {
	...
	public LIBRARY_SYSTEM(Funder funder) {
		setFunder(funder);
	}
	...
	public LIBRARY_SYSTEM(GlobalLocationNumber globalLocationNumber) {
	...
	public LIBRARY_SYSTEM(HasOfferCatalog hasOfferCatalog) {
	...
	public LIBRARY_SYSTEM(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public LIBRARY_SYSTEM(Identifier identifier) {
	...
	public LIBRARY_SYSTEM(Image image) {
		setImage(image);
	}
	...
	public LIBRARY_SYSTEM(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public LIBRARY_SYSTEM(KnowsAbout knowsAbout) {
	...
	public LIBRARY_SYSTEM(KnowsLanguage knowsLanguage) {
	...
	public LIBRARY_SYSTEM(LegalName legalName) {
	...
	public LIBRARY_SYSTEM(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public LIBRARY_SYSTEM(Location location) {
	...
	public LIBRARY_SYSTEM(Logo logo) {
		setLogo(logo);
	}
	...
	public LIBRARY_SYSTEM(MainEntityOfPage mainEntityOfPage) {
	...
	public LIBRARY_SYSTEM(MakesOffer makesOffer) {
	...
	public LIBRARY_SYSTEM(Member member) {
		setMember(member);
	}
	...
	public LIBRARY_SYSTEM(MemberOf memberOf) {
	...
	public LIBRARY_SYSTEM(Naics naics) {
		setNaics(naics);
	}
	...
	public LIBRARY_SYSTEM(Name name) {
		setName(name);
	}
	...
	public LIBRARY_SYSTEM(NameFuzzy nameFuzzy) {
	...
	public LIBRARY_SYSTEM(NameRuby nameRuby) {
	...
	public LIBRARY_SYSTEM(NumberOfEmployees numberOfEmployees) {
	...
	public LIBRARY_SYSTEM(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public LIBRARY_SYSTEM(Owns owns) {
		setOwns(owns);
	}
	...
	public LIBRARY_SYSTEM(ParentOrganization parentOrganization) {
	...
	public LIBRARY_SYSTEM(PotentialAction potentialAction) {
	...
	public LIBRARY_SYSTEM(PublishingPrinciples publishingPrinciples) {
	...
	public LIBRARY_SYSTEM(Review review) {
		setReview(review);
	}
	...
	public LIBRARY_SYSTEM(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public LIBRARY_SYSTEM(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public LIBRARY_SYSTEM(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public LIBRARY_SYSTEM(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public LIBRARY_SYSTEM(SubOrganization subOrganization) {
	...
	public LIBRARY_SYSTEM(SubjectOf subjectOf) {
	...
	public LIBRARY_SYSTEM(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public LIBRARY_SYSTEM(Telephone telephone) {
	...
	public LIBRARY_SYSTEM(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public LIBRARY_SYSTEM(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.LibrarySystem org) {
		setSeq(org.getSeq());
