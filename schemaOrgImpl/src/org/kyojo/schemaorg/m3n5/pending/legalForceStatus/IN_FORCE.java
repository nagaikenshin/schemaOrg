...
public class IN_FORCE implements LegalForceStatus.InForce {
	...
	public IN_FORCE(Long seq) {
		setSeq(seq);
	}

	public IN_FORCE(String string) {
	...
	public IN_FORCE(AdditionalType additionalType) {
	...
	public IN_FORCE(AlternateName alternateName) {
	...
	public IN_FORCE(Description description) {
	...
	public IN_FORCE(DisambiguatingDescription disambiguatingDescription) {
	...
	public IN_FORCE(Identifier identifier) {
	...
	public IN_FORCE(MainEntityOfPage mainEntityOfPage) {
	...
	public IN_FORCE(NameFuzzy nameFuzzy) {
	...
	public IN_FORCE(NameRuby nameRuby) {
	...
	public IN_FORCE(PotentialAction potentialAction) {
	...
	public IN_FORCE(SubjectOf subjectOf) {
	...
	public IN_FORCE(SupersededBy supersededBy) {
	...
	public void copy(LegalForceStatus.InForce org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return LegalForceStatus.InForce.class.getAnnotation(SampleValue.class).value();
	}
