...
public class COMIC_STORY implements Clazz.ComicStory {
	...
	public COMIC_STORY(Long seq) {
		setSeq(seq);
	}

	public COMIC_STORY(String string) {
	...
	public COMIC_STORY(About about) {
		setAbout(about);
	}
	...
	public COMIC_STORY(AccessMode accessMode) {
	...
	public COMIC_STORY(AccessModeSufficient accessModeSufficient) {
	...
	public COMIC_STORY(AccessibilityAPI accessibilityAPI) {
	...
	public COMIC_STORY(AccessibilityControl accessibilityControl) {
	...
	public COMIC_STORY(AccessibilityFeature accessibilityFeature) {
	...
	public COMIC_STORY(AccessibilityHazard accessibilityHazard) {
	...
	public COMIC_STORY(AccessibilitySummary accessibilitySummary) {
	...
	public COMIC_STORY(AccountablePerson accountablePerson) {
	...
	public COMIC_STORY(AdditionalType additionalType) {
	...
	public COMIC_STORY(AggregateRating aggregateRating) {
	...
	public COMIC_STORY(AlternateName alternateName) {
	...
	public COMIC_STORY(AlternativeHeadline alternativeHeadline) {
	...
	public COMIC_STORY(Artist artist) {
		setArtist(artist);
	}
	...
	public COMIC_STORY(AssociatedMedia associatedMedia) {
	...
	public COMIC_STORY(Audience audience) {
	...
	public COMIC_STORY(Audio audio) {
		setAudio(audio);
	}
	...
	public COMIC_STORY(Author author) {
		setAuthor(author);
	}
	...
	public COMIC_STORY(Award award) {
		setAward(award);
	}
	...
	public COMIC_STORY(Character character) {
	...
	public COMIC_STORY(Citation citation) {
	...
	public COMIC_STORY(Colorist colorist) {
	...
	public COMIC_STORY(Comment comment) {
		setComment(comment);
	}
	...
	public COMIC_STORY(CommentCount commentCount) {
	...
	public COMIC_STORY(ContentLocation contentLocation) {
	...
	public COMIC_STORY(ContentRating contentRating) {
	...
	public COMIC_STORY(ContentReferenceTime contentReferenceTime) {
	...
	public COMIC_STORY(Contributor contributor) {
	...
	public COMIC_STORY(CopyrightHolder copyrightHolder) {
	...
	public COMIC_STORY(CopyrightYear copyrightYear) {
	...
	public COMIC_STORY(Correction correction) {
	...
	public COMIC_STORY(Creator creator) {
		setCreator(creator);
	}
	...
	public COMIC_STORY(DateCreated dateCreated) {
	...
	public COMIC_STORY(DateModified dateModified) {
	...
	public COMIC_STORY(DatePublished datePublished) {
	...
	public COMIC_STORY(Description description) {
	...
	public COMIC_STORY(DisambiguatingDescription disambiguatingDescription) {
	...
	public COMIC_STORY(DiscussionUrl discussionUrl) {
	...
	public COMIC_STORY(Editor editor) {
		setEditor(editor);
	}
	...
	public COMIC_STORY(EducationalAlignment educationalAlignment) {
	...
	public COMIC_STORY(EducationalUse educationalUse) {
	...
	public COMIC_STORY(Encoding encoding) {
	...
	public COMIC_STORY(EncodingFormat encodingFormat) {
	...
	public COMIC_STORY(ExampleOfWork exampleOfWork) {
	...
	public COMIC_STORY(Expires expires) {
		setExpires(expires);
	}
	...
	public COMIC_STORY(Funder funder) {
		setFunder(funder);
	}
	...
	public COMIC_STORY(Genre genre) {
		setGenre(genre);
	}
	...
	public COMIC_STORY(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public COMIC_STORY(Headline headline) {
	...
	public COMIC_STORY(Identifier identifier) {
	...
	public COMIC_STORY(Image image) {
		setImage(image);
	}
	...
	public COMIC_STORY(InLanguage inLanguage) {
	...
	public COMIC_STORY(Inker inker) {
		setInker(inker);
	}
	...
	public COMIC_STORY(InteractionStatistic interactionStatistic) {
	...
	public COMIC_STORY(InteractivityType interactivityType) {
	...
	public COMIC_STORY(IsAccessibleForFree isAccessibleForFree) {
	...
	public COMIC_STORY(IsBasedOn isBasedOn) {
	...
	public COMIC_STORY(IsFamilyFriendly isFamilyFriendly) {
	...
	public COMIC_STORY(IsPartOf isPartOf) {
	...
	public COMIC_STORY(Keywords keywords) {
	...
	public COMIC_STORY(LearningResourceType learningResourceType) {
	...
	public COMIC_STORY(Letterer letterer) {
	...
	public COMIC_STORY(License license) {
		setLicense(license);
	}
	...
	public COMIC_STORY(LocationCreated locationCreated) {
	...
	public COMIC_STORY(MainEntity mainEntity) {
	...
	public COMIC_STORY(MainEntityOfPage mainEntityOfPage) {
	...
	public COMIC_STORY(Material material) {
	...
	public COMIC_STORY(MaterialExtent materialExtent) {
	...
	public COMIC_STORY(Mentions mentions) {
	...
	public COMIC_STORY(NameFuzzy nameFuzzy) {
	...
	public COMIC_STORY(NameRuby nameRuby) {
	...
	public COMIC_STORY(Offers offers) {
		setOffers(offers);
	}
	...
	public COMIC_STORY(Penciler penciler) {
	...
	public COMIC_STORY(Position position) {
	...
	public COMIC_STORY(PotentialAction potentialAction) {
	...
	public COMIC_STORY(Producer producer) {
	...
	public COMIC_STORY(Provider provider) {
	...
	public COMIC_STORY(Publication publication) {
	...
	public COMIC_STORY(Publisher publisher) {
	...
	public COMIC_STORY(PublisherImprint publisherImprint) {
	...
	public COMIC_STORY(PublishingPrinciples publishingPrinciples) {
	...
	public COMIC_STORY(RecordedAt recordedAt) {
	...
	public COMIC_STORY(ReleasedEvent releasedEvent) {
	...
	public COMIC_STORY(Review review) {
		setReview(review);
	}
	...
	public COMIC_STORY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public COMIC_STORY(SchemaVersion schemaVersion) {
	...
	public COMIC_STORY(SdDatePublished sdDatePublished) {
	...
	public COMIC_STORY(SdLicense sdLicense) {
	...
	public COMIC_STORY(SdPublisher sdPublisher) {
	...
	public COMIC_STORY(SourceOrganization sourceOrganization) {
	...
	public COMIC_STORY(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public COMIC_STORY(SpatialCoverage spatialCoverage) {
	...
	public COMIC_STORY(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public COMIC_STORY(SubjectOf subjectOf) {
	...
	public COMIC_STORY(Temporal temporal) {
	...
	public COMIC_STORY(TemporalCoverage temporalCoverage) {
	...
	public COMIC_STORY(ThumbnailUrl thumbnailUrl) {
	...
	public COMIC_STORY(TimeRequired timeRequired) {
	...
	public COMIC_STORY(TranslationOfWork translationOfWork) {
	...
	public COMIC_STORY(Translator translator) {
	...
	public COMIC_STORY(TypicalAgeRange typicalAgeRange) {
	...
	public COMIC_STORY(Version version) {
		setVersion(version);
	}
	...
	public COMIC_STORY(Video video) {
		setVideo(video);
	}
	...
	public COMIC_STORY(WorkExample workExample) {
	...
	public COMIC_STORY(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.ComicStory org) {
		setSeq(org.getSeq());
