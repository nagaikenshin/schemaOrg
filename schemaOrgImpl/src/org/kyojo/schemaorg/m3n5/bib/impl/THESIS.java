...
public class THESIS implements Clazz.Thesis {
	...
	public InSupportOf inSupportOf;
	...
	public THESIS(Long seq) {
		setSeq(seq);
	}

	public THESIS(String string) {
	...
	public THESIS(AccessMode accessMode) {
	...
	public THESIS(AccessModeSufficient accessModeSufficient) {
	...
	public THESIS(AccessibilityAPI accessibilityAPI) {
	...
	public THESIS(AccessibilityControl accessibilityControl) {
	...
	public THESIS(AccessibilityFeature accessibilityFeature) {
	...
	public THESIS(AccessibilityHazard accessibilityHazard) {
	...
	public THESIS(AccessibilitySummary accessibilitySummary) {
	...
	public THESIS(AccountablePerson accountablePerson) {
	...
	public THESIS(AdditionalType additionalType) {
	...
	public THESIS(AggregateRating aggregateRating) {
	...
	public THESIS(AlternateName alternateName) {
	...
	public THESIS(AlternativeHeadline alternativeHeadline) {
	...
	public THESIS(AssociatedMedia associatedMedia) {
	...
	public THESIS(Audience audience) {
	...
	public THESIS(Character character) {
	...
	public THESIS(Citation citation) {
	...
	public THESIS(CommentCount commentCount) {
	...
	public THESIS(ContentLocation contentLocation) {
	...
	public THESIS(ContentRating contentRating) {
	...
	public THESIS(ContentReferenceTime contentReferenceTime) {
	...
	public THESIS(Contributor contributor) {
	...
	public THESIS(CopyrightHolder copyrightHolder) {
	...
	public THESIS(CopyrightYear copyrightYear) {
	...
	public THESIS(Correction correction) {
	...
	public THESIS(DateCreated dateCreated) {
	...
	public THESIS(DateModified dateModified) {
	...
	public THESIS(DatePublished datePublished) {
	...
	public THESIS(Description description) {
	...
	public THESIS(DisambiguatingDescription disambiguatingDescription) {
	...
	public THESIS(DiscussionUrl discussionUrl) {
	...
	public THESIS(EducationalAlignment educationalAlignment) {
	...
	public THESIS(EducationalUse educationalUse) {
	...
	public THESIS(Encoding encoding) {
	...
	public THESIS(EncodingFormat encodingFormat) {
	...
	public THESIS(ExampleOfWork exampleOfWork) {
	...
	public THESIS(Headline headline) {
	...
	public THESIS(Identifier identifier) {
	...
	public THESIS(InLanguage inLanguage) {
	...
	public THESIS(InSupportOf inSupportOf) {
		setInSupportOf(inSupportOf);
	}

	@Override
	public InSupportOf getInSupportOf() {
		return inSupportOf;
	}

	@Override
	public void setInSupportOf(InSupportOf inSupportOf) {
		this.inSupportOf = inSupportOf;
	}

	public THESIS(InteractionStatistic interactionStatistic) {
	...
	public THESIS(InteractivityType interactivityType) {
	...
	public THESIS(IsAccessibleForFree isAccessibleForFree) {
	...
	public THESIS(IsBasedOn isBasedOn) {
	...
	public THESIS(IsFamilyFriendly isFamilyFriendly) {
	...
	public THESIS(IsPartOf isPartOf) {
	...
	public THESIS(Keywords keywords) {
	...
	public THESIS(LearningResourceType learningResourceType) {
	...
	public THESIS(LocationCreated locationCreated) {
	...
	public THESIS(MainEntity mainEntity) {
	...
	public THESIS(MainEntityOfPage mainEntityOfPage) {
	...
	public THESIS(Material material) {
	...
	public THESIS(MaterialExtent materialExtent) {
	...
	public THESIS(Mentions mentions) {
	...
	public THESIS(NameFuzzy nameFuzzy) {
	...
	public THESIS(NameRuby nameRuby) {
	...
	public THESIS(Position position) {
	...
	public THESIS(PotentialAction potentialAction) {
	...
	public THESIS(Producer producer) {
	...
	public THESIS(Provider provider) {
	...
	public THESIS(Publisher publisher) {
	...
	public THESIS(PublisherImprint publisherImprint) {
	...
	public THESIS(PublishingPrinciples publishingPrinciples) {
	...
	public THESIS(RecordedAt recordedAt) {
	...
	public THESIS(ReleasedEvent releasedEvent) {
	...
	public THESIS(SchemaVersion schemaVersion) {
	...
	public THESIS(SdDatePublished sdDatePublished) {
	...
	public THESIS(SdLicense sdLicense) {
	...
	public THESIS(SdPublisher sdPublisher) {
	...
	public THESIS(SourceOrganization sourceOrganization) {
	...
	public THESIS(SpatialCoverage spatialCoverage) {
	...
	public THESIS(SubjectOf subjectOf) {
	...
	public THESIS(Temporal temporal) {
	...
	public THESIS(TemporalCoverage temporalCoverage) {
	...
	public THESIS(ThumbnailUrl thumbnailUrl) {
	...
	public THESIS(TimeRequired timeRequired) {
	...
	public THESIS(TranslationOfWork translationOfWork) {
	...
	public THESIS(Translator translator) {
	...
	public THESIS(TypicalAgeRange typicalAgeRange) {
	...
	public THESIS(WorkExample workExample) {
	...
	public THESIS(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Thesis org) {
		setSeq(org.getSeq());
		...
		setInSupportOf(org.getInSupportOf());
