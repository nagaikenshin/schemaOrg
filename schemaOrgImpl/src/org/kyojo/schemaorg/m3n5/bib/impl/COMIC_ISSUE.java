...
public class COMIC_ISSUE implements Clazz.ComicIssue {
	...
	public Url url;
	public VariantCover variantCover;
	...
	public COMIC_ISSUE(Long seq) {
		setSeq(seq);
	}

	public COMIC_ISSUE(String string) {
	...
	public COMIC_ISSUE(About about) {
		setAbout(about);
	}
	...
	public COMIC_ISSUE(AccessMode accessMode) {
	...
	public COMIC_ISSUE(AccessModeSufficient accessModeSufficient) {
	...
	public COMIC_ISSUE(AccessibilityAPI accessibilityAPI) {
	...
	public COMIC_ISSUE(AccessibilityControl accessibilityControl) {
	...
	public COMIC_ISSUE(AccessibilityFeature accessibilityFeature) {
	...
	public COMIC_ISSUE(AccessibilityHazard accessibilityHazard) {
	...
	public COMIC_ISSUE(AccessibilitySummary accessibilitySummary) {
	...
	public COMIC_ISSUE(AccountablePerson accountablePerson) {
	...
	public COMIC_ISSUE(AdditionalType additionalType) {
	...
	public COMIC_ISSUE(AggregateRating aggregateRating) {
	...
	public COMIC_ISSUE(AlternateName alternateName) {
	...
	public COMIC_ISSUE(AlternativeHeadline alternativeHeadline) {
	...
	public COMIC_ISSUE(Artist artist) {
		setArtist(artist);
	}
	...
	public COMIC_ISSUE(AssociatedMedia associatedMedia) {
	...
	public COMIC_ISSUE(Audience audience) {
	...
	public COMIC_ISSUE(Audio audio) {
		setAudio(audio);
	}
	...
	public COMIC_ISSUE(Author author) {
		setAuthor(author);
	}
	...
	public COMIC_ISSUE(Award award) {
		setAward(award);
	}
	...
	public COMIC_ISSUE(Character character) {
	...
	public COMIC_ISSUE(Citation citation) {
	...
	public COMIC_ISSUE(Colorist colorist) {
	...
	public COMIC_ISSUE(Comment comment) {
		setComment(comment);
	}
	...
	public COMIC_ISSUE(CommentCount commentCount) {
	...
	public COMIC_ISSUE(ContentLocation contentLocation) {
	...
	public COMIC_ISSUE(ContentRating contentRating) {
	...
	public COMIC_ISSUE(ContentReferenceTime contentReferenceTime) {
	...
	public COMIC_ISSUE(Contributor contributor) {
	...
	public COMIC_ISSUE(CopyrightHolder copyrightHolder) {
	...
	public COMIC_ISSUE(CopyrightYear copyrightYear) {
	...
	public COMIC_ISSUE(Correction correction) {
	...
	public COMIC_ISSUE(Creator creator) {
		setCreator(creator);
	}
	...
	public COMIC_ISSUE(DateCreated dateCreated) {
	...
	public COMIC_ISSUE(DateModified dateModified) {
	...
	public COMIC_ISSUE(DatePublished datePublished) {
	...
	public COMIC_ISSUE(Description description) {
	...
	public COMIC_ISSUE(DisambiguatingDescription disambiguatingDescription) {
	...
	public COMIC_ISSUE(DiscussionUrl discussionUrl) {
	...
	public COMIC_ISSUE(Editor editor) {
		setEditor(editor);
	}
	...
	public COMIC_ISSUE(EducationalAlignment educationalAlignment) {
	...
	public COMIC_ISSUE(EducationalUse educationalUse) {
	...
	public COMIC_ISSUE(Encoding encoding) {
	...
	public COMIC_ISSUE(EncodingFormat encodingFormat) {
	...
	public COMIC_ISSUE(ExampleOfWork exampleOfWork) {
	...
	public COMIC_ISSUE(Expires expires) {
		setExpires(expires);
	}
	...
	public COMIC_ISSUE(Funder funder) {
		setFunder(funder);
	}
	...
	public COMIC_ISSUE(Genre genre) {
		setGenre(genre);
	}
	...
	public COMIC_ISSUE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public COMIC_ISSUE(Headline headline) {
	...
	public COMIC_ISSUE(Identifier identifier) {
	...
	public COMIC_ISSUE(Image image) {
		setImage(image);
	}
	...
	public COMIC_ISSUE(InLanguage inLanguage) {
	...
	public COMIC_ISSUE(Inker inker) {
		setInker(inker);
	}
	...
	public COMIC_ISSUE(InteractionStatistic interactionStatistic) {
	...
	public COMIC_ISSUE(InteractivityType interactivityType) {
	...
	public COMIC_ISSUE(IsAccessibleForFree isAccessibleForFree) {
	...
	public COMIC_ISSUE(IsBasedOn isBasedOn) {
	...
	public COMIC_ISSUE(IsFamilyFriendly isFamilyFriendly) {
	...
	public COMIC_ISSUE(IsPartOf isPartOf) {
	...
	public COMIC_ISSUE(IssueNumber issueNumber) {
	...
	public COMIC_ISSUE(Keywords keywords) {
	...
	public COMIC_ISSUE(LearningResourceType learningResourceType) {
	...
	public COMIC_ISSUE(Letterer letterer) {
	...
	public COMIC_ISSUE(License license) {
		setLicense(license);
	}
	...
	public COMIC_ISSUE(LocationCreated locationCreated) {
	...
	public COMIC_ISSUE(MainEntity mainEntity) {
	...
	public COMIC_ISSUE(MainEntityOfPage mainEntityOfPage) {
	...
	public COMIC_ISSUE(Material material) {
	...
	public COMIC_ISSUE(MaterialExtent materialExtent) {
	...
	public COMIC_ISSUE(Mentions mentions) {
	...
	public COMIC_ISSUE(NameFuzzy nameFuzzy) {
	...
	public COMIC_ISSUE(NameRuby nameRuby) {
	...
	public COMIC_ISSUE(Offers offers) {
		setOffers(offers);
	}
	...
	public COMIC_ISSUE(PageEnd pageEnd) {
		setPageEnd(pageEnd);
	}
	...
	public COMIC_ISSUE(PageStart pageStart) {
	...
	public COMIC_ISSUE(Pagination pagination) {
	...
	public COMIC_ISSUE(Penciler penciler) {
	...
	public COMIC_ISSUE(Position position) {
	...
	public COMIC_ISSUE(PotentialAction potentialAction) {
	...
	public COMIC_ISSUE(Producer producer) {
	...
	public COMIC_ISSUE(Provider provider) {
	...
	public COMIC_ISSUE(Publication publication) {
	...
	public COMIC_ISSUE(Publisher publisher) {
	...
	public COMIC_ISSUE(PublisherImprint publisherImprint) {
	...
	public COMIC_ISSUE(PublishingPrinciples publishingPrinciples) {
	...
	public COMIC_ISSUE(RecordedAt recordedAt) {
	...
	public COMIC_ISSUE(ReleasedEvent releasedEvent) {
	...
	public COMIC_ISSUE(Review review) {
		setReview(review);
	}
	...
	public COMIC_ISSUE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public COMIC_ISSUE(SchemaVersion schemaVersion) {
	...
	public COMIC_ISSUE(SdDatePublished sdDatePublished) {
	...
	public COMIC_ISSUE(SdLicense sdLicense) {
	...
	public COMIC_ISSUE(SdPublisher sdPublisher) {
	...
	public COMIC_ISSUE(SourceOrganization sourceOrganization) {
	...
	public COMIC_ISSUE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public COMIC_ISSUE(SpatialCoverage spatialCoverage) {
	...
	public COMIC_ISSUE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public COMIC_ISSUE(SubjectOf subjectOf) {
	...
	public COMIC_ISSUE(Temporal temporal) {
	...
	public COMIC_ISSUE(TemporalCoverage temporalCoverage) {
	...
	public COMIC_ISSUE(ThumbnailUrl thumbnailUrl) {
	...
	public COMIC_ISSUE(TimeRequired timeRequired) {
	...
	public COMIC_ISSUE(TranslationOfWork translationOfWork) {
	...
	public COMIC_ISSUE(Translator translator) {
	...
	public COMIC_ISSUE(TypicalAgeRange typicalAgeRange) {
	...
	public COMIC_ISSUE(VariantCover variantCover) {
		setVariantCover(variantCover);
	}

	@Override
	public VariantCover getVariantCover() {
		return variantCover;
	}

	@Override
	public void setVariantCover(VariantCover variantCover) {
		this.variantCover = variantCover;
	}

	public COMIC_ISSUE(Version version) {
		setVersion(version);
	}
	...
	public COMIC_ISSUE(Video video) {
		setVideo(video);
	}
	...
	public COMIC_ISSUE(WorkExample workExample) {
	...
	public COMIC_ISSUE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.ComicIssue org) {
		setSeq(org.getSeq());
		...
		setUrl(org.getUrl());
		setVariantCover(org.getVariantCover());
