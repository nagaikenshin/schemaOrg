...
public class COMIC_SERIES implements Clazz.ComicSeries {
	...
	public COMIC_SERIES(Long seq) {
		setSeq(seq);
	}

	public COMIC_SERIES(String string) {
	...
	public COMIC_SERIES(About about) {
		setAbout(about);
	}
	...
	public COMIC_SERIES(AccessMode accessMode) {
	...
	public COMIC_SERIES(AccessModeSufficient accessModeSufficient) {
	...
	public COMIC_SERIES(AccessibilityAPI accessibilityAPI) {
	...
	public COMIC_SERIES(AccessibilityControl accessibilityControl) {
	...
	public COMIC_SERIES(AccessibilityFeature accessibilityFeature) {
	...
	public COMIC_SERIES(AccessibilityHazard accessibilityHazard) {
	...
	public COMIC_SERIES(AccessibilitySummary accessibilitySummary) {
	...
	public COMIC_SERIES(AccountablePerson accountablePerson) {
	...
	public COMIC_SERIES(AdditionalType additionalType) {
	...
	public COMIC_SERIES(AggregateRating aggregateRating) {
	...
	public COMIC_SERIES(AlternateName alternateName) {
	...
	public COMIC_SERIES(AlternativeHeadline alternativeHeadline) {
	...
	public COMIC_SERIES(AssociatedMedia associatedMedia) {
	...
	public COMIC_SERIES(Audience audience) {
	...
	public COMIC_SERIES(Audio audio) {
		setAudio(audio);
	}
	...
	public COMIC_SERIES(Author author) {
		setAuthor(author);
	}
	...
	public COMIC_SERIES(Award award) {
		setAward(award);
	}
	...
	public COMIC_SERIES(Character character) {
	...
	public COMIC_SERIES(Citation citation) {
	...
	public COMIC_SERIES(Comment comment) {
		setComment(comment);
	}
	...
	public COMIC_SERIES(CommentCount commentCount) {
	...
	public COMIC_SERIES(ContentLocation contentLocation) {
	...
	public COMIC_SERIES(ContentRating contentRating) {
	...
	public COMIC_SERIES(ContentReferenceTime contentReferenceTime) {
	...
	public COMIC_SERIES(Contributor contributor) {
	...
	public COMIC_SERIES(CopyrightHolder copyrightHolder) {
	...
	public COMIC_SERIES(CopyrightYear copyrightYear) {
	...
	public COMIC_SERIES(Correction correction) {
	...
	public COMIC_SERIES(Creator creator) {
		setCreator(creator);
	}
	...
	public COMIC_SERIES(DateCreated dateCreated) {
	...
	public COMIC_SERIES(DateModified dateModified) {
	...
	public COMIC_SERIES(DatePublished datePublished) {
	...
	public COMIC_SERIES(Description description) {
	...
	public COMIC_SERIES(DisambiguatingDescription disambiguatingDescription) {
	...
	public COMIC_SERIES(DiscussionUrl discussionUrl) {
	...
	public COMIC_SERIES(Editor editor) {
		setEditor(editor);
	}
	...
	public COMIC_SERIES(EducationalAlignment educationalAlignment) {
	...
	public COMIC_SERIES(EducationalUse educationalUse) {
	...
	public COMIC_SERIES(Encoding encoding) {
	...
	public COMIC_SERIES(EncodingFormat encodingFormat) {
	...
	public COMIC_SERIES(EndDate endDate) {
		setEndDate(endDate);
	}
	...
	public COMIC_SERIES(ExampleOfWork exampleOfWork) {
	...
	public COMIC_SERIES(Expires expires) {
		setExpires(expires);
	}
	...
	public COMIC_SERIES(Funder funder) {
		setFunder(funder);
	}
	...
	public COMIC_SERIES(Genre genre) {
		setGenre(genre);
	}
	...
	public COMIC_SERIES(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public COMIC_SERIES(Headline headline) {
	...
	public COMIC_SERIES(Identifier identifier) {
	...
	public COMIC_SERIES(Image image) {
		setImage(image);
	}
	...
	public COMIC_SERIES(InLanguage inLanguage) {
	...
	public COMIC_SERIES(InteractionStatistic interactionStatistic) {
	...
	public COMIC_SERIES(InteractivityType interactivityType) {
	...
	public COMIC_SERIES(IsAccessibleForFree isAccessibleForFree) {
	...
	public COMIC_SERIES(IsBasedOn isBasedOn) {
	...
	public COMIC_SERIES(IsFamilyFriendly isFamilyFriendly) {
	...
	public COMIC_SERIES(IsPartOf isPartOf) {
	...
	public COMIC_SERIES(Keywords keywords) {
	...
	public COMIC_SERIES(LearningResourceType learningResourceType) {
	...
	public COMIC_SERIES(License license) {
		setLicense(license);
	}
	...
	public COMIC_SERIES(LocationCreated locationCreated) {
	...
	public COMIC_SERIES(MainEntity mainEntity) {
	...
	public COMIC_SERIES(MainEntityOfPage mainEntityOfPage) {
	...
	public COMIC_SERIES(Material material) {
	...
	public COMIC_SERIES(MaterialExtent materialExtent) {
	...
	public COMIC_SERIES(Mentions mentions) {
	...
	public COMIC_SERIES(NameFuzzy nameFuzzy) {
	...
	public COMIC_SERIES(NameRuby nameRuby) {
	...
	public COMIC_SERIES(Offers offers) {
		setOffers(offers);
	}
	...
	public COMIC_SERIES(Position position) {
	...
	public COMIC_SERIES(PotentialAction potentialAction) {
	...
	public COMIC_SERIES(Producer producer) {
	...
	public COMIC_SERIES(Provider provider) {
	...
	public COMIC_SERIES(Publication publication) {
	...
	public COMIC_SERIES(Publisher publisher) {
	...
	public COMIC_SERIES(PublisherImprint publisherImprint) {
	...
	public COMIC_SERIES(PublishingPrinciples publishingPrinciples) {
	...
	public COMIC_SERIES(RecordedAt recordedAt) {
	...
	public COMIC_SERIES(ReleasedEvent releasedEvent) {
	...
	public COMIC_SERIES(Review review) {
		setReview(review);
	}
	...
	public COMIC_SERIES(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public COMIC_SERIES(SchemaVersion schemaVersion) {
	...
	public COMIC_SERIES(SdDatePublished sdDatePublished) {
	...
	public COMIC_SERIES(SdLicense sdLicense) {
	...
	public COMIC_SERIES(SdPublisher sdPublisher) {
	...
	public COMIC_SERIES(SourceOrganization sourceOrganization) {
	...
	public COMIC_SERIES(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public COMIC_SERIES(SpatialCoverage spatialCoverage) {
	...
	public COMIC_SERIES(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public COMIC_SERIES(StartDate startDate) {
	...
	public COMIC_SERIES(SubjectOf subjectOf) {
	...
	public COMIC_SERIES(Temporal temporal) {
	...
	public COMIC_SERIES(TemporalCoverage temporalCoverage) {
	...
	public COMIC_SERIES(ThumbnailUrl thumbnailUrl) {
	...
	public COMIC_SERIES(TimeRequired timeRequired) {
	...
	public COMIC_SERIES(TranslationOfWork translationOfWork) {
	...
	public COMIC_SERIES(Translator translator) {
	...
	public COMIC_SERIES(TypicalAgeRange typicalAgeRange) {
	...
	public COMIC_SERIES(Version version) {
		setVersion(version);
	}
	...
	public COMIC_SERIES(Video video) {
		setVideo(video);
	}
	...
	public COMIC_SERIES(WorkExample workExample) {
	...
	public COMIC_SERIES(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.ComicSeries org) {
		setSeq(org.getSeq());
