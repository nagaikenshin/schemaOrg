...
import org.kyojo.schemaorg.m3n5.auto.Container;
...
public class ENGINE_TYPE implements Container.EngineType {
	...
	public ENGINE_TYPE(QualitativeValue qualitativeValue) {
	...
	public ENGINE_TYPE(String string) {
		this(new TEXT(string));
	}

	public ENGINE_TYPE(Text text) {
	...
	public ENGINE_TYPE(List<QualitativeValue> qualitativeValueList,
			List<Text> textList,
			List<URL> urlList) {
	...
	public void copy(Container.EngineType org) {
