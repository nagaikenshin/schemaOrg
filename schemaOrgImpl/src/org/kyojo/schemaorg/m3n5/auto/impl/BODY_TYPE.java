...
public class BODY_TYPE implements Container.BodyType {
	...
	public BODY_TYPE(QualitativeValue qualitativeValue) {
	...
	public BODY_TYPE(String string) {
		this(new TEXT(string));
	}

	public BODY_TYPE(Text text) {
	...
	public BODY_TYPE(List<QualitativeValue> qualitativeValueList,
			List<Text> textList,
			List<URL> urlList) {
	...
	public void copy(Container.BodyType org) {
