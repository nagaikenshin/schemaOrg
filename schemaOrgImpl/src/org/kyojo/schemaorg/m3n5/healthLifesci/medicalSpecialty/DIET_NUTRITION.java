...
public class DIET_NUTRITION implements MedicalSpecialty.DietNutrition {
	...
	public DIET_NUTRITION(GeoContains geoContains) {
	...
	public DIET_NUTRITION(GeoCoveredBy geoCoveredBy) {
	...
	public DIET_NUTRITION(GeoCovers geoCovers) {
	...
	public DIET_NUTRITION(GeoCrosses geoCrosses) {
	...
	public DIET_NUTRITION(GeoDisjoint geoDisjoint) {
	...
	public DIET_NUTRITION(GeoEquals geoEquals) {
	...
	public DIET_NUTRITION(GeoIntersects geoIntersects) {
	...
	public DIET_NUTRITION(GeoOverlaps geoOverlaps) {
	...
	public DIET_NUTRITION(GeoTouches geoTouches) {
	...
	public DIET_NUTRITION(GeoWithin geoWithin) {
	...
	public DIET_NUTRITION(Slogan slogan) {
		setSlogan(slogan);
	}
