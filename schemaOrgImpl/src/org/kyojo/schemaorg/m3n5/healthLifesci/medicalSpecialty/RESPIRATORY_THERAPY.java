...
import org.kyojo.schemaorg.m3n5.healthLifesci.Container.DoseSchedule;
...
import org.kyojo.schemaorg.m3n5.healthLifesci.Container.HowPerformed;
...
import org.kyojo.schemaorg.m3n5.healthLifesci.Container.Preparation;
...
public class RESPIRATORY_THERAPY implements MedicalSpecialty.RespiratoryTherapy {
	...
	public RESPIRATORY_THERAPY() {
	}

	public RESPIRATORY_THERAPY(Long seq) {
		setSeq(seq);
	}

	public RESPIRATORY_THERAPY(String string) {
	...
	public RESPIRATORY_THERAPY(AdditionalType additionalType) {
	...
	public RESPIRATORY_THERAPY(AdverseOutcome adverseOutcome) {
	...
	public RESPIRATORY_THERAPY(AlternateName alternateName) {
	...
	public RESPIRATORY_THERAPY(BodyLocation bodyLocation) {
	...
	public RESPIRATORY_THERAPY(Code code) {
		setCode(code);
	}
	...
	public RESPIRATORY_THERAPY(Contraindication contraindication) {
	...
	public RESPIRATORY_THERAPY(Description description) {
	...
	public RESPIRATORY_THERAPY(DisambiguatingDescription disambiguatingDescription) {
	...
	public RESPIRATORY_THERAPY(DoseSchedule doseSchedule) {
	...
	public RESPIRATORY_THERAPY(Drug drug) {
		setDrug(drug);
	}
	...
	public RESPIRATORY_THERAPY(DuplicateTherapy duplicateTherapy) {
	...
	public RESPIRATORY_THERAPY(Followup followup) {
	...
	public RESPIRATORY_THERAPY(Guideline guideline) {
	...
	public RESPIRATORY_THERAPY(HowPerformed howPerformed) {
	...
	public RESPIRATORY_THERAPY(Identifier identifier) {
	...
	public RESPIRATORY_THERAPY(Image image) {
		setImage(image);
	}
	...
	public RESPIRATORY_THERAPY(Indication indication) {
	...
	public RESPIRATORY_THERAPY(LegalStatus legalStatus) {
	...
	public RESPIRATORY_THERAPY(MainEntityOfPage mainEntityOfPage) {
	...
	public RESPIRATORY_THERAPY(MedicineSystem medicineSystem) {
	...
	public RESPIRATORY_THERAPY(Name name) {
		setName(name);
	}
	...
	public RESPIRATORY_THERAPY(NameFuzzy nameFuzzy) {
	...
	public RESPIRATORY_THERAPY(NameRuby nameRuby) {
	...
	public RESPIRATORY_THERAPY(Outcome outcome) {
		setOutcome(outcome);
	}
	...
	public RESPIRATORY_THERAPY(PotentialAction potentialAction) {
	...
	public RESPIRATORY_THERAPY(Preparation preparation) {
	...
	public RESPIRATORY_THERAPY(ProcedureType procedureType) {
	...
	public RESPIRATORY_THERAPY(RecognizingAuthority recognizingAuthority) {
	...
	public RESPIRATORY_THERAPY(RelevantSpecialty relevantSpecialty) {
	...
	public RESPIRATORY_THERAPY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RESPIRATORY_THERAPY(SeriousAdverseOutcome seriousAdverseOutcome) {
	...
	public RESPIRATORY_THERAPY(Status status) {
		setStatus(status);
	}
	...
	public RESPIRATORY_THERAPY(Study study) {
		setStudy(study);
	}
	...
	public RESPIRATORY_THERAPY(SubjectOf subjectOf) {
	...
	public RESPIRATORY_THERAPY(SupersededBy supersededBy) {
	...
	public RESPIRATORY_THERAPY(Url url) {
		setUrl(url);
	}
	...
	public void copy(MedicalSpecialty.RespiratoryTherapy org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalSpecialty.RespiratoryTherapy.class.getAnnotation(SampleValue.class).value();
	}
