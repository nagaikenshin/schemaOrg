...
public class OTOLARYNGOLOGIC implements MedicalSpecialty.Otolaryngologic {
	...
	public OTOLARYNGOLOGIC(GeoContains geoContains) {
	...
	public OTOLARYNGOLOGIC(GeoCoveredBy geoCoveredBy) {
	...
	public OTOLARYNGOLOGIC(GeoCovers geoCovers) {
	...
	public OTOLARYNGOLOGIC(GeoCrosses geoCrosses) {
	...
	public OTOLARYNGOLOGIC(GeoDisjoint geoDisjoint) {
	...
	public OTOLARYNGOLOGIC(GeoEquals geoEquals) {
	...
	public OTOLARYNGOLOGIC(GeoIntersects geoIntersects) {
	...
	public OTOLARYNGOLOGIC(GeoOverlaps geoOverlaps) {
	...
	public OTOLARYNGOLOGIC(GeoTouches geoTouches) {
	...
	public OTOLARYNGOLOGIC(GeoWithin geoWithin) {
	...
	public OTOLARYNGOLOGIC(Slogan slogan) {
		setSlogan(slogan);
	}
