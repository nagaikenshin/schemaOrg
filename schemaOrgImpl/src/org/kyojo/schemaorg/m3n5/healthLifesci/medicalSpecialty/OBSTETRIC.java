...
public class OBSTETRIC implements MedicalSpecialty.Obstetric {
	...
	public OBSTETRIC(DiversityStaffingReport diversityStaffingReport) {
	...
	public OBSTETRIC(GeoContains geoContains) {
	...
	public OBSTETRIC(GeoCoveredBy geoCoveredBy) {
	...
	public OBSTETRIC(GeoCovers geoCovers) {
	...
	public OBSTETRIC(GeoCrosses geoCrosses) {
	...
	public OBSTETRIC(GeoDisjoint geoDisjoint) {
	...
	public OBSTETRIC(GeoEquals geoEquals) {
	...
	public OBSTETRIC(GeoIntersects geoIntersects) {
	...
	public OBSTETRIC(GeoOverlaps geoOverlaps) {
	...
	public OBSTETRIC(GeoTouches geoTouches) {
	...
	public OBSTETRIC(GeoWithin geoWithin) {
	...
	public OBSTETRIC(KnowsAbout knowsAbout) {
	...
	public OBSTETRIC(KnowsLanguage knowsLanguage) {
	...
	public OBSTETRIC(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public OBSTETRIC(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public OBSTETRIC(SubjectOf subjectOf) {
