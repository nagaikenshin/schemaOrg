...
public class GYNECOLOGIC implements MedicalSpecialty.Gynecologic {
	...
	public GYNECOLOGIC(GeoContains geoContains) {
	...
	public GYNECOLOGIC(GeoCoveredBy geoCoveredBy) {
	...
	public GYNECOLOGIC(GeoCovers geoCovers) {
	...
	public GYNECOLOGIC(GeoCrosses geoCrosses) {
	...
	public GYNECOLOGIC(GeoDisjoint geoDisjoint) {
	...
	public GYNECOLOGIC(GeoEquals geoEquals) {
	...
	public GYNECOLOGIC(GeoIntersects geoIntersects) {
	...
	public GYNECOLOGIC(GeoOverlaps geoOverlaps) {
	...
	public GYNECOLOGIC(GeoTouches geoTouches) {
	...
	public GYNECOLOGIC(GeoWithin geoWithin) {
	...
	public GYNECOLOGIC(Slogan slogan) {
		setSlogan(slogan);
	}
