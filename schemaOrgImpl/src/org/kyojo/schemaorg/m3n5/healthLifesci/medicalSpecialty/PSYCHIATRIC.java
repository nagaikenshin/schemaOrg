...
public class PSYCHIATRIC implements MedicalSpecialty.Psychiatric {
	...
	public PSYCHIATRIC(GeoContains geoContains) {
	...
	public PSYCHIATRIC(GeoCoveredBy geoCoveredBy) {
	...
	public PSYCHIATRIC(GeoCovers geoCovers) {
	...
	public PSYCHIATRIC(GeoCrosses geoCrosses) {
	...
	public PSYCHIATRIC(GeoDisjoint geoDisjoint) {
	...
	public PSYCHIATRIC(GeoEquals geoEquals) {
	...
	public PSYCHIATRIC(GeoIntersects geoIntersects) {
	...
	public PSYCHIATRIC(GeoOverlaps geoOverlaps) {
	...
	public PSYCHIATRIC(GeoTouches geoTouches) {
	...
	public PSYCHIATRIC(GeoWithin geoWithin) {
	...
	public PSYCHIATRIC(Slogan slogan) {
		setSlogan(slogan);
	}
