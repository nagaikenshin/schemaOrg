...
public class PODIATRIC implements MedicalSpecialty.Podiatric {
	...
	public PODIATRIC(GeoContains geoContains) {
	...
	public PODIATRIC(GeoCoveredBy geoCoveredBy) {
	...
	public PODIATRIC(GeoCovers geoCovers) {
	...
	public PODIATRIC(GeoCrosses geoCrosses) {
	...
	public PODIATRIC(GeoDisjoint geoDisjoint) {
	...
	public PODIATRIC(GeoEquals geoEquals) {
	...
	public PODIATRIC(GeoIntersects geoIntersects) {
	...
	public PODIATRIC(GeoOverlaps geoOverlaps) {
	...
	public PODIATRIC(GeoTouches geoTouches) {
	...
	public PODIATRIC(GeoWithin geoWithin) {
	...
	public PODIATRIC(Slogan slogan) {
		setSlogan(slogan);
	}
