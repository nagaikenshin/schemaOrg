...
public class OPEN_TRIAL implements MedicalTrialDesign.OpenTrial {
	...
	public OPEN_TRIAL(Long seq) {
		setSeq(seq);
	}

	public OPEN_TRIAL(String string) {
	...
	public OPEN_TRIAL(AdditionalType additionalType) {
	...
	public OPEN_TRIAL(AlternateName alternateName) {
	...
	public OPEN_TRIAL(Description description) {
	...
	public OPEN_TRIAL(DisambiguatingDescription disambiguatingDescription) {
	...
	public OPEN_TRIAL(Identifier identifier) {
	...
	public OPEN_TRIAL(MainEntityOfPage mainEntityOfPage) {
	...
	public OPEN_TRIAL(NameFuzzy nameFuzzy) {
	...
	public OPEN_TRIAL(NameRuby nameRuby) {
	...
	public OPEN_TRIAL(PotentialAction potentialAction) {
	...
	public OPEN_TRIAL(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public OPEN_TRIAL(SubjectOf subjectOf) {
	...
	public OPEN_TRIAL(SupersededBy supersededBy) {
	...
	public void copy(MedicalTrialDesign.OpenTrial org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalTrialDesign.OpenTrial.class.getAnnotation(SampleValue.class).value();
	}
