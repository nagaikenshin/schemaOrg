...
public class LUNG implements PhysicalExam.Lung {
	...
	public LUNG(Long seq) {
		setSeq(seq);
	}

	public LUNG(String string) {
	...
	public LUNG(AdditionalType additionalType) {
	...
	public LUNG(AlternateName alternateName) {
	...
	public LUNG(BodyLocation bodyLocation) {
	...
	public LUNG(Description description) {
	...
	public LUNG(DisambiguatingDescription disambiguatingDescription) {
	...
	public LUNG(Guideline guideline) {
	...
	public LUNG(HowPerformed howPerformed) {
	...
	public LUNG(Identifier identifier) {
	...
	public LUNG(Indication indication) {
	...
	public LUNG(LegalStatus legalStatus) {
	...
	public LUNG(MainEntityOfPage mainEntityOfPage) {
	...
	public LUNG(MedicineSystem medicineSystem) {
	...
	public LUNG(NameFuzzy nameFuzzy) {
	...
	public LUNG(PotentialAction potentialAction) {
	...
	public LUNG(Preparation preparation) {
	...
	public LUNG(ProcedureType procedureType) {
	...
	public LUNG(RecognizingAuthority recognizingAuthority) {
	...
	public LUNG(RelevantSpecialty relevantSpecialty) {
	...
	public LUNG(SubjectOf subjectOf) {
	...
	public LUNG(SupersededBy supersededBy) {
	...
	public void copy(PhysicalExam.Lung org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return PhysicalExam.Lung.class.getAnnotation(SampleValue.class).value();
	}
