...
public class THROAT implements PhysicalExam.Throat {
	...
	public THROAT(Long seq) {
		setSeq(seq);
	}

	public THROAT(String string) {
	...
	public THROAT(AdditionalType additionalType) {
	...
	public THROAT(AlternateName alternateName) {
	...
	public THROAT(BodyLocation bodyLocation) {
	...
	public THROAT(Description description) {
	...
	public THROAT(DisambiguatingDescription disambiguatingDescription) {
	...
	public THROAT(Followup followup) {
	...
	public THROAT(Guideline guideline) {
	...
	public THROAT(HowPerformed howPerformed) {
	...
	public THROAT(Identifier identifier) {
	...
	public THROAT(Indication indication) {
	...
	public THROAT(LegalStatus legalStatus) {
	...
	public THROAT(MainEntityOfPage mainEntityOfPage) {
	...
	public THROAT(MedicineSystem medicineSystem) {
	...
	public THROAT(NameFuzzy nameFuzzy) {
	...
	public THROAT(NameRuby nameRuby) {
	...
	public THROAT(PotentialAction potentialAction) {
	...
	public THROAT(Preparation preparation) {
	...
	public THROAT(ProcedureType procedureType) {
	...
	public THROAT(RecognizingAuthority recognizingAuthority) {
	...
	public THROAT(RelevantSpecialty relevantSpecialty) {
	...
	public THROAT(SubjectOf subjectOf) {
	...
	public THROAT(SupersededBy supersededBy) {
	...
	public void copy(PhysicalExam.Throat org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return PhysicalExam.Throat.class.getAnnotation(SampleValue.class).value();
	}
