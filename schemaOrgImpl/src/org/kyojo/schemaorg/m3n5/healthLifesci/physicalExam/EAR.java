...
public class EAR implements PhysicalExam.Ear {
	...
	public EAR(AdditionalType additionalType) {
	...
	public EAR(AlternateName alternateName) {
	...
	public EAR(BodyLocation bodyLocation) {
	...
	public EAR(Description description) {
	...
	public EAR(DisambiguatingDescription disambiguatingDescription) {
	...
	public EAR(Guideline guideline) {
	...
	public EAR(HowPerformed howPerformed) {
	...
	public EAR(Identifier identifier) {
	...
	public EAR(Indication indication) {
	...
	public EAR(LegalStatus legalStatus) {
	...
	public EAR(MainEntityOfPage mainEntityOfPage) {
	...
	public EAR(MedicineSystem medicineSystem) {
	...
	public EAR(NameFuzzy nameFuzzy) {
	...
	public EAR(PotentialAction potentialAction) {
	...
	public EAR(Preparation preparation) {
	...
	public EAR(ProcedureType procedureType) {
	...
	public EAR(RecognizingAuthority recognizingAuthority) {
	...
	public EAR(RelevantSpecialty relevantSpecialty) {
	...
	public EAR(SubjectOf subjectOf) {
	...
	public EAR(SupersededBy supersededBy) {
	...
	public void copy(PhysicalExam.Ear org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return PhysicalExam.Ear.class.getAnnotation(SampleValue.class).value();
	}
