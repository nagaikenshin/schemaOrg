...
public class GENITOURINARY implements PhysicalExam.Genitourinary {
	...
	public GENITOURINARY() {
	}

	public GENITOURINARY(Long seq) {
		setSeq(seq);
	}

	public GENITOURINARY(String string) {
	...
	public GENITOURINARY(AdditionalType additionalType) {
	...
	public GENITOURINARY(AlternateName alternateName) {
	...
	public GENITOURINARY(BodyLocation bodyLocation) {
	...
	public GENITOURINARY(Code code) {
		setCode(code);
	}
	...
	public GENITOURINARY(Description description) {
	...
	public GENITOURINARY(DisambiguatingDescription disambiguatingDescription) {
	...
	public GENITOURINARY(Followup followup) {
	...
	public GENITOURINARY(Guideline guideline) {
	...
	public GENITOURINARY(HowPerformed howPerformed) {
	...
	public GENITOURINARY(Identifier identifier) {
	...
	public GENITOURINARY(Image image) {
		setImage(image);
	}
	...
	public GENITOURINARY(Indication indication) {
	...
	public GENITOURINARY(LegalStatus legalStatus) {
	...
	public GENITOURINARY(MainEntityOfPage mainEntityOfPage) {
	...
	public GENITOURINARY(MedicineSystem medicineSystem) {
	...
	public GENITOURINARY(Name name) {
		setName(name);
	}
	...
	public GENITOURINARY(NameFuzzy nameFuzzy) {
	...
	public GENITOURINARY(NameRuby nameRuby) {
	...
	public GENITOURINARY(Outcome outcome) {
		setOutcome(outcome);
	}
	...
	public GENITOURINARY(PotentialAction potentialAction) {
	...
	public GENITOURINARY(Preparation preparation) {
	...
	public GENITOURINARY(ProcedureType procedureType) {
	...
	public GENITOURINARY(RecognizingAuthority recognizingAuthority) {
	...
	public GENITOURINARY(RelevantSpecialty relevantSpecialty) {
	...
	public GENITOURINARY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public GENITOURINARY(Status status) {
		setStatus(status);
	}
	...
	public GENITOURINARY(Study study) {
		setStudy(study);
	}
	...
	public GENITOURINARY(SubjectOf subjectOf) {
	...
	public GENITOURINARY(SupersededBy supersededBy) {
	...
	public void copy(PhysicalExam.Genitourinary org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return PhysicalExam.Genitourinary.class.getAnnotation(SampleValue.class).value();
	}
