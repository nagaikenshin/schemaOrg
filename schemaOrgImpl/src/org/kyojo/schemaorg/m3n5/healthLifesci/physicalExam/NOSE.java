...
public class NOSE implements PhysicalExam.Nose {
	...
	public NOSE(Long seq) {
		setSeq(seq);
	}

	public NOSE(String string) {
	...
	public NOSE(AdditionalType additionalType) {
	...
	public NOSE(AlternateName alternateName) {
	...
	public NOSE(BodyLocation bodyLocation) {
	...
	public NOSE(Description description) {
	...
	public NOSE(DisambiguatingDescription disambiguatingDescription) {
	...
	public NOSE(Guideline guideline) {
	...
	public NOSE(HowPerformed howPerformed) {
	...
	public NOSE(Identifier identifier) {
	...
	public NOSE(Indication indication) {
	...
	public NOSE(LegalStatus legalStatus) {
	...
	public NOSE(MainEntityOfPage mainEntityOfPage) {
	...
	public NOSE(MedicineSystem medicineSystem) {
	...
	public NOSE(NameFuzzy nameFuzzy) {
	...
	public NOSE(PotentialAction potentialAction) {
	...
	public NOSE(Preparation preparation) {
	...
	public NOSE(ProcedureType procedureType) {
	...
	public NOSE(RecognizingAuthority recognizingAuthority) {
	...
	public NOSE(RelevantSpecialty relevantSpecialty) {
	...
	public NOSE(SubjectOf subjectOf) {
	...
	public NOSE(SupersededBy supersededBy) {
	...
	public void copy(PhysicalExam.Nose org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return PhysicalExam.Nose.class.getAnnotation(SampleValue.class).value();
	}
