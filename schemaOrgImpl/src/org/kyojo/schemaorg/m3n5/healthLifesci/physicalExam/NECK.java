...
public class NECK implements PhysicalExam.Neck {
	...
	public NECK(Long seq) {
		setSeq(seq);
	}

	public NECK(String string) {
	...
	public NECK(AdditionalType additionalType) {
	...
	public NECK(AlternateName alternateName) {
	...
	public NECK(BodyLocation bodyLocation) {
	...
	public NECK(Description description) {
	...
	public NECK(DisambiguatingDescription disambiguatingDescription) {
	...
	public NECK(Guideline guideline) {
	...
	public NECK(HowPerformed howPerformed) {
	...
	public NECK(Identifier identifier) {
	...
	public NECK(Indication indication) {
	...
	public NECK(LegalStatus legalStatus) {
	...
	public NECK(MainEntityOfPage mainEntityOfPage) {
	...
	public NECK(MedicineSystem medicineSystem) {
	...
	public NECK(NameFuzzy nameFuzzy) {
	...
	public NECK(PotentialAction potentialAction) {
	...
	public NECK(Preparation preparation) {
	...
	public NECK(ProcedureType procedureType) {
	...
	public NECK(RecognizingAuthority recognizingAuthority) {
	...
	public NECK(RelevantSpecialty relevantSpecialty) {
	...
	public NECK(SubjectOf subjectOf) {
	...
	public NECK(SupersededBy supersededBy) {
	...
	public void copy(PhysicalExam.Neck org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return PhysicalExam.Neck.class.getAnnotation(SampleValue.class).value();
	}
