...
public class COMPLETED implements MedicalStudyStatus.Completed {
	...
	public COMPLETED(Long seq) {
		setSeq(seq);
	}

	public COMPLETED(String string) {
	...
	public COMPLETED(AdditionalType additionalType) {
	...
	public COMPLETED(AlternateName alternateName) {
	...
	public COMPLETED(Description description) {
	...
	public COMPLETED(DisambiguatingDescription disambiguatingDescription) {
	...
	public COMPLETED(Identifier identifier) {
	...
	public COMPLETED(MainEntityOfPage mainEntityOfPage) {
	...
	public COMPLETED(NameFuzzy nameFuzzy) {
	...
	public COMPLETED(NameRuby nameRuby) {
	...
	public COMPLETED(PotentialAction potentialAction) {
	...
	public COMPLETED(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public COMPLETED(SubjectOf subjectOf) {
	...
	public COMPLETED(SupersededBy supersededBy) {
	...
	public void copy(MedicalStudyStatus.Completed org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalStudyStatus.Completed.class.getAnnotation(SampleValue.class).value();
	}
