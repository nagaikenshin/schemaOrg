...
public class RECRUITING implements MedicalStudyStatus.Recruiting {
	...
	public RECRUITING(Long seq) {
		setSeq(seq);
	}

	public RECRUITING(String string) {
	...
	public RECRUITING(AdditionalType additionalType) {
	...
	public RECRUITING(AlternateName alternateName) {
	...
	public RECRUITING(Description description) {
	...
	public RECRUITING(DisambiguatingDescription disambiguatingDescription) {
	...
	public RECRUITING(Identifier identifier) {
	...
	public RECRUITING(MainEntityOfPage mainEntityOfPage) {
	...
	public RECRUITING(NameFuzzy nameFuzzy) {
	...
	public RECRUITING(NameRuby nameRuby) {
	...
	public RECRUITING(PotentialAction potentialAction) {
	...
	public RECRUITING(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RECRUITING(SubjectOf subjectOf) {
	...
	public RECRUITING(SupersededBy supersededBy) {
	...
	public void copy(MedicalStudyStatus.Recruiting org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalStudyStatus.Recruiting.class.getAnnotation(SampleValue.class).value();
	}
