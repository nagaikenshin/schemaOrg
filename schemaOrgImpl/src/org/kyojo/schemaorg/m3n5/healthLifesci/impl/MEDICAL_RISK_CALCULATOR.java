...
public class MEDICAL_RISK_CALCULATOR implements Clazz.MedicalRiskCalculator {
	...
	public MEDICAL_RISK_CALCULATOR() {
	}

	public MEDICAL_RISK_CALCULATOR(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_RISK_CALCULATOR(String string) {
	...
	public MEDICAL_RISK_CALCULATOR(AdditionalType additionalType) {
	...
	public MEDICAL_RISK_CALCULATOR(AlternateName alternateName) {
	...
	public MEDICAL_RISK_CALCULATOR(Code code) {
		setCode(code);
	}
	...
	public MEDICAL_RISK_CALCULATOR(Description description) {
	...
	public MEDICAL_RISK_CALCULATOR(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_RISK_CALCULATOR(EstimatesRiskOf estimatesRiskOf) {
	...
	public MEDICAL_RISK_CALCULATOR(Guideline guideline) {
	...
	public MEDICAL_RISK_CALCULATOR(Identifier identifier) {
	...
	public MEDICAL_RISK_CALCULATOR(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_RISK_CALCULATOR(IncludedRiskFactor includedRiskFactor) {
	...
	public MEDICAL_RISK_CALCULATOR(LegalStatus legalStatus) {
	...
	public MEDICAL_RISK_CALCULATOR(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_RISK_CALCULATOR(MedicineSystem medicineSystem) {
	...
	public MEDICAL_RISK_CALCULATOR(Name name) {
		setName(name);
	}
	...
	public MEDICAL_RISK_CALCULATOR(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_RISK_CALCULATOR(NameRuby nameRuby) {
	...
	public MEDICAL_RISK_CALCULATOR(PotentialAction potentialAction) {
	...
	public MEDICAL_RISK_CALCULATOR(RecognizingAuthority recognizingAuthority) {
	...
	public MEDICAL_RISK_CALCULATOR(RelevantSpecialty relevantSpecialty) {
	...
	public MEDICAL_RISK_CALCULATOR(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_RISK_CALCULATOR(Study study) {
		setStudy(study);
	}
	...
	public MEDICAL_RISK_CALCULATOR(SubjectOf subjectOf) {
	...
	public MEDICAL_RISK_CALCULATOR(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.MedicalRiskCalculator org) {
		setSeq(org.getSeq());
