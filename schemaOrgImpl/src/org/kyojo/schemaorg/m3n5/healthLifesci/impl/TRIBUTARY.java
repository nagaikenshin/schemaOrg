...
public class TRIBUTARY implements Container.Tributary {
	...
	public TRIBUTARY(String string) {
	...
	public TRIBUTARY(AnatomicalStructure anatomicalStructure) {
		anatomicalStructureList = new ArrayList<AnatomicalStructure>();
	...
	public TRIBUTARY(Artery artery) {
	...
	public TRIBUTARY(BrainStructure brainStructure) {
	...
	public TRIBUTARY(Ligament ligament) {
	...
	public TRIBUTARY(LymphaticVessel lymphaticVessel) {
	...
	public TRIBUTARY(Muscle muscle) {
	...
	public TRIBUTARY(Vessel vessel) {
	...
	public TRIBUTARY(List<AnatomicalStructure> anatomicalStructureList,
	...
	public void copy(Container.Tributary org) {
