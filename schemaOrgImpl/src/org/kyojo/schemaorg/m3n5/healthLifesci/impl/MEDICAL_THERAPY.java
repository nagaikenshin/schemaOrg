...
public class MEDICAL_THERAPY implements Clazz.MedicalTherapy {
	...
	public MEDICAL_THERAPY() {
	}

	public MEDICAL_THERAPY(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_THERAPY(String string) {
	...
	public MEDICAL_THERAPY(AdditionalType additionalType) {
	...
	public MEDICAL_THERAPY(AdverseOutcome adverseOutcome) {
	...
	public MEDICAL_THERAPY(AlternateName alternateName) {
	...
	public MEDICAL_THERAPY(BodyLocation bodyLocation) {
	...
	public MEDICAL_THERAPY(Code code) {
		setCode(code);
	}
	...
	public MEDICAL_THERAPY(Contraindication contraindication) {
	...
	public MEDICAL_THERAPY(Description description) {
	...
	public MEDICAL_THERAPY(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_THERAPY(DoseSchedule doseSchedule) {
	...
	public MEDICAL_THERAPY(Drug drug) {
		setDrug(drug);
	}
	...
	public MEDICAL_THERAPY(DuplicateTherapy duplicateTherapy) {
	...
	public MEDICAL_THERAPY(Followup followup) {
	...
	public MEDICAL_THERAPY(Guideline guideline) {
	...
	public MEDICAL_THERAPY(HowPerformed howPerformed) {
	...
	public MEDICAL_THERAPY(Identifier identifier) {
	...
	public MEDICAL_THERAPY(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_THERAPY(Indication indication) {
	...
	public MEDICAL_THERAPY(LegalStatus legalStatus) {
	...
	public MEDICAL_THERAPY(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_THERAPY(MedicineSystem medicineSystem) {
	...
	public MEDICAL_THERAPY(Name name) {
		setName(name);
	}
	...
	public MEDICAL_THERAPY(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_THERAPY(NameRuby nameRuby) {
	...
	public MEDICAL_THERAPY(Outcome outcome) {
		setOutcome(outcome);
	}
	...
	public MEDICAL_THERAPY(PotentialAction potentialAction) {
	...
	public MEDICAL_THERAPY(Preparation preparation) {
	...
	public MEDICAL_THERAPY(ProcedureType procedureType) {
	...
	public MEDICAL_THERAPY(RecognizingAuthority recognizingAuthority) {
	...
	public MEDICAL_THERAPY(RelevantSpecialty relevantSpecialty) {
	...
	public MEDICAL_THERAPY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_THERAPY(SeriousAdverseOutcome seriousAdverseOutcome) {
	...
	public MEDICAL_THERAPY(Status status) {
		setStatus(status);
	}
	...
	public MEDICAL_THERAPY(Study study) {
		setStudy(study);
	}
	...
	public MEDICAL_THERAPY(SubjectOf subjectOf) {
	...
	public MEDICAL_THERAPY(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.MedicalTherapy org) {
		setSeq(org.getSeq());
