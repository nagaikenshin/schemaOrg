...
import org.kyojo.schemaorg.m3n5.healthLifesci.Container.AffectedBy;
...
public class IMAGING_TEST implements Clazz.ImagingTest {
	...
	public Image image;
	public ImagingTechnique imagingTechnique;
	...
	public IMAGING_TEST(Long seq) {
		setSeq(seq);
	}

	public IMAGING_TEST(String string) {
	...
	public IMAGING_TEST(AdditionalType additionalType) {
	...
	public IMAGING_TEST(AffectedBy affectedBy) {
	...
	public IMAGING_TEST(AlternateName alternateName) {
	...
	public IMAGING_TEST(Description description) {
	...
	public IMAGING_TEST(DisambiguatingDescription disambiguatingDescription) {
	...
	public IMAGING_TEST(Guideline guideline) {
	...
	public IMAGING_TEST(Identifier identifier) {
	...
	public IMAGING_TEST(Image image) {
		setImage(image);
	}
	...
	public IMAGING_TEST(ImagingTechnique imagingTechnique) {
		setImagingTechnique(imagingTechnique);
	}

	@Override
	public ImagingTechnique getImagingTechnique() {
		return imagingTechnique;
	}

	@Override
	public void setImagingTechnique(ImagingTechnique imagingTechnique) {
		this.imagingTechnique = imagingTechnique;
	}

	public IMAGING_TEST(LegalStatus legalStatus) {
	...
	public IMAGING_TEST(MainEntityOfPage mainEntityOfPage) {
	...
	public IMAGING_TEST(MedicineSystem medicineSystem) {
	...
	public IMAGING_TEST(NameFuzzy nameFuzzy) {
	...
	public IMAGING_TEST(NameRuby nameRuby) {
	...
	public IMAGING_TEST(NormalRange normalRange) {
	...
	public IMAGING_TEST(PotentialAction potentialAction) {
	...
	public IMAGING_TEST(RecognizingAuthority recognizingAuthority) {
	...
	public IMAGING_TEST(RelevantSpecialty relevantSpecialty) {
	...
	public IMAGING_TEST(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public IMAGING_TEST(SignDetected signDetected) {
	...
	public IMAGING_TEST(Study study) {
		setStudy(study);
	}
	...
	public IMAGING_TEST(SubjectOf subjectOf) {
	...
	public IMAGING_TEST(UsedToDiagnose usedToDiagnose) {
	...
	public IMAGING_TEST(UsesDevice usesDevice) {
	...
	public void copy(Clazz.ImagingTest org) {
		setSeq(org.getSeq());
		...
		setImagingTechnique(org.getImagingTechnique());
