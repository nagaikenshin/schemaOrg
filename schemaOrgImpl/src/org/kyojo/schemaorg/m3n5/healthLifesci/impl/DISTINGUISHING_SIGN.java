...
import org.kyojo.schemaorg.m3n5.healthLifesci.impl.MEDICAL_SIGN_OR_SYMPTOM;
...
public class DISTINGUISHING_SIGN implements Container.DistinguishingSign {
	...
	public DISTINGUISHING_SIGN(MedicalSign medicalSign) {
	...
	public DISTINGUISHING_SIGN(MedicalSymptom medicalSymptom) {
	...
	public DISTINGUISHING_SIGN(VitalSign vitalSign) {
	...
	public DISTINGUISHING_SIGN(List<MedicalSign> medicalSignList,
	...
	public void copy(Container.DistinguishingSign org) {
