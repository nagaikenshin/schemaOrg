...
public class DIAGNOSTIC_LAB implements Clazz.DiagnosticLab {
	...
	public AvailableTest availableTest;
	public Award award;
	public Brand brand;
	...
	public DIAGNOSTIC_LAB() {
	}

	public DIAGNOSTIC_LAB(Long seq) {
		setSeq(seq);
	}

	public DIAGNOSTIC_LAB(String string) {
	...
	public DIAGNOSTIC_LAB(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public DIAGNOSTIC_LAB(AdditionalType additionalType) {
	...
	public DIAGNOSTIC_LAB(Address address) {
		setAddress(address);
	}
	...
	public DIAGNOSTIC_LAB(AggregateRating aggregateRating) {
	...
	public DIAGNOSTIC_LAB(AlternateName alternateName) {
	...
	public DIAGNOSTIC_LAB(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public DIAGNOSTIC_LAB(AreaServed areaServed) {
	...
	public DIAGNOSTIC_LAB(AvailableTest availableTest) {
		setAvailableTest(availableTest);
	}
	...
	public DIAGNOSTIC_LAB(Award award) {
		setAward(award);
	}
	...
	public DIAGNOSTIC_LAB(Brand brand) {
		setBrand(brand);
	}
	...
	public DIAGNOSTIC_LAB(ContactPoint contactPoint) {
	...
	public DIAGNOSTIC_LAB(CorrectionsPolicy correctionsPolicy) {
	...
	public DIAGNOSTIC_LAB(Department department) {
	...
	public DIAGNOSTIC_LAB(Description description) {
	...
	public DIAGNOSTIC_LAB(DisambiguatingDescription disambiguatingDescription) {
	...
	public DIAGNOSTIC_LAB(DissolutionDate dissolutionDate) {
	...
	public DIAGNOSTIC_LAB(DiversityPolicy diversityPolicy) {
	...
	public DIAGNOSTIC_LAB(DiversityStaffingReport diversityStaffingReport) {
	...
	public DIAGNOSTIC_LAB(Duns duns) {
		setDuns(duns);
	}
	...
	public DIAGNOSTIC_LAB(Email email) {
		setEmail(email);
	}
	...
	public DIAGNOSTIC_LAB(Employee employee) {
	...
	public DIAGNOSTIC_LAB(EthicsPolicy ethicsPolicy) {
	...
	public DIAGNOSTIC_LAB(Event event) {
		setEvent(event);
	}
	...
	public DIAGNOSTIC_LAB(FaxNumber faxNumber) {
	...
	public DIAGNOSTIC_LAB(Founder founder) {
		setFounder(founder);
	}
	...
	public DIAGNOSTIC_LAB(FoundingDate foundingDate) {
	...
	public DIAGNOSTIC_LAB(FoundingLocation foundingLocation) {
	...
	public DIAGNOSTIC_LAB(Funder funder) {
		setFunder(funder);
	}
	...
	public DIAGNOSTIC_LAB(GlobalLocationNumber globalLocationNumber) {
	...
	public DIAGNOSTIC_LAB(HasOfferCatalog hasOfferCatalog) {
	...
	public DIAGNOSTIC_LAB(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public DIAGNOSTIC_LAB(HealthPlanNetworkId healthPlanNetworkId) {
	...
	public DIAGNOSTIC_LAB(Identifier identifier) {
	...
	public DIAGNOSTIC_LAB(Image image) {
		setImage(image);
	}
	...
	public DIAGNOSTIC_LAB(IsAcceptingNewPatients isAcceptingNewPatients) {
	...
	public DIAGNOSTIC_LAB(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public DIAGNOSTIC_LAB(KnowsAbout knowsAbout) {
	...
	public DIAGNOSTIC_LAB(KnowsLanguage knowsLanguage) {
	...
	public DIAGNOSTIC_LAB(LegalName legalName) {
	...
	public DIAGNOSTIC_LAB(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public DIAGNOSTIC_LAB(Location location) {
	...
	public DIAGNOSTIC_LAB(Logo logo) {
		setLogo(logo);
	}
	...
	public DIAGNOSTIC_LAB(MainEntityOfPage mainEntityOfPage) {
	...
	public DIAGNOSTIC_LAB(MakesOffer makesOffer) {
	...
	public DIAGNOSTIC_LAB(MedicalSpecialty medicalSpecialty) {
	...
	public DIAGNOSTIC_LAB(Member member) {
		setMember(member);
	}
	...
	public DIAGNOSTIC_LAB(MemberOf memberOf) {
	...
	public DIAGNOSTIC_LAB(Naics naics) {
		setNaics(naics);
	}
	...
	public DIAGNOSTIC_LAB(Name name) {
		setName(name);
	}
	...
	public DIAGNOSTIC_LAB(NameFuzzy nameFuzzy) {
	...
	public DIAGNOSTIC_LAB(NameRuby nameRuby) {
	...
	public DIAGNOSTIC_LAB(NumberOfEmployees numberOfEmployees) {
	...
	public DIAGNOSTIC_LAB(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public DIAGNOSTIC_LAB(Owns owns) {
		setOwns(owns);
	}
	...
	public DIAGNOSTIC_LAB(ParentOrganization parentOrganization) {
	...
	public DIAGNOSTIC_LAB(PotentialAction potentialAction) {
	...
	public DIAGNOSTIC_LAB(PublishingPrinciples publishingPrinciples) {
	...
	public DIAGNOSTIC_LAB(Review review) {
		setReview(review);
	}
	...
	public DIAGNOSTIC_LAB(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DIAGNOSTIC_LAB(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public DIAGNOSTIC_LAB(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public DIAGNOSTIC_LAB(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public DIAGNOSTIC_LAB(SubOrganization subOrganization) {
	...
	public DIAGNOSTIC_LAB(SubjectOf subjectOf) {
	...
	public DIAGNOSTIC_LAB(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public DIAGNOSTIC_LAB(Telephone telephone) {
	...
	public DIAGNOSTIC_LAB(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public DIAGNOSTIC_LAB(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.DiagnosticLab org) {
		setSeq(org.getSeq());
		...
		setAvailableTest(org.getAvailableTest());
