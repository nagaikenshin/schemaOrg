...
public class MEDICAL_INDICATION implements Clazz.MedicalIndication {
	...
	public MEDICAL_INDICATION() {
	}

	public MEDICAL_INDICATION(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_INDICATION(String string) {
	...
	public MEDICAL_INDICATION(AdditionalType additionalType) {
	...
	public MEDICAL_INDICATION(AlternateName alternateName) {
	...
	public MEDICAL_INDICATION(Code code) {
		setCode(code);
	}
	...
	public MEDICAL_INDICATION(Description description) {
	...
	public MEDICAL_INDICATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_INDICATION(Guideline guideline) {
	...
	public MEDICAL_INDICATION(Identifier identifier) {
	...
	public MEDICAL_INDICATION(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_INDICATION(LegalStatus legalStatus) {
	...
	public MEDICAL_INDICATION(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_INDICATION(MedicineSystem medicineSystem) {
	...
	public MEDICAL_INDICATION(Name name) {
		setName(name);
	}
	...
	public MEDICAL_INDICATION(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_INDICATION(NameRuby nameRuby) {
	...
	public MEDICAL_INDICATION(PotentialAction potentialAction) {
	...
	public MEDICAL_INDICATION(RecognizingAuthority recognizingAuthority) {
	...
	public MEDICAL_INDICATION(RelevantSpecialty relevantSpecialty) {
	...
	public MEDICAL_INDICATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_INDICATION(Study study) {
		setStudy(study);
	}
	...
	public MEDICAL_INDICATION(SubjectOf subjectOf) {
	...
	public MEDICAL_INDICATION(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.MedicalIndication org) {
		setSeq(org.getSeq());
