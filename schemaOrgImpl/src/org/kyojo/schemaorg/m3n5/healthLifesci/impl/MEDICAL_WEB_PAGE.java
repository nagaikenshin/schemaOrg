...
public class MEDICAL_WEB_PAGE implements Clazz.MedicalWebPage {
	...
	public MEDICAL_WEB_PAGE() {
	}

	public MEDICAL_WEB_PAGE(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_WEB_PAGE(String string) {
	...
	public MEDICAL_WEB_PAGE(About about) {
		setAbout(about);
	}
	...
	public MEDICAL_WEB_PAGE(AccessMode accessMode) {
	...
	public MEDICAL_WEB_PAGE(AccessModeSufficient accessModeSufficient) {
	...
	public MEDICAL_WEB_PAGE(AccessibilityAPI accessibilityAPI) {
	...
	public MEDICAL_WEB_PAGE(AccessibilityControl accessibilityControl) {
	...
	public MEDICAL_WEB_PAGE(AccessibilityFeature accessibilityFeature) {
	...
	public MEDICAL_WEB_PAGE(AccessibilityHazard accessibilityHazard) {
	...
	public MEDICAL_WEB_PAGE(AccessibilitySummary accessibilitySummary) {
	...
	public MEDICAL_WEB_PAGE(AccountablePerson accountablePerson) {
	...
	public MEDICAL_WEB_PAGE(AdditionalType additionalType) {
	...
	public MEDICAL_WEB_PAGE(AggregateRating aggregateRating) {
	...
	public MEDICAL_WEB_PAGE(AlternateName alternateName) {
	...
	public MEDICAL_WEB_PAGE(AlternativeHeadline alternativeHeadline) {
	...
	public MEDICAL_WEB_PAGE(AssociatedMedia associatedMedia) {
	...
	public MEDICAL_WEB_PAGE(Audience audience) {
	...
	public MEDICAL_WEB_PAGE(Audio audio) {
		setAudio(audio);
	}
	...
	public MEDICAL_WEB_PAGE(Author author) {
		setAuthor(author);
	}
	...
	public MEDICAL_WEB_PAGE(Award award) {
		setAward(award);
	}
	...
	public MEDICAL_WEB_PAGE(Breadcrumb breadcrumb) {
	...
	public MEDICAL_WEB_PAGE(Character character) {
	...
	public MEDICAL_WEB_PAGE(Citation citation) {
	...
	public MEDICAL_WEB_PAGE(Comment comment) {
		setComment(comment);
	}
	...
	public MEDICAL_WEB_PAGE(CommentCount commentCount) {
	...
	public MEDICAL_WEB_PAGE(ContentLocation contentLocation) {
	...
	public MEDICAL_WEB_PAGE(ContentRating contentRating) {
	...
	public MEDICAL_WEB_PAGE(ContentReferenceTime contentReferenceTime) {
	...
	public MEDICAL_WEB_PAGE(Contributor contributor) {
	...
	public MEDICAL_WEB_PAGE(CopyrightHolder copyrightHolder) {
	...
	public MEDICAL_WEB_PAGE(CopyrightYear copyrightYear) {
	...
	public MEDICAL_WEB_PAGE(Correction correction) {
	...
	public MEDICAL_WEB_PAGE(Creator creator) {
		setCreator(creator);
	}
	...
	public MEDICAL_WEB_PAGE(DateCreated dateCreated) {
	...
	public MEDICAL_WEB_PAGE(DateModified dateModified) {
	...
	public MEDICAL_WEB_PAGE(DatePublished datePublished) {
	...
	public MEDICAL_WEB_PAGE(Description description) {
	...
	public MEDICAL_WEB_PAGE(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_WEB_PAGE(DiscussionUrl discussionUrl) {
	...
	public MEDICAL_WEB_PAGE(Editor editor) {
		setEditor(editor);
	}
	...
	public MEDICAL_WEB_PAGE(EducationalAlignment educationalAlignment) {
	...
	public MEDICAL_WEB_PAGE(EducationalUse educationalUse) {
	...
	public MEDICAL_WEB_PAGE(Encoding encoding) {
	...
	public MEDICAL_WEB_PAGE(EncodingFormat encodingFormat) {
	...
	public MEDICAL_WEB_PAGE(ExampleOfWork exampleOfWork) {
	...
	public MEDICAL_WEB_PAGE(Expires expires) {
		setExpires(expires);
	}
	...
	public MEDICAL_WEB_PAGE(Funder funder) {
		setFunder(funder);
	}
	...
	public MEDICAL_WEB_PAGE(Genre genre) {
		setGenre(genre);
	}
	...
	public MEDICAL_WEB_PAGE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public MEDICAL_WEB_PAGE(Headline headline) {
	...
	public MEDICAL_WEB_PAGE(Identifier identifier) {
	...
	public MEDICAL_WEB_PAGE(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_WEB_PAGE(InLanguage inLanguage) {
	...
	public MEDICAL_WEB_PAGE(InteractionStatistic interactionStatistic) {
	...
	public MEDICAL_WEB_PAGE(InteractivityType interactivityType) {
	...
	public MEDICAL_WEB_PAGE(IsAccessibleForFree isAccessibleForFree) {
	...
	public MEDICAL_WEB_PAGE(IsBasedOn isBasedOn) {
	...
	public MEDICAL_WEB_PAGE(IsFamilyFriendly isFamilyFriendly) {
	...
	public MEDICAL_WEB_PAGE(IsPartOf isPartOf) {
	...
	public MEDICAL_WEB_PAGE(Keywords keywords) {
	...
	public MEDICAL_WEB_PAGE(LastReviewed lastReviewed) {
	...
	public MEDICAL_WEB_PAGE(LearningResourceType learningResourceType) {
	...
	public MEDICAL_WEB_PAGE(License license) {
		setLicense(license);
	}
	...
	public MEDICAL_WEB_PAGE(LocationCreated locationCreated) {
	...
	public MEDICAL_WEB_PAGE(MainContentOfPage mainContentOfPage) {
	...
	public MEDICAL_WEB_PAGE(MainEntity mainEntity) {
	...
	public MEDICAL_WEB_PAGE(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_WEB_PAGE(Material material) {
	...
	public MEDICAL_WEB_PAGE(MaterialExtent materialExtent) {
	...
	public MEDICAL_WEB_PAGE(Mentions mentions) {
	...
	public MEDICAL_WEB_PAGE(Name name) {
		setName(name);
	}
	...
	public MEDICAL_WEB_PAGE(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_WEB_PAGE(NameRuby nameRuby) {
	...
	public MEDICAL_WEB_PAGE(Offers offers) {
		setOffers(offers);
	}
	...
	public MEDICAL_WEB_PAGE(Position position) {
	...
	public MEDICAL_WEB_PAGE(PotentialAction potentialAction) {
	...
	public MEDICAL_WEB_PAGE(PrimaryImageOfPage primaryImageOfPage) {
	...
	public MEDICAL_WEB_PAGE(Producer producer) {
	...
	public MEDICAL_WEB_PAGE(Provider provider) {
	...
	public MEDICAL_WEB_PAGE(Publication publication) {
	...
	public MEDICAL_WEB_PAGE(Publisher publisher) {
	...
	public MEDICAL_WEB_PAGE(PublisherImprint publisherImprint) {
	...
	public MEDICAL_WEB_PAGE(PublishingPrinciples publishingPrinciples) {
	...
	public MEDICAL_WEB_PAGE(RecordedAt recordedAt) {
	...
	public MEDICAL_WEB_PAGE(RelatedLink relatedLink) {
	...
	public MEDICAL_WEB_PAGE(ReleasedEvent releasedEvent) {
	...
	public MEDICAL_WEB_PAGE(Review review) {
		setReview(review);
	}
	...
	public MEDICAL_WEB_PAGE(ReviewedBy reviewedBy) {
	...
	public MEDICAL_WEB_PAGE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_WEB_PAGE(SchemaVersion schemaVersion) {
	...
	public MEDICAL_WEB_PAGE(SdDatePublished sdDatePublished) {
	...
	public MEDICAL_WEB_PAGE(SdLicense sdLicense) {
	...
	public MEDICAL_WEB_PAGE(SdPublisher sdPublisher) {
	...
	public MEDICAL_WEB_PAGE(SignificantLink significantLink) {
	...
	public MEDICAL_WEB_PAGE(SourceOrganization sourceOrganization) {
	...
	public MEDICAL_WEB_PAGE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public MEDICAL_WEB_PAGE(SpatialCoverage spatialCoverage) {
	...
	public MEDICAL_WEB_PAGE(Speakable speakable) {
	...
	public MEDICAL_WEB_PAGE(Specialty specialty) {
	...
	public MEDICAL_WEB_PAGE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MEDICAL_WEB_PAGE(SubjectOf subjectOf) {
	...
	public MEDICAL_WEB_PAGE(Temporal temporal) {
	...
	public MEDICAL_WEB_PAGE(TemporalCoverage temporalCoverage) {
	...
	public MEDICAL_WEB_PAGE(Text text) {
		setText(text);
	}
	...
	public MEDICAL_WEB_PAGE(ThumbnailUrl thumbnailUrl) {
	...
	public MEDICAL_WEB_PAGE(TimeRequired timeRequired) {
	...
	public MEDICAL_WEB_PAGE(TranslationOfWork translationOfWork) {
	...
	public MEDICAL_WEB_PAGE(Translator translator) {
	...
	public MEDICAL_WEB_PAGE(TypicalAgeRange typicalAgeRange) {
	...
	public MEDICAL_WEB_PAGE(Url url) {
		setUrl(url);
	}
	...
	public MEDICAL_WEB_PAGE(Version version) {
		setVersion(version);
	}
	...
	public MEDICAL_WEB_PAGE(Video video) {
		setVideo(video);
	}
	...
	public MEDICAL_WEB_PAGE(WorkExample workExample) {
	...
	public MEDICAL_WEB_PAGE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.MedicalWebPage org) {
		setSeq(org.getSeq());
