...
public class AVAILABLE_IN implements Container.AvailableIn {
	...
	public AVAILABLE_IN(Country country) {
	...
	public AVAILABLE_IN(State state) {
	...
	public AVAILABLE_IN(List<AdministrativeArea> administrativeAreaList,
			List<City> cityList,
	...
	public void copy(Container.AvailableIn org) {
