...
public class ENDORSERS implements Container.Endorsers {
	...
	public ENDORSERS(AccountingService accountingService) {
	...
	public ENDORSERS(AdultEntertainment adultEntertainment) {
	...
	public ENDORSERS(Airline airline) {
	...
	public ENDORSERS(AmusementPark amusementPark) {
	...
	public ENDORSERS(AnimalShelter animalShelter) {
	...
	public ENDORSERS(ArchiveOrganization archiveOrganization) {
	...
	public ENDORSERS(ArtGallery artGallery) {
	...
	public ENDORSERS(Attorney attorney) {
	...
	public ENDORSERS(AutoBodyShop autoBodyShop) {
	...
	public ENDORSERS(AutoDealer autoDealer) {
	...
	public ENDORSERS(AutoPartsStore autoPartsStore) {
	...
	public ENDORSERS(AutoRental autoRental) {
	...
	public ENDORSERS(AutoRepair autoRepair) {
	...
	public ENDORSERS(AutoWash autoWash) {
	...
	public ENDORSERS(AutomatedTeller automatedTeller) {
	...
	public ENDORSERS(AutomotiveBusiness automotiveBusiness) {
	...
	public ENDORSERS(Bakery bakery) {
	...
	public ENDORSERS(BankOrCreditUnion bankOrCreditUnion) {
	...
	public ENDORSERS(BarOrPub barOrPub) {
	...
	public ENDORSERS(BeautySalon beautySalon) {
	...
	public ENDORSERS(BedAndBreakfast bedAndBreakfast) {
	...
	public ENDORSERS(BikeStore bikeStore) {
	...
	public ENDORSERS(BookStore bookStore) {
	...
	public ENDORSERS(BowlingAlley bowlingAlley) {
	...
	public ENDORSERS(Brewery brewery) {
	...
	public ENDORSERS(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public ENDORSERS(Campground campground) {
	...
	public ENDORSERS(Casino casino) {
	...
	public ENDORSERS(ChildCare childCare) {
	...
	public ENDORSERS(ClothingStore clothingStore) {
	...
	public ENDORSERS(CollegeOrUniversity collegeOrUniversity) {
	...
	public ENDORSERS(ComedyClub comedyClub) {
	...
	public ENDORSERS(CommunityHealth communityHealth) {
	...
	public ENDORSERS(ComputerStore computerStore) {
	...
	public ENDORSERS(Consortium consortium) {
	...
	public ENDORSERS(ConvenienceStore convenienceStore) {
	...
	public ENDORSERS(Corporation corporation) {
	...
	public ENDORSERS(DanceGroup danceGroup) {
	...
	public ENDORSERS(DaySpa daySpa) {
	...
	public ENDORSERS(Dentist dentist) {
	...
	public ENDORSERS(DepartmentStore departmentStore) {
	...
	public ENDORSERS(Dermatology dermatology) {
	...
	public ENDORSERS(DiagnosticLab diagnosticLab) {
	...
	public ENDORSERS(DietNutrition dietNutrition) {
	...
	public ENDORSERS(Distillery distillery) {
	...
	public ENDORSERS(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public ENDORSERS(EducationalOrganization educationalOrganization) {
	...
	public ENDORSERS(Electrician electrician) {
	...
	public ENDORSERS(ElectronicsStore electronicsStore) {
	...
	public ENDORSERS(ElementarySchool elementarySchool) {
	...
	public ENDORSERS(Emergency emergency) {
	...
	public ENDORSERS(EmergencyService emergencyService) {
	...
	public ENDORSERS(EmploymentAgency employmentAgency) {
	...
	public ENDORSERS(EntertainmentBusiness entertainmentBusiness) {
	...
	public ENDORSERS(ExerciseGym exerciseGym) {
	...
	public ENDORSERS(FastFoodRestaurant fastFoodRestaurant) {
	...
	public ENDORSERS(FinancialService financialService) {
	...
	public ENDORSERS(FireStation fireStation) {
	...
	public ENDORSERS(Florist florist) {
	...
	public ENDORSERS(FoodEstablishment foodEstablishment) {
	...
	public ENDORSERS(FundingAgency fundingAgency) {
	...
	public ENDORSERS(FundingScheme fundingScheme) {
	...
	public ENDORSERS(FurnitureStore furnitureStore) {
	...
	public ENDORSERS(GardenStore gardenStore) {
	...
	public ENDORSERS(GasStation gasStation) {
	...
	public ENDORSERS(GeneralContractor generalContractor) {
	...
	public ENDORSERS(Geriatric geriatric) {
	...
	public ENDORSERS(GolfCourse golfCourse) {
	...
	public ENDORSERS(GovernmentOffice governmentOffice) {
	...
	public ENDORSERS(GovernmentOrganization governmentOrganization) {
	...
	public ENDORSERS(GroceryStore groceryStore) {
	...
	public ENDORSERS(Gynecologic gynecologic) {
	...
	public ENDORSERS(HVACBusiness hvacBusiness) {
	...
	public ENDORSERS(HairSalon hairSalon) {
	...
	public ENDORSERS(HardwareStore hardwareStore) {
	...
	public ENDORSERS(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public ENDORSERS(HealthClub healthClub) {
	...
	public ENDORSERS(HighSchool highSchool) {
	...
	public ENDORSERS(HobbyShop hobbyShop) {
	...
	public ENDORSERS(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public ENDORSERS(HomeGoodsStore homeGoodsStore) {
	...
	public ENDORSERS(Hospital hospital) {
	...
	public ENDORSERS(Hostel hostel) {
	...
	public ENDORSERS(HousePainter housePainter) {
	...
	public ENDORSERS(IceCreamShop iceCreamShop) {
	...
	public ENDORSERS(InsuranceAgency insuranceAgency) {
	...
	public ENDORSERS(InternetCafe internetCafe) {
	...
	public ENDORSERS(JewelryStore jewelryStore) {
	...
	public ENDORSERS(LegalService legalService) {
	...
	public ENDORSERS(Library library) {
	...
	public ENDORSERS(LibrarySystem librarySystem) {
	...
	public ENDORSERS(LiquorStore liquorStore) {
	...
	public ENDORSERS(LocalBusiness localBusiness) {
	...
	public ENDORSERS(Locksmith locksmith) {
	...
	public ENDORSERS(LodgingBusiness lodgingBusiness) {
	...
	public ENDORSERS(MedicalBusiness medicalBusiness) {
	...
	public ENDORSERS(MedicalClinic medicalClinic) {
	...
	public ENDORSERS(MedicalOrganization medicalOrganization) {
	...
	public ENDORSERS(MensClothingStore mensClothingStore) {
	...
	public ENDORSERS(MiddleSchool middleSchool) {
	...
	public ENDORSERS(Midwifery midwifery) {
	...
	public ENDORSERS(MobilePhoneStore mobilePhoneStore) {
	...
	public ENDORSERS(MotorcycleDealer motorcycleDealer) {
	...
	public ENDORSERS(MotorcycleRepair motorcycleRepair) {
	...
	public ENDORSERS(MovieRentalStore movieRentalStore) {
	...
	public ENDORSERS(MovieTheater movieTheater) {
	...
	public ENDORSERS(MovingCompany movingCompany) {
	...
	public ENDORSERS(MusicGroup musicGroup) {
	...
	public ENDORSERS(MusicStore musicStore) {
	...
	public ENDORSERS(NailSalon nailSalon) {
	...
	public ENDORSERS(NewsMediaOrganization newsMediaOrganization) {
	...
	public ENDORSERS(NightClub nightClub) {
	...
	public ENDORSERS(Notary notary) {
	...
	public ENDORSERS(Nursing nursing) {
	...
	public ENDORSERS(Obstetric obstetric) {
	...
	public ENDORSERS(OfficeEquipmentStore officeEquipmentStore) {
	...
	public ENDORSERS(Oncologic oncologic) {
	...
	public ENDORSERS(Optician optician) {
	...
	public ENDORSERS(Optometric optometric) {
	...
	public ENDORSERS(Otolaryngologic otolaryngologic) {
	...
	public ENDORSERS(OutletStore outletStore) {
	...
	public ENDORSERS(Patient patient) {
	...
	public ENDORSERS(PawnShop pawnShop) {
	...
	public ENDORSERS(Pediatric pediatric) {
	...
	public ENDORSERS(PerformingGroup performingGroup) {
	...
	public ENDORSERS(PetStore petStore) {
	...
	public ENDORSERS(Pharmacy pharmacy) {
	...
	public ENDORSERS(Physician physician) {
	...
	public ENDORSERS(Physiotherapy physiotherapy) {
	...
	public ENDORSERS(PlasticSurgery plasticSurgery) {
	...
	public ENDORSERS(Plumber plumber) {
	...
	public ENDORSERS(Podiatric podiatric) {
	...
	public ENDORSERS(PoliceStation policeStation) {
	...
	public ENDORSERS(PostOffice postOffice) {
	...
	public ENDORSERS(Preschool preschool) {
	...
	public ENDORSERS(PrimaryCare primaryCare) {
	...
	public ENDORSERS(ProfessionalService professionalService) {
	...
	public ENDORSERS(Project project) {
	...
	public ENDORSERS(Psychiatric psychiatric) {
	...
	public ENDORSERS(PublicHealth publicHealth) {
	...
	public ENDORSERS(PublicSwimmingPool publicSwimmingPool) {
	...
	public ENDORSERS(RadioStation radioStation) {
	...
	public ENDORSERS(RealEstateAgent realEstateAgent) {
	...
	public ENDORSERS(RecyclingCenter recyclingCenter) {
	...
	public ENDORSERS(ResearchProject researchProject) {
	...
	public ENDORSERS(Resort resort) {
	...
	public ENDORSERS(Restaurant restaurant) {
	...
	public ENDORSERS(RoofingContractor roofingContractor) {
	...
	public ENDORSERS(School school) {
	...
	public ENDORSERS(SelfStorage selfStorage) {
	...
	public ENDORSERS(ShoeStore shoeStore) {
	...
	public ENDORSERS(ShoppingCenter shoppingCenter) {
	...
	public ENDORSERS(SkiResort skiResort) {
	...
	public ENDORSERS(SportingGoodsStore sportingGoodsStore) {
	...
	public ENDORSERS(SportsActivityLocation sportsActivityLocation) {
	...
	public ENDORSERS(SportsClub sportsClub) {
	...
	public ENDORSERS(SportsOrganization sportsOrganization) {
	...
	public ENDORSERS(SportsTeam sportsTeam) {
	...
	public ENDORSERS(StadiumOrArena stadiumOrArena) {
	...
	public ENDORSERS(TattooParlor tattooParlor) {
	...
	public ENDORSERS(TelevisionStation televisionStation) {
	...
	public ENDORSERS(TennisComplex tennisComplex) {
	...
	public ENDORSERS(TheaterGroup theaterGroup) {
	...
	public ENDORSERS(TireShop tireShop) {
	...
	public ENDORSERS(TouristInformationCenter touristInformationCenter) {
	...
	public ENDORSERS(ToyStore toyStore) {
	...
	public ENDORSERS(TravelAgency travelAgency) {
	...
	public ENDORSERS(VeterinaryCare veterinaryCare) {
	...
	public ENDORSERS(WholesaleStore wholesaleStore) {
	...
	public ENDORSERS(Winery winery) {
	...
	public ENDORSERS(WorkersUnion workersUnion) {
