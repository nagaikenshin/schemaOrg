...
public class VETERINARY_CARE implements Clazz.VeterinaryCare {
	...
	public VETERINARY_CARE() {
	}

	public VETERINARY_CARE(Long seq) {
		setSeq(seq);
	}

	public VETERINARY_CARE(String string) {
	...
	public VETERINARY_CARE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public VETERINARY_CARE(AdditionalType additionalType) {
	...
	public VETERINARY_CARE(Address address) {
		setAddress(address);
	}
	...
	public VETERINARY_CARE(AggregateRating aggregateRating) {
	...
	public VETERINARY_CARE(AlternateName alternateName) {
	...
	public VETERINARY_CARE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public VETERINARY_CARE(AreaServed areaServed) {
	...
	public VETERINARY_CARE(Award award) {
		setAward(award);
	}
	...
	public VETERINARY_CARE(Brand brand) {
		setBrand(brand);
	}
	...
	public VETERINARY_CARE(ContactPoint contactPoint) {
	...
	public VETERINARY_CARE(CorrectionsPolicy correctionsPolicy) {
	...
	public VETERINARY_CARE(Department department) {
	...
	public VETERINARY_CARE(Description description) {
	...
	public VETERINARY_CARE(DisambiguatingDescription disambiguatingDescription) {
	...
	public VETERINARY_CARE(DissolutionDate dissolutionDate) {
	...
	public VETERINARY_CARE(DiversityPolicy diversityPolicy) {
	...
	public VETERINARY_CARE(DiversityStaffingReport diversityStaffingReport) {
	...
	public VETERINARY_CARE(Duns duns) {
		setDuns(duns);
	}
	...
	public VETERINARY_CARE(Email email) {
		setEmail(email);
	}
	...
	public VETERINARY_CARE(Employee employee) {
	...
	public VETERINARY_CARE(EthicsPolicy ethicsPolicy) {
	...
	public VETERINARY_CARE(Event event) {
		setEvent(event);
	}
	...
	public VETERINARY_CARE(FaxNumber faxNumber) {
	...
	public VETERINARY_CARE(Founder founder) {
		setFounder(founder);
	}
	...
	public VETERINARY_CARE(FoundingDate foundingDate) {
	...
	public VETERINARY_CARE(FoundingLocation foundingLocation) {
	...
	public VETERINARY_CARE(Funder funder) {
		setFunder(funder);
	}
	...
	public VETERINARY_CARE(GlobalLocationNumber globalLocationNumber) {
	...
	public VETERINARY_CARE(HasOfferCatalog hasOfferCatalog) {
	...
	public VETERINARY_CARE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public VETERINARY_CARE(HealthPlanNetworkId healthPlanNetworkId) {
	...
	public VETERINARY_CARE(Identifier identifier) {
	...
	public VETERINARY_CARE(Image image) {
		setImage(image);
	}
	...
	public VETERINARY_CARE(IsAcceptingNewPatients isAcceptingNewPatients) {
	...
	public VETERINARY_CARE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public VETERINARY_CARE(KnowsAbout knowsAbout) {
	...
	public VETERINARY_CARE(KnowsLanguage knowsLanguage) {
	...
	public VETERINARY_CARE(LegalName legalName) {
	...
	public VETERINARY_CARE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public VETERINARY_CARE(Location location) {
	...
	public VETERINARY_CARE(Logo logo) {
		setLogo(logo);
	}
	...
	public VETERINARY_CARE(MainEntityOfPage mainEntityOfPage) {
	...
	public VETERINARY_CARE(MakesOffer makesOffer) {
	...
	public VETERINARY_CARE(MedicalSpecialty medicalSpecialty) {
	...
	public VETERINARY_CARE(Member member) {
		setMember(member);
	}
	...
	public VETERINARY_CARE(MemberOf memberOf) {
	...
	public VETERINARY_CARE(Naics naics) {
		setNaics(naics);
	}
	...
	public VETERINARY_CARE(Name name) {
		setName(name);
	}
	...
	public VETERINARY_CARE(NameFuzzy nameFuzzy) {
	...
	public VETERINARY_CARE(NameRuby nameRuby) {
	...
	public VETERINARY_CARE(NumberOfEmployees numberOfEmployees) {
	...
	public VETERINARY_CARE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public VETERINARY_CARE(Owns owns) {
		setOwns(owns);
	}
	...
	public VETERINARY_CARE(ParentOrganization parentOrganization) {
	...
	public VETERINARY_CARE(PotentialAction potentialAction) {
	...
	public VETERINARY_CARE(PublishingPrinciples publishingPrinciples) {
	...
	public VETERINARY_CARE(Review review) {
		setReview(review);
	}
	...
	public VETERINARY_CARE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public VETERINARY_CARE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public VETERINARY_CARE(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public VETERINARY_CARE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public VETERINARY_CARE(SubOrganization subOrganization) {
	...
	public VETERINARY_CARE(SubjectOf subjectOf) {
	...
	public VETERINARY_CARE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public VETERINARY_CARE(Telephone telephone) {
	...
	public VETERINARY_CARE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public VETERINARY_CARE(Url url) {
		setUrl(url);
	}
	...
	public VETERINARY_CARE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.VeterinaryCare org) {
		setSeq(org.getSeq());
