...
public class MAXIMUM_DOSE_SCHEDULE implements Clazz.MaximumDoseSchedule {
	...
	public MAXIMUM_DOSE_SCHEDULE() {
	}

	public MAXIMUM_DOSE_SCHEDULE(Long seq) {
		setSeq(seq);
	}

	public MAXIMUM_DOSE_SCHEDULE(String string) {
	...
	public MAXIMUM_DOSE_SCHEDULE(AdditionalType additionalType) {
	...
	public MAXIMUM_DOSE_SCHEDULE(AlternateName alternateName) {
	...
	public MAXIMUM_DOSE_SCHEDULE(Code code) {
		setCode(code);
	}
	...
	public MAXIMUM_DOSE_SCHEDULE(Description description) {
	...
	public MAXIMUM_DOSE_SCHEDULE(DisambiguatingDescription disambiguatingDescription) {
	...
	public MAXIMUM_DOSE_SCHEDULE(DoseUnit doseUnit) {
	...
	public MAXIMUM_DOSE_SCHEDULE(DoseValue doseValue) {
	...
	public MAXIMUM_DOSE_SCHEDULE(Frequency frequency) {
	...
	public MAXIMUM_DOSE_SCHEDULE(Guideline guideline) {
	...
	public MAXIMUM_DOSE_SCHEDULE(Identifier identifier) {
	...
	public MAXIMUM_DOSE_SCHEDULE(Image image) {
		setImage(image);
	}
	...
	public MAXIMUM_DOSE_SCHEDULE(LegalStatus legalStatus) {
	...
	public MAXIMUM_DOSE_SCHEDULE(MainEntityOfPage mainEntityOfPage) {
	...
	public MAXIMUM_DOSE_SCHEDULE(MedicineSystem medicineSystem) {
	...
	public MAXIMUM_DOSE_SCHEDULE(Name name) {
		setName(name);
	}
	...
	public MAXIMUM_DOSE_SCHEDULE(NameFuzzy nameFuzzy) {
	...
	public MAXIMUM_DOSE_SCHEDULE(NameRuby nameRuby) {
	...
	public MAXIMUM_DOSE_SCHEDULE(PotentialAction potentialAction) {
	...
	public MAXIMUM_DOSE_SCHEDULE(RecognizingAuthority recognizingAuthority) {
	...
	public MAXIMUM_DOSE_SCHEDULE(RelevantSpecialty relevantSpecialty) {
	...
	public MAXIMUM_DOSE_SCHEDULE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MAXIMUM_DOSE_SCHEDULE(Study study) {
		setStudy(study);
	}
	...
	public MAXIMUM_DOSE_SCHEDULE(SubjectOf subjectOf) {
	...
	public MAXIMUM_DOSE_SCHEDULE(TargetPopulation targetPopulation) {
	...
	public MAXIMUM_DOSE_SCHEDULE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.MaximumDoseSchedule org) {
		setSeq(org.getSeq());
