...
public class MEDICAL_CONTRAINDICATION implements Clazz.MedicalContraindication {
	...
	public MEDICAL_CONTRAINDICATION() {
	}

	public MEDICAL_CONTRAINDICATION(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_CONTRAINDICATION(String string) {
	...
	public MEDICAL_CONTRAINDICATION(AdditionalType additionalType) {
	...
	public MEDICAL_CONTRAINDICATION(AlternateName alternateName) {
	...
	public MEDICAL_CONTRAINDICATION(Code code) {
		setCode(code);
	}
	...
	public MEDICAL_CONTRAINDICATION(Description description) {
	...
	public MEDICAL_CONTRAINDICATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_CONTRAINDICATION(Guideline guideline) {
	...
	public MEDICAL_CONTRAINDICATION(Identifier identifier) {
	...
	public MEDICAL_CONTRAINDICATION(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_CONTRAINDICATION(LegalStatus legalStatus) {
	...
	public MEDICAL_CONTRAINDICATION(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_CONTRAINDICATION(MedicineSystem medicineSystem) {
	...
	public MEDICAL_CONTRAINDICATION(Name name) {
		setName(name);
	}
	...
	public MEDICAL_CONTRAINDICATION(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_CONTRAINDICATION(NameRuby nameRuby) {
	...
	public MEDICAL_CONTRAINDICATION(PotentialAction potentialAction) {
	...
	public MEDICAL_CONTRAINDICATION(RecognizingAuthority recognizingAuthority) {
	...
	public MEDICAL_CONTRAINDICATION(RelevantSpecialty relevantSpecialty) {
	...
	public MEDICAL_CONTRAINDICATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_CONTRAINDICATION(Study study) {
		setStudy(study);
	}
	...
	public MEDICAL_CONTRAINDICATION(SubjectOf subjectOf) {
	...
	public MEDICAL_CONTRAINDICATION(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.MedicalContraindication org) {
		setSeq(org.getSeq());
