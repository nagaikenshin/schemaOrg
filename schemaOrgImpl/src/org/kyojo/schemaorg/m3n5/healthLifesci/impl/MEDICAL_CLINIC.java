...
public class MEDICAL_CLINIC implements Clazz.MedicalClinic {
	...
	public MEDICAL_CLINIC(GeoContains geoContains) {
	...
	public MEDICAL_CLINIC(GeoCoveredBy geoCoveredBy) {
	...
	public MEDICAL_CLINIC(GeoCovers geoCovers) {
	...
	public MEDICAL_CLINIC(GeoCrosses geoCrosses) {
	...
	public MEDICAL_CLINIC(GeoDisjoint geoDisjoint) {
	...
	public MEDICAL_CLINIC(GeoEquals geoEquals) {
	...
	public MEDICAL_CLINIC(GeoIntersects geoIntersects) {
	...
	public MEDICAL_CLINIC(GeoOverlaps geoOverlaps) {
	...
	public MEDICAL_CLINIC(GeoTouches geoTouches) {
	...
	public MEDICAL_CLINIC(GeoWithin geoWithin) {
	...
	public MEDICAL_CLINIC(Slogan slogan) {
		setSlogan(slogan);
	}
