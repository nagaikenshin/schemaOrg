...
public class SENSORY_UNIT implements Container.SensoryUnit {
	...
	public SENSORY_UNIT(Artery artery) {
	...
	public SENSORY_UNIT(BrainStructure brainStructure) {
	...
	public SENSORY_UNIT(Joint joint) {
	...
	public SENSORY_UNIT(Ligament ligament) {
	...
	public SENSORY_UNIT(LymphaticVessel lymphaticVessel) {
	...
	public SENSORY_UNIT(Muscle muscle) {
	...
	public SENSORY_UNIT(Nerve nerve) {
	...
	public SENSORY_UNIT(Vessel vessel) {
