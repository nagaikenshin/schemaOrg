...
public class STRENGTH_VALUE implements Container.StrengthValue {
	...
	public STRENGTH_VALUE(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public STRENGTH_VALUE(Float fl0at) {
	...
	public STRENGTH_VALUE(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public STRENGTH_VALUE(Integer integer) {
	...
	public STRENGTH_VALUE(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public STRENGTH_VALUE(Number number) {
	...
	public STRENGTH_VALUE(List<Float> fl0atList,
	...
	public void copy(Container.StrengthValue org) {
