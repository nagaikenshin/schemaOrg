...
public class MEDICAL_SCHOLARLY_ARTICLE implements Clazz.MedicalScholarlyArticle {
	...
	public MEDICAL_SCHOLARLY_ARTICLE() {
	}

	public MEDICAL_SCHOLARLY_ARTICLE(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_SCHOLARLY_ARTICLE(String string) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(About about) {
		setAbout(about);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(AccessMode accessMode) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(AccessModeSufficient accessModeSufficient) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(AccessibilityAPI accessibilityAPI) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(AccessibilityControl accessibilityControl) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(AccessibilityFeature accessibilityFeature) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(AccessibilityHazard accessibilityHazard) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(AccessibilitySummary accessibilitySummary) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(AccountablePerson accountablePerson) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(AdditionalType additionalType) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(AggregateRating aggregateRating) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(AlternateName alternateName) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(AlternativeHeadline alternativeHeadline) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(ArticleBody articleBody) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(ArticleSection articleSection) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(AssociatedMedia associatedMedia) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Audience audience) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Audio audio) {
		setAudio(audio);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Author author) {
		setAuthor(author);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Award award) {
		setAward(award);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Backstory backstory) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Character character) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Citation citation) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Comment comment) {
		setComment(comment);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(CommentCount commentCount) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(ContentLocation contentLocation) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(ContentRating contentRating) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(ContentReferenceTime contentReferenceTime) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Contributor contributor) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(CopyrightHolder copyrightHolder) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(CopyrightYear copyrightYear) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Correction correction) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Creator creator) {
		setCreator(creator);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(DateCreated dateCreated) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(DateModified dateModified) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(DatePublished datePublished) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Description description) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(DiscussionUrl discussionUrl) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Editor editor) {
		setEditor(editor);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(EducationalAlignment educationalAlignment) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(EducationalUse educationalUse) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Encoding encoding) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(EncodingFormat encodingFormat) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(ExampleOfWork exampleOfWork) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Expires expires) {
		setExpires(expires);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Funder funder) {
		setFunder(funder);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Genre genre) {
		setGenre(genre);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Headline headline) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Identifier identifier) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(InLanguage inLanguage) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(InteractionStatistic interactionStatistic) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(InteractivityType interactivityType) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(IsAccessibleForFree isAccessibleForFree) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(IsBasedOn isBasedOn) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(IsFamilyFriendly isFamilyFriendly) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(IsPartOf isPartOf) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Keywords keywords) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(LearningResourceType learningResourceType) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(License license) {
		setLicense(license);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(LocationCreated locationCreated) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(MainEntity mainEntity) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Material material) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(MaterialExtent materialExtent) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Mentions mentions) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Name name) {
		setName(name);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(NameRuby nameRuby) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Offers offers) {
		setOffers(offers);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(PageEnd pageEnd) {
		setPageEnd(pageEnd);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(PageStart pageStart) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Pagination pagination) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Position position) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(PotentialAction potentialAction) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Producer producer) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Provider provider) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Publication publication) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(PublicationType publicationType) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Publisher publisher) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(PublisherImprint publisherImprint) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(PublishingPrinciples publishingPrinciples) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(RecordedAt recordedAt) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(ReleasedEvent releasedEvent) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Review review) {
		setReview(review);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(SchemaVersion schemaVersion) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(SdDatePublished sdDatePublished) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(SdLicense sdLicense) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(SdPublisher sdPublisher) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(SourceOrganization sourceOrganization) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(SpatialCoverage spatialCoverage) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Speakable speakable) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(SubjectOf subjectOf) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Temporal temporal) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(TemporalCoverage temporalCoverage) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Text text) {
		setText(text);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(ThumbnailUrl thumbnailUrl) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(TimeRequired timeRequired) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(TranslationOfWork translationOfWork) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Translator translator) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(TypicalAgeRange typicalAgeRange) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Url url) {
		setUrl(url);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Version version) {
		setVersion(version);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(Video video) {
		setVideo(video);
	}
	...
	public MEDICAL_SCHOLARLY_ARTICLE(WordCount wordCount) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(WorkExample workExample) {
	...
	public MEDICAL_SCHOLARLY_ARTICLE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.MedicalScholarlyArticle org) {
		setSeq(org.getSeq());
		...
		setPublicationType(org.getPublicationType());
