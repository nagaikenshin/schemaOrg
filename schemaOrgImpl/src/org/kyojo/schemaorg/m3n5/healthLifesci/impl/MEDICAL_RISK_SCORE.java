...
import org.kyojo.schemaorg.m3n5.healthLifesci.Container.Algorithm;
...
import org.kyojo.schemaorg.m3n5.healthLifesci.Container.IncludedRiskFactor;
...
public class MEDICAL_RISK_SCORE implements Clazz.MedicalRiskScore {
	...
	public EstimatesRiskOf estimatesRiskOf;
	public Guideline guideline;
	public Identifier identifier;
	public Image image;
	public IncludedRiskFactor includedRiskFactor;
	...
	public MEDICAL_RISK_SCORE() {
	}

	public MEDICAL_RISK_SCORE(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_RISK_SCORE(String string) {
	...
	public MEDICAL_RISK_SCORE(AdditionalType additionalType) {
	...
	public MEDICAL_RISK_SCORE(Algorithm algorithm) {
	...
	public MEDICAL_RISK_SCORE(AlternateName alternateName) {
	...
	public MEDICAL_RISK_SCORE(Code code) {
		setCode(code);
	}
	...
	public MEDICAL_RISK_SCORE(Description description) {
	...
	public MEDICAL_RISK_SCORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_RISK_SCORE(EstimatesRiskOf estimatesRiskOf) {
		setEstimatesRiskOf(estimatesRiskOf);
	}

	@Override
	public EstimatesRiskOf getEstimatesRiskOf() {
		return estimatesRiskOf;
	}

	@Override
	public void setEstimatesRiskOf(EstimatesRiskOf estimatesRiskOf) {
		this.estimatesRiskOf = estimatesRiskOf;
	}

	public MEDICAL_RISK_SCORE(Guideline guideline) {
	...
	public MEDICAL_RISK_SCORE(Identifier identifier) {
	...
	public MEDICAL_RISK_SCORE(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_RISK_SCORE(IncludedRiskFactor includedRiskFactor) {
		setIncludedRiskFactor(includedRiskFactor);
	}

	@Override
	public IncludedRiskFactor getIncludedRiskFactor() {
		return includedRiskFactor;
	}

	@Override
	public void setIncludedRiskFactor(IncludedRiskFactor includedRiskFactor) {
		this.includedRiskFactor = includedRiskFactor;
	}

	public MEDICAL_RISK_SCORE(LegalStatus legalStatus) {
	...
	public MEDICAL_RISK_SCORE(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_RISK_SCORE(MedicineSystem medicineSystem) {
	...
	public MEDICAL_RISK_SCORE(Name name) {
		setName(name);
	}
	...
	public MEDICAL_RISK_SCORE(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_RISK_SCORE(NameRuby nameRuby) {
	...
	public MEDICAL_RISK_SCORE(PotentialAction potentialAction) {
	...
	public MEDICAL_RISK_SCORE(RecognizingAuthority recognizingAuthority) {
	...
	public MEDICAL_RISK_SCORE(RelevantSpecialty relevantSpecialty) {
	...
	public MEDICAL_RISK_SCORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_RISK_SCORE(Study study) {
		setStudy(study);
	}
	...
	public MEDICAL_RISK_SCORE(SubjectOf subjectOf) {
	...
	public MEDICAL_RISK_SCORE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.MedicalRiskScore org) {
		setSeq(org.getSeq());
		...
		setAlgorithm(org.getAlgorithm());
		setAlternateName(org.getAlternateName());
		setCode(org.getCode());
		setDescription(org.getDescription());
		setDisambiguatingDescription(org.getDisambiguatingDescription());
		setEstimatesRiskOf(org.getEstimatesRiskOf());
		setGuideline(org.getGuideline());
		setIdentifier(org.getIdentifier());
		setImage(org.getImage());
		setIncludedRiskFactor(org.getIncludedRiskFactor());
