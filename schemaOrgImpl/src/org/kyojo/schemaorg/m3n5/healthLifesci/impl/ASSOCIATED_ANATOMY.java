...
public class ASSOCIATED_ANATOMY implements Container.AssociatedAnatomy {
	...
	public ASSOCIATED_ANATOMY(Artery artery) {
	...
	public ASSOCIATED_ANATOMY(Bone bone) {
	...
	public ASSOCIATED_ANATOMY(BrainStructure brainStructure) {
	...
	public ASSOCIATED_ANATOMY(Joint joint) {
	...
	public ASSOCIATED_ANATOMY(Ligament ligament) {
	...
	public ASSOCIATED_ANATOMY(LymphaticVessel lymphaticVessel) {
	...
	public ASSOCIATED_ANATOMY(Muscle muscle) {
	...
	public ASSOCIATED_ANATOMY(Nerve nerve) {
	...
	public ASSOCIATED_ANATOMY(Vein vein) {
	...
	public ASSOCIATED_ANATOMY(Vessel vessel) {
