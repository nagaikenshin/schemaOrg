...
public class DIAGNOSTIC_PROCEDURE implements Clazz.DiagnosticProcedure {
	...
	public DIAGNOSTIC_PROCEDURE() {
	}

	public DIAGNOSTIC_PROCEDURE(Long seq) {
		setSeq(seq);
	}

	public DIAGNOSTIC_PROCEDURE(String string) {
	...
	public DIAGNOSTIC_PROCEDURE(AdditionalType additionalType) {
	...
	public DIAGNOSTIC_PROCEDURE(AlternateName alternateName) {
	...
	public DIAGNOSTIC_PROCEDURE(BodyLocation bodyLocation) {
	...
	public DIAGNOSTIC_PROCEDURE(Code code) {
		setCode(code);
	}
	...
	public DIAGNOSTIC_PROCEDURE(Description description) {
	...
	public DIAGNOSTIC_PROCEDURE(DisambiguatingDescription disambiguatingDescription) {
	...
	public DIAGNOSTIC_PROCEDURE(Followup followup) {
	...
	public DIAGNOSTIC_PROCEDURE(Guideline guideline) {
	...
	public DIAGNOSTIC_PROCEDURE(HowPerformed howPerformed) {
	...
	public DIAGNOSTIC_PROCEDURE(Identifier identifier) {
	...
	public DIAGNOSTIC_PROCEDURE(Image image) {
		setImage(image);
	}
	...
	public DIAGNOSTIC_PROCEDURE(Indication indication) {
	...
	public DIAGNOSTIC_PROCEDURE(LegalStatus legalStatus) {
	...
	public DIAGNOSTIC_PROCEDURE(MainEntityOfPage mainEntityOfPage) {
	...
	public DIAGNOSTIC_PROCEDURE(MedicineSystem medicineSystem) {
	...
	public DIAGNOSTIC_PROCEDURE(Name name) {
		setName(name);
	}
	...
	public DIAGNOSTIC_PROCEDURE(NameFuzzy nameFuzzy) {
	...
	public DIAGNOSTIC_PROCEDURE(NameRuby nameRuby) {
	...
	public DIAGNOSTIC_PROCEDURE(Outcome outcome) {
		setOutcome(outcome);
	}
	...
	public DIAGNOSTIC_PROCEDURE(PotentialAction potentialAction) {
	...
	public DIAGNOSTIC_PROCEDURE(Preparation preparation) {
	...
	public DIAGNOSTIC_PROCEDURE(ProcedureType procedureType) {
	...
	public DIAGNOSTIC_PROCEDURE(RecognizingAuthority recognizingAuthority) {
	...
	public DIAGNOSTIC_PROCEDURE(RelevantSpecialty relevantSpecialty) {
	...
	public DIAGNOSTIC_PROCEDURE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DIAGNOSTIC_PROCEDURE(Status status) {
		setStatus(status);
	}
	...
	public DIAGNOSTIC_PROCEDURE(Study study) {
		setStudy(study);
	}
	...
	public DIAGNOSTIC_PROCEDURE(SubjectOf subjectOf) {
	...
	public DIAGNOSTIC_PROCEDURE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.DiagnosticProcedure org) {
		setSeq(org.getSeq());
