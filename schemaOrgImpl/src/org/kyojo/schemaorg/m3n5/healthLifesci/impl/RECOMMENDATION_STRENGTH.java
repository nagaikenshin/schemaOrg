...
public class RECOMMENDATION_STRENGTH implements Container.RecommendationStrength {
	...
	public RECOMMENDATION_STRENGTH(String string) {
		this(new TEXT(string));
	}

	public RECOMMENDATION_STRENGTH(Text text) {
