...
public class OPTICIAN implements Clazz.Optician {
	...
	public OPTICIAN(GeoContains geoContains) {
	...
	public OPTICIAN(GeoCoveredBy geoCoveredBy) {
	...
	public OPTICIAN(GeoCovers geoCovers) {
	...
	public OPTICIAN(GeoCrosses geoCrosses) {
	...
	public OPTICIAN(GeoDisjoint geoDisjoint) {
	...
	public OPTICIAN(GeoEquals geoEquals) {
	...
	public OPTICIAN(GeoIntersects geoIntersects) {
	...
	public OPTICIAN(GeoOverlaps geoOverlaps) {
	...
	public OPTICIAN(GeoTouches geoTouches) {
	...
	public OPTICIAN(GeoWithin geoWithin) {
