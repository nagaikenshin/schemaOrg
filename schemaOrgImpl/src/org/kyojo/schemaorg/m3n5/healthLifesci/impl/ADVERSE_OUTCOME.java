...
public class ADVERSE_OUTCOME implements Container.AdverseOutcome {
	...
	public ADVERSE_OUTCOME(String string) {
	...
	public ADVERSE_OUTCOME(AnatomicalStructure anatomicalStructure) {
	...
	public ADVERSE_OUTCOME(AnatomicalSystem anatomicalSystem) {
	...
	public ADVERSE_OUTCOME(ApprovedIndication approvedIndication) {
	...
	public ADVERSE_OUTCOME(Artery artery) {
	...
	public ADVERSE_OUTCOME(BloodTest bloodTest) {
	...
	public ADVERSE_OUTCOME(Bone bone) {
	...
	public ADVERSE_OUTCOME(BrainStructure brainStructure) {
	...
	public ADVERSE_OUTCOME(DDxElement ddxElement) {
	...
	public ADVERSE_OUTCOME(DiagnosticProcedure diagnosticProcedure) {
	...
	public ADVERSE_OUTCOME(Diet diet) {
	...
	public ADVERSE_OUTCOME(DietarySupplement dietarySupplement) {
	...
	public ADVERSE_OUTCOME(DoseSchedule doseSchedule) {
	...
	public ADVERSE_OUTCOME(Drug drug) {
	...
	public ADVERSE_OUTCOME(DrugLegalStatus drugLegalStatus) {
	...
	public ADVERSE_OUTCOME(DrugStrength drugStrength) {
	...
	public ADVERSE_OUTCOME(ExercisePlan exercisePlan) {
	...
	public ADVERSE_OUTCOME(ImagingTest imagingTest) {
	...
	public ADVERSE_OUTCOME(InfectiousDisease infectiousDisease) {
	...
	public ADVERSE_OUTCOME(Joint joint) {
	...
	public ADVERSE_OUTCOME(LifestyleModification lifestyleModification) {
	...
	public ADVERSE_OUTCOME(Ligament ligament) {
	...
	public ADVERSE_OUTCOME(LymphaticVessel lymphaticVessel) {
	...
	public ADVERSE_OUTCOME(MaximumDoseSchedule maximumDoseSchedule) {
	...
	public ADVERSE_OUTCOME(MedicalCause medicalCause) {
	...
	public ADVERSE_OUTCOME(MedicalCode medicalCode) {
	...
	public ADVERSE_OUTCOME(MedicalCondition medicalCondition) {
	...
	public ADVERSE_OUTCOME(MedicalConditionStage medicalConditionStage) {
	...
	public ADVERSE_OUTCOME(MedicalContraindication medicalContraindication) {
	...
	public ADVERSE_OUTCOME(MedicalDevice medicalDevice) {
	...
	public ADVERSE_OUTCOME(MedicalEntity medicalEntity) {
		medicalEntityList = new ArrayList<MedicalEntity>();
	...
	public ADVERSE_OUTCOME(MedicalGuideline medicalGuideline) {
	...
	public ADVERSE_OUTCOME(MedicalGuidelineContraindication medicalGuidelineContraindication) {
	...
	public ADVERSE_OUTCOME(MedicalGuidelineRecommendation medicalGuidelineRecommendation) {
	...
	public ADVERSE_OUTCOME(MedicalIndication medicalIndication) {
	...
	public ADVERSE_OUTCOME(MedicalIntangible medicalIntangible) {
	...
	public ADVERSE_OUTCOME(MedicalObservationalStudy medicalObservationalStudy) {
	...
	public ADVERSE_OUTCOME(MedicalProcedure medicalProcedure) {
	...
	public ADVERSE_OUTCOME(MedicalRiskCalculator medicalRiskCalculator) {
	...
	public ADVERSE_OUTCOME(MedicalRiskEstimator medicalRiskEstimator) {
	...
	public ADVERSE_OUTCOME(MedicalRiskFactor medicalRiskFactor) {
	...
	public ADVERSE_OUTCOME(MedicalRiskScore medicalRiskScore) {
	...
	public ADVERSE_OUTCOME(MedicalSign medicalSign) {
	...
	public ADVERSE_OUTCOME(MedicalSignOrSymptom medicalSignOrSymptom) {
	...
	public ADVERSE_OUTCOME(MedicalStudy medicalStudy) {
	...
	public ADVERSE_OUTCOME(MedicalSymptom medicalSymptom) {
	...
	public ADVERSE_OUTCOME(MedicalTest medicalTest) {
	...
	public ADVERSE_OUTCOME(MedicalTestPanel medicalTestPanel) {
	...
	public ADVERSE_OUTCOME(MedicalTherapy medicalTherapy) {
	...
	public ADVERSE_OUTCOME(MedicalTrial medicalTrial) {
	...
	public ADVERSE_OUTCOME(Muscle muscle) {
	...
	public ADVERSE_OUTCOME(Nerve nerve) {
	...
	public ADVERSE_OUTCOME(OccupationalTherapy occupationalTherapy) {
	...
	public ADVERSE_OUTCOME(PalliativeProcedure palliativeProcedure) {
	...
	public ADVERSE_OUTCOME(PathologyTest pathologyTest) {
	...
	public ADVERSE_OUTCOME(PhysicalActivity physicalActivity) {
	...
	public ADVERSE_OUTCOME(PhysicalExam physicalExam) {
	...
	public ADVERSE_OUTCOME(PhysicalTherapy physicalTherapy) {
	...
	public ADVERSE_OUTCOME(PreventionIndication preventionIndication) {
	...
	public ADVERSE_OUTCOME(PsychologicalTreatment psychologicalTreatment) {
	...
	public ADVERSE_OUTCOME(RadiationTherapy radiationTherapy) {
	...
	public ADVERSE_OUTCOME(RecommendedDoseSchedule recommendedDoseSchedule) {
	...
	public ADVERSE_OUTCOME(ReportedDoseSchedule reportedDoseSchedule) {
	...
	public ADVERSE_OUTCOME(RespiratoryTherapy respiratoryTherapy) {
	...
	public ADVERSE_OUTCOME(Substance substance) {
	...
	public ADVERSE_OUTCOME(SuperficialAnatomy superficialAnatomy) {
	...
	public ADVERSE_OUTCOME(SurgicalProcedure surgicalProcedure) {
	...
	public ADVERSE_OUTCOME(TherapeuticProcedure therapeuticProcedure) {
	...
	public ADVERSE_OUTCOME(TreatmentIndication treatmentIndication) {
	...
	public ADVERSE_OUTCOME(Vein vein) {
	...
	public ADVERSE_OUTCOME(Vessel vessel) {
	...
	public ADVERSE_OUTCOME(VitalSign vitalSign) {
	...
	public void copy(Container.AdverseOutcome org) {
