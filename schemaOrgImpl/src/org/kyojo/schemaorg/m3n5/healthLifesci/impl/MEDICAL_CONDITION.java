...
public class MEDICAL_CONDITION implements Clazz.MedicalCondition {
	...
	public MEDICAL_CONDITION(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_CONDITION(String string) {
	...
	public MEDICAL_CONDITION(AdditionalType additionalType) {
	...
	public MEDICAL_CONDITION(AlternateName alternateName) {
	...
	public MEDICAL_CONDITION(AssociatedAnatomy associatedAnatomy) {
	...
	public MEDICAL_CONDITION(Cause cause) {
		setCause(cause);
	}
	...
	public MEDICAL_CONDITION(Code code) {
		setCode(code);
	}
	...
	public MEDICAL_CONDITION(Description description) {
	...
	public MEDICAL_CONDITION(DifferentialDiagnosis differentialDiagnosis) {
	...
	public MEDICAL_CONDITION(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_CONDITION(Drug drug) {
		setDrug(drug);
	}
	...
	public MEDICAL_CONDITION(Epidemiology epidemiology) {
	...
	public MEDICAL_CONDITION(ExpectedPrognosis expectedPrognosis) {
	...
	public MEDICAL_CONDITION(Guideline guideline) {
	...
	public MEDICAL_CONDITION(Identifier identifier) {
	...
	public MEDICAL_CONDITION(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_CONDITION(LegalStatus legalStatus) {
	...
	public MEDICAL_CONDITION(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_CONDITION(MedicineSystem medicineSystem) {
	...
	public MEDICAL_CONDITION(Name name) {
		setName(name);
	}
	...
	public MEDICAL_CONDITION(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_CONDITION(NameRuby nameRuby) {
	...
	public MEDICAL_CONDITION(NaturalProgression naturalProgression) {
	...
	public MEDICAL_CONDITION(Pathophysiology pathophysiology) {
	...
	public MEDICAL_CONDITION(PossibleComplication possibleComplication) {
	...
	public MEDICAL_CONDITION(PossibleTreatment possibleTreatment) {
	...
	public MEDICAL_CONDITION(PotentialAction potentialAction) {
	...
	public MEDICAL_CONDITION(PrimaryPrevention primaryPrevention) {
	...
	public MEDICAL_CONDITION(RecognizingAuthority recognizingAuthority) {
	...
	public MEDICAL_CONDITION(RelevantSpecialty relevantSpecialty) {
	...
	public MEDICAL_CONDITION(RiskFactor riskFactor) {
	...
	public MEDICAL_CONDITION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_CONDITION(SecondaryPrevention secondaryPrevention) {
	...
	public MEDICAL_CONDITION(SignOrSymptom signOrSymptom) {
	...
	public MEDICAL_CONDITION(Stage stage) {
		setStage(stage);
	}
	...
	public MEDICAL_CONDITION(Status status) {
		setStatus(status);
	}
	...
	public MEDICAL_CONDITION(Study study) {
		setStudy(study);
	}
	...
	public MEDICAL_CONDITION(SubjectOf subjectOf) {
	...
	public MEDICAL_CONDITION(Subtype subtype) {
		setSubtype(subtype);
	}
	...
	public MEDICAL_CONDITION(TypicalTest typicalTest) {
	...
	public MEDICAL_CONDITION(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.MedicalCondition org) {
		setSeq(org.getSeq());
