...
public class DIAGNOSTIC implements MedicalDevicePurpose.Diagnostic {
	...
	public DIAGNOSTIC(Long seq) {
		setSeq(seq);
	}

	public DIAGNOSTIC(String string) {
	...
	public DIAGNOSTIC(AdditionalType additionalType) {
	...
	public DIAGNOSTIC(AlternateName alternateName) {
	...
	public DIAGNOSTIC(Description description) {
	...
	public DIAGNOSTIC(DisambiguatingDescription disambiguatingDescription) {
	...
	public DIAGNOSTIC(Identifier identifier) {
	...
	public DIAGNOSTIC(MainEntityOfPage mainEntityOfPage) {
	...
	public DIAGNOSTIC(NameFuzzy nameFuzzy) {
	...
	public DIAGNOSTIC(NameRuby nameRuby) {
	...
	public DIAGNOSTIC(PotentialAction potentialAction) {
	...
	public DIAGNOSTIC(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DIAGNOSTIC(SubjectOf subjectOf) {
	...
	public DIAGNOSTIC(SupersededBy supersededBy) {
	...
	public void copy(MedicalDevicePurpose.Diagnostic org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalDevicePurpose.Diagnostic.class.getAnnotation(SampleValue.class).value();
	}
