package org.kyojo.schemaorg.m3n5.healthLifesci.medicalDevicePurpose;
...
import org.kyojo.schemaorg.m3n5.healthLifesci.MedicalDevicePurpose;
import org.kyojo.schemaorg.m3n5.meta.Container.SupersededBy;

public class THERAPEUTIC implements MedicalDevicePurpose.Therapeutic {
	...
	public THERAPEUTIC(Long seq) {
		setSeq(seq);
	}

	public THERAPEUTIC(String string) {
	...
	public THERAPEUTIC(AdditionalType additionalType) {
	...
	public THERAPEUTIC(AlternateName alternateName) {
	...
	public THERAPEUTIC(Description description) {
	...
	public THERAPEUTIC(DisambiguatingDescription disambiguatingDescription) {
	...
	public THERAPEUTIC(Identifier identifier) {
	...
	public THERAPEUTIC(Image image) {
		setImage(image);
	}
	...
	public THERAPEUTIC(MainEntityOfPage mainEntityOfPage) {
	...
	public THERAPEUTIC(NameFuzzy nameFuzzy) {
	...
	public THERAPEUTIC(NameRuby nameRuby) {
	...
	public THERAPEUTIC(PotentialAction potentialAction) {
	...
	public THERAPEUTIC(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public THERAPEUTIC(SubjectOf subjectOf) {
	...
	public THERAPEUTIC(SupersededBy supersededBy) {
	...
	public void copy(MedicalDevicePurpose.Therapeutic org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalDevicePurpose.Therapeutic.class.getAnnotation(SampleValue.class).value();
	}
