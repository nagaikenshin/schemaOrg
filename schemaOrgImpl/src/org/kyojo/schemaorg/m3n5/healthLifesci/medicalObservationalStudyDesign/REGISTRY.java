...
public class REGISTRY implements MedicalObservationalStudyDesign.Registry {
	...
	public REGISTRY(AdditionalType additionalType) {
	...
	public REGISTRY(AlternateName alternateName) {
	...
	public REGISTRY(Description description) {
	...
	public REGISTRY(DisambiguatingDescription disambiguatingDescription) {
	...
	public REGISTRY(MainEntityOfPage mainEntityOfPage) {
	...
	public REGISTRY(NameFuzzy nameFuzzy) {
	...
	public REGISTRY(NameRuby nameRuby) {
	...
	public REGISTRY(PotentialAction potentialAction) {
	...
	public REGISTRY(SubjectOf subjectOf) {
	...
	public REGISTRY(SupersededBy supersededBy) {
	...
	public void copy(MedicalObservationalStudyDesign.Registry org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalObservationalStudyDesign.Registry.class.getAnnotation(SampleValue.class).value();
	}
