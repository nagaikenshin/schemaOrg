...
public class COHORT_STUDY implements MedicalObservationalStudyDesign.CohortStudy {
	...
	public COHORT_STUDY(Long seq) {
		setSeq(seq);
	}

	public COHORT_STUDY(String string) {
	...
	public COHORT_STUDY(AdditionalType additionalType) {
	...
	public COHORT_STUDY(AlternateName alternateName) {
	...
	public COHORT_STUDY(Description description) {
	...
	public COHORT_STUDY(DisambiguatingDescription disambiguatingDescription) {
	...
	public COHORT_STUDY(Identifier identifier) {
	...
	public COHORT_STUDY(Image image) {
		setImage(image);
	}
	...
	public COHORT_STUDY(MainEntityOfPage mainEntityOfPage) {
	...
	public COHORT_STUDY(NameFuzzy nameFuzzy) {
	...
	public COHORT_STUDY(NameRuby nameRuby) {
	...
	public COHORT_STUDY(PotentialAction potentialAction) {
	...
	public COHORT_STUDY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public COHORT_STUDY(SubjectOf subjectOf) {
	...
	public COHORT_STUDY(SupersededBy supersededBy) {
	...
	public void copy(MedicalObservationalStudyDesign.CohortStudy org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalObservationalStudyDesign.CohortStudy.class.getAnnotation(SampleValue.class).value();
	}
