...
public class PROTOZOA implements InfectiousAgentClass.Protozoa {
	...
	public PROTOZOA(Long seq) {
		setSeq(seq);
	}

	public PROTOZOA(String string) {
	...
	public PROTOZOA(AdditionalType additionalType) {
	...
	public PROTOZOA(AlternateName alternateName) {
	...
	public PROTOZOA(Description description) {
	...
	public PROTOZOA(DisambiguatingDescription disambiguatingDescription) {
	...
	public PROTOZOA(Identifier identifier) {
	...
	public PROTOZOA(MainEntityOfPage mainEntityOfPage) {
	...
	public PROTOZOA(NameFuzzy nameFuzzy) {
	...
	public PROTOZOA(NameRuby nameRuby) {
	...
	public PROTOZOA(PotentialAction potentialAction) {
	...
	public PROTOZOA(SubjectOf subjectOf) {
	...
	public PROTOZOA(SupersededBy supersededBy) {
	...
	public void copy(InfectiousAgentClass.Protozoa org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return InfectiousAgentClass.Protozoa.class.getAnnotation(SampleValue.class).value();
	}
