...
public class FUNGUS implements InfectiousAgentClass.Fungus {
	...
	public FUNGUS(Long seq) {
		setSeq(seq);
	}

	public FUNGUS(String string) {
	...
	public FUNGUS(AdditionalType additionalType) {
	...
	public FUNGUS(AlternateName alternateName) {
	...
	public FUNGUS(Description description) {
	...
	public FUNGUS(DisambiguatingDescription disambiguatingDescription) {
	...
	public FUNGUS(Identifier identifier) {
	...
	public FUNGUS(MainEntityOfPage mainEntityOfPage) {
	...
	public FUNGUS(NameFuzzy nameFuzzy) {
	...
	public FUNGUS(NameRuby nameRuby) {
	...
	public FUNGUS(PotentialAction potentialAction) {
	...
	public FUNGUS(SubjectOf subjectOf) {
	...
	public FUNGUS(SupersededBy supersededBy) {
	...
	public void copy(InfectiousAgentClass.Fungus org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return InfectiousAgentClass.Fungus.class.getAnnotation(SampleValue.class).value();
	}
