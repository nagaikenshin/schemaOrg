...
public class FDA_CATEGORY_C implements DrugPregnancyCategory.FDAcategoryC {
	...
	public FDA_CATEGORY_C() {
	}

	public FDA_CATEGORY_C(Long seq) {
		setSeq(seq);
	}

	public FDA_CATEGORY_C(String string) {
	...
	public FDA_CATEGORY_C(AdditionalType additionalType) {
	...
	public FDA_CATEGORY_C(AlternateName alternateName) {
	...
	public FDA_CATEGORY_C(Description description) {
	...
	public FDA_CATEGORY_C(DisambiguatingDescription disambiguatingDescription) {
	...
	public FDA_CATEGORY_C(Identifier identifier) {
	...
	public FDA_CATEGORY_C(Image image) {
		setImage(image);
	}
	...
	public FDA_CATEGORY_C(MainEntityOfPage mainEntityOfPage) {
	...
	public FDA_CATEGORY_C(Name name) {
		setName(name);
	}
	...
	public FDA_CATEGORY_C(NameFuzzy nameFuzzy) {
	...
	public FDA_CATEGORY_C(NameRuby nameRuby) {
	...
	public FDA_CATEGORY_C(PotentialAction potentialAction) {
	...
	public FDA_CATEGORY_C(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public FDA_CATEGORY_C(SubjectOf subjectOf) {
	...
	public FDA_CATEGORY_C(SupersededBy supersededBy) {
	...
	public void copy(DrugPregnancyCategory.FDAcategoryC org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return DrugPregnancyCategory.FDAcategoryC.class.getAnnotation(SampleValue.class).value();
	}
