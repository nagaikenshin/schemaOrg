...
public class FDA_CATEGORY_X implements DrugPregnancyCategory.FDAcategoryX {
	...
	public FDA_CATEGORY_X() {
	}

	public FDA_CATEGORY_X(Long seq) {
		setSeq(seq);
	}

	public FDA_CATEGORY_X(String string) {
	...
	public FDA_CATEGORY_X(AdditionalType additionalType) {
	...
	public FDA_CATEGORY_X(AlternateName alternateName) {
	...
	public FDA_CATEGORY_X(Description description) {
	...
	public FDA_CATEGORY_X(DisambiguatingDescription disambiguatingDescription) {
	...
	public FDA_CATEGORY_X(Identifier identifier) {
	...
	public FDA_CATEGORY_X(Image image) {
		setImage(image);
	}
	...
	public FDA_CATEGORY_X(MainEntityOfPage mainEntityOfPage) {
	...
	public FDA_CATEGORY_X(Name name) {
		setName(name);
	}
	...
	public FDA_CATEGORY_X(NameFuzzy nameFuzzy) {
	...
	public FDA_CATEGORY_X(NameRuby nameRuby) {
	...
	public FDA_CATEGORY_X(PotentialAction potentialAction) {
	...
	public FDA_CATEGORY_X(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public FDA_CATEGORY_X(SubjectOf subjectOf) {
	...
	public FDA_CATEGORY_X(SupersededBy supersededBy) {
	...
	public void copy(DrugPregnancyCategory.FDAcategoryX org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return DrugPregnancyCategory.FDAcategoryX.class.getAnnotation(SampleValue.class).value();
	}
