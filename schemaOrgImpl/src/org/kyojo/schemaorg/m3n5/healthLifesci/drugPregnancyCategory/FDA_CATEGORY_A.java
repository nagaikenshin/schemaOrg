...
public class FDA_CATEGORY_A implements DrugPregnancyCategory.FDAcategoryA {
	...
	public FDA_CATEGORY_A() {
	}

	public FDA_CATEGORY_A(Long seq) {
		setSeq(seq);
	}

	public FDA_CATEGORY_A(String string) {
	...
	public FDA_CATEGORY_A(AdditionalType additionalType) {
	...
	public FDA_CATEGORY_A(AlternateName alternateName) {
	...
	public FDA_CATEGORY_A(Description description) {
	...
	public FDA_CATEGORY_A(DisambiguatingDescription disambiguatingDescription) {
	...
	public FDA_CATEGORY_A(Identifier identifier) {
	...
	public FDA_CATEGORY_A(Image image) {
		setImage(image);
	}
	...
	public FDA_CATEGORY_A(MainEntityOfPage mainEntityOfPage) {
	...
	public FDA_CATEGORY_A(Name name) {
		setName(name);
	}
	...
	public FDA_CATEGORY_A(NameFuzzy nameFuzzy) {
	...
	public FDA_CATEGORY_A(NameRuby nameRuby) {
	...
	public FDA_CATEGORY_A(PotentialAction potentialAction) {
	...
	public FDA_CATEGORY_A(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public FDA_CATEGORY_A(SubjectOf subjectOf) {
	...
	public FDA_CATEGORY_A(SupersededBy supersededBy) {
	...
	public void copy(DrugPregnancyCategory.FDAcategoryA org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return DrugPregnancyCategory.FDAcategoryA.class.getAnnotation(SampleValue.class).value();
	}
