...
public class FDA_CATEGORY_D implements DrugPregnancyCategory.FDAcategoryD {
	...
	public FDA_CATEGORY_D() {
	}

	public FDA_CATEGORY_D(Long seq) {
		setSeq(seq);
	}

	public FDA_CATEGORY_D(String string) {
	...
	public FDA_CATEGORY_D(AdditionalType additionalType) {
	...
	public FDA_CATEGORY_D(AlternateName alternateName) {
	...
	public FDA_CATEGORY_D(Description description) {
	...
	public FDA_CATEGORY_D(DisambiguatingDescription disambiguatingDescription) {
	...
	public FDA_CATEGORY_D(Identifier identifier) {
	...
	public FDA_CATEGORY_D(Image image) {
		setImage(image);
	}
	...
	public FDA_CATEGORY_D(MainEntityOfPage mainEntityOfPage) {
	...
	public FDA_CATEGORY_D(Name name) {
		setName(name);
	}
	...
	public FDA_CATEGORY_D(NameFuzzy nameFuzzy) {
	...
	public FDA_CATEGORY_D(NameRuby nameRuby) {
	...
	public FDA_CATEGORY_D(PotentialAction potentialAction) {
	...
	public FDA_CATEGORY_D(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public FDA_CATEGORY_D(SubjectOf subjectOf) {
	...
	public FDA_CATEGORY_D(SupersededBy supersededBy) {
	...
	public void copy(DrugPregnancyCategory.FDAcategoryD org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return DrugPregnancyCategory.FDAcategoryD.class.getAnnotation(SampleValue.class).value();
	}
