...
public class RETAIL implements DrugCostCategory.Retail {
	...
	public RETAIL(Long seq) {
		setSeq(seq);
	}

	public RETAIL(String string) {
	...
	public RETAIL(AdditionalType additionalType) {
	...
	public RETAIL(AlternateName alternateName) {
	...
	public RETAIL(Description description) {
	...
	public RETAIL(DisambiguatingDescription disambiguatingDescription) {
	...
	public RETAIL(Identifier identifier) {
	...
	public RETAIL(MainEntityOfPage mainEntityOfPage) {
	...
	public RETAIL(NameFuzzy nameFuzzy) {
	...
	public RETAIL(NameRuby nameRuby) {
	...
	public RETAIL(PotentialAction potentialAction) {
	...
	public RETAIL(SubjectOf subjectOf) {
	...
	public RETAIL(SupersededBy supersededBy) {
	...
	public void copy(DrugCostCategory.Retail org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return DrugCostCategory.Retail.class.getAnnotation(SampleValue.class).value();
	}
