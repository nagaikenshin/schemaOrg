...
public class OTC implements DrugPrescriptionStatus.OTC {
	...
	public OTC(AdditionalType additionalType) {
	...
	public OTC(AlternateName alternateName) {
	...
	public OTC(Description description) {
	...
	public OTC(DisambiguatingDescription disambiguatingDescription) {
	...
	public OTC(Identifier identifier) {
	...
	public OTC(MainEntityOfPage mainEntityOfPage) {
	...
	public OTC(NameFuzzy nameFuzzy) {
	...
	public OTC(PotentialAction potentialAction) {
	...
	public OTC(SubjectOf subjectOf) {
	...
	public OTC(SupersededBy supersededBy) {
	...
	public void copy(DrugPrescriptionStatus.OTC org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return DrugPrescriptionStatus.OTC.class.getAnnotation(SampleValue.class).value();
	}
