package org.kyojo.schemaorg.m3n4.core.steeringPositionValue;
...
public class RIGHT_HAND_DRIVING implements SteeringPositionValue.RightHandDriving {
	...
	public RIGHT_HAND_DRIVING() {
	}

	public RIGHT_HAND_DRIVING(Long seq) {
		setSeq(seq);
	}

	public RIGHT_HAND_DRIVING(String string) {
	...
	public RIGHT_HAND_DRIVING(AdditionalProperty additionalProperty) {
	...
	public RIGHT_HAND_DRIVING(AdditionalType additionalType) {
	...
	public RIGHT_HAND_DRIVING(AlternateName alternateName) {
	...
	public RIGHT_HAND_DRIVING(Description description) {
	...
	public RIGHT_HAND_DRIVING(DisambiguatingDescription disambiguatingDescription) {
	...
	public RIGHT_HAND_DRIVING(Equal equal) {
		setEqual(equal);
	}
	...
	public RIGHT_HAND_DRIVING(Greater greater) {
		setGreater(greater);
	}
	...
	public RIGHT_HAND_DRIVING(GreaterOrEqual greaterOrEqual) {
	...
	public RIGHT_HAND_DRIVING(Identifier identifier) {
	...
	public RIGHT_HAND_DRIVING(Image image) {
		setImage(image);
	}
	...
	public RIGHT_HAND_DRIVING(Lesser lesser) {
		setLesser(lesser);
	}
	...
	public RIGHT_HAND_DRIVING(LesserOrEqual lesserOrEqual) {
	...
	public RIGHT_HAND_DRIVING(MainEntityOfPage mainEntityOfPage) {
	...
	public RIGHT_HAND_DRIVING(Name name) {
		setName(name);
	}
	...
	public RIGHT_HAND_DRIVING(NameFuzzy nameFuzzy) {
	...
	public RIGHT_HAND_DRIVING(NameRuby nameRuby) {
	...
	public RIGHT_HAND_DRIVING(NonEqual nonEqual) {
	...
	public RIGHT_HAND_DRIVING(PotentialAction potentialAction) {
	...
	public RIGHT_HAND_DRIVING(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RIGHT_HAND_DRIVING(SubjectOf subjectOf) {
	...
	public RIGHT_HAND_DRIVING(SupersededBy supersededBy) {
	...
	public RIGHT_HAND_DRIVING(Url url) {
		setUrl(url);
	}
	...
	public RIGHT_HAND_DRIVING(ValueReference valueReference) {
	...
	public void copy(SteeringPositionValue.RightHandDriving org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return SteeringPositionValue.RightHandDriving.class.getAnnotation(SampleValue.class).value();
	}
