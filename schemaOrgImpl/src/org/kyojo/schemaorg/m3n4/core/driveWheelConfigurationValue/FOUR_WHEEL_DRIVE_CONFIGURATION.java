...
public class FOUR_WHEEL_DRIVE_CONFIGURATION implements DriveWheelConfigurationValue.FourWheelDriveConfiguration {
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION() {
	}

	public FOUR_WHEEL_DRIVE_CONFIGURATION(Long seq) {
		setSeq(seq);
	}

	public FOUR_WHEEL_DRIVE_CONFIGURATION(String string) {
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION(AdditionalProperty additionalProperty) {
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION(AdditionalType additionalType) {
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION(AlternateName alternateName) {
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION(Description description) {
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION(Equal equal) {
		setEqual(equal);
	}
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION(Greater greater) {
		setGreater(greater);
	}
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION(GreaterOrEqual greaterOrEqual) {
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION(Identifier identifier) {
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION(Image image) {
		setImage(image);
	}
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION(Lesser lesser) {
		setLesser(lesser);
	}
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION(LesserOrEqual lesserOrEqual) {
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION(MainEntityOfPage mainEntityOfPage) {
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION(Name name) {
		setName(name);
	}
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION(NameFuzzy nameFuzzy) {
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION(NameRuby nameRuby) {
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION(NonEqual nonEqual) {
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION(PotentialAction potentialAction) {
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION(SubjectOf subjectOf) {
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION(SupersededBy supersededBy) {
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION(Url url) {
		setUrl(url);
	}
	...
	public FOUR_WHEEL_DRIVE_CONFIGURATION(ValueReference valueReference) {
	...
	public void copy(DriveWheelConfigurationValue.FourWheelDriveConfiguration org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return DriveWheelConfigurationValue.FourWheelDriveConfiguration.class.getAnnotation(SampleValue.class).value();
	}
