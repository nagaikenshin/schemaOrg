...
public class NOTARY implements Clazz.Notary {
	...
	public NOTARY(Long seq) {
		setSeq(seq);
	}

	public NOTARY(String string) {
	...
	public NOTARY(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public NOTARY(AdditionalProperty additionalProperty) {
	...
	public NOTARY(AdditionalType additionalType) {
	...
	public NOTARY(AggregateRating aggregateRating) {
	...
	public NOTARY(AlternateName alternateName) {
	...
	public NOTARY(AmenityFeature amenityFeature) {
	...
	public NOTARY(AreaServed areaServed) {
	...
	public NOTARY(BranchCode branchCode) {
	...
	public NOTARY(ContactPoint contactPoint) {
	...
	public NOTARY(ContainedInPlace containedInPlace) {
	...
	public NOTARY(ContainsPlace containsPlace) {
	...
	public NOTARY(CorrectionsPolicy correctionsPolicy) {
	...
	public NOTARY(CurrenciesAccepted currenciesAccepted) {
	...
	public NOTARY(Department department) {
	...
	public NOTARY(Description description) {
	...
	public NOTARY(DisambiguatingDescription disambiguatingDescription) {
	...
	public NOTARY(DissolutionDate dissolutionDate) {
	...
	public NOTARY(DiversityPolicy diversityPolicy) {
	...
	public NOTARY(DiversityStaffingReport diversityStaffingReport) {
	...
	public NOTARY(Employee employee) {
	...
	public NOTARY(EthicsPolicy ethicsPolicy) {
	...
	public NOTARY(FaxNumber faxNumber) {
	...
	public NOTARY(FoundingDate foundingDate) {
	...
	public NOTARY(FoundingLocation foundingLocation) {
	...
	public NOTARY(GeospatiallyContains geospatiallyContains) {
	...
	public NOTARY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public NOTARY(GeospatiallyCovers geospatiallyCovers) {
	...
	public NOTARY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public NOTARY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public NOTARY(GeospatiallyEquals geospatiallyEquals) {
	...
	public NOTARY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public NOTARY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public NOTARY(GeospatiallyTouches geospatiallyTouches) {
	...
	public NOTARY(GeospatiallyWithin geospatiallyWithin) {
	...
	public NOTARY(GlobalLocationNumber globalLocationNumber) {
	...
	public NOTARY(HasOfferCatalog hasOfferCatalog) {
	...
	public NOTARY(Identifier identifier) {
	...
	public NOTARY(IsAccessibleForFree isAccessibleForFree) {
	...
	public NOTARY(KnowsAbout knowsAbout) {
	...
	public NOTARY(KnowsLanguage knowsLanguage) {
	...
	public NOTARY(LegalName legalName) {
	...
	public NOTARY(Location location) {
	...
	public NOTARY(MainEntityOfPage mainEntityOfPage) {
	...
	public NOTARY(MakesOffer makesOffer) {
	...
	public NOTARY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public NOTARY(MemberOf memberOf) {
	...
	public NOTARY(NameFuzzy nameFuzzy) {
	...
	public NOTARY(NameRuby nameRuby) {
	...
	public NOTARY(NumberOfEmployees numberOfEmployees) {
	...
	public NOTARY(OpeningHours openingHours) {
	...
	public NOTARY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public NOTARY(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public NOTARY(ParentOrganization parentOrganization) {
	...
	public NOTARY(PaymentAccepted paymentAccepted) {
	...
	public NOTARY(PotentialAction potentialAction) {
	...
	public NOTARY(PriceRange priceRange) {
	...
	public NOTARY(PublicAccess publicAccess) {
	...
	public NOTARY(PublishingPrinciples publishingPrinciples) {
	...
	public NOTARY(SmokingAllowed smokingAllowed) {
	...
	public NOTARY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public NOTARY(SubOrganization subOrganization) {
	...
	public NOTARY(SubjectOf subjectOf) {
	...
	public NOTARY(Telephone telephone) {
	...
	public NOTARY(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Notary org) {
		setSeq(org.getSeq());
