...
public class FUEL_EFFICIENCY implements Container.FuelEfficiency {
	...
	public FUEL_EFFICIENCY(String string) {
	...
	public FUEL_EFFICIENCY(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public FUEL_EFFICIENCY(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public FUEL_EFFICIENCY(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public FUEL_EFFICIENCY(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.FuelEfficiency org) {
