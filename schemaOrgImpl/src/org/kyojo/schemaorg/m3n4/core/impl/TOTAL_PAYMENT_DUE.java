...
public class TOTAL_PAYMENT_DUE implements Container.TotalPaymentDue {
	...
	public TOTAL_PAYMENT_DUE(String string) {
	...
	public TOTAL_PAYMENT_DUE(CompoundPriceSpecification compoundPriceSpecification) {
	...
	public TOTAL_PAYMENT_DUE(DeliveryChargeSpecification deliveryChargeSpecification) {
	...
	public TOTAL_PAYMENT_DUE(MonetaryAmount monetaryAmount) {
		monetaryAmountList = new ArrayList<MonetaryAmount>();
	...
	public TOTAL_PAYMENT_DUE(PaymentChargeSpecification paymentChargeSpecification) {
	...
	public TOTAL_PAYMENT_DUE(PriceSpecification priceSpecification) {
	...
	public TOTAL_PAYMENT_DUE(UnitPriceSpecification unitPriceSpecification) {
	...
	public TOTAL_PAYMENT_DUE(List<CompoundPriceSpecification> compoundPriceSpecificationList,
	...
	public void copy(Container.TotalPaymentDue org) {
