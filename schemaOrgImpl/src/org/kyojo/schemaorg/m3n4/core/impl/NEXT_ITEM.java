...
public class NEXT_ITEM implements Container.NextItem {
	...
	public NEXT_ITEM(HowToDirection howToDirection) {
	...
	public NEXT_ITEM(HowToItem howToItem) {
	...
	public NEXT_ITEM(HowToSection howToSection) {
	...
	public NEXT_ITEM(HowToStep howToStep) {
	...
	public NEXT_ITEM(HowToSupply howToSupply) {
	...
	public NEXT_ITEM(HowToTip howToTip) {
	...
	public NEXT_ITEM(HowToTool howToTool) {
	...
	public NEXT_ITEM(List<HowToDirection> howToDirectionList,
	...
	public void copy(Container.NextItem org) {
