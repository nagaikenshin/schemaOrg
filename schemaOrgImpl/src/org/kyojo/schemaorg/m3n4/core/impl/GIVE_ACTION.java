...
public class GIVE_ACTION implements Clazz.GiveAction {
	...
	public GIVE_ACTION(Long seq) {
		setSeq(seq);
	}

	public GIVE_ACTION(String string) {
	...
	public GIVE_ACTION(ActionStatus actionStatus) {
	...
	public GIVE_ACTION(AdditionalType additionalType) {
	...
	public GIVE_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public GIVE_ACTION(AlternateName alternateName) {
	...
	public GIVE_ACTION(Description description) {
	...
	public GIVE_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public GIVE_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public GIVE_ACTION(Error error) {
		setError(error);
	}
	...
	public GIVE_ACTION(FromLocation fromLocation) {
	...
	public GIVE_ACTION(Identifier identifier) {
	...
	public GIVE_ACTION(Image image) {
		setImage(image);
	}
	...
	public GIVE_ACTION(Instrument instrument) {
	...
	public GIVE_ACTION(Location location) {
	...
	public GIVE_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public GIVE_ACTION(NameFuzzy nameFuzzy) {
	...
	public GIVE_ACTION(NameRuby nameRuby) {
	...
	public GIVE_ACTION(Object object) {
		setObject(object);
	}
	...
	public GIVE_ACTION(Participant participant) {
	...
	public GIVE_ACTION(PotentialAction potentialAction) {
	...
	public GIVE_ACTION(Recipient recipient) {
	...
	public GIVE_ACTION(Result result) {
		setResult(result);
	}
	...
	public GIVE_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public GIVE_ACTION(StartTime startTime) {
	...
	public GIVE_ACTION(SubjectOf subjectOf) {
	...
	public GIVE_ACTION(Target target) {
		setTarget(target);
	}
	...
	public GIVE_ACTION(ToLocation toLocation) {
	...
	public void copy(Clazz.GiveAction org) {
		setSeq(org.getSeq());
