...
public class HOW_TO_TOOL implements Clazz.HowToTool {
	...
	public HOW_TO_TOOL(Long seq) {
		setSeq(seq);
	}

	public HOW_TO_TOOL(String string) {
	...
	public HOW_TO_TOOL(AdditionalType additionalType) {
	...
	public HOW_TO_TOOL(AlternateName alternateName) {
	...
	public HOW_TO_TOOL(Description description) {
	...
	public HOW_TO_TOOL(DisambiguatingDescription disambiguatingDescription) {
	...
	public HOW_TO_TOOL(Identifier identifier) {
	...
	public HOW_TO_TOOL(Image image) {
		setImage(image);
	}
	...
	public HOW_TO_TOOL(MainEntityOfPage mainEntityOfPage) {
	...
	public HOW_TO_TOOL(NameFuzzy nameFuzzy) {
	...
	public HOW_TO_TOOL(NameRuby nameRuby) {
	...
	public HOW_TO_TOOL(NextItem nextItem) {
	...
	public HOW_TO_TOOL(Position position) {
	...
	public HOW_TO_TOOL(PotentialAction potentialAction) {
	...
	public HOW_TO_TOOL(PreviousItem previousItem) {
	...
	public HOW_TO_TOOL(RequiredQuantity requiredQuantity) {
	...
	public HOW_TO_TOOL(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public HOW_TO_TOOL(SubjectOf subjectOf) {
	...
	public void copy(Clazz.HowToTool org) {
		setSeq(org.getSeq());
