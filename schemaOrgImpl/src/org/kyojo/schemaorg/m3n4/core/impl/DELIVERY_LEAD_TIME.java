...
public class DELIVERY_LEAD_TIME implements Container.DeliveryLeadTime {
	...
	public DELIVERY_LEAD_TIME(String string) {
	...
	public DELIVERY_LEAD_TIME(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public DELIVERY_LEAD_TIME(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public DELIVERY_LEAD_TIME(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public DELIVERY_LEAD_TIME(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.DeliveryLeadTime org) {
