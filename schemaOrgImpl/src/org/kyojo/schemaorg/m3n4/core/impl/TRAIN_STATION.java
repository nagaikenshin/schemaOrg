...
public class TRAIN_STATION implements Clazz.TrainStation {
	...
	public TRAIN_STATION(Long seq) {
		setSeq(seq);
	}

	public TRAIN_STATION(String string) {
	...
	public TRAIN_STATION(AdditionalProperty additionalProperty) {
	...
	public TRAIN_STATION(AdditionalType additionalType) {
	...
	public TRAIN_STATION(Address address) {
		setAddress(address);
	}
	...
	public TRAIN_STATION(AggregateRating aggregateRating) {
	...
	public TRAIN_STATION(AlternateName alternateName) {
	...
	public TRAIN_STATION(AmenityFeature amenityFeature) {
	...
	public TRAIN_STATION(BranchCode branchCode) {
	...
	public TRAIN_STATION(ContainedInPlace containedInPlace) {
	...
	public TRAIN_STATION(ContainsPlace containsPlace) {
	...
	public TRAIN_STATION(Description description) {
	...
	public TRAIN_STATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public TRAIN_STATION(Event event) {
		setEvent(event);
	}
	...
	public TRAIN_STATION(FaxNumber faxNumber) {
	...
	public TRAIN_STATION(GeospatiallyContains geospatiallyContains) {
	...
	public TRAIN_STATION(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public TRAIN_STATION(GeospatiallyCovers geospatiallyCovers) {
	...
	public TRAIN_STATION(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public TRAIN_STATION(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public TRAIN_STATION(GeospatiallyEquals geospatiallyEquals) {
	...
	public TRAIN_STATION(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public TRAIN_STATION(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public TRAIN_STATION(GeospatiallyTouches geospatiallyTouches) {
	...
	public TRAIN_STATION(GeospatiallyWithin geospatiallyWithin) {
	...
	public TRAIN_STATION(GlobalLocationNumber globalLocationNumber) {
	...
	public TRAIN_STATION(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public TRAIN_STATION(Identifier identifier) {
	...
	public TRAIN_STATION(Image image) {
		setImage(image);
	}
	...
	public TRAIN_STATION(IsAccessibleForFree isAccessibleForFree) {
	...
	public TRAIN_STATION(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public TRAIN_STATION(Logo logo) {
		setLogo(logo);
	}
	...
	public TRAIN_STATION(MainEntityOfPage mainEntityOfPage) {
	...
	public TRAIN_STATION(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public TRAIN_STATION(Name name) {
		setName(name);
	}
	...
	public TRAIN_STATION(NameFuzzy nameFuzzy) {
	...
	public TRAIN_STATION(NameRuby nameRuby) {
	...
	public TRAIN_STATION(OpeningHours openingHours) {
	...
	public TRAIN_STATION(OpeningHoursSpecification openingHoursSpecification) {
	...
	public TRAIN_STATION(Photo photo) {
		setPhoto(photo);
	}
	...
	public TRAIN_STATION(PotentialAction potentialAction) {
	...
	public TRAIN_STATION(PublicAccess publicAccess) {
	...
	public TRAIN_STATION(Review review) {
		setReview(review);
	}
	...
	public TRAIN_STATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TRAIN_STATION(SmokingAllowed smokingAllowed) {
	...
	public TRAIN_STATION(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public TRAIN_STATION(SubjectOf subjectOf) {
	...
	public TRAIN_STATION(Telephone telephone) {
	...
	public void copy(Clazz.TrainStation org) {
		setSeq(org.getSeq());
