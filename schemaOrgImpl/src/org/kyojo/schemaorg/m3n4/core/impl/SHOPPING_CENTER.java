...
public class SHOPPING_CENTER implements Clazz.ShoppingCenter {
	...
	public SHOPPING_CENTER(Long seq) {
		setSeq(seq);
	}

	public SHOPPING_CENTER(String string) {
	...
	public SHOPPING_CENTER(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public SHOPPING_CENTER(AdditionalProperty additionalProperty) {
	...
	public SHOPPING_CENTER(AdditionalType additionalType) {
	...
	public SHOPPING_CENTER(Address address) {
		setAddress(address);
	}
	...
	public SHOPPING_CENTER(AggregateRating aggregateRating) {
	...
	public SHOPPING_CENTER(AlternateName alternateName) {
	...
	public SHOPPING_CENTER(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public SHOPPING_CENTER(AmenityFeature amenityFeature) {
	...
	public SHOPPING_CENTER(AreaServed areaServed) {
	...
	public SHOPPING_CENTER(Award award) {
		setAward(award);
	}
	...
	public SHOPPING_CENTER(BranchCode branchCode) {
	...
	public SHOPPING_CENTER(Brand brand) {
		setBrand(brand);
	}
	...
	public SHOPPING_CENTER(ContactPoint contactPoint) {
	...
	public SHOPPING_CENTER(ContainedInPlace containedInPlace) {
	...
	public SHOPPING_CENTER(ContainsPlace containsPlace) {
	...
	public SHOPPING_CENTER(CorrectionsPolicy correctionsPolicy) {
	...
	public SHOPPING_CENTER(CurrenciesAccepted currenciesAccepted) {
	...
	public SHOPPING_CENTER(Department department) {
	...
	public SHOPPING_CENTER(Description description) {
	...
	public SHOPPING_CENTER(DisambiguatingDescription disambiguatingDescription) {
	...
	public SHOPPING_CENTER(DissolutionDate dissolutionDate) {
	...
	public SHOPPING_CENTER(DiversityPolicy diversityPolicy) {
	...
	public SHOPPING_CENTER(DiversityStaffingReport diversityStaffingReport) {
	...
	public SHOPPING_CENTER(Duns duns) {
		setDuns(duns);
	}
	...
	public SHOPPING_CENTER(Email email) {
		setEmail(email);
	}
	...
	public SHOPPING_CENTER(Employee employee) {
	...
	public SHOPPING_CENTER(EthicsPolicy ethicsPolicy) {
	...
	public SHOPPING_CENTER(Event event) {
		setEvent(event);
	}
	...
	public SHOPPING_CENTER(FaxNumber faxNumber) {
	...
	public SHOPPING_CENTER(Founder founder) {
		setFounder(founder);
	}
	...
	public SHOPPING_CENTER(FoundingDate foundingDate) {
	...
	public SHOPPING_CENTER(FoundingLocation foundingLocation) {
	...
	public SHOPPING_CENTER(Funder funder) {
		setFunder(funder);
	}
	...
	public SHOPPING_CENTER(Geo geo) {
		setGeo(geo);
	}
	...
	public SHOPPING_CENTER(GeospatiallyContains geospatiallyContains) {
	...
	public SHOPPING_CENTER(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public SHOPPING_CENTER(GeospatiallyCovers geospatiallyCovers) {
	...
	public SHOPPING_CENTER(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public SHOPPING_CENTER(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public SHOPPING_CENTER(GeospatiallyEquals geospatiallyEquals) {
	...
	public SHOPPING_CENTER(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public SHOPPING_CENTER(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public SHOPPING_CENTER(GeospatiallyTouches geospatiallyTouches) {
	...
	public SHOPPING_CENTER(GeospatiallyWithin geospatiallyWithin) {
	...
	public SHOPPING_CENTER(GlobalLocationNumber globalLocationNumber) {
	...
	public SHOPPING_CENTER(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public SHOPPING_CENTER(HasOfferCatalog hasOfferCatalog) {
	...
	public SHOPPING_CENTER(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public SHOPPING_CENTER(Identifier identifier) {
	...
	public SHOPPING_CENTER(Image image) {
		setImage(image);
	}
	...
	public SHOPPING_CENTER(IsAccessibleForFree isAccessibleForFree) {
	...
	public SHOPPING_CENTER(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public SHOPPING_CENTER(KnowsAbout knowsAbout) {
	...
	public SHOPPING_CENTER(KnowsLanguage knowsLanguage) {
	...
	public SHOPPING_CENTER(LegalName legalName) {
	...
	public SHOPPING_CENTER(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public SHOPPING_CENTER(Location location) {
	...
	public SHOPPING_CENTER(Logo logo) {
		setLogo(logo);
	}
	...
	public SHOPPING_CENTER(MainEntityOfPage mainEntityOfPage) {
	...
	public SHOPPING_CENTER(MakesOffer makesOffer) {
	...
	public SHOPPING_CENTER(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public SHOPPING_CENTER(Member member) {
		setMember(member);
	}
	...
	public SHOPPING_CENTER(MemberOf memberOf) {
	...
	public SHOPPING_CENTER(Naics naics) {
		setNaics(naics);
	}
	...
	public SHOPPING_CENTER(Name name) {
		setName(name);
	}
	...
	public SHOPPING_CENTER(NameFuzzy nameFuzzy) {
	...
	public SHOPPING_CENTER(NameRuby nameRuby) {
	...
	public SHOPPING_CENTER(NumberOfEmployees numberOfEmployees) {
	...
	public SHOPPING_CENTER(OpeningHours openingHours) {
	...
	public SHOPPING_CENTER(OpeningHoursSpecification openingHoursSpecification) {
	...
	public SHOPPING_CENTER(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public SHOPPING_CENTER(Owns owns) {
		setOwns(owns);
	}
	...
	public SHOPPING_CENTER(ParentOrganization parentOrganization) {
	...
	public SHOPPING_CENTER(PaymentAccepted paymentAccepted) {
	...
	public SHOPPING_CENTER(Photo photo) {
		setPhoto(photo);
	}
	...
	public SHOPPING_CENTER(PotentialAction potentialAction) {
	...
	public SHOPPING_CENTER(PriceRange priceRange) {
	...
	public SHOPPING_CENTER(PublicAccess publicAccess) {
	...
	public SHOPPING_CENTER(PublishingPrinciples publishingPrinciples) {
	...
	public SHOPPING_CENTER(Review review) {
		setReview(review);
	}
	...
	public SHOPPING_CENTER(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SHOPPING_CENTER(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public SHOPPING_CENTER(SmokingAllowed smokingAllowed) {
	...
	public SHOPPING_CENTER(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public SHOPPING_CENTER(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public SHOPPING_CENTER(SubOrganization subOrganization) {
	...
	public SHOPPING_CENTER(SubjectOf subjectOf) {
	...
	public SHOPPING_CENTER(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public SHOPPING_CENTER(Telephone telephone) {
	...
	public SHOPPING_CENTER(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public SHOPPING_CENTER(Url url) {
		setUrl(url);
	}
	...
	public SHOPPING_CENTER(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.ShoppingCenter org) {
		setSeq(org.getSeq());
