...
public class PART_OF_EPISODE implements Container.PartOfEpisode {
	...
	public PART_OF_EPISODE(BusTrip busTrip) {
	...
	public PART_OF_EPISODE(Flight flight) {
	...
	public PART_OF_EPISODE(TouristTrip touristTrip) {
	...
	public PART_OF_EPISODE(TrainTrip trainTrip) {
