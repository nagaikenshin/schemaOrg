...
public class PARKING_FACILITY implements Clazz.ParkingFacility {
	...
	public PARKING_FACILITY(Long seq) {
		setSeq(seq);
	}

	public PARKING_FACILITY(String string) {
	...
	public PARKING_FACILITY(AdditionalProperty additionalProperty) {
	...
	public PARKING_FACILITY(AdditionalType additionalType) {
	...
	public PARKING_FACILITY(Address address) {
		setAddress(address);
	}
	...
	public PARKING_FACILITY(AggregateRating aggregateRating) {
	...
	public PARKING_FACILITY(AlternateName alternateName) {
	...
	public PARKING_FACILITY(AmenityFeature amenityFeature) {
	...
	public PARKING_FACILITY(BranchCode branchCode) {
	...
	public PARKING_FACILITY(ContainedInPlace containedInPlace) {
	...
	public PARKING_FACILITY(ContainsPlace containsPlace) {
	...
	public PARKING_FACILITY(Description description) {
	...
	public PARKING_FACILITY(DisambiguatingDescription disambiguatingDescription) {
	...
	public PARKING_FACILITY(Event event) {
		setEvent(event);
	}
	...
	public PARKING_FACILITY(FaxNumber faxNumber) {
	...
	public PARKING_FACILITY(Geo geo) {
		setGeo(geo);
	}
	...
	public PARKING_FACILITY(GeospatiallyContains geospatiallyContains) {
	...
	public PARKING_FACILITY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public PARKING_FACILITY(GeospatiallyCovers geospatiallyCovers) {
	...
	public PARKING_FACILITY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public PARKING_FACILITY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public PARKING_FACILITY(GeospatiallyEquals geospatiallyEquals) {
	...
	public PARKING_FACILITY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public PARKING_FACILITY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public PARKING_FACILITY(GeospatiallyTouches geospatiallyTouches) {
	...
	public PARKING_FACILITY(GeospatiallyWithin geospatiallyWithin) {
	...
	public PARKING_FACILITY(GlobalLocationNumber globalLocationNumber) {
	...
	public PARKING_FACILITY(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public PARKING_FACILITY(Identifier identifier) {
	...
	public PARKING_FACILITY(Image image) {
		setImage(image);
	}
	...
	public PARKING_FACILITY(IsAccessibleForFree isAccessibleForFree) {
	...
	public PARKING_FACILITY(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public PARKING_FACILITY(Logo logo) {
		setLogo(logo);
	}
	...
	public PARKING_FACILITY(MainEntityOfPage mainEntityOfPage) {
	...
	public PARKING_FACILITY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public PARKING_FACILITY(Name name) {
		setName(name);
	}
	...
	public PARKING_FACILITY(NameFuzzy nameFuzzy) {
	...
	public PARKING_FACILITY(NameRuby nameRuby) {
	...
	public PARKING_FACILITY(OpeningHours openingHours) {
	...
	public PARKING_FACILITY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public PARKING_FACILITY(Photo photo) {
		setPhoto(photo);
	}
	...
	public PARKING_FACILITY(PotentialAction potentialAction) {
	...
	public PARKING_FACILITY(PublicAccess publicAccess) {
	...
	public PARKING_FACILITY(Review review) {
		setReview(review);
	}
	...
	public PARKING_FACILITY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PARKING_FACILITY(SmokingAllowed smokingAllowed) {
	...
	public PARKING_FACILITY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public PARKING_FACILITY(SubjectOf subjectOf) {
	...
	public PARKING_FACILITY(Telephone telephone) {
	...
	public PARKING_FACILITY(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.ParkingFacility org) {
		setSeq(org.getSeq());
