...
public class COURTHOUSE implements Clazz.Courthouse {
	...
	public COURTHOUSE(Long seq) {
		setSeq(seq);
	}

	public COURTHOUSE(String string) {
	...
	public COURTHOUSE(AdditionalProperty additionalProperty) {
	...
	public COURTHOUSE(AdditionalType additionalType) {
	...
	public COURTHOUSE(AggregateRating aggregateRating) {
	...
	public COURTHOUSE(AlternateName alternateName) {
	...
	public COURTHOUSE(AmenityFeature amenityFeature) {
	...
	public COURTHOUSE(BranchCode branchCode) {
	...
	public COURTHOUSE(ContainedInPlace containedInPlace) {
	...
	public COURTHOUSE(ContainsPlace containsPlace) {
	...
	public COURTHOUSE(Description description) {
	...
	public COURTHOUSE(DisambiguatingDescription disambiguatingDescription) {
	...
	public COURTHOUSE(FaxNumber faxNumber) {
	...
	public COURTHOUSE(GeospatiallyContains geospatiallyContains) {
	...
	public COURTHOUSE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public COURTHOUSE(GeospatiallyCovers geospatiallyCovers) {
	...
	public COURTHOUSE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public COURTHOUSE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public COURTHOUSE(GeospatiallyEquals geospatiallyEquals) {
	...
	public COURTHOUSE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public COURTHOUSE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public COURTHOUSE(GeospatiallyTouches geospatiallyTouches) {
	...
	public COURTHOUSE(GeospatiallyWithin geospatiallyWithin) {
	...
	public COURTHOUSE(GlobalLocationNumber globalLocationNumber) {
	...
	public COURTHOUSE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public COURTHOUSE(Identifier identifier) {
	...
	public COURTHOUSE(IsAccessibleForFree isAccessibleForFree) {
	...
	public COURTHOUSE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public COURTHOUSE(MainEntityOfPage mainEntityOfPage) {
	...
	public COURTHOUSE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public COURTHOUSE(NameFuzzy nameFuzzy) {
	...
	public COURTHOUSE(NameRuby nameRuby) {
	...
	public COURTHOUSE(OpeningHours openingHours) {
	...
	public COURTHOUSE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public COURTHOUSE(PotentialAction potentialAction) {
	...
	public COURTHOUSE(PublicAccess publicAccess) {
	...
	public COURTHOUSE(Review review) {
		setReview(review);
	}
	...
	public COURTHOUSE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public COURTHOUSE(SmokingAllowed smokingAllowed) {
	...
	public COURTHOUSE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public COURTHOUSE(SubjectOf subjectOf) {
	...
	public COURTHOUSE(Telephone telephone) {
	...
	public void copy(Clazz.Courthouse org) {
		setSeq(org.getSeq());
