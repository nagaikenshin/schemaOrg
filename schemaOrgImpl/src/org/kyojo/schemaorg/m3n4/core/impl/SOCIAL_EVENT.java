...
public class SOCIAL_EVENT implements Clazz.SocialEvent {
	...
	public SOCIAL_EVENT(Long seq) {
		setSeq(seq);
	}

	public SOCIAL_EVENT(String string) {
	...
	public SOCIAL_EVENT(About about) {
		setAbout(about);
	}
	...
	public SOCIAL_EVENT(Actor actor) {
		setActor(actor);
	}
	...
	public SOCIAL_EVENT(AdditionalType additionalType) {
	...
	public SOCIAL_EVENT(AggregateRating aggregateRating) {
	...
	public SOCIAL_EVENT(AlternateName alternateName) {
	...
	public SOCIAL_EVENT(Attendee attendee) {
	...
	public SOCIAL_EVENT(Audience audience) {
	...
	public SOCIAL_EVENT(Composer composer) {
	...
	public SOCIAL_EVENT(Contributor contributor) {
	...
	public SOCIAL_EVENT(Description description) {
	...
	public SOCIAL_EVENT(Director director) {
	...
	public SOCIAL_EVENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public SOCIAL_EVENT(DoorTime doorTime) {
	...
	public SOCIAL_EVENT(Duration duration) {
	...
	public SOCIAL_EVENT(EndDate endDate) {
		setEndDate(endDate);
	}
	...
	public SOCIAL_EVENT(EventStatus eventStatus) {
	...
	public SOCIAL_EVENT(Funder funder) {
		setFunder(funder);
	}
	...
	public SOCIAL_EVENT(Identifier identifier) {
	...
	public SOCIAL_EVENT(Image image) {
		setImage(image);
	}
	...
	public SOCIAL_EVENT(InLanguage inLanguage) {
	...
	public SOCIAL_EVENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public SOCIAL_EVENT(Location location) {
	...
	public SOCIAL_EVENT(MainEntityOfPage mainEntityOfPage) {
	...
	public SOCIAL_EVENT(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public SOCIAL_EVENT(NameFuzzy nameFuzzy) {
	...
	public SOCIAL_EVENT(NameRuby nameRuby) {
	...
	public SOCIAL_EVENT(Offers offers) {
		setOffers(offers);
	}
	...
	public SOCIAL_EVENT(Organizer organizer) {
	...
	public SOCIAL_EVENT(Performer performer) {
	...
	public SOCIAL_EVENT(PotentialAction potentialAction) {
	...
	public SOCIAL_EVENT(PreviousStartDate previousStartDate) {
	...
	public SOCIAL_EVENT(RecordedIn recordedIn) {
	...
	public SOCIAL_EVENT(RemainingAttendeeCapacity remainingAttendeeCapacity) {
	...
	public SOCIAL_EVENT(Review review) {
		setReview(review);
	}
	...
	public SOCIAL_EVENT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SOCIAL_EVENT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public SOCIAL_EVENT(StartDate startDate) {
	...
	public SOCIAL_EVENT(SubEvent subEvent) {
	...
	public SOCIAL_EVENT(SubjectOf subjectOf) {
	...
	public SOCIAL_EVENT(SuperEvent superEvent) {
	...
	public SOCIAL_EVENT(Translator translator) {
	...
	public SOCIAL_EVENT(TypicalAgeRange typicalAgeRange) {
	...
	public SOCIAL_EVENT(WorkFeatured workFeatured) {
	...
	public SOCIAL_EVENT(WorkPerformed workPerformed) {
	...
	public void copy(Clazz.SocialEvent org) {
		setSeq(org.getSeq());
