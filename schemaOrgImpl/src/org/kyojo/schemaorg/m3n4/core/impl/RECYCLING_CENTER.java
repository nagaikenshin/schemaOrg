...
public class RECYCLING_CENTER implements Clazz.RecyclingCenter {
	...
	public RECYCLING_CENTER() {
	}

	public RECYCLING_CENTER(Long seq) {
		setSeq(seq);
	}

	public RECYCLING_CENTER(String string) {
	...
	public RECYCLING_CENTER(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public RECYCLING_CENTER(AdditionalProperty additionalProperty) {
	...
	public RECYCLING_CENTER(AdditionalType additionalType) {
	...
	public RECYCLING_CENTER(Address address) {
		setAddress(address);
	}
	...
	public RECYCLING_CENTER(AggregateRating aggregateRating) {
	...
	public RECYCLING_CENTER(AlternateName alternateName) {
	...
	public RECYCLING_CENTER(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public RECYCLING_CENTER(AmenityFeature amenityFeature) {
	...
	public RECYCLING_CENTER(AreaServed areaServed) {
	...
	public RECYCLING_CENTER(Award award) {
		setAward(award);
	}
	...
	public RECYCLING_CENTER(BranchCode branchCode) {
	...
	public RECYCLING_CENTER(Brand brand) {
		setBrand(brand);
	}
	...
	public RECYCLING_CENTER(ContactPoint contactPoint) {
	...
	public RECYCLING_CENTER(ContainedInPlace containedInPlace) {
	...
	public RECYCLING_CENTER(ContainsPlace containsPlace) {
	...
	public RECYCLING_CENTER(CorrectionsPolicy correctionsPolicy) {
	...
	public RECYCLING_CENTER(CurrenciesAccepted currenciesAccepted) {
	...
	public RECYCLING_CENTER(Department department) {
	...
	public RECYCLING_CENTER(Description description) {
	...
	public RECYCLING_CENTER(DisambiguatingDescription disambiguatingDescription) {
	...
	public RECYCLING_CENTER(DissolutionDate dissolutionDate) {
	...
	public RECYCLING_CENTER(DiversityPolicy diversityPolicy) {
	...
	public RECYCLING_CENTER(DiversityStaffingReport diversityStaffingReport) {
	...
	public RECYCLING_CENTER(Duns duns) {
		setDuns(duns);
	}
	...
	public RECYCLING_CENTER(Email email) {
		setEmail(email);
	}
	...
	public RECYCLING_CENTER(Employee employee) {
	...
	public RECYCLING_CENTER(EthicsPolicy ethicsPolicy) {
	...
	public RECYCLING_CENTER(Event event) {
		setEvent(event);
	}
	...
	public RECYCLING_CENTER(FaxNumber faxNumber) {
	...
	public RECYCLING_CENTER(Founder founder) {
		setFounder(founder);
	}
	...
	public RECYCLING_CENTER(FoundingDate foundingDate) {
	...
	public RECYCLING_CENTER(FoundingLocation foundingLocation) {
	...
	public RECYCLING_CENTER(Funder funder) {
		setFunder(funder);
	}
	...
	public RECYCLING_CENTER(Geo geo) {
		setGeo(geo);
	}
	...
	public RECYCLING_CENTER(GeospatiallyContains geospatiallyContains) {
	...
	public RECYCLING_CENTER(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public RECYCLING_CENTER(GeospatiallyCovers geospatiallyCovers) {
	...
	public RECYCLING_CENTER(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public RECYCLING_CENTER(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public RECYCLING_CENTER(GeospatiallyEquals geospatiallyEquals) {
	...
	public RECYCLING_CENTER(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public RECYCLING_CENTER(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public RECYCLING_CENTER(GeospatiallyTouches geospatiallyTouches) {
	...
	public RECYCLING_CENTER(GeospatiallyWithin geospatiallyWithin) {
	...
	public RECYCLING_CENTER(GlobalLocationNumber globalLocationNumber) {
	...
	public RECYCLING_CENTER(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public RECYCLING_CENTER(HasOfferCatalog hasOfferCatalog) {
	...
	public RECYCLING_CENTER(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public RECYCLING_CENTER(Identifier identifier) {
	...
	public RECYCLING_CENTER(Image image) {
		setImage(image);
	}
	...
	public RECYCLING_CENTER(IsAccessibleForFree isAccessibleForFree) {
	...
	public RECYCLING_CENTER(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public RECYCLING_CENTER(KnowsAbout knowsAbout) {
	...
	public RECYCLING_CENTER(KnowsLanguage knowsLanguage) {
	...
	public RECYCLING_CENTER(LegalName legalName) {
	...
	public RECYCLING_CENTER(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public RECYCLING_CENTER(Location location) {
	...
	public RECYCLING_CENTER(Logo logo) {
		setLogo(logo);
	}
	...
	public RECYCLING_CENTER(MainEntityOfPage mainEntityOfPage) {
	...
	public RECYCLING_CENTER(MakesOffer makesOffer) {
	...
	public RECYCLING_CENTER(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public RECYCLING_CENTER(Member member) {
		setMember(member);
	}
	...
	public RECYCLING_CENTER(MemberOf memberOf) {
	...
	public RECYCLING_CENTER(Naics naics) {
		setNaics(naics);
	}
	...
	public RECYCLING_CENTER(Name name) {
		setName(name);
	}
	...
	public RECYCLING_CENTER(NameFuzzy nameFuzzy) {
	...
	public RECYCLING_CENTER(NameRuby nameRuby) {
	...
	public RECYCLING_CENTER(NumberOfEmployees numberOfEmployees) {
	...
	public RECYCLING_CENTER(OpeningHours openingHours) {
	...
	public RECYCLING_CENTER(OpeningHoursSpecification openingHoursSpecification) {
	...
	public RECYCLING_CENTER(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public RECYCLING_CENTER(Owns owns) {
		setOwns(owns);
	}
	...
	public RECYCLING_CENTER(ParentOrganization parentOrganization) {
	...
	public RECYCLING_CENTER(PaymentAccepted paymentAccepted) {
	...
	public RECYCLING_CENTER(Photo photo) {
		setPhoto(photo);
	}
	...
	public RECYCLING_CENTER(PotentialAction potentialAction) {
	...
	public RECYCLING_CENTER(PriceRange priceRange) {
	...
	public RECYCLING_CENTER(PublicAccess publicAccess) {
	...
	public RECYCLING_CENTER(PublishingPrinciples publishingPrinciples) {
	...
	public RECYCLING_CENTER(Review review) {
		setReview(review);
	}
	...
	public RECYCLING_CENTER(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RECYCLING_CENTER(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public RECYCLING_CENTER(SmokingAllowed smokingAllowed) {
	...
	public RECYCLING_CENTER(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public RECYCLING_CENTER(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public RECYCLING_CENTER(SubOrganization subOrganization) {
	...
	public RECYCLING_CENTER(SubjectOf subjectOf) {
	...
	public RECYCLING_CENTER(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public RECYCLING_CENTER(Telephone telephone) {
	...
	public RECYCLING_CENTER(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public RECYCLING_CENTER(Url url) {
		setUrl(url);
	}
	...
	public RECYCLING_CENTER(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.RecyclingCenter org) {
		setSeq(org.getSeq());
