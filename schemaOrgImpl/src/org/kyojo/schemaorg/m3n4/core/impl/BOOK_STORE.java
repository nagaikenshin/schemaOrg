...
public class BOOK_STORE implements Clazz.BookStore {
	...
	public BOOK_STORE(Long seq) {
		setSeq(seq);
	}

	public BOOK_STORE(String string) {
	...
	public BOOK_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public BOOK_STORE(AdditionalProperty additionalProperty) {
	...
	public BOOK_STORE(AdditionalType additionalType) {
	...
	public BOOK_STORE(Address address) {
		setAddress(address);
	}
	...
	public BOOK_STORE(AggregateRating aggregateRating) {
	...
	public BOOK_STORE(AlternateName alternateName) {
	...
	public BOOK_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public BOOK_STORE(AmenityFeature amenityFeature) {
	...
	public BOOK_STORE(AreaServed areaServed) {
	...
	public BOOK_STORE(BranchCode branchCode) {
	...
	public BOOK_STORE(ContactPoint contactPoint) {
	...
	public BOOK_STORE(ContainedInPlace containedInPlace) {
	...
	public BOOK_STORE(ContainsPlace containsPlace) {
	...
	public BOOK_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public BOOK_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public BOOK_STORE(Department department) {
	...
	public BOOK_STORE(Description description) {
	...
	public BOOK_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public BOOK_STORE(DissolutionDate dissolutionDate) {
	...
	public BOOK_STORE(DiversityPolicy diversityPolicy) {
	...
	public BOOK_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public BOOK_STORE(Employee employee) {
	...
	public BOOK_STORE(EthicsPolicy ethicsPolicy) {
	...
	public BOOK_STORE(FaxNumber faxNumber) {
	...
	public BOOK_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public BOOK_STORE(FoundingDate foundingDate) {
	...
	public BOOK_STORE(FoundingLocation foundingLocation) {
	...
	public BOOK_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public BOOK_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public BOOK_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public BOOK_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public BOOK_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public BOOK_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public BOOK_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public BOOK_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public BOOK_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public BOOK_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public BOOK_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public BOOK_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public BOOK_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public BOOK_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public BOOK_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public BOOK_STORE(Identifier identifier) {
	...
	public BOOK_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public BOOK_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public BOOK_STORE(KnowsAbout knowsAbout) {
	...
	public BOOK_STORE(KnowsLanguage knowsLanguage) {
	...
	public BOOK_STORE(LegalName legalName) {
	...
	public BOOK_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public BOOK_STORE(Location location) {
	...
	public BOOK_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public BOOK_STORE(MakesOffer makesOffer) {
	...
	public BOOK_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public BOOK_STORE(Member member) {
		setMember(member);
	}
	...
	public BOOK_STORE(MemberOf memberOf) {
	...
	public BOOK_STORE(NameFuzzy nameFuzzy) {
	...
	public BOOK_STORE(NameRuby nameRuby) {
	...
	public BOOK_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public BOOK_STORE(OpeningHours openingHours) {
	...
	public BOOK_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public BOOK_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public BOOK_STORE(ParentOrganization parentOrganization) {
	...
	public BOOK_STORE(PaymentAccepted paymentAccepted) {
	...
	public BOOK_STORE(PotentialAction potentialAction) {
	...
	public BOOK_STORE(PriceRange priceRange) {
	...
	public BOOK_STORE(PublicAccess publicAccess) {
	...
	public BOOK_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public BOOK_STORE(Review review) {
		setReview(review);
	}
	...
	public BOOK_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public BOOK_STORE(SmokingAllowed smokingAllowed) {
	...
	public BOOK_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public BOOK_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public BOOK_STORE(SubOrganization subOrganization) {
	...
	public BOOK_STORE(SubjectOf subjectOf) {
	...
	public BOOK_STORE(Telephone telephone) {
	...
	public BOOK_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.BookStore org) {
		setSeq(org.getSeq());
