...
public class SUGGESTED_MIN_AGE implements Container.SuggestedMinAge {
	...
	public SUGGESTED_MIN_AGE(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public SUGGESTED_MIN_AGE(Float fl0at) {
	...
	public SUGGESTED_MIN_AGE(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public SUGGESTED_MIN_AGE(Integer integer) {
	...
	public SUGGESTED_MIN_AGE(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public SUGGESTED_MIN_AGE(Number number) {
	...
	public SUGGESTED_MIN_AGE(List<Float> fl0atList,
	...
	public void copy(Container.SuggestedMinAge org) {
