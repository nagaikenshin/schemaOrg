...
public class TAXI_STAND implements Clazz.TaxiStand {
	...
	public TAXI_STAND(GeospatiallyContains geospatiallyContains) {
	...
	public TAXI_STAND(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public TAXI_STAND(GeospatiallyCovers geospatiallyCovers) {
	...
	public TAXI_STAND(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public TAXI_STAND(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public TAXI_STAND(GeospatiallyEquals geospatiallyEquals) {
	...
	public TAXI_STAND(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public TAXI_STAND(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public TAXI_STAND(GeospatiallyTouches geospatiallyTouches) {
	...
	public TAXI_STAND(GeospatiallyWithin geospatiallyWithin) {
