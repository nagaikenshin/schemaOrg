...
public class BODY_OF_WATER implements Clazz.BodyOfWater {
	...
	public BODY_OF_WATER() {
	}

	public BODY_OF_WATER(Long seq) {
		setSeq(seq);
	}

	public BODY_OF_WATER(String string) {
	...
	public BODY_OF_WATER(AdditionalProperty additionalProperty) {
	...
	public BODY_OF_WATER(AdditionalType additionalType) {
	...
	public BODY_OF_WATER(Address address) {
		setAddress(address);
	}
	...
	public BODY_OF_WATER(AggregateRating aggregateRating) {
	...
	public BODY_OF_WATER(AlternateName alternateName) {
	...
	public BODY_OF_WATER(AmenityFeature amenityFeature) {
	...
	public BODY_OF_WATER(BranchCode branchCode) {
	...
	public BODY_OF_WATER(ContainedInPlace containedInPlace) {
	...
	public BODY_OF_WATER(ContainsPlace containsPlace) {
	...
	public BODY_OF_WATER(Description description) {
	...
	public BODY_OF_WATER(DisambiguatingDescription disambiguatingDescription) {
	...
	public BODY_OF_WATER(Event event) {
		setEvent(event);
	}
	...
	public BODY_OF_WATER(FaxNumber faxNumber) {
	...
	public BODY_OF_WATER(GeospatiallyContains geospatiallyContains) {
	...
	public BODY_OF_WATER(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public BODY_OF_WATER(GeospatiallyCovers geospatiallyCovers) {
	...
	public BODY_OF_WATER(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public BODY_OF_WATER(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public BODY_OF_WATER(GeospatiallyEquals geospatiallyEquals) {
	...
	public BODY_OF_WATER(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public BODY_OF_WATER(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public BODY_OF_WATER(GeospatiallyTouches geospatiallyTouches) {
	...
	public BODY_OF_WATER(GeospatiallyWithin geospatiallyWithin) {
	...
	public BODY_OF_WATER(GlobalLocationNumber globalLocationNumber) {
	...
	public BODY_OF_WATER(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public BODY_OF_WATER(Identifier identifier) {
	...
	public BODY_OF_WATER(Image image) {
		setImage(image);
	}
	...
	public BODY_OF_WATER(IsAccessibleForFree isAccessibleForFree) {
	...
	public BODY_OF_WATER(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public BODY_OF_WATER(Logo logo) {
		setLogo(logo);
	}
	...
	public BODY_OF_WATER(MainEntityOfPage mainEntityOfPage) {
	...
	public BODY_OF_WATER(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public BODY_OF_WATER(Name name) {
		setName(name);
	}
	...
	public BODY_OF_WATER(NameFuzzy nameFuzzy) {
	...
	public BODY_OF_WATER(NameRuby nameRuby) {
	...
	public BODY_OF_WATER(OpeningHoursSpecification openingHoursSpecification) {
	...
	public BODY_OF_WATER(Photo photo) {
		setPhoto(photo);
	}
	...
	public BODY_OF_WATER(PotentialAction potentialAction) {
	...
	public BODY_OF_WATER(PublicAccess publicAccess) {
	...
	public BODY_OF_WATER(Review review) {
		setReview(review);
	}
	...
	public BODY_OF_WATER(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public BODY_OF_WATER(SmokingAllowed smokingAllowed) {
	...
	public BODY_OF_WATER(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public BODY_OF_WATER(SubjectOf subjectOf) {
	...
	public BODY_OF_WATER(Telephone telephone) {
	...
	public void copy(Clazz.BodyOfWater org) {
		setSeq(org.getSeq());
