...
public class CATHOLIC_CHURCH implements Clazz.CatholicChurch {
	...
	public CATHOLIC_CHURCH(GeospatiallyContains geospatiallyContains) {
	...
	public CATHOLIC_CHURCH(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public CATHOLIC_CHURCH(GeospatiallyCovers geospatiallyCovers) {
	...
	public CATHOLIC_CHURCH(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public CATHOLIC_CHURCH(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public CATHOLIC_CHURCH(GeospatiallyEquals geospatiallyEquals) {
	...
	public CATHOLIC_CHURCH(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public CATHOLIC_CHURCH(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public CATHOLIC_CHURCH(GeospatiallyTouches geospatiallyTouches) {
	...
	public CATHOLIC_CHURCH(GeospatiallyWithin geospatiallyWithin) {
