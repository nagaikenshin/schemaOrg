...
public class DENTIST implements Clazz.Dentist {
	...
	public DENTIST(Long seq) {
		setSeq(seq);
	}

	public DENTIST(String string) {
	...
	public DENTIST(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public DENTIST(AdditionalProperty additionalProperty) {
	...
	public DENTIST(AdditionalType additionalType) {
	...
	public DENTIST(Address address) {
		setAddress(address);
	}
	...
	public DENTIST(AggregateRating aggregateRating) {
	...
	public DENTIST(AlternateName alternateName) {
	...
	public DENTIST(AmenityFeature amenityFeature) {
	...
	public DENTIST(AreaServed areaServed) {
	...
	public DENTIST(BranchCode branchCode) {
	...
	public DENTIST(ContactPoint contactPoint) {
	...
	public DENTIST(ContainedInPlace containedInPlace) {
	...
	public DENTIST(ContainsPlace containsPlace) {
	...
	public DENTIST(CorrectionsPolicy correctionsPolicy) {
	...
	public DENTIST(CurrenciesAccepted currenciesAccepted) {
	...
	public DENTIST(Department department) {
	...
	public DENTIST(Description description) {
	...
	public DENTIST(DisambiguatingDescription disambiguatingDescription) {
	...
	public DENTIST(DissolutionDate dissolutionDate) {
	...
	public DENTIST(DiversityPolicy diversityPolicy) {
	...
	public DENTIST(DiversityStaffingReport diversityStaffingReport) {
	...
	public DENTIST(Employee employee) {
	...
	public DENTIST(EthicsPolicy ethicsPolicy) {
	...
	public DENTIST(FaxNumber faxNumber) {
	...
	public DENTIST(Founder founder) {
		setFounder(founder);
	}
	...
	public DENTIST(FoundingDate foundingDate) {
	...
	public DENTIST(FoundingLocation foundingLocation) {
	...
	public DENTIST(GeospatiallyContains geospatiallyContains) {
	...
	public DENTIST(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public DENTIST(GeospatiallyCovers geospatiallyCovers) {
	...
	public DENTIST(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public DENTIST(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public DENTIST(GeospatiallyEquals geospatiallyEquals) {
	...
	public DENTIST(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public DENTIST(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public DENTIST(GeospatiallyTouches geospatiallyTouches) {
	...
	public DENTIST(GeospatiallyWithin geospatiallyWithin) {
	...
	public DENTIST(GlobalLocationNumber globalLocationNumber) {
	...
	public DENTIST(HasOfferCatalog hasOfferCatalog) {
	...
	public DENTIST(HealthPlanNetworkId healthPlanNetworkId) {
	...
	public DENTIST(Identifier identifier) {
	...
	public DENTIST(IsAcceptingNewPatients isAcceptingNewPatients) {
	...
	public DENTIST(IsAccessibleForFree isAccessibleForFree) {
	...
	public DENTIST(KnowsAbout knowsAbout) {
	...
	public DENTIST(KnowsLanguage knowsLanguage) {
	...
	public DENTIST(LegalName legalName) {
	...
	public DENTIST(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public DENTIST(Location location) {
	...
	public DENTIST(MainEntityOfPage mainEntityOfPage) {
	...
	public DENTIST(MakesOffer makesOffer) {
	...
	public DENTIST(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public DENTIST(MedicalSpecialty medicalSpecialty) {
	...
	public DENTIST(MemberOf memberOf) {
	...
	public DENTIST(NameFuzzy nameFuzzy) {
	...
	public DENTIST(NameRuby nameRuby) {
	...
	public DENTIST(NumberOfEmployees numberOfEmployees) {
	...
	public DENTIST(OpeningHours openingHours) {
	...
	public DENTIST(OpeningHoursSpecification openingHoursSpecification) {
	...
	public DENTIST(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public DENTIST(ParentOrganization parentOrganization) {
	...
	public DENTIST(PaymentAccepted paymentAccepted) {
	...
	public DENTIST(PotentialAction potentialAction) {
	...
	public DENTIST(PriceRange priceRange) {
	...
	public DENTIST(PublicAccess publicAccess) {
	...
	public DENTIST(PublishingPrinciples publishingPrinciples) {
	...
	public DENTIST(SmokingAllowed smokingAllowed) {
	...
	public DENTIST(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public DENTIST(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public DENTIST(SubOrganization subOrganization) {
	...
	public DENTIST(SubjectOf subjectOf) {
	...
	public DENTIST(Telephone telephone) {
	...
	public DENTIST(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Dentist org) {
		setSeq(org.getSeq());
