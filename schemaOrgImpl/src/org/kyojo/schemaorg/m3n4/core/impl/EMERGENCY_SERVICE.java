...
public class EMERGENCY_SERVICE implements Clazz.EmergencyService {
	...
	public EMERGENCY_SERVICE() {
	}

	public EMERGENCY_SERVICE(Long seq) {
		setSeq(seq);
	}

	public EMERGENCY_SERVICE(String string) {
	...
	public EMERGENCY_SERVICE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public EMERGENCY_SERVICE(AdditionalProperty additionalProperty) {
	...
	public EMERGENCY_SERVICE(AdditionalType additionalType) {
	...
	public EMERGENCY_SERVICE(Address address) {
		setAddress(address);
	}
	...
	public EMERGENCY_SERVICE(AggregateRating aggregateRating) {
	...
	public EMERGENCY_SERVICE(AlternateName alternateName) {
	...
	public EMERGENCY_SERVICE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public EMERGENCY_SERVICE(AmenityFeature amenityFeature) {
	...
	public EMERGENCY_SERVICE(AreaServed areaServed) {
	...
	public EMERGENCY_SERVICE(Award award) {
		setAward(award);
	}
	...
	public EMERGENCY_SERVICE(BranchCode branchCode) {
	...
	public EMERGENCY_SERVICE(Brand brand) {
		setBrand(brand);
	}
	...
	public EMERGENCY_SERVICE(ContactPoint contactPoint) {
	...
	public EMERGENCY_SERVICE(ContainedInPlace containedInPlace) {
	...
	public EMERGENCY_SERVICE(ContainsPlace containsPlace) {
	...
	public EMERGENCY_SERVICE(CorrectionsPolicy correctionsPolicy) {
	...
	public EMERGENCY_SERVICE(CurrenciesAccepted currenciesAccepted) {
	...
	public EMERGENCY_SERVICE(Department department) {
	...
	public EMERGENCY_SERVICE(Description description) {
	...
	public EMERGENCY_SERVICE(DisambiguatingDescription disambiguatingDescription) {
	...
	public EMERGENCY_SERVICE(DissolutionDate dissolutionDate) {
	...
	public EMERGENCY_SERVICE(DiversityPolicy diversityPolicy) {
	...
	public EMERGENCY_SERVICE(DiversityStaffingReport diversityStaffingReport) {
	...
	public EMERGENCY_SERVICE(Duns duns) {
		setDuns(duns);
	}
	...
	public EMERGENCY_SERVICE(Email email) {
		setEmail(email);
	}
	...
	public EMERGENCY_SERVICE(Employee employee) {
	...
	public EMERGENCY_SERVICE(EthicsPolicy ethicsPolicy) {
	...
	public EMERGENCY_SERVICE(Event event) {
		setEvent(event);
	}
	...
	public EMERGENCY_SERVICE(FaxNumber faxNumber) {
	...
	public EMERGENCY_SERVICE(Founder founder) {
		setFounder(founder);
	}
	...
	public EMERGENCY_SERVICE(FoundingDate foundingDate) {
	...
	public EMERGENCY_SERVICE(FoundingLocation foundingLocation) {
	...
	public EMERGENCY_SERVICE(Funder funder) {
		setFunder(funder);
	}
	...
	public EMERGENCY_SERVICE(Geo geo) {
		setGeo(geo);
	}
	...
	public EMERGENCY_SERVICE(GeospatiallyContains geospatiallyContains) {
	...
	public EMERGENCY_SERVICE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public EMERGENCY_SERVICE(GeospatiallyCovers geospatiallyCovers) {
	...
	public EMERGENCY_SERVICE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public EMERGENCY_SERVICE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public EMERGENCY_SERVICE(GeospatiallyEquals geospatiallyEquals) {
	...
	public EMERGENCY_SERVICE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public EMERGENCY_SERVICE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public EMERGENCY_SERVICE(GeospatiallyTouches geospatiallyTouches) {
	...
	public EMERGENCY_SERVICE(GeospatiallyWithin geospatiallyWithin) {
	...
	public EMERGENCY_SERVICE(GlobalLocationNumber globalLocationNumber) {
	...
	public EMERGENCY_SERVICE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public EMERGENCY_SERVICE(HasOfferCatalog hasOfferCatalog) {
	...
	public EMERGENCY_SERVICE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public EMERGENCY_SERVICE(Identifier identifier) {
	...
	public EMERGENCY_SERVICE(Image image) {
		setImage(image);
	}
	...
	public EMERGENCY_SERVICE(IsAccessibleForFree isAccessibleForFree) {
	...
	public EMERGENCY_SERVICE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public EMERGENCY_SERVICE(KnowsAbout knowsAbout) {
	...
	public EMERGENCY_SERVICE(KnowsLanguage knowsLanguage) {
	...
	public EMERGENCY_SERVICE(LegalName legalName) {
	...
	public EMERGENCY_SERVICE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public EMERGENCY_SERVICE(Location location) {
	...
	public EMERGENCY_SERVICE(Logo logo) {
		setLogo(logo);
	}
	...
	public EMERGENCY_SERVICE(MainEntityOfPage mainEntityOfPage) {
	...
	public EMERGENCY_SERVICE(MakesOffer makesOffer) {
	...
	public EMERGENCY_SERVICE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public EMERGENCY_SERVICE(Member member) {
		setMember(member);
	}
	...
	public EMERGENCY_SERVICE(MemberOf memberOf) {
	...
	public EMERGENCY_SERVICE(Naics naics) {
		setNaics(naics);
	}
	...
	public EMERGENCY_SERVICE(Name name) {
		setName(name);
	}
	...
	public EMERGENCY_SERVICE(NameFuzzy nameFuzzy) {
	...
	public EMERGENCY_SERVICE(NameRuby nameRuby) {
	...
	public EMERGENCY_SERVICE(NumberOfEmployees numberOfEmployees) {
	...
	public EMERGENCY_SERVICE(OpeningHours openingHours) {
	...
	public EMERGENCY_SERVICE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public EMERGENCY_SERVICE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public EMERGENCY_SERVICE(Owns owns) {
		setOwns(owns);
	}
	...
	public EMERGENCY_SERVICE(ParentOrganization parentOrganization) {
	...
	public EMERGENCY_SERVICE(PaymentAccepted paymentAccepted) {
	...
	public EMERGENCY_SERVICE(Photo photo) {
		setPhoto(photo);
	}
	...
	public EMERGENCY_SERVICE(PotentialAction potentialAction) {
	...
	public EMERGENCY_SERVICE(PriceRange priceRange) {
	...
	public EMERGENCY_SERVICE(PublicAccess publicAccess) {
	...
	public EMERGENCY_SERVICE(PublishingPrinciples publishingPrinciples) {
	...
	public EMERGENCY_SERVICE(Review review) {
		setReview(review);
	}
	...
	public EMERGENCY_SERVICE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public EMERGENCY_SERVICE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public EMERGENCY_SERVICE(SmokingAllowed smokingAllowed) {
	...
	public EMERGENCY_SERVICE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public EMERGENCY_SERVICE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public EMERGENCY_SERVICE(SubOrganization subOrganization) {
	...
	public EMERGENCY_SERVICE(SubjectOf subjectOf) {
	...
	public EMERGENCY_SERVICE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public EMERGENCY_SERVICE(Telephone telephone) {
	...
	public EMERGENCY_SERVICE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public EMERGENCY_SERVICE(Url url) {
		setUrl(url);
	}
	...
	public EMERGENCY_SERVICE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.EmergencyService org) {
		setSeq(org.getSeq());
