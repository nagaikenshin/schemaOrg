...
public class GAS_STATION implements Clazz.GasStation {
	...
	public GAS_STATION(Long seq) {
		setSeq(seq);
	}

	public GAS_STATION(String string) {
	...
	public GAS_STATION(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public GAS_STATION(AdditionalProperty additionalProperty) {
	...
	public GAS_STATION(AdditionalType additionalType) {
	...
	public GAS_STATION(Address address) {
		setAddress(address);
	}
	...
	public GAS_STATION(AggregateRating aggregateRating) {
	...
	public GAS_STATION(AlternateName alternateName) {
	...
	public GAS_STATION(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public GAS_STATION(AmenityFeature amenityFeature) {
	...
	public GAS_STATION(AreaServed areaServed) {
	...
	public GAS_STATION(Award award) {
		setAward(award);
	}
	...
	public GAS_STATION(BranchCode branchCode) {
	...
	public GAS_STATION(Brand brand) {
		setBrand(brand);
	}
	...
	public GAS_STATION(ContactPoint contactPoint) {
	...
	public GAS_STATION(ContainedInPlace containedInPlace) {
	...
	public GAS_STATION(ContainsPlace containsPlace) {
	...
	public GAS_STATION(CorrectionsPolicy correctionsPolicy) {
	...
	public GAS_STATION(CurrenciesAccepted currenciesAccepted) {
	...
	public GAS_STATION(Department department) {
	...
	public GAS_STATION(Description description) {
	...
	public GAS_STATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public GAS_STATION(DissolutionDate dissolutionDate) {
	...
	public GAS_STATION(DiversityPolicy diversityPolicy) {
	...
	public GAS_STATION(DiversityStaffingReport diversityStaffingReport) {
	...
	public GAS_STATION(Email email) {
		setEmail(email);
	}
	...
	public GAS_STATION(Employee employee) {
	...
	public GAS_STATION(EthicsPolicy ethicsPolicy) {
	...
	public GAS_STATION(Event event) {
		setEvent(event);
	}
	...
	public GAS_STATION(FaxNumber faxNumber) {
	...
	public GAS_STATION(Founder founder) {
		setFounder(founder);
	}
	...
	public GAS_STATION(FoundingDate foundingDate) {
	...
	public GAS_STATION(FoundingLocation foundingLocation) {
	...
	public GAS_STATION(Funder funder) {
		setFunder(funder);
	}
	...
	public GAS_STATION(GeospatiallyContains geospatiallyContains) {
	...
	public GAS_STATION(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public GAS_STATION(GeospatiallyCovers geospatiallyCovers) {
	...
	public GAS_STATION(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public GAS_STATION(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public GAS_STATION(GeospatiallyEquals geospatiallyEquals) {
	...
	public GAS_STATION(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public GAS_STATION(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public GAS_STATION(GeospatiallyTouches geospatiallyTouches) {
	...
	public GAS_STATION(GeospatiallyWithin geospatiallyWithin) {
	...
	public GAS_STATION(GlobalLocationNumber globalLocationNumber) {
	...
	public GAS_STATION(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public GAS_STATION(HasOfferCatalog hasOfferCatalog) {
	...
	public GAS_STATION(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public GAS_STATION(Identifier identifier) {
	...
	public GAS_STATION(Image image) {
		setImage(image);
	}
	...
	public GAS_STATION(IsAccessibleForFree isAccessibleForFree) {
	...
	public GAS_STATION(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public GAS_STATION(KnowsAbout knowsAbout) {
	...
	public GAS_STATION(KnowsLanguage knowsLanguage) {
	...
	public GAS_STATION(LegalName legalName) {
	...
	public GAS_STATION(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public GAS_STATION(Location location) {
	...
	public GAS_STATION(MainEntityOfPage mainEntityOfPage) {
	...
	public GAS_STATION(MakesOffer makesOffer) {
	...
	public GAS_STATION(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public GAS_STATION(Member member) {
		setMember(member);
	}
	...
	public GAS_STATION(MemberOf memberOf) {
	...
	public GAS_STATION(Naics naics) {
		setNaics(naics);
	}
	...
	public GAS_STATION(NameFuzzy nameFuzzy) {
	...
	public GAS_STATION(NameRuby nameRuby) {
	...
	public GAS_STATION(NumberOfEmployees numberOfEmployees) {
	...
	public GAS_STATION(OpeningHours openingHours) {
	...
	public GAS_STATION(OpeningHoursSpecification openingHoursSpecification) {
	...
	public GAS_STATION(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public GAS_STATION(ParentOrganization parentOrganization) {
	...
	public GAS_STATION(PaymentAccepted paymentAccepted) {
	...
	public GAS_STATION(Photo photo) {
		setPhoto(photo);
	}
	...
	public GAS_STATION(PotentialAction potentialAction) {
	...
	public GAS_STATION(PriceRange priceRange) {
	...
	public GAS_STATION(PublicAccess publicAccess) {
	...
	public GAS_STATION(PublishingPrinciples publishingPrinciples) {
	...
	public GAS_STATION(Review review) {
		setReview(review);
	}
	...
	public GAS_STATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public GAS_STATION(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public GAS_STATION(SmokingAllowed smokingAllowed) {
	...
	public GAS_STATION(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public GAS_STATION(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public GAS_STATION(SubOrganization subOrganization) {
	...
	public GAS_STATION(SubjectOf subjectOf) {
	...
	public GAS_STATION(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public GAS_STATION(Telephone telephone) {
	...
	public GAS_STATION(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public GAS_STATION(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.GasStation org) {
		setSeq(org.getSeq());
