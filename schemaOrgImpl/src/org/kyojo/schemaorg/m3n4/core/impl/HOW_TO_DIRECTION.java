...
import org.kyojo.schemaorg.m3n4.core.Container.AfterMedia;
...
public class HOW_TO_DIRECTION implements Clazz.HowToDirection {
	...
	public HOW_TO_DIRECTION(About about) {
		setAbout(about);
	}
	...
	public HOW_TO_DIRECTION(AccessMode accessMode) {
	...
	public HOW_TO_DIRECTION(AccessModeSufficient accessModeSufficient) {
	...
	public HOW_TO_DIRECTION(AccessibilityAPI accessibilityAPI) {
	...
	public HOW_TO_DIRECTION(AccessibilityControl accessibilityControl) {
	...
	public HOW_TO_DIRECTION(AccessibilityFeature accessibilityFeature) {
	...
	public HOW_TO_DIRECTION(AccessibilityHazard accessibilityHazard) {
	...
	public HOW_TO_DIRECTION(AccessibilitySummary accessibilitySummary) {
	...
	public HOW_TO_DIRECTION(AccountablePerson accountablePerson) {
	...
	public HOW_TO_DIRECTION(AggregateRating aggregateRating) {
	...
	public HOW_TO_DIRECTION(AlternativeHeadline alternativeHeadline) {
	...
	public HOW_TO_DIRECTION(AssociatedMedia associatedMedia) {
	...
	public HOW_TO_DIRECTION(Audience audience) {
	...
	public HOW_TO_DIRECTION(Audio audio) {
		setAudio(audio);
	}
	...
	public HOW_TO_DIRECTION(Author author) {
		setAuthor(author);
	}
	...
	public HOW_TO_DIRECTION(Award award) {
		setAward(award);
	}
	...
	public HOW_TO_DIRECTION(Character character) {
	...
	public HOW_TO_DIRECTION(Citation citation) {
	...
	public HOW_TO_DIRECTION(Comment comment) {
		setComment(comment);
	}
	...
	public HOW_TO_DIRECTION(CommentCount commentCount) {
	...
	public HOW_TO_DIRECTION(ContentLocation contentLocation) {
	...
	public HOW_TO_DIRECTION(ContentRating contentRating) {
	...
	public HOW_TO_DIRECTION(ContentReferenceTime contentReferenceTime) {
	...
	public HOW_TO_DIRECTION(Contributor contributor) {
	...
	public HOW_TO_DIRECTION(CopyrightHolder copyrightHolder) {
	...
	public HOW_TO_DIRECTION(CopyrightYear copyrightYear) {
	...
	public HOW_TO_DIRECTION(Correction correction) {
	...
	public HOW_TO_DIRECTION(Creator creator) {
		setCreator(creator);
	}
	...
	public HOW_TO_DIRECTION(DateCreated dateCreated) {
	...
	public HOW_TO_DIRECTION(DateModified dateModified) {
	...
	public HOW_TO_DIRECTION(DatePublished datePublished) {
	...
	public HOW_TO_DIRECTION(DiscussionUrl discussionUrl) {
	...
	public HOW_TO_DIRECTION(Editor editor) {
		setEditor(editor);
	}
	...
	public HOW_TO_DIRECTION(EducationalAlignment educationalAlignment) {
	...
	public HOW_TO_DIRECTION(EducationalUse educationalUse) {
	...
	public HOW_TO_DIRECTION(Encoding encoding) {
	...
	public HOW_TO_DIRECTION(EncodingFormat encodingFormat) {
	...
	public HOW_TO_DIRECTION(ExampleOfWork exampleOfWork) {
	...
	public HOW_TO_DIRECTION(Expires expires) {
		setExpires(expires);
	}
	...
	public HOW_TO_DIRECTION(Funder funder) {
		setFunder(funder);
	}
	...
	public HOW_TO_DIRECTION(Genre genre) {
		setGenre(genre);
	}
	...
	public HOW_TO_DIRECTION(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public HOW_TO_DIRECTION(Headline headline) {
	...
	public HOW_TO_DIRECTION(InLanguage inLanguage) {
	...
	public HOW_TO_DIRECTION(InteractionStatistic interactionStatistic) {
	...
	public HOW_TO_DIRECTION(InteractivityType interactivityType) {
	...
	public HOW_TO_DIRECTION(IsAccessibleForFree isAccessibleForFree) {
	...
	public HOW_TO_DIRECTION(IsBasedOn isBasedOn) {
	...
	public HOW_TO_DIRECTION(IsFamilyFriendly isFamilyFriendly) {
	...
	public HOW_TO_DIRECTION(IsPartOf isPartOf) {
	...
	public HOW_TO_DIRECTION(Keywords keywords) {
	...
	public HOW_TO_DIRECTION(LearningResourceType learningResourceType) {
	...
	public HOW_TO_DIRECTION(License license) {
		setLicense(license);
	}
	...
	public HOW_TO_DIRECTION(LocationCreated locationCreated) {
	...
	public HOW_TO_DIRECTION(MainEntity mainEntity) {
	...
	public HOW_TO_DIRECTION(Material material) {
	...
	public HOW_TO_DIRECTION(Mentions mentions) {
	...
	public HOW_TO_DIRECTION(Offers offers) {
		setOffers(offers);
	}
	...
	public HOW_TO_DIRECTION(Producer producer) {
	...
	public HOW_TO_DIRECTION(Provider provider) {
	...
	public HOW_TO_DIRECTION(Publication publication) {
	...
	public HOW_TO_DIRECTION(Publisher publisher) {
	...
	public HOW_TO_DIRECTION(PublisherImprint publisherImprint) {
	...
	public HOW_TO_DIRECTION(PublishingPrinciples publishingPrinciples) {
	...
	public HOW_TO_DIRECTION(RecordedAt recordedAt) {
	...
	public HOW_TO_DIRECTION(ReleasedEvent releasedEvent) {
	...
	public HOW_TO_DIRECTION(Review review) {
		setReview(review);
	}
	...
	public HOW_TO_DIRECTION(SchemaVersion schemaVersion) {
	...
	public HOW_TO_DIRECTION(SdDatePublished sdDatePublished) {
	...
	public HOW_TO_DIRECTION(SdLicense sdLicense) {
	...
	public HOW_TO_DIRECTION(SdPublisher sdPublisher) {
	...
	public HOW_TO_DIRECTION(SourceOrganization sourceOrganization) {
	...
	public HOW_TO_DIRECTION(SpatialCoverage spatialCoverage) {
	...
	public HOW_TO_DIRECTION(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public HOW_TO_DIRECTION(SubjectOf subjectOf) {
	...
	public HOW_TO_DIRECTION(TemporalCoverage temporalCoverage) {
	...
	public HOW_TO_DIRECTION(Text text) {
		setText(text);
	}
	...
	public HOW_TO_DIRECTION(ThumbnailUrl thumbnailUrl) {
	...
	public HOW_TO_DIRECTION(TimeRequired timeRequired) {
	...
	public HOW_TO_DIRECTION(TranslationOfWork translationOfWork) {
	...
	public HOW_TO_DIRECTION(Translator translator) {
	...
	public HOW_TO_DIRECTION(TypicalAgeRange typicalAgeRange) {
	...
	public HOW_TO_DIRECTION(Version version) {
		setVersion(version);
	}
	...
	public HOW_TO_DIRECTION(Video video) {
		setVideo(video);
	}
	...
	public HOW_TO_DIRECTION(WorkExample workExample) {
	...
	public HOW_TO_DIRECTION(WorkTranslation workTranslation) {
