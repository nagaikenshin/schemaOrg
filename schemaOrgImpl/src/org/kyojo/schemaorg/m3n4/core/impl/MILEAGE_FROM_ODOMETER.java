...
public class MILEAGE_FROM_ODOMETER implements Container.MileageFromOdometer {
	...
	public MILEAGE_FROM_ODOMETER(String string) {
	...
	public MILEAGE_FROM_ODOMETER(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public MILEAGE_FROM_ODOMETER(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public MILEAGE_FROM_ODOMETER(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public MILEAGE_FROM_ODOMETER(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.MileageFromOdometer org) {
