...
public class PLACE_OF_WORSHIP implements Clazz.PlaceOfWorship {
	...
	public PLACE_OF_WORSHIP() {
	}

	public PLACE_OF_WORSHIP(Long seq) {
		setSeq(seq);
	}

	public PLACE_OF_WORSHIP(String string) {
	...
	public PLACE_OF_WORSHIP(AdditionalProperty additionalProperty) {
	...
	public PLACE_OF_WORSHIP(AdditionalType additionalType) {
	...
	public PLACE_OF_WORSHIP(Address address) {
		setAddress(address);
	}
	...
	public PLACE_OF_WORSHIP(AggregateRating aggregateRating) {
	...
	public PLACE_OF_WORSHIP(AlternateName alternateName) {
	...
	public PLACE_OF_WORSHIP(AmenityFeature amenityFeature) {
	...
	public PLACE_OF_WORSHIP(BranchCode branchCode) {
	...
	public PLACE_OF_WORSHIP(ContainedInPlace containedInPlace) {
	...
	public PLACE_OF_WORSHIP(ContainsPlace containsPlace) {
	...
	public PLACE_OF_WORSHIP(Description description) {
	...
	public PLACE_OF_WORSHIP(DisambiguatingDescription disambiguatingDescription) {
	...
	public PLACE_OF_WORSHIP(Event event) {
		setEvent(event);
	}
	...
	public PLACE_OF_WORSHIP(FaxNumber faxNumber) {
	...
	public PLACE_OF_WORSHIP(Geo geo) {
		setGeo(geo);
	}
	...
	public PLACE_OF_WORSHIP(GeospatiallyContains geospatiallyContains) {
	...
	public PLACE_OF_WORSHIP(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public PLACE_OF_WORSHIP(GeospatiallyCovers geospatiallyCovers) {
	...
	public PLACE_OF_WORSHIP(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public PLACE_OF_WORSHIP(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public PLACE_OF_WORSHIP(GeospatiallyEquals geospatiallyEquals) {
	...
	public PLACE_OF_WORSHIP(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public PLACE_OF_WORSHIP(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public PLACE_OF_WORSHIP(GeospatiallyTouches geospatiallyTouches) {
	...
	public PLACE_OF_WORSHIP(GeospatiallyWithin geospatiallyWithin) {
	...
	public PLACE_OF_WORSHIP(GlobalLocationNumber globalLocationNumber) {
	...
	public PLACE_OF_WORSHIP(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public PLACE_OF_WORSHIP(Identifier identifier) {
	...
	public PLACE_OF_WORSHIP(Image image) {
		setImage(image);
	}
	...
	public PLACE_OF_WORSHIP(IsAccessibleForFree isAccessibleForFree) {
	...
	public PLACE_OF_WORSHIP(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public PLACE_OF_WORSHIP(Logo logo) {
		setLogo(logo);
	}
	...
	public PLACE_OF_WORSHIP(MainEntityOfPage mainEntityOfPage) {
	...
	public PLACE_OF_WORSHIP(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public PLACE_OF_WORSHIP(Name name) {
		setName(name);
	}
	...
	public PLACE_OF_WORSHIP(NameFuzzy nameFuzzy) {
	...
	public PLACE_OF_WORSHIP(NameRuby nameRuby) {
	...
	public PLACE_OF_WORSHIP(OpeningHours openingHours) {
	...
	public PLACE_OF_WORSHIP(OpeningHoursSpecification openingHoursSpecification) {
	...
	public PLACE_OF_WORSHIP(Photo photo) {
		setPhoto(photo);
	}
	...
	public PLACE_OF_WORSHIP(PotentialAction potentialAction) {
	...
	public PLACE_OF_WORSHIP(PublicAccess publicAccess) {
	...
	public PLACE_OF_WORSHIP(Review review) {
		setReview(review);
	}
	...
	public PLACE_OF_WORSHIP(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PLACE_OF_WORSHIP(SmokingAllowed smokingAllowed) {
	...
	public PLACE_OF_WORSHIP(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public PLACE_OF_WORSHIP(SubjectOf subjectOf) {
	...
	public PLACE_OF_WORSHIP(Telephone telephone) {
	...
	public PLACE_OF_WORSHIP(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.PlaceOfWorship org) {
		setSeq(org.getSeq());
