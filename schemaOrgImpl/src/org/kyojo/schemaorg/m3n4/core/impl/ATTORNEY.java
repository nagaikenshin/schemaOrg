...
public class ATTORNEY implements Clazz.Attorney {
	...
	public ATTORNEY(Long seq) {
		setSeq(seq);
	}

	public ATTORNEY(String string) {
	...
	public ATTORNEY(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public ATTORNEY(AdditionalProperty additionalProperty) {
	...
	public ATTORNEY(AdditionalType additionalType) {
	...
	public ATTORNEY(Address address) {
		setAddress(address);
	}
	...
	public ATTORNEY(AggregateRating aggregateRating) {
	...
	public ATTORNEY(AlternateName alternateName) {
	...
	public ATTORNEY(AmenityFeature amenityFeature) {
	...
	public ATTORNEY(AreaServed areaServed) {
	...
	public ATTORNEY(BranchCode branchCode) {
	...
	public ATTORNEY(ContactPoint contactPoint) {
	...
	public ATTORNEY(ContainedInPlace containedInPlace) {
	...
	public ATTORNEY(ContainsPlace containsPlace) {
	...
	public ATTORNEY(CorrectionsPolicy correctionsPolicy) {
	...
	public ATTORNEY(CurrenciesAccepted currenciesAccepted) {
	...
	public ATTORNEY(Department department) {
	...
	public ATTORNEY(Description description) {
	...
	public ATTORNEY(DisambiguatingDescription disambiguatingDescription) {
	...
	public ATTORNEY(DissolutionDate dissolutionDate) {
	...
	public ATTORNEY(DiversityPolicy diversityPolicy) {
	...
	public ATTORNEY(DiversityStaffingReport diversityStaffingReport) {
	...
	public ATTORNEY(Employee employee) {
	...
	public ATTORNEY(EthicsPolicy ethicsPolicy) {
	...
	public ATTORNEY(FaxNumber faxNumber) {
	...
	public ATTORNEY(Founder founder) {
		setFounder(founder);
	}
	...
	public ATTORNEY(FoundingDate foundingDate) {
	...
	public ATTORNEY(FoundingLocation foundingLocation) {
	...
	public ATTORNEY(GeospatiallyContains geospatiallyContains) {
	...
	public ATTORNEY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public ATTORNEY(GeospatiallyCovers geospatiallyCovers) {
	...
	public ATTORNEY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public ATTORNEY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public ATTORNEY(GeospatiallyEquals geospatiallyEquals) {
	...
	public ATTORNEY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public ATTORNEY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public ATTORNEY(GeospatiallyTouches geospatiallyTouches) {
	...
	public ATTORNEY(GeospatiallyWithin geospatiallyWithin) {
	...
	public ATTORNEY(GlobalLocationNumber globalLocationNumber) {
	...
	public ATTORNEY(HasOfferCatalog hasOfferCatalog) {
	...
	public ATTORNEY(Identifier identifier) {
	...
	public ATTORNEY(IsAccessibleForFree isAccessibleForFree) {
	...
	public ATTORNEY(KnowsAbout knowsAbout) {
	...
	public ATTORNEY(KnowsLanguage knowsLanguage) {
	...
	public ATTORNEY(LegalName legalName) {
	...
	public ATTORNEY(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public ATTORNEY(Location location) {
	...
	public ATTORNEY(MainEntityOfPage mainEntityOfPage) {
	...
	public ATTORNEY(MakesOffer makesOffer) {
	...
	public ATTORNEY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public ATTORNEY(MemberOf memberOf) {
	...
	public ATTORNEY(NameFuzzy nameFuzzy) {
	...
	public ATTORNEY(NameRuby nameRuby) {
	...
	public ATTORNEY(NumberOfEmployees numberOfEmployees) {
	...
	public ATTORNEY(OpeningHours openingHours) {
	...
	public ATTORNEY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public ATTORNEY(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public ATTORNEY(ParentOrganization parentOrganization) {
	...
	public ATTORNEY(PaymentAccepted paymentAccepted) {
	...
	public ATTORNEY(PotentialAction potentialAction) {
	...
	public ATTORNEY(PriceRange priceRange) {
	...
	public ATTORNEY(PublicAccess publicAccess) {
	...
	public ATTORNEY(PublishingPrinciples publishingPrinciples) {
	...
	public ATTORNEY(SmokingAllowed smokingAllowed) {
	...
	public ATTORNEY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public ATTORNEY(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public ATTORNEY(SubOrganization subOrganization) {
	...
	public ATTORNEY(SubjectOf subjectOf) {
	...
	public ATTORNEY(Telephone telephone) {
	...
	public ATTORNEY(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Attorney org) {
		setSeq(org.getSeq());
