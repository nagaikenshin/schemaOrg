...
public class PARK implements Clazz.Park {
	...
	public PARK(AdditionalProperty additionalProperty) {
	...
	public PARK(AdditionalType additionalType) {
	...
	public PARK(AggregateRating aggregateRating) {
	...
	public PARK(AlternateName alternateName) {
	...
	public PARK(AmenityFeature amenityFeature) {
	...
	public PARK(BranchCode branchCode) {
	...
	public PARK(ContainedInPlace containedInPlace) {
	...
	public PARK(ContainsPlace containsPlace) {
	...
	public PARK(Description description) {
	...
	public PARK(DisambiguatingDescription disambiguatingDescription) {
	...
	public PARK(FaxNumber faxNumber) {
	...
	public PARK(GeospatiallyContains geospatiallyContains) {
	...
	public PARK(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public PARK(GeospatiallyCovers geospatiallyCovers) {
	...
	public PARK(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public PARK(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public PARK(GeospatiallyEquals geospatiallyEquals) {
	...
	public PARK(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public PARK(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public PARK(GeospatiallyTouches geospatiallyTouches) {
	...
	public PARK(GeospatiallyWithin geospatiallyWithin) {
	...
	public PARK(GlobalLocationNumber globalLocationNumber) {
	...
	public PARK(Identifier identifier) {
	...
	public PARK(IsAccessibleForFree isAccessibleForFree) {
	...
	public PARK(MainEntityOfPage mainEntityOfPage) {
	...
	public PARK(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public PARK(NameFuzzy nameFuzzy) {
	...
	public PARK(OpeningHours openingHours) {
	...
	public PARK(OpeningHoursSpecification openingHoursSpecification) {
	...
	public PARK(PotentialAction potentialAction) {
	...
	public PARK(PublicAccess publicAccess) {
	...
	public PARK(SmokingAllowed smokingAllowed) {
	...
	public PARK(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public PARK(SubjectOf subjectOf) {
	...
	public PARK(Telephone telephone) {
	...
	public void copy(Clazz.Park org) {
		setSeq(org.getSeq());
