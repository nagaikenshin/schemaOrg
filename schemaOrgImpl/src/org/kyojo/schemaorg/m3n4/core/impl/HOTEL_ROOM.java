...
public class HOTEL_ROOM implements Clazz.HotelRoom {
	...
	public HOTEL_ROOM(Long seq) {
		setSeq(seq);
	}

	public HOTEL_ROOM(String string) {
	...
	public HOTEL_ROOM(AdditionalProperty additionalProperty) {
	...
	public HOTEL_ROOM(AdditionalType additionalType) {
	...
	public HOTEL_ROOM(Address address) {
		setAddress(address);
	}
	...
	public HOTEL_ROOM(AggregateRating aggregateRating) {
	...
	public HOTEL_ROOM(AlternateName alternateName) {
	...
	public HOTEL_ROOM(AmenityFeature amenityFeature) {
	...
	public HOTEL_ROOM(BranchCode branchCode) {
	...
	public HOTEL_ROOM(ContainedInPlace containedInPlace) {
	...
	public HOTEL_ROOM(ContainsPlace containsPlace) {
	...
	public HOTEL_ROOM(Description description) {
	...
	public HOTEL_ROOM(DisambiguatingDescription disambiguatingDescription) {
	...
	public HOTEL_ROOM(FaxNumber faxNumber) {
	...
	public HOTEL_ROOM(FloorSize floorSize) {
	...
	public HOTEL_ROOM(GeospatiallyContains geospatiallyContains) {
	...
	public HOTEL_ROOM(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public HOTEL_ROOM(GeospatiallyCovers geospatiallyCovers) {
	...
	public HOTEL_ROOM(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public HOTEL_ROOM(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public HOTEL_ROOM(GeospatiallyEquals geospatiallyEquals) {
	...
	public HOTEL_ROOM(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public HOTEL_ROOM(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public HOTEL_ROOM(GeospatiallyTouches geospatiallyTouches) {
	...
	public HOTEL_ROOM(GeospatiallyWithin geospatiallyWithin) {
	...
	public HOTEL_ROOM(GlobalLocationNumber globalLocationNumber) {
	...
	public HOTEL_ROOM(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public HOTEL_ROOM(Identifier identifier) {
	...
	public HOTEL_ROOM(IsAccessibleForFree isAccessibleForFree) {
	...
	public HOTEL_ROOM(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public HOTEL_ROOM(MainEntityOfPage mainEntityOfPage) {
	...
	public HOTEL_ROOM(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public HOTEL_ROOM(NameFuzzy nameFuzzy) {
	...
	public HOTEL_ROOM(NameRuby nameRuby) {
	...
	public HOTEL_ROOM(NumberOfRooms numberOfRooms) {
	...
	public HOTEL_ROOM(Occupancy occupancy) {
	...
	public HOTEL_ROOM(OpeningHoursSpecification openingHoursSpecification) {
	...
	public HOTEL_ROOM(PermittedUsage permittedUsage) {
	...
	public HOTEL_ROOM(PetsAllowed petsAllowed) {
	...
	public HOTEL_ROOM(PotentialAction potentialAction) {
	...
	public HOTEL_ROOM(PublicAccess publicAccess) {
	...
	public HOTEL_ROOM(Review review) {
		setReview(review);
	}
	...
	public HOTEL_ROOM(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public HOTEL_ROOM(SmokingAllowed smokingAllowed) {
	...
	public HOTEL_ROOM(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public HOTEL_ROOM(SubjectOf subjectOf) {
	...
	public HOTEL_ROOM(Telephone telephone) {
	...
	public void copy(Clazz.HotelRoom org) {
		setSeq(org.getSeq());
