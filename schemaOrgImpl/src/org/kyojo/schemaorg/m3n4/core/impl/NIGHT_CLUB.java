...
public class NIGHT_CLUB implements Clazz.NightClub {
	...
	public NIGHT_CLUB(Long seq) {
		setSeq(seq);
	}

	public NIGHT_CLUB(String string) {
	...
	public NIGHT_CLUB(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public NIGHT_CLUB(AdditionalProperty additionalProperty) {
	...
	public NIGHT_CLUB(AdditionalType additionalType) {
	...
	public NIGHT_CLUB(Address address) {
		setAddress(address);
	}
	...
	public NIGHT_CLUB(AggregateRating aggregateRating) {
	...
	public NIGHT_CLUB(AlternateName alternateName) {
	...
	public NIGHT_CLUB(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public NIGHT_CLUB(AmenityFeature amenityFeature) {
	...
	public NIGHT_CLUB(AreaServed areaServed) {
	...
	public NIGHT_CLUB(BranchCode branchCode) {
	...
	public NIGHT_CLUB(ContactPoint contactPoint) {
	...
	public NIGHT_CLUB(ContainedInPlace containedInPlace) {
	...
	public NIGHT_CLUB(ContainsPlace containsPlace) {
	...
	public NIGHT_CLUB(CorrectionsPolicy correctionsPolicy) {
	...
	public NIGHT_CLUB(CurrenciesAccepted currenciesAccepted) {
	...
	public NIGHT_CLUB(Department department) {
	...
	public NIGHT_CLUB(Description description) {
	...
	public NIGHT_CLUB(DisambiguatingDescription disambiguatingDescription) {
	...
	public NIGHT_CLUB(DissolutionDate dissolutionDate) {
	...
	public NIGHT_CLUB(DiversityPolicy diversityPolicy) {
	...
	public NIGHT_CLUB(DiversityStaffingReport diversityStaffingReport) {
	...
	public NIGHT_CLUB(Employee employee) {
	...
	public NIGHT_CLUB(EthicsPolicy ethicsPolicy) {
	...
	public NIGHT_CLUB(FaxNumber faxNumber) {
	...
	public NIGHT_CLUB(Founder founder) {
		setFounder(founder);
	}
	...
	public NIGHT_CLUB(FoundingDate foundingDate) {
	...
	public NIGHT_CLUB(FoundingLocation foundingLocation) {
	...
	public NIGHT_CLUB(Funder funder) {
		setFunder(funder);
	}
	...
	public NIGHT_CLUB(GeospatiallyContains geospatiallyContains) {
	...
	public NIGHT_CLUB(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public NIGHT_CLUB(GeospatiallyCovers geospatiallyCovers) {
	...
	public NIGHT_CLUB(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public NIGHT_CLUB(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public NIGHT_CLUB(GeospatiallyEquals geospatiallyEquals) {
	...
	public NIGHT_CLUB(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public NIGHT_CLUB(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public NIGHT_CLUB(GeospatiallyTouches geospatiallyTouches) {
	...
	public NIGHT_CLUB(GeospatiallyWithin geospatiallyWithin) {
	...
	public NIGHT_CLUB(GlobalLocationNumber globalLocationNumber) {
	...
	public NIGHT_CLUB(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public NIGHT_CLUB(HasOfferCatalog hasOfferCatalog) {
	...
	public NIGHT_CLUB(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public NIGHT_CLUB(Identifier identifier) {
	...
	public NIGHT_CLUB(IsAccessibleForFree isAccessibleForFree) {
	...
	public NIGHT_CLUB(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public NIGHT_CLUB(KnowsAbout knowsAbout) {
	...
	public NIGHT_CLUB(KnowsLanguage knowsLanguage) {
	...
	public NIGHT_CLUB(LegalName legalName) {
	...
	public NIGHT_CLUB(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public NIGHT_CLUB(Location location) {
	...
	public NIGHT_CLUB(MainEntityOfPage mainEntityOfPage) {
	...
	public NIGHT_CLUB(MakesOffer makesOffer) {
	...
	public NIGHT_CLUB(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public NIGHT_CLUB(Member member) {
		setMember(member);
	}
	...
	public NIGHT_CLUB(MemberOf memberOf) {
	...
	public NIGHT_CLUB(NameFuzzy nameFuzzy) {
	...
	public NIGHT_CLUB(NameRuby nameRuby) {
	...
	public NIGHT_CLUB(NumberOfEmployees numberOfEmployees) {
	...
	public NIGHT_CLUB(OpeningHours openingHours) {
	...
	public NIGHT_CLUB(OpeningHoursSpecification openingHoursSpecification) {
	...
	public NIGHT_CLUB(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public NIGHT_CLUB(ParentOrganization parentOrganization) {
	...
	public NIGHT_CLUB(PaymentAccepted paymentAccepted) {
	...
	public NIGHT_CLUB(PotentialAction potentialAction) {
	...
	public NIGHT_CLUB(PriceRange priceRange) {
	...
	public NIGHT_CLUB(PublicAccess publicAccess) {
	...
	public NIGHT_CLUB(PublishingPrinciples publishingPrinciples) {
	...
	public NIGHT_CLUB(Review review) {
		setReview(review);
	}
	...
	public NIGHT_CLUB(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public NIGHT_CLUB(SmokingAllowed smokingAllowed) {
	...
	public NIGHT_CLUB(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public NIGHT_CLUB(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public NIGHT_CLUB(SubOrganization subOrganization) {
	...
	public NIGHT_CLUB(SubjectOf subjectOf) {
	...
	public NIGHT_CLUB(Telephone telephone) {
	...
	public NIGHT_CLUB(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.NightClub org) {
		setSeq(org.getSeq());
