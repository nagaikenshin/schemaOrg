...
public class HOME_GOODS_STORE implements Clazz.HomeGoodsStore {
	...
	public HOME_GOODS_STORE() {
	}

	public HOME_GOODS_STORE(Long seq) {
		setSeq(seq);
	}

	public HOME_GOODS_STORE(String string) {
	...
	public HOME_GOODS_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public HOME_GOODS_STORE(AdditionalProperty additionalProperty) {
	...
	public HOME_GOODS_STORE(AdditionalType additionalType) {
	...
	public HOME_GOODS_STORE(Address address) {
		setAddress(address);
	}
	...
	public HOME_GOODS_STORE(AggregateRating aggregateRating) {
	...
	public HOME_GOODS_STORE(AlternateName alternateName) {
	...
	public HOME_GOODS_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public HOME_GOODS_STORE(AmenityFeature amenityFeature) {
	...
	public HOME_GOODS_STORE(AreaServed areaServed) {
	...
	public HOME_GOODS_STORE(Award award) {
		setAward(award);
	}
	...
	public HOME_GOODS_STORE(BranchCode branchCode) {
	...
	public HOME_GOODS_STORE(Brand brand) {
		setBrand(brand);
	}
	...
	public HOME_GOODS_STORE(ContactPoint contactPoint) {
	...
	public HOME_GOODS_STORE(ContainedInPlace containedInPlace) {
	...
	public HOME_GOODS_STORE(ContainsPlace containsPlace) {
	...
	public HOME_GOODS_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public HOME_GOODS_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public HOME_GOODS_STORE(Department department) {
	...
	public HOME_GOODS_STORE(Description description) {
	...
	public HOME_GOODS_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public HOME_GOODS_STORE(DissolutionDate dissolutionDate) {
	...
	public HOME_GOODS_STORE(DiversityPolicy diversityPolicy) {
	...
	public HOME_GOODS_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public HOME_GOODS_STORE(Duns duns) {
		setDuns(duns);
	}
	...
	public HOME_GOODS_STORE(Email email) {
		setEmail(email);
	}
	...
	public HOME_GOODS_STORE(Employee employee) {
	...
	public HOME_GOODS_STORE(EthicsPolicy ethicsPolicy) {
	...
	public HOME_GOODS_STORE(Event event) {
		setEvent(event);
	}
	...
	public HOME_GOODS_STORE(FaxNumber faxNumber) {
	...
	public HOME_GOODS_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public HOME_GOODS_STORE(FoundingDate foundingDate) {
	...
	public HOME_GOODS_STORE(FoundingLocation foundingLocation) {
	...
	public HOME_GOODS_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public HOME_GOODS_STORE(Geo geo) {
		setGeo(geo);
	}
	...
	public HOME_GOODS_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public HOME_GOODS_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public HOME_GOODS_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public HOME_GOODS_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public HOME_GOODS_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public HOME_GOODS_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public HOME_GOODS_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public HOME_GOODS_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public HOME_GOODS_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public HOME_GOODS_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public HOME_GOODS_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public HOME_GOODS_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public HOME_GOODS_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public HOME_GOODS_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public HOME_GOODS_STORE(Identifier identifier) {
	...
	public HOME_GOODS_STORE(Image image) {
		setImage(image);
	}
	...
	public HOME_GOODS_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public HOME_GOODS_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public HOME_GOODS_STORE(KnowsAbout knowsAbout) {
	...
	public HOME_GOODS_STORE(KnowsLanguage knowsLanguage) {
	...
	public HOME_GOODS_STORE(LegalName legalName) {
	...
	public HOME_GOODS_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public HOME_GOODS_STORE(Location location) {
	...
	public HOME_GOODS_STORE(Logo logo) {
		setLogo(logo);
	}
	...
	public HOME_GOODS_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public HOME_GOODS_STORE(MakesOffer makesOffer) {
	...
	public HOME_GOODS_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public HOME_GOODS_STORE(Member member) {
		setMember(member);
	}
	...
	public HOME_GOODS_STORE(MemberOf memberOf) {
	...
	public HOME_GOODS_STORE(Naics naics) {
		setNaics(naics);
	}
	...
	public HOME_GOODS_STORE(Name name) {
		setName(name);
	}
	...
	public HOME_GOODS_STORE(NameFuzzy nameFuzzy) {
	...
	public HOME_GOODS_STORE(NameRuby nameRuby) {
	...
	public HOME_GOODS_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public HOME_GOODS_STORE(OpeningHours openingHours) {
	...
	public HOME_GOODS_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public HOME_GOODS_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public HOME_GOODS_STORE(Owns owns) {
		setOwns(owns);
	}
	...
	public HOME_GOODS_STORE(ParentOrganization parentOrganization) {
	...
	public HOME_GOODS_STORE(PaymentAccepted paymentAccepted) {
	...
	public HOME_GOODS_STORE(Photo photo) {
		setPhoto(photo);
	}
	...
	public HOME_GOODS_STORE(PotentialAction potentialAction) {
	...
	public HOME_GOODS_STORE(PriceRange priceRange) {
	...
	public HOME_GOODS_STORE(PublicAccess publicAccess) {
	...
	public HOME_GOODS_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public HOME_GOODS_STORE(Review review) {
		setReview(review);
	}
	...
	public HOME_GOODS_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public HOME_GOODS_STORE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public HOME_GOODS_STORE(SmokingAllowed smokingAllowed) {
	...
	public HOME_GOODS_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public HOME_GOODS_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public HOME_GOODS_STORE(SubOrganization subOrganization) {
	...
	public HOME_GOODS_STORE(SubjectOf subjectOf) {
	...
	public HOME_GOODS_STORE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public HOME_GOODS_STORE(Telephone telephone) {
	...
	public HOME_GOODS_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public HOME_GOODS_STORE(Url url) {
		setUrl(url);
	}
	...
	public HOME_GOODS_STORE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.HomeGoodsStore org) {
		setSeq(org.getSeq());
