...
public class MOTORCYCLE_REPAIR implements Clazz.MotorcycleRepair {
	...
	public MOTORCYCLE_REPAIR() {
	}

	public MOTORCYCLE_REPAIR(Long seq) {
		setSeq(seq);
	}

	public MOTORCYCLE_REPAIR(String string) {
	...
	public MOTORCYCLE_REPAIR(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public MOTORCYCLE_REPAIR(AdditionalProperty additionalProperty) {
	...
	public MOTORCYCLE_REPAIR(AdditionalType additionalType) {
	...
	public MOTORCYCLE_REPAIR(Address address) {
		setAddress(address);
	}
	...
	public MOTORCYCLE_REPAIR(AggregateRating aggregateRating) {
	...
	public MOTORCYCLE_REPAIR(AlternateName alternateName) {
	...
	public MOTORCYCLE_REPAIR(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public MOTORCYCLE_REPAIR(AmenityFeature amenityFeature) {
	...
	public MOTORCYCLE_REPAIR(AreaServed areaServed) {
	...
	public MOTORCYCLE_REPAIR(Award award) {
		setAward(award);
	}
	...
	public MOTORCYCLE_REPAIR(BranchCode branchCode) {
	...
	public MOTORCYCLE_REPAIR(Brand brand) {
		setBrand(brand);
	}
	...
	public MOTORCYCLE_REPAIR(ContactPoint contactPoint) {
	...
	public MOTORCYCLE_REPAIR(ContainedInPlace containedInPlace) {
	...
	public MOTORCYCLE_REPAIR(ContainsPlace containsPlace) {
	...
	public MOTORCYCLE_REPAIR(CorrectionsPolicy correctionsPolicy) {
	...
	public MOTORCYCLE_REPAIR(CurrenciesAccepted currenciesAccepted) {
	...
	public MOTORCYCLE_REPAIR(Department department) {
	...
	public MOTORCYCLE_REPAIR(Description description) {
	...
	public MOTORCYCLE_REPAIR(DisambiguatingDescription disambiguatingDescription) {
	...
	public MOTORCYCLE_REPAIR(DissolutionDate dissolutionDate) {
	...
	public MOTORCYCLE_REPAIR(DiversityPolicy diversityPolicy) {
	...
	public MOTORCYCLE_REPAIR(DiversityStaffingReport diversityStaffingReport) {
	...
	public MOTORCYCLE_REPAIR(Duns duns) {
		setDuns(duns);
	}
	...
	public MOTORCYCLE_REPAIR(Email email) {
		setEmail(email);
	}
	...
	public MOTORCYCLE_REPAIR(Employee employee) {
	...
	public MOTORCYCLE_REPAIR(EthicsPolicy ethicsPolicy) {
	...
	public MOTORCYCLE_REPAIR(Event event) {
		setEvent(event);
	}
	...
	public MOTORCYCLE_REPAIR(FaxNumber faxNumber) {
	...
	public MOTORCYCLE_REPAIR(Founder founder) {
		setFounder(founder);
	}
	...
	public MOTORCYCLE_REPAIR(FoundingDate foundingDate) {
	...
	public MOTORCYCLE_REPAIR(FoundingLocation foundingLocation) {
	...
	public MOTORCYCLE_REPAIR(Funder funder) {
		setFunder(funder);
	}
	...
	public MOTORCYCLE_REPAIR(Geo geo) {
		setGeo(geo);
	}
	...
	public MOTORCYCLE_REPAIR(GeospatiallyContains geospatiallyContains) {
	...
	public MOTORCYCLE_REPAIR(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public MOTORCYCLE_REPAIR(GeospatiallyCovers geospatiallyCovers) {
	...
	public MOTORCYCLE_REPAIR(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public MOTORCYCLE_REPAIR(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public MOTORCYCLE_REPAIR(GeospatiallyEquals geospatiallyEquals) {
	...
	public MOTORCYCLE_REPAIR(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public MOTORCYCLE_REPAIR(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public MOTORCYCLE_REPAIR(GeospatiallyTouches geospatiallyTouches) {
	...
	public MOTORCYCLE_REPAIR(GeospatiallyWithin geospatiallyWithin) {
	...
	public MOTORCYCLE_REPAIR(GlobalLocationNumber globalLocationNumber) {
	...
	public MOTORCYCLE_REPAIR(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public MOTORCYCLE_REPAIR(HasOfferCatalog hasOfferCatalog) {
	...
	public MOTORCYCLE_REPAIR(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public MOTORCYCLE_REPAIR(Identifier identifier) {
	...
	public MOTORCYCLE_REPAIR(Image image) {
		setImage(image);
	}
	...
	public MOTORCYCLE_REPAIR(IsAccessibleForFree isAccessibleForFree) {
	...
	public MOTORCYCLE_REPAIR(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public MOTORCYCLE_REPAIR(KnowsAbout knowsAbout) {
	...
	public MOTORCYCLE_REPAIR(KnowsLanguage knowsLanguage) {
	...
	public MOTORCYCLE_REPAIR(LegalName legalName) {
	...
	public MOTORCYCLE_REPAIR(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public MOTORCYCLE_REPAIR(Location location) {
	...
	public MOTORCYCLE_REPAIR(Logo logo) {
		setLogo(logo);
	}
	...
	public MOTORCYCLE_REPAIR(MainEntityOfPage mainEntityOfPage) {
	...
	public MOTORCYCLE_REPAIR(MakesOffer makesOffer) {
	...
	public MOTORCYCLE_REPAIR(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public MOTORCYCLE_REPAIR(Member member) {
		setMember(member);
	}
	...
	public MOTORCYCLE_REPAIR(MemberOf memberOf) {
	...
	public MOTORCYCLE_REPAIR(Naics naics) {
		setNaics(naics);
	}
	...
	public MOTORCYCLE_REPAIR(Name name) {
		setName(name);
	}
	...
	public MOTORCYCLE_REPAIR(NameFuzzy nameFuzzy) {
	...
	public MOTORCYCLE_REPAIR(NameRuby nameRuby) {
	...
	public MOTORCYCLE_REPAIR(NumberOfEmployees numberOfEmployees) {
	...
	public MOTORCYCLE_REPAIR(OpeningHours openingHours) {
	...
	public MOTORCYCLE_REPAIR(OpeningHoursSpecification openingHoursSpecification) {
	...
	public MOTORCYCLE_REPAIR(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public MOTORCYCLE_REPAIR(Owns owns) {
		setOwns(owns);
	}
	...
	public MOTORCYCLE_REPAIR(ParentOrganization parentOrganization) {
	...
	public MOTORCYCLE_REPAIR(PaymentAccepted paymentAccepted) {
	...
	public MOTORCYCLE_REPAIR(Photo photo) {
		setPhoto(photo);
	}
	...
	public MOTORCYCLE_REPAIR(PotentialAction potentialAction) {
	...
	public MOTORCYCLE_REPAIR(PriceRange priceRange) {
	...
	public MOTORCYCLE_REPAIR(PublicAccess publicAccess) {
	...
	public MOTORCYCLE_REPAIR(PublishingPrinciples publishingPrinciples) {
	...
	public MOTORCYCLE_REPAIR(Review review) {
		setReview(review);
	}
	...
	public MOTORCYCLE_REPAIR(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MOTORCYCLE_REPAIR(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public MOTORCYCLE_REPAIR(SmokingAllowed smokingAllowed) {
	...
	public MOTORCYCLE_REPAIR(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public MOTORCYCLE_REPAIR(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MOTORCYCLE_REPAIR(SubOrganization subOrganization) {
	...
	public MOTORCYCLE_REPAIR(SubjectOf subjectOf) {
	...
	public MOTORCYCLE_REPAIR(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public MOTORCYCLE_REPAIR(Telephone telephone) {
	...
	public MOTORCYCLE_REPAIR(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public MOTORCYCLE_REPAIR(Url url) {
		setUrl(url);
	}
	...
	public MOTORCYCLE_REPAIR(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.MotorcycleRepair org) {
		setSeq(org.getSeq());
