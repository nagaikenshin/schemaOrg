...
public class CHECK_IN_ACTION implements Clazz.CheckInAction {
	...
	public CHECK_IN_ACTION() {
	}

	public CHECK_IN_ACTION(Long seq) {
		setSeq(seq);
	}

	public CHECK_IN_ACTION(String string) {
	...
	public CHECK_IN_ACTION(About about) {
		setAbout(about);
	}
	...
	public CHECK_IN_ACTION(ActionStatus actionStatus) {
	...
	public CHECK_IN_ACTION(AdditionalType additionalType) {
	...
	public CHECK_IN_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public CHECK_IN_ACTION(AlternateName alternateName) {
	...
	public CHECK_IN_ACTION(Description description) {
	...
	public CHECK_IN_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public CHECK_IN_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public CHECK_IN_ACTION(Error error) {
		setError(error);
	}
	...
	public CHECK_IN_ACTION(Identifier identifier) {
	...
	public CHECK_IN_ACTION(Image image) {
		setImage(image);
	}
	...
	public CHECK_IN_ACTION(InLanguage inLanguage) {
	...
	public CHECK_IN_ACTION(Instrument instrument) {
	...
	public CHECK_IN_ACTION(Location location) {
	...
	public CHECK_IN_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public CHECK_IN_ACTION(Name name) {
		setName(name);
	}
	...
	public CHECK_IN_ACTION(NameFuzzy nameFuzzy) {
	...
	public CHECK_IN_ACTION(NameRuby nameRuby) {
	...
	public CHECK_IN_ACTION(Object object) {
		setObject(object);
	}
	...
	public CHECK_IN_ACTION(Participant participant) {
	...
	public CHECK_IN_ACTION(PotentialAction potentialAction) {
	...
	public CHECK_IN_ACTION(Recipient recipient) {
	...
	public CHECK_IN_ACTION(Result result) {
		setResult(result);
	}
	...
	public CHECK_IN_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CHECK_IN_ACTION(StartTime startTime) {
	...
	public CHECK_IN_ACTION(SubjectOf subjectOf) {
	...
	public CHECK_IN_ACTION(Target target) {
		setTarget(target);
	}
	...
	public CHECK_IN_ACTION(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.CheckInAction org) {
		setSeq(org.getSeq());
