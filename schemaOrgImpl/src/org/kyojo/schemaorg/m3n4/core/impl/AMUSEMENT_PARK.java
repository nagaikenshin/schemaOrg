...
public class AMUSEMENT_PARK implements Clazz.AmusementPark {
	...
	public AMUSEMENT_PARK(Long seq) {
		setSeq(seq);
	}

	public AMUSEMENT_PARK(String string) {
	...
	public AMUSEMENT_PARK(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public AMUSEMENT_PARK(AdditionalProperty additionalProperty) {
	...
	public AMUSEMENT_PARK(AdditionalType additionalType) {
	...
	public AMUSEMENT_PARK(Address address) {
		setAddress(address);
	}
	...
	public AMUSEMENT_PARK(AggregateRating aggregateRating) {
	...
	public AMUSEMENT_PARK(AlternateName alternateName) {
	...
	public AMUSEMENT_PARK(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public AMUSEMENT_PARK(AmenityFeature amenityFeature) {
	...
	public AMUSEMENT_PARK(AreaServed areaServed) {
	...
	public AMUSEMENT_PARK(Award award) {
		setAward(award);
	}
	...
	public AMUSEMENT_PARK(BranchCode branchCode) {
	...
	public AMUSEMENT_PARK(Brand brand) {
		setBrand(brand);
	}
	...
	public AMUSEMENT_PARK(ContactPoint contactPoint) {
	...
	public AMUSEMENT_PARK(ContainedInPlace containedInPlace) {
	...
	public AMUSEMENT_PARK(ContainsPlace containsPlace) {
	...
	public AMUSEMENT_PARK(CorrectionsPolicy correctionsPolicy) {
	...
	public AMUSEMENT_PARK(CurrenciesAccepted currenciesAccepted) {
	...
	public AMUSEMENT_PARK(Department department) {
	...
	public AMUSEMENT_PARK(Description description) {
	...
	public AMUSEMENT_PARK(DisambiguatingDescription disambiguatingDescription) {
	...
	public AMUSEMENT_PARK(DissolutionDate dissolutionDate) {
	...
	public AMUSEMENT_PARK(DiversityPolicy diversityPolicy) {
	...
	public AMUSEMENT_PARK(DiversityStaffingReport diversityStaffingReport) {
	...
	public AMUSEMENT_PARK(Duns duns) {
		setDuns(duns);
	}
	...
	public AMUSEMENT_PARK(Email email) {
		setEmail(email);
	}
	...
	public AMUSEMENT_PARK(Employee employee) {
	...
	public AMUSEMENT_PARK(EthicsPolicy ethicsPolicy) {
	...
	public AMUSEMENT_PARK(Event event) {
		setEvent(event);
	}
	...
	public AMUSEMENT_PARK(FaxNumber faxNumber) {
	...
	public AMUSEMENT_PARK(Founder founder) {
		setFounder(founder);
	}
	...
	public AMUSEMENT_PARK(FoundingDate foundingDate) {
	...
	public AMUSEMENT_PARK(FoundingLocation foundingLocation) {
	...
	public AMUSEMENT_PARK(Funder funder) {
		setFunder(funder);
	}
	...
	public AMUSEMENT_PARK(GeospatiallyContains geospatiallyContains) {
	...
	public AMUSEMENT_PARK(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public AMUSEMENT_PARK(GeospatiallyCovers geospatiallyCovers) {
	...
	public AMUSEMENT_PARK(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public AMUSEMENT_PARK(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public AMUSEMENT_PARK(GeospatiallyEquals geospatiallyEquals) {
	...
	public AMUSEMENT_PARK(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public AMUSEMENT_PARK(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public AMUSEMENT_PARK(GeospatiallyTouches geospatiallyTouches) {
	...
	public AMUSEMENT_PARK(GeospatiallyWithin geospatiallyWithin) {
	...
	public AMUSEMENT_PARK(GlobalLocationNumber globalLocationNumber) {
	...
	public AMUSEMENT_PARK(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public AMUSEMENT_PARK(HasOfferCatalog hasOfferCatalog) {
	...
	public AMUSEMENT_PARK(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public AMUSEMENT_PARK(Identifier identifier) {
	...
	public AMUSEMENT_PARK(Image image) {
		setImage(image);
	}
	...
	public AMUSEMENT_PARK(IsAccessibleForFree isAccessibleForFree) {
	...
	public AMUSEMENT_PARK(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public AMUSEMENT_PARK(KnowsAbout knowsAbout) {
	...
	public AMUSEMENT_PARK(KnowsLanguage knowsLanguage) {
	...
	public AMUSEMENT_PARK(LegalName legalName) {
	...
	public AMUSEMENT_PARK(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public AMUSEMENT_PARK(Location location) {
	...
	public AMUSEMENT_PARK(Logo logo) {
		setLogo(logo);
	}
	...
	public AMUSEMENT_PARK(MainEntityOfPage mainEntityOfPage) {
	...
	public AMUSEMENT_PARK(MakesOffer makesOffer) {
	...
	public AMUSEMENT_PARK(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public AMUSEMENT_PARK(Member member) {
		setMember(member);
	}
	...
	public AMUSEMENT_PARK(MemberOf memberOf) {
	...
	public AMUSEMENT_PARK(Naics naics) {
		setNaics(naics);
	}
	...
	public AMUSEMENT_PARK(Name name) {
		setName(name);
	}
	...
	public AMUSEMENT_PARK(NameFuzzy nameFuzzy) {
	...
	public AMUSEMENT_PARK(NameRuby nameRuby) {
	...
	public AMUSEMENT_PARK(NumberOfEmployees numberOfEmployees) {
	...
	public AMUSEMENT_PARK(OpeningHours openingHours) {
	...
	public AMUSEMENT_PARK(OpeningHoursSpecification openingHoursSpecification) {
	...
	public AMUSEMENT_PARK(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public AMUSEMENT_PARK(Owns owns) {
		setOwns(owns);
	}
	...
	public AMUSEMENT_PARK(ParentOrganization parentOrganization) {
	...
	public AMUSEMENT_PARK(PaymentAccepted paymentAccepted) {
	...
	public AMUSEMENT_PARK(Photo photo) {
		setPhoto(photo);
	}
	...
	public AMUSEMENT_PARK(PotentialAction potentialAction) {
	...
	public AMUSEMENT_PARK(PriceRange priceRange) {
	...
	public AMUSEMENT_PARK(PublicAccess publicAccess) {
	...
	public AMUSEMENT_PARK(PublishingPrinciples publishingPrinciples) {
	...
	public AMUSEMENT_PARK(Review review) {
		setReview(review);
	}
	...
	public AMUSEMENT_PARK(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public AMUSEMENT_PARK(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public AMUSEMENT_PARK(SmokingAllowed smokingAllowed) {
	...
	public AMUSEMENT_PARK(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public AMUSEMENT_PARK(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public AMUSEMENT_PARK(SubOrganization subOrganization) {
	...
	public AMUSEMENT_PARK(SubjectOf subjectOf) {
	...
	public AMUSEMENT_PARK(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public AMUSEMENT_PARK(Telephone telephone) {
	...
	public AMUSEMENT_PARK(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public AMUSEMENT_PARK(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.AmusementPark org) {
		setSeq(org.getSeq());
