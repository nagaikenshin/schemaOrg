...
public class POLICE_STATION implements Clazz.PoliceStation {
	...
	public POLICE_STATION(Long seq) {
		setSeq(seq);
	}

	public POLICE_STATION(String string) {
	...
	public POLICE_STATION(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public POLICE_STATION(AdditionalProperty additionalProperty) {
	...
	public POLICE_STATION(AdditionalType additionalType) {
	...
	public POLICE_STATION(Address address) {
		setAddress(address);
	}
	...
	public POLICE_STATION(AggregateRating aggregateRating) {
	...
	public POLICE_STATION(AlternateName alternateName) {
	...
	public POLICE_STATION(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public POLICE_STATION(AmenityFeature amenityFeature) {
	...
	public POLICE_STATION(AreaServed areaServed) {
	...
	public POLICE_STATION(Award award) {
		setAward(award);
	}
	...
	public POLICE_STATION(BranchCode branchCode) {
	...
	public POLICE_STATION(Brand brand) {
		setBrand(brand);
	}
	...
	public POLICE_STATION(ContactPoint contactPoint) {
	...
	public POLICE_STATION(ContainedInPlace containedInPlace) {
	...
	public POLICE_STATION(ContainsPlace containsPlace) {
	...
	public POLICE_STATION(CorrectionsPolicy correctionsPolicy) {
	...
	public POLICE_STATION(CurrenciesAccepted currenciesAccepted) {
	...
	public POLICE_STATION(Department department) {
	...
	public POLICE_STATION(Description description) {
	...
	public POLICE_STATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public POLICE_STATION(DissolutionDate dissolutionDate) {
	...
	public POLICE_STATION(DiversityPolicy diversityPolicy) {
	...
	public POLICE_STATION(DiversityStaffingReport diversityStaffingReport) {
	...
	public POLICE_STATION(Duns duns) {
		setDuns(duns);
	}
	...
	public POLICE_STATION(Email email) {
		setEmail(email);
	}
	...
	public POLICE_STATION(Employee employee) {
	...
	public POLICE_STATION(EthicsPolicy ethicsPolicy) {
	...
	public POLICE_STATION(Event event) {
		setEvent(event);
	}
	...
	public POLICE_STATION(FaxNumber faxNumber) {
	...
	public POLICE_STATION(Founder founder) {
		setFounder(founder);
	}
	...
	public POLICE_STATION(FoundingDate foundingDate) {
	...
	public POLICE_STATION(FoundingLocation foundingLocation) {
	...
	public POLICE_STATION(Funder funder) {
		setFunder(funder);
	}
	...
	public POLICE_STATION(GeospatiallyContains geospatiallyContains) {
	...
	public POLICE_STATION(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public POLICE_STATION(GeospatiallyCovers geospatiallyCovers) {
	...
	public POLICE_STATION(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public POLICE_STATION(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public POLICE_STATION(GeospatiallyEquals geospatiallyEquals) {
	...
	public POLICE_STATION(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public POLICE_STATION(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public POLICE_STATION(GeospatiallyTouches geospatiallyTouches) {
	...
	public POLICE_STATION(GeospatiallyWithin geospatiallyWithin) {
	...
	public POLICE_STATION(GlobalLocationNumber globalLocationNumber) {
	...
	public POLICE_STATION(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public POLICE_STATION(HasOfferCatalog hasOfferCatalog) {
	...
	public POLICE_STATION(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public POLICE_STATION(Identifier identifier) {
	...
	public POLICE_STATION(Image image) {
		setImage(image);
	}
	...
	public POLICE_STATION(IsAccessibleForFree isAccessibleForFree) {
	...
	public POLICE_STATION(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public POLICE_STATION(KnowsAbout knowsAbout) {
	...
	public POLICE_STATION(KnowsLanguage knowsLanguage) {
	...
	public POLICE_STATION(LegalName legalName) {
	...
	public POLICE_STATION(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public POLICE_STATION(Location location) {
	...
	public POLICE_STATION(Logo logo) {
		setLogo(logo);
	}
	...
	public POLICE_STATION(MainEntityOfPage mainEntityOfPage) {
	...
	public POLICE_STATION(MakesOffer makesOffer) {
	...
	public POLICE_STATION(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public POLICE_STATION(Member member) {
		setMember(member);
	}
	...
	public POLICE_STATION(MemberOf memberOf) {
	...
	public POLICE_STATION(Naics naics) {
		setNaics(naics);
	}
	...
	public POLICE_STATION(Name name) {
		setName(name);
	}
	...
	public POLICE_STATION(NameFuzzy nameFuzzy) {
	...
	public POLICE_STATION(NameRuby nameRuby) {
	...
	public POLICE_STATION(NumberOfEmployees numberOfEmployees) {
	...
	public POLICE_STATION(OpeningHours openingHours) {
	...
	public POLICE_STATION(OpeningHoursSpecification openingHoursSpecification) {
	...
	public POLICE_STATION(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public POLICE_STATION(Owns owns) {
		setOwns(owns);
	}
	...
	public POLICE_STATION(ParentOrganization parentOrganization) {
	...
	public POLICE_STATION(PaymentAccepted paymentAccepted) {
	...
	public POLICE_STATION(Photo photo) {
		setPhoto(photo);
	}
	...
	public POLICE_STATION(PotentialAction potentialAction) {
	...
	public POLICE_STATION(PriceRange priceRange) {
	...
	public POLICE_STATION(PublicAccess publicAccess) {
	...
	public POLICE_STATION(PublishingPrinciples publishingPrinciples) {
	...
	public POLICE_STATION(Review review) {
		setReview(review);
	}
	...
	public POLICE_STATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public POLICE_STATION(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public POLICE_STATION(SmokingAllowed smokingAllowed) {
	...
	public POLICE_STATION(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public POLICE_STATION(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public POLICE_STATION(SubOrganization subOrganization) {
	...
	public POLICE_STATION(SubjectOf subjectOf) {
	...
	public POLICE_STATION(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public POLICE_STATION(Telephone telephone) {
	...
	public POLICE_STATION(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public POLICE_STATION(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.PoliceStation org) {
		setSeq(org.getSeq());
