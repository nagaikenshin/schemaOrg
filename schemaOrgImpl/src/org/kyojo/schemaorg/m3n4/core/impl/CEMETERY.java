...
public class CEMETERY implements Clazz.Cemetery {
	...
	public CEMETERY(Long seq) {
		setSeq(seq);
	}

	public CEMETERY(String string) {
	...
	public CEMETERY(AdditionalProperty additionalProperty) {
	...
	public CEMETERY(AdditionalType additionalType) {
	...
	public CEMETERY(Address address) {
		setAddress(address);
	}
	...
	public CEMETERY(AggregateRating aggregateRating) {
	...
	public CEMETERY(AlternateName alternateName) {
	...
	public CEMETERY(AmenityFeature amenityFeature) {
	...
	public CEMETERY(BranchCode branchCode) {
	...
	public CEMETERY(ContainedInPlace containedInPlace) {
	...
	public CEMETERY(ContainsPlace containsPlace) {
	...
	public CEMETERY(Description description) {
	...
	public CEMETERY(DisambiguatingDescription disambiguatingDescription) {
	...
	public CEMETERY(FaxNumber faxNumber) {
	...
	public CEMETERY(GeospatiallyContains geospatiallyContains) {
	...
	public CEMETERY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public CEMETERY(GeospatiallyCovers geospatiallyCovers) {
	...
	public CEMETERY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public CEMETERY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public CEMETERY(GeospatiallyEquals geospatiallyEquals) {
	...
	public CEMETERY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public CEMETERY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public CEMETERY(GeospatiallyTouches geospatiallyTouches) {
	...
	public CEMETERY(GeospatiallyWithin geospatiallyWithin) {
	...
	public CEMETERY(GlobalLocationNumber globalLocationNumber) {
	...
	public CEMETERY(Identifier identifier) {
	...
	public CEMETERY(IsAccessibleForFree isAccessibleForFree) {
	...
	public CEMETERY(MainEntityOfPage mainEntityOfPage) {
	...
	public CEMETERY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public CEMETERY(NameFuzzy nameFuzzy) {
	...
	public CEMETERY(NameRuby nameRuby) {
	...
	public CEMETERY(OpeningHours openingHours) {
	...
	public CEMETERY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public CEMETERY(PotentialAction potentialAction) {
	...
	public CEMETERY(PublicAccess publicAccess) {
	...
	public CEMETERY(SmokingAllowed smokingAllowed) {
	...
	public CEMETERY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public CEMETERY(SubjectOf subjectOf) {
	...
	public CEMETERY(Telephone telephone) {
	...
	public void copy(Clazz.Cemetery org) {
		setSeq(org.getSeq());
