...
public class REFERENCE_QUANTITY implements Container.ReferenceQuantity {
	...
	public REFERENCE_QUANTITY(String string) {
	...
	public REFERENCE_QUANTITY(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public REFERENCE_QUANTITY(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public REFERENCE_QUANTITY(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public REFERENCE_QUANTITY(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.ReferenceQuantity org) {
