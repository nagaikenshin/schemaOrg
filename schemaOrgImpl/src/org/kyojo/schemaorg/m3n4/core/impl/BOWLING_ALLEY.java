...
public class BOWLING_ALLEY implements Clazz.BowlingAlley {
	...
	public BOWLING_ALLEY(Long seq) {
		setSeq(seq);
	}

	public BOWLING_ALLEY(String string) {
	...
	public BOWLING_ALLEY(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public BOWLING_ALLEY(AdditionalProperty additionalProperty) {
	...
	public BOWLING_ALLEY(AdditionalType additionalType) {
	...
	public BOWLING_ALLEY(Address address) {
		setAddress(address);
	}
	...
	public BOWLING_ALLEY(AggregateRating aggregateRating) {
	...
	public BOWLING_ALLEY(AlternateName alternateName) {
	...
	public BOWLING_ALLEY(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public BOWLING_ALLEY(AmenityFeature amenityFeature) {
	...
	public BOWLING_ALLEY(AreaServed areaServed) {
	...
	public BOWLING_ALLEY(Award award) {
		setAward(award);
	}
	...
	public BOWLING_ALLEY(BranchCode branchCode) {
	...
	public BOWLING_ALLEY(Brand brand) {
		setBrand(brand);
	}
	...
	public BOWLING_ALLEY(ContactPoint contactPoint) {
	...
	public BOWLING_ALLEY(ContainedInPlace containedInPlace) {
	...
	public BOWLING_ALLEY(ContainsPlace containsPlace) {
	...
	public BOWLING_ALLEY(CorrectionsPolicy correctionsPolicy) {
	...
	public BOWLING_ALLEY(CurrenciesAccepted currenciesAccepted) {
	...
	public BOWLING_ALLEY(Department department) {
	...
	public BOWLING_ALLEY(Description description) {
	...
	public BOWLING_ALLEY(DisambiguatingDescription disambiguatingDescription) {
	...
	public BOWLING_ALLEY(DissolutionDate dissolutionDate) {
	...
	public BOWLING_ALLEY(DiversityPolicy diversityPolicy) {
	...
	public BOWLING_ALLEY(DiversityStaffingReport diversityStaffingReport) {
	...
	public BOWLING_ALLEY(Duns duns) {
		setDuns(duns);
	}
	...
	public BOWLING_ALLEY(Email email) {
		setEmail(email);
	}
	...
	public BOWLING_ALLEY(Employee employee) {
	...
	public BOWLING_ALLEY(EthicsPolicy ethicsPolicy) {
	...
	public BOWLING_ALLEY(Event event) {
		setEvent(event);
	}
	...
	public BOWLING_ALLEY(FaxNumber faxNumber) {
	...
	public BOWLING_ALLEY(Founder founder) {
		setFounder(founder);
	}
	...
	public BOWLING_ALLEY(FoundingDate foundingDate) {
	...
	public BOWLING_ALLEY(FoundingLocation foundingLocation) {
	...
	public BOWLING_ALLEY(Funder funder) {
		setFunder(funder);
	}
	...
	public BOWLING_ALLEY(GeospatiallyContains geospatiallyContains) {
	...
	public BOWLING_ALLEY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public BOWLING_ALLEY(GeospatiallyCovers geospatiallyCovers) {
	...
	public BOWLING_ALLEY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public BOWLING_ALLEY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public BOWLING_ALLEY(GeospatiallyEquals geospatiallyEquals) {
	...
	public BOWLING_ALLEY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public BOWLING_ALLEY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public BOWLING_ALLEY(GeospatiallyTouches geospatiallyTouches) {
	...
	public BOWLING_ALLEY(GeospatiallyWithin geospatiallyWithin) {
	...
	public BOWLING_ALLEY(GlobalLocationNumber globalLocationNumber) {
	...
	public BOWLING_ALLEY(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public BOWLING_ALLEY(HasOfferCatalog hasOfferCatalog) {
	...
	public BOWLING_ALLEY(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public BOWLING_ALLEY(Identifier identifier) {
	...
	public BOWLING_ALLEY(Image image) {
		setImage(image);
	}
	...
	public BOWLING_ALLEY(IsAccessibleForFree isAccessibleForFree) {
	...
	public BOWLING_ALLEY(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public BOWLING_ALLEY(KnowsAbout knowsAbout) {
	...
	public BOWLING_ALLEY(KnowsLanguage knowsLanguage) {
	...
	public BOWLING_ALLEY(LegalName legalName) {
	...
	public BOWLING_ALLEY(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public BOWLING_ALLEY(Location location) {
	...
	public BOWLING_ALLEY(Logo logo) {
		setLogo(logo);
	}
	...
	public BOWLING_ALLEY(MainEntityOfPage mainEntityOfPage) {
	...
	public BOWLING_ALLEY(MakesOffer makesOffer) {
	...
	public BOWLING_ALLEY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public BOWLING_ALLEY(Member member) {
		setMember(member);
	}
	...
	public BOWLING_ALLEY(MemberOf memberOf) {
	...
	public BOWLING_ALLEY(Naics naics) {
		setNaics(naics);
	}
	...
	public BOWLING_ALLEY(Name name) {
		setName(name);
	}
	...
	public BOWLING_ALLEY(NameFuzzy nameFuzzy) {
	...
	public BOWLING_ALLEY(NameRuby nameRuby) {
	...
	public BOWLING_ALLEY(NumberOfEmployees numberOfEmployees) {
	...
	public BOWLING_ALLEY(OpeningHours openingHours) {
	...
	public BOWLING_ALLEY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public BOWLING_ALLEY(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public BOWLING_ALLEY(Owns owns) {
		setOwns(owns);
	}
	...
	public BOWLING_ALLEY(ParentOrganization parentOrganization) {
	...
	public BOWLING_ALLEY(PaymentAccepted paymentAccepted) {
	...
	public BOWLING_ALLEY(Photo photo) {
		setPhoto(photo);
	}
	...
	public BOWLING_ALLEY(PotentialAction potentialAction) {
	...
	public BOWLING_ALLEY(PriceRange priceRange) {
	...
	public BOWLING_ALLEY(PublicAccess publicAccess) {
	...
	public BOWLING_ALLEY(PublishingPrinciples publishingPrinciples) {
	...
	public BOWLING_ALLEY(Review review) {
		setReview(review);
	}
	...
	public BOWLING_ALLEY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public BOWLING_ALLEY(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public BOWLING_ALLEY(SmokingAllowed smokingAllowed) {
	...
	public BOWLING_ALLEY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public BOWLING_ALLEY(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public BOWLING_ALLEY(SubOrganization subOrganization) {
	...
	public BOWLING_ALLEY(SubjectOf subjectOf) {
	...
	public BOWLING_ALLEY(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public BOWLING_ALLEY(Telephone telephone) {
	...
	public BOWLING_ALLEY(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public BOWLING_ALLEY(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.BowlingAlley org) {
		setSeq(org.getSeq());
