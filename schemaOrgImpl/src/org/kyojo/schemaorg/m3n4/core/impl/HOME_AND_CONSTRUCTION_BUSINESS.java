...
public class HOME_AND_CONSTRUCTION_BUSINESS implements Clazz.HomeAndConstructionBusiness {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS() {
	}

	public HOME_AND_CONSTRUCTION_BUSINESS(Long seq) {
		setSeq(seq);
	}

	public HOME_AND_CONSTRUCTION_BUSINESS(String string) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(AdditionalProperty additionalProperty) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(AdditionalType additionalType) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Address address) {
		setAddress(address);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(AggregateRating aggregateRating) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(AlternateName alternateName) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(AmenityFeature amenityFeature) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(AreaServed areaServed) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Award award) {
		setAward(award);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(BranchCode branchCode) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Brand brand) {
		setBrand(brand);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(ContactPoint contactPoint) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(ContainedInPlace containedInPlace) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(ContainsPlace containsPlace) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(CorrectionsPolicy correctionsPolicy) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(CurrenciesAccepted currenciesAccepted) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Department department) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Description description) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(DisambiguatingDescription disambiguatingDescription) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(DissolutionDate dissolutionDate) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(DiversityPolicy diversityPolicy) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(DiversityStaffingReport diversityStaffingReport) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Duns duns) {
		setDuns(duns);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Email email) {
		setEmail(email);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Employee employee) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(EthicsPolicy ethicsPolicy) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Event event) {
		setEvent(event);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(FaxNumber faxNumber) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Founder founder) {
		setFounder(founder);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(FoundingDate foundingDate) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(FoundingLocation foundingLocation) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Funder funder) {
		setFunder(funder);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Geo geo) {
		setGeo(geo);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(GeospatiallyContains geospatiallyContains) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(GeospatiallyCovers geospatiallyCovers) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(GeospatiallyEquals geospatiallyEquals) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(GeospatiallyTouches geospatiallyTouches) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(GeospatiallyWithin geospatiallyWithin) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(GlobalLocationNumber globalLocationNumber) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(HasOfferCatalog hasOfferCatalog) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Identifier identifier) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Image image) {
		setImage(image);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(IsAccessibleForFree isAccessibleForFree) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(KnowsAbout knowsAbout) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(KnowsLanguage knowsLanguage) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(LegalName legalName) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Location location) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Logo logo) {
		setLogo(logo);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(MainEntityOfPage mainEntityOfPage) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(MakesOffer makesOffer) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Member member) {
		setMember(member);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(MemberOf memberOf) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Naics naics) {
		setNaics(naics);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Name name) {
		setName(name);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(NameFuzzy nameFuzzy) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(NameRuby nameRuby) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(NumberOfEmployees numberOfEmployees) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(OpeningHours openingHours) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(OpeningHoursSpecification openingHoursSpecification) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Owns owns) {
		setOwns(owns);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(ParentOrganization parentOrganization) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(PaymentAccepted paymentAccepted) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Photo photo) {
		setPhoto(photo);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(PotentialAction potentialAction) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(PriceRange priceRange) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(PublicAccess publicAccess) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(PublishingPrinciples publishingPrinciples) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Review review) {
		setReview(review);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(SmokingAllowed smokingAllowed) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(SubOrganization subOrganization) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(SubjectOf subjectOf) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Telephone telephone) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(Url url) {
		setUrl(url);
	}
	...
	public HOME_AND_CONSTRUCTION_BUSINESS(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.HomeAndConstructionBusiness org) {
		setSeq(org.getSeq());
