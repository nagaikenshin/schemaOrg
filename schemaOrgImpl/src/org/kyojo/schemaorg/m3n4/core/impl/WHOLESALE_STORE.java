...
public class WHOLESALE_STORE implements Clazz.WholesaleStore {
	...
	public WHOLESALE_STORE() {
	}

	public WHOLESALE_STORE(Long seq) {
		setSeq(seq);
	}

	public WHOLESALE_STORE(String string) {
	...
	public WHOLESALE_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public WHOLESALE_STORE(AdditionalProperty additionalProperty) {
	...
	public WHOLESALE_STORE(AdditionalType additionalType) {
	...
	public WHOLESALE_STORE(Address address) {
		setAddress(address);
	}
	...
	public WHOLESALE_STORE(AggregateRating aggregateRating) {
	...
	public WHOLESALE_STORE(AlternateName alternateName) {
	...
	public WHOLESALE_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public WHOLESALE_STORE(AmenityFeature amenityFeature) {
	...
	public WHOLESALE_STORE(AreaServed areaServed) {
	...
	public WHOLESALE_STORE(Award award) {
		setAward(award);
	}
	...
	public WHOLESALE_STORE(BranchCode branchCode) {
	...
	public WHOLESALE_STORE(Brand brand) {
		setBrand(brand);
	}
	...
	public WHOLESALE_STORE(ContactPoint contactPoint) {
	...
	public WHOLESALE_STORE(ContainedInPlace containedInPlace) {
	...
	public WHOLESALE_STORE(ContainsPlace containsPlace) {
	...
	public WHOLESALE_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public WHOLESALE_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public WHOLESALE_STORE(Department department) {
	...
	public WHOLESALE_STORE(Description description) {
	...
	public WHOLESALE_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public WHOLESALE_STORE(DissolutionDate dissolutionDate) {
	...
	public WHOLESALE_STORE(DiversityPolicy diversityPolicy) {
	...
	public WHOLESALE_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public WHOLESALE_STORE(Duns duns) {
		setDuns(duns);
	}
	...
	public WHOLESALE_STORE(Email email) {
		setEmail(email);
	}
	...
	public WHOLESALE_STORE(Employee employee) {
	...
	public WHOLESALE_STORE(EthicsPolicy ethicsPolicy) {
	...
	public WHOLESALE_STORE(Event event) {
		setEvent(event);
	}
	...
	public WHOLESALE_STORE(FaxNumber faxNumber) {
	...
	public WHOLESALE_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public WHOLESALE_STORE(FoundingDate foundingDate) {
	...
	public WHOLESALE_STORE(FoundingLocation foundingLocation) {
	...
	public WHOLESALE_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public WHOLESALE_STORE(Geo geo) {
		setGeo(geo);
	}
	...
	public WHOLESALE_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public WHOLESALE_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public WHOLESALE_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public WHOLESALE_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public WHOLESALE_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public WHOLESALE_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public WHOLESALE_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public WHOLESALE_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public WHOLESALE_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public WHOLESALE_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public WHOLESALE_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public WHOLESALE_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public WHOLESALE_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public WHOLESALE_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public WHOLESALE_STORE(Identifier identifier) {
	...
	public WHOLESALE_STORE(Image image) {
		setImage(image);
	}
	...
	public WHOLESALE_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public WHOLESALE_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public WHOLESALE_STORE(KnowsAbout knowsAbout) {
	...
	public WHOLESALE_STORE(KnowsLanguage knowsLanguage) {
	...
	public WHOLESALE_STORE(LegalName legalName) {
	...
	public WHOLESALE_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public WHOLESALE_STORE(Location location) {
	...
	public WHOLESALE_STORE(Logo logo) {
		setLogo(logo);
	}
	...
	public WHOLESALE_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public WHOLESALE_STORE(MakesOffer makesOffer) {
	...
	public WHOLESALE_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public WHOLESALE_STORE(Member member) {
		setMember(member);
	}
	...
	public WHOLESALE_STORE(MemberOf memberOf) {
	...
	public WHOLESALE_STORE(Naics naics) {
		setNaics(naics);
	}
	...
	public WHOLESALE_STORE(Name name) {
		setName(name);
	}
	...
	public WHOLESALE_STORE(NameFuzzy nameFuzzy) {
	...
	public WHOLESALE_STORE(NameRuby nameRuby) {
	...
	public WHOLESALE_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public WHOLESALE_STORE(OpeningHours openingHours) {
	...
	public WHOLESALE_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public WHOLESALE_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public WHOLESALE_STORE(Owns owns) {
		setOwns(owns);
	}
	...
	public WHOLESALE_STORE(ParentOrganization parentOrganization) {
	...
	public WHOLESALE_STORE(PaymentAccepted paymentAccepted) {
	...
	public WHOLESALE_STORE(Photo photo) {
		setPhoto(photo);
	}
	...
	public WHOLESALE_STORE(PotentialAction potentialAction) {
	...
	public WHOLESALE_STORE(PriceRange priceRange) {
	...
	public WHOLESALE_STORE(PublicAccess publicAccess) {
	...
	public WHOLESALE_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public WHOLESALE_STORE(Review review) {
		setReview(review);
	}
	...
	public WHOLESALE_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public WHOLESALE_STORE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public WHOLESALE_STORE(SmokingAllowed smokingAllowed) {
	...
	public WHOLESALE_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public WHOLESALE_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public WHOLESALE_STORE(SubOrganization subOrganization) {
	...
	public WHOLESALE_STORE(SubjectOf subjectOf) {
	...
	public WHOLESALE_STORE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public WHOLESALE_STORE(Telephone telephone) {
	...
	public WHOLESALE_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public WHOLESALE_STORE(Url url) {
		setUrl(url);
	}
	...
	public WHOLESALE_STORE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.WholesaleStore org) {
		setSeq(org.getSeq());
