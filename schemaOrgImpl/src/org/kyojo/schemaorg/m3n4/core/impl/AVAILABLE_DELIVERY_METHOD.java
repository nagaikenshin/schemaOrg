...
public class AVAILABLE_DELIVERY_METHOD implements Container.AvailableDeliveryMethod {
	...
	public AVAILABLE_DELIVERY_METHOD(LockerDelivery lockerDelivery) {
	...
	public AVAILABLE_DELIVERY_METHOD(ParcelService parcelService) {
	...
	public AVAILABLE_DELIVERY_METHOD(List<DeliveryMethod> deliveryMethodList,
	...
	public void copy(Container.AvailableDeliveryMethod org) {
