...
public class CITY_HALL implements Clazz.CityHall {
	...
	public CITY_HALL(Long seq) {
		setSeq(seq);
	}

	public CITY_HALL(String string) {
	...
	public CITY_HALL(AdditionalProperty additionalProperty) {
	...
	public CITY_HALL(AdditionalType additionalType) {
	...
	public CITY_HALL(Address address) {
		setAddress(address);
	}
	...
	public CITY_HALL(AggregateRating aggregateRating) {
	...
	public CITY_HALL(AlternateName alternateName) {
	...
	public CITY_HALL(AmenityFeature amenityFeature) {
	...
	public CITY_HALL(BranchCode branchCode) {
	...
	public CITY_HALL(ContainedInPlace containedInPlace) {
	...
	public CITY_HALL(ContainsPlace containsPlace) {
	...
	public CITY_HALL(Description description) {
	...
	public CITY_HALL(DisambiguatingDescription disambiguatingDescription) {
	...
	public CITY_HALL(FaxNumber faxNumber) {
	...
	public CITY_HALL(GeospatiallyContains geospatiallyContains) {
	...
	public CITY_HALL(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public CITY_HALL(GeospatiallyCovers geospatiallyCovers) {
	...
	public CITY_HALL(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public CITY_HALL(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public CITY_HALL(GeospatiallyEquals geospatiallyEquals) {
	...
	public CITY_HALL(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public CITY_HALL(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public CITY_HALL(GeospatiallyTouches geospatiallyTouches) {
	...
	public CITY_HALL(GeospatiallyWithin geospatiallyWithin) {
	...
	public CITY_HALL(GlobalLocationNumber globalLocationNumber) {
	...
	public CITY_HALL(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public CITY_HALL(Identifier identifier) {
	...
	public CITY_HALL(IsAccessibleForFree isAccessibleForFree) {
	...
	public CITY_HALL(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public CITY_HALL(MainEntityOfPage mainEntityOfPage) {
	...
	public CITY_HALL(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public CITY_HALL(NameFuzzy nameFuzzy) {
	...
	public CITY_HALL(NameRuby nameRuby) {
	...
	public CITY_HALL(OpeningHours openingHours) {
	...
	public CITY_HALL(OpeningHoursSpecification openingHoursSpecification) {
	...
	public CITY_HALL(PotentialAction potentialAction) {
	...
	public CITY_HALL(PublicAccess publicAccess) {
	...
	public CITY_HALL(Review review) {
		setReview(review);
	}
	...
	public CITY_HALL(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CITY_HALL(SmokingAllowed smokingAllowed) {
	...
	public CITY_HALL(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public CITY_HALL(SubjectOf subjectOf) {
	...
	public CITY_HALL(Telephone telephone) {
	...
	public void copy(Clazz.CityHall org) {
		setSeq(org.getSeq());
