...
public class HOTEL implements Clazz.Hotel {
	...
	public HOTEL(Long seq) {
		setSeq(seq);
	}

	public HOTEL(String string) {
	...
	public HOTEL(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public HOTEL(AdditionalProperty additionalProperty) {
	...
	public HOTEL(AdditionalType additionalType) {
	...
	public HOTEL(AggregateRating aggregateRating) {
	...
	public HOTEL(AlternateName alternateName) {
	...
	public HOTEL(AmenityFeature amenityFeature) {
	...
	public HOTEL(AreaServed areaServed) {
	...
	public HOTEL(Audience audience) {
	...
	public HOTEL(AvailableLanguage availableLanguage) {
	...
	public HOTEL(BranchCode branchCode) {
	...
	public HOTEL(CheckinTime checkinTime) {
	...
	public HOTEL(CheckoutTime checkoutTime) {
	...
	public HOTEL(ContactPoint contactPoint) {
	...
	public HOTEL(ContainedInPlace containedInPlace) {
	...
	public HOTEL(ContainsPlace containsPlace) {
	...
	public HOTEL(CorrectionsPolicy correctionsPolicy) {
	...
	public HOTEL(CurrenciesAccepted currenciesAccepted) {
	...
	public HOTEL(Department department) {
	...
	public HOTEL(Description description) {
	...
	public HOTEL(DisambiguatingDescription disambiguatingDescription) {
	...
	public HOTEL(DissolutionDate dissolutionDate) {
	...
	public HOTEL(DiversityPolicy diversityPolicy) {
	...
	public HOTEL(DiversityStaffingReport diversityStaffingReport) {
	...
	public HOTEL(Employee employee) {
	...
	public HOTEL(EthicsPolicy ethicsPolicy) {
	...
	public HOTEL(FaxNumber faxNumber) {
	...
	public HOTEL(FoundingDate foundingDate) {
	...
	public HOTEL(FoundingLocation foundingLocation) {
	...
	public HOTEL(GeospatiallyContains geospatiallyContains) {
	...
	public HOTEL(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public HOTEL(GeospatiallyCovers geospatiallyCovers) {
	...
	public HOTEL(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public HOTEL(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public HOTEL(GeospatiallyEquals geospatiallyEquals) {
	...
	public HOTEL(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public HOTEL(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public HOTEL(GeospatiallyTouches geospatiallyTouches) {
	...
	public HOTEL(GeospatiallyWithin geospatiallyWithin) {
	...
	public HOTEL(GlobalLocationNumber globalLocationNumber) {
	...
	public HOTEL(HasOfferCatalog hasOfferCatalog) {
	...
	public HOTEL(IsAccessibleForFree isAccessibleForFree) {
	...
	public HOTEL(KnowsAbout knowsAbout) {
	...
	public HOTEL(KnowsLanguage knowsLanguage) {
	...
	public HOTEL(LegalName legalName) {
	...
	public HOTEL(MainEntityOfPage mainEntityOfPage) {
	...
	public HOTEL(MakesOffer makesOffer) {
	...
	public HOTEL(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public HOTEL(MemberOf memberOf) {
	...
	public HOTEL(NameFuzzy nameFuzzy) {
	...
	public HOTEL(NameRuby nameRuby) {
	...
	public HOTEL(NumberOfEmployees numberOfEmployees) {
	...
	public HOTEL(OpeningHours openingHours) {
	...
	public HOTEL(OpeningHoursSpecification openingHoursSpecification) {
	...
	public HOTEL(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public HOTEL(ParentOrganization parentOrganization) {
	...
	public HOTEL(PaymentAccepted paymentAccepted) {
	...
	public HOTEL(PetsAllowed petsAllowed) {
	...
	public HOTEL(PotentialAction potentialAction) {
	...
	public HOTEL(PriceRange priceRange) {
	...
	public HOTEL(PublicAccess publicAccess) {
	...
	public HOTEL(PublishingPrinciples publishingPrinciples) {
	...
	public HOTEL(SmokingAllowed smokingAllowed) {
	...
	public HOTEL(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public HOTEL(StarRating starRating) {
	...
	public HOTEL(SubOrganization subOrganization) {
	...
	public HOTEL(SubjectOf subjectOf) {
	...
	public HOTEL(Telephone telephone) {
	...
	public HOTEL(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Hotel org) {
		setSeq(org.getSeq());
