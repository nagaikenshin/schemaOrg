...
public class NUMBER_OF_PLAYERS implements Container.NumberOfPlayers {
	...
	public NUMBER_OF_PLAYERS(String string) {
	...
	public NUMBER_OF_PLAYERS(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public NUMBER_OF_PLAYERS(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public NUMBER_OF_PLAYERS(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public NUMBER_OF_PLAYERS(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.NumberOfPlayers org) {
