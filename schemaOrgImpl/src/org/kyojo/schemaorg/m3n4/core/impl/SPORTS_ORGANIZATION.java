...
public class SPORTS_ORGANIZATION implements Clazz.SportsOrganization {
	...
	public SPORTS_ORGANIZATION() {
	}

	public SPORTS_ORGANIZATION(Long seq) {
		setSeq(seq);
	}

	public SPORTS_ORGANIZATION(String string) {
	...
	public SPORTS_ORGANIZATION(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public SPORTS_ORGANIZATION(AdditionalType additionalType) {
	...
	public SPORTS_ORGANIZATION(Address address) {
		setAddress(address);
	}
	...
	public SPORTS_ORGANIZATION(AggregateRating aggregateRating) {
	...
	public SPORTS_ORGANIZATION(AlternateName alternateName) {
	...
	public SPORTS_ORGANIZATION(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public SPORTS_ORGANIZATION(AreaServed areaServed) {
	...
	public SPORTS_ORGANIZATION(Award award) {
		setAward(award);
	}
	...
	public SPORTS_ORGANIZATION(Brand brand) {
		setBrand(brand);
	}
	...
	public SPORTS_ORGANIZATION(ContactPoint contactPoint) {
	...
	public SPORTS_ORGANIZATION(CorrectionsPolicy correctionsPolicy) {
	...
	public SPORTS_ORGANIZATION(Department department) {
	...
	public SPORTS_ORGANIZATION(Description description) {
	...
	public SPORTS_ORGANIZATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public SPORTS_ORGANIZATION(DissolutionDate dissolutionDate) {
	...
	public SPORTS_ORGANIZATION(DiversityPolicy diversityPolicy) {
	...
	public SPORTS_ORGANIZATION(DiversityStaffingReport diversityStaffingReport) {
	...
	public SPORTS_ORGANIZATION(Duns duns) {
		setDuns(duns);
	}
	...
	public SPORTS_ORGANIZATION(Email email) {
		setEmail(email);
	}
	...
	public SPORTS_ORGANIZATION(Employee employee) {
	...
	public SPORTS_ORGANIZATION(EthicsPolicy ethicsPolicy) {
	...
	public SPORTS_ORGANIZATION(Event event) {
		setEvent(event);
	}
	...
	public SPORTS_ORGANIZATION(FaxNumber faxNumber) {
	...
	public SPORTS_ORGANIZATION(Founder founder) {
		setFounder(founder);
	}
	...
	public SPORTS_ORGANIZATION(FoundingDate foundingDate) {
	...
	public SPORTS_ORGANIZATION(FoundingLocation foundingLocation) {
	...
	public SPORTS_ORGANIZATION(Funder funder) {
		setFunder(funder);
	}
	...
	public SPORTS_ORGANIZATION(GlobalLocationNumber globalLocationNumber) {
	...
	public SPORTS_ORGANIZATION(HasOfferCatalog hasOfferCatalog) {
	...
	public SPORTS_ORGANIZATION(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public SPORTS_ORGANIZATION(Identifier identifier) {
	...
	public SPORTS_ORGANIZATION(Image image) {
		setImage(image);
	}
	...
	public SPORTS_ORGANIZATION(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public SPORTS_ORGANIZATION(KnowsAbout knowsAbout) {
	...
	public SPORTS_ORGANIZATION(KnowsLanguage knowsLanguage) {
	...
	public SPORTS_ORGANIZATION(LegalName legalName) {
	...
	public SPORTS_ORGANIZATION(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public SPORTS_ORGANIZATION(Location location) {
	...
	public SPORTS_ORGANIZATION(Logo logo) {
		setLogo(logo);
	}
	...
	public SPORTS_ORGANIZATION(MainEntityOfPage mainEntityOfPage) {
	...
	public SPORTS_ORGANIZATION(MakesOffer makesOffer) {
	...
	public SPORTS_ORGANIZATION(Member member) {
		setMember(member);
	}
	...
	public SPORTS_ORGANIZATION(MemberOf memberOf) {
	...
	public SPORTS_ORGANIZATION(Naics naics) {
		setNaics(naics);
	}
	...
	public SPORTS_ORGANIZATION(Name name) {
		setName(name);
	}
	...
	public SPORTS_ORGANIZATION(NameFuzzy nameFuzzy) {
	...
	public SPORTS_ORGANIZATION(NameRuby nameRuby) {
	...
	public SPORTS_ORGANIZATION(NumberOfEmployees numberOfEmployees) {
	...
	public SPORTS_ORGANIZATION(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public SPORTS_ORGANIZATION(Owns owns) {
		setOwns(owns);
	}
	...
	public SPORTS_ORGANIZATION(ParentOrganization parentOrganization) {
	...
	public SPORTS_ORGANIZATION(PotentialAction potentialAction) {
	...
	public SPORTS_ORGANIZATION(PublishingPrinciples publishingPrinciples) {
	...
	public SPORTS_ORGANIZATION(Review review) {
		setReview(review);
	}
	...
	public SPORTS_ORGANIZATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SPORTS_ORGANIZATION(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public SPORTS_ORGANIZATION(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public SPORTS_ORGANIZATION(Sport sport) {
		setSport(sport);
	}
	...
	public SPORTS_ORGANIZATION(SubOrganization subOrganization) {
	...
	public SPORTS_ORGANIZATION(SubjectOf subjectOf) {
	...
	public SPORTS_ORGANIZATION(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public SPORTS_ORGANIZATION(Telephone telephone) {
	...
	public SPORTS_ORGANIZATION(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public SPORTS_ORGANIZATION(Url url) {
		setUrl(url);
	}
	...
	public SPORTS_ORGANIZATION(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.SportsOrganization org) {
		setSeq(org.getSeq());
