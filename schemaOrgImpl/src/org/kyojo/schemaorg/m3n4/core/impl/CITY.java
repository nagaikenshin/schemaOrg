...
public class CITY implements Clazz.City {
	...
	public CITY(AdditionalProperty additionalProperty) {
	...
	public CITY(AdditionalType additionalType) {
	...
	public CITY(AggregateRating aggregateRating) {
	...
	public CITY(AlternateName alternateName) {
	...
	public CITY(AmenityFeature amenityFeature) {
	...
	public CITY(BranchCode branchCode) {
	...
	public CITY(ContainedInPlace containedInPlace) {
	...
	public CITY(ContainsPlace containsPlace) {
	...
	public CITY(Description description) {
	...
	public CITY(DisambiguatingDescription disambiguatingDescription) {
	...
	public CITY(FaxNumber faxNumber) {
	...
	public CITY(GeospatiallyContains geospatiallyContains) {
	...
	public CITY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public CITY(GeospatiallyCovers geospatiallyCovers) {
	...
	public CITY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public CITY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public CITY(GeospatiallyEquals geospatiallyEquals) {
	...
	public CITY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public CITY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public CITY(GeospatiallyTouches geospatiallyTouches) {
	...
	public CITY(GeospatiallyWithin geospatiallyWithin) {
	...
	public CITY(GlobalLocationNumber globalLocationNumber) {
	...
	public CITY(Identifier identifier) {
	...
	public CITY(IsAccessibleForFree isAccessibleForFree) {
	...
	public CITY(MainEntityOfPage mainEntityOfPage) {
	...
	public CITY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public CITY(NameFuzzy nameFuzzy) {
	...
	public CITY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public CITY(PotentialAction potentialAction) {
	...
	public CITY(PublicAccess publicAccess) {
	...
	public CITY(SmokingAllowed smokingAllowed) {
	...
	public CITY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public CITY(SubjectOf subjectOf) {
	...
	public CITY(Telephone telephone) {
	...
	public void copy(Clazz.City org) {
		setSeq(org.getSeq());
