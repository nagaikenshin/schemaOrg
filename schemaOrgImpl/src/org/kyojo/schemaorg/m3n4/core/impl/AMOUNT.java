...
public class AMOUNT implements Container.Amount {
	...
	public AMOUNT(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public AMOUNT(Float fl0at) {
	...
	public AMOUNT(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public AMOUNT(Integer integer) {
	...
	public AMOUNT(java.math.BigDecimal number) {
	...
	public AMOUNT(List<Float> fl0atList,
	...
	public void copy(Container.Amount org) {
