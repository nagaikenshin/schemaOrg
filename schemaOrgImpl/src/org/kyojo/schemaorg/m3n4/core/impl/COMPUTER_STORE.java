...
public class COMPUTER_STORE implements Clazz.ComputerStore {
	...
	public COMPUTER_STORE() {
	}

	public COMPUTER_STORE(Long seq) {
		setSeq(seq);
	}

	public COMPUTER_STORE(String string) {
	...
	public COMPUTER_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public COMPUTER_STORE(AdditionalProperty additionalProperty) {
	...
	public COMPUTER_STORE(AdditionalType additionalType) {
	...
	public COMPUTER_STORE(Address address) {
		setAddress(address);
	}
	...
	public COMPUTER_STORE(AggregateRating aggregateRating) {
	...
	public COMPUTER_STORE(AlternateName alternateName) {
	...
	public COMPUTER_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public COMPUTER_STORE(AmenityFeature amenityFeature) {
	...
	public COMPUTER_STORE(AreaServed areaServed) {
	...
	public COMPUTER_STORE(Award award) {
		setAward(award);
	}
	...
	public COMPUTER_STORE(BranchCode branchCode) {
	...
	public COMPUTER_STORE(Brand brand) {
		setBrand(brand);
	}
	...
	public COMPUTER_STORE(ContactPoint contactPoint) {
	...
	public COMPUTER_STORE(ContainedInPlace containedInPlace) {
	...
	public COMPUTER_STORE(ContainsPlace containsPlace) {
	...
	public COMPUTER_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public COMPUTER_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public COMPUTER_STORE(Department department) {
	...
	public COMPUTER_STORE(Description description) {
	...
	public COMPUTER_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public COMPUTER_STORE(DissolutionDate dissolutionDate) {
	...
	public COMPUTER_STORE(DiversityPolicy diversityPolicy) {
	...
	public COMPUTER_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public COMPUTER_STORE(Duns duns) {
		setDuns(duns);
	}
	...
	public COMPUTER_STORE(Email email) {
		setEmail(email);
	}
	...
	public COMPUTER_STORE(Employee employee) {
	...
	public COMPUTER_STORE(EthicsPolicy ethicsPolicy) {
	...
	public COMPUTER_STORE(Event event) {
		setEvent(event);
	}
	...
	public COMPUTER_STORE(FaxNumber faxNumber) {
	...
	public COMPUTER_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public COMPUTER_STORE(FoundingDate foundingDate) {
	...
	public COMPUTER_STORE(FoundingLocation foundingLocation) {
	...
	public COMPUTER_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public COMPUTER_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public COMPUTER_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public COMPUTER_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public COMPUTER_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public COMPUTER_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public COMPUTER_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public COMPUTER_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public COMPUTER_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public COMPUTER_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public COMPUTER_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public COMPUTER_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public COMPUTER_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public COMPUTER_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public COMPUTER_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public COMPUTER_STORE(Identifier identifier) {
	...
	public COMPUTER_STORE(Image image) {
		setImage(image);
	}
	...
	public COMPUTER_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public COMPUTER_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public COMPUTER_STORE(KnowsAbout knowsAbout) {
	...
	public COMPUTER_STORE(KnowsLanguage knowsLanguage) {
	...
	public COMPUTER_STORE(LegalName legalName) {
	...
	public COMPUTER_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public COMPUTER_STORE(Location location) {
	...
	public COMPUTER_STORE(Logo logo) {
		setLogo(logo);
	}
	...
	public COMPUTER_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public COMPUTER_STORE(MakesOffer makesOffer) {
	...
	public COMPUTER_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public COMPUTER_STORE(Member member) {
		setMember(member);
	}
	...
	public COMPUTER_STORE(MemberOf memberOf) {
	...
	public COMPUTER_STORE(Naics naics) {
		setNaics(naics);
	}
	...
	public COMPUTER_STORE(Name name) {
		setName(name);
	}
	...
	public COMPUTER_STORE(NameFuzzy nameFuzzy) {
	...
	public COMPUTER_STORE(NameRuby nameRuby) {
	...
	public COMPUTER_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public COMPUTER_STORE(OpeningHours openingHours) {
	...
	public COMPUTER_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public COMPUTER_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public COMPUTER_STORE(Owns owns) {
		setOwns(owns);
	}
	...
	public COMPUTER_STORE(ParentOrganization parentOrganization) {
	...
	public COMPUTER_STORE(PaymentAccepted paymentAccepted) {
	...
	public COMPUTER_STORE(Photo photo) {
		setPhoto(photo);
	}
	...
	public COMPUTER_STORE(PotentialAction potentialAction) {
	...
	public COMPUTER_STORE(PriceRange priceRange) {
	...
	public COMPUTER_STORE(PublicAccess publicAccess) {
	...
	public COMPUTER_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public COMPUTER_STORE(Review review) {
		setReview(review);
	}
	...
	public COMPUTER_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public COMPUTER_STORE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public COMPUTER_STORE(SmokingAllowed smokingAllowed) {
	...
	public COMPUTER_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public COMPUTER_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public COMPUTER_STORE(SubOrganization subOrganization) {
	...
	public COMPUTER_STORE(SubjectOf subjectOf) {
	...
	public COMPUTER_STORE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public COMPUTER_STORE(Telephone telephone) {
	...
	public COMPUTER_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public COMPUTER_STORE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.ComputerStore org) {
		setSeq(org.getSeq());
