...
public class LANDFORM implements Clazz.Landform {
	...
	public LANDFORM(Long seq) {
		setSeq(seq);
	}

	public LANDFORM(String string) {
	...
	public LANDFORM(AdditionalProperty additionalProperty) {
	...
	public LANDFORM(AdditionalType additionalType) {
	...
	public LANDFORM(Address address) {
		setAddress(address);
	}
	...
	public LANDFORM(AggregateRating aggregateRating) {
	...
	public LANDFORM(AlternateName alternateName) {
	...
	public LANDFORM(AmenityFeature amenityFeature) {
	...
	public LANDFORM(BranchCode branchCode) {
	...
	public LANDFORM(ContainedInPlace containedInPlace) {
	...
	public LANDFORM(ContainsPlace containsPlace) {
	...
	public LANDFORM(Description description) {
	...
	public LANDFORM(DisambiguatingDescription disambiguatingDescription) {
	...
	public LANDFORM(FaxNumber faxNumber) {
	...
	public LANDFORM(GeospatiallyContains geospatiallyContains) {
	...
	public LANDFORM(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public LANDFORM(GeospatiallyCovers geospatiallyCovers) {
	...
	public LANDFORM(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public LANDFORM(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public LANDFORM(GeospatiallyEquals geospatiallyEquals) {
	...
	public LANDFORM(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public LANDFORM(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public LANDFORM(GeospatiallyTouches geospatiallyTouches) {
	...
	public LANDFORM(GeospatiallyWithin geospatiallyWithin) {
	...
	public LANDFORM(GlobalLocationNumber globalLocationNumber) {
	...
	public LANDFORM(Identifier identifier) {
	...
	public LANDFORM(IsAccessibleForFree isAccessibleForFree) {
	...
	public LANDFORM(MainEntityOfPage mainEntityOfPage) {
	...
	public LANDFORM(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public LANDFORM(NameFuzzy nameFuzzy) {
	...
	public LANDFORM(NameRuby nameRuby) {
	...
	public LANDFORM(OpeningHoursSpecification openingHoursSpecification) {
	...
	public LANDFORM(PotentialAction potentialAction) {
	...
	public LANDFORM(PublicAccess publicAccess) {
	...
	public LANDFORM(SmokingAllowed smokingAllowed) {
	...
	public LANDFORM(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public LANDFORM(SubjectOf subjectOf) {
	...
	public LANDFORM(Telephone telephone) {
	...
	public void copy(Clazz.Landform org) {
		setSeq(org.getSeq());
