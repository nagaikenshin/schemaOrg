...
public class ABOUT_PAGE implements Clazz.AboutPage {
	...
	public ABOUT_PAGE(Long seq) {
		setSeq(seq);
	}

	public ABOUT_PAGE(String string) {
	...
	public ABOUT_PAGE(AccessMode accessMode) {
	...
	public ABOUT_PAGE(AccessModeSufficient accessModeSufficient) {
	...
	public ABOUT_PAGE(AccessibilityAPI accessibilityAPI) {
	...
	public ABOUT_PAGE(AccessibilityControl accessibilityControl) {
	...
	public ABOUT_PAGE(AccessibilityFeature accessibilityFeature) {
	...
	public ABOUT_PAGE(AccessibilityHazard accessibilityHazard) {
	...
	public ABOUT_PAGE(AccessibilitySummary accessibilitySummary) {
	...
	public ABOUT_PAGE(AccountablePerson accountablePerson) {
	...
	public ABOUT_PAGE(AdditionalType additionalType) {
	...
	public ABOUT_PAGE(AggregateRating aggregateRating) {
	...
	public ABOUT_PAGE(AlternateName alternateName) {
	...
	public ABOUT_PAGE(AlternativeHeadline alternativeHeadline) {
	...
	public ABOUT_PAGE(AssociatedMedia associatedMedia) {
	...
	public ABOUT_PAGE(Audience audience) {
	...
	public ABOUT_PAGE(Author author) {
		setAuthor(author);
	}
	...
	public ABOUT_PAGE(Breadcrumb breadcrumb) {
	...
	public ABOUT_PAGE(Character character) {
	...
	public ABOUT_PAGE(Citation citation) {
	...
	public ABOUT_PAGE(Comment comment) {
		setComment(comment);
	}
	...
	public ABOUT_PAGE(CommentCount commentCount) {
	...
	public ABOUT_PAGE(ContentLocation contentLocation) {
	...
	public ABOUT_PAGE(ContentRating contentRating) {
	...
	public ABOUT_PAGE(ContentReferenceTime contentReferenceTime) {
	...
	public ABOUT_PAGE(Contributor contributor) {
	...
	public ABOUT_PAGE(CopyrightHolder copyrightHolder) {
	...
	public ABOUT_PAGE(CopyrightYear copyrightYear) {
	...
	public ABOUT_PAGE(Correction correction) {
	...
	public ABOUT_PAGE(Creator creator) {
		setCreator(creator);
	}
	...
	public ABOUT_PAGE(DateCreated dateCreated) {
	...
	public ABOUT_PAGE(DateModified dateModified) {
	...
	public ABOUT_PAGE(DatePublished datePublished) {
	...
	public ABOUT_PAGE(Description description) {
	...
	public ABOUT_PAGE(DisambiguatingDescription disambiguatingDescription) {
	...
	public ABOUT_PAGE(DiscussionUrl discussionUrl) {
	...
	public ABOUT_PAGE(Editor editor) {
		setEditor(editor);
	}
	...
	public ABOUT_PAGE(EducationalAlignment educationalAlignment) {
	...
	public ABOUT_PAGE(EducationalUse educationalUse) {
	...
	public ABOUT_PAGE(Encoding encoding) {
	...
	public ABOUT_PAGE(EncodingFormat encodingFormat) {
	...
	public ABOUT_PAGE(ExampleOfWork exampleOfWork) {
	...
	public ABOUT_PAGE(Expires expires) {
		setExpires(expires);
	}
	...
	public ABOUT_PAGE(Funder funder) {
		setFunder(funder);
	}
	...
	public ABOUT_PAGE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public ABOUT_PAGE(Headline headline) {
	...
	public ABOUT_PAGE(Identifier identifier) {
	...
	public ABOUT_PAGE(InLanguage inLanguage) {
	...
	public ABOUT_PAGE(InteractionStatistic interactionStatistic) {
	...
	public ABOUT_PAGE(InteractivityType interactivityType) {
	...
	public ABOUT_PAGE(IsAccessibleForFree isAccessibleForFree) {
	...
	public ABOUT_PAGE(IsBasedOn isBasedOn) {
	...
	public ABOUT_PAGE(IsFamilyFriendly isFamilyFriendly) {
	...
	public ABOUT_PAGE(IsPartOf isPartOf) {
	...
	public ABOUT_PAGE(Keywords keywords) {
	...
	public ABOUT_PAGE(LastReviewed lastReviewed) {
	...
	public ABOUT_PAGE(LearningResourceType learningResourceType) {
	...
	public ABOUT_PAGE(License license) {
		setLicense(license);
	}
	...
	public ABOUT_PAGE(LocationCreated locationCreated) {
	...
	public ABOUT_PAGE(MainContentOfPage mainContentOfPage) {
	...
	public ABOUT_PAGE(MainEntity mainEntity) {
	...
	public ABOUT_PAGE(MainEntityOfPage mainEntityOfPage) {
	...
	public ABOUT_PAGE(Material material) {
	...
	public ABOUT_PAGE(Mentions mentions) {
	...
	public ABOUT_PAGE(NameFuzzy nameFuzzy) {
	...
	public ABOUT_PAGE(NameRuby nameRuby) {
	...
	public ABOUT_PAGE(Offers offers) {
		setOffers(offers);
	}
	...
	public ABOUT_PAGE(Position position) {
	...
	public ABOUT_PAGE(PotentialAction potentialAction) {
	...
	public ABOUT_PAGE(PrimaryImageOfPage primaryImageOfPage) {
	...
	public ABOUT_PAGE(Producer producer) {
	...
	public ABOUT_PAGE(Provider provider) {
	...
	public ABOUT_PAGE(Publication publication) {
	...
	public ABOUT_PAGE(Publisher publisher) {
	...
	public ABOUT_PAGE(PublisherImprint publisherImprint) {
	...
	public ABOUT_PAGE(PublishingPrinciples publishingPrinciples) {
	...
	public ABOUT_PAGE(RecordedAt recordedAt) {
	...
	public ABOUT_PAGE(RelatedLink relatedLink) {
	...
	public ABOUT_PAGE(ReleasedEvent releasedEvent) {
	...
	public ABOUT_PAGE(Review review) {
		setReview(review);
	}
	...
	public ABOUT_PAGE(ReviewedBy reviewedBy) {
	...
	public ABOUT_PAGE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ABOUT_PAGE(SchemaVersion schemaVersion) {
	...
	public ABOUT_PAGE(SdDatePublished sdDatePublished) {
	...
	public ABOUT_PAGE(SdLicense sdLicense) {
	...
	public ABOUT_PAGE(SdPublisher sdPublisher) {
	...
	public ABOUT_PAGE(SignificantLink significantLink) {
	...
	public ABOUT_PAGE(SourceOrganization sourceOrganization) {
	...
	public ABOUT_PAGE(SpatialCoverage spatialCoverage) {
	...
	public ABOUT_PAGE(Speakable speakable) {
	...
	public ABOUT_PAGE(Specialty specialty) {
	...
	public ABOUT_PAGE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public ABOUT_PAGE(SubjectOf subjectOf) {
	...
	public ABOUT_PAGE(TemporalCoverage temporalCoverage) {
	...
	public ABOUT_PAGE(ThumbnailUrl thumbnailUrl) {
	...
	public ABOUT_PAGE(TimeRequired timeRequired) {
	...
	public ABOUT_PAGE(TranslationOfWork translationOfWork) {
	...
	public ABOUT_PAGE(Translator translator) {
	...
	public ABOUT_PAGE(TypicalAgeRange typicalAgeRange) {
	...
	public ABOUT_PAGE(Version version) {
		setVersion(version);
	}
	...
	public ABOUT_PAGE(WorkExample workExample) {
	...
	public ABOUT_PAGE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.AboutPage org) {
		setSeq(org.getSeq());
