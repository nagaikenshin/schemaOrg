...
public class MOVIE_THEATER implements Clazz.MovieTheater {
	...
	public MOVIE_THEATER(Long seq) {
		setSeq(seq);
	}

	public MOVIE_THEATER(String string) {
	...
	public MOVIE_THEATER(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public MOVIE_THEATER(AdditionalProperty additionalProperty) {
	...
	public MOVIE_THEATER(AdditionalType additionalType) {
	...
	public MOVIE_THEATER(Address address) {
		setAddress(address);
	}
	...
	public MOVIE_THEATER(AggregateRating aggregateRating) {
	...
	public MOVIE_THEATER(AlternateName alternateName) {
	...
	public MOVIE_THEATER(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public MOVIE_THEATER(AmenityFeature amenityFeature) {
	...
	public MOVIE_THEATER(AreaServed areaServed) {
	...
	public MOVIE_THEATER(Award award) {
		setAward(award);
	}
	...
	public MOVIE_THEATER(BranchCode branchCode) {
	...
	public MOVIE_THEATER(Brand brand) {
		setBrand(brand);
	}
	...
	public MOVIE_THEATER(ContactPoint contactPoint) {
	...
	public MOVIE_THEATER(ContainedInPlace containedInPlace) {
	...
	public MOVIE_THEATER(ContainsPlace containsPlace) {
	...
	public MOVIE_THEATER(CorrectionsPolicy correctionsPolicy) {
	...
	public MOVIE_THEATER(CurrenciesAccepted currenciesAccepted) {
	...
	public MOVIE_THEATER(Department department) {
	...
	public MOVIE_THEATER(Description description) {
	...
	public MOVIE_THEATER(DisambiguatingDescription disambiguatingDescription) {
	...
	public MOVIE_THEATER(DissolutionDate dissolutionDate) {
	...
	public MOVIE_THEATER(DiversityPolicy diversityPolicy) {
	...
	public MOVIE_THEATER(DiversityStaffingReport diversityStaffingReport) {
	...
	public MOVIE_THEATER(Duns duns) {
		setDuns(duns);
	}
	...
	public MOVIE_THEATER(Email email) {
		setEmail(email);
	}
	...
	public MOVIE_THEATER(Employee employee) {
	...
	public MOVIE_THEATER(EthicsPolicy ethicsPolicy) {
	...
	public MOVIE_THEATER(Event event) {
		setEvent(event);
	}
	...
	public MOVIE_THEATER(FaxNumber faxNumber) {
	...
	public MOVIE_THEATER(Founder founder) {
		setFounder(founder);
	}
	...
	public MOVIE_THEATER(FoundingDate foundingDate) {
	...
	public MOVIE_THEATER(FoundingLocation foundingLocation) {
	...
	public MOVIE_THEATER(Funder funder) {
		setFunder(funder);
	}
	...
	public MOVIE_THEATER(GeospatiallyContains geospatiallyContains) {
	...
	public MOVIE_THEATER(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public MOVIE_THEATER(GeospatiallyCovers geospatiallyCovers) {
	...
	public MOVIE_THEATER(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public MOVIE_THEATER(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public MOVIE_THEATER(GeospatiallyEquals geospatiallyEquals) {
	...
	public MOVIE_THEATER(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public MOVIE_THEATER(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public MOVIE_THEATER(GeospatiallyTouches geospatiallyTouches) {
	...
	public MOVIE_THEATER(GeospatiallyWithin geospatiallyWithin) {
	...
	public MOVIE_THEATER(GlobalLocationNumber globalLocationNumber) {
	...
	public MOVIE_THEATER(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public MOVIE_THEATER(HasOfferCatalog hasOfferCatalog) {
	...
	public MOVIE_THEATER(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public MOVIE_THEATER(Identifier identifier) {
	...
	public MOVIE_THEATER(Image image) {
		setImage(image);
	}
	...
	public MOVIE_THEATER(IsAccessibleForFree isAccessibleForFree) {
	...
	public MOVIE_THEATER(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public MOVIE_THEATER(KnowsAbout knowsAbout) {
	...
	public MOVIE_THEATER(KnowsLanguage knowsLanguage) {
	...
	public MOVIE_THEATER(LegalName legalName) {
	...
	public MOVIE_THEATER(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public MOVIE_THEATER(Location location) {
	...
	public MOVIE_THEATER(Logo logo) {
		setLogo(logo);
	}
	...
	public MOVIE_THEATER(MainEntityOfPage mainEntityOfPage) {
	...
	public MOVIE_THEATER(MakesOffer makesOffer) {
	...
	public MOVIE_THEATER(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public MOVIE_THEATER(Member member) {
		setMember(member);
	}
	...
	public MOVIE_THEATER(MemberOf memberOf) {
	...
	public MOVIE_THEATER(Naics naics) {
		setNaics(naics);
	}
	...
	public MOVIE_THEATER(Name name) {
		setName(name);
	}
	...
	public MOVIE_THEATER(NameFuzzy nameFuzzy) {
	...
	public MOVIE_THEATER(NameRuby nameRuby) {
	...
	public MOVIE_THEATER(NumberOfEmployees numberOfEmployees) {
	...
	public MOVIE_THEATER(OpeningHours openingHours) {
	...
	public MOVIE_THEATER(OpeningHoursSpecification openingHoursSpecification) {
	...
	public MOVIE_THEATER(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public MOVIE_THEATER(Owns owns) {
		setOwns(owns);
	}
	...
	public MOVIE_THEATER(ParentOrganization parentOrganization) {
	...
	public MOVIE_THEATER(PaymentAccepted paymentAccepted) {
	...
	public MOVIE_THEATER(Photo photo) {
		setPhoto(photo);
	}
	...
	public MOVIE_THEATER(PotentialAction potentialAction) {
	...
	public MOVIE_THEATER(PriceRange priceRange) {
	...
	public MOVIE_THEATER(PublicAccess publicAccess) {
	...
	public MOVIE_THEATER(PublishingPrinciples publishingPrinciples) {
	...
	public MOVIE_THEATER(Review review) {
		setReview(review);
	}
	...
	public MOVIE_THEATER(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MOVIE_THEATER(ScreenCount screenCount) {
		setScreenCount(screenCount);
	}

	@Override
	public ScreenCount getScreenCount() {
		return screenCount;
	}

	@Override
	public void setScreenCount(ScreenCount screenCount) {
		this.screenCount = screenCount;
	}

	public MOVIE_THEATER(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public MOVIE_THEATER(SmokingAllowed smokingAllowed) {
	...
	public MOVIE_THEATER(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public MOVIE_THEATER(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MOVIE_THEATER(SubOrganization subOrganization) {
	...
	public MOVIE_THEATER(SubjectOf subjectOf) {
	...
	public MOVIE_THEATER(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public MOVIE_THEATER(Telephone telephone) {
	...
	public MOVIE_THEATER(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public MOVIE_THEATER(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.MovieTheater org) {
		setSeq(org.getSeq());
		...
		setScreenCount(org.getScreenCount());
