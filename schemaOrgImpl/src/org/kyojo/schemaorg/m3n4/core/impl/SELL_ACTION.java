...
import org.kyojo.schemaorg.m3n4.core.Container.Buyer;
...
public class SELL_ACTION implements Clazz.SellAction {
	...
	public SELL_ACTION(Long seq) {
		setSeq(seq);
	}

	public SELL_ACTION(String string) {
	...
	public SELL_ACTION(ActionStatus actionStatus) {
	...
	public SELL_ACTION(AdditionalType additionalType) {
	...
	public SELL_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public SELL_ACTION(AlternateName alternateName) {
	...
	public SELL_ACTION(Buyer buyer) {
		setBuyer(buyer);
	}
	...
	public SELL_ACTION(Description description) {
	...
	public SELL_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public SELL_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public SELL_ACTION(Error error) {
		setError(error);
	}
	...
	public SELL_ACTION(Identifier identifier) {
	...
	public SELL_ACTION(Image image) {
		setImage(image);
	}
	...
	public SELL_ACTION(Instrument instrument) {
	...
	public SELL_ACTION(Location location) {
	...
	public SELL_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public SELL_ACTION(NameFuzzy nameFuzzy) {
	...
	public SELL_ACTION(NameRuby nameRuby) {
	...
	public SELL_ACTION(Object object) {
		setObject(object);
	}
	...
	public SELL_ACTION(Participant participant) {
	...
	public SELL_ACTION(PotentialAction potentialAction) {
	...
	public SELL_ACTION(Price price) {
		setPrice(price);
	}
	...
	public SELL_ACTION(PriceSpecification priceSpecification) {
	...
	public SELL_ACTION(Result result) {
		setResult(result);
	}
	...
	public SELL_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SELL_ACTION(StartTime startTime) {
	...
	public SELL_ACTION(SubjectOf subjectOf) {
	...
	public SELL_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.SellAction org) {
		setSeq(org.getSeq());
