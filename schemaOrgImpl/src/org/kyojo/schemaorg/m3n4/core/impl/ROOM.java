...
public class ROOM implements Clazz.Room {
	...
	public ROOM(AdditionalProperty additionalProperty) {
	...
	public ROOM(AdditionalType additionalType) {
	...
	public ROOM(AggregateRating aggregateRating) {
	...
	public ROOM(AlternateName alternateName) {
	...
	public ROOM(AmenityFeature amenityFeature) {
	...
	public ROOM(BranchCode branchCode) {
	...
	public ROOM(ContainedInPlace containedInPlace) {
	...
	public ROOM(ContainsPlace containsPlace) {
	...
	public ROOM(Description description) {
	...
	public ROOM(DisambiguatingDescription disambiguatingDescription) {
	...
	public ROOM(FaxNumber faxNumber) {
	...
	public ROOM(FloorSize floorSize) {
	...
	public ROOM(GeospatiallyContains geospatiallyContains) {
	...
	public ROOM(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public ROOM(GeospatiallyCovers geospatiallyCovers) {
	...
	public ROOM(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public ROOM(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public ROOM(GeospatiallyEquals geospatiallyEquals) {
	...
	public ROOM(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public ROOM(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public ROOM(GeospatiallyTouches geospatiallyTouches) {
	...
	public ROOM(GeospatiallyWithin geospatiallyWithin) {
	...
	public ROOM(GlobalLocationNumber globalLocationNumber) {
	...
	public ROOM(Identifier identifier) {
	...
	public ROOM(IsAccessibleForFree isAccessibleForFree) {
	...
	public ROOM(MainEntityOfPage mainEntityOfPage) {
	...
	public ROOM(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public ROOM(NameFuzzy nameFuzzy) {
	...
	public ROOM(NumberOfRooms numberOfRooms) {
	...
	public ROOM(OpeningHoursSpecification openingHoursSpecification) {
	...
	public ROOM(PermittedUsage permittedUsage) {
	...
	public ROOM(PetsAllowed petsAllowed) {
	...
	public ROOM(PotentialAction potentialAction) {
	...
	public ROOM(PublicAccess publicAccess) {
	...
	public ROOM(SmokingAllowed smokingAllowed) {
	...
	public ROOM(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public ROOM(SubjectOf subjectOf) {
	...
	public ROOM(Telephone telephone) {
	...
	public void copy(Clazz.Room org) {
		setSeq(org.getSeq());
