...
public class EMPLOYEE implements Container.Employee {
	...
	public EMPLOYEE(Patient patient) {
	...
	public EMPLOYEE(List<Patient> patientList,
			List<Person> personList) {
		setPatientList(patientList);
		setPersonList(personList);
	}

	public void copy(Container.Employee org) {
