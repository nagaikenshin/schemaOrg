...
public class ELEVATION implements Container.Elevation {
	...
	public ELEVATION(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public ELEVATION(Float fl0at) {
	...
	public ELEVATION(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public ELEVATION(Integer integer) {
	...
	public ELEVATION(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public ELEVATION(Number number) {
	...
	public ELEVATION(String string) {
		this(new TEXT(string));
	}

	public ELEVATION(Text text) {
	...
	public ELEVATION(List<Float> fl0atList,
	...
	public void copy(Container.Elevation org) {
