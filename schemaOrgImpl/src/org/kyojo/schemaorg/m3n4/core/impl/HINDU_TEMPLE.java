...
public class HINDU_TEMPLE implements Clazz.HinduTemple {
	...
	public HINDU_TEMPLE(Long seq) {
		setSeq(seq);
	}

	public HINDU_TEMPLE(String string) {
	...
	public HINDU_TEMPLE(AdditionalProperty additionalProperty) {
	...
	public HINDU_TEMPLE(AdditionalType additionalType) {
	...
	public HINDU_TEMPLE(Address address) {
		setAddress(address);
	}
	...
	public HINDU_TEMPLE(AggregateRating aggregateRating) {
	...
	public HINDU_TEMPLE(AlternateName alternateName) {
	...
	public HINDU_TEMPLE(AmenityFeature amenityFeature) {
	...
	public HINDU_TEMPLE(BranchCode branchCode) {
	...
	public HINDU_TEMPLE(ContainedInPlace containedInPlace) {
	...
	public HINDU_TEMPLE(ContainsPlace containsPlace) {
	...
	public HINDU_TEMPLE(Description description) {
	...
	public HINDU_TEMPLE(DisambiguatingDescription disambiguatingDescription) {
	...
	public HINDU_TEMPLE(Event event) {
		setEvent(event);
	}
	...
	public HINDU_TEMPLE(FaxNumber faxNumber) {
	...
	public HINDU_TEMPLE(GeospatiallyContains geospatiallyContains) {
	...
	public HINDU_TEMPLE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public HINDU_TEMPLE(GeospatiallyCovers geospatiallyCovers) {
	...
	public HINDU_TEMPLE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public HINDU_TEMPLE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public HINDU_TEMPLE(GeospatiallyEquals geospatiallyEquals) {
	...
	public HINDU_TEMPLE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public HINDU_TEMPLE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public HINDU_TEMPLE(GeospatiallyTouches geospatiallyTouches) {
	...
	public HINDU_TEMPLE(GeospatiallyWithin geospatiallyWithin) {
	...
	public HINDU_TEMPLE(GlobalLocationNumber globalLocationNumber) {
	...
	public HINDU_TEMPLE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public HINDU_TEMPLE(Identifier identifier) {
	...
	public HINDU_TEMPLE(Image image) {
		setImage(image);
	}
	...
	public HINDU_TEMPLE(IsAccessibleForFree isAccessibleForFree) {
	...
	public HINDU_TEMPLE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public HINDU_TEMPLE(MainEntityOfPage mainEntityOfPage) {
	...
	public HINDU_TEMPLE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public HINDU_TEMPLE(NameFuzzy nameFuzzy) {
	...
	public HINDU_TEMPLE(NameRuby nameRuby) {
	...
	public HINDU_TEMPLE(OpeningHours openingHours) {
	...
	public HINDU_TEMPLE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public HINDU_TEMPLE(Photo photo) {
		setPhoto(photo);
	}
	...
	public HINDU_TEMPLE(PotentialAction potentialAction) {
	...
	public HINDU_TEMPLE(PublicAccess publicAccess) {
	...
	public HINDU_TEMPLE(Review review) {
		setReview(review);
	}
	...
	public HINDU_TEMPLE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public HINDU_TEMPLE(SmokingAllowed smokingAllowed) {
	...
	public HINDU_TEMPLE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public HINDU_TEMPLE(SubjectOf subjectOf) {
	...
	public HINDU_TEMPLE(Telephone telephone) {
	...
	public void copy(Clazz.HinduTemple org) {
		setSeq(org.getSeq());
