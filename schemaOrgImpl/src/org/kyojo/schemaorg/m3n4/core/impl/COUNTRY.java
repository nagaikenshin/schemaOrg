...
public class COUNTRY implements Clazz.Country {
	...
	public COUNTRY(AdditionalProperty additionalProperty) {
	...
	public COUNTRY(AdditionalType additionalType) {
	...
	public COUNTRY(AggregateRating aggregateRating) {
	...
	public COUNTRY(AlternateName alternateName) {
	...
	public COUNTRY(AmenityFeature amenityFeature) {
	...
	public COUNTRY(BranchCode branchCode) {
	...
	public COUNTRY(ContainedInPlace containedInPlace) {
	...
	public COUNTRY(ContainsPlace containsPlace) {
	...
	public COUNTRY(DisambiguatingDescription disambiguatingDescription) {
	...
	public COUNTRY(FaxNumber faxNumber) {
	...
	public COUNTRY(GeospatiallyContains geospatiallyContains) {
	...
	public COUNTRY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public COUNTRY(GeospatiallyCovers geospatiallyCovers) {
	...
	public COUNTRY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public COUNTRY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public COUNTRY(GeospatiallyEquals geospatiallyEquals) {
	...
	public COUNTRY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public COUNTRY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public COUNTRY(GeospatiallyTouches geospatiallyTouches) {
	...
	public COUNTRY(GeospatiallyWithin geospatiallyWithin) {
	...
	public COUNTRY(GlobalLocationNumber globalLocationNumber) {
	...
	public COUNTRY(Identifier identifier) {
	...
	public COUNTRY(IsAccessibleForFree isAccessibleForFree) {
	...
	public COUNTRY(MainEntityOfPage mainEntityOfPage) {
	...
	public COUNTRY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public COUNTRY(NameFuzzy nameFuzzy) {
	...
	public COUNTRY(NameRuby nameRuby) {
	...
	public COUNTRY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public COUNTRY(PotentialAction potentialAction) {
	...
	public COUNTRY(PublicAccess publicAccess) {
	...
	public COUNTRY(SmokingAllowed smokingAllowed) {
	...
	public COUNTRY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public COUNTRY(SubjectOf subjectOf) {
	...
	public COUNTRY(Telephone telephone) {
	...
	public void copy(Clazz.Country org) {
		setSeq(org.getSeq());
