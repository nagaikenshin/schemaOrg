...
public class FINANCIAL_SERVICE implements Clazz.FinancialService {
	...
	public FINANCIAL_SERVICE() {
	}

	public FINANCIAL_SERVICE(Long seq) {
		setSeq(seq);
	}

	public FINANCIAL_SERVICE(String string) {
	...
	public FINANCIAL_SERVICE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public FINANCIAL_SERVICE(AdditionalProperty additionalProperty) {
	...
	public FINANCIAL_SERVICE(AdditionalType additionalType) {
	...
	public FINANCIAL_SERVICE(Address address) {
		setAddress(address);
	}
	...
	public FINANCIAL_SERVICE(AggregateRating aggregateRating) {
	...
	public FINANCIAL_SERVICE(AlternateName alternateName) {
	...
	public FINANCIAL_SERVICE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public FINANCIAL_SERVICE(AmenityFeature amenityFeature) {
	...
	public FINANCIAL_SERVICE(AreaServed areaServed) {
	...
	public FINANCIAL_SERVICE(Award award) {
		setAward(award);
	}
	...
	public FINANCIAL_SERVICE(BranchCode branchCode) {
	...
	public FINANCIAL_SERVICE(Brand brand) {
		setBrand(brand);
	}
	...
	public FINANCIAL_SERVICE(ContactPoint contactPoint) {
	...
	public FINANCIAL_SERVICE(ContainedInPlace containedInPlace) {
	...
	public FINANCIAL_SERVICE(ContainsPlace containsPlace) {
	...
	public FINANCIAL_SERVICE(CorrectionsPolicy correctionsPolicy) {
	...
	public FINANCIAL_SERVICE(CurrenciesAccepted currenciesAccepted) {
	...
	public FINANCIAL_SERVICE(Department department) {
	...
	public FINANCIAL_SERVICE(Description description) {
	...
	public FINANCIAL_SERVICE(DisambiguatingDescription disambiguatingDescription) {
	...
	public FINANCIAL_SERVICE(DissolutionDate dissolutionDate) {
	...
	public FINANCIAL_SERVICE(DiversityPolicy diversityPolicy) {
	...
	public FINANCIAL_SERVICE(DiversityStaffingReport diversityStaffingReport) {
	...
	public FINANCIAL_SERVICE(Duns duns) {
		setDuns(duns);
	}
	...
	public FINANCIAL_SERVICE(Email email) {
		setEmail(email);
	}
	...
	public FINANCIAL_SERVICE(Employee employee) {
	...
	public FINANCIAL_SERVICE(EthicsPolicy ethicsPolicy) {
	...
	public FINANCIAL_SERVICE(Event event) {
		setEvent(event);
	}
	...
	public FINANCIAL_SERVICE(FaxNumber faxNumber) {
	...
	public FINANCIAL_SERVICE(FeesAndCommissionsSpecification feesAndCommissionsSpecification) {
	...
	public FINANCIAL_SERVICE(Founder founder) {
		setFounder(founder);
	}
	...
	public FINANCIAL_SERVICE(FoundingDate foundingDate) {
	...
	public FINANCIAL_SERVICE(FoundingLocation foundingLocation) {
	...
	public FINANCIAL_SERVICE(Funder funder) {
		setFunder(funder);
	}
	...
	public FINANCIAL_SERVICE(Geo geo) {
		setGeo(geo);
	}
	...
	public FINANCIAL_SERVICE(GeospatiallyContains geospatiallyContains) {
	...
	public FINANCIAL_SERVICE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public FINANCIAL_SERVICE(GeospatiallyCovers geospatiallyCovers) {
	...
	public FINANCIAL_SERVICE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public FINANCIAL_SERVICE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public FINANCIAL_SERVICE(GeospatiallyEquals geospatiallyEquals) {
	...
	public FINANCIAL_SERVICE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public FINANCIAL_SERVICE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public FINANCIAL_SERVICE(GeospatiallyTouches geospatiallyTouches) {
	...
	public FINANCIAL_SERVICE(GeospatiallyWithin geospatiallyWithin) {
	...
	public FINANCIAL_SERVICE(GlobalLocationNumber globalLocationNumber) {
	...
	public FINANCIAL_SERVICE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public FINANCIAL_SERVICE(HasOfferCatalog hasOfferCatalog) {
	...
	public FINANCIAL_SERVICE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public FINANCIAL_SERVICE(Identifier identifier) {
	...
	public FINANCIAL_SERVICE(Image image) {
		setImage(image);
	}
	...
	public FINANCIAL_SERVICE(IsAccessibleForFree isAccessibleForFree) {
	...
	public FINANCIAL_SERVICE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public FINANCIAL_SERVICE(KnowsAbout knowsAbout) {
	...
	public FINANCIAL_SERVICE(KnowsLanguage knowsLanguage) {
	...
	public FINANCIAL_SERVICE(LegalName legalName) {
	...
	public FINANCIAL_SERVICE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public FINANCIAL_SERVICE(Location location) {
	...
	public FINANCIAL_SERVICE(Logo logo) {
		setLogo(logo);
	}
	...
	public FINANCIAL_SERVICE(MainEntityOfPage mainEntityOfPage) {
	...
	public FINANCIAL_SERVICE(MakesOffer makesOffer) {
	...
	public FINANCIAL_SERVICE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public FINANCIAL_SERVICE(Member member) {
		setMember(member);
	}
	...
	public FINANCIAL_SERVICE(MemberOf memberOf) {
	...
	public FINANCIAL_SERVICE(Naics naics) {
		setNaics(naics);
	}
	...
	public FINANCIAL_SERVICE(Name name) {
		setName(name);
	}
	...
	public FINANCIAL_SERVICE(NameFuzzy nameFuzzy) {
	...
	public FINANCIAL_SERVICE(NameRuby nameRuby) {
	...
	public FINANCIAL_SERVICE(NumberOfEmployees numberOfEmployees) {
	...
	public FINANCIAL_SERVICE(OpeningHours openingHours) {
	...
	public FINANCIAL_SERVICE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public FINANCIAL_SERVICE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public FINANCIAL_SERVICE(Owns owns) {
		setOwns(owns);
	}
	...
	public FINANCIAL_SERVICE(ParentOrganization parentOrganization) {
	...
	public FINANCIAL_SERVICE(PaymentAccepted paymentAccepted) {
	...
	public FINANCIAL_SERVICE(Photo photo) {
		setPhoto(photo);
	}
	...
	public FINANCIAL_SERVICE(PotentialAction potentialAction) {
	...
	public FINANCIAL_SERVICE(PriceRange priceRange) {
	...
	public FINANCIAL_SERVICE(PublicAccess publicAccess) {
	...
	public FINANCIAL_SERVICE(PublishingPrinciples publishingPrinciples) {
	...
	public FINANCIAL_SERVICE(Review review) {
		setReview(review);
	}
	...
	public FINANCIAL_SERVICE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public FINANCIAL_SERVICE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public FINANCIAL_SERVICE(SmokingAllowed smokingAllowed) {
	...
	public FINANCIAL_SERVICE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public FINANCIAL_SERVICE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public FINANCIAL_SERVICE(SubOrganization subOrganization) {
	...
	public FINANCIAL_SERVICE(SubjectOf subjectOf) {
	...
	public FINANCIAL_SERVICE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public FINANCIAL_SERVICE(Telephone telephone) {
	...
	public FINANCIAL_SERVICE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public FINANCIAL_SERVICE(Url url) {
		setUrl(url);
	}
	...
	public FINANCIAL_SERVICE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.FinancialService org) {
		setSeq(org.getSeq());
