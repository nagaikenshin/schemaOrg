...
public class ACCOMMODATION implements Clazz.Accommodation {
	...
	public ACCOMMODATION(Long seq) {
		setSeq(seq);
	}

	public ACCOMMODATION(String string) {
	...
	public ACCOMMODATION(AdditionalProperty additionalProperty) {
	...
	public ACCOMMODATION(AdditionalType additionalType) {
	...
	public ACCOMMODATION(Address address) {
		setAddress(address);
	}
	...
	public ACCOMMODATION(AggregateRating aggregateRating) {
	...
	public ACCOMMODATION(AlternateName alternateName) {
	...
	public ACCOMMODATION(AmenityFeature amenityFeature) {
	...
	public ACCOMMODATION(BranchCode branchCode) {
	...
	public ACCOMMODATION(ContainedInPlace containedInPlace) {
	...
	public ACCOMMODATION(ContainsPlace containsPlace) {
	...
	public ACCOMMODATION(Description description) {
	...
	public ACCOMMODATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public ACCOMMODATION(Event event) {
		setEvent(event);
	}
	...
	public ACCOMMODATION(FaxNumber faxNumber) {
	...
	public ACCOMMODATION(FloorSize floorSize) {
	...
	public ACCOMMODATION(GeospatiallyContains geospatiallyContains) {
	...
	public ACCOMMODATION(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public ACCOMMODATION(GeospatiallyCovers geospatiallyCovers) {
	...
	public ACCOMMODATION(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public ACCOMMODATION(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public ACCOMMODATION(GeospatiallyEquals geospatiallyEquals) {
	...
	public ACCOMMODATION(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public ACCOMMODATION(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public ACCOMMODATION(GeospatiallyTouches geospatiallyTouches) {
	...
	public ACCOMMODATION(GeospatiallyWithin geospatiallyWithin) {
	...
	public ACCOMMODATION(GlobalLocationNumber globalLocationNumber) {
	...
	public ACCOMMODATION(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public ACCOMMODATION(Identifier identifier) {
	...
	public ACCOMMODATION(Image image) {
		setImage(image);
	}
	...
	public ACCOMMODATION(IsAccessibleForFree isAccessibleForFree) {
	...
	public ACCOMMODATION(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public ACCOMMODATION(Logo logo) {
		setLogo(logo);
	}
	...
	public ACCOMMODATION(MainEntityOfPage mainEntityOfPage) {
	...
	public ACCOMMODATION(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public ACCOMMODATION(Name name) {
		setName(name);
	}
	...
	public ACCOMMODATION(NameFuzzy nameFuzzy) {
	...
	public ACCOMMODATION(NameRuby nameRuby) {
	...
	public ACCOMMODATION(NumberOfRooms numberOfRooms) {
	...
	public ACCOMMODATION(OpeningHoursSpecification openingHoursSpecification) {
	...
	public ACCOMMODATION(PermittedUsage permittedUsage) {
	...
	public ACCOMMODATION(PetsAllowed petsAllowed) {
	...
	public ACCOMMODATION(Photo photo) {
		setPhoto(photo);
	}
	...
	public ACCOMMODATION(PotentialAction potentialAction) {
	...
	public ACCOMMODATION(PublicAccess publicAccess) {
	...
	public ACCOMMODATION(Review review) {
		setReview(review);
	}
	...
	public ACCOMMODATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ACCOMMODATION(SmokingAllowed smokingAllowed) {
	...
	public ACCOMMODATION(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public ACCOMMODATION(SubjectOf subjectOf) {
	...
	public ACCOMMODATION(Telephone telephone) {
	...
	public void copy(Clazz.Accommodation org) {
		setSeq(org.getSeq());
