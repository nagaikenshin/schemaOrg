...
public class GOVERNMENT_BUILDING implements Clazz.GovernmentBuilding {
	...
	public GOVERNMENT_BUILDING() {
	}

	public GOVERNMENT_BUILDING(Long seq) {
		setSeq(seq);
	}

	public GOVERNMENT_BUILDING(String string) {
	...
	public GOVERNMENT_BUILDING(AdditionalProperty additionalProperty) {
	...
	public GOVERNMENT_BUILDING(AdditionalType additionalType) {
	...
	public GOVERNMENT_BUILDING(Address address) {
		setAddress(address);
	}
	...
	public GOVERNMENT_BUILDING(AggregateRating aggregateRating) {
	...
	public GOVERNMENT_BUILDING(AlternateName alternateName) {
	...
	public GOVERNMENT_BUILDING(AmenityFeature amenityFeature) {
	...
	public GOVERNMENT_BUILDING(BranchCode branchCode) {
	...
	public GOVERNMENT_BUILDING(ContainedInPlace containedInPlace) {
	...
	public GOVERNMENT_BUILDING(ContainsPlace containsPlace) {
	...
	public GOVERNMENT_BUILDING(Description description) {
	...
	public GOVERNMENT_BUILDING(DisambiguatingDescription disambiguatingDescription) {
	...
	public GOVERNMENT_BUILDING(Event event) {
		setEvent(event);
	}
	...
	public GOVERNMENT_BUILDING(FaxNumber faxNumber) {
	...
	public GOVERNMENT_BUILDING(Geo geo) {
		setGeo(geo);
	}
	...
	public GOVERNMENT_BUILDING(GeospatiallyContains geospatiallyContains) {
	...
	public GOVERNMENT_BUILDING(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public GOVERNMENT_BUILDING(GeospatiallyCovers geospatiallyCovers) {
	...
	public GOVERNMENT_BUILDING(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public GOVERNMENT_BUILDING(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public GOVERNMENT_BUILDING(GeospatiallyEquals geospatiallyEquals) {
	...
	public GOVERNMENT_BUILDING(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public GOVERNMENT_BUILDING(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public GOVERNMENT_BUILDING(GeospatiallyTouches geospatiallyTouches) {
	...
	public GOVERNMENT_BUILDING(GeospatiallyWithin geospatiallyWithin) {
	...
	public GOVERNMENT_BUILDING(GlobalLocationNumber globalLocationNumber) {
	...
	public GOVERNMENT_BUILDING(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public GOVERNMENT_BUILDING(Identifier identifier) {
	...
	public GOVERNMENT_BUILDING(Image image) {
		setImage(image);
	}
	...
	public GOVERNMENT_BUILDING(IsAccessibleForFree isAccessibleForFree) {
	...
	public GOVERNMENT_BUILDING(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public GOVERNMENT_BUILDING(Logo logo) {
		setLogo(logo);
	}
	...
	public GOVERNMENT_BUILDING(MainEntityOfPage mainEntityOfPage) {
	...
	public GOVERNMENT_BUILDING(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public GOVERNMENT_BUILDING(Name name) {
		setName(name);
	}
	...
	public GOVERNMENT_BUILDING(NameFuzzy nameFuzzy) {
	...
	public GOVERNMENT_BUILDING(NameRuby nameRuby) {
	...
	public GOVERNMENT_BUILDING(OpeningHours openingHours) {
	...
	public GOVERNMENT_BUILDING(OpeningHoursSpecification openingHoursSpecification) {
	...
	public GOVERNMENT_BUILDING(Photo photo) {
		setPhoto(photo);
	}
	...
	public GOVERNMENT_BUILDING(PotentialAction potentialAction) {
	...
	public GOVERNMENT_BUILDING(PublicAccess publicAccess) {
	...
	public GOVERNMENT_BUILDING(Review review) {
		setReview(review);
	}
	...
	public GOVERNMENT_BUILDING(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public GOVERNMENT_BUILDING(SmokingAllowed smokingAllowed) {
	...
	public GOVERNMENT_BUILDING(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public GOVERNMENT_BUILDING(SubjectOf subjectOf) {
	...
	public GOVERNMENT_BUILDING(Telephone telephone) {
	...
	public GOVERNMENT_BUILDING(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.GovernmentBuilding org) {
		setSeq(org.getSeq());
