...
public class BEACH implements Clazz.Beach {
	...
	public BEACH(Long seq) {
		setSeq(seq);
	}

	public BEACH(String string) {
	...
	public BEACH(AdditionalProperty additionalProperty) {
	...
	public BEACH(AdditionalType additionalType) {
	...
	public BEACH(AggregateRating aggregateRating) {
	...
	public BEACH(AlternateName alternateName) {
	...
	public BEACH(AmenityFeature amenityFeature) {
	...
	public BEACH(BranchCode branchCode) {
	...
	public BEACH(ContainedInPlace containedInPlace) {
	...
	public BEACH(ContainsPlace containsPlace) {
	...
	public BEACH(Description description) {
	...
	public BEACH(DisambiguatingDescription disambiguatingDescription) {
	...
	public BEACH(FaxNumber faxNumber) {
	...
	public BEACH(GeospatiallyContains geospatiallyContains) {
	...
	public BEACH(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public BEACH(GeospatiallyCovers geospatiallyCovers) {
	...
	public BEACH(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public BEACH(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public BEACH(GeospatiallyEquals geospatiallyEquals) {
	...
	public BEACH(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public BEACH(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public BEACH(GeospatiallyTouches geospatiallyTouches) {
	...
	public BEACH(GeospatiallyWithin geospatiallyWithin) {
	...
	public BEACH(GlobalLocationNumber globalLocationNumber) {
	...
	public BEACH(Identifier identifier) {
	...
	public BEACH(IsAccessibleForFree isAccessibleForFree) {
	...
	public BEACH(MainEntityOfPage mainEntityOfPage) {
	...
	public BEACH(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public BEACH(NameFuzzy nameFuzzy) {
	...
	public BEACH(NameRuby nameRuby) {
	...
	public BEACH(OpeningHours openingHours) {
	...
	public BEACH(OpeningHoursSpecification openingHoursSpecification) {
	...
	public BEACH(PotentialAction potentialAction) {
	...
	public BEACH(PublicAccess publicAccess) {
	...
	public BEACH(SmokingAllowed smokingAllowed) {
	...
	public BEACH(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public BEACH(SubjectOf subjectOf) {
	...
	public BEACH(Telephone telephone) {
	...
	public void copy(Clazz.Beach org) {
		setSeq(org.getSeq());
