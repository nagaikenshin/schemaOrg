...
public class ALUMNI implements Container.Alumni {
	...
	public ALUMNI(List<Patient> patientList,
			List<Person> personList) {
		setPatientList(patientList);
		setPersonList(personList);
	}

	public void copy(Container.Alumni org) {
