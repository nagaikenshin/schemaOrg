...
public class INVITE_ACTION implements Clazz.InviteAction {
	...
	public INVITE_ACTION() {
	}

	public INVITE_ACTION(Long seq) {
		setSeq(seq);
	}

	public INVITE_ACTION(String string) {
	...
	public INVITE_ACTION(About about) {
		setAbout(about);
	}
	...
	public INVITE_ACTION(ActionStatus actionStatus) {
	...
	public INVITE_ACTION(AdditionalType additionalType) {
	...
	public INVITE_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public INVITE_ACTION(AlternateName alternateName) {
	...
	public INVITE_ACTION(Description description) {
	...
	public INVITE_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public INVITE_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public INVITE_ACTION(Error error) {
		setError(error);
	}
	...
	public INVITE_ACTION(Event event) {
		setEvent(event);
	}
	...
	public INVITE_ACTION(Identifier identifier) {
	...
	public INVITE_ACTION(Image image) {
		setImage(image);
	}
	...
	public INVITE_ACTION(InLanguage inLanguage) {
	...
	public INVITE_ACTION(Instrument instrument) {
	...
	public INVITE_ACTION(Location location) {
	...
	public INVITE_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public INVITE_ACTION(Name name) {
		setName(name);
	}
	...
	public INVITE_ACTION(NameFuzzy nameFuzzy) {
	...
	public INVITE_ACTION(NameRuby nameRuby) {
	...
	public INVITE_ACTION(Object object) {
		setObject(object);
	}
	...
	public INVITE_ACTION(Participant participant) {
	...
	public INVITE_ACTION(PotentialAction potentialAction) {
	...
	public INVITE_ACTION(Recipient recipient) {
	...
	public INVITE_ACTION(Result result) {
		setResult(result);
	}
	...
	public INVITE_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public INVITE_ACTION(StartTime startTime) {
	...
	public INVITE_ACTION(SubjectOf subjectOf) {
	...
	public INVITE_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.InviteAction org) {
		setSeq(org.getSeq());
