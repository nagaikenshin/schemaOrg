...
public class MAX_VALUE implements Container.MaxValue {
	...
	public MAX_VALUE(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public MAX_VALUE(Float fl0at) {
	...
	public MAX_VALUE(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public MAX_VALUE(Integer integer) {
	...
	public MAX_VALUE(List<Float> fl0atList,
	...
	public void copy(Container.MaxValue org) {
