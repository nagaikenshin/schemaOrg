...
public class CAMPGROUND implements Clazz.Campground {
	...
	public CAMPGROUND(Long seq) {
		setSeq(seq);
	}

	public CAMPGROUND(String string) {
	...
	public CAMPGROUND(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public CAMPGROUND(AdditionalProperty additionalProperty) {
	...
	public CAMPGROUND(AdditionalType additionalType) {
	...
	public CAMPGROUND(Address address) {
		setAddress(address);
	}
	...
	public CAMPGROUND(AggregateRating aggregateRating) {
	...
	public CAMPGROUND(AlternateName alternateName) {
	...
	public CAMPGROUND(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public CAMPGROUND(AmenityFeature amenityFeature) {
	...
	public CAMPGROUND(AreaServed areaServed) {
	...
	public CAMPGROUND(Audience audience) {
	...
	public CAMPGROUND(AvailableLanguage availableLanguage) {
	...
	public CAMPGROUND(BranchCode branchCode) {
	...
	public CAMPGROUND(CheckinTime checkinTime) {
	...
	public CAMPGROUND(CheckoutTime checkoutTime) {
	...
	public CAMPGROUND(ContactPoint contactPoint) {
	...
	public CAMPGROUND(ContainedInPlace containedInPlace) {
	...
	public CAMPGROUND(ContainsPlace containsPlace) {
	...
	public CAMPGROUND(CorrectionsPolicy correctionsPolicy) {
	...
	public CAMPGROUND(CurrenciesAccepted currenciesAccepted) {
	...
	public CAMPGROUND(Department department) {
	...
	public CAMPGROUND(Description description) {
	...
	public CAMPGROUND(DisambiguatingDescription disambiguatingDescription) {
	...
	public CAMPGROUND(DissolutionDate dissolutionDate) {
	...
	public CAMPGROUND(DiversityPolicy diversityPolicy) {
	...
	public CAMPGROUND(DiversityStaffingReport diversityStaffingReport) {
	...
	public CAMPGROUND(Employee employee) {
	...
	public CAMPGROUND(EthicsPolicy ethicsPolicy) {
	...
	public CAMPGROUND(FaxNumber faxNumber) {
	...
	public CAMPGROUND(Founder founder) {
		setFounder(founder);
	}
	...
	public CAMPGROUND(FoundingDate foundingDate) {
	...
	public CAMPGROUND(FoundingLocation foundingLocation) {
	...
	public CAMPGROUND(Funder funder) {
		setFunder(funder);
	}
	...
	public CAMPGROUND(GeospatiallyContains geospatiallyContains) {
	...
	public CAMPGROUND(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public CAMPGROUND(GeospatiallyCovers geospatiallyCovers) {
	...
	public CAMPGROUND(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public CAMPGROUND(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public CAMPGROUND(GeospatiallyEquals geospatiallyEquals) {
	...
	public CAMPGROUND(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public CAMPGROUND(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public CAMPGROUND(GeospatiallyTouches geospatiallyTouches) {
	...
	public CAMPGROUND(GeospatiallyWithin geospatiallyWithin) {
	...
	public CAMPGROUND(GlobalLocationNumber globalLocationNumber) {
	...
	public CAMPGROUND(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public CAMPGROUND(HasOfferCatalog hasOfferCatalog) {
	...
	public CAMPGROUND(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public CAMPGROUND(Identifier identifier) {
	...
	public CAMPGROUND(IsAccessibleForFree isAccessibleForFree) {
	...
	public CAMPGROUND(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public CAMPGROUND(KnowsAbout knowsAbout) {
	...
	public CAMPGROUND(KnowsLanguage knowsLanguage) {
	...
	public CAMPGROUND(LegalName legalName) {
	...
	public CAMPGROUND(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public CAMPGROUND(Location location) {
	...
	public CAMPGROUND(MainEntityOfPage mainEntityOfPage) {
	...
	public CAMPGROUND(MakesOffer makesOffer) {
	...
	public CAMPGROUND(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public CAMPGROUND(Member member) {
		setMember(member);
	}
	...
	public CAMPGROUND(MemberOf memberOf) {
	...
	public CAMPGROUND(NameFuzzy nameFuzzy) {
	...
	public CAMPGROUND(NameRuby nameRuby) {
	...
	public CAMPGROUND(NumberOfEmployees numberOfEmployees) {
	...
	public CAMPGROUND(OpeningHours openingHours) {
	...
	public CAMPGROUND(OpeningHoursSpecification openingHoursSpecification) {
	...
	public CAMPGROUND(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public CAMPGROUND(ParentOrganization parentOrganization) {
	...
	public CAMPGROUND(PaymentAccepted paymentAccepted) {
	...
	public CAMPGROUND(PetsAllowed petsAllowed) {
	...
	public CAMPGROUND(PotentialAction potentialAction) {
	...
	public CAMPGROUND(PriceRange priceRange) {
	...
	public CAMPGROUND(PublicAccess publicAccess) {
	...
	public CAMPGROUND(PublishingPrinciples publishingPrinciples) {
	...
	public CAMPGROUND(Review review) {
		setReview(review);
	}
	...
	public CAMPGROUND(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CAMPGROUND(SmokingAllowed smokingAllowed) {
	...
	public CAMPGROUND(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public CAMPGROUND(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public CAMPGROUND(StarRating starRating) {
	...
	public CAMPGROUND(SubOrganization subOrganization) {
	...
	public CAMPGROUND(SubjectOf subjectOf) {
	...
	public CAMPGROUND(Telephone telephone) {
	...
	public CAMPGROUND(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Campground org) {
		setSeq(org.getSeq());
