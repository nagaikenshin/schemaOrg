...
public class DRY_CLEANING_OR_LAUNDRY implements Clazz.DryCleaningOrLaundry {
	...
	public DRY_CLEANING_OR_LAUNDRY() {
	}

	public DRY_CLEANING_OR_LAUNDRY(Long seq) {
		setSeq(seq);
	}

	public DRY_CLEANING_OR_LAUNDRY(String string) {
	...
	public DRY_CLEANING_OR_LAUNDRY(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public DRY_CLEANING_OR_LAUNDRY(AdditionalProperty additionalProperty) {
	...
	public DRY_CLEANING_OR_LAUNDRY(AdditionalType additionalType) {
	...
	public DRY_CLEANING_OR_LAUNDRY(Address address) {
		setAddress(address);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(AggregateRating aggregateRating) {
	...
	public DRY_CLEANING_OR_LAUNDRY(AlternateName alternateName) {
	...
	public DRY_CLEANING_OR_LAUNDRY(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(AmenityFeature amenityFeature) {
	...
	public DRY_CLEANING_OR_LAUNDRY(AreaServed areaServed) {
	...
	public DRY_CLEANING_OR_LAUNDRY(Award award) {
		setAward(award);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(BranchCode branchCode) {
	...
	public DRY_CLEANING_OR_LAUNDRY(Brand brand) {
		setBrand(brand);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(ContactPoint contactPoint) {
	...
	public DRY_CLEANING_OR_LAUNDRY(ContainedInPlace containedInPlace) {
	...
	public DRY_CLEANING_OR_LAUNDRY(ContainsPlace containsPlace) {
	...
	public DRY_CLEANING_OR_LAUNDRY(CorrectionsPolicy correctionsPolicy) {
	...
	public DRY_CLEANING_OR_LAUNDRY(CurrenciesAccepted currenciesAccepted) {
	...
	public DRY_CLEANING_OR_LAUNDRY(Department department) {
	...
	public DRY_CLEANING_OR_LAUNDRY(Description description) {
	...
	public DRY_CLEANING_OR_LAUNDRY(DisambiguatingDescription disambiguatingDescription) {
	...
	public DRY_CLEANING_OR_LAUNDRY(DissolutionDate dissolutionDate) {
	...
	public DRY_CLEANING_OR_LAUNDRY(DiversityPolicy diversityPolicy) {
	...
	public DRY_CLEANING_OR_LAUNDRY(DiversityStaffingReport diversityStaffingReport) {
	...
	public DRY_CLEANING_OR_LAUNDRY(Duns duns) {
		setDuns(duns);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(Email email) {
		setEmail(email);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(Employee employee) {
	...
	public DRY_CLEANING_OR_LAUNDRY(EthicsPolicy ethicsPolicy) {
	...
	public DRY_CLEANING_OR_LAUNDRY(Event event) {
		setEvent(event);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(FaxNumber faxNumber) {
	...
	public DRY_CLEANING_OR_LAUNDRY(Founder founder) {
		setFounder(founder);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(FoundingDate foundingDate) {
	...
	public DRY_CLEANING_OR_LAUNDRY(FoundingLocation foundingLocation) {
	...
	public DRY_CLEANING_OR_LAUNDRY(Funder funder) {
		setFunder(funder);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(Geo geo) {
		setGeo(geo);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(GeospatiallyContains geospatiallyContains) {
	...
	public DRY_CLEANING_OR_LAUNDRY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public DRY_CLEANING_OR_LAUNDRY(GeospatiallyCovers geospatiallyCovers) {
	...
	public DRY_CLEANING_OR_LAUNDRY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public DRY_CLEANING_OR_LAUNDRY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public DRY_CLEANING_OR_LAUNDRY(GeospatiallyEquals geospatiallyEquals) {
	...
	public DRY_CLEANING_OR_LAUNDRY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public DRY_CLEANING_OR_LAUNDRY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public DRY_CLEANING_OR_LAUNDRY(GeospatiallyTouches geospatiallyTouches) {
	...
	public DRY_CLEANING_OR_LAUNDRY(GeospatiallyWithin geospatiallyWithin) {
	...
	public DRY_CLEANING_OR_LAUNDRY(GlobalLocationNumber globalLocationNumber) {
	...
	public DRY_CLEANING_OR_LAUNDRY(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(HasOfferCatalog hasOfferCatalog) {
	...
	public DRY_CLEANING_OR_LAUNDRY(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(Identifier identifier) {
	...
	public DRY_CLEANING_OR_LAUNDRY(Image image) {
		setImage(image);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(IsAccessibleForFree isAccessibleForFree) {
	...
	public DRY_CLEANING_OR_LAUNDRY(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(KnowsAbout knowsAbout) {
	...
	public DRY_CLEANING_OR_LAUNDRY(KnowsLanguage knowsLanguage) {
	...
	public DRY_CLEANING_OR_LAUNDRY(LegalName legalName) {
	...
	public DRY_CLEANING_OR_LAUNDRY(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(Location location) {
	...
	public DRY_CLEANING_OR_LAUNDRY(Logo logo) {
		setLogo(logo);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(MainEntityOfPage mainEntityOfPage) {
	...
	public DRY_CLEANING_OR_LAUNDRY(MakesOffer makesOffer) {
	...
	public DRY_CLEANING_OR_LAUNDRY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public DRY_CLEANING_OR_LAUNDRY(Member member) {
		setMember(member);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(MemberOf memberOf) {
	...
	public DRY_CLEANING_OR_LAUNDRY(Naics naics) {
		setNaics(naics);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(Name name) {
		setName(name);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(NameFuzzy nameFuzzy) {
	...
	public DRY_CLEANING_OR_LAUNDRY(NameRuby nameRuby) {
	...
	public DRY_CLEANING_OR_LAUNDRY(NumberOfEmployees numberOfEmployees) {
	...
	public DRY_CLEANING_OR_LAUNDRY(OpeningHours openingHours) {
	...
	public DRY_CLEANING_OR_LAUNDRY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public DRY_CLEANING_OR_LAUNDRY(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public DRY_CLEANING_OR_LAUNDRY(Owns owns) {
		setOwns(owns);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(ParentOrganization parentOrganization) {
	...
	public DRY_CLEANING_OR_LAUNDRY(PaymentAccepted paymentAccepted) {
	...
	public DRY_CLEANING_OR_LAUNDRY(Photo photo) {
		setPhoto(photo);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(PotentialAction potentialAction) {
	...
	public DRY_CLEANING_OR_LAUNDRY(PriceRange priceRange) {
	...
	public DRY_CLEANING_OR_LAUNDRY(PublicAccess publicAccess) {
	...
	public DRY_CLEANING_OR_LAUNDRY(PublishingPrinciples publishingPrinciples) {
	...
	public DRY_CLEANING_OR_LAUNDRY(Review review) {
		setReview(review);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(SmokingAllowed smokingAllowed) {
	...
	public DRY_CLEANING_OR_LAUNDRY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public DRY_CLEANING_OR_LAUNDRY(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(SubOrganization subOrganization) {
	...
	public DRY_CLEANING_OR_LAUNDRY(SubjectOf subjectOf) {
	...
	public DRY_CLEANING_OR_LAUNDRY(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(Telephone telephone) {
	...
	public DRY_CLEANING_OR_LAUNDRY(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public DRY_CLEANING_OR_LAUNDRY(Url url) {
		setUrl(url);
	}
	...
	public DRY_CLEANING_OR_LAUNDRY(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.DryCleaningOrLaundry org) {
		setSeq(org.getSeq());
