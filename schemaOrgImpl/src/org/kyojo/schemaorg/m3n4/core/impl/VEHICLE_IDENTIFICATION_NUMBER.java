...
public class VEHICLE_IDENTIFICATION_NUMBER implements Container.VehicleIdentificationNumber {
	...
	public VEHICLE_IDENTIFICATION_NUMBER(LocationFeatureSpecification locationFeatureSpecification) {
	...
	public VEHICLE_IDENTIFICATION_NUMBER(PropertyValue propertyValue) {
	...
	public VEHICLE_IDENTIFICATION_NUMBER(String string) {
		this(new TEXT(string));
	}

	public VEHICLE_IDENTIFICATION_NUMBER(Text text) {
	...
	public VEHICLE_IDENTIFICATION_NUMBER(URL url) {
	...
	public VEHICLE_IDENTIFICATION_NUMBER(List<LocationFeatureSpecification> locationFeatureSpecificationList,
	...
	public void copy(Container.VehicleIdentificationNumber org) {
