...
public class NUMBER_OF_EMPLOYEES implements Container.NumberOfEmployees {
	...
	public NUMBER_OF_EMPLOYEES(String string) {
	...
	public NUMBER_OF_EMPLOYEES(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public NUMBER_OF_EMPLOYEES(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public NUMBER_OF_EMPLOYEES(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public NUMBER_OF_EMPLOYEES(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.NumberOfEmployees org) {
