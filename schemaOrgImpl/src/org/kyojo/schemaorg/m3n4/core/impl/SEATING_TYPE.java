...
public class SEATING_TYPE implements Container.SeatingType {
	...
	public SEATING_TYPE(QualitativeValue qualitativeValue) {
	...
	public SEATING_TYPE(String string) {
		this(new TEXT(string));
	}

	public SEATING_TYPE(Text text) {
	...
	public SEATING_TYPE(List<QualitativeValue> qualitativeValueList,
			List<Text> textList) {
		setQualitativeValueList(qualitativeValueList);
		setTextList(textList);
	}

	public void copy(Container.SeatingType org) {
