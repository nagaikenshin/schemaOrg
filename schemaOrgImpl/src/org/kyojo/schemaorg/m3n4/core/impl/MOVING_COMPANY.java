...
public class MOVING_COMPANY implements Clazz.MovingCompany {
	...
	public MOVING_COMPANY() {
	}

	public MOVING_COMPANY(Long seq) {
		setSeq(seq);
	}

	public MOVING_COMPANY(String string) {
	...
	public MOVING_COMPANY(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public MOVING_COMPANY(AdditionalProperty additionalProperty) {
	...
	public MOVING_COMPANY(AdditionalType additionalType) {
	...
	public MOVING_COMPANY(Address address) {
		setAddress(address);
	}
	...
	public MOVING_COMPANY(AggregateRating aggregateRating) {
	...
	public MOVING_COMPANY(AlternateName alternateName) {
	...
	public MOVING_COMPANY(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public MOVING_COMPANY(AmenityFeature amenityFeature) {
	...
	public MOVING_COMPANY(AreaServed areaServed) {
	...
	public MOVING_COMPANY(Award award) {
		setAward(award);
	}
	...
	public MOVING_COMPANY(BranchCode branchCode) {
	...
	public MOVING_COMPANY(Brand brand) {
		setBrand(brand);
	}
	...
	public MOVING_COMPANY(ContactPoint contactPoint) {
	...
	public MOVING_COMPANY(ContainedInPlace containedInPlace) {
	...
	public MOVING_COMPANY(ContainsPlace containsPlace) {
	...
	public MOVING_COMPANY(CorrectionsPolicy correctionsPolicy) {
	...
	public MOVING_COMPANY(CurrenciesAccepted currenciesAccepted) {
	...
	public MOVING_COMPANY(Department department) {
	...
	public MOVING_COMPANY(Description description) {
	...
	public MOVING_COMPANY(DisambiguatingDescription disambiguatingDescription) {
	...
	public MOVING_COMPANY(DissolutionDate dissolutionDate) {
	...
	public MOVING_COMPANY(DiversityPolicy diversityPolicy) {
	...
	public MOVING_COMPANY(DiversityStaffingReport diversityStaffingReport) {
	...
	public MOVING_COMPANY(Duns duns) {
		setDuns(duns);
	}
	...
	public MOVING_COMPANY(Email email) {
		setEmail(email);
	}
	...
	public MOVING_COMPANY(Employee employee) {
	...
	public MOVING_COMPANY(EthicsPolicy ethicsPolicy) {
	...
	public MOVING_COMPANY(Event event) {
		setEvent(event);
	}
	...
	public MOVING_COMPANY(FaxNumber faxNumber) {
	...
	public MOVING_COMPANY(Founder founder) {
		setFounder(founder);
	}
	...
	public MOVING_COMPANY(FoundingDate foundingDate) {
	...
	public MOVING_COMPANY(FoundingLocation foundingLocation) {
	...
	public MOVING_COMPANY(Funder funder) {
		setFunder(funder);
	}
	...
	public MOVING_COMPANY(GeospatiallyContains geospatiallyContains) {
	...
	public MOVING_COMPANY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public MOVING_COMPANY(GeospatiallyCovers geospatiallyCovers) {
	...
	public MOVING_COMPANY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public MOVING_COMPANY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public MOVING_COMPANY(GeospatiallyEquals geospatiallyEquals) {
	...
	public MOVING_COMPANY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public MOVING_COMPANY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public MOVING_COMPANY(GeospatiallyTouches geospatiallyTouches) {
	...
	public MOVING_COMPANY(GeospatiallyWithin geospatiallyWithin) {
	...
	public MOVING_COMPANY(GlobalLocationNumber globalLocationNumber) {
	...
	public MOVING_COMPANY(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public MOVING_COMPANY(HasOfferCatalog hasOfferCatalog) {
	...
	public MOVING_COMPANY(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public MOVING_COMPANY(Identifier identifier) {
	...
	public MOVING_COMPANY(Image image) {
		setImage(image);
	}
	...
	public MOVING_COMPANY(IsAccessibleForFree isAccessibleForFree) {
	...
	public MOVING_COMPANY(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public MOVING_COMPANY(KnowsAbout knowsAbout) {
	...
	public MOVING_COMPANY(KnowsLanguage knowsLanguage) {
	...
	public MOVING_COMPANY(LegalName legalName) {
	...
	public MOVING_COMPANY(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public MOVING_COMPANY(Location location) {
	...
	public MOVING_COMPANY(Logo logo) {
		setLogo(logo);
	}
	...
	public MOVING_COMPANY(MainEntityOfPage mainEntityOfPage) {
	...
	public MOVING_COMPANY(MakesOffer makesOffer) {
	...
	public MOVING_COMPANY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public MOVING_COMPANY(Member member) {
		setMember(member);
	}
	...
	public MOVING_COMPANY(MemberOf memberOf) {
	...
	public MOVING_COMPANY(Naics naics) {
		setNaics(naics);
	}
	...
	public MOVING_COMPANY(Name name) {
		setName(name);
	}
	...
	public MOVING_COMPANY(NameFuzzy nameFuzzy) {
	...
	public MOVING_COMPANY(NameRuby nameRuby) {
	...
	public MOVING_COMPANY(NumberOfEmployees numberOfEmployees) {
	...
	public MOVING_COMPANY(OpeningHours openingHours) {
	...
	public MOVING_COMPANY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public MOVING_COMPANY(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public MOVING_COMPANY(Owns owns) {
		setOwns(owns);
	}
	...
	public MOVING_COMPANY(ParentOrganization parentOrganization) {
	...
	public MOVING_COMPANY(PaymentAccepted paymentAccepted) {
	...
	public MOVING_COMPANY(Photo photo) {
		setPhoto(photo);
	}
	...
	public MOVING_COMPANY(PotentialAction potentialAction) {
	...
	public MOVING_COMPANY(PriceRange priceRange) {
	...
	public MOVING_COMPANY(PublicAccess publicAccess) {
	...
	public MOVING_COMPANY(PublishingPrinciples publishingPrinciples) {
	...
	public MOVING_COMPANY(Review review) {
		setReview(review);
	}
	...
	public MOVING_COMPANY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MOVING_COMPANY(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public MOVING_COMPANY(SmokingAllowed smokingAllowed) {
	...
	public MOVING_COMPANY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public MOVING_COMPANY(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MOVING_COMPANY(SubOrganization subOrganization) {
	...
	public MOVING_COMPANY(SubjectOf subjectOf) {
	...
	public MOVING_COMPANY(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public MOVING_COMPANY(Telephone telephone) {
	...
	public MOVING_COMPANY(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public MOVING_COMPANY(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.MovingCompany org) {
		setSeq(org.getSeq());
