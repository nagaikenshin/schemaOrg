...
public class PART_OF_SERIES implements Container.PartOfSeries {
	...
	public PART_OF_SERIES(BusTrip busTrip) {
	...
	public PART_OF_SERIES(Flight flight) {
	...
	public PART_OF_SERIES(TouristTrip touristTrip) {
	...
	public PART_OF_SERIES(TrainTrip trainTrip) {
