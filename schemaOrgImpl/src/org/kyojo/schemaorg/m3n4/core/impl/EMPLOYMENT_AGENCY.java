...
public class EMPLOYMENT_AGENCY implements Clazz.EmploymentAgency {
	...
	public EMPLOYMENT_AGENCY(Long seq) {
		setSeq(seq);
	}

	public EMPLOYMENT_AGENCY(String string) {
	...
	public EMPLOYMENT_AGENCY(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public EMPLOYMENT_AGENCY(AdditionalProperty additionalProperty) {
	...
	public EMPLOYMENT_AGENCY(AdditionalType additionalType) {
	...
	public EMPLOYMENT_AGENCY(Address address) {
		setAddress(address);
	}
	...
	public EMPLOYMENT_AGENCY(AggregateRating aggregateRating) {
	...
	public EMPLOYMENT_AGENCY(AlternateName alternateName) {
	...
	public EMPLOYMENT_AGENCY(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public EMPLOYMENT_AGENCY(AmenityFeature amenityFeature) {
	...
	public EMPLOYMENT_AGENCY(AreaServed areaServed) {
	...
	public EMPLOYMENT_AGENCY(Award award) {
		setAward(award);
	}
	...
	public EMPLOYMENT_AGENCY(BranchCode branchCode) {
	...
	public EMPLOYMENT_AGENCY(Brand brand) {
		setBrand(brand);
	}
	...
	public EMPLOYMENT_AGENCY(ContactPoint contactPoint) {
	...
	public EMPLOYMENT_AGENCY(ContainedInPlace containedInPlace) {
	...
	public EMPLOYMENT_AGENCY(ContainsPlace containsPlace) {
	...
	public EMPLOYMENT_AGENCY(CorrectionsPolicy correctionsPolicy) {
	...
	public EMPLOYMENT_AGENCY(CurrenciesAccepted currenciesAccepted) {
	...
	public EMPLOYMENT_AGENCY(Department department) {
	...
	public EMPLOYMENT_AGENCY(Description description) {
	...
	public EMPLOYMENT_AGENCY(DisambiguatingDescription disambiguatingDescription) {
	...
	public EMPLOYMENT_AGENCY(DissolutionDate dissolutionDate) {
	...
	public EMPLOYMENT_AGENCY(DiversityPolicy diversityPolicy) {
	...
	public EMPLOYMENT_AGENCY(DiversityStaffingReport diversityStaffingReport) {
	...
	public EMPLOYMENT_AGENCY(Duns duns) {
		setDuns(duns);
	}
	...
	public EMPLOYMENT_AGENCY(Email email) {
		setEmail(email);
	}
	...
	public EMPLOYMENT_AGENCY(Employee employee) {
	...
	public EMPLOYMENT_AGENCY(EthicsPolicy ethicsPolicy) {
	...
	public EMPLOYMENT_AGENCY(Event event) {
		setEvent(event);
	}
	...
	public EMPLOYMENT_AGENCY(FaxNumber faxNumber) {
	...
	public EMPLOYMENT_AGENCY(Founder founder) {
		setFounder(founder);
	}
	...
	public EMPLOYMENT_AGENCY(FoundingDate foundingDate) {
	...
	public EMPLOYMENT_AGENCY(FoundingLocation foundingLocation) {
	...
	public EMPLOYMENT_AGENCY(Funder funder) {
		setFunder(funder);
	}
	...
	public EMPLOYMENT_AGENCY(Geo geo) {
		setGeo(geo);
	}
	...
	public EMPLOYMENT_AGENCY(GeospatiallyContains geospatiallyContains) {
	...
	public EMPLOYMENT_AGENCY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public EMPLOYMENT_AGENCY(GeospatiallyCovers geospatiallyCovers) {
	...
	public EMPLOYMENT_AGENCY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public EMPLOYMENT_AGENCY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public EMPLOYMENT_AGENCY(GeospatiallyEquals geospatiallyEquals) {
	...
	public EMPLOYMENT_AGENCY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public EMPLOYMENT_AGENCY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public EMPLOYMENT_AGENCY(GeospatiallyTouches geospatiallyTouches) {
	...
	public EMPLOYMENT_AGENCY(GeospatiallyWithin geospatiallyWithin) {
	...
	public EMPLOYMENT_AGENCY(GlobalLocationNumber globalLocationNumber) {
	...
	public EMPLOYMENT_AGENCY(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public EMPLOYMENT_AGENCY(HasOfferCatalog hasOfferCatalog) {
	...
	public EMPLOYMENT_AGENCY(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public EMPLOYMENT_AGENCY(Identifier identifier) {
	...
	public EMPLOYMENT_AGENCY(Image image) {
		setImage(image);
	}
	...
	public EMPLOYMENT_AGENCY(IsAccessibleForFree isAccessibleForFree) {
	...
	public EMPLOYMENT_AGENCY(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public EMPLOYMENT_AGENCY(KnowsAbout knowsAbout) {
	...
	public EMPLOYMENT_AGENCY(KnowsLanguage knowsLanguage) {
	...
	public EMPLOYMENT_AGENCY(LegalName legalName) {
	...
	public EMPLOYMENT_AGENCY(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public EMPLOYMENT_AGENCY(Location location) {
	...
	public EMPLOYMENT_AGENCY(Logo logo) {
		setLogo(logo);
	}
	...
	public EMPLOYMENT_AGENCY(MainEntityOfPage mainEntityOfPage) {
	...
	public EMPLOYMENT_AGENCY(MakesOffer makesOffer) {
	...
	public EMPLOYMENT_AGENCY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public EMPLOYMENT_AGENCY(Member member) {
		setMember(member);
	}
	...
	public EMPLOYMENT_AGENCY(MemberOf memberOf) {
	...
	public EMPLOYMENT_AGENCY(Naics naics) {
		setNaics(naics);
	}
	...
	public EMPLOYMENT_AGENCY(Name name) {
		setName(name);
	}
	...
	public EMPLOYMENT_AGENCY(NameFuzzy nameFuzzy) {
	...
	public EMPLOYMENT_AGENCY(NameRuby nameRuby) {
	...
	public EMPLOYMENT_AGENCY(NumberOfEmployees numberOfEmployees) {
	...
	public EMPLOYMENT_AGENCY(OpeningHours openingHours) {
	...
	public EMPLOYMENT_AGENCY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public EMPLOYMENT_AGENCY(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public EMPLOYMENT_AGENCY(Owns owns) {
		setOwns(owns);
	}
	...
	public EMPLOYMENT_AGENCY(ParentOrganization parentOrganization) {
	...
	public EMPLOYMENT_AGENCY(PaymentAccepted paymentAccepted) {
	...
	public EMPLOYMENT_AGENCY(Photo photo) {
		setPhoto(photo);
	}
	...
	public EMPLOYMENT_AGENCY(PotentialAction potentialAction) {
	...
	public EMPLOYMENT_AGENCY(PriceRange priceRange) {
	...
	public EMPLOYMENT_AGENCY(PublicAccess publicAccess) {
	...
	public EMPLOYMENT_AGENCY(PublishingPrinciples publishingPrinciples) {
	...
	public EMPLOYMENT_AGENCY(Review review) {
		setReview(review);
	}
	...
	public EMPLOYMENT_AGENCY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public EMPLOYMENT_AGENCY(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public EMPLOYMENT_AGENCY(SmokingAllowed smokingAllowed) {
	...
	public EMPLOYMENT_AGENCY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public EMPLOYMENT_AGENCY(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public EMPLOYMENT_AGENCY(SubOrganization subOrganization) {
	...
	public EMPLOYMENT_AGENCY(SubjectOf subjectOf) {
	...
	public EMPLOYMENT_AGENCY(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public EMPLOYMENT_AGENCY(Telephone telephone) {
	...
	public EMPLOYMENT_AGENCY(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public EMPLOYMENT_AGENCY(Url url) {
		setUrl(url);
	}
	...
	public EMPLOYMENT_AGENCY(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.EmploymentAgency org) {
		setSeq(org.getSeq());
