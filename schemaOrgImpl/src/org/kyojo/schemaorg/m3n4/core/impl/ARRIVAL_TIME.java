...
public class ARRIVAL_TIME implements Container.ArrivalTime {
	...
	public ARRIVAL_TIME(java.util.Date dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public ARRIVAL_TIME(java.time.OffsetDateTime dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public ARRIVAL_TIME(DateTime dateTime) {
