...
public class SINGLE_FAMILY_RESIDENCE implements Clazz.SingleFamilyResidence {
	...
	public SINGLE_FAMILY_RESIDENCE() {
	}

	public SINGLE_FAMILY_RESIDENCE(Long seq) {
		setSeq(seq);
	}

	public SINGLE_FAMILY_RESIDENCE(String string) {
	...
	public SINGLE_FAMILY_RESIDENCE(AdditionalProperty additionalProperty) {
	...
	public SINGLE_FAMILY_RESIDENCE(AdditionalType additionalType) {
	...
	public SINGLE_FAMILY_RESIDENCE(Address address) {
		setAddress(address);
	}
	...
	public SINGLE_FAMILY_RESIDENCE(AggregateRating aggregateRating) {
	...
	public SINGLE_FAMILY_RESIDENCE(AlternateName alternateName) {
	...
	public SINGLE_FAMILY_RESIDENCE(AmenityFeature amenityFeature) {
	...
	public SINGLE_FAMILY_RESIDENCE(BranchCode branchCode) {
	...
	public SINGLE_FAMILY_RESIDENCE(ContainedInPlace containedInPlace) {
	...
	public SINGLE_FAMILY_RESIDENCE(ContainsPlace containsPlace) {
	...
	public SINGLE_FAMILY_RESIDENCE(Description description) {
	...
	public SINGLE_FAMILY_RESIDENCE(DisambiguatingDescription disambiguatingDescription) {
	...
	public SINGLE_FAMILY_RESIDENCE(Event event) {
		setEvent(event);
	}
	...
	public SINGLE_FAMILY_RESIDENCE(FaxNumber faxNumber) {
	...
	public SINGLE_FAMILY_RESIDENCE(FloorSize floorSize) {
	...
	public SINGLE_FAMILY_RESIDENCE(Geo geo) {
		setGeo(geo);
	}
	...
	public SINGLE_FAMILY_RESIDENCE(GeospatiallyContains geospatiallyContains) {
	...
	public SINGLE_FAMILY_RESIDENCE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public SINGLE_FAMILY_RESIDENCE(GeospatiallyCovers geospatiallyCovers) {
	...
	public SINGLE_FAMILY_RESIDENCE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public SINGLE_FAMILY_RESIDENCE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public SINGLE_FAMILY_RESIDENCE(GeospatiallyEquals geospatiallyEquals) {
	...
	public SINGLE_FAMILY_RESIDENCE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public SINGLE_FAMILY_RESIDENCE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public SINGLE_FAMILY_RESIDENCE(GeospatiallyTouches geospatiallyTouches) {
	...
	public SINGLE_FAMILY_RESIDENCE(GeospatiallyWithin geospatiallyWithin) {
	...
	public SINGLE_FAMILY_RESIDENCE(GlobalLocationNumber globalLocationNumber) {
	...
	public SINGLE_FAMILY_RESIDENCE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public SINGLE_FAMILY_RESIDENCE(Identifier identifier) {
	...
	public SINGLE_FAMILY_RESIDENCE(Image image) {
		setImage(image);
	}
	...
	public SINGLE_FAMILY_RESIDENCE(IsAccessibleForFree isAccessibleForFree) {
	...
	public SINGLE_FAMILY_RESIDENCE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public SINGLE_FAMILY_RESIDENCE(Logo logo) {
		setLogo(logo);
	}
	...
	public SINGLE_FAMILY_RESIDENCE(MainEntityOfPage mainEntityOfPage) {
	...
	public SINGLE_FAMILY_RESIDENCE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public SINGLE_FAMILY_RESIDENCE(Name name) {
		setName(name);
	}
	...
	public SINGLE_FAMILY_RESIDENCE(NameFuzzy nameFuzzy) {
	...
	public SINGLE_FAMILY_RESIDENCE(NameRuby nameRuby) {
	...
	public SINGLE_FAMILY_RESIDENCE(NumberOfRooms numberOfRooms) {
	...
	public SINGLE_FAMILY_RESIDENCE(Occupancy occupancy) {
	...
	public SINGLE_FAMILY_RESIDENCE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public SINGLE_FAMILY_RESIDENCE(PermittedUsage permittedUsage) {
	...
	public SINGLE_FAMILY_RESIDENCE(PetsAllowed petsAllowed) {
	...
	public SINGLE_FAMILY_RESIDENCE(Photo photo) {
		setPhoto(photo);
	}
	...
	public SINGLE_FAMILY_RESIDENCE(PotentialAction potentialAction) {
	...
	public SINGLE_FAMILY_RESIDENCE(PublicAccess publicAccess) {
	...
	public SINGLE_FAMILY_RESIDENCE(Review review) {
		setReview(review);
	}
	...
	public SINGLE_FAMILY_RESIDENCE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SINGLE_FAMILY_RESIDENCE(SmokingAllowed smokingAllowed) {
	...
	public SINGLE_FAMILY_RESIDENCE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public SINGLE_FAMILY_RESIDENCE(SubjectOf subjectOf) {
	...
	public SINGLE_FAMILY_RESIDENCE(Telephone telephone) {
	...
	public SINGLE_FAMILY_RESIDENCE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.SingleFamilyResidence org) {
		setSeq(org.getSeq());
