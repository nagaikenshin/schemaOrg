...
public class VISUAL_ARTS_EVENT implements Clazz.VisualArtsEvent {
	...
	public VISUAL_ARTS_EVENT() {
	}

	public VISUAL_ARTS_EVENT(Long seq) {
		setSeq(seq);
	}

	public VISUAL_ARTS_EVENT(String string) {
	...
	public VISUAL_ARTS_EVENT(About about) {
		setAbout(about);
	}
	...
	public VISUAL_ARTS_EVENT(Actor actor) {
		setActor(actor);
	}
	...
	public VISUAL_ARTS_EVENT(AdditionalType additionalType) {
	...
	public VISUAL_ARTS_EVENT(AggregateRating aggregateRating) {
	...
	public VISUAL_ARTS_EVENT(AlternateName alternateName) {
	...
	public VISUAL_ARTS_EVENT(Attendee attendee) {
	...
	public VISUAL_ARTS_EVENT(Audience audience) {
	...
	public VISUAL_ARTS_EVENT(Composer composer) {
	...
	public VISUAL_ARTS_EVENT(Contributor contributor) {
	...
	public VISUAL_ARTS_EVENT(Description description) {
	...
	public VISUAL_ARTS_EVENT(Director director) {
	...
	public VISUAL_ARTS_EVENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public VISUAL_ARTS_EVENT(DoorTime doorTime) {
	...
	public VISUAL_ARTS_EVENT(Duration duration) {
	...
	public VISUAL_ARTS_EVENT(EndDate endDate) {
		setEndDate(endDate);
	}
	...
	public VISUAL_ARTS_EVENT(EventStatus eventStatus) {
	...
	public VISUAL_ARTS_EVENT(Funder funder) {
		setFunder(funder);
	}
	...
	public VISUAL_ARTS_EVENT(Identifier identifier) {
	...
	public VISUAL_ARTS_EVENT(Image image) {
		setImage(image);
	}
	...
	public VISUAL_ARTS_EVENT(InLanguage inLanguage) {
	...
	public VISUAL_ARTS_EVENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public VISUAL_ARTS_EVENT(Location location) {
	...
	public VISUAL_ARTS_EVENT(MainEntityOfPage mainEntityOfPage) {
	...
	public VISUAL_ARTS_EVENT(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public VISUAL_ARTS_EVENT(Name name) {
		setName(name);
	}
	...
	public VISUAL_ARTS_EVENT(NameFuzzy nameFuzzy) {
	...
	public VISUAL_ARTS_EVENT(NameRuby nameRuby) {
	...
	public VISUAL_ARTS_EVENT(Offers offers) {
		setOffers(offers);
	}
	...
	public VISUAL_ARTS_EVENT(Organizer organizer) {
	...
	public VISUAL_ARTS_EVENT(Performer performer) {
	...
	public VISUAL_ARTS_EVENT(PotentialAction potentialAction) {
	...
	public VISUAL_ARTS_EVENT(PreviousStartDate previousStartDate) {
	...
	public VISUAL_ARTS_EVENT(RecordedIn recordedIn) {
	...
	public VISUAL_ARTS_EVENT(RemainingAttendeeCapacity remainingAttendeeCapacity) {
	...
	public VISUAL_ARTS_EVENT(Review review) {
		setReview(review);
	}
	...
	public VISUAL_ARTS_EVENT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public VISUAL_ARTS_EVENT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public VISUAL_ARTS_EVENT(StartDate startDate) {
	...
	public VISUAL_ARTS_EVENT(SubEvent subEvent) {
	...
	public VISUAL_ARTS_EVENT(SubjectOf subjectOf) {
	...
	public VISUAL_ARTS_EVENT(SuperEvent superEvent) {
	...
	public VISUAL_ARTS_EVENT(Translator translator) {
	...
	public VISUAL_ARTS_EVENT(TypicalAgeRange typicalAgeRange) {
	...
	public VISUAL_ARTS_EVENT(Url url) {
		setUrl(url);
	}
	...
	public VISUAL_ARTS_EVENT(WorkFeatured workFeatured) {
	...
	public VISUAL_ARTS_EVENT(WorkPerformed workPerformed) {
	...
	public void copy(Clazz.VisualArtsEvent org) {
		setSeq(org.getSeq());
