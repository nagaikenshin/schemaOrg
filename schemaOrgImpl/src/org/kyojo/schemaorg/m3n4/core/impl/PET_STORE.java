...
public class PET_STORE implements Clazz.PetStore {
	...
	public PET_STORE(Long seq) {
		setSeq(seq);
	}

	public PET_STORE(String string) {
	...
	public PET_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public PET_STORE(AdditionalProperty additionalProperty) {
	...
	public PET_STORE(AdditionalType additionalType) {
	...
	public PET_STORE(Address address) {
		setAddress(address);
	}
	...
	public PET_STORE(AggregateRating aggregateRating) {
	...
	public PET_STORE(AlternateName alternateName) {
	...
	public PET_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public PET_STORE(AmenityFeature amenityFeature) {
	...
	public PET_STORE(AreaServed areaServed) {
	...
	public PET_STORE(BranchCode branchCode) {
	...
	public PET_STORE(ContactPoint contactPoint) {
	...
	public PET_STORE(ContainedInPlace containedInPlace) {
	...
	public PET_STORE(ContainsPlace containsPlace) {
	...
	public PET_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public PET_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public PET_STORE(Department department) {
	...
	public PET_STORE(Description description) {
	...
	public PET_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public PET_STORE(DissolutionDate dissolutionDate) {
	...
	public PET_STORE(DiversityPolicy diversityPolicy) {
	...
	public PET_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public PET_STORE(Employee employee) {
	...
	public PET_STORE(EthicsPolicy ethicsPolicy) {
	...
	public PET_STORE(FaxNumber faxNumber) {
	...
	public PET_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public PET_STORE(FoundingDate foundingDate) {
	...
	public PET_STORE(FoundingLocation foundingLocation) {
	...
	public PET_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public PET_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public PET_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public PET_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public PET_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public PET_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public PET_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public PET_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public PET_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public PET_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public PET_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public PET_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public PET_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public PET_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public PET_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public PET_STORE(Identifier identifier) {
	...
	public PET_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public PET_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public PET_STORE(KnowsAbout knowsAbout) {
	...
	public PET_STORE(KnowsLanguage knowsLanguage) {
	...
	public PET_STORE(LegalName legalName) {
	...
	public PET_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public PET_STORE(Location location) {
	...
	public PET_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public PET_STORE(MakesOffer makesOffer) {
	...
	public PET_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public PET_STORE(Member member) {
		setMember(member);
	}
	...
	public PET_STORE(MemberOf memberOf) {
	...
	public PET_STORE(NameFuzzy nameFuzzy) {
	...
	public PET_STORE(NameRuby nameRuby) {
	...
	public PET_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public PET_STORE(OpeningHours openingHours) {
	...
	public PET_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public PET_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public PET_STORE(ParentOrganization parentOrganization) {
	...
	public PET_STORE(PaymentAccepted paymentAccepted) {
	...
	public PET_STORE(PotentialAction potentialAction) {
	...
	public PET_STORE(PriceRange priceRange) {
	...
	public PET_STORE(PublicAccess publicAccess) {
	...
	public PET_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public PET_STORE(Review review) {
		setReview(review);
	}
	...
	public PET_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PET_STORE(SmokingAllowed smokingAllowed) {
	...
	public PET_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public PET_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public PET_STORE(SubOrganization subOrganization) {
	...
	public PET_STORE(SubjectOf subjectOf) {
	...
	public PET_STORE(Telephone telephone) {
	...
	public PET_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.PetStore org) {
		setSeq(org.getSeq());
