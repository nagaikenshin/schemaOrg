...
public class THEATER_EVENT implements Clazz.TheaterEvent {
	...
	public THEATER_EVENT() {
	}

	public THEATER_EVENT(Long seq) {
		setSeq(seq);
	}

	public THEATER_EVENT(String string) {
	...
	public THEATER_EVENT(About about) {
		setAbout(about);
	}
	...
	public THEATER_EVENT(Actor actor) {
		setActor(actor);
	}
	...
	public THEATER_EVENT(AdditionalType additionalType) {
	...
	public THEATER_EVENT(AggregateRating aggregateRating) {
	...
	public THEATER_EVENT(AlternateName alternateName) {
	...
	public THEATER_EVENT(Attendee attendee) {
	...
	public THEATER_EVENT(Audience audience) {
	...
	public THEATER_EVENT(Composer composer) {
	...
	public THEATER_EVENT(Contributor contributor) {
	...
	public THEATER_EVENT(Description description) {
	...
	public THEATER_EVENT(Director director) {
	...
	public THEATER_EVENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public THEATER_EVENT(DoorTime doorTime) {
	...
	public THEATER_EVENT(Duration duration) {
	...
	public THEATER_EVENT(EndDate endDate) {
		setEndDate(endDate);
	}
	...
	public THEATER_EVENT(EventStatus eventStatus) {
	...
	public THEATER_EVENT(Funder funder) {
		setFunder(funder);
	}
	...
	public THEATER_EVENT(Identifier identifier) {
	...
	public THEATER_EVENT(Image image) {
		setImage(image);
	}
	...
	public THEATER_EVENT(InLanguage inLanguage) {
	...
	public THEATER_EVENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public THEATER_EVENT(Location location) {
	...
	public THEATER_EVENT(MainEntityOfPage mainEntityOfPage) {
	...
	public THEATER_EVENT(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public THEATER_EVENT(Name name) {
		setName(name);
	}
	...
	public THEATER_EVENT(NameFuzzy nameFuzzy) {
	...
	public THEATER_EVENT(NameRuby nameRuby) {
	...
	public THEATER_EVENT(Offers offers) {
		setOffers(offers);
	}
	...
	public THEATER_EVENT(Organizer organizer) {
	...
	public THEATER_EVENT(Performer performer) {
	...
	public THEATER_EVENT(PotentialAction potentialAction) {
	...
	public THEATER_EVENT(PreviousStartDate previousStartDate) {
	...
	public THEATER_EVENT(RecordedIn recordedIn) {
	...
	public THEATER_EVENT(RemainingAttendeeCapacity remainingAttendeeCapacity) {
	...
	public THEATER_EVENT(Review review) {
		setReview(review);
	}
	...
	public THEATER_EVENT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public THEATER_EVENT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public THEATER_EVENT(StartDate startDate) {
	...
	public THEATER_EVENT(SubEvent subEvent) {
	...
	public THEATER_EVENT(SubjectOf subjectOf) {
	...
	public THEATER_EVENT(SuperEvent superEvent) {
	...
	public THEATER_EVENT(Translator translator) {
	...
	public THEATER_EVENT(TypicalAgeRange typicalAgeRange) {
	...
	public THEATER_EVENT(WorkFeatured workFeatured) {
	...
	public THEATER_EVENT(WorkPerformed workPerformed) {
	...
	public void copy(Clazz.TheaterEvent org) {
		setSeq(org.getSeq());
