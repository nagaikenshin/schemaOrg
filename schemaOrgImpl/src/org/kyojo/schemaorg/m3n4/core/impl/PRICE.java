...
public class PRICE implements Container.Price {
	...
	public PRICE(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public PRICE(Float fl0at) {
	...
	public PRICE(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public PRICE(Integer integer) {
	...
	public PRICE(java.math.BigDecimal number) {
	...
	public PRICE(List<Float> fl0atList,
	...
	public void copy(Container.Price org) {
