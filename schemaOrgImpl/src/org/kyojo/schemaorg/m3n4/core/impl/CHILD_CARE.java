...
public class CHILD_CARE implements Clazz.ChildCare {
	...
	public CHILD_CARE(Long seq) {
		setSeq(seq);
	}

	public CHILD_CARE(String string) {
	...
	public CHILD_CARE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public CHILD_CARE(AdditionalProperty additionalProperty) {
	...
	public CHILD_CARE(AdditionalType additionalType) {
	...
	public CHILD_CARE(Address address) {
		setAddress(address);
	}
	...
	public CHILD_CARE(AggregateRating aggregateRating) {
	...
	public CHILD_CARE(AlternateName alternateName) {
	...
	public CHILD_CARE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public CHILD_CARE(AmenityFeature amenityFeature) {
	...
	public CHILD_CARE(AreaServed areaServed) {
	...
	public CHILD_CARE(BranchCode branchCode) {
	...
	public CHILD_CARE(ContactPoint contactPoint) {
	...
	public CHILD_CARE(ContainedInPlace containedInPlace) {
	...
	public CHILD_CARE(ContainsPlace containsPlace) {
	...
	public CHILD_CARE(CorrectionsPolicy correctionsPolicy) {
	...
	public CHILD_CARE(CurrenciesAccepted currenciesAccepted) {
	...
	public CHILD_CARE(Department department) {
	...
	public CHILD_CARE(Description description) {
	...
	public CHILD_CARE(DisambiguatingDescription disambiguatingDescription) {
	...
	public CHILD_CARE(DissolutionDate dissolutionDate) {
	...
	public CHILD_CARE(DiversityPolicy diversityPolicy) {
	...
	public CHILD_CARE(DiversityStaffingReport diversityStaffingReport) {
	...
	public CHILD_CARE(Employee employee) {
	...
	public CHILD_CARE(EthicsPolicy ethicsPolicy) {
	...
	public CHILD_CARE(FaxNumber faxNumber) {
	...
	public CHILD_CARE(Founder founder) {
		setFounder(founder);
	}
	...
	public CHILD_CARE(FoundingDate foundingDate) {
	...
	public CHILD_CARE(FoundingLocation foundingLocation) {
	...
	public CHILD_CARE(Funder funder) {
		setFunder(funder);
	}
	...
	public CHILD_CARE(GeospatiallyContains geospatiallyContains) {
	...
	public CHILD_CARE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public CHILD_CARE(GeospatiallyCovers geospatiallyCovers) {
	...
	public CHILD_CARE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public CHILD_CARE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public CHILD_CARE(GeospatiallyEquals geospatiallyEquals) {
	...
	public CHILD_CARE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public CHILD_CARE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public CHILD_CARE(GeospatiallyTouches geospatiallyTouches) {
	...
	public CHILD_CARE(GeospatiallyWithin geospatiallyWithin) {
	...
	public CHILD_CARE(GlobalLocationNumber globalLocationNumber) {
	...
	public CHILD_CARE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public CHILD_CARE(HasOfferCatalog hasOfferCatalog) {
	...
	public CHILD_CARE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public CHILD_CARE(Identifier identifier) {
	...
	public CHILD_CARE(IsAccessibleForFree isAccessibleForFree) {
	...
	public CHILD_CARE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public CHILD_CARE(KnowsAbout knowsAbout) {
	...
	public CHILD_CARE(KnowsLanguage knowsLanguage) {
	...
	public CHILD_CARE(LegalName legalName) {
	...
	public CHILD_CARE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public CHILD_CARE(Location location) {
	...
	public CHILD_CARE(MainEntityOfPage mainEntityOfPage) {
	...
	public CHILD_CARE(MakesOffer makesOffer) {
	...
	public CHILD_CARE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public CHILD_CARE(Member member) {
		setMember(member);
	}
	...
	public CHILD_CARE(MemberOf memberOf) {
	...
	public CHILD_CARE(NameFuzzy nameFuzzy) {
	...
	public CHILD_CARE(NameRuby nameRuby) {
	...
	public CHILD_CARE(NumberOfEmployees numberOfEmployees) {
	...
	public CHILD_CARE(OpeningHours openingHours) {
	...
	public CHILD_CARE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public CHILD_CARE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public CHILD_CARE(ParentOrganization parentOrganization) {
	...
	public CHILD_CARE(PaymentAccepted paymentAccepted) {
	...
	public CHILD_CARE(PotentialAction potentialAction) {
	...
	public CHILD_CARE(PriceRange priceRange) {
	...
	public CHILD_CARE(PublicAccess publicAccess) {
	...
	public CHILD_CARE(PublishingPrinciples publishingPrinciples) {
	...
	public CHILD_CARE(Review review) {
		setReview(review);
	}
	...
	public CHILD_CARE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CHILD_CARE(SmokingAllowed smokingAllowed) {
	...
	public CHILD_CARE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public CHILD_CARE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public CHILD_CARE(SubOrganization subOrganization) {
	...
	public CHILD_CARE(SubjectOf subjectOf) {
	...
	public CHILD_CARE(Telephone telephone) {
	...
	public CHILD_CARE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.ChildCare org) {
		setSeq(org.getSeq());
