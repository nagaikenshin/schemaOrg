...
public class REPLY_ACTION implements Clazz.ReplyAction {
	...
	public REPLY_ACTION(Long seq) {
		setSeq(seq);
	}

	public REPLY_ACTION(String string) {
	...
	public REPLY_ACTION(About about) {
		setAbout(about);
	}
	...
	public REPLY_ACTION(ActionStatus actionStatus) {
	...
	public REPLY_ACTION(AdditionalType additionalType) {
	...
	public REPLY_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public REPLY_ACTION(AlternateName alternateName) {
	...
	public REPLY_ACTION(Description description) {
	...
	public REPLY_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public REPLY_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public REPLY_ACTION(Error error) {
		setError(error);
	}
	...
	public REPLY_ACTION(Identifier identifier) {
	...
	public REPLY_ACTION(Image image) {
		setImage(image);
	}
	...
	public REPLY_ACTION(InLanguage inLanguage) {
	...
	public REPLY_ACTION(Instrument instrument) {
	...
	public REPLY_ACTION(Location location) {
	...
	public REPLY_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public REPLY_ACTION(NameFuzzy nameFuzzy) {
	...
	public REPLY_ACTION(NameRuby nameRuby) {
	...
	public REPLY_ACTION(Object object) {
		setObject(object);
	}
	...
	public REPLY_ACTION(Participant participant) {
	...
	public REPLY_ACTION(PotentialAction potentialAction) {
	...
	public REPLY_ACTION(Recipient recipient) {
	...
	public REPLY_ACTION(Result result) {
		setResult(result);
	}
	...
	public REPLY_ACTION(ResultComment resultComment) {
	...
	public REPLY_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public REPLY_ACTION(StartTime startTime) {
	...
	public REPLY_ACTION(SubjectOf subjectOf) {
	...
	public REPLY_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.ReplyAction org) {
		setSeq(org.getSeq());
