...
public class BRIDGE implements Clazz.Bridge {
	...
	public BRIDGE(AdditionalProperty additionalProperty) {
	...
	public BRIDGE(AdditionalType additionalType) {
	...
	public BRIDGE(AggregateRating aggregateRating) {
	...
	public BRIDGE(AlternateName alternateName) {
	...
	public BRIDGE(AmenityFeature amenityFeature) {
	...
	public BRIDGE(BranchCode branchCode) {
	...
	public BRIDGE(ContainedInPlace containedInPlace) {
	...
	public BRIDGE(ContainsPlace containsPlace) {
	...
	public BRIDGE(Description description) {
	...
	public BRIDGE(DisambiguatingDescription disambiguatingDescription) {
	...
	public BRIDGE(FaxNumber faxNumber) {
	...
	public BRIDGE(GeospatiallyContains geospatiallyContains) {
	...
	public BRIDGE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public BRIDGE(GeospatiallyCovers geospatiallyCovers) {
	...
	public BRIDGE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public BRIDGE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public BRIDGE(GeospatiallyEquals geospatiallyEquals) {
	...
	public BRIDGE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public BRIDGE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public BRIDGE(GeospatiallyTouches geospatiallyTouches) {
	...
	public BRIDGE(GeospatiallyWithin geospatiallyWithin) {
	...
	public BRIDGE(GlobalLocationNumber globalLocationNumber) {
	...
	public BRIDGE(Identifier identifier) {
	...
	public BRIDGE(IsAccessibleForFree isAccessibleForFree) {
	...
	public BRIDGE(MainEntityOfPage mainEntityOfPage) {
	...
	public BRIDGE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public BRIDGE(NameFuzzy nameFuzzy) {
	...
	public BRIDGE(NameRuby nameRuby) {
	...
	public BRIDGE(OpeningHours openingHours) {
	...
	public BRIDGE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public BRIDGE(PotentialAction potentialAction) {
	...
	public BRIDGE(PublicAccess publicAccess) {
	...
	public BRIDGE(SmokingAllowed smokingAllowed) {
	...
	public BRIDGE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public BRIDGE(SubjectOf subjectOf) {
	...
	public BRIDGE(Telephone telephone) {
	...
	public void copy(Clazz.Bridge org) {
		setSeq(org.getSeq());
