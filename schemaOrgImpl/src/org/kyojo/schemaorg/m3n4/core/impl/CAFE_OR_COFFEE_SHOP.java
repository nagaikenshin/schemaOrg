...
public class CAFE_OR_COFFEE_SHOP implements Clazz.CafeOrCoffeeShop {
	...
	public CAFE_OR_COFFEE_SHOP() {
	}

	public CAFE_OR_COFFEE_SHOP(Long seq) {
		setSeq(seq);
	}

	public CAFE_OR_COFFEE_SHOP(String string) {
	...
	public CAFE_OR_COFFEE_SHOP(AcceptsReservations acceptsReservations) {
	...
	public CAFE_OR_COFFEE_SHOP(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public CAFE_OR_COFFEE_SHOP(AdditionalProperty additionalProperty) {
	...
	public CAFE_OR_COFFEE_SHOP(AdditionalType additionalType) {
	...
	public CAFE_OR_COFFEE_SHOP(Address address) {
		setAddress(address);
	}
	...
	public CAFE_OR_COFFEE_SHOP(AggregateRating aggregateRating) {
	...
	public CAFE_OR_COFFEE_SHOP(AlternateName alternateName) {
	...
	public CAFE_OR_COFFEE_SHOP(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public CAFE_OR_COFFEE_SHOP(AmenityFeature amenityFeature) {
	...
	public CAFE_OR_COFFEE_SHOP(AreaServed areaServed) {
	...
	public CAFE_OR_COFFEE_SHOP(Award award) {
		setAward(award);
	}
	...
	public CAFE_OR_COFFEE_SHOP(BranchCode branchCode) {
	...
	public CAFE_OR_COFFEE_SHOP(Brand brand) {
		setBrand(brand);
	}
	...
	public CAFE_OR_COFFEE_SHOP(ContactPoint contactPoint) {
	...
	public CAFE_OR_COFFEE_SHOP(ContainedInPlace containedInPlace) {
	...
	public CAFE_OR_COFFEE_SHOP(ContainsPlace containsPlace) {
	...
	public CAFE_OR_COFFEE_SHOP(CorrectionsPolicy correctionsPolicy) {
	...
	public CAFE_OR_COFFEE_SHOP(CurrenciesAccepted currenciesAccepted) {
	...
	public CAFE_OR_COFFEE_SHOP(Department department) {
	...
	public CAFE_OR_COFFEE_SHOP(Description description) {
	...
	public CAFE_OR_COFFEE_SHOP(DisambiguatingDescription disambiguatingDescription) {
	...
	public CAFE_OR_COFFEE_SHOP(DissolutionDate dissolutionDate) {
	...
	public CAFE_OR_COFFEE_SHOP(DiversityPolicy diversityPolicy) {
	...
	public CAFE_OR_COFFEE_SHOP(DiversityStaffingReport diversityStaffingReport) {
	...
	public CAFE_OR_COFFEE_SHOP(Duns duns) {
		setDuns(duns);
	}
	...
	public CAFE_OR_COFFEE_SHOP(Email email) {
		setEmail(email);
	}
	...
	public CAFE_OR_COFFEE_SHOP(Employee employee) {
	...
	public CAFE_OR_COFFEE_SHOP(EthicsPolicy ethicsPolicy) {
	...
	public CAFE_OR_COFFEE_SHOP(Event event) {
		setEvent(event);
	}
	...
	public CAFE_OR_COFFEE_SHOP(FaxNumber faxNumber) {
	...
	public CAFE_OR_COFFEE_SHOP(Founder founder) {
		setFounder(founder);
	}
	...
	public CAFE_OR_COFFEE_SHOP(FoundingDate foundingDate) {
	...
	public CAFE_OR_COFFEE_SHOP(FoundingLocation foundingLocation) {
	...
	public CAFE_OR_COFFEE_SHOP(Funder funder) {
		setFunder(funder);
	}
	...
	public CAFE_OR_COFFEE_SHOP(Geo geo) {
		setGeo(geo);
	}
	...
	public CAFE_OR_COFFEE_SHOP(GeospatiallyContains geospatiallyContains) {
	...
	public CAFE_OR_COFFEE_SHOP(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public CAFE_OR_COFFEE_SHOP(GeospatiallyCovers geospatiallyCovers) {
	...
	public CAFE_OR_COFFEE_SHOP(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public CAFE_OR_COFFEE_SHOP(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public CAFE_OR_COFFEE_SHOP(GeospatiallyEquals geospatiallyEquals) {
	...
	public CAFE_OR_COFFEE_SHOP(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public CAFE_OR_COFFEE_SHOP(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public CAFE_OR_COFFEE_SHOP(GeospatiallyTouches geospatiallyTouches) {
	...
	public CAFE_OR_COFFEE_SHOP(GeospatiallyWithin geospatiallyWithin) {
	...
	public CAFE_OR_COFFEE_SHOP(GlobalLocationNumber globalLocationNumber) {
	...
	public CAFE_OR_COFFEE_SHOP(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public CAFE_OR_COFFEE_SHOP(HasMenu hasMenu) {
		setHasMenu(hasMenu);
	}
	...
	public CAFE_OR_COFFEE_SHOP(HasOfferCatalog hasOfferCatalog) {
	...
	public CAFE_OR_COFFEE_SHOP(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public CAFE_OR_COFFEE_SHOP(Identifier identifier) {
	...
	public CAFE_OR_COFFEE_SHOP(Image image) {
		setImage(image);
	}
	...
	public CAFE_OR_COFFEE_SHOP(IsAccessibleForFree isAccessibleForFree) {
	...
	public CAFE_OR_COFFEE_SHOP(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public CAFE_OR_COFFEE_SHOP(KnowsAbout knowsAbout) {
	...
	public CAFE_OR_COFFEE_SHOP(KnowsLanguage knowsLanguage) {
	...
	public CAFE_OR_COFFEE_SHOP(LegalName legalName) {
	...
	public CAFE_OR_COFFEE_SHOP(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public CAFE_OR_COFFEE_SHOP(Location location) {
	...
	public CAFE_OR_COFFEE_SHOP(Logo logo) {
		setLogo(logo);
	}
	...
	public CAFE_OR_COFFEE_SHOP(MainEntityOfPage mainEntityOfPage) {
	...
	public CAFE_OR_COFFEE_SHOP(MakesOffer makesOffer) {
	...
	public CAFE_OR_COFFEE_SHOP(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public CAFE_OR_COFFEE_SHOP(Member member) {
		setMember(member);
	}
	...
	public CAFE_OR_COFFEE_SHOP(MemberOf memberOf) {
	...
	public CAFE_OR_COFFEE_SHOP(Naics naics) {
		setNaics(naics);
	}
	...
	public CAFE_OR_COFFEE_SHOP(Name name) {
		setName(name);
	}
	...
	public CAFE_OR_COFFEE_SHOP(NameFuzzy nameFuzzy) {
	...
	public CAFE_OR_COFFEE_SHOP(NameRuby nameRuby) {
	...
	public CAFE_OR_COFFEE_SHOP(NumberOfEmployees numberOfEmployees) {
	...
	public CAFE_OR_COFFEE_SHOP(OpeningHours openingHours) {
	...
	public CAFE_OR_COFFEE_SHOP(OpeningHoursSpecification openingHoursSpecification) {
	...
	public CAFE_OR_COFFEE_SHOP(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public CAFE_OR_COFFEE_SHOP(Owns owns) {
		setOwns(owns);
	}
	...
	public CAFE_OR_COFFEE_SHOP(ParentOrganization parentOrganization) {
	...
	public CAFE_OR_COFFEE_SHOP(PaymentAccepted paymentAccepted) {
	...
	public CAFE_OR_COFFEE_SHOP(Photo photo) {
		setPhoto(photo);
	}
	...
	public CAFE_OR_COFFEE_SHOP(PotentialAction potentialAction) {
	...
	public CAFE_OR_COFFEE_SHOP(PriceRange priceRange) {
	...
	public CAFE_OR_COFFEE_SHOP(PublicAccess publicAccess) {
	...
	public CAFE_OR_COFFEE_SHOP(PublishingPrinciples publishingPrinciples) {
	...
	public CAFE_OR_COFFEE_SHOP(Review review) {
		setReview(review);
	}
	...
	public CAFE_OR_COFFEE_SHOP(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CAFE_OR_COFFEE_SHOP(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public CAFE_OR_COFFEE_SHOP(ServesCuisine servesCuisine) {
	...
	public CAFE_OR_COFFEE_SHOP(SmokingAllowed smokingAllowed) {
	...
	public CAFE_OR_COFFEE_SHOP(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public CAFE_OR_COFFEE_SHOP(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public CAFE_OR_COFFEE_SHOP(StarRating starRating) {
	...
	public CAFE_OR_COFFEE_SHOP(SubOrganization subOrganization) {
	...
	public CAFE_OR_COFFEE_SHOP(SubjectOf subjectOf) {
	...
	public CAFE_OR_COFFEE_SHOP(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public CAFE_OR_COFFEE_SHOP(Telephone telephone) {
	...
	public CAFE_OR_COFFEE_SHOP(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public CAFE_OR_COFFEE_SHOP(Url url) {
		setUrl(url);
	}
	...
	public CAFE_OR_COFFEE_SHOP(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.CafeOrCoffeeShop org) {
		setSeq(org.getSeq());
