...
public class ELECTRONICS_STORE implements Clazz.ElectronicsStore {
	...
	public ELECTRONICS_STORE() {
	}

	public ELECTRONICS_STORE(Long seq) {
		setSeq(seq);
	}

	public ELECTRONICS_STORE(String string) {
	...
	public ELECTRONICS_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public ELECTRONICS_STORE(AdditionalProperty additionalProperty) {
	...
	public ELECTRONICS_STORE(AdditionalType additionalType) {
	...
	public ELECTRONICS_STORE(Address address) {
		setAddress(address);
	}
	...
	public ELECTRONICS_STORE(AggregateRating aggregateRating) {
	...
	public ELECTRONICS_STORE(AlternateName alternateName) {
	...
	public ELECTRONICS_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public ELECTRONICS_STORE(AmenityFeature amenityFeature) {
	...
	public ELECTRONICS_STORE(AreaServed areaServed) {
	...
	public ELECTRONICS_STORE(Award award) {
		setAward(award);
	}
	...
	public ELECTRONICS_STORE(BranchCode branchCode) {
	...
	public ELECTRONICS_STORE(Brand brand) {
		setBrand(brand);
	}
	...
	public ELECTRONICS_STORE(ContactPoint contactPoint) {
	...
	public ELECTRONICS_STORE(ContainedInPlace containedInPlace) {
	...
	public ELECTRONICS_STORE(ContainsPlace containsPlace) {
	...
	public ELECTRONICS_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public ELECTRONICS_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public ELECTRONICS_STORE(Department department) {
	...
	public ELECTRONICS_STORE(Description description) {
	...
	public ELECTRONICS_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public ELECTRONICS_STORE(DissolutionDate dissolutionDate) {
	...
	public ELECTRONICS_STORE(DiversityPolicy diversityPolicy) {
	...
	public ELECTRONICS_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public ELECTRONICS_STORE(Duns duns) {
		setDuns(duns);
	}
	...
	public ELECTRONICS_STORE(Email email) {
		setEmail(email);
	}
	...
	public ELECTRONICS_STORE(Employee employee) {
	...
	public ELECTRONICS_STORE(EthicsPolicy ethicsPolicy) {
	...
	public ELECTRONICS_STORE(Event event) {
		setEvent(event);
	}
	...
	public ELECTRONICS_STORE(FaxNumber faxNumber) {
	...
	public ELECTRONICS_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public ELECTRONICS_STORE(FoundingDate foundingDate) {
	...
	public ELECTRONICS_STORE(FoundingLocation foundingLocation) {
	...
	public ELECTRONICS_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public ELECTRONICS_STORE(Geo geo) {
		setGeo(geo);
	}
	...
	public ELECTRONICS_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public ELECTRONICS_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public ELECTRONICS_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public ELECTRONICS_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public ELECTRONICS_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public ELECTRONICS_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public ELECTRONICS_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public ELECTRONICS_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public ELECTRONICS_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public ELECTRONICS_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public ELECTRONICS_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public ELECTRONICS_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public ELECTRONICS_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public ELECTRONICS_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public ELECTRONICS_STORE(Identifier identifier) {
	...
	public ELECTRONICS_STORE(Image image) {
		setImage(image);
	}
	...
	public ELECTRONICS_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public ELECTRONICS_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public ELECTRONICS_STORE(KnowsAbout knowsAbout) {
	...
	public ELECTRONICS_STORE(KnowsLanguage knowsLanguage) {
	...
	public ELECTRONICS_STORE(LegalName legalName) {
	...
	public ELECTRONICS_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public ELECTRONICS_STORE(Location location) {
	...
	public ELECTRONICS_STORE(Logo logo) {
		setLogo(logo);
	}
	...
	public ELECTRONICS_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public ELECTRONICS_STORE(MakesOffer makesOffer) {
	...
	public ELECTRONICS_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public ELECTRONICS_STORE(Member member) {
		setMember(member);
	}
	...
	public ELECTRONICS_STORE(MemberOf memberOf) {
	...
	public ELECTRONICS_STORE(Naics naics) {
		setNaics(naics);
	}
	...
	public ELECTRONICS_STORE(Name name) {
		setName(name);
	}
	...
	public ELECTRONICS_STORE(NameFuzzy nameFuzzy) {
	...
	public ELECTRONICS_STORE(NameRuby nameRuby) {
	...
	public ELECTRONICS_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public ELECTRONICS_STORE(OpeningHours openingHours) {
	...
	public ELECTRONICS_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public ELECTRONICS_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public ELECTRONICS_STORE(Owns owns) {
		setOwns(owns);
	}
	...
	public ELECTRONICS_STORE(ParentOrganization parentOrganization) {
	...
	public ELECTRONICS_STORE(PaymentAccepted paymentAccepted) {
	...
	public ELECTRONICS_STORE(Photo photo) {
		setPhoto(photo);
	}
	...
	public ELECTRONICS_STORE(PotentialAction potentialAction) {
	...
	public ELECTRONICS_STORE(PriceRange priceRange) {
	...
	public ELECTRONICS_STORE(PublicAccess publicAccess) {
	...
	public ELECTRONICS_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public ELECTRONICS_STORE(Review review) {
		setReview(review);
	}
	...
	public ELECTRONICS_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ELECTRONICS_STORE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public ELECTRONICS_STORE(SmokingAllowed smokingAllowed) {
	...
	public ELECTRONICS_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public ELECTRONICS_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public ELECTRONICS_STORE(SubOrganization subOrganization) {
	...
	public ELECTRONICS_STORE(SubjectOf subjectOf) {
	...
	public ELECTRONICS_STORE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public ELECTRONICS_STORE(Telephone telephone) {
	...
	public ELECTRONICS_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public ELECTRONICS_STORE(Url url) {
		setUrl(url);
	}
	...
	public ELECTRONICS_STORE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.ElectronicsStore org) {
		setSeq(org.getSeq());
