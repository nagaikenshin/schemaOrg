...
public class CONSUME_ACTION implements Clazz.ConsumeAction {
	...
	public ActionAccessibilityRequirement actionAccessibilityRequirement;
	...
	public CONSUME_ACTION() {
	}

	public CONSUME_ACTION(Long seq) {
		setSeq(seq);
	}

	public CONSUME_ACTION(String string) {
	...
	public CONSUME_ACTION(ActionAccessibilityRequirement actionAccessibilityRequirement) {
		setActionAccessibilityRequirement(actionAccessibilityRequirement);
	}
	...
	public CONSUME_ACTION(ActionStatus actionStatus) {
	...
	public CONSUME_ACTION(AdditionalType additionalType) {
	...
	public CONSUME_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public CONSUME_ACTION(AlternateName alternateName) {
	...
	public CONSUME_ACTION(Description description) {
	...
	public CONSUME_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public CONSUME_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public CONSUME_ACTION(Error error) {
		setError(error);
	}
	...
	public CONSUME_ACTION(ExpectsAcceptanceOf expectsAcceptanceOf) {
	...
	public CONSUME_ACTION(Identifier identifier) {
	...
	public CONSUME_ACTION(Image image) {
		setImage(image);
	}
	...
	public CONSUME_ACTION(Instrument instrument) {
	...
	public CONSUME_ACTION(Location location) {
	...
	public CONSUME_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public CONSUME_ACTION(Name name) {
		setName(name);
	}
	...
	public CONSUME_ACTION(NameFuzzy nameFuzzy) {
	...
	public CONSUME_ACTION(NameRuby nameRuby) {
	...
	public CONSUME_ACTION(Object object) {
		setObject(object);
	}
	...
	public CONSUME_ACTION(Participant participant) {
	...
	public CONSUME_ACTION(PotentialAction potentialAction) {
	...
	public CONSUME_ACTION(Result result) {
		setResult(result);
	}
	...
	public CONSUME_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CONSUME_ACTION(StartTime startTime) {
	...
	public CONSUME_ACTION(SubjectOf subjectOf) {
	...
	public CONSUME_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.ConsumeAction org) {
		setSeq(org.getSeq());
		...
		setActionAccessibilityRequirement(org.getActionAccessibilityRequirement());
