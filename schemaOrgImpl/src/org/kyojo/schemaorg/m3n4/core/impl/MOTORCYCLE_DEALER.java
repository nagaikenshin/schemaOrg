...
public class MOTORCYCLE_DEALER implements Clazz.MotorcycleDealer {
	...
	public MOTORCYCLE_DEALER() {
	}

	public MOTORCYCLE_DEALER(Long seq) {
		setSeq(seq);
	}

	public MOTORCYCLE_DEALER(String string) {
	...
	public MOTORCYCLE_DEALER(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public MOTORCYCLE_DEALER(AdditionalProperty additionalProperty) {
	...
	public MOTORCYCLE_DEALER(AdditionalType additionalType) {
	...
	public MOTORCYCLE_DEALER(Address address) {
		setAddress(address);
	}
	...
	public MOTORCYCLE_DEALER(AggregateRating aggregateRating) {
	...
	public MOTORCYCLE_DEALER(AlternateName alternateName) {
	...
	public MOTORCYCLE_DEALER(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public MOTORCYCLE_DEALER(AmenityFeature amenityFeature) {
	...
	public MOTORCYCLE_DEALER(AreaServed areaServed) {
	...
	public MOTORCYCLE_DEALER(Award award) {
		setAward(award);
	}
	...
	public MOTORCYCLE_DEALER(BranchCode branchCode) {
	...
	public MOTORCYCLE_DEALER(Brand brand) {
		setBrand(brand);
	}
	...
	public MOTORCYCLE_DEALER(ContactPoint contactPoint) {
	...
	public MOTORCYCLE_DEALER(ContainedInPlace containedInPlace) {
	...
	public MOTORCYCLE_DEALER(ContainsPlace containsPlace) {
	...
	public MOTORCYCLE_DEALER(CorrectionsPolicy correctionsPolicy) {
	...
	public MOTORCYCLE_DEALER(CurrenciesAccepted currenciesAccepted) {
	...
	public MOTORCYCLE_DEALER(Department department) {
	...
	public MOTORCYCLE_DEALER(Description description) {
	...
	public MOTORCYCLE_DEALER(DisambiguatingDescription disambiguatingDescription) {
	...
	public MOTORCYCLE_DEALER(DissolutionDate dissolutionDate) {
	...
	public MOTORCYCLE_DEALER(DiversityPolicy diversityPolicy) {
	...
	public MOTORCYCLE_DEALER(DiversityStaffingReport diversityStaffingReport) {
	...
	public MOTORCYCLE_DEALER(Duns duns) {
		setDuns(duns);
	}
	...
	public MOTORCYCLE_DEALER(Email email) {
		setEmail(email);
	}
	...
	public MOTORCYCLE_DEALER(Employee employee) {
	...
	public MOTORCYCLE_DEALER(EthicsPolicy ethicsPolicy) {
	...
	public MOTORCYCLE_DEALER(Event event) {
		setEvent(event);
	}
	...
	public MOTORCYCLE_DEALER(FaxNumber faxNumber) {
	...
	public MOTORCYCLE_DEALER(Founder founder) {
		setFounder(founder);
	}
	...
	public MOTORCYCLE_DEALER(FoundingDate foundingDate) {
	...
	public MOTORCYCLE_DEALER(FoundingLocation foundingLocation) {
	...
	public MOTORCYCLE_DEALER(Funder funder) {
		setFunder(funder);
	}
	...
	public MOTORCYCLE_DEALER(Geo geo) {
		setGeo(geo);
	}
	...
	public MOTORCYCLE_DEALER(GeospatiallyContains geospatiallyContains) {
	...
	public MOTORCYCLE_DEALER(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public MOTORCYCLE_DEALER(GeospatiallyCovers geospatiallyCovers) {
	...
	public MOTORCYCLE_DEALER(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public MOTORCYCLE_DEALER(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public MOTORCYCLE_DEALER(GeospatiallyEquals geospatiallyEquals) {
	...
	public MOTORCYCLE_DEALER(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public MOTORCYCLE_DEALER(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public MOTORCYCLE_DEALER(GeospatiallyTouches geospatiallyTouches) {
	...
	public MOTORCYCLE_DEALER(GeospatiallyWithin geospatiallyWithin) {
	...
	public MOTORCYCLE_DEALER(GlobalLocationNumber globalLocationNumber) {
	...
	public MOTORCYCLE_DEALER(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public MOTORCYCLE_DEALER(HasOfferCatalog hasOfferCatalog) {
	...
	public MOTORCYCLE_DEALER(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public MOTORCYCLE_DEALER(Identifier identifier) {
	...
	public MOTORCYCLE_DEALER(Image image) {
		setImage(image);
	}
	...
	public MOTORCYCLE_DEALER(IsAccessibleForFree isAccessibleForFree) {
	...
	public MOTORCYCLE_DEALER(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public MOTORCYCLE_DEALER(KnowsAbout knowsAbout) {
	...
	public MOTORCYCLE_DEALER(KnowsLanguage knowsLanguage) {
	...
	public MOTORCYCLE_DEALER(LegalName legalName) {
	...
	public MOTORCYCLE_DEALER(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public MOTORCYCLE_DEALER(Location location) {
	...
	public MOTORCYCLE_DEALER(Logo logo) {
		setLogo(logo);
	}
	...
	public MOTORCYCLE_DEALER(MainEntityOfPage mainEntityOfPage) {
	...
	public MOTORCYCLE_DEALER(MakesOffer makesOffer) {
	...
	public MOTORCYCLE_DEALER(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public MOTORCYCLE_DEALER(Member member) {
		setMember(member);
	}
	...
	public MOTORCYCLE_DEALER(MemberOf memberOf) {
	...
	public MOTORCYCLE_DEALER(Naics naics) {
		setNaics(naics);
	}
	...
	public MOTORCYCLE_DEALER(Name name) {
		setName(name);
	}
	...
	public MOTORCYCLE_DEALER(NameFuzzy nameFuzzy) {
	...
	public MOTORCYCLE_DEALER(NameRuby nameRuby) {
	...
	public MOTORCYCLE_DEALER(NumberOfEmployees numberOfEmployees) {
	...
	public MOTORCYCLE_DEALER(OpeningHours openingHours) {
	...
	public MOTORCYCLE_DEALER(OpeningHoursSpecification openingHoursSpecification) {
	...
	public MOTORCYCLE_DEALER(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public MOTORCYCLE_DEALER(Owns owns) {
		setOwns(owns);
	}
	...
	public MOTORCYCLE_DEALER(ParentOrganization parentOrganization) {
	...
	public MOTORCYCLE_DEALER(PaymentAccepted paymentAccepted) {
	...
	public MOTORCYCLE_DEALER(Photo photo) {
		setPhoto(photo);
	}
	...
	public MOTORCYCLE_DEALER(PotentialAction potentialAction) {
	...
	public MOTORCYCLE_DEALER(PriceRange priceRange) {
	...
	public MOTORCYCLE_DEALER(PublicAccess publicAccess) {
	...
	public MOTORCYCLE_DEALER(PublishingPrinciples publishingPrinciples) {
	...
	public MOTORCYCLE_DEALER(Review review) {
		setReview(review);
	}
	...
	public MOTORCYCLE_DEALER(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MOTORCYCLE_DEALER(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public MOTORCYCLE_DEALER(SmokingAllowed smokingAllowed) {
	...
	public MOTORCYCLE_DEALER(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public MOTORCYCLE_DEALER(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MOTORCYCLE_DEALER(SubOrganization subOrganization) {
	...
	public MOTORCYCLE_DEALER(SubjectOf subjectOf) {
	...
	public MOTORCYCLE_DEALER(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public MOTORCYCLE_DEALER(Telephone telephone) {
	...
	public MOTORCYCLE_DEALER(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public MOTORCYCLE_DEALER(Url url) {
		setUrl(url);
	}
	...
	public MOTORCYCLE_DEALER(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.MotorcycleDealer org) {
		setSeq(org.getSeq());
