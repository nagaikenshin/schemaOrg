...
public class AUTOMOTIVE_BUSINESS implements Clazz.AutomotiveBusiness {
	...
	public AUTOMOTIVE_BUSINESS() {
	}

	public AUTOMOTIVE_BUSINESS(Long seq) {
		setSeq(seq);
	}

	public AUTOMOTIVE_BUSINESS(String string) {
	...
	public AUTOMOTIVE_BUSINESS(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public AUTOMOTIVE_BUSINESS(AdditionalProperty additionalProperty) {
	...
	public AUTOMOTIVE_BUSINESS(AdditionalType additionalType) {
	...
	public AUTOMOTIVE_BUSINESS(Address address) {
		setAddress(address);
	}
	...
	public AUTOMOTIVE_BUSINESS(AggregateRating aggregateRating) {
	...
	public AUTOMOTIVE_BUSINESS(AlternateName alternateName) {
	...
	public AUTOMOTIVE_BUSINESS(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public AUTOMOTIVE_BUSINESS(AmenityFeature amenityFeature) {
	...
	public AUTOMOTIVE_BUSINESS(AreaServed areaServed) {
	...
	public AUTOMOTIVE_BUSINESS(Award award) {
		setAward(award);
	}
	...
	public AUTOMOTIVE_BUSINESS(BranchCode branchCode) {
	...
	public AUTOMOTIVE_BUSINESS(Brand brand) {
		setBrand(brand);
	}
	...
	public AUTOMOTIVE_BUSINESS(ContactPoint contactPoint) {
	...
	public AUTOMOTIVE_BUSINESS(ContainedInPlace containedInPlace) {
	...
	public AUTOMOTIVE_BUSINESS(ContainsPlace containsPlace) {
	...
	public AUTOMOTIVE_BUSINESS(CorrectionsPolicy correctionsPolicy) {
	...
	public AUTOMOTIVE_BUSINESS(CurrenciesAccepted currenciesAccepted) {
	...
	public AUTOMOTIVE_BUSINESS(Department department) {
	...
	public AUTOMOTIVE_BUSINESS(Description description) {
	...
	public AUTOMOTIVE_BUSINESS(DisambiguatingDescription disambiguatingDescription) {
	...
	public AUTOMOTIVE_BUSINESS(DissolutionDate dissolutionDate) {
	...
	public AUTOMOTIVE_BUSINESS(DiversityPolicy diversityPolicy) {
	...
	public AUTOMOTIVE_BUSINESS(DiversityStaffingReport diversityStaffingReport) {
	...
	public AUTOMOTIVE_BUSINESS(Duns duns) {
		setDuns(duns);
	}
	...
	public AUTOMOTIVE_BUSINESS(Email email) {
		setEmail(email);
	}
	...
	public AUTOMOTIVE_BUSINESS(Employee employee) {
	...
	public AUTOMOTIVE_BUSINESS(EthicsPolicy ethicsPolicy) {
	...
	public AUTOMOTIVE_BUSINESS(Event event) {
		setEvent(event);
	}
	...
	public AUTOMOTIVE_BUSINESS(FaxNumber faxNumber) {
	...
	public AUTOMOTIVE_BUSINESS(Founder founder) {
		setFounder(founder);
	}
	...
	public AUTOMOTIVE_BUSINESS(FoundingDate foundingDate) {
	...
	public AUTOMOTIVE_BUSINESS(FoundingLocation foundingLocation) {
	...
	public AUTOMOTIVE_BUSINESS(Funder funder) {
		setFunder(funder);
	}
	...
	public AUTOMOTIVE_BUSINESS(Geo geo) {
		setGeo(geo);
	}
	...
	public AUTOMOTIVE_BUSINESS(GeospatiallyContains geospatiallyContains) {
	...
	public AUTOMOTIVE_BUSINESS(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public AUTOMOTIVE_BUSINESS(GeospatiallyCovers geospatiallyCovers) {
	...
	public AUTOMOTIVE_BUSINESS(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public AUTOMOTIVE_BUSINESS(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public AUTOMOTIVE_BUSINESS(GeospatiallyEquals geospatiallyEquals) {
	...
	public AUTOMOTIVE_BUSINESS(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public AUTOMOTIVE_BUSINESS(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public AUTOMOTIVE_BUSINESS(GeospatiallyTouches geospatiallyTouches) {
	...
	public AUTOMOTIVE_BUSINESS(GeospatiallyWithin geospatiallyWithin) {
	...
	public AUTOMOTIVE_BUSINESS(GlobalLocationNumber globalLocationNumber) {
	...
	public AUTOMOTIVE_BUSINESS(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public AUTOMOTIVE_BUSINESS(HasOfferCatalog hasOfferCatalog) {
	...
	public AUTOMOTIVE_BUSINESS(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public AUTOMOTIVE_BUSINESS(Identifier identifier) {
	...
	public AUTOMOTIVE_BUSINESS(Image image) {
		setImage(image);
	}
	...
	public AUTOMOTIVE_BUSINESS(IsAccessibleForFree isAccessibleForFree) {
	...
	public AUTOMOTIVE_BUSINESS(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public AUTOMOTIVE_BUSINESS(KnowsAbout knowsAbout) {
	...
	public AUTOMOTIVE_BUSINESS(KnowsLanguage knowsLanguage) {
	...
	public AUTOMOTIVE_BUSINESS(LegalName legalName) {
	...
	public AUTOMOTIVE_BUSINESS(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public AUTOMOTIVE_BUSINESS(Location location) {
	...
	public AUTOMOTIVE_BUSINESS(Logo logo) {
		setLogo(logo);
	}
	...
	public AUTOMOTIVE_BUSINESS(MainEntityOfPage mainEntityOfPage) {
	...
	public AUTOMOTIVE_BUSINESS(MakesOffer makesOffer) {
	...
	public AUTOMOTIVE_BUSINESS(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public AUTOMOTIVE_BUSINESS(Member member) {
		setMember(member);
	}
	...
	public AUTOMOTIVE_BUSINESS(MemberOf memberOf) {
	...
	public AUTOMOTIVE_BUSINESS(Naics naics) {
		setNaics(naics);
	}
	...
	public AUTOMOTIVE_BUSINESS(Name name) {
		setName(name);
	}
	...
	public AUTOMOTIVE_BUSINESS(NameFuzzy nameFuzzy) {
	...
	public AUTOMOTIVE_BUSINESS(NameRuby nameRuby) {
	...
	public AUTOMOTIVE_BUSINESS(NumberOfEmployees numberOfEmployees) {
	...
	public AUTOMOTIVE_BUSINESS(OpeningHours openingHours) {
	...
	public AUTOMOTIVE_BUSINESS(OpeningHoursSpecification openingHoursSpecification) {
	...
	public AUTOMOTIVE_BUSINESS(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public AUTOMOTIVE_BUSINESS(Owns owns) {
		setOwns(owns);
	}
	...
	public AUTOMOTIVE_BUSINESS(ParentOrganization parentOrganization) {
	...
	public AUTOMOTIVE_BUSINESS(PaymentAccepted paymentAccepted) {
	...
	public AUTOMOTIVE_BUSINESS(Photo photo) {
		setPhoto(photo);
	}
	...
	public AUTOMOTIVE_BUSINESS(PotentialAction potentialAction) {
	...
	public AUTOMOTIVE_BUSINESS(PriceRange priceRange) {
	...
	public AUTOMOTIVE_BUSINESS(PublicAccess publicAccess) {
	...
	public AUTOMOTIVE_BUSINESS(PublishingPrinciples publishingPrinciples) {
	...
	public AUTOMOTIVE_BUSINESS(Review review) {
		setReview(review);
	}
	...
	public AUTOMOTIVE_BUSINESS(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public AUTOMOTIVE_BUSINESS(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public AUTOMOTIVE_BUSINESS(SmokingAllowed smokingAllowed) {
	...
	public AUTOMOTIVE_BUSINESS(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public AUTOMOTIVE_BUSINESS(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public AUTOMOTIVE_BUSINESS(SubOrganization subOrganization) {
	...
	public AUTOMOTIVE_BUSINESS(SubjectOf subjectOf) {
	...
	public AUTOMOTIVE_BUSINESS(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public AUTOMOTIVE_BUSINESS(Telephone telephone) {
	...
	public AUTOMOTIVE_BUSINESS(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public AUTOMOTIVE_BUSINESS(Url url) {
		setUrl(url);
	}
	...
	public AUTOMOTIVE_BUSINESS(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.AutomotiveBusiness org) {
		setSeq(org.getSeq());
