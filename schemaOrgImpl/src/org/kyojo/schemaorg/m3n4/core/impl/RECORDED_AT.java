...
public class RECORDED_AT implements Container.RecordedAt {
	...
	public RECORDED_AT(BroadcastEvent broadcastEvent) {
	...
	public RECORDED_AT(BusinessEvent businessEvent) {
	...
	public RECORDED_AT(ChildrensEvent childrensEvent) {
	...
	public RECORDED_AT(ComedyEvent comedyEvent) {
	...
	public RECORDED_AT(CourseInstance courseInstance) {
	...
	public RECORDED_AT(DanceEvent danceEvent) {
	...
	public RECORDED_AT(DeliveryEvent deliveryEvent) {
	...
	public RECORDED_AT(EducationEvent educationEvent) {
	...
	public RECORDED_AT(EventSeries eventSeries) {
	...
	public RECORDED_AT(ExhibitionEvent exhibitionEvent) {
	...
	public RECORDED_AT(Festival festival) {
	...
	public RECORDED_AT(FoodEvent foodEvent) {
	...
	public RECORDED_AT(LiteraryEvent literaryEvent) {
	...
	public RECORDED_AT(MusicEvent musicEvent) {
	...
	public RECORDED_AT(OnDemandEvent onDemandEvent) {
	...
	public RECORDED_AT(PublicationEvent publicationEvent) {
	...
	public RECORDED_AT(SaleEvent saleEvent) {
	...
	public RECORDED_AT(ScreeningEvent screeningEvent) {
	...
	public RECORDED_AT(SocialEvent socialEvent) {
	...
	public RECORDED_AT(SportsEvent sportsEvent) {
	...
	public RECORDED_AT(TheaterEvent theaterEvent) {
	...
	public RECORDED_AT(VisualArtsEvent visualArtsEvent) {
	...
	public void copy(Container.RecordedAt org) {
