...
public class AUTO_DEALER implements Clazz.AutoDealer {
	...
	public AUTO_DEALER(Long seq) {
		setSeq(seq);
	}

	public AUTO_DEALER(String string) {
	...
	public AUTO_DEALER(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public AUTO_DEALER(AdditionalProperty additionalProperty) {
	...
	public AUTO_DEALER(AdditionalType additionalType) {
	...
	public AUTO_DEALER(Address address) {
		setAddress(address);
	}
	...
	public AUTO_DEALER(AggregateRating aggregateRating) {
	...
	public AUTO_DEALER(AlternateName alternateName) {
	...
	public AUTO_DEALER(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public AUTO_DEALER(AmenityFeature amenityFeature) {
	...
	public AUTO_DEALER(AreaServed areaServed) {
	...
	public AUTO_DEALER(Award award) {
		setAward(award);
	}
	...
	public AUTO_DEALER(BranchCode branchCode) {
	...
	public AUTO_DEALER(Brand brand) {
		setBrand(brand);
	}
	...
	public AUTO_DEALER(ContactPoint contactPoint) {
	...
	public AUTO_DEALER(ContainedInPlace containedInPlace) {
	...
	public AUTO_DEALER(ContainsPlace containsPlace) {
	...
	public AUTO_DEALER(CorrectionsPolicy correctionsPolicy) {
	...
	public AUTO_DEALER(CurrenciesAccepted currenciesAccepted) {
	...
	public AUTO_DEALER(Department department) {
	...
	public AUTO_DEALER(Description description) {
	...
	public AUTO_DEALER(DisambiguatingDescription disambiguatingDescription) {
	...
	public AUTO_DEALER(DissolutionDate dissolutionDate) {
	...
	public AUTO_DEALER(DiversityPolicy diversityPolicy) {
	...
	public AUTO_DEALER(DiversityStaffingReport diversityStaffingReport) {
	...
	public AUTO_DEALER(Email email) {
		setEmail(email);
	}
	...
	public AUTO_DEALER(Employee employee) {
	...
	public AUTO_DEALER(EthicsPolicy ethicsPolicy) {
	...
	public AUTO_DEALER(Event event) {
		setEvent(event);
	}
	...
	public AUTO_DEALER(FaxNumber faxNumber) {
	...
	public AUTO_DEALER(Founder founder) {
		setFounder(founder);
	}
	...
	public AUTO_DEALER(FoundingDate foundingDate) {
	...
	public AUTO_DEALER(FoundingLocation foundingLocation) {
	...
	public AUTO_DEALER(Funder funder) {
		setFunder(funder);
	}
	...
	public AUTO_DEALER(GeospatiallyContains geospatiallyContains) {
	...
	public AUTO_DEALER(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public AUTO_DEALER(GeospatiallyCovers geospatiallyCovers) {
	...
	public AUTO_DEALER(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public AUTO_DEALER(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public AUTO_DEALER(GeospatiallyEquals geospatiallyEquals) {
	...
	public AUTO_DEALER(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public AUTO_DEALER(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public AUTO_DEALER(GeospatiallyTouches geospatiallyTouches) {
	...
	public AUTO_DEALER(GeospatiallyWithin geospatiallyWithin) {
	...
	public AUTO_DEALER(GlobalLocationNumber globalLocationNumber) {
	...
	public AUTO_DEALER(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public AUTO_DEALER(HasOfferCatalog hasOfferCatalog) {
	...
	public AUTO_DEALER(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public AUTO_DEALER(Identifier identifier) {
	...
	public AUTO_DEALER(Image image) {
		setImage(image);
	}
	...
	public AUTO_DEALER(IsAccessibleForFree isAccessibleForFree) {
	...
	public AUTO_DEALER(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public AUTO_DEALER(KnowsAbout knowsAbout) {
	...
	public AUTO_DEALER(KnowsLanguage knowsLanguage) {
	...
	public AUTO_DEALER(LegalName legalName) {
	...
	public AUTO_DEALER(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public AUTO_DEALER(Location location) {
	...
	public AUTO_DEALER(MainEntityOfPage mainEntityOfPage) {
	...
	public AUTO_DEALER(MakesOffer makesOffer) {
	...
	public AUTO_DEALER(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public AUTO_DEALER(Member member) {
		setMember(member);
	}
	...
	public AUTO_DEALER(MemberOf memberOf) {
	...
	public AUTO_DEALER(Naics naics) {
		setNaics(naics);
	}
	...
	public AUTO_DEALER(NameFuzzy nameFuzzy) {
	...
	public AUTO_DEALER(NameRuby nameRuby) {
	...
	public AUTO_DEALER(NumberOfEmployees numberOfEmployees) {
	...
	public AUTO_DEALER(OpeningHours openingHours) {
	...
	public AUTO_DEALER(OpeningHoursSpecification openingHoursSpecification) {
	...
	public AUTO_DEALER(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public AUTO_DEALER(ParentOrganization parentOrganization) {
	...
	public AUTO_DEALER(PaymentAccepted paymentAccepted) {
	...
	public AUTO_DEALER(Photo photo) {
		setPhoto(photo);
	}
	...
	public AUTO_DEALER(PotentialAction potentialAction) {
	...
	public AUTO_DEALER(PriceRange priceRange) {
	...
	public AUTO_DEALER(PublicAccess publicAccess) {
	...
	public AUTO_DEALER(PublishingPrinciples publishingPrinciples) {
	...
	public AUTO_DEALER(Review review) {
		setReview(review);
	}
	...
	public AUTO_DEALER(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public AUTO_DEALER(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public AUTO_DEALER(SmokingAllowed smokingAllowed) {
	...
	public AUTO_DEALER(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public AUTO_DEALER(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public AUTO_DEALER(SubOrganization subOrganization) {
	...
	public AUTO_DEALER(SubjectOf subjectOf) {
	...
	public AUTO_DEALER(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public AUTO_DEALER(Telephone telephone) {
	...
	public AUTO_DEALER(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public AUTO_DEALER(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.AutoDealer org) {
		setSeq(org.getSeq());
