...
public class STADIUM_OR_ARENA implements Clazz.StadiumOrArena {
	...
	public STADIUM_OR_ARENA() {
	}

	public STADIUM_OR_ARENA(Long seq) {
		setSeq(seq);
	}

	public STADIUM_OR_ARENA(String string) {
	...
	public STADIUM_OR_ARENA(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public STADIUM_OR_ARENA(AdditionalProperty additionalProperty) {
	...
	public STADIUM_OR_ARENA(AdditionalType additionalType) {
	...
	public STADIUM_OR_ARENA(Address address) {
		setAddress(address);
	}
	...
	public STADIUM_OR_ARENA(AggregateRating aggregateRating) {
	...
	public STADIUM_OR_ARENA(AlternateName alternateName) {
	...
	public STADIUM_OR_ARENA(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public STADIUM_OR_ARENA(AmenityFeature amenityFeature) {
	...
	public STADIUM_OR_ARENA(AreaServed areaServed) {
	...
	public STADIUM_OR_ARENA(Award award) {
		setAward(award);
	}
	...
	public STADIUM_OR_ARENA(BranchCode branchCode) {
	...
	public STADIUM_OR_ARENA(Brand brand) {
		setBrand(brand);
	}
	...
	public STADIUM_OR_ARENA(ContactPoint contactPoint) {
	...
	public STADIUM_OR_ARENA(ContainedInPlace containedInPlace) {
	...
	public STADIUM_OR_ARENA(ContainsPlace containsPlace) {
	...
	public STADIUM_OR_ARENA(CorrectionsPolicy correctionsPolicy) {
	...
	public STADIUM_OR_ARENA(CurrenciesAccepted currenciesAccepted) {
	...
	public STADIUM_OR_ARENA(Department department) {
	...
	public STADIUM_OR_ARENA(Description description) {
	...
	public STADIUM_OR_ARENA(DisambiguatingDescription disambiguatingDescription) {
	...
	public STADIUM_OR_ARENA(DissolutionDate dissolutionDate) {
	...
	public STADIUM_OR_ARENA(DiversityPolicy diversityPolicy) {
	...
	public STADIUM_OR_ARENA(DiversityStaffingReport diversityStaffingReport) {
	...
	public STADIUM_OR_ARENA(Duns duns) {
		setDuns(duns);
	}
	...
	public STADIUM_OR_ARENA(Email email) {
		setEmail(email);
	}
	...
	public STADIUM_OR_ARENA(Employee employee) {
	...
	public STADIUM_OR_ARENA(EthicsPolicy ethicsPolicy) {
	...
	public STADIUM_OR_ARENA(Event event) {
		setEvent(event);
	}
	...
	public STADIUM_OR_ARENA(FaxNumber faxNumber) {
	...
	public STADIUM_OR_ARENA(Founder founder) {
		setFounder(founder);
	}
	...
	public STADIUM_OR_ARENA(FoundingDate foundingDate) {
	...
	public STADIUM_OR_ARENA(FoundingLocation foundingLocation) {
	...
	public STADIUM_OR_ARENA(Funder funder) {
		setFunder(funder);
	}
	...
	public STADIUM_OR_ARENA(Geo geo) {
		setGeo(geo);
	}
	...
	public STADIUM_OR_ARENA(GeospatiallyContains geospatiallyContains) {
	...
	public STADIUM_OR_ARENA(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public STADIUM_OR_ARENA(GeospatiallyCovers geospatiallyCovers) {
	...
	public STADIUM_OR_ARENA(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public STADIUM_OR_ARENA(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public STADIUM_OR_ARENA(GeospatiallyEquals geospatiallyEquals) {
	...
	public STADIUM_OR_ARENA(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public STADIUM_OR_ARENA(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public STADIUM_OR_ARENA(GeospatiallyTouches geospatiallyTouches) {
	...
	public STADIUM_OR_ARENA(GeospatiallyWithin geospatiallyWithin) {
	...
	public STADIUM_OR_ARENA(GlobalLocationNumber globalLocationNumber) {
	...
	public STADIUM_OR_ARENA(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public STADIUM_OR_ARENA(HasOfferCatalog hasOfferCatalog) {
	...
	public STADIUM_OR_ARENA(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public STADIUM_OR_ARENA(Identifier identifier) {
	...
	public STADIUM_OR_ARENA(Image image) {
		setImage(image);
	}
	...
	public STADIUM_OR_ARENA(IsAccessibleForFree isAccessibleForFree) {
	...
	public STADIUM_OR_ARENA(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public STADIUM_OR_ARENA(KnowsAbout knowsAbout) {
	...
	public STADIUM_OR_ARENA(KnowsLanguage knowsLanguage) {
	...
	public STADIUM_OR_ARENA(LegalName legalName) {
	...
	public STADIUM_OR_ARENA(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public STADIUM_OR_ARENA(Location location) {
	...
	public STADIUM_OR_ARENA(Logo logo) {
		setLogo(logo);
	}
	...
	public STADIUM_OR_ARENA(MainEntityOfPage mainEntityOfPage) {
	...
	public STADIUM_OR_ARENA(MakesOffer makesOffer) {
	...
	public STADIUM_OR_ARENA(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public STADIUM_OR_ARENA(Member member) {
		setMember(member);
	}
	...
	public STADIUM_OR_ARENA(MemberOf memberOf) {
	...
	public STADIUM_OR_ARENA(Naics naics) {
		setNaics(naics);
	}
	...
	public STADIUM_OR_ARENA(Name name) {
		setName(name);
	}
	...
	public STADIUM_OR_ARENA(NameFuzzy nameFuzzy) {
	...
	public STADIUM_OR_ARENA(NameRuby nameRuby) {
	...
	public STADIUM_OR_ARENA(NumberOfEmployees numberOfEmployees) {
	...
	public STADIUM_OR_ARENA(OpeningHours openingHours) {
	...
	public STADIUM_OR_ARENA(OpeningHoursSpecification openingHoursSpecification) {
	...
	public STADIUM_OR_ARENA(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public STADIUM_OR_ARENA(Owns owns) {
		setOwns(owns);
	}
	...
	public STADIUM_OR_ARENA(ParentOrganization parentOrganization) {
	...
	public STADIUM_OR_ARENA(PaymentAccepted paymentAccepted) {
	...
	public STADIUM_OR_ARENA(Photo photo) {
		setPhoto(photo);
	}
	...
	public STADIUM_OR_ARENA(PotentialAction potentialAction) {
	...
	public STADIUM_OR_ARENA(PriceRange priceRange) {
	...
	public STADIUM_OR_ARENA(PublicAccess publicAccess) {
	...
	public STADIUM_OR_ARENA(PublishingPrinciples publishingPrinciples) {
	...
	public STADIUM_OR_ARENA(Review review) {
		setReview(review);
	}
	...
	public STADIUM_OR_ARENA(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public STADIUM_OR_ARENA(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public STADIUM_OR_ARENA(SmokingAllowed smokingAllowed) {
	...
	public STADIUM_OR_ARENA(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public STADIUM_OR_ARENA(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public STADIUM_OR_ARENA(SubOrganization subOrganization) {
	...
	public STADIUM_OR_ARENA(SubjectOf subjectOf) {
	...
	public STADIUM_OR_ARENA(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public STADIUM_OR_ARENA(Telephone telephone) {
	...
	public STADIUM_OR_ARENA(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public STADIUM_OR_ARENA(Url url) {
		setUrl(url);
	}
	...
	public STADIUM_OR_ARENA(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.StadiumOrArena org) {
		setSeq(org.getSeq());
