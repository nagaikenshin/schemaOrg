...
public class ART_GALLERY implements Clazz.ArtGallery {
	...
	public ART_GALLERY(Long seq) {
		setSeq(seq);
	}

	public ART_GALLERY(String string) {
	...
	public ART_GALLERY(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public ART_GALLERY(AdditionalProperty additionalProperty) {
	...
	public ART_GALLERY(AdditionalType additionalType) {
	...
	public ART_GALLERY(Address address) {
		setAddress(address);
	}
	...
	public ART_GALLERY(AggregateRating aggregateRating) {
	...
	public ART_GALLERY(AlternateName alternateName) {
	...
	public ART_GALLERY(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public ART_GALLERY(AmenityFeature amenityFeature) {
	...
	public ART_GALLERY(AreaServed areaServed) {
	...
	public ART_GALLERY(Award award) {
		setAward(award);
	}
	...
	public ART_GALLERY(BranchCode branchCode) {
	...
	public ART_GALLERY(Brand brand) {
		setBrand(brand);
	}
	...
	public ART_GALLERY(ContactPoint contactPoint) {
	...
	public ART_GALLERY(ContainedInPlace containedInPlace) {
	...
	public ART_GALLERY(ContainsPlace containsPlace) {
	...
	public ART_GALLERY(CorrectionsPolicy correctionsPolicy) {
	...
	public ART_GALLERY(CurrenciesAccepted currenciesAccepted) {
	...
	public ART_GALLERY(Department department) {
	...
	public ART_GALLERY(Description description) {
	...
	public ART_GALLERY(DisambiguatingDescription disambiguatingDescription) {
	...
	public ART_GALLERY(DissolutionDate dissolutionDate) {
	...
	public ART_GALLERY(DiversityPolicy diversityPolicy) {
	...
	public ART_GALLERY(DiversityStaffingReport diversityStaffingReport) {
	...
	public ART_GALLERY(Email email) {
		setEmail(email);
	}
	...
	public ART_GALLERY(Employee employee) {
	...
	public ART_GALLERY(EthicsPolicy ethicsPolicy) {
	...
	public ART_GALLERY(Event event) {
		setEvent(event);
	}
	...
	public ART_GALLERY(FaxNumber faxNumber) {
	...
	public ART_GALLERY(Founder founder) {
		setFounder(founder);
	}
	...
	public ART_GALLERY(FoundingDate foundingDate) {
	...
	public ART_GALLERY(FoundingLocation foundingLocation) {
	...
	public ART_GALLERY(Funder funder) {
		setFunder(funder);
	}
	...
	public ART_GALLERY(GeospatiallyContains geospatiallyContains) {
	...
	public ART_GALLERY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public ART_GALLERY(GeospatiallyCovers geospatiallyCovers) {
	...
	public ART_GALLERY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public ART_GALLERY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public ART_GALLERY(GeospatiallyEquals geospatiallyEquals) {
	...
	public ART_GALLERY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public ART_GALLERY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public ART_GALLERY(GeospatiallyTouches geospatiallyTouches) {
	...
	public ART_GALLERY(GeospatiallyWithin geospatiallyWithin) {
	...
	public ART_GALLERY(GlobalLocationNumber globalLocationNumber) {
	...
	public ART_GALLERY(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public ART_GALLERY(HasOfferCatalog hasOfferCatalog) {
	...
	public ART_GALLERY(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public ART_GALLERY(Identifier identifier) {
	...
	public ART_GALLERY(Image image) {
		setImage(image);
	}
	...
	public ART_GALLERY(IsAccessibleForFree isAccessibleForFree) {
	...
	public ART_GALLERY(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public ART_GALLERY(KnowsAbout knowsAbout) {
	...
	public ART_GALLERY(KnowsLanguage knowsLanguage) {
	...
	public ART_GALLERY(LegalName legalName) {
	...
	public ART_GALLERY(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public ART_GALLERY(Location location) {
	...
	public ART_GALLERY(MainEntityOfPage mainEntityOfPage) {
	...
	public ART_GALLERY(MakesOffer makesOffer) {
	...
	public ART_GALLERY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public ART_GALLERY(Member member) {
		setMember(member);
	}
	...
	public ART_GALLERY(MemberOf memberOf) {
	...
	public ART_GALLERY(Naics naics) {
		setNaics(naics);
	}
	...
	public ART_GALLERY(NameFuzzy nameFuzzy) {
	...
	public ART_GALLERY(NameRuby nameRuby) {
	...
	public ART_GALLERY(NumberOfEmployees numberOfEmployees) {
	...
	public ART_GALLERY(OpeningHours openingHours) {
	...
	public ART_GALLERY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public ART_GALLERY(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public ART_GALLERY(ParentOrganization parentOrganization) {
	...
	public ART_GALLERY(PaymentAccepted paymentAccepted) {
	...
	public ART_GALLERY(Photo photo) {
		setPhoto(photo);
	}
	...
	public ART_GALLERY(PotentialAction potentialAction) {
	...
	public ART_GALLERY(PriceRange priceRange) {
	...
	public ART_GALLERY(PublicAccess publicAccess) {
	...
	public ART_GALLERY(PublishingPrinciples publishingPrinciples) {
	...
	public ART_GALLERY(Review review) {
		setReview(review);
	}
	...
	public ART_GALLERY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ART_GALLERY(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public ART_GALLERY(SmokingAllowed smokingAllowed) {
	...
	public ART_GALLERY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public ART_GALLERY(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public ART_GALLERY(SubOrganization subOrganization) {
	...
	public ART_GALLERY(SubjectOf subjectOf) {
	...
	public ART_GALLERY(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public ART_GALLERY(Telephone telephone) {
	...
	public ART_GALLERY(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public ART_GALLERY(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.ArtGallery org) {
		setSeq(org.getSeq());
