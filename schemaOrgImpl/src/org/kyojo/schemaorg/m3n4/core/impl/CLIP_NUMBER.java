...
public class CLIP_NUMBER implements Container.ClipNumber {
	...
	public CLIP_NUMBER(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public CLIP_NUMBER(Integer integer) {
	...
	public CLIP_NUMBER(String string) {
		this(new TEXT(string));
	}

	public CLIP_NUMBER(Text text) {
	...
	public CLIP_NUMBER(List<Integer> integerList,
			List<Text> textList) {
		setIntegerList(integerList);
		setTextList(textList);
	}

	public void copy(Container.ClipNumber org) {
