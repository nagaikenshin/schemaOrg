...
public class HEIGHT implements Container.Height {
	...
	public HEIGHT(Distance distance) {
		distanceList = new ArrayList<Distance>();
	...
	public HEIGHT(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public HEIGHT(QuantitativeValue quantitativeValue) {
	...
	public HEIGHT(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public HEIGHT(List<Distance> distanceList,
	...
	public void copy(Container.Height org) {
