...
public class CARGO_VOLUME implements Container.CargoVolume {
	...
	public CARGO_VOLUME(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public CARGO_VOLUME(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public CARGO_VOLUME(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.CargoVolume org) {
