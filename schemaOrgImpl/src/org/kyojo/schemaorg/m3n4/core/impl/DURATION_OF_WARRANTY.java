...
public class DURATION_OF_WARRANTY implements Container.DurationOfWarranty {
	...
	public DURATION_OF_WARRANTY(String string) {
	...
	public DURATION_OF_WARRANTY(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public DURATION_OF_WARRANTY(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public DURATION_OF_WARRANTY(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public DURATION_OF_WARRANTY(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.DurationOfWarranty org) {
