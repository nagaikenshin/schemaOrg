...
public class ANNUAL_PERCENTAGE_RATE implements Container.AnnualPercentageRate {
	...
	public ANNUAL_PERCENTAGE_RATE(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public ANNUAL_PERCENTAGE_RATE(Float fl0at) {
	...
	public ANNUAL_PERCENTAGE_RATE(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public ANNUAL_PERCENTAGE_RATE(Integer integer) {
	...
	public ANNUAL_PERCENTAGE_RATE(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public ANNUAL_PERCENTAGE_RATE(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public ANNUAL_PERCENTAGE_RATE(List<Float> fl0atList,
