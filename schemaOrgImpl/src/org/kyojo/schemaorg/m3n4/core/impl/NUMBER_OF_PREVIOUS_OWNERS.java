...
public class NUMBER_OF_PREVIOUS_OWNERS implements Container.NumberOfPreviousOwners {
	...
	public NUMBER_OF_PREVIOUS_OWNERS(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public NUMBER_OF_PREVIOUS_OWNERS(Float fl0at) {
	...
	public NUMBER_OF_PREVIOUS_OWNERS(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public NUMBER_OF_PREVIOUS_OWNERS(Integer integer) {
	...
	public NUMBER_OF_PREVIOUS_OWNERS(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public NUMBER_OF_PREVIOUS_OWNERS(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public NUMBER_OF_PREVIOUS_OWNERS(List<Float> fl0atList,
