...
public class WINERY implements Clazz.Winery {
	...
	public WINERY(Long seq) {
		setSeq(seq);
	}

	public WINERY(String string) {
	...
	public WINERY(AcceptsReservations acceptsReservations) {
	...
	public WINERY(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public WINERY(AdditionalProperty additionalProperty) {
	...
	public WINERY(AdditionalType additionalType) {
	...
	public WINERY(AggregateRating aggregateRating) {
	...
	public WINERY(AlternateName alternateName) {
	...
	public WINERY(AmenityFeature amenityFeature) {
	...
	public WINERY(AreaServed areaServed) {
	...
	public WINERY(BranchCode branchCode) {
	...
	public WINERY(ContactPoint contactPoint) {
	...
	public WINERY(ContainedInPlace containedInPlace) {
	...
	public WINERY(ContainsPlace containsPlace) {
	...
	public WINERY(CorrectionsPolicy correctionsPolicy) {
	...
	public WINERY(CurrenciesAccepted currenciesAccepted) {
	...
	public WINERY(Department department) {
	...
	public WINERY(Description description) {
	...
	public WINERY(DisambiguatingDescription disambiguatingDescription) {
	...
	public WINERY(DissolutionDate dissolutionDate) {
	...
	public WINERY(DiversityPolicy diversityPolicy) {
	...
	public WINERY(DiversityStaffingReport diversityStaffingReport) {
	...
	public WINERY(Employee employee) {
	...
	public WINERY(EthicsPolicy ethicsPolicy) {
	...
	public WINERY(FaxNumber faxNumber) {
	...
	public WINERY(FoundingDate foundingDate) {
	...
	public WINERY(FoundingLocation foundingLocation) {
	...
	public WINERY(GeospatiallyContains geospatiallyContains) {
	...
	public WINERY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public WINERY(GeospatiallyCovers geospatiallyCovers) {
	...
	public WINERY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public WINERY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public WINERY(GeospatiallyEquals geospatiallyEquals) {
	...
	public WINERY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public WINERY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public WINERY(GeospatiallyTouches geospatiallyTouches) {
	...
	public WINERY(GeospatiallyWithin geospatiallyWithin) {
	...
	public WINERY(GlobalLocationNumber globalLocationNumber) {
	...
	public WINERY(HasOfferCatalog hasOfferCatalog) {
	...
	public WINERY(Identifier identifier) {
	...
	public WINERY(IsAccessibleForFree isAccessibleForFree) {
	...
	public WINERY(KnowsAbout knowsAbout) {
	...
	public WINERY(KnowsLanguage knowsLanguage) {
	...
	public WINERY(LegalName legalName) {
	...
	public WINERY(Location location) {
	...
	public WINERY(MainEntityOfPage mainEntityOfPage) {
	...
	public WINERY(MakesOffer makesOffer) {
	...
	public WINERY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public WINERY(MemberOf memberOf) {
	...
	public WINERY(NameFuzzy nameFuzzy) {
	...
	public WINERY(NameRuby nameRuby) {
	...
	public WINERY(NumberOfEmployees numberOfEmployees) {
	...
	public WINERY(OpeningHours openingHours) {
	...
	public WINERY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public WINERY(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public WINERY(ParentOrganization parentOrganization) {
	...
	public WINERY(PaymentAccepted paymentAccepted) {
	...
	public WINERY(PotentialAction potentialAction) {
	...
	public WINERY(PriceRange priceRange) {
	...
	public WINERY(PublicAccess publicAccess) {
	...
	public WINERY(PublishingPrinciples publishingPrinciples) {
	...
	public WINERY(ServesCuisine servesCuisine) {
	...
	public WINERY(SmokingAllowed smokingAllowed) {
	...
	public WINERY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public WINERY(StarRating starRating) {
	...
	public WINERY(SubOrganization subOrganization) {
	...
	public WINERY(SubjectOf subjectOf) {
	...
	public WINERY(Telephone telephone) {
	...
	public WINERY(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Winery org) {
		setSeq(org.getSeq());
