...
public class HARDWARE_STORE implements Clazz.HardwareStore {
	...
	public HARDWARE_STORE() {
	}

	public HARDWARE_STORE(Long seq) {
		setSeq(seq);
	}

	public HARDWARE_STORE(String string) {
	...
	public HARDWARE_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public HARDWARE_STORE(AdditionalProperty additionalProperty) {
	...
	public HARDWARE_STORE(AdditionalType additionalType) {
	...
	public HARDWARE_STORE(Address address) {
		setAddress(address);
	}
	...
	public HARDWARE_STORE(AggregateRating aggregateRating) {
	...
	public HARDWARE_STORE(AlternateName alternateName) {
	...
	public HARDWARE_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public HARDWARE_STORE(AmenityFeature amenityFeature) {
	...
	public HARDWARE_STORE(AreaServed areaServed) {
	...
	public HARDWARE_STORE(Award award) {
		setAward(award);
	}
	...
	public HARDWARE_STORE(BranchCode branchCode) {
	...
	public HARDWARE_STORE(Brand brand) {
		setBrand(brand);
	}
	...
	public HARDWARE_STORE(ContactPoint contactPoint) {
	...
	public HARDWARE_STORE(ContainedInPlace containedInPlace) {
	...
	public HARDWARE_STORE(ContainsPlace containsPlace) {
	...
	public HARDWARE_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public HARDWARE_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public HARDWARE_STORE(Department department) {
	...
	public HARDWARE_STORE(Description description) {
	...
	public HARDWARE_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public HARDWARE_STORE(DissolutionDate dissolutionDate) {
	...
	public HARDWARE_STORE(DiversityPolicy diversityPolicy) {
	...
	public HARDWARE_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public HARDWARE_STORE(Duns duns) {
		setDuns(duns);
	}
	...
	public HARDWARE_STORE(Email email) {
		setEmail(email);
	}
	...
	public HARDWARE_STORE(Employee employee) {
	...
	public HARDWARE_STORE(EthicsPolicy ethicsPolicy) {
	...
	public HARDWARE_STORE(Event event) {
		setEvent(event);
	}
	...
	public HARDWARE_STORE(FaxNumber faxNumber) {
	...
	public HARDWARE_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public HARDWARE_STORE(FoundingDate foundingDate) {
	...
	public HARDWARE_STORE(FoundingLocation foundingLocation) {
	...
	public HARDWARE_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public HARDWARE_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public HARDWARE_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public HARDWARE_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public HARDWARE_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public HARDWARE_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public HARDWARE_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public HARDWARE_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public HARDWARE_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public HARDWARE_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public HARDWARE_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public HARDWARE_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public HARDWARE_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public HARDWARE_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public HARDWARE_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public HARDWARE_STORE(Identifier identifier) {
	...
	public HARDWARE_STORE(Image image) {
		setImage(image);
	}
	...
	public HARDWARE_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public HARDWARE_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public HARDWARE_STORE(KnowsAbout knowsAbout) {
	...
	public HARDWARE_STORE(KnowsLanguage knowsLanguage) {
	...
	public HARDWARE_STORE(LegalName legalName) {
	...
	public HARDWARE_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public HARDWARE_STORE(Location location) {
	...
	public HARDWARE_STORE(Logo logo) {
		setLogo(logo);
	}
	...
	public HARDWARE_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public HARDWARE_STORE(MakesOffer makesOffer) {
	...
	public HARDWARE_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public HARDWARE_STORE(Member member) {
		setMember(member);
	}
	...
	public HARDWARE_STORE(MemberOf memberOf) {
	...
	public HARDWARE_STORE(Naics naics) {
		setNaics(naics);
	}
	...
	public HARDWARE_STORE(Name name) {
		setName(name);
	}
	...
	public HARDWARE_STORE(NameFuzzy nameFuzzy) {
	...
	public HARDWARE_STORE(NameRuby nameRuby) {
	...
	public HARDWARE_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public HARDWARE_STORE(OpeningHours openingHours) {
	...
	public HARDWARE_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public HARDWARE_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public HARDWARE_STORE(Owns owns) {
		setOwns(owns);
	}
	...
	public HARDWARE_STORE(ParentOrganization parentOrganization) {
	...
	public HARDWARE_STORE(PaymentAccepted paymentAccepted) {
	...
	public HARDWARE_STORE(Photo photo) {
		setPhoto(photo);
	}
	...
	public HARDWARE_STORE(PotentialAction potentialAction) {
	...
	public HARDWARE_STORE(PriceRange priceRange) {
	...
	public HARDWARE_STORE(PublicAccess publicAccess) {
	...
	public HARDWARE_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public HARDWARE_STORE(Review review) {
		setReview(review);
	}
	...
	public HARDWARE_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public HARDWARE_STORE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public HARDWARE_STORE(SmokingAllowed smokingAllowed) {
	...
	public HARDWARE_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public HARDWARE_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public HARDWARE_STORE(SubOrganization subOrganization) {
	...
	public HARDWARE_STORE(SubjectOf subjectOf) {
	...
	public HARDWARE_STORE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public HARDWARE_STORE(Telephone telephone) {
	...
	public HARDWARE_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public HARDWARE_STORE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.HardwareStore org) {
		setSeq(org.getSeq());
