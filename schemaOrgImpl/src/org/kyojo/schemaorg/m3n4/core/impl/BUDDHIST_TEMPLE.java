...
public class BUDDHIST_TEMPLE implements Clazz.BuddhistTemple {
	...
	public BUDDHIST_TEMPLE() {
	}

	public BUDDHIST_TEMPLE(Long seq) {
		setSeq(seq);
	}

	public BUDDHIST_TEMPLE(String string) {
	...
	public BUDDHIST_TEMPLE(AdditionalProperty additionalProperty) {
	...
	public BUDDHIST_TEMPLE(AdditionalType additionalType) {
	...
	public BUDDHIST_TEMPLE(Address address) {
		setAddress(address);
	}
	...
	public BUDDHIST_TEMPLE(AggregateRating aggregateRating) {
	...
	public BUDDHIST_TEMPLE(AlternateName alternateName) {
	...
	public BUDDHIST_TEMPLE(AmenityFeature amenityFeature) {
	...
	public BUDDHIST_TEMPLE(BranchCode branchCode) {
	...
	public BUDDHIST_TEMPLE(ContainedInPlace containedInPlace) {
	...
	public BUDDHIST_TEMPLE(ContainsPlace containsPlace) {
	...
	public BUDDHIST_TEMPLE(Description description) {
	...
	public BUDDHIST_TEMPLE(DisambiguatingDescription disambiguatingDescription) {
	...
	public BUDDHIST_TEMPLE(Event event) {
		setEvent(event);
	}
	...
	public BUDDHIST_TEMPLE(FaxNumber faxNumber) {
	...
	public BUDDHIST_TEMPLE(Geo geo) {
		setGeo(geo);
	}
	...
	public BUDDHIST_TEMPLE(GeospatiallyContains geospatiallyContains) {
	...
	public BUDDHIST_TEMPLE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public BUDDHIST_TEMPLE(GeospatiallyCovers geospatiallyCovers) {
	...
	public BUDDHIST_TEMPLE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public BUDDHIST_TEMPLE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public BUDDHIST_TEMPLE(GeospatiallyEquals geospatiallyEquals) {
	...
	public BUDDHIST_TEMPLE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public BUDDHIST_TEMPLE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public BUDDHIST_TEMPLE(GeospatiallyTouches geospatiallyTouches) {
	...
	public BUDDHIST_TEMPLE(GeospatiallyWithin geospatiallyWithin) {
	...
	public BUDDHIST_TEMPLE(GlobalLocationNumber globalLocationNumber) {
	...
	public BUDDHIST_TEMPLE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public BUDDHIST_TEMPLE(Identifier identifier) {
	...
	public BUDDHIST_TEMPLE(Image image) {
		setImage(image);
	}
	...
	public BUDDHIST_TEMPLE(IsAccessibleForFree isAccessibleForFree) {
	...
	public BUDDHIST_TEMPLE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public BUDDHIST_TEMPLE(Logo logo) {
		setLogo(logo);
	}
	...
	public BUDDHIST_TEMPLE(MainEntityOfPage mainEntityOfPage) {
	...
	public BUDDHIST_TEMPLE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public BUDDHIST_TEMPLE(Name name) {
		setName(name);
	}
	...
	public BUDDHIST_TEMPLE(NameFuzzy nameFuzzy) {
	...
	public BUDDHIST_TEMPLE(NameRuby nameRuby) {
	...
	public BUDDHIST_TEMPLE(OpeningHours openingHours) {
	...
	public BUDDHIST_TEMPLE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public BUDDHIST_TEMPLE(Photo photo) {
		setPhoto(photo);
	}
	...
	public BUDDHIST_TEMPLE(PotentialAction potentialAction) {
	...
	public BUDDHIST_TEMPLE(PublicAccess publicAccess) {
	...
	public BUDDHIST_TEMPLE(Review review) {
		setReview(review);
	}
	...
	public BUDDHIST_TEMPLE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public BUDDHIST_TEMPLE(SmokingAllowed smokingAllowed) {
	...
	public BUDDHIST_TEMPLE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public BUDDHIST_TEMPLE(SubjectOf subjectOf) {
	...
	public BUDDHIST_TEMPLE(Telephone telephone) {
	...
	public BUDDHIST_TEMPLE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.BuddhistTemple org) {
		setSeq(org.getSeq());
