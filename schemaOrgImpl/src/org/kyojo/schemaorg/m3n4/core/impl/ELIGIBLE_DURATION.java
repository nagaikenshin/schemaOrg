...
public class ELIGIBLE_DURATION implements Container.EligibleDuration {
	...
	public ELIGIBLE_DURATION(String string) {
	...
	public ELIGIBLE_DURATION(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public ELIGIBLE_DURATION(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public ELIGIBLE_DURATION(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public ELIGIBLE_DURATION(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.EligibleDuration org) {
