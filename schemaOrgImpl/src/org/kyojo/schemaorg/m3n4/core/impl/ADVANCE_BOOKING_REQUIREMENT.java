...
public class ADVANCE_BOOKING_REQUIREMENT implements Container.AdvanceBookingRequirement {
	...
	public ADVANCE_BOOKING_REQUIREMENT(String string) {
	...
	public ADVANCE_BOOKING_REQUIREMENT(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public ADVANCE_BOOKING_REQUIREMENT(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public ADVANCE_BOOKING_REQUIREMENT(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public ADVANCE_BOOKING_REQUIREMENT(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.AdvanceBookingRequirement org) {
