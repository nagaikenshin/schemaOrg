...
public class CONTAINS_SEASON implements Container.ContainsSeason {
	...
	public CONTAINS_SEASON(BusTrip busTrip) {
	...
	public CONTAINS_SEASON(Flight flight) {
	...
	public CONTAINS_SEASON(TouristTrip touristTrip) {
	...
	public CONTAINS_SEASON(TrainTrip trainTrip) {
