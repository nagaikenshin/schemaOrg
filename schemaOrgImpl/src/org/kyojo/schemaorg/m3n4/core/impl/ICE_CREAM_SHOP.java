...
public class ICE_CREAM_SHOP implements Clazz.IceCreamShop {
	...
	public ICE_CREAM_SHOP() {
	}

	public ICE_CREAM_SHOP(Long seq) {
		setSeq(seq);
	}

	public ICE_CREAM_SHOP(String string) {
	...
	public ICE_CREAM_SHOP(AcceptsReservations acceptsReservations) {
	...
	public ICE_CREAM_SHOP(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public ICE_CREAM_SHOP(AdditionalProperty additionalProperty) {
	...
	public ICE_CREAM_SHOP(AdditionalType additionalType) {
	...
	public ICE_CREAM_SHOP(Address address) {
		setAddress(address);
	}
	...
	public ICE_CREAM_SHOP(AggregateRating aggregateRating) {
	...
	public ICE_CREAM_SHOP(AlternateName alternateName) {
	...
	public ICE_CREAM_SHOP(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public ICE_CREAM_SHOP(AmenityFeature amenityFeature) {
	...
	public ICE_CREAM_SHOP(AreaServed areaServed) {
	...
	public ICE_CREAM_SHOP(Award award) {
		setAward(award);
	}
	...
	public ICE_CREAM_SHOP(BranchCode branchCode) {
	...
	public ICE_CREAM_SHOP(Brand brand) {
		setBrand(brand);
	}
	...
	public ICE_CREAM_SHOP(ContactPoint contactPoint) {
	...
	public ICE_CREAM_SHOP(ContainedInPlace containedInPlace) {
	...
	public ICE_CREAM_SHOP(ContainsPlace containsPlace) {
	...
	public ICE_CREAM_SHOP(CorrectionsPolicy correctionsPolicy) {
	...
	public ICE_CREAM_SHOP(CurrenciesAccepted currenciesAccepted) {
	...
	public ICE_CREAM_SHOP(Department department) {
	...
	public ICE_CREAM_SHOP(Description description) {
	...
	public ICE_CREAM_SHOP(DisambiguatingDescription disambiguatingDescription) {
	...
	public ICE_CREAM_SHOP(DissolutionDate dissolutionDate) {
	...
	public ICE_CREAM_SHOP(DiversityPolicy diversityPolicy) {
	...
	public ICE_CREAM_SHOP(DiversityStaffingReport diversityStaffingReport) {
	...
	public ICE_CREAM_SHOP(Duns duns) {
		setDuns(duns);
	}
	...
	public ICE_CREAM_SHOP(Email email) {
		setEmail(email);
	}
	...
	public ICE_CREAM_SHOP(Employee employee) {
	...
	public ICE_CREAM_SHOP(EthicsPolicy ethicsPolicy) {
	...
	public ICE_CREAM_SHOP(Event event) {
		setEvent(event);
	}
	...
	public ICE_CREAM_SHOP(FaxNumber faxNumber) {
	...
	public ICE_CREAM_SHOP(Founder founder) {
		setFounder(founder);
	}
	...
	public ICE_CREAM_SHOP(FoundingDate foundingDate) {
	...
	public ICE_CREAM_SHOP(FoundingLocation foundingLocation) {
	...
	public ICE_CREAM_SHOP(Funder funder) {
		setFunder(funder);
	}
	...
	public ICE_CREAM_SHOP(GeospatiallyContains geospatiallyContains) {
	...
	public ICE_CREAM_SHOP(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public ICE_CREAM_SHOP(GeospatiallyCovers geospatiallyCovers) {
	...
	public ICE_CREAM_SHOP(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public ICE_CREAM_SHOP(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public ICE_CREAM_SHOP(GeospatiallyEquals geospatiallyEquals) {
	...
	public ICE_CREAM_SHOP(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public ICE_CREAM_SHOP(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public ICE_CREAM_SHOP(GeospatiallyTouches geospatiallyTouches) {
	...
	public ICE_CREAM_SHOP(GeospatiallyWithin geospatiallyWithin) {
	...
	public ICE_CREAM_SHOP(GlobalLocationNumber globalLocationNumber) {
	...
	public ICE_CREAM_SHOP(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public ICE_CREAM_SHOP(HasMenu hasMenu) {
		setHasMenu(hasMenu);
	}
	...
	public ICE_CREAM_SHOP(HasOfferCatalog hasOfferCatalog) {
	...
	public ICE_CREAM_SHOP(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public ICE_CREAM_SHOP(Identifier identifier) {
	...
	public ICE_CREAM_SHOP(Image image) {
		setImage(image);
	}
	...
	public ICE_CREAM_SHOP(IsAccessibleForFree isAccessibleForFree) {
	...
	public ICE_CREAM_SHOP(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public ICE_CREAM_SHOP(KnowsAbout knowsAbout) {
	...
	public ICE_CREAM_SHOP(KnowsLanguage knowsLanguage) {
	...
	public ICE_CREAM_SHOP(LegalName legalName) {
	...
	public ICE_CREAM_SHOP(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public ICE_CREAM_SHOP(Location location) {
	...
	public ICE_CREAM_SHOP(Logo logo) {
		setLogo(logo);
	}
	...
	public ICE_CREAM_SHOP(MainEntityOfPage mainEntityOfPage) {
	...
	public ICE_CREAM_SHOP(MakesOffer makesOffer) {
	...
	public ICE_CREAM_SHOP(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public ICE_CREAM_SHOP(Member member) {
		setMember(member);
	}
	...
	public ICE_CREAM_SHOP(MemberOf memberOf) {
	...
	public ICE_CREAM_SHOP(Naics naics) {
		setNaics(naics);
	}
	...
	public ICE_CREAM_SHOP(Name name) {
		setName(name);
	}
	...
	public ICE_CREAM_SHOP(NameFuzzy nameFuzzy) {
	...
	public ICE_CREAM_SHOP(NameRuby nameRuby) {
	...
	public ICE_CREAM_SHOP(NumberOfEmployees numberOfEmployees) {
	...
	public ICE_CREAM_SHOP(OpeningHours openingHours) {
	...
	public ICE_CREAM_SHOP(OpeningHoursSpecification openingHoursSpecification) {
	...
	public ICE_CREAM_SHOP(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public ICE_CREAM_SHOP(Owns owns) {
		setOwns(owns);
	}
	...
	public ICE_CREAM_SHOP(ParentOrganization parentOrganization) {
	...
	public ICE_CREAM_SHOP(PaymentAccepted paymentAccepted) {
	...
	public ICE_CREAM_SHOP(Photo photo) {
		setPhoto(photo);
	}
	...
	public ICE_CREAM_SHOP(PotentialAction potentialAction) {
	...
	public ICE_CREAM_SHOP(PriceRange priceRange) {
	...
	public ICE_CREAM_SHOP(PublicAccess publicAccess) {
	...
	public ICE_CREAM_SHOP(PublishingPrinciples publishingPrinciples) {
	...
	public ICE_CREAM_SHOP(Review review) {
		setReview(review);
	}
	...
	public ICE_CREAM_SHOP(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ICE_CREAM_SHOP(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public ICE_CREAM_SHOP(ServesCuisine servesCuisine) {
	...
	public ICE_CREAM_SHOP(SmokingAllowed smokingAllowed) {
	...
	public ICE_CREAM_SHOP(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public ICE_CREAM_SHOP(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public ICE_CREAM_SHOP(StarRating starRating) {
	...
	public ICE_CREAM_SHOP(SubOrganization subOrganization) {
	...
	public ICE_CREAM_SHOP(SubjectOf subjectOf) {
	...
	public ICE_CREAM_SHOP(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public ICE_CREAM_SHOP(Telephone telephone) {
	...
	public ICE_CREAM_SHOP(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public ICE_CREAM_SHOP(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.IceCreamShop org) {
		setSeq(org.getSeq());
