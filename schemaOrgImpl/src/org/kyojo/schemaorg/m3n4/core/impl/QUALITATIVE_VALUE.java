...
public class QUALITATIVE_VALUE implements Clazz.QualitativeValue {
	...
	public QUALITATIVE_VALUE() {
	}

	public QUALITATIVE_VALUE(Long seq) {
		setSeq(seq);
	}

	public QUALITATIVE_VALUE(String string) {
	...
	public QUALITATIVE_VALUE(AdditionalProperty additionalProperty) {
	...
	public QUALITATIVE_VALUE(AdditionalType additionalType) {
	...
	public QUALITATIVE_VALUE(AlternateName alternateName) {
	...
	public QUALITATIVE_VALUE(Description description) {
	...
	public QUALITATIVE_VALUE(DisambiguatingDescription disambiguatingDescription) {
	...
	public QUALITATIVE_VALUE(Equal equal) {
		setEqual(equal);
	}
	...
	public QUALITATIVE_VALUE(Greater greater) {
		setGreater(greater);
	}
	...
	public QUALITATIVE_VALUE(GreaterOrEqual greaterOrEqual) {
	...
	public QUALITATIVE_VALUE(Identifier identifier) {
	...
	public QUALITATIVE_VALUE(Image image) {
		setImage(image);
	}
	...
	public QUALITATIVE_VALUE(Lesser lesser) {
		setLesser(lesser);
	}
	...
	public QUALITATIVE_VALUE(LesserOrEqual lesserOrEqual) {
	...
	public QUALITATIVE_VALUE(MainEntityOfPage mainEntityOfPage) {
	...
	public QUALITATIVE_VALUE(Name name) {
		setName(name);
	}
	...
	public QUALITATIVE_VALUE(NameFuzzy nameFuzzy) {
	...
	public QUALITATIVE_VALUE(NameRuby nameRuby) {
	...
	public QUALITATIVE_VALUE(NonEqual nonEqual) {
	...
	public QUALITATIVE_VALUE(PotentialAction potentialAction) {
	...
	public QUALITATIVE_VALUE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public QUALITATIVE_VALUE(SubjectOf subjectOf) {
	...
	public QUALITATIVE_VALUE(SupersededBy supersededBy) {
	...
	public QUALITATIVE_VALUE(Url url) {
		setUrl(url);
	}
	...
	public QUALITATIVE_VALUE(ValueReference valueReference) {
	...
	public void copy(Clazz.QualitativeValue org) {
		setSeq(org.getSeq());
