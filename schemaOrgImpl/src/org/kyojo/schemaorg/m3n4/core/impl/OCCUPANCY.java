...
public class OCCUPANCY implements Container.Occupancy {
	...
	public OCCUPANCY(String string) {
	...
	public OCCUPANCY(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public OCCUPANCY(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public OCCUPANCY(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public OCCUPANCY(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.Occupancy org) {
