...
public class PLAYGROUND implements Clazz.Playground {
	...
	public PLAYGROUND(Long seq) {
		setSeq(seq);
	}

	public PLAYGROUND(String string) {
	...
	public PLAYGROUND(AdditionalProperty additionalProperty) {
	...
	public PLAYGROUND(AdditionalType additionalType) {
	...
	public PLAYGROUND(Address address) {
		setAddress(address);
	}
	...
	public PLAYGROUND(AggregateRating aggregateRating) {
	...
	public PLAYGROUND(AlternateName alternateName) {
	...
	public PLAYGROUND(AmenityFeature amenityFeature) {
	...
	public PLAYGROUND(BranchCode branchCode) {
	...
	public PLAYGROUND(ContainedInPlace containedInPlace) {
	...
	public PLAYGROUND(ContainsPlace containsPlace) {
	...
	public PLAYGROUND(Description description) {
	...
	public PLAYGROUND(DisambiguatingDescription disambiguatingDescription) {
	...
	public PLAYGROUND(FaxNumber faxNumber) {
	...
	public PLAYGROUND(GeospatiallyContains geospatiallyContains) {
	...
	public PLAYGROUND(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public PLAYGROUND(GeospatiallyCovers geospatiallyCovers) {
	...
	public PLAYGROUND(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public PLAYGROUND(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public PLAYGROUND(GeospatiallyEquals geospatiallyEquals) {
	...
	public PLAYGROUND(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public PLAYGROUND(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public PLAYGROUND(GeospatiallyTouches geospatiallyTouches) {
	...
	public PLAYGROUND(GeospatiallyWithin geospatiallyWithin) {
	...
	public PLAYGROUND(GlobalLocationNumber globalLocationNumber) {
	...
	public PLAYGROUND(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public PLAYGROUND(Identifier identifier) {
	...
	public PLAYGROUND(IsAccessibleForFree isAccessibleForFree) {
	...
	public PLAYGROUND(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public PLAYGROUND(MainEntityOfPage mainEntityOfPage) {
	...
	public PLAYGROUND(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public PLAYGROUND(NameFuzzy nameFuzzy) {
	...
	public PLAYGROUND(NameRuby nameRuby) {
	...
	public PLAYGROUND(OpeningHours openingHours) {
	...
	public PLAYGROUND(OpeningHoursSpecification openingHoursSpecification) {
	...
	public PLAYGROUND(PotentialAction potentialAction) {
	...
	public PLAYGROUND(PublicAccess publicAccess) {
	...
	public PLAYGROUND(Review review) {
		setReview(review);
	}
	...
	public PLAYGROUND(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PLAYGROUND(SmokingAllowed smokingAllowed) {
	...
	public PLAYGROUND(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public PLAYGROUND(SubjectOf subjectOf) {
	...
	public PLAYGROUND(Telephone telephone) {
	...
	public void copy(Clazz.Playground org) {
		setSeq(org.getSeq());
