...
public class TARGET_PRODUCT implements Container.TargetProduct {
	...
	public TARGET_PRODUCT(String string) {
	...
	public TARGET_PRODUCT(MobileApplication mobileApplication) {
	...
	public TARGET_PRODUCT(SoftwareApplication softwareApplication) {
		softwareApplicationList = new ArrayList<SoftwareApplication>();
	...
	public TARGET_PRODUCT(VideoGame videoGame) {
	...
	public TARGET_PRODUCT(WebApplication webApplication) {
	...
	public TARGET_PRODUCT(List<MobileApplication> mobileApplicationList,
	...
	public void copy(Container.TargetProduct org) {
