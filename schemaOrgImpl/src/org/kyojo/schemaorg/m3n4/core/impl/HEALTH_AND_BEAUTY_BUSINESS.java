...
public class HEALTH_AND_BEAUTY_BUSINESS implements Clazz.HealthAndBeautyBusiness {
	...
	public HEALTH_AND_BEAUTY_BUSINESS() {
	}

	public HEALTH_AND_BEAUTY_BUSINESS(Long seq) {
		setSeq(seq);
	}

	public HEALTH_AND_BEAUTY_BUSINESS(String string) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(AdditionalProperty additionalProperty) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(AdditionalType additionalType) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Address address) {
		setAddress(address);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(AggregateRating aggregateRating) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(AlternateName alternateName) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(AmenityFeature amenityFeature) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(AreaServed areaServed) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Award award) {
		setAward(award);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(BranchCode branchCode) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Brand brand) {
		setBrand(brand);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(ContactPoint contactPoint) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(ContainedInPlace containedInPlace) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(ContainsPlace containsPlace) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(CorrectionsPolicy correctionsPolicy) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(CurrenciesAccepted currenciesAccepted) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Department department) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Description description) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(DisambiguatingDescription disambiguatingDescription) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(DissolutionDate dissolutionDate) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(DiversityPolicy diversityPolicy) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(DiversityStaffingReport diversityStaffingReport) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Duns duns) {
		setDuns(duns);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Email email) {
		setEmail(email);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Employee employee) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(EthicsPolicy ethicsPolicy) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Event event) {
		setEvent(event);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(FaxNumber faxNumber) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Founder founder) {
		setFounder(founder);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(FoundingDate foundingDate) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(FoundingLocation foundingLocation) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Funder funder) {
		setFunder(funder);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Geo geo) {
		setGeo(geo);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(GeospatiallyContains geospatiallyContains) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(GeospatiallyCovers geospatiallyCovers) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(GeospatiallyEquals geospatiallyEquals) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(GeospatiallyTouches geospatiallyTouches) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(GeospatiallyWithin geospatiallyWithin) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(GlobalLocationNumber globalLocationNumber) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(HasOfferCatalog hasOfferCatalog) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Identifier identifier) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Image image) {
		setImage(image);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(IsAccessibleForFree isAccessibleForFree) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(KnowsAbout knowsAbout) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(KnowsLanguage knowsLanguage) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(LegalName legalName) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Location location) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Logo logo) {
		setLogo(logo);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(MainEntityOfPage mainEntityOfPage) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(MakesOffer makesOffer) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Member member) {
		setMember(member);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(MemberOf memberOf) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Naics naics) {
		setNaics(naics);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Name name) {
		setName(name);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(NameFuzzy nameFuzzy) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(NameRuby nameRuby) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(NumberOfEmployees numberOfEmployees) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(OpeningHours openingHours) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(OpeningHoursSpecification openingHoursSpecification) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Owns owns) {
		setOwns(owns);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(ParentOrganization parentOrganization) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(PaymentAccepted paymentAccepted) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Photo photo) {
		setPhoto(photo);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(PotentialAction potentialAction) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(PriceRange priceRange) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(PublicAccess publicAccess) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(PublishingPrinciples publishingPrinciples) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Review review) {
		setReview(review);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(SmokingAllowed smokingAllowed) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(SubOrganization subOrganization) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(SubjectOf subjectOf) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Telephone telephone) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public HEALTH_AND_BEAUTY_BUSINESS(Url url) {
		setUrl(url);
	}
	...
	public HEALTH_AND_BEAUTY_BUSINESS(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.HealthAndBeautyBusiness org) {
		setSeq(org.getSeq());
