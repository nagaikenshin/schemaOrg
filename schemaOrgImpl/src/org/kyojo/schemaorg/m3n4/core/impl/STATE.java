...
public class STATE implements Clazz.State {
	...
	public STATE(AdditionalProperty additionalProperty) {
	...
	public STATE(AdditionalType additionalType) {
	...
	public STATE(AggregateRating aggregateRating) {
	...
	public STATE(AlternateName alternateName) {
	...
	public STATE(AmenityFeature amenityFeature) {
	...
	public STATE(BranchCode branchCode) {
	...
	public STATE(ContainedInPlace containedInPlace) {
	...
	public STATE(ContainsPlace containsPlace) {
	...
	public STATE(Description description) {
	...
	public STATE(DisambiguatingDescription disambiguatingDescription) {
	...
	public STATE(FaxNumber faxNumber) {
	...
	public STATE(GeospatiallyContains geospatiallyContains) {
	...
	public STATE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public STATE(GeospatiallyCovers geospatiallyCovers) {
	...
	public STATE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public STATE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public STATE(GeospatiallyEquals geospatiallyEquals) {
	...
	public STATE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public STATE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public STATE(GeospatiallyTouches geospatiallyTouches) {
	...
	public STATE(GeospatiallyWithin geospatiallyWithin) {
	...
	public STATE(GlobalLocationNumber globalLocationNumber) {
	...
	public STATE(Identifier identifier) {
	...
	public STATE(IsAccessibleForFree isAccessibleForFree) {
	...
	public STATE(MainEntityOfPage mainEntityOfPage) {
	...
	public STATE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public STATE(NameFuzzy nameFuzzy) {
	...
	public STATE(NameRuby nameRuby) {
	...
	public STATE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public STATE(PotentialAction potentialAction) {
	...
	public STATE(PublicAccess publicAccess) {
	...
	public STATE(SmokingAllowed smokingAllowed) {
	...
	public STATE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public STATE(SubjectOf subjectOf) {
	...
	public void copy(Clazz.State org) {
		setSeq(org.getSeq());
