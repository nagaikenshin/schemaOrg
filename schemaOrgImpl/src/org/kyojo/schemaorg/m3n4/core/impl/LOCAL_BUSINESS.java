...
public class LOCAL_BUSINESS implements Clazz.LocalBusiness {
	...
	public LOCAL_BUSINESS() {
	}

	public LOCAL_BUSINESS(Long seq) {
		setSeq(seq);
	}

	public LOCAL_BUSINESS(String string) {
	...
	public LOCAL_BUSINESS(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public LOCAL_BUSINESS(AdditionalProperty additionalProperty) {
	...
	public LOCAL_BUSINESS(AdditionalType additionalType) {
	...
	public LOCAL_BUSINESS(Address address) {
		setAddress(address);
	}
	...
	public LOCAL_BUSINESS(AggregateRating aggregateRating) {
	...
	public LOCAL_BUSINESS(AlternateName alternateName) {
	...
	public LOCAL_BUSINESS(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public LOCAL_BUSINESS(AmenityFeature amenityFeature) {
	...
	public LOCAL_BUSINESS(AreaServed areaServed) {
	...
	public LOCAL_BUSINESS(Award award) {
		setAward(award);
	}
	...
	public LOCAL_BUSINESS(BranchCode branchCode) {
	...
	public LOCAL_BUSINESS(Brand brand) {
		setBrand(brand);
	}
	...
	public LOCAL_BUSINESS(ContactPoint contactPoint) {
	...
	public LOCAL_BUSINESS(ContainedInPlace containedInPlace) {
	...
	public LOCAL_BUSINESS(ContainsPlace containsPlace) {
	...
	public LOCAL_BUSINESS(CorrectionsPolicy correctionsPolicy) {
	...
	public LOCAL_BUSINESS(CurrenciesAccepted currenciesAccepted) {
	...
	public LOCAL_BUSINESS(Department department) {
	...
	public LOCAL_BUSINESS(Description description) {
	...
	public LOCAL_BUSINESS(DisambiguatingDescription disambiguatingDescription) {
	...
	public LOCAL_BUSINESS(DissolutionDate dissolutionDate) {
	...
	public LOCAL_BUSINESS(DiversityPolicy diversityPolicy) {
	...
	public LOCAL_BUSINESS(DiversityStaffingReport diversityStaffingReport) {
	...
	public LOCAL_BUSINESS(Duns duns) {
		setDuns(duns);
	}
	...
	public LOCAL_BUSINESS(Email email) {
		setEmail(email);
	}
	...
	public LOCAL_BUSINESS(Employee employee) {
	...
	public LOCAL_BUSINESS(EthicsPolicy ethicsPolicy) {
	...
	public LOCAL_BUSINESS(Event event) {
		setEvent(event);
	}
	...
	public LOCAL_BUSINESS(FaxNumber faxNumber) {
	...
	public LOCAL_BUSINESS(Founder founder) {
		setFounder(founder);
	}
	...
	public LOCAL_BUSINESS(FoundingDate foundingDate) {
	...
	public LOCAL_BUSINESS(FoundingLocation foundingLocation) {
	...
	public LOCAL_BUSINESS(Funder funder) {
		setFunder(funder);
	}
	...
	public LOCAL_BUSINESS(GeospatiallyContains geospatiallyContains) {
	...
	public LOCAL_BUSINESS(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public LOCAL_BUSINESS(GeospatiallyCovers geospatiallyCovers) {
	...
	public LOCAL_BUSINESS(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public LOCAL_BUSINESS(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public LOCAL_BUSINESS(GeospatiallyEquals geospatiallyEquals) {
	...
	public LOCAL_BUSINESS(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public LOCAL_BUSINESS(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public LOCAL_BUSINESS(GeospatiallyTouches geospatiallyTouches) {
	...
	public LOCAL_BUSINESS(GeospatiallyWithin geospatiallyWithin) {
	...
	public LOCAL_BUSINESS(GlobalLocationNumber globalLocationNumber) {
	...
	public LOCAL_BUSINESS(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public LOCAL_BUSINESS(HasOfferCatalog hasOfferCatalog) {
	...
	public LOCAL_BUSINESS(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public LOCAL_BUSINESS(Identifier identifier) {
	...
	public LOCAL_BUSINESS(Image image) {
		setImage(image);
	}
	...
	public LOCAL_BUSINESS(IsAccessibleForFree isAccessibleForFree) {
	...
	public LOCAL_BUSINESS(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public LOCAL_BUSINESS(KnowsAbout knowsAbout) {
	...
	public LOCAL_BUSINESS(KnowsLanguage knowsLanguage) {
	...
	public LOCAL_BUSINESS(LegalName legalName) {
	...
	public LOCAL_BUSINESS(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public LOCAL_BUSINESS(Location location) {
	...
	public LOCAL_BUSINESS(Logo logo) {
		setLogo(logo);
	}
	...
	public LOCAL_BUSINESS(MainEntityOfPage mainEntityOfPage) {
	...
	public LOCAL_BUSINESS(MakesOffer makesOffer) {
	...
	public LOCAL_BUSINESS(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public LOCAL_BUSINESS(Member member) {
		setMember(member);
	}
	...
	public LOCAL_BUSINESS(MemberOf memberOf) {
	...
	public LOCAL_BUSINESS(Naics naics) {
		setNaics(naics);
	}
	...
	public LOCAL_BUSINESS(Name name) {
		setName(name);
	}
	...
	public LOCAL_BUSINESS(NameFuzzy nameFuzzy) {
	...
	public LOCAL_BUSINESS(NameRuby nameRuby) {
	...
	public LOCAL_BUSINESS(NumberOfEmployees numberOfEmployees) {
	...
	public LOCAL_BUSINESS(OpeningHours openingHours) {
	...
	public LOCAL_BUSINESS(OpeningHoursSpecification openingHoursSpecification) {
	...
	public LOCAL_BUSINESS(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public LOCAL_BUSINESS(Owns owns) {
		setOwns(owns);
	}
	...
	public LOCAL_BUSINESS(ParentOrganization parentOrganization) {
	...
	public LOCAL_BUSINESS(PaymentAccepted paymentAccepted) {
	...
	public LOCAL_BUSINESS(Photo photo) {
		setPhoto(photo);
	}
	...
	public LOCAL_BUSINESS(PotentialAction potentialAction) {
	...
	public LOCAL_BUSINESS(PriceRange priceRange) {
	...
	public LOCAL_BUSINESS(PublicAccess publicAccess) {
	...
	public LOCAL_BUSINESS(PublishingPrinciples publishingPrinciples) {
	...
	public LOCAL_BUSINESS(Review review) {
		setReview(review);
	}
	...
	public LOCAL_BUSINESS(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public LOCAL_BUSINESS(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public LOCAL_BUSINESS(SmokingAllowed smokingAllowed) {
	...
	public LOCAL_BUSINESS(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public LOCAL_BUSINESS(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public LOCAL_BUSINESS(SubOrganization subOrganization) {
	...
	public LOCAL_BUSINESS(SubjectOf subjectOf) {
	...
	public LOCAL_BUSINESS(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public LOCAL_BUSINESS(Telephone telephone) {
	...
	public LOCAL_BUSINESS(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public LOCAL_BUSINESS(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.LocalBusiness org) {
		setSeq(org.getSeq());
