...
public class ACCOUNTING_SERVICE implements Clazz.AccountingService {
	...
	public ACCOUNTING_SERVICE() {
	}

	public ACCOUNTING_SERVICE(Long seq) {
		setSeq(seq);
	}

	public ACCOUNTING_SERVICE(String string) {
	...
	public ACCOUNTING_SERVICE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public ACCOUNTING_SERVICE(AdditionalProperty additionalProperty) {
	...
	public ACCOUNTING_SERVICE(AdditionalType additionalType) {
	...
	public ACCOUNTING_SERVICE(Address address) {
		setAddress(address);
	}
	...
	public ACCOUNTING_SERVICE(AggregateRating aggregateRating) {
	...
	public ACCOUNTING_SERVICE(AlternateName alternateName) {
	...
	public ACCOUNTING_SERVICE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public ACCOUNTING_SERVICE(AmenityFeature amenityFeature) {
	...
	public ACCOUNTING_SERVICE(AreaServed areaServed) {
	...
	public ACCOUNTING_SERVICE(Award award) {
		setAward(award);
	}
	...
	public ACCOUNTING_SERVICE(BranchCode branchCode) {
	...
	public ACCOUNTING_SERVICE(Brand brand) {
		setBrand(brand);
	}
	...
	public ACCOUNTING_SERVICE(ContactPoint contactPoint) {
	...
	public ACCOUNTING_SERVICE(ContainedInPlace containedInPlace) {
	...
	public ACCOUNTING_SERVICE(ContainsPlace containsPlace) {
	...
	public ACCOUNTING_SERVICE(CorrectionsPolicy correctionsPolicy) {
	...
	public ACCOUNTING_SERVICE(CurrenciesAccepted currenciesAccepted) {
	...
	public ACCOUNTING_SERVICE(Department department) {
	...
	public ACCOUNTING_SERVICE(Description description) {
	...
	public ACCOUNTING_SERVICE(DisambiguatingDescription disambiguatingDescription) {
	...
	public ACCOUNTING_SERVICE(DissolutionDate dissolutionDate) {
	...
	public ACCOUNTING_SERVICE(DiversityPolicy diversityPolicy) {
	...
	public ACCOUNTING_SERVICE(DiversityStaffingReport diversityStaffingReport) {
	...
	public ACCOUNTING_SERVICE(Duns duns) {
		setDuns(duns);
	}
	...
	public ACCOUNTING_SERVICE(Email email) {
		setEmail(email);
	}
	...
	public ACCOUNTING_SERVICE(Employee employee) {
	...
	public ACCOUNTING_SERVICE(EthicsPolicy ethicsPolicy) {
	...
	public ACCOUNTING_SERVICE(Event event) {
		setEvent(event);
	}
	...
	public ACCOUNTING_SERVICE(FaxNumber faxNumber) {
	...
	public ACCOUNTING_SERVICE(FeesAndCommissionsSpecification feesAndCommissionsSpecification) {
	...
	public ACCOUNTING_SERVICE(Founder founder) {
		setFounder(founder);
	}
	...
	public ACCOUNTING_SERVICE(FoundingDate foundingDate) {
	...
	public ACCOUNTING_SERVICE(FoundingLocation foundingLocation) {
	...
	public ACCOUNTING_SERVICE(Funder funder) {
		setFunder(funder);
	}
	...
	public ACCOUNTING_SERVICE(Geo geo) {
		setGeo(geo);
	}
	...
	public ACCOUNTING_SERVICE(GeospatiallyContains geospatiallyContains) {
	...
	public ACCOUNTING_SERVICE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public ACCOUNTING_SERVICE(GeospatiallyCovers geospatiallyCovers) {
	...
	public ACCOUNTING_SERVICE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public ACCOUNTING_SERVICE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public ACCOUNTING_SERVICE(GeospatiallyEquals geospatiallyEquals) {
	...
	public ACCOUNTING_SERVICE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public ACCOUNTING_SERVICE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public ACCOUNTING_SERVICE(GeospatiallyTouches geospatiallyTouches) {
	...
	public ACCOUNTING_SERVICE(GeospatiallyWithin geospatiallyWithin) {
	...
	public ACCOUNTING_SERVICE(GlobalLocationNumber globalLocationNumber) {
	...
	public ACCOUNTING_SERVICE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public ACCOUNTING_SERVICE(HasOfferCatalog hasOfferCatalog) {
	...
	public ACCOUNTING_SERVICE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public ACCOUNTING_SERVICE(Identifier identifier) {
	...
	public ACCOUNTING_SERVICE(Image image) {
		setImage(image);
	}
	...
	public ACCOUNTING_SERVICE(IsAccessibleForFree isAccessibleForFree) {
	...
	public ACCOUNTING_SERVICE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public ACCOUNTING_SERVICE(KnowsAbout knowsAbout) {
	...
	public ACCOUNTING_SERVICE(KnowsLanguage knowsLanguage) {
	...
	public ACCOUNTING_SERVICE(LegalName legalName) {
	...
	public ACCOUNTING_SERVICE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public ACCOUNTING_SERVICE(Location location) {
	...
	public ACCOUNTING_SERVICE(Logo logo) {
		setLogo(logo);
	}
	...
	public ACCOUNTING_SERVICE(MainEntityOfPage mainEntityOfPage) {
	...
	public ACCOUNTING_SERVICE(MakesOffer makesOffer) {
	...
	public ACCOUNTING_SERVICE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public ACCOUNTING_SERVICE(Member member) {
		setMember(member);
	}
	...
	public ACCOUNTING_SERVICE(MemberOf memberOf) {
	...
	public ACCOUNTING_SERVICE(Naics naics) {
		setNaics(naics);
	}
	...
	public ACCOUNTING_SERVICE(Name name) {
		setName(name);
	}
	...
	public ACCOUNTING_SERVICE(NameFuzzy nameFuzzy) {
	...
	public ACCOUNTING_SERVICE(NameRuby nameRuby) {
	...
	public ACCOUNTING_SERVICE(NumberOfEmployees numberOfEmployees) {
	...
	public ACCOUNTING_SERVICE(OpeningHours openingHours) {
	...
	public ACCOUNTING_SERVICE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public ACCOUNTING_SERVICE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public ACCOUNTING_SERVICE(Owns owns) {
		setOwns(owns);
	}
	...
	public ACCOUNTING_SERVICE(ParentOrganization parentOrganization) {
	...
	public ACCOUNTING_SERVICE(PaymentAccepted paymentAccepted) {
	...
	public ACCOUNTING_SERVICE(Photo photo) {
		setPhoto(photo);
	}
	...
	public ACCOUNTING_SERVICE(PotentialAction potentialAction) {
	...
	public ACCOUNTING_SERVICE(PriceRange priceRange) {
	...
	public ACCOUNTING_SERVICE(PublicAccess publicAccess) {
	...
	public ACCOUNTING_SERVICE(PublishingPrinciples publishingPrinciples) {
	...
	public ACCOUNTING_SERVICE(Review review) {
		setReview(review);
	}
	...
	public ACCOUNTING_SERVICE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ACCOUNTING_SERVICE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public ACCOUNTING_SERVICE(SmokingAllowed smokingAllowed) {
	...
	public ACCOUNTING_SERVICE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public ACCOUNTING_SERVICE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public ACCOUNTING_SERVICE(SubOrganization subOrganization) {
	...
	public ACCOUNTING_SERVICE(SubjectOf subjectOf) {
	...
	public ACCOUNTING_SERVICE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public ACCOUNTING_SERVICE(Telephone telephone) {
	...
	public ACCOUNTING_SERVICE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public ACCOUNTING_SERVICE(Url url) {
		setUrl(url);
	}
	...
	public ACCOUNTING_SERVICE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.AccountingService org) {
		setSeq(org.getSeq());
