...
public class RADIO_STATION implements Clazz.RadioStation {
	...
	public RADIO_STATION(Long seq) {
		setSeq(seq);
	}

	public RADIO_STATION(String string) {
	...
	public RADIO_STATION(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public RADIO_STATION(AdditionalProperty additionalProperty) {
	...
	public RADIO_STATION(AdditionalType additionalType) {
	...
	public RADIO_STATION(Address address) {
		setAddress(address);
	}
	...
	public RADIO_STATION(AggregateRating aggregateRating) {
	...
	public RADIO_STATION(AlternateName alternateName) {
	...
	public RADIO_STATION(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public RADIO_STATION(AmenityFeature amenityFeature) {
	...
	public RADIO_STATION(AreaServed areaServed) {
	...
	public RADIO_STATION(Award award) {
		setAward(award);
	}
	...
	public RADIO_STATION(BranchCode branchCode) {
	...
	public RADIO_STATION(Brand brand) {
		setBrand(brand);
	}
	...
	public RADIO_STATION(ContactPoint contactPoint) {
	...
	public RADIO_STATION(ContainedInPlace containedInPlace) {
	...
	public RADIO_STATION(ContainsPlace containsPlace) {
	...
	public RADIO_STATION(CorrectionsPolicy correctionsPolicy) {
	...
	public RADIO_STATION(CurrenciesAccepted currenciesAccepted) {
	...
	public RADIO_STATION(Department department) {
	...
	public RADIO_STATION(Description description) {
	...
	public RADIO_STATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public RADIO_STATION(DissolutionDate dissolutionDate) {
	...
	public RADIO_STATION(DiversityPolicy diversityPolicy) {
	...
	public RADIO_STATION(DiversityStaffingReport diversityStaffingReport) {
	...
	public RADIO_STATION(Duns duns) {
		setDuns(duns);
	}
	...
	public RADIO_STATION(Email email) {
		setEmail(email);
	}
	...
	public RADIO_STATION(Employee employee) {
	...
	public RADIO_STATION(EthicsPolicy ethicsPolicy) {
	...
	public RADIO_STATION(Event event) {
		setEvent(event);
	}
	...
	public RADIO_STATION(FaxNumber faxNumber) {
	...
	public RADIO_STATION(Founder founder) {
		setFounder(founder);
	}
	...
	public RADIO_STATION(FoundingDate foundingDate) {
	...
	public RADIO_STATION(FoundingLocation foundingLocation) {
	...
	public RADIO_STATION(Funder funder) {
		setFunder(funder);
	}
	...
	public RADIO_STATION(GeospatiallyContains geospatiallyContains) {
	...
	public RADIO_STATION(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public RADIO_STATION(GeospatiallyCovers geospatiallyCovers) {
	...
	public RADIO_STATION(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public RADIO_STATION(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public RADIO_STATION(GeospatiallyEquals geospatiallyEquals) {
	...
	public RADIO_STATION(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public RADIO_STATION(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public RADIO_STATION(GeospatiallyTouches geospatiallyTouches) {
	...
	public RADIO_STATION(GeospatiallyWithin geospatiallyWithin) {
	...
	public RADIO_STATION(GlobalLocationNumber globalLocationNumber) {
	...
	public RADIO_STATION(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public RADIO_STATION(HasOfferCatalog hasOfferCatalog) {
	...
	public RADIO_STATION(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public RADIO_STATION(Identifier identifier) {
	...
	public RADIO_STATION(Image image) {
		setImage(image);
	}
	...
	public RADIO_STATION(IsAccessibleForFree isAccessibleForFree) {
	...
	public RADIO_STATION(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public RADIO_STATION(KnowsAbout knowsAbout) {
	...
	public RADIO_STATION(KnowsLanguage knowsLanguage) {
	...
	public RADIO_STATION(LegalName legalName) {
	...
	public RADIO_STATION(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public RADIO_STATION(Location location) {
	...
	public RADIO_STATION(Logo logo) {
		setLogo(logo);
	}
	...
	public RADIO_STATION(MainEntityOfPage mainEntityOfPage) {
	...
	public RADIO_STATION(MakesOffer makesOffer) {
	...
	public RADIO_STATION(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public RADIO_STATION(Member member) {
		setMember(member);
	}
	...
	public RADIO_STATION(MemberOf memberOf) {
	...
	public RADIO_STATION(Naics naics) {
		setNaics(naics);
	}
	...
	public RADIO_STATION(Name name) {
		setName(name);
	}
	...
	public RADIO_STATION(NameFuzzy nameFuzzy) {
	...
	public RADIO_STATION(NameRuby nameRuby) {
	...
	public RADIO_STATION(NumberOfEmployees numberOfEmployees) {
	...
	public RADIO_STATION(OpeningHours openingHours) {
	...
	public RADIO_STATION(OpeningHoursSpecification openingHoursSpecification) {
	...
	public RADIO_STATION(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public RADIO_STATION(Owns owns) {
		setOwns(owns);
	}
	...
	public RADIO_STATION(ParentOrganization parentOrganization) {
	...
	public RADIO_STATION(PaymentAccepted paymentAccepted) {
	...
	public RADIO_STATION(Photo photo) {
		setPhoto(photo);
	}
	...
	public RADIO_STATION(PotentialAction potentialAction) {
	...
	public RADIO_STATION(PriceRange priceRange) {
	...
	public RADIO_STATION(PublicAccess publicAccess) {
	...
	public RADIO_STATION(PublishingPrinciples publishingPrinciples) {
	...
	public RADIO_STATION(Review review) {
		setReview(review);
	}
	...
	public RADIO_STATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RADIO_STATION(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public RADIO_STATION(SmokingAllowed smokingAllowed) {
	...
	public RADIO_STATION(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public RADIO_STATION(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public RADIO_STATION(SubOrganization subOrganization) {
	...
	public RADIO_STATION(SubjectOf subjectOf) {
	...
	public RADIO_STATION(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public RADIO_STATION(Telephone telephone) {
	...
	public RADIO_STATION(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public RADIO_STATION(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.RadioStation org) {
		setSeq(org.getSeq());
