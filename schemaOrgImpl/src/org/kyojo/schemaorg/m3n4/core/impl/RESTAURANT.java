...
public class RESTAURANT implements Clazz.Restaurant {
	...
	public RESTAURANT(AcceptsReservations acceptsReservations) {
	...
	public RESTAURANT(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public RESTAURANT(AdditionalProperty additionalProperty) {
	...
	public RESTAURANT(AdditionalType additionalType) {
	...
	public RESTAURANT(AggregateRating aggregateRating) {
	...
	public RESTAURANT(AlternateName alternateName) {
	...
	public RESTAURANT(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public RESTAURANT(AmenityFeature amenityFeature) {
	...
	public RESTAURANT(AreaServed areaServed) {
	...
	public RESTAURANT(BranchCode branchCode) {
	...
	public RESTAURANT(ContactPoint contactPoint) {
	...
	public RESTAURANT(ContainedInPlace containedInPlace) {
	...
	public RESTAURANT(ContainsPlace containsPlace) {
	...
	public RESTAURANT(CorrectionsPolicy correctionsPolicy) {
	...
	public RESTAURANT(CurrenciesAccepted currenciesAccepted) {
	...
	public RESTAURANT(Department department) {
	...
	public RESTAURANT(Description description) {
	...
	public RESTAURANT(DisambiguatingDescription disambiguatingDescription) {
	...
	public RESTAURANT(DissolutionDate dissolutionDate) {
	...
	public RESTAURANT(DiversityPolicy diversityPolicy) {
	...
	public RESTAURANT(DiversityStaffingReport diversityStaffingReport) {
	...
	public RESTAURANT(Employee employee) {
	...
	public RESTAURANT(EthicsPolicy ethicsPolicy) {
	...
	public RESTAURANT(FaxNumber faxNumber) {
	...
	public RESTAURANT(Founder founder) {
		setFounder(founder);
	}
	...
	public RESTAURANT(FoundingDate foundingDate) {
	...
	public RESTAURANT(FoundingLocation foundingLocation) {
	...
	public RESTAURANT(Funder funder) {
		setFunder(funder);
	}
	...
	public RESTAURANT(GeospatiallyContains geospatiallyContains) {
	...
	public RESTAURANT(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public RESTAURANT(GeospatiallyCovers geospatiallyCovers) {
	...
	public RESTAURANT(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public RESTAURANT(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public RESTAURANT(GeospatiallyEquals geospatiallyEquals) {
	...
	public RESTAURANT(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public RESTAURANT(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public RESTAURANT(GeospatiallyTouches geospatiallyTouches) {
	...
	public RESTAURANT(GeospatiallyWithin geospatiallyWithin) {
	...
	public RESTAURANT(GlobalLocationNumber globalLocationNumber) {
	...
	public RESTAURANT(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public RESTAURANT(HasMenu hasMenu) {
		setHasMenu(hasMenu);
	}
	...
	public RESTAURANT(HasOfferCatalog hasOfferCatalog) {
	...
	public RESTAURANT(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public RESTAURANT(Identifier identifier) {
	...
	public RESTAURANT(IsAccessibleForFree isAccessibleForFree) {
	...
	public RESTAURANT(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public RESTAURANT(KnowsAbout knowsAbout) {
	...
	public RESTAURANT(KnowsLanguage knowsLanguage) {
	...
	public RESTAURANT(LegalName legalName) {
	...
	public RESTAURANT(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public RESTAURANT(MainEntityOfPage mainEntityOfPage) {
	...
	public RESTAURANT(MakesOffer makesOffer) {
	...
	public RESTAURANT(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public RESTAURANT(Member member) {
		setMember(member);
	}
	...
	public RESTAURANT(MemberOf memberOf) {
	...
	public RESTAURANT(NameFuzzy nameFuzzy) {
	...
	public RESTAURANT(NameRuby nameRuby) {
	...
	public RESTAURANT(NumberOfEmployees numberOfEmployees) {
	...
	public RESTAURANT(OpeningHours openingHours) {
	...
	public RESTAURANT(OpeningHoursSpecification openingHoursSpecification) {
	...
	public RESTAURANT(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public RESTAURANT(ParentOrganization parentOrganization) {
	...
	public RESTAURANT(PaymentAccepted paymentAccepted) {
	...
	public RESTAURANT(PotentialAction potentialAction) {
	...
	public RESTAURANT(PriceRange priceRange) {
	...
	public RESTAURANT(PublicAccess publicAccess) {
	...
	public RESTAURANT(PublishingPrinciples publishingPrinciples) {
	...
	public RESTAURANT(Review review) {
		setReview(review);
	}
	...
	public RESTAURANT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RESTAURANT(ServesCuisine servesCuisine) {
	...
	public RESTAURANT(SmokingAllowed smokingAllowed) {
	...
	public RESTAURANT(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public RESTAURANT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public RESTAURANT(StarRating starRating) {
	...
	public RESTAURANT(SubOrganization subOrganization) {
	...
	public RESTAURANT(SubjectOf subjectOf) {
	...
	public RESTAURANT(Telephone telephone) {
	...
	public RESTAURANT(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Restaurant org) {
		setSeq(org.getSeq());
