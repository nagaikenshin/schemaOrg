...
public class WRITE_ACTION implements Clazz.WriteAction {
	...
	public WRITE_ACTION(Long seq) {
		setSeq(seq);
	}

	public WRITE_ACTION(String string) {
	...
	public WRITE_ACTION(ActionStatus actionStatus) {
	...
	public WRITE_ACTION(AdditionalType additionalType) {
	...
	public WRITE_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public WRITE_ACTION(AlternateName alternateName) {
	...
	public WRITE_ACTION(Description description) {
	...
	public WRITE_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public WRITE_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public WRITE_ACTION(Error error) {
		setError(error);
	}
	...
	public WRITE_ACTION(Identifier identifier) {
	...
	public WRITE_ACTION(Image image) {
		setImage(image);
	}
	...
	public WRITE_ACTION(InLanguage inLanguage) {
	...
	public WRITE_ACTION(Instrument instrument) {
	...
	public WRITE_ACTION(Location location) {
	...
	public WRITE_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public WRITE_ACTION(NameFuzzy nameFuzzy) {
	...
	public WRITE_ACTION(NameRuby nameRuby) {
	...
	public WRITE_ACTION(Object object) {
		setObject(object);
	}
	...
	public WRITE_ACTION(Participant participant) {
	...
	public WRITE_ACTION(PotentialAction potentialAction) {
	...
	public WRITE_ACTION(Result result) {
		setResult(result);
	}
	...
	public WRITE_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public WRITE_ACTION(StartTime startTime) {
	...
	public WRITE_ACTION(SubjectOf subjectOf) {
	...
	public WRITE_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.WriteAction org) {
		setSeq(org.getSeq());
