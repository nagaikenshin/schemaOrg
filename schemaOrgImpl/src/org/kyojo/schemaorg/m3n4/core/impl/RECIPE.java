...
public class RECIPE implements Clazz.Recipe, Container.Recipe {
	...
	public RECIPE(AggregateRating aggregateRating) {
	...
	public RECIPE(Audience audience) {
