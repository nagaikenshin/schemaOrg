...
public class DATE_CREATED implements Container.DateCreated {
	...
	public DATE_CREATED(java.time.LocalDate date) {
		this(new DATE(date));
	}

	public DATE_CREATED(Date date) {
	...
	public DATE_CREATED(java.util.Date dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public DATE_CREATED(java.time.OffsetDateTime dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public DATE_CREATED(DateTime dateTime) {
	...
	public DATE_CREATED(List<Date> dateList,
			List<DateTime> dateTimeList) {
		setDateList(dateList);
		setDateTimeList(dateTimeList);
	}

	public void copy(Container.DateCreated org) {
