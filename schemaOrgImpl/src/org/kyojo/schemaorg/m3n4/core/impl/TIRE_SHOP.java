...
public class TIRE_SHOP implements Clazz.TireShop {
	...
	public TIRE_SHOP(Long seq) {
		setSeq(seq);
	}

	public TIRE_SHOP(String string) {
	...
	public TIRE_SHOP(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public TIRE_SHOP(AdditionalProperty additionalProperty) {
	...
	public TIRE_SHOP(AdditionalType additionalType) {
	...
	public TIRE_SHOP(Address address) {
		setAddress(address);
	}
	...
	public TIRE_SHOP(AggregateRating aggregateRating) {
	...
	public TIRE_SHOP(AlternateName alternateName) {
	...
	public TIRE_SHOP(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public TIRE_SHOP(AmenityFeature amenityFeature) {
	...
	public TIRE_SHOP(AreaServed areaServed) {
	...
	public TIRE_SHOP(BranchCode branchCode) {
	...
	public TIRE_SHOP(ContactPoint contactPoint) {
	...
	public TIRE_SHOP(ContainedInPlace containedInPlace) {
	...
	public TIRE_SHOP(ContainsPlace containsPlace) {
	...
	public TIRE_SHOP(CorrectionsPolicy correctionsPolicy) {
	...
	public TIRE_SHOP(CurrenciesAccepted currenciesAccepted) {
	...
	public TIRE_SHOP(Department department) {
	...
	public TIRE_SHOP(Description description) {
	...
	public TIRE_SHOP(DisambiguatingDescription disambiguatingDescription) {
	...
	public TIRE_SHOP(DissolutionDate dissolutionDate) {
	...
	public TIRE_SHOP(DiversityPolicy diversityPolicy) {
	...
	public TIRE_SHOP(DiversityStaffingReport diversityStaffingReport) {
	...
	public TIRE_SHOP(Employee employee) {
	...
	public TIRE_SHOP(EthicsPolicy ethicsPolicy) {
	...
	public TIRE_SHOP(FaxNumber faxNumber) {
	...
	public TIRE_SHOP(Founder founder) {
		setFounder(founder);
	}
	...
	public TIRE_SHOP(FoundingDate foundingDate) {
	...
	public TIRE_SHOP(FoundingLocation foundingLocation) {
	...
	public TIRE_SHOP(Funder funder) {
		setFunder(funder);
	}
	...
	public TIRE_SHOP(GeospatiallyContains geospatiallyContains) {
	...
	public TIRE_SHOP(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public TIRE_SHOP(GeospatiallyCovers geospatiallyCovers) {
	...
	public TIRE_SHOP(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public TIRE_SHOP(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public TIRE_SHOP(GeospatiallyEquals geospatiallyEquals) {
	...
	public TIRE_SHOP(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public TIRE_SHOP(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public TIRE_SHOP(GeospatiallyTouches geospatiallyTouches) {
	...
	public TIRE_SHOP(GeospatiallyWithin geospatiallyWithin) {
	...
	public TIRE_SHOP(GlobalLocationNumber globalLocationNumber) {
	...
	public TIRE_SHOP(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public TIRE_SHOP(HasOfferCatalog hasOfferCatalog) {
	...
	public TIRE_SHOP(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public TIRE_SHOP(Identifier identifier) {
	...
	public TIRE_SHOP(IsAccessibleForFree isAccessibleForFree) {
	...
	public TIRE_SHOP(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public TIRE_SHOP(KnowsAbout knowsAbout) {
	...
	public TIRE_SHOP(KnowsLanguage knowsLanguage) {
	...
	public TIRE_SHOP(LegalName legalName) {
	...
	public TIRE_SHOP(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public TIRE_SHOP(Location location) {
	...
	public TIRE_SHOP(MainEntityOfPage mainEntityOfPage) {
	...
	public TIRE_SHOP(MakesOffer makesOffer) {
	...
	public TIRE_SHOP(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public TIRE_SHOP(Member member) {
		setMember(member);
	}
	...
	public TIRE_SHOP(MemberOf memberOf) {
	...
	public TIRE_SHOP(NameFuzzy nameFuzzy) {
	...
	public TIRE_SHOP(NameRuby nameRuby) {
	...
	public TIRE_SHOP(NumberOfEmployees numberOfEmployees) {
	...
	public TIRE_SHOP(OpeningHours openingHours) {
	...
	public TIRE_SHOP(OpeningHoursSpecification openingHoursSpecification) {
	...
	public TIRE_SHOP(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public TIRE_SHOP(ParentOrganization parentOrganization) {
	...
	public TIRE_SHOP(PaymentAccepted paymentAccepted) {
	...
	public TIRE_SHOP(PotentialAction potentialAction) {
	...
	public TIRE_SHOP(PriceRange priceRange) {
	...
	public TIRE_SHOP(PublicAccess publicAccess) {
	...
	public TIRE_SHOP(PublishingPrinciples publishingPrinciples) {
	...
	public TIRE_SHOP(Review review) {
		setReview(review);
	}
	...
	public TIRE_SHOP(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TIRE_SHOP(SmokingAllowed smokingAllowed) {
	...
	public TIRE_SHOP(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public TIRE_SHOP(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public TIRE_SHOP(SubOrganization subOrganization) {
	...
	public TIRE_SHOP(SubjectOf subjectOf) {
	...
	public TIRE_SHOP(Telephone telephone) {
	...
	public TIRE_SHOP(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.TireShop org) {
		setSeq(org.getSeq());
