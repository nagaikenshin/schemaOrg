...
public class BUS_STOP implements Clazz.BusStop {
	...
	public BUS_STOP(Long seq) {
		setSeq(seq);
	}

	public BUS_STOP(String string) {
	...
	public BUS_STOP(AdditionalProperty additionalProperty) {
	...
	public BUS_STOP(AdditionalType additionalType) {
	...
	public BUS_STOP(Address address) {
		setAddress(address);
	}
	...
	public BUS_STOP(AggregateRating aggregateRating) {
	...
	public BUS_STOP(AlternateName alternateName) {
	...
	public BUS_STOP(AmenityFeature amenityFeature) {
	...
	public BUS_STOP(BranchCode branchCode) {
	...
	public BUS_STOP(ContainedInPlace containedInPlace) {
	...
	public BUS_STOP(ContainsPlace containsPlace) {
	...
	public BUS_STOP(Description description) {
	...
	public BUS_STOP(DisambiguatingDescription disambiguatingDescription) {
	...
	public BUS_STOP(FaxNumber faxNumber) {
	...
	public BUS_STOP(GeospatiallyContains geospatiallyContains) {
	...
	public BUS_STOP(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public BUS_STOP(GeospatiallyCovers geospatiallyCovers) {
	...
	public BUS_STOP(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public BUS_STOP(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public BUS_STOP(GeospatiallyEquals geospatiallyEquals) {
	...
	public BUS_STOP(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public BUS_STOP(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public BUS_STOP(GeospatiallyTouches geospatiallyTouches) {
	...
	public BUS_STOP(GeospatiallyWithin geospatiallyWithin) {
	...
	public BUS_STOP(GlobalLocationNumber globalLocationNumber) {
	...
	public BUS_STOP(Identifier identifier) {
	...
	public BUS_STOP(IsAccessibleForFree isAccessibleForFree) {
	...
	public BUS_STOP(MainEntityOfPage mainEntityOfPage) {
	...
	public BUS_STOP(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public BUS_STOP(NameFuzzy nameFuzzy) {
	...
	public BUS_STOP(NameRuby nameRuby) {
	...
	public BUS_STOP(OpeningHours openingHours) {
	...
	public BUS_STOP(OpeningHoursSpecification openingHoursSpecification) {
	...
	public BUS_STOP(PotentialAction potentialAction) {
	...
	public BUS_STOP(PublicAccess publicAccess) {
	...
	public BUS_STOP(SmokingAllowed smokingAllowed) {
	...
	public BUS_STOP(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public BUS_STOP(SubjectOf subjectOf) {
	...
	public BUS_STOP(Telephone telephone) {
	...
	public void copy(Clazz.BusStop org) {
		setSeq(org.getSeq());
