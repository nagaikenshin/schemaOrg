...
public class LESSER_OR_EQUAL implements Container.LesserOrEqual {
	...
	public LESSER_OR_EQUAL(String string) {
	...
	public LESSER_OR_EQUAL(QualitativeValue qualitativeValue) {
		qualitativeValueList = new ArrayList<QualitativeValue>();
