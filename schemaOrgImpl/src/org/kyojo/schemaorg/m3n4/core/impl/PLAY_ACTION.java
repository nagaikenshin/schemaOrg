...
public class PLAY_ACTION implements Clazz.PlayAction {
	...
	public PLAY_ACTION(Long seq) {
		setSeq(seq);
	}

	public PLAY_ACTION(String string) {
	...
	public PLAY_ACTION(ActionStatus actionStatus) {
	...
	public PLAY_ACTION(AdditionalType additionalType) {
	...
	public PLAY_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public PLAY_ACTION(AlternateName alternateName) {
	...
	public PLAY_ACTION(Audience audience) {
	...
	public PLAY_ACTION(Description description) {
	...
	public PLAY_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public PLAY_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public PLAY_ACTION(Error error) {
		setError(error);
	}
	...
	public PLAY_ACTION(Event event) {
		setEvent(event);
	}
	...
	public PLAY_ACTION(Identifier identifier) {
	...
	public PLAY_ACTION(Image image) {
		setImage(image);
	}
	...
	public PLAY_ACTION(Instrument instrument) {
	...
	public PLAY_ACTION(Location location) {
	...
	public PLAY_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public PLAY_ACTION(NameFuzzy nameFuzzy) {
	...
	public PLAY_ACTION(NameRuby nameRuby) {
	...
	public PLAY_ACTION(Object object) {
		setObject(object);
	}
	...
	public PLAY_ACTION(Participant participant) {
	...
	public PLAY_ACTION(PotentialAction potentialAction) {
	...
	public PLAY_ACTION(Result result) {
		setResult(result);
	}
	...
	public PLAY_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PLAY_ACTION(StartTime startTime) {
	...
	public PLAY_ACTION(SubjectOf subjectOf) {
	...
	public PLAY_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.PlayAction org) {
		setSeq(org.getSeq());
