...
public class STEERING_POSITION_VALUE implements Clazz.SteeringPositionValue {
	...
	public STEERING_POSITION_VALUE() {
	}

	public STEERING_POSITION_VALUE(Long seq) {
		setSeq(seq);
	}

	public STEERING_POSITION_VALUE(String string) {
	...
	public STEERING_POSITION_VALUE(AdditionalProperty additionalProperty) {
	...
	public STEERING_POSITION_VALUE(AdditionalType additionalType) {
	...
	public STEERING_POSITION_VALUE(AlternateName alternateName) {
	...
	public STEERING_POSITION_VALUE(Description description) {
	...
	public STEERING_POSITION_VALUE(DisambiguatingDescription disambiguatingDescription) {
	...
	public STEERING_POSITION_VALUE(Equal equal) {
		setEqual(equal);
	}
	...
	public STEERING_POSITION_VALUE(Greater greater) {
		setGreater(greater);
	}
	...
	public STEERING_POSITION_VALUE(GreaterOrEqual greaterOrEqual) {
	...
	public STEERING_POSITION_VALUE(Identifier identifier) {
	...
	public STEERING_POSITION_VALUE(Image image) {
		setImage(image);
	}
	...
	public STEERING_POSITION_VALUE(Lesser lesser) {
		setLesser(lesser);
	}
	...
	public STEERING_POSITION_VALUE(LesserOrEqual lesserOrEqual) {
	...
	public STEERING_POSITION_VALUE(MainEntityOfPage mainEntityOfPage) {
	...
	public STEERING_POSITION_VALUE(Name name) {
		setName(name);
	}
	...
	public STEERING_POSITION_VALUE(NameFuzzy nameFuzzy) {
	...
	public STEERING_POSITION_VALUE(NameRuby nameRuby) {
	...
	public STEERING_POSITION_VALUE(NonEqual nonEqual) {
	...
	public STEERING_POSITION_VALUE(PotentialAction potentialAction) {
	...
	public STEERING_POSITION_VALUE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public STEERING_POSITION_VALUE(SubjectOf subjectOf) {
	...
	public STEERING_POSITION_VALUE(SupersededBy supersededBy) {
	...
	public STEERING_POSITION_VALUE(Url url) {
		setUrl(url);
	}
	...
	public STEERING_POSITION_VALUE(ValueReference valueReference) {
	...
	public void copy(Clazz.SteeringPositionValue org) {
		setSeq(org.getSeq());
