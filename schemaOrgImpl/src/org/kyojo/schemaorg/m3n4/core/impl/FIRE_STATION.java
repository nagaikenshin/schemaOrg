...
public class FIRE_STATION implements Clazz.FireStation {
	...
	public FIRE_STATION(Long seq) {
		setSeq(seq);
	}

	public FIRE_STATION(String string) {
	...
	public FIRE_STATION(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public FIRE_STATION(AdditionalProperty additionalProperty) {
	...
	public FIRE_STATION(AdditionalType additionalType) {
	...
	public FIRE_STATION(Address address) {
		setAddress(address);
	}
	...
	public FIRE_STATION(AggregateRating aggregateRating) {
	...
	public FIRE_STATION(AlternateName alternateName) {
	...
	public FIRE_STATION(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public FIRE_STATION(AmenityFeature amenityFeature) {
	...
	public FIRE_STATION(AreaServed areaServed) {
	...
	public FIRE_STATION(Award award) {
		setAward(award);
	}
	...
	public FIRE_STATION(BranchCode branchCode) {
	...
	public FIRE_STATION(Brand brand) {
		setBrand(brand);
	}
	...
	public FIRE_STATION(ContactPoint contactPoint) {
	...
	public FIRE_STATION(ContainedInPlace containedInPlace) {
	...
	public FIRE_STATION(ContainsPlace containsPlace) {
	...
	public FIRE_STATION(CorrectionsPolicy correctionsPolicy) {
	...
	public FIRE_STATION(CurrenciesAccepted currenciesAccepted) {
	...
	public FIRE_STATION(Department department) {
	...
	public FIRE_STATION(Description description) {
	...
	public FIRE_STATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public FIRE_STATION(DissolutionDate dissolutionDate) {
	...
	public FIRE_STATION(DiversityPolicy diversityPolicy) {
	...
	public FIRE_STATION(DiversityStaffingReport diversityStaffingReport) {
	...
	public FIRE_STATION(Email email) {
		setEmail(email);
	}
	...
	public FIRE_STATION(Employee employee) {
	...
	public FIRE_STATION(EthicsPolicy ethicsPolicy) {
	...
	public FIRE_STATION(Event event) {
		setEvent(event);
	}
	...
	public FIRE_STATION(FaxNumber faxNumber) {
	...
	public FIRE_STATION(Founder founder) {
		setFounder(founder);
	}
	...
	public FIRE_STATION(FoundingDate foundingDate) {
	...
	public FIRE_STATION(FoundingLocation foundingLocation) {
	...
	public FIRE_STATION(Funder funder) {
		setFunder(funder);
	}
	...
	public FIRE_STATION(GeospatiallyContains geospatiallyContains) {
	...
	public FIRE_STATION(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public FIRE_STATION(GeospatiallyCovers geospatiallyCovers) {
	...
	public FIRE_STATION(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public FIRE_STATION(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public FIRE_STATION(GeospatiallyEquals geospatiallyEquals) {
	...
	public FIRE_STATION(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public FIRE_STATION(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public FIRE_STATION(GeospatiallyTouches geospatiallyTouches) {
	...
	public FIRE_STATION(GeospatiallyWithin geospatiallyWithin) {
	...
	public FIRE_STATION(GlobalLocationNumber globalLocationNumber) {
	...
	public FIRE_STATION(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public FIRE_STATION(HasOfferCatalog hasOfferCatalog) {
	...
	public FIRE_STATION(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public FIRE_STATION(Identifier identifier) {
	...
	public FIRE_STATION(Image image) {
		setImage(image);
	}
	...
	public FIRE_STATION(IsAccessibleForFree isAccessibleForFree) {
	...
	public FIRE_STATION(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public FIRE_STATION(KnowsAbout knowsAbout) {
	...
	public FIRE_STATION(KnowsLanguage knowsLanguage) {
	...
	public FIRE_STATION(LegalName legalName) {
	...
	public FIRE_STATION(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public FIRE_STATION(Location location) {
	...
	public FIRE_STATION(MainEntityOfPage mainEntityOfPage) {
	...
	public FIRE_STATION(MakesOffer makesOffer) {
	...
	public FIRE_STATION(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public FIRE_STATION(Member member) {
		setMember(member);
	}
	...
	public FIRE_STATION(MemberOf memberOf) {
	...
	public FIRE_STATION(Naics naics) {
		setNaics(naics);
	}
	...
	public FIRE_STATION(NameFuzzy nameFuzzy) {
	...
	public FIRE_STATION(NameRuby nameRuby) {
	...
	public FIRE_STATION(NumberOfEmployees numberOfEmployees) {
	...
	public FIRE_STATION(OpeningHours openingHours) {
	...
	public FIRE_STATION(OpeningHoursSpecification openingHoursSpecification) {
	...
	public FIRE_STATION(ParentOrganization parentOrganization) {
	...
	public FIRE_STATION(PaymentAccepted paymentAccepted) {
	...
	public FIRE_STATION(Photo photo) {
		setPhoto(photo);
	}
	...
	public FIRE_STATION(PotentialAction potentialAction) {
	...
	public FIRE_STATION(PriceRange priceRange) {
	...
	public FIRE_STATION(PublicAccess publicAccess) {
	...
	public FIRE_STATION(PublishingPrinciples publishingPrinciples) {
	...
	public FIRE_STATION(Review review) {
		setReview(review);
	}
	...
	public FIRE_STATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public FIRE_STATION(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public FIRE_STATION(SmokingAllowed smokingAllowed) {
	...
	public FIRE_STATION(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public FIRE_STATION(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public FIRE_STATION(SubOrganization subOrganization) {
	...
	public FIRE_STATION(SubjectOf subjectOf) {
	...
	public FIRE_STATION(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public FIRE_STATION(Telephone telephone) {
	...
	public FIRE_STATION(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public FIRE_STATION(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.FireStation org) {
		setSeq(org.getSeq());
