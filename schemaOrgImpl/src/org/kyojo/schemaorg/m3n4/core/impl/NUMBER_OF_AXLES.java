...
public class NUMBER_OF_AXLES implements Container.NumberOfAxles {
	...
	public NUMBER_OF_AXLES(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public NUMBER_OF_AXLES(Float fl0at) {
	...
	public NUMBER_OF_AXLES(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public NUMBER_OF_AXLES(Integer integer) {
	...
	public NUMBER_OF_AXLES(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public NUMBER_OF_AXLES(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public NUMBER_OF_AXLES(List<Float> fl0atList,
