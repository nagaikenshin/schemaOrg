...
public class ADULT_ENTERTAINMENT implements Clazz.AdultEntertainment {
	...
	public ADULT_ENTERTAINMENT() {
	}

	public ADULT_ENTERTAINMENT(Long seq) {
		setSeq(seq);
	}

	public ADULT_ENTERTAINMENT(String string) {
	...
	public ADULT_ENTERTAINMENT(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public ADULT_ENTERTAINMENT(AdditionalProperty additionalProperty) {
	...
	public ADULT_ENTERTAINMENT(AdditionalType additionalType) {
	...
	public ADULT_ENTERTAINMENT(Address address) {
		setAddress(address);
	}
	...
	public ADULT_ENTERTAINMENT(AggregateRating aggregateRating) {
	...
	public ADULT_ENTERTAINMENT(AlternateName alternateName) {
	...
	public ADULT_ENTERTAINMENT(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public ADULT_ENTERTAINMENT(AmenityFeature amenityFeature) {
	...
	public ADULT_ENTERTAINMENT(AreaServed areaServed) {
	...
	public ADULT_ENTERTAINMENT(Award award) {
		setAward(award);
	}
	...
	public ADULT_ENTERTAINMENT(BranchCode branchCode) {
	...
	public ADULT_ENTERTAINMENT(Brand brand) {
		setBrand(brand);
	}
	...
	public ADULT_ENTERTAINMENT(ContactPoint contactPoint) {
	...
	public ADULT_ENTERTAINMENT(ContainedInPlace containedInPlace) {
	...
	public ADULT_ENTERTAINMENT(ContainsPlace containsPlace) {
	...
	public ADULT_ENTERTAINMENT(CorrectionsPolicy correctionsPolicy) {
	...
	public ADULT_ENTERTAINMENT(CurrenciesAccepted currenciesAccepted) {
	...
	public ADULT_ENTERTAINMENT(Department department) {
	...
	public ADULT_ENTERTAINMENT(Description description) {
	...
	public ADULT_ENTERTAINMENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public ADULT_ENTERTAINMENT(DissolutionDate dissolutionDate) {
	...
	public ADULT_ENTERTAINMENT(DiversityPolicy diversityPolicy) {
	...
	public ADULT_ENTERTAINMENT(DiversityStaffingReport diversityStaffingReport) {
	...
	public ADULT_ENTERTAINMENT(Duns duns) {
		setDuns(duns);
	}
	...
	public ADULT_ENTERTAINMENT(Email email) {
		setEmail(email);
	}
	...
	public ADULT_ENTERTAINMENT(Employee employee) {
	...
	public ADULT_ENTERTAINMENT(EthicsPolicy ethicsPolicy) {
	...
	public ADULT_ENTERTAINMENT(Event event) {
		setEvent(event);
	}
	...
	public ADULT_ENTERTAINMENT(FaxNumber faxNumber) {
	...
	public ADULT_ENTERTAINMENT(Founder founder) {
		setFounder(founder);
	}
	...
	public ADULT_ENTERTAINMENT(FoundingDate foundingDate) {
	...
	public ADULT_ENTERTAINMENT(FoundingLocation foundingLocation) {
	...
	public ADULT_ENTERTAINMENT(Funder funder) {
		setFunder(funder);
	}
	...
	public ADULT_ENTERTAINMENT(Geo geo) {
		setGeo(geo);
	}
	...
	public ADULT_ENTERTAINMENT(GeospatiallyContains geospatiallyContains) {
	...
	public ADULT_ENTERTAINMENT(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public ADULT_ENTERTAINMENT(GeospatiallyCovers geospatiallyCovers) {
	...
	public ADULT_ENTERTAINMENT(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public ADULT_ENTERTAINMENT(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public ADULT_ENTERTAINMENT(GeospatiallyEquals geospatiallyEquals) {
	...
	public ADULT_ENTERTAINMENT(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public ADULT_ENTERTAINMENT(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public ADULT_ENTERTAINMENT(GeospatiallyTouches geospatiallyTouches) {
	...
	public ADULT_ENTERTAINMENT(GeospatiallyWithin geospatiallyWithin) {
	...
	public ADULT_ENTERTAINMENT(GlobalLocationNumber globalLocationNumber) {
	...
	public ADULT_ENTERTAINMENT(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public ADULT_ENTERTAINMENT(HasOfferCatalog hasOfferCatalog) {
	...
	public ADULT_ENTERTAINMENT(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public ADULT_ENTERTAINMENT(Identifier identifier) {
	...
	public ADULT_ENTERTAINMENT(Image image) {
		setImage(image);
	}
	...
	public ADULT_ENTERTAINMENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public ADULT_ENTERTAINMENT(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public ADULT_ENTERTAINMENT(KnowsAbout knowsAbout) {
	...
	public ADULT_ENTERTAINMENT(KnowsLanguage knowsLanguage) {
	...
	public ADULT_ENTERTAINMENT(LegalName legalName) {
	...
	public ADULT_ENTERTAINMENT(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public ADULT_ENTERTAINMENT(Location location) {
	...
	public ADULT_ENTERTAINMENT(Logo logo) {
		setLogo(logo);
	}
	...
	public ADULT_ENTERTAINMENT(MainEntityOfPage mainEntityOfPage) {
	...
	public ADULT_ENTERTAINMENT(MakesOffer makesOffer) {
	...
	public ADULT_ENTERTAINMENT(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public ADULT_ENTERTAINMENT(Member member) {
		setMember(member);
	}
	...
	public ADULT_ENTERTAINMENT(MemberOf memberOf) {
	...
	public ADULT_ENTERTAINMENT(Naics naics) {
		setNaics(naics);
	}
	...
	public ADULT_ENTERTAINMENT(Name name) {
		setName(name);
	}
	...
	public ADULT_ENTERTAINMENT(NameFuzzy nameFuzzy) {
	...
	public ADULT_ENTERTAINMENT(NameRuby nameRuby) {
	...
	public ADULT_ENTERTAINMENT(NumberOfEmployees numberOfEmployees) {
	...
	public ADULT_ENTERTAINMENT(OpeningHours openingHours) {
	...
	public ADULT_ENTERTAINMENT(OpeningHoursSpecification openingHoursSpecification) {
	...
	public ADULT_ENTERTAINMENT(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public ADULT_ENTERTAINMENT(Owns owns) {
		setOwns(owns);
	}
	...
	public ADULT_ENTERTAINMENT(ParentOrganization parentOrganization) {
	...
	public ADULT_ENTERTAINMENT(PaymentAccepted paymentAccepted) {
	...
	public ADULT_ENTERTAINMENT(Photo photo) {
		setPhoto(photo);
	}
	...
	public ADULT_ENTERTAINMENT(PotentialAction potentialAction) {
	...
	public ADULT_ENTERTAINMENT(PriceRange priceRange) {
	...
	public ADULT_ENTERTAINMENT(PublicAccess publicAccess) {
	...
	public ADULT_ENTERTAINMENT(PublishingPrinciples publishingPrinciples) {
	...
	public ADULT_ENTERTAINMENT(Review review) {
		setReview(review);
	}
	...
	public ADULT_ENTERTAINMENT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ADULT_ENTERTAINMENT(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public ADULT_ENTERTAINMENT(SmokingAllowed smokingAllowed) {
	...
	public ADULT_ENTERTAINMENT(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public ADULT_ENTERTAINMENT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public ADULT_ENTERTAINMENT(SubOrganization subOrganization) {
	...
	public ADULT_ENTERTAINMENT(SubjectOf subjectOf) {
	...
	public ADULT_ENTERTAINMENT(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public ADULT_ENTERTAINMENT(Telephone telephone) {
	...
	public ADULT_ENTERTAINMENT(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public ADULT_ENTERTAINMENT(Url url) {
		setUrl(url);
	}
	...
	public ADULT_ENTERTAINMENT(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.AdultEntertainment org) {
		setSeq(org.getSeq());
