...
public class LANDMARKS_OR_HISTORICAL_BUILDINGS implements Clazz.LandmarksOrHistoricalBuildings {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS() {
	}

	public LANDMARKS_OR_HISTORICAL_BUILDINGS(Long seq) {
		setSeq(seq);
	}

	public LANDMARKS_OR_HISTORICAL_BUILDINGS(String string) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(AdditionalProperty additionalProperty) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(AdditionalType additionalType) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(Address address) {
		setAddress(address);
	}
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(AggregateRating aggregateRating) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(AlternateName alternateName) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(AmenityFeature amenityFeature) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(BranchCode branchCode) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(ContainedInPlace containedInPlace) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(ContainsPlace containsPlace) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(Description description) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(DisambiguatingDescription disambiguatingDescription) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(Event event) {
		setEvent(event);
	}
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(FaxNumber faxNumber) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(Geo geo) {
		setGeo(geo);
	}
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(GeospatiallyContains geospatiallyContains) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(GeospatiallyCovers geospatiallyCovers) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(GeospatiallyEquals geospatiallyEquals) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(GeospatiallyTouches geospatiallyTouches) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(GeospatiallyWithin geospatiallyWithin) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(GlobalLocationNumber globalLocationNumber) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(Identifier identifier) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(Image image) {
		setImage(image);
	}
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(IsAccessibleForFree isAccessibleForFree) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(Logo logo) {
		setLogo(logo);
	}
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(MainEntityOfPage mainEntityOfPage) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(Name name) {
		setName(name);
	}
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(NameFuzzy nameFuzzy) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(NameRuby nameRuby) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(OpeningHoursSpecification openingHoursSpecification) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(Photo photo) {
		setPhoto(photo);
	}
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(PotentialAction potentialAction) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(PublicAccess publicAccess) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(Review review) {
		setReview(review);
	}
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(SmokingAllowed smokingAllowed) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(SubjectOf subjectOf) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(Telephone telephone) {
	...
	public LANDMARKS_OR_HISTORICAL_BUILDINGS(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.LandmarksOrHistoricalBuildings org) {
		setSeq(org.getSeq());
