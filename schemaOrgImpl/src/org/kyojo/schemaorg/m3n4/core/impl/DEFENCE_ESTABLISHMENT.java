...
public class DEFENCE_ESTABLISHMENT implements Clazz.DefenceEstablishment {
	...
	public DEFENCE_ESTABLISHMENT() {
	}

	public DEFENCE_ESTABLISHMENT(Long seq) {
		setSeq(seq);
	}

	public DEFENCE_ESTABLISHMENT(String string) {
	...
	public DEFENCE_ESTABLISHMENT(AdditionalProperty additionalProperty) {
	...
	public DEFENCE_ESTABLISHMENT(AdditionalType additionalType) {
	...
	public DEFENCE_ESTABLISHMENT(Address address) {
		setAddress(address);
	}
	...
	public DEFENCE_ESTABLISHMENT(AggregateRating aggregateRating) {
	...
	public DEFENCE_ESTABLISHMENT(AlternateName alternateName) {
	...
	public DEFENCE_ESTABLISHMENT(AmenityFeature amenityFeature) {
	...
	public DEFENCE_ESTABLISHMENT(BranchCode branchCode) {
	...
	public DEFENCE_ESTABLISHMENT(ContainedInPlace containedInPlace) {
	...
	public DEFENCE_ESTABLISHMENT(ContainsPlace containsPlace) {
	...
	public DEFENCE_ESTABLISHMENT(Description description) {
	...
	public DEFENCE_ESTABLISHMENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public DEFENCE_ESTABLISHMENT(Event event) {
		setEvent(event);
	}
	...
	public DEFENCE_ESTABLISHMENT(FaxNumber faxNumber) {
	...
	public DEFENCE_ESTABLISHMENT(Geo geo) {
		setGeo(geo);
	}
	...
	public DEFENCE_ESTABLISHMENT(GeospatiallyContains geospatiallyContains) {
	...
	public DEFENCE_ESTABLISHMENT(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public DEFENCE_ESTABLISHMENT(GeospatiallyCovers geospatiallyCovers) {
	...
	public DEFENCE_ESTABLISHMENT(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public DEFENCE_ESTABLISHMENT(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public DEFENCE_ESTABLISHMENT(GeospatiallyEquals geospatiallyEquals) {
	...
	public DEFENCE_ESTABLISHMENT(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public DEFENCE_ESTABLISHMENT(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public DEFENCE_ESTABLISHMENT(GeospatiallyTouches geospatiallyTouches) {
	...
	public DEFENCE_ESTABLISHMENT(GeospatiallyWithin geospatiallyWithin) {
	...
	public DEFENCE_ESTABLISHMENT(GlobalLocationNumber globalLocationNumber) {
	...
	public DEFENCE_ESTABLISHMENT(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public DEFENCE_ESTABLISHMENT(Identifier identifier) {
	...
	public DEFENCE_ESTABLISHMENT(Image image) {
		setImage(image);
	}
	...
	public DEFENCE_ESTABLISHMENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public DEFENCE_ESTABLISHMENT(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public DEFENCE_ESTABLISHMENT(Logo logo) {
		setLogo(logo);
	}
	...
	public DEFENCE_ESTABLISHMENT(MainEntityOfPage mainEntityOfPage) {
	...
	public DEFENCE_ESTABLISHMENT(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public DEFENCE_ESTABLISHMENT(Name name) {
		setName(name);
	}
	...
	public DEFENCE_ESTABLISHMENT(NameFuzzy nameFuzzy) {
	...
	public DEFENCE_ESTABLISHMENT(NameRuby nameRuby) {
	...
	public DEFENCE_ESTABLISHMENT(OpeningHours openingHours) {
	...
	public DEFENCE_ESTABLISHMENT(OpeningHoursSpecification openingHoursSpecification) {
	...
	public DEFENCE_ESTABLISHMENT(Photo photo) {
		setPhoto(photo);
	}
	...
	public DEFENCE_ESTABLISHMENT(PotentialAction potentialAction) {
	...
	public DEFENCE_ESTABLISHMENT(PublicAccess publicAccess) {
	...
	public DEFENCE_ESTABLISHMENT(Review review) {
		setReview(review);
	}
	...
	public DEFENCE_ESTABLISHMENT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DEFENCE_ESTABLISHMENT(SmokingAllowed smokingAllowed) {
	...
	public DEFENCE_ESTABLISHMENT(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public DEFENCE_ESTABLISHMENT(SubjectOf subjectOf) {
	...
	public DEFENCE_ESTABLISHMENT(Telephone telephone) {
	...
	public DEFENCE_ESTABLISHMENT(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.DefenceEstablishment org) {
		setSeq(org.getSeq());
