...
public class HAIR_SALON implements Clazz.HairSalon {
	...
	public HAIR_SALON(Long seq) {
		setSeq(seq);
	}

	public HAIR_SALON(String string) {
	...
	public HAIR_SALON(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public HAIR_SALON(AdditionalProperty additionalProperty) {
	...
	public HAIR_SALON(AdditionalType additionalType) {
	...
	public HAIR_SALON(Address address) {
		setAddress(address);
	}
	...
	public HAIR_SALON(AggregateRating aggregateRating) {
	...
	public HAIR_SALON(AlternateName alternateName) {
	...
	public HAIR_SALON(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public HAIR_SALON(AmenityFeature amenityFeature) {
	...
	public HAIR_SALON(AreaServed areaServed) {
	...
	public HAIR_SALON(BranchCode branchCode) {
	...
	public HAIR_SALON(ContactPoint contactPoint) {
	...
	public HAIR_SALON(ContainedInPlace containedInPlace) {
	...
	public HAIR_SALON(ContainsPlace containsPlace) {
	...
	public HAIR_SALON(CorrectionsPolicy correctionsPolicy) {
	...
	public HAIR_SALON(CurrenciesAccepted currenciesAccepted) {
	...
	public HAIR_SALON(Department department) {
	...
	public HAIR_SALON(Description description) {
	...
	public HAIR_SALON(DisambiguatingDescription disambiguatingDescription) {
	...
	public HAIR_SALON(DissolutionDate dissolutionDate) {
	...
	public HAIR_SALON(DiversityPolicy diversityPolicy) {
	...
	public HAIR_SALON(DiversityStaffingReport diversityStaffingReport) {
	...
	public HAIR_SALON(Employee employee) {
	...
	public HAIR_SALON(EthicsPolicy ethicsPolicy) {
	...
	public HAIR_SALON(FaxNumber faxNumber) {
	...
	public HAIR_SALON(Founder founder) {
		setFounder(founder);
	}
	...
	public HAIR_SALON(FoundingDate foundingDate) {
	...
	public HAIR_SALON(FoundingLocation foundingLocation) {
	...
	public HAIR_SALON(Funder funder) {
		setFunder(funder);
	}
	...
	public HAIR_SALON(GeospatiallyContains geospatiallyContains) {
	...
	public HAIR_SALON(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public HAIR_SALON(GeospatiallyCovers geospatiallyCovers) {
	...
	public HAIR_SALON(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public HAIR_SALON(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public HAIR_SALON(GeospatiallyEquals geospatiallyEquals) {
	...
	public HAIR_SALON(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public HAIR_SALON(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public HAIR_SALON(GeospatiallyTouches geospatiallyTouches) {
	...
	public HAIR_SALON(GeospatiallyWithin geospatiallyWithin) {
	...
	public HAIR_SALON(GlobalLocationNumber globalLocationNumber) {
	...
	public HAIR_SALON(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public HAIR_SALON(HasOfferCatalog hasOfferCatalog) {
	...
	public HAIR_SALON(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public HAIR_SALON(Identifier identifier) {
	...
	public HAIR_SALON(IsAccessibleForFree isAccessibleForFree) {
	...
	public HAIR_SALON(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public HAIR_SALON(KnowsAbout knowsAbout) {
	...
	public HAIR_SALON(KnowsLanguage knowsLanguage) {
	...
	public HAIR_SALON(LegalName legalName) {
	...
	public HAIR_SALON(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public HAIR_SALON(Location location) {
	...
	public HAIR_SALON(MainEntityOfPage mainEntityOfPage) {
	...
	public HAIR_SALON(MakesOffer makesOffer) {
	...
	public HAIR_SALON(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public HAIR_SALON(Member member) {
		setMember(member);
	}
	...
	public HAIR_SALON(MemberOf memberOf) {
	...
	public HAIR_SALON(NameFuzzy nameFuzzy) {
	...
	public HAIR_SALON(NameRuby nameRuby) {
	...
	public HAIR_SALON(NumberOfEmployees numberOfEmployees) {
	...
	public HAIR_SALON(OpeningHours openingHours) {
	...
	public HAIR_SALON(OpeningHoursSpecification openingHoursSpecification) {
	...
	public HAIR_SALON(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public HAIR_SALON(ParentOrganization parentOrganization) {
	...
	public HAIR_SALON(PaymentAccepted paymentAccepted) {
	...
	public HAIR_SALON(PotentialAction potentialAction) {
	...
	public HAIR_SALON(PriceRange priceRange) {
	...
	public HAIR_SALON(PublicAccess publicAccess) {
	...
	public HAIR_SALON(PublishingPrinciples publishingPrinciples) {
	...
	public HAIR_SALON(Review review) {
		setReview(review);
	}
	...
	public HAIR_SALON(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public HAIR_SALON(SmokingAllowed smokingAllowed) {
	...
	public HAIR_SALON(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public HAIR_SALON(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public HAIR_SALON(SubOrganization subOrganization) {
	...
	public HAIR_SALON(SubjectOf subjectOf) {
	...
	public HAIR_SALON(Telephone telephone) {
	...
	public HAIR_SALON(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.HairSalon org) {
		setSeq(org.getSeq());
