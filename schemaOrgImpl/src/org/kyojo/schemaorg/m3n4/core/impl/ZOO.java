...
public class ZOO implements Clazz.Zoo {
	...
	public ZOO(AdditionalProperty additionalProperty) {
	...
	public ZOO(AdditionalType additionalType) {
	...
	public ZOO(AggregateRating aggregateRating) {
	...
	public ZOO(AlternateName alternateName) {
	...
	public ZOO(AmenityFeature amenityFeature) {
	...
	public ZOO(BranchCode branchCode) {
	...
	public ZOO(ContainedInPlace containedInPlace) {
	...
	public ZOO(ContainsPlace containsPlace) {
	...
	public ZOO(Description description) {
	...
	public ZOO(DisambiguatingDescription disambiguatingDescription) {
	...
	public ZOO(FaxNumber faxNumber) {
	...
	public ZOO(GeospatiallyContains geospatiallyContains) {
	...
	public ZOO(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public ZOO(GeospatiallyCovers geospatiallyCovers) {
	...
	public ZOO(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public ZOO(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public ZOO(GeospatiallyEquals geospatiallyEquals) {
	...
	public ZOO(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public ZOO(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public ZOO(GeospatiallyTouches geospatiallyTouches) {
	...
	public ZOO(GeospatiallyWithin geospatiallyWithin) {
	...
	public ZOO(GlobalLocationNumber globalLocationNumber) {
	...
	public ZOO(Identifier identifier) {
	...
	public ZOO(IsAccessibleForFree isAccessibleForFree) {
	...
	public ZOO(MainEntityOfPage mainEntityOfPage) {
	...
	public ZOO(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public ZOO(NameFuzzy nameFuzzy) {
	...
	public ZOO(OpeningHours openingHours) {
	...
	public ZOO(OpeningHoursSpecification openingHoursSpecification) {
	...
	public ZOO(PotentialAction potentialAction) {
	...
	public ZOO(PublicAccess publicAccess) {
	...
	public ZOO(SmokingAllowed smokingAllowed) {
	...
	public ZOO(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public ZOO(SubjectOf subjectOf) {
	...
	public ZOO(Telephone telephone) {
	...
	public void copy(Clazz.Zoo org) {
		setSeq(org.getSeq());
