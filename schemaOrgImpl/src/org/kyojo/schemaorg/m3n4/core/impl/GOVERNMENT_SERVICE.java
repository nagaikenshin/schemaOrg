...
import org.kyojo.schemaorg.m3n4.core.Container.ServiceOperator;
...
public class GOVERNMENT_SERVICE implements Clazz.GovernmentService {
	...
	public GOVERNMENT_SERVICE(Long seq) {
		setSeq(seq);
	}

	public GOVERNMENT_SERVICE(String string) {
	...
	public GOVERNMENT_SERVICE(AdditionalType additionalType) {
	...
	public GOVERNMENT_SERVICE(AggregateRating aggregateRating) {
	...
	public GOVERNMENT_SERVICE(AlternateName alternateName) {
	...
	public GOVERNMENT_SERVICE(AreaServed areaServed) {
	...
	public GOVERNMENT_SERVICE(Audience audience) {
	...
	public GOVERNMENT_SERVICE(AvailableChannel availableChannel) {
	...
	public GOVERNMENT_SERVICE(Award award) {
		setAward(award);
	}
	...
	public GOVERNMENT_SERVICE(Brand brand) {
		setBrand(brand);
	}
	...
	public GOVERNMENT_SERVICE(Broker broker) {
		setBroker(broker);
	}
	...
	public GOVERNMENT_SERVICE(Category category) {
	...
	public GOVERNMENT_SERVICE(Description description) {
	...
	public GOVERNMENT_SERVICE(DisambiguatingDescription disambiguatingDescription) {
	...
	public GOVERNMENT_SERVICE(HasOfferCatalog hasOfferCatalog) {
	...
	public GOVERNMENT_SERVICE(HoursAvailable hoursAvailable) {
	...
	public GOVERNMENT_SERVICE(Identifier identifier) {
	...
	public GOVERNMENT_SERVICE(Image image) {
		setImage(image);
	}
	...
	public GOVERNMENT_SERVICE(IsRelatedTo isRelatedTo) {
	...
	public GOVERNMENT_SERVICE(IsSimilarTo isSimilarTo) {
	...
	public GOVERNMENT_SERVICE(Logo logo) {
		setLogo(logo);
	}
	...
	public GOVERNMENT_SERVICE(MainEntityOfPage mainEntityOfPage) {
	...
	public GOVERNMENT_SERVICE(Name name) {
		setName(name);
	}
	...
	public GOVERNMENT_SERVICE(NameFuzzy nameFuzzy) {
	...
	public GOVERNMENT_SERVICE(NameRuby nameRuby) {
	...
	public GOVERNMENT_SERVICE(Offers offers) {
		setOffers(offers);
	}
	...
	public GOVERNMENT_SERVICE(PotentialAction potentialAction) {
	...
	public GOVERNMENT_SERVICE(Provider provider) {
	...
	public GOVERNMENT_SERVICE(ProviderMobility providerMobility) {
	...
	public GOVERNMENT_SERVICE(Review review) {
		setReview(review);
	}
	...
	public GOVERNMENT_SERVICE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public GOVERNMENT_SERVICE(ServiceOperator serviceOperator) {
		setServiceOperator(serviceOperator);
	}
	...
	public GOVERNMENT_SERVICE(ServiceOutput serviceOutput) {
	...
	public GOVERNMENT_SERVICE(ServiceType serviceType) {
	...
	public GOVERNMENT_SERVICE(SubjectOf subjectOf) {
	...
	public GOVERNMENT_SERVICE(TermsOfService termsOfService) {
	...
	public GOVERNMENT_SERVICE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.GovernmentService org) {
		setSeq(org.getSeq());
		...
		setServiceOperator(org.getServiceOperator());
