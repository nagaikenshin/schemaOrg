...
public class DAY_SPA implements Clazz.DaySpa {
	...
	public DAY_SPA(Long seq) {
		setSeq(seq);
	}

	public DAY_SPA(String string) {
	...
	public DAY_SPA(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public DAY_SPA(AdditionalProperty additionalProperty) {
	...
	public DAY_SPA(AdditionalType additionalType) {
	...
	public DAY_SPA(Address address) {
		setAddress(address);
	}
	...
	public DAY_SPA(AggregateRating aggregateRating) {
	...
	public DAY_SPA(AlternateName alternateName) {
	...
	public DAY_SPA(AmenityFeature amenityFeature) {
	...
	public DAY_SPA(AreaServed areaServed) {
	...
	public DAY_SPA(BranchCode branchCode) {
	...
	public DAY_SPA(ContactPoint contactPoint) {
	...
	public DAY_SPA(ContainedInPlace containedInPlace) {
	...
	public DAY_SPA(ContainsPlace containsPlace) {
	...
	public DAY_SPA(CorrectionsPolicy correctionsPolicy) {
	...
	public DAY_SPA(CurrenciesAccepted currenciesAccepted) {
	...
	public DAY_SPA(Department department) {
	...
	public DAY_SPA(Description description) {
	...
	public DAY_SPA(DisambiguatingDescription disambiguatingDescription) {
	...
	public DAY_SPA(DissolutionDate dissolutionDate) {
	...
	public DAY_SPA(DiversityPolicy diversityPolicy) {
	...
	public DAY_SPA(DiversityStaffingReport diversityStaffingReport) {
	...
	public DAY_SPA(Employee employee) {
	...
	public DAY_SPA(EthicsPolicy ethicsPolicy) {
	...
	public DAY_SPA(FaxNumber faxNumber) {
	...
	public DAY_SPA(Founder founder) {
		setFounder(founder);
	}
	...
	public DAY_SPA(FoundingDate foundingDate) {
	...
	public DAY_SPA(FoundingLocation foundingLocation) {
	...
	public DAY_SPA(GeospatiallyContains geospatiallyContains) {
	...
	public DAY_SPA(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public DAY_SPA(GeospatiallyCovers geospatiallyCovers) {
	...
	public DAY_SPA(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public DAY_SPA(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public DAY_SPA(GeospatiallyEquals geospatiallyEquals) {
	...
	public DAY_SPA(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public DAY_SPA(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public DAY_SPA(GeospatiallyTouches geospatiallyTouches) {
	...
	public DAY_SPA(GeospatiallyWithin geospatiallyWithin) {
	...
	public DAY_SPA(GlobalLocationNumber globalLocationNumber) {
	...
	public DAY_SPA(HasOfferCatalog hasOfferCatalog) {
	...
	public DAY_SPA(Identifier identifier) {
	...
	public DAY_SPA(IsAccessibleForFree isAccessibleForFree) {
	...
	public DAY_SPA(KnowsAbout knowsAbout) {
	...
	public DAY_SPA(KnowsLanguage knowsLanguage) {
	...
	public DAY_SPA(LegalName legalName) {
	...
	public DAY_SPA(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public DAY_SPA(Location location) {
	...
	public DAY_SPA(MainEntityOfPage mainEntityOfPage) {
	...
	public DAY_SPA(MakesOffer makesOffer) {
	...
	public DAY_SPA(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public DAY_SPA(MemberOf memberOf) {
	...
	public DAY_SPA(NameFuzzy nameFuzzy) {
	...
	public DAY_SPA(NameRuby nameRuby) {
	...
	public DAY_SPA(NumberOfEmployees numberOfEmployees) {
	...
	public DAY_SPA(OpeningHours openingHours) {
	...
	public DAY_SPA(OpeningHoursSpecification openingHoursSpecification) {
	...
	public DAY_SPA(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public DAY_SPA(ParentOrganization parentOrganization) {
	...
	public DAY_SPA(PaymentAccepted paymentAccepted) {
	...
	public DAY_SPA(PotentialAction potentialAction) {
	...
	public DAY_SPA(PriceRange priceRange) {
	...
	public DAY_SPA(PublicAccess publicAccess) {
	...
	public DAY_SPA(PublishingPrinciples publishingPrinciples) {
	...
	public DAY_SPA(SmokingAllowed smokingAllowed) {
	...
	public DAY_SPA(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public DAY_SPA(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public DAY_SPA(SubOrganization subOrganization) {
	...
	public DAY_SPA(SubjectOf subjectOf) {
	...
	public DAY_SPA(Telephone telephone) {
	...
	public DAY_SPA(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.DaySpa org) {
		setSeq(org.getSeq());
