...
public class OCEAN_BODY_OF_WATER implements Clazz.OceanBodyOfWater {
	...
	public OCEAN_BODY_OF_WATER() {
	}

	public OCEAN_BODY_OF_WATER(Long seq) {
		setSeq(seq);
	}

	public OCEAN_BODY_OF_WATER(String string) {
	...
	public OCEAN_BODY_OF_WATER(AdditionalProperty additionalProperty) {
	...
	public OCEAN_BODY_OF_WATER(AdditionalType additionalType) {
	...
	public OCEAN_BODY_OF_WATER(Address address) {
		setAddress(address);
	}
	...
	public OCEAN_BODY_OF_WATER(AggregateRating aggregateRating) {
	...
	public OCEAN_BODY_OF_WATER(AlternateName alternateName) {
	...
	public OCEAN_BODY_OF_WATER(AmenityFeature amenityFeature) {
	...
	public OCEAN_BODY_OF_WATER(BranchCode branchCode) {
	...
	public OCEAN_BODY_OF_WATER(ContainedInPlace containedInPlace) {
	...
	public OCEAN_BODY_OF_WATER(ContainsPlace containsPlace) {
	...
	public OCEAN_BODY_OF_WATER(Description description) {
	...
	public OCEAN_BODY_OF_WATER(DisambiguatingDescription disambiguatingDescription) {
	...
	public OCEAN_BODY_OF_WATER(Event event) {
		setEvent(event);
	}
	...
	public OCEAN_BODY_OF_WATER(FaxNumber faxNumber) {
	...
	public OCEAN_BODY_OF_WATER(Geo geo) {
		setGeo(geo);
	}
	...
	public OCEAN_BODY_OF_WATER(GeospatiallyContains geospatiallyContains) {
	...
	public OCEAN_BODY_OF_WATER(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public OCEAN_BODY_OF_WATER(GeospatiallyCovers geospatiallyCovers) {
	...
	public OCEAN_BODY_OF_WATER(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public OCEAN_BODY_OF_WATER(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public OCEAN_BODY_OF_WATER(GeospatiallyEquals geospatiallyEquals) {
	...
	public OCEAN_BODY_OF_WATER(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public OCEAN_BODY_OF_WATER(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public OCEAN_BODY_OF_WATER(GeospatiallyTouches geospatiallyTouches) {
	...
	public OCEAN_BODY_OF_WATER(GeospatiallyWithin geospatiallyWithin) {
	...
	public OCEAN_BODY_OF_WATER(GlobalLocationNumber globalLocationNumber) {
	...
	public OCEAN_BODY_OF_WATER(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public OCEAN_BODY_OF_WATER(Identifier identifier) {
	...
	public OCEAN_BODY_OF_WATER(Image image) {
		setImage(image);
	}
	...
	public OCEAN_BODY_OF_WATER(IsAccessibleForFree isAccessibleForFree) {
	...
	public OCEAN_BODY_OF_WATER(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public OCEAN_BODY_OF_WATER(Logo logo) {
		setLogo(logo);
	}
	...
	public OCEAN_BODY_OF_WATER(MainEntityOfPage mainEntityOfPage) {
	...
	public OCEAN_BODY_OF_WATER(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public OCEAN_BODY_OF_WATER(Name name) {
		setName(name);
	}
	...
	public OCEAN_BODY_OF_WATER(NameFuzzy nameFuzzy) {
	...
	public OCEAN_BODY_OF_WATER(NameRuby nameRuby) {
	...
	public OCEAN_BODY_OF_WATER(OpeningHoursSpecification openingHoursSpecification) {
	...
	public OCEAN_BODY_OF_WATER(Photo photo) {
		setPhoto(photo);
	}
	...
	public OCEAN_BODY_OF_WATER(PotentialAction potentialAction) {
	...
	public OCEAN_BODY_OF_WATER(PublicAccess publicAccess) {
	...
	public OCEAN_BODY_OF_WATER(Review review) {
		setReview(review);
	}
	...
	public OCEAN_BODY_OF_WATER(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public OCEAN_BODY_OF_WATER(SmokingAllowed smokingAllowed) {
	...
	public OCEAN_BODY_OF_WATER(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public OCEAN_BODY_OF_WATER(SubjectOf subjectOf) {
	...
	public OCEAN_BODY_OF_WATER(Telephone telephone) {
	...
	public OCEAN_BODY_OF_WATER(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.OceanBodyOfWater org) {
		setSeq(org.getSeq());
