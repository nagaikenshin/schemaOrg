...
public class LIQUOR_STORE implements Clazz.LiquorStore {
	...
	public LIQUOR_STORE(Long seq) {
		setSeq(seq);
	}

	public LIQUOR_STORE(String string) {
	...
	public LIQUOR_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public LIQUOR_STORE(AdditionalProperty additionalProperty) {
	...
	public LIQUOR_STORE(AdditionalType additionalType) {
	...
	public LIQUOR_STORE(Address address) {
		setAddress(address);
	}
	...
	public LIQUOR_STORE(AggregateRating aggregateRating) {
	...
	public LIQUOR_STORE(AlternateName alternateName) {
	...
	public LIQUOR_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public LIQUOR_STORE(AmenityFeature amenityFeature) {
	...
	public LIQUOR_STORE(AreaServed areaServed) {
	...
	public LIQUOR_STORE(Award award) {
		setAward(award);
	}
	...
	public LIQUOR_STORE(BranchCode branchCode) {
	...
	public LIQUOR_STORE(Brand brand) {
		setBrand(brand);
	}
	...
	public LIQUOR_STORE(ContactPoint contactPoint) {
	...
	public LIQUOR_STORE(ContainedInPlace containedInPlace) {
	...
	public LIQUOR_STORE(ContainsPlace containsPlace) {
	...
	public LIQUOR_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public LIQUOR_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public LIQUOR_STORE(Department department) {
	...
	public LIQUOR_STORE(Description description) {
	...
	public LIQUOR_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public LIQUOR_STORE(DissolutionDate dissolutionDate) {
	...
	public LIQUOR_STORE(DiversityPolicy diversityPolicy) {
	...
	public LIQUOR_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public LIQUOR_STORE(Email email) {
		setEmail(email);
	}
	...
	public LIQUOR_STORE(Employee employee) {
	...
	public LIQUOR_STORE(EthicsPolicy ethicsPolicy) {
	...
	public LIQUOR_STORE(Event event) {
		setEvent(event);
	}
	...
	public LIQUOR_STORE(FaxNumber faxNumber) {
	...
	public LIQUOR_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public LIQUOR_STORE(FoundingDate foundingDate) {
	...
	public LIQUOR_STORE(FoundingLocation foundingLocation) {
	...
	public LIQUOR_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public LIQUOR_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public LIQUOR_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public LIQUOR_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public LIQUOR_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public LIQUOR_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public LIQUOR_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public LIQUOR_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public LIQUOR_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public LIQUOR_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public LIQUOR_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public LIQUOR_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public LIQUOR_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public LIQUOR_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public LIQUOR_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public LIQUOR_STORE(Identifier identifier) {
	...
	public LIQUOR_STORE(Image image) {
		setImage(image);
	}
	...
	public LIQUOR_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public LIQUOR_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public LIQUOR_STORE(KnowsAbout knowsAbout) {
	...
	public LIQUOR_STORE(KnowsLanguage knowsLanguage) {
	...
	public LIQUOR_STORE(LegalName legalName) {
	...
	public LIQUOR_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public LIQUOR_STORE(Location location) {
	...
	public LIQUOR_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public LIQUOR_STORE(MakesOffer makesOffer) {
	...
	public LIQUOR_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public LIQUOR_STORE(Member member) {
		setMember(member);
	}
	...
	public LIQUOR_STORE(MemberOf memberOf) {
	...
	public LIQUOR_STORE(Naics naics) {
		setNaics(naics);
	}
	...
	public LIQUOR_STORE(NameFuzzy nameFuzzy) {
	...
	public LIQUOR_STORE(NameRuby nameRuby) {
	...
	public LIQUOR_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public LIQUOR_STORE(OpeningHours openingHours) {
	...
	public LIQUOR_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public LIQUOR_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public LIQUOR_STORE(ParentOrganization parentOrganization) {
	...
	public LIQUOR_STORE(PaymentAccepted paymentAccepted) {
	...
	public LIQUOR_STORE(Photo photo) {
		setPhoto(photo);
	}
	...
	public LIQUOR_STORE(PotentialAction potentialAction) {
	...
	public LIQUOR_STORE(PriceRange priceRange) {
	...
	public LIQUOR_STORE(PublicAccess publicAccess) {
	...
	public LIQUOR_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public LIQUOR_STORE(Review review) {
		setReview(review);
	}
	...
	public LIQUOR_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public LIQUOR_STORE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public LIQUOR_STORE(SmokingAllowed smokingAllowed) {
	...
	public LIQUOR_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public LIQUOR_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public LIQUOR_STORE(SubOrganization subOrganization) {
	...
	public LIQUOR_STORE(SubjectOf subjectOf) {
	...
	public LIQUOR_STORE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public LIQUOR_STORE(Telephone telephone) {
	...
	public LIQUOR_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public LIQUOR_STORE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.LiquorStore org) {
		setSeq(org.getSeq());
