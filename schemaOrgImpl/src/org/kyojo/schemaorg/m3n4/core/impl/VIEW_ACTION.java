...
public class VIEW_ACTION implements Clazz.ViewAction {
	...
	public VIEW_ACTION(Long seq) {
		setSeq(seq);
	}

	public VIEW_ACTION(String string) {
	...
	public VIEW_ACTION(ActionAccessibilityRequirement actionAccessibilityRequirement) {
	...
	public VIEW_ACTION(ActionStatus actionStatus) {
	...
	public VIEW_ACTION(AdditionalType additionalType) {
	...
	public VIEW_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public VIEW_ACTION(AlternateName alternateName) {
	...
	public VIEW_ACTION(Description description) {
	...
	public VIEW_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public VIEW_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public VIEW_ACTION(Error error) {
		setError(error);
	}
	...
	public VIEW_ACTION(ExpectsAcceptanceOf expectsAcceptanceOf) {
	...
	public VIEW_ACTION(Identifier identifier) {
	...
	public VIEW_ACTION(Image image) {
		setImage(image);
	}
	...
	public VIEW_ACTION(Instrument instrument) {
	...
	public VIEW_ACTION(Location location) {
	...
	public VIEW_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public VIEW_ACTION(NameFuzzy nameFuzzy) {
	...
	public VIEW_ACTION(NameRuby nameRuby) {
	...
	public VIEW_ACTION(Object object) {
		setObject(object);
	}
	...
	public VIEW_ACTION(Participant participant) {
	...
	public VIEW_ACTION(PotentialAction potentialAction) {
	...
	public VIEW_ACTION(Result result) {
		setResult(result);
	}
	...
	public VIEW_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public VIEW_ACTION(StartTime startTime) {
	...
	public VIEW_ACTION(SubjectOf subjectOf) {
	...
	public VIEW_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.ViewAction org) {
		setSeq(org.getSeq());
