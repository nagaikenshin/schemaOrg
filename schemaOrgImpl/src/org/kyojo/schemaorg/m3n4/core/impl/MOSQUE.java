...
public class MOSQUE implements Clazz.Mosque {
	...
	public MOSQUE(Long seq) {
		setSeq(seq);
	}

	public MOSQUE(String string) {
	...
	public MOSQUE(AdditionalProperty additionalProperty) {
	...
	public MOSQUE(AdditionalType additionalType) {
	...
	public MOSQUE(AggregateRating aggregateRating) {
	...
	public MOSQUE(AlternateName alternateName) {
	...
	public MOSQUE(AmenityFeature amenityFeature) {
	...
	public MOSQUE(BranchCode branchCode) {
	...
	public MOSQUE(ContainedInPlace containedInPlace) {
	...
	public MOSQUE(ContainsPlace containsPlace) {
	...
	public MOSQUE(Description description) {
	...
	public MOSQUE(DisambiguatingDescription disambiguatingDescription) {
	...
	public MOSQUE(FaxNumber faxNumber) {
	...
	public MOSQUE(GeospatiallyContains geospatiallyContains) {
	...
	public MOSQUE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public MOSQUE(GeospatiallyCovers geospatiallyCovers) {
	...
	public MOSQUE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public MOSQUE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public MOSQUE(GeospatiallyEquals geospatiallyEquals) {
	...
	public MOSQUE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public MOSQUE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public MOSQUE(GeospatiallyTouches geospatiallyTouches) {
	...
	public MOSQUE(GeospatiallyWithin geospatiallyWithin) {
	...
	public MOSQUE(GlobalLocationNumber globalLocationNumber) {
	...
	public MOSQUE(Identifier identifier) {
	...
	public MOSQUE(IsAccessibleForFree isAccessibleForFree) {
	...
	public MOSQUE(MainEntityOfPage mainEntityOfPage) {
	...
	public MOSQUE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public MOSQUE(NameFuzzy nameFuzzy) {
	...
	public MOSQUE(NameRuby nameRuby) {
	...
	public MOSQUE(OpeningHours openingHours) {
	...
	public MOSQUE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public MOSQUE(PotentialAction potentialAction) {
	...
	public MOSQUE(PublicAccess publicAccess) {
	...
	public MOSQUE(SmokingAllowed smokingAllowed) {
	...
	public MOSQUE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public MOSQUE(SubjectOf subjectOf) {
	...
	public MOSQUE(Telephone telephone) {
	...
	public void copy(Clazz.Mosque org) {
		setSeq(org.getSeq());
