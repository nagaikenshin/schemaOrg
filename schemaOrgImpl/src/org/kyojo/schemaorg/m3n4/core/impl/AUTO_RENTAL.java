...
public class AUTO_RENTAL implements Clazz.AutoRental {
	...
	public AUTO_RENTAL(Long seq) {
		setSeq(seq);
	}

	public AUTO_RENTAL(String string) {
	...
	public AUTO_RENTAL(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public AUTO_RENTAL(AdditionalProperty additionalProperty) {
	...
	public AUTO_RENTAL(AdditionalType additionalType) {
	...
	public AUTO_RENTAL(Address address) {
		setAddress(address);
	}
	...
	public AUTO_RENTAL(AggregateRating aggregateRating) {
	...
	public AUTO_RENTAL(AlternateName alternateName) {
	...
	public AUTO_RENTAL(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public AUTO_RENTAL(AmenityFeature amenityFeature) {
	...
	public AUTO_RENTAL(AreaServed areaServed) {
	...
	public AUTO_RENTAL(Award award) {
		setAward(award);
	}
	...
	public AUTO_RENTAL(BranchCode branchCode) {
	...
	public AUTO_RENTAL(Brand brand) {
		setBrand(brand);
	}
	...
	public AUTO_RENTAL(ContactPoint contactPoint) {
	...
	public AUTO_RENTAL(ContainedInPlace containedInPlace) {
	...
	public AUTO_RENTAL(ContainsPlace containsPlace) {
	...
	public AUTO_RENTAL(CorrectionsPolicy correctionsPolicy) {
	...
	public AUTO_RENTAL(CurrenciesAccepted currenciesAccepted) {
	...
	public AUTO_RENTAL(Department department) {
	...
	public AUTO_RENTAL(Description description) {
	...
	public AUTO_RENTAL(DisambiguatingDescription disambiguatingDescription) {
	...
	public AUTO_RENTAL(DissolutionDate dissolutionDate) {
	...
	public AUTO_RENTAL(DiversityPolicy diversityPolicy) {
	...
	public AUTO_RENTAL(DiversityStaffingReport diversityStaffingReport) {
	...
	public AUTO_RENTAL(Email email) {
		setEmail(email);
	}
	...
	public AUTO_RENTAL(Employee employee) {
	...
	public AUTO_RENTAL(EthicsPolicy ethicsPolicy) {
	...
	public AUTO_RENTAL(Event event) {
		setEvent(event);
	}
	...
	public AUTO_RENTAL(FaxNumber faxNumber) {
	...
	public AUTO_RENTAL(Founder founder) {
		setFounder(founder);
	}
	...
	public AUTO_RENTAL(FoundingDate foundingDate) {
	...
	public AUTO_RENTAL(FoundingLocation foundingLocation) {
	...
	public AUTO_RENTAL(Funder funder) {
		setFunder(funder);
	}
	...
	public AUTO_RENTAL(GeospatiallyContains geospatiallyContains) {
	...
	public AUTO_RENTAL(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public AUTO_RENTAL(GeospatiallyCovers geospatiallyCovers) {
	...
	public AUTO_RENTAL(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public AUTO_RENTAL(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public AUTO_RENTAL(GeospatiallyEquals geospatiallyEquals) {
	...
	public AUTO_RENTAL(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public AUTO_RENTAL(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public AUTO_RENTAL(GeospatiallyTouches geospatiallyTouches) {
	...
	public AUTO_RENTAL(GeospatiallyWithin geospatiallyWithin) {
	...
	public AUTO_RENTAL(GlobalLocationNumber globalLocationNumber) {
	...
	public AUTO_RENTAL(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public AUTO_RENTAL(HasOfferCatalog hasOfferCatalog) {
	...
	public AUTO_RENTAL(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public AUTO_RENTAL(Identifier identifier) {
	...
	public AUTO_RENTAL(Image image) {
		setImage(image);
	}
	...
	public AUTO_RENTAL(IsAccessibleForFree isAccessibleForFree) {
	...
	public AUTO_RENTAL(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public AUTO_RENTAL(KnowsAbout knowsAbout) {
	...
	public AUTO_RENTAL(KnowsLanguage knowsLanguage) {
	...
	public AUTO_RENTAL(LegalName legalName) {
	...
	public AUTO_RENTAL(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public AUTO_RENTAL(Location location) {
	...
	public AUTO_RENTAL(MainEntityOfPage mainEntityOfPage) {
	...
	public AUTO_RENTAL(MakesOffer makesOffer) {
	...
	public AUTO_RENTAL(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public AUTO_RENTAL(Member member) {
		setMember(member);
	}
	...
	public AUTO_RENTAL(MemberOf memberOf) {
	...
	public AUTO_RENTAL(Naics naics) {
		setNaics(naics);
	}
	...
	public AUTO_RENTAL(NameFuzzy nameFuzzy) {
	...
	public AUTO_RENTAL(NameRuby nameRuby) {
	...
	public AUTO_RENTAL(NumberOfEmployees numberOfEmployees) {
	...
	public AUTO_RENTAL(OpeningHours openingHours) {
	...
	public AUTO_RENTAL(OpeningHoursSpecification openingHoursSpecification) {
	...
	public AUTO_RENTAL(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public AUTO_RENTAL(ParentOrganization parentOrganization) {
	...
	public AUTO_RENTAL(PaymentAccepted paymentAccepted) {
	...
	public AUTO_RENTAL(Photo photo) {
		setPhoto(photo);
	}
	...
	public AUTO_RENTAL(PotentialAction potentialAction) {
	...
	public AUTO_RENTAL(PriceRange priceRange) {
	...
	public AUTO_RENTAL(PublicAccess publicAccess) {
	...
	public AUTO_RENTAL(PublishingPrinciples publishingPrinciples) {
	...
	public AUTO_RENTAL(Review review) {
		setReview(review);
	}
	...
	public AUTO_RENTAL(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public AUTO_RENTAL(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public AUTO_RENTAL(SmokingAllowed smokingAllowed) {
	...
	public AUTO_RENTAL(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public AUTO_RENTAL(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public AUTO_RENTAL(SubOrganization subOrganization) {
	...
	public AUTO_RENTAL(SubjectOf subjectOf) {
	...
	public AUTO_RENTAL(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public AUTO_RENTAL(Telephone telephone) {
	...
	public AUTO_RENTAL(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public AUTO_RENTAL(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.AutoRental org) {
		setSeq(org.getSeq());
