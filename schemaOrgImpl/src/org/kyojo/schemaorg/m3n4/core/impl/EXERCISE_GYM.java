...
public class EXERCISE_GYM implements Clazz.ExerciseGym {
	...
	public EXERCISE_GYM(Long seq) {
		setSeq(seq);
	}

	public EXERCISE_GYM(String string) {
	...
	public EXERCISE_GYM(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public EXERCISE_GYM(AdditionalProperty additionalProperty) {
	...
	public EXERCISE_GYM(AdditionalType additionalType) {
	...
	public EXERCISE_GYM(Address address) {
		setAddress(address);
	}
	...
	public EXERCISE_GYM(AggregateRating aggregateRating) {
	...
	public EXERCISE_GYM(AlternateName alternateName) {
	...
	public EXERCISE_GYM(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public EXERCISE_GYM(AmenityFeature amenityFeature) {
	...
	public EXERCISE_GYM(AreaServed areaServed) {
	...
	public EXERCISE_GYM(Award award) {
		setAward(award);
	}
	...
	public EXERCISE_GYM(BranchCode branchCode) {
	...
	public EXERCISE_GYM(Brand brand) {
		setBrand(brand);
	}
	...
	public EXERCISE_GYM(ContactPoint contactPoint) {
	...
	public EXERCISE_GYM(ContainedInPlace containedInPlace) {
	...
	public EXERCISE_GYM(ContainsPlace containsPlace) {
	...
	public EXERCISE_GYM(CorrectionsPolicy correctionsPolicy) {
	...
	public EXERCISE_GYM(CurrenciesAccepted currenciesAccepted) {
	...
	public EXERCISE_GYM(Department department) {
	...
	public EXERCISE_GYM(Description description) {
	...
	public EXERCISE_GYM(DisambiguatingDescription disambiguatingDescription) {
	...
	public EXERCISE_GYM(DissolutionDate dissolutionDate) {
	...
	public EXERCISE_GYM(DiversityPolicy diversityPolicy) {
	...
	public EXERCISE_GYM(DiversityStaffingReport diversityStaffingReport) {
	...
	public EXERCISE_GYM(Email email) {
		setEmail(email);
	}
	...
	public EXERCISE_GYM(Employee employee) {
	...
	public EXERCISE_GYM(EthicsPolicy ethicsPolicy) {
	...
	public EXERCISE_GYM(Event event) {
		setEvent(event);
	}
	...
	public EXERCISE_GYM(FaxNumber faxNumber) {
	...
	public EXERCISE_GYM(Founder founder) {
		setFounder(founder);
	}
	...
	public EXERCISE_GYM(FoundingDate foundingDate) {
	...
	public EXERCISE_GYM(FoundingLocation foundingLocation) {
	...
	public EXERCISE_GYM(Funder funder) {
		setFunder(funder);
	}
	...
	public EXERCISE_GYM(GeospatiallyContains geospatiallyContains) {
	...
	public EXERCISE_GYM(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public EXERCISE_GYM(GeospatiallyCovers geospatiallyCovers) {
	...
	public EXERCISE_GYM(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public EXERCISE_GYM(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public EXERCISE_GYM(GeospatiallyEquals geospatiallyEquals) {
	...
	public EXERCISE_GYM(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public EXERCISE_GYM(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public EXERCISE_GYM(GeospatiallyTouches geospatiallyTouches) {
	...
	public EXERCISE_GYM(GeospatiallyWithin geospatiallyWithin) {
	...
	public EXERCISE_GYM(GlobalLocationNumber globalLocationNumber) {
	...
	public EXERCISE_GYM(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public EXERCISE_GYM(HasOfferCatalog hasOfferCatalog) {
	...
	public EXERCISE_GYM(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public EXERCISE_GYM(Identifier identifier) {
	...
	public EXERCISE_GYM(Image image) {
		setImage(image);
	}
	...
	public EXERCISE_GYM(IsAccessibleForFree isAccessibleForFree) {
	...
	public EXERCISE_GYM(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public EXERCISE_GYM(KnowsAbout knowsAbout) {
	...
	public EXERCISE_GYM(KnowsLanguage knowsLanguage) {
	...
	public EXERCISE_GYM(LegalName legalName) {
	...
	public EXERCISE_GYM(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public EXERCISE_GYM(Location location) {
	...
	public EXERCISE_GYM(MainEntityOfPage mainEntityOfPage) {
	...
	public EXERCISE_GYM(MakesOffer makesOffer) {
	...
	public EXERCISE_GYM(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public EXERCISE_GYM(Member member) {
		setMember(member);
	}
	...
	public EXERCISE_GYM(MemberOf memberOf) {
	...
	public EXERCISE_GYM(Naics naics) {
		setNaics(naics);
	}
	...
	public EXERCISE_GYM(NameFuzzy nameFuzzy) {
	...
	public EXERCISE_GYM(NameRuby nameRuby) {
	...
	public EXERCISE_GYM(NumberOfEmployees numberOfEmployees) {
	...
	public EXERCISE_GYM(OpeningHours openingHours) {
	...
	public EXERCISE_GYM(OpeningHoursSpecification openingHoursSpecification) {
	...
	public EXERCISE_GYM(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public EXERCISE_GYM(ParentOrganization parentOrganization) {
	...
	public EXERCISE_GYM(PaymentAccepted paymentAccepted) {
	...
	public EXERCISE_GYM(Photo photo) {
		setPhoto(photo);
	}
	...
	public EXERCISE_GYM(PotentialAction potentialAction) {
	...
	public EXERCISE_GYM(PriceRange priceRange) {
	...
	public EXERCISE_GYM(PublicAccess publicAccess) {
	...
	public EXERCISE_GYM(PublishingPrinciples publishingPrinciples) {
	...
	public EXERCISE_GYM(Review review) {
		setReview(review);
	}
	...
	public EXERCISE_GYM(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public EXERCISE_GYM(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public EXERCISE_GYM(SmokingAllowed smokingAllowed) {
	...
	public EXERCISE_GYM(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public EXERCISE_GYM(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public EXERCISE_GYM(SubOrganization subOrganization) {
	...
	public EXERCISE_GYM(SubjectOf subjectOf) {
	...
	public EXERCISE_GYM(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public EXERCISE_GYM(Telephone telephone) {
	...
	public EXERCISE_GYM(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public EXERCISE_GYM(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.ExerciseGym org) {
		setSeq(org.getSeq());
