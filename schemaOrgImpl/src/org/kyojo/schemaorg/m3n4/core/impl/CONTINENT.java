...
public class CONTINENT implements Clazz.Continent {
	...
	public CONTINENT(Long seq) {
		setSeq(seq);
	}

	public CONTINENT(String string) {
	...
	public CONTINENT(AdditionalProperty additionalProperty) {
	...
	public CONTINENT(AdditionalType additionalType) {
	...
	public CONTINENT(Address address) {
		setAddress(address);
	}
	...
	public CONTINENT(AggregateRating aggregateRating) {
	...
	public CONTINENT(AlternateName alternateName) {
	...
	public CONTINENT(AmenityFeature amenityFeature) {
	...
	public CONTINENT(BranchCode branchCode) {
	...
	public CONTINENT(ContainedInPlace containedInPlace) {
	...
	public CONTINENT(ContainsPlace containsPlace) {
	...
	public CONTINENT(Description description) {
	...
	public CONTINENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public CONTINENT(FaxNumber faxNumber) {
	...
	public CONTINENT(GeospatiallyContains geospatiallyContains) {
	...
	public CONTINENT(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public CONTINENT(GeospatiallyCovers geospatiallyCovers) {
	...
	public CONTINENT(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public CONTINENT(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public CONTINENT(GeospatiallyEquals geospatiallyEquals) {
	...
	public CONTINENT(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public CONTINENT(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public CONTINENT(GeospatiallyTouches geospatiallyTouches) {
	...
	public CONTINENT(GeospatiallyWithin geospatiallyWithin) {
	...
	public CONTINENT(GlobalLocationNumber globalLocationNumber) {
	...
	public CONTINENT(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public CONTINENT(Identifier identifier) {
	...
	public CONTINENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public CONTINENT(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public CONTINENT(MainEntityOfPage mainEntityOfPage) {
	...
	public CONTINENT(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public CONTINENT(NameFuzzy nameFuzzy) {
	...
	public CONTINENT(NameRuby nameRuby) {
	...
	public CONTINENT(OpeningHoursSpecification openingHoursSpecification) {
	...
	public CONTINENT(PotentialAction potentialAction) {
	...
	public CONTINENT(PublicAccess publicAccess) {
	...
	public CONTINENT(Review review) {
		setReview(review);
	}
	...
	public CONTINENT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CONTINENT(SmokingAllowed smokingAllowed) {
	...
	public CONTINENT(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public CONTINENT(SubjectOf subjectOf) {
	...
	public CONTINENT(Telephone telephone) {
	...
	public void copy(Clazz.Continent org) {
		setSeq(org.getSeq());
