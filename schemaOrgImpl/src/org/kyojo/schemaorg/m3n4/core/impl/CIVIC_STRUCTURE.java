...
public class CIVIC_STRUCTURE implements Clazz.CivicStructure {
	...
	public CIVIC_STRUCTURE(Long seq) {
		setSeq(seq);
	}

	public CIVIC_STRUCTURE(String string) {
	...
	public CIVIC_STRUCTURE(AdditionalProperty additionalProperty) {
	...
	public CIVIC_STRUCTURE(AdditionalType additionalType) {
	...
	public CIVIC_STRUCTURE(Address address) {
		setAddress(address);
	}
	...
	public CIVIC_STRUCTURE(AggregateRating aggregateRating) {
	...
	public CIVIC_STRUCTURE(AlternateName alternateName) {
	...
	public CIVIC_STRUCTURE(AmenityFeature amenityFeature) {
	...
	public CIVIC_STRUCTURE(BranchCode branchCode) {
	...
	public CIVIC_STRUCTURE(ContainedInPlace containedInPlace) {
	...
	public CIVIC_STRUCTURE(ContainsPlace containsPlace) {
	...
	public CIVIC_STRUCTURE(Description description) {
	...
	public CIVIC_STRUCTURE(DisambiguatingDescription disambiguatingDescription) {
	...
	public CIVIC_STRUCTURE(Event event) {
		setEvent(event);
	}
	...
	public CIVIC_STRUCTURE(FaxNumber faxNumber) {
	...
	public CIVIC_STRUCTURE(Geo geo) {
		setGeo(geo);
	}
	...
	public CIVIC_STRUCTURE(GeospatiallyContains geospatiallyContains) {
	...
	public CIVIC_STRUCTURE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public CIVIC_STRUCTURE(GeospatiallyCovers geospatiallyCovers) {
	...
	public CIVIC_STRUCTURE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public CIVIC_STRUCTURE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public CIVIC_STRUCTURE(GeospatiallyEquals geospatiallyEquals) {
	...
	public CIVIC_STRUCTURE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public CIVIC_STRUCTURE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public CIVIC_STRUCTURE(GeospatiallyTouches geospatiallyTouches) {
	...
	public CIVIC_STRUCTURE(GeospatiallyWithin geospatiallyWithin) {
	...
	public CIVIC_STRUCTURE(GlobalLocationNumber globalLocationNumber) {
	...
	public CIVIC_STRUCTURE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public CIVIC_STRUCTURE(Identifier identifier) {
	...
	public CIVIC_STRUCTURE(Image image) {
		setImage(image);
	}
	...
	public CIVIC_STRUCTURE(IsAccessibleForFree isAccessibleForFree) {
	...
	public CIVIC_STRUCTURE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public CIVIC_STRUCTURE(Logo logo) {
		setLogo(logo);
	}
	...
	public CIVIC_STRUCTURE(MainEntityOfPage mainEntityOfPage) {
	...
	public CIVIC_STRUCTURE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public CIVIC_STRUCTURE(Name name) {
		setName(name);
	}
	...
	public CIVIC_STRUCTURE(NameFuzzy nameFuzzy) {
	...
	public CIVIC_STRUCTURE(NameRuby nameRuby) {
	...
	public CIVIC_STRUCTURE(OpeningHours openingHours) {
	...
	public CIVIC_STRUCTURE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public CIVIC_STRUCTURE(Photo photo) {
		setPhoto(photo);
	}
	...
	public CIVIC_STRUCTURE(PotentialAction potentialAction) {
	...
	public CIVIC_STRUCTURE(PublicAccess publicAccess) {
	...
	public CIVIC_STRUCTURE(Review review) {
		setReview(review);
	}
	...
	public CIVIC_STRUCTURE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CIVIC_STRUCTURE(SmokingAllowed smokingAllowed) {
	...
	public CIVIC_STRUCTURE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public CIVIC_STRUCTURE(SubjectOf subjectOf) {
	...
	public CIVIC_STRUCTURE(Telephone telephone) {
	...
	public CIVIC_STRUCTURE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.CivicStructure org) {
		setSeq(org.getSeq());
