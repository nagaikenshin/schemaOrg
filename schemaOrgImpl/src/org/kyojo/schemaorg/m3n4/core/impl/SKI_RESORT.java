...
public class SKI_RESORT implements Clazz.SkiResort {
	...
	public SKI_RESORT(Long seq) {
		setSeq(seq);
	}

	public SKI_RESORT(String string) {
	...
	public SKI_RESORT(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public SKI_RESORT(AdditionalProperty additionalProperty) {
	...
	public SKI_RESORT(AdditionalType additionalType) {
	...
	public SKI_RESORT(Address address) {
		setAddress(address);
	}
	...
	public SKI_RESORT(AggregateRating aggregateRating) {
	...
	public SKI_RESORT(AlternateName alternateName) {
	...
	public SKI_RESORT(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public SKI_RESORT(AmenityFeature amenityFeature) {
	...
	public SKI_RESORT(AreaServed areaServed) {
	...
	public SKI_RESORT(BranchCode branchCode) {
	...
	public SKI_RESORT(ContactPoint contactPoint) {
	...
	public SKI_RESORT(ContainedInPlace containedInPlace) {
	...
	public SKI_RESORT(ContainsPlace containsPlace) {
	...
	public SKI_RESORT(CorrectionsPolicy correctionsPolicy) {
	...
	public SKI_RESORT(CurrenciesAccepted currenciesAccepted) {
	...
	public SKI_RESORT(Department department) {
	...
	public SKI_RESORT(Description description) {
	...
	public SKI_RESORT(DisambiguatingDescription disambiguatingDescription) {
	...
	public SKI_RESORT(DissolutionDate dissolutionDate) {
	...
	public SKI_RESORT(DiversityPolicy diversityPolicy) {
	...
	public SKI_RESORT(DiversityStaffingReport diversityStaffingReport) {
	...
	public SKI_RESORT(Employee employee) {
	...
	public SKI_RESORT(EthicsPolicy ethicsPolicy) {
	...
	public SKI_RESORT(FaxNumber faxNumber) {
	...
	public SKI_RESORT(Founder founder) {
		setFounder(founder);
	}
	...
	public SKI_RESORT(FoundingDate foundingDate) {
	...
	public SKI_RESORT(FoundingLocation foundingLocation) {
	...
	public SKI_RESORT(Funder funder) {
		setFunder(funder);
	}
	...
	public SKI_RESORT(GeospatiallyContains geospatiallyContains) {
	...
	public SKI_RESORT(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public SKI_RESORT(GeospatiallyCovers geospatiallyCovers) {
	...
	public SKI_RESORT(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public SKI_RESORT(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public SKI_RESORT(GeospatiallyEquals geospatiallyEquals) {
	...
	public SKI_RESORT(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public SKI_RESORT(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public SKI_RESORT(GeospatiallyTouches geospatiallyTouches) {
	...
	public SKI_RESORT(GeospatiallyWithin geospatiallyWithin) {
	...
	public SKI_RESORT(GlobalLocationNumber globalLocationNumber) {
	...
	public SKI_RESORT(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public SKI_RESORT(HasOfferCatalog hasOfferCatalog) {
	...
	public SKI_RESORT(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public SKI_RESORT(Identifier identifier) {
	...
	public SKI_RESORT(IsAccessibleForFree isAccessibleForFree) {
	...
	public SKI_RESORT(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public SKI_RESORT(KnowsAbout knowsAbout) {
	...
	public SKI_RESORT(KnowsLanguage knowsLanguage) {
	...
	public SKI_RESORT(LegalName legalName) {
	...
	public SKI_RESORT(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public SKI_RESORT(Location location) {
	...
	public SKI_RESORT(MainEntityOfPage mainEntityOfPage) {
	...
	public SKI_RESORT(MakesOffer makesOffer) {
	...
	public SKI_RESORT(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public SKI_RESORT(Member member) {
		setMember(member);
	}
	...
	public SKI_RESORT(MemberOf memberOf) {
	...
	public SKI_RESORT(NameFuzzy nameFuzzy) {
	...
	public SKI_RESORT(NameRuby nameRuby) {
	...
	public SKI_RESORT(NumberOfEmployees numberOfEmployees) {
	...
	public SKI_RESORT(OpeningHours openingHours) {
	...
	public SKI_RESORT(OpeningHoursSpecification openingHoursSpecification) {
	...
	public SKI_RESORT(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public SKI_RESORT(ParentOrganization parentOrganization) {
	...
	public SKI_RESORT(PaymentAccepted paymentAccepted) {
	...
	public SKI_RESORT(PotentialAction potentialAction) {
	...
	public SKI_RESORT(PriceRange priceRange) {
	...
	public SKI_RESORT(PublicAccess publicAccess) {
	...
	public SKI_RESORT(PublishingPrinciples publishingPrinciples) {
	...
	public SKI_RESORT(Review review) {
		setReview(review);
	}
	...
	public SKI_RESORT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SKI_RESORT(SmokingAllowed smokingAllowed) {
	...
	public SKI_RESORT(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public SKI_RESORT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public SKI_RESORT(SubOrganization subOrganization) {
	...
	public SKI_RESORT(SubjectOf subjectOf) {
	...
	public SKI_RESORT(Telephone telephone) {
	...
	public SKI_RESORT(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.SkiResort org) {
		setSeq(org.getSeq());
