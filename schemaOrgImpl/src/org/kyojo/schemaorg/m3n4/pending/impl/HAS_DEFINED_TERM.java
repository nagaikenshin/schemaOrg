...
public class HAS_DEFINED_TERM implements Container.HasDefinedTerm {
	...
	public HAS_DEFINED_TERM(BusTrip busTrip) {
	...
	public HAS_DEFINED_TERM(Flight flight) {
	...
	public HAS_DEFINED_TERM(TouristTrip touristTrip) {
	...
	public HAS_DEFINED_TERM(TrainTrip trainTrip) {
