...
public class X_PATH_TYPE implements Clazz.XPathType {
	...
	public X_PATH_TYPE(Long seq) {
		setSeq(seq);
	}

	public X_PATH_TYPE(String string) {
		setString(string);
	}
	...
	public void copy(Clazz.XPathType org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return Clazz.XPathType.class.getAnnotation(SampleValue.class).value();
	}
