...
public class PERCENTILE25 implements Container.Percentile25 {
	...
	public PERCENTILE25(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public PERCENTILE25(Float fl0at) {
	...
	public PERCENTILE25(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public PERCENTILE25(Integer integer) {
	...
	public PERCENTILE25(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public PERCENTILE25(Number number) {
	...
	public PERCENTILE25(List<Float> fl0atList,
	...
	public void copy(Container.Percentile25 org) {
