...
import org.kyojo.schemaorg.m3n4.pending.Container.Documentation;
import org.kyojo.schemaorg.m3n4.pending.Container.SubjectOf;
import org.kyojo.schemaorg.m3n4.pending.Container.TermsOfService;

public class WEB_API implements Clazz.WebAPI {
	...
	public WEB_API(Long seq) {
		setSeq(seq);
	}

	public WEB_API(String string) {
	...
	public WEB_API(AdditionalType additionalType) {
	...
	public WEB_API(AggregateRating aggregateRating) {
	...
	public WEB_API(AlternateName alternateName) {
	...
	public WEB_API(AreaServed areaServed) {
	...
	public WEB_API(Audience audience) {
	...
	public WEB_API(AvailableChannel availableChannel) {
	...
	public WEB_API(Category category) {
	...
	public WEB_API(Description description) {
	...
	public WEB_API(DisambiguatingDescription disambiguatingDescription) {
	...
	public WEB_API(Documentation documentation) {
	...
	public WEB_API(HasOfferCatalog hasOfferCatalog) {
	...
	public WEB_API(HoursAvailable hoursAvailable) {
	...
	public WEB_API(Identifier identifier) {
	...
	public WEB_API(IsRelatedTo isRelatedTo) {
	...
	public WEB_API(IsSimilarTo isSimilarTo) {
	...
	public WEB_API(MainEntityOfPage mainEntityOfPage) {
	...
	public WEB_API(NameFuzzy nameFuzzy) {
	...
	public WEB_API(NameRuby nameRuby) {
	...
	public WEB_API(PotentialAction potentialAction) {
	...
	public WEB_API(Provider provider) {
	...
	public WEB_API(ProviderMobility providerMobility) {
	...
	public WEB_API(ServiceOutput serviceOutput) {
	...
	public WEB_API(ServiceType serviceType) {
	...
	public WEB_API(SubjectOf subjectOf) {
	...
	public WEB_API(TermsOfService termsOfService) {
	...
	public void copy(Clazz.WebAPI org) {
		setSeq(org.getSeq());
		...
		setDocumentation(org.getDocumentation());
