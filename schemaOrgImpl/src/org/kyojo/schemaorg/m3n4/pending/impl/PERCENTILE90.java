...
public class PERCENTILE90 implements Container.Percentile90 {
	...
	public PERCENTILE90(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public PERCENTILE90(Float fl0at) {
	...
	public PERCENTILE90(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public PERCENTILE90(Integer integer) {
	...
	public PERCENTILE90(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public PERCENTILE90(Number number) {
	...
	public PERCENTILE90(List<Float> fl0atList,
	...
	public void copy(Container.Percentile90 org) {
