...
public class ESTIMATED_SALARY implements Container.EstimatedSalary {
	...
	public ESTIMATED_SALARY(CompoundPriceSpecification compoundPriceSpecification) {
	...
	public ESTIMATED_SALARY(DeliveryChargeSpecification deliveryChargeSpecification) {
	...
	public ESTIMATED_SALARY(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public ESTIMATED_SALARY(Float fl0at) {
	...
	public ESTIMATED_SALARY(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public ESTIMATED_SALARY(Integer integer) {
	...
	public ESTIMATED_SALARY(PaymentChargeSpecification paymentChargeSpecification) {
	...
	public ESTIMATED_SALARY(UnitPriceSpecification unitPriceSpecification) {
	...
	public ESTIMATED_SALARY(List<CompoundPriceSpecification> compoundPriceSpecificationList,
