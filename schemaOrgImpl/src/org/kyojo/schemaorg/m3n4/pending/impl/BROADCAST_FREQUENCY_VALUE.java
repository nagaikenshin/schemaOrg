...
public class BROADCAST_FREQUENCY_VALUE implements Container.BroadcastFrequencyValue {
	...
	public BROADCAST_FREQUENCY_VALUE(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public BROADCAST_FREQUENCY_VALUE(QuantitativeValueDistribution quantitativeValueDistribution) {
