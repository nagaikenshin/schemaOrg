...
public class POSSIBLE_TREATMENT implements Container.PossibleTreatment {
	...
	public POSSIBLE_TREATMENT(String string) {
	...
	public POSSIBLE_TREATMENT(MedicalTherapy medicalTherapy) {
		medicalTherapyList = new ArrayList<MedicalTherapy>();
	...
	public POSSIBLE_TREATMENT(OccupationalTherapy occupationalTherapy) {
	...
	public POSSIBLE_TREATMENT(PalliativeProcedure palliativeProcedure) {
	...
	public POSSIBLE_TREATMENT(PhysicalTherapy physicalTherapy) {
	...
	public POSSIBLE_TREATMENT(RadiationTherapy radiationTherapy) {
	...
	public POSSIBLE_TREATMENT(RespiratoryTherapy respiratoryTherapy) {
	...
	public POSSIBLE_TREATMENT(List<MedicalTherapy> medicalTherapyList,
	...
	public void copy(Container.PossibleTreatment org) {
