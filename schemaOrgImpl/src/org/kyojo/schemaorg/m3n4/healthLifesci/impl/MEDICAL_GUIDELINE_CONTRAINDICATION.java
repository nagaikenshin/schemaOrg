...
import org.kyojo.schemaorg.m3n4.healthLifesci.Container.GuidelineSubject;
...
public class MEDICAL_GUIDELINE_CONTRAINDICATION implements Clazz.MedicalGuidelineContraindication {
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION() {
	}

	public MEDICAL_GUIDELINE_CONTRAINDICATION(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_GUIDELINE_CONTRAINDICATION(String string) {
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(AdditionalType additionalType) {
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(AlternateName alternateName) {
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(Code code) {
		setCode(code);
	}
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(Description description) {
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(EvidenceLevel evidenceLevel) {
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(EvidenceOrigin evidenceOrigin) {
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(Guideline guideline) {
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(GuidelineDate guidelineDate) {
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(GuidelineSubject guidelineSubject) {
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(Identifier identifier) {
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(LegalStatus legalStatus) {
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(MedicineSystem medicineSystem) {
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(Name name) {
		setName(name);
	}
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(NameRuby nameRuby) {
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(PotentialAction potentialAction) {
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(RecognizingAuthority recognizingAuthority) {
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(RelevantSpecialty relevantSpecialty) {
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(Study study) {
		setStudy(study);
	}
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(SubjectOf subjectOf) {
	...
	public MEDICAL_GUIDELINE_CONTRAINDICATION(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.MedicalGuidelineContraindication org) {
		setSeq(org.getSeq());
