...
public class SUPPLY_TO implements Container.SupplyTo {
	...
	public SUPPLY_TO(String string) {
	...
	public SUPPLY_TO(AnatomicalStructure anatomicalStructure) {
		anatomicalStructureList = new ArrayList<AnatomicalStructure>();
	...
	public SUPPLY_TO(Artery artery) {
	...
	public SUPPLY_TO(BrainStructure brainStructure) {
	...
	public SUPPLY_TO(Ligament ligament) {
	...
	public SUPPLY_TO(LymphaticVessel lymphaticVessel) {
	...
	public SUPPLY_TO(Muscle muscle) {
	...
	public SUPPLY_TO(Vessel vessel) {
	...
	public SUPPLY_TO(List<AnatomicalStructure> anatomicalStructureList,
	...
	public void copy(Container.SupplyTo org) {
