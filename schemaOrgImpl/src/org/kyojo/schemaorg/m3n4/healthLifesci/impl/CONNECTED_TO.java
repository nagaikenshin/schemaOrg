...
public class CONNECTED_TO implements Container.ConnectedTo {
	...
	public CONNECTED_TO(String string) {
	...
	public CONNECTED_TO(AnatomicalStructure anatomicalStructure) {
		anatomicalStructureList = new ArrayList<AnatomicalStructure>();
	...
	public CONNECTED_TO(Artery artery) {
	...
	public CONNECTED_TO(BrainStructure brainStructure) {
	...
	public CONNECTED_TO(Joint joint) {
	...
	public CONNECTED_TO(Ligament ligament) {
	...
	public CONNECTED_TO(LymphaticVessel lymphaticVessel) {
	...
	public CONNECTED_TO(Muscle muscle) {
	...
	public CONNECTED_TO(Nerve nerve) {
	...
	public CONNECTED_TO(Vessel vessel) {
	...
	public CONNECTED_TO(List<AnatomicalStructure> anatomicalStructureList,
	...
	public void copy(Container.ConnectedTo org) {
