...
import org.kyojo.schemaorg.m3n4.pending.Container.CodeValue;
...
public class MEDICAL_CODE implements Clazz.MedicalCode {
	...
	public Image image;
	public InCodeSet inCodeSet;
	public InDefinedTermSet inDefinedTermSet;
	...
	public MEDICAL_CODE(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_CODE(String string) {
	...
	public MEDICAL_CODE(AdditionalType additionalType) {
	...
	public MEDICAL_CODE(AlternateName alternateName) {
	...
	public MEDICAL_CODE(CodeValue codeValue) {
	...
	public MEDICAL_CODE(CodingSystem codingSystem) {
		setCodingSystem(codingSystem);
	}
	...
	public MEDICAL_CODE(Description description) {
	...
	public MEDICAL_CODE(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_CODE(Guideline guideline) {
	...
	public MEDICAL_CODE(Identifier identifier) {
	...
	public MEDICAL_CODE(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_CODE(InCodeSet inCodeSet) {
		setInCodeSet(inCodeSet);
	}

	@Override
	public InCodeSet getInCodeSet() {
		return inCodeSet;
	}

	@Override
	public void setInCodeSet(InCodeSet inCodeSet) {
		this.inCodeSet = inCodeSet;
	}

	public MEDICAL_CODE(InDefinedTermSet inDefinedTermSet) {
		setInDefinedTermSet(inDefinedTermSet);
	}

	@Override
	public InDefinedTermSet getInDefinedTermSet() {
		return inDefinedTermSet;
	}

	@Override
	public void setInDefinedTermSet(InDefinedTermSet inDefinedTermSet) {
		this.inDefinedTermSet = inDefinedTermSet;
	}

	public MEDICAL_CODE(LegalStatus legalStatus) {
	...
	public MEDICAL_CODE(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_CODE(MedicineSystem medicineSystem) {
	...
	public MEDICAL_CODE(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_CODE(NameRuby nameRuby) {
	...
	public MEDICAL_CODE(PotentialAction potentialAction) {
	...
	public MEDICAL_CODE(RecognizingAuthority recognizingAuthority) {
	...
	public MEDICAL_CODE(RelevantSpecialty relevantSpecialty) {
	...
	public MEDICAL_CODE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_CODE(Study study) {
		setStudy(study);
	}
	...
	public MEDICAL_CODE(SubjectOf subjectOf) {
	...
	public MEDICAL_CODE(TermCode termCode) {
	...
	@Override
	public void setTermCode(TermCode termCode) {
		this.termCode = termCode;
	}

	public MEDICAL_CODE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.MedicalCode org) {
		setSeq(org.getSeq());
		...
		setCode(org.getCode());
		setCodeValue(org.getCodeValue());
		setCodingSystem(org.getCodingSystem());
		setDescription(org.getDescription());
		setDisambiguatingDescription(org.getDisambiguatingDescription());
		setGuideline(org.getGuideline());
		setIdentifier(org.getIdentifier());
		setImage(org.getImage());
		setInCodeSet(org.getInCodeSet());
		setInDefinedTermSet(org.getInDefinedTermSet());
