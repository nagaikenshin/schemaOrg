...
public class INSERTION implements Container.Insertion {
	...
	public INSERTION(Artery artery) {
	...
	public INSERTION(BrainStructure brainStructure) {
	...
	public INSERTION(Ligament ligament) {
	...
	public INSERTION(LymphaticVessel lymphaticVessel) {
	...
	public INSERTION(Muscle muscle) {
	...
	public INSERTION(Vessel vessel) {
	...
	public INSERTION(List<AnatomicalStructure> anatomicalStructureList,
	...
	public void copy(Container.Insertion org) {
