...
public class TREATMENT_INDICATION implements Clazz.TreatmentIndication {
	...
	public TREATMENT_INDICATION() {
	}

	public TREATMENT_INDICATION(Long seq) {
		setSeq(seq);
	}

	public TREATMENT_INDICATION(String string) {
	...
	public TREATMENT_INDICATION(AdditionalType additionalType) {
	...
	public TREATMENT_INDICATION(AlternateName alternateName) {
	...
	public TREATMENT_INDICATION(Code code) {
		setCode(code);
	}
	...
	public TREATMENT_INDICATION(Description description) {
	...
	public TREATMENT_INDICATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public TREATMENT_INDICATION(Guideline guideline) {
	...
	public TREATMENT_INDICATION(Identifier identifier) {
	...
	public TREATMENT_INDICATION(Image image) {
		setImage(image);
	}
	...
	public TREATMENT_INDICATION(LegalStatus legalStatus) {
	...
	public TREATMENT_INDICATION(MainEntityOfPage mainEntityOfPage) {
	...
	public TREATMENT_INDICATION(MedicineSystem medicineSystem) {
	...
	public TREATMENT_INDICATION(Name name) {
		setName(name);
	}
	...
	public TREATMENT_INDICATION(NameFuzzy nameFuzzy) {
	...
	public TREATMENT_INDICATION(NameRuby nameRuby) {
	...
	public TREATMENT_INDICATION(PotentialAction potentialAction) {
	...
	public TREATMENT_INDICATION(RecognizingAuthority recognizingAuthority) {
	...
	public TREATMENT_INDICATION(RelevantSpecialty relevantSpecialty) {
	...
	public TREATMENT_INDICATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TREATMENT_INDICATION(Study study) {
		setStudy(study);
	}
	...
	public TREATMENT_INDICATION(SubjectOf subjectOf) {
	...
	public TREATMENT_INDICATION(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.TreatmentIndication org) {
		setSeq(org.getSeq());
