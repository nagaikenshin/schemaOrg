...
public class VESSEL implements Clazz.Vessel {
	...
	public VESSEL(Long seq) {
		setSeq(seq);
	}

	public VESSEL(String string) {
	...
	public VESSEL(AdditionalType additionalType) {
	...
	public VESSEL(AlternateName alternateName) {
	...
	public VESSEL(AssociatedPathophysiology associatedPathophysiology) {
	...
	public VESSEL(BodyLocation bodyLocation) {
	...
	public VESSEL(ConnectedTo connectedTo) {
	...
	public VESSEL(Description description) {
	...
	public VESSEL(DisambiguatingDescription disambiguatingDescription) {
	...
	public VESSEL(Function function) {
	...
	public VESSEL(Guideline guideline) {
	...
	public VESSEL(Identifier identifier) {
	...
	public VESSEL(LegalStatus legalStatus) {
	...
	public VESSEL(MainEntityOfPage mainEntityOfPage) {
	...
	public VESSEL(MedicineSystem medicineSystem) {
	...
	public VESSEL(NameFuzzy nameFuzzy) {
	...
	public VESSEL(NameRuby nameRuby) {
	...
	public VESSEL(PartOfSystem partOfSystem) {
	...
	public VESSEL(PotentialAction potentialAction) {
	...
	public VESSEL(RecognizingAuthority recognizingAuthority) {
	...
	public VESSEL(RelatedCondition relatedCondition) {
	...
	public VESSEL(RelatedTherapy relatedTherapy) {
	...
	public VESSEL(RelevantSpecialty relevantSpecialty) {
	...
	public VESSEL(SubStructure subStructure) {
	...
	public VESSEL(SubjectOf subjectOf) {
	...
	public void copy(Clazz.Vessel org) {
		setSeq(org.getSeq());
