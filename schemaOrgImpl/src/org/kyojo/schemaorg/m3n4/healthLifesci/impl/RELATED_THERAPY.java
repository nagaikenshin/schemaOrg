...
public class RELATED_THERAPY implements Container.RelatedTherapy {
	...
	public RELATED_THERAPY(String string) {
	...
	public RELATED_THERAPY(MedicalTherapy medicalTherapy) {
		medicalTherapyList = new ArrayList<MedicalTherapy>();
	...
	public RELATED_THERAPY(OccupationalTherapy occupationalTherapy) {
	...
	public RELATED_THERAPY(PalliativeProcedure palliativeProcedure) {
	...
	public RELATED_THERAPY(PhysicalTherapy physicalTherapy) {
	...
	public RELATED_THERAPY(RadiationTherapy radiationTherapy) {
	...
	public RELATED_THERAPY(RespiratoryTherapy respiratoryTherapy) {
	...
	public RELATED_THERAPY(List<MedicalTherapy> medicalTherapyList,
	...
	public void copy(Container.RelatedTherapy org) {
