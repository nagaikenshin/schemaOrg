...
public class MEDICINE_SYSTEM implements Clazz.MedicineSystem, Container.MedicineSystem {
	...
	public MEDICINE_SYSTEM(Long seq) {
		setSeq(seq);
	}

	public MEDICINE_SYSTEM(String string) {
	...
	public MEDICINE_SYSTEM(AdditionalType additionalType) {
	...
	public MEDICINE_SYSTEM(AlternateName alternateName) {
	...
	public MEDICINE_SYSTEM(Description description) {
	...
	public MEDICINE_SYSTEM(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICINE_SYSTEM(Identifier identifier) {
	...
	public MEDICINE_SYSTEM(Image image) {
		setImage(image);
	}
	...
	public MEDICINE_SYSTEM(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICINE_SYSTEM(Clazz.MedicineSystem medicineSystem) {
	...
	public MEDICINE_SYSTEM(Name name) {
		setName(name);
	}
	...
	public MEDICINE_SYSTEM(NameFuzzy nameFuzzy) {
	...
	public MEDICINE_SYSTEM(NameRuby nameRuby) {
	...
	public MEDICINE_SYSTEM(PotentialAction potentialAction) {
	...
	public MEDICINE_SYSTEM(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICINE_SYSTEM(SubjectOf subjectOf) {
	...
	public MEDICINE_SYSTEM(SupersededBy supersededBy) {
	...
	public MEDICINE_SYSTEM(Url url) {
		setUrl(url);
	}
	...
	public MEDICINE_SYSTEM(Long seq,
			...
			List<Clazz.MedicineSystem> medicineSystemList,
			Name name,
			NameFuzzy nameFuzzy,
			NameRuby nameRuby,
	...
	public void copy(Clazz.MedicineSystem org) {
		setSeq(org.getSeq());
	...
	public void copy(Container.MedicineSystem org) {
