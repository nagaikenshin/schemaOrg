...
import org.kyojo.schemaorg.m3n4.healthLifesci.impl.MEDICAL_TEST;

public class AVAILABLE_TEST implements Container.AvailableTest {
	...
	public AVAILABLE_TEST(String string) {
	...
	public AVAILABLE_TEST(BloodTest bloodTest) {
	...
	public AVAILABLE_TEST(ImagingTest imagingTest) {
	...
	public AVAILABLE_TEST(MedicalTest medicalTest) {
		medicalTestList = new ArrayList<MedicalTest>();
	...
	public AVAILABLE_TEST(MedicalTestPanel medicalTestPanel) {
	...
	public AVAILABLE_TEST(PathologyTest pathologyTest) {
	...
	public AVAILABLE_TEST(List<BloodTest> bloodTestList,
	...
	public void copy(Container.AvailableTest org) {
