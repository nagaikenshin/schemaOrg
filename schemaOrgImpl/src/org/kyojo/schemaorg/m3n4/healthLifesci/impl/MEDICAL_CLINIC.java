...
public class MEDICAL_CLINIC implements Clazz.MedicalClinic {
	...
	public HealthPlanNetworkId healthPlanNetworkId;
	public Identifier identifier;
	public Image image;
	public IsAcceptingNewPatients isAcceptingNewPatients;
	...
	public MEDICAL_CLINIC(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_CLINIC(String string) {
	...
	public MEDICAL_CLINIC(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public MEDICAL_CLINIC(AdditionalProperty additionalProperty) {
	...
	public MEDICAL_CLINIC(AdditionalType additionalType) {
	...
	public MEDICAL_CLINIC(Address address) {
		setAddress(address);
	}
	...
	public MEDICAL_CLINIC(AggregateRating aggregateRating) {
	...
	public MEDICAL_CLINIC(AlternateName alternateName) {
	...
	public MEDICAL_CLINIC(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public MEDICAL_CLINIC(AmenityFeature amenityFeature) {
	...
	public MEDICAL_CLINIC(AreaServed areaServed) {
	...
	public MEDICAL_CLINIC(AvailableService availableService) {
	...
	public MEDICAL_CLINIC(Award award) {
		setAward(award);
	}
	...
	public MEDICAL_CLINIC(BranchCode branchCode) {
	...
	public MEDICAL_CLINIC(Brand brand) {
		setBrand(brand);
	}
	...
	public MEDICAL_CLINIC(ContactPoint contactPoint) {
	...
	public MEDICAL_CLINIC(ContainedInPlace containedInPlace) {
	...
	public MEDICAL_CLINIC(ContainsPlace containsPlace) {
	...
	public MEDICAL_CLINIC(CorrectionsPolicy correctionsPolicy) {
	...
	public MEDICAL_CLINIC(CurrenciesAccepted currenciesAccepted) {
	...
	public MEDICAL_CLINIC(Department department) {
	...
	public MEDICAL_CLINIC(Description description) {
	...
	public MEDICAL_CLINIC(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_CLINIC(DissolutionDate dissolutionDate) {
	...
	public MEDICAL_CLINIC(DiversityPolicy diversityPolicy) {
	...
	public MEDICAL_CLINIC(DiversityStaffingReport diversityStaffingReport) {
	...
	public MEDICAL_CLINIC(Duns duns) {
		setDuns(duns);
	}
	...
	public MEDICAL_CLINIC(Email email) {
		setEmail(email);
	}
	...
	public MEDICAL_CLINIC(Employee employee) {
	...
	public MEDICAL_CLINIC(EthicsPolicy ethicsPolicy) {
	...
	public MEDICAL_CLINIC(Event event) {
		setEvent(event);
	}
	...
	public MEDICAL_CLINIC(FaxNumber faxNumber) {
	...
	public MEDICAL_CLINIC(Founder founder) {
		setFounder(founder);
	}
	...
	public MEDICAL_CLINIC(FoundingDate foundingDate) {
	...
	public MEDICAL_CLINIC(FoundingLocation foundingLocation) {
	...
	public MEDICAL_CLINIC(Funder funder) {
		setFunder(funder);
	}
	...
	public MEDICAL_CLINIC(GeospatiallyContains geospatiallyContains) {
	...
	public MEDICAL_CLINIC(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public MEDICAL_CLINIC(GeospatiallyCovers geospatiallyCovers) {
	...
	public MEDICAL_CLINIC(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public MEDICAL_CLINIC(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public MEDICAL_CLINIC(GeospatiallyEquals geospatiallyEquals) {
	...
	public MEDICAL_CLINIC(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public MEDICAL_CLINIC(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public MEDICAL_CLINIC(GeospatiallyTouches geospatiallyTouches) {
	...
	public MEDICAL_CLINIC(GeospatiallyWithin geospatiallyWithin) {
	...
	public MEDICAL_CLINIC(GlobalLocationNumber globalLocationNumber) {
	...
	public MEDICAL_CLINIC(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public MEDICAL_CLINIC(HasOfferCatalog hasOfferCatalog) {
	...
	public MEDICAL_CLINIC(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public MEDICAL_CLINIC(HealthPlanNetworkId healthPlanNetworkId) {
		setHealthPlanNetworkId(healthPlanNetworkId);
	}
	...
	public MEDICAL_CLINIC(Identifier identifier) {
	...
	public MEDICAL_CLINIC(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_CLINIC(IsAcceptingNewPatients isAcceptingNewPatients) {
		setIsAcceptingNewPatients(isAcceptingNewPatients);
	}
	...
	public MEDICAL_CLINIC(IsAccessibleForFree isAccessibleForFree) {
	...
	public MEDICAL_CLINIC(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public MEDICAL_CLINIC(KnowsAbout knowsAbout) {
	...
	public MEDICAL_CLINIC(KnowsLanguage knowsLanguage) {
	...
	public MEDICAL_CLINIC(LegalName legalName) {
	...
	public MEDICAL_CLINIC(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public MEDICAL_CLINIC(Location location) {
	...
	public MEDICAL_CLINIC(Logo logo) {
		setLogo(logo);
	}
	...
	public MEDICAL_CLINIC(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_CLINIC(MakesOffer makesOffer) {
	...
	public MEDICAL_CLINIC(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public MEDICAL_CLINIC(MedicalSpecialty medicalSpecialty) {
	...
	public MEDICAL_CLINIC(Member member) {
		setMember(member);
	}
	...
	public MEDICAL_CLINIC(MemberOf memberOf) {
	...
	public MEDICAL_CLINIC(Naics naics) {
		setNaics(naics);
	}
	...
	public MEDICAL_CLINIC(Name name) {
		setName(name);
	}
	...
	public MEDICAL_CLINIC(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_CLINIC(NameRuby nameRuby) {
	...
	public MEDICAL_CLINIC(NumberOfEmployees numberOfEmployees) {
	...
	public MEDICAL_CLINIC(OpeningHours openingHours) {
	...
	public MEDICAL_CLINIC(OpeningHoursSpecification openingHoursSpecification) {
	...
	public MEDICAL_CLINIC(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public MEDICAL_CLINIC(Owns owns) {
		setOwns(owns);
	}
	...
	public MEDICAL_CLINIC(ParentOrganization parentOrganization) {
	...
	public MEDICAL_CLINIC(PaymentAccepted paymentAccepted) {
	...
	public MEDICAL_CLINIC(Photo photo) {
		setPhoto(photo);
	}
	...
	public MEDICAL_CLINIC(PotentialAction potentialAction) {
	...
	public MEDICAL_CLINIC(PriceRange priceRange) {
	...
	public MEDICAL_CLINIC(PublicAccess publicAccess) {
	...
	public MEDICAL_CLINIC(PublishingPrinciples publishingPrinciples) {
	...
	public MEDICAL_CLINIC(Review review) {
		setReview(review);
	}
	...
	public MEDICAL_CLINIC(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_CLINIC(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public MEDICAL_CLINIC(SmokingAllowed smokingAllowed) {
	...
	public MEDICAL_CLINIC(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public MEDICAL_CLINIC(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MEDICAL_CLINIC(SubOrganization subOrganization) {
	...
	public MEDICAL_CLINIC(SubjectOf subjectOf) {
	...
	public MEDICAL_CLINIC(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public MEDICAL_CLINIC(Telephone telephone) {
	...
	public MEDICAL_CLINIC(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public MEDICAL_CLINIC(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.MedicalClinic org) {
		setSeq(org.getSeq());
		...
		setAvailableService(org.getAvailableService());
		...
		setHealthPlanNetworkId(org.getHealthPlanNetworkId());
		setIdentifier(org.getIdentifier());
		setImage(org.getImage());
		setIsAcceptingNewPatients(org.getIsAcceptingNewPatients());
		...
		setMedicalSpecialty(org.getMedicalSpecialty());
