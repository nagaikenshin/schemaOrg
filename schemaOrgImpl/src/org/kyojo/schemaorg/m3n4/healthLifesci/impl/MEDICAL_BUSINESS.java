...
public class MEDICAL_BUSINESS implements Clazz.MedicalBusiness {
	...
	public MEDICAL_BUSINESS() {
	}

	public MEDICAL_BUSINESS(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_BUSINESS(String string) {
	...
	public MEDICAL_BUSINESS(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public MEDICAL_BUSINESS(AdditionalProperty additionalProperty) {
	...
	public MEDICAL_BUSINESS(AdditionalType additionalType) {
	...
	public MEDICAL_BUSINESS(Address address) {
		setAddress(address);
	}
	...
	public MEDICAL_BUSINESS(AggregateRating aggregateRating) {
	...
	public MEDICAL_BUSINESS(AlternateName alternateName) {
	...
	public MEDICAL_BUSINESS(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public MEDICAL_BUSINESS(AmenityFeature amenityFeature) {
	...
	public MEDICAL_BUSINESS(AreaServed areaServed) {
	...
	public MEDICAL_BUSINESS(Award award) {
		setAward(award);
	}
	...
	public MEDICAL_BUSINESS(BranchCode branchCode) {
	...
	public MEDICAL_BUSINESS(Brand brand) {
		setBrand(brand);
	}
	...
	public MEDICAL_BUSINESS(ContactPoint contactPoint) {
	...
	public MEDICAL_BUSINESS(ContainedInPlace containedInPlace) {
	...
	public MEDICAL_BUSINESS(ContainsPlace containsPlace) {
	...
	public MEDICAL_BUSINESS(CorrectionsPolicy correctionsPolicy) {
	...
	public MEDICAL_BUSINESS(CurrenciesAccepted currenciesAccepted) {
	...
	public MEDICAL_BUSINESS(Department department) {
	...
	public MEDICAL_BUSINESS(Description description) {
	...
	public MEDICAL_BUSINESS(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_BUSINESS(DissolutionDate dissolutionDate) {
	...
	public MEDICAL_BUSINESS(DiversityPolicy diversityPolicy) {
	...
	public MEDICAL_BUSINESS(DiversityStaffingReport diversityStaffingReport) {
	...
	public MEDICAL_BUSINESS(Duns duns) {
		setDuns(duns);
	}
	...
	public MEDICAL_BUSINESS(Email email) {
		setEmail(email);
	}
	...
	public MEDICAL_BUSINESS(Employee employee) {
	...
	public MEDICAL_BUSINESS(EthicsPolicy ethicsPolicy) {
	...
	public MEDICAL_BUSINESS(Event event) {
		setEvent(event);
	}
	...
	public MEDICAL_BUSINESS(FaxNumber faxNumber) {
	...
	public MEDICAL_BUSINESS(Founder founder) {
		setFounder(founder);
	}
	...
	public MEDICAL_BUSINESS(FoundingDate foundingDate) {
	...
	public MEDICAL_BUSINESS(FoundingLocation foundingLocation) {
	...
	public MEDICAL_BUSINESS(Funder funder) {
		setFunder(funder);
	}
	...
	public MEDICAL_BUSINESS(Geo geo) {
		setGeo(geo);
	}
	...
	public MEDICAL_BUSINESS(GeospatiallyContains geospatiallyContains) {
	...
	public MEDICAL_BUSINESS(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public MEDICAL_BUSINESS(GeospatiallyCovers geospatiallyCovers) {
	...
	public MEDICAL_BUSINESS(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public MEDICAL_BUSINESS(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public MEDICAL_BUSINESS(GeospatiallyEquals geospatiallyEquals) {
	...
	public MEDICAL_BUSINESS(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public MEDICAL_BUSINESS(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public MEDICAL_BUSINESS(GeospatiallyTouches geospatiallyTouches) {
	...
	public MEDICAL_BUSINESS(GeospatiallyWithin geospatiallyWithin) {
	...
	public MEDICAL_BUSINESS(GlobalLocationNumber globalLocationNumber) {
	...
	public MEDICAL_BUSINESS(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public MEDICAL_BUSINESS(HasOfferCatalog hasOfferCatalog) {
	...
	public MEDICAL_BUSINESS(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public MEDICAL_BUSINESS(Identifier identifier) {
	...
	public MEDICAL_BUSINESS(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_BUSINESS(IsAccessibleForFree isAccessibleForFree) {
	...
	public MEDICAL_BUSINESS(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public MEDICAL_BUSINESS(KnowsAbout knowsAbout) {
	...
	public MEDICAL_BUSINESS(KnowsLanguage knowsLanguage) {
	...
	public MEDICAL_BUSINESS(LegalName legalName) {
	...
	public MEDICAL_BUSINESS(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public MEDICAL_BUSINESS(Location location) {
	...
	public MEDICAL_BUSINESS(Logo logo) {
		setLogo(logo);
	}
	...
	public MEDICAL_BUSINESS(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_BUSINESS(MakesOffer makesOffer) {
	...
	public MEDICAL_BUSINESS(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public MEDICAL_BUSINESS(Member member) {
		setMember(member);
	}
	...
	public MEDICAL_BUSINESS(MemberOf memberOf) {
	...
	public MEDICAL_BUSINESS(Naics naics) {
		setNaics(naics);
	}
	...
	public MEDICAL_BUSINESS(Name name) {
		setName(name);
	}
	...
	public MEDICAL_BUSINESS(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_BUSINESS(NameRuby nameRuby) {
	...
	public MEDICAL_BUSINESS(NumberOfEmployees numberOfEmployees) {
	...
	public MEDICAL_BUSINESS(OpeningHours openingHours) {
	...
	public MEDICAL_BUSINESS(OpeningHoursSpecification openingHoursSpecification) {
	...
	public MEDICAL_BUSINESS(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public MEDICAL_BUSINESS(Owns owns) {
		setOwns(owns);
	}
	...
	public MEDICAL_BUSINESS(ParentOrganization parentOrganization) {
	...
	public MEDICAL_BUSINESS(PaymentAccepted paymentAccepted) {
	...
	public MEDICAL_BUSINESS(Photo photo) {
		setPhoto(photo);
	}
	...
	public MEDICAL_BUSINESS(PotentialAction potentialAction) {
	...
	public MEDICAL_BUSINESS(PriceRange priceRange) {
	...
	public MEDICAL_BUSINESS(PublicAccess publicAccess) {
	...
	public MEDICAL_BUSINESS(PublishingPrinciples publishingPrinciples) {
	...
	public MEDICAL_BUSINESS(Review review) {
		setReview(review);
	}
	...
	public MEDICAL_BUSINESS(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_BUSINESS(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public MEDICAL_BUSINESS(SmokingAllowed smokingAllowed) {
	...
	public MEDICAL_BUSINESS(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public MEDICAL_BUSINESS(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MEDICAL_BUSINESS(SubOrganization subOrganization) {
	...
	public MEDICAL_BUSINESS(SubjectOf subjectOf) {
	...
	public MEDICAL_BUSINESS(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public MEDICAL_BUSINESS(Telephone telephone) {
	...
	public MEDICAL_BUSINESS(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public MEDICAL_BUSINESS(Url url) {
		setUrl(url);
	}
	...
	public MEDICAL_BUSINESS(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.MedicalBusiness org) {
		setSeq(org.getSeq());
