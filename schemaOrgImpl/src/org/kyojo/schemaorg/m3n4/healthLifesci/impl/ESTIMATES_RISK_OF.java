...
public class ESTIMATES_RISK_OF implements Container.EstimatesRiskOf {
	...
	public ESTIMATES_RISK_OF(String string) {
	...
	public ESTIMATES_RISK_OF(AnatomicalStructure anatomicalStructure) {
	...
	public ESTIMATES_RISK_OF(AnatomicalSystem anatomicalSystem) {
	...
	public ESTIMATES_RISK_OF(ApprovedIndication approvedIndication) {
	...
	public ESTIMATES_RISK_OF(Artery artery) {
	...
	public ESTIMATES_RISK_OF(BloodTest bloodTest) {
	...
	public ESTIMATES_RISK_OF(Bone bone) {
	...
	public ESTIMATES_RISK_OF(BrainStructure brainStructure) {
	...
	public ESTIMATES_RISK_OF(DDxElement ddxElement) {
	...
	public ESTIMATES_RISK_OF(DiagnosticProcedure diagnosticProcedure) {
	...
	public ESTIMATES_RISK_OF(Diet diet) {
	...
	public ESTIMATES_RISK_OF(DietarySupplement dietarySupplement) {
	...
	public ESTIMATES_RISK_OF(DoseSchedule doseSchedule) {
	...
	public ESTIMATES_RISK_OF(Drug drug) {
	...
	public ESTIMATES_RISK_OF(DrugLegalStatus drugLegalStatus) {
	...
	public ESTIMATES_RISK_OF(DrugStrength drugStrength) {
	...
	public ESTIMATES_RISK_OF(ExercisePlan exercisePlan) {
	...
	public ESTIMATES_RISK_OF(ImagingTest imagingTest) {
	...
	public ESTIMATES_RISK_OF(InfectiousDisease infectiousDisease) {
	...
	public ESTIMATES_RISK_OF(Joint joint) {
	...
	public ESTIMATES_RISK_OF(LifestyleModification lifestyleModification) {
	...
	public ESTIMATES_RISK_OF(Ligament ligament) {
	...
	public ESTIMATES_RISK_OF(LymphaticVessel lymphaticVessel) {
	...
	public ESTIMATES_RISK_OF(MaximumDoseSchedule maximumDoseSchedule) {
	...
	public ESTIMATES_RISK_OF(MedicalCause medicalCause) {
	...
	public ESTIMATES_RISK_OF(MedicalCode medicalCode) {
	...
	public ESTIMATES_RISK_OF(MedicalCondition medicalCondition) {
	...
	public ESTIMATES_RISK_OF(MedicalConditionStage medicalConditionStage) {
	...
	public ESTIMATES_RISK_OF(MedicalContraindication medicalContraindication) {
	...
	public ESTIMATES_RISK_OF(MedicalDevice medicalDevice) {
	...
	public ESTIMATES_RISK_OF(MedicalEntity medicalEntity) {
		medicalEntityList = new ArrayList<MedicalEntity>();
	...
	public ESTIMATES_RISK_OF(MedicalGuideline medicalGuideline) {
	...
	public ESTIMATES_RISK_OF(MedicalGuidelineContraindication medicalGuidelineContraindication) {
	...
	public ESTIMATES_RISK_OF(MedicalGuidelineRecommendation medicalGuidelineRecommendation) {
	...
	public ESTIMATES_RISK_OF(MedicalIndication medicalIndication) {
	...
	public ESTIMATES_RISK_OF(MedicalIntangible medicalIntangible) {
	...
	public ESTIMATES_RISK_OF(MedicalObservationalStudy medicalObservationalStudy) {
	...
	public ESTIMATES_RISK_OF(MedicalProcedure medicalProcedure) {
	...
	public ESTIMATES_RISK_OF(MedicalRiskCalculator medicalRiskCalculator) {
	...
	public ESTIMATES_RISK_OF(MedicalRiskEstimator medicalRiskEstimator) {
	...
	public ESTIMATES_RISK_OF(MedicalRiskFactor medicalRiskFactor) {
	...
	public ESTIMATES_RISK_OF(MedicalRiskScore medicalRiskScore) {
	...
	public ESTIMATES_RISK_OF(MedicalSign medicalSign) {
	...
	public ESTIMATES_RISK_OF(MedicalSignOrSymptom medicalSignOrSymptom) {
	...
	public ESTIMATES_RISK_OF(MedicalStudy medicalStudy) {
	...
	public ESTIMATES_RISK_OF(MedicalSymptom medicalSymptom) {
	...
	public ESTIMATES_RISK_OF(MedicalTest medicalTest) {
	...
	public ESTIMATES_RISK_OF(MedicalTestPanel medicalTestPanel) {
	...
	public ESTIMATES_RISK_OF(MedicalTherapy medicalTherapy) {
	...
	public ESTIMATES_RISK_OF(MedicalTrial medicalTrial) {
	...
	public ESTIMATES_RISK_OF(Muscle muscle) {
	...
	public ESTIMATES_RISK_OF(Nerve nerve) {
	...
	public ESTIMATES_RISK_OF(OccupationalTherapy occupationalTherapy) {
	...
	public ESTIMATES_RISK_OF(PalliativeProcedure palliativeProcedure) {
	...
	public ESTIMATES_RISK_OF(PathologyTest pathologyTest) {
	...
	public ESTIMATES_RISK_OF(PhysicalActivity physicalActivity) {
	...
	public ESTIMATES_RISK_OF(PhysicalExam physicalExam) {
	...
	public ESTIMATES_RISK_OF(PhysicalTherapy physicalTherapy) {
	...
	public ESTIMATES_RISK_OF(PreventionIndication preventionIndication) {
	...
	public ESTIMATES_RISK_OF(PsychologicalTreatment psychologicalTreatment) {
	...
	public ESTIMATES_RISK_OF(RadiationTherapy radiationTherapy) {
	...
	public ESTIMATES_RISK_OF(RecommendedDoseSchedule recommendedDoseSchedule) {
	...
	public ESTIMATES_RISK_OF(ReportedDoseSchedule reportedDoseSchedule) {
	...
	public ESTIMATES_RISK_OF(RespiratoryTherapy respiratoryTherapy) {
	...
	public ESTIMATES_RISK_OF(Substance substance) {
	...
	public ESTIMATES_RISK_OF(SuperficialAnatomy superficialAnatomy) {
	...
	public ESTIMATES_RISK_OF(SurgicalProcedure surgicalProcedure) {
	...
	public ESTIMATES_RISK_OF(TherapeuticProcedure therapeuticProcedure) {
	...
	public ESTIMATES_RISK_OF(TreatmentIndication treatmentIndication) {
	...
	public ESTIMATES_RISK_OF(Vein vein) {
	...
	public ESTIMATES_RISK_OF(Vessel vessel) {
	...
	public ESTIMATES_RISK_OF(VitalSign vitalSign) {
	...
	public void copy(Container.EstimatesRiskOf org) {
