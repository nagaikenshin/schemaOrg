...
public class DIET implements Clazz.Diet, Container.Diet {
	...
	public DIET(AggregateRating aggregateRating) {
	...
	public DIET(MedicineSystem medicineSystem) {
