...
public class RELATED_STRUCTURE implements Container.RelatedStructure {
	...
	public RELATED_STRUCTURE(String string) {
	...
	public RELATED_STRUCTURE(AnatomicalStructure anatomicalStructure) {
		anatomicalStructureList = new ArrayList<AnatomicalStructure>();
	...
	public RELATED_STRUCTURE(Artery artery) {
	...
	public RELATED_STRUCTURE(Bone bone) {
	...
	public RELATED_STRUCTURE(BrainStructure brainStructure) {
	...
	public RELATED_STRUCTURE(Joint joint) {
	...
	public RELATED_STRUCTURE(Ligament ligament) {
	...
	public RELATED_STRUCTURE(LymphaticVessel lymphaticVessel) {
	...
	public RELATED_STRUCTURE(Muscle muscle) {
	...
	public RELATED_STRUCTURE(Nerve nerve) {
	...
	public RELATED_STRUCTURE(Vein vein) {
	...
	public RELATED_STRUCTURE(Vessel vessel) {
	...
	public RELATED_STRUCTURE(List<AnatomicalStructure> anatomicalStructureList,
	...
	public void copy(Container.RelatedStructure org) {
