...
public class PREVENTION_INDICATION implements Clazz.PreventionIndication {
	...
	public PREVENTION_INDICATION() {
	}

	public PREVENTION_INDICATION(Long seq) {
		setSeq(seq);
	}

	public PREVENTION_INDICATION(String string) {
	...
	public PREVENTION_INDICATION(AdditionalType additionalType) {
	...
	public PREVENTION_INDICATION(AlternateName alternateName) {
	...
	public PREVENTION_INDICATION(Code code) {
		setCode(code);
	}
	...
	public PREVENTION_INDICATION(Description description) {
	...
	public PREVENTION_INDICATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public PREVENTION_INDICATION(Guideline guideline) {
	...
	public PREVENTION_INDICATION(Identifier identifier) {
	...
	public PREVENTION_INDICATION(Image image) {
		setImage(image);
	}
	...
	public PREVENTION_INDICATION(LegalStatus legalStatus) {
	...
	public PREVENTION_INDICATION(MainEntityOfPage mainEntityOfPage) {
	...
	public PREVENTION_INDICATION(MedicineSystem medicineSystem) {
	...
	public PREVENTION_INDICATION(Name name) {
		setName(name);
	}
	...
	public PREVENTION_INDICATION(NameFuzzy nameFuzzy) {
	...
	public PREVENTION_INDICATION(NameRuby nameRuby) {
	...
	public PREVENTION_INDICATION(PotentialAction potentialAction) {
	...
	public PREVENTION_INDICATION(RecognizingAuthority recognizingAuthority) {
	...
	public PREVENTION_INDICATION(RelevantSpecialty relevantSpecialty) {
	...
	public PREVENTION_INDICATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PREVENTION_INDICATION(Study study) {
		setStudy(study);
	}
	...
	public PREVENTION_INDICATION(SubjectOf subjectOf) {
	...
	public PREVENTION_INDICATION(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.PreventionIndication org) {
		setSeq(org.getSeq());
