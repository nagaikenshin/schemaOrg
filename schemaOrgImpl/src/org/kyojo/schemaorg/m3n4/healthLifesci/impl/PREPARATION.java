...
public class PREPARATION implements Container.Preparation {
	...
	public PREPARATION(AnatomicalStructure anatomicalStructure) {
	...
	public PREPARATION(AnatomicalSystem anatomicalSystem) {
	...
	public PREPARATION(ApprovedIndication approvedIndication) {
	...
	public PREPARATION(Artery artery) {
	...
	public PREPARATION(BloodTest bloodTest) {
	...
	public PREPARATION(BrainStructure brainStructure) {
	...
	public PREPARATION(DDxElement ddxElement) {
	...
	public PREPARATION(DiagnosticProcedure diagnosticProcedure) {
	...
	public PREPARATION(DietarySupplement dietarySupplement) {
	...
	public PREPARATION(DoseSchedule doseSchedule) {
	...
	public PREPARATION(DrugLegalStatus drugLegalStatus) {
	...
	public PREPARATION(DrugStrength drugStrength) {
	...
	public PREPARATION(ExercisePlan exercisePlan) {
	...
	public PREPARATION(ImagingTest imagingTest) {
	...
	public PREPARATION(InfectiousDisease infectiousDisease) {
	...
	public PREPARATION(Joint joint) {
	...
	public PREPARATION(LifestyleModification lifestyleModification) {
	...
	public PREPARATION(Ligament ligament) {
	...
	public PREPARATION(LymphaticVessel lymphaticVessel) {
	...
	public PREPARATION(MaximumDoseSchedule maximumDoseSchedule) {
	...
	public PREPARATION(MedicalCause medicalCause) {
	...
	public PREPARATION(MedicalCode medicalCode) {
	...
	public PREPARATION(MedicalCondition medicalCondition) {
	...
	public PREPARATION(MedicalConditionStage medicalConditionStage) {
	...
	public PREPARATION(MedicalContraindication medicalContraindication) {
	...
	public PREPARATION(MedicalDevice medicalDevice) {
	...
	public PREPARATION(MedicalGuideline medicalGuideline) {
	...
	public PREPARATION(MedicalGuidelineContraindication medicalGuidelineContraindication) {
	...
	public PREPARATION(MedicalGuidelineRecommendation medicalGuidelineRecommendation) {
	...
	public PREPARATION(MedicalIndication medicalIndication) {
	...
	public PREPARATION(MedicalIntangible medicalIntangible) {
	...
	public PREPARATION(MedicalObservationalStudy medicalObservationalStudy) {
	...
	public PREPARATION(MedicalProcedure medicalProcedure) {
	...
	public PREPARATION(MedicalRiskCalculator medicalRiskCalculator) {
	...
	public PREPARATION(MedicalRiskEstimator medicalRiskEstimator) {
	...
	public PREPARATION(MedicalRiskFactor medicalRiskFactor) {
	...
	public PREPARATION(MedicalRiskScore medicalRiskScore) {
	...
	public PREPARATION(MedicalSign medicalSign) {
	...
	public PREPARATION(MedicalSignOrSymptom medicalSignOrSymptom) {
	...
	public PREPARATION(MedicalStudy medicalStudy) {
	...
	public PREPARATION(MedicalSymptom medicalSymptom) {
	...
	public PREPARATION(MedicalTest medicalTest) {
	...
	public PREPARATION(MedicalTestPanel medicalTestPanel) {
	...
	public PREPARATION(MedicalTherapy medicalTherapy) {
	...
	public PREPARATION(MedicalTrial medicalTrial) {
	...
	public PREPARATION(Muscle muscle) {
	...
	public PREPARATION(Nerve nerve) {
	...
	public PREPARATION(OccupationalTherapy occupationalTherapy) {
	...
	public PREPARATION(PalliativeProcedure palliativeProcedure) {
	...
	public PREPARATION(PathologyTest pathologyTest) {
	...
	public PREPARATION(PhysicalActivity physicalActivity) {
	...
	public PREPARATION(PhysicalExam physicalExam) {
	...
	public PREPARATION(PhysicalTherapy physicalTherapy) {
	...
	public PREPARATION(PreventionIndication preventionIndication) {
	...
	public PREPARATION(PsychologicalTreatment psychologicalTreatment) {
	...
	public PREPARATION(RadiationTherapy radiationTherapy) {
	...
	public PREPARATION(RecommendedDoseSchedule recommendedDoseSchedule) {
	...
	public PREPARATION(ReportedDoseSchedule reportedDoseSchedule) {
	...
	public PREPARATION(RespiratoryTherapy respiratoryTherapy) {
	...
	public PREPARATION(Substance substance) {
	...
	public PREPARATION(SuperficialAnatomy superficialAnatomy) {
	...
	public PREPARATION(SurgicalProcedure surgicalProcedure) {
	...
	public PREPARATION(TherapeuticProcedure therapeuticProcedure) {
	...
	public PREPARATION(TreatmentIndication treatmentIndication) {
	...
	public PREPARATION(Vessel vessel) {
	...
	public PREPARATION(VitalSign vitalSign) {
