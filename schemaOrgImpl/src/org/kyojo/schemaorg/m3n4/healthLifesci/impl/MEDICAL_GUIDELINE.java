...
public class MEDICAL_GUIDELINE implements Clazz.MedicalGuideline {
	...
	public MEDICAL_GUIDELINE() {
	}

	public MEDICAL_GUIDELINE(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_GUIDELINE(String string) {
	...
	public MEDICAL_GUIDELINE(AdditionalType additionalType) {
	...
	public MEDICAL_GUIDELINE(AlternateName alternateName) {
	...
	public MEDICAL_GUIDELINE(Code code) {
		setCode(code);
	}
	...
	public MEDICAL_GUIDELINE(Description description) {
	...
	public MEDICAL_GUIDELINE(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_GUIDELINE(EvidenceLevel evidenceLevel) {
	...
	public MEDICAL_GUIDELINE(EvidenceOrigin evidenceOrigin) {
	...
	public MEDICAL_GUIDELINE(Guideline guideline) {
	...
	public MEDICAL_GUIDELINE(GuidelineDate guidelineDate) {
	...
	public MEDICAL_GUIDELINE(GuidelineSubject guidelineSubject) {
	...
	public MEDICAL_GUIDELINE(Identifier identifier) {
	...
	public MEDICAL_GUIDELINE(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_GUIDELINE(LegalStatus legalStatus) {
	...
	public MEDICAL_GUIDELINE(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_GUIDELINE(MedicineSystem medicineSystem) {
	...
	public MEDICAL_GUIDELINE(Name name) {
		setName(name);
	}
	...
	public MEDICAL_GUIDELINE(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_GUIDELINE(NameRuby nameRuby) {
	...
	public MEDICAL_GUIDELINE(PotentialAction potentialAction) {
	...
	public MEDICAL_GUIDELINE(RecognizingAuthority recognizingAuthority) {
	...
	public MEDICAL_GUIDELINE(RelevantSpecialty relevantSpecialty) {
	...
	public MEDICAL_GUIDELINE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_GUIDELINE(Study study) {
		setStudy(study);
	}
	...
	public MEDICAL_GUIDELINE(SubjectOf subjectOf) {
	...
	public MEDICAL_GUIDELINE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.MedicalGuideline org) {
		setSeq(org.getSeq());
