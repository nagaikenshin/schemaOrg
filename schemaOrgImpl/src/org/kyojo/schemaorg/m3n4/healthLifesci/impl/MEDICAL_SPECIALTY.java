...
public class MEDICAL_SPECIALTY implements Clazz.MedicalSpecialty, Container.MedicalSpecialty {
	...
	public MEDICAL_SPECIALTY(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_SPECIALTY(String string) {
	...
	public MEDICAL_SPECIALTY(AdditionalType additionalType) {
	...
	public MEDICAL_SPECIALTY(AlternateName alternateName) {
	...
	public MEDICAL_SPECIALTY(Description description) {
	...
	public MEDICAL_SPECIALTY(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_SPECIALTY(Identifier identifier) {
	...
	public MEDICAL_SPECIALTY(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_SPECIALTY(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_SPECIALTY(Clazz.MedicalSpecialty medicalSpecialty) {
		medicalSpecialtyList = new ArrayList<Clazz.MedicalSpecialty>();
	...
	public MEDICAL_SPECIALTY(Name name) {
		setName(name);
	}
	...
	public MEDICAL_SPECIALTY(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_SPECIALTY(NameRuby nameRuby) {
	...
	public MEDICAL_SPECIALTY(PotentialAction potentialAction) {
	...
	public MEDICAL_SPECIALTY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_SPECIALTY(SubjectOf subjectOf) {
	...
	public MEDICAL_SPECIALTY(SupersededBy supersededBy) {
	...
	public MEDICAL_SPECIALTY(Url url) {
		setUrl(url);
	}
	...
	public MEDICAL_SPECIALTY(Long seq,
			...
			List<Clazz.MedicalSpecialty> medicalSpecialtyList,
			Name name,
			NameFuzzy nameFuzzy,
			NameRuby nameRuby,
	...
	public void copy(Clazz.MedicalSpecialty org) {
		setSeq(org.getSeq());
	...
	public void copy(Container.MedicalSpecialty org) {
