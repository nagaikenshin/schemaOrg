...
public class TYPICAL_TEST implements Container.TypicalTest {
	...
	public TYPICAL_TEST(String string) {
	...
	public TYPICAL_TEST(BloodTest bloodTest) {
	...
	public TYPICAL_TEST(ImagingTest imagingTest) {
	...
	public TYPICAL_TEST(MedicalTest medicalTest) {
		medicalTestList = new ArrayList<MedicalTest>();
	...
	public TYPICAL_TEST(MedicalTestPanel medicalTestPanel) {
	...
	public TYPICAL_TEST(PathologyTest pathologyTest) {
	...
	public TYPICAL_TEST(List<BloodTest> bloodTestList,
	...
	public void copy(Container.TypicalTest org) {
