...
public class MEDICAL_INTANGIBLE implements Clazz.MedicalIntangible {
	...
	public MEDICAL_INTANGIBLE() {
	}

	public MEDICAL_INTANGIBLE(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_INTANGIBLE(String string) {
	...
	public MEDICAL_INTANGIBLE(AdditionalType additionalType) {
	...
	public MEDICAL_INTANGIBLE(AlternateName alternateName) {
	...
	public MEDICAL_INTANGIBLE(Code code) {
		setCode(code);
	}
	...
	public MEDICAL_INTANGIBLE(Description description) {
	...
	public MEDICAL_INTANGIBLE(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_INTANGIBLE(Guideline guideline) {
	...
	public MEDICAL_INTANGIBLE(Identifier identifier) {
	...
	public MEDICAL_INTANGIBLE(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_INTANGIBLE(LegalStatus legalStatus) {
	...
	public MEDICAL_INTANGIBLE(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_INTANGIBLE(MedicineSystem medicineSystem) {
	...
	public MEDICAL_INTANGIBLE(Name name) {
		setName(name);
	}
	...
	public MEDICAL_INTANGIBLE(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_INTANGIBLE(NameRuby nameRuby) {
	...
	public MEDICAL_INTANGIBLE(PotentialAction potentialAction) {
	...
	public MEDICAL_INTANGIBLE(RecognizingAuthority recognizingAuthority) {
	...
	public MEDICAL_INTANGIBLE(RelevantSpecialty relevantSpecialty) {
	...
	public MEDICAL_INTANGIBLE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_INTANGIBLE(Study study) {
		setStudy(study);
	}
	...
	public MEDICAL_INTANGIBLE(SubjectOf subjectOf) {
	...
	public MEDICAL_INTANGIBLE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.MedicalIntangible org) {
		setSeq(org.getSeq());
