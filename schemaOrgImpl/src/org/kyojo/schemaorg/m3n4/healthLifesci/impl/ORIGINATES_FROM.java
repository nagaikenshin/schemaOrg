...
public class ORIGINATES_FROM implements Container.OriginatesFrom {
	...
	public ORIGINATES_FROM(Artery artery) {
	...
	public ORIGINATES_FROM(LymphaticVessel lymphaticVessel) {
	...
	public ORIGINATES_FROM(Vein vein) {
	...
	public ORIGINATES_FROM(List<Artery> arteryList,
	...
	public void copy(Container.OriginatesFrom org) {
