...
public class OUTCOME implements Container.Outcome {
	...
	public OUTCOME(AnatomicalStructure anatomicalStructure) {
	...
	public OUTCOME(AnatomicalSystem anatomicalSystem) {
	...
	public OUTCOME(ApprovedIndication approvedIndication) {
	...
	public OUTCOME(BloodTest bloodTest) {
	...
	public OUTCOME(BrainStructure brainStructure) {
	...
	public OUTCOME(DDxElement ddxElement) {
	...
	public OUTCOME(DiagnosticProcedure diagnosticProcedure) {
	...
	public OUTCOME(DietarySupplement dietarySupplement) {
	...
	public OUTCOME(DoseSchedule doseSchedule) {
	...
	public OUTCOME(DrugLegalStatus drugLegalStatus) {
	...
	public OUTCOME(DrugStrength drugStrength) {
	...
	public OUTCOME(ExercisePlan exercisePlan) {
	...
	public OUTCOME(ImagingTest imagingTest) {
	...
	public OUTCOME(InfectiousDisease infectiousDisease) {
	...
	public OUTCOME(LifestyleModification lifestyleModification) {
	...
	public OUTCOME(Ligament ligament) {
	...
	public OUTCOME(LymphaticVessel lymphaticVessel) {
	...
	public OUTCOME(MaximumDoseSchedule maximumDoseSchedule) {
	...
	public OUTCOME(MedicalCause medicalCause) {
	...
	public OUTCOME(MedicalCode medicalCode) {
	...
	public OUTCOME(MedicalCondition medicalCondition) {
	...
	public OUTCOME(MedicalConditionStage medicalConditionStage) {
	...
	public OUTCOME(MedicalContraindication medicalContraindication) {
	...
	public OUTCOME(MedicalDevice medicalDevice) {
	...
	public OUTCOME(MedicalEntity medicalEntity) {
	...
	public OUTCOME(MedicalGuideline medicalGuideline) {
	...
	public OUTCOME(MedicalGuidelineContraindication medicalGuidelineContraindication) {
	...
	public OUTCOME(MedicalGuidelineRecommendation medicalGuidelineRecommendation) {
	...
	public OUTCOME(MedicalIndication medicalIndication) {
	...
	public OUTCOME(MedicalIntangible medicalIntangible) {
	...
	public OUTCOME(MedicalObservationalStudy medicalObservationalStudy) {
	...
	public OUTCOME(MedicalProcedure medicalProcedure) {
	...
	public OUTCOME(MedicalRiskCalculator medicalRiskCalculator) {
	...
	public OUTCOME(MedicalRiskEstimator medicalRiskEstimator) {
	...
	public OUTCOME(MedicalRiskFactor medicalRiskFactor) {
	...
	public OUTCOME(MedicalRiskScore medicalRiskScore) {
	...
	public OUTCOME(MedicalSign medicalSign) {
	...
	public OUTCOME(MedicalSignOrSymptom medicalSignOrSymptom) {
	...
	public OUTCOME(MedicalStudy medicalStudy) {
	...
	public OUTCOME(MedicalSymptom medicalSymptom) {
	...
	public OUTCOME(MedicalTest medicalTest) {
	...
	public OUTCOME(MedicalTestPanel medicalTestPanel) {
	...
	public OUTCOME(MedicalTherapy medicalTherapy) {
	...
	public OUTCOME(MedicalTrial medicalTrial) {
	...
	public OUTCOME(OccupationalTherapy occupationalTherapy) {
	...
	public OUTCOME(PalliativeProcedure palliativeProcedure) {
	...
	public OUTCOME(PathologyTest pathologyTest) {
	...
	public OUTCOME(PhysicalActivity physicalActivity) {
	...
	public OUTCOME(PhysicalExam physicalExam) {
	...
	public OUTCOME(PhysicalTherapy physicalTherapy) {
	...
	public OUTCOME(PreventionIndication preventionIndication) {
	...
	public OUTCOME(PsychologicalTreatment psychologicalTreatment) {
	...
	public OUTCOME(RadiationTherapy radiationTherapy) {
	...
	public OUTCOME(RecommendedDoseSchedule recommendedDoseSchedule) {
	...
	public OUTCOME(ReportedDoseSchedule reportedDoseSchedule) {
	...
	public OUTCOME(RespiratoryTherapy respiratoryTherapy) {
	...
	public OUTCOME(Substance substance) {
	...
	public OUTCOME(SuperficialAnatomy superficialAnatomy) {
	...
	public OUTCOME(SurgicalProcedure surgicalProcedure) {
	...
	public OUTCOME(TherapeuticProcedure therapeuticProcedure) {
	...
	public OUTCOME(TreatmentIndication treatmentIndication) {
	...
	public OUTCOME(VitalSign vitalSign) {
	...
	public void copy(Container.Outcome org) {
