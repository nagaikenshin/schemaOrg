...
public class SUB_TEST implements Container.SubTest {
	...
	public SUB_TEST(BloodTest bloodTest) {
	...
	public SUB_TEST(ImagingTest imagingTest) {
	...
	public SUB_TEST(MedicalTest medicalTest) {
		medicalTestList = new ArrayList<MedicalTest>();
	...
	public SUB_TEST(MedicalTestPanel medicalTestPanel) {
	...
	public SUB_TEST(PathologyTest pathologyTest) {
	...
	public SUB_TEST(List<BloodTest> bloodTestList,
	...
	public void copy(Container.SubTest org) {
