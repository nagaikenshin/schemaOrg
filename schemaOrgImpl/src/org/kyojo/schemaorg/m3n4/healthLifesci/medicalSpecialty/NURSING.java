...
public class NURSING implements MedicalSpecialty.Nursing {
	...
	public NURSING(Long seq) {
		setSeq(seq);
	}

	public NURSING(String string) {
	...
	public NURSING(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public NURSING(AdditionalProperty additionalProperty) {
	...
	public NURSING(AdditionalType additionalType) {
	...
	public NURSING(Address address) {
		setAddress(address);
	}
	...
	public NURSING(AggregateRating aggregateRating) {
	...
	public NURSING(AlternateName alternateName) {
	...
	public NURSING(AmenityFeature amenityFeature) {
	...
	public NURSING(AreaServed areaServed) {
	...
	public NURSING(BranchCode branchCode) {
	...
	public NURSING(ContactPoint contactPoint) {
	...
	public NURSING(ContainedInPlace containedInPlace) {
	...
	public NURSING(ContainsPlace containsPlace) {
	...
	public NURSING(CorrectionsPolicy correctionsPolicy) {
	...
	public NURSING(CurrenciesAccepted currenciesAccepted) {
	...
	public NURSING(Department department) {
	...
	public NURSING(Description description) {
	...
	public NURSING(DisambiguatingDescription disambiguatingDescription) {
	...
	public NURSING(DissolutionDate dissolutionDate) {
	...
	public NURSING(DiversityPolicy diversityPolicy) {
	...
	public NURSING(DiversityStaffingReport diversityStaffingReport) {
	...
	public NURSING(Employee employee) {
	...
	public NURSING(EthicsPolicy ethicsPolicy) {
	...
	public NURSING(FaxNumber faxNumber) {
	...
	public NURSING(Founder founder) {
		setFounder(founder);
	}
	...
	public NURSING(FoundingDate foundingDate) {
	...
	public NURSING(FoundingLocation foundingLocation) {
	...
	public NURSING(GeospatiallyContains geospatiallyContains) {
	...
	public NURSING(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public NURSING(GeospatiallyCovers geospatiallyCovers) {
	...
	public NURSING(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public NURSING(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public NURSING(GeospatiallyEquals geospatiallyEquals) {
	...
	public NURSING(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public NURSING(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public NURSING(GeospatiallyTouches geospatiallyTouches) {
	...
	public NURSING(GeospatiallyWithin geospatiallyWithin) {
	...
	public NURSING(GlobalLocationNumber globalLocationNumber) {
	...
	public NURSING(HasOfferCatalog hasOfferCatalog) {
	...
	public NURSING(Identifier identifier) {
	...
	public NURSING(IsAccessibleForFree isAccessibleForFree) {
	...
	public NURSING(KnowsAbout knowsAbout) {
	...
	public NURSING(KnowsLanguage knowsLanguage) {
	...
	public NURSING(LegalName legalName) {
	...
	public NURSING(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public NURSING(Location location) {
	...
	public NURSING(MainEntityOfPage mainEntityOfPage) {
	...
	public NURSING(MakesOffer makesOffer) {
	...
	public NURSING(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public NURSING(MemberOf memberOf) {
	...
	public NURSING(NameFuzzy nameFuzzy) {
	...
	public NURSING(NameRuby nameRuby) {
	...
	public NURSING(NumberOfEmployees numberOfEmployees) {
	...
	public NURSING(OpeningHours openingHours) {
	...
	public NURSING(OpeningHoursSpecification openingHoursSpecification) {
	...
	public NURSING(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public NURSING(ParentOrganization parentOrganization) {
	...
	public NURSING(PaymentAccepted paymentAccepted) {
	...
	public NURSING(PotentialAction potentialAction) {
	...
	public NURSING(PriceRange priceRange) {
	...
	public NURSING(PublicAccess publicAccess) {
	...
	public NURSING(PublishingPrinciples publishingPrinciples) {
	...
	public NURSING(SmokingAllowed smokingAllowed) {
	...
	public NURSING(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public NURSING(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public NURSING(SubOrganization subOrganization) {
	...
	public NURSING(SubjectOf subjectOf) {
	...
	public NURSING(SupersededBy supersededBy) {
	...
	public NURSING(Telephone telephone) {
	...
	public NURSING(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(MedicalSpecialty.Nursing org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalSpecialty.Nursing.class.getAnnotation(SampleValue.class).value();
	}
