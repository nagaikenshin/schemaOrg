...
public class MIDWIFERY implements MedicalSpecialty.Midwifery {
	...
	public MIDWIFERY(Long seq) {
		setSeq(seq);
	}

	public MIDWIFERY(String string) {
	...
	public MIDWIFERY(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public MIDWIFERY(AdditionalProperty additionalProperty) {
	...
	public MIDWIFERY(AdditionalType additionalType) {
	...
	public MIDWIFERY(Address address) {
		setAddress(address);
	}
	...
	public MIDWIFERY(AggregateRating aggregateRating) {
	...
	public MIDWIFERY(AlternateName alternateName) {
	...
	public MIDWIFERY(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public MIDWIFERY(AmenityFeature amenityFeature) {
	...
	public MIDWIFERY(AreaServed areaServed) {
	...
	public MIDWIFERY(BranchCode branchCode) {
	...
	public MIDWIFERY(ContactPoint contactPoint) {
	...
	public MIDWIFERY(ContainedInPlace containedInPlace) {
	...
	public MIDWIFERY(ContainsPlace containsPlace) {
	...
	public MIDWIFERY(CorrectionsPolicy correctionsPolicy) {
	...
	public MIDWIFERY(CurrenciesAccepted currenciesAccepted) {
	...
	public MIDWIFERY(Department department) {
	...
	public MIDWIFERY(Description description) {
	...
	public MIDWIFERY(DisambiguatingDescription disambiguatingDescription) {
	...
	public MIDWIFERY(DissolutionDate dissolutionDate) {
	...
	public MIDWIFERY(DiversityPolicy diversityPolicy) {
	...
	public MIDWIFERY(DiversityStaffingReport diversityStaffingReport) {
	...
	public MIDWIFERY(Employee employee) {
	...
	public MIDWIFERY(EthicsPolicy ethicsPolicy) {
	...
	public MIDWIFERY(FaxNumber faxNumber) {
	...
	public MIDWIFERY(Founder founder) {
		setFounder(founder);
	}
	...
	public MIDWIFERY(FoundingDate foundingDate) {
	...
	public MIDWIFERY(FoundingLocation foundingLocation) {
	...
	public MIDWIFERY(Funder funder) {
		setFunder(funder);
	}
	...
	public MIDWIFERY(GeospatiallyContains geospatiallyContains) {
	...
	public MIDWIFERY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public MIDWIFERY(GeospatiallyCovers geospatiallyCovers) {
	...
	public MIDWIFERY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public MIDWIFERY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public MIDWIFERY(GeospatiallyEquals geospatiallyEquals) {
	...
	public MIDWIFERY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public MIDWIFERY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public MIDWIFERY(GeospatiallyTouches geospatiallyTouches) {
	...
	public MIDWIFERY(GeospatiallyWithin geospatiallyWithin) {
	...
	public MIDWIFERY(GlobalLocationNumber globalLocationNumber) {
	...
	public MIDWIFERY(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public MIDWIFERY(HasOfferCatalog hasOfferCatalog) {
	...
	public MIDWIFERY(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public MIDWIFERY(Identifier identifier) {
	...
	public MIDWIFERY(IsAccessibleForFree isAccessibleForFree) {
	...
	public MIDWIFERY(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public MIDWIFERY(KnowsAbout knowsAbout) {
	...
	public MIDWIFERY(KnowsLanguage knowsLanguage) {
	...
	public MIDWIFERY(LegalName legalName) {
	...
	public MIDWIFERY(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public MIDWIFERY(Location location) {
	...
	public MIDWIFERY(MainEntityOfPage mainEntityOfPage) {
	...
	public MIDWIFERY(MakesOffer makesOffer) {
	...
	public MIDWIFERY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public MIDWIFERY(Member member) {
		setMember(member);
	}
	...
	public MIDWIFERY(MemberOf memberOf) {
	...
	public MIDWIFERY(NameFuzzy nameFuzzy) {
	...
	public MIDWIFERY(NameRuby nameRuby) {
	...
	public MIDWIFERY(NumberOfEmployees numberOfEmployees) {
	...
	public MIDWIFERY(OpeningHours openingHours) {
	...
	public MIDWIFERY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public MIDWIFERY(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public MIDWIFERY(ParentOrganization parentOrganization) {
	...
	public MIDWIFERY(PaymentAccepted paymentAccepted) {
	...
	public MIDWIFERY(PotentialAction potentialAction) {
	...
	public MIDWIFERY(PriceRange priceRange) {
	...
	public MIDWIFERY(PublicAccess publicAccess) {
	...
	public MIDWIFERY(PublishingPrinciples publishingPrinciples) {
	...
	public MIDWIFERY(Review review) {
		setReview(review);
	}
	...
	public MIDWIFERY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MIDWIFERY(SmokingAllowed smokingAllowed) {
	...
	public MIDWIFERY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public MIDWIFERY(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MIDWIFERY(SubOrganization subOrganization) {
	...
	public MIDWIFERY(SubjectOf subjectOf) {
	...
	public MIDWIFERY(SupersededBy supersededBy) {
	...
	public MIDWIFERY(Telephone telephone) {
	...
	public MIDWIFERY(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(MedicalSpecialty.Midwifery org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalSpecialty.Midwifery.class.getAnnotation(SampleValue.class).value();
	}
