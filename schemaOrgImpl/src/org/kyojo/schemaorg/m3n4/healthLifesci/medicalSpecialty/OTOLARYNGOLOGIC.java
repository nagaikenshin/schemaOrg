...
public class OTOLARYNGOLOGIC implements MedicalSpecialty.Otolaryngologic {
	...
	public OTOLARYNGOLOGIC() {
	}

	public OTOLARYNGOLOGIC(Long seq) {
		setSeq(seq);
	}

	public OTOLARYNGOLOGIC(String string) {
	...
	public OTOLARYNGOLOGIC(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public OTOLARYNGOLOGIC(AdditionalProperty additionalProperty) {
	...
	public OTOLARYNGOLOGIC(AdditionalType additionalType) {
	...
	public OTOLARYNGOLOGIC(Address address) {
		setAddress(address);
	}
	...
	public OTOLARYNGOLOGIC(AggregateRating aggregateRating) {
	...
	public OTOLARYNGOLOGIC(AlternateName alternateName) {
	...
	public OTOLARYNGOLOGIC(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public OTOLARYNGOLOGIC(AmenityFeature amenityFeature) {
	...
	public OTOLARYNGOLOGIC(AreaServed areaServed) {
	...
	public OTOLARYNGOLOGIC(Award award) {
		setAward(award);
	}
	...
	public OTOLARYNGOLOGIC(BranchCode branchCode) {
	...
	public OTOLARYNGOLOGIC(Brand brand) {
		setBrand(brand);
	}
	...
	public OTOLARYNGOLOGIC(ContactPoint contactPoint) {
	...
	public OTOLARYNGOLOGIC(ContainedInPlace containedInPlace) {
	...
	public OTOLARYNGOLOGIC(ContainsPlace containsPlace) {
	...
	public OTOLARYNGOLOGIC(CorrectionsPolicy correctionsPolicy) {
	...
	public OTOLARYNGOLOGIC(CurrenciesAccepted currenciesAccepted) {
	...
	public OTOLARYNGOLOGIC(Department department) {
	...
	public OTOLARYNGOLOGIC(Description description) {
	...
	public OTOLARYNGOLOGIC(DisambiguatingDescription disambiguatingDescription) {
	...
	public OTOLARYNGOLOGIC(DissolutionDate dissolutionDate) {
	...
	public OTOLARYNGOLOGIC(DiversityPolicy diversityPolicy) {
	...
	public OTOLARYNGOLOGIC(DiversityStaffingReport diversityStaffingReport) {
	...
	public OTOLARYNGOLOGIC(Duns duns) {
		setDuns(duns);
	}
	...
	public OTOLARYNGOLOGIC(Email email) {
		setEmail(email);
	}
	...
	public OTOLARYNGOLOGIC(Employee employee) {
	...
	public OTOLARYNGOLOGIC(EthicsPolicy ethicsPolicy) {
	...
	public OTOLARYNGOLOGIC(Event event) {
		setEvent(event);
	}
	...
	public OTOLARYNGOLOGIC(FaxNumber faxNumber) {
	...
	public OTOLARYNGOLOGIC(Founder founder) {
		setFounder(founder);
	}
	...
	public OTOLARYNGOLOGIC(FoundingDate foundingDate) {
	...
	public OTOLARYNGOLOGIC(FoundingLocation foundingLocation) {
	...
	public OTOLARYNGOLOGIC(Funder funder) {
		setFunder(funder);
	}
	...
	public OTOLARYNGOLOGIC(Geo geo) {
		setGeo(geo);
	}
	...
	public OTOLARYNGOLOGIC(GeospatiallyContains geospatiallyContains) {
	...
	public OTOLARYNGOLOGIC(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public OTOLARYNGOLOGIC(GeospatiallyCovers geospatiallyCovers) {
	...
	public OTOLARYNGOLOGIC(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public OTOLARYNGOLOGIC(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public OTOLARYNGOLOGIC(GeospatiallyEquals geospatiallyEquals) {
	...
	public OTOLARYNGOLOGIC(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public OTOLARYNGOLOGIC(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public OTOLARYNGOLOGIC(GeospatiallyTouches geospatiallyTouches) {
	...
	public OTOLARYNGOLOGIC(GeospatiallyWithin geospatiallyWithin) {
	...
	public OTOLARYNGOLOGIC(GlobalLocationNumber globalLocationNumber) {
	...
	public OTOLARYNGOLOGIC(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public OTOLARYNGOLOGIC(HasOfferCatalog hasOfferCatalog) {
	...
	public OTOLARYNGOLOGIC(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public OTOLARYNGOLOGIC(Identifier identifier) {
	...
	public OTOLARYNGOLOGIC(Image image) {
		setImage(image);
	}
	...
	public OTOLARYNGOLOGIC(IsAccessibleForFree isAccessibleForFree) {
	...
	public OTOLARYNGOLOGIC(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public OTOLARYNGOLOGIC(KnowsAbout knowsAbout) {
	...
	public OTOLARYNGOLOGIC(KnowsLanguage knowsLanguage) {
	...
	public OTOLARYNGOLOGIC(LegalName legalName) {
	...
	public OTOLARYNGOLOGIC(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public OTOLARYNGOLOGIC(Location location) {
	...
	public OTOLARYNGOLOGIC(Logo logo) {
		setLogo(logo);
	}
	...
	public OTOLARYNGOLOGIC(MainEntityOfPage mainEntityOfPage) {
	...
	public OTOLARYNGOLOGIC(MakesOffer makesOffer) {
	...
	public OTOLARYNGOLOGIC(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public OTOLARYNGOLOGIC(Member member) {
		setMember(member);
	}
	...
	public OTOLARYNGOLOGIC(MemberOf memberOf) {
	...
	public OTOLARYNGOLOGIC(Naics naics) {
		setNaics(naics);
	}
	...
	public OTOLARYNGOLOGIC(Name name) {
		setName(name);
	}
	...
	public OTOLARYNGOLOGIC(NameFuzzy nameFuzzy) {
	...
	public OTOLARYNGOLOGIC(NameRuby nameRuby) {
	...
	public OTOLARYNGOLOGIC(NumberOfEmployees numberOfEmployees) {
	...
	public OTOLARYNGOLOGIC(OpeningHours openingHours) {
	...
	public OTOLARYNGOLOGIC(OpeningHoursSpecification openingHoursSpecification) {
	...
	public OTOLARYNGOLOGIC(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public OTOLARYNGOLOGIC(Owns owns) {
		setOwns(owns);
	}
	...
	public OTOLARYNGOLOGIC(ParentOrganization parentOrganization) {
	...
	public OTOLARYNGOLOGIC(PaymentAccepted paymentAccepted) {
	...
	public OTOLARYNGOLOGIC(Photo photo) {
		setPhoto(photo);
	}
	...
	public OTOLARYNGOLOGIC(PotentialAction potentialAction) {
	...
	public OTOLARYNGOLOGIC(PriceRange priceRange) {
	...
	public OTOLARYNGOLOGIC(PublicAccess publicAccess) {
	...
	public OTOLARYNGOLOGIC(PublishingPrinciples publishingPrinciples) {
	...
	public OTOLARYNGOLOGIC(Review review) {
		setReview(review);
	}
	...
	public OTOLARYNGOLOGIC(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public OTOLARYNGOLOGIC(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public OTOLARYNGOLOGIC(SmokingAllowed smokingAllowed) {
	...
	public OTOLARYNGOLOGIC(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public OTOLARYNGOLOGIC(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public OTOLARYNGOLOGIC(SubOrganization subOrganization) {
	...
	public OTOLARYNGOLOGIC(SubjectOf subjectOf) {
	...
	public OTOLARYNGOLOGIC(SupersededBy supersededBy) {
	...
	public OTOLARYNGOLOGIC(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public OTOLARYNGOLOGIC(Telephone telephone) {
	...
	public OTOLARYNGOLOGIC(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public OTOLARYNGOLOGIC(Url url) {
		setUrl(url);
	}
	...
	public OTOLARYNGOLOGIC(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(MedicalSpecialty.Otolaryngologic org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalSpecialty.Otolaryngologic.class.getAnnotation(SampleValue.class).value();
	}
