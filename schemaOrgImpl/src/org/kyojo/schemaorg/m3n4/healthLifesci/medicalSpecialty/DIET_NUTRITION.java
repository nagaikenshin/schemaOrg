...
public class DIET_NUTRITION implements MedicalSpecialty.DietNutrition {
	...
	public DIET_NUTRITION() {
	}

	public DIET_NUTRITION(Long seq) {
		setSeq(seq);
	}

	public DIET_NUTRITION(String string) {
	...
	public DIET_NUTRITION(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public DIET_NUTRITION(AdditionalProperty additionalProperty) {
	...
	public DIET_NUTRITION(AdditionalType additionalType) {
	...
	public DIET_NUTRITION(Address address) {
		setAddress(address);
	}
	...
	public DIET_NUTRITION(AggregateRating aggregateRating) {
	...
	public DIET_NUTRITION(AlternateName alternateName) {
	...
	public DIET_NUTRITION(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public DIET_NUTRITION(AmenityFeature amenityFeature) {
	...
	public DIET_NUTRITION(AreaServed areaServed) {
	...
	public DIET_NUTRITION(Award award) {
		setAward(award);
	}
	...
	public DIET_NUTRITION(BranchCode branchCode) {
	...
	public DIET_NUTRITION(Brand brand) {
		setBrand(brand);
	}
	...
	public DIET_NUTRITION(ContactPoint contactPoint) {
	...
	public DIET_NUTRITION(ContainedInPlace containedInPlace) {
	...
	public DIET_NUTRITION(ContainsPlace containsPlace) {
	...
	public DIET_NUTRITION(CorrectionsPolicy correctionsPolicy) {
	...
	public DIET_NUTRITION(CurrenciesAccepted currenciesAccepted) {
	...
	public DIET_NUTRITION(Department department) {
	...
	public DIET_NUTRITION(Description description) {
	...
	public DIET_NUTRITION(DisambiguatingDescription disambiguatingDescription) {
	...
	public DIET_NUTRITION(DissolutionDate dissolutionDate) {
	...
	public DIET_NUTRITION(DiversityPolicy diversityPolicy) {
	...
	public DIET_NUTRITION(DiversityStaffingReport diversityStaffingReport) {
	...
	public DIET_NUTRITION(Duns duns) {
		setDuns(duns);
	}
	...
	public DIET_NUTRITION(Email email) {
		setEmail(email);
	}
	...
	public DIET_NUTRITION(Employee employee) {
	...
	public DIET_NUTRITION(EthicsPolicy ethicsPolicy) {
	...
	public DIET_NUTRITION(Event event) {
		setEvent(event);
	}
	...
	public DIET_NUTRITION(FaxNumber faxNumber) {
	...
	public DIET_NUTRITION(Founder founder) {
		setFounder(founder);
	}
	...
	public DIET_NUTRITION(FoundingDate foundingDate) {
	...
	public DIET_NUTRITION(FoundingLocation foundingLocation) {
	...
	public DIET_NUTRITION(Funder funder) {
		setFunder(funder);
	}
	...
	public DIET_NUTRITION(GeospatiallyContains geospatiallyContains) {
	...
	public DIET_NUTRITION(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public DIET_NUTRITION(GeospatiallyCovers geospatiallyCovers) {
	...
	public DIET_NUTRITION(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public DIET_NUTRITION(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public DIET_NUTRITION(GeospatiallyEquals geospatiallyEquals) {
	...
	public DIET_NUTRITION(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public DIET_NUTRITION(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public DIET_NUTRITION(GeospatiallyTouches geospatiallyTouches) {
	...
	public DIET_NUTRITION(GeospatiallyWithin geospatiallyWithin) {
	...
	public DIET_NUTRITION(GlobalLocationNumber globalLocationNumber) {
	...
	public DIET_NUTRITION(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public DIET_NUTRITION(HasOfferCatalog hasOfferCatalog) {
	...
	public DIET_NUTRITION(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public DIET_NUTRITION(Identifier identifier) {
	...
	public DIET_NUTRITION(Image image) {
		setImage(image);
	}
	...
	public DIET_NUTRITION(IsAccessibleForFree isAccessibleForFree) {
	...
	public DIET_NUTRITION(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public DIET_NUTRITION(KnowsAbout knowsAbout) {
	...
	public DIET_NUTRITION(KnowsLanguage knowsLanguage) {
	...
	public DIET_NUTRITION(LegalName legalName) {
	...
	public DIET_NUTRITION(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public DIET_NUTRITION(Location location) {
	...
	public DIET_NUTRITION(Logo logo) {
		setLogo(logo);
	}
	...
	public DIET_NUTRITION(MainEntityOfPage mainEntityOfPage) {
	...
	public DIET_NUTRITION(MakesOffer makesOffer) {
	...
	public DIET_NUTRITION(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public DIET_NUTRITION(Member member) {
		setMember(member);
	}
	...
	public DIET_NUTRITION(MemberOf memberOf) {
	...
	public DIET_NUTRITION(Naics naics) {
		setNaics(naics);
	}
	...
	public DIET_NUTRITION(Name name) {
		setName(name);
	}
	...
	public DIET_NUTRITION(NameFuzzy nameFuzzy) {
	...
	public DIET_NUTRITION(NameRuby nameRuby) {
	...
	public DIET_NUTRITION(NumberOfEmployees numberOfEmployees) {
	...
	public DIET_NUTRITION(OpeningHours openingHours) {
	...
	public DIET_NUTRITION(OpeningHoursSpecification openingHoursSpecification) {
	...
	public DIET_NUTRITION(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public DIET_NUTRITION(Owns owns) {
		setOwns(owns);
	}
	...
	public DIET_NUTRITION(ParentOrganization parentOrganization) {
	...
	public DIET_NUTRITION(PaymentAccepted paymentAccepted) {
	...
	public DIET_NUTRITION(Photo photo) {
		setPhoto(photo);
	}
	...
	public DIET_NUTRITION(PotentialAction potentialAction) {
	...
	public DIET_NUTRITION(PriceRange priceRange) {
	...
	public DIET_NUTRITION(PublicAccess publicAccess) {
	...
	public DIET_NUTRITION(PublishingPrinciples publishingPrinciples) {
	...
	public DIET_NUTRITION(Review review) {
		setReview(review);
	}
	...
	public DIET_NUTRITION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DIET_NUTRITION(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public DIET_NUTRITION(SmokingAllowed smokingAllowed) {
	...
	public DIET_NUTRITION(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public DIET_NUTRITION(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public DIET_NUTRITION(SubOrganization subOrganization) {
	...
	public DIET_NUTRITION(SubjectOf subjectOf) {
	...
	public DIET_NUTRITION(SupersededBy supersededBy) {
	...
	public DIET_NUTRITION(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public DIET_NUTRITION(Telephone telephone) {
	...
	public DIET_NUTRITION(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public DIET_NUTRITION(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(MedicalSpecialty.DietNutrition org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalSpecialty.DietNutrition.class.getAnnotation(SampleValue.class).value();
	}
