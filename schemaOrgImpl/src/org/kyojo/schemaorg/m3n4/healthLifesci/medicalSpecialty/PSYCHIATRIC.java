...
public class PSYCHIATRIC implements MedicalSpecialty.Psychiatric {
	...
	public PSYCHIATRIC(Long seq) {
		setSeq(seq);
	}

	public PSYCHIATRIC(String string) {
	...
	public PSYCHIATRIC(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public PSYCHIATRIC(AdditionalProperty additionalProperty) {
	...
	public PSYCHIATRIC(AdditionalType additionalType) {
	...
	public PSYCHIATRIC(Address address) {
		setAddress(address);
	}
	...
	public PSYCHIATRIC(AggregateRating aggregateRating) {
	...
	public PSYCHIATRIC(AlternateName alternateName) {
	...
	public PSYCHIATRIC(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public PSYCHIATRIC(AmenityFeature amenityFeature) {
	...
	public PSYCHIATRIC(AreaServed areaServed) {
	...
	public PSYCHIATRIC(Award award) {
		setAward(award);
	}
	...
	public PSYCHIATRIC(BranchCode branchCode) {
	...
	public PSYCHIATRIC(Brand brand) {
		setBrand(brand);
	}
	...
	public PSYCHIATRIC(ContactPoint contactPoint) {
	...
	public PSYCHIATRIC(ContainedInPlace containedInPlace) {
	...
	public PSYCHIATRIC(ContainsPlace containsPlace) {
	...
	public PSYCHIATRIC(CorrectionsPolicy correctionsPolicy) {
	...
	public PSYCHIATRIC(CurrenciesAccepted currenciesAccepted) {
	...
	public PSYCHIATRIC(Department department) {
	...
	public PSYCHIATRIC(Description description) {
	...
	public PSYCHIATRIC(DisambiguatingDescription disambiguatingDescription) {
	...
	public PSYCHIATRIC(DissolutionDate dissolutionDate) {
	...
	public PSYCHIATRIC(DiversityPolicy diversityPolicy) {
	...
	public PSYCHIATRIC(DiversityStaffingReport diversityStaffingReport) {
	...
	public PSYCHIATRIC(Email email) {
		setEmail(email);
	}
	...
	public PSYCHIATRIC(Employee employee) {
	...
	public PSYCHIATRIC(EthicsPolicy ethicsPolicy) {
	...
	public PSYCHIATRIC(Event event) {
		setEvent(event);
	}
	...
	public PSYCHIATRIC(FaxNumber faxNumber) {
	...
	public PSYCHIATRIC(Founder founder) {
		setFounder(founder);
	}
	...
	public PSYCHIATRIC(FoundingDate foundingDate) {
	...
	public PSYCHIATRIC(FoundingLocation foundingLocation) {
	...
	public PSYCHIATRIC(Funder funder) {
		setFunder(funder);
	}
	...
	public PSYCHIATRIC(GeospatiallyContains geospatiallyContains) {
	...
	public PSYCHIATRIC(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public PSYCHIATRIC(GeospatiallyCovers geospatiallyCovers) {
	...
	public PSYCHIATRIC(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public PSYCHIATRIC(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public PSYCHIATRIC(GeospatiallyEquals geospatiallyEquals) {
	...
	public PSYCHIATRIC(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public PSYCHIATRIC(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public PSYCHIATRIC(GeospatiallyTouches geospatiallyTouches) {
	...
	public PSYCHIATRIC(GeospatiallyWithin geospatiallyWithin) {
	...
	public PSYCHIATRIC(GlobalLocationNumber globalLocationNumber) {
	...
	public PSYCHIATRIC(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public PSYCHIATRIC(HasOfferCatalog hasOfferCatalog) {
	...
	public PSYCHIATRIC(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public PSYCHIATRIC(Identifier identifier) {
	...
	public PSYCHIATRIC(Image image) {
		setImage(image);
	}
	...
	public PSYCHIATRIC(IsAccessibleForFree isAccessibleForFree) {
	...
	public PSYCHIATRIC(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public PSYCHIATRIC(KnowsAbout knowsAbout) {
	...
	public PSYCHIATRIC(KnowsLanguage knowsLanguage) {
	...
	public PSYCHIATRIC(LegalName legalName) {
	...
	public PSYCHIATRIC(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public PSYCHIATRIC(Location location) {
	...
	public PSYCHIATRIC(MainEntityOfPage mainEntityOfPage) {
	...
	public PSYCHIATRIC(MakesOffer makesOffer) {
	...
	public PSYCHIATRIC(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public PSYCHIATRIC(Member member) {
		setMember(member);
	}
	...
	public PSYCHIATRIC(MemberOf memberOf) {
	...
	public PSYCHIATRIC(Naics naics) {
		setNaics(naics);
	}
	...
	public PSYCHIATRIC(NameFuzzy nameFuzzy) {
	...
	public PSYCHIATRIC(NameRuby nameRuby) {
	...
	public PSYCHIATRIC(NumberOfEmployees numberOfEmployees) {
	...
	public PSYCHIATRIC(OpeningHours openingHours) {
	...
	public PSYCHIATRIC(OpeningHoursSpecification openingHoursSpecification) {
	...
	public PSYCHIATRIC(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public PSYCHIATRIC(ParentOrganization parentOrganization) {
	...
	public PSYCHIATRIC(PaymentAccepted paymentAccepted) {
	...
	public PSYCHIATRIC(Photo photo) {
		setPhoto(photo);
	}
	...
	public PSYCHIATRIC(PotentialAction potentialAction) {
	...
	public PSYCHIATRIC(PriceRange priceRange) {
	...
	public PSYCHIATRIC(PublicAccess publicAccess) {
	...
	public PSYCHIATRIC(PublishingPrinciples publishingPrinciples) {
	...
	public PSYCHIATRIC(Review review) {
		setReview(review);
	}
	...
	public PSYCHIATRIC(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PSYCHIATRIC(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public PSYCHIATRIC(SmokingAllowed smokingAllowed) {
	...
	public PSYCHIATRIC(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public PSYCHIATRIC(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public PSYCHIATRIC(SubOrganization subOrganization) {
	...
	public PSYCHIATRIC(SubjectOf subjectOf) {
	...
	public PSYCHIATRIC(SupersededBy supersededBy) {
	...
	public PSYCHIATRIC(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public PSYCHIATRIC(Telephone telephone) {
	...
	public PSYCHIATRIC(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public PSYCHIATRIC(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(MedicalSpecialty.Psychiatric org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalSpecialty.Psychiatric.class.getAnnotation(SampleValue.class).value();
	}
