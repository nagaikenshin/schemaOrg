...
public class OPTOMETRIC implements MedicalSpecialty.Optometric {
	...
	public OPTOMETRIC(Long seq) {
		setSeq(seq);
	}

	public OPTOMETRIC(String string) {
	...
	public OPTOMETRIC(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public OPTOMETRIC(AdditionalProperty additionalProperty) {
	...
	public OPTOMETRIC(AdditionalType additionalType) {
	...
	public OPTOMETRIC(Address address) {
		setAddress(address);
	}
	...
	public OPTOMETRIC(AggregateRating aggregateRating) {
	...
	public OPTOMETRIC(AlternateName alternateName) {
	...
	public OPTOMETRIC(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public OPTOMETRIC(AmenityFeature amenityFeature) {
	...
	public OPTOMETRIC(AreaServed areaServed) {
	...
	public OPTOMETRIC(BranchCode branchCode) {
	...
	public OPTOMETRIC(ContactPoint contactPoint) {
	...
	public OPTOMETRIC(ContainedInPlace containedInPlace) {
	...
	public OPTOMETRIC(ContainsPlace containsPlace) {
	...
	public OPTOMETRIC(CorrectionsPolicy correctionsPolicy) {
	...
	public OPTOMETRIC(CurrenciesAccepted currenciesAccepted) {
	...
	public OPTOMETRIC(Department department) {
	...
	public OPTOMETRIC(Description description) {
	...
	public OPTOMETRIC(DisambiguatingDescription disambiguatingDescription) {
	...
	public OPTOMETRIC(DissolutionDate dissolutionDate) {
	...
	public OPTOMETRIC(DiversityPolicy diversityPolicy) {
	...
	public OPTOMETRIC(DiversityStaffingReport diversityStaffingReport) {
	...
	public OPTOMETRIC(Employee employee) {
	...
	public OPTOMETRIC(EthicsPolicy ethicsPolicy) {
	...
	public OPTOMETRIC(FaxNumber faxNumber) {
	...
	public OPTOMETRIC(Founder founder) {
		setFounder(founder);
	}
	...
	public OPTOMETRIC(FoundingDate foundingDate) {
	...
	public OPTOMETRIC(FoundingLocation foundingLocation) {
	...
	public OPTOMETRIC(Funder funder) {
		setFunder(funder);
	}
	...
	public OPTOMETRIC(GeospatiallyContains geospatiallyContains) {
	...
	public OPTOMETRIC(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public OPTOMETRIC(GeospatiallyCovers geospatiallyCovers) {
	...
	public OPTOMETRIC(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public OPTOMETRIC(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public OPTOMETRIC(GeospatiallyEquals geospatiallyEquals) {
	...
	public OPTOMETRIC(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public OPTOMETRIC(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public OPTOMETRIC(GeospatiallyTouches geospatiallyTouches) {
	...
	public OPTOMETRIC(GeospatiallyWithin geospatiallyWithin) {
	...
	public OPTOMETRIC(GlobalLocationNumber globalLocationNumber) {
	...
	public OPTOMETRIC(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public OPTOMETRIC(HasOfferCatalog hasOfferCatalog) {
	...
	public OPTOMETRIC(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public OPTOMETRIC(Identifier identifier) {
	...
	public OPTOMETRIC(IsAccessibleForFree isAccessibleForFree) {
	...
	public OPTOMETRIC(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public OPTOMETRIC(KnowsAbout knowsAbout) {
	...
	public OPTOMETRIC(KnowsLanguage knowsLanguage) {
	...
	public OPTOMETRIC(LegalName legalName) {
	...
	public OPTOMETRIC(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public OPTOMETRIC(Location location) {
	...
	public OPTOMETRIC(MainEntityOfPage mainEntityOfPage) {
	...
	public OPTOMETRIC(MakesOffer makesOffer) {
	...
	public OPTOMETRIC(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public OPTOMETRIC(Member member) {
		setMember(member);
	}
	...
	public OPTOMETRIC(MemberOf memberOf) {
	...
	public OPTOMETRIC(NameFuzzy nameFuzzy) {
	...
	public OPTOMETRIC(NameRuby nameRuby) {
	...
	public OPTOMETRIC(NumberOfEmployees numberOfEmployees) {
	...
	public OPTOMETRIC(OpeningHours openingHours) {
	...
	public OPTOMETRIC(OpeningHoursSpecification openingHoursSpecification) {
	...
	public OPTOMETRIC(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public OPTOMETRIC(ParentOrganization parentOrganization) {
	...
	public OPTOMETRIC(PaymentAccepted paymentAccepted) {
	...
	public OPTOMETRIC(PotentialAction potentialAction) {
	...
	public OPTOMETRIC(PriceRange priceRange) {
	...
	public OPTOMETRIC(PublicAccess publicAccess) {
	...
	public OPTOMETRIC(PublishingPrinciples publishingPrinciples) {
	...
	public OPTOMETRIC(Review review) {
		setReview(review);
	}
	...
	public OPTOMETRIC(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public OPTOMETRIC(SmokingAllowed smokingAllowed) {
	...
	public OPTOMETRIC(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public OPTOMETRIC(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public OPTOMETRIC(SubOrganization subOrganization) {
	...
	public OPTOMETRIC(SubjectOf subjectOf) {
	...
	public OPTOMETRIC(SupersededBy supersededBy) {
	...
	public OPTOMETRIC(Telephone telephone) {
	...
	public OPTOMETRIC(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(MedicalSpecialty.Optometric org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalSpecialty.Optometric.class.getAnnotation(SampleValue.class).value();
	}
