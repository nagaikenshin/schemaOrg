...
public class GERIATRIC implements MedicalSpecialty.Geriatric {
	...
	public GERIATRIC(Long seq) {
		setSeq(seq);
	}

	public GERIATRIC(String string) {
	...
	public GERIATRIC(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public GERIATRIC(AdditionalProperty additionalProperty) {
	...
	public GERIATRIC(AdditionalType additionalType) {
	...
	public GERIATRIC(Address address) {
		setAddress(address);
	}
	...
	public GERIATRIC(AggregateRating aggregateRating) {
	...
	public GERIATRIC(AlternateName alternateName) {
	...
	public GERIATRIC(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public GERIATRIC(AmenityFeature amenityFeature) {
	...
	public GERIATRIC(AreaServed areaServed) {
	...
	public GERIATRIC(BranchCode branchCode) {
	...
	public GERIATRIC(ContactPoint contactPoint) {
	...
	public GERIATRIC(ContainedInPlace containedInPlace) {
	...
	public GERIATRIC(ContainsPlace containsPlace) {
	...
	public GERIATRIC(CorrectionsPolicy correctionsPolicy) {
	...
	public GERIATRIC(CurrenciesAccepted currenciesAccepted) {
	...
	public GERIATRIC(Department department) {
	...
	public GERIATRIC(Description description) {
	...
	public GERIATRIC(DisambiguatingDescription disambiguatingDescription) {
	...
	public GERIATRIC(DissolutionDate dissolutionDate) {
	...
	public GERIATRIC(DiversityPolicy diversityPolicy) {
	...
	public GERIATRIC(DiversityStaffingReport diversityStaffingReport) {
	...
	public GERIATRIC(Employee employee) {
	...
	public GERIATRIC(EthicsPolicy ethicsPolicy) {
	...
	public GERIATRIC(FaxNumber faxNumber) {
	...
	public GERIATRIC(Founder founder) {
		setFounder(founder);
	}
	...
	public GERIATRIC(FoundingDate foundingDate) {
	...
	public GERIATRIC(FoundingLocation foundingLocation) {
	...
	public GERIATRIC(Funder funder) {
		setFunder(funder);
	}
	...
	public GERIATRIC(GeospatiallyContains geospatiallyContains) {
	...
	public GERIATRIC(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public GERIATRIC(GeospatiallyCovers geospatiallyCovers) {
	...
	public GERIATRIC(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public GERIATRIC(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public GERIATRIC(GeospatiallyEquals geospatiallyEquals) {
	...
	public GERIATRIC(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public GERIATRIC(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public GERIATRIC(GeospatiallyTouches geospatiallyTouches) {
	...
	public GERIATRIC(GeospatiallyWithin geospatiallyWithin) {
	...
	public GERIATRIC(GlobalLocationNumber globalLocationNumber) {
	...
	public GERIATRIC(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public GERIATRIC(HasOfferCatalog hasOfferCatalog) {
	...
	public GERIATRIC(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public GERIATRIC(Identifier identifier) {
	...
	public GERIATRIC(IsAccessibleForFree isAccessibleForFree) {
	...
	public GERIATRIC(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public GERIATRIC(KnowsAbout knowsAbout) {
	...
	public GERIATRIC(KnowsLanguage knowsLanguage) {
	...
	public GERIATRIC(LegalName legalName) {
	...
	public GERIATRIC(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public GERIATRIC(Location location) {
	...
	public GERIATRIC(MainEntityOfPage mainEntityOfPage) {
	...
	public GERIATRIC(MakesOffer makesOffer) {
	...
	public GERIATRIC(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public GERIATRIC(Member member) {
		setMember(member);
	}
	...
	public GERIATRIC(MemberOf memberOf) {
	...
	public GERIATRIC(NameFuzzy nameFuzzy) {
	...
	public GERIATRIC(NameRuby nameRuby) {
	...
	public GERIATRIC(NumberOfEmployees numberOfEmployees) {
	...
	public GERIATRIC(OpeningHours openingHours) {
	...
	public GERIATRIC(OpeningHoursSpecification openingHoursSpecification) {
	...
	public GERIATRIC(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public GERIATRIC(ParentOrganization parentOrganization) {
	...
	public GERIATRIC(PaymentAccepted paymentAccepted) {
	...
	public GERIATRIC(PotentialAction potentialAction) {
	...
	public GERIATRIC(PriceRange priceRange) {
	...
	public GERIATRIC(PublicAccess publicAccess) {
	...
	public GERIATRIC(PublishingPrinciples publishingPrinciples) {
	...
	public GERIATRIC(Review review) {
		setReview(review);
	}
	...
	public GERIATRIC(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public GERIATRIC(SmokingAllowed smokingAllowed) {
	...
	public GERIATRIC(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public GERIATRIC(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public GERIATRIC(SubOrganization subOrganization) {
	...
	public GERIATRIC(SubjectOf subjectOf) {
	...
	public GERIATRIC(SupersededBy supersededBy) {
	...
	public GERIATRIC(Telephone telephone) {
	...
	public GERIATRIC(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(MedicalSpecialty.Geriatric org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalSpecialty.Geriatric.class.getAnnotation(SampleValue.class).value();
	}
