...
public class GYNECOLOGIC implements MedicalSpecialty.Gynecologic {
	...
	public GYNECOLOGIC(Long seq) {
		setSeq(seq);
	}

	public GYNECOLOGIC(String string) {
	...
	public GYNECOLOGIC(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public GYNECOLOGIC(AdditionalProperty additionalProperty) {
	...
	public GYNECOLOGIC(AdditionalType additionalType) {
	...
	public GYNECOLOGIC(Address address) {
		setAddress(address);
	}
	...
	public GYNECOLOGIC(AggregateRating aggregateRating) {
	...
	public GYNECOLOGIC(AlternateName alternateName) {
	...
	public GYNECOLOGIC(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public GYNECOLOGIC(AmenityFeature amenityFeature) {
	...
	public GYNECOLOGIC(AreaServed areaServed) {
	...
	public GYNECOLOGIC(Award award) {
		setAward(award);
	}
	...
	public GYNECOLOGIC(BranchCode branchCode) {
	...
	public GYNECOLOGIC(Brand brand) {
		setBrand(brand);
	}
	...
	public GYNECOLOGIC(ContactPoint contactPoint) {
	...
	public GYNECOLOGIC(ContainedInPlace containedInPlace) {
	...
	public GYNECOLOGIC(ContainsPlace containsPlace) {
	...
	public GYNECOLOGIC(CorrectionsPolicy correctionsPolicy) {
	...
	public GYNECOLOGIC(CurrenciesAccepted currenciesAccepted) {
	...
	public GYNECOLOGIC(Department department) {
	...
	public GYNECOLOGIC(Description description) {
	...
	public GYNECOLOGIC(DisambiguatingDescription disambiguatingDescription) {
	...
	public GYNECOLOGIC(DissolutionDate dissolutionDate) {
	...
	public GYNECOLOGIC(DiversityPolicy diversityPolicy) {
	...
	public GYNECOLOGIC(DiversityStaffingReport diversityStaffingReport) {
	...
	public GYNECOLOGIC(Email email) {
		setEmail(email);
	}
	...
	public GYNECOLOGIC(Employee employee) {
	...
	public GYNECOLOGIC(EthicsPolicy ethicsPolicy) {
	...
	public GYNECOLOGIC(Event event) {
		setEvent(event);
	}
	...
	public GYNECOLOGIC(FaxNumber faxNumber) {
	...
	public GYNECOLOGIC(Founder founder) {
		setFounder(founder);
	}
	...
	public GYNECOLOGIC(FoundingDate foundingDate) {
	...
	public GYNECOLOGIC(FoundingLocation foundingLocation) {
	...
	public GYNECOLOGIC(Funder funder) {
		setFunder(funder);
	}
	...
	public GYNECOLOGIC(GeospatiallyContains geospatiallyContains) {
	...
	public GYNECOLOGIC(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public GYNECOLOGIC(GeospatiallyCovers geospatiallyCovers) {
	...
	public GYNECOLOGIC(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public GYNECOLOGIC(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public GYNECOLOGIC(GeospatiallyEquals geospatiallyEquals) {
	...
	public GYNECOLOGIC(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public GYNECOLOGIC(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public GYNECOLOGIC(GeospatiallyTouches geospatiallyTouches) {
	...
	public GYNECOLOGIC(GeospatiallyWithin geospatiallyWithin) {
	...
	public GYNECOLOGIC(GlobalLocationNumber globalLocationNumber) {
	...
	public GYNECOLOGIC(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public GYNECOLOGIC(HasOfferCatalog hasOfferCatalog) {
	...
	public GYNECOLOGIC(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public GYNECOLOGIC(Identifier identifier) {
	...
	public GYNECOLOGIC(Image image) {
		setImage(image);
	}
	...
	public GYNECOLOGIC(IsAccessibleForFree isAccessibleForFree) {
	...
	public GYNECOLOGIC(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public GYNECOLOGIC(KnowsAbout knowsAbout) {
	...
	public GYNECOLOGIC(KnowsLanguage knowsLanguage) {
	...
	public GYNECOLOGIC(LegalName legalName) {
	...
	public GYNECOLOGIC(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public GYNECOLOGIC(Location location) {
	...
	public GYNECOLOGIC(MainEntityOfPage mainEntityOfPage) {
	...
	public GYNECOLOGIC(MakesOffer makesOffer) {
	...
	public GYNECOLOGIC(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public GYNECOLOGIC(Member member) {
		setMember(member);
	}
	...
	public GYNECOLOGIC(MemberOf memberOf) {
	...
	public GYNECOLOGIC(Naics naics) {
		setNaics(naics);
	}
	...
	public GYNECOLOGIC(NameFuzzy nameFuzzy) {
	...
	public GYNECOLOGIC(NameRuby nameRuby) {
	...
	public GYNECOLOGIC(NumberOfEmployees numberOfEmployees) {
	...
	public GYNECOLOGIC(OpeningHours openingHours) {
	...
	public GYNECOLOGIC(OpeningHoursSpecification openingHoursSpecification) {
	...
	public GYNECOLOGIC(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public GYNECOLOGIC(ParentOrganization parentOrganization) {
	...
	public GYNECOLOGIC(PaymentAccepted paymentAccepted) {
	...
	public GYNECOLOGIC(Photo photo) {
		setPhoto(photo);
	}
	...
	public GYNECOLOGIC(PotentialAction potentialAction) {
	...
	public GYNECOLOGIC(PriceRange priceRange) {
	...
	public GYNECOLOGIC(PublicAccess publicAccess) {
	...
	public GYNECOLOGIC(PublishingPrinciples publishingPrinciples) {
	...
	public GYNECOLOGIC(Review review) {
		setReview(review);
	}
	...
	public GYNECOLOGIC(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public GYNECOLOGIC(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public GYNECOLOGIC(SmokingAllowed smokingAllowed) {
	...
	public GYNECOLOGIC(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public GYNECOLOGIC(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public GYNECOLOGIC(SubOrganization subOrganization) {
	...
	public GYNECOLOGIC(SubjectOf subjectOf) {
	...
	public GYNECOLOGIC(SupersededBy supersededBy) {
	...
	public GYNECOLOGIC(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public GYNECOLOGIC(Telephone telephone) {
	...
	public GYNECOLOGIC(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public GYNECOLOGIC(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(MedicalSpecialty.Gynecologic org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalSpecialty.Gynecologic.class.getAnnotation(SampleValue.class).value();
	}
