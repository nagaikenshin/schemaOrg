package org.kyojo.schemaorg.m3n4.auto.carUsageType;
...
public class DRIVING_SCHOOL_VEHICLE_USAGE implements CarUsageType.DrivingSchoolVehicleUsage {
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE() {
	}

	public DRIVING_SCHOOL_VEHICLE_USAGE(Long seq) {
		setSeq(seq);
	}

	public DRIVING_SCHOOL_VEHICLE_USAGE(String string) {
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE(AdditionalProperty additionalProperty) {
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE(AdditionalType additionalType) {
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE(AlternateName alternateName) {
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE(Description description) {
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE(DisambiguatingDescription disambiguatingDescription) {
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE(Equal equal) {
		setEqual(equal);
	}
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE(Greater greater) {
		setGreater(greater);
	}
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE(GreaterOrEqual greaterOrEqual) {
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE(Identifier identifier) {
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE(Image image) {
		setImage(image);
	}
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE(Lesser lesser) {
		setLesser(lesser);
	}
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE(LesserOrEqual lesserOrEqual) {
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE(MainEntityOfPage mainEntityOfPage) {
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE(Name name) {
		setName(name);
	}
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE(NameFuzzy nameFuzzy) {
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE(NameRuby nameRuby) {
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE(NonEqual nonEqual) {
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE(PotentialAction potentialAction) {
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE(SubjectOf subjectOf) {
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE(SupersededBy supersededBy) {
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE(Url url) {
		setUrl(url);
	}
	...
	public DRIVING_SCHOOL_VEHICLE_USAGE(ValueReference valueReference) {
	...
	public void copy(CarUsageType.DrivingSchoolVehicleUsage org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return CarUsageType.DrivingSchoolVehicleUsage.class.getAnnotation(SampleValue.class).value();
	}
