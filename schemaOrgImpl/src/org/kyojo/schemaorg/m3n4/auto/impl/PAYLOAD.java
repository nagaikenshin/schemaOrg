...
public class PAYLOAD implements Container.Payload {
	...
	public PAYLOAD(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public PAYLOAD(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public PAYLOAD(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public PAYLOAD(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.Payload org) {
