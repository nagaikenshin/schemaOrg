...
public class TRAILER_WEIGHT implements Container.TrailerWeight {
	...
	public TRAILER_WEIGHT(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public TRAILER_WEIGHT(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public TRAILER_WEIGHT(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.TrailerWeight org) {
