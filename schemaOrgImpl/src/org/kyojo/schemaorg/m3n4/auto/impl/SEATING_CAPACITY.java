...
public class SEATING_CAPACITY implements Container.SeatingCapacity {
	...
	public SEATING_CAPACITY(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public SEATING_CAPACITY(Float fl0at) {
	...
	public SEATING_CAPACITY(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public SEATING_CAPACITY(Integer integer) {
	...
	public SEATING_CAPACITY(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public SEATING_CAPACITY(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public SEATING_CAPACITY(List<Float> fl0atList,
