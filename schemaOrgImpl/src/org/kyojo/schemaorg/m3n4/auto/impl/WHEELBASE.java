...
public class WHEELBASE implements Container.Wheelbase {
	...
	public WHEELBASE(String string) {
	...
	public WHEELBASE(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public WHEELBASE(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public WHEELBASE(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public WHEELBASE(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.Wheelbase org) {
