...
public class TORQUE implements Container.Torque {
	...
	public TORQUE(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public TORQUE(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public TORQUE(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public TORQUE(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.Torque org) {
