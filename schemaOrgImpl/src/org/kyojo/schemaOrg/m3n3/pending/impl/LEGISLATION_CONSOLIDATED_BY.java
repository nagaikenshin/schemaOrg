...
public class LEGISLATION_CONSOLIDATED_BY implements Container.LegislationConsolidatedBy {

	private static final long serialVersionUID = 1L;

	public List<Legislation> legislationList;

	public LEGISLATION_CONSOLIDATED_BY() {
	}

	public LEGISLATION_CONSOLIDATED_BY(String string) {
	...
	public LEGISLATION_CONSOLIDATED_BY(Legislation legislation) {
		legislationList = new ArrayList<Legislation>();
