...
public class LEGISLATION_APPLIED_BY implements Container.LegislationAppliedBy {

	private static final long serialVersionUID = 1L;

	public List<Legislation> legislationList;

	public LEGISLATION_APPLIED_BY() {
	}

	public LEGISLATION_APPLIED_BY(String string) {
	...
	public LEGISLATION_APPLIED_BY(Legislation legislation) {
		legislationList = new ArrayList<Legislation>();
