...
public class LOAN_TYPE implements Container.LoanType {
	...
	public LOAN_TYPE(String string) {
		this(new TEXT(string));
	}

	public LOAN_TYPE(Text text) {
	...
	public LOAN_TYPE(List<Text> textList,
			List<URL> urlList) {
		setTextList(textList);
		setURLList(urlList);
	}

	public void copy(Container.LoanType org) {
