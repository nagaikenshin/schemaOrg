...
public class CONTACTLESS_PAYMENT implements Container.ContactlessPayment {
	...
	public CONTACTLESS_PAYMENT(java.lang.Boolean b00lean) {
		this(new BOOLEAN(b00lean));
	}

	public CONTACTLESS_PAYMENT(Boolean b00lean) {
