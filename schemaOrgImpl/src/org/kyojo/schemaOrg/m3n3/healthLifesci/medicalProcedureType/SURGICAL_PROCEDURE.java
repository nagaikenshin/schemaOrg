package org.kyojo.schemaOrg.m3n3.healthLifesci.medicalProcedureType;
...
import org.kyojo.schemaOrg.m3n3.healthLifesci.MedicalProcedureType;
import org.kyojo.schemaOrg.m3n3.meta.Container.SupersededBy;

public class SURGICAL_PROCEDURE implements MedicalProcedureType.SurgicalProcedure {
	...
	public SURGICAL_PROCEDURE(Long seq) {
		setSeq(seq);
	}

	public SURGICAL_PROCEDURE(String string) {
	...
	public SURGICAL_PROCEDURE(AdditionalType additionalType) {
	...
	public SURGICAL_PROCEDURE(AlternateName alternateName) {
	...
	public SURGICAL_PROCEDURE(BodyLocation bodyLocation) {
	...
	public SURGICAL_PROCEDURE(Code code) {
		setCode(code);
	}
	...
	public SURGICAL_PROCEDURE(Description description) {
	...
	public SURGICAL_PROCEDURE(DisambiguatingDescription disambiguatingDescription) {
	...
	public SURGICAL_PROCEDURE(Followup followup) {
	...
	public SURGICAL_PROCEDURE(Guideline guideline) {
	...
	public SURGICAL_PROCEDURE(HowPerformed howPerformed) {
	...
	public SURGICAL_PROCEDURE(Identifier identifier) {
	...
	public SURGICAL_PROCEDURE(Image image) {
		setImage(image);
	}
	...
	public SURGICAL_PROCEDURE(Indication indication) {
	...
	public SURGICAL_PROCEDURE(LegalStatus legalStatus) {
	...
	public SURGICAL_PROCEDURE(MainEntityOfPage mainEntityOfPage) {
	...
	public SURGICAL_PROCEDURE(MedicineSystem medicineSystem) {
	...
	public SURGICAL_PROCEDURE(Name name) {
		setName(name);
	}
	...
	public SURGICAL_PROCEDURE(NameFuzzy nameFuzzy) {
	...
	public SURGICAL_PROCEDURE(NameRuby nameRuby) {
	...
	public SURGICAL_PROCEDURE(Outcome outcome) {
		setOutcome(outcome);
	}
	...
	public SURGICAL_PROCEDURE(PotentialAction potentialAction) {
	...
	public SURGICAL_PROCEDURE(Preparation preparation) {
	...
	public SURGICAL_PROCEDURE(ProcedureType procedureType) {
	...
	public SURGICAL_PROCEDURE(RecognizingAuthority recognizingAuthority) {
	...
	public SURGICAL_PROCEDURE(RelevantSpecialty relevantSpecialty) {
	...
	public SURGICAL_PROCEDURE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SURGICAL_PROCEDURE(Status status) {
		setStatus(status);
	}
	...
	public SURGICAL_PROCEDURE(Study study) {
		setStudy(study);
	}
	...
	public SURGICAL_PROCEDURE(SupersededBy supersededBy) {
	...
	public SURGICAL_PROCEDURE(Url url) {
		setUrl(url);
	}
	...
	public void copy(MedicalProcedureType.SurgicalProcedure org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalProcedureType.SurgicalProcedure.class.getAnnotation(SampleValue.class).value();
	}
