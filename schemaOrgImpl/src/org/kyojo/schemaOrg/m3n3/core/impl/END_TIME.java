...
public class END_TIME implements Container.EndTime {
	...
	public END_TIME(java.util.Date dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public END_TIME(java.time.OffsetDateTime dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public END_TIME(DateTime dateTime) {
