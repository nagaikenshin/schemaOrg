...
public class MULTIPLE_VALUES implements Container.MultipleValues {
	...
	public MULTIPLE_VALUES(java.lang.Boolean b00lean) {
		this(new BOOLEAN(b00lean));
	}

	public MULTIPLE_VALUES(Boolean b00lean) {
