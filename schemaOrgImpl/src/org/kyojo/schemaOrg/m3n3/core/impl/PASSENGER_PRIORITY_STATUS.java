...
public class PASSENGER_PRIORITY_STATUS implements Container.PassengerPriorityStatus {
	...
	public PASSENGER_PRIORITY_STATUS(QualitativeValue qualitativeValue) {
	...
	public PASSENGER_PRIORITY_STATUS(String string) {
		this(new TEXT(string));
	}

	public PASSENGER_PRIORITY_STATUS(Text text) {
	...
	public PASSENGER_PRIORITY_STATUS(List<QualitativeValue> qualitativeValueList,
			List<Text> textList) {
		setQualitativeValueList(qualitativeValueList);
		setTextList(textList);
	}

	public void copy(Container.PassengerPriorityStatus org) {
