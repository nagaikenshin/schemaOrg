...
public class POSITION implements Container.Position {
	...
	public POSITION(List<Integer> integerList,
			List<Text> textList) {
		setIntegerList(integerList);
		setTextList(textList);
	}

	public void copy(Container.Position org) {
