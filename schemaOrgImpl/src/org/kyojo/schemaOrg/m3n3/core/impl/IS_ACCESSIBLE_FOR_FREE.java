...
public class IS_ACCESSIBLE_FOR_FREE implements Container.IsAccessibleForFree {
	...
	public IS_ACCESSIBLE_FOR_FREE(java.lang.Boolean b00lean) {
		this(new BOOLEAN(b00lean));
	}

	public IS_ACCESSIBLE_FOR_FREE(Boolean b00lean) {
