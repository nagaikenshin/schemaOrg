...
public class AVAILABLE_FROM implements Container.AvailableFrom {
	...
	public AVAILABLE_FROM(java.util.Date dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public AVAILABLE_FROM(java.time.OffsetDateTime dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public AVAILABLE_FROM(DateTime dateTime) {
