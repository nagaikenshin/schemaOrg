...
public class ADMINISTRATIVE_AREA implements Clazz.AdministrativeArea {
	...
	public ADMINISTRATIVE_AREA(GeospatiallyContains geospatiallyContains) {
	...
	public ADMINISTRATIVE_AREA(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public ADMINISTRATIVE_AREA(GeospatiallyCovers geospatiallyCovers) {
	...
	public ADMINISTRATIVE_AREA(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public ADMINISTRATIVE_AREA(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public ADMINISTRATIVE_AREA(GeospatiallyEquals geospatiallyEquals) {
	...
	public ADMINISTRATIVE_AREA(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public ADMINISTRATIVE_AREA(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public ADMINISTRATIVE_AREA(GeospatiallyTouches geospatiallyTouches) {
	...
	public ADMINISTRATIVE_AREA(GeospatiallyWithin geospatiallyWithin) {
