...
public class FOUNDING_DATE implements Container.FoundingDate {
	...
	public FOUNDING_DATE(java.util.Date date) {
		this(new DATE(date));
	}

	public FOUNDING_DATE(java.time.LocalDate date) {
		this(new DATE(date));
	}

	public FOUNDING_DATE(Date date) {
