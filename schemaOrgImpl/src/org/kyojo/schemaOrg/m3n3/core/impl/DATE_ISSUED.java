...
public class DATE_ISSUED implements Container.DateIssued {
	...
	public DATE_ISSUED(java.util.Date dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public DATE_ISSUED(java.time.OffsetDateTime dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public DATE_ISSUED(DateTime dateTime) {
