...
public class UPLOAD_DATE implements Container.UploadDate {
	...
	public UPLOAD_DATE(java.util.Date date) {
		this(new DATE(date));
	}

	public UPLOAD_DATE(java.time.LocalDate date) {
		this(new DATE(date));
	}

	public UPLOAD_DATE(Date date) {
