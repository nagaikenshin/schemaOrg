...
public class CARBOHYDRATE_CONTENT implements Container.CarbohydrateContent {
	...
	public CARBOHYDRATE_CONTENT(String string) {
	...
	public CARBOHYDRATE_CONTENT(Mass mass) {
		massList = new ArrayList<Mass>();
		massList.add(mass);
	}
