...
public class SMOKING_ALLOWED implements Container.SmokingAllowed {
	...
	public SMOKING_ALLOWED(java.lang.Boolean b00lean) {
		this(new BOOLEAN(b00lean));
	}

	public SMOKING_ALLOWED(Boolean b00lean) {
