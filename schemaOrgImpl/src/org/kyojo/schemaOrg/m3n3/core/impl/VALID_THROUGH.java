...
public class VALID_THROUGH implements Container.ValidThrough {
	...
	public VALID_THROUGH(java.util.Date dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public VALID_THROUGH(java.time.OffsetDateTime dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public VALID_THROUGH(DateTime dateTime) {
