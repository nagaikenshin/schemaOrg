...
public class DISSOLUTION_DATE implements Container.DissolutionDate {
	...
	public DISSOLUTION_DATE(java.util.Date date) {
		this(new DATE(date));
	}

	public DISSOLUTION_DATE(java.time.LocalDate date) {
		this(new DATE(date));
	}

	public DISSOLUTION_DATE(Date date) {
