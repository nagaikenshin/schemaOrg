...
public class DOOR_TIME implements Container.DoorTime {
	...
	public DOOR_TIME(java.util.Date dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public DOOR_TIME(java.time.OffsetDateTime dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public DOOR_TIME(DateTime dateTime) {
