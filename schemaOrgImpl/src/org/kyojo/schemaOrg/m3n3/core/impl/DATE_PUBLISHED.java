...
public class DATE_PUBLISHED implements Container.DatePublished {
	...
	public DATE_PUBLISHED(java.util.Date date) {
		this(new DATE(date));
	}

	public DATE_PUBLISHED(java.time.LocalDate date) {
		this(new DATE(date));
	}

	public DATE_PUBLISHED(Date date) {
