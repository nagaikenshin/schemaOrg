...
public class AVAILABILITY_ENDS implements Container.AvailabilityEnds {
	...
	public AVAILABILITY_ENDS(java.util.Date dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public AVAILABILITY_ENDS(java.time.OffsetDateTime dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public AVAILABILITY_ENDS(DateTime dateTime) {
