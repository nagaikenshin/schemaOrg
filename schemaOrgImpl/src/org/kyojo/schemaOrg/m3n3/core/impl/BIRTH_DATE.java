...
public class BIRTH_DATE implements Container.BirthDate {
	...
	public BIRTH_DATE(java.util.Date date) {
		this(new DATE(date));
	}

	public BIRTH_DATE(java.time.LocalDate date) {
		this(new DATE(date));
	}

	public BIRTH_DATE(Date date) {
