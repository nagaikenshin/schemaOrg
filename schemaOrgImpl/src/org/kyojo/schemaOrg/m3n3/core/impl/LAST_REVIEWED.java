...
public class LAST_REVIEWED implements Container.LastReviewed {
	...
	public LAST_REVIEWED(java.util.Date date) {
		this(new DATE(date));
	}

	public LAST_REVIEWED(java.time.LocalDate date) {
		this(new DATE(date));
	}

	public LAST_REVIEWED(Date date) {
