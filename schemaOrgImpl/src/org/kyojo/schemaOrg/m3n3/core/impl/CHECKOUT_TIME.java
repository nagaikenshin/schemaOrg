...
public class CHECKOUT_TIME implements Container.CheckoutTime {
	...
	public CHECKOUT_TIME(java.util.Date dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public CHECKOUT_TIME(java.time.OffsetDateTime dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public CHECKOUT_TIME(DateTime dateTime) {
