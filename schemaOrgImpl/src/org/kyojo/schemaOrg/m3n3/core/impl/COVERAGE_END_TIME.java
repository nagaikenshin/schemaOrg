...
public class COVERAGE_END_TIME implements Container.CoverageEndTime {
	...
	public COVERAGE_END_TIME(java.util.Date dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public COVERAGE_END_TIME(java.time.OffsetDateTime dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public COVERAGE_END_TIME(DateTime dateTime) {
