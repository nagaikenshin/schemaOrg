...
public class MEDICAL_SYMPTOM implements Clazz.MedicalSymptom {
	...
	public MEDICAL_SYMPTOM(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_SYMPTOM(String string) {
	...
	public MEDICAL_SYMPTOM(AdditionalType additionalType) {
	...
	public MEDICAL_SYMPTOM(AlternateName alternateName) {
	...
	public MEDICAL_SYMPTOM(AssociatedAnatomy associatedAnatomy) {
	...
	public MEDICAL_SYMPTOM(Cause cause) {
		setCause(cause);
	}
	...
	public MEDICAL_SYMPTOM(Code code) {
		setCode(code);
	}
	...
	public MEDICAL_SYMPTOM(Description description) {
	...
	public MEDICAL_SYMPTOM(DifferentialDiagnosis differentialDiagnosis) {
	...
	public MEDICAL_SYMPTOM(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_SYMPTOM(Drug drug) {
		setDrug(drug);
	}
	...
	public MEDICAL_SYMPTOM(Epidemiology epidemiology) {
	...
	public MEDICAL_SYMPTOM(ExpectedPrognosis expectedPrognosis) {
	...
	public MEDICAL_SYMPTOM(Guideline guideline) {
	...
	public MEDICAL_SYMPTOM(Identifier identifier) {
	...
	public MEDICAL_SYMPTOM(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_SYMPTOM(LegalStatus legalStatus) {
	...
	public MEDICAL_SYMPTOM(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_SYMPTOM(MedicineSystem medicineSystem) {
	...
	public MEDICAL_SYMPTOM(Name name) {
		setName(name);
	}
	...
	public MEDICAL_SYMPTOM(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_SYMPTOM(NameRuby nameRuby) {
	...
	public MEDICAL_SYMPTOM(NaturalProgression naturalProgression) {
	...
	public MEDICAL_SYMPTOM(Pathophysiology pathophysiology) {
	...
	public MEDICAL_SYMPTOM(PossibleComplication possibleComplication) {
	...
	public MEDICAL_SYMPTOM(PossibleTreatment possibleTreatment) {
	...
	public MEDICAL_SYMPTOM(PotentialAction potentialAction) {
	...
	public MEDICAL_SYMPTOM(PrimaryPrevention primaryPrevention) {
	...
	public MEDICAL_SYMPTOM(RecognizingAuthority recognizingAuthority) {
	...
	public MEDICAL_SYMPTOM(RelevantSpecialty relevantSpecialty) {
	...
	public MEDICAL_SYMPTOM(RiskFactor riskFactor) {
	...
	public MEDICAL_SYMPTOM(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_SYMPTOM(SecondaryPrevention secondaryPrevention) {
	...
	public MEDICAL_SYMPTOM(SignOrSymptom signOrSymptom) {
	...
	public MEDICAL_SYMPTOM(Stage stage) {
		setStage(stage);
	}
	...
	public MEDICAL_SYMPTOM(Status status) {
		setStatus(status);
	}
	...
	public MEDICAL_SYMPTOM(Study study) {
		setStudy(study);
	}
	...
	public MEDICAL_SYMPTOM(SubjectOf subjectOf) {
	...
	public MEDICAL_SYMPTOM(Subtype subtype) {
		setSubtype(subtype);
	}
	...
	public MEDICAL_SYMPTOM(TypicalTest typicalTest) {
	...
	public MEDICAL_SYMPTOM(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.MedicalSymptom org) {
		setSeq(org.getSeq());
