...
public class MEDICAL_ENTITY implements Clazz.MedicalEntity {
	...
	public MEDICAL_ENTITY() {
	}

	public MEDICAL_ENTITY(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_ENTITY(String string) {
	...
	public MEDICAL_ENTITY(AdditionalType additionalType) {
	...
	public MEDICAL_ENTITY(AlternateName alternateName) {
	...
	public MEDICAL_ENTITY(Code code) {
		setCode(code);
	}
	...
	public MEDICAL_ENTITY(Description description) {
	...
	public MEDICAL_ENTITY(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_ENTITY(Guideline guideline) {
	...
	public MEDICAL_ENTITY(Identifier identifier) {
	...
	public MEDICAL_ENTITY(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_ENTITY(LegalStatus legalStatus) {
	...
	public MEDICAL_ENTITY(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_ENTITY(MedicineSystem medicineSystem) {
	...
	public MEDICAL_ENTITY(Name name) {
		setName(name);
	}
	...
	public MEDICAL_ENTITY(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_ENTITY(NameRuby nameRuby) {
	...
	public MEDICAL_ENTITY(PotentialAction potentialAction) {
	...
	public MEDICAL_ENTITY(RecognizingAuthority recognizingAuthority) {
	...
	public MEDICAL_ENTITY(RelevantSpecialty relevantSpecialty) {
	...
	public MEDICAL_ENTITY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_ENTITY(Study study) {
		setStudy(study);
	}
	...
	public MEDICAL_ENTITY(SubjectOf subjectOf) {
	...
	public void copy(Clazz.MedicalEntity org) {
		setSeq(org.getSeq());
