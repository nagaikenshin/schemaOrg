...
public class DRAINS_TO implements Container.DrainsTo {
	...
	public DRAINS_TO(String string) {
	...
	public DRAINS_TO(Artery artery) {
	...
	public DRAINS_TO(LymphaticVessel lymphaticVessel) {
	...
	public DRAINS_TO(Vessel vessel) {
		vesselList = new ArrayList<Vessel>();
	...
	public DRAINS_TO(List<Artery> arteryList,
	...
	public void copy(Container.DrainsTo org) {
