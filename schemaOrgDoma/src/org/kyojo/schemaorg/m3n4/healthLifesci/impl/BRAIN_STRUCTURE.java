...
public class BRAIN_STRUCTURE implements Clazz.BrainStructure {
	...
	public BRAIN_STRUCTURE() {
	}

	public BRAIN_STRUCTURE(Long seq) {
		setSeq(seq);
	}

	public BRAIN_STRUCTURE(String string) {
	...
	public BRAIN_STRUCTURE(AdditionalType additionalType) {
	...
	public BRAIN_STRUCTURE(AlternateName alternateName) {
	...
	public BRAIN_STRUCTURE(AssociatedPathophysiology associatedPathophysiology) {
	...
	public BRAIN_STRUCTURE(BodyLocation bodyLocation) {
	...
	public BRAIN_STRUCTURE(Code code) {
		setCode(code);
	}
	...
	public BRAIN_STRUCTURE(ConnectedTo connectedTo) {
	...
	public BRAIN_STRUCTURE(Description description) {
	...
	public BRAIN_STRUCTURE(Diagram diagram) {
		setDiagram(diagram);
	}
	...
	public BRAIN_STRUCTURE(DisambiguatingDescription disambiguatingDescription) {
	...
	public BRAIN_STRUCTURE(Function function) {
	...
	public BRAIN_STRUCTURE(Guideline guideline) {
	...
	public BRAIN_STRUCTURE(Identifier identifier) {
	...
	public BRAIN_STRUCTURE(Image image) {
		setImage(image);
	}
	...
	public BRAIN_STRUCTURE(LegalStatus legalStatus) {
	...
	public BRAIN_STRUCTURE(MainEntityOfPage mainEntityOfPage) {
	...
	public BRAIN_STRUCTURE(MedicineSystem medicineSystem) {
	...
	public BRAIN_STRUCTURE(Name name) {
		setName(name);
	}
	...
	public BRAIN_STRUCTURE(NameFuzzy nameFuzzy) {
	...
	public BRAIN_STRUCTURE(NameRuby nameRuby) {
	...
	public BRAIN_STRUCTURE(PartOfSystem partOfSystem) {
	...
	public BRAIN_STRUCTURE(PotentialAction potentialAction) {
	...
	public BRAIN_STRUCTURE(RecognizingAuthority recognizingAuthority) {
	...
	public BRAIN_STRUCTURE(RelatedCondition relatedCondition) {
	...
	public BRAIN_STRUCTURE(RelatedTherapy relatedTherapy) {
	...
	public BRAIN_STRUCTURE(RelevantSpecialty relevantSpecialty) {
	...
	public BRAIN_STRUCTURE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public BRAIN_STRUCTURE(Study study) {
		setStudy(study);
	}
	...
	public BRAIN_STRUCTURE(SubStructure subStructure) {
	...
	public BRAIN_STRUCTURE(SubjectOf subjectOf) {
	...
	public BRAIN_STRUCTURE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.BrainStructure org) {
		setSeq(org.getSeq());
