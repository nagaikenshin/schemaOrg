...
public class ANATOMICAL_STRUCTURE implements Clazz.AnatomicalStructure {
	...
	public ANATOMICAL_STRUCTURE() {
	}

	public ANATOMICAL_STRUCTURE(Long seq) {
		setSeq(seq);
	}

	public ANATOMICAL_STRUCTURE(String string) {
	...
	public ANATOMICAL_STRUCTURE(AdditionalType additionalType) {
	...
	public ANATOMICAL_STRUCTURE(AlternateName alternateName) {
	...
	public ANATOMICAL_STRUCTURE(AssociatedPathophysiology associatedPathophysiology) {
	...
	public ANATOMICAL_STRUCTURE(BodyLocation bodyLocation) {
	...
	public ANATOMICAL_STRUCTURE(Code code) {
		setCode(code);
	}
	...
	public ANATOMICAL_STRUCTURE(ConnectedTo connectedTo) {
	...
	public ANATOMICAL_STRUCTURE(Description description) {
	...
	public ANATOMICAL_STRUCTURE(Diagram diagram) {
		setDiagram(diagram);
	}
	...
	public ANATOMICAL_STRUCTURE(DisambiguatingDescription disambiguatingDescription) {
	...
	public ANATOMICAL_STRUCTURE(Function function) {
	...
	public ANATOMICAL_STRUCTURE(Guideline guideline) {
	...
	public ANATOMICAL_STRUCTURE(Identifier identifier) {
	...
	public ANATOMICAL_STRUCTURE(Image image) {
		setImage(image);
	}
	...
	public ANATOMICAL_STRUCTURE(LegalStatus legalStatus) {
	...
	public ANATOMICAL_STRUCTURE(MainEntityOfPage mainEntityOfPage) {
	...
	public ANATOMICAL_STRUCTURE(MedicineSystem medicineSystem) {
	...
	public ANATOMICAL_STRUCTURE(Name name) {
		setName(name);
	}
	...
	public ANATOMICAL_STRUCTURE(NameFuzzy nameFuzzy) {
	...
	public ANATOMICAL_STRUCTURE(NameRuby nameRuby) {
	...
	public ANATOMICAL_STRUCTURE(PartOfSystem partOfSystem) {
	...
	public ANATOMICAL_STRUCTURE(PotentialAction potentialAction) {
	...
	public ANATOMICAL_STRUCTURE(RecognizingAuthority recognizingAuthority) {
	...
	public ANATOMICAL_STRUCTURE(RelatedCondition relatedCondition) {
	...
	public ANATOMICAL_STRUCTURE(RelatedTherapy relatedTherapy) {
	...
	public ANATOMICAL_STRUCTURE(RelevantSpecialty relevantSpecialty) {
	...
	public ANATOMICAL_STRUCTURE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ANATOMICAL_STRUCTURE(Study study) {
		setStudy(study);
	}
	...
	public ANATOMICAL_STRUCTURE(SubStructure subStructure) {
	...
	public ANATOMICAL_STRUCTURE(SubjectOf subjectOf) {
	...
	public ANATOMICAL_STRUCTURE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.AnatomicalStructure org) {
		setSeq(org.getSeq());
