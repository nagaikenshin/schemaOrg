...
import org.kyojo.schemaorg.m3n4.healthLifesci.Container.TrialDesign;
import org.kyojo.schemaorg.m3n4.pending.Container.SubjectOf;


public class MEDICAL_TRIAL implements Clazz.MedicalTrial {
	...
	public TrialDesign trialDesign;
	public Url url;

	public MEDICAL_TRIAL() {
	}

	public MEDICAL_TRIAL(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_TRIAL(String string) {
	...
	public MEDICAL_TRIAL(AdditionalType additionalType) {
	...
	public MEDICAL_TRIAL(AlternateName alternateName) {
	...
	public MEDICAL_TRIAL(Code code) {
		setCode(code);
	}
	...
	public MEDICAL_TRIAL(Description description) {
	...
	public MEDICAL_TRIAL(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_TRIAL(Guideline guideline) {
	...
	public MEDICAL_TRIAL(HealthCondition healthCondition) {
	...
	public MEDICAL_TRIAL(Identifier identifier) {
	...
	public MEDICAL_TRIAL(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_TRIAL(LegalStatus legalStatus) {
	...
	public MEDICAL_TRIAL(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_TRIAL(MedicineSystem medicineSystem) {
	...
	public MEDICAL_TRIAL(Name name) {
		setName(name);
	}
	...
	public MEDICAL_TRIAL(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_TRIAL(NameRuby nameRuby) {
	...
	public MEDICAL_TRIAL(Outcome outcome) {
		setOutcome(outcome);
	}
	...
	public MEDICAL_TRIAL(Phase phase) {
		setPhase(phase);
	}
	...
	public MEDICAL_TRIAL(Population population) {
	...
	public MEDICAL_TRIAL(PotentialAction potentialAction) {
	...
	public MEDICAL_TRIAL(RecognizingAuthority recognizingAuthority) {
	...
	public MEDICAL_TRIAL(RelevantSpecialty relevantSpecialty) {
	...
	public MEDICAL_TRIAL(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_TRIAL(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MEDICAL_TRIAL(Status status) {
		setStatus(status);
	}
	...
	public MEDICAL_TRIAL(Study study) {
		setStudy(study);
	}
	...
	public MEDICAL_TRIAL(StudyLocation studyLocation) {
	...
	public MEDICAL_TRIAL(StudySubject studySubject) {
	...
	public MEDICAL_TRIAL(SubjectOf subjectOf) {
	...
	public MEDICAL_TRIAL(TrialDesign trialDesign) {
		setTrialDesign(trialDesign);
	}
	...
	public void copy(Clazz.MedicalTrial org) {
		setSeq(org.getSeq());
		...
		setTrialDesign(org.getTrialDesign());
		setUrl(org.getUrl());
	}
