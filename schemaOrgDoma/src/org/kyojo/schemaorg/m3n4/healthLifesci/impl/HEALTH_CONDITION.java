...
public class HEALTH_CONDITION implements Container.HealthCondition {
	...
	public HEALTH_CONDITION(InfectiousDisease infectiousDisease) {
	...
	public HEALTH_CONDITION(MedicalSign medicalSign) {
	...
	public HEALTH_CONDITION(MedicalSignOrSymptom medicalSignOrSymptom) {
	...
	public HEALTH_CONDITION(MedicalSymptom medicalSymptom) {
	...
	public HEALTH_CONDITION(VitalSign vitalSign) {
	...
	public HEALTH_CONDITION(List<InfectiousDisease> infectiousDiseaseList,
	...
	public void copy(Container.HealthCondition org) {
