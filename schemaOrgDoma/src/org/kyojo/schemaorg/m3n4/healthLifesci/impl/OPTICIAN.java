...
public class OPTICIAN implements Clazz.Optician {
	...
	public OPTICIAN(Long seq) {
		setSeq(seq);
	}

	public OPTICIAN(String string) {
	...
	public OPTICIAN(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public OPTICIAN(AdditionalProperty additionalProperty) {
	...
	public OPTICIAN(AdditionalType additionalType) {
	...
	public OPTICIAN(Address address) {
		setAddress(address);
	}
	...
	public OPTICIAN(AggregateRating aggregateRating) {
	...
	public OPTICIAN(AlternateName alternateName) {
	...
	public OPTICIAN(AmenityFeature amenityFeature) {
	...
	public OPTICIAN(AreaServed areaServed) {
	...
	public OPTICIAN(BranchCode branchCode) {
	...
	public OPTICIAN(ContactPoint contactPoint) {
	...
	public OPTICIAN(ContainedInPlace containedInPlace) {
	...
	public OPTICIAN(ContainsPlace containsPlace) {
	...
	public OPTICIAN(CorrectionsPolicy correctionsPolicy) {
	...
	public OPTICIAN(CurrenciesAccepted currenciesAccepted) {
	...
	public OPTICIAN(Department department) {
	...
	public OPTICIAN(Description description) {
	...
	public OPTICIAN(DisambiguatingDescription disambiguatingDescription) {
	...
	public OPTICIAN(DissolutionDate dissolutionDate) {
	...
	public OPTICIAN(DiversityPolicy diversityPolicy) {
	...
	public OPTICIAN(DiversityStaffingReport diversityStaffingReport) {
	...
	public OPTICIAN(Employee employee) {
	...
	public OPTICIAN(EthicsPolicy ethicsPolicy) {
	...
	public OPTICIAN(FaxNumber faxNumber) {
	...
	public OPTICIAN(Founder founder) {
		setFounder(founder);
	}
	...
	public OPTICIAN(FoundingDate foundingDate) {
	...
	public OPTICIAN(FoundingLocation foundingLocation) {
	...
	public OPTICIAN(GeospatiallyContains geospatiallyContains) {
	...
	public OPTICIAN(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public OPTICIAN(GeospatiallyCovers geospatiallyCovers) {
	...
	public OPTICIAN(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public OPTICIAN(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public OPTICIAN(GeospatiallyEquals geospatiallyEquals) {
	...
	public OPTICIAN(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public OPTICIAN(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public OPTICIAN(GeospatiallyTouches geospatiallyTouches) {
	...
	public OPTICIAN(GeospatiallyWithin geospatiallyWithin) {
	...
	public OPTICIAN(GlobalLocationNumber globalLocationNumber) {
	...
	public OPTICIAN(HasOfferCatalog hasOfferCatalog) {
	...
	public OPTICIAN(Identifier identifier) {
	...
	public OPTICIAN(IsAccessibleForFree isAccessibleForFree) {
	...
	public OPTICIAN(KnowsAbout knowsAbout) {
	...
	public OPTICIAN(KnowsLanguage knowsLanguage) {
	...
	public OPTICIAN(LegalName legalName) {
	...
	public OPTICIAN(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public OPTICIAN(Location location) {
	...
	public OPTICIAN(MainEntityOfPage mainEntityOfPage) {
	...
	public OPTICIAN(MakesOffer makesOffer) {
	...
	public OPTICIAN(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public OPTICIAN(MemberOf memberOf) {
	...
	public OPTICIAN(NameFuzzy nameFuzzy) {
	...
	public OPTICIAN(NameRuby nameRuby) {
	...
	public OPTICIAN(NumberOfEmployees numberOfEmployees) {
	...
	public OPTICIAN(OpeningHours openingHours) {
	...
	public OPTICIAN(OpeningHoursSpecification openingHoursSpecification) {
	...
	public OPTICIAN(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public OPTICIAN(ParentOrganization parentOrganization) {
	...
	public OPTICIAN(PaymentAccepted paymentAccepted) {
	...
	public OPTICIAN(PotentialAction potentialAction) {
	...
	public OPTICIAN(PriceRange priceRange) {
	...
	public OPTICIAN(PublicAccess publicAccess) {
	...
	public OPTICIAN(PublishingPrinciples publishingPrinciples) {
	...
	public OPTICIAN(SmokingAllowed smokingAllowed) {
	...
	public OPTICIAN(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public OPTICIAN(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public OPTICIAN(SubOrganization subOrganization) {
	...
	public OPTICIAN(SubjectOf subjectOf) {
	...
	public OPTICIAN(Telephone telephone) {
	...
	public OPTICIAN(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Optician org) {
		setSeq(org.getSeq());
