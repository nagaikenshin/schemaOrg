...
public class DRUG_CLASS implements Clazz.DrugClass, Container.DrugClass {
	...
	public DRUG_CLASS(Long seq) {
		setSeq(seq);
	}

	public DRUG_CLASS(String string) {
	...
	public DRUG_CLASS(AdditionalType additionalType) {
	...
	public DRUG_CLASS(AlternateName alternateName) {
	...
	public DRUG_CLASS(Description description) {
	...
	public DRUG_CLASS(DisambiguatingDescription disambiguatingDescription) {
	...
	public DRUG_CLASS(Clazz.DrugClass drugClass) {
		drugClassList = new ArrayList<Clazz.DrugClass>();
	...
	public DRUG_CLASS(Identifier identifier) {
	...
	public DRUG_CLASS(MainEntityOfPage mainEntityOfPage) {
	...
	public DRUG_CLASS(NameFuzzy nameFuzzy) {
	...
	public DRUG_CLASS(NameRuby nameRuby) {
	...
	public DRUG_CLASS(PotentialAction potentialAction) {
	...
	public DRUG_CLASS(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DRUG_CLASS(SubjectOf subjectOf) {
	...
	public DRUG_CLASS(SupersededBy supersededBy) {
	...
	public DRUG_CLASS(Long seq,
			...
			Drug drug,
			List<Clazz.DrugClass> drugClassList,
	...
	public void copy(Clazz.DrugClass org) {
		setSeq(org.getSeq());
	...
	public void copy(Container.DrugClass org) {
