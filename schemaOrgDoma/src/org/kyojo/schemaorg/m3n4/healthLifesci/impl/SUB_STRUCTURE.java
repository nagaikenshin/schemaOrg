...
public class SUB_STRUCTURE implements Container.SubStructure {
	...
	public SUB_STRUCTURE(String string) {
	...
	public SUB_STRUCTURE(AnatomicalStructure anatomicalStructure) {
		anatomicalStructureList = new ArrayList<AnatomicalStructure>();
	...
	public SUB_STRUCTURE(Artery artery) {
	...
	public SUB_STRUCTURE(Bone bone) {
	...
	public SUB_STRUCTURE(BrainStructure brainStructure) {
	...
	public SUB_STRUCTURE(Joint joint) {
	...
	public SUB_STRUCTURE(Ligament ligament) {
	...
	public SUB_STRUCTURE(LymphaticVessel lymphaticVessel) {
	...
	public SUB_STRUCTURE(Muscle muscle) {
	...
	public SUB_STRUCTURE(Nerve nerve) {
	...
	public SUB_STRUCTURE(Vein vein) {
	...
	public SUB_STRUCTURE(Vessel vessel) {
	...
	public SUB_STRUCTURE(List<AnatomicalStructure> anatomicalStructureList,
	...
	public void copy(Container.SubStructure org) {
