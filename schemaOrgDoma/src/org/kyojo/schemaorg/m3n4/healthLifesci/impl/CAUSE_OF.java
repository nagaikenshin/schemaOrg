...
public class CAUSE_OF implements Container.CauseOf {
	...
	public CAUSE_OF(AnatomicalStructure anatomicalStructure) {
	...
	public CAUSE_OF(AnatomicalSystem anatomicalSystem) {
	...
	public CAUSE_OF(ApprovedIndication approvedIndication) {
	...
	public CAUSE_OF(BloodTest bloodTest) {
	...
	public CAUSE_OF(BrainStructure brainStructure) {
	...
	public CAUSE_OF(DDxElement ddxElement) {
	...
	public CAUSE_OF(DiagnosticProcedure diagnosticProcedure) {
	...
	public CAUSE_OF(DietarySupplement dietarySupplement) {
	...
	public CAUSE_OF(DoseSchedule doseSchedule) {
	...
	public CAUSE_OF(DrugLegalStatus drugLegalStatus) {
	...
	public CAUSE_OF(DrugStrength drugStrength) {
	...
	public CAUSE_OF(ExercisePlan exercisePlan) {
	...
	public CAUSE_OF(ImagingTest imagingTest) {
	...
	public CAUSE_OF(InfectiousDisease infectiousDisease) {
	...
	public CAUSE_OF(LifestyleModification lifestyleModification) {
	...
	public CAUSE_OF(Ligament ligament) {
	...
	public CAUSE_OF(LymphaticVessel lymphaticVessel) {
	...
	public CAUSE_OF(MaximumDoseSchedule maximumDoseSchedule) {
	...
	public CAUSE_OF(MedicalCause medicalCause) {
	...
	public CAUSE_OF(MedicalCode medicalCode) {
	...
	public CAUSE_OF(MedicalCondition medicalCondition) {
	...
	public CAUSE_OF(MedicalConditionStage medicalConditionStage) {
	...
	public CAUSE_OF(MedicalContraindication medicalContraindication) {
	...
	public CAUSE_OF(MedicalDevice medicalDevice) {
	...
	public CAUSE_OF(MedicalGuideline medicalGuideline) {
	...
	public CAUSE_OF(MedicalGuidelineContraindication medicalGuidelineContraindication) {
	...
	public CAUSE_OF(MedicalGuidelineRecommendation medicalGuidelineRecommendation) {
	...
	public CAUSE_OF(MedicalIndication medicalIndication) {
	...
	public CAUSE_OF(MedicalIntangible medicalIntangible) {
	...
	public CAUSE_OF(MedicalObservationalStudy medicalObservationalStudy) {
	...
	public CAUSE_OF(MedicalProcedure medicalProcedure) {
	...
	public CAUSE_OF(MedicalRiskCalculator medicalRiskCalculator) {
	...
	public CAUSE_OF(MedicalRiskEstimator medicalRiskEstimator) {
	...
	public CAUSE_OF(MedicalRiskFactor medicalRiskFactor) {
	...
	public CAUSE_OF(MedicalRiskScore medicalRiskScore) {
	...
	public CAUSE_OF(MedicalSign medicalSign) {
	...
	public CAUSE_OF(MedicalSignOrSymptom medicalSignOrSymptom) {
	...
	public CAUSE_OF(MedicalStudy medicalStudy) {
	...
	public CAUSE_OF(MedicalSymptom medicalSymptom) {
	...
	public CAUSE_OF(MedicalTest medicalTest) {
	...
	public CAUSE_OF(MedicalTestPanel medicalTestPanel) {
	...
	public CAUSE_OF(MedicalTherapy medicalTherapy) {
	...
	public CAUSE_OF(MedicalTrial medicalTrial) {
	...
	public CAUSE_OF(OccupationalTherapy occupationalTherapy) {
	...
	public CAUSE_OF(PalliativeProcedure palliativeProcedure) {
	...
	public CAUSE_OF(PathologyTest pathologyTest) {
	...
	public CAUSE_OF(PhysicalActivity physicalActivity) {
	...
	public CAUSE_OF(PhysicalExam physicalExam) {
	...
	public CAUSE_OF(PhysicalTherapy physicalTherapy) {
	...
	public CAUSE_OF(PreventionIndication preventionIndication) {
	...
	public CAUSE_OF(PsychologicalTreatment psychologicalTreatment) {
	...
	public CAUSE_OF(RadiationTherapy radiationTherapy) {
	...
	public CAUSE_OF(RecommendedDoseSchedule recommendedDoseSchedule) {
	...
	public CAUSE_OF(ReportedDoseSchedule reportedDoseSchedule) {
	...
	public CAUSE_OF(RespiratoryTherapy respiratoryTherapy) {
	...
	public CAUSE_OF(Substance substance) {
	...
	public CAUSE_OF(SuperficialAnatomy superficialAnatomy) {
	...
	public CAUSE_OF(SurgicalProcedure surgicalProcedure) {
	...
	public CAUSE_OF(TherapeuticProcedure therapeuticProcedure) {
	...
	public CAUSE_OF(TreatmentIndication treatmentIndication) {
	...
	public CAUSE_OF(VitalSign vitalSign) {
	...
	public void copy(Container.CauseOf org) {
