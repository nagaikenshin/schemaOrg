...
public class SECONDARY_PREVENTION implements Container.SecondaryPrevention {
	...
	public SECONDARY_PREVENTION(String string) {
	...
	public SECONDARY_PREVENTION(MedicalTherapy medicalTherapy) {
		medicalTherapyList = new ArrayList<MedicalTherapy>();
	...
	public SECONDARY_PREVENTION(OccupationalTherapy occupationalTherapy) {
	...
	public SECONDARY_PREVENTION(PalliativeProcedure palliativeProcedure) {
	...
	public SECONDARY_PREVENTION(PhysicalTherapy physicalTherapy) {
	...
	public SECONDARY_PREVENTION(RadiationTherapy radiationTherapy) {
	...
	public SECONDARY_PREVENTION(RespiratoryTherapy respiratoryTherapy) {
	...
	public SECONDARY_PREVENTION(List<MedicalTherapy> medicalTherapyList,
	...
	public void copy(Container.SecondaryPrevention org) {
