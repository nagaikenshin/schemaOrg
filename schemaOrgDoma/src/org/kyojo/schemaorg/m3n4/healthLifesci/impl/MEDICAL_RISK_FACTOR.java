...
public class MEDICAL_RISK_FACTOR implements Clazz.MedicalRiskFactor {
	...
	public Image image;
	public IncreasesRiskOf increasesRiskOf;
	...
	public MEDICAL_RISK_FACTOR() {
	}

	public MEDICAL_RISK_FACTOR(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_RISK_FACTOR(String string) {
	...
	public MEDICAL_RISK_FACTOR(AdditionalType additionalType) {
	...
	public MEDICAL_RISK_FACTOR(AlternateName alternateName) {
	...
	public MEDICAL_RISK_FACTOR(Code code) {
		setCode(code);
	}
	...
	public MEDICAL_RISK_FACTOR(Description description) {
	...
	public MEDICAL_RISK_FACTOR(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_RISK_FACTOR(Guideline guideline) {
	...
	public MEDICAL_RISK_FACTOR(Identifier identifier) {
	...
	public MEDICAL_RISK_FACTOR(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_RISK_FACTOR(IncreasesRiskOf increasesRiskOf) {
		setIncreasesRiskOf(increasesRiskOf);
	}

	@Override
	public IncreasesRiskOf getIncreasesRiskOf() {
		return increasesRiskOf;
	}

	@Override
	public void setIncreasesRiskOf(IncreasesRiskOf increasesRiskOf) {
		this.increasesRiskOf = increasesRiskOf;
	}

	public MEDICAL_RISK_FACTOR(LegalStatus legalStatus) {
	...
	public MEDICAL_RISK_FACTOR(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_RISK_FACTOR(MedicineSystem medicineSystem) {
	...
	public MEDICAL_RISK_FACTOR(Name name) {
		setName(name);
	}
	...
	public MEDICAL_RISK_FACTOR(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_RISK_FACTOR(NameRuby nameRuby) {
	...
	public MEDICAL_RISK_FACTOR(PotentialAction potentialAction) {
	...
	public MEDICAL_RISK_FACTOR(RecognizingAuthority recognizingAuthority) {
	...
	public MEDICAL_RISK_FACTOR(RelevantSpecialty relevantSpecialty) {
	...
	public MEDICAL_RISK_FACTOR(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_RISK_FACTOR(Study study) {
		setStudy(study);
	}
	...
	public MEDICAL_RISK_FACTOR(SubjectOf subjectOf) {
	...
	public MEDICAL_RISK_FACTOR(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.MedicalRiskFactor org) {
		setSeq(org.getSeq());
		...
		setIncreasesRiskOf(org.getIncreasesRiskOf());
