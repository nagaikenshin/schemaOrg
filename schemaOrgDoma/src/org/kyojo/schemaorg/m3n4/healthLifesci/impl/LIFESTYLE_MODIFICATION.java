...
public class LIFESTYLE_MODIFICATION implements Clazz.LifestyleModification {
	...
	public LIFESTYLE_MODIFICATION() {
	}

	public LIFESTYLE_MODIFICATION(Long seq) {
		setSeq(seq);
	}

	public LIFESTYLE_MODIFICATION(String string) {
	...
	public LIFESTYLE_MODIFICATION(AdditionalType additionalType) {
	...
	public LIFESTYLE_MODIFICATION(AlternateName alternateName) {
	...
	public LIFESTYLE_MODIFICATION(Code code) {
		setCode(code);
	}
	...
	public LIFESTYLE_MODIFICATION(Description description) {
	...
	public LIFESTYLE_MODIFICATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public LIFESTYLE_MODIFICATION(Guideline guideline) {
	...
	public LIFESTYLE_MODIFICATION(Identifier identifier) {
	...
	public LIFESTYLE_MODIFICATION(Image image) {
		setImage(image);
	}
	...
	public LIFESTYLE_MODIFICATION(LegalStatus legalStatus) {
	...
	public LIFESTYLE_MODIFICATION(MainEntityOfPage mainEntityOfPage) {
	...
	public LIFESTYLE_MODIFICATION(MedicineSystem medicineSystem) {
	...
	public LIFESTYLE_MODIFICATION(Name name) {
		setName(name);
	}
	...
	public LIFESTYLE_MODIFICATION(NameFuzzy nameFuzzy) {
	...
	public LIFESTYLE_MODIFICATION(NameRuby nameRuby) {
	...
	public LIFESTYLE_MODIFICATION(PotentialAction potentialAction) {
	...
	public LIFESTYLE_MODIFICATION(RecognizingAuthority recognizingAuthority) {
	...
	public LIFESTYLE_MODIFICATION(RelevantSpecialty relevantSpecialty) {
	...
	public LIFESTYLE_MODIFICATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public LIFESTYLE_MODIFICATION(Study study) {
		setStudy(study);
	}
	...
	public LIFESTYLE_MODIFICATION(SubjectOf subjectOf) {
	...
	public LIFESTYLE_MODIFICATION(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.LifestyleModification org) {
		setSeq(org.getSeq());
