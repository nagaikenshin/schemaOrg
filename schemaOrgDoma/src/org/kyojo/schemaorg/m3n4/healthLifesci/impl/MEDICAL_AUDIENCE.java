...
public class MEDICAL_AUDIENCE implements Clazz.MedicalAudience {
	...
	public MEDICAL_AUDIENCE() {
	}

	public MEDICAL_AUDIENCE(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_AUDIENCE(String string) {
	...
	public MEDICAL_AUDIENCE(AdditionalType additionalType) {
	...
	public MEDICAL_AUDIENCE(AlternateName alternateName) {
	...
	public MEDICAL_AUDIENCE(AudienceType audienceType) {
	...
	public MEDICAL_AUDIENCE(Description description) {
	...
	public MEDICAL_AUDIENCE(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_AUDIENCE(GeographicArea geographicArea) {
	...
	public MEDICAL_AUDIENCE(HealthCondition healthCondition) {
	...
	public MEDICAL_AUDIENCE(Identifier identifier) {
	...
	public MEDICAL_AUDIENCE(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_AUDIENCE(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_AUDIENCE(Name name) {
		setName(name);
	}
	...
	public MEDICAL_AUDIENCE(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_AUDIENCE(NameRuby nameRuby) {
	...
	public MEDICAL_AUDIENCE(PotentialAction potentialAction) {
	...
	public MEDICAL_AUDIENCE(RequiredGender requiredGender) {
	...
	public MEDICAL_AUDIENCE(RequiredMaxAge requiredMaxAge) {
	...
	public MEDICAL_AUDIENCE(RequiredMinAge requiredMinAge) {
	...
	public MEDICAL_AUDIENCE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_AUDIENCE(SubjectOf subjectOf) {
	...
	public MEDICAL_AUDIENCE(SuggestedGender suggestedGender) {
	...
	public MEDICAL_AUDIENCE(SuggestedMaxAge suggestedMaxAge) {
	...
	public MEDICAL_AUDIENCE(SuggestedMinAge suggestedMinAge) {
	...
	public MEDICAL_AUDIENCE(SupersededBy supersededBy) {
	...
	public MEDICAL_AUDIENCE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.MedicalAudience org) {
		setSeq(org.getSeq());
