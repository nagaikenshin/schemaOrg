...
public class MEDICAL_STUDY implements Clazz.MedicalStudy {
	...
	public MEDICAL_STUDY() {
	}

	public MEDICAL_STUDY(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_STUDY(String string) {
	...
	public MEDICAL_STUDY(AdditionalType additionalType) {
	...
	public MEDICAL_STUDY(AlternateName alternateName) {
	...
	public MEDICAL_STUDY(Code code) {
		setCode(code);
	}
	...
	public MEDICAL_STUDY(Description description) {
	...
	public MEDICAL_STUDY(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_STUDY(Guideline guideline) {
	...
	public MEDICAL_STUDY(HealthCondition healthCondition) {
	...
	public MEDICAL_STUDY(Identifier identifier) {
	...
	public MEDICAL_STUDY(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_STUDY(LegalStatus legalStatus) {
	...
	public MEDICAL_STUDY(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_STUDY(MedicineSystem medicineSystem) {
	...
	public MEDICAL_STUDY(Name name) {
		setName(name);
	}
	...
	public MEDICAL_STUDY(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_STUDY(NameRuby nameRuby) {
	...
	public MEDICAL_STUDY(Outcome outcome) {
		setOutcome(outcome);
	}
	...
	public MEDICAL_STUDY(Population population) {
	...
	public MEDICAL_STUDY(PotentialAction potentialAction) {
	...
	public MEDICAL_STUDY(RecognizingAuthority recognizingAuthority) {
	...
	public MEDICAL_STUDY(RelevantSpecialty relevantSpecialty) {
	...
	public MEDICAL_STUDY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_STUDY(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MEDICAL_STUDY(Status status) {
		setStatus(status);
	}
	...
	public MEDICAL_STUDY(Study study) {
		setStudy(study);
	}
	...
	public MEDICAL_STUDY(StudyLocation studyLocation) {
	...
	public MEDICAL_STUDY(StudySubject studySubject) {
	...
	public MEDICAL_STUDY(SubjectOf subjectOf) {
	...
	public void copy(Clazz.MedicalStudy org) {
		setSeq(org.getSeq());
