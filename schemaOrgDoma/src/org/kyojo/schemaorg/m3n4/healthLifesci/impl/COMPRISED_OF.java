...
public class COMPRISED_OF implements Container.ComprisedOf {
	...
	public COMPRISED_OF(Artery artery) {
	...
	public COMPRISED_OF(BrainStructure brainStructure) {
	...
	public COMPRISED_OF(Joint joint) {
	...
	public COMPRISED_OF(Ligament ligament) {
	...
	public COMPRISED_OF(LymphaticVessel lymphaticVessel) {
	...
	public COMPRISED_OF(Muscle muscle) {
	...
	public COMPRISED_OF(Nerve nerve) {
	...
	public COMPRISED_OF(Vessel vessel) {
