...
public class REST_PERIODS implements Container.RestPeriods {
	...
	public REST_PERIODS(QualitativeValue qualitativeValue) {
	...
	public REST_PERIODS(String string) {
		this(new TEXT(string));
	}

	public REST_PERIODS(Text text) {
	...
	public REST_PERIODS(List<QualitativeValue> qualitativeValueList,
			List<Text> textList) {
		setQualitativeValueList(qualitativeValueList);
		setTextList(textList);
	}

	public void copy(Container.RestPeriods org) {
