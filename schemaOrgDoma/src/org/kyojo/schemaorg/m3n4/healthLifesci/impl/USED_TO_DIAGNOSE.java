...
public class USED_TO_DIAGNOSE implements Container.UsedToDiagnose {
	...
	public USED_TO_DIAGNOSE(String string) {
	...
	public USED_TO_DIAGNOSE(InfectiousDisease infectiousDisease) {
	...
	public USED_TO_DIAGNOSE(MedicalCondition medicalCondition) {
		medicalConditionList = new ArrayList<MedicalCondition>();
	...
	public USED_TO_DIAGNOSE(MedicalSign medicalSign) {
	...
	public USED_TO_DIAGNOSE(MedicalSignOrSymptom medicalSignOrSymptom) {
	...
	public USED_TO_DIAGNOSE(MedicalSymptom medicalSymptom) {
	...
	public USED_TO_DIAGNOSE(VitalSign vitalSign) {
	...
	public USED_TO_DIAGNOSE(List<InfectiousDisease> infectiousDiseaseList,
	...
	public void copy(Container.UsedToDiagnose org) {
