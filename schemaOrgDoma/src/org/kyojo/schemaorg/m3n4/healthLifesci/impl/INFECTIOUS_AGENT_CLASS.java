...
public class INFECTIOUS_AGENT_CLASS implements Clazz.InfectiousAgentClass, Container.InfectiousAgentClass {
	...
	public INFECTIOUS_AGENT_CLASS(Long seq) {
		setSeq(seq);
	}

	public INFECTIOUS_AGENT_CLASS(String string) {
	...
	public INFECTIOUS_AGENT_CLASS(AdditionalType additionalType) {
	...
	public INFECTIOUS_AGENT_CLASS(AlternateName alternateName) {
	...
	public INFECTIOUS_AGENT_CLASS(Description description) {
	...
	public INFECTIOUS_AGENT_CLASS(DisambiguatingDescription disambiguatingDescription) {
	...
	public INFECTIOUS_AGENT_CLASS(Identifier identifier) {
	...
	public INFECTIOUS_AGENT_CLASS(Image image) {
		setImage(image);
	}
	...
	public INFECTIOUS_AGENT_CLASS(Clazz.InfectiousAgentClass infectiousAgentClass) {
		infectiousAgentClassList = new ArrayList<Clazz.InfectiousAgentClass>();
	...
	public INFECTIOUS_AGENT_CLASS(MainEntityOfPage mainEntityOfPage) {
	...
	public INFECTIOUS_AGENT_CLASS(Name name) {
		setName(name);
	}
	...
	public INFECTIOUS_AGENT_CLASS(NameFuzzy nameFuzzy) {
	...
	public INFECTIOUS_AGENT_CLASS(NameRuby nameRuby) {
	...
	public INFECTIOUS_AGENT_CLASS(PotentialAction potentialAction) {
	...
	public INFECTIOUS_AGENT_CLASS(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public INFECTIOUS_AGENT_CLASS(SubjectOf subjectOf) {
	...
	public INFECTIOUS_AGENT_CLASS(SupersededBy supersededBy) {
	...
	public INFECTIOUS_AGENT_CLASS(Url url) {
		setUrl(url);
	}
	...
	public INFECTIOUS_AGENT_CLASS(Long seq,
			...
			Image image,
			List<Clazz.InfectiousAgentClass> infectiousAgentClassList,
	...
	public void copy(Clazz.InfectiousAgentClass org) {
		setSeq(org.getSeq());
	...
	public void copy(Container.InfectiousAgentClass org) {
