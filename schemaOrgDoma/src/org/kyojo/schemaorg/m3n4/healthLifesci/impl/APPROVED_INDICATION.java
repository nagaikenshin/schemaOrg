...
public class APPROVED_INDICATION implements Clazz.ApprovedIndication {
	...
	public APPROVED_INDICATION() {
	}

	public APPROVED_INDICATION(Long seq) {
		setSeq(seq);
	}

	public APPROVED_INDICATION(String string) {
	...
	public APPROVED_INDICATION(AdditionalType additionalType) {
	...
	public APPROVED_INDICATION(AlternateName alternateName) {
	...
	public APPROVED_INDICATION(Code code) {
		setCode(code);
	}
	...
	public APPROVED_INDICATION(Description description) {
	...
	public APPROVED_INDICATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public APPROVED_INDICATION(Guideline guideline) {
	...
	public APPROVED_INDICATION(Identifier identifier) {
	...
	public APPROVED_INDICATION(Image image) {
		setImage(image);
	}
	...
	public APPROVED_INDICATION(LegalStatus legalStatus) {
	...
	public APPROVED_INDICATION(MainEntityOfPage mainEntityOfPage) {
	...
	public APPROVED_INDICATION(MedicineSystem medicineSystem) {
	...
	public APPROVED_INDICATION(Name name) {
		setName(name);
	}
	...
	public APPROVED_INDICATION(NameFuzzy nameFuzzy) {
	...
	public APPROVED_INDICATION(NameRuby nameRuby) {
	...
	public APPROVED_INDICATION(PotentialAction potentialAction) {
	...
	public APPROVED_INDICATION(RecognizingAuthority recognizingAuthority) {
	...
	public APPROVED_INDICATION(RelevantSpecialty relevantSpecialty) {
	...
	public APPROVED_INDICATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public APPROVED_INDICATION(Study study) {
		setStudy(study);
	}
	...
	public APPROVED_INDICATION(SubjectOf subjectOf) {
	...
	public APPROVED_INDICATION(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.ApprovedIndication org) {
		setSeq(org.getSeq());
