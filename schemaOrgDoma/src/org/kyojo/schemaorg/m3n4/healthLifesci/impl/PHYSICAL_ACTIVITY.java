...
public class PHYSICAL_ACTIVITY implements Clazz.PhysicalActivity {
	...
	public PHYSICAL_ACTIVITY(Long seq) {
		setSeq(seq);
	}

	public PHYSICAL_ACTIVITY(String string) {
	...
	public PHYSICAL_ACTIVITY(AdditionalType additionalType) {
	...
	public PHYSICAL_ACTIVITY(AlternateName alternateName) {
	...
	public PHYSICAL_ACTIVITY(AssociatedAnatomy associatedAnatomy) {
	...
	public PHYSICAL_ACTIVITY(Category category) {
	...
	public PHYSICAL_ACTIVITY(Code code) {
		setCode(code);
	}
	...
	public PHYSICAL_ACTIVITY(Description description) {
	...
	public PHYSICAL_ACTIVITY(DisambiguatingDescription disambiguatingDescription) {
	...
	public PHYSICAL_ACTIVITY(Epidemiology epidemiology) {
	...
	public PHYSICAL_ACTIVITY(Guideline guideline) {
	...
	public PHYSICAL_ACTIVITY(Identifier identifier) {
	...
	public PHYSICAL_ACTIVITY(Image image) {
		setImage(image);
	}
	...
	public PHYSICAL_ACTIVITY(LegalStatus legalStatus) {
	...
	public PHYSICAL_ACTIVITY(MainEntityOfPage mainEntityOfPage) {
	...
	public PHYSICAL_ACTIVITY(MedicineSystem medicineSystem) {
	...
	public PHYSICAL_ACTIVITY(Name name) {
		setName(name);
	}
	...
	public PHYSICAL_ACTIVITY(NameFuzzy nameFuzzy) {
	...
	public PHYSICAL_ACTIVITY(NameRuby nameRuby) {
	...
	public PHYSICAL_ACTIVITY(Pathophysiology pathophysiology) {
	...
	public PHYSICAL_ACTIVITY(PotentialAction potentialAction) {
	...
	public PHYSICAL_ACTIVITY(RecognizingAuthority recognizingAuthority) {
	...
	public PHYSICAL_ACTIVITY(RelevantSpecialty relevantSpecialty) {
	...
	public PHYSICAL_ACTIVITY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PHYSICAL_ACTIVITY(Study study) {
		setStudy(study);
	}
	...
	public PHYSICAL_ACTIVITY(SubjectOf subjectOf) {
	...
	public PHYSICAL_ACTIVITY(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.PhysicalActivity org) {
		setSeq(org.getSeq());
