...
public class FUNCTIONAL_CLASS implements Container.FunctionalClass {
	...
	public FUNCTIONAL_CLASS(AnatomicalStructure anatomicalStructure) {
	...
	public FUNCTIONAL_CLASS(AnatomicalSystem anatomicalSystem) {
	...
	public FUNCTIONAL_CLASS(ApprovedIndication approvedIndication) {
	...
	public FUNCTIONAL_CLASS(Artery artery) {
	...
	public FUNCTIONAL_CLASS(BloodTest bloodTest) {
	...
	public FUNCTIONAL_CLASS(Bone bone) {
	...
	public FUNCTIONAL_CLASS(BrainStructure brainStructure) {
	...
	public FUNCTIONAL_CLASS(DDxElement ddxElement) {
	...
	public FUNCTIONAL_CLASS(DiagnosticProcedure diagnosticProcedure) {
	...
	public FUNCTIONAL_CLASS(Diet diet) {
	...
	public FUNCTIONAL_CLASS(DietarySupplement dietarySupplement) {
	...
	public FUNCTIONAL_CLASS(DoseSchedule doseSchedule) {
	...
	public FUNCTIONAL_CLASS(Drug drug) {
	...
	public FUNCTIONAL_CLASS(DrugLegalStatus drugLegalStatus) {
	...
	public FUNCTIONAL_CLASS(DrugStrength drugStrength) {
	...
	public FUNCTIONAL_CLASS(ExercisePlan exercisePlan) {
	...
	public FUNCTIONAL_CLASS(ImagingTest imagingTest) {
	...
	public FUNCTIONAL_CLASS(InfectiousDisease infectiousDisease) {
	...
	public FUNCTIONAL_CLASS(Joint joint) {
	...
	public FUNCTIONAL_CLASS(LifestyleModification lifestyleModification) {
	...
	public FUNCTIONAL_CLASS(Ligament ligament) {
	...
	public FUNCTIONAL_CLASS(LymphaticVessel lymphaticVessel) {
	...
	public FUNCTIONAL_CLASS(MaximumDoseSchedule maximumDoseSchedule) {
	...
	public FUNCTIONAL_CLASS(MedicalCause medicalCause) {
	...
	public FUNCTIONAL_CLASS(MedicalCode medicalCode) {
	...
	public FUNCTIONAL_CLASS(MedicalCondition medicalCondition) {
	...
	public FUNCTIONAL_CLASS(MedicalConditionStage medicalConditionStage) {
	...
	public FUNCTIONAL_CLASS(MedicalContraindication medicalContraindication) {
	...
	public FUNCTIONAL_CLASS(MedicalDevice medicalDevice) {
	...
	public FUNCTIONAL_CLASS(MedicalGuideline medicalGuideline) {
	...
	public FUNCTIONAL_CLASS(MedicalGuidelineContraindication medicalGuidelineContraindication) {
	...
	public FUNCTIONAL_CLASS(MedicalGuidelineRecommendation medicalGuidelineRecommendation) {
	...
	public FUNCTIONAL_CLASS(MedicalIndication medicalIndication) {
	...
	public FUNCTIONAL_CLASS(MedicalIntangible medicalIntangible) {
	...
	public FUNCTIONAL_CLASS(MedicalObservationalStudy medicalObservationalStudy) {
	...
	public FUNCTIONAL_CLASS(MedicalProcedure medicalProcedure) {
	...
	public FUNCTIONAL_CLASS(MedicalRiskCalculator medicalRiskCalculator) {
	...
	public FUNCTIONAL_CLASS(MedicalRiskEstimator medicalRiskEstimator) {
	...
	public FUNCTIONAL_CLASS(MedicalRiskFactor medicalRiskFactor) {
	...
	public FUNCTIONAL_CLASS(MedicalRiskScore medicalRiskScore) {
	...
	public FUNCTIONAL_CLASS(MedicalSign medicalSign) {
	...
	public FUNCTIONAL_CLASS(MedicalSignOrSymptom medicalSignOrSymptom) {
	...
	public FUNCTIONAL_CLASS(MedicalStudy medicalStudy) {
	...
	public FUNCTIONAL_CLASS(MedicalSymptom medicalSymptom) {
	...
	public FUNCTIONAL_CLASS(MedicalTest medicalTest) {
	...
	public FUNCTIONAL_CLASS(MedicalTestPanel medicalTestPanel) {
	...
	public FUNCTIONAL_CLASS(MedicalTherapy medicalTherapy) {
	...
	public FUNCTIONAL_CLASS(MedicalTrial medicalTrial) {
	...
	public FUNCTIONAL_CLASS(Muscle muscle) {
	...
	public FUNCTIONAL_CLASS(Nerve nerve) {
	...
	public FUNCTIONAL_CLASS(OccupationalTherapy occupationalTherapy) {
	...
	public FUNCTIONAL_CLASS(PalliativeProcedure palliativeProcedure) {
	...
	public FUNCTIONAL_CLASS(PathologyTest pathologyTest) {
	...
	public FUNCTIONAL_CLASS(PhysicalActivity physicalActivity) {
	...
	public FUNCTIONAL_CLASS(PhysicalExam physicalExam) {
	...
	public FUNCTIONAL_CLASS(PhysicalTherapy physicalTherapy) {
	...
	public FUNCTIONAL_CLASS(PreventionIndication preventionIndication) {
	...
	public FUNCTIONAL_CLASS(PsychologicalTreatment psychologicalTreatment) {
	...
	public FUNCTIONAL_CLASS(RadiationTherapy radiationTherapy) {
	...
	public FUNCTIONAL_CLASS(RecommendedDoseSchedule recommendedDoseSchedule) {
	...
	public FUNCTIONAL_CLASS(ReportedDoseSchedule reportedDoseSchedule) {
	...
	public FUNCTIONAL_CLASS(RespiratoryTherapy respiratoryTherapy) {
	...
	public FUNCTIONAL_CLASS(Substance substance) {
	...
	public FUNCTIONAL_CLASS(SuperficialAnatomy superficialAnatomy) {
	...
	public FUNCTIONAL_CLASS(SurgicalProcedure surgicalProcedure) {
	...
	public FUNCTIONAL_CLASS(TherapeuticProcedure therapeuticProcedure) {
	...
	public FUNCTIONAL_CLASS(TreatmentIndication treatmentIndication) {
	...
	public FUNCTIONAL_CLASS(Vein vein) {
	...
	public FUNCTIONAL_CLASS(Vessel vessel) {
	...
	public FUNCTIONAL_CLASS(VitalSign vitalSign) {
