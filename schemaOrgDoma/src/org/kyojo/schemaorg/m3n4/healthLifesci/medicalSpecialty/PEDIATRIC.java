...
public class PEDIATRIC implements MedicalSpecialty.Pediatric {
	...
	public PEDIATRIC(Long seq) {
		setSeq(seq);
	}

	public PEDIATRIC(String string) {
	...
	public PEDIATRIC(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public PEDIATRIC(AdditionalProperty additionalProperty) {
	...
	public PEDIATRIC(AdditionalType additionalType) {
	...
	public PEDIATRIC(Address address) {
		setAddress(address);
	}
	...
	public PEDIATRIC(AggregateRating aggregateRating) {
	...
	public PEDIATRIC(AlternateName alternateName) {
	...
	public PEDIATRIC(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public PEDIATRIC(AmenityFeature amenityFeature) {
	...
	public PEDIATRIC(AreaServed areaServed) {
	...
	public PEDIATRIC(BranchCode branchCode) {
	...
	public PEDIATRIC(ContactPoint contactPoint) {
	...
	public PEDIATRIC(ContainedInPlace containedInPlace) {
	...
	public PEDIATRIC(ContainsPlace containsPlace) {
	...
	public PEDIATRIC(CorrectionsPolicy correctionsPolicy) {
	...
	public PEDIATRIC(CurrenciesAccepted currenciesAccepted) {
	...
	public PEDIATRIC(Department department) {
	...
	public PEDIATRIC(Description description) {
	...
	public PEDIATRIC(DisambiguatingDescription disambiguatingDescription) {
	...
	public PEDIATRIC(DissolutionDate dissolutionDate) {
	...
	public PEDIATRIC(DiversityPolicy diversityPolicy) {
	...
	public PEDIATRIC(DiversityStaffingReport diversityStaffingReport) {
	...
	public PEDIATRIC(Employee employee) {
	...
	public PEDIATRIC(EthicsPolicy ethicsPolicy) {
	...
	public PEDIATRIC(FaxNumber faxNumber) {
	...
	public PEDIATRIC(Founder founder) {
		setFounder(founder);
	}
	...
	public PEDIATRIC(FoundingDate foundingDate) {
	...
	public PEDIATRIC(FoundingLocation foundingLocation) {
	...
	public PEDIATRIC(Funder funder) {
		setFunder(funder);
	}
	...
	public PEDIATRIC(GeospatiallyContains geospatiallyContains) {
	...
	public PEDIATRIC(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public PEDIATRIC(GeospatiallyCovers geospatiallyCovers) {
	...
	public PEDIATRIC(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public PEDIATRIC(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public PEDIATRIC(GeospatiallyEquals geospatiallyEquals) {
	...
	public PEDIATRIC(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public PEDIATRIC(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public PEDIATRIC(GeospatiallyTouches geospatiallyTouches) {
	...
	public PEDIATRIC(GeospatiallyWithin geospatiallyWithin) {
	...
	public PEDIATRIC(GlobalLocationNumber globalLocationNumber) {
	...
	public PEDIATRIC(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public PEDIATRIC(HasOfferCatalog hasOfferCatalog) {
	...
	public PEDIATRIC(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public PEDIATRIC(Identifier identifier) {
	...
	public PEDIATRIC(IsAccessibleForFree isAccessibleForFree) {
	...
	public PEDIATRIC(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public PEDIATRIC(KnowsAbout knowsAbout) {
	...
	public PEDIATRIC(KnowsLanguage knowsLanguage) {
	...
	public PEDIATRIC(LegalName legalName) {
	...
	public PEDIATRIC(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public PEDIATRIC(Location location) {
	...
	public PEDIATRIC(MainEntityOfPage mainEntityOfPage) {
	...
	public PEDIATRIC(MakesOffer makesOffer) {
	...
	public PEDIATRIC(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public PEDIATRIC(Member member) {
		setMember(member);
	}
	...
	public PEDIATRIC(MemberOf memberOf) {
	...
	public PEDIATRIC(NameFuzzy nameFuzzy) {
	...
	public PEDIATRIC(NameRuby nameRuby) {
	...
	public PEDIATRIC(NumberOfEmployees numberOfEmployees) {
	...
	public PEDIATRIC(OpeningHours openingHours) {
	...
	public PEDIATRIC(OpeningHoursSpecification openingHoursSpecification) {
	...
	public PEDIATRIC(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public PEDIATRIC(ParentOrganization parentOrganization) {
	...
	public PEDIATRIC(PaymentAccepted paymentAccepted) {
	...
	public PEDIATRIC(PotentialAction potentialAction) {
	...
	public PEDIATRIC(PriceRange priceRange) {
	...
	public PEDIATRIC(PublicAccess publicAccess) {
	...
	public PEDIATRIC(PublishingPrinciples publishingPrinciples) {
	...
	public PEDIATRIC(Review review) {
		setReview(review);
	}
	...
	public PEDIATRIC(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PEDIATRIC(SmokingAllowed smokingAllowed) {
	...
	public PEDIATRIC(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public PEDIATRIC(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public PEDIATRIC(SubOrganization subOrganization) {
	...
	public PEDIATRIC(SubjectOf subjectOf) {
	...
	public PEDIATRIC(SupersededBy supersededBy) {
	...
	public PEDIATRIC(Telephone telephone) {
	...
	public PEDIATRIC(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(MedicalSpecialty.Pediatric org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalSpecialty.Pediatric.class.getAnnotation(SampleValue.class).value();
	}
