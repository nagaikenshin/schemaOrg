...
public class ONCOLOGIC implements MedicalSpecialty.Oncologic {
	...
	public ONCOLOGIC(Long seq) {
		setSeq(seq);
	}

	public ONCOLOGIC(String string) {
	...
	public ONCOLOGIC(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public ONCOLOGIC(AdditionalProperty additionalProperty) {
	...
	public ONCOLOGIC(AdditionalType additionalType) {
	...
	public ONCOLOGIC(Address address) {
		setAddress(address);
	}
	...
	public ONCOLOGIC(AggregateRating aggregateRating) {
	...
	public ONCOLOGIC(AlternateName alternateName) {
	...
	public ONCOLOGIC(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public ONCOLOGIC(AmenityFeature amenityFeature) {
	...
	public ONCOLOGIC(AreaServed areaServed) {
	...
	public ONCOLOGIC(BranchCode branchCode) {
	...
	public ONCOLOGIC(ContactPoint contactPoint) {
	...
	public ONCOLOGIC(ContainedInPlace containedInPlace) {
	...
	public ONCOLOGIC(ContainsPlace containsPlace) {
	...
	public ONCOLOGIC(CorrectionsPolicy correctionsPolicy) {
	...
	public ONCOLOGIC(CurrenciesAccepted currenciesAccepted) {
	...
	public ONCOLOGIC(Department department) {
	...
	public ONCOLOGIC(Description description) {
	...
	public ONCOLOGIC(DisambiguatingDescription disambiguatingDescription) {
	...
	public ONCOLOGIC(DissolutionDate dissolutionDate) {
	...
	public ONCOLOGIC(DiversityPolicy diversityPolicy) {
	...
	public ONCOLOGIC(DiversityStaffingReport diversityStaffingReport) {
	...
	public ONCOLOGIC(Employee employee) {
	...
	public ONCOLOGIC(EthicsPolicy ethicsPolicy) {
	...
	public ONCOLOGIC(FaxNumber faxNumber) {
	...
	public ONCOLOGIC(Founder founder) {
		setFounder(founder);
	}
	...
	public ONCOLOGIC(FoundingDate foundingDate) {
	...
	public ONCOLOGIC(FoundingLocation foundingLocation) {
	...
	public ONCOLOGIC(Funder funder) {
		setFunder(funder);
	}
	...
	public ONCOLOGIC(GeospatiallyContains geospatiallyContains) {
	...
	public ONCOLOGIC(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public ONCOLOGIC(GeospatiallyCovers geospatiallyCovers) {
	...
	public ONCOLOGIC(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public ONCOLOGIC(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public ONCOLOGIC(GeospatiallyEquals geospatiallyEquals) {
	...
	public ONCOLOGIC(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public ONCOLOGIC(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public ONCOLOGIC(GeospatiallyTouches geospatiallyTouches) {
	...
	public ONCOLOGIC(GeospatiallyWithin geospatiallyWithin) {
	...
	public ONCOLOGIC(GlobalLocationNumber globalLocationNumber) {
	...
	public ONCOLOGIC(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public ONCOLOGIC(HasOfferCatalog hasOfferCatalog) {
	...
	public ONCOLOGIC(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public ONCOLOGIC(Identifier identifier) {
	...
	public ONCOLOGIC(IsAccessibleForFree isAccessibleForFree) {
	...
	public ONCOLOGIC(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public ONCOLOGIC(KnowsAbout knowsAbout) {
	...
	public ONCOLOGIC(KnowsLanguage knowsLanguage) {
	...
	public ONCOLOGIC(LegalName legalName) {
	...
	public ONCOLOGIC(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public ONCOLOGIC(Location location) {
	...
	public ONCOLOGIC(MainEntityOfPage mainEntityOfPage) {
	...
	public ONCOLOGIC(MakesOffer makesOffer) {
	...
	public ONCOLOGIC(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public ONCOLOGIC(Member member) {
		setMember(member);
	}
	...
	public ONCOLOGIC(MemberOf memberOf) {
	...
	public ONCOLOGIC(NameFuzzy nameFuzzy) {
	...
	public ONCOLOGIC(NameRuby nameRuby) {
	...
	public ONCOLOGIC(NumberOfEmployees numberOfEmployees) {
	...
	public ONCOLOGIC(OpeningHours openingHours) {
	...
	public ONCOLOGIC(OpeningHoursSpecification openingHoursSpecification) {
	...
	public ONCOLOGIC(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public ONCOLOGIC(ParentOrganization parentOrganization) {
	...
	public ONCOLOGIC(PaymentAccepted paymentAccepted) {
	...
	public ONCOLOGIC(PotentialAction potentialAction) {
	...
	public ONCOLOGIC(PriceRange priceRange) {
	...
	public ONCOLOGIC(PublicAccess publicAccess) {
	...
	public ONCOLOGIC(PublishingPrinciples publishingPrinciples) {
	...
	public ONCOLOGIC(Review review) {
		setReview(review);
	}
	...
	public ONCOLOGIC(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ONCOLOGIC(SmokingAllowed smokingAllowed) {
	...
	public ONCOLOGIC(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public ONCOLOGIC(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public ONCOLOGIC(SubOrganization subOrganization) {
	...
	public ONCOLOGIC(SubjectOf subjectOf) {
	...
	public ONCOLOGIC(SupersededBy supersededBy) {
	...
	public ONCOLOGIC(Telephone telephone) {
	...
	public ONCOLOGIC(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(MedicalSpecialty.Oncologic org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalSpecialty.Oncologic.class.getAnnotation(SampleValue.class).value();
	}
