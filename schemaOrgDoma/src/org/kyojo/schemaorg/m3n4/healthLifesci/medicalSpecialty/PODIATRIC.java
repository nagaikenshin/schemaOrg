...
public class PODIATRIC implements MedicalSpecialty.Podiatric {
	...
	public PODIATRIC(Long seq) {
		setSeq(seq);
	}

	public PODIATRIC(String string) {
	...
	public PODIATRIC(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public PODIATRIC(AdditionalProperty additionalProperty) {
	...
	public PODIATRIC(AdditionalType additionalType) {
	...
	public PODIATRIC(Address address) {
		setAddress(address);
	}
	...
	public PODIATRIC(AggregateRating aggregateRating) {
	...
	public PODIATRIC(AlternateName alternateName) {
	...
	public PODIATRIC(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public PODIATRIC(AmenityFeature amenityFeature) {
	...
	public PODIATRIC(AreaServed areaServed) {
	...
	public PODIATRIC(BranchCode branchCode) {
	...
	public PODIATRIC(ContactPoint contactPoint) {
	...
	public PODIATRIC(ContainedInPlace containedInPlace) {
	...
	public PODIATRIC(ContainsPlace containsPlace) {
	...
	public PODIATRIC(CorrectionsPolicy correctionsPolicy) {
	...
	public PODIATRIC(CurrenciesAccepted currenciesAccepted) {
	...
	public PODIATRIC(Department department) {
	...
	public PODIATRIC(Description description) {
	...
	public PODIATRIC(DisambiguatingDescription disambiguatingDescription) {
	...
	public PODIATRIC(DissolutionDate dissolutionDate) {
	...
	public PODIATRIC(DiversityPolicy diversityPolicy) {
	...
	public PODIATRIC(DiversityStaffingReport diversityStaffingReport) {
	...
	public PODIATRIC(Employee employee) {
	...
	public PODIATRIC(EthicsPolicy ethicsPolicy) {
	...
	public PODIATRIC(FaxNumber faxNumber) {
	...
	public PODIATRIC(Founder founder) {
		setFounder(founder);
	}
	...
	public PODIATRIC(FoundingDate foundingDate) {
	...
	public PODIATRIC(FoundingLocation foundingLocation) {
	...
	public PODIATRIC(Funder funder) {
		setFunder(funder);
	}
	...
	public PODIATRIC(GeospatiallyContains geospatiallyContains) {
	...
	public PODIATRIC(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public PODIATRIC(GeospatiallyCovers geospatiallyCovers) {
	...
	public PODIATRIC(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public PODIATRIC(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public PODIATRIC(GeospatiallyEquals geospatiallyEquals) {
	...
	public PODIATRIC(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public PODIATRIC(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public PODIATRIC(GeospatiallyTouches geospatiallyTouches) {
	...
	public PODIATRIC(GeospatiallyWithin geospatiallyWithin) {
	...
	public PODIATRIC(GlobalLocationNumber globalLocationNumber) {
	...
	public PODIATRIC(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public PODIATRIC(HasOfferCatalog hasOfferCatalog) {
	...
	public PODIATRIC(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public PODIATRIC(Identifier identifier) {
	...
	public PODIATRIC(IsAccessibleForFree isAccessibleForFree) {
	...
	public PODIATRIC(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public PODIATRIC(KnowsAbout knowsAbout) {
	...
	public PODIATRIC(KnowsLanguage knowsLanguage) {
	...
	public PODIATRIC(LegalName legalName) {
	...
	public PODIATRIC(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public PODIATRIC(Location location) {
	...
	public PODIATRIC(MainEntityOfPage mainEntityOfPage) {
	...
	public PODIATRIC(MakesOffer makesOffer) {
	...
	public PODIATRIC(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public PODIATRIC(Member member) {
		setMember(member);
	}
	...
	public PODIATRIC(MemberOf memberOf) {
	...
	public PODIATRIC(NameFuzzy nameFuzzy) {
	...
	public PODIATRIC(NameRuby nameRuby) {
	...
	public PODIATRIC(NumberOfEmployees numberOfEmployees) {
	...
	public PODIATRIC(OpeningHours openingHours) {
	...
	public PODIATRIC(OpeningHoursSpecification openingHoursSpecification) {
	...
	public PODIATRIC(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public PODIATRIC(ParentOrganization parentOrganization) {
	...
	public PODIATRIC(PaymentAccepted paymentAccepted) {
	...
	public PODIATRIC(PotentialAction potentialAction) {
	...
	public PODIATRIC(PriceRange priceRange) {
	...
	public PODIATRIC(PublicAccess publicAccess) {
	...
	public PODIATRIC(PublishingPrinciples publishingPrinciples) {
	...
	public PODIATRIC(Review review) {
		setReview(review);
	}
	...
	public PODIATRIC(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PODIATRIC(SmokingAllowed smokingAllowed) {
	...
	public PODIATRIC(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public PODIATRIC(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public PODIATRIC(SubOrganization subOrganization) {
	...
	public PODIATRIC(SubjectOf subjectOf) {
	...
	public PODIATRIC(SupersededBy supersededBy) {
	...
	public PODIATRIC(Telephone telephone) {
	...
	public PODIATRIC(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(MedicalSpecialty.Podiatric org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalSpecialty.Podiatric.class.getAnnotation(SampleValue.class).value();
	}
