...
public class PHYSIOTHERAPY implements MedicalSpecialty.Physiotherapy {
	...
	public PHYSIOTHERAPY(Long seq) {
		setSeq(seq);
	}

	public PHYSIOTHERAPY(String string) {
	...
	public PHYSIOTHERAPY(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public PHYSIOTHERAPY(AdditionalProperty additionalProperty) {
	...
	public PHYSIOTHERAPY(AdditionalType additionalType) {
	...
	public PHYSIOTHERAPY(Address address) {
		setAddress(address);
	}
	...
	public PHYSIOTHERAPY(AggregateRating aggregateRating) {
	...
	public PHYSIOTHERAPY(AlternateName alternateName) {
	...
	public PHYSIOTHERAPY(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public PHYSIOTHERAPY(AmenityFeature amenityFeature) {
	...
	public PHYSIOTHERAPY(AreaServed areaServed) {
	...
	public PHYSIOTHERAPY(Award award) {
		setAward(award);
	}
	...
	public PHYSIOTHERAPY(BranchCode branchCode) {
	...
	public PHYSIOTHERAPY(Brand brand) {
		setBrand(brand);
	}
	...
	public PHYSIOTHERAPY(ContactPoint contactPoint) {
	...
	public PHYSIOTHERAPY(ContainedInPlace containedInPlace) {
	...
	public PHYSIOTHERAPY(ContainsPlace containsPlace) {
	...
	public PHYSIOTHERAPY(CorrectionsPolicy correctionsPolicy) {
	...
	public PHYSIOTHERAPY(CurrenciesAccepted currenciesAccepted) {
	...
	public PHYSIOTHERAPY(Department department) {
	...
	public PHYSIOTHERAPY(Description description) {
	...
	public PHYSIOTHERAPY(DisambiguatingDescription disambiguatingDescription) {
	...
	public PHYSIOTHERAPY(DissolutionDate dissolutionDate) {
	...
	public PHYSIOTHERAPY(DiversityPolicy diversityPolicy) {
	...
	public PHYSIOTHERAPY(DiversityStaffingReport diversityStaffingReport) {
	...
	public PHYSIOTHERAPY(Duns duns) {
		setDuns(duns);
	}
	...
	public PHYSIOTHERAPY(Email email) {
		setEmail(email);
	}
	...
	public PHYSIOTHERAPY(Employee employee) {
	...
	public PHYSIOTHERAPY(EthicsPolicy ethicsPolicy) {
	...
	public PHYSIOTHERAPY(Event event) {
		setEvent(event);
	}
	...
	public PHYSIOTHERAPY(FaxNumber faxNumber) {
	...
	public PHYSIOTHERAPY(Founder founder) {
		setFounder(founder);
	}
	...
	public PHYSIOTHERAPY(FoundingDate foundingDate) {
	...
	public PHYSIOTHERAPY(FoundingLocation foundingLocation) {
	...
	public PHYSIOTHERAPY(Funder funder) {
		setFunder(funder);
	}
	...
	public PHYSIOTHERAPY(GeospatiallyContains geospatiallyContains) {
	...
	public PHYSIOTHERAPY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public PHYSIOTHERAPY(GeospatiallyCovers geospatiallyCovers) {
	...
	public PHYSIOTHERAPY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public PHYSIOTHERAPY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public PHYSIOTHERAPY(GeospatiallyEquals geospatiallyEquals) {
	...
	public PHYSIOTHERAPY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public PHYSIOTHERAPY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public PHYSIOTHERAPY(GeospatiallyTouches geospatiallyTouches) {
	...
	public PHYSIOTHERAPY(GeospatiallyWithin geospatiallyWithin) {
	...
	public PHYSIOTHERAPY(GlobalLocationNumber globalLocationNumber) {
	...
	public PHYSIOTHERAPY(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public PHYSIOTHERAPY(HasOfferCatalog hasOfferCatalog) {
	...
	public PHYSIOTHERAPY(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public PHYSIOTHERAPY(Identifier identifier) {
	...
	public PHYSIOTHERAPY(Image image) {
		setImage(image);
	}
	...
	public PHYSIOTHERAPY(IsAccessibleForFree isAccessibleForFree) {
	...
	public PHYSIOTHERAPY(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public PHYSIOTHERAPY(KnowsAbout knowsAbout) {
	...
	public PHYSIOTHERAPY(KnowsLanguage knowsLanguage) {
	...
	public PHYSIOTHERAPY(LegalName legalName) {
	...
	public PHYSIOTHERAPY(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public PHYSIOTHERAPY(Location location) {
	...
	public PHYSIOTHERAPY(Logo logo) {
		setLogo(logo);
	}
	...
	public PHYSIOTHERAPY(MainEntityOfPage mainEntityOfPage) {
	...
	public PHYSIOTHERAPY(MakesOffer makesOffer) {
	...
	public PHYSIOTHERAPY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public PHYSIOTHERAPY(Member member) {
		setMember(member);
	}
	...
	public PHYSIOTHERAPY(MemberOf memberOf) {
	...
	public PHYSIOTHERAPY(Naics naics) {
		setNaics(naics);
	}
	...
	public PHYSIOTHERAPY(Name name) {
		setName(name);
	}
	...
	public PHYSIOTHERAPY(NameFuzzy nameFuzzy) {
	...
	public PHYSIOTHERAPY(NameRuby nameRuby) {
	...
	public PHYSIOTHERAPY(NumberOfEmployees numberOfEmployees) {
	...
	public PHYSIOTHERAPY(OpeningHours openingHours) {
	...
	public PHYSIOTHERAPY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public PHYSIOTHERAPY(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public PHYSIOTHERAPY(Owns owns) {
		setOwns(owns);
	}
	...
	public PHYSIOTHERAPY(ParentOrganization parentOrganization) {
	...
	public PHYSIOTHERAPY(PaymentAccepted paymentAccepted) {
	...
	public PHYSIOTHERAPY(Photo photo) {
		setPhoto(photo);
	}
	...
	public PHYSIOTHERAPY(PotentialAction potentialAction) {
	...
	public PHYSIOTHERAPY(PriceRange priceRange) {
	...
	public PHYSIOTHERAPY(PublicAccess publicAccess) {
	...
	public PHYSIOTHERAPY(PublishingPrinciples publishingPrinciples) {
	...
	public PHYSIOTHERAPY(Review review) {
		setReview(review);
	}
	...
	public PHYSIOTHERAPY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PHYSIOTHERAPY(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public PHYSIOTHERAPY(SmokingAllowed smokingAllowed) {
	...
	public PHYSIOTHERAPY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public PHYSIOTHERAPY(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public PHYSIOTHERAPY(SubOrganization subOrganization) {
	...
	public PHYSIOTHERAPY(SubjectOf subjectOf) {
	...
	public PHYSIOTHERAPY(SupersededBy supersededBy) {
	...
	public PHYSIOTHERAPY(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public PHYSIOTHERAPY(Telephone telephone) {
	...
	public PHYSIOTHERAPY(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public PHYSIOTHERAPY(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(MedicalSpecialty.Physiotherapy org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalSpecialty.Physiotherapy.class.getAnnotation(SampleValue.class).value();
	}
