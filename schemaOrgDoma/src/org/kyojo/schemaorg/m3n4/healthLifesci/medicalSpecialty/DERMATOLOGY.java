...
public class DERMATOLOGY implements MedicalSpecialty.Dermatology {
	...
	public DERMATOLOGY(Long seq) {
		setSeq(seq);
	}

	public DERMATOLOGY(String string) {
	...
	public DERMATOLOGY(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public DERMATOLOGY(AdditionalProperty additionalProperty) {
	...
	public DERMATOLOGY(AdditionalType additionalType) {
	...
	public DERMATOLOGY(Address address) {
		setAddress(address);
	}
	...
	public DERMATOLOGY(AggregateRating aggregateRating) {
	...
	public DERMATOLOGY(AlternateName alternateName) {
	...
	public DERMATOLOGY(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public DERMATOLOGY(AmenityFeature amenityFeature) {
	...
	public DERMATOLOGY(AreaServed areaServed) {
	...
	public DERMATOLOGY(Award award) {
		setAward(award);
	}
	...
	public DERMATOLOGY(BranchCode branchCode) {
	...
	public DERMATOLOGY(Brand brand) {
		setBrand(brand);
	}
	...
	public DERMATOLOGY(ContactPoint contactPoint) {
	...
	public DERMATOLOGY(ContainedInPlace containedInPlace) {
	...
	public DERMATOLOGY(ContainsPlace containsPlace) {
	...
	public DERMATOLOGY(CorrectionsPolicy correctionsPolicy) {
	...
	public DERMATOLOGY(CurrenciesAccepted currenciesAccepted) {
	...
	public DERMATOLOGY(Department department) {
	...
	public DERMATOLOGY(Description description) {
	...
	public DERMATOLOGY(DisambiguatingDescription disambiguatingDescription) {
	...
	public DERMATOLOGY(DissolutionDate dissolutionDate) {
	...
	public DERMATOLOGY(DiversityPolicy diversityPolicy) {
	...
	public DERMATOLOGY(DiversityStaffingReport diversityStaffingReport) {
	...
	public DERMATOLOGY(Email email) {
		setEmail(email);
	}
	...
	public DERMATOLOGY(Employee employee) {
	...
	public DERMATOLOGY(EthicsPolicy ethicsPolicy) {
	...
	public DERMATOLOGY(Event event) {
		setEvent(event);
	}
	...
	public DERMATOLOGY(FaxNumber faxNumber) {
	...
	public DERMATOLOGY(Founder founder) {
		setFounder(founder);
	}
	...
	public DERMATOLOGY(FoundingDate foundingDate) {
	...
	public DERMATOLOGY(FoundingLocation foundingLocation) {
	...
	public DERMATOLOGY(Funder funder) {
		setFunder(funder);
	}
	...
	public DERMATOLOGY(GeospatiallyContains geospatiallyContains) {
	...
	public DERMATOLOGY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public DERMATOLOGY(GeospatiallyCovers geospatiallyCovers) {
	...
	public DERMATOLOGY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public DERMATOLOGY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public DERMATOLOGY(GeospatiallyEquals geospatiallyEquals) {
	...
	public DERMATOLOGY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public DERMATOLOGY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public DERMATOLOGY(GeospatiallyTouches geospatiallyTouches) {
	...
	public DERMATOLOGY(GeospatiallyWithin geospatiallyWithin) {
	...
	public DERMATOLOGY(GlobalLocationNumber globalLocationNumber) {
	...
	public DERMATOLOGY(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public DERMATOLOGY(HasOfferCatalog hasOfferCatalog) {
	...
	public DERMATOLOGY(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public DERMATOLOGY(Identifier identifier) {
	...
	public DERMATOLOGY(Image image) {
		setImage(image);
	}
	...
	public DERMATOLOGY(IsAccessibleForFree isAccessibleForFree) {
	...
	public DERMATOLOGY(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public DERMATOLOGY(KnowsAbout knowsAbout) {
	...
	public DERMATOLOGY(KnowsLanguage knowsLanguage) {
	...
	public DERMATOLOGY(LegalName legalName) {
	...
	public DERMATOLOGY(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public DERMATOLOGY(Location location) {
	...
	public DERMATOLOGY(MainEntityOfPage mainEntityOfPage) {
	...
	public DERMATOLOGY(MakesOffer makesOffer) {
	...
	public DERMATOLOGY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public DERMATOLOGY(Member member) {
		setMember(member);
	}
	...
	public DERMATOLOGY(MemberOf memberOf) {
	...
	public DERMATOLOGY(Naics naics) {
		setNaics(naics);
	}
	...
	public DERMATOLOGY(NameFuzzy nameFuzzy) {
	...
	public DERMATOLOGY(NameRuby nameRuby) {
	...
	public DERMATOLOGY(NumberOfEmployees numberOfEmployees) {
	...
	public DERMATOLOGY(OpeningHours openingHours) {
	...
	public DERMATOLOGY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public DERMATOLOGY(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public DERMATOLOGY(ParentOrganization parentOrganization) {
	...
	public DERMATOLOGY(PaymentAccepted paymentAccepted) {
	...
	public DERMATOLOGY(Photo photo) {
		setPhoto(photo);
	}
	...
	public DERMATOLOGY(PotentialAction potentialAction) {
	...
	public DERMATOLOGY(PriceRange priceRange) {
	...
	public DERMATOLOGY(PublicAccess publicAccess) {
	...
	public DERMATOLOGY(PublishingPrinciples publishingPrinciples) {
	...
	public DERMATOLOGY(Review review) {
		setReview(review);
	}
	...
	public DERMATOLOGY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DERMATOLOGY(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public DERMATOLOGY(SmokingAllowed smokingAllowed) {
	...
	public DERMATOLOGY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public DERMATOLOGY(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public DERMATOLOGY(SubOrganization subOrganization) {
	...
	public DERMATOLOGY(SubjectOf subjectOf) {
	...
	public DERMATOLOGY(SupersededBy supersededBy) {
	...
	public DERMATOLOGY(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public DERMATOLOGY(Telephone telephone) {
	...
	public DERMATOLOGY(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public DERMATOLOGY(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(MedicalSpecialty.Dermatology org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalSpecialty.Dermatology.class.getAnnotation(SampleValue.class).value();
	}
