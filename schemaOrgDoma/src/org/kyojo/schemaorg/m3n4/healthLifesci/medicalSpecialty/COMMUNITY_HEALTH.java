package org.kyojo.schemaorg.m3n4.healthLifesci.medicalSpecialty;
...
public class COMMUNITY_HEALTH implements MedicalSpecialty.CommunityHealth {
	...
	public COMMUNITY_HEALTH() {
	}

	public COMMUNITY_HEALTH(Long seq) {
		setSeq(seq);
	}

	public COMMUNITY_HEALTH(String string) {
	...
	public COMMUNITY_HEALTH(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public COMMUNITY_HEALTH(AdditionalProperty additionalProperty) {
	...
	public COMMUNITY_HEALTH(AdditionalType additionalType) {
	...
	public COMMUNITY_HEALTH(Address address) {
		setAddress(address);
	}
	...
	public COMMUNITY_HEALTH(AggregateRating aggregateRating) {
	...
	public COMMUNITY_HEALTH(AlternateName alternateName) {
	...
	public COMMUNITY_HEALTH(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public COMMUNITY_HEALTH(AmenityFeature amenityFeature) {
	...
	public COMMUNITY_HEALTH(AreaServed areaServed) {
	...
	public COMMUNITY_HEALTH(Award award) {
		setAward(award);
	}
	...
	public COMMUNITY_HEALTH(BranchCode branchCode) {
	...
	public COMMUNITY_HEALTH(Brand brand) {
		setBrand(brand);
	}
	...
	public COMMUNITY_HEALTH(ContactPoint contactPoint) {
	...
	public COMMUNITY_HEALTH(ContainedInPlace containedInPlace) {
	...
	public COMMUNITY_HEALTH(ContainsPlace containsPlace) {
	...
	public COMMUNITY_HEALTH(CorrectionsPolicy correctionsPolicy) {
	...
	public COMMUNITY_HEALTH(CurrenciesAccepted currenciesAccepted) {
	...
	public COMMUNITY_HEALTH(Department department) {
	...
	public COMMUNITY_HEALTH(Description description) {
	...
	public COMMUNITY_HEALTH(DisambiguatingDescription disambiguatingDescription) {
	...
	public COMMUNITY_HEALTH(DissolutionDate dissolutionDate) {
	...
	public COMMUNITY_HEALTH(DiversityPolicy diversityPolicy) {
	...
	public COMMUNITY_HEALTH(DiversityStaffingReport diversityStaffingReport) {
	...
	public COMMUNITY_HEALTH(Duns duns) {
		setDuns(duns);
	}
	...
	public COMMUNITY_HEALTH(Email email) {
		setEmail(email);
	}
	...
	public COMMUNITY_HEALTH(Employee employee) {
	...
	public COMMUNITY_HEALTH(EthicsPolicy ethicsPolicy) {
	...
	public COMMUNITY_HEALTH(Event event) {
		setEvent(event);
	}
	...
	public COMMUNITY_HEALTH(FaxNumber faxNumber) {
	...
	public COMMUNITY_HEALTH(Founder founder) {
		setFounder(founder);
	}
	...
	public COMMUNITY_HEALTH(FoundingDate foundingDate) {
	...
	public COMMUNITY_HEALTH(FoundingLocation foundingLocation) {
	...
	public COMMUNITY_HEALTH(Funder funder) {
		setFunder(funder);
	}
	...
	public COMMUNITY_HEALTH(Geo geo) {
		setGeo(geo);
	}
	...
	public COMMUNITY_HEALTH(GeospatiallyContains geospatiallyContains) {
	...
	public COMMUNITY_HEALTH(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public COMMUNITY_HEALTH(GeospatiallyCovers geospatiallyCovers) {
	...
	public COMMUNITY_HEALTH(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public COMMUNITY_HEALTH(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public COMMUNITY_HEALTH(GeospatiallyEquals geospatiallyEquals) {
	...
	public COMMUNITY_HEALTH(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public COMMUNITY_HEALTH(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public COMMUNITY_HEALTH(GeospatiallyTouches geospatiallyTouches) {
	...
	public COMMUNITY_HEALTH(GeospatiallyWithin geospatiallyWithin) {
	...
	public COMMUNITY_HEALTH(GlobalLocationNumber globalLocationNumber) {
	...
	public COMMUNITY_HEALTH(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public COMMUNITY_HEALTH(HasOfferCatalog hasOfferCatalog) {
	...
	public COMMUNITY_HEALTH(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public COMMUNITY_HEALTH(Identifier identifier) {
	...
	public COMMUNITY_HEALTH(Image image) {
		setImage(image);
	}
	...
	public COMMUNITY_HEALTH(IsAccessibleForFree isAccessibleForFree) {
	...
	public COMMUNITY_HEALTH(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public COMMUNITY_HEALTH(KnowsAbout knowsAbout) {
	...
	public COMMUNITY_HEALTH(KnowsLanguage knowsLanguage) {
	...
	public COMMUNITY_HEALTH(LegalName legalName) {
	...
	public COMMUNITY_HEALTH(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public COMMUNITY_HEALTH(Location location) {
	...
	public COMMUNITY_HEALTH(Logo logo) {
		setLogo(logo);
	}
	...
	public COMMUNITY_HEALTH(MainEntityOfPage mainEntityOfPage) {
	...
	public COMMUNITY_HEALTH(MakesOffer makesOffer) {
	...
	public COMMUNITY_HEALTH(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public COMMUNITY_HEALTH(Member member) {
		setMember(member);
	}
	...
	public COMMUNITY_HEALTH(MemberOf memberOf) {
	...
	public COMMUNITY_HEALTH(Naics naics) {
		setNaics(naics);
	}
	...
	public COMMUNITY_HEALTH(Name name) {
		setName(name);
	}
	...
	public COMMUNITY_HEALTH(NameFuzzy nameFuzzy) {
	...
	public COMMUNITY_HEALTH(NameRuby nameRuby) {
	...
	public COMMUNITY_HEALTH(NumberOfEmployees numberOfEmployees) {
	...
	public COMMUNITY_HEALTH(OpeningHours openingHours) {
	...
	public COMMUNITY_HEALTH(OpeningHoursSpecification openingHoursSpecification) {
	...
	public COMMUNITY_HEALTH(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public COMMUNITY_HEALTH(Owns owns) {
		setOwns(owns);
	}
	...
	public COMMUNITY_HEALTH(ParentOrganization parentOrganization) {
	...
	public COMMUNITY_HEALTH(PaymentAccepted paymentAccepted) {
	...
	public COMMUNITY_HEALTH(Photo photo) {
		setPhoto(photo);
	}
	...
	public COMMUNITY_HEALTH(PotentialAction potentialAction) {
	...
	public COMMUNITY_HEALTH(PriceRange priceRange) {
	...
	public COMMUNITY_HEALTH(PublicAccess publicAccess) {
	...
	public COMMUNITY_HEALTH(PublishingPrinciples publishingPrinciples) {
	...
	public COMMUNITY_HEALTH(Review review) {
		setReview(review);
	}
	...
	public COMMUNITY_HEALTH(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public COMMUNITY_HEALTH(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public COMMUNITY_HEALTH(SmokingAllowed smokingAllowed) {
	...
	public COMMUNITY_HEALTH(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public COMMUNITY_HEALTH(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public COMMUNITY_HEALTH(SubOrganization subOrganization) {
	...
	public COMMUNITY_HEALTH(SubjectOf subjectOf) {
	...
	public COMMUNITY_HEALTH(SupersededBy supersededBy) {
	...
	public COMMUNITY_HEALTH(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public COMMUNITY_HEALTH(Telephone telephone) {
	...
	public COMMUNITY_HEALTH(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public COMMUNITY_HEALTH(Url url) {
		setUrl(url);
	}
	...
	public COMMUNITY_HEALTH(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(MedicalSpecialty.CommunityHealth org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalSpecialty.CommunityHealth.class.getAnnotation(SampleValue.class).value();
	}
