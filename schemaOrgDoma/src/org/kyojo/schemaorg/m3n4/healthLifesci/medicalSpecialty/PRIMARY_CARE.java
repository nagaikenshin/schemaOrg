...
public class PRIMARY_CARE implements MedicalSpecialty.PrimaryCare {
	...
	public PRIMARY_CARE(GeospatiallyContains geospatiallyContains) {
	...
	public PRIMARY_CARE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public PRIMARY_CARE(GeospatiallyCovers geospatiallyCovers) {
	...
	public PRIMARY_CARE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public PRIMARY_CARE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public PRIMARY_CARE(GeospatiallyEquals geospatiallyEquals) {
	...
	public PRIMARY_CARE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public PRIMARY_CARE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public PRIMARY_CARE(GeospatiallyTouches geospatiallyTouches) {
	...
	public PRIMARY_CARE(GeospatiallyWithin geospatiallyWithin) {
