...
public class PUBLIC_HEALTH implements MedicalSpecialty.PublicHealth {
	...
	public PUBLIC_HEALTH(Long seq) {
		setSeq(seq);
	}

	public PUBLIC_HEALTH(String string) {
	...
	public PUBLIC_HEALTH(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public PUBLIC_HEALTH(AdditionalProperty additionalProperty) {
	...
	public PUBLIC_HEALTH(AdditionalType additionalType) {
	...
	public PUBLIC_HEALTH(Address address) {
		setAddress(address);
	}
	...
	public PUBLIC_HEALTH(AggregateRating aggregateRating) {
	...
	public PUBLIC_HEALTH(AlternateName alternateName) {
	...
	public PUBLIC_HEALTH(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public PUBLIC_HEALTH(AmenityFeature amenityFeature) {
	...
	public PUBLIC_HEALTH(AreaServed areaServed) {
	...
	public PUBLIC_HEALTH(Award award) {
		setAward(award);
	}
	...
	public PUBLIC_HEALTH(BranchCode branchCode) {
	...
	public PUBLIC_HEALTH(Brand brand) {
		setBrand(brand);
	}
	...
	public PUBLIC_HEALTH(ContactPoint contactPoint) {
	...
	public PUBLIC_HEALTH(ContainedInPlace containedInPlace) {
	...
	public PUBLIC_HEALTH(ContainsPlace containsPlace) {
	...
	public PUBLIC_HEALTH(CorrectionsPolicy correctionsPolicy) {
	...
	public PUBLIC_HEALTH(CurrenciesAccepted currenciesAccepted) {
	...
	public PUBLIC_HEALTH(Department department) {
	...
	public PUBLIC_HEALTH(Description description) {
	...
	public PUBLIC_HEALTH(DisambiguatingDescription disambiguatingDescription) {
	...
	public PUBLIC_HEALTH(DissolutionDate dissolutionDate) {
	...
	public PUBLIC_HEALTH(DiversityPolicy diversityPolicy) {
	...
	public PUBLIC_HEALTH(DiversityStaffingReport diversityStaffingReport) {
	...
	public PUBLIC_HEALTH(Duns duns) {
		setDuns(duns);
	}
	...
	public PUBLIC_HEALTH(Email email) {
		setEmail(email);
	}
	...
	public PUBLIC_HEALTH(Employee employee) {
	...
	public PUBLIC_HEALTH(EthicsPolicy ethicsPolicy) {
	...
	public PUBLIC_HEALTH(Event event) {
		setEvent(event);
	}
	...
	public PUBLIC_HEALTH(FaxNumber faxNumber) {
	...
	public PUBLIC_HEALTH(Founder founder) {
		setFounder(founder);
	}
	...
	public PUBLIC_HEALTH(FoundingDate foundingDate) {
	...
	public PUBLIC_HEALTH(FoundingLocation foundingLocation) {
	...
	public PUBLIC_HEALTH(Funder funder) {
		setFunder(funder);
	}
	...
	public PUBLIC_HEALTH(GeospatiallyContains geospatiallyContains) {
	...
	public PUBLIC_HEALTH(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public PUBLIC_HEALTH(GeospatiallyCovers geospatiallyCovers) {
	...
	public PUBLIC_HEALTH(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public PUBLIC_HEALTH(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public PUBLIC_HEALTH(GeospatiallyEquals geospatiallyEquals) {
	...
	public PUBLIC_HEALTH(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public PUBLIC_HEALTH(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public PUBLIC_HEALTH(GeospatiallyTouches geospatiallyTouches) {
	...
	public PUBLIC_HEALTH(GeospatiallyWithin geospatiallyWithin) {
	...
	public PUBLIC_HEALTH(GlobalLocationNumber globalLocationNumber) {
	...
	public PUBLIC_HEALTH(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public PUBLIC_HEALTH(HasOfferCatalog hasOfferCatalog) {
	...
	public PUBLIC_HEALTH(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public PUBLIC_HEALTH(Identifier identifier) {
	...
	public PUBLIC_HEALTH(Image image) {
		setImage(image);
	}
	...
	public PUBLIC_HEALTH(IsAccessibleForFree isAccessibleForFree) {
	...
	public PUBLIC_HEALTH(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public PUBLIC_HEALTH(KnowsAbout knowsAbout) {
	...
	public PUBLIC_HEALTH(KnowsLanguage knowsLanguage) {
	...
	public PUBLIC_HEALTH(LegalName legalName) {
	...
	public PUBLIC_HEALTH(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public PUBLIC_HEALTH(Location location) {
	...
	public PUBLIC_HEALTH(Logo logo) {
		setLogo(logo);
	}
	...
	public PUBLIC_HEALTH(MainEntityOfPage mainEntityOfPage) {
	...
	public PUBLIC_HEALTH(MakesOffer makesOffer) {
	...
	public PUBLIC_HEALTH(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public PUBLIC_HEALTH(Member member) {
		setMember(member);
	}
	...
	public PUBLIC_HEALTH(MemberOf memberOf) {
	...
	public PUBLIC_HEALTH(Naics naics) {
		setNaics(naics);
	}
	...
	public PUBLIC_HEALTH(Name name) {
		setName(name);
	}
	...
	public PUBLIC_HEALTH(NameFuzzy nameFuzzy) {
	...
	public PUBLIC_HEALTH(NameRuby nameRuby) {
	...
	public PUBLIC_HEALTH(NumberOfEmployees numberOfEmployees) {
	...
	public PUBLIC_HEALTH(OpeningHours openingHours) {
	...
	public PUBLIC_HEALTH(OpeningHoursSpecification openingHoursSpecification) {
	...
	public PUBLIC_HEALTH(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public PUBLIC_HEALTH(Owns owns) {
		setOwns(owns);
	}
	...
	public PUBLIC_HEALTH(ParentOrganization parentOrganization) {
	...
	public PUBLIC_HEALTH(PaymentAccepted paymentAccepted) {
	...
	public PUBLIC_HEALTH(Photo photo) {
		setPhoto(photo);
	}
	...
	public PUBLIC_HEALTH(PotentialAction potentialAction) {
	...
	public PUBLIC_HEALTH(PriceRange priceRange) {
	...
	public PUBLIC_HEALTH(PublicAccess publicAccess) {
	...
	public PUBLIC_HEALTH(PublishingPrinciples publishingPrinciples) {
	...
	public PUBLIC_HEALTH(Review review) {
		setReview(review);
	}
	...
	public PUBLIC_HEALTH(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PUBLIC_HEALTH(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public PUBLIC_HEALTH(SmokingAllowed smokingAllowed) {
	...
	public PUBLIC_HEALTH(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public PUBLIC_HEALTH(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public PUBLIC_HEALTH(SubOrganization subOrganization) {
	...
	public PUBLIC_HEALTH(SubjectOf subjectOf) {
	...
	public PUBLIC_HEALTH(SupersededBy supersededBy) {
	...
	public PUBLIC_HEALTH(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public PUBLIC_HEALTH(Telephone telephone) {
	...
	public PUBLIC_HEALTH(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public PUBLIC_HEALTH(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(MedicalSpecialty.PublicHealth org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalSpecialty.PublicHealth.class.getAnnotation(SampleValue.class).value();
	}
