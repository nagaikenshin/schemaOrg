...
public class EMERGENCY implements MedicalSpecialty.Emergency {
	...
	public EMERGENCY(Long seq) {
		setSeq(seq);
	}

	public EMERGENCY(String string) {
	...
	public EMERGENCY(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public EMERGENCY(AdditionalProperty additionalProperty) {
	...
	public EMERGENCY(AdditionalType additionalType) {
	...
	public EMERGENCY(Address address) {
		setAddress(address);
	}
	...
	public EMERGENCY(AggregateRating aggregateRating) {
	...
	public EMERGENCY(AlternateName alternateName) {
	...
	public EMERGENCY(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public EMERGENCY(AmenityFeature amenityFeature) {
	...
	public EMERGENCY(AreaServed areaServed) {
	...
	public EMERGENCY(BranchCode branchCode) {
	...
	public EMERGENCY(ContactPoint contactPoint) {
	...
	public EMERGENCY(ContainedInPlace containedInPlace) {
	...
	public EMERGENCY(ContainsPlace containsPlace) {
	...
	public EMERGENCY(CorrectionsPolicy correctionsPolicy) {
	...
	public EMERGENCY(CurrenciesAccepted currenciesAccepted) {
	...
	public EMERGENCY(Department department) {
	...
	public EMERGENCY(Description description) {
	...
	public EMERGENCY(DisambiguatingDescription disambiguatingDescription) {
	...
	public EMERGENCY(DissolutionDate dissolutionDate) {
	...
	public EMERGENCY(DiversityPolicy diversityPolicy) {
	...
	public EMERGENCY(DiversityStaffingReport diversityStaffingReport) {
	...
	public EMERGENCY(Employee employee) {
	...
	public EMERGENCY(EthicsPolicy ethicsPolicy) {
	...
	public EMERGENCY(FaxNumber faxNumber) {
	...
	public EMERGENCY(Founder founder) {
		setFounder(founder);
	}
	...
	public EMERGENCY(FoundingDate foundingDate) {
	...
	public EMERGENCY(FoundingLocation foundingLocation) {
	...
	public EMERGENCY(Funder funder) {
		setFunder(funder);
	}
	...
	public EMERGENCY(GeospatiallyContains geospatiallyContains) {
	...
	public EMERGENCY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public EMERGENCY(GeospatiallyCovers geospatiallyCovers) {
	...
	public EMERGENCY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public EMERGENCY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public EMERGENCY(GeospatiallyEquals geospatiallyEquals) {
	...
	public EMERGENCY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public EMERGENCY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public EMERGENCY(GeospatiallyTouches geospatiallyTouches) {
	...
	public EMERGENCY(GeospatiallyWithin geospatiallyWithin) {
	...
	public EMERGENCY(GlobalLocationNumber globalLocationNumber) {
	...
	public EMERGENCY(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public EMERGENCY(HasOfferCatalog hasOfferCatalog) {
	...
	public EMERGENCY(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public EMERGENCY(Identifier identifier) {
	...
	public EMERGENCY(IsAccessibleForFree isAccessibleForFree) {
	...
	public EMERGENCY(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public EMERGENCY(KnowsAbout knowsAbout) {
	...
	public EMERGENCY(KnowsLanguage knowsLanguage) {
	...
	public EMERGENCY(LegalName legalName) {
	...
	public EMERGENCY(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public EMERGENCY(Location location) {
	...
	public EMERGENCY(MainEntityOfPage mainEntityOfPage) {
	...
	public EMERGENCY(MakesOffer makesOffer) {
	...
	public EMERGENCY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public EMERGENCY(Member member) {
		setMember(member);
	}
	...
	public EMERGENCY(MemberOf memberOf) {
	...
	public EMERGENCY(NameFuzzy nameFuzzy) {
	...
	public EMERGENCY(NameRuby nameRuby) {
	...
	public EMERGENCY(NumberOfEmployees numberOfEmployees) {
	...
	public EMERGENCY(OpeningHours openingHours) {
	...
	public EMERGENCY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public EMERGENCY(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public EMERGENCY(ParentOrganization parentOrganization) {
	...
	public EMERGENCY(PaymentAccepted paymentAccepted) {
	...
	public EMERGENCY(PotentialAction potentialAction) {
	...
	public EMERGENCY(PriceRange priceRange) {
	...
	public EMERGENCY(PublicAccess publicAccess) {
	...
	public EMERGENCY(PublishingPrinciples publishingPrinciples) {
	...
	public EMERGENCY(Review review) {
		setReview(review);
	}
	...
	public EMERGENCY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public EMERGENCY(SmokingAllowed smokingAllowed) {
	...
	public EMERGENCY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public EMERGENCY(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public EMERGENCY(SubOrganization subOrganization) {
	...
	public EMERGENCY(SubjectOf subjectOf) {
	...
	public EMERGENCY(SupersededBy supersededBy) {
	...
	public EMERGENCY(Telephone telephone) {
	...
	public EMERGENCY(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(MedicalSpecialty.Emergency org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalSpecialty.Emergency.class.getAnnotation(SampleValue.class).value();
	}
