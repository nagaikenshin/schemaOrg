...
public class PLASTIC_SURGERY implements MedicalSpecialty.PlasticSurgery {
	...
	public PLASTIC_SURGERY() {
	}

	public PLASTIC_SURGERY(Long seq) {
		setSeq(seq);
	}

	public PLASTIC_SURGERY(String string) {
	...
	public PLASTIC_SURGERY(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public PLASTIC_SURGERY(AdditionalProperty additionalProperty) {
	...
	public PLASTIC_SURGERY(AdditionalType additionalType) {
	...
	public PLASTIC_SURGERY(Address address) {
		setAddress(address);
	}
	...
	public PLASTIC_SURGERY(AggregateRating aggregateRating) {
	...
	public PLASTIC_SURGERY(AlternateName alternateName) {
	...
	public PLASTIC_SURGERY(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public PLASTIC_SURGERY(AmenityFeature amenityFeature) {
	...
	public PLASTIC_SURGERY(AreaServed areaServed) {
	...
	public PLASTIC_SURGERY(Award award) {
		setAward(award);
	}
	...
	public PLASTIC_SURGERY(BranchCode branchCode) {
	...
	public PLASTIC_SURGERY(Brand brand) {
		setBrand(brand);
	}
	...
	public PLASTIC_SURGERY(ContactPoint contactPoint) {
	...
	public PLASTIC_SURGERY(ContainedInPlace containedInPlace) {
	...
	public PLASTIC_SURGERY(ContainsPlace containsPlace) {
	...
	public PLASTIC_SURGERY(CorrectionsPolicy correctionsPolicy) {
	...
	public PLASTIC_SURGERY(CurrenciesAccepted currenciesAccepted) {
	...
	public PLASTIC_SURGERY(Department department) {
	...
	public PLASTIC_SURGERY(Description description) {
	...
	public PLASTIC_SURGERY(DisambiguatingDescription disambiguatingDescription) {
	...
	public PLASTIC_SURGERY(DissolutionDate dissolutionDate) {
	...
	public PLASTIC_SURGERY(DiversityPolicy diversityPolicy) {
	...
	public PLASTIC_SURGERY(DiversityStaffingReport diversityStaffingReport) {
	...
	public PLASTIC_SURGERY(Duns duns) {
		setDuns(duns);
	}
	...
	public PLASTIC_SURGERY(Email email) {
		setEmail(email);
	}
	...
	public PLASTIC_SURGERY(Employee employee) {
	...
	public PLASTIC_SURGERY(EthicsPolicy ethicsPolicy) {
	...
	public PLASTIC_SURGERY(Event event) {
		setEvent(event);
	}
	...
	public PLASTIC_SURGERY(FaxNumber faxNumber) {
	...
	public PLASTIC_SURGERY(Founder founder) {
		setFounder(founder);
	}
	...
	public PLASTIC_SURGERY(FoundingDate foundingDate) {
	...
	public PLASTIC_SURGERY(FoundingLocation foundingLocation) {
	...
	public PLASTIC_SURGERY(Funder funder) {
		setFunder(funder);
	}
	...
	public PLASTIC_SURGERY(Geo geo) {
		setGeo(geo);
	}
	...
	public PLASTIC_SURGERY(GeospatiallyContains geospatiallyContains) {
	...
	public PLASTIC_SURGERY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public PLASTIC_SURGERY(GeospatiallyCovers geospatiallyCovers) {
	...
	public PLASTIC_SURGERY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public PLASTIC_SURGERY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public PLASTIC_SURGERY(GeospatiallyEquals geospatiallyEquals) {
	...
	public PLASTIC_SURGERY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public PLASTIC_SURGERY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public PLASTIC_SURGERY(GeospatiallyTouches geospatiallyTouches) {
	...
	public PLASTIC_SURGERY(GeospatiallyWithin geospatiallyWithin) {
	...
	public PLASTIC_SURGERY(GlobalLocationNumber globalLocationNumber) {
	...
	public PLASTIC_SURGERY(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public PLASTIC_SURGERY(HasOfferCatalog hasOfferCatalog) {
	...
	public PLASTIC_SURGERY(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public PLASTIC_SURGERY(Identifier identifier) {
	...
	public PLASTIC_SURGERY(Image image) {
		setImage(image);
	}
	...
	public PLASTIC_SURGERY(IsAccessibleForFree isAccessibleForFree) {
	...
	public PLASTIC_SURGERY(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public PLASTIC_SURGERY(KnowsAbout knowsAbout) {
	...
	public PLASTIC_SURGERY(KnowsLanguage knowsLanguage) {
	...
	public PLASTIC_SURGERY(LegalName legalName) {
	...
	public PLASTIC_SURGERY(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public PLASTIC_SURGERY(Location location) {
	...
	public PLASTIC_SURGERY(Logo logo) {
		setLogo(logo);
	}
	...
	public PLASTIC_SURGERY(MainEntityOfPage mainEntityOfPage) {
	...
	public PLASTIC_SURGERY(MakesOffer makesOffer) {
	...
	public PLASTIC_SURGERY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public PLASTIC_SURGERY(Member member) {
		setMember(member);
	}
	...
	public PLASTIC_SURGERY(MemberOf memberOf) {
	...
	public PLASTIC_SURGERY(Naics naics) {
		setNaics(naics);
	}
	...
	public PLASTIC_SURGERY(Name name) {
		setName(name);
	}
	...
	public PLASTIC_SURGERY(NameFuzzy nameFuzzy) {
	...
	public PLASTIC_SURGERY(NameRuby nameRuby) {
	...
	public PLASTIC_SURGERY(NumberOfEmployees numberOfEmployees) {
	...
	public PLASTIC_SURGERY(OpeningHours openingHours) {
	...
	public PLASTIC_SURGERY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public PLASTIC_SURGERY(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public PLASTIC_SURGERY(Owns owns) {
		setOwns(owns);
	}
	...
	public PLASTIC_SURGERY(ParentOrganization parentOrganization) {
	...
	public PLASTIC_SURGERY(PaymentAccepted paymentAccepted) {
	...
	public PLASTIC_SURGERY(Photo photo) {
		setPhoto(photo);
	}
	...
	public PLASTIC_SURGERY(PotentialAction potentialAction) {
	...
	public PLASTIC_SURGERY(PriceRange priceRange) {
	...
	public PLASTIC_SURGERY(PublicAccess publicAccess) {
	...
	public PLASTIC_SURGERY(PublishingPrinciples publishingPrinciples) {
	...
	public PLASTIC_SURGERY(Review review) {
		setReview(review);
	}
	...
	public PLASTIC_SURGERY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PLASTIC_SURGERY(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public PLASTIC_SURGERY(SmokingAllowed smokingAllowed) {
	...
	public PLASTIC_SURGERY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public PLASTIC_SURGERY(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public PLASTIC_SURGERY(SubOrganization subOrganization) {
	...
	public PLASTIC_SURGERY(SubjectOf subjectOf) {
	...
	public PLASTIC_SURGERY(SupersededBy supersededBy) {
	...
	public PLASTIC_SURGERY(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public PLASTIC_SURGERY(Telephone telephone) {
	...
	public PLASTIC_SURGERY(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public PLASTIC_SURGERY(Url url) {
		setUrl(url);
	}
	...
	public PLASTIC_SURGERY(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(MedicalSpecialty.PlasticSurgery org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalSpecialty.PlasticSurgery.class.getAnnotation(SampleValue.class).value();
	}
