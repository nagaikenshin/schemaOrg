...
public class ALL_WHEEL_DRIVE_CONFIGURATION implements DriveWheelConfigurationValue.AllWheelDriveConfiguration {
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION() {
	}

	public ALL_WHEEL_DRIVE_CONFIGURATION(Long seq) {
		setSeq(seq);
	}

	public ALL_WHEEL_DRIVE_CONFIGURATION(String string) {
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION(AdditionalProperty additionalProperty) {
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION(AdditionalType additionalType) {
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION(AlternateName alternateName) {
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION(Description description) {
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION(Equal equal) {
		setEqual(equal);
	}
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION(Greater greater) {
		setGreater(greater);
	}
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION(GreaterOrEqual greaterOrEqual) {
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION(Identifier identifier) {
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION(Image image) {
		setImage(image);
	}
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION(Lesser lesser) {
		setLesser(lesser);
	}
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION(LesserOrEqual lesserOrEqual) {
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION(MainEntityOfPage mainEntityOfPage) {
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION(Name name) {
		setName(name);
	}
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION(NameFuzzy nameFuzzy) {
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION(NameRuby nameRuby) {
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION(NonEqual nonEqual) {
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION(PotentialAction potentialAction) {
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION(SubjectOf subjectOf) {
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION(SupersededBy supersededBy) {
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION(Url url) {
		setUrl(url);
	}
	...
	public ALL_WHEEL_DRIVE_CONFIGURATION(ValueReference valueReference) {
	...
	public void copy(DriveWheelConfigurationValue.AllWheelDriveConfiguration org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return DriveWheelConfigurationValue.AllWheelDriveConfiguration.class.getAnnotation(SampleValue.class).value();
	}
