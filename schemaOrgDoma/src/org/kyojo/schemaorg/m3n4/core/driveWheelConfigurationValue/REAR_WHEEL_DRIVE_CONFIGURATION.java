...
public class REAR_WHEEL_DRIVE_CONFIGURATION implements DriveWheelConfigurationValue.RearWheelDriveConfiguration {
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION() {
	}

	public REAR_WHEEL_DRIVE_CONFIGURATION(Long seq) {
		setSeq(seq);
	}

	public REAR_WHEEL_DRIVE_CONFIGURATION(String string) {
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION(AdditionalProperty additionalProperty) {
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION(AdditionalType additionalType) {
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION(AlternateName alternateName) {
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION(Description description) {
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION(Equal equal) {
		setEqual(equal);
	}
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION(Greater greater) {
		setGreater(greater);
	}
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION(GreaterOrEqual greaterOrEqual) {
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION(Identifier identifier) {
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION(Image image) {
		setImage(image);
	}
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION(Lesser lesser) {
		setLesser(lesser);
	}
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION(LesserOrEqual lesserOrEqual) {
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION(MainEntityOfPage mainEntityOfPage) {
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION(Name name) {
		setName(name);
	}
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION(NameFuzzy nameFuzzy) {
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION(NameRuby nameRuby) {
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION(NonEqual nonEqual) {
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION(PotentialAction potentialAction) {
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION(SubjectOf subjectOf) {
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION(SupersededBy supersededBy) {
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION(Url url) {
		setUrl(url);
	}
	...
	public REAR_WHEEL_DRIVE_CONFIGURATION(ValueReference valueReference) {
	...
	public void copy(DriveWheelConfigurationValue.RearWheelDriveConfiguration org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return DriveWheelConfigurationValue.RearWheelDriveConfiguration.class.getAnnotation(SampleValue.class).value();
	}
