...
public class PERFORMING_ARTS_THEATER implements Clazz.PerformingArtsTheater {
	...
	public PERFORMING_ARTS_THEATER() {
	}

	public PERFORMING_ARTS_THEATER(Long seq) {
		setSeq(seq);
	}

	public PERFORMING_ARTS_THEATER(String string) {
	...
	public PERFORMING_ARTS_THEATER(AdditionalProperty additionalProperty) {
	...
	public PERFORMING_ARTS_THEATER(AdditionalType additionalType) {
	...
	public PERFORMING_ARTS_THEATER(Address address) {
		setAddress(address);
	}
	...
	public PERFORMING_ARTS_THEATER(AggregateRating aggregateRating) {
	...
	public PERFORMING_ARTS_THEATER(AlternateName alternateName) {
	...
	public PERFORMING_ARTS_THEATER(AmenityFeature amenityFeature) {
	...
	public PERFORMING_ARTS_THEATER(BranchCode branchCode) {
	...
	public PERFORMING_ARTS_THEATER(ContainedInPlace containedInPlace) {
	...
	public PERFORMING_ARTS_THEATER(ContainsPlace containsPlace) {
	...
	public PERFORMING_ARTS_THEATER(Description description) {
	...
	public PERFORMING_ARTS_THEATER(DisambiguatingDescription disambiguatingDescription) {
	...
	public PERFORMING_ARTS_THEATER(Event event) {
		setEvent(event);
	}
	...
	public PERFORMING_ARTS_THEATER(FaxNumber faxNumber) {
	...
	public PERFORMING_ARTS_THEATER(Geo geo) {
		setGeo(geo);
	}
	...
	public PERFORMING_ARTS_THEATER(GeospatiallyContains geospatiallyContains) {
	...
	public PERFORMING_ARTS_THEATER(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public PERFORMING_ARTS_THEATER(GeospatiallyCovers geospatiallyCovers) {
	...
	public PERFORMING_ARTS_THEATER(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public PERFORMING_ARTS_THEATER(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public PERFORMING_ARTS_THEATER(GeospatiallyEquals geospatiallyEquals) {
	...
	public PERFORMING_ARTS_THEATER(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public PERFORMING_ARTS_THEATER(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public PERFORMING_ARTS_THEATER(GeospatiallyTouches geospatiallyTouches) {
	...
	public PERFORMING_ARTS_THEATER(GeospatiallyWithin geospatiallyWithin) {
	...
	public PERFORMING_ARTS_THEATER(GlobalLocationNumber globalLocationNumber) {
	...
	public PERFORMING_ARTS_THEATER(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public PERFORMING_ARTS_THEATER(Identifier identifier) {
	...
	public PERFORMING_ARTS_THEATER(Image image) {
		setImage(image);
	}
	...
	public PERFORMING_ARTS_THEATER(IsAccessibleForFree isAccessibleForFree) {
	...
	public PERFORMING_ARTS_THEATER(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public PERFORMING_ARTS_THEATER(Logo logo) {
		setLogo(logo);
	}
	...
	public PERFORMING_ARTS_THEATER(MainEntityOfPage mainEntityOfPage) {
	...
	public PERFORMING_ARTS_THEATER(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public PERFORMING_ARTS_THEATER(Name name) {
		setName(name);
	}
	...
	public PERFORMING_ARTS_THEATER(NameFuzzy nameFuzzy) {
	...
	public PERFORMING_ARTS_THEATER(NameRuby nameRuby) {
	...
	public PERFORMING_ARTS_THEATER(OpeningHours openingHours) {
	...
	public PERFORMING_ARTS_THEATER(OpeningHoursSpecification openingHoursSpecification) {
	...
	public PERFORMING_ARTS_THEATER(Photo photo) {
		setPhoto(photo);
	}
	...
	public PERFORMING_ARTS_THEATER(PotentialAction potentialAction) {
	...
	public PERFORMING_ARTS_THEATER(PublicAccess publicAccess) {
	...
	public PERFORMING_ARTS_THEATER(Review review) {
		setReview(review);
	}
	...
	public PERFORMING_ARTS_THEATER(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PERFORMING_ARTS_THEATER(SmokingAllowed smokingAllowed) {
	...
	public PERFORMING_ARTS_THEATER(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public PERFORMING_ARTS_THEATER(SubjectOf subjectOf) {
	...
	public PERFORMING_ARTS_THEATER(Telephone telephone) {
	...
	public PERFORMING_ARTS_THEATER(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.PerformingArtsTheater org) {
		setSeq(org.getSeq());
