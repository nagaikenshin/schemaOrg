...
public class HEALTH_CLUB implements Clazz.HealthClub {
	...
	public HEALTH_CLUB(Long seq) {
		setSeq(seq);
	}

	public HEALTH_CLUB(String string) {
	...
	public HEALTH_CLUB(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public HEALTH_CLUB(AdditionalProperty additionalProperty) {
	...
	public HEALTH_CLUB(AdditionalType additionalType) {
	...
	public HEALTH_CLUB(Address address) {
		setAddress(address);
	}
	...
	public HEALTH_CLUB(AggregateRating aggregateRating) {
	...
	public HEALTH_CLUB(AlternateName alternateName) {
	...
	public HEALTH_CLUB(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public HEALTH_CLUB(AmenityFeature amenityFeature) {
	...
	public HEALTH_CLUB(AreaServed areaServed) {
	...
	public HEALTH_CLUB(Award award) {
		setAward(award);
	}
	...
	public HEALTH_CLUB(BranchCode branchCode) {
	...
	public HEALTH_CLUB(Brand brand) {
		setBrand(brand);
	}
	...
	public HEALTH_CLUB(ContactPoint contactPoint) {
	...
	public HEALTH_CLUB(ContainedInPlace containedInPlace) {
	...
	public HEALTH_CLUB(ContainsPlace containsPlace) {
	...
	public HEALTH_CLUB(CorrectionsPolicy correctionsPolicy) {
	...
	public HEALTH_CLUB(CurrenciesAccepted currenciesAccepted) {
	...
	public HEALTH_CLUB(Department department) {
	...
	public HEALTH_CLUB(Description description) {
	...
	public HEALTH_CLUB(DisambiguatingDescription disambiguatingDescription) {
	...
	public HEALTH_CLUB(DissolutionDate dissolutionDate) {
	...
	public HEALTH_CLUB(DiversityPolicy diversityPolicy) {
	...
	public HEALTH_CLUB(DiversityStaffingReport diversityStaffingReport) {
	...
	public HEALTH_CLUB(Email email) {
		setEmail(email);
	}
	...
	public HEALTH_CLUB(Employee employee) {
	...
	public HEALTH_CLUB(EthicsPolicy ethicsPolicy) {
	...
	public HEALTH_CLUB(Event event) {
		setEvent(event);
	}
	...
	public HEALTH_CLUB(FaxNumber faxNumber) {
	...
	public HEALTH_CLUB(Founder founder) {
		setFounder(founder);
	}
	...
	public HEALTH_CLUB(FoundingDate foundingDate) {
	...
	public HEALTH_CLUB(FoundingLocation foundingLocation) {
	...
	public HEALTH_CLUB(Funder funder) {
		setFunder(funder);
	}
	...
	public HEALTH_CLUB(GeospatiallyContains geospatiallyContains) {
	...
	public HEALTH_CLUB(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public HEALTH_CLUB(GeospatiallyCovers geospatiallyCovers) {
	...
	public HEALTH_CLUB(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public HEALTH_CLUB(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public HEALTH_CLUB(GeospatiallyEquals geospatiallyEquals) {
	...
	public HEALTH_CLUB(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public HEALTH_CLUB(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public HEALTH_CLUB(GeospatiallyTouches geospatiallyTouches) {
	...
	public HEALTH_CLUB(GeospatiallyWithin geospatiallyWithin) {
	...
	public HEALTH_CLUB(GlobalLocationNumber globalLocationNumber) {
	...
	public HEALTH_CLUB(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public HEALTH_CLUB(HasOfferCatalog hasOfferCatalog) {
	...
	public HEALTH_CLUB(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public HEALTH_CLUB(Identifier identifier) {
	...
	public HEALTH_CLUB(Image image) {
		setImage(image);
	}
	...
	public HEALTH_CLUB(IsAccessibleForFree isAccessibleForFree) {
	...
	public HEALTH_CLUB(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public HEALTH_CLUB(KnowsAbout knowsAbout) {
	...
	public HEALTH_CLUB(KnowsLanguage knowsLanguage) {
	...
	public HEALTH_CLUB(LegalName legalName) {
	...
	public HEALTH_CLUB(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public HEALTH_CLUB(Location location) {
	...
	public HEALTH_CLUB(MainEntityOfPage mainEntityOfPage) {
	...
	public HEALTH_CLUB(MakesOffer makesOffer) {
	...
	public HEALTH_CLUB(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public HEALTH_CLUB(Member member) {
		setMember(member);
	}
	...
	public HEALTH_CLUB(MemberOf memberOf) {
	...
	public HEALTH_CLUB(Naics naics) {
		setNaics(naics);
	}
	...
	public HEALTH_CLUB(NameFuzzy nameFuzzy) {
	...
	public HEALTH_CLUB(NameRuby nameRuby) {
	...
	public HEALTH_CLUB(NumberOfEmployees numberOfEmployees) {
	...
	public HEALTH_CLUB(OpeningHours openingHours) {
	...
	public HEALTH_CLUB(OpeningHoursSpecification openingHoursSpecification) {
	...
	public HEALTH_CLUB(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public HEALTH_CLUB(ParentOrganization parentOrganization) {
	...
	public HEALTH_CLUB(PaymentAccepted paymentAccepted) {
	...
	public HEALTH_CLUB(Photo photo) {
		setPhoto(photo);
	}
	...
	public HEALTH_CLUB(PotentialAction potentialAction) {
	...
	public HEALTH_CLUB(PriceRange priceRange) {
	...
	public HEALTH_CLUB(PublicAccess publicAccess) {
	...
	public HEALTH_CLUB(PublishingPrinciples publishingPrinciples) {
	...
	public HEALTH_CLUB(Review review) {
		setReview(review);
	}
	...
	public HEALTH_CLUB(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public HEALTH_CLUB(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public HEALTH_CLUB(SmokingAllowed smokingAllowed) {
	...
	public HEALTH_CLUB(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public HEALTH_CLUB(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public HEALTH_CLUB(SubOrganization subOrganization) {
	...
	public HEALTH_CLUB(SubjectOf subjectOf) {
	...
	public HEALTH_CLUB(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public HEALTH_CLUB(Telephone telephone) {
	...
	public HEALTH_CLUB(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public HEALTH_CLUB(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.HealthClub org) {
		setSeq(org.getSeq());
