...
public class PROFESSIONAL_SERVICE implements Clazz.ProfessionalService {
	...
	public PROFESSIONAL_SERVICE(Long seq) {
		setSeq(seq);
	}

	public PROFESSIONAL_SERVICE(String string) {
	...
	public PROFESSIONAL_SERVICE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public PROFESSIONAL_SERVICE(AdditionalProperty additionalProperty) {
	...
	public PROFESSIONAL_SERVICE(AdditionalType additionalType) {
	...
	public PROFESSIONAL_SERVICE(Address address) {
		setAddress(address);
	}
	...
	public PROFESSIONAL_SERVICE(AggregateRating aggregateRating) {
	...
	public PROFESSIONAL_SERVICE(AlternateName alternateName) {
	...
	public PROFESSIONAL_SERVICE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public PROFESSIONAL_SERVICE(AmenityFeature amenityFeature) {
	...
	public PROFESSIONAL_SERVICE(AreaServed areaServed) {
	...
	public PROFESSIONAL_SERVICE(Award award) {
		setAward(award);
	}
	...
	public PROFESSIONAL_SERVICE(BranchCode branchCode) {
	...
	public PROFESSIONAL_SERVICE(Brand brand) {
		setBrand(brand);
	}
	...
	public PROFESSIONAL_SERVICE(ContactPoint contactPoint) {
	...
	public PROFESSIONAL_SERVICE(ContainedInPlace containedInPlace) {
	...
	public PROFESSIONAL_SERVICE(ContainsPlace containsPlace) {
	...
	public PROFESSIONAL_SERVICE(CorrectionsPolicy correctionsPolicy) {
	...
	public PROFESSIONAL_SERVICE(CurrenciesAccepted currenciesAccepted) {
	...
	public PROFESSIONAL_SERVICE(Department department) {
	...
	public PROFESSIONAL_SERVICE(Description description) {
	...
	public PROFESSIONAL_SERVICE(DisambiguatingDescription disambiguatingDescription) {
	...
	public PROFESSIONAL_SERVICE(DissolutionDate dissolutionDate) {
	...
	public PROFESSIONAL_SERVICE(DiversityPolicy diversityPolicy) {
	...
	public PROFESSIONAL_SERVICE(DiversityStaffingReport diversityStaffingReport) {
	...
	public PROFESSIONAL_SERVICE(Duns duns) {
		setDuns(duns);
	}
	...
	public PROFESSIONAL_SERVICE(Email email) {
		setEmail(email);
	}
	...
	public PROFESSIONAL_SERVICE(Employee employee) {
	...
	public PROFESSIONAL_SERVICE(EthicsPolicy ethicsPolicy) {
	...
	public PROFESSIONAL_SERVICE(Event event) {
		setEvent(event);
	}
	...
	public PROFESSIONAL_SERVICE(FaxNumber faxNumber) {
	...
	public PROFESSIONAL_SERVICE(Founder founder) {
		setFounder(founder);
	}
	...
	public PROFESSIONAL_SERVICE(FoundingDate foundingDate) {
	...
	public PROFESSIONAL_SERVICE(FoundingLocation foundingLocation) {
	...
	public PROFESSIONAL_SERVICE(Funder funder) {
		setFunder(funder);
	}
	...
	public PROFESSIONAL_SERVICE(Geo geo) {
		setGeo(geo);
	}
	...
	public PROFESSIONAL_SERVICE(GeospatiallyContains geospatiallyContains) {
	...
	public PROFESSIONAL_SERVICE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public PROFESSIONAL_SERVICE(GeospatiallyCovers geospatiallyCovers) {
	...
	public PROFESSIONAL_SERVICE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public PROFESSIONAL_SERVICE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public PROFESSIONAL_SERVICE(GeospatiallyEquals geospatiallyEquals) {
	...
	public PROFESSIONAL_SERVICE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public PROFESSIONAL_SERVICE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public PROFESSIONAL_SERVICE(GeospatiallyTouches geospatiallyTouches) {
	...
	public PROFESSIONAL_SERVICE(GeospatiallyWithin geospatiallyWithin) {
	...
	public PROFESSIONAL_SERVICE(GlobalLocationNumber globalLocationNumber) {
	...
	public PROFESSIONAL_SERVICE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public PROFESSIONAL_SERVICE(HasOfferCatalog hasOfferCatalog) {
	...
	public PROFESSIONAL_SERVICE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public PROFESSIONAL_SERVICE(Identifier identifier) {
	...
	public PROFESSIONAL_SERVICE(Image image) {
		setImage(image);
	}
	...
	public PROFESSIONAL_SERVICE(IsAccessibleForFree isAccessibleForFree) {
	...
	public PROFESSIONAL_SERVICE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public PROFESSIONAL_SERVICE(KnowsAbout knowsAbout) {
	...
	public PROFESSIONAL_SERVICE(KnowsLanguage knowsLanguage) {
	...
	public PROFESSIONAL_SERVICE(LegalName legalName) {
	...
	public PROFESSIONAL_SERVICE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public PROFESSIONAL_SERVICE(Location location) {
	...
	public PROFESSIONAL_SERVICE(Logo logo) {
		setLogo(logo);
	}
	...
	public PROFESSIONAL_SERVICE(MainEntityOfPage mainEntityOfPage) {
	...
	public PROFESSIONAL_SERVICE(MakesOffer makesOffer) {
	...
	public PROFESSIONAL_SERVICE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public PROFESSIONAL_SERVICE(Member member) {
		setMember(member);
	}
	...
	public PROFESSIONAL_SERVICE(MemberOf memberOf) {
	...
	public PROFESSIONAL_SERVICE(Naics naics) {
		setNaics(naics);
	}
	...
	public PROFESSIONAL_SERVICE(Name name) {
		setName(name);
	}
	...
	public PROFESSIONAL_SERVICE(NameFuzzy nameFuzzy) {
	...
	public PROFESSIONAL_SERVICE(NameRuby nameRuby) {
	...
	public PROFESSIONAL_SERVICE(NumberOfEmployees numberOfEmployees) {
	...
	public PROFESSIONAL_SERVICE(OpeningHours openingHours) {
	...
	public PROFESSIONAL_SERVICE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public PROFESSIONAL_SERVICE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public PROFESSIONAL_SERVICE(Owns owns) {
		setOwns(owns);
	}
	...
	public PROFESSIONAL_SERVICE(ParentOrganization parentOrganization) {
	...
	public PROFESSIONAL_SERVICE(PaymentAccepted paymentAccepted) {
	...
	public PROFESSIONAL_SERVICE(Photo photo) {
		setPhoto(photo);
	}
	...
	public PROFESSIONAL_SERVICE(PotentialAction potentialAction) {
	...
	public PROFESSIONAL_SERVICE(PriceRange priceRange) {
	...
	public PROFESSIONAL_SERVICE(PublicAccess publicAccess) {
	...
	public PROFESSIONAL_SERVICE(PublishingPrinciples publishingPrinciples) {
	...
	public PROFESSIONAL_SERVICE(Review review) {
		setReview(review);
	}
	...
	public PROFESSIONAL_SERVICE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PROFESSIONAL_SERVICE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public PROFESSIONAL_SERVICE(SmokingAllowed smokingAllowed) {
	...
	public PROFESSIONAL_SERVICE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public PROFESSIONAL_SERVICE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public PROFESSIONAL_SERVICE(SubOrganization subOrganization) {
	...
	public PROFESSIONAL_SERVICE(SubjectOf subjectOf) {
	...
	public PROFESSIONAL_SERVICE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public PROFESSIONAL_SERVICE(Telephone telephone) {
	...
	public PROFESSIONAL_SERVICE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public PROFESSIONAL_SERVICE(Url url) {
		setUrl(url);
	}
	...
	public PROFESSIONAL_SERVICE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.ProfessionalService org) {
		setSeq(org.getSeq());
