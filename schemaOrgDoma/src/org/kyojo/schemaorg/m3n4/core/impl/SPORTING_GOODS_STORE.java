...
public class SPORTING_GOODS_STORE implements Clazz.SportingGoodsStore {
	...
	public SPORTING_GOODS_STORE() {
	}

	public SPORTING_GOODS_STORE(Long seq) {
		setSeq(seq);
	}

	public SPORTING_GOODS_STORE(String string) {
	...
	public SPORTING_GOODS_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public SPORTING_GOODS_STORE(AdditionalProperty additionalProperty) {
	...
	public SPORTING_GOODS_STORE(AdditionalType additionalType) {
	...
	public SPORTING_GOODS_STORE(Address address) {
		setAddress(address);
	}
	...
	public SPORTING_GOODS_STORE(AggregateRating aggregateRating) {
	...
	public SPORTING_GOODS_STORE(AlternateName alternateName) {
	...
	public SPORTING_GOODS_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public SPORTING_GOODS_STORE(AmenityFeature amenityFeature) {
	...
	public SPORTING_GOODS_STORE(AreaServed areaServed) {
	...
	public SPORTING_GOODS_STORE(Award award) {
		setAward(award);
	}
	...
	public SPORTING_GOODS_STORE(BranchCode branchCode) {
	...
	public SPORTING_GOODS_STORE(Brand brand) {
		setBrand(brand);
	}
	...
	public SPORTING_GOODS_STORE(ContactPoint contactPoint) {
	...
	public SPORTING_GOODS_STORE(ContainedInPlace containedInPlace) {
	...
	public SPORTING_GOODS_STORE(ContainsPlace containsPlace) {
	...
	public SPORTING_GOODS_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public SPORTING_GOODS_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public SPORTING_GOODS_STORE(Department department) {
	...
	public SPORTING_GOODS_STORE(Description description) {
	...
	public SPORTING_GOODS_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public SPORTING_GOODS_STORE(DissolutionDate dissolutionDate) {
	...
	public SPORTING_GOODS_STORE(DiversityPolicy diversityPolicy) {
	...
	public SPORTING_GOODS_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public SPORTING_GOODS_STORE(Duns duns) {
		setDuns(duns);
	}
	...
	public SPORTING_GOODS_STORE(Email email) {
		setEmail(email);
	}
	...
	public SPORTING_GOODS_STORE(Employee employee) {
	...
	public SPORTING_GOODS_STORE(EthicsPolicy ethicsPolicy) {
	...
	public SPORTING_GOODS_STORE(Event event) {
		setEvent(event);
	}
	...
	public SPORTING_GOODS_STORE(FaxNumber faxNumber) {
	...
	public SPORTING_GOODS_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public SPORTING_GOODS_STORE(FoundingDate foundingDate) {
	...
	public SPORTING_GOODS_STORE(FoundingLocation foundingLocation) {
	...
	public SPORTING_GOODS_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public SPORTING_GOODS_STORE(Geo geo) {
		setGeo(geo);
	}
	...
	public SPORTING_GOODS_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public SPORTING_GOODS_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public SPORTING_GOODS_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public SPORTING_GOODS_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public SPORTING_GOODS_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public SPORTING_GOODS_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public SPORTING_GOODS_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public SPORTING_GOODS_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public SPORTING_GOODS_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public SPORTING_GOODS_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public SPORTING_GOODS_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public SPORTING_GOODS_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public SPORTING_GOODS_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public SPORTING_GOODS_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public SPORTING_GOODS_STORE(Identifier identifier) {
	...
	public SPORTING_GOODS_STORE(Image image) {
		setImage(image);
	}
	...
	public SPORTING_GOODS_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public SPORTING_GOODS_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public SPORTING_GOODS_STORE(KnowsAbout knowsAbout) {
	...
	public SPORTING_GOODS_STORE(KnowsLanguage knowsLanguage) {
	...
	public SPORTING_GOODS_STORE(LegalName legalName) {
	...
	public SPORTING_GOODS_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public SPORTING_GOODS_STORE(Location location) {
	...
	public SPORTING_GOODS_STORE(Logo logo) {
		setLogo(logo);
	}
	...
	public SPORTING_GOODS_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public SPORTING_GOODS_STORE(MakesOffer makesOffer) {
	...
	public SPORTING_GOODS_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public SPORTING_GOODS_STORE(Member member) {
		setMember(member);
	}
	...
	public SPORTING_GOODS_STORE(MemberOf memberOf) {
	...
	public SPORTING_GOODS_STORE(Naics naics) {
		setNaics(naics);
	}
	...
	public SPORTING_GOODS_STORE(Name name) {
		setName(name);
	}
	...
	public SPORTING_GOODS_STORE(NameFuzzy nameFuzzy) {
	...
	public SPORTING_GOODS_STORE(NameRuby nameRuby) {
	...
	public SPORTING_GOODS_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public SPORTING_GOODS_STORE(OpeningHours openingHours) {
	...
	public SPORTING_GOODS_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public SPORTING_GOODS_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public SPORTING_GOODS_STORE(Owns owns) {
		setOwns(owns);
	}
	...
	public SPORTING_GOODS_STORE(ParentOrganization parentOrganization) {
	...
	public SPORTING_GOODS_STORE(PaymentAccepted paymentAccepted) {
	...
	public SPORTING_GOODS_STORE(Photo photo) {
		setPhoto(photo);
	}
	...
	public SPORTING_GOODS_STORE(PotentialAction potentialAction) {
	...
	public SPORTING_GOODS_STORE(PriceRange priceRange) {
	...
	public SPORTING_GOODS_STORE(PublicAccess publicAccess) {
	...
	public SPORTING_GOODS_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public SPORTING_GOODS_STORE(Review review) {
		setReview(review);
	}
	...
	public SPORTING_GOODS_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SPORTING_GOODS_STORE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public SPORTING_GOODS_STORE(SmokingAllowed smokingAllowed) {
	...
	public SPORTING_GOODS_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public SPORTING_GOODS_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public SPORTING_GOODS_STORE(SubOrganization subOrganization) {
	...
	public SPORTING_GOODS_STORE(SubjectOf subjectOf) {
	...
	public SPORTING_GOODS_STORE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public SPORTING_GOODS_STORE(Telephone telephone) {
	...
	public SPORTING_GOODS_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public SPORTING_GOODS_STORE(Url url) {
		setUrl(url);
	}
	...
	public SPORTING_GOODS_STORE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.SportingGoodsStore org) {
		setSeq(org.getSeq());
