...
public class HOUSE implements Clazz.House {
	...
	public HOUSE(AdditionalProperty additionalProperty) {
	...
	public HOUSE(AdditionalType additionalType) {
	...
	public HOUSE(AggregateRating aggregateRating) {
	...
	public HOUSE(AlternateName alternateName) {
	...
	public HOUSE(AmenityFeature amenityFeature) {
	...
	public HOUSE(BranchCode branchCode) {
	...
	public HOUSE(ContainedInPlace containedInPlace) {
	...
	public HOUSE(ContainsPlace containsPlace) {
	...
	public HOUSE(Description description) {
	...
	public HOUSE(DisambiguatingDescription disambiguatingDescription) {
	...
	public HOUSE(FaxNumber faxNumber) {
	...
	public HOUSE(FloorSize floorSize) {
	...
	public HOUSE(GeospatiallyContains geospatiallyContains) {
	...
	public HOUSE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public HOUSE(GeospatiallyCovers geospatiallyCovers) {
	...
	public HOUSE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public HOUSE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public HOUSE(GeospatiallyEquals geospatiallyEquals) {
	...
	public HOUSE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public HOUSE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public HOUSE(GeospatiallyTouches geospatiallyTouches) {
	...
	public HOUSE(GeospatiallyWithin geospatiallyWithin) {
	...
	public HOUSE(GlobalLocationNumber globalLocationNumber) {
	...
	public HOUSE(Identifier identifier) {
	...
	public HOUSE(IsAccessibleForFree isAccessibleForFree) {
	...
	public HOUSE(MainEntityOfPage mainEntityOfPage) {
	...
	public HOUSE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public HOUSE(NameFuzzy nameFuzzy) {
	...
	public HOUSE(NameRuby nameRuby) {
	...
	public HOUSE(NumberOfRooms numberOfRooms) {
	...
	public HOUSE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public HOUSE(PermittedUsage permittedUsage) {
	...
	public HOUSE(PetsAllowed petsAllowed) {
	...
	public HOUSE(PotentialAction potentialAction) {
	...
	public HOUSE(PublicAccess publicAccess) {
	...
	public HOUSE(SmokingAllowed smokingAllowed) {
	...
	public HOUSE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public HOUSE(SubjectOf subjectOf) {
	...
	public HOUSE(Telephone telephone) {
	...
	public void copy(Clazz.House org) {
		setSeq(org.getSeq());
