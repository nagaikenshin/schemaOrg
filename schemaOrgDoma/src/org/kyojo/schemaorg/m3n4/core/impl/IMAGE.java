...
public class IMAGE implements Container.Image {
	...
	public IMAGE(ImageObject imageObject) {
	...
	public IMAGE(List<Barcode> barcodeList,
	...
	public void copy(Container.Image org) {
