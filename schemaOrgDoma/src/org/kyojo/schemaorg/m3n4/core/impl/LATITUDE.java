...
public class LATITUDE implements Container.Latitude {
	...
	public LATITUDE(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public LATITUDE(Float fl0at) {
	...
	public LATITUDE(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public LATITUDE(Integer integer) {
	...
	public LATITUDE(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public LATITUDE(Number number) {
	...
	public LATITUDE(String string) {
		this(new TEXT(string));
	}

	public LATITUDE(Text text) {
	...
	public LATITUDE(List<Float> fl0atList,
	...
	public void copy(Container.Latitude org) {
