...
public class FLOOR_SIZE implements Container.FloorSize {
	...
	public FLOOR_SIZE(String string) {
	...
	public FLOOR_SIZE(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public FLOOR_SIZE(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public FLOOR_SIZE(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public FLOOR_SIZE(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.FloorSize org) {
