...
public class GTIN8 implements Container.Gtin8 {
	...
	public GTIN8(LocationFeatureSpecification locationFeatureSpecification) {
	...
	public GTIN8(PropertyValue propertyValue) {
	...
	public GTIN8(String string) {
		this(new TEXT(string));
	}

	public GTIN8(Text text) {
	...
	public GTIN8(List<LocationFeatureSpecification> locationFeatureSpecificationList,
	...
	public void copy(Container.Gtin8 org) {
