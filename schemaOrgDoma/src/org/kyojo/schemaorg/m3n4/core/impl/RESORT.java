...
public class RESORT implements Clazz.Resort {
	...
	public RESORT(Long seq) {
		setSeq(seq);
	}

	public RESORT(String string) {
	...
	public RESORT(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public RESORT(AdditionalProperty additionalProperty) {
	...
	public RESORT(AdditionalType additionalType) {
	...
	public RESORT(AggregateRating aggregateRating) {
	...
	public RESORT(AlternateName alternateName) {
	...
	public RESORT(AmenityFeature amenityFeature) {
	...
	public RESORT(AreaServed areaServed) {
	...
	public RESORT(Audience audience) {
	...
	public RESORT(AvailableLanguage availableLanguage) {
	...
	public RESORT(BranchCode branchCode) {
	...
	public RESORT(CheckinTime checkinTime) {
	...
	public RESORT(CheckoutTime checkoutTime) {
	...
	public RESORT(ContactPoint contactPoint) {
	...
	public RESORT(ContainedInPlace containedInPlace) {
	...
	public RESORT(ContainsPlace containsPlace) {
	...
	public RESORT(CorrectionsPolicy correctionsPolicy) {
	...
	public RESORT(CurrenciesAccepted currenciesAccepted) {
	...
	public RESORT(Department department) {
	...
	public RESORT(Description description) {
	...
	public RESORT(DisambiguatingDescription disambiguatingDescription) {
	...
	public RESORT(DissolutionDate dissolutionDate) {
	...
	public RESORT(DiversityPolicy diversityPolicy) {
	...
	public RESORT(DiversityStaffingReport diversityStaffingReport) {
	...
	public RESORT(Employee employee) {
	...
	public RESORT(EthicsPolicy ethicsPolicy) {
	...
	public RESORT(FaxNumber faxNumber) {
	...
	public RESORT(FoundingDate foundingDate) {
	...
	public RESORT(FoundingLocation foundingLocation) {
	...
	public RESORT(GeospatiallyContains geospatiallyContains) {
	...
	public RESORT(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public RESORT(GeospatiallyCovers geospatiallyCovers) {
	...
	public RESORT(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public RESORT(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public RESORT(GeospatiallyEquals geospatiallyEquals) {
	...
	public RESORT(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public RESORT(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public RESORT(GeospatiallyTouches geospatiallyTouches) {
	...
	public RESORT(GeospatiallyWithin geospatiallyWithin) {
	...
	public RESORT(GlobalLocationNumber globalLocationNumber) {
	...
	public RESORT(HasOfferCatalog hasOfferCatalog) {
	...
	public RESORT(Identifier identifier) {
	...
	public RESORT(IsAccessibleForFree isAccessibleForFree) {
	...
	public RESORT(KnowsAbout knowsAbout) {
	...
	public RESORT(KnowsLanguage knowsLanguage) {
	...
	public RESORT(LegalName legalName) {
	...
	public RESORT(Location location) {
	...
	public RESORT(MainEntityOfPage mainEntityOfPage) {
	...
	public RESORT(MakesOffer makesOffer) {
	...
	public RESORT(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public RESORT(MemberOf memberOf) {
	...
	public RESORT(NameFuzzy nameFuzzy) {
	...
	public RESORT(NameRuby nameRuby) {
	...
	public RESORT(NumberOfEmployees numberOfEmployees) {
	...
	public RESORT(OpeningHours openingHours) {
	...
	public RESORT(OpeningHoursSpecification openingHoursSpecification) {
	...
	public RESORT(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public RESORT(ParentOrganization parentOrganization) {
	...
	public RESORT(PaymentAccepted paymentAccepted) {
	...
	public RESORT(PetsAllowed petsAllowed) {
	...
	public RESORT(PotentialAction potentialAction) {
	...
	public RESORT(PriceRange priceRange) {
	...
	public RESORT(PublicAccess publicAccess) {
	...
	public RESORT(PublishingPrinciples publishingPrinciples) {
	...
	public RESORT(SmokingAllowed smokingAllowed) {
	...
	public RESORT(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public RESORT(StarRating starRating) {
	...
	public RESORT(SubOrganization subOrganization) {
	...
	public RESORT(SubjectOf subjectOf) {
	...
	public RESORT(Telephone telephone) {
	...
	public RESORT(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Resort org) {
		setSeq(org.getSeq());
