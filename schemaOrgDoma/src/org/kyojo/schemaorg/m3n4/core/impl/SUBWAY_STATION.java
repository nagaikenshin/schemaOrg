...
public class SUBWAY_STATION implements Clazz.SubwayStation {
	...
	public SUBWAY_STATION(Long seq) {
		setSeq(seq);
	}

	public SUBWAY_STATION(String string) {
	...
	public SUBWAY_STATION(AdditionalProperty additionalProperty) {
	...
	public SUBWAY_STATION(AdditionalType additionalType) {
	...
	public SUBWAY_STATION(Address address) {
		setAddress(address);
	}
	...
	public SUBWAY_STATION(AggregateRating aggregateRating) {
	...
	public SUBWAY_STATION(AlternateName alternateName) {
	...
	public SUBWAY_STATION(AmenityFeature amenityFeature) {
	...
	public SUBWAY_STATION(BranchCode branchCode) {
	...
	public SUBWAY_STATION(ContainedInPlace containedInPlace) {
	...
	public SUBWAY_STATION(ContainsPlace containsPlace) {
	...
	public SUBWAY_STATION(Description description) {
	...
	public SUBWAY_STATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public SUBWAY_STATION(Event event) {
		setEvent(event);
	}
	...
	public SUBWAY_STATION(FaxNumber faxNumber) {
	...
	public SUBWAY_STATION(GeospatiallyContains geospatiallyContains) {
	...
	public SUBWAY_STATION(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public SUBWAY_STATION(GeospatiallyCovers geospatiallyCovers) {
	...
	public SUBWAY_STATION(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public SUBWAY_STATION(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public SUBWAY_STATION(GeospatiallyEquals geospatiallyEquals) {
	...
	public SUBWAY_STATION(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public SUBWAY_STATION(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public SUBWAY_STATION(GeospatiallyTouches geospatiallyTouches) {
	...
	public SUBWAY_STATION(GeospatiallyWithin geospatiallyWithin) {
	...
	public SUBWAY_STATION(GlobalLocationNumber globalLocationNumber) {
	...
	public SUBWAY_STATION(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public SUBWAY_STATION(Identifier identifier) {
	...
	public SUBWAY_STATION(Image image) {
		setImage(image);
	}
	...
	public SUBWAY_STATION(IsAccessibleForFree isAccessibleForFree) {
	...
	public SUBWAY_STATION(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public SUBWAY_STATION(Logo logo) {
		setLogo(logo);
	}
	...
	public SUBWAY_STATION(MainEntityOfPage mainEntityOfPage) {
	...
	public SUBWAY_STATION(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public SUBWAY_STATION(Name name) {
		setName(name);
	}
	...
	public SUBWAY_STATION(NameFuzzy nameFuzzy) {
	...
	public SUBWAY_STATION(NameRuby nameRuby) {
	...
	public SUBWAY_STATION(OpeningHours openingHours) {
	...
	public SUBWAY_STATION(OpeningHoursSpecification openingHoursSpecification) {
	...
	public SUBWAY_STATION(Photo photo) {
		setPhoto(photo);
	}
	...
	public SUBWAY_STATION(PotentialAction potentialAction) {
	...
	public SUBWAY_STATION(PublicAccess publicAccess) {
	...
	public SUBWAY_STATION(Review review) {
		setReview(review);
	}
	...
	public SUBWAY_STATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SUBWAY_STATION(SmokingAllowed smokingAllowed) {
	...
	public SUBWAY_STATION(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public SUBWAY_STATION(SubjectOf subjectOf) {
	...
	public SUBWAY_STATION(Telephone telephone) {
	...
	public void copy(Clazz.SubwayStation org) {
		setSeq(org.getSeq());
