...
public class SELF_STORAGE implements Clazz.SelfStorage {
	...
	public SELF_STORAGE(Long seq) {
		setSeq(seq);
	}

	public SELF_STORAGE(String string) {
	...
	public SELF_STORAGE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public SELF_STORAGE(AdditionalProperty additionalProperty) {
	...
	public SELF_STORAGE(AdditionalType additionalType) {
	...
	public SELF_STORAGE(Address address) {
		setAddress(address);
	}
	...
	public SELF_STORAGE(AggregateRating aggregateRating) {
	...
	public SELF_STORAGE(AlternateName alternateName) {
	...
	public SELF_STORAGE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public SELF_STORAGE(AmenityFeature amenityFeature) {
	...
	public SELF_STORAGE(AreaServed areaServed) {
	...
	public SELF_STORAGE(Award award) {
		setAward(award);
	}
	...
	public SELF_STORAGE(BranchCode branchCode) {
	...
	public SELF_STORAGE(Brand brand) {
		setBrand(brand);
	}
	...
	public SELF_STORAGE(ContactPoint contactPoint) {
	...
	public SELF_STORAGE(ContainedInPlace containedInPlace) {
	...
	public SELF_STORAGE(ContainsPlace containsPlace) {
	...
	public SELF_STORAGE(CorrectionsPolicy correctionsPolicy) {
	...
	public SELF_STORAGE(CurrenciesAccepted currenciesAccepted) {
	...
	public SELF_STORAGE(Department department) {
	...
	public SELF_STORAGE(Description description) {
	...
	public SELF_STORAGE(DisambiguatingDescription disambiguatingDescription) {
	...
	public SELF_STORAGE(DissolutionDate dissolutionDate) {
	...
	public SELF_STORAGE(DiversityPolicy diversityPolicy) {
	...
	public SELF_STORAGE(DiversityStaffingReport diversityStaffingReport) {
	...
	public SELF_STORAGE(Email email) {
		setEmail(email);
	}
	...
	public SELF_STORAGE(Employee employee) {
	...
	public SELF_STORAGE(EthicsPolicy ethicsPolicy) {
	...
	public SELF_STORAGE(Event event) {
		setEvent(event);
	}
	...
	public SELF_STORAGE(FaxNumber faxNumber) {
	...
	public SELF_STORAGE(Founder founder) {
		setFounder(founder);
	}
	...
	public SELF_STORAGE(FoundingDate foundingDate) {
	...
	public SELF_STORAGE(FoundingLocation foundingLocation) {
	...
	public SELF_STORAGE(Funder funder) {
		setFunder(funder);
	}
	...
	public SELF_STORAGE(GeospatiallyContains geospatiallyContains) {
	...
	public SELF_STORAGE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public SELF_STORAGE(GeospatiallyCovers geospatiallyCovers) {
	...
	public SELF_STORAGE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public SELF_STORAGE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public SELF_STORAGE(GeospatiallyEquals geospatiallyEquals) {
	...
	public SELF_STORAGE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public SELF_STORAGE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public SELF_STORAGE(GeospatiallyTouches geospatiallyTouches) {
	...
	public SELF_STORAGE(GeospatiallyWithin geospatiallyWithin) {
	...
	public SELF_STORAGE(GlobalLocationNumber globalLocationNumber) {
	...
	public SELF_STORAGE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public SELF_STORAGE(HasOfferCatalog hasOfferCatalog) {
	...
	public SELF_STORAGE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public SELF_STORAGE(Identifier identifier) {
	...
	public SELF_STORAGE(Image image) {
		setImage(image);
	}
	...
	public SELF_STORAGE(IsAccessibleForFree isAccessibleForFree) {
	...
	public SELF_STORAGE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public SELF_STORAGE(KnowsAbout knowsAbout) {
	...
	public SELF_STORAGE(KnowsLanguage knowsLanguage) {
	...
	public SELF_STORAGE(LegalName legalName) {
	...
	public SELF_STORAGE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public SELF_STORAGE(Location location) {
	...
	public SELF_STORAGE(MainEntityOfPage mainEntityOfPage) {
	...
	public SELF_STORAGE(MakesOffer makesOffer) {
	...
	public SELF_STORAGE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public SELF_STORAGE(Member member) {
		setMember(member);
	}
	...
	public SELF_STORAGE(MemberOf memberOf) {
	...
	public SELF_STORAGE(Naics naics) {
		setNaics(naics);
	}
	...
	public SELF_STORAGE(NameFuzzy nameFuzzy) {
	...
	public SELF_STORAGE(NameRuby nameRuby) {
	...
	public SELF_STORAGE(NumberOfEmployees numberOfEmployees) {
	...
	public SELF_STORAGE(OpeningHours openingHours) {
	...
	public SELF_STORAGE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public SELF_STORAGE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public SELF_STORAGE(ParentOrganization parentOrganization) {
	...
	public SELF_STORAGE(PaymentAccepted paymentAccepted) {
	...
	public SELF_STORAGE(Photo photo) {
		setPhoto(photo);
	}
	...
	public SELF_STORAGE(PotentialAction potentialAction) {
	...
	public SELF_STORAGE(PriceRange priceRange) {
	...
	public SELF_STORAGE(PublicAccess publicAccess) {
	...
	public SELF_STORAGE(PublishingPrinciples publishingPrinciples) {
	...
	public SELF_STORAGE(Review review) {
		setReview(review);
	}
	...
	public SELF_STORAGE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SELF_STORAGE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public SELF_STORAGE(SmokingAllowed smokingAllowed) {
	...
	public SELF_STORAGE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public SELF_STORAGE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public SELF_STORAGE(SubOrganization subOrganization) {
	...
	public SELF_STORAGE(SubjectOf subjectOf) {
	...
	public SELF_STORAGE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public SELF_STORAGE(Telephone telephone) {
	...
	public SELF_STORAGE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public SELF_STORAGE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.SelfStorage org) {
		setSeq(org.getSeq());
