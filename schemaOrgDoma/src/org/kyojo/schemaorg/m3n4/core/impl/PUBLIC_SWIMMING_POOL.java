...
public class PUBLIC_SWIMMING_POOL implements Clazz.PublicSwimmingPool {
	...
	public PUBLIC_SWIMMING_POOL() {
	}

	public PUBLIC_SWIMMING_POOL(Long seq) {
		setSeq(seq);
	}

	public PUBLIC_SWIMMING_POOL(String string) {
	...
	public PUBLIC_SWIMMING_POOL(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public PUBLIC_SWIMMING_POOL(AdditionalProperty additionalProperty) {
	...
	public PUBLIC_SWIMMING_POOL(AdditionalType additionalType) {
	...
	public PUBLIC_SWIMMING_POOL(Address address) {
		setAddress(address);
	}
	...
	public PUBLIC_SWIMMING_POOL(AggregateRating aggregateRating) {
	...
	public PUBLIC_SWIMMING_POOL(AlternateName alternateName) {
	...
	public PUBLIC_SWIMMING_POOL(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public PUBLIC_SWIMMING_POOL(AmenityFeature amenityFeature) {
	...
	public PUBLIC_SWIMMING_POOL(AreaServed areaServed) {
	...
	public PUBLIC_SWIMMING_POOL(Award award) {
		setAward(award);
	}
	...
	public PUBLIC_SWIMMING_POOL(BranchCode branchCode) {
	...
	public PUBLIC_SWIMMING_POOL(Brand brand) {
		setBrand(brand);
	}
	...
	public PUBLIC_SWIMMING_POOL(ContactPoint contactPoint) {
	...
	public PUBLIC_SWIMMING_POOL(ContainedInPlace containedInPlace) {
	...
	public PUBLIC_SWIMMING_POOL(ContainsPlace containsPlace) {
	...
	public PUBLIC_SWIMMING_POOL(CorrectionsPolicy correctionsPolicy) {
	...
	public PUBLIC_SWIMMING_POOL(CurrenciesAccepted currenciesAccepted) {
	...
	public PUBLIC_SWIMMING_POOL(Department department) {
	...
	public PUBLIC_SWIMMING_POOL(Description description) {
	...
	public PUBLIC_SWIMMING_POOL(DisambiguatingDescription disambiguatingDescription) {
	...
	public PUBLIC_SWIMMING_POOL(DissolutionDate dissolutionDate) {
	...
	public PUBLIC_SWIMMING_POOL(DiversityPolicy diversityPolicy) {
	...
	public PUBLIC_SWIMMING_POOL(DiversityStaffingReport diversityStaffingReport) {
	...
	public PUBLIC_SWIMMING_POOL(Duns duns) {
		setDuns(duns);
	}
	...
	public PUBLIC_SWIMMING_POOL(Email email) {
		setEmail(email);
	}
	...
	public PUBLIC_SWIMMING_POOL(Employee employee) {
	...
	public PUBLIC_SWIMMING_POOL(EthicsPolicy ethicsPolicy) {
	...
	public PUBLIC_SWIMMING_POOL(Event event) {
		setEvent(event);
	}
	...
	public PUBLIC_SWIMMING_POOL(FaxNumber faxNumber) {
	...
	public PUBLIC_SWIMMING_POOL(Founder founder) {
		setFounder(founder);
	}
	...
	public PUBLIC_SWIMMING_POOL(FoundingDate foundingDate) {
	...
	public PUBLIC_SWIMMING_POOL(FoundingLocation foundingLocation) {
	...
	public PUBLIC_SWIMMING_POOL(Funder funder) {
		setFunder(funder);
	}
	...
	public PUBLIC_SWIMMING_POOL(Geo geo) {
		setGeo(geo);
	}
	...
	public PUBLIC_SWIMMING_POOL(GeospatiallyContains geospatiallyContains) {
	...
	public PUBLIC_SWIMMING_POOL(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public PUBLIC_SWIMMING_POOL(GeospatiallyCovers geospatiallyCovers) {
	...
	public PUBLIC_SWIMMING_POOL(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public PUBLIC_SWIMMING_POOL(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public PUBLIC_SWIMMING_POOL(GeospatiallyEquals geospatiallyEquals) {
	...
	public PUBLIC_SWIMMING_POOL(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public PUBLIC_SWIMMING_POOL(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public PUBLIC_SWIMMING_POOL(GeospatiallyTouches geospatiallyTouches) {
	...
	public PUBLIC_SWIMMING_POOL(GeospatiallyWithin geospatiallyWithin) {
	...
	public PUBLIC_SWIMMING_POOL(GlobalLocationNumber globalLocationNumber) {
	...
	public PUBLIC_SWIMMING_POOL(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public PUBLIC_SWIMMING_POOL(HasOfferCatalog hasOfferCatalog) {
	...
	public PUBLIC_SWIMMING_POOL(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public PUBLIC_SWIMMING_POOL(Identifier identifier) {
	...
	public PUBLIC_SWIMMING_POOL(Image image) {
		setImage(image);
	}
	...
	public PUBLIC_SWIMMING_POOL(IsAccessibleForFree isAccessibleForFree) {
	...
	public PUBLIC_SWIMMING_POOL(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public PUBLIC_SWIMMING_POOL(KnowsAbout knowsAbout) {
	...
	public PUBLIC_SWIMMING_POOL(KnowsLanguage knowsLanguage) {
	...
	public PUBLIC_SWIMMING_POOL(LegalName legalName) {
	...
	public PUBLIC_SWIMMING_POOL(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public PUBLIC_SWIMMING_POOL(Location location) {
	...
	public PUBLIC_SWIMMING_POOL(Logo logo) {
		setLogo(logo);
	}
	...
	public PUBLIC_SWIMMING_POOL(MainEntityOfPage mainEntityOfPage) {
	...
	public PUBLIC_SWIMMING_POOL(MakesOffer makesOffer) {
	...
	public PUBLIC_SWIMMING_POOL(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public PUBLIC_SWIMMING_POOL(Member member) {
		setMember(member);
	}
	...
	public PUBLIC_SWIMMING_POOL(MemberOf memberOf) {
	...
	public PUBLIC_SWIMMING_POOL(Naics naics) {
		setNaics(naics);
	}
	...
	public PUBLIC_SWIMMING_POOL(Name name) {
		setName(name);
	}
	...
	public PUBLIC_SWIMMING_POOL(NameFuzzy nameFuzzy) {
	...
	public PUBLIC_SWIMMING_POOL(NameRuby nameRuby) {
	...
	public PUBLIC_SWIMMING_POOL(NumberOfEmployees numberOfEmployees) {
	...
	public PUBLIC_SWIMMING_POOL(OpeningHours openingHours) {
	...
	public PUBLIC_SWIMMING_POOL(OpeningHoursSpecification openingHoursSpecification) {
	...
	public PUBLIC_SWIMMING_POOL(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public PUBLIC_SWIMMING_POOL(Owns owns) {
		setOwns(owns);
	}
	...
	public PUBLIC_SWIMMING_POOL(ParentOrganization parentOrganization) {
	...
	public PUBLIC_SWIMMING_POOL(PaymentAccepted paymentAccepted) {
	...
	public PUBLIC_SWIMMING_POOL(Photo photo) {
		setPhoto(photo);
	}
	...
	public PUBLIC_SWIMMING_POOL(PotentialAction potentialAction) {
	...
	public PUBLIC_SWIMMING_POOL(PriceRange priceRange) {
	...
	public PUBLIC_SWIMMING_POOL(PublicAccess publicAccess) {
	...
	public PUBLIC_SWIMMING_POOL(PublishingPrinciples publishingPrinciples) {
	...
	public PUBLIC_SWIMMING_POOL(Review review) {
		setReview(review);
	}
	...
	public PUBLIC_SWIMMING_POOL(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PUBLIC_SWIMMING_POOL(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public PUBLIC_SWIMMING_POOL(SmokingAllowed smokingAllowed) {
	...
	public PUBLIC_SWIMMING_POOL(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public PUBLIC_SWIMMING_POOL(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public PUBLIC_SWIMMING_POOL(SubOrganization subOrganization) {
	...
	public PUBLIC_SWIMMING_POOL(SubjectOf subjectOf) {
	...
	public PUBLIC_SWIMMING_POOL(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public PUBLIC_SWIMMING_POOL(Telephone telephone) {
	...
	public PUBLIC_SWIMMING_POOL(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public PUBLIC_SWIMMING_POOL(Url url) {
		setUrl(url);
	}
	...
	public PUBLIC_SWIMMING_POOL(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.PublicSwimmingPool org) {
		setSeq(org.getSeq());
