...
public class EAT_ACTION implements Clazz.EatAction {
	...
	public EAT_ACTION(Long seq) {
		setSeq(seq);
	}

	public EAT_ACTION(String string) {
	...
	public EAT_ACTION(ActionAccessibilityRequirement actionAccessibilityRequirement) {
	...
	public EAT_ACTION(ActionStatus actionStatus) {
	...
	public EAT_ACTION(AdditionalType additionalType) {
	...
	public EAT_ACTION(AlternateName alternateName) {
	...
	public EAT_ACTION(Description description) {
	...
	public EAT_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public EAT_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public EAT_ACTION(ExpectsAcceptanceOf expectsAcceptanceOf) {
	...
	public EAT_ACTION(Identifier identifier) {
	...
	public EAT_ACTION(Instrument instrument) {
	...
	public EAT_ACTION(Location location) {
	...
	public EAT_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public EAT_ACTION(NameFuzzy nameFuzzy) {
	...
	public EAT_ACTION(NameRuby nameRuby) {
	...
	public EAT_ACTION(Object object) {
		setObject(object);
	}
	...
	public EAT_ACTION(Participant participant) {
	...
	public EAT_ACTION(PotentialAction potentialAction) {
	...
	public EAT_ACTION(Result result) {
		setResult(result);
	}
	...
	public EAT_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public EAT_ACTION(StartTime startTime) {
	...
	public EAT_ACTION(SubjectOf subjectOf) {
	...
	public EAT_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.EatAction org) {
		setSeq(org.getSeq());
