...
public class MUSIC_STORE implements Clazz.MusicStore {
	...
	public MUSIC_STORE(Long seq) {
		setSeq(seq);
	}

	public MUSIC_STORE(String string) {
	...
	public MUSIC_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public MUSIC_STORE(AdditionalProperty additionalProperty) {
	...
	public MUSIC_STORE(AdditionalType additionalType) {
	...
	public MUSIC_STORE(Address address) {
		setAddress(address);
	}
	...
	public MUSIC_STORE(AggregateRating aggregateRating) {
	...
	public MUSIC_STORE(AlternateName alternateName) {
	...
	public MUSIC_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public MUSIC_STORE(AmenityFeature amenityFeature) {
	...
	public MUSIC_STORE(AreaServed areaServed) {
	...
	public MUSIC_STORE(Award award) {
		setAward(award);
	}
	...
	public MUSIC_STORE(BranchCode branchCode) {
	...
	public MUSIC_STORE(Brand brand) {
		setBrand(brand);
	}
	...
	public MUSIC_STORE(ContactPoint contactPoint) {
	...
	public MUSIC_STORE(ContainedInPlace containedInPlace) {
	...
	public MUSIC_STORE(ContainsPlace containsPlace) {
	...
	public MUSIC_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public MUSIC_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public MUSIC_STORE(Department department) {
	...
	public MUSIC_STORE(Description description) {
	...
	public MUSIC_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public MUSIC_STORE(DissolutionDate dissolutionDate) {
	...
	public MUSIC_STORE(DiversityPolicy diversityPolicy) {
	...
	public MUSIC_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public MUSIC_STORE(Email email) {
		setEmail(email);
	}
	...
	public MUSIC_STORE(Employee employee) {
	...
	public MUSIC_STORE(EthicsPolicy ethicsPolicy) {
	...
	public MUSIC_STORE(Event event) {
		setEvent(event);
	}
	...
	public MUSIC_STORE(FaxNumber faxNumber) {
	...
	public MUSIC_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public MUSIC_STORE(FoundingDate foundingDate) {
	...
	public MUSIC_STORE(FoundingLocation foundingLocation) {
	...
	public MUSIC_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public MUSIC_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public MUSIC_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public MUSIC_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public MUSIC_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public MUSIC_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public MUSIC_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public MUSIC_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public MUSIC_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public MUSIC_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public MUSIC_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public MUSIC_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public MUSIC_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public MUSIC_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public MUSIC_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public MUSIC_STORE(Identifier identifier) {
	...
	public MUSIC_STORE(Image image) {
		setImage(image);
	}
	...
	public MUSIC_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public MUSIC_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public MUSIC_STORE(KnowsAbout knowsAbout) {
	...
	public MUSIC_STORE(KnowsLanguage knowsLanguage) {
	...
	public MUSIC_STORE(LegalName legalName) {
	...
	public MUSIC_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public MUSIC_STORE(Location location) {
	...
	public MUSIC_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public MUSIC_STORE(MakesOffer makesOffer) {
	...
	public MUSIC_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public MUSIC_STORE(Member member) {
		setMember(member);
	}
	...
	public MUSIC_STORE(MemberOf memberOf) {
	...
	public MUSIC_STORE(Naics naics) {
		setNaics(naics);
	}
	...
	public MUSIC_STORE(NameFuzzy nameFuzzy) {
	...
	public MUSIC_STORE(NameRuby nameRuby) {
	...
	public MUSIC_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public MUSIC_STORE(OpeningHours openingHours) {
	...
	public MUSIC_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public MUSIC_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public MUSIC_STORE(ParentOrganization parentOrganization) {
	...
	public MUSIC_STORE(PaymentAccepted paymentAccepted) {
	...
	public MUSIC_STORE(Photo photo) {
		setPhoto(photo);
	}
	...
	public MUSIC_STORE(PotentialAction potentialAction) {
	...
	public MUSIC_STORE(PriceRange priceRange) {
	...
	public MUSIC_STORE(PublicAccess publicAccess) {
	...
	public MUSIC_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public MUSIC_STORE(Review review) {
		setReview(review);
	}
	...
	public MUSIC_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MUSIC_STORE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public MUSIC_STORE(SmokingAllowed smokingAllowed) {
	...
	public MUSIC_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public MUSIC_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MUSIC_STORE(SubOrganization subOrganization) {
	...
	public MUSIC_STORE(SubjectOf subjectOf) {
	...
	public MUSIC_STORE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public MUSIC_STORE(Telephone telephone) {
	...
	public MUSIC_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public MUSIC_STORE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.MusicStore org) {
		setSeq(org.getSeq());
