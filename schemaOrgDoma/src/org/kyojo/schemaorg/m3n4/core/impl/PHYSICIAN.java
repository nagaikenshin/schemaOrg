...
public class PHYSICIAN implements Clazz.Physician {
	...
	public HospitalAffiliation hospitalAffiliation;
	...
	public PHYSICIAN(Long seq) {
		setSeq(seq);
	}

	public PHYSICIAN(String string) {
	...
	public PHYSICIAN(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public PHYSICIAN(AdditionalProperty additionalProperty) {
	...
	public PHYSICIAN(AdditionalType additionalType) {
	...
	public PHYSICIAN(Address address) {
		setAddress(address);
	}
	...
	public PHYSICIAN(AggregateRating aggregateRating) {
	...
	public PHYSICIAN(AlternateName alternateName) {
	...
	public PHYSICIAN(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public PHYSICIAN(AmenityFeature amenityFeature) {
	...
	public PHYSICIAN(AreaServed areaServed) {
	...
	public PHYSICIAN(AvailableService availableService) {
	...
	public PHYSICIAN(BranchCode branchCode) {
	...
	public PHYSICIAN(ContactPoint contactPoint) {
	...
	public PHYSICIAN(ContainedInPlace containedInPlace) {
	...
	public PHYSICIAN(ContainsPlace containsPlace) {
	...
	public PHYSICIAN(CorrectionsPolicy correctionsPolicy) {
	...
	public PHYSICIAN(CurrenciesAccepted currenciesAccepted) {
	...
	public PHYSICIAN(Department department) {
	...
	public PHYSICIAN(Description description) {
	...
	public PHYSICIAN(DisambiguatingDescription disambiguatingDescription) {
	...
	public PHYSICIAN(DissolutionDate dissolutionDate) {
	...
	public PHYSICIAN(DiversityPolicy diversityPolicy) {
	...
	public PHYSICIAN(DiversityStaffingReport diversityStaffingReport) {
	...
	public PHYSICIAN(Employee employee) {
	...
	public PHYSICIAN(EthicsPolicy ethicsPolicy) {
	...
	public PHYSICIAN(FaxNumber faxNumber) {
	...
	public PHYSICIAN(Founder founder) {
		setFounder(founder);
	}
	...
	public PHYSICIAN(FoundingDate foundingDate) {
	...
	public PHYSICIAN(FoundingLocation foundingLocation) {
	...
	public PHYSICIAN(Funder funder) {
		setFunder(funder);
	}
	...
	public PHYSICIAN(GeospatiallyContains geospatiallyContains) {
	...
	public PHYSICIAN(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public PHYSICIAN(GeospatiallyCovers geospatiallyCovers) {
	...
	public PHYSICIAN(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public PHYSICIAN(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public PHYSICIAN(GeospatiallyEquals geospatiallyEquals) {
	...
	public PHYSICIAN(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public PHYSICIAN(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public PHYSICIAN(GeospatiallyTouches geospatiallyTouches) {
	...
	public PHYSICIAN(GeospatiallyWithin geospatiallyWithin) {
	...
	public PHYSICIAN(GlobalLocationNumber globalLocationNumber) {
	...
	public PHYSICIAN(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public PHYSICIAN(HasOfferCatalog hasOfferCatalog) {
	...
	public PHYSICIAN(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public PHYSICIAN(HealthPlanNetworkId healthPlanNetworkId) {
	...
	public PHYSICIAN(HospitalAffiliation hospitalAffiliation) {
	...
	public PHYSICIAN(Identifier identifier) {
	...
	public PHYSICIAN(IsAcceptingNewPatients isAcceptingNewPatients) {
	...
	public PHYSICIAN(IsAccessibleForFree isAccessibleForFree) {
	...
	public PHYSICIAN(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public PHYSICIAN(KnowsAbout knowsAbout) {
	...
	public PHYSICIAN(KnowsLanguage knowsLanguage) {
	...
	public PHYSICIAN(LegalName legalName) {
	...
	public PHYSICIAN(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public PHYSICIAN(Location location) {
	...
	public PHYSICIAN(MainEntityOfPage mainEntityOfPage) {
	...
	public PHYSICIAN(MakesOffer makesOffer) {
	...
	public PHYSICIAN(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public PHYSICIAN(MedicalSpecialty medicalSpecialty) {
	...
	public PHYSICIAN(Member member) {
		setMember(member);
	}
	...
	public PHYSICIAN(MemberOf memberOf) {
	...
	public PHYSICIAN(NameFuzzy nameFuzzy) {
	...
	public PHYSICIAN(NameRuby nameRuby) {
	...
	public PHYSICIAN(NumberOfEmployees numberOfEmployees) {
	...
	public PHYSICIAN(OpeningHours openingHours) {
	...
	public PHYSICIAN(OpeningHoursSpecification openingHoursSpecification) {
	...
	public PHYSICIAN(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public PHYSICIAN(ParentOrganization parentOrganization) {
	...
	public PHYSICIAN(PaymentAccepted paymentAccepted) {
	...
	public PHYSICIAN(PotentialAction potentialAction) {
	...
	public PHYSICIAN(PriceRange priceRange) {
	...
	public PHYSICIAN(PublicAccess publicAccess) {
	...
	public PHYSICIAN(PublishingPrinciples publishingPrinciples) {
	...
	public PHYSICIAN(Review review) {
		setReview(review);
	}
	...
	public PHYSICIAN(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PHYSICIAN(SmokingAllowed smokingAllowed) {
	...
	public PHYSICIAN(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public PHYSICIAN(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public PHYSICIAN(SubOrganization subOrganization) {
	...
	public PHYSICIAN(SubjectOf subjectOf) {
	...
	public PHYSICIAN(Telephone telephone) {
	...
	public PHYSICIAN(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Physician org) {
		setSeq(org.getSeq());
		...
		setHospitalAffiliation(org.getHospitalAffiliation());
