...
public class MENS_CLOTHING_STORE implements Clazz.MensClothingStore {
	...
	public MENS_CLOTHING_STORE() {
	}

	public MENS_CLOTHING_STORE(Long seq) {
		setSeq(seq);
	}

	public MENS_CLOTHING_STORE(String string) {
	...
	public MENS_CLOTHING_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public MENS_CLOTHING_STORE(AdditionalProperty additionalProperty) {
	...
	public MENS_CLOTHING_STORE(AdditionalType additionalType) {
	...
	public MENS_CLOTHING_STORE(Address address) {
		setAddress(address);
	}
	...
	public MENS_CLOTHING_STORE(AggregateRating aggregateRating) {
	...
	public MENS_CLOTHING_STORE(AlternateName alternateName) {
	...
	public MENS_CLOTHING_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public MENS_CLOTHING_STORE(AmenityFeature amenityFeature) {
	...
	public MENS_CLOTHING_STORE(AreaServed areaServed) {
	...
	public MENS_CLOTHING_STORE(Award award) {
		setAward(award);
	}
	...
	public MENS_CLOTHING_STORE(BranchCode branchCode) {
	...
	public MENS_CLOTHING_STORE(Brand brand) {
		setBrand(brand);
	}
	...
	public MENS_CLOTHING_STORE(ContactPoint contactPoint) {
	...
	public MENS_CLOTHING_STORE(ContainedInPlace containedInPlace) {
	...
	public MENS_CLOTHING_STORE(ContainsPlace containsPlace) {
	...
	public MENS_CLOTHING_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public MENS_CLOTHING_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public MENS_CLOTHING_STORE(Department department) {
	...
	public MENS_CLOTHING_STORE(Description description) {
	...
	public MENS_CLOTHING_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public MENS_CLOTHING_STORE(DissolutionDate dissolutionDate) {
	...
	public MENS_CLOTHING_STORE(DiversityPolicy diversityPolicy) {
	...
	public MENS_CLOTHING_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public MENS_CLOTHING_STORE(Duns duns) {
		setDuns(duns);
	}
	...
	public MENS_CLOTHING_STORE(Email email) {
		setEmail(email);
	}
	...
	public MENS_CLOTHING_STORE(Employee employee) {
	...
	public MENS_CLOTHING_STORE(EthicsPolicy ethicsPolicy) {
	...
	public MENS_CLOTHING_STORE(Event event) {
		setEvent(event);
	}
	...
	public MENS_CLOTHING_STORE(FaxNumber faxNumber) {
	...
	public MENS_CLOTHING_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public MENS_CLOTHING_STORE(FoundingDate foundingDate) {
	...
	public MENS_CLOTHING_STORE(FoundingLocation foundingLocation) {
	...
	public MENS_CLOTHING_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public MENS_CLOTHING_STORE(Geo geo) {
		setGeo(geo);
	}
	...
	public MENS_CLOTHING_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public MENS_CLOTHING_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public MENS_CLOTHING_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public MENS_CLOTHING_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public MENS_CLOTHING_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public MENS_CLOTHING_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public MENS_CLOTHING_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public MENS_CLOTHING_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public MENS_CLOTHING_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public MENS_CLOTHING_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public MENS_CLOTHING_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public MENS_CLOTHING_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public MENS_CLOTHING_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public MENS_CLOTHING_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public MENS_CLOTHING_STORE(Identifier identifier) {
	...
	public MENS_CLOTHING_STORE(Image image) {
		setImage(image);
	}
	...
	public MENS_CLOTHING_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public MENS_CLOTHING_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public MENS_CLOTHING_STORE(KnowsAbout knowsAbout) {
	...
	public MENS_CLOTHING_STORE(KnowsLanguage knowsLanguage) {
	...
	public MENS_CLOTHING_STORE(LegalName legalName) {
	...
	public MENS_CLOTHING_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public MENS_CLOTHING_STORE(Location location) {
	...
	public MENS_CLOTHING_STORE(Logo logo) {
		setLogo(logo);
	}
	...
	public MENS_CLOTHING_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public MENS_CLOTHING_STORE(MakesOffer makesOffer) {
	...
	public MENS_CLOTHING_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public MENS_CLOTHING_STORE(Member member) {
		setMember(member);
	}
	...
	public MENS_CLOTHING_STORE(MemberOf memberOf) {
	...
	public MENS_CLOTHING_STORE(Naics naics) {
		setNaics(naics);
	}
	...
	public MENS_CLOTHING_STORE(Name name) {
		setName(name);
	}
	...
	public MENS_CLOTHING_STORE(NameFuzzy nameFuzzy) {
	...
	public MENS_CLOTHING_STORE(NameRuby nameRuby) {
	...
	public MENS_CLOTHING_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public MENS_CLOTHING_STORE(OpeningHours openingHours) {
	...
	public MENS_CLOTHING_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public MENS_CLOTHING_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public MENS_CLOTHING_STORE(Owns owns) {
		setOwns(owns);
	}
	...
	public MENS_CLOTHING_STORE(ParentOrganization parentOrganization) {
	...
	public MENS_CLOTHING_STORE(PaymentAccepted paymentAccepted) {
	...
	public MENS_CLOTHING_STORE(Photo photo) {
		setPhoto(photo);
	}
	...
	public MENS_CLOTHING_STORE(PotentialAction potentialAction) {
	...
	public MENS_CLOTHING_STORE(PriceRange priceRange) {
	...
	public MENS_CLOTHING_STORE(PublicAccess publicAccess) {
	...
	public MENS_CLOTHING_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public MENS_CLOTHING_STORE(Review review) {
		setReview(review);
	}
	...
	public MENS_CLOTHING_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MENS_CLOTHING_STORE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public MENS_CLOTHING_STORE(SmokingAllowed smokingAllowed) {
	...
	public MENS_CLOTHING_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public MENS_CLOTHING_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MENS_CLOTHING_STORE(SubOrganization subOrganization) {
	...
	public MENS_CLOTHING_STORE(SubjectOf subjectOf) {
	...
	public MENS_CLOTHING_STORE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public MENS_CLOTHING_STORE(Telephone telephone) {
	...
	public MENS_CLOTHING_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public MENS_CLOTHING_STORE(Url url) {
		setUrl(url);
	}
	...
	public MENS_CLOTHING_STORE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.MensClothingStore org) {
		setSeq(org.getSeq());
