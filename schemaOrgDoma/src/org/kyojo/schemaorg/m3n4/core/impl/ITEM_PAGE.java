...
public class ITEM_PAGE implements Clazz.ItemPage {
	...
	public ITEM_PAGE(Long seq) {
		setSeq(seq);
	}

	public ITEM_PAGE(String string) {
	...
	public ITEM_PAGE(AccessMode accessMode) {
	...
	public ITEM_PAGE(AccessModeSufficient accessModeSufficient) {
	...
	public ITEM_PAGE(AccessibilityAPI accessibilityAPI) {
	...
	public ITEM_PAGE(AccessibilityControl accessibilityControl) {
	...
	public ITEM_PAGE(AccessibilityFeature accessibilityFeature) {
	...
	public ITEM_PAGE(AccessibilityHazard accessibilityHazard) {
	...
	public ITEM_PAGE(AccessibilitySummary accessibilitySummary) {
	...
	public ITEM_PAGE(AccountablePerson accountablePerson) {
	...
	public ITEM_PAGE(AdditionalType additionalType) {
	...
	public ITEM_PAGE(AggregateRating aggregateRating) {
	...
	public ITEM_PAGE(AlternateName alternateName) {
	...
	public ITEM_PAGE(AlternativeHeadline alternativeHeadline) {
	...
	public ITEM_PAGE(AssociatedMedia associatedMedia) {
	...
	public ITEM_PAGE(Audience audience) {
	...
	public ITEM_PAGE(Author author) {
		setAuthor(author);
	}
	...
	public ITEM_PAGE(Breadcrumb breadcrumb) {
	...
	public ITEM_PAGE(Character character) {
	...
	public ITEM_PAGE(Citation citation) {
	...
	public ITEM_PAGE(Comment comment) {
		setComment(comment);
	}
	...
	public ITEM_PAGE(CommentCount commentCount) {
	...
	public ITEM_PAGE(ContentLocation contentLocation) {
	...
	public ITEM_PAGE(ContentRating contentRating) {
	...
	public ITEM_PAGE(ContentReferenceTime contentReferenceTime) {
	...
	public ITEM_PAGE(Contributor contributor) {
	...
	public ITEM_PAGE(CopyrightHolder copyrightHolder) {
	...
	public ITEM_PAGE(CopyrightYear copyrightYear) {
	...
	public ITEM_PAGE(Correction correction) {
	...
	public ITEM_PAGE(Creator creator) {
		setCreator(creator);
	}
	...
	public ITEM_PAGE(DateCreated dateCreated) {
	...
	public ITEM_PAGE(DateModified dateModified) {
	...
	public ITEM_PAGE(DatePublished datePublished) {
	...
	public ITEM_PAGE(Description description) {
	...
	public ITEM_PAGE(DisambiguatingDescription disambiguatingDescription) {
	...
	public ITEM_PAGE(DiscussionUrl discussionUrl) {
	...
	public ITEM_PAGE(Editor editor) {
		setEditor(editor);
	}
	...
	public ITEM_PAGE(EducationalAlignment educationalAlignment) {
	...
	public ITEM_PAGE(EducationalUse educationalUse) {
	...
	public ITEM_PAGE(Encoding encoding) {
	...
	public ITEM_PAGE(EncodingFormat encodingFormat) {
	...
	public ITEM_PAGE(ExampleOfWork exampleOfWork) {
	...
	public ITEM_PAGE(Expires expires) {
		setExpires(expires);
	}
	...
	public ITEM_PAGE(Funder funder) {
		setFunder(funder);
	}
	...
	public ITEM_PAGE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public ITEM_PAGE(Headline headline) {
	...
	public ITEM_PAGE(Identifier identifier) {
	...
	public ITEM_PAGE(InLanguage inLanguage) {
	...
	public ITEM_PAGE(InteractionStatistic interactionStatistic) {
	...
	public ITEM_PAGE(InteractivityType interactivityType) {
	...
	public ITEM_PAGE(IsAccessibleForFree isAccessibleForFree) {
	...
	public ITEM_PAGE(IsBasedOn isBasedOn) {
	...
	public ITEM_PAGE(IsFamilyFriendly isFamilyFriendly) {
	...
	public ITEM_PAGE(IsPartOf isPartOf) {
	...
	public ITEM_PAGE(Keywords keywords) {
	...
	public ITEM_PAGE(LastReviewed lastReviewed) {
	...
	public ITEM_PAGE(LearningResourceType learningResourceType) {
	...
	public ITEM_PAGE(License license) {
		setLicense(license);
	}
	...
	public ITEM_PAGE(LocationCreated locationCreated) {
	...
	public ITEM_PAGE(MainContentOfPage mainContentOfPage) {
	...
	public ITEM_PAGE(MainEntity mainEntity) {
	...
	public ITEM_PAGE(MainEntityOfPage mainEntityOfPage) {
	...
	public ITEM_PAGE(Material material) {
	...
	public ITEM_PAGE(Mentions mentions) {
	...
	public ITEM_PAGE(NameFuzzy nameFuzzy) {
	...
	public ITEM_PAGE(NameRuby nameRuby) {
	...
	public ITEM_PAGE(Offers offers) {
		setOffers(offers);
	}
	...
	public ITEM_PAGE(Position position) {
	...
	public ITEM_PAGE(PotentialAction potentialAction) {
	...
	public ITEM_PAGE(PrimaryImageOfPage primaryImageOfPage) {
	...
	public ITEM_PAGE(Producer producer) {
	...
	public ITEM_PAGE(Provider provider) {
	...
	public ITEM_PAGE(Publication publication) {
	...
	public ITEM_PAGE(Publisher publisher) {
	...
	public ITEM_PAGE(PublisherImprint publisherImprint) {
	...
	public ITEM_PAGE(PublishingPrinciples publishingPrinciples) {
	...
	public ITEM_PAGE(RecordedAt recordedAt) {
	...
	public ITEM_PAGE(RelatedLink relatedLink) {
	...
	public ITEM_PAGE(ReleasedEvent releasedEvent) {
	...
	public ITEM_PAGE(Review review) {
		setReview(review);
	}
	...
	public ITEM_PAGE(ReviewedBy reviewedBy) {
	...
	public ITEM_PAGE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ITEM_PAGE(SchemaVersion schemaVersion) {
	...
	public ITEM_PAGE(SdDatePublished sdDatePublished) {
	...
	public ITEM_PAGE(SdLicense sdLicense) {
	...
	public ITEM_PAGE(SdPublisher sdPublisher) {
	...
	public ITEM_PAGE(SignificantLink significantLink) {
	...
	public ITEM_PAGE(SourceOrganization sourceOrganization) {
	...
	public ITEM_PAGE(SpatialCoverage spatialCoverage) {
	...
	public ITEM_PAGE(Speakable speakable) {
	...
	public ITEM_PAGE(Specialty specialty) {
	...
	public ITEM_PAGE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public ITEM_PAGE(SubjectOf subjectOf) {
	...
	public ITEM_PAGE(TemporalCoverage temporalCoverage) {
	...
	public ITEM_PAGE(ThumbnailUrl thumbnailUrl) {
	...
	public ITEM_PAGE(TimeRequired timeRequired) {
	...
	public ITEM_PAGE(TranslationOfWork translationOfWork) {
	...
	public ITEM_PAGE(Translator translator) {
	...
	public ITEM_PAGE(TypicalAgeRange typicalAgeRange) {
	...
	public ITEM_PAGE(Version version) {
		setVersion(version);
	}
	...
	public ITEM_PAGE(WorkExample workExample) {
	...
	public ITEM_PAGE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.ItemPage org) {
		setSeq(org.getSeq());
