...
public class TOURIST_ATTRACTION implements Clazz.TouristAttraction {
	...
	public TOURIST_ATTRACTION(Long seq) {
		setSeq(seq);
	}

	public TOURIST_ATTRACTION(String string) {
	...
	public TOURIST_ATTRACTION(AdditionalProperty additionalProperty) {
	...
	public TOURIST_ATTRACTION(AdditionalType additionalType) {
	...
	public TOURIST_ATTRACTION(Address address) {
		setAddress(address);
	}
	...
	public TOURIST_ATTRACTION(AggregateRating aggregateRating) {
	...
	public TOURIST_ATTRACTION(AlternateName alternateName) {
	...
	public TOURIST_ATTRACTION(AmenityFeature amenityFeature) {
	...
	public TOURIST_ATTRACTION(AvailableLanguage availableLanguage) {
	...
	public TOURIST_ATTRACTION(BranchCode branchCode) {
	...
	public TOURIST_ATTRACTION(ContainedInPlace containedInPlace) {
	...
	public TOURIST_ATTRACTION(ContainsPlace containsPlace) {
	...
	public TOURIST_ATTRACTION(Description description) {
	...
	public TOURIST_ATTRACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public TOURIST_ATTRACTION(Event event) {
		setEvent(event);
	}
	...
	public TOURIST_ATTRACTION(FaxNumber faxNumber) {
	...
	public TOURIST_ATTRACTION(Geo geo) {
		setGeo(geo);
	}
	...
	public TOURIST_ATTRACTION(GeospatiallyContains geospatiallyContains) {
	...
	public TOURIST_ATTRACTION(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public TOURIST_ATTRACTION(GeospatiallyCovers geospatiallyCovers) {
	...
	public TOURIST_ATTRACTION(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public TOURIST_ATTRACTION(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public TOURIST_ATTRACTION(GeospatiallyEquals geospatiallyEquals) {
	...
	public TOURIST_ATTRACTION(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public TOURIST_ATTRACTION(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public TOURIST_ATTRACTION(GeospatiallyTouches geospatiallyTouches) {
	...
	public TOURIST_ATTRACTION(GeospatiallyWithin geospatiallyWithin) {
	...
	public TOURIST_ATTRACTION(GlobalLocationNumber globalLocationNumber) {
	...
	public TOURIST_ATTRACTION(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public TOURIST_ATTRACTION(Identifier identifier) {
	...
	public TOURIST_ATTRACTION(Image image) {
		setImage(image);
	}
	...
	public TOURIST_ATTRACTION(IsAccessibleForFree isAccessibleForFree) {
	...
	public TOURIST_ATTRACTION(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public TOURIST_ATTRACTION(Logo logo) {
		setLogo(logo);
	}
	...
	public TOURIST_ATTRACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public TOURIST_ATTRACTION(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public TOURIST_ATTRACTION(Name name) {
		setName(name);
	}
	...
	public TOURIST_ATTRACTION(NameFuzzy nameFuzzy) {
	...
	public TOURIST_ATTRACTION(NameRuby nameRuby) {
	...
	public TOURIST_ATTRACTION(OpeningHoursSpecification openingHoursSpecification) {
	...
	public TOURIST_ATTRACTION(Photo photo) {
		setPhoto(photo);
	}
	...
	public TOURIST_ATTRACTION(PotentialAction potentialAction) {
	...
	public TOURIST_ATTRACTION(PublicAccess publicAccess) {
	...
	public TOURIST_ATTRACTION(Review review) {
		setReview(review);
	}
	...
	public TOURIST_ATTRACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TOURIST_ATTRACTION(SmokingAllowed smokingAllowed) {
	...
	public TOURIST_ATTRACTION(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public TOURIST_ATTRACTION(SubjectOf subjectOf) {
	...
	public TOURIST_ATTRACTION(Telephone telephone) {
	...
	public TOURIST_ATTRACTION(TouristType touristType) {
	...
	public TOURIST_ATTRACTION(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.TouristAttraction org) {
		setSeq(org.getSeq());
