...
public class AUTO_PARTS_STORE implements Clazz.AutoPartsStore {
	...
	public AUTO_PARTS_STORE() {
	}

	public AUTO_PARTS_STORE(Long seq) {
		setSeq(seq);
	}

	public AUTO_PARTS_STORE(String string) {
	...
	public AUTO_PARTS_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public AUTO_PARTS_STORE(AdditionalProperty additionalProperty) {
	...
	public AUTO_PARTS_STORE(AdditionalType additionalType) {
	...
	public AUTO_PARTS_STORE(Address address) {
		setAddress(address);
	}
	...
	public AUTO_PARTS_STORE(AggregateRating aggregateRating) {
	...
	public AUTO_PARTS_STORE(AlternateName alternateName) {
	...
	public AUTO_PARTS_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public AUTO_PARTS_STORE(AmenityFeature amenityFeature) {
	...
	public AUTO_PARTS_STORE(AreaServed areaServed) {
	...
	public AUTO_PARTS_STORE(Award award) {
		setAward(award);
	}
	...
	public AUTO_PARTS_STORE(BranchCode branchCode) {
	...
	public AUTO_PARTS_STORE(Brand brand) {
		setBrand(brand);
	}
	...
	public AUTO_PARTS_STORE(ContactPoint contactPoint) {
	...
	public AUTO_PARTS_STORE(ContainedInPlace containedInPlace) {
	...
	public AUTO_PARTS_STORE(ContainsPlace containsPlace) {
	...
	public AUTO_PARTS_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public AUTO_PARTS_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public AUTO_PARTS_STORE(Department department) {
	...
	public AUTO_PARTS_STORE(Description description) {
	...
	public AUTO_PARTS_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public AUTO_PARTS_STORE(DissolutionDate dissolutionDate) {
	...
	public AUTO_PARTS_STORE(DiversityPolicy diversityPolicy) {
	...
	public AUTO_PARTS_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public AUTO_PARTS_STORE(Duns duns) {
		setDuns(duns);
	}
	...
	public AUTO_PARTS_STORE(Email email) {
		setEmail(email);
	}
	...
	public AUTO_PARTS_STORE(Employee employee) {
	...
	public AUTO_PARTS_STORE(EthicsPolicy ethicsPolicy) {
	...
	public AUTO_PARTS_STORE(Event event) {
		setEvent(event);
	}
	...
	public AUTO_PARTS_STORE(FaxNumber faxNumber) {
	...
	public AUTO_PARTS_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public AUTO_PARTS_STORE(FoundingDate foundingDate) {
	...
	public AUTO_PARTS_STORE(FoundingLocation foundingLocation) {
	...
	public AUTO_PARTS_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public AUTO_PARTS_STORE(Geo geo) {
		setGeo(geo);
	}
	...
	public AUTO_PARTS_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public AUTO_PARTS_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public AUTO_PARTS_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public AUTO_PARTS_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public AUTO_PARTS_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public AUTO_PARTS_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public AUTO_PARTS_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public AUTO_PARTS_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public AUTO_PARTS_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public AUTO_PARTS_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public AUTO_PARTS_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public AUTO_PARTS_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public AUTO_PARTS_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public AUTO_PARTS_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public AUTO_PARTS_STORE(Identifier identifier) {
	...
	public AUTO_PARTS_STORE(Image image) {
		setImage(image);
	}
	...
	public AUTO_PARTS_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public AUTO_PARTS_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public AUTO_PARTS_STORE(KnowsAbout knowsAbout) {
	...
	public AUTO_PARTS_STORE(KnowsLanguage knowsLanguage) {
	...
	public AUTO_PARTS_STORE(LegalName legalName) {
	...
	public AUTO_PARTS_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public AUTO_PARTS_STORE(Location location) {
	...
	public AUTO_PARTS_STORE(Logo logo) {
		setLogo(logo);
	}
	...
	public AUTO_PARTS_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public AUTO_PARTS_STORE(MakesOffer makesOffer) {
	...
	public AUTO_PARTS_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public AUTO_PARTS_STORE(Member member) {
		setMember(member);
	}
	...
	public AUTO_PARTS_STORE(MemberOf memberOf) {
	...
	public AUTO_PARTS_STORE(Naics naics) {
		setNaics(naics);
	}
	...
	public AUTO_PARTS_STORE(Name name) {
		setName(name);
	}
	...
	public AUTO_PARTS_STORE(NameFuzzy nameFuzzy) {
	...
	public AUTO_PARTS_STORE(NameRuby nameRuby) {
	...
	public AUTO_PARTS_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public AUTO_PARTS_STORE(OpeningHours openingHours) {
	...
	public AUTO_PARTS_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public AUTO_PARTS_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public AUTO_PARTS_STORE(Owns owns) {
		setOwns(owns);
	}
	...
	public AUTO_PARTS_STORE(ParentOrganization parentOrganization) {
	...
	public AUTO_PARTS_STORE(PaymentAccepted paymentAccepted) {
	...
	public AUTO_PARTS_STORE(Photo photo) {
		setPhoto(photo);
	}
	...
	public AUTO_PARTS_STORE(PotentialAction potentialAction) {
	...
	public AUTO_PARTS_STORE(PriceRange priceRange) {
	...
	public AUTO_PARTS_STORE(PublicAccess publicAccess) {
	...
	public AUTO_PARTS_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public AUTO_PARTS_STORE(Review review) {
		setReview(review);
	}
	...
	public AUTO_PARTS_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public AUTO_PARTS_STORE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public AUTO_PARTS_STORE(SmokingAllowed smokingAllowed) {
	...
	public AUTO_PARTS_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public AUTO_PARTS_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public AUTO_PARTS_STORE(SubOrganization subOrganization) {
	...
	public AUTO_PARTS_STORE(SubjectOf subjectOf) {
	...
	public AUTO_PARTS_STORE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public AUTO_PARTS_STORE(Telephone telephone) {
	...
	public AUTO_PARTS_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public AUTO_PARTS_STORE(Url url) {
		setUrl(url);
	}
	...
	public AUTO_PARTS_STORE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.AutoPartsStore org) {
		setSeq(org.getSeq());
