...
public class WEAR_ACTION implements Clazz.WearAction {
	...
	public WEAR_ACTION(Long seq) {
		setSeq(seq);
	}

	public WEAR_ACTION(String string) {
	...
	public WEAR_ACTION(ActionAccessibilityRequirement actionAccessibilityRequirement) {
	...
	public WEAR_ACTION(ActionStatus actionStatus) {
	...
	public WEAR_ACTION(AdditionalType additionalType) {
	...
	public WEAR_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public WEAR_ACTION(AlternateName alternateName) {
	...
	public WEAR_ACTION(Description description) {
	...
	public WEAR_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public WEAR_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public WEAR_ACTION(Error error) {
		setError(error);
	}
	...
	public WEAR_ACTION(ExpectsAcceptanceOf expectsAcceptanceOf) {
	...
	public WEAR_ACTION(Identifier identifier) {
	...
	public WEAR_ACTION(Image image) {
		setImage(image);
	}
	...
	public WEAR_ACTION(Instrument instrument) {
	...
	public WEAR_ACTION(Location location) {
	...
	public WEAR_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public WEAR_ACTION(NameFuzzy nameFuzzy) {
	...
	public WEAR_ACTION(NameRuby nameRuby) {
	...
	public WEAR_ACTION(Object object) {
		setObject(object);
	}
	...
	public WEAR_ACTION(Participant participant) {
	...
	public WEAR_ACTION(PotentialAction potentialAction) {
	...
	public WEAR_ACTION(Result result) {
		setResult(result);
	}
	...
	public WEAR_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public WEAR_ACTION(StartTime startTime) {
	...
	public WEAR_ACTION(SubjectOf subjectOf) {
	...
	public WEAR_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.WearAction org) {
		setSeq(org.getSeq());
