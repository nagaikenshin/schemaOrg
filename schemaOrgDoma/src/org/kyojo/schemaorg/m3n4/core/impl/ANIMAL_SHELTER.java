...
public class ANIMAL_SHELTER implements Clazz.AnimalShelter {
	...
	public ANIMAL_SHELTER(Long seq) {
		setSeq(seq);
	}

	public ANIMAL_SHELTER(String string) {
	...
	public ANIMAL_SHELTER(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public ANIMAL_SHELTER(AdditionalProperty additionalProperty) {
	...
	public ANIMAL_SHELTER(AdditionalType additionalType) {
	...
	public ANIMAL_SHELTER(Address address) {
		setAddress(address);
	}
	...
	public ANIMAL_SHELTER(AggregateRating aggregateRating) {
	...
	public ANIMAL_SHELTER(AlternateName alternateName) {
	...
	public ANIMAL_SHELTER(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public ANIMAL_SHELTER(AmenityFeature amenityFeature) {
	...
	public ANIMAL_SHELTER(AreaServed areaServed) {
	...
	public ANIMAL_SHELTER(Award award) {
		setAward(award);
	}
	...
	public ANIMAL_SHELTER(BranchCode branchCode) {
	...
	public ANIMAL_SHELTER(Brand brand) {
		setBrand(brand);
	}
	...
	public ANIMAL_SHELTER(ContactPoint contactPoint) {
	...
	public ANIMAL_SHELTER(ContainedInPlace containedInPlace) {
	...
	public ANIMAL_SHELTER(ContainsPlace containsPlace) {
	...
	public ANIMAL_SHELTER(CorrectionsPolicy correctionsPolicy) {
	...
	public ANIMAL_SHELTER(CurrenciesAccepted currenciesAccepted) {
	...
	public ANIMAL_SHELTER(Department department) {
	...
	public ANIMAL_SHELTER(Description description) {
	...
	public ANIMAL_SHELTER(DisambiguatingDescription disambiguatingDescription) {
	...
	public ANIMAL_SHELTER(DissolutionDate dissolutionDate) {
	...
	public ANIMAL_SHELTER(DiversityPolicy diversityPolicy) {
	...
	public ANIMAL_SHELTER(DiversityStaffingReport diversityStaffingReport) {
	...
	public ANIMAL_SHELTER(Duns duns) {
		setDuns(duns);
	}
	...
	public ANIMAL_SHELTER(Email email) {
		setEmail(email);
	}
	...
	public ANIMAL_SHELTER(Employee employee) {
	...
	public ANIMAL_SHELTER(EthicsPolicy ethicsPolicy) {
	...
	public ANIMAL_SHELTER(Event event) {
		setEvent(event);
	}
	...
	public ANIMAL_SHELTER(FaxNumber faxNumber) {
	...
	public ANIMAL_SHELTER(Founder founder) {
		setFounder(founder);
	}
	...
	public ANIMAL_SHELTER(FoundingDate foundingDate) {
	...
	public ANIMAL_SHELTER(FoundingLocation foundingLocation) {
	...
	public ANIMAL_SHELTER(Funder funder) {
		setFunder(funder);
	}
	...
	public ANIMAL_SHELTER(GeospatiallyContains geospatiallyContains) {
	...
	public ANIMAL_SHELTER(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public ANIMAL_SHELTER(GeospatiallyCovers geospatiallyCovers) {
	...
	public ANIMAL_SHELTER(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public ANIMAL_SHELTER(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public ANIMAL_SHELTER(GeospatiallyEquals geospatiallyEquals) {
	...
	public ANIMAL_SHELTER(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public ANIMAL_SHELTER(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public ANIMAL_SHELTER(GeospatiallyTouches geospatiallyTouches) {
	...
	public ANIMAL_SHELTER(GeospatiallyWithin geospatiallyWithin) {
	...
	public ANIMAL_SHELTER(GlobalLocationNumber globalLocationNumber) {
	...
	public ANIMAL_SHELTER(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public ANIMAL_SHELTER(HasOfferCatalog hasOfferCatalog) {
	...
	public ANIMAL_SHELTER(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public ANIMAL_SHELTER(Identifier identifier) {
	...
	public ANIMAL_SHELTER(Image image) {
		setImage(image);
	}
	...
	public ANIMAL_SHELTER(IsAccessibleForFree isAccessibleForFree) {
	...
	public ANIMAL_SHELTER(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public ANIMAL_SHELTER(KnowsAbout knowsAbout) {
	...
	public ANIMAL_SHELTER(KnowsLanguage knowsLanguage) {
	...
	public ANIMAL_SHELTER(LegalName legalName) {
	...
	public ANIMAL_SHELTER(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public ANIMAL_SHELTER(Location location) {
	...
	public ANIMAL_SHELTER(Logo logo) {
		setLogo(logo);
	}
	...
	public ANIMAL_SHELTER(MainEntityOfPage mainEntityOfPage) {
	...
	public ANIMAL_SHELTER(MakesOffer makesOffer) {
	...
	public ANIMAL_SHELTER(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public ANIMAL_SHELTER(Member member) {
		setMember(member);
	}
	...
	public ANIMAL_SHELTER(MemberOf memberOf) {
	...
	public ANIMAL_SHELTER(Naics naics) {
		setNaics(naics);
	}
	...
	public ANIMAL_SHELTER(Name name) {
		setName(name);
	}
	...
	public ANIMAL_SHELTER(NameFuzzy nameFuzzy) {
	...
	public ANIMAL_SHELTER(NameRuby nameRuby) {
	...
	public ANIMAL_SHELTER(NumberOfEmployees numberOfEmployees) {
	...
	public ANIMAL_SHELTER(OpeningHours openingHours) {
	...
	public ANIMAL_SHELTER(OpeningHoursSpecification openingHoursSpecification) {
	...
	public ANIMAL_SHELTER(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public ANIMAL_SHELTER(Owns owns) {
		setOwns(owns);
	}
	...
	public ANIMAL_SHELTER(ParentOrganization parentOrganization) {
	...
	public ANIMAL_SHELTER(PaymentAccepted paymentAccepted) {
	...
	public ANIMAL_SHELTER(Photo photo) {
		setPhoto(photo);
	}
	...
	public ANIMAL_SHELTER(PotentialAction potentialAction) {
	...
	public ANIMAL_SHELTER(PriceRange priceRange) {
	...
	public ANIMAL_SHELTER(PublicAccess publicAccess) {
	...
	public ANIMAL_SHELTER(PublishingPrinciples publishingPrinciples) {
	...
	public ANIMAL_SHELTER(Review review) {
		setReview(review);
	}
	...
	public ANIMAL_SHELTER(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ANIMAL_SHELTER(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public ANIMAL_SHELTER(SmokingAllowed smokingAllowed) {
	...
	public ANIMAL_SHELTER(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public ANIMAL_SHELTER(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public ANIMAL_SHELTER(SubOrganization subOrganization) {
	...
	public ANIMAL_SHELTER(SubjectOf subjectOf) {
	...
	public ANIMAL_SHELTER(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public ANIMAL_SHELTER(Telephone telephone) {
	...
	public ANIMAL_SHELTER(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public ANIMAL_SHELTER(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.AnimalShelter org) {
		setSeq(org.getSeq());
