...
public class BIKE_STORE implements Clazz.BikeStore {
	...
	public BIKE_STORE(Long seq) {
		setSeq(seq);
	}

	public BIKE_STORE(String string) {
	...
	public BIKE_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public BIKE_STORE(AdditionalProperty additionalProperty) {
	...
	public BIKE_STORE(AdditionalType additionalType) {
	...
	public BIKE_STORE(Address address) {
		setAddress(address);
	}
	...
	public BIKE_STORE(AggregateRating aggregateRating) {
	...
	public BIKE_STORE(AlternateName alternateName) {
	...
	public BIKE_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public BIKE_STORE(AmenityFeature amenityFeature) {
	...
	public BIKE_STORE(AreaServed areaServed) {
	...
	public BIKE_STORE(BranchCode branchCode) {
	...
	public BIKE_STORE(ContactPoint contactPoint) {
	...
	public BIKE_STORE(ContainedInPlace containedInPlace) {
	...
	public BIKE_STORE(ContainsPlace containsPlace) {
	...
	public BIKE_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public BIKE_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public BIKE_STORE(Department department) {
	...
	public BIKE_STORE(Description description) {
	...
	public BIKE_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public BIKE_STORE(DissolutionDate dissolutionDate) {
	...
	public BIKE_STORE(DiversityPolicy diversityPolicy) {
	...
	public BIKE_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public BIKE_STORE(Employee employee) {
	...
	public BIKE_STORE(EthicsPolicy ethicsPolicy) {
	...
	public BIKE_STORE(FaxNumber faxNumber) {
	...
	public BIKE_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public BIKE_STORE(FoundingDate foundingDate) {
	...
	public BIKE_STORE(FoundingLocation foundingLocation) {
	...
	public BIKE_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public BIKE_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public BIKE_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public BIKE_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public BIKE_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public BIKE_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public BIKE_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public BIKE_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public BIKE_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public BIKE_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public BIKE_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public BIKE_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public BIKE_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public BIKE_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public BIKE_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public BIKE_STORE(Identifier identifier) {
	...
	public BIKE_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public BIKE_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public BIKE_STORE(KnowsAbout knowsAbout) {
	...
	public BIKE_STORE(KnowsLanguage knowsLanguage) {
	...
	public BIKE_STORE(LegalName legalName) {
	...
	public BIKE_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public BIKE_STORE(Location location) {
	...
	public BIKE_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public BIKE_STORE(MakesOffer makesOffer) {
	...
	public BIKE_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public BIKE_STORE(Member member) {
		setMember(member);
	}
	...
	public BIKE_STORE(MemberOf memberOf) {
	...
	public BIKE_STORE(NameFuzzy nameFuzzy) {
	...
	public BIKE_STORE(NameRuby nameRuby) {
	...
	public BIKE_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public BIKE_STORE(OpeningHours openingHours) {
	...
	public BIKE_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public BIKE_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public BIKE_STORE(ParentOrganization parentOrganization) {
	...
	public BIKE_STORE(PaymentAccepted paymentAccepted) {
	...
	public BIKE_STORE(PotentialAction potentialAction) {
	...
	public BIKE_STORE(PriceRange priceRange) {
	...
	public BIKE_STORE(PublicAccess publicAccess) {
	...
	public BIKE_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public BIKE_STORE(Review review) {
		setReview(review);
	}
	...
	public BIKE_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public BIKE_STORE(SmokingAllowed smokingAllowed) {
	...
	public BIKE_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public BIKE_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public BIKE_STORE(SubOrganization subOrganization) {
	...
	public BIKE_STORE(SubjectOf subjectOf) {
	...
	public BIKE_STORE(Telephone telephone) {
	...
	public BIKE_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.BikeStore org) {
		setSeq(org.getSeq());
