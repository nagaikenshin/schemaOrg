...
public class FLIGHT_NUMBER implements Container.FlightNumber {
	...
	public FLIGHT_NUMBER(String string) {
		this(new TEXT(string));
	}

	public FLIGHT_NUMBER(Text text) {
