...
public class NUMBERED_POSITION implements Container.NumberedPosition {
	...
	public NUMBERED_POSITION(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public NUMBERED_POSITION(Float fl0at) {
	...
	public NUMBERED_POSITION(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public NUMBERED_POSITION(Integer integer) {
	...
	public NUMBERED_POSITION(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public NUMBERED_POSITION(Number number) {
	...
	public NUMBERED_POSITION(List<Float> fl0atList,
	...
	public void copy(Container.NumberedPosition org) {
