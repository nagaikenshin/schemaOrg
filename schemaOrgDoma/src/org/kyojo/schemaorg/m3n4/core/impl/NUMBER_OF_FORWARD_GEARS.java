...
public class NUMBER_OF_FORWARD_GEARS implements Container.NumberOfForwardGears {
	...
	public NUMBER_OF_FORWARD_GEARS(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public NUMBER_OF_FORWARD_GEARS(Float fl0at) {
	...
	public NUMBER_OF_FORWARD_GEARS(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public NUMBER_OF_FORWARD_GEARS(Integer integer) {
	...
	public NUMBER_OF_FORWARD_GEARS(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public NUMBER_OF_FORWARD_GEARS(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public NUMBER_OF_FORWARD_GEARS(List<Float> fl0atList,
