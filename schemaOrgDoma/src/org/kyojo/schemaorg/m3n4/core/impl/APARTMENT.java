...
public class APARTMENT implements Clazz.Apartment {
	...
	public APARTMENT(Long seq) {
		setSeq(seq);
	}

	public APARTMENT(String string) {
	...
	public APARTMENT(AdditionalProperty additionalProperty) {
	...
	public APARTMENT(AdditionalType additionalType) {
	...
	public APARTMENT(AggregateRating aggregateRating) {
	...
	public APARTMENT(AlternateName alternateName) {
	...
	public APARTMENT(AmenityFeature amenityFeature) {
	...
	public APARTMENT(BranchCode branchCode) {
	...
	public APARTMENT(ContainedInPlace containedInPlace) {
	...
	public APARTMENT(ContainsPlace containsPlace) {
	...
	public APARTMENT(Description description) {
	...
	public APARTMENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public APARTMENT(FaxNumber faxNumber) {
	...
	public APARTMENT(FloorSize floorSize) {
	...
	public APARTMENT(GeospatiallyContains geospatiallyContains) {
	...
	public APARTMENT(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public APARTMENT(GeospatiallyCovers geospatiallyCovers) {
	...
	public APARTMENT(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public APARTMENT(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public APARTMENT(GeospatiallyEquals geospatiallyEquals) {
	...
	public APARTMENT(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public APARTMENT(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public APARTMENT(GeospatiallyTouches geospatiallyTouches) {
	...
	public APARTMENT(GeospatiallyWithin geospatiallyWithin) {
	...
	public APARTMENT(GlobalLocationNumber globalLocationNumber) {
	...
	public APARTMENT(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public APARTMENT(Identifier identifier) {
	...
	public APARTMENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public APARTMENT(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public APARTMENT(MainEntityOfPage mainEntityOfPage) {
	...
	public APARTMENT(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public APARTMENT(NameFuzzy nameFuzzy) {
	...
	public APARTMENT(NameRuby nameRuby) {
	...
	public APARTMENT(NumberOfRooms numberOfRooms) {
	...
	public APARTMENT(Occupancy occupancy) {
	...
	public APARTMENT(OpeningHoursSpecification openingHoursSpecification) {
	...
	public APARTMENT(PermittedUsage permittedUsage) {
	...
	public APARTMENT(PetsAllowed petsAllowed) {
	...
	public APARTMENT(PotentialAction potentialAction) {
	...
	public APARTMENT(PublicAccess publicAccess) {
	...
	public APARTMENT(Review review) {
		setReview(review);
	}
	...
	public APARTMENT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public APARTMENT(SmokingAllowed smokingAllowed) {
	...
	public APARTMENT(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public APARTMENT(SubjectOf subjectOf) {
	...
	public APARTMENT(Telephone telephone) {
	...
	public void copy(Clazz.Apartment org) {
		setSeq(org.getSeq());
