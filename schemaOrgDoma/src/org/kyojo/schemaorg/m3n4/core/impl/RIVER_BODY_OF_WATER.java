...
public class RIVER_BODY_OF_WATER implements Clazz.RiverBodyOfWater {
	...
	public RIVER_BODY_OF_WATER() {
	}

	public RIVER_BODY_OF_WATER(Long seq) {
		setSeq(seq);
	}

	public RIVER_BODY_OF_WATER(String string) {
	...
	public RIVER_BODY_OF_WATER(AdditionalProperty additionalProperty) {
	...
	public RIVER_BODY_OF_WATER(AdditionalType additionalType) {
	...
	public RIVER_BODY_OF_WATER(Address address) {
		setAddress(address);
	}
	...
	public RIVER_BODY_OF_WATER(AggregateRating aggregateRating) {
	...
	public RIVER_BODY_OF_WATER(AlternateName alternateName) {
	...
	public RIVER_BODY_OF_WATER(AmenityFeature amenityFeature) {
	...
	public RIVER_BODY_OF_WATER(BranchCode branchCode) {
	...
	public RIVER_BODY_OF_WATER(ContainedInPlace containedInPlace) {
	...
	public RIVER_BODY_OF_WATER(ContainsPlace containsPlace) {
	...
	public RIVER_BODY_OF_WATER(Description description) {
	...
	public RIVER_BODY_OF_WATER(DisambiguatingDescription disambiguatingDescription) {
	...
	public RIVER_BODY_OF_WATER(Event event) {
		setEvent(event);
	}
	...
	public RIVER_BODY_OF_WATER(FaxNumber faxNumber) {
	...
	public RIVER_BODY_OF_WATER(Geo geo) {
		setGeo(geo);
	}
	...
	public RIVER_BODY_OF_WATER(GeospatiallyContains geospatiallyContains) {
	...
	public RIVER_BODY_OF_WATER(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public RIVER_BODY_OF_WATER(GeospatiallyCovers geospatiallyCovers) {
	...
	public RIVER_BODY_OF_WATER(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public RIVER_BODY_OF_WATER(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public RIVER_BODY_OF_WATER(GeospatiallyEquals geospatiallyEquals) {
	...
	public RIVER_BODY_OF_WATER(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public RIVER_BODY_OF_WATER(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public RIVER_BODY_OF_WATER(GeospatiallyTouches geospatiallyTouches) {
	...
	public RIVER_BODY_OF_WATER(GeospatiallyWithin geospatiallyWithin) {
	...
	public RIVER_BODY_OF_WATER(GlobalLocationNumber globalLocationNumber) {
	...
	public RIVER_BODY_OF_WATER(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public RIVER_BODY_OF_WATER(Identifier identifier) {
	...
	public RIVER_BODY_OF_WATER(Image image) {
		setImage(image);
	}
	...
	public RIVER_BODY_OF_WATER(IsAccessibleForFree isAccessibleForFree) {
	...
	public RIVER_BODY_OF_WATER(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public RIVER_BODY_OF_WATER(Logo logo) {
		setLogo(logo);
	}
	...
	public RIVER_BODY_OF_WATER(MainEntityOfPage mainEntityOfPage) {
	...
	public RIVER_BODY_OF_WATER(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public RIVER_BODY_OF_WATER(Name name) {
		setName(name);
	}
	...
	public RIVER_BODY_OF_WATER(NameFuzzy nameFuzzy) {
	...
	public RIVER_BODY_OF_WATER(NameRuby nameRuby) {
	...
	public RIVER_BODY_OF_WATER(OpeningHoursSpecification openingHoursSpecification) {
	...
	public RIVER_BODY_OF_WATER(Photo photo) {
		setPhoto(photo);
	}
	...
	public RIVER_BODY_OF_WATER(PotentialAction potentialAction) {
	...
	public RIVER_BODY_OF_WATER(PublicAccess publicAccess) {
	...
	public RIVER_BODY_OF_WATER(Review review) {
		setReview(review);
	}
	...
	public RIVER_BODY_OF_WATER(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RIVER_BODY_OF_WATER(SmokingAllowed smokingAllowed) {
	...
	public RIVER_BODY_OF_WATER(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public RIVER_BODY_OF_WATER(SubjectOf subjectOf) {
	...
	public RIVER_BODY_OF_WATER(Telephone telephone) {
	...
	public RIVER_BODY_OF_WATER(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.RiverBodyOfWater org) {
		setSeq(org.getSeq());
