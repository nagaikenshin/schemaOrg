...
public class PLACE implements Clazz.Place {
	...
	public PLACE(AdditionalProperty additionalProperty) {
	...
	public PLACE(AdditionalType additionalType) {
	...
	public PLACE(AggregateRating aggregateRating) {
	...
	public PLACE(AlternateName alternateName) {
	...
	public PLACE(AmenityFeature amenityFeature) {
	...
	public PLACE(BranchCode branchCode) {
	...
	public PLACE(ContainedInPlace containedInPlace) {
	...
	public PLACE(ContainsPlace containsPlace) {
	...
	public PLACE(Description description) {
	...
	public PLACE(DisambiguatingDescription disambiguatingDescription) {
	...
	public PLACE(FaxNumber faxNumber) {
	...
	public PLACE(GeospatiallyContains geospatiallyContains) {
	...
	public PLACE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public PLACE(GeospatiallyCovers geospatiallyCovers) {
	...
	public PLACE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public PLACE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public PLACE(GeospatiallyEquals geospatiallyEquals) {
	...
	public PLACE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public PLACE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public PLACE(GeospatiallyTouches geospatiallyTouches) {
	...
	public PLACE(GeospatiallyWithin geospatiallyWithin) {
	...
	public PLACE(GlobalLocationNumber globalLocationNumber) {
	...
	public PLACE(Identifier identifier) {
	...
	public PLACE(IsAccessibleForFree isAccessibleForFree) {
	...
	public PLACE(MainEntityOfPage mainEntityOfPage) {
	...
	public PLACE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public PLACE(NameFuzzy nameFuzzy) {
	...
	public PLACE(NameRuby nameRuby) {
	...
	public PLACE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public PLACE(PotentialAction potentialAction) {
	...
	public PLACE(PublicAccess publicAccess) {
	...
	public PLACE(SmokingAllowed smokingAllowed) {
	...
	public PLACE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public PLACE(SubjectOf subjectOf) {
	...
	public PLACE(Telephone telephone) {
	...
	public void copy(Clazz.Place org) {
		setSeq(org.getSeq());
