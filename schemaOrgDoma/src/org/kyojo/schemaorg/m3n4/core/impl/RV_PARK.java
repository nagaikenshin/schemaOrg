...
public class RV_PARK implements Clazz.RVPark {
	...
	public RV_PARK(Long seq) {
		setSeq(seq);
	}

	public RV_PARK(String string) {
	...
	public RV_PARK(AdditionalProperty additionalProperty) {
	...
	public RV_PARK(AdditionalType additionalType) {
	...
	public RV_PARK(Address address) {
		setAddress(address);
	}
	...
	public RV_PARK(AggregateRating aggregateRating) {
	...
	public RV_PARK(AlternateName alternateName) {
	...
	public RV_PARK(AmenityFeature amenityFeature) {
	...
	public RV_PARK(BranchCode branchCode) {
	...
	public RV_PARK(ContainedInPlace containedInPlace) {
	...
	public RV_PARK(ContainsPlace containsPlace) {
	...
	public RV_PARK(Description description) {
	...
	public RV_PARK(DisambiguatingDescription disambiguatingDescription) {
	...
	public RV_PARK(FaxNumber faxNumber) {
	...
	public RV_PARK(GeospatiallyContains geospatiallyContains) {
	...
	public RV_PARK(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public RV_PARK(GeospatiallyCovers geospatiallyCovers) {
	...
	public RV_PARK(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public RV_PARK(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public RV_PARK(GeospatiallyEquals geospatiallyEquals) {
	...
	public RV_PARK(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public RV_PARK(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public RV_PARK(GeospatiallyTouches geospatiallyTouches) {
	...
	public RV_PARK(GeospatiallyWithin geospatiallyWithin) {
	...
	public RV_PARK(GlobalLocationNumber globalLocationNumber) {
	...
	public RV_PARK(Identifier identifier) {
	...
	public RV_PARK(IsAccessibleForFree isAccessibleForFree) {
	...
	public RV_PARK(MainEntityOfPage mainEntityOfPage) {
	...
	public RV_PARK(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public RV_PARK(NameFuzzy nameFuzzy) {
	...
	public RV_PARK(NameRuby nameRuby) {
	...
	public RV_PARK(OpeningHours openingHours) {
	...
	public RV_PARK(OpeningHoursSpecification openingHoursSpecification) {
	...
	public RV_PARK(PotentialAction potentialAction) {
	...
	public RV_PARK(PublicAccess publicAccess) {
	...
	public RV_PARK(SmokingAllowed smokingAllowed) {
	...
	public RV_PARK(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public RV_PARK(SubjectOf subjectOf) {
	...
	public RV_PARK(Telephone telephone) {
	...
	public void copy(Clazz.RVPark org) {
		setSeq(org.getSeq());
