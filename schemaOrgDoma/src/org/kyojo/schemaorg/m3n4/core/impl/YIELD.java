...
public class YIELD implements Container.Yield {
	...
	public YIELD(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public YIELD(QuantitativeValue quantitativeValue) {
	...
	public YIELD(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public YIELD(String string) {
		this(new TEXT(string));
	}

	public YIELD(Text text) {
	...
	public YIELD(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.Yield org) {
