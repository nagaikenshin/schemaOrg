...
public class AUTO_BODY_SHOP implements Clazz.AutoBodyShop {
	...
	public AUTO_BODY_SHOP() {
	}

	public AUTO_BODY_SHOP(Long seq) {
		setSeq(seq);
	}

	public AUTO_BODY_SHOP(String string) {
	...
	public AUTO_BODY_SHOP(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public AUTO_BODY_SHOP(AdditionalProperty additionalProperty) {
	...
	public AUTO_BODY_SHOP(AdditionalType additionalType) {
	...
	public AUTO_BODY_SHOP(Address address) {
		setAddress(address);
	}
	...
	public AUTO_BODY_SHOP(AggregateRating aggregateRating) {
	...
	public AUTO_BODY_SHOP(AlternateName alternateName) {
	...
	public AUTO_BODY_SHOP(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public AUTO_BODY_SHOP(AmenityFeature amenityFeature) {
	...
	public AUTO_BODY_SHOP(AreaServed areaServed) {
	...
	public AUTO_BODY_SHOP(Award award) {
		setAward(award);
	}
	...
	public AUTO_BODY_SHOP(BranchCode branchCode) {
	...
	public AUTO_BODY_SHOP(Brand brand) {
		setBrand(brand);
	}
	...
	public AUTO_BODY_SHOP(ContactPoint contactPoint) {
	...
	public AUTO_BODY_SHOP(ContainedInPlace containedInPlace) {
	...
	public AUTO_BODY_SHOP(ContainsPlace containsPlace) {
	...
	public AUTO_BODY_SHOP(CorrectionsPolicy correctionsPolicy) {
	...
	public AUTO_BODY_SHOP(CurrenciesAccepted currenciesAccepted) {
	...
	public AUTO_BODY_SHOP(Department department) {
	...
	public AUTO_BODY_SHOP(Description description) {
	...
	public AUTO_BODY_SHOP(DisambiguatingDescription disambiguatingDescription) {
	...
	public AUTO_BODY_SHOP(DissolutionDate dissolutionDate) {
	...
	public AUTO_BODY_SHOP(DiversityPolicy diversityPolicy) {
	...
	public AUTO_BODY_SHOP(DiversityStaffingReport diversityStaffingReport) {
	...
	public AUTO_BODY_SHOP(Duns duns) {
		setDuns(duns);
	}
	...
	public AUTO_BODY_SHOP(Email email) {
		setEmail(email);
	}
	...
	public AUTO_BODY_SHOP(Employee employee) {
	...
	public AUTO_BODY_SHOP(EthicsPolicy ethicsPolicy) {
	...
	public AUTO_BODY_SHOP(Event event) {
		setEvent(event);
	}
	...
	public AUTO_BODY_SHOP(FaxNumber faxNumber) {
	...
	public AUTO_BODY_SHOP(Founder founder) {
		setFounder(founder);
	}
	...
	public AUTO_BODY_SHOP(FoundingDate foundingDate) {
	...
	public AUTO_BODY_SHOP(FoundingLocation foundingLocation) {
	...
	public AUTO_BODY_SHOP(Funder funder) {
		setFunder(funder);
	}
	...
	public AUTO_BODY_SHOP(GeospatiallyContains geospatiallyContains) {
	...
	public AUTO_BODY_SHOP(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public AUTO_BODY_SHOP(GeospatiallyCovers geospatiallyCovers) {
	...
	public AUTO_BODY_SHOP(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public AUTO_BODY_SHOP(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public AUTO_BODY_SHOP(GeospatiallyEquals geospatiallyEquals) {
	...
	public AUTO_BODY_SHOP(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public AUTO_BODY_SHOP(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public AUTO_BODY_SHOP(GeospatiallyTouches geospatiallyTouches) {
	...
	public AUTO_BODY_SHOP(GeospatiallyWithin geospatiallyWithin) {
	...
	public AUTO_BODY_SHOP(GlobalLocationNumber globalLocationNumber) {
	...
	public AUTO_BODY_SHOP(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public AUTO_BODY_SHOP(HasOfferCatalog hasOfferCatalog) {
	...
	public AUTO_BODY_SHOP(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public AUTO_BODY_SHOP(Identifier identifier) {
	...
	public AUTO_BODY_SHOP(Image image) {
		setImage(image);
	}
	...
	public AUTO_BODY_SHOP(IsAccessibleForFree isAccessibleForFree) {
	...
	public AUTO_BODY_SHOP(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public AUTO_BODY_SHOP(KnowsAbout knowsAbout) {
	...
	public AUTO_BODY_SHOP(KnowsLanguage knowsLanguage) {
	...
	public AUTO_BODY_SHOP(LegalName legalName) {
	...
	public AUTO_BODY_SHOP(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public AUTO_BODY_SHOP(Location location) {
	...
	public AUTO_BODY_SHOP(Logo logo) {
		setLogo(logo);
	}
	...
	public AUTO_BODY_SHOP(MainEntityOfPage mainEntityOfPage) {
	...
	public AUTO_BODY_SHOP(MakesOffer makesOffer) {
	...
	public AUTO_BODY_SHOP(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public AUTO_BODY_SHOP(Member member) {
		setMember(member);
	}
	...
	public AUTO_BODY_SHOP(MemberOf memberOf) {
	...
	public AUTO_BODY_SHOP(Naics naics) {
		setNaics(naics);
	}
	...
	public AUTO_BODY_SHOP(Name name) {
		setName(name);
	}
	...
	public AUTO_BODY_SHOP(NameFuzzy nameFuzzy) {
	...
	public AUTO_BODY_SHOP(NameRuby nameRuby) {
	...
	public AUTO_BODY_SHOP(NumberOfEmployees numberOfEmployees) {
	...
	public AUTO_BODY_SHOP(OpeningHours openingHours) {
	...
	public AUTO_BODY_SHOP(OpeningHoursSpecification openingHoursSpecification) {
	...
	public AUTO_BODY_SHOP(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public AUTO_BODY_SHOP(Owns owns) {
		setOwns(owns);
	}
	...
	public AUTO_BODY_SHOP(ParentOrganization parentOrganization) {
	...
	public AUTO_BODY_SHOP(PaymentAccepted paymentAccepted) {
	...
	public AUTO_BODY_SHOP(Photo photo) {
		setPhoto(photo);
	}
	...
	public AUTO_BODY_SHOP(PotentialAction potentialAction) {
	...
	public AUTO_BODY_SHOP(PriceRange priceRange) {
	...
	public AUTO_BODY_SHOP(PublicAccess publicAccess) {
	...
	public AUTO_BODY_SHOP(PublishingPrinciples publishingPrinciples) {
	...
	public AUTO_BODY_SHOP(Review review) {
		setReview(review);
	}
	...
	public AUTO_BODY_SHOP(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public AUTO_BODY_SHOP(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public AUTO_BODY_SHOP(SmokingAllowed smokingAllowed) {
	...
	public AUTO_BODY_SHOP(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public AUTO_BODY_SHOP(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public AUTO_BODY_SHOP(SubOrganization subOrganization) {
	...
	public AUTO_BODY_SHOP(SubjectOf subjectOf) {
	...
	public AUTO_BODY_SHOP(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public AUTO_BODY_SHOP(Telephone telephone) {
	...
	public AUTO_BODY_SHOP(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public AUTO_BODY_SHOP(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.AutoBodyShop org) {
		setSeq(org.getSeq());
