...
public class WATERFALL implements Clazz.Waterfall {
	...
	public WATERFALL(Long seq) {
		setSeq(seq);
	}

	public WATERFALL(String string) {
	...
	public WATERFALL(AdditionalProperty additionalProperty) {
	...
	public WATERFALL(AdditionalType additionalType) {
	...
	public WATERFALL(Address address) {
		setAddress(address);
	}
	...
	public WATERFALL(AggregateRating aggregateRating) {
	...
	public WATERFALL(AlternateName alternateName) {
	...
	public WATERFALL(AmenityFeature amenityFeature) {
	...
	public WATERFALL(BranchCode branchCode) {
	...
	public WATERFALL(ContainedInPlace containedInPlace) {
	...
	public WATERFALL(ContainsPlace containsPlace) {
	...
	public WATERFALL(Description description) {
	...
	public WATERFALL(DisambiguatingDescription disambiguatingDescription) {
	...
	public WATERFALL(FaxNumber faxNumber) {
	...
	public WATERFALL(GeospatiallyContains geospatiallyContains) {
	...
	public WATERFALL(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public WATERFALL(GeospatiallyCovers geospatiallyCovers) {
	...
	public WATERFALL(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public WATERFALL(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public WATERFALL(GeospatiallyEquals geospatiallyEquals) {
	...
	public WATERFALL(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public WATERFALL(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public WATERFALL(GeospatiallyTouches geospatiallyTouches) {
	...
	public WATERFALL(GeospatiallyWithin geospatiallyWithin) {
	...
	public WATERFALL(GlobalLocationNumber globalLocationNumber) {
	...
	public WATERFALL(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public WATERFALL(Identifier identifier) {
	...
	public WATERFALL(IsAccessibleForFree isAccessibleForFree) {
	...
	public WATERFALL(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public WATERFALL(MainEntityOfPage mainEntityOfPage) {
	...
	public WATERFALL(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public WATERFALL(NameFuzzy nameFuzzy) {
	...
	public WATERFALL(NameRuby nameRuby) {
	...
	public WATERFALL(OpeningHoursSpecification openingHoursSpecification) {
	...
	public WATERFALL(PotentialAction potentialAction) {
	...
	public WATERFALL(PublicAccess publicAccess) {
	...
	public WATERFALL(Review review) {
		setReview(review);
	}
	...
	public WATERFALL(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public WATERFALL(SmokingAllowed smokingAllowed) {
	...
	public WATERFALL(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public WATERFALL(SubjectOf subjectOf) {
	...
	public WATERFALL(Telephone telephone) {
	...
	public void copy(Clazz.Waterfall org) {
		setSeq(org.getSeq());
