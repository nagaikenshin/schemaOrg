...
public class SPORTS_CLUB implements Clazz.SportsClub {
	...
	public SPORTS_CLUB(Long seq) {
		setSeq(seq);
	}

	public SPORTS_CLUB(String string) {
	...
	public SPORTS_CLUB(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public SPORTS_CLUB(AdditionalProperty additionalProperty) {
	...
	public SPORTS_CLUB(AdditionalType additionalType) {
	...
	public SPORTS_CLUB(Address address) {
		setAddress(address);
	}
	...
	public SPORTS_CLUB(AggregateRating aggregateRating) {
	...
	public SPORTS_CLUB(AlternateName alternateName) {
	...
	public SPORTS_CLUB(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public SPORTS_CLUB(AmenityFeature amenityFeature) {
	...
	public SPORTS_CLUB(AreaServed areaServed) {
	...
	public SPORTS_CLUB(Award award) {
		setAward(award);
	}
	...
	public SPORTS_CLUB(BranchCode branchCode) {
	...
	public SPORTS_CLUB(Brand brand) {
		setBrand(brand);
	}
	...
	public SPORTS_CLUB(ContactPoint contactPoint) {
	...
	public SPORTS_CLUB(ContainedInPlace containedInPlace) {
	...
	public SPORTS_CLUB(ContainsPlace containsPlace) {
	...
	public SPORTS_CLUB(CorrectionsPolicy correctionsPolicy) {
	...
	public SPORTS_CLUB(CurrenciesAccepted currenciesAccepted) {
	...
	public SPORTS_CLUB(Department department) {
	...
	public SPORTS_CLUB(Description description) {
	...
	public SPORTS_CLUB(DisambiguatingDescription disambiguatingDescription) {
	...
	public SPORTS_CLUB(DissolutionDate dissolutionDate) {
	...
	public SPORTS_CLUB(DiversityPolicy diversityPolicy) {
	...
	public SPORTS_CLUB(DiversityStaffingReport diversityStaffingReport) {
	...
	public SPORTS_CLUB(Email email) {
		setEmail(email);
	}
	...
	public SPORTS_CLUB(Employee employee) {
	...
	public SPORTS_CLUB(EthicsPolicy ethicsPolicy) {
	...
	public SPORTS_CLUB(Event event) {
		setEvent(event);
	}
	...
	public SPORTS_CLUB(FaxNumber faxNumber) {
	...
	public SPORTS_CLUB(Founder founder) {
		setFounder(founder);
	}
	...
	public SPORTS_CLUB(FoundingDate foundingDate) {
	...
	public SPORTS_CLUB(FoundingLocation foundingLocation) {
	...
	public SPORTS_CLUB(Funder funder) {
		setFunder(funder);
	}
	...
	public SPORTS_CLUB(GeospatiallyContains geospatiallyContains) {
	...
	public SPORTS_CLUB(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public SPORTS_CLUB(GeospatiallyCovers geospatiallyCovers) {
	...
	public SPORTS_CLUB(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public SPORTS_CLUB(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public SPORTS_CLUB(GeospatiallyEquals geospatiallyEquals) {
	...
	public SPORTS_CLUB(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public SPORTS_CLUB(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public SPORTS_CLUB(GeospatiallyTouches geospatiallyTouches) {
	...
	public SPORTS_CLUB(GeospatiallyWithin geospatiallyWithin) {
	...
	public SPORTS_CLUB(GlobalLocationNumber globalLocationNumber) {
	...
	public SPORTS_CLUB(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public SPORTS_CLUB(HasOfferCatalog hasOfferCatalog) {
	...
	public SPORTS_CLUB(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public SPORTS_CLUB(Identifier identifier) {
	...
	public SPORTS_CLUB(Image image) {
		setImage(image);
	}
	...
	public SPORTS_CLUB(IsAccessibleForFree isAccessibleForFree) {
	...
	public SPORTS_CLUB(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public SPORTS_CLUB(KnowsAbout knowsAbout) {
	...
	public SPORTS_CLUB(KnowsLanguage knowsLanguage) {
	...
	public SPORTS_CLUB(LegalName legalName) {
	...
	public SPORTS_CLUB(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public SPORTS_CLUB(Location location) {
	...
	public SPORTS_CLUB(MainEntityOfPage mainEntityOfPage) {
	...
	public SPORTS_CLUB(MakesOffer makesOffer) {
	...
	public SPORTS_CLUB(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public SPORTS_CLUB(Member member) {
		setMember(member);
	}
	...
	public SPORTS_CLUB(MemberOf memberOf) {
	...
	public SPORTS_CLUB(Naics naics) {
		setNaics(naics);
	}
	...
	public SPORTS_CLUB(NameFuzzy nameFuzzy) {
	...
	public SPORTS_CLUB(NameRuby nameRuby) {
	...
	public SPORTS_CLUB(NumberOfEmployees numberOfEmployees) {
	...
	public SPORTS_CLUB(OpeningHours openingHours) {
	...
	public SPORTS_CLUB(OpeningHoursSpecification openingHoursSpecification) {
	...
	public SPORTS_CLUB(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public SPORTS_CLUB(ParentOrganization parentOrganization) {
	...
	public SPORTS_CLUB(PaymentAccepted paymentAccepted) {
	...
	public SPORTS_CLUB(Photo photo) {
		setPhoto(photo);
	}
	...
	public SPORTS_CLUB(PotentialAction potentialAction) {
	...
	public SPORTS_CLUB(PriceRange priceRange) {
	...
	public SPORTS_CLUB(PublicAccess publicAccess) {
	...
	public SPORTS_CLUB(PublishingPrinciples publishingPrinciples) {
	...
	public SPORTS_CLUB(Review review) {
		setReview(review);
	}
	...
	public SPORTS_CLUB(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SPORTS_CLUB(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public SPORTS_CLUB(SmokingAllowed smokingAllowed) {
	...
	public SPORTS_CLUB(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public SPORTS_CLUB(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public SPORTS_CLUB(SubOrganization subOrganization) {
	...
	public SPORTS_CLUB(SubjectOf subjectOf) {
	...
	public SPORTS_CLUB(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public SPORTS_CLUB(Telephone telephone) {
	...
	public SPORTS_CLUB(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public SPORTS_CLUB(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.SportsClub org) {
		setSeq(org.getSeq());
