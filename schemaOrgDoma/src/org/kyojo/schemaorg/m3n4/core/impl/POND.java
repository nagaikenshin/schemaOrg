...
public class POND implements Clazz.Pond {
	...
	public POND(Long seq) {
		setSeq(seq);
	}

	public POND(String string) {
	...
	public POND(AdditionalProperty additionalProperty) {
	...
	public POND(AdditionalType additionalType) {
	...
	public POND(AggregateRating aggregateRating) {
	...
	public POND(AlternateName alternateName) {
	...
	public POND(AmenityFeature amenityFeature) {
	...
	public POND(BranchCode branchCode) {
	...
	public POND(ContainedInPlace containedInPlace) {
	...
	public POND(ContainsPlace containsPlace) {
	...
	public POND(Description description) {
	...
	public POND(DisambiguatingDescription disambiguatingDescription) {
	...
	public POND(FaxNumber faxNumber) {
	...
	public POND(GeospatiallyContains geospatiallyContains) {
	...
	public POND(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public POND(GeospatiallyCovers geospatiallyCovers) {
	...
	public POND(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public POND(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public POND(GeospatiallyEquals geospatiallyEquals) {
	...
	public POND(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public POND(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public POND(GeospatiallyTouches geospatiallyTouches) {
	...
	public POND(GeospatiallyWithin geospatiallyWithin) {
	...
	public POND(GlobalLocationNumber globalLocationNumber) {
	...
	public POND(Identifier identifier) {
	...
	public POND(IsAccessibleForFree isAccessibleForFree) {
	...
	public POND(MainEntityOfPage mainEntityOfPage) {
	...
	public POND(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public POND(NameFuzzy nameFuzzy) {
	...
	public POND(OpeningHoursSpecification openingHoursSpecification) {
	...
	public POND(PotentialAction potentialAction) {
	...
	public POND(PublicAccess publicAccess) {
	...
	public POND(SmokingAllowed smokingAllowed) {
	...
	public POND(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public POND(SubjectOf subjectOf) {
	...
	public POND(Telephone telephone) {
	...
	public void copy(Clazz.Pond org) {
		setSeq(org.getSeq());
