...
public class DRIVE_WHEEL_CONFIGURATION_VALUE implements Clazz.DriveWheelConfigurationValue {
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE() {
	}

	public DRIVE_WHEEL_CONFIGURATION_VALUE(Long seq) {
		setSeq(seq);
	}

	public DRIVE_WHEEL_CONFIGURATION_VALUE(String string) {
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE(AdditionalProperty additionalProperty) {
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE(AdditionalType additionalType) {
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE(AlternateName alternateName) {
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE(Description description) {
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE(DisambiguatingDescription disambiguatingDescription) {
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE(Equal equal) {
		setEqual(equal);
	}
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE(Greater greater) {
		setGreater(greater);
	}
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE(GreaterOrEqual greaterOrEqual) {
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE(Identifier identifier) {
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE(Image image) {
		setImage(image);
	}
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE(Lesser lesser) {
		setLesser(lesser);
	}
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE(LesserOrEqual lesserOrEqual) {
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE(MainEntityOfPage mainEntityOfPage) {
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE(Name name) {
		setName(name);
	}
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE(NameFuzzy nameFuzzy) {
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE(NameRuby nameRuby) {
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE(NonEqual nonEqual) {
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE(PotentialAction potentialAction) {
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE(SubjectOf subjectOf) {
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE(SupersededBy supersededBy) {
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE(Url url) {
		setUrl(url);
	}
	...
	public DRIVE_WHEEL_CONFIGURATION_VALUE(ValueReference valueReference) {
	...
	public void copy(Clazz.DriveWheelConfigurationValue org) {
		setSeq(org.getSeq());
