...
public class STEP_VALUE implements Container.StepValue {
	...
	public STEP_VALUE(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public STEP_VALUE(Float fl0at) {
	...
	public STEP_VALUE(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public STEP_VALUE(Integer integer) {
	...
	public STEP_VALUE(List<Float> fl0atList,
	...
	public void copy(Container.StepValue org) {
