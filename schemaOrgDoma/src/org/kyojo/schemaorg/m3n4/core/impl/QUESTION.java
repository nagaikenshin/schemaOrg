...
public class QUESTION implements Clazz.Question, Container.Question {
	...
	public QUESTION(AggregateRating aggregateRating) {
	...
	public QUESTION(Audience audience) {
	...
	public QUESTION(Comment comment) {
		setComment(comment);
	}
	...
	public QUESTION(Long seq,
			...
			List<Clazz.Question> questionList,
