...
public class TOURIST_INFORMATION_CENTER implements Clazz.TouristInformationCenter {
	...
	public TOURIST_INFORMATION_CENTER() {
	}

	public TOURIST_INFORMATION_CENTER(Long seq) {
		setSeq(seq);
	}

	public TOURIST_INFORMATION_CENTER(String string) {
	...
	public TOURIST_INFORMATION_CENTER(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public TOURIST_INFORMATION_CENTER(AdditionalProperty additionalProperty) {
	...
	public TOURIST_INFORMATION_CENTER(AdditionalType additionalType) {
	...
	public TOURIST_INFORMATION_CENTER(Address address) {
		setAddress(address);
	}
	...
	public TOURIST_INFORMATION_CENTER(AggregateRating aggregateRating) {
	...
	public TOURIST_INFORMATION_CENTER(AlternateName alternateName) {
	...
	public TOURIST_INFORMATION_CENTER(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public TOURIST_INFORMATION_CENTER(AmenityFeature amenityFeature) {
	...
	public TOURIST_INFORMATION_CENTER(AreaServed areaServed) {
	...
	public TOURIST_INFORMATION_CENTER(Award award) {
		setAward(award);
	}
	...
	public TOURIST_INFORMATION_CENTER(BranchCode branchCode) {
	...
	public TOURIST_INFORMATION_CENTER(Brand brand) {
		setBrand(brand);
	}
	...
	public TOURIST_INFORMATION_CENTER(ContactPoint contactPoint) {
	...
	public TOURIST_INFORMATION_CENTER(ContainedInPlace containedInPlace) {
	...
	public TOURIST_INFORMATION_CENTER(ContainsPlace containsPlace) {
	...
	public TOURIST_INFORMATION_CENTER(CorrectionsPolicy correctionsPolicy) {
	...
	public TOURIST_INFORMATION_CENTER(CurrenciesAccepted currenciesAccepted) {
	...
	public TOURIST_INFORMATION_CENTER(Department department) {
	...
	public TOURIST_INFORMATION_CENTER(Description description) {
	...
	public TOURIST_INFORMATION_CENTER(DisambiguatingDescription disambiguatingDescription) {
	...
	public TOURIST_INFORMATION_CENTER(DissolutionDate dissolutionDate) {
	...
	public TOURIST_INFORMATION_CENTER(DiversityPolicy diversityPolicy) {
	...
	public TOURIST_INFORMATION_CENTER(DiversityStaffingReport diversityStaffingReport) {
	...
	public TOURIST_INFORMATION_CENTER(Duns duns) {
		setDuns(duns);
	}
	...
	public TOURIST_INFORMATION_CENTER(Email email) {
		setEmail(email);
	}
	...
	public TOURIST_INFORMATION_CENTER(Employee employee) {
	...
	public TOURIST_INFORMATION_CENTER(EthicsPolicy ethicsPolicy) {
	...
	public TOURIST_INFORMATION_CENTER(Event event) {
		setEvent(event);
	}
	...
	public TOURIST_INFORMATION_CENTER(FaxNumber faxNumber) {
	...
	public TOURIST_INFORMATION_CENTER(Founder founder) {
		setFounder(founder);
	}
	...
	public TOURIST_INFORMATION_CENTER(FoundingDate foundingDate) {
	...
	public TOURIST_INFORMATION_CENTER(FoundingLocation foundingLocation) {
	...
	public TOURIST_INFORMATION_CENTER(Funder funder) {
		setFunder(funder);
	}
	...
	public TOURIST_INFORMATION_CENTER(Geo geo) {
		setGeo(geo);
	}
	...
	public TOURIST_INFORMATION_CENTER(GeospatiallyContains geospatiallyContains) {
	...
	public TOURIST_INFORMATION_CENTER(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public TOURIST_INFORMATION_CENTER(GeospatiallyCovers geospatiallyCovers) {
	...
	public TOURIST_INFORMATION_CENTER(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public TOURIST_INFORMATION_CENTER(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public TOURIST_INFORMATION_CENTER(GeospatiallyEquals geospatiallyEquals) {
	...
	public TOURIST_INFORMATION_CENTER(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public TOURIST_INFORMATION_CENTER(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public TOURIST_INFORMATION_CENTER(GeospatiallyTouches geospatiallyTouches) {
	...
	public TOURIST_INFORMATION_CENTER(GeospatiallyWithin geospatiallyWithin) {
	...
	public TOURIST_INFORMATION_CENTER(GlobalLocationNumber globalLocationNumber) {
	...
	public TOURIST_INFORMATION_CENTER(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public TOURIST_INFORMATION_CENTER(HasOfferCatalog hasOfferCatalog) {
	...
	public TOURIST_INFORMATION_CENTER(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public TOURIST_INFORMATION_CENTER(Identifier identifier) {
	...
	public TOURIST_INFORMATION_CENTER(Image image) {
		setImage(image);
	}
	...
	public TOURIST_INFORMATION_CENTER(IsAccessibleForFree isAccessibleForFree) {
	...
	public TOURIST_INFORMATION_CENTER(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public TOURIST_INFORMATION_CENTER(KnowsAbout knowsAbout) {
	...
	public TOURIST_INFORMATION_CENTER(KnowsLanguage knowsLanguage) {
	...
	public TOURIST_INFORMATION_CENTER(LegalName legalName) {
	...
	public TOURIST_INFORMATION_CENTER(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public TOURIST_INFORMATION_CENTER(Location location) {
	...
	public TOURIST_INFORMATION_CENTER(Logo logo) {
		setLogo(logo);
	}
	...
	public TOURIST_INFORMATION_CENTER(MainEntityOfPage mainEntityOfPage) {
	...
	public TOURIST_INFORMATION_CENTER(MakesOffer makesOffer) {
	...
	public TOURIST_INFORMATION_CENTER(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public TOURIST_INFORMATION_CENTER(Member member) {
		setMember(member);
	}
	...
	public TOURIST_INFORMATION_CENTER(MemberOf memberOf) {
	...
	public TOURIST_INFORMATION_CENTER(Naics naics) {
		setNaics(naics);
	}
	...
	public TOURIST_INFORMATION_CENTER(Name name) {
		setName(name);
	}
	...
	public TOURIST_INFORMATION_CENTER(NameFuzzy nameFuzzy) {
	...
	public TOURIST_INFORMATION_CENTER(NameRuby nameRuby) {
	...
	public TOURIST_INFORMATION_CENTER(NumberOfEmployees numberOfEmployees) {
	...
	public TOURIST_INFORMATION_CENTER(OpeningHours openingHours) {
	...
	public TOURIST_INFORMATION_CENTER(OpeningHoursSpecification openingHoursSpecification) {
	...
	public TOURIST_INFORMATION_CENTER(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public TOURIST_INFORMATION_CENTER(Owns owns) {
		setOwns(owns);
	}
	...
	public TOURIST_INFORMATION_CENTER(ParentOrganization parentOrganization) {
	...
	public TOURIST_INFORMATION_CENTER(PaymentAccepted paymentAccepted) {
	...
	public TOURIST_INFORMATION_CENTER(Photo photo) {
		setPhoto(photo);
	}
	...
	public TOURIST_INFORMATION_CENTER(PotentialAction potentialAction) {
	...
	public TOURIST_INFORMATION_CENTER(PriceRange priceRange) {
	...
	public TOURIST_INFORMATION_CENTER(PublicAccess publicAccess) {
	...
	public TOURIST_INFORMATION_CENTER(PublishingPrinciples publishingPrinciples) {
	...
	public TOURIST_INFORMATION_CENTER(Review review) {
		setReview(review);
	}
	...
	public TOURIST_INFORMATION_CENTER(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TOURIST_INFORMATION_CENTER(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public TOURIST_INFORMATION_CENTER(SmokingAllowed smokingAllowed) {
	...
	public TOURIST_INFORMATION_CENTER(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public TOURIST_INFORMATION_CENTER(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public TOURIST_INFORMATION_CENTER(SubOrganization subOrganization) {
	...
	public TOURIST_INFORMATION_CENTER(SubjectOf subjectOf) {
	...
	public TOURIST_INFORMATION_CENTER(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public TOURIST_INFORMATION_CENTER(Telephone telephone) {
	...
	public TOURIST_INFORMATION_CENTER(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public TOURIST_INFORMATION_CENTER(Url url) {
		setUrl(url);
	}
	...
	public TOURIST_INFORMATION_CENTER(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.TouristInformationCenter org) {
		setSeq(org.getSeq());
