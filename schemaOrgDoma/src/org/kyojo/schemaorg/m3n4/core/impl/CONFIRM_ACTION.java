...
public class CONFIRM_ACTION implements Clazz.ConfirmAction {
	...
	public CONFIRM_ACTION(Long seq) {
		setSeq(seq);
	}

	public CONFIRM_ACTION(String string) {
	...
	public CONFIRM_ACTION(About about) {
		setAbout(about);
	}
	...
	public CONFIRM_ACTION(ActionStatus actionStatus) {
	...
	public CONFIRM_ACTION(AdditionalType additionalType) {
	...
	public CONFIRM_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public CONFIRM_ACTION(AlternateName alternateName) {
	...
	public CONFIRM_ACTION(Description description) {
	...
	public CONFIRM_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public CONFIRM_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public CONFIRM_ACTION(Error error) {
		setError(error);
	}
	...
	public CONFIRM_ACTION(Event event) {
		setEvent(event);
	}
	...
	public CONFIRM_ACTION(Identifier identifier) {
	...
	public CONFIRM_ACTION(Image image) {
		setImage(image);
	}
	...
	public CONFIRM_ACTION(InLanguage inLanguage) {
	...
	public CONFIRM_ACTION(Instrument instrument) {
	...
	public CONFIRM_ACTION(Location location) {
	...
	public CONFIRM_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public CONFIRM_ACTION(Name name) {
		setName(name);
	}
	...
	public CONFIRM_ACTION(NameFuzzy nameFuzzy) {
	...
	public CONFIRM_ACTION(NameRuby nameRuby) {
	...
	public CONFIRM_ACTION(Object object) {
		setObject(object);
	}
	...
	public CONFIRM_ACTION(Participant participant) {
	...
	public CONFIRM_ACTION(PotentialAction potentialAction) {
	...
	public CONFIRM_ACTION(Recipient recipient) {
	...
	public CONFIRM_ACTION(Result result) {
		setResult(result);
	}
	...
	public CONFIRM_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CONFIRM_ACTION(StartTime startTime) {
	...
	public CONFIRM_ACTION(SubjectOf subjectOf) {
	...
	public CONFIRM_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.ConfirmAction org) {
		setSeq(org.getSeq());
