...
public class HAS_PART implements Container.HasPart {
	...
	public HAS_PART(BusTrip busTrip) {
	...
	public HAS_PART(TouristTrip touristTrip) {
	...
	public HAS_PART(TrainTrip trainTrip) {
