...
public class EMBASSY implements Clazz.Embassy {
	...
	public EMBASSY(Long seq) {
		setSeq(seq);
	}

	public EMBASSY(String string) {
	...
	public EMBASSY(AdditionalProperty additionalProperty) {
	...
	public EMBASSY(AdditionalType additionalType) {
	...
	public EMBASSY(Address address) {
		setAddress(address);
	}
	...
	public EMBASSY(AggregateRating aggregateRating) {
	...
	public EMBASSY(AlternateName alternateName) {
	...
	public EMBASSY(AmenityFeature amenityFeature) {
	...
	public EMBASSY(BranchCode branchCode) {
	...
	public EMBASSY(ContainedInPlace containedInPlace) {
	...
	public EMBASSY(ContainsPlace containsPlace) {
	...
	public EMBASSY(Description description) {
	...
	public EMBASSY(DisambiguatingDescription disambiguatingDescription) {
	...
	public EMBASSY(FaxNumber faxNumber) {
	...
	public EMBASSY(GeospatiallyContains geospatiallyContains) {
	...
	public EMBASSY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public EMBASSY(GeospatiallyCovers geospatiallyCovers) {
	...
	public EMBASSY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public EMBASSY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public EMBASSY(GeospatiallyEquals geospatiallyEquals) {
	...
	public EMBASSY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public EMBASSY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public EMBASSY(GeospatiallyTouches geospatiallyTouches) {
	...
	public EMBASSY(GeospatiallyWithin geospatiallyWithin) {
	...
	public EMBASSY(GlobalLocationNumber globalLocationNumber) {
	...
	public EMBASSY(Identifier identifier) {
	...
	public EMBASSY(IsAccessibleForFree isAccessibleForFree) {
	...
	public EMBASSY(MainEntityOfPage mainEntityOfPage) {
	...
	public EMBASSY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public EMBASSY(NameFuzzy nameFuzzy) {
	...
	public EMBASSY(NameRuby nameRuby) {
	...
	public EMBASSY(OpeningHours openingHours) {
	...
	public EMBASSY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public EMBASSY(PotentialAction potentialAction) {
	...
	public EMBASSY(PublicAccess publicAccess) {
	...
	public EMBASSY(SmokingAllowed smokingAllowed) {
	...
	public EMBASSY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public EMBASSY(SubjectOf subjectOf) {
	...
	public EMBASSY(Telephone telephone) {
	...
	public void copy(Clazz.Embassy org) {
		setSeq(org.getSeq());
