...
public class HOSPITAL implements Clazz.Hospital {
	...
	public HOSPITAL(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public HOSPITAL(AdditionalProperty additionalProperty) {
	...
	public HOSPITAL(AdditionalType additionalType) {
	...
	public HOSPITAL(AggregateRating aggregateRating) {
	...
	public HOSPITAL(AlternateName alternateName) {
	...
	public HOSPITAL(AmenityFeature amenityFeature) {
	...
	public HOSPITAL(AreaServed areaServed) {
	...
	public HOSPITAL(AvailableService availableService) {
	...
	public HOSPITAL(BranchCode branchCode) {
	...
	public HOSPITAL(ContactPoint contactPoint) {
	...
	public HOSPITAL(ContainedInPlace containedInPlace) {
	...
	public HOSPITAL(ContainsPlace containsPlace) {
	...
	public HOSPITAL(CorrectionsPolicy correctionsPolicy) {
	...
	public HOSPITAL(CurrenciesAccepted currenciesAccepted) {
	...
	public HOSPITAL(Description description) {
	...
	public HOSPITAL(DisambiguatingDescription disambiguatingDescription) {
	...
	public HOSPITAL(DissolutionDate dissolutionDate) {
	...
	public HOSPITAL(DiversityPolicy diversityPolicy) {
	...
	public HOSPITAL(DiversityStaffingReport diversityStaffingReport) {
	...
	public HOSPITAL(Employee employee) {
	...
	public HOSPITAL(EthicsPolicy ethicsPolicy) {
	...
	public HOSPITAL(FaxNumber faxNumber) {
	...
	public HOSPITAL(Founder founder) {
		setFounder(founder);
	}
	...
	public HOSPITAL(FoundingDate foundingDate) {
	...
	public HOSPITAL(FoundingLocation foundingLocation) {
	...
	public HOSPITAL(GeospatiallyContains geospatiallyContains) {
	...
	public HOSPITAL(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public HOSPITAL(GeospatiallyCovers geospatiallyCovers) {
	...
	public HOSPITAL(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public HOSPITAL(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public HOSPITAL(GeospatiallyEquals geospatiallyEquals) {
	...
	public HOSPITAL(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public HOSPITAL(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public HOSPITAL(GeospatiallyTouches geospatiallyTouches) {
	...
	public HOSPITAL(GeospatiallyWithin geospatiallyWithin) {
	...
	public HOSPITAL(GlobalLocationNumber globalLocationNumber) {
	...
	public HOSPITAL(HasOfferCatalog hasOfferCatalog) {
	...
	public HOSPITAL(HealthPlanNetworkId healthPlanNetworkId) {
	...
	public HOSPITAL(Identifier identifier) {
	...
	public HOSPITAL(IsAcceptingNewPatients isAcceptingNewPatients) {
	...
	public HOSPITAL(IsAccessibleForFree isAccessibleForFree) {
	...
	public HOSPITAL(KnowsAbout knowsAbout) {
	...
	public HOSPITAL(KnowsLanguage knowsLanguage) {
	...
	public HOSPITAL(LegalName legalName) {
	...
	public HOSPITAL(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public HOSPITAL(MainEntityOfPage mainEntityOfPage) {
	...
	public HOSPITAL(MakesOffer makesOffer) {
	...
	public HOSPITAL(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public HOSPITAL(MedicalSpecialty medicalSpecialty) {
	...
	public HOSPITAL(MemberOf memberOf) {
	...
	public HOSPITAL(NameFuzzy nameFuzzy) {
	...
	public HOSPITAL(NameRuby nameRuby) {
	...
	public HOSPITAL(NumberOfEmployees numberOfEmployees) {
	...
	public HOSPITAL(OpeningHours openingHours) {
	...
	public HOSPITAL(OpeningHoursSpecification openingHoursSpecification) {
	...
	public HOSPITAL(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public HOSPITAL(ParentOrganization parentOrganization) {
	...
	public HOSPITAL(PaymentAccepted paymentAccepted) {
	...
	public HOSPITAL(PotentialAction potentialAction) {
	...
	public HOSPITAL(PriceRange priceRange) {
	...
	public HOSPITAL(PublicAccess publicAccess) {
	...
	public HOSPITAL(PublishingPrinciples publishingPrinciples) {
	...
	public HOSPITAL(SmokingAllowed smokingAllowed) {
	...
	public HOSPITAL(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public HOSPITAL(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public HOSPITAL(SubOrganization subOrganization) {
	...
	public HOSPITAL(SubjectOf subjectOf) {
	...
	public HOSPITAL(Telephone telephone) {
	...
	public HOSPITAL(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Hospital org) {
		setSeq(org.getSeq());
