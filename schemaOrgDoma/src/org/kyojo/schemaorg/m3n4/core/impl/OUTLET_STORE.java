...
public class OUTLET_STORE implements Clazz.OutletStore {
	...
	public OUTLET_STORE(Long seq) {
		setSeq(seq);
	}

	public OUTLET_STORE(String string) {
	...
	public OUTLET_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public OUTLET_STORE(AdditionalProperty additionalProperty) {
	...
	public OUTLET_STORE(AdditionalType additionalType) {
	...
	public OUTLET_STORE(Address address) {
		setAddress(address);
	}
	...
	public OUTLET_STORE(AggregateRating aggregateRating) {
	...
	public OUTLET_STORE(AlternateName alternateName) {
	...
	public OUTLET_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public OUTLET_STORE(AmenityFeature amenityFeature) {
	...
	public OUTLET_STORE(AreaServed areaServed) {
	...
	public OUTLET_STORE(Award award) {
		setAward(award);
	}
	...
	public OUTLET_STORE(BranchCode branchCode) {
	...
	public OUTLET_STORE(Brand brand) {
		setBrand(brand);
	}
	...
	public OUTLET_STORE(ContactPoint contactPoint) {
	...
	public OUTLET_STORE(ContainedInPlace containedInPlace) {
	...
	public OUTLET_STORE(ContainsPlace containsPlace) {
	...
	public OUTLET_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public OUTLET_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public OUTLET_STORE(Department department) {
	...
	public OUTLET_STORE(Description description) {
	...
	public OUTLET_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public OUTLET_STORE(DissolutionDate dissolutionDate) {
	...
	public OUTLET_STORE(DiversityPolicy diversityPolicy) {
	...
	public OUTLET_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public OUTLET_STORE(Email email) {
		setEmail(email);
	}
	...
	public OUTLET_STORE(Employee employee) {
	...
	public OUTLET_STORE(EthicsPolicy ethicsPolicy) {
	...
	public OUTLET_STORE(Event event) {
		setEvent(event);
	}
	...
	public OUTLET_STORE(FaxNumber faxNumber) {
	...
	public OUTLET_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public OUTLET_STORE(FoundingDate foundingDate) {
	...
	public OUTLET_STORE(FoundingLocation foundingLocation) {
	...
	public OUTLET_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public OUTLET_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public OUTLET_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public OUTLET_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public OUTLET_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public OUTLET_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public OUTLET_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public OUTLET_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public OUTLET_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public OUTLET_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public OUTLET_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public OUTLET_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public OUTLET_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public OUTLET_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public OUTLET_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public OUTLET_STORE(Identifier identifier) {
	...
	public OUTLET_STORE(Image image) {
		setImage(image);
	}
	...
	public OUTLET_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public OUTLET_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public OUTLET_STORE(KnowsAbout knowsAbout) {
	...
	public OUTLET_STORE(KnowsLanguage knowsLanguage) {
	...
	public OUTLET_STORE(LegalName legalName) {
	...
	public OUTLET_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public OUTLET_STORE(Location location) {
	...
	public OUTLET_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public OUTLET_STORE(MakesOffer makesOffer) {
	...
	public OUTLET_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public OUTLET_STORE(Member member) {
		setMember(member);
	}
	...
	public OUTLET_STORE(MemberOf memberOf) {
	...
	public OUTLET_STORE(Naics naics) {
		setNaics(naics);
	}
	...
	public OUTLET_STORE(NameFuzzy nameFuzzy) {
	...
	public OUTLET_STORE(NameRuby nameRuby) {
	...
	public OUTLET_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public OUTLET_STORE(OpeningHours openingHours) {
	...
	public OUTLET_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public OUTLET_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public OUTLET_STORE(ParentOrganization parentOrganization) {
	...
	public OUTLET_STORE(PaymentAccepted paymentAccepted) {
	...
	public OUTLET_STORE(Photo photo) {
		setPhoto(photo);
	}
	...
	public OUTLET_STORE(PotentialAction potentialAction) {
	...
	public OUTLET_STORE(PriceRange priceRange) {
	...
	public OUTLET_STORE(PublicAccess publicAccess) {
	...
	public OUTLET_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public OUTLET_STORE(Review review) {
		setReview(review);
	}
	...
	public OUTLET_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public OUTLET_STORE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public OUTLET_STORE(SmokingAllowed smokingAllowed) {
	...
	public OUTLET_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public OUTLET_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public OUTLET_STORE(SubOrganization subOrganization) {
	...
	public OUTLET_STORE(SubjectOf subjectOf) {
	...
	public OUTLET_STORE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public OUTLET_STORE(Telephone telephone) {
	...
	public OUTLET_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public OUTLET_STORE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.OutletStore org) {
		setSeq(org.getSeq());
