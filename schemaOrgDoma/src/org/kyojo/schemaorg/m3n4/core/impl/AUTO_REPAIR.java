...
public class AUTO_REPAIR implements Clazz.AutoRepair {
	...
	public AUTO_REPAIR(Long seq) {
		setSeq(seq);
	}

	public AUTO_REPAIR(String string) {
	...
	public AUTO_REPAIR(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public AUTO_REPAIR(AdditionalProperty additionalProperty) {
	...
	public AUTO_REPAIR(AdditionalType additionalType) {
	...
	public AUTO_REPAIR(Address address) {
		setAddress(address);
	}
	...
	public AUTO_REPAIR(AggregateRating aggregateRating) {
	...
	public AUTO_REPAIR(AlternateName alternateName) {
	...
	public AUTO_REPAIR(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public AUTO_REPAIR(AmenityFeature amenityFeature) {
	...
	public AUTO_REPAIR(AreaServed areaServed) {
	...
	public AUTO_REPAIR(Award award) {
		setAward(award);
	}
	...
	public AUTO_REPAIR(BranchCode branchCode) {
	...
	public AUTO_REPAIR(Brand brand) {
		setBrand(brand);
	}
	...
	public AUTO_REPAIR(ContactPoint contactPoint) {
	...
	public AUTO_REPAIR(ContainedInPlace containedInPlace) {
	...
	public AUTO_REPAIR(ContainsPlace containsPlace) {
	...
	public AUTO_REPAIR(CorrectionsPolicy correctionsPolicy) {
	...
	public AUTO_REPAIR(CurrenciesAccepted currenciesAccepted) {
	...
	public AUTO_REPAIR(Department department) {
	...
	public AUTO_REPAIR(Description description) {
	...
	public AUTO_REPAIR(DisambiguatingDescription disambiguatingDescription) {
	...
	public AUTO_REPAIR(DissolutionDate dissolutionDate) {
	...
	public AUTO_REPAIR(DiversityPolicy diversityPolicy) {
	...
	public AUTO_REPAIR(DiversityStaffingReport diversityStaffingReport) {
	...
	public AUTO_REPAIR(Email email) {
		setEmail(email);
	}
	...
	public AUTO_REPAIR(Employee employee) {
	...
	public AUTO_REPAIR(EthicsPolicy ethicsPolicy) {
	...
	public AUTO_REPAIR(Event event) {
		setEvent(event);
	}
	...
	public AUTO_REPAIR(FaxNumber faxNumber) {
	...
	public AUTO_REPAIR(Founder founder) {
		setFounder(founder);
	}
	...
	public AUTO_REPAIR(FoundingDate foundingDate) {
	...
	public AUTO_REPAIR(FoundingLocation foundingLocation) {
	...
	public AUTO_REPAIR(Funder funder) {
		setFunder(funder);
	}
	...
	public AUTO_REPAIR(GeospatiallyContains geospatiallyContains) {
	...
	public AUTO_REPAIR(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public AUTO_REPAIR(GeospatiallyCovers geospatiallyCovers) {
	...
	public AUTO_REPAIR(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public AUTO_REPAIR(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public AUTO_REPAIR(GeospatiallyEquals geospatiallyEquals) {
	...
	public AUTO_REPAIR(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public AUTO_REPAIR(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public AUTO_REPAIR(GeospatiallyTouches geospatiallyTouches) {
	...
	public AUTO_REPAIR(GeospatiallyWithin geospatiallyWithin) {
	...
	public AUTO_REPAIR(GlobalLocationNumber globalLocationNumber) {
	...
	public AUTO_REPAIR(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public AUTO_REPAIR(HasOfferCatalog hasOfferCatalog) {
	...
	public AUTO_REPAIR(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public AUTO_REPAIR(Identifier identifier) {
	...
	public AUTO_REPAIR(Image image) {
		setImage(image);
	}
	...
	public AUTO_REPAIR(IsAccessibleForFree isAccessibleForFree) {
	...
	public AUTO_REPAIR(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public AUTO_REPAIR(KnowsAbout knowsAbout) {
	...
	public AUTO_REPAIR(KnowsLanguage knowsLanguage) {
	...
	public AUTO_REPAIR(LegalName legalName) {
	...
	public AUTO_REPAIR(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public AUTO_REPAIR(Location location) {
	...
	public AUTO_REPAIR(MainEntityOfPage mainEntityOfPage) {
	...
	public AUTO_REPAIR(MakesOffer makesOffer) {
	...
	public AUTO_REPAIR(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public AUTO_REPAIR(Member member) {
		setMember(member);
	}
	...
	public AUTO_REPAIR(MemberOf memberOf) {
	...
	public AUTO_REPAIR(Naics naics) {
		setNaics(naics);
	}
	...
	public AUTO_REPAIR(NameFuzzy nameFuzzy) {
	...
	public AUTO_REPAIR(NameRuby nameRuby) {
	...
	public AUTO_REPAIR(NumberOfEmployees numberOfEmployees) {
	...
	public AUTO_REPAIR(OpeningHours openingHours) {
	...
	public AUTO_REPAIR(OpeningHoursSpecification openingHoursSpecification) {
	...
	public AUTO_REPAIR(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public AUTO_REPAIR(ParentOrganization parentOrganization) {
	...
	public AUTO_REPAIR(PaymentAccepted paymentAccepted) {
	...
	public AUTO_REPAIR(Photo photo) {
		setPhoto(photo);
	}
	...
	public AUTO_REPAIR(PotentialAction potentialAction) {
	...
	public AUTO_REPAIR(PriceRange priceRange) {
	...
	public AUTO_REPAIR(PublicAccess publicAccess) {
	...
	public AUTO_REPAIR(PublishingPrinciples publishingPrinciples) {
	...
	public AUTO_REPAIR(Review review) {
		setReview(review);
	}
	...
	public AUTO_REPAIR(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public AUTO_REPAIR(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public AUTO_REPAIR(SmokingAllowed smokingAllowed) {
	...
	public AUTO_REPAIR(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public AUTO_REPAIR(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public AUTO_REPAIR(SubOrganization subOrganization) {
	...
	public AUTO_REPAIR(SubjectOf subjectOf) {
	...
	public AUTO_REPAIR(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public AUTO_REPAIR(Telephone telephone) {
	...
	public AUTO_REPAIR(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public AUTO_REPAIR(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.AutoRepair org) {
		setSeq(org.getSeq());
