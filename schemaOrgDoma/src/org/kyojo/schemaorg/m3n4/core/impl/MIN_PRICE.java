...
public class MIN_PRICE implements Container.MinPrice {
	...
	public MIN_PRICE(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public MIN_PRICE(Float fl0at) {
	...
	public MIN_PRICE(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public MIN_PRICE(Integer integer) {
	...
	public MIN_PRICE(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public MIN_PRICE(Number number) {
	...
	public MIN_PRICE(List<Float> fl0atList,
	...
	public void copy(Container.MinPrice org) {
