...
public class VALID_IN implements Container.ValidIn {
	...
	public VALID_IN(Country country) {
	...
	public VALID_IN(List<AdministrativeArea> administrativeAreaList,
			List<City> cityList,
	...
	public void copy(Container.ValidIn org) {
