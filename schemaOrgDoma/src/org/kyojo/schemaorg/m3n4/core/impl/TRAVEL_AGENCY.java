...
public class TRAVEL_AGENCY implements Clazz.TravelAgency {
	...
	public TRAVEL_AGENCY(Long seq) {
		setSeq(seq);
	}

	public TRAVEL_AGENCY(String string) {
	...
	public TRAVEL_AGENCY(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public TRAVEL_AGENCY(AdditionalProperty additionalProperty) {
	...
	public TRAVEL_AGENCY(AdditionalType additionalType) {
	...
	public TRAVEL_AGENCY(Address address) {
		setAddress(address);
	}
	...
	public TRAVEL_AGENCY(AggregateRating aggregateRating) {
	...
	public TRAVEL_AGENCY(AlternateName alternateName) {
	...
	public TRAVEL_AGENCY(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public TRAVEL_AGENCY(AmenityFeature amenityFeature) {
	...
	public TRAVEL_AGENCY(AreaServed areaServed) {
	...
	public TRAVEL_AGENCY(Award award) {
		setAward(award);
	}
	...
	public TRAVEL_AGENCY(BranchCode branchCode) {
	...
	public TRAVEL_AGENCY(Brand brand) {
		setBrand(brand);
	}
	...
	public TRAVEL_AGENCY(ContactPoint contactPoint) {
	...
	public TRAVEL_AGENCY(ContainedInPlace containedInPlace) {
	...
	public TRAVEL_AGENCY(ContainsPlace containsPlace) {
	...
	public TRAVEL_AGENCY(CorrectionsPolicy correctionsPolicy) {
	...
	public TRAVEL_AGENCY(CurrenciesAccepted currenciesAccepted) {
	...
	public TRAVEL_AGENCY(Department department) {
	...
	public TRAVEL_AGENCY(Description description) {
	...
	public TRAVEL_AGENCY(DisambiguatingDescription disambiguatingDescription) {
	...
	public TRAVEL_AGENCY(DissolutionDate dissolutionDate) {
	...
	public TRAVEL_AGENCY(DiversityPolicy diversityPolicy) {
	...
	public TRAVEL_AGENCY(DiversityStaffingReport diversityStaffingReport) {
	...
	public TRAVEL_AGENCY(Duns duns) {
		setDuns(duns);
	}
	...
	public TRAVEL_AGENCY(Email email) {
		setEmail(email);
	}
	...
	public TRAVEL_AGENCY(Employee employee) {
	...
	public TRAVEL_AGENCY(EthicsPolicy ethicsPolicy) {
	...
	public TRAVEL_AGENCY(Event event) {
		setEvent(event);
	}
	...
	public TRAVEL_AGENCY(FaxNumber faxNumber) {
	...
	public TRAVEL_AGENCY(Founder founder) {
		setFounder(founder);
	}
	...
	public TRAVEL_AGENCY(FoundingDate foundingDate) {
	...
	public TRAVEL_AGENCY(FoundingLocation foundingLocation) {
	...
	public TRAVEL_AGENCY(Funder funder) {
		setFunder(funder);
	}
	...
	public TRAVEL_AGENCY(GeospatiallyContains geospatiallyContains) {
	...
	public TRAVEL_AGENCY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public TRAVEL_AGENCY(GeospatiallyCovers geospatiallyCovers) {
	...
	public TRAVEL_AGENCY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public TRAVEL_AGENCY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public TRAVEL_AGENCY(GeospatiallyEquals geospatiallyEquals) {
	...
	public TRAVEL_AGENCY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public TRAVEL_AGENCY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public TRAVEL_AGENCY(GeospatiallyTouches geospatiallyTouches) {
	...
	public TRAVEL_AGENCY(GeospatiallyWithin geospatiallyWithin) {
	...
	public TRAVEL_AGENCY(GlobalLocationNumber globalLocationNumber) {
	...
	public TRAVEL_AGENCY(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public TRAVEL_AGENCY(HasOfferCatalog hasOfferCatalog) {
	...
	public TRAVEL_AGENCY(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public TRAVEL_AGENCY(Identifier identifier) {
	...
	public TRAVEL_AGENCY(Image image) {
		setImage(image);
	}
	...
	public TRAVEL_AGENCY(IsAccessibleForFree isAccessibleForFree) {
	...
	public TRAVEL_AGENCY(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public TRAVEL_AGENCY(KnowsAbout knowsAbout) {
	...
	public TRAVEL_AGENCY(KnowsLanguage knowsLanguage) {
	...
	public TRAVEL_AGENCY(LegalName legalName) {
	...
	public TRAVEL_AGENCY(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public TRAVEL_AGENCY(Location location) {
	...
	public TRAVEL_AGENCY(Logo logo) {
		setLogo(logo);
	}
	...
	public TRAVEL_AGENCY(MainEntityOfPage mainEntityOfPage) {
	...
	public TRAVEL_AGENCY(MakesOffer makesOffer) {
	...
	public TRAVEL_AGENCY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public TRAVEL_AGENCY(Member member) {
		setMember(member);
	}
	...
	public TRAVEL_AGENCY(MemberOf memberOf) {
	...
	public TRAVEL_AGENCY(Naics naics) {
		setNaics(naics);
	}
	...
	public TRAVEL_AGENCY(Name name) {
		setName(name);
	}
	...
	public TRAVEL_AGENCY(NameFuzzy nameFuzzy) {
	...
	public TRAVEL_AGENCY(NameRuby nameRuby) {
	...
	public TRAVEL_AGENCY(NumberOfEmployees numberOfEmployees) {
	...
	public TRAVEL_AGENCY(OpeningHours openingHours) {
	...
	public TRAVEL_AGENCY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public TRAVEL_AGENCY(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public TRAVEL_AGENCY(Owns owns) {
		setOwns(owns);
	}
	...
	public TRAVEL_AGENCY(ParentOrganization parentOrganization) {
	...
	public TRAVEL_AGENCY(PaymentAccepted paymentAccepted) {
	...
	public TRAVEL_AGENCY(Photo photo) {
		setPhoto(photo);
	}
	...
	public TRAVEL_AGENCY(PotentialAction potentialAction) {
	...
	public TRAVEL_AGENCY(PriceRange priceRange) {
	...
	public TRAVEL_AGENCY(PublicAccess publicAccess) {
	...
	public TRAVEL_AGENCY(PublishingPrinciples publishingPrinciples) {
	...
	public TRAVEL_AGENCY(Review review) {
		setReview(review);
	}
	...
	public TRAVEL_AGENCY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TRAVEL_AGENCY(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public TRAVEL_AGENCY(SmokingAllowed smokingAllowed) {
	...
	public TRAVEL_AGENCY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public TRAVEL_AGENCY(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public TRAVEL_AGENCY(SubOrganization subOrganization) {
	...
	public TRAVEL_AGENCY(SubjectOf subjectOf) {
	...
	public TRAVEL_AGENCY(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public TRAVEL_AGENCY(Telephone telephone) {
	...
	public TRAVEL_AGENCY(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public TRAVEL_AGENCY(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.TravelAgency org) {
		setSeq(org.getSeq());
