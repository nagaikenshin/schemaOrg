...
public class LODGING_BUSINESS implements Clazz.LodgingBusiness {
	...
	public LODGING_BUSINESS() {
	}

	public LODGING_BUSINESS(Long seq) {
		setSeq(seq);
	}

	public LODGING_BUSINESS(String string) {
	...
	public LODGING_BUSINESS(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public LODGING_BUSINESS(AdditionalProperty additionalProperty) {
	...
	public LODGING_BUSINESS(AdditionalType additionalType) {
	...
	public LODGING_BUSINESS(Address address) {
		setAddress(address);
	}
	...
	public LODGING_BUSINESS(AggregateRating aggregateRating) {
	...
	public LODGING_BUSINESS(AlternateName alternateName) {
	...
	public LODGING_BUSINESS(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public LODGING_BUSINESS(AmenityFeature amenityFeature) {
	...
	public LODGING_BUSINESS(AreaServed areaServed) {
	...
	public LODGING_BUSINESS(Audience audience) {
	...
	public LODGING_BUSINESS(AvailableLanguage availableLanguage) {
	...
	public LODGING_BUSINESS(Award award) {
		setAward(award);
	}
	...
	public LODGING_BUSINESS(BranchCode branchCode) {
	...
	public LODGING_BUSINESS(Brand brand) {
		setBrand(brand);
	}
	...
	public LODGING_BUSINESS(CheckinTime checkinTime) {
	...
	public LODGING_BUSINESS(CheckoutTime checkoutTime) {
	...
	public LODGING_BUSINESS(ContactPoint contactPoint) {
	...
	public LODGING_BUSINESS(ContainedInPlace containedInPlace) {
	...
	public LODGING_BUSINESS(ContainsPlace containsPlace) {
	...
	public LODGING_BUSINESS(CorrectionsPolicy correctionsPolicy) {
	...
	public LODGING_BUSINESS(CurrenciesAccepted currenciesAccepted) {
	...
	public LODGING_BUSINESS(Department department) {
	...
	public LODGING_BUSINESS(Description description) {
	...
	public LODGING_BUSINESS(DisambiguatingDescription disambiguatingDescription) {
	...
	public LODGING_BUSINESS(DissolutionDate dissolutionDate) {
	...
	public LODGING_BUSINESS(DiversityPolicy diversityPolicy) {
	...
	public LODGING_BUSINESS(DiversityStaffingReport diversityStaffingReport) {
	...
	public LODGING_BUSINESS(Duns duns) {
		setDuns(duns);
	}
	...
	public LODGING_BUSINESS(Email email) {
		setEmail(email);
	}
	...
	public LODGING_BUSINESS(Employee employee) {
	...
	public LODGING_BUSINESS(EthicsPolicy ethicsPolicy) {
	...
	public LODGING_BUSINESS(Event event) {
		setEvent(event);
	}
	...
	public LODGING_BUSINESS(FaxNumber faxNumber) {
	...
	public LODGING_BUSINESS(Founder founder) {
		setFounder(founder);
	}
	...
	public LODGING_BUSINESS(FoundingDate foundingDate) {
	...
	public LODGING_BUSINESS(FoundingLocation foundingLocation) {
	...
	public LODGING_BUSINESS(Funder funder) {
		setFunder(funder);
	}
	...
	public LODGING_BUSINESS(Geo geo) {
		setGeo(geo);
	}
	...
	public LODGING_BUSINESS(GeospatiallyContains geospatiallyContains) {
	...
	public LODGING_BUSINESS(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public LODGING_BUSINESS(GeospatiallyCovers geospatiallyCovers) {
	...
	public LODGING_BUSINESS(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public LODGING_BUSINESS(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public LODGING_BUSINESS(GeospatiallyEquals geospatiallyEquals) {
	...
	public LODGING_BUSINESS(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public LODGING_BUSINESS(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public LODGING_BUSINESS(GeospatiallyTouches geospatiallyTouches) {
	...
	public LODGING_BUSINESS(GeospatiallyWithin geospatiallyWithin) {
	...
	public LODGING_BUSINESS(GlobalLocationNumber globalLocationNumber) {
	...
	public LODGING_BUSINESS(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public LODGING_BUSINESS(HasOfferCatalog hasOfferCatalog) {
	...
	public LODGING_BUSINESS(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public LODGING_BUSINESS(Identifier identifier) {
	...
	public LODGING_BUSINESS(Image image) {
		setImage(image);
	}
	...
	public LODGING_BUSINESS(IsAccessibleForFree isAccessibleForFree) {
	...
	public LODGING_BUSINESS(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public LODGING_BUSINESS(KnowsAbout knowsAbout) {
	...
	public LODGING_BUSINESS(KnowsLanguage knowsLanguage) {
	...
	public LODGING_BUSINESS(LegalName legalName) {
	...
	public LODGING_BUSINESS(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public LODGING_BUSINESS(Location location) {
	...
	public LODGING_BUSINESS(Logo logo) {
		setLogo(logo);
	}
	...
	public LODGING_BUSINESS(MainEntityOfPage mainEntityOfPage) {
	...
	public LODGING_BUSINESS(MakesOffer makesOffer) {
	...
	public LODGING_BUSINESS(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public LODGING_BUSINESS(Member member) {
		setMember(member);
	}
	...
	public LODGING_BUSINESS(MemberOf memberOf) {
	...
	public LODGING_BUSINESS(Naics naics) {
		setNaics(naics);
	}
	...
	public LODGING_BUSINESS(Name name) {
		setName(name);
	}
	...
	public LODGING_BUSINESS(NameFuzzy nameFuzzy) {
	...
	public LODGING_BUSINESS(NameRuby nameRuby) {
	...
	public LODGING_BUSINESS(NumberOfEmployees numberOfEmployees) {
	...
	public LODGING_BUSINESS(OpeningHours openingHours) {
	...
	public LODGING_BUSINESS(OpeningHoursSpecification openingHoursSpecification) {
	...
	public LODGING_BUSINESS(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public LODGING_BUSINESS(Owns owns) {
		setOwns(owns);
	}
	...
	public LODGING_BUSINESS(ParentOrganization parentOrganization) {
	...
	public LODGING_BUSINESS(PaymentAccepted paymentAccepted) {
	...
	public LODGING_BUSINESS(PetsAllowed petsAllowed) {
	...
	public LODGING_BUSINESS(Photo photo) {
		setPhoto(photo);
	}
	...
	public LODGING_BUSINESS(PotentialAction potentialAction) {
	...
	public LODGING_BUSINESS(PriceRange priceRange) {
	...
	public LODGING_BUSINESS(PublicAccess publicAccess) {
	...
	public LODGING_BUSINESS(PublishingPrinciples publishingPrinciples) {
	...
	public LODGING_BUSINESS(Review review) {
		setReview(review);
	}
	...
	public LODGING_BUSINESS(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public LODGING_BUSINESS(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public LODGING_BUSINESS(SmokingAllowed smokingAllowed) {
	...
	public LODGING_BUSINESS(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public LODGING_BUSINESS(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public LODGING_BUSINESS(StarRating starRating) {
	...
	public LODGING_BUSINESS(SubOrganization subOrganization) {
	...
	public LODGING_BUSINESS(SubjectOf subjectOf) {
	...
	public LODGING_BUSINESS(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public LODGING_BUSINESS(Telephone telephone) {
	...
	public LODGING_BUSINESS(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public LODGING_BUSINESS(Url url) {
		setUrl(url);
	}
	...
	public LODGING_BUSINESS(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.LodgingBusiness org) {
		setSeq(org.getSeq());
