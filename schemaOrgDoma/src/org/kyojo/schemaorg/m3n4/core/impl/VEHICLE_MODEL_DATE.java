...
public class VEHICLE_MODEL_DATE implements Container.VehicleModelDate {
	...
	public VEHICLE_MODEL_DATE(java.util.Date date) {
		this(new DATE(date));
	}

	public VEHICLE_MODEL_DATE(java.time.LocalDate date) {
		this(new DATE(date));
	}

	public VEHICLE_MODEL_DATE(Date date) {
