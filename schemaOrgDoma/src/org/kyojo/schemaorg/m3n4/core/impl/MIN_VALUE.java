...
public class MIN_VALUE implements Container.MinValue {
	...
	public MIN_VALUE(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public MIN_VALUE(Float fl0at) {
	...
	public MIN_VALUE(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public MIN_VALUE(Integer integer) {
	...
	public MIN_VALUE(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public MIN_VALUE(Number number) {
	...
	public MIN_VALUE(List<Float> fl0atList,
	...
	public void copy(Container.MinValue org) {
