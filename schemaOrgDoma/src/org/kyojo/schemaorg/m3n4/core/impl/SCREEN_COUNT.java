...
public class SCREEN_COUNT implements Container.ScreenCount {
	...
	public SCREEN_COUNT(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public SCREEN_COUNT(Float fl0at) {
	...
	public SCREEN_COUNT(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public SCREEN_COUNT(Integer integer) {
	...
	public SCREEN_COUNT(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public SCREEN_COUNT(Number number) {
	...
	public SCREEN_COUNT(List<Float> fl0atList,
	...
	public void copy(Container.ScreenCount org) {
