...
public class MUSIC_VENUE implements Clazz.MusicVenue {
	...
	public MUSIC_VENUE(Long seq) {
		setSeq(seq);
	}

	public MUSIC_VENUE(String string) {
	...
	public MUSIC_VENUE(AdditionalProperty additionalProperty) {
	...
	public MUSIC_VENUE(AdditionalType additionalType) {
	...
	public MUSIC_VENUE(Address address) {
		setAddress(address);
	}
	...
	public MUSIC_VENUE(AggregateRating aggregateRating) {
	...
	public MUSIC_VENUE(AlternateName alternateName) {
	...
	public MUSIC_VENUE(AmenityFeature amenityFeature) {
	...
	public MUSIC_VENUE(BranchCode branchCode) {
	...
	public MUSIC_VENUE(ContainedInPlace containedInPlace) {
	...
	public MUSIC_VENUE(ContainsPlace containsPlace) {
	...
	public MUSIC_VENUE(Description description) {
	...
	public MUSIC_VENUE(DisambiguatingDescription disambiguatingDescription) {
	...
	public MUSIC_VENUE(Event event) {
		setEvent(event);
	}
	...
	public MUSIC_VENUE(FaxNumber faxNumber) {
	...
	public MUSIC_VENUE(GeospatiallyContains geospatiallyContains) {
	...
	public MUSIC_VENUE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public MUSIC_VENUE(GeospatiallyCovers geospatiallyCovers) {
	...
	public MUSIC_VENUE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public MUSIC_VENUE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public MUSIC_VENUE(GeospatiallyEquals geospatiallyEquals) {
	...
	public MUSIC_VENUE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public MUSIC_VENUE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public MUSIC_VENUE(GeospatiallyTouches geospatiallyTouches) {
	...
	public MUSIC_VENUE(GeospatiallyWithin geospatiallyWithin) {
	...
	public MUSIC_VENUE(GlobalLocationNumber globalLocationNumber) {
	...
	public MUSIC_VENUE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public MUSIC_VENUE(Identifier identifier) {
	...
	public MUSIC_VENUE(Image image) {
		setImage(image);
	}
	...
	public MUSIC_VENUE(IsAccessibleForFree isAccessibleForFree) {
	...
	public MUSIC_VENUE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public MUSIC_VENUE(MainEntityOfPage mainEntityOfPage) {
	...
	public MUSIC_VENUE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public MUSIC_VENUE(NameFuzzy nameFuzzy) {
	...
	public MUSIC_VENUE(NameRuby nameRuby) {
	...
	public MUSIC_VENUE(OpeningHours openingHours) {
	...
	public MUSIC_VENUE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public MUSIC_VENUE(Photo photo) {
		setPhoto(photo);
	}
	...
	public MUSIC_VENUE(PotentialAction potentialAction) {
	...
	public MUSIC_VENUE(PublicAccess publicAccess) {
	...
	public MUSIC_VENUE(Review review) {
		setReview(review);
	}
	...
	public MUSIC_VENUE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MUSIC_VENUE(SmokingAllowed smokingAllowed) {
	...
	public MUSIC_VENUE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public MUSIC_VENUE(SubjectOf subjectOf) {
	...
	public MUSIC_VENUE(Telephone telephone) {
	...
	public void copy(Clazz.MusicVenue org) {
		setSeq(org.getSeq());
