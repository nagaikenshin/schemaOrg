...
public class GOLF_COURSE implements Clazz.GolfCourse {
	...
	public GOLF_COURSE(Long seq) {
		setSeq(seq);
	}

	public GOLF_COURSE(String string) {
	...
	public GOLF_COURSE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public GOLF_COURSE(AdditionalProperty additionalProperty) {
	...
	public GOLF_COURSE(AdditionalType additionalType) {
	...
	public GOLF_COURSE(Address address) {
		setAddress(address);
	}
	...
	public GOLF_COURSE(AggregateRating aggregateRating) {
	...
	public GOLF_COURSE(AlternateName alternateName) {
	...
	public GOLF_COURSE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public GOLF_COURSE(AmenityFeature amenityFeature) {
	...
	public GOLF_COURSE(AreaServed areaServed) {
	...
	public GOLF_COURSE(Award award) {
		setAward(award);
	}
	...
	public GOLF_COURSE(BranchCode branchCode) {
	...
	public GOLF_COURSE(Brand brand) {
		setBrand(brand);
	}
	...
	public GOLF_COURSE(ContactPoint contactPoint) {
	...
	public GOLF_COURSE(ContainedInPlace containedInPlace) {
	...
	public GOLF_COURSE(ContainsPlace containsPlace) {
	...
	public GOLF_COURSE(CorrectionsPolicy correctionsPolicy) {
	...
	public GOLF_COURSE(CurrenciesAccepted currenciesAccepted) {
	...
	public GOLF_COURSE(Department department) {
	...
	public GOLF_COURSE(Description description) {
	...
	public GOLF_COURSE(DisambiguatingDescription disambiguatingDescription) {
	...
	public GOLF_COURSE(DissolutionDate dissolutionDate) {
	...
	public GOLF_COURSE(DiversityPolicy diversityPolicy) {
	...
	public GOLF_COURSE(DiversityStaffingReport diversityStaffingReport) {
	...
	public GOLF_COURSE(Email email) {
		setEmail(email);
	}
	...
	public GOLF_COURSE(Employee employee) {
	...
	public GOLF_COURSE(EthicsPolicy ethicsPolicy) {
	...
	public GOLF_COURSE(Event event) {
		setEvent(event);
	}
	...
	public GOLF_COURSE(FaxNumber faxNumber) {
	...
	public GOLF_COURSE(Founder founder) {
		setFounder(founder);
	}
	...
	public GOLF_COURSE(FoundingDate foundingDate) {
	...
	public GOLF_COURSE(FoundingLocation foundingLocation) {
	...
	public GOLF_COURSE(Funder funder) {
		setFunder(funder);
	}
	...
	public GOLF_COURSE(GeospatiallyContains geospatiallyContains) {
	...
	public GOLF_COURSE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public GOLF_COURSE(GeospatiallyCovers geospatiallyCovers) {
	...
	public GOLF_COURSE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public GOLF_COURSE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public GOLF_COURSE(GeospatiallyEquals geospatiallyEquals) {
	...
	public GOLF_COURSE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public GOLF_COURSE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public GOLF_COURSE(GeospatiallyTouches geospatiallyTouches) {
	...
	public GOLF_COURSE(GeospatiallyWithin geospatiallyWithin) {
	...
	public GOLF_COURSE(GlobalLocationNumber globalLocationNumber) {
	...
	public GOLF_COURSE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public GOLF_COURSE(HasOfferCatalog hasOfferCatalog) {
	...
	public GOLF_COURSE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public GOLF_COURSE(Identifier identifier) {
	...
	public GOLF_COURSE(Image image) {
		setImage(image);
	}
	...
	public GOLF_COURSE(IsAccessibleForFree isAccessibleForFree) {
	...
	public GOLF_COURSE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public GOLF_COURSE(KnowsAbout knowsAbout) {
	...
	public GOLF_COURSE(KnowsLanguage knowsLanguage) {
	...
	public GOLF_COURSE(LegalName legalName) {
	...
	public GOLF_COURSE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public GOLF_COURSE(Location location) {
	...
	public GOLF_COURSE(MainEntityOfPage mainEntityOfPage) {
	...
	public GOLF_COURSE(MakesOffer makesOffer) {
	...
	public GOLF_COURSE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public GOLF_COURSE(Member member) {
		setMember(member);
	}
	...
	public GOLF_COURSE(MemberOf memberOf) {
	...
	public GOLF_COURSE(Naics naics) {
		setNaics(naics);
	}
	...
	public GOLF_COURSE(NameFuzzy nameFuzzy) {
	...
	public GOLF_COURSE(NameRuby nameRuby) {
	...
	public GOLF_COURSE(NumberOfEmployees numberOfEmployees) {
	...
	public GOLF_COURSE(OpeningHours openingHours) {
	...
	public GOLF_COURSE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public GOLF_COURSE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public GOLF_COURSE(ParentOrganization parentOrganization) {
	...
	public GOLF_COURSE(PaymentAccepted paymentAccepted) {
	...
	public GOLF_COURSE(Photo photo) {
		setPhoto(photo);
	}
	...
	public GOLF_COURSE(PotentialAction potentialAction) {
	...
	public GOLF_COURSE(PriceRange priceRange) {
	...
	public GOLF_COURSE(PublicAccess publicAccess) {
	...
	public GOLF_COURSE(PublishingPrinciples publishingPrinciples) {
	...
	public GOLF_COURSE(Review review) {
		setReview(review);
	}
	...
	public GOLF_COURSE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public GOLF_COURSE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public GOLF_COURSE(SmokingAllowed smokingAllowed) {
	...
	public GOLF_COURSE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public GOLF_COURSE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public GOLF_COURSE(SubOrganization subOrganization) {
	...
	public GOLF_COURSE(SubjectOf subjectOf) {
	...
	public GOLF_COURSE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public GOLF_COURSE(Telephone telephone) {
	...
	public GOLF_COURSE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public GOLF_COURSE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.GolfCourse org) {
		setSeq(org.getSeq());
