...
public class BUS_STATION implements Clazz.BusStation {
	...
	public BUS_STATION(Long seq) {
		setSeq(seq);
	}

	public BUS_STATION(String string) {
	...
	public BUS_STATION(AdditionalProperty additionalProperty) {
	...
	public BUS_STATION(AdditionalType additionalType) {
	...
	public BUS_STATION(Address address) {
		setAddress(address);
	}
	...
	public BUS_STATION(AggregateRating aggregateRating) {
	...
	public BUS_STATION(AlternateName alternateName) {
	...
	public BUS_STATION(AmenityFeature amenityFeature) {
	...
	public BUS_STATION(BranchCode branchCode) {
	...
	public BUS_STATION(ContainedInPlace containedInPlace) {
	...
	public BUS_STATION(ContainsPlace containsPlace) {
	...
	public BUS_STATION(Description description) {
	...
	public BUS_STATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public BUS_STATION(Event event) {
		setEvent(event);
	}
	...
	public BUS_STATION(FaxNumber faxNumber) {
	...
	public BUS_STATION(GeospatiallyContains geospatiallyContains) {
	...
	public BUS_STATION(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public BUS_STATION(GeospatiallyCovers geospatiallyCovers) {
	...
	public BUS_STATION(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public BUS_STATION(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public BUS_STATION(GeospatiallyEquals geospatiallyEquals) {
	...
	public BUS_STATION(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public BUS_STATION(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public BUS_STATION(GeospatiallyTouches geospatiallyTouches) {
	...
	public BUS_STATION(GeospatiallyWithin geospatiallyWithin) {
	...
	public BUS_STATION(GlobalLocationNumber globalLocationNumber) {
	...
	public BUS_STATION(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public BUS_STATION(Identifier identifier) {
	...
	public BUS_STATION(Image image) {
		setImage(image);
	}
	...
	public BUS_STATION(IsAccessibleForFree isAccessibleForFree) {
	...
	public BUS_STATION(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public BUS_STATION(MainEntityOfPage mainEntityOfPage) {
	...
	public BUS_STATION(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public BUS_STATION(NameFuzzy nameFuzzy) {
	...
	public BUS_STATION(NameRuby nameRuby) {
	...
	public BUS_STATION(OpeningHours openingHours) {
	...
	public BUS_STATION(OpeningHoursSpecification openingHoursSpecification) {
	...
	public BUS_STATION(Photo photo) {
		setPhoto(photo);
	}
	...
	public BUS_STATION(PotentialAction potentialAction) {
	...
	public BUS_STATION(PublicAccess publicAccess) {
	...
	public BUS_STATION(Review review) {
		setReview(review);
	}
	...
	public BUS_STATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public BUS_STATION(SmokingAllowed smokingAllowed) {
	...
	public BUS_STATION(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public BUS_STATION(SubjectOf subjectOf) {
	...
	public BUS_STATION(Telephone telephone) {
	...
	public void copy(Clazz.BusStation org) {
		setSeq(org.getSeq());
