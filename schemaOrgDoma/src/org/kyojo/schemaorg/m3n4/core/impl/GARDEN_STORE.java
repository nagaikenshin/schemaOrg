...
public class GARDEN_STORE implements Clazz.GardenStore {
	...
	public GARDEN_STORE(Long seq) {
		setSeq(seq);
	}

	public GARDEN_STORE(String string) {
	...
	public GARDEN_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public GARDEN_STORE(AdditionalProperty additionalProperty) {
	...
	public GARDEN_STORE(AdditionalType additionalType) {
	...
	public GARDEN_STORE(Address address) {
		setAddress(address);
	}
	...
	public GARDEN_STORE(AggregateRating aggregateRating) {
	...
	public GARDEN_STORE(AlternateName alternateName) {
	...
	public GARDEN_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public GARDEN_STORE(AmenityFeature amenityFeature) {
	...
	public GARDEN_STORE(AreaServed areaServed) {
	...
	public GARDEN_STORE(Award award) {
		setAward(award);
	}
	...
	public GARDEN_STORE(BranchCode branchCode) {
	...
	public GARDEN_STORE(Brand brand) {
		setBrand(brand);
	}
	...
	public GARDEN_STORE(ContactPoint contactPoint) {
	...
	public GARDEN_STORE(ContainedInPlace containedInPlace) {
	...
	public GARDEN_STORE(ContainsPlace containsPlace) {
	...
	public GARDEN_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public GARDEN_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public GARDEN_STORE(Department department) {
	...
	public GARDEN_STORE(Description description) {
	...
	public GARDEN_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public GARDEN_STORE(DissolutionDate dissolutionDate) {
	...
	public GARDEN_STORE(DiversityPolicy diversityPolicy) {
	...
	public GARDEN_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public GARDEN_STORE(Email email) {
		setEmail(email);
	}
	...
	public GARDEN_STORE(Employee employee) {
	...
	public GARDEN_STORE(EthicsPolicy ethicsPolicy) {
	...
	public GARDEN_STORE(Event event) {
		setEvent(event);
	}
	...
	public GARDEN_STORE(FaxNumber faxNumber) {
	...
	public GARDEN_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public GARDEN_STORE(FoundingDate foundingDate) {
	...
	public GARDEN_STORE(FoundingLocation foundingLocation) {
	...
	public GARDEN_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public GARDEN_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public GARDEN_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public GARDEN_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public GARDEN_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public GARDEN_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public GARDEN_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public GARDEN_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public GARDEN_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public GARDEN_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public GARDEN_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public GARDEN_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public GARDEN_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public GARDEN_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public GARDEN_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public GARDEN_STORE(Identifier identifier) {
	...
	public GARDEN_STORE(Image image) {
		setImage(image);
	}
	...
	public GARDEN_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public GARDEN_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public GARDEN_STORE(KnowsAbout knowsAbout) {
	...
	public GARDEN_STORE(KnowsLanguage knowsLanguage) {
	...
	public GARDEN_STORE(LegalName legalName) {
	...
	public GARDEN_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public GARDEN_STORE(Location location) {
	...
	public GARDEN_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public GARDEN_STORE(MakesOffer makesOffer) {
	...
	public GARDEN_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public GARDEN_STORE(Member member) {
		setMember(member);
	}
	...
	public GARDEN_STORE(MemberOf memberOf) {
	...
	public GARDEN_STORE(Naics naics) {
		setNaics(naics);
	}
	...
	public GARDEN_STORE(NameFuzzy nameFuzzy) {
	...
	public GARDEN_STORE(NameRuby nameRuby) {
	...
	public GARDEN_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public GARDEN_STORE(OpeningHours openingHours) {
	...
	public GARDEN_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public GARDEN_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public GARDEN_STORE(ParentOrganization parentOrganization) {
	...
	public GARDEN_STORE(PaymentAccepted paymentAccepted) {
	...
	public GARDEN_STORE(Photo photo) {
		setPhoto(photo);
	}
	...
	public GARDEN_STORE(PotentialAction potentialAction) {
	...
	public GARDEN_STORE(PriceRange priceRange) {
	...
	public GARDEN_STORE(PublicAccess publicAccess) {
	...
	public GARDEN_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public GARDEN_STORE(Review review) {
		setReview(review);
	}
	...
	public GARDEN_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public GARDEN_STORE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public GARDEN_STORE(SmokingAllowed smokingAllowed) {
	...
	public GARDEN_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public GARDEN_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public GARDEN_STORE(SubOrganization subOrganization) {
	...
	public GARDEN_STORE(SubjectOf subjectOf) {
	...
	public GARDEN_STORE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public GARDEN_STORE(Telephone telephone) {
	...
	public GARDEN_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public GARDEN_STORE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.GardenStore org) {
		setSeq(org.getSeq());
