...
public class SHOE_STORE implements Clazz.ShoeStore {
	...
	public SHOE_STORE(Long seq) {
		setSeq(seq);
	}

	public SHOE_STORE(String string) {
	...
	public SHOE_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public SHOE_STORE(AdditionalProperty additionalProperty) {
	...
	public SHOE_STORE(AdditionalType additionalType) {
	...
	public SHOE_STORE(Address address) {
		setAddress(address);
	}
	...
	public SHOE_STORE(AggregateRating aggregateRating) {
	...
	public SHOE_STORE(AlternateName alternateName) {
	...
	public SHOE_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public SHOE_STORE(AmenityFeature amenityFeature) {
	...
	public SHOE_STORE(AreaServed areaServed) {
	...
	public SHOE_STORE(BranchCode branchCode) {
	...
	public SHOE_STORE(ContactPoint contactPoint) {
	...
	public SHOE_STORE(ContainedInPlace containedInPlace) {
	...
	public SHOE_STORE(ContainsPlace containsPlace) {
	...
	public SHOE_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public SHOE_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public SHOE_STORE(Department department) {
	...
	public SHOE_STORE(Description description) {
	...
	public SHOE_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public SHOE_STORE(DissolutionDate dissolutionDate) {
	...
	public SHOE_STORE(DiversityPolicy diversityPolicy) {
	...
	public SHOE_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public SHOE_STORE(Employee employee) {
	...
	public SHOE_STORE(EthicsPolicy ethicsPolicy) {
	...
	public SHOE_STORE(FaxNumber faxNumber) {
	...
	public SHOE_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public SHOE_STORE(FoundingDate foundingDate) {
	...
	public SHOE_STORE(FoundingLocation foundingLocation) {
	...
	public SHOE_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public SHOE_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public SHOE_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public SHOE_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public SHOE_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public SHOE_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public SHOE_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public SHOE_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public SHOE_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public SHOE_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public SHOE_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public SHOE_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public SHOE_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public SHOE_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public SHOE_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public SHOE_STORE(Identifier identifier) {
	...
	public SHOE_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public SHOE_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public SHOE_STORE(KnowsAbout knowsAbout) {
	...
	public SHOE_STORE(KnowsLanguage knowsLanguage) {
	...
	public SHOE_STORE(LegalName legalName) {
	...
	public SHOE_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public SHOE_STORE(Location location) {
	...
	public SHOE_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public SHOE_STORE(MakesOffer makesOffer) {
	...
	public SHOE_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public SHOE_STORE(Member member) {
		setMember(member);
	}
	...
	public SHOE_STORE(MemberOf memberOf) {
	...
	public SHOE_STORE(NameFuzzy nameFuzzy) {
	...
	public SHOE_STORE(NameRuby nameRuby) {
	...
	public SHOE_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public SHOE_STORE(OpeningHours openingHours) {
	...
	public SHOE_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public SHOE_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public SHOE_STORE(ParentOrganization parentOrganization) {
	...
	public SHOE_STORE(PaymentAccepted paymentAccepted) {
	...
	public SHOE_STORE(PotentialAction potentialAction) {
	...
	public SHOE_STORE(PriceRange priceRange) {
	...
	public SHOE_STORE(PublicAccess publicAccess) {
	...
	public SHOE_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public SHOE_STORE(Review review) {
		setReview(review);
	}
	...
	public SHOE_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SHOE_STORE(SmokingAllowed smokingAllowed) {
	...
	public SHOE_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public SHOE_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public SHOE_STORE(SubOrganization subOrganization) {
	...
	public SHOE_STORE(SubjectOf subjectOf) {
	...
	public SHOE_STORE(Telephone telephone) {
	...
	public SHOE_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.ShoeStore org) {
		setSeq(org.getSeq());
