...
public class ARRIVE_ACTION implements Clazz.ArriveAction {
	...
	public ARRIVE_ACTION() {
	}

	public ARRIVE_ACTION(Long seq) {
		setSeq(seq);
	}

	public ARRIVE_ACTION(String string) {
	...
	public ARRIVE_ACTION(ActionStatus actionStatus) {
	...
	public ARRIVE_ACTION(AdditionalType additionalType) {
	...
	public ARRIVE_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public ARRIVE_ACTION(AlternateName alternateName) {
	...
	public ARRIVE_ACTION(Description description) {
	...
	public ARRIVE_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public ARRIVE_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public ARRIVE_ACTION(Error error) {
		setError(error);
	}
	...
	public ARRIVE_ACTION(FromLocation fromLocation) {
	...
	public ARRIVE_ACTION(Identifier identifier) {
	...
	public ARRIVE_ACTION(Image image) {
		setImage(image);
	}
	...
	public ARRIVE_ACTION(Instrument instrument) {
	...
	public ARRIVE_ACTION(Location location) {
	...
	public ARRIVE_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public ARRIVE_ACTION(Name name) {
		setName(name);
	}
	...
	public ARRIVE_ACTION(NameFuzzy nameFuzzy) {
	...
	public ARRIVE_ACTION(NameRuby nameRuby) {
	...
	public ARRIVE_ACTION(Object object) {
		setObject(object);
	}
	...
	public ARRIVE_ACTION(Participant participant) {
	...
	public ARRIVE_ACTION(PotentialAction potentialAction) {
	...
	public ARRIVE_ACTION(Result result) {
		setResult(result);
	}
	...
	public ARRIVE_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ARRIVE_ACTION(StartTime startTime) {
	...
	public ARRIVE_ACTION(SubjectOf subjectOf) {
	...
	public ARRIVE_ACTION(Target target) {
		setTarget(target);
	}
	...
	public ARRIVE_ACTION(ToLocation toLocation) {
	...
	public void copy(Clazz.ArriveAction org) {
		setSeq(org.getSeq());
