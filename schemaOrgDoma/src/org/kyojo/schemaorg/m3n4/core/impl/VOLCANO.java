...
public class VOLCANO implements Clazz.Volcano {
	...
	public VOLCANO(Long seq) {
		setSeq(seq);
	}

	public VOLCANO(String string) {
	...
	public VOLCANO(AdditionalProperty additionalProperty) {
	...
	public VOLCANO(AdditionalType additionalType) {
	...
	public VOLCANO(Address address) {
		setAddress(address);
	}
	...
	public VOLCANO(AggregateRating aggregateRating) {
	...
	public VOLCANO(AlternateName alternateName) {
	...
	public VOLCANO(AmenityFeature amenityFeature) {
	...
	public VOLCANO(BranchCode branchCode) {
	...
	public VOLCANO(ContainedInPlace containedInPlace) {
	...
	public VOLCANO(ContainsPlace containsPlace) {
	...
	public VOLCANO(Description description) {
	...
	public VOLCANO(DisambiguatingDescription disambiguatingDescription) {
	...
	public VOLCANO(FaxNumber faxNumber) {
	...
	public VOLCANO(GeospatiallyContains geospatiallyContains) {
	...
	public VOLCANO(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public VOLCANO(GeospatiallyCovers geospatiallyCovers) {
	...
	public VOLCANO(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public VOLCANO(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public VOLCANO(GeospatiallyEquals geospatiallyEquals) {
	...
	public VOLCANO(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public VOLCANO(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public VOLCANO(GeospatiallyTouches geospatiallyTouches) {
	...
	public VOLCANO(GeospatiallyWithin geospatiallyWithin) {
	...
	public VOLCANO(GlobalLocationNumber globalLocationNumber) {
	...
	public VOLCANO(Identifier identifier) {
	...
	public VOLCANO(IsAccessibleForFree isAccessibleForFree) {
	...
	public VOLCANO(MainEntityOfPage mainEntityOfPage) {
	...
	public VOLCANO(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public VOLCANO(NameFuzzy nameFuzzy) {
	...
	public VOLCANO(NameRuby nameRuby) {
	...
	public VOLCANO(OpeningHoursSpecification openingHoursSpecification) {
	...
	public VOLCANO(PotentialAction potentialAction) {
	...
	public VOLCANO(PublicAccess publicAccess) {
	...
	public VOLCANO(SmokingAllowed smokingAllowed) {
	...
	public VOLCANO(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public VOLCANO(SubjectOf subjectOf) {
	...
	public VOLCANO(Telephone telephone) {
	...
	public void copy(Clazz.Volcano org) {
		setSeq(org.getSeq());
