...
public class GENERAL_CONTRACTOR implements Clazz.GeneralContractor {
	...
	public GENERAL_CONTRACTOR(Long seq) {
		setSeq(seq);
	}

	public GENERAL_CONTRACTOR(String string) {
	...
	public GENERAL_CONTRACTOR(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public GENERAL_CONTRACTOR(AdditionalProperty additionalProperty) {
	...
	public GENERAL_CONTRACTOR(AdditionalType additionalType) {
	...
	public GENERAL_CONTRACTOR(Address address) {
		setAddress(address);
	}
	...
	public GENERAL_CONTRACTOR(AggregateRating aggregateRating) {
	...
	public GENERAL_CONTRACTOR(AlternateName alternateName) {
	...
	public GENERAL_CONTRACTOR(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public GENERAL_CONTRACTOR(AmenityFeature amenityFeature) {
	...
	public GENERAL_CONTRACTOR(AreaServed areaServed) {
	...
	public GENERAL_CONTRACTOR(Award award) {
		setAward(award);
	}
	...
	public GENERAL_CONTRACTOR(BranchCode branchCode) {
	...
	public GENERAL_CONTRACTOR(Brand brand) {
		setBrand(brand);
	}
	...
	public GENERAL_CONTRACTOR(ContactPoint contactPoint) {
	...
	public GENERAL_CONTRACTOR(ContainedInPlace containedInPlace) {
	...
	public GENERAL_CONTRACTOR(ContainsPlace containsPlace) {
	...
	public GENERAL_CONTRACTOR(CorrectionsPolicy correctionsPolicy) {
	...
	public GENERAL_CONTRACTOR(CurrenciesAccepted currenciesAccepted) {
	...
	public GENERAL_CONTRACTOR(Department department) {
	...
	public GENERAL_CONTRACTOR(Description description) {
	...
	public GENERAL_CONTRACTOR(DisambiguatingDescription disambiguatingDescription) {
	...
	public GENERAL_CONTRACTOR(DissolutionDate dissolutionDate) {
	...
	public GENERAL_CONTRACTOR(DiversityPolicy diversityPolicy) {
	...
	public GENERAL_CONTRACTOR(DiversityStaffingReport diversityStaffingReport) {
	...
	public GENERAL_CONTRACTOR(Duns duns) {
		setDuns(duns);
	}
	...
	public GENERAL_CONTRACTOR(Email email) {
		setEmail(email);
	}
	...
	public GENERAL_CONTRACTOR(Employee employee) {
	...
	public GENERAL_CONTRACTOR(EthicsPolicy ethicsPolicy) {
	...
	public GENERAL_CONTRACTOR(Event event) {
		setEvent(event);
	}
	...
	public GENERAL_CONTRACTOR(FaxNumber faxNumber) {
	...
	public GENERAL_CONTRACTOR(Founder founder) {
		setFounder(founder);
	}
	...
	public GENERAL_CONTRACTOR(FoundingDate foundingDate) {
	...
	public GENERAL_CONTRACTOR(FoundingLocation foundingLocation) {
	...
	public GENERAL_CONTRACTOR(Funder funder) {
		setFunder(funder);
	}
	...
	public GENERAL_CONTRACTOR(Geo geo) {
		setGeo(geo);
	}
	...
	public GENERAL_CONTRACTOR(GeospatiallyContains geospatiallyContains) {
	...
	public GENERAL_CONTRACTOR(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public GENERAL_CONTRACTOR(GeospatiallyCovers geospatiallyCovers) {
	...
	public GENERAL_CONTRACTOR(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public GENERAL_CONTRACTOR(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public GENERAL_CONTRACTOR(GeospatiallyEquals geospatiallyEquals) {
	...
	public GENERAL_CONTRACTOR(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public GENERAL_CONTRACTOR(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public GENERAL_CONTRACTOR(GeospatiallyTouches geospatiallyTouches) {
	...
	public GENERAL_CONTRACTOR(GeospatiallyWithin geospatiallyWithin) {
	...
	public GENERAL_CONTRACTOR(GlobalLocationNumber globalLocationNumber) {
	...
	public GENERAL_CONTRACTOR(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public GENERAL_CONTRACTOR(HasOfferCatalog hasOfferCatalog) {
	...
	public GENERAL_CONTRACTOR(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public GENERAL_CONTRACTOR(Identifier identifier) {
	...
	public GENERAL_CONTRACTOR(Image image) {
		setImage(image);
	}
	...
	public GENERAL_CONTRACTOR(IsAccessibleForFree isAccessibleForFree) {
	...
	public GENERAL_CONTRACTOR(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public GENERAL_CONTRACTOR(KnowsAbout knowsAbout) {
	...
	public GENERAL_CONTRACTOR(KnowsLanguage knowsLanguage) {
	...
	public GENERAL_CONTRACTOR(LegalName legalName) {
	...
	public GENERAL_CONTRACTOR(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public GENERAL_CONTRACTOR(Location location) {
	...
	public GENERAL_CONTRACTOR(Logo logo) {
		setLogo(logo);
	}
	...
	public GENERAL_CONTRACTOR(MainEntityOfPage mainEntityOfPage) {
	...
	public GENERAL_CONTRACTOR(MakesOffer makesOffer) {
	...
	public GENERAL_CONTRACTOR(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public GENERAL_CONTRACTOR(Member member) {
		setMember(member);
	}
	...
	public GENERAL_CONTRACTOR(MemberOf memberOf) {
	...
	public GENERAL_CONTRACTOR(Naics naics) {
		setNaics(naics);
	}
	...
	public GENERAL_CONTRACTOR(Name name) {
		setName(name);
	}
	...
	public GENERAL_CONTRACTOR(NameFuzzy nameFuzzy) {
	...
	public GENERAL_CONTRACTOR(NameRuby nameRuby) {
	...
	public GENERAL_CONTRACTOR(NumberOfEmployees numberOfEmployees) {
	...
	public GENERAL_CONTRACTOR(OpeningHours openingHours) {
	...
	public GENERAL_CONTRACTOR(OpeningHoursSpecification openingHoursSpecification) {
	...
	public GENERAL_CONTRACTOR(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public GENERAL_CONTRACTOR(Owns owns) {
		setOwns(owns);
	}
	...
	public GENERAL_CONTRACTOR(ParentOrganization parentOrganization) {
	...
	public GENERAL_CONTRACTOR(PaymentAccepted paymentAccepted) {
	...
	public GENERAL_CONTRACTOR(Photo photo) {
		setPhoto(photo);
	}
	...
	public GENERAL_CONTRACTOR(PotentialAction potentialAction) {
	...
	public GENERAL_CONTRACTOR(PriceRange priceRange) {
	...
	public GENERAL_CONTRACTOR(PublicAccess publicAccess) {
	...
	public GENERAL_CONTRACTOR(PublishingPrinciples publishingPrinciples) {
	...
	public GENERAL_CONTRACTOR(Review review) {
		setReview(review);
	}
	...
	public GENERAL_CONTRACTOR(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public GENERAL_CONTRACTOR(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public GENERAL_CONTRACTOR(SmokingAllowed smokingAllowed) {
	...
	public GENERAL_CONTRACTOR(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public GENERAL_CONTRACTOR(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public GENERAL_CONTRACTOR(SubOrganization subOrganization) {
	...
	public GENERAL_CONTRACTOR(SubjectOf subjectOf) {
	...
	public GENERAL_CONTRACTOR(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public GENERAL_CONTRACTOR(Telephone telephone) {
	...
	public GENERAL_CONTRACTOR(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public GENERAL_CONTRACTOR(Url url) {
		setUrl(url);
	}
	...
	public GENERAL_CONTRACTOR(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.GeneralContractor org) {
		setSeq(org.getSeq());
