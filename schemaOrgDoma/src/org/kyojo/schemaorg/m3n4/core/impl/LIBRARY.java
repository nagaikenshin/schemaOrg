...
public class LIBRARY implements Clazz.Library {
	...
	public LIBRARY(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public LIBRARY(AdditionalProperty additionalProperty) {
	...
	public LIBRARY(AdditionalType additionalType) {
	...
	public LIBRARY(AggregateRating aggregateRating) {
	...
	public LIBRARY(AlternateName alternateName) {
	...
	public LIBRARY(AmenityFeature amenityFeature) {
	...
	public LIBRARY(AreaServed areaServed) {
	...
	public LIBRARY(BranchCode branchCode) {
	...
	public LIBRARY(ContactPoint contactPoint) {
	...
	public LIBRARY(ContainedInPlace containedInPlace) {
	...
	public LIBRARY(ContainsPlace containsPlace) {
	...
	public LIBRARY(CorrectionsPolicy correctionsPolicy) {
	...
	public LIBRARY(CurrenciesAccepted currenciesAccepted) {
	...
	public LIBRARY(Department department) {
	...
	public LIBRARY(Description description) {
	...
	public LIBRARY(DisambiguatingDescription disambiguatingDescription) {
	...
	public LIBRARY(DissolutionDate dissolutionDate) {
	...
	public LIBRARY(DiversityPolicy diversityPolicy) {
	...
	public LIBRARY(DiversityStaffingReport diversityStaffingReport) {
	...
	public LIBRARY(EthicsPolicy ethicsPolicy) {
	...
	public LIBRARY(FaxNumber faxNumber) {
	...
	public LIBRARY(Founder founder) {
		setFounder(founder);
	}
	...
	public LIBRARY(FoundingDate foundingDate) {
	...
	public LIBRARY(FoundingLocation foundingLocation) {
	...
	public LIBRARY(GeospatiallyContains geospatiallyContains) {
	...
	public LIBRARY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public LIBRARY(GeospatiallyCovers geospatiallyCovers) {
	...
	public LIBRARY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public LIBRARY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public LIBRARY(GeospatiallyEquals geospatiallyEquals) {
	...
	public LIBRARY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public LIBRARY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public LIBRARY(GeospatiallyTouches geospatiallyTouches) {
	...
	public LIBRARY(GeospatiallyWithin geospatiallyWithin) {
	...
	public LIBRARY(GlobalLocationNumber globalLocationNumber) {
	...
	public LIBRARY(HasOfferCatalog hasOfferCatalog) {
	...
	public LIBRARY(Identifier identifier) {
	...
	public LIBRARY(IsAccessibleForFree isAccessibleForFree) {
	...
	public LIBRARY(KnowsAbout knowsAbout) {
	...
	public LIBRARY(KnowsLanguage knowsLanguage) {
	...
	public LIBRARY(LegalName legalName) {
	...
	public LIBRARY(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public LIBRARY(MainEntityOfPage mainEntityOfPage) {
	...
	public LIBRARY(MakesOffer makesOffer) {
	...
	public LIBRARY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public LIBRARY(MemberOf memberOf) {
	...
	public LIBRARY(NameFuzzy nameFuzzy) {
	...
	public LIBRARY(NameRuby nameRuby) {
	...
	public LIBRARY(NumberOfEmployees numberOfEmployees) {
	...
	public LIBRARY(OpeningHours openingHours) {
	...
	public LIBRARY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public LIBRARY(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public LIBRARY(ParentOrganization parentOrganization) {
	...
	public LIBRARY(PaymentAccepted paymentAccepted) {
	...
	public LIBRARY(PotentialAction potentialAction) {
	...
	public LIBRARY(PriceRange priceRange) {
	...
	public LIBRARY(PublicAccess publicAccess) {
	...
	public LIBRARY(PublishingPrinciples publishingPrinciples) {
	...
	public LIBRARY(SmokingAllowed smokingAllowed) {
	...
	public LIBRARY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public LIBRARY(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public LIBRARY(SubOrganization subOrganization) {
	...
	public LIBRARY(SubjectOf subjectOf) {
	...
	public LIBRARY(Telephone telephone) {
	...
	public LIBRARY(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Library org) {
		setSeq(org.getSeq());
