...
public class TENNIS_COMPLEX implements Clazz.TennisComplex {
	...
	public TENNIS_COMPLEX(GeospatiallyContains geospatiallyContains) {
	...
	public TENNIS_COMPLEX(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public TENNIS_COMPLEX(GeospatiallyCovers geospatiallyCovers) {
	...
	public TENNIS_COMPLEX(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public TENNIS_COMPLEX(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public TENNIS_COMPLEX(GeospatiallyEquals geospatiallyEquals) {
	...
	public TENNIS_COMPLEX(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public TENNIS_COMPLEX(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public TENNIS_COMPLEX(GeospatiallyTouches geospatiallyTouches) {
	...
	public TENNIS_COMPLEX(GeospatiallyWithin geospatiallyWithin) {
