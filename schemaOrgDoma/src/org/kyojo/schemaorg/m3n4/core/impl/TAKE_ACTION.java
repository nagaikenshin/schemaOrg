...
public class TAKE_ACTION implements Clazz.TakeAction {
	...
	public TAKE_ACTION(Long seq) {
		setSeq(seq);
	}

	public TAKE_ACTION(String string) {
	...
	public TAKE_ACTION(ActionStatus actionStatus) {
	...
	public TAKE_ACTION(AdditionalType additionalType) {
	...
	public TAKE_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public TAKE_ACTION(AlternateName alternateName) {
	...
	public TAKE_ACTION(Description description) {
	...
	public TAKE_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public TAKE_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public TAKE_ACTION(Error error) {
		setError(error);
	}
	...
	public TAKE_ACTION(FromLocation fromLocation) {
	...
	public TAKE_ACTION(Identifier identifier) {
	...
	public TAKE_ACTION(Image image) {
		setImage(image);
	}
	...
	public TAKE_ACTION(Instrument instrument) {
	...
	public TAKE_ACTION(Location location) {
	...
	public TAKE_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public TAKE_ACTION(NameFuzzy nameFuzzy) {
	...
	public TAKE_ACTION(NameRuby nameRuby) {
	...
	public TAKE_ACTION(Object object) {
		setObject(object);
	}
	...
	public TAKE_ACTION(Participant participant) {
	...
	public TAKE_ACTION(PotentialAction potentialAction) {
	...
	public TAKE_ACTION(Result result) {
		setResult(result);
	}
	...
	public TAKE_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TAKE_ACTION(StartTime startTime) {
	...
	public TAKE_ACTION(SubjectOf subjectOf) {
	...
	public TAKE_ACTION(Target target) {
		setTarget(target);
	}
	...
	public TAKE_ACTION(ToLocation toLocation) {
	...
	public void copy(Clazz.TakeAction org) {
		setSeq(org.getSeq());
