...
public class LOCKSMITH implements Clazz.Locksmith {
	...
	public LOCKSMITH(Long seq) {
		setSeq(seq);
	}

	public LOCKSMITH(String string) {
	...
	public LOCKSMITH(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public LOCKSMITH(AdditionalProperty additionalProperty) {
	...
	public LOCKSMITH(AdditionalType additionalType) {
	...
	public LOCKSMITH(Address address) {
		setAddress(address);
	}
	...
	public LOCKSMITH(AggregateRating aggregateRating) {
	...
	public LOCKSMITH(AlternateName alternateName) {
	...
	public LOCKSMITH(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public LOCKSMITH(AmenityFeature amenityFeature) {
	...
	public LOCKSMITH(AreaServed areaServed) {
	...
	public LOCKSMITH(BranchCode branchCode) {
	...
	public LOCKSMITH(ContactPoint contactPoint) {
	...
	public LOCKSMITH(ContainedInPlace containedInPlace) {
	...
	public LOCKSMITH(ContainsPlace containsPlace) {
	...
	public LOCKSMITH(CorrectionsPolicy correctionsPolicy) {
	...
	public LOCKSMITH(CurrenciesAccepted currenciesAccepted) {
	...
	public LOCKSMITH(Department department) {
	...
	public LOCKSMITH(Description description) {
	...
	public LOCKSMITH(DisambiguatingDescription disambiguatingDescription) {
	...
	public LOCKSMITH(DissolutionDate dissolutionDate) {
	...
	public LOCKSMITH(DiversityPolicy diversityPolicy) {
	...
	public LOCKSMITH(DiversityStaffingReport diversityStaffingReport) {
	...
	public LOCKSMITH(Employee employee) {
	...
	public LOCKSMITH(EthicsPolicy ethicsPolicy) {
	...
	public LOCKSMITH(FaxNumber faxNumber) {
	...
	public LOCKSMITH(Founder founder) {
		setFounder(founder);
	}
	...
	public LOCKSMITH(FoundingDate foundingDate) {
	...
	public LOCKSMITH(FoundingLocation foundingLocation) {
	...
	public LOCKSMITH(Funder funder) {
		setFunder(funder);
	}
	...
	public LOCKSMITH(GeospatiallyContains geospatiallyContains) {
	...
	public LOCKSMITH(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public LOCKSMITH(GeospatiallyCovers geospatiallyCovers) {
	...
	public LOCKSMITH(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public LOCKSMITH(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public LOCKSMITH(GeospatiallyEquals geospatiallyEquals) {
	...
	public LOCKSMITH(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public LOCKSMITH(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public LOCKSMITH(GeospatiallyTouches geospatiallyTouches) {
	...
	public LOCKSMITH(GeospatiallyWithin geospatiallyWithin) {
	...
	public LOCKSMITH(GlobalLocationNumber globalLocationNumber) {
	...
	public LOCKSMITH(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public LOCKSMITH(HasOfferCatalog hasOfferCatalog) {
	...
	public LOCKSMITH(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public LOCKSMITH(Identifier identifier) {
	...
	public LOCKSMITH(IsAccessibleForFree isAccessibleForFree) {
	...
	public LOCKSMITH(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public LOCKSMITH(KnowsAbout knowsAbout) {
	...
	public LOCKSMITH(KnowsLanguage knowsLanguage) {
	...
	public LOCKSMITH(LegalName legalName) {
	...
	public LOCKSMITH(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public LOCKSMITH(Location location) {
	...
	public LOCKSMITH(MainEntityOfPage mainEntityOfPage) {
	...
	public LOCKSMITH(MakesOffer makesOffer) {
	...
	public LOCKSMITH(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public LOCKSMITH(Member member) {
		setMember(member);
	}
	...
	public LOCKSMITH(MemberOf memberOf) {
	...
	public LOCKSMITH(NameFuzzy nameFuzzy) {
	...
	public LOCKSMITH(NameRuby nameRuby) {
	...
	public LOCKSMITH(NumberOfEmployees numberOfEmployees) {
	...
	public LOCKSMITH(OpeningHours openingHours) {
	...
	public LOCKSMITH(OpeningHoursSpecification openingHoursSpecification) {
	...
	public LOCKSMITH(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public LOCKSMITH(ParentOrganization parentOrganization) {
	...
	public LOCKSMITH(PaymentAccepted paymentAccepted) {
	...
	public LOCKSMITH(PotentialAction potentialAction) {
	...
	public LOCKSMITH(PriceRange priceRange) {
	...
	public LOCKSMITH(PublicAccess publicAccess) {
	...
	public LOCKSMITH(PublishingPrinciples publishingPrinciples) {
	...
	public LOCKSMITH(Review review) {
		setReview(review);
	}
	...
	public LOCKSMITH(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public LOCKSMITH(SmokingAllowed smokingAllowed) {
	...
	public LOCKSMITH(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public LOCKSMITH(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public LOCKSMITH(SubOrganization subOrganization) {
	...
	public LOCKSMITH(SubjectOf subjectOf) {
	...
	public LOCKSMITH(Telephone telephone) {
	...
	public LOCKSMITH(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Locksmith org) {
		setSeq(org.getSeq());
