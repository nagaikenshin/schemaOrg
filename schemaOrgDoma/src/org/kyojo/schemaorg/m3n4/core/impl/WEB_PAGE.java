...
public class WEB_PAGE implements Clazz.WebPage {
	...
	public WEB_PAGE(Long seq) {
		setSeq(seq);
	}

	public WEB_PAGE(String string) {
	...
	public WEB_PAGE(AccessMode accessMode) {
	...
	public WEB_PAGE(AccessModeSufficient accessModeSufficient) {
	...
	public WEB_PAGE(AccessibilityAPI accessibilityAPI) {
	...
	public WEB_PAGE(AccessibilityControl accessibilityControl) {
	...
	public WEB_PAGE(AccessibilityFeature accessibilityFeature) {
	...
	public WEB_PAGE(AccessibilityHazard accessibilityHazard) {
	...
	public WEB_PAGE(AccessibilitySummary accessibilitySummary) {
	...
	public WEB_PAGE(AccountablePerson accountablePerson) {
	...
	public WEB_PAGE(AdditionalType additionalType) {
	...
	public WEB_PAGE(AggregateRating aggregateRating) {
	...
	public WEB_PAGE(AlternateName alternateName) {
	...
	public WEB_PAGE(AlternativeHeadline alternativeHeadline) {
	...
	public WEB_PAGE(AssociatedMedia associatedMedia) {
	...
	public WEB_PAGE(Audience audience) {
	...
	public WEB_PAGE(Breadcrumb breadcrumb) {
	...
	public WEB_PAGE(Character character) {
	...
	public WEB_PAGE(Citation citation) {
	...
	public WEB_PAGE(Comment comment) {
		setComment(comment);
	}
	...
	public WEB_PAGE(CommentCount commentCount) {
	...
	public WEB_PAGE(ContentLocation contentLocation) {
	...
	public WEB_PAGE(ContentRating contentRating) {
	...
	public WEB_PAGE(ContentReferenceTime contentReferenceTime) {
	...
	public WEB_PAGE(Contributor contributor) {
	...
	public WEB_PAGE(CopyrightHolder copyrightHolder) {
	...
	public WEB_PAGE(CopyrightYear copyrightYear) {
	...
	public WEB_PAGE(Correction correction) {
	...
	public WEB_PAGE(Creator creator) {
		setCreator(creator);
	}
	...
	public WEB_PAGE(DateCreated dateCreated) {
	...
	public WEB_PAGE(DateModified dateModified) {
	...
	public WEB_PAGE(DatePublished datePublished) {
	...
	public WEB_PAGE(Description description) {
	...
	public WEB_PAGE(DisambiguatingDescription disambiguatingDescription) {
	...
	public WEB_PAGE(DiscussionUrl discussionUrl) {
	...
	public WEB_PAGE(EducationalAlignment educationalAlignment) {
	...
	public WEB_PAGE(EducationalUse educationalUse) {
	...
	public WEB_PAGE(Encoding encoding) {
	...
	public WEB_PAGE(EncodingFormat encodingFormat) {
	...
	public WEB_PAGE(ExampleOfWork exampleOfWork) {
	...
	public WEB_PAGE(Expires expires) {
		setExpires(expires);
	}
	...
	public WEB_PAGE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public WEB_PAGE(Headline headline) {
	...
	public WEB_PAGE(Identifier identifier) {
	...
	public WEB_PAGE(InLanguage inLanguage) {
	...
	public WEB_PAGE(InteractionStatistic interactionStatistic) {
	...
	public WEB_PAGE(InteractivityType interactivityType) {
	...
	public WEB_PAGE(IsAccessibleForFree isAccessibleForFree) {
	...
	public WEB_PAGE(IsBasedOn isBasedOn) {
	...
	public WEB_PAGE(IsFamilyFriendly isFamilyFriendly) {
	...
	public WEB_PAGE(IsPartOf isPartOf) {
	...
	public WEB_PAGE(Keywords keywords) {
	...
	public WEB_PAGE(LastReviewed lastReviewed) {
	...
	public WEB_PAGE(LearningResourceType learningResourceType) {
	...
	public WEB_PAGE(License license) {
		setLicense(license);
	}
	...
	public WEB_PAGE(LocationCreated locationCreated) {
	...
	public WEB_PAGE(MainContentOfPage mainContentOfPage) {
	...
	public WEB_PAGE(MainEntity mainEntity) {
	...
	public WEB_PAGE(MainEntityOfPage mainEntityOfPage) {
	...
	public WEB_PAGE(Material material) {
	...
	public WEB_PAGE(Mentions mentions) {
	...
	public WEB_PAGE(NameFuzzy nameFuzzy) {
	...
	public WEB_PAGE(NameRuby nameRuby) {
	...
	public WEB_PAGE(Position position) {
	...
	public WEB_PAGE(PotentialAction potentialAction) {
	...
	public WEB_PAGE(PrimaryImageOfPage primaryImageOfPage) {
	...
	public WEB_PAGE(Producer producer) {
	...
	public WEB_PAGE(Provider provider) {
	...
	public WEB_PAGE(Publication publication) {
	...
	public WEB_PAGE(Publisher publisher) {
	...
	public WEB_PAGE(PublisherImprint publisherImprint) {
	...
	public WEB_PAGE(PublishingPrinciples publishingPrinciples) {
	...
	public WEB_PAGE(RecordedAt recordedAt) {
	...
	public WEB_PAGE(RelatedLink relatedLink) {
	...
	public WEB_PAGE(ReleasedEvent releasedEvent) {
	...
	public WEB_PAGE(ReviewedBy reviewedBy) {
	...
	public WEB_PAGE(SchemaVersion schemaVersion) {
	...
	public WEB_PAGE(SdDatePublished sdDatePublished) {
	...
	public WEB_PAGE(SdLicense sdLicense) {
	...
	public WEB_PAGE(SdPublisher sdPublisher) {
	...
	public WEB_PAGE(SignificantLink significantLink) {
	...
	public WEB_PAGE(SourceOrganization sourceOrganization) {
	...
	public WEB_PAGE(SpatialCoverage spatialCoverage) {
	...
	public WEB_PAGE(Speakable speakable) {
	...
	public WEB_PAGE(Specialty specialty) {
	...
	public WEB_PAGE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public WEB_PAGE(SubjectOf subjectOf) {
	...
	public WEB_PAGE(TemporalCoverage temporalCoverage) {
	...
	public WEB_PAGE(ThumbnailUrl thumbnailUrl) {
	...
	public WEB_PAGE(TimeRequired timeRequired) {
	...
	public WEB_PAGE(TranslationOfWork translationOfWork) {
	...
	public WEB_PAGE(Translator translator) {
	...
	public WEB_PAGE(TypicalAgeRange typicalAgeRange) {
	...
	public WEB_PAGE(Version version) {
		setVersion(version);
	}
	...
	public WEB_PAGE(WorkExample workExample) {
	...
	public WEB_PAGE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.WebPage org) {
		setSeq(org.getSeq());
