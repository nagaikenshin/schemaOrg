...
public class PARENT implements Container.Parent {
	...
	public PARENT(List<Patient> patientList,
			List<Person> personList) {
		setPatientList(patientList);
		setPersonList(personList);
	}

	public void copy(Container.Parent org) {
