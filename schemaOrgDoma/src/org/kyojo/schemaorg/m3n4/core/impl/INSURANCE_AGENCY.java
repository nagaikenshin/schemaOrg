...
public class INSURANCE_AGENCY implements Clazz.InsuranceAgency {
	...
	public INSURANCE_AGENCY() {
	}

	public INSURANCE_AGENCY(Long seq) {
		setSeq(seq);
	}

	public INSURANCE_AGENCY(String string) {
	...
	public INSURANCE_AGENCY(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public INSURANCE_AGENCY(AdditionalProperty additionalProperty) {
	...
	public INSURANCE_AGENCY(AdditionalType additionalType) {
	...
	public INSURANCE_AGENCY(Address address) {
		setAddress(address);
	}
	...
	public INSURANCE_AGENCY(AggregateRating aggregateRating) {
	...
	public INSURANCE_AGENCY(AlternateName alternateName) {
	...
	public INSURANCE_AGENCY(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public INSURANCE_AGENCY(AmenityFeature amenityFeature) {
	...
	public INSURANCE_AGENCY(AreaServed areaServed) {
	...
	public INSURANCE_AGENCY(Award award) {
		setAward(award);
	}
	...
	public INSURANCE_AGENCY(BranchCode branchCode) {
	...
	public INSURANCE_AGENCY(Brand brand) {
		setBrand(brand);
	}
	...
	public INSURANCE_AGENCY(ContactPoint contactPoint) {
	...
	public INSURANCE_AGENCY(ContainedInPlace containedInPlace) {
	...
	public INSURANCE_AGENCY(ContainsPlace containsPlace) {
	...
	public INSURANCE_AGENCY(CorrectionsPolicy correctionsPolicy) {
	...
	public INSURANCE_AGENCY(CurrenciesAccepted currenciesAccepted) {
	...
	public INSURANCE_AGENCY(Department department) {
	...
	public INSURANCE_AGENCY(Description description) {
	...
	public INSURANCE_AGENCY(DisambiguatingDescription disambiguatingDescription) {
	...
	public INSURANCE_AGENCY(DissolutionDate dissolutionDate) {
	...
	public INSURANCE_AGENCY(DiversityPolicy diversityPolicy) {
	...
	public INSURANCE_AGENCY(DiversityStaffingReport diversityStaffingReport) {
	...
	public INSURANCE_AGENCY(Duns duns) {
		setDuns(duns);
	}
	...
	public INSURANCE_AGENCY(Email email) {
		setEmail(email);
	}
	...
	public INSURANCE_AGENCY(Employee employee) {
	...
	public INSURANCE_AGENCY(EthicsPolicy ethicsPolicy) {
	...
	public INSURANCE_AGENCY(Event event) {
		setEvent(event);
	}
	...
	public INSURANCE_AGENCY(FaxNumber faxNumber) {
	...
	public INSURANCE_AGENCY(FeesAndCommissionsSpecification feesAndCommissionsSpecification) {
	...
	public INSURANCE_AGENCY(Founder founder) {
		setFounder(founder);
	}
	...
	public INSURANCE_AGENCY(FoundingDate foundingDate) {
	...
	public INSURANCE_AGENCY(FoundingLocation foundingLocation) {
	...
	public INSURANCE_AGENCY(Funder funder) {
		setFunder(funder);
	}
	...
	public INSURANCE_AGENCY(Geo geo) {
		setGeo(geo);
	}
	...
	public INSURANCE_AGENCY(GeospatiallyContains geospatiallyContains) {
	...
	public INSURANCE_AGENCY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public INSURANCE_AGENCY(GeospatiallyCovers geospatiallyCovers) {
	...
	public INSURANCE_AGENCY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public INSURANCE_AGENCY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public INSURANCE_AGENCY(GeospatiallyEquals geospatiallyEquals) {
	...
	public INSURANCE_AGENCY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public INSURANCE_AGENCY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public INSURANCE_AGENCY(GeospatiallyTouches geospatiallyTouches) {
	...
	public INSURANCE_AGENCY(GeospatiallyWithin geospatiallyWithin) {
	...
	public INSURANCE_AGENCY(GlobalLocationNumber globalLocationNumber) {
	...
	public INSURANCE_AGENCY(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public INSURANCE_AGENCY(HasOfferCatalog hasOfferCatalog) {
	...
	public INSURANCE_AGENCY(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public INSURANCE_AGENCY(Identifier identifier) {
	...
	public INSURANCE_AGENCY(Image image) {
		setImage(image);
	}
	...
	public INSURANCE_AGENCY(IsAccessibleForFree isAccessibleForFree) {
	...
	public INSURANCE_AGENCY(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public INSURANCE_AGENCY(KnowsAbout knowsAbout) {
	...
	public INSURANCE_AGENCY(KnowsLanguage knowsLanguage) {
	...
	public INSURANCE_AGENCY(LegalName legalName) {
	...
	public INSURANCE_AGENCY(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public INSURANCE_AGENCY(Location location) {
	...
	public INSURANCE_AGENCY(Logo logo) {
		setLogo(logo);
	}
	...
	public INSURANCE_AGENCY(MainEntityOfPage mainEntityOfPage) {
	...
	public INSURANCE_AGENCY(MakesOffer makesOffer) {
	...
	public INSURANCE_AGENCY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public INSURANCE_AGENCY(Member member) {
		setMember(member);
	}
	...
	public INSURANCE_AGENCY(MemberOf memberOf) {
	...
	public INSURANCE_AGENCY(Naics naics) {
		setNaics(naics);
	}
	...
	public INSURANCE_AGENCY(Name name) {
		setName(name);
	}
	...
	public INSURANCE_AGENCY(NameFuzzy nameFuzzy) {
	...
	public INSURANCE_AGENCY(NameRuby nameRuby) {
	...
	public INSURANCE_AGENCY(NumberOfEmployees numberOfEmployees) {
	...
	public INSURANCE_AGENCY(OpeningHours openingHours) {
	...
	public INSURANCE_AGENCY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public INSURANCE_AGENCY(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public INSURANCE_AGENCY(Owns owns) {
		setOwns(owns);
	}
	...
	public INSURANCE_AGENCY(ParentOrganization parentOrganization) {
	...
	public INSURANCE_AGENCY(PaymentAccepted paymentAccepted) {
	...
	public INSURANCE_AGENCY(Photo photo) {
		setPhoto(photo);
	}
	...
	public INSURANCE_AGENCY(PotentialAction potentialAction) {
	...
	public INSURANCE_AGENCY(PriceRange priceRange) {
	...
	public INSURANCE_AGENCY(PublicAccess publicAccess) {
	...
	public INSURANCE_AGENCY(PublishingPrinciples publishingPrinciples) {
	...
	public INSURANCE_AGENCY(Review review) {
		setReview(review);
	}
	...
	public INSURANCE_AGENCY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public INSURANCE_AGENCY(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public INSURANCE_AGENCY(SmokingAllowed smokingAllowed) {
	...
	public INSURANCE_AGENCY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public INSURANCE_AGENCY(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public INSURANCE_AGENCY(SubOrganization subOrganization) {
	...
	public INSURANCE_AGENCY(SubjectOf subjectOf) {
	...
	public INSURANCE_AGENCY(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public INSURANCE_AGENCY(Telephone telephone) {
	...
	public INSURANCE_AGENCY(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public INSURANCE_AGENCY(Url url) {
		setUrl(url);
	}
	...
	public INSURANCE_AGENCY(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.InsuranceAgency org) {
		setSeq(org.getSeq());
