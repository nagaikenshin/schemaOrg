...
public class OFFICE_EQUIPMENT_STORE implements Clazz.OfficeEquipmentStore {
	...
	public OFFICE_EQUIPMENT_STORE() {
	}

	public OFFICE_EQUIPMENT_STORE(Long seq) {
		setSeq(seq);
	}

	public OFFICE_EQUIPMENT_STORE(String string) {
	...
	public OFFICE_EQUIPMENT_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public OFFICE_EQUIPMENT_STORE(AdditionalProperty additionalProperty) {
	...
	public OFFICE_EQUIPMENT_STORE(AdditionalType additionalType) {
	...
	public OFFICE_EQUIPMENT_STORE(Address address) {
		setAddress(address);
	}
	...
	public OFFICE_EQUIPMENT_STORE(AggregateRating aggregateRating) {
	...
	public OFFICE_EQUIPMENT_STORE(AlternateName alternateName) {
	...
	public OFFICE_EQUIPMENT_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public OFFICE_EQUIPMENT_STORE(AmenityFeature amenityFeature) {
	...
	public OFFICE_EQUIPMENT_STORE(AreaServed areaServed) {
	...
	public OFFICE_EQUIPMENT_STORE(Award award) {
		setAward(award);
	}
	...
	public OFFICE_EQUIPMENT_STORE(BranchCode branchCode) {
	...
	public OFFICE_EQUIPMENT_STORE(Brand brand) {
		setBrand(brand);
	}
	...
	public OFFICE_EQUIPMENT_STORE(ContactPoint contactPoint) {
	...
	public OFFICE_EQUIPMENT_STORE(ContainedInPlace containedInPlace) {
	...
	public OFFICE_EQUIPMENT_STORE(ContainsPlace containsPlace) {
	...
	public OFFICE_EQUIPMENT_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public OFFICE_EQUIPMENT_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public OFFICE_EQUIPMENT_STORE(Department department) {
	...
	public OFFICE_EQUIPMENT_STORE(Description description) {
	...
	public OFFICE_EQUIPMENT_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public OFFICE_EQUIPMENT_STORE(DissolutionDate dissolutionDate) {
	...
	public OFFICE_EQUIPMENT_STORE(DiversityPolicy diversityPolicy) {
	...
	public OFFICE_EQUIPMENT_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public OFFICE_EQUIPMENT_STORE(Duns duns) {
		setDuns(duns);
	}
	...
	public OFFICE_EQUIPMENT_STORE(Email email) {
		setEmail(email);
	}
	...
	public OFFICE_EQUIPMENT_STORE(Employee employee) {
	...
	public OFFICE_EQUIPMENT_STORE(EthicsPolicy ethicsPolicy) {
	...
	public OFFICE_EQUIPMENT_STORE(Event event) {
		setEvent(event);
	}
	...
	public OFFICE_EQUIPMENT_STORE(FaxNumber faxNumber) {
	...
	public OFFICE_EQUIPMENT_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public OFFICE_EQUIPMENT_STORE(FoundingDate foundingDate) {
	...
	public OFFICE_EQUIPMENT_STORE(FoundingLocation foundingLocation) {
	...
	public OFFICE_EQUIPMENT_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public OFFICE_EQUIPMENT_STORE(Geo geo) {
		setGeo(geo);
	}
	...
	public OFFICE_EQUIPMENT_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public OFFICE_EQUIPMENT_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public OFFICE_EQUIPMENT_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public OFFICE_EQUIPMENT_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public OFFICE_EQUIPMENT_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public OFFICE_EQUIPMENT_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public OFFICE_EQUIPMENT_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public OFFICE_EQUIPMENT_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public OFFICE_EQUIPMENT_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public OFFICE_EQUIPMENT_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public OFFICE_EQUIPMENT_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public OFFICE_EQUIPMENT_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public OFFICE_EQUIPMENT_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public OFFICE_EQUIPMENT_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public OFFICE_EQUIPMENT_STORE(Identifier identifier) {
	...
	public OFFICE_EQUIPMENT_STORE(Image image) {
		setImage(image);
	}
	...
	public OFFICE_EQUIPMENT_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public OFFICE_EQUIPMENT_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public OFFICE_EQUIPMENT_STORE(KnowsAbout knowsAbout) {
	...
	public OFFICE_EQUIPMENT_STORE(KnowsLanguage knowsLanguage) {
	...
	public OFFICE_EQUIPMENT_STORE(LegalName legalName) {
	...
	public OFFICE_EQUIPMENT_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public OFFICE_EQUIPMENT_STORE(Location location) {
	...
	public OFFICE_EQUIPMENT_STORE(Logo logo) {
		setLogo(logo);
	}
	...
	public OFFICE_EQUIPMENT_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public OFFICE_EQUIPMENT_STORE(MakesOffer makesOffer) {
	...
	public OFFICE_EQUIPMENT_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public OFFICE_EQUIPMENT_STORE(Member member) {
		setMember(member);
	}
	...
	public OFFICE_EQUIPMENT_STORE(MemberOf memberOf) {
	...
	public OFFICE_EQUIPMENT_STORE(Naics naics) {
		setNaics(naics);
	}
	...
	public OFFICE_EQUIPMENT_STORE(Name name) {
		setName(name);
	}
	...
	public OFFICE_EQUIPMENT_STORE(NameFuzzy nameFuzzy) {
	...
	public OFFICE_EQUIPMENT_STORE(NameRuby nameRuby) {
	...
	public OFFICE_EQUIPMENT_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public OFFICE_EQUIPMENT_STORE(OpeningHours openingHours) {
	...
	public OFFICE_EQUIPMENT_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public OFFICE_EQUIPMENT_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public OFFICE_EQUIPMENT_STORE(Owns owns) {
		setOwns(owns);
	}
	...
	public OFFICE_EQUIPMENT_STORE(ParentOrganization parentOrganization) {
	...
	public OFFICE_EQUIPMENT_STORE(PaymentAccepted paymentAccepted) {
	...
	public OFFICE_EQUIPMENT_STORE(Photo photo) {
		setPhoto(photo);
	}
	...
	public OFFICE_EQUIPMENT_STORE(PotentialAction potentialAction) {
	...
	public OFFICE_EQUIPMENT_STORE(PriceRange priceRange) {
	...
	public OFFICE_EQUIPMENT_STORE(PublicAccess publicAccess) {
	...
	public OFFICE_EQUIPMENT_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public OFFICE_EQUIPMENT_STORE(Review review) {
		setReview(review);
	}
	...
	public OFFICE_EQUIPMENT_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public OFFICE_EQUIPMENT_STORE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public OFFICE_EQUIPMENT_STORE(SmokingAllowed smokingAllowed) {
	...
	public OFFICE_EQUIPMENT_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public OFFICE_EQUIPMENT_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public OFFICE_EQUIPMENT_STORE(SubOrganization subOrganization) {
	...
	public OFFICE_EQUIPMENT_STORE(SubjectOf subjectOf) {
	...
	public OFFICE_EQUIPMENT_STORE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public OFFICE_EQUIPMENT_STORE(Telephone telephone) {
	...
	public OFFICE_EQUIPMENT_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public OFFICE_EQUIPMENT_STORE(Url url) {
		setUrl(url);
	}
	...
	public OFFICE_EQUIPMENT_STORE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.OfficeEquipmentStore org) {
		setSeq(org.getSeq());
