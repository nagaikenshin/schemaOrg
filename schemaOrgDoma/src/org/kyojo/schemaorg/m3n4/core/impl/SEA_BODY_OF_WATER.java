...
public class SEA_BODY_OF_WATER implements Clazz.SeaBodyOfWater {
	...
	public SEA_BODY_OF_WATER() {
	}

	public SEA_BODY_OF_WATER(Long seq) {
		setSeq(seq);
	}

	public SEA_BODY_OF_WATER(String string) {
	...
	public SEA_BODY_OF_WATER(AdditionalProperty additionalProperty) {
	...
	public SEA_BODY_OF_WATER(AdditionalType additionalType) {
	...
	public SEA_BODY_OF_WATER(Address address) {
		setAddress(address);
	}
	...
	public SEA_BODY_OF_WATER(AggregateRating aggregateRating) {
	...
	public SEA_BODY_OF_WATER(AlternateName alternateName) {
	...
	public SEA_BODY_OF_WATER(AmenityFeature amenityFeature) {
	...
	public SEA_BODY_OF_WATER(BranchCode branchCode) {
	...
	public SEA_BODY_OF_WATER(ContainedInPlace containedInPlace) {
	...
	public SEA_BODY_OF_WATER(ContainsPlace containsPlace) {
	...
	public SEA_BODY_OF_WATER(Description description) {
	...
	public SEA_BODY_OF_WATER(DisambiguatingDescription disambiguatingDescription) {
	...
	public SEA_BODY_OF_WATER(Event event) {
		setEvent(event);
	}
	...
	public SEA_BODY_OF_WATER(FaxNumber faxNumber) {
	...
	public SEA_BODY_OF_WATER(Geo geo) {
		setGeo(geo);
	}
	...
	public SEA_BODY_OF_WATER(GeospatiallyContains geospatiallyContains) {
	...
	public SEA_BODY_OF_WATER(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public SEA_BODY_OF_WATER(GeospatiallyCovers geospatiallyCovers) {
	...
	public SEA_BODY_OF_WATER(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public SEA_BODY_OF_WATER(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public SEA_BODY_OF_WATER(GeospatiallyEquals geospatiallyEquals) {
	...
	public SEA_BODY_OF_WATER(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public SEA_BODY_OF_WATER(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public SEA_BODY_OF_WATER(GeospatiallyTouches geospatiallyTouches) {
	...
	public SEA_BODY_OF_WATER(GeospatiallyWithin geospatiallyWithin) {
	...
	public SEA_BODY_OF_WATER(GlobalLocationNumber globalLocationNumber) {
	...
	public SEA_BODY_OF_WATER(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public SEA_BODY_OF_WATER(Identifier identifier) {
	...
	public SEA_BODY_OF_WATER(Image image) {
		setImage(image);
	}
	...
	public SEA_BODY_OF_WATER(IsAccessibleForFree isAccessibleForFree) {
	...
	public SEA_BODY_OF_WATER(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public SEA_BODY_OF_WATER(Logo logo) {
		setLogo(logo);
	}
	...
	public SEA_BODY_OF_WATER(MainEntityOfPage mainEntityOfPage) {
	...
	public SEA_BODY_OF_WATER(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public SEA_BODY_OF_WATER(Name name) {
		setName(name);
	}
	...
	public SEA_BODY_OF_WATER(NameFuzzy nameFuzzy) {
	...
	public SEA_BODY_OF_WATER(NameRuby nameRuby) {
	...
	public SEA_BODY_OF_WATER(OpeningHoursSpecification openingHoursSpecification) {
	...
	public SEA_BODY_OF_WATER(Photo photo) {
		setPhoto(photo);
	}
	...
	public SEA_BODY_OF_WATER(PotentialAction potentialAction) {
	...
	public SEA_BODY_OF_WATER(PublicAccess publicAccess) {
	...
	public SEA_BODY_OF_WATER(Review review) {
		setReview(review);
	}
	...
	public SEA_BODY_OF_WATER(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SEA_BODY_OF_WATER(SmokingAllowed smokingAllowed) {
	...
	public SEA_BODY_OF_WATER(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public SEA_BODY_OF_WATER(SubjectOf subjectOf) {
	...
	public SEA_BODY_OF_WATER(Telephone telephone) {
	...
	public SEA_BODY_OF_WATER(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.SeaBodyOfWater org) {
		setSeq(org.getSeq());
