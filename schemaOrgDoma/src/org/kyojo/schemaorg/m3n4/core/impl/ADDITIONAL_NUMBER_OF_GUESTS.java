...
public class ADDITIONAL_NUMBER_OF_GUESTS implements Container.AdditionalNumberOfGuests {
	...
	public ADDITIONAL_NUMBER_OF_GUESTS(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public ADDITIONAL_NUMBER_OF_GUESTS(Float fl0at) {
	...
	public ADDITIONAL_NUMBER_OF_GUESTS(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public ADDITIONAL_NUMBER_OF_GUESTS(Integer integer) {
	...
	public ADDITIONAL_NUMBER_OF_GUESTS(List<Float> fl0atList,
	...
	public void copy(Container.AdditionalNumberOfGuests org) {
