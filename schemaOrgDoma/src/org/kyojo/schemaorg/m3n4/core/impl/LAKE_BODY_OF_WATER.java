...
public class LAKE_BODY_OF_WATER implements Clazz.LakeBodyOfWater {
	...
	public LAKE_BODY_OF_WATER() {
	}

	public LAKE_BODY_OF_WATER(Long seq) {
		setSeq(seq);
	}

	public LAKE_BODY_OF_WATER(String string) {
	...
	public LAKE_BODY_OF_WATER(AdditionalProperty additionalProperty) {
	...
	public LAKE_BODY_OF_WATER(AdditionalType additionalType) {
	...
	public LAKE_BODY_OF_WATER(Address address) {
		setAddress(address);
	}
	...
	public LAKE_BODY_OF_WATER(AggregateRating aggregateRating) {
	...
	public LAKE_BODY_OF_WATER(AlternateName alternateName) {
	...
	public LAKE_BODY_OF_WATER(AmenityFeature amenityFeature) {
	...
	public LAKE_BODY_OF_WATER(BranchCode branchCode) {
	...
	public LAKE_BODY_OF_WATER(ContainedInPlace containedInPlace) {
	...
	public LAKE_BODY_OF_WATER(ContainsPlace containsPlace) {
	...
	public LAKE_BODY_OF_WATER(Description description) {
	...
	public LAKE_BODY_OF_WATER(DisambiguatingDescription disambiguatingDescription) {
	...
	public LAKE_BODY_OF_WATER(Event event) {
		setEvent(event);
	}
	...
	public LAKE_BODY_OF_WATER(FaxNumber faxNumber) {
	...
	public LAKE_BODY_OF_WATER(Geo geo) {
		setGeo(geo);
	}
	...
	public LAKE_BODY_OF_WATER(GeospatiallyContains geospatiallyContains) {
	...
	public LAKE_BODY_OF_WATER(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public LAKE_BODY_OF_WATER(GeospatiallyCovers geospatiallyCovers) {
	...
	public LAKE_BODY_OF_WATER(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public LAKE_BODY_OF_WATER(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public LAKE_BODY_OF_WATER(GeospatiallyEquals geospatiallyEquals) {
	...
	public LAKE_BODY_OF_WATER(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public LAKE_BODY_OF_WATER(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public LAKE_BODY_OF_WATER(GeospatiallyTouches geospatiallyTouches) {
	...
	public LAKE_BODY_OF_WATER(GeospatiallyWithin geospatiallyWithin) {
	...
	public LAKE_BODY_OF_WATER(GlobalLocationNumber globalLocationNumber) {
	...
	public LAKE_BODY_OF_WATER(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public LAKE_BODY_OF_WATER(Identifier identifier) {
	...
	public LAKE_BODY_OF_WATER(Image image) {
		setImage(image);
	}
	...
	public LAKE_BODY_OF_WATER(IsAccessibleForFree isAccessibleForFree) {
	...
	public LAKE_BODY_OF_WATER(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public LAKE_BODY_OF_WATER(Logo logo) {
		setLogo(logo);
	}
	...
	public LAKE_BODY_OF_WATER(MainEntityOfPage mainEntityOfPage) {
	...
	public LAKE_BODY_OF_WATER(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public LAKE_BODY_OF_WATER(Name name) {
		setName(name);
	}
	...
	public LAKE_BODY_OF_WATER(NameFuzzy nameFuzzy) {
	...
	public LAKE_BODY_OF_WATER(NameRuby nameRuby) {
	...
	public LAKE_BODY_OF_WATER(OpeningHoursSpecification openingHoursSpecification) {
	...
	public LAKE_BODY_OF_WATER(Photo photo) {
		setPhoto(photo);
	}
	...
	public LAKE_BODY_OF_WATER(PotentialAction potentialAction) {
	...
	public LAKE_BODY_OF_WATER(PublicAccess publicAccess) {
	...
	public LAKE_BODY_OF_WATER(Review review) {
		setReview(review);
	}
	...
	public LAKE_BODY_OF_WATER(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public LAKE_BODY_OF_WATER(SmokingAllowed smokingAllowed) {
	...
	public LAKE_BODY_OF_WATER(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public LAKE_BODY_OF_WATER(SubjectOf subjectOf) {
	...
	public LAKE_BODY_OF_WATER(Telephone telephone) {
	...
	public LAKE_BODY_OF_WATER(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.LakeBodyOfWater org) {
		setSeq(org.getSeq());
