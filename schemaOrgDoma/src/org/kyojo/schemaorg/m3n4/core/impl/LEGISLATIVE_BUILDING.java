...
public class LEGISLATIVE_BUILDING implements Clazz.LegislativeBuilding {
	...
	public LEGISLATIVE_BUILDING() {
	}

	public LEGISLATIVE_BUILDING(Long seq) {
		setSeq(seq);
	}

	public LEGISLATIVE_BUILDING(String string) {
	...
	public LEGISLATIVE_BUILDING(AdditionalProperty additionalProperty) {
	...
	public LEGISLATIVE_BUILDING(AdditionalType additionalType) {
	...
	public LEGISLATIVE_BUILDING(Address address) {
		setAddress(address);
	}
	...
	public LEGISLATIVE_BUILDING(AggregateRating aggregateRating) {
	...
	public LEGISLATIVE_BUILDING(AlternateName alternateName) {
	...
	public LEGISLATIVE_BUILDING(AmenityFeature amenityFeature) {
	...
	public LEGISLATIVE_BUILDING(BranchCode branchCode) {
	...
	public LEGISLATIVE_BUILDING(ContainedInPlace containedInPlace) {
	...
	public LEGISLATIVE_BUILDING(ContainsPlace containsPlace) {
	...
	public LEGISLATIVE_BUILDING(Description description) {
	...
	public LEGISLATIVE_BUILDING(DisambiguatingDescription disambiguatingDescription) {
	...
	public LEGISLATIVE_BUILDING(Event event) {
		setEvent(event);
	}
	...
	public LEGISLATIVE_BUILDING(FaxNumber faxNumber) {
	...
	public LEGISLATIVE_BUILDING(Geo geo) {
		setGeo(geo);
	}
	...
	public LEGISLATIVE_BUILDING(GeospatiallyContains geospatiallyContains) {
	...
	public LEGISLATIVE_BUILDING(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public LEGISLATIVE_BUILDING(GeospatiallyCovers geospatiallyCovers) {
	...
	public LEGISLATIVE_BUILDING(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public LEGISLATIVE_BUILDING(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public LEGISLATIVE_BUILDING(GeospatiallyEquals geospatiallyEquals) {
	...
	public LEGISLATIVE_BUILDING(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public LEGISLATIVE_BUILDING(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public LEGISLATIVE_BUILDING(GeospatiallyTouches geospatiallyTouches) {
	...
	public LEGISLATIVE_BUILDING(GeospatiallyWithin geospatiallyWithin) {
	...
	public LEGISLATIVE_BUILDING(GlobalLocationNumber globalLocationNumber) {
	...
	public LEGISLATIVE_BUILDING(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public LEGISLATIVE_BUILDING(Identifier identifier) {
	...
	public LEGISLATIVE_BUILDING(Image image) {
		setImage(image);
	}
	...
	public LEGISLATIVE_BUILDING(IsAccessibleForFree isAccessibleForFree) {
	...
	public LEGISLATIVE_BUILDING(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public LEGISLATIVE_BUILDING(Logo logo) {
		setLogo(logo);
	}
	...
	public LEGISLATIVE_BUILDING(MainEntityOfPage mainEntityOfPage) {
	...
	public LEGISLATIVE_BUILDING(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public LEGISLATIVE_BUILDING(Name name) {
		setName(name);
	}
	...
	public LEGISLATIVE_BUILDING(NameFuzzy nameFuzzy) {
	...
	public LEGISLATIVE_BUILDING(NameRuby nameRuby) {
	...
	public LEGISLATIVE_BUILDING(OpeningHours openingHours) {
	...
	public LEGISLATIVE_BUILDING(OpeningHoursSpecification openingHoursSpecification) {
	...
	public LEGISLATIVE_BUILDING(Photo photo) {
		setPhoto(photo);
	}
	...
	public LEGISLATIVE_BUILDING(PotentialAction potentialAction) {
	...
	public LEGISLATIVE_BUILDING(PublicAccess publicAccess) {
	...
	public LEGISLATIVE_BUILDING(Review review) {
		setReview(review);
	}
	...
	public LEGISLATIVE_BUILDING(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public LEGISLATIVE_BUILDING(SmokingAllowed smokingAllowed) {
	...
	public LEGISLATIVE_BUILDING(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public LEGISLATIVE_BUILDING(SubjectOf subjectOf) {
	...
	public LEGISLATIVE_BUILDING(Telephone telephone) {
	...
	public LEGISLATIVE_BUILDING(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.LegislativeBuilding org) {
		setSeq(org.getSeq());
