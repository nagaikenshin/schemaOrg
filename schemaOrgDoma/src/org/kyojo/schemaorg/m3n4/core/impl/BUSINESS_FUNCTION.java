...
public class BUSINESS_FUNCTION implements Clazz.BusinessFunction, Container.BusinessFunction {
	...
	public BUSINESS_FUNCTION(Long seq) {
		setSeq(seq);
	}

	public BUSINESS_FUNCTION(String string) {
	...
	public BUSINESS_FUNCTION(AdditionalType additionalType) {
	...
	public BUSINESS_FUNCTION(AlternateName alternateName) {
	...
	public BUSINESS_FUNCTION(Clazz.BusinessFunction businessFunction) {
		businessFunctionList = new ArrayList<Clazz.BusinessFunction>();
	...
	public BUSINESS_FUNCTION(Description description) {
	...
	public BUSINESS_FUNCTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public BUSINESS_FUNCTION(Identifier identifier) {
	...
	public BUSINESS_FUNCTION(Image image) {
		setImage(image);
	}
	...
	public BUSINESS_FUNCTION(MainEntityOfPage mainEntityOfPage) {
	...
	public BUSINESS_FUNCTION(Name name) {
		setName(name);
	}
	...
	public BUSINESS_FUNCTION(NameFuzzy nameFuzzy) {
	...
	public BUSINESS_FUNCTION(NameRuby nameRuby) {
	...
	public BUSINESS_FUNCTION(PotentialAction potentialAction) {
	...
	public BUSINESS_FUNCTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public BUSINESS_FUNCTION(SubjectOf subjectOf) {
	...
	public BUSINESS_FUNCTION(SupersededBy supersededBy) {
	...
	public BUSINESS_FUNCTION(Url url) {
		setUrl(url);
	}
	...
	public BUSINESS_FUNCTION(Long seq,
			...
			List<Clazz.BusinessFunction> businessFunctionList,
		...
		setAdditionalType(additionalType);
		setAlternateName(alternateName);
		setBusinessFunctionList(businessFunctionList);
		setDescription(description);
		setDisambiguatingDescription(disambiguatingDescription);
		setIdentifier(identifier);
		setImage(image);
	...
	public void copy(Clazz.BusinessFunction org) {
		setSeq(org.getSeq());
	...
	public void copy(Container.BusinessFunction org) {
