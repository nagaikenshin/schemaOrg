...
public class BANK_OR_CREDIT_UNION implements Clazz.BankOrCreditUnion {
	...
	public BANK_OR_CREDIT_UNION() {
	}

	public BANK_OR_CREDIT_UNION(Long seq) {
		setSeq(seq);
	}

	public BANK_OR_CREDIT_UNION(String string) {
	...
	public BANK_OR_CREDIT_UNION(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public BANK_OR_CREDIT_UNION(AdditionalProperty additionalProperty) {
	...
	public BANK_OR_CREDIT_UNION(AdditionalType additionalType) {
	...
	public BANK_OR_CREDIT_UNION(Address address) {
		setAddress(address);
	}
	...
	public BANK_OR_CREDIT_UNION(AggregateRating aggregateRating) {
	...
	public BANK_OR_CREDIT_UNION(AlternateName alternateName) {
	...
	public BANK_OR_CREDIT_UNION(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public BANK_OR_CREDIT_UNION(AmenityFeature amenityFeature) {
	...
	public BANK_OR_CREDIT_UNION(AreaServed areaServed) {
	...
	public BANK_OR_CREDIT_UNION(Award award) {
		setAward(award);
	}
	...
	public BANK_OR_CREDIT_UNION(BranchCode branchCode) {
	...
	public BANK_OR_CREDIT_UNION(Brand brand) {
		setBrand(brand);
	}
	...
	public BANK_OR_CREDIT_UNION(ContactPoint contactPoint) {
	...
	public BANK_OR_CREDIT_UNION(ContainedInPlace containedInPlace) {
	...
	public BANK_OR_CREDIT_UNION(ContainsPlace containsPlace) {
	...
	public BANK_OR_CREDIT_UNION(CorrectionsPolicy correctionsPolicy) {
	...
	public BANK_OR_CREDIT_UNION(CurrenciesAccepted currenciesAccepted) {
	...
	public BANK_OR_CREDIT_UNION(Department department) {
	...
	public BANK_OR_CREDIT_UNION(Description description) {
	...
	public BANK_OR_CREDIT_UNION(DisambiguatingDescription disambiguatingDescription) {
	...
	public BANK_OR_CREDIT_UNION(DissolutionDate dissolutionDate) {
	...
	public BANK_OR_CREDIT_UNION(DiversityPolicy diversityPolicy) {
	...
	public BANK_OR_CREDIT_UNION(DiversityStaffingReport diversityStaffingReport) {
	...
	public BANK_OR_CREDIT_UNION(Duns duns) {
		setDuns(duns);
	}
	...
	public BANK_OR_CREDIT_UNION(Email email) {
		setEmail(email);
	}
	...
	public BANK_OR_CREDIT_UNION(Employee employee) {
	...
	public BANK_OR_CREDIT_UNION(EthicsPolicy ethicsPolicy) {
	...
	public BANK_OR_CREDIT_UNION(Event event) {
		setEvent(event);
	}
	...
	public BANK_OR_CREDIT_UNION(FaxNumber faxNumber) {
	...
	public BANK_OR_CREDIT_UNION(FeesAndCommissionsSpecification feesAndCommissionsSpecification) {
	...
	public BANK_OR_CREDIT_UNION(Founder founder) {
		setFounder(founder);
	}
	...
	public BANK_OR_CREDIT_UNION(FoundingDate foundingDate) {
	...
	public BANK_OR_CREDIT_UNION(FoundingLocation foundingLocation) {
	...
	public BANK_OR_CREDIT_UNION(Funder funder) {
		setFunder(funder);
	}
	...
	public BANK_OR_CREDIT_UNION(Geo geo) {
		setGeo(geo);
	}
	...
	public BANK_OR_CREDIT_UNION(GeospatiallyContains geospatiallyContains) {
	...
	public BANK_OR_CREDIT_UNION(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public BANK_OR_CREDIT_UNION(GeospatiallyCovers geospatiallyCovers) {
	...
	public BANK_OR_CREDIT_UNION(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public BANK_OR_CREDIT_UNION(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public BANK_OR_CREDIT_UNION(GeospatiallyEquals geospatiallyEquals) {
	...
	public BANK_OR_CREDIT_UNION(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public BANK_OR_CREDIT_UNION(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public BANK_OR_CREDIT_UNION(GeospatiallyTouches geospatiallyTouches) {
	...
	public BANK_OR_CREDIT_UNION(GeospatiallyWithin geospatiallyWithin) {
	...
	public BANK_OR_CREDIT_UNION(GlobalLocationNumber globalLocationNumber) {
	...
	public BANK_OR_CREDIT_UNION(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public BANK_OR_CREDIT_UNION(HasOfferCatalog hasOfferCatalog) {
	...
	public BANK_OR_CREDIT_UNION(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public BANK_OR_CREDIT_UNION(Identifier identifier) {
	...
	public BANK_OR_CREDIT_UNION(Image image) {
		setImage(image);
	}
	...
	public BANK_OR_CREDIT_UNION(IsAccessibleForFree isAccessibleForFree) {
	...
	public BANK_OR_CREDIT_UNION(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public BANK_OR_CREDIT_UNION(KnowsAbout knowsAbout) {
	...
	public BANK_OR_CREDIT_UNION(KnowsLanguage knowsLanguage) {
	...
	public BANK_OR_CREDIT_UNION(LegalName legalName) {
	...
	public BANK_OR_CREDIT_UNION(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public BANK_OR_CREDIT_UNION(Location location) {
	...
	public BANK_OR_CREDIT_UNION(Logo logo) {
		setLogo(logo);
	}
	...
	public BANK_OR_CREDIT_UNION(MainEntityOfPage mainEntityOfPage) {
	...
	public BANK_OR_CREDIT_UNION(MakesOffer makesOffer) {
	...
	public BANK_OR_CREDIT_UNION(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public BANK_OR_CREDIT_UNION(Member member) {
		setMember(member);
	}
	...
	public BANK_OR_CREDIT_UNION(MemberOf memberOf) {
	...
	public BANK_OR_CREDIT_UNION(Naics naics) {
		setNaics(naics);
	}
	...
	public BANK_OR_CREDIT_UNION(Name name) {
		setName(name);
	}
	...
	public BANK_OR_CREDIT_UNION(NameFuzzy nameFuzzy) {
	...
	public BANK_OR_CREDIT_UNION(NameRuby nameRuby) {
	...
	public BANK_OR_CREDIT_UNION(NumberOfEmployees numberOfEmployees) {
	...
	public BANK_OR_CREDIT_UNION(OpeningHours openingHours) {
	...
	public BANK_OR_CREDIT_UNION(OpeningHoursSpecification openingHoursSpecification) {
	...
	public BANK_OR_CREDIT_UNION(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public BANK_OR_CREDIT_UNION(Owns owns) {
		setOwns(owns);
	}
	...
	public BANK_OR_CREDIT_UNION(ParentOrganization parentOrganization) {
	...
	public BANK_OR_CREDIT_UNION(PaymentAccepted paymentAccepted) {
	...
	public BANK_OR_CREDIT_UNION(Photo photo) {
		setPhoto(photo);
	}
	...
	public BANK_OR_CREDIT_UNION(PotentialAction potentialAction) {
	...
	public BANK_OR_CREDIT_UNION(PriceRange priceRange) {
	...
	public BANK_OR_CREDIT_UNION(PublicAccess publicAccess) {
	...
	public BANK_OR_CREDIT_UNION(PublishingPrinciples publishingPrinciples) {
	...
	public BANK_OR_CREDIT_UNION(Review review) {
		setReview(review);
	}
	...
	public BANK_OR_CREDIT_UNION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public BANK_OR_CREDIT_UNION(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public BANK_OR_CREDIT_UNION(SmokingAllowed smokingAllowed) {
	...
	public BANK_OR_CREDIT_UNION(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public BANK_OR_CREDIT_UNION(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public BANK_OR_CREDIT_UNION(SubOrganization subOrganization) {
	...
	public BANK_OR_CREDIT_UNION(SubjectOf subjectOf) {
	...
	public BANK_OR_CREDIT_UNION(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public BANK_OR_CREDIT_UNION(Telephone telephone) {
	...
	public BANK_OR_CREDIT_UNION(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public BANK_OR_CREDIT_UNION(Url url) {
		setUrl(url);
	}
	...
	public BANK_OR_CREDIT_UNION(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.BankOrCreditUnion org) {
		setSeq(org.getSeq());
