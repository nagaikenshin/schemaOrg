...
public class WEIGHT implements Container.Weight {
	...
	public WEIGHT(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public WEIGHT(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public WEIGHT(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public WEIGHT(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.Weight org) {
