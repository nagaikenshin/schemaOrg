...
public class WATCH_ACTION implements Clazz.WatchAction {
	...
	public WATCH_ACTION(Long seq) {
		setSeq(seq);
	}

	public WATCH_ACTION(String string) {
	...
	public WATCH_ACTION(ActionAccessibilityRequirement actionAccessibilityRequirement) {
	...
	public WATCH_ACTION(ActionStatus actionStatus) {
	...
	public WATCH_ACTION(AdditionalType additionalType) {
	...
	public WATCH_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public WATCH_ACTION(AlternateName alternateName) {
	...
	public WATCH_ACTION(Description description) {
	...
	public WATCH_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public WATCH_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public WATCH_ACTION(Error error) {
		setError(error);
	}
	...
	public WATCH_ACTION(ExpectsAcceptanceOf expectsAcceptanceOf) {
	...
	public WATCH_ACTION(Identifier identifier) {
	...
	public WATCH_ACTION(Image image) {
		setImage(image);
	}
	...
	public WATCH_ACTION(Instrument instrument) {
	...
	public WATCH_ACTION(Location location) {
	...
	public WATCH_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public WATCH_ACTION(NameFuzzy nameFuzzy) {
	...
	public WATCH_ACTION(NameRuby nameRuby) {
	...
	public WATCH_ACTION(Object object) {
		setObject(object);
	}
	...
	public WATCH_ACTION(Participant participant) {
	...
	public WATCH_ACTION(PotentialAction potentialAction) {
	...
	public WATCH_ACTION(Result result) {
		setResult(result);
	}
	...
	public WATCH_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public WATCH_ACTION(StartTime startTime) {
	...
	public WATCH_ACTION(SubjectOf subjectOf) {
	...
	public WATCH_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.WatchAction org) {
		setSeq(org.getSeq());
