...
public class PAWN_SHOP implements Clazz.PawnShop {
	...
	public PAWN_SHOP(Long seq) {
		setSeq(seq);
	}

	public PAWN_SHOP(String string) {
	...
	public PAWN_SHOP(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public PAWN_SHOP(AdditionalProperty additionalProperty) {
	...
	public PAWN_SHOP(AdditionalType additionalType) {
	...
	public PAWN_SHOP(Address address) {
		setAddress(address);
	}
	...
	public PAWN_SHOP(AggregateRating aggregateRating) {
	...
	public PAWN_SHOP(AlternateName alternateName) {
	...
	public PAWN_SHOP(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public PAWN_SHOP(AmenityFeature amenityFeature) {
	...
	public PAWN_SHOP(AreaServed areaServed) {
	...
	public PAWN_SHOP(BranchCode branchCode) {
	...
	public PAWN_SHOP(ContactPoint contactPoint) {
	...
	public PAWN_SHOP(ContainedInPlace containedInPlace) {
	...
	public PAWN_SHOP(ContainsPlace containsPlace) {
	...
	public PAWN_SHOP(CorrectionsPolicy correctionsPolicy) {
	...
	public PAWN_SHOP(CurrenciesAccepted currenciesAccepted) {
	...
	public PAWN_SHOP(Department department) {
	...
	public PAWN_SHOP(Description description) {
	...
	public PAWN_SHOP(DisambiguatingDescription disambiguatingDescription) {
	...
	public PAWN_SHOP(DissolutionDate dissolutionDate) {
	...
	public PAWN_SHOP(DiversityPolicy diversityPolicy) {
	...
	public PAWN_SHOP(DiversityStaffingReport diversityStaffingReport) {
	...
	public PAWN_SHOP(Employee employee) {
	...
	public PAWN_SHOP(EthicsPolicy ethicsPolicy) {
	...
	public PAWN_SHOP(FaxNumber faxNumber) {
	...
	public PAWN_SHOP(Founder founder) {
		setFounder(founder);
	}
	...
	public PAWN_SHOP(FoundingDate foundingDate) {
	...
	public PAWN_SHOP(FoundingLocation foundingLocation) {
	...
	public PAWN_SHOP(Funder funder) {
		setFunder(funder);
	}
	...
	public PAWN_SHOP(GeospatiallyContains geospatiallyContains) {
	...
	public PAWN_SHOP(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public PAWN_SHOP(GeospatiallyCovers geospatiallyCovers) {
	...
	public PAWN_SHOP(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public PAWN_SHOP(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public PAWN_SHOP(GeospatiallyEquals geospatiallyEquals) {
	...
	public PAWN_SHOP(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public PAWN_SHOP(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public PAWN_SHOP(GeospatiallyTouches geospatiallyTouches) {
	...
	public PAWN_SHOP(GeospatiallyWithin geospatiallyWithin) {
	...
	public PAWN_SHOP(GlobalLocationNumber globalLocationNumber) {
	...
	public PAWN_SHOP(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public PAWN_SHOP(HasOfferCatalog hasOfferCatalog) {
	...
	public PAWN_SHOP(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public PAWN_SHOP(Identifier identifier) {
	...
	public PAWN_SHOP(IsAccessibleForFree isAccessibleForFree) {
	...
	public PAWN_SHOP(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public PAWN_SHOP(KnowsAbout knowsAbout) {
	...
	public PAWN_SHOP(KnowsLanguage knowsLanguage) {
	...
	public PAWN_SHOP(LegalName legalName) {
	...
	public PAWN_SHOP(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public PAWN_SHOP(Location location) {
	...
	public PAWN_SHOP(MainEntityOfPage mainEntityOfPage) {
	...
	public PAWN_SHOP(MakesOffer makesOffer) {
	...
	public PAWN_SHOP(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public PAWN_SHOP(Member member) {
		setMember(member);
	}
	...
	public PAWN_SHOP(MemberOf memberOf) {
	...
	public PAWN_SHOP(NameFuzzy nameFuzzy) {
	...
	public PAWN_SHOP(NameRuby nameRuby) {
	...
	public PAWN_SHOP(NumberOfEmployees numberOfEmployees) {
	...
	public PAWN_SHOP(OpeningHours openingHours) {
	...
	public PAWN_SHOP(OpeningHoursSpecification openingHoursSpecification) {
	...
	public PAWN_SHOP(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public PAWN_SHOP(ParentOrganization parentOrganization) {
	...
	public PAWN_SHOP(PaymentAccepted paymentAccepted) {
	...
	public PAWN_SHOP(PotentialAction potentialAction) {
	...
	public PAWN_SHOP(PriceRange priceRange) {
	...
	public PAWN_SHOP(PublicAccess publicAccess) {
	...
	public PAWN_SHOP(PublishingPrinciples publishingPrinciples) {
	...
	public PAWN_SHOP(Review review) {
		setReview(review);
	}
	...
	public PAWN_SHOP(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PAWN_SHOP(SmokingAllowed smokingAllowed) {
	...
	public PAWN_SHOP(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public PAWN_SHOP(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public PAWN_SHOP(SubOrganization subOrganization) {
	...
	public PAWN_SHOP(SubjectOf subjectOf) {
	...
	public PAWN_SHOP(Telephone telephone) {
	...
	public PAWN_SHOP(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.PawnShop org) {
		setSeq(org.getSeq());
