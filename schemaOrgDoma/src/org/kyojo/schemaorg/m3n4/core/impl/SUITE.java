...
public class SUITE implements Clazz.Suite {
	...
	public SUITE(Long seq) {
		setSeq(seq);
	}

	public SUITE(String string) {
	...
	public SUITE(AdditionalProperty additionalProperty) {
	...
	public SUITE(AdditionalType additionalType) {
	...
	public SUITE(AggregateRating aggregateRating) {
	...
	public SUITE(AlternateName alternateName) {
	...
	public SUITE(AmenityFeature amenityFeature) {
	...
	public SUITE(BranchCode branchCode) {
	...
	public SUITE(ContainedInPlace containedInPlace) {
	...
	public SUITE(ContainsPlace containsPlace) {
	...
	public SUITE(DisambiguatingDescription disambiguatingDescription) {
	...
	public SUITE(FaxNumber faxNumber) {
	...
	public SUITE(FloorSize floorSize) {
	...
	public SUITE(GeospatiallyContains geospatiallyContains) {
	...
	public SUITE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public SUITE(GeospatiallyCovers geospatiallyCovers) {
	...
	public SUITE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public SUITE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public SUITE(GeospatiallyEquals geospatiallyEquals) {
	...
	public SUITE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public SUITE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public SUITE(GeospatiallyTouches geospatiallyTouches) {
	...
	public SUITE(GeospatiallyWithin geospatiallyWithin) {
	...
	public SUITE(GlobalLocationNumber globalLocationNumber) {
	...
	public SUITE(Identifier identifier) {
	...
	public SUITE(IsAccessibleForFree isAccessibleForFree) {
	...
	public SUITE(MainEntityOfPage mainEntityOfPage) {
	...
	public SUITE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public SUITE(NameFuzzy nameFuzzy) {
	...
	public SUITE(NameRuby nameRuby) {
	...
	public SUITE(NumberOfRooms numberOfRooms) {
	...
	public SUITE(Occupancy occupancy) {
	...
	public SUITE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public SUITE(PermittedUsage permittedUsage) {
	...
	public SUITE(PetsAllowed petsAllowed) {
	...
	public SUITE(PotentialAction potentialAction) {
	...
	public SUITE(PublicAccess publicAccess) {
	...
	public SUITE(SmokingAllowed smokingAllowed) {
	...
	public SUITE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public SUITE(SubjectOf subjectOf) {
	...
	public SUITE(Telephone telephone) {
	...
	public void copy(Clazz.Suite org) {
		setSeq(org.getSeq());
