...
public class CREMATORIUM implements Clazz.Crematorium {
	...
	public CREMATORIUM(Long seq) {
		setSeq(seq);
	}

	public CREMATORIUM(String string) {
	...
	public CREMATORIUM(AdditionalProperty additionalProperty) {
	...
	public CREMATORIUM(AdditionalType additionalType) {
	...
	public CREMATORIUM(Address address) {
		setAddress(address);
	}
	...
	public CREMATORIUM(AggregateRating aggregateRating) {
	...
	public CREMATORIUM(AlternateName alternateName) {
	...
	public CREMATORIUM(AmenityFeature amenityFeature) {
	...
	public CREMATORIUM(BranchCode branchCode) {
	...
	public CREMATORIUM(ContainedInPlace containedInPlace) {
	...
	public CREMATORIUM(ContainsPlace containsPlace) {
	...
	public CREMATORIUM(Description description) {
	...
	public CREMATORIUM(DisambiguatingDescription disambiguatingDescription) {
	...
	public CREMATORIUM(Event event) {
		setEvent(event);
	}
	...
	public CREMATORIUM(FaxNumber faxNumber) {
	...
	public CREMATORIUM(GeospatiallyContains geospatiallyContains) {
	...
	public CREMATORIUM(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public CREMATORIUM(GeospatiallyCovers geospatiallyCovers) {
	...
	public CREMATORIUM(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public CREMATORIUM(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public CREMATORIUM(GeospatiallyEquals geospatiallyEquals) {
	...
	public CREMATORIUM(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public CREMATORIUM(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public CREMATORIUM(GeospatiallyTouches geospatiallyTouches) {
	...
	public CREMATORIUM(GeospatiallyWithin geospatiallyWithin) {
	...
	public CREMATORIUM(GlobalLocationNumber globalLocationNumber) {
	...
	public CREMATORIUM(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public CREMATORIUM(Identifier identifier) {
	...
	public CREMATORIUM(Image image) {
		setImage(image);
	}
	...
	public CREMATORIUM(IsAccessibleForFree isAccessibleForFree) {
	...
	public CREMATORIUM(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public CREMATORIUM(MainEntityOfPage mainEntityOfPage) {
	...
	public CREMATORIUM(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public CREMATORIUM(NameFuzzy nameFuzzy) {
	...
	public CREMATORIUM(NameRuby nameRuby) {
	...
	public CREMATORIUM(OpeningHours openingHours) {
	...
	public CREMATORIUM(OpeningHoursSpecification openingHoursSpecification) {
	...
	public CREMATORIUM(Photo photo) {
		setPhoto(photo);
	}
	...
	public CREMATORIUM(PotentialAction potentialAction) {
	...
	public CREMATORIUM(PublicAccess publicAccess) {
	...
	public CREMATORIUM(Review review) {
		setReview(review);
	}
	...
	public CREMATORIUM(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CREMATORIUM(SmokingAllowed smokingAllowed) {
	...
	public CREMATORIUM(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public CREMATORIUM(SubjectOf subjectOf) {
	...
	public CREMATORIUM(Telephone telephone) {
	...
	public void copy(Clazz.Crematorium org) {
		setSeq(org.getSeq());
