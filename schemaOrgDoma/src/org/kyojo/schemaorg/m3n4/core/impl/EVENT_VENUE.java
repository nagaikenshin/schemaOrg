...
public class EVENT_VENUE implements Clazz.EventVenue {
	...
	public EVENT_VENUE(Long seq) {
		setSeq(seq);
	}

	public EVENT_VENUE(String string) {
	...
	public EVENT_VENUE(AdditionalProperty additionalProperty) {
	...
	public EVENT_VENUE(AdditionalType additionalType) {
	...
	public EVENT_VENUE(Address address) {
		setAddress(address);
	}
	...
	public EVENT_VENUE(AggregateRating aggregateRating) {
	...
	public EVENT_VENUE(AlternateName alternateName) {
	...
	public EVENT_VENUE(AmenityFeature amenityFeature) {
	...
	public EVENT_VENUE(BranchCode branchCode) {
	...
	public EVENT_VENUE(ContainedInPlace containedInPlace) {
	...
	public EVENT_VENUE(ContainsPlace containsPlace) {
	...
	public EVENT_VENUE(Description description) {
	...
	public EVENT_VENUE(DisambiguatingDescription disambiguatingDescription) {
	...
	public EVENT_VENUE(Event event) {
		setEvent(event);
	}
	...
	public EVENT_VENUE(FaxNumber faxNumber) {
	...
	public EVENT_VENUE(GeospatiallyContains geospatiallyContains) {
	...
	public EVENT_VENUE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public EVENT_VENUE(GeospatiallyCovers geospatiallyCovers) {
	...
	public EVENT_VENUE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public EVENT_VENUE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public EVENT_VENUE(GeospatiallyEquals geospatiallyEquals) {
	...
	public EVENT_VENUE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public EVENT_VENUE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public EVENT_VENUE(GeospatiallyTouches geospatiallyTouches) {
	...
	public EVENT_VENUE(GeospatiallyWithin geospatiallyWithin) {
	...
	public EVENT_VENUE(GlobalLocationNumber globalLocationNumber) {
	...
	public EVENT_VENUE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public EVENT_VENUE(Identifier identifier) {
	...
	public EVENT_VENUE(Image image) {
		setImage(image);
	}
	...
	public EVENT_VENUE(IsAccessibleForFree isAccessibleForFree) {
	...
	public EVENT_VENUE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public EVENT_VENUE(MainEntityOfPage mainEntityOfPage) {
	...
	public EVENT_VENUE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public EVENT_VENUE(NameFuzzy nameFuzzy) {
	...
	public EVENT_VENUE(NameRuby nameRuby) {
	...
	public EVENT_VENUE(OpeningHours openingHours) {
	...
	public EVENT_VENUE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public EVENT_VENUE(Photo photo) {
		setPhoto(photo);
	}
	...
	public EVENT_VENUE(PotentialAction potentialAction) {
	...
	public EVENT_VENUE(PublicAccess publicAccess) {
	...
	public EVENT_VENUE(Review review) {
		setReview(review);
	}
	...
	public EVENT_VENUE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public EVENT_VENUE(SmokingAllowed smokingAllowed) {
	...
	public EVENT_VENUE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public EVENT_VENUE(SubjectOf subjectOf) {
	...
	public EVENT_VENUE(Telephone telephone) {
	...
	public void copy(Clazz.EventVenue org) {
		setSeq(org.getSeq());
