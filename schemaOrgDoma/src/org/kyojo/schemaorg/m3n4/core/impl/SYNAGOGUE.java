...
public class SYNAGOGUE implements Clazz.Synagogue {
	...
	public SYNAGOGUE(Long seq) {
		setSeq(seq);
	}

	public SYNAGOGUE(String string) {
	...
	public SYNAGOGUE(AdditionalProperty additionalProperty) {
	...
	public SYNAGOGUE(AdditionalType additionalType) {
	...
	public SYNAGOGUE(Address address) {
		setAddress(address);
	}
	...
	public SYNAGOGUE(AggregateRating aggregateRating) {
	...
	public SYNAGOGUE(AlternateName alternateName) {
	...
	public SYNAGOGUE(AmenityFeature amenityFeature) {
	...
	public SYNAGOGUE(BranchCode branchCode) {
	...
	public SYNAGOGUE(ContainedInPlace containedInPlace) {
	...
	public SYNAGOGUE(ContainsPlace containsPlace) {
	...
	public SYNAGOGUE(Description description) {
	...
	public SYNAGOGUE(DisambiguatingDescription disambiguatingDescription) {
	...
	public SYNAGOGUE(FaxNumber faxNumber) {
	...
	public SYNAGOGUE(GeospatiallyContains geospatiallyContains) {
	...
	public SYNAGOGUE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public SYNAGOGUE(GeospatiallyCovers geospatiallyCovers) {
	...
	public SYNAGOGUE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public SYNAGOGUE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public SYNAGOGUE(GeospatiallyEquals geospatiallyEquals) {
	...
	public SYNAGOGUE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public SYNAGOGUE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public SYNAGOGUE(GeospatiallyTouches geospatiallyTouches) {
	...
	public SYNAGOGUE(GeospatiallyWithin geospatiallyWithin) {
	...
	public SYNAGOGUE(GlobalLocationNumber globalLocationNumber) {
	...
	public SYNAGOGUE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public SYNAGOGUE(Identifier identifier) {
	...
	public SYNAGOGUE(IsAccessibleForFree isAccessibleForFree) {
	...
	public SYNAGOGUE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public SYNAGOGUE(MainEntityOfPage mainEntityOfPage) {
	...
	public SYNAGOGUE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public SYNAGOGUE(NameFuzzy nameFuzzy) {
	...
	public SYNAGOGUE(NameRuby nameRuby) {
	...
	public SYNAGOGUE(OpeningHours openingHours) {
	...
	public SYNAGOGUE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public SYNAGOGUE(PotentialAction potentialAction) {
	...
	public SYNAGOGUE(PublicAccess publicAccess) {
	...
	public SYNAGOGUE(Review review) {
		setReview(review);
	}
	...
	public SYNAGOGUE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SYNAGOGUE(SmokingAllowed smokingAllowed) {
	...
	public SYNAGOGUE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public SYNAGOGUE(SubjectOf subjectOf) {
	...
	public SYNAGOGUE(Telephone telephone) {
	...
	public void copy(Clazz.Synagogue org) {
		setSeq(org.getSeq());
