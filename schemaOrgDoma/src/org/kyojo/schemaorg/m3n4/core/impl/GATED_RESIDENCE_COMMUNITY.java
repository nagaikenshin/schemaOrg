...
public class GATED_RESIDENCE_COMMUNITY implements Clazz.GatedResidenceCommunity {
	...
	public GATED_RESIDENCE_COMMUNITY() {
	}

	public GATED_RESIDENCE_COMMUNITY(Long seq) {
		setSeq(seq);
	}

	public GATED_RESIDENCE_COMMUNITY(String string) {
	...
	public GATED_RESIDENCE_COMMUNITY(AdditionalProperty additionalProperty) {
	...
	public GATED_RESIDENCE_COMMUNITY(AdditionalType additionalType) {
	...
	public GATED_RESIDENCE_COMMUNITY(Address address) {
		setAddress(address);
	}
	...
	public GATED_RESIDENCE_COMMUNITY(AggregateRating aggregateRating) {
	...
	public GATED_RESIDENCE_COMMUNITY(AlternateName alternateName) {
	...
	public GATED_RESIDENCE_COMMUNITY(AmenityFeature amenityFeature) {
	...
	public GATED_RESIDENCE_COMMUNITY(BranchCode branchCode) {
	...
	public GATED_RESIDENCE_COMMUNITY(ContainedInPlace containedInPlace) {
	...
	public GATED_RESIDENCE_COMMUNITY(ContainsPlace containsPlace) {
	...
	public GATED_RESIDENCE_COMMUNITY(Description description) {
	...
	public GATED_RESIDENCE_COMMUNITY(DisambiguatingDescription disambiguatingDescription) {
	...
	public GATED_RESIDENCE_COMMUNITY(Event event) {
		setEvent(event);
	}
	...
	public GATED_RESIDENCE_COMMUNITY(FaxNumber faxNumber) {
	...
	public GATED_RESIDENCE_COMMUNITY(Geo geo) {
		setGeo(geo);
	}
	...
	public GATED_RESIDENCE_COMMUNITY(GeospatiallyContains geospatiallyContains) {
	...
	public GATED_RESIDENCE_COMMUNITY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public GATED_RESIDENCE_COMMUNITY(GeospatiallyCovers geospatiallyCovers) {
	...
	public GATED_RESIDENCE_COMMUNITY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public GATED_RESIDENCE_COMMUNITY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public GATED_RESIDENCE_COMMUNITY(GeospatiallyEquals geospatiallyEquals) {
	...
	public GATED_RESIDENCE_COMMUNITY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public GATED_RESIDENCE_COMMUNITY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public GATED_RESIDENCE_COMMUNITY(GeospatiallyTouches geospatiallyTouches) {
	...
	public GATED_RESIDENCE_COMMUNITY(GeospatiallyWithin geospatiallyWithin) {
	...
	public GATED_RESIDENCE_COMMUNITY(GlobalLocationNumber globalLocationNumber) {
	...
	public GATED_RESIDENCE_COMMUNITY(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public GATED_RESIDENCE_COMMUNITY(Identifier identifier) {
	...
	public GATED_RESIDENCE_COMMUNITY(Image image) {
		setImage(image);
	}
	...
	public GATED_RESIDENCE_COMMUNITY(IsAccessibleForFree isAccessibleForFree) {
	...
	public GATED_RESIDENCE_COMMUNITY(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public GATED_RESIDENCE_COMMUNITY(Logo logo) {
		setLogo(logo);
	}
	...
	public GATED_RESIDENCE_COMMUNITY(MainEntityOfPage mainEntityOfPage) {
	...
	public GATED_RESIDENCE_COMMUNITY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public GATED_RESIDENCE_COMMUNITY(Name name) {
		setName(name);
	}
	...
	public GATED_RESIDENCE_COMMUNITY(NameFuzzy nameFuzzy) {
	...
	public GATED_RESIDENCE_COMMUNITY(NameRuby nameRuby) {
	...
	public GATED_RESIDENCE_COMMUNITY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public GATED_RESIDENCE_COMMUNITY(Photo photo) {
		setPhoto(photo);
	}
	...
	public GATED_RESIDENCE_COMMUNITY(PotentialAction potentialAction) {
	...
	public GATED_RESIDENCE_COMMUNITY(PublicAccess publicAccess) {
	...
	public GATED_RESIDENCE_COMMUNITY(Review review) {
		setReview(review);
	}
	...
	public GATED_RESIDENCE_COMMUNITY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public GATED_RESIDENCE_COMMUNITY(SmokingAllowed smokingAllowed) {
	...
	public GATED_RESIDENCE_COMMUNITY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public GATED_RESIDENCE_COMMUNITY(SubjectOf subjectOf) {
	...
	public GATED_RESIDENCE_COMMUNITY(Telephone telephone) {
	...
	public GATED_RESIDENCE_COMMUNITY(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.GatedResidenceCommunity org) {
		setSeq(org.getSeq());
