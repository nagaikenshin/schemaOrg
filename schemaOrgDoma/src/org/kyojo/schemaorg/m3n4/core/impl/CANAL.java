...
public class CANAL implements Clazz.Canal {
	...
	public CANAL(Long seq) {
		setSeq(seq);
	}

	public CANAL(String string) {
	...
	public CANAL(AdditionalProperty additionalProperty) {
	...
	public CANAL(AdditionalType additionalType) {
	...
	public CANAL(AggregateRating aggregateRating) {
	...
	public CANAL(AlternateName alternateName) {
	...
	public CANAL(AmenityFeature amenityFeature) {
	...
	public CANAL(BranchCode branchCode) {
	...
	public CANAL(ContainedInPlace containedInPlace) {
	...
	public CANAL(ContainsPlace containsPlace) {
	...
	public CANAL(Description description) {
	...
	public CANAL(DisambiguatingDescription disambiguatingDescription) {
	...
	public CANAL(FaxNumber faxNumber) {
	...
	public CANAL(GeospatiallyContains geospatiallyContains) {
	...
	public CANAL(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public CANAL(GeospatiallyCovers geospatiallyCovers) {
	...
	public CANAL(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public CANAL(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public CANAL(GeospatiallyEquals geospatiallyEquals) {
	...
	public CANAL(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public CANAL(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public CANAL(GeospatiallyTouches geospatiallyTouches) {
	...
	public CANAL(GeospatiallyWithin geospatiallyWithin) {
	...
	public CANAL(GlobalLocationNumber globalLocationNumber) {
	...
	public CANAL(Identifier identifier) {
	...
	public CANAL(IsAccessibleForFree isAccessibleForFree) {
	...
	public CANAL(MainEntityOfPage mainEntityOfPage) {
	...
	public CANAL(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public CANAL(NameFuzzy nameFuzzy) {
	...
	public CANAL(NameRuby nameRuby) {
	...
	public CANAL(OpeningHoursSpecification openingHoursSpecification) {
	...
	public CANAL(PotentialAction potentialAction) {
	...
	public CANAL(PublicAccess publicAccess) {
	...
	public CANAL(SmokingAllowed smokingAllowed) {
	...
	public CANAL(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public CANAL(SubjectOf subjectOf) {
	...
	public CANAL(Telephone telephone) {
	...
	public void copy(Clazz.Canal org) {
		setSeq(org.getSeq());
