...
public class RESERVOIR implements Clazz.Reservoir {
	...
	public RESERVOIR(Long seq) {
		setSeq(seq);
	}

	public RESERVOIR(String string) {
	...
	public RESERVOIR(AdditionalProperty additionalProperty) {
	...
	public RESERVOIR(AdditionalType additionalType) {
	...
	public RESERVOIR(Address address) {
		setAddress(address);
	}
	...
	public RESERVOIR(AggregateRating aggregateRating) {
	...
	public RESERVOIR(AlternateName alternateName) {
	...
	public RESERVOIR(AmenityFeature amenityFeature) {
	...
	public RESERVOIR(BranchCode branchCode) {
	...
	public RESERVOIR(ContainedInPlace containedInPlace) {
	...
	public RESERVOIR(ContainsPlace containsPlace) {
	...
	public RESERVOIR(Description description) {
	...
	public RESERVOIR(DisambiguatingDescription disambiguatingDescription) {
	...
	public RESERVOIR(FaxNumber faxNumber) {
	...
	public RESERVOIR(GeospatiallyContains geospatiallyContains) {
	...
	public RESERVOIR(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public RESERVOIR(GeospatiallyCovers geospatiallyCovers) {
	...
	public RESERVOIR(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public RESERVOIR(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public RESERVOIR(GeospatiallyEquals geospatiallyEquals) {
	...
	public RESERVOIR(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public RESERVOIR(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public RESERVOIR(GeospatiallyTouches geospatiallyTouches) {
	...
	public RESERVOIR(GeospatiallyWithin geospatiallyWithin) {
	...
	public RESERVOIR(GlobalLocationNumber globalLocationNumber) {
	...
	public RESERVOIR(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public RESERVOIR(Identifier identifier) {
	...
	public RESERVOIR(IsAccessibleForFree isAccessibleForFree) {
	...
	public RESERVOIR(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public RESERVOIR(MainEntityOfPage mainEntityOfPage) {
	...
	public RESERVOIR(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public RESERVOIR(NameFuzzy nameFuzzy) {
	...
	public RESERVOIR(NameRuby nameRuby) {
	...
	public RESERVOIR(OpeningHoursSpecification openingHoursSpecification) {
	...
	public RESERVOIR(PotentialAction potentialAction) {
	...
	public RESERVOIR(PublicAccess publicAccess) {
	...
	public RESERVOIR(Review review) {
		setReview(review);
	}
	...
	public RESERVOIR(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RESERVOIR(SmokingAllowed smokingAllowed) {
	...
	public RESERVOIR(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public RESERVOIR(SubjectOf subjectOf) {
	...
	public RESERVOIR(Telephone telephone) {
	...
	public void copy(Clazz.Reservoir org) {
		setSeq(org.getSeq());
