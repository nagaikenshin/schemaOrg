...
public class FUEL_CONSUMPTION implements Container.FuelConsumption {
	...
	public FUEL_CONSUMPTION(String string) {
	...
	public FUEL_CONSUMPTION(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public FUEL_CONSUMPTION(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public FUEL_CONSUMPTION(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public FUEL_CONSUMPTION(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.FuelConsumption org) {
