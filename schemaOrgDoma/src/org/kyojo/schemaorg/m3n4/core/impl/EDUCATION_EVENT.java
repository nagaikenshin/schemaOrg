...
public class EDUCATION_EVENT implements Clazz.EducationEvent {
	...
	public EDUCATION_EVENT() {
	}

	public EDUCATION_EVENT(Long seq) {
		setSeq(seq);
	}

	public EDUCATION_EVENT(String string) {
	...
	public EDUCATION_EVENT(About about) {
		setAbout(about);
	}
	...
	public EDUCATION_EVENT(Actor actor) {
		setActor(actor);
	}
	...
	public EDUCATION_EVENT(AdditionalType additionalType) {
	...
	public EDUCATION_EVENT(AggregateRating aggregateRating) {
	...
	public EDUCATION_EVENT(AlternateName alternateName) {
	...
	public EDUCATION_EVENT(Attendee attendee) {
	...
	public EDUCATION_EVENT(Audience audience) {
	...
	public EDUCATION_EVENT(Composer composer) {
	...
	public EDUCATION_EVENT(Contributor contributor) {
	...
	public EDUCATION_EVENT(Description description) {
	...
	public EDUCATION_EVENT(Director director) {
	...
	public EDUCATION_EVENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public EDUCATION_EVENT(DoorTime doorTime) {
	...
	public EDUCATION_EVENT(Duration duration) {
	...
	public EDUCATION_EVENT(EndDate endDate) {
		setEndDate(endDate);
	}
	...
	public EDUCATION_EVENT(EventStatus eventStatus) {
	...
	public EDUCATION_EVENT(Funder funder) {
		setFunder(funder);
	}
	...
	public EDUCATION_EVENT(Identifier identifier) {
	...
	public EDUCATION_EVENT(Image image) {
		setImage(image);
	}
	...
	public EDUCATION_EVENT(InLanguage inLanguage) {
	...
	public EDUCATION_EVENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public EDUCATION_EVENT(Location location) {
	...
	public EDUCATION_EVENT(MainEntityOfPage mainEntityOfPage) {
	...
	public EDUCATION_EVENT(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public EDUCATION_EVENT(Name name) {
		setName(name);
	}
	...
	public EDUCATION_EVENT(NameFuzzy nameFuzzy) {
	...
	public EDUCATION_EVENT(NameRuby nameRuby) {
	...
	public EDUCATION_EVENT(Offers offers) {
		setOffers(offers);
	}
	...
	public EDUCATION_EVENT(Organizer organizer) {
	...
	public EDUCATION_EVENT(Performer performer) {
	...
	public EDUCATION_EVENT(PotentialAction potentialAction) {
	...
	public EDUCATION_EVENT(PreviousStartDate previousStartDate) {
	...
	public EDUCATION_EVENT(RecordedIn recordedIn) {
	...
	public EDUCATION_EVENT(RemainingAttendeeCapacity remainingAttendeeCapacity) {
	...
	public EDUCATION_EVENT(Review review) {
		setReview(review);
	}
	...
	public EDUCATION_EVENT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public EDUCATION_EVENT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public EDUCATION_EVENT(StartDate startDate) {
	...
	public EDUCATION_EVENT(SubEvent subEvent) {
	...
	public EDUCATION_EVENT(SubjectOf subjectOf) {
	...
	public EDUCATION_EVENT(SuperEvent superEvent) {
	...
	public EDUCATION_EVENT(Translator translator) {
	...
	public EDUCATION_EVENT(TypicalAgeRange typicalAgeRange) {
	...
	public EDUCATION_EVENT(Url url) {
		setUrl(url);
	}
	...
	public EDUCATION_EVENT(WorkFeatured workFeatured) {
	...
	public EDUCATION_EVENT(WorkPerformed workPerformed) {
	...
	public void copy(Clazz.EducationEvent org) {
		setSeq(org.getSeq());
