...
public class INTERNET_CAFE implements Clazz.InternetCafe {
	...
	public INTERNET_CAFE(Long seq) {
		setSeq(seq);
	}

	public INTERNET_CAFE(String string) {
	...
	public INTERNET_CAFE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public INTERNET_CAFE(AdditionalProperty additionalProperty) {
	...
	public INTERNET_CAFE(AdditionalType additionalType) {
	...
	public INTERNET_CAFE(Address address) {
		setAddress(address);
	}
	...
	public INTERNET_CAFE(AggregateRating aggregateRating) {
	...
	public INTERNET_CAFE(AlternateName alternateName) {
	...
	public INTERNET_CAFE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public INTERNET_CAFE(AmenityFeature amenityFeature) {
	...
	public INTERNET_CAFE(AreaServed areaServed) {
	...
	public INTERNET_CAFE(Award award) {
		setAward(award);
	}
	...
	public INTERNET_CAFE(BranchCode branchCode) {
	...
	public INTERNET_CAFE(Brand brand) {
		setBrand(brand);
	}
	...
	public INTERNET_CAFE(ContactPoint contactPoint) {
	...
	public INTERNET_CAFE(ContainedInPlace containedInPlace) {
	...
	public INTERNET_CAFE(ContainsPlace containsPlace) {
	...
	public INTERNET_CAFE(CorrectionsPolicy correctionsPolicy) {
	...
	public INTERNET_CAFE(CurrenciesAccepted currenciesAccepted) {
	...
	public INTERNET_CAFE(Department department) {
	...
	public INTERNET_CAFE(Description description) {
	...
	public INTERNET_CAFE(DisambiguatingDescription disambiguatingDescription) {
	...
	public INTERNET_CAFE(DissolutionDate dissolutionDate) {
	...
	public INTERNET_CAFE(DiversityPolicy diversityPolicy) {
	...
	public INTERNET_CAFE(DiversityStaffingReport diversityStaffingReport) {
	...
	public INTERNET_CAFE(Duns duns) {
		setDuns(duns);
	}
	...
	public INTERNET_CAFE(Email email) {
		setEmail(email);
	}
	...
	public INTERNET_CAFE(Employee employee) {
	...
	public INTERNET_CAFE(EthicsPolicy ethicsPolicy) {
	...
	public INTERNET_CAFE(Event event) {
		setEvent(event);
	}
	...
	public INTERNET_CAFE(FaxNumber faxNumber) {
	...
	public INTERNET_CAFE(Founder founder) {
		setFounder(founder);
	}
	...
	public INTERNET_CAFE(FoundingDate foundingDate) {
	...
	public INTERNET_CAFE(FoundingLocation foundingLocation) {
	...
	public INTERNET_CAFE(Funder funder) {
		setFunder(funder);
	}
	...
	public INTERNET_CAFE(GeospatiallyContains geospatiallyContains) {
	...
	public INTERNET_CAFE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public INTERNET_CAFE(GeospatiallyCovers geospatiallyCovers) {
	...
	public INTERNET_CAFE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public INTERNET_CAFE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public INTERNET_CAFE(GeospatiallyEquals geospatiallyEquals) {
	...
	public INTERNET_CAFE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public INTERNET_CAFE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public INTERNET_CAFE(GeospatiallyTouches geospatiallyTouches) {
	...
	public INTERNET_CAFE(GeospatiallyWithin geospatiallyWithin) {
	...
	public INTERNET_CAFE(GlobalLocationNumber globalLocationNumber) {
	...
	public INTERNET_CAFE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public INTERNET_CAFE(HasOfferCatalog hasOfferCatalog) {
	...
	public INTERNET_CAFE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public INTERNET_CAFE(Identifier identifier) {
	...
	public INTERNET_CAFE(Image image) {
		setImage(image);
	}
	...
	public INTERNET_CAFE(IsAccessibleForFree isAccessibleForFree) {
	...
	public INTERNET_CAFE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public INTERNET_CAFE(KnowsAbout knowsAbout) {
	...
	public INTERNET_CAFE(KnowsLanguage knowsLanguage) {
	...
	public INTERNET_CAFE(LegalName legalName) {
	...
	public INTERNET_CAFE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public INTERNET_CAFE(Location location) {
	...
	public INTERNET_CAFE(Logo logo) {
		setLogo(logo);
	}
	...
	public INTERNET_CAFE(MainEntityOfPage mainEntityOfPage) {
	...
	public INTERNET_CAFE(MakesOffer makesOffer) {
	...
	public INTERNET_CAFE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public INTERNET_CAFE(Member member) {
		setMember(member);
	}
	...
	public INTERNET_CAFE(MemberOf memberOf) {
	...
	public INTERNET_CAFE(Naics naics) {
		setNaics(naics);
	}
	...
	public INTERNET_CAFE(Name name) {
		setName(name);
	}
	...
	public INTERNET_CAFE(NameFuzzy nameFuzzy) {
	...
	public INTERNET_CAFE(NameRuby nameRuby) {
	...
	public INTERNET_CAFE(NumberOfEmployees numberOfEmployees) {
	...
	public INTERNET_CAFE(OpeningHours openingHours) {
	...
	public INTERNET_CAFE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public INTERNET_CAFE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public INTERNET_CAFE(Owns owns) {
		setOwns(owns);
	}
	...
	public INTERNET_CAFE(ParentOrganization parentOrganization) {
	...
	public INTERNET_CAFE(PaymentAccepted paymentAccepted) {
	...
	public INTERNET_CAFE(Photo photo) {
		setPhoto(photo);
	}
	...
	public INTERNET_CAFE(PotentialAction potentialAction) {
	...
	public INTERNET_CAFE(PriceRange priceRange) {
	...
	public INTERNET_CAFE(PublicAccess publicAccess) {
	...
	public INTERNET_CAFE(PublishingPrinciples publishingPrinciples) {
	...
	public INTERNET_CAFE(Review review) {
		setReview(review);
	}
	...
	public INTERNET_CAFE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public INTERNET_CAFE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public INTERNET_CAFE(SmokingAllowed smokingAllowed) {
	...
	public INTERNET_CAFE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public INTERNET_CAFE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public INTERNET_CAFE(SubOrganization subOrganization) {
	...
	public INTERNET_CAFE(SubjectOf subjectOf) {
	...
	public INTERNET_CAFE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public INTERNET_CAFE(Telephone telephone) {
	...
	public INTERNET_CAFE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public INTERNET_CAFE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.InternetCafe org) {
		setSeq(org.getSeq());
