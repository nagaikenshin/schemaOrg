...
public class GOVERNMENT_OFFICE implements Clazz.GovernmentOffice {
	...
	public GOVERNMENT_OFFICE() {
	}

	public GOVERNMENT_OFFICE(Long seq) {
		setSeq(seq);
	}

	public GOVERNMENT_OFFICE(String string) {
	...
	public GOVERNMENT_OFFICE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public GOVERNMENT_OFFICE(AdditionalProperty additionalProperty) {
	...
	public GOVERNMENT_OFFICE(AdditionalType additionalType) {
	...
	public GOVERNMENT_OFFICE(Address address) {
		setAddress(address);
	}
	...
	public GOVERNMENT_OFFICE(AggregateRating aggregateRating) {
	...
	public GOVERNMENT_OFFICE(AlternateName alternateName) {
	...
	public GOVERNMENT_OFFICE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public GOVERNMENT_OFFICE(AmenityFeature amenityFeature) {
	...
	public GOVERNMENT_OFFICE(AreaServed areaServed) {
	...
	public GOVERNMENT_OFFICE(Award award) {
		setAward(award);
	}
	...
	public GOVERNMENT_OFFICE(BranchCode branchCode) {
	...
	public GOVERNMENT_OFFICE(Brand brand) {
		setBrand(brand);
	}
	...
	public GOVERNMENT_OFFICE(ContactPoint contactPoint) {
	...
	public GOVERNMENT_OFFICE(ContainedInPlace containedInPlace) {
	...
	public GOVERNMENT_OFFICE(ContainsPlace containsPlace) {
	...
	public GOVERNMENT_OFFICE(CorrectionsPolicy correctionsPolicy) {
	...
	public GOVERNMENT_OFFICE(CurrenciesAccepted currenciesAccepted) {
	...
	public GOVERNMENT_OFFICE(Department department) {
	...
	public GOVERNMENT_OFFICE(Description description) {
	...
	public GOVERNMENT_OFFICE(DisambiguatingDescription disambiguatingDescription) {
	...
	public GOVERNMENT_OFFICE(DissolutionDate dissolutionDate) {
	...
	public GOVERNMENT_OFFICE(DiversityPolicy diversityPolicy) {
	...
	public GOVERNMENT_OFFICE(DiversityStaffingReport diversityStaffingReport) {
	...
	public GOVERNMENT_OFFICE(Duns duns) {
		setDuns(duns);
	}
	...
	public GOVERNMENT_OFFICE(Email email) {
		setEmail(email);
	}
	...
	public GOVERNMENT_OFFICE(Employee employee) {
	...
	public GOVERNMENT_OFFICE(EthicsPolicy ethicsPolicy) {
	...
	public GOVERNMENT_OFFICE(Event event) {
		setEvent(event);
	}
	...
	public GOVERNMENT_OFFICE(FaxNumber faxNumber) {
	...
	public GOVERNMENT_OFFICE(Founder founder) {
		setFounder(founder);
	}
	...
	public GOVERNMENT_OFFICE(FoundingDate foundingDate) {
	...
	public GOVERNMENT_OFFICE(FoundingLocation foundingLocation) {
	...
	public GOVERNMENT_OFFICE(Funder funder) {
		setFunder(funder);
	}
	...
	public GOVERNMENT_OFFICE(Geo geo) {
		setGeo(geo);
	}
	...
	public GOVERNMENT_OFFICE(GeospatiallyContains geospatiallyContains) {
	...
	public GOVERNMENT_OFFICE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public GOVERNMENT_OFFICE(GeospatiallyCovers geospatiallyCovers) {
	...
	public GOVERNMENT_OFFICE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public GOVERNMENT_OFFICE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public GOVERNMENT_OFFICE(GeospatiallyEquals geospatiallyEquals) {
	...
	public GOVERNMENT_OFFICE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public GOVERNMENT_OFFICE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public GOVERNMENT_OFFICE(GeospatiallyTouches geospatiallyTouches) {
	...
	public GOVERNMENT_OFFICE(GeospatiallyWithin geospatiallyWithin) {
	...
	public GOVERNMENT_OFFICE(GlobalLocationNumber globalLocationNumber) {
	...
	public GOVERNMENT_OFFICE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public GOVERNMENT_OFFICE(HasOfferCatalog hasOfferCatalog) {
	...
	public GOVERNMENT_OFFICE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public GOVERNMENT_OFFICE(Identifier identifier) {
	...
	public GOVERNMENT_OFFICE(Image image) {
		setImage(image);
	}
	...
	public GOVERNMENT_OFFICE(IsAccessibleForFree isAccessibleForFree) {
	...
	public GOVERNMENT_OFFICE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public GOVERNMENT_OFFICE(KnowsAbout knowsAbout) {
	...
	public GOVERNMENT_OFFICE(KnowsLanguage knowsLanguage) {
	...
	public GOVERNMENT_OFFICE(LegalName legalName) {
	...
	public GOVERNMENT_OFFICE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public GOVERNMENT_OFFICE(Location location) {
	...
	public GOVERNMENT_OFFICE(Logo logo) {
		setLogo(logo);
	}
	...
	public GOVERNMENT_OFFICE(MainEntityOfPage mainEntityOfPage) {
	...
	public GOVERNMENT_OFFICE(MakesOffer makesOffer) {
	...
	public GOVERNMENT_OFFICE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public GOVERNMENT_OFFICE(Member member) {
		setMember(member);
	}
	...
	public GOVERNMENT_OFFICE(MemberOf memberOf) {
	...
	public GOVERNMENT_OFFICE(Naics naics) {
		setNaics(naics);
	}
	...
	public GOVERNMENT_OFFICE(Name name) {
		setName(name);
	}
	...
	public GOVERNMENT_OFFICE(NameFuzzy nameFuzzy) {
	...
	public GOVERNMENT_OFFICE(NameRuby nameRuby) {
	...
	public GOVERNMENT_OFFICE(NumberOfEmployees numberOfEmployees) {
	...
	public GOVERNMENT_OFFICE(OpeningHours openingHours) {
	...
	public GOVERNMENT_OFFICE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public GOVERNMENT_OFFICE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public GOVERNMENT_OFFICE(Owns owns) {
		setOwns(owns);
	}
	...
	public GOVERNMENT_OFFICE(ParentOrganization parentOrganization) {
	...
	public GOVERNMENT_OFFICE(PaymentAccepted paymentAccepted) {
	...
	public GOVERNMENT_OFFICE(Photo photo) {
		setPhoto(photo);
	}
	...
	public GOVERNMENT_OFFICE(PotentialAction potentialAction) {
	...
	public GOVERNMENT_OFFICE(PriceRange priceRange) {
	...
	public GOVERNMENT_OFFICE(PublicAccess publicAccess) {
	...
	public GOVERNMENT_OFFICE(PublishingPrinciples publishingPrinciples) {
	...
	public GOVERNMENT_OFFICE(Review review) {
		setReview(review);
	}
	...
	public GOVERNMENT_OFFICE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public GOVERNMENT_OFFICE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public GOVERNMENT_OFFICE(SmokingAllowed smokingAllowed) {
	...
	public GOVERNMENT_OFFICE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public GOVERNMENT_OFFICE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public GOVERNMENT_OFFICE(SubOrganization subOrganization) {
	...
	public GOVERNMENT_OFFICE(SubjectOf subjectOf) {
	...
	public GOVERNMENT_OFFICE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public GOVERNMENT_OFFICE(Telephone telephone) {
	...
	public GOVERNMENT_OFFICE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public GOVERNMENT_OFFICE(Url url) {
		setUrl(url);
	}
	...
	public GOVERNMENT_OFFICE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.GovernmentOffice org) {
		setSeq(org.getSeq());
