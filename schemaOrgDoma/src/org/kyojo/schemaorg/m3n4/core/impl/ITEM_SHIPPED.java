...
public class ITEM_SHIPPED implements Container.ItemShipped {
	...
	public ITEM_SHIPPED(BusOrCoach busOrCoach) {
	...
	public ITEM_SHIPPED(IndividualProduct individualProduct) {
	...
	public ITEM_SHIPPED(Motorcycle motorcycle) {
	...
	public ITEM_SHIPPED(MotorizedBicycle motorizedBicycle) {
	...
	public ITEM_SHIPPED(ProductModel productModel) {
	...
	public ITEM_SHIPPED(SomeProducts someProducts) {
	...
	public ITEM_SHIPPED(Vehicle vehicle) {
	...
	public ITEM_SHIPPED(List<BusOrCoach> busOrCoachList,
			List<Car> carList,
	...
	public void copy(Container.ItemShipped org) {
