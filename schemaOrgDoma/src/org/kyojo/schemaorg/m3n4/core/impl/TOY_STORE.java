...
public class TOY_STORE implements Clazz.ToyStore {
	...
	public TOY_STORE(Long seq) {
		setSeq(seq);
	}

	public TOY_STORE(String string) {
	...
	public TOY_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public TOY_STORE(AdditionalProperty additionalProperty) {
	...
	public TOY_STORE(AdditionalType additionalType) {
	...
	public TOY_STORE(Address address) {
		setAddress(address);
	}
	...
	public TOY_STORE(AggregateRating aggregateRating) {
	...
	public TOY_STORE(AlternateName alternateName) {
	...
	public TOY_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public TOY_STORE(AmenityFeature amenityFeature) {
	...
	public TOY_STORE(AreaServed areaServed) {
	...
	public TOY_STORE(BranchCode branchCode) {
	...
	public TOY_STORE(ContactPoint contactPoint) {
	...
	public TOY_STORE(ContainedInPlace containedInPlace) {
	...
	public TOY_STORE(ContainsPlace containsPlace) {
	...
	public TOY_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public TOY_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public TOY_STORE(Department department) {
	...
	public TOY_STORE(Description description) {
	...
	public TOY_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public TOY_STORE(DissolutionDate dissolutionDate) {
	...
	public TOY_STORE(DiversityPolicy diversityPolicy) {
	...
	public TOY_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public TOY_STORE(Employee employee) {
	...
	public TOY_STORE(EthicsPolicy ethicsPolicy) {
	...
	public TOY_STORE(FaxNumber faxNumber) {
	...
	public TOY_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public TOY_STORE(FoundingDate foundingDate) {
	...
	public TOY_STORE(FoundingLocation foundingLocation) {
	...
	public TOY_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public TOY_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public TOY_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public TOY_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public TOY_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public TOY_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public TOY_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public TOY_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public TOY_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public TOY_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public TOY_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public TOY_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public TOY_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public TOY_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public TOY_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public TOY_STORE(Identifier identifier) {
	...
	public TOY_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public TOY_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public TOY_STORE(KnowsAbout knowsAbout) {
	...
	public TOY_STORE(KnowsLanguage knowsLanguage) {
	...
	public TOY_STORE(LegalName legalName) {
	...
	public TOY_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public TOY_STORE(Location location) {
	...
	public TOY_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public TOY_STORE(MakesOffer makesOffer) {
	...
	public TOY_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public TOY_STORE(Member member) {
		setMember(member);
	}
	...
	public TOY_STORE(MemberOf memberOf) {
	...
	public TOY_STORE(NameFuzzy nameFuzzy) {
	...
	public TOY_STORE(NameRuby nameRuby) {
	...
	public TOY_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public TOY_STORE(OpeningHours openingHours) {
	...
	public TOY_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public TOY_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public TOY_STORE(ParentOrganization parentOrganization) {
	...
	public TOY_STORE(PaymentAccepted paymentAccepted) {
	...
	public TOY_STORE(PotentialAction potentialAction) {
	...
	public TOY_STORE(PriceRange priceRange) {
	...
	public TOY_STORE(PublicAccess publicAccess) {
	...
	public TOY_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public TOY_STORE(Review review) {
		setReview(review);
	}
	...
	public TOY_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TOY_STORE(SmokingAllowed smokingAllowed) {
	...
	public TOY_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public TOY_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public TOY_STORE(SubOrganization subOrganization) {
	...
	public TOY_STORE(SubjectOf subjectOf) {
	...
	public TOY_STORE(Telephone telephone) {
	...
	public TOY_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.ToyStore org) {
		setSeq(org.getSeq());
