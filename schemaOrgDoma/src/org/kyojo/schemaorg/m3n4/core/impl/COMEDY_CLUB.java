...
public class COMEDY_CLUB implements Clazz.ComedyClub {
	...
	public COMEDY_CLUB(Long seq) {
		setSeq(seq);
	}

	public COMEDY_CLUB(String string) {
	...
	public COMEDY_CLUB(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public COMEDY_CLUB(AdditionalProperty additionalProperty) {
	...
	public COMEDY_CLUB(AdditionalType additionalType) {
	...
	public COMEDY_CLUB(Address address) {
		setAddress(address);
	}
	...
	public COMEDY_CLUB(AggregateRating aggregateRating) {
	...
	public COMEDY_CLUB(AlternateName alternateName) {
	...
	public COMEDY_CLUB(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public COMEDY_CLUB(AmenityFeature amenityFeature) {
	...
	public COMEDY_CLUB(AreaServed areaServed) {
	...
	public COMEDY_CLUB(Award award) {
		setAward(award);
	}
	...
	public COMEDY_CLUB(BranchCode branchCode) {
	...
	public COMEDY_CLUB(Brand brand) {
		setBrand(brand);
	}
	...
	public COMEDY_CLUB(ContactPoint contactPoint) {
	...
	public COMEDY_CLUB(ContainedInPlace containedInPlace) {
	...
	public COMEDY_CLUB(ContainsPlace containsPlace) {
	...
	public COMEDY_CLUB(CorrectionsPolicy correctionsPolicy) {
	...
	public COMEDY_CLUB(CurrenciesAccepted currenciesAccepted) {
	...
	public COMEDY_CLUB(Department department) {
	...
	public COMEDY_CLUB(Description description) {
	...
	public COMEDY_CLUB(DisambiguatingDescription disambiguatingDescription) {
	...
	public COMEDY_CLUB(DissolutionDate dissolutionDate) {
	...
	public COMEDY_CLUB(DiversityPolicy diversityPolicy) {
	...
	public COMEDY_CLUB(DiversityStaffingReport diversityStaffingReport) {
	...
	public COMEDY_CLUB(Email email) {
		setEmail(email);
	}
	...
	public COMEDY_CLUB(Employee employee) {
	...
	public COMEDY_CLUB(EthicsPolicy ethicsPolicy) {
	...
	public COMEDY_CLUB(Event event) {
		setEvent(event);
	}
	...
	public COMEDY_CLUB(FaxNumber faxNumber) {
	...
	public COMEDY_CLUB(Founder founder) {
		setFounder(founder);
	}
	...
	public COMEDY_CLUB(FoundingDate foundingDate) {
	...
	public COMEDY_CLUB(FoundingLocation foundingLocation) {
	...
	public COMEDY_CLUB(Funder funder) {
		setFunder(funder);
	}
	...
	public COMEDY_CLUB(GeospatiallyContains geospatiallyContains) {
	...
	public COMEDY_CLUB(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public COMEDY_CLUB(GeospatiallyCovers geospatiallyCovers) {
	...
	public COMEDY_CLUB(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public COMEDY_CLUB(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public COMEDY_CLUB(GeospatiallyEquals geospatiallyEquals) {
	...
	public COMEDY_CLUB(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public COMEDY_CLUB(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public COMEDY_CLUB(GeospatiallyTouches geospatiallyTouches) {
	...
	public COMEDY_CLUB(GeospatiallyWithin geospatiallyWithin) {
	...
	public COMEDY_CLUB(GlobalLocationNumber globalLocationNumber) {
	...
	public COMEDY_CLUB(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public COMEDY_CLUB(HasOfferCatalog hasOfferCatalog) {
	...
	public COMEDY_CLUB(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public COMEDY_CLUB(Identifier identifier) {
	...
	public COMEDY_CLUB(Image image) {
		setImage(image);
	}
	...
	public COMEDY_CLUB(IsAccessibleForFree isAccessibleForFree) {
	...
	public COMEDY_CLUB(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public COMEDY_CLUB(KnowsAbout knowsAbout) {
	...
	public COMEDY_CLUB(KnowsLanguage knowsLanguage) {
	...
	public COMEDY_CLUB(LegalName legalName) {
	...
	public COMEDY_CLUB(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public COMEDY_CLUB(Location location) {
	...
	public COMEDY_CLUB(MainEntityOfPage mainEntityOfPage) {
	...
	public COMEDY_CLUB(MakesOffer makesOffer) {
	...
	public COMEDY_CLUB(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public COMEDY_CLUB(Member member) {
		setMember(member);
	}
	...
	public COMEDY_CLUB(MemberOf memberOf) {
	...
	public COMEDY_CLUB(Naics naics) {
		setNaics(naics);
	}
	...
	public COMEDY_CLUB(NameFuzzy nameFuzzy) {
	...
	public COMEDY_CLUB(NameRuby nameRuby) {
	...
	public COMEDY_CLUB(NumberOfEmployees numberOfEmployees) {
	...
	public COMEDY_CLUB(OpeningHours openingHours) {
	...
	public COMEDY_CLUB(OpeningHoursSpecification openingHoursSpecification) {
	...
	public COMEDY_CLUB(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public COMEDY_CLUB(ParentOrganization parentOrganization) {
	...
	public COMEDY_CLUB(PaymentAccepted paymentAccepted) {
	...
	public COMEDY_CLUB(Photo photo) {
		setPhoto(photo);
	}
	...
	public COMEDY_CLUB(PotentialAction potentialAction) {
	...
	public COMEDY_CLUB(PriceRange priceRange) {
	...
	public COMEDY_CLUB(PublicAccess publicAccess) {
	...
	public COMEDY_CLUB(PublishingPrinciples publishingPrinciples) {
	...
	public COMEDY_CLUB(Review review) {
		setReview(review);
	}
	...
	public COMEDY_CLUB(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public COMEDY_CLUB(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public COMEDY_CLUB(SmokingAllowed smokingAllowed) {
	...
	public COMEDY_CLUB(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public COMEDY_CLUB(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public COMEDY_CLUB(SubOrganization subOrganization) {
	...
	public COMEDY_CLUB(SubjectOf subjectOf) {
	...
	public COMEDY_CLUB(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public COMEDY_CLUB(Telephone telephone) {
	...
	public COMEDY_CLUB(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public COMEDY_CLUB(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.ComedyClub org) {
		setSeq(org.getSeq());
