...
public class YEARLY_REVENUE implements Container.YearlyRevenue {
	...
	public YEARLY_REVENUE(String string) {
	...
	public YEARLY_REVENUE(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public YEARLY_REVENUE(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public YEARLY_REVENUE(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public YEARLY_REVENUE(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.YearlyRevenue org) {
