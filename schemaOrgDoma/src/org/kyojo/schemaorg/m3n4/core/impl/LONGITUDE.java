...
public class LONGITUDE implements Container.Longitude {
	...
	public LONGITUDE(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public LONGITUDE(Float fl0at) {
	...
	public LONGITUDE(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public LONGITUDE(Integer integer) {
	...
	public LONGITUDE(List<Float> fl0atList,
