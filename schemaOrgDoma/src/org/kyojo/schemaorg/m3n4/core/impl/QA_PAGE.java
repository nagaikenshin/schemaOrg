...
public class QA_PAGE implements Clazz.QAPage {
	...
	public QA_PAGE(Long seq) {
		setSeq(seq);
	}

	public QA_PAGE(String string) {
	...
	public QA_PAGE(AccessMode accessMode) {
	...
	public QA_PAGE(AccessModeSufficient accessModeSufficient) {
	...
	public QA_PAGE(AccessibilityAPI accessibilityAPI) {
	...
	public QA_PAGE(AccessibilityControl accessibilityControl) {
	...
	public QA_PAGE(AccessibilityFeature accessibilityFeature) {
	...
	public QA_PAGE(AccessibilityHazard accessibilityHazard) {
	...
	public QA_PAGE(AccessibilitySummary accessibilitySummary) {
	...
	public QA_PAGE(AccountablePerson accountablePerson) {
	...
	public QA_PAGE(AdditionalType additionalType) {
	...
	public QA_PAGE(AggregateRating aggregateRating) {
	...
	public QA_PAGE(AlternateName alternateName) {
	...
	public QA_PAGE(AlternativeHeadline alternativeHeadline) {
	...
	public QA_PAGE(AssociatedMedia associatedMedia) {
	...
	public QA_PAGE(Audience audience) {
	...
	public QA_PAGE(Breadcrumb breadcrumb) {
	...
	public QA_PAGE(Character character) {
	...
	public QA_PAGE(Citation citation) {
	...
	public QA_PAGE(Comment comment) {
		setComment(comment);
	}
	...
	public QA_PAGE(CommentCount commentCount) {
	...
	public QA_PAGE(ContentLocation contentLocation) {
	...
	public QA_PAGE(ContentRating contentRating) {
	...
	public QA_PAGE(ContentReferenceTime contentReferenceTime) {
	...
	public QA_PAGE(Contributor contributor) {
	...
	public QA_PAGE(CopyrightHolder copyrightHolder) {
	...
	public QA_PAGE(CopyrightYear copyrightYear) {
	...
	public QA_PAGE(Correction correction) {
	...
	public QA_PAGE(Creator creator) {
		setCreator(creator);
	}
	...
	public QA_PAGE(DateCreated dateCreated) {
	...
	public QA_PAGE(DateModified dateModified) {
	...
	public QA_PAGE(DatePublished datePublished) {
	...
	public QA_PAGE(Description description) {
	...
	public QA_PAGE(DisambiguatingDescription disambiguatingDescription) {
	...
	public QA_PAGE(DiscussionUrl discussionUrl) {
	...
	public QA_PAGE(EducationalAlignment educationalAlignment) {
	...
	public QA_PAGE(EducationalUse educationalUse) {
	...
	public QA_PAGE(Encoding encoding) {
	...
	public QA_PAGE(EncodingFormat encodingFormat) {
	...
	public QA_PAGE(ExampleOfWork exampleOfWork) {
	...
	public QA_PAGE(Expires expires) {
		setExpires(expires);
	}
	...
	public QA_PAGE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public QA_PAGE(Headline headline) {
	...
	public QA_PAGE(Identifier identifier) {
	...
	public QA_PAGE(InLanguage inLanguage) {
	...
	public QA_PAGE(InteractionStatistic interactionStatistic) {
	...
	public QA_PAGE(InteractivityType interactivityType) {
	...
	public QA_PAGE(IsAccessibleForFree isAccessibleForFree) {
	...
	public QA_PAGE(IsBasedOn isBasedOn) {
	...
	public QA_PAGE(IsFamilyFriendly isFamilyFriendly) {
	...
	public QA_PAGE(IsPartOf isPartOf) {
	...
	public QA_PAGE(Keywords keywords) {
	...
	public QA_PAGE(LastReviewed lastReviewed) {
	...
	public QA_PAGE(LearningResourceType learningResourceType) {
	...
	public QA_PAGE(License license) {
		setLicense(license);
	}
	...
	public QA_PAGE(LocationCreated locationCreated) {
	...
	public QA_PAGE(MainContentOfPage mainContentOfPage) {
	...
	public QA_PAGE(MainEntity mainEntity) {
	...
	public QA_PAGE(MainEntityOfPage mainEntityOfPage) {
	...
	public QA_PAGE(Material material) {
	...
	public QA_PAGE(Mentions mentions) {
	...
	public QA_PAGE(NameFuzzy nameFuzzy) {
	...
	public QA_PAGE(NameRuby nameRuby) {
	...
	public QA_PAGE(Position position) {
	...
	public QA_PAGE(PotentialAction potentialAction) {
	...
	public QA_PAGE(PrimaryImageOfPage primaryImageOfPage) {
	...
	public QA_PAGE(Producer producer) {
	...
	public QA_PAGE(Provider provider) {
	...
	public QA_PAGE(Publication publication) {
	...
	public QA_PAGE(Publisher publisher) {
	...
	public QA_PAGE(PublisherImprint publisherImprint) {
	...
	public QA_PAGE(PublishingPrinciples publishingPrinciples) {
	...
	public QA_PAGE(RecordedAt recordedAt) {
	...
	public QA_PAGE(RelatedLink relatedLink) {
	...
	public QA_PAGE(ReleasedEvent releasedEvent) {
	...
	public QA_PAGE(ReviewedBy reviewedBy) {
	...
	public QA_PAGE(SchemaVersion schemaVersion) {
	...
	public QA_PAGE(SdDatePublished sdDatePublished) {
	...
	public QA_PAGE(SdLicense sdLicense) {
	...
	public QA_PAGE(SdPublisher sdPublisher) {
	...
	public QA_PAGE(SignificantLink significantLink) {
	...
	public QA_PAGE(SourceOrganization sourceOrganization) {
	...
	public QA_PAGE(SpatialCoverage spatialCoverage) {
	...
	public QA_PAGE(Speakable speakable) {
	...
	public QA_PAGE(Specialty specialty) {
	...
	public QA_PAGE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public QA_PAGE(SubjectOf subjectOf) {
	...
	public QA_PAGE(TemporalCoverage temporalCoverage) {
	...
	public QA_PAGE(ThumbnailUrl thumbnailUrl) {
	...
	public QA_PAGE(TimeRequired timeRequired) {
	...
	public QA_PAGE(TranslationOfWork translationOfWork) {
	...
	public QA_PAGE(Translator translator) {
	...
	public QA_PAGE(TypicalAgeRange typicalAgeRange) {
	...
	public QA_PAGE(Version version) {
		setVersion(version);
	}
	...
	public QA_PAGE(WorkExample workExample) {
	...
	public QA_PAGE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.QAPage org) {
		setSeq(org.getSeq());
