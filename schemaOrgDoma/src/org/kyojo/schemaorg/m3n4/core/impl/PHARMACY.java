...
public class PHARMACY implements Clazz.Pharmacy {
	...
	public PHARMACY(Long seq) {
		setSeq(seq);
	}

	public PHARMACY(String string) {
	...
	public PHARMACY(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public PHARMACY(AdditionalProperty additionalProperty) {
	...
	public PHARMACY(AdditionalType additionalType) {
	...
	public PHARMACY(Address address) {
		setAddress(address);
	}
	...
	public PHARMACY(AggregateRating aggregateRating) {
	...
	public PHARMACY(AlternateName alternateName) {
	...
	public PHARMACY(AmenityFeature amenityFeature) {
	...
	public PHARMACY(AreaServed areaServed) {
	...
	public PHARMACY(BranchCode branchCode) {
	...
	public PHARMACY(ContactPoint contactPoint) {
	...
	public PHARMACY(ContainedInPlace containedInPlace) {
	...
	public PHARMACY(ContainsPlace containsPlace) {
	...
	public PHARMACY(CorrectionsPolicy correctionsPolicy) {
	...
	public PHARMACY(CurrenciesAccepted currenciesAccepted) {
	...
	public PHARMACY(Department department) {
	...
	public PHARMACY(Description description) {
	...
	public PHARMACY(DisambiguatingDescription disambiguatingDescription) {
	...
	public PHARMACY(DissolutionDate dissolutionDate) {
	...
	public PHARMACY(DiversityPolicy diversityPolicy) {
	...
	public PHARMACY(DiversityStaffingReport diversityStaffingReport) {
	...
	public PHARMACY(Employee employee) {
	...
	public PHARMACY(EthicsPolicy ethicsPolicy) {
	...
	public PHARMACY(FaxNumber faxNumber) {
	...
	public PHARMACY(Founder founder) {
		setFounder(founder);
	}
	...
	public PHARMACY(FoundingDate foundingDate) {
	...
	public PHARMACY(FoundingLocation foundingLocation) {
	...
	public PHARMACY(GeospatiallyContains geospatiallyContains) {
	...
	public PHARMACY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public PHARMACY(GeospatiallyCovers geospatiallyCovers) {
	...
	public PHARMACY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public PHARMACY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public PHARMACY(GeospatiallyEquals geospatiallyEquals) {
	...
	public PHARMACY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public PHARMACY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public PHARMACY(GeospatiallyTouches geospatiallyTouches) {
	...
	public PHARMACY(GeospatiallyWithin geospatiallyWithin) {
	...
	public PHARMACY(GlobalLocationNumber globalLocationNumber) {
	...
	public PHARMACY(HasOfferCatalog hasOfferCatalog) {
	...
	public PHARMACY(HealthPlanNetworkId healthPlanNetworkId) {
	...
	public PHARMACY(Identifier identifier) {
	...
	public PHARMACY(IsAcceptingNewPatients isAcceptingNewPatients) {
	...
	public PHARMACY(IsAccessibleForFree isAccessibleForFree) {
	...
	public PHARMACY(KnowsAbout knowsAbout) {
	...
	public PHARMACY(KnowsLanguage knowsLanguage) {
	...
	public PHARMACY(LegalName legalName) {
	...
	public PHARMACY(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public PHARMACY(Location location) {
	...
	public PHARMACY(MainEntityOfPage mainEntityOfPage) {
	...
	public PHARMACY(MakesOffer makesOffer) {
	...
	public PHARMACY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public PHARMACY(MedicalSpecialty medicalSpecialty) {
	...
	public PHARMACY(MemberOf memberOf) {
	...
	public PHARMACY(NameFuzzy nameFuzzy) {
	...
	public PHARMACY(NameRuby nameRuby) {
	...
	public PHARMACY(NumberOfEmployees numberOfEmployees) {
	...
	public PHARMACY(OpeningHours openingHours) {
	...
	public PHARMACY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public PHARMACY(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public PHARMACY(ParentOrganization parentOrganization) {
	...
	public PHARMACY(PaymentAccepted paymentAccepted) {
	...
	public PHARMACY(PotentialAction potentialAction) {
	...
	public PHARMACY(PriceRange priceRange) {
	...
	public PHARMACY(PublicAccess publicAccess) {
	...
	public PHARMACY(PublishingPrinciples publishingPrinciples) {
	...
	public PHARMACY(SmokingAllowed smokingAllowed) {
	...
	public PHARMACY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public PHARMACY(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public PHARMACY(SubOrganization subOrganization) {
	...
	public PHARMACY(SubjectOf subjectOf) {
	...
	public PHARMACY(Telephone telephone) {
	...
	public PHARMACY(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Pharmacy org) {
		setSeq(org.getSeq());
