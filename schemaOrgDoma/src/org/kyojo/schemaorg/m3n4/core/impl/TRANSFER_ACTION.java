...
public class TRANSFER_ACTION implements Clazz.TransferAction {
	...
	public TRANSFER_ACTION() {
	}

	public TRANSFER_ACTION(Long seq) {
		setSeq(seq);
	}

	public TRANSFER_ACTION(String string) {
	...
	public TRANSFER_ACTION(ActionStatus actionStatus) {
	...
	public TRANSFER_ACTION(AdditionalType additionalType) {
	...
	public TRANSFER_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public TRANSFER_ACTION(AlternateName alternateName) {
	...
	public TRANSFER_ACTION(Description description) {
	...
	public TRANSFER_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public TRANSFER_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public TRANSFER_ACTION(Error error) {
		setError(error);
	}
	...
	public TRANSFER_ACTION(FromLocation fromLocation) {
	...
	public TRANSFER_ACTION(Identifier identifier) {
	...
	public TRANSFER_ACTION(Image image) {
		setImage(image);
	}
	...
	public TRANSFER_ACTION(Instrument instrument) {
	...
	public TRANSFER_ACTION(Location location) {
	...
	public TRANSFER_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public TRANSFER_ACTION(Name name) {
		setName(name);
	}
	...
	public TRANSFER_ACTION(NameFuzzy nameFuzzy) {
	...
	public TRANSFER_ACTION(NameRuby nameRuby) {
	...
	public TRANSFER_ACTION(Object object) {
		setObject(object);
	}
	...
	public TRANSFER_ACTION(Participant participant) {
	...
	public TRANSFER_ACTION(PotentialAction potentialAction) {
	...
	public TRANSFER_ACTION(Result result) {
		setResult(result);
	}
	...
	public TRANSFER_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TRANSFER_ACTION(StartTime startTime) {
	...
	public TRANSFER_ACTION(SubjectOf subjectOf) {
	...
	public TRANSFER_ACTION(Target target) {
		setTarget(target);
	}
	...
	public TRANSFER_ACTION(ToLocation toLocation) {
	...
	public TRANSFER_ACTION(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.TransferAction org) {
		setSeq(org.getSeq());
