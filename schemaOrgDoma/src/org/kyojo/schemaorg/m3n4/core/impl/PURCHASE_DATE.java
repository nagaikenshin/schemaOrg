...
public class PURCHASE_DATE implements Container.PurchaseDate {
	...
	public PURCHASE_DATE(java.util.Date date) {
		this(new DATE(date));
	}

	public PURCHASE_DATE(java.time.LocalDate date) {
		this(new DATE(date));
	}

	public PURCHASE_DATE(Date date) {
