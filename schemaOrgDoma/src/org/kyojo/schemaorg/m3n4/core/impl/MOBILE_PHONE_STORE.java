...
public class MOBILE_PHONE_STORE implements Clazz.MobilePhoneStore {
	...
	public MOBILE_PHONE_STORE() {
	}

	public MOBILE_PHONE_STORE(Long seq) {
		setSeq(seq);
	}

	public MOBILE_PHONE_STORE(String string) {
	...
	public MOBILE_PHONE_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public MOBILE_PHONE_STORE(AdditionalProperty additionalProperty) {
	...
	public MOBILE_PHONE_STORE(AdditionalType additionalType) {
	...
	public MOBILE_PHONE_STORE(Address address) {
		setAddress(address);
	}
	...
	public MOBILE_PHONE_STORE(AggregateRating aggregateRating) {
	...
	public MOBILE_PHONE_STORE(AlternateName alternateName) {
	...
	public MOBILE_PHONE_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public MOBILE_PHONE_STORE(AmenityFeature amenityFeature) {
	...
	public MOBILE_PHONE_STORE(AreaServed areaServed) {
	...
	public MOBILE_PHONE_STORE(Award award) {
		setAward(award);
	}
	...
	public MOBILE_PHONE_STORE(BranchCode branchCode) {
	...
	public MOBILE_PHONE_STORE(Brand brand) {
		setBrand(brand);
	}
	...
	public MOBILE_PHONE_STORE(ContactPoint contactPoint) {
	...
	public MOBILE_PHONE_STORE(ContainedInPlace containedInPlace) {
	...
	public MOBILE_PHONE_STORE(ContainsPlace containsPlace) {
	...
	public MOBILE_PHONE_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public MOBILE_PHONE_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public MOBILE_PHONE_STORE(Department department) {
	...
	public MOBILE_PHONE_STORE(Description description) {
	...
	public MOBILE_PHONE_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public MOBILE_PHONE_STORE(DissolutionDate dissolutionDate) {
	...
	public MOBILE_PHONE_STORE(DiversityPolicy diversityPolicy) {
	...
	public MOBILE_PHONE_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public MOBILE_PHONE_STORE(Duns duns) {
		setDuns(duns);
	}
	...
	public MOBILE_PHONE_STORE(Email email) {
		setEmail(email);
	}
	...
	public MOBILE_PHONE_STORE(Employee employee) {
	...
	public MOBILE_PHONE_STORE(EthicsPolicy ethicsPolicy) {
	...
	public MOBILE_PHONE_STORE(Event event) {
		setEvent(event);
	}
	...
	public MOBILE_PHONE_STORE(FaxNumber faxNumber) {
	...
	public MOBILE_PHONE_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public MOBILE_PHONE_STORE(FoundingDate foundingDate) {
	...
	public MOBILE_PHONE_STORE(FoundingLocation foundingLocation) {
	...
	public MOBILE_PHONE_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public MOBILE_PHONE_STORE(Geo geo) {
		setGeo(geo);
	}
	...
	public MOBILE_PHONE_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public MOBILE_PHONE_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public MOBILE_PHONE_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public MOBILE_PHONE_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public MOBILE_PHONE_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public MOBILE_PHONE_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public MOBILE_PHONE_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public MOBILE_PHONE_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public MOBILE_PHONE_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public MOBILE_PHONE_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public MOBILE_PHONE_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public MOBILE_PHONE_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public MOBILE_PHONE_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public MOBILE_PHONE_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public MOBILE_PHONE_STORE(Identifier identifier) {
	...
	public MOBILE_PHONE_STORE(Image image) {
		setImage(image);
	}
	...
	public MOBILE_PHONE_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public MOBILE_PHONE_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public MOBILE_PHONE_STORE(KnowsAbout knowsAbout) {
	...
	public MOBILE_PHONE_STORE(KnowsLanguage knowsLanguage) {
	...
	public MOBILE_PHONE_STORE(LegalName legalName) {
	...
	public MOBILE_PHONE_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public MOBILE_PHONE_STORE(Location location) {
	...
	public MOBILE_PHONE_STORE(Logo logo) {
		setLogo(logo);
	}
	...
	public MOBILE_PHONE_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public MOBILE_PHONE_STORE(MakesOffer makesOffer) {
	...
	public MOBILE_PHONE_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public MOBILE_PHONE_STORE(Member member) {
		setMember(member);
	}
	...
	public MOBILE_PHONE_STORE(MemberOf memberOf) {
	...
	public MOBILE_PHONE_STORE(Naics naics) {
		setNaics(naics);
	}
	...
	public MOBILE_PHONE_STORE(Name name) {
		setName(name);
	}
	...
	public MOBILE_PHONE_STORE(NameFuzzy nameFuzzy) {
	...
	public MOBILE_PHONE_STORE(NameRuby nameRuby) {
	...
	public MOBILE_PHONE_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public MOBILE_PHONE_STORE(OpeningHours openingHours) {
	...
	public MOBILE_PHONE_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public MOBILE_PHONE_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public MOBILE_PHONE_STORE(Owns owns) {
		setOwns(owns);
	}
	...
	public MOBILE_PHONE_STORE(ParentOrganization parentOrganization) {
	...
	public MOBILE_PHONE_STORE(PaymentAccepted paymentAccepted) {
	...
	public MOBILE_PHONE_STORE(Photo photo) {
		setPhoto(photo);
	}
	...
	public MOBILE_PHONE_STORE(PotentialAction potentialAction) {
	...
	public MOBILE_PHONE_STORE(PriceRange priceRange) {
	...
	public MOBILE_PHONE_STORE(PublicAccess publicAccess) {
	...
	public MOBILE_PHONE_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public MOBILE_PHONE_STORE(Review review) {
		setReview(review);
	}
	...
	public MOBILE_PHONE_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MOBILE_PHONE_STORE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public MOBILE_PHONE_STORE(SmokingAllowed smokingAllowed) {
	...
	public MOBILE_PHONE_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public MOBILE_PHONE_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MOBILE_PHONE_STORE(SubOrganization subOrganization) {
	...
	public MOBILE_PHONE_STORE(SubjectOf subjectOf) {
	...
	public MOBILE_PHONE_STORE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public MOBILE_PHONE_STORE(Telephone telephone) {
	...
	public MOBILE_PHONE_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public MOBILE_PHONE_STORE(Url url) {
		setUrl(url);
	}
	...
	public MOBILE_PHONE_STORE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.MobilePhoneStore org) {
		setSeq(org.getSeq());
