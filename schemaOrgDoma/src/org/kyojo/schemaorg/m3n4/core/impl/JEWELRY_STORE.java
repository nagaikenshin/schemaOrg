...
public class JEWELRY_STORE implements Clazz.JewelryStore {
	...
	public JEWELRY_STORE() {
	}

	public JEWELRY_STORE(Long seq) {
		setSeq(seq);
	}

	public JEWELRY_STORE(String string) {
	...
	public JEWELRY_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public JEWELRY_STORE(AdditionalProperty additionalProperty) {
	...
	public JEWELRY_STORE(AdditionalType additionalType) {
	...
	public JEWELRY_STORE(Address address) {
		setAddress(address);
	}
	...
	public JEWELRY_STORE(AggregateRating aggregateRating) {
	...
	public JEWELRY_STORE(AlternateName alternateName) {
	...
	public JEWELRY_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public JEWELRY_STORE(AmenityFeature amenityFeature) {
	...
	public JEWELRY_STORE(AreaServed areaServed) {
	...
	public JEWELRY_STORE(Award award) {
		setAward(award);
	}
	...
	public JEWELRY_STORE(BranchCode branchCode) {
	...
	public JEWELRY_STORE(Brand brand) {
		setBrand(brand);
	}
	...
	public JEWELRY_STORE(ContactPoint contactPoint) {
	...
	public JEWELRY_STORE(ContainedInPlace containedInPlace) {
	...
	public JEWELRY_STORE(ContainsPlace containsPlace) {
	...
	public JEWELRY_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public JEWELRY_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public JEWELRY_STORE(Department department) {
	...
	public JEWELRY_STORE(Description description) {
	...
	public JEWELRY_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public JEWELRY_STORE(DissolutionDate dissolutionDate) {
	...
	public JEWELRY_STORE(DiversityPolicy diversityPolicy) {
	...
	public JEWELRY_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public JEWELRY_STORE(Duns duns) {
		setDuns(duns);
	}
	...
	public JEWELRY_STORE(Email email) {
		setEmail(email);
	}
	...
	public JEWELRY_STORE(Employee employee) {
	...
	public JEWELRY_STORE(EthicsPolicy ethicsPolicy) {
	...
	public JEWELRY_STORE(Event event) {
		setEvent(event);
	}
	...
	public JEWELRY_STORE(FaxNumber faxNumber) {
	...
	public JEWELRY_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public JEWELRY_STORE(FoundingDate foundingDate) {
	...
	public JEWELRY_STORE(FoundingLocation foundingLocation) {
	...
	public JEWELRY_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public JEWELRY_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public JEWELRY_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public JEWELRY_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public JEWELRY_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public JEWELRY_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public JEWELRY_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public JEWELRY_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public JEWELRY_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public JEWELRY_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public JEWELRY_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public JEWELRY_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public JEWELRY_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public JEWELRY_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public JEWELRY_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public JEWELRY_STORE(Identifier identifier) {
	...
	public JEWELRY_STORE(Image image) {
		setImage(image);
	}
	...
	public JEWELRY_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public JEWELRY_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public JEWELRY_STORE(KnowsAbout knowsAbout) {
	...
	public JEWELRY_STORE(KnowsLanguage knowsLanguage) {
	...
	public JEWELRY_STORE(LegalName legalName) {
	...
	public JEWELRY_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public JEWELRY_STORE(Location location) {
	...
	public JEWELRY_STORE(Logo logo) {
		setLogo(logo);
	}
	...
	public JEWELRY_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public JEWELRY_STORE(MakesOffer makesOffer) {
	...
	public JEWELRY_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public JEWELRY_STORE(Member member) {
		setMember(member);
	}
	...
	public JEWELRY_STORE(MemberOf memberOf) {
	...
	public JEWELRY_STORE(Naics naics) {
		setNaics(naics);
	}
	...
	public JEWELRY_STORE(Name name) {
		setName(name);
	}
	...
	public JEWELRY_STORE(NameFuzzy nameFuzzy) {
	...
	public JEWELRY_STORE(NameRuby nameRuby) {
	...
	public JEWELRY_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public JEWELRY_STORE(OpeningHours openingHours) {
	...
	public JEWELRY_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public JEWELRY_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public JEWELRY_STORE(Owns owns) {
		setOwns(owns);
	}
	...
	public JEWELRY_STORE(ParentOrganization parentOrganization) {
	...
	public JEWELRY_STORE(PaymentAccepted paymentAccepted) {
	...
	public JEWELRY_STORE(Photo photo) {
		setPhoto(photo);
	}
	...
	public JEWELRY_STORE(PotentialAction potentialAction) {
	...
	public JEWELRY_STORE(PriceRange priceRange) {
	...
	public JEWELRY_STORE(PublicAccess publicAccess) {
	...
	public JEWELRY_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public JEWELRY_STORE(Review review) {
		setReview(review);
	}
	...
	public JEWELRY_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public JEWELRY_STORE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public JEWELRY_STORE(SmokingAllowed smokingAllowed) {
	...
	public JEWELRY_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public JEWELRY_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public JEWELRY_STORE(SubOrganization subOrganization) {
	...
	public JEWELRY_STORE(SubjectOf subjectOf) {
	...
	public JEWELRY_STORE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public JEWELRY_STORE(Telephone telephone) {
	...
	public JEWELRY_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public JEWELRY_STORE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.JewelryStore org) {
		setSeq(org.getSeq());
