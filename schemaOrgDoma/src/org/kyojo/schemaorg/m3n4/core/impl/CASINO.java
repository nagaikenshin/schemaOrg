...
public class CASINO implements Clazz.Casino {
	...
	public CASINO(Long seq) {
		setSeq(seq);
	}

	public CASINO(String string) {
	...
	public CASINO(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public CASINO(AdditionalProperty additionalProperty) {
	...
	public CASINO(AdditionalType additionalType) {
	...
	public CASINO(AggregateRating aggregateRating) {
	...
	public CASINO(AlternateName alternateName) {
	...
	public CASINO(AmenityFeature amenityFeature) {
	...
	public CASINO(AreaServed areaServed) {
	...
	public CASINO(BranchCode branchCode) {
	...
	public CASINO(ContactPoint contactPoint) {
	...
	public CASINO(ContainedInPlace containedInPlace) {
	...
	public CASINO(ContainsPlace containsPlace) {
	...
	public CASINO(CorrectionsPolicy correctionsPolicy) {
	...
	public CASINO(CurrenciesAccepted currenciesAccepted) {
	...
	public CASINO(Department department) {
	...
	public CASINO(Description description) {
	...
	public CASINO(DisambiguatingDescription disambiguatingDescription) {
	...
	public CASINO(DissolutionDate dissolutionDate) {
	...
	public CASINO(DiversityPolicy diversityPolicy) {
	...
	public CASINO(DiversityStaffingReport diversityStaffingReport) {
	...
	public CASINO(Employee employee) {
	...
	public CASINO(EthicsPolicy ethicsPolicy) {
	...
	public CASINO(FaxNumber faxNumber) {
	...
	public CASINO(FoundingDate foundingDate) {
	...
	public CASINO(FoundingLocation foundingLocation) {
	...
	public CASINO(GeospatiallyContains geospatiallyContains) {
	...
	public CASINO(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public CASINO(GeospatiallyCovers geospatiallyCovers) {
	...
	public CASINO(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public CASINO(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public CASINO(GeospatiallyEquals geospatiallyEquals) {
	...
	public CASINO(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public CASINO(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public CASINO(GeospatiallyTouches geospatiallyTouches) {
	...
	public CASINO(GeospatiallyWithin geospatiallyWithin) {
	...
	public CASINO(GlobalLocationNumber globalLocationNumber) {
	...
	public CASINO(HasOfferCatalog hasOfferCatalog) {
	...
	public CASINO(Identifier identifier) {
	...
	public CASINO(IsAccessibleForFree isAccessibleForFree) {
	...
	public CASINO(KnowsAbout knowsAbout) {
	...
	public CASINO(KnowsLanguage knowsLanguage) {
	...
	public CASINO(LegalName legalName) {
	...
	public CASINO(Location location) {
	...
	public CASINO(MainEntityOfPage mainEntityOfPage) {
	...
	public CASINO(MakesOffer makesOffer) {
	...
	public CASINO(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public CASINO(MemberOf memberOf) {
	...
	public CASINO(NameFuzzy nameFuzzy) {
	...
	public CASINO(NameRuby nameRuby) {
	...
	public CASINO(NumberOfEmployees numberOfEmployees) {
	...
	public CASINO(OpeningHours openingHours) {
	...
	public CASINO(OpeningHoursSpecification openingHoursSpecification) {
	...
	public CASINO(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public CASINO(ParentOrganization parentOrganization) {
	...
	public CASINO(PaymentAccepted paymentAccepted) {
	...
	public CASINO(PotentialAction potentialAction) {
	...
	public CASINO(PriceRange priceRange) {
	...
	public CASINO(PublicAccess publicAccess) {
	...
	public CASINO(PublishingPrinciples publishingPrinciples) {
	...
	public CASINO(SmokingAllowed smokingAllowed) {
	...
	public CASINO(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public CASINO(SubOrganization subOrganization) {
	...
	public CASINO(SubjectOf subjectOf) {
	...
	public CASINO(Telephone telephone) {
	...
	public CASINO(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Casino org) {
		setSeq(org.getSeq());
