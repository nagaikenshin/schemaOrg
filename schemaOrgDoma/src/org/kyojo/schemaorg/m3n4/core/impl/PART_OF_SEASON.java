...
public class PART_OF_SEASON implements Container.PartOfSeason {
	...
	public PART_OF_SEASON(BusTrip busTrip) {
	...
	public PART_OF_SEASON(Flight flight) {
	...
	public PART_OF_SEASON(TouristTrip touristTrip) {
	...
	public PART_OF_SEASON(TrainTrip trainTrip) {
	...
	public PART_OF_SEASON(Trip trip) {
