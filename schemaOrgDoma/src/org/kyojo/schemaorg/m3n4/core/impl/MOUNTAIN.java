...
public class MOUNTAIN implements Clazz.Mountain {
	...
	public MOUNTAIN(Long seq) {
		setSeq(seq);
	}

	public MOUNTAIN(String string) {
	...
	public MOUNTAIN(AdditionalProperty additionalProperty) {
	...
	public MOUNTAIN(AdditionalType additionalType) {
	...
	public MOUNTAIN(Address address) {
		setAddress(address);
	}
	...
	public MOUNTAIN(AggregateRating aggregateRating) {
	...
	public MOUNTAIN(AlternateName alternateName) {
	...
	public MOUNTAIN(AmenityFeature amenityFeature) {
	...
	public MOUNTAIN(BranchCode branchCode) {
	...
	public MOUNTAIN(ContainedInPlace containedInPlace) {
	...
	public MOUNTAIN(ContainsPlace containsPlace) {
	...
	public MOUNTAIN(Description description) {
	...
	public MOUNTAIN(DisambiguatingDescription disambiguatingDescription) {
	...
	public MOUNTAIN(FaxNumber faxNumber) {
	...
	public MOUNTAIN(GeospatiallyContains geospatiallyContains) {
	...
	public MOUNTAIN(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public MOUNTAIN(GeospatiallyCovers geospatiallyCovers) {
	...
	public MOUNTAIN(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public MOUNTAIN(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public MOUNTAIN(GeospatiallyEquals geospatiallyEquals) {
	...
	public MOUNTAIN(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public MOUNTAIN(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public MOUNTAIN(GeospatiallyTouches geospatiallyTouches) {
	...
	public MOUNTAIN(GeospatiallyWithin geospatiallyWithin) {
	...
	public MOUNTAIN(GlobalLocationNumber globalLocationNumber) {
	...
	public MOUNTAIN(Identifier identifier) {
	...
	public MOUNTAIN(IsAccessibleForFree isAccessibleForFree) {
	...
	public MOUNTAIN(MainEntityOfPage mainEntityOfPage) {
	...
	public MOUNTAIN(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public MOUNTAIN(NameFuzzy nameFuzzy) {
	...
	public MOUNTAIN(NameRuby nameRuby) {
	...
	public MOUNTAIN(OpeningHoursSpecification openingHoursSpecification) {
	...
	public MOUNTAIN(PotentialAction potentialAction) {
	...
	public MOUNTAIN(PublicAccess publicAccess) {
	...
	public MOUNTAIN(SmokingAllowed smokingAllowed) {
	...
	public MOUNTAIN(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public MOUNTAIN(SubjectOf subjectOf) {
	...
	public MOUNTAIN(Telephone telephone) {
	...
	public void copy(Clazz.Mountain org) {
		setSeq(org.getSeq());
