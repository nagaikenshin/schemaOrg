...
public class ORDER_NUMBER implements Container.OrderNumber {
	...
	public ORDER_NUMBER(LocationFeatureSpecification locationFeatureSpecification) {
	...
	public ORDER_NUMBER(PropertyValue propertyValue) {
	...
	public ORDER_NUMBER(String string) {
		this(new TEXT(string));
	}

	public ORDER_NUMBER(Text text) {
	...
	public ORDER_NUMBER(List<LocationFeatureSpecification> locationFeatureSpecificationList,
	...
	public void copy(Container.OrderNumber org) {
