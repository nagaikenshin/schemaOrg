...
public class FOLLOWS implements Container.Follows {
	...
	public FOLLOWS(Patient patient) {
	...
	public FOLLOWS(List<Patient> patientList,
			List<Person> personList) {
		setPatientList(patientList);
		setPersonList(personList);
	}

	public void copy(Container.Follows org) {
