...
public class RATING_VALUE implements Container.RatingValue {
	...
	public RATING_VALUE(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public RATING_VALUE(Float fl0at) {
	...
	public RATING_VALUE(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public RATING_VALUE(Integer integer) {
	...
	public RATING_VALUE(List<Float> fl0atList,
