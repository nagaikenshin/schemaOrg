...
public class AUTO_WASH implements Clazz.AutoWash {
	...
	public AUTO_WASH(Long seq) {
		setSeq(seq);
	}

	public AUTO_WASH(String string) {
	...
	public AUTO_WASH(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public AUTO_WASH(AdditionalProperty additionalProperty) {
	...
	public AUTO_WASH(AdditionalType additionalType) {
	...
	public AUTO_WASH(Address address) {
		setAddress(address);
	}
	...
	public AUTO_WASH(AggregateRating aggregateRating) {
	...
	public AUTO_WASH(AlternateName alternateName) {
	...
	public AUTO_WASH(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public AUTO_WASH(AmenityFeature amenityFeature) {
	...
	public AUTO_WASH(AreaServed areaServed) {
	...
	public AUTO_WASH(BranchCode branchCode) {
	...
	public AUTO_WASH(ContactPoint contactPoint) {
	...
	public AUTO_WASH(ContainedInPlace containedInPlace) {
	...
	public AUTO_WASH(ContainsPlace containsPlace) {
	...
	public AUTO_WASH(CorrectionsPolicy correctionsPolicy) {
	...
	public AUTO_WASH(CurrenciesAccepted currenciesAccepted) {
	...
	public AUTO_WASH(Department department) {
	...
	public AUTO_WASH(Description description) {
	...
	public AUTO_WASH(DisambiguatingDescription disambiguatingDescription) {
	...
	public AUTO_WASH(DissolutionDate dissolutionDate) {
	...
	public AUTO_WASH(DiversityPolicy diversityPolicy) {
	...
	public AUTO_WASH(DiversityStaffingReport diversityStaffingReport) {
	...
	public AUTO_WASH(Employee employee) {
	...
	public AUTO_WASH(EthicsPolicy ethicsPolicy) {
	...
	public AUTO_WASH(FaxNumber faxNumber) {
	...
	public AUTO_WASH(Founder founder) {
		setFounder(founder);
	}
	...
	public AUTO_WASH(FoundingDate foundingDate) {
	...
	public AUTO_WASH(FoundingLocation foundingLocation) {
	...
	public AUTO_WASH(Funder funder) {
		setFunder(funder);
	}
	...
	public AUTO_WASH(GeospatiallyContains geospatiallyContains) {
	...
	public AUTO_WASH(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public AUTO_WASH(GeospatiallyCovers geospatiallyCovers) {
	...
	public AUTO_WASH(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public AUTO_WASH(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public AUTO_WASH(GeospatiallyEquals geospatiallyEquals) {
	...
	public AUTO_WASH(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public AUTO_WASH(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public AUTO_WASH(GeospatiallyTouches geospatiallyTouches) {
	...
	public AUTO_WASH(GeospatiallyWithin geospatiallyWithin) {
	...
	public AUTO_WASH(GlobalLocationNumber globalLocationNumber) {
	...
	public AUTO_WASH(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public AUTO_WASH(HasOfferCatalog hasOfferCatalog) {
	...
	public AUTO_WASH(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public AUTO_WASH(Identifier identifier) {
	...
	public AUTO_WASH(IsAccessibleForFree isAccessibleForFree) {
	...
	public AUTO_WASH(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public AUTO_WASH(KnowsAbout knowsAbout) {
	...
	public AUTO_WASH(KnowsLanguage knowsLanguage) {
	...
	public AUTO_WASH(LegalName legalName) {
	...
	public AUTO_WASH(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public AUTO_WASH(Location location) {
	...
	public AUTO_WASH(MainEntityOfPage mainEntityOfPage) {
	...
	public AUTO_WASH(MakesOffer makesOffer) {
	...
	public AUTO_WASH(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public AUTO_WASH(Member member) {
		setMember(member);
	}
	...
	public AUTO_WASH(MemberOf memberOf) {
	...
	public AUTO_WASH(NameFuzzy nameFuzzy) {
	...
	public AUTO_WASH(NameRuby nameRuby) {
	...
	public AUTO_WASH(NumberOfEmployees numberOfEmployees) {
	...
	public AUTO_WASH(OpeningHours openingHours) {
	...
	public AUTO_WASH(OpeningHoursSpecification openingHoursSpecification) {
	...
	public AUTO_WASH(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public AUTO_WASH(ParentOrganization parentOrganization) {
	...
	public AUTO_WASH(PaymentAccepted paymentAccepted) {
	...
	public AUTO_WASH(PotentialAction potentialAction) {
	...
	public AUTO_WASH(PriceRange priceRange) {
	...
	public AUTO_WASH(PublicAccess publicAccess) {
	...
	public AUTO_WASH(PublishingPrinciples publishingPrinciples) {
	...
	public AUTO_WASH(Review review) {
		setReview(review);
	}
	...
	public AUTO_WASH(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public AUTO_WASH(SmokingAllowed smokingAllowed) {
	...
	public AUTO_WASH(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public AUTO_WASH(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public AUTO_WASH(SubOrganization subOrganization) {
	...
	public AUTO_WASH(SubjectOf subjectOf) {
	...
	public AUTO_WASH(Telephone telephone) {
	...
	public AUTO_WASH(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.AutoWash org) {
		setSeq(org.getSeq());
