...
public class NUM_CHILDREN implements Container.NumChildren {
	...
	public NUM_CHILDREN(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public NUM_CHILDREN(Integer integer) {
	...
	public NUM_CHILDREN(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public NUM_CHILDREN(QuantitativeValue quantitativeValue) {
	...
	public NUM_CHILDREN(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public NUM_CHILDREN(List<Integer> integerList,
	...
	public void copy(Container.NumChildren org) {
