...
public class HOUSE_PAINTER implements Clazz.HousePainter {
	...
	public HOUSE_PAINTER() {
	}

	public HOUSE_PAINTER(Long seq) {
		setSeq(seq);
	}

	public HOUSE_PAINTER(String string) {
	...
	public HOUSE_PAINTER(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public HOUSE_PAINTER(AdditionalProperty additionalProperty) {
	...
	public HOUSE_PAINTER(AdditionalType additionalType) {
	...
	public HOUSE_PAINTER(Address address) {
		setAddress(address);
	}
	...
	public HOUSE_PAINTER(AggregateRating aggregateRating) {
	...
	public HOUSE_PAINTER(AlternateName alternateName) {
	...
	public HOUSE_PAINTER(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public HOUSE_PAINTER(AmenityFeature amenityFeature) {
	...
	public HOUSE_PAINTER(AreaServed areaServed) {
	...
	public HOUSE_PAINTER(Award award) {
		setAward(award);
	}
	...
	public HOUSE_PAINTER(BranchCode branchCode) {
	...
	public HOUSE_PAINTER(Brand brand) {
		setBrand(brand);
	}
	...
	public HOUSE_PAINTER(ContactPoint contactPoint) {
	...
	public HOUSE_PAINTER(ContainedInPlace containedInPlace) {
	...
	public HOUSE_PAINTER(ContainsPlace containsPlace) {
	...
	public HOUSE_PAINTER(CorrectionsPolicy correctionsPolicy) {
	...
	public HOUSE_PAINTER(CurrenciesAccepted currenciesAccepted) {
	...
	public HOUSE_PAINTER(Department department) {
	...
	public HOUSE_PAINTER(Description description) {
	...
	public HOUSE_PAINTER(DisambiguatingDescription disambiguatingDescription) {
	...
	public HOUSE_PAINTER(DissolutionDate dissolutionDate) {
	...
	public HOUSE_PAINTER(DiversityPolicy diversityPolicy) {
	...
	public HOUSE_PAINTER(DiversityStaffingReport diversityStaffingReport) {
	...
	public HOUSE_PAINTER(Duns duns) {
		setDuns(duns);
	}
	...
	public HOUSE_PAINTER(Email email) {
		setEmail(email);
	}
	...
	public HOUSE_PAINTER(Employee employee) {
	...
	public HOUSE_PAINTER(EthicsPolicy ethicsPolicy) {
	...
	public HOUSE_PAINTER(Event event) {
		setEvent(event);
	}
	...
	public HOUSE_PAINTER(FaxNumber faxNumber) {
	...
	public HOUSE_PAINTER(Founder founder) {
		setFounder(founder);
	}
	...
	public HOUSE_PAINTER(FoundingDate foundingDate) {
	...
	public HOUSE_PAINTER(FoundingLocation foundingLocation) {
	...
	public HOUSE_PAINTER(Funder funder) {
		setFunder(funder);
	}
	...
	public HOUSE_PAINTER(GeospatiallyContains geospatiallyContains) {
	...
	public HOUSE_PAINTER(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public HOUSE_PAINTER(GeospatiallyCovers geospatiallyCovers) {
	...
	public HOUSE_PAINTER(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public HOUSE_PAINTER(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public HOUSE_PAINTER(GeospatiallyEquals geospatiallyEquals) {
	...
	public HOUSE_PAINTER(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public HOUSE_PAINTER(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public HOUSE_PAINTER(GeospatiallyTouches geospatiallyTouches) {
	...
	public HOUSE_PAINTER(GeospatiallyWithin geospatiallyWithin) {
	...
	public HOUSE_PAINTER(GlobalLocationNumber globalLocationNumber) {
	...
	public HOUSE_PAINTER(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public HOUSE_PAINTER(HasOfferCatalog hasOfferCatalog) {
	...
	public HOUSE_PAINTER(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public HOUSE_PAINTER(Identifier identifier) {
	...
	public HOUSE_PAINTER(Image image) {
		setImage(image);
	}
	...
	public HOUSE_PAINTER(IsAccessibleForFree isAccessibleForFree) {
	...
	public HOUSE_PAINTER(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public HOUSE_PAINTER(KnowsAbout knowsAbout) {
	...
	public HOUSE_PAINTER(KnowsLanguage knowsLanguage) {
	...
	public HOUSE_PAINTER(LegalName legalName) {
	...
	public HOUSE_PAINTER(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public HOUSE_PAINTER(Location location) {
	...
	public HOUSE_PAINTER(Logo logo) {
		setLogo(logo);
	}
	...
	public HOUSE_PAINTER(MainEntityOfPage mainEntityOfPage) {
	...
	public HOUSE_PAINTER(MakesOffer makesOffer) {
	...
	public HOUSE_PAINTER(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public HOUSE_PAINTER(Member member) {
		setMember(member);
	}
	...
	public HOUSE_PAINTER(MemberOf memberOf) {
	...
	public HOUSE_PAINTER(Naics naics) {
		setNaics(naics);
	}
	...
	public HOUSE_PAINTER(Name name) {
		setName(name);
	}
	...
	public HOUSE_PAINTER(NameFuzzy nameFuzzy) {
	...
	public HOUSE_PAINTER(NameRuby nameRuby) {
	...
	public HOUSE_PAINTER(NumberOfEmployees numberOfEmployees) {
	...
	public HOUSE_PAINTER(OpeningHours openingHours) {
	...
	public HOUSE_PAINTER(OpeningHoursSpecification openingHoursSpecification) {
	...
	public HOUSE_PAINTER(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public HOUSE_PAINTER(Owns owns) {
		setOwns(owns);
	}
	...
	public HOUSE_PAINTER(ParentOrganization parentOrganization) {
	...
	public HOUSE_PAINTER(PaymentAccepted paymentAccepted) {
	...
	public HOUSE_PAINTER(Photo photo) {
		setPhoto(photo);
	}
	...
	public HOUSE_PAINTER(PotentialAction potentialAction) {
	...
	public HOUSE_PAINTER(PriceRange priceRange) {
	...
	public HOUSE_PAINTER(PublicAccess publicAccess) {
	...
	public HOUSE_PAINTER(PublishingPrinciples publishingPrinciples) {
	...
	public HOUSE_PAINTER(Review review) {
		setReview(review);
	}
	...
	public HOUSE_PAINTER(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public HOUSE_PAINTER(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public HOUSE_PAINTER(SmokingAllowed smokingAllowed) {
	...
	public HOUSE_PAINTER(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public HOUSE_PAINTER(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public HOUSE_PAINTER(SubOrganization subOrganization) {
	...
	public HOUSE_PAINTER(SubjectOf subjectOf) {
	...
	public HOUSE_PAINTER(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public HOUSE_PAINTER(Telephone telephone) {
	...
	public HOUSE_PAINTER(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public HOUSE_PAINTER(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.HousePainter org) {
		setSeq(org.getSeq());
