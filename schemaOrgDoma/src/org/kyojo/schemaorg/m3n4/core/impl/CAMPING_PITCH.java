...
public class CAMPING_PITCH implements Clazz.CampingPitch {
	...
	public CAMPING_PITCH() {
	}

	public CAMPING_PITCH(Long seq) {
		setSeq(seq);
	}

	public CAMPING_PITCH(String string) {
	...
	public CAMPING_PITCH(AdditionalProperty additionalProperty) {
	...
	public CAMPING_PITCH(AdditionalType additionalType) {
	...
	public CAMPING_PITCH(Address address) {
		setAddress(address);
	}
	...
	public CAMPING_PITCH(AggregateRating aggregateRating) {
	...
	public CAMPING_PITCH(AlternateName alternateName) {
	...
	public CAMPING_PITCH(AmenityFeature amenityFeature) {
	...
	public CAMPING_PITCH(BranchCode branchCode) {
	...
	public CAMPING_PITCH(ContainedInPlace containedInPlace) {
	...
	public CAMPING_PITCH(ContainsPlace containsPlace) {
	...
	public CAMPING_PITCH(Description description) {
	...
	public CAMPING_PITCH(DisambiguatingDescription disambiguatingDescription) {
	...
	public CAMPING_PITCH(Event event) {
		setEvent(event);
	}
	...
	public CAMPING_PITCH(FaxNumber faxNumber) {
	...
	public CAMPING_PITCH(FloorSize floorSize) {
	...
	public CAMPING_PITCH(GeospatiallyContains geospatiallyContains) {
	...
	public CAMPING_PITCH(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public CAMPING_PITCH(GeospatiallyCovers geospatiallyCovers) {
	...
	public CAMPING_PITCH(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public CAMPING_PITCH(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public CAMPING_PITCH(GeospatiallyEquals geospatiallyEquals) {
	...
	public CAMPING_PITCH(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public CAMPING_PITCH(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public CAMPING_PITCH(GeospatiallyTouches geospatiallyTouches) {
	...
	public CAMPING_PITCH(GeospatiallyWithin geospatiallyWithin) {
	...
	public CAMPING_PITCH(GlobalLocationNumber globalLocationNumber) {
	...
	public CAMPING_PITCH(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public CAMPING_PITCH(Identifier identifier) {
	...
	public CAMPING_PITCH(Image image) {
		setImage(image);
	}
	...
	public CAMPING_PITCH(IsAccessibleForFree isAccessibleForFree) {
	...
	public CAMPING_PITCH(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public CAMPING_PITCH(Logo logo) {
		setLogo(logo);
	}
	...
	public CAMPING_PITCH(MainEntityOfPage mainEntityOfPage) {
	...
	public CAMPING_PITCH(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public CAMPING_PITCH(Name name) {
		setName(name);
	}
	...
	public CAMPING_PITCH(NameFuzzy nameFuzzy) {
	...
	public CAMPING_PITCH(NameRuby nameRuby) {
	...
	public CAMPING_PITCH(NumberOfRooms numberOfRooms) {
	...
	public CAMPING_PITCH(OpeningHoursSpecification openingHoursSpecification) {
	...
	public CAMPING_PITCH(PermittedUsage permittedUsage) {
	...
	public CAMPING_PITCH(PetsAllowed petsAllowed) {
	...
	public CAMPING_PITCH(Photo photo) {
		setPhoto(photo);
	}
	...
	public CAMPING_PITCH(PotentialAction potentialAction) {
	...
	public CAMPING_PITCH(PublicAccess publicAccess) {
	...
	public CAMPING_PITCH(Review review) {
		setReview(review);
	}
	...
	public CAMPING_PITCH(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CAMPING_PITCH(SmokingAllowed smokingAllowed) {
	...
	public CAMPING_PITCH(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public CAMPING_PITCH(SubjectOf subjectOf) {
	...
	public CAMPING_PITCH(Telephone telephone) {
	...
	public void copy(Clazz.CampingPitch org) {
		setSeq(org.getSeq());
