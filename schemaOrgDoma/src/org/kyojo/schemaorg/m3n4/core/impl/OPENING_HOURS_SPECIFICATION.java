...
import org.kyojo.schemaorg.m3n4.core.Container.DayOfWeek;
...
public class OPENING_HOURS_SPECIFICATION implements Clazz.OpeningHoursSpecification, Container.OpeningHoursSpecification {
	...
	public OPENING_HOURS_SPECIFICATION(String string) {
	...
	public OPENING_HOURS_SPECIFICATION(AdditionalType additionalType) {
	...
	public OPENING_HOURS_SPECIFICATION(AlternateName alternateName) {
	...
	public OPENING_HOURS_SPECIFICATION(Closes closes) {
		setCloses(closes);
	}
	...
	public OPENING_HOURS_SPECIFICATION(DayOfWeek dayOfWeek) {
	...
	public OPENING_HOURS_SPECIFICATION(Description description) {
	...
	public OPENING_HOURS_SPECIFICATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public OPENING_HOURS_SPECIFICATION(Identifier identifier) {
	...
	public OPENING_HOURS_SPECIFICATION(Image image) {
		setImage(image);
	}
	...
	public OPENING_HOURS_SPECIFICATION(MainEntityOfPage mainEntityOfPage) {
	...
	public OPENING_HOURS_SPECIFICATION(Name name) {
		setName(name);
	}
	...
	public OPENING_HOURS_SPECIFICATION(NameFuzzy nameFuzzy) {
	...
	public OPENING_HOURS_SPECIFICATION(NameRuby nameRuby) {
	...
	public OPENING_HOURS_SPECIFICATION(Clazz.OpeningHoursSpecification openingHoursSpecification) {
		openingHoursSpecificationList = new ArrayList<Clazz.OpeningHoursSpecification>();
	...
	public OPENING_HOURS_SPECIFICATION(Opens opens) {
		setOpens(opens);
	}
	...
	public OPENING_HOURS_SPECIFICATION(PotentialAction potentialAction) {
	...
	public OPENING_HOURS_SPECIFICATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public OPENING_HOURS_SPECIFICATION(SubjectOf subjectOf) {
	...
	public OPENING_HOURS_SPECIFICATION(Url url) {
		setUrl(url);
	}
	...
	public OPENING_HOURS_SPECIFICATION(ValidFrom validFrom) {
	...
	public OPENING_HOURS_SPECIFICATION(ValidThrough validThrough) {
	...
	public void copy(Clazz.OpeningHoursSpecification org) {
		...
		setCloses(org.getCloses());
		setDayOfWeek(org.getDayOfWeek());
	...
	public void copy(Container.OpeningHoursSpecification org) {
