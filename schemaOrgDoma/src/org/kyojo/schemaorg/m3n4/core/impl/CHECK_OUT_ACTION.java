...
public class CHECK_OUT_ACTION implements Clazz.CheckOutAction {
	...
	public CHECK_OUT_ACTION() {
	}

	public CHECK_OUT_ACTION(Long seq) {
		setSeq(seq);
	}

	public CHECK_OUT_ACTION(String string) {
	...
	public CHECK_OUT_ACTION(About about) {
		setAbout(about);
	}
	...
	public CHECK_OUT_ACTION(ActionStatus actionStatus) {
	...
	public CHECK_OUT_ACTION(AdditionalType additionalType) {
	...
	public CHECK_OUT_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public CHECK_OUT_ACTION(AlternateName alternateName) {
	...
	public CHECK_OUT_ACTION(Description description) {
	...
	public CHECK_OUT_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public CHECK_OUT_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public CHECK_OUT_ACTION(Error error) {
		setError(error);
	}
	...
	public CHECK_OUT_ACTION(Identifier identifier) {
	...
	public CHECK_OUT_ACTION(Image image) {
		setImage(image);
	}
	...
	public CHECK_OUT_ACTION(InLanguage inLanguage) {
	...
	public CHECK_OUT_ACTION(Instrument instrument) {
	...
	public CHECK_OUT_ACTION(Location location) {
	...
	public CHECK_OUT_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public CHECK_OUT_ACTION(Name name) {
		setName(name);
	}
	...
	public CHECK_OUT_ACTION(NameFuzzy nameFuzzy) {
	...
	public CHECK_OUT_ACTION(NameRuby nameRuby) {
	...
	public CHECK_OUT_ACTION(Object object) {
		setObject(object);
	}
	...
	public CHECK_OUT_ACTION(Participant participant) {
	...
	public CHECK_OUT_ACTION(PotentialAction potentialAction) {
	...
	public CHECK_OUT_ACTION(Recipient recipient) {
	...
	public CHECK_OUT_ACTION(Result result) {
		setResult(result);
	}
	...
	public CHECK_OUT_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CHECK_OUT_ACTION(StartTime startTime) {
	...
	public CHECK_OUT_ACTION(SubjectOf subjectOf) {
	...
	public CHECK_OUT_ACTION(Target target) {
		setTarget(target);
	}
	...
	public CHECK_OUT_ACTION(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.CheckOutAction org) {
		setSeq(org.getSeq());
