...
public class VALUE_MAX_LENGTH implements Container.ValueMaxLength {
	...
	public VALUE_MAX_LENGTH(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public VALUE_MAX_LENGTH(Float fl0at) {
	...
	public VALUE_MAX_LENGTH(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public VALUE_MAX_LENGTH(Integer integer) {
	...
	public VALUE_MAX_LENGTH(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public VALUE_MAX_LENGTH(Number number) {
	...
	public VALUE_MAX_LENGTH(List<Float> fl0atList,
	...
	public void copy(Container.ValueMaxLength org) {
