...
public class MOVIE_RENTAL_STORE implements Clazz.MovieRentalStore {
	...
	public MOVIE_RENTAL_STORE() {
	}

	public MOVIE_RENTAL_STORE(Long seq) {
		setSeq(seq);
	}

	public MOVIE_RENTAL_STORE(String string) {
	...
	public MOVIE_RENTAL_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public MOVIE_RENTAL_STORE(AdditionalProperty additionalProperty) {
	...
	public MOVIE_RENTAL_STORE(AdditionalType additionalType) {
	...
	public MOVIE_RENTAL_STORE(Address address) {
		setAddress(address);
	}
	...
	public MOVIE_RENTAL_STORE(AggregateRating aggregateRating) {
	...
	public MOVIE_RENTAL_STORE(AlternateName alternateName) {
	...
	public MOVIE_RENTAL_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public MOVIE_RENTAL_STORE(AmenityFeature amenityFeature) {
	...
	public MOVIE_RENTAL_STORE(AreaServed areaServed) {
	...
	public MOVIE_RENTAL_STORE(Award award) {
		setAward(award);
	}
	...
	public MOVIE_RENTAL_STORE(BranchCode branchCode) {
	...
	public MOVIE_RENTAL_STORE(Brand brand) {
		setBrand(brand);
	}
	...
	public MOVIE_RENTAL_STORE(ContactPoint contactPoint) {
	...
	public MOVIE_RENTAL_STORE(ContainedInPlace containedInPlace) {
	...
	public MOVIE_RENTAL_STORE(ContainsPlace containsPlace) {
	...
	public MOVIE_RENTAL_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public MOVIE_RENTAL_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public MOVIE_RENTAL_STORE(Department department) {
	...
	public MOVIE_RENTAL_STORE(Description description) {
	...
	public MOVIE_RENTAL_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public MOVIE_RENTAL_STORE(DissolutionDate dissolutionDate) {
	...
	public MOVIE_RENTAL_STORE(DiversityPolicy diversityPolicy) {
	...
	public MOVIE_RENTAL_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public MOVIE_RENTAL_STORE(Duns duns) {
		setDuns(duns);
	}
	...
	public MOVIE_RENTAL_STORE(Email email) {
		setEmail(email);
	}
	...
	public MOVIE_RENTAL_STORE(Employee employee) {
	...
	public MOVIE_RENTAL_STORE(EthicsPolicy ethicsPolicy) {
	...
	public MOVIE_RENTAL_STORE(Event event) {
		setEvent(event);
	}
	...
	public MOVIE_RENTAL_STORE(FaxNumber faxNumber) {
	...
	public MOVIE_RENTAL_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public MOVIE_RENTAL_STORE(FoundingDate foundingDate) {
	...
	public MOVIE_RENTAL_STORE(FoundingLocation foundingLocation) {
	...
	public MOVIE_RENTAL_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public MOVIE_RENTAL_STORE(Geo geo) {
		setGeo(geo);
	}
	...
	public MOVIE_RENTAL_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public MOVIE_RENTAL_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public MOVIE_RENTAL_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public MOVIE_RENTAL_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public MOVIE_RENTAL_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public MOVIE_RENTAL_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public MOVIE_RENTAL_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public MOVIE_RENTAL_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public MOVIE_RENTAL_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public MOVIE_RENTAL_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public MOVIE_RENTAL_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public MOVIE_RENTAL_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public MOVIE_RENTAL_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public MOVIE_RENTAL_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public MOVIE_RENTAL_STORE(Identifier identifier) {
	...
	public MOVIE_RENTAL_STORE(Image image) {
		setImage(image);
	}
	...
	public MOVIE_RENTAL_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public MOVIE_RENTAL_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public MOVIE_RENTAL_STORE(KnowsAbout knowsAbout) {
	...
	public MOVIE_RENTAL_STORE(KnowsLanguage knowsLanguage) {
	...
	public MOVIE_RENTAL_STORE(LegalName legalName) {
	...
	public MOVIE_RENTAL_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public MOVIE_RENTAL_STORE(Location location) {
	...
	public MOVIE_RENTAL_STORE(Logo logo) {
		setLogo(logo);
	}
	...
	public MOVIE_RENTAL_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public MOVIE_RENTAL_STORE(MakesOffer makesOffer) {
	...
	public MOVIE_RENTAL_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public MOVIE_RENTAL_STORE(Member member) {
		setMember(member);
	}
	...
	public MOVIE_RENTAL_STORE(MemberOf memberOf) {
	...
	public MOVIE_RENTAL_STORE(Naics naics) {
		setNaics(naics);
	}
	...
	public MOVIE_RENTAL_STORE(Name name) {
		setName(name);
	}
	...
	public MOVIE_RENTAL_STORE(NameFuzzy nameFuzzy) {
	...
	public MOVIE_RENTAL_STORE(NameRuby nameRuby) {
	...
	public MOVIE_RENTAL_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public MOVIE_RENTAL_STORE(OpeningHours openingHours) {
	...
	public MOVIE_RENTAL_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public MOVIE_RENTAL_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public MOVIE_RENTAL_STORE(Owns owns) {
		setOwns(owns);
	}
	...
	public MOVIE_RENTAL_STORE(ParentOrganization parentOrganization) {
	...
	public MOVIE_RENTAL_STORE(PaymentAccepted paymentAccepted) {
	...
	public MOVIE_RENTAL_STORE(Photo photo) {
		setPhoto(photo);
	}
	...
	public MOVIE_RENTAL_STORE(PotentialAction potentialAction) {
	...
	public MOVIE_RENTAL_STORE(PriceRange priceRange) {
	...
	public MOVIE_RENTAL_STORE(PublicAccess publicAccess) {
	...
	public MOVIE_RENTAL_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public MOVIE_RENTAL_STORE(Review review) {
		setReview(review);
	}
	...
	public MOVIE_RENTAL_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MOVIE_RENTAL_STORE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public MOVIE_RENTAL_STORE(SmokingAllowed smokingAllowed) {
	...
	public MOVIE_RENTAL_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public MOVIE_RENTAL_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MOVIE_RENTAL_STORE(SubOrganization subOrganization) {
	...
	public MOVIE_RENTAL_STORE(SubjectOf subjectOf) {
	...
	public MOVIE_RENTAL_STORE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public MOVIE_RENTAL_STORE(Telephone telephone) {
	...
	public MOVIE_RENTAL_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public MOVIE_RENTAL_STORE(Url url) {
		setUrl(url);
	}
	...
	public MOVIE_RENTAL_STORE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.MovieRentalStore org) {
		setSeq(org.getSeq());
