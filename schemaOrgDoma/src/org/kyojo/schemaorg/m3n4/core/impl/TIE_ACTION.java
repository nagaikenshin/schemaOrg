...
public class TIE_ACTION implements Clazz.TieAction {
	...
	public TIE_ACTION(Long seq) {
		setSeq(seq);
	}

	public TIE_ACTION(String string) {
	...
	public TIE_ACTION(ActionStatus actionStatus) {
	...
	public TIE_ACTION(AdditionalType additionalType) {
	...
	public TIE_ACTION(AlternateName alternateName) {
	...
	public TIE_ACTION(Description description) {
	...
	public TIE_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public TIE_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public TIE_ACTION(Identifier identifier) {
	...
	public TIE_ACTION(Instrument instrument) {
	...
	public TIE_ACTION(Location location) {
	...
	public TIE_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public TIE_ACTION(NameFuzzy nameFuzzy) {
	...
	public TIE_ACTION(NameRuby nameRuby) {
	...
	public TIE_ACTION(Object object) {
		setObject(object);
	}
	...
	public TIE_ACTION(Participant participant) {
	...
	public TIE_ACTION(PotentialAction potentialAction) {
	...
	public TIE_ACTION(Result result) {
		setResult(result);
	}
	...
	public TIE_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TIE_ACTION(StartTime startTime) {
	...
	public TIE_ACTION(SubjectOf subjectOf) {
	...
	public TIE_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.TieAction org) {
		setSeq(org.getSeq());
