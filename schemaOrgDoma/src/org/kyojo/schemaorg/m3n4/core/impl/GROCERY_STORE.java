...
public class GROCERY_STORE implements Clazz.GroceryStore {
	...
	public GROCERY_STORE(Long seq) {
		setSeq(seq);
	}

	public GROCERY_STORE(String string) {
	...
	public GROCERY_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public GROCERY_STORE(AdditionalProperty additionalProperty) {
	...
	public GROCERY_STORE(AdditionalType additionalType) {
	...
	public GROCERY_STORE(Address address) {
		setAddress(address);
	}
	...
	public GROCERY_STORE(AggregateRating aggregateRating) {
	...
	public GROCERY_STORE(AlternateName alternateName) {
	...
	public GROCERY_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public GROCERY_STORE(AmenityFeature amenityFeature) {
	...
	public GROCERY_STORE(AreaServed areaServed) {
	...
	public GROCERY_STORE(Award award) {
		setAward(award);
	}
	...
	public GROCERY_STORE(BranchCode branchCode) {
	...
	public GROCERY_STORE(Brand brand) {
		setBrand(brand);
	}
	...
	public GROCERY_STORE(ContactPoint contactPoint) {
	...
	public GROCERY_STORE(ContainedInPlace containedInPlace) {
	...
	public GROCERY_STORE(ContainsPlace containsPlace) {
	...
	public GROCERY_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public GROCERY_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public GROCERY_STORE(Department department) {
	...
	public GROCERY_STORE(Description description) {
	...
	public GROCERY_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public GROCERY_STORE(DissolutionDate dissolutionDate) {
	...
	public GROCERY_STORE(DiversityPolicy diversityPolicy) {
	...
	public GROCERY_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public GROCERY_STORE(Duns duns) {
		setDuns(duns);
	}
	...
	public GROCERY_STORE(Email email) {
		setEmail(email);
	}
	...
	public GROCERY_STORE(Employee employee) {
	...
	public GROCERY_STORE(EthicsPolicy ethicsPolicy) {
	...
	public GROCERY_STORE(Event event) {
		setEvent(event);
	}
	...
	public GROCERY_STORE(FaxNumber faxNumber) {
	...
	public GROCERY_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public GROCERY_STORE(FoundingDate foundingDate) {
	...
	public GROCERY_STORE(FoundingLocation foundingLocation) {
	...
	public GROCERY_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public GROCERY_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public GROCERY_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public GROCERY_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public GROCERY_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public GROCERY_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public GROCERY_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public GROCERY_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public GROCERY_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public GROCERY_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public GROCERY_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public GROCERY_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public GROCERY_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public GROCERY_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public GROCERY_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public GROCERY_STORE(Identifier identifier) {
	...
	public GROCERY_STORE(Image image) {
		setImage(image);
	}
	...
	public GROCERY_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public GROCERY_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public GROCERY_STORE(KnowsAbout knowsAbout) {
	...
	public GROCERY_STORE(KnowsLanguage knowsLanguage) {
	...
	public GROCERY_STORE(LegalName legalName) {
	...
	public GROCERY_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public GROCERY_STORE(Location location) {
	...
	public GROCERY_STORE(Logo logo) {
		setLogo(logo);
	}
	...
	public GROCERY_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public GROCERY_STORE(MakesOffer makesOffer) {
	...
	public GROCERY_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public GROCERY_STORE(Member member) {
		setMember(member);
	}
	...
	public GROCERY_STORE(MemberOf memberOf) {
	...
	public GROCERY_STORE(Naics naics) {
		setNaics(naics);
	}
	...
	public GROCERY_STORE(Name name) {
		setName(name);
	}
	...
	public GROCERY_STORE(NameFuzzy nameFuzzy) {
	...
	public GROCERY_STORE(NameRuby nameRuby) {
	...
	public GROCERY_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public GROCERY_STORE(OpeningHours openingHours) {
	...
	public GROCERY_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public GROCERY_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public GROCERY_STORE(Owns owns) {
		setOwns(owns);
	}
	...
	public GROCERY_STORE(ParentOrganization parentOrganization) {
	...
	public GROCERY_STORE(PaymentAccepted paymentAccepted) {
	...
	public GROCERY_STORE(Photo photo) {
		setPhoto(photo);
	}
	...
	public GROCERY_STORE(PotentialAction potentialAction) {
	...
	public GROCERY_STORE(PriceRange priceRange) {
	...
	public GROCERY_STORE(PublicAccess publicAccess) {
	...
	public GROCERY_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public GROCERY_STORE(Review review) {
		setReview(review);
	}
	...
	public GROCERY_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public GROCERY_STORE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public GROCERY_STORE(SmokingAllowed smokingAllowed) {
	...
	public GROCERY_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public GROCERY_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public GROCERY_STORE(SubOrganization subOrganization) {
	...
	public GROCERY_STORE(SubjectOf subjectOf) {
	...
	public GROCERY_STORE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public GROCERY_STORE(Telephone telephone) {
	...
	public GROCERY_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public GROCERY_STORE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.GroceryStore org) {
		setSeq(org.getSeq());
