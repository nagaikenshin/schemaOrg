...
public class MOTEL implements Clazz.Motel {
	...
	public MOTEL(Long seq) {
		setSeq(seq);
	}

	public MOTEL(String string) {
	...
	public MOTEL(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public MOTEL(AdditionalProperty additionalProperty) {
	...
	public MOTEL(AdditionalType additionalType) {
	...
	public MOTEL(AggregateRating aggregateRating) {
	...
	public MOTEL(AlternateName alternateName) {
	...
	public MOTEL(AmenityFeature amenityFeature) {
	...
	public MOTEL(AreaServed areaServed) {
	...
	public MOTEL(Audience audience) {
	...
	public MOTEL(AvailableLanguage availableLanguage) {
	...
	public MOTEL(BranchCode branchCode) {
	...
	public MOTEL(CheckinTime checkinTime) {
	...
	public MOTEL(CheckoutTime checkoutTime) {
	...
	public MOTEL(ContactPoint contactPoint) {
	...
	public MOTEL(ContainedInPlace containedInPlace) {
	...
	public MOTEL(ContainsPlace containsPlace) {
	...
	public MOTEL(CorrectionsPolicy correctionsPolicy) {
	...
	public MOTEL(CurrenciesAccepted currenciesAccepted) {
	...
	public MOTEL(Department department) {
	...
	public MOTEL(Description description) {
	...
	public MOTEL(DisambiguatingDescription disambiguatingDescription) {
	...
	public MOTEL(DissolutionDate dissolutionDate) {
	...
	public MOTEL(DiversityPolicy diversityPolicy) {
	...
	public MOTEL(DiversityStaffingReport diversityStaffingReport) {
	...
	public MOTEL(Employee employee) {
	...
	public MOTEL(EthicsPolicy ethicsPolicy) {
	...
	public MOTEL(FaxNumber faxNumber) {
	...
	public MOTEL(FoundingDate foundingDate) {
	...
	public MOTEL(FoundingLocation foundingLocation) {
	...
	public MOTEL(GeospatiallyContains geospatiallyContains) {
	...
	public MOTEL(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public MOTEL(GeospatiallyCovers geospatiallyCovers) {
	...
	public MOTEL(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public MOTEL(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public MOTEL(GeospatiallyEquals geospatiallyEquals) {
	...
	public MOTEL(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public MOTEL(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public MOTEL(GeospatiallyTouches geospatiallyTouches) {
	...
	public MOTEL(GeospatiallyWithin geospatiallyWithin) {
	...
	public MOTEL(GlobalLocationNumber globalLocationNumber) {
	...
	public MOTEL(HasOfferCatalog hasOfferCatalog) {
	...
	public MOTEL(Identifier identifier) {
	...
	public MOTEL(IsAccessibleForFree isAccessibleForFree) {
	...
	public MOTEL(KnowsAbout knowsAbout) {
	...
	public MOTEL(KnowsLanguage knowsLanguage) {
	...
	public MOTEL(LegalName legalName) {
	...
	public MOTEL(MainEntityOfPage mainEntityOfPage) {
	...
	public MOTEL(MakesOffer makesOffer) {
	...
	public MOTEL(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public MOTEL(MemberOf memberOf) {
	...
	public MOTEL(NameFuzzy nameFuzzy) {
	...
	public MOTEL(NameRuby nameRuby) {
	...
	public MOTEL(NumberOfEmployees numberOfEmployees) {
	...
	public MOTEL(OpeningHours openingHours) {
	...
	public MOTEL(OpeningHoursSpecification openingHoursSpecification) {
	...
	public MOTEL(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public MOTEL(ParentOrganization parentOrganization) {
	...
	public MOTEL(PaymentAccepted paymentAccepted) {
	...
	public MOTEL(PetsAllowed petsAllowed) {
	...
	public MOTEL(PotentialAction potentialAction) {
	...
	public MOTEL(PriceRange priceRange) {
	...
	public MOTEL(PublicAccess publicAccess) {
	...
	public MOTEL(PublishingPrinciples publishingPrinciples) {
	...
	public MOTEL(SmokingAllowed smokingAllowed) {
	...
	public MOTEL(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public MOTEL(StarRating starRating) {
	...
	public MOTEL(SubOrganization subOrganization) {
	...
	public MOTEL(SubjectOf subjectOf) {
	...
	public MOTEL(Telephone telephone) {
	...
	public MOTEL(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Motel org) {
		setSeq(org.getSeq());
