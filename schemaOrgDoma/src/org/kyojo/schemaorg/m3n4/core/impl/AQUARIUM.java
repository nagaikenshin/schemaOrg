...
public class AQUARIUM implements Clazz.Aquarium {
	...
	public AQUARIUM(Long seq) {
		setSeq(seq);
	}

	public AQUARIUM(String string) {
	...
	public AQUARIUM(AdditionalProperty additionalProperty) {
	...
	public AQUARIUM(AdditionalType additionalType) {
	...
	public AQUARIUM(Address address) {
		setAddress(address);
	}
	...
	public AQUARIUM(AggregateRating aggregateRating) {
	...
	public AQUARIUM(AlternateName alternateName) {
	...
	public AQUARIUM(AmenityFeature amenityFeature) {
	...
	public AQUARIUM(BranchCode branchCode) {
	...
	public AQUARIUM(ContainedInPlace containedInPlace) {
	...
	public AQUARIUM(ContainsPlace containsPlace) {
	...
	public AQUARIUM(Description description) {
	...
	public AQUARIUM(DisambiguatingDescription disambiguatingDescription) {
	...
	public AQUARIUM(FaxNumber faxNumber) {
	...
	public AQUARIUM(GeospatiallyContains geospatiallyContains) {
	...
	public AQUARIUM(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public AQUARIUM(GeospatiallyCovers geospatiallyCovers) {
	...
	public AQUARIUM(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public AQUARIUM(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public AQUARIUM(GeospatiallyEquals geospatiallyEquals) {
	...
	public AQUARIUM(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public AQUARIUM(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public AQUARIUM(GeospatiallyTouches geospatiallyTouches) {
	...
	public AQUARIUM(GeospatiallyWithin geospatiallyWithin) {
	...
	public AQUARIUM(GlobalLocationNumber globalLocationNumber) {
	...
	public AQUARIUM(Identifier identifier) {
	...
	public AQUARIUM(IsAccessibleForFree isAccessibleForFree) {
	...
	public AQUARIUM(MainEntityOfPage mainEntityOfPage) {
	...
	public AQUARIUM(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public AQUARIUM(NameFuzzy nameFuzzy) {
	...
	public AQUARIUM(NameRuby nameRuby) {
	...
	public AQUARIUM(OpeningHours openingHours) {
	...
	public AQUARIUM(OpeningHoursSpecification openingHoursSpecification) {
	...
	public AQUARIUM(PotentialAction potentialAction) {
	...
	public AQUARIUM(PublicAccess publicAccess) {
	...
	public AQUARIUM(SmokingAllowed smokingAllowed) {
	...
	public AQUARIUM(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public AQUARIUM(SubjectOf subjectOf) {
	...
	public AQUARIUM(Telephone telephone) {
	...
	public void copy(Clazz.Aquarium org) {
		setSeq(org.getSeq());
