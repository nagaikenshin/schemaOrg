...
public class HOSTEL implements Clazz.Hostel {
	...
	public HOSTEL(Long seq) {
		setSeq(seq);
	}

	public HOSTEL(String string) {
	...
	public HOSTEL(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public HOSTEL(AdditionalProperty additionalProperty) {
	...
	public HOSTEL(AdditionalType additionalType) {
	...
	public HOSTEL(AggregateRating aggregateRating) {
	...
	public HOSTEL(AlternateName alternateName) {
	...
	public HOSTEL(AmenityFeature amenityFeature) {
	...
	public HOSTEL(AreaServed areaServed) {
	...
	public HOSTEL(Audience audience) {
	...
	public HOSTEL(AvailableLanguage availableLanguage) {
	...
	public HOSTEL(BranchCode branchCode) {
	...
	public HOSTEL(CheckinTime checkinTime) {
	...
	public HOSTEL(CheckoutTime checkoutTime) {
	...
	public HOSTEL(ContactPoint contactPoint) {
	...
	public HOSTEL(ContainedInPlace containedInPlace) {
	...
	public HOSTEL(ContainsPlace containsPlace) {
	...
	public HOSTEL(CorrectionsPolicy correctionsPolicy) {
	...
	public HOSTEL(CurrenciesAccepted currenciesAccepted) {
	...
	public HOSTEL(Department department) {
	...
	public HOSTEL(Description description) {
	...
	public HOSTEL(DisambiguatingDescription disambiguatingDescription) {
	...
	public HOSTEL(DissolutionDate dissolutionDate) {
	...
	public HOSTEL(DiversityPolicy diversityPolicy) {
	...
	public HOSTEL(DiversityStaffingReport diversityStaffingReport) {
	...
	public HOSTEL(Employee employee) {
	...
	public HOSTEL(EthicsPolicy ethicsPolicy) {
	...
	public HOSTEL(FaxNumber faxNumber) {
	...
	public HOSTEL(FoundingDate foundingDate) {
	...
	public HOSTEL(FoundingLocation foundingLocation) {
	...
	public HOSTEL(GeospatiallyContains geospatiallyContains) {
	...
	public HOSTEL(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public HOSTEL(GeospatiallyCovers geospatiallyCovers) {
	...
	public HOSTEL(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public HOSTEL(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public HOSTEL(GeospatiallyEquals geospatiallyEquals) {
	...
	public HOSTEL(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public HOSTEL(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public HOSTEL(GeospatiallyTouches geospatiallyTouches) {
	...
	public HOSTEL(GeospatiallyWithin geospatiallyWithin) {
	...
	public HOSTEL(GlobalLocationNumber globalLocationNumber) {
	...
	public HOSTEL(HasOfferCatalog hasOfferCatalog) {
	...
	public HOSTEL(Identifier identifier) {
	...
	public HOSTEL(IsAccessibleForFree isAccessibleForFree) {
	...
	public HOSTEL(KnowsAbout knowsAbout) {
	...
	public HOSTEL(KnowsLanguage knowsLanguage) {
	...
	public HOSTEL(LegalName legalName) {
	...
	public HOSTEL(Location location) {
	...
	public HOSTEL(MainEntityOfPage mainEntityOfPage) {
	...
	public HOSTEL(MakesOffer makesOffer) {
	...
	public HOSTEL(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public HOSTEL(MemberOf memberOf) {
	...
	public HOSTEL(NameFuzzy nameFuzzy) {
	...
	public HOSTEL(NameRuby nameRuby) {
	...
	public HOSTEL(NumberOfEmployees numberOfEmployees) {
	...
	public HOSTEL(OpeningHours openingHours) {
	...
	public HOSTEL(OpeningHoursSpecification openingHoursSpecification) {
	...
	public HOSTEL(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public HOSTEL(ParentOrganization parentOrganization) {
	...
	public HOSTEL(PaymentAccepted paymentAccepted) {
	...
	public HOSTEL(PetsAllowed petsAllowed) {
	...
	public HOSTEL(PotentialAction potentialAction) {
	...
	public HOSTEL(PriceRange priceRange) {
	...
	public HOSTEL(PublicAccess publicAccess) {
	...
	public HOSTEL(PublishingPrinciples publishingPrinciples) {
	...
	public HOSTEL(SmokingAllowed smokingAllowed) {
	...
	public HOSTEL(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public HOSTEL(StarRating starRating) {
	...
	public HOSTEL(SubOrganization subOrganization) {
	...
	public HOSTEL(SubjectOf subjectOf) {
	...
	public HOSTEL(Telephone telephone) {
	...
	public HOSTEL(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Hostel org) {
		setSeq(org.getSeq());
