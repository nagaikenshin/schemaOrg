...
public class ILLUSTRATOR implements Container.Illustrator {
	...
	public ILLUSTRATOR(String string) {
	...
	public ILLUSTRATOR(Patient patient) {
	...
	public ILLUSTRATOR(List<Patient> patientList,
			List<Person> personList) {
		setPatientList(patientList);
		setPersonList(personList);
	}

	public void copy(Container.Illustrator org) {
