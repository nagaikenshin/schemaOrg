...
public class DEPARTMENT_STORE implements Clazz.DepartmentStore {
	...
	public DEPARTMENT_STORE(Long seq) {
		setSeq(seq);
	}

	public DEPARTMENT_STORE(String string) {
	...
	public DEPARTMENT_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public DEPARTMENT_STORE(AdditionalProperty additionalProperty) {
	...
	public DEPARTMENT_STORE(AdditionalType additionalType) {
	...
	public DEPARTMENT_STORE(Address address) {
		setAddress(address);
	}
	...
	public DEPARTMENT_STORE(AggregateRating aggregateRating) {
	...
	public DEPARTMENT_STORE(AlternateName alternateName) {
	...
	public DEPARTMENT_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public DEPARTMENT_STORE(AmenityFeature amenityFeature) {
	...
	public DEPARTMENT_STORE(AreaServed areaServed) {
	...
	public DEPARTMENT_STORE(Award award) {
		setAward(award);
	}
	...
	public DEPARTMENT_STORE(BranchCode branchCode) {
	...
	public DEPARTMENT_STORE(Brand brand) {
		setBrand(brand);
	}
	...
	public DEPARTMENT_STORE(ContactPoint contactPoint) {
	...
	public DEPARTMENT_STORE(ContainedInPlace containedInPlace) {
	...
	public DEPARTMENT_STORE(ContainsPlace containsPlace) {
	...
	public DEPARTMENT_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public DEPARTMENT_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public DEPARTMENT_STORE(Department department) {
	...
	public DEPARTMENT_STORE(Description description) {
	...
	public DEPARTMENT_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public DEPARTMENT_STORE(DissolutionDate dissolutionDate) {
	...
	public DEPARTMENT_STORE(DiversityPolicy diversityPolicy) {
	...
	public DEPARTMENT_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public DEPARTMENT_STORE(Duns duns) {
		setDuns(duns);
	}
	...
	public DEPARTMENT_STORE(Email email) {
		setEmail(email);
	}
	...
	public DEPARTMENT_STORE(Employee employee) {
	...
	public DEPARTMENT_STORE(EthicsPolicy ethicsPolicy) {
	...
	public DEPARTMENT_STORE(Event event) {
		setEvent(event);
	}
	...
	public DEPARTMENT_STORE(FaxNumber faxNumber) {
	...
	public DEPARTMENT_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public DEPARTMENT_STORE(FoundingDate foundingDate) {
	...
	public DEPARTMENT_STORE(FoundingLocation foundingLocation) {
	...
	public DEPARTMENT_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public DEPARTMENT_STORE(Geo geo) {
		setGeo(geo);
	}
	...
	public DEPARTMENT_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public DEPARTMENT_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public DEPARTMENT_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public DEPARTMENT_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public DEPARTMENT_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public DEPARTMENT_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public DEPARTMENT_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public DEPARTMENT_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public DEPARTMENT_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public DEPARTMENT_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public DEPARTMENT_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public DEPARTMENT_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public DEPARTMENT_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public DEPARTMENT_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public DEPARTMENT_STORE(Identifier identifier) {
	...
	public DEPARTMENT_STORE(Image image) {
		setImage(image);
	}
	...
	public DEPARTMENT_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public DEPARTMENT_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public DEPARTMENT_STORE(KnowsAbout knowsAbout) {
	...
	public DEPARTMENT_STORE(KnowsLanguage knowsLanguage) {
	...
	public DEPARTMENT_STORE(LegalName legalName) {
	...
	public DEPARTMENT_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public DEPARTMENT_STORE(Location location) {
	...
	public DEPARTMENT_STORE(Logo logo) {
		setLogo(logo);
	}
	...
	public DEPARTMENT_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public DEPARTMENT_STORE(MakesOffer makesOffer) {
	...
	public DEPARTMENT_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public DEPARTMENT_STORE(Member member) {
		setMember(member);
	}
	...
	public DEPARTMENT_STORE(MemberOf memberOf) {
	...
	public DEPARTMENT_STORE(Naics naics) {
		setNaics(naics);
	}
	...
	public DEPARTMENT_STORE(Name name) {
		setName(name);
	}
	...
	public DEPARTMENT_STORE(NameFuzzy nameFuzzy) {
	...
	public DEPARTMENT_STORE(NameRuby nameRuby) {
	...
	public DEPARTMENT_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public DEPARTMENT_STORE(OpeningHours openingHours) {
	...
	public DEPARTMENT_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public DEPARTMENT_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public DEPARTMENT_STORE(Owns owns) {
		setOwns(owns);
	}
	...
	public DEPARTMENT_STORE(ParentOrganization parentOrganization) {
	...
	public DEPARTMENT_STORE(PaymentAccepted paymentAccepted) {
	...
	public DEPARTMENT_STORE(Photo photo) {
		setPhoto(photo);
	}
	...
	public DEPARTMENT_STORE(PotentialAction potentialAction) {
	...
	public DEPARTMENT_STORE(PriceRange priceRange) {
	...
	public DEPARTMENT_STORE(PublicAccess publicAccess) {
	...
	public DEPARTMENT_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public DEPARTMENT_STORE(Review review) {
		setReview(review);
	}
	...
	public DEPARTMENT_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DEPARTMENT_STORE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public DEPARTMENT_STORE(SmokingAllowed smokingAllowed) {
	...
	public DEPARTMENT_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public DEPARTMENT_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public DEPARTMENT_STORE(SubOrganization subOrganization) {
	...
	public DEPARTMENT_STORE(SubjectOf subjectOf) {
	...
	public DEPARTMENT_STORE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public DEPARTMENT_STORE(Telephone telephone) {
	...
	public DEPARTMENT_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public DEPARTMENT_STORE(Url url) {
		setUrl(url);
	}
	...
	public DEPARTMENT_STORE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.DepartmentStore org) {
		setSeq(org.getSeq());
