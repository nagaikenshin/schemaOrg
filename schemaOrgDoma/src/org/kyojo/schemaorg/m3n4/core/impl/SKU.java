...
public class SKU implements Container.Sku {
	...
	public SKU(LocationFeatureSpecification locationFeatureSpecification) {
	...
	public SKU(PropertyValue propertyValue) {
	...
	public SKU(String string) {
		this(new TEXT(string));
	}

	public SKU(Text text) {
	...
	public SKU(List<LocationFeatureSpecification> locationFeatureSpecificationList,
	...
	public void copy(Container.Sku org) {
