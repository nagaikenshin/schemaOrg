...
public class FAST_FOOD_RESTAURANT implements Clazz.FastFoodRestaurant {
	...
	public FAST_FOOD_RESTAURANT() {
	}

	public FAST_FOOD_RESTAURANT(Long seq) {
		setSeq(seq);
	}

	public FAST_FOOD_RESTAURANT(String string) {
	...
	public FAST_FOOD_RESTAURANT(AcceptsReservations acceptsReservations) {
	...
	public FAST_FOOD_RESTAURANT(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public FAST_FOOD_RESTAURANT(AdditionalProperty additionalProperty) {
	...
	public FAST_FOOD_RESTAURANT(AdditionalType additionalType) {
	...
	public FAST_FOOD_RESTAURANT(Address address) {
		setAddress(address);
	}
	...
	public FAST_FOOD_RESTAURANT(AggregateRating aggregateRating) {
	...
	public FAST_FOOD_RESTAURANT(AlternateName alternateName) {
	...
	public FAST_FOOD_RESTAURANT(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public FAST_FOOD_RESTAURANT(AmenityFeature amenityFeature) {
	...
	public FAST_FOOD_RESTAURANT(AreaServed areaServed) {
	...
	public FAST_FOOD_RESTAURANT(Award award) {
		setAward(award);
	}
	...
	public FAST_FOOD_RESTAURANT(BranchCode branchCode) {
	...
	public FAST_FOOD_RESTAURANT(Brand brand) {
		setBrand(brand);
	}
	...
	public FAST_FOOD_RESTAURANT(ContactPoint contactPoint) {
	...
	public FAST_FOOD_RESTAURANT(ContainedInPlace containedInPlace) {
	...
	public FAST_FOOD_RESTAURANT(ContainsPlace containsPlace) {
	...
	public FAST_FOOD_RESTAURANT(CorrectionsPolicy correctionsPolicy) {
	...
	public FAST_FOOD_RESTAURANT(CurrenciesAccepted currenciesAccepted) {
	...
	public FAST_FOOD_RESTAURANT(Department department) {
	...
	public FAST_FOOD_RESTAURANT(Description description) {
	...
	public FAST_FOOD_RESTAURANT(DisambiguatingDescription disambiguatingDescription) {
	...
	public FAST_FOOD_RESTAURANT(DissolutionDate dissolutionDate) {
	...
	public FAST_FOOD_RESTAURANT(DiversityPolicy diversityPolicy) {
	...
	public FAST_FOOD_RESTAURANT(DiversityStaffingReport diversityStaffingReport) {
	...
	public FAST_FOOD_RESTAURANT(Duns duns) {
		setDuns(duns);
	}
	...
	public FAST_FOOD_RESTAURANT(Email email) {
		setEmail(email);
	}
	...
	public FAST_FOOD_RESTAURANT(Employee employee) {
	...
	public FAST_FOOD_RESTAURANT(EthicsPolicy ethicsPolicy) {
	...
	public FAST_FOOD_RESTAURANT(Event event) {
		setEvent(event);
	}
	...
	public FAST_FOOD_RESTAURANT(FaxNumber faxNumber) {
	...
	public FAST_FOOD_RESTAURANT(Founder founder) {
		setFounder(founder);
	}
	...
	public FAST_FOOD_RESTAURANT(FoundingDate foundingDate) {
	...
	public FAST_FOOD_RESTAURANT(FoundingLocation foundingLocation) {
	...
	public FAST_FOOD_RESTAURANT(Funder funder) {
		setFunder(funder);
	}
	...
	public FAST_FOOD_RESTAURANT(Geo geo) {
		setGeo(geo);
	}
	...
	public FAST_FOOD_RESTAURANT(GeospatiallyContains geospatiallyContains) {
	...
	public FAST_FOOD_RESTAURANT(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public FAST_FOOD_RESTAURANT(GeospatiallyCovers geospatiallyCovers) {
	...
	public FAST_FOOD_RESTAURANT(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public FAST_FOOD_RESTAURANT(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public FAST_FOOD_RESTAURANT(GeospatiallyEquals geospatiallyEquals) {
	...
	public FAST_FOOD_RESTAURANT(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public FAST_FOOD_RESTAURANT(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public FAST_FOOD_RESTAURANT(GeospatiallyTouches geospatiallyTouches) {
	...
	public FAST_FOOD_RESTAURANT(GeospatiallyWithin geospatiallyWithin) {
	...
	public FAST_FOOD_RESTAURANT(GlobalLocationNumber globalLocationNumber) {
	...
	public FAST_FOOD_RESTAURANT(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public FAST_FOOD_RESTAURANT(HasMenu hasMenu) {
		setHasMenu(hasMenu);
	}
	...
	public FAST_FOOD_RESTAURANT(HasOfferCatalog hasOfferCatalog) {
	...
	public FAST_FOOD_RESTAURANT(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public FAST_FOOD_RESTAURANT(Identifier identifier) {
	...
	public FAST_FOOD_RESTAURANT(Image image) {
		setImage(image);
	}
	...
	public FAST_FOOD_RESTAURANT(IsAccessibleForFree isAccessibleForFree) {
	...
	public FAST_FOOD_RESTAURANT(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public FAST_FOOD_RESTAURANT(KnowsAbout knowsAbout) {
	...
	public FAST_FOOD_RESTAURANT(KnowsLanguage knowsLanguage) {
	...
	public FAST_FOOD_RESTAURANT(LegalName legalName) {
	...
	public FAST_FOOD_RESTAURANT(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public FAST_FOOD_RESTAURANT(Location location) {
	...
	public FAST_FOOD_RESTAURANT(Logo logo) {
		setLogo(logo);
	}
	...
	public FAST_FOOD_RESTAURANT(MainEntityOfPage mainEntityOfPage) {
	...
	public FAST_FOOD_RESTAURANT(MakesOffer makesOffer) {
	...
	public FAST_FOOD_RESTAURANT(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public FAST_FOOD_RESTAURANT(Member member) {
		setMember(member);
	}
	...
	public FAST_FOOD_RESTAURANT(MemberOf memberOf) {
	...
	public FAST_FOOD_RESTAURANT(Naics naics) {
		setNaics(naics);
	}
	...
	public FAST_FOOD_RESTAURANT(Name name) {
		setName(name);
	}
	...
	public FAST_FOOD_RESTAURANT(NameFuzzy nameFuzzy) {
	...
	public FAST_FOOD_RESTAURANT(NameRuby nameRuby) {
	...
	public FAST_FOOD_RESTAURANT(NumberOfEmployees numberOfEmployees) {
	...
	public FAST_FOOD_RESTAURANT(OpeningHours openingHours) {
	...
	public FAST_FOOD_RESTAURANT(OpeningHoursSpecification openingHoursSpecification) {
	...
	public FAST_FOOD_RESTAURANT(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public FAST_FOOD_RESTAURANT(Owns owns) {
		setOwns(owns);
	}
	...
	public FAST_FOOD_RESTAURANT(ParentOrganization parentOrganization) {
	...
	public FAST_FOOD_RESTAURANT(PaymentAccepted paymentAccepted) {
	...
	public FAST_FOOD_RESTAURANT(Photo photo) {
		setPhoto(photo);
	}
	...
	public FAST_FOOD_RESTAURANT(PotentialAction potentialAction) {
	...
	public FAST_FOOD_RESTAURANT(PriceRange priceRange) {
	...
	public FAST_FOOD_RESTAURANT(PublicAccess publicAccess) {
	...
	public FAST_FOOD_RESTAURANT(PublishingPrinciples publishingPrinciples) {
	...
	public FAST_FOOD_RESTAURANT(Review review) {
		setReview(review);
	}
	...
	public FAST_FOOD_RESTAURANT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public FAST_FOOD_RESTAURANT(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public FAST_FOOD_RESTAURANT(ServesCuisine servesCuisine) {
	...
	public FAST_FOOD_RESTAURANT(SmokingAllowed smokingAllowed) {
	...
	public FAST_FOOD_RESTAURANT(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public FAST_FOOD_RESTAURANT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public FAST_FOOD_RESTAURANT(StarRating starRating) {
	...
	public FAST_FOOD_RESTAURANT(SubOrganization subOrganization) {
	...
	public FAST_FOOD_RESTAURANT(SubjectOf subjectOf) {
	...
	public FAST_FOOD_RESTAURANT(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public FAST_FOOD_RESTAURANT(Telephone telephone) {
	...
	public FAST_FOOD_RESTAURANT(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public FAST_FOOD_RESTAURANT(Url url) {
		setUrl(url);
	}
	...
	public FAST_FOOD_RESTAURANT(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.FastFoodRestaurant org) {
		setSeq(org.getSeq());
