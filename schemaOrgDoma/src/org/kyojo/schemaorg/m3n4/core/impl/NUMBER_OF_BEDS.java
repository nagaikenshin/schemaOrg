...
public class NUMBER_OF_BEDS implements Container.NumberOfBeds {
	...
	public NUMBER_OF_BEDS(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public NUMBER_OF_BEDS(Float fl0at) {
	...
	public NUMBER_OF_BEDS(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public NUMBER_OF_BEDS(Integer integer) {
	...
	public NUMBER_OF_BEDS(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public NUMBER_OF_BEDS(Number number) {
	...
	public NUMBER_OF_BEDS(List<Float> fl0atList,
	...
	public void copy(Container.NumberOfBeds org) {
