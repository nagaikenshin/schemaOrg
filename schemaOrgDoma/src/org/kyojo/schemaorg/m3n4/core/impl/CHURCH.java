...
public class CHURCH implements Clazz.Church {
	...
	public CHURCH(Long seq) {
		setSeq(seq);
	}

	public CHURCH(String string) {
	...
	public CHURCH(AdditionalProperty additionalProperty) {
	...
	public CHURCH(AdditionalType additionalType) {
	...
	public CHURCH(AggregateRating aggregateRating) {
	...
	public CHURCH(AlternateName alternateName) {
	...
	public CHURCH(AmenityFeature amenityFeature) {
	...
	public CHURCH(BranchCode branchCode) {
	...
	public CHURCH(ContainedInPlace containedInPlace) {
	...
	public CHURCH(ContainsPlace containsPlace) {
	...
	public CHURCH(Description description) {
	...
	public CHURCH(DisambiguatingDescription disambiguatingDescription) {
	...
	public CHURCH(FaxNumber faxNumber) {
	...
	public CHURCH(GeospatiallyContains geospatiallyContains) {
	...
	public CHURCH(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public CHURCH(GeospatiallyCovers geospatiallyCovers) {
	...
	public CHURCH(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public CHURCH(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public CHURCH(GeospatiallyEquals geospatiallyEquals) {
	...
	public CHURCH(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public CHURCH(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public CHURCH(GeospatiallyTouches geospatiallyTouches) {
	...
	public CHURCH(GeospatiallyWithin geospatiallyWithin) {
	...
	public CHURCH(GlobalLocationNumber globalLocationNumber) {
	...
	public CHURCH(Identifier identifier) {
	...
	public CHURCH(IsAccessibleForFree isAccessibleForFree) {
	...
	public CHURCH(MainEntityOfPage mainEntityOfPage) {
	...
	public CHURCH(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public CHURCH(NameFuzzy nameFuzzy) {
	...
	public CHURCH(NameRuby nameRuby) {
	...
	public CHURCH(OpeningHours openingHours) {
	...
	public CHURCH(OpeningHoursSpecification openingHoursSpecification) {
	...
	public CHURCH(PotentialAction potentialAction) {
	...
	public CHURCH(PublicAccess publicAccess) {
	...
	public CHURCH(SmokingAllowed smokingAllowed) {
	...
	public CHURCH(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public CHURCH(SubjectOf subjectOf) {
	...
	public CHURCH(Telephone telephone) {
	...
	public void copy(Clazz.Church org) {
		setSeq(org.getSeq());
