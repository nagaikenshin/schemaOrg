...
public class VOLUME_NUMBER implements Container.VolumeNumber {
	...
	public VOLUME_NUMBER(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public VOLUME_NUMBER(Integer integer) {
	...
	public VOLUME_NUMBER(String string) {
		this(new TEXT(string));
	}

	public VOLUME_NUMBER(Text text) {
	...
	public VOLUME_NUMBER(List<Integer> integerList,
			List<Text> textList) {
		setIntegerList(integerList);
		setTextList(textList);
	}

	public void copy(Container.VolumeNumber org) {
