...
public class LITERARY_EVENT implements Clazz.LiteraryEvent {
	...
	public LITERARY_EVENT() {
	}

	public LITERARY_EVENT(Long seq) {
		setSeq(seq);
	}

	public LITERARY_EVENT(String string) {
	...
	public LITERARY_EVENT(About about) {
		setAbout(about);
	}
	...
	public LITERARY_EVENT(Actor actor) {
		setActor(actor);
	}
	...
	public LITERARY_EVENT(AdditionalType additionalType) {
	...
	public LITERARY_EVENT(AggregateRating aggregateRating) {
	...
	public LITERARY_EVENT(AlternateName alternateName) {
	...
	public LITERARY_EVENT(Attendee attendee) {
	...
	public LITERARY_EVENT(Audience audience) {
	...
	public LITERARY_EVENT(Composer composer) {
	...
	public LITERARY_EVENT(Contributor contributor) {
	...
	public LITERARY_EVENT(Description description) {
	...
	public LITERARY_EVENT(Director director) {
	...
	public LITERARY_EVENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public LITERARY_EVENT(DoorTime doorTime) {
	...
	public LITERARY_EVENT(Duration duration) {
	...
	public LITERARY_EVENT(EndDate endDate) {
		setEndDate(endDate);
	}
	...
	public LITERARY_EVENT(EventStatus eventStatus) {
	...
	public LITERARY_EVENT(Funder funder) {
		setFunder(funder);
	}
	...
	public LITERARY_EVENT(Identifier identifier) {
	...
	public LITERARY_EVENT(Image image) {
		setImage(image);
	}
	...
	public LITERARY_EVENT(InLanguage inLanguage) {
	...
	public LITERARY_EVENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public LITERARY_EVENT(Location location) {
	...
	public LITERARY_EVENT(MainEntityOfPage mainEntityOfPage) {
	...
	public LITERARY_EVENT(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public LITERARY_EVENT(Name name) {
		setName(name);
	}
	...
	public LITERARY_EVENT(NameFuzzy nameFuzzy) {
	...
	public LITERARY_EVENT(NameRuby nameRuby) {
	...
	public LITERARY_EVENT(Offers offers) {
		setOffers(offers);
	}
	...
	public LITERARY_EVENT(Organizer organizer) {
	...
	public LITERARY_EVENT(Performer performer) {
	...
	public LITERARY_EVENT(PotentialAction potentialAction) {
	...
	public LITERARY_EVENT(PreviousStartDate previousStartDate) {
	...
	public LITERARY_EVENT(RecordedIn recordedIn) {
	...
	public LITERARY_EVENT(RemainingAttendeeCapacity remainingAttendeeCapacity) {
	...
	public LITERARY_EVENT(Review review) {
		setReview(review);
	}
	...
	public LITERARY_EVENT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public LITERARY_EVENT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public LITERARY_EVENT(StartDate startDate) {
	...
	public LITERARY_EVENT(SubEvent subEvent) {
	...
	public LITERARY_EVENT(SubjectOf subjectOf) {
	...
	public LITERARY_EVENT(SuperEvent superEvent) {
	...
	public LITERARY_EVENT(Translator translator) {
	...
	public LITERARY_EVENT(TypicalAgeRange typicalAgeRange) {
	...
	public LITERARY_EVENT(WorkFeatured workFeatured) {
	...
	public LITERARY_EVENT(WorkPerformed workPerformed) {
	...
	public void copy(Clazz.LiteraryEvent org) {
		setSeq(org.getSeq());
