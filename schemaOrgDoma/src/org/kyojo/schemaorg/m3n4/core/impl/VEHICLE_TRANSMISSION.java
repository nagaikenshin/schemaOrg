...
public class VEHICLE_TRANSMISSION implements Container.VehicleTransmission {
	...
	public VEHICLE_TRANSMISSION(QualitativeValue qualitativeValue) {
	...
	public VEHICLE_TRANSMISSION(String string) {
		this(new TEXT(string));
	}

	public VEHICLE_TRANSMISSION(Text text) {
	...
	public VEHICLE_TRANSMISSION(URL url) {
	...
	public VEHICLE_TRANSMISSION(List<QualitativeValue> qualitativeValueList,
			List<Text> textList,
			List<URL> urlList) {
	...
	public void copy(Container.VehicleTransmission org) {
