...
public class TATTOO_PARLOR implements Clazz.TattooParlor {
	...
	public TATTOO_PARLOR() {
	}

	public TATTOO_PARLOR(Long seq) {
		setSeq(seq);
	}

	public TATTOO_PARLOR(String string) {
	...
	public TATTOO_PARLOR(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public TATTOO_PARLOR(AdditionalProperty additionalProperty) {
	...
	public TATTOO_PARLOR(AdditionalType additionalType) {
	...
	public TATTOO_PARLOR(Address address) {
		setAddress(address);
	}
	...
	public TATTOO_PARLOR(AggregateRating aggregateRating) {
	...
	public TATTOO_PARLOR(AlternateName alternateName) {
	...
	public TATTOO_PARLOR(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public TATTOO_PARLOR(AmenityFeature amenityFeature) {
	...
	public TATTOO_PARLOR(AreaServed areaServed) {
	...
	public TATTOO_PARLOR(Award award) {
		setAward(award);
	}
	...
	public TATTOO_PARLOR(BranchCode branchCode) {
	...
	public TATTOO_PARLOR(Brand brand) {
		setBrand(brand);
	}
	...
	public TATTOO_PARLOR(ContactPoint contactPoint) {
	...
	public TATTOO_PARLOR(ContainedInPlace containedInPlace) {
	...
	public TATTOO_PARLOR(ContainsPlace containsPlace) {
	...
	public TATTOO_PARLOR(CorrectionsPolicy correctionsPolicy) {
	...
	public TATTOO_PARLOR(CurrenciesAccepted currenciesAccepted) {
	...
	public TATTOO_PARLOR(Department department) {
	...
	public TATTOO_PARLOR(Description description) {
	...
	public TATTOO_PARLOR(DisambiguatingDescription disambiguatingDescription) {
	...
	public TATTOO_PARLOR(DissolutionDate dissolutionDate) {
	...
	public TATTOO_PARLOR(DiversityPolicy diversityPolicy) {
	...
	public TATTOO_PARLOR(DiversityStaffingReport diversityStaffingReport) {
	...
	public TATTOO_PARLOR(Duns duns) {
		setDuns(duns);
	}
	...
	public TATTOO_PARLOR(Email email) {
		setEmail(email);
	}
	...
	public TATTOO_PARLOR(Employee employee) {
	...
	public TATTOO_PARLOR(EthicsPolicy ethicsPolicy) {
	...
	public TATTOO_PARLOR(Event event) {
		setEvent(event);
	}
	...
	public TATTOO_PARLOR(FaxNumber faxNumber) {
	...
	public TATTOO_PARLOR(Founder founder) {
		setFounder(founder);
	}
	...
	public TATTOO_PARLOR(FoundingDate foundingDate) {
	...
	public TATTOO_PARLOR(FoundingLocation foundingLocation) {
	...
	public TATTOO_PARLOR(Funder funder) {
		setFunder(funder);
	}
	...
	public TATTOO_PARLOR(GeospatiallyContains geospatiallyContains) {
	...
	public TATTOO_PARLOR(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public TATTOO_PARLOR(GeospatiallyCovers geospatiallyCovers) {
	...
	public TATTOO_PARLOR(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public TATTOO_PARLOR(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public TATTOO_PARLOR(GeospatiallyEquals geospatiallyEquals) {
	...
	public TATTOO_PARLOR(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public TATTOO_PARLOR(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public TATTOO_PARLOR(GeospatiallyTouches geospatiallyTouches) {
	...
	public TATTOO_PARLOR(GeospatiallyWithin geospatiallyWithin) {
	...
	public TATTOO_PARLOR(GlobalLocationNumber globalLocationNumber) {
	...
	public TATTOO_PARLOR(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public TATTOO_PARLOR(HasOfferCatalog hasOfferCatalog) {
	...
	public TATTOO_PARLOR(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public TATTOO_PARLOR(Identifier identifier) {
	...
	public TATTOO_PARLOR(Image image) {
		setImage(image);
	}
	...
	public TATTOO_PARLOR(IsAccessibleForFree isAccessibleForFree) {
	...
	public TATTOO_PARLOR(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public TATTOO_PARLOR(KnowsAbout knowsAbout) {
	...
	public TATTOO_PARLOR(KnowsLanguage knowsLanguage) {
	...
	public TATTOO_PARLOR(LegalName legalName) {
	...
	public TATTOO_PARLOR(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public TATTOO_PARLOR(Location location) {
	...
	public TATTOO_PARLOR(Logo logo) {
		setLogo(logo);
	}
	...
	public TATTOO_PARLOR(MainEntityOfPage mainEntityOfPage) {
	...
	public TATTOO_PARLOR(MakesOffer makesOffer) {
	...
	public TATTOO_PARLOR(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public TATTOO_PARLOR(Member member) {
		setMember(member);
	}
	...
	public TATTOO_PARLOR(MemberOf memberOf) {
	...
	public TATTOO_PARLOR(Naics naics) {
		setNaics(naics);
	}
	...
	public TATTOO_PARLOR(Name name) {
		setName(name);
	}
	...
	public TATTOO_PARLOR(NameFuzzy nameFuzzy) {
	...
	public TATTOO_PARLOR(NameRuby nameRuby) {
	...
	public TATTOO_PARLOR(NumberOfEmployees numberOfEmployees) {
	...
	public TATTOO_PARLOR(OpeningHours openingHours) {
	...
	public TATTOO_PARLOR(OpeningHoursSpecification openingHoursSpecification) {
	...
	public TATTOO_PARLOR(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public TATTOO_PARLOR(Owns owns) {
		setOwns(owns);
	}
	...
	public TATTOO_PARLOR(ParentOrganization parentOrganization) {
	...
	public TATTOO_PARLOR(PaymentAccepted paymentAccepted) {
	...
	public TATTOO_PARLOR(Photo photo) {
		setPhoto(photo);
	}
	...
	public TATTOO_PARLOR(PotentialAction potentialAction) {
	...
	public TATTOO_PARLOR(PriceRange priceRange) {
	...
	public TATTOO_PARLOR(PublicAccess publicAccess) {
	...
	public TATTOO_PARLOR(PublishingPrinciples publishingPrinciples) {
	...
	public TATTOO_PARLOR(Review review) {
		setReview(review);
	}
	...
	public TATTOO_PARLOR(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TATTOO_PARLOR(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public TATTOO_PARLOR(SmokingAllowed smokingAllowed) {
	...
	public TATTOO_PARLOR(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public TATTOO_PARLOR(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public TATTOO_PARLOR(SubOrganization subOrganization) {
	...
	public TATTOO_PARLOR(SubjectOf subjectOf) {
	...
	public TATTOO_PARLOR(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public TATTOO_PARLOR(Telephone telephone) {
	...
	public TATTOO_PARLOR(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public TATTOO_PARLOR(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.TattooParlor org) {
		setSeq(org.getSeq());
