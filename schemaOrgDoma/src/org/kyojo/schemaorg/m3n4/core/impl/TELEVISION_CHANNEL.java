...
public class TELEVISION_CHANNEL implements Clazz.TelevisionChannel {
	...
	public TELEVISION_CHANNEL() {
	}

	public TELEVISION_CHANNEL(Long seq) {
		setSeq(seq);
	}

	public TELEVISION_CHANNEL(String string) {
	...
	public TELEVISION_CHANNEL(AdditionalType additionalType) {
	...
	public TELEVISION_CHANNEL(AlternateName alternateName) {
	...
	public TELEVISION_CHANNEL(BroadcastChannelId broadcastChannelId) {
	...
	public TELEVISION_CHANNEL(BroadcastFrequency broadcastFrequency) {
	...
	public TELEVISION_CHANNEL(BroadcastServiceTier broadcastServiceTier) {
	...
	public TELEVISION_CHANNEL(Description description) {
	...
	public TELEVISION_CHANNEL(DisambiguatingDescription disambiguatingDescription) {
	...
	public TELEVISION_CHANNEL(Genre genre) {
		setGenre(genre);
	}
	...
	public TELEVISION_CHANNEL(Identifier identifier) {
	...
	public TELEVISION_CHANNEL(Image image) {
		setImage(image);
	}
	...
	public TELEVISION_CHANNEL(InBroadcastLineup inBroadcastLineup) {
	...
	public TELEVISION_CHANNEL(MainEntityOfPage mainEntityOfPage) {
	...
	public TELEVISION_CHANNEL(Name name) {
		setName(name);
	}
	...
	public TELEVISION_CHANNEL(NameFuzzy nameFuzzy) {
	...
	public TELEVISION_CHANNEL(NameRuby nameRuby) {
	...
	public TELEVISION_CHANNEL(PotentialAction potentialAction) {
	...
	public TELEVISION_CHANNEL(ProvidesBroadcastService providesBroadcastService) {
	...
	public TELEVISION_CHANNEL(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TELEVISION_CHANNEL(SubjectOf subjectOf) {
	...
	public TELEVISION_CHANNEL(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.TelevisionChannel org) {
		setSeq(org.getSeq());
