...
public class TELEVISION_STATION implements Clazz.TelevisionStation {
	...
	public TELEVISION_STATION() {
	}

	public TELEVISION_STATION(Long seq) {
		setSeq(seq);
	}

	public TELEVISION_STATION(String string) {
	...
	public TELEVISION_STATION(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public TELEVISION_STATION(AdditionalProperty additionalProperty) {
	...
	public TELEVISION_STATION(AdditionalType additionalType) {
	...
	public TELEVISION_STATION(Address address) {
		setAddress(address);
	}
	...
	public TELEVISION_STATION(AggregateRating aggregateRating) {
	...
	public TELEVISION_STATION(AlternateName alternateName) {
	...
	public TELEVISION_STATION(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public TELEVISION_STATION(AmenityFeature amenityFeature) {
	...
	public TELEVISION_STATION(AreaServed areaServed) {
	...
	public TELEVISION_STATION(Award award) {
		setAward(award);
	}
	...
	public TELEVISION_STATION(BranchCode branchCode) {
	...
	public TELEVISION_STATION(Brand brand) {
		setBrand(brand);
	}
	...
	public TELEVISION_STATION(ContactPoint contactPoint) {
	...
	public TELEVISION_STATION(ContainedInPlace containedInPlace) {
	...
	public TELEVISION_STATION(ContainsPlace containsPlace) {
	...
	public TELEVISION_STATION(CorrectionsPolicy correctionsPolicy) {
	...
	public TELEVISION_STATION(CurrenciesAccepted currenciesAccepted) {
	...
	public TELEVISION_STATION(Department department) {
	...
	public TELEVISION_STATION(Description description) {
	...
	public TELEVISION_STATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public TELEVISION_STATION(DissolutionDate dissolutionDate) {
	...
	public TELEVISION_STATION(DiversityPolicy diversityPolicy) {
	...
	public TELEVISION_STATION(DiversityStaffingReport diversityStaffingReport) {
	...
	public TELEVISION_STATION(Duns duns) {
		setDuns(duns);
	}
	...
	public TELEVISION_STATION(Email email) {
		setEmail(email);
	}
	...
	public TELEVISION_STATION(Employee employee) {
	...
	public TELEVISION_STATION(EthicsPolicy ethicsPolicy) {
	...
	public TELEVISION_STATION(Event event) {
		setEvent(event);
	}
	...
	public TELEVISION_STATION(FaxNumber faxNumber) {
	...
	public TELEVISION_STATION(Founder founder) {
		setFounder(founder);
	}
	...
	public TELEVISION_STATION(FoundingDate foundingDate) {
	...
	public TELEVISION_STATION(FoundingLocation foundingLocation) {
	...
	public TELEVISION_STATION(Funder funder) {
		setFunder(funder);
	}
	...
	public TELEVISION_STATION(Geo geo) {
		setGeo(geo);
	}
	...
	public TELEVISION_STATION(GeospatiallyContains geospatiallyContains) {
	...
	public TELEVISION_STATION(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public TELEVISION_STATION(GeospatiallyCovers geospatiallyCovers) {
	...
	public TELEVISION_STATION(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public TELEVISION_STATION(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public TELEVISION_STATION(GeospatiallyEquals geospatiallyEquals) {
	...
	public TELEVISION_STATION(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public TELEVISION_STATION(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public TELEVISION_STATION(GeospatiallyTouches geospatiallyTouches) {
	...
	public TELEVISION_STATION(GeospatiallyWithin geospatiallyWithin) {
	...
	public TELEVISION_STATION(GlobalLocationNumber globalLocationNumber) {
	...
	public TELEVISION_STATION(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public TELEVISION_STATION(HasOfferCatalog hasOfferCatalog) {
	...
	public TELEVISION_STATION(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public TELEVISION_STATION(Identifier identifier) {
	...
	public TELEVISION_STATION(Image image) {
		setImage(image);
	}
	...
	public TELEVISION_STATION(IsAccessibleForFree isAccessibleForFree) {
	...
	public TELEVISION_STATION(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public TELEVISION_STATION(KnowsAbout knowsAbout) {
	...
	public TELEVISION_STATION(KnowsLanguage knowsLanguage) {
	...
	public TELEVISION_STATION(LegalName legalName) {
	...
	public TELEVISION_STATION(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public TELEVISION_STATION(Location location) {
	...
	public TELEVISION_STATION(Logo logo) {
		setLogo(logo);
	}
	...
	public TELEVISION_STATION(MainEntityOfPage mainEntityOfPage) {
	...
	public TELEVISION_STATION(MakesOffer makesOffer) {
	...
	public TELEVISION_STATION(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public TELEVISION_STATION(Member member) {
		setMember(member);
	}
	...
	public TELEVISION_STATION(MemberOf memberOf) {
	...
	public TELEVISION_STATION(Naics naics) {
		setNaics(naics);
	}
	...
	public TELEVISION_STATION(Name name) {
		setName(name);
	}
	...
	public TELEVISION_STATION(NameFuzzy nameFuzzy) {
	...
	public TELEVISION_STATION(NameRuby nameRuby) {
	...
	public TELEVISION_STATION(NumberOfEmployees numberOfEmployees) {
	...
	public TELEVISION_STATION(OpeningHours openingHours) {
	...
	public TELEVISION_STATION(OpeningHoursSpecification openingHoursSpecification) {
	...
	public TELEVISION_STATION(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public TELEVISION_STATION(Owns owns) {
		setOwns(owns);
	}
	...
	public TELEVISION_STATION(ParentOrganization parentOrganization) {
	...
	public TELEVISION_STATION(PaymentAccepted paymentAccepted) {
	...
	public TELEVISION_STATION(Photo photo) {
		setPhoto(photo);
	}
	...
	public TELEVISION_STATION(PotentialAction potentialAction) {
	...
	public TELEVISION_STATION(PriceRange priceRange) {
	...
	public TELEVISION_STATION(PublicAccess publicAccess) {
	...
	public TELEVISION_STATION(PublishingPrinciples publishingPrinciples) {
	...
	public TELEVISION_STATION(Review review) {
		setReview(review);
	}
	...
	public TELEVISION_STATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TELEVISION_STATION(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public TELEVISION_STATION(SmokingAllowed smokingAllowed) {
	...
	public TELEVISION_STATION(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public TELEVISION_STATION(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public TELEVISION_STATION(SubOrganization subOrganization) {
	...
	public TELEVISION_STATION(SubjectOf subjectOf) {
	...
	public TELEVISION_STATION(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public TELEVISION_STATION(Telephone telephone) {
	...
	public TELEVISION_STATION(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public TELEVISION_STATION(Url url) {
		setUrl(url);
	}
	...
	public TELEVISION_STATION(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.TelevisionStation org) {
		setSeq(org.getSeq());
