...
public class POST_OFFICE implements Clazz.PostOffice {
	...
	public POST_OFFICE(Long seq) {
		setSeq(seq);
	}

	public POST_OFFICE(String string) {
	...
	public POST_OFFICE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public POST_OFFICE(AdditionalProperty additionalProperty) {
	...
	public POST_OFFICE(AdditionalType additionalType) {
	...
	public POST_OFFICE(Address address) {
		setAddress(address);
	}
	...
	public POST_OFFICE(AggregateRating aggregateRating) {
	...
	public POST_OFFICE(AlternateName alternateName) {
	...
	public POST_OFFICE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public POST_OFFICE(AmenityFeature amenityFeature) {
	...
	public POST_OFFICE(AreaServed areaServed) {
	...
	public POST_OFFICE(Award award) {
		setAward(award);
	}
	...
	public POST_OFFICE(BranchCode branchCode) {
	...
	public POST_OFFICE(Brand brand) {
		setBrand(brand);
	}
	...
	public POST_OFFICE(ContactPoint contactPoint) {
	...
	public POST_OFFICE(ContainedInPlace containedInPlace) {
	...
	public POST_OFFICE(ContainsPlace containsPlace) {
	...
	public POST_OFFICE(CorrectionsPolicy correctionsPolicy) {
	...
	public POST_OFFICE(CurrenciesAccepted currenciesAccepted) {
	...
	public POST_OFFICE(Department department) {
	...
	public POST_OFFICE(Description description) {
	...
	public POST_OFFICE(DisambiguatingDescription disambiguatingDescription) {
	...
	public POST_OFFICE(DissolutionDate dissolutionDate) {
	...
	public POST_OFFICE(DiversityPolicy diversityPolicy) {
	...
	public POST_OFFICE(DiversityStaffingReport diversityStaffingReport) {
	...
	public POST_OFFICE(Email email) {
		setEmail(email);
	}
	...
	public POST_OFFICE(Employee employee) {
	...
	public POST_OFFICE(EthicsPolicy ethicsPolicy) {
	...
	public POST_OFFICE(Event event) {
		setEvent(event);
	}
	...
	public POST_OFFICE(FaxNumber faxNumber) {
	...
	public POST_OFFICE(Founder founder) {
		setFounder(founder);
	}
	...
	public POST_OFFICE(FoundingDate foundingDate) {
	...
	public POST_OFFICE(FoundingLocation foundingLocation) {
	...
	public POST_OFFICE(Funder funder) {
		setFunder(funder);
	}
	...
	public POST_OFFICE(GeospatiallyContains geospatiallyContains) {
	...
	public POST_OFFICE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public POST_OFFICE(GeospatiallyCovers geospatiallyCovers) {
	...
	public POST_OFFICE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public POST_OFFICE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public POST_OFFICE(GeospatiallyEquals geospatiallyEquals) {
	...
	public POST_OFFICE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public POST_OFFICE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public POST_OFFICE(GeospatiallyTouches geospatiallyTouches) {
	...
	public POST_OFFICE(GeospatiallyWithin geospatiallyWithin) {
	...
	public POST_OFFICE(GlobalLocationNumber globalLocationNumber) {
	...
	public POST_OFFICE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public POST_OFFICE(HasOfferCatalog hasOfferCatalog) {
	...
	public POST_OFFICE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public POST_OFFICE(Identifier identifier) {
	...
	public POST_OFFICE(Image image) {
		setImage(image);
	}
	...
	public POST_OFFICE(IsAccessibleForFree isAccessibleForFree) {
	...
	public POST_OFFICE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public POST_OFFICE(KnowsAbout knowsAbout) {
	...
	public POST_OFFICE(KnowsLanguage knowsLanguage) {
	...
	public POST_OFFICE(LegalName legalName) {
	...
	public POST_OFFICE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public POST_OFFICE(Location location) {
	...
	public POST_OFFICE(MainEntityOfPage mainEntityOfPage) {
	...
	public POST_OFFICE(MakesOffer makesOffer) {
	...
	public POST_OFFICE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public POST_OFFICE(Member member) {
		setMember(member);
	}
	...
	public POST_OFFICE(MemberOf memberOf) {
	...
	public POST_OFFICE(Naics naics) {
		setNaics(naics);
	}
	...
	public POST_OFFICE(NameFuzzy nameFuzzy) {
	...
	public POST_OFFICE(NameRuby nameRuby) {
	...
	public POST_OFFICE(NumberOfEmployees numberOfEmployees) {
	...
	public POST_OFFICE(OpeningHours openingHours) {
	...
	public POST_OFFICE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public POST_OFFICE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public POST_OFFICE(ParentOrganization parentOrganization) {
	...
	public POST_OFFICE(PaymentAccepted paymentAccepted) {
	...
	public POST_OFFICE(Photo photo) {
		setPhoto(photo);
	}
	...
	public POST_OFFICE(PotentialAction potentialAction) {
	...
	public POST_OFFICE(PriceRange priceRange) {
	...
	public POST_OFFICE(PublicAccess publicAccess) {
	...
	public POST_OFFICE(PublishingPrinciples publishingPrinciples) {
	...
	public POST_OFFICE(Review review) {
		setReview(review);
	}
	...
	public POST_OFFICE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public POST_OFFICE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public POST_OFFICE(SmokingAllowed smokingAllowed) {
	...
	public POST_OFFICE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public POST_OFFICE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public POST_OFFICE(SubOrganization subOrganization) {
	...
	public POST_OFFICE(SubjectOf subjectOf) {
	...
	public POST_OFFICE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public POST_OFFICE(Telephone telephone) {
	...
	public POST_OFFICE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public POST_OFFICE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.PostOffice org) {
		setSeq(org.getSeq());
