...
public class LISTEN_ACTION implements Clazz.ListenAction {
	...
	public LISTEN_ACTION() {
	}

	public LISTEN_ACTION(Long seq) {
		setSeq(seq);
	}

	public LISTEN_ACTION(String string) {
	...
	public LISTEN_ACTION(ActionAccessibilityRequirement actionAccessibilityRequirement) {
	...
	public LISTEN_ACTION(ActionStatus actionStatus) {
	...
	public LISTEN_ACTION(AdditionalType additionalType) {
	...
	public LISTEN_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public LISTEN_ACTION(AlternateName alternateName) {
	...
	public LISTEN_ACTION(Description description) {
	...
	public LISTEN_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public LISTEN_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public LISTEN_ACTION(Error error) {
		setError(error);
	}
	...
	public LISTEN_ACTION(ExpectsAcceptanceOf expectsAcceptanceOf) {
	...
	public LISTEN_ACTION(Identifier identifier) {
	...
	public LISTEN_ACTION(Image image) {
		setImage(image);
	}
	...
	public LISTEN_ACTION(Instrument instrument) {
	...
	public LISTEN_ACTION(Location location) {
	...
	public LISTEN_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public LISTEN_ACTION(Name name) {
		setName(name);
	}
	...
	public LISTEN_ACTION(NameFuzzy nameFuzzy) {
	...
	public LISTEN_ACTION(NameRuby nameRuby) {
	...
	public LISTEN_ACTION(Object object) {
		setObject(object);
	}
	...
	public LISTEN_ACTION(Participant participant) {
	...
	public LISTEN_ACTION(PotentialAction potentialAction) {
	...
	public LISTEN_ACTION(Result result) {
		setResult(result);
	}
	...
	public LISTEN_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public LISTEN_ACTION(StartTime startTime) {
	...
	public LISTEN_ACTION(SubjectOf subjectOf) {
	...
	public LISTEN_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.ListenAction org) {
		setSeq(org.getSeq());
