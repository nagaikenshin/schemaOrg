...
public class APPLIES_TO_DELIVERY_METHOD implements Container.AppliesToDeliveryMethod {
	...
	public APPLIES_TO_DELIVERY_METHOD(String string) {
	...
	public APPLIES_TO_DELIVERY_METHOD(DeliveryMethod deliveryMethod) {
		deliveryMethodList = new ArrayList<DeliveryMethod>();
	...
	public APPLIES_TO_DELIVERY_METHOD(LockerDelivery lockerDelivery) {
	...
	public APPLIES_TO_DELIVERY_METHOD(ParcelService parcelService) {
	...
	public APPLIES_TO_DELIVERY_METHOD(List<DeliveryMethod> deliveryMethodList,
	...
	public void copy(Container.AppliesToDeliveryMethod org) {
