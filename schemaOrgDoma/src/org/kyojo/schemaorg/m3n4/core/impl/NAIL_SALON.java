...
public class NAIL_SALON implements Clazz.NailSalon {
	...
	public NAIL_SALON(Long seq) {
		setSeq(seq);
	}

	public NAIL_SALON(String string) {
	...
	public NAIL_SALON(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public NAIL_SALON(AdditionalProperty additionalProperty) {
	...
	public NAIL_SALON(AdditionalType additionalType) {
	...
	public NAIL_SALON(Address address) {
		setAddress(address);
	}
	...
	public NAIL_SALON(AggregateRating aggregateRating) {
	...
	public NAIL_SALON(AlternateName alternateName) {
	...
	public NAIL_SALON(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public NAIL_SALON(AmenityFeature amenityFeature) {
	...
	public NAIL_SALON(AreaServed areaServed) {
	...
	public NAIL_SALON(BranchCode branchCode) {
	...
	public NAIL_SALON(ContactPoint contactPoint) {
	...
	public NAIL_SALON(ContainedInPlace containedInPlace) {
	...
	public NAIL_SALON(ContainsPlace containsPlace) {
	...
	public NAIL_SALON(CorrectionsPolicy correctionsPolicy) {
	...
	public NAIL_SALON(CurrenciesAccepted currenciesAccepted) {
	...
	public NAIL_SALON(Department department) {
	...
	public NAIL_SALON(Description description) {
	...
	public NAIL_SALON(DisambiguatingDescription disambiguatingDescription) {
	...
	public NAIL_SALON(DissolutionDate dissolutionDate) {
	...
	public NAIL_SALON(DiversityPolicy diversityPolicy) {
	...
	public NAIL_SALON(DiversityStaffingReport diversityStaffingReport) {
	...
	public NAIL_SALON(Employee employee) {
	...
	public NAIL_SALON(EthicsPolicy ethicsPolicy) {
	...
	public NAIL_SALON(FaxNumber faxNumber) {
	...
	public NAIL_SALON(Founder founder) {
		setFounder(founder);
	}
	...
	public NAIL_SALON(FoundingDate foundingDate) {
	...
	public NAIL_SALON(FoundingLocation foundingLocation) {
	...
	public NAIL_SALON(Funder funder) {
		setFunder(funder);
	}
	...
	public NAIL_SALON(GeospatiallyContains geospatiallyContains) {
	...
	public NAIL_SALON(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public NAIL_SALON(GeospatiallyCovers geospatiallyCovers) {
	...
	public NAIL_SALON(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public NAIL_SALON(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public NAIL_SALON(GeospatiallyEquals geospatiallyEquals) {
	...
	public NAIL_SALON(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public NAIL_SALON(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public NAIL_SALON(GeospatiallyTouches geospatiallyTouches) {
	...
	public NAIL_SALON(GeospatiallyWithin geospatiallyWithin) {
	...
	public NAIL_SALON(GlobalLocationNumber globalLocationNumber) {
	...
	public NAIL_SALON(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public NAIL_SALON(HasOfferCatalog hasOfferCatalog) {
	...
	public NAIL_SALON(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public NAIL_SALON(Identifier identifier) {
	...
	public NAIL_SALON(IsAccessibleForFree isAccessibleForFree) {
	...
	public NAIL_SALON(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public NAIL_SALON(KnowsAbout knowsAbout) {
	...
	public NAIL_SALON(KnowsLanguage knowsLanguage) {
	...
	public NAIL_SALON(LegalName legalName) {
	...
	public NAIL_SALON(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public NAIL_SALON(Location location) {
	...
	public NAIL_SALON(MainEntityOfPage mainEntityOfPage) {
	...
	public NAIL_SALON(MakesOffer makesOffer) {
	...
	public NAIL_SALON(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public NAIL_SALON(Member member) {
		setMember(member);
	}
	...
	public NAIL_SALON(MemberOf memberOf) {
	...
	public NAIL_SALON(NameFuzzy nameFuzzy) {
	...
	public NAIL_SALON(NameRuby nameRuby) {
	...
	public NAIL_SALON(NumberOfEmployees numberOfEmployees) {
	...
	public NAIL_SALON(OpeningHours openingHours) {
	...
	public NAIL_SALON(OpeningHoursSpecification openingHoursSpecification) {
	...
	public NAIL_SALON(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public NAIL_SALON(ParentOrganization parentOrganization) {
	...
	public NAIL_SALON(PaymentAccepted paymentAccepted) {
	...
	public NAIL_SALON(PotentialAction potentialAction) {
	...
	public NAIL_SALON(PriceRange priceRange) {
	...
	public NAIL_SALON(PublicAccess publicAccess) {
	...
	public NAIL_SALON(PublishingPrinciples publishingPrinciples) {
	...
	public NAIL_SALON(Review review) {
		setReview(review);
	}
	...
	public NAIL_SALON(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public NAIL_SALON(SmokingAllowed smokingAllowed) {
	...
	public NAIL_SALON(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public NAIL_SALON(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public NAIL_SALON(SubOrganization subOrganization) {
	...
	public NAIL_SALON(SubjectOf subjectOf) {
	...
	public NAIL_SALON(Telephone telephone) {
	...
	public NAIL_SALON(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.NailSalon org) {
		setSeq(org.getSeq());
