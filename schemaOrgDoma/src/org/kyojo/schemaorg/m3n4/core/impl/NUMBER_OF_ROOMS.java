...
public class NUMBER_OF_ROOMS implements Container.NumberOfRooms {
	...
	public NUMBER_OF_ROOMS(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public NUMBER_OF_ROOMS(Float fl0at) {
	...
	public NUMBER_OF_ROOMS(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public NUMBER_OF_ROOMS(Integer integer) {
	...
	public NUMBER_OF_ROOMS(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public NUMBER_OF_ROOMS(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public NUMBER_OF_ROOMS(Number number) {
	...
	public NUMBER_OF_ROOMS(QuantitativeValue quantitativeValue) {
	...
	public NUMBER_OF_ROOMS(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public NUMBER_OF_ROOMS(List<Float> fl0atList,
	...
	public void copy(Container.NumberOfRooms org) {
