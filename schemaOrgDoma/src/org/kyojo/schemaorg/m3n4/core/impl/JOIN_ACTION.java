...
public class JOIN_ACTION implements Clazz.JoinAction {
	...
	public JOIN_ACTION(Long seq) {
		setSeq(seq);
	}

	public JOIN_ACTION(String string) {
	...
	public JOIN_ACTION(ActionStatus actionStatus) {
	...
	public JOIN_ACTION(AdditionalType additionalType) {
	...
	public JOIN_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public JOIN_ACTION(AlternateName alternateName) {
	...
	public JOIN_ACTION(Description description) {
	...
	public JOIN_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public JOIN_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public JOIN_ACTION(Error error) {
		setError(error);
	}
	...
	public JOIN_ACTION(Event event) {
		setEvent(event);
	}
	...
	public JOIN_ACTION(Identifier identifier) {
	...
	public JOIN_ACTION(Image image) {
		setImage(image);
	}
	...
	public JOIN_ACTION(Instrument instrument) {
	...
	public JOIN_ACTION(Location location) {
	...
	public JOIN_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public JOIN_ACTION(NameFuzzy nameFuzzy) {
	...
	public JOIN_ACTION(NameRuby nameRuby) {
	...
	public JOIN_ACTION(Object object) {
		setObject(object);
	}
	...
	public JOIN_ACTION(Participant participant) {
	...
	public JOIN_ACTION(PotentialAction potentialAction) {
	...
	public JOIN_ACTION(Result result) {
		setResult(result);
	}
	...
	public JOIN_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public JOIN_ACTION(StartTime startTime) {
	...
	public JOIN_ACTION(SubjectOf subjectOf) {
	...
	public JOIN_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.JoinAction org) {
		setSeq(org.getSeq());
