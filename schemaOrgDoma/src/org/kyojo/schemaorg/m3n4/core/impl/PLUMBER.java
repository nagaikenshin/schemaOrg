...
public class PLUMBER implements Clazz.Plumber {
	...
	public PLUMBER(Long seq) {
		setSeq(seq);
	}

	public PLUMBER(String string) {
	...
	public PLUMBER(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public PLUMBER(AdditionalProperty additionalProperty) {
	...
	public PLUMBER(AdditionalType additionalType) {
	...
	public PLUMBER(Address address) {
		setAddress(address);
	}
	...
	public PLUMBER(AggregateRating aggregateRating) {
	...
	public PLUMBER(AlternateName alternateName) {
	...
	public PLUMBER(AmenityFeature amenityFeature) {
	...
	public PLUMBER(AreaServed areaServed) {
	...
	public PLUMBER(BranchCode branchCode) {
	...
	public PLUMBER(ContactPoint contactPoint) {
	...
	public PLUMBER(ContainedInPlace containedInPlace) {
	...
	public PLUMBER(ContainsPlace containsPlace) {
	...
	public PLUMBER(CorrectionsPolicy correctionsPolicy) {
	...
	public PLUMBER(CurrenciesAccepted currenciesAccepted) {
	...
	public PLUMBER(Department department) {
	...
	public PLUMBER(Description description) {
	...
	public PLUMBER(DisambiguatingDescription disambiguatingDescription) {
	...
	public PLUMBER(DissolutionDate dissolutionDate) {
	...
	public PLUMBER(DiversityPolicy diversityPolicy) {
	...
	public PLUMBER(DiversityStaffingReport diversityStaffingReport) {
	...
	public PLUMBER(Employee employee) {
	...
	public PLUMBER(EthicsPolicy ethicsPolicy) {
	...
	public PLUMBER(FaxNumber faxNumber) {
	...
	public PLUMBER(Founder founder) {
		setFounder(founder);
	}
	...
	public PLUMBER(FoundingDate foundingDate) {
	...
	public PLUMBER(FoundingLocation foundingLocation) {
	...
	public PLUMBER(GeospatiallyContains geospatiallyContains) {
	...
	public PLUMBER(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public PLUMBER(GeospatiallyCovers geospatiallyCovers) {
	...
	public PLUMBER(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public PLUMBER(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public PLUMBER(GeospatiallyEquals geospatiallyEquals) {
	...
	public PLUMBER(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public PLUMBER(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public PLUMBER(GeospatiallyTouches geospatiallyTouches) {
	...
	public PLUMBER(GeospatiallyWithin geospatiallyWithin) {
	...
	public PLUMBER(GlobalLocationNumber globalLocationNumber) {
	...
	public PLUMBER(HasOfferCatalog hasOfferCatalog) {
	...
	public PLUMBER(Identifier identifier) {
	...
	public PLUMBER(IsAccessibleForFree isAccessibleForFree) {
	...
	public PLUMBER(KnowsAbout knowsAbout) {
	...
	public PLUMBER(KnowsLanguage knowsLanguage) {
	...
	public PLUMBER(LegalName legalName) {
	...
	public PLUMBER(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public PLUMBER(Location location) {
	...
	public PLUMBER(MainEntityOfPage mainEntityOfPage) {
	...
	public PLUMBER(MakesOffer makesOffer) {
	...
	public PLUMBER(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public PLUMBER(MemberOf memberOf) {
	...
	public PLUMBER(NameFuzzy nameFuzzy) {
	...
	public PLUMBER(NameRuby nameRuby) {
	...
	public PLUMBER(NumberOfEmployees numberOfEmployees) {
	...
	public PLUMBER(OpeningHours openingHours) {
	...
	public PLUMBER(OpeningHoursSpecification openingHoursSpecification) {
	...
	public PLUMBER(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public PLUMBER(ParentOrganization parentOrganization) {
	...
	public PLUMBER(PaymentAccepted paymentAccepted) {
	...
	public PLUMBER(PotentialAction potentialAction) {
	...
	public PLUMBER(PriceRange priceRange) {
	...
	public PLUMBER(PublicAccess publicAccess) {
	...
	public PLUMBER(PublishingPrinciples publishingPrinciples) {
	...
	public PLUMBER(SmokingAllowed smokingAllowed) {
	...
	public PLUMBER(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public PLUMBER(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public PLUMBER(SubOrganization subOrganization) {
	...
	public PLUMBER(SubjectOf subjectOf) {
	...
	public PLUMBER(Telephone telephone) {
	...
	public PLUMBER(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Plumber org) {
		setSeq(org.getSeq());
