...
public class BED_AND_BREAKFAST implements Clazz.BedAndBreakfast {
	...
	public BED_AND_BREAKFAST() {
	}

	public BED_AND_BREAKFAST(Long seq) {
		setSeq(seq);
	}

	public BED_AND_BREAKFAST(String string) {
	...
	public BED_AND_BREAKFAST(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public BED_AND_BREAKFAST(AdditionalProperty additionalProperty) {
	...
	public BED_AND_BREAKFAST(AdditionalType additionalType) {
	...
	public BED_AND_BREAKFAST(Address address) {
		setAddress(address);
	}
	...
	public BED_AND_BREAKFAST(AggregateRating aggregateRating) {
	...
	public BED_AND_BREAKFAST(AlternateName alternateName) {
	...
	public BED_AND_BREAKFAST(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public BED_AND_BREAKFAST(AmenityFeature amenityFeature) {
	...
	public BED_AND_BREAKFAST(AreaServed areaServed) {
	...
	public BED_AND_BREAKFAST(Audience audience) {
	...
	public BED_AND_BREAKFAST(AvailableLanguage availableLanguage) {
	...
	public BED_AND_BREAKFAST(Award award) {
		setAward(award);
	}
	...
	public BED_AND_BREAKFAST(BranchCode branchCode) {
	...
	public BED_AND_BREAKFAST(Brand brand) {
		setBrand(brand);
	}
	...
	public BED_AND_BREAKFAST(CheckinTime checkinTime) {
	...
	public BED_AND_BREAKFAST(CheckoutTime checkoutTime) {
	...
	public BED_AND_BREAKFAST(ContactPoint contactPoint) {
	...
	public BED_AND_BREAKFAST(ContainedInPlace containedInPlace) {
	...
	public BED_AND_BREAKFAST(ContainsPlace containsPlace) {
	...
	public BED_AND_BREAKFAST(CorrectionsPolicy correctionsPolicy) {
	...
	public BED_AND_BREAKFAST(CurrenciesAccepted currenciesAccepted) {
	...
	public BED_AND_BREAKFAST(Department department) {
	...
	public BED_AND_BREAKFAST(Description description) {
	...
	public BED_AND_BREAKFAST(DisambiguatingDescription disambiguatingDescription) {
	...
	public BED_AND_BREAKFAST(DissolutionDate dissolutionDate) {
	...
	public BED_AND_BREAKFAST(DiversityPolicy diversityPolicy) {
	...
	public BED_AND_BREAKFAST(DiversityStaffingReport diversityStaffingReport) {
	...
	public BED_AND_BREAKFAST(Duns duns) {
		setDuns(duns);
	}
	...
	public BED_AND_BREAKFAST(Email email) {
		setEmail(email);
	}
	...
	public BED_AND_BREAKFAST(Employee employee) {
	...
	public BED_AND_BREAKFAST(EthicsPolicy ethicsPolicy) {
	...
	public BED_AND_BREAKFAST(Event event) {
		setEvent(event);
	}
	...
	public BED_AND_BREAKFAST(FaxNumber faxNumber) {
	...
	public BED_AND_BREAKFAST(Founder founder) {
		setFounder(founder);
	}
	...
	public BED_AND_BREAKFAST(FoundingDate foundingDate) {
	...
	public BED_AND_BREAKFAST(FoundingLocation foundingLocation) {
	...
	public BED_AND_BREAKFAST(Funder funder) {
		setFunder(funder);
	}
	...
	public BED_AND_BREAKFAST(Geo geo) {
		setGeo(geo);
	}
	...
	public BED_AND_BREAKFAST(GeospatiallyContains geospatiallyContains) {
	...
	public BED_AND_BREAKFAST(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public BED_AND_BREAKFAST(GeospatiallyCovers geospatiallyCovers) {
	...
	public BED_AND_BREAKFAST(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public BED_AND_BREAKFAST(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public BED_AND_BREAKFAST(GeospatiallyEquals geospatiallyEquals) {
	...
	public BED_AND_BREAKFAST(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public BED_AND_BREAKFAST(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public BED_AND_BREAKFAST(GeospatiallyTouches geospatiallyTouches) {
	...
	public BED_AND_BREAKFAST(GeospatiallyWithin geospatiallyWithin) {
	...
	public BED_AND_BREAKFAST(GlobalLocationNumber globalLocationNumber) {
	...
	public BED_AND_BREAKFAST(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public BED_AND_BREAKFAST(HasOfferCatalog hasOfferCatalog) {
	...
	public BED_AND_BREAKFAST(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public BED_AND_BREAKFAST(Identifier identifier) {
	...
	public BED_AND_BREAKFAST(Image image) {
		setImage(image);
	}
	...
	public BED_AND_BREAKFAST(IsAccessibleForFree isAccessibleForFree) {
	...
	public BED_AND_BREAKFAST(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public BED_AND_BREAKFAST(KnowsAbout knowsAbout) {
	...
	public BED_AND_BREAKFAST(KnowsLanguage knowsLanguage) {
	...
	public BED_AND_BREAKFAST(LegalName legalName) {
	...
	public BED_AND_BREAKFAST(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public BED_AND_BREAKFAST(Location location) {
	...
	public BED_AND_BREAKFAST(Logo logo) {
		setLogo(logo);
	}
	...
	public BED_AND_BREAKFAST(MainEntityOfPage mainEntityOfPage) {
	...
	public BED_AND_BREAKFAST(MakesOffer makesOffer) {
	...
	public BED_AND_BREAKFAST(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public BED_AND_BREAKFAST(Member member) {
		setMember(member);
	}
	...
	public BED_AND_BREAKFAST(MemberOf memberOf) {
	...
	public BED_AND_BREAKFAST(Naics naics) {
		setNaics(naics);
	}
	...
	public BED_AND_BREAKFAST(Name name) {
		setName(name);
	}
	...
	public BED_AND_BREAKFAST(NameFuzzy nameFuzzy) {
	...
	public BED_AND_BREAKFAST(NameRuby nameRuby) {
	...
	public BED_AND_BREAKFAST(NumberOfEmployees numberOfEmployees) {
	...
	public BED_AND_BREAKFAST(OpeningHours openingHours) {
	...
	public BED_AND_BREAKFAST(OpeningHoursSpecification openingHoursSpecification) {
	...
	public BED_AND_BREAKFAST(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public BED_AND_BREAKFAST(Owns owns) {
		setOwns(owns);
	}
	...
	public BED_AND_BREAKFAST(ParentOrganization parentOrganization) {
	...
	public BED_AND_BREAKFAST(PaymentAccepted paymentAccepted) {
	...
	public BED_AND_BREAKFAST(PetsAllowed petsAllowed) {
	...
	public BED_AND_BREAKFAST(Photo photo) {
		setPhoto(photo);
	}
	...
	public BED_AND_BREAKFAST(PotentialAction potentialAction) {
	...
	public BED_AND_BREAKFAST(PriceRange priceRange) {
	...
	public BED_AND_BREAKFAST(PublicAccess publicAccess) {
	...
	public BED_AND_BREAKFAST(PublishingPrinciples publishingPrinciples) {
	...
	public BED_AND_BREAKFAST(Review review) {
		setReview(review);
	}
	...
	public BED_AND_BREAKFAST(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public BED_AND_BREAKFAST(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public BED_AND_BREAKFAST(SmokingAllowed smokingAllowed) {
	...
	public BED_AND_BREAKFAST(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public BED_AND_BREAKFAST(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public BED_AND_BREAKFAST(StarRating starRating) {
	...
	public BED_AND_BREAKFAST(SubOrganization subOrganization) {
	...
	public BED_AND_BREAKFAST(SubjectOf subjectOf) {
	...
	public BED_AND_BREAKFAST(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public BED_AND_BREAKFAST(Telephone telephone) {
	...
	public BED_AND_BREAKFAST(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public BED_AND_BREAKFAST(Url url) {
		setUrl(url);
	}
	...
	public BED_AND_BREAKFAST(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.BedAndBreakfast org) {
		setSeq(org.getSeq());
