...
public class BEAUTY_SALON implements Clazz.BeautySalon {
	...
	public BEAUTY_SALON(Long seq) {
		setSeq(seq);
	}

	public BEAUTY_SALON(String string) {
	...
	public BEAUTY_SALON(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public BEAUTY_SALON(AdditionalProperty additionalProperty) {
	...
	public BEAUTY_SALON(AdditionalType additionalType) {
	...
	public BEAUTY_SALON(Address address) {
		setAddress(address);
	}
	...
	public BEAUTY_SALON(AggregateRating aggregateRating) {
	...
	public BEAUTY_SALON(AlternateName alternateName) {
	...
	public BEAUTY_SALON(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public BEAUTY_SALON(AmenityFeature amenityFeature) {
	...
	public BEAUTY_SALON(AreaServed areaServed) {
	...
	public BEAUTY_SALON(Award award) {
		setAward(award);
	}
	...
	public BEAUTY_SALON(BranchCode branchCode) {
	...
	public BEAUTY_SALON(Brand brand) {
		setBrand(brand);
	}
	...
	public BEAUTY_SALON(ContactPoint contactPoint) {
	...
	public BEAUTY_SALON(ContainedInPlace containedInPlace) {
	...
	public BEAUTY_SALON(ContainsPlace containsPlace) {
	...
	public BEAUTY_SALON(CorrectionsPolicy correctionsPolicy) {
	...
	public BEAUTY_SALON(CurrenciesAccepted currenciesAccepted) {
	...
	public BEAUTY_SALON(Department department) {
	...
	public BEAUTY_SALON(Description description) {
	...
	public BEAUTY_SALON(DisambiguatingDescription disambiguatingDescription) {
	...
	public BEAUTY_SALON(DissolutionDate dissolutionDate) {
	...
	public BEAUTY_SALON(DiversityPolicy diversityPolicy) {
	...
	public BEAUTY_SALON(DiversityStaffingReport diversityStaffingReport) {
	...
	public BEAUTY_SALON(Email email) {
		setEmail(email);
	}
	...
	public BEAUTY_SALON(Employee employee) {
	...
	public BEAUTY_SALON(EthicsPolicy ethicsPolicy) {
	...
	public BEAUTY_SALON(Event event) {
		setEvent(event);
	}
	...
	public BEAUTY_SALON(FaxNumber faxNumber) {
	...
	public BEAUTY_SALON(Founder founder) {
		setFounder(founder);
	}
	...
	public BEAUTY_SALON(FoundingDate foundingDate) {
	...
	public BEAUTY_SALON(FoundingLocation foundingLocation) {
	...
	public BEAUTY_SALON(Funder funder) {
		setFunder(funder);
	}
	...
	public BEAUTY_SALON(GeospatiallyContains geospatiallyContains) {
	...
	public BEAUTY_SALON(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public BEAUTY_SALON(GeospatiallyCovers geospatiallyCovers) {
	...
	public BEAUTY_SALON(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public BEAUTY_SALON(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public BEAUTY_SALON(GeospatiallyEquals geospatiallyEquals) {
	...
	public BEAUTY_SALON(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public BEAUTY_SALON(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public BEAUTY_SALON(GeospatiallyTouches geospatiallyTouches) {
	...
	public BEAUTY_SALON(GeospatiallyWithin geospatiallyWithin) {
	...
	public BEAUTY_SALON(GlobalLocationNumber globalLocationNumber) {
	...
	public BEAUTY_SALON(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public BEAUTY_SALON(HasOfferCatalog hasOfferCatalog) {
	...
	public BEAUTY_SALON(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public BEAUTY_SALON(Identifier identifier) {
	...
	public BEAUTY_SALON(Image image) {
		setImage(image);
	}
	...
	public BEAUTY_SALON(IsAccessibleForFree isAccessibleForFree) {
	...
	public BEAUTY_SALON(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public BEAUTY_SALON(KnowsAbout knowsAbout) {
	...
	public BEAUTY_SALON(KnowsLanguage knowsLanguage) {
	...
	public BEAUTY_SALON(LegalName legalName) {
	...
	public BEAUTY_SALON(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public BEAUTY_SALON(Location location) {
	...
	public BEAUTY_SALON(MainEntityOfPage mainEntityOfPage) {
	...
	public BEAUTY_SALON(MakesOffer makesOffer) {
	...
	public BEAUTY_SALON(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public BEAUTY_SALON(Member member) {
		setMember(member);
	}
	...
	public BEAUTY_SALON(MemberOf memberOf) {
	...
	public BEAUTY_SALON(Naics naics) {
		setNaics(naics);
	}
	...
	public BEAUTY_SALON(NameFuzzy nameFuzzy) {
	...
	public BEAUTY_SALON(NameRuby nameRuby) {
	...
	public BEAUTY_SALON(NumberOfEmployees numberOfEmployees) {
	...
	public BEAUTY_SALON(OpeningHours openingHours) {
	...
	public BEAUTY_SALON(OpeningHoursSpecification openingHoursSpecification) {
	...
	public BEAUTY_SALON(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public BEAUTY_SALON(ParentOrganization parentOrganization) {
	...
	public BEAUTY_SALON(PaymentAccepted paymentAccepted) {
	...
	public BEAUTY_SALON(Photo photo) {
		setPhoto(photo);
	}
	...
	public BEAUTY_SALON(PotentialAction potentialAction) {
	...
	public BEAUTY_SALON(PriceRange priceRange) {
	...
	public BEAUTY_SALON(PublicAccess publicAccess) {
	...
	public BEAUTY_SALON(PublishingPrinciples publishingPrinciples) {
	...
	public BEAUTY_SALON(Review review) {
		setReview(review);
	}
	...
	public BEAUTY_SALON(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public BEAUTY_SALON(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public BEAUTY_SALON(SmokingAllowed smokingAllowed) {
	...
	public BEAUTY_SALON(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public BEAUTY_SALON(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public BEAUTY_SALON(SubOrganization subOrganization) {
	...
	public BEAUTY_SALON(SubjectOf subjectOf) {
	...
	public BEAUTY_SALON(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public BEAUTY_SALON(Telephone telephone) {
	...
	public BEAUTY_SALON(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public BEAUTY_SALON(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.BeautySalon org) {
		setSeq(org.getSeq());
