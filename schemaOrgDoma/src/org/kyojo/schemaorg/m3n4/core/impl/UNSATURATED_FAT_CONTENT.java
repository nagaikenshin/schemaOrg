...
public class UNSATURATED_FAT_CONTENT implements Container.UnsaturatedFatContent {
	...
	public UNSATURATED_FAT_CONTENT(String string) {
	...
	public UNSATURATED_FAT_CONTENT(Mass mass) {
		massList = new ArrayList<Mass>();
		massList.add(mass);
	}
