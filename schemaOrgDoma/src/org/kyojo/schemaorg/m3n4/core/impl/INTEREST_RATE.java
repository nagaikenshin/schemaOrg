...
public class INTEREST_RATE implements Container.InterestRate {
	...
	public INTEREST_RATE(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public INTEREST_RATE(Float fl0at) {
	...
	public INTEREST_RATE(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public INTEREST_RATE(Integer integer) {
	...
	public INTEREST_RATE(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public INTEREST_RATE(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public INTEREST_RATE(Number number) {
	...
	public INTEREST_RATE(QuantitativeValue quantitativeValue) {
	...
	public INTEREST_RATE(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public INTEREST_RATE(List<Float> fl0atList,
	...
	public void copy(Container.InterestRate org) {
