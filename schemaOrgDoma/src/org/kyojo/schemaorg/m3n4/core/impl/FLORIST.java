...
public class FLORIST implements Clazz.Florist {
	...
	public FLORIST(Long seq) {
		setSeq(seq);
	}

	public FLORIST(String string) {
	...
	public FLORIST(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public FLORIST(AdditionalProperty additionalProperty) {
	...
	public FLORIST(AdditionalType additionalType) {
	...
	public FLORIST(Address address) {
		setAddress(address);
	}
	...
	public FLORIST(AggregateRating aggregateRating) {
	...
	public FLORIST(AlternateName alternateName) {
	...
	public FLORIST(AmenityFeature amenityFeature) {
	...
	public FLORIST(AreaServed areaServed) {
	...
	public FLORIST(BranchCode branchCode) {
	...
	public FLORIST(ContactPoint contactPoint) {
	...
	public FLORIST(ContainedInPlace containedInPlace) {
	...
	public FLORIST(ContainsPlace containsPlace) {
	...
	public FLORIST(CorrectionsPolicy correctionsPolicy) {
	...
	public FLORIST(CurrenciesAccepted currenciesAccepted) {
	...
	public FLORIST(Department department) {
	...
	public FLORIST(Description description) {
	...
	public FLORIST(DisambiguatingDescription disambiguatingDescription) {
	...
	public FLORIST(DissolutionDate dissolutionDate) {
	...
	public FLORIST(DiversityPolicy diversityPolicy) {
	...
	public FLORIST(DiversityStaffingReport diversityStaffingReport) {
	...
	public FLORIST(Employee employee) {
	...
	public FLORIST(EthicsPolicy ethicsPolicy) {
	...
	public FLORIST(FaxNumber faxNumber) {
	...
	public FLORIST(Founder founder) {
		setFounder(founder);
	}
	...
	public FLORIST(FoundingDate foundingDate) {
	...
	public FLORIST(FoundingLocation foundingLocation) {
	...
	public FLORIST(GeospatiallyContains geospatiallyContains) {
	...
	public FLORIST(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public FLORIST(GeospatiallyCovers geospatiallyCovers) {
	...
	public FLORIST(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public FLORIST(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public FLORIST(GeospatiallyEquals geospatiallyEquals) {
	...
	public FLORIST(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public FLORIST(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public FLORIST(GeospatiallyTouches geospatiallyTouches) {
	...
	public FLORIST(GeospatiallyWithin geospatiallyWithin) {
	...
	public FLORIST(GlobalLocationNumber globalLocationNumber) {
	...
	public FLORIST(HasOfferCatalog hasOfferCatalog) {
	...
	public FLORIST(Identifier identifier) {
	...
	public FLORIST(IsAccessibleForFree isAccessibleForFree) {
	...
	public FLORIST(KnowsAbout knowsAbout) {
	...
	public FLORIST(KnowsLanguage knowsLanguage) {
	...
	public FLORIST(LegalName legalName) {
	...
	public FLORIST(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public FLORIST(Location location) {
	...
	public FLORIST(MainEntityOfPage mainEntityOfPage) {
	...
	public FLORIST(MakesOffer makesOffer) {
	...
	public FLORIST(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public FLORIST(MemberOf memberOf) {
	...
	public FLORIST(NameFuzzy nameFuzzy) {
	...
	public FLORIST(NameRuby nameRuby) {
	...
	public FLORIST(NumberOfEmployees numberOfEmployees) {
	...
	public FLORIST(OpeningHours openingHours) {
	...
	public FLORIST(OpeningHoursSpecification openingHoursSpecification) {
	...
	public FLORIST(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public FLORIST(ParentOrganization parentOrganization) {
	...
	public FLORIST(PaymentAccepted paymentAccepted) {
	...
	public FLORIST(PotentialAction potentialAction) {
	...
	public FLORIST(PriceRange priceRange) {
	...
	public FLORIST(PublicAccess publicAccess) {
	...
	public FLORIST(PublishingPrinciples publishingPrinciples) {
	...
	public FLORIST(SmokingAllowed smokingAllowed) {
	...
	public FLORIST(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public FLORIST(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public FLORIST(SubOrganization subOrganization) {
	...
	public FLORIST(SubjectOf subjectOf) {
	...
	public FLORIST(Telephone telephone) {
	...
	public FLORIST(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Florist org) {
		setSeq(org.getSeq());
