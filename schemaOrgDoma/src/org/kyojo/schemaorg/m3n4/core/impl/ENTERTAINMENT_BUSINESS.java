...
public class ENTERTAINMENT_BUSINESS implements Clazz.EntertainmentBusiness, Container.EntertainmentBusiness {
	...
	public ENTERTAINMENT_BUSINESS(Long seq) {
		setSeq(seq);
	}

	public ENTERTAINMENT_BUSINESS(String string) {
	...
	public ENTERTAINMENT_BUSINESS(Accommodation accommodation) {
	...
	public ENTERTAINMENT_BUSINESS(AccountingService accountingService) {
	...
	public ENTERTAINMENT_BUSINESS(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public ENTERTAINMENT_BUSINESS(AdditionalProperty additionalProperty) {
	...
	public ENTERTAINMENT_BUSINESS(AdditionalType additionalType) {
	...
	public ENTERTAINMENT_BUSINESS(Address address) {
		setAddress(address);
	}
	...
	public ENTERTAINMENT_BUSINESS(AdministrativeArea administrativeArea) {
	...
	public ENTERTAINMENT_BUSINESS(AdultEntertainment adultEntertainment) {
	...
	public ENTERTAINMENT_BUSINESS(AggregateRating aggregateRating) {
	...
	public ENTERTAINMENT_BUSINESS(Airport airport) {
	...
	public ENTERTAINMENT_BUSINESS(AlternateName alternateName) {
	...
	public ENTERTAINMENT_BUSINESS(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public ENTERTAINMENT_BUSINESS(AmenityFeature amenityFeature) {
	...
	public ENTERTAINMENT_BUSINESS(AmusementPark amusementPark) {
	...
	public ENTERTAINMENT_BUSINESS(AnimalShelter animalShelter) {
	...
	public ENTERTAINMENT_BUSINESS(Apartment apartment) {
	...
	public ENTERTAINMENT_BUSINESS(ApartmentComplex apartmentComplex) {
	...
	public ENTERTAINMENT_BUSINESS(Aquarium aquarium) {
	...
	public ENTERTAINMENT_BUSINESS(AreaServed areaServed) {
	...
	public ENTERTAINMENT_BUSINESS(ArtGallery artGallery) {
	...
	public ENTERTAINMENT_BUSINESS(Attorney attorney) {
	...
	public ENTERTAINMENT_BUSINESS(AutoBodyShop autoBodyShop) {
	...
	public ENTERTAINMENT_BUSINESS(AutoDealer autoDealer) {
	...
	public ENTERTAINMENT_BUSINESS(AutoPartsStore autoPartsStore) {
	...
	public ENTERTAINMENT_BUSINESS(AutoRental autoRental) {
	...
	public ENTERTAINMENT_BUSINESS(AutoRepair autoRepair) {
	...
	public ENTERTAINMENT_BUSINESS(AutoWash autoWash) {
	...
	public ENTERTAINMENT_BUSINESS(AutomatedTeller automatedTeller) {
	...
	public ENTERTAINMENT_BUSINESS(AutomotiveBusiness automotiveBusiness) {
	...
	public ENTERTAINMENT_BUSINESS(Award award) {
		setAward(award);
	}
	...
	public ENTERTAINMENT_BUSINESS(Bakery bakery) {
	...
	public ENTERTAINMENT_BUSINESS(BankOrCreditUnion bankOrCreditUnion) {
	...
	public ENTERTAINMENT_BUSINESS(BarOrPub barOrPub) {
	...
	public ENTERTAINMENT_BUSINESS(Beach beach) {
	...
	public ENTERTAINMENT_BUSINESS(BeautySalon beautySalon) {
	...
	public ENTERTAINMENT_BUSINESS(BedAndBreakfast bedAndBreakfast) {
	...
	public ENTERTAINMENT_BUSINESS(BikeStore bikeStore) {
	...
	public ENTERTAINMENT_BUSINESS(BodyOfWater bodyOfWater) {
	...
	public ENTERTAINMENT_BUSINESS(BookStore bookStore) {
	...
	public ENTERTAINMENT_BUSINESS(BowlingAlley bowlingAlley) {
	...
	public ENTERTAINMENT_BUSINESS(BranchCode branchCode) {
	...
	public ENTERTAINMENT_BUSINESS(Brand brand) {
		setBrand(brand);
	}
	...
	public ENTERTAINMENT_BUSINESS(Brewery brewery) {
	...
	public ENTERTAINMENT_BUSINESS(Bridge bridge) {
	...
	public ENTERTAINMENT_BUSINESS(BuddhistTemple buddhistTemple) {
	...
	public ENTERTAINMENT_BUSINESS(BusStation busStation) {
	...
	public ENTERTAINMENT_BUSINESS(BusStop busStop) {
	...
	public ENTERTAINMENT_BUSINESS(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public ENTERTAINMENT_BUSINESS(Campground campground) {
	...
	public ENTERTAINMENT_BUSINESS(CampingPitch campingPitch) {
	...
	public ENTERTAINMENT_BUSINESS(Canal canal) {
	...
	public ENTERTAINMENT_BUSINESS(Casino casino) {
	...
	public ENTERTAINMENT_BUSINESS(CatholicChurch catholicChurch) {
	...
	public ENTERTAINMENT_BUSINESS(Cemetery cemetery) {
	...
	public ENTERTAINMENT_BUSINESS(ChildCare childCare) {
	...
	public ENTERTAINMENT_BUSINESS(Church church) {
	...
	public ENTERTAINMENT_BUSINESS(City city) {
	...
	public ENTERTAINMENT_BUSINESS(CityHall cityHall) {
	...
	public ENTERTAINMENT_BUSINESS(CivicStructure civicStructure) {
	...
	public ENTERTAINMENT_BUSINESS(ClothingStore clothingStore) {
	...
	public ENTERTAINMENT_BUSINESS(ComedyClub comedyClub) {
	...
	public ENTERTAINMENT_BUSINESS(CommunityHealth communityHealth) {
	...
	public ENTERTAINMENT_BUSINESS(ComputerStore computerStore) {
	...
	public ENTERTAINMENT_BUSINESS(ContactPoint contactPoint) {
	...
	public ENTERTAINMENT_BUSINESS(ContainedInPlace containedInPlace) {
	...
	public ENTERTAINMENT_BUSINESS(ContainsPlace containsPlace) {
	...
	public ENTERTAINMENT_BUSINESS(Continent continent) {
	...
	public ENTERTAINMENT_BUSINESS(ConvenienceStore convenienceStore) {
	...
	public ENTERTAINMENT_BUSINESS(CorrectionsPolicy correctionsPolicy) {
	...
	public ENTERTAINMENT_BUSINESS(Country country) {
	...
	public ENTERTAINMENT_BUSINESS(Courthouse courthouse) {
	...
	public ENTERTAINMENT_BUSINESS(Crematorium crematorium) {
	...
	public ENTERTAINMENT_BUSINESS(CurrenciesAccepted currenciesAccepted) {
	...
	public ENTERTAINMENT_BUSINESS(DaySpa daySpa) {
	...
	public ENTERTAINMENT_BUSINESS(DefenceEstablishment defenceEstablishment) {
	...
	public ENTERTAINMENT_BUSINESS(Dentist dentist) {
	...
	public ENTERTAINMENT_BUSINESS(Department department) {
	...
	public ENTERTAINMENT_BUSINESS(DepartmentStore departmentStore) {
	...
	public ENTERTAINMENT_BUSINESS(Dermatology dermatology) {
	...
	public ENTERTAINMENT_BUSINESS(Description description) {
	...
	public ENTERTAINMENT_BUSINESS(DietNutrition dietNutrition) {
	...
	public ENTERTAINMENT_BUSINESS(DisambiguatingDescription disambiguatingDescription) {
	...
	public ENTERTAINMENT_BUSINESS(DissolutionDate dissolutionDate) {
	...
	public ENTERTAINMENT_BUSINESS(Distillery distillery) {
	...
	public ENTERTAINMENT_BUSINESS(DiversityPolicy diversityPolicy) {
	...
	public ENTERTAINMENT_BUSINESS(DiversityStaffingReport diversityStaffingReport) {
	...
	public ENTERTAINMENT_BUSINESS(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public ENTERTAINMENT_BUSINESS(Duns duns) {
		setDuns(duns);
	}
	...
	public ENTERTAINMENT_BUSINESS(Electrician electrician) {
	...
	public ENTERTAINMENT_BUSINESS(ElectronicsStore electronicsStore) {
	...
	public ENTERTAINMENT_BUSINESS(Email email) {
		setEmail(email);
	}
	...
	public ENTERTAINMENT_BUSINESS(Embassy embassy) {
	...
	public ENTERTAINMENT_BUSINESS(Emergency emergency) {
	...
	public ENTERTAINMENT_BUSINESS(EmergencyService emergencyService) {
	...
	public ENTERTAINMENT_BUSINESS(Employee employee) {
	...
	public ENTERTAINMENT_BUSINESS(EmploymentAgency employmentAgency) {
	...
	public ENTERTAINMENT_BUSINESS(Clazz.EntertainmentBusiness entertainmentBusiness) {
		entertainmentBusinessList = new ArrayList<Clazz.EntertainmentBusiness>();
	...
	public ENTERTAINMENT_BUSINESS(EthicsPolicy ethicsPolicy) {
	...
	public ENTERTAINMENT_BUSINESS(Event event) {
		setEvent(event);
	}
	...
	public ENTERTAINMENT_BUSINESS(EventVenue eventVenue) {
	...
	public ENTERTAINMENT_BUSINESS(ExerciseGym exerciseGym) {
	...
	public ENTERTAINMENT_BUSINESS(FastFoodRestaurant fastFoodRestaurant) {
	...
	public ENTERTAINMENT_BUSINESS(FaxNumber faxNumber) {
	...
	public ENTERTAINMENT_BUSINESS(FinancialService financialService) {
	...
	public ENTERTAINMENT_BUSINESS(FireStation fireStation) {
	...
	public ENTERTAINMENT_BUSINESS(Florist florist) {
	...
	public ENTERTAINMENT_BUSINESS(FoodEstablishment foodEstablishment) {
	...
	public ENTERTAINMENT_BUSINESS(Founder founder) {
		setFounder(founder);
	}
	...
	public ENTERTAINMENT_BUSINESS(FoundingDate foundingDate) {
	...
	public ENTERTAINMENT_BUSINESS(FoundingLocation foundingLocation) {
	...
	public ENTERTAINMENT_BUSINESS(Funder funder) {
		setFunder(funder);
	}
	...
	public ENTERTAINMENT_BUSINESS(FurnitureStore furnitureStore) {
	...
	public ENTERTAINMENT_BUSINESS(GardenStore gardenStore) {
	...
	public ENTERTAINMENT_BUSINESS(GasStation gasStation) {
	...
	public ENTERTAINMENT_BUSINESS(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public ENTERTAINMENT_BUSINESS(GeneralContractor generalContractor) {
	...
	public ENTERTAINMENT_BUSINESS(Geo geo) {
		setGeo(geo);
	}
	...
	public ENTERTAINMENT_BUSINESS(GeospatiallyContains geospatiallyContains) {
	...
	public ENTERTAINMENT_BUSINESS(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public ENTERTAINMENT_BUSINESS(GeospatiallyCovers geospatiallyCovers) {
	...
	public ENTERTAINMENT_BUSINESS(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public ENTERTAINMENT_BUSINESS(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public ENTERTAINMENT_BUSINESS(GeospatiallyEquals geospatiallyEquals) {
	...
	public ENTERTAINMENT_BUSINESS(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public ENTERTAINMENT_BUSINESS(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public ENTERTAINMENT_BUSINESS(GeospatiallyTouches geospatiallyTouches) {
	...
	public ENTERTAINMENT_BUSINESS(GeospatiallyWithin geospatiallyWithin) {
	...
	public ENTERTAINMENT_BUSINESS(Geriatric geriatric) {
	...
	public ENTERTAINMENT_BUSINESS(GlobalLocationNumber globalLocationNumber) {
	...
	public ENTERTAINMENT_BUSINESS(GolfCourse golfCourse) {
	...
	public ENTERTAINMENT_BUSINESS(GovernmentBuilding governmentBuilding) {
	...
	public ENTERTAINMENT_BUSINESS(GovernmentOffice governmentOffice) {
	...
	public ENTERTAINMENT_BUSINESS(GroceryStore groceryStore) {
	...
	public ENTERTAINMENT_BUSINESS(Gynecologic gynecologic) {
	...
	public ENTERTAINMENT_BUSINESS(HVACBusiness hvacBusiness) {
	...
	public ENTERTAINMENT_BUSINESS(HairSalon hairSalon) {
	...
	public ENTERTAINMENT_BUSINESS(HardwareStore hardwareStore) {
	...
	public ENTERTAINMENT_BUSINESS(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public ENTERTAINMENT_BUSINESS(HasOfferCatalog hasOfferCatalog) {
	...
	public ENTERTAINMENT_BUSINESS(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public ENTERTAINMENT_BUSINESS(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public ENTERTAINMENT_BUSINESS(HealthClub healthClub) {
	...
	public ENTERTAINMENT_BUSINESS(HinduTemple hinduTemple) {
	...
	public ENTERTAINMENT_BUSINESS(HobbyShop hobbyShop) {
	...
	public ENTERTAINMENT_BUSINESS(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public ENTERTAINMENT_BUSINESS(HomeGoodsStore homeGoodsStore) {
	...
	public ENTERTAINMENT_BUSINESS(Hospital hospital) {
	...
	public ENTERTAINMENT_BUSINESS(Hostel hostel) {
	...
	public ENTERTAINMENT_BUSINESS(Hotel hotel) {
	...
	public ENTERTAINMENT_BUSINESS(HotelRoom hotelRoom) {
	...
	public ENTERTAINMENT_BUSINESS(House house) {
	...
	public ENTERTAINMENT_BUSINESS(HousePainter housePainter) {
	...
	public ENTERTAINMENT_BUSINESS(IceCreamShop iceCreamShop) {
	...
	public ENTERTAINMENT_BUSINESS(Identifier identifier) {
	...
	public ENTERTAINMENT_BUSINESS(Image image) {
		setImage(image);
	}
	...
	public ENTERTAINMENT_BUSINESS(InsuranceAgency insuranceAgency) {
	...
	public ENTERTAINMENT_BUSINESS(InternetCafe internetCafe) {
	...
	public ENTERTAINMENT_BUSINESS(IsAccessibleForFree isAccessibleForFree) {
	...
	public ENTERTAINMENT_BUSINESS(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public ENTERTAINMENT_BUSINESS(JewelryStore jewelryStore) {
	...
	public ENTERTAINMENT_BUSINESS(KnowsAbout knowsAbout) {
	...
	public ENTERTAINMENT_BUSINESS(KnowsLanguage knowsLanguage) {
	...
	public ENTERTAINMENT_BUSINESS(LakeBodyOfWater lakeBodyOfWater) {
	...
	public ENTERTAINMENT_BUSINESS(Landform landform) {
	...
	public ENTERTAINMENT_BUSINESS(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public ENTERTAINMENT_BUSINESS(LegalName legalName) {
	...
	public ENTERTAINMENT_BUSINESS(LegalService legalService) {
	...
	public ENTERTAINMENT_BUSINESS(LegislativeBuilding legislativeBuilding) {
	...
	public ENTERTAINMENT_BUSINESS(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public ENTERTAINMENT_BUSINESS(Library library) {
	...
	public ENTERTAINMENT_BUSINESS(LiquorStore liquorStore) {
	...
	public ENTERTAINMENT_BUSINESS(LocalBusiness localBusiness) {
	...
	public ENTERTAINMENT_BUSINESS(Location location) {
	...
	public ENTERTAINMENT_BUSINESS(Locksmith locksmith) {
	...
	public ENTERTAINMENT_BUSINESS(LodgingBusiness lodgingBusiness) {
	...
	public ENTERTAINMENT_BUSINESS(Logo logo) {
		setLogo(logo);
	}
	...
	public ENTERTAINMENT_BUSINESS(MainEntityOfPage mainEntityOfPage) {
	...
	public ENTERTAINMENT_BUSINESS(MakesOffer makesOffer) {
	...
	public ENTERTAINMENT_BUSINESS(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public ENTERTAINMENT_BUSINESS(MedicalBusiness medicalBusiness) {
	...
	public ENTERTAINMENT_BUSINESS(MedicalClinic medicalClinic) {
	...
	public ENTERTAINMENT_BUSINESS(MeetingRoom meetingRoom) {
	...
	public ENTERTAINMENT_BUSINESS(Member member) {
		setMember(member);
	}
	...
	public ENTERTAINMENT_BUSINESS(MemberOf memberOf) {
	...
	public ENTERTAINMENT_BUSINESS(MensClothingStore mensClothingStore) {
	...
	public ENTERTAINMENT_BUSINESS(Midwifery midwifery) {
	...
	public ENTERTAINMENT_BUSINESS(MobilePhoneStore mobilePhoneStore) {
	...
	public ENTERTAINMENT_BUSINESS(Mosque mosque) {
	...
	public ENTERTAINMENT_BUSINESS(Motel motel) {
	...
	public ENTERTAINMENT_BUSINESS(MotorcycleDealer motorcycleDealer) {
	...
	public ENTERTAINMENT_BUSINESS(MotorcycleRepair motorcycleRepair) {
	...
	public ENTERTAINMENT_BUSINESS(Mountain mountain) {
	...
	public ENTERTAINMENT_BUSINESS(MovieRentalStore movieRentalStore) {
	...
	public ENTERTAINMENT_BUSINESS(MovieTheater movieTheater) {
	...
	public ENTERTAINMENT_BUSINESS(MovingCompany movingCompany) {
	...
	public ENTERTAINMENT_BUSINESS(Museum museum) {
	...
	public ENTERTAINMENT_BUSINESS(MusicStore musicStore) {
	...
	public ENTERTAINMENT_BUSINESS(MusicVenue musicVenue) {
	...
	public ENTERTAINMENT_BUSINESS(Naics naics) {
		setNaics(naics);
	}
	...
	public ENTERTAINMENT_BUSINESS(NailSalon nailSalon) {
	...
	public ENTERTAINMENT_BUSINESS(Name name) {
		setName(name);
	}
	...
	public ENTERTAINMENT_BUSINESS(NameFuzzy nameFuzzy) {
	...
	public ENTERTAINMENT_BUSINESS(NameRuby nameRuby) {
	...
	public ENTERTAINMENT_BUSINESS(NightClub nightClub) {
	...
	public ENTERTAINMENT_BUSINESS(Notary notary) {
	...
	public ENTERTAINMENT_BUSINESS(NumberOfEmployees numberOfEmployees) {
	...
	public ENTERTAINMENT_BUSINESS(Nursing nursing) {
	...
	public ENTERTAINMENT_BUSINESS(Obstetric obstetric) {
	...
	public ENTERTAINMENT_BUSINESS(OceanBodyOfWater oceanBodyOfWater) {
	...
	public ENTERTAINMENT_BUSINESS(OfficeEquipmentStore officeEquipmentStore) {
	...
	public ENTERTAINMENT_BUSINESS(Oncologic oncologic) {
	...
	public ENTERTAINMENT_BUSINESS(OpeningHours openingHours) {
	...
	public ENTERTAINMENT_BUSINESS(OpeningHoursSpecification openingHoursSpecification) {
	...
	public ENTERTAINMENT_BUSINESS(Optician optician) {
	...
	public ENTERTAINMENT_BUSINESS(Optometric optometric) {
	...
	public ENTERTAINMENT_BUSINESS(Otolaryngologic otolaryngologic) {
	...
	public ENTERTAINMENT_BUSINESS(OutletStore outletStore) {
	...
	public ENTERTAINMENT_BUSINESS(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public ENTERTAINMENT_BUSINESS(Owns owns) {
		setOwns(owns);
	}
	...
	public ENTERTAINMENT_BUSINESS(ParentOrganization parentOrganization) {
	...
	public ENTERTAINMENT_BUSINESS(Park park) {
	...
	public ENTERTAINMENT_BUSINESS(ParkingFacility parkingFacility) {
	...
	public ENTERTAINMENT_BUSINESS(PawnShop pawnShop) {
	...
	public ENTERTAINMENT_BUSINESS(PaymentAccepted paymentAccepted) {
	...
	public ENTERTAINMENT_BUSINESS(Pediatric pediatric) {
	...
	public ENTERTAINMENT_BUSINESS(PerformingArtsTheater performingArtsTheater) {
	...
	public ENTERTAINMENT_BUSINESS(PetStore petStore) {
	...
	public ENTERTAINMENT_BUSINESS(Pharmacy pharmacy) {
	...
	public ENTERTAINMENT_BUSINESS(Photo photo) {
		setPhoto(photo);
	}
	...
	public ENTERTAINMENT_BUSINESS(Physician physician) {
	...
	public ENTERTAINMENT_BUSINESS(Physiotherapy physiotherapy) {
	...
	public ENTERTAINMENT_BUSINESS(Place place) {
	...
	public ENTERTAINMENT_BUSINESS(PlaceOfWorship placeOfWorship) {
	...
	public ENTERTAINMENT_BUSINESS(PlasticSurgery plasticSurgery) {
	...
	public ENTERTAINMENT_BUSINESS(Playground playground) {
	...
	public ENTERTAINMENT_BUSINESS(Plumber plumber) {
	...
	public ENTERTAINMENT_BUSINESS(Podiatric podiatric) {
	...
	public ENTERTAINMENT_BUSINESS(PoliceStation policeStation) {
	...
	public ENTERTAINMENT_BUSINESS(Pond pond) {
	...
	public ENTERTAINMENT_BUSINESS(PostOffice postOffice) {
	...
	public ENTERTAINMENT_BUSINESS(PostalAddress postalAddress) {
	...
	public ENTERTAINMENT_BUSINESS(PotentialAction potentialAction) {
	...
	public ENTERTAINMENT_BUSINESS(PriceRange priceRange) {
	...
	public ENTERTAINMENT_BUSINESS(PrimaryCare primaryCare) {
	...
	public ENTERTAINMENT_BUSINESS(ProfessionalService professionalService) {
	...
	public ENTERTAINMENT_BUSINESS(Psychiatric psychiatric) {
	...
	public ENTERTAINMENT_BUSINESS(PublicAccess publicAccess) {
	...
	public ENTERTAINMENT_BUSINESS(PublicHealth publicHealth) {
	...
	public ENTERTAINMENT_BUSINESS(PublicSwimmingPool publicSwimmingPool) {
	...
	public ENTERTAINMENT_BUSINESS(PublicToilet publicToilet) {
	...
	public ENTERTAINMENT_BUSINESS(PublishingPrinciples publishingPrinciples) {
	...
	public ENTERTAINMENT_BUSINESS(RVPark rvPark) {
	...
	public ENTERTAINMENT_BUSINESS(RadioStation radioStation) {
	...
	public ENTERTAINMENT_BUSINESS(RealEstateAgent realEstateAgent) {
	...
	public ENTERTAINMENT_BUSINESS(RecyclingCenter recyclingCenter) {
	...
	public ENTERTAINMENT_BUSINESS(Reservoir reservoir) {
	...
	public ENTERTAINMENT_BUSINESS(Residence residence) {
	...
	public ENTERTAINMENT_BUSINESS(Resort resort) {
	...
	public ENTERTAINMENT_BUSINESS(Restaurant restaurant) {
	...
	public ENTERTAINMENT_BUSINESS(Review review) {
		setReview(review);
	}
	...
	public ENTERTAINMENT_BUSINESS(RiverBodyOfWater riverBodyOfWater) {
	...
	public ENTERTAINMENT_BUSINESS(RoofingContractor roofingContractor) {
	...
	public ENTERTAINMENT_BUSINESS(Room room) {
	...
	public ENTERTAINMENT_BUSINESS(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ENTERTAINMENT_BUSINESS(SeaBodyOfWater seaBodyOfWater) {
	...
	public ENTERTAINMENT_BUSINESS(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public ENTERTAINMENT_BUSINESS(SelfStorage selfStorage) {
	...
	public ENTERTAINMENT_BUSINESS(ShoeStore shoeStore) {
	...
	public ENTERTAINMENT_BUSINESS(ShoppingCenter shoppingCenter) {
	...
	public ENTERTAINMENT_BUSINESS(SingleFamilyResidence singleFamilyResidence) {
	...
	public ENTERTAINMENT_BUSINESS(SkiResort skiResort) {
	...
	public ENTERTAINMENT_BUSINESS(SmokingAllowed smokingAllowed) {
	...
	public ENTERTAINMENT_BUSINESS(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public ENTERTAINMENT_BUSINESS(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public ENTERTAINMENT_BUSINESS(SportingGoodsStore sportingGoodsStore) {
	...
	public ENTERTAINMENT_BUSINESS(SportsActivityLocation sportsActivityLocation) {
	...
	public ENTERTAINMENT_BUSINESS(SportsClub sportsClub) {
	...
	public ENTERTAINMENT_BUSINESS(StadiumOrArena stadiumOrArena) {
	...
	public ENTERTAINMENT_BUSINESS(State state) {
	...
	public ENTERTAINMENT_BUSINESS(Store store) {
	...
	public ENTERTAINMENT_BUSINESS(SubOrganization subOrganization) {
	...
	public ENTERTAINMENT_BUSINESS(SubjectOf subjectOf) {
	...
	public ENTERTAINMENT_BUSINESS(SubwayStation subwayStation) {
	...
	public ENTERTAINMENT_BUSINESS(Suite suite) {
	...
	public ENTERTAINMENT_BUSINESS(Synagogue synagogue) {
	...
	public ENTERTAINMENT_BUSINESS(TattooParlor tattooParlor) {
	...
	public ENTERTAINMENT_BUSINESS(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public ENTERTAINMENT_BUSINESS(TaxiStand taxiStand) {
	...
	public ENTERTAINMENT_BUSINESS(Telephone telephone) {
	...
	public ENTERTAINMENT_BUSINESS(TelevisionStation televisionStation) {
	...
	public ENTERTAINMENT_BUSINESS(TennisComplex tennisComplex) {
	...
	public ENTERTAINMENT_BUSINESS(Text text) {
	...
	public ENTERTAINMENT_BUSINESS(TireShop tireShop) {
	...
	public ENTERTAINMENT_BUSINESS(TouristAttraction touristAttraction) {
	...
	public ENTERTAINMENT_BUSINESS(TouristDestination touristDestination) {
	...
	public ENTERTAINMENT_BUSINESS(TouristInformationCenter touristInformationCenter) {
	...
	public ENTERTAINMENT_BUSINESS(ToyStore toyStore) {
	...
	public ENTERTAINMENT_BUSINESS(TrainStation trainStation) {
	...
	public ENTERTAINMENT_BUSINESS(TravelAgency travelAgency) {
	...
	public ENTERTAINMENT_BUSINESS(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public ENTERTAINMENT_BUSINESS(Url url) {
		setUrl(url);
	}
	...
	public ENTERTAINMENT_BUSINESS(VatID vatID) {
		setVatID(vatID);
	}
	...
	public ENTERTAINMENT_BUSINESS(Volcano volcano) {
	...
	public ENTERTAINMENT_BUSINESS(Waterfall waterfall) {
	...
	public ENTERTAINMENT_BUSINESS(WholesaleStore wholesaleStore) {
	...
	public ENTERTAINMENT_BUSINESS(Winery winery) {
	...
	public ENTERTAINMENT_BUSINESS(Zoo zoo) {
	...
	public void copy(Clazz.EntertainmentBusiness org) {
		setSeq(org.getSeq());
	...
	public void copy(Container.EntertainmentBusiness org) {
