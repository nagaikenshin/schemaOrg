...
import org.kyojo.schemaorg.m3n4.core.Container.AwayTeam;
...
import org.kyojo.schemaorg.m3n4.core.Container.HomeTeam;
...
public class SPORTS_EVENT implements Clazz.SportsEvent, Container.SportsEvent {
	...
	public SPORTS_EVENT(Accommodation accommodation) {
	...
	public SPORTS_EVENT(AccountingService accountingService) {
	...
	public SPORTS_EVENT(AdministrativeArea administrativeArea) {
	...
	public SPORTS_EVENT(AdultEntertainment adultEntertainment) {
	...
	public SPORTS_EVENT(Airport airport) {
	...
	public SPORTS_EVENT(AmusementPark amusementPark) {
	...
	public SPORTS_EVENT(AnimalShelter animalShelter) {
	...
	public SPORTS_EVENT(Apartment apartment) {
	...
	public SPORTS_EVENT(ApartmentComplex apartmentComplex) {
	...
	public SPORTS_EVENT(Aquarium aquarium) {
	...
	public SPORTS_EVENT(ArtGallery artGallery) {
	...
	public SPORTS_EVENT(Attorney attorney) {
	...
	public SPORTS_EVENT(AutoBodyShop autoBodyShop) {
	...
	public SPORTS_EVENT(AutoDealer autoDealer) {
	...
	public SPORTS_EVENT(AutoPartsStore autoPartsStore) {
	...
	public SPORTS_EVENT(AutoRental autoRental) {
	...
	public SPORTS_EVENT(AutoRepair autoRepair) {
	...
	public SPORTS_EVENT(AutoWash autoWash) {
	...
	public SPORTS_EVENT(AutomatedTeller automatedTeller) {
	...
	public SPORTS_EVENT(AutomotiveBusiness automotiveBusiness) {
	...
	public SPORTS_EVENT(Bakery bakery) {
	...
	public SPORTS_EVENT(BankOrCreditUnion bankOrCreditUnion) {
	...
	public SPORTS_EVENT(BarOrPub barOrPub) {
	...
	public SPORTS_EVENT(Beach beach) {
	...
	public SPORTS_EVENT(BeautySalon beautySalon) {
	...
	public SPORTS_EVENT(BedAndBreakfast bedAndBreakfast) {
	...
	public SPORTS_EVENT(BikeStore bikeStore) {
	...
	public SPORTS_EVENT(BodyOfWater bodyOfWater) {
	...
	public SPORTS_EVENT(BookStore bookStore) {
	...
	public SPORTS_EVENT(BowlingAlley bowlingAlley) {
	...
	public SPORTS_EVENT(Brewery brewery) {
	...
	public SPORTS_EVENT(Bridge bridge) {
	...
	public SPORTS_EVENT(BuddhistTemple buddhistTemple) {
	...
	public SPORTS_EVENT(BusStation busStation) {
	...
	public SPORTS_EVENT(BusStop busStop) {
	...
	public SPORTS_EVENT(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public SPORTS_EVENT(Campground campground) {
	...
	public SPORTS_EVENT(CampingPitch campingPitch) {
	...
	public SPORTS_EVENT(Canal canal) {
	...
	public SPORTS_EVENT(Casino casino) {
	...
	public SPORTS_EVENT(CatholicChurch catholicChurch) {
	...
	public SPORTS_EVENT(Cemetery cemetery) {
	...
	public SPORTS_EVENT(ChildCare childCare) {
	...
	public SPORTS_EVENT(Church church) {
	...
	public SPORTS_EVENT(CityHall cityHall) {
	...
	public SPORTS_EVENT(CivicStructure civicStructure) {
	...
	public SPORTS_EVENT(ClothingStore clothingStore) {
	...
	public SPORTS_EVENT(ComedyClub comedyClub) {
	...
	public SPORTS_EVENT(CommunityHealth communityHealth) {
	...
	public SPORTS_EVENT(ComputerStore computerStore) {
	...
	public SPORTS_EVENT(Continent continent) {
	...
	public SPORTS_EVENT(ConvenienceStore convenienceStore) {
	...
	public SPORTS_EVENT(Country country) {
	...
	public SPORTS_EVENT(Courthouse courthouse) {
	...
	public SPORTS_EVENT(Crematorium crematorium) {
	...
	public SPORTS_EVENT(DaySpa daySpa) {
	...
	public SPORTS_EVENT(DefenceEstablishment defenceEstablishment) {
	...
	public SPORTS_EVENT(Dentist dentist) {
	...
	public SPORTS_EVENT(DepartmentStore departmentStore) {
	...
	public SPORTS_EVENT(Dermatology dermatology) {
	...
	public SPORTS_EVENT(DietNutrition dietNutrition) {
	...
	public SPORTS_EVENT(Distillery distillery) {
	...
	public SPORTS_EVENT(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public SPORTS_EVENT(Electrician electrician) {
	...
	public SPORTS_EVENT(ElectronicsStore electronicsStore) {
	...
	public SPORTS_EVENT(Embassy embassy) {
	...
	public SPORTS_EVENT(Emergency emergency) {
	...
	public SPORTS_EVENT(EmergencyService emergencyService) {
	...
	public SPORTS_EVENT(EmploymentAgency employmentAgency) {
	...
	public SPORTS_EVENT(EntertainmentBusiness entertainmentBusiness) {
	...
	public SPORTS_EVENT(EventVenue eventVenue) {
	...
	public SPORTS_EVENT(ExerciseGym exerciseGym) {
	...
	public SPORTS_EVENT(FastFoodRestaurant fastFoodRestaurant) {
	...
	public SPORTS_EVENT(FinancialService financialService) {
	...
	public SPORTS_EVENT(FireStation fireStation) {
	...
	public SPORTS_EVENT(Florist florist) {
	...
	public SPORTS_EVENT(FoodEstablishment foodEstablishment) {
	...
	public SPORTS_EVENT(FurnitureStore furnitureStore) {
	...
	public SPORTS_EVENT(GardenStore gardenStore) {
	...
	public SPORTS_EVENT(GasStation gasStation) {
	...
	public SPORTS_EVENT(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public SPORTS_EVENT(GeneralContractor generalContractor) {
	...
	public SPORTS_EVENT(Geriatric geriatric) {
	...
	public SPORTS_EVENT(GolfCourse golfCourse) {
	...
	public SPORTS_EVENT(GovernmentBuilding governmentBuilding) {
	...
	public SPORTS_EVENT(GovernmentOffice governmentOffice) {
	...
	public SPORTS_EVENT(GroceryStore groceryStore) {
	...
	public SPORTS_EVENT(Gynecologic gynecologic) {
	...
	public SPORTS_EVENT(HVACBusiness hvacBusiness) {
	...
	public SPORTS_EVENT(HairSalon hairSalon) {
	...
	public SPORTS_EVENT(HardwareStore hardwareStore) {
	...
	public SPORTS_EVENT(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public SPORTS_EVENT(HealthClub healthClub) {
	...
	public SPORTS_EVENT(HinduTemple hinduTemple) {
	...
	public SPORTS_EVENT(HobbyShop hobbyShop) {
	...
	public SPORTS_EVENT(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public SPORTS_EVENT(HomeGoodsStore homeGoodsStore) {
	...
	public SPORTS_EVENT(Hospital hospital) {
	...
	public SPORTS_EVENT(Hostel hostel) {
	...
	public SPORTS_EVENT(Hotel hotel) {
	...
	public SPORTS_EVENT(HotelRoom hotelRoom) {
	...
	public SPORTS_EVENT(House house) {
	...
	public SPORTS_EVENT(HousePainter housePainter) {
	...
	public SPORTS_EVENT(IceCreamShop iceCreamShop) {
	...
	public SPORTS_EVENT(InsuranceAgency insuranceAgency) {
	...
	public SPORTS_EVENT(InternetCafe internetCafe) {
	...
	public SPORTS_EVENT(JewelryStore jewelryStore) {
	...
	public SPORTS_EVENT(LakeBodyOfWater lakeBodyOfWater) {
	...
	public SPORTS_EVENT(Landform landform) {
	...
	public SPORTS_EVENT(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public SPORTS_EVENT(LegalService legalService) {
	...
	public SPORTS_EVENT(LegislativeBuilding legislativeBuilding) {
	...
	public SPORTS_EVENT(Library library) {
	...
	public SPORTS_EVENT(LiquorStore liquorStore) {
	...
	public SPORTS_EVENT(LocalBusiness localBusiness) {
	...
	public SPORTS_EVENT(Locksmith locksmith) {
	...
	public SPORTS_EVENT(LodgingBusiness lodgingBusiness) {
	...
	public SPORTS_EVENT(MedicalBusiness medicalBusiness) {
	...
	public SPORTS_EVENT(MedicalClinic medicalClinic) {
	...
	public SPORTS_EVENT(MeetingRoom meetingRoom) {
	...
	public SPORTS_EVENT(MensClothingStore mensClothingStore) {
	...
	public SPORTS_EVENT(Midwifery midwifery) {
	...
	public SPORTS_EVENT(MobilePhoneStore mobilePhoneStore) {
	...
	public SPORTS_EVENT(Mosque mosque) {
	...
	public SPORTS_EVENT(Motel motel) {
	...
	public SPORTS_EVENT(MotorcycleDealer motorcycleDealer) {
	...
	public SPORTS_EVENT(MotorcycleRepair motorcycleRepair) {
	...
	public SPORTS_EVENT(Mountain mountain) {
	...
	public SPORTS_EVENT(MovieRentalStore movieRentalStore) {
	...
	public SPORTS_EVENT(MovieTheater movieTheater) {
	...
	public SPORTS_EVENT(MovingCompany movingCompany) {
	...
	public SPORTS_EVENT(Museum museum) {
	...
	public SPORTS_EVENT(MusicStore musicStore) {
	...
	public SPORTS_EVENT(MusicVenue musicVenue) {
	...
	public SPORTS_EVENT(NailSalon nailSalon) {
	...
	public SPORTS_EVENT(NightClub nightClub) {
	...
	public SPORTS_EVENT(Notary notary) {
	...
	public SPORTS_EVENT(Nursing nursing) {
	...
	public SPORTS_EVENT(Obstetric obstetric) {
	...
	public SPORTS_EVENT(OceanBodyOfWater oceanBodyOfWater) {
	...
	public SPORTS_EVENT(OfficeEquipmentStore officeEquipmentStore) {
	...
	public SPORTS_EVENT(Oncologic oncologic) {
	...
	public SPORTS_EVENT(Optician optician) {
	...
	public SPORTS_EVENT(Optometric optometric) {
	...
	public SPORTS_EVENT(Otolaryngologic otolaryngologic) {
	...
	public SPORTS_EVENT(OutletStore outletStore) {
	...
	public SPORTS_EVENT(ParkingFacility parkingFacility) {
	...
	public SPORTS_EVENT(PawnShop pawnShop) {
	...
	public SPORTS_EVENT(Pediatric pediatric) {
	...
	public SPORTS_EVENT(PerformingArtsTheater performingArtsTheater) {
	...
	public SPORTS_EVENT(PetStore petStore) {
	...
	public SPORTS_EVENT(Pharmacy pharmacy) {
	...
	public SPORTS_EVENT(Physician physician) {
	...
	public SPORTS_EVENT(Physiotherapy physiotherapy) {
	...
	public SPORTS_EVENT(PlaceOfWorship placeOfWorship) {
	...
	public SPORTS_EVENT(PlasticSurgery plasticSurgery) {
	...
	public SPORTS_EVENT(Playground playground) {
	...
	public SPORTS_EVENT(Plumber plumber) {
	...
	public SPORTS_EVENT(Podiatric podiatric) {
	...
	public SPORTS_EVENT(PoliceStation policeStation) {
	...
	public SPORTS_EVENT(PostOffice postOffice) {
	...
	public SPORTS_EVENT(PrimaryCare primaryCare) {
	...
	public SPORTS_EVENT(ProfessionalService professionalService) {
	...
	public SPORTS_EVENT(Psychiatric psychiatric) {
	...
	public SPORTS_EVENT(PublicHealth publicHealth) {
	...
	public SPORTS_EVENT(PublicSwimmingPool publicSwimmingPool) {
	...
	public SPORTS_EVENT(PublicToilet publicToilet) {
	...
	public SPORTS_EVENT(RVPark rvPark) {
	...
	public SPORTS_EVENT(RadioStation radioStation) {
	...
	public SPORTS_EVENT(RealEstateAgent realEstateAgent) {
	...
	public SPORTS_EVENT(RecyclingCenter recyclingCenter) {
	...
	public SPORTS_EVENT(Reservoir reservoir) {
	...
	public SPORTS_EVENT(Residence residence) {
	...
	public SPORTS_EVENT(Resort resort) {
	...
	public SPORTS_EVENT(Restaurant restaurant) {
	...
	public SPORTS_EVENT(RiverBodyOfWater riverBodyOfWater) {
	...
	public SPORTS_EVENT(RoofingContractor roofingContractor) {
	...
	public SPORTS_EVENT(SeaBodyOfWater seaBodyOfWater) {
	...
	public SPORTS_EVENT(SelfStorage selfStorage) {
	...
	public SPORTS_EVENT(ShoeStore shoeStore) {
	...
	public SPORTS_EVENT(ShoppingCenter shoppingCenter) {
	...
	public SPORTS_EVENT(SingleFamilyResidence singleFamilyResidence) {
	...
	public SPORTS_EVENT(SkiResort skiResort) {
	...
	public SPORTS_EVENT(SportingGoodsStore sportingGoodsStore) {
	...
	public SPORTS_EVENT(SportsActivityLocation sportsActivityLocation) {
	...
	public SPORTS_EVENT(SportsClub sportsClub) {
	...
	public SPORTS_EVENT(StadiumOrArena stadiumOrArena) {
	...
	public SPORTS_EVENT(State state) {
	...
	public SPORTS_EVENT(Store store) {
	...
	public SPORTS_EVENT(SubjectOf subjectOf) {
	...
	public SPORTS_EVENT(SubwayStation subwayStation) {
	...
	public SPORTS_EVENT(Suite suite) {
	...
	public SPORTS_EVENT(Synagogue synagogue) {
	...
	public SPORTS_EVENT(TattooParlor tattooParlor) {
	...
	public SPORTS_EVENT(TaxiStand taxiStand) {
	...
	public SPORTS_EVENT(TelevisionStation televisionStation) {
	...
	public SPORTS_EVENT(TennisComplex tennisComplex) {
	...
	public SPORTS_EVENT(TireShop tireShop) {
	...
	public SPORTS_EVENT(TouristAttraction touristAttraction) {
	...
	public SPORTS_EVENT(TouristDestination touristDestination) {
	...
	public SPORTS_EVENT(TouristInformationCenter touristInformationCenter) {
	...
	public SPORTS_EVENT(ToyStore toyStore) {
	...
	public SPORTS_EVENT(TrainStation trainStation) {
	...
	public SPORTS_EVENT(TravelAgency travelAgency) {
	...
	public SPORTS_EVENT(Volcano volcano) {
	...
	public SPORTS_EVENT(Waterfall waterfall) {
	...
	public SPORTS_EVENT(WholesaleStore wholesaleStore) {
	...
	public SPORTS_EVENT(Winery winery) {
