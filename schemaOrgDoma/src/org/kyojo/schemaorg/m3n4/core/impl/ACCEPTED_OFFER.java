...
public class ACCEPTED_OFFER implements Container.AcceptedOffer {
	...
	public ACCEPTED_OFFER(String string) {
	...
	public ACCEPTED_OFFER(AggregateOffer aggregateOffer) {
	...
	public ACCEPTED_OFFER(Offer offer) {
		offerList = new ArrayList<Offer>();
		offerList.add(offer);
	}
	...
	public ACCEPTED_OFFER(List<AggregateOffer> aggregateOfferList,
			List<Offer> offerList) {
		setAggregateOfferList(aggregateOfferList);
		setOfferList(offerList);
	}

	public void copy(Container.AcceptedOffer org) {
