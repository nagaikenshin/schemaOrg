...
public class YEARS_IN_OPERATION implements Container.YearsInOperation {
	...
	public YEARS_IN_OPERATION(String string) {
	...
	public YEARS_IN_OPERATION(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public YEARS_IN_OPERATION(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public YEARS_IN_OPERATION(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public YEARS_IN_OPERATION(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.YearsInOperation org) {
