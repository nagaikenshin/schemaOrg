...
public class STORE implements Clazz.Store {
	...
	public STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public STORE(AdditionalProperty additionalProperty) {
	...
	public STORE(AdditionalType additionalType) {
	...
	public STORE(AggregateRating aggregateRating) {
	...
	public STORE(AlternateName alternateName) {
	...
	public STORE(AmenityFeature amenityFeature) {
	...
	public STORE(AreaServed areaServed) {
	...
	public STORE(BranchCode branchCode) {
	...
	public STORE(ContactPoint contactPoint) {
	...
	public STORE(ContainedInPlace containedInPlace) {
	...
	public STORE(ContainsPlace containsPlace) {
	...
	public STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public STORE(DissolutionDate dissolutionDate) {
	...
	public STORE(DiversityPolicy diversityPolicy) {
	...
	public STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public STORE(EthicsPolicy ethicsPolicy) {
	...
	public STORE(FaxNumber faxNumber) {
	...
	public STORE(FoundingDate foundingDate) {
	...
	public STORE(FoundingLocation foundingLocation) {
	...
	public STORE(GeospatiallyContains geospatiallyContains) {
	...
	public STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public STORE(KnowsAbout knowsAbout) {
	...
	public STORE(KnowsLanguage knowsLanguage) {
	...
	public STORE(LegalName legalName) {
	...
	public STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public STORE(MakesOffer makesOffer) {
	...
	public STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public STORE(MemberOf memberOf) {
	...
	public STORE(NameFuzzy nameFuzzy) {
	...
	public STORE(NameRuby nameRuby) {
	...
	public STORE(NumberOfEmployees numberOfEmployees) {
	...
	public STORE(OpeningHours openingHours) {
	...
	public STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public STORE(ParentOrganization parentOrganization) {
	...
	public STORE(PaymentAccepted paymentAccepted) {
	...
	public STORE(PotentialAction potentialAction) {
	...
	public STORE(PriceRange priceRange) {
	...
	public STORE(PublicAccess publicAccess) {
	...
	public STORE(PublishingPrinciples publishingPrinciples) {
	...
	public STORE(SmokingAllowed smokingAllowed) {
	...
	public STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public STORE(SubOrganization subOrganization) {
	...
	public STORE(SubjectOf subjectOf) {
	...
	public STORE(Telephone telephone) {
	...
	public STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Store org) {
		setSeq(org.getSeq());
