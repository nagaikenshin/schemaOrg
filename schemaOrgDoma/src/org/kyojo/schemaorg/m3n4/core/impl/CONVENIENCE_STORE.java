...
public class CONVENIENCE_STORE implements Clazz.ConvenienceStore {
	...
	public CONVENIENCE_STORE(Long seq) {
		setSeq(seq);
	}

	public CONVENIENCE_STORE(String string) {
	...
	public CONVENIENCE_STORE(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public CONVENIENCE_STORE(AdditionalProperty additionalProperty) {
	...
	public CONVENIENCE_STORE(AdditionalType additionalType) {
	...
	public CONVENIENCE_STORE(Address address) {
		setAddress(address);
	}
	...
	public CONVENIENCE_STORE(AggregateRating aggregateRating) {
	...
	public CONVENIENCE_STORE(AlternateName alternateName) {
	...
	public CONVENIENCE_STORE(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public CONVENIENCE_STORE(AmenityFeature amenityFeature) {
	...
	public CONVENIENCE_STORE(AreaServed areaServed) {
	...
	public CONVENIENCE_STORE(Award award) {
		setAward(award);
	}
	...
	public CONVENIENCE_STORE(BranchCode branchCode) {
	...
	public CONVENIENCE_STORE(Brand brand) {
		setBrand(brand);
	}
	...
	public CONVENIENCE_STORE(ContactPoint contactPoint) {
	...
	public CONVENIENCE_STORE(ContainedInPlace containedInPlace) {
	...
	public CONVENIENCE_STORE(ContainsPlace containsPlace) {
	...
	public CONVENIENCE_STORE(CorrectionsPolicy correctionsPolicy) {
	...
	public CONVENIENCE_STORE(CurrenciesAccepted currenciesAccepted) {
	...
	public CONVENIENCE_STORE(Department department) {
	...
	public CONVENIENCE_STORE(Description description) {
	...
	public CONVENIENCE_STORE(DisambiguatingDescription disambiguatingDescription) {
	...
	public CONVENIENCE_STORE(DissolutionDate dissolutionDate) {
	...
	public CONVENIENCE_STORE(DiversityPolicy diversityPolicy) {
	...
	public CONVENIENCE_STORE(DiversityStaffingReport diversityStaffingReport) {
	...
	public CONVENIENCE_STORE(Duns duns) {
		setDuns(duns);
	}
	...
	public CONVENIENCE_STORE(Email email) {
		setEmail(email);
	}
	...
	public CONVENIENCE_STORE(Employee employee) {
	...
	public CONVENIENCE_STORE(EthicsPolicy ethicsPolicy) {
	...
	public CONVENIENCE_STORE(Event event) {
		setEvent(event);
	}
	...
	public CONVENIENCE_STORE(FaxNumber faxNumber) {
	...
	public CONVENIENCE_STORE(Founder founder) {
		setFounder(founder);
	}
	...
	public CONVENIENCE_STORE(FoundingDate foundingDate) {
	...
	public CONVENIENCE_STORE(FoundingLocation foundingLocation) {
	...
	public CONVENIENCE_STORE(Funder funder) {
		setFunder(funder);
	}
	...
	public CONVENIENCE_STORE(Geo geo) {
		setGeo(geo);
	}
	...
	public CONVENIENCE_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public CONVENIENCE_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public CONVENIENCE_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public CONVENIENCE_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public CONVENIENCE_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public CONVENIENCE_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public CONVENIENCE_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public CONVENIENCE_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public CONVENIENCE_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public CONVENIENCE_STORE(GeospatiallyWithin geospatiallyWithin) {
	...
	public CONVENIENCE_STORE(GlobalLocationNumber globalLocationNumber) {
	...
	public CONVENIENCE_STORE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public CONVENIENCE_STORE(HasOfferCatalog hasOfferCatalog) {
	...
	public CONVENIENCE_STORE(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public CONVENIENCE_STORE(Identifier identifier) {
	...
	public CONVENIENCE_STORE(Image image) {
		setImage(image);
	}
	...
	public CONVENIENCE_STORE(IsAccessibleForFree isAccessibleForFree) {
	...
	public CONVENIENCE_STORE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public CONVENIENCE_STORE(KnowsAbout knowsAbout) {
	...
	public CONVENIENCE_STORE(KnowsLanguage knowsLanguage) {
	...
	public CONVENIENCE_STORE(LegalName legalName) {
	...
	public CONVENIENCE_STORE(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public CONVENIENCE_STORE(Location location) {
	...
	public CONVENIENCE_STORE(Logo logo) {
		setLogo(logo);
	}
	...
	public CONVENIENCE_STORE(MainEntityOfPage mainEntityOfPage) {
	...
	public CONVENIENCE_STORE(MakesOffer makesOffer) {
	...
	public CONVENIENCE_STORE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public CONVENIENCE_STORE(Member member) {
		setMember(member);
	}
	...
	public CONVENIENCE_STORE(MemberOf memberOf) {
	...
	public CONVENIENCE_STORE(Naics naics) {
		setNaics(naics);
	}
	...
	public CONVENIENCE_STORE(Name name) {
		setName(name);
	}
	...
	public CONVENIENCE_STORE(NameFuzzy nameFuzzy) {
	...
	public CONVENIENCE_STORE(NameRuby nameRuby) {
	...
	public CONVENIENCE_STORE(NumberOfEmployees numberOfEmployees) {
	...
	public CONVENIENCE_STORE(OpeningHours openingHours) {
	...
	public CONVENIENCE_STORE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public CONVENIENCE_STORE(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public CONVENIENCE_STORE(Owns owns) {
		setOwns(owns);
	}
	...
	public CONVENIENCE_STORE(ParentOrganization parentOrganization) {
	...
	public CONVENIENCE_STORE(PaymentAccepted paymentAccepted) {
	...
	public CONVENIENCE_STORE(Photo photo) {
		setPhoto(photo);
	}
	...
	public CONVENIENCE_STORE(PotentialAction potentialAction) {
	...
	public CONVENIENCE_STORE(PriceRange priceRange) {
	...
	public CONVENIENCE_STORE(PublicAccess publicAccess) {
	...
	public CONVENIENCE_STORE(PublishingPrinciples publishingPrinciples) {
	...
	public CONVENIENCE_STORE(Review review) {
		setReview(review);
	}
	...
	public CONVENIENCE_STORE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CONVENIENCE_STORE(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public CONVENIENCE_STORE(SmokingAllowed smokingAllowed) {
	...
	public CONVENIENCE_STORE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public CONVENIENCE_STORE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public CONVENIENCE_STORE(SubOrganization subOrganization) {
	...
	public CONVENIENCE_STORE(SubjectOf subjectOf) {
	...
	public CONVENIENCE_STORE(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public CONVENIENCE_STORE(Telephone telephone) {
	...
	public CONVENIENCE_STORE(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public CONVENIENCE_STORE(Url url) {
		setUrl(url);
	}
	...
	public CONVENIENCE_STORE(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.ConvenienceStore org) {
		setSeq(org.getSeq());
