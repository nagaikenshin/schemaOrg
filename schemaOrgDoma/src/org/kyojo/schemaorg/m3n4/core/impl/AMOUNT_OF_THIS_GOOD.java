...
public class AMOUNT_OF_THIS_GOOD implements Container.AmountOfThisGood {
	...
	public AMOUNT_OF_THIS_GOOD(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public AMOUNT_OF_THIS_GOOD(Float fl0at) {
	...
	public AMOUNT_OF_THIS_GOOD(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public AMOUNT_OF_THIS_GOOD(Integer integer) {
	...
	public AMOUNT_OF_THIS_GOOD(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public AMOUNT_OF_THIS_GOOD(Number number) {
	...
	public AMOUNT_OF_THIS_GOOD(List<Float> fl0atList,
	...
	public void copy(Container.AmountOfThisGood org) {
