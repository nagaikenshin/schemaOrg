...
public class RESIDENCE implements Clazz.Residence {
	...
	public RESIDENCE(Long seq) {
		setSeq(seq);
	}

	public RESIDENCE(String string) {
	...
	public RESIDENCE(AdditionalProperty additionalProperty) {
	...
	public RESIDENCE(AdditionalType additionalType) {
	...
	public RESIDENCE(AggregateRating aggregateRating) {
	...
	public RESIDENCE(AlternateName alternateName) {
	...
	public RESIDENCE(AmenityFeature amenityFeature) {
	...
	public RESIDENCE(BranchCode branchCode) {
	...
	public RESIDENCE(ContainedInPlace containedInPlace) {
	...
	public RESIDENCE(ContainsPlace containsPlace) {
	...
	public RESIDENCE(Description description) {
	...
	public RESIDENCE(DisambiguatingDescription disambiguatingDescription) {
	...
	public RESIDENCE(FaxNumber faxNumber) {
	...
	public RESIDENCE(GeospatiallyContains geospatiallyContains) {
	...
	public RESIDENCE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public RESIDENCE(GeospatiallyCovers geospatiallyCovers) {
	...
	public RESIDENCE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public RESIDENCE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public RESIDENCE(GeospatiallyEquals geospatiallyEquals) {
	...
	public RESIDENCE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public RESIDENCE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public RESIDENCE(GeospatiallyTouches geospatiallyTouches) {
	...
	public RESIDENCE(GeospatiallyWithin geospatiallyWithin) {
	...
	public RESIDENCE(GlobalLocationNumber globalLocationNumber) {
	...
	public RESIDENCE(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public RESIDENCE(Identifier identifier) {
	...
	public RESIDENCE(IsAccessibleForFree isAccessibleForFree) {
	...
	public RESIDENCE(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public RESIDENCE(MainEntityOfPage mainEntityOfPage) {
	...
	public RESIDENCE(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public RESIDENCE(NameFuzzy nameFuzzy) {
	...
	public RESIDENCE(NameRuby nameRuby) {
	...
	public RESIDENCE(OpeningHoursSpecification openingHoursSpecification) {
	...
	public RESIDENCE(PotentialAction potentialAction) {
	...
	public RESIDENCE(PublicAccess publicAccess) {
	...
	public RESIDENCE(Review review) {
		setReview(review);
	}
	...
	public RESIDENCE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RESIDENCE(SmokingAllowed smokingAllowed) {
	...
	public RESIDENCE(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public RESIDENCE(SubjectOf subjectOf) {
	...
	public RESIDENCE(Telephone telephone) {
	...
	public void copy(Clazz.Residence org) {
		setSeq(org.getSeq());
