...
public class ENGINE_DISPLACEMENT implements Container.EngineDisplacement {
	...
	public ENGINE_DISPLACEMENT(String string) {
	...
	public ENGINE_DISPLACEMENT(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public ENGINE_DISPLACEMENT(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public ENGINE_DISPLACEMENT(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public ENGINE_DISPLACEMENT(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.EngineDisplacement org) {
