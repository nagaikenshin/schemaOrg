...
public class ACCELERATION_TIME implements Container.AccelerationTime {
	...
	public ACCELERATION_TIME(String string) {
	...
	public ACCELERATION_TIME(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public ACCELERATION_TIME(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public ACCELERATION_TIME(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public ACCELERATION_TIME(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.AccelerationTime org) {
