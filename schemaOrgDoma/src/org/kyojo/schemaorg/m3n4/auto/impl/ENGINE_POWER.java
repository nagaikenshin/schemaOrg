...
public class ENGINE_POWER implements Container.EnginePower {
	...
	public ENGINE_POWER(String string) {
	...
	public ENGINE_POWER(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public ENGINE_POWER(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public ENGINE_POWER(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public ENGINE_POWER(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.EnginePower org) {
