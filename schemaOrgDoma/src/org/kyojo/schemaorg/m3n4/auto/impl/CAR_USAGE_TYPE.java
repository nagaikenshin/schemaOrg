...
public class CAR_USAGE_TYPE implements Clazz.CarUsageType {
	...
	public CAR_USAGE_TYPE() {
	}

	public CAR_USAGE_TYPE(Long seq) {
		setSeq(seq);
	}

	public CAR_USAGE_TYPE(String string) {
	...
	public CAR_USAGE_TYPE(AdditionalProperty additionalProperty) {
	...
	public CAR_USAGE_TYPE(AdditionalType additionalType) {
	...
	public CAR_USAGE_TYPE(AlternateName alternateName) {
	...
	public CAR_USAGE_TYPE(Description description) {
	...
	public CAR_USAGE_TYPE(DisambiguatingDescription disambiguatingDescription) {
	...
	public CAR_USAGE_TYPE(Equal equal) {
		setEqual(equal);
	}
	...
	public CAR_USAGE_TYPE(Greater greater) {
		setGreater(greater);
	}
	...
	public CAR_USAGE_TYPE(GreaterOrEqual greaterOrEqual) {
	...
	public CAR_USAGE_TYPE(Identifier identifier) {
	...
	public CAR_USAGE_TYPE(Image image) {
		setImage(image);
	}
	...
	public CAR_USAGE_TYPE(Lesser lesser) {
		setLesser(lesser);
	}
	...
	public CAR_USAGE_TYPE(LesserOrEqual lesserOrEqual) {
	...
	public CAR_USAGE_TYPE(MainEntityOfPage mainEntityOfPage) {
	...
	public CAR_USAGE_TYPE(Name name) {
		setName(name);
	}
	...
	public CAR_USAGE_TYPE(NameFuzzy nameFuzzy) {
	...
	public CAR_USAGE_TYPE(NameRuby nameRuby) {
	...
	public CAR_USAGE_TYPE(NonEqual nonEqual) {
	...
	public CAR_USAGE_TYPE(PotentialAction potentialAction) {
	...
	public CAR_USAGE_TYPE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CAR_USAGE_TYPE(SubjectOf subjectOf) {
	...
	public CAR_USAGE_TYPE(SupersededBy supersededBy) {
	...
	public CAR_USAGE_TYPE(ValueReference valueReference) {
	...
	public void copy(Clazz.CarUsageType org) {
		setSeq(org.getSeq());
