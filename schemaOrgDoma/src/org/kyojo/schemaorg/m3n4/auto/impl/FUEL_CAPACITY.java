...
public class FUEL_CAPACITY implements Container.FuelCapacity {
	...
	public FUEL_CAPACITY(String string) {
	...
	public FUEL_CAPACITY(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public FUEL_CAPACITY(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public FUEL_CAPACITY(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public FUEL_CAPACITY(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.FuelCapacity org) {
