...
public class SPEED implements Container.Speed {
	...
	public SPEED(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public SPEED(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public SPEED(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public SPEED(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.Speed org) {
