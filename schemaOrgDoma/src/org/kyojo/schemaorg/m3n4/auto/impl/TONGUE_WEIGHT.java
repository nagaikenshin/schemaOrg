...
public class TONGUE_WEIGHT implements Container.TongueWeight {
	...
	public TONGUE_WEIGHT(String string) {
	...
	public TONGUE_WEIGHT(MonetaryAmountDistribution monetaryAmountDistribution) {
	...
	public TONGUE_WEIGHT(QuantitativeValue quantitativeValue) {
		quantitativeValueList = new ArrayList<QuantitativeValue>();
	...
	public TONGUE_WEIGHT(QuantitativeValueDistribution quantitativeValueDistribution) {
	...
	public TONGUE_WEIGHT(List<MonetaryAmountDistribution> monetaryAmountDistributionList,
	...
	public void copy(Container.TongueWeight org) {
