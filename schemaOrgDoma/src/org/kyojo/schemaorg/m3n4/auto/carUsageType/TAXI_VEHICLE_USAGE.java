...
public class TAXI_VEHICLE_USAGE implements CarUsageType.TaxiVehicleUsage {
	...
	public TAXI_VEHICLE_USAGE() {
	}

	public TAXI_VEHICLE_USAGE(Long seq) {
		setSeq(seq);
	}

	public TAXI_VEHICLE_USAGE(String string) {
	...
	public TAXI_VEHICLE_USAGE(AdditionalProperty additionalProperty) {
	...
	public TAXI_VEHICLE_USAGE(AdditionalType additionalType) {
	...
	public TAXI_VEHICLE_USAGE(AlternateName alternateName) {
	...
	public TAXI_VEHICLE_USAGE(Description description) {
	...
	public TAXI_VEHICLE_USAGE(DisambiguatingDescription disambiguatingDescription) {
	...
	public TAXI_VEHICLE_USAGE(Equal equal) {
		setEqual(equal);
	}
	...
	public TAXI_VEHICLE_USAGE(Greater greater) {
		setGreater(greater);
	}
	...
	public TAXI_VEHICLE_USAGE(GreaterOrEqual greaterOrEqual) {
	...
	public TAXI_VEHICLE_USAGE(Identifier identifier) {
	...
	public TAXI_VEHICLE_USAGE(Image image) {
		setImage(image);
	}
	...
	public TAXI_VEHICLE_USAGE(Lesser lesser) {
		setLesser(lesser);
	}
	...
	public TAXI_VEHICLE_USAGE(LesserOrEqual lesserOrEqual) {
	...
	public TAXI_VEHICLE_USAGE(MainEntityOfPage mainEntityOfPage) {
	...
	public TAXI_VEHICLE_USAGE(Name name) {
		setName(name);
	}
	...
	public TAXI_VEHICLE_USAGE(NameFuzzy nameFuzzy) {
	...
	public TAXI_VEHICLE_USAGE(NameRuby nameRuby) {
	...
	public TAXI_VEHICLE_USAGE(NonEqual nonEqual) {
	...
	public TAXI_VEHICLE_USAGE(PotentialAction potentialAction) {
	...
	public TAXI_VEHICLE_USAGE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TAXI_VEHICLE_USAGE(SubjectOf subjectOf) {
	...
	public TAXI_VEHICLE_USAGE(SupersededBy supersededBy) {
	...
	public TAXI_VEHICLE_USAGE(Url url) {
		setUrl(url);
	}
	...
	public TAXI_VEHICLE_USAGE(ValueReference valueReference) {
	...
	public void copy(CarUsageType.TaxiVehicleUsage org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return CarUsageType.TaxiVehicleUsage.class.getAnnotation(SampleValue.class).value();
	}
