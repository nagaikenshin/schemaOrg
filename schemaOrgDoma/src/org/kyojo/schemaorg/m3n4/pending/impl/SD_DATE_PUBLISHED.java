...
public class SD_DATE_PUBLISHED implements Container.SdDatePublished {
	...
	public SD_DATE_PUBLISHED(java.util.Date date) {
		this(new DATE(date));
	}

	public SD_DATE_PUBLISHED(java.time.LocalDate date) {
		this(new DATE(date));
	}

	public SD_DATE_PUBLISHED(Date date) {
