...
public class PERCENTILE75 implements Container.Percentile75 {
	...
	public PERCENTILE75(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public PERCENTILE75(Float fl0at) {
	...
	public PERCENTILE75(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public PERCENTILE75(Integer integer) {
	...
	public PERCENTILE75(List<Float> fl0atList,
	...
	public void copy(Container.Percentile75 org) {
