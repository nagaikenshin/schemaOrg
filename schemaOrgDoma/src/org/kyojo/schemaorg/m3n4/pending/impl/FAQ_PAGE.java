...
public class FAQ_PAGE implements Clazz.FAQPage {
	...
	public FAQ_PAGE(Long seq) {
		setSeq(seq);
	}

	public FAQ_PAGE(String string) {
	...
	public FAQ_PAGE(AccessMode accessMode) {
	...
	public FAQ_PAGE(AccessModeSufficient accessModeSufficient) {
	...
	public FAQ_PAGE(AccessibilityAPI accessibilityAPI) {
	...
	public FAQ_PAGE(AccessibilityControl accessibilityControl) {
	...
	public FAQ_PAGE(AccessibilityFeature accessibilityFeature) {
	...
	public FAQ_PAGE(AccessibilityHazard accessibilityHazard) {
	...
	public FAQ_PAGE(AccessibilitySummary accessibilitySummary) {
	...
	public FAQ_PAGE(AccountablePerson accountablePerson) {
	...
	public FAQ_PAGE(AdditionalType additionalType) {
	...
	public FAQ_PAGE(AggregateRating aggregateRating) {
	...
	public FAQ_PAGE(AlternateName alternateName) {
	...
	public FAQ_PAGE(AlternativeHeadline alternativeHeadline) {
	...
	public FAQ_PAGE(AssociatedMedia associatedMedia) {
	...
	public FAQ_PAGE(Audience audience) {
	...
	public FAQ_PAGE(Breadcrumb breadcrumb) {
	...
	public FAQ_PAGE(Character character) {
	...
	public FAQ_PAGE(Citation citation) {
	...
	public FAQ_PAGE(Comment comment) {
		setComment(comment);
	}
	...
	public FAQ_PAGE(CommentCount commentCount) {
	...
	public FAQ_PAGE(ContentLocation contentLocation) {
	...
	public FAQ_PAGE(ContentRating contentRating) {
	...
	public FAQ_PAGE(ContentReferenceTime contentReferenceTime) {
	...
	public FAQ_PAGE(Contributor contributor) {
	...
	public FAQ_PAGE(CopyrightHolder copyrightHolder) {
	...
	public FAQ_PAGE(CopyrightYear copyrightYear) {
	...
	public FAQ_PAGE(Correction correction) {
	...
	public FAQ_PAGE(Creator creator) {
		setCreator(creator);
	}
	...
	public FAQ_PAGE(DateCreated dateCreated) {
	...
	public FAQ_PAGE(DateModified dateModified) {
	...
	public FAQ_PAGE(DatePublished datePublished) {
	...
	public FAQ_PAGE(Description description) {
	...
	public FAQ_PAGE(DisambiguatingDescription disambiguatingDescription) {
	...
	public FAQ_PAGE(DiscussionUrl discussionUrl) {
	...
	public FAQ_PAGE(EducationalAlignment educationalAlignment) {
	...
	public FAQ_PAGE(EducationalUse educationalUse) {
	...
	public FAQ_PAGE(Encoding encoding) {
	...
	public FAQ_PAGE(EncodingFormat encodingFormat) {
	...
	public FAQ_PAGE(ExampleOfWork exampleOfWork) {
	...
	public FAQ_PAGE(Expires expires) {
		setExpires(expires);
	}
	...
	public FAQ_PAGE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public FAQ_PAGE(Headline headline) {
	...
	public FAQ_PAGE(Identifier identifier) {
	...
	public FAQ_PAGE(InLanguage inLanguage) {
	...
	public FAQ_PAGE(InteractionStatistic interactionStatistic) {
	...
	public FAQ_PAGE(InteractivityType interactivityType) {
	...
	public FAQ_PAGE(IsAccessibleForFree isAccessibleForFree) {
	...
	public FAQ_PAGE(IsBasedOn isBasedOn) {
	...
	public FAQ_PAGE(IsFamilyFriendly isFamilyFriendly) {
	...
	public FAQ_PAGE(IsPartOf isPartOf) {
	...
	public FAQ_PAGE(Keywords keywords) {
	...
	public FAQ_PAGE(LastReviewed lastReviewed) {
	...
	public FAQ_PAGE(LearningResourceType learningResourceType) {
	...
	public FAQ_PAGE(License license) {
		setLicense(license);
	}
	...
	public FAQ_PAGE(LocationCreated locationCreated) {
	...
	public FAQ_PAGE(MainContentOfPage mainContentOfPage) {
	...
	public FAQ_PAGE(MainEntity mainEntity) {
	...
	public FAQ_PAGE(MainEntityOfPage mainEntityOfPage) {
	...
	public FAQ_PAGE(Material material) {
	...
	public FAQ_PAGE(Mentions mentions) {
	...
	public FAQ_PAGE(NameFuzzy nameFuzzy) {
	...
	public FAQ_PAGE(NameRuby nameRuby) {
	...
	public FAQ_PAGE(Position position) {
	...
	public FAQ_PAGE(PotentialAction potentialAction) {
	...
	public FAQ_PAGE(PrimaryImageOfPage primaryImageOfPage) {
	...
	public FAQ_PAGE(Producer producer) {
	...
	public FAQ_PAGE(Provider provider) {
	...
	public FAQ_PAGE(Publication publication) {
	...
	public FAQ_PAGE(Publisher publisher) {
	...
	public FAQ_PAGE(PublisherImprint publisherImprint) {
	...
	public FAQ_PAGE(PublishingPrinciples publishingPrinciples) {
	...
	public FAQ_PAGE(RecordedAt recordedAt) {
	...
	public FAQ_PAGE(RelatedLink relatedLink) {
	...
	public FAQ_PAGE(ReleasedEvent releasedEvent) {
	...
	public FAQ_PAGE(ReviewedBy reviewedBy) {
	...
	public FAQ_PAGE(SchemaVersion schemaVersion) {
	...
	public FAQ_PAGE(SdDatePublished sdDatePublished) {
	...
	public FAQ_PAGE(SdLicense sdLicense) {
	...
	public FAQ_PAGE(SdPublisher sdPublisher) {
	...
	public FAQ_PAGE(SignificantLink significantLink) {
	...
	public FAQ_PAGE(SourceOrganization sourceOrganization) {
	...
	public FAQ_PAGE(SpatialCoverage spatialCoverage) {
	...
	public FAQ_PAGE(Speakable speakable) {
	...
	public FAQ_PAGE(Specialty specialty) {
	...
	public FAQ_PAGE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public FAQ_PAGE(SubjectOf subjectOf) {
	...
	public FAQ_PAGE(TemporalCoverage temporalCoverage) {
	...
	public FAQ_PAGE(ThumbnailUrl thumbnailUrl) {
	...
	public FAQ_PAGE(TimeRequired timeRequired) {
	...
	public FAQ_PAGE(TranslationOfWork translationOfWork) {
	...
	public FAQ_PAGE(Translator translator) {
	...
	public FAQ_PAGE(TypicalAgeRange typicalAgeRange) {
	...
	public FAQ_PAGE(Version version) {
		setVersion(version);
	}
	...
	public FAQ_PAGE(WorkExample workExample) {
	...
	public FAQ_PAGE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.FAQPage org) {
		setSeq(org.getSeq());
