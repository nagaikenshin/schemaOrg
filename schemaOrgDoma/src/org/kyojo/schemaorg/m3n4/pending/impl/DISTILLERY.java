...
public class DISTILLERY implements Clazz.Distillery {
	...
	public DISTILLERY(Long seq) {
		setSeq(seq);
	}

	public DISTILLERY(String string) {
	...
	public DISTILLERY(AcceptsReservations acceptsReservations) {
	...
	public DISTILLERY(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public DISTILLERY(AdditionalProperty additionalProperty) {
	...
	public DISTILLERY(AdditionalType additionalType) {
	...
	public DISTILLERY(Address address) {
		setAddress(address);
	}
	...
	public DISTILLERY(AggregateRating aggregateRating) {
	...
	public DISTILLERY(AlternateName alternateName) {
	...
	public DISTILLERY(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public DISTILLERY(AmenityFeature amenityFeature) {
	...
	public DISTILLERY(AreaServed areaServed) {
	...
	public DISTILLERY(BranchCode branchCode) {
	...
	public DISTILLERY(ContactPoint contactPoint) {
	...
	public DISTILLERY(ContainedInPlace containedInPlace) {
	...
	public DISTILLERY(ContainsPlace containsPlace) {
	...
	public DISTILLERY(CorrectionsPolicy correctionsPolicy) {
	...
	public DISTILLERY(CurrenciesAccepted currenciesAccepted) {
	...
	public DISTILLERY(Department department) {
	...
	public DISTILLERY(Description description) {
	...
	public DISTILLERY(DisambiguatingDescription disambiguatingDescription) {
	...
	public DISTILLERY(DissolutionDate dissolutionDate) {
	...
	public DISTILLERY(DiversityPolicy diversityPolicy) {
	...
	public DISTILLERY(DiversityStaffingReport diversityStaffingReport) {
	...
	public DISTILLERY(Employee employee) {
	...
	public DISTILLERY(EthicsPolicy ethicsPolicy) {
	...
	public DISTILLERY(FaxNumber faxNumber) {
	...
	public DISTILLERY(Founder founder) {
		setFounder(founder);
	}
	...
	public DISTILLERY(FoundingDate foundingDate) {
	...
	public DISTILLERY(FoundingLocation foundingLocation) {
	...
	public DISTILLERY(Funder funder) {
		setFunder(funder);
	}
	...
	public DISTILLERY(GeospatiallyContains geospatiallyContains) {
	...
	public DISTILLERY(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public DISTILLERY(GeospatiallyCovers geospatiallyCovers) {
	...
	public DISTILLERY(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public DISTILLERY(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public DISTILLERY(GeospatiallyEquals geospatiallyEquals) {
	...
	public DISTILLERY(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public DISTILLERY(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public DISTILLERY(GeospatiallyTouches geospatiallyTouches) {
	...
	public DISTILLERY(GeospatiallyWithin geospatiallyWithin) {
	...
	public DISTILLERY(GlobalLocationNumber globalLocationNumber) {
	...
	public DISTILLERY(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public DISTILLERY(HasMenu hasMenu) {
		setHasMenu(hasMenu);
	}
	...
	public DISTILLERY(HasOfferCatalog hasOfferCatalog) {
	...
	public DISTILLERY(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public DISTILLERY(Identifier identifier) {
	...
	public DISTILLERY(IsAccessibleForFree isAccessibleForFree) {
	...
	public DISTILLERY(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public DISTILLERY(KnowsAbout knowsAbout) {
	...
	public DISTILLERY(KnowsLanguage knowsLanguage) {
	...
	public DISTILLERY(LegalName legalName) {
	...
	public DISTILLERY(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public DISTILLERY(Location location) {
	...
	public DISTILLERY(MainEntityOfPage mainEntityOfPage) {
	...
	public DISTILLERY(MakesOffer makesOffer) {
	...
	public DISTILLERY(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public DISTILLERY(Member member) {
		setMember(member);
	}
	...
	public DISTILLERY(MemberOf memberOf) {
	...
	public DISTILLERY(NameFuzzy nameFuzzy) {
	...
	public DISTILLERY(NameRuby nameRuby) {
	...
	public DISTILLERY(NumberOfEmployees numberOfEmployees) {
	...
	public DISTILLERY(OpeningHours openingHours) {
	...
	public DISTILLERY(OpeningHoursSpecification openingHoursSpecification) {
	...
	public DISTILLERY(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public DISTILLERY(ParentOrganization parentOrganization) {
	...
	public DISTILLERY(PaymentAccepted paymentAccepted) {
	...
	public DISTILLERY(PotentialAction potentialAction) {
	...
	public DISTILLERY(PriceRange priceRange) {
	...
	public DISTILLERY(PublicAccess publicAccess) {
	...
	public DISTILLERY(PublishingPrinciples publishingPrinciples) {
	...
	public DISTILLERY(Review review) {
		setReview(review);
	}
	...
	public DISTILLERY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DISTILLERY(ServesCuisine servesCuisine) {
	...
	public DISTILLERY(SmokingAllowed smokingAllowed) {
	...
	public DISTILLERY(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public DISTILLERY(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public DISTILLERY(StarRating starRating) {
	...
	public DISTILLERY(SubOrganization subOrganization) {
	...
	public DISTILLERY(SubjectOf subjectOf) {
	...
	public DISTILLERY(Telephone telephone) {
	...
	public DISTILLERY(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Distillery org) {
		setSeq(org.getSeq());
