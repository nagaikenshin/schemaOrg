...
public class IN_DEFINED_TERM_SET implements Container.InDefinedTermSet {
	...
	public IN_DEFINED_TERM_SET(BusTrip busTrip) {
	...
	public IN_DEFINED_TERM_SET(Flight flight) {
	...
	public IN_DEFINED_TERM_SET(TouristTrip touristTrip) {
	...
	public IN_DEFINED_TERM_SET(TrainTrip trainTrip) {
