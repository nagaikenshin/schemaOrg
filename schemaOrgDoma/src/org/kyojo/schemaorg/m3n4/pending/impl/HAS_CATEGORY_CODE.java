...
public class HAS_CATEGORY_CODE implements Container.HasCategoryCode {
	...
	public HAS_CATEGORY_CODE(BusTrip busTrip) {
	...
	public HAS_CATEGORY_CODE(Flight flight) {
	...
	public HAS_CATEGORY_CODE(TouristTrip touristTrip) {
	...
	public HAS_CATEGORY_CODE(TrainTrip trainTrip) {
