...
public class PUBLIC_TOILET implements Clazz.PublicToilet {
	...
	public PUBLIC_TOILET(GeospatiallyContains geospatiallyContains) {
	...
	public PUBLIC_TOILET(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public PUBLIC_TOILET(GeospatiallyCovers geospatiallyCovers) {
	...
	public PUBLIC_TOILET(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public PUBLIC_TOILET(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public PUBLIC_TOILET(GeospatiallyEquals geospatiallyEquals) {
	...
	public PUBLIC_TOILET(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public PUBLIC_TOILET(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public PUBLIC_TOILET(GeospatiallyTouches geospatiallyTouches) {
	...
	public PUBLIC_TOILET(GeospatiallyWithin geospatiallyWithin) {
