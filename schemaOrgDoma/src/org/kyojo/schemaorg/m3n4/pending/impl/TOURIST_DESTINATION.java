...
public class TOURIST_DESTINATION implements Clazz.TouristDestination {
	...
	public TOURIST_DESTINATION(GeospatiallyContains geospatiallyContains) {
	...
	public TOURIST_DESTINATION(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public TOURIST_DESTINATION(GeospatiallyCovers geospatiallyCovers) {
	...
	public TOURIST_DESTINATION(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public TOURIST_DESTINATION(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public TOURIST_DESTINATION(GeospatiallyEquals geospatiallyEquals) {
	...
	public TOURIST_DESTINATION(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public TOURIST_DESTINATION(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public TOURIST_DESTINATION(GeospatiallyTouches geospatiallyTouches) {
	...
	public TOURIST_DESTINATION(GeospatiallyWithin geospatiallyWithin) {
