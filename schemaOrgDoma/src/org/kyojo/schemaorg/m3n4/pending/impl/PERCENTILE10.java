...
public class PERCENTILE10 implements Container.Percentile10 {
	...
	public PERCENTILE10(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public PERCENTILE10(Float fl0at) {
	...
	public PERCENTILE10(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public PERCENTILE10(Integer integer) {
	...
	public PERCENTILE10(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public PERCENTILE10(Number number) {
	...
	public PERCENTILE10(List<Float> fl0atList,
	...
	public void copy(Container.Percentile10 org) {
