...
public class ORDER_IN_TRANSIT implements OrderStatus.OrderInTransit {
	...
	public ORDER_IN_TRANSIT() {
	}

	public ORDER_IN_TRANSIT(Long seq) {
		setSeq(seq);
	}

	public ORDER_IN_TRANSIT(String string) {
	...
	public ORDER_IN_TRANSIT(AdditionalType additionalType) {
	...
	public ORDER_IN_TRANSIT(AlternateName alternateName) {
	...
	public ORDER_IN_TRANSIT(Description description) {
	...
	public ORDER_IN_TRANSIT(DisambiguatingDescription disambiguatingDescription) {
	...
	public ORDER_IN_TRANSIT(Identifier identifier) {
	...
	public ORDER_IN_TRANSIT(Image image) {
		setImage(image);
	}
	...
	public ORDER_IN_TRANSIT(MainEntityOfPage mainEntityOfPage) {
	...
	public ORDER_IN_TRANSIT(Name name) {
		setName(name);
	}
	...
	public ORDER_IN_TRANSIT(NameFuzzy nameFuzzy) {
	...
	public ORDER_IN_TRANSIT(NameRuby nameRuby) {
	...
	public ORDER_IN_TRANSIT(PotentialAction potentialAction) {
	...
	public ORDER_IN_TRANSIT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ORDER_IN_TRANSIT(SubjectOf subjectOf) {
	...
	public ORDER_IN_TRANSIT(SupersededBy supersededBy) {
	...
	public ORDER_IN_TRANSIT(Url url) {
		setUrl(url);
	}
	...
	public void copy(OrderStatus.OrderInTransit org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return OrderStatus.OrderInTransit.class.getAnnotation(SampleValue.class).value();
	}
