...
public class ORDER_RETURNED implements OrderStatus.OrderReturned {
	...
	public ORDER_RETURNED() {
	}

	public ORDER_RETURNED(Long seq) {
		setSeq(seq);
	}

	public ORDER_RETURNED(String string) {
	...
	public ORDER_RETURNED(AdditionalType additionalType) {
	...
	public ORDER_RETURNED(AlternateName alternateName) {
	...
	public ORDER_RETURNED(Description description) {
	...
	public ORDER_RETURNED(DisambiguatingDescription disambiguatingDescription) {
	...
	public ORDER_RETURNED(Identifier identifier) {
	...
	public ORDER_RETURNED(Image image) {
		setImage(image);
	}
	...
	public ORDER_RETURNED(MainEntityOfPage mainEntityOfPage) {
	...
	public ORDER_RETURNED(Name name) {
		setName(name);
	}
	...
	public ORDER_RETURNED(NameFuzzy nameFuzzy) {
	...
	public ORDER_RETURNED(NameRuby nameRuby) {
	...
	public ORDER_RETURNED(PotentialAction potentialAction) {
	...
	public ORDER_RETURNED(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ORDER_RETURNED(SubjectOf subjectOf) {
	...
	public ORDER_RETURNED(SupersededBy supersededBy) {
	...
	public void copy(OrderStatus.OrderReturned org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return OrderStatus.OrderReturned.class.getAnnotation(SampleValue.class).value();
	}
