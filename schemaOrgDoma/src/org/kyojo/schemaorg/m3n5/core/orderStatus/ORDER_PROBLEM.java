...
public class ORDER_PROBLEM implements OrderStatus.OrderProblem {
	...
	public ORDER_PROBLEM() {
	}

	public ORDER_PROBLEM(Long seq) {
		setSeq(seq);
	}

	public ORDER_PROBLEM(String string) {
	...
	public ORDER_PROBLEM(AdditionalType additionalType) {
	...
	public ORDER_PROBLEM(AlternateName alternateName) {
	...
	public ORDER_PROBLEM(Description description) {
	...
	public ORDER_PROBLEM(DisambiguatingDescription disambiguatingDescription) {
	...
	public ORDER_PROBLEM(Identifier identifier) {
	...
	public ORDER_PROBLEM(Image image) {
		setImage(image);
	}
	...
	public ORDER_PROBLEM(MainEntityOfPage mainEntityOfPage) {
	...
	public ORDER_PROBLEM(Name name) {
		setName(name);
	}
	...
	public ORDER_PROBLEM(NameFuzzy nameFuzzy) {
	...
	public ORDER_PROBLEM(NameRuby nameRuby) {
	...
	public ORDER_PROBLEM(PotentialAction potentialAction) {
	...
	public ORDER_PROBLEM(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ORDER_PROBLEM(SubjectOf subjectOf) {
	...
	public ORDER_PROBLEM(SupersededBy supersededBy) {
	...
	public void copy(OrderStatus.OrderProblem org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return OrderStatus.OrderProblem.class.getAnnotation(SampleValue.class).value();
	}
