...
public class ORDER_DELIVERED implements OrderStatus.OrderDelivered {
	...
	public ORDER_DELIVERED(Long seq) {
		setSeq(seq);
	}

	public ORDER_DELIVERED(String string) {
	...
	public ORDER_DELIVERED(AdditionalType additionalType) {
	...
	public ORDER_DELIVERED(AlternateName alternateName) {
	...
	public ORDER_DELIVERED(Description description) {
	...
	public ORDER_DELIVERED(DisambiguatingDescription disambiguatingDescription) {
	...
	public ORDER_DELIVERED(Identifier identifier) {
	...
	public ORDER_DELIVERED(Image image) {
		setImage(image);
	}
	...
	public ORDER_DELIVERED(MainEntityOfPage mainEntityOfPage) {
	...
	public ORDER_DELIVERED(Name name) {
		setName(name);
	}
	...
	public ORDER_DELIVERED(NameFuzzy nameFuzzy) {
	...
	public ORDER_DELIVERED(NameRuby nameRuby) {
	...
	public ORDER_DELIVERED(PotentialAction potentialAction) {
	...
	public ORDER_DELIVERED(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ORDER_DELIVERED(SubjectOf subjectOf) {
	...
	public ORDER_DELIVERED(SupersededBy supersededBy) {
	...
	public ORDER_DELIVERED(Url url) {
		setUrl(url);
	}
	...
	public void copy(OrderStatus.OrderDelivered org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return OrderStatus.OrderDelivered.class.getAnnotation(SampleValue.class).value();
	}
