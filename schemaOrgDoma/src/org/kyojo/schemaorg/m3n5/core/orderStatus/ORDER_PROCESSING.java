...
public class ORDER_PROCESSING implements OrderStatus.OrderProcessing {
	...
	public ORDER_PROCESSING(Long seq) {
		setSeq(seq);
	}

	public ORDER_PROCESSING(String string) {
	...
	public ORDER_PROCESSING(AdditionalType additionalType) {
	...
	public ORDER_PROCESSING(AlternateName alternateName) {
	...
	public ORDER_PROCESSING(Description description) {
	...
	public ORDER_PROCESSING(DisambiguatingDescription disambiguatingDescription) {
	...
	public ORDER_PROCESSING(Identifier identifier) {
	...
	public ORDER_PROCESSING(Image image) {
		setImage(image);
	}
	...
	public ORDER_PROCESSING(MainEntityOfPage mainEntityOfPage) {
	...
	public ORDER_PROCESSING(Name name) {
		setName(name);
	}
	...
	public ORDER_PROCESSING(NameFuzzy nameFuzzy) {
	...
	public ORDER_PROCESSING(NameRuby nameRuby) {
	...
	public ORDER_PROCESSING(PotentialAction potentialAction) {
	...
	public ORDER_PROCESSING(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ORDER_PROCESSING(SubjectOf subjectOf) {
	...
	public ORDER_PROCESSING(SupersededBy supersededBy) {
	...
	public ORDER_PROCESSING(Url url) {
		setUrl(url);
	}
	...
	public void copy(OrderStatus.OrderProcessing org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return OrderStatus.OrderProcessing.class.getAnnotation(SampleValue.class).value();
	}
