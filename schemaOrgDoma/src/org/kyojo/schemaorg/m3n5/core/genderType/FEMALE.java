package org.kyojo.schemaorg.m3n5.core.genderType;
...
import org.kyojo.schemaorg.m3n5.core.GenderType;
...
public class FEMALE implements GenderType.Female {
	...
	public FEMALE(Long seq) {
		setSeq(seq);
	}

	public FEMALE(String string) {
	...
	public FEMALE(AdditionalType additionalType) {
	...
	public FEMALE(AlternateName alternateName) {
	...
	public FEMALE(Description description) {
	...
	public FEMALE(DisambiguatingDescription disambiguatingDescription) {
	...
	public FEMALE(Identifier identifier) {
	...
	public FEMALE(MainEntityOfPage mainEntityOfPage) {
	...
	public FEMALE(NameFuzzy nameFuzzy) {
	...
	public FEMALE(NameRuby nameRuby) {
	...
	public FEMALE(PotentialAction potentialAction) {
	...
	public FEMALE(SubjectOf subjectOf) {
	...
	public FEMALE(SupersededBy supersededBy) {
	...
	public void copy(GenderType.Female org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return GenderType.Female.class.getAnnotation(SampleValue.class).value();
	}
