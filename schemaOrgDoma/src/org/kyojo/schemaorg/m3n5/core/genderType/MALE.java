...
public class MALE implements GenderType.Male {
	...
	public MALE(Long seq) {
		setSeq(seq);
	}

	public MALE(String string) {
	...
	public MALE(AdditionalType additionalType) {
	...
	public MALE(AlternateName alternateName) {
	...
	public MALE(Description description) {
	...
	public MALE(DisambiguatingDescription disambiguatingDescription) {
	...
	public MALE(Identifier identifier) {
	...
	public MALE(MainEntityOfPage mainEntityOfPage) {
	...
	public MALE(NameFuzzy nameFuzzy) {
	...
	public MALE(PotentialAction potentialAction) {
	...
	public MALE(SubjectOf subjectOf) {
	...
	public MALE(SupersededBy supersededBy) {
	...
	public void copy(GenderType.Male org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return GenderType.Male.class.getAnnotation(SampleValue.class).value();
	}
