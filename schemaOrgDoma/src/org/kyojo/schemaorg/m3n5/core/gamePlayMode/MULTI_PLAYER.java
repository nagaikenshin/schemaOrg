...
public class MULTI_PLAYER implements GamePlayMode.MultiPlayer {
	...
	public MULTI_PLAYER(Long seq) {
		setSeq(seq);
	}

	public MULTI_PLAYER(String string) {
	...
	public MULTI_PLAYER(AdditionalType additionalType) {
	...
	public MULTI_PLAYER(AlternateName alternateName) {
	...
	public MULTI_PLAYER(Description description) {
	...
	public MULTI_PLAYER(DisambiguatingDescription disambiguatingDescription) {
	...
	public MULTI_PLAYER(Identifier identifier) {
	...
	public MULTI_PLAYER(Image image) {
		setImage(image);
	}
	...
	public MULTI_PLAYER(MainEntityOfPage mainEntityOfPage) {
	...
	public MULTI_PLAYER(NameFuzzy nameFuzzy) {
	...
	public MULTI_PLAYER(NameRuby nameRuby) {
	...
	public MULTI_PLAYER(PotentialAction potentialAction) {
	...
	public MULTI_PLAYER(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MULTI_PLAYER(SubjectOf subjectOf) {
	...
	public MULTI_PLAYER(SupersededBy supersededBy) {
	...
	public void copy(GamePlayMode.MultiPlayer org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return GamePlayMode.MultiPlayer.class.getAnnotation(SampleValue.class).value();
	}
