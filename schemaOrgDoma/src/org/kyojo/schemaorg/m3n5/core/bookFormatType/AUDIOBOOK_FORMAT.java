package org.kyojo.schemaorg.m3n5.core.bookFormatType;
...
import org.kyojo.schemaorg.m3n5.core.BookFormatType;
...
public class AUDIOBOOK_FORMAT implements BookFormatType.AudiobookFormat {
	...
	public AUDIOBOOK_FORMAT() {
	}

	public AUDIOBOOK_FORMAT(Long seq) {
		setSeq(seq);
	}

	public AUDIOBOOK_FORMAT(String string) {
	...
	public AUDIOBOOK_FORMAT(AdditionalType additionalType) {
	...
	public AUDIOBOOK_FORMAT(AlternateName alternateName) {
	...
	public AUDIOBOOK_FORMAT(Description description) {
	...
	public AUDIOBOOK_FORMAT(DisambiguatingDescription disambiguatingDescription) {
	...
	public AUDIOBOOK_FORMAT(Identifier identifier) {
	...
	public AUDIOBOOK_FORMAT(Image image) {
		setImage(image);
	}
	...
	public AUDIOBOOK_FORMAT(MainEntityOfPage mainEntityOfPage) {
	...
	public AUDIOBOOK_FORMAT(Name name) {
		setName(name);
	}
	...
	public AUDIOBOOK_FORMAT(NameFuzzy nameFuzzy) {
	...
	public AUDIOBOOK_FORMAT(NameRuby nameRuby) {
	...
	public AUDIOBOOK_FORMAT(PotentialAction potentialAction) {
	...
	public AUDIOBOOK_FORMAT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public AUDIOBOOK_FORMAT(SubjectOf subjectOf) {
	...
	public AUDIOBOOK_FORMAT(SupersededBy supersededBy) {
	...
	public AUDIOBOOK_FORMAT(Url url) {
		setUrl(url);
	}
	...
	public void copy(BookFormatType.AudiobookFormat org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return BookFormatType.AudiobookFormat.class.getAnnotation(SampleValue.class).value();
	}
