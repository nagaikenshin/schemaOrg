...
public class E_BOOK implements BookFormatType.EBook {
	...
	public E_BOOK(Long seq) {
		setSeq(seq);
	}

	public E_BOOK(String string) {
	...
	public E_BOOK(AdditionalType additionalType) {
	...
	public E_BOOK(AlternateName alternateName) {
	...
	public E_BOOK(Description description) {
	...
	public E_BOOK(DisambiguatingDescription disambiguatingDescription) {
	...
	public E_BOOK(Identifier identifier) {
	...
	public E_BOOK(MainEntityOfPage mainEntityOfPage) {
	...
	public E_BOOK(NameFuzzy nameFuzzy) {
	...
	public E_BOOK(NameRuby nameRuby) {
	...
	public E_BOOK(PotentialAction potentialAction) {
	...
	public E_BOOK(SubjectOf subjectOf) {
	...
	public E_BOOK(SupersededBy supersededBy) {
	...
	public void copy(BookFormatType.EBook org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return BookFormatType.EBook.class.getAnnotation(SampleValue.class).value();
	}
