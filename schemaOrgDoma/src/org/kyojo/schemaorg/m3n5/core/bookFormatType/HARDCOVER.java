...
public class HARDCOVER implements BookFormatType.Hardcover {
	...
	public HARDCOVER(Long seq) {
		setSeq(seq);
	}

	public HARDCOVER(String string) {
	...
	public HARDCOVER(AdditionalType additionalType) {
	...
	public HARDCOVER(AlternateName alternateName) {
	...
	public HARDCOVER(Description description) {
	...
	public HARDCOVER(DisambiguatingDescription disambiguatingDescription) {
	...
	public HARDCOVER(Identifier identifier) {
	...
	public HARDCOVER(MainEntityOfPage mainEntityOfPage) {
	...
	public HARDCOVER(NameFuzzy nameFuzzy) {
	...
	public HARDCOVER(NameRuby nameRuby) {
	...
	public HARDCOVER(PotentialAction potentialAction) {
	...
	public HARDCOVER(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public HARDCOVER(SubjectOf subjectOf) {
	...
	public HARDCOVER(SupersededBy supersededBy) {
	...
	public void copy(BookFormatType.Hardcover org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return BookFormatType.Hardcover.class.getAnnotation(SampleValue.class).value();
	}
