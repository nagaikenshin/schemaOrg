...
public class PAPERBACK implements BookFormatType.Paperback {
	...
	public PAPERBACK(AdditionalType additionalType) {
	...
	public PAPERBACK(AlternateName alternateName) {
	...
	public PAPERBACK(Description description) {
	...
	public PAPERBACK(DisambiguatingDescription disambiguatingDescription) {
	...
	public PAPERBACK(Identifier identifier) {
	...
	public PAPERBACK(MainEntityOfPage mainEntityOfPage) {
	...
	public PAPERBACK(NameFuzzy nameFuzzy) {
	...
	public PAPERBACK(NameRuby nameRuby) {
	...
	public PAPERBACK(PotentialAction potentialAction) {
	...
	public PAPERBACK(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PAPERBACK(SubjectOf subjectOf) {
	...
	public PAPERBACK(SupersededBy supersededBy) {
	...
	public void copy(BookFormatType.Paperback org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return BookFormatType.Paperback.class.getAnnotation(SampleValue.class).value();
	}
