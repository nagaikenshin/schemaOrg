...
public class SUNDAY implements DayOfWeek.Sunday {
	...
	public SUNDAY(Long seq) {
		setSeq(seq);
	}

	public SUNDAY(String string) {
	...
	public SUNDAY(AdditionalType additionalType) {
	...
	public SUNDAY(AlternateName alternateName) {
	...
	public SUNDAY(Description description) {
	...
	public SUNDAY(DisambiguatingDescription disambiguatingDescription) {
	...
	public SUNDAY(Identifier identifier) {
	...
	public SUNDAY(MainEntityOfPage mainEntityOfPage) {
	...
	public SUNDAY(NameFuzzy nameFuzzy) {
	...
	public SUNDAY(NameRuby nameRuby) {
	...
	public SUNDAY(PotentialAction potentialAction) {
	...
	public SUNDAY(SubjectOf subjectOf) {
	...
	public SUNDAY(SupersededBy supersededBy) {
	...
	public void copy(DayOfWeek.Sunday org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return DayOfWeek.Sunday.class.getAnnotation(SampleValue.class).value();
	}
