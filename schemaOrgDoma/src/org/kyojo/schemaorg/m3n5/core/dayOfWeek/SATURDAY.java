...
public class SATURDAY implements DayOfWeek.Saturday {
	...
	public SATURDAY(Long seq) {
		setSeq(seq);
	}

	public SATURDAY(String string) {
	...
	public SATURDAY(AdditionalType additionalType) {
	...
	public SATURDAY(AlternateName alternateName) {
	...
	public SATURDAY(Description description) {
	...
	public SATURDAY(DisambiguatingDescription disambiguatingDescription) {
	...
	public SATURDAY(Identifier identifier) {
	...
	public SATURDAY(MainEntityOfPage mainEntityOfPage) {
	...
	public SATURDAY(NameFuzzy nameFuzzy) {
	...
	public SATURDAY(NameRuby nameRuby) {
	...
	public SATURDAY(PotentialAction potentialAction) {
	...
	public SATURDAY(SubjectOf subjectOf) {
	...
	public SATURDAY(SupersededBy supersededBy) {
	...
	public void copy(DayOfWeek.Saturday org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return DayOfWeek.Saturday.class.getAnnotation(SampleValue.class).value();
	}
