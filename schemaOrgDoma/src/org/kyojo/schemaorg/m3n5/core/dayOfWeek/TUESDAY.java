...
public class TUESDAY implements DayOfWeek.Tuesday {
	...
	public TUESDAY(Long seq) {
		setSeq(seq);
	}

	public TUESDAY(String string) {
	...
	public TUESDAY(AdditionalType additionalType) {
	...
	public TUESDAY(AlternateName alternateName) {
	...
	public TUESDAY(Description description) {
	...
	public TUESDAY(DisambiguatingDescription disambiguatingDescription) {
	...
	public TUESDAY(Identifier identifier) {
	...
	public TUESDAY(MainEntityOfPage mainEntityOfPage) {
	...
	public TUESDAY(NameFuzzy nameFuzzy) {
	...
	public TUESDAY(NameRuby nameRuby) {
	...
	public TUESDAY(PotentialAction potentialAction) {
	...
	public TUESDAY(SubjectOf subjectOf) {
	...
	public TUESDAY(SupersededBy supersededBy) {
	...
	public void copy(DayOfWeek.Tuesday org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return DayOfWeek.Tuesday.class.getAnnotation(SampleValue.class).value();
	}
