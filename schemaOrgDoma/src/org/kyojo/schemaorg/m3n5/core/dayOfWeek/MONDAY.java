...
public class MONDAY implements DayOfWeek.Monday {
	...
	public MONDAY(Long seq) {
		setSeq(seq);
	}

	public MONDAY(String string) {
	...
	public MONDAY(AdditionalType additionalType) {
	...
	public MONDAY(AlternateName alternateName) {
	...
	public MONDAY(Description description) {
	...
	public MONDAY(DisambiguatingDescription disambiguatingDescription) {
	...
	public MONDAY(Identifier identifier) {
	...
	public MONDAY(MainEntityOfPage mainEntityOfPage) {
	...
	public MONDAY(NameFuzzy nameFuzzy) {
	...
	public MONDAY(NameRuby nameRuby) {
	...
	public MONDAY(PotentialAction potentialAction) {
	...
	public MONDAY(SubjectOf subjectOf) {
	...
	public MONDAY(SupersededBy supersededBy) {
	...
	public void copy(DayOfWeek.Monday org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return DayOfWeek.Monday.class.getAnnotation(SampleValue.class).value();
	}
