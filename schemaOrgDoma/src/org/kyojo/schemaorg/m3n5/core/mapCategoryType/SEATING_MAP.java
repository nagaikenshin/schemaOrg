...
public class SEATING_MAP implements MapCategoryType.SeatingMap {
	...
	public SEATING_MAP(Long seq) {
		setSeq(seq);
	}

	public SEATING_MAP(String string) {
	...
	public SEATING_MAP(AdditionalType additionalType) {
	...
	public SEATING_MAP(AlternateName alternateName) {
	...
	public SEATING_MAP(Description description) {
	...
	public SEATING_MAP(DisambiguatingDescription disambiguatingDescription) {
	...
	public SEATING_MAP(Identifier identifier) {
	...
	public SEATING_MAP(Image image) {
		setImage(image);
	}
	...
	public SEATING_MAP(MainEntityOfPage mainEntityOfPage) {
	...
	public SEATING_MAP(NameFuzzy nameFuzzy) {
	...
	public SEATING_MAP(NameRuby nameRuby) {
	...
	public SEATING_MAP(PotentialAction potentialAction) {
	...
	public SEATING_MAP(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SEATING_MAP(SubjectOf subjectOf) {
	...
	public SEATING_MAP(SupersededBy supersededBy) {
	...
	public void copy(MapCategoryType.SeatingMap org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MapCategoryType.SeatingMap.class.getAnnotation(SampleValue.class).value();
	}
