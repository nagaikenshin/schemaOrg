...
public class VENUE_MAP implements MapCategoryType.VenueMap {
	...
	public VENUE_MAP(Long seq) {
		setSeq(seq);
	}

	public VENUE_MAP(String string) {
	...
	public VENUE_MAP(AdditionalType additionalType) {
	...
	public VENUE_MAP(AlternateName alternateName) {
	...
	public VENUE_MAP(Description description) {
	...
	public VENUE_MAP(DisambiguatingDescription disambiguatingDescription) {
	...
	public VENUE_MAP(Identifier identifier) {
	...
	public VENUE_MAP(MainEntityOfPage mainEntityOfPage) {
	...
	public VENUE_MAP(NameFuzzy nameFuzzy) {
	...
	public VENUE_MAP(NameRuby nameRuby) {
	...
	public VENUE_MAP(PotentialAction potentialAction) {
	...
	public VENUE_MAP(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public VENUE_MAP(SubjectOf subjectOf) {
	...
	public VENUE_MAP(SupersededBy supersededBy) {
	...
	public void copy(MapCategoryType.VenueMap org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MapCategoryType.VenueMap.class.getAnnotation(SampleValue.class).value();
	}
