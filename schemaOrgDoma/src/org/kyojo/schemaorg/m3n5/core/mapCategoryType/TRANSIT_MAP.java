package org.kyojo.schemaorg.m3n5.core.mapCategoryType;
...
import org.kyojo.schemaorg.m3n5.core.MapCategoryType;
...
public class TRANSIT_MAP implements MapCategoryType.TransitMap {
	...
	public TRANSIT_MAP(Long seq) {
		setSeq(seq);
	}

	public TRANSIT_MAP(String string) {
	...
	public TRANSIT_MAP(AdditionalType additionalType) {
	...
	public TRANSIT_MAP(AlternateName alternateName) {
	...
	public TRANSIT_MAP(Description description) {
	...
	public TRANSIT_MAP(DisambiguatingDescription disambiguatingDescription) {
	...
	public TRANSIT_MAP(Identifier identifier) {
	...
	public TRANSIT_MAP(Image image) {
		setImage(image);
	}
	...
	public TRANSIT_MAP(MainEntityOfPage mainEntityOfPage) {
	...
	public TRANSIT_MAP(NameFuzzy nameFuzzy) {
	...
	public TRANSIT_MAP(NameRuby nameRuby) {
	...
	public TRANSIT_MAP(PotentialAction potentialAction) {
	...
	public TRANSIT_MAP(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TRANSIT_MAP(SubjectOf subjectOf) {
	...
	public TRANSIT_MAP(SupersededBy supersededBy) {
	...
	public void copy(MapCategoryType.TransitMap org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MapCategoryType.TransitMap.class.getAnnotation(SampleValue.class).value();
	}
