...
public class DJ_MIX_ALBUM implements MusicAlbumProductionType.DJMixAlbum {
	...
	public DJ_MIX_ALBUM(Long seq) {
		setSeq(seq);
	}

	public DJ_MIX_ALBUM(String string) {
	...
	public DJ_MIX_ALBUM(AdditionalType additionalType) {
	...
	public DJ_MIX_ALBUM(AlternateName alternateName) {
	...
	public DJ_MIX_ALBUM(Description description) {
	...
	public DJ_MIX_ALBUM(DisambiguatingDescription disambiguatingDescription) {
	...
	public DJ_MIX_ALBUM(Identifier identifier) {
	...
	public DJ_MIX_ALBUM(Image image) {
		setImage(image);
	}
	...
	public DJ_MIX_ALBUM(MainEntityOfPage mainEntityOfPage) {
	...
	public DJ_MIX_ALBUM(NameFuzzy nameFuzzy) {
	...
	public DJ_MIX_ALBUM(NameRuby nameRuby) {
	...
	public DJ_MIX_ALBUM(PotentialAction potentialAction) {
	...
	public DJ_MIX_ALBUM(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DJ_MIX_ALBUM(SubjectOf subjectOf) {
	...
	public DJ_MIX_ALBUM(SupersededBy supersededBy) {
	...
	public void copy(MusicAlbumProductionType.DJMixAlbum org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MusicAlbumProductionType.DJMixAlbum.class.getAnnotation(SampleValue.class).value();
	}
