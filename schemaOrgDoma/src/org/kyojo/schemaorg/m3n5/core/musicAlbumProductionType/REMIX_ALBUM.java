...
public class REMIX_ALBUM implements MusicAlbumProductionType.RemixAlbum {
	...
	public REMIX_ALBUM(Long seq) {
		setSeq(seq);
	}

	public REMIX_ALBUM(String string) {
	...
	public REMIX_ALBUM(AdditionalType additionalType) {
	...
	public REMIX_ALBUM(AlternateName alternateName) {
	...
	public REMIX_ALBUM(Description description) {
	...
	public REMIX_ALBUM(DisambiguatingDescription disambiguatingDescription) {
	...
	public REMIX_ALBUM(Identifier identifier) {
	...
	public REMIX_ALBUM(Image image) {
		setImage(image);
	}
	...
	public REMIX_ALBUM(MainEntityOfPage mainEntityOfPage) {
	...
	public REMIX_ALBUM(NameFuzzy nameFuzzy) {
	...
	public REMIX_ALBUM(NameRuby nameRuby) {
	...
	public REMIX_ALBUM(PotentialAction potentialAction) {
	...
	public REMIX_ALBUM(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public REMIX_ALBUM(SubjectOf subjectOf) {
	...
	public REMIX_ALBUM(SupersededBy supersededBy) {
	...
	public void copy(MusicAlbumProductionType.RemixAlbum org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MusicAlbumProductionType.RemixAlbum.class.getAnnotation(SampleValue.class).value();
	}
