...
public class PAYMENT_COMPLETE implements PaymentStatusType.PaymentComplete {
	...
	public PAYMENT_COMPLETE(Long seq) {
		setSeq(seq);
	}

	public PAYMENT_COMPLETE(String string) {
	...
	public PAYMENT_COMPLETE(AdditionalType additionalType) {
	...
	public PAYMENT_COMPLETE(AlternateName alternateName) {
	...
	public PAYMENT_COMPLETE(Description description) {
	...
	public PAYMENT_COMPLETE(DisambiguatingDescription disambiguatingDescription) {
	...
	public PAYMENT_COMPLETE(Identifier identifier) {
	...
	public PAYMENT_COMPLETE(Image image) {
		setImage(image);
	}
	...
	public PAYMENT_COMPLETE(MainEntityOfPage mainEntityOfPage) {
	...
	public PAYMENT_COMPLETE(Name name) {
		setName(name);
	}
	...
	public PAYMENT_COMPLETE(NameFuzzy nameFuzzy) {
	...
	public PAYMENT_COMPLETE(NameRuby nameRuby) {
	...
	public PAYMENT_COMPLETE(PotentialAction potentialAction) {
	...
	public PAYMENT_COMPLETE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PAYMENT_COMPLETE(SubjectOf subjectOf) {
	...
	public PAYMENT_COMPLETE(SupersededBy supersededBy) {
	...
	public PAYMENT_COMPLETE(Url url) {
		setUrl(url);
	}
	...
	public void copy(PaymentStatusType.PaymentComplete org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return PaymentStatusType.PaymentComplete.class.getAnnotation(SampleValue.class).value();
	}
