...
public class PAYMENT_DUE implements PaymentStatusType.PaymentDue {
	...
	public PAYMENT_DUE(Long seq) {
		setSeq(seq);
	}

	public PAYMENT_DUE(String string) {
	...
	public PAYMENT_DUE(AdditionalType additionalType) {
	...
	public PAYMENT_DUE(AlternateName alternateName) {
	...
	public PAYMENT_DUE(Description description) {
	...
	public PAYMENT_DUE(DisambiguatingDescription disambiguatingDescription) {
	...
	public PAYMENT_DUE(Identifier identifier) {
	...
	public PAYMENT_DUE(Image image) {
		setImage(image);
	}
	...
	public PAYMENT_DUE(MainEntityOfPage mainEntityOfPage) {
	...
	public PAYMENT_DUE(NameFuzzy nameFuzzy) {
	...
	public PAYMENT_DUE(NameRuby nameRuby) {
	...
	public PAYMENT_DUE(PotentialAction potentialAction) {
	...
	public PAYMENT_DUE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PAYMENT_DUE(SubjectOf subjectOf) {
	...
	public PAYMENT_DUE(SupersededBy supersededBy) {
	...
	public void copy(PaymentStatusType.PaymentDue org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return PaymentStatusType.PaymentDue.class.getAnnotation(SampleValue.class).value();
	}
