package org.kyojo.schemaorg.m3n5.core.deliveryMethod;
...
import org.kyojo.schemaorg.m3n5.core.DeliveryMethod;
...
public class ON_SITE_PICKUP implements DeliveryMethod.OnSitePickup {
	...
	public ON_SITE_PICKUP() {
	}

	public ON_SITE_PICKUP(Long seq) {
		setSeq(seq);
	}

	public ON_SITE_PICKUP(String string) {
	...
	public ON_SITE_PICKUP(AdditionalType additionalType) {
	...
	public ON_SITE_PICKUP(AlternateName alternateName) {
	...
	public ON_SITE_PICKUP(Description description) {
	...
	public ON_SITE_PICKUP(DisambiguatingDescription disambiguatingDescription) {
	...
	public ON_SITE_PICKUP(Identifier identifier) {
	...
	public ON_SITE_PICKUP(Image image) {
		setImage(image);
	}
	...
	public ON_SITE_PICKUP(MainEntityOfPage mainEntityOfPage) {
	...
	public ON_SITE_PICKUP(Name name) {
		setName(name);
	}
	...
	public ON_SITE_PICKUP(NameFuzzy nameFuzzy) {
	...
	public ON_SITE_PICKUP(NameRuby nameRuby) {
	...
	public ON_SITE_PICKUP(PotentialAction potentialAction) {
	...
	public ON_SITE_PICKUP(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ON_SITE_PICKUP(SubjectOf subjectOf) {
	...
	public ON_SITE_PICKUP(SupersededBy supersededBy) {
	...
	public void copy(DeliveryMethod.OnSitePickup org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return DeliveryMethod.OnSitePickup.class.getAnnotation(SampleValue.class).value();
	}
