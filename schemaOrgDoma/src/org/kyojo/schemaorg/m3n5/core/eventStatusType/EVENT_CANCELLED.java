...
public class EVENT_CANCELLED implements EventStatusType.EventCancelled {
	...
	public EVENT_CANCELLED() {
	}

	public EVENT_CANCELLED(Long seq) {
		setSeq(seq);
	}

	public EVENT_CANCELLED(String string) {
	...
	public EVENT_CANCELLED(AdditionalType additionalType) {
	...
	public EVENT_CANCELLED(AlternateName alternateName) {
	...
	public EVENT_CANCELLED(Description description) {
	...
	public EVENT_CANCELLED(DisambiguatingDescription disambiguatingDescription) {
	...
	public EVENT_CANCELLED(Identifier identifier) {
	...
	public EVENT_CANCELLED(Image image) {
		setImage(image);
	}
	...
	public EVENT_CANCELLED(MainEntityOfPage mainEntityOfPage) {
	...
	public EVENT_CANCELLED(Name name) {
		setName(name);
	}
	...
	public EVENT_CANCELLED(NameFuzzy nameFuzzy) {
	...
	public EVENT_CANCELLED(NameRuby nameRuby) {
	...
	public EVENT_CANCELLED(PotentialAction potentialAction) {
	...
	public EVENT_CANCELLED(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public EVENT_CANCELLED(SubjectOf subjectOf) {
	...
	public EVENT_CANCELLED(SupersededBy supersededBy) {
	...
	public EVENT_CANCELLED(Url url) {
		setUrl(url);
	}
	...
	public void copy(EventStatusType.EventCancelled org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return EventStatusType.EventCancelled.class.getAnnotation(SampleValue.class).value();
	}
