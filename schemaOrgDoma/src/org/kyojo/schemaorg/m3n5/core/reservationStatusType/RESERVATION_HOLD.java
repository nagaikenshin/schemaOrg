...
public class RESERVATION_HOLD implements ReservationStatusType.ReservationHold {
	...
	public RESERVATION_HOLD() {
	}

	public RESERVATION_HOLD(Long seq) {
		setSeq(seq);
	}

	public RESERVATION_HOLD(String string) {
	...
	public RESERVATION_HOLD(AdditionalType additionalType) {
	...
	public RESERVATION_HOLD(AlternateName alternateName) {
	...
	public RESERVATION_HOLD(Description description) {
	...
	public RESERVATION_HOLD(DisambiguatingDescription disambiguatingDescription) {
	...
	public RESERVATION_HOLD(Identifier identifier) {
	...
	public RESERVATION_HOLD(Image image) {
		setImage(image);
	}
	...
	public RESERVATION_HOLD(MainEntityOfPage mainEntityOfPage) {
	...
	public RESERVATION_HOLD(Name name) {
		setName(name);
	}
	...
	public RESERVATION_HOLD(NameFuzzy nameFuzzy) {
	...
	public RESERVATION_HOLD(NameRuby nameRuby) {
	...
	public RESERVATION_HOLD(PotentialAction potentialAction) {
	...
	public RESERVATION_HOLD(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RESERVATION_HOLD(SubjectOf subjectOf) {
	...
	public RESERVATION_HOLD(SupersededBy supersededBy) {
	...
	public RESERVATION_HOLD(Url url) {
		setUrl(url);
	}
	...
	public void copy(ReservationStatusType.ReservationHold org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return ReservationStatusType.ReservationHold.class.getAnnotation(SampleValue.class).value();
	}
