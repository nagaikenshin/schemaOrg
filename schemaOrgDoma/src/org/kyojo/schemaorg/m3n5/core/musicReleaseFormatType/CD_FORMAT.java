...
public class CD_FORMAT implements MusicReleaseFormatType.CDFormat {
	...
	public CD_FORMAT(Long seq) {
		setSeq(seq);
	}

	public CD_FORMAT(String string) {
	...
	public CD_FORMAT(AdditionalType additionalType) {
	...
	public CD_FORMAT(AlternateName alternateName) {
	...
	public CD_FORMAT(Description description) {
	...
	public CD_FORMAT(DisambiguatingDescription disambiguatingDescription) {
	...
	public CD_FORMAT(Identifier identifier) {
	...
	public CD_FORMAT(MainEntityOfPage mainEntityOfPage) {
	...
	public CD_FORMAT(NameFuzzy nameFuzzy) {
	...
	public CD_FORMAT(NameRuby nameRuby) {
	...
	public CD_FORMAT(PotentialAction potentialAction) {
	...
	public CD_FORMAT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CD_FORMAT(SubjectOf subjectOf) {
	...
	public CD_FORMAT(SupersededBy supersededBy) {
	...
	public void copy(MusicReleaseFormatType.CDFormat org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MusicReleaseFormatType.CDFormat.class.getAnnotation(SampleValue.class).value();
	}
