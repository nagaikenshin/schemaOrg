...
public class CASSETTE_FORMAT implements MusicReleaseFormatType.CassetteFormat {
	...
	public CASSETTE_FORMAT() {
	}

	public CASSETTE_FORMAT(Long seq) {
		setSeq(seq);
	}

	public CASSETTE_FORMAT(String string) {
	...
	public CASSETTE_FORMAT(AdditionalType additionalType) {
	...
	public CASSETTE_FORMAT(AlternateName alternateName) {
	...
	public CASSETTE_FORMAT(Description description) {
	...
	public CASSETTE_FORMAT(DisambiguatingDescription disambiguatingDescription) {
	...
	public CASSETTE_FORMAT(Identifier identifier) {
	...
	public CASSETTE_FORMAT(Image image) {
		setImage(image);
	}
	...
	public CASSETTE_FORMAT(MainEntityOfPage mainEntityOfPage) {
	...
	public CASSETTE_FORMAT(Name name) {
		setName(name);
	}
	...
	public CASSETTE_FORMAT(NameFuzzy nameFuzzy) {
	...
	public CASSETTE_FORMAT(NameRuby nameRuby) {
	...
	public CASSETTE_FORMAT(PotentialAction potentialAction) {
	...
	public CASSETTE_FORMAT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CASSETTE_FORMAT(SubjectOf subjectOf) {
	...
	public CASSETTE_FORMAT(SupersededBy supersededBy) {
	...
	public CASSETTE_FORMAT(Url url) {
		setUrl(url);
	}
	...
	public void copy(MusicReleaseFormatType.CassetteFormat org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MusicReleaseFormatType.CassetteFormat.class.getAnnotation(SampleValue.class).value();
	}
