...
public class VINYL_FORMAT implements MusicReleaseFormatType.VinylFormat {
	...
	public VINYL_FORMAT(Long seq) {
		setSeq(seq);
	}

	public VINYL_FORMAT(String string) {
	...
	public VINYL_FORMAT(AdditionalType additionalType) {
	...
	public VINYL_FORMAT(AlternateName alternateName) {
	...
	public VINYL_FORMAT(Description description) {
	...
	public VINYL_FORMAT(DisambiguatingDescription disambiguatingDescription) {
	...
	public VINYL_FORMAT(Identifier identifier) {
	...
	public VINYL_FORMAT(Image image) {
		setImage(image);
	}
	...
	public VINYL_FORMAT(MainEntityOfPage mainEntityOfPage) {
	...
	public VINYL_FORMAT(NameFuzzy nameFuzzy) {
	...
	public VINYL_FORMAT(NameRuby nameRuby) {
	...
	public VINYL_FORMAT(PotentialAction potentialAction) {
	...
	public VINYL_FORMAT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public VINYL_FORMAT(SubjectOf subjectOf) {
	...
	public VINYL_FORMAT(SupersededBy supersededBy) {
	...
	public void copy(MusicReleaseFormatType.VinylFormat org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MusicReleaseFormatType.VinylFormat.class.getAnnotation(SampleValue.class).value();
	}
