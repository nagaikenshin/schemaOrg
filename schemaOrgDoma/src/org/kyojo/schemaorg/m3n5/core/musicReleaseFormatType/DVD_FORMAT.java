...
public class DVD_FORMAT implements MusicReleaseFormatType.DVDFormat {
	...
	public DVD_FORMAT(Long seq) {
		setSeq(seq);
	}

	public DVD_FORMAT(String string) {
	...
	public DVD_FORMAT(AdditionalType additionalType) {
	...
	public DVD_FORMAT(AlternateName alternateName) {
	...
	public DVD_FORMAT(Description description) {
	...
	public DVD_FORMAT(DisambiguatingDescription disambiguatingDescription) {
	...
	public DVD_FORMAT(Identifier identifier) {
	...
	public DVD_FORMAT(MainEntityOfPage mainEntityOfPage) {
	...
	public DVD_FORMAT(NameFuzzy nameFuzzy) {
	...
	public DVD_FORMAT(NameRuby nameRuby) {
	...
	public DVD_FORMAT(PotentialAction potentialAction) {
	...
	public DVD_FORMAT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DVD_FORMAT(SubjectOf subjectOf) {
	...
	public DVD_FORMAT(SupersededBy supersededBy) {
	...
	public void copy(MusicReleaseFormatType.DVDFormat org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MusicReleaseFormatType.DVDFormat.class.getAnnotation(SampleValue.class).value();
	}
