...
public class ALBUM_RELEASE implements MusicAlbumReleaseType.AlbumRelease {
	...
	public ALBUM_RELEASE(AdditionalType additionalType) {
	...
	public ALBUM_RELEASE(AlternateName alternateName) {
	...
	public ALBUM_RELEASE(Description description) {
	...
	public ALBUM_RELEASE(DisambiguatingDescription disambiguatingDescription) {
	...
	public ALBUM_RELEASE(Identifier identifier) {
	...
	public ALBUM_RELEASE(Image image) {
		setImage(image);
	}
	...
	public ALBUM_RELEASE(MainEntityOfPage mainEntityOfPage) {
	...
	public ALBUM_RELEASE(Name name) {
		setName(name);
	}
	...
	public ALBUM_RELEASE(NameFuzzy nameFuzzy) {
	...
	public ALBUM_RELEASE(NameRuby nameRuby) {
	...
	public ALBUM_RELEASE(PotentialAction potentialAction) {
	...
	public ALBUM_RELEASE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ALBUM_RELEASE(SubjectOf subjectOf) {
	...
	public ALBUM_RELEASE(SupersededBy supersededBy) {
	...
	public void copy(MusicAlbumReleaseType.AlbumRelease org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MusicAlbumReleaseType.AlbumRelease.class.getAnnotation(SampleValue.class).value();
	}
