...
public class DISCONTINUED implements ItemAvailability.Discontinued {
	...
	public DISCONTINUED(Long seq) {
		setSeq(seq);
	}

	public DISCONTINUED(String string) {
	...
	public DISCONTINUED(AdditionalType additionalType) {
	...
	public DISCONTINUED(AlternateName alternateName) {
	...
	public DISCONTINUED(Description description) {
	...
	public DISCONTINUED(DisambiguatingDescription disambiguatingDescription) {
	...
	public DISCONTINUED(Identifier identifier) {
	...
	public DISCONTINUED(Image image) {
		setImage(image);
	}
	...
	public DISCONTINUED(MainEntityOfPage mainEntityOfPage) {
	...
	public DISCONTINUED(NameFuzzy nameFuzzy) {
	...
	public DISCONTINUED(NameRuby nameRuby) {
	...
	public DISCONTINUED(PotentialAction potentialAction) {
	...
	public DISCONTINUED(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DISCONTINUED(SubjectOf subjectOf) {
	...
	public DISCONTINUED(SupersededBy supersededBy) {
	...
	public void copy(ItemAvailability.Discontinued org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return ItemAvailability.Discontinued.class.getAnnotation(SampleValue.class).value();
	}
