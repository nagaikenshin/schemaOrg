...
public class PRE_SALE implements ItemAvailability.PreSale {
	...
	public PRE_SALE(Long seq) {
		setSeq(seq);
	}

	public PRE_SALE(String string) {
	...
	public PRE_SALE(AdditionalType additionalType) {
	...
	public PRE_SALE(AlternateName alternateName) {
	...
	public PRE_SALE(Description description) {
	...
	public PRE_SALE(DisambiguatingDescription disambiguatingDescription) {
	...
	public PRE_SALE(Identifier identifier) {
	...
	public PRE_SALE(MainEntityOfPage mainEntityOfPage) {
	...
	public PRE_SALE(NameFuzzy nameFuzzy) {
	...
	public PRE_SALE(NameRuby nameRuby) {
	...
	public PRE_SALE(PotentialAction potentialAction) {
	...
	public PRE_SALE(SubjectOf subjectOf) {
	...
	public PRE_SALE(SupersededBy supersededBy) {
	...
	public void copy(ItemAvailability.PreSale org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return ItemAvailability.PreSale.class.getAnnotation(SampleValue.class).value();
	}
