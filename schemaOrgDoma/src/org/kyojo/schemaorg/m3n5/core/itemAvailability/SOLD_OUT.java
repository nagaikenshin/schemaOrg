...
public class SOLD_OUT implements ItemAvailability.SoldOut {
	...
	public SOLD_OUT(Long seq) {
		setSeq(seq);
	}

	public SOLD_OUT(String string) {
	...
	public SOLD_OUT(AdditionalType additionalType) {
	...
	public SOLD_OUT(AlternateName alternateName) {
	...
	public SOLD_OUT(Description description) {
	...
	public SOLD_OUT(DisambiguatingDescription disambiguatingDescription) {
	...
	public SOLD_OUT(Identifier identifier) {
	...
	public SOLD_OUT(MainEntityOfPage mainEntityOfPage) {
	...
	public SOLD_OUT(NameFuzzy nameFuzzy) {
	...
	public SOLD_OUT(NameRuby nameRuby) {
	...
	public SOLD_OUT(PotentialAction potentialAction) {
	...
	public SOLD_OUT(SubjectOf subjectOf) {
	...
	public SOLD_OUT(SupersededBy supersededBy) {
	...
	public void copy(ItemAvailability.SoldOut org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return ItemAvailability.SoldOut.class.getAnnotation(SampleValue.class).value();
	}
