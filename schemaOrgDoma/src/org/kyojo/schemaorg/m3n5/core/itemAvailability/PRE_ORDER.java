...
public class PRE_ORDER implements ItemAvailability.PreOrder {
	...
	public PRE_ORDER(Long seq) {
		setSeq(seq);
	}

	public PRE_ORDER(String string) {
	...
	public PRE_ORDER(AdditionalType additionalType) {
	...
	public PRE_ORDER(AlternateName alternateName) {
	...
	public PRE_ORDER(Description description) {
	...
	public PRE_ORDER(DisambiguatingDescription disambiguatingDescription) {
	...
	public PRE_ORDER(Identifier identifier) {
	...
	public PRE_ORDER(MainEntityOfPage mainEntityOfPage) {
	...
	public PRE_ORDER(NameFuzzy nameFuzzy) {
	...
	public PRE_ORDER(NameRuby nameRuby) {
	...
	public PRE_ORDER(PotentialAction potentialAction) {
	...
	public PRE_ORDER(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PRE_ORDER(SubjectOf subjectOf) {
	...
	public PRE_ORDER(SupersededBy supersededBy) {
	...
	public void copy(ItemAvailability.PreOrder org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return ItemAvailability.PreOrder.class.getAnnotation(SampleValue.class).value();
	}
