...
public class PAWN_SHOP implements Clazz.PawnShop {
	...
	public PAWN_SHOP(GeoContains geoContains) {
	...
	public PAWN_SHOP(GeoCoveredBy geoCoveredBy) {
	...
	public PAWN_SHOP(GeoCovers geoCovers) {
	...
	public PAWN_SHOP(GeoCrosses geoCrosses) {
	...
	public PAWN_SHOP(GeoDisjoint geoDisjoint) {
	...
	public PAWN_SHOP(GeoEquals geoEquals) {
	...
	public PAWN_SHOP(GeoIntersects geoIntersects) {
	...
	public PAWN_SHOP(GeoOverlaps geoOverlaps) {
	...
	public PAWN_SHOP(GeoTouches geoTouches) {
	...
	public PAWN_SHOP(GeoWithin geoWithin) {
	...
	public PAWN_SHOP(Slogan slogan) {
		setSlogan(slogan);
	}
