...
public class PROVIDES_SERVICE implements Container.ProvidesService {
	...
	public PROVIDES_SERVICE(BankAccount bankAccount) {
	...
	public PROVIDES_SERVICE(BroadcastService broadcastService) {
	...
	public PROVIDES_SERVICE(BrokerageAccount brokerageAccount) {
	...
	public PROVIDES_SERVICE(CableOrSatelliteService cableOrSatelliteService) {
	...
	public PROVIDES_SERVICE(CreditCard creditCard) {
	...
	public PROVIDES_SERVICE(CurrencyConversionService currencyConversionService) {
	...
	public PROVIDES_SERVICE(DepositAccount depositAccount) {
	...
	public PROVIDES_SERVICE(FinancialProduct financialProduct) {
	...
	public PROVIDES_SERVICE(FoodService foodService) {
	...
	public PROVIDES_SERVICE(GovernmentService governmentService) {
	...
	public PROVIDES_SERVICE(InvestmentFund investmentFund) {
	...
	public PROVIDES_SERVICE(InvestmentOrDeposit investmentOrDeposit) {
	...
	public PROVIDES_SERVICE(LoanOrCredit loanOrCredit) {
	...
	public PROVIDES_SERVICE(MortgageLoan mortgageLoan) {
	...
	public PROVIDES_SERVICE(PaymentCard paymentCard) {
	...
	public PROVIDES_SERVICE(PaymentService paymentService) {
	...
	public PROVIDES_SERVICE(RadioBroadcastService radioBroadcastService) {
	...
	public PROVIDES_SERVICE(TaxiService taxiService) {
	...
	public PROVIDES_SERVICE(WebAPI webAPI) {
	...
	public PROVIDES_SERVICE(List<BankAccount> bankAccountList,
	...
	public void copy(Container.ProvidesService org) {
