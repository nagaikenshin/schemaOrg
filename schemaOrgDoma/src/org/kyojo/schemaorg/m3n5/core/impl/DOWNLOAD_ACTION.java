...
public class DOWNLOAD_ACTION implements Clazz.DownloadAction {
	...
	public DOWNLOAD_ACTION() {
	}

	public DOWNLOAD_ACTION(Long seq) {
		setSeq(seq);
	}

	public DOWNLOAD_ACTION(String string) {
	...
	public DOWNLOAD_ACTION(ActionStatus actionStatus) {
	...
	public DOWNLOAD_ACTION(AdditionalType additionalType) {
	...
	public DOWNLOAD_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public DOWNLOAD_ACTION(AlternateName alternateName) {
	...
	public DOWNLOAD_ACTION(Description description) {
	...
	public DOWNLOAD_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public DOWNLOAD_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public DOWNLOAD_ACTION(Error error) {
		setError(error);
	}
	...
	public DOWNLOAD_ACTION(FromLocation fromLocation) {
	...
	public DOWNLOAD_ACTION(Identifier identifier) {
	...
	public DOWNLOAD_ACTION(Image image) {
		setImage(image);
	}
	...
	public DOWNLOAD_ACTION(Instrument instrument) {
	...
	public DOWNLOAD_ACTION(Location location) {
	...
	public DOWNLOAD_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public DOWNLOAD_ACTION(Name name) {
		setName(name);
	}
	...
	public DOWNLOAD_ACTION(NameFuzzy nameFuzzy) {
	...
	public DOWNLOAD_ACTION(NameRuby nameRuby) {
	...
	public DOWNLOAD_ACTION(Object object) {
		setObject(object);
	}
	...
	public DOWNLOAD_ACTION(Participant participant) {
	...
	public DOWNLOAD_ACTION(PotentialAction potentialAction) {
	...
	public DOWNLOAD_ACTION(Result result) {
		setResult(result);
	}
	...
	public DOWNLOAD_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DOWNLOAD_ACTION(StartTime startTime) {
	...
	public DOWNLOAD_ACTION(SubjectOf subjectOf) {
	...
	public DOWNLOAD_ACTION(Target target) {
		setTarget(target);
	}
	...
	public DOWNLOAD_ACTION(ToLocation toLocation) {
	...
	public DOWNLOAD_ACTION(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.DownloadAction org) {
		setSeq(org.getSeq());
