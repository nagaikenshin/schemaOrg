...
public class PRESCHOOL implements Clazz.Preschool {
	...
	public PRESCHOOL(Long seq) {
		setSeq(seq);
	}

	public PRESCHOOL(String string) {
	...
	public PRESCHOOL(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public PRESCHOOL(AdditionalType additionalType) {
	...
	public PRESCHOOL(Address address) {
		setAddress(address);
	}
	...
	public PRESCHOOL(AggregateRating aggregateRating) {
	...
	public PRESCHOOL(AlternateName alternateName) {
	...
	public PRESCHOOL(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public PRESCHOOL(AreaServed areaServed) {
	...
	public PRESCHOOL(ContactPoint contactPoint) {
	...
	public PRESCHOOL(CorrectionsPolicy correctionsPolicy) {
	...
	public PRESCHOOL(Department department) {
	...
	public PRESCHOOL(Description description) {
	...
	public PRESCHOOL(DisambiguatingDescription disambiguatingDescription) {
	...
	public PRESCHOOL(DissolutionDate dissolutionDate) {
	...
	public PRESCHOOL(DiversityPolicy diversityPolicy) {
	...
	public PRESCHOOL(DiversityStaffingReport diversityStaffingReport) {
	...
	public PRESCHOOL(Employee employee) {
	...
	public PRESCHOOL(EthicsPolicy ethicsPolicy) {
	...
	public PRESCHOOL(FaxNumber faxNumber) {
	...
	public PRESCHOOL(Founder founder) {
		setFounder(founder);
	}
	...
	public PRESCHOOL(FoundingDate foundingDate) {
	...
	public PRESCHOOL(FoundingLocation foundingLocation) {
	...
	public PRESCHOOL(Funder funder) {
		setFunder(funder);
	}
	...
	public PRESCHOOL(GlobalLocationNumber globalLocationNumber) {
	...
	public PRESCHOOL(HasOfferCatalog hasOfferCatalog) {
	...
	public PRESCHOOL(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public PRESCHOOL(Identifier identifier) {
	...
	public PRESCHOOL(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public PRESCHOOL(KnowsAbout knowsAbout) {
	...
	public PRESCHOOL(KnowsLanguage knowsLanguage) {
	...
	public PRESCHOOL(LegalName legalName) {
	...
	public PRESCHOOL(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public PRESCHOOL(Location location) {
	...
	public PRESCHOOL(MainEntityOfPage mainEntityOfPage) {
	...
	public PRESCHOOL(MakesOffer makesOffer) {
	...
	public PRESCHOOL(Member member) {
		setMember(member);
	}
	...
	public PRESCHOOL(MemberOf memberOf) {
	...
	public PRESCHOOL(NameFuzzy nameFuzzy) {
	...
	public PRESCHOOL(NameRuby nameRuby) {
	...
	public PRESCHOOL(NumberOfEmployees numberOfEmployees) {
	...
	public PRESCHOOL(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public PRESCHOOL(ParentOrganization parentOrganization) {
	...
	public PRESCHOOL(PotentialAction potentialAction) {
	...
	public PRESCHOOL(PublishingPrinciples publishingPrinciples) {
	...
	public PRESCHOOL(Review review) {
		setReview(review);
	}
	...
	public PRESCHOOL(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PRESCHOOL(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public PRESCHOOL(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public PRESCHOOL(SubOrganization subOrganization) {
	...
	public PRESCHOOL(SubjectOf subjectOf) {
	...
	public PRESCHOOL(Telephone telephone) {
	...
	public PRESCHOOL(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.Preschool org) {
		setSeq(org.getSeq());
