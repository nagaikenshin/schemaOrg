...
public class IS_SIMILAR_TO implements Container.IsSimilarTo {
	...
	public IS_SIMILAR_TO(String string) {
	...
	public IS_SIMILAR_TO(BankAccount bankAccount) {
	...
	public IS_SIMILAR_TO(BroadcastService broadcastService) {
	...
	public IS_SIMILAR_TO(BrokerageAccount brokerageAccount) {
	...
	public IS_SIMILAR_TO(BusOrCoach busOrCoach) {
	...
	public IS_SIMILAR_TO(CableOrSatelliteService cableOrSatelliteService) {
	...
	public IS_SIMILAR_TO(CreditCard creditCard) {
	...
	public IS_SIMILAR_TO(CurrencyConversionService currencyConversionService) {
	...
	public IS_SIMILAR_TO(DepositAccount depositAccount) {
	...
	public IS_SIMILAR_TO(FinancialProduct financialProduct) {
	...
	public IS_SIMILAR_TO(FoodService foodService) {
	...
	public IS_SIMILAR_TO(GovernmentService governmentService) {
	...
	public IS_SIMILAR_TO(IndividualProduct individualProduct) {
	...
	public IS_SIMILAR_TO(InvestmentFund investmentFund) {
	...
	public IS_SIMILAR_TO(InvestmentOrDeposit investmentOrDeposit) {
	...
	public IS_SIMILAR_TO(LoanOrCredit loanOrCredit) {
	...
	public IS_SIMILAR_TO(MortgageLoan mortgageLoan) {
	...
	public IS_SIMILAR_TO(Motorcycle motorcycle) {
	...
	public IS_SIMILAR_TO(MotorizedBicycle motorizedBicycle) {
	...
	public IS_SIMILAR_TO(PaymentCard paymentCard) {
	...
	public IS_SIMILAR_TO(PaymentService paymentService) {
	...
	public IS_SIMILAR_TO(Product product) {
		productList = new ArrayList<Product>();
	...
	public IS_SIMILAR_TO(ProductModel productModel) {
	...
	public IS_SIMILAR_TO(RadioBroadcastService radioBroadcastService) {
	...
	public IS_SIMILAR_TO(Service service) {
	...
	public IS_SIMILAR_TO(SomeProducts someProducts) {
	...
	public IS_SIMILAR_TO(TaxiService taxiService) {
	...
	public IS_SIMILAR_TO(Vehicle vehicle) {
	...
	public IS_SIMILAR_TO(WebAPI webAPI) {
	...
	public void copy(Container.IsSimilarTo org) {
