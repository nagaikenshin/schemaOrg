...
public class LIVE_BLOG_POSTING implements Clazz.LiveBlogPosting {
	...
	public LIVE_BLOG_POSTING(Backstory backstory) {
	...
	public LIVE_BLOG_POSTING(Correction correction) {
	...
	public LIVE_BLOG_POSTING(EncodingFormat encodingFormat) {
	...
	public LIVE_BLOG_POSTING(MaterialExtent materialExtent) {
	...
	public LIVE_BLOG_POSTING(SdDatePublished sdDatePublished) {
	...
	public LIVE_BLOG_POSTING(SdLicense sdLicense) {
	...
	public LIVE_BLOG_POSTING(SdPublisher sdPublisher) {
	...
	public LIVE_BLOG_POSTING(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public LIVE_BLOG_POSTING(SubjectOf subjectOf) {
	...
	public LIVE_BLOG_POSTING(Temporal temporal) {
