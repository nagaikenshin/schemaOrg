...
public class COUNTRY implements Clazz.Country {
	...
	public COUNTRY(GeoContains geoContains) {
	...
	public COUNTRY(GeoCoveredBy geoCoveredBy) {
	...
	public COUNTRY(GeoCovers geoCovers) {
	...
	public COUNTRY(GeoCrosses geoCrosses) {
	...
	public COUNTRY(GeoDisjoint geoDisjoint) {
	...
	public COUNTRY(GeoEquals geoEquals) {
	...
	public COUNTRY(GeoIntersects geoIntersects) {
	...
	public COUNTRY(GeoOverlaps geoOverlaps) {
	...
	public COUNTRY(GeoTouches geoTouches) {
	...
	public COUNTRY(GeoWithin geoWithin) {
