...
public class LYRICS implements Container.Lyrics {
	...
	public LYRICS(APIReference apiReference) {
	...
	public LYRICS(AboutPage aboutPage) {
	...
	public LYRICS(AdvertiserContentArticle advertiserContentArticle) {
	...
	public LYRICS(AnalysisNewsArticle analysisNewsArticle) {
	...
	public LYRICS(ArchiveComponent archiveComponent) {
	...
	public LYRICS(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public LYRICS(AudioObject audioObject) {
	...
	public LYRICS(Audiobook audiobook) {
	...
	public LYRICS(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public LYRICS(BlogPosting blogPosting) {
	...
	public LYRICS(BookSeries bookSeries) {
	...
	public LYRICS(CategoryCodeSet categoryCodeSet) {
	...
	public LYRICS(CheckoutPage checkoutPage) {
	...
	public LYRICS(ClaimReview claimReview) {
	...
	public LYRICS(Collection collection) {
	...
	public LYRICS(CollectionPage collectionPage) {
	...
	public LYRICS(ComicCoverArt comicCoverArt) {
	...
	public LYRICS(ComicIssue comicIssue) {
	...
	public LYRICS(ComicSeries comicSeries) {
	...
	public LYRICS(ComicStory comicStory) {
	...
	public LYRICS(CompleteDataFeed completeDataFeed) {
	...
	public LYRICS(ContactPage contactPage) {
	...
	public LYRICS(Conversation conversation) {
	...
	public LYRICS(CorrectionComment correctionComment) {
	...
	public LYRICS(CoverArt coverArt) {
	...
	public LYRICS(CreativeWork creativeWork) {
		creativeWorkList = new ArrayList<CreativeWork>();
	...
	public LYRICS(CreativeWorkSeason creativeWorkSeason) {
	...
	public LYRICS(CreativeWorkSeries creativeWorkSeries) {
	...
	public LYRICS(CriticReview criticReview) {
	...
	public LYRICS(DataCatalog dataCatalog) {
	...
	public LYRICS(DataDownload dataDownload) {
	...
	public LYRICS(DataFeed dataFeed) {
	...
	public LYRICS(DefinedTermSet definedTermSet) {
	...
	public LYRICS(DigitalDocument digitalDocument) {
	...
	public LYRICS(DiscussionForumPosting discussionForumPosting) {
	...
	public LYRICS(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public LYRICS(EmailMessage emailMessage) {
	...
	public LYRICS(EmployerReview employerReview) {
	...
	public LYRICS(ExercisePlan exercisePlan) {
	...
	public LYRICS(HowToDirection howToDirection) {
	...
	public LYRICS(HowToSection howToSection) {
	...
	public LYRICS(HowToStep howToStep) {
	...
	public LYRICS(HowToTip howToTip) {
	...
	public LYRICS(ImageGallery imageGallery) {
	...
	public LYRICS(ImageObject imageObject) {
	...
	public LYRICS(ItemPage itemPage) {
	...
	public LYRICS(Legislation legislation) {
	...
	public LYRICS(LegislationObject legislationObject) {
	...
	public LYRICS(LiveBlogPosting liveBlogPosting) {
	...
	public LYRICS(Manuscript manuscript) {
	...
	public LYRICS(MediaObject mediaObject) {
	...
	public LYRICS(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public LYRICS(MedicalWebPage medicalWebPage) {
	...
	public LYRICS(MenuSection menuSection) {
	...
	public LYRICS(MobileApplication mobileApplication) {
	...
	public LYRICS(MovieClip movieClip) {
	...
	public LYRICS(MovieSeries movieSeries) {
	...
	public LYRICS(MusicAlbum musicAlbum) {
	...
	public LYRICS(MusicComposition musicComposition) {
	...
	public LYRICS(MusicPlaylist musicPlaylist) {
	...
	public LYRICS(MusicRecording musicRecording) {
	...
	public LYRICS(MusicRelease musicRelease) {
	...
	public LYRICS(MusicVideoObject musicVideoObject) {
	...
	public LYRICS(NewsArticle newsArticle) {
	...
	public LYRICS(Newspaper newspaper) {
	...
	public LYRICS(NoteDigitalDocument noteDigitalDocument) {
	...
	public LYRICS(OpinionNewsArticle opinionNewsArticle) {
	...
	public LYRICS(Painting painting) {
	...
	public LYRICS(Periodical periodical) {
	...
	public LYRICS(Photograph photograph) {
	...
	public LYRICS(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public LYRICS(ProfilePage profilePage) {
	...
	public LYRICS(PublicationIssue publicationIssue) {
	...
	public LYRICS(PublicationVolume publicationVolume) {
	...
	public LYRICS(Question question) {
	...
	public LYRICS(Quotation quotation) {
	...
	public LYRICS(RadioClip radioClip) {
	...
	public LYRICS(RadioEpisode radioEpisode) {
	...
	public LYRICS(RadioSeason radioSeason) {
	...
	public LYRICS(RadioSeries radioSeries) {
	...
	public LYRICS(ReportageNewsArticle reportageNewsArticle) {
	...
	public LYRICS(ReviewNewsArticle reviewNewsArticle) {
	...
	public LYRICS(SatiricalArticle satiricalArticle) {
	...
	public LYRICS(ScholarlyArticle scholarlyArticle) {
	...
	public LYRICS(Sculpture sculpture) {
	...
	public LYRICS(SearchResultsPage searchResultsPage) {
	...
	public LYRICS(SheetMusic sheetMusic) {
	...
	public LYRICS(ShortStory shortStory) {
	...
	public LYRICS(SiteNavigationElement siteNavigationElement) {
	...
	public LYRICS(SocialMediaPosting socialMediaPosting) {
	...
	public LYRICS(SoftwareApplication softwareApplication) {
	...
	public LYRICS(SoftwareSourceCode softwareSourceCode) {
	...
	public LYRICS(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public LYRICS(TVEpisode tvEpisode) {
	...
	public LYRICS(TVSeason tvSeason) {
	...
	public LYRICS(TVSeries tvSeries) {
	...
	public LYRICS(TechArticle techArticle) {
	...
	public LYRICS(TextDigitalDocument textDigitalDocument) {
	...
	public LYRICS(ThreeDimensionalModel threeDimensionalModel) {
	...
	public LYRICS(UserReview userReview) {
	...
	public LYRICS(VideoGallery videoGallery) {
	...
	public LYRICS(VideoGame videoGame) {
	...
	public LYRICS(VideoGameClip videoGameClip) {
	...
	public LYRICS(VideoGameSeries videoGameSeries) {
	...
	public LYRICS(VideoObject videoObject) {
	...
	public LYRICS(VisualArtwork visualArtwork) {
	...
	public LYRICS(WPAdBlock wpAdBlock) {
	...
	public LYRICS(WPFooter wpFooter) {
	...
	public LYRICS(WPHeader wpHeader) {
	...
	public LYRICS(WPSideBar wpSideBar) {
	...
	public LYRICS(WebApplication webApplication) {
	...
	public LYRICS(WebPageElement webPageElement) {
	...
	public void copy(Container.Lyrics org) {
