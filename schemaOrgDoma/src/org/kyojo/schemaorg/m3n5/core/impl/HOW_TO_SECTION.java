...
import org.kyojo.schemaorg.m3n5.core.Container.ItemListOrder;
...
import org.kyojo.schemaorg.m3n5.core.Container.NumberOfItems;
...
public class HOW_TO_SECTION implements Clazz.HowToSection {
	...
	public Item item;
	public ItemListElement itemListElement;
	public ItemListOrder itemListOrder;
	...
	public NumberOfItems numberOfItems;
	...
	public HOW_TO_SECTION() {
	}

	public HOW_TO_SECTION(Long seq) {
		setSeq(seq);
	}

	public HOW_TO_SECTION(String string) {
	...
	public HOW_TO_SECTION(About about) {
		setAbout(about);
	}
	...
	public HOW_TO_SECTION(AccessMode accessMode) {
	...
	public HOW_TO_SECTION(AccessModeSufficient accessModeSufficient) {
	...
	public HOW_TO_SECTION(AccessibilityAPI accessibilityAPI) {
	...
	public HOW_TO_SECTION(AccessibilityControl accessibilityControl) {
	...
	public HOW_TO_SECTION(AccessibilityFeature accessibilityFeature) {
	...
	public HOW_TO_SECTION(AccessibilityHazard accessibilityHazard) {
	...
	public HOW_TO_SECTION(AccessibilitySummary accessibilitySummary) {
	...
	public HOW_TO_SECTION(AccountablePerson accountablePerson) {
	...
	public HOW_TO_SECTION(AdditionalType additionalType) {
	...
	public HOW_TO_SECTION(AggregateRating aggregateRating) {
	...
	public HOW_TO_SECTION(AlternateName alternateName) {
	...
	public HOW_TO_SECTION(AlternativeHeadline alternativeHeadline) {
	...
	public HOW_TO_SECTION(AssociatedMedia associatedMedia) {
	...
	public HOW_TO_SECTION(Audience audience) {
	...
	public HOW_TO_SECTION(Audio audio) {
		setAudio(audio);
	}
	...
	public HOW_TO_SECTION(Author author) {
		setAuthor(author);
	}
	...
	public HOW_TO_SECTION(Award award) {
		setAward(award);
	}
	...
	public HOW_TO_SECTION(Character character) {
	...
	public HOW_TO_SECTION(Citation citation) {
	...
	public HOW_TO_SECTION(Comment comment) {
		setComment(comment);
	}
	...
	public HOW_TO_SECTION(CommentCount commentCount) {
	...
	public HOW_TO_SECTION(ContentLocation contentLocation) {
	...
	public HOW_TO_SECTION(ContentRating contentRating) {
	...
	public HOW_TO_SECTION(ContentReferenceTime contentReferenceTime) {
	...
	public HOW_TO_SECTION(Contributor contributor) {
	...
	public HOW_TO_SECTION(CopyrightHolder copyrightHolder) {
	...
	public HOW_TO_SECTION(CopyrightYear copyrightYear) {
	...
	public HOW_TO_SECTION(Correction correction) {
	...
	public HOW_TO_SECTION(Creator creator) {
		setCreator(creator);
	}
	...
	public HOW_TO_SECTION(DateCreated dateCreated) {
	...
	public HOW_TO_SECTION(DateModified dateModified) {
	...
	public HOW_TO_SECTION(DatePublished datePublished) {
	...
	public HOW_TO_SECTION(Description description) {
	...
	public HOW_TO_SECTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public HOW_TO_SECTION(DiscussionUrl discussionUrl) {
	...
	public HOW_TO_SECTION(Editor editor) {
		setEditor(editor);
	}
	...
	public HOW_TO_SECTION(EducationalAlignment educationalAlignment) {
	...
	public HOW_TO_SECTION(EducationalUse educationalUse) {
	...
	public HOW_TO_SECTION(Encoding encoding) {
	...
	public HOW_TO_SECTION(EncodingFormat encodingFormat) {
	...
	public HOW_TO_SECTION(ExampleOfWork exampleOfWork) {
	...
	public HOW_TO_SECTION(Expires expires) {
		setExpires(expires);
	}
	...
	public HOW_TO_SECTION(Funder funder) {
		setFunder(funder);
	}
	...
	public HOW_TO_SECTION(Genre genre) {
		setGenre(genre);
	}
	...
	public HOW_TO_SECTION(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public HOW_TO_SECTION(Headline headline) {
	...
	public HOW_TO_SECTION(Identifier identifier) {
	...
	public HOW_TO_SECTION(Image image) {
		setImage(image);
	}
	...
	public HOW_TO_SECTION(InLanguage inLanguage) {
	...
	public HOW_TO_SECTION(InteractionStatistic interactionStatistic) {
	...
	public HOW_TO_SECTION(InteractivityType interactivityType) {
	...
	public HOW_TO_SECTION(IsAccessibleForFree isAccessibleForFree) {
	...
	public HOW_TO_SECTION(IsBasedOn isBasedOn) {
	...
	public HOW_TO_SECTION(IsFamilyFriendly isFamilyFriendly) {
	...
	public HOW_TO_SECTION(IsPartOf isPartOf) {
	...
	public HOW_TO_SECTION(Item item) {
		setItem(item);
	}
	...
	public HOW_TO_SECTION(ItemListElement itemListElement) {
		setItemListElement(itemListElement);
	}

	@Override
	public ItemListElement getItemListElement() {
		return itemListElement;
	}

	@Override
	public void setItemListElement(ItemListElement itemListElement) {
		this.itemListElement = itemListElement;
	}

	public HOW_TO_SECTION(ItemListOrder itemListOrder) {
		setItemListOrder(itemListOrder);
	}

	@Override
	public ItemListOrder getItemListOrder() {
		return itemListOrder;
	}

	@Override
	public void setItemListOrder(ItemListOrder itemListOrder) {
		this.itemListOrder = itemListOrder;
	}

	public HOW_TO_SECTION(Keywords keywords) {
	...
	public HOW_TO_SECTION(LearningResourceType learningResourceType) {
	...
	public HOW_TO_SECTION(License license) {
		setLicense(license);
	}
	...
	public HOW_TO_SECTION(LocationCreated locationCreated) {
	...
	public HOW_TO_SECTION(MainEntity mainEntity) {
	...
	public HOW_TO_SECTION(MainEntityOfPage mainEntityOfPage) {
	...
	public HOW_TO_SECTION(Material material) {
	...
	public HOW_TO_SECTION(MaterialExtent materialExtent) {
	...
	public HOW_TO_SECTION(Mentions mentions) {
	...
	public HOW_TO_SECTION(Name name) {
		setName(name);
	}
	...
	public HOW_TO_SECTION(NameFuzzy nameFuzzy) {
	...
	public HOW_TO_SECTION(NameRuby nameRuby) {
	...
	public HOW_TO_SECTION(NextItem nextItem) {
	...
	public HOW_TO_SECTION(NumberOfItems numberOfItems) {
	...
	public HOW_TO_SECTION(Offers offers) {
		setOffers(offers);
	}
	...
	public HOW_TO_SECTION(Position position) {
	...
	public HOW_TO_SECTION(PotentialAction potentialAction) {
	...
	public HOW_TO_SECTION(PreviousItem previousItem) {
	...
	public HOW_TO_SECTION(Producer producer) {
	...
	public HOW_TO_SECTION(Provider provider) {
	...
	public HOW_TO_SECTION(Publication publication) {
	...
	public HOW_TO_SECTION(Publisher publisher) {
	...
	public HOW_TO_SECTION(PublisherImprint publisherImprint) {
	...
	public HOW_TO_SECTION(PublishingPrinciples publishingPrinciples) {
	...
	public HOW_TO_SECTION(RecordedAt recordedAt) {
	...
	public HOW_TO_SECTION(ReleasedEvent releasedEvent) {
	...
	public HOW_TO_SECTION(Review review) {
		setReview(review);
	}
	...
	public HOW_TO_SECTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public HOW_TO_SECTION(SchemaVersion schemaVersion) {
	...
	public HOW_TO_SECTION(SdDatePublished sdDatePublished) {
	...
	public HOW_TO_SECTION(SdLicense sdLicense) {
	...
	public HOW_TO_SECTION(SdPublisher sdPublisher) {
	...
	public HOW_TO_SECTION(SourceOrganization sourceOrganization) {
	...
	public HOW_TO_SECTION(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public HOW_TO_SECTION(SpatialCoverage spatialCoverage) {
	...
	public HOW_TO_SECTION(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public HOW_TO_SECTION(SubjectOf subjectOf) {
	...
	public HOW_TO_SECTION(Temporal temporal) {
	...
	public HOW_TO_SECTION(TemporalCoverage temporalCoverage) {
	...
	public HOW_TO_SECTION(Text text) {
		setText(text);
	}
	...
	public HOW_TO_SECTION(ThumbnailUrl thumbnailUrl) {
	...
	public HOW_TO_SECTION(TimeRequired timeRequired) {
	...
	public HOW_TO_SECTION(TranslationOfWork translationOfWork) {
	...
	public HOW_TO_SECTION(Translator translator) {
	...
	public HOW_TO_SECTION(TypicalAgeRange typicalAgeRange) {
	...
	public HOW_TO_SECTION(Version version) {
		setVersion(version);
	}
	...
	public HOW_TO_SECTION(Video video) {
		setVideo(video);
	}
	...
	public HOW_TO_SECTION(WorkExample workExample) {
	...
	public HOW_TO_SECTION(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.HowToSection org) {
		setSeq(org.getSeq());
		...
		setItem(org.getItem());
		setItemListElement(org.getItemListElement());
		setItemListOrder(org.getItemListOrder());
		...
		setNumberOfItems(org.getNumberOfItems());
