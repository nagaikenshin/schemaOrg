...
public class BEAUTY_SALON implements Clazz.BeautySalon {
	...
	public BEAUTY_SALON(GeoContains geoContains) {
	...
	public BEAUTY_SALON(GeoCoveredBy geoCoveredBy) {
	...
	public BEAUTY_SALON(GeoCovers geoCovers) {
	...
	public BEAUTY_SALON(GeoCrosses geoCrosses) {
	...
	public BEAUTY_SALON(GeoDisjoint geoDisjoint) {
	...
	public BEAUTY_SALON(GeoEquals geoEquals) {
	...
	public BEAUTY_SALON(GeoIntersects geoIntersects) {
	...
	public BEAUTY_SALON(GeoOverlaps geoOverlaps) {
	...
	public BEAUTY_SALON(GeoTouches geoTouches) {
	...
	public BEAUTY_SALON(GeoWithin geoWithin) {
	...
	public BEAUTY_SALON(Slogan slogan) {
		setSlogan(slogan);
	}
