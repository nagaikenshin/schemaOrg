...
public class LANDFORM implements Clazz.Landform {
	...
	public LANDFORM(GeoContains geoContains) {
	...
	public LANDFORM(GeoCoveredBy geoCoveredBy) {
	...
	public LANDFORM(GeoCovers geoCovers) {
	...
	public LANDFORM(GeoCrosses geoCrosses) {
	...
	public LANDFORM(GeoDisjoint geoDisjoint) {
	...
	public LANDFORM(GeoEquals geoEquals) {
	...
	public LANDFORM(GeoIntersects geoIntersects) {
	...
	public LANDFORM(GeoOverlaps geoOverlaps) {
	...
	public LANDFORM(GeoTouches geoTouches) {
	...
	public LANDFORM(GeoWithin geoWithin) {
