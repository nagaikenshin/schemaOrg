...
public class PARKING_FACILITY implements Clazz.ParkingFacility {
	...
	public PARKING_FACILITY(GeoContains geoContains) {
	...
	public PARKING_FACILITY(GeoCoveredBy geoCoveredBy) {
	...
	public PARKING_FACILITY(GeoCovers geoCovers) {
	...
	public PARKING_FACILITY(GeoCrosses geoCrosses) {
	...
	public PARKING_FACILITY(GeoDisjoint geoDisjoint) {
	...
	public PARKING_FACILITY(GeoEquals geoEquals) {
	...
	public PARKING_FACILITY(GeoIntersects geoIntersects) {
	...
	public PARKING_FACILITY(GeoOverlaps geoOverlaps) {
	...
	public PARKING_FACILITY(GeoTouches geoTouches) {
	...
	public PARKING_FACILITY(GeoWithin geoWithin) {
	...
	public PARKING_FACILITY(Slogan slogan) {
		setSlogan(slogan);
	}
