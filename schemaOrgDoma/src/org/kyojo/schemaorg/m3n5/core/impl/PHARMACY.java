...
public class PHARMACY implements Clazz.Pharmacy {
	...
	public PHARMACY(GeoContains geoContains) {
	...
	public PHARMACY(GeoCoveredBy geoCoveredBy) {
	...
	public PHARMACY(GeoCovers geoCovers) {
	...
	public PHARMACY(GeoCrosses geoCrosses) {
	...
	public PHARMACY(GeoDisjoint geoDisjoint) {
	...
	public PHARMACY(GeoEquals geoEquals) {
	...
	public PHARMACY(GeoIntersects geoIntersects) {
	...
	public PHARMACY(GeoOverlaps geoOverlaps) {
	...
	public PHARMACY(GeoTouches geoTouches) {
	...
	public PHARMACY(GeoWithin geoWithin) {
