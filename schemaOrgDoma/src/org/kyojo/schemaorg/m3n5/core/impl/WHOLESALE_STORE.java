...
public class WHOLESALE_STORE implements Clazz.WholesaleStore {
	...
	public WHOLESALE_STORE(GeoContains geoContains) {
	...
	public WHOLESALE_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public WHOLESALE_STORE(GeoCovers geoCovers) {
	...
	public WHOLESALE_STORE(GeoCrosses geoCrosses) {
	...
	public WHOLESALE_STORE(GeoDisjoint geoDisjoint) {
	...
	public WHOLESALE_STORE(GeoEquals geoEquals) {
	...
	public WHOLESALE_STORE(GeoIntersects geoIntersects) {
	...
	public WHOLESALE_STORE(GeoOverlaps geoOverlaps) {
	...
	public WHOLESALE_STORE(GeoTouches geoTouches) {
	...
	public WHOLESALE_STORE(GeoWithin geoWithin) {
	...
	public WHOLESALE_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
