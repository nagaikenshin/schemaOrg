...
public class GROCERY_STORE implements Clazz.GroceryStore {
	...
	public GROCERY_STORE(GeoContains geoContains) {
	...
	public GROCERY_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public GROCERY_STORE(GeoCovers geoCovers) {
	...
	public GROCERY_STORE(GeoCrosses geoCrosses) {
	...
	public GROCERY_STORE(GeoDisjoint geoDisjoint) {
	...
	public GROCERY_STORE(GeoEquals geoEquals) {
	...
	public GROCERY_STORE(GeoIntersects geoIntersects) {
	...
	public GROCERY_STORE(GeoOverlaps geoOverlaps) {
	...
	public GROCERY_STORE(GeoTouches geoTouches) {
	...
	public GROCERY_STORE(GeoWithin geoWithin) {
	...
	public GROCERY_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
