...
public class MAP implements Clazz.Map {
	...
	public MAP(AccessMode accessMode) {
	...
	public MAP(AccessModeSufficient accessModeSufficient) {
	...
	public MAP(AccessibilityAPI accessibilityAPI) {
	...
	public MAP(AccessibilityControl accessibilityControl) {
	...
	public MAP(AccessibilityFeature accessibilityFeature) {
	...
	public MAP(AccessibilityHazard accessibilityHazard) {
	...
	public MAP(AccessibilitySummary accessibilitySummary) {
	...
	public MAP(AccountablePerson accountablePerson) {
	...
	public MAP(AdditionalType additionalType) {
	...
	public MAP(AggregateRating aggregateRating) {
	...
	public MAP(AlternateName alternateName) {
	...
	public MAP(AlternativeHeadline alternativeHeadline) {
	...
	public MAP(AssociatedMedia associatedMedia) {
	...
	public MAP(CommentCount commentCount) {
	...
	public MAP(ContentLocation contentLocation) {
	...
	public MAP(ContentRating contentRating) {
	...
	public MAP(ContentReferenceTime contentReferenceTime) {
	...
	public MAP(Contributor contributor) {
	...
	public MAP(CopyrightHolder copyrightHolder) {
	...
	public MAP(CopyrightYear copyrightYear) {
	...
	public MAP(Correction correction) {
	...
	public MAP(DateCreated dateCreated) {
	...
	public MAP(DateModified dateModified) {
	...
	public MAP(DatePublished datePublished) {
	...
	public MAP(Description description) {
	...
	public MAP(DisambiguatingDescription disambiguatingDescription) {
	...
	public MAP(DiscussionUrl discussionUrl) {
	...
	public MAP(EducationalAlignment educationalAlignment) {
	...
	public MAP(EducationalUse educationalUse) {
	...
	public MAP(EncodingFormat encodingFormat) {
	...
	public MAP(ExampleOfWork exampleOfWork) {
	...
	public MAP(InLanguage inLanguage) {
	...
	public MAP(InteractionStatistic interactionStatistic) {
	...
	public MAP(InteractivityType interactivityType) {
	...
	public MAP(IsAccessibleForFree isAccessibleForFree) {
	...
	public MAP(IsBasedOn isBasedOn) {
	...
	public MAP(IsFamilyFriendly isFamilyFriendly) {
	...
	public MAP(LearningResourceType learningResourceType) {
	...
	public MAP(LocationCreated locationCreated) {
	...
	public MAP(MainEntity mainEntity) {
	...
	public MAP(MainEntityOfPage mainEntityOfPage) {
	...
	public MAP(MaterialExtent materialExtent) {
	...
	public MAP(NameFuzzy nameFuzzy) {
	...
	public MAP(PotentialAction potentialAction) {
	...
	public MAP(Publication publication) {
	...
	public MAP(Publisher publisher) {
	...
	public MAP(PublisherImprint publisherImprint) {
	...
	public MAP(PublishingPrinciples publishingPrinciples) {
	...
	public MAP(RecordedAt recordedAt) {
	...
	public MAP(ReleasedEvent releasedEvent) {
	...
	public MAP(SchemaVersion schemaVersion) {
	...
	public MAP(SdDatePublished sdDatePublished) {
	...
	public MAP(SdLicense sdLicense) {
	...
	public MAP(SdPublisher sdPublisher) {
	...
	public MAP(SourceOrganization sourceOrganization) {
	...
	public MAP(SpatialCoverage spatialCoverage) {
	...
	public MAP(SubjectOf subjectOf) {
	...
	public MAP(TemporalCoverage temporalCoverage) {
	...
	public MAP(ThumbnailUrl thumbnailUrl) {
	...
	public MAP(TimeRequired timeRequired) {
	...
	public MAP(TranslationOfWork translationOfWork) {
	...
	public MAP(TypicalAgeRange typicalAgeRange) {
	...
	public MAP(WorkExample workExample) {
	...
	public MAP(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Map org) {
		setSeq(org.getSeq());
