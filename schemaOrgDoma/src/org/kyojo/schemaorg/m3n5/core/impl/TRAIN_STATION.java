...
public class TRAIN_STATION implements Clazz.TrainStation {
	...
	public TRAIN_STATION(GeoContains geoContains) {
	...
	public TRAIN_STATION(GeoCoveredBy geoCoveredBy) {
	...
	public TRAIN_STATION(GeoCovers geoCovers) {
	...
	public TRAIN_STATION(GeoCrosses geoCrosses) {
	...
	public TRAIN_STATION(GeoDisjoint geoDisjoint) {
	...
	public TRAIN_STATION(GeoEquals geoEquals) {
	...
	public TRAIN_STATION(GeoIntersects geoIntersects) {
	...
	public TRAIN_STATION(GeoOverlaps geoOverlaps) {
	...
	public TRAIN_STATION(GeoTouches geoTouches) {
	...
	public TRAIN_STATION(GeoWithin geoWithin) {
	...
	public TRAIN_STATION(Slogan slogan) {
		setSlogan(slogan);
	}
