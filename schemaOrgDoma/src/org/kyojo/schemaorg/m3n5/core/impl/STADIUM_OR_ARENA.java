...
public class STADIUM_OR_ARENA implements Clazz.StadiumOrArena {
	...
	public STADIUM_OR_ARENA(GeoContains geoContains) {
	...
	public STADIUM_OR_ARENA(GeoCoveredBy geoCoveredBy) {
	...
	public STADIUM_OR_ARENA(GeoCovers geoCovers) {
	...
	public STADIUM_OR_ARENA(GeoCrosses geoCrosses) {
	...
	public STADIUM_OR_ARENA(GeoDisjoint geoDisjoint) {
	...
	public STADIUM_OR_ARENA(GeoEquals geoEquals) {
	...
	public STADIUM_OR_ARENA(GeoIntersects geoIntersects) {
	...
	public STADIUM_OR_ARENA(GeoOverlaps geoOverlaps) {
	...
	public STADIUM_OR_ARENA(GeoTouches geoTouches) {
	...
	public STADIUM_OR_ARENA(GeoWithin geoWithin) {
	...
	public STADIUM_OR_ARENA(Slogan slogan) {
		setSlogan(slogan);
	}
