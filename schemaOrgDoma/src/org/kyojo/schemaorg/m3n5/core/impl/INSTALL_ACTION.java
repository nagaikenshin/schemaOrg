...
public class INSTALL_ACTION implements Clazz.InstallAction {
	...
	public INSTALL_ACTION() {
	}

	public INSTALL_ACTION(Long seq) {
		setSeq(seq);
	}

	public INSTALL_ACTION(String string) {
	...
	public INSTALL_ACTION(ActionAccessibilityRequirement actionAccessibilityRequirement) {
	...
	public INSTALL_ACTION(ActionStatus actionStatus) {
	...
	public INSTALL_ACTION(AdditionalType additionalType) {
	...
	public INSTALL_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public INSTALL_ACTION(AlternateName alternateName) {
	...
	public INSTALL_ACTION(Description description) {
	...
	public INSTALL_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public INSTALL_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public INSTALL_ACTION(Error error) {
		setError(error);
	}
	...
	public INSTALL_ACTION(ExpectsAcceptanceOf expectsAcceptanceOf) {
	...
	public INSTALL_ACTION(Identifier identifier) {
	...
	public INSTALL_ACTION(Image image) {
		setImage(image);
	}
	...
	public INSTALL_ACTION(Instrument instrument) {
	...
	public INSTALL_ACTION(Location location) {
	...
	public INSTALL_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public INSTALL_ACTION(Name name) {
		setName(name);
	}
	...
	public INSTALL_ACTION(NameFuzzy nameFuzzy) {
	...
	public INSTALL_ACTION(NameRuby nameRuby) {
	...
	public INSTALL_ACTION(Object object) {
		setObject(object);
	}
	...
	public INSTALL_ACTION(Participant participant) {
	...
	public INSTALL_ACTION(PotentialAction potentialAction) {
	...
	public INSTALL_ACTION(Result result) {
		setResult(result);
	}
	...
	public INSTALL_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public INSTALL_ACTION(StartTime startTime) {
	...
	public INSTALL_ACTION(SubjectOf subjectOf) {
	...
	public INSTALL_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.InstallAction org) {
		setSeq(org.getSeq());
