...
public class RESERVATION_STATUS_TYPE implements Clazz.ReservationStatusType {
	...
	public RESERVATION_STATUS_TYPE(Long seq) {
		setSeq(seq);
	}

	public RESERVATION_STATUS_TYPE(String string) {
	...
	public RESERVATION_STATUS_TYPE(AdditionalType additionalType) {
	...
	public RESERVATION_STATUS_TYPE(AlternateName alternateName) {
	...
	public RESERVATION_STATUS_TYPE(Description description) {
	...
	public RESERVATION_STATUS_TYPE(DisambiguatingDescription disambiguatingDescription) {
	...
	public RESERVATION_STATUS_TYPE(Identifier identifier) {
	...
	public RESERVATION_STATUS_TYPE(Image image) {
		setImage(image);
	}
	...
	public RESERVATION_STATUS_TYPE(MainEntityOfPage mainEntityOfPage) {
	...
	public RESERVATION_STATUS_TYPE(Name name) {
		setName(name);
	}
	...
	public RESERVATION_STATUS_TYPE(NameFuzzy nameFuzzy) {
	...
	public RESERVATION_STATUS_TYPE(NameRuby nameRuby) {
	...
	public RESERVATION_STATUS_TYPE(PotentialAction potentialAction) {
	...
	public RESERVATION_STATUS_TYPE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RESERVATION_STATUS_TYPE(SubjectOf subjectOf) {
	...
	public RESERVATION_STATUS_TYPE(SupersededBy supersededBy) {
	...
	public RESERVATION_STATUS_TYPE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.ReservationStatusType org) {
		setSeq(org.getSeq());
