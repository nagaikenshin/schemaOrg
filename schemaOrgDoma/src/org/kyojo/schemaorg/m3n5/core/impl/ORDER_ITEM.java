...
import org.kyojo.schemaorg.m3n5.core.Container.OrderItemStatus;
...
public class ORDER_ITEM implements Clazz.OrderItem {
	...
	public ORDER_ITEM(String string) {
	...
	public ORDER_ITEM(AdditionalType additionalType) {
	...
	public ORDER_ITEM(AlternateName alternateName) {
	...
	public ORDER_ITEM(Description description) {
	...
	public ORDER_ITEM(DisambiguatingDescription disambiguatingDescription) {
	...
	public ORDER_ITEM(Identifier identifier) {
	...
	public ORDER_ITEM(MainEntityOfPage mainEntityOfPage) {
	...
	public ORDER_ITEM(NameFuzzy nameFuzzy) {
	...
	public ORDER_ITEM(NameRuby nameRuby) {
	...
	public ORDER_ITEM(OrderDelivery orderDelivery) {
	...
	public ORDER_ITEM(OrderItemNumber orderItemNumber) {
		setOrderItemNumber(orderItemNumber);
	}

	@Override
	public OrderItemNumber getOrderItemNumber() {
		return orderItemNumber;
	}

	@Override
	public void setOrderItemNumber(OrderItemNumber orderItemNumber) {
		this.orderItemNumber = orderItemNumber;
	}

	public ORDER_ITEM(OrderItemStatus orderItemStatus) {
	...
	public ORDER_ITEM(OrderQuantity orderQuantity) {
	...
	public ORDER_ITEM(OrderedItem orderedItem) {
	...
	public ORDER_ITEM(PotentialAction potentialAction) {
	...
	public ORDER_ITEM(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ORDER_ITEM(SubjectOf subjectOf) {
	...
	public void copy(Clazz.OrderItem org) {
		...
		setOrderItemNumber(org.getOrderItemNumber());
		setOrderItemStatus(org.getOrderItemStatus());
		setOrderQuantity(org.getOrderQuantity());
