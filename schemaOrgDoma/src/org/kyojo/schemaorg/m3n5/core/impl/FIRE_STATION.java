...
public class FIRE_STATION implements Clazz.FireStation {
	...
	public FIRE_STATION(GeoContains geoContains) {
	...
	public FIRE_STATION(GeoCoveredBy geoCoveredBy) {
	...
	public FIRE_STATION(GeoCovers geoCovers) {
	...
	public FIRE_STATION(GeoCrosses geoCrosses) {
	...
	public FIRE_STATION(GeoDisjoint geoDisjoint) {
	...
	public FIRE_STATION(GeoEquals geoEquals) {
	...
	public FIRE_STATION(GeoIntersects geoIntersects) {
	...
	public FIRE_STATION(GeoOverlaps geoOverlaps) {
	...
	public FIRE_STATION(GeoTouches geoTouches) {
	...
	public FIRE_STATION(GeoWithin geoWithin) {
	...
	public FIRE_STATION(Slogan slogan) {
		setSlogan(slogan);
	}
