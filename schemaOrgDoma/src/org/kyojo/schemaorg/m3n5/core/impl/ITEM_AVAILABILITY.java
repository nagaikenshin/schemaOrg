...
public class ITEM_AVAILABILITY implements Clazz.ItemAvailability {
	...
	public ITEM_AVAILABILITY(Long seq) {
		setSeq(seq);
	}

	public ITEM_AVAILABILITY(String string) {
	...
	public ITEM_AVAILABILITY(AdditionalType additionalType) {
	...
	public ITEM_AVAILABILITY(AlternateName alternateName) {
	...
	public ITEM_AVAILABILITY(Description description) {
	...
	public ITEM_AVAILABILITY(DisambiguatingDescription disambiguatingDescription) {
	...
	public ITEM_AVAILABILITY(Identifier identifier) {
	...
	public ITEM_AVAILABILITY(Image image) {
		setImage(image);
	}
	...
	public ITEM_AVAILABILITY(MainEntityOfPage mainEntityOfPage) {
	...
	public ITEM_AVAILABILITY(Name name) {
		setName(name);
	}
	...
	public ITEM_AVAILABILITY(NameFuzzy nameFuzzy) {
	...
	public ITEM_AVAILABILITY(NameRuby nameRuby) {
	...
	public ITEM_AVAILABILITY(PotentialAction potentialAction) {
	...
	public ITEM_AVAILABILITY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ITEM_AVAILABILITY(SubjectOf subjectOf) {
	...
	public ITEM_AVAILABILITY(SupersededBy supersededBy) {
	...
	public ITEM_AVAILABILITY(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.ItemAvailability org) {
		setSeq(org.getSeq());
