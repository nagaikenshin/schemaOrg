...
public class CITY implements Clazz.City {
	...
	public CITY(GeoContains geoContains) {
	...
	public CITY(GeoCoveredBy geoCoveredBy) {
	...
	public CITY(GeoCovers geoCovers) {
	...
	public CITY(GeoCrosses geoCrosses) {
	...
	public CITY(GeoDisjoint geoDisjoint) {
	...
	public CITY(GeoEquals geoEquals) {
	...
	public CITY(GeoIntersects geoIntersects) {
	...
	public CITY(GeoOverlaps geoOverlaps) {
	...
	public CITY(GeoTouches geoTouches) {
	...
	public CITY(GeoWithin geoWithin) {
