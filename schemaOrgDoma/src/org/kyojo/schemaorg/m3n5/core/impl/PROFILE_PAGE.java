...
public class PROFILE_PAGE implements Clazz.ProfilePage {
	...
	public PROFILE_PAGE(Long seq) {
		setSeq(seq);
	}

	public PROFILE_PAGE(String string) {
	...
	public PROFILE_PAGE(About about) {
		setAbout(about);
	}
	...
	public PROFILE_PAGE(AccessMode accessMode) {
	...
	public PROFILE_PAGE(AccessModeSufficient accessModeSufficient) {
	...
	public PROFILE_PAGE(AccessibilityAPI accessibilityAPI) {
	...
	public PROFILE_PAGE(AccessibilityControl accessibilityControl) {
	...
	public PROFILE_PAGE(AccessibilityFeature accessibilityFeature) {
	...
	public PROFILE_PAGE(AccessibilityHazard accessibilityHazard) {
	...
	public PROFILE_PAGE(AccessibilitySummary accessibilitySummary) {
	...
	public PROFILE_PAGE(AccountablePerson accountablePerson) {
	...
	public PROFILE_PAGE(AdditionalType additionalType) {
	...
	public PROFILE_PAGE(AggregateRating aggregateRating) {
	...
	public PROFILE_PAGE(AlternateName alternateName) {
	...
	public PROFILE_PAGE(AlternativeHeadline alternativeHeadline) {
	...
	public PROFILE_PAGE(AssociatedMedia associatedMedia) {
	...
	public PROFILE_PAGE(Audience audience) {
	...
	public PROFILE_PAGE(Audio audio) {
		setAudio(audio);
	}
	...
	public PROFILE_PAGE(Author author) {
		setAuthor(author);
	}
	...
	public PROFILE_PAGE(Award award) {
		setAward(award);
	}
	...
	public PROFILE_PAGE(Breadcrumb breadcrumb) {
	...
	public PROFILE_PAGE(Character character) {
	...
	public PROFILE_PAGE(Citation citation) {
	...
	public PROFILE_PAGE(Comment comment) {
		setComment(comment);
	}
	...
	public PROFILE_PAGE(CommentCount commentCount) {
	...
	public PROFILE_PAGE(ContentLocation contentLocation) {
	...
	public PROFILE_PAGE(ContentRating contentRating) {
	...
	public PROFILE_PAGE(ContentReferenceTime contentReferenceTime) {
	...
	public PROFILE_PAGE(Contributor contributor) {
	...
	public PROFILE_PAGE(CopyrightHolder copyrightHolder) {
	...
	public PROFILE_PAGE(CopyrightYear copyrightYear) {
	...
	public PROFILE_PAGE(Correction correction) {
	...
	public PROFILE_PAGE(Creator creator) {
		setCreator(creator);
	}
	...
	public PROFILE_PAGE(DateCreated dateCreated) {
	...
	public PROFILE_PAGE(DateModified dateModified) {
	...
	public PROFILE_PAGE(DatePublished datePublished) {
	...
	public PROFILE_PAGE(Description description) {
	...
	public PROFILE_PAGE(DisambiguatingDescription disambiguatingDescription) {
	...
	public PROFILE_PAGE(DiscussionUrl discussionUrl) {
	...
	public PROFILE_PAGE(Editor editor) {
		setEditor(editor);
	}
	...
	public PROFILE_PAGE(EducationalAlignment educationalAlignment) {
	...
	public PROFILE_PAGE(EducationalUse educationalUse) {
	...
	public PROFILE_PAGE(Encoding encoding) {
	...
	public PROFILE_PAGE(EncodingFormat encodingFormat) {
	...
	public PROFILE_PAGE(ExampleOfWork exampleOfWork) {
	...
	public PROFILE_PAGE(Expires expires) {
		setExpires(expires);
	}
	...
	public PROFILE_PAGE(Funder funder) {
		setFunder(funder);
	}
	...
	public PROFILE_PAGE(Genre genre) {
		setGenre(genre);
	}
	...
	public PROFILE_PAGE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public PROFILE_PAGE(Headline headline) {
	...
	public PROFILE_PAGE(Identifier identifier) {
	...
	public PROFILE_PAGE(Image image) {
		setImage(image);
	}
	...
	public PROFILE_PAGE(InLanguage inLanguage) {
	...
	public PROFILE_PAGE(InteractionStatistic interactionStatistic) {
	...
	public PROFILE_PAGE(InteractivityType interactivityType) {
	...
	public PROFILE_PAGE(IsAccessibleForFree isAccessibleForFree) {
	...
	public PROFILE_PAGE(IsBasedOn isBasedOn) {
	...
	public PROFILE_PAGE(IsFamilyFriendly isFamilyFriendly) {
	...
	public PROFILE_PAGE(IsPartOf isPartOf) {
	...
	public PROFILE_PAGE(Keywords keywords) {
	...
	public PROFILE_PAGE(LastReviewed lastReviewed) {
	...
	public PROFILE_PAGE(LearningResourceType learningResourceType) {
	...
	public PROFILE_PAGE(License license) {
		setLicense(license);
	}
	...
	public PROFILE_PAGE(LocationCreated locationCreated) {
	...
	public PROFILE_PAGE(MainContentOfPage mainContentOfPage) {
	...
	public PROFILE_PAGE(MainEntity mainEntity) {
	...
	public PROFILE_PAGE(MainEntityOfPage mainEntityOfPage) {
	...
	public PROFILE_PAGE(Material material) {
	...
	public PROFILE_PAGE(MaterialExtent materialExtent) {
	...
	public PROFILE_PAGE(Mentions mentions) {
	...
	public PROFILE_PAGE(NameFuzzy nameFuzzy) {
	...
	public PROFILE_PAGE(NameRuby nameRuby) {
	...
	public PROFILE_PAGE(Offers offers) {
		setOffers(offers);
	}
	...
	public PROFILE_PAGE(Position position) {
	...
	public PROFILE_PAGE(PotentialAction potentialAction) {
	...
	public PROFILE_PAGE(PrimaryImageOfPage primaryImageOfPage) {
	...
	public PROFILE_PAGE(Producer producer) {
	...
	public PROFILE_PAGE(Provider provider) {
	...
	public PROFILE_PAGE(Publication publication) {
	...
	public PROFILE_PAGE(Publisher publisher) {
	...
	public PROFILE_PAGE(PublisherImprint publisherImprint) {
	...
	public PROFILE_PAGE(PublishingPrinciples publishingPrinciples) {
	...
	public PROFILE_PAGE(RecordedAt recordedAt) {
	...
	public PROFILE_PAGE(RelatedLink relatedLink) {
	...
	public PROFILE_PAGE(ReleasedEvent releasedEvent) {
	...
	public PROFILE_PAGE(Review review) {
		setReview(review);
	}
	...
	public PROFILE_PAGE(ReviewedBy reviewedBy) {
	...
	public PROFILE_PAGE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PROFILE_PAGE(SchemaVersion schemaVersion) {
	...
	public PROFILE_PAGE(SdDatePublished sdDatePublished) {
	...
	public PROFILE_PAGE(SdLicense sdLicense) {
	...
	public PROFILE_PAGE(SdPublisher sdPublisher) {
	...
	public PROFILE_PAGE(SignificantLink significantLink) {
	...
	public PROFILE_PAGE(SourceOrganization sourceOrganization) {
	...
	public PROFILE_PAGE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public PROFILE_PAGE(SpatialCoverage spatialCoverage) {
	...
	public PROFILE_PAGE(Speakable speakable) {
	...
	public PROFILE_PAGE(Specialty specialty) {
	...
	public PROFILE_PAGE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public PROFILE_PAGE(SubjectOf subjectOf) {
	...
	public PROFILE_PAGE(Temporal temporal) {
	...
	public PROFILE_PAGE(TemporalCoverage temporalCoverage) {
	...
	public PROFILE_PAGE(ThumbnailUrl thumbnailUrl) {
	...
	public PROFILE_PAGE(TimeRequired timeRequired) {
	...
	public PROFILE_PAGE(TranslationOfWork translationOfWork) {
	...
	public PROFILE_PAGE(Translator translator) {
	...
	public PROFILE_PAGE(TypicalAgeRange typicalAgeRange) {
	...
	public PROFILE_PAGE(Version version) {
		setVersion(version);
	}
	...
	public PROFILE_PAGE(Video video) {
		setVideo(video);
	}
	...
	public PROFILE_PAGE(WorkExample workExample) {
	...
	public PROFILE_PAGE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.ProfilePage org) {
		setSeq(org.getSeq());
