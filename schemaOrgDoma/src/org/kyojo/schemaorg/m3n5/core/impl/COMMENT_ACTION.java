...
public class COMMENT_ACTION implements Clazz.CommentAction {
	...
	public ResultComment resultComment;
	...
	public COMMENT_ACTION(Long seq) {
		setSeq(seq);
	}

	public COMMENT_ACTION(String string) {
	...
	public COMMENT_ACTION(About about) {
		setAbout(about);
	}
	...
	public COMMENT_ACTION(ActionStatus actionStatus) {
	...
	public COMMENT_ACTION(AdditionalType additionalType) {
	...
	public COMMENT_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public COMMENT_ACTION(AlternateName alternateName) {
	...
	public COMMENT_ACTION(Description description) {
	...
	public COMMENT_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public COMMENT_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public COMMENT_ACTION(Error error) {
		setError(error);
	}
	...
	public COMMENT_ACTION(Identifier identifier) {
	...
	public COMMENT_ACTION(Image image) {
		setImage(image);
	}
	...
	public COMMENT_ACTION(InLanguage inLanguage) {
	...
	public COMMENT_ACTION(Instrument instrument) {
	...
	public COMMENT_ACTION(Location location) {
	...
	public COMMENT_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public COMMENT_ACTION(Name name) {
		setName(name);
	}
	...
	public COMMENT_ACTION(NameFuzzy nameFuzzy) {
	...
	public COMMENT_ACTION(NameRuby nameRuby) {
	...
	public COMMENT_ACTION(Object object) {
		setObject(object);
	}
	...
	public COMMENT_ACTION(Participant participant) {
	...
	public COMMENT_ACTION(PotentialAction potentialAction) {
	...
	public COMMENT_ACTION(Recipient recipient) {
	...
	public COMMENT_ACTION(Result result) {
		setResult(result);
	}
	...
	public COMMENT_ACTION(ResultComment resultComment) {
		setResultComment(resultComment);
	}
	...
	public COMMENT_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public COMMENT_ACTION(StartTime startTime) {
	...
	public COMMENT_ACTION(SubjectOf subjectOf) {
	...
	public COMMENT_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.CommentAction org) {
		setSeq(org.getSeq());
		...
		setResultComment(org.getResultComment());
