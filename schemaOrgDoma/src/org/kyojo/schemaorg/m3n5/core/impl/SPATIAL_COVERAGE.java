...
public class SPATIAL_COVERAGE implements Container.SpatialCoverage {
	...
	public SPATIAL_COVERAGE(String string) {
	...
	public SPATIAL_COVERAGE(Accommodation accommodation) {
	...
	public SPATIAL_COVERAGE(AccountingService accountingService) {
	...
	public SPATIAL_COVERAGE(AdministrativeArea administrativeArea) {
	...
	public SPATIAL_COVERAGE(AdultEntertainment adultEntertainment) {
	...
	public SPATIAL_COVERAGE(Airport airport) {
	...
	public SPATIAL_COVERAGE(AmusementPark amusementPark) {
	...
	public SPATIAL_COVERAGE(AnimalShelter animalShelter) {
	...
	public SPATIAL_COVERAGE(Apartment apartment) {
	...
	public SPATIAL_COVERAGE(ApartmentComplex apartmentComplex) {
	...
	public SPATIAL_COVERAGE(Aquarium aquarium) {
	...
	public SPATIAL_COVERAGE(ArchiveOrganization archiveOrganization) {
	...
	public SPATIAL_COVERAGE(ArtGallery artGallery) {
	...
	public SPATIAL_COVERAGE(Attorney attorney) {
	...
	public SPATIAL_COVERAGE(AutoBodyShop autoBodyShop) {
	...
	public SPATIAL_COVERAGE(AutoDealer autoDealer) {
	...
	public SPATIAL_COVERAGE(AutoPartsStore autoPartsStore) {
	...
	public SPATIAL_COVERAGE(AutoRental autoRental) {
	...
	public SPATIAL_COVERAGE(AutoRepair autoRepair) {
	...
	public SPATIAL_COVERAGE(AutoWash autoWash) {
	...
	public SPATIAL_COVERAGE(AutomatedTeller automatedTeller) {
	...
	public SPATIAL_COVERAGE(AutomotiveBusiness automotiveBusiness) {
	...
	public SPATIAL_COVERAGE(Bakery bakery) {
	...
	public SPATIAL_COVERAGE(BankOrCreditUnion bankOrCreditUnion) {
	...
	public SPATIAL_COVERAGE(BarOrPub barOrPub) {
	...
	public SPATIAL_COVERAGE(Beach beach) {
	...
	public SPATIAL_COVERAGE(BeautySalon beautySalon) {
	...
	public SPATIAL_COVERAGE(BedAndBreakfast bedAndBreakfast) {
	...
	public SPATIAL_COVERAGE(BikeStore bikeStore) {
	...
	public SPATIAL_COVERAGE(BodyOfWater bodyOfWater) {
	...
	public SPATIAL_COVERAGE(BookStore bookStore) {
	...
	public SPATIAL_COVERAGE(BowlingAlley bowlingAlley) {
	...
	public SPATIAL_COVERAGE(Brewery brewery) {
	...
	public SPATIAL_COVERAGE(Bridge bridge) {
	...
	public SPATIAL_COVERAGE(BuddhistTemple buddhistTemple) {
	...
	public SPATIAL_COVERAGE(BusStation busStation) {
	...
	public SPATIAL_COVERAGE(BusStop busStop) {
	...
	public SPATIAL_COVERAGE(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public SPATIAL_COVERAGE(Campground campground) {
	...
	public SPATIAL_COVERAGE(CampingPitch campingPitch) {
	...
	public SPATIAL_COVERAGE(Canal canal) {
	...
	public SPATIAL_COVERAGE(Casino casino) {
	...
	public SPATIAL_COVERAGE(CatholicChurch catholicChurch) {
	...
	public SPATIAL_COVERAGE(Cemetery cemetery) {
	...
	public SPATIAL_COVERAGE(ChildCare childCare) {
	...
	public SPATIAL_COVERAGE(Church church) {
	...
	public SPATIAL_COVERAGE(City city) {
	...
	public SPATIAL_COVERAGE(CityHall cityHall) {
	...
	public SPATIAL_COVERAGE(CivicStructure civicStructure) {
	...
	public SPATIAL_COVERAGE(ClothingStore clothingStore) {
	...
	public SPATIAL_COVERAGE(ComedyClub comedyClub) {
	...
	public SPATIAL_COVERAGE(CommunityHealth communityHealth) {
	...
	public SPATIAL_COVERAGE(ComputerStore computerStore) {
	...
	public SPATIAL_COVERAGE(Continent continent) {
	...
	public SPATIAL_COVERAGE(ConvenienceStore convenienceStore) {
	...
	public SPATIAL_COVERAGE(Country country) {
	...
	public SPATIAL_COVERAGE(Courthouse courthouse) {
	...
	public SPATIAL_COVERAGE(Crematorium crematorium) {
	...
	public SPATIAL_COVERAGE(DaySpa daySpa) {
	...
	public SPATIAL_COVERAGE(DefenceEstablishment defenceEstablishment) {
	...
	public SPATIAL_COVERAGE(Dentist dentist) {
	...
	public SPATIAL_COVERAGE(DepartmentStore departmentStore) {
	...
	public SPATIAL_COVERAGE(Dermatology dermatology) {
	...
	public SPATIAL_COVERAGE(DietNutrition dietNutrition) {
	...
	public SPATIAL_COVERAGE(Distillery distillery) {
	...
	public SPATIAL_COVERAGE(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public SPATIAL_COVERAGE(Electrician electrician) {
	...
	public SPATIAL_COVERAGE(ElectronicsStore electronicsStore) {
	...
	public SPATIAL_COVERAGE(Embassy embassy) {
	...
	public SPATIAL_COVERAGE(Emergency emergency) {
	...
	public SPATIAL_COVERAGE(EmergencyService emergencyService) {
	...
	public SPATIAL_COVERAGE(EmploymentAgency employmentAgency) {
	...
	public SPATIAL_COVERAGE(EntertainmentBusiness entertainmentBusiness) {
	...
	public SPATIAL_COVERAGE(EventVenue eventVenue) {
	...
	public SPATIAL_COVERAGE(ExerciseGym exerciseGym) {
	...
	public SPATIAL_COVERAGE(FastFoodRestaurant fastFoodRestaurant) {
	...
	public SPATIAL_COVERAGE(FinancialService financialService) {
	...
	public SPATIAL_COVERAGE(FireStation fireStation) {
	...
	public SPATIAL_COVERAGE(Florist florist) {
	...
	public SPATIAL_COVERAGE(FoodEstablishment foodEstablishment) {
	...
	public SPATIAL_COVERAGE(FurnitureStore furnitureStore) {
	...
	public SPATIAL_COVERAGE(GardenStore gardenStore) {
	...
	public SPATIAL_COVERAGE(GasStation gasStation) {
	...
	public SPATIAL_COVERAGE(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public SPATIAL_COVERAGE(GeneralContractor generalContractor) {
	...
	public SPATIAL_COVERAGE(Geriatric geriatric) {
	...
	public SPATIAL_COVERAGE(GolfCourse golfCourse) {
	...
	public SPATIAL_COVERAGE(GovernmentBuilding governmentBuilding) {
	...
	public SPATIAL_COVERAGE(GovernmentOffice governmentOffice) {
	...
	public SPATIAL_COVERAGE(GroceryStore groceryStore) {
	...
	public SPATIAL_COVERAGE(Gynecologic gynecologic) {
	...
	public SPATIAL_COVERAGE(HVACBusiness hvacBusiness) {
	...
	public SPATIAL_COVERAGE(HairSalon hairSalon) {
	...
	public SPATIAL_COVERAGE(HardwareStore hardwareStore) {
	...
	public SPATIAL_COVERAGE(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public SPATIAL_COVERAGE(HealthClub healthClub) {
	...
	public SPATIAL_COVERAGE(HinduTemple hinduTemple) {
	...
	public SPATIAL_COVERAGE(HobbyShop hobbyShop) {
	...
	public SPATIAL_COVERAGE(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public SPATIAL_COVERAGE(HomeGoodsStore homeGoodsStore) {
	...
	public SPATIAL_COVERAGE(Hospital hospital) {
	...
	public SPATIAL_COVERAGE(Hostel hostel) {
	...
	public SPATIAL_COVERAGE(Hotel hotel) {
	...
	public SPATIAL_COVERAGE(HotelRoom hotelRoom) {
	...
	public SPATIAL_COVERAGE(House house) {
	...
	public SPATIAL_COVERAGE(HousePainter housePainter) {
	...
	public SPATIAL_COVERAGE(IceCreamShop iceCreamShop) {
	...
	public SPATIAL_COVERAGE(InsuranceAgency insuranceAgency) {
	...
	public SPATIAL_COVERAGE(InternetCafe internetCafe) {
	...
	public SPATIAL_COVERAGE(JewelryStore jewelryStore) {
	...
	public SPATIAL_COVERAGE(LakeBodyOfWater lakeBodyOfWater) {
	...
	public SPATIAL_COVERAGE(Landform landform) {
	...
	public SPATIAL_COVERAGE(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public SPATIAL_COVERAGE(LegalService legalService) {
	...
	public SPATIAL_COVERAGE(LegislativeBuilding legislativeBuilding) {
	...
	public SPATIAL_COVERAGE(Library library) {
	...
	public SPATIAL_COVERAGE(LiquorStore liquorStore) {
	...
	public SPATIAL_COVERAGE(LocalBusiness localBusiness) {
	...
	public SPATIAL_COVERAGE(Locksmith locksmith) {
	...
	public SPATIAL_COVERAGE(LodgingBusiness lodgingBusiness) {
	...
	public SPATIAL_COVERAGE(MedicalBusiness medicalBusiness) {
	...
	public SPATIAL_COVERAGE(MedicalClinic medicalClinic) {
	...
	public SPATIAL_COVERAGE(MeetingRoom meetingRoom) {
	...
	public SPATIAL_COVERAGE(MensClothingStore mensClothingStore) {
	...
	public SPATIAL_COVERAGE(Midwifery midwifery) {
	...
	public SPATIAL_COVERAGE(MobilePhoneStore mobilePhoneStore) {
	...
	public SPATIAL_COVERAGE(Mosque mosque) {
	...
	public SPATIAL_COVERAGE(Motel motel) {
	...
	public SPATIAL_COVERAGE(MotorcycleDealer motorcycleDealer) {
	...
	public SPATIAL_COVERAGE(MotorcycleRepair motorcycleRepair) {
	...
	public SPATIAL_COVERAGE(Mountain mountain) {
	...
	public SPATIAL_COVERAGE(MovieRentalStore movieRentalStore) {
	...
	public SPATIAL_COVERAGE(MovieTheater movieTheater) {
	...
	public SPATIAL_COVERAGE(MovingCompany movingCompany) {
	...
	public SPATIAL_COVERAGE(Museum museum) {
	...
	public SPATIAL_COVERAGE(MusicStore musicStore) {
	...
	public SPATIAL_COVERAGE(MusicVenue musicVenue) {
	...
	public SPATIAL_COVERAGE(NailSalon nailSalon) {
	...
	public SPATIAL_COVERAGE(NightClub nightClub) {
	...
	public SPATIAL_COVERAGE(Notary notary) {
	...
	public SPATIAL_COVERAGE(Nursing nursing) {
	...
	public SPATIAL_COVERAGE(Obstetric obstetric) {
	...
	public SPATIAL_COVERAGE(OceanBodyOfWater oceanBodyOfWater) {
	...
	public SPATIAL_COVERAGE(OfficeEquipmentStore officeEquipmentStore) {
	...
	public SPATIAL_COVERAGE(Oncologic oncologic) {
	...
	public SPATIAL_COVERAGE(Optician optician) {
	...
	public SPATIAL_COVERAGE(Optometric optometric) {
	...
	public SPATIAL_COVERAGE(Otolaryngologic otolaryngologic) {
	...
	public SPATIAL_COVERAGE(OutletStore outletStore) {
	...
	public SPATIAL_COVERAGE(Park park) {
	...
	public SPATIAL_COVERAGE(ParkingFacility parkingFacility) {
	...
	public SPATIAL_COVERAGE(PawnShop pawnShop) {
	...
	public SPATIAL_COVERAGE(Pediatric pediatric) {
	...
	public SPATIAL_COVERAGE(PerformingArtsTheater performingArtsTheater) {
	...
	public SPATIAL_COVERAGE(PetStore petStore) {
	...
	public SPATIAL_COVERAGE(Pharmacy pharmacy) {
	...
	public SPATIAL_COVERAGE(Physician physician) {
	...
	public SPATIAL_COVERAGE(Physiotherapy physiotherapy) {
	...
	public SPATIAL_COVERAGE(Place place) {
		placeList = new ArrayList<Place>();
		placeList.add(place);
	}
	...
	public SPATIAL_COVERAGE(PlaceOfWorship placeOfWorship) {
	...
	public SPATIAL_COVERAGE(PlasticSurgery plasticSurgery) {
	...
	public SPATIAL_COVERAGE(Playground playground) {
	...
	public SPATIAL_COVERAGE(Plumber plumber) {
	...
	public SPATIAL_COVERAGE(Podiatric podiatric) {
	...
	public SPATIAL_COVERAGE(PoliceStation policeStation) {
	...
	public SPATIAL_COVERAGE(Pond pond) {
	...
	public SPATIAL_COVERAGE(PostOffice postOffice) {
	...
	public SPATIAL_COVERAGE(PrimaryCare primaryCare) {
	...
	public SPATIAL_COVERAGE(ProfessionalService professionalService) {
	...
	public SPATIAL_COVERAGE(Psychiatric psychiatric) {
	...
	public SPATIAL_COVERAGE(PublicHealth publicHealth) {
	...
	public SPATIAL_COVERAGE(PublicSwimmingPool publicSwimmingPool) {
	...
	public SPATIAL_COVERAGE(PublicToilet publicToilet) {
	...
	public SPATIAL_COVERAGE(RVPark rvPark) {
	...
	public SPATIAL_COVERAGE(RadioStation radioStation) {
	...
	public SPATIAL_COVERAGE(RealEstateAgent realEstateAgent) {
	...
	public SPATIAL_COVERAGE(RecyclingCenter recyclingCenter) {
	...
	public SPATIAL_COVERAGE(Reservoir reservoir) {
	...
	public SPATIAL_COVERAGE(Residence residence) {
	...
	public SPATIAL_COVERAGE(Resort resort) {
	...
	public SPATIAL_COVERAGE(Restaurant restaurant) {
	...
	public SPATIAL_COVERAGE(RiverBodyOfWater riverBodyOfWater) {
	...
	public SPATIAL_COVERAGE(RoofingContractor roofingContractor) {
	...
	public SPATIAL_COVERAGE(Room room) {
	...
	public SPATIAL_COVERAGE(SeaBodyOfWater seaBodyOfWater) {
	...
	public SPATIAL_COVERAGE(SelfStorage selfStorage) {
	...
	public SPATIAL_COVERAGE(ShoeStore shoeStore) {
	...
	public SPATIAL_COVERAGE(ShoppingCenter shoppingCenter) {
	...
	public SPATIAL_COVERAGE(SingleFamilyResidence singleFamilyResidence) {
	...
	public SPATIAL_COVERAGE(SkiResort skiResort) {
	...
	public SPATIAL_COVERAGE(SportingGoodsStore sportingGoodsStore) {
	...
	public SPATIAL_COVERAGE(SportsActivityLocation sportsActivityLocation) {
	...
	public SPATIAL_COVERAGE(SportsClub sportsClub) {
	...
	public SPATIAL_COVERAGE(StadiumOrArena stadiumOrArena) {
	...
	public SPATIAL_COVERAGE(State state) {
	...
	public SPATIAL_COVERAGE(Store store) {
	...
	public SPATIAL_COVERAGE(SubwayStation subwayStation) {
	...
	public SPATIAL_COVERAGE(Suite suite) {
	...
	public SPATIAL_COVERAGE(Synagogue synagogue) {
	...
	public SPATIAL_COVERAGE(TattooParlor tattooParlor) {
	...
	public SPATIAL_COVERAGE(TaxiStand taxiStand) {
	...
	public SPATIAL_COVERAGE(TelevisionStation televisionStation) {
	...
	public SPATIAL_COVERAGE(TennisComplex tennisComplex) {
	...
	public SPATIAL_COVERAGE(TireShop tireShop) {
	...
	public SPATIAL_COVERAGE(TouristAttraction touristAttraction) {
	...
	public SPATIAL_COVERAGE(TouristDestination touristDestination) {
	...
	public SPATIAL_COVERAGE(TouristInformationCenter touristInformationCenter) {
	...
	public SPATIAL_COVERAGE(ToyStore toyStore) {
	...
	public SPATIAL_COVERAGE(TrainStation trainStation) {
	...
	public SPATIAL_COVERAGE(TravelAgency travelAgency) {
	...
	public SPATIAL_COVERAGE(Volcano volcano) {
	...
	public SPATIAL_COVERAGE(Waterfall waterfall) {
	...
	public SPATIAL_COVERAGE(WholesaleStore wholesaleStore) {
	...
	public SPATIAL_COVERAGE(Winery winery) {
	...
	public SPATIAL_COVERAGE(Zoo zoo) {
	...
	public void copy(Container.SpatialCoverage org) {
