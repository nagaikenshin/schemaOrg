...
public class ACTION implements Clazz.Action {
	...
	public ACTION(AdditionalType additionalType) {
	...
	public ACTION(AlternateName alternateName) {
	...
	public ACTION(Description description) {
	...
	public ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public ACTION(Identifier identifier) {
	...
	public ACTION(Instrument instrument) {
	...
	public ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public ACTION(NameFuzzy nameFuzzy) {
	...
	public ACTION(NameRuby nameRuby) {
	...
	public ACTION(PotentialAction potentialAction) {
	...
	public ACTION(StartTime startTime) {
	...
	public ACTION(SubjectOf subjectOf) {
	...
	public void copy(Clazz.Action org) {
		setSeq(org.getSeq());
