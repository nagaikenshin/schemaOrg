...
public class GENERAL_CONTRACTOR implements Clazz.GeneralContractor {
	...
	public GENERAL_CONTRACTOR(GeoContains geoContains) {
	...
	public GENERAL_CONTRACTOR(GeoCoveredBy geoCoveredBy) {
	...
	public GENERAL_CONTRACTOR(GeoCovers geoCovers) {
	...
	public GENERAL_CONTRACTOR(GeoCrosses geoCrosses) {
	...
	public GENERAL_CONTRACTOR(GeoDisjoint geoDisjoint) {
	...
	public GENERAL_CONTRACTOR(GeoEquals geoEquals) {
	...
	public GENERAL_CONTRACTOR(GeoIntersects geoIntersects) {
	...
	public GENERAL_CONTRACTOR(GeoOverlaps geoOverlaps) {
	...
	public GENERAL_CONTRACTOR(GeoTouches geoTouches) {
	...
	public GENERAL_CONTRACTOR(GeoWithin geoWithin) {
	...
	public GENERAL_CONTRACTOR(Slogan slogan) {
		setSlogan(slogan);
	}
