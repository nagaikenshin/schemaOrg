...
public class DATASET implements Clazz.Dataset, Container.Dataset {
	...
	public DATASET(AccessMode accessMode) {
	...
	public DATASET(AccessModeSufficient accessModeSufficient) {
	...
	public DATASET(AccessibilityAPI accessibilityAPI) {
	...
	public DATASET(AccessibilityControl accessibilityControl) {
	...
	public DATASET(AccessibilityFeature accessibilityFeature) {
	...
	public DATASET(AccessibilityHazard accessibilityHazard) {
	...
	public DATASET(AccessibilitySummary accessibilitySummary) {
	...
	public DATASET(AccountablePerson accountablePerson) {
	...
	public DATASET(AdditionalType additionalType) {
	...
	public DATASET(AggregateRating aggregateRating) {
	...
	public DATASET(AlternateName alternateName) {
	...
	public DATASET(AlternativeHeadline alternativeHeadline) {
	...
	public DATASET(AssociatedMedia associatedMedia) {
	...
	public DATASET(Audience audience) {
	...
	public DATASET(Character character) {
	...
	public DATASET(Citation citation) {
	...
	public DATASET(Comment comment) {
		setComment(comment);
	}
	...
	public DATASET(CommentCount commentCount) {
	...
	public DATASET(ContentRating contentRating) {
	...
	public DATASET(ContentReferenceTime contentReferenceTime) {
	...
	public DATASET(Contributor contributor) {
	...
	public DATASET(CopyrightHolder copyrightHolder) {
	...
	public DATASET(CopyrightYear copyrightYear) {
	...
	public DATASET(Correction correction) {
	...
	public DATASET(Creator creator) {
		setCreator(creator);
	}
	...
	public DATASET(Clazz.Dataset dataset) {
		datasetList = new ArrayList<Clazz.Dataset>();
	...
	public DATASET(DateCreated dateCreated) {
	...
	public DATASET(DateModified dateModified) {
	...
	public DATASET(DatePublished datePublished) {
	...
	public DATASET(Description description) {
	...
	public DATASET(DisambiguatingDescription disambiguatingDescription) {
	...
	public DATASET(DiscussionUrl discussionUrl) {
	...
	public DATASET(EducationalAlignment educationalAlignment) {
	...
	public DATASET(EducationalUse educationalUse) {
	...
	public DATASET(Encoding encoding) {
	...
	public DATASET(EncodingFormat encodingFormat) {
	...
	public DATASET(ExampleOfWork exampleOfWork) {
	...
	public DATASET(Expires expires) {
		setExpires(expires);
	}
	...
	public DATASET(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public DATASET(Headline headline) {
	...
	public DATASET(Identifier identifier) {
	...
	public DATASET(InLanguage inLanguage) {
	...
	public DATASET(IncludedInDataCatalog includedInDataCatalog) {
	...
	public DATASET(InteractionStatistic interactionStatistic) {
	...
	public DATASET(InteractivityType interactivityType) {
	...
	public DATASET(IsAccessibleForFree isAccessibleForFree) {
	...
	public DATASET(IsBasedOn isBasedOn) {
	...
	public DATASET(IsFamilyFriendly isFamilyFriendly) {
	...
	public DATASET(IsPartOf isPartOf) {
	...
	public DATASET(Keywords keywords) {
	...
	public DATASET(LearningResourceType learningResourceType) {
	...
	public DATASET(LocationCreated locationCreated) {
	...
	public DATASET(MainEntity mainEntity) {
	...
	public DATASET(MainEntityOfPage mainEntityOfPage) {
	...
	public DATASET(Material material) {
	...
	public DATASET(MaterialExtent materialExtent) {
	...
	public DATASET(MeasurementTechnique measurementTechnique) {
	...
	public DATASET(Mentions mentions) {
	...
	public DATASET(NameFuzzy nameFuzzy) {
	...
	public DATASET(NameRuby nameRuby) {
	...
	public DATASET(Position position) {
	...
	public DATASET(PotentialAction potentialAction) {
	...
	public DATASET(Producer producer) {
	...
	public DATASET(Provider provider) {
	...
	public DATASET(Publication publication) {
	...
	public DATASET(Publisher publisher) {
	...
	public DATASET(PublisherImprint publisherImprint) {
	...
	public DATASET(PublishingPrinciples publishingPrinciples) {
	...
	public DATASET(RecordedAt recordedAt) {
	...
	public DATASET(ReleasedEvent releasedEvent) {
	...
	public DATASET(SchemaVersion schemaVersion) {
	...
	public DATASET(SdDatePublished sdDatePublished) {
	...
	public DATASET(SdLicense sdLicense) {
	...
	public DATASET(SdPublisher sdPublisher) {
	...
	public DATASET(SourceOrganization sourceOrganization) {
	...
	public DATASET(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public DATASET(SpatialCoverage spatialCoverage) {
	...
	public DATASET(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public DATASET(SubjectOf subjectOf) {
	...
	public DATASET(Temporal temporal) {
	...
	public DATASET(TemporalCoverage temporalCoverage) {
	...
	public DATASET(ThumbnailUrl thumbnailUrl) {
	...
	public DATASET(TimeRequired timeRequired) {
	...
	public DATASET(TranslationOfWork translationOfWork) {
	...
	public DATASET(Translator translator) {
	...
	public DATASET(TypicalAgeRange typicalAgeRange) {
	...
	public DATASET(VariableMeasured variableMeasured) {
	...
	public DATASET(Version version) {
		setVersion(version);
	}
	...
	public DATASET(WorkExample workExample) {
	...
	public DATASET(WorkTranslation workTranslation) {
