...
public class DENTIST implements Clazz.Dentist {
	...
	public DENTIST(GeoContains geoContains) {
	...
	public DENTIST(GeoCoveredBy geoCoveredBy) {
	...
	public DENTIST(GeoCovers geoCovers) {
	...
	public DENTIST(GeoCrosses geoCrosses) {
	...
	public DENTIST(GeoDisjoint geoDisjoint) {
	...
	public DENTIST(GeoEquals geoEquals) {
	...
	public DENTIST(GeoIntersects geoIntersects) {
	...
	public DENTIST(GeoOverlaps geoOverlaps) {
	...
	public DENTIST(GeoTouches geoTouches) {
	...
	public DENTIST(GeoWithin geoWithin) {
