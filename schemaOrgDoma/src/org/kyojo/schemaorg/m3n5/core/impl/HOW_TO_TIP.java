...
public class HOW_TO_TIP implements Clazz.HowToTip {
	...
	public HOW_TO_TIP(Long seq) {
		setSeq(seq);
	}

	public HOW_TO_TIP(String string) {
	...
	public HOW_TO_TIP(AccessMode accessMode) {
	...
	public HOW_TO_TIP(AccessModeSufficient accessModeSufficient) {
	...
	public HOW_TO_TIP(AccessibilityAPI accessibilityAPI) {
	...
	public HOW_TO_TIP(AccessibilityControl accessibilityControl) {
	...
	public HOW_TO_TIP(AccessibilityFeature accessibilityFeature) {
	...
	public HOW_TO_TIP(AccessibilityHazard accessibilityHazard) {
	...
	public HOW_TO_TIP(AccessibilitySummary accessibilitySummary) {
	...
	public HOW_TO_TIP(AccountablePerson accountablePerson) {
	...
	public HOW_TO_TIP(AdditionalType additionalType) {
	...
	public HOW_TO_TIP(AggregateRating aggregateRating) {
	...
	public HOW_TO_TIP(AlternateName alternateName) {
	...
	public HOW_TO_TIP(AlternativeHeadline alternativeHeadline) {
	...
	public HOW_TO_TIP(AssociatedMedia associatedMedia) {
	...
	public HOW_TO_TIP(Audience audience) {
	...
	public HOW_TO_TIP(Author author) {
		setAuthor(author);
	}
	...
	public HOW_TO_TIP(Character character) {
	...
	public HOW_TO_TIP(Citation citation) {
	...
	public HOW_TO_TIP(Comment comment) {
		setComment(comment);
	}
	...
	public HOW_TO_TIP(CommentCount commentCount) {
	...
	public HOW_TO_TIP(ContentLocation contentLocation) {
	...
	public HOW_TO_TIP(ContentRating contentRating) {
	...
	public HOW_TO_TIP(ContentReferenceTime contentReferenceTime) {
	...
	public HOW_TO_TIP(Contributor contributor) {
	...
	public HOW_TO_TIP(CopyrightHolder copyrightHolder) {
	...
	public HOW_TO_TIP(CopyrightYear copyrightYear) {
	...
	public HOW_TO_TIP(Correction correction) {
	...
	public HOW_TO_TIP(Creator creator) {
		setCreator(creator);
	}
	...
	public HOW_TO_TIP(DateCreated dateCreated) {
	...
	public HOW_TO_TIP(DateModified dateModified) {
	...
	public HOW_TO_TIP(DatePublished datePublished) {
	...
	public HOW_TO_TIP(Description description) {
	...
	public HOW_TO_TIP(DisambiguatingDescription disambiguatingDescription) {
	...
	public HOW_TO_TIP(DiscussionUrl discussionUrl) {
	...
	public HOW_TO_TIP(Editor editor) {
		setEditor(editor);
	}
	...
	public HOW_TO_TIP(EducationalAlignment educationalAlignment) {
	...
	public HOW_TO_TIP(EducationalUse educationalUse) {
	...
	public HOW_TO_TIP(Encoding encoding) {
	...
	public HOW_TO_TIP(EncodingFormat encodingFormat) {
	...
	public HOW_TO_TIP(ExampleOfWork exampleOfWork) {
	...
	public HOW_TO_TIP(Expires expires) {
		setExpires(expires);
	}
	...
	public HOW_TO_TIP(Funder funder) {
		setFunder(funder);
	}
	...
	public HOW_TO_TIP(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public HOW_TO_TIP(Headline headline) {
	...
	public HOW_TO_TIP(Identifier identifier) {
	...
	public HOW_TO_TIP(InLanguage inLanguage) {
	...
	public HOW_TO_TIP(InteractionStatistic interactionStatistic) {
	...
	public HOW_TO_TIP(InteractivityType interactivityType) {
	...
	public HOW_TO_TIP(IsAccessibleForFree isAccessibleForFree) {
	...
	public HOW_TO_TIP(IsBasedOn isBasedOn) {
	...
	public HOW_TO_TIP(IsFamilyFriendly isFamilyFriendly) {
	...
	public HOW_TO_TIP(IsPartOf isPartOf) {
	...
	public HOW_TO_TIP(Keywords keywords) {
	...
	public HOW_TO_TIP(LearningResourceType learningResourceType) {
	...
	public HOW_TO_TIP(License license) {
		setLicense(license);
	}
	...
	public HOW_TO_TIP(LocationCreated locationCreated) {
	...
	public HOW_TO_TIP(MainEntity mainEntity) {
	...
	public HOW_TO_TIP(MainEntityOfPage mainEntityOfPage) {
	...
	public HOW_TO_TIP(Material material) {
	...
	public HOW_TO_TIP(MaterialExtent materialExtent) {
	...
	public HOW_TO_TIP(Mentions mentions) {
	...
	public HOW_TO_TIP(NameFuzzy nameFuzzy) {
	...
	public HOW_TO_TIP(NameRuby nameRuby) {
	...
	public HOW_TO_TIP(NextItem nextItem) {
	...
	public HOW_TO_TIP(Offers offers) {
		setOffers(offers);
	}
	...
	public HOW_TO_TIP(Position position) {
	...
	public HOW_TO_TIP(PotentialAction potentialAction) {
	...
	public HOW_TO_TIP(PreviousItem previousItem) {
	...
	public HOW_TO_TIP(Producer producer) {
	...
	public HOW_TO_TIP(Provider provider) {
	...
	public HOW_TO_TIP(Publication publication) {
	...
	public HOW_TO_TIP(Publisher publisher) {
	...
	public HOW_TO_TIP(PublisherImprint publisherImprint) {
	...
	public HOW_TO_TIP(PublishingPrinciples publishingPrinciples) {
	...
	public HOW_TO_TIP(RecordedAt recordedAt) {
	...
	public HOW_TO_TIP(ReleasedEvent releasedEvent) {
	...
	public HOW_TO_TIP(Review review) {
		setReview(review);
	}
	...
	public HOW_TO_TIP(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public HOW_TO_TIP(SchemaVersion schemaVersion) {
	...
	public HOW_TO_TIP(SdDatePublished sdDatePublished) {
	...
	public HOW_TO_TIP(SdLicense sdLicense) {
	...
	public HOW_TO_TIP(SdPublisher sdPublisher) {
	...
	public HOW_TO_TIP(SourceOrganization sourceOrganization) {
	...
	public HOW_TO_TIP(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public HOW_TO_TIP(SpatialCoverage spatialCoverage) {
	...
	public HOW_TO_TIP(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public HOW_TO_TIP(SubjectOf subjectOf) {
	...
	public HOW_TO_TIP(Temporal temporal) {
	...
	public HOW_TO_TIP(TemporalCoverage temporalCoverage) {
	...
	public HOW_TO_TIP(ThumbnailUrl thumbnailUrl) {
	...
	public HOW_TO_TIP(TimeRequired timeRequired) {
	...
	public HOW_TO_TIP(TranslationOfWork translationOfWork) {
	...
	public HOW_TO_TIP(Translator translator) {
	...
	public HOW_TO_TIP(TypicalAgeRange typicalAgeRange) {
	...
	public HOW_TO_TIP(Version version) {
		setVersion(version);
	}
	...
	public HOW_TO_TIP(WorkExample workExample) {
	...
	public HOW_TO_TIP(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.HowToTip org) {
		setSeq(org.getSeq());
