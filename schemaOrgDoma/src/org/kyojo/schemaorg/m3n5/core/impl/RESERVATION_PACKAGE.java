...
import org.kyojo.schemaorg.m3n5.core.Container.ModifiedTime;
...
import org.kyojo.schemaorg.m3n5.core.Container.ReservationId;
...
import org.kyojo.schemaorg.m3n5.core.Container.TotalPrice;
import org.kyojo.schemaorg.m3n5.core.Container.UnderName;
...
public class RESERVATION_PACKAGE implements Clazz.ReservationPackage {
	...
	public SubReservation subReservation;
	public SubjectOf subjectOf;
	public TotalPrice totalPrice;
	public UnderName underName;
	public Url url;

	public RESERVATION_PACKAGE() {
	}

	public RESERVATION_PACKAGE(Long seq) {
		setSeq(seq);
	}

	public RESERVATION_PACKAGE(String string) {
	...
	public RESERVATION_PACKAGE(AdditionalType additionalType) {
	...
	public RESERVATION_PACKAGE(AlternateName alternateName) {
	...
	public RESERVATION_PACKAGE(BookingTime bookingTime) {
	...
	public RESERVATION_PACKAGE(Broker broker) {
		setBroker(broker);
	}
	...
	public RESERVATION_PACKAGE(Description description) {
	...
	public RESERVATION_PACKAGE(DisambiguatingDescription disambiguatingDescription) {
	...
	public RESERVATION_PACKAGE(Identifier identifier) {
	...
	public RESERVATION_PACKAGE(Image image) {
		setImage(image);
	}
	...
	public RESERVATION_PACKAGE(MainEntityOfPage mainEntityOfPage) {
	...
	public RESERVATION_PACKAGE(ModifiedTime modifiedTime) {
	...
	public RESERVATION_PACKAGE(Name name) {
		setName(name);
	}
	...
	public RESERVATION_PACKAGE(NameFuzzy nameFuzzy) {
	...
	public RESERVATION_PACKAGE(NameRuby nameRuby) {
	...
	public RESERVATION_PACKAGE(PotentialAction potentialAction) {
	...
	public RESERVATION_PACKAGE(PriceCurrency priceCurrency) {
	...
	public RESERVATION_PACKAGE(ProgramMembershipUsed programMembershipUsed) {
	...
	public RESERVATION_PACKAGE(Provider provider) {
	...
	public RESERVATION_PACKAGE(ReservationFor reservationFor) {
	...
	public RESERVATION_PACKAGE(ReservationId reservationId) {
	...
	public RESERVATION_PACKAGE(ReservationStatus reservationStatus) {
	...
	public RESERVATION_PACKAGE(ReservedTicket reservedTicket) {
	...
	public RESERVATION_PACKAGE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RESERVATION_PACKAGE(SubReservation subReservation) {
		setSubReservation(subReservation);
	}

	@Override
	public SubReservation getSubReservation() {
		return subReservation;
	}

	@Override
	public void setSubReservation(SubReservation subReservation) {
		this.subReservation = subReservation;
	}

	public RESERVATION_PACKAGE(SubjectOf subjectOf) {
	...
	public RESERVATION_PACKAGE(TotalPrice totalPrice) {
	...
	public RESERVATION_PACKAGE(UnderName underName) {
	...
	public RESERVATION_PACKAGE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.ReservationPackage org) {
		setSeq(org.getSeq());
		...
		setSubReservation(org.getSubReservation());
