...
import org.kyojo.schemaorg.m3n5.core.Container.Latitude;
import org.kyojo.schemaorg.m3n5.core.Container.Longitude;
...
public class GEO_COORDINATES implements Clazz.GeoCoordinates {
	...
	public GEO_COORDINATES(String string) {
	...
	public GEO_COORDINATES(AdditionalType additionalType) {
	...
	public GEO_COORDINATES(Address address) {
		setAddress(address);
	}
	...
	public GEO_COORDINATES(AddressCountry addressCountry) {
	...
	public GEO_COORDINATES(AlternateName alternateName) {
	...
	public GEO_COORDINATES(Description description) {
	...
	public GEO_COORDINATES(DisambiguatingDescription disambiguatingDescription) {
	...
	public GEO_COORDINATES(Elevation elevation) {
	...
	public GEO_COORDINATES(Identifier identifier) {
	...
	public GEO_COORDINATES(Image image) {
		setImage(image);
	}
	...
	public GEO_COORDINATES(Latitude latitude) {
	...
	public GEO_COORDINATES(Longitude longitude) {
	...
	public GEO_COORDINATES(MainEntityOfPage mainEntityOfPage) {
	...
	public GEO_COORDINATES(Name name) {
		setName(name);
	}
	...
	public GEO_COORDINATES(NameFuzzy nameFuzzy) {
	...
	public GEO_COORDINATES(NameRuby nameRuby) {
	...
	public GEO_COORDINATES(PostalCode postalCode) {
	...
	public GEO_COORDINATES(PotentialAction potentialAction) {
	...
	public GEO_COORDINATES(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public GEO_COORDINATES(SubjectOf subjectOf) {
	...
	public GEO_COORDINATES(Url url) {
		setUrl(url);
	}
