...
public class NAIL_SALON implements Clazz.NailSalon {
	...
	public NAIL_SALON(GeoContains geoContains) {
	...
	public NAIL_SALON(GeoCoveredBy geoCoveredBy) {
	...
	public NAIL_SALON(GeoCovers geoCovers) {
	...
	public NAIL_SALON(GeoCrosses geoCrosses) {
	...
	public NAIL_SALON(GeoDisjoint geoDisjoint) {
	...
	public NAIL_SALON(GeoEquals geoEquals) {
	...
	public NAIL_SALON(GeoIntersects geoIntersects) {
	...
	public NAIL_SALON(GeoOverlaps geoOverlaps) {
	...
	public NAIL_SALON(GeoTouches geoTouches) {
	...
	public NAIL_SALON(GeoWithin geoWithin) {
	...
	public NAIL_SALON(Slogan slogan) {
		setSlogan(slogan);
	}
