...
public class RATING implements Clazz.Rating {
	...
	public RATING(Long seq) {
		setSeq(seq);
	}

	public RATING(String string) {
	...
	public RATING(AdditionalType additionalType) {
	...
	public RATING(AlternateName alternateName) {
	...
	public RATING(BestRating bestRating) {
	...
	public RATING(Description description) {
	...
	public RATING(DisambiguatingDescription disambiguatingDescription) {
	...
	public RATING(Identifier identifier) {
	...
	public RATING(MainEntityOfPage mainEntityOfPage) {
	...
	public RATING(NameFuzzy nameFuzzy) {
	...
	public RATING(NameRuby nameRuby) {
	...
	public RATING(PotentialAction potentialAction) {
	...
	public RATING(RatingValue ratingValue) {
	...
	public RATING(ReviewAspect reviewAspect) {
	...
	public RATING(SubjectOf subjectOf) {
	...
	public RATING(WorstRating worstRating) {
	...
	public void copy(Clazz.Rating org) {
		setSeq(org.getSeq());
