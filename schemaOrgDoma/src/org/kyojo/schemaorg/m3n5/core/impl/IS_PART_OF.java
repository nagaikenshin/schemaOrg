...
public class IS_PART_OF implements Container.IsPartOf {
	...
	public IS_PART_OF(APIReference apiReference) {
	...
	public IS_PART_OF(AboutPage aboutPage) {
	...
	public IS_PART_OF(AdvertiserContentArticle advertiserContentArticle) {
	...
	public IS_PART_OF(AnalysisNewsArticle analysisNewsArticle) {
	...
	public IS_PART_OF(Answer answer) {
	...
	public IS_PART_OF(ArchiveComponent archiveComponent) {
	...
	public IS_PART_OF(Article article) {
	...
	public IS_PART_OF(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public IS_PART_OF(AudioObject audioObject) {
	...
	public IS_PART_OF(Audiobook audiobook) {
	...
	public IS_PART_OF(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public IS_PART_OF(Barcode barcode) {
	...
	public IS_PART_OF(BlogPosting blogPosting) {
	...
	public IS_PART_OF(BookSeries bookSeries) {
	...
	public IS_PART_OF(CategoryCodeSet categoryCodeSet) {
	...
	public IS_PART_OF(Chapter chapter) {
	...
	public IS_PART_OF(CheckoutPage checkoutPage) {
	...
	public IS_PART_OF(ClaimReview claimReview) {
	...
	public IS_PART_OF(Collection collection) {
	...
	public IS_PART_OF(CollectionPage collectionPage) {
	...
	public IS_PART_OF(ComicCoverArt comicCoverArt) {
	...
	public IS_PART_OF(ComicIssue comicIssue) {
	...
	public IS_PART_OF(ComicSeries comicSeries) {
	...
	public IS_PART_OF(ComicStory comicStory) {
	...
	public IS_PART_OF(Comment comment) {
	...
	public IS_PART_OF(CompleteDataFeed completeDataFeed) {
	...
	public IS_PART_OF(ContactPage contactPage) {
	...
	public IS_PART_OF(Conversation conversation) {
	...
	public IS_PART_OF(CorrectionComment correctionComment) {
	...
	public IS_PART_OF(Course course) {
	...
	public IS_PART_OF(CoverArt coverArt) {
	...
	public IS_PART_OF(CreativeWorkSeason creativeWorkSeason) {
	...
	public IS_PART_OF(CreativeWorkSeries creativeWorkSeries) {
	...
	public IS_PART_OF(CriticReview criticReview) {
	...
	public IS_PART_OF(DataCatalog dataCatalog) {
	...
	public IS_PART_OF(DataDownload dataDownload) {
	...
	public IS_PART_OF(DataFeed dataFeed) {
	...
	public IS_PART_OF(Dataset dataset) {
	...
	public IS_PART_OF(DefinedTermSet definedTermSet) {
	...
	public IS_PART_OF(DigitalDocument digitalDocument) {
	...
	public IS_PART_OF(DiscussionForumPosting discussionForumPosting) {
	...
	public IS_PART_OF(Drawing drawing) {
	...
	public IS_PART_OF(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public IS_PART_OF(EmailMessage emailMessage) {
	...
	public IS_PART_OF(EmployerReview employerReview) {
	...
	public IS_PART_OF(Episode episode) {
	...
	public IS_PART_OF(ExercisePlan exercisePlan) {
	...
	public IS_PART_OF(FAQPage faqPage) {
	...
	public IS_PART_OF(HowToDirection howToDirection) {
	...
	public IS_PART_OF(HowToSection howToSection) {
	...
	public IS_PART_OF(HowToStep howToStep) {
	...
	public IS_PART_OF(HowToTip howToTip) {
	...
	public IS_PART_OF(ImageGallery imageGallery) {
	...
	public IS_PART_OF(ImageObject imageObject) {
	...
	public IS_PART_OF(ItemPage itemPage) {
	...
	public IS_PART_OF(Legislation legislation) {
	...
	public IS_PART_OF(LegislationObject legislationObject) {
	...
	public IS_PART_OF(LiveBlogPosting liveBlogPosting) {
	...
	public IS_PART_OF(Manuscript manuscript) {
	...
	public IS_PART_OF(MediaObject mediaObject) {
	...
	public IS_PART_OF(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public IS_PART_OF(MedicalWebPage medicalWebPage) {
	...
	public IS_PART_OF(MenuSection menuSection) {
	...
	public IS_PART_OF(Message message) {
	...
	public IS_PART_OF(MobileApplication mobileApplication) {
	...
	public IS_PART_OF(MovieClip movieClip) {
	...
	public IS_PART_OF(MovieSeries movieSeries) {
	...
	public IS_PART_OF(MusicAlbum musicAlbum) {
	...
	public IS_PART_OF(MusicComposition musicComposition) {
	...
	public IS_PART_OF(MusicPlaylist musicPlaylist) {
	...
	public IS_PART_OF(MusicRecording musicRecording) {
	...
	public IS_PART_OF(MusicRelease musicRelease) {
	...
	public IS_PART_OF(MusicVideoObject musicVideoObject) {
	...
	public IS_PART_OF(NewsArticle newsArticle) {
	...
	public IS_PART_OF(Newspaper newspaper) {
	...
	public IS_PART_OF(NoteDigitalDocument noteDigitalDocument) {
	...
	public IS_PART_OF(OpinionNewsArticle opinionNewsArticle) {
	...
	public IS_PART_OF(Painting painting) {
	...
	public IS_PART_OF(Periodical periodical) {
	...
	public IS_PART_OF(Photograph photograph) {
	...
	public IS_PART_OF(Poster poster) {
	...
	public IS_PART_OF(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public IS_PART_OF(ProfilePage profilePage) {
	...
	public IS_PART_OF(PublicationIssue publicationIssue) {
	...
	public IS_PART_OF(PublicationVolume publicationVolume) {
	...
	public IS_PART_OF(QAPage qaPage) {
	...
	public IS_PART_OF(Question question) {
	...
	public IS_PART_OF(Quotation quotation) {
	...
	public IS_PART_OF(RadioClip radioClip) {
	...
	public IS_PART_OF(RadioEpisode radioEpisode) {
	...
	public IS_PART_OF(RadioSeason radioSeason) {
	...
	public IS_PART_OF(RadioSeries radioSeries) {
	...
	public IS_PART_OF(Recipe recipe) {
	...
	public IS_PART_OF(Report report) {
	...
	public IS_PART_OF(ReportageNewsArticle reportageNewsArticle) {
	...
	public IS_PART_OF(Review review) {
	...
	public IS_PART_OF(ReviewNewsArticle reviewNewsArticle) {
	...
	public IS_PART_OF(SatiricalArticle satiricalArticle) {
	...
	public IS_PART_OF(ScholarlyArticle scholarlyArticle) {
	...
	public IS_PART_OF(Sculpture sculpture) {
	...
	public IS_PART_OF(SearchResultsPage searchResultsPage) {
	...
	public IS_PART_OF(SheetMusic sheetMusic) {
	...
	public IS_PART_OF(ShortStory shortStory) {
	...
	public IS_PART_OF(SiteNavigationElement siteNavigationElement) {
	...
	public IS_PART_OF(SocialMediaPosting socialMediaPosting) {
	...
	public IS_PART_OF(SoftwareApplication softwareApplication) {
	...
	public IS_PART_OF(SoftwareSourceCode softwareSourceCode) {
	...
	public IS_PART_OF(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public IS_PART_OF(TVClip tvClip) {
	...
	public IS_PART_OF(TVEpisode tvEpisode) {
	...
	public IS_PART_OF(TVSeason tvSeason) {
	...
	public IS_PART_OF(TVSeries tvSeries) {
	...
	public IS_PART_OF(TechArticle techArticle) {
	...
	public IS_PART_OF(TextDigitalDocument textDigitalDocument) {
	...
	public IS_PART_OF(Thesis thesis) {
	...
	public IS_PART_OF(ThreeDimensionalModel threeDimensionalModel) {
	...
	public IS_PART_OF(UserReview userReview) {
	...
	public IS_PART_OF(VideoGallery videoGallery) {
	...
	public IS_PART_OF(VideoGame videoGame) {
	...
	public IS_PART_OF(VideoGameClip videoGameClip) {
	...
	public IS_PART_OF(VideoGameSeries videoGameSeries) {
	...
	public IS_PART_OF(VideoObject videoObject) {
	...
	public IS_PART_OF(VisualArtwork visualArtwork) {
	...
	public IS_PART_OF(WPAdBlock wpAdBlock) {
	...
	public IS_PART_OF(WPFooter wpFooter) {
	...
	public IS_PART_OF(WPHeader wpHeader) {
	...
	public IS_PART_OF(WPSideBar wpSideBar) {
	...
	public IS_PART_OF(WebApplication webApplication) {
	...
	public IS_PART_OF(WebPage webPage) {
	...
	public IS_PART_OF(WebPageElement webPageElement) {
	...
	public IS_PART_OF(WebSite webSite) {
