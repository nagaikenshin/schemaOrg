...
public class CONTACT_PAGE implements Clazz.ContactPage {
	...
	public CONTACT_PAGE(Long seq) {
		setSeq(seq);
	}

	public CONTACT_PAGE(String string) {
	...
	public CONTACT_PAGE(About about) {
		setAbout(about);
	}
	...
	public CONTACT_PAGE(AccessMode accessMode) {
	...
	public CONTACT_PAGE(AccessModeSufficient accessModeSufficient) {
	...
	public CONTACT_PAGE(AccessibilityAPI accessibilityAPI) {
	...
	public CONTACT_PAGE(AccessibilityControl accessibilityControl) {
	...
	public CONTACT_PAGE(AccessibilityFeature accessibilityFeature) {
	...
	public CONTACT_PAGE(AccessibilityHazard accessibilityHazard) {
	...
	public CONTACT_PAGE(AccessibilitySummary accessibilitySummary) {
	...
	public CONTACT_PAGE(AccountablePerson accountablePerson) {
	...
	public CONTACT_PAGE(AdditionalType additionalType) {
	...
	public CONTACT_PAGE(AggregateRating aggregateRating) {
	...
	public CONTACT_PAGE(AlternateName alternateName) {
	...
	public CONTACT_PAGE(AlternativeHeadline alternativeHeadline) {
	...
	public CONTACT_PAGE(AssociatedMedia associatedMedia) {
	...
	public CONTACT_PAGE(Audience audience) {
	...
	public CONTACT_PAGE(Audio audio) {
		setAudio(audio);
	}
	...
	public CONTACT_PAGE(Author author) {
		setAuthor(author);
	}
	...
	public CONTACT_PAGE(Award award) {
		setAward(award);
	}
	...
	public CONTACT_PAGE(Breadcrumb breadcrumb) {
	...
	public CONTACT_PAGE(Character character) {
	...
	public CONTACT_PAGE(Citation citation) {
	...
	public CONTACT_PAGE(Comment comment) {
		setComment(comment);
	}
	...
	public CONTACT_PAGE(CommentCount commentCount) {
	...
	public CONTACT_PAGE(ContentLocation contentLocation) {
	...
	public CONTACT_PAGE(ContentRating contentRating) {
	...
	public CONTACT_PAGE(ContentReferenceTime contentReferenceTime) {
	...
	public CONTACT_PAGE(Contributor contributor) {
	...
	public CONTACT_PAGE(CopyrightHolder copyrightHolder) {
	...
	public CONTACT_PAGE(CopyrightYear copyrightYear) {
	...
	public CONTACT_PAGE(Correction correction) {
	...
	public CONTACT_PAGE(Creator creator) {
		setCreator(creator);
	}
	...
	public CONTACT_PAGE(DateCreated dateCreated) {
	...
	public CONTACT_PAGE(DateModified dateModified) {
	...
	public CONTACT_PAGE(DatePublished datePublished) {
	...
	public CONTACT_PAGE(Description description) {
	...
	public CONTACT_PAGE(DisambiguatingDescription disambiguatingDescription) {
	...
	public CONTACT_PAGE(DiscussionUrl discussionUrl) {
	...
	public CONTACT_PAGE(Editor editor) {
		setEditor(editor);
	}
	...
	public CONTACT_PAGE(EducationalAlignment educationalAlignment) {
	...
	public CONTACT_PAGE(EducationalUse educationalUse) {
	...
	public CONTACT_PAGE(Encoding encoding) {
	...
	public CONTACT_PAGE(EncodingFormat encodingFormat) {
	...
	public CONTACT_PAGE(ExampleOfWork exampleOfWork) {
	...
	public CONTACT_PAGE(Expires expires) {
		setExpires(expires);
	}
	...
	public CONTACT_PAGE(Funder funder) {
		setFunder(funder);
	}
	...
	public CONTACT_PAGE(Genre genre) {
		setGenre(genre);
	}
	...
	public CONTACT_PAGE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public CONTACT_PAGE(Headline headline) {
	...
	public CONTACT_PAGE(Identifier identifier) {
	...
	public CONTACT_PAGE(Image image) {
		setImage(image);
	}
	...
	public CONTACT_PAGE(InLanguage inLanguage) {
	...
	public CONTACT_PAGE(InteractionStatistic interactionStatistic) {
	...
	public CONTACT_PAGE(InteractivityType interactivityType) {
	...
	public CONTACT_PAGE(IsAccessibleForFree isAccessibleForFree) {
	...
	public CONTACT_PAGE(IsBasedOn isBasedOn) {
	...
	public CONTACT_PAGE(IsFamilyFriendly isFamilyFriendly) {
	...
	public CONTACT_PAGE(IsPartOf isPartOf) {
	...
	public CONTACT_PAGE(Keywords keywords) {
	...
	public CONTACT_PAGE(LastReviewed lastReviewed) {
	...
	public CONTACT_PAGE(LearningResourceType learningResourceType) {
	...
	public CONTACT_PAGE(License license) {
		setLicense(license);
	}
	...
	public CONTACT_PAGE(LocationCreated locationCreated) {
	...
	public CONTACT_PAGE(MainContentOfPage mainContentOfPage) {
	...
	public CONTACT_PAGE(MainEntity mainEntity) {
	...
	public CONTACT_PAGE(MainEntityOfPage mainEntityOfPage) {
	...
	public CONTACT_PAGE(Material material) {
	...
	public CONTACT_PAGE(MaterialExtent materialExtent) {
	...
	public CONTACT_PAGE(Mentions mentions) {
	...
	public CONTACT_PAGE(NameFuzzy nameFuzzy) {
	...
	public CONTACT_PAGE(NameRuby nameRuby) {
	...
	public CONTACT_PAGE(Offers offers) {
		setOffers(offers);
	}
	...
	public CONTACT_PAGE(Position position) {
	...
	public CONTACT_PAGE(PotentialAction potentialAction) {
	...
	public CONTACT_PAGE(PrimaryImageOfPage primaryImageOfPage) {
	...
	public CONTACT_PAGE(Producer producer) {
	...
	public CONTACT_PAGE(Provider provider) {
	...
	public CONTACT_PAGE(Publication publication) {
	...
	public CONTACT_PAGE(Publisher publisher) {
	...
	public CONTACT_PAGE(PublisherImprint publisherImprint) {
	...
	public CONTACT_PAGE(PublishingPrinciples publishingPrinciples) {
	...
	public CONTACT_PAGE(RecordedAt recordedAt) {
	...
	public CONTACT_PAGE(RelatedLink relatedLink) {
	...
	public CONTACT_PAGE(ReleasedEvent releasedEvent) {
	...
	public CONTACT_PAGE(Review review) {
		setReview(review);
	}
	...
	public CONTACT_PAGE(ReviewedBy reviewedBy) {
	...
	public CONTACT_PAGE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CONTACT_PAGE(SchemaVersion schemaVersion) {
	...
	public CONTACT_PAGE(SdDatePublished sdDatePublished) {
	...
	public CONTACT_PAGE(SdLicense sdLicense) {
	...
	public CONTACT_PAGE(SdPublisher sdPublisher) {
	...
	public CONTACT_PAGE(SignificantLink significantLink) {
	...
	public CONTACT_PAGE(SourceOrganization sourceOrganization) {
	...
	public CONTACT_PAGE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public CONTACT_PAGE(SpatialCoverage spatialCoverage) {
	...
	public CONTACT_PAGE(Speakable speakable) {
	...
	public CONTACT_PAGE(Specialty specialty) {
	...
	public CONTACT_PAGE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public CONTACT_PAGE(SubjectOf subjectOf) {
	...
	public CONTACT_PAGE(Temporal temporal) {
	...
	public CONTACT_PAGE(TemporalCoverage temporalCoverage) {
	...
	public CONTACT_PAGE(ThumbnailUrl thumbnailUrl) {
	...
	public CONTACT_PAGE(TimeRequired timeRequired) {
	...
	public CONTACT_PAGE(TranslationOfWork translationOfWork) {
	...
	public CONTACT_PAGE(Translator translator) {
	...
	public CONTACT_PAGE(TypicalAgeRange typicalAgeRange) {
	...
	public CONTACT_PAGE(Version version) {
		setVersion(version);
	}
	...
	public CONTACT_PAGE(Video video) {
		setVideo(video);
	}
	...
	public CONTACT_PAGE(WorkExample workExample) {
	...
	public CONTACT_PAGE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.ContactPage org) {
		setSeq(org.getSeq());
