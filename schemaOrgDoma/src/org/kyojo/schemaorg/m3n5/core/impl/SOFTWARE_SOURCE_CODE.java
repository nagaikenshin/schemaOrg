...
import org.kyojo.schemaorg.m3n5.core.Container.CodeRepository;
import org.kyojo.schemaorg.m3n5.core.Container.CodeSampleType;
...
import org.kyojo.schemaorg.m3n5.core.Container.ProgrammingLanguage;
...
public class SOFTWARE_SOURCE_CODE implements Clazz.SoftwareSourceCode {
	...
	public SOFTWARE_SOURCE_CODE(Correction correction) {
	...
	public SOFTWARE_SOURCE_CODE(EncodingFormat encodingFormat) {
	...
	public SOFTWARE_SOURCE_CODE(MaterialExtent materialExtent) {
	...
	public SOFTWARE_SOURCE_CODE(SdDatePublished sdDatePublished) {
	...
	public SOFTWARE_SOURCE_CODE(SdLicense sdLicense) {
	...
	public SOFTWARE_SOURCE_CODE(SdPublisher sdPublisher) {
	...
	public SOFTWARE_SOURCE_CODE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public SOFTWARE_SOURCE_CODE(SubjectOf subjectOf) {
	...
	public SOFTWARE_SOURCE_CODE(Temporal temporal) {
