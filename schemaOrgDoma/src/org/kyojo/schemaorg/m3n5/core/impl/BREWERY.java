...
public class BREWERY implements Clazz.Brewery {
	...
	public BREWERY(GeoContains geoContains) {
	...
	public BREWERY(GeoCoveredBy geoCoveredBy) {
	...
	public BREWERY(GeoCovers geoCovers) {
	...
	public BREWERY(GeoCrosses geoCrosses) {
	...
	public BREWERY(GeoDisjoint geoDisjoint) {
	...
	public BREWERY(GeoEquals geoEquals) {
	...
	public BREWERY(GeoIntersects geoIntersects) {
	...
	public BREWERY(GeoOverlaps geoOverlaps) {
	...
	public BREWERY(GeoTouches geoTouches) {
	...
	public BREWERY(GeoWithin geoWithin) {
