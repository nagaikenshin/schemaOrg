...
public class RECIPIENT implements Container.Recipient {
	...
	public RECIPIENT(AccountingService accountingService) {
	...
	public RECIPIENT(AdultEntertainment adultEntertainment) {
	...
	public RECIPIENT(Airline airline) {
	...
	public RECIPIENT(AmusementPark amusementPark) {
	...
	public RECIPIENT(AnimalShelter animalShelter) {
	...
	public RECIPIENT(ArchiveOrganization archiveOrganization) {
	...
	public RECIPIENT(ArtGallery artGallery) {
	...
	public RECIPIENT(Attorney attorney) {
	...
	public RECIPIENT(AutoBodyShop autoBodyShop) {
	...
	public RECIPIENT(AutoDealer autoDealer) {
	...
	public RECIPIENT(AutoPartsStore autoPartsStore) {
	...
	public RECIPIENT(AutoRental autoRental) {
	...
	public RECIPIENT(AutoRepair autoRepair) {
	...
	public RECIPIENT(AutoWash autoWash) {
	...
	public RECIPIENT(AutomatedTeller automatedTeller) {
	...
	public RECIPIENT(AutomotiveBusiness automotiveBusiness) {
	...
	public RECIPIENT(Bakery bakery) {
	...
	public RECIPIENT(BankOrCreditUnion bankOrCreditUnion) {
	...
	public RECIPIENT(BarOrPub barOrPub) {
	...
	public RECIPIENT(BeautySalon beautySalon) {
	...
	public RECIPIENT(BedAndBreakfast bedAndBreakfast) {
	...
	public RECIPIENT(BikeStore bikeStore) {
	...
	public RECIPIENT(BookStore bookStore) {
	...
	public RECIPIENT(BowlingAlley bowlingAlley) {
	...
	public RECIPIENT(Brewery brewery) {
	...
	public RECIPIENT(BusinessAudience businessAudience) {
	...
	public RECIPIENT(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public RECIPIENT(Campground campground) {
	...
	public RECIPIENT(Casino casino) {
	...
	public RECIPIENT(ChildCare childCare) {
	...
	public RECIPIENT(ClothingStore clothingStore) {
	...
	public RECIPIENT(CollegeOrUniversity collegeOrUniversity) {
	...
	public RECIPIENT(ComedyClub comedyClub) {
	...
	public RECIPIENT(CommunityHealth communityHealth) {
	...
	public RECIPIENT(ComputerStore computerStore) {
	...
	public RECIPIENT(Consortium consortium) {
	...
	public RECIPIENT(ConvenienceStore convenienceStore) {
	...
	public RECIPIENT(Corporation corporation) {
	...
	public RECIPIENT(DanceGroup danceGroup) {
	...
	public RECIPIENT(DaySpa daySpa) {
	...
	public RECIPIENT(Dentist dentist) {
	...
	public RECIPIENT(DepartmentStore departmentStore) {
	...
	public RECIPIENT(Dermatology dermatology) {
	...
	public RECIPIENT(DiagnosticLab diagnosticLab) {
	...
	public RECIPIENT(DietNutrition dietNutrition) {
	...
	public RECIPIENT(Distillery distillery) {
	...
	public RECIPIENT(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public RECIPIENT(EducationalAudience educationalAudience) {
	...
	public RECIPIENT(EducationalOrganization educationalOrganization) {
	...
	public RECIPIENT(Electrician electrician) {
	...
	public RECIPIENT(ElectronicsStore electronicsStore) {
	...
	public RECIPIENT(ElementarySchool elementarySchool) {
	...
	public RECIPIENT(Emergency emergency) {
	...
	public RECIPIENT(EmergencyService emergencyService) {
	...
	public RECIPIENT(EmploymentAgency employmentAgency) {
	...
	public RECIPIENT(EntertainmentBusiness entertainmentBusiness) {
	...
	public RECIPIENT(ExerciseGym exerciseGym) {
	...
	public RECIPIENT(FastFoodRestaurant fastFoodRestaurant) {
	...
	public RECIPIENT(FinancialService financialService) {
	...
	public RECIPIENT(FireStation fireStation) {
	...
	public RECIPIENT(Florist florist) {
	...
	public RECIPIENT(FoodEstablishment foodEstablishment) {
	...
	public RECIPIENT(FundingAgency fundingAgency) {
	...
	public RECIPIENT(FundingScheme fundingScheme) {
	...
	public RECIPIENT(FurnitureStore furnitureStore) {
	...
	public RECIPIENT(GardenStore gardenStore) {
	...
	public RECIPIENT(GasStation gasStation) {
	...
	public RECIPIENT(GeneralContractor generalContractor) {
	...
	public RECIPIENT(Geriatric geriatric) {
	...
	public RECIPIENT(GolfCourse golfCourse) {
	...
	public RECIPIENT(GovernmentOffice governmentOffice) {
	...
	public RECIPIENT(GovernmentOrganization governmentOrganization) {
	...
	public RECIPIENT(GroceryStore groceryStore) {
	...
	public RECIPIENT(Gynecologic gynecologic) {
	...
	public RECIPIENT(HVACBusiness hvacBusiness) {
	...
	public RECIPIENT(HairSalon hairSalon) {
	...
	public RECIPIENT(HardwareStore hardwareStore) {
	...
	public RECIPIENT(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public RECIPIENT(HealthClub healthClub) {
	...
	public RECIPIENT(HighSchool highSchool) {
	...
	public RECIPIENT(HobbyShop hobbyShop) {
	...
	public RECIPIENT(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public RECIPIENT(HomeGoodsStore homeGoodsStore) {
	...
	public RECIPIENT(Hospital hospital) {
	...
	public RECIPIENT(Hostel hostel) {
	...
	public RECIPIENT(HousePainter housePainter) {
	...
	public RECIPIENT(IceCreamShop iceCreamShop) {
	...
	public RECIPIENT(InsuranceAgency insuranceAgency) {
	...
	public RECIPIENT(InternetCafe internetCafe) {
	...
	public RECIPIENT(JewelryStore jewelryStore) {
	...
	public RECIPIENT(LegalService legalService) {
	...
	public RECIPIENT(Library library) {
	...
	public RECIPIENT(LibrarySystem librarySystem) {
	...
	public RECIPIENT(LiquorStore liquorStore) {
	...
	public RECIPIENT(LocalBusiness localBusiness) {
	...
	public RECIPIENT(Locksmith locksmith) {
	...
	public RECIPIENT(LodgingBusiness lodgingBusiness) {
	...
	public RECIPIENT(MedicalAudience medicalAudience) {
	...
	public RECIPIENT(MedicalBusiness medicalBusiness) {
	...
	public RECIPIENT(MedicalClinic medicalClinic) {
	...
	public RECIPIENT(MedicalOrganization medicalOrganization) {
	...
	public RECIPIENT(MensClothingStore mensClothingStore) {
	...
	public RECIPIENT(MiddleSchool middleSchool) {
	...
	public RECIPIENT(Midwifery midwifery) {
	...
	public RECIPIENT(MobilePhoneStore mobilePhoneStore) {
	...
	public RECIPIENT(MotorcycleDealer motorcycleDealer) {
	...
	public RECIPIENT(MotorcycleRepair motorcycleRepair) {
	...
	public RECIPIENT(MovieRentalStore movieRentalStore) {
	...
	public RECIPIENT(MovieTheater movieTheater) {
	...
	public RECIPIENT(MovingCompany movingCompany) {
	...
	public RECIPIENT(MusicGroup musicGroup) {
	...
	public RECIPIENT(MusicStore musicStore) {
	...
	public RECIPIENT(NailSalon nailSalon) {
	...
	public RECIPIENT(NewsMediaOrganization newsMediaOrganization) {
	...
	public RECIPIENT(NightClub nightClub) {
	...
	public RECIPIENT(Notary notary) {
	...
	public RECIPIENT(Nursing nursing) {
	...
	public RECIPIENT(Obstetric obstetric) {
	...
	public RECIPIENT(OfficeEquipmentStore officeEquipmentStore) {
	...
	public RECIPIENT(Oncologic oncologic) {
	...
	public RECIPIENT(Optician optician) {
	...
	public RECIPIENT(Optometric optometric) {
	...
	public RECIPIENT(Otolaryngologic otolaryngologic) {
	...
	public RECIPIENT(OutletStore outletStore) {
	...
	public RECIPIENT(ParentAudience parentAudience) {
	...
	public RECIPIENT(PawnShop pawnShop) {
	...
	public RECIPIENT(Pediatric pediatric) {
	...
	public RECIPIENT(PeopleAudience peopleAudience) {
	...
	public RECIPIENT(PerformingGroup performingGroup) {
	...
	public RECIPIENT(PetStore petStore) {
	...
	public RECIPIENT(Pharmacy pharmacy) {
	...
	public RECIPIENT(Physician physician) {
	...
	public RECIPIENT(Physiotherapy physiotherapy) {
	...
	public RECIPIENT(PlasticSurgery plasticSurgery) {
	...
	public RECIPIENT(Plumber plumber) {
	...
	public RECIPIENT(Podiatric podiatric) {
	...
	public RECIPIENT(PoliceStation policeStation) {
	...
	public RECIPIENT(PostOffice postOffice) {
	...
	public RECIPIENT(PostalAddress postalAddress) {
	...
	public RECIPIENT(Preschool preschool) {
	...
	public RECIPIENT(PrimaryCare primaryCare) {
	...
	public RECIPIENT(ProfessionalService professionalService) {
	...
	public RECIPIENT(Project project) {
	...
	public RECIPIENT(Psychiatric psychiatric) {
	...
	public RECIPIENT(PublicHealth publicHealth) {
	...
	public RECIPIENT(PublicSwimmingPool publicSwimmingPool) {
	...
	public RECIPIENT(RadioStation radioStation) {
	...
	public RECIPIENT(RealEstateAgent realEstateAgent) {
	...
	public RECIPIENT(RecyclingCenter recyclingCenter) {
	...
	public RECIPIENT(ResearchProject researchProject) {
	...
	public RECIPIENT(Resort resort) {
	...
	public RECIPIENT(Restaurant restaurant) {
	...
	public RECIPIENT(RoofingContractor roofingContractor) {
	...
	public RECIPIENT(School school) {
	...
	public RECIPIENT(SelfStorage selfStorage) {
	...
	public RECIPIENT(ShoeStore shoeStore) {
	...
	public RECIPIENT(ShoppingCenter shoppingCenter) {
	...
	public RECIPIENT(SkiResort skiResort) {
	...
	public RECIPIENT(SportingGoodsStore sportingGoodsStore) {
	...
	public RECIPIENT(SportsActivityLocation sportsActivityLocation) {
	...
	public RECIPIENT(SportsClub sportsClub) {
	...
	public RECIPIENT(SportsOrganization sportsOrganization) {
	...
	public RECIPIENT(SportsTeam sportsTeam) {
	...
	public RECIPIENT(StadiumOrArena stadiumOrArena) {
	...
	public RECIPIENT(TattooParlor tattooParlor) {
	...
	public RECIPIENT(TelevisionStation televisionStation) {
	...
	public RECIPIENT(TennisComplex tennisComplex) {
	...
	public RECIPIENT(TheaterGroup theaterGroup) {
	...
	public RECIPIENT(TireShop tireShop) {
	...
	public RECIPIENT(TouristInformationCenter touristInformationCenter) {
	...
	public RECIPIENT(ToyStore toyStore) {
	...
	public RECIPIENT(TravelAgency travelAgency) {
	...
	public RECIPIENT(VeterinaryCare veterinaryCare) {
	...
	public RECIPIENT(WholesaleStore wholesaleStore) {
	...
	public RECIPIENT(Winery winery) {
	...
	public RECIPIENT(WorkersUnion workersUnion) {
	...
	public void copy(Container.Recipient org) {
