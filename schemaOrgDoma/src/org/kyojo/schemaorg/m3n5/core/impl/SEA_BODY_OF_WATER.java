...
public class SEA_BODY_OF_WATER implements Clazz.SeaBodyOfWater {
	...
	public SEA_BODY_OF_WATER(GeoContains geoContains) {
	...
	public SEA_BODY_OF_WATER(GeoCoveredBy geoCoveredBy) {
	...
	public SEA_BODY_OF_WATER(GeoCovers geoCovers) {
	...
	public SEA_BODY_OF_WATER(GeoCrosses geoCrosses) {
	...
	public SEA_BODY_OF_WATER(GeoDisjoint geoDisjoint) {
	...
	public SEA_BODY_OF_WATER(GeoEquals geoEquals) {
	...
	public SEA_BODY_OF_WATER(GeoIntersects geoIntersects) {
	...
	public SEA_BODY_OF_WATER(GeoOverlaps geoOverlaps) {
	...
	public SEA_BODY_OF_WATER(GeoTouches geoTouches) {
	...
	public SEA_BODY_OF_WATER(GeoWithin geoWithin) {
	...
	public SEA_BODY_OF_WATER(Slogan slogan) {
		setSlogan(slogan);
	}
