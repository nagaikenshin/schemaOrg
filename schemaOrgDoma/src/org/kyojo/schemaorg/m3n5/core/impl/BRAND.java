...
public class BRAND implements Clazz.Brand, Container.Brand {
	...
	public BRAND(AccountingService accountingService) {
	...
	public BRAND(AdultEntertainment adultEntertainment) {
	...
	public BRAND(AmusementPark amusementPark) {
	...
	public BRAND(AnimalShelter animalShelter) {
	...
	public BRAND(ArchiveOrganization archiveOrganization) {
	...
	public BRAND(ArtGallery artGallery) {
	...
	public BRAND(Attorney attorney) {
	...
	public BRAND(AutoBodyShop autoBodyShop) {
	...
	public BRAND(AutoDealer autoDealer) {
	...
	public BRAND(AutoPartsStore autoPartsStore) {
	...
	public BRAND(AutoRental autoRental) {
	...
	public BRAND(AutoRepair autoRepair) {
	...
	public BRAND(AutoWash autoWash) {
	...
	public BRAND(AutomatedTeller automatedTeller) {
	...
	public BRAND(AutomotiveBusiness automotiveBusiness) {
	...
	public BRAND(BankOrCreditUnion bankOrCreditUnion) {
	...
	public BRAND(BarOrPub barOrPub) {
	...
	public BRAND(BeautySalon beautySalon) {
	...
	public BRAND(BedAndBreakfast bedAndBreakfast) {
	...
	public BRAND(BikeStore bikeStore) {
	...
	public BRAND(BookStore bookStore) {
	...
	public BRAND(BowlingAlley bowlingAlley) {
	...
	public BRAND(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public BRAND(Campground campground) {
	...
	public BRAND(ChildCare childCare) {
	...
	public BRAND(ClothingStore clothingStore) {
	...
	public BRAND(CollegeOrUniversity collegeOrUniversity) {
	...
	public BRAND(ComedyClub comedyClub) {
	...
	public BRAND(CommunityHealth communityHealth) {
	...
	public BRAND(ComputerStore computerStore) {
	...
	public BRAND(Consortium consortium) {
	...
	public BRAND(ConvenienceStore convenienceStore) {
	...
	public BRAND(Corporation corporation) {
	...
	public BRAND(DanceGroup danceGroup) {
	...
	public BRAND(DepartmentStore departmentStore) {
	...
	public BRAND(Dermatology dermatology) {
	...
	public BRAND(DiagnosticLab diagnosticLab) {
	...
	public BRAND(DietNutrition dietNutrition) {
	...
	public BRAND(Distillery distillery) {
	...
	public BRAND(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public BRAND(EducationalOrganization educationalOrganization) {
	...
	public BRAND(Electrician electrician) {
	...
	public BRAND(ElectronicsStore electronicsStore) {
	...
	public BRAND(ElementarySchool elementarySchool) {
	...
	public BRAND(Emergency emergency) {
	...
	public BRAND(EmergencyService emergencyService) {
	...
	public BRAND(EmploymentAgency employmentAgency) {
	...
	public BRAND(EntertainmentBusiness entertainmentBusiness) {
	...
	public BRAND(ExerciseGym exerciseGym) {
	...
	public BRAND(FastFoodRestaurant fastFoodRestaurant) {
	...
	public BRAND(FinancialService financialService) {
	...
	public BRAND(FireStation fireStation) {
	...
	public BRAND(FoodEstablishment foodEstablishment) {
	...
	public BRAND(FundingAgency fundingAgency) {
	...
	public BRAND(FundingScheme fundingScheme) {
	...
	public BRAND(FurnitureStore furnitureStore) {
	...
	public BRAND(GardenStore gardenStore) {
	...
	public BRAND(GasStation gasStation) {
	...
	public BRAND(GeneralContractor generalContractor) {
	...
	public BRAND(Geriatric geriatric) {
	...
	public BRAND(GolfCourse golfCourse) {
	...
	public BRAND(GovernmentOffice governmentOffice) {
	...
	public BRAND(GovernmentOrganization governmentOrganization) {
	...
	public BRAND(GroceryStore groceryStore) {
	...
	public BRAND(Gynecologic gynecologic) {
	...
	public BRAND(HVACBusiness hvacBusiness) {
	...
	public BRAND(HairSalon hairSalon) {
	...
	public BRAND(HardwareStore hardwareStore) {
	...
	public BRAND(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public BRAND(HealthClub healthClub) {
	...
	public BRAND(HighSchool highSchool) {
	...
	public BRAND(HobbyShop hobbyShop) {
	...
	public BRAND(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public BRAND(HomeGoodsStore homeGoodsStore) {
	...
	public BRAND(Hospital hospital) {
	...
	public BRAND(HousePainter housePainter) {
	...
	public BRAND(IceCreamShop iceCreamShop) {
	...
	public BRAND(InsuranceAgency insuranceAgency) {
	...
	public BRAND(InternetCafe internetCafe) {
	...
	public BRAND(JewelryStore jewelryStore) {
	...
	public BRAND(LegalService legalService) {
	...
	public BRAND(LibrarySystem librarySystem) {
	...
	public BRAND(LiquorStore liquorStore) {
	...
	public BRAND(LocalBusiness localBusiness) {
	...
	public BRAND(Locksmith locksmith) {
	...
	public BRAND(LodgingBusiness lodgingBusiness) {
	...
	public BRAND(MedicalBusiness medicalBusiness) {
	...
	public BRAND(MedicalClinic medicalClinic) {
	...
	public BRAND(MedicalOrganization medicalOrganization) {
	...
	public BRAND(MensClothingStore mensClothingStore) {
	...
	public BRAND(MiddleSchool middleSchool) {
	...
	public BRAND(Midwifery midwifery) {
	...
	public BRAND(MobilePhoneStore mobilePhoneStore) {
	...
	public BRAND(MotorcycleDealer motorcycleDealer) {
	...
	public BRAND(MotorcycleRepair motorcycleRepair) {
	...
	public BRAND(MovieRentalStore movieRentalStore) {
	...
	public BRAND(MovieTheater movieTheater) {
	...
	public BRAND(MovingCompany movingCompany) {
	...
	public BRAND(MusicGroup musicGroup) {
	...
	public BRAND(MusicStore musicStore) {
	...
	public BRAND(NailSalon nailSalon) {
	...
	public BRAND(NewsMediaOrganization newsMediaOrganization) {
	...
	public BRAND(NightClub nightClub) {
	...
	public BRAND(Obstetric obstetric) {
	...
	public BRAND(OfficeEquipmentStore officeEquipmentStore) {
	...
	public BRAND(Oncologic oncologic) {
	...
	public BRAND(Optician optician) {
	...
	public BRAND(Optometric optometric) {
	...
	public BRAND(Otolaryngologic otolaryngologic) {
	...
	public BRAND(OutletStore outletStore) {
	...
	public BRAND(PawnShop pawnShop) {
	...
	public BRAND(Pediatric pediatric) {
	...
	public BRAND(PerformingGroup performingGroup) {
	...
	public BRAND(PetStore petStore) {
	...
	public BRAND(Pharmacy pharmacy) {
	...
	public BRAND(Physician physician) {
	...
	public BRAND(Physiotherapy physiotherapy) {
	...
	public BRAND(PlasticSurgery plasticSurgery) {
	...
	public BRAND(Podiatric podiatric) {
	...
	public BRAND(PoliceStation policeStation) {
	...
	public BRAND(PostOffice postOffice) {
	...
	public BRAND(Preschool preschool) {
	...
	public BRAND(PrimaryCare primaryCare) {
	...
	public BRAND(ProfessionalService professionalService) {
	...
	public BRAND(Psychiatric psychiatric) {
	...
	public BRAND(PublicHealth publicHealth) {
	...
	public BRAND(PublicSwimmingPool publicSwimmingPool) {
	...
	public BRAND(RadioStation radioStation) {
	...
	public BRAND(RealEstateAgent realEstateAgent) {
	...
	public BRAND(RecyclingCenter recyclingCenter) {
	...
	public BRAND(ResearchProject researchProject) {
	...
	public BRAND(Restaurant restaurant) {
	...
	public BRAND(RoofingContractor roofingContractor) {
	...
	public BRAND(SelfStorage selfStorage) {
	...
	public BRAND(ShoeStore shoeStore) {
	...
	public BRAND(ShoppingCenter shoppingCenter) {
	...
	public BRAND(SkiResort skiResort) {
	...
	public BRAND(SportingGoodsStore sportingGoodsStore) {
	...
	public BRAND(SportsActivityLocation sportsActivityLocation) {
	...
	public BRAND(SportsClub sportsClub) {
	...
	public BRAND(SportsOrganization sportsOrganization) {
	...
	public BRAND(SportsTeam sportsTeam) {
	...
	public BRAND(StadiumOrArena stadiumOrArena) {
	...
	public BRAND(TattooParlor tattooParlor) {
	...
	public BRAND(TelevisionStation televisionStation) {
	...
	public BRAND(TennisComplex tennisComplex) {
	...
	public BRAND(TheaterGroup theaterGroup) {
	...
	public BRAND(TireShop tireShop) {
	...
	public BRAND(TouristInformationCenter touristInformationCenter) {
	...
	public BRAND(ToyStore toyStore) {
	...
	public BRAND(TravelAgency travelAgency) {
	...
	public BRAND(VeterinaryCare veterinaryCare) {
	...
	public BRAND(WholesaleStore wholesaleStore) {
	...
	public BRAND(WorkersUnion workersUnion) {
