...
public class PAINT_ACTION implements Clazz.PaintAction {
	...
	public PAINT_ACTION(Long seq) {
		setSeq(seq);
	}

	public PAINT_ACTION(String string) {
	...
	public PAINT_ACTION(ActionStatus actionStatus) {
	...
	public PAINT_ACTION(AdditionalType additionalType) {
	...
	public PAINT_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public PAINT_ACTION(AlternateName alternateName) {
	...
	public PAINT_ACTION(Description description) {
	...
	public PAINT_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public PAINT_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public PAINT_ACTION(Error error) {
		setError(error);
	}
	...
	public PAINT_ACTION(Identifier identifier) {
	...
	public PAINT_ACTION(Image image) {
		setImage(image);
	}
	...
	public PAINT_ACTION(Instrument instrument) {
	...
	public PAINT_ACTION(Location location) {
	...
	public PAINT_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public PAINT_ACTION(NameFuzzy nameFuzzy) {
	...
	public PAINT_ACTION(NameRuby nameRuby) {
	...
	public PAINT_ACTION(Object object) {
		setObject(object);
	}
	...
	public PAINT_ACTION(Participant participant) {
	...
	public PAINT_ACTION(PotentialAction potentialAction) {
	...
	public PAINT_ACTION(Result result) {
		setResult(result);
	}
	...
	public PAINT_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PAINT_ACTION(StartTime startTime) {
	...
	public PAINT_ACTION(SubjectOf subjectOf) {
	...
	public PAINT_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.PaintAction org) {
		setSeq(org.getSeq());
