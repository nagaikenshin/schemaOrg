...
public class ELIGIBLE_TRANSACTION_VOLUME implements Container.EligibleTransactionVolume {
	...
	public ELIGIBLE_TRANSACTION_VOLUME(CompoundPriceSpecification compoundPriceSpecification) {
	...
	public ELIGIBLE_TRANSACTION_VOLUME(DeliveryChargeSpecification deliveryChargeSpecification) {
	...
	public ELIGIBLE_TRANSACTION_VOLUME(PaymentChargeSpecification paymentChargeSpecification) {
	...
	public ELIGIBLE_TRANSACTION_VOLUME(UnitPriceSpecification unitPriceSpecification) {
	...
	public ELIGIBLE_TRANSACTION_VOLUME(List<CompoundPriceSpecification> compoundPriceSpecificationList,
	...
	public void copy(Container.EligibleTransactionVolume org) {
