...
public class PART_OF_SERIES implements Container.PartOfSeries {
	...
	public PART_OF_SERIES(String string) {
		this(new CREATIVE_WORK_SERIES(string));
	}

	public String getString() {
		if(creativeWorkSeriesList == null || creativeWorkSeriesList.size() == 0 || creativeWorkSeriesList.get(0) == null) {
			return null;
		} else {
			Name name = creativeWorkSeriesList.get(0).getName();
	...
	public void setString(String string) {
		...
		if(creativeWorkSeriesList.size() == 0) {
			creativeWorkSeriesList.add(new CREATIVE_WORK_SERIES(string));
		} else {
			creativeWorkSeriesList.set(0, new CREATIVE_WORK_SERIES(string));
		}
	}

	public PART_OF_SERIES(APIReference apiReference) {
	...
	public PART_OF_SERIES(AboutPage aboutPage) {
	...
	public PART_OF_SERIES(AdvertiserContentArticle advertiserContentArticle) {
	...
	public PART_OF_SERIES(AnalysisNewsArticle analysisNewsArticle) {
	...
	public PART_OF_SERIES(Answer answer) {
	...
	public PART_OF_SERIES(ArchiveComponent archiveComponent) {
	...
	public PART_OF_SERIES(Article article) {
	...
	public PART_OF_SERIES(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public PART_OF_SERIES(Atlas atlas) {
	...
	public PART_OF_SERIES(AudioObject audioObject) {
	...
	public PART_OF_SERIES(Audiobook audiobook) {
	...
	public PART_OF_SERIES(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public PART_OF_SERIES(Barcode barcode) {
	...
	public PART_OF_SERIES(Blog blog) {
	...
	public PART_OF_SERIES(BlogPosting blogPosting) {
	...
	public PART_OF_SERIES(Book book) {
	...
	public PART_OF_SERIES(BookSeries bookSeries) {
	...
	public PART_OF_SERIES(CategoryCodeSet categoryCodeSet) {
	...
	public PART_OF_SERIES(Chapter chapter) {
	...
	public PART_OF_SERIES(CheckoutPage checkoutPage) {
	...
	public PART_OF_SERIES(Claim claim) {
	...
	public PART_OF_SERIES(ClaimReview claimReview) {
	...
	public PART_OF_SERIES(Clip clip) {
	...
	public PART_OF_SERIES(Collection collection) {
	...
	public PART_OF_SERIES(CollectionPage collectionPage) {
	...
	public PART_OF_SERIES(ComicCoverArt comicCoverArt) {
	...
	public PART_OF_SERIES(ComicIssue comicIssue) {
	...
	public PART_OF_SERIES(ComicSeries comicSeries) {
	...
	public PART_OF_SERIES(ComicStory comicStory) {
	...
	public PART_OF_SERIES(Comment comment) {
	...
	public PART_OF_SERIES(CompleteDataFeed completeDataFeed) {
	...
	public PART_OF_SERIES(ContactPage contactPage) {
	...
	public PART_OF_SERIES(Conversation conversation) {
	...
	public PART_OF_SERIES(CorrectionComment correctionComment) {
	...
	public PART_OF_SERIES(Course course) {
	...
	public PART_OF_SERIES(CoverArt coverArt) {
	...
	public PART_OF_SERIES(CreativeWorkSeason creativeWorkSeason) {
	...
	public PART_OF_SERIES(CriticReview criticReview) {
	...
	public PART_OF_SERIES(DataCatalog dataCatalog) {
	...
	public PART_OF_SERIES(DataDownload dataDownload) {
	...
	public PART_OF_SERIES(DataFeed dataFeed) {
	...
	public PART_OF_SERIES(Dataset dataset) {
	...
	public PART_OF_SERIES(DefinedTermSet definedTermSet) {
	...
	public PART_OF_SERIES(Diet diet) {
	...
	public PART_OF_SERIES(DigitalDocument digitalDocument) {
	...
	public PART_OF_SERIES(DiscussionForumPosting discussionForumPosting) {
	...
	public PART_OF_SERIES(Drawing drawing) {
	...
	public PART_OF_SERIES(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public PART_OF_SERIES(EmailMessage emailMessage) {
	...
	public PART_OF_SERIES(EmployerReview employerReview) {
	...
	public PART_OF_SERIES(Episode episode) {
	...
	public PART_OF_SERIES(ExercisePlan exercisePlan) {
	...
	public PART_OF_SERIES(FAQPage faqPage) {
	...
	public PART_OF_SERIES(Game game) {
	...
	public PART_OF_SERIES(HowTo howTo) {
	...
	public PART_OF_SERIES(HowToDirection howToDirection) {
	...
	public PART_OF_SERIES(HowToSection howToSection) {
	...
	public PART_OF_SERIES(HowToStep howToStep) {
	...
	public PART_OF_SERIES(HowToTip howToTip) {
	...
	public PART_OF_SERIES(ImageGallery imageGallery) {
	...
	public PART_OF_SERIES(ImageObject imageObject) {
	...
	public PART_OF_SERIES(ItemPage itemPage) {
	...
	public PART_OF_SERIES(Legislation legislation) {
	...
	public PART_OF_SERIES(LegislationObject legislationObject) {
	...
	public PART_OF_SERIES(LiveBlogPosting liveBlogPosting) {
	...
	public PART_OF_SERIES(Manuscript manuscript) {
	...
	public PART_OF_SERIES(MediaObject mediaObject) {
	...
	public PART_OF_SERIES(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public PART_OF_SERIES(MedicalWebPage medicalWebPage) {
	...
	public PART_OF_SERIES(Menu menu) {
	...
	public PART_OF_SERIES(MenuSection menuSection) {
	...
	public PART_OF_SERIES(Message message) {
	...
	public PART_OF_SERIES(MobileApplication mobileApplication) {
	...
	public PART_OF_SERIES(Movie movie) {
	...
	public PART_OF_SERIES(MovieClip movieClip) {
	...
	public PART_OF_SERIES(MovieSeries movieSeries) {
	...
	public PART_OF_SERIES(MusicAlbum musicAlbum) {
	...
	public PART_OF_SERIES(MusicComposition musicComposition) {
	...
	public PART_OF_SERIES(MusicPlaylist musicPlaylist) {
	...
	public PART_OF_SERIES(MusicRecording musicRecording) {
	...
	public PART_OF_SERIES(MusicRelease musicRelease) {
	...
	public PART_OF_SERIES(MusicVideoObject musicVideoObject) {
	...
	public PART_OF_SERIES(NewsArticle newsArticle) {
	...
	public PART_OF_SERIES(Newspaper newspaper) {
	...
	public PART_OF_SERIES(NoteDigitalDocument noteDigitalDocument) {
	...
	public PART_OF_SERIES(OpinionNewsArticle opinionNewsArticle) {
	...
	public PART_OF_SERIES(Painting painting) {
	...
	public PART_OF_SERIES(Periodical periodical) {
	...
	public PART_OF_SERIES(Photograph photograph) {
	...
	public PART_OF_SERIES(Play play) {
	...
	public PART_OF_SERIES(Poster poster) {
	...
	public PART_OF_SERIES(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public PART_OF_SERIES(ProfilePage profilePage) {
	...
	public PART_OF_SERIES(PublicationIssue publicationIssue) {
	...
	public PART_OF_SERIES(PublicationVolume publicationVolume) {
	...
	public PART_OF_SERIES(QAPage qaPage) {
	...
	public PART_OF_SERIES(Question question) {
	...
	public PART_OF_SERIES(Quotation quotation) {
	...
	public PART_OF_SERIES(RadioClip radioClip) {
	...
	public PART_OF_SERIES(RadioEpisode radioEpisode) {
	...
	public PART_OF_SERIES(RadioSeason radioSeason) {
	...
	public PART_OF_SERIES(RadioSeries radioSeries) {
	...
	public PART_OF_SERIES(Recipe recipe) {
	...
	public PART_OF_SERIES(Report report) {
	...
	public PART_OF_SERIES(ReportageNewsArticle reportageNewsArticle) {
	...
	public PART_OF_SERIES(Review review) {
	...
	public PART_OF_SERIES(ReviewNewsArticle reviewNewsArticle) {
	...
	public PART_OF_SERIES(SatiricalArticle satiricalArticle) {
	...
	public PART_OF_SERIES(ScholarlyArticle scholarlyArticle) {
	...
	public PART_OF_SERIES(Sculpture sculpture) {
	...
	public PART_OF_SERIES(SearchResultsPage searchResultsPage) {
	...
	public PART_OF_SERIES(SheetMusic sheetMusic) {
	...
	public PART_OF_SERIES(ShortStory shortStory) {
	...
	public PART_OF_SERIES(SiteNavigationElement siteNavigationElement) {
	...
	public PART_OF_SERIES(SocialMediaPosting socialMediaPosting) {
	...
	public PART_OF_SERIES(SoftwareApplication softwareApplication) {
	...
	public PART_OF_SERIES(SoftwareSourceCode softwareSourceCode) {
	...
	public PART_OF_SERIES(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public PART_OF_SERIES(TVClip tvClip) {
	...
	public PART_OF_SERIES(TVEpisode tvEpisode) {
	...
	public PART_OF_SERIES(TVSeason tvSeason) {
	...
	public PART_OF_SERIES(TVSeries tvSeries) {
	...
	public PART_OF_SERIES(Table table) {
	...
	public PART_OF_SERIES(TechArticle techArticle) {
	...
	public PART_OF_SERIES(TextDigitalDocument textDigitalDocument) {
	...
	public PART_OF_SERIES(Thesis thesis) {
	...
	public PART_OF_SERIES(ThreeDimensionalModel threeDimensionalModel) {
	...
	public PART_OF_SERIES(UserReview userReview) {
	...
	public PART_OF_SERIES(VideoGallery videoGallery) {
	...
	public PART_OF_SERIES(VideoGame videoGame) {
	...
	public PART_OF_SERIES(VideoGameClip videoGameClip) {
	...
	public PART_OF_SERIES(VideoGameSeries videoGameSeries) {
	...
	public PART_OF_SERIES(VideoObject videoObject) {
	...
	public PART_OF_SERIES(VisualArtwork visualArtwork) {
	...
	public PART_OF_SERIES(WPAdBlock wpAdBlock) {
	...
	public PART_OF_SERIES(WPFooter wpFooter) {
	...
	public PART_OF_SERIES(WPHeader wpHeader) {
	...
	public PART_OF_SERIES(WPSideBar wpSideBar) {
	...
	public PART_OF_SERIES(WebApplication webApplication) {
	...
	public PART_OF_SERIES(WebPage webPage) {
	...
	public PART_OF_SERIES(WebPageElement webPageElement) {
	...
	public PART_OF_SERIES(WebSite webSite) {
