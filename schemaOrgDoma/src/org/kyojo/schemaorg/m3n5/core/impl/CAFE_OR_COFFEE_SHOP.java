...
public class CAFE_OR_COFFEE_SHOP implements Clazz.CafeOrCoffeeShop {
	...
	public CAFE_OR_COFFEE_SHOP(GeoContains geoContains) {
	...
	public CAFE_OR_COFFEE_SHOP(GeoCoveredBy geoCoveredBy) {
	...
	public CAFE_OR_COFFEE_SHOP(GeoCovers geoCovers) {
	...
	public CAFE_OR_COFFEE_SHOP(GeoCrosses geoCrosses) {
	...
	public CAFE_OR_COFFEE_SHOP(GeoDisjoint geoDisjoint) {
	...
	public CAFE_OR_COFFEE_SHOP(GeoEquals geoEquals) {
	...
	public CAFE_OR_COFFEE_SHOP(GeoIntersects geoIntersects) {
	...
	public CAFE_OR_COFFEE_SHOP(GeoOverlaps geoOverlaps) {
	...
	public CAFE_OR_COFFEE_SHOP(GeoTouches geoTouches) {
	...
	public CAFE_OR_COFFEE_SHOP(GeoWithin geoWithin) {
	...
	public CAFE_OR_COFFEE_SHOP(Slogan slogan) {
		setSlogan(slogan);
	}
