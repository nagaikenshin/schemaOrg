...
public class MAX_PRICE implements Container.MaxPrice {
	...
	public MAX_PRICE(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public MAX_PRICE(Float fl0at) {
	...
	public MAX_PRICE(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public MAX_PRICE(Integer integer) {
	...
	public MAX_PRICE(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public MAX_PRICE(Number number) {
	...
	public MAX_PRICE(List<Float> fl0atList,
	...
	public void copy(Container.MaxPrice org) {
