...
public class DATA_FEED implements Clazz.DataFeed {
	...
	public DATA_FEED(Long seq) {
		setSeq(seq);
	}

	public DATA_FEED(String string) {
	...
	public DATA_FEED(AccessMode accessMode) {
	...
	public DATA_FEED(AccessModeSufficient accessModeSufficient) {
	...
	public DATA_FEED(AccessibilityAPI accessibilityAPI) {
	...
	public DATA_FEED(AccessibilityControl accessibilityControl) {
	...
	public DATA_FEED(AccessibilityFeature accessibilityFeature) {
	...
	public DATA_FEED(AccessibilityHazard accessibilityHazard) {
	...
	public DATA_FEED(AccessibilitySummary accessibilitySummary) {
	...
	public DATA_FEED(AccountablePerson accountablePerson) {
	...
	public DATA_FEED(AdditionalType additionalType) {
	...
	public DATA_FEED(AggregateRating aggregateRating) {
	...
	public DATA_FEED(AlternateName alternateName) {
	...
	public DATA_FEED(AlternativeHeadline alternativeHeadline) {
	...
	public DATA_FEED(AssociatedMedia associatedMedia) {
	...
	public DATA_FEED(Audience audience) {
	...
	public DATA_FEED(Author author) {
		setAuthor(author);
	}
	...
	public DATA_FEED(Character character) {
	...
	public DATA_FEED(Citation citation) {
	...
	public DATA_FEED(Comment comment) {
		setComment(comment);
	}
	...
	public DATA_FEED(CommentCount commentCount) {
	...
	public DATA_FEED(ContentLocation contentLocation) {
	...
	public DATA_FEED(ContentRating contentRating) {
	...
	public DATA_FEED(ContentReferenceTime contentReferenceTime) {
	...
	public DATA_FEED(Contributor contributor) {
	...
	public DATA_FEED(CopyrightHolder copyrightHolder) {
	...
	public DATA_FEED(CopyrightYear copyrightYear) {
	...
	public DATA_FEED(Correction correction) {
	...
	public DATA_FEED(Creator creator) {
		setCreator(creator);
	}
	...
	public DATA_FEED(DataFeedElement dataFeedElement) {
	...
	public DATA_FEED(DateCreated dateCreated) {
	...
	public DATA_FEED(DateModified dateModified) {
	...
	public DATA_FEED(DatePublished datePublished) {
	...
	public DATA_FEED(Description description) {
	...
	public DATA_FEED(DisambiguatingDescription disambiguatingDescription) {
	...
	public DATA_FEED(DiscussionUrl discussionUrl) {
	...
	public DATA_FEED(Distribution distribution) {
	...
	public DATA_FEED(Editor editor) {
		setEditor(editor);
	}
	...
	public DATA_FEED(EducationalAlignment educationalAlignment) {
	...
	public DATA_FEED(EducationalUse educationalUse) {
	...
	public DATA_FEED(Encoding encoding) {
	...
	public DATA_FEED(EncodingFormat encodingFormat) {
	...
	public DATA_FEED(ExampleOfWork exampleOfWork) {
	...
	public DATA_FEED(Expires expires) {
		setExpires(expires);
	}
	...
	public DATA_FEED(Funder funder) {
		setFunder(funder);
	}
	...
	public DATA_FEED(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public DATA_FEED(Headline headline) {
	...
	public DATA_FEED(Identifier identifier) {
	...
	public DATA_FEED(InLanguage inLanguage) {
	...
	public DATA_FEED(IncludedInDataCatalog includedInDataCatalog) {
	...
	public DATA_FEED(InteractionStatistic interactionStatistic) {
	...
	public DATA_FEED(InteractivityType interactivityType) {
	...
	public DATA_FEED(IsAccessibleForFree isAccessibleForFree) {
	...
	public DATA_FEED(IsBasedOn isBasedOn) {
	...
	public DATA_FEED(IsFamilyFriendly isFamilyFriendly) {
	...
	public DATA_FEED(IsPartOf isPartOf) {
	...
	public DATA_FEED(Keywords keywords) {
	...
	public DATA_FEED(LearningResourceType learningResourceType) {
	...
	public DATA_FEED(License license) {
		setLicense(license);
	}
	...
	public DATA_FEED(LocationCreated locationCreated) {
	...
	public DATA_FEED(MainEntity mainEntity) {
	...
	public DATA_FEED(MainEntityOfPage mainEntityOfPage) {
	...
	public DATA_FEED(Material material) {
	...
	public DATA_FEED(MaterialExtent materialExtent) {
	...
	public DATA_FEED(MeasurementTechnique measurementTechnique) {
	...
	public DATA_FEED(Mentions mentions) {
	...
	public DATA_FEED(NameFuzzy nameFuzzy) {
	...
	public DATA_FEED(NameRuby nameRuby) {
	...
	public DATA_FEED(Offers offers) {
		setOffers(offers);
	}
	...
	public DATA_FEED(Position position) {
	...
	public DATA_FEED(PotentialAction potentialAction) {
	...
	public DATA_FEED(Producer producer) {
	...
	public DATA_FEED(Provider provider) {
	...
	public DATA_FEED(Publication publication) {
	...
	public DATA_FEED(Publisher publisher) {
	...
	public DATA_FEED(PublisherImprint publisherImprint) {
	...
	public DATA_FEED(PublishingPrinciples publishingPrinciples) {
	...
	public DATA_FEED(RecordedAt recordedAt) {
	...
	public DATA_FEED(ReleasedEvent releasedEvent) {
	...
	public DATA_FEED(Review review) {
		setReview(review);
	}
	...
	public DATA_FEED(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DATA_FEED(SchemaVersion schemaVersion) {
	...
	public DATA_FEED(SdDatePublished sdDatePublished) {
	...
	public DATA_FEED(SdLicense sdLicense) {
	...
	public DATA_FEED(SdPublisher sdPublisher) {
	...
	public DATA_FEED(SourceOrganization sourceOrganization) {
	...
	public DATA_FEED(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public DATA_FEED(SpatialCoverage spatialCoverage) {
	...
	public DATA_FEED(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public DATA_FEED(SubjectOf subjectOf) {
	...
	public DATA_FEED(Temporal temporal) {
	...
	public DATA_FEED(TemporalCoverage temporalCoverage) {
	...
	public DATA_FEED(ThumbnailUrl thumbnailUrl) {
	...
	public DATA_FEED(TimeRequired timeRequired) {
	...
	public DATA_FEED(TranslationOfWork translationOfWork) {
	...
	public DATA_FEED(Translator translator) {
	...
	public DATA_FEED(TypicalAgeRange typicalAgeRange) {
	...
	public DATA_FEED(VariableMeasured variableMeasured) {
	...
	public DATA_FEED(Version version) {
		setVersion(version);
	}
	...
	public DATA_FEED(WorkExample workExample) {
	...
	public DATA_FEED(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.DataFeed org) {
		setSeq(org.getSeq());
