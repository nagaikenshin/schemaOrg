...
public class TOURIST_ATTRACTION implements Clazz.TouristAttraction {
	...
	public TOURIST_ATTRACTION(GeoContains geoContains) {
	...
	public TOURIST_ATTRACTION(GeoCoveredBy geoCoveredBy) {
	...
	public TOURIST_ATTRACTION(GeoCovers geoCovers) {
	...
	public TOURIST_ATTRACTION(GeoCrosses geoCrosses) {
	...
	public TOURIST_ATTRACTION(GeoDisjoint geoDisjoint) {
	...
	public TOURIST_ATTRACTION(GeoEquals geoEquals) {
	...
	public TOURIST_ATTRACTION(GeoIntersects geoIntersects) {
	...
	public TOURIST_ATTRACTION(GeoOverlaps geoOverlaps) {
	...
	public TOURIST_ATTRACTION(GeoTouches geoTouches) {
	...
	public TOURIST_ATTRACTION(GeoWithin geoWithin) {
	...
	public TOURIST_ATTRACTION(Slogan slogan) {
		setSlogan(slogan);
	}
