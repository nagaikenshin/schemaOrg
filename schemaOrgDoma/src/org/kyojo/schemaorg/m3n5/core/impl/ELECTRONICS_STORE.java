...
public class ELECTRONICS_STORE implements Clazz.ElectronicsStore {
	...
	public ELECTRONICS_STORE(GeoContains geoContains) {
	...
	public ELECTRONICS_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public ELECTRONICS_STORE(GeoCovers geoCovers) {
	...
	public ELECTRONICS_STORE(GeoCrosses geoCrosses) {
	...
	public ELECTRONICS_STORE(GeoDisjoint geoDisjoint) {
	...
	public ELECTRONICS_STORE(GeoEquals geoEquals) {
	...
	public ELECTRONICS_STORE(GeoIntersects geoIntersects) {
	...
	public ELECTRONICS_STORE(GeoOverlaps geoOverlaps) {
	...
	public ELECTRONICS_STORE(GeoTouches geoTouches) {
	...
	public ELECTRONICS_STORE(GeoWithin geoWithin) {
	...
	public ELECTRONICS_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
