...
public class HOME_GOODS_STORE implements Clazz.HomeGoodsStore {
	...
	public HOME_GOODS_STORE(GeoContains geoContains) {
	...
	public HOME_GOODS_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public HOME_GOODS_STORE(GeoCovers geoCovers) {
	...
	public HOME_GOODS_STORE(GeoCrosses geoCrosses) {
	...
	public HOME_GOODS_STORE(GeoDisjoint geoDisjoint) {
	...
	public HOME_GOODS_STORE(GeoEquals geoEquals) {
	...
	public HOME_GOODS_STORE(GeoIntersects geoIntersects) {
	...
	public HOME_GOODS_STORE(GeoOverlaps geoOverlaps) {
	...
	public HOME_GOODS_STORE(GeoTouches geoTouches) {
	...
	public HOME_GOODS_STORE(GeoWithin geoWithin) {
	...
	public HOME_GOODS_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
