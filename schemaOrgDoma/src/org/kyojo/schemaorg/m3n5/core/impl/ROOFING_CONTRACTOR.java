...
public class ROOFING_CONTRACTOR implements Clazz.RoofingContractor {
	...
	public ROOFING_CONTRACTOR(GeoContains geoContains) {
	...
	public ROOFING_CONTRACTOR(GeoCoveredBy geoCoveredBy) {
	...
	public ROOFING_CONTRACTOR(GeoCovers geoCovers) {
	...
	public ROOFING_CONTRACTOR(GeoCrosses geoCrosses) {
	...
	public ROOFING_CONTRACTOR(GeoDisjoint geoDisjoint) {
	...
	public ROOFING_CONTRACTOR(GeoEquals geoEquals) {
	...
	public ROOFING_CONTRACTOR(GeoIntersects geoIntersects) {
	...
	public ROOFING_CONTRACTOR(GeoOverlaps geoOverlaps) {
	...
	public ROOFING_CONTRACTOR(GeoTouches geoTouches) {
	...
	public ROOFING_CONTRACTOR(GeoWithin geoWithin) {
	...
	public ROOFING_CONTRACTOR(Slogan slogan) {
		setSlogan(slogan);
	}
