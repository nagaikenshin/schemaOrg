...
public class EXERCISE_GYM implements Clazz.ExerciseGym {
	...
	public EXERCISE_GYM(GeoContains geoContains) {
	...
	public EXERCISE_GYM(GeoCoveredBy geoCoveredBy) {
	...
	public EXERCISE_GYM(GeoCovers geoCovers) {
	...
	public EXERCISE_GYM(GeoCrosses geoCrosses) {
	...
	public EXERCISE_GYM(GeoDisjoint geoDisjoint) {
	...
	public EXERCISE_GYM(GeoEquals geoEquals) {
	...
	public EXERCISE_GYM(GeoIntersects geoIntersects) {
	...
	public EXERCISE_GYM(GeoOverlaps geoOverlaps) {
	...
	public EXERCISE_GYM(GeoTouches geoTouches) {
	...
	public EXERCISE_GYM(GeoWithin geoWithin) {
	...
	public EXERCISE_GYM(Slogan slogan) {
		setSlogan(slogan);
	}
