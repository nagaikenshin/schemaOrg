...
import org.kyojo.schemaorg.m3n5.core.Container.Coach;
...
public class SPORTS_TEAM implements Clazz.SportsTeam, Container.SportsTeam {
	...
	public SPORTS_TEAM(AccountingService accountingService) {
	...
	public SPORTS_TEAM(AdultEntertainment adultEntertainment) {
	...
	public SPORTS_TEAM(Airline airline) {
	...
	public SPORTS_TEAM(AmusementPark amusementPark) {
	...
	public SPORTS_TEAM(AnimalShelter animalShelter) {
	...
	public SPORTS_TEAM(ArchiveOrganization archiveOrganization) {
	...
	public SPORTS_TEAM(ArtGallery artGallery) {
	...
	public SPORTS_TEAM(Attorney attorney) {
	...
	public SPORTS_TEAM(AutoBodyShop autoBodyShop) {
	...
	public SPORTS_TEAM(AutoDealer autoDealer) {
	...
	public SPORTS_TEAM(AutoPartsStore autoPartsStore) {
	...
	public SPORTS_TEAM(AutoRental autoRental) {
	...
	public SPORTS_TEAM(AutoRepair autoRepair) {
	...
	public SPORTS_TEAM(AutoWash autoWash) {
	...
	public SPORTS_TEAM(AutomatedTeller automatedTeller) {
	...
	public SPORTS_TEAM(AutomotiveBusiness automotiveBusiness) {
	...
	public SPORTS_TEAM(Bakery bakery) {
	...
	public SPORTS_TEAM(BankOrCreditUnion bankOrCreditUnion) {
	...
	public SPORTS_TEAM(BarOrPub barOrPub) {
	...
	public SPORTS_TEAM(BeautySalon beautySalon) {
	...
	public SPORTS_TEAM(BedAndBreakfast bedAndBreakfast) {
	...
	public SPORTS_TEAM(BikeStore bikeStore) {
	...
	public SPORTS_TEAM(BookStore bookStore) {
	...
	public SPORTS_TEAM(BowlingAlley bowlingAlley) {
	...
	public SPORTS_TEAM(Brewery brewery) {
	...
	public SPORTS_TEAM(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public SPORTS_TEAM(Campground campground) {
	...
	public SPORTS_TEAM(Casino casino) {
	...
	public SPORTS_TEAM(ChildCare childCare) {
	...
	public SPORTS_TEAM(ClothingStore clothingStore) {
	...
	public SPORTS_TEAM(CollegeOrUniversity collegeOrUniversity) {
	...
	public SPORTS_TEAM(ComedyClub comedyClub) {
	...
	public SPORTS_TEAM(CommunityHealth communityHealth) {
	...
	public SPORTS_TEAM(ComputerStore computerStore) {
	...
	public SPORTS_TEAM(Consortium consortium) {
	...
	public SPORTS_TEAM(ConvenienceStore convenienceStore) {
	...
	public SPORTS_TEAM(Corporation corporation) {
	...
	public SPORTS_TEAM(DanceGroup danceGroup) {
	...
	public SPORTS_TEAM(DaySpa daySpa) {
	...
	public SPORTS_TEAM(Dentist dentist) {
	...
	public SPORTS_TEAM(DepartmentStore departmentStore) {
	...
	public SPORTS_TEAM(Dermatology dermatology) {
	...
	public SPORTS_TEAM(DiagnosticLab diagnosticLab) {
	...
	public SPORTS_TEAM(DietNutrition dietNutrition) {
	...
	public SPORTS_TEAM(Distillery distillery) {
	...
	public SPORTS_TEAM(DiversityStaffingReport diversityStaffingReport) {
	...
	public SPORTS_TEAM(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public SPORTS_TEAM(EducationalOrganization educationalOrganization) {
	...
	public SPORTS_TEAM(Electrician electrician) {
	...
	public SPORTS_TEAM(ElectronicsStore electronicsStore) {
	...
	public SPORTS_TEAM(ElementarySchool elementarySchool) {
	...
	public SPORTS_TEAM(Emergency emergency) {
	...
	public SPORTS_TEAM(EmergencyService emergencyService) {
	...
	public SPORTS_TEAM(EmploymentAgency employmentAgency) {
	...
	public SPORTS_TEAM(EntertainmentBusiness entertainmentBusiness) {
	...
	public SPORTS_TEAM(ExerciseGym exerciseGym) {
	...
	public SPORTS_TEAM(FastFoodRestaurant fastFoodRestaurant) {
	...
	public SPORTS_TEAM(FinancialService financialService) {
	...
	public SPORTS_TEAM(FireStation fireStation) {
	...
	public SPORTS_TEAM(Florist florist) {
	...
	public SPORTS_TEAM(FoodEstablishment foodEstablishment) {
	...
	public SPORTS_TEAM(FundingAgency fundingAgency) {
	...
	public SPORTS_TEAM(FundingScheme fundingScheme) {
	...
	public SPORTS_TEAM(FurnitureStore furnitureStore) {
	...
	public SPORTS_TEAM(GardenStore gardenStore) {
	...
	public SPORTS_TEAM(GasStation gasStation) {
	...
	public SPORTS_TEAM(GeneralContractor generalContractor) {
	...
	public SPORTS_TEAM(Geriatric geriatric) {
	...
	public SPORTS_TEAM(GolfCourse golfCourse) {
	...
	public SPORTS_TEAM(GovernmentOffice governmentOffice) {
	...
	public SPORTS_TEAM(GovernmentOrganization governmentOrganization) {
	...
	public SPORTS_TEAM(GroceryStore groceryStore) {
	...
	public SPORTS_TEAM(Gynecologic gynecologic) {
	...
	public SPORTS_TEAM(HVACBusiness hvacBusiness) {
	...
	public SPORTS_TEAM(HairSalon hairSalon) {
	...
	public SPORTS_TEAM(HardwareStore hardwareStore) {
	...
	public SPORTS_TEAM(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public SPORTS_TEAM(HealthClub healthClub) {
	...
	public SPORTS_TEAM(HighSchool highSchool) {
	...
	public SPORTS_TEAM(HobbyShop hobbyShop) {
	...
	public SPORTS_TEAM(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public SPORTS_TEAM(HomeGoodsStore homeGoodsStore) {
	...
	public SPORTS_TEAM(Hospital hospital) {
	...
	public SPORTS_TEAM(Hostel hostel) {
	...
	public SPORTS_TEAM(Hotel hotel) {
	...
	public SPORTS_TEAM(HousePainter housePainter) {
	...
	public SPORTS_TEAM(IceCreamShop iceCreamShop) {
	...
	public SPORTS_TEAM(InsuranceAgency insuranceAgency) {
	...
	public SPORTS_TEAM(InternetCafe internetCafe) {
	...
	public SPORTS_TEAM(JewelryStore jewelryStore) {
	...
	public SPORTS_TEAM(KnowsAbout knowsAbout) {
	...
	public SPORTS_TEAM(KnowsLanguage knowsLanguage) {
	...
	public SPORTS_TEAM(LegalService legalService) {
	...
	public SPORTS_TEAM(Library library) {
	...
	public SPORTS_TEAM(LibrarySystem librarySystem) {
	...
	public SPORTS_TEAM(LiquorStore liquorStore) {
	...
	public SPORTS_TEAM(LocalBusiness localBusiness) {
	...
	public SPORTS_TEAM(Locksmith locksmith) {
	...
	public SPORTS_TEAM(LodgingBusiness lodgingBusiness) {
	...
	public SPORTS_TEAM(MedicalBusiness medicalBusiness) {
	...
	public SPORTS_TEAM(MedicalClinic medicalClinic) {
	...
	public SPORTS_TEAM(MedicalOrganization medicalOrganization) {
	...
	public SPORTS_TEAM(MensClothingStore mensClothingStore) {
	...
	public SPORTS_TEAM(MiddleSchool middleSchool) {
	...
	public SPORTS_TEAM(Midwifery midwifery) {
	...
	public SPORTS_TEAM(MobilePhoneStore mobilePhoneStore) {
	...
	public SPORTS_TEAM(Motel motel) {
	...
	public SPORTS_TEAM(MotorcycleDealer motorcycleDealer) {
	...
	public SPORTS_TEAM(MotorcycleRepair motorcycleRepair) {
	...
	public SPORTS_TEAM(MovieRentalStore movieRentalStore) {
	...
	public SPORTS_TEAM(MovieTheater movieTheater) {
	...
	public SPORTS_TEAM(MovingCompany movingCompany) {
	...
	public SPORTS_TEAM(MusicGroup musicGroup) {
	...
	public SPORTS_TEAM(MusicStore musicStore) {
	...
	public SPORTS_TEAM(NailSalon nailSalon) {
	...
	public SPORTS_TEAM(NewsMediaOrganization newsMediaOrganization) {
	...
	public SPORTS_TEAM(NightClub nightClub) {
	...
	public SPORTS_TEAM(Notary notary) {
	...
	public SPORTS_TEAM(Nursing nursing) {
	...
	public SPORTS_TEAM(Obstetric obstetric) {
	...
	public SPORTS_TEAM(OfficeEquipmentStore officeEquipmentStore) {
	...
	public SPORTS_TEAM(Oncologic oncologic) {
	...
	public SPORTS_TEAM(Optician optician) {
	...
	public SPORTS_TEAM(Optometric optometric) {
	...
	public SPORTS_TEAM(Otolaryngologic otolaryngologic) {
	...
	public SPORTS_TEAM(OutletStore outletStore) {
	...
	public SPORTS_TEAM(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public SPORTS_TEAM(Patient patient) {
	...
	public SPORTS_TEAM(PawnShop pawnShop) {
	...
	public SPORTS_TEAM(Pediatric pediatric) {
	...
	public SPORTS_TEAM(PerformingGroup performingGroup) {
	...
	public SPORTS_TEAM(PetStore petStore) {
	...
	public SPORTS_TEAM(Pharmacy pharmacy) {
	...
	public SPORTS_TEAM(Physician physician) {
	...
	public SPORTS_TEAM(Physiotherapy physiotherapy) {
	...
	public SPORTS_TEAM(PlasticSurgery plasticSurgery) {
	...
	public SPORTS_TEAM(Plumber plumber) {
	...
	public SPORTS_TEAM(Podiatric podiatric) {
	...
	public SPORTS_TEAM(PoliceStation policeStation) {
	...
	public SPORTS_TEAM(PostOffice postOffice) {
	...
	public SPORTS_TEAM(Preschool preschool) {
	...
	public SPORTS_TEAM(PrimaryCare primaryCare) {
	...
	public SPORTS_TEAM(ProfessionalService professionalService) {
	...
	public SPORTS_TEAM(Project project) {
	...
	public SPORTS_TEAM(Psychiatric psychiatric) {
	...
	public SPORTS_TEAM(PublicHealth publicHealth) {
	...
	public SPORTS_TEAM(PublicSwimmingPool publicSwimmingPool) {
	...
	public SPORTS_TEAM(RadioStation radioStation) {
	...
	public SPORTS_TEAM(RealEstateAgent realEstateAgent) {
	...
	public SPORTS_TEAM(RecyclingCenter recyclingCenter) {
	...
	public SPORTS_TEAM(ResearchProject researchProject) {
	...
	public SPORTS_TEAM(Resort resort) {
	...
	public SPORTS_TEAM(Restaurant restaurant) {
	...
	public SPORTS_TEAM(RoofingContractor roofingContractor) {
	...
	public SPORTS_TEAM(School school) {
	...
	public SPORTS_TEAM(SelfStorage selfStorage) {
	...
	public SPORTS_TEAM(ShoeStore shoeStore) {
	...
	public SPORTS_TEAM(ShoppingCenter shoppingCenter) {
	...
	public SPORTS_TEAM(SkiResort skiResort) {
	...
	public SPORTS_TEAM(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public SPORTS_TEAM(SportingGoodsStore sportingGoodsStore) {
	...
	public SPORTS_TEAM(SportsActivityLocation sportsActivityLocation) {
	...
	public SPORTS_TEAM(SportsClub sportsClub) {
	...
	public SPORTS_TEAM(SportsOrganization sportsOrganization) {
	...
	public SPORTS_TEAM(StadiumOrArena stadiumOrArena) {
	...
	public SPORTS_TEAM(Store store) {
	...
	public SPORTS_TEAM(SubjectOf subjectOf) {
	...
	public SPORTS_TEAM(TattooParlor tattooParlor) {
	...
	public SPORTS_TEAM(TelevisionStation televisionStation) {
	...
	public SPORTS_TEAM(TennisComplex tennisComplex) {
	...
	public SPORTS_TEAM(TheaterGroup theaterGroup) {
	...
	public SPORTS_TEAM(TireShop tireShop) {
	...
	public SPORTS_TEAM(TouristInformationCenter touristInformationCenter) {
	...
	public SPORTS_TEAM(ToyStore toyStore) {
	...
	public SPORTS_TEAM(TravelAgency travelAgency) {
	...
	public SPORTS_TEAM(VeterinaryCare veterinaryCare) {
	...
	public SPORTS_TEAM(WholesaleStore wholesaleStore) {
	...
	public SPORTS_TEAM(Winery winery) {
	...
	public SPORTS_TEAM(WorkersUnion workersUnion) {
