...
public class ATTENDEE implements Container.Attendee {
	...
	public ATTENDEE(AccountingService accountingService) {
	...
	public ATTENDEE(AdultEntertainment adultEntertainment) {
	...
	public ATTENDEE(Airline airline) {
	...
	public ATTENDEE(AmusementPark amusementPark) {
	...
	public ATTENDEE(AnimalShelter animalShelter) {
	...
	public ATTENDEE(ArchiveOrganization archiveOrganization) {
	...
	public ATTENDEE(ArtGallery artGallery) {
	...
	public ATTENDEE(Attorney attorney) {
	...
	public ATTENDEE(AutoBodyShop autoBodyShop) {
	...
	public ATTENDEE(AutoDealer autoDealer) {
	...
	public ATTENDEE(AutoPartsStore autoPartsStore) {
	...
	public ATTENDEE(AutoRental autoRental) {
	...
	public ATTENDEE(AutoRepair autoRepair) {
	...
	public ATTENDEE(AutoWash autoWash) {
	...
	public ATTENDEE(AutomatedTeller automatedTeller) {
	...
	public ATTENDEE(AutomotiveBusiness automotiveBusiness) {
	...
	public ATTENDEE(BankOrCreditUnion bankOrCreditUnion) {
	...
	public ATTENDEE(BarOrPub barOrPub) {
	...
	public ATTENDEE(BeautySalon beautySalon) {
	...
	public ATTENDEE(BedAndBreakfast bedAndBreakfast) {
	...
	public ATTENDEE(BikeStore bikeStore) {
	...
	public ATTENDEE(BookStore bookStore) {
	...
	public ATTENDEE(BowlingAlley bowlingAlley) {
	...
	public ATTENDEE(Brewery brewery) {
	...
	public ATTENDEE(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public ATTENDEE(Campground campground) {
	...
	public ATTENDEE(ChildCare childCare) {
	...
	public ATTENDEE(ClothingStore clothingStore) {
	...
	public ATTENDEE(CollegeOrUniversity collegeOrUniversity) {
	...
	public ATTENDEE(ComedyClub comedyClub) {
	...
	public ATTENDEE(CommunityHealth communityHealth) {
	...
	public ATTENDEE(ComputerStore computerStore) {
	...
	public ATTENDEE(Consortium consortium) {
	...
	public ATTENDEE(ConvenienceStore convenienceStore) {
	...
	public ATTENDEE(Corporation corporation) {
	...
	public ATTENDEE(DanceGroup danceGroup) {
	...
	public ATTENDEE(Dentist dentist) {
	...
	public ATTENDEE(DepartmentStore departmentStore) {
	...
	public ATTENDEE(Dermatology dermatology) {
	...
	public ATTENDEE(DiagnosticLab diagnosticLab) {
	...
	public ATTENDEE(DietNutrition dietNutrition) {
	...
	public ATTENDEE(Distillery distillery) {
	...
	public ATTENDEE(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public ATTENDEE(EducationalOrganization educationalOrganization) {
	...
	public ATTENDEE(Electrician electrician) {
	...
	public ATTENDEE(ElectronicsStore electronicsStore) {
	...
	public ATTENDEE(ElementarySchool elementarySchool) {
	...
	public ATTENDEE(Emergency emergency) {
	...
	public ATTENDEE(EmergencyService emergencyService) {
	...
	public ATTENDEE(EmploymentAgency employmentAgency) {
	...
	public ATTENDEE(EntertainmentBusiness entertainmentBusiness) {
	...
	public ATTENDEE(ExerciseGym exerciseGym) {
	...
	public ATTENDEE(FastFoodRestaurant fastFoodRestaurant) {
	...
	public ATTENDEE(FinancialService financialService) {
	...
	public ATTENDEE(FireStation fireStation) {
	...
	public ATTENDEE(Florist florist) {
	...
	public ATTENDEE(FoodEstablishment foodEstablishment) {
	...
	public ATTENDEE(FundingAgency fundingAgency) {
	...
	public ATTENDEE(FundingScheme fundingScheme) {
	...
	public ATTENDEE(FurnitureStore furnitureStore) {
	...
	public ATTENDEE(GardenStore gardenStore) {
	...
	public ATTENDEE(GasStation gasStation) {
	...
	public ATTENDEE(GeneralContractor generalContractor) {
	...
	public ATTENDEE(Geriatric geriatric) {
	...
	public ATTENDEE(GolfCourse golfCourse) {
	...
	public ATTENDEE(GovernmentOffice governmentOffice) {
	...
	public ATTENDEE(GovernmentOrganization governmentOrganization) {
	...
	public ATTENDEE(GroceryStore groceryStore) {
	...
	public ATTENDEE(Gynecologic gynecologic) {
	...
	public ATTENDEE(HVACBusiness hvacBusiness) {
	...
	public ATTENDEE(HairSalon hairSalon) {
	...
	public ATTENDEE(HardwareStore hardwareStore) {
	...
	public ATTENDEE(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public ATTENDEE(HealthClub healthClub) {
	...
	public ATTENDEE(HighSchool highSchool) {
	...
	public ATTENDEE(HobbyShop hobbyShop) {
	...
	public ATTENDEE(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public ATTENDEE(HomeGoodsStore homeGoodsStore) {
	...
	public ATTENDEE(Hospital hospital) {
	...
	public ATTENDEE(HousePainter housePainter) {
	...
	public ATTENDEE(IceCreamShop iceCreamShop) {
	...
	public ATTENDEE(InsuranceAgency insuranceAgency) {
	...
	public ATTENDEE(InternetCafe internetCafe) {
	...
	public ATTENDEE(JewelryStore jewelryStore) {
	...
	public ATTENDEE(LegalService legalService) {
	...
	public ATTENDEE(Library library) {
	...
	public ATTENDEE(LibrarySystem librarySystem) {
	...
	public ATTENDEE(LiquorStore liquorStore) {
	...
	public ATTENDEE(LocalBusiness localBusiness) {
	...
	public ATTENDEE(Locksmith locksmith) {
	...
	public ATTENDEE(LodgingBusiness lodgingBusiness) {
	...
	public ATTENDEE(MedicalBusiness medicalBusiness) {
	...
	public ATTENDEE(MedicalClinic medicalClinic) {
	...
	public ATTENDEE(MedicalOrganization medicalOrganization) {
	...
	public ATTENDEE(MensClothingStore mensClothingStore) {
	...
	public ATTENDEE(MiddleSchool middleSchool) {
	...
	public ATTENDEE(Midwifery midwifery) {
	...
	public ATTENDEE(MobilePhoneStore mobilePhoneStore) {
	...
	public ATTENDEE(MotorcycleDealer motorcycleDealer) {
	...
	public ATTENDEE(MotorcycleRepair motorcycleRepair) {
	...
	public ATTENDEE(MovieRentalStore movieRentalStore) {
	...
	public ATTENDEE(MovieTheater movieTheater) {
	...
	public ATTENDEE(MovingCompany movingCompany) {
	...
	public ATTENDEE(MusicGroup musicGroup) {
	...
	public ATTENDEE(MusicStore musicStore) {
	...
	public ATTENDEE(NailSalon nailSalon) {
	...
	public ATTENDEE(NewsMediaOrganization newsMediaOrganization) {
	...
	public ATTENDEE(NightClub nightClub) {
	...
	public ATTENDEE(Nursing nursing) {
	...
	public ATTENDEE(Obstetric obstetric) {
	...
	public ATTENDEE(OfficeEquipmentStore officeEquipmentStore) {
	...
	public ATTENDEE(Oncologic oncologic) {
	...
	public ATTENDEE(Optician optician) {
	...
	public ATTENDEE(Optometric optometric) {
	...
	public ATTENDEE(Organization organization) {
		organizationList = new ArrayList<Organization>();
	...
	public ATTENDEE(Otolaryngologic otolaryngologic) {
	...
	public ATTENDEE(OutletStore outletStore) {
	...
	public ATTENDEE(Patient patient) {
	...
	public ATTENDEE(PawnShop pawnShop) {
	...
	public ATTENDEE(Pediatric pediatric) {
	...
	public ATTENDEE(PerformingGroup performingGroup) {
	...
	public ATTENDEE(PetStore petStore) {
	...
	public ATTENDEE(Pharmacy pharmacy) {
	...
	public ATTENDEE(Physician physician) {
	...
	public ATTENDEE(Physiotherapy physiotherapy) {
	...
	public ATTENDEE(PlasticSurgery plasticSurgery) {
	...
	public ATTENDEE(Plumber plumber) {
	...
	public ATTENDEE(Podiatric podiatric) {
	...
	public ATTENDEE(PoliceStation policeStation) {
	...
	public ATTENDEE(PostOffice postOffice) {
	...
	public ATTENDEE(Preschool preschool) {
	...
	public ATTENDEE(PrimaryCare primaryCare) {
	...
	public ATTENDEE(ProfessionalService professionalService) {
	...
	public ATTENDEE(Project project) {
	...
	public ATTENDEE(Psychiatric psychiatric) {
	...
	public ATTENDEE(PublicHealth publicHealth) {
	...
	public ATTENDEE(PublicSwimmingPool publicSwimmingPool) {
	...
	public ATTENDEE(RadioStation radioStation) {
	...
	public ATTENDEE(RealEstateAgent realEstateAgent) {
	...
	public ATTENDEE(RecyclingCenter recyclingCenter) {
	...
	public ATTENDEE(ResearchProject researchProject) {
	...
	public ATTENDEE(Restaurant restaurant) {
	...
	public ATTENDEE(RoofingContractor roofingContractor) {
	...
	public ATTENDEE(SelfStorage selfStorage) {
	...
	public ATTENDEE(ShoeStore shoeStore) {
	...
	public ATTENDEE(ShoppingCenter shoppingCenter) {
	...
	public ATTENDEE(SkiResort skiResort) {
	...
	public ATTENDEE(SportingGoodsStore sportingGoodsStore) {
	...
	public ATTENDEE(SportsActivityLocation sportsActivityLocation) {
	...
	public ATTENDEE(SportsClub sportsClub) {
	...
	public ATTENDEE(SportsOrganization sportsOrganization) {
	...
	public ATTENDEE(SportsTeam sportsTeam) {
	...
	public ATTENDEE(StadiumOrArena stadiumOrArena) {
	...
	public ATTENDEE(TattooParlor tattooParlor) {
	...
	public ATTENDEE(TelevisionStation televisionStation) {
	...
	public ATTENDEE(TennisComplex tennisComplex) {
	...
	public ATTENDEE(TheaterGroup theaterGroup) {
	...
	public ATTENDEE(TireShop tireShop) {
	...
	public ATTENDEE(TouristInformationCenter touristInformationCenter) {
	...
	public ATTENDEE(ToyStore toyStore) {
	...
	public ATTENDEE(TravelAgency travelAgency) {
	...
	public ATTENDEE(VeterinaryCare veterinaryCare) {
	...
	public ATTENDEE(WholesaleStore wholesaleStore) {
	...
	public ATTENDEE(WorkersUnion workersUnion) {
	...
	public void copy(Container.Attendee org) {
