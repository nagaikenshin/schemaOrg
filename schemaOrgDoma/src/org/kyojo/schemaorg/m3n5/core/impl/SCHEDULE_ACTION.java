...
import org.kyojo.schemaorg.m3n5.core.Container.ScheduledTime;
...
public class SCHEDULE_ACTION implements Clazz.ScheduleAction {
	...
	public SCHEDULE_ACTION(Long seq) {
		setSeq(seq);
	}

	public SCHEDULE_ACTION(String string) {
	...
	public SCHEDULE_ACTION(ActionStatus actionStatus) {
	...
	public SCHEDULE_ACTION(AdditionalType additionalType) {
	...
	public SCHEDULE_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public SCHEDULE_ACTION(AlternateName alternateName) {
	...
	public SCHEDULE_ACTION(Description description) {
	...
	public SCHEDULE_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public SCHEDULE_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public SCHEDULE_ACTION(Error error) {
		setError(error);
	}
	...
	public SCHEDULE_ACTION(Identifier identifier) {
	...
	public SCHEDULE_ACTION(Image image) {
		setImage(image);
	}
	...
	public SCHEDULE_ACTION(Instrument instrument) {
	...
	public SCHEDULE_ACTION(Location location) {
	...
	public SCHEDULE_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public SCHEDULE_ACTION(Name name) {
		setName(name);
	}
	...
	public SCHEDULE_ACTION(NameFuzzy nameFuzzy) {
	...
	public SCHEDULE_ACTION(NameRuby nameRuby) {
	...
	public SCHEDULE_ACTION(Object object) {
		setObject(object);
	}
	...
	public SCHEDULE_ACTION(Participant participant) {
	...
	public SCHEDULE_ACTION(PotentialAction potentialAction) {
	...
	public SCHEDULE_ACTION(Result result) {
		setResult(result);
	}
	...
	public SCHEDULE_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SCHEDULE_ACTION(ScheduledTime scheduledTime) {
	...
	public SCHEDULE_ACTION(StartTime startTime) {
	...
	public SCHEDULE_ACTION(SubjectOf subjectOf) {
	...
	public SCHEDULE_ACTION(Target target) {
		setTarget(target);
	}
	...
	public SCHEDULE_ACTION(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.ScheduleAction org) {
		setSeq(org.getSeq());
		...
		setScheduledTime(org.getScheduledTime());
