...
public class POST_OFFICE implements Clazz.PostOffice {
	...
	public POST_OFFICE(GeoContains geoContains) {
	...
	public POST_OFFICE(GeoCoveredBy geoCoveredBy) {
	...
	public POST_OFFICE(GeoCovers geoCovers) {
	...
	public POST_OFFICE(GeoCrosses geoCrosses) {
	...
	public POST_OFFICE(GeoDisjoint geoDisjoint) {
	...
	public POST_OFFICE(GeoEquals geoEquals) {
	...
	public POST_OFFICE(GeoIntersects geoIntersects) {
	...
	public POST_OFFICE(GeoOverlaps geoOverlaps) {
	...
	public POST_OFFICE(GeoTouches geoTouches) {
	...
	public POST_OFFICE(GeoWithin geoWithin) {
	...
	public POST_OFFICE(Slogan slogan) {
		setSlogan(slogan);
	}
