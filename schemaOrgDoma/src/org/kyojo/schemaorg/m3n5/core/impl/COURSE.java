...
import org.kyojo.schemaorg.m3n5.core.Container.CourseCode;
...
import org.kyojo.schemaorg.m3n5.core.Container.HasCourseInstance;
...
public class COURSE implements Clazz.Course {
	...
	public CoursePrerequisites coursePrerequisites;
	...
	public EducationalCredentialAwarded educationalCredentialAwarded;
	...
	public Genre genre;
	public HasCourseInstance hasCourseInstance;
	...
	public COURSE(AccessMode accessMode) {
	...
	public COURSE(AccessModeSufficient accessModeSufficient) {
	...
	public COURSE(AccessibilityAPI accessibilityAPI) {
	...
	public COURSE(AccessibilityControl accessibilityControl) {
	...
	public COURSE(AccessibilityFeature accessibilityFeature) {
	...
	public COURSE(AccessibilityHazard accessibilityHazard) {
	...
	public COURSE(AccessibilitySummary accessibilitySummary) {
	...
	public COURSE(AccountablePerson accountablePerson) {
	...
	public COURSE(AdditionalType additionalType) {
	...
	public COURSE(AggregateRating aggregateRating) {
	...
	public COURSE(AlternateName alternateName) {
	...
	public COURSE(AlternativeHeadline alternativeHeadline) {
	...
	public COURSE(AssociatedMedia associatedMedia) {
	...
	public COURSE(Audience audience) {
	...
	public COURSE(Citation citation) {
	...
	public COURSE(CommentCount commentCount) {
	...
	public COURSE(ContentLocation contentLocation) {
	...
	public COURSE(ContentRating contentRating) {
	...
	public COURSE(ContentReferenceTime contentReferenceTime) {
	...
	public COURSE(Contributor contributor) {
	...
	public COURSE(CopyrightHolder copyrightHolder) {
	...
	public COURSE(CopyrightYear copyrightYear) {
	...
	public COURSE(Correction correction) {
	...
	public COURSE(CoursePrerequisites coursePrerequisites) {
		setCoursePrerequisites(coursePrerequisites);
	}

	@Override
	public CoursePrerequisites getCoursePrerequisites() {
		return coursePrerequisites;
	}

	@Override
	public void setCoursePrerequisites(CoursePrerequisites coursePrerequisites) {
		this.coursePrerequisites = coursePrerequisites;
	}

	public COURSE(Creator creator) {
		setCreator(creator);
	}
	...
	public COURSE(DateCreated dateCreated) {
	...
	public COURSE(DateModified dateModified) {
	...
	public COURSE(DatePublished datePublished) {
	...
	public COURSE(Description description) {
	...
	public COURSE(DisambiguatingDescription disambiguatingDescription) {
	...
	public COURSE(DiscussionUrl discussionUrl) {
	...
	public COURSE(EducationalAlignment educationalAlignment) {
	...
	public COURSE(EducationalCredentialAwarded educationalCredentialAwarded) {
		setEducationalCredentialAwarded(educationalCredentialAwarded);
	}
	...
	public COURSE(EducationalUse educationalUse) {
	...
	public COURSE(Encoding encoding) {
	...
	public COURSE(EncodingFormat encodingFormat) {
	...
	public COURSE(ExampleOfWork exampleOfWork) {
	...
	public COURSE(HasCourseInstance hasCourseInstance) {
		setHasCourseInstance(hasCourseInstance);
	}

	@Override
	public HasCourseInstance getHasCourseInstance() {
		return hasCourseInstance;
	}

	@Override
	public void setHasCourseInstance(HasCourseInstance hasCourseInstance) {
		this.hasCourseInstance = hasCourseInstance;
	}

	public COURSE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public COURSE(Headline headline) {
	...
	public COURSE(Identifier identifier) {
	...
	public COURSE(InLanguage inLanguage) {
	...
	public COURSE(InteractionStatistic interactionStatistic) {
	...
	public COURSE(InteractivityType interactivityType) {
	...
	public COURSE(IsAccessibleForFree isAccessibleForFree) {
	...
	public COURSE(IsBasedOn isBasedOn) {
	...
	public COURSE(IsFamilyFriendly isFamilyFriendly) {
	...
	public COURSE(IsPartOf isPartOf) {
	...
	public COURSE(Keywords keywords) {
	...
	public COURSE(LearningResourceType learningResourceType) {
	...
	public COURSE(LocationCreated locationCreated) {
	...
	public COURSE(MainEntity mainEntity) {
	...
	public COURSE(MainEntityOfPage mainEntityOfPage) {
	...
	public COURSE(Material material) {
	...
	public COURSE(MaterialExtent materialExtent) {
	...
	public COURSE(Mentions mentions) {
	...
	public COURSE(NameFuzzy nameFuzzy) {
	...
	public COURSE(NameRuby nameRuby) {
	...
	public COURSE(PotentialAction potentialAction) {
	...
	public COURSE(Producer producer) {
	...
	public COURSE(Provider provider) {
	...
	public COURSE(Publication publication) {
	...
	public COURSE(Publisher publisher) {
	...
	public COURSE(PublisherImprint publisherImprint) {
	...
	public COURSE(PublishingPrinciples publishingPrinciples) {
	...
	public COURSE(RecordedAt recordedAt) {
	...
	public COURSE(ReleasedEvent releasedEvent) {
	...
	public COURSE(SchemaVersion schemaVersion) {
	...
	public COURSE(SdDatePublished sdDatePublished) {
	...
	public COURSE(SdLicense sdLicense) {
	...
	public COURSE(SdPublisher sdPublisher) {
	...
	public COURSE(SourceOrganization sourceOrganization) {
	...
	public COURSE(SpatialCoverage spatialCoverage) {
	...
	public COURSE(SubjectOf subjectOf) {
	...
	public COURSE(Temporal temporal) {
	...
	public COURSE(TemporalCoverage temporalCoverage) {
	...
	public COURSE(ThumbnailUrl thumbnailUrl) {
	...
	public COURSE(TimeRequired timeRequired) {
	...
	public COURSE(TranslationOfWork translationOfWork) {
	...
	public COURSE(Translator translator) {
	...
	public COURSE(TypicalAgeRange typicalAgeRange) {
	...
	public COURSE(WorkExample workExample) {
	...
	public COURSE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Course org) {
		setSeq(org.getSeq());
		...
		setCourseCode(org.getCourseCode());
		setCoursePrerequisites(org.getCoursePrerequisites());
		...
		setEducationalCredentialAwarded(org.getEducationalCredentialAwarded());
		...
		setHasCourseInstance(org.getHasCourseInstance());
