...
public class EDITOR implements Container.Editor {
	...
	public EDITOR(List<Patient> patientList,
			List<Person> personList) {
		setPatientList(patientList);
		setPersonList(personList);
	}

	public void copy(Container.Editor org) {
