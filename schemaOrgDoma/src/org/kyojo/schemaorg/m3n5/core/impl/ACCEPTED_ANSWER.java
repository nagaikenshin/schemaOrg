...
public class ACCEPTED_ANSWER implements Container.AcceptedAnswer {
	...
	public ACCEPTED_ANSWER(BreadcrumbList breadcrumbList) {
	...
	public ACCEPTED_ANSWER(HowToSection howToSection) {
	...
	public ACCEPTED_ANSWER(HowToStep howToStep) {
	...
	public ACCEPTED_ANSWER(OfferCatalog offerCatalog) {
