...
import org.kyojo.schemaorg.m3n5.core.Container.Occupancy;
...
public class SINGLE_FAMILY_RESIDENCE implements Clazz.SingleFamilyResidence {
	...
	public SINGLE_FAMILY_RESIDENCE(GeoContains geoContains) {
	...
	public SINGLE_FAMILY_RESIDENCE(GeoCoveredBy geoCoveredBy) {
	...
	public SINGLE_FAMILY_RESIDENCE(GeoCovers geoCovers) {
	...
	public SINGLE_FAMILY_RESIDENCE(GeoCrosses geoCrosses) {
	...
	public SINGLE_FAMILY_RESIDENCE(GeoDisjoint geoDisjoint) {
	...
	public SINGLE_FAMILY_RESIDENCE(GeoEquals geoEquals) {
	...
	public SINGLE_FAMILY_RESIDENCE(GeoIntersects geoIntersects) {
	...
	public SINGLE_FAMILY_RESIDENCE(GeoOverlaps geoOverlaps) {
	...
	public SINGLE_FAMILY_RESIDENCE(GeoTouches geoTouches) {
	...
	public SINGLE_FAMILY_RESIDENCE(GeoWithin geoWithin) {
	...
	public SINGLE_FAMILY_RESIDENCE(Slogan slogan) {
		setSlogan(slogan);
	}
