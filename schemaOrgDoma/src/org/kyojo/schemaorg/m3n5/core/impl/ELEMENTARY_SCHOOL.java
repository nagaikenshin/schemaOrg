...
public class ELEMENTARY_SCHOOL implements Clazz.ElementarySchool {
	...
	public ELEMENTARY_SCHOOL(Long seq) {
		setSeq(seq);
	}

	public ELEMENTARY_SCHOOL(String string) {
	...
	public ELEMENTARY_SCHOOL(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public ELEMENTARY_SCHOOL(AdditionalType additionalType) {
	...
	public ELEMENTARY_SCHOOL(Address address) {
		setAddress(address);
	}
	...
	public ELEMENTARY_SCHOOL(AggregateRating aggregateRating) {
	...
	public ELEMENTARY_SCHOOL(AlternateName alternateName) {
	...
	public ELEMENTARY_SCHOOL(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public ELEMENTARY_SCHOOL(AreaServed areaServed) {
	...
	public ELEMENTARY_SCHOOL(Award award) {
		setAward(award);
	}
	...
	public ELEMENTARY_SCHOOL(Brand brand) {
		setBrand(brand);
	}
	...
	public ELEMENTARY_SCHOOL(ContactPoint contactPoint) {
	...
	public ELEMENTARY_SCHOOL(CorrectionsPolicy correctionsPolicy) {
	...
	public ELEMENTARY_SCHOOL(Department department) {
	...
	public ELEMENTARY_SCHOOL(Description description) {
	...
	public ELEMENTARY_SCHOOL(DisambiguatingDescription disambiguatingDescription) {
	...
	public ELEMENTARY_SCHOOL(DissolutionDate dissolutionDate) {
	...
	public ELEMENTARY_SCHOOL(DiversityPolicy diversityPolicy) {
	...
	public ELEMENTARY_SCHOOL(DiversityStaffingReport diversityStaffingReport) {
	...
	public ELEMENTARY_SCHOOL(Duns duns) {
		setDuns(duns);
	}
	...
	public ELEMENTARY_SCHOOL(Email email) {
		setEmail(email);
	}
	...
	public ELEMENTARY_SCHOOL(Employee employee) {
	...
	public ELEMENTARY_SCHOOL(EthicsPolicy ethicsPolicy) {
	...
	public ELEMENTARY_SCHOOL(Event event) {
		setEvent(event);
	}
	...
	public ELEMENTARY_SCHOOL(FaxNumber faxNumber) {
	...
	public ELEMENTARY_SCHOOL(Founder founder) {
		setFounder(founder);
	}
	...
	public ELEMENTARY_SCHOOL(FoundingDate foundingDate) {
	...
	public ELEMENTARY_SCHOOL(FoundingLocation foundingLocation) {
	...
	public ELEMENTARY_SCHOOL(Funder funder) {
		setFunder(funder);
	}
	...
	public ELEMENTARY_SCHOOL(GlobalLocationNumber globalLocationNumber) {
	...
	public ELEMENTARY_SCHOOL(HasOfferCatalog hasOfferCatalog) {
	...
	public ELEMENTARY_SCHOOL(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public ELEMENTARY_SCHOOL(Identifier identifier) {
	...
	public ELEMENTARY_SCHOOL(Image image) {
		setImage(image);
	}
	...
	public ELEMENTARY_SCHOOL(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public ELEMENTARY_SCHOOL(KnowsAbout knowsAbout) {
	...
	public ELEMENTARY_SCHOOL(KnowsLanguage knowsLanguage) {
	...
	public ELEMENTARY_SCHOOL(LegalName legalName) {
	...
	public ELEMENTARY_SCHOOL(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public ELEMENTARY_SCHOOL(Location location) {
	...
	public ELEMENTARY_SCHOOL(Logo logo) {
		setLogo(logo);
	}
	...
	public ELEMENTARY_SCHOOL(MainEntityOfPage mainEntityOfPage) {
	...
	public ELEMENTARY_SCHOOL(MakesOffer makesOffer) {
	...
	public ELEMENTARY_SCHOOL(Member member) {
		setMember(member);
	}
	...
	public ELEMENTARY_SCHOOL(MemberOf memberOf) {
	...
	public ELEMENTARY_SCHOOL(Naics naics) {
		setNaics(naics);
	}
	...
	public ELEMENTARY_SCHOOL(Name name) {
		setName(name);
	}
	...
	public ELEMENTARY_SCHOOL(NameFuzzy nameFuzzy) {
	...
	public ELEMENTARY_SCHOOL(NameRuby nameRuby) {
	...
	public ELEMENTARY_SCHOOL(NumberOfEmployees numberOfEmployees) {
	...
	public ELEMENTARY_SCHOOL(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public ELEMENTARY_SCHOOL(Owns owns) {
		setOwns(owns);
	}
	...
	public ELEMENTARY_SCHOOL(ParentOrganization parentOrganization) {
	...
	public ELEMENTARY_SCHOOL(PotentialAction potentialAction) {
	...
	public ELEMENTARY_SCHOOL(PublishingPrinciples publishingPrinciples) {
	...
	public ELEMENTARY_SCHOOL(Review review) {
		setReview(review);
	}
	...
	public ELEMENTARY_SCHOOL(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ELEMENTARY_SCHOOL(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public ELEMENTARY_SCHOOL(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public ELEMENTARY_SCHOOL(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public ELEMENTARY_SCHOOL(SubOrganization subOrganization) {
	...
	public ELEMENTARY_SCHOOL(SubjectOf subjectOf) {
	...
	public ELEMENTARY_SCHOOL(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public ELEMENTARY_SCHOOL(Telephone telephone) {
	...
	public ELEMENTARY_SCHOOL(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public ELEMENTARY_SCHOOL(Url url) {
		setUrl(url);
	}
	...
	public ELEMENTARY_SCHOOL(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.ElementarySchool org) {
		setSeq(org.getSeq());
