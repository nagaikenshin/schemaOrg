...
public class ZOO implements Clazz.Zoo {
	...
	public ZOO(GeoContains geoContains) {
	...
	public ZOO(GeoCoveredBy geoCoveredBy) {
	...
	public ZOO(GeoCovers geoCovers) {
	...
	public ZOO(GeoCrosses geoCrosses) {
	...
	public ZOO(GeoDisjoint geoDisjoint) {
	...
	public ZOO(GeoEquals geoEquals) {
	...
	public ZOO(GeoIntersects geoIntersects) {
	...
	public ZOO(GeoOverlaps geoOverlaps) {
	...
	public ZOO(GeoTouches geoTouches) {
	...
	public ZOO(GeoWithin geoWithin) {
