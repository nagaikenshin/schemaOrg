...
public class RESERVOIR implements Clazz.Reservoir {
	...
	public RESERVOIR(GeoContains geoContains) {
	...
	public RESERVOIR(GeoCoveredBy geoCoveredBy) {
	...
	public RESERVOIR(GeoCovers geoCovers) {
	...
	public RESERVOIR(GeoCrosses geoCrosses) {
	...
	public RESERVOIR(GeoDisjoint geoDisjoint) {
	...
	public RESERVOIR(GeoEquals geoEquals) {
	...
	public RESERVOIR(GeoIntersects geoIntersects) {
	...
	public RESERVOIR(GeoOverlaps geoOverlaps) {
	...
	public RESERVOIR(GeoTouches geoTouches) {
	...
	public RESERVOIR(GeoWithin geoWithin) {
	...
	public RESERVOIR(Slogan slogan) {
		setSlogan(slogan);
	}
