...
public class MIDDLE_SCHOOL implements Clazz.MiddleSchool {
	...
	public MIDDLE_SCHOOL(Long seq) {
		setSeq(seq);
	}

	public MIDDLE_SCHOOL(String string) {
	...
	public MIDDLE_SCHOOL(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public MIDDLE_SCHOOL(AdditionalType additionalType) {
	...
	public MIDDLE_SCHOOL(Address address) {
		setAddress(address);
	}
	...
	public MIDDLE_SCHOOL(AggregateRating aggregateRating) {
	...
	public MIDDLE_SCHOOL(AlternateName alternateName) {
	...
	public MIDDLE_SCHOOL(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public MIDDLE_SCHOOL(AreaServed areaServed) {
	...
	public MIDDLE_SCHOOL(Award award) {
		setAward(award);
	}
	...
	public MIDDLE_SCHOOL(Brand brand) {
		setBrand(brand);
	}
	...
	public MIDDLE_SCHOOL(ContactPoint contactPoint) {
	...
	public MIDDLE_SCHOOL(CorrectionsPolicy correctionsPolicy) {
	...
	public MIDDLE_SCHOOL(Department department) {
	...
	public MIDDLE_SCHOOL(Description description) {
	...
	public MIDDLE_SCHOOL(DisambiguatingDescription disambiguatingDescription) {
	...
	public MIDDLE_SCHOOL(DissolutionDate dissolutionDate) {
	...
	public MIDDLE_SCHOOL(DiversityPolicy diversityPolicy) {
	...
	public MIDDLE_SCHOOL(DiversityStaffingReport diversityStaffingReport) {
	...
	public MIDDLE_SCHOOL(Duns duns) {
		setDuns(duns);
	}
	...
	public MIDDLE_SCHOOL(Email email) {
		setEmail(email);
	}
	...
	public MIDDLE_SCHOOL(Employee employee) {
	...
	public MIDDLE_SCHOOL(EthicsPolicy ethicsPolicy) {
	...
	public MIDDLE_SCHOOL(Event event) {
		setEvent(event);
	}
	...
	public MIDDLE_SCHOOL(FaxNumber faxNumber) {
	...
	public MIDDLE_SCHOOL(Founder founder) {
		setFounder(founder);
	}
	...
	public MIDDLE_SCHOOL(FoundingDate foundingDate) {
	...
	public MIDDLE_SCHOOL(FoundingLocation foundingLocation) {
	...
	public MIDDLE_SCHOOL(Funder funder) {
		setFunder(funder);
	}
	...
	public MIDDLE_SCHOOL(GlobalLocationNumber globalLocationNumber) {
	...
	public MIDDLE_SCHOOL(HasOfferCatalog hasOfferCatalog) {
	...
	public MIDDLE_SCHOOL(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public MIDDLE_SCHOOL(Identifier identifier) {
	...
	public MIDDLE_SCHOOL(Image image) {
		setImage(image);
	}
	...
	public MIDDLE_SCHOOL(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public MIDDLE_SCHOOL(KnowsAbout knowsAbout) {
	...
	public MIDDLE_SCHOOL(KnowsLanguage knowsLanguage) {
	...
	public MIDDLE_SCHOOL(LegalName legalName) {
	...
	public MIDDLE_SCHOOL(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public MIDDLE_SCHOOL(Location location) {
	...
	public MIDDLE_SCHOOL(Logo logo) {
		setLogo(logo);
	}
	...
	public MIDDLE_SCHOOL(MainEntityOfPage mainEntityOfPage) {
	...
	public MIDDLE_SCHOOL(MakesOffer makesOffer) {
	...
	public MIDDLE_SCHOOL(Member member) {
		setMember(member);
	}
	...
	public MIDDLE_SCHOOL(MemberOf memberOf) {
	...
	public MIDDLE_SCHOOL(Naics naics) {
		setNaics(naics);
	}
	...
	public MIDDLE_SCHOOL(Name name) {
		setName(name);
	}
	...
	public MIDDLE_SCHOOL(NameFuzzy nameFuzzy) {
	...
	public MIDDLE_SCHOOL(NameRuby nameRuby) {
	...
	public MIDDLE_SCHOOL(NumberOfEmployees numberOfEmployees) {
	...
	public MIDDLE_SCHOOL(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public MIDDLE_SCHOOL(Owns owns) {
		setOwns(owns);
	}
	...
	public MIDDLE_SCHOOL(ParentOrganization parentOrganization) {
	...
	public MIDDLE_SCHOOL(PotentialAction potentialAction) {
	...
	public MIDDLE_SCHOOL(PublishingPrinciples publishingPrinciples) {
	...
	public MIDDLE_SCHOOL(Review review) {
		setReview(review);
	}
	...
	public MIDDLE_SCHOOL(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MIDDLE_SCHOOL(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public MIDDLE_SCHOOL(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public MIDDLE_SCHOOL(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MIDDLE_SCHOOL(SubOrganization subOrganization) {
	...
	public MIDDLE_SCHOOL(SubjectOf subjectOf) {
	...
	public MIDDLE_SCHOOL(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public MIDDLE_SCHOOL(Telephone telephone) {
	...
	public MIDDLE_SCHOOL(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public MIDDLE_SCHOOL(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.MiddleSchool org) {
		setSeq(org.getSeq());
