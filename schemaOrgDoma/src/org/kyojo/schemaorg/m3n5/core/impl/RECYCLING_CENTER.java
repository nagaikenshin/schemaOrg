...
public class RECYCLING_CENTER implements Clazz.RecyclingCenter {
	...
	public RECYCLING_CENTER(GeoContains geoContains) {
	...
	public RECYCLING_CENTER(GeoCoveredBy geoCoveredBy) {
	...
	public RECYCLING_CENTER(GeoCovers geoCovers) {
	...
	public RECYCLING_CENTER(GeoCrosses geoCrosses) {
	...
	public RECYCLING_CENTER(GeoDisjoint geoDisjoint) {
	...
	public RECYCLING_CENTER(GeoEquals geoEquals) {
	...
	public RECYCLING_CENTER(GeoIntersects geoIntersects) {
	...
	public RECYCLING_CENTER(GeoOverlaps geoOverlaps) {
	...
	public RECYCLING_CENTER(GeoTouches geoTouches) {
	...
	public RECYCLING_CENTER(GeoWithin geoWithin) {
	...
	public RECYCLING_CENTER(Slogan slogan) {
		setSlogan(slogan);
	}
