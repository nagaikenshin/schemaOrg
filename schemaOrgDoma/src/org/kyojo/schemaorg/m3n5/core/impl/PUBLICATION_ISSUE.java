...
public class PUBLICATION_ISSUE implements Clazz.PublicationIssue {
	...
	public PUBLICATION_ISSUE() {
	}

	public PUBLICATION_ISSUE(Long seq) {
		setSeq(seq);
	}

	public PUBLICATION_ISSUE(String string) {
	...
	public PUBLICATION_ISSUE(About about) {
		setAbout(about);
	}
	...
	public PUBLICATION_ISSUE(AccessMode accessMode) {
	...
	public PUBLICATION_ISSUE(AccessModeSufficient accessModeSufficient) {
	...
	public PUBLICATION_ISSUE(AccessibilityAPI accessibilityAPI) {
	...
	public PUBLICATION_ISSUE(AccessibilityControl accessibilityControl) {
	...
	public PUBLICATION_ISSUE(AccessibilityFeature accessibilityFeature) {
	...
	public PUBLICATION_ISSUE(AccessibilityHazard accessibilityHazard) {
	...
	public PUBLICATION_ISSUE(AccessibilitySummary accessibilitySummary) {
	...
	public PUBLICATION_ISSUE(AccountablePerson accountablePerson) {
	...
	public PUBLICATION_ISSUE(AdditionalType additionalType) {
	...
	public PUBLICATION_ISSUE(AggregateRating aggregateRating) {
	...
	public PUBLICATION_ISSUE(AlternateName alternateName) {
	...
	public PUBLICATION_ISSUE(AlternativeHeadline alternativeHeadline) {
	...
	public PUBLICATION_ISSUE(AssociatedMedia associatedMedia) {
	...
	public PUBLICATION_ISSUE(Audience audience) {
	...
	public PUBLICATION_ISSUE(Audio audio) {
		setAudio(audio);
	}
	...
	public PUBLICATION_ISSUE(Author author) {
		setAuthor(author);
	}
	...
	public PUBLICATION_ISSUE(Award award) {
		setAward(award);
	}
	...
	public PUBLICATION_ISSUE(Character character) {
	...
	public PUBLICATION_ISSUE(Citation citation) {
	...
	public PUBLICATION_ISSUE(Comment comment) {
		setComment(comment);
	}
	...
	public PUBLICATION_ISSUE(CommentCount commentCount) {
	...
	public PUBLICATION_ISSUE(ContentLocation contentLocation) {
	...
	public PUBLICATION_ISSUE(ContentRating contentRating) {
	...
	public PUBLICATION_ISSUE(ContentReferenceTime contentReferenceTime) {
	...
	public PUBLICATION_ISSUE(Contributor contributor) {
	...
	public PUBLICATION_ISSUE(CopyrightHolder copyrightHolder) {
	...
	public PUBLICATION_ISSUE(CopyrightYear copyrightYear) {
	...
	public PUBLICATION_ISSUE(Correction correction) {
	...
	public PUBLICATION_ISSUE(Creator creator) {
		setCreator(creator);
	}
	...
	public PUBLICATION_ISSUE(DateCreated dateCreated) {
	...
	public PUBLICATION_ISSUE(DateModified dateModified) {
	...
	public PUBLICATION_ISSUE(DatePublished datePublished) {
	...
	public PUBLICATION_ISSUE(Description description) {
	...
	public PUBLICATION_ISSUE(DisambiguatingDescription disambiguatingDescription) {
	...
	public PUBLICATION_ISSUE(DiscussionUrl discussionUrl) {
	...
	public PUBLICATION_ISSUE(Editor editor) {
		setEditor(editor);
	}
	...
	public PUBLICATION_ISSUE(EducationalAlignment educationalAlignment) {
	...
	public PUBLICATION_ISSUE(EducationalUse educationalUse) {
	...
	public PUBLICATION_ISSUE(Encoding encoding) {
	...
	public PUBLICATION_ISSUE(EncodingFormat encodingFormat) {
	...
	public PUBLICATION_ISSUE(ExampleOfWork exampleOfWork) {
	...
	public PUBLICATION_ISSUE(Expires expires) {
		setExpires(expires);
	}
	...
	public PUBLICATION_ISSUE(Funder funder) {
		setFunder(funder);
	}
	...
	public PUBLICATION_ISSUE(Genre genre) {
		setGenre(genre);
	}
	...
	public PUBLICATION_ISSUE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public PUBLICATION_ISSUE(Headline headline) {
	...
	public PUBLICATION_ISSUE(Identifier identifier) {
	...
	public PUBLICATION_ISSUE(Image image) {
		setImage(image);
	}
	...
	public PUBLICATION_ISSUE(InLanguage inLanguage) {
	...
	public PUBLICATION_ISSUE(InteractionStatistic interactionStatistic) {
	...
	public PUBLICATION_ISSUE(InteractivityType interactivityType) {
	...
	public PUBLICATION_ISSUE(IsAccessibleForFree isAccessibleForFree) {
	...
	public PUBLICATION_ISSUE(IsBasedOn isBasedOn) {
	...
	public PUBLICATION_ISSUE(IsFamilyFriendly isFamilyFriendly) {
	...
	public PUBLICATION_ISSUE(IsPartOf isPartOf) {
	...
	public PUBLICATION_ISSUE(IssueNumber issueNumber) {
	...
	@Override
	public void setIssueNumber(IssueNumber issueNumber) {
		this.issueNumber = issueNumber;
	}

	public PUBLICATION_ISSUE(Keywords keywords) {
	...
	public PUBLICATION_ISSUE(LearningResourceType learningResourceType) {
	...
	public PUBLICATION_ISSUE(License license) {
		setLicense(license);
	}
	...
	public PUBLICATION_ISSUE(LocationCreated locationCreated) {
	...
	public PUBLICATION_ISSUE(MainEntity mainEntity) {
	...
	public PUBLICATION_ISSUE(MainEntityOfPage mainEntityOfPage) {
	...
	public PUBLICATION_ISSUE(Material material) {
	...
	public PUBLICATION_ISSUE(MaterialExtent materialExtent) {
	...
	public PUBLICATION_ISSUE(Mentions mentions) {
	...
	public PUBLICATION_ISSUE(Name name) {
		setName(name);
	}
	...
	public PUBLICATION_ISSUE(NameFuzzy nameFuzzy) {
	...
	public PUBLICATION_ISSUE(NameRuby nameRuby) {
	...
	public PUBLICATION_ISSUE(Offers offers) {
		setOffers(offers);
	}
	...
	public PUBLICATION_ISSUE(PageEnd pageEnd) {
		setPageEnd(pageEnd);
	}
	...
	public PUBLICATION_ISSUE(PageStart pageStart) {
	...
	public PUBLICATION_ISSUE(Pagination pagination) {
	...
	public PUBLICATION_ISSUE(Position position) {
	...
	public PUBLICATION_ISSUE(PotentialAction potentialAction) {
	...
	public PUBLICATION_ISSUE(Producer producer) {
	...
	public PUBLICATION_ISSUE(Provider provider) {
	...
	public PUBLICATION_ISSUE(Publication publication) {
	...
	public PUBLICATION_ISSUE(Publisher publisher) {
	...
	public PUBLICATION_ISSUE(PublisherImprint publisherImprint) {
	...
	public PUBLICATION_ISSUE(PublishingPrinciples publishingPrinciples) {
	...
	public PUBLICATION_ISSUE(RecordedAt recordedAt) {
	...
	public PUBLICATION_ISSUE(ReleasedEvent releasedEvent) {
	...
	public PUBLICATION_ISSUE(Review review) {
		setReview(review);
	}
	...
	public PUBLICATION_ISSUE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PUBLICATION_ISSUE(SchemaVersion schemaVersion) {
	...
	public PUBLICATION_ISSUE(SdDatePublished sdDatePublished) {
	...
	public PUBLICATION_ISSUE(SdLicense sdLicense) {
	...
	public PUBLICATION_ISSUE(SdPublisher sdPublisher) {
	...
	public PUBLICATION_ISSUE(SourceOrganization sourceOrganization) {
	...
	public PUBLICATION_ISSUE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public PUBLICATION_ISSUE(SpatialCoverage spatialCoverage) {
	...
	public PUBLICATION_ISSUE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public PUBLICATION_ISSUE(SubjectOf subjectOf) {
	...
	public PUBLICATION_ISSUE(Temporal temporal) {
	...
	public PUBLICATION_ISSUE(TemporalCoverage temporalCoverage) {
	...
	public PUBLICATION_ISSUE(Text text) {
		setText(text);
	}
	...
	public PUBLICATION_ISSUE(ThumbnailUrl thumbnailUrl) {
	...
	public PUBLICATION_ISSUE(TimeRequired timeRequired) {
	...
	public PUBLICATION_ISSUE(TranslationOfWork translationOfWork) {
	...
	public PUBLICATION_ISSUE(Translator translator) {
	...
	public PUBLICATION_ISSUE(TypicalAgeRange typicalAgeRange) {
	...
	public PUBLICATION_ISSUE(Url url) {
		setUrl(url);
	}
	...
	public PUBLICATION_ISSUE(Version version) {
		setVersion(version);
	}
	...
	public PUBLICATION_ISSUE(Video video) {
		setVideo(video);
	}
	...
	public PUBLICATION_ISSUE(WorkExample workExample) {
	...
	public PUBLICATION_ISSUE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.PublicationIssue org) {
		setSeq(org.getSeq());
		...
		setIssueNumber(org.getIssueNumber());
