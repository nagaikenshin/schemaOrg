...
public class BOWLING_ALLEY implements Clazz.BowlingAlley {
	...
	public BOWLING_ALLEY(GeoContains geoContains) {
	...
	public BOWLING_ALLEY(GeoCoveredBy geoCoveredBy) {
	...
	public BOWLING_ALLEY(GeoCovers geoCovers) {
	...
	public BOWLING_ALLEY(GeoCrosses geoCrosses) {
	...
	public BOWLING_ALLEY(GeoDisjoint geoDisjoint) {
	...
	public BOWLING_ALLEY(GeoEquals geoEquals) {
	...
	public BOWLING_ALLEY(GeoIntersects geoIntersects) {
	...
	public BOWLING_ALLEY(GeoOverlaps geoOverlaps) {
	...
	public BOWLING_ALLEY(GeoTouches geoTouches) {
	...
	public BOWLING_ALLEY(GeoWithin geoWithin) {
	...
	public BOWLING_ALLEY(Slogan slogan) {
		setSlogan(slogan);
	}
