...
public class GOVERNMENT_OFFICE implements Clazz.GovernmentOffice {
	...
	public GOVERNMENT_OFFICE(GeoContains geoContains) {
	...
	public GOVERNMENT_OFFICE(GeoCoveredBy geoCoveredBy) {
	...
	public GOVERNMENT_OFFICE(GeoCovers geoCovers) {
	...
	public GOVERNMENT_OFFICE(GeoCrosses geoCrosses) {
	...
	public GOVERNMENT_OFFICE(GeoDisjoint geoDisjoint) {
	...
	public GOVERNMENT_OFFICE(GeoEquals geoEquals) {
	...
	public GOVERNMENT_OFFICE(GeoIntersects geoIntersects) {
	...
	public GOVERNMENT_OFFICE(GeoOverlaps geoOverlaps) {
	...
	public GOVERNMENT_OFFICE(GeoTouches geoTouches) {
	...
	public GOVERNMENT_OFFICE(GeoWithin geoWithin) {
	...
	public GOVERNMENT_OFFICE(Slogan slogan) {
		setSlogan(slogan);
	}
