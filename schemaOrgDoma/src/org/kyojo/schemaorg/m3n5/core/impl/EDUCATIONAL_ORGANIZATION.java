...
public class EDUCATIONAL_ORGANIZATION implements Clazz.EducationalOrganization {
	...
	public EDUCATIONAL_ORGANIZATION(DiversityStaffingReport diversityStaffingReport) {
	...
	public EDUCATIONAL_ORGANIZATION(KnowsAbout knowsAbout) {
	...
	public EDUCATIONAL_ORGANIZATION(KnowsLanguage knowsLanguage) {
	...
	public EDUCATIONAL_ORGANIZATION(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public EDUCATIONAL_ORGANIZATION(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public EDUCATIONAL_ORGANIZATION(SubjectOf subjectOf) {
