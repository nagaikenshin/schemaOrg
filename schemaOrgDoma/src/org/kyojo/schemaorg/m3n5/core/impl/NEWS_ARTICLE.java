...
public class NEWS_ARTICLE implements Clazz.NewsArticle {
	...
	public NEWS_ARTICLE(Long seq) {
		setSeq(seq);
	}

	public NEWS_ARTICLE(String string) {
	...
	public NEWS_ARTICLE(About about) {
		setAbout(about);
	}
	...
	public NEWS_ARTICLE(AccessMode accessMode) {
	...
	public NEWS_ARTICLE(AccessModeSufficient accessModeSufficient) {
	...
	public NEWS_ARTICLE(AccessibilityAPI accessibilityAPI) {
	...
	public NEWS_ARTICLE(AccessibilityControl accessibilityControl) {
	...
	public NEWS_ARTICLE(AccessibilityFeature accessibilityFeature) {
	...
	public NEWS_ARTICLE(AccessibilityHazard accessibilityHazard) {
	...
	public NEWS_ARTICLE(AccessibilitySummary accessibilitySummary) {
	...
	public NEWS_ARTICLE(AccountablePerson accountablePerson) {
	...
	public NEWS_ARTICLE(AdditionalType additionalType) {
	...
	public NEWS_ARTICLE(AggregateRating aggregateRating) {
	...
	public NEWS_ARTICLE(AlternateName alternateName) {
	...
	public NEWS_ARTICLE(AlternativeHeadline alternativeHeadline) {
	...
	public NEWS_ARTICLE(ArticleBody articleBody) {
	...
	public NEWS_ARTICLE(ArticleSection articleSection) {
	...
	public NEWS_ARTICLE(AssociatedMedia associatedMedia) {
	...
	public NEWS_ARTICLE(Audience audience) {
	...
	public NEWS_ARTICLE(Audio audio) {
		setAudio(audio);
	}
	...
	public NEWS_ARTICLE(Author author) {
		setAuthor(author);
	}
	...
	public NEWS_ARTICLE(Award award) {
		setAward(award);
	}
	...
	public NEWS_ARTICLE(Backstory backstory) {
	...
	public NEWS_ARTICLE(Character character) {
	...
	public NEWS_ARTICLE(Citation citation) {
	...
	public NEWS_ARTICLE(Comment comment) {
		setComment(comment);
	}
	...
	public NEWS_ARTICLE(CommentCount commentCount) {
	...
	public NEWS_ARTICLE(ContentLocation contentLocation) {
	...
	public NEWS_ARTICLE(ContentRating contentRating) {
	...
	public NEWS_ARTICLE(ContentReferenceTime contentReferenceTime) {
	...
	public NEWS_ARTICLE(Contributor contributor) {
	...
	public NEWS_ARTICLE(CopyrightHolder copyrightHolder) {
	...
	public NEWS_ARTICLE(CopyrightYear copyrightYear) {
	...
	public NEWS_ARTICLE(Correction correction) {
	...
	public NEWS_ARTICLE(Creator creator) {
		setCreator(creator);
	}
	...
	public NEWS_ARTICLE(DateCreated dateCreated) {
	...
	public NEWS_ARTICLE(DateModified dateModified) {
	...
	public NEWS_ARTICLE(DatePublished datePublished) {
	...
	public NEWS_ARTICLE(Dateline dateline) {
	...
	public NEWS_ARTICLE(Description description) {
	...
	public NEWS_ARTICLE(DisambiguatingDescription disambiguatingDescription) {
	...
	public NEWS_ARTICLE(DiscussionUrl discussionUrl) {
	...
	public NEWS_ARTICLE(Editor editor) {
		setEditor(editor);
	}
	...
	public NEWS_ARTICLE(EducationalAlignment educationalAlignment) {
	...
	public NEWS_ARTICLE(EducationalUse educationalUse) {
	...
	public NEWS_ARTICLE(Encoding encoding) {
	...
	public NEWS_ARTICLE(EncodingFormat encodingFormat) {
	...
	public NEWS_ARTICLE(ExampleOfWork exampleOfWork) {
	...
	public NEWS_ARTICLE(Expires expires) {
		setExpires(expires);
	}
	...
	public NEWS_ARTICLE(Funder funder) {
		setFunder(funder);
	}
	...
	public NEWS_ARTICLE(Genre genre) {
		setGenre(genre);
	}
	...
	public NEWS_ARTICLE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public NEWS_ARTICLE(Headline headline) {
	...
	public NEWS_ARTICLE(Identifier identifier) {
	...
	public NEWS_ARTICLE(Image image) {
		setImage(image);
	}
	...
	public NEWS_ARTICLE(InLanguage inLanguage) {
	...
	public NEWS_ARTICLE(InteractionStatistic interactionStatistic) {
	...
	public NEWS_ARTICLE(InteractivityType interactivityType) {
	...
	public NEWS_ARTICLE(IsAccessibleForFree isAccessibleForFree) {
	...
	public NEWS_ARTICLE(IsBasedOn isBasedOn) {
	...
	public NEWS_ARTICLE(IsFamilyFriendly isFamilyFriendly) {
	...
	public NEWS_ARTICLE(IsPartOf isPartOf) {
	...
	public NEWS_ARTICLE(Keywords keywords) {
	...
	public NEWS_ARTICLE(LearningResourceType learningResourceType) {
	...
	public NEWS_ARTICLE(License license) {
		setLicense(license);
	}
	...
	public NEWS_ARTICLE(LocationCreated locationCreated) {
	...
	public NEWS_ARTICLE(MainEntity mainEntity) {
	...
	public NEWS_ARTICLE(MainEntityOfPage mainEntityOfPage) {
	...
	public NEWS_ARTICLE(Material material) {
	...
	public NEWS_ARTICLE(MaterialExtent materialExtent) {
	...
	public NEWS_ARTICLE(Mentions mentions) {
	...
	public NEWS_ARTICLE(NameFuzzy nameFuzzy) {
	...
	public NEWS_ARTICLE(NameRuby nameRuby) {
	...
	public NEWS_ARTICLE(Offers offers) {
		setOffers(offers);
	}
	...
	public NEWS_ARTICLE(PageEnd pageEnd) {
		setPageEnd(pageEnd);
	}
	...
	public NEWS_ARTICLE(PageStart pageStart) {
	...
	public NEWS_ARTICLE(Pagination pagination) {
	...
	public NEWS_ARTICLE(Position position) {
	...
	public NEWS_ARTICLE(PotentialAction potentialAction) {
	...
	public NEWS_ARTICLE(PrintColumn printColumn) {
	...
	public NEWS_ARTICLE(PrintEdition printEdition) {
	...
	public NEWS_ARTICLE(PrintPage printPage) {
	...
	public NEWS_ARTICLE(PrintSection printSection) {
	...
	public NEWS_ARTICLE(Producer producer) {
	...
	public NEWS_ARTICLE(Provider provider) {
	...
	public NEWS_ARTICLE(Publication publication) {
	...
	public NEWS_ARTICLE(Publisher publisher) {
	...
	public NEWS_ARTICLE(PublisherImprint publisherImprint) {
	...
	public NEWS_ARTICLE(PublishingPrinciples publishingPrinciples) {
	...
	public NEWS_ARTICLE(RecordedAt recordedAt) {
	...
	public NEWS_ARTICLE(ReleasedEvent releasedEvent) {
	...
	public NEWS_ARTICLE(Review review) {
		setReview(review);
	}
	...
	public NEWS_ARTICLE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public NEWS_ARTICLE(SchemaVersion schemaVersion) {
	...
	public NEWS_ARTICLE(SdDatePublished sdDatePublished) {
	...
	public NEWS_ARTICLE(SdLicense sdLicense) {
	...
	public NEWS_ARTICLE(SdPublisher sdPublisher) {
	...
	public NEWS_ARTICLE(SourceOrganization sourceOrganization) {
	...
	public NEWS_ARTICLE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public NEWS_ARTICLE(SpatialCoverage spatialCoverage) {
	...
	public NEWS_ARTICLE(Speakable speakable) {
	...
	public NEWS_ARTICLE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public NEWS_ARTICLE(SubjectOf subjectOf) {
	...
	public NEWS_ARTICLE(Temporal temporal) {
	...
	public NEWS_ARTICLE(TemporalCoverage temporalCoverage) {
	...
	public NEWS_ARTICLE(ThumbnailUrl thumbnailUrl) {
	...
	public NEWS_ARTICLE(TimeRequired timeRequired) {
	...
	public NEWS_ARTICLE(TranslationOfWork translationOfWork) {
	...
	public NEWS_ARTICLE(Translator translator) {
	...
	public NEWS_ARTICLE(TypicalAgeRange typicalAgeRange) {
	...
	public NEWS_ARTICLE(Version version) {
		setVersion(version);
	}
	...
	public NEWS_ARTICLE(Video video) {
		setVideo(video);
	}
	...
	public NEWS_ARTICLE(WordCount wordCount) {
	...
	public NEWS_ARTICLE(WorkExample workExample) {
	...
	public NEWS_ARTICLE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.NewsArticle org) {
		setSeq(org.getSeq());
