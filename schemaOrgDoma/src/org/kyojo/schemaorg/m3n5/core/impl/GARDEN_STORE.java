...
public class GARDEN_STORE implements Clazz.GardenStore {
	...
	public GARDEN_STORE(GeoContains geoContains) {
	...
	public GARDEN_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public GARDEN_STORE(GeoCovers geoCovers) {
	...
	public GARDEN_STORE(GeoCrosses geoCrosses) {
	...
	public GARDEN_STORE(GeoDisjoint geoDisjoint) {
	...
	public GARDEN_STORE(GeoEquals geoEquals) {
	...
	public GARDEN_STORE(GeoIntersects geoIntersects) {
	...
	public GARDEN_STORE(GeoOverlaps geoOverlaps) {
	...
	public GARDEN_STORE(GeoTouches geoTouches) {
	...
	public GARDEN_STORE(GeoWithin geoWithin) {
	...
	public GARDEN_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
