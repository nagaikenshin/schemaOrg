...
public class DANCE_GROUP implements Clazz.DanceGroup {
	...
	public DANCE_GROUP(Long seq) {
		setSeq(seq);
	}

	public DANCE_GROUP(String string) {
	...
	public DANCE_GROUP(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public DANCE_GROUP(AdditionalType additionalType) {
	...
	public DANCE_GROUP(Address address) {
		setAddress(address);
	}
	...
	public DANCE_GROUP(AggregateRating aggregateRating) {
	...
	public DANCE_GROUP(AlternateName alternateName) {
	...
	public DANCE_GROUP(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public DANCE_GROUP(AreaServed areaServed) {
	...
	public DANCE_GROUP(Award award) {
		setAward(award);
	}
	...
	public DANCE_GROUP(Brand brand) {
		setBrand(brand);
	}
	...
	public DANCE_GROUP(ContactPoint contactPoint) {
	...
	public DANCE_GROUP(CorrectionsPolicy correctionsPolicy) {
	...
	public DANCE_GROUP(Department department) {
	...
	public DANCE_GROUP(Description description) {
	...
	public DANCE_GROUP(DisambiguatingDescription disambiguatingDescription) {
	...
	public DANCE_GROUP(DissolutionDate dissolutionDate) {
	...
	public DANCE_GROUP(DiversityPolicy diversityPolicy) {
	...
	public DANCE_GROUP(DiversityStaffingReport diversityStaffingReport) {
	...
	public DANCE_GROUP(Email email) {
		setEmail(email);
	}
	...
	public DANCE_GROUP(Employee employee) {
	...
	public DANCE_GROUP(EthicsPolicy ethicsPolicy) {
	...
	public DANCE_GROUP(Event event) {
		setEvent(event);
	}
	...
	public DANCE_GROUP(FaxNumber faxNumber) {
	...
	public DANCE_GROUP(Founder founder) {
		setFounder(founder);
	}
	...
	public DANCE_GROUP(FoundingDate foundingDate) {
	...
	public DANCE_GROUP(FoundingLocation foundingLocation) {
	...
	public DANCE_GROUP(Funder funder) {
		setFunder(funder);
	}
	...
	public DANCE_GROUP(GlobalLocationNumber globalLocationNumber) {
	...
	public DANCE_GROUP(HasOfferCatalog hasOfferCatalog) {
	...
	public DANCE_GROUP(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public DANCE_GROUP(Identifier identifier) {
	...
	public DANCE_GROUP(Image image) {
		setImage(image);
	}
	...
	public DANCE_GROUP(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public DANCE_GROUP(KnowsAbout knowsAbout) {
	...
	public DANCE_GROUP(KnowsLanguage knowsLanguage) {
	...
	public DANCE_GROUP(LegalName legalName) {
	...
	public DANCE_GROUP(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public DANCE_GROUP(Location location) {
	...
	public DANCE_GROUP(MainEntityOfPage mainEntityOfPage) {
	...
	public DANCE_GROUP(MakesOffer makesOffer) {
	...
	public DANCE_GROUP(Member member) {
		setMember(member);
	}
	...
	public DANCE_GROUP(MemberOf memberOf) {
	...
	public DANCE_GROUP(Naics naics) {
		setNaics(naics);
	}
	...
	public DANCE_GROUP(NameFuzzy nameFuzzy) {
	...
	public DANCE_GROUP(NameRuby nameRuby) {
	...
	public DANCE_GROUP(NumberOfEmployees numberOfEmployees) {
	...
	public DANCE_GROUP(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public DANCE_GROUP(ParentOrganization parentOrganization) {
	...
	public DANCE_GROUP(PotentialAction potentialAction) {
	...
	public DANCE_GROUP(PublishingPrinciples publishingPrinciples) {
	...
	public DANCE_GROUP(Review review) {
		setReview(review);
	}
	...
	public DANCE_GROUP(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DANCE_GROUP(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public DANCE_GROUP(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public DANCE_GROUP(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public DANCE_GROUP(SubOrganization subOrganization) {
	...
	public DANCE_GROUP(SubjectOf subjectOf) {
	...
	public DANCE_GROUP(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public DANCE_GROUP(Telephone telephone) {
	...
	public DANCE_GROUP(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public DANCE_GROUP(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.DanceGroup org) {
		setSeq(org.getSeq());
