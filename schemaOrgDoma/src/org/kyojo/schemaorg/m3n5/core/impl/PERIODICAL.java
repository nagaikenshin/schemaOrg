...
public class PERIODICAL implements Clazz.Periodical {
	...
	public PERIODICAL(Long seq) {
		setSeq(seq);
	}

	public PERIODICAL(String string) {
	...
	public PERIODICAL(AccessMode accessMode) {
	...
	public PERIODICAL(AccessModeSufficient accessModeSufficient) {
	...
	public PERIODICAL(AccessibilityAPI accessibilityAPI) {
	...
	public PERIODICAL(AccessibilityControl accessibilityControl) {
	...
	public PERIODICAL(AccessibilityFeature accessibilityFeature) {
	...
	public PERIODICAL(AccessibilityHazard accessibilityHazard) {
	...
	public PERIODICAL(AccessibilitySummary accessibilitySummary) {
	...
	public PERIODICAL(AccountablePerson accountablePerson) {
	...
	public PERIODICAL(AdditionalType additionalType) {
	...
	public PERIODICAL(AggregateRating aggregateRating) {
	...
	public PERIODICAL(AlternateName alternateName) {
	...
	public PERIODICAL(AlternativeHeadline alternativeHeadline) {
	...
	public PERIODICAL(AssociatedMedia associatedMedia) {
	...
	public PERIODICAL(Audience audience) {
	...
	public PERIODICAL(Author author) {
		setAuthor(author);
	}
	...
	public PERIODICAL(Character character) {
	...
	public PERIODICAL(Citation citation) {
	...
	public PERIODICAL(Comment comment) {
		setComment(comment);
	}
	...
	public PERIODICAL(CommentCount commentCount) {
	...
	public PERIODICAL(ContentLocation contentLocation) {
	...
	public PERIODICAL(ContentRating contentRating) {
	...
	public PERIODICAL(ContentReferenceTime contentReferenceTime) {
	...
	public PERIODICAL(Contributor contributor) {
	...
	public PERIODICAL(CopyrightHolder copyrightHolder) {
	...
	public PERIODICAL(CopyrightYear copyrightYear) {
	...
	public PERIODICAL(Correction correction) {
	...
	public PERIODICAL(Creator creator) {
		setCreator(creator);
	}
	...
	public PERIODICAL(DateCreated dateCreated) {
	...
	public PERIODICAL(DateModified dateModified) {
	...
	public PERIODICAL(DatePublished datePublished) {
	...
	public PERIODICAL(Description description) {
	...
	public PERIODICAL(DisambiguatingDescription disambiguatingDescription) {
	...
	public PERIODICAL(DiscussionUrl discussionUrl) {
	...
	public PERIODICAL(Editor editor) {
		setEditor(editor);
	}
	...
	public PERIODICAL(EducationalAlignment educationalAlignment) {
	...
	public PERIODICAL(EducationalUse educationalUse) {
	...
	public PERIODICAL(Encoding encoding) {
	...
	public PERIODICAL(EncodingFormat encodingFormat) {
	...
	public PERIODICAL(EndDate endDate) {
		setEndDate(endDate);
	}
	...
	public PERIODICAL(ExampleOfWork exampleOfWork) {
	...
	public PERIODICAL(Expires expires) {
		setExpires(expires);
	}
	...
	public PERIODICAL(Funder funder) {
		setFunder(funder);
	}
	...
	public PERIODICAL(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public PERIODICAL(Headline headline) {
	...
	public PERIODICAL(Identifier identifier) {
	...
	public PERIODICAL(InLanguage inLanguage) {
	...
	public PERIODICAL(InteractionStatistic interactionStatistic) {
	...
	public PERIODICAL(InteractivityType interactivityType) {
	...
	public PERIODICAL(IsAccessibleForFree isAccessibleForFree) {
	...
	public PERIODICAL(IsBasedOn isBasedOn) {
	...
	public PERIODICAL(IsFamilyFriendly isFamilyFriendly) {
	...
	public PERIODICAL(IsPartOf isPartOf) {
	...
	public PERIODICAL(Keywords keywords) {
	...
	public PERIODICAL(LearningResourceType learningResourceType) {
	...
	public PERIODICAL(License license) {
		setLicense(license);
	}
	...
	public PERIODICAL(LocationCreated locationCreated) {
	...
	public PERIODICAL(MainEntity mainEntity) {
	...
	public PERIODICAL(MainEntityOfPage mainEntityOfPage) {
	...
	public PERIODICAL(Material material) {
	...
	public PERIODICAL(MaterialExtent materialExtent) {
	...
	public PERIODICAL(Mentions mentions) {
	...
	public PERIODICAL(NameFuzzy nameFuzzy) {
	...
	public PERIODICAL(NameRuby nameRuby) {
	...
	public PERIODICAL(Offers offers) {
		setOffers(offers);
	}
	...
	public PERIODICAL(Position position) {
	...
	public PERIODICAL(PotentialAction potentialAction) {
	...
	public PERIODICAL(Producer producer) {
	...
	public PERIODICAL(Provider provider) {
	...
	public PERIODICAL(Publication publication) {
	...
	public PERIODICAL(Publisher publisher) {
	...
	public PERIODICAL(PublisherImprint publisherImprint) {
	...
	public PERIODICAL(PublishingPrinciples publishingPrinciples) {
	...
	public PERIODICAL(RecordedAt recordedAt) {
	...
	public PERIODICAL(ReleasedEvent releasedEvent) {
	...
	public PERIODICAL(Review review) {
		setReview(review);
	}
	...
	public PERIODICAL(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PERIODICAL(SchemaVersion schemaVersion) {
	...
	public PERIODICAL(SdDatePublished sdDatePublished) {
	...
	public PERIODICAL(SdLicense sdLicense) {
	...
	public PERIODICAL(SdPublisher sdPublisher) {
	...
	public PERIODICAL(SourceOrganization sourceOrganization) {
	...
	public PERIODICAL(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public PERIODICAL(SpatialCoverage spatialCoverage) {
	...
	public PERIODICAL(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public PERIODICAL(StartDate startDate) {
	...
	public PERIODICAL(SubjectOf subjectOf) {
	...
	public PERIODICAL(Temporal temporal) {
	...
	public PERIODICAL(TemporalCoverage temporalCoverage) {
	...
	public PERIODICAL(ThumbnailUrl thumbnailUrl) {
	...
	public PERIODICAL(TimeRequired timeRequired) {
	...
	public PERIODICAL(TranslationOfWork translationOfWork) {
	...
	public PERIODICAL(Translator translator) {
	...
	public PERIODICAL(TypicalAgeRange typicalAgeRange) {
	...
	public PERIODICAL(Version version) {
		setVersion(version);
	}
	...
	public PERIODICAL(WorkExample workExample) {
	...
	public PERIODICAL(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Periodical org) {
		setSeq(org.getSeq());
