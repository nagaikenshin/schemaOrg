...
public class LANDLORD implements Container.Landlord {
	...
	public LANDLORD(AccountingService accountingService) {
	...
	public LANDLORD(AdultEntertainment adultEntertainment) {
	...
	public LANDLORD(Airline airline) {
	...
	public LANDLORD(AmusementPark amusementPark) {
	...
	public LANDLORD(AnimalShelter animalShelter) {
	...
	public LANDLORD(ArchiveOrganization archiveOrganization) {
	...
	public LANDLORD(ArtGallery artGallery) {
	...
	public LANDLORD(Attorney attorney) {
	...
	public LANDLORD(AutoBodyShop autoBodyShop) {
	...
	public LANDLORD(AutoDealer autoDealer) {
	...
	public LANDLORD(AutoPartsStore autoPartsStore) {
	...
	public LANDLORD(AutoRental autoRental) {
	...
	public LANDLORD(AutoRepair autoRepair) {
	...
	public LANDLORD(AutoWash autoWash) {
	...
	public LANDLORD(AutomatedTeller automatedTeller) {
	...
	public LANDLORD(AutomotiveBusiness automotiveBusiness) {
	...
	public LANDLORD(BankOrCreditUnion bankOrCreditUnion) {
	...
	public LANDLORD(BarOrPub barOrPub) {
	...
	public LANDLORD(BeautySalon beautySalon) {
	...
	public LANDLORD(BedAndBreakfast bedAndBreakfast) {
	...
	public LANDLORD(BikeStore bikeStore) {
	...
	public LANDLORD(BookStore bookStore) {
	...
	public LANDLORD(BowlingAlley bowlingAlley) {
	...
	public LANDLORD(Brewery brewery) {
	...
	public LANDLORD(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public LANDLORD(Campground campground) {
	...
	public LANDLORD(ChildCare childCare) {
	...
	public LANDLORD(ClothingStore clothingStore) {
	...
	public LANDLORD(CollegeOrUniversity collegeOrUniversity) {
	...
	public LANDLORD(ComedyClub comedyClub) {
	...
	public LANDLORD(CommunityHealth communityHealth) {
	...
	public LANDLORD(ComputerStore computerStore) {
	...
	public LANDLORD(Consortium consortium) {
	...
	public LANDLORD(ConvenienceStore convenienceStore) {
	...
	public LANDLORD(Corporation corporation) {
	...
	public LANDLORD(DanceGroup danceGroup) {
	...
	public LANDLORD(Dentist dentist) {
	...
	public LANDLORD(DepartmentStore departmentStore) {
	...
	public LANDLORD(Dermatology dermatology) {
	...
	public LANDLORD(DiagnosticLab diagnosticLab) {
	...
	public LANDLORD(DietNutrition dietNutrition) {
	...
	public LANDLORD(Distillery distillery) {
	...
	public LANDLORD(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public LANDLORD(EducationalOrganization educationalOrganization) {
	...
	public LANDLORD(Electrician electrician) {
	...
	public LANDLORD(ElectronicsStore electronicsStore) {
	...
	public LANDLORD(ElementarySchool elementarySchool) {
	...
	public LANDLORD(Emergency emergency) {
	...
	public LANDLORD(EmergencyService emergencyService) {
	...
	public LANDLORD(EmploymentAgency employmentAgency) {
	...
	public LANDLORD(EntertainmentBusiness entertainmentBusiness) {
	...
	public LANDLORD(ExerciseGym exerciseGym) {
	...
	public LANDLORD(FastFoodRestaurant fastFoodRestaurant) {
	...
	public LANDLORD(FinancialService financialService) {
	...
	public LANDLORD(FireStation fireStation) {
	...
	public LANDLORD(Florist florist) {
	...
	public LANDLORD(FoodEstablishment foodEstablishment) {
	...
	public LANDLORD(FundingAgency fundingAgency) {
	...
	public LANDLORD(FundingScheme fundingScheme) {
	...
	public LANDLORD(FurnitureStore furnitureStore) {
	...
	public LANDLORD(GardenStore gardenStore) {
	...
	public LANDLORD(GasStation gasStation) {
	...
	public LANDLORD(GeneralContractor generalContractor) {
	...
	public LANDLORD(Geriatric geriatric) {
	...
	public LANDLORD(GolfCourse golfCourse) {
	...
	public LANDLORD(GovernmentOffice governmentOffice) {
	...
	public LANDLORD(GovernmentOrganization governmentOrganization) {
	...
	public LANDLORD(GroceryStore groceryStore) {
	...
	public LANDLORD(Gynecologic gynecologic) {
	...
	public LANDLORD(HVACBusiness hvacBusiness) {
	...
	public LANDLORD(HairSalon hairSalon) {
	...
	public LANDLORD(HardwareStore hardwareStore) {
	...
	public LANDLORD(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public LANDLORD(HealthClub healthClub) {
	...
	public LANDLORD(HighSchool highSchool) {
	...
	public LANDLORD(HobbyShop hobbyShop) {
	...
	public LANDLORD(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public LANDLORD(HomeGoodsStore homeGoodsStore) {
	...
	public LANDLORD(Hospital hospital) {
	...
	public LANDLORD(HousePainter housePainter) {
	...
	public LANDLORD(IceCreamShop iceCreamShop) {
	...
	public LANDLORD(InsuranceAgency insuranceAgency) {
	...
	public LANDLORD(InternetCafe internetCafe) {
	...
	public LANDLORD(JewelryStore jewelryStore) {
	...
	public LANDLORD(LegalService legalService) {
	...
	public LANDLORD(Library library) {
	...
	public LANDLORD(LibrarySystem librarySystem) {
	...
	public LANDLORD(LiquorStore liquorStore) {
	...
	public LANDLORD(LocalBusiness localBusiness) {
	...
	public LANDLORD(Locksmith locksmith) {
	...
	public LANDLORD(LodgingBusiness lodgingBusiness) {
	...
	public LANDLORD(MedicalBusiness medicalBusiness) {
	...
	public LANDLORD(MedicalClinic medicalClinic) {
	...
	public LANDLORD(MedicalOrganization medicalOrganization) {
	...
	public LANDLORD(MensClothingStore mensClothingStore) {
	...
	public LANDLORD(MiddleSchool middleSchool) {
	...
	public LANDLORD(Midwifery midwifery) {
	...
	public LANDLORD(MobilePhoneStore mobilePhoneStore) {
	...
	public LANDLORD(MotorcycleDealer motorcycleDealer) {
	...
	public LANDLORD(MotorcycleRepair motorcycleRepair) {
	...
	public LANDLORD(MovieRentalStore movieRentalStore) {
	...
	public LANDLORD(MovieTheater movieTheater) {
	...
	public LANDLORD(MovingCompany movingCompany) {
	...
	public LANDLORD(MusicGroup musicGroup) {
	...
	public LANDLORD(MusicStore musicStore) {
	...
	public LANDLORD(NailSalon nailSalon) {
	...
	public LANDLORD(NewsMediaOrganization newsMediaOrganization) {
	...
	public LANDLORD(NightClub nightClub) {
	...
	public LANDLORD(Nursing nursing) {
	...
	public LANDLORD(Obstetric obstetric) {
	...
	public LANDLORD(OfficeEquipmentStore officeEquipmentStore) {
	...
	public LANDLORD(Oncologic oncologic) {
	...
	public LANDLORD(Optician optician) {
	...
	public LANDLORD(Optometric optometric) {
	...
	public LANDLORD(Organization organization) {
		organizationList = new ArrayList<Organization>();
	...
	public LANDLORD(Otolaryngologic otolaryngologic) {
	...
	public LANDLORD(OutletStore outletStore) {
	...
	public LANDLORD(Patient patient) {
	...
	public LANDLORD(PawnShop pawnShop) {
	...
	public LANDLORD(Pediatric pediatric) {
	...
	public LANDLORD(PerformingGroup performingGroup) {
	...
	public LANDLORD(PetStore petStore) {
	...
	public LANDLORD(Pharmacy pharmacy) {
	...
	public LANDLORD(Physician physician) {
	...
	public LANDLORD(Physiotherapy physiotherapy) {
	...
	public LANDLORD(PlasticSurgery plasticSurgery) {
	...
	public LANDLORD(Plumber plumber) {
	...
	public LANDLORD(Podiatric podiatric) {
	...
	public LANDLORD(PoliceStation policeStation) {
	...
	public LANDLORD(PostOffice postOffice) {
	...
	public LANDLORD(Preschool preschool) {
	...
	public LANDLORD(PrimaryCare primaryCare) {
	...
	public LANDLORD(ProfessionalService professionalService) {
	...
	public LANDLORD(Project project) {
	...
	public LANDLORD(Psychiatric psychiatric) {
	...
	public LANDLORD(PublicHealth publicHealth) {
	...
	public LANDLORD(PublicSwimmingPool publicSwimmingPool) {
	...
	public LANDLORD(RadioStation radioStation) {
	...
	public LANDLORD(RealEstateAgent realEstateAgent) {
	...
	public LANDLORD(RecyclingCenter recyclingCenter) {
	...
	public LANDLORD(ResearchProject researchProject) {
	...
	public LANDLORD(Restaurant restaurant) {
	...
	public LANDLORD(RoofingContractor roofingContractor) {
	...
	public LANDLORD(SelfStorage selfStorage) {
	...
	public LANDLORD(ShoeStore shoeStore) {
	...
	public LANDLORD(ShoppingCenter shoppingCenter) {
	...
	public LANDLORD(SkiResort skiResort) {
	...
	public LANDLORD(SportingGoodsStore sportingGoodsStore) {
	...
	public LANDLORD(SportsActivityLocation sportsActivityLocation) {
	...
	public LANDLORD(SportsClub sportsClub) {
	...
	public LANDLORD(SportsOrganization sportsOrganization) {
	...
	public LANDLORD(SportsTeam sportsTeam) {
	...
	public LANDLORD(StadiumOrArena stadiumOrArena) {
	...
	public LANDLORD(TattooParlor tattooParlor) {
	...
	public LANDLORD(TelevisionStation televisionStation) {
	...
	public LANDLORD(TennisComplex tennisComplex) {
	...
	public LANDLORD(TheaterGroup theaterGroup) {
	...
	public LANDLORD(TireShop tireShop) {
	...
	public LANDLORD(TouristInformationCenter touristInformationCenter) {
	...
	public LANDLORD(ToyStore toyStore) {
	...
	public LANDLORD(TravelAgency travelAgency) {
	...
	public LANDLORD(VeterinaryCare veterinaryCare) {
	...
	public LANDLORD(WholesaleStore wholesaleStore) {
	...
	public LANDLORD(WorkersUnion workersUnion) {
	...
	public void copy(Container.Landlord org) {
