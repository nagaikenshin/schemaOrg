...
public class TEXT_DIGITAL_DOCUMENT implements Clazz.TextDigitalDocument {
	...
	public TEXT_DIGITAL_DOCUMENT() {
	}

	public TEXT_DIGITAL_DOCUMENT(Long seq) {
		setSeq(seq);
	}

	public TEXT_DIGITAL_DOCUMENT(String string) {
	...
	public TEXT_DIGITAL_DOCUMENT(About about) {
		setAbout(about);
	}
	...
	public TEXT_DIGITAL_DOCUMENT(AccessMode accessMode) {
	...
	public TEXT_DIGITAL_DOCUMENT(AccessModeSufficient accessModeSufficient) {
	...
	public TEXT_DIGITAL_DOCUMENT(AccessibilityAPI accessibilityAPI) {
	...
	public TEXT_DIGITAL_DOCUMENT(AccessibilityControl accessibilityControl) {
	...
	public TEXT_DIGITAL_DOCUMENT(AccessibilityFeature accessibilityFeature) {
	...
	public TEXT_DIGITAL_DOCUMENT(AccessibilityHazard accessibilityHazard) {
	...
	public TEXT_DIGITAL_DOCUMENT(AccessibilitySummary accessibilitySummary) {
	...
	public TEXT_DIGITAL_DOCUMENT(AccountablePerson accountablePerson) {
	...
	public TEXT_DIGITAL_DOCUMENT(AdditionalType additionalType) {
	...
	public TEXT_DIGITAL_DOCUMENT(AggregateRating aggregateRating) {
	...
	public TEXT_DIGITAL_DOCUMENT(AlternateName alternateName) {
	...
	public TEXT_DIGITAL_DOCUMENT(AlternativeHeadline alternativeHeadline) {
	...
	public TEXT_DIGITAL_DOCUMENT(AssociatedMedia associatedMedia) {
	...
	public TEXT_DIGITAL_DOCUMENT(Audience audience) {
	...
	public TEXT_DIGITAL_DOCUMENT(Audio audio) {
		setAudio(audio);
	}
	...
	public TEXT_DIGITAL_DOCUMENT(Author author) {
		setAuthor(author);
	}
	...
	public TEXT_DIGITAL_DOCUMENT(Award award) {
		setAward(award);
	}
	...
	public TEXT_DIGITAL_DOCUMENT(Character character) {
	...
	public TEXT_DIGITAL_DOCUMENT(Citation citation) {
	...
	public TEXT_DIGITAL_DOCUMENT(Comment comment) {
		setComment(comment);
	}
	...
	public TEXT_DIGITAL_DOCUMENT(CommentCount commentCount) {
	...
	public TEXT_DIGITAL_DOCUMENT(ContentLocation contentLocation) {
	...
	public TEXT_DIGITAL_DOCUMENT(ContentRating contentRating) {
	...
	public TEXT_DIGITAL_DOCUMENT(ContentReferenceTime contentReferenceTime) {
	...
	public TEXT_DIGITAL_DOCUMENT(Contributor contributor) {
	...
	public TEXT_DIGITAL_DOCUMENT(CopyrightHolder copyrightHolder) {
	...
	public TEXT_DIGITAL_DOCUMENT(CopyrightYear copyrightYear) {
	...
	public TEXT_DIGITAL_DOCUMENT(Correction correction) {
	...
	public TEXT_DIGITAL_DOCUMENT(Creator creator) {
		setCreator(creator);
	}
	...
	public TEXT_DIGITAL_DOCUMENT(DateCreated dateCreated) {
	...
	public TEXT_DIGITAL_DOCUMENT(DateModified dateModified) {
	...
	public TEXT_DIGITAL_DOCUMENT(DatePublished datePublished) {
	...
	public TEXT_DIGITAL_DOCUMENT(Description description) {
	...
	public TEXT_DIGITAL_DOCUMENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public TEXT_DIGITAL_DOCUMENT(DiscussionUrl discussionUrl) {
	...
	public TEXT_DIGITAL_DOCUMENT(Editor editor) {
		setEditor(editor);
	}
	...
	public TEXT_DIGITAL_DOCUMENT(EducationalAlignment educationalAlignment) {
	...
	public TEXT_DIGITAL_DOCUMENT(EducationalUse educationalUse) {
	...
	public TEXT_DIGITAL_DOCUMENT(Encoding encoding) {
	...
	public TEXT_DIGITAL_DOCUMENT(EncodingFormat encodingFormat) {
	...
	public TEXT_DIGITAL_DOCUMENT(ExampleOfWork exampleOfWork) {
	...
	public TEXT_DIGITAL_DOCUMENT(Expires expires) {
		setExpires(expires);
	}
	...
	public TEXT_DIGITAL_DOCUMENT(Funder funder) {
		setFunder(funder);
	}
	...
	public TEXT_DIGITAL_DOCUMENT(Genre genre) {
		setGenre(genre);
	}
	...
	public TEXT_DIGITAL_DOCUMENT(HasDigitalDocumentPermission hasDigitalDocumentPermission) {
	...
	public TEXT_DIGITAL_DOCUMENT(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public TEXT_DIGITAL_DOCUMENT(Headline headline) {
	...
	public TEXT_DIGITAL_DOCUMENT(Identifier identifier) {
	...
	public TEXT_DIGITAL_DOCUMENT(Image image) {
		setImage(image);
	}
	...
	public TEXT_DIGITAL_DOCUMENT(InLanguage inLanguage) {
	...
	public TEXT_DIGITAL_DOCUMENT(InteractionStatistic interactionStatistic) {
	...
	public TEXT_DIGITAL_DOCUMENT(InteractivityType interactivityType) {
	...
	public TEXT_DIGITAL_DOCUMENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public TEXT_DIGITAL_DOCUMENT(IsBasedOn isBasedOn) {
	...
	public TEXT_DIGITAL_DOCUMENT(IsFamilyFriendly isFamilyFriendly) {
	...
	public TEXT_DIGITAL_DOCUMENT(IsPartOf isPartOf) {
	...
	public TEXT_DIGITAL_DOCUMENT(Keywords keywords) {
	...
	public TEXT_DIGITAL_DOCUMENT(LearningResourceType learningResourceType) {
	...
	public TEXT_DIGITAL_DOCUMENT(License license) {
		setLicense(license);
	}
	...
	public TEXT_DIGITAL_DOCUMENT(LocationCreated locationCreated) {
	...
	public TEXT_DIGITAL_DOCUMENT(MainEntity mainEntity) {
	...
	public TEXT_DIGITAL_DOCUMENT(MainEntityOfPage mainEntityOfPage) {
	...
	public TEXT_DIGITAL_DOCUMENT(Material material) {
	...
	public TEXT_DIGITAL_DOCUMENT(MaterialExtent materialExtent) {
	...
	public TEXT_DIGITAL_DOCUMENT(Mentions mentions) {
	...
	public TEXT_DIGITAL_DOCUMENT(Name name) {
		setName(name);
	}
	...
	public TEXT_DIGITAL_DOCUMENT(NameFuzzy nameFuzzy) {
	...
	public TEXT_DIGITAL_DOCUMENT(NameRuby nameRuby) {
	...
	public TEXT_DIGITAL_DOCUMENT(Offers offers) {
		setOffers(offers);
	}
	...
	public TEXT_DIGITAL_DOCUMENT(Position position) {
	...
	public TEXT_DIGITAL_DOCUMENT(PotentialAction potentialAction) {
	...
	public TEXT_DIGITAL_DOCUMENT(Producer producer) {
	...
	public TEXT_DIGITAL_DOCUMENT(Provider provider) {
	...
	public TEXT_DIGITAL_DOCUMENT(Publication publication) {
	...
	public TEXT_DIGITAL_DOCUMENT(Publisher publisher) {
	...
	public TEXT_DIGITAL_DOCUMENT(PublisherImprint publisherImprint) {
	...
	public TEXT_DIGITAL_DOCUMENT(PublishingPrinciples publishingPrinciples) {
	...
	public TEXT_DIGITAL_DOCUMENT(RecordedAt recordedAt) {
	...
	public TEXT_DIGITAL_DOCUMENT(ReleasedEvent releasedEvent) {
	...
	public TEXT_DIGITAL_DOCUMENT(Review review) {
		setReview(review);
	}
	...
	public TEXT_DIGITAL_DOCUMENT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TEXT_DIGITAL_DOCUMENT(SchemaVersion schemaVersion) {
	...
	public TEXT_DIGITAL_DOCUMENT(SdDatePublished sdDatePublished) {
	...
	public TEXT_DIGITAL_DOCUMENT(SdLicense sdLicense) {
	...
	public TEXT_DIGITAL_DOCUMENT(SdPublisher sdPublisher) {
	...
	public TEXT_DIGITAL_DOCUMENT(SourceOrganization sourceOrganization) {
	...
	public TEXT_DIGITAL_DOCUMENT(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public TEXT_DIGITAL_DOCUMENT(SpatialCoverage spatialCoverage) {
	...
	public TEXT_DIGITAL_DOCUMENT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public TEXT_DIGITAL_DOCUMENT(SubjectOf subjectOf) {
	...
	public TEXT_DIGITAL_DOCUMENT(Temporal temporal) {
	...
	public TEXT_DIGITAL_DOCUMENT(TemporalCoverage temporalCoverage) {
	...
	public TEXT_DIGITAL_DOCUMENT(Text text) {
		setText(text);
	}
	...
	public TEXT_DIGITAL_DOCUMENT(ThumbnailUrl thumbnailUrl) {
	...
	public TEXT_DIGITAL_DOCUMENT(TimeRequired timeRequired) {
	...
	public TEXT_DIGITAL_DOCUMENT(TranslationOfWork translationOfWork) {
	...
	public TEXT_DIGITAL_DOCUMENT(Translator translator) {
	...
	public TEXT_DIGITAL_DOCUMENT(TypicalAgeRange typicalAgeRange) {
	...
	public TEXT_DIGITAL_DOCUMENT(Url url) {
		setUrl(url);
	}
	...
	public TEXT_DIGITAL_DOCUMENT(Version version) {
		setVersion(version);
	}
	...
	public TEXT_DIGITAL_DOCUMENT(Video video) {
		setVideo(video);
	}
	...
	public TEXT_DIGITAL_DOCUMENT(WorkExample workExample) {
	...
	public TEXT_DIGITAL_DOCUMENT(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.TextDigitalDocument org) {
		setSeq(org.getSeq());
