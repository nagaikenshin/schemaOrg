...
public class MOVING_COMPANY implements Clazz.MovingCompany {
	...
	public MOVING_COMPANY(GeoContains geoContains) {
	...
	public MOVING_COMPANY(GeoCoveredBy geoCoveredBy) {
	...
	public MOVING_COMPANY(GeoCovers geoCovers) {
	...
	public MOVING_COMPANY(GeoCrosses geoCrosses) {
	...
	public MOVING_COMPANY(GeoDisjoint geoDisjoint) {
	...
	public MOVING_COMPANY(GeoEquals geoEquals) {
	...
	public MOVING_COMPANY(GeoIntersects geoIntersects) {
	...
	public MOVING_COMPANY(GeoOverlaps geoOverlaps) {
	...
	public MOVING_COMPANY(GeoTouches geoTouches) {
	...
	public MOVING_COMPANY(GeoWithin geoWithin) {
	...
	public MOVING_COMPANY(Slogan slogan) {
		setSlogan(slogan);
	}
