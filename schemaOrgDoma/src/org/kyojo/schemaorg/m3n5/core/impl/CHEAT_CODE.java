...
public class CHEAT_CODE implements Container.CheatCode {
	...
	public CHEAT_CODE(String string) {
	...
	public CHEAT_CODE(APIReference apiReference) {
	...
	public CHEAT_CODE(AboutPage aboutPage) {
	...
	public CHEAT_CODE(AdvertiserContentArticle advertiserContentArticle) {
	...
	public CHEAT_CODE(AnalysisNewsArticle analysisNewsArticle) {
	...
	public CHEAT_CODE(Answer answer) {
	...
	public CHEAT_CODE(ArchiveComponent archiveComponent) {
	...
	public CHEAT_CODE(Article article) {
	...
	public CHEAT_CODE(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public CHEAT_CODE(AudioObject audioObject) {
	...
	public CHEAT_CODE(Audiobook audiobook) {
	...
	public CHEAT_CODE(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public CHEAT_CODE(Barcode barcode) {
	...
	public CHEAT_CODE(BlogPosting blogPosting) {
	...
	public CHEAT_CODE(BookSeries bookSeries) {
	...
	public CHEAT_CODE(CategoryCodeSet categoryCodeSet) {
	...
	public CHEAT_CODE(Chapter chapter) {
	...
	public CHEAT_CODE(CheckoutPage checkoutPage) {
	...
	public CHEAT_CODE(ClaimReview claimReview) {
	...
	public CHEAT_CODE(Collection collection) {
	...
	public CHEAT_CODE(CollectionPage collectionPage) {
	...
	public CHEAT_CODE(ComicCoverArt comicCoverArt) {
	...
	public CHEAT_CODE(ComicIssue comicIssue) {
	...
	public CHEAT_CODE(ComicSeries comicSeries) {
	...
	public CHEAT_CODE(ComicStory comicStory) {
	...
	public CHEAT_CODE(Comment comment) {
	...
	public CHEAT_CODE(CompleteDataFeed completeDataFeed) {
	...
	public CHEAT_CODE(ContactPage contactPage) {
	...
	public CHEAT_CODE(Conversation conversation) {
	...
	public CHEAT_CODE(CorrectionComment correctionComment) {
	...
	public CHEAT_CODE(Course course) {
	...
	public CHEAT_CODE(CoverArt coverArt) {
	...
	public CHEAT_CODE(CreativeWork creativeWork) {
		creativeWorkList = new ArrayList<CreativeWork>();
	...
	public CHEAT_CODE(CreativeWorkSeason creativeWorkSeason) {
	...
	public CHEAT_CODE(CreativeWorkSeries creativeWorkSeries) {
	...
	public CHEAT_CODE(CriticReview criticReview) {
	...
	public CHEAT_CODE(DataCatalog dataCatalog) {
	...
	public CHEAT_CODE(DataDownload dataDownload) {
	...
	public CHEAT_CODE(DataFeed dataFeed) {
	...
	public CHEAT_CODE(Dataset dataset) {
	...
	public CHEAT_CODE(DefinedTermSet definedTermSet) {
	...
	public CHEAT_CODE(DigitalDocument digitalDocument) {
	...
	public CHEAT_CODE(DiscussionForumPosting discussionForumPosting) {
	...
	public CHEAT_CODE(Drawing drawing) {
	...
	public CHEAT_CODE(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public CHEAT_CODE(EmailMessage emailMessage) {
	...
	public CHEAT_CODE(EmployerReview employerReview) {
	...
	public CHEAT_CODE(Episode episode) {
	...
	public CHEAT_CODE(ExercisePlan exercisePlan) {
	...
	public CHEAT_CODE(FAQPage faqPage) {
	...
	public CHEAT_CODE(HowToDirection howToDirection) {
	...
	public CHEAT_CODE(HowToSection howToSection) {
	...
	public CHEAT_CODE(HowToStep howToStep) {
	...
	public CHEAT_CODE(HowToTip howToTip) {
	...
	public CHEAT_CODE(ImageGallery imageGallery) {
	...
	public CHEAT_CODE(ImageObject imageObject) {
	...
	public CHEAT_CODE(ItemPage itemPage) {
	...
	public CHEAT_CODE(Legislation legislation) {
	...
	public CHEAT_CODE(LegislationObject legislationObject) {
	...
	public CHEAT_CODE(LiveBlogPosting liveBlogPosting) {
	...
	public CHEAT_CODE(Manuscript manuscript) {
	...
	public CHEAT_CODE(MediaObject mediaObject) {
	...
	public CHEAT_CODE(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public CHEAT_CODE(MedicalWebPage medicalWebPage) {
	...
	public CHEAT_CODE(MenuSection menuSection) {
	...
	public CHEAT_CODE(Message message) {
	...
	public CHEAT_CODE(MobileApplication mobileApplication) {
	...
	public CHEAT_CODE(MovieClip movieClip) {
	...
	public CHEAT_CODE(MovieSeries movieSeries) {
	...
	public CHEAT_CODE(MusicAlbum musicAlbum) {
	...
	public CHEAT_CODE(MusicComposition musicComposition) {
	...
	public CHEAT_CODE(MusicPlaylist musicPlaylist) {
	...
	public CHEAT_CODE(MusicRecording musicRecording) {
	...
	public CHEAT_CODE(MusicRelease musicRelease) {
	...
	public CHEAT_CODE(MusicVideoObject musicVideoObject) {
	...
	public CHEAT_CODE(NewsArticle newsArticle) {
	...
	public CHEAT_CODE(Newspaper newspaper) {
	...
	public CHEAT_CODE(NoteDigitalDocument noteDigitalDocument) {
	...
	public CHEAT_CODE(OpinionNewsArticle opinionNewsArticle) {
	...
	public CHEAT_CODE(Painting painting) {
	...
	public CHEAT_CODE(Periodical periodical) {
	...
	public CHEAT_CODE(Photograph photograph) {
	...
	public CHEAT_CODE(Poster poster) {
	...
	public CHEAT_CODE(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public CHEAT_CODE(ProfilePage profilePage) {
	...
	public CHEAT_CODE(PublicationIssue publicationIssue) {
	...
	public CHEAT_CODE(PublicationVolume publicationVolume) {
	...
	public CHEAT_CODE(QAPage qaPage) {
	...
	public CHEAT_CODE(Question question) {
	...
	public CHEAT_CODE(Quotation quotation) {
	...
	public CHEAT_CODE(RadioClip radioClip) {
	...
	public CHEAT_CODE(RadioEpisode radioEpisode) {
	...
	public CHEAT_CODE(RadioSeason radioSeason) {
	...
	public CHEAT_CODE(RadioSeries radioSeries) {
	...
	public CHEAT_CODE(Recipe recipe) {
	...
	public CHEAT_CODE(Report report) {
	...
	public CHEAT_CODE(ReportageNewsArticle reportageNewsArticle) {
	...
	public CHEAT_CODE(Review review) {
	...
	public CHEAT_CODE(ReviewNewsArticle reviewNewsArticle) {
	...
	public CHEAT_CODE(SatiricalArticle satiricalArticle) {
	...
	public CHEAT_CODE(ScholarlyArticle scholarlyArticle) {
	...
	public CHEAT_CODE(Sculpture sculpture) {
	...
	public CHEAT_CODE(SearchResultsPage searchResultsPage) {
	...
	public CHEAT_CODE(SheetMusic sheetMusic) {
	...
	public CHEAT_CODE(ShortStory shortStory) {
	...
	public CHEAT_CODE(SiteNavigationElement siteNavigationElement) {
	...
	public CHEAT_CODE(SocialMediaPosting socialMediaPosting) {
	...
	public CHEAT_CODE(SoftwareApplication softwareApplication) {
	...
	public CHEAT_CODE(SoftwareSourceCode softwareSourceCode) {
	...
	public CHEAT_CODE(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public CHEAT_CODE(TVClip tvClip) {
	...
	public CHEAT_CODE(TVEpisode tvEpisode) {
	...
	public CHEAT_CODE(TVSeason tvSeason) {
	...
	public CHEAT_CODE(TVSeries tvSeries) {
	...
	public CHEAT_CODE(TechArticle techArticle) {
	...
	public CHEAT_CODE(TextDigitalDocument textDigitalDocument) {
	...
	public CHEAT_CODE(Thesis thesis) {
	...
	public CHEAT_CODE(ThreeDimensionalModel threeDimensionalModel) {
	...
	public CHEAT_CODE(UserReview userReview) {
	...
	public CHEAT_CODE(VideoGallery videoGallery) {
	...
	public CHEAT_CODE(VideoGame videoGame) {
	...
	public CHEAT_CODE(VideoGameClip videoGameClip) {
	...
	public CHEAT_CODE(VideoGameSeries videoGameSeries) {
	...
	public CHEAT_CODE(VideoObject videoObject) {
	...
	public CHEAT_CODE(VisualArtwork visualArtwork) {
	...
	public CHEAT_CODE(WPAdBlock wpAdBlock) {
	...
	public CHEAT_CODE(WPFooter wpFooter) {
	...
	public CHEAT_CODE(WPHeader wpHeader) {
	...
	public CHEAT_CODE(WPSideBar wpSideBar) {
	...
	public CHEAT_CODE(WebApplication webApplication) {
	...
	public CHEAT_CODE(WebPage webPage) {
	...
	public CHEAT_CODE(WebPageElement webPageElement) {
	...
	public CHEAT_CODE(WebSite webSite) {
	...
	public void copy(Container.CheatCode org) {
