...
public class WORK_EXAMPLE implements Container.WorkExample {
	...
	public WORK_EXAMPLE(String string) {
	...
	public WORK_EXAMPLE(APIReference apiReference) {
	...
	public WORK_EXAMPLE(AboutPage aboutPage) {
	...
	public WORK_EXAMPLE(AdvertiserContentArticle advertiserContentArticle) {
	...
	public WORK_EXAMPLE(AnalysisNewsArticle analysisNewsArticle) {
	...
	public WORK_EXAMPLE(Answer answer) {
	...
	public WORK_EXAMPLE(ArchiveComponent archiveComponent) {
	...
	public WORK_EXAMPLE(Article article) {
	...
	public WORK_EXAMPLE(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public WORK_EXAMPLE(Atlas atlas) {
	...
	public WORK_EXAMPLE(AudioObject audioObject) {
	...
	public WORK_EXAMPLE(Audiobook audiobook) {
	...
	public WORK_EXAMPLE(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public WORK_EXAMPLE(Barcode barcode) {
	...
	public WORK_EXAMPLE(BlogPosting blogPosting) {
	...
	public WORK_EXAMPLE(BookSeries bookSeries) {
	...
	public WORK_EXAMPLE(CategoryCodeSet categoryCodeSet) {
	...
	public WORK_EXAMPLE(Chapter chapter) {
	...
	public WORK_EXAMPLE(CheckoutPage checkoutPage) {
	...
	public WORK_EXAMPLE(Claim claim) {
	...
	public WORK_EXAMPLE(ClaimReview claimReview) {
	...
	public WORK_EXAMPLE(Collection collection) {
	...
	public WORK_EXAMPLE(CollectionPage collectionPage) {
	...
	public WORK_EXAMPLE(ComicCoverArt comicCoverArt) {
	...
	public WORK_EXAMPLE(ComicIssue comicIssue) {
	...
	public WORK_EXAMPLE(ComicSeries comicSeries) {
	...
	public WORK_EXAMPLE(ComicStory comicStory) {
	...
	public WORK_EXAMPLE(Comment comment) {
	...
	public WORK_EXAMPLE(CompleteDataFeed completeDataFeed) {
	...
	public WORK_EXAMPLE(ContactPage contactPage) {
	...
	public WORK_EXAMPLE(Conversation conversation) {
	...
	public WORK_EXAMPLE(CorrectionComment correctionComment) {
	...
	public WORK_EXAMPLE(Course course) {
	...
	public WORK_EXAMPLE(CoverArt coverArt) {
	...
	public WORK_EXAMPLE(CreativeWork creativeWork) {
		creativeWorkList = new ArrayList<CreativeWork>();
	...
	public WORK_EXAMPLE(CreativeWorkSeason creativeWorkSeason) {
	...
	public WORK_EXAMPLE(CreativeWorkSeries creativeWorkSeries) {
	...
	public WORK_EXAMPLE(CriticReview criticReview) {
	...
	public WORK_EXAMPLE(DataCatalog dataCatalog) {
	...
	public WORK_EXAMPLE(DataDownload dataDownload) {
	...
	public WORK_EXAMPLE(DataFeed dataFeed) {
	...
	public WORK_EXAMPLE(Dataset dataset) {
	...
	public WORK_EXAMPLE(DefinedTermSet definedTermSet) {
	...
	public WORK_EXAMPLE(DigitalDocument digitalDocument) {
	...
	public WORK_EXAMPLE(DiscussionForumPosting discussionForumPosting) {
	...
	public WORK_EXAMPLE(Drawing drawing) {
	...
	public WORK_EXAMPLE(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public WORK_EXAMPLE(EmailMessage emailMessage) {
	...
	public WORK_EXAMPLE(EmployerReview employerReview) {
	...
	public WORK_EXAMPLE(Episode episode) {
	...
	public WORK_EXAMPLE(ExercisePlan exercisePlan) {
	...
	public WORK_EXAMPLE(FAQPage faqPage) {
	...
	public WORK_EXAMPLE(HowTo howTo) {
	...
	public WORK_EXAMPLE(HowToDirection howToDirection) {
	...
	public WORK_EXAMPLE(HowToSection howToSection) {
	...
	public WORK_EXAMPLE(HowToStep howToStep) {
	...
	public WORK_EXAMPLE(HowToTip howToTip) {
	...
	public WORK_EXAMPLE(ImageGallery imageGallery) {
	...
	public WORK_EXAMPLE(ImageObject imageObject) {
	...
	public WORK_EXAMPLE(ItemPage itemPage) {
	...
	public WORK_EXAMPLE(Legislation legislation) {
	...
	public WORK_EXAMPLE(LegislationObject legislationObject) {
	...
	public WORK_EXAMPLE(LiveBlogPosting liveBlogPosting) {
	...
	public WORK_EXAMPLE(Manuscript manuscript) {
	...
	public WORK_EXAMPLE(MediaObject mediaObject) {
	...
	public WORK_EXAMPLE(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public WORK_EXAMPLE(MedicalWebPage medicalWebPage) {
	...
	public WORK_EXAMPLE(MenuSection menuSection) {
	...
	public WORK_EXAMPLE(Message message) {
	...
	public WORK_EXAMPLE(MobileApplication mobileApplication) {
	...
	public WORK_EXAMPLE(Movie movie) {
	...
	public WORK_EXAMPLE(MovieClip movieClip) {
	...
	public WORK_EXAMPLE(MovieSeries movieSeries) {
	...
	public WORK_EXAMPLE(MusicAlbum musicAlbum) {
	...
	public WORK_EXAMPLE(MusicComposition musicComposition) {
	...
	public WORK_EXAMPLE(MusicPlaylist musicPlaylist) {
	...
	public WORK_EXAMPLE(MusicRecording musicRecording) {
	...
	public WORK_EXAMPLE(MusicRelease musicRelease) {
	...
	public WORK_EXAMPLE(MusicVideoObject musicVideoObject) {
	...
	public WORK_EXAMPLE(NewsArticle newsArticle) {
	...
	public WORK_EXAMPLE(Newspaper newspaper) {
	...
	public WORK_EXAMPLE(NoteDigitalDocument noteDigitalDocument) {
	...
	public WORK_EXAMPLE(OpinionNewsArticle opinionNewsArticle) {
	...
	public WORK_EXAMPLE(Painting painting) {
	...
	public WORK_EXAMPLE(Periodical periodical) {
	...
	public WORK_EXAMPLE(Photograph photograph) {
	...
	public WORK_EXAMPLE(Poster poster) {
	...
	public WORK_EXAMPLE(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public WORK_EXAMPLE(ProfilePage profilePage) {
	...
	public WORK_EXAMPLE(PublicationIssue publicationIssue) {
	...
	public WORK_EXAMPLE(PublicationVolume publicationVolume) {
	...
	public WORK_EXAMPLE(QAPage qaPage) {
	...
	public WORK_EXAMPLE(Question question) {
	...
	public WORK_EXAMPLE(Quotation quotation) {
	...
	public WORK_EXAMPLE(RadioClip radioClip) {
	...
	public WORK_EXAMPLE(RadioEpisode radioEpisode) {
	...
	public WORK_EXAMPLE(RadioSeason radioSeason) {
	...
	public WORK_EXAMPLE(RadioSeries radioSeries) {
	...
	public WORK_EXAMPLE(Recipe recipe) {
	...
	public WORK_EXAMPLE(Report report) {
	...
	public WORK_EXAMPLE(ReportageNewsArticle reportageNewsArticle) {
	...
	public WORK_EXAMPLE(Review review) {
	...
	public WORK_EXAMPLE(ReviewNewsArticle reviewNewsArticle) {
	...
	public WORK_EXAMPLE(SatiricalArticle satiricalArticle) {
	...
	public WORK_EXAMPLE(ScholarlyArticle scholarlyArticle) {
	...
	public WORK_EXAMPLE(Sculpture sculpture) {
	...
	public WORK_EXAMPLE(SearchResultsPage searchResultsPage) {
	...
	public WORK_EXAMPLE(SheetMusic sheetMusic) {
	...
	public WORK_EXAMPLE(ShortStory shortStory) {
	...
	public WORK_EXAMPLE(SiteNavigationElement siteNavigationElement) {
	...
	public WORK_EXAMPLE(SocialMediaPosting socialMediaPosting) {
	...
	public WORK_EXAMPLE(SoftwareApplication softwareApplication) {
	...
	public WORK_EXAMPLE(SoftwareSourceCode softwareSourceCode) {
	...
	public WORK_EXAMPLE(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public WORK_EXAMPLE(TVClip tvClip) {
	...
	public WORK_EXAMPLE(TVEpisode tvEpisode) {
	...
	public WORK_EXAMPLE(TVSeason tvSeason) {
	...
	public WORK_EXAMPLE(TVSeries tvSeries) {
	...
	public WORK_EXAMPLE(Table table) {
	...
	public WORK_EXAMPLE(TechArticle techArticle) {
	...
	public WORK_EXAMPLE(TextDigitalDocument textDigitalDocument) {
	...
	public WORK_EXAMPLE(Thesis thesis) {
	...
	public WORK_EXAMPLE(ThreeDimensionalModel threeDimensionalModel) {
	...
	public WORK_EXAMPLE(UserReview userReview) {
	...
	public WORK_EXAMPLE(VideoGallery videoGallery) {
	...
	public WORK_EXAMPLE(VideoGame videoGame) {
	...
	public WORK_EXAMPLE(VideoGameClip videoGameClip) {
	...
	public WORK_EXAMPLE(VideoGameSeries videoGameSeries) {
	...
	public WORK_EXAMPLE(VideoObject videoObject) {
	...
	public WORK_EXAMPLE(VisualArtwork visualArtwork) {
	...
	public WORK_EXAMPLE(WPAdBlock wpAdBlock) {
	...
	public WORK_EXAMPLE(WPFooter wpFooter) {
	...
	public WORK_EXAMPLE(WPHeader wpHeader) {
	...
	public WORK_EXAMPLE(WPSideBar wpSideBar) {
	...
	public WORK_EXAMPLE(WebApplication webApplication) {
	...
	public WORK_EXAMPLE(WebPage webPage) {
	...
	public WORK_EXAMPLE(WebPageElement webPageElement) {
	...
	public WORK_EXAMPLE(WebSite webSite) {
	...
	public void copy(Container.WorkExample org) {
