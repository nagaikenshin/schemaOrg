...
public class BUSINESS_ENTITY_TYPE implements Clazz.BusinessEntityType {
	...
	public BUSINESS_ENTITY_TYPE() {
	}

	public BUSINESS_ENTITY_TYPE(Long seq) {
		setSeq(seq);
	}

	public BUSINESS_ENTITY_TYPE(String string) {
	...
	public BUSINESS_ENTITY_TYPE(AdditionalType additionalType) {
	...
	public BUSINESS_ENTITY_TYPE(AlternateName alternateName) {
	...
	public BUSINESS_ENTITY_TYPE(Description description) {
	...
	public BUSINESS_ENTITY_TYPE(DisambiguatingDescription disambiguatingDescription) {
	...
	public BUSINESS_ENTITY_TYPE(Identifier identifier) {
	...
	public BUSINESS_ENTITY_TYPE(Image image) {
		setImage(image);
	}
	...
	public BUSINESS_ENTITY_TYPE(MainEntityOfPage mainEntityOfPage) {
	...
	public BUSINESS_ENTITY_TYPE(Name name) {
		setName(name);
	}
	...
	public BUSINESS_ENTITY_TYPE(NameFuzzy nameFuzzy) {
	...
	public BUSINESS_ENTITY_TYPE(NameRuby nameRuby) {
	...
	public BUSINESS_ENTITY_TYPE(PotentialAction potentialAction) {
	...
	public BUSINESS_ENTITY_TYPE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public BUSINESS_ENTITY_TYPE(SubjectOf subjectOf) {
	...
	public BUSINESS_ENTITY_TYPE(SupersededBy supersededBy) {
	...
	public BUSINESS_ENTITY_TYPE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.BusinessEntityType org) {
		setSeq(org.getSeq());
