...
public class PLUMBER implements Clazz.Plumber {
	...
	public PLUMBER(GeoContains geoContains) {
	...
	public PLUMBER(GeoCoveredBy geoCoveredBy) {
	...
	public PLUMBER(GeoCovers geoCovers) {
	...
	public PLUMBER(GeoCrosses geoCrosses) {
	...
	public PLUMBER(GeoDisjoint geoDisjoint) {
	...
	public PLUMBER(GeoEquals geoEquals) {
	...
	public PLUMBER(GeoIntersects geoIntersects) {
	...
	public PLUMBER(GeoOverlaps geoOverlaps) {
	...
	public PLUMBER(GeoTouches geoTouches) {
	...
	public PLUMBER(GeoWithin geoWithin) {
