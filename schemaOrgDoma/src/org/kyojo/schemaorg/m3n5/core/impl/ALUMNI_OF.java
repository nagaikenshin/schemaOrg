...
public class ALUMNI_OF implements Container.AlumniOf {
	...
	public ALUMNI_OF(String string) {
		this(new EDUCATIONAL_ORGANIZATION(string));
	}

	public String getString() {
		if(educationalOrganizationList == null || educationalOrganizationList.size() == 0 || educationalOrganizationList.get(0) == null) {
			return null;
		} else {
			Name name = educationalOrganizationList.get(0).getName();
	...
	public void setString(String string) {
		...
		if(educationalOrganizationList.size() == 0) {
			educationalOrganizationList.add(new EDUCATIONAL_ORGANIZATION(string));
		} else {
			educationalOrganizationList.set(0, new EDUCATIONAL_ORGANIZATION(string));
		}
	}

	public ALUMNI_OF(AccountingService accountingService) {
	...
	public ALUMNI_OF(AdultEntertainment adultEntertainment) {
	...
	public ALUMNI_OF(Airline airline) {
	...
	public ALUMNI_OF(AmusementPark amusementPark) {
	...
	public ALUMNI_OF(AnimalShelter animalShelter) {
	...
	public ALUMNI_OF(ArchiveOrganization archiveOrganization) {
	...
	public ALUMNI_OF(ArtGallery artGallery) {
	...
	public ALUMNI_OF(Attorney attorney) {
	...
	public ALUMNI_OF(AutoBodyShop autoBodyShop) {
	...
	public ALUMNI_OF(AutoDealer autoDealer) {
	...
	public ALUMNI_OF(AutoPartsStore autoPartsStore) {
	...
	public ALUMNI_OF(AutoRental autoRental) {
	...
	public ALUMNI_OF(AutoRepair autoRepair) {
	...
	public ALUMNI_OF(AutoWash autoWash) {
	...
	public ALUMNI_OF(AutomatedTeller automatedTeller) {
	...
	public ALUMNI_OF(AutomotiveBusiness automotiveBusiness) {
	...
	public ALUMNI_OF(Bakery bakery) {
	...
	public ALUMNI_OF(BankOrCreditUnion bankOrCreditUnion) {
	...
	public ALUMNI_OF(BarOrPub barOrPub) {
	...
	public ALUMNI_OF(BeautySalon beautySalon) {
	...
	public ALUMNI_OF(BedAndBreakfast bedAndBreakfast) {
	...
	public ALUMNI_OF(BikeStore bikeStore) {
	...
	public ALUMNI_OF(BookStore bookStore) {
	...
	public ALUMNI_OF(BowlingAlley bowlingAlley) {
	...
	public ALUMNI_OF(Brewery brewery) {
	...
	public ALUMNI_OF(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public ALUMNI_OF(Campground campground) {
	...
	public ALUMNI_OF(Casino casino) {
	...
	public ALUMNI_OF(ChildCare childCare) {
	...
	public ALUMNI_OF(ClothingStore clothingStore) {
	...
	public ALUMNI_OF(CollegeOrUniversity collegeOrUniversity) {
	...
	public ALUMNI_OF(ComedyClub comedyClub) {
	...
	public ALUMNI_OF(CommunityHealth communityHealth) {
	...
	public ALUMNI_OF(ComputerStore computerStore) {
	...
	public ALUMNI_OF(Consortium consortium) {
	...
	public ALUMNI_OF(ConvenienceStore convenienceStore) {
	...
	public ALUMNI_OF(Corporation corporation) {
	...
	public ALUMNI_OF(DanceGroup danceGroup) {
	...
	public ALUMNI_OF(DaySpa daySpa) {
	...
	public ALUMNI_OF(Dentist dentist) {
	...
	public ALUMNI_OF(DepartmentStore departmentStore) {
	...
	public ALUMNI_OF(Dermatology dermatology) {
	...
	public ALUMNI_OF(DiagnosticLab diagnosticLab) {
	...
	public ALUMNI_OF(DietNutrition dietNutrition) {
	...
	public ALUMNI_OF(Distillery distillery) {
	...
	public ALUMNI_OF(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public ALUMNI_OF(Electrician electrician) {
	...
	public ALUMNI_OF(ElectronicsStore electronicsStore) {
	...
	public ALUMNI_OF(ElementarySchool elementarySchool) {
	...
	public ALUMNI_OF(Emergency emergency) {
	...
	public ALUMNI_OF(EmergencyService emergencyService) {
	...
	public ALUMNI_OF(EmploymentAgency employmentAgency) {
	...
	public ALUMNI_OF(EntertainmentBusiness entertainmentBusiness) {
	...
	public ALUMNI_OF(ExerciseGym exerciseGym) {
	...
	public ALUMNI_OF(FastFoodRestaurant fastFoodRestaurant) {
	...
	public ALUMNI_OF(FinancialService financialService) {
	...
	public ALUMNI_OF(FireStation fireStation) {
	...
	public ALUMNI_OF(Florist florist) {
	...
	public ALUMNI_OF(FoodEstablishment foodEstablishment) {
	...
	public ALUMNI_OF(FundingAgency fundingAgency) {
	...
	public ALUMNI_OF(FundingScheme fundingScheme) {
	...
	public ALUMNI_OF(FurnitureStore furnitureStore) {
	...
	public ALUMNI_OF(GardenStore gardenStore) {
	...
	public ALUMNI_OF(GasStation gasStation) {
	...
	public ALUMNI_OF(GeneralContractor generalContractor) {
	...
	public ALUMNI_OF(Geriatric geriatric) {
	...
	public ALUMNI_OF(GolfCourse golfCourse) {
	...
	public ALUMNI_OF(GovernmentOffice governmentOffice) {
	...
	public ALUMNI_OF(GovernmentOrganization governmentOrganization) {
	...
	public ALUMNI_OF(GroceryStore groceryStore) {
	...
	public ALUMNI_OF(Gynecologic gynecologic) {
	...
	public ALUMNI_OF(HVACBusiness hvacBusiness) {
	...
	public ALUMNI_OF(HairSalon hairSalon) {
	...
	public ALUMNI_OF(HardwareStore hardwareStore) {
	...
	public ALUMNI_OF(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public ALUMNI_OF(HealthClub healthClub) {
	...
	public ALUMNI_OF(HighSchool highSchool) {
	...
	public ALUMNI_OF(HobbyShop hobbyShop) {
	...
	public ALUMNI_OF(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public ALUMNI_OF(HomeGoodsStore homeGoodsStore) {
	...
	public ALUMNI_OF(Hospital hospital) {
	...
	public ALUMNI_OF(Hostel hostel) {
	...
	public ALUMNI_OF(HousePainter housePainter) {
	...
	public ALUMNI_OF(IceCreamShop iceCreamShop) {
	...
	public ALUMNI_OF(InsuranceAgency insuranceAgency) {
	...
	public ALUMNI_OF(InternetCafe internetCafe) {
	...
	public ALUMNI_OF(JewelryStore jewelryStore) {
	...
	public ALUMNI_OF(LegalService legalService) {
	...
	public ALUMNI_OF(Library library) {
	...
	public ALUMNI_OF(LibrarySystem librarySystem) {
	...
	public ALUMNI_OF(LiquorStore liquorStore) {
	...
	public ALUMNI_OF(LocalBusiness localBusiness) {
	...
	public ALUMNI_OF(Locksmith locksmith) {
	...
	public ALUMNI_OF(LodgingBusiness lodgingBusiness) {
	...
	public ALUMNI_OF(MedicalBusiness medicalBusiness) {
	...
	public ALUMNI_OF(MedicalClinic medicalClinic) {
	...
	public ALUMNI_OF(MedicalOrganization medicalOrganization) {
	...
	public ALUMNI_OF(MensClothingStore mensClothingStore) {
	...
	public ALUMNI_OF(MiddleSchool middleSchool) {
	...
	public ALUMNI_OF(Midwifery midwifery) {
	...
	public ALUMNI_OF(MobilePhoneStore mobilePhoneStore) {
	...
	public ALUMNI_OF(MotorcycleDealer motorcycleDealer) {
	...
	public ALUMNI_OF(MotorcycleRepair motorcycleRepair) {
	...
	public ALUMNI_OF(MovieRentalStore movieRentalStore) {
	...
	public ALUMNI_OF(MovieTheater movieTheater) {
	...
	public ALUMNI_OF(MovingCompany movingCompany) {
	...
	public ALUMNI_OF(MusicGroup musicGroup) {
	...
	public ALUMNI_OF(MusicStore musicStore) {
	...
	public ALUMNI_OF(NailSalon nailSalon) {
	...
	public ALUMNI_OF(NewsMediaOrganization newsMediaOrganization) {
	...
	public ALUMNI_OF(NightClub nightClub) {
	...
	public ALUMNI_OF(Notary notary) {
	...
	public ALUMNI_OF(Nursing nursing) {
	...
	public ALUMNI_OF(Obstetric obstetric) {
	...
	public ALUMNI_OF(OfficeEquipmentStore officeEquipmentStore) {
	...
	public ALUMNI_OF(Oncologic oncologic) {
	...
	public ALUMNI_OF(Optician optician) {
	...
	public ALUMNI_OF(Optometric optometric) {
	...
	public ALUMNI_OF(Otolaryngologic otolaryngologic) {
	...
	public ALUMNI_OF(OutletStore outletStore) {
	...
	public ALUMNI_OF(PawnShop pawnShop) {
	...
	public ALUMNI_OF(Pediatric pediatric) {
	...
	public ALUMNI_OF(PerformingGroup performingGroup) {
	...
	public ALUMNI_OF(PetStore petStore) {
	...
	public ALUMNI_OF(Pharmacy pharmacy) {
	...
	public ALUMNI_OF(Physician physician) {
	...
	public ALUMNI_OF(Physiotherapy physiotherapy) {
	...
	public ALUMNI_OF(PlasticSurgery plasticSurgery) {
	...
	public ALUMNI_OF(Plumber plumber) {
	...
	public ALUMNI_OF(Podiatric podiatric) {
	...
	public ALUMNI_OF(PoliceStation policeStation) {
	...
	public ALUMNI_OF(PostOffice postOffice) {
	...
	public ALUMNI_OF(Preschool preschool) {
	...
	public ALUMNI_OF(PrimaryCare primaryCare) {
	...
	public ALUMNI_OF(ProfessionalService professionalService) {
	...
	public ALUMNI_OF(Project project) {
	...
	public ALUMNI_OF(Psychiatric psychiatric) {
	...
	public ALUMNI_OF(PublicHealth publicHealth) {
	...
	public ALUMNI_OF(PublicSwimmingPool publicSwimmingPool) {
	...
	public ALUMNI_OF(RadioStation radioStation) {
	...
	public ALUMNI_OF(RealEstateAgent realEstateAgent) {
	...
	public ALUMNI_OF(RecyclingCenter recyclingCenter) {
	...
	public ALUMNI_OF(ResearchProject researchProject) {
	...
	public ALUMNI_OF(Resort resort) {
	...
	public ALUMNI_OF(Restaurant restaurant) {
	...
	public ALUMNI_OF(RoofingContractor roofingContractor) {
	...
	public ALUMNI_OF(School school) {
	...
	public ALUMNI_OF(SelfStorage selfStorage) {
	...
	public ALUMNI_OF(ShoeStore shoeStore) {
	...
	public ALUMNI_OF(ShoppingCenter shoppingCenter) {
	...
	public ALUMNI_OF(SkiResort skiResort) {
	...
	public ALUMNI_OF(SportingGoodsStore sportingGoodsStore) {
	...
	public ALUMNI_OF(SportsActivityLocation sportsActivityLocation) {
	...
	public ALUMNI_OF(SportsClub sportsClub) {
	...
	public ALUMNI_OF(SportsOrganization sportsOrganization) {
	...
	public ALUMNI_OF(SportsTeam sportsTeam) {
	...
	public ALUMNI_OF(StadiumOrArena stadiumOrArena) {
	...
	public ALUMNI_OF(TattooParlor tattooParlor) {
	...
	public ALUMNI_OF(TelevisionStation televisionStation) {
	...
	public ALUMNI_OF(TennisComplex tennisComplex) {
	...
	public ALUMNI_OF(TheaterGroup theaterGroup) {
	...
	public ALUMNI_OF(TireShop tireShop) {
	...
	public ALUMNI_OF(TouristInformationCenter touristInformationCenter) {
	...
	public ALUMNI_OF(ToyStore toyStore) {
	...
	public ALUMNI_OF(TravelAgency travelAgency) {
	...
	public ALUMNI_OF(VeterinaryCare veterinaryCare) {
	...
	public ALUMNI_OF(WholesaleStore wholesaleStore) {
	...
	public ALUMNI_OF(Winery winery) {
	...
	public ALUMNI_OF(WorkersUnion workersUnion) {
