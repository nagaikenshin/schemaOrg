...
public class PRODUCER implements Container.Producer {
	...
	public PRODUCER(AccountingService accountingService) {
	...
	public PRODUCER(AdultEntertainment adultEntertainment) {
	...
	public PRODUCER(Airline airline) {
	...
	public PRODUCER(AmusementPark amusementPark) {
	...
	public PRODUCER(AnimalShelter animalShelter) {
	...
	public PRODUCER(ArchiveOrganization archiveOrganization) {
	...
	public PRODUCER(ArtGallery artGallery) {
	...
	public PRODUCER(Attorney attorney) {
	...
	public PRODUCER(AutoBodyShop autoBodyShop) {
	...
	public PRODUCER(AutoDealer autoDealer) {
	...
	public PRODUCER(AutoPartsStore autoPartsStore) {
	...
	public PRODUCER(AutoRental autoRental) {
	...
	public PRODUCER(AutoRepair autoRepair) {
	...
	public PRODUCER(AutoWash autoWash) {
	...
	public PRODUCER(AutomatedTeller automatedTeller) {
	...
	public PRODUCER(AutomotiveBusiness automotiveBusiness) {
	...
	public PRODUCER(BankOrCreditUnion bankOrCreditUnion) {
	...
	public PRODUCER(BarOrPub barOrPub) {
	...
	public PRODUCER(BeautySalon beautySalon) {
	...
	public PRODUCER(BedAndBreakfast bedAndBreakfast) {
	...
	public PRODUCER(BikeStore bikeStore) {
	...
	public PRODUCER(BookStore bookStore) {
	...
	public PRODUCER(BowlingAlley bowlingAlley) {
	...
	public PRODUCER(Brewery brewery) {
	...
	public PRODUCER(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public PRODUCER(Campground campground) {
	...
	public PRODUCER(ChildCare childCare) {
	...
	public PRODUCER(ClothingStore clothingStore) {
	...
	public PRODUCER(CollegeOrUniversity collegeOrUniversity) {
	...
	public PRODUCER(ComedyClub comedyClub) {
	...
	public PRODUCER(CommunityHealth communityHealth) {
	...
	public PRODUCER(ComputerStore computerStore) {
	...
	public PRODUCER(Consortium consortium) {
	...
	public PRODUCER(ConvenienceStore convenienceStore) {
	...
	public PRODUCER(Corporation corporation) {
	...
	public PRODUCER(DanceGroup danceGroup) {
	...
	public PRODUCER(Dentist dentist) {
	...
	public PRODUCER(DepartmentStore departmentStore) {
	...
	public PRODUCER(Dermatology dermatology) {
	...
	public PRODUCER(DiagnosticLab diagnosticLab) {
	...
	public PRODUCER(DietNutrition dietNutrition) {
	...
	public PRODUCER(Distillery distillery) {
	...
	public PRODUCER(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public PRODUCER(EducationalOrganization educationalOrganization) {
	...
	public PRODUCER(Electrician electrician) {
	...
	public PRODUCER(ElectronicsStore electronicsStore) {
	...
	public PRODUCER(ElementarySchool elementarySchool) {
	...
	public PRODUCER(Emergency emergency) {
	...
	public PRODUCER(EmergencyService emergencyService) {
	...
	public PRODUCER(EmploymentAgency employmentAgency) {
	...
	public PRODUCER(EntertainmentBusiness entertainmentBusiness) {
	...
	public PRODUCER(ExerciseGym exerciseGym) {
	...
	public PRODUCER(FastFoodRestaurant fastFoodRestaurant) {
	...
	public PRODUCER(FinancialService financialService) {
	...
	public PRODUCER(FireStation fireStation) {
	...
	public PRODUCER(Florist florist) {
	...
	public PRODUCER(FoodEstablishment foodEstablishment) {
	...
	public PRODUCER(FundingAgency fundingAgency) {
	...
	public PRODUCER(FundingScheme fundingScheme) {
	...
	public PRODUCER(FurnitureStore furnitureStore) {
	...
	public PRODUCER(GardenStore gardenStore) {
	...
	public PRODUCER(GasStation gasStation) {
	...
	public PRODUCER(GeneralContractor generalContractor) {
	...
	public PRODUCER(Geriatric geriatric) {
	...
	public PRODUCER(GolfCourse golfCourse) {
	...
	public PRODUCER(GovernmentOffice governmentOffice) {
	...
	public PRODUCER(GovernmentOrganization governmentOrganization) {
	...
	public PRODUCER(GroceryStore groceryStore) {
	...
	public PRODUCER(Gynecologic gynecologic) {
	...
	public PRODUCER(HVACBusiness hvacBusiness) {
	...
	public PRODUCER(HairSalon hairSalon) {
	...
	public PRODUCER(HardwareStore hardwareStore) {
	...
	public PRODUCER(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public PRODUCER(HealthClub healthClub) {
	...
	public PRODUCER(HighSchool highSchool) {
	...
	public PRODUCER(HobbyShop hobbyShop) {
	...
	public PRODUCER(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public PRODUCER(HomeGoodsStore homeGoodsStore) {
	...
	public PRODUCER(Hospital hospital) {
	...
	public PRODUCER(HousePainter housePainter) {
	...
	public PRODUCER(IceCreamShop iceCreamShop) {
	...
	public PRODUCER(InsuranceAgency insuranceAgency) {
	...
	public PRODUCER(InternetCafe internetCafe) {
	...
	public PRODUCER(JewelryStore jewelryStore) {
	...
	public PRODUCER(LegalService legalService) {
	...
	public PRODUCER(LibrarySystem librarySystem) {
	...
	public PRODUCER(LiquorStore liquorStore) {
	...
	public PRODUCER(LocalBusiness localBusiness) {
	...
	public PRODUCER(Locksmith locksmith) {
	...
	public PRODUCER(LodgingBusiness lodgingBusiness) {
	...
	public PRODUCER(MedicalBusiness medicalBusiness) {
	...
	public PRODUCER(MedicalClinic medicalClinic) {
	...
	public PRODUCER(MedicalOrganization medicalOrganization) {
	...
	public PRODUCER(MensClothingStore mensClothingStore) {
	...
	public PRODUCER(MiddleSchool middleSchool) {
	...
	public PRODUCER(Midwifery midwifery) {
	...
	public PRODUCER(MobilePhoneStore mobilePhoneStore) {
	...
	public PRODUCER(MotorcycleDealer motorcycleDealer) {
	...
	public PRODUCER(MotorcycleRepair motorcycleRepair) {
	...
	public PRODUCER(MovieRentalStore movieRentalStore) {
	...
	public PRODUCER(MovieTheater movieTheater) {
	...
	public PRODUCER(MovingCompany movingCompany) {
	...
	public PRODUCER(MusicGroup musicGroup) {
	...
	public PRODUCER(MusicStore musicStore) {
	...
	public PRODUCER(NailSalon nailSalon) {
	...
	public PRODUCER(NewsMediaOrganization newsMediaOrganization) {
	...
	public PRODUCER(NightClub nightClub) {
	...
	public PRODUCER(Nursing nursing) {
	...
	public PRODUCER(Obstetric obstetric) {
	...
	public PRODUCER(OfficeEquipmentStore officeEquipmentStore) {
	...
	public PRODUCER(Oncologic oncologic) {
	...
	public PRODUCER(Optician optician) {
	...
	public PRODUCER(Optometric optometric) {
	...
	public PRODUCER(Organization organization) {
		organizationList = new ArrayList<Organization>();
	...
	public PRODUCER(Otolaryngologic otolaryngologic) {
	...
	public PRODUCER(OutletStore outletStore) {
	...
	public PRODUCER(Patient patient) {
	...
	public PRODUCER(PawnShop pawnShop) {
	...
	public PRODUCER(Pediatric pediatric) {
	...
	public PRODUCER(PerformingGroup performingGroup) {
	...
	public PRODUCER(PetStore petStore) {
	...
	public PRODUCER(Pharmacy pharmacy) {
	...
	public PRODUCER(Physician physician) {
	...
	public PRODUCER(Physiotherapy physiotherapy) {
	...
	public PRODUCER(PlasticSurgery plasticSurgery) {
	...
	public PRODUCER(Plumber plumber) {
	...
	public PRODUCER(Podiatric podiatric) {
	...
	public PRODUCER(PoliceStation policeStation) {
	...
	public PRODUCER(PostOffice postOffice) {
	...
	public PRODUCER(Preschool preschool) {
	...
	public PRODUCER(PrimaryCare primaryCare) {
	...
	public PRODUCER(ProfessionalService professionalService) {
	...
	public PRODUCER(Project project) {
	...
	public PRODUCER(Psychiatric psychiatric) {
	...
	public PRODUCER(PublicHealth publicHealth) {
	...
	public PRODUCER(PublicSwimmingPool publicSwimmingPool) {
	...
	public PRODUCER(RadioStation radioStation) {
	...
	public PRODUCER(RealEstateAgent realEstateAgent) {
	...
	public PRODUCER(RecyclingCenter recyclingCenter) {
	...
	public PRODUCER(ResearchProject researchProject) {
	...
	public PRODUCER(RoofingContractor roofingContractor) {
	...
	public PRODUCER(SelfStorage selfStorage) {
	...
	public PRODUCER(ShoeStore shoeStore) {
	...
	public PRODUCER(ShoppingCenter shoppingCenter) {
	...
	public PRODUCER(SkiResort skiResort) {
	...
	public PRODUCER(SportingGoodsStore sportingGoodsStore) {
	...
	public PRODUCER(SportsActivityLocation sportsActivityLocation) {
	...
	public PRODUCER(SportsClub sportsClub) {
	...
	public PRODUCER(SportsOrganization sportsOrganization) {
	...
	public PRODUCER(SportsTeam sportsTeam) {
	...
	public PRODUCER(StadiumOrArena stadiumOrArena) {
	...
	public PRODUCER(TattooParlor tattooParlor) {
	...
	public PRODUCER(TelevisionStation televisionStation) {
	...
	public PRODUCER(TennisComplex tennisComplex) {
	...
	public PRODUCER(TheaterGroup theaterGroup) {
	...
	public PRODUCER(TireShop tireShop) {
	...
	public PRODUCER(TouristInformationCenter touristInformationCenter) {
	...
	public PRODUCER(ToyStore toyStore) {
	...
	public PRODUCER(TravelAgency travelAgency) {
	...
	public PRODUCER(VeterinaryCare veterinaryCare) {
	...
	public PRODUCER(WholesaleStore wholesaleStore) {
	...
	public PRODUCER(WorkersUnion workersUnion) {
	...
	public void copy(Container.Producer org) {
