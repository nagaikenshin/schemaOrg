...
public class MOTEL implements Clazz.Motel {
	...
	public MOTEL(GeoContains geoContains) {
	...
	public MOTEL(GeoCoveredBy geoCoveredBy) {
	...
	public MOTEL(GeoCovers geoCovers) {
	...
	public MOTEL(GeoCrosses geoCrosses) {
	...
	public MOTEL(GeoDisjoint geoDisjoint) {
	...
	public MOTEL(GeoEquals geoEquals) {
	...
	public MOTEL(GeoIntersects geoIntersects) {
	...
	public MOTEL(GeoOverlaps geoOverlaps) {
	...
	public MOTEL(GeoTouches geoTouches) {
	...
	public MOTEL(GeoWithin geoWithin) {
