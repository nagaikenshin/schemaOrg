...
public class MESSAGE implements Clazz.Message {
	...
	public MESSAGE(AccessMode accessMode) {
	...
	public MESSAGE(AccessModeSufficient accessModeSufficient) {
	...
	public MESSAGE(AccessibilityAPI accessibilityAPI) {
	...
	public MESSAGE(AccessibilityControl accessibilityControl) {
	...
	public MESSAGE(AccessibilityFeature accessibilityFeature) {
	...
	public MESSAGE(AccessibilityHazard accessibilityHazard) {
	...
	public MESSAGE(AccessibilitySummary accessibilitySummary) {
	...
	public MESSAGE(AccountablePerson accountablePerson) {
	...
	public MESSAGE(AdditionalType additionalType) {
	...
	public MESSAGE(AggregateRating aggregateRating) {
	...
	public MESSAGE(AlternateName alternateName) {
	...
	public MESSAGE(AlternativeHeadline alternativeHeadline) {
	...
	public MESSAGE(AssociatedMedia associatedMedia) {
	...
	public MESSAGE(Audience audience) {
	...
	public MESSAGE(BccRecipient bccRecipient) {
	...
	public MESSAGE(CcRecipient ccRecipient) {
	...
	public MESSAGE(Citation citation) {
	...
	public MESSAGE(CommentCount commentCount) {
	...
	public MESSAGE(ContentLocation contentLocation) {
	...
	public MESSAGE(ContentRating contentRating) {
	...
	public MESSAGE(ContentReferenceTime contentReferenceTime) {
	...
	public MESSAGE(Contributor contributor) {
	...
	public MESSAGE(CopyrightHolder copyrightHolder) {
	...
	public MESSAGE(CopyrightYear copyrightYear) {
	...
	public MESSAGE(Correction correction) {
	...
	public MESSAGE(Creator creator) {
		setCreator(creator);
	}
	...
	public MESSAGE(DateCreated dateCreated) {
	...
	public MESSAGE(DateModified dateModified) {
	...
	public MESSAGE(DatePublished datePublished) {
	...
	public MESSAGE(DateRead dateRead) {
	...
	public MESSAGE(DateReceived dateReceived) {
	...
	public MESSAGE(DateSent dateSent) {
	...
	public MESSAGE(DisambiguatingDescription disambiguatingDescription) {
	...
	public MESSAGE(DiscussionUrl discussionUrl) {
	...
	public MESSAGE(EducationalAlignment educationalAlignment) {
	...
	public MESSAGE(EducationalUse educationalUse) {
	...
	public MESSAGE(EncodingFormat encodingFormat) {
	...
	public MESSAGE(ExampleOfWork exampleOfWork) {
	...
	public MESSAGE(Expires expires) {
		setExpires(expires);
	}
	...
	public MESSAGE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public MESSAGE(Headline headline) {
	...
	public MESSAGE(InLanguage inLanguage) {
	...
	public MESSAGE(InteractionStatistic interactionStatistic) {
	...
	public MESSAGE(InteractivityType interactivityType) {
	...
	public MESSAGE(IsAccessibleForFree isAccessibleForFree) {
	...
	public MESSAGE(IsBasedOn isBasedOn) {
	...
	public MESSAGE(IsFamilyFriendly isFamilyFriendly) {
	...
	public MESSAGE(IsPartOf isPartOf) {
	...
	public MESSAGE(Keywords keywords) {
	...
	public MESSAGE(LearningResourceType learningResourceType) {
	...
	public MESSAGE(License license) {
		setLicense(license);
	}
	...
	public MESSAGE(LocationCreated locationCreated) {
	...
	public MESSAGE(MainEntity mainEntity) {
	...
	public MESSAGE(MainEntityOfPage mainEntityOfPage) {
	...
	public MESSAGE(Material material) {
	...
	public MESSAGE(MaterialExtent materialExtent) {
	...
	public MESSAGE(Mentions mentions) {
	...
	public MESSAGE(NameFuzzy nameFuzzy) {
	...
	public MESSAGE(NameRuby nameRuby) {
	...
	public MESSAGE(PotentialAction potentialAction) {
	...
	public MESSAGE(Producer producer) {
	...
	public MESSAGE(Provider provider) {
	...
	public MESSAGE(Publication publication) {
	...
	public MESSAGE(Publisher publisher) {
	...
	public MESSAGE(PublisherImprint publisherImprint) {
	...
	public MESSAGE(PublishingPrinciples publishingPrinciples) {
	...
	public MESSAGE(Recipient recipient) {
	...
	public MESSAGE(RecordedAt recordedAt) {
	...
	public MESSAGE(ReleasedEvent releasedEvent) {
	...
	public MESSAGE(SchemaVersion schemaVersion) {
	...
	public MESSAGE(SdDatePublished sdDatePublished) {
	...
	public MESSAGE(SdLicense sdLicense) {
	...
	public MESSAGE(SdPublisher sdPublisher) {
	...
	public MESSAGE(SourceOrganization sourceOrganization) {
	...
	public MESSAGE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public MESSAGE(SpatialCoverage spatialCoverage) {
	...
	public MESSAGE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MESSAGE(SubjectOf subjectOf) {
	...
	public MESSAGE(Temporal temporal) {
	...
	public MESSAGE(TemporalCoverage temporalCoverage) {
	...
	public MESSAGE(ThumbnailUrl thumbnailUrl) {
	...
	public MESSAGE(TimeRequired timeRequired) {
	...
	public MESSAGE(ToRecipient toRecipient) {
	...
	public MESSAGE(TranslationOfWork translationOfWork) {
	...
	public MESSAGE(Translator translator) {
	...
	public MESSAGE(TypicalAgeRange typicalAgeRange) {
	...
	public MESSAGE(WorkExample workExample) {
	...
	public MESSAGE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Message org) {
		setSeq(org.getSeq());
