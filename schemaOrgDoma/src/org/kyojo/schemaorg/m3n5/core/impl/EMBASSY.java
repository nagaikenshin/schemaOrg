...
public class EMBASSY implements Clazz.Embassy {
	...
	public EMBASSY(GeoContains geoContains) {
	...
	public EMBASSY(GeoCoveredBy geoCoveredBy) {
	...
	public EMBASSY(GeoCovers geoCovers) {
	...
	public EMBASSY(GeoCrosses geoCrosses) {
	...
	public EMBASSY(GeoDisjoint geoDisjoint) {
	...
	public EMBASSY(GeoEquals geoEquals) {
	...
	public EMBASSY(GeoIntersects geoIntersects) {
	...
	public EMBASSY(GeoOverlaps geoOverlaps) {
	...
	public EMBASSY(GeoTouches geoTouches) {
	...
	public EMBASSY(GeoWithin geoWithin) {
