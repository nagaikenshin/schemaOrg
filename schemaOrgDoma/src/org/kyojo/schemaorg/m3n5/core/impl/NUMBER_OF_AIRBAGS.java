...
public class NUMBER_OF_AIRBAGS implements Container.NumberOfAirbags {
	...
	public NUMBER_OF_AIRBAGS(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public NUMBER_OF_AIRBAGS(Float fl0at) {
	...
	public NUMBER_OF_AIRBAGS(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public NUMBER_OF_AIRBAGS(Integer integer) {
	...
	public NUMBER_OF_AIRBAGS(List<Float> fl0atList,
