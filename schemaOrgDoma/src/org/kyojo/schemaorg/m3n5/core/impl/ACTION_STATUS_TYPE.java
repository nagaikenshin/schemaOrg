...
public class ACTION_STATUS_TYPE implements Clazz.ActionStatusType {
	...
	public ACTION_STATUS_TYPE() {
	}

	public ACTION_STATUS_TYPE(Long seq) {
		setSeq(seq);
	}

	public ACTION_STATUS_TYPE(String string) {
	...
	public ACTION_STATUS_TYPE(AdditionalType additionalType) {
	...
	public ACTION_STATUS_TYPE(AlternateName alternateName) {
	...
	public ACTION_STATUS_TYPE(Description description) {
	...
	public ACTION_STATUS_TYPE(DisambiguatingDescription disambiguatingDescription) {
	...
	public ACTION_STATUS_TYPE(Identifier identifier) {
	...
	public ACTION_STATUS_TYPE(Image image) {
		setImage(image);
	}
	...
	public ACTION_STATUS_TYPE(MainEntityOfPage mainEntityOfPage) {
	...
	public ACTION_STATUS_TYPE(Name name) {
		setName(name);
	}
	...
	public ACTION_STATUS_TYPE(NameFuzzy nameFuzzy) {
	...
	public ACTION_STATUS_TYPE(NameRuby nameRuby) {
	...
	public ACTION_STATUS_TYPE(PotentialAction potentialAction) {
	...
	public ACTION_STATUS_TYPE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ACTION_STATUS_TYPE(SubjectOf subjectOf) {
	...
	public ACTION_STATUS_TYPE(SupersededBy supersededBy) {
	...
	public ACTION_STATUS_TYPE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.ActionStatusType org) {
		setSeq(org.getSeq());
