...
public class WORKS_FOR implements Container.WorksFor {
	...
	public WORKS_FOR(AccountingService accountingService) {
	...
	public WORKS_FOR(AdultEntertainment adultEntertainment) {
	...
	public WORKS_FOR(Airline airline) {
	...
	public WORKS_FOR(AmusementPark amusementPark) {
	...
	public WORKS_FOR(AnimalShelter animalShelter) {
	...
	public WORKS_FOR(ArchiveOrganization archiveOrganization) {
	...
	public WORKS_FOR(ArtGallery artGallery) {
	...
	public WORKS_FOR(Attorney attorney) {
	...
	public WORKS_FOR(AutoBodyShop autoBodyShop) {
	...
	public WORKS_FOR(AutoDealer autoDealer) {
	...
	public WORKS_FOR(AutoPartsStore autoPartsStore) {
	...
	public WORKS_FOR(AutoRental autoRental) {
	...
	public WORKS_FOR(AutoRepair autoRepair) {
	...
	public WORKS_FOR(AutoWash autoWash) {
	...
	public WORKS_FOR(AutomatedTeller automatedTeller) {
	...
	public WORKS_FOR(AutomotiveBusiness automotiveBusiness) {
	...
	public WORKS_FOR(Bakery bakery) {
	...
	public WORKS_FOR(BankOrCreditUnion bankOrCreditUnion) {
	...
	public WORKS_FOR(BarOrPub barOrPub) {
	...
	public WORKS_FOR(BeautySalon beautySalon) {
	...
	public WORKS_FOR(BedAndBreakfast bedAndBreakfast) {
	...
	public WORKS_FOR(BikeStore bikeStore) {
	...
	public WORKS_FOR(BookStore bookStore) {
	...
	public WORKS_FOR(BowlingAlley bowlingAlley) {
	...
	public WORKS_FOR(Brewery brewery) {
	...
	public WORKS_FOR(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public WORKS_FOR(Campground campground) {
	...
	public WORKS_FOR(Casino casino) {
	...
	public WORKS_FOR(ChildCare childCare) {
	...
	public WORKS_FOR(ClothingStore clothingStore) {
	...
	public WORKS_FOR(CollegeOrUniversity collegeOrUniversity) {
	...
	public WORKS_FOR(ComedyClub comedyClub) {
	...
	public WORKS_FOR(CommunityHealth communityHealth) {
	...
	public WORKS_FOR(ComputerStore computerStore) {
	...
	public WORKS_FOR(Consortium consortium) {
	...
	public WORKS_FOR(ConvenienceStore convenienceStore) {
	...
	public WORKS_FOR(Corporation corporation) {
	...
	public WORKS_FOR(DanceGroup danceGroup) {
	...
	public WORKS_FOR(DaySpa daySpa) {
	...
	public WORKS_FOR(Dentist dentist) {
	...
	public WORKS_FOR(DepartmentStore departmentStore) {
	...
	public WORKS_FOR(Dermatology dermatology) {
	...
	public WORKS_FOR(DiagnosticLab diagnosticLab) {
	...
	public WORKS_FOR(DietNutrition dietNutrition) {
	...
	public WORKS_FOR(Distillery distillery) {
	...
	public WORKS_FOR(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public WORKS_FOR(EducationalOrganization educationalOrganization) {
	...
	public WORKS_FOR(Electrician electrician) {
	...
	public WORKS_FOR(ElectronicsStore electronicsStore) {
	...
	public WORKS_FOR(ElementarySchool elementarySchool) {
	...
	public WORKS_FOR(Emergency emergency) {
	...
	public WORKS_FOR(EmergencyService emergencyService) {
	...
	public WORKS_FOR(EmploymentAgency employmentAgency) {
	...
	public WORKS_FOR(EntertainmentBusiness entertainmentBusiness) {
	...
	public WORKS_FOR(ExerciseGym exerciseGym) {
	...
	public WORKS_FOR(FastFoodRestaurant fastFoodRestaurant) {
	...
	public WORKS_FOR(FinancialService financialService) {
	...
	public WORKS_FOR(FireStation fireStation) {
	...
	public WORKS_FOR(Florist florist) {
	...
	public WORKS_FOR(FoodEstablishment foodEstablishment) {
	...
	public WORKS_FOR(FundingAgency fundingAgency) {
	...
	public WORKS_FOR(FundingScheme fundingScheme) {
	...
	public WORKS_FOR(FurnitureStore furnitureStore) {
	...
	public WORKS_FOR(GardenStore gardenStore) {
	...
	public WORKS_FOR(GasStation gasStation) {
	...
	public WORKS_FOR(GeneralContractor generalContractor) {
	...
	public WORKS_FOR(Geriatric geriatric) {
	...
	public WORKS_FOR(GolfCourse golfCourse) {
	...
	public WORKS_FOR(GovernmentOffice governmentOffice) {
	...
	public WORKS_FOR(GovernmentOrganization governmentOrganization) {
	...
	public WORKS_FOR(GroceryStore groceryStore) {
	...
	public WORKS_FOR(Gynecologic gynecologic) {
	...
	public WORKS_FOR(HVACBusiness hvacBusiness) {
	...
	public WORKS_FOR(HairSalon hairSalon) {
	...
	public WORKS_FOR(HardwareStore hardwareStore) {
	...
	public WORKS_FOR(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public WORKS_FOR(HealthClub healthClub) {
	...
	public WORKS_FOR(HighSchool highSchool) {
	...
	public WORKS_FOR(HobbyShop hobbyShop) {
	...
	public WORKS_FOR(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public WORKS_FOR(HomeGoodsStore homeGoodsStore) {
	...
	public WORKS_FOR(Hospital hospital) {
	...
	public WORKS_FOR(Hostel hostel) {
	...
	public WORKS_FOR(HousePainter housePainter) {
	...
	public WORKS_FOR(IceCreamShop iceCreamShop) {
	...
	public WORKS_FOR(InsuranceAgency insuranceAgency) {
	...
	public WORKS_FOR(InternetCafe internetCafe) {
	...
	public WORKS_FOR(JewelryStore jewelryStore) {
	...
	public WORKS_FOR(LegalService legalService) {
	...
	public WORKS_FOR(Library library) {
	...
	public WORKS_FOR(LibrarySystem librarySystem) {
	...
	public WORKS_FOR(LiquorStore liquorStore) {
	...
	public WORKS_FOR(LocalBusiness localBusiness) {
	...
	public WORKS_FOR(Locksmith locksmith) {
	...
	public WORKS_FOR(LodgingBusiness lodgingBusiness) {
	...
	public WORKS_FOR(MedicalBusiness medicalBusiness) {
	...
	public WORKS_FOR(MedicalClinic medicalClinic) {
	...
	public WORKS_FOR(MedicalOrganization medicalOrganization) {
	...
	public WORKS_FOR(MensClothingStore mensClothingStore) {
	...
	public WORKS_FOR(MiddleSchool middleSchool) {
	...
	public WORKS_FOR(Midwifery midwifery) {
	...
	public WORKS_FOR(MobilePhoneStore mobilePhoneStore) {
	...
	public WORKS_FOR(MotorcycleDealer motorcycleDealer) {
	...
	public WORKS_FOR(MotorcycleRepair motorcycleRepair) {
	...
	public WORKS_FOR(MovieRentalStore movieRentalStore) {
	...
	public WORKS_FOR(MovieTheater movieTheater) {
	...
	public WORKS_FOR(MovingCompany movingCompany) {
	...
	public WORKS_FOR(MusicGroup musicGroup) {
	...
	public WORKS_FOR(MusicStore musicStore) {
	...
	public WORKS_FOR(NailSalon nailSalon) {
	...
	public WORKS_FOR(NewsMediaOrganization newsMediaOrganization) {
	...
	public WORKS_FOR(NightClub nightClub) {
	...
	public WORKS_FOR(Notary notary) {
	...
	public WORKS_FOR(Nursing nursing) {
	...
	public WORKS_FOR(Obstetric obstetric) {
	...
	public WORKS_FOR(OfficeEquipmentStore officeEquipmentStore) {
	...
	public WORKS_FOR(Oncologic oncologic) {
	...
	public WORKS_FOR(Optician optician) {
	...
	public WORKS_FOR(Optometric optometric) {
	...
	public WORKS_FOR(Otolaryngologic otolaryngologic) {
	...
	public WORKS_FOR(OutletStore outletStore) {
	...
	public WORKS_FOR(PawnShop pawnShop) {
	...
	public WORKS_FOR(Pediatric pediatric) {
	...
	public WORKS_FOR(PerformingGroup performingGroup) {
	...
	public WORKS_FOR(PetStore petStore) {
	...
	public WORKS_FOR(Pharmacy pharmacy) {
	...
	public WORKS_FOR(Physician physician) {
	...
	public WORKS_FOR(Physiotherapy physiotherapy) {
	...
	public WORKS_FOR(PlasticSurgery plasticSurgery) {
	...
	public WORKS_FOR(Plumber plumber) {
	...
	public WORKS_FOR(Podiatric podiatric) {
	...
	public WORKS_FOR(PoliceStation policeStation) {
	...
	public WORKS_FOR(PostOffice postOffice) {
	...
	public WORKS_FOR(Preschool preschool) {
	...
	public WORKS_FOR(PrimaryCare primaryCare) {
	...
	public WORKS_FOR(ProfessionalService professionalService) {
	...
	public WORKS_FOR(Project project) {
	...
	public WORKS_FOR(Psychiatric psychiatric) {
	...
	public WORKS_FOR(PublicHealth publicHealth) {
	...
	public WORKS_FOR(PublicSwimmingPool publicSwimmingPool) {
	...
	public WORKS_FOR(RadioStation radioStation) {
	...
	public WORKS_FOR(RealEstateAgent realEstateAgent) {
	...
	public WORKS_FOR(RecyclingCenter recyclingCenter) {
	...
	public WORKS_FOR(ResearchProject researchProject) {
	...
	public WORKS_FOR(Resort resort) {
	...
	public WORKS_FOR(Restaurant restaurant) {
	...
	public WORKS_FOR(RoofingContractor roofingContractor) {
	...
	public WORKS_FOR(School school) {
	...
	public WORKS_FOR(SelfStorage selfStorage) {
	...
	public WORKS_FOR(ShoeStore shoeStore) {
	...
	public WORKS_FOR(ShoppingCenter shoppingCenter) {
	...
	public WORKS_FOR(SkiResort skiResort) {
	...
	public WORKS_FOR(SportingGoodsStore sportingGoodsStore) {
	...
	public WORKS_FOR(SportsActivityLocation sportsActivityLocation) {
	...
	public WORKS_FOR(SportsClub sportsClub) {
	...
	public WORKS_FOR(SportsOrganization sportsOrganization) {
	...
	public WORKS_FOR(SportsTeam sportsTeam) {
	...
	public WORKS_FOR(StadiumOrArena stadiumOrArena) {
	...
	public WORKS_FOR(TattooParlor tattooParlor) {
	...
	public WORKS_FOR(TelevisionStation televisionStation) {
	...
	public WORKS_FOR(TennisComplex tennisComplex) {
	...
	public WORKS_FOR(TheaterGroup theaterGroup) {
	...
	public WORKS_FOR(TireShop tireShop) {
	...
	public WORKS_FOR(TouristInformationCenter touristInformationCenter) {
	...
	public WORKS_FOR(ToyStore toyStore) {
	...
	public WORKS_FOR(TravelAgency travelAgency) {
	...
	public WORKS_FOR(VeterinaryCare veterinaryCare) {
	...
	public WORKS_FOR(WholesaleStore wholesaleStore) {
	...
	public WORKS_FOR(Winery winery) {
	...
	public WORKS_FOR(WorkersUnion workersUnion) {
	...
	public void copy(Container.WorksFor org) {
