...
public class PHOTOGRAPH_ACTION implements Clazz.PhotographAction {
	...
	public PHOTOGRAPH_ACTION() {
	}

	public PHOTOGRAPH_ACTION(Long seq) {
		setSeq(seq);
	}

	public PHOTOGRAPH_ACTION(String string) {
	...
	public PHOTOGRAPH_ACTION(ActionStatus actionStatus) {
	...
	public PHOTOGRAPH_ACTION(AdditionalType additionalType) {
	...
	public PHOTOGRAPH_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public PHOTOGRAPH_ACTION(AlternateName alternateName) {
	...
	public PHOTOGRAPH_ACTION(Description description) {
	...
	public PHOTOGRAPH_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public PHOTOGRAPH_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public PHOTOGRAPH_ACTION(Error error) {
		setError(error);
	}
	...
	public PHOTOGRAPH_ACTION(Identifier identifier) {
	...
	public PHOTOGRAPH_ACTION(Image image) {
		setImage(image);
	}
	...
	public PHOTOGRAPH_ACTION(Instrument instrument) {
	...
	public PHOTOGRAPH_ACTION(Location location) {
	...
	public PHOTOGRAPH_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public PHOTOGRAPH_ACTION(Name name) {
		setName(name);
	}
	...
	public PHOTOGRAPH_ACTION(NameFuzzy nameFuzzy) {
	...
	public PHOTOGRAPH_ACTION(NameRuby nameRuby) {
	...
	public PHOTOGRAPH_ACTION(Object object) {
		setObject(object);
	}
	...
	public PHOTOGRAPH_ACTION(Participant participant) {
	...
	public PHOTOGRAPH_ACTION(PotentialAction potentialAction) {
	...
	public PHOTOGRAPH_ACTION(Result result) {
		setResult(result);
	}
	...
	public PHOTOGRAPH_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PHOTOGRAPH_ACTION(StartTime startTime) {
	...
	public PHOTOGRAPH_ACTION(SubjectOf subjectOf) {
	...
	public PHOTOGRAPH_ACTION(Target target) {
		setTarget(target);
	}
	...
	public PHOTOGRAPH_ACTION(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.PhotographAction org) {
		setSeq(org.getSeq());
