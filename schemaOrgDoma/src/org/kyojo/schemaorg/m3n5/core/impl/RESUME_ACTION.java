...
public class RESUME_ACTION implements Clazz.ResumeAction {
	...
	public RESUME_ACTION(Long seq) {
		setSeq(seq);
	}

	public RESUME_ACTION(String string) {
	...
	public RESUME_ACTION(ActionStatus actionStatus) {
	...
	public RESUME_ACTION(AdditionalType additionalType) {
	...
	public RESUME_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public RESUME_ACTION(AlternateName alternateName) {
	...
	public RESUME_ACTION(Description description) {
	...
	public RESUME_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public RESUME_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public RESUME_ACTION(Error error) {
		setError(error);
	}
	...
	public RESUME_ACTION(Identifier identifier) {
	...
	public RESUME_ACTION(Image image) {
		setImage(image);
	}
	...
	public RESUME_ACTION(Instrument instrument) {
	...
	public RESUME_ACTION(Location location) {
	...
	public RESUME_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public RESUME_ACTION(Name name) {
		setName(name);
	}
	...
	public RESUME_ACTION(NameFuzzy nameFuzzy) {
	...
	public RESUME_ACTION(NameRuby nameRuby) {
	...
	public RESUME_ACTION(Object object) {
		setObject(object);
	}
	...
	public RESUME_ACTION(Participant participant) {
	...
	public RESUME_ACTION(PotentialAction potentialAction) {
	...
	public RESUME_ACTION(Result result) {
		setResult(result);
	}
	...
	public RESUME_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RESUME_ACTION(StartTime startTime) {
	...
	public RESUME_ACTION(SubjectOf subjectOf) {
	...
	public RESUME_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.ResumeAction org) {
		setSeq(org.getSeq());
