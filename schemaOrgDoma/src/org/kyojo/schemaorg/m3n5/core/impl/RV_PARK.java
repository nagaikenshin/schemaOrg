...
public class RV_PARK implements Clazz.RVPark {
	...
	public RV_PARK(GeoContains geoContains) {
	...
	public RV_PARK(GeoCoveredBy geoCoveredBy) {
	...
	public RV_PARK(GeoCovers geoCovers) {
	...
	public RV_PARK(GeoCrosses geoCrosses) {
	...
	public RV_PARK(GeoDisjoint geoDisjoint) {
	...
	public RV_PARK(GeoEquals geoEquals) {
	...
	public RV_PARK(GeoIntersects geoIntersects) {
	...
	public RV_PARK(GeoOverlaps geoOverlaps) {
	...
	public RV_PARK(GeoTouches geoTouches) {
	...
	public RV_PARK(GeoWithin geoWithin) {
