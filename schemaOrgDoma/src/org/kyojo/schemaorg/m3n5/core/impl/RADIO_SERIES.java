...
public class RADIO_SERIES implements Clazz.RadioSeries {
	...
	public RADIO_SERIES(Long seq) {
		setSeq(seq);
	}

	public RADIO_SERIES(String string) {
	...
	public RADIO_SERIES(About about) {
		setAbout(about);
	}
	...
	public RADIO_SERIES(AccessMode accessMode) {
	...
	public RADIO_SERIES(AccessModeSufficient accessModeSufficient) {
	...
	public RADIO_SERIES(AccessibilityAPI accessibilityAPI) {
	...
	public RADIO_SERIES(AccessibilityControl accessibilityControl) {
	...
	public RADIO_SERIES(AccessibilityFeature accessibilityFeature) {
	...
	public RADIO_SERIES(AccessibilityHazard accessibilityHazard) {
	...
	public RADIO_SERIES(AccessibilitySummary accessibilitySummary) {
	...
	public RADIO_SERIES(AccountablePerson accountablePerson) {
	...
	public RADIO_SERIES(Actor actor) {
		setActor(actor);
	}
	...
	public RADIO_SERIES(AdditionalType additionalType) {
	...
	public RADIO_SERIES(AggregateRating aggregateRating) {
	...
	public RADIO_SERIES(AlternateName alternateName) {
	...
	public RADIO_SERIES(AlternativeHeadline alternativeHeadline) {
	...
	public RADIO_SERIES(AssociatedMedia associatedMedia) {
	...
	public RADIO_SERIES(Audience audience) {
	...
	public RADIO_SERIES(Audio audio) {
		setAudio(audio);
	}
	...
	public RADIO_SERIES(Author author) {
		setAuthor(author);
	}
	...
	public RADIO_SERIES(Award award) {
		setAward(award);
	}
	...
	public RADIO_SERIES(Character character) {
	...
	public RADIO_SERIES(Citation citation) {
	...
	public RADIO_SERIES(Comment comment) {
		setComment(comment);
	}
	...
	public RADIO_SERIES(CommentCount commentCount) {
	...
	public RADIO_SERIES(ContainsSeason containsSeason) {
	...
	public RADIO_SERIES(ContentLocation contentLocation) {
	...
	public RADIO_SERIES(ContentRating contentRating) {
	...
	public RADIO_SERIES(ContentReferenceTime contentReferenceTime) {
	...
	public RADIO_SERIES(Contributor contributor) {
	...
	public RADIO_SERIES(CopyrightHolder copyrightHolder) {
	...
	public RADIO_SERIES(CopyrightYear copyrightYear) {
	...
	public RADIO_SERIES(Correction correction) {
	...
	public RADIO_SERIES(Creator creator) {
		setCreator(creator);
	}
	...
	public RADIO_SERIES(DateCreated dateCreated) {
	...
	public RADIO_SERIES(DateModified dateModified) {
	...
	public RADIO_SERIES(DatePublished datePublished) {
	...
	public RADIO_SERIES(Description description) {
	...
	public RADIO_SERIES(Director director) {
	...
	public RADIO_SERIES(DisambiguatingDescription disambiguatingDescription) {
	...
	public RADIO_SERIES(DiscussionUrl discussionUrl) {
	...
	public RADIO_SERIES(Editor editor) {
		setEditor(editor);
	}
	...
	public RADIO_SERIES(EducationalAlignment educationalAlignment) {
	...
	public RADIO_SERIES(EducationalUse educationalUse) {
	...
	public RADIO_SERIES(Encoding encoding) {
	...
	public RADIO_SERIES(EncodingFormat encodingFormat) {
	...
	public RADIO_SERIES(EndDate endDate) {
		setEndDate(endDate);
	}
	...
	public RADIO_SERIES(Episode episode) {
		setEpisode(episode);
	}
	...
	public RADIO_SERIES(ExampleOfWork exampleOfWork) {
	...
	public RADIO_SERIES(Expires expires) {
		setExpires(expires);
	}
	...
	public RADIO_SERIES(Funder funder) {
		setFunder(funder);
	}
	...
	public RADIO_SERIES(Genre genre) {
		setGenre(genre);
	}
	...
	public RADIO_SERIES(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public RADIO_SERIES(Headline headline) {
	...
	public RADIO_SERIES(Identifier identifier) {
	...
	public RADIO_SERIES(Image image) {
		setImage(image);
	}
	...
	public RADIO_SERIES(InLanguage inLanguage) {
	...
	public RADIO_SERIES(InteractionStatistic interactionStatistic) {
	...
	public RADIO_SERIES(InteractivityType interactivityType) {
	...
	public RADIO_SERIES(IsAccessibleForFree isAccessibleForFree) {
	...
	public RADIO_SERIES(IsBasedOn isBasedOn) {
	...
	public RADIO_SERIES(IsFamilyFriendly isFamilyFriendly) {
	...
	public RADIO_SERIES(IsPartOf isPartOf) {
	...
	public RADIO_SERIES(Keywords keywords) {
	...
	public RADIO_SERIES(LearningResourceType learningResourceType) {
	...
	public RADIO_SERIES(License license) {
		setLicense(license);
	}
	...
	public RADIO_SERIES(LocationCreated locationCreated) {
	...
	public RADIO_SERIES(MainEntity mainEntity) {
	...
	public RADIO_SERIES(MainEntityOfPage mainEntityOfPage) {
	...
	public RADIO_SERIES(Material material) {
	...
	public RADIO_SERIES(MaterialExtent materialExtent) {
	...
	public RADIO_SERIES(Mentions mentions) {
	...
	public RADIO_SERIES(MusicBy musicBy) {
		setMusicBy(musicBy);
	}
	...
	public RADIO_SERIES(NameFuzzy nameFuzzy) {
	...
	public RADIO_SERIES(NameRuby nameRuby) {
	...
	public RADIO_SERIES(NumberOfEpisodes numberOfEpisodes) {
	...
	public RADIO_SERIES(NumberOfSeasons numberOfSeasons) {
	...
	public RADIO_SERIES(Offers offers) {
		setOffers(offers);
	}
	...
	public RADIO_SERIES(Position position) {
	...
	public RADIO_SERIES(PotentialAction potentialAction) {
	...
	public RADIO_SERIES(Producer producer) {
	...
	public RADIO_SERIES(ProductionCompany productionCompany) {
	...
	public RADIO_SERIES(Provider provider) {
	...
	public RADIO_SERIES(Publication publication) {
	...
	public RADIO_SERIES(Publisher publisher) {
	...
	public RADIO_SERIES(PublisherImprint publisherImprint) {
	...
	public RADIO_SERIES(PublishingPrinciples publishingPrinciples) {
	...
	public RADIO_SERIES(RecordedAt recordedAt) {
	...
	public RADIO_SERIES(ReleasedEvent releasedEvent) {
	...
	public RADIO_SERIES(Review review) {
		setReview(review);
	}
	...
	public RADIO_SERIES(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RADIO_SERIES(SchemaVersion schemaVersion) {
	...
	public RADIO_SERIES(SdDatePublished sdDatePublished) {
	...
	public RADIO_SERIES(SdLicense sdLicense) {
	...
	public RADIO_SERIES(SdPublisher sdPublisher) {
	...
	public RADIO_SERIES(SourceOrganization sourceOrganization) {
	...
	public RADIO_SERIES(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public RADIO_SERIES(SpatialCoverage spatialCoverage) {
	...
	public RADIO_SERIES(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public RADIO_SERIES(StartDate startDate) {
	...
	public RADIO_SERIES(SubjectOf subjectOf) {
	...
	public RADIO_SERIES(Temporal temporal) {
	...
	public RADIO_SERIES(TemporalCoverage temporalCoverage) {
	...
	public RADIO_SERIES(ThumbnailUrl thumbnailUrl) {
	...
	public RADIO_SERIES(TimeRequired timeRequired) {
	...
	public RADIO_SERIES(Trailer trailer) {
		setTrailer(trailer);
	}
	...
	public RADIO_SERIES(TranslationOfWork translationOfWork) {
	...
	public RADIO_SERIES(Translator translator) {
	...
	public RADIO_SERIES(TypicalAgeRange typicalAgeRange) {
	...
	public RADIO_SERIES(Version version) {
		setVersion(version);
	}
	...
	public RADIO_SERIES(Video video) {
		setVideo(video);
	}
	...
	public RADIO_SERIES(WorkExample workExample) {
	...
	public RADIO_SERIES(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.RadioSeries org) {
		setSeq(org.getSeq());
