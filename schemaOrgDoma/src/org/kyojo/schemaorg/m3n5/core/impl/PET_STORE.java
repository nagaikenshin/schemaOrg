...
public class PET_STORE implements Clazz.PetStore {
	...
	public PET_STORE(GeoContains geoContains) {
	...
	public PET_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public PET_STORE(GeoCovers geoCovers) {
	...
	public PET_STORE(GeoCrosses geoCrosses) {
	...
	public PET_STORE(GeoDisjoint geoDisjoint) {
	...
	public PET_STORE(GeoEquals geoEquals) {
	...
	public PET_STORE(GeoIntersects geoIntersects) {
	...
	public PET_STORE(GeoOverlaps geoOverlaps) {
	...
	public PET_STORE(GeoTouches geoTouches) {
	...
	public PET_STORE(GeoWithin geoWithin) {
	...
	public PET_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
