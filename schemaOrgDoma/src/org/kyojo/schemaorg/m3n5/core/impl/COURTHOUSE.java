...
public class COURTHOUSE implements Clazz.Courthouse {
	...
	public COURTHOUSE(GeoContains geoContains) {
	...
	public COURTHOUSE(GeoCoveredBy geoCoveredBy) {
	...
	public COURTHOUSE(GeoCovers geoCovers) {
	...
	public COURTHOUSE(GeoCrosses geoCrosses) {
	...
	public COURTHOUSE(GeoDisjoint geoDisjoint) {
	...
	public COURTHOUSE(GeoEquals geoEquals) {
	...
	public COURTHOUSE(GeoIntersects geoIntersects) {
	...
	public COURTHOUSE(GeoOverlaps geoOverlaps) {
	...
	public COURTHOUSE(GeoTouches geoTouches) {
	...
	public COURTHOUSE(GeoWithin geoWithin) {
	...
	public COURTHOUSE(Slogan slogan) {
		setSlogan(slogan);
	}
