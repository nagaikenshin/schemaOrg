...
public class READ_ACTION implements Clazz.ReadAction {
	...
	public READ_ACTION(Long seq) {
		setSeq(seq);
	}

	public READ_ACTION(String string) {
	...
	public READ_ACTION(ActionAccessibilityRequirement actionAccessibilityRequirement) {
	...
	public READ_ACTION(ActionStatus actionStatus) {
	...
	public READ_ACTION(AdditionalType additionalType) {
	...
	public READ_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public READ_ACTION(AlternateName alternateName) {
	...
	public READ_ACTION(Description description) {
	...
	public READ_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public READ_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public READ_ACTION(Error error) {
		setError(error);
	}
	...
	public READ_ACTION(ExpectsAcceptanceOf expectsAcceptanceOf) {
	...
	public READ_ACTION(Identifier identifier) {
	...
	public READ_ACTION(Image image) {
		setImage(image);
	}
	...
	public READ_ACTION(Instrument instrument) {
	...
	public READ_ACTION(Location location) {
	...
	public READ_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public READ_ACTION(NameFuzzy nameFuzzy) {
	...
	public READ_ACTION(NameRuby nameRuby) {
	...
	public READ_ACTION(Object object) {
		setObject(object);
	}
	...
	public READ_ACTION(Participant participant) {
	...
	public READ_ACTION(PotentialAction potentialAction) {
	...
	public READ_ACTION(Result result) {
		setResult(result);
	}
	...
	public READ_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public READ_ACTION(StartTime startTime) {
	...
	public READ_ACTION(SubjectOf subjectOf) {
	...
	public READ_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.ReadAction org) {
		setSeq(org.getSeq());
