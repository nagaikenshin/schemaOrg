...
public class BUY_ACTION implements Clazz.BuyAction {
	...
	public BUY_ACTION(Long seq) {
		setSeq(seq);
	}

	public BUY_ACTION(String string) {
	...
	public BUY_ACTION(ActionStatus actionStatus) {
	...
	public BUY_ACTION(AdditionalType additionalType) {
	...
	public BUY_ACTION(AlternateName alternateName) {
	...
	public BUY_ACTION(Description description) {
	...
	public BUY_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public BUY_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public BUY_ACTION(Identifier identifier) {
	...
	public BUY_ACTION(Instrument instrument) {
	...
	public BUY_ACTION(Location location) {
	...
	public BUY_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public BUY_ACTION(NameFuzzy nameFuzzy) {
	...
	public BUY_ACTION(NameRuby nameRuby) {
	...
	public BUY_ACTION(Object object) {
		setObject(object);
	}
	...
	public BUY_ACTION(Participant participant) {
	...
	public BUY_ACTION(PotentialAction potentialAction) {
	...
	public BUY_ACTION(PriceCurrency priceCurrency) {
	...
	public BUY_ACTION(PriceSpecification priceSpecification) {
	...
	public BUY_ACTION(Result result) {
		setResult(result);
	}
	...
	public BUY_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public BUY_ACTION(Seller seller) {
		setSeller(seller);
	}
	...
	public BUY_ACTION(StartTime startTime) {
	...
	public BUY_ACTION(SubjectOf subjectOf) {
	...
	public BUY_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.BuyAction org) {
		setSeq(org.getSeq());
