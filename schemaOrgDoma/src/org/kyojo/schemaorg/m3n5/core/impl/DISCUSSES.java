...
public class DISCUSSES implements Container.Discusses {
	...
	public DISCUSSES(APIReference apiReference) {
	...
	public DISCUSSES(AboutPage aboutPage) {
	...
	public DISCUSSES(AdvertiserContentArticle advertiserContentArticle) {
	...
	public DISCUSSES(AnalysisNewsArticle analysisNewsArticle) {
	...
	public DISCUSSES(Answer answer) {
	...
	public DISCUSSES(ArchiveComponent archiveComponent) {
	...
	public DISCUSSES(Article article) {
	...
	public DISCUSSES(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public DISCUSSES(AudioObject audioObject) {
	...
	public DISCUSSES(Audiobook audiobook) {
	...
	public DISCUSSES(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public DISCUSSES(Barcode barcode) {
	...
	public DISCUSSES(BlogPosting blogPosting) {
	...
	public DISCUSSES(BookSeries bookSeries) {
	...
	public DISCUSSES(CategoryCodeSet categoryCodeSet) {
	...
	public DISCUSSES(Chapter chapter) {
	...
	public DISCUSSES(CheckoutPage checkoutPage) {
	...
	public DISCUSSES(ClaimReview claimReview) {
	...
	public DISCUSSES(Collection collection) {
	...
	public DISCUSSES(CollectionPage collectionPage) {
	...
	public DISCUSSES(ComicCoverArt comicCoverArt) {
	...
	public DISCUSSES(ComicIssue comicIssue) {
	...
	public DISCUSSES(ComicSeries comicSeries) {
	...
	public DISCUSSES(ComicStory comicStory) {
	...
	public DISCUSSES(Comment comment) {
	...
	public DISCUSSES(CompleteDataFeed completeDataFeed) {
	...
	public DISCUSSES(ContactPage contactPage) {
	...
	public DISCUSSES(Conversation conversation) {
	...
	public DISCUSSES(CorrectionComment correctionComment) {
	...
	public DISCUSSES(Course course) {
	...
	public DISCUSSES(CoverArt coverArt) {
	...
	public DISCUSSES(CreativeWorkSeason creativeWorkSeason) {
	...
	public DISCUSSES(CreativeWorkSeries creativeWorkSeries) {
	...
	public DISCUSSES(CriticReview criticReview) {
	...
	public DISCUSSES(DataCatalog dataCatalog) {
	...
	public DISCUSSES(DataDownload dataDownload) {
	...
	public DISCUSSES(DataFeed dataFeed) {
	...
	public DISCUSSES(Dataset dataset) {
	...
	public DISCUSSES(DefinedTermSet definedTermSet) {
	...
	public DISCUSSES(DigitalDocument digitalDocument) {
	...
	public DISCUSSES(DiscussionForumPosting discussionForumPosting) {
	...
	public DISCUSSES(Drawing drawing) {
	...
	public DISCUSSES(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public DISCUSSES(EmailMessage emailMessage) {
	...
	public DISCUSSES(EmployerReview employerReview) {
	...
	public DISCUSSES(Episode episode) {
	...
	public DISCUSSES(ExercisePlan exercisePlan) {
	...
	public DISCUSSES(FAQPage faqPage) {
	...
	public DISCUSSES(HowToDirection howToDirection) {
	...
	public DISCUSSES(HowToSection howToSection) {
	...
	public DISCUSSES(HowToStep howToStep) {
	...
	public DISCUSSES(HowToTip howToTip) {
	...
	public DISCUSSES(ImageGallery imageGallery) {
	...
	public DISCUSSES(ImageObject imageObject) {
	...
	public DISCUSSES(ItemPage itemPage) {
	...
	public DISCUSSES(Legislation legislation) {
	...
	public DISCUSSES(LegislationObject legislationObject) {
	...
	public DISCUSSES(LiveBlogPosting liveBlogPosting) {
	...
	public DISCUSSES(Manuscript manuscript) {
	...
	public DISCUSSES(MediaObject mediaObject) {
	...
	public DISCUSSES(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public DISCUSSES(MedicalWebPage medicalWebPage) {
	...
	public DISCUSSES(MenuSection menuSection) {
	...
	public DISCUSSES(Message message) {
	...
	public DISCUSSES(MobileApplication mobileApplication) {
	...
	public DISCUSSES(MovieClip movieClip) {
	...
	public DISCUSSES(MovieSeries movieSeries) {
	...
	public DISCUSSES(MusicAlbum musicAlbum) {
	...
	public DISCUSSES(MusicComposition musicComposition) {
	...
	public DISCUSSES(MusicPlaylist musicPlaylist) {
	...
	public DISCUSSES(MusicRecording musicRecording) {
	...
	public DISCUSSES(MusicRelease musicRelease) {
	...
	public DISCUSSES(MusicVideoObject musicVideoObject) {
	...
	public DISCUSSES(NewsArticle newsArticle) {
	...
	public DISCUSSES(Newspaper newspaper) {
	...
	public DISCUSSES(NoteDigitalDocument noteDigitalDocument) {
	...
	public DISCUSSES(OpinionNewsArticle opinionNewsArticle) {
	...
	public DISCUSSES(Painting painting) {
	...
	public DISCUSSES(Periodical periodical) {
	...
	public DISCUSSES(Photograph photograph) {
	...
	public DISCUSSES(Poster poster) {
	...
	public DISCUSSES(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public DISCUSSES(ProfilePage profilePage) {
	...
	public DISCUSSES(PublicationIssue publicationIssue) {
	...
	public DISCUSSES(PublicationVolume publicationVolume) {
	...
	public DISCUSSES(QAPage qaPage) {
	...
	public DISCUSSES(Question question) {
	...
	public DISCUSSES(Quotation quotation) {
	...
	public DISCUSSES(RadioClip radioClip) {
	...
	public DISCUSSES(RadioEpisode radioEpisode) {
	...
	public DISCUSSES(RadioSeason radioSeason) {
	...
	public DISCUSSES(RadioSeries radioSeries) {
	...
	public DISCUSSES(Recipe recipe) {
	...
	public DISCUSSES(Report report) {
	...
	public DISCUSSES(ReportageNewsArticle reportageNewsArticle) {
	...
	public DISCUSSES(Review review) {
	...
	public DISCUSSES(ReviewNewsArticle reviewNewsArticle) {
	...
	public DISCUSSES(SatiricalArticle satiricalArticle) {
	...
	public DISCUSSES(ScholarlyArticle scholarlyArticle) {
	...
	public DISCUSSES(Sculpture sculpture) {
	...
	public DISCUSSES(SearchResultsPage searchResultsPage) {
	...
	public DISCUSSES(SheetMusic sheetMusic) {
	...
	public DISCUSSES(ShortStory shortStory) {
	...
	public DISCUSSES(SiteNavigationElement siteNavigationElement) {
	...
	public DISCUSSES(SocialMediaPosting socialMediaPosting) {
	...
	public DISCUSSES(SoftwareApplication softwareApplication) {
	...
	public DISCUSSES(SoftwareSourceCode softwareSourceCode) {
	...
	public DISCUSSES(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public DISCUSSES(TVClip tvClip) {
	...
	public DISCUSSES(TVEpisode tvEpisode) {
	...
	public DISCUSSES(TVSeason tvSeason) {
	...
	public DISCUSSES(TVSeries tvSeries) {
	...
	public DISCUSSES(TechArticle techArticle) {
	...
	public DISCUSSES(TextDigitalDocument textDigitalDocument) {
	...
	public DISCUSSES(Thesis thesis) {
	...
	public DISCUSSES(ThreeDimensionalModel threeDimensionalModel) {
	...
	public DISCUSSES(UserReview userReview) {
	...
	public DISCUSSES(VideoGallery videoGallery) {
	...
	public DISCUSSES(VideoGame videoGame) {
	...
	public DISCUSSES(VideoGameClip videoGameClip) {
	...
	public DISCUSSES(VideoGameSeries videoGameSeries) {
	...
	public DISCUSSES(VideoObject videoObject) {
	...
	public DISCUSSES(VisualArtwork visualArtwork) {
	...
	public DISCUSSES(WPAdBlock wpAdBlock) {
	...
	public DISCUSSES(WPFooter wpFooter) {
	...
	public DISCUSSES(WPHeader wpHeader) {
	...
	public DISCUSSES(WPSideBar wpSideBar) {
	...
	public DISCUSSES(WebApplication webApplication) {
	...
	public DISCUSSES(WebPage webPage) {
	...
	public DISCUSSES(WebPageElement webPageElement) {
	...
	public DISCUSSES(WebSite webSite) {
	...
	public void copy(Container.Discusses org) {
