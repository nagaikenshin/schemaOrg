...
public class PHYSICIAN implements Clazz.Physician {
	...
	public PHYSICIAN(GeoContains geoContains) {
	...
	public PHYSICIAN(GeoCoveredBy geoCoveredBy) {
	...
	public PHYSICIAN(GeoCovers geoCovers) {
	...
	public PHYSICIAN(GeoCrosses geoCrosses) {
	...
	public PHYSICIAN(GeoDisjoint geoDisjoint) {
	...
	public PHYSICIAN(GeoEquals geoEquals) {
	...
	public PHYSICIAN(GeoIntersects geoIntersects) {
	...
	public PHYSICIAN(GeoOverlaps geoOverlaps) {
	...
	public PHYSICIAN(GeoTouches geoTouches) {
	...
	public PHYSICIAN(GeoWithin geoWithin) {
	...
	public PHYSICIAN(Slogan slogan) {
		setSlogan(slogan);
	}
