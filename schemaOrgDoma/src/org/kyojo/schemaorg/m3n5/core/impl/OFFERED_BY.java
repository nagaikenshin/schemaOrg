...
public class OFFERED_BY implements Container.OfferedBy {
	...
	public OFFERED_BY(String string) {
	...
	public OFFERED_BY(AccountingService accountingService) {
	...
	public OFFERED_BY(AdultEntertainment adultEntertainment) {
	...
	public OFFERED_BY(Airline airline) {
	...
	public OFFERED_BY(AmusementPark amusementPark) {
	...
	public OFFERED_BY(AnimalShelter animalShelter) {
	...
	public OFFERED_BY(ArchiveOrganization archiveOrganization) {
	...
	public OFFERED_BY(ArtGallery artGallery) {
	...
	public OFFERED_BY(Attorney attorney) {
	...
	public OFFERED_BY(AutoBodyShop autoBodyShop) {
	...
	public OFFERED_BY(AutoDealer autoDealer) {
	...
	public OFFERED_BY(AutoPartsStore autoPartsStore) {
	...
	public OFFERED_BY(AutoRental autoRental) {
	...
	public OFFERED_BY(AutoRepair autoRepair) {
	...
	public OFFERED_BY(AutoWash autoWash) {
	...
	public OFFERED_BY(AutomatedTeller automatedTeller) {
	...
	public OFFERED_BY(AutomotiveBusiness automotiveBusiness) {
	...
	public OFFERED_BY(Bakery bakery) {
	...
	public OFFERED_BY(BankOrCreditUnion bankOrCreditUnion) {
	...
	public OFFERED_BY(BarOrPub barOrPub) {
	...
	public OFFERED_BY(BeautySalon beautySalon) {
	...
	public OFFERED_BY(BedAndBreakfast bedAndBreakfast) {
	...
	public OFFERED_BY(BikeStore bikeStore) {
	...
	public OFFERED_BY(BookStore bookStore) {
	...
	public OFFERED_BY(BowlingAlley bowlingAlley) {
	...
	public OFFERED_BY(Brewery brewery) {
	...
	public OFFERED_BY(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public OFFERED_BY(Campground campground) {
	...
	public OFFERED_BY(Casino casino) {
	...
	public OFFERED_BY(ChildCare childCare) {
	...
	public OFFERED_BY(ClothingStore clothingStore) {
	...
	public OFFERED_BY(CollegeOrUniversity collegeOrUniversity) {
	...
	public OFFERED_BY(ComedyClub comedyClub) {
	...
	public OFFERED_BY(CommunityHealth communityHealth) {
	...
	public OFFERED_BY(ComputerStore computerStore) {
	...
	public OFFERED_BY(Consortium consortium) {
	...
	public OFFERED_BY(ConvenienceStore convenienceStore) {
	...
	public OFFERED_BY(Corporation corporation) {
	...
	public OFFERED_BY(DanceGroup danceGroup) {
	...
	public OFFERED_BY(DaySpa daySpa) {
	...
	public OFFERED_BY(Dentist dentist) {
	...
	public OFFERED_BY(DepartmentStore departmentStore) {
	...
	public OFFERED_BY(Dermatology dermatology) {
	...
	public OFFERED_BY(DiagnosticLab diagnosticLab) {
	...
	public OFFERED_BY(DietNutrition dietNutrition) {
	...
	public OFFERED_BY(Distillery distillery) {
	...
	public OFFERED_BY(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public OFFERED_BY(EducationalOrganization educationalOrganization) {
	...
	public OFFERED_BY(Electrician electrician) {
	...
	public OFFERED_BY(ElectronicsStore electronicsStore) {
	...
	public OFFERED_BY(ElementarySchool elementarySchool) {
	...
	public OFFERED_BY(Emergency emergency) {
	...
	public OFFERED_BY(EmergencyService emergencyService) {
	...
	public OFFERED_BY(EmploymentAgency employmentAgency) {
	...
	public OFFERED_BY(EntertainmentBusiness entertainmentBusiness) {
	...
	public OFFERED_BY(ExerciseGym exerciseGym) {
	...
	public OFFERED_BY(FastFoodRestaurant fastFoodRestaurant) {
	...
	public OFFERED_BY(FinancialService financialService) {
	...
	public OFFERED_BY(FireStation fireStation) {
	...
	public OFFERED_BY(Florist florist) {
	...
	public OFFERED_BY(FoodEstablishment foodEstablishment) {
	...
	public OFFERED_BY(FundingAgency fundingAgency) {
	...
	public OFFERED_BY(FundingScheme fundingScheme) {
	...
	public OFFERED_BY(FurnitureStore furnitureStore) {
	...
	public OFFERED_BY(GardenStore gardenStore) {
	...
	public OFFERED_BY(GasStation gasStation) {
	...
	public OFFERED_BY(GeneralContractor generalContractor) {
	...
	public OFFERED_BY(Geriatric geriatric) {
	...
	public OFFERED_BY(GolfCourse golfCourse) {
	...
	public OFFERED_BY(GovernmentOffice governmentOffice) {
	...
	public OFFERED_BY(GovernmentOrganization governmentOrganization) {
	...
	public OFFERED_BY(GroceryStore groceryStore) {
	...
	public OFFERED_BY(Gynecologic gynecologic) {
	...
	public OFFERED_BY(HVACBusiness hvacBusiness) {
	...
	public OFFERED_BY(HairSalon hairSalon) {
	...
	public OFFERED_BY(HardwareStore hardwareStore) {
	...
	public OFFERED_BY(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public OFFERED_BY(HealthClub healthClub) {
	...
	public OFFERED_BY(HighSchool highSchool) {
	...
	public OFFERED_BY(HobbyShop hobbyShop) {
	...
	public OFFERED_BY(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public OFFERED_BY(HomeGoodsStore homeGoodsStore) {
	...
	public OFFERED_BY(Hospital hospital) {
	...
	public OFFERED_BY(Hostel hostel) {
	...
	public OFFERED_BY(HousePainter housePainter) {
	...
	public OFFERED_BY(IceCreamShop iceCreamShop) {
	...
	public OFFERED_BY(InsuranceAgency insuranceAgency) {
	...
	public OFFERED_BY(InternetCafe internetCafe) {
	...
	public OFFERED_BY(JewelryStore jewelryStore) {
	...
	public OFFERED_BY(LegalService legalService) {
	...
	public OFFERED_BY(Library library) {
	...
	public OFFERED_BY(LibrarySystem librarySystem) {
	...
	public OFFERED_BY(LiquorStore liquorStore) {
	...
	public OFFERED_BY(LocalBusiness localBusiness) {
	...
	public OFFERED_BY(Locksmith locksmith) {
	...
	public OFFERED_BY(LodgingBusiness lodgingBusiness) {
	...
	public OFFERED_BY(MedicalBusiness medicalBusiness) {
	...
	public OFFERED_BY(MedicalClinic medicalClinic) {
	...
	public OFFERED_BY(MedicalOrganization medicalOrganization) {
	...
	public OFFERED_BY(MensClothingStore mensClothingStore) {
	...
	public OFFERED_BY(MiddleSchool middleSchool) {
	...
	public OFFERED_BY(Midwifery midwifery) {
	...
	public OFFERED_BY(MobilePhoneStore mobilePhoneStore) {
	...
	public OFFERED_BY(MotorcycleDealer motorcycleDealer) {
	...
	public OFFERED_BY(MotorcycleRepair motorcycleRepair) {
	...
	public OFFERED_BY(MovieRentalStore movieRentalStore) {
	...
	public OFFERED_BY(MovieTheater movieTheater) {
	...
	public OFFERED_BY(MovingCompany movingCompany) {
	...
	public OFFERED_BY(MusicGroup musicGroup) {
	...
	public OFFERED_BY(MusicStore musicStore) {
	...
	public OFFERED_BY(NailSalon nailSalon) {
	...
	public OFFERED_BY(NewsMediaOrganization newsMediaOrganization) {
	...
	public OFFERED_BY(NightClub nightClub) {
	...
	public OFFERED_BY(Notary notary) {
	...
	public OFFERED_BY(Nursing nursing) {
	...
	public OFFERED_BY(Obstetric obstetric) {
	...
	public OFFERED_BY(OfficeEquipmentStore officeEquipmentStore) {
	...
	public OFFERED_BY(Oncologic oncologic) {
	...
	public OFFERED_BY(Optician optician) {
	...
	public OFFERED_BY(Optometric optometric) {
	...
	public OFFERED_BY(Organization organization) {
		organizationList = new ArrayList<Organization>();
	...
	public OFFERED_BY(Otolaryngologic otolaryngologic) {
	...
	public OFFERED_BY(OutletStore outletStore) {
	...
	public OFFERED_BY(Patient patient) {
	...
	public OFFERED_BY(PawnShop pawnShop) {
	...
	public OFFERED_BY(Pediatric pediatric) {
	...
	public OFFERED_BY(PerformingGroup performingGroup) {
	...
	public OFFERED_BY(Person person) {
	...
	public OFFERED_BY(PetStore petStore) {
	...
	public OFFERED_BY(Pharmacy pharmacy) {
	...
	public OFFERED_BY(Physician physician) {
	...
	public OFFERED_BY(Physiotherapy physiotherapy) {
	...
	public OFFERED_BY(PlasticSurgery plasticSurgery) {
	...
	public OFFERED_BY(Plumber plumber) {
	...
	public OFFERED_BY(Podiatric podiatric) {
	...
	public OFFERED_BY(PoliceStation policeStation) {
	...
	public OFFERED_BY(PostOffice postOffice) {
	...
	public OFFERED_BY(Preschool preschool) {
	...
	public OFFERED_BY(PrimaryCare primaryCare) {
	...
	public OFFERED_BY(ProfessionalService professionalService) {
	...
	public OFFERED_BY(Project project) {
	...
	public OFFERED_BY(Psychiatric psychiatric) {
	...
	public OFFERED_BY(PublicHealth publicHealth) {
	...
	public OFFERED_BY(PublicSwimmingPool publicSwimmingPool) {
	...
	public OFFERED_BY(RadioStation radioStation) {
	...
	public OFFERED_BY(RealEstateAgent realEstateAgent) {
	...
	public OFFERED_BY(RecyclingCenter recyclingCenter) {
	...
	public OFFERED_BY(ResearchProject researchProject) {
	...
	public OFFERED_BY(Resort resort) {
	...
	public OFFERED_BY(Restaurant restaurant) {
	...
	public OFFERED_BY(RoofingContractor roofingContractor) {
	...
	public OFFERED_BY(School school) {
	...
	public OFFERED_BY(SelfStorage selfStorage) {
	...
	public OFFERED_BY(ShoeStore shoeStore) {
	...
	public OFFERED_BY(ShoppingCenter shoppingCenter) {
	...
	public OFFERED_BY(SkiResort skiResort) {
	...
	public OFFERED_BY(SportingGoodsStore sportingGoodsStore) {
	...
	public OFFERED_BY(SportsActivityLocation sportsActivityLocation) {
	...
	public OFFERED_BY(SportsClub sportsClub) {
	...
	public OFFERED_BY(SportsOrganization sportsOrganization) {
	...
	public OFFERED_BY(SportsTeam sportsTeam) {
	...
	public OFFERED_BY(StadiumOrArena stadiumOrArena) {
	...
	public OFFERED_BY(TattooParlor tattooParlor) {
	...
	public OFFERED_BY(TelevisionStation televisionStation) {
	...
	public OFFERED_BY(TennisComplex tennisComplex) {
	...
	public OFFERED_BY(TheaterGroup theaterGroup) {
	...
	public OFFERED_BY(TireShop tireShop) {
	...
	public OFFERED_BY(TouristInformationCenter touristInformationCenter) {
	...
	public OFFERED_BY(ToyStore toyStore) {
	...
	public OFFERED_BY(TravelAgency travelAgency) {
	...
	public OFFERED_BY(VeterinaryCare veterinaryCare) {
	...
	public OFFERED_BY(WholesaleStore wholesaleStore) {
	...
	public OFFERED_BY(Winery winery) {
	...
	public OFFERED_BY(WorkersUnion workersUnion) {
	...
	public void copy(Container.OfferedBy org) {
