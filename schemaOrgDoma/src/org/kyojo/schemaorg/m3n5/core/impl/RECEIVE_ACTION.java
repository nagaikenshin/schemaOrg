...
import org.kyojo.schemaorg.m3n5.core.Container.DeliveryMethod;
...
public class RECEIVE_ACTION implements Clazz.ReceiveAction {
	...
	public RECEIVE_ACTION() {
	}

	public RECEIVE_ACTION(Long seq) {
		setSeq(seq);
	}

	public RECEIVE_ACTION(String string) {
	...
	public RECEIVE_ACTION(ActionStatus actionStatus) {
	...
	public RECEIVE_ACTION(AdditionalType additionalType) {
	...
	public RECEIVE_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public RECEIVE_ACTION(AlternateName alternateName) {
	...
	public RECEIVE_ACTION(DeliveryMethod deliveryMethod) {
	...
	public RECEIVE_ACTION(Description description) {
	...
	public RECEIVE_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public RECEIVE_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public RECEIVE_ACTION(Error error) {
		setError(error);
	}
	...
	public RECEIVE_ACTION(FromLocation fromLocation) {
	...
	public RECEIVE_ACTION(Identifier identifier) {
	...
	public RECEIVE_ACTION(Image image) {
		setImage(image);
	}
	...
	public RECEIVE_ACTION(Instrument instrument) {
	...
	public RECEIVE_ACTION(Location location) {
	...
	public RECEIVE_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public RECEIVE_ACTION(Name name) {
		setName(name);
	}
	...
	public RECEIVE_ACTION(NameFuzzy nameFuzzy) {
	...
	public RECEIVE_ACTION(NameRuby nameRuby) {
	...
	public RECEIVE_ACTION(Object object) {
		setObject(object);
	}
	...
	public RECEIVE_ACTION(Participant participant) {
	...
	public RECEIVE_ACTION(PotentialAction potentialAction) {
	...
	public RECEIVE_ACTION(Result result) {
		setResult(result);
	}
	...
	public RECEIVE_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RECEIVE_ACTION(Sender sender) {
		setSender(sender);
	}
	...
	public RECEIVE_ACTION(StartTime startTime) {
	...
	public RECEIVE_ACTION(SubjectOf subjectOf) {
	...
	public RECEIVE_ACTION(Target target) {
		setTarget(target);
	}
	...
	public RECEIVE_ACTION(ToLocation toLocation) {
	...
	public void copy(Clazz.ReceiveAction org) {
		setSeq(org.getSeq());
