...
public class RESORT implements Clazz.Resort {
	...
	public RESORT(GeoContains geoContains) {
	...
	public RESORT(GeoCoveredBy geoCoveredBy) {
	...
	public RESORT(GeoCovers geoCovers) {
	...
	public RESORT(GeoCrosses geoCrosses) {
	...
	public RESORT(GeoDisjoint geoDisjoint) {
	...
	public RESORT(GeoEquals geoEquals) {
	...
	public RESORT(GeoIntersects geoIntersects) {
	...
	public RESORT(GeoOverlaps geoOverlaps) {
	...
	public RESORT(GeoTouches geoTouches) {
	...
	public RESORT(GeoWithin geoWithin) {
