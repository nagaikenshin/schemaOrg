...
public class PICKUP_LOCATION implements Container.PickupLocation {
	...
	public PICKUP_LOCATION(String string) {
	...
	public PICKUP_LOCATION(Accommodation accommodation) {
	...
	public PICKUP_LOCATION(AccountingService accountingService) {
	...
	public PICKUP_LOCATION(AdministrativeArea administrativeArea) {
	...
	public PICKUP_LOCATION(AdultEntertainment adultEntertainment) {
	...
	public PICKUP_LOCATION(Airport airport) {
	...
	public PICKUP_LOCATION(AmusementPark amusementPark) {
	...
	public PICKUP_LOCATION(AnimalShelter animalShelter) {
	...
	public PICKUP_LOCATION(Apartment apartment) {
	...
	public PICKUP_LOCATION(ApartmentComplex apartmentComplex) {
	...
	public PICKUP_LOCATION(Aquarium aquarium) {
	...
	public PICKUP_LOCATION(ArchiveOrganization archiveOrganization) {
	...
	public PICKUP_LOCATION(ArtGallery artGallery) {
	...
	public PICKUP_LOCATION(Attorney attorney) {
	...
	public PICKUP_LOCATION(AutoBodyShop autoBodyShop) {
	...
	public PICKUP_LOCATION(AutoDealer autoDealer) {
	...
	public PICKUP_LOCATION(AutoPartsStore autoPartsStore) {
	...
	public PICKUP_LOCATION(AutoRental autoRental) {
	...
	public PICKUP_LOCATION(AutoRepair autoRepair) {
	...
	public PICKUP_LOCATION(AutoWash autoWash) {
	...
	public PICKUP_LOCATION(AutomatedTeller automatedTeller) {
	...
	public PICKUP_LOCATION(AutomotiveBusiness automotiveBusiness) {
	...
	public PICKUP_LOCATION(Bakery bakery) {
	...
	public PICKUP_LOCATION(BankOrCreditUnion bankOrCreditUnion) {
	...
	public PICKUP_LOCATION(BarOrPub barOrPub) {
	...
	public PICKUP_LOCATION(Beach beach) {
	...
	public PICKUP_LOCATION(BeautySalon beautySalon) {
	...
	public PICKUP_LOCATION(BedAndBreakfast bedAndBreakfast) {
	...
	public PICKUP_LOCATION(BikeStore bikeStore) {
	...
	public PICKUP_LOCATION(BodyOfWater bodyOfWater) {
	...
	public PICKUP_LOCATION(BookStore bookStore) {
	...
	public PICKUP_LOCATION(BowlingAlley bowlingAlley) {
	...
	public PICKUP_LOCATION(Brewery brewery) {
	...
	public PICKUP_LOCATION(Bridge bridge) {
	...
	public PICKUP_LOCATION(BuddhistTemple buddhistTemple) {
	...
	public PICKUP_LOCATION(BusStation busStation) {
	...
	public PICKUP_LOCATION(BusStop busStop) {
	...
	public PICKUP_LOCATION(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public PICKUP_LOCATION(Campground campground) {
	...
	public PICKUP_LOCATION(CampingPitch campingPitch) {
	...
	public PICKUP_LOCATION(Canal canal) {
	...
	public PICKUP_LOCATION(Casino casino) {
	...
	public PICKUP_LOCATION(CatholicChurch catholicChurch) {
	...
	public PICKUP_LOCATION(Cemetery cemetery) {
	...
	public PICKUP_LOCATION(ChildCare childCare) {
	...
	public PICKUP_LOCATION(Church church) {
	...
	public PICKUP_LOCATION(City city) {
	...
	public PICKUP_LOCATION(CityHall cityHall) {
	...
	public PICKUP_LOCATION(CivicStructure civicStructure) {
	...
	public PICKUP_LOCATION(ClothingStore clothingStore) {
	...
	public PICKUP_LOCATION(ComedyClub comedyClub) {
	...
	public PICKUP_LOCATION(CommunityHealth communityHealth) {
	...
	public PICKUP_LOCATION(ComputerStore computerStore) {
	...
	public PICKUP_LOCATION(Continent continent) {
	...
	public PICKUP_LOCATION(ConvenienceStore convenienceStore) {
	...
	public PICKUP_LOCATION(Country country) {
	...
	public PICKUP_LOCATION(Courthouse courthouse) {
	...
	public PICKUP_LOCATION(Crematorium crematorium) {
	...
	public PICKUP_LOCATION(DaySpa daySpa) {
	...
	public PICKUP_LOCATION(DefenceEstablishment defenceEstablishment) {
	...
	public PICKUP_LOCATION(Dentist dentist) {
	...
	public PICKUP_LOCATION(DepartmentStore departmentStore) {
	...
	public PICKUP_LOCATION(Dermatology dermatology) {
	...
	public PICKUP_LOCATION(DietNutrition dietNutrition) {
	...
	public PICKUP_LOCATION(Distillery distillery) {
	...
	public PICKUP_LOCATION(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public PICKUP_LOCATION(Electrician electrician) {
	...
	public PICKUP_LOCATION(ElectronicsStore electronicsStore) {
	...
	public PICKUP_LOCATION(Embassy embassy) {
	...
	public PICKUP_LOCATION(Emergency emergency) {
	...
	public PICKUP_LOCATION(EmergencyService emergencyService) {
	...
	public PICKUP_LOCATION(EmploymentAgency employmentAgency) {
	...
	public PICKUP_LOCATION(EntertainmentBusiness entertainmentBusiness) {
	...
	public PICKUP_LOCATION(EventVenue eventVenue) {
	...
	public PICKUP_LOCATION(ExerciseGym exerciseGym) {
	...
	public PICKUP_LOCATION(FastFoodRestaurant fastFoodRestaurant) {
	...
	public PICKUP_LOCATION(FinancialService financialService) {
	...
	public PICKUP_LOCATION(FireStation fireStation) {
	...
	public PICKUP_LOCATION(Florist florist) {
	...
	public PICKUP_LOCATION(FoodEstablishment foodEstablishment) {
	...
	public PICKUP_LOCATION(FurnitureStore furnitureStore) {
	...
	public PICKUP_LOCATION(GardenStore gardenStore) {
	...
	public PICKUP_LOCATION(GasStation gasStation) {
	...
	public PICKUP_LOCATION(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public PICKUP_LOCATION(GeneralContractor generalContractor) {
	...
	public PICKUP_LOCATION(Geriatric geriatric) {
	...
	public PICKUP_LOCATION(GolfCourse golfCourse) {
	...
	public PICKUP_LOCATION(GovernmentBuilding governmentBuilding) {
	...
	public PICKUP_LOCATION(GovernmentOffice governmentOffice) {
	...
	public PICKUP_LOCATION(GroceryStore groceryStore) {
	...
	public PICKUP_LOCATION(Gynecologic gynecologic) {
	...
	public PICKUP_LOCATION(HVACBusiness hvacBusiness) {
	...
	public PICKUP_LOCATION(HairSalon hairSalon) {
	...
	public PICKUP_LOCATION(HardwareStore hardwareStore) {
	...
	public PICKUP_LOCATION(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public PICKUP_LOCATION(HealthClub healthClub) {
	...
	public PICKUP_LOCATION(HinduTemple hinduTemple) {
	...
	public PICKUP_LOCATION(HobbyShop hobbyShop) {
	...
	public PICKUP_LOCATION(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public PICKUP_LOCATION(HomeGoodsStore homeGoodsStore) {
	...
	public PICKUP_LOCATION(Hospital hospital) {
	...
	public PICKUP_LOCATION(Hostel hostel) {
	...
	public PICKUP_LOCATION(Hotel hotel) {
	...
	public PICKUP_LOCATION(HotelRoom hotelRoom) {
	...
	public PICKUP_LOCATION(House house) {
	...
	public PICKUP_LOCATION(HousePainter housePainter) {
	...
	public PICKUP_LOCATION(IceCreamShop iceCreamShop) {
	...
	public PICKUP_LOCATION(InsuranceAgency insuranceAgency) {
	...
	public PICKUP_LOCATION(InternetCafe internetCafe) {
	...
	public PICKUP_LOCATION(JewelryStore jewelryStore) {
	...
	public PICKUP_LOCATION(LakeBodyOfWater lakeBodyOfWater) {
	...
	public PICKUP_LOCATION(Landform landform) {
	...
	public PICKUP_LOCATION(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public PICKUP_LOCATION(LegalService legalService) {
	...
	public PICKUP_LOCATION(LegislativeBuilding legislativeBuilding) {
	...
	public PICKUP_LOCATION(Library library) {
	...
	public PICKUP_LOCATION(LiquorStore liquorStore) {
	...
	public PICKUP_LOCATION(LocalBusiness localBusiness) {
	...
	public PICKUP_LOCATION(Locksmith locksmith) {
	...
	public PICKUP_LOCATION(LodgingBusiness lodgingBusiness) {
	...
	public PICKUP_LOCATION(MedicalBusiness medicalBusiness) {
	...
	public PICKUP_LOCATION(MedicalClinic medicalClinic) {
	...
	public PICKUP_LOCATION(MeetingRoom meetingRoom) {
	...
	public PICKUP_LOCATION(MensClothingStore mensClothingStore) {
	...
	public PICKUP_LOCATION(Midwifery midwifery) {
	...
	public PICKUP_LOCATION(MobilePhoneStore mobilePhoneStore) {
	...
	public PICKUP_LOCATION(Mosque mosque) {
	...
	public PICKUP_LOCATION(Motel motel) {
	...
	public PICKUP_LOCATION(MotorcycleDealer motorcycleDealer) {
	...
	public PICKUP_LOCATION(MotorcycleRepair motorcycleRepair) {
	...
	public PICKUP_LOCATION(Mountain mountain) {
	...
	public PICKUP_LOCATION(MovieRentalStore movieRentalStore) {
	...
	public PICKUP_LOCATION(MovieTheater movieTheater) {
	...
	public PICKUP_LOCATION(MovingCompany movingCompany) {
	...
	public PICKUP_LOCATION(Museum museum) {
	...
	public PICKUP_LOCATION(MusicStore musicStore) {
	...
	public PICKUP_LOCATION(MusicVenue musicVenue) {
	...
	public PICKUP_LOCATION(NailSalon nailSalon) {
	...
	public PICKUP_LOCATION(NightClub nightClub) {
	...
	public PICKUP_LOCATION(Notary notary) {
	...
	public PICKUP_LOCATION(Nursing nursing) {
	...
	public PICKUP_LOCATION(Obstetric obstetric) {
	...
	public PICKUP_LOCATION(OceanBodyOfWater oceanBodyOfWater) {
	...
	public PICKUP_LOCATION(OfficeEquipmentStore officeEquipmentStore) {
	...
	public PICKUP_LOCATION(Oncologic oncologic) {
	...
	public PICKUP_LOCATION(Optician optician) {
	...
	public PICKUP_LOCATION(Optometric optometric) {
	...
	public PICKUP_LOCATION(Otolaryngologic otolaryngologic) {
	...
	public PICKUP_LOCATION(OutletStore outletStore) {
	...
	public PICKUP_LOCATION(Park park) {
	...
	public PICKUP_LOCATION(ParkingFacility parkingFacility) {
	...
	public PICKUP_LOCATION(PawnShop pawnShop) {
	...
	public PICKUP_LOCATION(Pediatric pediatric) {
	...
	public PICKUP_LOCATION(PerformingArtsTheater performingArtsTheater) {
	...
	public PICKUP_LOCATION(PetStore petStore) {
	...
	public PICKUP_LOCATION(Pharmacy pharmacy) {
	...
	public PICKUP_LOCATION(Physician physician) {
	...
	public PICKUP_LOCATION(Physiotherapy physiotherapy) {
	...
	public PICKUP_LOCATION(Place place) {
		placeList = new ArrayList<Place>();
		placeList.add(place);
	}
	...
	public PICKUP_LOCATION(PlaceOfWorship placeOfWorship) {
	...
	public PICKUP_LOCATION(PlasticSurgery plasticSurgery) {
	...
	public PICKUP_LOCATION(Playground playground) {
	...
	public PICKUP_LOCATION(Plumber plumber) {
	...
	public PICKUP_LOCATION(Podiatric podiatric) {
	...
	public PICKUP_LOCATION(PoliceStation policeStation) {
	...
	public PICKUP_LOCATION(Pond pond) {
	...
	public PICKUP_LOCATION(PostOffice postOffice) {
	...
	public PICKUP_LOCATION(PrimaryCare primaryCare) {
	...
	public PICKUP_LOCATION(ProfessionalService professionalService) {
	...
	public PICKUP_LOCATION(Psychiatric psychiatric) {
	...
	public PICKUP_LOCATION(PublicHealth publicHealth) {
	...
	public PICKUP_LOCATION(PublicSwimmingPool publicSwimmingPool) {
	...
	public PICKUP_LOCATION(PublicToilet publicToilet) {
	...
	public PICKUP_LOCATION(RVPark rvPark) {
	...
	public PICKUP_LOCATION(RadioStation radioStation) {
	...
	public PICKUP_LOCATION(RealEstateAgent realEstateAgent) {
	...
	public PICKUP_LOCATION(RecyclingCenter recyclingCenter) {
	...
	public PICKUP_LOCATION(Reservoir reservoir) {
	...
	public PICKUP_LOCATION(Residence residence) {
	...
	public PICKUP_LOCATION(Resort resort) {
	...
	public PICKUP_LOCATION(Restaurant restaurant) {
	...
	public PICKUP_LOCATION(RiverBodyOfWater riverBodyOfWater) {
	...
	public PICKUP_LOCATION(RoofingContractor roofingContractor) {
	...
	public PICKUP_LOCATION(Room room) {
	...
	public PICKUP_LOCATION(SeaBodyOfWater seaBodyOfWater) {
	...
	public PICKUP_LOCATION(SelfStorage selfStorage) {
	...
	public PICKUP_LOCATION(ShoeStore shoeStore) {
	...
	public PICKUP_LOCATION(ShoppingCenter shoppingCenter) {
	...
	public PICKUP_LOCATION(SingleFamilyResidence singleFamilyResidence) {
	...
	public PICKUP_LOCATION(SkiResort skiResort) {
	...
	public PICKUP_LOCATION(SportingGoodsStore sportingGoodsStore) {
	...
	public PICKUP_LOCATION(SportsActivityLocation sportsActivityLocation) {
	...
	public PICKUP_LOCATION(SportsClub sportsClub) {
	...
	public PICKUP_LOCATION(StadiumOrArena stadiumOrArena) {
	...
	public PICKUP_LOCATION(State state) {
	...
	public PICKUP_LOCATION(Store store) {
	...
	public PICKUP_LOCATION(SubwayStation subwayStation) {
	...
	public PICKUP_LOCATION(Suite suite) {
	...
	public PICKUP_LOCATION(Synagogue synagogue) {
	...
	public PICKUP_LOCATION(TattooParlor tattooParlor) {
	...
	public PICKUP_LOCATION(TaxiStand taxiStand) {
	...
	public PICKUP_LOCATION(TelevisionStation televisionStation) {
	...
	public PICKUP_LOCATION(TennisComplex tennisComplex) {
	...
	public PICKUP_LOCATION(TireShop tireShop) {
	...
	public PICKUP_LOCATION(TouristAttraction touristAttraction) {
	...
	public PICKUP_LOCATION(TouristDestination touristDestination) {
	...
	public PICKUP_LOCATION(TouristInformationCenter touristInformationCenter) {
	...
	public PICKUP_LOCATION(ToyStore toyStore) {
	...
	public PICKUP_LOCATION(TrainStation trainStation) {
	...
	public PICKUP_LOCATION(TravelAgency travelAgency) {
	...
	public PICKUP_LOCATION(Volcano volcano) {
	...
	public PICKUP_LOCATION(Waterfall waterfall) {
	...
	public PICKUP_LOCATION(WholesaleStore wholesaleStore) {
	...
	public PICKUP_LOCATION(Winery winery) {
	...
	public PICKUP_LOCATION(Zoo zoo) {
	...
	public void copy(Container.PickupLocation org) {
