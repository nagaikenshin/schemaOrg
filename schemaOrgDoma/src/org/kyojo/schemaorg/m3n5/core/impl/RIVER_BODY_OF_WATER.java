...
public class RIVER_BODY_OF_WATER implements Clazz.RiverBodyOfWater {
	...
	public RIVER_BODY_OF_WATER(GeoContains geoContains) {
	...
	public RIVER_BODY_OF_WATER(GeoCoveredBy geoCoveredBy) {
	...
	public RIVER_BODY_OF_WATER(GeoCovers geoCovers) {
	...
	public RIVER_BODY_OF_WATER(GeoCrosses geoCrosses) {
	...
	public RIVER_BODY_OF_WATER(GeoDisjoint geoDisjoint) {
	...
	public RIVER_BODY_OF_WATER(GeoEquals geoEquals) {
	...
	public RIVER_BODY_OF_WATER(GeoIntersects geoIntersects) {
	...
	public RIVER_BODY_OF_WATER(GeoOverlaps geoOverlaps) {
	...
	public RIVER_BODY_OF_WATER(GeoTouches geoTouches) {
	...
	public RIVER_BODY_OF_WATER(GeoWithin geoWithin) {
	...
	public RIVER_BODY_OF_WATER(Slogan slogan) {
		setSlogan(slogan);
	}
