...
public class ADULT_ENTERTAINMENT implements Clazz.AdultEntertainment {
	...
	public ADULT_ENTERTAINMENT(GeoContains geoContains) {
	...
	public ADULT_ENTERTAINMENT(GeoCoveredBy geoCoveredBy) {
	...
	public ADULT_ENTERTAINMENT(GeoCovers geoCovers) {
	...
	public ADULT_ENTERTAINMENT(GeoCrosses geoCrosses) {
	...
	public ADULT_ENTERTAINMENT(GeoDisjoint geoDisjoint) {
	...
	public ADULT_ENTERTAINMENT(GeoEquals geoEquals) {
	...
	public ADULT_ENTERTAINMENT(GeoIntersects geoIntersects) {
	...
	public ADULT_ENTERTAINMENT(GeoOverlaps geoOverlaps) {
	...
	public ADULT_ENTERTAINMENT(GeoTouches geoTouches) {
	...
	public ADULT_ENTERTAINMENT(GeoWithin geoWithin) {
	...
	public ADULT_ENTERTAINMENT(Slogan slogan) {
		setSlogan(slogan);
	}
