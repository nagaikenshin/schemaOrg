...
public class FINANCIAL_SERVICE implements Clazz.FinancialService {
	...
	public FINANCIAL_SERVICE(GeoContains geoContains) {
	...
	public FINANCIAL_SERVICE(GeoCoveredBy geoCoveredBy) {
	...
	public FINANCIAL_SERVICE(GeoCovers geoCovers) {
	...
	public FINANCIAL_SERVICE(GeoCrosses geoCrosses) {
	...
	public FINANCIAL_SERVICE(GeoDisjoint geoDisjoint) {
	...
	public FINANCIAL_SERVICE(GeoEquals geoEquals) {
	...
	public FINANCIAL_SERVICE(GeoIntersects geoIntersects) {
	...
	public FINANCIAL_SERVICE(GeoOverlaps geoOverlaps) {
	...
	public FINANCIAL_SERVICE(GeoTouches geoTouches) {
	...
	public FINANCIAL_SERVICE(GeoWithin geoWithin) {
	...
	public FINANCIAL_SERVICE(Slogan slogan) {
		setSlogan(slogan);
	}
