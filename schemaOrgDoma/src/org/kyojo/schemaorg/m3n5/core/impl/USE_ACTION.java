...
public class USE_ACTION implements Clazz.UseAction {
	...
	public USE_ACTION(Long seq) {
		setSeq(seq);
	}

	public USE_ACTION(String string) {
	...
	public USE_ACTION(ActionAccessibilityRequirement actionAccessibilityRequirement) {
	...
	public USE_ACTION(ActionStatus actionStatus) {
	...
	public USE_ACTION(AdditionalType additionalType) {
	...
	public USE_ACTION(AlternateName alternateName) {
	...
	public USE_ACTION(Description description) {
	...
	public USE_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public USE_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public USE_ACTION(ExpectsAcceptanceOf expectsAcceptanceOf) {
	...
	public USE_ACTION(Identifier identifier) {
	...
	public USE_ACTION(Instrument instrument) {
	...
	public USE_ACTION(Location location) {
	...
	public USE_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public USE_ACTION(NameFuzzy nameFuzzy) {
	...
	public USE_ACTION(NameRuby nameRuby) {
	...
	public USE_ACTION(Object object) {
		setObject(object);
	}
	...
	public USE_ACTION(Participant participant) {
	...
	public USE_ACTION(PotentialAction potentialAction) {
	...
	public USE_ACTION(Result result) {
		setResult(result);
	}
	...
	public USE_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public USE_ACTION(StartTime startTime) {
	...
	public USE_ACTION(SubjectOf subjectOf) {
	...
	public USE_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.UseAction org) {
		setSeq(org.getSeq());
