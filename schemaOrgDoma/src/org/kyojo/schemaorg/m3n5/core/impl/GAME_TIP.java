...
public class GAME_TIP implements Container.GameTip {
	...
	public GAME_TIP(APIReference apiReference) {
	...
	public GAME_TIP(AboutPage aboutPage) {
	...
	public GAME_TIP(AdvertiserContentArticle advertiserContentArticle) {
	...
	public GAME_TIP(AnalysisNewsArticle analysisNewsArticle) {
	...
	public GAME_TIP(ArchiveComponent archiveComponent) {
	...
	public GAME_TIP(Article article) {
	...
	public GAME_TIP(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public GAME_TIP(AudioObject audioObject) {
	...
	public GAME_TIP(Audiobook audiobook) {
	...
	public GAME_TIP(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public GAME_TIP(Barcode barcode) {
	...
	public GAME_TIP(BlogPosting blogPosting) {
	...
	public GAME_TIP(BookSeries bookSeries) {
	...
	public GAME_TIP(CategoryCodeSet categoryCodeSet) {
	...
	public GAME_TIP(Chapter chapter) {
	...
	public GAME_TIP(CheckoutPage checkoutPage) {
	...
	public GAME_TIP(ClaimReview claimReview) {
	...
	public GAME_TIP(Collection collection) {
	...
	public GAME_TIP(CollectionPage collectionPage) {
	...
	public GAME_TIP(ComicCoverArt comicCoverArt) {
	...
	public GAME_TIP(ComicIssue comicIssue) {
	...
	public GAME_TIP(ComicSeries comicSeries) {
	...
	public GAME_TIP(ComicStory comicStory) {
	...
	public GAME_TIP(Comment comment) {
	...
	public GAME_TIP(CompleteDataFeed completeDataFeed) {
	...
	public GAME_TIP(ContactPage contactPage) {
	...
	public GAME_TIP(Conversation conversation) {
	...
	public GAME_TIP(CorrectionComment correctionComment) {
	...
	public GAME_TIP(CoverArt coverArt) {
	...
	public GAME_TIP(CreativeWork creativeWork) {
		creativeWorkList = new ArrayList<CreativeWork>();
	...
	public GAME_TIP(CreativeWorkSeason creativeWorkSeason) {
	...
	public GAME_TIP(CreativeWorkSeries creativeWorkSeries) {
	...
	public GAME_TIP(CriticReview criticReview) {
	...
	public GAME_TIP(DataCatalog dataCatalog) {
	...
	public GAME_TIP(DataDownload dataDownload) {
	...
	public GAME_TIP(DataFeed dataFeed) {
	...
	public GAME_TIP(Dataset dataset) {
	...
	public GAME_TIP(DefinedTermSet definedTermSet) {
	...
	public GAME_TIP(DigitalDocument digitalDocument) {
	...
	public GAME_TIP(DiscussionForumPosting discussionForumPosting) {
	...
	public GAME_TIP(Drawing drawing) {
	...
	public GAME_TIP(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public GAME_TIP(EmailMessage emailMessage) {
	...
	public GAME_TIP(EmployerReview employerReview) {
	...
	public GAME_TIP(Episode episode) {
	...
	public GAME_TIP(ExercisePlan exercisePlan) {
	...
	public GAME_TIP(FAQPage faqPage) {
	...
	public GAME_TIP(HowToDirection howToDirection) {
	...
	public GAME_TIP(HowToSection howToSection) {
	...
	public GAME_TIP(HowToStep howToStep) {
	...
	public GAME_TIP(HowToTip howToTip) {
	...
	public GAME_TIP(ImageGallery imageGallery) {
	...
	public GAME_TIP(ImageObject imageObject) {
	...
	public GAME_TIP(ItemPage itemPage) {
	...
	public GAME_TIP(Legislation legislation) {
	...
	public GAME_TIP(LegislationObject legislationObject) {
	...
	public GAME_TIP(LiveBlogPosting liveBlogPosting) {
	...
	public GAME_TIP(Manuscript manuscript) {
	...
	public GAME_TIP(MediaObject mediaObject) {
	...
	public GAME_TIP(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public GAME_TIP(MedicalWebPage medicalWebPage) {
	...
	public GAME_TIP(MenuSection menuSection) {
	...
	public GAME_TIP(Message message) {
	...
	public GAME_TIP(MobileApplication mobileApplication) {
	...
	public GAME_TIP(MovieClip movieClip) {
	...
	public GAME_TIP(MovieSeries movieSeries) {
	...
	public GAME_TIP(MusicAlbum musicAlbum) {
	...
	public GAME_TIP(MusicComposition musicComposition) {
	...
	public GAME_TIP(MusicPlaylist musicPlaylist) {
	...
	public GAME_TIP(MusicRecording musicRecording) {
	...
	public GAME_TIP(MusicRelease musicRelease) {
	...
	public GAME_TIP(MusicVideoObject musicVideoObject) {
	...
	public GAME_TIP(NewsArticle newsArticle) {
	...
	public GAME_TIP(Newspaper newspaper) {
	...
	public GAME_TIP(NoteDigitalDocument noteDigitalDocument) {
	...
	public GAME_TIP(OpinionNewsArticle opinionNewsArticle) {
	...
	public GAME_TIP(Painting painting) {
	...
	public GAME_TIP(Periodical periodical) {
	...
	public GAME_TIP(Photograph photograph) {
	...
	public GAME_TIP(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public GAME_TIP(ProfilePage profilePage) {
	...
	public GAME_TIP(PublicationIssue publicationIssue) {
	...
	public GAME_TIP(PublicationVolume publicationVolume) {
	...
	public GAME_TIP(Question question) {
	...
	public GAME_TIP(Quotation quotation) {
	...
	public GAME_TIP(RadioClip radioClip) {
	...
	public GAME_TIP(RadioEpisode radioEpisode) {
	...
	public GAME_TIP(RadioSeason radioSeason) {
	...
	public GAME_TIP(RadioSeries radioSeries) {
	...
	public GAME_TIP(ReportageNewsArticle reportageNewsArticle) {
	...
	public GAME_TIP(ReviewNewsArticle reviewNewsArticle) {
	...
	public GAME_TIP(SatiricalArticle satiricalArticle) {
	...
	public GAME_TIP(ScholarlyArticle scholarlyArticle) {
	...
	public GAME_TIP(Sculpture sculpture) {
	...
	public GAME_TIP(SearchResultsPage searchResultsPage) {
	...
	public GAME_TIP(SheetMusic sheetMusic) {
	...
	public GAME_TIP(ShortStory shortStory) {
	...
	public GAME_TIP(SiteNavigationElement siteNavigationElement) {
	...
	public GAME_TIP(SocialMediaPosting socialMediaPosting) {
	...
	public GAME_TIP(SoftwareApplication softwareApplication) {
	...
	public GAME_TIP(SoftwareSourceCode softwareSourceCode) {
	...
	public GAME_TIP(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public GAME_TIP(TVEpisode tvEpisode) {
	...
	public GAME_TIP(TVSeason tvSeason) {
	...
	public GAME_TIP(TVSeries tvSeries) {
	...
	public GAME_TIP(TechArticle techArticle) {
	...
	public GAME_TIP(TextDigitalDocument textDigitalDocument) {
	...
	public GAME_TIP(ThreeDimensionalModel threeDimensionalModel) {
	...
	public GAME_TIP(UserReview userReview) {
	...
	public GAME_TIP(VideoGallery videoGallery) {
	...
	public GAME_TIP(VideoGame videoGame) {
	...
	public GAME_TIP(VideoGameClip videoGameClip) {
	...
	public GAME_TIP(VideoGameSeries videoGameSeries) {
	...
	public GAME_TIP(VideoObject videoObject) {
	...
	public GAME_TIP(VisualArtwork visualArtwork) {
	...
	public GAME_TIP(WPAdBlock wpAdBlock) {
	...
	public GAME_TIP(WPFooter wpFooter) {
	...
	public GAME_TIP(WPHeader wpHeader) {
	...
	public GAME_TIP(WPSideBar wpSideBar) {
	...
	public GAME_TIP(WebApplication webApplication) {
	...
	public GAME_TIP(WebPage webPage) {
	...
	public GAME_TIP(WebPageElement webPageElement) {
	...
	public GAME_TIP(WebSite webSite) {
	...
	public void copy(Container.GameTip org) {
