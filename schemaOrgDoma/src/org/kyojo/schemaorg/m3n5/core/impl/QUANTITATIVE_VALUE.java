...
public class QUANTITATIVE_VALUE implements Clazz.QuantitativeValue {
	...
	public QUANTITATIVE_VALUE(String string) {
	...
	public QUANTITATIVE_VALUE(AdditionalProperty additionalProperty) {
	...
	public QUANTITATIVE_VALUE(AdditionalType additionalType) {
	...
	public QUANTITATIVE_VALUE(AlternateName alternateName) {
	...
	public QUANTITATIVE_VALUE(Description description) {
	...
	public QUANTITATIVE_VALUE(DisambiguatingDescription disambiguatingDescription) {
	...
	public QUANTITATIVE_VALUE(Identifier identifier) {
	...
	public QUANTITATIVE_VALUE(Image image) {
		setImage(image);
	}
	...
	public QUANTITATIVE_VALUE(MainEntityOfPage mainEntityOfPage) {
	...
	public QUANTITATIVE_VALUE(MaxValue maxValue) {
	...
	public QUANTITATIVE_VALUE(MinValue minValue) {
	...
	public QUANTITATIVE_VALUE(Name name) {
		setName(name);
	}
	...
	public QUANTITATIVE_VALUE(NameFuzzy nameFuzzy) {
	...
	public QUANTITATIVE_VALUE(NameRuby nameRuby) {
	...
	public QUANTITATIVE_VALUE(PotentialAction potentialAction) {
	...
	public QUANTITATIVE_VALUE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public QUANTITATIVE_VALUE(SubjectOf subjectOf) {
	...
	public QUANTITATIVE_VALUE(UnitCode unitCode) {
	...
	public QUANTITATIVE_VALUE(UnitText unitText) {
	...
	public QUANTITATIVE_VALUE(Url url) {
		setUrl(url);
	}
	...
	public QUANTITATIVE_VALUE(Value value) {
		setValue(value);
	}
	...
	public QUANTITATIVE_VALUE(ValueReference valueReference) {
