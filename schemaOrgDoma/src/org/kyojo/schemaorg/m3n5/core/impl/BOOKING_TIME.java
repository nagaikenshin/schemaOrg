...
public class BOOKING_TIME implements Container.BookingTime {
	...
	public BOOKING_TIME(java.util.Date dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public BOOKING_TIME(java.time.OffsetDateTime dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public BOOKING_TIME(DateTime dateTime) {
