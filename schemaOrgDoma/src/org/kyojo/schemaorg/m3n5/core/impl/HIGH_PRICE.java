...
public class HIGH_PRICE implements Container.HighPrice {
	...
	public HIGH_PRICE(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public HIGH_PRICE(Float fl0at) {
	...
	public HIGH_PRICE(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public HIGH_PRICE(Integer integer) {
	...
	public HIGH_PRICE(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public HIGH_PRICE(Number number) {
	...
	public HIGH_PRICE(String string) {
		this(new TEXT(string));
	}

	public HIGH_PRICE(Text text) {
	...
	public HIGH_PRICE(List<Float> fl0atList,
	...
	public void copy(Container.HighPrice org) {
