...
public class BROKER implements Container.Broker {
	...
	public BROKER(AccountingService accountingService) {
	...
	public BROKER(AdultEntertainment adultEntertainment) {
	...
	public BROKER(AmusementPark amusementPark) {
	...
	public BROKER(AnimalShelter animalShelter) {
	...
	public BROKER(ArchiveOrganization archiveOrganization) {
	...
	public BROKER(ArtGallery artGallery) {
	...
	public BROKER(Attorney attorney) {
	...
	public BROKER(AutoBodyShop autoBodyShop) {
	...
	public BROKER(AutoDealer autoDealer) {
	...
	public BROKER(AutoPartsStore autoPartsStore) {
	...
	public BROKER(AutoRental autoRental) {
	...
	public BROKER(AutoRepair autoRepair) {
	...
	public BROKER(AutoWash autoWash) {
	...
	public BROKER(AutomatedTeller automatedTeller) {
	...
	public BROKER(AutomotiveBusiness automotiveBusiness) {
	...
	public BROKER(BankOrCreditUnion bankOrCreditUnion) {
	...
	public BROKER(BarOrPub barOrPub) {
	...
	public BROKER(BeautySalon beautySalon) {
	...
	public BROKER(BedAndBreakfast bedAndBreakfast) {
	...
	public BROKER(BikeStore bikeStore) {
	...
	public BROKER(BookStore bookStore) {
	...
	public BROKER(BowlingAlley bowlingAlley) {
	...
	public BROKER(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public BROKER(Campground campground) {
	...
	public BROKER(ChildCare childCare) {
	...
	public BROKER(ClothingStore clothingStore) {
	...
	public BROKER(CollegeOrUniversity collegeOrUniversity) {
	...
	public BROKER(ComedyClub comedyClub) {
	...
	public BROKER(CommunityHealth communityHealth) {
	...
	public BROKER(ComputerStore computerStore) {
	...
	public BROKER(Consortium consortium) {
	...
	public BROKER(ConvenienceStore convenienceStore) {
	...
	public BROKER(Corporation corporation) {
	...
	public BROKER(DanceGroup danceGroup) {
	...
	public BROKER(DepartmentStore departmentStore) {
	...
	public BROKER(Dermatology dermatology) {
	...
	public BROKER(DiagnosticLab diagnosticLab) {
	...
	public BROKER(DietNutrition dietNutrition) {
	...
	public BROKER(Distillery distillery) {
	...
	public BROKER(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public BROKER(EducationalOrganization educationalOrganization) {
	...
	public BROKER(Electrician electrician) {
	...
	public BROKER(ElectronicsStore electronicsStore) {
	...
	public BROKER(ElementarySchool elementarySchool) {
	...
	public BROKER(Emergency emergency) {
	...
	public BROKER(EmergencyService emergencyService) {
	...
	public BROKER(EmploymentAgency employmentAgency) {
	...
	public BROKER(EntertainmentBusiness entertainmentBusiness) {
	...
	public BROKER(ExerciseGym exerciseGym) {
	...
	public BROKER(FastFoodRestaurant fastFoodRestaurant) {
	...
	public BROKER(FinancialService financialService) {
	...
	public BROKER(FireStation fireStation) {
	...
	public BROKER(FoodEstablishment foodEstablishment) {
	...
	public BROKER(FundingAgency fundingAgency) {
	...
	public BROKER(FundingScheme fundingScheme) {
	...
	public BROKER(FurnitureStore furnitureStore) {
	...
	public BROKER(GardenStore gardenStore) {
	...
	public BROKER(GasStation gasStation) {
	...
	public BROKER(GeneralContractor generalContractor) {
	...
	public BROKER(Geriatric geriatric) {
	...
	public BROKER(GolfCourse golfCourse) {
	...
	public BROKER(GovernmentOffice governmentOffice) {
	...
	public BROKER(GovernmentOrganization governmentOrganization) {
	...
	public BROKER(GroceryStore groceryStore) {
	...
	public BROKER(Gynecologic gynecologic) {
	...
	public BROKER(HVACBusiness hvacBusiness) {
	...
	public BROKER(HairSalon hairSalon) {
	...
	public BROKER(HardwareStore hardwareStore) {
	...
	public BROKER(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public BROKER(HealthClub healthClub) {
	...
	public BROKER(HighSchool highSchool) {
	...
	public BROKER(HobbyShop hobbyShop) {
	...
	public BROKER(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public BROKER(HomeGoodsStore homeGoodsStore) {
	...
	public BROKER(Hospital hospital) {
	...
	public BROKER(HousePainter housePainter) {
	...
	public BROKER(IceCreamShop iceCreamShop) {
	...
	public BROKER(InsuranceAgency insuranceAgency) {
	...
	public BROKER(InternetCafe internetCafe) {
	...
	public BROKER(JewelryStore jewelryStore) {
	...
	public BROKER(LegalService legalService) {
	...
	public BROKER(LibrarySystem librarySystem) {
	...
	public BROKER(LiquorStore liquorStore) {
	...
	public BROKER(LocalBusiness localBusiness) {
	...
	public BROKER(Locksmith locksmith) {
	...
	public BROKER(LodgingBusiness lodgingBusiness) {
	...
	public BROKER(MedicalBusiness medicalBusiness) {
	...
	public BROKER(MedicalClinic medicalClinic) {
	...
	public BROKER(MedicalOrganization medicalOrganization) {
	...
	public BROKER(MensClothingStore mensClothingStore) {
	...
	public BROKER(MiddleSchool middleSchool) {
	...
	public BROKER(Midwifery midwifery) {
	...
	public BROKER(MobilePhoneStore mobilePhoneStore) {
	...
	public BROKER(MotorcycleDealer motorcycleDealer) {
	...
	public BROKER(MotorcycleRepair motorcycleRepair) {
	...
	public BROKER(MovieRentalStore movieRentalStore) {
	...
	public BROKER(MovieTheater movieTheater) {
	...
	public BROKER(MovingCompany movingCompany) {
	...
	public BROKER(MusicGroup musicGroup) {
	...
	public BROKER(MusicStore musicStore) {
	...
	public BROKER(NailSalon nailSalon) {
	...
	public BROKER(NewsMediaOrganization newsMediaOrganization) {
	...
	public BROKER(NightClub nightClub) {
	...
	public BROKER(Obstetric obstetric) {
	...
	public BROKER(OfficeEquipmentStore officeEquipmentStore) {
	...
	public BROKER(Oncologic oncologic) {
	...
	public BROKER(Optician optician) {
	...
	public BROKER(Optometric optometric) {
	...
	public BROKER(Organization organization) {
		organizationList = new ArrayList<Organization>();
	...
	public BROKER(Otolaryngologic otolaryngologic) {
	...
	public BROKER(OutletStore outletStore) {
	...
	public BROKER(PawnShop pawnShop) {
	...
	public BROKER(Pediatric pediatric) {
	...
	public BROKER(PerformingGroup performingGroup) {
	...
	public BROKER(PetStore petStore) {
	...
	public BROKER(Pharmacy pharmacy) {
	...
	public BROKER(Physician physician) {
	...
	public BROKER(Physiotherapy physiotherapy) {
	...
	public BROKER(PlasticSurgery plasticSurgery) {
	...
	public BROKER(Podiatric podiatric) {
	...
	public BROKER(PoliceStation policeStation) {
	...
	public BROKER(PostOffice postOffice) {
	...
	public BROKER(Preschool preschool) {
	...
	public BROKER(PrimaryCare primaryCare) {
	...
	public BROKER(ProfessionalService professionalService) {
	...
	public BROKER(Psychiatric psychiatric) {
	...
	public BROKER(PublicHealth publicHealth) {
	...
	public BROKER(PublicSwimmingPool publicSwimmingPool) {
	...
	public BROKER(RadioStation radioStation) {
	...
	public BROKER(RealEstateAgent realEstateAgent) {
	...
	public BROKER(RecyclingCenter recyclingCenter) {
	...
	public BROKER(ResearchProject researchProject) {
	...
	public BROKER(Restaurant restaurant) {
	...
	public BROKER(RoofingContractor roofingContractor) {
	...
	public BROKER(SelfStorage selfStorage) {
	...
	public BROKER(ShoeStore shoeStore) {
	...
	public BROKER(ShoppingCenter shoppingCenter) {
	...
	public BROKER(SkiResort skiResort) {
	...
	public BROKER(SportingGoodsStore sportingGoodsStore) {
	...
	public BROKER(SportsActivityLocation sportsActivityLocation) {
	...
	public BROKER(SportsClub sportsClub) {
	...
	public BROKER(SportsOrganization sportsOrganization) {
	...
	public BROKER(SportsTeam sportsTeam) {
	...
	public BROKER(StadiumOrArena stadiumOrArena) {
	...
	public BROKER(TattooParlor tattooParlor) {
	...
	public BROKER(TelevisionStation televisionStation) {
	...
	public BROKER(TennisComplex tennisComplex) {
	...
	public BROKER(TheaterGroup theaterGroup) {
	...
	public BROKER(TireShop tireShop) {
	...
	public BROKER(TouristInformationCenter touristInformationCenter) {
	...
	public BROKER(ToyStore toyStore) {
	...
	public BROKER(TravelAgency travelAgency) {
	...
	public BROKER(VeterinaryCare veterinaryCare) {
	...
	public BROKER(WholesaleStore wholesaleStore) {
	...
	public BROKER(WorkersUnion workersUnion) {
	...
	public void copy(Container.Broker org) {
