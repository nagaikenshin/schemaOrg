...
public class APPEND_ACTION implements Clazz.AppendAction {
	...
	public APPEND_ACTION() {
	}

	public APPEND_ACTION(Long seq) {
		setSeq(seq);
	}

	public APPEND_ACTION(String string) {
	...
	public APPEND_ACTION(ActionStatus actionStatus) {
	...
	public APPEND_ACTION(AdditionalType additionalType) {
	...
	public APPEND_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public APPEND_ACTION(AlternateName alternateName) {
	...
	public APPEND_ACTION(Description description) {
	...
	public APPEND_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public APPEND_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public APPEND_ACTION(Error error) {
		setError(error);
	}
	...
	public APPEND_ACTION(Identifier identifier) {
	...
	public APPEND_ACTION(Image image) {
		setImage(image);
	}
	...
	public APPEND_ACTION(Instrument instrument) {
	...
	public APPEND_ACTION(Location location) {
	...
	public APPEND_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public APPEND_ACTION(Name name) {
		setName(name);
	}
	...
	public APPEND_ACTION(NameFuzzy nameFuzzy) {
	...
	public APPEND_ACTION(NameRuby nameRuby) {
	...
	public APPEND_ACTION(Object object) {
		setObject(object);
	}
	...
	public APPEND_ACTION(Participant participant) {
	...
	public APPEND_ACTION(PotentialAction potentialAction) {
	...
	public APPEND_ACTION(Result result) {
		setResult(result);
	}
	...
	public APPEND_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public APPEND_ACTION(StartTime startTime) {
	...
	public APPEND_ACTION(SubjectOf subjectOf) {
	...
	public APPEND_ACTION(Target target) {
		setTarget(target);
	}
	...
	public APPEND_ACTION(TargetCollection targetCollection) {
	...
	public APPEND_ACTION(ToLocation toLocation) {
	...
	public void copy(Clazz.AppendAction org) {
		setSeq(org.getSeq());
