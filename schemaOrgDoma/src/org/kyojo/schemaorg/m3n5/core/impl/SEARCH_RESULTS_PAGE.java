...
public class SEARCH_RESULTS_PAGE implements Clazz.SearchResultsPage {
	...
	public SEARCH_RESULTS_PAGE() {
	}

	public SEARCH_RESULTS_PAGE(Long seq) {
		setSeq(seq);
	}

	public SEARCH_RESULTS_PAGE(String string) {
	...
	public SEARCH_RESULTS_PAGE(About about) {
		setAbout(about);
	}
	...
	public SEARCH_RESULTS_PAGE(AccessMode accessMode) {
	...
	public SEARCH_RESULTS_PAGE(AccessModeSufficient accessModeSufficient) {
	...
	public SEARCH_RESULTS_PAGE(AccessibilityAPI accessibilityAPI) {
	...
	public SEARCH_RESULTS_PAGE(AccessibilityControl accessibilityControl) {
	...
	public SEARCH_RESULTS_PAGE(AccessibilityFeature accessibilityFeature) {
	...
	public SEARCH_RESULTS_PAGE(AccessibilityHazard accessibilityHazard) {
	...
	public SEARCH_RESULTS_PAGE(AccessibilitySummary accessibilitySummary) {
	...
	public SEARCH_RESULTS_PAGE(AccountablePerson accountablePerson) {
	...
	public SEARCH_RESULTS_PAGE(AdditionalType additionalType) {
	...
	public SEARCH_RESULTS_PAGE(AggregateRating aggregateRating) {
	...
	public SEARCH_RESULTS_PAGE(AlternateName alternateName) {
	...
	public SEARCH_RESULTS_PAGE(AlternativeHeadline alternativeHeadline) {
	...
	public SEARCH_RESULTS_PAGE(AssociatedMedia associatedMedia) {
	...
	public SEARCH_RESULTS_PAGE(Audience audience) {
	...
	public SEARCH_RESULTS_PAGE(Audio audio) {
		setAudio(audio);
	}
	...
	public SEARCH_RESULTS_PAGE(Author author) {
		setAuthor(author);
	}
	...
	public SEARCH_RESULTS_PAGE(Award award) {
		setAward(award);
	}
	...
	public SEARCH_RESULTS_PAGE(Breadcrumb breadcrumb) {
	...
	public SEARCH_RESULTS_PAGE(Character character) {
	...
	public SEARCH_RESULTS_PAGE(Citation citation) {
	...
	public SEARCH_RESULTS_PAGE(Comment comment) {
		setComment(comment);
	}
	...
	public SEARCH_RESULTS_PAGE(CommentCount commentCount) {
	...
	public SEARCH_RESULTS_PAGE(ContentLocation contentLocation) {
	...
	public SEARCH_RESULTS_PAGE(ContentRating contentRating) {
	...
	public SEARCH_RESULTS_PAGE(ContentReferenceTime contentReferenceTime) {
	...
	public SEARCH_RESULTS_PAGE(Contributor contributor) {
	...
	public SEARCH_RESULTS_PAGE(CopyrightHolder copyrightHolder) {
	...
	public SEARCH_RESULTS_PAGE(CopyrightYear copyrightYear) {
	...
	public SEARCH_RESULTS_PAGE(Correction correction) {
	...
	public SEARCH_RESULTS_PAGE(Creator creator) {
		setCreator(creator);
	}
	...
	public SEARCH_RESULTS_PAGE(DateCreated dateCreated) {
	...
	public SEARCH_RESULTS_PAGE(DateModified dateModified) {
	...
	public SEARCH_RESULTS_PAGE(DatePublished datePublished) {
	...
	public SEARCH_RESULTS_PAGE(Description description) {
	...
	public SEARCH_RESULTS_PAGE(DisambiguatingDescription disambiguatingDescription) {
	...
	public SEARCH_RESULTS_PAGE(DiscussionUrl discussionUrl) {
	...
	public SEARCH_RESULTS_PAGE(Editor editor) {
		setEditor(editor);
	}
	...
	public SEARCH_RESULTS_PAGE(EducationalAlignment educationalAlignment) {
	...
	public SEARCH_RESULTS_PAGE(EducationalUse educationalUse) {
	...
	public SEARCH_RESULTS_PAGE(Encoding encoding) {
	...
	public SEARCH_RESULTS_PAGE(EncodingFormat encodingFormat) {
	...
	public SEARCH_RESULTS_PAGE(ExampleOfWork exampleOfWork) {
	...
	public SEARCH_RESULTS_PAGE(Expires expires) {
		setExpires(expires);
	}
	...
	public SEARCH_RESULTS_PAGE(Funder funder) {
		setFunder(funder);
	}
	...
	public SEARCH_RESULTS_PAGE(Genre genre) {
		setGenre(genre);
	}
	...
	public SEARCH_RESULTS_PAGE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public SEARCH_RESULTS_PAGE(Headline headline) {
	...
	public SEARCH_RESULTS_PAGE(Identifier identifier) {
	...
	public SEARCH_RESULTS_PAGE(Image image) {
		setImage(image);
	}
	...
	public SEARCH_RESULTS_PAGE(InLanguage inLanguage) {
	...
	public SEARCH_RESULTS_PAGE(InteractionStatistic interactionStatistic) {
	...
	public SEARCH_RESULTS_PAGE(InteractivityType interactivityType) {
	...
	public SEARCH_RESULTS_PAGE(IsAccessibleForFree isAccessibleForFree) {
	...
	public SEARCH_RESULTS_PAGE(IsBasedOn isBasedOn) {
	...
	public SEARCH_RESULTS_PAGE(IsFamilyFriendly isFamilyFriendly) {
	...
	public SEARCH_RESULTS_PAGE(IsPartOf isPartOf) {
	...
	public SEARCH_RESULTS_PAGE(Keywords keywords) {
	...
	public SEARCH_RESULTS_PAGE(LastReviewed lastReviewed) {
	...
	public SEARCH_RESULTS_PAGE(LearningResourceType learningResourceType) {
	...
	public SEARCH_RESULTS_PAGE(License license) {
		setLicense(license);
	}
	...
	public SEARCH_RESULTS_PAGE(LocationCreated locationCreated) {
	...
	public SEARCH_RESULTS_PAGE(MainContentOfPage mainContentOfPage) {
	...
	public SEARCH_RESULTS_PAGE(MainEntity mainEntity) {
	...
	public SEARCH_RESULTS_PAGE(MainEntityOfPage mainEntityOfPage) {
	...
	public SEARCH_RESULTS_PAGE(Material material) {
	...
	public SEARCH_RESULTS_PAGE(MaterialExtent materialExtent) {
	...
	public SEARCH_RESULTS_PAGE(Mentions mentions) {
	...
	public SEARCH_RESULTS_PAGE(Name name) {
		setName(name);
	}
	...
	public SEARCH_RESULTS_PAGE(NameFuzzy nameFuzzy) {
	...
	public SEARCH_RESULTS_PAGE(NameRuby nameRuby) {
	...
	public SEARCH_RESULTS_PAGE(Offers offers) {
		setOffers(offers);
	}
	...
	public SEARCH_RESULTS_PAGE(Position position) {
	...
	public SEARCH_RESULTS_PAGE(PotentialAction potentialAction) {
	...
	public SEARCH_RESULTS_PAGE(PrimaryImageOfPage primaryImageOfPage) {
	...
	public SEARCH_RESULTS_PAGE(Producer producer) {
	...
	public SEARCH_RESULTS_PAGE(Provider provider) {
	...
	public SEARCH_RESULTS_PAGE(Publication publication) {
	...
	public SEARCH_RESULTS_PAGE(Publisher publisher) {
	...
	public SEARCH_RESULTS_PAGE(PublisherImprint publisherImprint) {
	...
	public SEARCH_RESULTS_PAGE(PublishingPrinciples publishingPrinciples) {
	...
	public SEARCH_RESULTS_PAGE(RecordedAt recordedAt) {
	...
	public SEARCH_RESULTS_PAGE(RelatedLink relatedLink) {
	...
	public SEARCH_RESULTS_PAGE(ReleasedEvent releasedEvent) {
	...
	public SEARCH_RESULTS_PAGE(Review review) {
		setReview(review);
	}
	...
	public SEARCH_RESULTS_PAGE(ReviewedBy reviewedBy) {
	...
	public SEARCH_RESULTS_PAGE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SEARCH_RESULTS_PAGE(SchemaVersion schemaVersion) {
	...
	public SEARCH_RESULTS_PAGE(SdDatePublished sdDatePublished) {
	...
	public SEARCH_RESULTS_PAGE(SdLicense sdLicense) {
	...
	public SEARCH_RESULTS_PAGE(SdPublisher sdPublisher) {
	...
	public SEARCH_RESULTS_PAGE(SignificantLink significantLink) {
	...
	public SEARCH_RESULTS_PAGE(SourceOrganization sourceOrganization) {
	...
	public SEARCH_RESULTS_PAGE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public SEARCH_RESULTS_PAGE(SpatialCoverage spatialCoverage) {
	...
	public SEARCH_RESULTS_PAGE(Speakable speakable) {
	...
	public SEARCH_RESULTS_PAGE(Specialty specialty) {
	...
	public SEARCH_RESULTS_PAGE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public SEARCH_RESULTS_PAGE(SubjectOf subjectOf) {
	...
	public SEARCH_RESULTS_PAGE(Temporal temporal) {
	...
	public SEARCH_RESULTS_PAGE(TemporalCoverage temporalCoverage) {
	...
	public SEARCH_RESULTS_PAGE(Text text) {
		setText(text);
	}
	...
	public SEARCH_RESULTS_PAGE(ThumbnailUrl thumbnailUrl) {
	...
	public SEARCH_RESULTS_PAGE(TimeRequired timeRequired) {
	...
	public SEARCH_RESULTS_PAGE(TranslationOfWork translationOfWork) {
	...
	public SEARCH_RESULTS_PAGE(Translator translator) {
	...
	public SEARCH_RESULTS_PAGE(TypicalAgeRange typicalAgeRange) {
	...
	public SEARCH_RESULTS_PAGE(Url url) {
		setUrl(url);
	}
	...
	public SEARCH_RESULTS_PAGE(Version version) {
		setVersion(version);
	}
	...
	public SEARCH_RESULTS_PAGE(Video video) {
		setVideo(video);
	}
	...
	public SEARCH_RESULTS_PAGE(WorkExample workExample) {
	...
	public SEARCH_RESULTS_PAGE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.SearchResultsPage org) {
		setSeq(org.getSeq());
