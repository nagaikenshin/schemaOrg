...
public class ART_MEDIUM implements Container.ArtMedium {
	...
	public ART_MEDIUM(BusOrCoach busOrCoach) {
	...
	public ART_MEDIUM(IndividualProduct individualProduct) {
	...
	public ART_MEDIUM(Motorcycle motorcycle) {
	...
	public ART_MEDIUM(MotorizedBicycle motorizedBicycle) {
	...
	public ART_MEDIUM(ProductModel productModel) {
	...
	public ART_MEDIUM(SomeProducts someProducts) {
	...
	public ART_MEDIUM(Vehicle vehicle) {
	...
	public ART_MEDIUM(List<BusOrCoach> busOrCoachList,
			List<Car> carList,
