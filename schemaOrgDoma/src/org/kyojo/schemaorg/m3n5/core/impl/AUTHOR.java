...
public class AUTHOR implements Container.Author {
	...
	public AUTHOR(AccountingService accountingService) {
	...
	public AUTHOR(AdultEntertainment adultEntertainment) {
	...
	public AUTHOR(AmusementPark amusementPark) {
	...
	public AUTHOR(AnimalShelter animalShelter) {
	...
	public AUTHOR(ArchiveOrganization archiveOrganization) {
	...
	public AUTHOR(ArtGallery artGallery) {
	...
	public AUTHOR(Attorney attorney) {
	...
	public AUTHOR(AutoBodyShop autoBodyShop) {
	...
	public AUTHOR(AutoDealer autoDealer) {
	...
	public AUTHOR(AutoPartsStore autoPartsStore) {
	...
	public AUTHOR(AutoRental autoRental) {
	...
	public AUTHOR(AutoRepair autoRepair) {
	...
	public AUTHOR(AutoWash autoWash) {
	...
	public AUTHOR(AutomatedTeller automatedTeller) {
	...
	public AUTHOR(AutomotiveBusiness automotiveBusiness) {
	...
	public AUTHOR(BankOrCreditUnion bankOrCreditUnion) {
	...
	public AUTHOR(BarOrPub barOrPub) {
	...
	public AUTHOR(BeautySalon beautySalon) {
	...
	public AUTHOR(BedAndBreakfast bedAndBreakfast) {
	...
	public AUTHOR(BikeStore bikeStore) {
	...
	public AUTHOR(BookStore bookStore) {
	...
	public AUTHOR(BowlingAlley bowlingAlley) {
	...
	public AUTHOR(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public AUTHOR(Campground campground) {
	...
	public AUTHOR(ChildCare childCare) {
	...
	public AUTHOR(ClothingStore clothingStore) {
	...
	public AUTHOR(CollegeOrUniversity collegeOrUniversity) {
	...
	public AUTHOR(ComedyClub comedyClub) {
	...
	public AUTHOR(CommunityHealth communityHealth) {
	...
	public AUTHOR(ComputerStore computerStore) {
	...
	public AUTHOR(Consortium consortium) {
	...
	public AUTHOR(ConvenienceStore convenienceStore) {
	...
	public AUTHOR(Corporation corporation) {
	...
	public AUTHOR(DanceGroup danceGroup) {
	...
	public AUTHOR(DepartmentStore departmentStore) {
	...
	public AUTHOR(Dermatology dermatology) {
	...
	public AUTHOR(DiagnosticLab diagnosticLab) {
	...
	public AUTHOR(DietNutrition dietNutrition) {
	...
	public AUTHOR(Distillery distillery) {
	...
	public AUTHOR(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public AUTHOR(EducationalOrganization educationalOrganization) {
	...
	public AUTHOR(Electrician electrician) {
	...
	public AUTHOR(ElectronicsStore electronicsStore) {
	...
	public AUTHOR(ElementarySchool elementarySchool) {
	...
	public AUTHOR(Emergency emergency) {
	...
	public AUTHOR(EmergencyService emergencyService) {
	...
	public AUTHOR(EmploymentAgency employmentAgency) {
	...
	public AUTHOR(EntertainmentBusiness entertainmentBusiness) {
	...
	public AUTHOR(ExerciseGym exerciseGym) {
	...
	public AUTHOR(FastFoodRestaurant fastFoodRestaurant) {
	...
	public AUTHOR(FinancialService financialService) {
	...
	public AUTHOR(FireStation fireStation) {
	...
	public AUTHOR(FoodEstablishment foodEstablishment) {
	...
	public AUTHOR(FundingAgency fundingAgency) {
	...
	public AUTHOR(FundingScheme fundingScheme) {
	...
	public AUTHOR(FurnitureStore furnitureStore) {
	...
	public AUTHOR(GardenStore gardenStore) {
	...
	public AUTHOR(GasStation gasStation) {
	...
	public AUTHOR(GeneralContractor generalContractor) {
	...
	public AUTHOR(Geriatric geriatric) {
	...
	public AUTHOR(GolfCourse golfCourse) {
	...
	public AUTHOR(GovernmentOffice governmentOffice) {
	...
	public AUTHOR(GovernmentOrganization governmentOrganization) {
	...
	public AUTHOR(GroceryStore groceryStore) {
	...
	public AUTHOR(Gynecologic gynecologic) {
	...
	public AUTHOR(HVACBusiness hvacBusiness) {
	...
	public AUTHOR(HairSalon hairSalon) {
	...
	public AUTHOR(HardwareStore hardwareStore) {
	...
	public AUTHOR(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public AUTHOR(HealthClub healthClub) {
	...
	public AUTHOR(HighSchool highSchool) {
	...
	public AUTHOR(HobbyShop hobbyShop) {
	...
	public AUTHOR(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public AUTHOR(HomeGoodsStore homeGoodsStore) {
	...
	public AUTHOR(Hospital hospital) {
	...
	public AUTHOR(HousePainter housePainter) {
	...
	public AUTHOR(IceCreamShop iceCreamShop) {
	...
	public AUTHOR(InsuranceAgency insuranceAgency) {
	...
	public AUTHOR(InternetCafe internetCafe) {
	...
	public AUTHOR(JewelryStore jewelryStore) {
	...
	public AUTHOR(LegalService legalService) {
	...
	public AUTHOR(LibrarySystem librarySystem) {
	...
	public AUTHOR(LiquorStore liquorStore) {
	...
	public AUTHOR(LocalBusiness localBusiness) {
	...
	public AUTHOR(Locksmith locksmith) {
	...
	public AUTHOR(LodgingBusiness lodgingBusiness) {
	...
	public AUTHOR(MedicalBusiness medicalBusiness) {
	...
	public AUTHOR(MedicalClinic medicalClinic) {
	...
	public AUTHOR(MedicalOrganization medicalOrganization) {
	...
	public AUTHOR(MensClothingStore mensClothingStore) {
	...
	public AUTHOR(MiddleSchool middleSchool) {
	...
	public AUTHOR(Midwifery midwifery) {
	...
	public AUTHOR(MobilePhoneStore mobilePhoneStore) {
	...
	public AUTHOR(MotorcycleDealer motorcycleDealer) {
	...
	public AUTHOR(MotorcycleRepair motorcycleRepair) {
	...
	public AUTHOR(MovieRentalStore movieRentalStore) {
	...
	public AUTHOR(MovieTheater movieTheater) {
	...
	public AUTHOR(MovingCompany movingCompany) {
	...
	public AUTHOR(MusicGroup musicGroup) {
	...
	public AUTHOR(MusicStore musicStore) {
	...
	public AUTHOR(NailSalon nailSalon) {
	...
	public AUTHOR(NewsMediaOrganization newsMediaOrganization) {
	...
	public AUTHOR(NightClub nightClub) {
	...
	public AUTHOR(Obstetric obstetric) {
	...
	public AUTHOR(OfficeEquipmentStore officeEquipmentStore) {
	...
	public AUTHOR(Oncologic oncologic) {
	...
	public AUTHOR(Optician optician) {
	...
	public AUTHOR(Optometric optometric) {
	...
	public AUTHOR(Otolaryngologic otolaryngologic) {
	...
	public AUTHOR(OutletStore outletStore) {
	...
	public AUTHOR(PawnShop pawnShop) {
	...
	public AUTHOR(Pediatric pediatric) {
	...
	public AUTHOR(PerformingGroup performingGroup) {
	...
	public AUTHOR(PetStore petStore) {
	...
	public AUTHOR(Pharmacy pharmacy) {
	...
	public AUTHOR(Physician physician) {
	...
	public AUTHOR(Physiotherapy physiotherapy) {
	...
	public AUTHOR(PlasticSurgery plasticSurgery) {
	...
	public AUTHOR(Podiatric podiatric) {
	...
	public AUTHOR(PoliceStation policeStation) {
	...
	public AUTHOR(PostOffice postOffice) {
	...
	public AUTHOR(Preschool preschool) {
	...
	public AUTHOR(PrimaryCare primaryCare) {
	...
	public AUTHOR(ProfessionalService professionalService) {
	...
	public AUTHOR(Psychiatric psychiatric) {
	...
	public AUTHOR(PublicHealth publicHealth) {
	...
	public AUTHOR(PublicSwimmingPool publicSwimmingPool) {
	...
	public AUTHOR(RadioStation radioStation) {
	...
	public AUTHOR(RealEstateAgent realEstateAgent) {
	...
	public AUTHOR(RecyclingCenter recyclingCenter) {
	...
	public AUTHOR(ResearchProject researchProject) {
	...
	public AUTHOR(Restaurant restaurant) {
	...
	public AUTHOR(RoofingContractor roofingContractor) {
	...
	public AUTHOR(SelfStorage selfStorage) {
	...
	public AUTHOR(ShoeStore shoeStore) {
	...
	public AUTHOR(ShoppingCenter shoppingCenter) {
	...
	public AUTHOR(SkiResort skiResort) {
	...
	public AUTHOR(SportingGoodsStore sportingGoodsStore) {
	...
	public AUTHOR(SportsActivityLocation sportsActivityLocation) {
	...
	public AUTHOR(SportsClub sportsClub) {
	...
	public AUTHOR(SportsOrganization sportsOrganization) {
	...
	public AUTHOR(SportsTeam sportsTeam) {
	...
	public AUTHOR(StadiumOrArena stadiumOrArena) {
	...
	public AUTHOR(TattooParlor tattooParlor) {
	...
	public AUTHOR(TelevisionStation televisionStation) {
	...
	public AUTHOR(TennisComplex tennisComplex) {
	...
	public AUTHOR(TheaterGroup theaterGroup) {
	...
	public AUTHOR(TireShop tireShop) {
	...
	public AUTHOR(TouristInformationCenter touristInformationCenter) {
	...
	public AUTHOR(ToyStore toyStore) {
	...
	public AUTHOR(TravelAgency travelAgency) {
	...
	public AUTHOR(VeterinaryCare veterinaryCare) {
	...
	public AUTHOR(WholesaleStore wholesaleStore) {
	...
	public AUTHOR(WorkersUnion workersUnion) {
	...
	public void copy(Container.Author org) {
