...
public class PARTICIPANT implements Container.Participant {
	...
	public PARTICIPANT(AccountingService accountingService) {
	...
	public PARTICIPANT(AdultEntertainment adultEntertainment) {
	...
	public PARTICIPANT(Airline airline) {
	...
	public PARTICIPANT(AmusementPark amusementPark) {
	...
	public PARTICIPANT(AnimalShelter animalShelter) {
	...
	public PARTICIPANT(ArchiveOrganization archiveOrganization) {
	...
	public PARTICIPANT(ArtGallery artGallery) {
	...
	public PARTICIPANT(Attorney attorney) {
	...
	public PARTICIPANT(AutoBodyShop autoBodyShop) {
	...
	public PARTICIPANT(AutoDealer autoDealer) {
	...
	public PARTICIPANT(AutoPartsStore autoPartsStore) {
	...
	public PARTICIPANT(AutoRental autoRental) {
	...
	public PARTICIPANT(AutoRepair autoRepair) {
	...
	public PARTICIPANT(AutoWash autoWash) {
	...
	public PARTICIPANT(AutomatedTeller automatedTeller) {
	...
	public PARTICIPANT(AutomotiveBusiness automotiveBusiness) {
	...
	public PARTICIPANT(Bakery bakery) {
	...
	public PARTICIPANT(BankOrCreditUnion bankOrCreditUnion) {
	...
	public PARTICIPANT(BarOrPub barOrPub) {
	...
	public PARTICIPANT(BeautySalon beautySalon) {
	...
	public PARTICIPANT(BedAndBreakfast bedAndBreakfast) {
	...
	public PARTICIPANT(BikeStore bikeStore) {
	...
	public PARTICIPANT(BookStore bookStore) {
	...
	public PARTICIPANT(BowlingAlley bowlingAlley) {
	...
	public PARTICIPANT(Brewery brewery) {
	...
	public PARTICIPANT(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public PARTICIPANT(Campground campground) {
	...
	public PARTICIPANT(Casino casino) {
	...
	public PARTICIPANT(ChildCare childCare) {
	...
	public PARTICIPANT(ClothingStore clothingStore) {
	...
	public PARTICIPANT(CollegeOrUniversity collegeOrUniversity) {
	...
	public PARTICIPANT(ComedyClub comedyClub) {
	...
	public PARTICIPANT(CommunityHealth communityHealth) {
	...
	public PARTICIPANT(ComputerStore computerStore) {
	...
	public PARTICIPANT(Consortium consortium) {
	...
	public PARTICIPANT(ConvenienceStore convenienceStore) {
	...
	public PARTICIPANT(Corporation corporation) {
	...
	public PARTICIPANT(DanceGroup danceGroup) {
	...
	public PARTICIPANT(DaySpa daySpa) {
	...
	public PARTICIPANT(Dentist dentist) {
	...
	public PARTICIPANT(DepartmentStore departmentStore) {
	...
	public PARTICIPANT(Dermatology dermatology) {
	...
	public PARTICIPANT(DiagnosticLab diagnosticLab) {
	...
	public PARTICIPANT(DietNutrition dietNutrition) {
	...
	public PARTICIPANT(Distillery distillery) {
	...
	public PARTICIPANT(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public PARTICIPANT(EducationalOrganization educationalOrganization) {
	...
	public PARTICIPANT(Electrician electrician) {
	...
	public PARTICIPANT(ElectronicsStore electronicsStore) {
	...
	public PARTICIPANT(ElementarySchool elementarySchool) {
	...
	public PARTICIPANT(Emergency emergency) {
	...
	public PARTICIPANT(EmergencyService emergencyService) {
	...
	public PARTICIPANT(EmploymentAgency employmentAgency) {
	...
	public PARTICIPANT(EntertainmentBusiness entertainmentBusiness) {
	...
	public PARTICIPANT(ExerciseGym exerciseGym) {
	...
	public PARTICIPANT(FastFoodRestaurant fastFoodRestaurant) {
	...
	public PARTICIPANT(FinancialService financialService) {
	...
	public PARTICIPANT(FireStation fireStation) {
	...
	public PARTICIPANT(Florist florist) {
	...
	public PARTICIPANT(FoodEstablishment foodEstablishment) {
	...
	public PARTICIPANT(FundingAgency fundingAgency) {
	...
	public PARTICIPANT(FundingScheme fundingScheme) {
	...
	public PARTICIPANT(FurnitureStore furnitureStore) {
	...
	public PARTICIPANT(GardenStore gardenStore) {
	...
	public PARTICIPANT(GasStation gasStation) {
	...
	public PARTICIPANT(GeneralContractor generalContractor) {
	...
	public PARTICIPANT(Geriatric geriatric) {
	...
	public PARTICIPANT(GolfCourse golfCourse) {
	...
	public PARTICIPANT(GovernmentOffice governmentOffice) {
	...
	public PARTICIPANT(GovernmentOrganization governmentOrganization) {
	...
	public PARTICIPANT(GroceryStore groceryStore) {
	...
	public PARTICIPANT(Gynecologic gynecologic) {
	...
	public PARTICIPANT(HVACBusiness hvacBusiness) {
	...
	public PARTICIPANT(HairSalon hairSalon) {
	...
	public PARTICIPANT(HardwareStore hardwareStore) {
	...
	public PARTICIPANT(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public PARTICIPANT(HealthClub healthClub) {
	...
	public PARTICIPANT(HighSchool highSchool) {
	...
	public PARTICIPANT(HobbyShop hobbyShop) {
	...
	public PARTICIPANT(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public PARTICIPANT(HomeGoodsStore homeGoodsStore) {
	...
	public PARTICIPANT(Hospital hospital) {
	...
	public PARTICIPANT(Hostel hostel) {
	...
	public PARTICIPANT(Hotel hotel) {
	...
	public PARTICIPANT(HousePainter housePainter) {
	...
	public PARTICIPANT(IceCreamShop iceCreamShop) {
	...
	public PARTICIPANT(InsuranceAgency insuranceAgency) {
	...
	public PARTICIPANT(InternetCafe internetCafe) {
	...
	public PARTICIPANT(JewelryStore jewelryStore) {
	...
	public PARTICIPANT(LegalService legalService) {
	...
	public PARTICIPANT(Library library) {
	...
	public PARTICIPANT(LibrarySystem librarySystem) {
	...
	public PARTICIPANT(LiquorStore liquorStore) {
	...
	public PARTICIPANT(LocalBusiness localBusiness) {
	...
	public PARTICIPANT(Locksmith locksmith) {
	...
	public PARTICIPANT(LodgingBusiness lodgingBusiness) {
	...
	public PARTICIPANT(MedicalBusiness medicalBusiness) {
	...
	public PARTICIPANT(MedicalClinic medicalClinic) {
	...
	public PARTICIPANT(MedicalOrganization medicalOrganization) {
	...
	public PARTICIPANT(MensClothingStore mensClothingStore) {
	...
	public PARTICIPANT(MiddleSchool middleSchool) {
	...
	public PARTICIPANT(Midwifery midwifery) {
	...
	public PARTICIPANT(MobilePhoneStore mobilePhoneStore) {
	...
	public PARTICIPANT(Motel motel) {
	...
	public PARTICIPANT(MotorcycleDealer motorcycleDealer) {
	...
	public PARTICIPANT(MotorcycleRepair motorcycleRepair) {
	...
	public PARTICIPANT(MovieRentalStore movieRentalStore) {
	...
	public PARTICIPANT(MovieTheater movieTheater) {
	...
	public PARTICIPANT(MovingCompany movingCompany) {
	...
	public PARTICIPANT(MusicGroup musicGroup) {
	...
	public PARTICIPANT(MusicStore musicStore) {
	...
	public PARTICIPANT(NailSalon nailSalon) {
	...
	public PARTICIPANT(NewsMediaOrganization newsMediaOrganization) {
	...
	public PARTICIPANT(NightClub nightClub) {
	...
	public PARTICIPANT(Notary notary) {
	...
	public PARTICIPANT(Nursing nursing) {
	...
	public PARTICIPANT(Obstetric obstetric) {
	...
	public PARTICIPANT(OfficeEquipmentStore officeEquipmentStore) {
	...
	public PARTICIPANT(Oncologic oncologic) {
	...
	public PARTICIPANT(Optician optician) {
	...
	public PARTICIPANT(Optometric optometric) {
	...
	public PARTICIPANT(Otolaryngologic otolaryngologic) {
	...
	public PARTICIPANT(OutletStore outletStore) {
	...
	public PARTICIPANT(Patient patient) {
	...
	public PARTICIPANT(PawnShop pawnShop) {
	...
	public PARTICIPANT(Pediatric pediatric) {
	...
	public PARTICIPANT(PerformingGroup performingGroup) {
	...
	public PARTICIPANT(PetStore petStore) {
	...
	public PARTICIPANT(Pharmacy pharmacy) {
	...
	public PARTICIPANT(Physician physician) {
	...
	public PARTICIPANT(Physiotherapy physiotherapy) {
	...
	public PARTICIPANT(PlasticSurgery plasticSurgery) {
	...
	public PARTICIPANT(Plumber plumber) {
	...
	public PARTICIPANT(Podiatric podiatric) {
	...
	public PARTICIPANT(PoliceStation policeStation) {
	...
	public PARTICIPANT(PostOffice postOffice) {
	...
	public PARTICIPANT(Preschool preschool) {
	...
	public PARTICIPANT(PrimaryCare primaryCare) {
	...
	public PARTICIPANT(ProfessionalService professionalService) {
	...
	public PARTICIPANT(Psychiatric psychiatric) {
	...
	public PARTICIPANT(PublicHealth publicHealth) {
	...
	public PARTICIPANT(PublicSwimmingPool publicSwimmingPool) {
	...
	public PARTICIPANT(RadioStation radioStation) {
	...
	public PARTICIPANT(RealEstateAgent realEstateAgent) {
	...
	public PARTICIPANT(RecyclingCenter recyclingCenter) {
	...
	public PARTICIPANT(ResearchProject researchProject) {
	...
	public PARTICIPANT(Resort resort) {
	...
	public PARTICIPANT(Restaurant restaurant) {
	...
	public PARTICIPANT(RoofingContractor roofingContractor) {
	...
	public PARTICIPANT(School school) {
	...
	public PARTICIPANT(SelfStorage selfStorage) {
	...
	public PARTICIPANT(ShoeStore shoeStore) {
	...
	public PARTICIPANT(ShoppingCenter shoppingCenter) {
	...
	public PARTICIPANT(SkiResort skiResort) {
	...
	public PARTICIPANT(SportingGoodsStore sportingGoodsStore) {
	...
	public PARTICIPANT(SportsActivityLocation sportsActivityLocation) {
	...
	public PARTICIPANT(SportsClub sportsClub) {
	...
	public PARTICIPANT(SportsOrganization sportsOrganization) {
	...
	public PARTICIPANT(SportsTeam sportsTeam) {
	...
	public PARTICIPANT(StadiumOrArena stadiumOrArena) {
	...
	public PARTICIPANT(Store store) {
	...
	public PARTICIPANT(TattooParlor tattooParlor) {
	...
	public PARTICIPANT(TelevisionStation televisionStation) {
	...
	public PARTICIPANT(TennisComplex tennisComplex) {
	...
	public PARTICIPANT(TheaterGroup theaterGroup) {
	...
	public PARTICIPANT(TireShop tireShop) {
	...
	public PARTICIPANT(TouristInformationCenter touristInformationCenter) {
	...
	public PARTICIPANT(ToyStore toyStore) {
	...
	public PARTICIPANT(TravelAgency travelAgency) {
	...
	public PARTICIPANT(VeterinaryCare veterinaryCare) {
	...
	public PARTICIPANT(WholesaleStore wholesaleStore) {
	...
	public PARTICIPANT(Winery winery) {
	...
	public PARTICIPANT(WorkersUnion workersUnion) {
	...
	public void copy(Container.Participant org) {
