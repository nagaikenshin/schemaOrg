...
public class MOVIE_CLIP implements Clazz.MovieClip {
	...
	public MOVIE_CLIP(Long seq) {
		setSeq(seq);
	}

	public MOVIE_CLIP(String string) {
	...
	public MOVIE_CLIP(AccessMode accessMode) {
	...
	public MOVIE_CLIP(AccessModeSufficient accessModeSufficient) {
	...
	public MOVIE_CLIP(AccessibilityAPI accessibilityAPI) {
	...
	public MOVIE_CLIP(AccessibilityControl accessibilityControl) {
	...
	public MOVIE_CLIP(AccessibilityFeature accessibilityFeature) {
	...
	public MOVIE_CLIP(AccessibilityHazard accessibilityHazard) {
	...
	public MOVIE_CLIP(AccessibilitySummary accessibilitySummary) {
	...
	public MOVIE_CLIP(AccountablePerson accountablePerson) {
	...
	public MOVIE_CLIP(AdditionalType additionalType) {
	...
	public MOVIE_CLIP(AggregateRating aggregateRating) {
	...
	public MOVIE_CLIP(AlternateName alternateName) {
	...
	public MOVIE_CLIP(AlternativeHeadline alternativeHeadline) {
	...
	public MOVIE_CLIP(AssociatedMedia associatedMedia) {
	...
	public MOVIE_CLIP(Audience audience) {
	...
	public MOVIE_CLIP(Author author) {
		setAuthor(author);
	}
	...
	public MOVIE_CLIP(Character character) {
	...
	public MOVIE_CLIP(Citation citation) {
	...
	public MOVIE_CLIP(ClipNumber clipNumber) {
	...
	public MOVIE_CLIP(Comment comment) {
		setComment(comment);
	}
	...
	public MOVIE_CLIP(CommentCount commentCount) {
	...
	public MOVIE_CLIP(ContentLocation contentLocation) {
	...
	public MOVIE_CLIP(ContentRating contentRating) {
	...
	public MOVIE_CLIP(ContentReferenceTime contentReferenceTime) {
	...
	public MOVIE_CLIP(Contributor contributor) {
	...
	public MOVIE_CLIP(CopyrightHolder copyrightHolder) {
	...
	public MOVIE_CLIP(CopyrightYear copyrightYear) {
	...
	public MOVIE_CLIP(Correction correction) {
	...
	public MOVIE_CLIP(Creator creator) {
		setCreator(creator);
	}
	...
	public MOVIE_CLIP(DateCreated dateCreated) {
	...
	public MOVIE_CLIP(DateModified dateModified) {
	...
	public MOVIE_CLIP(DatePublished datePublished) {
	...
	public MOVIE_CLIP(Description description) {
	...
	public MOVIE_CLIP(Director director) {
	...
	public MOVIE_CLIP(DisambiguatingDescription disambiguatingDescription) {
	...
	public MOVIE_CLIP(DiscussionUrl discussionUrl) {
	...
	public MOVIE_CLIP(Editor editor) {
		setEditor(editor);
	}
	...
	public MOVIE_CLIP(EducationalAlignment educationalAlignment) {
	...
	public MOVIE_CLIP(EducationalUse educationalUse) {
	...
	public MOVIE_CLIP(Encoding encoding) {
	...
	public MOVIE_CLIP(EncodingFormat encodingFormat) {
	...
	public MOVIE_CLIP(EndOffset endOffset) {
	...
	public MOVIE_CLIP(ExampleOfWork exampleOfWork) {
	...
	public MOVIE_CLIP(Expires expires) {
		setExpires(expires);
	}
	...
	public MOVIE_CLIP(Funder funder) {
		setFunder(funder);
	}
	...
	public MOVIE_CLIP(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public MOVIE_CLIP(Headline headline) {
	...
	public MOVIE_CLIP(Identifier identifier) {
	...
	public MOVIE_CLIP(InLanguage inLanguage) {
	...
	public MOVIE_CLIP(InteractionStatistic interactionStatistic) {
	...
	public MOVIE_CLIP(InteractivityType interactivityType) {
	...
	public MOVIE_CLIP(IsAccessibleForFree isAccessibleForFree) {
	...
	public MOVIE_CLIP(IsBasedOn isBasedOn) {
	...
	public MOVIE_CLIP(IsFamilyFriendly isFamilyFriendly) {
	...
	public MOVIE_CLIP(IsPartOf isPartOf) {
	...
	public MOVIE_CLIP(Keywords keywords) {
	...
	public MOVIE_CLIP(LearningResourceType learningResourceType) {
	...
	public MOVIE_CLIP(License license) {
		setLicense(license);
	}
	...
	public MOVIE_CLIP(LocationCreated locationCreated) {
	...
	public MOVIE_CLIP(MainEntity mainEntity) {
	...
	public MOVIE_CLIP(MainEntityOfPage mainEntityOfPage) {
	...
	public MOVIE_CLIP(Material material) {
	...
	public MOVIE_CLIP(MaterialExtent materialExtent) {
	...
	public MOVIE_CLIP(Mentions mentions) {
	...
	public MOVIE_CLIP(MusicBy musicBy) {
		setMusicBy(musicBy);
	}
	...
	public MOVIE_CLIP(NameFuzzy nameFuzzy) {
	...
	public MOVIE_CLIP(NameRuby nameRuby) {
	...
	public MOVIE_CLIP(Offers offers) {
		setOffers(offers);
	}
	...
	public MOVIE_CLIP(PartOfEpisode partOfEpisode) {
	...
	public MOVIE_CLIP(PartOfSeason partOfSeason) {
	...
	public MOVIE_CLIP(PartOfSeries partOfSeries) {
	...
	public MOVIE_CLIP(Position position) {
	...
	public MOVIE_CLIP(PotentialAction potentialAction) {
	...
	public MOVIE_CLIP(Producer producer) {
	...
	public MOVIE_CLIP(Provider provider) {
	...
	public MOVIE_CLIP(Publication publication) {
	...
	public MOVIE_CLIP(Publisher publisher) {
	...
	public MOVIE_CLIP(PublisherImprint publisherImprint) {
	...
	public MOVIE_CLIP(PublishingPrinciples publishingPrinciples) {
	...
	public MOVIE_CLIP(RecordedAt recordedAt) {
	...
	public MOVIE_CLIP(ReleasedEvent releasedEvent) {
	...
	public MOVIE_CLIP(Review review) {
		setReview(review);
	}
	...
	public MOVIE_CLIP(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MOVIE_CLIP(SchemaVersion schemaVersion) {
	...
	public MOVIE_CLIP(SdDatePublished sdDatePublished) {
	...
	public MOVIE_CLIP(SdLicense sdLicense) {
	...
	public MOVIE_CLIP(SdPublisher sdPublisher) {
	...
	public MOVIE_CLIP(SourceOrganization sourceOrganization) {
	...
	public MOVIE_CLIP(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public MOVIE_CLIP(SpatialCoverage spatialCoverage) {
	...
	public MOVIE_CLIP(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MOVIE_CLIP(StartOffset startOffset) {
	...
	public MOVIE_CLIP(SubjectOf subjectOf) {
	...
	public MOVIE_CLIP(Temporal temporal) {
	...
	public MOVIE_CLIP(TemporalCoverage temporalCoverage) {
	...
	public MOVIE_CLIP(ThumbnailUrl thumbnailUrl) {
	...
	public MOVIE_CLIP(TimeRequired timeRequired) {
	...
	public MOVIE_CLIP(TranslationOfWork translationOfWork) {
	...
	public MOVIE_CLIP(Translator translator) {
	...
	public MOVIE_CLIP(TypicalAgeRange typicalAgeRange) {
	...
	public MOVIE_CLIP(Version version) {
		setVersion(version);
	}
	...
	public MOVIE_CLIP(WorkExample workExample) {
	...
	public MOVIE_CLIP(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.MovieClip org) {
		setSeq(org.getSeq());
