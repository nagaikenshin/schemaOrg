...
public class DEPARTMENT_STORE implements Clazz.DepartmentStore {
	...
	public DEPARTMENT_STORE(GeoContains geoContains) {
	...
	public DEPARTMENT_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public DEPARTMENT_STORE(GeoCovers geoCovers) {
	...
	public DEPARTMENT_STORE(GeoCrosses geoCrosses) {
	...
	public DEPARTMENT_STORE(GeoDisjoint geoDisjoint) {
	...
	public DEPARTMENT_STORE(GeoEquals geoEquals) {
	...
	public DEPARTMENT_STORE(GeoIntersects geoIntersects) {
	...
	public DEPARTMENT_STORE(GeoOverlaps geoOverlaps) {
	...
	public DEPARTMENT_STORE(GeoTouches geoTouches) {
	...
	public DEPARTMENT_STORE(GeoWithin geoWithin) {
	...
	public DEPARTMENT_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
