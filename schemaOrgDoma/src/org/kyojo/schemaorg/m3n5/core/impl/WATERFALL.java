...
public class WATERFALL implements Clazz.Waterfall {
	...
	public WATERFALL(GeoContains geoContains) {
	...
	public WATERFALL(GeoCoveredBy geoCoveredBy) {
	...
	public WATERFALL(GeoCovers geoCovers) {
	...
	public WATERFALL(GeoCrosses geoCrosses) {
	...
	public WATERFALL(GeoDisjoint geoDisjoint) {
	...
	public WATERFALL(GeoEquals geoEquals) {
	...
	public WATERFALL(GeoIntersects geoIntersects) {
	...
	public WATERFALL(GeoOverlaps geoOverlaps) {
	...
	public WATERFALL(GeoTouches geoTouches) {
	...
	public WATERFALL(GeoWithin geoWithin) {
	...
	public WATERFALL(Slogan slogan) {
		setSlogan(slogan);
	}
