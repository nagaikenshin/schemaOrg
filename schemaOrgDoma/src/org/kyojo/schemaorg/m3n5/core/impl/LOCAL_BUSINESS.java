...
public class LOCAL_BUSINESS implements Clazz.LocalBusiness {
	...
	public LOCAL_BUSINESS(GeoContains geoContains) {
	...
	public LOCAL_BUSINESS(GeoCoveredBy geoCoveredBy) {
	...
	public LOCAL_BUSINESS(GeoCovers geoCovers) {
	...
	public LOCAL_BUSINESS(GeoCrosses geoCrosses) {
	...
	public LOCAL_BUSINESS(GeoDisjoint geoDisjoint) {
	...
	public LOCAL_BUSINESS(GeoEquals geoEquals) {
	...
	public LOCAL_BUSINESS(GeoIntersects geoIntersects) {
	...
	public LOCAL_BUSINESS(GeoOverlaps geoOverlaps) {
	...
	public LOCAL_BUSINESS(GeoTouches geoTouches) {
	...
	public LOCAL_BUSINESS(GeoWithin geoWithin) {
	...
	public LOCAL_BUSINESS(Slogan slogan) {
		setSlogan(slogan);
	}
