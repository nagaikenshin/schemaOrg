...
public class DIGITAL_DOCUMENT implements Clazz.DigitalDocument {
	...
	public DIGITAL_DOCUMENT() {
	}

	public DIGITAL_DOCUMENT(Long seq) {
		setSeq(seq);
	}

	public DIGITAL_DOCUMENT(String string) {
	...
	public DIGITAL_DOCUMENT(About about) {
		setAbout(about);
	}
	...
	public DIGITAL_DOCUMENT(AccessMode accessMode) {
	...
	public DIGITAL_DOCUMENT(AccessModeSufficient accessModeSufficient) {
	...
	public DIGITAL_DOCUMENT(AccessibilityAPI accessibilityAPI) {
	...
	public DIGITAL_DOCUMENT(AccessibilityControl accessibilityControl) {
	...
	public DIGITAL_DOCUMENT(AccessibilityFeature accessibilityFeature) {
	...
	public DIGITAL_DOCUMENT(AccessibilityHazard accessibilityHazard) {
	...
	public DIGITAL_DOCUMENT(AccessibilitySummary accessibilitySummary) {
	...
	public DIGITAL_DOCUMENT(AccountablePerson accountablePerson) {
	...
	public DIGITAL_DOCUMENT(AdditionalType additionalType) {
	...
	public DIGITAL_DOCUMENT(AggregateRating aggregateRating) {
	...
	public DIGITAL_DOCUMENT(AlternateName alternateName) {
	...
	public DIGITAL_DOCUMENT(AlternativeHeadline alternativeHeadline) {
	...
	public DIGITAL_DOCUMENT(AssociatedMedia associatedMedia) {
	...
	public DIGITAL_DOCUMENT(Audience audience) {
	...
	public DIGITAL_DOCUMENT(Audio audio) {
		setAudio(audio);
	}
	...
	public DIGITAL_DOCUMENT(Author author) {
		setAuthor(author);
	}
	...
	public DIGITAL_DOCUMENT(Award award) {
		setAward(award);
	}
	...
	public DIGITAL_DOCUMENT(Character character) {
	...
	public DIGITAL_DOCUMENT(Citation citation) {
	...
	public DIGITAL_DOCUMENT(Comment comment) {
		setComment(comment);
	}
	...
	public DIGITAL_DOCUMENT(CommentCount commentCount) {
	...
	public DIGITAL_DOCUMENT(ContentLocation contentLocation) {
	...
	public DIGITAL_DOCUMENT(ContentRating contentRating) {
	...
	public DIGITAL_DOCUMENT(ContentReferenceTime contentReferenceTime) {
	...
	public DIGITAL_DOCUMENT(Contributor contributor) {
	...
	public DIGITAL_DOCUMENT(CopyrightHolder copyrightHolder) {
	...
	public DIGITAL_DOCUMENT(CopyrightYear copyrightYear) {
	...
	public DIGITAL_DOCUMENT(Correction correction) {
	...
	public DIGITAL_DOCUMENT(Creator creator) {
		setCreator(creator);
	}
	...
	public DIGITAL_DOCUMENT(DateCreated dateCreated) {
	...
	public DIGITAL_DOCUMENT(DateModified dateModified) {
	...
	public DIGITAL_DOCUMENT(DatePublished datePublished) {
	...
	public DIGITAL_DOCUMENT(Description description) {
	...
	public DIGITAL_DOCUMENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public DIGITAL_DOCUMENT(DiscussionUrl discussionUrl) {
	...
	public DIGITAL_DOCUMENT(Editor editor) {
		setEditor(editor);
	}
	...
	public DIGITAL_DOCUMENT(EducationalAlignment educationalAlignment) {
	...
	public DIGITAL_DOCUMENT(EducationalUse educationalUse) {
	...
	public DIGITAL_DOCUMENT(Encoding encoding) {
	...
	public DIGITAL_DOCUMENT(EncodingFormat encodingFormat) {
	...
	public DIGITAL_DOCUMENT(ExampleOfWork exampleOfWork) {
	...
	public DIGITAL_DOCUMENT(Expires expires) {
		setExpires(expires);
	}
	...
	public DIGITAL_DOCUMENT(Funder funder) {
		setFunder(funder);
	}
	...
	public DIGITAL_DOCUMENT(Genre genre) {
		setGenre(genre);
	}
	...
	public DIGITAL_DOCUMENT(HasDigitalDocumentPermission hasDigitalDocumentPermission) {
	...
	public DIGITAL_DOCUMENT(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public DIGITAL_DOCUMENT(Headline headline) {
	...
	public DIGITAL_DOCUMENT(Identifier identifier) {
	...
	public DIGITAL_DOCUMENT(Image image) {
		setImage(image);
	}
	...
	public DIGITAL_DOCUMENT(InLanguage inLanguage) {
	...
	public DIGITAL_DOCUMENT(InteractionStatistic interactionStatistic) {
	...
	public DIGITAL_DOCUMENT(InteractivityType interactivityType) {
	...
	public DIGITAL_DOCUMENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public DIGITAL_DOCUMENT(IsBasedOn isBasedOn) {
	...
	public DIGITAL_DOCUMENT(IsFamilyFriendly isFamilyFriendly) {
	...
	public DIGITAL_DOCUMENT(IsPartOf isPartOf) {
	...
	public DIGITAL_DOCUMENT(Keywords keywords) {
	...
	public DIGITAL_DOCUMENT(LearningResourceType learningResourceType) {
	...
	public DIGITAL_DOCUMENT(License license) {
		setLicense(license);
	}
	...
	public DIGITAL_DOCUMENT(LocationCreated locationCreated) {
	...
	public DIGITAL_DOCUMENT(MainEntity mainEntity) {
	...
	public DIGITAL_DOCUMENT(MainEntityOfPage mainEntityOfPage) {
	...
	public DIGITAL_DOCUMENT(Material material) {
	...
	public DIGITAL_DOCUMENT(MaterialExtent materialExtent) {
	...
	public DIGITAL_DOCUMENT(Mentions mentions) {
	...
	public DIGITAL_DOCUMENT(Name name) {
		setName(name);
	}
	...
	public DIGITAL_DOCUMENT(NameFuzzy nameFuzzy) {
	...
	public DIGITAL_DOCUMENT(NameRuby nameRuby) {
	...
	public DIGITAL_DOCUMENT(Offers offers) {
		setOffers(offers);
	}
	...
	public DIGITAL_DOCUMENT(Position position) {
	...
	public DIGITAL_DOCUMENT(PotentialAction potentialAction) {
	...
	public DIGITAL_DOCUMENT(Producer producer) {
	...
	public DIGITAL_DOCUMENT(Provider provider) {
	...
	public DIGITAL_DOCUMENT(Publication publication) {
	...
	public DIGITAL_DOCUMENT(Publisher publisher) {
	...
	public DIGITAL_DOCUMENT(PublisherImprint publisherImprint) {
	...
	public DIGITAL_DOCUMENT(PublishingPrinciples publishingPrinciples) {
	...
	public DIGITAL_DOCUMENT(RecordedAt recordedAt) {
	...
	public DIGITAL_DOCUMENT(ReleasedEvent releasedEvent) {
	...
	public DIGITAL_DOCUMENT(Review review) {
		setReview(review);
	}
	...
	public DIGITAL_DOCUMENT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DIGITAL_DOCUMENT(SchemaVersion schemaVersion) {
	...
	public DIGITAL_DOCUMENT(SdDatePublished sdDatePublished) {
	...
	public DIGITAL_DOCUMENT(SdLicense sdLicense) {
	...
	public DIGITAL_DOCUMENT(SdPublisher sdPublisher) {
	...
	public DIGITAL_DOCUMENT(SourceOrganization sourceOrganization) {
	...
	public DIGITAL_DOCUMENT(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public DIGITAL_DOCUMENT(SpatialCoverage spatialCoverage) {
	...
	public DIGITAL_DOCUMENT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public DIGITAL_DOCUMENT(SubjectOf subjectOf) {
	...
	public DIGITAL_DOCUMENT(Temporal temporal) {
	...
	public DIGITAL_DOCUMENT(TemporalCoverage temporalCoverage) {
	...
	public DIGITAL_DOCUMENT(Text text) {
		setText(text);
	}
	...
	public DIGITAL_DOCUMENT(ThumbnailUrl thumbnailUrl) {
	...
	public DIGITAL_DOCUMENT(TimeRequired timeRequired) {
	...
	public DIGITAL_DOCUMENT(TranslationOfWork translationOfWork) {
	...
	public DIGITAL_DOCUMENT(Translator translator) {
	...
	public DIGITAL_DOCUMENT(TypicalAgeRange typicalAgeRange) {
	...
	public DIGITAL_DOCUMENT(Url url) {
		setUrl(url);
	}
	...
	public DIGITAL_DOCUMENT(Version version) {
		setVersion(version);
	}
	...
	public DIGITAL_DOCUMENT(Video video) {
		setVideo(video);
	}
	...
	public DIGITAL_DOCUMENT(WorkExample workExample) {
	...
	public DIGITAL_DOCUMENT(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.DigitalDocument org) {
		setSeq(org.getSeq());
