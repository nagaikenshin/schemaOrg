...
public class VIDEO_GALLERY implements Clazz.VideoGallery {
	...
	public VIDEO_GALLERY(Long seq) {
		setSeq(seq);
	}

	public VIDEO_GALLERY(String string) {
	...
	public VIDEO_GALLERY(About about) {
		setAbout(about);
	}
	...
	public VIDEO_GALLERY(AccessMode accessMode) {
	...
	public VIDEO_GALLERY(AccessModeSufficient accessModeSufficient) {
	...
	public VIDEO_GALLERY(AccessibilityAPI accessibilityAPI) {
	...
	public VIDEO_GALLERY(AccessibilityControl accessibilityControl) {
	...
	public VIDEO_GALLERY(AccessibilityFeature accessibilityFeature) {
	...
	public VIDEO_GALLERY(AccessibilityHazard accessibilityHazard) {
	...
	public VIDEO_GALLERY(AccessibilitySummary accessibilitySummary) {
	...
	public VIDEO_GALLERY(AccountablePerson accountablePerson) {
	...
	public VIDEO_GALLERY(AdditionalType additionalType) {
	...
	public VIDEO_GALLERY(AggregateRating aggregateRating) {
	...
	public VIDEO_GALLERY(AlternateName alternateName) {
	...
	public VIDEO_GALLERY(AlternativeHeadline alternativeHeadline) {
	...
	public VIDEO_GALLERY(AssociatedMedia associatedMedia) {
	...
	public VIDEO_GALLERY(Audience audience) {
	...
	public VIDEO_GALLERY(Audio audio) {
		setAudio(audio);
	}
	...
	public VIDEO_GALLERY(Author author) {
		setAuthor(author);
	}
	...
	public VIDEO_GALLERY(Award award) {
		setAward(award);
	}
	...
	public VIDEO_GALLERY(Breadcrumb breadcrumb) {
	...
	public VIDEO_GALLERY(Character character) {
	...
	public VIDEO_GALLERY(Citation citation) {
	...
	public VIDEO_GALLERY(Comment comment) {
		setComment(comment);
	}
	...
	public VIDEO_GALLERY(CommentCount commentCount) {
	...
	public VIDEO_GALLERY(ContentLocation contentLocation) {
	...
	public VIDEO_GALLERY(ContentRating contentRating) {
	...
	public VIDEO_GALLERY(ContentReferenceTime contentReferenceTime) {
	...
	public VIDEO_GALLERY(Contributor contributor) {
	...
	public VIDEO_GALLERY(CopyrightHolder copyrightHolder) {
	...
	public VIDEO_GALLERY(CopyrightYear copyrightYear) {
	...
	public VIDEO_GALLERY(Correction correction) {
	...
	public VIDEO_GALLERY(Creator creator) {
		setCreator(creator);
	}
	...
	public VIDEO_GALLERY(DateCreated dateCreated) {
	...
	public VIDEO_GALLERY(DateModified dateModified) {
	...
	public VIDEO_GALLERY(DatePublished datePublished) {
	...
	public VIDEO_GALLERY(Description description) {
	...
	public VIDEO_GALLERY(DisambiguatingDescription disambiguatingDescription) {
	...
	public VIDEO_GALLERY(DiscussionUrl discussionUrl) {
	...
	public VIDEO_GALLERY(Editor editor) {
		setEditor(editor);
	}
	...
	public VIDEO_GALLERY(EducationalAlignment educationalAlignment) {
	...
	public VIDEO_GALLERY(EducationalUse educationalUse) {
	...
	public VIDEO_GALLERY(Encoding encoding) {
	...
	public VIDEO_GALLERY(EncodingFormat encodingFormat) {
	...
	public VIDEO_GALLERY(ExampleOfWork exampleOfWork) {
	...
	public VIDEO_GALLERY(Expires expires) {
		setExpires(expires);
	}
	...
	public VIDEO_GALLERY(Funder funder) {
		setFunder(funder);
	}
	...
	public VIDEO_GALLERY(Genre genre) {
		setGenre(genre);
	}
	...
	public VIDEO_GALLERY(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public VIDEO_GALLERY(Headline headline) {
	...
	public VIDEO_GALLERY(Identifier identifier) {
	...
	public VIDEO_GALLERY(Image image) {
		setImage(image);
	}
	...
	public VIDEO_GALLERY(InLanguage inLanguage) {
	...
	public VIDEO_GALLERY(InteractionStatistic interactionStatistic) {
	...
	public VIDEO_GALLERY(InteractivityType interactivityType) {
	...
	public VIDEO_GALLERY(IsAccessibleForFree isAccessibleForFree) {
	...
	public VIDEO_GALLERY(IsBasedOn isBasedOn) {
	...
	public VIDEO_GALLERY(IsFamilyFriendly isFamilyFriendly) {
	...
	public VIDEO_GALLERY(IsPartOf isPartOf) {
	...
	public VIDEO_GALLERY(Keywords keywords) {
	...
	public VIDEO_GALLERY(LastReviewed lastReviewed) {
	...
	public VIDEO_GALLERY(LearningResourceType learningResourceType) {
	...
	public VIDEO_GALLERY(License license) {
		setLicense(license);
	}
	...
	public VIDEO_GALLERY(LocationCreated locationCreated) {
	...
	public VIDEO_GALLERY(MainContentOfPage mainContentOfPage) {
	...
	public VIDEO_GALLERY(MainEntity mainEntity) {
	...
	public VIDEO_GALLERY(MainEntityOfPage mainEntityOfPage) {
	...
	public VIDEO_GALLERY(Material material) {
	...
	public VIDEO_GALLERY(MaterialExtent materialExtent) {
	...
	public VIDEO_GALLERY(Mentions mentions) {
	...
	public VIDEO_GALLERY(Name name) {
		setName(name);
	}
	...
	public VIDEO_GALLERY(NameFuzzy nameFuzzy) {
	...
	public VIDEO_GALLERY(NameRuby nameRuby) {
	...
	public VIDEO_GALLERY(Offers offers) {
		setOffers(offers);
	}
	...
	public VIDEO_GALLERY(Position position) {
	...
	public VIDEO_GALLERY(PotentialAction potentialAction) {
	...
	public VIDEO_GALLERY(PrimaryImageOfPage primaryImageOfPage) {
	...
	public VIDEO_GALLERY(Producer producer) {
	...
	public VIDEO_GALLERY(Provider provider) {
	...
	public VIDEO_GALLERY(Publication publication) {
	...
	public VIDEO_GALLERY(Publisher publisher) {
	...
	public VIDEO_GALLERY(PublisherImprint publisherImprint) {
	...
	public VIDEO_GALLERY(PublishingPrinciples publishingPrinciples) {
	...
	public VIDEO_GALLERY(RecordedAt recordedAt) {
	...
	public VIDEO_GALLERY(RelatedLink relatedLink) {
	...
	public VIDEO_GALLERY(ReleasedEvent releasedEvent) {
	...
	public VIDEO_GALLERY(Review review) {
		setReview(review);
	}
	...
	public VIDEO_GALLERY(ReviewedBy reviewedBy) {
	...
	public VIDEO_GALLERY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public VIDEO_GALLERY(SchemaVersion schemaVersion) {
	...
	public VIDEO_GALLERY(SdDatePublished sdDatePublished) {
	...
	public VIDEO_GALLERY(SdLicense sdLicense) {
	...
	public VIDEO_GALLERY(SdPublisher sdPublisher) {
	...
	public VIDEO_GALLERY(SignificantLink significantLink) {
	...
	public VIDEO_GALLERY(SourceOrganization sourceOrganization) {
	...
	public VIDEO_GALLERY(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public VIDEO_GALLERY(SpatialCoverage spatialCoverage) {
	...
	public VIDEO_GALLERY(Speakable speakable) {
	...
	public VIDEO_GALLERY(Specialty specialty) {
	...
	public VIDEO_GALLERY(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public VIDEO_GALLERY(SubjectOf subjectOf) {
	...
	public VIDEO_GALLERY(Temporal temporal) {
	...
	public VIDEO_GALLERY(TemporalCoverage temporalCoverage) {
	...
	public VIDEO_GALLERY(Text text) {
		setText(text);
	}
	...
	public VIDEO_GALLERY(ThumbnailUrl thumbnailUrl) {
	...
	public VIDEO_GALLERY(TimeRequired timeRequired) {
	...
	public VIDEO_GALLERY(TranslationOfWork translationOfWork) {
	...
	public VIDEO_GALLERY(Translator translator) {
	...
	public VIDEO_GALLERY(TypicalAgeRange typicalAgeRange) {
	...
	public VIDEO_GALLERY(Version version) {
		setVersion(version);
	}
	...
	public VIDEO_GALLERY(Video video) {
		setVideo(video);
	}
	...
	public VIDEO_GALLERY(WorkExample workExample) {
	...
	public VIDEO_GALLERY(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.VideoGallery org) {
		setSeq(org.getSeq());
