...
public class MEDIA_OBJECT implements Clazz.MediaObject {
	...
	public MEDIA_OBJECT(Long seq) {
		setSeq(seq);
	}

	public MEDIA_OBJECT(String string) {
	...
	public MEDIA_OBJECT(About about) {
		setAbout(about);
	}
	...
	public MEDIA_OBJECT(AccessMode accessMode) {
	...
	public MEDIA_OBJECT(AccessModeSufficient accessModeSufficient) {
	...
	public MEDIA_OBJECT(AccessibilityAPI accessibilityAPI) {
	...
	public MEDIA_OBJECT(AccessibilityControl accessibilityControl) {
	...
	public MEDIA_OBJECT(AccessibilityFeature accessibilityFeature) {
	...
	public MEDIA_OBJECT(AccessibilityHazard accessibilityHazard) {
	...
	public MEDIA_OBJECT(AccessibilitySummary accessibilitySummary) {
	...
	public MEDIA_OBJECT(AccountablePerson accountablePerson) {
	...
	public MEDIA_OBJECT(AdditionalType additionalType) {
	...
	public MEDIA_OBJECT(AggregateRating aggregateRating) {
	...
	public MEDIA_OBJECT(AlternateName alternateName) {
	...
	public MEDIA_OBJECT(AlternativeHeadline alternativeHeadline) {
	...
	public MEDIA_OBJECT(AssociatedArticle associatedArticle) {
	...
	public MEDIA_OBJECT(AssociatedMedia associatedMedia) {
	...
	public MEDIA_OBJECT(Audience audience) {
	...
	public MEDIA_OBJECT(Audio audio) {
		setAudio(audio);
	}
	...
	public MEDIA_OBJECT(Author author) {
		setAuthor(author);
	}
	...
	public MEDIA_OBJECT(Award award) {
		setAward(award);
	}
	...
	public MEDIA_OBJECT(Bitrate bitrate) {
		setBitrate(bitrate);
	}
	...
	public MEDIA_OBJECT(Character character) {
	...
	public MEDIA_OBJECT(Citation citation) {
	...
	public MEDIA_OBJECT(Comment comment) {
		setComment(comment);
	}
	...
	public MEDIA_OBJECT(CommentCount commentCount) {
	...
	public MEDIA_OBJECT(ContentLocation contentLocation) {
	...
	public MEDIA_OBJECT(ContentRating contentRating) {
	...
	public MEDIA_OBJECT(ContentReferenceTime contentReferenceTime) {
	...
	public MEDIA_OBJECT(ContentSize contentSize) {
	...
	public MEDIA_OBJECT(ContentUrl contentUrl) {
	...
	public MEDIA_OBJECT(Contributor contributor) {
	...
	public MEDIA_OBJECT(CopyrightHolder copyrightHolder) {
	...
	public MEDIA_OBJECT(CopyrightYear copyrightYear) {
	...
	public MEDIA_OBJECT(Correction correction) {
	...
	public MEDIA_OBJECT(Creator creator) {
		setCreator(creator);
	}
	...
	public MEDIA_OBJECT(DateCreated dateCreated) {
	...
	public MEDIA_OBJECT(DateModified dateModified) {
	...
	public MEDIA_OBJECT(DatePublished datePublished) {
	...
	public MEDIA_OBJECT(Description description) {
	...
	public MEDIA_OBJECT(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDIA_OBJECT(DiscussionUrl discussionUrl) {
	...
	public MEDIA_OBJECT(Duration duration) {
	...
	public MEDIA_OBJECT(Editor editor) {
		setEditor(editor);
	}
	...
	public MEDIA_OBJECT(EducationalAlignment educationalAlignment) {
	...
	public MEDIA_OBJECT(EducationalUse educationalUse) {
	...
	public MEDIA_OBJECT(EmbedUrl embedUrl) {
	...
	public MEDIA_OBJECT(EncodesCreativeWork encodesCreativeWork) {
	...
	public MEDIA_OBJECT(Encoding encoding) {
	...
	public MEDIA_OBJECT(EncodingFormat encodingFormat) {
	...
	public MEDIA_OBJECT(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public MEDIA_OBJECT(ExampleOfWork exampleOfWork) {
	...
	public MEDIA_OBJECT(Expires expires) {
		setExpires(expires);
	}
	...
	public MEDIA_OBJECT(Funder funder) {
		setFunder(funder);
	}
	...
	public MEDIA_OBJECT(Genre genre) {
		setGenre(genre);
	}
	...
	public MEDIA_OBJECT(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public MEDIA_OBJECT(Headline headline) {
	...
	public MEDIA_OBJECT(Height height) {
		setHeight(height);
	}
	...
	public MEDIA_OBJECT(Identifier identifier) {
	...
	public MEDIA_OBJECT(Image image) {
		setImage(image);
	}
	...
	public MEDIA_OBJECT(InLanguage inLanguage) {
	...
	public MEDIA_OBJECT(InteractionStatistic interactionStatistic) {
	...
	public MEDIA_OBJECT(InteractivityType interactivityType) {
	...
	public MEDIA_OBJECT(IsAccessibleForFree isAccessibleForFree) {
	...
	public MEDIA_OBJECT(IsBasedOn isBasedOn) {
	...
	public MEDIA_OBJECT(IsFamilyFriendly isFamilyFriendly) {
	...
	public MEDIA_OBJECT(IsPartOf isPartOf) {
	...
	public MEDIA_OBJECT(Keywords keywords) {
	...
	public MEDIA_OBJECT(LearningResourceType learningResourceType) {
	...
	public MEDIA_OBJECT(License license) {
		setLicense(license);
	}
	...
	public MEDIA_OBJECT(LocationCreated locationCreated) {
	...
	public MEDIA_OBJECT(MainEntity mainEntity) {
	...
	public MEDIA_OBJECT(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDIA_OBJECT(Material material) {
	...
	public MEDIA_OBJECT(MaterialExtent materialExtent) {
	...
	public MEDIA_OBJECT(Mentions mentions) {
	...
	public MEDIA_OBJECT(NameFuzzy nameFuzzy) {
	...
	public MEDIA_OBJECT(NameRuby nameRuby) {
	...
	public MEDIA_OBJECT(Offers offers) {
		setOffers(offers);
	}
	...
	public MEDIA_OBJECT(PlayerType playerType) {
	...
	public MEDIA_OBJECT(Position position) {
	...
	public MEDIA_OBJECT(PotentialAction potentialAction) {
	...
	public MEDIA_OBJECT(Producer producer) {
	...
	public MEDIA_OBJECT(ProductionCompany productionCompany) {
	...
	public MEDIA_OBJECT(Provider provider) {
	...
	public MEDIA_OBJECT(Publication publication) {
	...
	public MEDIA_OBJECT(Publisher publisher) {
	...
	public MEDIA_OBJECT(PublisherImprint publisherImprint) {
	...
	public MEDIA_OBJECT(PublishingPrinciples publishingPrinciples) {
	...
	public MEDIA_OBJECT(RecordedAt recordedAt) {
	...
	public MEDIA_OBJECT(RegionsAllowed regionsAllowed) {
	...
	public MEDIA_OBJECT(ReleasedEvent releasedEvent) {
	...
	public MEDIA_OBJECT(RequiresSubscription requiresSubscription) {
	...
	public MEDIA_OBJECT(Review review) {
		setReview(review);
	}
	...
	public MEDIA_OBJECT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDIA_OBJECT(SchemaVersion schemaVersion) {
	...
	public MEDIA_OBJECT(SdDatePublished sdDatePublished) {
	...
	public MEDIA_OBJECT(SdLicense sdLicense) {
	...
	public MEDIA_OBJECT(SdPublisher sdPublisher) {
	...
	public MEDIA_OBJECT(SourceOrganization sourceOrganization) {
	...
	public MEDIA_OBJECT(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public MEDIA_OBJECT(SpatialCoverage spatialCoverage) {
	...
	public MEDIA_OBJECT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MEDIA_OBJECT(StartTime startTime) {
	...
	public MEDIA_OBJECT(SubjectOf subjectOf) {
	...
	public MEDIA_OBJECT(Temporal temporal) {
	...
	public MEDIA_OBJECT(TemporalCoverage temporalCoverage) {
	...
	public MEDIA_OBJECT(ThumbnailUrl thumbnailUrl) {
	...
	public MEDIA_OBJECT(TimeRequired timeRequired) {
	...
	public MEDIA_OBJECT(TranslationOfWork translationOfWork) {
	...
	public MEDIA_OBJECT(Translator translator) {
	...
	public MEDIA_OBJECT(TypicalAgeRange typicalAgeRange) {
	...
	public MEDIA_OBJECT(UploadDate uploadDate) {
	...
	public MEDIA_OBJECT(Version version) {
		setVersion(version);
	}
	...
	public MEDIA_OBJECT(Video video) {
		setVideo(video);
	}
	...
	public MEDIA_OBJECT(Width width) {
		setWidth(width);
	}
	...
	public MEDIA_OBJECT(WorkExample workExample) {
	...
	public MEDIA_OBJECT(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.MediaObject org) {
		setSeq(org.getSeq());
