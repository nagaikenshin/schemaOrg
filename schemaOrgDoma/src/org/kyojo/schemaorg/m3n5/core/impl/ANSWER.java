...
public class ANSWER implements Clazz.Answer {
	...
	public ANSWER(AccessMode accessMode) {
	...
	public ANSWER(AccessModeSufficient accessModeSufficient) {
	...
	public ANSWER(AccessibilityAPI accessibilityAPI) {
	...
	public ANSWER(AccessibilityControl accessibilityControl) {
	...
	public ANSWER(AccessibilityFeature accessibilityFeature) {
	...
	public ANSWER(AccessibilityHazard accessibilityHazard) {
	...
	public ANSWER(AccessibilitySummary accessibilitySummary) {
	...
	public ANSWER(AccountablePerson accountablePerson) {
	...
	public ANSWER(AdditionalType additionalType) {
	...
	public ANSWER(AggregateRating aggregateRating) {
	...
	public ANSWER(AlternateName alternateName) {
	...
	public ANSWER(AlternativeHeadline alternativeHeadline) {
	...
	public ANSWER(AssociatedMedia associatedMedia) {
	...
	public ANSWER(Audience audience) {
	...
	public ANSWER(Character character) {
	...
	public ANSWER(Citation citation) {
	...
	public ANSWER(CommentCount commentCount) {
	...
	public ANSWER(ContentLocation contentLocation) {
	...
	public ANSWER(ContentRating contentRating) {
	...
	public ANSWER(ContentReferenceTime contentReferenceTime) {
	...
	public ANSWER(Contributor contributor) {
	...
	public ANSWER(CopyrightHolder copyrightHolder) {
	...
	public ANSWER(CopyrightYear copyrightYear) {
	...
	public ANSWER(Correction correction) {
	...
	public ANSWER(DateCreated dateCreated) {
	...
	public ANSWER(DateModified dateModified) {
	...
	public ANSWER(DatePublished datePublished) {
	...
	public ANSWER(Description description) {
	...
	public ANSWER(DisambiguatingDescription disambiguatingDescription) {
	...
	public ANSWER(DiscussionUrl discussionUrl) {
	...
	public ANSWER(DownvoteCount downvoteCount) {
	...
	public ANSWER(EducationalAlignment educationalAlignment) {
	...
	public ANSWER(EducationalUse educationalUse) {
	...
	public ANSWER(Encoding encoding) {
	...
	public ANSWER(EncodingFormat encodingFormat) {
	...
	public ANSWER(ExampleOfWork exampleOfWork) {
	...
	public ANSWER(Headline headline) {
	...
	public ANSWER(Identifier identifier) {
	...
	public ANSWER(InLanguage inLanguage) {
	...
	public ANSWER(InteractionStatistic interactionStatistic) {
	...
	public ANSWER(InteractivityType interactivityType) {
	...
	public ANSWER(IsAccessibleForFree isAccessibleForFree) {
	...
	public ANSWER(IsBasedOn isBasedOn) {
	...
	public ANSWER(IsFamilyFriendly isFamilyFriendly) {
	...
	public ANSWER(IsPartOf isPartOf) {
	...
	public ANSWER(Keywords keywords) {
	...
	public ANSWER(LearningResourceType learningResourceType) {
	...
	public ANSWER(LocationCreated locationCreated) {
	...
	public ANSWER(MainEntity mainEntity) {
	...
	public ANSWER(MainEntityOfPage mainEntityOfPage) {
	...
	public ANSWER(Material material) {
	...
	public ANSWER(MaterialExtent materialExtent) {
	...
	public ANSWER(Mentions mentions) {
	...
	public ANSWER(NameFuzzy nameFuzzy) {
	...
	public ANSWER(NameRuby nameRuby) {
	...
	public ANSWER(ParentItem parentItem) {
	...
	public ANSWER(Position position) {
	...
	public ANSWER(PotentialAction potentialAction) {
	...
	public ANSWER(Producer producer) {
	...
	public ANSWER(Provider provider) {
	...
	public ANSWER(Publication publication) {
	...
	public ANSWER(Publisher publisher) {
	...
	public ANSWER(PublisherImprint publisherImprint) {
	...
	public ANSWER(PublishingPrinciples publishingPrinciples) {
	...
	public ANSWER(RecordedAt recordedAt) {
	...
	public ANSWER(ReleasedEvent releasedEvent) {
	...
	public ANSWER(SchemaVersion schemaVersion) {
	...
	public ANSWER(SdDatePublished sdDatePublished) {
	...
	public ANSWER(SdLicense sdLicense) {
	...
	public ANSWER(SdPublisher sdPublisher) {
	...
	public ANSWER(SourceOrganization sourceOrganization) {
	...
	public ANSWER(SpatialCoverage spatialCoverage) {
	...
	public ANSWER(SubjectOf subjectOf) {
	...
	public ANSWER(Temporal temporal) {
	...
	public ANSWER(TemporalCoverage temporalCoverage) {
	...
	public ANSWER(ThumbnailUrl thumbnailUrl) {
	...
	public ANSWER(TimeRequired timeRequired) {
	...
	public ANSWER(TranslationOfWork translationOfWork) {
	...
	public ANSWER(Translator translator) {
	...
	public ANSWER(TypicalAgeRange typicalAgeRange) {
	...
	public ANSWER(UpvoteCount upvoteCount) {
	...
	public ANSWER(WorkExample workExample) {
	...
	public ANSWER(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Answer org) {
		setSeq(org.getSeq());
