...
public class RECORDED_IN implements Container.RecordedIn {
	...
	public RECORDED_IN(String string) {
	...
	public RECORDED_IN(APIReference apiReference) {
	...
	public RECORDED_IN(AboutPage aboutPage) {
	...
	public RECORDED_IN(AdvertiserContentArticle advertiserContentArticle) {
	...
	public RECORDED_IN(AnalysisNewsArticle analysisNewsArticle) {
	...
	public RECORDED_IN(Answer answer) {
	...
	public RECORDED_IN(ArchiveComponent archiveComponent) {
	...
	public RECORDED_IN(Article article) {
	...
	public RECORDED_IN(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public RECORDED_IN(Atlas atlas) {
	...
	public RECORDED_IN(AudioObject audioObject) {
	...
	public RECORDED_IN(Audiobook audiobook) {
	...
	public RECORDED_IN(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public RECORDED_IN(Barcode barcode) {
	...
	public RECORDED_IN(BlogPosting blogPosting) {
	...
	public RECORDED_IN(BookSeries bookSeries) {
	...
	public RECORDED_IN(CategoryCodeSet categoryCodeSet) {
	...
	public RECORDED_IN(Chapter chapter) {
	...
	public RECORDED_IN(CheckoutPage checkoutPage) {
	...
	public RECORDED_IN(Claim claim) {
	...
	public RECORDED_IN(ClaimReview claimReview) {
	...
	public RECORDED_IN(Collection collection) {
	...
	public RECORDED_IN(CollectionPage collectionPage) {
	...
	public RECORDED_IN(ComicCoverArt comicCoverArt) {
	...
	public RECORDED_IN(ComicIssue comicIssue) {
	...
	public RECORDED_IN(ComicSeries comicSeries) {
	...
	public RECORDED_IN(ComicStory comicStory) {
	...
	public RECORDED_IN(Comment comment) {
	...
	public RECORDED_IN(CompleteDataFeed completeDataFeed) {
	...
	public RECORDED_IN(ContactPage contactPage) {
	...
	public RECORDED_IN(Conversation conversation) {
	...
	public RECORDED_IN(CorrectionComment correctionComment) {
	...
	public RECORDED_IN(Course course) {
	...
	public RECORDED_IN(CoverArt coverArt) {
	...
	public RECORDED_IN(CreativeWork creativeWork) {
		creativeWorkList = new ArrayList<CreativeWork>();
	...
	public RECORDED_IN(CreativeWorkSeason creativeWorkSeason) {
	...
	public RECORDED_IN(CreativeWorkSeries creativeWorkSeries) {
	...
	public RECORDED_IN(CriticReview criticReview) {
	...
	public RECORDED_IN(DataCatalog dataCatalog) {
	...
	public RECORDED_IN(DataDownload dataDownload) {
	...
	public RECORDED_IN(DataFeed dataFeed) {
	...
	public RECORDED_IN(Dataset dataset) {
	...
	public RECORDED_IN(DefinedTermSet definedTermSet) {
	...
	public RECORDED_IN(DigitalDocument digitalDocument) {
	...
	public RECORDED_IN(DiscussionForumPosting discussionForumPosting) {
	...
	public RECORDED_IN(Drawing drawing) {
	...
	public RECORDED_IN(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public RECORDED_IN(EmailMessage emailMessage) {
	...
	public RECORDED_IN(EmployerReview employerReview) {
	...
	public RECORDED_IN(Episode episode) {
	...
	public RECORDED_IN(ExercisePlan exercisePlan) {
	...
	public RECORDED_IN(FAQPage faqPage) {
	...
	public RECORDED_IN(HowTo howTo) {
	...
	public RECORDED_IN(HowToDirection howToDirection) {
	...
	public RECORDED_IN(HowToSection howToSection) {
	...
	public RECORDED_IN(HowToStep howToStep) {
	...
	public RECORDED_IN(HowToTip howToTip) {
	...
	public RECORDED_IN(ImageGallery imageGallery) {
	...
	public RECORDED_IN(ImageObject imageObject) {
	...
	public RECORDED_IN(ItemPage itemPage) {
	...
	public RECORDED_IN(Legislation legislation) {
	...
	public RECORDED_IN(LegislationObject legislationObject) {
	...
	public RECORDED_IN(LiveBlogPosting liveBlogPosting) {
	...
	public RECORDED_IN(Manuscript manuscript) {
	...
	public RECORDED_IN(MediaObject mediaObject) {
	...
	public RECORDED_IN(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public RECORDED_IN(MedicalWebPage medicalWebPage) {
	...
	public RECORDED_IN(MenuSection menuSection) {
	...
	public RECORDED_IN(Message message) {
	...
	public RECORDED_IN(MobileApplication mobileApplication) {
	...
	public RECORDED_IN(Movie movie) {
	...
	public RECORDED_IN(MovieClip movieClip) {
	...
	public RECORDED_IN(MovieSeries movieSeries) {
	...
	public RECORDED_IN(MusicAlbum musicAlbum) {
	...
	public RECORDED_IN(MusicComposition musicComposition) {
	...
	public RECORDED_IN(MusicPlaylist musicPlaylist) {
	...
	public RECORDED_IN(MusicRecording musicRecording) {
	...
	public RECORDED_IN(MusicRelease musicRelease) {
	...
	public RECORDED_IN(MusicVideoObject musicVideoObject) {
	...
	public RECORDED_IN(NewsArticle newsArticle) {
	...
	public RECORDED_IN(Newspaper newspaper) {
	...
	public RECORDED_IN(NoteDigitalDocument noteDigitalDocument) {
	...
	public RECORDED_IN(OpinionNewsArticle opinionNewsArticle) {
	...
	public RECORDED_IN(Painting painting) {
	...
	public RECORDED_IN(Periodical periodical) {
	...
	public RECORDED_IN(Photograph photograph) {
	...
	public RECORDED_IN(Poster poster) {
	...
	public RECORDED_IN(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public RECORDED_IN(ProfilePage profilePage) {
	...
	public RECORDED_IN(PublicationIssue publicationIssue) {
	...
	public RECORDED_IN(PublicationVolume publicationVolume) {
	...
	public RECORDED_IN(QAPage qaPage) {
	...
	public RECORDED_IN(Question question) {
	...
	public RECORDED_IN(Quotation quotation) {
	...
	public RECORDED_IN(RadioClip radioClip) {
	...
	public RECORDED_IN(RadioEpisode radioEpisode) {
	...
	public RECORDED_IN(RadioSeason radioSeason) {
	...
	public RECORDED_IN(RadioSeries radioSeries) {
	...
	public RECORDED_IN(Recipe recipe) {
	...
	public RECORDED_IN(Report report) {
	...
	public RECORDED_IN(ReportageNewsArticle reportageNewsArticle) {
	...
	public RECORDED_IN(Review review) {
	...
	public RECORDED_IN(ReviewNewsArticle reviewNewsArticle) {
	...
	public RECORDED_IN(SatiricalArticle satiricalArticle) {
	...
	public RECORDED_IN(ScholarlyArticle scholarlyArticle) {
	...
	public RECORDED_IN(Sculpture sculpture) {
	...
	public RECORDED_IN(SearchResultsPage searchResultsPage) {
	...
	public RECORDED_IN(SheetMusic sheetMusic) {
	...
	public RECORDED_IN(ShortStory shortStory) {
	...
	public RECORDED_IN(SiteNavigationElement siteNavigationElement) {
	...
	public RECORDED_IN(SocialMediaPosting socialMediaPosting) {
	...
	public RECORDED_IN(SoftwareApplication softwareApplication) {
	...
	public RECORDED_IN(SoftwareSourceCode softwareSourceCode) {
	...
	public RECORDED_IN(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public RECORDED_IN(TVClip tvClip) {
	...
	public RECORDED_IN(TVEpisode tvEpisode) {
	...
	public RECORDED_IN(TVSeason tvSeason) {
	...
	public RECORDED_IN(TVSeries tvSeries) {
	...
	public RECORDED_IN(Table table) {
	...
	public RECORDED_IN(TechArticle techArticle) {
	...
	public RECORDED_IN(TextDigitalDocument textDigitalDocument) {
	...
	public RECORDED_IN(Thesis thesis) {
	...
	public RECORDED_IN(ThreeDimensionalModel threeDimensionalModel) {
	...
	public RECORDED_IN(UserReview userReview) {
	...
	public RECORDED_IN(VideoGallery videoGallery) {
	...
	public RECORDED_IN(VideoGame videoGame) {
	...
	public RECORDED_IN(VideoGameClip videoGameClip) {
	...
	public RECORDED_IN(VideoGameSeries videoGameSeries) {
	...
	public RECORDED_IN(VideoObject videoObject) {
	...
	public RECORDED_IN(VisualArtwork visualArtwork) {
	...
	public RECORDED_IN(WPAdBlock wpAdBlock) {
	...
	public RECORDED_IN(WPFooter wpFooter) {
	...
	public RECORDED_IN(WPHeader wpHeader) {
	...
	public RECORDED_IN(WPSideBar wpSideBar) {
	...
	public RECORDED_IN(WebApplication webApplication) {
	...
	public RECORDED_IN(WebPage webPage) {
	...
	public RECORDED_IN(WebPageElement webPageElement) {
	...
	public RECORDED_IN(WebSite webSite) {
	...
	public void copy(Container.RecordedIn org) {
