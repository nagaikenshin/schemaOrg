...
public class DEFENCE_ESTABLISHMENT implements Clazz.DefenceEstablishment {
	...
	public DEFENCE_ESTABLISHMENT(GeoContains geoContains) {
	...
	public DEFENCE_ESTABLISHMENT(GeoCoveredBy geoCoveredBy) {
	...
	public DEFENCE_ESTABLISHMENT(GeoCovers geoCovers) {
	...
	public DEFENCE_ESTABLISHMENT(GeoCrosses geoCrosses) {
	...
	public DEFENCE_ESTABLISHMENT(GeoDisjoint geoDisjoint) {
	...
	public DEFENCE_ESTABLISHMENT(GeoEquals geoEquals) {
	...
	public DEFENCE_ESTABLISHMENT(GeoIntersects geoIntersects) {
	...
	public DEFENCE_ESTABLISHMENT(GeoOverlaps geoOverlaps) {
	...
	public DEFENCE_ESTABLISHMENT(GeoTouches geoTouches) {
	...
	public DEFENCE_ESTABLISHMENT(GeoWithin geoWithin) {
	...
	public DEFENCE_ESTABLISHMENT(Slogan slogan) {
		setSlogan(slogan);
	}
