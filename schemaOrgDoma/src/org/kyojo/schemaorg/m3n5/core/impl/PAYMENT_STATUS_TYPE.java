...
public class PAYMENT_STATUS_TYPE implements Clazz.PaymentStatusType {
	...
	public PAYMENT_STATUS_TYPE(Long seq) {
		setSeq(seq);
	}

	public PAYMENT_STATUS_TYPE(String string) {
	...
	public PAYMENT_STATUS_TYPE(AdditionalType additionalType) {
	...
	public PAYMENT_STATUS_TYPE(AlternateName alternateName) {
	...
	public PAYMENT_STATUS_TYPE(Description description) {
	...
	public PAYMENT_STATUS_TYPE(DisambiguatingDescription disambiguatingDescription) {
	...
	public PAYMENT_STATUS_TYPE(Identifier identifier) {
	...
	public PAYMENT_STATUS_TYPE(Image image) {
		setImage(image);
	}
	...
	public PAYMENT_STATUS_TYPE(MainEntityOfPage mainEntityOfPage) {
	...
	public PAYMENT_STATUS_TYPE(Name name) {
		setName(name);
	}
	...
	public PAYMENT_STATUS_TYPE(NameFuzzy nameFuzzy) {
	...
	public PAYMENT_STATUS_TYPE(NameRuby nameRuby) {
	...
	public PAYMENT_STATUS_TYPE(PotentialAction potentialAction) {
	...
	public PAYMENT_STATUS_TYPE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PAYMENT_STATUS_TYPE(SubjectOf subjectOf) {
	...
	public PAYMENT_STATUS_TYPE(SupersededBy supersededBy) {
	...
	public PAYMENT_STATUS_TYPE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.PaymentStatusType org) {
		setSeq(org.getSeq());
