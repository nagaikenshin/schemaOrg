...
public class ARTICLE implements Clazz.Article {
	...
	public ARTICLE(AccessMode accessMode) {
	...
	public ARTICLE(AccessModeSufficient accessModeSufficient) {
	...
	public ARTICLE(AccessibilityAPI accessibilityAPI) {
	...
	public ARTICLE(AccessibilityControl accessibilityControl) {
	...
	public ARTICLE(AccessibilityFeature accessibilityFeature) {
	...
	public ARTICLE(AccessibilityHazard accessibilityHazard) {
	...
	public ARTICLE(AccessibilitySummary accessibilitySummary) {
	...
	public ARTICLE(AccountablePerson accountablePerson) {
	...
	public ARTICLE(AdditionalType additionalType) {
	...
	public ARTICLE(AggregateRating aggregateRating) {
	...
	public ARTICLE(AlternateName alternateName) {
	...
	public ARTICLE(AlternativeHeadline alternativeHeadline) {
	...
	public ARTICLE(ArticleBody articleBody) {
	...
	public ARTICLE(ArticleSection articleSection) {
	...
	public ARTICLE(AssociatedMedia associatedMedia) {
	...
	public ARTICLE(Audience audience) {
	...
	public ARTICLE(Backstory backstory) {
	...
	public ARTICLE(Character character) {
	...
	public ARTICLE(Citation citation) {
	...
	public ARTICLE(CommentCount commentCount) {
	...
	public ARTICLE(ContentLocation contentLocation) {
	...
	public ARTICLE(ContentRating contentRating) {
	...
	public ARTICLE(ContentReferenceTime contentReferenceTime) {
	...
	public ARTICLE(Contributor contributor) {
	...
	public ARTICLE(CopyrightHolder copyrightHolder) {
	...
	public ARTICLE(CopyrightYear copyrightYear) {
	...
	public ARTICLE(Correction correction) {
	...
	public ARTICLE(Creator creator) {
		setCreator(creator);
	}
	...
	public ARTICLE(DateCreated dateCreated) {
	...
	public ARTICLE(DateModified dateModified) {
	...
	public ARTICLE(DatePublished datePublished) {
	...
	public ARTICLE(Description description) {
	...
	public ARTICLE(DisambiguatingDescription disambiguatingDescription) {
	...
	public ARTICLE(DiscussionUrl discussionUrl) {
	...
	public ARTICLE(EducationalAlignment educationalAlignment) {
	...
	public ARTICLE(EducationalUse educationalUse) {
	...
	public ARTICLE(Encoding encoding) {
	...
	public ARTICLE(EncodingFormat encodingFormat) {
	...
	public ARTICLE(ExampleOfWork exampleOfWork) {
	...
	public ARTICLE(Expires expires) {
		setExpires(expires);
	}
	...
	public ARTICLE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public ARTICLE(Headline headline) {
	...
	public ARTICLE(InLanguage inLanguage) {
	...
	public ARTICLE(InteractionStatistic interactionStatistic) {
	...
	public ARTICLE(InteractivityType interactivityType) {
	...
	public ARTICLE(IsAccessibleForFree isAccessibleForFree) {
	...
	public ARTICLE(IsBasedOn isBasedOn) {
	...
	public ARTICLE(IsFamilyFriendly isFamilyFriendly) {
	...
	public ARTICLE(IsPartOf isPartOf) {
	...
	public ARTICLE(Keywords keywords) {
	...
	public ARTICLE(LearningResourceType learningResourceType) {
	...
	public ARTICLE(License license) {
		setLicense(license);
	}
	...
	public ARTICLE(LocationCreated locationCreated) {
	...
	public ARTICLE(MainEntity mainEntity) {
	...
	public ARTICLE(MainEntityOfPage mainEntityOfPage) {
	...
	public ARTICLE(Material material) {
	...
	public ARTICLE(MaterialExtent materialExtent) {
	...
	public ARTICLE(Mentions mentions) {
	...
	public ARTICLE(NameFuzzy nameFuzzy) {
	...
	public ARTICLE(NameRuby nameRuby) {
	...
	public ARTICLE(PageEnd pageEnd) {
		setPageEnd(pageEnd);
	}
	...
	public ARTICLE(PageStart pageStart) {
	...
	public ARTICLE(Pagination pagination) {
	...
	public ARTICLE(Position position) {
	...
	public ARTICLE(PotentialAction potentialAction) {
	...
	public ARTICLE(Producer producer) {
	...
	public ARTICLE(Provider provider) {
	...
	public ARTICLE(Publisher publisher) {
	...
	public ARTICLE(PublisherImprint publisherImprint) {
	...
	public ARTICLE(PublishingPrinciples publishingPrinciples) {
	...
	public ARTICLE(RecordedAt recordedAt) {
	...
	public ARTICLE(ReleasedEvent releasedEvent) {
	...
	public ARTICLE(SchemaVersion schemaVersion) {
	...
	public ARTICLE(SdDatePublished sdDatePublished) {
	...
	public ARTICLE(SdLicense sdLicense) {
	...
	public ARTICLE(SdPublisher sdPublisher) {
	...
	public ARTICLE(SourceOrganization sourceOrganization) {
	...
	public ARTICLE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public ARTICLE(SpatialCoverage spatialCoverage) {
	...
	public ARTICLE(Speakable speakable) {
	...
	public ARTICLE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public ARTICLE(SubjectOf subjectOf) {
	...
	public ARTICLE(Temporal temporal) {
	...
	public ARTICLE(TemporalCoverage temporalCoverage) {
	...
	public ARTICLE(ThumbnailUrl thumbnailUrl) {
	...
	public ARTICLE(TimeRequired timeRequired) {
	...
	public ARTICLE(TranslationOfWork translationOfWork) {
	...
	public ARTICLE(Translator translator) {
	...
	public ARTICLE(TypicalAgeRange typicalAgeRange) {
	...
	public ARTICLE(Version version) {
		setVersion(version);
	}
	...
	public ARTICLE(WordCount wordCount) {
	...
	public ARTICLE(WorkExample workExample) {
	...
	public ARTICLE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Article org) {
		setSeq(org.getSeq());
