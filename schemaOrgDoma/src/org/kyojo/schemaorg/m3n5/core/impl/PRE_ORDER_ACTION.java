...
public class PRE_ORDER_ACTION implements Clazz.PreOrderAction {
	...
	public PRE_ORDER_ACTION() {
	}

	public PRE_ORDER_ACTION(Long seq) {
		setSeq(seq);
	}

	public PRE_ORDER_ACTION(String string) {
	...
	public PRE_ORDER_ACTION(ActionStatus actionStatus) {
	...
	public PRE_ORDER_ACTION(AdditionalType additionalType) {
	...
	public PRE_ORDER_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public PRE_ORDER_ACTION(AlternateName alternateName) {
	...
	public PRE_ORDER_ACTION(Description description) {
	...
	public PRE_ORDER_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public PRE_ORDER_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public PRE_ORDER_ACTION(Error error) {
		setError(error);
	}
	...
	public PRE_ORDER_ACTION(Identifier identifier) {
	...
	public PRE_ORDER_ACTION(Image image) {
		setImage(image);
	}
	...
	public PRE_ORDER_ACTION(Instrument instrument) {
	...
	public PRE_ORDER_ACTION(Location location) {
	...
	public PRE_ORDER_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public PRE_ORDER_ACTION(Name name) {
		setName(name);
	}
	...
	public PRE_ORDER_ACTION(NameFuzzy nameFuzzy) {
	...
	public PRE_ORDER_ACTION(NameRuby nameRuby) {
	...
	public PRE_ORDER_ACTION(Object object) {
		setObject(object);
	}
	...
	public PRE_ORDER_ACTION(Participant participant) {
	...
	public PRE_ORDER_ACTION(PotentialAction potentialAction) {
	...
	public PRE_ORDER_ACTION(Price price) {
		setPrice(price);
	}
	...
	public PRE_ORDER_ACTION(PriceCurrency priceCurrency) {
	...
	public PRE_ORDER_ACTION(PriceSpecification priceSpecification) {
	...
	public PRE_ORDER_ACTION(Result result) {
		setResult(result);
	}
	...
	public PRE_ORDER_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PRE_ORDER_ACTION(StartTime startTime) {
	...
	public PRE_ORDER_ACTION(SubjectOf subjectOf) {
	...
	public PRE_ORDER_ACTION(Target target) {
		setTarget(target);
	}
	...
	public PRE_ORDER_ACTION(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.PreOrderAction org) {
		setSeq(org.getSeq());
