...
public class IMAGE_OBJECT implements Clazz.ImageObject {
	...
	public IMAGE_OBJECT(Long seq) {
		setSeq(seq);
	}

	public IMAGE_OBJECT(String string) {
	...
	public IMAGE_OBJECT(About about) {
		setAbout(about);
	}
	...
	public IMAGE_OBJECT(AccessMode accessMode) {
	...
	public IMAGE_OBJECT(AccessModeSufficient accessModeSufficient) {
	...
	public IMAGE_OBJECT(AccessibilityAPI accessibilityAPI) {
	...
	public IMAGE_OBJECT(AccessibilityControl accessibilityControl) {
	...
	public IMAGE_OBJECT(AccessibilityFeature accessibilityFeature) {
	...
	public IMAGE_OBJECT(AccessibilityHazard accessibilityHazard) {
	...
	public IMAGE_OBJECT(AccessibilitySummary accessibilitySummary) {
	...
	public IMAGE_OBJECT(AccountablePerson accountablePerson) {
	...
	public IMAGE_OBJECT(AdditionalType additionalType) {
	...
	public IMAGE_OBJECT(AggregateRating aggregateRating) {
	...
	public IMAGE_OBJECT(AlternateName alternateName) {
	...
	public IMAGE_OBJECT(AlternativeHeadline alternativeHeadline) {
	...
	public IMAGE_OBJECT(AssociatedArticle associatedArticle) {
	...
	public IMAGE_OBJECT(AssociatedMedia associatedMedia) {
	...
	public IMAGE_OBJECT(Audience audience) {
	...
	public IMAGE_OBJECT(Audio audio) {
		setAudio(audio);
	}
	...
	public IMAGE_OBJECT(Author author) {
		setAuthor(author);
	}
	...
	public IMAGE_OBJECT(Award award) {
		setAward(award);
	}
	...
	public IMAGE_OBJECT(Bitrate bitrate) {
		setBitrate(bitrate);
	}
	...
	public IMAGE_OBJECT(Caption caption) {
		setCaption(caption);
	}
	...
	public IMAGE_OBJECT(Character character) {
	...
	public IMAGE_OBJECT(Citation citation) {
	...
	public IMAGE_OBJECT(Comment comment) {
		setComment(comment);
	}
	...
	public IMAGE_OBJECT(CommentCount commentCount) {
	...
	public IMAGE_OBJECT(ContentLocation contentLocation) {
	...
	public IMAGE_OBJECT(ContentRating contentRating) {
	...
	public IMAGE_OBJECT(ContentReferenceTime contentReferenceTime) {
	...
	public IMAGE_OBJECT(ContentSize contentSize) {
	...
	public IMAGE_OBJECT(ContentUrl contentUrl) {
	...
	public IMAGE_OBJECT(Contributor contributor) {
	...
	public IMAGE_OBJECT(CopyrightHolder copyrightHolder) {
	...
	public IMAGE_OBJECT(CopyrightYear copyrightYear) {
	...
	public IMAGE_OBJECT(Correction correction) {
	...
	public IMAGE_OBJECT(Creator creator) {
		setCreator(creator);
	}
	...
	public IMAGE_OBJECT(DateCreated dateCreated) {
	...
	public IMAGE_OBJECT(DateModified dateModified) {
	...
	public IMAGE_OBJECT(DatePublished datePublished) {
	...
	public IMAGE_OBJECT(Description description) {
	...
	public IMAGE_OBJECT(DisambiguatingDescription disambiguatingDescription) {
	...
	public IMAGE_OBJECT(DiscussionUrl discussionUrl) {
	...
	public IMAGE_OBJECT(Duration duration) {
	...
	public IMAGE_OBJECT(Editor editor) {
		setEditor(editor);
	}
	...
	public IMAGE_OBJECT(EducationalAlignment educationalAlignment) {
	...
	public IMAGE_OBJECT(EducationalUse educationalUse) {
	...
	public IMAGE_OBJECT(EmbedUrl embedUrl) {
	...
	public IMAGE_OBJECT(EncodesCreativeWork encodesCreativeWork) {
	...
	public IMAGE_OBJECT(Encoding encoding) {
	...
	public IMAGE_OBJECT(EncodingFormat encodingFormat) {
	...
	public IMAGE_OBJECT(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public IMAGE_OBJECT(ExampleOfWork exampleOfWork) {
	...
	public IMAGE_OBJECT(ExifData exifData) {
	...
	public IMAGE_OBJECT(Expires expires) {
		setExpires(expires);
	}
	...
	public IMAGE_OBJECT(Funder funder) {
		setFunder(funder);
	}
	...
	public IMAGE_OBJECT(Genre genre) {
		setGenre(genre);
	}
	...
	public IMAGE_OBJECT(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public IMAGE_OBJECT(Headline headline) {
	...
	public IMAGE_OBJECT(Height height) {
		setHeight(height);
	}
	...
	public IMAGE_OBJECT(Identifier identifier) {
	...
	public IMAGE_OBJECT(Image image) {
		setImage(image);
	}
	...
	public IMAGE_OBJECT(InLanguage inLanguage) {
	...
	public IMAGE_OBJECT(InteractionStatistic interactionStatistic) {
	...
	public IMAGE_OBJECT(InteractivityType interactivityType) {
	...
	public IMAGE_OBJECT(IsAccessibleForFree isAccessibleForFree) {
	...
	public IMAGE_OBJECT(IsBasedOn isBasedOn) {
	...
	public IMAGE_OBJECT(IsFamilyFriendly isFamilyFriendly) {
	...
	public IMAGE_OBJECT(IsPartOf isPartOf) {
	...
	public IMAGE_OBJECT(Keywords keywords) {
	...
	public IMAGE_OBJECT(LearningResourceType learningResourceType) {
	...
	public IMAGE_OBJECT(License license) {
		setLicense(license);
	}
	...
	public IMAGE_OBJECT(LocationCreated locationCreated) {
	...
	public IMAGE_OBJECT(MainEntity mainEntity) {
	...
	public IMAGE_OBJECT(MainEntityOfPage mainEntityOfPage) {
	...
	public IMAGE_OBJECT(Material material) {
	...
	public IMAGE_OBJECT(MaterialExtent materialExtent) {
	...
	public IMAGE_OBJECT(Mentions mentions) {
	...
	public IMAGE_OBJECT(NameFuzzy nameFuzzy) {
	...
	public IMAGE_OBJECT(NameRuby nameRuby) {
	...
	public IMAGE_OBJECT(Offers offers) {
		setOffers(offers);
	}
	...
	public IMAGE_OBJECT(PlayerType playerType) {
	...
	public IMAGE_OBJECT(Position position) {
	...
	public IMAGE_OBJECT(PotentialAction potentialAction) {
	...
	public IMAGE_OBJECT(Producer producer) {
	...
	public IMAGE_OBJECT(ProductionCompany productionCompany) {
	...
	public IMAGE_OBJECT(Provider provider) {
	...
	public IMAGE_OBJECT(Publication publication) {
	...
	public IMAGE_OBJECT(Publisher publisher) {
	...
	public IMAGE_OBJECT(PublisherImprint publisherImprint) {
	...
	public IMAGE_OBJECT(PublishingPrinciples publishingPrinciples) {
	...
	public IMAGE_OBJECT(RecordedAt recordedAt) {
	...
	public IMAGE_OBJECT(RegionsAllowed regionsAllowed) {
	...
	public IMAGE_OBJECT(ReleasedEvent releasedEvent) {
	...
	public IMAGE_OBJECT(RepresentativeOfPage representativeOfPage) {
	...
	public IMAGE_OBJECT(RequiresSubscription requiresSubscription) {
	...
	public IMAGE_OBJECT(Review review) {
		setReview(review);
	}
	...
	public IMAGE_OBJECT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public IMAGE_OBJECT(SchemaVersion schemaVersion) {
	...
	public IMAGE_OBJECT(SdDatePublished sdDatePublished) {
	...
	public IMAGE_OBJECT(SdLicense sdLicense) {
	...
	public IMAGE_OBJECT(SdPublisher sdPublisher) {
	...
	public IMAGE_OBJECT(SourceOrganization sourceOrganization) {
	...
	public IMAGE_OBJECT(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public IMAGE_OBJECT(SpatialCoverage spatialCoverage) {
	...
	public IMAGE_OBJECT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public IMAGE_OBJECT(StartTime startTime) {
	...
	public IMAGE_OBJECT(SubjectOf subjectOf) {
	...
	public IMAGE_OBJECT(Temporal temporal) {
	...
	public IMAGE_OBJECT(TemporalCoverage temporalCoverage) {
	...
	public IMAGE_OBJECT(Thumbnail thumbnail) {
	...
	public IMAGE_OBJECT(ThumbnailUrl thumbnailUrl) {
	...
	public IMAGE_OBJECT(TimeRequired timeRequired) {
	...
	public IMAGE_OBJECT(TranslationOfWork translationOfWork) {
	...
	public IMAGE_OBJECT(Translator translator) {
	...
	public IMAGE_OBJECT(TypicalAgeRange typicalAgeRange) {
	...
	public IMAGE_OBJECT(UploadDate uploadDate) {
	...
	public IMAGE_OBJECT(Version version) {
		setVersion(version);
	}
	...
	public IMAGE_OBJECT(Video video) {
		setVideo(video);
	}
	...
	public IMAGE_OBJECT(Width width) {
		setWidth(width);
	}
	...
	public IMAGE_OBJECT(WorkExample workExample) {
	...
	public IMAGE_OBJECT(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.ImageObject org) {
		setSeq(org.getSeq());
