...
public class SCHOLARLY_ARTICLE implements Clazz.ScholarlyArticle {
	...
	public SCHOLARLY_ARTICLE(Long seq) {
		setSeq(seq);
	}

	public SCHOLARLY_ARTICLE(String string) {
	...
	public SCHOLARLY_ARTICLE(About about) {
		setAbout(about);
	}
	...
	public SCHOLARLY_ARTICLE(AccessMode accessMode) {
	...
	public SCHOLARLY_ARTICLE(AccessModeSufficient accessModeSufficient) {
	...
	public SCHOLARLY_ARTICLE(AccessibilityAPI accessibilityAPI) {
	...
	public SCHOLARLY_ARTICLE(AccessibilityControl accessibilityControl) {
	...
	public SCHOLARLY_ARTICLE(AccessibilityFeature accessibilityFeature) {
	...
	public SCHOLARLY_ARTICLE(AccessibilityHazard accessibilityHazard) {
	...
	public SCHOLARLY_ARTICLE(AccessibilitySummary accessibilitySummary) {
	...
	public SCHOLARLY_ARTICLE(AccountablePerson accountablePerson) {
	...
	public SCHOLARLY_ARTICLE(AdditionalType additionalType) {
	...
	public SCHOLARLY_ARTICLE(AggregateRating aggregateRating) {
	...
	public SCHOLARLY_ARTICLE(AlternateName alternateName) {
	...
	public SCHOLARLY_ARTICLE(AlternativeHeadline alternativeHeadline) {
	...
	public SCHOLARLY_ARTICLE(ArticleBody articleBody) {
	...
	public SCHOLARLY_ARTICLE(ArticleSection articleSection) {
	...
	public SCHOLARLY_ARTICLE(AssociatedMedia associatedMedia) {
	...
	public SCHOLARLY_ARTICLE(Audience audience) {
	...
	public SCHOLARLY_ARTICLE(Audio audio) {
		setAudio(audio);
	}
	...
	public SCHOLARLY_ARTICLE(Author author) {
		setAuthor(author);
	}
	...
	public SCHOLARLY_ARTICLE(Award award) {
		setAward(award);
	}
	...
	public SCHOLARLY_ARTICLE(Backstory backstory) {
	...
	public SCHOLARLY_ARTICLE(Character character) {
	...
	public SCHOLARLY_ARTICLE(Citation citation) {
	...
	public SCHOLARLY_ARTICLE(Comment comment) {
		setComment(comment);
	}
	...
	public SCHOLARLY_ARTICLE(CommentCount commentCount) {
	...
	public SCHOLARLY_ARTICLE(ContentLocation contentLocation) {
	...
	public SCHOLARLY_ARTICLE(ContentRating contentRating) {
	...
	public SCHOLARLY_ARTICLE(ContentReferenceTime contentReferenceTime) {
	...
	public SCHOLARLY_ARTICLE(Contributor contributor) {
	...
	public SCHOLARLY_ARTICLE(CopyrightHolder copyrightHolder) {
	...
	public SCHOLARLY_ARTICLE(CopyrightYear copyrightYear) {
	...
	public SCHOLARLY_ARTICLE(Correction correction) {
	...
	public SCHOLARLY_ARTICLE(Creator creator) {
		setCreator(creator);
	}
	...
	public SCHOLARLY_ARTICLE(DateCreated dateCreated) {
	...
	public SCHOLARLY_ARTICLE(DateModified dateModified) {
	...
	public SCHOLARLY_ARTICLE(DatePublished datePublished) {
	...
	public SCHOLARLY_ARTICLE(Description description) {
	...
	public SCHOLARLY_ARTICLE(DisambiguatingDescription disambiguatingDescription) {
	...
	public SCHOLARLY_ARTICLE(DiscussionUrl discussionUrl) {
	...
	public SCHOLARLY_ARTICLE(Editor editor) {
		setEditor(editor);
	}
	...
	public SCHOLARLY_ARTICLE(EducationalAlignment educationalAlignment) {
	...
	public SCHOLARLY_ARTICLE(EducationalUse educationalUse) {
	...
	public SCHOLARLY_ARTICLE(Encoding encoding) {
	...
	public SCHOLARLY_ARTICLE(EncodingFormat encodingFormat) {
	...
	public SCHOLARLY_ARTICLE(ExampleOfWork exampleOfWork) {
	...
	public SCHOLARLY_ARTICLE(Expires expires) {
		setExpires(expires);
	}
	...
	public SCHOLARLY_ARTICLE(Funder funder) {
		setFunder(funder);
	}
	...
	public SCHOLARLY_ARTICLE(Genre genre) {
		setGenre(genre);
	}
	...
	public SCHOLARLY_ARTICLE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public SCHOLARLY_ARTICLE(Headline headline) {
	...
	public SCHOLARLY_ARTICLE(Identifier identifier) {
	...
	public SCHOLARLY_ARTICLE(Image image) {
		setImage(image);
	}
	...
	public SCHOLARLY_ARTICLE(InLanguage inLanguage) {
	...
	public SCHOLARLY_ARTICLE(InteractionStatistic interactionStatistic) {
	...
	public SCHOLARLY_ARTICLE(InteractivityType interactivityType) {
	...
	public SCHOLARLY_ARTICLE(IsAccessibleForFree isAccessibleForFree) {
	...
	public SCHOLARLY_ARTICLE(IsBasedOn isBasedOn) {
	...
	public SCHOLARLY_ARTICLE(IsFamilyFriendly isFamilyFriendly) {
	...
	public SCHOLARLY_ARTICLE(IsPartOf isPartOf) {
	...
	public SCHOLARLY_ARTICLE(Keywords keywords) {
	...
	public SCHOLARLY_ARTICLE(LearningResourceType learningResourceType) {
	...
	public SCHOLARLY_ARTICLE(License license) {
		setLicense(license);
	}
	...
	public SCHOLARLY_ARTICLE(LocationCreated locationCreated) {
	...
	public SCHOLARLY_ARTICLE(MainEntity mainEntity) {
	...
	public SCHOLARLY_ARTICLE(MainEntityOfPage mainEntityOfPage) {
	...
	public SCHOLARLY_ARTICLE(Material material) {
	...
	public SCHOLARLY_ARTICLE(MaterialExtent materialExtent) {
	...
	public SCHOLARLY_ARTICLE(Mentions mentions) {
	...
	public SCHOLARLY_ARTICLE(Name name) {
		setName(name);
	}
	...
	public SCHOLARLY_ARTICLE(NameFuzzy nameFuzzy) {
	...
	public SCHOLARLY_ARTICLE(NameRuby nameRuby) {
	...
	public SCHOLARLY_ARTICLE(Offers offers) {
		setOffers(offers);
	}
	...
	public SCHOLARLY_ARTICLE(PageEnd pageEnd) {
		setPageEnd(pageEnd);
	}
	...
	public SCHOLARLY_ARTICLE(PageStart pageStart) {
	...
	public SCHOLARLY_ARTICLE(Pagination pagination) {
	...
	public SCHOLARLY_ARTICLE(Position position) {
	...
	public SCHOLARLY_ARTICLE(PotentialAction potentialAction) {
	...
	public SCHOLARLY_ARTICLE(Producer producer) {
	...
	public SCHOLARLY_ARTICLE(Provider provider) {
	...
	public SCHOLARLY_ARTICLE(Publication publication) {
	...
	public SCHOLARLY_ARTICLE(Publisher publisher) {
	...
	public SCHOLARLY_ARTICLE(PublisherImprint publisherImprint) {
	...
	public SCHOLARLY_ARTICLE(PublishingPrinciples publishingPrinciples) {
	...
	public SCHOLARLY_ARTICLE(RecordedAt recordedAt) {
	...
	public SCHOLARLY_ARTICLE(ReleasedEvent releasedEvent) {
	...
	public SCHOLARLY_ARTICLE(Review review) {
		setReview(review);
	}
	...
	public SCHOLARLY_ARTICLE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SCHOLARLY_ARTICLE(SchemaVersion schemaVersion) {
	...
	public SCHOLARLY_ARTICLE(SdDatePublished sdDatePublished) {
	...
	public SCHOLARLY_ARTICLE(SdLicense sdLicense) {
	...
	public SCHOLARLY_ARTICLE(SdPublisher sdPublisher) {
	...
	public SCHOLARLY_ARTICLE(SourceOrganization sourceOrganization) {
	...
	public SCHOLARLY_ARTICLE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public SCHOLARLY_ARTICLE(SpatialCoverage spatialCoverage) {
	...
	public SCHOLARLY_ARTICLE(Speakable speakable) {
	...
	public SCHOLARLY_ARTICLE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public SCHOLARLY_ARTICLE(SubjectOf subjectOf) {
	...
	public SCHOLARLY_ARTICLE(Temporal temporal) {
	...
	public SCHOLARLY_ARTICLE(TemporalCoverage temporalCoverage) {
	...
	public SCHOLARLY_ARTICLE(Text text) {
		setText(text);
	}
	...
	public SCHOLARLY_ARTICLE(ThumbnailUrl thumbnailUrl) {
	...
	public SCHOLARLY_ARTICLE(TimeRequired timeRequired) {
	...
	public SCHOLARLY_ARTICLE(TranslationOfWork translationOfWork) {
	...
	public SCHOLARLY_ARTICLE(Translator translator) {
	...
	public SCHOLARLY_ARTICLE(TypicalAgeRange typicalAgeRange) {
	...
	public SCHOLARLY_ARTICLE(Url url) {
		setUrl(url);
	}
	...
	public SCHOLARLY_ARTICLE(Version version) {
		setVersion(version);
	}
	...
	public SCHOLARLY_ARTICLE(Video video) {
		setVideo(video);
	}
	...
	public SCHOLARLY_ARTICLE(WordCount wordCount) {
	...
	public SCHOLARLY_ARTICLE(WorkExample workExample) {
	...
	public SCHOLARLY_ARTICLE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.ScholarlyArticle org) {
		setSeq(org.getSeq());
