...
public class DELETE_ACTION implements Clazz.DeleteAction {
	...
	public DELETE_ACTION(Long seq) {
		setSeq(seq);
	}

	public DELETE_ACTION(String string) {
	...
	public DELETE_ACTION(ActionStatus actionStatus) {
	...
	public DELETE_ACTION(AdditionalType additionalType) {
	...
	public DELETE_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public DELETE_ACTION(AlternateName alternateName) {
	...
	public DELETE_ACTION(Description description) {
	...
	public DELETE_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public DELETE_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public DELETE_ACTION(Error error) {
		setError(error);
	}
	...
	public DELETE_ACTION(Identifier identifier) {
	...
	public DELETE_ACTION(Image image) {
		setImage(image);
	}
	...
	public DELETE_ACTION(Instrument instrument) {
	...
	public DELETE_ACTION(Location location) {
	...
	public DELETE_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public DELETE_ACTION(Name name) {
		setName(name);
	}
	...
	public DELETE_ACTION(NameFuzzy nameFuzzy) {
	...
	public DELETE_ACTION(NameRuby nameRuby) {
	...
	public DELETE_ACTION(Object object) {
		setObject(object);
	}
	...
	public DELETE_ACTION(Participant participant) {
	...
	public DELETE_ACTION(PotentialAction potentialAction) {
	...
	public DELETE_ACTION(Result result) {
		setResult(result);
	}
	...
	public DELETE_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DELETE_ACTION(StartTime startTime) {
	...
	public DELETE_ACTION(SubjectOf subjectOf) {
	...
	public DELETE_ACTION(Target target) {
		setTarget(target);
	}
	...
	public DELETE_ACTION(TargetCollection targetCollection) {
	...
	public void copy(Clazz.DeleteAction org) {
		setSeq(org.getSeq());
