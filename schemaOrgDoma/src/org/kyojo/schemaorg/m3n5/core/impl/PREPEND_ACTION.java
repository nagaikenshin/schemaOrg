...
public class PREPEND_ACTION implements Clazz.PrependAction {
	...
	public PREPEND_ACTION() {
	}

	public PREPEND_ACTION(Long seq) {
		setSeq(seq);
	}

	public PREPEND_ACTION(String string) {
	...
	public PREPEND_ACTION(ActionStatus actionStatus) {
	...
	public PREPEND_ACTION(AdditionalType additionalType) {
	...
	public PREPEND_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public PREPEND_ACTION(AlternateName alternateName) {
	...
	public PREPEND_ACTION(Description description) {
	...
	public PREPEND_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public PREPEND_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public PREPEND_ACTION(Error error) {
		setError(error);
	}
	...
	public PREPEND_ACTION(Identifier identifier) {
	...
	public PREPEND_ACTION(Image image) {
		setImage(image);
	}
	...
	public PREPEND_ACTION(Instrument instrument) {
	...
	public PREPEND_ACTION(Location location) {
	...
	public PREPEND_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public PREPEND_ACTION(Name name) {
		setName(name);
	}
	...
	public PREPEND_ACTION(NameFuzzy nameFuzzy) {
	...
	public PREPEND_ACTION(NameRuby nameRuby) {
	...
	public PREPEND_ACTION(Object object) {
		setObject(object);
	}
	...
	public PREPEND_ACTION(Participant participant) {
	...
	public PREPEND_ACTION(PotentialAction potentialAction) {
	...
	public PREPEND_ACTION(Result result) {
		setResult(result);
	}
	...
	public PREPEND_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PREPEND_ACTION(StartTime startTime) {
	...
	public PREPEND_ACTION(SubjectOf subjectOf) {
	...
	public PREPEND_ACTION(Target target) {
		setTarget(target);
	}
	...
	public PREPEND_ACTION(TargetCollection targetCollection) {
	...
	public PREPEND_ACTION(ToLocation toLocation) {
	...
	public void copy(Clazz.PrependAction org) {
		setSeq(org.getSeq());
