...
public class NET_WORTH implements Container.NetWorth {
	...
	public NET_WORTH(String string) {
	...
	public NET_WORTH(CompoundPriceSpecification compoundPriceSpecification) {
	...
	public NET_WORTH(DeliveryChargeSpecification deliveryChargeSpecification) {
	...
	public NET_WORTH(MonetaryAmount monetaryAmount) {
		monetaryAmountList = new ArrayList<MonetaryAmount>();
	...
	public NET_WORTH(PaymentChargeSpecification paymentChargeSpecification) {
	...
	public NET_WORTH(PriceSpecification priceSpecification) {
	...
	public NET_WORTH(UnitPriceSpecification unitPriceSpecification) {
	...
	public NET_WORTH(List<CompoundPriceSpecification> compoundPriceSpecificationList,
	...
	public void copy(Container.NetWorth org) {
