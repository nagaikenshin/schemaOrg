...
public class ICE_CREAM_SHOP implements Clazz.IceCreamShop {
	...
	public ICE_CREAM_SHOP(GeoContains geoContains) {
	...
	public ICE_CREAM_SHOP(GeoCoveredBy geoCoveredBy) {
	...
	public ICE_CREAM_SHOP(GeoCovers geoCovers) {
	...
	public ICE_CREAM_SHOP(GeoCrosses geoCrosses) {
	...
	public ICE_CREAM_SHOP(GeoDisjoint geoDisjoint) {
	...
	public ICE_CREAM_SHOP(GeoEquals geoEquals) {
	...
	public ICE_CREAM_SHOP(GeoIntersects geoIntersects) {
	...
	public ICE_CREAM_SHOP(GeoOverlaps geoOverlaps) {
	...
	public ICE_CREAM_SHOP(GeoTouches geoTouches) {
	...
	public ICE_CREAM_SHOP(GeoWithin geoWithin) {
	...
	public ICE_CREAM_SHOP(Slogan slogan) {
		setSlogan(slogan);
	}
