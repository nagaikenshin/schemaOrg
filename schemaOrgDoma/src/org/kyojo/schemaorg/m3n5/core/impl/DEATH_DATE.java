...
public class DEATH_DATE implements Container.DeathDate {
	...
	public DEATH_DATE(java.util.Date date) {
		this(new DATE(date));
	}

	public DEATH_DATE(java.time.LocalDate date) {
		this(new DATE(date));
	}

	public DEATH_DATE(Date date) {
