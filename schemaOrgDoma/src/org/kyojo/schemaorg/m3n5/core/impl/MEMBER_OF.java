...
public class MEMBER_OF implements Container.MemberOf {
	...
	public MEMBER_OF(AccountingService accountingService) {
	...
	public MEMBER_OF(AdultEntertainment adultEntertainment) {
	...
	public MEMBER_OF(Airline airline) {
	...
	public MEMBER_OF(AmusementPark amusementPark) {
	...
	public MEMBER_OF(AnimalShelter animalShelter) {
	...
	public MEMBER_OF(ArchiveOrganization archiveOrganization) {
	...
	public MEMBER_OF(ArtGallery artGallery) {
	...
	public MEMBER_OF(Attorney attorney) {
	...
	public MEMBER_OF(AutoBodyShop autoBodyShop) {
	...
	public MEMBER_OF(AutoDealer autoDealer) {
	...
	public MEMBER_OF(AutoPartsStore autoPartsStore) {
	...
	public MEMBER_OF(AutoRental autoRental) {
	...
	public MEMBER_OF(AutoRepair autoRepair) {
	...
	public MEMBER_OF(AutoWash autoWash) {
	...
	public MEMBER_OF(AutomatedTeller automatedTeller) {
	...
	public MEMBER_OF(AutomotiveBusiness automotiveBusiness) {
	...
	public MEMBER_OF(Bakery bakery) {
	...
	public MEMBER_OF(BankOrCreditUnion bankOrCreditUnion) {
	...
	public MEMBER_OF(BarOrPub barOrPub) {
	...
	public MEMBER_OF(BeautySalon beautySalon) {
	...
	public MEMBER_OF(BedAndBreakfast bedAndBreakfast) {
	...
	public MEMBER_OF(BikeStore bikeStore) {
	...
	public MEMBER_OF(BookStore bookStore) {
	...
	public MEMBER_OF(BowlingAlley bowlingAlley) {
	...
	public MEMBER_OF(Brewery brewery) {
	...
	public MEMBER_OF(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public MEMBER_OF(Campground campground) {
	...
	public MEMBER_OF(Casino casino) {
	...
	public MEMBER_OF(ChildCare childCare) {
	...
	public MEMBER_OF(ClothingStore clothingStore) {
	...
	public MEMBER_OF(CollegeOrUniversity collegeOrUniversity) {
	...
	public MEMBER_OF(ComedyClub comedyClub) {
	...
	public MEMBER_OF(CommunityHealth communityHealth) {
	...
	public MEMBER_OF(ComputerStore computerStore) {
	...
	public MEMBER_OF(Consortium consortium) {
	...
	public MEMBER_OF(ConvenienceStore convenienceStore) {
	...
	public MEMBER_OF(Corporation corporation) {
	...
	public MEMBER_OF(DanceGroup danceGroup) {
	...
	public MEMBER_OF(DaySpa daySpa) {
	...
	public MEMBER_OF(Dentist dentist) {
	...
	public MEMBER_OF(DepartmentStore departmentStore) {
	...
	public MEMBER_OF(Dermatology dermatology) {
	...
	public MEMBER_OF(DiagnosticLab diagnosticLab) {
	...
	public MEMBER_OF(DietNutrition dietNutrition) {
	...
	public MEMBER_OF(Distillery distillery) {
	...
	public MEMBER_OF(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public MEMBER_OF(EducationalOrganization educationalOrganization) {
	...
	public MEMBER_OF(Electrician electrician) {
	...
	public MEMBER_OF(ElectronicsStore electronicsStore) {
	...
	public MEMBER_OF(ElementarySchool elementarySchool) {
	...
	public MEMBER_OF(Emergency emergency) {
	...
	public MEMBER_OF(EmergencyService emergencyService) {
	...
	public MEMBER_OF(EmploymentAgency employmentAgency) {
	...
	public MEMBER_OF(EntertainmentBusiness entertainmentBusiness) {
	...
	public MEMBER_OF(ExerciseGym exerciseGym) {
	...
	public MEMBER_OF(FastFoodRestaurant fastFoodRestaurant) {
	...
	public MEMBER_OF(FinancialService financialService) {
	...
	public MEMBER_OF(FireStation fireStation) {
	...
	public MEMBER_OF(Florist florist) {
	...
	public MEMBER_OF(FoodEstablishment foodEstablishment) {
	...
	public MEMBER_OF(FundingAgency fundingAgency) {
	...
	public MEMBER_OF(FundingScheme fundingScheme) {
	...
	public MEMBER_OF(FurnitureStore furnitureStore) {
	...
	public MEMBER_OF(GardenStore gardenStore) {
	...
	public MEMBER_OF(GasStation gasStation) {
	...
	public MEMBER_OF(GeneralContractor generalContractor) {
	...
	public MEMBER_OF(Geriatric geriatric) {
	...
	public MEMBER_OF(GolfCourse golfCourse) {
	...
	public MEMBER_OF(GovernmentOffice governmentOffice) {
	...
	public MEMBER_OF(GovernmentOrganization governmentOrganization) {
	...
	public MEMBER_OF(GroceryStore groceryStore) {
	...
	public MEMBER_OF(Gynecologic gynecologic) {
	...
	public MEMBER_OF(HVACBusiness hvacBusiness) {
	...
	public MEMBER_OF(HairSalon hairSalon) {
	...
	public MEMBER_OF(HardwareStore hardwareStore) {
	...
	public MEMBER_OF(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public MEMBER_OF(HealthClub healthClub) {
	...
	public MEMBER_OF(HighSchool highSchool) {
	...
	public MEMBER_OF(HobbyShop hobbyShop) {
	...
	public MEMBER_OF(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public MEMBER_OF(HomeGoodsStore homeGoodsStore) {
	...
	public MEMBER_OF(Hospital hospital) {
	...
	public MEMBER_OF(Hostel hostel) {
	...
	public MEMBER_OF(HousePainter housePainter) {
	...
	public MEMBER_OF(IceCreamShop iceCreamShop) {
	...
	public MEMBER_OF(InsuranceAgency insuranceAgency) {
	...
	public MEMBER_OF(InternetCafe internetCafe) {
	...
	public MEMBER_OF(JewelryStore jewelryStore) {
	...
	public MEMBER_OF(LegalService legalService) {
	...
	public MEMBER_OF(Library library) {
	...
	public MEMBER_OF(LibrarySystem librarySystem) {
	...
	public MEMBER_OF(LiquorStore liquorStore) {
	...
	public MEMBER_OF(LocalBusiness localBusiness) {
	...
	public MEMBER_OF(Locksmith locksmith) {
	...
	public MEMBER_OF(LodgingBusiness lodgingBusiness) {
	...
	public MEMBER_OF(MedicalBusiness medicalBusiness) {
	...
	public MEMBER_OF(MedicalClinic medicalClinic) {
	...
	public MEMBER_OF(MedicalOrganization medicalOrganization) {
	...
	public MEMBER_OF(MensClothingStore mensClothingStore) {
	...
	public MEMBER_OF(MiddleSchool middleSchool) {
	...
	public MEMBER_OF(Midwifery midwifery) {
	...
	public MEMBER_OF(MobilePhoneStore mobilePhoneStore) {
	...
	public MEMBER_OF(MotorcycleDealer motorcycleDealer) {
	...
	public MEMBER_OF(MotorcycleRepair motorcycleRepair) {
	...
	public MEMBER_OF(MovieRentalStore movieRentalStore) {
	...
	public MEMBER_OF(MovieTheater movieTheater) {
	...
	public MEMBER_OF(MovingCompany movingCompany) {
	...
	public MEMBER_OF(MusicGroup musicGroup) {
	...
	public MEMBER_OF(MusicStore musicStore) {
	...
	public MEMBER_OF(NailSalon nailSalon) {
	...
	public MEMBER_OF(NewsMediaOrganization newsMediaOrganization) {
	...
	public MEMBER_OF(NightClub nightClub) {
	...
	public MEMBER_OF(Notary notary) {
	...
	public MEMBER_OF(Nursing nursing) {
	...
	public MEMBER_OF(Obstetric obstetric) {
	...
	public MEMBER_OF(OfficeEquipmentStore officeEquipmentStore) {
	...
	public MEMBER_OF(Oncologic oncologic) {
	...
	public MEMBER_OF(Optician optician) {
	...
	public MEMBER_OF(Optometric optometric) {
	...
	public MEMBER_OF(Otolaryngologic otolaryngologic) {
	...
	public MEMBER_OF(OutletStore outletStore) {
	...
	public MEMBER_OF(PawnShop pawnShop) {
	...
	public MEMBER_OF(Pediatric pediatric) {
	...
	public MEMBER_OF(PerformingGroup performingGroup) {
	...
	public MEMBER_OF(PetStore petStore) {
	...
	public MEMBER_OF(Pharmacy pharmacy) {
	...
	public MEMBER_OF(Physician physician) {
	...
	public MEMBER_OF(Physiotherapy physiotherapy) {
	...
	public MEMBER_OF(PlasticSurgery plasticSurgery) {
	...
	public MEMBER_OF(Plumber plumber) {
	...
	public MEMBER_OF(Podiatric podiatric) {
	...
	public MEMBER_OF(PoliceStation policeStation) {
	...
	public MEMBER_OF(PostOffice postOffice) {
	...
	public MEMBER_OF(Preschool preschool) {
	...
	public MEMBER_OF(PrimaryCare primaryCare) {
	...
	public MEMBER_OF(ProfessionalService professionalService) {
	...
	public MEMBER_OF(Project project) {
	...
	public MEMBER_OF(Psychiatric psychiatric) {
	...
	public MEMBER_OF(PublicHealth publicHealth) {
	...
	public MEMBER_OF(PublicSwimmingPool publicSwimmingPool) {
	...
	public MEMBER_OF(RadioStation radioStation) {
	...
	public MEMBER_OF(RealEstateAgent realEstateAgent) {
	...
	public MEMBER_OF(RecyclingCenter recyclingCenter) {
	...
	public MEMBER_OF(ResearchProject researchProject) {
	...
	public MEMBER_OF(Resort resort) {
	...
	public MEMBER_OF(Restaurant restaurant) {
	...
	public MEMBER_OF(RoofingContractor roofingContractor) {
	...
	public MEMBER_OF(School school) {
	...
	public MEMBER_OF(SelfStorage selfStorage) {
	...
	public MEMBER_OF(ShoeStore shoeStore) {
	...
	public MEMBER_OF(ShoppingCenter shoppingCenter) {
	...
	public MEMBER_OF(SkiResort skiResort) {
	...
	public MEMBER_OF(SportingGoodsStore sportingGoodsStore) {
	...
	public MEMBER_OF(SportsActivityLocation sportsActivityLocation) {
	...
	public MEMBER_OF(SportsClub sportsClub) {
	...
	public MEMBER_OF(SportsOrganization sportsOrganization) {
	...
	public MEMBER_OF(SportsTeam sportsTeam) {
	...
	public MEMBER_OF(StadiumOrArena stadiumOrArena) {
	...
	public MEMBER_OF(TattooParlor tattooParlor) {
	...
	public MEMBER_OF(TelevisionStation televisionStation) {
	...
	public MEMBER_OF(TennisComplex tennisComplex) {
	...
	public MEMBER_OF(TheaterGroup theaterGroup) {
	...
	public MEMBER_OF(TireShop tireShop) {
	...
	public MEMBER_OF(TouristInformationCenter touristInformationCenter) {
	...
	public MEMBER_OF(ToyStore toyStore) {
	...
	public MEMBER_OF(TravelAgency travelAgency) {
	...
	public MEMBER_OF(VeterinaryCare veterinaryCare) {
	...
	public MEMBER_OF(WholesaleStore wholesaleStore) {
	...
	public MEMBER_OF(Winery winery) {
	...
	public MEMBER_OF(WorkersUnion workersUnion) {
