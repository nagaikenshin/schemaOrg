...
public class DRY_CLEANING_OR_LAUNDRY implements Clazz.DryCleaningOrLaundry {
	...
	public DRY_CLEANING_OR_LAUNDRY(GeoContains geoContains) {
	...
	public DRY_CLEANING_OR_LAUNDRY(GeoCoveredBy geoCoveredBy) {
	...
	public DRY_CLEANING_OR_LAUNDRY(GeoCovers geoCovers) {
	...
	public DRY_CLEANING_OR_LAUNDRY(GeoCrosses geoCrosses) {
	...
	public DRY_CLEANING_OR_LAUNDRY(GeoDisjoint geoDisjoint) {
	...
	public DRY_CLEANING_OR_LAUNDRY(GeoEquals geoEquals) {
	...
	public DRY_CLEANING_OR_LAUNDRY(GeoIntersects geoIntersects) {
	...
	public DRY_CLEANING_OR_LAUNDRY(GeoOverlaps geoOverlaps) {
	...
	public DRY_CLEANING_OR_LAUNDRY(GeoTouches geoTouches) {
	...
	public DRY_CLEANING_OR_LAUNDRY(GeoWithin geoWithin) {
	...
	public DRY_CLEANING_OR_LAUNDRY(Slogan slogan) {
		setSlogan(slogan);
	}
