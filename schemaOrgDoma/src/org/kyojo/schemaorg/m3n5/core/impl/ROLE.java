...
public class ROLE implements Clazz.Role {
	...
	public ROLE(AdditionalType additionalType) {
	...
	public ROLE(AlternateName alternateName) {
	...
	public ROLE(DisambiguatingDescription disambiguatingDescription) {
	...
	public ROLE(Identifier identifier) {
	...
	public ROLE(MainEntityOfPage mainEntityOfPage) {
	...
	public ROLE(NameFuzzy nameFuzzy) {
	...
	public ROLE(PotentialAction potentialAction) {
	...
	public ROLE(StartDate startDate) {
	...
	public ROLE(SubjectOf subjectOf) {
	...
	public void copy(Clazz.Role org) {
		setSeq(org.getSeq());
