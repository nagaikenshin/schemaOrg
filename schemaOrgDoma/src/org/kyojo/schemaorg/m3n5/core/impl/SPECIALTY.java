...
public class SPECIALTY implements Clazz.Specialty, Container.Specialty {
	...
	public SPECIALTY(AdditionalType additionalType) {
	...
	public SPECIALTY(AlternateName alternateName) {
	...
	public SPECIALTY(Description description) {
	...
	public SPECIALTY(DisambiguatingDescription disambiguatingDescription) {
	...
	public SPECIALTY(Identifier identifier) {
	...
	public SPECIALTY(MainEntityOfPage mainEntityOfPage) {
	...
	public SPECIALTY(NameFuzzy nameFuzzy) {
	...
	public SPECIALTY(NameRuby nameRuby) {
	...
	public SPECIALTY(PotentialAction potentialAction) {
	...
	public SPECIALTY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SPECIALTY(Clazz.Specialty specialty) {
		specialtyList = new ArrayList<Clazz.Specialty>();
	...
	public SPECIALTY(SubjectOf subjectOf) {
	...
	public SPECIALTY(SupersededBy supersededBy) {
