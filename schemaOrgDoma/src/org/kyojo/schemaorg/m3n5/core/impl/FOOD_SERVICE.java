...
public class FOOD_SERVICE implements Clazz.FoodService {
	...
	public FOOD_SERVICE(Long seq) {
		setSeq(seq);
	}

	public FOOD_SERVICE(String string) {
	...
	public FOOD_SERVICE(AdditionalType additionalType) {
	...
	public FOOD_SERVICE(AggregateRating aggregateRating) {
	...
	public FOOD_SERVICE(AlternateName alternateName) {
	...
	public FOOD_SERVICE(AreaServed areaServed) {
	...
	public FOOD_SERVICE(Audience audience) {
	...
	public FOOD_SERVICE(AvailableChannel availableChannel) {
	...
	public FOOD_SERVICE(Award award) {
		setAward(award);
	}
	...
	public FOOD_SERVICE(Brand brand) {
		setBrand(brand);
	}
	...
	public FOOD_SERVICE(Broker broker) {
		setBroker(broker);
	}
	...
	public FOOD_SERVICE(Category category) {
	...
	public FOOD_SERVICE(Description description) {
	...
	public FOOD_SERVICE(DisambiguatingDescription disambiguatingDescription) {
	...
	public FOOD_SERVICE(HasOfferCatalog hasOfferCatalog) {
	...
	public FOOD_SERVICE(HoursAvailable hoursAvailable) {
	...
	public FOOD_SERVICE(Identifier identifier) {
	...
	public FOOD_SERVICE(Image image) {
		setImage(image);
	}
	...
	public FOOD_SERVICE(IsRelatedTo isRelatedTo) {
	...
	public FOOD_SERVICE(IsSimilarTo isSimilarTo) {
	...
	public FOOD_SERVICE(MainEntityOfPage mainEntityOfPage) {
	...
	public FOOD_SERVICE(NameFuzzy nameFuzzy) {
	...
	public FOOD_SERVICE(NameRuby nameRuby) {
	...
	public FOOD_SERVICE(Offers offers) {
		setOffers(offers);
	}
	...
	public FOOD_SERVICE(PotentialAction potentialAction) {
	...
	public FOOD_SERVICE(Provider provider) {
	...
	public FOOD_SERVICE(ProviderMobility providerMobility) {
	...
	public FOOD_SERVICE(Review review) {
		setReview(review);
	}
	...
	public FOOD_SERVICE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public FOOD_SERVICE(ServiceOutput serviceOutput) {
	...
	public FOOD_SERVICE(ServiceType serviceType) {
	...
	public FOOD_SERVICE(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public FOOD_SERVICE(SubjectOf subjectOf) {
	...
	public FOOD_SERVICE(TermsOfService termsOfService) {
	...
	public void copy(Clazz.FoodService org) {
		setSeq(org.getSeq());
