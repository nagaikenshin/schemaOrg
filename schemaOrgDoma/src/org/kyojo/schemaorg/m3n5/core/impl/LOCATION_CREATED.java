...
public class LOCATION_CREATED implements Container.LocationCreated {
	...
	public LOCATION_CREATED(String string) {
	...
	public LOCATION_CREATED(Accommodation accommodation) {
	...
	public LOCATION_CREATED(AccountingService accountingService) {
	...
	public LOCATION_CREATED(AdministrativeArea administrativeArea) {
	...
	public LOCATION_CREATED(AdultEntertainment adultEntertainment) {
	...
	public LOCATION_CREATED(Airport airport) {
	...
	public LOCATION_CREATED(AmusementPark amusementPark) {
	...
	public LOCATION_CREATED(AnimalShelter animalShelter) {
	...
	public LOCATION_CREATED(Apartment apartment) {
	...
	public LOCATION_CREATED(ApartmentComplex apartmentComplex) {
	...
	public LOCATION_CREATED(Aquarium aquarium) {
	...
	public LOCATION_CREATED(ArchiveOrganization archiveOrganization) {
	...
	public LOCATION_CREATED(ArtGallery artGallery) {
	...
	public LOCATION_CREATED(Attorney attorney) {
	...
	public LOCATION_CREATED(AutoBodyShop autoBodyShop) {
	...
	public LOCATION_CREATED(AutoDealer autoDealer) {
	...
	public LOCATION_CREATED(AutoPartsStore autoPartsStore) {
	...
	public LOCATION_CREATED(AutoRental autoRental) {
	...
	public LOCATION_CREATED(AutoRepair autoRepair) {
	...
	public LOCATION_CREATED(AutoWash autoWash) {
	...
	public LOCATION_CREATED(AutomatedTeller automatedTeller) {
	...
	public LOCATION_CREATED(AutomotiveBusiness automotiveBusiness) {
	...
	public LOCATION_CREATED(Bakery bakery) {
	...
	public LOCATION_CREATED(BankOrCreditUnion bankOrCreditUnion) {
	...
	public LOCATION_CREATED(BarOrPub barOrPub) {
	...
	public LOCATION_CREATED(Beach beach) {
	...
	public LOCATION_CREATED(BeautySalon beautySalon) {
	...
	public LOCATION_CREATED(BedAndBreakfast bedAndBreakfast) {
	...
	public LOCATION_CREATED(BikeStore bikeStore) {
	...
	public LOCATION_CREATED(BodyOfWater bodyOfWater) {
	...
	public LOCATION_CREATED(BookStore bookStore) {
	...
	public LOCATION_CREATED(BowlingAlley bowlingAlley) {
	...
	public LOCATION_CREATED(Brewery brewery) {
	...
	public LOCATION_CREATED(Bridge bridge) {
	...
	public LOCATION_CREATED(BuddhistTemple buddhistTemple) {
	...
	public LOCATION_CREATED(BusStation busStation) {
	...
	public LOCATION_CREATED(BusStop busStop) {
	...
	public LOCATION_CREATED(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public LOCATION_CREATED(Campground campground) {
	...
	public LOCATION_CREATED(CampingPitch campingPitch) {
	...
	public LOCATION_CREATED(Canal canal) {
	...
	public LOCATION_CREATED(Casino casino) {
	...
	public LOCATION_CREATED(CatholicChurch catholicChurch) {
	...
	public LOCATION_CREATED(Cemetery cemetery) {
	...
	public LOCATION_CREATED(ChildCare childCare) {
	...
	public LOCATION_CREATED(Church church) {
	...
	public LOCATION_CREATED(City city) {
	...
	public LOCATION_CREATED(CityHall cityHall) {
	...
	public LOCATION_CREATED(CivicStructure civicStructure) {
	...
	public LOCATION_CREATED(ClothingStore clothingStore) {
	...
	public LOCATION_CREATED(ComedyClub comedyClub) {
	...
	public LOCATION_CREATED(CommunityHealth communityHealth) {
	...
	public LOCATION_CREATED(ComputerStore computerStore) {
	...
	public LOCATION_CREATED(Continent continent) {
	...
	public LOCATION_CREATED(ConvenienceStore convenienceStore) {
	...
	public LOCATION_CREATED(Country country) {
	...
	public LOCATION_CREATED(Courthouse courthouse) {
	...
	public LOCATION_CREATED(Crematorium crematorium) {
	...
	public LOCATION_CREATED(DaySpa daySpa) {
	...
	public LOCATION_CREATED(DefenceEstablishment defenceEstablishment) {
	...
	public LOCATION_CREATED(Dentist dentist) {
	...
	public LOCATION_CREATED(DepartmentStore departmentStore) {
	...
	public LOCATION_CREATED(Dermatology dermatology) {
	...
	public LOCATION_CREATED(DietNutrition dietNutrition) {
	...
	public LOCATION_CREATED(Distillery distillery) {
	...
	public LOCATION_CREATED(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public LOCATION_CREATED(Electrician electrician) {
	...
	public LOCATION_CREATED(ElectronicsStore electronicsStore) {
	...
	public LOCATION_CREATED(Embassy embassy) {
	...
	public LOCATION_CREATED(Emergency emergency) {
	...
	public LOCATION_CREATED(EmergencyService emergencyService) {
	...
	public LOCATION_CREATED(EmploymentAgency employmentAgency) {
	...
	public LOCATION_CREATED(EntertainmentBusiness entertainmentBusiness) {
	...
	public LOCATION_CREATED(EventVenue eventVenue) {
	...
	public LOCATION_CREATED(ExerciseGym exerciseGym) {
	...
	public LOCATION_CREATED(FastFoodRestaurant fastFoodRestaurant) {
	...
	public LOCATION_CREATED(FinancialService financialService) {
	...
	public LOCATION_CREATED(FireStation fireStation) {
	...
	public LOCATION_CREATED(Florist florist) {
	...
	public LOCATION_CREATED(FoodEstablishment foodEstablishment) {
	...
	public LOCATION_CREATED(FurnitureStore furnitureStore) {
	...
	public LOCATION_CREATED(GardenStore gardenStore) {
	...
	public LOCATION_CREATED(GasStation gasStation) {
	...
	public LOCATION_CREATED(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public LOCATION_CREATED(GeneralContractor generalContractor) {
	...
	public LOCATION_CREATED(Geriatric geriatric) {
	...
	public LOCATION_CREATED(GolfCourse golfCourse) {
	...
	public LOCATION_CREATED(GovernmentBuilding governmentBuilding) {
	...
	public LOCATION_CREATED(GovernmentOffice governmentOffice) {
	...
	public LOCATION_CREATED(GroceryStore groceryStore) {
	...
	public LOCATION_CREATED(Gynecologic gynecologic) {
	...
	public LOCATION_CREATED(HVACBusiness hvacBusiness) {
	...
	public LOCATION_CREATED(HairSalon hairSalon) {
	...
	public LOCATION_CREATED(HardwareStore hardwareStore) {
	...
	public LOCATION_CREATED(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public LOCATION_CREATED(HealthClub healthClub) {
	...
	public LOCATION_CREATED(HinduTemple hinduTemple) {
	...
	public LOCATION_CREATED(HobbyShop hobbyShop) {
	...
	public LOCATION_CREATED(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public LOCATION_CREATED(HomeGoodsStore homeGoodsStore) {
	...
	public LOCATION_CREATED(Hospital hospital) {
	...
	public LOCATION_CREATED(Hostel hostel) {
	...
	public LOCATION_CREATED(Hotel hotel) {
	...
	public LOCATION_CREATED(HotelRoom hotelRoom) {
	...
	public LOCATION_CREATED(House house) {
	...
	public LOCATION_CREATED(HousePainter housePainter) {
	...
	public LOCATION_CREATED(IceCreamShop iceCreamShop) {
	...
	public LOCATION_CREATED(InsuranceAgency insuranceAgency) {
	...
	public LOCATION_CREATED(InternetCafe internetCafe) {
	...
	public LOCATION_CREATED(JewelryStore jewelryStore) {
	...
	public LOCATION_CREATED(LakeBodyOfWater lakeBodyOfWater) {
	...
	public LOCATION_CREATED(Landform landform) {
	...
	public LOCATION_CREATED(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public LOCATION_CREATED(LegalService legalService) {
	...
	public LOCATION_CREATED(LegislativeBuilding legislativeBuilding) {
	...
	public LOCATION_CREATED(Library library) {
	...
	public LOCATION_CREATED(LiquorStore liquorStore) {
	...
	public LOCATION_CREATED(LocalBusiness localBusiness) {
	...
	public LOCATION_CREATED(Locksmith locksmith) {
	...
	public LOCATION_CREATED(LodgingBusiness lodgingBusiness) {
	...
	public LOCATION_CREATED(MedicalBusiness medicalBusiness) {
	...
	public LOCATION_CREATED(MedicalClinic medicalClinic) {
	...
	public LOCATION_CREATED(MeetingRoom meetingRoom) {
	...
	public LOCATION_CREATED(MensClothingStore mensClothingStore) {
	...
	public LOCATION_CREATED(Midwifery midwifery) {
	...
	public LOCATION_CREATED(MobilePhoneStore mobilePhoneStore) {
	...
	public LOCATION_CREATED(Mosque mosque) {
	...
	public LOCATION_CREATED(Motel motel) {
	...
	public LOCATION_CREATED(MotorcycleDealer motorcycleDealer) {
	...
	public LOCATION_CREATED(MotorcycleRepair motorcycleRepair) {
	...
	public LOCATION_CREATED(Mountain mountain) {
	...
	public LOCATION_CREATED(MovieRentalStore movieRentalStore) {
	...
	public LOCATION_CREATED(MovieTheater movieTheater) {
	...
	public LOCATION_CREATED(MovingCompany movingCompany) {
	...
	public LOCATION_CREATED(Museum museum) {
	...
	public LOCATION_CREATED(MusicStore musicStore) {
	...
	public LOCATION_CREATED(MusicVenue musicVenue) {
	...
	public LOCATION_CREATED(NailSalon nailSalon) {
	...
	public LOCATION_CREATED(NightClub nightClub) {
	...
	public LOCATION_CREATED(Notary notary) {
	...
	public LOCATION_CREATED(Nursing nursing) {
	...
	public LOCATION_CREATED(Obstetric obstetric) {
	...
	public LOCATION_CREATED(OceanBodyOfWater oceanBodyOfWater) {
	...
	public LOCATION_CREATED(OfficeEquipmentStore officeEquipmentStore) {
	...
	public LOCATION_CREATED(Oncologic oncologic) {
	...
	public LOCATION_CREATED(Optician optician) {
	...
	public LOCATION_CREATED(Optometric optometric) {
	...
	public LOCATION_CREATED(Otolaryngologic otolaryngologic) {
	...
	public LOCATION_CREATED(OutletStore outletStore) {
	...
	public LOCATION_CREATED(Park park) {
	...
	public LOCATION_CREATED(ParkingFacility parkingFacility) {
	...
	public LOCATION_CREATED(PawnShop pawnShop) {
	...
	public LOCATION_CREATED(Pediatric pediatric) {
	...
	public LOCATION_CREATED(PerformingArtsTheater performingArtsTheater) {
	...
	public LOCATION_CREATED(PetStore petStore) {
	...
	public LOCATION_CREATED(Pharmacy pharmacy) {
	...
	public LOCATION_CREATED(Physician physician) {
	...
	public LOCATION_CREATED(Physiotherapy physiotherapy) {
	...
	public LOCATION_CREATED(Place place) {
		placeList = new ArrayList<Place>();
		placeList.add(place);
	}
	...
	public LOCATION_CREATED(PlaceOfWorship placeOfWorship) {
	...
	public LOCATION_CREATED(PlasticSurgery plasticSurgery) {
	...
	public LOCATION_CREATED(Playground playground) {
	...
	public LOCATION_CREATED(Plumber plumber) {
	...
	public LOCATION_CREATED(Podiatric podiatric) {
	...
	public LOCATION_CREATED(PoliceStation policeStation) {
	...
	public LOCATION_CREATED(Pond pond) {
	...
	public LOCATION_CREATED(PostOffice postOffice) {
	...
	public LOCATION_CREATED(PrimaryCare primaryCare) {
	...
	public LOCATION_CREATED(ProfessionalService professionalService) {
	...
	public LOCATION_CREATED(Psychiatric psychiatric) {
	...
	public LOCATION_CREATED(PublicHealth publicHealth) {
	...
	public LOCATION_CREATED(PublicSwimmingPool publicSwimmingPool) {
	...
	public LOCATION_CREATED(PublicToilet publicToilet) {
	...
	public LOCATION_CREATED(RVPark rvPark) {
	...
	public LOCATION_CREATED(RadioStation radioStation) {
	...
	public LOCATION_CREATED(RealEstateAgent realEstateAgent) {
	...
	public LOCATION_CREATED(RecyclingCenter recyclingCenter) {
	...
	public LOCATION_CREATED(Reservoir reservoir) {
	...
	public LOCATION_CREATED(Residence residence) {
	...
	public LOCATION_CREATED(Resort resort) {
	...
	public LOCATION_CREATED(Restaurant restaurant) {
	...
	public LOCATION_CREATED(RiverBodyOfWater riverBodyOfWater) {
	...
	public LOCATION_CREATED(RoofingContractor roofingContractor) {
	...
	public LOCATION_CREATED(Room room) {
	...
	public LOCATION_CREATED(SeaBodyOfWater seaBodyOfWater) {
	...
	public LOCATION_CREATED(SelfStorage selfStorage) {
	...
	public LOCATION_CREATED(ShoeStore shoeStore) {
	...
	public LOCATION_CREATED(ShoppingCenter shoppingCenter) {
	...
	public LOCATION_CREATED(SingleFamilyResidence singleFamilyResidence) {
	...
	public LOCATION_CREATED(SkiResort skiResort) {
	...
	public LOCATION_CREATED(SportingGoodsStore sportingGoodsStore) {
	...
	public LOCATION_CREATED(SportsActivityLocation sportsActivityLocation) {
	...
	public LOCATION_CREATED(SportsClub sportsClub) {
	...
	public LOCATION_CREATED(StadiumOrArena stadiumOrArena) {
	...
	public LOCATION_CREATED(State state) {
	...
	public LOCATION_CREATED(Store store) {
	...
	public LOCATION_CREATED(SubwayStation subwayStation) {
	...
	public LOCATION_CREATED(Suite suite) {
	...
	public LOCATION_CREATED(Synagogue synagogue) {
	...
	public LOCATION_CREATED(TattooParlor tattooParlor) {
	...
	public LOCATION_CREATED(TaxiStand taxiStand) {
	...
	public LOCATION_CREATED(TelevisionStation televisionStation) {
	...
	public LOCATION_CREATED(TennisComplex tennisComplex) {
	...
	public LOCATION_CREATED(TireShop tireShop) {
	...
	public LOCATION_CREATED(TouristAttraction touristAttraction) {
	...
	public LOCATION_CREATED(TouristDestination touristDestination) {
	...
	public LOCATION_CREATED(TouristInformationCenter touristInformationCenter) {
	...
	public LOCATION_CREATED(ToyStore toyStore) {
	...
	public LOCATION_CREATED(TrainStation trainStation) {
	...
	public LOCATION_CREATED(TravelAgency travelAgency) {
	...
	public LOCATION_CREATED(Volcano volcano) {
	...
	public LOCATION_CREATED(Waterfall waterfall) {
	...
	public LOCATION_CREATED(WholesaleStore wholesaleStore) {
	...
	public LOCATION_CREATED(Winery winery) {
	...
	public LOCATION_CREATED(Zoo zoo) {
	...
	public void copy(Container.LocationCreated org) {
