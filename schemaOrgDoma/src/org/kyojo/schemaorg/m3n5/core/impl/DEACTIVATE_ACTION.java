...
public class DEACTIVATE_ACTION implements Clazz.DeactivateAction {
	...
	public DEACTIVATE_ACTION() {
	}

	public DEACTIVATE_ACTION(Long seq) {
		setSeq(seq);
	}

	public DEACTIVATE_ACTION(String string) {
	...
	public DEACTIVATE_ACTION(ActionStatus actionStatus) {
	...
	public DEACTIVATE_ACTION(AdditionalType additionalType) {
	...
	public DEACTIVATE_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public DEACTIVATE_ACTION(AlternateName alternateName) {
	...
	public DEACTIVATE_ACTION(Description description) {
	...
	public DEACTIVATE_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public DEACTIVATE_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public DEACTIVATE_ACTION(Error error) {
		setError(error);
	}
	...
	public DEACTIVATE_ACTION(Identifier identifier) {
	...
	public DEACTIVATE_ACTION(Image image) {
		setImage(image);
	}
	...
	public DEACTIVATE_ACTION(Instrument instrument) {
	...
	public DEACTIVATE_ACTION(Location location) {
	...
	public DEACTIVATE_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public DEACTIVATE_ACTION(Name name) {
		setName(name);
	}
	...
	public DEACTIVATE_ACTION(NameFuzzy nameFuzzy) {
	...
	public DEACTIVATE_ACTION(NameRuby nameRuby) {
	...
	public DEACTIVATE_ACTION(Object object) {
		setObject(object);
	}
	...
	public DEACTIVATE_ACTION(Participant participant) {
	...
	public DEACTIVATE_ACTION(PotentialAction potentialAction) {
	...
	public DEACTIVATE_ACTION(Result result) {
		setResult(result);
	}
	...
	public DEACTIVATE_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DEACTIVATE_ACTION(StartTime startTime) {
	...
	public DEACTIVATE_ACTION(SubjectOf subjectOf) {
	...
	public DEACTIVATE_ACTION(Target target) {
		setTarget(target);
	}
	...
	public DEACTIVATE_ACTION(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.DeactivateAction org) {
		setSeq(org.getSeq());
