...
public class INSERT_ACTION implements Clazz.InsertAction {
	...
	public INSERT_ACTION(Long seq) {
		setSeq(seq);
	}

	public INSERT_ACTION(String string) {
	...
	public INSERT_ACTION(ActionStatus actionStatus) {
	...
	public INSERT_ACTION(AdditionalType additionalType) {
	...
	public INSERT_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public INSERT_ACTION(AlternateName alternateName) {
	...
	public INSERT_ACTION(Description description) {
	...
	public INSERT_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public INSERT_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public INSERT_ACTION(Error error) {
		setError(error);
	}
	...
	public INSERT_ACTION(Identifier identifier) {
	...
	public INSERT_ACTION(Image image) {
		setImage(image);
	}
	...
	public INSERT_ACTION(Instrument instrument) {
	...
	public INSERT_ACTION(Location location) {
	...
	public INSERT_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public INSERT_ACTION(Name name) {
		setName(name);
	}
	...
	public INSERT_ACTION(NameFuzzy nameFuzzy) {
	...
	public INSERT_ACTION(NameRuby nameRuby) {
	...
	public INSERT_ACTION(Object object) {
		setObject(object);
	}
	...
	public INSERT_ACTION(Participant participant) {
	...
	public INSERT_ACTION(PotentialAction potentialAction) {
	...
	public INSERT_ACTION(Result result) {
		setResult(result);
	}
	...
	public INSERT_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public INSERT_ACTION(StartTime startTime) {
	...
	public INSERT_ACTION(SubjectOf subjectOf) {
	...
	public INSERT_ACTION(Target target) {
		setTarget(target);
	}
	...
	public INSERT_ACTION(TargetCollection targetCollection) {
	...
	public INSERT_ACTION(ToLocation toLocation) {
	...
	public void copy(Clazz.InsertAction org) {
		setSeq(org.getSeq());
