...
public class CUSTOMER implements Container.Customer {
	...
	public CUSTOMER(AccountingService accountingService) {
	...
	public CUSTOMER(AdultEntertainment adultEntertainment) {
	...
	public CUSTOMER(Airline airline) {
	...
	public CUSTOMER(AmusementPark amusementPark) {
	...
	public CUSTOMER(AnimalShelter animalShelter) {
	...
	public CUSTOMER(ArchiveOrganization archiveOrganization) {
	...
	public CUSTOMER(ArtGallery artGallery) {
	...
	public CUSTOMER(Attorney attorney) {
	...
	public CUSTOMER(AutoBodyShop autoBodyShop) {
	...
	public CUSTOMER(AutoPartsStore autoPartsStore) {
	...
	public CUSTOMER(AutoRental autoRental) {
	...
	public CUSTOMER(AutoRepair autoRepair) {
	...
	public CUSTOMER(AutoWash autoWash) {
	...
	public CUSTOMER(AutomatedTeller automatedTeller) {
	...
	public CUSTOMER(AutomotiveBusiness automotiveBusiness) {
	...
	public CUSTOMER(BankOrCreditUnion bankOrCreditUnion) {
	...
	public CUSTOMER(BarOrPub barOrPub) {
	...
	public CUSTOMER(BeautySalon beautySalon) {
	...
	public CUSTOMER(BedAndBreakfast bedAndBreakfast) {
	...
	public CUSTOMER(BikeStore bikeStore) {
	...
	public CUSTOMER(BowlingAlley bowlingAlley) {
	...
	public CUSTOMER(Brewery brewery) {
	...
	public CUSTOMER(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public CUSTOMER(Campground campground) {
	...
	public CUSTOMER(ChildCare childCare) {
	...
	public CUSTOMER(ClothingStore clothingStore) {
	...
	public CUSTOMER(CollegeOrUniversity collegeOrUniversity) {
	...
	public CUSTOMER(ComedyClub comedyClub) {
	...
	public CUSTOMER(CommunityHealth communityHealth) {
	...
	public CUSTOMER(ComputerStore computerStore) {
	...
	public CUSTOMER(Consortium consortium) {
	...
	public CUSTOMER(ConvenienceStore convenienceStore) {
	...
	public CUSTOMER(Corporation corporation) {
	...
	public CUSTOMER(DanceGroup danceGroup) {
	...
	public CUSTOMER(Dentist dentist) {
	...
	public CUSTOMER(DepartmentStore departmentStore) {
	...
	public CUSTOMER(Dermatology dermatology) {
	...
	public CUSTOMER(DiagnosticLab diagnosticLab) {
	...
	public CUSTOMER(DietNutrition dietNutrition) {
	...
	public CUSTOMER(Distillery distillery) {
	...
	public CUSTOMER(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public CUSTOMER(EducationalOrganization educationalOrganization) {
	...
	public CUSTOMER(Electrician electrician) {
	...
	public CUSTOMER(ElectronicsStore electronicsStore) {
	...
	public CUSTOMER(ElementarySchool elementarySchool) {
	...
	public CUSTOMER(Emergency emergency) {
	...
	public CUSTOMER(EmergencyService emergencyService) {
	...
	public CUSTOMER(EmploymentAgency employmentAgency) {
	...
	public CUSTOMER(EntertainmentBusiness entertainmentBusiness) {
	...
	public CUSTOMER(ExerciseGym exerciseGym) {
	...
	public CUSTOMER(FinancialService financialService) {
	...
	public CUSTOMER(FireStation fireStation) {
	...
	public CUSTOMER(Florist florist) {
	...
	public CUSTOMER(FoodEstablishment foodEstablishment) {
	...
	public CUSTOMER(FundingAgency fundingAgency) {
	...
	public CUSTOMER(FundingScheme fundingScheme) {
	...
	public CUSTOMER(FurnitureStore furnitureStore) {
	...
	public CUSTOMER(GardenStore gardenStore) {
	...
	public CUSTOMER(GasStation gasStation) {
	...
	public CUSTOMER(GeneralContractor generalContractor) {
	...
	public CUSTOMER(Geriatric geriatric) {
	...
	public CUSTOMER(GolfCourse golfCourse) {
	...
	public CUSTOMER(GovernmentOffice governmentOffice) {
	...
	public CUSTOMER(GovernmentOrganization governmentOrganization) {
	...
	public CUSTOMER(GroceryStore groceryStore) {
	...
	public CUSTOMER(Gynecologic gynecologic) {
	...
	public CUSTOMER(HVACBusiness hvacBusiness) {
	...
	public CUSTOMER(HairSalon hairSalon) {
	...
	public CUSTOMER(HardwareStore hardwareStore) {
	...
	public CUSTOMER(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public CUSTOMER(HealthClub healthClub) {
	...
	public CUSTOMER(HighSchool highSchool) {
	...
	public CUSTOMER(HobbyShop hobbyShop) {
	...
	public CUSTOMER(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public CUSTOMER(HomeGoodsStore homeGoodsStore) {
	...
	public CUSTOMER(Hospital hospital) {
	...
	public CUSTOMER(HousePainter housePainter) {
	...
	public CUSTOMER(IceCreamShop iceCreamShop) {
	...
	public CUSTOMER(InsuranceAgency insuranceAgency) {
	...
	public CUSTOMER(InternetCafe internetCafe) {
	...
	public CUSTOMER(JewelryStore jewelryStore) {
	...
	public CUSTOMER(LegalService legalService) {
	...
	public CUSTOMER(LibrarySystem librarySystem) {
	...
	public CUSTOMER(LiquorStore liquorStore) {
	...
	public CUSTOMER(LocalBusiness localBusiness) {
	...
	public CUSTOMER(Locksmith locksmith) {
	...
	public CUSTOMER(LodgingBusiness lodgingBusiness) {
	...
	public CUSTOMER(MedicalBusiness medicalBusiness) {
	...
	public CUSTOMER(MedicalClinic medicalClinic) {
	...
	public CUSTOMER(MedicalOrganization medicalOrganization) {
	...
	public CUSTOMER(MensClothingStore mensClothingStore) {
	...
	public CUSTOMER(MiddleSchool middleSchool) {
	...
	public CUSTOMER(Midwifery midwifery) {
	...
	public CUSTOMER(MobilePhoneStore mobilePhoneStore) {
	...
	public CUSTOMER(MotorcycleDealer motorcycleDealer) {
	...
	public CUSTOMER(MotorcycleRepair motorcycleRepair) {
	...
	public CUSTOMER(MovieRentalStore movieRentalStore) {
	...
	public CUSTOMER(MovieTheater movieTheater) {
	...
	public CUSTOMER(MovingCompany movingCompany) {
	...
	public CUSTOMER(MusicGroup musicGroup) {
	...
	public CUSTOMER(MusicStore musicStore) {
	...
	public CUSTOMER(NailSalon nailSalon) {
	...
	public CUSTOMER(NewsMediaOrganization newsMediaOrganization) {
	...
	public CUSTOMER(NightClub nightClub) {
	...
	public CUSTOMER(Nursing nursing) {
	...
	public CUSTOMER(Obstetric obstetric) {
	...
	public CUSTOMER(OfficeEquipmentStore officeEquipmentStore) {
	...
	public CUSTOMER(Oncologic oncologic) {
	...
	public CUSTOMER(Optician optician) {
	...
	public CUSTOMER(Optometric optometric) {
	...
	public CUSTOMER(Otolaryngologic otolaryngologic) {
	...
	public CUSTOMER(OutletStore outletStore) {
	...
	public CUSTOMER(PawnShop pawnShop) {
	...
	public CUSTOMER(Pediatric pediatric) {
	...
	public CUSTOMER(PerformingGroup performingGroup) {
	...
	public CUSTOMER(PetStore petStore) {
	...
	public CUSTOMER(Pharmacy pharmacy) {
	...
	public CUSTOMER(Physician physician) {
	...
	public CUSTOMER(Physiotherapy physiotherapy) {
	...
	public CUSTOMER(PlasticSurgery plasticSurgery) {
	...
	public CUSTOMER(Plumber plumber) {
	...
	public CUSTOMER(Podiatric podiatric) {
	...
	public CUSTOMER(PoliceStation policeStation) {
	...
	public CUSTOMER(PostOffice postOffice) {
	...
	public CUSTOMER(Preschool preschool) {
	...
	public CUSTOMER(PrimaryCare primaryCare) {
	...
	public CUSTOMER(ProfessionalService professionalService) {
	...
	public CUSTOMER(Psychiatric psychiatric) {
	...
	public CUSTOMER(PublicHealth publicHealth) {
	...
	public CUSTOMER(PublicSwimmingPool publicSwimmingPool) {
	...
	public CUSTOMER(RadioStation radioStation) {
	...
	public CUSTOMER(RealEstateAgent realEstateAgent) {
	...
	public CUSTOMER(RecyclingCenter recyclingCenter) {
	...
	public CUSTOMER(ResearchProject researchProject) {
	...
	public CUSTOMER(RoofingContractor roofingContractor) {
	...
	public CUSTOMER(SelfStorage selfStorage) {
	...
	public CUSTOMER(ShoeStore shoeStore) {
	...
	public CUSTOMER(ShoppingCenter shoppingCenter) {
	...
	public CUSTOMER(SkiResort skiResort) {
	...
	public CUSTOMER(SportingGoodsStore sportingGoodsStore) {
	...
	public CUSTOMER(SportsActivityLocation sportsActivityLocation) {
	...
	public CUSTOMER(SportsClub sportsClub) {
	...
	public CUSTOMER(SportsOrganization sportsOrganization) {
	...
	public CUSTOMER(SportsTeam sportsTeam) {
	...
	public CUSTOMER(StadiumOrArena stadiumOrArena) {
	...
	public CUSTOMER(TattooParlor tattooParlor) {
	...
	public CUSTOMER(TelevisionStation televisionStation) {
	...
	public CUSTOMER(TennisComplex tennisComplex) {
	...
	public CUSTOMER(TheaterGroup theaterGroup) {
	...
	public CUSTOMER(TireShop tireShop) {
	...
	public CUSTOMER(TouristInformationCenter touristInformationCenter) {
	...
	public CUSTOMER(ToyStore toyStore) {
	...
	public CUSTOMER(TravelAgency travelAgency) {
	...
	public CUSTOMER(VeterinaryCare veterinaryCare) {
	...
	public CUSTOMER(WholesaleStore wholesaleStore) {
	...
	public CUSTOMER(WorkersUnion workersUnion) {
	...
	public void copy(Container.Customer org) {
