...
public class MOUNTAIN implements Clazz.Mountain {
	...
	public MOUNTAIN(GeoContains geoContains) {
	...
	public MOUNTAIN(GeoCoveredBy geoCoveredBy) {
	...
	public MOUNTAIN(GeoCovers geoCovers) {
	...
	public MOUNTAIN(GeoCrosses geoCrosses) {
	...
	public MOUNTAIN(GeoDisjoint geoDisjoint) {
	...
	public MOUNTAIN(GeoEquals geoEquals) {
	...
	public MOUNTAIN(GeoIntersects geoIntersects) {
	...
	public MOUNTAIN(GeoOverlaps geoOverlaps) {
	...
	public MOUNTAIN(GeoTouches geoTouches) {
	...
	public MOUNTAIN(GeoWithin geoWithin) {
