...
public class MOVIE_SERIES implements Clazz.MovieSeries {
	...
	public MOVIE_SERIES(Long seq) {
		setSeq(seq);
	}

	public MOVIE_SERIES(String string) {
	...
	public MOVIE_SERIES(About about) {
		setAbout(about);
	}
	...
	public MOVIE_SERIES(AccessMode accessMode) {
	...
	public MOVIE_SERIES(AccessModeSufficient accessModeSufficient) {
	...
	public MOVIE_SERIES(AccessibilityAPI accessibilityAPI) {
	...
	public MOVIE_SERIES(AccessibilityControl accessibilityControl) {
	...
	public MOVIE_SERIES(AccessibilityFeature accessibilityFeature) {
	...
	public MOVIE_SERIES(AccessibilityHazard accessibilityHazard) {
	...
	public MOVIE_SERIES(AccessibilitySummary accessibilitySummary) {
	...
	public MOVIE_SERIES(AccountablePerson accountablePerson) {
	...
	public MOVIE_SERIES(Actor actor) {
		setActor(actor);
	}
	...
	public MOVIE_SERIES(AdditionalType additionalType) {
	...
	public MOVIE_SERIES(AggregateRating aggregateRating) {
	...
	public MOVIE_SERIES(AlternateName alternateName) {
	...
	public MOVIE_SERIES(AlternativeHeadline alternativeHeadline) {
	...
	public MOVIE_SERIES(AssociatedMedia associatedMedia) {
	...
	public MOVIE_SERIES(Audience audience) {
	...
	public MOVIE_SERIES(Audio audio) {
		setAudio(audio);
	}
	...
	public MOVIE_SERIES(Author author) {
		setAuthor(author);
	}
	...
	public MOVIE_SERIES(Award award) {
		setAward(award);
	}
	...
	public MOVIE_SERIES(Character character) {
	...
	public MOVIE_SERIES(Citation citation) {
	...
	public MOVIE_SERIES(Comment comment) {
		setComment(comment);
	}
	...
	public MOVIE_SERIES(CommentCount commentCount) {
	...
	public MOVIE_SERIES(ContentLocation contentLocation) {
	...
	public MOVIE_SERIES(ContentRating contentRating) {
	...
	public MOVIE_SERIES(ContentReferenceTime contentReferenceTime) {
	...
	public MOVIE_SERIES(Contributor contributor) {
	...
	public MOVIE_SERIES(CopyrightHolder copyrightHolder) {
	...
	public MOVIE_SERIES(CopyrightYear copyrightYear) {
	...
	public MOVIE_SERIES(Correction correction) {
	...
	public MOVIE_SERIES(Creator creator) {
		setCreator(creator);
	}
	...
	public MOVIE_SERIES(DateCreated dateCreated) {
	...
	public MOVIE_SERIES(DateModified dateModified) {
	...
	public MOVIE_SERIES(DatePublished datePublished) {
	...
	public MOVIE_SERIES(Description description) {
	...
	public MOVIE_SERIES(Director director) {
	...
	public MOVIE_SERIES(DisambiguatingDescription disambiguatingDescription) {
	...
	public MOVIE_SERIES(DiscussionUrl discussionUrl) {
	...
	public MOVIE_SERIES(Editor editor) {
		setEditor(editor);
	}
	...
	public MOVIE_SERIES(EducationalAlignment educationalAlignment) {
	...
	public MOVIE_SERIES(EducationalUse educationalUse) {
	...
	public MOVIE_SERIES(Encoding encoding) {
	...
	public MOVIE_SERIES(EncodingFormat encodingFormat) {
	...
	public MOVIE_SERIES(EndDate endDate) {
		setEndDate(endDate);
	}
	...
	public MOVIE_SERIES(ExampleOfWork exampleOfWork) {
	...
	public MOVIE_SERIES(Expires expires) {
		setExpires(expires);
	}
	...
	public MOVIE_SERIES(Funder funder) {
		setFunder(funder);
	}
	...
	public MOVIE_SERIES(Genre genre) {
		setGenre(genre);
	}
	...
	public MOVIE_SERIES(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public MOVIE_SERIES(Headline headline) {
	...
	public MOVIE_SERIES(Identifier identifier) {
	...
	public MOVIE_SERIES(Image image) {
		setImage(image);
	}
	...
	public MOVIE_SERIES(InLanguage inLanguage) {
	...
	public MOVIE_SERIES(InteractionStatistic interactionStatistic) {
	...
	public MOVIE_SERIES(InteractivityType interactivityType) {
	...
	public MOVIE_SERIES(IsAccessibleForFree isAccessibleForFree) {
	...
	public MOVIE_SERIES(IsBasedOn isBasedOn) {
	...
	public MOVIE_SERIES(IsFamilyFriendly isFamilyFriendly) {
	...
	public MOVIE_SERIES(IsPartOf isPartOf) {
	...
	public MOVIE_SERIES(Keywords keywords) {
	...
	public MOVIE_SERIES(LearningResourceType learningResourceType) {
	...
	public MOVIE_SERIES(License license) {
		setLicense(license);
	}
	...
	public MOVIE_SERIES(LocationCreated locationCreated) {
	...
	public MOVIE_SERIES(MainEntity mainEntity) {
	...
	public MOVIE_SERIES(MainEntityOfPage mainEntityOfPage) {
	...
	public MOVIE_SERIES(Material material) {
	...
	public MOVIE_SERIES(MaterialExtent materialExtent) {
	...
	public MOVIE_SERIES(Mentions mentions) {
	...
	public MOVIE_SERIES(MusicBy musicBy) {
		setMusicBy(musicBy);
	}
	...
	public MOVIE_SERIES(NameFuzzy nameFuzzy) {
	...
	public MOVIE_SERIES(NameRuby nameRuby) {
	...
	public MOVIE_SERIES(Offers offers) {
		setOffers(offers);
	}
	...
	public MOVIE_SERIES(Position position) {
	...
	public MOVIE_SERIES(PotentialAction potentialAction) {
	...
	public MOVIE_SERIES(Producer producer) {
	...
	public MOVIE_SERIES(ProductionCompany productionCompany) {
	...
	public MOVIE_SERIES(Provider provider) {
	...
	public MOVIE_SERIES(Publication publication) {
	...
	public MOVIE_SERIES(Publisher publisher) {
	...
	public MOVIE_SERIES(PublisherImprint publisherImprint) {
	...
	public MOVIE_SERIES(PublishingPrinciples publishingPrinciples) {
	...
	public MOVIE_SERIES(RecordedAt recordedAt) {
	...
	public MOVIE_SERIES(ReleasedEvent releasedEvent) {
	...
	public MOVIE_SERIES(Review review) {
		setReview(review);
	}
	...
	public MOVIE_SERIES(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MOVIE_SERIES(SchemaVersion schemaVersion) {
	...
	public MOVIE_SERIES(SdDatePublished sdDatePublished) {
	...
	public MOVIE_SERIES(SdLicense sdLicense) {
	...
	public MOVIE_SERIES(SdPublisher sdPublisher) {
	...
	public MOVIE_SERIES(SourceOrganization sourceOrganization) {
	...
	public MOVIE_SERIES(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public MOVIE_SERIES(SpatialCoverage spatialCoverage) {
	...
	public MOVIE_SERIES(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MOVIE_SERIES(StartDate startDate) {
	...
	public MOVIE_SERIES(SubjectOf subjectOf) {
	...
	public MOVIE_SERIES(Temporal temporal) {
	...
	public MOVIE_SERIES(TemporalCoverage temporalCoverage) {
	...
	public MOVIE_SERIES(ThumbnailUrl thumbnailUrl) {
	...
	public MOVIE_SERIES(TimeRequired timeRequired) {
	...
	public MOVIE_SERIES(Trailer trailer) {
		setTrailer(trailer);
	}
	...
	public MOVIE_SERIES(TranslationOfWork translationOfWork) {
	...
	public MOVIE_SERIES(Translator translator) {
	...
	public MOVIE_SERIES(TypicalAgeRange typicalAgeRange) {
	...
	public MOVIE_SERIES(Version version) {
		setVersion(version);
	}
	...
	public MOVIE_SERIES(Video video) {
		setVideo(video);
	}
	...
	public MOVIE_SERIES(WorkExample workExample) {
	...
	public MOVIE_SERIES(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.MovieSeries org) {
		setSeq(org.getSeq());
