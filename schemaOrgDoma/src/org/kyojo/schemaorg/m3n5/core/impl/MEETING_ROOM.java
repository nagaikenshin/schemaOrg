...
public class MEETING_ROOM implements Clazz.MeetingRoom {
	...
	public MEETING_ROOM(GeoContains geoContains) {
	...
	public MEETING_ROOM(GeoCoveredBy geoCoveredBy) {
	...
	public MEETING_ROOM(GeoCovers geoCovers) {
	...
	public MEETING_ROOM(GeoCrosses geoCrosses) {
	...
	public MEETING_ROOM(GeoDisjoint geoDisjoint) {
	...
	public MEETING_ROOM(GeoEquals geoEquals) {
	...
	public MEETING_ROOM(GeoIntersects geoIntersects) {
	...
	public MEETING_ROOM(GeoOverlaps geoOverlaps) {
	...
	public MEETING_ROOM(GeoTouches geoTouches) {
	...
	public MEETING_ROOM(GeoWithin geoWithin) {
	...
	public MEETING_ROOM(Slogan slogan) {
		setSlogan(slogan);
	}
