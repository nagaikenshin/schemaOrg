...
public class ORGANIZATION implements Clazz.Organization {
	...
	public ORGANIZATION(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public ORGANIZATION(AdditionalType additionalType) {
	...
	public ORGANIZATION(AggregateRating aggregateRating) {
	...
	public ORGANIZATION(AlternateName alternateName) {
	...
	public ORGANIZATION(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public ORGANIZATION(AreaServed areaServed) {
	...
	public ORGANIZATION(Award award) {
		setAward(award);
	}
	...
	public ORGANIZATION(Brand brand) {
		setBrand(brand);
	}
	...
	public ORGANIZATION(ContactPoint contactPoint) {
	...
	public ORGANIZATION(CorrectionsPolicy correctionsPolicy) {
	...
	public ORGANIZATION(Description description) {
	...
	public ORGANIZATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public ORGANIZATION(DissolutionDate dissolutionDate) {
	...
	public ORGANIZATION(DiversityPolicy diversityPolicy) {
	...
	public ORGANIZATION(DiversityStaffingReport diversityStaffingReport) {
	...
	public ORGANIZATION(Email email) {
		setEmail(email);
	}
	...
	public ORGANIZATION(EthicsPolicy ethicsPolicy) {
	...
	public ORGANIZATION(Event event) {
		setEvent(event);
	}
	...
	public ORGANIZATION(FaxNumber faxNumber) {
	...
	public ORGANIZATION(Founder founder) {
		setFounder(founder);
	}
	...
	public ORGANIZATION(FoundingDate foundingDate) {
	...
	public ORGANIZATION(FoundingLocation foundingLocation) {
	...
	public ORGANIZATION(Funder funder) {
		setFunder(funder);
	}
	...
	public ORGANIZATION(GlobalLocationNumber globalLocationNumber) {
	...
	public ORGANIZATION(HasOfferCatalog hasOfferCatalog) {
	...
	public ORGANIZATION(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public ORGANIZATION(Image image) {
		setImage(image);
	}
	...
	public ORGANIZATION(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public ORGANIZATION(KnowsAbout knowsAbout) {
	...
	public ORGANIZATION(KnowsLanguage knowsLanguage) {
	...
	public ORGANIZATION(LegalName legalName) {
	...
	public ORGANIZATION(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public ORGANIZATION(Location location) {
	...
	public ORGANIZATION(MainEntityOfPage mainEntityOfPage) {
	...
	public ORGANIZATION(MakesOffer makesOffer) {
	...
	public ORGANIZATION(Member member) {
		setMember(member);
	}
	...
	public ORGANIZATION(MemberOf memberOf) {
	...
	public ORGANIZATION(Naics naics) {
		setNaics(naics);
	}
	...
	public ORGANIZATION(NameFuzzy nameFuzzy) {
	...
	public ORGANIZATION(NameRuby nameRuby) {
	...
	public ORGANIZATION(NumberOfEmployees numberOfEmployees) {
	...
	public ORGANIZATION(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public ORGANIZATION(ParentOrganization parentOrganization) {
	...
	public ORGANIZATION(PotentialAction potentialAction) {
	...
	public ORGANIZATION(PublishingPrinciples publishingPrinciples) {
	...
	public ORGANIZATION(Review review) {
		setReview(review);
	}
	...
	public ORGANIZATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ORGANIZATION(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public ORGANIZATION(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public ORGANIZATION(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public ORGANIZATION(SubOrganization subOrganization) {
	...
	public ORGANIZATION(SubjectOf subjectOf) {
	...
	public ORGANIZATION(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public ORGANIZATION(Telephone telephone) {
	...
	public ORGANIZATION(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public ORGANIZATION(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.Organization org) {
		setSeq(org.getSeq());
