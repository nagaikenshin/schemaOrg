...
public class MUSIC_STORE implements Clazz.MusicStore {
	...
	public MUSIC_STORE(GeoContains geoContains) {
	...
	public MUSIC_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public MUSIC_STORE(GeoCovers geoCovers) {
	...
	public MUSIC_STORE(GeoCrosses geoCrosses) {
	...
	public MUSIC_STORE(GeoDisjoint geoDisjoint) {
	...
	public MUSIC_STORE(GeoEquals geoEquals) {
	...
	public MUSIC_STORE(GeoIntersects geoIntersects) {
	...
	public MUSIC_STORE(GeoOverlaps geoOverlaps) {
	...
	public MUSIC_STORE(GeoTouches geoTouches) {
	...
	public MUSIC_STORE(GeoWithin geoWithin) {
	...
	public MUSIC_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
