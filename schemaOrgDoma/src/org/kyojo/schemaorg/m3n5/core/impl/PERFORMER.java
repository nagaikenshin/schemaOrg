...
public class PERFORMER implements Container.Performer {
	...
	public PERFORMER(String string) {
	...
	public PERFORMER(AccountingService accountingService) {
	...
	public PERFORMER(AdultEntertainment adultEntertainment) {
	...
	public PERFORMER(Airline airline) {
	...
	public PERFORMER(AmusementPark amusementPark) {
	...
	public PERFORMER(AnimalShelter animalShelter) {
	...
	public PERFORMER(ArchiveOrganization archiveOrganization) {
	...
	public PERFORMER(ArtGallery artGallery) {
	...
	public PERFORMER(Attorney attorney) {
	...
	public PERFORMER(AutoBodyShop autoBodyShop) {
	...
	public PERFORMER(AutoDealer autoDealer) {
	...
	public PERFORMER(AutoPartsStore autoPartsStore) {
	...
	public PERFORMER(AutoRental autoRental) {
	...
	public PERFORMER(AutoRepair autoRepair) {
	...
	public PERFORMER(AutoWash autoWash) {
	...
	public PERFORMER(AutomatedTeller automatedTeller) {
	...
	public PERFORMER(AutomotiveBusiness automotiveBusiness) {
	...
	public PERFORMER(Bakery bakery) {
	...
	public PERFORMER(BankOrCreditUnion bankOrCreditUnion) {
	...
	public PERFORMER(BarOrPub barOrPub) {
	...
	public PERFORMER(BeautySalon beautySalon) {
	...
	public PERFORMER(BedAndBreakfast bedAndBreakfast) {
	...
	public PERFORMER(BikeStore bikeStore) {
	...
	public PERFORMER(BookStore bookStore) {
	...
	public PERFORMER(BowlingAlley bowlingAlley) {
	...
	public PERFORMER(Brewery brewery) {
	...
	public PERFORMER(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public PERFORMER(Campground campground) {
	...
	public PERFORMER(Casino casino) {
	...
	public PERFORMER(ChildCare childCare) {
	...
	public PERFORMER(ClothingStore clothingStore) {
	...
	public PERFORMER(CollegeOrUniversity collegeOrUniversity) {
	...
	public PERFORMER(ComedyClub comedyClub) {
	...
	public PERFORMER(CommunityHealth communityHealth) {
	...
	public PERFORMER(ComputerStore computerStore) {
	...
	public PERFORMER(Consortium consortium) {
	...
	public PERFORMER(ConvenienceStore convenienceStore) {
	...
	public PERFORMER(Corporation corporation) {
	...
	public PERFORMER(DanceGroup danceGroup) {
	...
	public PERFORMER(DaySpa daySpa) {
	...
	public PERFORMER(Dentist dentist) {
	...
	public PERFORMER(DepartmentStore departmentStore) {
	...
	public PERFORMER(Dermatology dermatology) {
	...
	public PERFORMER(DiagnosticLab diagnosticLab) {
	...
	public PERFORMER(DietNutrition dietNutrition) {
	...
	public PERFORMER(Distillery distillery) {
	...
	public PERFORMER(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public PERFORMER(EducationalOrganization educationalOrganization) {
	...
	public PERFORMER(Electrician electrician) {
	...
	public PERFORMER(ElectronicsStore electronicsStore) {
	...
	public PERFORMER(ElementarySchool elementarySchool) {
	...
	public PERFORMER(Emergency emergency) {
	...
	public PERFORMER(EmergencyService emergencyService) {
	...
	public PERFORMER(EmploymentAgency employmentAgency) {
	...
	public PERFORMER(EntertainmentBusiness entertainmentBusiness) {
	...
	public PERFORMER(ExerciseGym exerciseGym) {
	...
	public PERFORMER(FastFoodRestaurant fastFoodRestaurant) {
	...
	public PERFORMER(FinancialService financialService) {
	...
	public PERFORMER(FireStation fireStation) {
	...
	public PERFORMER(Florist florist) {
	...
	public PERFORMER(FoodEstablishment foodEstablishment) {
	...
	public PERFORMER(FundingAgency fundingAgency) {
	...
	public PERFORMER(FundingScheme fundingScheme) {
	...
	public PERFORMER(FurnitureStore furnitureStore) {
	...
	public PERFORMER(GardenStore gardenStore) {
	...
	public PERFORMER(GasStation gasStation) {
	...
	public PERFORMER(GeneralContractor generalContractor) {
	...
	public PERFORMER(Geriatric geriatric) {
	...
	public PERFORMER(GolfCourse golfCourse) {
	...
	public PERFORMER(GovernmentOffice governmentOffice) {
	...
	public PERFORMER(GovernmentOrganization governmentOrganization) {
	...
	public PERFORMER(GroceryStore groceryStore) {
	...
	public PERFORMER(Gynecologic gynecologic) {
	...
	public PERFORMER(HVACBusiness hvacBusiness) {
	...
	public PERFORMER(HairSalon hairSalon) {
	...
	public PERFORMER(HardwareStore hardwareStore) {
	...
	public PERFORMER(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public PERFORMER(HealthClub healthClub) {
	...
	public PERFORMER(HighSchool highSchool) {
	...
	public PERFORMER(HobbyShop hobbyShop) {
	...
	public PERFORMER(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public PERFORMER(HomeGoodsStore homeGoodsStore) {
	...
	public PERFORMER(Hospital hospital) {
	...
	public PERFORMER(Hostel hostel) {
	...
	public PERFORMER(HousePainter housePainter) {
	...
	public PERFORMER(IceCreamShop iceCreamShop) {
	...
	public PERFORMER(InsuranceAgency insuranceAgency) {
	...
	public PERFORMER(InternetCafe internetCafe) {
	...
	public PERFORMER(JewelryStore jewelryStore) {
	...
	public PERFORMER(LegalService legalService) {
	...
	public PERFORMER(Library library) {
	...
	public PERFORMER(LibrarySystem librarySystem) {
	...
	public PERFORMER(LiquorStore liquorStore) {
	...
	public PERFORMER(LocalBusiness localBusiness) {
	...
	public PERFORMER(Locksmith locksmith) {
	...
	public PERFORMER(LodgingBusiness lodgingBusiness) {
	...
	public PERFORMER(MedicalBusiness medicalBusiness) {
	...
	public PERFORMER(MedicalClinic medicalClinic) {
	...
	public PERFORMER(MedicalOrganization medicalOrganization) {
	...
	public PERFORMER(MensClothingStore mensClothingStore) {
	...
	public PERFORMER(MiddleSchool middleSchool) {
	...
	public PERFORMER(Midwifery midwifery) {
	...
	public PERFORMER(MobilePhoneStore mobilePhoneStore) {
	...
	public PERFORMER(MotorcycleDealer motorcycleDealer) {
	...
	public PERFORMER(MotorcycleRepair motorcycleRepair) {
	...
	public PERFORMER(MovieRentalStore movieRentalStore) {
	...
	public PERFORMER(MovieTheater movieTheater) {
	...
	public PERFORMER(MovingCompany movingCompany) {
	...
	public PERFORMER(MusicGroup musicGroup) {
	...
	public PERFORMER(MusicStore musicStore) {
	...
	public PERFORMER(NailSalon nailSalon) {
	...
	public PERFORMER(NewsMediaOrganization newsMediaOrganization) {
	...
	public PERFORMER(NightClub nightClub) {
	...
	public PERFORMER(Notary notary) {
	...
	public PERFORMER(Nursing nursing) {
	...
	public PERFORMER(Obstetric obstetric) {
	...
	public PERFORMER(OfficeEquipmentStore officeEquipmentStore) {
	...
	public PERFORMER(Oncologic oncologic) {
	...
	public PERFORMER(Optician optician) {
	...
	public PERFORMER(Optometric optometric) {
	...
	public PERFORMER(Otolaryngologic otolaryngologic) {
	...
	public PERFORMER(OutletStore outletStore) {
	...
	public PERFORMER(Patient patient) {
	...
	public PERFORMER(PawnShop pawnShop) {
	...
	public PERFORMER(Pediatric pediatric) {
	...
	public PERFORMER(PerformingGroup performingGroup) {
	...
	public PERFORMER(PetStore petStore) {
	...
	public PERFORMER(Pharmacy pharmacy) {
	...
	public PERFORMER(Physician physician) {
	...
	public PERFORMER(Physiotherapy physiotherapy) {
	...
	public PERFORMER(PlasticSurgery plasticSurgery) {
	...
	public PERFORMER(Plumber plumber) {
	...
	public PERFORMER(Podiatric podiatric) {
	...
	public PERFORMER(PoliceStation policeStation) {
	...
	public PERFORMER(PostOffice postOffice) {
	...
	public PERFORMER(Preschool preschool) {
	...
	public PERFORMER(PrimaryCare primaryCare) {
	...
	public PERFORMER(ProfessionalService professionalService) {
	...
	public PERFORMER(Project project) {
	...
	public PERFORMER(Psychiatric psychiatric) {
	...
	public PERFORMER(PublicHealth publicHealth) {
	...
	public PERFORMER(PublicSwimmingPool publicSwimmingPool) {
	...
	public PERFORMER(RadioStation radioStation) {
	...
	public PERFORMER(RealEstateAgent realEstateAgent) {
	...
	public PERFORMER(RecyclingCenter recyclingCenter) {
	...
	public PERFORMER(ResearchProject researchProject) {
	...
	public PERFORMER(Resort resort) {
	...
	public PERFORMER(Restaurant restaurant) {
	...
	public PERFORMER(RoofingContractor roofingContractor) {
	...
	public PERFORMER(School school) {
	...
	public PERFORMER(SelfStorage selfStorage) {
	...
	public PERFORMER(ShoeStore shoeStore) {
	...
	public PERFORMER(ShoppingCenter shoppingCenter) {
	...
	public PERFORMER(SkiResort skiResort) {
	...
	public PERFORMER(SportingGoodsStore sportingGoodsStore) {
	...
	public PERFORMER(SportsActivityLocation sportsActivityLocation) {
	...
	public PERFORMER(SportsClub sportsClub) {
	...
	public PERFORMER(SportsOrganization sportsOrganization) {
	...
	public PERFORMER(SportsTeam sportsTeam) {
	...
	public PERFORMER(StadiumOrArena stadiumOrArena) {
	...
	public PERFORMER(TattooParlor tattooParlor) {
	...
	public PERFORMER(TelevisionStation televisionStation) {
	...
	public PERFORMER(TennisComplex tennisComplex) {
	...
	public PERFORMER(TheaterGroup theaterGroup) {
	...
	public PERFORMER(TireShop tireShop) {
	...
	public PERFORMER(TouristInformationCenter touristInformationCenter) {
	...
	public PERFORMER(ToyStore toyStore) {
	...
	public PERFORMER(TravelAgency travelAgency) {
	...
	public PERFORMER(VeterinaryCare veterinaryCare) {
	...
	public PERFORMER(WholesaleStore wholesaleStore) {
	...
	public PERFORMER(Winery winery) {
	...
	public PERFORMER(WorkersUnion workersUnion) {
	...
	public void copy(Container.Performer org) {
