...
public class TECH_ARTICLE implements Clazz.TechArticle {
	...
	public TECH_ARTICLE(Long seq) {
		setSeq(seq);
	}

	public TECH_ARTICLE(String string) {
	...
	public TECH_ARTICLE(About about) {
		setAbout(about);
	}
	...
	public TECH_ARTICLE(AccessMode accessMode) {
	...
	public TECH_ARTICLE(AccessModeSufficient accessModeSufficient) {
	...
	public TECH_ARTICLE(AccessibilityAPI accessibilityAPI) {
	...
	public TECH_ARTICLE(AccessibilityControl accessibilityControl) {
	...
	public TECH_ARTICLE(AccessibilityFeature accessibilityFeature) {
	...
	public TECH_ARTICLE(AccessibilityHazard accessibilityHazard) {
	...
	public TECH_ARTICLE(AccessibilitySummary accessibilitySummary) {
	...
	public TECH_ARTICLE(AccountablePerson accountablePerson) {
	...
	public TECH_ARTICLE(AdditionalType additionalType) {
	...
	public TECH_ARTICLE(AggregateRating aggregateRating) {
	...
	public TECH_ARTICLE(AlternateName alternateName) {
	...
	public TECH_ARTICLE(AlternativeHeadline alternativeHeadline) {
	...
	public TECH_ARTICLE(ArticleBody articleBody) {
	...
	public TECH_ARTICLE(ArticleSection articleSection) {
	...
	public TECH_ARTICLE(AssociatedMedia associatedMedia) {
	...
	public TECH_ARTICLE(Audience audience) {
	...
	public TECH_ARTICLE(Audio audio) {
		setAudio(audio);
	}
	...
	public TECH_ARTICLE(Author author) {
		setAuthor(author);
	}
	...
	public TECH_ARTICLE(Award award) {
		setAward(award);
	}
	...
	public TECH_ARTICLE(Backstory backstory) {
	...
	public TECH_ARTICLE(Character character) {
	...
	public TECH_ARTICLE(Citation citation) {
	...
	public TECH_ARTICLE(Comment comment) {
		setComment(comment);
	}
	...
	public TECH_ARTICLE(CommentCount commentCount) {
	...
	public TECH_ARTICLE(ContentLocation contentLocation) {
	...
	public TECH_ARTICLE(ContentRating contentRating) {
	...
	public TECH_ARTICLE(ContentReferenceTime contentReferenceTime) {
	...
	public TECH_ARTICLE(Contributor contributor) {
	...
	public TECH_ARTICLE(CopyrightHolder copyrightHolder) {
	...
	public TECH_ARTICLE(CopyrightYear copyrightYear) {
	...
	public TECH_ARTICLE(Correction correction) {
	...
	public TECH_ARTICLE(Creator creator) {
		setCreator(creator);
	}
	...
	public TECH_ARTICLE(DateCreated dateCreated) {
	...
	public TECH_ARTICLE(DateModified dateModified) {
	...
	public TECH_ARTICLE(DatePublished datePublished) {
	...
	public TECH_ARTICLE(Dependencies dependencies) {
	...
	public TECH_ARTICLE(Description description) {
	...
	public TECH_ARTICLE(DisambiguatingDescription disambiguatingDescription) {
	...
	public TECH_ARTICLE(DiscussionUrl discussionUrl) {
	...
	public TECH_ARTICLE(Editor editor) {
		setEditor(editor);
	}
	...
	public TECH_ARTICLE(EducationalAlignment educationalAlignment) {
	...
	public TECH_ARTICLE(EducationalUse educationalUse) {
	...
	public TECH_ARTICLE(Encoding encoding) {
	...
	public TECH_ARTICLE(EncodingFormat encodingFormat) {
	...
	public TECH_ARTICLE(ExampleOfWork exampleOfWork) {
	...
	public TECH_ARTICLE(Expires expires) {
		setExpires(expires);
	}
	...
	public TECH_ARTICLE(Funder funder) {
		setFunder(funder);
	}
	...
	public TECH_ARTICLE(Genre genre) {
		setGenre(genre);
	}
	...
	public TECH_ARTICLE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public TECH_ARTICLE(Headline headline) {
	...
	public TECH_ARTICLE(Identifier identifier) {
	...
	public TECH_ARTICLE(Image image) {
		setImage(image);
	}
	...
	public TECH_ARTICLE(InLanguage inLanguage) {
	...
	public TECH_ARTICLE(InteractionStatistic interactionStatistic) {
	...
	public TECH_ARTICLE(InteractivityType interactivityType) {
	...
	public TECH_ARTICLE(IsAccessibleForFree isAccessibleForFree) {
	...
	public TECH_ARTICLE(IsBasedOn isBasedOn) {
	...
	public TECH_ARTICLE(IsFamilyFriendly isFamilyFriendly) {
	...
	public TECH_ARTICLE(IsPartOf isPartOf) {
	...
	public TECH_ARTICLE(Keywords keywords) {
	...
	public TECH_ARTICLE(LearningResourceType learningResourceType) {
	...
	public TECH_ARTICLE(License license) {
		setLicense(license);
	}
	...
	public TECH_ARTICLE(LocationCreated locationCreated) {
	...
	public TECH_ARTICLE(MainEntity mainEntity) {
	...
	public TECH_ARTICLE(MainEntityOfPage mainEntityOfPage) {
	...
	public TECH_ARTICLE(Material material) {
	...
	public TECH_ARTICLE(MaterialExtent materialExtent) {
	...
	public TECH_ARTICLE(Mentions mentions) {
	...
	public TECH_ARTICLE(NameFuzzy nameFuzzy) {
	...
	public TECH_ARTICLE(NameRuby nameRuby) {
	...
	public TECH_ARTICLE(Offers offers) {
		setOffers(offers);
	}
	...
	public TECH_ARTICLE(PageEnd pageEnd) {
		setPageEnd(pageEnd);
	}
	...
	public TECH_ARTICLE(PageStart pageStart) {
	...
	public TECH_ARTICLE(Pagination pagination) {
	...
	public TECH_ARTICLE(Position position) {
	...
	public TECH_ARTICLE(PotentialAction potentialAction) {
	...
	public TECH_ARTICLE(Producer producer) {
	...
	public TECH_ARTICLE(ProficiencyLevel proficiencyLevel) {
	...
	public TECH_ARTICLE(Provider provider) {
	...
	public TECH_ARTICLE(Publication publication) {
	...
	public TECH_ARTICLE(Publisher publisher) {
	...
	public TECH_ARTICLE(PublisherImprint publisherImprint) {
	...
	public TECH_ARTICLE(PublishingPrinciples publishingPrinciples) {
	...
	public TECH_ARTICLE(RecordedAt recordedAt) {
	...
	public TECH_ARTICLE(ReleasedEvent releasedEvent) {
	...
	public TECH_ARTICLE(Review review) {
		setReview(review);
	}
	...
	public TECH_ARTICLE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TECH_ARTICLE(SchemaVersion schemaVersion) {
	...
	public TECH_ARTICLE(SdDatePublished sdDatePublished) {
	...
	public TECH_ARTICLE(SdLicense sdLicense) {
	...
	public TECH_ARTICLE(SdPublisher sdPublisher) {
	...
	public TECH_ARTICLE(SourceOrganization sourceOrganization) {
	...
	public TECH_ARTICLE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public TECH_ARTICLE(SpatialCoverage spatialCoverage) {
	...
	public TECH_ARTICLE(Speakable speakable) {
	...
	public TECH_ARTICLE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public TECH_ARTICLE(SubjectOf subjectOf) {
	...
	public TECH_ARTICLE(Temporal temporal) {
	...
	public TECH_ARTICLE(TemporalCoverage temporalCoverage) {
	...
	public TECH_ARTICLE(ThumbnailUrl thumbnailUrl) {
	...
	public TECH_ARTICLE(TimeRequired timeRequired) {
	...
	public TECH_ARTICLE(TranslationOfWork translationOfWork) {
	...
	public TECH_ARTICLE(Translator translator) {
	...
	public TECH_ARTICLE(TypicalAgeRange typicalAgeRange) {
	...
	public TECH_ARTICLE(Version version) {
		setVersion(version);
	}
	...
	public TECH_ARTICLE(Video video) {
		setVideo(video);
	}
	...
	public TECH_ARTICLE(WordCount wordCount) {
	...
	public TECH_ARTICLE(WorkExample workExample) {
	...
	public TECH_ARTICLE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.TechArticle org) {
		setSeq(org.getSeq());
