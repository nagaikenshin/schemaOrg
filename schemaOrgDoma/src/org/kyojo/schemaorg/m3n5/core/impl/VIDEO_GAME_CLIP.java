...
public class VIDEO_GAME_CLIP implements Clazz.VideoGameClip {
	...
	public VIDEO_GAME_CLIP() {
	}

	public VIDEO_GAME_CLIP(Long seq) {
		setSeq(seq);
	}

	public VIDEO_GAME_CLIP(String string) {
	...
	public VIDEO_GAME_CLIP(About about) {
		setAbout(about);
	}
	...
	public VIDEO_GAME_CLIP(AccessMode accessMode) {
	...
	public VIDEO_GAME_CLIP(AccessModeSufficient accessModeSufficient) {
	...
	public VIDEO_GAME_CLIP(AccessibilityAPI accessibilityAPI) {
	...
	public VIDEO_GAME_CLIP(AccessibilityControl accessibilityControl) {
	...
	public VIDEO_GAME_CLIP(AccessibilityFeature accessibilityFeature) {
	...
	public VIDEO_GAME_CLIP(AccessibilityHazard accessibilityHazard) {
	...
	public VIDEO_GAME_CLIP(AccessibilitySummary accessibilitySummary) {
	...
	public VIDEO_GAME_CLIP(AccountablePerson accountablePerson) {
	...
	public VIDEO_GAME_CLIP(Actor actor) {
		setActor(actor);
	}
	...
	public VIDEO_GAME_CLIP(AdditionalType additionalType) {
	...
	public VIDEO_GAME_CLIP(AggregateRating aggregateRating) {
	...
	public VIDEO_GAME_CLIP(AlternateName alternateName) {
	...
	public VIDEO_GAME_CLIP(AlternativeHeadline alternativeHeadline) {
	...
	public VIDEO_GAME_CLIP(AssociatedMedia associatedMedia) {
	...
	public VIDEO_GAME_CLIP(Audience audience) {
	...
	public VIDEO_GAME_CLIP(Audio audio) {
		setAudio(audio);
	}
	...
	public VIDEO_GAME_CLIP(Author author) {
		setAuthor(author);
	}
	...
	public VIDEO_GAME_CLIP(Award award) {
		setAward(award);
	}
	...
	public VIDEO_GAME_CLIP(Character character) {
	...
	public VIDEO_GAME_CLIP(Citation citation) {
	...
	public VIDEO_GAME_CLIP(ClipNumber clipNumber) {
	...
	public VIDEO_GAME_CLIP(Comment comment) {
		setComment(comment);
	}
	...
	public VIDEO_GAME_CLIP(CommentCount commentCount) {
	...
	public VIDEO_GAME_CLIP(ContentLocation contentLocation) {
	...
	public VIDEO_GAME_CLIP(ContentRating contentRating) {
	...
	public VIDEO_GAME_CLIP(ContentReferenceTime contentReferenceTime) {
	...
	public VIDEO_GAME_CLIP(Contributor contributor) {
	...
	public VIDEO_GAME_CLIP(CopyrightHolder copyrightHolder) {
	...
	public VIDEO_GAME_CLIP(CopyrightYear copyrightYear) {
	...
	public VIDEO_GAME_CLIP(Correction correction) {
	...
	public VIDEO_GAME_CLIP(Creator creator) {
		setCreator(creator);
	}
	...
	public VIDEO_GAME_CLIP(DateCreated dateCreated) {
	...
	public VIDEO_GAME_CLIP(DateModified dateModified) {
	...
	public VIDEO_GAME_CLIP(DatePublished datePublished) {
	...
	public VIDEO_GAME_CLIP(Description description) {
	...
	public VIDEO_GAME_CLIP(Director director) {
	...
	public VIDEO_GAME_CLIP(DisambiguatingDescription disambiguatingDescription) {
	...
	public VIDEO_GAME_CLIP(DiscussionUrl discussionUrl) {
	...
	public VIDEO_GAME_CLIP(Editor editor) {
		setEditor(editor);
	}
	...
	public VIDEO_GAME_CLIP(EducationalAlignment educationalAlignment) {
	...
	public VIDEO_GAME_CLIP(EducationalUse educationalUse) {
	...
	public VIDEO_GAME_CLIP(Encoding encoding) {
	...
	public VIDEO_GAME_CLIP(EncodingFormat encodingFormat) {
	...
	public VIDEO_GAME_CLIP(EndOffset endOffset) {
	...
	public VIDEO_GAME_CLIP(ExampleOfWork exampleOfWork) {
	...
	public VIDEO_GAME_CLIP(Expires expires) {
		setExpires(expires);
	}
	...
	public VIDEO_GAME_CLIP(Funder funder) {
		setFunder(funder);
	}
	...
	public VIDEO_GAME_CLIP(Genre genre) {
		setGenre(genre);
	}
	...
	public VIDEO_GAME_CLIP(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public VIDEO_GAME_CLIP(Headline headline) {
	...
	public VIDEO_GAME_CLIP(Identifier identifier) {
	...
	public VIDEO_GAME_CLIP(Image image) {
		setImage(image);
	}
	...
	public VIDEO_GAME_CLIP(InLanguage inLanguage) {
	...
	public VIDEO_GAME_CLIP(InteractionStatistic interactionStatistic) {
	...
	public VIDEO_GAME_CLIP(InteractivityType interactivityType) {
	...
	public VIDEO_GAME_CLIP(IsAccessibleForFree isAccessibleForFree) {
	...
	public VIDEO_GAME_CLIP(IsBasedOn isBasedOn) {
	...
	public VIDEO_GAME_CLIP(IsFamilyFriendly isFamilyFriendly) {
	...
	public VIDEO_GAME_CLIP(IsPartOf isPartOf) {
	...
	public VIDEO_GAME_CLIP(Keywords keywords) {
	...
	public VIDEO_GAME_CLIP(LearningResourceType learningResourceType) {
	...
	public VIDEO_GAME_CLIP(License license) {
		setLicense(license);
	}
	...
	public VIDEO_GAME_CLIP(LocationCreated locationCreated) {
	...
	public VIDEO_GAME_CLIP(MainEntity mainEntity) {
	...
	public VIDEO_GAME_CLIP(MainEntityOfPage mainEntityOfPage) {
	...
	public VIDEO_GAME_CLIP(Material material) {
	...
	public VIDEO_GAME_CLIP(MaterialExtent materialExtent) {
	...
	public VIDEO_GAME_CLIP(Mentions mentions) {
	...
	public VIDEO_GAME_CLIP(MusicBy musicBy) {
		setMusicBy(musicBy);
	}
	...
	public VIDEO_GAME_CLIP(Name name) {
		setName(name);
	}
	...
	public VIDEO_GAME_CLIP(NameFuzzy nameFuzzy) {
	...
	public VIDEO_GAME_CLIP(NameRuby nameRuby) {
	...
	public VIDEO_GAME_CLIP(Offers offers) {
		setOffers(offers);
	}
	...
	public VIDEO_GAME_CLIP(PartOfEpisode partOfEpisode) {
	...
	public VIDEO_GAME_CLIP(PartOfSeason partOfSeason) {
	...
	public VIDEO_GAME_CLIP(PartOfSeries partOfSeries) {
	...
	public VIDEO_GAME_CLIP(Position position) {
	...
	public VIDEO_GAME_CLIP(PotentialAction potentialAction) {
	...
	public VIDEO_GAME_CLIP(Producer producer) {
	...
	public VIDEO_GAME_CLIP(Provider provider) {
	...
	public VIDEO_GAME_CLIP(Publication publication) {
	...
	public VIDEO_GAME_CLIP(Publisher publisher) {
	...
	public VIDEO_GAME_CLIP(PublisherImprint publisherImprint) {
	...
	public VIDEO_GAME_CLIP(PublishingPrinciples publishingPrinciples) {
	...
	public VIDEO_GAME_CLIP(RecordedAt recordedAt) {
	...
	public VIDEO_GAME_CLIP(ReleasedEvent releasedEvent) {
	...
	public VIDEO_GAME_CLIP(Review review) {
		setReview(review);
	}
	...
	public VIDEO_GAME_CLIP(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public VIDEO_GAME_CLIP(SchemaVersion schemaVersion) {
	...
	public VIDEO_GAME_CLIP(SdDatePublished sdDatePublished) {
	...
	public VIDEO_GAME_CLIP(SdLicense sdLicense) {
	...
	public VIDEO_GAME_CLIP(SdPublisher sdPublisher) {
	...
	public VIDEO_GAME_CLIP(SourceOrganization sourceOrganization) {
	...
	public VIDEO_GAME_CLIP(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public VIDEO_GAME_CLIP(SpatialCoverage spatialCoverage) {
	...
	public VIDEO_GAME_CLIP(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public VIDEO_GAME_CLIP(StartOffset startOffset) {
	...
	public VIDEO_GAME_CLIP(SubjectOf subjectOf) {
	...
	public VIDEO_GAME_CLIP(Temporal temporal) {
	...
	public VIDEO_GAME_CLIP(TemporalCoverage temporalCoverage) {
	...
	public VIDEO_GAME_CLIP(Text text) {
		setText(text);
	}
	...
	public VIDEO_GAME_CLIP(ThumbnailUrl thumbnailUrl) {
	...
	public VIDEO_GAME_CLIP(TimeRequired timeRequired) {
	...
	public VIDEO_GAME_CLIP(TranslationOfWork translationOfWork) {
	...
	public VIDEO_GAME_CLIP(Translator translator) {
	...
	public VIDEO_GAME_CLIP(TypicalAgeRange typicalAgeRange) {
	...
	public VIDEO_GAME_CLIP(Url url) {
		setUrl(url);
	}
	...
	public VIDEO_GAME_CLIP(Version version) {
		setVersion(version);
	}
	...
	public VIDEO_GAME_CLIP(Video video) {
		setVideo(video);
	}
	...
	public VIDEO_GAME_CLIP(WorkExample workExample) {
	...
	public VIDEO_GAME_CLIP(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.VideoGameClip org) {
		setSeq(org.getSeq());
