...
public class TIP_ACTION implements Clazz.TipAction {
	...
	public TIP_ACTION(Long seq) {
		setSeq(seq);
	}

	public TIP_ACTION(String string) {
	...
	public TIP_ACTION(ActionStatus actionStatus) {
	...
	public TIP_ACTION(AdditionalType additionalType) {
	...
	public TIP_ACTION(AlternateName alternateName) {
	...
	public TIP_ACTION(Description description) {
	...
	public TIP_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public TIP_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public TIP_ACTION(Identifier identifier) {
	...
	public TIP_ACTION(Instrument instrument) {
	...
	public TIP_ACTION(Location location) {
	...
	public TIP_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public TIP_ACTION(NameFuzzy nameFuzzy) {
	...
	public TIP_ACTION(NameRuby nameRuby) {
	...
	public TIP_ACTION(Object object) {
		setObject(object);
	}
	...
	public TIP_ACTION(Participant participant) {
	...
	public TIP_ACTION(PotentialAction potentialAction) {
	...
	public TIP_ACTION(PriceCurrency priceCurrency) {
	...
	public TIP_ACTION(PriceSpecification priceSpecification) {
	...
	public TIP_ACTION(Recipient recipient) {
	...
	public TIP_ACTION(Result result) {
		setResult(result);
	}
	...
	public TIP_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TIP_ACTION(StartTime startTime) {
	...
	public TIP_ACTION(SubjectOf subjectOf) {
	...
	public TIP_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.TipAction org) {
		setSeq(org.getSeq());
