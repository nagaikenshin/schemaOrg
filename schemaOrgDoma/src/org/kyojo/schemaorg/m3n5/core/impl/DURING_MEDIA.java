...
public class DURING_MEDIA implements Container.DuringMedia {
	...
	public DURING_MEDIA(AudioObject audioObject) {
	...
	public DURING_MEDIA(Audiobook audiobook) {
	...
	public DURING_MEDIA(Barcode barcode) {
	...
	public DURING_MEDIA(DataDownload dataDownload) {
	...
	public DURING_MEDIA(ImageObject imageObject) {
	...
	public DURING_MEDIA(LegislationObject legislationObject) {
	...
	public DURING_MEDIA(MusicVideoObject musicVideoObject) {
	...
	public DURING_MEDIA(VideoObject videoObject) {
	...
	public DURING_MEDIA(List<AudioObject> audioObjectList,
