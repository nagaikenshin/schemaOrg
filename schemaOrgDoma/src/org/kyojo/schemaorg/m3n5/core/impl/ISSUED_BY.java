...
public class ISSUED_BY implements Container.IssuedBy {
	...
	public ISSUED_BY(String string) {
	...
	public ISSUED_BY(AccountingService accountingService) {
	...
	public ISSUED_BY(AdultEntertainment adultEntertainment) {
	...
	public ISSUED_BY(Airline airline) {
	...
	public ISSUED_BY(AmusementPark amusementPark) {
	...
	public ISSUED_BY(AnimalShelter animalShelter) {
	...
	public ISSUED_BY(ArchiveOrganization archiveOrganization) {
	...
	public ISSUED_BY(ArtGallery artGallery) {
	...
	public ISSUED_BY(Attorney attorney) {
	...
	public ISSUED_BY(AutoBodyShop autoBodyShop) {
	...
	public ISSUED_BY(AutoDealer autoDealer) {
	...
	public ISSUED_BY(AutoPartsStore autoPartsStore) {
	...
	public ISSUED_BY(AutoRental autoRental) {
	...
	public ISSUED_BY(AutoRepair autoRepair) {
	...
	public ISSUED_BY(AutoWash autoWash) {
	...
	public ISSUED_BY(AutomatedTeller automatedTeller) {
	...
	public ISSUED_BY(AutomotiveBusiness automotiveBusiness) {
	...
	public ISSUED_BY(Bakery bakery) {
	...
	public ISSUED_BY(BankOrCreditUnion bankOrCreditUnion) {
	...
	public ISSUED_BY(BarOrPub barOrPub) {
	...
	public ISSUED_BY(BeautySalon beautySalon) {
	...
	public ISSUED_BY(BedAndBreakfast bedAndBreakfast) {
	...
	public ISSUED_BY(BikeStore bikeStore) {
	...
	public ISSUED_BY(BookStore bookStore) {
	...
	public ISSUED_BY(BowlingAlley bowlingAlley) {
	...
	public ISSUED_BY(Brewery brewery) {
	...
	public ISSUED_BY(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public ISSUED_BY(Campground campground) {
	...
	public ISSUED_BY(Casino casino) {
	...
	public ISSUED_BY(ChildCare childCare) {
	...
	public ISSUED_BY(ClothingStore clothingStore) {
	...
	public ISSUED_BY(CollegeOrUniversity collegeOrUniversity) {
	...
	public ISSUED_BY(ComedyClub comedyClub) {
	...
	public ISSUED_BY(CommunityHealth communityHealth) {
	...
	public ISSUED_BY(ComputerStore computerStore) {
	...
	public ISSUED_BY(Consortium consortium) {
	...
	public ISSUED_BY(ConvenienceStore convenienceStore) {
	...
	public ISSUED_BY(Corporation corporation) {
	...
	public ISSUED_BY(DanceGroup danceGroup) {
	...
	public ISSUED_BY(DaySpa daySpa) {
	...
	public ISSUED_BY(Dentist dentist) {
	...
	public ISSUED_BY(DepartmentStore departmentStore) {
	...
	public ISSUED_BY(Dermatology dermatology) {
	...
	public ISSUED_BY(DiagnosticLab diagnosticLab) {
	...
	public ISSUED_BY(DietNutrition dietNutrition) {
	...
	public ISSUED_BY(Distillery distillery) {
	...
	public ISSUED_BY(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public ISSUED_BY(EducationalOrganization educationalOrganization) {
	...
	public ISSUED_BY(Electrician electrician) {
	...
	public ISSUED_BY(ElectronicsStore electronicsStore) {
	...
	public ISSUED_BY(ElementarySchool elementarySchool) {
	...
	public ISSUED_BY(Emergency emergency) {
	...
	public ISSUED_BY(EmergencyService emergencyService) {
	...
	public ISSUED_BY(EmploymentAgency employmentAgency) {
	...
	public ISSUED_BY(EntertainmentBusiness entertainmentBusiness) {
	...
	public ISSUED_BY(ExerciseGym exerciseGym) {
	...
	public ISSUED_BY(FastFoodRestaurant fastFoodRestaurant) {
	...
	public ISSUED_BY(FinancialService financialService) {
	...
	public ISSUED_BY(FireStation fireStation) {
	...
	public ISSUED_BY(Florist florist) {
	...
	public ISSUED_BY(FoodEstablishment foodEstablishment) {
	...
	public ISSUED_BY(FundingAgency fundingAgency) {
	...
	public ISSUED_BY(FundingScheme fundingScheme) {
	...
	public ISSUED_BY(FurnitureStore furnitureStore) {
	...
	public ISSUED_BY(GardenStore gardenStore) {
	...
	public ISSUED_BY(GasStation gasStation) {
	...
	public ISSUED_BY(GeneralContractor generalContractor) {
	...
	public ISSUED_BY(Geriatric geriatric) {
	...
	public ISSUED_BY(GolfCourse golfCourse) {
	...
	public ISSUED_BY(GovernmentOffice governmentOffice) {
	...
	public ISSUED_BY(GovernmentOrganization governmentOrganization) {
	...
	public ISSUED_BY(GroceryStore groceryStore) {
	...
	public ISSUED_BY(Gynecologic gynecologic) {
	...
	public ISSUED_BY(HVACBusiness hvacBusiness) {
	...
	public ISSUED_BY(HairSalon hairSalon) {
	...
	public ISSUED_BY(HardwareStore hardwareStore) {
	...
	public ISSUED_BY(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public ISSUED_BY(HealthClub healthClub) {
	...
	public ISSUED_BY(HighSchool highSchool) {
	...
	public ISSUED_BY(HobbyShop hobbyShop) {
	...
	public ISSUED_BY(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public ISSUED_BY(HomeGoodsStore homeGoodsStore) {
	...
	public ISSUED_BY(Hospital hospital) {
	...
	public ISSUED_BY(Hostel hostel) {
	...
	public ISSUED_BY(HousePainter housePainter) {
	...
	public ISSUED_BY(IceCreamShop iceCreamShop) {
	...
	public ISSUED_BY(InsuranceAgency insuranceAgency) {
	...
	public ISSUED_BY(InternetCafe internetCafe) {
	...
	public ISSUED_BY(JewelryStore jewelryStore) {
	...
	public ISSUED_BY(LegalService legalService) {
	...
	public ISSUED_BY(Library library) {
	...
	public ISSUED_BY(LibrarySystem librarySystem) {
	...
	public ISSUED_BY(LiquorStore liquorStore) {
	...
	public ISSUED_BY(LocalBusiness localBusiness) {
	...
	public ISSUED_BY(Locksmith locksmith) {
	...
	public ISSUED_BY(LodgingBusiness lodgingBusiness) {
	...
	public ISSUED_BY(MedicalBusiness medicalBusiness) {
	...
	public ISSUED_BY(MedicalClinic medicalClinic) {
	...
	public ISSUED_BY(MedicalOrganization medicalOrganization) {
	...
	public ISSUED_BY(MensClothingStore mensClothingStore) {
	...
	public ISSUED_BY(MiddleSchool middleSchool) {
	...
	public ISSUED_BY(Midwifery midwifery) {
	...
	public ISSUED_BY(MobilePhoneStore mobilePhoneStore) {
	...
	public ISSUED_BY(MotorcycleDealer motorcycleDealer) {
	...
	public ISSUED_BY(MotorcycleRepair motorcycleRepair) {
	...
	public ISSUED_BY(MovieRentalStore movieRentalStore) {
	...
	public ISSUED_BY(MovieTheater movieTheater) {
	...
	public ISSUED_BY(MovingCompany movingCompany) {
	...
	public ISSUED_BY(MusicGroup musicGroup) {
	...
	public ISSUED_BY(MusicStore musicStore) {
	...
	public ISSUED_BY(NailSalon nailSalon) {
	...
	public ISSUED_BY(NewsMediaOrganization newsMediaOrganization) {
	...
	public ISSUED_BY(NightClub nightClub) {
	...
	public ISSUED_BY(Notary notary) {
	...
	public ISSUED_BY(Nursing nursing) {
	...
	public ISSUED_BY(Obstetric obstetric) {
	...
	public ISSUED_BY(OfficeEquipmentStore officeEquipmentStore) {
	...
	public ISSUED_BY(Oncologic oncologic) {
	...
	public ISSUED_BY(Optician optician) {
	...
	public ISSUED_BY(Optometric optometric) {
	...
	public ISSUED_BY(Organization organization) {
		organizationList = new ArrayList<Organization>();
	...
	public ISSUED_BY(Otolaryngologic otolaryngologic) {
	...
	public ISSUED_BY(OutletStore outletStore) {
	...
	public ISSUED_BY(PawnShop pawnShop) {
	...
	public ISSUED_BY(Pediatric pediatric) {
	...
	public ISSUED_BY(PerformingGroup performingGroup) {
	...
	public ISSUED_BY(PetStore petStore) {
	...
	public ISSUED_BY(Pharmacy pharmacy) {
	...
	public ISSUED_BY(Physician physician) {
	...
	public ISSUED_BY(Physiotherapy physiotherapy) {
	...
	public ISSUED_BY(PlasticSurgery plasticSurgery) {
	...
	public ISSUED_BY(Plumber plumber) {
	...
	public ISSUED_BY(Podiatric podiatric) {
	...
	public ISSUED_BY(PoliceStation policeStation) {
	...
	public ISSUED_BY(PostOffice postOffice) {
	...
	public ISSUED_BY(Preschool preschool) {
	...
	public ISSUED_BY(PrimaryCare primaryCare) {
	...
	public ISSUED_BY(ProfessionalService professionalService) {
	...
	public ISSUED_BY(Project project) {
	...
	public ISSUED_BY(Psychiatric psychiatric) {
	...
	public ISSUED_BY(PublicHealth publicHealth) {
	...
	public ISSUED_BY(PublicSwimmingPool publicSwimmingPool) {
	...
	public ISSUED_BY(RadioStation radioStation) {
	...
	public ISSUED_BY(RealEstateAgent realEstateAgent) {
	...
	public ISSUED_BY(RecyclingCenter recyclingCenter) {
	...
	public ISSUED_BY(ResearchProject researchProject) {
	...
	public ISSUED_BY(Resort resort) {
	...
	public ISSUED_BY(Restaurant restaurant) {
	...
	public ISSUED_BY(RoofingContractor roofingContractor) {
	...
	public ISSUED_BY(School school) {
	...
	public ISSUED_BY(SelfStorage selfStorage) {
	...
	public ISSUED_BY(ShoeStore shoeStore) {
	...
	public ISSUED_BY(ShoppingCenter shoppingCenter) {
	...
	public ISSUED_BY(SkiResort skiResort) {
	...
	public ISSUED_BY(SportingGoodsStore sportingGoodsStore) {
	...
	public ISSUED_BY(SportsActivityLocation sportsActivityLocation) {
	...
	public ISSUED_BY(SportsClub sportsClub) {
	...
	public ISSUED_BY(SportsOrganization sportsOrganization) {
	...
	public ISSUED_BY(SportsTeam sportsTeam) {
	...
	public ISSUED_BY(StadiumOrArena stadiumOrArena) {
	...
	public ISSUED_BY(TattooParlor tattooParlor) {
	...
	public ISSUED_BY(TelevisionStation televisionStation) {
	...
	public ISSUED_BY(TennisComplex tennisComplex) {
	...
	public ISSUED_BY(TheaterGroup theaterGroup) {
	...
	public ISSUED_BY(TireShop tireShop) {
	...
	public ISSUED_BY(TouristInformationCenter touristInformationCenter) {
	...
	public ISSUED_BY(ToyStore toyStore) {
	...
	public ISSUED_BY(TravelAgency travelAgency) {
	...
	public ISSUED_BY(VeterinaryCare veterinaryCare) {
	...
	public ISSUED_BY(WholesaleStore wholesaleStore) {
	...
	public ISSUED_BY(Winery winery) {
	...
	public ISSUED_BY(WorkersUnion workersUnion) {
	...
	public void copy(Container.IssuedBy org) {
