...
public class CREMATORIUM implements Clazz.Crematorium {
	...
	public CREMATORIUM(GeoContains geoContains) {
	...
	public CREMATORIUM(GeoCoveredBy geoCoveredBy) {
	...
	public CREMATORIUM(GeoCovers geoCovers) {
	...
	public CREMATORIUM(GeoCrosses geoCrosses) {
	...
	public CREMATORIUM(GeoDisjoint geoDisjoint) {
	...
	public CREMATORIUM(GeoEquals geoEquals) {
	...
	public CREMATORIUM(GeoIntersects geoIntersects) {
	...
	public CREMATORIUM(GeoOverlaps geoOverlaps) {
	...
	public CREMATORIUM(GeoTouches geoTouches) {
	...
	public CREMATORIUM(GeoWithin geoWithin) {
	...
	public CREMATORIUM(Slogan slogan) {
		setSlogan(slogan);
	}
