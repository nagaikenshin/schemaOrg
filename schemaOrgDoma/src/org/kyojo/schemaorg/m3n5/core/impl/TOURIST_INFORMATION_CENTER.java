...
public class TOURIST_INFORMATION_CENTER implements Clazz.TouristInformationCenter {
	...
	public TOURIST_INFORMATION_CENTER(GeoContains geoContains) {
	...
	public TOURIST_INFORMATION_CENTER(GeoCoveredBy geoCoveredBy) {
	...
	public TOURIST_INFORMATION_CENTER(GeoCovers geoCovers) {
	...
	public TOURIST_INFORMATION_CENTER(GeoCrosses geoCrosses) {
	...
	public TOURIST_INFORMATION_CENTER(GeoDisjoint geoDisjoint) {
	...
	public TOURIST_INFORMATION_CENTER(GeoEquals geoEquals) {
	...
	public TOURIST_INFORMATION_CENTER(GeoIntersects geoIntersects) {
	...
	public TOURIST_INFORMATION_CENTER(GeoOverlaps geoOverlaps) {
	...
	public TOURIST_INFORMATION_CENTER(GeoTouches geoTouches) {
	...
	public TOURIST_INFORMATION_CENTER(GeoWithin geoWithin) {
	...
	public TOURIST_INFORMATION_CENTER(Slogan slogan) {
		setSlogan(slogan);
	}
