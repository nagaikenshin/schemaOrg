...
public class RADIO_SEASON implements Clazz.RadioSeason {
	...
	public RADIO_SEASON(Long seq) {
		setSeq(seq);
	}

	public RADIO_SEASON(String string) {
	...
	public RADIO_SEASON(About about) {
		setAbout(about);
	}
	...
	public RADIO_SEASON(AccessMode accessMode) {
	...
	public RADIO_SEASON(AccessModeSufficient accessModeSufficient) {
	...
	public RADIO_SEASON(AccessibilityAPI accessibilityAPI) {
	...
	public RADIO_SEASON(AccessibilityControl accessibilityControl) {
	...
	public RADIO_SEASON(AccessibilityFeature accessibilityFeature) {
	...
	public RADIO_SEASON(AccessibilityHazard accessibilityHazard) {
	...
	public RADIO_SEASON(AccessibilitySummary accessibilitySummary) {
	...
	public RADIO_SEASON(AccountablePerson accountablePerson) {
	...
	public RADIO_SEASON(Actor actor) {
		setActor(actor);
	}
	...
	public RADIO_SEASON(AdditionalType additionalType) {
	...
	public RADIO_SEASON(AggregateRating aggregateRating) {
	...
	public RADIO_SEASON(AlternateName alternateName) {
	...
	public RADIO_SEASON(AlternativeHeadline alternativeHeadline) {
	...
	public RADIO_SEASON(AssociatedMedia associatedMedia) {
	...
	public RADIO_SEASON(Audience audience) {
	...
	public RADIO_SEASON(Audio audio) {
		setAudio(audio);
	}
	...
	public RADIO_SEASON(Author author) {
		setAuthor(author);
	}
	...
	public RADIO_SEASON(Award award) {
		setAward(award);
	}
	...
	public RADIO_SEASON(Character character) {
	...
	public RADIO_SEASON(Citation citation) {
	...
	public RADIO_SEASON(Comment comment) {
		setComment(comment);
	}
	...
	public RADIO_SEASON(CommentCount commentCount) {
	...
	public RADIO_SEASON(ContentLocation contentLocation) {
	...
	public RADIO_SEASON(ContentRating contentRating) {
	...
	public RADIO_SEASON(ContentReferenceTime contentReferenceTime) {
	...
	public RADIO_SEASON(Contributor contributor) {
	...
	public RADIO_SEASON(CopyrightHolder copyrightHolder) {
	...
	public RADIO_SEASON(CopyrightYear copyrightYear) {
	...
	public RADIO_SEASON(Correction correction) {
	...
	public RADIO_SEASON(Creator creator) {
		setCreator(creator);
	}
	...
	public RADIO_SEASON(DateCreated dateCreated) {
	...
	public RADIO_SEASON(DateModified dateModified) {
	...
	public RADIO_SEASON(DatePublished datePublished) {
	...
	public RADIO_SEASON(Description description) {
	...
	public RADIO_SEASON(Director director) {
	...
	public RADIO_SEASON(DisambiguatingDescription disambiguatingDescription) {
	...
	public RADIO_SEASON(DiscussionUrl discussionUrl) {
	...
	public RADIO_SEASON(Editor editor) {
		setEditor(editor);
	}
	...
	public RADIO_SEASON(EducationalAlignment educationalAlignment) {
	...
	public RADIO_SEASON(EducationalUse educationalUse) {
	...
	public RADIO_SEASON(Encoding encoding) {
	...
	public RADIO_SEASON(EncodingFormat encodingFormat) {
	...
	public RADIO_SEASON(EndDate endDate) {
		setEndDate(endDate);
	}
	...
	public RADIO_SEASON(Episode episode) {
		setEpisode(episode);
	}
	...
	public RADIO_SEASON(ExampleOfWork exampleOfWork) {
	...
	public RADIO_SEASON(Expires expires) {
		setExpires(expires);
	}
	...
	public RADIO_SEASON(Funder funder) {
		setFunder(funder);
	}
	...
	public RADIO_SEASON(Genre genre) {
		setGenre(genre);
	}
	...
	public RADIO_SEASON(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public RADIO_SEASON(Headline headline) {
	...
	public RADIO_SEASON(Identifier identifier) {
	...
	public RADIO_SEASON(Image image) {
		setImage(image);
	}
	...
	public RADIO_SEASON(InLanguage inLanguage) {
	...
	public RADIO_SEASON(InteractionStatistic interactionStatistic) {
	...
	public RADIO_SEASON(InteractivityType interactivityType) {
	...
	public RADIO_SEASON(IsAccessibleForFree isAccessibleForFree) {
	...
	public RADIO_SEASON(IsBasedOn isBasedOn) {
	...
	public RADIO_SEASON(IsFamilyFriendly isFamilyFriendly) {
	...
	public RADIO_SEASON(IsPartOf isPartOf) {
	...
	public RADIO_SEASON(Keywords keywords) {
	...
	public RADIO_SEASON(LearningResourceType learningResourceType) {
	...
	public RADIO_SEASON(License license) {
		setLicense(license);
	}
	...
	public RADIO_SEASON(LocationCreated locationCreated) {
	...
	public RADIO_SEASON(MainEntity mainEntity) {
	...
	public RADIO_SEASON(MainEntityOfPage mainEntityOfPage) {
	...
	public RADIO_SEASON(Material material) {
	...
	public RADIO_SEASON(MaterialExtent materialExtent) {
	...
	public RADIO_SEASON(Mentions mentions) {
	...
	public RADIO_SEASON(NameFuzzy nameFuzzy) {
	...
	public RADIO_SEASON(NameRuby nameRuby) {
	...
	public RADIO_SEASON(NumberOfEpisodes numberOfEpisodes) {
	...
	public RADIO_SEASON(Offers offers) {
		setOffers(offers);
	}
	...
	public RADIO_SEASON(PartOfSeries partOfSeries) {
	...
	public RADIO_SEASON(Position position) {
	...
	public RADIO_SEASON(PotentialAction potentialAction) {
	...
	public RADIO_SEASON(Producer producer) {
	...
	public RADIO_SEASON(ProductionCompany productionCompany) {
	...
	public RADIO_SEASON(Provider provider) {
	...
	public RADIO_SEASON(Publication publication) {
	...
	public RADIO_SEASON(Publisher publisher) {
	...
	public RADIO_SEASON(PublisherImprint publisherImprint) {
	...
	public RADIO_SEASON(PublishingPrinciples publishingPrinciples) {
	...
	public RADIO_SEASON(RecordedAt recordedAt) {
	...
	public RADIO_SEASON(ReleasedEvent releasedEvent) {
	...
	public RADIO_SEASON(Review review) {
		setReview(review);
	}
	...
	public RADIO_SEASON(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RADIO_SEASON(SchemaVersion schemaVersion) {
	...
	public RADIO_SEASON(SdDatePublished sdDatePublished) {
	...
	public RADIO_SEASON(SdLicense sdLicense) {
	...
	public RADIO_SEASON(SdPublisher sdPublisher) {
	...
	public RADIO_SEASON(SeasonNumber seasonNumber) {
	...
	public RADIO_SEASON(SourceOrganization sourceOrganization) {
	...
	public RADIO_SEASON(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public RADIO_SEASON(SpatialCoverage spatialCoverage) {
	...
	public RADIO_SEASON(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public RADIO_SEASON(StartDate startDate) {
	...
	public RADIO_SEASON(SubjectOf subjectOf) {
	...
	public RADIO_SEASON(Temporal temporal) {
	...
	public RADIO_SEASON(TemporalCoverage temporalCoverage) {
	...
	public RADIO_SEASON(ThumbnailUrl thumbnailUrl) {
	...
	public RADIO_SEASON(TimeRequired timeRequired) {
	...
	public RADIO_SEASON(Trailer trailer) {
		setTrailer(trailer);
	}
	...
	public RADIO_SEASON(TranslationOfWork translationOfWork) {
	...
	public RADIO_SEASON(Translator translator) {
	...
	public RADIO_SEASON(TypicalAgeRange typicalAgeRange) {
	...
	public RADIO_SEASON(Version version) {
		setVersion(version);
	}
	...
	public RADIO_SEASON(Video video) {
		setVideo(video);
	}
	...
	public RADIO_SEASON(WorkExample workExample) {
	...
	public RADIO_SEASON(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.RadioSeason org) {
		setSeq(org.getSeq());
