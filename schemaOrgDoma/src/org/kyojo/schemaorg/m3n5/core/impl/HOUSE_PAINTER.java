...
public class HOUSE_PAINTER implements Clazz.HousePainter {
	...
	public HOUSE_PAINTER(GeoContains geoContains) {
	...
	public HOUSE_PAINTER(GeoCoveredBy geoCoveredBy) {
	...
	public HOUSE_PAINTER(GeoCovers geoCovers) {
	...
	public HOUSE_PAINTER(GeoCrosses geoCrosses) {
	...
	public HOUSE_PAINTER(GeoDisjoint geoDisjoint) {
	...
	public HOUSE_PAINTER(GeoEquals geoEquals) {
	...
	public HOUSE_PAINTER(GeoIntersects geoIntersects) {
	...
	public HOUSE_PAINTER(GeoOverlaps geoOverlaps) {
	...
	public HOUSE_PAINTER(GeoTouches geoTouches) {
	...
	public HOUSE_PAINTER(GeoWithin geoWithin) {
	...
	public HOUSE_PAINTER(Slogan slogan) {
		setSlogan(slogan);
	}
