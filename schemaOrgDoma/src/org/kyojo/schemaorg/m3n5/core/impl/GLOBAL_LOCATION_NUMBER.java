...
public class GLOBAL_LOCATION_NUMBER implements Container.GlobalLocationNumber {
	...
	public GLOBAL_LOCATION_NUMBER(LocationFeatureSpecification locationFeatureSpecification) {
	...
	public GLOBAL_LOCATION_NUMBER(PropertyValue propertyValue) {
	...
	public GLOBAL_LOCATION_NUMBER(String string) {
		this(new TEXT(string));
	}

	public GLOBAL_LOCATION_NUMBER(Text text) {
	...
	public GLOBAL_LOCATION_NUMBER(URL url) {
	...
	public GLOBAL_LOCATION_NUMBER(List<LocationFeatureSpecification> locationFeatureSpecificationList,
	...
	public void copy(Container.GlobalLocationNumber org) {
