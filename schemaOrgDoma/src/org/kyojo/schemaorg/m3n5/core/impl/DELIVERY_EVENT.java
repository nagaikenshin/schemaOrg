...
import org.kyojo.schemaorg.m3n5.core.Container.AvailableFrom;
...
import org.kyojo.schemaorg.m3n5.core.Container.HasDeliveryMethod;
...
public class DELIVERY_EVENT implements Clazz.DeliveryEvent {
	...
	public AvailableThrough availableThrough;
	...
	public DELIVERY_EVENT(Long seq) {
		setSeq(seq);
	}

	public DELIVERY_EVENT(String string) {
	...
	public DELIVERY_EVENT(About about) {
		setAbout(about);
	}
	...
	public DELIVERY_EVENT(AccessCode accessCode) {
	...
	public DELIVERY_EVENT(Actor actor) {
		setActor(actor);
	}
	...
	public DELIVERY_EVENT(AdditionalType additionalType) {
	...
	public DELIVERY_EVENT(AggregateRating aggregateRating) {
	...
	public DELIVERY_EVENT(AlternateName alternateName) {
	...
	public DELIVERY_EVENT(Attendee attendee) {
	...
	public DELIVERY_EVENT(Audience audience) {
	...
	public DELIVERY_EVENT(AvailableFrom availableFrom) {
	...
	public DELIVERY_EVENT(AvailableThrough availableThrough) {
		setAvailableThrough(availableThrough);
	}

	@Override
	public AvailableThrough getAvailableThrough() {
		return availableThrough;
	}

	@Override
	public void setAvailableThrough(AvailableThrough availableThrough) {
		this.availableThrough = availableThrough;
	}

	public DELIVERY_EVENT(Composer composer) {
	...
	public DELIVERY_EVENT(Contributor contributor) {
	...
	public DELIVERY_EVENT(Description description) {
	...
	public DELIVERY_EVENT(Director director) {
	...
	public DELIVERY_EVENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public DELIVERY_EVENT(DoorTime doorTime) {
	...
	public DELIVERY_EVENT(Duration duration) {
	...
	public DELIVERY_EVENT(EndDate endDate) {
		setEndDate(endDate);
	}
	...
	public DELIVERY_EVENT(EventStatus eventStatus) {
	...
	public DELIVERY_EVENT(Funder funder) {
		setFunder(funder);
	}
	...
	public DELIVERY_EVENT(HasDeliveryMethod hasDeliveryMethod) {
	...
	public DELIVERY_EVENT(Identifier identifier) {
	...
	public DELIVERY_EVENT(Image image) {
		setImage(image);
	}
	...
	public DELIVERY_EVENT(InLanguage inLanguage) {
	...
	public DELIVERY_EVENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public DELIVERY_EVENT(Location location) {
	...
	public DELIVERY_EVENT(MainEntityOfPage mainEntityOfPage) {
	...
	public DELIVERY_EVENT(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public DELIVERY_EVENT(Name name) {
		setName(name);
	}
	...
	public DELIVERY_EVENT(NameFuzzy nameFuzzy) {
	...
	public DELIVERY_EVENT(NameRuby nameRuby) {
	...
	public DELIVERY_EVENT(Offers offers) {
		setOffers(offers);
	}
	...
	public DELIVERY_EVENT(Organizer organizer) {
	...
	public DELIVERY_EVENT(Performer performer) {
	...
	public DELIVERY_EVENT(PotentialAction potentialAction) {
	...
	public DELIVERY_EVENT(PreviousStartDate previousStartDate) {
	...
	public DELIVERY_EVENT(RecordedIn recordedIn) {
	...
	public DELIVERY_EVENT(RemainingAttendeeCapacity remainingAttendeeCapacity) {
	...
	public DELIVERY_EVENT(Review review) {
		setReview(review);
	}
	...
	public DELIVERY_EVENT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DELIVERY_EVENT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public DELIVERY_EVENT(StartDate startDate) {
	...
	public DELIVERY_EVENT(SubEvent subEvent) {
	...
	public DELIVERY_EVENT(SubjectOf subjectOf) {
	...
	public DELIVERY_EVENT(SuperEvent superEvent) {
	...
	public DELIVERY_EVENT(Translator translator) {
	...
	public DELIVERY_EVENT(TypicalAgeRange typicalAgeRange) {
	...
	public DELIVERY_EVENT(WorkFeatured workFeatured) {
	...
	public DELIVERY_EVENT(WorkPerformed workPerformed) {
	...
	public void copy(Clazz.DeliveryEvent org) {
		setSeq(org.getSeq());
		...
		setAccessCode(org.getAccessCode());
		...
		setAvailableFrom(org.getAvailableFrom());
		setAvailableThrough(org.getAvailableThrough());
