...
public class JEWELRY_STORE implements Clazz.JewelryStore {
	...
	public JEWELRY_STORE(GeoContains geoContains) {
	...
	public JEWELRY_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public JEWELRY_STORE(GeoCovers geoCovers) {
	...
	public JEWELRY_STORE(GeoCrosses geoCrosses) {
	...
	public JEWELRY_STORE(GeoDisjoint geoDisjoint) {
	...
	public JEWELRY_STORE(GeoEquals geoEquals) {
	...
	public JEWELRY_STORE(GeoIntersects geoIntersects) {
	...
	public JEWELRY_STORE(GeoOverlaps geoOverlaps) {
	...
	public JEWELRY_STORE(GeoTouches geoTouches) {
	...
	public JEWELRY_STORE(GeoWithin geoWithin) {
	...
	public JEWELRY_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
