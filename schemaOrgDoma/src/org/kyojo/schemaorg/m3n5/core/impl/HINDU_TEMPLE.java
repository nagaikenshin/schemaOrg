...
public class HINDU_TEMPLE implements Clazz.HinduTemple {
	...
	public HINDU_TEMPLE(GeoContains geoContains) {
	...
	public HINDU_TEMPLE(GeoCoveredBy geoCoveredBy) {
	...
	public HINDU_TEMPLE(GeoCovers geoCovers) {
	...
	public HINDU_TEMPLE(GeoCrosses geoCrosses) {
	...
	public HINDU_TEMPLE(GeoDisjoint geoDisjoint) {
	...
	public HINDU_TEMPLE(GeoEquals geoEquals) {
	...
	public HINDU_TEMPLE(GeoIntersects geoIntersects) {
	...
	public HINDU_TEMPLE(GeoOverlaps geoOverlaps) {
	...
	public HINDU_TEMPLE(GeoTouches geoTouches) {
	...
	public HINDU_TEMPLE(GeoWithin geoWithin) {
	...
	public HINDU_TEMPLE(Slogan slogan) {
		setSlogan(slogan);
	}
