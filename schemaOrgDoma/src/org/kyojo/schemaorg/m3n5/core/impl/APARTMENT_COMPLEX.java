...
public class APARTMENT_COMPLEX implements Clazz.ApartmentComplex {
	...
	public APARTMENT_COMPLEX(GeoContains geoContains) {
	...
	public APARTMENT_COMPLEX(GeoCoveredBy geoCoveredBy) {
	...
	public APARTMENT_COMPLEX(GeoCovers geoCovers) {
	...
	public APARTMENT_COMPLEX(GeoCrosses geoCrosses) {
	...
	public APARTMENT_COMPLEX(GeoDisjoint geoDisjoint) {
	...
	public APARTMENT_COMPLEX(GeoEquals geoEquals) {
	...
	public APARTMENT_COMPLEX(GeoIntersects geoIntersects) {
	...
	public APARTMENT_COMPLEX(GeoOverlaps geoOverlaps) {
	...
	public APARTMENT_COMPLEX(GeoTouches geoTouches) {
	...
	public APARTMENT_COMPLEX(GeoWithin geoWithin) {
	...
	public APARTMENT_COMPLEX(Slogan slogan) {
		setSlogan(slogan);
	}
