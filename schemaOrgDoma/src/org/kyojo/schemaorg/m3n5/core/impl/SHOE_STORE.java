...
public class SHOE_STORE implements Clazz.ShoeStore {
	...
	public SHOE_STORE(GeoContains geoContains) {
	...
	public SHOE_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public SHOE_STORE(GeoCovers geoCovers) {
	...
	public SHOE_STORE(GeoCrosses geoCrosses) {
	...
	public SHOE_STORE(GeoDisjoint geoDisjoint) {
	...
	public SHOE_STORE(GeoEquals geoEquals) {
	...
	public SHOE_STORE(GeoIntersects geoIntersects) {
	...
	public SHOE_STORE(GeoOverlaps geoOverlaps) {
	...
	public SHOE_STORE(GeoTouches geoTouches) {
	...
	public SHOE_STORE(GeoWithin geoWithin) {
	...
	public SHOE_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
