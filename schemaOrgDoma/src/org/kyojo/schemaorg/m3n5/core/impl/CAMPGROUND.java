...
public class CAMPGROUND implements Clazz.Campground {
	...
	public CAMPGROUND(GeoContains geoContains) {
	...
	public CAMPGROUND(GeoCoveredBy geoCoveredBy) {
	...
	public CAMPGROUND(GeoCovers geoCovers) {
	...
	public CAMPGROUND(GeoCrosses geoCrosses) {
	...
	public CAMPGROUND(GeoDisjoint geoDisjoint) {
	...
	public CAMPGROUND(GeoEquals geoEquals) {
	...
	public CAMPGROUND(GeoIntersects geoIntersects) {
	...
	public CAMPGROUND(GeoOverlaps geoOverlaps) {
	...
	public CAMPGROUND(GeoTouches geoTouches) {
	...
	public CAMPGROUND(GeoWithin geoWithin) {
	...
	public CAMPGROUND(Slogan slogan) {
		setSlogan(slogan);
	}
