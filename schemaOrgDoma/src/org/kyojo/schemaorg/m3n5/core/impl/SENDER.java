...
public class SENDER implements Container.Sender {
	...
	public SENDER(ArchiveOrganization archiveOrganization) {
	...
	public SENDER(FundingAgency fundingAgency) {
	...
	public SENDER(FundingScheme fundingScheme) {
	...
	public SENDER(ResearchProject researchProject) {
