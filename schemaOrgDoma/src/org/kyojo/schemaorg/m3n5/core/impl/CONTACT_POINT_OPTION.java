...
public class CONTACT_POINT_OPTION implements Clazz.ContactPointOption {
	...
	public CONTACT_POINT_OPTION() {
	}

	public CONTACT_POINT_OPTION(Long seq) {
		setSeq(seq);
	}

	public CONTACT_POINT_OPTION(String string) {
	...
	public CONTACT_POINT_OPTION(AdditionalType additionalType) {
	...
	public CONTACT_POINT_OPTION(AlternateName alternateName) {
	...
	public CONTACT_POINT_OPTION(Description description) {
	...
	public CONTACT_POINT_OPTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public CONTACT_POINT_OPTION(Identifier identifier) {
	...
	public CONTACT_POINT_OPTION(Image image) {
		setImage(image);
	}
	...
	public CONTACT_POINT_OPTION(MainEntityOfPage mainEntityOfPage) {
	...
	public CONTACT_POINT_OPTION(Name name) {
		setName(name);
	}
	...
	public CONTACT_POINT_OPTION(NameFuzzy nameFuzzy) {
	...
	public CONTACT_POINT_OPTION(NameRuby nameRuby) {
	...
	public CONTACT_POINT_OPTION(PotentialAction potentialAction) {
	...
	public CONTACT_POINT_OPTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CONTACT_POINT_OPTION(SubjectOf subjectOf) {
	...
	public CONTACT_POINT_OPTION(SupersededBy supersededBy) {
	...
	public CONTACT_POINT_OPTION(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.ContactPointOption org) {
		setSeq(org.getSeq());
