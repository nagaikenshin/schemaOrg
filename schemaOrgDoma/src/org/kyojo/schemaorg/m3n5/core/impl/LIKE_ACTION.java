...
public class LIKE_ACTION implements Clazz.LikeAction {
	...
	public LIKE_ACTION(Long seq) {
		setSeq(seq);
	}

	public LIKE_ACTION(String string) {
	...
	public LIKE_ACTION(ActionStatus actionStatus) {
	...
	public LIKE_ACTION(AdditionalType additionalType) {
	...
	public LIKE_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public LIKE_ACTION(AlternateName alternateName) {
	...
	public LIKE_ACTION(Description description) {
	...
	public LIKE_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public LIKE_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public LIKE_ACTION(Error error) {
		setError(error);
	}
	...
	public LIKE_ACTION(Identifier identifier) {
	...
	public LIKE_ACTION(Image image) {
		setImage(image);
	}
	...
	public LIKE_ACTION(Instrument instrument) {
	...
	public LIKE_ACTION(Location location) {
	...
	public LIKE_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public LIKE_ACTION(NameFuzzy nameFuzzy) {
	...
	public LIKE_ACTION(NameRuby nameRuby) {
	...
	public LIKE_ACTION(Object object) {
		setObject(object);
	}
	...
	public LIKE_ACTION(Participant participant) {
	...
	public LIKE_ACTION(PotentialAction potentialAction) {
	...
	public LIKE_ACTION(Result result) {
		setResult(result);
	}
	...
	public LIKE_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public LIKE_ACTION(StartTime startTime) {
	...
	public LIKE_ACTION(SubjectOf subjectOf) {
	...
	public LIKE_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.LikeAction org) {
		setSeq(org.getSeq());
