...
public class HOSPITAL implements Clazz.Hospital {
	...
	public HOSPITAL(GeoContains geoContains) {
	...
	public HOSPITAL(GeoCoveredBy geoCoveredBy) {
	...
	public HOSPITAL(GeoCovers geoCovers) {
	...
	public HOSPITAL(GeoCrosses geoCrosses) {
	...
	public HOSPITAL(GeoDisjoint geoDisjoint) {
	...
	public HOSPITAL(GeoEquals geoEquals) {
	...
	public HOSPITAL(GeoIntersects geoIntersects) {
	...
	public HOSPITAL(GeoOverlaps geoOverlaps) {
	...
	public HOSPITAL(GeoTouches geoTouches) {
	...
	public HOSPITAL(GeoWithin geoWithin) {
