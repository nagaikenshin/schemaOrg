...
public class POLICE_STATION implements Clazz.PoliceStation {
	...
	public POLICE_STATION(GeoContains geoContains) {
	...
	public POLICE_STATION(GeoCoveredBy geoCoveredBy) {
	...
	public POLICE_STATION(GeoCovers geoCovers) {
	...
	public POLICE_STATION(GeoCrosses geoCrosses) {
	...
	public POLICE_STATION(GeoDisjoint geoDisjoint) {
	...
	public POLICE_STATION(GeoEquals geoEquals) {
	...
	public POLICE_STATION(GeoIntersects geoIntersects) {
	...
	public POLICE_STATION(GeoOverlaps geoOverlaps) {
	...
	public POLICE_STATION(GeoTouches geoTouches) {
	...
	public POLICE_STATION(GeoWithin geoWithin) {
	...
	public POLICE_STATION(Slogan slogan) {
		setSlogan(slogan);
	}
