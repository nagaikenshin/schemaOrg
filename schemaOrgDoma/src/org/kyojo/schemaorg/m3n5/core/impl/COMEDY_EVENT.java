...
public class COMEDY_EVENT implements Clazz.ComedyEvent {
	...
	public COMEDY_EVENT(Long seq) {
		setSeq(seq);
	}

	public COMEDY_EVENT(String string) {
	...
	public COMEDY_EVENT(About about) {
		setAbout(about);
	}
	...
	public COMEDY_EVENT(Actor actor) {
		setActor(actor);
	}
	...
	public COMEDY_EVENT(AdditionalType additionalType) {
	...
	public COMEDY_EVENT(AggregateRating aggregateRating) {
	...
	public COMEDY_EVENT(AlternateName alternateName) {
	...
	public COMEDY_EVENT(Attendee attendee) {
	...
	public COMEDY_EVENT(Audience audience) {
	...
	public COMEDY_EVENT(Composer composer) {
	...
	public COMEDY_EVENT(Contributor contributor) {
	...
	public COMEDY_EVENT(Description description) {
	...
	public COMEDY_EVENT(Director director) {
	...
	public COMEDY_EVENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public COMEDY_EVENT(DoorTime doorTime) {
	...
	public COMEDY_EVENT(Duration duration) {
	...
	public COMEDY_EVENT(EndDate endDate) {
		setEndDate(endDate);
	}
	...
	public COMEDY_EVENT(EventStatus eventStatus) {
	...
	public COMEDY_EVENT(Funder funder) {
		setFunder(funder);
	}
	...
	public COMEDY_EVENT(Identifier identifier) {
	...
	public COMEDY_EVENT(Image image) {
		setImage(image);
	}
	...
	public COMEDY_EVENT(InLanguage inLanguage) {
	...
	public COMEDY_EVENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public COMEDY_EVENT(Location location) {
	...
	public COMEDY_EVENT(MainEntityOfPage mainEntityOfPage) {
	...
	public COMEDY_EVENT(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public COMEDY_EVENT(NameFuzzy nameFuzzy) {
	...
	public COMEDY_EVENT(NameRuby nameRuby) {
	...
	public COMEDY_EVENT(Offers offers) {
		setOffers(offers);
	}
	...
	public COMEDY_EVENT(Organizer organizer) {
	...
	public COMEDY_EVENT(Performer performer) {
	...
	public COMEDY_EVENT(PotentialAction potentialAction) {
	...
	public COMEDY_EVENT(PreviousStartDate previousStartDate) {
	...
	public COMEDY_EVENT(RecordedIn recordedIn) {
	...
	public COMEDY_EVENT(RemainingAttendeeCapacity remainingAttendeeCapacity) {
	...
	public COMEDY_EVENT(Review review) {
		setReview(review);
	}
	...
	public COMEDY_EVENT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public COMEDY_EVENT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public COMEDY_EVENT(StartDate startDate) {
	...
	public COMEDY_EVENT(SubEvent subEvent) {
	...
	public COMEDY_EVENT(SubjectOf subjectOf) {
	...
	public COMEDY_EVENT(SuperEvent superEvent) {
	...
	public COMEDY_EVENT(Translator translator) {
	...
	public COMEDY_EVENT(TypicalAgeRange typicalAgeRange) {
	...
	public COMEDY_EVENT(WorkFeatured workFeatured) {
	...
	public COMEDY_EVENT(WorkPerformed workPerformed) {
	...
	public void copy(Clazz.ComedyEvent org) {
		setSeq(org.getSeq());
