...
public class BUS_STATION implements Clazz.BusStation {
	...
	public BUS_STATION(GeoContains geoContains) {
	...
	public BUS_STATION(GeoCoveredBy geoCoveredBy) {
	...
	public BUS_STATION(GeoCovers geoCovers) {
	...
	public BUS_STATION(GeoCrosses geoCrosses) {
	...
	public BUS_STATION(GeoDisjoint geoDisjoint) {
	...
	public BUS_STATION(GeoEquals geoEquals) {
	...
	public BUS_STATION(GeoIntersects geoIntersects) {
	...
	public BUS_STATION(GeoOverlaps geoOverlaps) {
	...
	public BUS_STATION(GeoTouches geoTouches) {
	...
	public BUS_STATION(GeoWithin geoWithin) {
	...
	public BUS_STATION(Slogan slogan) {
		setSlogan(slogan);
	}
