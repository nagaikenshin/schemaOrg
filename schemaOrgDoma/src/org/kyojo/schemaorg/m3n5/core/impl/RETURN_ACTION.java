...
public class RETURN_ACTION implements Clazz.ReturnAction {
	...
	public RETURN_ACTION(Long seq) {
		setSeq(seq);
	}

	public RETURN_ACTION(String string) {
	...
	public RETURN_ACTION(ActionStatus actionStatus) {
	...
	public RETURN_ACTION(AdditionalType additionalType) {
	...
	public RETURN_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public RETURN_ACTION(AlternateName alternateName) {
	...
	public RETURN_ACTION(Description description) {
	...
	public RETURN_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public RETURN_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public RETURN_ACTION(Error error) {
		setError(error);
	}
	...
	public RETURN_ACTION(FromLocation fromLocation) {
	...
	public RETURN_ACTION(Identifier identifier) {
	...
	public RETURN_ACTION(Image image) {
		setImage(image);
	}
	...
	public RETURN_ACTION(Instrument instrument) {
	...
	public RETURN_ACTION(Location location) {
	...
	public RETURN_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public RETURN_ACTION(Name name) {
		setName(name);
	}
	...
	public RETURN_ACTION(NameFuzzy nameFuzzy) {
	...
	public RETURN_ACTION(NameRuby nameRuby) {
	...
	public RETURN_ACTION(Object object) {
		setObject(object);
	}
	...
	public RETURN_ACTION(Participant participant) {
	...
	public RETURN_ACTION(PotentialAction potentialAction) {
	...
	public RETURN_ACTION(Recipient recipient) {
	...
	public RETURN_ACTION(Result result) {
		setResult(result);
	}
	...
	public RETURN_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RETURN_ACTION(StartTime startTime) {
	...
	public RETURN_ACTION(SubjectOf subjectOf) {
	...
	public RETURN_ACTION(Target target) {
		setTarget(target);
	}
	...
	public RETURN_ACTION(ToLocation toLocation) {
	...
	public void copy(Clazz.ReturnAction org) {
		setSeq(org.getSeq());
