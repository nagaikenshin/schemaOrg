...
public class BRIDGE implements Clazz.Bridge {
	...
	public BRIDGE(GeoContains geoContains) {
	...
	public BRIDGE(GeoCoveredBy geoCoveredBy) {
	...
	public BRIDGE(GeoCovers geoCovers) {
	...
	public BRIDGE(GeoCrosses geoCrosses) {
	...
	public BRIDGE(GeoDisjoint geoDisjoint) {
	...
	public BRIDGE(GeoEquals geoEquals) {
	...
	public BRIDGE(GeoIntersects geoIntersects) {
	...
	public BRIDGE(GeoOverlaps geoOverlaps) {
	...
	public BRIDGE(GeoTouches geoTouches) {
	...
	public BRIDGE(GeoWithin geoWithin) {
