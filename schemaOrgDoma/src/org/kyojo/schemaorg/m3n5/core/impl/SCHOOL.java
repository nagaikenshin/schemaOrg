...
public class SCHOOL implements Clazz.School {
	...
	public SCHOOL(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public SCHOOL(AdditionalType additionalType) {
	...
	public SCHOOL(AggregateRating aggregateRating) {
	...
	public SCHOOL(AlternateName alternateName) {
	...
	public SCHOOL(AreaServed areaServed) {
	...
	public SCHOOL(ContactPoint contactPoint) {
	...
	public SCHOOL(CorrectionsPolicy correctionsPolicy) {
	...
	public SCHOOL(Description description) {
	...
	public SCHOOL(DisambiguatingDescription disambiguatingDescription) {
	...
	public SCHOOL(DissolutionDate dissolutionDate) {
	...
	public SCHOOL(DiversityPolicy diversityPolicy) {
	...
	public SCHOOL(DiversityStaffingReport diversityStaffingReport) {
	...
	public SCHOOL(EthicsPolicy ethicsPolicy) {
	...
	public SCHOOL(FaxNumber faxNumber) {
	...
	public SCHOOL(FoundingDate foundingDate) {
	...
	public SCHOOL(FoundingLocation foundingLocation) {
	...
	public SCHOOL(GlobalLocationNumber globalLocationNumber) {
	...
	public SCHOOL(HasOfferCatalog hasOfferCatalog) {
	...
	public SCHOOL(Identifier identifier) {
	...
	public SCHOOL(KnowsAbout knowsAbout) {
	...
	public SCHOOL(KnowsLanguage knowsLanguage) {
	...
	public SCHOOL(LegalName legalName) {
	...
	public SCHOOL(MainEntityOfPage mainEntityOfPage) {
	...
	public SCHOOL(MakesOffer makesOffer) {
	...
	public SCHOOL(MemberOf memberOf) {
	...
	public SCHOOL(NameFuzzy nameFuzzy) {
	...
	public SCHOOL(NameRuby nameRuby) {
	...
	public SCHOOL(NumberOfEmployees numberOfEmployees) {
	...
	public SCHOOL(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public SCHOOL(ParentOrganization parentOrganization) {
	...
	public SCHOOL(PotentialAction potentialAction) {
	...
	public SCHOOL(PublishingPrinciples publishingPrinciples) {
	...
	public SCHOOL(SubOrganization subOrganization) {
	...
	public SCHOOL(SubjectOf subjectOf) {
	...
	public SCHOOL(Telephone telephone) {
	...
	public SCHOOL(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public void copy(Clazz.School org) {
		setSeq(org.getSeq());
