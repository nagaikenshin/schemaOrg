...
public class THING implements Clazz.Thing {
	...
	public THING(AdditionalType additionalType) {
	...
	public THING(AlternateName alternateName) {
	...
	public THING(Description description) {
	...
	public THING(DisambiguatingDescription disambiguatingDescription) {
	...
	public THING(Identifier identifier) {
	...
	public THING(MainEntityOfPage mainEntityOfPage) {
	...
	public THING(NameFuzzy nameFuzzy) {
	...
	public THING(NameRuby nameRuby) {
	...
	public THING(PotentialAction potentialAction) {
	...
	public THING(SubjectOf subjectOf) {
	...
	public void copy(Clazz.Thing org) {
		setSeq(org.getSeq());
