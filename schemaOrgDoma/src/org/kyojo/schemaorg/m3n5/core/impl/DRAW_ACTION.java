...
public class DRAW_ACTION implements Clazz.DrawAction {
	...
	public DRAW_ACTION(Long seq) {
		setSeq(seq);
	}

	public DRAW_ACTION(String string) {
	...
	public DRAW_ACTION(ActionStatus actionStatus) {
	...
	public DRAW_ACTION(AdditionalType additionalType) {
	...
	public DRAW_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public DRAW_ACTION(AlternateName alternateName) {
	...
	public DRAW_ACTION(Description description) {
	...
	public DRAW_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public DRAW_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public DRAW_ACTION(Error error) {
		setError(error);
	}
	...
	public DRAW_ACTION(Identifier identifier) {
	...
	public DRAW_ACTION(Image image) {
		setImage(image);
	}
	...
	public DRAW_ACTION(Instrument instrument) {
	...
	public DRAW_ACTION(Location location) {
	...
	public DRAW_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public DRAW_ACTION(NameFuzzy nameFuzzy) {
	...
	public DRAW_ACTION(NameRuby nameRuby) {
	...
	public DRAW_ACTION(Object object) {
		setObject(object);
	}
	...
	public DRAW_ACTION(Participant participant) {
	...
	public DRAW_ACTION(PotentialAction potentialAction) {
	...
	public DRAW_ACTION(Result result) {
		setResult(result);
	}
	...
	public DRAW_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DRAW_ACTION(StartTime startTime) {
	...
	public DRAW_ACTION(SubjectOf subjectOf) {
	...
	public DRAW_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.DrawAction org) {
		setSeq(org.getSeq());
