...
public class AUTO_RENTAL implements Clazz.AutoRental {
	...
	public AUTO_RENTAL(GeoContains geoContains) {
	...
	public AUTO_RENTAL(GeoCoveredBy geoCoveredBy) {
	...
	public AUTO_RENTAL(GeoCovers geoCovers) {
	...
	public AUTO_RENTAL(GeoCrosses geoCrosses) {
	...
	public AUTO_RENTAL(GeoDisjoint geoDisjoint) {
	...
	public AUTO_RENTAL(GeoEquals geoEquals) {
	...
	public AUTO_RENTAL(GeoIntersects geoIntersects) {
	...
	public AUTO_RENTAL(GeoOverlaps geoOverlaps) {
	...
	public AUTO_RENTAL(GeoTouches geoTouches) {
	...
	public AUTO_RENTAL(GeoWithin geoWithin) {
	...
	public AUTO_RENTAL(Slogan slogan) {
		setSlogan(slogan);
	}
