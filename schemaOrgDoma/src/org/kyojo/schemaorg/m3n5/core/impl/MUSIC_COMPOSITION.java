...
import org.kyojo.schemaorg.m3n5.core.Container.FirstPerformance;
...
import org.kyojo.schemaorg.m3n5.core.Container.MusicArrangement;
import org.kyojo.schemaorg.m3n5.core.Container.MusicCompositionForm;
...
public class MUSIC_COMPOSITION implements Clazz.MusicComposition {
	...
	public FirstPerformance firstPerformance;
	...
	public IncludedComposition includedComposition;
	...
	public MusicArrangement musicArrangement;
	public MusicCompositionForm musicCompositionForm;
	...
	public MUSIC_COMPOSITION() {
	}

	public MUSIC_COMPOSITION(Long seq) {
		setSeq(seq);
	}

	public MUSIC_COMPOSITION(String string) {
	...
	public MUSIC_COMPOSITION(About about) {
		setAbout(about);
	}
	...
	public MUSIC_COMPOSITION(AccessMode accessMode) {
	...
	public MUSIC_COMPOSITION(AccessModeSufficient accessModeSufficient) {
	...
	public MUSIC_COMPOSITION(AccessibilityAPI accessibilityAPI) {
	...
	public MUSIC_COMPOSITION(AccessibilityControl accessibilityControl) {
	...
	public MUSIC_COMPOSITION(AccessibilityFeature accessibilityFeature) {
	...
	public MUSIC_COMPOSITION(AccessibilityHazard accessibilityHazard) {
	...
	public MUSIC_COMPOSITION(AccessibilitySummary accessibilitySummary) {
	...
	public MUSIC_COMPOSITION(AccountablePerson accountablePerson) {
	...
	public MUSIC_COMPOSITION(AdditionalType additionalType) {
	...
	public MUSIC_COMPOSITION(AggregateRating aggregateRating) {
	...
	public MUSIC_COMPOSITION(AlternateName alternateName) {
	...
	public MUSIC_COMPOSITION(AlternativeHeadline alternativeHeadline) {
	...
	public MUSIC_COMPOSITION(AssociatedMedia associatedMedia) {
	...
	public MUSIC_COMPOSITION(Audience audience) {
	...
	public MUSIC_COMPOSITION(Audio audio) {
		setAudio(audio);
	}
	...
	public MUSIC_COMPOSITION(Author author) {
		setAuthor(author);
	}
	...
	public MUSIC_COMPOSITION(Award award) {
		setAward(award);
	}
	...
	public MUSIC_COMPOSITION(Character character) {
	...
	public MUSIC_COMPOSITION(Citation citation) {
	...
	public MUSIC_COMPOSITION(Comment comment) {
		setComment(comment);
	}
	...
	public MUSIC_COMPOSITION(CommentCount commentCount) {
	...
	public MUSIC_COMPOSITION(Composer composer) {
	...
	public MUSIC_COMPOSITION(ContentLocation contentLocation) {
	...
	public MUSIC_COMPOSITION(ContentRating contentRating) {
	...
	public MUSIC_COMPOSITION(ContentReferenceTime contentReferenceTime) {
	...
	public MUSIC_COMPOSITION(Contributor contributor) {
	...
	public MUSIC_COMPOSITION(CopyrightHolder copyrightHolder) {
	...
	public MUSIC_COMPOSITION(CopyrightYear copyrightYear) {
	...
	public MUSIC_COMPOSITION(Correction correction) {
	...
	public MUSIC_COMPOSITION(Creator creator) {
		setCreator(creator);
	}
	...
	public MUSIC_COMPOSITION(DateCreated dateCreated) {
	...
	public MUSIC_COMPOSITION(DateModified dateModified) {
	...
	public MUSIC_COMPOSITION(DatePublished datePublished) {
	...
	public MUSIC_COMPOSITION(Description description) {
	...
	public MUSIC_COMPOSITION(DisambiguatingDescription disambiguatingDescription) {
	...
	public MUSIC_COMPOSITION(DiscussionUrl discussionUrl) {
	...
	public MUSIC_COMPOSITION(Editor editor) {
		setEditor(editor);
	}
	...
	public MUSIC_COMPOSITION(EducationalAlignment educationalAlignment) {
	...
	public MUSIC_COMPOSITION(EducationalUse educationalUse) {
	...
	public MUSIC_COMPOSITION(Encoding encoding) {
	...
	public MUSIC_COMPOSITION(EncodingFormat encodingFormat) {
	...
	public MUSIC_COMPOSITION(ExampleOfWork exampleOfWork) {
	...
	public MUSIC_COMPOSITION(Expires expires) {
		setExpires(expires);
	}
	...
	public MUSIC_COMPOSITION(FirstPerformance firstPerformance) {
		setFirstPerformance(firstPerformance);
	}

	@Override
	public FirstPerformance getFirstPerformance() {
		return firstPerformance;
	}

	@Override
	public void setFirstPerformance(FirstPerformance firstPerformance) {
		this.firstPerformance = firstPerformance;
	}

	public MUSIC_COMPOSITION(Funder funder) {
		setFunder(funder);
	}
	...
	public MUSIC_COMPOSITION(Genre genre) {
		setGenre(genre);
	}
	...
	public MUSIC_COMPOSITION(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public MUSIC_COMPOSITION(Headline headline) {
	...
	public MUSIC_COMPOSITION(Identifier identifier) {
	...
	public MUSIC_COMPOSITION(Image image) {
		setImage(image);
	}
	...
	public MUSIC_COMPOSITION(InLanguage inLanguage) {
	...
	public MUSIC_COMPOSITION(IncludedComposition includedComposition) {
		setIncludedComposition(includedComposition);
	}

	@Override
	public IncludedComposition getIncludedComposition() {
		return includedComposition;
	}

	@Override
	public void setIncludedComposition(IncludedComposition includedComposition) {
		this.includedComposition = includedComposition;
	}

	public MUSIC_COMPOSITION(InteractionStatistic interactionStatistic) {
	...
	public MUSIC_COMPOSITION(InteractivityType interactivityType) {
	...
	public MUSIC_COMPOSITION(IsAccessibleForFree isAccessibleForFree) {
	...
	public MUSIC_COMPOSITION(IsBasedOn isBasedOn) {
	...
	public MUSIC_COMPOSITION(IsFamilyFriendly isFamilyFriendly) {
	...
	public MUSIC_COMPOSITION(IsPartOf isPartOf) {
	...
	public MUSIC_COMPOSITION(IswcCode iswcCode) {
		setIswcCode(iswcCode);
	}
	...
	public MUSIC_COMPOSITION(Keywords keywords) {
	...
	public MUSIC_COMPOSITION(LearningResourceType learningResourceType) {
	...
	public MUSIC_COMPOSITION(License license) {
		setLicense(license);
	}
	...
	public MUSIC_COMPOSITION(LocationCreated locationCreated) {
	...
	public MUSIC_COMPOSITION(Lyricist lyricist) {
	...
	public MUSIC_COMPOSITION(Lyrics lyrics) {
		setLyrics(lyrics);
	}
	...
	public MUSIC_COMPOSITION(MainEntity mainEntity) {
	...
	public MUSIC_COMPOSITION(MainEntityOfPage mainEntityOfPage) {
	...
	public MUSIC_COMPOSITION(Material material) {
	...
	public MUSIC_COMPOSITION(MaterialExtent materialExtent) {
	...
	public MUSIC_COMPOSITION(Mentions mentions) {
	...
	public MUSIC_COMPOSITION(MusicArrangement musicArrangement) {
		setMusicArrangement(musicArrangement);
	}

	@Override
	public MusicArrangement getMusicArrangement() {
		return musicArrangement;
	}

	@Override
	public void setMusicArrangement(MusicArrangement musicArrangement) {
		this.musicArrangement = musicArrangement;
	}

	public MUSIC_COMPOSITION(MusicCompositionForm musicCompositionForm) {
		setMusicCompositionForm(musicCompositionForm);
	}

	@Override
	public MusicCompositionForm getMusicCompositionForm() {
		return musicCompositionForm;
	}

	@Override
	public void setMusicCompositionForm(MusicCompositionForm musicCompositionForm) {
		this.musicCompositionForm = musicCompositionForm;
	}

	public MUSIC_COMPOSITION(MusicalKey musicalKey) {
	...
	public MUSIC_COMPOSITION(Name name) {
		setName(name);
	}
	...
	public MUSIC_COMPOSITION(NameFuzzy nameFuzzy) {
	...
	public MUSIC_COMPOSITION(NameRuby nameRuby) {
	...
	public MUSIC_COMPOSITION(Offers offers) {
		setOffers(offers);
	}
	...
	public MUSIC_COMPOSITION(Position position) {
	...
	public MUSIC_COMPOSITION(PotentialAction potentialAction) {
	...
	public MUSIC_COMPOSITION(Producer producer) {
	...
	public MUSIC_COMPOSITION(Provider provider) {
	...
	public MUSIC_COMPOSITION(Publication publication) {
	...
	public MUSIC_COMPOSITION(Publisher publisher) {
	...
	public MUSIC_COMPOSITION(PublisherImprint publisherImprint) {
	...
	public MUSIC_COMPOSITION(PublishingPrinciples publishingPrinciples) {
	...
	public MUSIC_COMPOSITION(RecordedAs recordedAs) {
		setRecordedAs(recordedAs);
	}

	@Override
	public RecordedAs getRecordedAs() {
		return recordedAs;
	}

	@Override
	public void setRecordedAs(RecordedAs recordedAs) {
		this.recordedAs = recordedAs;
	}

	public MUSIC_COMPOSITION(RecordedAt recordedAt) {
	...
	public MUSIC_COMPOSITION(ReleasedEvent releasedEvent) {
	...
	public MUSIC_COMPOSITION(Review review) {
		setReview(review);
	}
	...
	public MUSIC_COMPOSITION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MUSIC_COMPOSITION(SchemaVersion schemaVersion) {
	...
	public MUSIC_COMPOSITION(SdDatePublished sdDatePublished) {
	...
	public MUSIC_COMPOSITION(SdLicense sdLicense) {
	...
	public MUSIC_COMPOSITION(SdPublisher sdPublisher) {
	...
	public MUSIC_COMPOSITION(SourceOrganization sourceOrganization) {
	...
	public MUSIC_COMPOSITION(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public MUSIC_COMPOSITION(SpatialCoverage spatialCoverage) {
	...
	public MUSIC_COMPOSITION(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MUSIC_COMPOSITION(SubjectOf subjectOf) {
	...
	public MUSIC_COMPOSITION(Temporal temporal) {
	...
	public MUSIC_COMPOSITION(TemporalCoverage temporalCoverage) {
	...
	public MUSIC_COMPOSITION(Text text) {
		setText(text);
	}
	...
	public MUSIC_COMPOSITION(ThumbnailUrl thumbnailUrl) {
	...
	public MUSIC_COMPOSITION(TimeRequired timeRequired) {
	...
	public MUSIC_COMPOSITION(TranslationOfWork translationOfWork) {
	...
	public MUSIC_COMPOSITION(Translator translator) {
	...
	public MUSIC_COMPOSITION(TypicalAgeRange typicalAgeRange) {
	...
	public MUSIC_COMPOSITION(Url url) {
		setUrl(url);
	}
	...
	public MUSIC_COMPOSITION(Version version) {
		setVersion(version);
	}
	...
	public MUSIC_COMPOSITION(Video video) {
		setVideo(video);
	}
	...
	public MUSIC_COMPOSITION(WorkExample workExample) {
	...
	public MUSIC_COMPOSITION(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.MusicComposition org) {
		setSeq(org.getSeq());
		...
		setFirstPerformance(org.getFirstPerformance());
		...
		setIncludedComposition(org.getIncludedComposition());
		...
		setLyricist(org.getLyricist());
		setLyrics(org.getLyrics());
		...
		setMusicArrangement(org.getMusicArrangement());
		setMusicCompositionForm(org.getMusicCompositionForm());
		setMusicalKey(org.getMusicalKey());
		setName(org.getName());
		...
		setRecordedAs(org.getRecordedAs());
