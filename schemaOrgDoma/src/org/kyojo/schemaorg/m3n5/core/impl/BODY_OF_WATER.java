...
public class BODY_OF_WATER implements Clazz.BodyOfWater {
	...
	public BODY_OF_WATER(GeoContains geoContains) {
	...
	public BODY_OF_WATER(GeoCoveredBy geoCoveredBy) {
	...
	public BODY_OF_WATER(GeoCovers geoCovers) {
	...
	public BODY_OF_WATER(GeoCrosses geoCrosses) {
	...
	public BODY_OF_WATER(GeoDisjoint geoDisjoint) {
	...
	public BODY_OF_WATER(GeoEquals geoEquals) {
	...
	public BODY_OF_WATER(GeoIntersects geoIntersects) {
	...
	public BODY_OF_WATER(GeoOverlaps geoOverlaps) {
	...
	public BODY_OF_WATER(GeoTouches geoTouches) {
	...
	public BODY_OF_WATER(GeoWithin geoWithin) {
	...
	public BODY_OF_WATER(Slogan slogan) {
		setSlogan(slogan);
	}
