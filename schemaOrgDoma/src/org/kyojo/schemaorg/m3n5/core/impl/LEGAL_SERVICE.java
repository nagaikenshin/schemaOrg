...
public class LEGAL_SERVICE implements Clazz.LegalService {
	...
	public LEGAL_SERVICE(GeoContains geoContains) {
	...
	public LEGAL_SERVICE(GeoCoveredBy geoCoveredBy) {
	...
	public LEGAL_SERVICE(GeoCovers geoCovers) {
	...
	public LEGAL_SERVICE(GeoCrosses geoCrosses) {
	...
	public LEGAL_SERVICE(GeoDisjoint geoDisjoint) {
	...
	public LEGAL_SERVICE(GeoEquals geoEquals) {
	...
	public LEGAL_SERVICE(GeoIntersects geoIntersects) {
	...
	public LEGAL_SERVICE(GeoOverlaps geoOverlaps) {
	...
	public LEGAL_SERVICE(GeoTouches geoTouches) {
	...
	public LEGAL_SERVICE(GeoWithin geoWithin) {
	...
	public LEGAL_SERVICE(Slogan slogan) {
		setSlogan(slogan);
	}
