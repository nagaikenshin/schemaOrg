...
public class SUBWAY_STATION implements Clazz.SubwayStation {
	...
	public SUBWAY_STATION(GeoContains geoContains) {
	...
	public SUBWAY_STATION(GeoCoveredBy geoCoveredBy) {
	...
	public SUBWAY_STATION(GeoCovers geoCovers) {
	...
	public SUBWAY_STATION(GeoCrosses geoCrosses) {
	...
	public SUBWAY_STATION(GeoDisjoint geoDisjoint) {
	...
	public SUBWAY_STATION(GeoEquals geoEquals) {
	...
	public SUBWAY_STATION(GeoIntersects geoIntersects) {
	...
	public SUBWAY_STATION(GeoOverlaps geoOverlaps) {
	...
	public SUBWAY_STATION(GeoTouches geoTouches) {
	...
	public SUBWAY_STATION(GeoWithin geoWithin) {
	...
	public SUBWAY_STATION(Slogan slogan) {
		setSlogan(slogan);
	}
