...
import org.kyojo.schemaorg.m3n5.core.Container.AmountOfThisGood;
...
import org.kyojo.schemaorg.m3n5.core.Container.UnitCode;
...
public class TYPE_AND_QUANTITY_NODE implements Clazz.TypeAndQuantityNode {
	...
	public AmountOfThisGood amountOfThisGood;
	...
	public TYPE_AND_QUANTITY_NODE(String string) {
	...
	public TYPE_AND_QUANTITY_NODE(AdditionalType additionalType) {
	...
	public TYPE_AND_QUANTITY_NODE(AlternateName alternateName) {
	...
	public TYPE_AND_QUANTITY_NODE(AmountOfThisGood amountOfThisGood) {
		setAmountOfThisGood(amountOfThisGood);
	}

	@Override
	public AmountOfThisGood getAmountOfThisGood() {
		return amountOfThisGood;
	}

	@Override
	public void setAmountOfThisGood(AmountOfThisGood amountOfThisGood) {
		this.amountOfThisGood = amountOfThisGood;
	}

	public TYPE_AND_QUANTITY_NODE(BusinessFunction businessFunction) {
	...
	public TYPE_AND_QUANTITY_NODE(Description description) {
	...
	public TYPE_AND_QUANTITY_NODE(DisambiguatingDescription disambiguatingDescription) {
	...
	public TYPE_AND_QUANTITY_NODE(Identifier identifier) {
	...
	public TYPE_AND_QUANTITY_NODE(Image image) {
		setImage(image);
	}
	...
	public TYPE_AND_QUANTITY_NODE(MainEntityOfPage mainEntityOfPage) {
	...
	public TYPE_AND_QUANTITY_NODE(Name name) {
		setName(name);
	}
	...
	public TYPE_AND_QUANTITY_NODE(NameFuzzy nameFuzzy) {
	...
	public TYPE_AND_QUANTITY_NODE(NameRuby nameRuby) {
	...
	public TYPE_AND_QUANTITY_NODE(PotentialAction potentialAction) {
	...
	public TYPE_AND_QUANTITY_NODE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TYPE_AND_QUANTITY_NODE(SubjectOf subjectOf) {
	...
	public TYPE_AND_QUANTITY_NODE(TypeOfGood typeOfGood) {
	...
	public TYPE_AND_QUANTITY_NODE(UnitCode unitCode) {
	...
	public TYPE_AND_QUANTITY_NODE(UnitText unitText) {
	...
	public TYPE_AND_QUANTITY_NODE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.TypeAndQuantityNode org) {
		...
		setAmountOfThisGood(org.getAmountOfThisGood());
