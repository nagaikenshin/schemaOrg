...
public class OFFICE_EQUIPMENT_STORE implements Clazz.OfficeEquipmentStore {
	...
	public OFFICE_EQUIPMENT_STORE(GeoContains geoContains) {
	...
	public OFFICE_EQUIPMENT_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public OFFICE_EQUIPMENT_STORE(GeoCovers geoCovers) {
	...
	public OFFICE_EQUIPMENT_STORE(GeoCrosses geoCrosses) {
	...
	public OFFICE_EQUIPMENT_STORE(GeoDisjoint geoDisjoint) {
	...
	public OFFICE_EQUIPMENT_STORE(GeoEquals geoEquals) {
	...
	public OFFICE_EQUIPMENT_STORE(GeoIntersects geoIntersects) {
	...
	public OFFICE_EQUIPMENT_STORE(GeoOverlaps geoOverlaps) {
	...
	public OFFICE_EQUIPMENT_STORE(GeoTouches geoTouches) {
	...
	public OFFICE_EQUIPMENT_STORE(GeoWithin geoWithin) {
	...
	public OFFICE_EQUIPMENT_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
