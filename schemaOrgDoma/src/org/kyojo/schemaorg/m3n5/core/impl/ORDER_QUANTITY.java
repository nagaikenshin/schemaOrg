...
public class ORDER_QUANTITY implements Container.OrderQuantity {
	...
	public ORDER_QUANTITY(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public ORDER_QUANTITY(Float fl0at) {
	...
	public ORDER_QUANTITY(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public ORDER_QUANTITY(Integer integer) {
	...
	public ORDER_QUANTITY(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public ORDER_QUANTITY(Number number) {
	...
	public ORDER_QUANTITY(List<Float> fl0atList,
	...
	public void copy(Container.OrderQuantity org) {
