...
public class SELF_STORAGE implements Clazz.SelfStorage {
	...
	public SELF_STORAGE(GeoContains geoContains) {
	...
	public SELF_STORAGE(GeoCoveredBy geoCoveredBy) {
	...
	public SELF_STORAGE(GeoCovers geoCovers) {
	...
	public SELF_STORAGE(GeoCrosses geoCrosses) {
	...
	public SELF_STORAGE(GeoDisjoint geoDisjoint) {
	...
	public SELF_STORAGE(GeoEquals geoEquals) {
	...
	public SELF_STORAGE(GeoIntersects geoIntersects) {
	...
	public SELF_STORAGE(GeoOverlaps geoOverlaps) {
	...
	public SELF_STORAGE(GeoTouches geoTouches) {
	...
	public SELF_STORAGE(GeoWithin geoWithin) {
	...
	public SELF_STORAGE(Slogan slogan) {
		setSlogan(slogan);
	}
