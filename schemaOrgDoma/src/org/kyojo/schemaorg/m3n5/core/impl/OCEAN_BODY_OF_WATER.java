...
public class OCEAN_BODY_OF_WATER implements Clazz.OceanBodyOfWater {
	...
	public OCEAN_BODY_OF_WATER(GeoContains geoContains) {
	...
	public OCEAN_BODY_OF_WATER(GeoCoveredBy geoCoveredBy) {
	...
	public OCEAN_BODY_OF_WATER(GeoCovers geoCovers) {
	...
	public OCEAN_BODY_OF_WATER(GeoCrosses geoCrosses) {
	...
	public OCEAN_BODY_OF_WATER(GeoDisjoint geoDisjoint) {
	...
	public OCEAN_BODY_OF_WATER(GeoEquals geoEquals) {
	...
	public OCEAN_BODY_OF_WATER(GeoIntersects geoIntersects) {
	...
	public OCEAN_BODY_OF_WATER(GeoOverlaps geoOverlaps) {
	...
	public OCEAN_BODY_OF_WATER(GeoTouches geoTouches) {
	...
	public OCEAN_BODY_OF_WATER(GeoWithin geoWithin) {
	...
	public OCEAN_BODY_OF_WATER(Slogan slogan) {
		setSlogan(slogan);
	}
