...
public class CHILD_MIN_AGE implements Container.ChildMinAge {
	...
	public CHILD_MIN_AGE(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public CHILD_MIN_AGE(Float fl0at) {
	...
	public CHILD_MIN_AGE(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public CHILD_MIN_AGE(Integer integer) {
	...
	public CHILD_MIN_AGE(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public CHILD_MIN_AGE(Number number) {
	...
	public CHILD_MIN_AGE(List<Float> fl0atList,
	...
	public void copy(Container.ChildMinAge org) {
