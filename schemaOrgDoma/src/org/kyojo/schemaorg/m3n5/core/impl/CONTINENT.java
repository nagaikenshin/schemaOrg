...
public class CONTINENT implements Clazz.Continent {
	...
	public CONTINENT(GeoContains geoContains) {
	...
	public CONTINENT(GeoCoveredBy geoCoveredBy) {
	...
	public CONTINENT(GeoCovers geoCovers) {
	...
	public CONTINENT(GeoCrosses geoCrosses) {
	...
	public CONTINENT(GeoDisjoint geoDisjoint) {
	...
	public CONTINENT(GeoEquals geoEquals) {
	...
	public CONTINENT(GeoIntersects geoIntersects) {
	...
	public CONTINENT(GeoOverlaps geoOverlaps) {
	...
	public CONTINENT(GeoTouches geoTouches) {
	...
	public CONTINENT(GeoWithin geoWithin) {
	...
	public CONTINENT(Slogan slogan) {
		setSlogan(slogan);
	}
