...
public class TELEVISION_STATION implements Clazz.TelevisionStation {
	...
	public TELEVISION_STATION(GeoContains geoContains) {
	...
	public TELEVISION_STATION(GeoCoveredBy geoCoveredBy) {
	...
	public TELEVISION_STATION(GeoCovers geoCovers) {
	...
	public TELEVISION_STATION(GeoCrosses geoCrosses) {
	...
	public TELEVISION_STATION(GeoDisjoint geoDisjoint) {
	...
	public TELEVISION_STATION(GeoEquals geoEquals) {
	...
	public TELEVISION_STATION(GeoIntersects geoIntersects) {
	...
	public TELEVISION_STATION(GeoOverlaps geoOverlaps) {
	...
	public TELEVISION_STATION(GeoTouches geoTouches) {
	...
	public TELEVISION_STATION(GeoWithin geoWithin) {
	...
	public TELEVISION_STATION(Slogan slogan) {
		setSlogan(slogan);
	}
