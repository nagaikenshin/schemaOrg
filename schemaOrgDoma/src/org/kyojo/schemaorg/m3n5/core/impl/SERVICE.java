...
public class SERVICE implements Clazz.Service {
	...
	public SERVICE(AdditionalType additionalType) {
	...
	public SERVICE(AggregateRating aggregateRating) {
	...
	public SERVICE(AlternateName alternateName) {
	...
	public SERVICE(AreaServed areaServed) {
	...
	public SERVICE(Audience audience) {
	...
	public SERVICE(AvailableChannel availableChannel) {
	...
	public SERVICE(Description description) {
	...
	public SERVICE(DisambiguatingDescription disambiguatingDescription) {
	...
	public SERVICE(HasOfferCatalog hasOfferCatalog) {
	...
	public SERVICE(HoursAvailable hoursAvailable) {
	...
	public SERVICE(IsRelatedTo isRelatedTo) {
	...
	public SERVICE(IsSimilarTo isSimilarTo) {
	...
	public SERVICE(MainEntityOfPage mainEntityOfPage) {
	...
	public SERVICE(NameFuzzy nameFuzzy) {
	...
	public SERVICE(NameRuby nameRuby) {
	...
	public SERVICE(PotentialAction potentialAction) {
	...
	public SERVICE(ProviderMobility providerMobility) {
	...
	public SERVICE(ServiceOutput serviceOutput) {
	...
	public SERVICE(SubjectOf subjectOf) {
	...
	public SERVICE(TermsOfService termsOfService) {
	...
	public void copy(Clazz.Service org) {
		setSeq(org.getSeq());
