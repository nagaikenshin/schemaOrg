...
public class ACTIVATE_ACTION implements Clazz.ActivateAction {
	...
	public ACTIVATE_ACTION() {
	}

	public ACTIVATE_ACTION(Long seq) {
		setSeq(seq);
	}

	public ACTIVATE_ACTION(String string) {
	...
	public ACTIVATE_ACTION(ActionStatus actionStatus) {
	...
	public ACTIVATE_ACTION(AdditionalType additionalType) {
	...
	public ACTIVATE_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public ACTIVATE_ACTION(AlternateName alternateName) {
	...
	public ACTIVATE_ACTION(Description description) {
	...
	public ACTIVATE_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public ACTIVATE_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public ACTIVATE_ACTION(Error error) {
		setError(error);
	}
	...
	public ACTIVATE_ACTION(Identifier identifier) {
	...
	public ACTIVATE_ACTION(Image image) {
		setImage(image);
	}
	...
	public ACTIVATE_ACTION(Instrument instrument) {
	...
	public ACTIVATE_ACTION(Location location) {
	...
	public ACTIVATE_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public ACTIVATE_ACTION(Name name) {
		setName(name);
	}
	...
	public ACTIVATE_ACTION(NameFuzzy nameFuzzy) {
	...
	public ACTIVATE_ACTION(NameRuby nameRuby) {
	...
	public ACTIVATE_ACTION(Object object) {
		setObject(object);
	}
	...
	public ACTIVATE_ACTION(Participant participant) {
	...
	public ACTIVATE_ACTION(PotentialAction potentialAction) {
	...
	public ACTIVATE_ACTION(Result result) {
		setResult(result);
	}
	...
	public ACTIVATE_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ACTIVATE_ACTION(StartTime startTime) {
	...
	public ACTIVATE_ACTION(SubjectOf subjectOf) {
	...
	public ACTIVATE_ACTION(Target target) {
		setTarget(target);
	}
	...
	public ACTIVATE_ACTION(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.ActivateAction org) {
		setSeq(org.getSeq());
