...
public class TV_SERIES implements Clazz.TVSeries {
	...
	public TV_SERIES(Long seq) {
		setSeq(seq);
	}

	public TV_SERIES(String string) {
	...
	public TV_SERIES(AccessMode accessMode) {
	...
	public TV_SERIES(AccessModeSufficient accessModeSufficient) {
	...
	public TV_SERIES(AccessibilityAPI accessibilityAPI) {
	...
	public TV_SERIES(AccessibilityControl accessibilityControl) {
	...
	public TV_SERIES(AccessibilityFeature accessibilityFeature) {
	...
	public TV_SERIES(AccessibilityHazard accessibilityHazard) {
	...
	public TV_SERIES(AccessibilitySummary accessibilitySummary) {
	...
	public TV_SERIES(AccountablePerson accountablePerson) {
	...
	public TV_SERIES(AdditionalType additionalType) {
	...
	public TV_SERIES(AggregateRating aggregateRating) {
	...
	public TV_SERIES(AlternateName alternateName) {
	...
	public TV_SERIES(AlternativeHeadline alternativeHeadline) {
	...
	public TV_SERIES(AssociatedMedia associatedMedia) {
	...
	public TV_SERIES(Audience audience) {
	...
	public TV_SERIES(Author author) {
		setAuthor(author);
	}
	...
	public TV_SERIES(Character character) {
	...
	public TV_SERIES(Citation citation) {
	...
	public TV_SERIES(Comment comment) {
		setComment(comment);
	}
	...
	public TV_SERIES(CommentCount commentCount) {
	...
	public TV_SERIES(ContainsSeason containsSeason) {
	...
	public TV_SERIES(ContentLocation contentLocation) {
	...
	public TV_SERIES(ContentRating contentRating) {
	...
	public TV_SERIES(ContentReferenceTime contentReferenceTime) {
	...
	public TV_SERIES(Contributor contributor) {
	...
	public TV_SERIES(CopyrightHolder copyrightHolder) {
	...
	public TV_SERIES(CopyrightYear copyrightYear) {
	...
	public TV_SERIES(Correction correction) {
	...
	public TV_SERIES(CountryOfOrigin countryOfOrigin) {
	...
	public TV_SERIES(Creator creator) {
		setCreator(creator);
	}
	...
	public TV_SERIES(DateCreated dateCreated) {
	...
	public TV_SERIES(DateModified dateModified) {
	...
	public TV_SERIES(DatePublished datePublished) {
	...
	public TV_SERIES(Description description) {
	...
	public TV_SERIES(Director director) {
	...
	public TV_SERIES(DisambiguatingDescription disambiguatingDescription) {
	...
	public TV_SERIES(DiscussionUrl discussionUrl) {
	...
	public TV_SERIES(Editor editor) {
		setEditor(editor);
	}
	...
	public TV_SERIES(EducationalAlignment educationalAlignment) {
	...
	public TV_SERIES(EducationalUse educationalUse) {
	...
	public TV_SERIES(Encoding encoding) {
	...
	public TV_SERIES(EncodingFormat encodingFormat) {
	...
	public TV_SERIES(EndDate endDate) {
		setEndDate(endDate);
	}
	...
	public TV_SERIES(Episode episode) {
		setEpisode(episode);
	}
	...
	public TV_SERIES(ExampleOfWork exampleOfWork) {
	...
	public TV_SERIES(Expires expires) {
		setExpires(expires);
	}
	...
	public TV_SERIES(Funder funder) {
		setFunder(funder);
	}
	...
	public TV_SERIES(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public TV_SERIES(Headline headline) {
	...
	public TV_SERIES(Identifier identifier) {
	...
	public TV_SERIES(InLanguage inLanguage) {
	...
	public TV_SERIES(InteractionStatistic interactionStatistic) {
	...
	public TV_SERIES(InteractivityType interactivityType) {
	...
	public TV_SERIES(IsAccessibleForFree isAccessibleForFree) {
	...
	public TV_SERIES(IsBasedOn isBasedOn) {
	...
	public TV_SERIES(IsFamilyFriendly isFamilyFriendly) {
	...
	public TV_SERIES(IsPartOf isPartOf) {
	...
	public TV_SERIES(Keywords keywords) {
	...
	public TV_SERIES(LearningResourceType learningResourceType) {
	...
	public TV_SERIES(License license) {
		setLicense(license);
	}
	...
	public TV_SERIES(LocationCreated locationCreated) {
	...
	public TV_SERIES(MainEntity mainEntity) {
	...
	public TV_SERIES(MainEntityOfPage mainEntityOfPage) {
	...
	public TV_SERIES(Material material) {
	...
	public TV_SERIES(MaterialExtent materialExtent) {
	...
	public TV_SERIES(Mentions mentions) {
	...
	public TV_SERIES(MusicBy musicBy) {
		setMusicBy(musicBy);
	}
	...
	public TV_SERIES(NameFuzzy nameFuzzy) {
	...
	public TV_SERIES(NameRuby nameRuby) {
	...
	public TV_SERIES(NumberOfEpisodes numberOfEpisodes) {
	...
	public TV_SERIES(NumberOfSeasons numberOfSeasons) {
	...
	public TV_SERIES(Offers offers) {
		setOffers(offers);
	}
	...
	public TV_SERIES(Position position) {
	...
	public TV_SERIES(PotentialAction potentialAction) {
	...
	public TV_SERIES(Producer producer) {
	...
	public TV_SERIES(ProductionCompany productionCompany) {
	...
	public TV_SERIES(Provider provider) {
	...
	public TV_SERIES(Publication publication) {
	...
	public TV_SERIES(Publisher publisher) {
	...
	public TV_SERIES(PublisherImprint publisherImprint) {
	...
	public TV_SERIES(PublishingPrinciples publishingPrinciples) {
	...
	public TV_SERIES(RecordedAt recordedAt) {
	...
	public TV_SERIES(ReleasedEvent releasedEvent) {
	...
	public TV_SERIES(Review review) {
		setReview(review);
	}
	...
	public TV_SERIES(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TV_SERIES(SchemaVersion schemaVersion) {
	...
	public TV_SERIES(SdDatePublished sdDatePublished) {
	...
	public TV_SERIES(SdLicense sdLicense) {
	...
	public TV_SERIES(SdPublisher sdPublisher) {
	...
	public TV_SERIES(SourceOrganization sourceOrganization) {
	...
	public TV_SERIES(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public TV_SERIES(SpatialCoverage spatialCoverage) {
	...
	public TV_SERIES(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public TV_SERIES(StartDate startDate) {
	...
	public TV_SERIES(SubjectOf subjectOf) {
	...
	public TV_SERIES(Temporal temporal) {
	...
	public TV_SERIES(TemporalCoverage temporalCoverage) {
	...
	public TV_SERIES(ThumbnailUrl thumbnailUrl) {
	...
	public TV_SERIES(TimeRequired timeRequired) {
	...
	public TV_SERIES(Trailer trailer) {
		setTrailer(trailer);
	}
	...
	public TV_SERIES(TranslationOfWork translationOfWork) {
	...
	public TV_SERIES(Translator translator) {
	...
	public TV_SERIES(TypicalAgeRange typicalAgeRange) {
	...
	public TV_SERIES(Version version) {
		setVersion(version);
	}
	...
	public TV_SERIES(WorkExample workExample) {
	...
	public TV_SERIES(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.TVSeries org) {
		setSeq(org.getSeq());
