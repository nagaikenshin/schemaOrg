...
public class ISSN implements Container.Issn {
	...
	public ISSN(LocationFeatureSpecification locationFeatureSpecification) {
	...
	public ISSN(PropertyValue propertyValue) {
	...
	public ISSN(String string) {
		this(new TEXT(string));
	}

	public ISSN(Text text) {
	...
	public ISSN(List<LocationFeatureSpecification> locationFeatureSpecificationList,
	...
	public void copy(Container.Issn org) {
