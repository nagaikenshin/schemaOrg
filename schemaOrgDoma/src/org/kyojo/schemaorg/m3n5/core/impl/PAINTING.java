...
public class PAINTING implements Clazz.Painting {
	...
	public PAINTING(Correction correction) {
	...
	public PAINTING(EncodingFormat encodingFormat) {
	...
	public PAINTING(MaterialExtent materialExtent) {
	...
	public PAINTING(SdDatePublished sdDatePublished) {
	...
	public PAINTING(SdLicense sdLicense) {
	...
	public PAINTING(SdPublisher sdPublisher) {
	...
	public PAINTING(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public PAINTING(SubjectOf subjectOf) {
	...
	public PAINTING(Temporal temporal) {
