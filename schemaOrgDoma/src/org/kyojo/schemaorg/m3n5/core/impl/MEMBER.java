...
public class MEMBER implements Container.Member {
	...
	public MEMBER(AccountingService accountingService) {
	...
	public MEMBER(AdultEntertainment adultEntertainment) {
	...
	public MEMBER(AmusementPark amusementPark) {
	...
	public MEMBER(AnimalShelter animalShelter) {
	...
	public MEMBER(ArchiveOrganization archiveOrganization) {
	...
	public MEMBER(ArtGallery artGallery) {
	...
	public MEMBER(Attorney attorney) {
	...
	public MEMBER(AutoBodyShop autoBodyShop) {
	...
	public MEMBER(AutoDealer autoDealer) {
	...
	public MEMBER(AutoPartsStore autoPartsStore) {
	...
	public MEMBER(AutoRental autoRental) {
	...
	public MEMBER(AutoRepair autoRepair) {
	...
	public MEMBER(AutoWash autoWash) {
	...
	public MEMBER(AutomatedTeller automatedTeller) {
	...
	public MEMBER(AutomotiveBusiness automotiveBusiness) {
	...
	public MEMBER(BankOrCreditUnion bankOrCreditUnion) {
	...
	public MEMBER(BarOrPub barOrPub) {
	...
	public MEMBER(BeautySalon beautySalon) {
	...
	public MEMBER(BedAndBreakfast bedAndBreakfast) {
	...
	public MEMBER(BikeStore bikeStore) {
	...
	public MEMBER(BookStore bookStore) {
	...
	public MEMBER(BowlingAlley bowlingAlley) {
	...
	public MEMBER(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public MEMBER(Campground campground) {
	...
	public MEMBER(ChildCare childCare) {
	...
	public MEMBER(ClothingStore clothingStore) {
	...
	public MEMBER(CollegeOrUniversity collegeOrUniversity) {
	...
	public MEMBER(ComedyClub comedyClub) {
	...
	public MEMBER(CommunityHealth communityHealth) {
	...
	public MEMBER(ComputerStore computerStore) {
	...
	public MEMBER(Consortium consortium) {
	...
	public MEMBER(ConvenienceStore convenienceStore) {
	...
	public MEMBER(Corporation corporation) {
	...
	public MEMBER(DanceGroup danceGroup) {
	...
	public MEMBER(DepartmentStore departmentStore) {
	...
	public MEMBER(Dermatology dermatology) {
	...
	public MEMBER(DiagnosticLab diagnosticLab) {
	...
	public MEMBER(DietNutrition dietNutrition) {
	...
	public MEMBER(Distillery distillery) {
	...
	public MEMBER(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public MEMBER(EducationalOrganization educationalOrganization) {
	...
	public MEMBER(Electrician electrician) {
	...
	public MEMBER(ElectronicsStore electronicsStore) {
	...
	public MEMBER(ElementarySchool elementarySchool) {
	...
	public MEMBER(Emergency emergency) {
	...
	public MEMBER(EmergencyService emergencyService) {
	...
	public MEMBER(EmploymentAgency employmentAgency) {
	...
	public MEMBER(EntertainmentBusiness entertainmentBusiness) {
	...
	public MEMBER(ExerciseGym exerciseGym) {
	...
	public MEMBER(FastFoodRestaurant fastFoodRestaurant) {
	...
	public MEMBER(FinancialService financialService) {
	...
	public MEMBER(FireStation fireStation) {
	...
	public MEMBER(FoodEstablishment foodEstablishment) {
	...
	public MEMBER(FundingAgency fundingAgency) {
	...
	public MEMBER(FundingScheme fundingScheme) {
	...
	public MEMBER(FurnitureStore furnitureStore) {
	...
	public MEMBER(GardenStore gardenStore) {
	...
	public MEMBER(GasStation gasStation) {
	...
	public MEMBER(GeneralContractor generalContractor) {
	...
	public MEMBER(Geriatric geriatric) {
	...
	public MEMBER(GolfCourse golfCourse) {
	...
	public MEMBER(GovernmentOffice governmentOffice) {
	...
	public MEMBER(GovernmentOrganization governmentOrganization) {
	...
	public MEMBER(GroceryStore groceryStore) {
	...
	public MEMBER(Gynecologic gynecologic) {
	...
	public MEMBER(HVACBusiness hvacBusiness) {
	...
	public MEMBER(HairSalon hairSalon) {
	...
	public MEMBER(HardwareStore hardwareStore) {
	...
	public MEMBER(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public MEMBER(HealthClub healthClub) {
	...
	public MEMBER(HighSchool highSchool) {
	...
	public MEMBER(HobbyShop hobbyShop) {
	...
	public MEMBER(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public MEMBER(HomeGoodsStore homeGoodsStore) {
	...
	public MEMBER(Hospital hospital) {
	...
	public MEMBER(HousePainter housePainter) {
	...
	public MEMBER(IceCreamShop iceCreamShop) {
	...
	public MEMBER(InsuranceAgency insuranceAgency) {
	...
	public MEMBER(InternetCafe internetCafe) {
	...
	public MEMBER(JewelryStore jewelryStore) {
	...
	public MEMBER(LegalService legalService) {
	...
	public MEMBER(LibrarySystem librarySystem) {
	...
	public MEMBER(LiquorStore liquorStore) {
	...
	public MEMBER(LocalBusiness localBusiness) {
	...
	public MEMBER(Locksmith locksmith) {
	...
	public MEMBER(LodgingBusiness lodgingBusiness) {
	...
	public MEMBER(MedicalBusiness medicalBusiness) {
	...
	public MEMBER(MedicalClinic medicalClinic) {
	...
	public MEMBER(MedicalOrganization medicalOrganization) {
	...
	public MEMBER(MensClothingStore mensClothingStore) {
	...
	public MEMBER(MiddleSchool middleSchool) {
	...
	public MEMBER(Midwifery midwifery) {
	...
	public MEMBER(MobilePhoneStore mobilePhoneStore) {
	...
	public MEMBER(MotorcycleDealer motorcycleDealer) {
	...
	public MEMBER(MotorcycleRepair motorcycleRepair) {
	...
	public MEMBER(MovieRentalStore movieRentalStore) {
	...
	public MEMBER(MovieTheater movieTheater) {
	...
	public MEMBER(MovingCompany movingCompany) {
	...
	public MEMBER(MusicGroup musicGroup) {
	...
	public MEMBER(MusicStore musicStore) {
	...
	public MEMBER(NailSalon nailSalon) {
	...
	public MEMBER(NewsMediaOrganization newsMediaOrganization) {
	...
	public MEMBER(NightClub nightClub) {
	...
	public MEMBER(Obstetric obstetric) {
	...
	public MEMBER(OfficeEquipmentStore officeEquipmentStore) {
	...
	public MEMBER(Oncologic oncologic) {
	...
	public MEMBER(Optician optician) {
	...
	public MEMBER(Optometric optometric) {
	...
	public MEMBER(Otolaryngologic otolaryngologic) {
	...
	public MEMBER(OutletStore outletStore) {
	...
	public MEMBER(PawnShop pawnShop) {
	...
	public MEMBER(Pediatric pediatric) {
	...
	public MEMBER(PerformingGroup performingGroup) {
	...
	public MEMBER(PetStore petStore) {
	...
	public MEMBER(Pharmacy pharmacy) {
	...
	public MEMBER(Physician physician) {
	...
	public MEMBER(Physiotherapy physiotherapy) {
	...
	public MEMBER(PlasticSurgery plasticSurgery) {
	...
	public MEMBER(Podiatric podiatric) {
	...
	public MEMBER(PoliceStation policeStation) {
	...
	public MEMBER(PostOffice postOffice) {
	...
	public MEMBER(Preschool preschool) {
	...
	public MEMBER(PrimaryCare primaryCare) {
	...
	public MEMBER(ProfessionalService professionalService) {
	...
	public MEMBER(Psychiatric psychiatric) {
	...
	public MEMBER(PublicHealth publicHealth) {
	...
	public MEMBER(PublicSwimmingPool publicSwimmingPool) {
	...
	public MEMBER(RadioStation radioStation) {
	...
	public MEMBER(RealEstateAgent realEstateAgent) {
	...
	public MEMBER(RecyclingCenter recyclingCenter) {
	...
	public MEMBER(ResearchProject researchProject) {
	...
	public MEMBER(Restaurant restaurant) {
	...
	public MEMBER(RoofingContractor roofingContractor) {
	...
	public MEMBER(SelfStorage selfStorage) {
	...
	public MEMBER(ShoeStore shoeStore) {
	...
	public MEMBER(ShoppingCenter shoppingCenter) {
	...
	public MEMBER(SkiResort skiResort) {
	...
	public MEMBER(SportingGoodsStore sportingGoodsStore) {
	...
	public MEMBER(SportsActivityLocation sportsActivityLocation) {
	...
	public MEMBER(SportsClub sportsClub) {
	...
	public MEMBER(SportsOrganization sportsOrganization) {
	...
	public MEMBER(SportsTeam sportsTeam) {
	...
	public MEMBER(StadiumOrArena stadiumOrArena) {
	...
	public MEMBER(TattooParlor tattooParlor) {
	...
	public MEMBER(TelevisionStation televisionStation) {
	...
	public MEMBER(TennisComplex tennisComplex) {
	...
	public MEMBER(TheaterGroup theaterGroup) {
	...
	public MEMBER(TireShop tireShop) {
	...
	public MEMBER(TouristInformationCenter touristInformationCenter) {
	...
	public MEMBER(ToyStore toyStore) {
	...
	public MEMBER(TravelAgency travelAgency) {
	...
	public MEMBER(VeterinaryCare veterinaryCare) {
	...
	public MEMBER(WholesaleStore wholesaleStore) {
	...
	public MEMBER(WorkersUnion workersUnion) {
	...
	public void copy(Container.Member org) {
