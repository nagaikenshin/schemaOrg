...
public class CHURCH implements Clazz.Church {
	...
	public CHURCH(GeoContains geoContains) {
	...
	public CHURCH(GeoCoveredBy geoCoveredBy) {
	...
	public CHURCH(GeoCovers geoCovers) {
	...
	public CHURCH(GeoCrosses geoCrosses) {
	...
	public CHURCH(GeoDisjoint geoDisjoint) {
	...
	public CHURCH(GeoEquals geoEquals) {
	...
	public CHURCH(GeoIntersects geoIntersects) {
	...
	public CHURCH(GeoOverlaps geoOverlaps) {
	...
	public CHURCH(GeoTouches geoTouches) {
	...
	public CHURCH(GeoWithin geoWithin) {
