...
public class CORPORATION implements Clazz.Corporation {
	...
	public CORPORATION(Long seq) {
		setSeq(seq);
	}

	public CORPORATION(String string) {
	...
	public CORPORATION(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public CORPORATION(AdditionalType additionalType) {
	...
	public CORPORATION(Address address) {
		setAddress(address);
	}
	...
	public CORPORATION(AggregateRating aggregateRating) {
	...
	public CORPORATION(AlternateName alternateName) {
	...
	public CORPORATION(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public CORPORATION(AreaServed areaServed) {
	...
	public CORPORATION(Award award) {
		setAward(award);
	}
	...
	public CORPORATION(Brand brand) {
		setBrand(brand);
	}
	...
	public CORPORATION(ContactPoint contactPoint) {
	...
	public CORPORATION(CorrectionsPolicy correctionsPolicy) {
	...
	public CORPORATION(Department department) {
	...
	public CORPORATION(Description description) {
	...
	public CORPORATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public CORPORATION(DissolutionDate dissolutionDate) {
	...
	public CORPORATION(DiversityPolicy diversityPolicy) {
	...
	public CORPORATION(DiversityStaffingReport diversityStaffingReport) {
	...
	public CORPORATION(Email email) {
		setEmail(email);
	}
	...
	public CORPORATION(Employee employee) {
	...
	public CORPORATION(EthicsPolicy ethicsPolicy) {
	...
	public CORPORATION(Event event) {
		setEvent(event);
	}
	...
	public CORPORATION(FaxNumber faxNumber) {
	...
	public CORPORATION(Founder founder) {
		setFounder(founder);
	}
	...
	public CORPORATION(FoundingDate foundingDate) {
	...
	public CORPORATION(FoundingLocation foundingLocation) {
	...
	public CORPORATION(Funder funder) {
		setFunder(funder);
	}
	...
	public CORPORATION(GlobalLocationNumber globalLocationNumber) {
	...
	public CORPORATION(HasOfferCatalog hasOfferCatalog) {
	...
	public CORPORATION(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public CORPORATION(Identifier identifier) {
	...
	public CORPORATION(Image image) {
		setImage(image);
	}
	...
	public CORPORATION(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public CORPORATION(KnowsAbout knowsAbout) {
	...
	public CORPORATION(KnowsLanguage knowsLanguage) {
	...
	public CORPORATION(LegalName legalName) {
	...
	public CORPORATION(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public CORPORATION(Location location) {
	...
	public CORPORATION(MainEntityOfPage mainEntityOfPage) {
	...
	public CORPORATION(MakesOffer makesOffer) {
	...
	public CORPORATION(Member member) {
		setMember(member);
	}
	...
	public CORPORATION(MemberOf memberOf) {
	...
	public CORPORATION(Naics naics) {
		setNaics(naics);
	}
	...
	public CORPORATION(NameFuzzy nameFuzzy) {
	...
	public CORPORATION(NameRuby nameRuby) {
	...
	public CORPORATION(NumberOfEmployees numberOfEmployees) {
	...
	public CORPORATION(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public CORPORATION(ParentOrganization parentOrganization) {
	...
	public CORPORATION(PotentialAction potentialAction) {
	...
	public CORPORATION(PublishingPrinciples publishingPrinciples) {
	...
	public CORPORATION(Review review) {
		setReview(review);
	}
	...
	public CORPORATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CORPORATION(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public CORPORATION(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public CORPORATION(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public CORPORATION(SubOrganization subOrganization) {
	...
	public CORPORATION(SubjectOf subjectOf) {
	...
	public CORPORATION(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public CORPORATION(Telephone telephone) {
	...
	public CORPORATION(TickerSymbol tickerSymbol) {
	...
	public CORPORATION(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public CORPORATION(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.Corporation org) {
		setSeq(org.getSeq());
		...
		setTickerSymbol(org.getTickerSymbol());
