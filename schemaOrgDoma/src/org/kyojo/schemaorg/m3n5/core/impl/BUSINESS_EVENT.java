...
public class BUSINESS_EVENT implements Clazz.BusinessEvent {
	...
	public BUSINESS_EVENT(Long seq) {
		setSeq(seq);
	}

	public BUSINESS_EVENT(String string) {
	...
	public BUSINESS_EVENT(About about) {
		setAbout(about);
	}
	...
	public BUSINESS_EVENT(Actor actor) {
		setActor(actor);
	}
	...
	public BUSINESS_EVENT(AdditionalType additionalType) {
	...
	public BUSINESS_EVENT(AggregateRating aggregateRating) {
	...
	public BUSINESS_EVENT(AlternateName alternateName) {
	...
	public BUSINESS_EVENT(Attendee attendee) {
	...
	public BUSINESS_EVENT(Audience audience) {
	...
	public BUSINESS_EVENT(Composer composer) {
	...
	public BUSINESS_EVENT(Contributor contributor) {
	...
	public BUSINESS_EVENT(Description description) {
	...
	public BUSINESS_EVENT(Director director) {
	...
	public BUSINESS_EVENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public BUSINESS_EVENT(DoorTime doorTime) {
	...
	public BUSINESS_EVENT(Duration duration) {
	...
	public BUSINESS_EVENT(EndDate endDate) {
		setEndDate(endDate);
	}
	...
	public BUSINESS_EVENT(EventStatus eventStatus) {
	...
	public BUSINESS_EVENT(Funder funder) {
		setFunder(funder);
	}
	...
	public BUSINESS_EVENT(Identifier identifier) {
	...
	public BUSINESS_EVENT(Image image) {
		setImage(image);
	}
	...
	public BUSINESS_EVENT(InLanguage inLanguage) {
	...
	public BUSINESS_EVENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public BUSINESS_EVENT(Location location) {
	...
	public BUSINESS_EVENT(MainEntityOfPage mainEntityOfPage) {
	...
	public BUSINESS_EVENT(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public BUSINESS_EVENT(Name name) {
		setName(name);
	}
	...
	public BUSINESS_EVENT(NameFuzzy nameFuzzy) {
	...
	public BUSINESS_EVENT(NameRuby nameRuby) {
	...
	public BUSINESS_EVENT(Offers offers) {
		setOffers(offers);
	}
	...
	public BUSINESS_EVENT(Organizer organizer) {
	...
	public BUSINESS_EVENT(Performer performer) {
	...
	public BUSINESS_EVENT(PotentialAction potentialAction) {
	...
	public BUSINESS_EVENT(PreviousStartDate previousStartDate) {
	...
	public BUSINESS_EVENT(RecordedIn recordedIn) {
	...
	public BUSINESS_EVENT(RemainingAttendeeCapacity remainingAttendeeCapacity) {
	...
	public BUSINESS_EVENT(Review review) {
		setReview(review);
	}
	...
	public BUSINESS_EVENT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public BUSINESS_EVENT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public BUSINESS_EVENT(StartDate startDate) {
	...
	public BUSINESS_EVENT(SubEvent subEvent) {
	...
	public BUSINESS_EVENT(SubjectOf subjectOf) {
	...
	public BUSINESS_EVENT(SuperEvent superEvent) {
	...
	public BUSINESS_EVENT(Translator translator) {
	...
	public BUSINESS_EVENT(TypicalAgeRange typicalAgeRange) {
	...
	public BUSINESS_EVENT(WorkFeatured workFeatured) {
	...
	public BUSINESS_EVENT(WorkPerformed workPerformed) {
	...
	public void copy(Clazz.BusinessEvent org) {
		setSeq(org.getSeq());
