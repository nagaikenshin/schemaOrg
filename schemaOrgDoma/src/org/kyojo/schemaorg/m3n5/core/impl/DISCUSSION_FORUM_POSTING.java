...
public class DISCUSSION_FORUM_POSTING implements Clazz.DiscussionForumPosting {
	...
	public DISCUSSION_FORUM_POSTING() {
	}

	public DISCUSSION_FORUM_POSTING(Long seq) {
		setSeq(seq);
	}

	public DISCUSSION_FORUM_POSTING(String string) {
	...
	public DISCUSSION_FORUM_POSTING(About about) {
		setAbout(about);
	}
	...
	public DISCUSSION_FORUM_POSTING(AccessMode accessMode) {
	...
	public DISCUSSION_FORUM_POSTING(AccessModeSufficient accessModeSufficient) {
	...
	public DISCUSSION_FORUM_POSTING(AccessibilityAPI accessibilityAPI) {
	...
	public DISCUSSION_FORUM_POSTING(AccessibilityControl accessibilityControl) {
	...
	public DISCUSSION_FORUM_POSTING(AccessibilityFeature accessibilityFeature) {
	...
	public DISCUSSION_FORUM_POSTING(AccessibilityHazard accessibilityHazard) {
	...
	public DISCUSSION_FORUM_POSTING(AccessibilitySummary accessibilitySummary) {
	...
	public DISCUSSION_FORUM_POSTING(AccountablePerson accountablePerson) {
	...
	public DISCUSSION_FORUM_POSTING(AdditionalType additionalType) {
	...
	public DISCUSSION_FORUM_POSTING(AggregateRating aggregateRating) {
	...
	public DISCUSSION_FORUM_POSTING(AlternateName alternateName) {
	...
	public DISCUSSION_FORUM_POSTING(AlternativeHeadline alternativeHeadline) {
	...
	public DISCUSSION_FORUM_POSTING(ArticleBody articleBody) {
	...
	public DISCUSSION_FORUM_POSTING(ArticleSection articleSection) {
	...
	public DISCUSSION_FORUM_POSTING(AssociatedMedia associatedMedia) {
	...
	public DISCUSSION_FORUM_POSTING(Audience audience) {
	...
	public DISCUSSION_FORUM_POSTING(Audio audio) {
		setAudio(audio);
	}
	...
	public DISCUSSION_FORUM_POSTING(Author author) {
		setAuthor(author);
	}
	...
	public DISCUSSION_FORUM_POSTING(Award award) {
		setAward(award);
	}
	...
	public DISCUSSION_FORUM_POSTING(Backstory backstory) {
	...
	public DISCUSSION_FORUM_POSTING(Character character) {
	...
	public DISCUSSION_FORUM_POSTING(Citation citation) {
	...
	public DISCUSSION_FORUM_POSTING(Comment comment) {
		setComment(comment);
	}
	...
	public DISCUSSION_FORUM_POSTING(CommentCount commentCount) {
	...
	public DISCUSSION_FORUM_POSTING(ContentLocation contentLocation) {
	...
	public DISCUSSION_FORUM_POSTING(ContentRating contentRating) {
	...
	public DISCUSSION_FORUM_POSTING(ContentReferenceTime contentReferenceTime) {
	...
	public DISCUSSION_FORUM_POSTING(Contributor contributor) {
	...
	public DISCUSSION_FORUM_POSTING(CopyrightHolder copyrightHolder) {
	...
	public DISCUSSION_FORUM_POSTING(CopyrightYear copyrightYear) {
	...
	public DISCUSSION_FORUM_POSTING(Correction correction) {
	...
	public DISCUSSION_FORUM_POSTING(Creator creator) {
		setCreator(creator);
	}
	...
	public DISCUSSION_FORUM_POSTING(DateCreated dateCreated) {
	...
	public DISCUSSION_FORUM_POSTING(DateModified dateModified) {
	...
	public DISCUSSION_FORUM_POSTING(DatePublished datePublished) {
	...
	public DISCUSSION_FORUM_POSTING(Description description) {
	...
	public DISCUSSION_FORUM_POSTING(DisambiguatingDescription disambiguatingDescription) {
	...
	public DISCUSSION_FORUM_POSTING(DiscussionUrl discussionUrl) {
	...
	public DISCUSSION_FORUM_POSTING(Editor editor) {
		setEditor(editor);
	}
	...
	public DISCUSSION_FORUM_POSTING(EducationalAlignment educationalAlignment) {
	...
	public DISCUSSION_FORUM_POSTING(EducationalUse educationalUse) {
	...
	public DISCUSSION_FORUM_POSTING(Encoding encoding) {
	...
	public DISCUSSION_FORUM_POSTING(EncodingFormat encodingFormat) {
	...
	public DISCUSSION_FORUM_POSTING(ExampleOfWork exampleOfWork) {
	...
	public DISCUSSION_FORUM_POSTING(Expires expires) {
		setExpires(expires);
	}
	...
	public DISCUSSION_FORUM_POSTING(Funder funder) {
		setFunder(funder);
	}
	...
	public DISCUSSION_FORUM_POSTING(Genre genre) {
		setGenre(genre);
	}
	...
	public DISCUSSION_FORUM_POSTING(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public DISCUSSION_FORUM_POSTING(Headline headline) {
	...
	public DISCUSSION_FORUM_POSTING(Identifier identifier) {
	...
	public DISCUSSION_FORUM_POSTING(Image image) {
		setImage(image);
	}
	...
	public DISCUSSION_FORUM_POSTING(InLanguage inLanguage) {
	...
	public DISCUSSION_FORUM_POSTING(InteractionStatistic interactionStatistic) {
	...
	public DISCUSSION_FORUM_POSTING(InteractivityType interactivityType) {
	...
	public DISCUSSION_FORUM_POSTING(IsAccessibleForFree isAccessibleForFree) {
	...
	public DISCUSSION_FORUM_POSTING(IsBasedOn isBasedOn) {
	...
	public DISCUSSION_FORUM_POSTING(IsFamilyFriendly isFamilyFriendly) {
	...
	public DISCUSSION_FORUM_POSTING(IsPartOf isPartOf) {
	...
	public DISCUSSION_FORUM_POSTING(Keywords keywords) {
	...
	public DISCUSSION_FORUM_POSTING(LearningResourceType learningResourceType) {
	...
	public DISCUSSION_FORUM_POSTING(License license) {
		setLicense(license);
	}
	...
	public DISCUSSION_FORUM_POSTING(LocationCreated locationCreated) {
	...
	public DISCUSSION_FORUM_POSTING(MainEntity mainEntity) {
	...
	public DISCUSSION_FORUM_POSTING(MainEntityOfPage mainEntityOfPage) {
	...
	public DISCUSSION_FORUM_POSTING(Material material) {
	...
	public DISCUSSION_FORUM_POSTING(MaterialExtent materialExtent) {
	...
	public DISCUSSION_FORUM_POSTING(Mentions mentions) {
	...
	public DISCUSSION_FORUM_POSTING(Name name) {
		setName(name);
	}
	...
	public DISCUSSION_FORUM_POSTING(NameFuzzy nameFuzzy) {
	...
	public DISCUSSION_FORUM_POSTING(NameRuby nameRuby) {
	...
	public DISCUSSION_FORUM_POSTING(Offers offers) {
		setOffers(offers);
	}
	...
	public DISCUSSION_FORUM_POSTING(PageEnd pageEnd) {
		setPageEnd(pageEnd);
	}
	...
	public DISCUSSION_FORUM_POSTING(PageStart pageStart) {
	...
	public DISCUSSION_FORUM_POSTING(Pagination pagination) {
	...
	public DISCUSSION_FORUM_POSTING(Position position) {
	...
	public DISCUSSION_FORUM_POSTING(PotentialAction potentialAction) {
	...
	public DISCUSSION_FORUM_POSTING(Producer producer) {
	...
	public DISCUSSION_FORUM_POSTING(Provider provider) {
	...
	public DISCUSSION_FORUM_POSTING(Publication publication) {
	...
	public DISCUSSION_FORUM_POSTING(Publisher publisher) {
	...
	public DISCUSSION_FORUM_POSTING(PublisherImprint publisherImprint) {
	...
	public DISCUSSION_FORUM_POSTING(PublishingPrinciples publishingPrinciples) {
	...
	public DISCUSSION_FORUM_POSTING(RecordedAt recordedAt) {
	...
	public DISCUSSION_FORUM_POSTING(ReleasedEvent releasedEvent) {
	...
	public DISCUSSION_FORUM_POSTING(Review review) {
		setReview(review);
	}
	...
	public DISCUSSION_FORUM_POSTING(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DISCUSSION_FORUM_POSTING(SchemaVersion schemaVersion) {
	...
	public DISCUSSION_FORUM_POSTING(SdDatePublished sdDatePublished) {
	...
	public DISCUSSION_FORUM_POSTING(SdLicense sdLicense) {
	...
	public DISCUSSION_FORUM_POSTING(SdPublisher sdPublisher) {
	...
	public DISCUSSION_FORUM_POSTING(SharedContent sharedContent) {
	...
	public DISCUSSION_FORUM_POSTING(SourceOrganization sourceOrganization) {
	...
	public DISCUSSION_FORUM_POSTING(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public DISCUSSION_FORUM_POSTING(SpatialCoverage spatialCoverage) {
	...
	public DISCUSSION_FORUM_POSTING(Speakable speakable) {
	...
	public DISCUSSION_FORUM_POSTING(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public DISCUSSION_FORUM_POSTING(SubjectOf subjectOf) {
	...
	public DISCUSSION_FORUM_POSTING(Temporal temporal) {
	...
	public DISCUSSION_FORUM_POSTING(TemporalCoverage temporalCoverage) {
	...
	public DISCUSSION_FORUM_POSTING(Text text) {
		setText(text);
	}
	...
	public DISCUSSION_FORUM_POSTING(ThumbnailUrl thumbnailUrl) {
	...
	public DISCUSSION_FORUM_POSTING(TimeRequired timeRequired) {
	...
	public DISCUSSION_FORUM_POSTING(TranslationOfWork translationOfWork) {
	...
	public DISCUSSION_FORUM_POSTING(Translator translator) {
	...
	public DISCUSSION_FORUM_POSTING(TypicalAgeRange typicalAgeRange) {
	...
	public DISCUSSION_FORUM_POSTING(Url url) {
		setUrl(url);
	}
	...
	public DISCUSSION_FORUM_POSTING(Version version) {
		setVersion(version);
	}
	...
	public DISCUSSION_FORUM_POSTING(Video video) {
		setVideo(video);
	}
	...
	public DISCUSSION_FORUM_POSTING(WordCount wordCount) {
	...
	public DISCUSSION_FORUM_POSTING(WorkExample workExample) {
	...
	public DISCUSSION_FORUM_POSTING(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.DiscussionForumPosting org) {
		setSeq(org.getSeq());
