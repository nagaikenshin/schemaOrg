...
public class THEATER_GROUP implements Clazz.TheaterGroup {
	...
	public THEATER_GROUP() {
	}

	public THEATER_GROUP(Long seq) {
		setSeq(seq);
	}

	public THEATER_GROUP(String string) {
	...
	public THEATER_GROUP(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public THEATER_GROUP(AdditionalType additionalType) {
	...
	public THEATER_GROUP(Address address) {
		setAddress(address);
	}
	...
	public THEATER_GROUP(AggregateRating aggregateRating) {
	...
	public THEATER_GROUP(AlternateName alternateName) {
	...
	public THEATER_GROUP(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public THEATER_GROUP(AreaServed areaServed) {
	...
	public THEATER_GROUP(Award award) {
		setAward(award);
	}
	...
	public THEATER_GROUP(Brand brand) {
		setBrand(brand);
	}
	...
	public THEATER_GROUP(ContactPoint contactPoint) {
	...
	public THEATER_GROUP(CorrectionsPolicy correctionsPolicy) {
	...
	public THEATER_GROUP(Department department) {
	...
	public THEATER_GROUP(Description description) {
	...
	public THEATER_GROUP(DisambiguatingDescription disambiguatingDescription) {
	...
	public THEATER_GROUP(DissolutionDate dissolutionDate) {
	...
	public THEATER_GROUP(DiversityPolicy diversityPolicy) {
	...
	public THEATER_GROUP(DiversityStaffingReport diversityStaffingReport) {
	...
	public THEATER_GROUP(Duns duns) {
		setDuns(duns);
	}
	...
	public THEATER_GROUP(Email email) {
		setEmail(email);
	}
	...
	public THEATER_GROUP(Employee employee) {
	...
	public THEATER_GROUP(EthicsPolicy ethicsPolicy) {
	...
	public THEATER_GROUP(Event event) {
		setEvent(event);
	}
	...
	public THEATER_GROUP(FaxNumber faxNumber) {
	...
	public THEATER_GROUP(Founder founder) {
		setFounder(founder);
	}
	...
	public THEATER_GROUP(FoundingDate foundingDate) {
	...
	public THEATER_GROUP(FoundingLocation foundingLocation) {
	...
	public THEATER_GROUP(Funder funder) {
		setFunder(funder);
	}
	...
	public THEATER_GROUP(GlobalLocationNumber globalLocationNumber) {
	...
	public THEATER_GROUP(HasOfferCatalog hasOfferCatalog) {
	...
	public THEATER_GROUP(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public THEATER_GROUP(Identifier identifier) {
	...
	public THEATER_GROUP(Image image) {
		setImage(image);
	}
	...
	public THEATER_GROUP(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public THEATER_GROUP(KnowsAbout knowsAbout) {
	...
	public THEATER_GROUP(KnowsLanguage knowsLanguage) {
	...
	public THEATER_GROUP(LegalName legalName) {
	...
	public THEATER_GROUP(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public THEATER_GROUP(Location location) {
	...
	public THEATER_GROUP(Logo logo) {
		setLogo(logo);
	}
	...
	public THEATER_GROUP(MainEntityOfPage mainEntityOfPage) {
	...
	public THEATER_GROUP(MakesOffer makesOffer) {
	...
	public THEATER_GROUP(Member member) {
		setMember(member);
	}
	...
	public THEATER_GROUP(MemberOf memberOf) {
	...
	public THEATER_GROUP(Naics naics) {
		setNaics(naics);
	}
	...
	public THEATER_GROUP(Name name) {
		setName(name);
	}
	...
	public THEATER_GROUP(NameFuzzy nameFuzzy) {
	...
	public THEATER_GROUP(NameRuby nameRuby) {
	...
	public THEATER_GROUP(NumberOfEmployees numberOfEmployees) {
	...
	public THEATER_GROUP(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public THEATER_GROUP(Owns owns) {
		setOwns(owns);
	}
	...
	public THEATER_GROUP(ParentOrganization parentOrganization) {
	...
	public THEATER_GROUP(PotentialAction potentialAction) {
	...
	public THEATER_GROUP(PublishingPrinciples publishingPrinciples) {
	...
	public THEATER_GROUP(Review review) {
		setReview(review);
	}
	...
	public THEATER_GROUP(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public THEATER_GROUP(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public THEATER_GROUP(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public THEATER_GROUP(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public THEATER_GROUP(SubOrganization subOrganization) {
	...
	public THEATER_GROUP(SubjectOf subjectOf) {
	...
	public THEATER_GROUP(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public THEATER_GROUP(Telephone telephone) {
	...
	public THEATER_GROUP(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public THEATER_GROUP(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.TheaterGroup org) {
		setSeq(org.getSeq());
