...
public class HEALTH_CLUB implements Clazz.HealthClub {
	...
	public HEALTH_CLUB(GeoContains geoContains) {
	...
	public HEALTH_CLUB(GeoCoveredBy geoCoveredBy) {
	...
	public HEALTH_CLUB(GeoCovers geoCovers) {
	...
	public HEALTH_CLUB(GeoCrosses geoCrosses) {
	...
	public HEALTH_CLUB(GeoDisjoint geoDisjoint) {
	...
	public HEALTH_CLUB(GeoEquals geoEquals) {
	...
	public HEALTH_CLUB(GeoIntersects geoIntersects) {
	...
	public HEALTH_CLUB(GeoOverlaps geoOverlaps) {
	...
	public HEALTH_CLUB(GeoTouches geoTouches) {
	...
	public HEALTH_CLUB(GeoWithin geoWithin) {
	...
	public HEALTH_CLUB(Slogan slogan) {
		setSlogan(slogan);
	}
