...
import org.kyojo.schemaorg.m3n5.core.Container.HasMenuItem;
...
public class MENU_SECTION implements Clazz.MenuSection {
	...
	public Genre genre;
	public HasMenuItem hasMenuItem;
	public HasMenuSection hasMenuSection;
	...
	public MENU_SECTION(Long seq) {
		setSeq(seq);
	}

	public MENU_SECTION(String string) {
	...
	public MENU_SECTION(About about) {
		setAbout(about);
	}
	...
	public MENU_SECTION(AccessMode accessMode) {
	...
	public MENU_SECTION(AccessModeSufficient accessModeSufficient) {
	...
	public MENU_SECTION(AccessibilityAPI accessibilityAPI) {
	...
	public MENU_SECTION(AccessibilityControl accessibilityControl) {
	...
	public MENU_SECTION(AccessibilityFeature accessibilityFeature) {
	...
	public MENU_SECTION(AccessibilityHazard accessibilityHazard) {
	...
	public MENU_SECTION(AccessibilitySummary accessibilitySummary) {
	...
	public MENU_SECTION(AccountablePerson accountablePerson) {
	...
	public MENU_SECTION(AdditionalType additionalType) {
	...
	public MENU_SECTION(AggregateRating aggregateRating) {
	...
	public MENU_SECTION(AlternateName alternateName) {
	...
	public MENU_SECTION(AlternativeHeadline alternativeHeadline) {
	...
	public MENU_SECTION(AssociatedMedia associatedMedia) {
	...
	public MENU_SECTION(Audience audience) {
	...
	public MENU_SECTION(Audio audio) {
		setAudio(audio);
	}
	...
	public MENU_SECTION(Author author) {
		setAuthor(author);
	}
	...
	public MENU_SECTION(Award award) {
		setAward(award);
	}
	...
	public MENU_SECTION(Character character) {
	...
	public MENU_SECTION(Citation citation) {
	...
	public MENU_SECTION(Comment comment) {
		setComment(comment);
	}
	...
	public MENU_SECTION(CommentCount commentCount) {
	...
	public MENU_SECTION(ContentLocation contentLocation) {
	...
	public MENU_SECTION(ContentRating contentRating) {
	...
	public MENU_SECTION(ContentReferenceTime contentReferenceTime) {
	...
	public MENU_SECTION(Contributor contributor) {
	...
	public MENU_SECTION(CopyrightHolder copyrightHolder) {
	...
	public MENU_SECTION(CopyrightYear copyrightYear) {
	...
	public MENU_SECTION(Correction correction) {
	...
	public MENU_SECTION(Creator creator) {
		setCreator(creator);
	}
	...
	public MENU_SECTION(DateCreated dateCreated) {
	...
	public MENU_SECTION(DateModified dateModified) {
	...
	public MENU_SECTION(DatePublished datePublished) {
	...
	public MENU_SECTION(Description description) {
	...
	public MENU_SECTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public MENU_SECTION(DiscussionUrl discussionUrl) {
	...
	public MENU_SECTION(Editor editor) {
		setEditor(editor);
	}
	...
	public MENU_SECTION(EducationalAlignment educationalAlignment) {
	...
	public MENU_SECTION(EducationalUse educationalUse) {
	...
	public MENU_SECTION(Encoding encoding) {
	...
	public MENU_SECTION(EncodingFormat encodingFormat) {
	...
	public MENU_SECTION(ExampleOfWork exampleOfWork) {
	...
	public MENU_SECTION(Expires expires) {
		setExpires(expires);
	}
	...
	public MENU_SECTION(Funder funder) {
		setFunder(funder);
	}
	...
	public MENU_SECTION(Genre genre) {
		setGenre(genre);
	}
	...
	public MENU_SECTION(HasMenuItem hasMenuItem) {
		setHasMenuItem(hasMenuItem);
	}

	@Override
	public HasMenuItem getHasMenuItem() {
		return hasMenuItem;
	}

	@Override
	public void setHasMenuItem(HasMenuItem hasMenuItem) {
		this.hasMenuItem = hasMenuItem;
	}

	public MENU_SECTION(HasMenuSection hasMenuSection) {
		setHasMenuSection(hasMenuSection);
	}

	@Override
	public HasMenuSection getHasMenuSection() {
		return hasMenuSection;
	}

	@Override
	public void setHasMenuSection(HasMenuSection hasMenuSection) {
		this.hasMenuSection = hasMenuSection;
	}

	public MENU_SECTION(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public MENU_SECTION(Headline headline) {
	...
	public MENU_SECTION(Identifier identifier) {
	...
	public MENU_SECTION(Image image) {
		setImage(image);
	}
	...
	public MENU_SECTION(InLanguage inLanguage) {
	...
	public MENU_SECTION(InteractionStatistic interactionStatistic) {
	...
	public MENU_SECTION(InteractivityType interactivityType) {
	...
	public MENU_SECTION(IsAccessibleForFree isAccessibleForFree) {
	...
	public MENU_SECTION(IsBasedOn isBasedOn) {
	...
	public MENU_SECTION(IsFamilyFriendly isFamilyFriendly) {
	...
	public MENU_SECTION(IsPartOf isPartOf) {
	...
	public MENU_SECTION(Keywords keywords) {
	...
	public MENU_SECTION(LearningResourceType learningResourceType) {
	...
	public MENU_SECTION(License license) {
		setLicense(license);
	}
	...
	public MENU_SECTION(LocationCreated locationCreated) {
	...
	public MENU_SECTION(MainEntity mainEntity) {
	...
	public MENU_SECTION(MainEntityOfPage mainEntityOfPage) {
	...
	public MENU_SECTION(Material material) {
	...
	public MENU_SECTION(MaterialExtent materialExtent) {
	...
	public MENU_SECTION(Mentions mentions) {
	...
	public MENU_SECTION(NameFuzzy nameFuzzy) {
	...
	public MENU_SECTION(NameRuby nameRuby) {
	...
	public MENU_SECTION(Offers offers) {
		setOffers(offers);
	}
	...
	public MENU_SECTION(Position position) {
	...
	public MENU_SECTION(PotentialAction potentialAction) {
	...
	public MENU_SECTION(Producer producer) {
	...
	public MENU_SECTION(Provider provider) {
	...
	public MENU_SECTION(Publication publication) {
	...
	public MENU_SECTION(Publisher publisher) {
	...
	public MENU_SECTION(PublisherImprint publisherImprint) {
	...
	public MENU_SECTION(PublishingPrinciples publishingPrinciples) {
	...
	public MENU_SECTION(RecordedAt recordedAt) {
	...
	public MENU_SECTION(ReleasedEvent releasedEvent) {
	...
	public MENU_SECTION(Review review) {
		setReview(review);
	}
	...
	public MENU_SECTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MENU_SECTION(SchemaVersion schemaVersion) {
	...
	public MENU_SECTION(SdDatePublished sdDatePublished) {
	...
	public MENU_SECTION(SdLicense sdLicense) {
	...
	public MENU_SECTION(SdPublisher sdPublisher) {
	...
	public MENU_SECTION(SourceOrganization sourceOrganization) {
	...
	public MENU_SECTION(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public MENU_SECTION(SpatialCoverage spatialCoverage) {
	...
	public MENU_SECTION(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MENU_SECTION(SubjectOf subjectOf) {
	...
	public MENU_SECTION(Temporal temporal) {
	...
	public MENU_SECTION(TemporalCoverage temporalCoverage) {
	...
	public MENU_SECTION(ThumbnailUrl thumbnailUrl) {
	...
	public MENU_SECTION(TimeRequired timeRequired) {
	...
	public MENU_SECTION(TranslationOfWork translationOfWork) {
	...
	public MENU_SECTION(Translator translator) {
	...
	public MENU_SECTION(TypicalAgeRange typicalAgeRange) {
	...
	public MENU_SECTION(Version version) {
		setVersion(version);
	}
	...
	public MENU_SECTION(Video video) {
		setVideo(video);
	}
	...
	public MENU_SECTION(WorkExample workExample) {
	...
	public MENU_SECTION(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.MenuSection org) {
		setSeq(org.getSeq());
		...
		setHasMenuItem(org.getHasMenuItem());
		setHasMenuSection(org.getHasMenuSection());
