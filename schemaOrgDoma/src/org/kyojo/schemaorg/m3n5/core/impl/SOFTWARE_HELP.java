...
public class SOFTWARE_HELP implements Container.SoftwareHelp {
	...
	public SOFTWARE_HELP(String string) {
	...
	public SOFTWARE_HELP(APIReference apiReference) {
	...
	public SOFTWARE_HELP(AboutPage aboutPage) {
	...
	public SOFTWARE_HELP(AdvertiserContentArticle advertiserContentArticle) {
	...
	public SOFTWARE_HELP(AnalysisNewsArticle analysisNewsArticle) {
	...
	public SOFTWARE_HELP(Answer answer) {
	...
	public SOFTWARE_HELP(ArchiveComponent archiveComponent) {
	...
	public SOFTWARE_HELP(Article article) {
	...
	public SOFTWARE_HELP(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public SOFTWARE_HELP(Atlas atlas) {
	...
	public SOFTWARE_HELP(AudioObject audioObject) {
	...
	public SOFTWARE_HELP(Audiobook audiobook) {
	...
	public SOFTWARE_HELP(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public SOFTWARE_HELP(Barcode barcode) {
	...
	public SOFTWARE_HELP(Blog blog) {
	...
	public SOFTWARE_HELP(BlogPosting blogPosting) {
	...
	public SOFTWARE_HELP(Book book) {
	...
	public SOFTWARE_HELP(BookSeries bookSeries) {
	...
	public SOFTWARE_HELP(CategoryCodeSet categoryCodeSet) {
	...
	public SOFTWARE_HELP(Chapter chapter) {
	...
	public SOFTWARE_HELP(CheckoutPage checkoutPage) {
	...
	public SOFTWARE_HELP(Claim claim) {
	...
	public SOFTWARE_HELP(ClaimReview claimReview) {
	...
	public SOFTWARE_HELP(Clip clip) {
	...
	public SOFTWARE_HELP(Collection collection) {
	...
	public SOFTWARE_HELP(CollectionPage collectionPage) {
	...
	public SOFTWARE_HELP(ComicCoverArt comicCoverArt) {
	...
	public SOFTWARE_HELP(ComicIssue comicIssue) {
	...
	public SOFTWARE_HELP(ComicSeries comicSeries) {
	...
	public SOFTWARE_HELP(ComicStory comicStory) {
	...
	public SOFTWARE_HELP(Comment comment) {
	...
	public SOFTWARE_HELP(CompleteDataFeed completeDataFeed) {
	...
	public SOFTWARE_HELP(ContactPage contactPage) {
	...
	public SOFTWARE_HELP(Conversation conversation) {
	...
	public SOFTWARE_HELP(CorrectionComment correctionComment) {
	...
	public SOFTWARE_HELP(Course course) {
	...
	public SOFTWARE_HELP(CoverArt coverArt) {
	...
	public SOFTWARE_HELP(CreativeWork creativeWork) {
		creativeWorkList = new ArrayList<CreativeWork>();
	...
	public SOFTWARE_HELP(CreativeWorkSeason creativeWorkSeason) {
	...
	public SOFTWARE_HELP(CreativeWorkSeries creativeWorkSeries) {
	...
	public SOFTWARE_HELP(CriticReview criticReview) {
	...
	public SOFTWARE_HELP(DataCatalog dataCatalog) {
	...
	public SOFTWARE_HELP(DataDownload dataDownload) {
	...
	public SOFTWARE_HELP(DataFeed dataFeed) {
	...
	public SOFTWARE_HELP(Dataset dataset) {
	...
	public SOFTWARE_HELP(DefinedTermSet definedTermSet) {
	...
	public SOFTWARE_HELP(Diet diet) {
	...
	public SOFTWARE_HELP(DigitalDocument digitalDocument) {
	...
	public SOFTWARE_HELP(DiscussionForumPosting discussionForumPosting) {
	...
	public SOFTWARE_HELP(Drawing drawing) {
	...
	public SOFTWARE_HELP(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public SOFTWARE_HELP(EmailMessage emailMessage) {
	...
	public SOFTWARE_HELP(EmployerReview employerReview) {
	...
	public SOFTWARE_HELP(Episode episode) {
	...
	public SOFTWARE_HELP(ExercisePlan exercisePlan) {
	...
	public SOFTWARE_HELP(FAQPage faqPage) {
	...
	public SOFTWARE_HELP(Game game) {
	...
	public SOFTWARE_HELP(HowTo howTo) {
	...
	public SOFTWARE_HELP(HowToDirection howToDirection) {
	...
	public SOFTWARE_HELP(HowToSection howToSection) {
	...
	public SOFTWARE_HELP(HowToStep howToStep) {
	...
	public SOFTWARE_HELP(HowToTip howToTip) {
	...
	public SOFTWARE_HELP(ImageGallery imageGallery) {
	...
	public SOFTWARE_HELP(ImageObject imageObject) {
	...
	public SOFTWARE_HELP(ItemPage itemPage) {
	...
	public SOFTWARE_HELP(Legislation legislation) {
	...
	public SOFTWARE_HELP(LegislationObject legislationObject) {
	...
	public SOFTWARE_HELP(LiveBlogPosting liveBlogPosting) {
	...
	public SOFTWARE_HELP(Manuscript manuscript) {
	...
	public SOFTWARE_HELP(MediaObject mediaObject) {
	...
	public SOFTWARE_HELP(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public SOFTWARE_HELP(MedicalWebPage medicalWebPage) {
	...
	public SOFTWARE_HELP(Menu menu) {
	...
	public SOFTWARE_HELP(MenuSection menuSection) {
	...
	public SOFTWARE_HELP(Message message) {
	...
	public SOFTWARE_HELP(MobileApplication mobileApplication) {
	...
	public SOFTWARE_HELP(Movie movie) {
	...
	public SOFTWARE_HELP(MovieClip movieClip) {
	...
	public SOFTWARE_HELP(MovieSeries movieSeries) {
	...
	public SOFTWARE_HELP(MusicAlbum musicAlbum) {
	...
	public SOFTWARE_HELP(MusicComposition musicComposition) {
	...
	public SOFTWARE_HELP(MusicPlaylist musicPlaylist) {
	...
	public SOFTWARE_HELP(MusicRecording musicRecording) {
	...
	public SOFTWARE_HELP(MusicRelease musicRelease) {
	...
	public SOFTWARE_HELP(MusicVideoObject musicVideoObject) {
	...
	public SOFTWARE_HELP(NewsArticle newsArticle) {
	...
	public SOFTWARE_HELP(Newspaper newspaper) {
	...
	public SOFTWARE_HELP(NoteDigitalDocument noteDigitalDocument) {
	...
	public SOFTWARE_HELP(OpinionNewsArticle opinionNewsArticle) {
	...
	public SOFTWARE_HELP(Painting painting) {
	...
	public SOFTWARE_HELP(Periodical periodical) {
	...
	public SOFTWARE_HELP(Photograph photograph) {
	...
	public SOFTWARE_HELP(Play play) {
	...
	public SOFTWARE_HELP(Poster poster) {
	...
	public SOFTWARE_HELP(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public SOFTWARE_HELP(ProfilePage profilePage) {
	...
	public SOFTWARE_HELP(PublicationIssue publicationIssue) {
	...
	public SOFTWARE_HELP(PublicationVolume publicationVolume) {
	...
	public SOFTWARE_HELP(QAPage qaPage) {
	...
	public SOFTWARE_HELP(Question question) {
	...
	public SOFTWARE_HELP(Quotation quotation) {
	...
	public SOFTWARE_HELP(RadioClip radioClip) {
	...
	public SOFTWARE_HELP(RadioEpisode radioEpisode) {
	...
	public SOFTWARE_HELP(RadioSeason radioSeason) {
	...
	public SOFTWARE_HELP(RadioSeries radioSeries) {
	...
	public SOFTWARE_HELP(Recipe recipe) {
	...
	public SOFTWARE_HELP(Report report) {
	...
	public SOFTWARE_HELP(ReportageNewsArticle reportageNewsArticle) {
	...
	public SOFTWARE_HELP(Review review) {
	...
	public SOFTWARE_HELP(ReviewNewsArticle reviewNewsArticle) {
	...
	public SOFTWARE_HELP(SatiricalArticle satiricalArticle) {
	...
	public SOFTWARE_HELP(ScholarlyArticle scholarlyArticle) {
	...
	public SOFTWARE_HELP(Sculpture sculpture) {
	...
	public SOFTWARE_HELP(SearchResultsPage searchResultsPage) {
	...
	public SOFTWARE_HELP(SheetMusic sheetMusic) {
	...
	public SOFTWARE_HELP(ShortStory shortStory) {
	...
	public SOFTWARE_HELP(SiteNavigationElement siteNavigationElement) {
	...
	public SOFTWARE_HELP(SocialMediaPosting socialMediaPosting) {
	...
	public SOFTWARE_HELP(SoftwareApplication softwareApplication) {
	...
	public SOFTWARE_HELP(SoftwareSourceCode softwareSourceCode) {
	...
	public SOFTWARE_HELP(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public SOFTWARE_HELP(TVClip tvClip) {
	...
	public SOFTWARE_HELP(TVEpisode tvEpisode) {
	...
	public SOFTWARE_HELP(TVSeason tvSeason) {
	...
	public SOFTWARE_HELP(TVSeries tvSeries) {
	...
	public SOFTWARE_HELP(Table table) {
	...
	public SOFTWARE_HELP(TechArticle techArticle) {
	...
	public SOFTWARE_HELP(TextDigitalDocument textDigitalDocument) {
	...
	public SOFTWARE_HELP(Thesis thesis) {
	...
	public SOFTWARE_HELP(ThreeDimensionalModel threeDimensionalModel) {
	...
	public SOFTWARE_HELP(UserReview userReview) {
	...
	public SOFTWARE_HELP(VideoGallery videoGallery) {
	...
	public SOFTWARE_HELP(VideoGame videoGame) {
	...
	public SOFTWARE_HELP(VideoGameClip videoGameClip) {
	...
	public SOFTWARE_HELP(VideoGameSeries videoGameSeries) {
	...
	public SOFTWARE_HELP(VideoObject videoObject) {
	...
	public SOFTWARE_HELP(VisualArtwork visualArtwork) {
	...
	public SOFTWARE_HELP(WPAdBlock wpAdBlock) {
	...
	public SOFTWARE_HELP(WPFooter wpFooter) {
	...
	public SOFTWARE_HELP(WPHeader wpHeader) {
	...
	public SOFTWARE_HELP(WPSideBar wpSideBar) {
	...
	public SOFTWARE_HELP(WebApplication webApplication) {
	...
	public SOFTWARE_HELP(WebPage webPage) {
	...
	public SOFTWARE_HELP(WebPageElement webPageElement) {
	...
	public SOFTWARE_HELP(WebSite webSite) {
	...
	public void copy(Container.SoftwareHelp org) {
