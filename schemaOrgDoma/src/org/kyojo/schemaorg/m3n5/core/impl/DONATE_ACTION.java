...
public class DONATE_ACTION implements Clazz.DonateAction {
	...
	public DONATE_ACTION() {
	}

	public DONATE_ACTION(Long seq) {
		setSeq(seq);
	}

	public DONATE_ACTION(String string) {
	...
	public DONATE_ACTION(ActionStatus actionStatus) {
	...
	public DONATE_ACTION(AdditionalType additionalType) {
	...
	public DONATE_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public DONATE_ACTION(AlternateName alternateName) {
	...
	public DONATE_ACTION(Description description) {
	...
	public DONATE_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public DONATE_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public DONATE_ACTION(Error error) {
		setError(error);
	}
	...
	public DONATE_ACTION(Identifier identifier) {
	...
	public DONATE_ACTION(Image image) {
		setImage(image);
	}
	...
	public DONATE_ACTION(Instrument instrument) {
	...
	public DONATE_ACTION(Location location) {
	...
	public DONATE_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public DONATE_ACTION(Name name) {
		setName(name);
	}
	...
	public DONATE_ACTION(NameFuzzy nameFuzzy) {
	...
	public DONATE_ACTION(NameRuby nameRuby) {
	...
	public DONATE_ACTION(Object object) {
		setObject(object);
	}
	...
	public DONATE_ACTION(Participant participant) {
	...
	public DONATE_ACTION(PotentialAction potentialAction) {
	...
	public DONATE_ACTION(Price price) {
		setPrice(price);
	}
	...
	public DONATE_ACTION(PriceCurrency priceCurrency) {
	...
	public DONATE_ACTION(PriceSpecification priceSpecification) {
	...
	public DONATE_ACTION(Recipient recipient) {
	...
	public DONATE_ACTION(Result result) {
		setResult(result);
	}
	...
	public DONATE_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DONATE_ACTION(StartTime startTime) {
	...
	public DONATE_ACTION(SubjectOf subjectOf) {
	...
	public DONATE_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.DonateAction org) {
		setSeq(org.getSeq());
