...
public class RESTRICTED_DIET implements Clazz.RestrictedDiet {
	...
	public RESTRICTED_DIET() {
	}

	public RESTRICTED_DIET(Long seq) {
		setSeq(seq);
	}

	public RESTRICTED_DIET(String string) {
	...
	public RESTRICTED_DIET(AdditionalType additionalType) {
	...
	public RESTRICTED_DIET(AlternateName alternateName) {
	...
	public RESTRICTED_DIET(Description description) {
	...
	public RESTRICTED_DIET(DisambiguatingDescription disambiguatingDescription) {
	...
	public RESTRICTED_DIET(Identifier identifier) {
	...
	public RESTRICTED_DIET(Image image) {
		setImage(image);
	}
	...
	public RESTRICTED_DIET(MainEntityOfPage mainEntityOfPage) {
	...
	public RESTRICTED_DIET(Name name) {
		setName(name);
	}
	...
	public RESTRICTED_DIET(NameFuzzy nameFuzzy) {
	...
	public RESTRICTED_DIET(NameRuby nameRuby) {
	...
	public RESTRICTED_DIET(PotentialAction potentialAction) {
	...
	public RESTRICTED_DIET(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RESTRICTED_DIET(SubjectOf subjectOf) {
	...
	public RESTRICTED_DIET(SupersededBy supersededBy) {
	...
	public RESTRICTED_DIET(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.RestrictedDiet org) {
		setSeq(org.getSeq());
