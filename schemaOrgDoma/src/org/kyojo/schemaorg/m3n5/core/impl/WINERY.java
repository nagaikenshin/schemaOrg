...
public class WINERY implements Clazz.Winery {
	...
	public WINERY(GeoContains geoContains) {
	...
	public WINERY(GeoCoveredBy geoCoveredBy) {
	...
	public WINERY(GeoCovers geoCovers) {
	...
	public WINERY(GeoCrosses geoCrosses) {
	...
	public WINERY(GeoDisjoint geoDisjoint) {
	...
	public WINERY(GeoEquals geoEquals) {
	...
	public WINERY(GeoIntersects geoIntersects) {
	...
	public WINERY(GeoOverlaps geoOverlaps) {
	...
	public WINERY(GeoTouches geoTouches) {
	...
	public WINERY(GeoWithin geoWithin) {
