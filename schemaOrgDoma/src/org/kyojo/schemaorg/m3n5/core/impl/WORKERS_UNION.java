...
public class WORKERS_UNION implements Clazz.WorkersUnion {
	...
	public WORKERS_UNION() {
	}

	public WORKERS_UNION(Long seq) {
		setSeq(seq);
	}

	public WORKERS_UNION(String string) {
	...
	public WORKERS_UNION(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public WORKERS_UNION(AdditionalType additionalType) {
	...
	public WORKERS_UNION(Address address) {
		setAddress(address);
	}
	...
	public WORKERS_UNION(AggregateRating aggregateRating) {
	...
	public WORKERS_UNION(AlternateName alternateName) {
	...
	public WORKERS_UNION(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public WORKERS_UNION(AreaServed areaServed) {
	...
	public WORKERS_UNION(Award award) {
		setAward(award);
	}
	...
	public WORKERS_UNION(Brand brand) {
		setBrand(brand);
	}
	...
	public WORKERS_UNION(ContactPoint contactPoint) {
	...
	public WORKERS_UNION(CorrectionsPolicy correctionsPolicy) {
	...
	public WORKERS_UNION(Department department) {
	...
	public WORKERS_UNION(Description description) {
	...
	public WORKERS_UNION(DisambiguatingDescription disambiguatingDescription) {
	...
	public WORKERS_UNION(DissolutionDate dissolutionDate) {
	...
	public WORKERS_UNION(DiversityPolicy diversityPolicy) {
	...
	public WORKERS_UNION(DiversityStaffingReport diversityStaffingReport) {
	...
	public WORKERS_UNION(Duns duns) {
		setDuns(duns);
	}
	...
	public WORKERS_UNION(Email email) {
		setEmail(email);
	}
	...
	public WORKERS_UNION(Employee employee) {
	...
	public WORKERS_UNION(EthicsPolicy ethicsPolicy) {
	...
	public WORKERS_UNION(Event event) {
		setEvent(event);
	}
	...
	public WORKERS_UNION(FaxNumber faxNumber) {
	...
	public WORKERS_UNION(Founder founder) {
		setFounder(founder);
	}
	...
	public WORKERS_UNION(FoundingDate foundingDate) {
	...
	public WORKERS_UNION(FoundingLocation foundingLocation) {
	...
	public WORKERS_UNION(Funder funder) {
		setFunder(funder);
	}
	...
	public WORKERS_UNION(GlobalLocationNumber globalLocationNumber) {
	...
	public WORKERS_UNION(HasOfferCatalog hasOfferCatalog) {
	...
	public WORKERS_UNION(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public WORKERS_UNION(Identifier identifier) {
	...
	public WORKERS_UNION(Image image) {
		setImage(image);
	}
	...
	public WORKERS_UNION(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public WORKERS_UNION(KnowsAbout knowsAbout) {
	...
	public WORKERS_UNION(KnowsLanguage knowsLanguage) {
	...
	public WORKERS_UNION(LegalName legalName) {
	...
	public WORKERS_UNION(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public WORKERS_UNION(Location location) {
	...
	public WORKERS_UNION(Logo logo) {
		setLogo(logo);
	}
	...
	public WORKERS_UNION(MainEntityOfPage mainEntityOfPage) {
	...
	public WORKERS_UNION(MakesOffer makesOffer) {
	...
	public WORKERS_UNION(Member member) {
		setMember(member);
	}
	...
	public WORKERS_UNION(MemberOf memberOf) {
	...
	public WORKERS_UNION(Naics naics) {
		setNaics(naics);
	}
	...
	public WORKERS_UNION(Name name) {
		setName(name);
	}
	...
	public WORKERS_UNION(NameFuzzy nameFuzzy) {
	...
	public WORKERS_UNION(NameRuby nameRuby) {
	...
	public WORKERS_UNION(NumberOfEmployees numberOfEmployees) {
	...
	public WORKERS_UNION(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public WORKERS_UNION(Owns owns) {
		setOwns(owns);
	}
	...
	public WORKERS_UNION(ParentOrganization parentOrganization) {
	...
	public WORKERS_UNION(PotentialAction potentialAction) {
	...
	public WORKERS_UNION(PublishingPrinciples publishingPrinciples) {
	...
	public WORKERS_UNION(Review review) {
		setReview(review);
	}
	...
	public WORKERS_UNION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public WORKERS_UNION(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public WORKERS_UNION(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public WORKERS_UNION(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public WORKERS_UNION(SubOrganization subOrganization) {
	...
	public WORKERS_UNION(SubjectOf subjectOf) {
	...
	public WORKERS_UNION(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public WORKERS_UNION(Telephone telephone) {
	...
	public WORKERS_UNION(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public WORKERS_UNION(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.WorkersUnion org) {
		setSeq(org.getSeq());
