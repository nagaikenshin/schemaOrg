...
public class UPDATE_ACTION implements Clazz.UpdateAction {
	...
	public UPDATE_ACTION(Long seq) {
		setSeq(seq);
	}

	public UPDATE_ACTION(String string) {
	...
	public UPDATE_ACTION(ActionStatus actionStatus) {
	...
	public UPDATE_ACTION(AdditionalType additionalType) {
	...
	public UPDATE_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public UPDATE_ACTION(AlternateName alternateName) {
	...
	public UPDATE_ACTION(Description description) {
	...
	public UPDATE_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public UPDATE_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public UPDATE_ACTION(Error error) {
		setError(error);
	}
	...
	public UPDATE_ACTION(Identifier identifier) {
	...
	public UPDATE_ACTION(Image image) {
		setImage(image);
	}
	...
	public UPDATE_ACTION(Instrument instrument) {
	...
	public UPDATE_ACTION(Location location) {
	...
	public UPDATE_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public UPDATE_ACTION(Name name) {
		setName(name);
	}
	...
	public UPDATE_ACTION(NameFuzzy nameFuzzy) {
	...
	public UPDATE_ACTION(NameRuby nameRuby) {
	...
	public UPDATE_ACTION(Object object) {
		setObject(object);
	}
	...
	public UPDATE_ACTION(Participant participant) {
	...
	public UPDATE_ACTION(PotentialAction potentialAction) {
	...
	public UPDATE_ACTION(Result result) {
		setResult(result);
	}
	...
	public UPDATE_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public UPDATE_ACTION(StartTime startTime) {
	...
	public UPDATE_ACTION(SubjectOf subjectOf) {
	...
	public UPDATE_ACTION(Target target) {
		setTarget(target);
	}
	...
	public UPDATE_ACTION(TargetCollection targetCollection) {
	...
	public void copy(Clazz.UpdateAction org) {
		setSeq(org.getSeq());
