...
public class AUTO_DEALER implements Clazz.AutoDealer {
	...
	public AUTO_DEALER(GeoContains geoContains) {
	...
	public AUTO_DEALER(GeoCoveredBy geoCoveredBy) {
	...
	public AUTO_DEALER(GeoCovers geoCovers) {
	...
	public AUTO_DEALER(GeoCrosses geoCrosses) {
	...
	public AUTO_DEALER(GeoDisjoint geoDisjoint) {
	...
	public AUTO_DEALER(GeoEquals geoEquals) {
	...
	public AUTO_DEALER(GeoIntersects geoIntersects) {
	...
	public AUTO_DEALER(GeoOverlaps geoOverlaps) {
	...
	public AUTO_DEALER(GeoTouches geoTouches) {
	...
	public AUTO_DEALER(GeoWithin geoWithin) {
	...
	public AUTO_DEALER(Slogan slogan) {
		setSlogan(slogan);
	}
