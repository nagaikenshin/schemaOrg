...
public class ANIMAL_SHELTER implements Clazz.AnimalShelter {
	...
	public ANIMAL_SHELTER(GeoContains geoContains) {
	...
	public ANIMAL_SHELTER(GeoCoveredBy geoCoveredBy) {
	...
	public ANIMAL_SHELTER(GeoCovers geoCovers) {
	...
	public ANIMAL_SHELTER(GeoCrosses geoCrosses) {
	...
	public ANIMAL_SHELTER(GeoDisjoint geoDisjoint) {
	...
	public ANIMAL_SHELTER(GeoEquals geoEquals) {
	...
	public ANIMAL_SHELTER(GeoIntersects geoIntersects) {
	...
	public ANIMAL_SHELTER(GeoOverlaps geoOverlaps) {
	...
	public ANIMAL_SHELTER(GeoTouches geoTouches) {
	...
	public ANIMAL_SHELTER(GeoWithin geoWithin) {
	...
	public ANIMAL_SHELTER(Slogan slogan) {
		setSlogan(slogan);
	}
