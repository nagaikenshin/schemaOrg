...
public class SKI_RESORT implements Clazz.SkiResort {
	...
	public SKI_RESORT(GeoContains geoContains) {
	...
	public SKI_RESORT(GeoCoveredBy geoCoveredBy) {
	...
	public SKI_RESORT(GeoCovers geoCovers) {
	...
	public SKI_RESORT(GeoCrosses geoCrosses) {
	...
	public SKI_RESORT(GeoDisjoint geoDisjoint) {
	...
	public SKI_RESORT(GeoEquals geoEquals) {
	...
	public SKI_RESORT(GeoIntersects geoIntersects) {
	...
	public SKI_RESORT(GeoOverlaps geoOverlaps) {
	...
	public SKI_RESORT(GeoTouches geoTouches) {
	...
	public SKI_RESORT(GeoWithin geoWithin) {
	...
	public SKI_RESORT(Slogan slogan) {
		setSlogan(slogan);
	}
