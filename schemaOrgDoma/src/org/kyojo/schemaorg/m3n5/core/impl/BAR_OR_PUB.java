...
public class BAR_OR_PUB implements Clazz.BarOrPub {
	...
	public BAR_OR_PUB(GeoContains geoContains) {
	...
	public BAR_OR_PUB(GeoCoveredBy geoCoveredBy) {
	...
	public BAR_OR_PUB(GeoCovers geoCovers) {
	...
	public BAR_OR_PUB(GeoCrosses geoCrosses) {
	...
	public BAR_OR_PUB(GeoDisjoint geoDisjoint) {
	...
	public BAR_OR_PUB(GeoEquals geoEquals) {
	...
	public BAR_OR_PUB(GeoIntersects geoIntersects) {
	...
	public BAR_OR_PUB(GeoOverlaps geoOverlaps) {
	...
	public BAR_OR_PUB(GeoTouches geoTouches) {
	...
	public BAR_OR_PUB(GeoWithin geoWithin) {
	...
	public BAR_OR_PUB(Slogan slogan) {
		setSlogan(slogan);
	}
