...
public class CHARACTER implements Container.Character {
	...
	public CHARACTER(Patient patient) {
	...
	public CHARACTER(List<Patient> patientList,
			List<Person> personList) {
		setPatientList(patientList);
		setPersonList(personList);
	}

	public void copy(Container.Character org) {
