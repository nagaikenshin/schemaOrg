...
public class ORGANIZER implements Container.Organizer {
	...
	public ORGANIZER(AccountingService accountingService) {
	...
	public ORGANIZER(AdultEntertainment adultEntertainment) {
	...
	public ORGANIZER(Airline airline) {
	...
	public ORGANIZER(AmusementPark amusementPark) {
	...
	public ORGANIZER(AnimalShelter animalShelter) {
	...
	public ORGANIZER(ArchiveOrganization archiveOrganization) {
	...
	public ORGANIZER(ArtGallery artGallery) {
	...
	public ORGANIZER(Attorney attorney) {
	...
	public ORGANIZER(AutoBodyShop autoBodyShop) {
	...
	public ORGANIZER(AutoDealer autoDealer) {
	...
	public ORGANIZER(AutoPartsStore autoPartsStore) {
	...
	public ORGANIZER(AutoRental autoRental) {
	...
	public ORGANIZER(AutoRepair autoRepair) {
	...
	public ORGANIZER(AutoWash autoWash) {
	...
	public ORGANIZER(AutomatedTeller automatedTeller) {
	...
	public ORGANIZER(AutomotiveBusiness automotiveBusiness) {
	...
	public ORGANIZER(Bakery bakery) {
	...
	public ORGANIZER(BankOrCreditUnion bankOrCreditUnion) {
	...
	public ORGANIZER(BarOrPub barOrPub) {
	...
	public ORGANIZER(BeautySalon beautySalon) {
	...
	public ORGANIZER(BedAndBreakfast bedAndBreakfast) {
	...
	public ORGANIZER(BikeStore bikeStore) {
	...
	public ORGANIZER(BookStore bookStore) {
	...
	public ORGANIZER(BowlingAlley bowlingAlley) {
	...
	public ORGANIZER(Brewery brewery) {
	...
	public ORGANIZER(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public ORGANIZER(Campground campground) {
	...
	public ORGANIZER(Casino casino) {
	...
	public ORGANIZER(ChildCare childCare) {
	...
	public ORGANIZER(ClothingStore clothingStore) {
	...
	public ORGANIZER(CollegeOrUniversity collegeOrUniversity) {
	...
	public ORGANIZER(ComedyClub comedyClub) {
	...
	public ORGANIZER(CommunityHealth communityHealth) {
	...
	public ORGANIZER(ComputerStore computerStore) {
	...
	public ORGANIZER(Consortium consortium) {
	...
	public ORGANIZER(ConvenienceStore convenienceStore) {
	...
	public ORGANIZER(Corporation corporation) {
	...
	public ORGANIZER(DanceGroup danceGroup) {
	...
	public ORGANIZER(DaySpa daySpa) {
	...
	public ORGANIZER(Dentist dentist) {
	...
	public ORGANIZER(DepartmentStore departmentStore) {
	...
	public ORGANIZER(Dermatology dermatology) {
	...
	public ORGANIZER(DiagnosticLab diagnosticLab) {
	...
	public ORGANIZER(DietNutrition dietNutrition) {
	...
	public ORGANIZER(Distillery distillery) {
	...
	public ORGANIZER(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public ORGANIZER(EducationalOrganization educationalOrganization) {
	...
	public ORGANIZER(Electrician electrician) {
	...
	public ORGANIZER(ElectronicsStore electronicsStore) {
	...
	public ORGANIZER(ElementarySchool elementarySchool) {
	...
	public ORGANIZER(Emergency emergency) {
	...
	public ORGANIZER(EmergencyService emergencyService) {
	...
	public ORGANIZER(EmploymentAgency employmentAgency) {
	...
	public ORGANIZER(EntertainmentBusiness entertainmentBusiness) {
	...
	public ORGANIZER(ExerciseGym exerciseGym) {
	...
	public ORGANIZER(FastFoodRestaurant fastFoodRestaurant) {
	...
	public ORGANIZER(FinancialService financialService) {
	...
	public ORGANIZER(FireStation fireStation) {
	...
	public ORGANIZER(Florist florist) {
	...
	public ORGANIZER(FoodEstablishment foodEstablishment) {
	...
	public ORGANIZER(FundingAgency fundingAgency) {
	...
	public ORGANIZER(FundingScheme fundingScheme) {
	...
	public ORGANIZER(FurnitureStore furnitureStore) {
	...
	public ORGANIZER(GardenStore gardenStore) {
	...
	public ORGANIZER(GasStation gasStation) {
	...
	public ORGANIZER(GeneralContractor generalContractor) {
	...
	public ORGANIZER(Geriatric geriatric) {
	...
	public ORGANIZER(GolfCourse golfCourse) {
	...
	public ORGANIZER(GovernmentOffice governmentOffice) {
	...
	public ORGANIZER(GovernmentOrganization governmentOrganization) {
	...
	public ORGANIZER(GroceryStore groceryStore) {
	...
	public ORGANIZER(Gynecologic gynecologic) {
	...
	public ORGANIZER(HVACBusiness hvacBusiness) {
	...
	public ORGANIZER(HairSalon hairSalon) {
	...
	public ORGANIZER(HardwareStore hardwareStore) {
	...
	public ORGANIZER(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public ORGANIZER(HealthClub healthClub) {
	...
	public ORGANIZER(HighSchool highSchool) {
	...
	public ORGANIZER(HobbyShop hobbyShop) {
	...
	public ORGANIZER(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public ORGANIZER(HomeGoodsStore homeGoodsStore) {
	...
	public ORGANIZER(Hospital hospital) {
	...
	public ORGANIZER(Hostel hostel) {
	...
	public ORGANIZER(HousePainter housePainter) {
	...
	public ORGANIZER(IceCreamShop iceCreamShop) {
	...
	public ORGANIZER(InsuranceAgency insuranceAgency) {
	...
	public ORGANIZER(InternetCafe internetCafe) {
	...
	public ORGANIZER(JewelryStore jewelryStore) {
	...
	public ORGANIZER(LegalService legalService) {
	...
	public ORGANIZER(Library library) {
	...
	public ORGANIZER(LibrarySystem librarySystem) {
	...
	public ORGANIZER(LiquorStore liquorStore) {
	...
	public ORGANIZER(LocalBusiness localBusiness) {
	...
	public ORGANIZER(Locksmith locksmith) {
	...
	public ORGANIZER(LodgingBusiness lodgingBusiness) {
	...
	public ORGANIZER(MedicalBusiness medicalBusiness) {
	...
	public ORGANIZER(MedicalClinic medicalClinic) {
	...
	public ORGANIZER(MedicalOrganization medicalOrganization) {
	...
	public ORGANIZER(MensClothingStore mensClothingStore) {
	...
	public ORGANIZER(MiddleSchool middleSchool) {
	...
	public ORGANIZER(Midwifery midwifery) {
	...
	public ORGANIZER(MobilePhoneStore mobilePhoneStore) {
	...
	public ORGANIZER(MotorcycleDealer motorcycleDealer) {
	...
	public ORGANIZER(MotorcycleRepair motorcycleRepair) {
	...
	public ORGANIZER(MovieRentalStore movieRentalStore) {
	...
	public ORGANIZER(MovieTheater movieTheater) {
	...
	public ORGANIZER(MovingCompany movingCompany) {
	...
	public ORGANIZER(MusicGroup musicGroup) {
	...
	public ORGANIZER(MusicStore musicStore) {
	...
	public ORGANIZER(NailSalon nailSalon) {
	...
	public ORGANIZER(NewsMediaOrganization newsMediaOrganization) {
	...
	public ORGANIZER(NightClub nightClub) {
	...
	public ORGANIZER(Notary notary) {
	...
	public ORGANIZER(Nursing nursing) {
	...
	public ORGANIZER(Obstetric obstetric) {
	...
	public ORGANIZER(OfficeEquipmentStore officeEquipmentStore) {
	...
	public ORGANIZER(Oncologic oncologic) {
	...
	public ORGANIZER(Optician optician) {
	...
	public ORGANIZER(Optometric optometric) {
	...
	public ORGANIZER(Organization organization) {
		organizationList = new ArrayList<Organization>();
	...
	public ORGANIZER(Otolaryngologic otolaryngologic) {
	...
	public ORGANIZER(OutletStore outletStore) {
	...
	public ORGANIZER(Patient patient) {
	...
	public ORGANIZER(PawnShop pawnShop) {
	...
	public ORGANIZER(Pediatric pediatric) {
	...
	public ORGANIZER(PerformingGroup performingGroup) {
	...
	public ORGANIZER(PetStore petStore) {
	...
	public ORGANIZER(Pharmacy pharmacy) {
	...
	public ORGANIZER(Physician physician) {
	...
	public ORGANIZER(Physiotherapy physiotherapy) {
	...
	public ORGANIZER(PlasticSurgery plasticSurgery) {
	...
	public ORGANIZER(Plumber plumber) {
	...
	public ORGANIZER(Podiatric podiatric) {
	...
	public ORGANIZER(PoliceStation policeStation) {
	...
	public ORGANIZER(PostOffice postOffice) {
	...
	public ORGANIZER(Preschool preschool) {
	...
	public ORGANIZER(PrimaryCare primaryCare) {
	...
	public ORGANIZER(ProfessionalService professionalService) {
	...
	public ORGANIZER(Project project) {
	...
	public ORGANIZER(Psychiatric psychiatric) {
	...
	public ORGANIZER(PublicHealth publicHealth) {
	...
	public ORGANIZER(PublicSwimmingPool publicSwimmingPool) {
	...
	public ORGANIZER(RadioStation radioStation) {
	...
	public ORGANIZER(RealEstateAgent realEstateAgent) {
	...
	public ORGANIZER(RecyclingCenter recyclingCenter) {
	...
	public ORGANIZER(ResearchProject researchProject) {
	...
	public ORGANIZER(Resort resort) {
	...
	public ORGANIZER(Restaurant restaurant) {
	...
	public ORGANIZER(RoofingContractor roofingContractor) {
	...
	public ORGANIZER(School school) {
	...
	public ORGANIZER(SelfStorage selfStorage) {
	...
	public ORGANIZER(ShoeStore shoeStore) {
	...
	public ORGANIZER(ShoppingCenter shoppingCenter) {
	...
	public ORGANIZER(SkiResort skiResort) {
	...
	public ORGANIZER(SportingGoodsStore sportingGoodsStore) {
	...
	public ORGANIZER(SportsActivityLocation sportsActivityLocation) {
	...
	public ORGANIZER(SportsClub sportsClub) {
	...
	public ORGANIZER(SportsOrganization sportsOrganization) {
	...
	public ORGANIZER(SportsTeam sportsTeam) {
	...
	public ORGANIZER(StadiumOrArena stadiumOrArena) {
	...
	public ORGANIZER(TattooParlor tattooParlor) {
	...
	public ORGANIZER(TelevisionStation televisionStation) {
	...
	public ORGANIZER(TennisComplex tennisComplex) {
	...
	public ORGANIZER(TheaterGroup theaterGroup) {
	...
	public ORGANIZER(TireShop tireShop) {
	...
	public ORGANIZER(TouristInformationCenter touristInformationCenter) {
	...
	public ORGANIZER(ToyStore toyStore) {
	...
	public ORGANIZER(TravelAgency travelAgency) {
	...
	public ORGANIZER(VeterinaryCare veterinaryCare) {
	...
	public ORGANIZER(WholesaleStore wholesaleStore) {
	...
	public ORGANIZER(Winery winery) {
	...
	public ORGANIZER(WorkersUnion workersUnion) {
	...
	public void copy(Container.Organizer org) {
