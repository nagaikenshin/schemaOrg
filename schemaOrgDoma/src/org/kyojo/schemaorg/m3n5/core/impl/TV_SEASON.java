...
public class TV_SEASON implements Clazz.TVSeason {
	...
	public TV_SEASON(Long seq) {
		setSeq(seq);
	}

	public TV_SEASON(String string) {
	...
	public TV_SEASON(AccessMode accessMode) {
	...
	public TV_SEASON(AccessModeSufficient accessModeSufficient) {
	...
	public TV_SEASON(AccessibilityAPI accessibilityAPI) {
	...
	public TV_SEASON(AccessibilityControl accessibilityControl) {
	...
	public TV_SEASON(AccessibilityFeature accessibilityFeature) {
	...
	public TV_SEASON(AccessibilityHazard accessibilityHazard) {
	...
	public TV_SEASON(AccessibilitySummary accessibilitySummary) {
	...
	public TV_SEASON(AccountablePerson accountablePerson) {
	...
	public TV_SEASON(AdditionalType additionalType) {
	...
	public TV_SEASON(AggregateRating aggregateRating) {
	...
	public TV_SEASON(AlternateName alternateName) {
	...
	public TV_SEASON(AlternativeHeadline alternativeHeadline) {
	...
	public TV_SEASON(AssociatedMedia associatedMedia) {
	...
	public TV_SEASON(Audience audience) {
	...
	public TV_SEASON(Author author) {
		setAuthor(author);
	}
	...
	public TV_SEASON(Character character) {
	...
	public TV_SEASON(Citation citation) {
	...
	public TV_SEASON(Comment comment) {
		setComment(comment);
	}
	...
	public TV_SEASON(CommentCount commentCount) {
	...
	public TV_SEASON(ContentLocation contentLocation) {
	...
	public TV_SEASON(ContentRating contentRating) {
	...
	public TV_SEASON(ContentReferenceTime contentReferenceTime) {
	...
	public TV_SEASON(Contributor contributor) {
	...
	public TV_SEASON(CopyrightHolder copyrightHolder) {
	...
	public TV_SEASON(CopyrightYear copyrightYear) {
	...
	public TV_SEASON(Correction correction) {
	...
	public TV_SEASON(CountryOfOrigin countryOfOrigin) {
	...
	public TV_SEASON(Creator creator) {
		setCreator(creator);
	}
	...
	public TV_SEASON(DateCreated dateCreated) {
	...
	public TV_SEASON(DateModified dateModified) {
	...
	public TV_SEASON(DatePublished datePublished) {
	...
	public TV_SEASON(Description description) {
	...
	public TV_SEASON(Director director) {
	...
	public TV_SEASON(DisambiguatingDescription disambiguatingDescription) {
	...
	public TV_SEASON(DiscussionUrl discussionUrl) {
	...
	public TV_SEASON(Editor editor) {
		setEditor(editor);
	}
	...
	public TV_SEASON(EducationalAlignment educationalAlignment) {
	...
	public TV_SEASON(EducationalUse educationalUse) {
	...
	public TV_SEASON(Encoding encoding) {
	...
	public TV_SEASON(EncodingFormat encodingFormat) {
	...
	public TV_SEASON(EndDate endDate) {
		setEndDate(endDate);
	}
	...
	public TV_SEASON(Episode episode) {
		setEpisode(episode);
	}
	...
	public TV_SEASON(ExampleOfWork exampleOfWork) {
	...
	public TV_SEASON(Expires expires) {
		setExpires(expires);
	}
	...
	public TV_SEASON(Funder funder) {
		setFunder(funder);
	}
	...
	public TV_SEASON(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public TV_SEASON(Headline headline) {
	...
	public TV_SEASON(Identifier identifier) {
	...
	public TV_SEASON(InLanguage inLanguage) {
	...
	public TV_SEASON(InteractionStatistic interactionStatistic) {
	...
	public TV_SEASON(InteractivityType interactivityType) {
	...
	public TV_SEASON(IsAccessibleForFree isAccessibleForFree) {
	...
	public TV_SEASON(IsBasedOn isBasedOn) {
	...
	public TV_SEASON(IsFamilyFriendly isFamilyFriendly) {
	...
	public TV_SEASON(IsPartOf isPartOf) {
	...
	public TV_SEASON(Keywords keywords) {
	...
	public TV_SEASON(LearningResourceType learningResourceType) {
	...
	public TV_SEASON(License license) {
		setLicense(license);
	}
	...
	public TV_SEASON(LocationCreated locationCreated) {
	...
	public TV_SEASON(MainEntity mainEntity) {
	...
	public TV_SEASON(MainEntityOfPage mainEntityOfPage) {
	...
	public TV_SEASON(Material material) {
	...
	public TV_SEASON(MaterialExtent materialExtent) {
	...
	public TV_SEASON(Mentions mentions) {
	...
	public TV_SEASON(NameFuzzy nameFuzzy) {
	...
	public TV_SEASON(NameRuby nameRuby) {
	...
	public TV_SEASON(NumberOfEpisodes numberOfEpisodes) {
	...
	public TV_SEASON(Offers offers) {
		setOffers(offers);
	}
	...
	public TV_SEASON(PartOfSeries partOfSeries) {
	...
	public TV_SEASON(Position position) {
	...
	public TV_SEASON(PotentialAction potentialAction) {
	...
	public TV_SEASON(Producer producer) {
	...
	public TV_SEASON(ProductionCompany productionCompany) {
	...
	public TV_SEASON(Provider provider) {
	...
	public TV_SEASON(Publication publication) {
	...
	public TV_SEASON(Publisher publisher) {
	...
	public TV_SEASON(PublisherImprint publisherImprint) {
	...
	public TV_SEASON(PublishingPrinciples publishingPrinciples) {
	...
	public TV_SEASON(RecordedAt recordedAt) {
	...
	public TV_SEASON(ReleasedEvent releasedEvent) {
	...
	public TV_SEASON(Review review) {
		setReview(review);
	}
	...
	public TV_SEASON(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TV_SEASON(SchemaVersion schemaVersion) {
	...
	public TV_SEASON(SdDatePublished sdDatePublished) {
	...
	public TV_SEASON(SdLicense sdLicense) {
	...
	public TV_SEASON(SdPublisher sdPublisher) {
	...
	public TV_SEASON(SeasonNumber seasonNumber) {
	...
	public TV_SEASON(SourceOrganization sourceOrganization) {
	...
	public TV_SEASON(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public TV_SEASON(SpatialCoverage spatialCoverage) {
	...
	public TV_SEASON(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public TV_SEASON(StartDate startDate) {
	...
	public TV_SEASON(SubjectOf subjectOf) {
	...
	public TV_SEASON(Temporal temporal) {
	...
	public TV_SEASON(TemporalCoverage temporalCoverage) {
	...
	public TV_SEASON(ThumbnailUrl thumbnailUrl) {
	...
	public TV_SEASON(TimeRequired timeRequired) {
	...
	public TV_SEASON(Trailer trailer) {
		setTrailer(trailer);
	}
	...
	public TV_SEASON(TranslationOfWork translationOfWork) {
	...
	public TV_SEASON(Translator translator) {
	...
	public TV_SEASON(TypicalAgeRange typicalAgeRange) {
	...
	public TV_SEASON(Version version) {
		setVersion(version);
	}
	...
	public TV_SEASON(WorkExample workExample) {
	...
	public TV_SEASON(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.TVSeason org) {
		setSeq(org.getSeq());
