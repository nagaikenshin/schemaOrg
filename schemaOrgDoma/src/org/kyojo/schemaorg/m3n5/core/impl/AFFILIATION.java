...
public class AFFILIATION implements Container.Affiliation {
	...
	public AFFILIATION(AccountingService accountingService) {
	...
	public AFFILIATION(AdultEntertainment adultEntertainment) {
	...
	public AFFILIATION(Airline airline) {
	...
	public AFFILIATION(AmusementPark amusementPark) {
	...
	public AFFILIATION(AnimalShelter animalShelter) {
	...
	public AFFILIATION(ArchiveOrganization archiveOrganization) {
	...
	public AFFILIATION(ArtGallery artGallery) {
	...
	public AFFILIATION(Attorney attorney) {
	...
	public AFFILIATION(AutoBodyShop autoBodyShop) {
	...
	public AFFILIATION(AutoDealer autoDealer) {
	...
	public AFFILIATION(AutoPartsStore autoPartsStore) {
	...
	public AFFILIATION(AutoRental autoRental) {
	...
	public AFFILIATION(AutoRepair autoRepair) {
	...
	public AFFILIATION(AutoWash autoWash) {
	...
	public AFFILIATION(AutomatedTeller automatedTeller) {
	...
	public AFFILIATION(AutomotiveBusiness automotiveBusiness) {
	...
	public AFFILIATION(Bakery bakery) {
	...
	public AFFILIATION(BankOrCreditUnion bankOrCreditUnion) {
	...
	public AFFILIATION(BarOrPub barOrPub) {
	...
	public AFFILIATION(BeautySalon beautySalon) {
	...
	public AFFILIATION(BedAndBreakfast bedAndBreakfast) {
	...
	public AFFILIATION(BikeStore bikeStore) {
	...
	public AFFILIATION(BookStore bookStore) {
	...
	public AFFILIATION(BowlingAlley bowlingAlley) {
	...
	public AFFILIATION(Brewery brewery) {
	...
	public AFFILIATION(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public AFFILIATION(Campground campground) {
	...
	public AFFILIATION(Casino casino) {
	...
	public AFFILIATION(ChildCare childCare) {
	...
	public AFFILIATION(ClothingStore clothingStore) {
	...
	public AFFILIATION(CollegeOrUniversity collegeOrUniversity) {
	...
	public AFFILIATION(ComedyClub comedyClub) {
	...
	public AFFILIATION(CommunityHealth communityHealth) {
	...
	public AFFILIATION(ComputerStore computerStore) {
	...
	public AFFILIATION(Consortium consortium) {
	...
	public AFFILIATION(ConvenienceStore convenienceStore) {
	...
	public AFFILIATION(Corporation corporation) {
	...
	public AFFILIATION(DanceGroup danceGroup) {
	...
	public AFFILIATION(DaySpa daySpa) {
	...
	public AFFILIATION(Dentist dentist) {
	...
	public AFFILIATION(DepartmentStore departmentStore) {
	...
	public AFFILIATION(Dermatology dermatology) {
	...
	public AFFILIATION(DiagnosticLab diagnosticLab) {
	...
	public AFFILIATION(DietNutrition dietNutrition) {
	...
	public AFFILIATION(Distillery distillery) {
	...
	public AFFILIATION(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public AFFILIATION(EducationalOrganization educationalOrganization) {
	...
	public AFFILIATION(Electrician electrician) {
	...
	public AFFILIATION(ElectronicsStore electronicsStore) {
	...
	public AFFILIATION(ElementarySchool elementarySchool) {
	...
	public AFFILIATION(Emergency emergency) {
	...
	public AFFILIATION(EmergencyService emergencyService) {
	...
	public AFFILIATION(EmploymentAgency employmentAgency) {
	...
	public AFFILIATION(EntertainmentBusiness entertainmentBusiness) {
	...
	public AFFILIATION(ExerciseGym exerciseGym) {
	...
	public AFFILIATION(FastFoodRestaurant fastFoodRestaurant) {
	...
	public AFFILIATION(FinancialService financialService) {
	...
	public AFFILIATION(FireStation fireStation) {
	...
	public AFFILIATION(Florist florist) {
	...
	public AFFILIATION(FoodEstablishment foodEstablishment) {
	...
	public AFFILIATION(FundingAgency fundingAgency) {
	...
	public AFFILIATION(FundingScheme fundingScheme) {
	...
	public AFFILIATION(FurnitureStore furnitureStore) {
	...
	public AFFILIATION(GardenStore gardenStore) {
	...
	public AFFILIATION(GasStation gasStation) {
	...
	public AFFILIATION(GeneralContractor generalContractor) {
	...
	public AFFILIATION(Geriatric geriatric) {
	...
	public AFFILIATION(GolfCourse golfCourse) {
	...
	public AFFILIATION(GovernmentOffice governmentOffice) {
	...
	public AFFILIATION(GovernmentOrganization governmentOrganization) {
	...
	public AFFILIATION(GroceryStore groceryStore) {
	...
	public AFFILIATION(Gynecologic gynecologic) {
	...
	public AFFILIATION(HVACBusiness hvacBusiness) {
	...
	public AFFILIATION(HairSalon hairSalon) {
	...
	public AFFILIATION(HardwareStore hardwareStore) {
	...
	public AFFILIATION(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public AFFILIATION(HealthClub healthClub) {
	...
	public AFFILIATION(HighSchool highSchool) {
	...
	public AFFILIATION(HobbyShop hobbyShop) {
	...
	public AFFILIATION(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public AFFILIATION(HomeGoodsStore homeGoodsStore) {
	...
	public AFFILIATION(Hospital hospital) {
	...
	public AFFILIATION(Hostel hostel) {
	...
	public AFFILIATION(Hotel hotel) {
	...
	public AFFILIATION(HousePainter housePainter) {
	...
	public AFFILIATION(IceCreamShop iceCreamShop) {
	...
	public AFFILIATION(InsuranceAgency insuranceAgency) {
	...
	public AFFILIATION(InternetCafe internetCafe) {
	...
	public AFFILIATION(JewelryStore jewelryStore) {
	...
	public AFFILIATION(LegalService legalService) {
	...
	public AFFILIATION(Library library) {
	...
	public AFFILIATION(LibrarySystem librarySystem) {
	...
	public AFFILIATION(LiquorStore liquorStore) {
	...
	public AFFILIATION(LocalBusiness localBusiness) {
	...
	public AFFILIATION(Locksmith locksmith) {
	...
	public AFFILIATION(LodgingBusiness lodgingBusiness) {
	...
	public AFFILIATION(MedicalBusiness medicalBusiness) {
	...
	public AFFILIATION(MedicalClinic medicalClinic) {
	...
	public AFFILIATION(MedicalOrganization medicalOrganization) {
	...
	public AFFILIATION(MensClothingStore mensClothingStore) {
	...
	public AFFILIATION(MiddleSchool middleSchool) {
	...
	public AFFILIATION(Midwifery midwifery) {
	...
	public AFFILIATION(MobilePhoneStore mobilePhoneStore) {
	...
	public AFFILIATION(Motel motel) {
	...
	public AFFILIATION(MotorcycleDealer motorcycleDealer) {
	...
	public AFFILIATION(MotorcycleRepair motorcycleRepair) {
	...
	public AFFILIATION(MovieRentalStore movieRentalStore) {
	...
	public AFFILIATION(MovieTheater movieTheater) {
	...
	public AFFILIATION(MovingCompany movingCompany) {
	...
	public AFFILIATION(MusicGroup musicGroup) {
	...
	public AFFILIATION(MusicStore musicStore) {
	...
	public AFFILIATION(NailSalon nailSalon) {
	...
	public AFFILIATION(NewsMediaOrganization newsMediaOrganization) {
	...
	public AFFILIATION(NightClub nightClub) {
	...
	public AFFILIATION(Notary notary) {
	...
	public AFFILIATION(Nursing nursing) {
	...
	public AFFILIATION(Obstetric obstetric) {
	...
	public AFFILIATION(OfficeEquipmentStore officeEquipmentStore) {
	...
	public AFFILIATION(Oncologic oncologic) {
	...
	public AFFILIATION(Optician optician) {
	...
	public AFFILIATION(Optometric optometric) {
	...
	public AFFILIATION(Otolaryngologic otolaryngologic) {
	...
	public AFFILIATION(OutletStore outletStore) {
	...
	public AFFILIATION(PawnShop pawnShop) {
	...
	public AFFILIATION(Pediatric pediatric) {
	...
	public AFFILIATION(PerformingGroup performingGroup) {
	...
	public AFFILIATION(PetStore petStore) {
	...
	public AFFILIATION(Pharmacy pharmacy) {
	...
	public AFFILIATION(Physician physician) {
	...
	public AFFILIATION(Physiotherapy physiotherapy) {
	...
	public AFFILIATION(PlasticSurgery plasticSurgery) {
	...
	public AFFILIATION(Plumber plumber) {
	...
	public AFFILIATION(Podiatric podiatric) {
	...
	public AFFILIATION(PoliceStation policeStation) {
	...
	public AFFILIATION(PostOffice postOffice) {
	...
	public AFFILIATION(Preschool preschool) {
	...
	public AFFILIATION(PrimaryCare primaryCare) {
	...
	public AFFILIATION(ProfessionalService professionalService) {
	...
	public AFFILIATION(Project project) {
	...
	public AFFILIATION(Psychiatric psychiatric) {
	...
	public AFFILIATION(PublicHealth publicHealth) {
	...
	public AFFILIATION(PublicSwimmingPool publicSwimmingPool) {
	...
	public AFFILIATION(RadioStation radioStation) {
	...
	public AFFILIATION(RealEstateAgent realEstateAgent) {
	...
	public AFFILIATION(RecyclingCenter recyclingCenter) {
	...
	public AFFILIATION(ResearchProject researchProject) {
	...
	public AFFILIATION(Resort resort) {
	...
	public AFFILIATION(Restaurant restaurant) {
	...
	public AFFILIATION(RoofingContractor roofingContractor) {
	...
	public AFFILIATION(School school) {
	...
	public AFFILIATION(SelfStorage selfStorage) {
	...
	public AFFILIATION(ShoeStore shoeStore) {
	...
	public AFFILIATION(ShoppingCenter shoppingCenter) {
	...
	public AFFILIATION(SkiResort skiResort) {
	...
	public AFFILIATION(SportingGoodsStore sportingGoodsStore) {
	...
	public AFFILIATION(SportsActivityLocation sportsActivityLocation) {
	...
	public AFFILIATION(SportsClub sportsClub) {
	...
	public AFFILIATION(SportsOrganization sportsOrganization) {
	...
	public AFFILIATION(SportsTeam sportsTeam) {
	...
	public AFFILIATION(StadiumOrArena stadiumOrArena) {
	...
	public AFFILIATION(Store store) {
	...
	public AFFILIATION(TattooParlor tattooParlor) {
	...
	public AFFILIATION(TelevisionStation televisionStation) {
	...
	public AFFILIATION(TennisComplex tennisComplex) {
	...
	public AFFILIATION(TheaterGroup theaterGroup) {
	...
	public AFFILIATION(TireShop tireShop) {
	...
	public AFFILIATION(TouristInformationCenter touristInformationCenter) {
	...
	public AFFILIATION(ToyStore toyStore) {
	...
	public AFFILIATION(TravelAgency travelAgency) {
	...
	public AFFILIATION(VeterinaryCare veterinaryCare) {
	...
	public AFFILIATION(WholesaleStore wholesaleStore) {
	...
	public AFFILIATION(Winery winery) {
	...
	public AFFILIATION(WorkersUnion workersUnion) {
