...
public class SOCIAL_MEDIA_POSTING implements Clazz.SocialMediaPosting {
	...
	public SOCIAL_MEDIA_POSTING() {
	}

	public SOCIAL_MEDIA_POSTING(Long seq) {
		setSeq(seq);
	}

	public SOCIAL_MEDIA_POSTING(String string) {
	...
	public SOCIAL_MEDIA_POSTING(About about) {
		setAbout(about);
	}
	...
	public SOCIAL_MEDIA_POSTING(AccessMode accessMode) {
	...
	public SOCIAL_MEDIA_POSTING(AccessModeSufficient accessModeSufficient) {
	...
	public SOCIAL_MEDIA_POSTING(AccessibilityAPI accessibilityAPI) {
	...
	public SOCIAL_MEDIA_POSTING(AccessibilityControl accessibilityControl) {
	...
	public SOCIAL_MEDIA_POSTING(AccessibilityFeature accessibilityFeature) {
	...
	public SOCIAL_MEDIA_POSTING(AccessibilityHazard accessibilityHazard) {
	...
	public SOCIAL_MEDIA_POSTING(AccessibilitySummary accessibilitySummary) {
	...
	public SOCIAL_MEDIA_POSTING(AccountablePerson accountablePerson) {
	...
	public SOCIAL_MEDIA_POSTING(AdditionalType additionalType) {
	...
	public SOCIAL_MEDIA_POSTING(AggregateRating aggregateRating) {
	...
	public SOCIAL_MEDIA_POSTING(AlternateName alternateName) {
	...
	public SOCIAL_MEDIA_POSTING(AlternativeHeadline alternativeHeadline) {
	...
	public SOCIAL_MEDIA_POSTING(ArticleBody articleBody) {
	...
	public SOCIAL_MEDIA_POSTING(ArticleSection articleSection) {
	...
	public SOCIAL_MEDIA_POSTING(AssociatedMedia associatedMedia) {
	...
	public SOCIAL_MEDIA_POSTING(Audience audience) {
	...
	public SOCIAL_MEDIA_POSTING(Audio audio) {
		setAudio(audio);
	}
	...
	public SOCIAL_MEDIA_POSTING(Author author) {
		setAuthor(author);
	}
	...
	public SOCIAL_MEDIA_POSTING(Award award) {
		setAward(award);
	}
	...
	public SOCIAL_MEDIA_POSTING(Backstory backstory) {
	...
	public SOCIAL_MEDIA_POSTING(Character character) {
	...
	public SOCIAL_MEDIA_POSTING(Citation citation) {
	...
	public SOCIAL_MEDIA_POSTING(Comment comment) {
		setComment(comment);
	}
	...
	public SOCIAL_MEDIA_POSTING(CommentCount commentCount) {
	...
	public SOCIAL_MEDIA_POSTING(ContentLocation contentLocation) {
	...
	public SOCIAL_MEDIA_POSTING(ContentRating contentRating) {
	...
	public SOCIAL_MEDIA_POSTING(ContentReferenceTime contentReferenceTime) {
	...
	public SOCIAL_MEDIA_POSTING(Contributor contributor) {
	...
	public SOCIAL_MEDIA_POSTING(CopyrightHolder copyrightHolder) {
	...
	public SOCIAL_MEDIA_POSTING(CopyrightYear copyrightYear) {
	...
	public SOCIAL_MEDIA_POSTING(Correction correction) {
	...
	public SOCIAL_MEDIA_POSTING(Creator creator) {
		setCreator(creator);
	}
	...
	public SOCIAL_MEDIA_POSTING(DateCreated dateCreated) {
	...
	public SOCIAL_MEDIA_POSTING(DateModified dateModified) {
	...
	public SOCIAL_MEDIA_POSTING(DatePublished datePublished) {
	...
	public SOCIAL_MEDIA_POSTING(Description description) {
	...
	public SOCIAL_MEDIA_POSTING(DisambiguatingDescription disambiguatingDescription) {
	...
	public SOCIAL_MEDIA_POSTING(DiscussionUrl discussionUrl) {
	...
	public SOCIAL_MEDIA_POSTING(Editor editor) {
		setEditor(editor);
	}
	...
	public SOCIAL_MEDIA_POSTING(EducationalAlignment educationalAlignment) {
	...
	public SOCIAL_MEDIA_POSTING(EducationalUse educationalUse) {
	...
	public SOCIAL_MEDIA_POSTING(Encoding encoding) {
	...
	public SOCIAL_MEDIA_POSTING(EncodingFormat encodingFormat) {
	...
	public SOCIAL_MEDIA_POSTING(ExampleOfWork exampleOfWork) {
	...
	public SOCIAL_MEDIA_POSTING(Expires expires) {
		setExpires(expires);
	}
	...
	public SOCIAL_MEDIA_POSTING(Funder funder) {
		setFunder(funder);
	}
	...
	public SOCIAL_MEDIA_POSTING(Genre genre) {
		setGenre(genre);
	}
	...
	public SOCIAL_MEDIA_POSTING(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public SOCIAL_MEDIA_POSTING(Headline headline) {
	...
	public SOCIAL_MEDIA_POSTING(Identifier identifier) {
	...
	public SOCIAL_MEDIA_POSTING(Image image) {
		setImage(image);
	}
	...
	public SOCIAL_MEDIA_POSTING(InLanguage inLanguage) {
	...
	public SOCIAL_MEDIA_POSTING(InteractionStatistic interactionStatistic) {
	...
	public SOCIAL_MEDIA_POSTING(InteractivityType interactivityType) {
	...
	public SOCIAL_MEDIA_POSTING(IsAccessibleForFree isAccessibleForFree) {
	...
	public SOCIAL_MEDIA_POSTING(IsBasedOn isBasedOn) {
	...
	public SOCIAL_MEDIA_POSTING(IsFamilyFriendly isFamilyFriendly) {
	...
	public SOCIAL_MEDIA_POSTING(IsPartOf isPartOf) {
	...
	public SOCIAL_MEDIA_POSTING(Keywords keywords) {
	...
	public SOCIAL_MEDIA_POSTING(LearningResourceType learningResourceType) {
	...
	public SOCIAL_MEDIA_POSTING(License license) {
		setLicense(license);
	}
	...
	public SOCIAL_MEDIA_POSTING(LocationCreated locationCreated) {
	...
	public SOCIAL_MEDIA_POSTING(MainEntity mainEntity) {
	...
	public SOCIAL_MEDIA_POSTING(MainEntityOfPage mainEntityOfPage) {
	...
	public SOCIAL_MEDIA_POSTING(Material material) {
	...
	public SOCIAL_MEDIA_POSTING(MaterialExtent materialExtent) {
	...
	public SOCIAL_MEDIA_POSTING(Mentions mentions) {
	...
	public SOCIAL_MEDIA_POSTING(Name name) {
		setName(name);
	}
	...
	public SOCIAL_MEDIA_POSTING(NameFuzzy nameFuzzy) {
	...
	public SOCIAL_MEDIA_POSTING(NameRuby nameRuby) {
	...
	public SOCIAL_MEDIA_POSTING(Offers offers) {
		setOffers(offers);
	}
	...
	public SOCIAL_MEDIA_POSTING(PageEnd pageEnd) {
		setPageEnd(pageEnd);
	}
	...
	public SOCIAL_MEDIA_POSTING(PageStart pageStart) {
	...
	public SOCIAL_MEDIA_POSTING(Pagination pagination) {
	...
	public SOCIAL_MEDIA_POSTING(Position position) {
	...
	public SOCIAL_MEDIA_POSTING(PotentialAction potentialAction) {
	...
	public SOCIAL_MEDIA_POSTING(Producer producer) {
	...
	public SOCIAL_MEDIA_POSTING(Provider provider) {
	...
	public SOCIAL_MEDIA_POSTING(Publication publication) {
	...
	public SOCIAL_MEDIA_POSTING(Publisher publisher) {
	...
	public SOCIAL_MEDIA_POSTING(PublisherImprint publisherImprint) {
	...
	public SOCIAL_MEDIA_POSTING(PublishingPrinciples publishingPrinciples) {
	...
	public SOCIAL_MEDIA_POSTING(RecordedAt recordedAt) {
	...
	public SOCIAL_MEDIA_POSTING(ReleasedEvent releasedEvent) {
	...
	public SOCIAL_MEDIA_POSTING(Review review) {
		setReview(review);
	}
	...
	public SOCIAL_MEDIA_POSTING(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SOCIAL_MEDIA_POSTING(SchemaVersion schemaVersion) {
	...
	public SOCIAL_MEDIA_POSTING(SdDatePublished sdDatePublished) {
	...
	public SOCIAL_MEDIA_POSTING(SdLicense sdLicense) {
	...
	public SOCIAL_MEDIA_POSTING(SdPublisher sdPublisher) {
	...
	public SOCIAL_MEDIA_POSTING(SharedContent sharedContent) {
	...
	public SOCIAL_MEDIA_POSTING(SourceOrganization sourceOrganization) {
	...
	public SOCIAL_MEDIA_POSTING(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public SOCIAL_MEDIA_POSTING(SpatialCoverage spatialCoverage) {
	...
	public SOCIAL_MEDIA_POSTING(Speakable speakable) {
	...
	public SOCIAL_MEDIA_POSTING(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public SOCIAL_MEDIA_POSTING(SubjectOf subjectOf) {
	...
	public SOCIAL_MEDIA_POSTING(Temporal temporal) {
	...
	public SOCIAL_MEDIA_POSTING(TemporalCoverage temporalCoverage) {
	...
	public SOCIAL_MEDIA_POSTING(Text text) {
		setText(text);
	}
	...
	public SOCIAL_MEDIA_POSTING(ThumbnailUrl thumbnailUrl) {
	...
	public SOCIAL_MEDIA_POSTING(TimeRequired timeRequired) {
	...
	public SOCIAL_MEDIA_POSTING(TranslationOfWork translationOfWork) {
	...
	public SOCIAL_MEDIA_POSTING(Translator translator) {
	...
	public SOCIAL_MEDIA_POSTING(TypicalAgeRange typicalAgeRange) {
	...
	public SOCIAL_MEDIA_POSTING(Url url) {
		setUrl(url);
	}
	...
	public SOCIAL_MEDIA_POSTING(Version version) {
		setVersion(version);
	}
	...
	public SOCIAL_MEDIA_POSTING(Video video) {
		setVideo(video);
	}
	...
	public SOCIAL_MEDIA_POSTING(WordCount wordCount) {
	...
	public SOCIAL_MEDIA_POSTING(WorkExample workExample) {
	...
	public SOCIAL_MEDIA_POSTING(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.SocialMediaPosting org) {
		setSeq(org.getSeq());
