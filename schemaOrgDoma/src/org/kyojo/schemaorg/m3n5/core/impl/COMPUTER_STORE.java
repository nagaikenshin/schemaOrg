...
public class COMPUTER_STORE implements Clazz.ComputerStore {
	...
	public COMPUTER_STORE(GeoContains geoContains) {
	...
	public COMPUTER_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public COMPUTER_STORE(GeoCovers geoCovers) {
	...
	public COMPUTER_STORE(GeoCrosses geoCrosses) {
	...
	public COMPUTER_STORE(GeoDisjoint geoDisjoint) {
	...
	public COMPUTER_STORE(GeoEquals geoEquals) {
	...
	public COMPUTER_STORE(GeoIntersects geoIntersects) {
	...
	public COMPUTER_STORE(GeoOverlaps geoOverlaps) {
	...
	public COMPUTER_STORE(GeoTouches geoTouches) {
	...
	public COMPUTER_STORE(GeoWithin geoWithin) {
	...
	public COMPUTER_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
