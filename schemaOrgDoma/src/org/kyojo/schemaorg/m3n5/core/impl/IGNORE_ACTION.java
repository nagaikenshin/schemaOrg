...
public class IGNORE_ACTION implements Clazz.IgnoreAction {
	...
	public IGNORE_ACTION() {
	}

	public IGNORE_ACTION(Long seq) {
		setSeq(seq);
	}

	public IGNORE_ACTION(String string) {
	...
	public IGNORE_ACTION(ActionStatus actionStatus) {
	...
	public IGNORE_ACTION(AdditionalType additionalType) {
	...
	public IGNORE_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public IGNORE_ACTION(AlternateName alternateName) {
	...
	public IGNORE_ACTION(Description description) {
	...
	public IGNORE_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public IGNORE_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public IGNORE_ACTION(Error error) {
		setError(error);
	}
	...
	public IGNORE_ACTION(Identifier identifier) {
	...
	public IGNORE_ACTION(Image image) {
		setImage(image);
	}
	...
	public IGNORE_ACTION(Instrument instrument) {
	...
	public IGNORE_ACTION(Location location) {
	...
	public IGNORE_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public IGNORE_ACTION(Name name) {
		setName(name);
	}
	...
	public IGNORE_ACTION(NameFuzzy nameFuzzy) {
	...
	public IGNORE_ACTION(NameRuby nameRuby) {
	...
	public IGNORE_ACTION(Object object) {
		setObject(object);
	}
	...
	public IGNORE_ACTION(Participant participant) {
	...
	public IGNORE_ACTION(PotentialAction potentialAction) {
	...
	public IGNORE_ACTION(Result result) {
		setResult(result);
	}
	...
	public IGNORE_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public IGNORE_ACTION(StartTime startTime) {
	...
	public IGNORE_ACTION(SubjectOf subjectOf) {
	...
	public IGNORE_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.IgnoreAction org) {
		setSeq(org.getSeq());
