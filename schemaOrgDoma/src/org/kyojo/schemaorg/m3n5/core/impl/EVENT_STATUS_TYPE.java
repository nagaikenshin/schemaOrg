...
public class EVENT_STATUS_TYPE implements Clazz.EventStatusType {
	...
	public EVENT_STATUS_TYPE(Long seq) {
		setSeq(seq);
	}

	public EVENT_STATUS_TYPE(String string) {
	...
	public EVENT_STATUS_TYPE(AdditionalType additionalType) {
	...
	public EVENT_STATUS_TYPE(AlternateName alternateName) {
	...
	public EVENT_STATUS_TYPE(Description description) {
	...
	public EVENT_STATUS_TYPE(DisambiguatingDescription disambiguatingDescription) {
	...
	public EVENT_STATUS_TYPE(Identifier identifier) {
	...
	public EVENT_STATUS_TYPE(Image image) {
		setImage(image);
	}
	...
	public EVENT_STATUS_TYPE(MainEntityOfPage mainEntityOfPage) {
	...
	public EVENT_STATUS_TYPE(Name name) {
		setName(name);
	}
	...
	public EVENT_STATUS_TYPE(NameFuzzy nameFuzzy) {
	...
	public EVENT_STATUS_TYPE(NameRuby nameRuby) {
	...
	public EVENT_STATUS_TYPE(PotentialAction potentialAction) {
	...
	public EVENT_STATUS_TYPE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public EVENT_STATUS_TYPE(SubjectOf subjectOf) {
	...
	public EVENT_STATUS_TYPE(SupersededBy supersededBy) {
	...
	public EVENT_STATUS_TYPE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.EventStatusType org) {
		setSeq(org.getSeq());
