...
public class TIRE_SHOP implements Clazz.TireShop {
	...
	public TIRE_SHOP(GeoContains geoContains) {
	...
	public TIRE_SHOP(GeoCoveredBy geoCoveredBy) {
	...
	public TIRE_SHOP(GeoCovers geoCovers) {
	...
	public TIRE_SHOP(GeoCrosses geoCrosses) {
	...
	public TIRE_SHOP(GeoDisjoint geoDisjoint) {
	...
	public TIRE_SHOP(GeoEquals geoEquals) {
	...
	public TIRE_SHOP(GeoIntersects geoIntersects) {
	...
	public TIRE_SHOP(GeoOverlaps geoOverlaps) {
	...
	public TIRE_SHOP(GeoTouches geoTouches) {
	...
	public TIRE_SHOP(GeoWithin geoWithin) {
	...
	public TIRE_SHOP(Slogan slogan) {
		setSlogan(slogan);
	}
