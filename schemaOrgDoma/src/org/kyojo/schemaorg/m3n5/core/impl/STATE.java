...
public class STATE implements Clazz.State {
	...
	public STATE(GeoContains geoContains) {
	...
	public STATE(GeoCoveredBy geoCoveredBy) {
	...
	public STATE(GeoCovers geoCovers) {
	...
	public STATE(GeoCrosses geoCrosses) {
	...
	public STATE(GeoDisjoint geoDisjoint) {
	...
	public STATE(GeoEquals geoEquals) {
	...
	public STATE(GeoIntersects geoIntersects) {
	...
	public STATE(GeoOverlaps geoOverlaps) {
	...
	public STATE(GeoTouches geoTouches) {
	...
	public STATE(GeoWithin geoWithin) {
