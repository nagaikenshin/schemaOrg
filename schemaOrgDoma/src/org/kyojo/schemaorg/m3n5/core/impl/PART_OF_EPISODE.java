...
public class PART_OF_EPISODE implements Container.PartOfEpisode {
	...
	public String getString() {
		if(episodeList == null || episodeList.size() == 0 || episodeList.get(0) == null) {
			...
			Name name = episodeList.get(0).getName();
	...
	public void setString(String string) {
		...
		if(episodeList.size() == 0) {
			episodeList.add(new EPISODE(string));
		} else {
			episodeList.set(0, new EPISODE(string));
		}
	}

	public PART_OF_EPISODE(APIReference apiReference) {
	...
	public PART_OF_EPISODE(AboutPage aboutPage) {
	...
	public PART_OF_EPISODE(AdvertiserContentArticle advertiserContentArticle) {
	...
	public PART_OF_EPISODE(AnalysisNewsArticle analysisNewsArticle) {
	...
	public PART_OF_EPISODE(Answer answer) {
	...
	public PART_OF_EPISODE(ArchiveComponent archiveComponent) {
	...
	public PART_OF_EPISODE(Article article) {
	...
	public PART_OF_EPISODE(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public PART_OF_EPISODE(Atlas atlas) {
	...
	public PART_OF_EPISODE(AudioObject audioObject) {
	...
	public PART_OF_EPISODE(Audiobook audiobook) {
	...
	public PART_OF_EPISODE(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public PART_OF_EPISODE(Barcode barcode) {
	...
	public PART_OF_EPISODE(Blog blog) {
	...
	public PART_OF_EPISODE(BlogPosting blogPosting) {
	...
	public PART_OF_EPISODE(Book book) {
	...
	public PART_OF_EPISODE(BookSeries bookSeries) {
	...
	public PART_OF_EPISODE(CategoryCodeSet categoryCodeSet) {
	...
	public PART_OF_EPISODE(Chapter chapter) {
	...
	public PART_OF_EPISODE(CheckoutPage checkoutPage) {
	...
	public PART_OF_EPISODE(Claim claim) {
	...
	public PART_OF_EPISODE(ClaimReview claimReview) {
	...
	public PART_OF_EPISODE(Clip clip) {
	...
	public PART_OF_EPISODE(Collection collection) {
	...
	public PART_OF_EPISODE(CollectionPage collectionPage) {
	...
	public PART_OF_EPISODE(ComicCoverArt comicCoverArt) {
	...
	public PART_OF_EPISODE(ComicIssue comicIssue) {
	...
	public PART_OF_EPISODE(ComicSeries comicSeries) {
	...
	public PART_OF_EPISODE(ComicStory comicStory) {
	...
	public PART_OF_EPISODE(Comment comment) {
	...
	public PART_OF_EPISODE(CompleteDataFeed completeDataFeed) {
	...
	public PART_OF_EPISODE(ContactPage contactPage) {
	...
	public PART_OF_EPISODE(Conversation conversation) {
	...
	public PART_OF_EPISODE(CorrectionComment correctionComment) {
	...
	public PART_OF_EPISODE(Course course) {
	...
	public PART_OF_EPISODE(CoverArt coverArt) {
	...
	public PART_OF_EPISODE(CreativeWorkSeason creativeWorkSeason) {
	...
	public PART_OF_EPISODE(CreativeWorkSeries creativeWorkSeries) {
	...
	public PART_OF_EPISODE(CriticReview criticReview) {
	...
	public PART_OF_EPISODE(DataCatalog dataCatalog) {
	...
	public PART_OF_EPISODE(DataDownload dataDownload) {
	...
	public PART_OF_EPISODE(DataFeed dataFeed) {
	...
	public PART_OF_EPISODE(Dataset dataset) {
	...
	public PART_OF_EPISODE(DefinedTermSet definedTermSet) {
	...
	public PART_OF_EPISODE(Diet diet) {
	...
	public PART_OF_EPISODE(DigitalDocument digitalDocument) {
	...
	public PART_OF_EPISODE(DiscussionForumPosting discussionForumPosting) {
	...
	public PART_OF_EPISODE(Drawing drawing) {
	...
	public PART_OF_EPISODE(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public PART_OF_EPISODE(EmailMessage emailMessage) {
	...
	public PART_OF_EPISODE(EmployerReview employerReview) {
	...
	public PART_OF_EPISODE(ExercisePlan exercisePlan) {
	...
	public PART_OF_EPISODE(FAQPage faqPage) {
	...
	public PART_OF_EPISODE(Game game) {
	...
	public PART_OF_EPISODE(HowTo howTo) {
	...
	public PART_OF_EPISODE(HowToDirection howToDirection) {
	...
	public PART_OF_EPISODE(HowToSection howToSection) {
	...
	public PART_OF_EPISODE(HowToStep howToStep) {
	...
	public PART_OF_EPISODE(HowToTip howToTip) {
	...
	public PART_OF_EPISODE(ImageGallery imageGallery) {
	...
	public PART_OF_EPISODE(ImageObject imageObject) {
	...
	public PART_OF_EPISODE(ItemPage itemPage) {
	...
	public PART_OF_EPISODE(Legislation legislation) {
	...
	public PART_OF_EPISODE(LegislationObject legislationObject) {
	...
	public PART_OF_EPISODE(LiveBlogPosting liveBlogPosting) {
	...
	public PART_OF_EPISODE(Manuscript manuscript) {
	...
	public PART_OF_EPISODE(Map map) {
	...
	public PART_OF_EPISODE(MediaObject mediaObject) {
	...
	public PART_OF_EPISODE(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public PART_OF_EPISODE(MedicalWebPage medicalWebPage) {
	...
	public PART_OF_EPISODE(Menu menu) {
	...
	public PART_OF_EPISODE(MenuSection menuSection) {
	...
	public PART_OF_EPISODE(Message message) {
	...
	public PART_OF_EPISODE(MobileApplication mobileApplication) {
	...
	public PART_OF_EPISODE(Movie movie) {
	...
	public PART_OF_EPISODE(MovieClip movieClip) {
	...
	public PART_OF_EPISODE(MovieSeries movieSeries) {
	...
	public PART_OF_EPISODE(MusicAlbum musicAlbum) {
	...
	public PART_OF_EPISODE(MusicComposition musicComposition) {
	...
	public PART_OF_EPISODE(MusicPlaylist musicPlaylist) {
	...
	public PART_OF_EPISODE(MusicRecording musicRecording) {
	...
	public PART_OF_EPISODE(MusicRelease musicRelease) {
	...
	public PART_OF_EPISODE(MusicVideoObject musicVideoObject) {
	...
	public PART_OF_EPISODE(NewsArticle newsArticle) {
	...
	public PART_OF_EPISODE(Newspaper newspaper) {
	...
	public PART_OF_EPISODE(NoteDigitalDocument noteDigitalDocument) {
	...
	public PART_OF_EPISODE(OpinionNewsArticle opinionNewsArticle) {
	...
	public PART_OF_EPISODE(Painting painting) {
	...
	public PART_OF_EPISODE(Periodical periodical) {
	...
	public PART_OF_EPISODE(Photograph photograph) {
	...
	public PART_OF_EPISODE(Play play) {
	...
	public PART_OF_EPISODE(Poster poster) {
	...
	public PART_OF_EPISODE(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public PART_OF_EPISODE(ProfilePage profilePage) {
	...
	public PART_OF_EPISODE(PublicationIssue publicationIssue) {
	...
	public PART_OF_EPISODE(PublicationVolume publicationVolume) {
	...
	public PART_OF_EPISODE(QAPage qaPage) {
	...
	public PART_OF_EPISODE(Question question) {
	...
	public PART_OF_EPISODE(Quotation quotation) {
	...
	public PART_OF_EPISODE(RadioClip radioClip) {
	...
	public PART_OF_EPISODE(RadioEpisode radioEpisode) {
	...
	public PART_OF_EPISODE(RadioSeason radioSeason) {
	...
	public PART_OF_EPISODE(RadioSeries radioSeries) {
	...
	public PART_OF_EPISODE(Recipe recipe) {
	...
	public PART_OF_EPISODE(Report report) {
	...
	public PART_OF_EPISODE(ReportageNewsArticle reportageNewsArticle) {
	...
	public PART_OF_EPISODE(Review review) {
	...
	public PART_OF_EPISODE(ReviewNewsArticle reviewNewsArticle) {
	...
	public PART_OF_EPISODE(SatiricalArticle satiricalArticle) {
	...
	public PART_OF_EPISODE(ScholarlyArticle scholarlyArticle) {
	...
	public PART_OF_EPISODE(Sculpture sculpture) {
	...
	public PART_OF_EPISODE(SearchResultsPage searchResultsPage) {
	...
	public PART_OF_EPISODE(SheetMusic sheetMusic) {
	...
	public PART_OF_EPISODE(ShortStory shortStory) {
	...
	public PART_OF_EPISODE(SiteNavigationElement siteNavigationElement) {
	...
	public PART_OF_EPISODE(SocialMediaPosting socialMediaPosting) {
	...
	public PART_OF_EPISODE(SoftwareApplication softwareApplication) {
	...
	public PART_OF_EPISODE(SoftwareSourceCode softwareSourceCode) {
	...
	public PART_OF_EPISODE(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public PART_OF_EPISODE(TVClip tvClip) {
	...
	public PART_OF_EPISODE(TVEpisode tvEpisode) {
	...
	public PART_OF_EPISODE(TVSeason tvSeason) {
	...
	public PART_OF_EPISODE(TVSeries tvSeries) {
	...
	public PART_OF_EPISODE(Table table) {
	...
	public PART_OF_EPISODE(TechArticle techArticle) {
	...
	public PART_OF_EPISODE(TextDigitalDocument textDigitalDocument) {
	...
	public PART_OF_EPISODE(Thesis thesis) {
	...
	public PART_OF_EPISODE(ThreeDimensionalModel threeDimensionalModel) {
	...
	public PART_OF_EPISODE(UserReview userReview) {
	...
	public PART_OF_EPISODE(VideoGallery videoGallery) {
	...
	public PART_OF_EPISODE(VideoGame videoGame) {
	...
	public PART_OF_EPISODE(VideoGameClip videoGameClip) {
	...
	public PART_OF_EPISODE(VideoGameSeries videoGameSeries) {
	...
	public PART_OF_EPISODE(VideoObject videoObject) {
	...
	public PART_OF_EPISODE(VisualArtwork visualArtwork) {
	...
	public PART_OF_EPISODE(WPAdBlock wpAdBlock) {
	...
	public PART_OF_EPISODE(WPFooter wpFooter) {
	...
	public PART_OF_EPISODE(WPHeader wpHeader) {
	...
	public PART_OF_EPISODE(WPSideBar wpSideBar) {
	...
	public PART_OF_EPISODE(WebApplication webApplication) {
	...
	public PART_OF_EPISODE(WebPage webPage) {
	...
	public PART_OF_EPISODE(WebPageElement webPageElement) {
	...
	public PART_OF_EPISODE(WebSite webSite) {
