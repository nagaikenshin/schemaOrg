...
public class ACHIEVE_ACTION implements Clazz.AchieveAction {
	...
	public ACHIEVE_ACTION() {
	}

	public ACHIEVE_ACTION(Long seq) {
		setSeq(seq);
	}

	public ACHIEVE_ACTION(String string) {
	...
	public ACHIEVE_ACTION(ActionStatus actionStatus) {
	...
	public ACHIEVE_ACTION(AdditionalType additionalType) {
	...
	public ACHIEVE_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public ACHIEVE_ACTION(AlternateName alternateName) {
	...
	public ACHIEVE_ACTION(Description description) {
	...
	public ACHIEVE_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public ACHIEVE_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public ACHIEVE_ACTION(Error error) {
		setError(error);
	}
	...
	public ACHIEVE_ACTION(Identifier identifier) {
	...
	public ACHIEVE_ACTION(Image image) {
		setImage(image);
	}
	...
	public ACHIEVE_ACTION(Instrument instrument) {
	...
	public ACHIEVE_ACTION(Location location) {
	...
	public ACHIEVE_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public ACHIEVE_ACTION(Name name) {
		setName(name);
	}
	...
	public ACHIEVE_ACTION(NameFuzzy nameFuzzy) {
	...
	public ACHIEVE_ACTION(NameRuby nameRuby) {
	...
	public ACHIEVE_ACTION(Object object) {
		setObject(object);
	}
	...
	public ACHIEVE_ACTION(Participant participant) {
	...
	public ACHIEVE_ACTION(PotentialAction potentialAction) {
	...
	public ACHIEVE_ACTION(Result result) {
		setResult(result);
	}
	...
	public ACHIEVE_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ACHIEVE_ACTION(StartTime startTime) {
	...
	public ACHIEVE_ACTION(SubjectOf subjectOf) {
	...
	public ACHIEVE_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.AchieveAction org) {
		setSeq(org.getSeq());
