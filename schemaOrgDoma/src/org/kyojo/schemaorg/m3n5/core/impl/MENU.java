...
public class MENU implements Clazz.Menu {
	...
	public MENU(AccessMode accessMode) {
	...
	public MENU(AccessModeSufficient accessModeSufficient) {
	...
	public MENU(AccessibilityAPI accessibilityAPI) {
	...
	public MENU(AccessibilityControl accessibilityControl) {
	...
	public MENU(AccessibilityFeature accessibilityFeature) {
	...
	public MENU(AccessibilityHazard accessibilityHazard) {
	...
	public MENU(AccessibilitySummary accessibilitySummary) {
	...
	public MENU(AccountablePerson accountablePerson) {
	...
	public MENU(AdditionalType additionalType) {
	...
	public MENU(AggregateRating aggregateRating) {
	...
	public MENU(AlternateName alternateName) {
	...
	public MENU(AlternativeHeadline alternativeHeadline) {
	...
	public MENU(AssociatedMedia associatedMedia) {
	...
	public MENU(CommentCount commentCount) {
	...
	public MENU(ContentLocation contentLocation) {
	...
	public MENU(ContentRating contentRating) {
	...
	public MENU(ContentReferenceTime contentReferenceTime) {
	...
	public MENU(Contributor contributor) {
	...
	public MENU(CopyrightHolder copyrightHolder) {
	...
	public MENU(CopyrightYear copyrightYear) {
	...
	public MENU(Correction correction) {
	...
	public MENU(DateCreated dateCreated) {
	...
	public MENU(DateModified dateModified) {
	...
	public MENU(DatePublished datePublished) {
	...
	public MENU(Description description) {
	...
	public MENU(DisambiguatingDescription disambiguatingDescription) {
	...
	public MENU(DiscussionUrl discussionUrl) {
	...
	public MENU(EducationalAlignment educationalAlignment) {
	...
	public MENU(EducationalUse educationalUse) {
	...
	public MENU(EncodingFormat encodingFormat) {
	...
	public MENU(ExampleOfWork exampleOfWork) {
	...
	public MENU(HasMenuItem hasMenuItem) {
	...
	public MENU(HasMenuSection hasMenuSection) {
	...
	public MENU(Identifier identifier) {
	...
	public MENU(InLanguage inLanguage) {
	...
	public MENU(InteractionStatistic interactionStatistic) {
	...
	public MENU(InteractivityType interactivityType) {
	...
	public MENU(IsAccessibleForFree isAccessibleForFree) {
	...
	public MENU(IsBasedOn isBasedOn) {
	...
	public MENU(IsFamilyFriendly isFamilyFriendly) {
	...
	public MENU(LearningResourceType learningResourceType) {
	...
	public MENU(LocationCreated locationCreated) {
	...
	public MENU(MainEntity mainEntity) {
	...
	public MENU(MainEntityOfPage mainEntityOfPage) {
	...
	public MENU(MaterialExtent materialExtent) {
	...
	public MENU(NameFuzzy nameFuzzy) {
	...
	public MENU(PotentialAction potentialAction) {
	...
	public MENU(Publication publication) {
	...
	public MENU(PublisherImprint publisherImprint) {
	...
	public MENU(PublishingPrinciples publishingPrinciples) {
	...
	public MENU(RecordedAt recordedAt) {
	...
	public MENU(ReleasedEvent releasedEvent) {
	...
	public MENU(SchemaVersion schemaVersion) {
	...
	public MENU(SdDatePublished sdDatePublished) {
	...
	public MENU(SdLicense sdLicense) {
	...
	public MENU(SdPublisher sdPublisher) {
	...
	public MENU(SourceOrganization sourceOrganization) {
	...
	public MENU(SpatialCoverage spatialCoverage) {
	...
	public MENU(SubjectOf subjectOf) {
	...
	public MENU(TemporalCoverage temporalCoverage) {
	...
	public MENU(ThumbnailUrl thumbnailUrl) {
	...
	public MENU(TimeRequired timeRequired) {
	...
	public MENU(TranslationOfWork translationOfWork) {
	...
	public MENU(TypicalAgeRange typicalAgeRange) {
	...
	public MENU(WorkExample workExample) {
	...
	public MENU(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Menu org) {
		setSeq(org.getSeq());
