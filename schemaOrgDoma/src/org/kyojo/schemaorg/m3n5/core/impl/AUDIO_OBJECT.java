...
public class AUDIO_OBJECT implements Clazz.AudioObject {
	...
	public AUDIO_OBJECT(Long seq) {
		setSeq(seq);
	}

	public AUDIO_OBJECT(String string) {
	...
	public AUDIO_OBJECT(About about) {
		setAbout(about);
	}
	...
	public AUDIO_OBJECT(AccessMode accessMode) {
	...
	public AUDIO_OBJECT(AccessModeSufficient accessModeSufficient) {
	...
	public AUDIO_OBJECT(AccessibilityAPI accessibilityAPI) {
	...
	public AUDIO_OBJECT(AccessibilityControl accessibilityControl) {
	...
	public AUDIO_OBJECT(AccessibilityFeature accessibilityFeature) {
	...
	public AUDIO_OBJECT(AccessibilityHazard accessibilityHazard) {
	...
	public AUDIO_OBJECT(AccessibilitySummary accessibilitySummary) {
	...
	public AUDIO_OBJECT(AccountablePerson accountablePerson) {
	...
	public AUDIO_OBJECT(AdditionalType additionalType) {
	...
	public AUDIO_OBJECT(AggregateRating aggregateRating) {
	...
	public AUDIO_OBJECT(AlternateName alternateName) {
	...
	public AUDIO_OBJECT(AlternativeHeadline alternativeHeadline) {
	...
	public AUDIO_OBJECT(AssociatedArticle associatedArticle) {
	...
	public AUDIO_OBJECT(AssociatedMedia associatedMedia) {
	...
	public AUDIO_OBJECT(Audience audience) {
	...
	public AUDIO_OBJECT(Audio audio) {
		setAudio(audio);
	}
	...
	public AUDIO_OBJECT(Author author) {
		setAuthor(author);
	}
	...
	public AUDIO_OBJECT(Award award) {
		setAward(award);
	}
	...
	public AUDIO_OBJECT(Bitrate bitrate) {
		setBitrate(bitrate);
	}
	...
	public AUDIO_OBJECT(Caption caption) {
		setCaption(caption);
	}
	...
	public AUDIO_OBJECT(Character character) {
	...
	public AUDIO_OBJECT(Citation citation) {
	...
	public AUDIO_OBJECT(Comment comment) {
		setComment(comment);
	}
	...
	public AUDIO_OBJECT(CommentCount commentCount) {
	...
	public AUDIO_OBJECT(ContentLocation contentLocation) {
	...
	public AUDIO_OBJECT(ContentRating contentRating) {
	...
	public AUDIO_OBJECT(ContentReferenceTime contentReferenceTime) {
	...
	public AUDIO_OBJECT(ContentSize contentSize) {
	...
	public AUDIO_OBJECT(ContentUrl contentUrl) {
	...
	public AUDIO_OBJECT(Contributor contributor) {
	...
	public AUDIO_OBJECT(CopyrightHolder copyrightHolder) {
	...
	public AUDIO_OBJECT(CopyrightYear copyrightYear) {
	...
	public AUDIO_OBJECT(Correction correction) {
	...
	public AUDIO_OBJECT(Creator creator) {
		setCreator(creator);
	}
	...
	public AUDIO_OBJECT(DateCreated dateCreated) {
	...
	public AUDIO_OBJECT(DateModified dateModified) {
	...
	public AUDIO_OBJECT(DatePublished datePublished) {
	...
	public AUDIO_OBJECT(Description description) {
	...
	public AUDIO_OBJECT(DisambiguatingDescription disambiguatingDescription) {
	...
	public AUDIO_OBJECT(DiscussionUrl discussionUrl) {
	...
	public AUDIO_OBJECT(Duration duration) {
	...
	public AUDIO_OBJECT(Editor editor) {
		setEditor(editor);
	}
	...
	public AUDIO_OBJECT(EducationalAlignment educationalAlignment) {
	...
	public AUDIO_OBJECT(EducationalUse educationalUse) {
	...
	public AUDIO_OBJECT(EmbedUrl embedUrl) {
	...
	public AUDIO_OBJECT(EncodesCreativeWork encodesCreativeWork) {
	...
	public AUDIO_OBJECT(Encoding encoding) {
	...
	public AUDIO_OBJECT(EncodingFormat encodingFormat) {
	...
	public AUDIO_OBJECT(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public AUDIO_OBJECT(ExampleOfWork exampleOfWork) {
	...
	public AUDIO_OBJECT(Expires expires) {
		setExpires(expires);
	}
	...
	public AUDIO_OBJECT(Funder funder) {
		setFunder(funder);
	}
	...
	public AUDIO_OBJECT(Genre genre) {
		setGenre(genre);
	}
	...
	public AUDIO_OBJECT(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public AUDIO_OBJECT(Headline headline) {
	...
	public AUDIO_OBJECT(Height height) {
		setHeight(height);
	}
	...
	public AUDIO_OBJECT(Identifier identifier) {
	...
	public AUDIO_OBJECT(Image image) {
		setImage(image);
	}
	...
	public AUDIO_OBJECT(InLanguage inLanguage) {
	...
	public AUDIO_OBJECT(InteractionStatistic interactionStatistic) {
	...
	public AUDIO_OBJECT(InteractivityType interactivityType) {
	...
	public AUDIO_OBJECT(IsAccessibleForFree isAccessibleForFree) {
	...
	public AUDIO_OBJECT(IsBasedOn isBasedOn) {
	...
	public AUDIO_OBJECT(IsFamilyFriendly isFamilyFriendly) {
	...
	public AUDIO_OBJECT(IsPartOf isPartOf) {
	...
	public AUDIO_OBJECT(Keywords keywords) {
	...
	public AUDIO_OBJECT(LearningResourceType learningResourceType) {
	...
	public AUDIO_OBJECT(License license) {
		setLicense(license);
	}
	...
	public AUDIO_OBJECT(LocationCreated locationCreated) {
	...
	public AUDIO_OBJECT(MainEntity mainEntity) {
	...
	public AUDIO_OBJECT(MainEntityOfPage mainEntityOfPage) {
	...
	public AUDIO_OBJECT(Material material) {
	...
	public AUDIO_OBJECT(MaterialExtent materialExtent) {
	...
	public AUDIO_OBJECT(Mentions mentions) {
	...
	public AUDIO_OBJECT(NameFuzzy nameFuzzy) {
	...
	public AUDIO_OBJECT(NameRuby nameRuby) {
	...
	public AUDIO_OBJECT(Offers offers) {
		setOffers(offers);
	}
	...
	public AUDIO_OBJECT(PlayerType playerType) {
	...
	public AUDIO_OBJECT(Position position) {
	...
	public AUDIO_OBJECT(PotentialAction potentialAction) {
	...
	public AUDIO_OBJECT(Producer producer) {
	...
	public AUDIO_OBJECT(ProductionCompany productionCompany) {
	...
	public AUDIO_OBJECT(Provider provider) {
	...
	public AUDIO_OBJECT(Publication publication) {
	...
	public AUDIO_OBJECT(Publisher publisher) {
	...
	public AUDIO_OBJECT(PublisherImprint publisherImprint) {
	...
	public AUDIO_OBJECT(PublishingPrinciples publishingPrinciples) {
	...
	public AUDIO_OBJECT(RecordedAt recordedAt) {
	...
	public AUDIO_OBJECT(RegionsAllowed regionsAllowed) {
	...
	public AUDIO_OBJECT(ReleasedEvent releasedEvent) {
	...
	public AUDIO_OBJECT(RequiresSubscription requiresSubscription) {
	...
	public AUDIO_OBJECT(Review review) {
		setReview(review);
	}
	...
	public AUDIO_OBJECT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public AUDIO_OBJECT(SchemaVersion schemaVersion) {
	...
	public AUDIO_OBJECT(SdDatePublished sdDatePublished) {
	...
	public AUDIO_OBJECT(SdLicense sdLicense) {
	...
	public AUDIO_OBJECT(SdPublisher sdPublisher) {
	...
	public AUDIO_OBJECT(SourceOrganization sourceOrganization) {
	...
	public AUDIO_OBJECT(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public AUDIO_OBJECT(SpatialCoverage spatialCoverage) {
	...
	public AUDIO_OBJECT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public AUDIO_OBJECT(StartTime startTime) {
	...
	public AUDIO_OBJECT(SubjectOf subjectOf) {
	...
	public AUDIO_OBJECT(Temporal temporal) {
	...
	public AUDIO_OBJECT(TemporalCoverage temporalCoverage) {
	...
	public AUDIO_OBJECT(ThumbnailUrl thumbnailUrl) {
	...
	public AUDIO_OBJECT(TimeRequired timeRequired) {
	...
	public AUDIO_OBJECT(Transcript transcript) {
	...
	public AUDIO_OBJECT(TranslationOfWork translationOfWork) {
	...
	public AUDIO_OBJECT(Translator translator) {
	...
	public AUDIO_OBJECT(TypicalAgeRange typicalAgeRange) {
	...
	public AUDIO_OBJECT(UploadDate uploadDate) {
	...
	public AUDIO_OBJECT(Version version) {
		setVersion(version);
	}
	...
	public AUDIO_OBJECT(Video video) {
		setVideo(video);
	}
	...
	public AUDIO_OBJECT(Width width) {
		setWidth(width);
	}
	...
	public AUDIO_OBJECT(WorkExample workExample) {
	...
	public AUDIO_OBJECT(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.AudioObject org) {
		setSeq(org.getSeq());
