...
public class PROVIDER implements Container.Provider {
	...
	public PROVIDER(AccountingService accountingService) {
	...
	public PROVIDER(AdultEntertainment adultEntertainment) {
	...
	public PROVIDER(Airline airline) {
	...
	public PROVIDER(AmusementPark amusementPark) {
	...
	public PROVIDER(AnimalShelter animalShelter) {
	...
	public PROVIDER(ArchiveOrganization archiveOrganization) {
	...
	public PROVIDER(ArtGallery artGallery) {
	...
	public PROVIDER(Attorney attorney) {
	...
	public PROVIDER(AutoBodyShop autoBodyShop) {
	...
	public PROVIDER(AutoDealer autoDealer) {
	...
	public PROVIDER(AutoPartsStore autoPartsStore) {
	...
	public PROVIDER(AutoRental autoRental) {
	...
	public PROVIDER(AutoRepair autoRepair) {
	...
	public PROVIDER(AutoWash autoWash) {
	...
	public PROVIDER(AutomatedTeller automatedTeller) {
	...
	public PROVIDER(AutomotiveBusiness automotiveBusiness) {
	...
	public PROVIDER(BankOrCreditUnion bankOrCreditUnion) {
	...
	public PROVIDER(BarOrPub barOrPub) {
	...
	public PROVIDER(BeautySalon beautySalon) {
	...
	public PROVIDER(BedAndBreakfast bedAndBreakfast) {
	...
	public PROVIDER(BikeStore bikeStore) {
	...
	public PROVIDER(BookStore bookStore) {
	...
	public PROVIDER(BowlingAlley bowlingAlley) {
	...
	public PROVIDER(Brewery brewery) {
	...
	public PROVIDER(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public PROVIDER(Campground campground) {
	...
	public PROVIDER(ChildCare childCare) {
	...
	public PROVIDER(ClothingStore clothingStore) {
	...
	public PROVIDER(CollegeOrUniversity collegeOrUniversity) {
	...
	public PROVIDER(ComedyClub comedyClub) {
	...
	public PROVIDER(CommunityHealth communityHealth) {
	...
	public PROVIDER(ComputerStore computerStore) {
	...
	public PROVIDER(Consortium consortium) {
	...
	public PROVIDER(ConvenienceStore convenienceStore) {
	...
	public PROVIDER(Corporation corporation) {
	...
	public PROVIDER(DanceGroup danceGroup) {
	...
	public PROVIDER(Dentist dentist) {
	...
	public PROVIDER(DepartmentStore departmentStore) {
	...
	public PROVIDER(Dermatology dermatology) {
	...
	public PROVIDER(DiagnosticLab diagnosticLab) {
	...
	public PROVIDER(DietNutrition dietNutrition) {
	...
	public PROVIDER(Distillery distillery) {
	...
	public PROVIDER(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public PROVIDER(EducationalOrganization educationalOrganization) {
	...
	public PROVIDER(Electrician electrician) {
	...
	public PROVIDER(ElectronicsStore electronicsStore) {
	...
	public PROVIDER(ElementarySchool elementarySchool) {
	...
	public PROVIDER(Emergency emergency) {
	...
	public PROVIDER(EmergencyService emergencyService) {
	...
	public PROVIDER(EmploymentAgency employmentAgency) {
	...
	public PROVIDER(EntertainmentBusiness entertainmentBusiness) {
	...
	public PROVIDER(ExerciseGym exerciseGym) {
	...
	public PROVIDER(FastFoodRestaurant fastFoodRestaurant) {
	...
	public PROVIDER(FinancialService financialService) {
	...
	public PROVIDER(FireStation fireStation) {
	...
	public PROVIDER(Florist florist) {
	...
	public PROVIDER(FoodEstablishment foodEstablishment) {
	...
	public PROVIDER(FundingAgency fundingAgency) {
	...
	public PROVIDER(FundingScheme fundingScheme) {
	...
	public PROVIDER(FurnitureStore furnitureStore) {
	...
	public PROVIDER(GardenStore gardenStore) {
	...
	public PROVIDER(GasStation gasStation) {
	...
	public PROVIDER(GeneralContractor generalContractor) {
	...
	public PROVIDER(Geriatric geriatric) {
	...
	public PROVIDER(GolfCourse golfCourse) {
	...
	public PROVIDER(GovernmentOffice governmentOffice) {
	...
	public PROVIDER(GovernmentOrganization governmentOrganization) {
	...
	public PROVIDER(GroceryStore groceryStore) {
	...
	public PROVIDER(Gynecologic gynecologic) {
	...
	public PROVIDER(HVACBusiness hvacBusiness) {
	...
	public PROVIDER(HairSalon hairSalon) {
	...
	public PROVIDER(HardwareStore hardwareStore) {
	...
	public PROVIDER(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public PROVIDER(HealthClub healthClub) {
	...
	public PROVIDER(HighSchool highSchool) {
	...
	public PROVIDER(HobbyShop hobbyShop) {
	...
	public PROVIDER(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public PROVIDER(HomeGoodsStore homeGoodsStore) {
	...
	public PROVIDER(Hospital hospital) {
	...
	public PROVIDER(HousePainter housePainter) {
	...
	public PROVIDER(IceCreamShop iceCreamShop) {
	...
	public PROVIDER(InsuranceAgency insuranceAgency) {
	...
	public PROVIDER(InternetCafe internetCafe) {
	...
	public PROVIDER(JewelryStore jewelryStore) {
	...
	public PROVIDER(LegalService legalService) {
	...
	public PROVIDER(Library library) {
	...
	public PROVIDER(LibrarySystem librarySystem) {
	...
	public PROVIDER(LiquorStore liquorStore) {
	...
	public PROVIDER(LocalBusiness localBusiness) {
	...
	public PROVIDER(Locksmith locksmith) {
	...
	public PROVIDER(LodgingBusiness lodgingBusiness) {
	...
	public PROVIDER(MedicalBusiness medicalBusiness) {
	...
	public PROVIDER(MedicalClinic medicalClinic) {
	...
	public PROVIDER(MedicalOrganization medicalOrganization) {
	...
	public PROVIDER(MensClothingStore mensClothingStore) {
	...
	public PROVIDER(MiddleSchool middleSchool) {
	...
	public PROVIDER(Midwifery midwifery) {
	...
	public PROVIDER(MobilePhoneStore mobilePhoneStore) {
	...
	public PROVIDER(MotorcycleDealer motorcycleDealer) {
	...
	public PROVIDER(MotorcycleRepair motorcycleRepair) {
	...
	public PROVIDER(MovieRentalStore movieRentalStore) {
	...
	public PROVIDER(MovieTheater movieTheater) {
	...
	public PROVIDER(MovingCompany movingCompany) {
	...
	public PROVIDER(MusicGroup musicGroup) {
	...
	public PROVIDER(MusicStore musicStore) {
	...
	public PROVIDER(NailSalon nailSalon) {
	...
	public PROVIDER(NewsMediaOrganization newsMediaOrganization) {
	...
	public PROVIDER(NightClub nightClub) {
	...
	public PROVIDER(Nursing nursing) {
	...
	public PROVIDER(Obstetric obstetric) {
	...
	public PROVIDER(OfficeEquipmentStore officeEquipmentStore) {
	...
	public PROVIDER(Oncologic oncologic) {
	...
	public PROVIDER(Optician optician) {
	...
	public PROVIDER(Optometric optometric) {
	...
	public PROVIDER(Organization organization) {
		organizationList = new ArrayList<Organization>();
	...
	public PROVIDER(Otolaryngologic otolaryngologic) {
	...
	public PROVIDER(OutletStore outletStore) {
	...
	public PROVIDER(Patient patient) {
	...
	public PROVIDER(PawnShop pawnShop) {
	...
	public PROVIDER(Pediatric pediatric) {
	...
	public PROVIDER(PerformingGroup performingGroup) {
	...
	public PROVIDER(PetStore petStore) {
	...
	public PROVIDER(Pharmacy pharmacy) {
	...
	public PROVIDER(Physician physician) {
	...
	public PROVIDER(Physiotherapy physiotherapy) {
	...
	public PROVIDER(PlasticSurgery plasticSurgery) {
	...
	public PROVIDER(Plumber plumber) {
	...
	public PROVIDER(Podiatric podiatric) {
	...
	public PROVIDER(PoliceStation policeStation) {
	...
	public PROVIDER(PostOffice postOffice) {
	...
	public PROVIDER(Preschool preschool) {
	...
	public PROVIDER(PrimaryCare primaryCare) {
	...
	public PROVIDER(ProfessionalService professionalService) {
	...
	public PROVIDER(Psychiatric psychiatric) {
	...
	public PROVIDER(PublicHealth publicHealth) {
	...
	public PROVIDER(PublicSwimmingPool publicSwimmingPool) {
	...
	public PROVIDER(RadioStation radioStation) {
	...
	public PROVIDER(RealEstateAgent realEstateAgent) {
	...
	public PROVIDER(RecyclingCenter recyclingCenter) {
	...
	public PROVIDER(ResearchProject researchProject) {
	...
	public PROVIDER(Restaurant restaurant) {
	...
	public PROVIDER(RoofingContractor roofingContractor) {
	...
	public PROVIDER(SelfStorage selfStorage) {
	...
	public PROVIDER(ShoeStore shoeStore) {
	...
	public PROVIDER(ShoppingCenter shoppingCenter) {
	...
	public PROVIDER(SkiResort skiResort) {
	...
	public PROVIDER(SportingGoodsStore sportingGoodsStore) {
	...
	public PROVIDER(SportsActivityLocation sportsActivityLocation) {
	...
	public PROVIDER(SportsClub sportsClub) {
	...
	public PROVIDER(SportsOrganization sportsOrganization) {
	...
	public PROVIDER(SportsTeam sportsTeam) {
	...
	public PROVIDER(StadiumOrArena stadiumOrArena) {
	...
	public PROVIDER(TattooParlor tattooParlor) {
	...
	public PROVIDER(TelevisionStation televisionStation) {
	...
	public PROVIDER(TennisComplex tennisComplex) {
	...
	public PROVIDER(TheaterGroup theaterGroup) {
	...
	public PROVIDER(TireShop tireShop) {
	...
	public PROVIDER(TouristInformationCenter touristInformationCenter) {
	...
	public PROVIDER(ToyStore toyStore) {
	...
	public PROVIDER(TravelAgency travelAgency) {
	...
	public PROVIDER(VeterinaryCare veterinaryCare) {
	...
	public PROVIDER(WholesaleStore wholesaleStore) {
	...
	public PROVIDER(WorkersUnion workersUnion) {
	...
	public void copy(Container.Provider org) {
