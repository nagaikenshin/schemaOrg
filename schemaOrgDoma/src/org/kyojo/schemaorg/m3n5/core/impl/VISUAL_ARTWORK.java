...
public class VISUAL_ARTWORK implements Clazz.VisualArtwork {
	...
	public VISUAL_ARTWORK(Correction correction) {
	...
	public VISUAL_ARTWORK(EncodingFormat encodingFormat) {
	...
	public VISUAL_ARTWORK(MaterialExtent materialExtent) {
	...
	public VISUAL_ARTWORK(SdDatePublished sdDatePublished) {
	...
	public VISUAL_ARTWORK(SdLicense sdLicense) {
	...
	public VISUAL_ARTWORK(SdPublisher sdPublisher) {
	...
	public VISUAL_ARTWORK(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public VISUAL_ARTWORK(SubjectOf subjectOf) {
	...
	public VISUAL_ARTWORK(Temporal temporal) {
