...
public class FROM_LOCATION implements Container.FromLocation {
	...
	public FROM_LOCATION(Accommodation accommodation) {
	...
	public FROM_LOCATION(AccountingService accountingService) {
	...
	public FROM_LOCATION(AdministrativeArea administrativeArea) {
	...
	public FROM_LOCATION(AdultEntertainment adultEntertainment) {
	...
	public FROM_LOCATION(Airport airport) {
	...
	public FROM_LOCATION(AmusementPark amusementPark) {
	...
	public FROM_LOCATION(AnimalShelter animalShelter) {
	...
	public FROM_LOCATION(Apartment apartment) {
	...
	public FROM_LOCATION(ApartmentComplex apartmentComplex) {
	...
	public FROM_LOCATION(Aquarium aquarium) {
	...
	public FROM_LOCATION(ArchiveOrganization archiveOrganization) {
	...
	public FROM_LOCATION(ArtGallery artGallery) {
	...
	public FROM_LOCATION(Attorney attorney) {
	...
	public FROM_LOCATION(AutoBodyShop autoBodyShop) {
	...
	public FROM_LOCATION(AutoDealer autoDealer) {
	...
	public FROM_LOCATION(AutoPartsStore autoPartsStore) {
	...
	public FROM_LOCATION(AutoRental autoRental) {
	...
	public FROM_LOCATION(AutoRepair autoRepair) {
	...
	public FROM_LOCATION(AutoWash autoWash) {
	...
	public FROM_LOCATION(AutomatedTeller automatedTeller) {
	...
	public FROM_LOCATION(AutomotiveBusiness automotiveBusiness) {
	...
	public FROM_LOCATION(Bakery bakery) {
	...
	public FROM_LOCATION(BankOrCreditUnion bankOrCreditUnion) {
	...
	public FROM_LOCATION(BarOrPub barOrPub) {
	...
	public FROM_LOCATION(Beach beach) {
	...
	public FROM_LOCATION(BeautySalon beautySalon) {
	...
	public FROM_LOCATION(BedAndBreakfast bedAndBreakfast) {
	...
	public FROM_LOCATION(BikeStore bikeStore) {
	...
	public FROM_LOCATION(BodyOfWater bodyOfWater) {
	...
	public FROM_LOCATION(BookStore bookStore) {
	...
	public FROM_LOCATION(BowlingAlley bowlingAlley) {
	...
	public FROM_LOCATION(Brewery brewery) {
	...
	public FROM_LOCATION(Bridge bridge) {
	...
	public FROM_LOCATION(BuddhistTemple buddhistTemple) {
	...
	public FROM_LOCATION(BusStation busStation) {
	...
	public FROM_LOCATION(BusStop busStop) {
	...
	public FROM_LOCATION(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public FROM_LOCATION(Campground campground) {
	...
	public FROM_LOCATION(CampingPitch campingPitch) {
	...
	public FROM_LOCATION(Canal canal) {
	...
	public FROM_LOCATION(Casino casino) {
	...
	public FROM_LOCATION(CatholicChurch catholicChurch) {
	...
	public FROM_LOCATION(Cemetery cemetery) {
	...
	public FROM_LOCATION(ChildCare childCare) {
	...
	public FROM_LOCATION(Church church) {
	...
	public FROM_LOCATION(City city) {
	...
	public FROM_LOCATION(CityHall cityHall) {
	...
	public FROM_LOCATION(CivicStructure civicStructure) {
	...
	public FROM_LOCATION(ClothingStore clothingStore) {
	...
	public FROM_LOCATION(ComedyClub comedyClub) {
	...
	public FROM_LOCATION(CommunityHealth communityHealth) {
	...
	public FROM_LOCATION(ComputerStore computerStore) {
	...
	public FROM_LOCATION(Continent continent) {
	...
	public FROM_LOCATION(ConvenienceStore convenienceStore) {
	...
	public FROM_LOCATION(Country country) {
	...
	public FROM_LOCATION(Courthouse courthouse) {
	...
	public FROM_LOCATION(Crematorium crematorium) {
	...
	public FROM_LOCATION(DaySpa daySpa) {
	...
	public FROM_LOCATION(DefenceEstablishment defenceEstablishment) {
	...
	public FROM_LOCATION(Dentist dentist) {
	...
	public FROM_LOCATION(DepartmentStore departmentStore) {
	...
	public FROM_LOCATION(Dermatology dermatology) {
	...
	public FROM_LOCATION(DietNutrition dietNutrition) {
	...
	public FROM_LOCATION(Distillery distillery) {
	...
	public FROM_LOCATION(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public FROM_LOCATION(Electrician electrician) {
	...
	public FROM_LOCATION(ElectronicsStore electronicsStore) {
	...
	public FROM_LOCATION(Embassy embassy) {
	...
	public FROM_LOCATION(Emergency emergency) {
	...
	public FROM_LOCATION(EmergencyService emergencyService) {
	...
	public FROM_LOCATION(EmploymentAgency employmentAgency) {
	...
	public FROM_LOCATION(EntertainmentBusiness entertainmentBusiness) {
	...
	public FROM_LOCATION(EventVenue eventVenue) {
	...
	public FROM_LOCATION(ExerciseGym exerciseGym) {
	...
	public FROM_LOCATION(FastFoodRestaurant fastFoodRestaurant) {
	...
	public FROM_LOCATION(FinancialService financialService) {
	...
	public FROM_LOCATION(FireStation fireStation) {
	...
	public FROM_LOCATION(Florist florist) {
	...
	public FROM_LOCATION(FoodEstablishment foodEstablishment) {
	...
	public FROM_LOCATION(FurnitureStore furnitureStore) {
	...
	public FROM_LOCATION(GardenStore gardenStore) {
	...
	public FROM_LOCATION(GasStation gasStation) {
	...
	public FROM_LOCATION(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public FROM_LOCATION(GeneralContractor generalContractor) {
	...
	public FROM_LOCATION(Geriatric geriatric) {
	...
	public FROM_LOCATION(GolfCourse golfCourse) {
	...
	public FROM_LOCATION(GovernmentBuilding governmentBuilding) {
	...
	public FROM_LOCATION(GovernmentOffice governmentOffice) {
	...
	public FROM_LOCATION(GroceryStore groceryStore) {
	...
	public FROM_LOCATION(Gynecologic gynecologic) {
	...
	public FROM_LOCATION(HVACBusiness hvacBusiness) {
	...
	public FROM_LOCATION(HairSalon hairSalon) {
	...
	public FROM_LOCATION(HardwareStore hardwareStore) {
	...
	public FROM_LOCATION(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public FROM_LOCATION(HealthClub healthClub) {
	...
	public FROM_LOCATION(HinduTemple hinduTemple) {
	...
	public FROM_LOCATION(HobbyShop hobbyShop) {
	...
	public FROM_LOCATION(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public FROM_LOCATION(HomeGoodsStore homeGoodsStore) {
	...
	public FROM_LOCATION(Hospital hospital) {
	...
	public FROM_LOCATION(Hostel hostel) {
	...
	public FROM_LOCATION(Hotel hotel) {
	...
	public FROM_LOCATION(HotelRoom hotelRoom) {
	...
	public FROM_LOCATION(House house) {
	...
	public FROM_LOCATION(HousePainter housePainter) {
	...
	public FROM_LOCATION(IceCreamShop iceCreamShop) {
	...
	public FROM_LOCATION(InsuranceAgency insuranceAgency) {
	...
	public FROM_LOCATION(InternetCafe internetCafe) {
	...
	public FROM_LOCATION(JewelryStore jewelryStore) {
	...
	public FROM_LOCATION(LakeBodyOfWater lakeBodyOfWater) {
	...
	public FROM_LOCATION(Landform landform) {
	...
	public FROM_LOCATION(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public FROM_LOCATION(LegalService legalService) {
	...
	public FROM_LOCATION(LegislativeBuilding legislativeBuilding) {
	...
	public FROM_LOCATION(Library library) {
	...
	public FROM_LOCATION(LiquorStore liquorStore) {
	...
	public FROM_LOCATION(LocalBusiness localBusiness) {
	...
	public FROM_LOCATION(Locksmith locksmith) {
	...
	public FROM_LOCATION(LodgingBusiness lodgingBusiness) {
	...
	public FROM_LOCATION(MedicalBusiness medicalBusiness) {
	...
	public FROM_LOCATION(MedicalClinic medicalClinic) {
	...
	public FROM_LOCATION(MeetingRoom meetingRoom) {
	...
	public FROM_LOCATION(MensClothingStore mensClothingStore) {
	...
	public FROM_LOCATION(Midwifery midwifery) {
	...
	public FROM_LOCATION(MobilePhoneStore mobilePhoneStore) {
	...
	public FROM_LOCATION(Mosque mosque) {
	...
	public FROM_LOCATION(Motel motel) {
	...
	public FROM_LOCATION(MotorcycleDealer motorcycleDealer) {
	...
	public FROM_LOCATION(MotorcycleRepair motorcycleRepair) {
	...
	public FROM_LOCATION(Mountain mountain) {
	...
	public FROM_LOCATION(MovieRentalStore movieRentalStore) {
	...
	public FROM_LOCATION(MovieTheater movieTheater) {
	...
	public FROM_LOCATION(MovingCompany movingCompany) {
	...
	public FROM_LOCATION(Museum museum) {
	...
	public FROM_LOCATION(MusicStore musicStore) {
	...
	public FROM_LOCATION(MusicVenue musicVenue) {
	...
	public FROM_LOCATION(NailSalon nailSalon) {
	...
	public FROM_LOCATION(NightClub nightClub) {
	...
	public FROM_LOCATION(Notary notary) {
	...
	public FROM_LOCATION(Nursing nursing) {
	...
	public FROM_LOCATION(Obstetric obstetric) {
	...
	public FROM_LOCATION(OceanBodyOfWater oceanBodyOfWater) {
	...
	public FROM_LOCATION(OfficeEquipmentStore officeEquipmentStore) {
	...
	public FROM_LOCATION(Oncologic oncologic) {
	...
	public FROM_LOCATION(Optician optician) {
	...
	public FROM_LOCATION(Optometric optometric) {
	...
	public FROM_LOCATION(Otolaryngologic otolaryngologic) {
	...
	public FROM_LOCATION(OutletStore outletStore) {
	...
	public FROM_LOCATION(Park park) {
	...
	public FROM_LOCATION(ParkingFacility parkingFacility) {
	...
	public FROM_LOCATION(PawnShop pawnShop) {
	...
	public FROM_LOCATION(Pediatric pediatric) {
	...
	public FROM_LOCATION(PerformingArtsTheater performingArtsTheater) {
	...
	public FROM_LOCATION(PetStore petStore) {
	...
	public FROM_LOCATION(Pharmacy pharmacy) {
	...
	public FROM_LOCATION(Physician physician) {
	...
	public FROM_LOCATION(Physiotherapy physiotherapy) {
	...
	public FROM_LOCATION(Place place) {
	...
	public FROM_LOCATION(PlaceOfWorship placeOfWorship) {
	...
	public FROM_LOCATION(PlasticSurgery plasticSurgery) {
	...
	public FROM_LOCATION(Playground playground) {
	...
	public FROM_LOCATION(Plumber plumber) {
	...
	public FROM_LOCATION(Podiatric podiatric) {
	...
	public FROM_LOCATION(PoliceStation policeStation) {
	...
	public FROM_LOCATION(Pond pond) {
	...
	public FROM_LOCATION(PostOffice postOffice) {
	...
	public FROM_LOCATION(PostalAddress postalAddress) {
	...
	public FROM_LOCATION(PrimaryCare primaryCare) {
	...
	public FROM_LOCATION(ProfessionalService professionalService) {
	...
	public FROM_LOCATION(Psychiatric psychiatric) {
	...
	public FROM_LOCATION(PublicHealth publicHealth) {
	...
	public FROM_LOCATION(PublicSwimmingPool publicSwimmingPool) {
	...
	public FROM_LOCATION(PublicToilet publicToilet) {
	...
	public FROM_LOCATION(RVPark rvPark) {
	...
	public FROM_LOCATION(RadioStation radioStation) {
	...
	public FROM_LOCATION(RealEstateAgent realEstateAgent) {
	...
	public FROM_LOCATION(RecyclingCenter recyclingCenter) {
	...
	public FROM_LOCATION(Reservoir reservoir) {
	...
	public FROM_LOCATION(Residence residence) {
	...
	public FROM_LOCATION(Resort resort) {
	...
	public FROM_LOCATION(Restaurant restaurant) {
	...
	public FROM_LOCATION(RiverBodyOfWater riverBodyOfWater) {
	...
	public FROM_LOCATION(RoofingContractor roofingContractor) {
	...
	public FROM_LOCATION(Room room) {
	...
	public FROM_LOCATION(SeaBodyOfWater seaBodyOfWater) {
	...
	public FROM_LOCATION(SelfStorage selfStorage) {
	...
	public FROM_LOCATION(ShoeStore shoeStore) {
	...
	public FROM_LOCATION(ShoppingCenter shoppingCenter) {
	...
	public FROM_LOCATION(SingleFamilyResidence singleFamilyResidence) {
	...
	public FROM_LOCATION(SkiResort skiResort) {
	...
	public FROM_LOCATION(SportingGoodsStore sportingGoodsStore) {
	...
	public FROM_LOCATION(SportsActivityLocation sportsActivityLocation) {
	...
	public FROM_LOCATION(SportsClub sportsClub) {
	...
	public FROM_LOCATION(StadiumOrArena stadiumOrArena) {
	...
	public FROM_LOCATION(State state) {
	...
	public FROM_LOCATION(Store store) {
	...
	public FROM_LOCATION(SubwayStation subwayStation) {
	...
	public FROM_LOCATION(Suite suite) {
	...
	public FROM_LOCATION(Synagogue synagogue) {
	...
	public FROM_LOCATION(TattooParlor tattooParlor) {
	...
	public FROM_LOCATION(TaxiStand taxiStand) {
	...
	public FROM_LOCATION(TelevisionStation televisionStation) {
	...
	public FROM_LOCATION(TennisComplex tennisComplex) {
	...
	public FROM_LOCATION(String string) {
		this(new TEXT(string));
	}

	public FROM_LOCATION(Text text) {
	...
	public FROM_LOCATION(TireShop tireShop) {
	...
	public FROM_LOCATION(TouristAttraction touristAttraction) {
	...
	public FROM_LOCATION(TouristDestination touristDestination) {
	...
	public FROM_LOCATION(TouristInformationCenter touristInformationCenter) {
	...
	public FROM_LOCATION(ToyStore toyStore) {
	...
	public FROM_LOCATION(TrainStation trainStation) {
	...
	public FROM_LOCATION(TravelAgency travelAgency) {
	...
	public FROM_LOCATION(Volcano volcano) {
	...
	public FROM_LOCATION(Waterfall waterfall) {
	...
	public FROM_LOCATION(WholesaleStore wholesaleStore) {
	...
	public FROM_LOCATION(Winery winery) {
	...
	public void copy(Container.FromLocation org) {
