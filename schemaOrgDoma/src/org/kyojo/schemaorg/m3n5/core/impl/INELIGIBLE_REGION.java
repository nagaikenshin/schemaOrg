...
public class INELIGIBLE_REGION implements Container.IneligibleRegion {
	...
	public INELIGIBLE_REGION(Accommodation accommodation) {
	...
	public INELIGIBLE_REGION(AccountingService accountingService) {
	...
	public INELIGIBLE_REGION(AdministrativeArea administrativeArea) {
	...
	public INELIGIBLE_REGION(AdultEntertainment adultEntertainment) {
	...
	public INELIGIBLE_REGION(Airport airport) {
	...
	public INELIGIBLE_REGION(AmusementPark amusementPark) {
	...
	public INELIGIBLE_REGION(AnimalShelter animalShelter) {
	...
	public INELIGIBLE_REGION(Apartment apartment) {
	...
	public INELIGIBLE_REGION(ApartmentComplex apartmentComplex) {
	...
	public INELIGIBLE_REGION(Aquarium aquarium) {
	...
	public INELIGIBLE_REGION(ArchiveOrganization archiveOrganization) {
	...
	public INELIGIBLE_REGION(ArtGallery artGallery) {
	...
	public INELIGIBLE_REGION(Attorney attorney) {
	...
	public INELIGIBLE_REGION(AutoBodyShop autoBodyShop) {
	...
	public INELIGIBLE_REGION(AutoDealer autoDealer) {
	...
	public INELIGIBLE_REGION(AutoPartsStore autoPartsStore) {
	...
	public INELIGIBLE_REGION(AutoRental autoRental) {
	...
	public INELIGIBLE_REGION(AutoRepair autoRepair) {
	...
	public INELIGIBLE_REGION(AutoWash autoWash) {
	...
	public INELIGIBLE_REGION(AutomatedTeller automatedTeller) {
	...
	public INELIGIBLE_REGION(AutomotiveBusiness automotiveBusiness) {
	...
	public INELIGIBLE_REGION(Bakery bakery) {
	...
	public INELIGIBLE_REGION(BankOrCreditUnion bankOrCreditUnion) {
	...
	public INELIGIBLE_REGION(BarOrPub barOrPub) {
	...
	public INELIGIBLE_REGION(Beach beach) {
	...
	public INELIGIBLE_REGION(BeautySalon beautySalon) {
	...
	public INELIGIBLE_REGION(BedAndBreakfast bedAndBreakfast) {
	...
	public INELIGIBLE_REGION(BikeStore bikeStore) {
	...
	public INELIGIBLE_REGION(BodyOfWater bodyOfWater) {
	...
	public INELIGIBLE_REGION(BookStore bookStore) {
	...
	public INELIGIBLE_REGION(BowlingAlley bowlingAlley) {
	...
	public INELIGIBLE_REGION(Brewery brewery) {
	...
	public INELIGIBLE_REGION(Bridge bridge) {
	...
	public INELIGIBLE_REGION(BuddhistTemple buddhistTemple) {
	...
	public INELIGIBLE_REGION(BusStation busStation) {
	...
	public INELIGIBLE_REGION(BusStop busStop) {
	...
	public INELIGIBLE_REGION(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public INELIGIBLE_REGION(Campground campground) {
	...
	public INELIGIBLE_REGION(CampingPitch campingPitch) {
	...
	public INELIGIBLE_REGION(Canal canal) {
	...
	public INELIGIBLE_REGION(Casino casino) {
	...
	public INELIGIBLE_REGION(CatholicChurch catholicChurch) {
	...
	public INELIGIBLE_REGION(Cemetery cemetery) {
	...
	public INELIGIBLE_REGION(ChildCare childCare) {
	...
	public INELIGIBLE_REGION(Church church) {
	...
	public INELIGIBLE_REGION(City city) {
	...
	public INELIGIBLE_REGION(CityHall cityHall) {
	...
	public INELIGIBLE_REGION(CivicStructure civicStructure) {
	...
	public INELIGIBLE_REGION(ClothingStore clothingStore) {
	...
	public INELIGIBLE_REGION(ComedyClub comedyClub) {
	...
	public INELIGIBLE_REGION(CommunityHealth communityHealth) {
	...
	public INELIGIBLE_REGION(ComputerStore computerStore) {
	...
	public INELIGIBLE_REGION(Continent continent) {
	...
	public INELIGIBLE_REGION(ConvenienceStore convenienceStore) {
	...
	public INELIGIBLE_REGION(Country country) {
	...
	public INELIGIBLE_REGION(Courthouse courthouse) {
	...
	public INELIGIBLE_REGION(Crematorium crematorium) {
	...
	public INELIGIBLE_REGION(DaySpa daySpa) {
	...
	public INELIGIBLE_REGION(DefenceEstablishment defenceEstablishment) {
	...
	public INELIGIBLE_REGION(Dentist dentist) {
	...
	public INELIGIBLE_REGION(DepartmentStore departmentStore) {
	...
	public INELIGIBLE_REGION(Dermatology dermatology) {
	...
	public INELIGIBLE_REGION(DietNutrition dietNutrition) {
	...
	public INELIGIBLE_REGION(Distillery distillery) {
	...
	public INELIGIBLE_REGION(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public INELIGIBLE_REGION(Electrician electrician) {
	...
	public INELIGIBLE_REGION(ElectronicsStore electronicsStore) {
	...
	public INELIGIBLE_REGION(Embassy embassy) {
	...
	public INELIGIBLE_REGION(Emergency emergency) {
	...
	public INELIGIBLE_REGION(EmergencyService emergencyService) {
	...
	public INELIGIBLE_REGION(EmploymentAgency employmentAgency) {
	...
	public INELIGIBLE_REGION(EntertainmentBusiness entertainmentBusiness) {
	...
	public INELIGIBLE_REGION(EventVenue eventVenue) {
	...
	public INELIGIBLE_REGION(ExerciseGym exerciseGym) {
	...
	public INELIGIBLE_REGION(FastFoodRestaurant fastFoodRestaurant) {
	...
	public INELIGIBLE_REGION(FinancialService financialService) {
	...
	public INELIGIBLE_REGION(FireStation fireStation) {
	...
	public INELIGIBLE_REGION(Florist florist) {
	...
	public INELIGIBLE_REGION(FoodEstablishment foodEstablishment) {
	...
	public INELIGIBLE_REGION(FurnitureStore furnitureStore) {
	...
	public INELIGIBLE_REGION(GardenStore gardenStore) {
	...
	public INELIGIBLE_REGION(GasStation gasStation) {
	...
	public INELIGIBLE_REGION(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public INELIGIBLE_REGION(GeneralContractor generalContractor) {
	...
	public INELIGIBLE_REGION(GeoCircle geoCircle) {
	...
	public INELIGIBLE_REGION(Geriatric geriatric) {
	...
	public INELIGIBLE_REGION(GolfCourse golfCourse) {
	...
	public INELIGIBLE_REGION(GovernmentBuilding governmentBuilding) {
	...
	public INELIGIBLE_REGION(GovernmentOffice governmentOffice) {
	...
	public INELIGIBLE_REGION(GroceryStore groceryStore) {
	...
	public INELIGIBLE_REGION(Gynecologic gynecologic) {
	...
	public INELIGIBLE_REGION(HVACBusiness hvacBusiness) {
	...
	public INELIGIBLE_REGION(HairSalon hairSalon) {
	...
	public INELIGIBLE_REGION(HardwareStore hardwareStore) {
	...
	public INELIGIBLE_REGION(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public INELIGIBLE_REGION(HealthClub healthClub) {
	...
	public INELIGIBLE_REGION(HinduTemple hinduTemple) {
	...
	public INELIGIBLE_REGION(HobbyShop hobbyShop) {
	...
	public INELIGIBLE_REGION(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public INELIGIBLE_REGION(HomeGoodsStore homeGoodsStore) {
	...
	public INELIGIBLE_REGION(Hospital hospital) {
	...
	public INELIGIBLE_REGION(Hostel hostel) {
	...
	public INELIGIBLE_REGION(Hotel hotel) {
	...
	public INELIGIBLE_REGION(HotelRoom hotelRoom) {
	...
	public INELIGIBLE_REGION(House house) {
	...
	public INELIGIBLE_REGION(HousePainter housePainter) {
	...
	public INELIGIBLE_REGION(IceCreamShop iceCreamShop) {
	...
	public INELIGIBLE_REGION(InsuranceAgency insuranceAgency) {
	...
	public INELIGIBLE_REGION(InternetCafe internetCafe) {
	...
	public INELIGIBLE_REGION(JewelryStore jewelryStore) {
	...
	public INELIGIBLE_REGION(LakeBodyOfWater lakeBodyOfWater) {
	...
	public INELIGIBLE_REGION(Landform landform) {
	...
	public INELIGIBLE_REGION(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public INELIGIBLE_REGION(LegalService legalService) {
	...
	public INELIGIBLE_REGION(LegislativeBuilding legislativeBuilding) {
	...
	public INELIGIBLE_REGION(Library library) {
	...
	public INELIGIBLE_REGION(LiquorStore liquorStore) {
	...
	public INELIGIBLE_REGION(LocalBusiness localBusiness) {
	...
	public INELIGIBLE_REGION(Locksmith locksmith) {
	...
	public INELIGIBLE_REGION(LodgingBusiness lodgingBusiness) {
	...
	public INELIGIBLE_REGION(MedicalBusiness medicalBusiness) {
	...
	public INELIGIBLE_REGION(MedicalClinic medicalClinic) {
	...
	public INELIGIBLE_REGION(MeetingRoom meetingRoom) {
	...
	public INELIGIBLE_REGION(MensClothingStore mensClothingStore) {
	...
	public INELIGIBLE_REGION(Midwifery midwifery) {
	...
	public INELIGIBLE_REGION(MobilePhoneStore mobilePhoneStore) {
	...
	public INELIGIBLE_REGION(Mosque mosque) {
	...
	public INELIGIBLE_REGION(Motel motel) {
	...
	public INELIGIBLE_REGION(MotorcycleDealer motorcycleDealer) {
	...
	public INELIGIBLE_REGION(MotorcycleRepair motorcycleRepair) {
	...
	public INELIGIBLE_REGION(Mountain mountain) {
	...
	public INELIGIBLE_REGION(MovieRentalStore movieRentalStore) {
	...
	public INELIGIBLE_REGION(MovieTheater movieTheater) {
	...
	public INELIGIBLE_REGION(MovingCompany movingCompany) {
	...
	public INELIGIBLE_REGION(Museum museum) {
	...
	public INELIGIBLE_REGION(MusicStore musicStore) {
	...
	public INELIGIBLE_REGION(MusicVenue musicVenue) {
	...
	public INELIGIBLE_REGION(NailSalon nailSalon) {
	...
	public INELIGIBLE_REGION(NightClub nightClub) {
	...
	public INELIGIBLE_REGION(Notary notary) {
	...
	public INELIGIBLE_REGION(Nursing nursing) {
	...
	public INELIGIBLE_REGION(Obstetric obstetric) {
	...
	public INELIGIBLE_REGION(OceanBodyOfWater oceanBodyOfWater) {
	...
	public INELIGIBLE_REGION(OfficeEquipmentStore officeEquipmentStore) {
	...
	public INELIGIBLE_REGION(Oncologic oncologic) {
	...
	public INELIGIBLE_REGION(Optician optician) {
	...
	public INELIGIBLE_REGION(Optometric optometric) {
	...
	public INELIGIBLE_REGION(Otolaryngologic otolaryngologic) {
	...
	public INELIGIBLE_REGION(OutletStore outletStore) {
	...
	public INELIGIBLE_REGION(Park park) {
	...
	public INELIGIBLE_REGION(ParkingFacility parkingFacility) {
	...
	public INELIGIBLE_REGION(PawnShop pawnShop) {
	...
	public INELIGIBLE_REGION(Pediatric pediatric) {
	...
	public INELIGIBLE_REGION(PerformingArtsTheater performingArtsTheater) {
	...
	public INELIGIBLE_REGION(PetStore petStore) {
	...
	public INELIGIBLE_REGION(Pharmacy pharmacy) {
	...
	public INELIGIBLE_REGION(Physician physician) {
	...
	public INELIGIBLE_REGION(Physiotherapy physiotherapy) {
	...
	public INELIGIBLE_REGION(PlaceOfWorship placeOfWorship) {
	...
	public INELIGIBLE_REGION(PlasticSurgery plasticSurgery) {
	...
	public INELIGIBLE_REGION(Playground playground) {
	...
	public INELIGIBLE_REGION(Plumber plumber) {
	...
	public INELIGIBLE_REGION(Podiatric podiatric) {
	...
	public INELIGIBLE_REGION(PoliceStation policeStation) {
	...
	public INELIGIBLE_REGION(Pond pond) {
	...
	public INELIGIBLE_REGION(PostOffice postOffice) {
	...
	public INELIGIBLE_REGION(PrimaryCare primaryCare) {
	...
	public INELIGIBLE_REGION(ProfessionalService professionalService) {
	...
	public INELIGIBLE_REGION(Psychiatric psychiatric) {
	...
	public INELIGIBLE_REGION(PublicHealth publicHealth) {
	...
	public INELIGIBLE_REGION(PublicSwimmingPool publicSwimmingPool) {
	...
	public INELIGIBLE_REGION(PublicToilet publicToilet) {
	...
	public INELIGIBLE_REGION(RVPark rvPark) {
	...
	public INELIGIBLE_REGION(RadioStation radioStation) {
	...
	public INELIGIBLE_REGION(RealEstateAgent realEstateAgent) {
	...
	public INELIGIBLE_REGION(RecyclingCenter recyclingCenter) {
	...
	public INELIGIBLE_REGION(Reservoir reservoir) {
	...
	public INELIGIBLE_REGION(Residence residence) {
	...
	public INELIGIBLE_REGION(Resort resort) {
	...
	public INELIGIBLE_REGION(Restaurant restaurant) {
	...
	public INELIGIBLE_REGION(RiverBodyOfWater riverBodyOfWater) {
	...
	public INELIGIBLE_REGION(RoofingContractor roofingContractor) {
	...
	public INELIGIBLE_REGION(Room room) {
	...
	public INELIGIBLE_REGION(SeaBodyOfWater seaBodyOfWater) {
	...
	public INELIGIBLE_REGION(SelfStorage selfStorage) {
	...
	public INELIGIBLE_REGION(ShoeStore shoeStore) {
	...
	public INELIGIBLE_REGION(ShoppingCenter shoppingCenter) {
	...
	public INELIGIBLE_REGION(SingleFamilyResidence singleFamilyResidence) {
	...
	public INELIGIBLE_REGION(SkiResort skiResort) {
	...
	public INELIGIBLE_REGION(SportingGoodsStore sportingGoodsStore) {
	...
	public INELIGIBLE_REGION(SportsActivityLocation sportsActivityLocation) {
	...
	public INELIGIBLE_REGION(SportsClub sportsClub) {
	...
	public INELIGIBLE_REGION(StadiumOrArena stadiumOrArena) {
	...
	public INELIGIBLE_REGION(State state) {
	...
	public INELIGIBLE_REGION(Store store) {
	...
	public INELIGIBLE_REGION(SubwayStation subwayStation) {
	...
	public INELIGIBLE_REGION(Suite suite) {
	...
	public INELIGIBLE_REGION(Synagogue synagogue) {
	...
	public INELIGIBLE_REGION(TattooParlor tattooParlor) {
	...
	public INELIGIBLE_REGION(TaxiStand taxiStand) {
	...
	public INELIGIBLE_REGION(TelevisionStation televisionStation) {
	...
	public INELIGIBLE_REGION(TennisComplex tennisComplex) {
	...
	public INELIGIBLE_REGION(TireShop tireShop) {
	...
	public INELIGIBLE_REGION(TouristAttraction touristAttraction) {
	...
	public INELIGIBLE_REGION(TouristDestination touristDestination) {
	...
	public INELIGIBLE_REGION(TouristInformationCenter touristInformationCenter) {
	...
	public INELIGIBLE_REGION(ToyStore toyStore) {
	...
	public INELIGIBLE_REGION(TrainStation trainStation) {
	...
	public INELIGIBLE_REGION(TravelAgency travelAgency) {
	...
	public INELIGIBLE_REGION(Volcano volcano) {
	...
	public INELIGIBLE_REGION(Waterfall waterfall) {
	...
	public INELIGIBLE_REGION(WholesaleStore wholesaleStore) {
	...
	public INELIGIBLE_REGION(Winery winery) {
	...
	public INELIGIBLE_REGION(Zoo zoo) {
