...
public class SATURATED_FAT_CONTENT implements Container.SaturatedFatContent {
	...
	public SATURATED_FAT_CONTENT(String string) {
	...
	public SATURATED_FAT_CONTENT(Mass mass) {
		massList = new ArrayList<Mass>();
		massList.add(mass);
	}
