...
public class MOVIE implements Clazz.Movie {
	...
	public MOVIE(Correction correction) {
	...
	public MOVIE(EncodingFormat encodingFormat) {
	...
	public MOVIE(MaterialExtent materialExtent) {
	...
	public MOVIE(SdDatePublished sdDatePublished) {
	...
	public MOVIE(SdLicense sdLicense) {
	...
	public MOVIE(SdPublisher sdPublisher) {
	...
	public MOVIE(SubjectOf subjectOf) {
	...
	public MOVIE(Temporal temporal) {
