...
public class SUB_EVENT implements Container.SubEvent {
	...
	public SUB_EVENT(String string) {
	...
	public SUB_EVENT(BroadcastEvent broadcastEvent) {
	...
	public SUB_EVENT(BusinessEvent businessEvent) {
	...
	public SUB_EVENT(ChildrensEvent childrensEvent) {
	...
	public SUB_EVENT(ComedyEvent comedyEvent) {
	...
	public SUB_EVENT(CourseInstance courseInstance) {
	...
	public SUB_EVENT(DanceEvent danceEvent) {
	...
	public SUB_EVENT(DeliveryEvent deliveryEvent) {
	...
	public SUB_EVENT(EducationEvent educationEvent) {
	...
	public SUB_EVENT(EventSeries eventSeries) {
	...
	public SUB_EVENT(ExhibitionEvent exhibitionEvent) {
	...
	public SUB_EVENT(Festival festival) {
	...
	public SUB_EVENT(FoodEvent foodEvent) {
	...
	public SUB_EVENT(LiteraryEvent literaryEvent) {
	...
	public SUB_EVENT(MusicEvent musicEvent) {
	...
	public SUB_EVENT(OnDemandEvent onDemandEvent) {
	...
	public SUB_EVENT(PublicationEvent publicationEvent) {
	...
	public SUB_EVENT(SaleEvent saleEvent) {
	...
	public SUB_EVENT(ScreeningEvent screeningEvent) {
	...
	public SUB_EVENT(SocialEvent socialEvent) {
	...
	public SUB_EVENT(SportsEvent sportsEvent) {
	...
	public SUB_EVENT(TheaterEvent theaterEvent) {
	...
	public SUB_EVENT(VisualArtsEvent visualArtsEvent) {
	...
	public void copy(Container.SubEvent org) {
