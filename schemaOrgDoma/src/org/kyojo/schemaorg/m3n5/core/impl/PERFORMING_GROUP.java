...
public class PERFORMING_GROUP implements Clazz.PerformingGroup {
	...
	public PERFORMING_GROUP() {
	}

	public PERFORMING_GROUP(Long seq) {
		setSeq(seq);
	}

	public PERFORMING_GROUP(String string) {
	...
	public PERFORMING_GROUP(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public PERFORMING_GROUP(AdditionalType additionalType) {
	...
	public PERFORMING_GROUP(Address address) {
		setAddress(address);
	}
	...
	public PERFORMING_GROUP(AggregateRating aggregateRating) {
	...
	public PERFORMING_GROUP(AlternateName alternateName) {
	...
	public PERFORMING_GROUP(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public PERFORMING_GROUP(AreaServed areaServed) {
	...
	public PERFORMING_GROUP(Award award) {
		setAward(award);
	}
	...
	public PERFORMING_GROUP(Brand brand) {
		setBrand(brand);
	}
	...
	public PERFORMING_GROUP(ContactPoint contactPoint) {
	...
	public PERFORMING_GROUP(CorrectionsPolicy correctionsPolicy) {
	...
	public PERFORMING_GROUP(Department department) {
	...
	public PERFORMING_GROUP(Description description) {
	...
	public PERFORMING_GROUP(DisambiguatingDescription disambiguatingDescription) {
	...
	public PERFORMING_GROUP(DissolutionDate dissolutionDate) {
	...
	public PERFORMING_GROUP(DiversityPolicy diversityPolicy) {
	...
	public PERFORMING_GROUP(DiversityStaffingReport diversityStaffingReport) {
	...
	public PERFORMING_GROUP(Duns duns) {
		setDuns(duns);
	}
	...
	public PERFORMING_GROUP(Email email) {
		setEmail(email);
	}
	...
	public PERFORMING_GROUP(Employee employee) {
	...
	public PERFORMING_GROUP(EthicsPolicy ethicsPolicy) {
	...
	public PERFORMING_GROUP(Event event) {
		setEvent(event);
	}
	...
	public PERFORMING_GROUP(FaxNumber faxNumber) {
	...
	public PERFORMING_GROUP(Founder founder) {
		setFounder(founder);
	}
	...
	public PERFORMING_GROUP(FoundingDate foundingDate) {
	...
	public PERFORMING_GROUP(FoundingLocation foundingLocation) {
	...
	public PERFORMING_GROUP(Funder funder) {
		setFunder(funder);
	}
	...
	public PERFORMING_GROUP(GlobalLocationNumber globalLocationNumber) {
	...
	public PERFORMING_GROUP(HasOfferCatalog hasOfferCatalog) {
	...
	public PERFORMING_GROUP(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public PERFORMING_GROUP(Identifier identifier) {
	...
	public PERFORMING_GROUP(Image image) {
		setImage(image);
	}
	...
	public PERFORMING_GROUP(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public PERFORMING_GROUP(KnowsAbout knowsAbout) {
	...
	public PERFORMING_GROUP(KnowsLanguage knowsLanguage) {
	...
	public PERFORMING_GROUP(LegalName legalName) {
	...
	public PERFORMING_GROUP(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public PERFORMING_GROUP(Location location) {
	...
	public PERFORMING_GROUP(Logo logo) {
		setLogo(logo);
	}
	...
	public PERFORMING_GROUP(MainEntityOfPage mainEntityOfPage) {
	...
	public PERFORMING_GROUP(MakesOffer makesOffer) {
	...
	public PERFORMING_GROUP(Member member) {
		setMember(member);
	}
	...
	public PERFORMING_GROUP(MemberOf memberOf) {
	...
	public PERFORMING_GROUP(Naics naics) {
		setNaics(naics);
	}
	...
	public PERFORMING_GROUP(Name name) {
		setName(name);
	}
	...
	public PERFORMING_GROUP(NameFuzzy nameFuzzy) {
	...
	public PERFORMING_GROUP(NameRuby nameRuby) {
	...
	public PERFORMING_GROUP(NumberOfEmployees numberOfEmployees) {
	...
	public PERFORMING_GROUP(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public PERFORMING_GROUP(Owns owns) {
		setOwns(owns);
	}
	...
	public PERFORMING_GROUP(ParentOrganization parentOrganization) {
	...
	public PERFORMING_GROUP(PotentialAction potentialAction) {
	...
	public PERFORMING_GROUP(PublishingPrinciples publishingPrinciples) {
	...
	public PERFORMING_GROUP(Review review) {
		setReview(review);
	}
	...
	public PERFORMING_GROUP(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public PERFORMING_GROUP(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public PERFORMING_GROUP(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public PERFORMING_GROUP(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public PERFORMING_GROUP(SubOrganization subOrganization) {
	...
	public PERFORMING_GROUP(SubjectOf subjectOf) {
	...
	public PERFORMING_GROUP(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public PERFORMING_GROUP(Telephone telephone) {
	...
	public PERFORMING_GROUP(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public PERFORMING_GROUP(Url url) {
		setUrl(url);
	}
	...
	public PERFORMING_GROUP(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.PerformingGroup org) {
		setSeq(org.getSeq());
