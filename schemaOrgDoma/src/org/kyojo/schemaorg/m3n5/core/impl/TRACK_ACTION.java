...
public class TRACK_ACTION implements Clazz.TrackAction {
	...
	public TRACK_ACTION(Long seq) {
		setSeq(seq);
	}

	public TRACK_ACTION(String string) {
	...
	public TRACK_ACTION(ActionStatus actionStatus) {
	...
	public TRACK_ACTION(AdditionalType additionalType) {
	...
	public TRACK_ACTION(Agent agent) {
		setAgent(agent);
	}
	...
	public TRACK_ACTION(AlternateName alternateName) {
	...
	public TRACK_ACTION(DeliveryMethod deliveryMethod) {
	...
	public TRACK_ACTION(Description description) {
	...
	public TRACK_ACTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public TRACK_ACTION(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public TRACK_ACTION(Error error) {
		setError(error);
	}
	...
	public TRACK_ACTION(Identifier identifier) {
	...
	public TRACK_ACTION(Image image) {
		setImage(image);
	}
	...
	public TRACK_ACTION(Instrument instrument) {
	...
	public TRACK_ACTION(Location location) {
	...
	public TRACK_ACTION(MainEntityOfPage mainEntityOfPage) {
	...
	public TRACK_ACTION(NameFuzzy nameFuzzy) {
	...
	public TRACK_ACTION(NameRuby nameRuby) {
	...
	public TRACK_ACTION(Object object) {
		setObject(object);
	}
	...
	public TRACK_ACTION(Participant participant) {
	...
	public TRACK_ACTION(PotentialAction potentialAction) {
	...
	public TRACK_ACTION(Result result) {
		setResult(result);
	}
	...
	public TRACK_ACTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TRACK_ACTION(StartTime startTime) {
	...
	public TRACK_ACTION(SubjectOf subjectOf) {
	...
	public TRACK_ACTION(Target target) {
		setTarget(target);
	}
	...
	public void copy(Clazz.TrackAction org) {
		setSeq(org.getSeq());
