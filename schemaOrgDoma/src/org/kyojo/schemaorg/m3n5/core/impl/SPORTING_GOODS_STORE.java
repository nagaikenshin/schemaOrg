...
public class SPORTING_GOODS_STORE implements Clazz.SportingGoodsStore {
	...
	public SPORTING_GOODS_STORE(GeoContains geoContains) {
	...
	public SPORTING_GOODS_STORE(GeoCoveredBy geoCoveredBy) {
	...
	public SPORTING_GOODS_STORE(GeoCovers geoCovers) {
	...
	public SPORTING_GOODS_STORE(GeoCrosses geoCrosses) {
	...
	public SPORTING_GOODS_STORE(GeoDisjoint geoDisjoint) {
	...
	public SPORTING_GOODS_STORE(GeoEquals geoEquals) {
	...
	public SPORTING_GOODS_STORE(GeoIntersects geoIntersects) {
	...
	public SPORTING_GOODS_STORE(GeoOverlaps geoOverlaps) {
	...
	public SPORTING_GOODS_STORE(GeoTouches geoTouches) {
	...
	public SPORTING_GOODS_STORE(GeoWithin geoWithin) {
	...
	public SPORTING_GOODS_STORE(Slogan slogan) {
		setSlogan(slogan);
	}
