...
public class MUSIC_ALBUM_RELEASE_TYPE implements Clazz.MusicAlbumReleaseType {
	...
	public MUSIC_ALBUM_RELEASE_TYPE() {
	}

	public MUSIC_ALBUM_RELEASE_TYPE(Long seq) {
		setSeq(seq);
	}

	public MUSIC_ALBUM_RELEASE_TYPE(String string) {
	...
	public MUSIC_ALBUM_RELEASE_TYPE(AdditionalType additionalType) {
	...
	public MUSIC_ALBUM_RELEASE_TYPE(AlternateName alternateName) {
	...
	public MUSIC_ALBUM_RELEASE_TYPE(Description description) {
	...
	public MUSIC_ALBUM_RELEASE_TYPE(DisambiguatingDescription disambiguatingDescription) {
	...
	public MUSIC_ALBUM_RELEASE_TYPE(Identifier identifier) {
	...
	public MUSIC_ALBUM_RELEASE_TYPE(Image image) {
		setImage(image);
	}
	...
	public MUSIC_ALBUM_RELEASE_TYPE(MainEntityOfPage mainEntityOfPage) {
	...
	public MUSIC_ALBUM_RELEASE_TYPE(Name name) {
		setName(name);
	}
	...
	public MUSIC_ALBUM_RELEASE_TYPE(NameFuzzy nameFuzzy) {
	...
	public MUSIC_ALBUM_RELEASE_TYPE(NameRuby nameRuby) {
	...
	public MUSIC_ALBUM_RELEASE_TYPE(PotentialAction potentialAction) {
	...
	public MUSIC_ALBUM_RELEASE_TYPE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MUSIC_ALBUM_RELEASE_TYPE(SubjectOf subjectOf) {
	...
	public MUSIC_ALBUM_RELEASE_TYPE(SupersededBy supersededBy) {
	...
	public MUSIC_ALBUM_RELEASE_TYPE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.MusicAlbumReleaseType org) {
		setSeq(org.getSeq());
