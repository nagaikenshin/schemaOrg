...
public class SCULPTURE implements Clazz.Sculpture {
	...
	public SCULPTURE(Long seq) {
		setSeq(seq);
	}

	public SCULPTURE(String string) {
	...
	public SCULPTURE(AccessMode accessMode) {
	...
	public SCULPTURE(AccessModeSufficient accessModeSufficient) {
	...
	public SCULPTURE(AccessibilityAPI accessibilityAPI) {
	...
	public SCULPTURE(AccessibilityControl accessibilityControl) {
	...
	public SCULPTURE(AccessibilityFeature accessibilityFeature) {
	...
	public SCULPTURE(AccessibilityHazard accessibilityHazard) {
	...
	public SCULPTURE(AccessibilitySummary accessibilitySummary) {
	...
	public SCULPTURE(AccountablePerson accountablePerson) {
	...
	public SCULPTURE(AdditionalType additionalType) {
	...
	public SCULPTURE(AggregateRating aggregateRating) {
	...
	public SCULPTURE(AlternateName alternateName) {
	...
	public SCULPTURE(AlternativeHeadline alternativeHeadline) {
	...
	public SCULPTURE(AssociatedMedia associatedMedia) {
	...
	public SCULPTURE(Audience audience) {
	...
	public SCULPTURE(Author author) {
		setAuthor(author);
	}
	...
	public SCULPTURE(Character character) {
	...
	public SCULPTURE(Citation citation) {
	...
	public SCULPTURE(Comment comment) {
		setComment(comment);
	}
	...
	public SCULPTURE(CommentCount commentCount) {
	...
	public SCULPTURE(ContentLocation contentLocation) {
	...
	public SCULPTURE(ContentRating contentRating) {
	...
	public SCULPTURE(ContentReferenceTime contentReferenceTime) {
	...
	public SCULPTURE(Contributor contributor) {
	...
	public SCULPTURE(CopyrightHolder copyrightHolder) {
	...
	public SCULPTURE(CopyrightYear copyrightYear) {
	...
	public SCULPTURE(Correction correction) {
	...
	public SCULPTURE(Creator creator) {
		setCreator(creator);
	}
	...
	public SCULPTURE(DateCreated dateCreated) {
	...
	public SCULPTURE(DateModified dateModified) {
	...
	public SCULPTURE(DatePublished datePublished) {
	...
	public SCULPTURE(Description description) {
	...
	public SCULPTURE(DisambiguatingDescription disambiguatingDescription) {
	...
	public SCULPTURE(DiscussionUrl discussionUrl) {
	...
	public SCULPTURE(Editor editor) {
		setEditor(editor);
	}
	...
	public SCULPTURE(EducationalAlignment educationalAlignment) {
	...
	public SCULPTURE(EducationalUse educationalUse) {
	...
	public SCULPTURE(Encoding encoding) {
	...
	public SCULPTURE(EncodingFormat encodingFormat) {
	...
	public SCULPTURE(ExampleOfWork exampleOfWork) {
	...
	public SCULPTURE(Expires expires) {
		setExpires(expires);
	}
	...
	public SCULPTURE(Funder funder) {
		setFunder(funder);
	}
	...
	public SCULPTURE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public SCULPTURE(Headline headline) {
	...
	public SCULPTURE(Identifier identifier) {
	...
	public SCULPTURE(InLanguage inLanguage) {
	...
	public SCULPTURE(InteractionStatistic interactionStatistic) {
	...
	public SCULPTURE(InteractivityType interactivityType) {
	...
	public SCULPTURE(IsAccessibleForFree isAccessibleForFree) {
	...
	public SCULPTURE(IsBasedOn isBasedOn) {
	...
	public SCULPTURE(IsFamilyFriendly isFamilyFriendly) {
	...
	public SCULPTURE(IsPartOf isPartOf) {
	...
	public SCULPTURE(Keywords keywords) {
	...
	public SCULPTURE(LearningResourceType learningResourceType) {
	...
	public SCULPTURE(License license) {
		setLicense(license);
	}
	...
	public SCULPTURE(LocationCreated locationCreated) {
	...
	public SCULPTURE(MainEntity mainEntity) {
	...
	public SCULPTURE(MainEntityOfPage mainEntityOfPage) {
	...
	public SCULPTURE(Material material) {
	...
	public SCULPTURE(MaterialExtent materialExtent) {
	...
	public SCULPTURE(Mentions mentions) {
	...
	public SCULPTURE(NameFuzzy nameFuzzy) {
	...
	public SCULPTURE(NameRuby nameRuby) {
	...
	public SCULPTURE(Offers offers) {
		setOffers(offers);
	}
	...
	public SCULPTURE(Position position) {
	...
	public SCULPTURE(PotentialAction potentialAction) {
	...
	public SCULPTURE(Producer producer) {
	...
	public SCULPTURE(Provider provider) {
	...
	public SCULPTURE(Publication publication) {
	...
	public SCULPTURE(Publisher publisher) {
	...
	public SCULPTURE(PublisherImprint publisherImprint) {
	...
	public SCULPTURE(PublishingPrinciples publishingPrinciples) {
	...
	public SCULPTURE(RecordedAt recordedAt) {
	...
	public SCULPTURE(ReleasedEvent releasedEvent) {
	...
	public SCULPTURE(Review review) {
		setReview(review);
	}
	...
	public SCULPTURE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SCULPTURE(SchemaVersion schemaVersion) {
	...
	public SCULPTURE(SdDatePublished sdDatePublished) {
	...
	public SCULPTURE(SdLicense sdLicense) {
	...
	public SCULPTURE(SdPublisher sdPublisher) {
	...
	public SCULPTURE(SourceOrganization sourceOrganization) {
	...
	public SCULPTURE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public SCULPTURE(SpatialCoverage spatialCoverage) {
	...
	public SCULPTURE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public SCULPTURE(SubjectOf subjectOf) {
	...
	public SCULPTURE(Temporal temporal) {
	...
	public SCULPTURE(TemporalCoverage temporalCoverage) {
	...
	public SCULPTURE(ThumbnailUrl thumbnailUrl) {
	...
	public SCULPTURE(TimeRequired timeRequired) {
	...
	public SCULPTURE(TranslationOfWork translationOfWork) {
	...
	public SCULPTURE(Translator translator) {
	...
	public SCULPTURE(TypicalAgeRange typicalAgeRange) {
	...
	public SCULPTURE(Version version) {
		setVersion(version);
	}
	...
	public SCULPTURE(WorkExample workExample) {
	...
	public SCULPTURE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Sculpture org) {
		setSeq(org.getSeq());
