...
public class INTERNET_CAFE implements Clazz.InternetCafe {
	...
	public INTERNET_CAFE(GeoContains geoContains) {
	...
	public INTERNET_CAFE(GeoCoveredBy geoCoveredBy) {
	...
	public INTERNET_CAFE(GeoCovers geoCovers) {
	...
	public INTERNET_CAFE(GeoCrosses geoCrosses) {
	...
	public INTERNET_CAFE(GeoDisjoint geoDisjoint) {
	...
	public INTERNET_CAFE(GeoEquals geoEquals) {
	...
	public INTERNET_CAFE(GeoIntersects geoIntersects) {
	...
	public INTERNET_CAFE(GeoOverlaps geoOverlaps) {
	...
	public INTERNET_CAFE(GeoTouches geoTouches) {
	...
	public INTERNET_CAFE(GeoWithin geoWithin) {
	...
	public INTERNET_CAFE(Slogan slogan) {
		setSlogan(slogan);
	}
