...
public class MUSIC_VENUE implements Clazz.MusicVenue {
	...
	public MUSIC_VENUE(GeoContains geoContains) {
	...
	public MUSIC_VENUE(GeoCoveredBy geoCoveredBy) {
	...
	public MUSIC_VENUE(GeoCovers geoCovers) {
	...
	public MUSIC_VENUE(GeoCrosses geoCrosses) {
	...
	public MUSIC_VENUE(GeoDisjoint geoDisjoint) {
	...
	public MUSIC_VENUE(GeoEquals geoEquals) {
	...
	public MUSIC_VENUE(GeoIntersects geoIntersects) {
	...
	public MUSIC_VENUE(GeoOverlaps geoOverlaps) {
	...
	public MUSIC_VENUE(GeoTouches geoTouches) {
	...
	public MUSIC_VENUE(GeoWithin geoWithin) {
	...
	public MUSIC_VENUE(Slogan slogan) {
		setSlogan(slogan);
	}
