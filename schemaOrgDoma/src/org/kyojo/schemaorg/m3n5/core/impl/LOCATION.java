...
public class LOCATION implements Container.Location {
	...
	public LOCATION(Accommodation accommodation) {
	...
	public LOCATION(AccountingService accountingService) {
	...
	public LOCATION(AdministrativeArea administrativeArea) {
	...
	public LOCATION(AdultEntertainment adultEntertainment) {
	...
	public LOCATION(AmusementPark amusementPark) {
	...
	public LOCATION(AnimalShelter animalShelter) {
	...
	public LOCATION(Apartment apartment) {
	...
	public LOCATION(ApartmentComplex apartmentComplex) {
	...
	public LOCATION(Aquarium aquarium) {
	...
	public LOCATION(ArchiveOrganization archiveOrganization) {
	...
	public LOCATION(ArtGallery artGallery) {
	...
	public LOCATION(Attorney attorney) {
	...
	public LOCATION(AutoBodyShop autoBodyShop) {
	...
	public LOCATION(AutoDealer autoDealer) {
	...
	public LOCATION(AutoPartsStore autoPartsStore) {
	...
	public LOCATION(AutoRental autoRental) {
	...
	public LOCATION(AutoRepair autoRepair) {
	...
	public LOCATION(AutoWash autoWash) {
	...
	public LOCATION(AutomatedTeller automatedTeller) {
	...
	public LOCATION(AutomotiveBusiness automotiveBusiness) {
	...
	public LOCATION(BankOrCreditUnion bankOrCreditUnion) {
	...
	public LOCATION(BarOrPub barOrPub) {
	...
	public LOCATION(BeautySalon beautySalon) {
	...
	public LOCATION(BedAndBreakfast bedAndBreakfast) {
	...
	public LOCATION(BikeStore bikeStore) {
	...
	public LOCATION(BodyOfWater bodyOfWater) {
	...
	public LOCATION(BookStore bookStore) {
	...
	public LOCATION(BowlingAlley bowlingAlley) {
	...
	public LOCATION(Brewery brewery) {
	...
	public LOCATION(BuddhistTemple buddhistTemple) {
	...
	public LOCATION(BusStation busStation) {
	...
	public LOCATION(BusStop busStop) {
	...
	public LOCATION(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public LOCATION(Campground campground) {
	...
	public LOCATION(CampingPitch campingPitch) {
	...
	public LOCATION(CatholicChurch catholicChurch) {
	...
	public LOCATION(Cemetery cemetery) {
	...
	public LOCATION(ChildCare childCare) {
	...
	public LOCATION(CityHall cityHall) {
	...
	public LOCATION(CivicStructure civicStructure) {
	...
	public LOCATION(ClothingStore clothingStore) {
	...
	public LOCATION(ComedyClub comedyClub) {
	...
	public LOCATION(CommunityHealth communityHealth) {
	...
	public LOCATION(ComputerStore computerStore) {
	...
	public LOCATION(ConvenienceStore convenienceStore) {
	...
	public LOCATION(Courthouse courthouse) {
	...
	public LOCATION(Crematorium crematorium) {
	...
	public LOCATION(DefenceEstablishment defenceEstablishment) {
	...
	public LOCATION(Dentist dentist) {
	...
	public LOCATION(DepartmentStore departmentStore) {
	...
	public LOCATION(Dermatology dermatology) {
	...
	public LOCATION(DietNutrition dietNutrition) {
	...
	public LOCATION(Distillery distillery) {
	...
	public LOCATION(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public LOCATION(Electrician electrician) {
	...
	public LOCATION(ElectronicsStore electronicsStore) {
	...
	public LOCATION(Embassy embassy) {
	...
	public LOCATION(Emergency emergency) {
	...
	public LOCATION(EmergencyService emergencyService) {
	...
	public LOCATION(EmploymentAgency employmentAgency) {
	...
	public LOCATION(EntertainmentBusiness entertainmentBusiness) {
	...
	public LOCATION(EventVenue eventVenue) {
	...
	public LOCATION(ExerciseGym exerciseGym) {
	...
	public LOCATION(FastFoodRestaurant fastFoodRestaurant) {
	...
	public LOCATION(FinancialService financialService) {
	...
	public LOCATION(FireStation fireStation) {
	...
	public LOCATION(Florist florist) {
	...
	public LOCATION(FoodEstablishment foodEstablishment) {
	...
	public LOCATION(FurnitureStore furnitureStore) {
	...
	public LOCATION(GardenStore gardenStore) {
	...
	public LOCATION(GasStation gasStation) {
	...
	public LOCATION(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public LOCATION(GeneralContractor generalContractor) {
	...
	public LOCATION(Geriatric geriatric) {
	...
	public LOCATION(GolfCourse golfCourse) {
	...
	public LOCATION(GovernmentBuilding governmentBuilding) {
	...
	public LOCATION(GovernmentOffice governmentOffice) {
	...
	public LOCATION(GroceryStore groceryStore) {
	...
	public LOCATION(Gynecologic gynecologic) {
	...
	public LOCATION(HVACBusiness hvacBusiness) {
	...
	public LOCATION(HairSalon hairSalon) {
	...
	public LOCATION(HardwareStore hardwareStore) {
	...
	public LOCATION(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public LOCATION(HealthClub healthClub) {
	...
	public LOCATION(HinduTemple hinduTemple) {
	...
	public LOCATION(HobbyShop hobbyShop) {
	...
	public LOCATION(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public LOCATION(HomeGoodsStore homeGoodsStore) {
	...
	public LOCATION(Hospital hospital) {
	...
	public LOCATION(HotelRoom hotelRoom) {
	...
	public LOCATION(HousePainter housePainter) {
	...
	public LOCATION(IceCreamShop iceCreamShop) {
	...
	public LOCATION(InsuranceAgency insuranceAgency) {
	...
	public LOCATION(InternetCafe internetCafe) {
	...
	public LOCATION(JewelryStore jewelryStore) {
	...
	public LOCATION(LakeBodyOfWater lakeBodyOfWater) {
	...
	public LOCATION(Landform landform) {
	...
	public LOCATION(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public LOCATION(LegalService legalService) {
	...
	public LOCATION(LegislativeBuilding legislativeBuilding) {
	...
	public LOCATION(Library library) {
	...
	public LOCATION(LiquorStore liquorStore) {
	...
	public LOCATION(LocalBusiness localBusiness) {
	...
	public LOCATION(Locksmith locksmith) {
	...
	public LOCATION(LodgingBusiness lodgingBusiness) {
	...
	public LOCATION(MedicalBusiness medicalBusiness) {
	...
	public LOCATION(MedicalClinic medicalClinic) {
	...
	public LOCATION(MeetingRoom meetingRoom) {
	...
	public LOCATION(MensClothingStore mensClothingStore) {
	...
	public LOCATION(Midwifery midwifery) {
	...
	public LOCATION(MobilePhoneStore mobilePhoneStore) {
	...
	public LOCATION(MotorcycleDealer motorcycleDealer) {
	...
	public LOCATION(MotorcycleRepair motorcycleRepair) {
	...
	public LOCATION(Mountain mountain) {
	...
	public LOCATION(MovieRentalStore movieRentalStore) {
	...
	public LOCATION(MovieTheater movieTheater) {
	...
	public LOCATION(MovingCompany movingCompany) {
	...
	public LOCATION(MusicStore musicStore) {
	...
	public LOCATION(MusicVenue musicVenue) {
	...
	public LOCATION(NailSalon nailSalon) {
	...
	public LOCATION(NightClub nightClub) {
	...
	public LOCATION(Nursing nursing) {
	...
	public LOCATION(Obstetric obstetric) {
	...
	public LOCATION(OceanBodyOfWater oceanBodyOfWater) {
	...
	public LOCATION(OfficeEquipmentStore officeEquipmentStore) {
	...
	public LOCATION(Oncologic oncologic) {
	...
	public LOCATION(Optician optician) {
	...
	public LOCATION(Optometric optometric) {
	...
	public LOCATION(Otolaryngologic otolaryngologic) {
	...
	public LOCATION(OutletStore outletStore) {
	...
	public LOCATION(ParkingFacility parkingFacility) {
	...
	public LOCATION(PawnShop pawnShop) {
	...
	public LOCATION(Pediatric pediatric) {
	...
	public LOCATION(PerformingArtsTheater performingArtsTheater) {
	...
	public LOCATION(PetStore petStore) {
	...
	public LOCATION(Pharmacy pharmacy) {
	...
	public LOCATION(Physician physician) {
	...
	public LOCATION(Physiotherapy physiotherapy) {
	...
	public LOCATION(PlaceOfWorship placeOfWorship) {
	...
	public LOCATION(PlasticSurgery plasticSurgery) {
	...
	public LOCATION(Plumber plumber) {
	...
	public LOCATION(Podiatric podiatric) {
	...
	public LOCATION(PoliceStation policeStation) {
	...
	public LOCATION(PrimaryCare primaryCare) {
	...
	public LOCATION(ProfessionalService professionalService) {
	...
	public LOCATION(Psychiatric psychiatric) {
	...
	public LOCATION(PublicHealth publicHealth) {
	...
	public LOCATION(PublicSwimmingPool publicSwimmingPool) {
	...
	public LOCATION(PublicToilet publicToilet) {
	...
	public LOCATION(RadioStation radioStation) {
	...
	public LOCATION(RealEstateAgent realEstateAgent) {
	...
	public LOCATION(RecyclingCenter recyclingCenter) {
	...
	public LOCATION(Reservoir reservoir) {
	...
	public LOCATION(Residence residence) {
	...
	public LOCATION(RiverBodyOfWater riverBodyOfWater) {
	...
	public LOCATION(RoofingContractor roofingContractor) {
	...
	public LOCATION(SeaBodyOfWater seaBodyOfWater) {
	...
	public LOCATION(SelfStorage selfStorage) {
	...
	public LOCATION(ShoeStore shoeStore) {
	...
	public LOCATION(ShoppingCenter shoppingCenter) {
	...
	public LOCATION(SingleFamilyResidence singleFamilyResidence) {
	...
	public LOCATION(SkiResort skiResort) {
	...
	public LOCATION(SportingGoodsStore sportingGoodsStore) {
	...
	public LOCATION(SportsActivityLocation sportsActivityLocation) {
	...
	public LOCATION(SportsClub sportsClub) {
	...
	public LOCATION(StadiumOrArena stadiumOrArena) {
	...
	public LOCATION(SubwayStation subwayStation) {
	...
	public LOCATION(Synagogue synagogue) {
	...
	public LOCATION(TattooParlor tattooParlor) {
	...
	public LOCATION(TaxiStand taxiStand) {
	...
	public LOCATION(TelevisionStation televisionStation) {
	...
	public LOCATION(TennisComplex tennisComplex) {
	...
	public LOCATION(TireShop tireShop) {
	...
	public LOCATION(TouristAttraction touristAttraction) {
	...
	public LOCATION(TouristDestination touristDestination) {
	...
	public LOCATION(TouristInformationCenter touristInformationCenter) {
	...
	public LOCATION(ToyStore toyStore) {
	...
	public LOCATION(TrainStation trainStation) {
	...
	public LOCATION(TravelAgency travelAgency) {
	...
	public LOCATION(Volcano volcano) {
	...
	public LOCATION(Waterfall waterfall) {
	...
	public LOCATION(WholesaleStore wholesaleStore) {
