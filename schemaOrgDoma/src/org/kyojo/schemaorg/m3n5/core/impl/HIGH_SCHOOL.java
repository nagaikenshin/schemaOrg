...
public class HIGH_SCHOOL implements Clazz.HighSchool {
	...
	public HIGH_SCHOOL(Long seq) {
		setSeq(seq);
	}

	public HIGH_SCHOOL(String string) {
	...
	public HIGH_SCHOOL(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public HIGH_SCHOOL(AdditionalType additionalType) {
	...
	public HIGH_SCHOOL(Address address) {
		setAddress(address);
	}
	...
	public HIGH_SCHOOL(AggregateRating aggregateRating) {
	...
	public HIGH_SCHOOL(AlternateName alternateName) {
	...
	public HIGH_SCHOOL(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public HIGH_SCHOOL(AreaServed areaServed) {
	...
	public HIGH_SCHOOL(Award award) {
		setAward(award);
	}
	...
	public HIGH_SCHOOL(Brand brand) {
		setBrand(brand);
	}
	...
	public HIGH_SCHOOL(ContactPoint contactPoint) {
	...
	public HIGH_SCHOOL(CorrectionsPolicy correctionsPolicy) {
	...
	public HIGH_SCHOOL(Department department) {
	...
	public HIGH_SCHOOL(Description description) {
	...
	public HIGH_SCHOOL(DisambiguatingDescription disambiguatingDescription) {
	...
	public HIGH_SCHOOL(DissolutionDate dissolutionDate) {
	...
	public HIGH_SCHOOL(DiversityPolicy diversityPolicy) {
	...
	public HIGH_SCHOOL(DiversityStaffingReport diversityStaffingReport) {
	...
	public HIGH_SCHOOL(Email email) {
		setEmail(email);
	}
	...
	public HIGH_SCHOOL(Employee employee) {
	...
	public HIGH_SCHOOL(EthicsPolicy ethicsPolicy) {
	...
	public HIGH_SCHOOL(Event event) {
		setEvent(event);
	}
	...
	public HIGH_SCHOOL(FaxNumber faxNumber) {
	...
	public HIGH_SCHOOL(Founder founder) {
		setFounder(founder);
	}
	...
	public HIGH_SCHOOL(FoundingDate foundingDate) {
	...
	public HIGH_SCHOOL(FoundingLocation foundingLocation) {
	...
	public HIGH_SCHOOL(Funder funder) {
		setFunder(funder);
	}
	...
	public HIGH_SCHOOL(GlobalLocationNumber globalLocationNumber) {
	...
	public HIGH_SCHOOL(HasOfferCatalog hasOfferCatalog) {
	...
	public HIGH_SCHOOL(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public HIGH_SCHOOL(Identifier identifier) {
	...
	public HIGH_SCHOOL(Image image) {
		setImage(image);
	}
	...
	public HIGH_SCHOOL(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public HIGH_SCHOOL(KnowsAbout knowsAbout) {
	...
	public HIGH_SCHOOL(KnowsLanguage knowsLanguage) {
	...
	public HIGH_SCHOOL(LegalName legalName) {
	...
	public HIGH_SCHOOL(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public HIGH_SCHOOL(Location location) {
	...
	public HIGH_SCHOOL(MainEntityOfPage mainEntityOfPage) {
	...
	public HIGH_SCHOOL(MakesOffer makesOffer) {
	...
	public HIGH_SCHOOL(Member member) {
		setMember(member);
	}
	...
	public HIGH_SCHOOL(MemberOf memberOf) {
	...
	public HIGH_SCHOOL(Naics naics) {
		setNaics(naics);
	}
	...
	public HIGH_SCHOOL(NameFuzzy nameFuzzy) {
	...
	public HIGH_SCHOOL(NameRuby nameRuby) {
	...
	public HIGH_SCHOOL(NumberOfEmployees numberOfEmployees) {
	...
	public HIGH_SCHOOL(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public HIGH_SCHOOL(ParentOrganization parentOrganization) {
	...
	public HIGH_SCHOOL(PotentialAction potentialAction) {
	...
	public HIGH_SCHOOL(PublishingPrinciples publishingPrinciples) {
	...
	public HIGH_SCHOOL(Review review) {
		setReview(review);
	}
	...
	public HIGH_SCHOOL(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public HIGH_SCHOOL(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public HIGH_SCHOOL(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public HIGH_SCHOOL(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public HIGH_SCHOOL(SubOrganization subOrganization) {
	...
	public HIGH_SCHOOL(SubjectOf subjectOf) {
	...
	public HIGH_SCHOOL(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public HIGH_SCHOOL(Telephone telephone) {
	...
	public HIGH_SCHOOL(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public HIGH_SCHOOL(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.HighSchool org) {
		setSeq(org.getSeq());
