...
public class PUBLIC_SWIMMING_POOL implements Clazz.PublicSwimmingPool {
	...
	public PUBLIC_SWIMMING_POOL(GeoContains geoContains) {
	...
	public PUBLIC_SWIMMING_POOL(GeoCoveredBy geoCoveredBy) {
	...
	public PUBLIC_SWIMMING_POOL(GeoCovers geoCovers) {
	...
	public PUBLIC_SWIMMING_POOL(GeoCrosses geoCrosses) {
	...
	public PUBLIC_SWIMMING_POOL(GeoDisjoint geoDisjoint) {
	...
	public PUBLIC_SWIMMING_POOL(GeoEquals geoEquals) {
	...
	public PUBLIC_SWIMMING_POOL(GeoIntersects geoIntersects) {
	...
	public PUBLIC_SWIMMING_POOL(GeoOverlaps geoOverlaps) {
	...
	public PUBLIC_SWIMMING_POOL(GeoTouches geoTouches) {
	...
	public PUBLIC_SWIMMING_POOL(GeoWithin geoWithin) {
	...
	public PUBLIC_SWIMMING_POOL(Slogan slogan) {
		setSlogan(slogan);
	}
