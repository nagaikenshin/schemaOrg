...
public class FESTIVAL implements Clazz.Festival {
	...
	public FESTIVAL(AdditionalType additionalType) {
	...
	public FESTIVAL(AggregateRating aggregateRating) {
	...
	public FESTIVAL(AlternateName alternateName) {
	...
	public FESTIVAL(Attendee attendee) {
	...
	public FESTIVAL(Audience audience) {
	...
	public FESTIVAL(Composer composer) {
	...
	public FESTIVAL(Contributor contributor) {
	...
	public FESTIVAL(Description description) {
	...
	public FESTIVAL(Director director) {
	...
	public FESTIVAL(DisambiguatingDescription disambiguatingDescription) {
	...
	public FESTIVAL(DoorTime doorTime) {
	...
	public FESTIVAL(Duration duration) {
	...
	public FESTIVAL(EndDate endDate) {
		setEndDate(endDate);
	}
	...
	public FESTIVAL(EventStatus eventStatus) {
	...
	public FESTIVAL(Identifier identifier) {
	...
	public FESTIVAL(InLanguage inLanguage) {
	...
	public FESTIVAL(IsAccessibleForFree isAccessibleForFree) {
	...
	public FESTIVAL(Location location) {
	...
	public FESTIVAL(MainEntityOfPage mainEntityOfPage) {
	...
	public FESTIVAL(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public FESTIVAL(NameFuzzy nameFuzzy) {
	...
	public FESTIVAL(NameRuby nameRuby) {
	...
	public FESTIVAL(Organizer organizer) {
	...
	public FESTIVAL(Performer performer) {
	...
	public FESTIVAL(PotentialAction potentialAction) {
	...
	public FESTIVAL(PreviousStartDate previousStartDate) {
	...
	public FESTIVAL(RecordedIn recordedIn) {
	...
	public FESTIVAL(RemainingAttendeeCapacity remainingAttendeeCapacity) {
	...
	public FESTIVAL(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public FESTIVAL(StartDate startDate) {
	...
	public FESTIVAL(SubEvent subEvent) {
	...
	public FESTIVAL(SubjectOf subjectOf) {
	...
	public FESTIVAL(SuperEvent superEvent) {
	...
	public FESTIVAL(Translator translator) {
	...
	public FESTIVAL(TypicalAgeRange typicalAgeRange) {
	...
	public FESTIVAL(WorkFeatured workFeatured) {
	...
	public FESTIVAL(WorkPerformed workPerformed) {
	...
	public void copy(Clazz.Festival org) {
		setSeq(org.getSeq());
