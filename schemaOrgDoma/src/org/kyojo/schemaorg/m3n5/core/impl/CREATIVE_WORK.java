...
public class CREATIVE_WORK implements Clazz.CreativeWork {
	...
	public CREATIVE_WORK(Long seq) {
		setSeq(seq);
	}

	public CREATIVE_WORK(String string) {
	...
	public CREATIVE_WORK(About about) {
		setAbout(about);
	}
	...
	public CREATIVE_WORK(AccessMode accessMode) {
	...
	public CREATIVE_WORK(AccessModeSufficient accessModeSufficient) {
	...
	public CREATIVE_WORK(AccessibilityAPI accessibilityAPI) {
	...
	public CREATIVE_WORK(AccessibilityControl accessibilityControl) {
	...
	public CREATIVE_WORK(AccessibilityFeature accessibilityFeature) {
	...
	public CREATIVE_WORK(AccessibilityHazard accessibilityHazard) {
	...
	public CREATIVE_WORK(AccessibilitySummary accessibilitySummary) {
	...
	public CREATIVE_WORK(AccountablePerson accountablePerson) {
	...
	public CREATIVE_WORK(AdditionalType additionalType) {
	...
	public CREATIVE_WORK(AggregateRating aggregateRating) {
	...
	public CREATIVE_WORK(AlternateName alternateName) {
	...
	public CREATIVE_WORK(AlternativeHeadline alternativeHeadline) {
	...
	public CREATIVE_WORK(AssociatedMedia associatedMedia) {
	...
	public CREATIVE_WORK(Audience audience) {
	...
	public CREATIVE_WORK(Audio audio) {
		setAudio(audio);
	}
	...
	public CREATIVE_WORK(Author author) {
		setAuthor(author);
	}
	...
	public CREATIVE_WORK(Award award) {
		setAward(award);
	}
	...
	public CREATIVE_WORK(Character character) {
	...
	public CREATIVE_WORK(Citation citation) {
	...
	public CREATIVE_WORK(Comment comment) {
		setComment(comment);
	}
	...
	public CREATIVE_WORK(CommentCount commentCount) {
	...
	public CREATIVE_WORK(ContentLocation contentLocation) {
	...
	public CREATIVE_WORK(ContentRating contentRating) {
	...
	public CREATIVE_WORK(ContentReferenceTime contentReferenceTime) {
	...
	public CREATIVE_WORK(Contributor contributor) {
	...
	public CREATIVE_WORK(CopyrightHolder copyrightHolder) {
	...
	public CREATIVE_WORK(CopyrightYear copyrightYear) {
	...
	public CREATIVE_WORK(Correction correction) {
	...
	public CREATIVE_WORK(Creator creator) {
		setCreator(creator);
	}
	...
	public CREATIVE_WORK(DateCreated dateCreated) {
	...
	public CREATIVE_WORK(DateModified dateModified) {
	...
	public CREATIVE_WORK(DatePublished datePublished) {
	...
	public CREATIVE_WORK(Description description) {
	...
	public CREATIVE_WORK(DisambiguatingDescription disambiguatingDescription) {
	...
	public CREATIVE_WORK(DiscussionUrl discussionUrl) {
	...
	public CREATIVE_WORK(Editor editor) {
		setEditor(editor);
	}
	...
	public CREATIVE_WORK(EducationalAlignment educationalAlignment) {
	...
	public CREATIVE_WORK(EducationalUse educationalUse) {
	...
	public CREATIVE_WORK(Encoding encoding) {
	...
	public CREATIVE_WORK(EncodingFormat encodingFormat) {
	...
	public CREATIVE_WORK(ExampleOfWork exampleOfWork) {
	...
	public CREATIVE_WORK(Expires expires) {
		setExpires(expires);
	}
	...
	public CREATIVE_WORK(Funder funder) {
		setFunder(funder);
	}
	...
	public CREATIVE_WORK(Genre genre) {
		setGenre(genre);
	}
	...
	public CREATIVE_WORK(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public CREATIVE_WORK(Headline headline) {
	...
	public CREATIVE_WORK(Identifier identifier) {
	...
	public CREATIVE_WORK(Image image) {
		setImage(image);
	}
	...
	public CREATIVE_WORK(InLanguage inLanguage) {
	...
	public CREATIVE_WORK(InteractionStatistic interactionStatistic) {
	...
	public CREATIVE_WORK(InteractivityType interactivityType) {
	...
	public CREATIVE_WORK(IsAccessibleForFree isAccessibleForFree) {
	...
	public CREATIVE_WORK(IsBasedOn isBasedOn) {
	...
	public CREATIVE_WORK(IsFamilyFriendly isFamilyFriendly) {
	...
	public CREATIVE_WORK(IsPartOf isPartOf) {
	...
	public CREATIVE_WORK(Keywords keywords) {
	...
	public CREATIVE_WORK(LearningResourceType learningResourceType) {
	...
	public CREATIVE_WORK(License license) {
		setLicense(license);
	}
	...
	public CREATIVE_WORK(LocationCreated locationCreated) {
	...
	public CREATIVE_WORK(MainEntity mainEntity) {
	...
	public CREATIVE_WORK(MainEntityOfPage mainEntityOfPage) {
	...
	public CREATIVE_WORK(Material material) {
	...
	public CREATIVE_WORK(MaterialExtent materialExtent) {
	...
	public CREATIVE_WORK(Mentions mentions) {
	...
	public CREATIVE_WORK(Name name) {
		setName(name);
	}
	...
	public CREATIVE_WORK(NameFuzzy nameFuzzy) {
	...
	public CREATIVE_WORK(NameRuby nameRuby) {
	...
	public CREATIVE_WORK(Offers offers) {
		setOffers(offers);
	}
	...
	public CREATIVE_WORK(Position position) {
	...
	public CREATIVE_WORK(PotentialAction potentialAction) {
	...
	public CREATIVE_WORK(Producer producer) {
	...
	public CREATIVE_WORK(Provider provider) {
	...
	public CREATIVE_WORK(Publication publication) {
	...
	public CREATIVE_WORK(Publisher publisher) {
	...
	public CREATIVE_WORK(PublisherImprint publisherImprint) {
	...
	public CREATIVE_WORK(PublishingPrinciples publishingPrinciples) {
	...
	public CREATIVE_WORK(RecordedAt recordedAt) {
	...
	public CREATIVE_WORK(ReleasedEvent releasedEvent) {
	...
	public CREATIVE_WORK(Review review) {
		setReview(review);
	}
	...
	public CREATIVE_WORK(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CREATIVE_WORK(SchemaVersion schemaVersion) {
	...
	public CREATIVE_WORK(SdDatePublished sdDatePublished) {
	...
	public CREATIVE_WORK(SdLicense sdLicense) {
	...
	public CREATIVE_WORK(SdPublisher sdPublisher) {
	...
	public CREATIVE_WORK(SourceOrganization sourceOrganization) {
	...
	public CREATIVE_WORK(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public CREATIVE_WORK(SpatialCoverage spatialCoverage) {
	...
	public CREATIVE_WORK(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public CREATIVE_WORK(SubjectOf subjectOf) {
	...
	public CREATIVE_WORK(Temporal temporal) {
	...
	public CREATIVE_WORK(TemporalCoverage temporalCoverage) {
	...
	public CREATIVE_WORK(Text text) {
		setText(text);
	}
	...
	public CREATIVE_WORK(ThumbnailUrl thumbnailUrl) {
	...
	public CREATIVE_WORK(TimeRequired timeRequired) {
	...
	public CREATIVE_WORK(TranslationOfWork translationOfWork) {
	...
	public CREATIVE_WORK(Translator translator) {
	...
	public CREATIVE_WORK(TypicalAgeRange typicalAgeRange) {
	...
	public CREATIVE_WORK(Version version) {
		setVersion(version);
	}
	...
	public CREATIVE_WORK(Video video) {
		setVideo(video);
	}
	...
	public CREATIVE_WORK(WorkExample workExample) {
	...
	public CREATIVE_WORK(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.CreativeWork org) {
		setSeq(org.getSeq());
