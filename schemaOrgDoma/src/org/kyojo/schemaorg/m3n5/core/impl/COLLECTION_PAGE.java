...
public class COLLECTION_PAGE implements Clazz.CollectionPage {
	...
	public COLLECTION_PAGE(Long seq) {
		setSeq(seq);
	}

	public COLLECTION_PAGE(String string) {
	...
	public COLLECTION_PAGE(About about) {
		setAbout(about);
	}
	...
	public COLLECTION_PAGE(AccessMode accessMode) {
	...
	public COLLECTION_PAGE(AccessModeSufficient accessModeSufficient) {
	...
	public COLLECTION_PAGE(AccessibilityAPI accessibilityAPI) {
	...
	public COLLECTION_PAGE(AccessibilityControl accessibilityControl) {
	...
	public COLLECTION_PAGE(AccessibilityFeature accessibilityFeature) {
	...
	public COLLECTION_PAGE(AccessibilityHazard accessibilityHazard) {
	...
	public COLLECTION_PAGE(AccessibilitySummary accessibilitySummary) {
	...
	public COLLECTION_PAGE(AccountablePerson accountablePerson) {
	...
	public COLLECTION_PAGE(AdditionalType additionalType) {
	...
	public COLLECTION_PAGE(AggregateRating aggregateRating) {
	...
	public COLLECTION_PAGE(AlternateName alternateName) {
	...
	public COLLECTION_PAGE(AlternativeHeadline alternativeHeadline) {
	...
	public COLLECTION_PAGE(AssociatedMedia associatedMedia) {
	...
	public COLLECTION_PAGE(Audience audience) {
	...
	public COLLECTION_PAGE(Audio audio) {
		setAudio(audio);
	}
	...
	public COLLECTION_PAGE(Author author) {
		setAuthor(author);
	}
	...
	public COLLECTION_PAGE(Award award) {
		setAward(award);
	}
	...
	public COLLECTION_PAGE(Breadcrumb breadcrumb) {
	...
	public COLLECTION_PAGE(Character character) {
	...
	public COLLECTION_PAGE(Citation citation) {
	...
	public COLLECTION_PAGE(Comment comment) {
		setComment(comment);
	}
	...
	public COLLECTION_PAGE(CommentCount commentCount) {
	...
	public COLLECTION_PAGE(ContentLocation contentLocation) {
	...
	public COLLECTION_PAGE(ContentRating contentRating) {
	...
	public COLLECTION_PAGE(ContentReferenceTime contentReferenceTime) {
	...
	public COLLECTION_PAGE(Contributor contributor) {
	...
	public COLLECTION_PAGE(CopyrightHolder copyrightHolder) {
	...
	public COLLECTION_PAGE(CopyrightYear copyrightYear) {
	...
	public COLLECTION_PAGE(Correction correction) {
	...
	public COLLECTION_PAGE(Creator creator) {
		setCreator(creator);
	}
	...
	public COLLECTION_PAGE(DateCreated dateCreated) {
	...
	public COLLECTION_PAGE(DateModified dateModified) {
	...
	public COLLECTION_PAGE(DatePublished datePublished) {
	...
	public COLLECTION_PAGE(Description description) {
	...
	public COLLECTION_PAGE(DisambiguatingDescription disambiguatingDescription) {
	...
	public COLLECTION_PAGE(DiscussionUrl discussionUrl) {
	...
	public COLLECTION_PAGE(Editor editor) {
		setEditor(editor);
	}
	...
	public COLLECTION_PAGE(EducationalAlignment educationalAlignment) {
	...
	public COLLECTION_PAGE(EducationalUse educationalUse) {
	...
	public COLLECTION_PAGE(Encoding encoding) {
	...
	public COLLECTION_PAGE(EncodingFormat encodingFormat) {
	...
	public COLLECTION_PAGE(ExampleOfWork exampleOfWork) {
	...
	public COLLECTION_PAGE(Expires expires) {
		setExpires(expires);
	}
	...
	public COLLECTION_PAGE(Funder funder) {
		setFunder(funder);
	}
	...
	public COLLECTION_PAGE(Genre genre) {
		setGenre(genre);
	}
	...
	public COLLECTION_PAGE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public COLLECTION_PAGE(Headline headline) {
	...
	public COLLECTION_PAGE(Identifier identifier) {
	...
	public COLLECTION_PAGE(Image image) {
		setImage(image);
	}
	...
	public COLLECTION_PAGE(InLanguage inLanguage) {
	...
	public COLLECTION_PAGE(InteractionStatistic interactionStatistic) {
	...
	public COLLECTION_PAGE(InteractivityType interactivityType) {
	...
	public COLLECTION_PAGE(IsAccessibleForFree isAccessibleForFree) {
	...
	public COLLECTION_PAGE(IsBasedOn isBasedOn) {
	...
	public COLLECTION_PAGE(IsFamilyFriendly isFamilyFriendly) {
	...
	public COLLECTION_PAGE(IsPartOf isPartOf) {
	...
	public COLLECTION_PAGE(Keywords keywords) {
	...
	public COLLECTION_PAGE(LastReviewed lastReviewed) {
	...
	public COLLECTION_PAGE(LearningResourceType learningResourceType) {
	...
	public COLLECTION_PAGE(License license) {
		setLicense(license);
	}
	...
	public COLLECTION_PAGE(LocationCreated locationCreated) {
	...
	public COLLECTION_PAGE(MainContentOfPage mainContentOfPage) {
	...
	public COLLECTION_PAGE(MainEntity mainEntity) {
	...
	public COLLECTION_PAGE(MainEntityOfPage mainEntityOfPage) {
	...
	public COLLECTION_PAGE(Material material) {
	...
	public COLLECTION_PAGE(MaterialExtent materialExtent) {
	...
	public COLLECTION_PAGE(Mentions mentions) {
	...
	public COLLECTION_PAGE(Name name) {
		setName(name);
	}
	...
	public COLLECTION_PAGE(NameFuzzy nameFuzzy) {
	...
	public COLLECTION_PAGE(NameRuby nameRuby) {
	...
	public COLLECTION_PAGE(Offers offers) {
		setOffers(offers);
	}
	...
	public COLLECTION_PAGE(Position position) {
	...
	public COLLECTION_PAGE(PotentialAction potentialAction) {
	...
	public COLLECTION_PAGE(PrimaryImageOfPage primaryImageOfPage) {
	...
	public COLLECTION_PAGE(Producer producer) {
	...
	public COLLECTION_PAGE(Provider provider) {
	...
	public COLLECTION_PAGE(Publication publication) {
	...
	public COLLECTION_PAGE(Publisher publisher) {
	...
	public COLLECTION_PAGE(PublisherImprint publisherImprint) {
	...
	public COLLECTION_PAGE(PublishingPrinciples publishingPrinciples) {
	...
	public COLLECTION_PAGE(RecordedAt recordedAt) {
	...
	public COLLECTION_PAGE(RelatedLink relatedLink) {
	...
	public COLLECTION_PAGE(ReleasedEvent releasedEvent) {
	...
	public COLLECTION_PAGE(Review review) {
		setReview(review);
	}
	...
	public COLLECTION_PAGE(ReviewedBy reviewedBy) {
	...
	public COLLECTION_PAGE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public COLLECTION_PAGE(SchemaVersion schemaVersion) {
	...
	public COLLECTION_PAGE(SdDatePublished sdDatePublished) {
	...
	public COLLECTION_PAGE(SdLicense sdLicense) {
	...
	public COLLECTION_PAGE(SdPublisher sdPublisher) {
	...
	public COLLECTION_PAGE(SignificantLink significantLink) {
	...
	public COLLECTION_PAGE(SourceOrganization sourceOrganization) {
	...
	public COLLECTION_PAGE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public COLLECTION_PAGE(SpatialCoverage spatialCoverage) {
	...
	public COLLECTION_PAGE(Speakable speakable) {
	...
	public COLLECTION_PAGE(Specialty specialty) {
	...
	public COLLECTION_PAGE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public COLLECTION_PAGE(SubjectOf subjectOf) {
	...
	public COLLECTION_PAGE(Temporal temporal) {
	...
	public COLLECTION_PAGE(TemporalCoverage temporalCoverage) {
	...
	public COLLECTION_PAGE(Text text) {
		setText(text);
	}
	...
	public COLLECTION_PAGE(ThumbnailUrl thumbnailUrl) {
	...
	public COLLECTION_PAGE(TimeRequired timeRequired) {
	...
	public COLLECTION_PAGE(TranslationOfWork translationOfWork) {
	...
	public COLLECTION_PAGE(Translator translator) {
	...
	public COLLECTION_PAGE(TypicalAgeRange typicalAgeRange) {
	...
	public COLLECTION_PAGE(Url url) {
		setUrl(url);
	}
	...
	public COLLECTION_PAGE(Version version) {
		setVersion(version);
	}
	...
	public COLLECTION_PAGE(Video video) {
		setVideo(video);
	}
	...
	public COLLECTION_PAGE(WorkExample workExample) {
	...
	public COLLECTION_PAGE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.CollectionPage org) {
		setSeq(org.getSeq());
