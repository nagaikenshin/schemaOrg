...
public class STORE implements Clazz.Store {
	...
	public STORE(GeoContains geoContains) {
	...
	public STORE(GeoCoveredBy geoCoveredBy) {
	...
	public STORE(GeoCovers geoCovers) {
	...
	public STORE(GeoCrosses geoCrosses) {
	...
	public STORE(GeoDisjoint geoDisjoint) {
	...
	public STORE(GeoEquals geoEquals) {
	...
	public STORE(GeoIntersects geoIntersects) {
	...
	public STORE(GeoOverlaps geoOverlaps) {
	...
	public STORE(GeoTouches geoTouches) {
	...
	public STORE(GeoWithin geoWithin) {
