...
public class TOLL_FREE implements ContactPointOption.TollFree {
	...
	public TOLL_FREE(Long seq) {
		setSeq(seq);
	}

	public TOLL_FREE(String string) {
	...
	public TOLL_FREE(AdditionalType additionalType) {
	...
	public TOLL_FREE(AlternateName alternateName) {
	...
	public TOLL_FREE(Description description) {
	...
	public TOLL_FREE(DisambiguatingDescription disambiguatingDescription) {
	...
	public TOLL_FREE(Identifier identifier) {
	...
	public TOLL_FREE(MainEntityOfPage mainEntityOfPage) {
	...
	public TOLL_FREE(NameFuzzy nameFuzzy) {
	...
	public TOLL_FREE(NameRuby nameRuby) {
	...
	public TOLL_FREE(PotentialAction potentialAction) {
	...
	public TOLL_FREE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TOLL_FREE(SubjectOf subjectOf) {
	...
	public TOLL_FREE(SupersededBy supersededBy) {
	...
	public void copy(ContactPointOption.TollFree org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return ContactPointOption.TollFree.class.getAnnotation(SampleValue.class).value();
	}
