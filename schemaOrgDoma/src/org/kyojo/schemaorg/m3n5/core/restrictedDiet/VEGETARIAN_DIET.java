...
public class VEGETARIAN_DIET implements RestrictedDiet.VegetarianDiet {
	...
	public VEGETARIAN_DIET() {
	}

	public VEGETARIAN_DIET(Long seq) {
		setSeq(seq);
	}

	public VEGETARIAN_DIET(String string) {
	...
	public VEGETARIAN_DIET(AdditionalType additionalType) {
	...
	public VEGETARIAN_DIET(AlternateName alternateName) {
	...
	public VEGETARIAN_DIET(Description description) {
	...
	public VEGETARIAN_DIET(DisambiguatingDescription disambiguatingDescription) {
	...
	public VEGETARIAN_DIET(Identifier identifier) {
	...
	public VEGETARIAN_DIET(Image image) {
		setImage(image);
	}
	...
	public VEGETARIAN_DIET(MainEntityOfPage mainEntityOfPage) {
	...
	public VEGETARIAN_DIET(Name name) {
		setName(name);
	}
	...
	public VEGETARIAN_DIET(NameFuzzy nameFuzzy) {
	...
	public VEGETARIAN_DIET(NameRuby nameRuby) {
	...
	public VEGETARIAN_DIET(PotentialAction potentialAction) {
	...
	public VEGETARIAN_DIET(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public VEGETARIAN_DIET(SubjectOf subjectOf) {
	...
	public VEGETARIAN_DIET(SupersededBy supersededBy) {
	...
	public VEGETARIAN_DIET(Url url) {
		setUrl(url);
	}
	...
	public void copy(RestrictedDiet.VegetarianDiet org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return RestrictedDiet.VegetarianDiet.class.getAnnotation(SampleValue.class).value();
	}
