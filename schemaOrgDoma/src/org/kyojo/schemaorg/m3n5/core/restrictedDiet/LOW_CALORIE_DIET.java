...
public class LOW_CALORIE_DIET implements RestrictedDiet.LowCalorieDiet {
	...
	public LOW_CALORIE_DIET() {
	}

	public LOW_CALORIE_DIET(Long seq) {
		setSeq(seq);
	}

	public LOW_CALORIE_DIET(String string) {
	...
	public LOW_CALORIE_DIET(AdditionalType additionalType) {
	...
	public LOW_CALORIE_DIET(AlternateName alternateName) {
	...
	public LOW_CALORIE_DIET(Description description) {
	...
	public LOW_CALORIE_DIET(DisambiguatingDescription disambiguatingDescription) {
	...
	public LOW_CALORIE_DIET(Identifier identifier) {
	...
	public LOW_CALORIE_DIET(Image image) {
		setImage(image);
	}
	...
	public LOW_CALORIE_DIET(MainEntityOfPage mainEntityOfPage) {
	...
	public LOW_CALORIE_DIET(Name name) {
		setName(name);
	}
	...
	public LOW_CALORIE_DIET(NameFuzzy nameFuzzy) {
	...
	public LOW_CALORIE_DIET(NameRuby nameRuby) {
	...
	public LOW_CALORIE_DIET(PotentialAction potentialAction) {
	...
	public LOW_CALORIE_DIET(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public LOW_CALORIE_DIET(SubjectOf subjectOf) {
	...
	public LOW_CALORIE_DIET(SupersededBy supersededBy) {
	...
	public LOW_CALORIE_DIET(Url url) {
		setUrl(url);
	}
	...
	public void copy(RestrictedDiet.LowCalorieDiet org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return RestrictedDiet.LowCalorieDiet.class.getAnnotation(SampleValue.class).value();
	}
