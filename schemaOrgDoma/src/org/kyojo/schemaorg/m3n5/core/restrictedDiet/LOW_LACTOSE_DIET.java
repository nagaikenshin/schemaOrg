...
public class LOW_LACTOSE_DIET implements RestrictedDiet.LowLactoseDiet {
	...
	public LOW_LACTOSE_DIET() {
	}

	public LOW_LACTOSE_DIET(Long seq) {
		setSeq(seq);
	}

	public LOW_LACTOSE_DIET(String string) {
	...
	public LOW_LACTOSE_DIET(AdditionalType additionalType) {
	...
	public LOW_LACTOSE_DIET(AlternateName alternateName) {
	...
	public LOW_LACTOSE_DIET(Description description) {
	...
	public LOW_LACTOSE_DIET(DisambiguatingDescription disambiguatingDescription) {
	...
	public LOW_LACTOSE_DIET(Identifier identifier) {
	...
	public LOW_LACTOSE_DIET(Image image) {
		setImage(image);
	}
	...
	public LOW_LACTOSE_DIET(MainEntityOfPage mainEntityOfPage) {
	...
	public LOW_LACTOSE_DIET(Name name) {
		setName(name);
	}
	...
	public LOW_LACTOSE_DIET(NameFuzzy nameFuzzy) {
	...
	public LOW_LACTOSE_DIET(NameRuby nameRuby) {
	...
	public LOW_LACTOSE_DIET(PotentialAction potentialAction) {
	...
	public LOW_LACTOSE_DIET(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public LOW_LACTOSE_DIET(SubjectOf subjectOf) {
	...
	public LOW_LACTOSE_DIET(SupersededBy supersededBy) {
	...
	public LOW_LACTOSE_DIET(Url url) {
		setUrl(url);
	}
	...
	public void copy(RestrictedDiet.LowLactoseDiet org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return RestrictedDiet.LowLactoseDiet.class.getAnnotation(SampleValue.class).value();
	}
