...
public class LOW_FAT_DIET implements RestrictedDiet.LowFatDiet {
	...
	public LOW_FAT_DIET(Long seq) {
		setSeq(seq);
	}

	public LOW_FAT_DIET(String string) {
	...
	public LOW_FAT_DIET(AdditionalType additionalType) {
	...
	public LOW_FAT_DIET(AlternateName alternateName) {
	...
	public LOW_FAT_DIET(Description description) {
	...
	public LOW_FAT_DIET(DisambiguatingDescription disambiguatingDescription) {
	...
	public LOW_FAT_DIET(Identifier identifier) {
	...
	public LOW_FAT_DIET(Image image) {
		setImage(image);
	}
	...
	public LOW_FAT_DIET(MainEntityOfPage mainEntityOfPage) {
	...
	public LOW_FAT_DIET(NameFuzzy nameFuzzy) {
	...
	public LOW_FAT_DIET(NameRuby nameRuby) {
	...
	public LOW_FAT_DIET(PotentialAction potentialAction) {
	...
	public LOW_FAT_DIET(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public LOW_FAT_DIET(SubjectOf subjectOf) {
	...
	public LOW_FAT_DIET(SupersededBy supersededBy) {
	...
	public void copy(RestrictedDiet.LowFatDiet org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return RestrictedDiet.LowFatDiet.class.getAnnotation(SampleValue.class).value();
	}
