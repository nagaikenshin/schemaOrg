...
public class ATLAS implements Clazz.Atlas {
	...
	public ATLAS(Long seq) {
		setSeq(seq);
	}

	public ATLAS(String string) {
	...
	public ATLAS(AccessMode accessMode) {
	...
	public ATLAS(AccessModeSufficient accessModeSufficient) {
	...
	public ATLAS(AccessibilityAPI accessibilityAPI) {
	...
	public ATLAS(AccessibilityControl accessibilityControl) {
	...
	public ATLAS(AccessibilityFeature accessibilityFeature) {
	...
	public ATLAS(AccessibilityHazard accessibilityHazard) {
	...
	public ATLAS(AccessibilitySummary accessibilitySummary) {
	...
	public ATLAS(AccountablePerson accountablePerson) {
	...
	public ATLAS(AdditionalType additionalType) {
	...
	public ATLAS(AggregateRating aggregateRating) {
	...
	public ATLAS(AlternateName alternateName) {
	...
	public ATLAS(AlternativeHeadline alternativeHeadline) {
	...
	public ATLAS(AssociatedMedia associatedMedia) {
	...
	public ATLAS(Audience audience) {
	...
	public ATLAS(Character character) {
	...
	public ATLAS(Citation citation) {
	...
	public ATLAS(CommentCount commentCount) {
	...
	public ATLAS(ContentLocation contentLocation) {
	...
	public ATLAS(ContentRating contentRating) {
	...
	public ATLAS(ContentReferenceTime contentReferenceTime) {
	...
	public ATLAS(Contributor contributor) {
	...
	public ATLAS(CopyrightHolder copyrightHolder) {
	...
	public ATLAS(CopyrightYear copyrightYear) {
	...
	public ATLAS(Correction correction) {
	...
	public ATLAS(DateCreated dateCreated) {
	...
	public ATLAS(DateModified dateModified) {
	...
	public ATLAS(DatePublished datePublished) {
	...
	public ATLAS(Description description) {
	...
	public ATLAS(DisambiguatingDescription disambiguatingDescription) {
	...
	public ATLAS(DiscussionUrl discussionUrl) {
	...
	public ATLAS(EducationalAlignment educationalAlignment) {
	...
	public ATLAS(EducationalUse educationalUse) {
	...
	public ATLAS(Encoding encoding) {
	...
	public ATLAS(EncodingFormat encodingFormat) {
	...
	public ATLAS(ExampleOfWork exampleOfWork) {
	...
	public ATLAS(Headline headline) {
	...
	public ATLAS(Identifier identifier) {
	...
	public ATLAS(InLanguage inLanguage) {
	...
	public ATLAS(InteractionStatistic interactionStatistic) {
	...
	public ATLAS(InteractivityType interactivityType) {
	...
	public ATLAS(IsAccessibleForFree isAccessibleForFree) {
	...
	public ATLAS(IsBasedOn isBasedOn) {
	...
	public ATLAS(IsFamilyFriendly isFamilyFriendly) {
	...
	public ATLAS(IsPartOf isPartOf) {
	...
	public ATLAS(Keywords keywords) {
	...
	public ATLAS(LearningResourceType learningResourceType) {
	...
	public ATLAS(LocationCreated locationCreated) {
	...
	public ATLAS(MainEntity mainEntity) {
	...
	public ATLAS(MainEntityOfPage mainEntityOfPage) {
	...
	public ATLAS(MaterialExtent materialExtent) {
	...
	public ATLAS(Mentions mentions) {
	...
	public ATLAS(NameFuzzy nameFuzzy) {
	...
	public ATLAS(NameRuby nameRuby) {
	...
	public ATLAS(Position position) {
	...
	public ATLAS(PotentialAction potentialAction) {
	...
	public ATLAS(Producer producer) {
	...
	public ATLAS(Provider provider) {
	...
	public ATLAS(Publication publication) {
	...
	public ATLAS(Publisher publisher) {
	...
	public ATLAS(PublisherImprint publisherImprint) {
	...
	public ATLAS(PublishingPrinciples publishingPrinciples) {
	...
	public ATLAS(RecordedAt recordedAt) {
	...
	public ATLAS(ReleasedEvent releasedEvent) {
	...
	public ATLAS(SchemaVersion schemaVersion) {
	...
	public ATLAS(SdDatePublished sdDatePublished) {
	...
	public ATLAS(SdLicense sdLicense) {
	...
	public ATLAS(SdPublisher sdPublisher) {
	...
	public ATLAS(SourceOrganization sourceOrganization) {
	...
	public ATLAS(SpatialCoverage spatialCoverage) {
	...
	public ATLAS(SubjectOf subjectOf) {
	...
	public ATLAS(Temporal temporal) {
	...
	public ATLAS(TemporalCoverage temporalCoverage) {
	...
	public ATLAS(ThumbnailUrl thumbnailUrl) {
	...
	public ATLAS(TimeRequired timeRequired) {
	...
	public ATLAS(TranslationOfWork translationOfWork) {
	...
	public ATLAS(Translator translator) {
	...
	public ATLAS(TypicalAgeRange typicalAgeRange) {
	...
	public ATLAS(WorkExample workExample) {
	...
	public ATLAS(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Atlas org) {
		setSeq(org.getSeq());
