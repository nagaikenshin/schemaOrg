...
public class CHAPTER implements Clazz.Chapter {
	...
	public CHAPTER(AccessMode accessMode) {
	...
	public CHAPTER(AccessModeSufficient accessModeSufficient) {
	...
	public CHAPTER(AccessibilityAPI accessibilityAPI) {
	...
	public CHAPTER(AccessibilityControl accessibilityControl) {
	...
	public CHAPTER(AccessibilityFeature accessibilityFeature) {
	...
	public CHAPTER(AccessibilityHazard accessibilityHazard) {
	...
	public CHAPTER(AccessibilitySummary accessibilitySummary) {
	...
	public CHAPTER(AccountablePerson accountablePerson) {
	...
	public CHAPTER(AdditionalType additionalType) {
	...
	public CHAPTER(AggregateRating aggregateRating) {
	...
	public CHAPTER(AlternateName alternateName) {
	...
	public CHAPTER(AlternativeHeadline alternativeHeadline) {
	...
	public CHAPTER(AssociatedMedia associatedMedia) {
	...
	public CHAPTER(Audience audience) {
	...
	public CHAPTER(Citation citation) {
	...
	public CHAPTER(Comment comment) {
		setComment(comment);
	}
	...
	public CHAPTER(CommentCount commentCount) {
	...
	public CHAPTER(ContentLocation contentLocation) {
	...
	public CHAPTER(ContentRating contentRating) {
	...
	public CHAPTER(ContentReferenceTime contentReferenceTime) {
	...
	public CHAPTER(Contributor contributor) {
	...
	public CHAPTER(CopyrightHolder copyrightHolder) {
	...
	public CHAPTER(CopyrightYear copyrightYear) {
	...
	public CHAPTER(Correction correction) {
	...
	public CHAPTER(Creator creator) {
		setCreator(creator);
	}
	...
	public CHAPTER(DateCreated dateCreated) {
	...
	public CHAPTER(DateModified dateModified) {
	...
	public CHAPTER(DatePublished datePublished) {
	...
	public CHAPTER(Description description) {
	...
	public CHAPTER(DisambiguatingDescription disambiguatingDescription) {
	...
	public CHAPTER(DiscussionUrl discussionUrl) {
	...
	public CHAPTER(EducationalAlignment educationalAlignment) {
	...
	public CHAPTER(EducationalUse educationalUse) {
	...
	public CHAPTER(Encoding encoding) {
	...
	public CHAPTER(EncodingFormat encodingFormat) {
	...
	public CHAPTER(ExampleOfWork exampleOfWork) {
	...
	public CHAPTER(Expires expires) {
		setExpires(expires);
	}
	...
	public CHAPTER(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public CHAPTER(Headline headline) {
	...
	public CHAPTER(Identifier identifier) {
	...
	public CHAPTER(InLanguage inLanguage) {
	...
	public CHAPTER(InteractionStatistic interactionStatistic) {
	...
	public CHAPTER(InteractivityType interactivityType) {
	...
	public CHAPTER(IsAccessibleForFree isAccessibleForFree) {
	...
	public CHAPTER(IsBasedOn isBasedOn) {
	...
	public CHAPTER(IsFamilyFriendly isFamilyFriendly) {
	...
	public CHAPTER(IsPartOf isPartOf) {
	...
	public CHAPTER(Keywords keywords) {
	...
	public CHAPTER(LearningResourceType learningResourceType) {
	...
	public CHAPTER(License license) {
		setLicense(license);
	}
	...
	public CHAPTER(LocationCreated locationCreated) {
	...
	public CHAPTER(MainEntity mainEntity) {
	...
	public CHAPTER(MainEntityOfPage mainEntityOfPage) {
	...
	public CHAPTER(Material material) {
	...
	public CHAPTER(MaterialExtent materialExtent) {
	...
	public CHAPTER(Mentions mentions) {
	...
	public CHAPTER(NameFuzzy nameFuzzy) {
	...
	public CHAPTER(NameRuby nameRuby) {
	...
	public CHAPTER(PageEnd pageEnd) {
		setPageEnd(pageEnd);
	}
	...
	public CHAPTER(PageStart pageStart) {
	...
	public CHAPTER(Pagination pagination) {
	...
	public CHAPTER(Position position) {
	...
	public CHAPTER(PotentialAction potentialAction) {
	...
	public CHAPTER(Producer producer) {
	...
	public CHAPTER(Provider provider) {
	...
	public CHAPTER(Publication publication) {
	...
	public CHAPTER(Publisher publisher) {
	...
	public CHAPTER(PublisherImprint publisherImprint) {
	...
	public CHAPTER(PublishingPrinciples publishingPrinciples) {
	...
	public CHAPTER(RecordedAt recordedAt) {
	...
	public CHAPTER(ReleasedEvent releasedEvent) {
	...
	public CHAPTER(SchemaVersion schemaVersion) {
	...
	public CHAPTER(SdDatePublished sdDatePublished) {
	...
	public CHAPTER(SdLicense sdLicense) {
	...
	public CHAPTER(SdPublisher sdPublisher) {
	...
	public CHAPTER(SourceOrganization sourceOrganization) {
	...
	public CHAPTER(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public CHAPTER(SpatialCoverage spatialCoverage) {
	...
	public CHAPTER(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public CHAPTER(SubjectOf subjectOf) {
	...
	public CHAPTER(Temporal temporal) {
	...
	public CHAPTER(TemporalCoverage temporalCoverage) {
	...
	public CHAPTER(ThumbnailUrl thumbnailUrl) {
	...
	public CHAPTER(TimeRequired timeRequired) {
	...
	public CHAPTER(TranslationOfWork translationOfWork) {
	...
	public CHAPTER(Translator translator) {
	...
	public CHAPTER(TypicalAgeRange typicalAgeRange) {
	...
	public CHAPTER(Version version) {
		setVersion(version);
	}
	...
	public CHAPTER(WorkExample workExample) {
	...
	public CHAPTER(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Chapter org) {
		setSeq(org.getSeq());
