...
public class COVER_ART implements Clazz.CoverArt {
	...
	public COVER_ART(Long seq) {
		setSeq(seq);
	}

	public COVER_ART(String string) {
	...
	public COVER_ART(AccessMode accessMode) {
	...
	public COVER_ART(AccessModeSufficient accessModeSufficient) {
	...
	public COVER_ART(AccessibilityAPI accessibilityAPI) {
	...
	public COVER_ART(AccessibilityControl accessibilityControl) {
	...
	public COVER_ART(AccessibilityFeature accessibilityFeature) {
	...
	public COVER_ART(AccessibilityHazard accessibilityHazard) {
	...
	public COVER_ART(AccessibilitySummary accessibilitySummary) {
	...
	public COVER_ART(AccountablePerson accountablePerson) {
	...
	public COVER_ART(AdditionalType additionalType) {
	...
	public COVER_ART(AggregateRating aggregateRating) {
	...
	public COVER_ART(AlternateName alternateName) {
	...
	public COVER_ART(AlternativeHeadline alternativeHeadline) {
	...
	public COVER_ART(ArtEdition artEdition) {
	...
	public COVER_ART(ArtMedium artMedium) {
	...
	public COVER_ART(Artform artform) {
		setArtform(artform);
	}
	...
	public COVER_ART(Artist artist) {
		setArtist(artist);
	}
	...
	public COVER_ART(ArtworkSurface artworkSurface) {
	...
	public COVER_ART(AssociatedMedia associatedMedia) {
	...
	public COVER_ART(Audience audience) {
	...
	public COVER_ART(Author author) {
		setAuthor(author);
	}
	...
	public COVER_ART(Character character) {
	...
	public COVER_ART(Citation citation) {
	...
	public COVER_ART(Colorist colorist) {
	...
	public COVER_ART(Comment comment) {
		setComment(comment);
	}
	...
	public COVER_ART(CommentCount commentCount) {
	...
	public COVER_ART(ContentLocation contentLocation) {
	...
	public COVER_ART(ContentRating contentRating) {
	...
	public COVER_ART(ContentReferenceTime contentReferenceTime) {
	...
	public COVER_ART(Contributor contributor) {
	...
	public COVER_ART(CopyrightHolder copyrightHolder) {
	...
	public COVER_ART(CopyrightYear copyrightYear) {
	...
	public COVER_ART(Correction correction) {
	...
	public COVER_ART(Creator creator) {
		setCreator(creator);
	}
	...
	public COVER_ART(DateCreated dateCreated) {
	...
	public COVER_ART(DateModified dateModified) {
	...
	public COVER_ART(DatePublished datePublished) {
	...
	public COVER_ART(Description description) {
	...
	public COVER_ART(DisambiguatingDescription disambiguatingDescription) {
	...
	public COVER_ART(DiscussionUrl discussionUrl) {
	...
	public COVER_ART(Editor editor) {
		setEditor(editor);
	}
	...
	public COVER_ART(EducationalAlignment educationalAlignment) {
	...
	public COVER_ART(EducationalUse educationalUse) {
	...
	public COVER_ART(Encoding encoding) {
	...
	public COVER_ART(EncodingFormat encodingFormat) {
	...
	public COVER_ART(ExampleOfWork exampleOfWork) {
	...
	public COVER_ART(Expires expires) {
		setExpires(expires);
	}
	...
	public COVER_ART(Funder funder) {
		setFunder(funder);
	}
	...
	public COVER_ART(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public COVER_ART(Headline headline) {
	...
	public COVER_ART(Height height) {
		setHeight(height);
	}
	...
	public COVER_ART(Identifier identifier) {
	...
	public COVER_ART(InLanguage inLanguage) {
	...
	public COVER_ART(InteractionStatistic interactionStatistic) {
	...
	public COVER_ART(InteractivityType interactivityType) {
	...
	public COVER_ART(IsAccessibleForFree isAccessibleForFree) {
	...
	public COVER_ART(IsBasedOn isBasedOn) {
	...
	public COVER_ART(IsFamilyFriendly isFamilyFriendly) {
	...
	public COVER_ART(IsPartOf isPartOf) {
	...
	public COVER_ART(Keywords keywords) {
	...
	public COVER_ART(LearningResourceType learningResourceType) {
	...
	public COVER_ART(Letterer letterer) {
	...
	public COVER_ART(License license) {
		setLicense(license);
	}
	...
	public COVER_ART(LocationCreated locationCreated) {
	...
	public COVER_ART(MainEntity mainEntity) {
	...
	public COVER_ART(MainEntityOfPage mainEntityOfPage) {
	...
	public COVER_ART(Material material) {
	...
	public COVER_ART(MaterialExtent materialExtent) {
	...
	public COVER_ART(Mentions mentions) {
	...
	public COVER_ART(NameFuzzy nameFuzzy) {
	...
	public COVER_ART(NameRuby nameRuby) {
	...
	public COVER_ART(Offers offers) {
		setOffers(offers);
	}
	...
	public COVER_ART(Penciler penciler) {
	...
	public COVER_ART(Position position) {
	...
	public COVER_ART(PotentialAction potentialAction) {
	...
	public COVER_ART(Producer producer) {
	...
	public COVER_ART(Provider provider) {
	...
	public COVER_ART(Publication publication) {
	...
	public COVER_ART(Publisher publisher) {
	...
	public COVER_ART(PublisherImprint publisherImprint) {
	...
	public COVER_ART(PublishingPrinciples publishingPrinciples) {
	...
	public COVER_ART(RecordedAt recordedAt) {
	...
	public COVER_ART(ReleasedEvent releasedEvent) {
	...
	public COVER_ART(Review review) {
		setReview(review);
	}
	...
	public COVER_ART(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public COVER_ART(SchemaVersion schemaVersion) {
	...
	public COVER_ART(SdDatePublished sdDatePublished) {
	...
	public COVER_ART(SdLicense sdLicense) {
	...
	public COVER_ART(SdPublisher sdPublisher) {
	...
	public COVER_ART(SourceOrganization sourceOrganization) {
	...
	public COVER_ART(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public COVER_ART(SpatialCoverage spatialCoverage) {
	...
	public COVER_ART(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public COVER_ART(SubjectOf subjectOf) {
	...
	public COVER_ART(Temporal temporal) {
	...
	public COVER_ART(TemporalCoverage temporalCoverage) {
	...
	public COVER_ART(ThumbnailUrl thumbnailUrl) {
	...
	public COVER_ART(TimeRequired timeRequired) {
	...
	public COVER_ART(TranslationOfWork translationOfWork) {
	...
	public COVER_ART(Translator translator) {
	...
	public COVER_ART(TypicalAgeRange typicalAgeRange) {
	...
	public COVER_ART(Version version) {
		setVersion(version);
	}
	...
	public COVER_ART(WorkExample workExample) {
	...
	public COVER_ART(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.CoverArt org) {
		setSeq(org.getSeq());
