...
import org.kyojo.schemaorg.m3n5.core.Container.ArtworkSurface;
...
public class COMIC_COVER_ART implements Clazz.ComicCoverArt {
	...
	public COMIC_COVER_ART() {
	}

	public COMIC_COVER_ART(Long seq) {
		setSeq(seq);
	}

	public COMIC_COVER_ART(String string) {
	...
	public COMIC_COVER_ART(About about) {
		setAbout(about);
	}
	...
	public COMIC_COVER_ART(AccessMode accessMode) {
	...
	public COMIC_COVER_ART(AccessModeSufficient accessModeSufficient) {
	...
	public COMIC_COVER_ART(AccessibilityAPI accessibilityAPI) {
	...
	public COMIC_COVER_ART(AccessibilityControl accessibilityControl) {
	...
	public COMIC_COVER_ART(AccessibilityFeature accessibilityFeature) {
	...
	public COMIC_COVER_ART(AccessibilityHazard accessibilityHazard) {
	...
	public COMIC_COVER_ART(AccessibilitySummary accessibilitySummary) {
	...
	public COMIC_COVER_ART(AccountablePerson accountablePerson) {
	...
	public COMIC_COVER_ART(AdditionalType additionalType) {
	...
	public COMIC_COVER_ART(AggregateRating aggregateRating) {
	...
	public COMIC_COVER_ART(AlternateName alternateName) {
	...
	public COMIC_COVER_ART(AlternativeHeadline alternativeHeadline) {
	...
	public COMIC_COVER_ART(ArtEdition artEdition) {
	...
	public COMIC_COVER_ART(ArtMedium artMedium) {
	...
	public COMIC_COVER_ART(Artform artform) {
		setArtform(artform);
	}
	...
	public COMIC_COVER_ART(Artist artist) {
		setArtist(artist);
	}
	...
	public COMIC_COVER_ART(ArtworkSurface artworkSurface) {
	...
	public COMIC_COVER_ART(AssociatedMedia associatedMedia) {
	...
	public COMIC_COVER_ART(Audience audience) {
	...
	public COMIC_COVER_ART(Audio audio) {
		setAudio(audio);
	}
	...
	public COMIC_COVER_ART(Author author) {
		setAuthor(author);
	}
	...
	public COMIC_COVER_ART(Award award) {
		setAward(award);
	}
	...
	public COMIC_COVER_ART(Character character) {
	...
	public COMIC_COVER_ART(Citation citation) {
	...
	public COMIC_COVER_ART(Colorist colorist) {
	...
	public COMIC_COVER_ART(Comment comment) {
		setComment(comment);
	}
	...
	public COMIC_COVER_ART(CommentCount commentCount) {
	...
	public COMIC_COVER_ART(ContentLocation contentLocation) {
	...
	public COMIC_COVER_ART(ContentRating contentRating) {
	...
	public COMIC_COVER_ART(ContentReferenceTime contentReferenceTime) {
	...
	public COMIC_COVER_ART(Contributor contributor) {
	...
	public COMIC_COVER_ART(CopyrightHolder copyrightHolder) {
	...
	public COMIC_COVER_ART(CopyrightYear copyrightYear) {
	...
	public COMIC_COVER_ART(Correction correction) {
	...
	public COMIC_COVER_ART(Creator creator) {
		setCreator(creator);
	}
	...
	public COMIC_COVER_ART(DateCreated dateCreated) {
	...
	public COMIC_COVER_ART(DateModified dateModified) {
	...
	public COMIC_COVER_ART(DatePublished datePublished) {
	...
	public COMIC_COVER_ART(Depth depth) {
		setDepth(depth);
	}
	...
	public COMIC_COVER_ART(Description description) {
	...
	public COMIC_COVER_ART(DisambiguatingDescription disambiguatingDescription) {
	...
	public COMIC_COVER_ART(DiscussionUrl discussionUrl) {
	...
	public COMIC_COVER_ART(Editor editor) {
		setEditor(editor);
	}
	...
	public COMIC_COVER_ART(EducationalAlignment educationalAlignment) {
	...
	public COMIC_COVER_ART(EducationalUse educationalUse) {
	...
	public COMIC_COVER_ART(Encoding encoding) {
	...
	public COMIC_COVER_ART(EncodingFormat encodingFormat) {
	...
	public COMIC_COVER_ART(ExampleOfWork exampleOfWork) {
	...
	public COMIC_COVER_ART(Expires expires) {
		setExpires(expires);
	}
	...
	public COMIC_COVER_ART(Funder funder) {
		setFunder(funder);
	}
	...
	public COMIC_COVER_ART(Genre genre) {
		setGenre(genre);
	}
	...
	public COMIC_COVER_ART(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public COMIC_COVER_ART(Headline headline) {
	...
	public COMIC_COVER_ART(Height height) {
		setHeight(height);
	}
	...
	public COMIC_COVER_ART(Identifier identifier) {
	...
	public COMIC_COVER_ART(Image image) {
		setImage(image);
	}
	...
	public COMIC_COVER_ART(InLanguage inLanguage) {
	...
	public COMIC_COVER_ART(Inker inker) {
		setInker(inker);
	}
	...
	public COMIC_COVER_ART(InteractionStatistic interactionStatistic) {
	...
	public COMIC_COVER_ART(InteractivityType interactivityType) {
	...
	public COMIC_COVER_ART(IsAccessibleForFree isAccessibleForFree) {
	...
	public COMIC_COVER_ART(IsBasedOn isBasedOn) {
	...
	public COMIC_COVER_ART(IsFamilyFriendly isFamilyFriendly) {
	...
	public COMIC_COVER_ART(IsPartOf isPartOf) {
	...
	public COMIC_COVER_ART(Keywords keywords) {
	...
	public COMIC_COVER_ART(LearningResourceType learningResourceType) {
	...
	public COMIC_COVER_ART(Letterer letterer) {
	...
	public COMIC_COVER_ART(License license) {
		setLicense(license);
	}
	...
	public COMIC_COVER_ART(LocationCreated locationCreated) {
	...
	public COMIC_COVER_ART(MainEntity mainEntity) {
	...
	public COMIC_COVER_ART(MainEntityOfPage mainEntityOfPage) {
	...
	public COMIC_COVER_ART(Material material) {
	...
	public COMIC_COVER_ART(MaterialExtent materialExtent) {
	...
	public COMIC_COVER_ART(Mentions mentions) {
	...
	public COMIC_COVER_ART(Name name) {
		setName(name);
	}
	...
	public COMIC_COVER_ART(NameFuzzy nameFuzzy) {
	...
	public COMIC_COVER_ART(NameRuby nameRuby) {
	...
	public COMIC_COVER_ART(Offers offers) {
		setOffers(offers);
	}
	...
	public COMIC_COVER_ART(Penciler penciler) {
	...
	public COMIC_COVER_ART(Position position) {
	...
	public COMIC_COVER_ART(PotentialAction potentialAction) {
	...
	public COMIC_COVER_ART(Producer producer) {
	...
	public COMIC_COVER_ART(Provider provider) {
	...
	public COMIC_COVER_ART(Publication publication) {
	...
	public COMIC_COVER_ART(Publisher publisher) {
	...
	public COMIC_COVER_ART(PublisherImprint publisherImprint) {
	...
	public COMIC_COVER_ART(PublishingPrinciples publishingPrinciples) {
	...
	public COMIC_COVER_ART(RecordedAt recordedAt) {
	...
	public COMIC_COVER_ART(ReleasedEvent releasedEvent) {
	...
	public COMIC_COVER_ART(Review review) {
		setReview(review);
	}
	...
	public COMIC_COVER_ART(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public COMIC_COVER_ART(SchemaVersion schemaVersion) {
	...
	public COMIC_COVER_ART(SdDatePublished sdDatePublished) {
	...
	public COMIC_COVER_ART(SdLicense sdLicense) {
	...
	public COMIC_COVER_ART(SdPublisher sdPublisher) {
	...
	public COMIC_COVER_ART(SourceOrganization sourceOrganization) {
	...
	public COMIC_COVER_ART(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public COMIC_COVER_ART(SpatialCoverage spatialCoverage) {
	...
	public COMIC_COVER_ART(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public COMIC_COVER_ART(SubjectOf subjectOf) {
	...
	public COMIC_COVER_ART(Temporal temporal) {
	...
	public COMIC_COVER_ART(TemporalCoverage temporalCoverage) {
	...
	public COMIC_COVER_ART(Text text) {
		setText(text);
	}
	...
	public COMIC_COVER_ART(ThumbnailUrl thumbnailUrl) {
	...
	public COMIC_COVER_ART(TimeRequired timeRequired) {
	...
	public COMIC_COVER_ART(TranslationOfWork translationOfWork) {
	...
	public COMIC_COVER_ART(Translator translator) {
	...
	public COMIC_COVER_ART(TypicalAgeRange typicalAgeRange) {
	...
	public COMIC_COVER_ART(Url url) {
		setUrl(url);
	}
	...
	public COMIC_COVER_ART(Version version) {
		setVersion(version);
	}
	...
	public COMIC_COVER_ART(Video video) {
		setVideo(video);
	}
	...
	public COMIC_COVER_ART(Width width) {
		setWidth(width);
	}
	...
	public COMIC_COVER_ART(WorkExample workExample) {
	...
	public COMIC_COVER_ART(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.ComicCoverArt org) {
		setSeq(org.getSeq());
