...
public class COLLECTION implements Clazz.Collection {
	...
	public CollectionSize collectionSize;
	...
	public COLLECTION(AccessMode accessMode) {
	...
	public COLLECTION(AccessModeSufficient accessModeSufficient) {
	...
	public COLLECTION(AccessibilityAPI accessibilityAPI) {
	...
	public COLLECTION(AccessibilityControl accessibilityControl) {
	...
	public COLLECTION(AccessibilityFeature accessibilityFeature) {
	...
	public COLLECTION(AccessibilityHazard accessibilityHazard) {
	...
	public COLLECTION(AccessibilitySummary accessibilitySummary) {
	...
	public COLLECTION(AccountablePerson accountablePerson) {
	...
	public COLLECTION(AdditionalType additionalType) {
	...
	public COLLECTION(AggregateRating aggregateRating) {
	...
	public COLLECTION(AlternateName alternateName) {
	...
	public COLLECTION(AlternativeHeadline alternativeHeadline) {
	...
	public COLLECTION(AssociatedMedia associatedMedia) {
	...
	public COLLECTION(Audience audience) {
	...
	public COLLECTION(Citation citation) {
	...
	public COLLECTION(CollectionSize collectionSize) {
	...
	@Override
	public void setCollectionSize(CollectionSize collectionSize) {
	...
	public COLLECTION(CommentCount commentCount) {
	...
	public COLLECTION(ContentLocation contentLocation) {
	...
	public COLLECTION(ContentRating contentRating) {
	...
	public COLLECTION(ContentReferenceTime contentReferenceTime) {
	...
	public COLLECTION(CopyrightHolder copyrightHolder) {
	...
	public COLLECTION(CopyrightYear copyrightYear) {
	...
	public COLLECTION(Correction correction) {
	...
	public COLLECTION(DateCreated dateCreated) {
	...
	public COLLECTION(DateModified dateModified) {
	...
	public COLLECTION(DatePublished datePublished) {
	...
	public COLLECTION(DisambiguatingDescription disambiguatingDescription) {
	...
	public COLLECTION(DiscussionUrl discussionUrl) {
	...
	public COLLECTION(Editor editor) {
		setEditor(editor);
	}
	...
	public COLLECTION(EducationalAlignment educationalAlignment) {
	...
	public COLLECTION(EducationalUse educationalUse) {
	...
	public COLLECTION(Encoding encoding) {
	...
	public COLLECTION(EncodingFormat encodingFormat) {
	...
	public COLLECTION(ExampleOfWork exampleOfWork) {
	...
	public COLLECTION(Expires expires) {
		setExpires(expires);
	}
	...
	public COLLECTION(Funder funder) {
		setFunder(funder);
	}
	...
	public COLLECTION(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public COLLECTION(Headline headline) {
	...
	public COLLECTION(Identifier identifier) {
	...
	public COLLECTION(InLanguage inLanguage) {
	...
	public COLLECTION(InteractionStatistic interactionStatistic) {
	...
	public COLLECTION(InteractivityType interactivityType) {
	...
	public COLLECTION(IsAccessibleForFree isAccessibleForFree) {
	...
	public COLLECTION(IsBasedOn isBasedOn) {
	...
	public COLLECTION(IsFamilyFriendly isFamilyFriendly) {
	...
	public COLLECTION(IsPartOf isPartOf) {
	...
	public COLLECTION(LearningResourceType learningResourceType) {
	...
	public COLLECTION(License license) {
		setLicense(license);
	}
	...
	public COLLECTION(LocationCreated locationCreated) {
	...
	public COLLECTION(MainEntity mainEntity) {
	...
	public COLLECTION(MainEntityOfPage mainEntityOfPage) {
	...
	public COLLECTION(Material material) {
	...
	public COLLECTION(MaterialExtent materialExtent) {
	...
	public COLLECTION(Mentions mentions) {
	...
	public COLLECTION(NameFuzzy nameFuzzy) {
	...
	public COLLECTION(NameRuby nameRuby) {
	...
	public COLLECTION(Offers offers) {
		setOffers(offers);
	}
	...
	public COLLECTION(PotentialAction potentialAction) {
	...
	public COLLECTION(Producer producer) {
	...
	public COLLECTION(Provider provider) {
	...
	public COLLECTION(Publication publication) {
	...
	public COLLECTION(Publisher publisher) {
	...
	public COLLECTION(PublisherImprint publisherImprint) {
	...
	public COLLECTION(PublishingPrinciples publishingPrinciples) {
	...
	public COLLECTION(RecordedAt recordedAt) {
	...
	public COLLECTION(ReleasedEvent releasedEvent) {
	...
	public COLLECTION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public COLLECTION(SchemaVersion schemaVersion) {
	...
	public COLLECTION(SdDatePublished sdDatePublished) {
	...
	public COLLECTION(SdLicense sdLicense) {
	...
	public COLLECTION(SdPublisher sdPublisher) {
	...
	public COLLECTION(SourceOrganization sourceOrganization) {
	...
	public COLLECTION(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public COLLECTION(SpatialCoverage spatialCoverage) {
	...
	public COLLECTION(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public COLLECTION(SubjectOf subjectOf) {
	...
	public COLLECTION(Temporal temporal) {
	...
	public COLLECTION(TemporalCoverage temporalCoverage) {
	...
	public COLLECTION(ThumbnailUrl thumbnailUrl) {
	...
	public COLLECTION(TimeRequired timeRequired) {
	...
	public COLLECTION(TranslationOfWork translationOfWork) {
	...
	public COLLECTION(Translator translator) {
	...
	public COLLECTION(TypicalAgeRange typicalAgeRange) {
	...
	public COLLECTION(Version version) {
		setVersion(version);
	}
	...
	public COLLECTION(WorkExample workExample) {
	...
	public COLLECTION(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Collection org) {
		setSeq(org.getSeq());
		...
		setCollectionSize(org.getCollectionSize());
