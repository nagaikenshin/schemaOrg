...
public class PUBLISHED_BY implements Container.PublishedBy {
	...
	public PUBLISHED_BY(String string) {
	...
	public PUBLISHED_BY(AccountingService accountingService) {
	...
	public PUBLISHED_BY(AdultEntertainment adultEntertainment) {
	...
	public PUBLISHED_BY(Airline airline) {
	...
	public PUBLISHED_BY(AmusementPark amusementPark) {
	...
	public PUBLISHED_BY(AnimalShelter animalShelter) {
	...
	public PUBLISHED_BY(ArchiveOrganization archiveOrganization) {
	...
	public PUBLISHED_BY(ArtGallery artGallery) {
	...
	public PUBLISHED_BY(Attorney attorney) {
	...
	public PUBLISHED_BY(AutoBodyShop autoBodyShop) {
	...
	public PUBLISHED_BY(AutoDealer autoDealer) {
	...
	public PUBLISHED_BY(AutoPartsStore autoPartsStore) {
	...
	public PUBLISHED_BY(AutoRental autoRental) {
	...
	public PUBLISHED_BY(AutoRepair autoRepair) {
	...
	public PUBLISHED_BY(AutoWash autoWash) {
	...
	public PUBLISHED_BY(AutomatedTeller automatedTeller) {
	...
	public PUBLISHED_BY(AutomotiveBusiness automotiveBusiness) {
	...
	public PUBLISHED_BY(Bakery bakery) {
	...
	public PUBLISHED_BY(BankOrCreditUnion bankOrCreditUnion) {
	...
	public PUBLISHED_BY(BarOrPub barOrPub) {
	...
	public PUBLISHED_BY(BeautySalon beautySalon) {
	...
	public PUBLISHED_BY(BedAndBreakfast bedAndBreakfast) {
	...
	public PUBLISHED_BY(BikeStore bikeStore) {
	...
	public PUBLISHED_BY(BookStore bookStore) {
	...
	public PUBLISHED_BY(BowlingAlley bowlingAlley) {
	...
	public PUBLISHED_BY(Brewery brewery) {
	...
	public PUBLISHED_BY(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public PUBLISHED_BY(Campground campground) {
	...
	public PUBLISHED_BY(Casino casino) {
	...
	public PUBLISHED_BY(ChildCare childCare) {
	...
	public PUBLISHED_BY(ClothingStore clothingStore) {
	...
	public PUBLISHED_BY(CollegeOrUniversity collegeOrUniversity) {
	...
	public PUBLISHED_BY(ComedyClub comedyClub) {
	...
	public PUBLISHED_BY(CommunityHealth communityHealth) {
	...
	public PUBLISHED_BY(ComputerStore computerStore) {
	...
	public PUBLISHED_BY(Consortium consortium) {
	...
	public PUBLISHED_BY(ConvenienceStore convenienceStore) {
	...
	public PUBLISHED_BY(Corporation corporation) {
	...
	public PUBLISHED_BY(DanceGroup danceGroup) {
	...
	public PUBLISHED_BY(DaySpa daySpa) {
	...
	public PUBLISHED_BY(Dentist dentist) {
	...
	public PUBLISHED_BY(DepartmentStore departmentStore) {
	...
	public PUBLISHED_BY(Dermatology dermatology) {
	...
	public PUBLISHED_BY(DiagnosticLab diagnosticLab) {
	...
	public PUBLISHED_BY(DietNutrition dietNutrition) {
	...
	public PUBLISHED_BY(Distillery distillery) {
	...
	public PUBLISHED_BY(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public PUBLISHED_BY(EducationalOrganization educationalOrganization) {
	...
	public PUBLISHED_BY(Electrician electrician) {
	...
	public PUBLISHED_BY(ElectronicsStore electronicsStore) {
	...
	public PUBLISHED_BY(ElementarySchool elementarySchool) {
	...
	public PUBLISHED_BY(Emergency emergency) {
	...
	public PUBLISHED_BY(EmergencyService emergencyService) {
	...
	public PUBLISHED_BY(EmploymentAgency employmentAgency) {
	...
	public PUBLISHED_BY(EntertainmentBusiness entertainmentBusiness) {
	...
	public PUBLISHED_BY(ExerciseGym exerciseGym) {
	...
	public PUBLISHED_BY(FastFoodRestaurant fastFoodRestaurant) {
	...
	public PUBLISHED_BY(FinancialService financialService) {
	...
	public PUBLISHED_BY(FireStation fireStation) {
	...
	public PUBLISHED_BY(Florist florist) {
	...
	public PUBLISHED_BY(FoodEstablishment foodEstablishment) {
	...
	public PUBLISHED_BY(FundingAgency fundingAgency) {
	...
	public PUBLISHED_BY(FundingScheme fundingScheme) {
	...
	public PUBLISHED_BY(FurnitureStore furnitureStore) {
	...
	public PUBLISHED_BY(GardenStore gardenStore) {
	...
	public PUBLISHED_BY(GasStation gasStation) {
	...
	public PUBLISHED_BY(GeneralContractor generalContractor) {
	...
	public PUBLISHED_BY(Geriatric geriatric) {
	...
	public PUBLISHED_BY(GolfCourse golfCourse) {
	...
	public PUBLISHED_BY(GovernmentOffice governmentOffice) {
	...
	public PUBLISHED_BY(GovernmentOrganization governmentOrganization) {
	...
	public PUBLISHED_BY(GroceryStore groceryStore) {
	...
	public PUBLISHED_BY(Gynecologic gynecologic) {
	...
	public PUBLISHED_BY(HVACBusiness hvacBusiness) {
	...
	public PUBLISHED_BY(HairSalon hairSalon) {
	...
	public PUBLISHED_BY(HardwareStore hardwareStore) {
	...
	public PUBLISHED_BY(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public PUBLISHED_BY(HealthClub healthClub) {
	...
	public PUBLISHED_BY(HighSchool highSchool) {
	...
	public PUBLISHED_BY(HobbyShop hobbyShop) {
	...
	public PUBLISHED_BY(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public PUBLISHED_BY(HomeGoodsStore homeGoodsStore) {
	...
	public PUBLISHED_BY(Hospital hospital) {
	...
	public PUBLISHED_BY(Hostel hostel) {
	...
	public PUBLISHED_BY(Hotel hotel) {
	...
	public PUBLISHED_BY(HousePainter housePainter) {
	...
	public PUBLISHED_BY(IceCreamShop iceCreamShop) {
	...
	public PUBLISHED_BY(InsuranceAgency insuranceAgency) {
	...
	public PUBLISHED_BY(InternetCafe internetCafe) {
	...
	public PUBLISHED_BY(JewelryStore jewelryStore) {
	...
	public PUBLISHED_BY(LegalService legalService) {
	...
	public PUBLISHED_BY(Library library) {
	...
	public PUBLISHED_BY(LibrarySystem librarySystem) {
	...
	public PUBLISHED_BY(LiquorStore liquorStore) {
	...
	public PUBLISHED_BY(LocalBusiness localBusiness) {
	...
	public PUBLISHED_BY(Locksmith locksmith) {
	...
	public PUBLISHED_BY(LodgingBusiness lodgingBusiness) {
	...
	public PUBLISHED_BY(MedicalBusiness medicalBusiness) {
	...
	public PUBLISHED_BY(MedicalClinic medicalClinic) {
	...
	public PUBLISHED_BY(MedicalOrganization medicalOrganization) {
	...
	public PUBLISHED_BY(MensClothingStore mensClothingStore) {
	...
	public PUBLISHED_BY(MiddleSchool middleSchool) {
	...
	public PUBLISHED_BY(Midwifery midwifery) {
	...
	public PUBLISHED_BY(MobilePhoneStore mobilePhoneStore) {
	...
	public PUBLISHED_BY(Motel motel) {
	...
	public PUBLISHED_BY(MotorcycleDealer motorcycleDealer) {
	...
	public PUBLISHED_BY(MotorcycleRepair motorcycleRepair) {
	...
	public PUBLISHED_BY(MovieRentalStore movieRentalStore) {
	...
	public PUBLISHED_BY(MovieTheater movieTheater) {
	...
	public PUBLISHED_BY(MovingCompany movingCompany) {
	...
	public PUBLISHED_BY(MusicGroup musicGroup) {
	...
	public PUBLISHED_BY(MusicStore musicStore) {
	...
	public PUBLISHED_BY(NailSalon nailSalon) {
	...
	public PUBLISHED_BY(NewsMediaOrganization newsMediaOrganization) {
	...
	public PUBLISHED_BY(NightClub nightClub) {
	...
	public PUBLISHED_BY(Notary notary) {
	...
	public PUBLISHED_BY(Nursing nursing) {
	...
	public PUBLISHED_BY(Obstetric obstetric) {
	...
	public PUBLISHED_BY(OfficeEquipmentStore officeEquipmentStore) {
	...
	public PUBLISHED_BY(Oncologic oncologic) {
	...
	public PUBLISHED_BY(Optician optician) {
	...
	public PUBLISHED_BY(Optometric optometric) {
	...
	public PUBLISHED_BY(Organization organization) {
		organizationList = new ArrayList<Organization>();
	...
	public PUBLISHED_BY(Otolaryngologic otolaryngologic) {
	...
	public PUBLISHED_BY(OutletStore outletStore) {
	...
	public PUBLISHED_BY(Patient patient) {
	...
	public PUBLISHED_BY(PawnShop pawnShop) {
	...
	public PUBLISHED_BY(Pediatric pediatric) {
	...
	public PUBLISHED_BY(PerformingGroup performingGroup) {
	...
	public PUBLISHED_BY(Person person) {
	...
	public PUBLISHED_BY(PetStore petStore) {
	...
	public PUBLISHED_BY(Pharmacy pharmacy) {
	...
	public PUBLISHED_BY(Physician physician) {
	...
	public PUBLISHED_BY(Physiotherapy physiotherapy) {
	...
	public PUBLISHED_BY(PlasticSurgery plasticSurgery) {
	...
	public PUBLISHED_BY(Plumber plumber) {
	...
	public PUBLISHED_BY(Podiatric podiatric) {
	...
	public PUBLISHED_BY(PoliceStation policeStation) {
	...
	public PUBLISHED_BY(PostOffice postOffice) {
	...
	public PUBLISHED_BY(Preschool preschool) {
	...
	public PUBLISHED_BY(PrimaryCare primaryCare) {
	...
	public PUBLISHED_BY(ProfessionalService professionalService) {
	...
	public PUBLISHED_BY(Project project) {
	...
	public PUBLISHED_BY(Psychiatric psychiatric) {
	...
	public PUBLISHED_BY(PublicHealth publicHealth) {
	...
	public PUBLISHED_BY(PublicSwimmingPool publicSwimmingPool) {
	...
	public PUBLISHED_BY(RadioStation radioStation) {
	...
	public PUBLISHED_BY(RealEstateAgent realEstateAgent) {
	...
	public PUBLISHED_BY(RecyclingCenter recyclingCenter) {
	...
	public PUBLISHED_BY(ResearchProject researchProject) {
	...
	public PUBLISHED_BY(Resort resort) {
	...
	public PUBLISHED_BY(Restaurant restaurant) {
	...
	public PUBLISHED_BY(RoofingContractor roofingContractor) {
	...
	public PUBLISHED_BY(School school) {
	...
	public PUBLISHED_BY(SelfStorage selfStorage) {
	...
	public PUBLISHED_BY(ShoeStore shoeStore) {
	...
	public PUBLISHED_BY(ShoppingCenter shoppingCenter) {
	...
	public PUBLISHED_BY(SkiResort skiResort) {
	...
	public PUBLISHED_BY(SportingGoodsStore sportingGoodsStore) {
	...
	public PUBLISHED_BY(SportsActivityLocation sportsActivityLocation) {
	...
	public PUBLISHED_BY(SportsClub sportsClub) {
	...
	public PUBLISHED_BY(SportsOrganization sportsOrganization) {
	...
	public PUBLISHED_BY(SportsTeam sportsTeam) {
	...
	public PUBLISHED_BY(StadiumOrArena stadiumOrArena) {
	...
	public PUBLISHED_BY(Store store) {
	...
	public PUBLISHED_BY(TattooParlor tattooParlor) {
	...
	public PUBLISHED_BY(TelevisionStation televisionStation) {
	...
	public PUBLISHED_BY(TennisComplex tennisComplex) {
	...
	public PUBLISHED_BY(TheaterGroup theaterGroup) {
	...
	public PUBLISHED_BY(TireShop tireShop) {
	...
	public PUBLISHED_BY(TouristInformationCenter touristInformationCenter) {
	...
	public PUBLISHED_BY(ToyStore toyStore) {
	...
	public PUBLISHED_BY(TravelAgency travelAgency) {
	...
	public PUBLISHED_BY(VeterinaryCare veterinaryCare) {
	...
	public PUBLISHED_BY(WholesaleStore wholesaleStore) {
	...
	public PUBLISHED_BY(Winery winery) {
	...
	public PUBLISHED_BY(WorkersUnion workersUnion) {
	...
	public void copy(Container.PublishedBy org) {
