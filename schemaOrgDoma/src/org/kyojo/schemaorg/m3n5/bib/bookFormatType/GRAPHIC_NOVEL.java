package org.kyojo.schemaorg.m3n5.bib.bookFormatType;
...
import org.kyojo.schemaorg.m3n5.bib.BookFormatType;
...
public class GRAPHIC_NOVEL implements BookFormatType.GraphicNovel {
	...
	public GRAPHIC_NOVEL() {
	}

	public GRAPHIC_NOVEL(Long seq) {
		setSeq(seq);
	}

	public GRAPHIC_NOVEL(String string) {
	...
	public GRAPHIC_NOVEL(AdditionalType additionalType) {
	...
	public GRAPHIC_NOVEL(AlternateName alternateName) {
	...
	public GRAPHIC_NOVEL(Description description) {
	...
	public GRAPHIC_NOVEL(DisambiguatingDescription disambiguatingDescription) {
	...
	public GRAPHIC_NOVEL(Identifier identifier) {
	...
	public GRAPHIC_NOVEL(Image image) {
		setImage(image);
	}
	...
	public GRAPHIC_NOVEL(MainEntityOfPage mainEntityOfPage) {
	...
	public GRAPHIC_NOVEL(Name name) {
		setName(name);
	}
	...
	public GRAPHIC_NOVEL(NameFuzzy nameFuzzy) {
	...
	public GRAPHIC_NOVEL(NameRuby nameRuby) {
	...
	public GRAPHIC_NOVEL(PotentialAction potentialAction) {
	...
	public GRAPHIC_NOVEL(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public GRAPHIC_NOVEL(SubjectOf subjectOf) {
	...
	public GRAPHIC_NOVEL(SupersededBy supersededBy) {
	...
	public void copy(BookFormatType.GraphicNovel org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return BookFormatType.GraphicNovel.class.getAnnotation(SampleValue.class).value();
	}
