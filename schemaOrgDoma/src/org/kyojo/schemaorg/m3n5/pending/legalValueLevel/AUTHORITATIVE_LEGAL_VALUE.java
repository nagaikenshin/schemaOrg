...
public class AUTHORITATIVE_LEGAL_VALUE implements LegalValueLevel.AuthoritativeLegalValue {
	...
	public AUTHORITATIVE_LEGAL_VALUE(Long seq) {
		setSeq(seq);
	}

	public AUTHORITATIVE_LEGAL_VALUE(String string) {
	...
	public AUTHORITATIVE_LEGAL_VALUE(AdditionalType additionalType) {
	...
	public AUTHORITATIVE_LEGAL_VALUE(AlternateName alternateName) {
	...
	public AUTHORITATIVE_LEGAL_VALUE(Description description) {
	...
	public AUTHORITATIVE_LEGAL_VALUE(DisambiguatingDescription disambiguatingDescription) {
	...
	public AUTHORITATIVE_LEGAL_VALUE(Identifier identifier) {
	...
	public AUTHORITATIVE_LEGAL_VALUE(Image image) {
		setImage(image);
	}
	...
	public AUTHORITATIVE_LEGAL_VALUE(MainEntityOfPage mainEntityOfPage) {
	...
	public AUTHORITATIVE_LEGAL_VALUE(Name name) {
		setName(name);
	}
	...
	public AUTHORITATIVE_LEGAL_VALUE(NameFuzzy nameFuzzy) {
	...
	public AUTHORITATIVE_LEGAL_VALUE(NameRuby nameRuby) {
	...
	public AUTHORITATIVE_LEGAL_VALUE(PotentialAction potentialAction) {
	...
	public AUTHORITATIVE_LEGAL_VALUE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public AUTHORITATIVE_LEGAL_VALUE(SubjectOf subjectOf) {
	...
	public AUTHORITATIVE_LEGAL_VALUE(SupersededBy supersededBy) {
	...
	public AUTHORITATIVE_LEGAL_VALUE(Url url) {
		setUrl(url);
	}
	...
	public void copy(LegalValueLevel.AuthoritativeLegalValue org) {
		setSeq(org.getSeq());
