...
public class MATERIAL_EXTENT implements Container.MaterialExtent {
	...
	public MATERIAL_EXTENT() {
	}

	public MATERIAL_EXTENT(QuantitativeValue quantitativeValue) {
	...
	public MATERIAL_EXTENT(String string) {
		this(new TEXT(string));
	}

	public MATERIAL_EXTENT(Text text) {
	...
	public MATERIAL_EXTENT(List<QuantitativeValue> quantitativeValueList,
			List<Text> textList) {
		setQuantitativeValueList(quantitativeValueList);
		setTextList(textList);
	}

	public void copy(Container.MaterialExtent org) {
