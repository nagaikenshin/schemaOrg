...
public class APPEARANCE implements Container.Appearance {
	...
	public APPEARANCE(String string) {
	...
	public APPEARANCE(APIReference apiReference) {
	...
	public APPEARANCE(AboutPage aboutPage) {
	...
	public APPEARANCE(AdvertiserContentArticle advertiserContentArticle) {
	...
	public APPEARANCE(AnalysisNewsArticle analysisNewsArticle) {
	...
	public APPEARANCE(Answer answer) {
	...
	public APPEARANCE(ArchiveComponent archiveComponent) {
	...
	public APPEARANCE(Article article) {
	...
	public APPEARANCE(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public APPEARANCE(AudioObject audioObject) {
	...
	public APPEARANCE(Audiobook audiobook) {
	...
	public APPEARANCE(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public APPEARANCE(Barcode barcode) {
	...
	public APPEARANCE(BlogPosting blogPosting) {
	...
	public APPEARANCE(BookSeries bookSeries) {
	...
	public APPEARANCE(CategoryCodeSet categoryCodeSet) {
	...
	public APPEARANCE(Chapter chapter) {
	...
	public APPEARANCE(CheckoutPage checkoutPage) {
	...
	public APPEARANCE(ClaimReview claimReview) {
	...
	public APPEARANCE(Collection collection) {
	...
	public APPEARANCE(CollectionPage collectionPage) {
	...
	public APPEARANCE(ComicCoverArt comicCoverArt) {
	...
	public APPEARANCE(ComicIssue comicIssue) {
	...
	public APPEARANCE(ComicSeries comicSeries) {
	...
	public APPEARANCE(ComicStory comicStory) {
	...
	public APPEARANCE(Comment comment) {
	...
	public APPEARANCE(CompleteDataFeed completeDataFeed) {
	...
	public APPEARANCE(ContactPage contactPage) {
	...
	public APPEARANCE(Conversation conversation) {
	...
	public APPEARANCE(CorrectionComment correctionComment) {
	...
	public APPEARANCE(Course course) {
	...
	public APPEARANCE(CoverArt coverArt) {
	...
	public APPEARANCE(CreativeWork creativeWork) {
		creativeWorkList = new ArrayList<CreativeWork>();
	...
	public APPEARANCE(CreativeWorkSeason creativeWorkSeason) {
	...
	public APPEARANCE(CreativeWorkSeries creativeWorkSeries) {
	...
	public APPEARANCE(CriticReview criticReview) {
	...
	public APPEARANCE(DataCatalog dataCatalog) {
	...
	public APPEARANCE(DataDownload dataDownload) {
	...
	public APPEARANCE(DataFeed dataFeed) {
	...
	public APPEARANCE(Dataset dataset) {
	...
	public APPEARANCE(DefinedTermSet definedTermSet) {
	...
	public APPEARANCE(DigitalDocument digitalDocument) {
	...
	public APPEARANCE(DiscussionForumPosting discussionForumPosting) {
	...
	public APPEARANCE(Drawing drawing) {
	...
	public APPEARANCE(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public APPEARANCE(EmailMessage emailMessage) {
	...
	public APPEARANCE(EmployerReview employerReview) {
	...
	public APPEARANCE(Episode episode) {
	...
	public APPEARANCE(ExercisePlan exercisePlan) {
	...
	public APPEARANCE(FAQPage faqPage) {
	...
	public APPEARANCE(HowToDirection howToDirection) {
	...
	public APPEARANCE(HowToSection howToSection) {
	...
	public APPEARANCE(HowToStep howToStep) {
	...
	public APPEARANCE(HowToTip howToTip) {
	...
	public APPEARANCE(ImageGallery imageGallery) {
	...
	public APPEARANCE(ImageObject imageObject) {
	...
	public APPEARANCE(ItemPage itemPage) {
	...
	public APPEARANCE(Legislation legislation) {
	...
	public APPEARANCE(LegislationObject legislationObject) {
	...
	public APPEARANCE(LiveBlogPosting liveBlogPosting) {
	...
	public APPEARANCE(Manuscript manuscript) {
	...
	public APPEARANCE(MediaObject mediaObject) {
	...
	public APPEARANCE(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public APPEARANCE(MedicalWebPage medicalWebPage) {
	...
	public APPEARANCE(MenuSection menuSection) {
	...
	public APPEARANCE(Message message) {
	...
	public APPEARANCE(MobileApplication mobileApplication) {
	...
	public APPEARANCE(MovieClip movieClip) {
	...
	public APPEARANCE(MovieSeries movieSeries) {
	...
	public APPEARANCE(MusicAlbum musicAlbum) {
	...
	public APPEARANCE(MusicComposition musicComposition) {
	...
	public APPEARANCE(MusicPlaylist musicPlaylist) {
	...
	public APPEARANCE(MusicRecording musicRecording) {
	...
	public APPEARANCE(MusicRelease musicRelease) {
	...
	public APPEARANCE(MusicVideoObject musicVideoObject) {
	...
	public APPEARANCE(NewsArticle newsArticle) {
	...
	public APPEARANCE(Newspaper newspaper) {
	...
	public APPEARANCE(NoteDigitalDocument noteDigitalDocument) {
	...
	public APPEARANCE(OpinionNewsArticle opinionNewsArticle) {
	...
	public APPEARANCE(Painting painting) {
	...
	public APPEARANCE(Periodical periodical) {
	...
	public APPEARANCE(Photograph photograph) {
	...
	public APPEARANCE(Poster poster) {
	...
	public APPEARANCE(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public APPEARANCE(ProfilePage profilePage) {
	...
	public APPEARANCE(PublicationIssue publicationIssue) {
	...
	public APPEARANCE(PublicationVolume publicationVolume) {
	...
	public APPEARANCE(QAPage qaPage) {
	...
	public APPEARANCE(Question question) {
	...
	public APPEARANCE(Quotation quotation) {
	...
	public APPEARANCE(RadioClip radioClip) {
	...
	public APPEARANCE(RadioEpisode radioEpisode) {
	...
	public APPEARANCE(RadioSeason radioSeason) {
	...
	public APPEARANCE(RadioSeries radioSeries) {
	...
	public APPEARANCE(Recipe recipe) {
	...
	public APPEARANCE(Report report) {
	...
	public APPEARANCE(ReportageNewsArticle reportageNewsArticle) {
	...
	public APPEARANCE(Review review) {
	...
	public APPEARANCE(ReviewNewsArticle reviewNewsArticle) {
	...
	public APPEARANCE(SatiricalArticle satiricalArticle) {
	...
	public APPEARANCE(ScholarlyArticle scholarlyArticle) {
	...
	public APPEARANCE(Sculpture sculpture) {
	...
	public APPEARANCE(SearchResultsPage searchResultsPage) {
	...
	public APPEARANCE(SheetMusic sheetMusic) {
	...
	public APPEARANCE(ShortStory shortStory) {
	...
	public APPEARANCE(SiteNavigationElement siteNavigationElement) {
	...
	public APPEARANCE(SocialMediaPosting socialMediaPosting) {
	...
	public APPEARANCE(SoftwareApplication softwareApplication) {
	...
	public APPEARANCE(SoftwareSourceCode softwareSourceCode) {
	...
	public APPEARANCE(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public APPEARANCE(TVClip tvClip) {
	...
	public APPEARANCE(TVEpisode tvEpisode) {
	...
	public APPEARANCE(TVSeason tvSeason) {
	...
	public APPEARANCE(TVSeries tvSeries) {
	...
	public APPEARANCE(TechArticle techArticle) {
	...
	public APPEARANCE(TextDigitalDocument textDigitalDocument) {
	...
	public APPEARANCE(Thesis thesis) {
	...
	public APPEARANCE(ThreeDimensionalModel threeDimensionalModel) {
	...
	public APPEARANCE(UserReview userReview) {
	...
	public APPEARANCE(VideoGallery videoGallery) {
	...
	public APPEARANCE(VideoGame videoGame) {
	...
	public APPEARANCE(VideoGameClip videoGameClip) {
	...
	public APPEARANCE(VideoGameSeries videoGameSeries) {
	...
	public APPEARANCE(VideoObject videoObject) {
	...
	public APPEARANCE(VisualArtwork visualArtwork) {
	...
	public APPEARANCE(WPAdBlock wpAdBlock) {
	...
	public APPEARANCE(WPFooter wpFooter) {
	...
	public APPEARANCE(WPHeader wpHeader) {
	...
	public APPEARANCE(WPSideBar wpSideBar) {
	...
	public APPEARANCE(WebApplication webApplication) {
	...
	public APPEARANCE(WebPage webPage) {
	...
	public APPEARANCE(WebPageElement webPageElement) {
	...
	public APPEARANCE(WebSite webSite) {
	...
	public void copy(Container.Appearance org) {
