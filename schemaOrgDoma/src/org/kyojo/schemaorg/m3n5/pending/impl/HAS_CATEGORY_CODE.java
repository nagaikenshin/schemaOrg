...
public class HAS_CATEGORY_CODE implements Container.HasCategoryCode {
	...
	public HAS_CATEGORY_CODE(APIReference apiReference) {
	...
	public HAS_CATEGORY_CODE(AboutPage aboutPage) {
	...
	public HAS_CATEGORY_CODE(AdvertiserContentArticle advertiserContentArticle) {
	...
	public HAS_CATEGORY_CODE(AnalysisNewsArticle analysisNewsArticle) {
	...
	public HAS_CATEGORY_CODE(Answer answer) {
	...
	public HAS_CATEGORY_CODE(ArchiveComponent archiveComponent) {
	...
	public HAS_CATEGORY_CODE(Article article) {
	...
	public HAS_CATEGORY_CODE(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public HAS_CATEGORY_CODE(Atlas atlas) {
	...
	public HAS_CATEGORY_CODE(AudioObject audioObject) {
	...
	public HAS_CATEGORY_CODE(Audiobook audiobook) {
	...
	public HAS_CATEGORY_CODE(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public HAS_CATEGORY_CODE(Barcode barcode) {
	...
	public HAS_CATEGORY_CODE(Blog blog) {
	...
	public HAS_CATEGORY_CODE(BlogPosting blogPosting) {
	...
	public HAS_CATEGORY_CODE(Book book) {
	...
	public HAS_CATEGORY_CODE(BookSeries bookSeries) {
	...
	public HAS_CATEGORY_CODE(CategoryCodeSet categoryCodeSet) {
	...
	public HAS_CATEGORY_CODE(Chapter chapter) {
	...
	public HAS_CATEGORY_CODE(CheckoutPage checkoutPage) {
	...
	public HAS_CATEGORY_CODE(Claim claim) {
	...
	public HAS_CATEGORY_CODE(ClaimReview claimReview) {
	...
	public HAS_CATEGORY_CODE(Clip clip) {
	...
	public HAS_CATEGORY_CODE(Collection collection) {
	...
	public HAS_CATEGORY_CODE(CollectionPage collectionPage) {
	...
	public HAS_CATEGORY_CODE(ComicCoverArt comicCoverArt) {
	...
	public HAS_CATEGORY_CODE(ComicIssue comicIssue) {
	...
	public HAS_CATEGORY_CODE(ComicSeries comicSeries) {
	...
	public HAS_CATEGORY_CODE(ComicStory comicStory) {
	...
	public HAS_CATEGORY_CODE(Comment comment) {
	...
	public HAS_CATEGORY_CODE(CompleteDataFeed completeDataFeed) {
	...
	public HAS_CATEGORY_CODE(ContactPage contactPage) {
	...
	public HAS_CATEGORY_CODE(Conversation conversation) {
	...
	public HAS_CATEGORY_CODE(CorrectionComment correctionComment) {
	...
	public HAS_CATEGORY_CODE(Course course) {
	...
	public HAS_CATEGORY_CODE(CoverArt coverArt) {
	...
	public HAS_CATEGORY_CODE(CreativeWorkSeason creativeWorkSeason) {
	...
	public HAS_CATEGORY_CODE(CreativeWorkSeries creativeWorkSeries) {
	...
	public HAS_CATEGORY_CODE(CriticReview criticReview) {
	...
	public HAS_CATEGORY_CODE(DataCatalog dataCatalog) {
	...
	public HAS_CATEGORY_CODE(DataDownload dataDownload) {
	...
	public HAS_CATEGORY_CODE(DataFeed dataFeed) {
	...
	public HAS_CATEGORY_CODE(Dataset dataset) {
	...
	public HAS_CATEGORY_CODE(DefinedTermSet definedTermSet) {
	...
	public HAS_CATEGORY_CODE(Diet diet) {
	...
	public HAS_CATEGORY_CODE(DigitalDocument digitalDocument) {
	...
	public HAS_CATEGORY_CODE(DiscussionForumPosting discussionForumPosting) {
	...
	public HAS_CATEGORY_CODE(Drawing drawing) {
	...
	public HAS_CATEGORY_CODE(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public HAS_CATEGORY_CODE(EmailMessage emailMessage) {
	...
	public HAS_CATEGORY_CODE(EmployerReview employerReview) {
	...
	public HAS_CATEGORY_CODE(Episode episode) {
	...
	public HAS_CATEGORY_CODE(ExercisePlan exercisePlan) {
	...
	public HAS_CATEGORY_CODE(FAQPage faqPage) {
	...
	public HAS_CATEGORY_CODE(Game game) {
	...
	public HAS_CATEGORY_CODE(HowTo howTo) {
	...
	public HAS_CATEGORY_CODE(HowToDirection howToDirection) {
	...
	public HAS_CATEGORY_CODE(HowToSection howToSection) {
	...
	public HAS_CATEGORY_CODE(HowToStep howToStep) {
	...
	public HAS_CATEGORY_CODE(HowToTip howToTip) {
	...
	public HAS_CATEGORY_CODE(ImageGallery imageGallery) {
	...
	public HAS_CATEGORY_CODE(ImageObject imageObject) {
	...
	public HAS_CATEGORY_CODE(ItemPage itemPage) {
	...
	public HAS_CATEGORY_CODE(Legislation legislation) {
	...
	public HAS_CATEGORY_CODE(LegislationObject legislationObject) {
	...
	public HAS_CATEGORY_CODE(LiveBlogPosting liveBlogPosting) {
	...
	public HAS_CATEGORY_CODE(Manuscript manuscript) {
	...
	public HAS_CATEGORY_CODE(Map map) {
	...
	public HAS_CATEGORY_CODE(MediaObject mediaObject) {
	...
	public HAS_CATEGORY_CODE(MedicalCode medicalCode) {
	...
	public HAS_CATEGORY_CODE(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public HAS_CATEGORY_CODE(MedicalWebPage medicalWebPage) {
	...
	public HAS_CATEGORY_CODE(Menu menu) {
	...
	public HAS_CATEGORY_CODE(MenuSection menuSection) {
	...
	public HAS_CATEGORY_CODE(Message message) {
	...
	public HAS_CATEGORY_CODE(MobileApplication mobileApplication) {
	...
	public HAS_CATEGORY_CODE(Movie movie) {
	...
	public HAS_CATEGORY_CODE(MovieClip movieClip) {
	...
	public HAS_CATEGORY_CODE(MovieSeries movieSeries) {
	...
	public HAS_CATEGORY_CODE(MusicAlbum musicAlbum) {
	...
	public HAS_CATEGORY_CODE(MusicComposition musicComposition) {
	...
	public HAS_CATEGORY_CODE(MusicPlaylist musicPlaylist) {
	...
	public HAS_CATEGORY_CODE(MusicRecording musicRecording) {
	...
	public HAS_CATEGORY_CODE(MusicRelease musicRelease) {
	...
	public HAS_CATEGORY_CODE(MusicVideoObject musicVideoObject) {
	...
	public HAS_CATEGORY_CODE(NewsArticle newsArticle) {
	...
	public HAS_CATEGORY_CODE(Newspaper newspaper) {
	...
	public HAS_CATEGORY_CODE(NoteDigitalDocument noteDigitalDocument) {
	...
	public HAS_CATEGORY_CODE(OpinionNewsArticle opinionNewsArticle) {
	...
	public HAS_CATEGORY_CODE(Painting painting) {
	...
	public HAS_CATEGORY_CODE(Periodical periodical) {
	...
	public HAS_CATEGORY_CODE(Photograph photograph) {
	...
	public HAS_CATEGORY_CODE(Play play) {
	...
	public HAS_CATEGORY_CODE(Poster poster) {
	...
	public HAS_CATEGORY_CODE(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public HAS_CATEGORY_CODE(ProfilePage profilePage) {
	...
	public HAS_CATEGORY_CODE(PublicationIssue publicationIssue) {
	...
	public HAS_CATEGORY_CODE(PublicationVolume publicationVolume) {
	...
	public HAS_CATEGORY_CODE(QAPage qaPage) {
	...
	public HAS_CATEGORY_CODE(Question question) {
	...
	public HAS_CATEGORY_CODE(Quotation quotation) {
	...
	public HAS_CATEGORY_CODE(RadioClip radioClip) {
	...
	public HAS_CATEGORY_CODE(RadioEpisode radioEpisode) {
	...
	public HAS_CATEGORY_CODE(RadioSeason radioSeason) {
	...
	public HAS_CATEGORY_CODE(RadioSeries radioSeries) {
	...
	public HAS_CATEGORY_CODE(Recipe recipe) {
	...
	public HAS_CATEGORY_CODE(Report report) {
	...
	public HAS_CATEGORY_CODE(ReportageNewsArticle reportageNewsArticle) {
	...
	public HAS_CATEGORY_CODE(Review review) {
	...
	public HAS_CATEGORY_CODE(ReviewNewsArticle reviewNewsArticle) {
	...
	public HAS_CATEGORY_CODE(SatiricalArticle satiricalArticle) {
	...
	public HAS_CATEGORY_CODE(ScholarlyArticle scholarlyArticle) {
	...
	public HAS_CATEGORY_CODE(Sculpture sculpture) {
	...
	public HAS_CATEGORY_CODE(SearchResultsPage searchResultsPage) {
	...
	public HAS_CATEGORY_CODE(SheetMusic sheetMusic) {
	...
	public HAS_CATEGORY_CODE(ShortStory shortStory) {
	...
	public HAS_CATEGORY_CODE(SiteNavigationElement siteNavigationElement) {
	...
	public HAS_CATEGORY_CODE(SocialMediaPosting socialMediaPosting) {
	...
	public HAS_CATEGORY_CODE(SoftwareApplication softwareApplication) {
	...
	public HAS_CATEGORY_CODE(SoftwareSourceCode softwareSourceCode) {
	...
	public HAS_CATEGORY_CODE(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public HAS_CATEGORY_CODE(TVClip tvClip) {
	...
	public HAS_CATEGORY_CODE(TVEpisode tvEpisode) {
	...
	public HAS_CATEGORY_CODE(TVSeason tvSeason) {
	...
	public HAS_CATEGORY_CODE(TVSeries tvSeries) {
	...
	public HAS_CATEGORY_CODE(Table table) {
	...
	public HAS_CATEGORY_CODE(TechArticle techArticle) {
	...
	public HAS_CATEGORY_CODE(TextDigitalDocument textDigitalDocument) {
	...
	public HAS_CATEGORY_CODE(Thesis thesis) {
	...
	public HAS_CATEGORY_CODE(ThreeDimensionalModel threeDimensionalModel) {
	...
	public HAS_CATEGORY_CODE(UserReview userReview) {
	...
	public HAS_CATEGORY_CODE(VideoGallery videoGallery) {
	...
	public HAS_CATEGORY_CODE(VideoGame videoGame) {
	...
	public HAS_CATEGORY_CODE(VideoGameClip videoGameClip) {
	...
	public HAS_CATEGORY_CODE(VideoGameSeries videoGameSeries) {
	...
	public HAS_CATEGORY_CODE(VideoObject videoObject) {
	...
	public HAS_CATEGORY_CODE(VisualArtwork visualArtwork) {
	...
	public HAS_CATEGORY_CODE(WPAdBlock wpAdBlock) {
	...
	public HAS_CATEGORY_CODE(WPFooter wpFooter) {
	...
	public HAS_CATEGORY_CODE(WPHeader wpHeader) {
	...
	public HAS_CATEGORY_CODE(WPSideBar wpSideBar) {
	...
	public HAS_CATEGORY_CODE(WebApplication webApplication) {
	...
	public HAS_CATEGORY_CODE(WebPage webPage) {
	...
	public HAS_CATEGORY_CODE(WebPageElement webPageElement) {
	...
	public HAS_CATEGORY_CODE(WebSite webSite) {
