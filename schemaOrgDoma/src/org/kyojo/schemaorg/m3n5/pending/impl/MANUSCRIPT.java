...
public class MANUSCRIPT implements Clazz.Manuscript {
	...
	public MANUSCRIPT(Long seq) {
		setSeq(seq);
	}

	public MANUSCRIPT(String string) {
	...
	public MANUSCRIPT(AccessMode accessMode) {
	...
	public MANUSCRIPT(AccessModeSufficient accessModeSufficient) {
	...
	public MANUSCRIPT(AccessibilityAPI accessibilityAPI) {
	...
	public MANUSCRIPT(AccessibilityControl accessibilityControl) {
	...
	public MANUSCRIPT(AccessibilityFeature accessibilityFeature) {
	...
	public MANUSCRIPT(AccessibilityHazard accessibilityHazard) {
	...
	public MANUSCRIPT(AccessibilitySummary accessibilitySummary) {
	...
	public MANUSCRIPT(AccountablePerson accountablePerson) {
	...
	public MANUSCRIPT(AdditionalType additionalType) {
	...
	public MANUSCRIPT(AggregateRating aggregateRating) {
	...
	public MANUSCRIPT(AlternateName alternateName) {
	...
	public MANUSCRIPT(AlternativeHeadline alternativeHeadline) {
	...
	public MANUSCRIPT(AssociatedMedia associatedMedia) {
	...
	public MANUSCRIPT(Audience audience) {
	...
	public MANUSCRIPT(Author author) {
		setAuthor(author);
	}
	...
	public MANUSCRIPT(Character character) {
	...
	public MANUSCRIPT(Citation citation) {
	...
	public MANUSCRIPT(Comment comment) {
		setComment(comment);
	}
	...
	public MANUSCRIPT(CommentCount commentCount) {
	...
	public MANUSCRIPT(ContentLocation contentLocation) {
	...
	public MANUSCRIPT(ContentRating contentRating) {
	...
	public MANUSCRIPT(ContentReferenceTime contentReferenceTime) {
	...
	public MANUSCRIPT(Contributor contributor) {
	...
	public MANUSCRIPT(CopyrightHolder copyrightHolder) {
	...
	public MANUSCRIPT(CopyrightYear copyrightYear) {
	...
	public MANUSCRIPT(Correction correction) {
	...
	public MANUSCRIPT(Creator creator) {
		setCreator(creator);
	}
	...
	public MANUSCRIPT(DateCreated dateCreated) {
	...
	public MANUSCRIPT(DateModified dateModified) {
	...
	public MANUSCRIPT(DatePublished datePublished) {
	...
	public MANUSCRIPT(Description description) {
	...
	public MANUSCRIPT(DisambiguatingDescription disambiguatingDescription) {
	...
	public MANUSCRIPT(DiscussionUrl discussionUrl) {
	...
	public MANUSCRIPT(Editor editor) {
		setEditor(editor);
	}
	...
	public MANUSCRIPT(EducationalAlignment educationalAlignment) {
	...
	public MANUSCRIPT(EducationalUse educationalUse) {
	...
	public MANUSCRIPT(Encoding encoding) {
	...
	public MANUSCRIPT(EncodingFormat encodingFormat) {
	...
	public MANUSCRIPT(ExampleOfWork exampleOfWork) {
	...
	public MANUSCRIPT(Expires expires) {
		setExpires(expires);
	}
	...
	public MANUSCRIPT(Funder funder) {
		setFunder(funder);
	}
	...
	public MANUSCRIPT(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public MANUSCRIPT(Headline headline) {
	...
	public MANUSCRIPT(Identifier identifier) {
	...
	public MANUSCRIPT(InLanguage inLanguage) {
	...
	public MANUSCRIPT(InteractionStatistic interactionStatistic) {
	...
	public MANUSCRIPT(InteractivityType interactivityType) {
	...
	public MANUSCRIPT(IsAccessibleForFree isAccessibleForFree) {
	...
	public MANUSCRIPT(IsBasedOn isBasedOn) {
	...
	public MANUSCRIPT(IsFamilyFriendly isFamilyFriendly) {
	...
	public MANUSCRIPT(IsPartOf isPartOf) {
	...
	public MANUSCRIPT(Keywords keywords) {
	...
	public MANUSCRIPT(LearningResourceType learningResourceType) {
	...
	public MANUSCRIPT(License license) {
		setLicense(license);
	}
	...
	public MANUSCRIPT(LocationCreated locationCreated) {
	...
	public MANUSCRIPT(MainEntity mainEntity) {
	...
	public MANUSCRIPT(MainEntityOfPage mainEntityOfPage) {
	...
	public MANUSCRIPT(Material material) {
	...
	public MANUSCRIPT(MaterialExtent materialExtent) {
	...
	public MANUSCRIPT(Mentions mentions) {
	...
	public MANUSCRIPT(NameFuzzy nameFuzzy) {
	...
	public MANUSCRIPT(NameRuby nameRuby) {
	...
	public MANUSCRIPT(Offers offers) {
		setOffers(offers);
	}
	...
	public MANUSCRIPT(Position position) {
	...
	public MANUSCRIPT(PotentialAction potentialAction) {
	...
	public MANUSCRIPT(Producer producer) {
	...
	public MANUSCRIPT(Provider provider) {
	...
	public MANUSCRIPT(Publication publication) {
	...
	public MANUSCRIPT(Publisher publisher) {
	...
	public MANUSCRIPT(PublisherImprint publisherImprint) {
	...
	public MANUSCRIPT(PublishingPrinciples publishingPrinciples) {
	...
	public MANUSCRIPT(RecordedAt recordedAt) {
	...
	public MANUSCRIPT(ReleasedEvent releasedEvent) {
	...
	public MANUSCRIPT(Review review) {
		setReview(review);
	}
	...
	public MANUSCRIPT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MANUSCRIPT(SchemaVersion schemaVersion) {
	...
	public MANUSCRIPT(SdDatePublished sdDatePublished) {
	...
	public MANUSCRIPT(SdLicense sdLicense) {
	...
	public MANUSCRIPT(SdPublisher sdPublisher) {
	...
	public MANUSCRIPT(SourceOrganization sourceOrganization) {
	...
	public MANUSCRIPT(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public MANUSCRIPT(SpatialCoverage spatialCoverage) {
	...
	public MANUSCRIPT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public MANUSCRIPT(SubjectOf subjectOf) {
	...
	public MANUSCRIPT(Temporal temporal) {
	...
	public MANUSCRIPT(TemporalCoverage temporalCoverage) {
	...
	public MANUSCRIPT(ThumbnailUrl thumbnailUrl) {
	...
	public MANUSCRIPT(TimeRequired timeRequired) {
	...
	public MANUSCRIPT(TranslationOfWork translationOfWork) {
	...
	public MANUSCRIPT(Translator translator) {
	...
	public MANUSCRIPT(TypicalAgeRange typicalAgeRange) {
	...
	public MANUSCRIPT(Version version) {
		setVersion(version);
	}
	...
	public MANUSCRIPT(WorkExample workExample) {
	...
	public MANUSCRIPT(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Manuscript org) {
		setSeq(org.getSeq());
