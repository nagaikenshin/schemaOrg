...
public class BROKERAGE_ACCOUNT implements Clazz.BrokerageAccount {
	...
	public BROKERAGE_ACCOUNT(Long seq) {
		setSeq(seq);
	}

	public BROKERAGE_ACCOUNT(String string) {
	...
	public BROKERAGE_ACCOUNT(AdditionalType additionalType) {
	...
	public BROKERAGE_ACCOUNT(AggregateRating aggregateRating) {
	...
	public BROKERAGE_ACCOUNT(AlternateName alternateName) {
	...
	public BROKERAGE_ACCOUNT(Amount amount) {
		setAmount(amount);
	}
	...
	public BROKERAGE_ACCOUNT(AnnualPercentageRate annualPercentageRate) {
	...
	public BROKERAGE_ACCOUNT(AreaServed areaServed) {
	...
	public BROKERAGE_ACCOUNT(Audience audience) {
	...
	public BROKERAGE_ACCOUNT(AvailableChannel availableChannel) {
	...
	public BROKERAGE_ACCOUNT(Award award) {
		setAward(award);
	}
	...
	public BROKERAGE_ACCOUNT(Brand brand) {
		setBrand(brand);
	}
	...
	public BROKERAGE_ACCOUNT(Broker broker) {
		setBroker(broker);
	}
	...
	public BROKERAGE_ACCOUNT(Category category) {
	...
	public BROKERAGE_ACCOUNT(Description description) {
	...
	public BROKERAGE_ACCOUNT(DisambiguatingDescription disambiguatingDescription) {
	...
	public BROKERAGE_ACCOUNT(FeesAndCommissionsSpecification feesAndCommissionsSpecification) {
	...
	public BROKERAGE_ACCOUNT(HasOfferCatalog hasOfferCatalog) {
	...
	public BROKERAGE_ACCOUNT(HoursAvailable hoursAvailable) {
	...
	public BROKERAGE_ACCOUNT(Identifier identifier) {
	...
	public BROKERAGE_ACCOUNT(Image image) {
		setImage(image);
	}
	...
	public BROKERAGE_ACCOUNT(InterestRate interestRate) {
	...
	public BROKERAGE_ACCOUNT(IsRelatedTo isRelatedTo) {
	...
	public BROKERAGE_ACCOUNT(IsSimilarTo isSimilarTo) {
	...
	public BROKERAGE_ACCOUNT(Logo logo) {
		setLogo(logo);
	}
	...
	public BROKERAGE_ACCOUNT(MainEntityOfPage mainEntityOfPage) {
	...
	public BROKERAGE_ACCOUNT(Name name) {
		setName(name);
	}
	...
	public BROKERAGE_ACCOUNT(NameFuzzy nameFuzzy) {
	...
	public BROKERAGE_ACCOUNT(NameRuby nameRuby) {
	...
	public BROKERAGE_ACCOUNT(Offers offers) {
		setOffers(offers);
	}
	...
	public BROKERAGE_ACCOUNT(PotentialAction potentialAction) {
	...
	public BROKERAGE_ACCOUNT(Provider provider) {
	...
	public BROKERAGE_ACCOUNT(ProviderMobility providerMobility) {
	...
	public BROKERAGE_ACCOUNT(Review review) {
		setReview(review);
	}
	...
	public BROKERAGE_ACCOUNT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public BROKERAGE_ACCOUNT(ServiceOutput serviceOutput) {
	...
	public BROKERAGE_ACCOUNT(ServiceType serviceType) {
	...
	public BROKERAGE_ACCOUNT(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public BROKERAGE_ACCOUNT(SubjectOf subjectOf) {
	...
	public BROKERAGE_ACCOUNT(TermsOfService termsOfService) {
	...
	public BROKERAGE_ACCOUNT(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.BrokerageAccount org) {
		setSeq(org.getSeq());
