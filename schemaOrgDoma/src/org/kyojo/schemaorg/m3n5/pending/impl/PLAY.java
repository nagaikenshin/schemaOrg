...
public class PLAY implements Clazz.Play {
	...
	public PLAY(AccessMode accessMode) {
	...
	public PLAY(AccessModeSufficient accessModeSufficient) {
	...
	public PLAY(AccessibilityAPI accessibilityAPI) {
	...
	public PLAY(AccessibilityControl accessibilityControl) {
	...
	public PLAY(AccessibilityFeature accessibilityFeature) {
	...
	public PLAY(AccessibilityHazard accessibilityHazard) {
	...
	public PLAY(AccessibilitySummary accessibilitySummary) {
	...
	public PLAY(AccountablePerson accountablePerson) {
	...
	public PLAY(AdditionalType additionalType) {
	...
	public PLAY(AggregateRating aggregateRating) {
	...
	public PLAY(AlternateName alternateName) {
	...
	public PLAY(AlternativeHeadline alternativeHeadline) {
	...
	public PLAY(AssociatedMedia associatedMedia) {
	...
	public PLAY(CommentCount commentCount) {
	...
	public PLAY(ContentLocation contentLocation) {
	...
	public PLAY(ContentRating contentRating) {
	...
	public PLAY(ContentReferenceTime contentReferenceTime) {
	...
	public PLAY(Contributor contributor) {
	...
	public PLAY(CopyrightHolder copyrightHolder) {
	...
	public PLAY(CopyrightYear copyrightYear) {
	...
	public PLAY(Correction correction) {
	...
	public PLAY(DateCreated dateCreated) {
	...
	public PLAY(DateModified dateModified) {
	...
	public PLAY(DatePublished datePublished) {
	...
	public PLAY(Description description) {
	...
	public PLAY(DisambiguatingDescription disambiguatingDescription) {
	...
	public PLAY(DiscussionUrl discussionUrl) {
	...
	public PLAY(EducationalAlignment educationalAlignment) {
	...
	public PLAY(EducationalUse educationalUse) {
	...
	public PLAY(EncodingFormat encodingFormat) {
	...
	public PLAY(ExampleOfWork exampleOfWork) {
	...
	public PLAY(Identifier identifier) {
	...
	public PLAY(InLanguage inLanguage) {
	...
	public PLAY(InteractionStatistic interactionStatistic) {
	...
	public PLAY(InteractivityType interactivityType) {
	...
	public PLAY(IsAccessibleForFree isAccessibleForFree) {
	...
	public PLAY(IsBasedOn isBasedOn) {
	...
	public PLAY(IsFamilyFriendly isFamilyFriendly) {
	...
	public PLAY(LearningResourceType learningResourceType) {
	...
	public PLAY(LocationCreated locationCreated) {
	...
	public PLAY(MainEntity mainEntity) {
	...
	public PLAY(MainEntityOfPage mainEntityOfPage) {
	...
	public PLAY(MaterialExtent materialExtent) {
	...
	public PLAY(NameFuzzy nameFuzzy) {
	...
	public PLAY(PotentialAction potentialAction) {
	...
	public PLAY(Publication publication) {
	...
	public PLAY(Publisher publisher) {
	...
	public PLAY(PublisherImprint publisherImprint) {
	...
	public PLAY(PublishingPrinciples publishingPrinciples) {
	...
	public PLAY(RecordedAt recordedAt) {
	...
	public PLAY(ReleasedEvent releasedEvent) {
	...
	public PLAY(SchemaVersion schemaVersion) {
	...
	public PLAY(SdDatePublished sdDatePublished) {
	...
	public PLAY(SdLicense sdLicense) {
	...
	public PLAY(SdPublisher sdPublisher) {
	...
	public PLAY(SourceOrganization sourceOrganization) {
	...
	public PLAY(SpatialCoverage spatialCoverage) {
	...
	public PLAY(SubjectOf subjectOf) {
	...
	public PLAY(TemporalCoverage temporalCoverage) {
	...
	public PLAY(ThumbnailUrl thumbnailUrl) {
	...
	public PLAY(TimeRequired timeRequired) {
	...
	public PLAY(TranslationOfWork translationOfWork) {
	...
	public PLAY(Translator translator) {
	...
	public PLAY(TypicalAgeRange typicalAgeRange) {
	...
	public PLAY(WorkExample workExample) {
	...
	public PLAY(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Play org) {
		setSeq(org.getSeq());
