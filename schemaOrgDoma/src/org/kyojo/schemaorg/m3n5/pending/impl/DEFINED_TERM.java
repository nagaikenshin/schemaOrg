...
public class DEFINED_TERM implements Clazz.DefinedTerm {
	...
	public DEFINED_TERM(Long seq) {
		setSeq(seq);
	}

	public DEFINED_TERM(String string) {
	...
	public DEFINED_TERM(AdditionalType additionalType) {
	...
	public DEFINED_TERM(AlternateName alternateName) {
	...
	public DEFINED_TERM(Description description) {
	...
	public DEFINED_TERM(DisambiguatingDescription disambiguatingDescription) {
	...
	public DEFINED_TERM(Identifier identifier) {
	...
	public DEFINED_TERM(Image image) {
		setImage(image);
	}
	...
	public DEFINED_TERM(InDefinedTermSet inDefinedTermSet) {
	...
	public DEFINED_TERM(MainEntityOfPage mainEntityOfPage) {
	...
	public DEFINED_TERM(NameFuzzy nameFuzzy) {
	...
	public DEFINED_TERM(NameRuby nameRuby) {
	...
	public DEFINED_TERM(PotentialAction potentialAction) {
	...
	public DEFINED_TERM(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DEFINED_TERM(SubjectOf subjectOf) {
	...
	public DEFINED_TERM(TermCode termCode) {
	...
	public void copy(Clazz.DefinedTerm org) {
		setSeq(org.getSeq());
