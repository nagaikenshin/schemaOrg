...
public class EMPLOYER_REVIEW implements Clazz.EmployerReview {
	...
	public EMPLOYER_REVIEW(Correction correction) {
	...
	public EMPLOYER_REVIEW(EncodingFormat encodingFormat) {
	...
	public EMPLOYER_REVIEW(MaterialExtent materialExtent) {
	...
	public EMPLOYER_REVIEW(ReviewAspect reviewAspect) {
	...
	public EMPLOYER_REVIEW(SdDatePublished sdDatePublished) {
	...
	public EMPLOYER_REVIEW(SdLicense sdLicense) {
	...
	public EMPLOYER_REVIEW(SdPublisher sdPublisher) {
	...
	public EMPLOYER_REVIEW(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public EMPLOYER_REVIEW(SubjectOf subjectOf) {
	...
	public EMPLOYER_REVIEW(Temporal temporal) {
