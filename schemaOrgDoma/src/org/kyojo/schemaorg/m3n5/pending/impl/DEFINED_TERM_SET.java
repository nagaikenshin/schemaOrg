...
public class DEFINED_TERM_SET implements Clazz.DefinedTermSet {
	...
	public DEFINED_TERM_SET() {
	}

	public DEFINED_TERM_SET(Long seq) {
		setSeq(seq);
	}

	public DEFINED_TERM_SET(String string) {
	...
	public DEFINED_TERM_SET(About about) {
		setAbout(about);
	}
	...
	public DEFINED_TERM_SET(AccessMode accessMode) {
	...
	public DEFINED_TERM_SET(AccessModeSufficient accessModeSufficient) {
	...
	public DEFINED_TERM_SET(AccessibilityAPI accessibilityAPI) {
	...
	public DEFINED_TERM_SET(AccessibilityControl accessibilityControl) {
	...
	public DEFINED_TERM_SET(AccessibilityFeature accessibilityFeature) {
	...
	public DEFINED_TERM_SET(AccessibilityHazard accessibilityHazard) {
	...
	public DEFINED_TERM_SET(AccessibilitySummary accessibilitySummary) {
	...
	public DEFINED_TERM_SET(AccountablePerson accountablePerson) {
	...
	public DEFINED_TERM_SET(AdditionalType additionalType) {
	...
	public DEFINED_TERM_SET(AggregateRating aggregateRating) {
	...
	public DEFINED_TERM_SET(AlternateName alternateName) {
	...
	public DEFINED_TERM_SET(AlternativeHeadline alternativeHeadline) {
	...
	public DEFINED_TERM_SET(AssociatedMedia associatedMedia) {
	...
	public DEFINED_TERM_SET(Audience audience) {
	...
	public DEFINED_TERM_SET(Audio audio) {
		setAudio(audio);
	}
	...
	public DEFINED_TERM_SET(Author author) {
		setAuthor(author);
	}
	...
	public DEFINED_TERM_SET(Award award) {
		setAward(award);
	}
	...
	public DEFINED_TERM_SET(Character character) {
	...
	public DEFINED_TERM_SET(Citation citation) {
	...
	public DEFINED_TERM_SET(Comment comment) {
		setComment(comment);
	}
	...
	public DEFINED_TERM_SET(CommentCount commentCount) {
	...
	public DEFINED_TERM_SET(ContentLocation contentLocation) {
	...
	public DEFINED_TERM_SET(ContentRating contentRating) {
	...
	public DEFINED_TERM_SET(ContentReferenceTime contentReferenceTime) {
	...
	public DEFINED_TERM_SET(Contributor contributor) {
	...
	public DEFINED_TERM_SET(CopyrightHolder copyrightHolder) {
	...
	public DEFINED_TERM_SET(CopyrightYear copyrightYear) {
	...
	public DEFINED_TERM_SET(Correction correction) {
	...
	public DEFINED_TERM_SET(Creator creator) {
		setCreator(creator);
	}
	...
	public DEFINED_TERM_SET(DateCreated dateCreated) {
	...
	public DEFINED_TERM_SET(DateModified dateModified) {
	...
	public DEFINED_TERM_SET(DatePublished datePublished) {
	...
	public DEFINED_TERM_SET(Description description) {
	...
	public DEFINED_TERM_SET(DisambiguatingDescription disambiguatingDescription) {
	...
	public DEFINED_TERM_SET(DiscussionUrl discussionUrl) {
	...
	public DEFINED_TERM_SET(Editor editor) {
		setEditor(editor);
	}
	...
	public DEFINED_TERM_SET(EducationalAlignment educationalAlignment) {
	...
	public DEFINED_TERM_SET(EducationalUse educationalUse) {
	...
	public DEFINED_TERM_SET(Encoding encoding) {
	...
	public DEFINED_TERM_SET(EncodingFormat encodingFormat) {
	...
	public DEFINED_TERM_SET(ExampleOfWork exampleOfWork) {
	...
	public DEFINED_TERM_SET(Expires expires) {
		setExpires(expires);
	}
	...
	public DEFINED_TERM_SET(Funder funder) {
		setFunder(funder);
	}
	...
	public DEFINED_TERM_SET(Genre genre) {
		setGenre(genre);
	}
	...
	public DEFINED_TERM_SET(HasDefinedTerm hasDefinedTerm) {
	...
	public DEFINED_TERM_SET(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public DEFINED_TERM_SET(Headline headline) {
	...
	public DEFINED_TERM_SET(Identifier identifier) {
	...
	public DEFINED_TERM_SET(Image image) {
		setImage(image);
	}
	...
	public DEFINED_TERM_SET(InLanguage inLanguage) {
	...
	public DEFINED_TERM_SET(InteractionStatistic interactionStatistic) {
	...
	public DEFINED_TERM_SET(InteractivityType interactivityType) {
	...
	public DEFINED_TERM_SET(IsAccessibleForFree isAccessibleForFree) {
	...
	public DEFINED_TERM_SET(IsBasedOn isBasedOn) {
	...
	public DEFINED_TERM_SET(IsFamilyFriendly isFamilyFriendly) {
	...
	public DEFINED_TERM_SET(IsPartOf isPartOf) {
	...
	public DEFINED_TERM_SET(Keywords keywords) {
	...
	public DEFINED_TERM_SET(LearningResourceType learningResourceType) {
	...
	public DEFINED_TERM_SET(License license) {
		setLicense(license);
	}
	...
	public DEFINED_TERM_SET(LocationCreated locationCreated) {
	...
	public DEFINED_TERM_SET(MainEntity mainEntity) {
	...
	public DEFINED_TERM_SET(MainEntityOfPage mainEntityOfPage) {
	...
	public DEFINED_TERM_SET(Material material) {
	...
	public DEFINED_TERM_SET(MaterialExtent materialExtent) {
	...
	public DEFINED_TERM_SET(Mentions mentions) {
	...
	public DEFINED_TERM_SET(Name name) {
		setName(name);
	}
	...
	public DEFINED_TERM_SET(NameFuzzy nameFuzzy) {
	...
	public DEFINED_TERM_SET(NameRuby nameRuby) {
	...
	public DEFINED_TERM_SET(Offers offers) {
		setOffers(offers);
	}
	...
	public DEFINED_TERM_SET(Position position) {
	...
	public DEFINED_TERM_SET(PotentialAction potentialAction) {
	...
	public DEFINED_TERM_SET(Producer producer) {
	...
	public DEFINED_TERM_SET(Provider provider) {
	...
	public DEFINED_TERM_SET(Publication publication) {
	...
	public DEFINED_TERM_SET(Publisher publisher) {
	...
	public DEFINED_TERM_SET(PublisherImprint publisherImprint) {
	...
	public DEFINED_TERM_SET(PublishingPrinciples publishingPrinciples) {
	...
	public DEFINED_TERM_SET(RecordedAt recordedAt) {
	...
	public DEFINED_TERM_SET(ReleasedEvent releasedEvent) {
	...
	public DEFINED_TERM_SET(Review review) {
		setReview(review);
	}
	...
	public DEFINED_TERM_SET(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public DEFINED_TERM_SET(SchemaVersion schemaVersion) {
	...
	public DEFINED_TERM_SET(SdDatePublished sdDatePublished) {
	...
	public DEFINED_TERM_SET(SdLicense sdLicense) {
	...
	public DEFINED_TERM_SET(SdPublisher sdPublisher) {
	...
	public DEFINED_TERM_SET(SourceOrganization sourceOrganization) {
	...
	public DEFINED_TERM_SET(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public DEFINED_TERM_SET(SpatialCoverage spatialCoverage) {
	...
	public DEFINED_TERM_SET(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public DEFINED_TERM_SET(SubjectOf subjectOf) {
	...
	public DEFINED_TERM_SET(Temporal temporal) {
	...
	public DEFINED_TERM_SET(TemporalCoverage temporalCoverage) {
	...
	public DEFINED_TERM_SET(Text text) {
		setText(text);
	}
	...
	public DEFINED_TERM_SET(ThumbnailUrl thumbnailUrl) {
	...
	public DEFINED_TERM_SET(TimeRequired timeRequired) {
	...
	public DEFINED_TERM_SET(TranslationOfWork translationOfWork) {
	...
	public DEFINED_TERM_SET(Translator translator) {
	...
	public DEFINED_TERM_SET(TypicalAgeRange typicalAgeRange) {
	...
	public DEFINED_TERM_SET(Url url) {
		setUrl(url);
	}
	...
	public DEFINED_TERM_SET(Version version) {
		setVersion(version);
	}
	...
	public DEFINED_TERM_SET(Video video) {
		setVideo(video);
	}
	...
	public DEFINED_TERM_SET(WorkExample workExample) {
	...
	public DEFINED_TERM_SET(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.DefinedTermSet org) {
		setSeq(org.getSeq());
