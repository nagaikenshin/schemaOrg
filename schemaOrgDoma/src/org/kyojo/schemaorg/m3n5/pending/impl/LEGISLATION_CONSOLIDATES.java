...
public class LEGISLATION_CONSOLIDATES implements Container.LegislationConsolidates {
	...
	public LEGISLATION_CONSOLIDATES() {
	}

	public LEGISLATION_CONSOLIDATES(String string) {
	...
	public LEGISLATION_CONSOLIDATES(Legislation legislation) {
		legislationList = new ArrayList<Legislation>();
	...
	public LEGISLATION_CONSOLIDATES(LegislationObject legislationObject) {
	...
	public LEGISLATION_CONSOLIDATES(List<Legislation> legislationList,
	...
	public void copy(Container.LegislationConsolidates org) {
