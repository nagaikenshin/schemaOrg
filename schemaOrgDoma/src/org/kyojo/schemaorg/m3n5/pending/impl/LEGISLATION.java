...
import org.kyojo.schemaorg.m3n5.pending.Container.LegislationDateVersion;
...
import org.kyojo.schemaorg.m3n5.pending.Container.LegislationResponsible;
...
public class LEGISLATION implements Clazz.Legislation {
	...
	public LEGISLATION(Correction correction) {
	...
	public LEGISLATION(EncodingFormat encodingFormat) {
	...
	public LEGISLATION(LegislationJurisdiction legislationJurisdiction) {
	...
	public LEGISLATION(MaterialExtent materialExtent) {
	...
	public LEGISLATION(SdDatePublished sdDatePublished) {
	...
	public LEGISLATION(SdLicense sdLicense) {
	...
	public LEGISLATION(SdPublisher sdPublisher) {
	...
	public LEGISLATION(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public LEGISLATION(SubjectOf subjectOf) {
	...
	public LEGISLATION(Temporal temporal) {
