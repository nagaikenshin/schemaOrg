...
import org.kyojo.schemaorg.m3n5.pending.impl.DEFINED_TERM;
...
public class HAS_DEFINED_TERM implements Container.HasDefinedTerm {
	...
	public HAS_DEFINED_TERM(String string) {
		this(new DEFINED_TERM(string));
	}

	public String getString() {
		if(definedTermList == null || definedTermList.size() == 0 || definedTermList.get(0) == null) {
			return null;
		} else {
			Name name = definedTermList.get(0).getName();
	...
	public void setString(String string) {
		...
		if(definedTermList.size() == 0) {
			definedTermList.add(new DEFINED_TERM(string));
		} else {
			definedTermList.set(0, new DEFINED_TERM(string));
		}
	}

	public HAS_DEFINED_TERM(APIReference apiReference) {
	...
	public HAS_DEFINED_TERM(AboutPage aboutPage) {
	...
	public HAS_DEFINED_TERM(AdvertiserContentArticle advertiserContentArticle) {
	...
	public HAS_DEFINED_TERM(AnalysisNewsArticle analysisNewsArticle) {
	...
	public HAS_DEFINED_TERM(Answer answer) {
	...
	public HAS_DEFINED_TERM(ArchiveComponent archiveComponent) {
	...
	public HAS_DEFINED_TERM(Article article) {
	...
	public HAS_DEFINED_TERM(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public HAS_DEFINED_TERM(Atlas atlas) {
	...
	public HAS_DEFINED_TERM(AudioObject audioObject) {
	...
	public HAS_DEFINED_TERM(Audiobook audiobook) {
	...
	public HAS_DEFINED_TERM(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public HAS_DEFINED_TERM(Barcode barcode) {
	...
	public HAS_DEFINED_TERM(Blog blog) {
	...
	public HAS_DEFINED_TERM(BlogPosting blogPosting) {
	...
	public HAS_DEFINED_TERM(Book book) {
	...
	public HAS_DEFINED_TERM(BookSeries bookSeries) {
	...
	public HAS_DEFINED_TERM(CategoryCode categoryCode) {
	...
	public HAS_DEFINED_TERM(CategoryCodeSet categoryCodeSet) {
	...
	public HAS_DEFINED_TERM(Chapter chapter) {
	...
	public HAS_DEFINED_TERM(CheckoutPage checkoutPage) {
	...
	public HAS_DEFINED_TERM(Claim claim) {
	...
	public HAS_DEFINED_TERM(ClaimReview claimReview) {
	...
	public HAS_DEFINED_TERM(Clip clip) {
	...
	public HAS_DEFINED_TERM(Collection collection) {
	...
	public HAS_DEFINED_TERM(CollectionPage collectionPage) {
	...
	public HAS_DEFINED_TERM(ComicCoverArt comicCoverArt) {
	...
	public HAS_DEFINED_TERM(ComicIssue comicIssue) {
	...
	public HAS_DEFINED_TERM(ComicSeries comicSeries) {
	...
	public HAS_DEFINED_TERM(ComicStory comicStory) {
	...
	public HAS_DEFINED_TERM(Comment comment) {
	...
	public HAS_DEFINED_TERM(CompleteDataFeed completeDataFeed) {
	...
	public HAS_DEFINED_TERM(ContactPage contactPage) {
	...
	public HAS_DEFINED_TERM(Conversation conversation) {
	...
	public HAS_DEFINED_TERM(CorrectionComment correctionComment) {
	...
	public HAS_DEFINED_TERM(Course course) {
	...
	public HAS_DEFINED_TERM(CoverArt coverArt) {
	...
	public HAS_DEFINED_TERM(CreativeWorkSeason creativeWorkSeason) {
	...
	public HAS_DEFINED_TERM(CreativeWorkSeries creativeWorkSeries) {
	...
	public HAS_DEFINED_TERM(CriticReview criticReview) {
	...
	public HAS_DEFINED_TERM(DataCatalog dataCatalog) {
	...
	public HAS_DEFINED_TERM(DataDownload dataDownload) {
	...
	public HAS_DEFINED_TERM(DataFeed dataFeed) {
	...
	public HAS_DEFINED_TERM(Dataset dataset) {
	...
	public HAS_DEFINED_TERM(DefinedTermSet definedTermSet) {
	...
	public HAS_DEFINED_TERM(Diet diet) {
	...
	public HAS_DEFINED_TERM(DigitalDocument digitalDocument) {
	...
	public HAS_DEFINED_TERM(DiscussionForumPosting discussionForumPosting) {
	...
	public HAS_DEFINED_TERM(Drawing drawing) {
	...
	public HAS_DEFINED_TERM(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public HAS_DEFINED_TERM(EmailMessage emailMessage) {
	...
	public HAS_DEFINED_TERM(EmployerReview employerReview) {
	...
	public HAS_DEFINED_TERM(Episode episode) {
	...
	public HAS_DEFINED_TERM(ExercisePlan exercisePlan) {
	...
	public HAS_DEFINED_TERM(FAQPage faqPage) {
	...
	public HAS_DEFINED_TERM(Game game) {
	...
	public HAS_DEFINED_TERM(HowTo howTo) {
	...
	public HAS_DEFINED_TERM(HowToDirection howToDirection) {
	...
	public HAS_DEFINED_TERM(HowToSection howToSection) {
	...
	public HAS_DEFINED_TERM(HowToStep howToStep) {
	...
	public HAS_DEFINED_TERM(HowToTip howToTip) {
	...
	public HAS_DEFINED_TERM(ImageGallery imageGallery) {
	...
	public HAS_DEFINED_TERM(ImageObject imageObject) {
	...
	public HAS_DEFINED_TERM(ItemPage itemPage) {
	...
	public HAS_DEFINED_TERM(Legislation legislation) {
	...
	public HAS_DEFINED_TERM(LegislationObject legislationObject) {
	...
	public HAS_DEFINED_TERM(LiveBlogPosting liveBlogPosting) {
	...
	public HAS_DEFINED_TERM(Manuscript manuscript) {
	...
	public HAS_DEFINED_TERM(Map map) {
	...
	public HAS_DEFINED_TERM(MediaObject mediaObject) {
	...
	public HAS_DEFINED_TERM(MedicalCode medicalCode) {
	...
	public HAS_DEFINED_TERM(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public HAS_DEFINED_TERM(MedicalWebPage medicalWebPage) {
	...
	public HAS_DEFINED_TERM(Menu menu) {
	...
	public HAS_DEFINED_TERM(MenuSection menuSection) {
	...
	public HAS_DEFINED_TERM(Message message) {
	...
	public HAS_DEFINED_TERM(MobileApplication mobileApplication) {
	...
	public HAS_DEFINED_TERM(Movie movie) {
	...
	public HAS_DEFINED_TERM(MovieClip movieClip) {
	...
	public HAS_DEFINED_TERM(MovieSeries movieSeries) {
	...
	public HAS_DEFINED_TERM(MusicAlbum musicAlbum) {
	...
	public HAS_DEFINED_TERM(MusicComposition musicComposition) {
	...
	public HAS_DEFINED_TERM(MusicPlaylist musicPlaylist) {
	...
	public HAS_DEFINED_TERM(MusicRecording musicRecording) {
	...
	public HAS_DEFINED_TERM(MusicRelease musicRelease) {
	...
	public HAS_DEFINED_TERM(MusicVideoObject musicVideoObject) {
	...
	public HAS_DEFINED_TERM(NewsArticle newsArticle) {
	...
	public HAS_DEFINED_TERM(Newspaper newspaper) {
	...
	public HAS_DEFINED_TERM(NoteDigitalDocument noteDigitalDocument) {
	...
	public HAS_DEFINED_TERM(OpinionNewsArticle opinionNewsArticle) {
	...
	public HAS_DEFINED_TERM(Painting painting) {
	...
	public HAS_DEFINED_TERM(Periodical periodical) {
	...
	public HAS_DEFINED_TERM(Photograph photograph) {
	...
	public HAS_DEFINED_TERM(Play play) {
	...
	public HAS_DEFINED_TERM(Poster poster) {
	...
	public HAS_DEFINED_TERM(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public HAS_DEFINED_TERM(ProfilePage profilePage) {
	...
	public HAS_DEFINED_TERM(PublicationIssue publicationIssue) {
	...
	public HAS_DEFINED_TERM(PublicationVolume publicationVolume) {
	...
	public HAS_DEFINED_TERM(QAPage qaPage) {
	...
	public HAS_DEFINED_TERM(Question question) {
	...
	public HAS_DEFINED_TERM(Quotation quotation) {
	...
	public HAS_DEFINED_TERM(RadioClip radioClip) {
	...
	public HAS_DEFINED_TERM(RadioEpisode radioEpisode) {
	...
	public HAS_DEFINED_TERM(RadioSeason radioSeason) {
	...
	public HAS_DEFINED_TERM(RadioSeries radioSeries) {
	...
	public HAS_DEFINED_TERM(Recipe recipe) {
	...
	public HAS_DEFINED_TERM(Report report) {
	...
	public HAS_DEFINED_TERM(ReportageNewsArticle reportageNewsArticle) {
	...
	public HAS_DEFINED_TERM(Review review) {
	...
	public HAS_DEFINED_TERM(ReviewNewsArticle reviewNewsArticle) {
	...
	public HAS_DEFINED_TERM(SatiricalArticle satiricalArticle) {
	...
	public HAS_DEFINED_TERM(ScholarlyArticle scholarlyArticle) {
	...
	public HAS_DEFINED_TERM(Sculpture sculpture) {
	...
	public HAS_DEFINED_TERM(SearchResultsPage searchResultsPage) {
	...
	public HAS_DEFINED_TERM(SheetMusic sheetMusic) {
	...
	public HAS_DEFINED_TERM(ShortStory shortStory) {
	...
	public HAS_DEFINED_TERM(SiteNavigationElement siteNavigationElement) {
	...
	public HAS_DEFINED_TERM(SocialMediaPosting socialMediaPosting) {
	...
	public HAS_DEFINED_TERM(SoftwareApplication softwareApplication) {
	...
	public HAS_DEFINED_TERM(SoftwareSourceCode softwareSourceCode) {
	...
	public HAS_DEFINED_TERM(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public HAS_DEFINED_TERM(TVClip tvClip) {
	...
	public HAS_DEFINED_TERM(TVEpisode tvEpisode) {
	...
	public HAS_DEFINED_TERM(TVSeason tvSeason) {
	...
	public HAS_DEFINED_TERM(TVSeries tvSeries) {
	...
	public HAS_DEFINED_TERM(Table table) {
	...
	public HAS_DEFINED_TERM(TechArticle techArticle) {
	...
	public HAS_DEFINED_TERM(TextDigitalDocument textDigitalDocument) {
	...
	public HAS_DEFINED_TERM(Thesis thesis) {
	...
	public HAS_DEFINED_TERM(ThreeDimensionalModel threeDimensionalModel) {
	...
	public HAS_DEFINED_TERM(UserReview userReview) {
	...
	public HAS_DEFINED_TERM(VideoGallery videoGallery) {
	...
	public HAS_DEFINED_TERM(VideoGame videoGame) {
	...
	public HAS_DEFINED_TERM(VideoGameClip videoGameClip) {
	...
	public HAS_DEFINED_TERM(VideoGameSeries videoGameSeries) {
	...
	public HAS_DEFINED_TERM(VideoObject videoObject) {
	...
	public HAS_DEFINED_TERM(VisualArtwork visualArtwork) {
	...
	public HAS_DEFINED_TERM(WPAdBlock wpAdBlock) {
	...
	public HAS_DEFINED_TERM(WPFooter wpFooter) {
	...
	public HAS_DEFINED_TERM(WPHeader wpHeader) {
	...
	public HAS_DEFINED_TERM(WPSideBar wpSideBar) {
	...
	public HAS_DEFINED_TERM(WebApplication webApplication) {
	...
	public HAS_DEFINED_TERM(WebPage webPage) {
	...
	public HAS_DEFINED_TERM(WebPageElement webPageElement) {
	...
	public HAS_DEFINED_TERM(WebSite webSite) {
