...
public class COMPLETE_DATA_FEED implements Clazz.CompleteDataFeed {
	...
	public DataFeedElement dataFeedElement;
	...
	public IncludedInDataCatalog includedInDataCatalog;
	...
	public Url url;
	public VariableMeasured variableMeasured;
	public Version version;
	public Video video;
	public WorkExample workExample;
	public WorkTranslation workTranslation;

	public COMPLETE_DATA_FEED() {
	}

	public COMPLETE_DATA_FEED(Long seq) {
		setSeq(seq);
	}

	public COMPLETE_DATA_FEED(String string) {
	...
	public COMPLETE_DATA_FEED(About about) {
		setAbout(about);
	}
	...
	public COMPLETE_DATA_FEED(AccessMode accessMode) {
	...
	public COMPLETE_DATA_FEED(AccessModeSufficient accessModeSufficient) {
	...
	public COMPLETE_DATA_FEED(AccessibilityAPI accessibilityAPI) {
	...
	public COMPLETE_DATA_FEED(AccessibilityControl accessibilityControl) {
	...
	public COMPLETE_DATA_FEED(AccessibilityFeature accessibilityFeature) {
	...
	public COMPLETE_DATA_FEED(AccessibilityHazard accessibilityHazard) {
	...
	public COMPLETE_DATA_FEED(AccessibilitySummary accessibilitySummary) {
	...
	public COMPLETE_DATA_FEED(AccountablePerson accountablePerson) {
	...
	public COMPLETE_DATA_FEED(AdditionalType additionalType) {
	...
	public COMPLETE_DATA_FEED(AggregateRating aggregateRating) {
	...
	public COMPLETE_DATA_FEED(AlternateName alternateName) {
	...
	public COMPLETE_DATA_FEED(AlternativeHeadline alternativeHeadline) {
	...
	public COMPLETE_DATA_FEED(AssociatedMedia associatedMedia) {
	...
	public COMPLETE_DATA_FEED(Audience audience) {
	...
	public COMPLETE_DATA_FEED(Audio audio) {
		setAudio(audio);
	}
	...
	public COMPLETE_DATA_FEED(Author author) {
		setAuthor(author);
	}
	...
	public COMPLETE_DATA_FEED(Award award) {
		setAward(award);
	}
	...
	public COMPLETE_DATA_FEED(Character character) {
	...
	public COMPLETE_DATA_FEED(Citation citation) {
	...
	public COMPLETE_DATA_FEED(Comment comment) {
		setComment(comment);
	}
	...
	public COMPLETE_DATA_FEED(CommentCount commentCount) {
	...
	public COMPLETE_DATA_FEED(ContentLocation contentLocation) {
	...
	public COMPLETE_DATA_FEED(ContentRating contentRating) {
	...
	public COMPLETE_DATA_FEED(ContentReferenceTime contentReferenceTime) {
	...
	public COMPLETE_DATA_FEED(Contributor contributor) {
	...
	public COMPLETE_DATA_FEED(CopyrightHolder copyrightHolder) {
	...
	public COMPLETE_DATA_FEED(CopyrightYear copyrightYear) {
	...
	public COMPLETE_DATA_FEED(Correction correction) {
	...
	public COMPLETE_DATA_FEED(Creator creator) {
		setCreator(creator);
	}
	...
	public COMPLETE_DATA_FEED(DataFeedElement dataFeedElement) {
		setDataFeedElement(dataFeedElement);
	}

	@Override
	public DataFeedElement getDataFeedElement() {
		return dataFeedElement;
	}

	@Override
	public void setDataFeedElement(DataFeedElement dataFeedElement) {
		this.dataFeedElement = dataFeedElement;
	}

	public COMPLETE_DATA_FEED(DateCreated dateCreated) {
	...
	public COMPLETE_DATA_FEED(DateModified dateModified) {
	...
	public COMPLETE_DATA_FEED(DatePublished datePublished) {
	...
	public COMPLETE_DATA_FEED(Description description) {
	...
	public COMPLETE_DATA_FEED(DisambiguatingDescription disambiguatingDescription) {
	...
	public COMPLETE_DATA_FEED(DiscussionUrl discussionUrl) {
	...
	public COMPLETE_DATA_FEED(Distribution distribution) {
	...
	public COMPLETE_DATA_FEED(Editor editor) {
		setEditor(editor);
	}
	...
	public COMPLETE_DATA_FEED(EducationalAlignment educationalAlignment) {
	...
	public COMPLETE_DATA_FEED(EducationalUse educationalUse) {
	...
	public COMPLETE_DATA_FEED(Encoding encoding) {
	...
	public COMPLETE_DATA_FEED(EncodingFormat encodingFormat) {
	...
	public COMPLETE_DATA_FEED(ExampleOfWork exampleOfWork) {
	...
	public COMPLETE_DATA_FEED(Expires expires) {
		setExpires(expires);
	}
	...
	public COMPLETE_DATA_FEED(Funder funder) {
		setFunder(funder);
	}
	...
	public COMPLETE_DATA_FEED(Genre genre) {
		setGenre(genre);
	}
	...
	public COMPLETE_DATA_FEED(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public COMPLETE_DATA_FEED(Headline headline) {
	...
	public COMPLETE_DATA_FEED(Identifier identifier) {
	...
	public COMPLETE_DATA_FEED(Image image) {
		setImage(image);
	}
	...
	public COMPLETE_DATA_FEED(InLanguage inLanguage) {
	...
	public COMPLETE_DATA_FEED(IncludedInDataCatalog includedInDataCatalog) {
		setIncludedInDataCatalog(includedInDataCatalog);
	}

	@Override
	public IncludedInDataCatalog getIncludedInDataCatalog() {
		return includedInDataCatalog;
	}

	@Override
	public void setIncludedInDataCatalog(IncludedInDataCatalog includedInDataCatalog) {
		this.includedInDataCatalog = includedInDataCatalog;
	}

	public COMPLETE_DATA_FEED(InteractionStatistic interactionStatistic) {
	...
	public COMPLETE_DATA_FEED(InteractivityType interactivityType) {
	...
	public COMPLETE_DATA_FEED(IsAccessibleForFree isAccessibleForFree) {
	...
	public COMPLETE_DATA_FEED(IsBasedOn isBasedOn) {
	...
	public COMPLETE_DATA_FEED(IsFamilyFriendly isFamilyFriendly) {
	...
	public COMPLETE_DATA_FEED(IsPartOf isPartOf) {
	...
	public COMPLETE_DATA_FEED(Issn issn) {
		setIssn(issn);
	}
	...
	public COMPLETE_DATA_FEED(Keywords keywords) {
	...
	public COMPLETE_DATA_FEED(LearningResourceType learningResourceType) {
	...
	public COMPLETE_DATA_FEED(License license) {
		setLicense(license);
	}
	...
	public COMPLETE_DATA_FEED(LocationCreated locationCreated) {
	...
	public COMPLETE_DATA_FEED(MainEntity mainEntity) {
	...
	public COMPLETE_DATA_FEED(MainEntityOfPage mainEntityOfPage) {
	...
	public COMPLETE_DATA_FEED(Material material) {
	...
	public COMPLETE_DATA_FEED(MaterialExtent materialExtent) {
	...
	public COMPLETE_DATA_FEED(MeasurementTechnique measurementTechnique) {
	...
	public COMPLETE_DATA_FEED(Mentions mentions) {
	...
	public COMPLETE_DATA_FEED(Name name) {
		setName(name);
	}
	...
	public COMPLETE_DATA_FEED(NameFuzzy nameFuzzy) {
	...
	public COMPLETE_DATA_FEED(NameRuby nameRuby) {
	...
	public COMPLETE_DATA_FEED(Offers offers) {
		setOffers(offers);
	}
	...
	public COMPLETE_DATA_FEED(Position position) {
	...
	public COMPLETE_DATA_FEED(PotentialAction potentialAction) {
	...
	public COMPLETE_DATA_FEED(Producer producer) {
	...
	public COMPLETE_DATA_FEED(Provider provider) {
	...
	public COMPLETE_DATA_FEED(Publication publication) {
	...
	public COMPLETE_DATA_FEED(Publisher publisher) {
	...
	public COMPLETE_DATA_FEED(PublisherImprint publisherImprint) {
	...
	public COMPLETE_DATA_FEED(PublishingPrinciples publishingPrinciples) {
	...
	public COMPLETE_DATA_FEED(RecordedAt recordedAt) {
	...
	public COMPLETE_DATA_FEED(ReleasedEvent releasedEvent) {
	...
	public COMPLETE_DATA_FEED(Review review) {
		setReview(review);
	}
	...
	public COMPLETE_DATA_FEED(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public COMPLETE_DATA_FEED(SchemaVersion schemaVersion) {
	...
	public COMPLETE_DATA_FEED(SdDatePublished sdDatePublished) {
	...
	public COMPLETE_DATA_FEED(SdLicense sdLicense) {
	...
	public COMPLETE_DATA_FEED(SdPublisher sdPublisher) {
	...
	public COMPLETE_DATA_FEED(SourceOrganization sourceOrganization) {
	...
	public COMPLETE_DATA_FEED(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public COMPLETE_DATA_FEED(SpatialCoverage spatialCoverage) {
	...
	public COMPLETE_DATA_FEED(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public COMPLETE_DATA_FEED(SubjectOf subjectOf) {
	...
	public COMPLETE_DATA_FEED(Temporal temporal) {
	...
	public COMPLETE_DATA_FEED(TemporalCoverage temporalCoverage) {
	...
	public COMPLETE_DATA_FEED(Text text) {
		setText(text);
	}
	...
	public COMPLETE_DATA_FEED(ThumbnailUrl thumbnailUrl) {
	...
	public COMPLETE_DATA_FEED(TimeRequired timeRequired) {
	...
	public COMPLETE_DATA_FEED(TranslationOfWork translationOfWork) {
	...
	public COMPLETE_DATA_FEED(Translator translator) {
	...
	public COMPLETE_DATA_FEED(TypicalAgeRange typicalAgeRange) {
	...
	public COMPLETE_DATA_FEED(Url url) {
		setUrl(url);
	}
	...
	public COMPLETE_DATA_FEED(VariableMeasured variableMeasured) {
	...
	public COMPLETE_DATA_FEED(Version version) {
		setVersion(version);
	}
	...
	public COMPLETE_DATA_FEED(Video video) {
		setVideo(video);
	}
	...
	public COMPLETE_DATA_FEED(WorkExample workExample) {
	...
	public COMPLETE_DATA_FEED(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.CompleteDataFeed org) {
		setSeq(org.getSeq());
		...
		setDataFeedElement(org.getDataFeedElement());
		...
		setDistribution(org.getDistribution());
		...
		setIncludedInDataCatalog(org.getIncludedInDataCatalog());
		...
		setUrl(org.getUrl());
		setVariableMeasured(org.getVariableMeasured());
