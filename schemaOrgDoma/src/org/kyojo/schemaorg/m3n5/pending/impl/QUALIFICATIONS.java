...
public class QUALIFICATIONS implements Container.Qualifications {
	...
	public QUALIFICATIONS(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public QUALIFICATIONS(Text text) {
	...
	public QUALIFICATIONS(List<EducationalOccupationalCredential> educationalOccupationalCredentialList,
			List<Text> textList) {
		setEducationalOccupationalCredentialList(educationalOccupationalCredentialList);
		setTextList(textList);
	}

	public void copy(Container.Qualifications org) {
