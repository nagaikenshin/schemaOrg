...
public class SD_LICENSE implements Container.SdLicense {
	...
	public SD_LICENSE(String string) {
	...
	public SD_LICENSE(APIReference apiReference) {
	...
	public SD_LICENSE(AboutPage aboutPage) {
	...
	public SD_LICENSE(AdvertiserContentArticle advertiserContentArticle) {
	...
	public SD_LICENSE(AnalysisNewsArticle analysisNewsArticle) {
	...
	public SD_LICENSE(Answer answer) {
	...
	public SD_LICENSE(ArchiveComponent archiveComponent) {
	...
	public SD_LICENSE(Article article) {
	...
	public SD_LICENSE(AskPublicNewsArticle askPublicNewsArticle) {
	...
	public SD_LICENSE(AudioObject audioObject) {
	...
	public SD_LICENSE(Audiobook audiobook) {
	...
	public SD_LICENSE(BackgroundNewsArticle backgroundNewsArticle) {
	...
	public SD_LICENSE(Barcode barcode) {
	...
	public SD_LICENSE(BlogPosting blogPosting) {
	...
	public SD_LICENSE(BookSeries bookSeries) {
	...
	public SD_LICENSE(CategoryCodeSet categoryCodeSet) {
	...
	public SD_LICENSE(Chapter chapter) {
	...
	public SD_LICENSE(CheckoutPage checkoutPage) {
	...
	public SD_LICENSE(ClaimReview claimReview) {
	...
	public SD_LICENSE(Collection collection) {
	...
	public SD_LICENSE(CollectionPage collectionPage) {
	...
	public SD_LICENSE(ComicCoverArt comicCoverArt) {
	...
	public SD_LICENSE(ComicIssue comicIssue) {
	...
	public SD_LICENSE(ComicSeries comicSeries) {
	...
	public SD_LICENSE(ComicStory comicStory) {
	...
	public SD_LICENSE(Comment comment) {
	...
	public SD_LICENSE(CompleteDataFeed completeDataFeed) {
	...
	public SD_LICENSE(ContactPage contactPage) {
	...
	public SD_LICENSE(Conversation conversation) {
	...
	public SD_LICENSE(CorrectionComment correctionComment) {
	...
	public SD_LICENSE(Course course) {
	...
	public SD_LICENSE(CoverArt coverArt) {
	...
	public SD_LICENSE(CreativeWork creativeWork) {
	...
	public SD_LICENSE(CreativeWorkSeason creativeWorkSeason) {
	...
	public SD_LICENSE(CreativeWorkSeries creativeWorkSeries) {
	...
	public SD_LICENSE(CriticReview criticReview) {
	...
	public SD_LICENSE(DataCatalog dataCatalog) {
	...
	public SD_LICENSE(DataDownload dataDownload) {
	...
	public SD_LICENSE(DataFeed dataFeed) {
	...
	public SD_LICENSE(Dataset dataset) {
	...
	public SD_LICENSE(DefinedTermSet definedTermSet) {
	...
	public SD_LICENSE(DigitalDocument digitalDocument) {
	...
	public SD_LICENSE(DiscussionForumPosting discussionForumPosting) {
	...
	public SD_LICENSE(Drawing drawing) {
	...
	public SD_LICENSE(EducationalOccupationalCredential educationalOccupationalCredential) {
	...
	public SD_LICENSE(EmailMessage emailMessage) {
	...
	public SD_LICENSE(EmployerReview employerReview) {
	...
	public SD_LICENSE(Episode episode) {
	...
	public SD_LICENSE(ExercisePlan exercisePlan) {
	...
	public SD_LICENSE(FAQPage faqPage) {
	...
	public SD_LICENSE(HowToDirection howToDirection) {
	...
	public SD_LICENSE(HowToSection howToSection) {
	...
	public SD_LICENSE(HowToStep howToStep) {
	...
	public SD_LICENSE(HowToTip howToTip) {
	...
	public SD_LICENSE(ImageGallery imageGallery) {
	...
	public SD_LICENSE(ImageObject imageObject) {
	...
	public SD_LICENSE(ItemPage itemPage) {
	...
	public SD_LICENSE(Legislation legislation) {
	...
	public SD_LICENSE(LegislationObject legislationObject) {
	...
	public SD_LICENSE(LiveBlogPosting liveBlogPosting) {
	...
	public SD_LICENSE(Manuscript manuscript) {
	...
	public SD_LICENSE(MediaObject mediaObject) {
	...
	public SD_LICENSE(MedicalScholarlyArticle medicalScholarlyArticle) {
	...
	public SD_LICENSE(MedicalWebPage medicalWebPage) {
	...
	public SD_LICENSE(MenuSection menuSection) {
	...
	public SD_LICENSE(Message message) {
	...
	public SD_LICENSE(MobileApplication mobileApplication) {
	...
	public SD_LICENSE(MovieClip movieClip) {
	...
	public SD_LICENSE(MovieSeries movieSeries) {
	...
	public SD_LICENSE(MusicAlbum musicAlbum) {
	...
	public SD_LICENSE(MusicComposition musicComposition) {
	...
	public SD_LICENSE(MusicPlaylist musicPlaylist) {
	...
	public SD_LICENSE(MusicRecording musicRecording) {
	...
	public SD_LICENSE(MusicRelease musicRelease) {
	...
	public SD_LICENSE(MusicVideoObject musicVideoObject) {
	...
	public SD_LICENSE(NewsArticle newsArticle) {
	...
	public SD_LICENSE(Newspaper newspaper) {
	...
	public SD_LICENSE(NoteDigitalDocument noteDigitalDocument) {
	...
	public SD_LICENSE(OpinionNewsArticle opinionNewsArticle) {
	...
	public SD_LICENSE(Painting painting) {
	...
	public SD_LICENSE(Periodical periodical) {
	...
	public SD_LICENSE(Photograph photograph) {
	...
	public SD_LICENSE(Poster poster) {
	...
	public SD_LICENSE(PresentationDigitalDocument presentationDigitalDocument) {
	...
	public SD_LICENSE(ProfilePage profilePage) {
	...
	public SD_LICENSE(PublicationIssue publicationIssue) {
	...
	public SD_LICENSE(PublicationVolume publicationVolume) {
	...
	public SD_LICENSE(QAPage qaPage) {
	...
	public SD_LICENSE(Question question) {
	...
	public SD_LICENSE(Quotation quotation) {
	...
	public SD_LICENSE(RadioClip radioClip) {
	...
	public SD_LICENSE(RadioEpisode radioEpisode) {
	...
	public SD_LICENSE(RadioSeason radioSeason) {
	...
	public SD_LICENSE(RadioSeries radioSeries) {
	...
	public SD_LICENSE(Recipe recipe) {
	...
	public SD_LICENSE(Report report) {
	...
	public SD_LICENSE(ReportageNewsArticle reportageNewsArticle) {
	...
	public SD_LICENSE(Review review) {
	...
	public SD_LICENSE(ReviewNewsArticle reviewNewsArticle) {
	...
	public SD_LICENSE(SatiricalArticle satiricalArticle) {
	...
	public SD_LICENSE(ScholarlyArticle scholarlyArticle) {
	...
	public SD_LICENSE(Sculpture sculpture) {
	...
	public SD_LICENSE(SearchResultsPage searchResultsPage) {
	...
	public SD_LICENSE(SheetMusic sheetMusic) {
	...
	public SD_LICENSE(ShortStory shortStory) {
	...
	public SD_LICENSE(SiteNavigationElement siteNavigationElement) {
	...
	public SD_LICENSE(SocialMediaPosting socialMediaPosting) {
	...
	public SD_LICENSE(SoftwareApplication softwareApplication) {
	...
	public SD_LICENSE(SoftwareSourceCode softwareSourceCode) {
	...
	public SD_LICENSE(SpreadsheetDigitalDocument spreadsheetDigitalDocument) {
	...
	public SD_LICENSE(TVClip tvClip) {
	...
	public SD_LICENSE(TVEpisode tvEpisode) {
	...
	public SD_LICENSE(TVSeason tvSeason) {
	...
	public SD_LICENSE(TVSeries tvSeries) {
	...
	public SD_LICENSE(TechArticle techArticle) {
	...
	public SD_LICENSE(TextDigitalDocument textDigitalDocument) {
	...
	public SD_LICENSE(Thesis thesis) {
	...
	public SD_LICENSE(ThreeDimensionalModel threeDimensionalModel) {
	...
	public SD_LICENSE(UserReview userReview) {
	...
	public SD_LICENSE(VideoGallery videoGallery) {
	...
	public SD_LICENSE(VideoGame videoGame) {
	...
	public SD_LICENSE(VideoGameClip videoGameClip) {
	...
	public SD_LICENSE(VideoGameSeries videoGameSeries) {
	...
	public SD_LICENSE(VideoObject videoObject) {
	...
	public SD_LICENSE(VisualArtwork visualArtwork) {
	...
	public SD_LICENSE(WPAdBlock wpAdBlock) {
	...
	public SD_LICENSE(WPFooter wpFooter) {
	...
	public SD_LICENSE(WPHeader wpHeader) {
	...
	public SD_LICENSE(WPSideBar wpSideBar) {
	...
	public SD_LICENSE(WebApplication webApplication) {
	...
	public SD_LICENSE(WebPage webPage) {
	...
	public SD_LICENSE(WebPageElement webPageElement) {
	...
	public SD_LICENSE(WebSite webSite) {
	...
	public void copy(Container.SdLicense org) {
