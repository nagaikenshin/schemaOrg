...
public class EDUCATIONAL_LEVEL implements Container.EducationalLevel {
	...
	public EDUCATIONAL_LEVEL(CategoryCode categoryCode) {
	...
	public EDUCATIONAL_LEVEL(DefinedTerm definedTerm) {
	...
	public EDUCATIONAL_LEVEL(MedicalCode medicalCode) {
	...
	public EDUCATIONAL_LEVEL(String string) {
		this(new TEXT(string));
	}

	public EDUCATIONAL_LEVEL(Text text) {
	...
	public EDUCATIONAL_LEVEL(URL url) {
	...
	public EDUCATIONAL_LEVEL(List<CategoryCode> categoryCodeList,
	...
	public void copy(Container.EducationalLevel org) {
