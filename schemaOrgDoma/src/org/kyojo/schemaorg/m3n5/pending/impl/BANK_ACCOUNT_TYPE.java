...
public class BANK_ACCOUNT_TYPE implements Container.BankAccountType {
	...
	public BANK_ACCOUNT_TYPE(String string) {
		this(new TEXT(string));
	}

	public BANK_ACCOUNT_TYPE(Text text) {
	...
	public BANK_ACCOUNT_TYPE(URL url) {
	...
	public BANK_ACCOUNT_TYPE(List<Text> textList,
			List<URL> urlList) {
		setTextList(textList);
		setURLList(urlList);
	}

	public void copy(Container.BankAccountType org) {
