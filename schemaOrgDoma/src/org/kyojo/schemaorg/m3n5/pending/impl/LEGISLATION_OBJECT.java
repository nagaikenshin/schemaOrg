...
public class LEGISLATION_OBJECT implements Clazz.LegislationObject {
	...
	public LEGISLATION_OBJECT(EndTime endTime) {
		setEndTime(endTime);
	}
	...
	public LEGISLATION_OBJECT(MaterialExtent materialExtent) {
	...
	public LEGISLATION_OBJECT(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public LEGISLATION_OBJECT(StartTime startTime) {
	...
	public LEGISLATION_OBJECT(Temporal temporal) {
