...
public class INVESTMENT_FUND implements Clazz.InvestmentFund {
	...
	public INVESTMENT_FUND() {
	}

	public INVESTMENT_FUND(Long seq) {
		setSeq(seq);
	}

	public INVESTMENT_FUND(String string) {
	...
	public INVESTMENT_FUND(AdditionalType additionalType) {
	...
	public INVESTMENT_FUND(AggregateRating aggregateRating) {
	...
	public INVESTMENT_FUND(AlternateName alternateName) {
	...
	public INVESTMENT_FUND(Amount amount) {
		setAmount(amount);
	}
	...
	public INVESTMENT_FUND(AnnualPercentageRate annualPercentageRate) {
	...
	public INVESTMENT_FUND(AreaServed areaServed) {
	...
	public INVESTMENT_FUND(Audience audience) {
	...
	public INVESTMENT_FUND(AvailableChannel availableChannel) {
	...
	public INVESTMENT_FUND(Award award) {
		setAward(award);
	}
	...
	public INVESTMENT_FUND(Brand brand) {
		setBrand(brand);
	}
	...
	public INVESTMENT_FUND(Broker broker) {
		setBroker(broker);
	}
	...
	public INVESTMENT_FUND(Category category) {
	...
	public INVESTMENT_FUND(Description description) {
	...
	public INVESTMENT_FUND(DisambiguatingDescription disambiguatingDescription) {
	...
	public INVESTMENT_FUND(FeesAndCommissionsSpecification feesAndCommissionsSpecification) {
	...
	public INVESTMENT_FUND(HasOfferCatalog hasOfferCatalog) {
	...
	public INVESTMENT_FUND(HoursAvailable hoursAvailable) {
	...
	public INVESTMENT_FUND(Identifier identifier) {
	...
	public INVESTMENT_FUND(Image image) {
		setImage(image);
	}
	...
	public INVESTMENT_FUND(InterestRate interestRate) {
	...
	public INVESTMENT_FUND(IsRelatedTo isRelatedTo) {
	...
	public INVESTMENT_FUND(IsSimilarTo isSimilarTo) {
	...
	public INVESTMENT_FUND(Logo logo) {
		setLogo(logo);
	}
	...
	public INVESTMENT_FUND(MainEntityOfPage mainEntityOfPage) {
	...
	public INVESTMENT_FUND(Name name) {
		setName(name);
	}
	...
	public INVESTMENT_FUND(NameFuzzy nameFuzzy) {
	...
	public INVESTMENT_FUND(NameRuby nameRuby) {
	...
	public INVESTMENT_FUND(Offers offers) {
		setOffers(offers);
	}
	...
	public INVESTMENT_FUND(PotentialAction potentialAction) {
	...
	public INVESTMENT_FUND(Provider provider) {
	...
	public INVESTMENT_FUND(ProviderMobility providerMobility) {
	...
	public INVESTMENT_FUND(Review review) {
		setReview(review);
	}
	...
	public INVESTMENT_FUND(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public INVESTMENT_FUND(ServiceOutput serviceOutput) {
	...
	public INVESTMENT_FUND(ServiceType serviceType) {
	...
	public INVESTMENT_FUND(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public INVESTMENT_FUND(SubjectOf subjectOf) {
	...
	public INVESTMENT_FUND(TermsOfService termsOfService) {
	...
	public INVESTMENT_FUND(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.InvestmentFund org) {
		setSeq(org.getSeq());
