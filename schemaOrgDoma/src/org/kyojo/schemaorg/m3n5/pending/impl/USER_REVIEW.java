...
public class USER_REVIEW implements Clazz.UserReview {
	...
	public USER_REVIEW(Long seq) {
		setSeq(seq);
	}

	public USER_REVIEW(String string) {
	...
	public USER_REVIEW(About about) {
		setAbout(about);
	}
	...
	public USER_REVIEW(AccessMode accessMode) {
	...
	public USER_REVIEW(AccessModeSufficient accessModeSufficient) {
	...
	public USER_REVIEW(AccessibilityAPI accessibilityAPI) {
	...
	public USER_REVIEW(AccessibilityControl accessibilityControl) {
	...
	public USER_REVIEW(AccessibilityFeature accessibilityFeature) {
	...
	public USER_REVIEW(AccessibilityHazard accessibilityHazard) {
	...
	public USER_REVIEW(AccessibilitySummary accessibilitySummary) {
	...
	public USER_REVIEW(AccountablePerson accountablePerson) {
	...
	public USER_REVIEW(AdditionalType additionalType) {
	...
	public USER_REVIEW(AggregateRating aggregateRating) {
	...
	public USER_REVIEW(AlternateName alternateName) {
	...
	public USER_REVIEW(AlternativeHeadline alternativeHeadline) {
	...
	public USER_REVIEW(AssociatedMedia associatedMedia) {
	...
	public USER_REVIEW(Audience audience) {
	...
	public USER_REVIEW(Audio audio) {
		setAudio(audio);
	}
	...
	public USER_REVIEW(Author author) {
		setAuthor(author);
	}
	...
	public USER_REVIEW(Award award) {
		setAward(award);
	}
	...
	public USER_REVIEW(Character character) {
	...
	public USER_REVIEW(Citation citation) {
	...
	public USER_REVIEW(Comment comment) {
		setComment(comment);
	}
	...
	public USER_REVIEW(CommentCount commentCount) {
	...
	public USER_REVIEW(ContentLocation contentLocation) {
	...
	public USER_REVIEW(ContentRating contentRating) {
	...
	public USER_REVIEW(ContentReferenceTime contentReferenceTime) {
	...
	public USER_REVIEW(Contributor contributor) {
	...
	public USER_REVIEW(CopyrightHolder copyrightHolder) {
	...
	public USER_REVIEW(CopyrightYear copyrightYear) {
	...
	public USER_REVIEW(Correction correction) {
	...
	public USER_REVIEW(Creator creator) {
		setCreator(creator);
	}
	...
	public USER_REVIEW(DateCreated dateCreated) {
	...
	public USER_REVIEW(DateModified dateModified) {
	...
	public USER_REVIEW(DatePublished datePublished) {
	...
	public USER_REVIEW(Description description) {
	...
	public USER_REVIEW(DisambiguatingDescription disambiguatingDescription) {
	...
	public USER_REVIEW(DiscussionUrl discussionUrl) {
	...
	public USER_REVIEW(Editor editor) {
		setEditor(editor);
	}
	...
	public USER_REVIEW(EducationalAlignment educationalAlignment) {
	...
	public USER_REVIEW(EducationalUse educationalUse) {
	...
	public USER_REVIEW(Encoding encoding) {
	...
	public USER_REVIEW(EncodingFormat encodingFormat) {
	...
	public USER_REVIEW(ExampleOfWork exampleOfWork) {
	...
	public USER_REVIEW(Expires expires) {
		setExpires(expires);
	}
	...
	public USER_REVIEW(Funder funder) {
		setFunder(funder);
	}
	...
	public USER_REVIEW(Genre genre) {
		setGenre(genre);
	}
	...
	public USER_REVIEW(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public USER_REVIEW(Headline headline) {
	...
	public USER_REVIEW(Identifier identifier) {
	...
	public USER_REVIEW(Image image) {
		setImage(image);
	}
	...
	public USER_REVIEW(InLanguage inLanguage) {
	...
	public USER_REVIEW(InteractionStatistic interactionStatistic) {
	...
	public USER_REVIEW(InteractivityType interactivityType) {
	...
	public USER_REVIEW(IsAccessibleForFree isAccessibleForFree) {
	...
	public USER_REVIEW(IsBasedOn isBasedOn) {
	...
	public USER_REVIEW(IsFamilyFriendly isFamilyFriendly) {
	...
	public USER_REVIEW(IsPartOf isPartOf) {
	...
	public USER_REVIEW(ItemReviewed itemReviewed) {
	...
	public USER_REVIEW(Keywords keywords) {
	...
	public USER_REVIEW(LearningResourceType learningResourceType) {
	...
	public USER_REVIEW(License license) {
		setLicense(license);
	}
	...
	public USER_REVIEW(LocationCreated locationCreated) {
	...
	public USER_REVIEW(MainEntity mainEntity) {
	...
	public USER_REVIEW(MainEntityOfPage mainEntityOfPage) {
	...
	public USER_REVIEW(Material material) {
	...
	public USER_REVIEW(MaterialExtent materialExtent) {
	...
	public USER_REVIEW(Mentions mentions) {
	...
	public USER_REVIEW(NameFuzzy nameFuzzy) {
	...
	public USER_REVIEW(NameRuby nameRuby) {
	...
	public USER_REVIEW(Offers offers) {
		setOffers(offers);
	}
	...
	public USER_REVIEW(Position position) {
	...
	public USER_REVIEW(PotentialAction potentialAction) {
	...
	public USER_REVIEW(Producer producer) {
	...
	public USER_REVIEW(Provider provider) {
	...
	public USER_REVIEW(Publication publication) {
	...
	public USER_REVIEW(Publisher publisher) {
	...
	public USER_REVIEW(PublisherImprint publisherImprint) {
	...
	public USER_REVIEW(PublishingPrinciples publishingPrinciples) {
	...
	public USER_REVIEW(RecordedAt recordedAt) {
	...
	public USER_REVIEW(ReleasedEvent releasedEvent) {
	...
	public USER_REVIEW(Review review) {
		setReview(review);
	}
	...
	public USER_REVIEW(ReviewAspect reviewAspect) {
	...
	public USER_REVIEW(ReviewBody reviewBody) {
	...
	public USER_REVIEW(ReviewRating reviewRating) {
	...
	public USER_REVIEW(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public USER_REVIEW(SchemaVersion schemaVersion) {
	...
	public USER_REVIEW(SdDatePublished sdDatePublished) {
	...
	public USER_REVIEW(SdLicense sdLicense) {
	...
	public USER_REVIEW(SdPublisher sdPublisher) {
	...
	public USER_REVIEW(SourceOrganization sourceOrganization) {
	...
	public USER_REVIEW(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public USER_REVIEW(SpatialCoverage spatialCoverage) {
	...
	public USER_REVIEW(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public USER_REVIEW(SubjectOf subjectOf) {
	...
	public USER_REVIEW(Temporal temporal) {
	...
	public USER_REVIEW(TemporalCoverage temporalCoverage) {
	...
	public USER_REVIEW(ThumbnailUrl thumbnailUrl) {
	...
	public USER_REVIEW(TimeRequired timeRequired) {
	...
	public USER_REVIEW(TranslationOfWork translationOfWork) {
	...
	public USER_REVIEW(Translator translator) {
	...
	public USER_REVIEW(TypicalAgeRange typicalAgeRange) {
	...
	public USER_REVIEW(Version version) {
		setVersion(version);
	}
	...
	public USER_REVIEW(Video video) {
		setVideo(video);
	}
	...
	public USER_REVIEW(WorkExample workExample) {
	...
	public USER_REVIEW(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.UserReview org) {
		setSeq(org.getSeq());
