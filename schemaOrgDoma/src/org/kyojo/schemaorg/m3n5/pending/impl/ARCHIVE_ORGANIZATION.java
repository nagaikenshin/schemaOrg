...
public class ARCHIVE_ORGANIZATION implements Clazz.ArchiveOrganization {
	...
	public ArchiveHeld archiveHeld;
	...
	public ARCHIVE_ORGANIZATION() {
	}

	public ARCHIVE_ORGANIZATION(Long seq) {
		setSeq(seq);
	}

	public ARCHIVE_ORGANIZATION(String string) {
	...
	public ARCHIVE_ORGANIZATION(ActionableFeedbackPolicy actionableFeedbackPolicy) {
	...
	public ARCHIVE_ORGANIZATION(AdditionalProperty additionalProperty) {
	...
	public ARCHIVE_ORGANIZATION(AdditionalType additionalType) {
	...
	public ARCHIVE_ORGANIZATION(Address address) {
		setAddress(address);
	}
	...
	public ARCHIVE_ORGANIZATION(AggregateRating aggregateRating) {
	...
	public ARCHIVE_ORGANIZATION(AlternateName alternateName) {
	...
	public ARCHIVE_ORGANIZATION(Alumni alumni) {
		setAlumni(alumni);
	}
	...
	public ARCHIVE_ORGANIZATION(AmenityFeature amenityFeature) {
	...
	public ARCHIVE_ORGANIZATION(ArchiveHeld archiveHeld) {
		setArchiveHeld(archiveHeld);
	}

	@Override
	public ArchiveHeld getArchiveHeld() {
		return archiveHeld;
	}

	@Override
	public void setArchiveHeld(ArchiveHeld archiveHeld) {
		this.archiveHeld = archiveHeld;
	}

	public ARCHIVE_ORGANIZATION(AreaServed areaServed) {
	...
	public ARCHIVE_ORGANIZATION(Award award) {
		setAward(award);
	}
	...
	public ARCHIVE_ORGANIZATION(BranchCode branchCode) {
	...
	public ARCHIVE_ORGANIZATION(Brand brand) {
		setBrand(brand);
	}
	...
	public ARCHIVE_ORGANIZATION(ContactPoint contactPoint) {
	...
	public ARCHIVE_ORGANIZATION(ContainedInPlace containedInPlace) {
	...
	public ARCHIVE_ORGANIZATION(ContainsPlace containsPlace) {
	...
	public ARCHIVE_ORGANIZATION(CorrectionsPolicy correctionsPolicy) {
	...
	public ARCHIVE_ORGANIZATION(CurrenciesAccepted currenciesAccepted) {
	...
	public ARCHIVE_ORGANIZATION(Department department) {
	...
	public ARCHIVE_ORGANIZATION(Description description) {
	...
	public ARCHIVE_ORGANIZATION(DisambiguatingDescription disambiguatingDescription) {
	...
	public ARCHIVE_ORGANIZATION(DissolutionDate dissolutionDate) {
	...
	public ARCHIVE_ORGANIZATION(DiversityPolicy diversityPolicy) {
	...
	public ARCHIVE_ORGANIZATION(DiversityStaffingReport diversityStaffingReport) {
	...
	public ARCHIVE_ORGANIZATION(Duns duns) {
		setDuns(duns);
	}
	...
	public ARCHIVE_ORGANIZATION(Email email) {
		setEmail(email);
	}
	...
	public ARCHIVE_ORGANIZATION(Employee employee) {
	...
	public ARCHIVE_ORGANIZATION(EthicsPolicy ethicsPolicy) {
	...
	public ARCHIVE_ORGANIZATION(Event event) {
		setEvent(event);
	}
	...
	public ARCHIVE_ORGANIZATION(FaxNumber faxNumber) {
	...
	public ARCHIVE_ORGANIZATION(Founder founder) {
		setFounder(founder);
	}
	...
	public ARCHIVE_ORGANIZATION(FoundingDate foundingDate) {
	...
	public ARCHIVE_ORGANIZATION(FoundingLocation foundingLocation) {
	...
	public ARCHIVE_ORGANIZATION(Funder funder) {
		setFunder(funder);
	}
	...
	public ARCHIVE_ORGANIZATION(Geo geo) {
		setGeo(geo);
	}
	...
	public ARCHIVE_ORGANIZATION(GeoContains geoContains) {
	...
	public ARCHIVE_ORGANIZATION(GeoCoveredBy geoCoveredBy) {
	...
	public ARCHIVE_ORGANIZATION(GeoCovers geoCovers) {
	...
	public ARCHIVE_ORGANIZATION(GeoCrosses geoCrosses) {
	...
	public ARCHIVE_ORGANIZATION(GeoDisjoint geoDisjoint) {
	...
	public ARCHIVE_ORGANIZATION(GeoEquals geoEquals) {
	...
	public ARCHIVE_ORGANIZATION(GeoIntersects geoIntersects) {
	...
	public ARCHIVE_ORGANIZATION(GeoOverlaps geoOverlaps) {
	...
	public ARCHIVE_ORGANIZATION(GeoTouches geoTouches) {
	...
	public ARCHIVE_ORGANIZATION(GeoWithin geoWithin) {
	...
	public ARCHIVE_ORGANIZATION(GlobalLocationNumber globalLocationNumber) {
	...
	public ARCHIVE_ORGANIZATION(HasMap hasMap) {
		setHasMap(hasMap);
	}
	...
	public ARCHIVE_ORGANIZATION(HasOfferCatalog hasOfferCatalog) {
	...
	public ARCHIVE_ORGANIZATION(HasPOS hasPOS) {
		setHasPOS(hasPOS);
	}
	...
	public ARCHIVE_ORGANIZATION(Identifier identifier) {
	...
	public ARCHIVE_ORGANIZATION(Image image) {
		setImage(image);
	}
	...
	public ARCHIVE_ORGANIZATION(IsAccessibleForFree isAccessibleForFree) {
	...
	public ARCHIVE_ORGANIZATION(IsicV4 isicV4) {
		setIsicV4(isicV4);
	}
	...
	public ARCHIVE_ORGANIZATION(KnowsAbout knowsAbout) {
	...
	public ARCHIVE_ORGANIZATION(KnowsLanguage knowsLanguage) {
	...
	public ARCHIVE_ORGANIZATION(LegalName legalName) {
	...
	public ARCHIVE_ORGANIZATION(LeiCode leiCode) {
		setLeiCode(leiCode);
	}
	...
	public ARCHIVE_ORGANIZATION(Location location) {
	...
	public ARCHIVE_ORGANIZATION(Logo logo) {
		setLogo(logo);
	}
	...
	public ARCHIVE_ORGANIZATION(MainEntityOfPage mainEntityOfPage) {
	...
	public ARCHIVE_ORGANIZATION(MakesOffer makesOffer) {
	...
	public ARCHIVE_ORGANIZATION(MaximumAttendeeCapacity maximumAttendeeCapacity) {
	...
	public ARCHIVE_ORGANIZATION(Member member) {
		setMember(member);
	}
	...
	public ARCHIVE_ORGANIZATION(MemberOf memberOf) {
	...
	public ARCHIVE_ORGANIZATION(Naics naics) {
		setNaics(naics);
	}
	...
	public ARCHIVE_ORGANIZATION(Name name) {
		setName(name);
	}
	...
	public ARCHIVE_ORGANIZATION(NameFuzzy nameFuzzy) {
	...
	public ARCHIVE_ORGANIZATION(NameRuby nameRuby) {
	...
	public ARCHIVE_ORGANIZATION(NumberOfEmployees numberOfEmployees) {
	...
	public ARCHIVE_ORGANIZATION(OpeningHours openingHours) {
	...
	public ARCHIVE_ORGANIZATION(OpeningHoursSpecification openingHoursSpecification) {
	...
	public ARCHIVE_ORGANIZATION(OwnershipFundingInfo ownershipFundingInfo) {
	...
	public ARCHIVE_ORGANIZATION(Owns owns) {
		setOwns(owns);
	}
	...
	public ARCHIVE_ORGANIZATION(ParentOrganization parentOrganization) {
	...
	public ARCHIVE_ORGANIZATION(PaymentAccepted paymentAccepted) {
	...
	public ARCHIVE_ORGANIZATION(Photo photo) {
		setPhoto(photo);
	}
	...
	public ARCHIVE_ORGANIZATION(PotentialAction potentialAction) {
	...
	public ARCHIVE_ORGANIZATION(PriceRange priceRange) {
	...
	public ARCHIVE_ORGANIZATION(PublicAccess publicAccess) {
	...
	public ARCHIVE_ORGANIZATION(PublishingPrinciples publishingPrinciples) {
	...
	public ARCHIVE_ORGANIZATION(Review review) {
		setReview(review);
	}
	...
	public ARCHIVE_ORGANIZATION(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ARCHIVE_ORGANIZATION(Seeks seeks) {
		setSeeks(seeks);
	}
	...
	public ARCHIVE_ORGANIZATION(Slogan slogan) {
		setSlogan(slogan);
	}
	...
	public ARCHIVE_ORGANIZATION(SmokingAllowed smokingAllowed) {
	...
	public ARCHIVE_ORGANIZATION(SpecialOpeningHoursSpecification specialOpeningHoursSpecification) {
	...
	public ARCHIVE_ORGANIZATION(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public ARCHIVE_ORGANIZATION(SubOrganization subOrganization) {
	...
	public ARCHIVE_ORGANIZATION(SubjectOf subjectOf) {
	...
	public ARCHIVE_ORGANIZATION(TaxID taxID) {
		setTaxID(taxID);
	}
	...
	public ARCHIVE_ORGANIZATION(Telephone telephone) {
	...
	public ARCHIVE_ORGANIZATION(UnnamedSourcesPolicy unnamedSourcesPolicy) {
	...
	public ARCHIVE_ORGANIZATION(Url url) {
		setUrl(url);
	}
	...
	public ARCHIVE_ORGANIZATION(VatID vatID) {
		setVatID(vatID);
	}
	...
	public void copy(Clazz.ArchiveOrganization org) {
		setSeq(org.getSeq());
		...
		setArchiveHeld(org.getArchiveHeld());
