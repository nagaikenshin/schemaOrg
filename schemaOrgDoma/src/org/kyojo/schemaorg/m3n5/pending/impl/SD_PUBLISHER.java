...
public class SD_PUBLISHER implements Container.SdPublisher {
	...
	public SD_PUBLISHER(String string) {
	...
	public SD_PUBLISHER(AccountingService accountingService) {
	...
	public SD_PUBLISHER(AdultEntertainment adultEntertainment) {
	...
	public SD_PUBLISHER(Airline airline) {
	...
	public SD_PUBLISHER(AmusementPark amusementPark) {
	...
	public SD_PUBLISHER(AnimalShelter animalShelter) {
	...
	public SD_PUBLISHER(ArchiveOrganization archiveOrganization) {
	...
	public SD_PUBLISHER(ArtGallery artGallery) {
	...
	public SD_PUBLISHER(Attorney attorney) {
	...
	public SD_PUBLISHER(AutoBodyShop autoBodyShop) {
	...
	public SD_PUBLISHER(AutoDealer autoDealer) {
	...
	public SD_PUBLISHER(AutoPartsStore autoPartsStore) {
	...
	public SD_PUBLISHER(AutoRental autoRental) {
	...
	public SD_PUBLISHER(AutoRepair autoRepair) {
	...
	public SD_PUBLISHER(AutoWash autoWash) {
	...
	public SD_PUBLISHER(AutomatedTeller automatedTeller) {
	...
	public SD_PUBLISHER(AutomotiveBusiness automotiveBusiness) {
	...
	public SD_PUBLISHER(Bakery bakery) {
	...
	public SD_PUBLISHER(BankOrCreditUnion bankOrCreditUnion) {
	...
	public SD_PUBLISHER(BarOrPub barOrPub) {
	...
	public SD_PUBLISHER(BeautySalon beautySalon) {
	...
	public SD_PUBLISHER(BedAndBreakfast bedAndBreakfast) {
	...
	public SD_PUBLISHER(BikeStore bikeStore) {
	...
	public SD_PUBLISHER(BookStore bookStore) {
	...
	public SD_PUBLISHER(BowlingAlley bowlingAlley) {
	...
	public SD_PUBLISHER(Brewery brewery) {
	...
	public SD_PUBLISHER(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public SD_PUBLISHER(Campground campground) {
	...
	public SD_PUBLISHER(Casino casino) {
	...
	public SD_PUBLISHER(ChildCare childCare) {
	...
	public SD_PUBLISHER(ClothingStore clothingStore) {
	...
	public SD_PUBLISHER(CollegeOrUniversity collegeOrUniversity) {
	...
	public SD_PUBLISHER(ComedyClub comedyClub) {
	...
	public SD_PUBLISHER(CommunityHealth communityHealth) {
	...
	public SD_PUBLISHER(ComputerStore computerStore) {
	...
	public SD_PUBLISHER(Consortium consortium) {
	...
	public SD_PUBLISHER(ConvenienceStore convenienceStore) {
	...
	public SD_PUBLISHER(Corporation corporation) {
	...
	public SD_PUBLISHER(DanceGroup danceGroup) {
	...
	public SD_PUBLISHER(DaySpa daySpa) {
	...
	public SD_PUBLISHER(Dentist dentist) {
	...
	public SD_PUBLISHER(DepartmentStore departmentStore) {
	...
	public SD_PUBLISHER(Dermatology dermatology) {
	...
	public SD_PUBLISHER(DiagnosticLab diagnosticLab) {
	...
	public SD_PUBLISHER(DietNutrition dietNutrition) {
	...
	public SD_PUBLISHER(Distillery distillery) {
	...
	public SD_PUBLISHER(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public SD_PUBLISHER(EducationalOrganization educationalOrganization) {
	...
	public SD_PUBLISHER(Electrician electrician) {
	...
	public SD_PUBLISHER(ElectronicsStore electronicsStore) {
	...
	public SD_PUBLISHER(ElementarySchool elementarySchool) {
	...
	public SD_PUBLISHER(Emergency emergency) {
	...
	public SD_PUBLISHER(EmergencyService emergencyService) {
	...
	public SD_PUBLISHER(EmploymentAgency employmentAgency) {
	...
	public SD_PUBLISHER(EntertainmentBusiness entertainmentBusiness) {
	...
	public SD_PUBLISHER(ExerciseGym exerciseGym) {
	...
	public SD_PUBLISHER(FastFoodRestaurant fastFoodRestaurant) {
	...
	public SD_PUBLISHER(FinancialService financialService) {
	...
	public SD_PUBLISHER(FireStation fireStation) {
	...
	public SD_PUBLISHER(Florist florist) {
	...
	public SD_PUBLISHER(FoodEstablishment foodEstablishment) {
	...
	public SD_PUBLISHER(FundingAgency fundingAgency) {
	...
	public SD_PUBLISHER(FundingScheme fundingScheme) {
	...
	public SD_PUBLISHER(FurnitureStore furnitureStore) {
	...
	public SD_PUBLISHER(GardenStore gardenStore) {
	...
	public SD_PUBLISHER(GasStation gasStation) {
	...
	public SD_PUBLISHER(GeneralContractor generalContractor) {
	...
	public SD_PUBLISHER(Geriatric geriatric) {
	...
	public SD_PUBLISHER(GolfCourse golfCourse) {
	...
	public SD_PUBLISHER(GovernmentOffice governmentOffice) {
	...
	public SD_PUBLISHER(GovernmentOrganization governmentOrganization) {
	...
	public SD_PUBLISHER(GroceryStore groceryStore) {
	...
	public SD_PUBLISHER(Gynecologic gynecologic) {
	...
	public SD_PUBLISHER(HVACBusiness hvacBusiness) {
	...
	public SD_PUBLISHER(HairSalon hairSalon) {
	...
	public SD_PUBLISHER(HardwareStore hardwareStore) {
	...
	public SD_PUBLISHER(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public SD_PUBLISHER(HealthClub healthClub) {
	...
	public SD_PUBLISHER(HighSchool highSchool) {
	...
	public SD_PUBLISHER(HobbyShop hobbyShop) {
	...
	public SD_PUBLISHER(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public SD_PUBLISHER(HomeGoodsStore homeGoodsStore) {
	...
	public SD_PUBLISHER(Hospital hospital) {
	...
	public SD_PUBLISHER(Hostel hostel) {
	...
	public SD_PUBLISHER(Hotel hotel) {
	...
	public SD_PUBLISHER(HousePainter housePainter) {
	...
	public SD_PUBLISHER(IceCreamShop iceCreamShop) {
	...
	public SD_PUBLISHER(InsuranceAgency insuranceAgency) {
	...
	public SD_PUBLISHER(InternetCafe internetCafe) {
	...
	public SD_PUBLISHER(JewelryStore jewelryStore) {
	...
	public SD_PUBLISHER(LegalService legalService) {
	...
	public SD_PUBLISHER(Library library) {
	...
	public SD_PUBLISHER(LibrarySystem librarySystem) {
	...
	public SD_PUBLISHER(LiquorStore liquorStore) {
	...
	public SD_PUBLISHER(LocalBusiness localBusiness) {
	...
	public SD_PUBLISHER(Locksmith locksmith) {
	...
	public SD_PUBLISHER(LodgingBusiness lodgingBusiness) {
	...
	public SD_PUBLISHER(MedicalBusiness medicalBusiness) {
	...
	public SD_PUBLISHER(MedicalClinic medicalClinic) {
	...
	public SD_PUBLISHER(MedicalOrganization medicalOrganization) {
	...
	public SD_PUBLISHER(MensClothingStore mensClothingStore) {
	...
	public SD_PUBLISHER(MiddleSchool middleSchool) {
	...
	public SD_PUBLISHER(Midwifery midwifery) {
	...
	public SD_PUBLISHER(MobilePhoneStore mobilePhoneStore) {
	...
	public SD_PUBLISHER(Motel motel) {
	...
	public SD_PUBLISHER(MotorcycleDealer motorcycleDealer) {
	...
	public SD_PUBLISHER(MotorcycleRepair motorcycleRepair) {
	...
	public SD_PUBLISHER(MovieRentalStore movieRentalStore) {
	...
	public SD_PUBLISHER(MovieTheater movieTheater) {
	...
	public SD_PUBLISHER(MovingCompany movingCompany) {
	...
	public SD_PUBLISHER(MusicGroup musicGroup) {
	...
	public SD_PUBLISHER(MusicStore musicStore) {
	...
	public SD_PUBLISHER(NailSalon nailSalon) {
	...
	public SD_PUBLISHER(NewsMediaOrganization newsMediaOrganization) {
	...
	public SD_PUBLISHER(NightClub nightClub) {
	...
	public SD_PUBLISHER(Notary notary) {
	...
	public SD_PUBLISHER(Nursing nursing) {
	...
	public SD_PUBLISHER(Obstetric obstetric) {
	...
	public SD_PUBLISHER(OfficeEquipmentStore officeEquipmentStore) {
	...
	public SD_PUBLISHER(Oncologic oncologic) {
	...
	public SD_PUBLISHER(Optician optician) {
	...
	public SD_PUBLISHER(Optometric optometric) {
	...
	public SD_PUBLISHER(Organization organization) {
		organizationList = new ArrayList<Organization>();
	...
	public SD_PUBLISHER(Otolaryngologic otolaryngologic) {
	...
	public SD_PUBLISHER(OutletStore outletStore) {
	...
	public SD_PUBLISHER(Patient patient) {
	...
	public SD_PUBLISHER(PawnShop pawnShop) {
	...
	public SD_PUBLISHER(Pediatric pediatric) {
	...
	public SD_PUBLISHER(PerformingGroup performingGroup) {
	...
	public SD_PUBLISHER(Person person) {
	...
	public SD_PUBLISHER(PetStore petStore) {
	...
	public SD_PUBLISHER(Pharmacy pharmacy) {
	...
	public SD_PUBLISHER(Physician physician) {
	...
	public SD_PUBLISHER(Physiotherapy physiotherapy) {
	...
	public SD_PUBLISHER(PlasticSurgery plasticSurgery) {
	...
	public SD_PUBLISHER(Plumber plumber) {
	...
	public SD_PUBLISHER(Podiatric podiatric) {
	...
	public SD_PUBLISHER(PoliceStation policeStation) {
	...
	public SD_PUBLISHER(PostOffice postOffice) {
	...
	public SD_PUBLISHER(Preschool preschool) {
	...
	public SD_PUBLISHER(PrimaryCare primaryCare) {
	...
	public SD_PUBLISHER(ProfessionalService professionalService) {
	...
	public SD_PUBLISHER(Project project) {
	...
	public SD_PUBLISHER(Psychiatric psychiatric) {
	...
	public SD_PUBLISHER(PublicHealth publicHealth) {
	...
	public SD_PUBLISHER(PublicSwimmingPool publicSwimmingPool) {
	...
	public SD_PUBLISHER(RadioStation radioStation) {
	...
	public SD_PUBLISHER(RealEstateAgent realEstateAgent) {
	...
	public SD_PUBLISHER(RecyclingCenter recyclingCenter) {
	...
	public SD_PUBLISHER(ResearchProject researchProject) {
	...
	public SD_PUBLISHER(Resort resort) {
	...
	public SD_PUBLISHER(Restaurant restaurant) {
	...
	public SD_PUBLISHER(RoofingContractor roofingContractor) {
	...
	public SD_PUBLISHER(School school) {
	...
	public SD_PUBLISHER(SelfStorage selfStorage) {
	...
	public SD_PUBLISHER(ShoeStore shoeStore) {
	...
	public SD_PUBLISHER(ShoppingCenter shoppingCenter) {
	...
	public SD_PUBLISHER(SkiResort skiResort) {
	...
	public SD_PUBLISHER(SportingGoodsStore sportingGoodsStore) {
	...
	public SD_PUBLISHER(SportsActivityLocation sportsActivityLocation) {
	...
	public SD_PUBLISHER(SportsClub sportsClub) {
	...
	public SD_PUBLISHER(SportsOrganization sportsOrganization) {
	...
	public SD_PUBLISHER(SportsTeam sportsTeam) {
	...
	public SD_PUBLISHER(StadiumOrArena stadiumOrArena) {
	...
	public SD_PUBLISHER(Store store) {
	...
	public SD_PUBLISHER(TattooParlor tattooParlor) {
	...
	public SD_PUBLISHER(TelevisionStation televisionStation) {
	...
	public SD_PUBLISHER(TennisComplex tennisComplex) {
	...
	public SD_PUBLISHER(TheaterGroup theaterGroup) {
	...
	public SD_PUBLISHER(TireShop tireShop) {
	...
	public SD_PUBLISHER(TouristInformationCenter touristInformationCenter) {
	...
	public SD_PUBLISHER(ToyStore toyStore) {
	...
	public SD_PUBLISHER(TravelAgency travelAgency) {
	...
	public SD_PUBLISHER(VeterinaryCare veterinaryCare) {
	...
	public SD_PUBLISHER(WholesaleStore wholesaleStore) {
	...
	public SD_PUBLISHER(Winery winery) {
	...
	public SD_PUBLISHER(WorkersUnion workersUnion) {
	...
	public void copy(Container.SdPublisher org) {
