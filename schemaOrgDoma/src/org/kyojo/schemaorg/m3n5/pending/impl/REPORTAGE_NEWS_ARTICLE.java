...
public class REPORTAGE_NEWS_ARTICLE implements Clazz.ReportageNewsArticle {
	...
	public REPORTAGE_NEWS_ARTICLE() {
	}

	public REPORTAGE_NEWS_ARTICLE(Long seq) {
		setSeq(seq);
	}

	public REPORTAGE_NEWS_ARTICLE(String string) {
	...
	public REPORTAGE_NEWS_ARTICLE(About about) {
		setAbout(about);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(AccessMode accessMode) {
	...
	public REPORTAGE_NEWS_ARTICLE(AccessModeSufficient accessModeSufficient) {
	...
	public REPORTAGE_NEWS_ARTICLE(AccessibilityAPI accessibilityAPI) {
	...
	public REPORTAGE_NEWS_ARTICLE(AccessibilityControl accessibilityControl) {
	...
	public REPORTAGE_NEWS_ARTICLE(AccessibilityFeature accessibilityFeature) {
	...
	public REPORTAGE_NEWS_ARTICLE(AccessibilityHazard accessibilityHazard) {
	...
	public REPORTAGE_NEWS_ARTICLE(AccessibilitySummary accessibilitySummary) {
	...
	public REPORTAGE_NEWS_ARTICLE(AccountablePerson accountablePerson) {
	...
	public REPORTAGE_NEWS_ARTICLE(AdditionalType additionalType) {
	...
	public REPORTAGE_NEWS_ARTICLE(AggregateRating aggregateRating) {
	...
	public REPORTAGE_NEWS_ARTICLE(AlternateName alternateName) {
	...
	public REPORTAGE_NEWS_ARTICLE(AlternativeHeadline alternativeHeadline) {
	...
	public REPORTAGE_NEWS_ARTICLE(ArticleBody articleBody) {
	...
	public REPORTAGE_NEWS_ARTICLE(ArticleSection articleSection) {
	...
	public REPORTAGE_NEWS_ARTICLE(AssociatedMedia associatedMedia) {
	...
	public REPORTAGE_NEWS_ARTICLE(Audience audience) {
	...
	public REPORTAGE_NEWS_ARTICLE(Audio audio) {
		setAudio(audio);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(Author author) {
		setAuthor(author);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(Award award) {
		setAward(award);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(Backstory backstory) {
	...
	public REPORTAGE_NEWS_ARTICLE(Character character) {
	...
	public REPORTAGE_NEWS_ARTICLE(Citation citation) {
	...
	public REPORTAGE_NEWS_ARTICLE(Comment comment) {
		setComment(comment);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(CommentCount commentCount) {
	...
	public REPORTAGE_NEWS_ARTICLE(ContentLocation contentLocation) {
	...
	public REPORTAGE_NEWS_ARTICLE(ContentRating contentRating) {
	...
	public REPORTAGE_NEWS_ARTICLE(ContentReferenceTime contentReferenceTime) {
	...
	public REPORTAGE_NEWS_ARTICLE(Contributor contributor) {
	...
	public REPORTAGE_NEWS_ARTICLE(CopyrightHolder copyrightHolder) {
	...
	public REPORTAGE_NEWS_ARTICLE(CopyrightYear copyrightYear) {
	...
	public REPORTAGE_NEWS_ARTICLE(Correction correction) {
	...
	public REPORTAGE_NEWS_ARTICLE(Creator creator) {
		setCreator(creator);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(DateCreated dateCreated) {
	...
	public REPORTAGE_NEWS_ARTICLE(DateModified dateModified) {
	...
	public REPORTAGE_NEWS_ARTICLE(DatePublished datePublished) {
	...
	public REPORTAGE_NEWS_ARTICLE(Dateline dateline) {
	...
	public REPORTAGE_NEWS_ARTICLE(Description description) {
	...
	public REPORTAGE_NEWS_ARTICLE(DisambiguatingDescription disambiguatingDescription) {
	...
	public REPORTAGE_NEWS_ARTICLE(DiscussionUrl discussionUrl) {
	...
	public REPORTAGE_NEWS_ARTICLE(Editor editor) {
		setEditor(editor);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(EducationalAlignment educationalAlignment) {
	...
	public REPORTAGE_NEWS_ARTICLE(EducationalUse educationalUse) {
	...
	public REPORTAGE_NEWS_ARTICLE(Encoding encoding) {
	...
	public REPORTAGE_NEWS_ARTICLE(EncodingFormat encodingFormat) {
	...
	public REPORTAGE_NEWS_ARTICLE(ExampleOfWork exampleOfWork) {
	...
	public REPORTAGE_NEWS_ARTICLE(Expires expires) {
		setExpires(expires);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(Funder funder) {
		setFunder(funder);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(Genre genre) {
		setGenre(genre);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(Headline headline) {
	...
	public REPORTAGE_NEWS_ARTICLE(Identifier identifier) {
	...
	public REPORTAGE_NEWS_ARTICLE(Image image) {
		setImage(image);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(InLanguage inLanguage) {
	...
	public REPORTAGE_NEWS_ARTICLE(InteractionStatistic interactionStatistic) {
	...
	public REPORTAGE_NEWS_ARTICLE(InteractivityType interactivityType) {
	...
	public REPORTAGE_NEWS_ARTICLE(IsAccessibleForFree isAccessibleForFree) {
	...
	public REPORTAGE_NEWS_ARTICLE(IsBasedOn isBasedOn) {
	...
	public REPORTAGE_NEWS_ARTICLE(IsFamilyFriendly isFamilyFriendly) {
	...
	public REPORTAGE_NEWS_ARTICLE(IsPartOf isPartOf) {
	...
	public REPORTAGE_NEWS_ARTICLE(Keywords keywords) {
	...
	public REPORTAGE_NEWS_ARTICLE(LearningResourceType learningResourceType) {
	...
	public REPORTAGE_NEWS_ARTICLE(License license) {
		setLicense(license);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(LocationCreated locationCreated) {
	...
	public REPORTAGE_NEWS_ARTICLE(MainEntity mainEntity) {
	...
	public REPORTAGE_NEWS_ARTICLE(MainEntityOfPage mainEntityOfPage) {
	...
	public REPORTAGE_NEWS_ARTICLE(Material material) {
	...
	public REPORTAGE_NEWS_ARTICLE(MaterialExtent materialExtent) {
	...
	public REPORTAGE_NEWS_ARTICLE(Mentions mentions) {
	...
	public REPORTAGE_NEWS_ARTICLE(Name name) {
		setName(name);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(NameFuzzy nameFuzzy) {
	...
	public REPORTAGE_NEWS_ARTICLE(NameRuby nameRuby) {
	...
	public REPORTAGE_NEWS_ARTICLE(Offers offers) {
		setOffers(offers);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(PageEnd pageEnd) {
		setPageEnd(pageEnd);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(PageStart pageStart) {
	...
	public REPORTAGE_NEWS_ARTICLE(Pagination pagination) {
	...
	public REPORTAGE_NEWS_ARTICLE(Position position) {
	...
	public REPORTAGE_NEWS_ARTICLE(PotentialAction potentialAction) {
	...
	public REPORTAGE_NEWS_ARTICLE(PrintColumn printColumn) {
	...
	public REPORTAGE_NEWS_ARTICLE(PrintEdition printEdition) {
	...
	public REPORTAGE_NEWS_ARTICLE(PrintPage printPage) {
	...
	public REPORTAGE_NEWS_ARTICLE(PrintSection printSection) {
	...
	public REPORTAGE_NEWS_ARTICLE(Producer producer) {
	...
	public REPORTAGE_NEWS_ARTICLE(Provider provider) {
	...
	public REPORTAGE_NEWS_ARTICLE(Publication publication) {
	...
	public REPORTAGE_NEWS_ARTICLE(Publisher publisher) {
	...
	public REPORTAGE_NEWS_ARTICLE(PublisherImprint publisherImprint) {
	...
	public REPORTAGE_NEWS_ARTICLE(PublishingPrinciples publishingPrinciples) {
	...
	public REPORTAGE_NEWS_ARTICLE(RecordedAt recordedAt) {
	...
	public REPORTAGE_NEWS_ARTICLE(ReleasedEvent releasedEvent) {
	...
	public REPORTAGE_NEWS_ARTICLE(Review review) {
		setReview(review);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(SchemaVersion schemaVersion) {
	...
	public REPORTAGE_NEWS_ARTICLE(SdDatePublished sdDatePublished) {
	...
	public REPORTAGE_NEWS_ARTICLE(SdLicense sdLicense) {
	...
	public REPORTAGE_NEWS_ARTICLE(SdPublisher sdPublisher) {
	...
	public REPORTAGE_NEWS_ARTICLE(SourceOrganization sourceOrganization) {
	...
	public REPORTAGE_NEWS_ARTICLE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(SpatialCoverage spatialCoverage) {
	...
	public REPORTAGE_NEWS_ARTICLE(Speakable speakable) {
	...
	public REPORTAGE_NEWS_ARTICLE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(SubjectOf subjectOf) {
	...
	public REPORTAGE_NEWS_ARTICLE(Temporal temporal) {
	...
	public REPORTAGE_NEWS_ARTICLE(TemporalCoverage temporalCoverage) {
	...
	public REPORTAGE_NEWS_ARTICLE(Text text) {
		setText(text);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(ThumbnailUrl thumbnailUrl) {
	...
	public REPORTAGE_NEWS_ARTICLE(TimeRequired timeRequired) {
	...
	public REPORTAGE_NEWS_ARTICLE(TranslationOfWork translationOfWork) {
	...
	public REPORTAGE_NEWS_ARTICLE(Translator translator) {
	...
	public REPORTAGE_NEWS_ARTICLE(TypicalAgeRange typicalAgeRange) {
	...
	public REPORTAGE_NEWS_ARTICLE(Url url) {
		setUrl(url);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(Version version) {
		setVersion(version);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(Video video) {
		setVideo(video);
	}
	...
	public REPORTAGE_NEWS_ARTICLE(WordCount wordCount) {
	...
	public REPORTAGE_NEWS_ARTICLE(WorkExample workExample) {
	...
	public REPORTAGE_NEWS_ARTICLE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.ReportageNewsArticle org) {
		setSeq(org.getSeq());
