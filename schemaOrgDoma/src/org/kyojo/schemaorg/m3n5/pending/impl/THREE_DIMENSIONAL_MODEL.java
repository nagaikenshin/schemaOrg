...
public class THREE_DIMENSIONAL_MODEL implements Clazz.ThreeDimensionalModel {
	...
	public THREE_DIMENSIONAL_MODEL() {
	}

	public THREE_DIMENSIONAL_MODEL(Long seq) {
		setSeq(seq);
	}

	public THREE_DIMENSIONAL_MODEL(String string) {
	...
	public THREE_DIMENSIONAL_MODEL(About about) {
		setAbout(about);
	}
	...
	public THREE_DIMENSIONAL_MODEL(AccessMode accessMode) {
	...
	public THREE_DIMENSIONAL_MODEL(AccessModeSufficient accessModeSufficient) {
	...
	public THREE_DIMENSIONAL_MODEL(AccessibilityAPI accessibilityAPI) {
	...
	public THREE_DIMENSIONAL_MODEL(AccessibilityControl accessibilityControl) {
	...
	public THREE_DIMENSIONAL_MODEL(AccessibilityFeature accessibilityFeature) {
	...
	public THREE_DIMENSIONAL_MODEL(AccessibilityHazard accessibilityHazard) {
	...
	public THREE_DIMENSIONAL_MODEL(AccessibilitySummary accessibilitySummary) {
	...
	public THREE_DIMENSIONAL_MODEL(AccountablePerson accountablePerson) {
	...
	public THREE_DIMENSIONAL_MODEL(AdditionalType additionalType) {
	...
	public THREE_DIMENSIONAL_MODEL(AggregateRating aggregateRating) {
	...
	public THREE_DIMENSIONAL_MODEL(AlternateName alternateName) {
	...
	public THREE_DIMENSIONAL_MODEL(AlternativeHeadline alternativeHeadline) {
	...
	public THREE_DIMENSIONAL_MODEL(AssociatedMedia associatedMedia) {
	...
	public THREE_DIMENSIONAL_MODEL(Audience audience) {
	...
	public THREE_DIMENSIONAL_MODEL(Audio audio) {
		setAudio(audio);
	}
	...
	public THREE_DIMENSIONAL_MODEL(Author author) {
		setAuthor(author);
	}
	...
	public THREE_DIMENSIONAL_MODEL(Award award) {
		setAward(award);
	}
	...
	public THREE_DIMENSIONAL_MODEL(Character character) {
	...
	public THREE_DIMENSIONAL_MODEL(Citation citation) {
	...
	public THREE_DIMENSIONAL_MODEL(Comment comment) {
		setComment(comment);
	}
	...
	public THREE_DIMENSIONAL_MODEL(CommentCount commentCount) {
	...
	public THREE_DIMENSIONAL_MODEL(ContentLocation contentLocation) {
	...
	public THREE_DIMENSIONAL_MODEL(ContentRating contentRating) {
	...
	public THREE_DIMENSIONAL_MODEL(ContentReferenceTime contentReferenceTime) {
	...
	public THREE_DIMENSIONAL_MODEL(Contributor contributor) {
	...
	public THREE_DIMENSIONAL_MODEL(CopyrightHolder copyrightHolder) {
	...
	public THREE_DIMENSIONAL_MODEL(CopyrightYear copyrightYear) {
	...
	public THREE_DIMENSIONAL_MODEL(Correction correction) {
	...
	public THREE_DIMENSIONAL_MODEL(Creator creator) {
		setCreator(creator);
	}
	...
	public THREE_DIMENSIONAL_MODEL(DateCreated dateCreated) {
	...
	public THREE_DIMENSIONAL_MODEL(DateModified dateModified) {
	...
	public THREE_DIMENSIONAL_MODEL(DatePublished datePublished) {
	...
	public THREE_DIMENSIONAL_MODEL(Description description) {
	...
	public THREE_DIMENSIONAL_MODEL(DisambiguatingDescription disambiguatingDescription) {
	...
	public THREE_DIMENSIONAL_MODEL(DiscussionUrl discussionUrl) {
	...
	public THREE_DIMENSIONAL_MODEL(Editor editor) {
		setEditor(editor);
	}
	...
	public THREE_DIMENSIONAL_MODEL(EducationalAlignment educationalAlignment) {
	...
	public THREE_DIMENSIONAL_MODEL(EducationalUse educationalUse) {
	...
	public THREE_DIMENSIONAL_MODEL(Encoding encoding) {
	...
	public THREE_DIMENSIONAL_MODEL(EncodingFormat encodingFormat) {
	...
	public THREE_DIMENSIONAL_MODEL(ExampleOfWork exampleOfWork) {
	...
	public THREE_DIMENSIONAL_MODEL(Expires expires) {
		setExpires(expires);
	}
	...
	public THREE_DIMENSIONAL_MODEL(Funder funder) {
		setFunder(funder);
	}
	...
	public THREE_DIMENSIONAL_MODEL(Genre genre) {
		setGenre(genre);
	}
	...
	public THREE_DIMENSIONAL_MODEL(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public THREE_DIMENSIONAL_MODEL(Headline headline) {
	...
	public THREE_DIMENSIONAL_MODEL(Identifier identifier) {
	...
	public THREE_DIMENSIONAL_MODEL(Image image) {
		setImage(image);
	}
	...
	public THREE_DIMENSIONAL_MODEL(InLanguage inLanguage) {
	...
	public THREE_DIMENSIONAL_MODEL(InteractionStatistic interactionStatistic) {
	...
	public THREE_DIMENSIONAL_MODEL(InteractivityType interactivityType) {
	...
	public THREE_DIMENSIONAL_MODEL(IsAccessibleForFree isAccessibleForFree) {
	...
	public THREE_DIMENSIONAL_MODEL(IsBasedOn isBasedOn) {
	...
	public THREE_DIMENSIONAL_MODEL(IsFamilyFriendly isFamilyFriendly) {
	...
	public THREE_DIMENSIONAL_MODEL(IsPartOf isPartOf) {
	...
	public THREE_DIMENSIONAL_MODEL(Keywords keywords) {
	...
	public THREE_DIMENSIONAL_MODEL(LearningResourceType learningResourceType) {
	...
	public THREE_DIMENSIONAL_MODEL(License license) {
		setLicense(license);
	}
	...
	public THREE_DIMENSIONAL_MODEL(LocationCreated locationCreated) {
	...
	public THREE_DIMENSIONAL_MODEL(MainEntity mainEntity) {
	...
	public THREE_DIMENSIONAL_MODEL(MainEntityOfPage mainEntityOfPage) {
	...
	public THREE_DIMENSIONAL_MODEL(Material material) {
	...
	public THREE_DIMENSIONAL_MODEL(MaterialExtent materialExtent) {
	...
	public THREE_DIMENSIONAL_MODEL(Mentions mentions) {
	...
	public THREE_DIMENSIONAL_MODEL(Name name) {
		setName(name);
	}
	...
	public THREE_DIMENSIONAL_MODEL(NameFuzzy nameFuzzy) {
	...
	public THREE_DIMENSIONAL_MODEL(NameRuby nameRuby) {
	...
	public THREE_DIMENSIONAL_MODEL(Offers offers) {
		setOffers(offers);
	}
	...
	public THREE_DIMENSIONAL_MODEL(Position position) {
	...
	public THREE_DIMENSIONAL_MODEL(PotentialAction potentialAction) {
	...
	public THREE_DIMENSIONAL_MODEL(Producer producer) {
	...
	public THREE_DIMENSIONAL_MODEL(Provider provider) {
	...
	public THREE_DIMENSIONAL_MODEL(Publication publication) {
	...
	public THREE_DIMENSIONAL_MODEL(Publisher publisher) {
	...
	public THREE_DIMENSIONAL_MODEL(PublisherImprint publisherImprint) {
	...
	public THREE_DIMENSIONAL_MODEL(PublishingPrinciples publishingPrinciples) {
	...
	public THREE_DIMENSIONAL_MODEL(RecordedAt recordedAt) {
	...
	public THREE_DIMENSIONAL_MODEL(ReleasedEvent releasedEvent) {
	...
	public THREE_DIMENSIONAL_MODEL(Review review) {
		setReview(review);
	}
	...
	public THREE_DIMENSIONAL_MODEL(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public THREE_DIMENSIONAL_MODEL(SchemaVersion schemaVersion) {
	...
	public THREE_DIMENSIONAL_MODEL(SdDatePublished sdDatePublished) {
	...
	public THREE_DIMENSIONAL_MODEL(SdLicense sdLicense) {
	...
	public THREE_DIMENSIONAL_MODEL(SdPublisher sdPublisher) {
	...
	public THREE_DIMENSIONAL_MODEL(SourceOrganization sourceOrganization) {
	...
	public THREE_DIMENSIONAL_MODEL(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public THREE_DIMENSIONAL_MODEL(SpatialCoverage spatialCoverage) {
	...
	public THREE_DIMENSIONAL_MODEL(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public THREE_DIMENSIONAL_MODEL(SubjectOf subjectOf) {
	...
	public THREE_DIMENSIONAL_MODEL(Temporal temporal) {
	...
	public THREE_DIMENSIONAL_MODEL(TemporalCoverage temporalCoverage) {
	...
	public THREE_DIMENSIONAL_MODEL(Text text) {
		setText(text);
	}
	...
	public THREE_DIMENSIONAL_MODEL(ThumbnailUrl thumbnailUrl) {
	...
	public THREE_DIMENSIONAL_MODEL(TimeRequired timeRequired) {
	...
	public THREE_DIMENSIONAL_MODEL(TranslationOfWork translationOfWork) {
	...
	public THREE_DIMENSIONAL_MODEL(Translator translator) {
	...
	public THREE_DIMENSIONAL_MODEL(TypicalAgeRange typicalAgeRange) {
	...
	public THREE_DIMENSIONAL_MODEL(Url url) {
		setUrl(url);
	}
	...
	public THREE_DIMENSIONAL_MODEL(Version version) {
		setVersion(version);
	}
	...
	public THREE_DIMENSIONAL_MODEL(Video video) {
		setVideo(video);
	}
	...
	public THREE_DIMENSIONAL_MODEL(WorkExample workExample) {
	...
	public THREE_DIMENSIONAL_MODEL(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.ThreeDimensionalModel org) {
		setSeq(org.getSeq());
