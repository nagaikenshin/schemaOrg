...
public class OPINION_NEWS_ARTICLE implements Clazz.OpinionNewsArticle {
	...
	public OPINION_NEWS_ARTICLE() {
	}

	public OPINION_NEWS_ARTICLE(Long seq) {
		setSeq(seq);
	}

	public OPINION_NEWS_ARTICLE(String string) {
	...
	public OPINION_NEWS_ARTICLE(About about) {
		setAbout(about);
	}
	...
	public OPINION_NEWS_ARTICLE(AccessMode accessMode) {
	...
	public OPINION_NEWS_ARTICLE(AccessModeSufficient accessModeSufficient) {
	...
	public OPINION_NEWS_ARTICLE(AccessibilityAPI accessibilityAPI) {
	...
	public OPINION_NEWS_ARTICLE(AccessibilityControl accessibilityControl) {
	...
	public OPINION_NEWS_ARTICLE(AccessibilityFeature accessibilityFeature) {
	...
	public OPINION_NEWS_ARTICLE(AccessibilityHazard accessibilityHazard) {
	...
	public OPINION_NEWS_ARTICLE(AccessibilitySummary accessibilitySummary) {
	...
	public OPINION_NEWS_ARTICLE(AccountablePerson accountablePerson) {
	...
	public OPINION_NEWS_ARTICLE(AdditionalType additionalType) {
	...
	public OPINION_NEWS_ARTICLE(AggregateRating aggregateRating) {
	...
	public OPINION_NEWS_ARTICLE(AlternateName alternateName) {
	...
	public OPINION_NEWS_ARTICLE(AlternativeHeadline alternativeHeadline) {
	...
	public OPINION_NEWS_ARTICLE(ArticleBody articleBody) {
	...
	public OPINION_NEWS_ARTICLE(ArticleSection articleSection) {
	...
	public OPINION_NEWS_ARTICLE(AssociatedMedia associatedMedia) {
	...
	public OPINION_NEWS_ARTICLE(Audience audience) {
	...
	public OPINION_NEWS_ARTICLE(Audio audio) {
		setAudio(audio);
	}
	...
	public OPINION_NEWS_ARTICLE(Author author) {
		setAuthor(author);
	}
	...
	public OPINION_NEWS_ARTICLE(Award award) {
		setAward(award);
	}
	...
	public OPINION_NEWS_ARTICLE(Backstory backstory) {
	...
	public OPINION_NEWS_ARTICLE(Character character) {
	...
	public OPINION_NEWS_ARTICLE(Citation citation) {
	...
	public OPINION_NEWS_ARTICLE(Comment comment) {
		setComment(comment);
	}
	...
	public OPINION_NEWS_ARTICLE(CommentCount commentCount) {
	...
	public OPINION_NEWS_ARTICLE(ContentLocation contentLocation) {
	...
	public OPINION_NEWS_ARTICLE(ContentRating contentRating) {
	...
	public OPINION_NEWS_ARTICLE(ContentReferenceTime contentReferenceTime) {
	...
	public OPINION_NEWS_ARTICLE(Contributor contributor) {
	...
	public OPINION_NEWS_ARTICLE(CopyrightHolder copyrightHolder) {
	...
	public OPINION_NEWS_ARTICLE(CopyrightYear copyrightYear) {
	...
	public OPINION_NEWS_ARTICLE(Correction correction) {
	...
	public OPINION_NEWS_ARTICLE(Creator creator) {
		setCreator(creator);
	}
	...
	public OPINION_NEWS_ARTICLE(DateCreated dateCreated) {
	...
	public OPINION_NEWS_ARTICLE(DateModified dateModified) {
	...
	public OPINION_NEWS_ARTICLE(DatePublished datePublished) {
	...
	public OPINION_NEWS_ARTICLE(Dateline dateline) {
	...
	public OPINION_NEWS_ARTICLE(Description description) {
	...
	public OPINION_NEWS_ARTICLE(DisambiguatingDescription disambiguatingDescription) {
	...
	public OPINION_NEWS_ARTICLE(DiscussionUrl discussionUrl) {
	...
	public OPINION_NEWS_ARTICLE(Editor editor) {
		setEditor(editor);
	}
	...
	public OPINION_NEWS_ARTICLE(EducationalAlignment educationalAlignment) {
	...
	public OPINION_NEWS_ARTICLE(EducationalUse educationalUse) {
	...
	public OPINION_NEWS_ARTICLE(Encoding encoding) {
	...
	public OPINION_NEWS_ARTICLE(EncodingFormat encodingFormat) {
	...
	public OPINION_NEWS_ARTICLE(ExampleOfWork exampleOfWork) {
	...
	public OPINION_NEWS_ARTICLE(Expires expires) {
		setExpires(expires);
	}
	...
	public OPINION_NEWS_ARTICLE(Funder funder) {
		setFunder(funder);
	}
	...
	public OPINION_NEWS_ARTICLE(Genre genre) {
		setGenre(genre);
	}
	...
	public OPINION_NEWS_ARTICLE(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public OPINION_NEWS_ARTICLE(Headline headline) {
	...
	public OPINION_NEWS_ARTICLE(Identifier identifier) {
	...
	public OPINION_NEWS_ARTICLE(Image image) {
		setImage(image);
	}
	...
	public OPINION_NEWS_ARTICLE(InLanguage inLanguage) {
	...
	public OPINION_NEWS_ARTICLE(InteractionStatistic interactionStatistic) {
	...
	public OPINION_NEWS_ARTICLE(InteractivityType interactivityType) {
	...
	public OPINION_NEWS_ARTICLE(IsAccessibleForFree isAccessibleForFree) {
	...
	public OPINION_NEWS_ARTICLE(IsBasedOn isBasedOn) {
	...
	public OPINION_NEWS_ARTICLE(IsFamilyFriendly isFamilyFriendly) {
	...
	public OPINION_NEWS_ARTICLE(IsPartOf isPartOf) {
	...
	public OPINION_NEWS_ARTICLE(Keywords keywords) {
	...
	public OPINION_NEWS_ARTICLE(LearningResourceType learningResourceType) {
	...
	public OPINION_NEWS_ARTICLE(License license) {
		setLicense(license);
	}
	...
	public OPINION_NEWS_ARTICLE(LocationCreated locationCreated) {
	...
	public OPINION_NEWS_ARTICLE(MainEntity mainEntity) {
	...
	public OPINION_NEWS_ARTICLE(MainEntityOfPage mainEntityOfPage) {
	...
	public OPINION_NEWS_ARTICLE(Material material) {
	...
	public OPINION_NEWS_ARTICLE(MaterialExtent materialExtent) {
	...
	public OPINION_NEWS_ARTICLE(Mentions mentions) {
	...
	public OPINION_NEWS_ARTICLE(Name name) {
		setName(name);
	}
	...
	public OPINION_NEWS_ARTICLE(NameFuzzy nameFuzzy) {
	...
	public OPINION_NEWS_ARTICLE(NameRuby nameRuby) {
	...
	public OPINION_NEWS_ARTICLE(Offers offers) {
		setOffers(offers);
	}
	...
	public OPINION_NEWS_ARTICLE(PageEnd pageEnd) {
		setPageEnd(pageEnd);
	}
	...
	public OPINION_NEWS_ARTICLE(PageStart pageStart) {
	...
	public OPINION_NEWS_ARTICLE(Pagination pagination) {
	...
	public OPINION_NEWS_ARTICLE(Position position) {
	...
	public OPINION_NEWS_ARTICLE(PotentialAction potentialAction) {
	...
	public OPINION_NEWS_ARTICLE(PrintColumn printColumn) {
	...
	public OPINION_NEWS_ARTICLE(PrintEdition printEdition) {
	...
	public OPINION_NEWS_ARTICLE(PrintPage printPage) {
	...
	public OPINION_NEWS_ARTICLE(PrintSection printSection) {
	...
	public OPINION_NEWS_ARTICLE(Producer producer) {
	...
	public OPINION_NEWS_ARTICLE(Provider provider) {
	...
	public OPINION_NEWS_ARTICLE(Publication publication) {
	...
	public OPINION_NEWS_ARTICLE(Publisher publisher) {
	...
	public OPINION_NEWS_ARTICLE(PublisherImprint publisherImprint) {
	...
	public OPINION_NEWS_ARTICLE(PublishingPrinciples publishingPrinciples) {
	...
	public OPINION_NEWS_ARTICLE(RecordedAt recordedAt) {
	...
	public OPINION_NEWS_ARTICLE(ReleasedEvent releasedEvent) {
	...
	public OPINION_NEWS_ARTICLE(Review review) {
		setReview(review);
	}
	...
	public OPINION_NEWS_ARTICLE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public OPINION_NEWS_ARTICLE(SchemaVersion schemaVersion) {
	...
	public OPINION_NEWS_ARTICLE(SdDatePublished sdDatePublished) {
	...
	public OPINION_NEWS_ARTICLE(SdLicense sdLicense) {
	...
	public OPINION_NEWS_ARTICLE(SdPublisher sdPublisher) {
	...
	public OPINION_NEWS_ARTICLE(SourceOrganization sourceOrganization) {
	...
	public OPINION_NEWS_ARTICLE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public OPINION_NEWS_ARTICLE(SpatialCoverage spatialCoverage) {
	...
	public OPINION_NEWS_ARTICLE(Speakable speakable) {
	...
	public OPINION_NEWS_ARTICLE(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public OPINION_NEWS_ARTICLE(SubjectOf subjectOf) {
	...
	public OPINION_NEWS_ARTICLE(Temporal temporal) {
	...
	public OPINION_NEWS_ARTICLE(TemporalCoverage temporalCoverage) {
	...
	public OPINION_NEWS_ARTICLE(Text text) {
		setText(text);
	}
	...
	public OPINION_NEWS_ARTICLE(ThumbnailUrl thumbnailUrl) {
	...
	public OPINION_NEWS_ARTICLE(TimeRequired timeRequired) {
	...
	public OPINION_NEWS_ARTICLE(TranslationOfWork translationOfWork) {
	...
	public OPINION_NEWS_ARTICLE(Translator translator) {
	...
	public OPINION_NEWS_ARTICLE(TypicalAgeRange typicalAgeRange) {
	...
	public OPINION_NEWS_ARTICLE(Url url) {
		setUrl(url);
	}
	...
	public OPINION_NEWS_ARTICLE(Version version) {
		setVersion(version);
	}
	...
	public OPINION_NEWS_ARTICLE(Video video) {
		setVideo(video);
	}
	...
	public OPINION_NEWS_ARTICLE(WordCount wordCount) {
	...
	public OPINION_NEWS_ARTICLE(WorkExample workExample) {
	...
	public OPINION_NEWS_ARTICLE(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.OpinionNewsArticle org) {
		setSeq(org.getSeq());
