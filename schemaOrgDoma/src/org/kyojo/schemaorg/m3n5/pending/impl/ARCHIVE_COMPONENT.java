...
public class ARCHIVE_COMPONENT implements Clazz.ArchiveComponent {
	...
	public HoldingArchive holdingArchive;
	...
	public ARCHIVE_COMPONENT() {
	}

	public ARCHIVE_COMPONENT(Long seq) {
		setSeq(seq);
	}

	public ARCHIVE_COMPONENT(String string) {
	...
	public ARCHIVE_COMPONENT(About about) {
		setAbout(about);
	}
	...
	public ARCHIVE_COMPONENT(AccessMode accessMode) {
	...
	public ARCHIVE_COMPONENT(AccessModeSufficient accessModeSufficient) {
	...
	public ARCHIVE_COMPONENT(AccessibilityAPI accessibilityAPI) {
	...
	public ARCHIVE_COMPONENT(AccessibilityControl accessibilityControl) {
	...
	public ARCHIVE_COMPONENT(AccessibilityFeature accessibilityFeature) {
	...
	public ARCHIVE_COMPONENT(AccessibilityHazard accessibilityHazard) {
	...
	public ARCHIVE_COMPONENT(AccessibilitySummary accessibilitySummary) {
	...
	public ARCHIVE_COMPONENT(AccountablePerson accountablePerson) {
	...
	public ARCHIVE_COMPONENT(AdditionalType additionalType) {
	...
	public ARCHIVE_COMPONENT(AggregateRating aggregateRating) {
	...
	public ARCHIVE_COMPONENT(AlternateName alternateName) {
	...
	public ARCHIVE_COMPONENT(AlternativeHeadline alternativeHeadline) {
	...
	public ARCHIVE_COMPONENT(AssociatedMedia associatedMedia) {
	...
	public ARCHIVE_COMPONENT(Audience audience) {
	...
	public ARCHIVE_COMPONENT(Audio audio) {
		setAudio(audio);
	}
	...
	public ARCHIVE_COMPONENT(Author author) {
		setAuthor(author);
	}
	...
	public ARCHIVE_COMPONENT(Award award) {
		setAward(award);
	}
	...
	public ARCHIVE_COMPONENT(Character character) {
	...
	public ARCHIVE_COMPONENT(Citation citation) {
	...
	public ARCHIVE_COMPONENT(Comment comment) {
		setComment(comment);
	}
	...
	public ARCHIVE_COMPONENT(CommentCount commentCount) {
	...
	public ARCHIVE_COMPONENT(ContentLocation contentLocation) {
	...
	public ARCHIVE_COMPONENT(ContentRating contentRating) {
	...
	public ARCHIVE_COMPONENT(ContentReferenceTime contentReferenceTime) {
	...
	public ARCHIVE_COMPONENT(Contributor contributor) {
	...
	public ARCHIVE_COMPONENT(CopyrightHolder copyrightHolder) {
	...
	public ARCHIVE_COMPONENT(CopyrightYear copyrightYear) {
	...
	public ARCHIVE_COMPONENT(Correction correction) {
	...
	public ARCHIVE_COMPONENT(Creator creator) {
		setCreator(creator);
	}
	...
	public ARCHIVE_COMPONENT(DateCreated dateCreated) {
	...
	public ARCHIVE_COMPONENT(DateModified dateModified) {
	...
	public ARCHIVE_COMPONENT(DatePublished datePublished) {
	...
	public ARCHIVE_COMPONENT(Description description) {
	...
	public ARCHIVE_COMPONENT(DisambiguatingDescription disambiguatingDescription) {
	...
	public ARCHIVE_COMPONENT(DiscussionUrl discussionUrl) {
	...
	public ARCHIVE_COMPONENT(Editor editor) {
		setEditor(editor);
	}
	...
	public ARCHIVE_COMPONENT(EducationalAlignment educationalAlignment) {
	...
	public ARCHIVE_COMPONENT(EducationalUse educationalUse) {
	...
	public ARCHIVE_COMPONENT(Encoding encoding) {
	...
	public ARCHIVE_COMPONENT(EncodingFormat encodingFormat) {
	...
	public ARCHIVE_COMPONENT(ExampleOfWork exampleOfWork) {
	...
	public ARCHIVE_COMPONENT(Expires expires) {
		setExpires(expires);
	}
	...
	public ARCHIVE_COMPONENT(Funder funder) {
		setFunder(funder);
	}
	...
	public ARCHIVE_COMPONENT(Genre genre) {
		setGenre(genre);
	}
	...
	public ARCHIVE_COMPONENT(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public ARCHIVE_COMPONENT(Headline headline) {
	...
	public ARCHIVE_COMPONENT(HoldingArchive holdingArchive) {
		setHoldingArchive(holdingArchive);
	}

	@Override
	public HoldingArchive getHoldingArchive() {
		return holdingArchive;
	}

	@Override
	public void setHoldingArchive(HoldingArchive holdingArchive) {
		this.holdingArchive = holdingArchive;
	}

	public ARCHIVE_COMPONENT(Identifier identifier) {
	...
	public ARCHIVE_COMPONENT(Image image) {
		setImage(image);
	}
	...
	public ARCHIVE_COMPONENT(InLanguage inLanguage) {
	...
	public ARCHIVE_COMPONENT(InteractionStatistic interactionStatistic) {
	...
	public ARCHIVE_COMPONENT(InteractivityType interactivityType) {
	...
	public ARCHIVE_COMPONENT(IsAccessibleForFree isAccessibleForFree) {
	...
	public ARCHIVE_COMPONENT(IsBasedOn isBasedOn) {
	...
	public ARCHIVE_COMPONENT(IsFamilyFriendly isFamilyFriendly) {
	...
	public ARCHIVE_COMPONENT(IsPartOf isPartOf) {
	...
	public ARCHIVE_COMPONENT(ItemLocation itemLocation) {
	...
	public ARCHIVE_COMPONENT(Keywords keywords) {
	...
	public ARCHIVE_COMPONENT(LearningResourceType learningResourceType) {
	...
	public ARCHIVE_COMPONENT(License license) {
		setLicense(license);
	}
	...
	public ARCHIVE_COMPONENT(LocationCreated locationCreated) {
	...
	public ARCHIVE_COMPONENT(MainEntity mainEntity) {
	...
	public ARCHIVE_COMPONENT(MainEntityOfPage mainEntityOfPage) {
	...
	public ARCHIVE_COMPONENT(Material material) {
	...
	public ARCHIVE_COMPONENT(MaterialExtent materialExtent) {
	...
	public ARCHIVE_COMPONENT(Mentions mentions) {
	...
	public ARCHIVE_COMPONENT(Name name) {
		setName(name);
	}
	...
	public ARCHIVE_COMPONENT(NameFuzzy nameFuzzy) {
	...
	public ARCHIVE_COMPONENT(NameRuby nameRuby) {
	...
	public ARCHIVE_COMPONENT(Offers offers) {
		setOffers(offers);
	}
	...
	public ARCHIVE_COMPONENT(Position position) {
	...
	public ARCHIVE_COMPONENT(PotentialAction potentialAction) {
	...
	public ARCHIVE_COMPONENT(Producer producer) {
	...
	public ARCHIVE_COMPONENT(Provider provider) {
	...
	public ARCHIVE_COMPONENT(Publication publication) {
	...
	public ARCHIVE_COMPONENT(Publisher publisher) {
	...
	public ARCHIVE_COMPONENT(PublisherImprint publisherImprint) {
	...
	public ARCHIVE_COMPONENT(PublishingPrinciples publishingPrinciples) {
	...
	public ARCHIVE_COMPONENT(RecordedAt recordedAt) {
	...
	public ARCHIVE_COMPONENT(ReleasedEvent releasedEvent) {
	...
	public ARCHIVE_COMPONENT(Review review) {
		setReview(review);
	}
	...
	public ARCHIVE_COMPONENT(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ARCHIVE_COMPONENT(SchemaVersion schemaVersion) {
	...
	public ARCHIVE_COMPONENT(SdDatePublished sdDatePublished) {
	...
	public ARCHIVE_COMPONENT(SdLicense sdLicense) {
	...
	public ARCHIVE_COMPONENT(SdPublisher sdPublisher) {
	...
	public ARCHIVE_COMPONENT(SourceOrganization sourceOrganization) {
	...
	public ARCHIVE_COMPONENT(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public ARCHIVE_COMPONENT(SpatialCoverage spatialCoverage) {
	...
	public ARCHIVE_COMPONENT(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public ARCHIVE_COMPONENT(SubjectOf subjectOf) {
	...
	public ARCHIVE_COMPONENT(Temporal temporal) {
	...
	public ARCHIVE_COMPONENT(TemporalCoverage temporalCoverage) {
	...
	public ARCHIVE_COMPONENT(Text text) {
		setText(text);
	}
	...
	public ARCHIVE_COMPONENT(ThumbnailUrl thumbnailUrl) {
	...
	public ARCHIVE_COMPONENT(TimeRequired timeRequired) {
	...
	public ARCHIVE_COMPONENT(TranslationOfWork translationOfWork) {
	...
	public ARCHIVE_COMPONENT(Translator translator) {
	...
	public ARCHIVE_COMPONENT(TypicalAgeRange typicalAgeRange) {
	...
	public ARCHIVE_COMPONENT(Url url) {
		setUrl(url);
	}
	...
	public ARCHIVE_COMPONENT(Version version) {
		setVersion(version);
	}
	...
	public ARCHIVE_COMPONENT(Video video) {
		setVideo(video);
	}
	...
	public ARCHIVE_COMPONENT(WorkExample workExample) {
	...
	public ARCHIVE_COMPONENT(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.ArchiveComponent org) {
		setSeq(org.getSeq());
		...
		setHoldingArchive(org.getHoldingArchive());
		...
		setItemLocation(org.getItemLocation());
