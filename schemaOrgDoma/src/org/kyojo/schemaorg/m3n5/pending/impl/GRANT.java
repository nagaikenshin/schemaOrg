...
public class GRANT implements Clazz.Grant {
	...
	public GRANT(AdditionalType additionalType) {
	...
	public GRANT(AlternateName alternateName) {
	...
	public GRANT(Description description) {
	...
	public GRANT(DisambiguatingDescription disambiguatingDescription) {
	...
	public GRANT(FundedItem fundedItem) {
	...
	public GRANT(Identifier identifier) {
	...
	public GRANT(MainEntityOfPage mainEntityOfPage) {
	...
	public GRANT(NameFuzzy nameFuzzy) {
	...
	public GRANT(NameRuby nameRuby) {
	...
	public GRANT(PotentialAction potentialAction) {
	...
	public GRANT(SubjectOf subjectOf) {
	...
	public void copy(Clazz.Grant org) {
		setSeq(org.getSeq());
