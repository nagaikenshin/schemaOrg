...
public class ITEM_LOCATION implements Container.ItemLocation {
	...
	public ITEM_LOCATION(Accommodation accommodation) {
	...
	public ITEM_LOCATION(AccountingService accountingService) {
	...
	public ITEM_LOCATION(AdministrativeArea administrativeArea) {
	...
	public ITEM_LOCATION(AdultEntertainment adultEntertainment) {
	...
	public ITEM_LOCATION(Airport airport) {
	...
	public ITEM_LOCATION(AmusementPark amusementPark) {
	...
	public ITEM_LOCATION(AnimalShelter animalShelter) {
	...
	public ITEM_LOCATION(Apartment apartment) {
	...
	public ITEM_LOCATION(ApartmentComplex apartmentComplex) {
	...
	public ITEM_LOCATION(Aquarium aquarium) {
	...
	public ITEM_LOCATION(ArchiveOrganization archiveOrganization) {
	...
	public ITEM_LOCATION(ArtGallery artGallery) {
	...
	public ITEM_LOCATION(Attorney attorney) {
	...
	public ITEM_LOCATION(AutoBodyShop autoBodyShop) {
	...
	public ITEM_LOCATION(AutoDealer autoDealer) {
	...
	public ITEM_LOCATION(AutoPartsStore autoPartsStore) {
	...
	public ITEM_LOCATION(AutoRental autoRental) {
	...
	public ITEM_LOCATION(AutoRepair autoRepair) {
	...
	public ITEM_LOCATION(AutoWash autoWash) {
	...
	public ITEM_LOCATION(AutomatedTeller automatedTeller) {
	...
	public ITEM_LOCATION(AutomotiveBusiness automotiveBusiness) {
	...
	public ITEM_LOCATION(Bakery bakery) {
	...
	public ITEM_LOCATION(BankOrCreditUnion bankOrCreditUnion) {
	...
	public ITEM_LOCATION(BarOrPub barOrPub) {
	...
	public ITEM_LOCATION(Beach beach) {
	...
	public ITEM_LOCATION(BeautySalon beautySalon) {
	...
	public ITEM_LOCATION(BedAndBreakfast bedAndBreakfast) {
	...
	public ITEM_LOCATION(BikeStore bikeStore) {
	...
	public ITEM_LOCATION(BodyOfWater bodyOfWater) {
	...
	public ITEM_LOCATION(BookStore bookStore) {
	...
	public ITEM_LOCATION(BowlingAlley bowlingAlley) {
	...
	public ITEM_LOCATION(Brewery brewery) {
	...
	public ITEM_LOCATION(Bridge bridge) {
	...
	public ITEM_LOCATION(BuddhistTemple buddhistTemple) {
	...
	public ITEM_LOCATION(BusStation busStation) {
	...
	public ITEM_LOCATION(BusStop busStop) {
	...
	public ITEM_LOCATION(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public ITEM_LOCATION(Campground campground) {
	...
	public ITEM_LOCATION(CampingPitch campingPitch) {
	...
	public ITEM_LOCATION(Canal canal) {
	...
	public ITEM_LOCATION(Casino casino) {
	...
	public ITEM_LOCATION(CatholicChurch catholicChurch) {
	...
	public ITEM_LOCATION(Cemetery cemetery) {
	...
	public ITEM_LOCATION(ChildCare childCare) {
	...
	public ITEM_LOCATION(Church church) {
	...
	public ITEM_LOCATION(City city) {
	...
	public ITEM_LOCATION(CityHall cityHall) {
	...
	public ITEM_LOCATION(CivicStructure civicStructure) {
	...
	public ITEM_LOCATION(ClothingStore clothingStore) {
	...
	public ITEM_LOCATION(ComedyClub comedyClub) {
	...
	public ITEM_LOCATION(CommunityHealth communityHealth) {
	...
	public ITEM_LOCATION(ComputerStore computerStore) {
	...
	public ITEM_LOCATION(Continent continent) {
	...
	public ITEM_LOCATION(ConvenienceStore convenienceStore) {
	...
	public ITEM_LOCATION(Country country) {
	...
	public ITEM_LOCATION(Courthouse courthouse) {
	...
	public ITEM_LOCATION(Crematorium crematorium) {
	...
	public ITEM_LOCATION(DaySpa daySpa) {
	...
	public ITEM_LOCATION(DefenceEstablishment defenceEstablishment) {
	...
	public ITEM_LOCATION(Dentist dentist) {
	...
	public ITEM_LOCATION(DepartmentStore departmentStore) {
	...
	public ITEM_LOCATION(Dermatology dermatology) {
	...
	public ITEM_LOCATION(DietNutrition dietNutrition) {
	...
	public ITEM_LOCATION(Distillery distillery) {
	...
	public ITEM_LOCATION(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public ITEM_LOCATION(Electrician electrician) {
	...
	public ITEM_LOCATION(ElectronicsStore electronicsStore) {
	...
	public ITEM_LOCATION(Embassy embassy) {
	...
	public ITEM_LOCATION(Emergency emergency) {
	...
	public ITEM_LOCATION(EmergencyService emergencyService) {
	...
	public ITEM_LOCATION(EmploymentAgency employmentAgency) {
	...
	public ITEM_LOCATION(EntertainmentBusiness entertainmentBusiness) {
	...
	public ITEM_LOCATION(EventVenue eventVenue) {
	...
	public ITEM_LOCATION(ExerciseGym exerciseGym) {
	...
	public ITEM_LOCATION(FastFoodRestaurant fastFoodRestaurant) {
	...
	public ITEM_LOCATION(FinancialService financialService) {
	...
	public ITEM_LOCATION(FireStation fireStation) {
	...
	public ITEM_LOCATION(Florist florist) {
	...
	public ITEM_LOCATION(FoodEstablishment foodEstablishment) {
	...
	public ITEM_LOCATION(FurnitureStore furnitureStore) {
	...
	public ITEM_LOCATION(GardenStore gardenStore) {
	...
	public ITEM_LOCATION(GasStation gasStation) {
	...
	public ITEM_LOCATION(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public ITEM_LOCATION(GeneralContractor generalContractor) {
	...
	public ITEM_LOCATION(Geriatric geriatric) {
	...
	public ITEM_LOCATION(GolfCourse golfCourse) {
	...
	public ITEM_LOCATION(GovernmentBuilding governmentBuilding) {
	...
	public ITEM_LOCATION(GovernmentOffice governmentOffice) {
	...
	public ITEM_LOCATION(GroceryStore groceryStore) {
	...
	public ITEM_LOCATION(Gynecologic gynecologic) {
	...
	public ITEM_LOCATION(HVACBusiness hvacBusiness) {
	...
	public ITEM_LOCATION(HairSalon hairSalon) {
	...
	public ITEM_LOCATION(HardwareStore hardwareStore) {
	...
	public ITEM_LOCATION(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public ITEM_LOCATION(HealthClub healthClub) {
	...
	public ITEM_LOCATION(HinduTemple hinduTemple) {
	...
	public ITEM_LOCATION(HobbyShop hobbyShop) {
	...
	public ITEM_LOCATION(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public ITEM_LOCATION(HomeGoodsStore homeGoodsStore) {
	...
	public ITEM_LOCATION(Hospital hospital) {
	...
	public ITEM_LOCATION(Hostel hostel) {
	...
	public ITEM_LOCATION(Hotel hotel) {
	...
	public ITEM_LOCATION(HotelRoom hotelRoom) {
	...
	public ITEM_LOCATION(House house) {
	...
	public ITEM_LOCATION(HousePainter housePainter) {
	...
	public ITEM_LOCATION(IceCreamShop iceCreamShop) {
	...
	public ITEM_LOCATION(InsuranceAgency insuranceAgency) {
	...
	public ITEM_LOCATION(InternetCafe internetCafe) {
	...
	public ITEM_LOCATION(JewelryStore jewelryStore) {
	...
	public ITEM_LOCATION(LakeBodyOfWater lakeBodyOfWater) {
	...
	public ITEM_LOCATION(Landform landform) {
	...
	public ITEM_LOCATION(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public ITEM_LOCATION(LegalService legalService) {
	...
	public ITEM_LOCATION(LegislativeBuilding legislativeBuilding) {
	...
	public ITEM_LOCATION(Library library) {
	...
	public ITEM_LOCATION(LiquorStore liquorStore) {
	...
	public ITEM_LOCATION(LocalBusiness localBusiness) {
	...
	public ITEM_LOCATION(Locksmith locksmith) {
	...
	public ITEM_LOCATION(LodgingBusiness lodgingBusiness) {
	...
	public ITEM_LOCATION(MedicalBusiness medicalBusiness) {
	...
	public ITEM_LOCATION(MedicalClinic medicalClinic) {
	...
	public ITEM_LOCATION(MeetingRoom meetingRoom) {
	...
	public ITEM_LOCATION(MensClothingStore mensClothingStore) {
	...
	public ITEM_LOCATION(Midwifery midwifery) {
	...
	public ITEM_LOCATION(MobilePhoneStore mobilePhoneStore) {
	...
	public ITEM_LOCATION(Mosque mosque) {
	...
	public ITEM_LOCATION(Motel motel) {
	...
	public ITEM_LOCATION(MotorcycleDealer motorcycleDealer) {
	...
	public ITEM_LOCATION(MotorcycleRepair motorcycleRepair) {
	...
	public ITEM_LOCATION(Mountain mountain) {
	...
	public ITEM_LOCATION(MovieRentalStore movieRentalStore) {
	...
	public ITEM_LOCATION(MovieTheater movieTheater) {
	...
	public ITEM_LOCATION(MovingCompany movingCompany) {
	...
	public ITEM_LOCATION(Museum museum) {
	...
	public ITEM_LOCATION(MusicStore musicStore) {
	...
	public ITEM_LOCATION(MusicVenue musicVenue) {
	...
	public ITEM_LOCATION(NailSalon nailSalon) {
	...
	public ITEM_LOCATION(NightClub nightClub) {
	...
	public ITEM_LOCATION(Notary notary) {
	...
	public ITEM_LOCATION(Nursing nursing) {
	...
	public ITEM_LOCATION(Obstetric obstetric) {
	...
	public ITEM_LOCATION(OceanBodyOfWater oceanBodyOfWater) {
	...
	public ITEM_LOCATION(OfficeEquipmentStore officeEquipmentStore) {
	...
	public ITEM_LOCATION(Oncologic oncologic) {
	...
	public ITEM_LOCATION(Optician optician) {
	...
	public ITEM_LOCATION(Optometric optometric) {
	...
	public ITEM_LOCATION(Otolaryngologic otolaryngologic) {
	...
	public ITEM_LOCATION(OutletStore outletStore) {
	...
	public ITEM_LOCATION(Park park) {
	...
	public ITEM_LOCATION(ParkingFacility parkingFacility) {
	...
	public ITEM_LOCATION(PawnShop pawnShop) {
	...
	public ITEM_LOCATION(Pediatric pediatric) {
	...
	public ITEM_LOCATION(PerformingArtsTheater performingArtsTheater) {
	...
	public ITEM_LOCATION(PetStore petStore) {
	...
	public ITEM_LOCATION(Pharmacy pharmacy) {
	...
	public ITEM_LOCATION(Physician physician) {
	...
	public ITEM_LOCATION(Physiotherapy physiotherapy) {
	...
	public ITEM_LOCATION(Place place) {
	...
	public ITEM_LOCATION(PlaceOfWorship placeOfWorship) {
	...
	public ITEM_LOCATION(PlasticSurgery plasticSurgery) {
	...
	public ITEM_LOCATION(Playground playground) {
	...
	public ITEM_LOCATION(Plumber plumber) {
	...
	public ITEM_LOCATION(Podiatric podiatric) {
	...
	public ITEM_LOCATION(PoliceStation policeStation) {
	...
	public ITEM_LOCATION(Pond pond) {
	...
	public ITEM_LOCATION(PostOffice postOffice) {
	...
	public ITEM_LOCATION(PostalAddress postalAddress) {
	...
	public ITEM_LOCATION(PrimaryCare primaryCare) {
	...
	public ITEM_LOCATION(ProfessionalService professionalService) {
	...
	public ITEM_LOCATION(Psychiatric psychiatric) {
	...
	public ITEM_LOCATION(PublicHealth publicHealth) {
	...
	public ITEM_LOCATION(PublicSwimmingPool publicSwimmingPool) {
	...
	public ITEM_LOCATION(PublicToilet publicToilet) {
	...
	public ITEM_LOCATION(RVPark rvPark) {
	...
	public ITEM_LOCATION(RadioStation radioStation) {
	...
	public ITEM_LOCATION(RealEstateAgent realEstateAgent) {
	...
	public ITEM_LOCATION(RecyclingCenter recyclingCenter) {
	...
	public ITEM_LOCATION(Reservoir reservoir) {
	...
	public ITEM_LOCATION(Residence residence) {
	...
	public ITEM_LOCATION(Resort resort) {
	...
	public ITEM_LOCATION(Restaurant restaurant) {
	...
	public ITEM_LOCATION(RiverBodyOfWater riverBodyOfWater) {
	...
	public ITEM_LOCATION(RoofingContractor roofingContractor) {
	...
	public ITEM_LOCATION(Room room) {
	...
	public ITEM_LOCATION(SeaBodyOfWater seaBodyOfWater) {
	...
	public ITEM_LOCATION(SelfStorage selfStorage) {
	...
	public ITEM_LOCATION(ShoeStore shoeStore) {
	...
	public ITEM_LOCATION(ShoppingCenter shoppingCenter) {
	...
	public ITEM_LOCATION(SingleFamilyResidence singleFamilyResidence) {
	...
	public ITEM_LOCATION(SkiResort skiResort) {
	...
	public ITEM_LOCATION(SportingGoodsStore sportingGoodsStore) {
	...
	public ITEM_LOCATION(SportsActivityLocation sportsActivityLocation) {
	...
	public ITEM_LOCATION(SportsClub sportsClub) {
	...
	public ITEM_LOCATION(StadiumOrArena stadiumOrArena) {
	...
	public ITEM_LOCATION(State state) {
	...
	public ITEM_LOCATION(Store store) {
	...
	public ITEM_LOCATION(SubwayStation subwayStation) {
	...
	public ITEM_LOCATION(Suite suite) {
	...
	public ITEM_LOCATION(Synagogue synagogue) {
	...
	public ITEM_LOCATION(TattooParlor tattooParlor) {
	...
	public ITEM_LOCATION(TaxiStand taxiStand) {
	...
	public ITEM_LOCATION(TelevisionStation televisionStation) {
	...
	public ITEM_LOCATION(TennisComplex tennisComplex) {
	...
	public ITEM_LOCATION(String string) {
		this(new TEXT(string));
	}

	public ITEM_LOCATION(Text text) {
	...
	public ITEM_LOCATION(TireShop tireShop) {
	...
	public ITEM_LOCATION(TouristAttraction touristAttraction) {
	...
	public ITEM_LOCATION(TouristDestination touristDestination) {
	...
	public ITEM_LOCATION(TouristInformationCenter touristInformationCenter) {
	...
	public ITEM_LOCATION(ToyStore toyStore) {
	...
	public ITEM_LOCATION(TrainStation trainStation) {
	...
	public ITEM_LOCATION(TravelAgency travelAgency) {
	...
	public ITEM_LOCATION(Volcano volcano) {
	...
	public ITEM_LOCATION(Waterfall waterfall) {
	...
	public ITEM_LOCATION(WholesaleStore wholesaleStore) {
	...
	public ITEM_LOCATION(Winery winery) {
	...
	public void copy(Container.ItemLocation org) {
