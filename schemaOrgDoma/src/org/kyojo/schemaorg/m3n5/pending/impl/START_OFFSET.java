...
public class START_OFFSET implements Container.StartOffset {
	...
	public START_OFFSET(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public START_OFFSET(Float fl0at) {
	...
	public START_OFFSET(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public START_OFFSET(Integer integer) {
	...
	public START_OFFSET(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public START_OFFSET(Number number) {
	...
	public START_OFFSET(List<Float> fl0atList,
	...
	public void copy(Container.StartOffset org) {
