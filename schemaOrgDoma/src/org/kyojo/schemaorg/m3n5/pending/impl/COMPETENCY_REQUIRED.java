...
public class COMPETENCY_REQUIRED implements Container.CompetencyRequired {
	...
	public COMPETENCY_REQUIRED() {
	}

	public COMPETENCY_REQUIRED(CategoryCode categoryCode) {
	...
	public COMPETENCY_REQUIRED(DefinedTerm definedTerm) {
	...
	public COMPETENCY_REQUIRED(MedicalCode medicalCode) {
	...
	public COMPETENCY_REQUIRED(String string) {
		this(new TEXT(string));
	}

	public COMPETENCY_REQUIRED(Text text) {
	...
	public COMPETENCY_REQUIRED(URL url) {
	...
	public COMPETENCY_REQUIRED(List<CategoryCode> categoryCodeList,
	...
	public void copy(Container.CompetencyRequired org) {
