...
public class SHORT_STORY implements Clazz.ShortStory {
	...
	public SHORT_STORY(Long seq) {
		setSeq(seq);
	}

	public SHORT_STORY(String string) {
	...
	public SHORT_STORY(About about) {
		setAbout(about);
	}
	...
	public SHORT_STORY(AccessMode accessMode) {
	...
	public SHORT_STORY(AccessModeSufficient accessModeSufficient) {
	...
	public SHORT_STORY(AccessibilityAPI accessibilityAPI) {
	...
	public SHORT_STORY(AccessibilityControl accessibilityControl) {
	...
	public SHORT_STORY(AccessibilityFeature accessibilityFeature) {
	...
	public SHORT_STORY(AccessibilityHazard accessibilityHazard) {
	...
	public SHORT_STORY(AccessibilitySummary accessibilitySummary) {
	...
	public SHORT_STORY(AccountablePerson accountablePerson) {
	...
	public SHORT_STORY(AdditionalType additionalType) {
	...
	public SHORT_STORY(AggregateRating aggregateRating) {
	...
	public SHORT_STORY(AlternateName alternateName) {
	...
	public SHORT_STORY(AlternativeHeadline alternativeHeadline) {
	...
	public SHORT_STORY(AssociatedMedia associatedMedia) {
	...
	public SHORT_STORY(Audience audience) {
	...
	public SHORT_STORY(Audio audio) {
		setAudio(audio);
	}
	...
	public SHORT_STORY(Author author) {
		setAuthor(author);
	}
	...
	public SHORT_STORY(Award award) {
		setAward(award);
	}
	...
	public SHORT_STORY(Character character) {
	...
	public SHORT_STORY(Citation citation) {
	...
	public SHORT_STORY(Comment comment) {
		setComment(comment);
	}
	...
	public SHORT_STORY(CommentCount commentCount) {
	...
	public SHORT_STORY(ContentLocation contentLocation) {
	...
	public SHORT_STORY(ContentRating contentRating) {
	...
	public SHORT_STORY(ContentReferenceTime contentReferenceTime) {
	...
	public SHORT_STORY(Contributor contributor) {
	...
	public SHORT_STORY(CopyrightHolder copyrightHolder) {
	...
	public SHORT_STORY(CopyrightYear copyrightYear) {
	...
	public SHORT_STORY(Correction correction) {
	...
	public SHORT_STORY(Creator creator) {
		setCreator(creator);
	}
	...
	public SHORT_STORY(DateCreated dateCreated) {
	...
	public SHORT_STORY(DateModified dateModified) {
	...
	public SHORT_STORY(DatePublished datePublished) {
	...
	public SHORT_STORY(Description description) {
	...
	public SHORT_STORY(DisambiguatingDescription disambiguatingDescription) {
	...
	public SHORT_STORY(DiscussionUrl discussionUrl) {
	...
	public SHORT_STORY(Editor editor) {
		setEditor(editor);
	}
	...
	public SHORT_STORY(EducationalAlignment educationalAlignment) {
	...
	public SHORT_STORY(EducationalUse educationalUse) {
	...
	public SHORT_STORY(Encoding encoding) {
	...
	public SHORT_STORY(EncodingFormat encodingFormat) {
	...
	public SHORT_STORY(ExampleOfWork exampleOfWork) {
	...
	public SHORT_STORY(Expires expires) {
		setExpires(expires);
	}
	...
	public SHORT_STORY(Funder funder) {
		setFunder(funder);
	}
	...
	public SHORT_STORY(Genre genre) {
		setGenre(genre);
	}
	...
	public SHORT_STORY(HasPart hasPart) {
		setHasPart(hasPart);
	}
	...
	public SHORT_STORY(Headline headline) {
	...
	public SHORT_STORY(Identifier identifier) {
	...
	public SHORT_STORY(Image image) {
		setImage(image);
	}
	...
	public SHORT_STORY(InLanguage inLanguage) {
	...
	public SHORT_STORY(InteractionStatistic interactionStatistic) {
	...
	public SHORT_STORY(InteractivityType interactivityType) {
	...
	public SHORT_STORY(IsAccessibleForFree isAccessibleForFree) {
	...
	public SHORT_STORY(IsBasedOn isBasedOn) {
	...
	public SHORT_STORY(IsFamilyFriendly isFamilyFriendly) {
	...
	public SHORT_STORY(IsPartOf isPartOf) {
	...
	public SHORT_STORY(Keywords keywords) {
	...
	public SHORT_STORY(LearningResourceType learningResourceType) {
	...
	public SHORT_STORY(License license) {
		setLicense(license);
	}
	...
	public SHORT_STORY(LocationCreated locationCreated) {
	...
	public SHORT_STORY(MainEntity mainEntity) {
	...
	public SHORT_STORY(MainEntityOfPage mainEntityOfPage) {
	...
	public SHORT_STORY(Material material) {
	...
	public SHORT_STORY(MaterialExtent materialExtent) {
	...
	public SHORT_STORY(Mentions mentions) {
	...
	public SHORT_STORY(NameFuzzy nameFuzzy) {
	...
	public SHORT_STORY(NameRuby nameRuby) {
	...
	public SHORT_STORY(Offers offers) {
		setOffers(offers);
	}
	...
	public SHORT_STORY(Position position) {
	...
	public SHORT_STORY(PotentialAction potentialAction) {
	...
	public SHORT_STORY(Producer producer) {
	...
	public SHORT_STORY(Provider provider) {
	...
	public SHORT_STORY(Publication publication) {
	...
	public SHORT_STORY(Publisher publisher) {
	...
	public SHORT_STORY(PublisherImprint publisherImprint) {
	...
	public SHORT_STORY(PublishingPrinciples publishingPrinciples) {
	...
	public SHORT_STORY(RecordedAt recordedAt) {
	...
	public SHORT_STORY(ReleasedEvent releasedEvent) {
	...
	public SHORT_STORY(Review review) {
		setReview(review);
	}
	...
	public SHORT_STORY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SHORT_STORY(SchemaVersion schemaVersion) {
	...
	public SHORT_STORY(SdDatePublished sdDatePublished) {
	...
	public SHORT_STORY(SdLicense sdLicense) {
	...
	public SHORT_STORY(SdPublisher sdPublisher) {
	...
	public SHORT_STORY(SourceOrganization sourceOrganization) {
	...
	public SHORT_STORY(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public SHORT_STORY(SpatialCoverage spatialCoverage) {
	...
	public SHORT_STORY(Sponsor sponsor) {
		setSponsor(sponsor);
	}
	...
	public SHORT_STORY(SubjectOf subjectOf) {
	...
	public SHORT_STORY(Temporal temporal) {
	...
	public SHORT_STORY(TemporalCoverage temporalCoverage) {
	...
	public SHORT_STORY(ThumbnailUrl thumbnailUrl) {
	...
	public SHORT_STORY(TimeRequired timeRequired) {
	...
	public SHORT_STORY(TranslationOfWork translationOfWork) {
	...
	public SHORT_STORY(Translator translator) {
	...
	public SHORT_STORY(TypicalAgeRange typicalAgeRange) {
	...
	public SHORT_STORY(Version version) {
		setVersion(version);
	}
	...
	public SHORT_STORY(Video video) {
		setVideo(video);
	}
	...
	public SHORT_STORY(WorkExample workExample) {
	...
	public SHORT_STORY(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.ShortStory org) {
		setSeq(org.getSeq());
