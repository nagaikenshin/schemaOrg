...
public class ASK_PUBLIC_NEWS_ARTICLE implements Clazz.AskPublicNewsArticle {
	...
	public ASK_PUBLIC_NEWS_ARTICLE(MaterialExtent materialExtent) {
	...
	public ASK_PUBLIC_NEWS_ARTICLE(Spatial spatial) {
		setSpatial(spatial);
	}
	...
	public ASK_PUBLIC_NEWS_ARTICLE(Temporal temporal) {
