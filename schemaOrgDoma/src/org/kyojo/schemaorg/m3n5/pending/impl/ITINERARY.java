...
public class ITINERARY implements Container.Itinerary {
	...
	public ITINERARY(Accommodation accommodation) {
	...
	public ITINERARY(AccountingService accountingService) {
	...
	public ITINERARY(AdministrativeArea administrativeArea) {
	...
	public ITINERARY(AdultEntertainment adultEntertainment) {
	...
	public ITINERARY(Airport airport) {
	...
	public ITINERARY(AmusementPark amusementPark) {
	...
	public ITINERARY(AnimalShelter animalShelter) {
	...
	public ITINERARY(Apartment apartment) {
	...
	public ITINERARY(ApartmentComplex apartmentComplex) {
	...
	public ITINERARY(Aquarium aquarium) {
	...
	public ITINERARY(ArchiveOrganization archiveOrganization) {
	...
	public ITINERARY(ArtGallery artGallery) {
	...
	public ITINERARY(Attorney attorney) {
	...
	public ITINERARY(AutoBodyShop autoBodyShop) {
	...
	public ITINERARY(AutoDealer autoDealer) {
	...
	public ITINERARY(AutoPartsStore autoPartsStore) {
	...
	public ITINERARY(AutoRental autoRental) {
	...
	public ITINERARY(AutoRepair autoRepair) {
	...
	public ITINERARY(AutoWash autoWash) {
	...
	public ITINERARY(AutomatedTeller automatedTeller) {
	...
	public ITINERARY(AutomotiveBusiness automotiveBusiness) {
	...
	public ITINERARY(Bakery bakery) {
	...
	public ITINERARY(BankOrCreditUnion bankOrCreditUnion) {
	...
	public ITINERARY(BarOrPub barOrPub) {
	...
	public ITINERARY(BeautySalon beautySalon) {
	...
	public ITINERARY(BedAndBreakfast bedAndBreakfast) {
	...
	public ITINERARY(BikeStore bikeStore) {
	...
	public ITINERARY(BodyOfWater bodyOfWater) {
	...
	public ITINERARY(BookStore bookStore) {
	...
	public ITINERARY(BowlingAlley bowlingAlley) {
	...
	public ITINERARY(BreadcrumbList breadcrumbList) {
	...
	public ITINERARY(Brewery brewery) {
	...
	public ITINERARY(Bridge bridge) {
	...
	public ITINERARY(BuddhistTemple buddhistTemple) {
	...
	public ITINERARY(BusStation busStation) {
	...
	public ITINERARY(BusStop busStop) {
	...
	public ITINERARY(CafeOrCoffeeShop cafeOrCoffeeShop) {
	...
	public ITINERARY(Campground campground) {
	...
	public ITINERARY(CampingPitch campingPitch) {
	...
	public ITINERARY(Casino casino) {
	...
	public ITINERARY(CatholicChurch catholicChurch) {
	...
	public ITINERARY(Cemetery cemetery) {
	...
	public ITINERARY(ChildCare childCare) {
	...
	public ITINERARY(Church church) {
	...
	public ITINERARY(CityHall cityHall) {
	...
	public ITINERARY(CivicStructure civicStructure) {
	...
	public ITINERARY(ClothingStore clothingStore) {
	...
	public ITINERARY(ComedyClub comedyClub) {
	...
	public ITINERARY(CommunityHealth communityHealth) {
	...
	public ITINERARY(ComputerStore computerStore) {
	...
	public ITINERARY(Continent continent) {
	...
	public ITINERARY(ConvenienceStore convenienceStore) {
	...
	public ITINERARY(Country country) {
	...
	public ITINERARY(Courthouse courthouse) {
	...
	public ITINERARY(Crematorium crematorium) {
	...
	public ITINERARY(DaySpa daySpa) {
	...
	public ITINERARY(DefenceEstablishment defenceEstablishment) {
	...
	public ITINERARY(Dentist dentist) {
	...
	public ITINERARY(DepartmentStore departmentStore) {
	...
	public ITINERARY(Dermatology dermatology) {
	...
	public ITINERARY(DietNutrition dietNutrition) {
	...
	public ITINERARY(Distillery distillery) {
	...
	public ITINERARY(DryCleaningOrLaundry dryCleaningOrLaundry) {
	...
	public ITINERARY(Electrician electrician) {
	...
	public ITINERARY(ElectronicsStore electronicsStore) {
	...
	public ITINERARY(Embassy embassy) {
	...
	public ITINERARY(Emergency emergency) {
	...
	public ITINERARY(EmergencyService emergencyService) {
	...
	public ITINERARY(EmploymentAgency employmentAgency) {
	...
	public ITINERARY(EntertainmentBusiness entertainmentBusiness) {
	...
	public ITINERARY(EventVenue eventVenue) {
	...
	public ITINERARY(ExerciseGym exerciseGym) {
	...
	public ITINERARY(FastFoodRestaurant fastFoodRestaurant) {
	...
	public ITINERARY(FinancialService financialService) {
	...
	public ITINERARY(FireStation fireStation) {
	...
	public ITINERARY(Florist florist) {
	...
	public ITINERARY(FoodEstablishment foodEstablishment) {
	...
	public ITINERARY(FurnitureStore furnitureStore) {
	...
	public ITINERARY(GardenStore gardenStore) {
	...
	public ITINERARY(GasStation gasStation) {
	...
	public ITINERARY(GatedResidenceCommunity gatedResidenceCommunity) {
	...
	public ITINERARY(GeneralContractor generalContractor) {
	...
	public ITINERARY(Geriatric geriatric) {
	...
	public ITINERARY(GolfCourse golfCourse) {
	...
	public ITINERARY(GovernmentBuilding governmentBuilding) {
	...
	public ITINERARY(GovernmentOffice governmentOffice) {
	...
	public ITINERARY(GroceryStore groceryStore) {
	...
	public ITINERARY(Gynecologic gynecologic) {
	...
	public ITINERARY(HVACBusiness hvacBusiness) {
	...
	public ITINERARY(HairSalon hairSalon) {
	...
	public ITINERARY(HardwareStore hardwareStore) {
	...
	public ITINERARY(HealthAndBeautyBusiness healthAndBeautyBusiness) {
	...
	public ITINERARY(HealthClub healthClub) {
	...
	public ITINERARY(HinduTemple hinduTemple) {
	...
	public ITINERARY(HobbyShop hobbyShop) {
	...
	public ITINERARY(HomeAndConstructionBusiness homeAndConstructionBusiness) {
	...
	public ITINERARY(HomeGoodsStore homeGoodsStore) {
	...
	public ITINERARY(Hospital hospital) {
	...
	public ITINERARY(Hostel hostel) {
	...
	public ITINERARY(HotelRoom hotelRoom) {
	...
	public ITINERARY(HousePainter housePainter) {
	...
	public ITINERARY(HowToSection howToSection) {
	...
	public ITINERARY(HowToStep howToStep) {
	...
	public ITINERARY(IceCreamShop iceCreamShop) {
	...
	public ITINERARY(InsuranceAgency insuranceAgency) {
	...
	public ITINERARY(InternetCafe internetCafe) {
	...
	public ITINERARY(JewelryStore jewelryStore) {
	...
	public ITINERARY(LakeBodyOfWater lakeBodyOfWater) {
	...
	public ITINERARY(Landform landform) {
	...
	public ITINERARY(LandmarksOrHistoricalBuildings landmarksOrHistoricalBuildings) {
	...
	public ITINERARY(LegalService legalService) {
	...
	public ITINERARY(LegislativeBuilding legislativeBuilding) {
	...
	public ITINERARY(Library library) {
	...
	public ITINERARY(LiquorStore liquorStore) {
	...
	public ITINERARY(LocalBusiness localBusiness) {
	...
	public ITINERARY(Locksmith locksmith) {
	...
	public ITINERARY(LodgingBusiness lodgingBusiness) {
	...
	public ITINERARY(MedicalBusiness medicalBusiness) {
	...
	public ITINERARY(MedicalClinic medicalClinic) {
	...
	public ITINERARY(MeetingRoom meetingRoom) {
	...
	public ITINERARY(MensClothingStore mensClothingStore) {
	...
	public ITINERARY(Midwifery midwifery) {
	...
	public ITINERARY(MobilePhoneStore mobilePhoneStore) {
	...
	public ITINERARY(Mosque mosque) {
	...
	public ITINERARY(MotorcycleDealer motorcycleDealer) {
	...
	public ITINERARY(MotorcycleRepair motorcycleRepair) {
	...
	public ITINERARY(Mountain mountain) {
	...
	public ITINERARY(MovieRentalStore movieRentalStore) {
	...
	public ITINERARY(MovieTheater movieTheater) {
	...
	public ITINERARY(MovingCompany movingCompany) {
	...
	public ITINERARY(Museum museum) {
	...
	public ITINERARY(MusicStore musicStore) {
	...
	public ITINERARY(MusicVenue musicVenue) {
	...
	public ITINERARY(NailSalon nailSalon) {
	...
	public ITINERARY(NightClub nightClub) {
	...
	public ITINERARY(Notary notary) {
	...
	public ITINERARY(Nursing nursing) {
	...
	public ITINERARY(Obstetric obstetric) {
	...
	public ITINERARY(OceanBodyOfWater oceanBodyOfWater) {
	...
	public ITINERARY(OfferCatalog offerCatalog) {
	...
	public ITINERARY(OfficeEquipmentStore officeEquipmentStore) {
	...
	public ITINERARY(Oncologic oncologic) {
	...
	public ITINERARY(Optician optician) {
	...
	public ITINERARY(Optometric optometric) {
	...
	public ITINERARY(Otolaryngologic otolaryngologic) {
	...
	public ITINERARY(OutletStore outletStore) {
	...
	public ITINERARY(ParkingFacility parkingFacility) {
	...
	public ITINERARY(PawnShop pawnShop) {
	...
	public ITINERARY(Pediatric pediatric) {
	...
	public ITINERARY(PerformingArtsTheater performingArtsTheater) {
	...
	public ITINERARY(PetStore petStore) {
	...
	public ITINERARY(Pharmacy pharmacy) {
	...
	public ITINERARY(Physician physician) {
	...
	public ITINERARY(Physiotherapy physiotherapy) {
	...
	public ITINERARY(PlaceOfWorship placeOfWorship) {
	...
	public ITINERARY(PlasticSurgery plasticSurgery) {
	...
	public ITINERARY(Playground playground) {
	...
	public ITINERARY(Plumber plumber) {
	...
	public ITINERARY(Podiatric podiatric) {
	...
	public ITINERARY(PoliceStation policeStation) {
	...
	public ITINERARY(PostOffice postOffice) {
	...
	public ITINERARY(PrimaryCare primaryCare) {
	...
	public ITINERARY(ProfessionalService professionalService) {
	...
	public ITINERARY(Psychiatric psychiatric) {
	...
	public ITINERARY(PublicHealth publicHealth) {
	...
	public ITINERARY(PublicSwimmingPool publicSwimmingPool) {
	...
	public ITINERARY(PublicToilet publicToilet) {
	...
	public ITINERARY(RVPark rvPark) {
	...
	public ITINERARY(RadioStation radioStation) {
	...
	public ITINERARY(RealEstateAgent realEstateAgent) {
	...
	public ITINERARY(RecyclingCenter recyclingCenter) {
	...
	public ITINERARY(Reservoir reservoir) {
	...
	public ITINERARY(Residence residence) {
	...
	public ITINERARY(Resort resort) {
	...
	public ITINERARY(Restaurant restaurant) {
	...
	public ITINERARY(RiverBodyOfWater riverBodyOfWater) {
	...
	public ITINERARY(RoofingContractor roofingContractor) {
	...
	public ITINERARY(SeaBodyOfWater seaBodyOfWater) {
	...
	public ITINERARY(SelfStorage selfStorage) {
	...
	public ITINERARY(ShoeStore shoeStore) {
	...
	public ITINERARY(ShoppingCenter shoppingCenter) {
	...
	public ITINERARY(SingleFamilyResidence singleFamilyResidence) {
	...
	public ITINERARY(SkiResort skiResort) {
	...
	public ITINERARY(SportingGoodsStore sportingGoodsStore) {
	...
	public ITINERARY(SportsActivityLocation sportsActivityLocation) {
	...
	public ITINERARY(SportsClub sportsClub) {
	...
	public ITINERARY(StadiumOrArena stadiumOrArena) {
	...
	public ITINERARY(SubwayStation subwayStation) {
	...
	public ITINERARY(Synagogue synagogue) {
	...
	public ITINERARY(TattooParlor tattooParlor) {
	...
	public ITINERARY(TaxiStand taxiStand) {
	...
	public ITINERARY(TelevisionStation televisionStation) {
	...
	public ITINERARY(TennisComplex tennisComplex) {
	...
	public ITINERARY(TireShop tireShop) {
	...
	public ITINERARY(TouristAttraction touristAttraction) {
	...
	public ITINERARY(TouristDestination touristDestination) {
	...
	public ITINERARY(TouristInformationCenter touristInformationCenter) {
	...
	public ITINERARY(ToyStore toyStore) {
	...
	public ITINERARY(TrainStation trainStation) {
	...
	public ITINERARY(TravelAgency travelAgency) {
	...
	public ITINERARY(Volcano volcano) {
	...
	public ITINERARY(Waterfall waterfall) {
	...
	public ITINERARY(WholesaleStore wholesaleStore) {
	...
	public ITINERARY(Winery winery) {
