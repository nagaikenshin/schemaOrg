...
public class MEMBERSHIP_POINTS_EARNED implements Container.MembershipPointsEarned {
	...
	public MEMBERSHIP_POINTS_EARNED() {
	}

	public MEMBERSHIP_POINTS_EARNED(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public MEMBERSHIP_POINTS_EARNED(Float fl0at) {
	...
	public MEMBERSHIP_POINTS_EARNED(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public MEMBERSHIP_POINTS_EARNED(Integer integer) {
	...
	public MEMBERSHIP_POINTS_EARNED(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public MEMBERSHIP_POINTS_EARNED(Number number) {
	...
	public MEMBERSHIP_POINTS_EARNED(QuantitativeValue quantitativeValue) {
	...
	public MEMBERSHIP_POINTS_EARNED(List<Float> fl0atList,
	...
	public void copy(Container.MembershipPointsEarned org) {
