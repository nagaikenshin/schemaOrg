...
public class NOT_IN_FORCE implements LegalForceStatus.NotInForce {
	...
	public NOT_IN_FORCE(Long seq) {
		setSeq(seq);
	}

	public NOT_IN_FORCE(String string) {
	...
	public NOT_IN_FORCE(AdditionalType additionalType) {
	...
	public NOT_IN_FORCE(AlternateName alternateName) {
	...
	public NOT_IN_FORCE(Description description) {
	...
	public NOT_IN_FORCE(DisambiguatingDescription disambiguatingDescription) {
	...
	public NOT_IN_FORCE(Identifier identifier) {
	...
	public NOT_IN_FORCE(Image image) {
		setImage(image);
	}
	...
	public NOT_IN_FORCE(MainEntityOfPage mainEntityOfPage) {
	...
	public NOT_IN_FORCE(NameFuzzy nameFuzzy) {
	...
	public NOT_IN_FORCE(NameRuby nameRuby) {
	...
	public NOT_IN_FORCE(PotentialAction potentialAction) {
	...
	public NOT_IN_FORCE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public NOT_IN_FORCE(SubjectOf subjectOf) {
	...
	public NOT_IN_FORCE(SupersededBy supersededBy) {
	...
	public void copy(LegalForceStatus.NotInForce org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return LegalForceStatus.NotInForce.class.getAnnotation(SampleValue.class).value();
	}
