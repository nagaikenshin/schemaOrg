...
public class BACTERIA implements InfectiousAgentClass.Bacteria {
	...
	public BACTERIA(Long seq) {
		setSeq(seq);
	}

	public BACTERIA(String string) {
	...
	public BACTERIA(AdditionalType additionalType) {
	...
	public BACTERIA(AlternateName alternateName) {
	...
	public BACTERIA(Description description) {
	...
	public BACTERIA(DisambiguatingDescription disambiguatingDescription) {
	...
	public BACTERIA(Identifier identifier) {
	...
	public BACTERIA(MainEntityOfPage mainEntityOfPage) {
	...
	public BACTERIA(NameFuzzy nameFuzzy) {
	...
	public BACTERIA(NameRuby nameRuby) {
	...
	public BACTERIA(PotentialAction potentialAction) {
	...
	public BACTERIA(SubjectOf subjectOf) {
	...
	public BACTERIA(SupersededBy supersededBy) {
	...
	public void copy(InfectiousAgentClass.Bacteria org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return InfectiousAgentClass.Bacteria.class.getAnnotation(SampleValue.class).value();
	}
