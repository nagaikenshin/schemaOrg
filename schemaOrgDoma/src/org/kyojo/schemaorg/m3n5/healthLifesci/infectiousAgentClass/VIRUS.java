...
public class VIRUS implements InfectiousAgentClass.Virus {
	...
	public VIRUS(Long seq) {
		setSeq(seq);
	}

	public VIRUS(String string) {
	...
	public VIRUS(AdditionalType additionalType) {
	...
	public VIRUS(AlternateName alternateName) {
	...
	public VIRUS(Description description) {
	...
	public VIRUS(DisambiguatingDescription disambiguatingDescription) {
	...
	public VIRUS(Identifier identifier) {
	...
	public VIRUS(MainEntityOfPage mainEntityOfPage) {
	...
	public VIRUS(NameFuzzy nameFuzzy) {
	...
	public VIRUS(NameRuby nameRuby) {
	...
	public VIRUS(PotentialAction potentialAction) {
	...
	public VIRUS(SubjectOf subjectOf) {
	...
	public VIRUS(SupersededBy supersededBy) {
	...
	public void copy(InfectiousAgentClass.Virus org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return InfectiousAgentClass.Virus.class.getAnnotation(SampleValue.class).value();
	}
