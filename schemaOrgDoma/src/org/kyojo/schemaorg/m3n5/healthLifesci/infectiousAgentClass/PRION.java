...
public class PRION implements InfectiousAgentClass.Prion {
	...
	public PRION(Long seq) {
		setSeq(seq);
	}

	public PRION(String string) {
	...
	public PRION(AdditionalType additionalType) {
	...
	public PRION(AlternateName alternateName) {
	...
	public PRION(Description description) {
	...
	public PRION(DisambiguatingDescription disambiguatingDescription) {
	...
	public PRION(Identifier identifier) {
	...
	public PRION(MainEntityOfPage mainEntityOfPage) {
	...
	public PRION(NameFuzzy nameFuzzy) {
	...
	public PRION(NameRuby nameRuby) {
	...
	public PRION(PotentialAction potentialAction) {
	...
	public PRION(SubjectOf subjectOf) {
	...
	public PRION(SupersededBy supersededBy) {
	...
	public void copy(InfectiousAgentClass.Prion org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return InfectiousAgentClass.Prion.class.getAnnotation(SampleValue.class).value();
	}
