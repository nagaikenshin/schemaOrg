package org.kyojo.schemaorg.m3n5.healthLifesci.medicalImagingTechnique;
...
public class RADIOGRAPHY implements MedicalImagingTechnique.Radiography {
	...
	public RADIOGRAPHY(Long seq) {
		setSeq(seq);
	}

	public RADIOGRAPHY(String string) {
	...
	public RADIOGRAPHY(AdditionalType additionalType) {
	...
	public RADIOGRAPHY(AlternateName alternateName) {
	...
	public RADIOGRAPHY(Description description) {
	...
	public RADIOGRAPHY(DisambiguatingDescription disambiguatingDescription) {
	...
	public RADIOGRAPHY(Identifier identifier) {
	...
	public RADIOGRAPHY(Image image) {
		setImage(image);
	}
	...
	public RADIOGRAPHY(MainEntityOfPage mainEntityOfPage) {
	...
	public RADIOGRAPHY(NameFuzzy nameFuzzy) {
	...
	public RADIOGRAPHY(NameRuby nameRuby) {
	...
	public RADIOGRAPHY(PotentialAction potentialAction) {
	...
	public RADIOGRAPHY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RADIOGRAPHY(SubjectOf subjectOf) {
	...
	public RADIOGRAPHY(SupersededBy supersededBy) {
	...
	public void copy(MedicalImagingTechnique.Radiography org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalImagingTechnique.Radiography.class.getAnnotation(SampleValue.class).value();
	}
