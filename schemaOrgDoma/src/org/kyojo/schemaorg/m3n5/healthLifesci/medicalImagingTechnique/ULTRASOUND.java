...
public class ULTRASOUND implements MedicalImagingTechnique.Ultrasound {
	...
	public ULTRASOUND(Long seq) {
		setSeq(seq);
	}

	public ULTRASOUND(String string) {
	...
	public ULTRASOUND(AdditionalType additionalType) {
	...
	public ULTRASOUND(AlternateName alternateName) {
	...
	public ULTRASOUND(Description description) {
	...
	public ULTRASOUND(DisambiguatingDescription disambiguatingDescription) {
	...
	public ULTRASOUND(Identifier identifier) {
	...
	public ULTRASOUND(MainEntityOfPage mainEntityOfPage) {
	...
	public ULTRASOUND(NameFuzzy nameFuzzy) {
	...
	public ULTRASOUND(NameRuby nameRuby) {
	...
	public ULTRASOUND(PotentialAction potentialAction) {
	...
	public ULTRASOUND(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public ULTRASOUND(SubjectOf subjectOf) {
	...
	public ULTRASOUND(SupersededBy supersededBy) {
	...
	public void copy(MedicalImagingTechnique.Ultrasound org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalImagingTechnique.Ultrasound.class.getAnnotation(SampleValue.class).value();
	}
