...
public class MRI implements MedicalImagingTechnique.MRI {
	...
	public MRI(AdditionalType additionalType) {
	...
	public MRI(AlternateName alternateName) {
	...
	public MRI(Description description) {
	...
	public MRI(DisambiguatingDescription disambiguatingDescription) {
	...
	public MRI(Identifier identifier) {
	...
	public MRI(MainEntityOfPage mainEntityOfPage) {
	...
	public MRI(NameFuzzy nameFuzzy) {
	...
	public MRI(PotentialAction potentialAction) {
	...
	public MRI(SubjectOf subjectOf) {
	...
	public MRI(SupersededBy supersededBy) {
	...
	public void copy(MedicalImagingTechnique.MRI org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalImagingTechnique.MRI.class.getAnnotation(SampleValue.class).value();
	}
