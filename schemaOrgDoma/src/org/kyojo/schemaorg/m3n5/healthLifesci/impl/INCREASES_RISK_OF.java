...
public class INCREASES_RISK_OF implements Container.IncreasesRiskOf {
	...
	public INCREASES_RISK_OF(String string) {
	...
	public INCREASES_RISK_OF(AnatomicalStructure anatomicalStructure) {
	...
	public INCREASES_RISK_OF(AnatomicalSystem anatomicalSystem) {
	...
	public INCREASES_RISK_OF(ApprovedIndication approvedIndication) {
	...
	public INCREASES_RISK_OF(Artery artery) {
	...
	public INCREASES_RISK_OF(BloodTest bloodTest) {
	...
	public INCREASES_RISK_OF(Bone bone) {
	...
	public INCREASES_RISK_OF(BrainStructure brainStructure) {
	...
	public INCREASES_RISK_OF(DDxElement ddxElement) {
	...
	public INCREASES_RISK_OF(DiagnosticProcedure diagnosticProcedure) {
	...
	public INCREASES_RISK_OF(Diet diet) {
	...
	public INCREASES_RISK_OF(DietarySupplement dietarySupplement) {
	...
	public INCREASES_RISK_OF(DoseSchedule doseSchedule) {
	...
	public INCREASES_RISK_OF(Drug drug) {
	...
	public INCREASES_RISK_OF(DrugLegalStatus drugLegalStatus) {
	...
	public INCREASES_RISK_OF(DrugStrength drugStrength) {
	...
	public INCREASES_RISK_OF(ExercisePlan exercisePlan) {
	...
	public INCREASES_RISK_OF(ImagingTest imagingTest) {
	...
	public INCREASES_RISK_OF(InfectiousDisease infectiousDisease) {
	...
	public INCREASES_RISK_OF(Joint joint) {
	...
	public INCREASES_RISK_OF(LifestyleModification lifestyleModification) {
	...
	public INCREASES_RISK_OF(Ligament ligament) {
	...
	public INCREASES_RISK_OF(LymphaticVessel lymphaticVessel) {
	...
	public INCREASES_RISK_OF(MaximumDoseSchedule maximumDoseSchedule) {
	...
	public INCREASES_RISK_OF(MedicalCause medicalCause) {
	...
	public INCREASES_RISK_OF(MedicalCode medicalCode) {
	...
	public INCREASES_RISK_OF(MedicalCondition medicalCondition) {
	...
	public INCREASES_RISK_OF(MedicalConditionStage medicalConditionStage) {
	...
	public INCREASES_RISK_OF(MedicalContraindication medicalContraindication) {
	...
	public INCREASES_RISK_OF(MedicalDevice medicalDevice) {
	...
	public INCREASES_RISK_OF(MedicalEntity medicalEntity) {
		medicalEntityList = new ArrayList<MedicalEntity>();
	...
	public INCREASES_RISK_OF(MedicalGuideline medicalGuideline) {
	...
	public INCREASES_RISK_OF(MedicalGuidelineContraindication medicalGuidelineContraindication) {
	...
	public INCREASES_RISK_OF(MedicalGuidelineRecommendation medicalGuidelineRecommendation) {
	...
	public INCREASES_RISK_OF(MedicalIndication medicalIndication) {
	...
	public INCREASES_RISK_OF(MedicalIntangible medicalIntangible) {
	...
	public INCREASES_RISK_OF(MedicalObservationalStudy medicalObservationalStudy) {
	...
	public INCREASES_RISK_OF(MedicalProcedure medicalProcedure) {
	...
	public INCREASES_RISK_OF(MedicalRiskCalculator medicalRiskCalculator) {
	...
	public INCREASES_RISK_OF(MedicalRiskEstimator medicalRiskEstimator) {
	...
	public INCREASES_RISK_OF(MedicalRiskFactor medicalRiskFactor) {
	...
	public INCREASES_RISK_OF(MedicalRiskScore medicalRiskScore) {
	...
	public INCREASES_RISK_OF(MedicalSign medicalSign) {
	...
	public INCREASES_RISK_OF(MedicalSignOrSymptom medicalSignOrSymptom) {
	...
	public INCREASES_RISK_OF(MedicalStudy medicalStudy) {
	...
	public INCREASES_RISK_OF(MedicalSymptom medicalSymptom) {
	...
	public INCREASES_RISK_OF(MedicalTest medicalTest) {
	...
	public INCREASES_RISK_OF(MedicalTestPanel medicalTestPanel) {
	...
	public INCREASES_RISK_OF(MedicalTherapy medicalTherapy) {
	...
	public INCREASES_RISK_OF(MedicalTrial medicalTrial) {
	...
	public INCREASES_RISK_OF(Muscle muscle) {
	...
	public INCREASES_RISK_OF(Nerve nerve) {
	...
	public INCREASES_RISK_OF(OccupationalTherapy occupationalTherapy) {
	...
	public INCREASES_RISK_OF(PalliativeProcedure palliativeProcedure) {
	...
	public INCREASES_RISK_OF(PathologyTest pathologyTest) {
	...
	public INCREASES_RISK_OF(PhysicalActivity physicalActivity) {
	...
	public INCREASES_RISK_OF(PhysicalExam physicalExam) {
	...
	public INCREASES_RISK_OF(PhysicalTherapy physicalTherapy) {
	...
	public INCREASES_RISK_OF(PreventionIndication preventionIndication) {
	...
	public INCREASES_RISK_OF(PsychologicalTreatment psychologicalTreatment) {
	...
	public INCREASES_RISK_OF(RadiationTherapy radiationTherapy) {
	...
	public INCREASES_RISK_OF(RecommendedDoseSchedule recommendedDoseSchedule) {
	...
	public INCREASES_RISK_OF(ReportedDoseSchedule reportedDoseSchedule) {
	...
	public INCREASES_RISK_OF(RespiratoryTherapy respiratoryTherapy) {
	...
	public INCREASES_RISK_OF(Substance substance) {
	...
	public INCREASES_RISK_OF(SuperficialAnatomy superficialAnatomy) {
	...
	public INCREASES_RISK_OF(SurgicalProcedure surgicalProcedure) {
	...
	public INCREASES_RISK_OF(TherapeuticProcedure therapeuticProcedure) {
	...
	public INCREASES_RISK_OF(TreatmentIndication treatmentIndication) {
	...
	public INCREASES_RISK_OF(Vein vein) {
	...
	public INCREASES_RISK_OF(Vessel vessel) {
	...
	public INCREASES_RISK_OF(VitalSign vitalSign) {
	...
	public void copy(Container.IncreasesRiskOf org) {
