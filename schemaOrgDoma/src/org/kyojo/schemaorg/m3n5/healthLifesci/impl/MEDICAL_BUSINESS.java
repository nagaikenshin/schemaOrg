...
public class MEDICAL_BUSINESS implements Clazz.MedicalBusiness {
	...
	public MEDICAL_BUSINESS(GeoContains geoContains) {
	...
	public MEDICAL_BUSINESS(GeoCoveredBy geoCoveredBy) {
	...
	public MEDICAL_BUSINESS(GeoCovers geoCovers) {
	...
	public MEDICAL_BUSINESS(GeoCrosses geoCrosses) {
	...
	public MEDICAL_BUSINESS(GeoDisjoint geoDisjoint) {
	...
	public MEDICAL_BUSINESS(GeoEquals geoEquals) {
	...
	public MEDICAL_BUSINESS(GeoIntersects geoIntersects) {
	...
	public MEDICAL_BUSINESS(GeoOverlaps geoOverlaps) {
	...
	public MEDICAL_BUSINESS(GeoTouches geoTouches) {
	...
	public MEDICAL_BUSINESS(GeoWithin geoWithin) {
	...
	public MEDICAL_BUSINESS(Slogan slogan) {
		setSlogan(slogan);
	}
