...
public class ARTERIAL_BRANCH implements Container.ArterialBranch {
	...
	public ARTERIAL_BRANCH(String string) {
	...
	public ARTERIAL_BRANCH(AnatomicalStructure anatomicalStructure) {
		anatomicalStructureList = new ArrayList<AnatomicalStructure>();
	...
	public ARTERIAL_BRANCH(Artery artery) {
	...
	public ARTERIAL_BRANCH(Bone bone) {
	...
	public ARTERIAL_BRANCH(BrainStructure brainStructure) {
	...
	public ARTERIAL_BRANCH(Joint joint) {
	...
	public ARTERIAL_BRANCH(Ligament ligament) {
	...
	public ARTERIAL_BRANCH(LymphaticVessel lymphaticVessel) {
	...
	public ARTERIAL_BRANCH(Muscle muscle) {
	...
	public ARTERIAL_BRANCH(Nerve nerve) {
	...
	public ARTERIAL_BRANCH(Vein vein) {
	...
	public ARTERIAL_BRANCH(Vessel vessel) {
	...
	public ARTERIAL_BRANCH(List<AnatomicalStructure> anatomicalStructureList,
	...
	public void copy(Container.ArterialBranch org) {
