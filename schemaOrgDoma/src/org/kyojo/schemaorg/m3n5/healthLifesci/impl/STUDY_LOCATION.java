...
public class STUDY_LOCATION implements Container.StudyLocation {
	...
	public STUDY_LOCATION(String string) {
	...
	public STUDY_LOCATION(AdministrativeArea administrativeArea) {
		administrativeAreaList = new ArrayList<AdministrativeArea>();
	...
	public STUDY_LOCATION(City city) {
	...
	public STUDY_LOCATION(Country country) {
	...
	public STUDY_LOCATION(State state) {
	...
	public STUDY_LOCATION(List<AdministrativeArea> administrativeAreaList,
			List<City> cityList,
	...
	public void copy(Container.StudyLocation org) {
