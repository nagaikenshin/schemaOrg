...
public class SOURCE implements Container.Source {
	...
	public SOURCE(AnatomicalStructure anatomicalStructure) {
		anatomicalStructureList = new ArrayList<AnatomicalStructure>();
	...
	public SOURCE(BrainStructure brainStructure) {
	...
	public SOURCE(Ligament ligament) {
	...
	public SOURCE(LymphaticVessel lymphaticVessel) {
	...
	public SOURCE(List<AnatomicalStructure> anatomicalStructureList,
	...
	public void copy(Container.Source org) {
