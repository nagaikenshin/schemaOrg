...
public class MEDICAL_TEST_PANEL implements Clazz.MedicalTestPanel {
	...
	public MEDICAL_TEST_PANEL() {
	}

	public MEDICAL_TEST_PANEL(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_TEST_PANEL(String string) {
	...
	public MEDICAL_TEST_PANEL(AdditionalType additionalType) {
	...
	public MEDICAL_TEST_PANEL(AffectedBy affectedBy) {
	...
	public MEDICAL_TEST_PANEL(AlternateName alternateName) {
	...
	public MEDICAL_TEST_PANEL(Code code) {
		setCode(code);
	}
	...
	public MEDICAL_TEST_PANEL(Description description) {
	...
	public MEDICAL_TEST_PANEL(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_TEST_PANEL(Guideline guideline) {
	...
	public MEDICAL_TEST_PANEL(Identifier identifier) {
	...
	public MEDICAL_TEST_PANEL(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_TEST_PANEL(LegalStatus legalStatus) {
	...
	public MEDICAL_TEST_PANEL(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_TEST_PANEL(MedicineSystem medicineSystem) {
	...
	public MEDICAL_TEST_PANEL(Name name) {
		setName(name);
	}
	...
	public MEDICAL_TEST_PANEL(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_TEST_PANEL(NameRuby nameRuby) {
	...
	public MEDICAL_TEST_PANEL(NormalRange normalRange) {
	...
	public MEDICAL_TEST_PANEL(PotentialAction potentialAction) {
	...
	public MEDICAL_TEST_PANEL(RecognizingAuthority recognizingAuthority) {
	...
	public MEDICAL_TEST_PANEL(RelevantSpecialty relevantSpecialty) {
	...
	public MEDICAL_TEST_PANEL(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_TEST_PANEL(SignDetected signDetected) {
	...
	public MEDICAL_TEST_PANEL(Study study) {
		setStudy(study);
	}
	...
	public MEDICAL_TEST_PANEL(SubTest subTest) {
		setSubTest(subTest);
	}
	...
	public MEDICAL_TEST_PANEL(SubjectOf subjectOf) {
	...
	public MEDICAL_TEST_PANEL(Url url) {
		setUrl(url);
	}
	...
	public MEDICAL_TEST_PANEL(UsedToDiagnose usedToDiagnose) {
	...
	public MEDICAL_TEST_PANEL(UsesDevice usesDevice) {
	...
	public void copy(Clazz.MedicalTestPanel org) {
		setSeq(org.getSeq());
