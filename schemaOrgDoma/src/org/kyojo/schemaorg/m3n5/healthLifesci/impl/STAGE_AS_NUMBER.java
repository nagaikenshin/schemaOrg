...
public class STAGE_AS_NUMBER implements Container.StageAsNumber {
	...
	public STAGE_AS_NUMBER(Double d0uble) {
		this(new FLOAT(d0uble));
	}

	public STAGE_AS_NUMBER(Float fl0at) {
	...
	public STAGE_AS_NUMBER(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public STAGE_AS_NUMBER(Integer integer) {
	...
	public STAGE_AS_NUMBER(java.math.BigDecimal number) {
		this(new NUMBER(number));
	}

	public STAGE_AS_NUMBER(Number number) {
	...
	public STAGE_AS_NUMBER(List<Float> fl0atList,
	...
	public void copy(Container.StageAsNumber org) {
