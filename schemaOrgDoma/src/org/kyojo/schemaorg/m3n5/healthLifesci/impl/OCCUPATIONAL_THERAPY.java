...
public class OCCUPATIONAL_THERAPY implements Clazz.OccupationalTherapy {
	...
	public OCCUPATIONAL_THERAPY() {
	}

	public OCCUPATIONAL_THERAPY(Long seq) {
		setSeq(seq);
	}

	public OCCUPATIONAL_THERAPY(String string) {
	...
	public OCCUPATIONAL_THERAPY(AdditionalType additionalType) {
	...
	public OCCUPATIONAL_THERAPY(AdverseOutcome adverseOutcome) {
	...
	public OCCUPATIONAL_THERAPY(AlternateName alternateName) {
	...
	public OCCUPATIONAL_THERAPY(BodyLocation bodyLocation) {
	...
	public OCCUPATIONAL_THERAPY(Code code) {
		setCode(code);
	}
	...
	public OCCUPATIONAL_THERAPY(Contraindication contraindication) {
	...
	public OCCUPATIONAL_THERAPY(Description description) {
	...
	public OCCUPATIONAL_THERAPY(DisambiguatingDescription disambiguatingDescription) {
	...
	public OCCUPATIONAL_THERAPY(DoseSchedule doseSchedule) {
	...
	public OCCUPATIONAL_THERAPY(Drug drug) {
		setDrug(drug);
	}
	...
	public OCCUPATIONAL_THERAPY(DuplicateTherapy duplicateTherapy) {
	...
	public OCCUPATIONAL_THERAPY(Followup followup) {
	...
	public OCCUPATIONAL_THERAPY(Guideline guideline) {
	...
	public OCCUPATIONAL_THERAPY(HowPerformed howPerformed) {
	...
	public OCCUPATIONAL_THERAPY(Identifier identifier) {
	...
	public OCCUPATIONAL_THERAPY(Image image) {
		setImage(image);
	}
	...
	public OCCUPATIONAL_THERAPY(Indication indication) {
	...
	public OCCUPATIONAL_THERAPY(LegalStatus legalStatus) {
	...
	public OCCUPATIONAL_THERAPY(MainEntityOfPage mainEntityOfPage) {
	...
	public OCCUPATIONAL_THERAPY(MedicineSystem medicineSystem) {
	...
	public OCCUPATIONAL_THERAPY(Name name) {
		setName(name);
	}
	...
	public OCCUPATIONAL_THERAPY(NameFuzzy nameFuzzy) {
	...
	public OCCUPATIONAL_THERAPY(NameRuby nameRuby) {
	...
	public OCCUPATIONAL_THERAPY(Outcome outcome) {
		setOutcome(outcome);
	}
	...
	public OCCUPATIONAL_THERAPY(PotentialAction potentialAction) {
	...
	public OCCUPATIONAL_THERAPY(Preparation preparation) {
	...
	public OCCUPATIONAL_THERAPY(ProcedureType procedureType) {
	...
	public OCCUPATIONAL_THERAPY(RecognizingAuthority recognizingAuthority) {
	...
	public OCCUPATIONAL_THERAPY(RelevantSpecialty relevantSpecialty) {
	...
	public OCCUPATIONAL_THERAPY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public OCCUPATIONAL_THERAPY(SeriousAdverseOutcome seriousAdverseOutcome) {
	...
	public OCCUPATIONAL_THERAPY(Status status) {
		setStatus(status);
	}
	...
	public OCCUPATIONAL_THERAPY(Study study) {
		setStudy(study);
	}
	...
	public OCCUPATIONAL_THERAPY(SubjectOf subjectOf) {
	...
	public OCCUPATIONAL_THERAPY(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.OccupationalTherapy org) {
		setSeq(org.getSeq());
