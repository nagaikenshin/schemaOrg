...
import org.kyojo.schemaorg.m3n5.healthLifesci.Container.DoseUnit;
import org.kyojo.schemaorg.m3n5.healthLifesci.Container.DoseValue;
import org.kyojo.schemaorg.m3n5.healthLifesci.Container.Frequency;
...
public class REPORTED_DOSE_SCHEDULE implements Clazz.ReportedDoseSchedule {
	...
	public REPORTED_DOSE_SCHEDULE() {
	}

	public REPORTED_DOSE_SCHEDULE(Long seq) {
		setSeq(seq);
	}

	public REPORTED_DOSE_SCHEDULE(String string) {
	...
	public REPORTED_DOSE_SCHEDULE(AdditionalType additionalType) {
	...
	public REPORTED_DOSE_SCHEDULE(AlternateName alternateName) {
	...
	public REPORTED_DOSE_SCHEDULE(Code code) {
		setCode(code);
	}
	...
	public REPORTED_DOSE_SCHEDULE(Description description) {
	...
	public REPORTED_DOSE_SCHEDULE(DisambiguatingDescription disambiguatingDescription) {
	...
	public REPORTED_DOSE_SCHEDULE(DoseUnit doseUnit) {
	...
	public REPORTED_DOSE_SCHEDULE(DoseValue doseValue) {
	...
	public REPORTED_DOSE_SCHEDULE(Frequency frequency) {
	...
	public REPORTED_DOSE_SCHEDULE(Guideline guideline) {
	...
	public REPORTED_DOSE_SCHEDULE(Identifier identifier) {
	...
	public REPORTED_DOSE_SCHEDULE(Image image) {
		setImage(image);
	}
	...
	public REPORTED_DOSE_SCHEDULE(LegalStatus legalStatus) {
	...
	public REPORTED_DOSE_SCHEDULE(MainEntityOfPage mainEntityOfPage) {
	...
	public REPORTED_DOSE_SCHEDULE(MedicineSystem medicineSystem) {
	...
	public REPORTED_DOSE_SCHEDULE(Name name) {
		setName(name);
	}
	...
	public REPORTED_DOSE_SCHEDULE(NameFuzzy nameFuzzy) {
	...
	public REPORTED_DOSE_SCHEDULE(NameRuby nameRuby) {
	...
	public REPORTED_DOSE_SCHEDULE(PotentialAction potentialAction) {
	...
	public REPORTED_DOSE_SCHEDULE(RecognizingAuthority recognizingAuthority) {
	...
	public REPORTED_DOSE_SCHEDULE(RelevantSpecialty relevantSpecialty) {
	...
	public REPORTED_DOSE_SCHEDULE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public REPORTED_DOSE_SCHEDULE(Study study) {
		setStudy(study);
	}
	...
	public REPORTED_DOSE_SCHEDULE(SubjectOf subjectOf) {
	...
	public REPORTED_DOSE_SCHEDULE(TargetPopulation targetPopulation) {
	...
	public REPORTED_DOSE_SCHEDULE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.ReportedDoseSchedule org) {
		setSeq(org.getSeq());
