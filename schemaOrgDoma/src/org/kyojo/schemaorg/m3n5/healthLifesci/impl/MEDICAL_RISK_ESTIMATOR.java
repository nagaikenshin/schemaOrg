...
public class MEDICAL_RISK_ESTIMATOR implements Clazz.MedicalRiskEstimator {
	...
	public MEDICAL_RISK_ESTIMATOR() {
	}

	public MEDICAL_RISK_ESTIMATOR(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_RISK_ESTIMATOR(String string) {
	...
	public MEDICAL_RISK_ESTIMATOR(AdditionalType additionalType) {
	...
	public MEDICAL_RISK_ESTIMATOR(AlternateName alternateName) {
	...
	public MEDICAL_RISK_ESTIMATOR(Code code) {
		setCode(code);
	}
	...
	public MEDICAL_RISK_ESTIMATOR(Description description) {
	...
	public MEDICAL_RISK_ESTIMATOR(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_RISK_ESTIMATOR(EstimatesRiskOf estimatesRiskOf) {
	...
	public MEDICAL_RISK_ESTIMATOR(Guideline guideline) {
	...
	public MEDICAL_RISK_ESTIMATOR(Identifier identifier) {
	...
	public MEDICAL_RISK_ESTIMATOR(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_RISK_ESTIMATOR(IncludedRiskFactor includedRiskFactor) {
	...
	public MEDICAL_RISK_ESTIMATOR(LegalStatus legalStatus) {
	...
	public MEDICAL_RISK_ESTIMATOR(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_RISK_ESTIMATOR(MedicineSystem medicineSystem) {
	...
	public MEDICAL_RISK_ESTIMATOR(Name name) {
		setName(name);
	}
	...
	public MEDICAL_RISK_ESTIMATOR(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_RISK_ESTIMATOR(NameRuby nameRuby) {
	...
	public MEDICAL_RISK_ESTIMATOR(PotentialAction potentialAction) {
	...
	public MEDICAL_RISK_ESTIMATOR(RecognizingAuthority recognizingAuthority) {
	...
	public MEDICAL_RISK_ESTIMATOR(RelevantSpecialty relevantSpecialty) {
	...
	public MEDICAL_RISK_ESTIMATOR(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_RISK_ESTIMATOR(Study study) {
		setStudy(study);
	}
	...
	public MEDICAL_RISK_ESTIMATOR(SubjectOf subjectOf) {
	...
	public MEDICAL_RISK_ESTIMATOR(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.MedicalRiskEstimator org) {
		setSeq(org.getSeq());
