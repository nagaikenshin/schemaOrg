...
public class GUIDELINE_SUBJECT implements Container.GuidelineSubject {
	...
	public GUIDELINE_SUBJECT(String string) {
	...
	public GUIDELINE_SUBJECT(AnatomicalStructure anatomicalStructure) {
	...
	public GUIDELINE_SUBJECT(AnatomicalSystem anatomicalSystem) {
	...
	public GUIDELINE_SUBJECT(ApprovedIndication approvedIndication) {
	...
	public GUIDELINE_SUBJECT(Artery artery) {
	...
	public GUIDELINE_SUBJECT(BloodTest bloodTest) {
	...
	public GUIDELINE_SUBJECT(Bone bone) {
	...
	public GUIDELINE_SUBJECT(BrainStructure brainStructure) {
	...
	public GUIDELINE_SUBJECT(DDxElement ddxElement) {
	...
	public GUIDELINE_SUBJECT(DiagnosticProcedure diagnosticProcedure) {
	...
	public GUIDELINE_SUBJECT(Diet diet) {
	...
	public GUIDELINE_SUBJECT(DietarySupplement dietarySupplement) {
	...
	public GUIDELINE_SUBJECT(DoseSchedule doseSchedule) {
	...
	public GUIDELINE_SUBJECT(Drug drug) {
	...
	public GUIDELINE_SUBJECT(DrugLegalStatus drugLegalStatus) {
	...
	public GUIDELINE_SUBJECT(DrugStrength drugStrength) {
	...
	public GUIDELINE_SUBJECT(ExercisePlan exercisePlan) {
	...
	public GUIDELINE_SUBJECT(ImagingTest imagingTest) {
	...
	public GUIDELINE_SUBJECT(InfectiousDisease infectiousDisease) {
	...
	public GUIDELINE_SUBJECT(Joint joint) {
	...
	public GUIDELINE_SUBJECT(LifestyleModification lifestyleModification) {
	...
	public GUIDELINE_SUBJECT(Ligament ligament) {
	...
	public GUIDELINE_SUBJECT(LymphaticVessel lymphaticVessel) {
	...
	public GUIDELINE_SUBJECT(MaximumDoseSchedule maximumDoseSchedule) {
	...
	public GUIDELINE_SUBJECT(MedicalCause medicalCause) {
	...
	public GUIDELINE_SUBJECT(MedicalCode medicalCode) {
	...
	public GUIDELINE_SUBJECT(MedicalCondition medicalCondition) {
	...
	public GUIDELINE_SUBJECT(MedicalConditionStage medicalConditionStage) {
	...
	public GUIDELINE_SUBJECT(MedicalContraindication medicalContraindication) {
	...
	public GUIDELINE_SUBJECT(MedicalDevice medicalDevice) {
	...
	public GUIDELINE_SUBJECT(MedicalEntity medicalEntity) {
		medicalEntityList = new ArrayList<MedicalEntity>();
	...
	public GUIDELINE_SUBJECT(MedicalGuideline medicalGuideline) {
	...
	public GUIDELINE_SUBJECT(MedicalGuidelineContraindication medicalGuidelineContraindication) {
	...
	public GUIDELINE_SUBJECT(MedicalGuidelineRecommendation medicalGuidelineRecommendation) {
	...
	public GUIDELINE_SUBJECT(MedicalIndication medicalIndication) {
	...
	public GUIDELINE_SUBJECT(MedicalIntangible medicalIntangible) {
	...
	public GUIDELINE_SUBJECT(MedicalObservationalStudy medicalObservationalStudy) {
	...
	public GUIDELINE_SUBJECT(MedicalProcedure medicalProcedure) {
	...
	public GUIDELINE_SUBJECT(MedicalRiskCalculator medicalRiskCalculator) {
	...
	public GUIDELINE_SUBJECT(MedicalRiskEstimator medicalRiskEstimator) {
	...
	public GUIDELINE_SUBJECT(MedicalRiskFactor medicalRiskFactor) {
	...
	public GUIDELINE_SUBJECT(MedicalRiskScore medicalRiskScore) {
	...
	public GUIDELINE_SUBJECT(MedicalSign medicalSign) {
	...
	public GUIDELINE_SUBJECT(MedicalSignOrSymptom medicalSignOrSymptom) {
	...
	public GUIDELINE_SUBJECT(MedicalStudy medicalStudy) {
	...
	public GUIDELINE_SUBJECT(MedicalSymptom medicalSymptom) {
	...
	public GUIDELINE_SUBJECT(MedicalTest medicalTest) {
	...
	public GUIDELINE_SUBJECT(MedicalTestPanel medicalTestPanel) {
	...
	public GUIDELINE_SUBJECT(MedicalTherapy medicalTherapy) {
	...
	public GUIDELINE_SUBJECT(MedicalTrial medicalTrial) {
	...
	public GUIDELINE_SUBJECT(Muscle muscle) {
	...
	public GUIDELINE_SUBJECT(Nerve nerve) {
	...
	public GUIDELINE_SUBJECT(OccupationalTherapy occupationalTherapy) {
	...
	public GUIDELINE_SUBJECT(PalliativeProcedure palliativeProcedure) {
	...
	public GUIDELINE_SUBJECT(PathologyTest pathologyTest) {
	...
	public GUIDELINE_SUBJECT(PhysicalActivity physicalActivity) {
	...
	public GUIDELINE_SUBJECT(PhysicalExam physicalExam) {
	...
	public GUIDELINE_SUBJECT(PhysicalTherapy physicalTherapy) {
	...
	public GUIDELINE_SUBJECT(PreventionIndication preventionIndication) {
	...
	public GUIDELINE_SUBJECT(PsychologicalTreatment psychologicalTreatment) {
	...
	public GUIDELINE_SUBJECT(RadiationTherapy radiationTherapy) {
	...
	public GUIDELINE_SUBJECT(RecommendedDoseSchedule recommendedDoseSchedule) {
	...
	public GUIDELINE_SUBJECT(ReportedDoseSchedule reportedDoseSchedule) {
	...
	public GUIDELINE_SUBJECT(RespiratoryTherapy respiratoryTherapy) {
	...
	public GUIDELINE_SUBJECT(Substance substance) {
	...
	public GUIDELINE_SUBJECT(SuperficialAnatomy superficialAnatomy) {
	...
	public GUIDELINE_SUBJECT(SurgicalProcedure surgicalProcedure) {
	...
	public GUIDELINE_SUBJECT(TherapeuticProcedure therapeuticProcedure) {
	...
	public GUIDELINE_SUBJECT(TreatmentIndication treatmentIndication) {
	...
	public GUIDELINE_SUBJECT(Vein vein) {
	...
	public GUIDELINE_SUBJECT(Vessel vessel) {
	...
	public GUIDELINE_SUBJECT(VitalSign vitalSign) {
	...
	public void copy(Container.GuidelineSubject org) {
