...
public class MEDICAL_PROCEDURE implements Clazz.MedicalProcedure {
	...
	public MEDICAL_PROCEDURE(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_PROCEDURE(String string) {
	...
	public MEDICAL_PROCEDURE(AdditionalType additionalType) {
	...
	public MEDICAL_PROCEDURE(AlternateName alternateName) {
	...
	public MEDICAL_PROCEDURE(BodyLocation bodyLocation) {
	...
	public MEDICAL_PROCEDURE(Code code) {
		setCode(code);
	}
	...
	public MEDICAL_PROCEDURE(Description description) {
	...
	public MEDICAL_PROCEDURE(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_PROCEDURE(Followup followup) {
	...
	public MEDICAL_PROCEDURE(Guideline guideline) {
	...
	public MEDICAL_PROCEDURE(HowPerformed howPerformed) {
	...
	public MEDICAL_PROCEDURE(Identifier identifier) {
	...
	public MEDICAL_PROCEDURE(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_PROCEDURE(Indication indication) {
	...
	public MEDICAL_PROCEDURE(LegalStatus legalStatus) {
	...
	public MEDICAL_PROCEDURE(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_PROCEDURE(MedicineSystem medicineSystem) {
	...
	public MEDICAL_PROCEDURE(Name name) {
		setName(name);
	}
	...
	public MEDICAL_PROCEDURE(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_PROCEDURE(NameRuby nameRuby) {
	...
	public MEDICAL_PROCEDURE(Outcome outcome) {
		setOutcome(outcome);
	}
	...
	public MEDICAL_PROCEDURE(PotentialAction potentialAction) {
	...
	public MEDICAL_PROCEDURE(Preparation preparation) {
	...
	public MEDICAL_PROCEDURE(ProcedureType procedureType) {
	...
	public MEDICAL_PROCEDURE(RecognizingAuthority recognizingAuthority) {
	...
	public MEDICAL_PROCEDURE(RelevantSpecialty relevantSpecialty) {
	...
	public MEDICAL_PROCEDURE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_PROCEDURE(Status status) {
		setStatus(status);
	}
	...
	public MEDICAL_PROCEDURE(Study study) {
		setStudy(study);
	}
	...
	public MEDICAL_PROCEDURE(SubjectOf subjectOf) {
	...
	public MEDICAL_PROCEDURE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.MedicalProcedure org) {
		setSeq(org.getSeq());
