...
public class APPLICABLE_LOCATION implements Container.ApplicableLocation {
	...
	public APPLICABLE_LOCATION(City city) {
	...
	public APPLICABLE_LOCATION(Country country) {
	...
	public APPLICABLE_LOCATION(State state) {
	...
	public APPLICABLE_LOCATION(List<AdministrativeArea> administrativeAreaList,
			List<City> cityList,
	...
	public void copy(Container.ApplicableLocation org) {
