...
import org.kyojo.schemaorg.m3n5.healthLifesci.Container.StageAsNumber;
...
public class MEDICAL_CONDITION_STAGE implements Clazz.MedicalConditionStage {
	...
	public StageAsNumber stageAsNumber;
	public Study study;
	public SubStageSuffix subStageSuffix;
	public SubjectOf subjectOf;
	public Url url;

	public MEDICAL_CONDITION_STAGE() {
	}

	public MEDICAL_CONDITION_STAGE(Long seq) {
		setSeq(seq);
	}

	public MEDICAL_CONDITION_STAGE(String string) {
	...
	public MEDICAL_CONDITION_STAGE(AdditionalType additionalType) {
	...
	public MEDICAL_CONDITION_STAGE(AlternateName alternateName) {
	...
	public MEDICAL_CONDITION_STAGE(Code code) {
		setCode(code);
	}
	...
	public MEDICAL_CONDITION_STAGE(Description description) {
	...
	public MEDICAL_CONDITION_STAGE(DisambiguatingDescription disambiguatingDescription) {
	...
	public MEDICAL_CONDITION_STAGE(Guideline guideline) {
	...
	public MEDICAL_CONDITION_STAGE(Identifier identifier) {
	...
	public MEDICAL_CONDITION_STAGE(Image image) {
		setImage(image);
	}
	...
	public MEDICAL_CONDITION_STAGE(LegalStatus legalStatus) {
	...
	public MEDICAL_CONDITION_STAGE(MainEntityOfPage mainEntityOfPage) {
	...
	public MEDICAL_CONDITION_STAGE(MedicineSystem medicineSystem) {
	...
	public MEDICAL_CONDITION_STAGE(Name name) {
		setName(name);
	}
	...
	public MEDICAL_CONDITION_STAGE(NameFuzzy nameFuzzy) {
	...
	public MEDICAL_CONDITION_STAGE(NameRuby nameRuby) {
	...
	public MEDICAL_CONDITION_STAGE(PotentialAction potentialAction) {
	...
	public MEDICAL_CONDITION_STAGE(RecognizingAuthority recognizingAuthority) {
	...
	public MEDICAL_CONDITION_STAGE(RelevantSpecialty relevantSpecialty) {
	...
	public MEDICAL_CONDITION_STAGE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MEDICAL_CONDITION_STAGE(StageAsNumber stageAsNumber) {
		setStageAsNumber(stageAsNumber);
	}

	@Override
	public StageAsNumber getStageAsNumber() {
		return stageAsNumber;
	}

	@Override
	public void setStageAsNumber(StageAsNumber stageAsNumber) {
		this.stageAsNumber = stageAsNumber;
	}

	public MEDICAL_CONDITION_STAGE(Study study) {
		setStudy(study);
	}
	...
	public MEDICAL_CONDITION_STAGE(SubStageSuffix subStageSuffix) {
		setSubStageSuffix(subStageSuffix);
	}

	@Override
	public SubStageSuffix getSubStageSuffix() {
		return subStageSuffix;
	}

	@Override
	public void setSubStageSuffix(SubStageSuffix subStageSuffix) {
		this.subStageSuffix = subStageSuffix;
	}

	public MEDICAL_CONDITION_STAGE(SubjectOf subjectOf) {
	...
	public MEDICAL_CONDITION_STAGE(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.MedicalConditionStage org) {
		setSeq(org.getSeq());
		...
		setStageAsNumber(org.getStageAsNumber());
		setStudy(org.getStudy());
		setSubStageSuffix(org.getSubStageSuffix());
