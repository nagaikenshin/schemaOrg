...
public class BLOOD_TEST implements Clazz.BloodTest {
	...
	public BLOOD_TEST(Long seq) {
		setSeq(seq);
	}

	public BLOOD_TEST(String string) {
	...
	public BLOOD_TEST(AdditionalType additionalType) {
	...
	public BLOOD_TEST(AffectedBy affectedBy) {
	...
	public BLOOD_TEST(AlternateName alternateName) {
	...
	public BLOOD_TEST(Description description) {
	...
	public BLOOD_TEST(DisambiguatingDescription disambiguatingDescription) {
	...
	public BLOOD_TEST(Guideline guideline) {
	...
	public BLOOD_TEST(Identifier identifier) {
	...
	public BLOOD_TEST(LegalStatus legalStatus) {
	...
	public BLOOD_TEST(MainEntityOfPage mainEntityOfPage) {
	...
	public BLOOD_TEST(MedicineSystem medicineSystem) {
	...
	public BLOOD_TEST(NameFuzzy nameFuzzy) {
	...
	public BLOOD_TEST(NameRuby nameRuby) {
	...
	public BLOOD_TEST(NormalRange normalRange) {
	...
	public BLOOD_TEST(PotentialAction potentialAction) {
	...
	public BLOOD_TEST(RecognizingAuthority recognizingAuthority) {
	...
	public BLOOD_TEST(RelevantSpecialty relevantSpecialty) {
	...
	public BLOOD_TEST(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public BLOOD_TEST(SignDetected signDetected) {
	...
	public BLOOD_TEST(SubjectOf subjectOf) {
	...
	public BLOOD_TEST(UsedToDiagnose usedToDiagnose) {
	...
	public BLOOD_TEST(UsesDevice usesDevice) {
	...
	public void copy(Clazz.BloodTest org) {
		setSeq(org.getSeq());
