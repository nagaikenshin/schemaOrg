...
public class RADIATION_THERAPY implements Clazz.RadiationTherapy {
	...
	public RADIATION_THERAPY() {
	}

	public RADIATION_THERAPY(Long seq) {
		setSeq(seq);
	}

	public RADIATION_THERAPY(String string) {
	...
	public RADIATION_THERAPY(AdditionalType additionalType) {
	...
	public RADIATION_THERAPY(AdverseOutcome adverseOutcome) {
	...
	public RADIATION_THERAPY(AlternateName alternateName) {
	...
	public RADIATION_THERAPY(BodyLocation bodyLocation) {
	...
	public RADIATION_THERAPY(Code code) {
		setCode(code);
	}
	...
	public RADIATION_THERAPY(Contraindication contraindication) {
	...
	public RADIATION_THERAPY(Description description) {
	...
	public RADIATION_THERAPY(DisambiguatingDescription disambiguatingDescription) {
	...
	public RADIATION_THERAPY(DoseSchedule doseSchedule) {
	...
	public RADIATION_THERAPY(Drug drug) {
		setDrug(drug);
	}
	...
	public RADIATION_THERAPY(DuplicateTherapy duplicateTherapy) {
	...
	public RADIATION_THERAPY(Followup followup) {
	...
	public RADIATION_THERAPY(Guideline guideline) {
	...
	public RADIATION_THERAPY(HowPerformed howPerformed) {
	...
	public RADIATION_THERAPY(Identifier identifier) {
	...
	public RADIATION_THERAPY(Image image) {
		setImage(image);
	}
	...
	public RADIATION_THERAPY(Indication indication) {
	...
	public RADIATION_THERAPY(LegalStatus legalStatus) {
	...
	public RADIATION_THERAPY(MainEntityOfPage mainEntityOfPage) {
	...
	public RADIATION_THERAPY(MedicineSystem medicineSystem) {
	...
	public RADIATION_THERAPY(Name name) {
		setName(name);
	}
	...
	public RADIATION_THERAPY(NameFuzzy nameFuzzy) {
	...
	public RADIATION_THERAPY(NameRuby nameRuby) {
	...
	public RADIATION_THERAPY(Outcome outcome) {
		setOutcome(outcome);
	}
	...
	public RADIATION_THERAPY(PotentialAction potentialAction) {
	...
	public RADIATION_THERAPY(Preparation preparation) {
	...
	public RADIATION_THERAPY(ProcedureType procedureType) {
	...
	public RADIATION_THERAPY(RecognizingAuthority recognizingAuthority) {
	...
	public RADIATION_THERAPY(RelevantSpecialty relevantSpecialty) {
	...
	public RADIATION_THERAPY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RADIATION_THERAPY(SeriousAdverseOutcome seriousAdverseOutcome) {
	...
	public RADIATION_THERAPY(Status status) {
		setStatus(status);
	}
	...
	public RADIATION_THERAPY(Study study) {
		setStudy(study);
	}
	...
	public RADIATION_THERAPY(SubjectOf subjectOf) {
	...
	public RADIATION_THERAPY(Url url) {
		setUrl(url);
	}
	...
	public void copy(Clazz.RadiationTherapy org) {
		setSeq(org.getSeq());
