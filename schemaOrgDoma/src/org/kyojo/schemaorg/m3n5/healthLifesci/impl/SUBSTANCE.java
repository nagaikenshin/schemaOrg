...
public class SUBSTANCE implements Clazz.Substance {
	...
	public SUBSTANCE(Long seq) {
		setSeq(seq);
	}

	public SUBSTANCE(String string) {
	...
	public SUBSTANCE(ActiveIngredient activeIngredient) {
	...
	public SUBSTANCE(AdditionalType additionalType) {
	...
	public SUBSTANCE(AlternateName alternateName) {
	...
	public SUBSTANCE(Description description) {
	...
	public SUBSTANCE(DisambiguatingDescription disambiguatingDescription) {
	...
	public SUBSTANCE(Guideline guideline) {
	...
	public SUBSTANCE(Identifier identifier) {
	...
	public SUBSTANCE(LegalStatus legalStatus) {
	...
	public SUBSTANCE(MainEntityOfPage mainEntityOfPage) {
	...
	public SUBSTANCE(MaximumIntake maximumIntake) {
	...
	public SUBSTANCE(MedicineSystem medicineSystem) {
	...
	public SUBSTANCE(NameFuzzy nameFuzzy) {
	...
	public SUBSTANCE(NameRuby nameRuby) {
	...
	public SUBSTANCE(PotentialAction potentialAction) {
	...
	public SUBSTANCE(RecognizingAuthority recognizingAuthority) {
	...
	public SUBSTANCE(RelevantSpecialty relevantSpecialty) {
	...
	public SUBSTANCE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SUBSTANCE(SubjectOf subjectOf) {
	...
	public void copy(Clazz.Substance org) {
		setSeq(org.getSeq());
