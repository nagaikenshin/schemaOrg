...
public class HOMEOPATHIC implements MedicineSystem.Homeopathic {
	...
	public HOMEOPATHIC(Long seq) {
		setSeq(seq);
	}

	public HOMEOPATHIC(String string) {
	...
	public HOMEOPATHIC(AdditionalType additionalType) {
	...
	public HOMEOPATHIC(AlternateName alternateName) {
	...
	public HOMEOPATHIC(Description description) {
	...
	public HOMEOPATHIC(DisambiguatingDescription disambiguatingDescription) {
	...
	public HOMEOPATHIC(Identifier identifier) {
	...
	public HOMEOPATHIC(Image image) {
		setImage(image);
	}
	...
	public HOMEOPATHIC(MainEntityOfPage mainEntityOfPage) {
	...
	public HOMEOPATHIC(NameFuzzy nameFuzzy) {
	...
	public HOMEOPATHIC(NameRuby nameRuby) {
	...
	public HOMEOPATHIC(PotentialAction potentialAction) {
	...
	public HOMEOPATHIC(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public HOMEOPATHIC(SubjectOf subjectOf) {
	...
	public HOMEOPATHIC(SupersededBy supersededBy) {
	...
	public void copy(MedicineSystem.Homeopathic org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicineSystem.Homeopathic.class.getAnnotation(SampleValue.class).value();
	}
