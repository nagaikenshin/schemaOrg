...
public class AYURVEDIC implements MedicineSystem.Ayurvedic {
	...
	public AYURVEDIC(Long seq) {
		setSeq(seq);
	}

	public AYURVEDIC(String string) {
	...
	public AYURVEDIC(AdditionalType additionalType) {
	...
	public AYURVEDIC(AlternateName alternateName) {
	...
	public AYURVEDIC(Description description) {
	...
	public AYURVEDIC(DisambiguatingDescription disambiguatingDescription) {
	...
	public AYURVEDIC(Identifier identifier) {
	...
	public AYURVEDIC(MainEntityOfPage mainEntityOfPage) {
	...
	public AYURVEDIC(NameFuzzy nameFuzzy) {
	...
	public AYURVEDIC(NameRuby nameRuby) {
	...
	public AYURVEDIC(PotentialAction potentialAction) {
	...
	public AYURVEDIC(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public AYURVEDIC(SubjectOf subjectOf) {
	...
	public AYURVEDIC(SupersededBy supersededBy) {
	...
	public void copy(MedicineSystem.Ayurvedic org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicineSystem.Ayurvedic.class.getAnnotation(SampleValue.class).value();
	}
