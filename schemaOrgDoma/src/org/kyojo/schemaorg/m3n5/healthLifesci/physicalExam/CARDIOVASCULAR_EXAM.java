...
public class CARDIOVASCULAR_EXAM implements PhysicalExam.CardiovascularExam {
	...
	public CARDIOVASCULAR_EXAM() {
	}

	public CARDIOVASCULAR_EXAM(Long seq) {
		setSeq(seq);
	}

	public CARDIOVASCULAR_EXAM(String string) {
	...
	public CARDIOVASCULAR_EXAM(AdditionalType additionalType) {
	...
	public CARDIOVASCULAR_EXAM(AlternateName alternateName) {
	...
	public CARDIOVASCULAR_EXAM(BodyLocation bodyLocation) {
	...
	public CARDIOVASCULAR_EXAM(Code code) {
		setCode(code);
	}
	...
	public CARDIOVASCULAR_EXAM(Description description) {
	...
	public CARDIOVASCULAR_EXAM(DisambiguatingDescription disambiguatingDescription) {
	...
	public CARDIOVASCULAR_EXAM(Followup followup) {
	...
	public CARDIOVASCULAR_EXAM(Guideline guideline) {
	...
	public CARDIOVASCULAR_EXAM(HowPerformed howPerformed) {
	...
	public CARDIOVASCULAR_EXAM(Identifier identifier) {
	...
	public CARDIOVASCULAR_EXAM(Image image) {
		setImage(image);
	}
	...
	public CARDIOVASCULAR_EXAM(Indication indication) {
	...
	public CARDIOVASCULAR_EXAM(LegalStatus legalStatus) {
	...
	public CARDIOVASCULAR_EXAM(MainEntityOfPage mainEntityOfPage) {
	...
	public CARDIOVASCULAR_EXAM(MedicineSystem medicineSystem) {
	...
	public CARDIOVASCULAR_EXAM(Name name) {
		setName(name);
	}
	...
	public CARDIOVASCULAR_EXAM(NameFuzzy nameFuzzy) {
	...
	public CARDIOVASCULAR_EXAM(NameRuby nameRuby) {
	...
	public CARDIOVASCULAR_EXAM(Outcome outcome) {
		setOutcome(outcome);
	}
	...
	public CARDIOVASCULAR_EXAM(PotentialAction potentialAction) {
	...
	public CARDIOVASCULAR_EXAM(Preparation preparation) {
	...
	public CARDIOVASCULAR_EXAM(ProcedureType procedureType) {
	...
	public CARDIOVASCULAR_EXAM(RecognizingAuthority recognizingAuthority) {
	...
	public CARDIOVASCULAR_EXAM(RelevantSpecialty relevantSpecialty) {
	...
	public CARDIOVASCULAR_EXAM(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CARDIOVASCULAR_EXAM(Status status) {
		setStatus(status);
	}
	...
	public CARDIOVASCULAR_EXAM(Study study) {
		setStudy(study);
	}
	...
	public CARDIOVASCULAR_EXAM(SubjectOf subjectOf) {
	...
	public CARDIOVASCULAR_EXAM(SupersededBy supersededBy) {
	...
	public CARDIOVASCULAR_EXAM(Url url) {
		setUrl(url);
	}
	...
	public void copy(PhysicalExam.CardiovascularExam org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return PhysicalExam.CardiovascularExam.class.getAnnotation(SampleValue.class).value();
	}
