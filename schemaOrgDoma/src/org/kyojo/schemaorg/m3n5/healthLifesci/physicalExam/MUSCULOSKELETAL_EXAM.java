package org.kyojo.schemaorg.m3n5.healthLifesci.physicalExam;
...
import org.kyojo.schemaorg.m3n5.healthLifesci.PhysicalExam;
import org.kyojo.schemaorg.m3n5.meta.Container.SupersededBy;


public class MUSCULOSKELETAL_EXAM implements PhysicalExam.MusculoskeletalExam {
	...
	public MUSCULOSKELETAL_EXAM() {
	}

	public MUSCULOSKELETAL_EXAM(Long seq) {
		setSeq(seq);
	}

	public MUSCULOSKELETAL_EXAM(String string) {
	...
	public MUSCULOSKELETAL_EXAM(AdditionalType additionalType) {
	...
	public MUSCULOSKELETAL_EXAM(AlternateName alternateName) {
	...
	public MUSCULOSKELETAL_EXAM(BodyLocation bodyLocation) {
	...
	public MUSCULOSKELETAL_EXAM(Code code) {
		setCode(code);
	}
	...
	public MUSCULOSKELETAL_EXAM(Description description) {
	...
	public MUSCULOSKELETAL_EXAM(DisambiguatingDescription disambiguatingDescription) {
	...
	public MUSCULOSKELETAL_EXAM(Followup followup) {
	...
	public MUSCULOSKELETAL_EXAM(Guideline guideline) {
	...
	public MUSCULOSKELETAL_EXAM(HowPerformed howPerformed) {
	...
	public MUSCULOSKELETAL_EXAM(Identifier identifier) {
	...
	public MUSCULOSKELETAL_EXAM(Image image) {
		setImage(image);
	}
	...
	public MUSCULOSKELETAL_EXAM(Indication indication) {
	...
	public MUSCULOSKELETAL_EXAM(LegalStatus legalStatus) {
	...
	public MUSCULOSKELETAL_EXAM(MainEntityOfPage mainEntityOfPage) {
	...
	public MUSCULOSKELETAL_EXAM(MedicineSystem medicineSystem) {
	...
	public MUSCULOSKELETAL_EXAM(Name name) {
		setName(name);
	}
	...
	public MUSCULOSKELETAL_EXAM(NameFuzzy nameFuzzy) {
	...
	public MUSCULOSKELETAL_EXAM(NameRuby nameRuby) {
	...
	public MUSCULOSKELETAL_EXAM(Outcome outcome) {
		setOutcome(outcome);
	}
	...
	public MUSCULOSKELETAL_EXAM(PotentialAction potentialAction) {
	...
	public MUSCULOSKELETAL_EXAM(Preparation preparation) {
	...
	public MUSCULOSKELETAL_EXAM(ProcedureType procedureType) {
	...
	public MUSCULOSKELETAL_EXAM(RecognizingAuthority recognizingAuthority) {
	...
	public MUSCULOSKELETAL_EXAM(RelevantSpecialty relevantSpecialty) {
	...
	public MUSCULOSKELETAL_EXAM(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public MUSCULOSKELETAL_EXAM(Status status) {
		setStatus(status);
	}
	...
	public MUSCULOSKELETAL_EXAM(Study study) {
		setStudy(study);
	}
	...
	public MUSCULOSKELETAL_EXAM(SubjectOf subjectOf) {
	...
	public MUSCULOSKELETAL_EXAM(SupersededBy supersededBy) {
	...
	public MUSCULOSKELETAL_EXAM(Url url) {
		setUrl(url);
	}
	...
	public void copy(PhysicalExam.MusculoskeletalExam org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return PhysicalExam.MusculoskeletalExam.class.getAnnotation(SampleValue.class).value();
	}
