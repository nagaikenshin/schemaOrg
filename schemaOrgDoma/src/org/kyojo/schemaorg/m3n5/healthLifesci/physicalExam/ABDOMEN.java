...
public class ABDOMEN implements PhysicalExam.Abdomen {
	...
	public ABDOMEN(Long seq) {
		setSeq(seq);
	}

	public ABDOMEN(String string) {
	...
	public ABDOMEN(AdditionalType additionalType) {
	...
	public ABDOMEN(AlternateName alternateName) {
	...
	public ABDOMEN(BodyLocation bodyLocation) {
	...
	public ABDOMEN(Description description) {
	...
	public ABDOMEN(DisambiguatingDescription disambiguatingDescription) {
	...
	public ABDOMEN(Followup followup) {
	...
	public ABDOMEN(Guideline guideline) {
	...
	public ABDOMEN(HowPerformed howPerformed) {
	...
	public ABDOMEN(Identifier identifier) {
	...
	public ABDOMEN(Indication indication) {
	...
	public ABDOMEN(LegalStatus legalStatus) {
	...
	public ABDOMEN(MainEntityOfPage mainEntityOfPage) {
	...
	public ABDOMEN(MedicineSystem medicineSystem) {
	...
	public ABDOMEN(NameFuzzy nameFuzzy) {
	...
	public ABDOMEN(NameRuby nameRuby) {
	...
	public ABDOMEN(Outcome outcome) {
		setOutcome(outcome);
	}
	...
	public ABDOMEN(PotentialAction potentialAction) {
	...
	public ABDOMEN(Preparation preparation) {
	...
	public ABDOMEN(ProcedureType procedureType) {
	...
	public ABDOMEN(RecognizingAuthority recognizingAuthority) {
	...
	public ABDOMEN(RelevantSpecialty relevantSpecialty) {
	...
	public ABDOMEN(SubjectOf subjectOf) {
	...
	public ABDOMEN(SupersededBy supersededBy) {
	...
	public void copy(PhysicalExam.Abdomen org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return PhysicalExam.Abdomen.class.getAnnotation(SampleValue.class).value();
	}
