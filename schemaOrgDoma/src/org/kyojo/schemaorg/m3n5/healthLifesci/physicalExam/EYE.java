...
public class EYE implements PhysicalExam.Eye {
	...
	public EYE(AdditionalType additionalType) {
	...
	public EYE(AlternateName alternateName) {
	...
	public EYE(BodyLocation bodyLocation) {
	...
	public EYE(Description description) {
	...
	public EYE(DisambiguatingDescription disambiguatingDescription) {
	...
	public EYE(Guideline guideline) {
	...
	public EYE(HowPerformed howPerformed) {
	...
	public EYE(Identifier identifier) {
	...
	public EYE(Indication indication) {
	...
	public EYE(LegalStatus legalStatus) {
	...
	public EYE(MainEntityOfPage mainEntityOfPage) {
	...
	public EYE(MedicineSystem medicineSystem) {
	...
	public EYE(NameFuzzy nameFuzzy) {
	...
	public EYE(PotentialAction potentialAction) {
	...
	public EYE(Preparation preparation) {
	...
	public EYE(ProcedureType procedureType) {
	...
	public EYE(RecognizingAuthority recognizingAuthority) {
	...
	public EYE(RelevantSpecialty relevantSpecialty) {
	...
	public EYE(SubjectOf subjectOf) {
	...
	public EYE(SupersededBy supersededBy) {
	...
	public void copy(PhysicalExam.Eye org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return PhysicalExam.Eye.class.getAnnotation(SampleValue.class).value();
	}
