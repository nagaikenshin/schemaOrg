...
public class APPEARANCE implements PhysicalExam.Appearance {
	...
	public APPEARANCE(AdditionalType additionalType) {
	...
	public APPEARANCE(AlternateName alternateName) {
	...
	public APPEARANCE(BodyLocation bodyLocation) {
	...
	public APPEARANCE(Description description) {
	...
	public APPEARANCE(DisambiguatingDescription disambiguatingDescription) {
	...
	public APPEARANCE(Followup followup) {
	...
	public APPEARANCE(Guideline guideline) {
	...
	public APPEARANCE(HowPerformed howPerformed) {
	...
	public APPEARANCE(Identifier identifier) {
	...
	public APPEARANCE(Indication indication) {
	...
	public APPEARANCE(LegalStatus legalStatus) {
	...
	public APPEARANCE(MainEntityOfPage mainEntityOfPage) {
	...
	public APPEARANCE(MedicineSystem medicineSystem) {
	...
	public APPEARANCE(NameFuzzy nameFuzzy) {
	...
	public APPEARANCE(NameRuby nameRuby) {
	...
	public APPEARANCE(Outcome outcome) {
		setOutcome(outcome);
	}
	...
	public APPEARANCE(PotentialAction potentialAction) {
	...
	public APPEARANCE(Preparation preparation) {
	...
	public APPEARANCE(ProcedureType procedureType) {
	...
	public APPEARANCE(RecognizingAuthority recognizingAuthority) {
	...
	public APPEARANCE(RelevantSpecialty relevantSpecialty) {
	...
	public APPEARANCE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public APPEARANCE(Status status) {
		setStatus(status);
	}
	...
	public APPEARANCE(SubjectOf subjectOf) {
	...
	public APPEARANCE(SupersededBy supersededBy) {
	...
	public void copy(PhysicalExam.Appearance org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return PhysicalExam.Appearance.class.getAnnotation(SampleValue.class).value();
	}
