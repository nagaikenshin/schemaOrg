...
public class HEAD implements PhysicalExam.Head {
	...
	public HEAD(AdditionalType additionalType) {
	...
	public HEAD(AlternateName alternateName) {
	...
	public HEAD(BodyLocation bodyLocation) {
	...
	public HEAD(Description description) {
	...
	public HEAD(DisambiguatingDescription disambiguatingDescription) {
	...
	public HEAD(Guideline guideline) {
	...
	public HEAD(HowPerformed howPerformed) {
	...
	public HEAD(Indication indication) {
	...
	public HEAD(LegalStatus legalStatus) {
	...
	public HEAD(MainEntityOfPage mainEntityOfPage) {
	...
	public HEAD(MedicineSystem medicineSystem) {
	...
	public HEAD(NameFuzzy nameFuzzy) {
	...
	public HEAD(PotentialAction potentialAction) {
	...
	public HEAD(Preparation preparation) {
	...
	public HEAD(ProcedureType procedureType) {
	...
	public HEAD(RecognizingAuthority recognizingAuthority) {
	...
	public HEAD(RelevantSpecialty relevantSpecialty) {
	...
	public HEAD(SubjectOf subjectOf) {
	...
	public HEAD(SupersededBy supersededBy) {
	...
	public void copy(PhysicalExam.Head org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return PhysicalExam.Head.class.getAnnotation(SampleValue.class).value();
	}
