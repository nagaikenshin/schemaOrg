...
public class FLEXIBILITY implements PhysicalActivityCategory.Flexibility {
	...
	public FLEXIBILITY(Long seq) {
		setSeq(seq);
	}

	public FLEXIBILITY(String string) {
	...
	public FLEXIBILITY(AdditionalType additionalType) {
	...
	public FLEXIBILITY(AlternateName alternateName) {
	...
	public FLEXIBILITY(Description description) {
	...
	public FLEXIBILITY(DisambiguatingDescription disambiguatingDescription) {
	...
	public FLEXIBILITY(Identifier identifier) {
	...
	public FLEXIBILITY(Image image) {
		setImage(image);
	}
	...
	public FLEXIBILITY(MainEntityOfPage mainEntityOfPage) {
	...
	public FLEXIBILITY(NameFuzzy nameFuzzy) {
	...
	public FLEXIBILITY(NameRuby nameRuby) {
	...
	public FLEXIBILITY(PotentialAction potentialAction) {
	...
	public FLEXIBILITY(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public FLEXIBILITY(SubjectOf subjectOf) {
	...
	public FLEXIBILITY(SupersededBy supersededBy) {
	...
	public void copy(PhysicalActivityCategory.Flexibility org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return PhysicalActivityCategory.Flexibility.class.getAnnotation(SampleValue.class).value();
	}
