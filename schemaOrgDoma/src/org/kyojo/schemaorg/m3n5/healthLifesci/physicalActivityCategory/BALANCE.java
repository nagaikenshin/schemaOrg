...
public class BALANCE implements PhysicalActivityCategory.Balance {
	...
	public BALANCE(AdditionalType additionalType) {
	...
	public BALANCE(AlternateName alternateName) {
	...
	public BALANCE(Description description) {
	...
	public BALANCE(DisambiguatingDescription disambiguatingDescription) {
	...
	public BALANCE(Identifier identifier) {
	...
	public BALANCE(MainEntityOfPage mainEntityOfPage) {
	...
	public BALANCE(NameFuzzy nameFuzzy) {
	...
	public BALANCE(NameRuby nameRuby) {
	...
	public BALANCE(PotentialAction potentialAction) {
	...
	public BALANCE(SubjectOf subjectOf) {
	...
	public BALANCE(SupersededBy supersededBy) {
	...
	public void copy(PhysicalActivityCategory.Balance org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return PhysicalActivityCategory.Balance.class.getAnnotation(SampleValue.class).value();
	}
