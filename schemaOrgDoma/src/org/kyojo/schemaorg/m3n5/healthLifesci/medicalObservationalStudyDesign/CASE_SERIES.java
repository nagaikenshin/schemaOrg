...
public class CASE_SERIES implements MedicalObservationalStudyDesign.CaseSeries {
	...
	public CASE_SERIES(Long seq) {
		setSeq(seq);
	}

	public CASE_SERIES(String string) {
	...
	public CASE_SERIES(AdditionalType additionalType) {
	...
	public CASE_SERIES(AlternateName alternateName) {
	...
	public CASE_SERIES(Description description) {
	...
	public CASE_SERIES(DisambiguatingDescription disambiguatingDescription) {
	...
	public CASE_SERIES(Identifier identifier) {
	...
	public CASE_SERIES(Image image) {
		setImage(image);
	}
	...
	public CASE_SERIES(MainEntityOfPage mainEntityOfPage) {
	...
	public CASE_SERIES(NameFuzzy nameFuzzy) {
	...
	public CASE_SERIES(NameRuby nameRuby) {
	...
	public CASE_SERIES(PotentialAction potentialAction) {
	...
	public CASE_SERIES(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public CASE_SERIES(SubjectOf subjectOf) {
	...
	public CASE_SERIES(SupersededBy supersededBy) {
	...
	public void copy(MedicalObservationalStudyDesign.CaseSeries org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalObservationalStudyDesign.CaseSeries.class.getAnnotation(SampleValue.class).value();
	}
