...
public class OBSERVATIONAL implements MedicalObservationalStudyDesign.Observational {
	...
	public OBSERVATIONAL() {
	}

	public OBSERVATIONAL(Long seq) {
		setSeq(seq);
	}

	public OBSERVATIONAL(String string) {
	...
	public OBSERVATIONAL(AdditionalType additionalType) {
	...
	public OBSERVATIONAL(AlternateName alternateName) {
	...
	public OBSERVATIONAL(Description description) {
	...
	public OBSERVATIONAL(DisambiguatingDescription disambiguatingDescription) {
	...
	public OBSERVATIONAL(Identifier identifier) {
	...
	public OBSERVATIONAL(Image image) {
		setImage(image);
	}
	...
	public OBSERVATIONAL(MainEntityOfPage mainEntityOfPage) {
	...
	public OBSERVATIONAL(Name name) {
		setName(name);
	}
	...
	public OBSERVATIONAL(NameFuzzy nameFuzzy) {
	...
	public OBSERVATIONAL(NameRuby nameRuby) {
	...
	public OBSERVATIONAL(PotentialAction potentialAction) {
	...
	public OBSERVATIONAL(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public OBSERVATIONAL(SubjectOf subjectOf) {
	...
	public OBSERVATIONAL(SupersededBy supersededBy) {
	...
	public void copy(MedicalObservationalStudyDesign.Observational org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalObservationalStudyDesign.Observational.class.getAnnotation(SampleValue.class).value();
	}
