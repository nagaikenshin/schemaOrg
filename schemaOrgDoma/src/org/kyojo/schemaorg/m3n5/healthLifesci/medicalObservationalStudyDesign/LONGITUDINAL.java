...
public class LONGITUDINAL implements MedicalObservationalStudyDesign.Longitudinal {
	...
	public LONGITUDINAL(Long seq) {
		setSeq(seq);
	}

	public LONGITUDINAL(String string) {
	...
	public LONGITUDINAL(AdditionalType additionalType) {
	...
	public LONGITUDINAL(AlternateName alternateName) {
	...
	public LONGITUDINAL(Description description) {
	...
	public LONGITUDINAL(DisambiguatingDescription disambiguatingDescription) {
	...
	public LONGITUDINAL(Identifier identifier) {
	...
	public LONGITUDINAL(Image image) {
		setImage(image);
	}
	...
	public LONGITUDINAL(MainEntityOfPage mainEntityOfPage) {
	...
	public LONGITUDINAL(NameFuzzy nameFuzzy) {
	...
	public LONGITUDINAL(NameRuby nameRuby) {
	...
	public LONGITUDINAL(PotentialAction potentialAction) {
	...
	public LONGITUDINAL(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public LONGITUDINAL(SubjectOf subjectOf) {
	...
	public LONGITUDINAL(SupersededBy supersededBy) {
	...
	public void copy(MedicalObservationalStudyDesign.Longitudinal org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalObservationalStudyDesign.Longitudinal.class.getAnnotation(SampleValue.class).value();
	}
