...
public class WHOLESALE implements DrugCostCategory.Wholesale {
	...
	public WHOLESALE(Long seq) {
		setSeq(seq);
	}

	public WHOLESALE(String string) {
	...
	public WHOLESALE(AdditionalType additionalType) {
	...
	public WHOLESALE(AlternateName alternateName) {
	...
	public WHOLESALE(Description description) {
	...
	public WHOLESALE(DisambiguatingDescription disambiguatingDescription) {
	...
	public WHOLESALE(Identifier identifier) {
	...
	public WHOLESALE(MainEntityOfPage mainEntityOfPage) {
	...
	public WHOLESALE(NameFuzzy nameFuzzy) {
	...
	public WHOLESALE(NameRuby nameRuby) {
	...
	public WHOLESALE(PotentialAction potentialAction) {
	...
	public WHOLESALE(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public WHOLESALE(SubjectOf subjectOf) {
	...
	public WHOLESALE(SupersededBy supersededBy) {
	...
	public void copy(DrugCostCategory.Wholesale org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return DrugCostCategory.Wholesale.class.getAnnotation(SampleValue.class).value();
	}
