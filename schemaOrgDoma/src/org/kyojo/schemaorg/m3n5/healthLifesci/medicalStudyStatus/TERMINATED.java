...
public class TERMINATED implements MedicalStudyStatus.Terminated {
	...
	public TERMINATED(Long seq) {
		setSeq(seq);
	}

	public TERMINATED(String string) {
	...
	public TERMINATED(AdditionalType additionalType) {
	...
	public TERMINATED(AlternateName alternateName) {
	...
	public TERMINATED(Description description) {
	...
	public TERMINATED(DisambiguatingDescription disambiguatingDescription) {
	...
	public TERMINATED(Identifier identifier) {
	...
	public TERMINATED(MainEntityOfPage mainEntityOfPage) {
	...
	public TERMINATED(NameFuzzy nameFuzzy) {
	...
	public TERMINATED(NameRuby nameRuby) {
	...
	public TERMINATED(PotentialAction potentialAction) {
	...
	public TERMINATED(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public TERMINATED(SubjectOf subjectOf) {
	...
	public TERMINATED(SupersededBy supersededBy) {
	...
	public void copy(MedicalStudyStatus.Terminated org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalStudyStatus.Terminated.class.getAnnotation(SampleValue.class).value();
	}
