...
public class SUSPENDED implements MedicalStudyStatus.Suspended {
	...
	public SUSPENDED(Long seq) {
		setSeq(seq);
	}

	public SUSPENDED(String string) {
	...
	public SUSPENDED(AdditionalType additionalType) {
	...
	public SUSPENDED(AlternateName alternateName) {
	...
	public SUSPENDED(Description description) {
	...
	public SUSPENDED(DisambiguatingDescription disambiguatingDescription) {
	...
	public SUSPENDED(Identifier identifier) {
	...
	public SUSPENDED(MainEntityOfPage mainEntityOfPage) {
	...
	public SUSPENDED(NameFuzzy nameFuzzy) {
	...
	public SUSPENDED(NameRuby nameRuby) {
	...
	public SUSPENDED(PotentialAction potentialAction) {
	...
	public SUSPENDED(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public SUSPENDED(SubjectOf subjectOf) {
	...
	public SUSPENDED(SupersededBy supersededBy) {
	...
	public void copy(MedicalStudyStatus.Suspended org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalStudyStatus.Suspended.class.getAnnotation(SampleValue.class).value();
	}
