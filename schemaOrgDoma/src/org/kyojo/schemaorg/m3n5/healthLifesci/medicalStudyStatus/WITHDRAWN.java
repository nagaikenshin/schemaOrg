...
public class WITHDRAWN implements MedicalStudyStatus.Withdrawn {
	...
	public WITHDRAWN(Long seq) {
		setSeq(seq);
	}

	public WITHDRAWN(String string) {
	...
	public WITHDRAWN(AdditionalType additionalType) {
	...
	public WITHDRAWN(AlternateName alternateName) {
	...
	public WITHDRAWN(Description description) {
	...
	public WITHDRAWN(DisambiguatingDescription disambiguatingDescription) {
	...
	public WITHDRAWN(Identifier identifier) {
	...
	public WITHDRAWN(MainEntityOfPage mainEntityOfPage) {
	...
	public WITHDRAWN(NameFuzzy nameFuzzy) {
	...
	public WITHDRAWN(NameRuby nameRuby) {
	...
	public WITHDRAWN(PotentialAction potentialAction) {
	...
	public WITHDRAWN(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public WITHDRAWN(SubjectOf subjectOf) {
	...
	public WITHDRAWN(SupersededBy supersededBy) {
	...
	public void copy(MedicalStudyStatus.Withdrawn org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalStudyStatus.Withdrawn.class.getAnnotation(SampleValue.class).value();
	}
