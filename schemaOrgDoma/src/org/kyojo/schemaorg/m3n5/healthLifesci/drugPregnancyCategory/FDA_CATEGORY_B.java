...
public class FDA_CATEGORY_B implements DrugPregnancyCategory.FDAcategoryB {
	...
	public FDA_CATEGORY_B() {
	}

	public FDA_CATEGORY_B(Long seq) {
		setSeq(seq);
	}

	public FDA_CATEGORY_B(String string) {
	...
	public FDA_CATEGORY_B(AdditionalType additionalType) {
	...
	public FDA_CATEGORY_B(AlternateName alternateName) {
	...
	public FDA_CATEGORY_B(Description description) {
	...
	public FDA_CATEGORY_B(DisambiguatingDescription disambiguatingDescription) {
	...
	public FDA_CATEGORY_B(Identifier identifier) {
	...
	public FDA_CATEGORY_B(Image image) {
		setImage(image);
	}
	...
	public FDA_CATEGORY_B(MainEntityOfPage mainEntityOfPage) {
	...
	public FDA_CATEGORY_B(Name name) {
		setName(name);
	}
	...
	public FDA_CATEGORY_B(NameFuzzy nameFuzzy) {
	...
	public FDA_CATEGORY_B(NameRuby nameRuby) {
	...
	public FDA_CATEGORY_B(PotentialAction potentialAction) {
	...
	public FDA_CATEGORY_B(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public FDA_CATEGORY_B(SubjectOf subjectOf) {
	...
	public FDA_CATEGORY_B(SupersededBy supersededBy) {
	...
	public void copy(DrugPregnancyCategory.FDAcategoryB org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return DrugPregnancyCategory.FDAcategoryB.class.getAnnotation(SampleValue.class).value();
	}
