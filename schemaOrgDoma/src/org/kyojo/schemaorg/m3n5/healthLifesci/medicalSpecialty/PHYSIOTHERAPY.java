...
public class PHYSIOTHERAPY implements MedicalSpecialty.Physiotherapy {
	...
	public PHYSIOTHERAPY(GeoContains geoContains) {
	...
	public PHYSIOTHERAPY(GeoCoveredBy geoCoveredBy) {
	...
	public PHYSIOTHERAPY(GeoCovers geoCovers) {
	...
	public PHYSIOTHERAPY(GeoCrosses geoCrosses) {
	...
	public PHYSIOTHERAPY(GeoDisjoint geoDisjoint) {
	...
	public PHYSIOTHERAPY(GeoEquals geoEquals) {
	...
	public PHYSIOTHERAPY(GeoIntersects geoIntersects) {
	...
	public PHYSIOTHERAPY(GeoOverlaps geoOverlaps) {
	...
	public PHYSIOTHERAPY(GeoTouches geoTouches) {
	...
	public PHYSIOTHERAPY(GeoWithin geoWithin) {
	...
	public PHYSIOTHERAPY(Slogan slogan) {
		setSlogan(slogan);
	}
