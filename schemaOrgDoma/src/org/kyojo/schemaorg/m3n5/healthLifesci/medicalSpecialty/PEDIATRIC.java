...
public class PEDIATRIC implements MedicalSpecialty.Pediatric {
	...
	public PEDIATRIC(GeoContains geoContains) {
	...
	public PEDIATRIC(GeoCoveredBy geoCoveredBy) {
	...
	public PEDIATRIC(GeoCovers geoCovers) {
	...
	public PEDIATRIC(GeoCrosses geoCrosses) {
	...
	public PEDIATRIC(GeoDisjoint geoDisjoint) {
	...
	public PEDIATRIC(GeoEquals geoEquals) {
	...
	public PEDIATRIC(GeoIntersects geoIntersects) {
	...
	public PEDIATRIC(GeoOverlaps geoOverlaps) {
	...
	public PEDIATRIC(GeoTouches geoTouches) {
	...
	public PEDIATRIC(GeoWithin geoWithin) {
	...
	public PEDIATRIC(Slogan slogan) {
		setSlogan(slogan);
	}
