...
public class COMMUNITY_HEALTH implements MedicalSpecialty.CommunityHealth {
	...
	public COMMUNITY_HEALTH(GeoContains geoContains) {
	...
	public COMMUNITY_HEALTH(GeoCoveredBy geoCoveredBy) {
	...
	public COMMUNITY_HEALTH(GeoCovers geoCovers) {
	...
	public COMMUNITY_HEALTH(GeoCrosses geoCrosses) {
	...
	public COMMUNITY_HEALTH(GeoDisjoint geoDisjoint) {
	...
	public COMMUNITY_HEALTH(GeoEquals geoEquals) {
	...
	public COMMUNITY_HEALTH(GeoIntersects geoIntersects) {
	...
	public COMMUNITY_HEALTH(GeoOverlaps geoOverlaps) {
	...
	public COMMUNITY_HEALTH(GeoTouches geoTouches) {
	...
	public COMMUNITY_HEALTH(GeoWithin geoWithin) {
	...
	public COMMUNITY_HEALTH(Slogan slogan) {
		setSlogan(slogan);
	}
