...
public class EMERGENCY implements MedicalSpecialty.Emergency {
	...
	public EMERGENCY(GeoContains geoContains) {
	...
	public EMERGENCY(GeoCoveredBy geoCoveredBy) {
	...
	public EMERGENCY(GeoCovers geoCovers) {
	...
	public EMERGENCY(GeoCrosses geoCrosses) {
	...
	public EMERGENCY(GeoDisjoint geoDisjoint) {
	...
	public EMERGENCY(GeoEquals geoEquals) {
	...
	public EMERGENCY(GeoIntersects geoIntersects) {
	...
	public EMERGENCY(GeoOverlaps geoOverlaps) {
	...
	public EMERGENCY(GeoTouches geoTouches) {
	...
	public EMERGENCY(GeoWithin geoWithin) {
	...
	public EMERGENCY(Slogan slogan) {
		setSlogan(slogan);
	}
