...
public class OPTOMETRIC implements MedicalSpecialty.Optometric {
	...
	public OPTOMETRIC(GeoContains geoContains) {
	...
	public OPTOMETRIC(GeoCoveredBy geoCoveredBy) {
	...
	public OPTOMETRIC(GeoCovers geoCovers) {
	...
	public OPTOMETRIC(GeoCrosses geoCrosses) {
	...
	public OPTOMETRIC(GeoDisjoint geoDisjoint) {
	...
	public OPTOMETRIC(GeoEquals geoEquals) {
	...
	public OPTOMETRIC(GeoIntersects geoIntersects) {
	...
	public OPTOMETRIC(GeoOverlaps geoOverlaps) {
	...
	public OPTOMETRIC(GeoTouches geoTouches) {
	...
	public OPTOMETRIC(GeoWithin geoWithin) {
	...
	public OPTOMETRIC(Slogan slogan) {
		setSlogan(slogan);
	}
