...
public class ONCOLOGIC implements MedicalSpecialty.Oncologic {
	...
	public ONCOLOGIC(GeoContains geoContains) {
	...
	public ONCOLOGIC(GeoCoveredBy geoCoveredBy) {
	...
	public ONCOLOGIC(GeoCovers geoCovers) {
	...
	public ONCOLOGIC(GeoCrosses geoCrosses) {
	...
	public ONCOLOGIC(GeoDisjoint geoDisjoint) {
	...
	public ONCOLOGIC(GeoEquals geoEquals) {
	...
	public ONCOLOGIC(GeoIntersects geoIntersects) {
	...
	public ONCOLOGIC(GeoOverlaps geoOverlaps) {
	...
	public ONCOLOGIC(GeoTouches geoTouches) {
	...
	public ONCOLOGIC(GeoWithin geoWithin) {
	...
	public ONCOLOGIC(Slogan slogan) {
		setSlogan(slogan);
	}
