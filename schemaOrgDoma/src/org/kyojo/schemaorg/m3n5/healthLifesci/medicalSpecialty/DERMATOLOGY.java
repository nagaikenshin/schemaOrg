...
public class DERMATOLOGY implements MedicalSpecialty.Dermatology {
	...
	public DERMATOLOGY(GeoContains geoContains) {
	...
	public DERMATOLOGY(GeoCoveredBy geoCoveredBy) {
	...
	public DERMATOLOGY(GeoCovers geoCovers) {
	...
	public DERMATOLOGY(GeoCrosses geoCrosses) {
	...
	public DERMATOLOGY(GeoDisjoint geoDisjoint) {
	...
	public DERMATOLOGY(GeoEquals geoEquals) {
	...
	public DERMATOLOGY(GeoIntersects geoIntersects) {
	...
	public DERMATOLOGY(GeoOverlaps geoOverlaps) {
	...
	public DERMATOLOGY(GeoTouches geoTouches) {
	...
	public DERMATOLOGY(GeoWithin geoWithin) {
	...
	public DERMATOLOGY(Slogan slogan) {
		setSlogan(slogan);
	}
