...
public class PLASTIC_SURGERY implements MedicalSpecialty.PlasticSurgery {
	...
	public PLASTIC_SURGERY(GeoContains geoContains) {
	...
	public PLASTIC_SURGERY(GeoCoveredBy geoCoveredBy) {
	...
	public PLASTIC_SURGERY(GeoCovers geoCovers) {
	...
	public PLASTIC_SURGERY(GeoCrosses geoCrosses) {
	...
	public PLASTIC_SURGERY(GeoDisjoint geoDisjoint) {
	...
	public PLASTIC_SURGERY(GeoEquals geoEquals) {
	...
	public PLASTIC_SURGERY(GeoIntersects geoIntersects) {
	...
	public PLASTIC_SURGERY(GeoOverlaps geoOverlaps) {
	...
	public PLASTIC_SURGERY(GeoTouches geoTouches) {
	...
	public PLASTIC_SURGERY(GeoWithin geoWithin) {
	...
	public PLASTIC_SURGERY(Slogan slogan) {
		setSlogan(slogan);
	}
