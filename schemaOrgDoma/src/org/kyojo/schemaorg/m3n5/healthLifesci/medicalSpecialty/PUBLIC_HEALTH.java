...
public class PUBLIC_HEALTH implements MedicalSpecialty.PublicHealth {
	...
	public PUBLIC_HEALTH(GeoContains geoContains) {
	...
	public PUBLIC_HEALTH(GeoCoveredBy geoCoveredBy) {
	...
	public PUBLIC_HEALTH(GeoCovers geoCovers) {
	...
	public PUBLIC_HEALTH(GeoCrosses geoCrosses) {
	...
	public PUBLIC_HEALTH(GeoDisjoint geoDisjoint) {
	...
	public PUBLIC_HEALTH(GeoEquals geoEquals) {
	...
	public PUBLIC_HEALTH(GeoIntersects geoIntersects) {
	...
	public PUBLIC_HEALTH(GeoOverlaps geoOverlaps) {
	...
	public PUBLIC_HEALTH(GeoTouches geoTouches) {
	...
	public PUBLIC_HEALTH(GeoWithin geoWithin) {
	...
	public PUBLIC_HEALTH(Slogan slogan) {
		setSlogan(slogan);
	}
