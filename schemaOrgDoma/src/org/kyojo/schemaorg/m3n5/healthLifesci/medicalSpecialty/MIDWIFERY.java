...
public class MIDWIFERY implements MedicalSpecialty.Midwifery {
	...
	public MIDWIFERY(GeoContains geoContains) {
	...
	public MIDWIFERY(GeoCoveredBy geoCoveredBy) {
	...
	public MIDWIFERY(GeoCovers geoCovers) {
	...
	public MIDWIFERY(GeoCrosses geoCrosses) {
	...
	public MIDWIFERY(GeoDisjoint geoDisjoint) {
	...
	public MIDWIFERY(GeoEquals geoEquals) {
	...
	public MIDWIFERY(GeoIntersects geoIntersects) {
	...
	public MIDWIFERY(GeoOverlaps geoOverlaps) {
	...
	public MIDWIFERY(GeoTouches geoTouches) {
	...
	public MIDWIFERY(GeoWithin geoWithin) {
	...
	public MIDWIFERY(Slogan slogan) {
		setSlogan(slogan);
	}
