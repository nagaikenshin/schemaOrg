...
public class GERIATRIC implements MedicalSpecialty.Geriatric {
	...
	public GERIATRIC(GeoContains geoContains) {
	...
	public GERIATRIC(GeoCoveredBy geoCoveredBy) {
	...
	public GERIATRIC(GeoCovers geoCovers) {
	...
	public GERIATRIC(GeoCrosses geoCrosses) {
	...
	public GERIATRIC(GeoDisjoint geoDisjoint) {
	...
	public GERIATRIC(GeoEquals geoEquals) {
	...
	public GERIATRIC(GeoIntersects geoIntersects) {
	...
	public GERIATRIC(GeoOverlaps geoOverlaps) {
	...
	public GERIATRIC(GeoTouches geoTouches) {
	...
	public GERIATRIC(GeoWithin geoWithin) {
	...
	public GERIATRIC(Slogan slogan) {
		setSlogan(slogan);
	}
