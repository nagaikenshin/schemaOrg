...
public class NURSING implements MedicalSpecialty.Nursing {
	...
	public NURSING(GeoContains geoContains) {
	...
	public NURSING(GeoCoveredBy geoCoveredBy) {
	...
	public NURSING(GeoCovers geoCovers) {
	...
	public NURSING(GeoCrosses geoCrosses) {
	...
	public NURSING(GeoDisjoint geoDisjoint) {
	...
	public NURSING(GeoEquals geoEquals) {
	...
	public NURSING(GeoIntersects geoIntersects) {
	...
	public NURSING(GeoOverlaps geoOverlaps) {
	...
	public NURSING(GeoTouches geoTouches) {
	...
	public NURSING(GeoWithin geoWithin) {
