...
public class RANDOMIZED_TRIAL implements MedicalTrialDesign.RandomizedTrial {
	...
	public RANDOMIZED_TRIAL() {
	}

	public RANDOMIZED_TRIAL(Long seq) {
		setSeq(seq);
	}

	public RANDOMIZED_TRIAL(String string) {
	...
	public RANDOMIZED_TRIAL(AdditionalType additionalType) {
	...
	public RANDOMIZED_TRIAL(AlternateName alternateName) {
	...
	public RANDOMIZED_TRIAL(Description description) {
	...
	public RANDOMIZED_TRIAL(DisambiguatingDescription disambiguatingDescription) {
	...
	public RANDOMIZED_TRIAL(Identifier identifier) {
	...
	public RANDOMIZED_TRIAL(Image image) {
		setImage(image);
	}
	...
	public RANDOMIZED_TRIAL(MainEntityOfPage mainEntityOfPage) {
	...
	public RANDOMIZED_TRIAL(Name name) {
		setName(name);
	}
	...
	public RANDOMIZED_TRIAL(NameFuzzy nameFuzzy) {
	...
	public RANDOMIZED_TRIAL(NameRuby nameRuby) {
	...
	public RANDOMIZED_TRIAL(PotentialAction potentialAction) {
	...
	public RANDOMIZED_TRIAL(SameAs sameAs) {
		setSameAs(sameAs);
	}
	...
	public RANDOMIZED_TRIAL(SubjectOf subjectOf) {
	...
	public RANDOMIZED_TRIAL(SupersededBy supersededBy) {
	...
	public RANDOMIZED_TRIAL(Url url) {
		setUrl(url);
	}
	...
	public void copy(MedicalTrialDesign.RandomizedTrial org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalTrialDesign.RandomizedTrial.class.getAnnotation(SampleValue.class).value();
	}
