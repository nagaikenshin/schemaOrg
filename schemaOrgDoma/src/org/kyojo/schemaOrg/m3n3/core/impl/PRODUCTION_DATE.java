...
public class PRODUCTION_DATE implements Container.ProductionDate {
	...
	public PRODUCTION_DATE(java.util.Date date) {
		this(new DATE(date));
	}

	public PRODUCTION_DATE(java.time.LocalDate date) {
		this(new DATE(date));
	}

	public PRODUCTION_DATE(Date date) {
