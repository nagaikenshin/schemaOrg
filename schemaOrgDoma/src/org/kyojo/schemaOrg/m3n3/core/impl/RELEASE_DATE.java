...
public class RELEASE_DATE implements Container.ReleaseDate {
	...
	public RELEASE_DATE(java.util.Date date) {
		this(new DATE(date));
	}

	public RELEASE_DATE(java.time.LocalDate date) {
		this(new DATE(date));
	}

	public RELEASE_DATE(Date date) {
