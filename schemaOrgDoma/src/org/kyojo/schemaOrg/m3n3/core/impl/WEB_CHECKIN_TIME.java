...
public class WEB_CHECKIN_TIME implements Container.WebCheckinTime {
	...
	public WEB_CHECKIN_TIME(java.util.Date dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public WEB_CHECKIN_TIME(java.time.OffsetDateTime dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public WEB_CHECKIN_TIME(DateTime dateTime) {
