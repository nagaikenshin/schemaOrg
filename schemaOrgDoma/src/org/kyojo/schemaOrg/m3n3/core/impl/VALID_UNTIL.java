...
public class VALID_UNTIL implements Container.ValidUntil {
	...
	public VALID_UNTIL(java.util.Date date) {
		this(new DATE(date));
	}

	public VALID_UNTIL(java.time.LocalDate date) {
		this(new DATE(date));
	}

	public VALID_UNTIL(Date date) {
