...
public class DATE_SENT implements Container.DateSent {
	...
	public DATE_SENT(java.util.Date dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public DATE_SENT(java.time.OffsetDateTime dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public DATE_SENT(DateTime dateTime) {
