...
public class CLOTHING_STORE implements Clazz.ClothingStore {
	...
	public CLOTHING_STORE(GeospatiallyContains geospatiallyContains) {
	...
	public CLOTHING_STORE(GeospatiallyCoveredBy geospatiallyCoveredBy) {
	...
	public CLOTHING_STORE(GeospatiallyCovers geospatiallyCovers) {
	...
	public CLOTHING_STORE(GeospatiallyCrosses geospatiallyCrosses) {
	...
	public CLOTHING_STORE(GeospatiallyDisjoint geospatiallyDisjoint) {
	...
	public CLOTHING_STORE(GeospatiallyEquals geospatiallyEquals) {
	...
	public CLOTHING_STORE(GeospatiallyIntersects geospatiallyIntersects) {
	...
	public CLOTHING_STORE(GeospatiallyOverlaps geospatiallyOverlaps) {
	...
	public CLOTHING_STORE(GeospatiallyTouches geospatiallyTouches) {
	...
	public CLOTHING_STORE(GeospatiallyWithin geospatiallyWithin) {
