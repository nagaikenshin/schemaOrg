...
public class DATE_POSTED implements Container.DatePosted {
	...
	public DATE_POSTED(java.util.Date date) {
		this(new DATE(date));
	}

	public DATE_POSTED(java.time.LocalDate date) {
		this(new DATE(date));
	}

	public DATE_POSTED(Date date) {
