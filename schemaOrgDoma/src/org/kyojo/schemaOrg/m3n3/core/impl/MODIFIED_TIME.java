...
public class MODIFIED_TIME implements Container.ModifiedTime {
	...
	public MODIFIED_TIME(java.util.Date dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public MODIFIED_TIME(java.time.OffsetDateTime dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public MODIFIED_TIME(DateTime dateTime) {
