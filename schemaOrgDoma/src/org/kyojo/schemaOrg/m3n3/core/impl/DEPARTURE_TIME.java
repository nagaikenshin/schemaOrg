...
public class DEPARTURE_TIME implements Container.DepartureTime {
	...
	public DEPARTURE_TIME(java.util.Date dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public DEPARTURE_TIME(java.time.OffsetDateTime dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public DEPARTURE_TIME(DateTime dateTime) {
