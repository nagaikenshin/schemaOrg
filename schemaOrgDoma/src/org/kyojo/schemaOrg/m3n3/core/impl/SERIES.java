...
public class SERIES implements Clazz.Series {
	...
	public SERIES(AccessMode accessMode) {
	...
	public SERIES(AccessModeSufficient accessModeSufficient) {
	...
	public SERIES(AccessibilityAPI accessibilityAPI) {
	...
	public SERIES(AccessibilityControl accessibilityControl) {
	...
	public SERIES(AccessibilityFeature accessibilityFeature) {
	...
	public SERIES(AccessibilityHazard accessibilityHazard) {
	...
	public SERIES(AccessibilitySummary accessibilitySummary) {
	...
	public SERIES(AccountablePerson accountablePerson) {
	...
	public SERIES(AdditionalType additionalType) {
	...
	public SERIES(AggregateRating aggregateRating) {
	...
	public SERIES(AlternateName alternateName) {
	...
	public SERIES(AlternativeHeadline alternativeHeadline) {
	...
	public SERIES(AssociatedMedia associatedMedia) {
	...
	public SERIES(Audience audience) {
	...
	public SERIES(Character character) {
	...
	public SERIES(Citation citation) {
	...
	public SERIES(CommentCount commentCount) {
	...
	public SERIES(ContentLocation contentLocation) {
	...
	public SERIES(ContentRating contentRating) {
	...
	public SERIES(ContentReferenceTime contentReferenceTime) {
	...
	public SERIES(Contributor contributor) {
	...
	public SERIES(CopyrightHolder copyrightHolder) {
	...
	public SERIES(CopyrightYear copyrightYear) {
	...
	public SERIES(DateCreated dateCreated) {
	...
	public SERIES(DateModified dateModified) {
	...
	public SERIES(DatePublished datePublished) {
	...
	public SERIES(Description description) {
	...
	public SERIES(DisambiguatingDescription disambiguatingDescription) {
	...
	public SERIES(DiscussionUrl discussionUrl) {
	...
	public SERIES(EducationalAlignment educationalAlignment) {
	...
	public SERIES(EducationalUse educationalUse) {
	...
	public SERIES(Encoding encoding) {
	...
	public SERIES(ExampleOfWork exampleOfWork) {
	...
	public SERIES(FileFormat fileFormat) {
	...
	public SERIES(Headline headline) {
	...
	public SERIES(Identifier identifier) {
	...
	public SERIES(InLanguage inLanguage) {
	...
	public SERIES(InteractionStatistic interactionStatistic) {
	...
	public SERIES(InteractivityType interactivityType) {
	...
	public SERIES(IsAccessibleForFree isAccessibleForFree) {
	...
	public SERIES(IsBasedOn isBasedOn) {
	...
	public SERIES(IsFamilyFriendly isFamilyFriendly) {
	...
	public SERIES(IsPartOf isPartOf) {
	...
	public SERIES(Keywords keywords) {
	...
	public SERIES(LearningResourceType learningResourceType) {
	...
	public SERIES(LocationCreated locationCreated) {
	...
	public SERIES(MainEntity mainEntity) {
	...
	public SERIES(MainEntityOfPage mainEntityOfPage) {
	...
	public SERIES(Material material) {
	...
	public SERIES(Mentions mentions) {
	...
	public SERIES(NameFuzzy nameFuzzy) {
	...
	public SERIES(NameRuby nameRuby) {
	...
	public SERIES(Position position) {
	...
	public SERIES(PotentialAction potentialAction) {
	...
	public SERIES(Producer producer) {
	...
	public SERIES(Provider provider) {
	...
	public SERIES(Publication publication) {
	...
	public SERIES(Publisher publisher) {
	...
	public SERIES(PublisherImprint publisherImprint) {
	...
	public SERIES(PublishingPrinciples publishingPrinciples) {
	...
	public SERIES(RecordedAt recordedAt) {
	...
	public SERIES(ReleasedEvent releasedEvent) {
	...
	public SERIES(SchemaVersion schemaVersion) {
	...
	public SERIES(SourceOrganization sourceOrganization) {
	...
	public SERIES(SpatialCoverage spatialCoverage) {
	...
	public SERIES(TemporalCoverage temporalCoverage) {
	...
	public SERIES(ThumbnailUrl thumbnailUrl) {
	...
	public SERIES(TimeRequired timeRequired) {
	...
	public SERIES(TranslationOfWork translationOfWork) {
	...
	public SERIES(Translator translator) {
	...
	public SERIES(TypicalAgeRange typicalAgeRange) {
	...
	public SERIES(WorkExample workExample) {
	...
	public SERIES(WorkTranslation workTranslation) {
	...
	public void copy(Clazz.Series org) {
		setSeq(org.getSeq());
