...
public class CHECKIN_TIME implements Container.CheckinTime {
	...
	public CHECKIN_TIME(java.util.Date dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public CHECKIN_TIME(java.time.OffsetDateTime dateTime) {
		this(new DATE_TIME(dateTime));
	}

	public CHECKIN_TIME(DateTime dateTime) {
