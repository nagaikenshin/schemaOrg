...
public class USER_INTERACTION_COUNT implements Container.UserInteractionCount {
	...
	public USER_INTERACTION_COUNT(Long l0ng) {
		this(new INTEGER(l0ng));
	}

	public USER_INTERACTION_COUNT(Integer integer) {
