...
public class DELIVERY_ADDRESS implements Container.DeliveryAddress {
	...
	public DELIVERY_ADDRESS(String string) {
	...
	public DELIVERY_ADDRESS(PostalAddress postalAddress) {
		postalAddressList = new ArrayList<PostalAddress>();
