...
public class LOAN_PAYMENT_AMOUNT implements Container.LoanPaymentAmount {
	...
	public LOAN_PAYMENT_AMOUNT() {
	}

	public LOAN_PAYMENT_AMOUNT(String string) {
	...
	public LOAN_PAYMENT_AMOUNT(MonetaryAmount monetaryAmount) {
		monetaryAmountList = new ArrayList<MonetaryAmount>();
