...
public class ACCOUNT_MINIMUM_INFLOW implements Container.AccountMinimumInflow {
	...
	public ACCOUNT_MINIMUM_INFLOW(String string) {
	...
	public ACCOUNT_MINIMUM_INFLOW(MonetaryAmount monetaryAmount) {
		monetaryAmountList = new ArrayList<MonetaryAmount>();
