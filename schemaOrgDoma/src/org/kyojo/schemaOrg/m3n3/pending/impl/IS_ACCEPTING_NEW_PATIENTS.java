...
public class IS_ACCEPTING_NEW_PATIENTS implements Container.IsAcceptingNewPatients {
	...
	public IS_ACCEPTING_NEW_PATIENTS(java.lang.Boolean b00lean) {
		this(new BOOLEAN(b00lean));
	}

	public IS_ACCEPTING_NEW_PATIENTS(Boolean b00lean) {
