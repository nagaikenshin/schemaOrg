...
public class HEALTH_PLAN_MARKETING_URL implements Container.HealthPlanMarketingUrl {
	...
	public HEALTH_PLAN_MARKETING_URL() {
	}

	public HEALTH_PLAN_MARKETING_URL(String string) {
	...
	public HEALTH_PLAN_MARKETING_URL(URL url) {
		urlList = new ArrayList<URL>();
		urlList.add(url);
	}
