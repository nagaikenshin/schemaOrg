...
public class LEGISLATION_TRANSPOSES implements Container.LegislationTransposes {
	...
	public LEGISLATION_TRANSPOSES(String string) {
	...
	public LEGISLATION_TRANSPOSES(Legislation legislation) {
		legislationList = new ArrayList<Legislation>();
