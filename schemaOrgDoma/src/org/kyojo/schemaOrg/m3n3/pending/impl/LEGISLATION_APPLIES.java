...
public class LEGISLATION_APPLIES implements Container.LegislationApplies {
	...
	public LEGISLATION_APPLIES(String string) {
	...
	public LEGISLATION_APPLIES(Legislation legislation) {
		legislationList = new ArrayList<Legislation>();
