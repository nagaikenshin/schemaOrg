...
public class BENEFITS_SUMMARY_URL implements Container.BenefitsSummaryUrl {
	...
	public BENEFITS_SUMMARY_URL() {
	}

	public BENEFITS_SUMMARY_URL(String string) {
	...
	public BENEFITS_SUMMARY_URL(URL url) {
		urlList = new ArrayList<URL>();
		urlList.add(url);
	}
