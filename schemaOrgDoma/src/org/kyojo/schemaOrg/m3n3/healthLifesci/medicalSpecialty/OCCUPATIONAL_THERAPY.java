...
public class OCCUPATIONAL_THERAPY implements MedicalSpecialty.OccupationalTherapy {
	...
	public OCCUPATIONAL_THERAPY(SupersededBy supersededBy) {
	...
	public void copy(MedicalSpecialty.OccupationalTherapy org) {
		setSeq(org.getSeq());
	...
	@Override
	public String value() {
		return MedicalSpecialty.OccupationalTherapy.class.getAnnotation(SampleValue.class).value();
	}
